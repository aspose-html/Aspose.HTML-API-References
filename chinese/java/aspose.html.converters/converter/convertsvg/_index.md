...
| options | XpsSaveOptions | 使用[`XpsSaveOptions`](../../../com.aspose.html.saving/xpssaveoptions/)对象可让您调优渲染过程。欲了解更多信息，请参阅[Aspose 文档](https://docs.aspose.com/html/net/converting-between-formats/svg-to-xps/#save-options)。 |
...
请参阅[文章](https://docs.aspose.com/html/net/converting-between-formats/svg-to-xps/)，其中提供了使用[`Converter`](../)类的 ConvertSVG() 方法将 SVG 转换为 XPS 的信息，以及如何应用[`XpsSaveOptions`](../../../com.aspose.html.saving/xpssaveoptions/)和[`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/)参数。

将 SVG 转换为 XPS

Converter 类提供多种针对 SVG 到 XPS 的特定转换。要将 SVG 转换为 XPS，您应遵循以下简易场景之一，包含几个步骤：

转换源。检测本地已有的 SVG 文件或远程[`Url`](../../../com.aspose.html/url/)作为转换源。您还可以将[`SVGDocument`](../../../com.aspose.html.dom.svg/svgdocument/)定义为转换源，甚至使用由字符串源呈现的内联 SVG 内容。转换结果。定义结果输出文件路径，或使用已知或自定义的[`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/)接口实现作为输出数据缓冲区。创建一个具有特定或默认设置的[`XpsSaveOptions`](../../../com.aspose.html.saving/xpssaveoptions/)对象。您还可以将[`configuration`](../../../com.aspose.html/configuration/)作为选项参数添加。使用 Converter 类的 ConvertSVG() 方法将 SVG 保存为 XPS 结果，参数可根据用户场景使用三项或更多。在线 SVG 转换器

Aspose.HTML 提供免费的在线[SVG 转 XPS 转换器](https://products.aspose.app/svg/en/conversion/svg-to-xps)，可高质量、简便且快速地将 SVG 转换为 XPS。只需上传、转换您的文件，即可在几秒钟内获得结果！
...
| options | DocSaveOptions | [`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/) 对象的使用使您能够调优渲染过程。欲了解更多信息，请参阅 [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/svg-to-docx/#convert-svg-to-docx-using-docsaveoptions)。 |
...
请参阅 [article](https://docs.aspose.com/html/net/converting-between-formats/svg-to-docx/)，您可以在其中找到有关如何使用 Converter 类的 ConvertSVG() 方法将 SVG 转换为 [DOCX](https://docs.fileformat.com/word-processing/docx/) 的信息，以及如何应用 [`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/) 和 [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) 参数。

将 SVG 转换为 DOCX

Converter 类提供多种针对 SVG 转换为 DOCX 的特定转换。要将 SVG 转换为 DOCX，您应遵循以下简易场景之一，包含几个步骤：

转换来源。检测本地已有的 SVG 文件或远程 [`Url`](../../../com.aspose.html/url/) 作为转换来源。您也可以将 [`SVGDocument`](../../../com.aspose.html.dom.svg/svgdocument/) 定义为转换来源，甚至使用由字符串源呈现的内联 SVG 内容。转换结果。定义结果输出文件路径，或使用已知或自定义的 [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) 接口实现作为输出数据缓冲区。使用特定或默认设置创建新的 [`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/) 对象。您还可以将 [`configuration`](../../../com.aspose.html/configuration/) 添加为可选参数。使用 Converter 类的 ConvertSVG() 方法，将 SVG 保存为 DOCX 结果，参数根据用户场景可为三项或更多。在线 SVG 转换器
...
将通过内联内容呈现的 SVG 源转换。结果是通过输出文件路径生成的 docx 文件。
...
| --- | --- | --- |
| source | SVGDocument | 由[`SVGDocument`](../../../com.aspose.html.dom.svg/svgdocument/)呈现的转换源。 |
| options | PdfSaveOptions | [`PdfSaveOptions`](../../../com.aspose.html.saving/pdfsaveoptions/) 对象的使用使您能够调优渲染过程。欲了解更多信息，请参阅 [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/svg-to-pdf/#save-options)。 |
...
请参阅 [article](https://docs.aspose.com/html/net/converting-between-formats/svg-to-pdf/)，您可以在其中找到有关如何使用 [`Converter`](../) 类的 ConvertSVG() 方法将 SVG 转换为 PDF 的信息，以及如何应用 [`PdfSaveOptions`](../../../com.aspose.html.saving/pdfsaveoptions/) 和 [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) 参数。

将 SVG 转换为 PDF

Converter 类提供多种针对 SVG 转换为 PDF 的特定转换。要将 SVG 转换为 PDF，您应遵循以下简易场景之一，包含几个步骤：

转换来源。检测本地已有的 SVG 文件或远程 [`Url`](../../../com.aspose.html/url/) 作为转换来源。您也可以将 [`SVGDocument`](../../../com.aspose.html.dom.svg/svgdocument/) 定义为转换来源，甚至使用由字符串源呈现的内联 SVG 内容。转换结果。定义结果输出文件路径，或使用已知或自定义的 [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) 接口实现作为输出数据缓冲区。使用特定或默认设置创建新的 [`PdfSaveOptions`](../../../com.aspose.html.saving/pdfsaveoptions/) 对象。您还可以将 [`configuration`](../../../com.aspose.html/configuration/) 添加为可选参数。使用 Converter 类的 ConvertSVG() 方法，将 SVG 保存为 PDF 结果，参数根据用户场景可为三项或更多。在线 SVG 转换器
...
将通过内联内容呈现的 SVG 源转换为 PDF。结果是通过输出文件路径生成的 pdf 文件。
...
将通过内联内容呈现的 SVG 源转换为图像。结果是通过输出文件路径生成的图像文件。
...
将通过内联内容呈现的 SVG 源转换为 XPS。结果是通过输出文件路径生成的 xps 文件。
