...
description: "com.aspose.html.accessibility 包用于所有 Web 可访问性相关的操作。符合国际标准 W3C Web 可访问性倡议。"
type: docs

url: /zh/java/com.aspose.html.accessibility/
---
该 **com.aspose.html.accessibility** 包用于所有 Web 可访问性相关的操作，符合国际标准 W3C Web Accessibility Initiative。

## 类

| 类 | 描述 |
| --- | --- |
| [AccessibilityRules](./accessibilityrules/) | Web 内容可访问性指南 (WCAG) 2 的要求（成功准则）和技术的快速参考。包含原则列表。 https://www.w3.org/WAI/WCAG21/quickref/ |
...
| [Guideline](./guideline/) | 指南 - 原则之后的下一级。它们不可测试，但概述框架和一般目标，帮助作者理解成功准则并更好地应用技术。指南是带有类型 RuleDirectory{Criterion} 的接受准则列表。 |
| [Principle](./principle/) | 可访问性原则 - 提供 Web 可访问性基础的最高层级，包含带有类型 RuleCollection{Guideline} 的指南列表。该对象不允许在程序集外创建。 https://www.w3.org/WAI/fundamentals/accessibility-principles/ |
