...
description: "WebAccessibility 方法。为特定规则创建 AccessibilityValidator 实例，使用 ValidationBuilder.All 对象的完整参数"
type: docs

url: /zh/java/com.aspose.html.accessibility/webaccessibility/createvalidator/
---
## CreateValidator(IRule) {#createvalidator_1}

针对特定规则，并提供 ValidationBuilder.All 对象的完整参数，创建 AccessibilityValidator 实例。
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| 规则 | IRule | 实现 IRule 接口的规则对象 |

### 返回值

AccessibilityValidator 对象
...
| --- | --- | --- |
| 规则 | IRule | 实现 IRule 接口的规则对象 |
| 构建器 | ValidationBuilder | ValidationBuilder 对象 |
...
| --- | --- | --- |
| 规则 | IRule | 实现 IRule 接口的规则对象 |
| 构建器 | Action`1 | 返回 ValidationBuilder 对象的方法 |
...
使用 ValidationBuilder.All 对象，根据所有规则创建 AccessibilityValidator 实例。
...
为特定规则列表创建 AccessibilityValidator 实例。
