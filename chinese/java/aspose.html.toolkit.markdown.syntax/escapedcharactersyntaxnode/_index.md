---
title: "EscapedCharacterSyntaxNode 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.toolkit.markdown.syntax.EscapedCharacterSyntaxNode 类。实现了转义字符语法节点"
type: docs

url: /zh/java/com.aspose.html.toolkit.markdown.syntax/escapedcharactersyntaxnode/
---
...
| [getSource](../../com.aspose.html.toolkit.markdown.syntax/textsyntaxnode/source/) 返回源文本。 |
| [getSpan](../../com.aspose.html.toolkit.markdown.syntax/textsyntaxnode/span/) 定义获取 span 的接口。 |
| [getValue](../../com.aspose.html.toolkit.markdown.syntax/textsyntaxnode/value/) 定义获取字符串值的属性。 |

## 方法

| 名称 | 描述 |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/escapedcharactersyntaxnode/accept/)(MarkdownSyntaxVisitor) | 定义接受访问者的接口。 |
