...
description: "MarkdownSyntaxFactory 方法。创建 HardBreakSyntaxNode"
type: docs

url: /zh/java/com.aspose.html.toolkit.markdown.syntax/markdownsyntaxfactory/hardbreak/
---
## MarkdownSyntaxFactory.HardBreak method

创建 [`HardBreakSyntaxNode`](../../hardbreaksyntaxnode/)。
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| 标签 | MarkdownSyntaxToken | 该 MarkdownSyntaxToken。 |
