...
description: "MarkdownSyntaxFactory 方法。创建 AutoLinkSyntaxNode"
type: docs

url: /zh/java/com.aspose.html.toolkit.markdown.syntax/markdownsyntaxfactory/autolink/
---
## AutoLink(MarkdownSyntaxToken, TextSyntaxNode, MarkdownSyntaxToken) {#autolink}

创建 [`AutoLinkSyntaxNode`](../../autolinksyntaxnode/)。
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| opening | MarkdownSyntaxToken | 该 MarkdownSyntaxToken。 |
| 内容 | TextSyntaxNode | 该 TextSyntax。 |
| closing | MarkdownSyntaxToken | 该 MarkdownSyntaxToken。 |
