...
description: "com.aspose.html.toolkit.markdown.syntax.InlineProxy 类。表示 InlineProxy"
type: docs

url: /zh/java/com.aspose.html.toolkit.markdown.syntax/inlineproxy/
---
## InlineProxy class
...
| 名称 | 描述 |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/inlineproxy/accept/)(MarkdownSyntaxVisitor) | 定义接受访问者的接口。 |
...
| [getTarget](../../com.aspose.html.toolkit.markdown.syntax/inlineproxy/gettarget/)() | 定义获取目标的接口。 |
...
| [writeTo](../../com.aspose.html.toolkit.markdown.syntax/inlineproxy/writeto/#writeto)(MarkdownTextWriter) | 写入文本写入器。 |
