---
title: "HTMLAppletElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.HTMLAppletElement 类。嵌入的 Java 小程序。参见 HTML 4.01 中的 APPLET 元素定义。此元素在 HTML 4.01 中已弃用"
type: docs

url: /zh/java/com.aspose.html/htmlappletelement/
---
## HTMLAppletElement class

嵌入的 Java applet。请参阅 HTML 4.01 中的 APPLET 元素定义。此元素在 HTML 4.01 中已弃用。
