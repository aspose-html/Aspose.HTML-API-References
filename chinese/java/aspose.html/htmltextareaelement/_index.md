---
title: "HTMLTextAreaElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.HTMLTextAreaElement 类。多行文本字段。参见 HTML 4.01 中的 TEXTAREA 元素定义。"
type: docs

url: /zh/java/com.aspose.html/htmltextareaelement/
---
## HTMLTextAreaElement class

多行文本字段。参见 HTML 4.01 中的 TEXTAREA 元素定义。
...
| [getForm](../../com.aspose.html/htmltextareaelement/form/) 返回包含此控件的 `FORM` 元素。如果此控件不在表单上下文中，则返回 `null`。 |
[getId]
...
| [getType](../../com.aspose.html/htmltextareaelement/type/) 此表单控件的类型。它是字符串 \"textarea\"。 |
[getValue]
