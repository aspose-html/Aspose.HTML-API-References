---
title: "HTMLOptionElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.HTMLOptionElement 类。一个可选择的选项。参见 HTML 4.01 中的 OPTION 元素定义。"
type: docs

url: /zh/java/com.aspose.html/htmloptionelement/
---
## HTMLOptionElement class

可选择的选项。参见 HTML 4.01 中的 OPTION 元素定义。
...
| [getForm](../../com.aspose.html/htmloptionelement/form/) 返回包含此控件的 `FORM` 元素。如果此控件不在表单上下文中，则返回 `null`。 |
[getId]
[setId] The element's identifier. See the id attribute definition in HTML 4.01. |
| [getIndex](../../com.aspose.html/htmloptionelement/index/) 此 `OPTION` 在其父 `SELECT` 中的索引，从 0 开始。@version DOM Level 2 |
[getInnerHTML]
...
| [getText](../../com.aspose.html/htmloptionelement/text/) 选项元素中包含的文本。 |
