---
title: "HTMLModElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.HTMLModElement 类。文档部分的修改通知。请参阅 HTML 4.01 中的 INS 和 DEL 元素定义。"
type: docs

url: /zh/java/com.aspose.html/htmlmodelement/
---
## HTMLModElement class

文档部分修改的通知。参见 HTML 4.01 中的 INS 和 DEL 元素定义。
