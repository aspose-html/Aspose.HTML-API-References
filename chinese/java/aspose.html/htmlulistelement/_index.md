---
title: "HTMLUListElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.HTMLUListElement 类。无序列表。参见 HTML 4.01 中的 UL 元素定义。"
type: docs

url: /zh/java/com.aspose.html/htmlulistelement/
---
## HTMLUListElement class

无序列表。请参阅 HTML 4.01 中的 UL 元素定义。
