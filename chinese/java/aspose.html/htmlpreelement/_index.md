---
title: "HTMLPreElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.HTMLPreElement 类。预格式化文本。参见 HTML 4.01 中的 PRE 元素定义。"
type: docs

url: /zh/java/com.aspose.html/htmlpreelement/
---
## HTMLPreElement class

预格式化文本。参见 HTML 4.01 中的 PRE 元素定义。
