---
title: "HTMLTableElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.HTMLTableElement 类。表格上的创建和删除方法允许作者构建和修改表格。HTML 4.01 指定表格中每种 CAPTION、THEAD 和 TFOOT 元素只能各出现一次。因此如果已存在且调用 createTHead 或 createTFoot 方法，方法将返回已有的 THead 或 TFoot 元素。参见 HTML 4.01 中的 TABLE 元素定义。"
type: docs

url: /zh/java/com.aspose.html/htmltableelement/
---
## HTMLTableElement class

表格上的 create* 和 delete* 方法允许作者构建和修改表格。[[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224)] 指定在表格中每种 `CAPTION`、`THEAD` 和 `TFOOT` 元素只能出现一次。因此，如果已存在，并调用 createTHead() 或 createTFoot() 方法，方法将返回已有的 THead 或 TFoot 元素。参见 HTML 4.01 中的 TABLE 元素定义。

另请参阅 [Document object Model (DOM) Level 2 HTML Specification](http://www.w3.org/TR/2003/REC-DOM-Level-2-HTML-20030109)。
...
| [getCaption](../../com.aspose.html/htmltableelement/caption/) 返回表格的 `CAPTION`，如果不存在则返回 void。@version DOM Level 2 |
[getCellPadding]
...
| [getRows](../../com.aspose.html/htmltableelement/rows/) 返回表格的 `TFOOT`，如果不存在则返回 `null`。 |
[getRules]
...
| [getTBodies](../../com.aspose.html/htmltableelement/tbodies/) 返回表格主体的集合（包括隐式的）。 |
...
| [getTFoot](../../com.aspose.html/htmltableelement/tfoot/) 返回表格的 `THEAD`，如果不存在则返回 `null`。 |
| [getTHead](../../com.aspose.html/htmltableelement/thead/) 返回表格的 `CAPTION`，如果不存在则返回 void。 |
[getTitle]
...
| [createCaption](../../com.aspose.html/htmltableelement/createcaption/)() | 创建一个新的表格标题对象，或返回已有的对象。 |
| [createTFoot](../../com.aspose.html/htmltableelement/createtfoot/)() | 创建表格页脚行，或返回已有的行。 |
| [createTHead](../../com.aspose.html/htmltableelement/createthead/)() | 创建表格页眉行，或返回已有的行。 |
| [deleteCaption](../../com.aspose.html/htmltableelement/deletecaption/)() | 删除表格标题（如果存在）。 |
| [deleteRow](../../com.aspose.html/htmltableelement/deleterow/)(int) | 删除表格行。 |
| [deleteTFoot](../../com.aspose.html/htmltableelement/deletetfoot/)() | 删除表格的页脚（如果存在）。 |
| [deleteTHead](../../com.aspose.html/htmltableelement/deletethead/)() | 删除表格的页眉（如果存在）。 |
...
| [insertRow](../../com.aspose.html/htmltableelement/insertrow/)(int) | 在表格中插入一个新的空行。新行会立即插入在当前第 `index` 行之前，并位于同一节中。如果 `index` 为 -1 或等于行数，则在表格末尾追加新行。此外，当表格为空时，行会插入到一个新创建并插入表格的 `TBODY` 中。根据 [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224)]，表格行不能为空。 |
