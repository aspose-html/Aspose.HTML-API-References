---
title: "HTMLBodyElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.HTMLBodyElement 类。HTML 文档主体。即使源文档中没有相应标签，此元素在 DOM API 中始终存在。参见 HTML 4.01 中的 BODY 元素定义。"
type: docs

url: /zh/java/com.aspose.html/htmlbodyelement/
---
## HTMLBodyElement class

HTML 文档的 body。即使源文档中没有相应标签，此元素在 DOM API 中始终存在。请参阅 HTML 4.01 中的 BODY 元素定义。
