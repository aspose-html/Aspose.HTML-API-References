---
title: "HTMLLinkElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.HTMLLinkElement 类。LINK 元素指定指向外部资源的链接，并定义此文档与该资源之间的关系，或反之。参见 HTML 4.01 中的 LINK 元素定义，还请参阅 StyleSheet 模块中的 LinkStyle 接口（DOM Level 2 样式表和 CSS）。"
type: docs

url: /zh/java/com.aspose.html/htmllinkelement/
---
## HTMLLinkElement class

`LINK` 元素指定指向外部资源的链接，并定义此文档与该资源之间的关系（或反之）。请参阅 HTML 4.01 中的 LINK 元素定义（另请参阅样式表模块中的 `LinkStyle` 接口 [[DOM Level 2 Style Sheets and CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113)]）。
...
| [getRelList](../../com.aspose.html/htmllinkelement/rellist/) 返回一个实时的 DOMTokenList，其中包含从解析 \"rel\" 属性获得的标记。 |
[getRev]
...
| [getSheet](../../com.aspose.html/htmllinkelement/sheet/) 获取关联的样式表。 |
