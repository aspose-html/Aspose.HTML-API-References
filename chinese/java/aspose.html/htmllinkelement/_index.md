...
description: "com.aspose.html.HTMLLinkElement 类。LINK 元素指定指向外部资源的链接，并定义此文档与该资源之间的关系，或反之。请参阅 HTML 4.01 中的 LINK 元素定义，还请参阅 StyleSheet 模块中的 LinkStyle 接口（DOM Level 2 样式表和 CSS）。"
type: docs
...
`LINK` 元素指定指向外部资源的链接，并定义该文档与该资源之间的关系（或反向关系）。参见 HTML 4.01 中的 LINK 元素定义（另请参见样式表模块中的 `LinkStyle` 接口 [[DOM Level 2 Style Sheets and CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113)]）。
