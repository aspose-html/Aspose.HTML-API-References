---
title: "HTMLSelectElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.HTMLSelectElement 类。select 元素允许选择一个选项。包含的选项可以通过 select 元素作为集合直接访问。请参阅 HTML 4.01 中的 SELECT 元素定义。"
type: docs

url: /zh/java/com.aspose.html/htmlselectelement/
---
## HTMLSelectElement class

select 元素允许选择一个选项。包含的选项可以通过 select 元素作为集合直接访问。参见 HTML 4.01 中的 SELECT 元素定义。
...
| [getForm](../../com.aspose.html/htmlselectelement/form/) 此 `SELECT` 中的选项数量。 |
[getId]
...
| [getOptions](../../com.aspose.html/htmlselectelement/options/) 此元素包含的 `OPTION` 元素集合。 @version DOM Level 2 |
[getOuterHTML]
...
| [getType](../../com.aspose.html/htmlselectelement/type/) 此表单控件的类型。当 multiple 属性为 `true` 时为字符串 "select-multiple"，当为 `false` 时为字符串 "select-one"。 |
[getValue]
