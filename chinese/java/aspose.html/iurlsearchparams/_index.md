...
| [set](../../com.aspose.html/iurlsearchparams/set/)(String, String) | 将找到的第一个名称为指定名称的键值对的值设为指定值，并删除其余的。如果未找到具有指定名称的键值对，则会在列表中追加一个新的键值对。 |
| [sort](../../com.aspose.html/iurlsearchparams/sort/)() | 对所有键值对（如果有）按名称进行排序。 |
