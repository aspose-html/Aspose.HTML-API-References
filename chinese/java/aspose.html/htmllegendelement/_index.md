---
title: "HTMLLegendElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.HTMLLegendElement 类。为 FIELDSET 分组提供标题。参见 HTML 4.01 中的 LEGEND 元素定义。"
type: docs

url: /zh/java/com.aspose.html/htmllegendelement/
---
## HTMLLegendElement class

为 `FIELDSET` 分组提供标题。请参阅 HTML 4.01 中的 LEGEND 元素定义。
...
| [getForm](../../com.aspose.html/htmllegendelement/form/) 返回包含此控件的 `FORM` 元素。如果此控件不在表单上下文中，则返回 `null`。 |
[getId]
