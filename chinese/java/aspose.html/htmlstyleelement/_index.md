...
description: "com.aspose.html.HTMLStyleElement 类。样式信息。请参阅 HTML 4.01 中的 STYLE 元素定义、CSS 模块 DOM Level 2 样式表与 CSS，以及 StyleSheets 模块 DOM Level 2 样式表与 CSS 中的 LinkStyle 接口。"
type: docs
