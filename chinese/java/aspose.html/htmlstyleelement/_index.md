---
title: "HTMLStyleElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.HTMLStyleElement 类。样式信息。参见 HTML 4.01 中的 STYLE 元素定义、CSS 模块 DOM Level 2 样式表与 CSS，以及 StyleSheets 模块 DOM Level 2 样式表中的 LinkStyle 接口。"
type: docs

url: /zh/java/com.aspose.html/htmlstyleelement/
---
## HTMLStyleElement class

样式信息。参见 HTML 4.01 中的 STYLE 元素定义、CSS 模块 [[DOM Level 2 Style Sheets and CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113)]，以及 StyleSheets 模块中的 `LinkStyle` 接口 [[DOM Level 2 Style Sheets and CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113)]。
...
| [getSheet](../../com.aspose.html/htmlstyleelement/sheet/) 获取关联的样式表。 |
