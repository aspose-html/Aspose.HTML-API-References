---
title: "HTMLIsIndexElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.HTMLIsIndexElement 类。此元素用于单行文本输入。参见 HTML 4.01 中的 ISINDEX 元素定义。此元素在 HTML 4.01 中已弃用。"
type: docs

url: /zh/java/com.aspose.html/htmlisindexelement/
---
## HTMLIsIndexElement class

此元素用于单行文本输入。请参阅 HTML 4.01 中的 ISINDEX 元素定义。此元素在 HTML 4.01 中已不推荐使用。
...
| [getForm](../../com.aspose.html/htmlisindexelement/form/) 返回 |
[getId]
