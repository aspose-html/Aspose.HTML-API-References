---
title: "HTMLOListElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.HTMLOListElement 类。有序列表。参见 HTML 4.01 中的 OL 元素定义。"
type: docs

url: /zh/java/com.aspose.html/htmlolistelement/
---
## HTMLOListElement class

有序列表。参见 HTML 4.01 中的 OL 元素定义。
