---
title: "HTMLFieldSetElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.HTMLFieldSetElement 类。将表单控件组织成逻辑组。参见 HTML 4.01 中的 FIELDSET 元素定义"
type: docs

url: /zh/java/com.aspose.html/htmlfieldsetelement/
---
## HTMLFieldSetElement class

将表单控件组织为逻辑组。请参阅 HTML 4.01 中的 FIELDSET 元素定义。
...
| [getForm](../../com.aspose.html/htmlfieldsetelement/form/) 返回包含此控件的 `FORM` 元素。如果此控件不在表单上下文中，则返回 `null`。 |
[getId]
