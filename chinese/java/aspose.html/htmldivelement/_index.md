---
title: "HTMLDivElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.HTMLDivElement 类。通用块容器。参见 HTML 4.01 中的 DIV 元素定义"
type: docs

url: /zh/java/com.aspose.html/htmldivelement/
---
## HTMLDivElement class

通用块容器。请参阅 HTML 4.01 中的 DIV 元素定义。
