...
description: "com.aspose.html.HTMLFontElement 类。对字体的局部更改。参见 HTML 4.01 中的 FONT 元素定义。此元素在 HTML 4.01 中已弃用"
type: docs
...
本地字体更改。参见 HTML 4.01 中的 FONT 元素定义。此元素在 HTML 4.01 中已废弃。
