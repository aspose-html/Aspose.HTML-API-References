---
title: "HTMLFontElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.HTMLFontElement 类。本地字体更改。参见 HTML 4.01 中的 FONT 元素定义。此元素在 HTML 4.01 中已弃用"
type: docs

url: /zh/java/com.aspose.html/htmlfontelement/
---
## HTMLFontElement class

本地字体更改。请参阅 HTML 4.01 中的 FONT 元素定义。此元素在 HTML 4.01 中已不推荐使用。
