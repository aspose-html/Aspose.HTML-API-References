---
title: "HTMLDListElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.HTMLDListElement 类。定义列表。参见 HTML 4.01 中的 DL 元素定义。"
type: docs

url: /zh/java/com.aspose.html/htmldlistelement/
---
## HTMLDListElement class

定义列表。请参阅 HTML 4.01 中的 DL 元素定义。
