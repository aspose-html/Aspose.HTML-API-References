---
title: "HTMLLabelElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.HTMLLabelElement 类。表单字段标签文本。参见 HTML 4.01 中的 LABEL 元素定义。"
type: docs

url: /zh/java/com.aspose.html/htmllabelelement/
---
## HTMLLabelElement class

表单字段标签文本。请参阅 HTML 4.01 中的 LABEL 元素定义。
...
| [getForm](../../com.aspose.html/htmllabelelement/form/) 返回包含此控件的 `FORM` 元素。如果此控件不在表单上下文中，则返回 `null`。 |
[getId]
