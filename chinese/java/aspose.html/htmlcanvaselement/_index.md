---
title: "HTMLCanvasElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.HTMLCanvasElement 类。HTMLCanvasElement 接口提供用于操作 canvas 元素布局和呈现的属性和方法。HTMLCanvasElement 接口还继承了 HTMLElement 接口的属性和方法"
type: docs

url: /zh/java/com.aspose.html/htmlcanvaselement/
---
## HTMLCanvasElement class

HTMLCanvasElement 接口提供用于操作画布元素的布局和呈现的属性和方法。HTMLCanvasElement 接口还继承了 HTMLElement 接口的属性和方法。
...
| [getContext](../../com.aspose.html/htmlcanvaselement/getcontext/)(String) | 返回 canvas 上的绘图上下文，如果不支持该上下文 ID，则返回 null。绘图上下文允许您在 canvas 上绘制。 |
...
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl)() | 返回一个数据 URI，包含按 type 参数指定的格式（默认 PNG）的图像表示。返回的图像分辨率为 96 dpi。 |
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl_1)(String) | 返回一个数据 URI，包含按 type 参数指定的格式（默认 PNG）的图像表示。返回的图像分辨率为 96 dpi。 |
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl_2)(String, double) | 返回一个数据 URI，包含按 type 参数指定的格式（默认 PNG）的图像表示。返回的图像分辨率为 96 dpi。 |
