...
| [getContext](../../com.aspose.html/htmlcanvaselement/getcontext/)(String) | 返回 canvas 上的绘图上下文，如果不支持该上下文 ID，则返回 null。绘图上下文允许您在 canvas 上绘图。 |
...
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl)() | 返回一个数据 URI，其中包含按 type 参数指定的格式（默认为 PNG）的图像表示。返回的图像分辨率为 96 dpi。 |
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl_1)(String) | 返回一个数据 URI，其中包含按 type 参数指定的格式（默认为 PNG）的图像表示。返回的图像分辨率为 96 dpi。 |
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl_2)(String, double) | 返回一个数据 URI，其中包含按 type 参数指定的格式（默认为 PNG）的图像表示。返回的图像分辨率为 96 dpi。 |
