---
title: "HTMLDirectoryElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.HTMLDirectoryElement 类。目录列表。请参阅 HTML 4.01 中的 DIR 元素定义。此元素在 HTML 4.01 中已弃用。"
type: docs

url: /zh/java/com.aspose.html/htmldirectoryelement/
---
## HTMLDirectoryElement class

目录列表。请参阅 HTML 4.01 中的 DIR 元素定义。此元素在 HTML 4.01 中已不推荐使用。
