---
title: "HTMLButtonElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.HTMLButtonElement 类。按钮。参见 HTML 4.01 中的 BUTTON 元素定义"
type: docs

url: /zh/java/com.aspose.html/htmlbuttonelement/
---
## HTMLButtonElement class

按钮。请参阅 HTML 4.01 中的 BUTTON 元素定义。
...
| [getForm](../../com.aspose.html/htmlbuttonelement/form/) 返回包含此控件的 `FORM` 元素。如果此控件不在表单上下文中，则返回 `null`。 |
[getId]
