---
title: "HTMLMenuElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.HTMLMenuElement 类。菜单列表。参见 HTML 4.01 中的 MENU 元素定义。此元素在 HTML 4.01 中已弃用"
type: docs

url: /zh/java/com.aspose.html/htmlmenuelement/
---
## HTMLMenuElement class

菜单列表。参见 HTML 4.01 中的 MENU 元素定义。此元素在 HTML 4.01 中已弃用。
