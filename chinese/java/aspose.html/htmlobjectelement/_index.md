...
description: "com.aspose.html.HTMLObjectElement 类。通用嵌入对象。原则上，对象元素的所有属性都是读写的，但在某些环境中，一旦底层对象实例化，某些属性可能变为只读。参见 HTML 4.01 中的 OBJECT 元素定义。"
type: docs
...
通用嵌入对象。原则上，object 元素的所有属性都是可读写的，但在某些环境中，一旦底层对象实例化，某些属性可能变为只读。参见 [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224)] 中的 OBJECT 元素定义。
