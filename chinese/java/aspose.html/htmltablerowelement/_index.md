---
title: "HTMLTableRowElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.HTMLTableRowElement 类。表格中的一行。参见 HTML 4.01 中的 TR 元素定义"
type: docs

url: /zh/java/com.aspose.html/htmltablerowelement/
---
## HTMLTableRowElement class

表格中的一行。参见 HTML 4.01 中的 TR 元素定义。
...
| [getCells](../../com.aspose.html/htmltablerowelement/cells/) 此行中单元格的集合。@version DOM Level 2 |
[getCh]
...
| [getRowIndex](../../com.aspose.html/htmltablerowelement/rowindex/) 这是按逻辑顺序而非文档顺序。`rowIndex` 会考虑表格中的章节（`THEAD`、`TFOOT` 或 `TBODY`），在索引中先放置 `THEAD` 行，其次是 `TBODY` 行，最后是 `TFOOT` 行。@version DOM Level 2 |
| [getSectionRowIndex](../../com.aspose.html/htmltablerowelement/sectionrowindex/) 此行相对于当前章节（`THEAD`、`TFOOT` 或 `TBODY`）的索引，从 0 开始。@version DOM Level 2 |
...
| [deleteCell](../../com.aspose.html/htmltablerowelement/deletecell/)(int) | 从当前行删除一个单元格。 |
...
| [insertCell](../../com.aspose.html/htmltablerowelement/insertcell/)(int) | 在此行插入一个空的 `TD` 单元格。如果 `index` 为 -1 或等于单元格数量，则在末尾追加新单元格。 |
