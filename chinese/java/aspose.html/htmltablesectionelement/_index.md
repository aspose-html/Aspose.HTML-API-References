---
title: "HTMLTableSectionElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.HTMLTableSectionElement 类。THEAD、TFOOT 和 TBODY 元素。"
type: docs

url: /zh/java/com.aspose.html/htmltablesectionelement/
---
...
| [getRows](../../com.aspose.html/htmltablesectionelement/rows/) 此表节中的行集合。 |
...
| [deleteRow](../../com.aspose.html/htmltablesectionelement/deleterow/)(int) | 删除此节中的一行。 |
...
| [insertRow](../../com.aspose.html/htmltablesectionelement/insertrow/)(int) | 在此节中插入一行。新行会立即插入到当前第 `index` 行之前。如果 `index` 为 -1 或等于此节中的行数，则在末尾追加新行。 |
