...
description: "com.aspose.html.Configuration 类。表示用于为应用程序设置环境配置的上下文对象。通过管理配置，您可以覆盖文档样式，应用自定义用户样式表，或处理来自应用程序的任何网络请求，并配置脚本策略。详细信息请参阅《环境配置指南》。"
type: docs
...
表示用于为应用程序设置环境配置的上下文对象。通过管理配置，您可以覆盖文档样式，应用自定义用户样式表，或处理来自应用程序的任何 Web 请求，并配置脚本策略。详细信息请参阅 [Environment Configuration guide](https://docs.aspose.com/html/net/working-with-documents/environment-configuration/)。
...
| [dispose](../../com.aspose.html/configuration/dispose/)() | 执行由应用程序定义的任务，以释放、解除占用或重置非托管资源。 |
