---
title: "HTMLFrameSetElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.HTMLFrameSetElement 类。创建帧网格。参见 HTML 4.01 中的 FRAMESET 元素定义。"
type: docs

url: /zh/java/com.aspose.html/htmlframesetelement/
---
## HTMLFrameSetElement class

创建一个框架网格。请参阅 HTML 4.01 中的 FRAMESET 元素定义。
