---
title: "HTMLDocument 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.HTMLDocument 类。表示一个 HTML 文档。所有顶层 HTML 对象都会添加到此对象中。该类将 HTML 页面表示为我们在浏览器中看到的页面。所有表单、表格、脚本等都通过该类的接口添加到 HTML 页面。HTMLDocument 是最通用的 Document 接口的 HTML 实现，两者都是 DOM（文档对象模型）的核心或根节点。这些概念完全符合官方的网页开发基础或标准。就网页开发而言，通常可以将 HTMLDocument 视为基于 Document 的别名。"
type: docs

url: /zh/java/com.aspose.html/htmldocument/
---
## HTMLDocument class

表示一个 HTML 文档。所有顶层 HTML 对象都会添加到此对象中。此类表示我们在浏览器中看到的 HTML 页面。所有表单、表格、脚本等都通过此类的接口添加到 HTML 页面中。[HTMLDocument](https://dom.spec.whatwg.org/#ref-for-dom-domimplementation-createhtmldocument) 是最通用的 [Document](https://dom.spec.whatwg.org/#document) 接口的 HTML 实现，两者都是 [DOM](https://dom.spec.whatwg.org/)（文档对象模型）的核心或根点。这些概念完全符合官方的网页开发基础或标准。出于网页开发的目的，通常可以将 HTMLDocument 视为 Document 的别名，HTMLDocument 基于 Document。
...
| 名称 | 描述 |
| --- | --- |
| [HTMLDocument](htmldocument/#constructor)() | HTMLDocument 构造函数创建一个新的 HTML 文档对象，该对象是加载在浏览器中的网页，并作为页面内容的入口点。 |
| [HTMLDocument](htmldocument/#constructor_1)(Configuration) | HTMLDocument 构造函数创建一个新的 HTML 文档对象，该对象是加载在浏览器中的网页，并作为页面内容的入口点。 |
| [HTMLDocument](htmldocument/#constructor_2)(RequestMessage) | 从 [`RequestMessage`](../../com.aspose.html.net/requestmessage/) 对象创建 HTML 文档。 |
| [HTMLDocument](htmldocument/#constructor_10)(String) | 从地址加载 HTML 文档。 |
| [HTMLDocument](htmldocument/#constructor_4)(Url) | 从 URL 加载 HTML 文档。 |
| [HTMLDocument](htmldocument/#constructor_3)(RequestMessage, Configuration) | 从 [RequestMessage](T:com.aspose.html.net.RequestMessage) 对象创建 HTML 文档。 |
| [HTMLDocument](htmldocument/#constructor_8)(Stream, String) | 从指定 base-uri 的 [Stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream) 内容创建 HTML 文档，该 base-uri 用于解析相对资源的路径。 |
| [HTMLDocument](htmldocument/#constructor_6)(Stream, Url) | 从指定 base-uri 的 [Stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream) 内容创建 HTML 文档，该 base-uri 用于解析相对资源的路径。 |
| [HTMLDocument](htmldocument/#constructor_11)(String, Configuration) | 使用指定的环境配置设置从地址加载 HTML 文档。 |
| [HTMLDocument](htmldocument/#constructor_14)(String, String) | 使用指定的 base-uri 从字符串内容创建 HTML 文档。 |
| [HTMLDocument](htmldocument/#constructor_12)(String, Url) | 使用指定的 base-uri 从字符串内容创建 HTML 文档。 |
| [HTMLDocument](htmldocument/#constructor_5)(Url, Configuration) | 使用指定的环境配置设置从 URL 加载 HTML 文档。 |
| [HTMLDocument](htmldocument/#constructor_9)(Stream, String, Configuration) | 使用指定的 base-uri 和环境配置设置，从 [Stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream) 内容创建 HTML 文档。 |
| [HTMLDocument](htmldocument/#constructor_7)(Stream, Url, Configuration) | 使用指定的 base-uri 和环境配置设置，从 [Stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream) 内容创建 HTML 文档。 |
| [HTMLDocument](htmldocument/#constructor_15)(String, String, Configuration) | 使用指定的 base-uri 和环境配置设置，从字符串内容创建 HTML 文档。 |
| [HTMLDocument](htmldocument/#constructor_13)(String, Url, Configuration) | 使用指定的 base-uri 和环境配置设置，从字符串内容创建 HTML 文档。 |

## 属性

| 名称 | 描述 |
| --- | --- |
| [getAnchors](../../com.aspose.html/htmldocument/anchors/) 文档中所有具有 `name` 属性值的锚点（`A`）元素的集合。出于向后兼容的考虑，返回的锚点集合仅包含使用 `name` 属性创建的锚点，而不包括使用 `id` 属性创建的锚点。请注意，在 [[XHTML 1.0](http://www.w3.org/TR/2002/REC-xhtml1-20020801)] 中，`name` 属性（参见第 4.10 节）没有语义，仅为旧版用户代理保留：应使用 `id` 属性。用户应优先使用 [[DOM Level 2 Traversal](http://www.w3.org/TR/2000/REC-DOM-Level-2-Traversal-Range-20001113)] 提供的迭代器机制。 |
| [getApplets](../../com.aspose.html/htmldocument/applets/) 文档中包含小程序的所有 `OBJECT` 元素以及 `APPLET`（已弃用）元素的集合。 |
...
| [getDomain](../../com.aspose.html/htmldocument/domain/) 提供文档的服务器的域名，如果无法通过域名识别服务器，则为 `null`。 |
...
| [getForms](../../com.aspose.html/htmldocument/forms/) 文档中所有表单的集合。 |
| [getImages](../../com.aspose.html/htmldocument/images/) 文档中所有 `IMG` 元素的集合。出于向后兼容的考虑，行为仅限于 `IMG` 元素。正如 [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224)] 所建议的，为了包含图像，作者可以使用 `OBJECT` 元素或 `IMG` 元素。因此，建议不要使用此属性来查找文档中的图像，而是使用 HTML 4.01 的 `getElementsByTagName` 或 XHTML 1.0 的 `getElementsByTagNameNS`。 |
...
| [getLinks](../../com.aspose.html/htmldocument/links/) 文档中所有具有 `href` 属性值的 `AREA` 元素和锚点（`A`）元素的集合。 |
| [getLocalName](../../com.aspose.html.dom/node/localname/) 返回此节点的限定名称的本地部分。对于除 [`ELEMENT_NODE`](../../com.aspose.html.dom/node/element_node/) 和 [`ATTRIBUTE_NODE`](../../com.aspose.html.dom/node/attribute_node/) 之外的任何类型的节点，以及使用 DOM Level 1 方法创建的节点，例如 [`Document.createElement()`](../../com.aspose.html.dom/document/createelement/)，此值始终为 null。 |
...
| [getReferrer](../../com.aspose.html/htmldocument/referrer/) 返回链接到此页面的页面的 URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt)]。如果用户直接访问页面（不是通过链接，而是例如通过书签），则该值为空字符串。 |
...
| [textContent](../../com.aspose.html.dom/node/textcontent/) { get; set; } | [`Node`](../../com.aspose.html.dom/node/) 接口的 textContent 属性表示节点及其后代的文本内容。 |
[getTitle]
...
| [createAttribute](../../com.aspose.html.dom/document/createattribute/)(String) | Document.createAttribute() 方法创建一个新的属性节点并返回它。创建的对象是实现了 [`Attr`](../../com.aspose.html.dom/attr/) 接口的节点。DOM 并不强制规定可以以这种方式添加到特定元素的属性类型。 |
...
| [createDocumentFragment](../../com.aspose.html.dom/document/createdocumentfragment/)() | 创建一个新的空的 [`DocumentFragment`](../../com.aspose.html.dom/documentfragment/) ，可以向其中添加 DOM 节点以构建离屏 DOM 树。 |
...
| [createElement](../../com.aspose.html.dom/document/createelement/)(String) | 在 HTML 文档中，document.createElement() 方法创建由 tagName 指定的 HTML 元素，如果 tagName 未被识别，则返回一个 [`HTMLUnknownElement`](../htmlunknownelement/)。 |
...
| [createNodeIterator](../../com.aspose.html.dom/document/createnodeiterator/)(Node) | 在指定节点为根的子树上创建一个新的 NodeIterator。 |
| [createNodeIterator](../../com.aspose.html.dom/document/createnodeiterator/)(Node, long) | 在指定节点为根的子树上创建一个新的 NodeIterator。 |
| [createNodeIterator](../../com.aspose.html.dom/document/createnodeiterator/)(Node, long, INodeFilter) | 在指定节点为根的子树上创建一个新的 NodeIterator。 |
...
| [createTreeWalker](../../com.aspose.html.dom/document/createtreewalker/)(Node) | 在指定节点为根的子树上创建一个新的 TreeWalker。 |
| [createTreeWalker](../../com.aspose.html.dom/document/createtreewalker/)(Node, long) | 在指定节点为根的子树上创建一个新的 TreeWalker。 |
| [createTreeWalker](../../com.aspose.html.dom/document/createtreewalker/)(Node, long, INodeFilter) | 在指定节点为根的子树上创建一个新的 TreeWalker。 |
...
| [getElementById](../../com.aspose.html.dom/document/getelementbyid/)(String) | Document 方法 getElementById() 返回一个表示其 id 属性与指定字符串匹配的元素的 [`Element`](../../com.aspose.html.dom/element/) 对象。由于元素 ID（如果指定）必须唯一，它们是快速访问特定元素的有用方式。 |
| [getElementsByClassName](../../com.aspose.html.dom/document/getelementsbyclassname/)(String) | [`Document`](../../com.aspose.html.dom/document/) 接口的 getElementsByClassName 方法返回一个类数组对象，包含所有具有给定类名的子元素。 |
| [getElementsByTagName](../../com.aspose.html.dom/document/getelementsbytagname/)(String) | [`Document`](../../com.aspose.html.dom/document/) 接口的 getElementsByTagName 方法返回一个包含具有给定标签名的元素的 [`HTMLCollection`](../../com.aspose.html.collections/htmlcollection/)。 |
...
| [getOverrideStyle](../../com.aspose.html/htmldocument/getoverridestyle/)(Element, String) | 此方法用于检索指定元素和指定伪元素的覆盖样式声明。 |
...
| [navigate](../../com.aspose.html.dom/document/navigate/)(Stream, String) | 从指定内容加载文档并使用 baseUri 解析相对资源，替换先前的内容。文档加载从流中的当前位置开始。 |
| [navigate](../../com.aspose.html.dom/document/navigate/)(Stream, Url) | 从指定内容加载文档并使用 baseUri 解析相对资源，替换先前的内容。文档加载从流中的当前位置开始。 |
| [navigate](../../com.aspose.html.dom/document/navigate/)(String, String) | 从指定内容加载文档并使用 baseUri 解析相对资源，替换先前的内容。 |
| [navigate](../../com.aspose.html.dom/document/navigate/)(String, Url) | 从指定内容加载文档并使用 baseUri 解析相对资源，替换先前的内容。 |
...
| [renderTo](../../com.aspose.html/htmldocument/renderto/)(IDevice) | 此方法用于将当前文档的内容打印到指定设备。 |
...
| [save](../../com.aspose.html/htmldocument/save/#save)(ResourceHandler) | 使用 [`ResourceHandler`](../../com.aspose.html.saving.resourcehandlers/resourcehandler/) 保存文档内容和资源。 |
| [save](../../com.aspose.html/htmldocument/save/#save_10)(String) | 将文档保存到由路径指定的本地文件。文档中使用的所有资源将保存到相邻的文件夹中，文件夹名称将构建为：output_file_name + \"_files\"。 |
| [save](../../com.aspose.html/htmldocument/save/#save_5)(Url) | 将文档保存到由 url 指定的本地文件。此文档使用的所有资源将保存到相邻的文件夹中，文件夹名称将构建为 output_file_name + "_files"。 |
| [save](../../com.aspose.html/htmldocument/save/#save_1)(ResourceHandler, HTMLSaveFormat) | 使用 [`ResourceHandler`](../../com.aspose.html.saving.resourcehandlers/resourcehandler/) 保存文档内容和资源。 |
| [save](../../com.aspose.html/htmldocument/save/#save_2)(ResourceHandler, HTMLSaveOptions) | 使用 [`ResourceHandler`](../../com.aspose.html.saving.resourcehandlers/resourcehandler/) 保存文档内容和资源。 |
| [save](../../com.aspose.html/htmldocument/save/#save_3)(ResourceHandler, MarkdownSaveOptions) | 使用 [`ResourceHandler`](../../com.aspose.html.saving.resourcehandlers/resourcehandler/) 保存文档内容和资源。 |
| [save](../../com.aspose.html/htmldocument/save/#save_4)(ResourceHandler, MHTMLSaveOptions) | 使用 [`ResourceHandler`](../../com.aspose.html.saving.resourcehandlers/resourcehandler/) 保存文档内容和资源。 |
| [save](../../com.aspose.html/htmldocument/save/#save_11)(String, HTMLSaveFormat) | 将文档保存到由路径指定的本地文件。此文档使用的所有资源将保存到相邻的文件夹中，文件夹名称将构建为 output_file_name + "_files"。 |
| [save](../../com.aspose.html/htmldocument/save/#save_12)(String, HTMLSaveOptions) | 将文档保存到由路径指定的本地文件。文档中使用的所有资源将保存到相邻的文件夹中，文件夹名称将构建为：output_file_name + \"_files\"。 |
| [save](../../com.aspose.html/htmldocument/save/#save_13)(String, MarkdownSaveOptions) | 将文档保存到由路径指定的本地文件。文档中使用的所有资源将保存到相邻的文件夹中，文件夹名称将构建为：output_file_name + \"_files\"。 |
| [save](../../com.aspose.html/htmldocument/save/#save_14)(String, MHTMLSaveOptions) | 将文档保存到由路径指定的本地文件。文档中使用的所有资源将保存到相邻的文件夹中，文件夹名称将构建为：output_file_name + \"_files\"。 |
| [save](../../com.aspose.html/htmldocument/save/#save_6)(Url, HTMLSaveFormat) | 将文档保存到由 url 指定的本地文件。此文档使用的所有资源将保存到相邻的文件夹中，文件夹名称将构建为 output_file_name + "_files"。 |
| [save](../../com.aspose.html/htmldocument/save/#save_7)(Url, HTMLSaveOptions) | 将文档保存到由 url 指定的本地文件。此文档使用的所有资源将保存到相邻的文件夹中，文件夹名称将构建为：output_file_name + "_files"。 |
| [save](../../com.aspose.html/htmldocument/save/#save_8)(Url, MarkdownSaveOptions) | 将文档保存到由 url 指定的本地文件。此文档使用的所有资源将保存到相邻的文件夹中，文件夹名称将构建为：output_file_name + "_files"。 |
| [save](../../com.aspose.html/htmldocument/save/#save_9)(Url, MHTMLSaveOptions) | 将文档保存到由 url 指定的本地文件。此文档使用的所有资源将保存到相邻的文件夹中，文件夹名称将构建为：output_file_name + "_files"。 |
...
关于 HTMLDocument、Document 和 DOM 的更多信息可在流行的 Web 开发资源中获取：
...
```java
	...
	using (var document = new HTMLDocument())
      {
        // 创建一个 style 元素，并为所有 class-name 等于 'gr' 的元素分配绿色。
        var style = document.CreateElement("style");
        style.TextContent = ".gr { color: green }";

        // 查找文档的 header 元素并将 style 元素追加到 header 中
        var head = document.GetElementsByTagName("head").First();
        head.AppendChild(style);

        // 创建一个 class-name 为 'gr' 的段落元素。
