---
title: "HTMLImageElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.HTMLImageElement 类。嵌入式图像。请参阅 HTML 4.01 中的 IMG 元素定义。"
type: docs

url: /zh/java/com.aspose.html/htmlimageelement/
---
## HTMLImageElement class

嵌入式图像。请参阅 HTML 4.01 中的 IMG 元素定义。
