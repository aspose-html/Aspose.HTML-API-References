---
title: "HTMLOptGroupElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.HTMLOptGroupElement 类。将选项分组为逻辑子区块。参见 HTML 4.01 中的 OPTGROUP 元素定义"
type: docs

url: /zh/java/com.aspose.html/htmloptgroupelement/
---
## HTMLOptGroupElement class

将选项分组为逻辑子区段。参见 HTML 4.01 中的 OPTGROUP 元素定义。
