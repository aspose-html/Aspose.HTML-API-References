---
title: "HTMLHeadingElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.HTMLHeadingElement 类。用于 H1 到 H6 元素。参见 HTML 4.01 中的 H1 元素定义。"
type: docs

url: /zh/java/com.aspose.html/htmlheadingelement/
---
## HTMLHeadingElement class

适用于 `H1` 到 `H6` 元素。请参阅 HTML 4.01 中的 H1 元素定义。
