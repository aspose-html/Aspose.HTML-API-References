---
title: "HTMLDataListElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.HTMLDataListElement 类。datalist 元素表示一组 option 元素，用于为其他控件提供预定义选项。另请参见 HTML 5.2 W3C 推荐规范。"
type: docs

url: /zh/java/com.aspose.html/htmldatalistelement/
---
## HTMLDataListElement class

datalist 元素表示一组用于其他控件的预定义选项。另请参阅 [HTML 5.2 W3C Recommendation](https://www.w3.org/TR/html52/sec-forms.html#elementdef-datalist)。
...
| [getOptions](../../com.aspose.html/htmldatalistelement/options/) 此元素包含的 `OPTION` 元素集合。 |
[getOuterHTML]
