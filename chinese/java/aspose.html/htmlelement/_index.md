...
description: "com.aspose.html.HTMLElement 类。所有 HTML 元素接口都派生自此类。仅暴露 HTML 核心属性的元素由基础 HTMLElement 接口表示。这些元素包括特殊的 SUB、SUP、SPAN、BDO、font、TT、I、B、U、S、STRIKE、BIG、SMALL、phrase、EM、STRONG、DFN、CODE、SAMP、KBD、VAR、CITE、ACRONYM、ABBR、list、DD、DT、NOFRAMES、NOSCRIPT、ADDRESS、CENTER。HTML 元素的 style 属性可通过在 CSS 模块 DOM Level 2 Style Sheets and CSS 中定义的 ElementCSSInlineStyle 接口访问。"
type: docs
...
所有 HTML 元素接口都派生自此类。仅暴露 HTML 核心属性的元素由基础 `HTMLElement` 接口表示。这些元素如下：special: SUB、SUP、SPAN、BDO；font: TT、I、B、U、S、STRIKE、BIG、SMALL；phrase: EM、STRONG、DFN、CODE、SAMP、KBD、VAR、CITE、ACRONYM、ABBR；list: DD、DT、NOFRAMES、NOSCRIPT、ADDRESS、CENTER。HTML 元素的 `style` 属性可通过在 CSS 模块中定义的 `ElementCSSInlineStyle` 接口访问，详见 [[DOM Level 2 Style Sheets and CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113)]。
