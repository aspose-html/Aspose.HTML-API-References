---
title: "HTMLFormElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.HTMLFormElement 类。FORM 元素的行为类似于集合和元素。它提供对包含的表单控件以及表单元素属性的直接访问。请参阅 HTML 4.01 中的 FORM 元素定义。"
type: docs

url: /zh/java/com.aspose.html/htmlformelement/
---
## HTMLFormElement class

`FORM` 元素具有类似集合和元素的行为。它提供对包含的表单控件以及表单元素属性的直接访问。请参阅 HTML 4.01 中的 FORM 元素定义。
...
| [getElements](../../com.aspose.html/htmlformelement/elements/) 返回表单中所有表单控件元素的集合。 |
[getEnctype]
...
| [getLength](../../com.aspose.html/htmlformelement/length/) 表单中表单控件的数量。 |
...
| [reset](../../com.aspose.html/htmlformelement/reset/)() | 恢复表单元素的默认值。其行为与重置按钮相同。 |
...
| [submit](../../com.aspose.html/htmlformelement/submit/)() | 提交表单。其行为与提交按钮相同。 |
