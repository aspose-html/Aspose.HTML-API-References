---
title: "HTMLFrameElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.HTMLFrameElement 类。创建一个框架。参见 HTML 4.01 中的 FRAME 元素定义"
type: docs

url: /zh/java/com.aspose.html/htmlframeelement/
---
## HTMLFrameElement class

创建一个框架。请参阅 HTML 4.01 中的 FRAME 元素定义。
...
| [getContentDocument](../../com.aspose.html/htmlframeelement/contentdocument/) 此框架包含的文档（如果存在且可用），否则为 `null`。@since DOM Level 2 |
[getDir]
