---
title: "HTMLTableCellElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.HTMLTableCellElement 类。用于表示 TH 和 TD 元素的对象。参见 HTML 4.01 中的 TD 元素定义。"
type: docs

url: /zh/java/com.aspose.html/htmltablecellelement/
---
## HTMLTableCellElement class

用于表示 `TH` 和 `TD` 元素的对象。参见 HTML 4.01 中的 TD 元素定义。
...
| [getCellIndex](../../com.aspose.html/htmltablecellelement/cellindex/) 此单元格在行中的索引，从 0 开始。该索引遵循文档树顺序，而非显示顺序。 |
[getCh]
