...
description: "com.aspose.html.HTMLBaseElement 类。文档基础 URI 符合 IETF RFC 2396。参见 HTML 4.01 中的 BASE 元素定义"
type: docs
...
该文档基础 URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt)]。请参阅 HTML 4.01 中的 BASE 元素定义。
