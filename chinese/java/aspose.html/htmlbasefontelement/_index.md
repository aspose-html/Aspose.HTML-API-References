---
title: "HTMLBaseFontElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.HTMLBaseFontElement 类。基础字体。参见 HTML 4.01 中的 BASEFONT 元素定义。此元素在 HTML 4.01 中已弃用。"
type: docs

url: /zh/java/com.aspose.html/htmlbasefontelement/
---
## HTMLBaseFontElement class

基础字体。请参阅 HTML 4.01 中的 BASEFONT 元素定义。此元素在 HTML 4.01 中已弃用。
