---
title: "HTMLParamElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.HTMLParamElement 类。提供给 OBJECT 元素的参数。参见 HTML 4.01 中的 PARAM 元素定义"
type: docs

url: /zh/java/com.aspose.html/htmlparamelement/
---
## HTMLParamElement class

提供给 `OBJECT` 元素的参数。参见 HTML 4.01 中的 PARAM 元素定义。
