...
另请参阅 [文档对象模型 (DOM) 第 2 级 HTML 规范](http://www.w3.org/TR/2003/REC-DOM-Level-2-HTML-20030109)。@since DOM Level 2
...
| 名称 | 描述 |
| --- | --- |
| [namedItem](../../com.aspose.html/ihtmloptionscollection/nameditem/)(String) | 方法返回集合中第 index 项。http://www.w3.org/TR/DOM-Level-2-HTML/html.html#HTMLOptionsCollection-namedItem |
