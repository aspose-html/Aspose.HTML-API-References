---
title: "HTMLMetaElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.HTMLMetaElement 类。它包含文档的通用元信息。参见 HTML 4.01 中的 META 元素定义。"
type: docs

url: /zh/java/com.aspose.html/htmlmetaelement/
---
## HTMLMetaElement class

此包含文档的通用元信息。参见 HTML 4.01 中的 META 元素定义。
