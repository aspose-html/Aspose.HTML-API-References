...
description: "com.aspose.html.rendering.image.ImageRenderingOptions 类。表示用于 ImageDevice 的渲染选项。此选项用于指定输出图像格式、压缩、分辨率等"
type: docs
...
表示用于 [`ImageDevice`](../imagedevice/) 的渲染选项。此选项用于指定输出图像格式、压缩、分辨率等。
...
| [getText](../../com.aspose.html.rendering.image/imagerenderingoptions/text/) 获取用于文本渲染配置的 [`TextOptions`](../textoptions/) 对象。 |
[getUseAntialiasing]
