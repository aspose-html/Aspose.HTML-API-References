---
title: "SVGFECompositeElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.dom.svg.filters.SVGFECompositeElement 类。SVGFECompositeElement 接口对应 feComposite 元素"
type: docs

url: /zh/java/com.aspose.html.dom.svg.filters/svgfecompositeelement/
---
## SVGFECompositeElement class

该 SVGFECompositeElement 接口对应 ‘feComposite’ 元素。
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/height/) 对应给定 ‘filter’ 元素上的属性 ‘height’。 |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/in1/) 对应给定 ‘feComposite’ 元素上的属性 ‘in’。 |
| [getIn2](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/in2/) 对应给定 ‘feComposite’ 元素上的属性 ‘in2’。 |
[getInnerHTML]
...
| [getK1](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k1/) 对应给定 ‘feComposite’ 元素上的属性 ‘k1’。 |
| [getK2](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k2/) 对应给定 ‘feComposite’ 元素上的属性 ‘k2’。 |
| [getK3](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k3/) 对应给定 ‘feComposite’ 元素上的属性 ‘k3’。 |
| [getK4](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k4/) 对应给定 ‘feComposite’ 元素上的属性 ‘k4’。 |
...
| [getOperator](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/operator/) 对应给定 ‘feComposite’ 元素上的属性 ‘operator’。接受此接口中定义的 SVG_FECOMPOSITE_OPERATOR_* 常量之一。 |
[getOuterHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/result/) 对应给定 ‘filter’ 元素上的属性 ‘result’。 |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/width/) 对应给定 ‘filter’ 元素上的属性 ‘width’。 |
| [X](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/x/) { get; } | 对应给定 ‘filter’ 元素的 ‘x’ 属性。 |
| [Y](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/y/) { get; } | 对应给定 ‘filter’ 元素的 ‘y’ 属性。 |
...
| 名称 | 描述 |
| --- | --- |
| const [SVG_FECOMPOSITE_OPERATOR_ARITHMETIC](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_arithmetic/) | 对应值 'arithmetic'。 |
| const [SVG_FECOMPOSITE_OPERATOR_ATOP](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_atop/) | 对应值 'atop'。 |
| const [SVG_FECOMPOSITE_OPERATOR_IN](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_in/) | 对应值 'in'。 |
| const [SVG_FECOMPOSITE_OPERATOR_OUT](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_out/) | 对应值 'out'。 |
| const [SVG_FECOMPOSITE_OPERATOR_OVER](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_over/) | 对应值 'over'。 |
| const [SVG_FECOMPOSITE_OPERATOR_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_unknown/) | 该类型不是预定义类型之一。尝试定义此类型的新值或尝试将现有值切换到此类型都是无效的。 |
| const [SVG_FECOMPOSITE_OPERATOR_XOR](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_xor/) | 对应值 'xor'。 |
