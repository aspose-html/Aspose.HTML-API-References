---
title: "SVGFEGaussianBlurElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.dom.svg.filters.SVGFEGaussianBlurElement 类。SVGFEGaussianBlurElement 接口对应于 feGaussianBlur 元素"
type: docs

url: /zh/java/com.aspose.html.dom.svg.filters/svgfegaussianblurelement/
---
## SVGFEGaussianBlurElement class

该 SVGFEGaussianBlurElement 接口对应 �feGaussianBlur� 元素。
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/height/) 对应于给定 �filter� 元素的属性 �height�。 |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/in1/) 对应于给定 �feGaussianBlur� 元素的属性 �in�。 |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/result/) 对应于给定 �filter� 元素的属性 �result�。 |
| [getShadowRoot](../../com.aspose.html.dom/element/shadowroot/) 返回存储在此元素上的 shadowRoot，如果它已关闭则为 null。 |
| [getStdDeviationX](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/stddeviationx/) 对应于给定 �feGaussianBlur� 元素的属性 �stdDeviation�。包含属性 �stdDeviation� 的 X 分量。 |
| [getStdDeviationY](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/stddeviationy/) 对应于给定 �feGaussianBlur� 元素的属性 �stdDeviation�。包含属性 �stdDeviation� 的 Y 分量（可能自动计算）。 |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/width/) 对应于给定 �filter� 元素的属性 �width�。 |
| [X](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/x/) { get; } | 对应于给定 �filter� 元素的属性 �x�。 |
| [Y](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/y/) { get; } | 对应于给定 �filter� 元素的属性 �y�。 |
...
| [setStdDeviation](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/setstddeviation/)(float, float) | 设置属性 �stdDeviation� 的值。 |
