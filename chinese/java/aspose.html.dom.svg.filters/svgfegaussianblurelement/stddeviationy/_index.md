...
description: "SVGFEGaussianBlurElement 属性。对应于给定 feGaussianBlur 元素上的属性 stdDeviation。包含属性 stdDeviation 的 Y 分量（可能自动计算）。"
type: docs

url: /zh/java/com.aspose.html.dom.svg.filters/svgfegaussianblurelement/stddeviationy/
---
