---
title: "SVGFEDisplacementMapElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.dom.svg.filters.SVGFEDisplacementMapElement 类。SVGFEDisplacementMapElement 接口对应于 feDisplacementMap 元素"
type: docs

url: /zh/java/com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/
---
## SVGFEDisplacementMapElement class

该 SVGFEDisplacementMapElement 接口对应 ‘feDisplacementMap’ 元素。
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/height/) 对应于给定 ‘filter’ 元素的属性 ‘height’。 |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/in1/) 对应于给定 ‘feDisplacementMap’ 元素的属性 ‘in’。 |
| [getIn2](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/in2/) 对应于给定 ‘feDisplacementMap’ 元素的属性 ‘in2’。 |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/result/) 对应于给定 ‘filter’ 元素的属性 ‘result’。 |
| [getScale](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/scale/) 对应于给定 ‘feDisplacementMap’ 元素的属性 ‘scale’。 |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/width/) 对应于给定 ‘filter’ 元素的属性 ‘width’。 |
| [X](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/x/) { get; } | 对应给定 ‘filter’ 元素的 ‘x’ 属性。 |
| [getXChannelSelector](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/xchannelselector/) 对应于给定 ‘feDisplacementMap’ 元素的属性 ‘xChannelSelector’。接受此接口上定义的 SVG_CHANNEL_* 常量之一。 |
| [Y](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/y/) { get; } | 对应给定 ‘filter’ 元素的 ‘y’ 属性。 |
| [getYChannelSelector](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/ychannelselector/) 对应于给定 ‘feDisplacementMap’ 元素上的属性 ‘yChannelSelector’。接受此接口上定义的 SVG_CHANNEL_* 常量之一。 |
...
| 名称 | 描述 |
| --- | --- |
| const [SVG_CHANNEL_A](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_a/) | 对应于值 'A'。 |
| const [SVG_CHANNEL_B](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_b/) | 对应于值 'B'。 |
| const [SVG_CHANNEL_G](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_g/) | 对应于值 'G'。 |
| const [SVG_CHANNEL_R](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_r/) | 对应于值 'R'。 |
| const [SVG_CHANNEL_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_unknown/) | 该类型不是预定义类型之一。尝试定义此类型的新值或尝试将现有值切换到此类型都是无效的。 |
