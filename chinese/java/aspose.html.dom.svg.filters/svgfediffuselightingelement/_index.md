---
title: "SVGFEDiffuseLightingElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.dom.svg.filters.SVGFEDiffuseLightingElement 类。SVGFEDiffuseLightingElement 接口对应于 feDiffuseLighting 元素。"
type: docs

url: /zh/java/com.aspose.html.dom.svg.filters/svgfediffuselightingelement/
---
## SVGFEDiffuseLightingElement class

该 SVGFEDiffuseLightingElement 接口对应 ‘feDiffuseLighting’ 元素。
...
| [getDiffuseConstant](../../com.aspose.html.dom.svg.filters/svgfediffuselightingelement/diffuseconstant/) 对应于给定 ‘feDiffuseLighting’ 元素上的属性 ‘diffuseConstant’。 |
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfediffuselightingelement/height/) 对应于给定 ‘filter’ 元素上的属性 ‘height’。 |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfediffuselightingelement/in1/) 对应于给定 ‘feDiffuseLighting’ 元素上的属性 ‘in’。 |
[getInnerHTML]
...
| [getKernelUnitLengthX](../../com.aspose.html.dom.svg.filters/svgfediffuselightingelement/kernelunitlengthx/) 对应于给定 ‘feDiffuseLighting’ 元素上的属性 ‘kernelUnitLength’。 |
| [getKernelUnitLengthY](../../com.aspose.html.dom.svg.filters/svgfediffuselightingelement/kernelunitlengthy/) 对应于给定 ‘feDiffuseLighting’ 元素上的属性 ‘kernelUnitLength’。 |
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfediffuselightingelement/result/) 对应于给定 ‘filter’ 元素上的属性 ‘result’。 |
...
| [getSurfaceScale](../../com.aspose.html.dom.svg.filters/svgfediffuselightingelement/surfacescale/) 对应于给定 ‘feDiffuseLighting’ 元素上的属性 ‘surfaceScale’。 |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfediffuselightingelement/width/) 对应于给定 ‘filter’ 元素上的属性 ‘width’。 |
| [X](../../com.aspose.html.dom.svg.filters/svgfediffuselightingelement/x/) { get; } | 对应给定 ‘filter’ 元素的 ‘x’ 属性。 |
| [Y](../../com.aspose.html.dom.svg.filters/svgfediffuselightingelement/y/) { get; } | 对应给定 ‘filter’ 元素的 ‘y’ 属性。 |
