---
title: "SVGFEColorMatrixElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.dom.svg.filters.SVGFEColorMatrixElement 类。SVGFEColorMatrixElement 接口对应于 feColorMatrix 元素。"
type: docs

url: /zh/java/com.aspose.html.dom.svg.filters/svgfecolormatrixelement/
---
## SVGFEColorMatrixElement class

该 SVGFEColorMatrixElement 接口对应 ‘feColorMatrix’ 元素。
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/height/) 对应给定 ‘filter’ 元素的属性 ‘height’。 |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/in1/) 对应给定 ‘feColorMatrix’ 元素的属性 ‘in’。 |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/result/) 对应给定 ‘filter’ 元素的属性 ‘result’。 |
...
| [getType](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/type/) 对应给定 ‘feColorMatrix’ 元素的属性 ‘type’。接受此接口上定义的 SVG_FECOLORMATRIX_TYPE_* 常量之一。 |
| [getValues](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/values/) 对应给定 ‘feColorMatrix’ 元素的属性 ‘values’。 |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/width/) 对应给定 ‘filter’ 元素的属性 ‘width’。 |
| [X](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/x/) { get; } | 对应给定 ‘filter’ 元素的 ‘x’ 属性。 |
| [Y](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/y/) { get; } | 对应给定 ‘filter’ 元素的 ‘y’ 属性。 |
...
| 名称 | 描述 |
| --- | --- |
| const [SVG_FECOLORMATRIX_TYPE_HUEROTATE](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_huerotate/) | 对应值 'hueRotate'。 |
| const [SVG_FECOLORMATRIX_TYPE_LUMINANCETOALPHA](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_luminancetoalpha/) | 对应值 'luminanceToAlpha'。 |
| const [SVG_FECOLORMATRIX_TYPE_MATRIX](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_matrix/) | 对应值 'matrix'。 |
| const [SVG_FECOLORMATRIX_TYPE_SATURATE](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_saturate/) | 对应值 'saturate'。 |
| const [SVG_FECOLORMATRIX_TYPE_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_unknown/) | 该类型不是预定义类型之一。尝试定义此类型的新值或尝试将现有值切换到此类型都是无效的。 |
