---
title: "SVGFEMorphologyElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.dom.svg.filters.SVGFEMorphologyElement 类。SVGFEMorphologyElement 接口对应于 feMorphology 元素。"
type: docs

url: /zh/java/com.aspose.html.dom.svg.filters/svgfemorphologyelement/
---
## SVGFEMorphologyElement class

该 SVGFEMorphologyElement 接口对应 ‘feMorphology’ 元素。
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/height/) 对应于给定 ‘filter’ 元素的属性 ‘height’。 |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/in1/) 对应于给定 ‘feMorphology’ 元素的属性 ‘in’。 |
[getInnerHTML]
...
| [getOperator](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/operator/) 对应给定 ‘feMorphology’ 元素上的属性 ‘operator’。接受此接口中定义的 SVG_MORPHOLOGY_OPERATOR_* 常量之一。 |
[getOuterHTML]
...
| [getRadiusX](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/radiusx/) 对应给定 ‘feMorphology’ 元素上的属性 ‘radius’。 |
| [getRadiusY](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/radiusy/) 对应给定 ‘feMorphology’ 元素上的属性 ‘radius’。 |
| [getResult](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/result/) 对应给定 ‘filter’ 元素上的属性 ‘result’。 |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/width/) 对应给定 ‘filter’ 元素上的属性 ‘width’。 |
| [X](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/x/) { get; } | 对应给定 ‘filter’ 元素的 ‘x’ 属性。 |
| [Y](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/y/) { get; } | 对应给定 ‘filter’ 元素的 ‘y’ 属性。 |
...
| 名称 | 描述 |
| --- | --- |
| const [SVG_MORPHOLOGY_OPERATOR_DILATE](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/svg_morphology_operator_dilate/) | 对应值 'dilate'。 |
| const [SVG_MORPHOLOGY_OPERATOR_ERODE](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/svg_morphology_operator_erode/) | 对应值 'erode'。 |
| const [SVG_MORPHOLOGY_OPERATOR_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/svg_morphology_operator_unknown/) | 该类型不是预定义类型之一。尝试定义此类型的新值或尝试将现有值切换到此类型都是无效的。 |
