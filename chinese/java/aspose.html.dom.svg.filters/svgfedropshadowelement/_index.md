...
| [getDx](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/dx/) 对应于给定 ‘feDropShadow’ 元素的属性 ‘dx’。 |
| [getDy](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/dy/) 对应于给定 ‘feDropShadow’ 元素的属性 ‘dy’。 |
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/height/) 对应于给定 ‘feDropShadow’ 元素的属性 ‘height’。 |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/in1/) 对应于给定 ‘feDropShadow’ 元素的属性 ‘in’。 |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/result/) 对应于给定 ‘feDropShadow’ 元素的属性 ‘result’。 |
| [getShadowRoot](../../com.aspose.html.dom/element/shadowroot/) 返回存储在此元素上的 shadowRoot，如果它已关闭则为 null。 |
| [getStdDeviationX](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/stddeviationx/) 对应于给定 ‘feDropShadow’ 元素的属性 ‘stdDeviation’。包含属性 ‘stdDeviation’ 的 X 分量。 |
| [getStdDeviationY](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/stddeviationy/) 对应于给定 ‘feDropShadow’ 元素的属性 ‘stdDeviation’。包含属性 ‘stdDeviation’ 的 Y 分量（可能自动计算）。 |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/width/) 对应于给定 ‘feDropShadow’ 元素的属性 ‘width’。 |
| [X](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/x/) { get; } | 对应于给定 ‘feDropShadow’ 元素的属性 ‘x’。 |
| [Y](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/y/) { get; } | 对应于给定 ‘feDropShadow’ 元素的属性 ‘y’。 |
