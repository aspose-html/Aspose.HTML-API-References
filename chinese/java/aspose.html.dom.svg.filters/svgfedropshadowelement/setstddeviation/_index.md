...
description: "SVGFEDropShadowElement 方法。设置属性 stdDeviation 的值"
type: docs

url: /zh/java/com.aspose.html.dom.svg.filters/svgfedropshadowelement/setstddeviation/
---
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| stdDeviationX | 单精度浮点数 | 属性 ‘stdDeviation’ 的 X 组件。 |
| stdDeviationY | 单精度浮点数 | 属性 ‘stdDeviation’ 的 Y 组件。 |
