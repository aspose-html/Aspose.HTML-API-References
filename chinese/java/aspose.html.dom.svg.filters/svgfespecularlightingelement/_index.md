...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/height/) 对应于给定 ‘filter’ 元素的属性 ‘height’。 |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/in1/) 对应于给定 ‘feSpecularLighting’ 元素的属性 ‘in’。 |
[getInnerHTML]
...
| [getKernelUnitLengthX](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/kernelunitlengthx/) 对应于给定 ‘feSpecularLighting’ 元素的属性 ‘kernelUnitLength’。 |
| [getKernelUnitLengthY](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/kernelunitlengthy/) 对应于给定 ‘feSpecularLighting’ 元素的属性 ‘kernelUnitLength’。 |
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/result/) 对应于给定 ‘filter’ 元素的属性 ‘result’。 |
| [getShadowRoot](../../com.aspose.html.dom/element/shadowroot/) 返回存储在此元素上的 shadowRoot，如果它已关闭则为 null。 |
| [getSpecularConstant](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/specularconstant/) 对应于给定 ‘feSpecularLighting’ 元素的属性 ‘specularConstant’。 |
| [getSpecularExponent](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/specularexponent/) 对应于给定 ‘feSpecularLighting’ 元素的属性 ‘specularExponent’。 |
| [getStyle](../../com.aspose.html.dom.svg/svgelement/style/) 对应给定元素的 ‘style’ 属性。如果用户代理不支持使用 CSS 进行样式设置，则此属性必须始终为 null。 |
| [getSurfaceScale](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/surfacescale/) 对应于给定 ‘feSpecularLighting’ 元素的属性 ‘surfaceScale’。 |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/width/) 对应于给定 ‘filter’ 元素的属性 ‘width’。 |
