---
title: "SVGFESpecularLightingElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.dom.svg.filters.SVGFESpecularLightingElement 类。SVGFESpecularLightingElement 接口对应于 feSpecularLighting 元素。"
type: docs

url: /zh/java/com.aspose.html.dom.svg.filters/svgfespecularlightingelement/
---
## SVGFESpecularLightingElement class

该 SVGFESpecularLightingElement 接口对应 ‘feSpecularLighting’ 元素。
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/height/) 对应于给定 ‘filter’ 元素上的属性 ‘height’。 |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/in1/) 对应于给定 ‘feSpecularLighting’ 元素上的属性 ‘in’。 |
[getInnerHTML]
...
| [getKernelUnitLengthX](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/kernelunitlengthx/) 对应于给定 ‘feSpecularLighting’ 元素上的属性 ‘kernelUnitLength’。 |
| [getKernelUnitLengthY](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/kernelunitlengthy/) 对应于给定 ‘feSpecularLighting’ 元素上的属性 ‘kernelUnitLength’。 |
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/result/) 对应于给定 ‘filter’ 元素上的属性 ‘result’。 |
| [getShadowRoot](../../com.aspose.html.dom/element/shadowroot/) 返回存储在此元素上的 shadowRoot，如果它已关闭则为 null。 |
| [getSpecularConstant](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/specularconstant/) 对应于给定 ‘feSpecularLighting’ 元素上的属性 ‘specularConstant’。 |
| [getSpecularExponent](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/specularexponent/) 对应于给定 ‘feSpecularLighting’ 元素上的属性 ‘specularExponent’。 |
| [getStyle](../../com.aspose.html.dom.svg/svgelement/style/) 对应给定元素的 ‘style’ 属性。如果用户代理不支持使用 CSS 进行样式设置，则此属性必须始终为 null。 |
| [getSurfaceScale](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/surfacescale/) 对应于给定 ‘feSpecularLighting’ 元素上的属性 ‘surfaceScale’。 |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/width/) 对应于给定 ‘filter’ 元素上的属性 ‘width’。 |
| [X](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/x/) { get; } | 对应给定 ‘filter’ 元素的 ‘x’ 属性。 |
| [Y](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/y/) { get; } | 对应给定 ‘filter’ 元素的 ‘y’ 属性。 |
