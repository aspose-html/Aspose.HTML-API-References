---
title: "SVGFEBlendElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.dom.svg.filters.SVGFEBlendElement 类。SVGFEBlendElement 接口对应 feBlend 元素。"
type: docs

url: /zh/java/com.aspose.html.dom.svg.filters/svgfeblendelement/
---
## SVGFEBlendElement class

该 SVGFEBlendElement 接口对应 ‘feBlend’ 元素。
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfeblendelement/height/) 对应给定 ‘filter’ 元素的属性 ‘height’。 |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfeblendelement/in1/) 对应给定 ‘feBlend’ 元素的属性 ‘in’。 |
| [getIn2](../../com.aspose.html.dom.svg.filters/svgfeblendelement/in2/) 对应给定 ‘feBlend’ 元素的属性 ‘in2’。 |
[getInnerHTML]
...
| [getMode](../../com.aspose.html.dom.svg.filters/svgfeblendelement/mode/) 对应给定 ‘feBlend’ 元素的属性 ‘mode’。接受此接口上定义的 SVG_FEBLEND_MODE_* 常量之一。 |
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfeblendelement/result/) 对应给定 ‘filter’ 元素的属性 ‘result’。 |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfeblendelement/width/) 对应给定 ‘filter’ 元素的属性 ‘width’。 |
| [X](../../com.aspose.html.dom.svg.filters/svgfeblendelement/x/) { get; } | 对应给定 ‘filter’ 元素的 ‘x’ 属性。 |
| [Y](../../com.aspose.html.dom.svg.filters/svgfeblendelement/y/) { get; } | 对应给定 ‘filter’ 元素的 ‘y’ 属性。 |
...
| 名称 | 描述 |
| --- | --- |
| const [SVG_FEBLEND_MODE_COLOR](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_color/) | 对应值 'color'。 |
| const [SVG_FEBLEND_MODE_COLOR_BURN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_color_burn/) | 对应值 'color_burn'。 |
| const [SVG_FEBLEND_MODE_COLOR_DODGE](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_color_dodge/) | 对应值 'color_dodge'。 |
| const [SVG_FEBLEND_MODE_DARKEN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_darken/) | 对应值 'darken'。 |
| const [SVG_FEBLEND_MODE_DIFFERENCE](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_difference/) | 对应值 'difference'。 |
| const [SVG_FEBLEND_MODE_EXCLUSION](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_exclusion/) | 对应值 'exclusion'。 |
| const [SVG_FEBLEND_MODE_HARD_LIGHT](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_hard_light/) | 对应值 'hard_light'。 |
| const [SVG_FEBLEND_MODE_HUE](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_hue/) | 对应值 'hue'。 |
| const [SVG_FEBLEND_MODE_LIGHTEN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_lighten/) | 对应值 'lighten'。 |
| const [SVG_FEBLEND_MODE_LUMINOSITY](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_luminosity/) | 对应值 'luminosity'。 |
| const [SVG_FEBLEND_MODE_MULTIPLY](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_multiply/) | 对应值 'multiply'。 |
| const [SVG_FEBLEND_MODE_NORMAL](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_normal/) | 对应值 'normal'。 |
| const [SVG_FEBLEND_MODE_OVERLAY](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_overlay/) | 对应值 'overlay'。 |
| const [SVG_FEBLEND_MODE_SATURATION](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_saturation/) | 对应值 'saturation'。 |
| const [SVG_FEBLEND_MODE_SCREEN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_screen/) | 对应值 'screen'。 |
| const [SVG_FEBLEND_MODE_SOFT_LIGHT](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_soft_light/) | 对应值 'soft_light'。 |
| const [SVG_FEBLEND_MODE_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_unknown/) | 该类型不是预定义类型之一。尝试定义此类型的新值或尝试将现有值切换到此类型都是无效的。 |
