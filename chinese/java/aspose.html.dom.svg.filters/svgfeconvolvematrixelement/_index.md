---
title: "SVGFEConvolveMatrixElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.dom.svg.filters.SVGFEConvolveMatrixElement 类。SVGFEConvolveMatrixElement 接口对应于 feConvolveMatrix 元素"
type: docs

url: /zh/java/com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/
---
## SVGFEConvolveMatrixElement class

该 SVGFEConvolveMatrixElement 接口对应 ‘feConvolveMatrix’ 元素。
...
| [getBias](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/bias/) 对应属性 ‘bias’ 于给定的 ‘feConvolveMatrix’ 元素。 |
...
| [getDivisor](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/divisor/) 对应属性 ‘divisor’ 于给定的 ‘feConvolveMatrix’ 元素。 |
| [getEdgeMode](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/edgemode/) 对应属性 ‘edgeMode’ 于给定的 ‘feConvolveMatrix’ 元素。 |
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/height/) 对应属性 ‘height’ 于给定的 ‘filter’ 元素。 |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/in1/) 对应属性 ‘in’ 于给定的 ‘feConvolveMatrix’ 元素。 |
[getInnerHTML]
...
| [getKernelMatrix](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelmatrix/) 对应属性 ‘kernelMatrix’ 于给定的 ‘feConvolveMatrix’ 元素。 |
| [getKernelUnitLengthX](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelunitlengthx/) 对应属性 ‘kernelUnitLength’ 于给定的 ‘feConvolveMatrix’ 元素。 |
| [getKernelUnitLengthY](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelunitlengthy/) 对应属性 ‘kernelUnitLength’ 于给定的 ‘feConvolveMatrix’ 元素。 |
...
| [getOrderX](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/orderx/) 对应属性 ‘order’ 于给定的 ‘feConvolveMatrix’ 元素。 |
| [getOrderY](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/ordery/) 对应属性 ‘order’ 于给定的 ‘feConvolveMatrix’ 元素。 |
[getOuterHTML]
...
| [getPreserveAlpha](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/preservealpha/) 对应属性 ‘preserveAlpha’ 于给定的 ‘feConvolveMatrix’ 元素。 |
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/result/) 对应属性 ‘result’ 于给定的 ‘filter’ 元素。 |
...
| [getTargetX](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/targetx/) 对应属性 ‘targetX’ 于给定的 ‘feConvolveMatrix’ 元素。 |
| [getTargetY](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/targety/) 对应属性 ‘targetY’ 于给定的 ‘feConvolveMatrix’ 元素。 |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/width/) 对应于给定 ‘filter’ 元素上的属性 ‘width’。 |
| [X](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/x/) { get; } | 对应给定 ‘filter’ 元素的 ‘x’ 属性。 |
| [Y](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/y/) { get; } | 对应给定 ‘filter’ 元素的 ‘y’ 属性。 |
...
| 名称 | 描述 |
| --- | --- |
| const [SVG_EDGEMODE_DUPLICATE](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_duplicate/) | 对应于值 'duplicate'。 |
| const [SVG_EDGEMODE_NONE](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_none/) | 对应于值 'none'。 |
| const [SVG_EDGEMODE_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_unknown/) | 该类型不是预定义类型之一。尝试定义此类型的新值或尝试将现有值切换到此类型都是无效的。 |
| const [SVG_EDGEMODE_WRAP](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_wrap/) | 对应于值 'wrap'。 |
