...
| [IXPathExpression](./ixpathexpression/) | `XPathExpression` 接口表示已解析且已求解的 XPath 表达式。 |
| [IXPathNamespace](./ixpathpackage/) | XPathNamespace 接口由 XPathResult 接口返回，用于表示 DOM 缺失的 XPath 包节点类型。 |
