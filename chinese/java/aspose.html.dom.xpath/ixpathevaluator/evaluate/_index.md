...
description: "IXPathEvaluator 方法。评估 XPath 表达式字符串，并在可能的情况下返回指定类型的结果。"
type: docs
...
| [dOMException](../../../com.aspose.html.dom/domexception/) | WRONG_DOCUMENT_ERR：该节点来自一个不受此 [`IXPathEvaluator`](../) 支持的文档。 |
