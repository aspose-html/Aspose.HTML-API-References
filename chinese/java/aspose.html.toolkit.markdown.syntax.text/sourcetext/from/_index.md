...
description: "SourceText 方法。定义从 String 获取 SourceText 的接口"
type: docs

url: /zh/java/com.aspose.html.toolkit.markdown.syntax.text/sourcetext/from/
---
## From(String) {#from_1}

定义用于从 String 获取 SourceText 的接口。
...
定义用于从 String 和编码获取 SourceText 的接口。
