...
description: "IDrawingFactory 方法。创建具有指定参数的线性渐变画刷"
type: docs

url: /zh/java/com.aspose.html.drawing/idrawingfactory/createlineargradientbrush/
---
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| rect | RectangleF | 定义渐变边界的矩形。 |
| colors | IInterpolationColor[] | 渐变的插值颜色。参见 [`IInterpolationColor`](../../iinterpolationcolor/)。 |

### 返回值

创建的 [`ILinearGradientBrush`](../../ilineargradientbrush/)。
