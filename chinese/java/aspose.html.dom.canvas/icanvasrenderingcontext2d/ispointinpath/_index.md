...
description: "ICanvasRenderingContext2D 方法。报告指定的点是否位于当前路径中。"
type: docs

url: /zh/java/com.aspose.html.dom.canvas/icanvasrenderingcontext2d/ispointinpath/
---
...
如果点位于路径填充所包含的区域内则返回 true，否则返回 false。
