---
title: "ICanvasDrawingStyles 接口"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.dom.canvas.ICanvasDrawingStyles 接口。ICanvasDrawingStyles 接口提供方法和属性，以控制线条的绘制方式以及文本的布局"
type: docs

url: /zh/java/com.aspose.html.dom.canvas/icanvasdrawingstyles/
---
## ICanvasDrawingStyles interface

ICanvasDrawingStyles 接口提供方法和属性，以控制线条的绘制方式和文本的布局。
...
| 名称 | 描述 |
| --- | --- |
| [getLineDash](../../com.aspose.html.dom.canvas/icanvasdrawingstyles/getlinedash/)() | 返回当前线段虚线模式数组，包含偶数个非负数。 |
| [setLineDash](../../com.aspose.html.dom.canvas/icanvasdrawingstyles/setlinedash/)(double[]) | 设置当前线段虚线模式。 |
