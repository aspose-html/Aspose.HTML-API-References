---
title: "SVGTransformList 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.dom.svg.datatypes.SVGTransformList 类。此接口定义了 SVGTransform 对象的列表。"
type: docs

url: /zh/java/com.aspose.html.dom.svg.datatypes/svgtransformlist/
---
## SVGTransformList class

此接口定义了 SVGTransform 对象的列表。
...
| 名称 | 描述 |
| --- | --- |
| [SVGTransformList](svgtransformlist/#constructor)() | 初始化 `SVGTransformList` 类的新实例。 |
| [SVGTransformList](svgtransformlist/#constructor_1)(IEnumerable&lt;SVGTransform&gt;) | 初始化 `SVGTransformList` 类的新实例。 |
...
| [toString](../../com.aspose.html.dom.svg.datatypes/svgtransformlist/toString/)() | 返回表示此实例的字符串。 |
