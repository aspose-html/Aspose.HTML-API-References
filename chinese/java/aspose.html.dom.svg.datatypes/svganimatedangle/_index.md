---
title: "SVGAnimatedAngle 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.dom.svg.datatypes.SVGAnimatedAngle 类。用于可以动画化的基本数据类型 angle（角度）的属性。"
type: docs

url: /zh/java/com.aspose.html.dom.svg.datatypes/svganimatedangle/
---
## SVGAnimatedAngle class

用于可以动画化的 angle 基本数据类型属性。
...
| [toString](../../com.aspose.html.dom.svg.datatypes/svganimatedangle/toString/)() | 返回表示此实例的字符串。 |
