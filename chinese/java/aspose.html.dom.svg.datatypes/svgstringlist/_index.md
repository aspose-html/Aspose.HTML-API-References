---
title: "SVGStringList 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.dom.svg.datatypes.SVGStringList 类。SVGStringList 具有与其他 SVGxxxList 接口相同的属性和方法。实现者可能考虑使用单一基类来实现各种 SVGxxxList 接口。"
type: docs

url: /zh/java/com.aspose.html.dom.svg.datatypes/svgStringlist/
---
## SVGStringList class

SVGStringList 具有与其他 SVGxxxList 接口相同的属性和方法。实现者可以考虑使用单一基类来实现各种 SVGxxxList 接口。
...
| 名称 | 描述 |
| --- | --- |
| [SVGStringList](svgStringlist/#constructor)() | 初始化 `SVGStringList` 类的新实例。 |
| [SVGStringList](svgStringlist/#constructor_1)(IEnumerable&lt;String&gt;) | 初始化 `SVGStringList` 类的新实例。 |
...
| [toString](../../com.aspose.html.dom.svg.datatypes/svgStringlist/toString/)() | 返回表示此实例的字符串。 |
