---
title: "SVGAnimatedLength 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.dom.svg.datatypes.SVGAnimatedLength 类。用于基本类型 length 且可以动画化的属性"
type: docs

url: /zh/java/com.aspose.html.dom.svg.datatypes/svganimatedlength/
---
## SVGAnimatedLength class

用于可以动画化的 length 基本类型属性。
...
| [toString](../../com.aspose.html.dom.svg.datatypes/svganimatedlength/toString/)() | 返回表示此实例的字符串。 |
