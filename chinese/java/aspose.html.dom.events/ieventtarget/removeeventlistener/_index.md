...
description: "IEventTarget 方法。此方法允许从事件目标中移除事件监听器。如果在处理事件时将其从目标中移除，则不会被当前操作触发。事件监听器在被移除后永远不会被调用。"
type: docs

url: /zh/java/com.aspose.html.dom.events/ieventtarget/removeeventlistener/
---
