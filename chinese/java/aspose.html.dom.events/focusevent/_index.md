...
description: "com.aspose.html.dom.events.FocusEvent 类。FocusEvent 接口提供与焦点事件相关的特定上下文信息。"
type: docs

url: /zh/java/com.aspose.html.dom.events/focusevent/
---
## FocusEvent class
...
| 名称 | 描述 |
| --- | --- |
| [FocusEvent](focusevent/#constructor)(String) | 初始化 `FocusEvent` 类的新实例。 |
...
| [getRelatedTarget](../../com.aspose.html.dom.events/focusevent/relatedtarget/) 用于识别与焦点事件相关的次要 EventTarget，取决于事件类型。 |
