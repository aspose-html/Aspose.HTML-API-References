...
description: "com.aspose.html.dom.events.CustomEvent 类。使用 CustomEvent 接口的事件可用于携带自定义数据。"
type: docs

url: /zh/java/com.aspose.html.dom.events/customevent/
---
## CustomEvent class
...
| [getDetail](../../com.aspose.html.dom.events/customevent/detail/) 获取自定义数据。 |
...
| [initCustomEvent](../../com.aspose.html.dom.events/customevent/initcustomevent/)(String, bool, bool, object) | /// [`InitEvent`](../event/initevent/) 方法用于初始化通过 [`IDocumentEvent`](../idocumentevent/) 接口创建的 [`Event`](../event/) 的值。 |
