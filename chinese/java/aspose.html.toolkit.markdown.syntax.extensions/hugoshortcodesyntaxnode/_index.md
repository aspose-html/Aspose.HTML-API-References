---
title: "HugoShortCodeSyntaxNode 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.toolkit.markdown.syntax.extensions.HugoShortCodeSyntaxNode 类。定义了 HugoShortCodeSyntaxNode"
type: docs

url: /zh/java/com.aspose.html.toolkit.markdown.syntax.extensions/hugoshortcodesyntaxnode/
---
## HugoShortCodeSyntaxNode class

定义 HugoShortCodeSyntaxNode。
...
| 名称 | 描述 |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/inlinecontainersyntaxnode/accept/)(MarkdownSyntaxVisitor) | 定义接受访问者的接口。 |
...
| [getEnumerator](../../com.aspose.html.toolkit.markdown.syntax/inlinecontainersyntaxnode/getenumerator/)() | 返回一个遍历集合的枚举器。 |
| [getLeadingTrivia](../../com.aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/getleadingtrivia/)() | 获取前导 trivia。 |
| [getParameter](../../com.aspose.html.toolkit.markdown.syntax.extensions/hugoshortcodesyntaxnode/getparameter/)(int) | 定义了 GetParameter |
| [getParametersCount](../../com.aspose.html.toolkit.markdown.syntax.extensions/hugoshortcodesyntaxnode/getparameterscount/)() | 定义了 GetParametersCount |
...
| [isEndTag](../../com.aspose.html.toolkit.markdown.syntax.extensions/hugoshortcodesyntaxnode/isendtag/)() | 定义了用于检查 IsEndTag 的接口 |
