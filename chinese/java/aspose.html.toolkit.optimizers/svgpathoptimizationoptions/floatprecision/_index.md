...
description: "SVGPathOptimizationOptions 属性。获取或设置将浮点精度值四舍五入到指定小数位数的选项。默认值为 3。"
type: docs

url: /zh/java/com.aspose.html.toolkit.optimizers/svgpathoptimizationoptions/floatprecision/
---
