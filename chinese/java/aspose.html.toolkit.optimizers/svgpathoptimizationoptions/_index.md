---
title: "SVGPathOptimizationOptions 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.toolkit.optimizers.SVGPathOptimizationOptions 类。SVGPathOptimizationOptions 是用于存储 SVG 路径元素段优化选项的类"
type: docs

url: /zh/java/com.aspose.html.toolkit.optimizers/svgpathoptimizationoptions/
---
## SVGPathOptimizationOptions class

SVGPathOptimizationOptions 是用于存储 SVG 路径元素段优化选项的类。
...
| 名称 | 描述 |
| --- | --- |
| [SVGPathOptimizationOptions](svgpathoptimizationoptions/)() | 初始化 `SVGPathOptimizationOptions` 类的新实例。 |
