...
description: "SVGOptimizationOptions 属性。获取或设置删除渲染期间不可见元素的选项。默认情况下为 true。"
type: docs

url: /zh/java/com.aspose.html.toolkit.optimizers/svgoptimizationoptions/removehiddenelements/
---
## SVGOptimizationOptions.RemoveHiddenElements property

获取或设置删除渲染期间不可见元素的选项。默认情况下为 'true'。
