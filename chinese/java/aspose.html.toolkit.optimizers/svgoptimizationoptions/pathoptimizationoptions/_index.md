...
description: "SVGOptimizationOptions 属性。获取或设置 SVGPathOptimizationOptions 选项。如果此选项为 null，则不会执行路径元素优化"
type: docs

url: /zh/java/com.aspose.html.toolkit.optimizers/svgoptimizationoptions/pathoptimizationoptions/
---
## SVGOptimizationOptions.PathOptimizationOptions property

获取或设置选项 [`SVGPathOptimizationOptions`](../../svgpathoptimizationoptions/)。如果此选项为 null，则不会执行路径元素优化。
