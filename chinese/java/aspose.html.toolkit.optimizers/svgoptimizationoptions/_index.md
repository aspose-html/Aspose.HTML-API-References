---
title: "SVGOptimizationOptions 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.toolkit.optimizers.SVGOptimizationOptions 类。SVGOptimizationOptions 是用于存储 SVG 文档优化选项的类"
type: docs

url: /zh/java/com.aspose.html.toolkit.optimizers/svgoptimizationoptions/
---
## SVGOptimizationOptions class

SVGOptimizationOptions 是用于存储 SVG 文档优化选项的类。
...
| 名称 | 描述 |
| --- | --- |
| [SVGOptimizationOptions](svgoptimizationoptions/)() | 初始化 `SVGOptimizationOptions` 类的新实例。 |
