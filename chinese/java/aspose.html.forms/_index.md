...
description: "该包提供对众多对象元素的访问，这些元素负责表单作为网页组件中的用户交互。"
type: docs

url: /zh/java/com.aspose.html.forms/
---
该包提供对众多对象（元素）的访问，这些对象负责表单内作为网页组件的用户交互。
...
| [FormEditor](./formeditor/) | 此类表示对 [`HTMLFormElement`](../com.aspose.html/htmlformelement/) 的编辑器，为 .net 开发人员提供更简便的 HTML 表单编辑方式。 |
| [FormElement](./formelement/) | 表示表单元素的基类。 |
| [FormElement&lt;T&gt;](./formelement-1/) | [`FormElement`](../com.aspose.html.forms/formelement/) 表示通用字段。 |
| [FormSubmitter](./formsubmitter/) | 此类允许准备指定的 [`HTMLFormElement`](../com.aspose.html/htmlformelement/)，收集表单元素的值，将其提交到远程服务器并接收响应。 |
...
| [SubmissionResult](./submissionresult/) | 此类表示将表单数据提交到服务器的结果。 |
...
| [FormElementType](./formelementtype/) | 表示表单元素类型及其对应的 HTML 元素的枚举。 |
