...
创建一个新的 [`FormEditor`](../) 基于 [`HTMLFormElement`](../../../com.aspose.html/htmlformelement/)。
...
创建一个新的 [`FormEditor`](../) 基于从 [`Forms`](../../../com.aspose.html/htmldocument/forms/) 集合中按索引选择的 [`HTMLFormElement`](../../../com.aspose.html/htmlformelement/)。
...
创建一个新的 [`FormEditor`](../)，基于通过 id 从文档中选择的 [`HTMLFormElement`](../../../com.aspose.html/htmlformelement/)。
...
| 异常 | 条件 |
| --- | --- |
| [dOMException](../../../com.aspose.html.dom/domexception/) | 如果指定的 Id 不存在元素或元素不是表单类型，将抛出异常。 |
