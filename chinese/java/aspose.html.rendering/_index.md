...
description: "com.aspose.html.rendering 包包含众多渲染器对象以及相应的低层选项类，这些类负责将文档/文件渲染为 IDevice 实现。"
type: docs

url: /zh/java/com.aspose.html.rendering/
---
**com.aspose.html.rendering** 包由众多渲染器对象以及负责将文档/文件渲染到 IDevice 实现的适当低层选项类组成。
...
| [EpubRenderer](./epubrenderer/) | 表示一个 EPub 文档渲染器。 |
| [GraphicContext](./graphiccontext/) | 保存当前图形控制参数。这些参数定义了图形操作执行的全局框架。 |
