...
description: "EpubRenderer 方法。定义用于将多个 EPub 流渲染到特定 IDevice 的方法。渲染将在没有任何网络操作用于加载资源、活动计时器、动画任务或指定超时已到达时执行。"
type: docs

url: /zh/java/com.aspose.html.rendering/epubrenderer/render/
---
## Render(IDevice, TimeSpan, params Stream[]) {#render_10}

定义用于将多个 EPub 流渲染到特定 [`IDevice`](../../idevice/) 的方法。渲染将在没有任何网络操作用于加载资源、活动计时器、动画任务或指定超时已到达时执行。
...
定义一种方法，将多个 EPub 文档渲染到特定 [`IDevice`](../../idevice/)，并使用取消令牌请求取消该操作。
...
将 EPub 文档渲染到指定的 [`IDevice`](../../idevice/)。
...
将 EPub 文档渲染到指定的 [`IDevice`](../../idevice/)。渲染将在没有任何网络操作用于加载资源、活动计时器、动画任务或指定超时已到达时执行。
...
将多个 EPub 文档渲染到指定的 [`IDevice`](../../idevice/)。
...
将多个 EPub 文档渲染到指定的 [`IDevice`](../../idevice/)。渲染将在没有任何网络操作用于加载资源、活动计时器、动画任务或指定超时已到达时执行。
