---
title: "HtmlRenderer 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.rendering.HtmlRenderer 类。表示一个 HTML 文档渲染器"
type: docs

url: /zh/java/com.aspose.html.rendering/htmlrenderer/
---
## HtmlRenderer class
...
| 名称 | 描述 |
| --- | --- |
| [HtmlRenderer](htmlrenderer/)() | 默认构造函数。 |
...
| [render](../../com.aspose.html.rendering/htmlrenderer/render/#render_5)(IDevice, CancellationToken, params HTMLDocument[]) | 定义一个方法，用于将多个[`HTMLDocument`](../../com.aspose.html/htmldocument/)s 渲染到特定的[`IDevice`](../idevice/)，使用取消令牌请求取消操作。 |
...
| [render](../../com.aspose.html.rendering/htmlrenderer/render/#render_6)(IDevice, TimeSpan, params HTMLDocument[]) | 定义方法，将多个[`HTMLDocument`](../../com.aspose.html/htmldocument/)s 渲染到特定的[`IDevice`](../idevice/)。 |
