---
title: "SVGPathSegArcRel 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.dom.svg.paths.SVGPathSegArcRel 类。SVGPathSegArcRel 接口对应一个相对弧线（arcto）路径数据命令"
type: docs

url: /zh/java/com.aspose.html.dom.svg.paths/svgpathsegarcrel/
---
## SVGPathSegArcRel class

SVGPathSegArcRel 接口对应“相对弧线”(a) 路径数据命令。
...
| [X](../../com.aspose.html.dom.svg.paths/svgpathsegarcrel/x/) { get; set; } | 此路径段终点的相对 X 坐标。 |
| [Y](../../com.aspose.html.dom.svg.paths/svgpathsegarcrel/y/) { get; set; } | 此路径段终点的相对 Y 坐标。 |
