...
description: "SVGPathSegArcRel 属性。椭圆的 x 轴相对于用户坐标系 x 轴的旋转角度（以度为单位）"
type: docs

url: /zh/java/com.aspose.html.dom.svg.paths/svgpathsegarcrel/angle/
---
## SVGPathSegArcRel.Angle property

椭圆的 x 轴相对于用户坐标系 x 轴的旋转角度（以度为单位）。
