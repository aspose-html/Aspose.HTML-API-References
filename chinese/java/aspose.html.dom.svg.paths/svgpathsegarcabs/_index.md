---
title: "SVGPathSegArcAbs 类。"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.dom.svg.paths.SVGPathSegArcAbs 类。该 SVGPathSegArcAbs 接口对应于绝对弧线 A 路径数据命令。"
type: docs

url: /zh/java/com.aspose.html.dom.svg.paths/svgpathsegarcabs/
---
## SVGPathSegArcAbs class

SVGPathSegArcAbs 接口对应"绝对 arcto"(A) 路径数据命令。
...
| [X](../../com.aspose.html.dom.svg.paths/svgpathsegarcabs/x/) { get; set; } | 该路径段终点的绝对 X 坐标。 |
| [Y](../../com.aspose.html.dom.svg.paths/svgpathsegarcabs/y/) { get; set; } | 该路径段终点的绝对 Y 坐标。 |
