---
title: "SVGPathSegCurvetoQuadraticAbs 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.dom.svg.paths.SVGPathSegCurvetoQuadraticAbs 类。该 SVGPathSegCurvetoQuadraticAbs 接口对应于绝对二次 Bézier 曲线 Q 路径数据命令"
type: docs

url: /zh/java/com.aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticabs/
---
## SVGPathSegCurvetoQuadraticAbs class

SVGPathSegCurvetoQuadraticAbs 接口对应"绝对二次 Bézier 曲线"(Q) 路径数据命令。
...
| [X](../../com.aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticabs/x/) { get; set; } | 该路径段终点的绝对 X 坐标。 |
[getX1]
[setX1] The absolute X coordinate for the first control point. |
| [Y](../../com.aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticabs/y/) { get; set; } | 该路径段终点的绝对 Y 坐标。 |
[getY1]
