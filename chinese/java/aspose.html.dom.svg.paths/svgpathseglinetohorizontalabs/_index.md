---
title: "SVGPathSegLinetoHorizontalAbs 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.dom.svg.paths.SVGPathSegLinetoHorizontalAbs 类。该 SVGPathSegLinetoHorizontalAbs 接口对应于绝对水平直线 H 路径数据命令"
type: docs

url: /zh/java/com.aspose.html.dom.svg.paths/svgpathseglinetohorizontalabs/
---
## SVGPathSegLinetoHorizontalAbs class

SVGPathSegLinetoHorizontalAbs 接口对应于“绝对水平直线”(H) 路径数据命令。
...
| [X](../../com.aspose.html.dom.svg.paths/svgpathseglinetohorizontalabs/x/) { get; set; } | 该路径段终点的绝对 X 坐标。 |
