...
description: "com.aspose.html.dom.svg.paths.SVGPathSegCurvetoCubicAbs 类。该 SVGPathSegCurvetoCubicAbs 接口对应于绝对立方贝塞尔曲线 C 路径数据命令"
type: docs

url: /zh/java/com.aspose.html.dom.svg.paths/svgpathsegcurvetocubicabs/
---
## SVGPathSegCurvetoCubicAbs class

SVGPathSegCurvetoCubicAbs 接口对应“绝对立方贝塞尔曲线”(C) 路径数据命令。
...
| [X](../../com.aspose.html.dom.svg.paths/svgpathsegcurvetocubicabs/x/) { get; set; } | 该路径段终点的绝对 X 坐标。 |
[getX1]
[setX1] The absolute X coordinate for the first control point. |
[getX2]
[setX2] The absolute X coordinate for the second control point. |
| [Y](../../com.aspose.html.dom.svg.paths/svgpathsegcurvetocubicabs/y/) { get; set; } | 该路径段终点的绝对 Y 坐标。 |
[getY1]
