---
title: "SVGPathSegCurvetoCubicSmoothRel 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.dom.svg.paths.SVGPathSegCurvetoCubicSmoothRel 类。该 SVGPathSegCurvetoCubicSmoothRel 接口对应于相对平滑立方曲线 s 路径数据命令"
type: docs

url: /zh/java/com.aspose.html.dom.svg.paths/svgpathsegcurvetocubicsmoothrel/
---
## SVGPathSegCurvetoCubicSmoothRel class

SVGPathSegCurvetoCubicSmoothRel 接口对应“相对平滑立方曲线”(s) 路径数据命令。
...
| [X](../../com.aspose.html.dom.svg.paths/svgpathsegcurvetocubicsmoothrel/x/) { get; set; } | 此路径段终点的相对 X 坐标。 |
[getX2]
[setX2] The relative X coordinate for the second control point. |
| [Y](../../com.aspose.html.dom.svg.paths/svgpathsegcurvetocubicsmoothrel/y/) { get; set; } | 此路径段终点的相对 Y 坐标。 |
[getY2]
