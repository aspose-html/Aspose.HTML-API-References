...
description: "com.aspose.html.dom.svg.paths.SVGPathSegMovetoAbs 类。SVGPathSegMovetoAbs 接口对应于一个 absolute moveto M 路径数据命令。"
type: docs

url: /zh/java/com.aspose.html.dom.svg.paths/svgpathsegmovetoabs/
---
## SVGPathSegMovetoAbs class

该 SVGPathSegMovetoAbs 接口对应于 "绝对移动到" (M) 路径数据命令。
...
| [X](../../com.aspose.html.dom.svg.paths/svgpathsegmovetoabs/x/) { get; set; } | 该路径段终点的绝对 X 坐标。 |
| [Y](../../com.aspose.html.dom.svg.paths/svgpathsegmovetoabs/y/) { get; set; } | 该路径段终点的绝对 Y 坐标。 |
