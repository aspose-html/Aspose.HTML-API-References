---
title: "SVGPathSegCurvetoQuadraticRel 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.dom.svg.paths.SVGPathSegCurvetoQuadraticRel 类。该 SVGPathSegCurvetoQuadraticRel 接口对应于相对二次 Bézier 曲线 q 路径数据命令"
type: docs

url: /zh/java/com.aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticrel/
---
## SVGPathSegCurvetoQuadraticRel class

该 SVGPathSegCurvetoQuadraticRel 接口对应于 "相对二次贝塞尔曲线" (q) 路径数据命令。
...
| [X](../../com.aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticrel/x/) { get; set; } | 此路径段终点的相对 X 坐标。 |
[getX1]
[setX1] The relative X coordinate for the first control point. |
| [Y](../../com.aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticrel/y/) { get; set; } | 此路径段终点的相对 Y 坐标。 |
[getY1]
