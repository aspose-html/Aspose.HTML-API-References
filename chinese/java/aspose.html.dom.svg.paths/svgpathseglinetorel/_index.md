---
title: "SVGPathSegLinetoRel 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.dom.svg.paths.SVGPathSegLinetoRel 类。SVGPathSegLinetoRel 接口对应相对 lineto l 路径数据命令。"
type: docs

url: /zh/java/com.aspose.html.dom.svg.paths/svgpathseglinetorel/
---
## SVGPathSegLinetoRel class

SVGPathSegLinetoRel 接口对应于“相对直线”(l) 路径数据命令。
...
| [X](../../com.aspose.html.dom.svg.paths/svgpathseglinetorel/x/) { get; set; } | 此路径段终点的相对 X 坐标。 |
| [Y](../../com.aspose.html.dom.svg.paths/svgpathseglinetorel/y/) { get; set; } | 此路径段终点的相对 Y 坐标。 |
