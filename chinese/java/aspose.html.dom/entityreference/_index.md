---
title: "EntityReference 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.dom.EntityReference 类。EntityReference 节点可用于在树中表示实体引用。"
type: docs

url: /zh/java/com.aspose.html.dom/entityreference/
---
## EntityReference class

EntityReference 节点可用于在树中表示实体引用。
...
| [getNodeName](../../com.aspose.html.dom/entityreference/nodename/) 此节点的名称，取决于其类型。 |
| [getNodeType](../../com.aspose.html.dom/entityreference/nodetype/) 表示底层对象类型的代码。 |
...
| [normalize](../../com.aspose.html.dom/node/normalize/)() | 将此节点下子树的全部深度中的所有 [`Text`](../text/) 节点（包括属性节点）放入一种\"normal\"形式，其中仅有结构（例如 [`elements`](../element/)、[`comments`](../comment/)、[`processing instructions`](../processinginstruction/)、[`CDATA sections`](../cdatasection/)、以及 `entity references`）将 [`Text`](../text/) 节点分隔开，即不存在相邻的 Text 节点或空的 Text 节点。此操作可用于确保文档的 DOM 视图与保存后重新加载时的视图相同，并且在需要依赖特定文档树结构的操作（如 XPointer [XPointer] 查找）时非常有用。如果附加到 [`Node.ownerDocument`](../node/ownerdocument/) 的 [`DOMConfiguration`](../../com.aspose.html/configuration/) 对象的参数 \"normalize-characters\" 为 true，则此方法还会完全规范化 Text 节点的字符。 |
