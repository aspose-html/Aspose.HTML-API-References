...
description: "com.aspose.html.dom.Notation 类。表示在 DTD 中声明的 notation。"
type: docs

url: /zh/java/com.aspose.html.dom/notation/
---
## Notation class

表示在 DTD 中声明的符号（notation）。
...
| [getNodeName](../../com.aspose.html.dom/notation/nodename/) 此节点的名称，取决于其类型。 |
| [getNodeType](../../com.aspose.html.dom/notation/nodetype/) 表示底层对象类型的代码。 |
...
| [getPublicId](../../com.aspose.html.dom/notation/publicid/) 此 notation 的公共标识符。如果未指定公共标识符，则为 null。 |
| [getSystemId](../../com.aspose.html.dom/notation/systemid/) 此 notation 的系统标识符。如果未指定系统标识符，则为 null。它可能是绝对 URI，也可能不是。 |
