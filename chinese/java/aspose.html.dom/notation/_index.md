...
description: "com.aspose.html.dom.Notation 类。表示在 DTD 中声明的符号。"
type: docs
...
| [getPublicId](../../com.aspose.html.dom/notation/publicid/) 此符号的公共标识符。如果未指定公共标识符，则为 null。 |
| [getSystemId](../../com.aspose.html.dom/notation/systemid/) 此符号的系统标识符。如果未指定系统标识符，则为 null。它可能是绝对 URI，也可能不是。 |
