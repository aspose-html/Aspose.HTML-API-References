...
description: "Node 字段。一个 DocumentType 节点，例如 DOCTYPE html"
type: docs

url: /zh/java/com.aspose.html.dom/node/document_type_node/
---
## Node.DOCUMENT_TYPE_NODE field

一个 [`DocumentType`](../../documenttype/) 节点，例如 &lt;!DOCTYPE html&gt;。
