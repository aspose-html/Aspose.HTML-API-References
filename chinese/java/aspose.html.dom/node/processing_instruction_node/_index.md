...
description: "Node 字段。XML 文档的 ProcessingInstruction，例如 xml-stylesheet"
type: docs

url: /zh/java/com.aspose.html.dom/node/processing_instruction_node/
---
## Node.PROCESSING_INSTRUCTION_NODE field

一个 [`ProcessingInstruction`](../../processinginstruction/)，用于 XML 文档，例如 &lt;?xml-stylesheet … ?&gt;。
