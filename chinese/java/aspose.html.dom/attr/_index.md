...
description: "com.aspose.html.dom.Attr 类。Attr 接口表示 Element 对象中的属性。通常，该属性的可取值在与文档关联的模式中定义。"
type: docs

url: /zh/java/com.aspose.html.dom/attr/
---
## Attr class
...
| [getLocalName](../../com.aspose.html.dom/attr/localname/) 返回此节点的限定名称的本地部分。对于除 ELEMENT_NODE 和 ATTRIBUTE_NODE 之外的任何类型的节点，以及使用 DOM Level 1 方法（如 Document.createElement()）创建的节点，此值始终为 null。 |
| [getName](../../com.aspose.html.dom/attr/name/) 返回此属性的名称。 |
| [getNamespaceURI](../../com.aspose.html.dom/attr/packageuri/) 此节点的包 URI，如果未指定则为 null。 |
...
| [getNodeName](../../com.aspose.html.dom/attr/nodename/) 此节点的名称，取决于其类型。 |
| [getNodeType](../../com.aspose.html.dom/attr/nodetype/) 表示底层对象类型的代码。 |
| [nodeValue](../../com.aspose.html.dom/attr/nodevalue/) { get; set; } | 此节点的值，取决于其类型。 |
| [getOwnerDocument](../../com.aspose.html.dom/node/ownerdocument/) 只读的 ownerDocument 属性（Node 接口）返回该节点的顶层文档对象。 |
| [getOwnerElement](../../com.aspose.html.dom/attr/ownerelement/) 此属性所附属的 Element 节点，如果该属性未被使用则为 null。 |
...
| [getPrefix](../../com.aspose.html.dom/attr/prefix/) 此节点的包前缀，如果未指定则为 null。当它被定义为 null 时，设置它不会产生任何效果。 |
...
| [getSpecified](../../com.aspose.html.dom/attr/specified/) 如果此属性在实例文档中被显式赋值则为 true，否则为 false。 |
| [textContent](../../com.aspose.html.dom/attr/textcontent/) { get; set; } | 此属性返回该节点及其后代的文本内容。当其被定义为 null 时，设置该属性没有任何效果。设置时，节点可能拥有的所有子节点将被移除，如果新的字符串既不为空也不为 null，则会被一个包含该字符串的单一 Text 节点所取代。 |
[getValue]
