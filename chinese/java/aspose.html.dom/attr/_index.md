...
description: "com.aspose.html.dom.Attr 类。Attr 接口表示 Element 对象中的属性。通常，属性的允许值在与文档关联的模式中定义。"
type: docs
...
| [getLocalName](../../com.aspose.html.dom/attr/localname/) 返回此节点的限定名称的本地部分。对于除 ELEMENT_NODE 和 ATTRIBUTE_NODE 之外的任何类型节点以及使用 DOM Level 1 方法（如 Document.createElement()）创建的节点，此值始终为 null。 |
...
| [getPrefix](../../com.aspose.html.dom/attr/prefix/) 此节点的包前缀，如果未指定则为 null。当其被定义为 null 时，设置该属性没有任何效果。 |
