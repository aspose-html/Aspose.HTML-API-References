...
搜索整个文档，包括根节点。返回的 [`HTMLCollection`](../../../com.aspose.html.collections/htmlcollection/) 是实时的，这意味着它会自动更新自身，以保持与 DOM 树同步，无需再次调用 document.getElementsByTagName()。
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| 标签名 | String | 一个字符串，表示元素的名称。特殊字符串 "*" 代表所有元素。 |
