...
description: "com.aspose.html.dom.IStorage 接口。Web Storage API 的此接口提供对特定域的会话或本地存储的访问。参见 Web Storage 规范 https//html.spec.whatwg.org/multipage/webstorage.htmlwebstorage"
type: docs
