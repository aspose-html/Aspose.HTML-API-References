...
description: "com.aspose.html.dom.Comment 类。继承自 CharacterData，表示注释的内容，即起始标记之间的所有字符"
type: docs

url: /zh/java/com.aspose.html.dom/comment/
---
## Comment class

继承自 CharacterData，表示注释的内容，即起始 '' 之间的所有字符。
...
| [getNodeName](../../com.aspose.html.dom/comment/nodename/) 此节点的名称，取决于其类型。 |
| [getNodeType](../../com.aspose.html.dom/comment/nodetype/) 表示底层对象类型的代码。 |
| [nodeValue](../../com.aspose.html.dom/comment/nodevalue/) { get; set; } | 此节点的值，取决于其类型。 |
...
| [textContent](../../com.aspose.html.dom/comment/textcontent/) { get; set; } | 此属性返回该节点及其后代的文本内容。当其被定义为 null 时，设置该属性没有任何效果。设置时，节点可能拥有的所有子节点将被移除，如果新的字符串既不为空也不为 null，则会被一个包含该字符串的单一 Text 节点所取代。 |
