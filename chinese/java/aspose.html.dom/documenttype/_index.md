---
title: "DocumentType 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.dom.DocumentType 类。DocumentType 提供了一个接口，用于访问文档中定义的实体列表。"
type: docs

url: /zh/java/com.aspose.html.dom/documenttype/
---
## DocumentType class

DocumentType 提供了一个接口，用于访问文档中定义的实体列表。
...
| 名称 | 描述 |
| --- | --- |
| [DocumentType](documenttype/)(String, String, String, String, Document) | 初始化 `DocumentType` 类的新实例。 |
...
| [getInternalSubset](../../com.aspose.html.dom/documenttype/internalsubset/) 以字符串形式返回内部子集，如果不存在则为 null。 |
...
| [getName](../../com.aspose.html.dom/documenttype/name/) DTD 的名称；即紧跟在 DOCTYPE 关键字之后的名称。 |
...
| [getNodeName](../../com.aspose.html.dom/documenttype/nodename/) 此节点的名称，取决于其类型。 |
| [getNodeType](../../com.aspose.html.dom/documenttype/nodetype/) 表示底层对象类型的代码。 |
...
| [getPublicId](../../com.aspose.html.dom/documenttype/publicid/) 外部子集的公共标识符。 |
| [getSystemId](../../com.aspose.html.dom/documenttype/systemid/) 外部子集的系统标识符。它可能是绝对 URI，也可能不是。 |
...
| [toString](../../com.aspose.html.dom/documenttype/toString/)() | 返回表示此实例的字符串。 |
