---
title: "CDATASection 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.dom.CDATASection 类。CDATA 区段用于转义包含本会被视为标记的字符的文本块。"
type: docs

url: /zh/java/com.aspose.html.dom/cdatasection/
---
## CDATASection class

CDATA 区段用于转义包含本应被视为标记的字符的文本块。
...
| [getIsElementContentWhitespace](../../com.aspose.html.dom/text/iselementcontentwhitespace/) 返回此文本节点是否包含元素内容空白，通常被滥称为"可忽略空白"。 |
...
| [getNodeName](../../com.aspose.html.dom/cdatasection/nodename/) 此节点的名称，取决于其类型。 |
| [getNodeType](../../com.aspose.html.dom/cdatasection/nodetype/) 表示底层对象类型的代码。 |
| [nodeValue](../../com.aspose.html.dom/text/nodevalue/) { get; set; } | 此节点的值，取决于其类型。 |
...
| [textContent](../../com.aspose.html.dom/text/textcontent/) { get; set; } | 此属性返回该节点及其后代的文本内容。当其被定义为 null 时，设置该属性没有任何效果。设置时，节点可能拥有的所有子节点将被移除，如果新的字符串既不为空也不为 null，则会被一个包含该字符串的单一 Text 节点所取代。 |
| [getWholeText](../../com.aspose.html.dom/text/wholetext/) 返回与此节点逻辑相邻的所有 Text 节点的文本，按文档顺序连接。 |
...
| [normalize](../../com.aspose.html.dom/node/normalize/)() | 将此节点下子树的全部深度中的所有[`Text`](../text/)节点（包括属性节点）放入一种"正常"形式，即只有结构（例如[`elements`](../element/)、[`comments`](../comment/)、[`processing instructions`](../processinginstruction/)、`CDATA sections`和[`entity references`](../entityreference/)）将[`Text`](../text/)节点分隔开，换句话说，不会出现相邻的 Text 节点或空的 Text 节点。此操作可用于确保文档的 DOM 视图与保存后重新加载时的视图相同，并在需要依赖特定文档树结构的操作（例如 XPointer [XPointer] 查找）时非常有用。如果附加到[`Node.ownerDocument`](../node/ownerdocument/)的[`DOMConfiguration`](../../com.aspose.html/configuration/)对象的参数 "normalize-characters" 为 true，则此方法还会完全规范化 Text 节点的字符。 |
...
| [replaceWholeText](../../com.aspose.html.dom/text/replacewholetext/)(String) | 用指定的文本替换当前节点及所有逻辑相邻的文本节点的内容。所有逻辑相邻的文本节点都会被移除，包括当前节点，除非它是替换文本的接收者。 |
| [splitText](../../com.aspose.html.dom/text/splittext/)(int) | 在指定的偏移位置将此节点拆分为两个节点，并将它们作为兄弟节点保留在树中。 |
