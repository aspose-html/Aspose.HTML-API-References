...
description: "com.aspose.html.dom.CDATASection 类。CDATA 区段用于转义包含本应被视为标记的字符的文本块。"
type: docs
...
| [getIsElementContentWhitespace](../../com.aspose.html.dom/text/iselementcontentwhitespace/) 返回此文本节点是否包含元素内容空白，通常被误称为“可忽略空白”。 |
...
| [normalize](../../com.aspose.html.dom/node/normalize/)() | 将此节点下子树的全部深度中的所有[`Text`](../text/)节点（包括属性节点）放入一种\"正常\"形式，其中仅有结构（例如[`elements`](../element/)、[`comments`](../comment/)、[`processing instructions`](../processinginstruction/)、`CDATA sections`和[`entity references`](../entityreference/)）将[`Text`](../text/)节点分隔开，即不存在相邻的 Text 节点或空的 Text 节点。此操作可用于确保文档的 DOM 视图与保存后重新加载时的视图相同，并在需要依赖特定文档树结构的操作（如 XPointer [XPointer] 查找）时非常有用。如果附加到[`Node.ownerDocument`](../node/ownerdocument/)的[`DOMConfiguration`](../../com.aspose.html/configuration/)对象的参数 \"normalize-characters\" 为 true，则此方法还会完全规范化 Text 节点的字符。 |
...
| [splitText](../../com.aspose.html.dom/text/splittext/)(int) | 在指定的偏移处将此节点拆分为两个节点，并保持它们在树中作为兄弟节点。 |
