...
description: "com.aspose.html.dom.Element 类。Element 接口表示 HTML 或 XML 文档中的元素。"
type: docs

url: /zh/java/com.aspose.html.dom/element/
---
## Element class

Element 接口表示 HTML 或 XML 文档中的元素。
...
| 名称 | 描述 |
| --- | --- |
| [Element](element/)(QualifiedName, Document) | 初始化 `Element` 类的新实例。不要直接调用此构造函数，请使用 [`CreateElement`](../document/createelement/) 或 [`CreateElementNS`](../document/createelementns/)。 |
...
| [getParentElement](../../com.aspose.html.dom/node/parentelement/) 只读的 parentElement 属性（来自 [`Node`](../node/) 接口）返回 DOM 节点的父 `Element`，如果节点没有父节点或其父节点不是 DOM Element，则返回 null。 |
...
| [getElementsByClassName](../../com.aspose.html.dom/element/getelementsbyclassname/)(String) | 返回包含 `element` 中所有具有参数中指定类的元素的 [`HTMLCollection`](../../com.aspose.html.collections/htmlcollection/) 对象。 |
| [getElementsByTagName](../../com.aspose.html.dom/element/getelementsbytagname/)(String) | 返回按文档顺序包含具有给定标签名的所有 `elements` 的 [`HTMLCollection`](../../com.aspose.html.collections/htmlcollection/) 对象。 |
| [getElementsByTagNameNS](../../com.aspose.html.dom/element/getelementsbytagnamens/)(String, String) | 返回按文档顺序包含具有给定本地名称和包 URI 字符串的所有 `elements` 的 [`HTMLCollection`](../../com.aspose.html.collections/htmlcollection/) 对象。 |
...
| [normalize](../../com.aspose.html.dom/node/normalize/)() | 将此节点下子树的全部深度中的所有 [`Text`](../text/) 节点（包括属性节点）转换为"normal"形式，即只有结构（例如 `elements`、[`comments`](../comment/)、[`processing instructions`](../processinginstruction/)、[`CDATA sections`](../cdatasection/)、以及 [`entity references`](../entityreference/)）将 [`Text`](../text/) 节点分隔开，换句话说，不会出现相邻的 Text 节点或空的 Text 节点。此操作可用于确保文档的 DOM 视图与保存后重新加载时相同，并在需要依赖特定文档树结构的操作（例如 XPointer [XPointer] 查找）时非常有用。如果附加到 [`Node.ownerDocument`](../node/ownerdocument/) 的 [`DOMConfiguration`](../../com.aspose.html/configuration/) 对象的参数 "normalize-characters" 为 true，则此方法还会完全规范化 Text 节点的字符。 |
...
| [toggleAttribute](../../com.aspose.html.dom/element/toggleattribute/#toggleattribute)(String) | 如果未提供 force，则切换 qualifiedName：如果已存在则移除，未存在则添加。如果 force 为 true，则添加 qualifiedName；如果 force 为 false，则移除 qualifiedName。 |
| [toggleAttribute](../../com.aspose.html.dom/element/toggleattribute/#toggleattribute_1)(String, bool) | 如果未提供 force，则切换 qualifiedName：如果已存在则移除，未存在则添加。如果 force 为 true，则添加 qualifiedName；如果 force 为 false，则移除 qualifiedName。 |
