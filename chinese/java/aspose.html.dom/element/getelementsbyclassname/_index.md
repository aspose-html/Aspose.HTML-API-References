...
description: "Element 方法。返回 HTMLCollection 对象，包含 element 中具有参数中指定的所有类的所有元素。"
type: docs
...
返回 [`HTMLCollection`](../../../com.aspose.html.collections/htmlcollection/) 对象，包含 [`element`](../) 中具有参数中指定的所有类的所有元素。
...
[`HTMLCollection`](../../../com.aspose.html.collections/htmlcollection/) 对象是一个类似数组的 [`elements`](../) 列表。
