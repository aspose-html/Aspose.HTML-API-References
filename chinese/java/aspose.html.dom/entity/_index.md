...
| [getNotationName](../../com.aspose.html.dom/entity/notationname/) 对于未解析实体，表示实体的标记名称。对于已解析实体，则为 null。 |
...
| [getPublicId](../../com.aspose.html.dom/entity/publicid/) 与实体关联的公共标识符（如果已指定），否则为 null。 |
| [getSystemId](../../com.aspose.html.dom/entity/systemid/) 与实体关联的系统标识符（如果已指定），否则为 null。它可以是绝对 URI，也可以不是。 |
| [textContent](../../com.aspose.html.dom/node/textcontent/) { get; set; } | `[`Node`](../node/)` 接口的 textContent 属性表示节点及其后代的文本内容。 |
| [getXmlEncoding](../../com.aspose.html.dom/entity/xmlencoding/) 当它是外部已解析实体时，作为文本声明的一部分，指定此实体的编码的属性。否则为 null。 |
| [getXmlVersion](../../com.aspose.html.dom/entity/xmlversion/) 当它是外部已解析实体时，作为文本声明的一部分，指定此实体的版本号的属性。否则为 null。 |
