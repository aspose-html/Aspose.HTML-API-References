...
description: "com.aspose.html.dom.Entity 类。表示 XML 文档中已知的实体，可为已解析或未解析的实体。"
type: docs

url: /zh/java/com.aspose.html.dom/entity/
---
## Entity class

表示 XML 文档中已知的实体，可以是已解析的或未解析的。
...
| [getInputEncoding](../../com.aspose.html.dom/entity/inputencoding/) 一个属性，指定在解析时此实体使用的编码（当它是外部已解析实体时）。如果它是内部子集中的实体或未知，则为 null。 |
...
| [getNodeName](../../com.aspose.html.dom/entity/nodename/) 此节点的名称，取决于其类型。 |
| [getNodeType](../../com.aspose.html.dom/entity/nodetype/) 表示底层对象类型的代码。 |
| [nodeValue](../../com.aspose.html.dom/node/nodevalue/) { get; set; } | [`Node `](../node/) 接口的 nodeValue 属性返回或设置当前节点的值。 |
| [getNotationName](../../com.aspose.html.dom/entity/notationname/) 对于未解析的实体，返回实体的标记名称。对于已解析的实体，则为 null。 |
...
| [getPublicId](../../com.aspose.html.dom/entity/publicid/) 如果已指定，则返回与实体关联的公共标识符，否则为 null。 |
| [getSystemId](../../com.aspose.html.dom/entity/systemid/) 如果已指定，则返回与实体关联的系统标识符，否则为 null。它可能是绝对 URI，也可能不是。 |
| [textContent](../../com.aspose.html.dom/node/textcontent/) { get; set; } | [`Node`](../node/) 接口的 textContent 属性表示节点及其后代的文本内容。 |
| [getXmlEncoding](../../com.aspose.html.dom/entity/xmlencoding/) 当它是外部已解析实体时，作为文本声明的一部分，指定此实体的编码。否则为 null。 |
| [getXmlVersion](../../com.aspose.html.dom/entity/xmlversion/) 当它是外部已解析实体时，作为文本声明的一部分，指定此实体的版本号。否则为 null。 |
