---
title: "SVGTextPathElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.dom.svg.SVGTextPathElement 类。SVGTextPathElement 接口对应于 textPath 元素"
type: docs

url: /zh/java/com.aspose.html.dom.svg/svgtextpathelement/
---
## SVGTextPathElement class

该 SVGTextPathElement 接口对应于 ‘textPath’ 元素。
...
| [getHref](../../com.aspose.html.dom.svg/svgtextpathelement/href/) 对应于给定元素的属性 ‘xlink:href’。 |
[getId]
...
| [getLengthAdjust](../../com.aspose.html.dom.svg/svgtextcontentelement/lengthadjust/) 对应于给定元素的属性 ‘lengthAdjust’。该值必须是此接口中定义的长度调整常量之一。 |
...
| [getMethod](../../com.aspose.html.dom.svg/svgtextpathelement/method/) 对应于给定 ‘textPath’ 元素的属性 ‘method’。 |
...
| [getSpacing](../../com.aspose.html.dom.svg/svgtextpathelement/spacing/) 对应于给定 ‘textPath’ 元素的属性 ‘spacing’。 |
| [getStartOffset](../../com.aspose.html.dom.svg/svgtextpathelement/startoffset/) 对应于给定 ‘textPath’ 元素的属性 ‘startOffset’。 |
...
| [getTextLength](../../com.aspose.html.dom.svg/svgtextcontentelement/textlength/) 对应于给定元素的属性 ‘textLength’。 |
...
| [getComputedTextLength](../../com.aspose.html.dom.svg/svgtextcontentelement/getcomputedtextlength/)() | 此元素中渲染的所有字符的所有前进值的总和，包括字形（水平或垂直）的前进值、属性 ‘kerning’、‘letter-spacing’ 和 ‘word-spacing’ 的影响以及 ‘tspan’ 元素上属性 ‘dx’ 和 ‘dy’ 的调整。对于非渲染环境，用户代理应对字形度量做出合理假设。 |
...
| [getNumberOfChars](../../com.aspose.html.dom.svg/svgtextcontentelement/getnumberofchars/)() | 返回当前元素中可用于渲染的字符总数，包括来自 ‘tref’ 引用的字符，无论它们是否会被渲染。实际上，这相当于 DOM Level 3 Core（[DOM3]，第 1.4 节）中 Node::textContent 属性的长度，如果该属性也展开了 ‘tref’ 元素的话。 |
...
| 名称 | 描述 |
| --- | --- |
| const [TEXTPATH_METHODTYPE_ALIGN](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_align/) | 对应于值 'align'。 |
| const [TEXTPATH_METHODTYPE_STRETCH](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_stretch/) | 对应于值 'stretch'。 |
| const [TEXTPATH_METHODTYPE_UNKNOWN](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_unknown/) | 枚举被设置为不是预定义类型之一的值。尝试定义此类型的新值或尝试将现有值切换到此类型都是无效的。 |
| const [TEXTPATH_SPACINGTYPE_AUTO](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_auto/) | 对应于值 'auto'。 |
| const [TEXTPATH_SPACINGTYPE_EXACT](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_exact/) | 对应于值 'exact'。 |
| const [TEXTPATH_SPACINGTYPE_UNKNOWN](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_unknown/) | 枚举被设置为不是预定义类型之一的值。尝试定义此类型的新值或尝试将现有值切换到此类型都是无效的。 |
