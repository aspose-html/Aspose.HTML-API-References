...
SVGTextPathElement 接口对应于 ‘textPath’ 元素。
...
| [getComputedTextLength](../../com.aspose.html.dom.svg/svgtextcontentelement/getcomputedtextlength/)() | 该元素内所有字符渲染产生的前进值的总和，包括字形（水平或垂直）的前进值、属性 ‘kerning’、‘letter-spacing’ 和 ‘word-spacing’ 的影响以及 ‘tspan’ 元素上属性 ‘dx’ 和 ‘dy’ 的调整。对于非渲染环境，用户代理应对字形度量作出合理假设。 |
...
| [getNumberOfChars](../../com.aspose.html.dom.svg/svgtextcontentelement/getnumberofchars/)() | 返回当前元素中可用于渲染的字符总数，包括来自 ‘tref’ 引用的字符，无论它们是否会被渲染。实际上，这相当于 DOM Level 3 Core（[DOM3]，第 1.4 节）中 Node::textContent 属性的长度，如果该属性同样展开了 ‘tref’ 元素的话。 |
