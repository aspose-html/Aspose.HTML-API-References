...
description: "com.aspose.html.dom.svg.SVGPathElement 类。SVGPathElement 接口对应 path 元素。"
type: docs
...
| 名称 | 描述 |
| --- | --- |
| [getAnimatedPathSegList](../../com.aspose.html.dom.svg/svgpathelement/animatedpathseglist/) 提供对 ‘d’ 属性当前动画内容的访问，形式与 SVG 语法一一对应。如果给定的属性或属性正在动画中，则包含该属性或属性的当前动画值，且对象本身及其内容均为只读。如果给定的属性或属性当前未动画，则包含与 pathSegList 相同的值。 |
...
| [getClassName](../../com.aspose.html.dom.svg/svgelement/classname/) 对应给定元素的 ‘class’ 属性。 |
[getClassName]
...
| [getNearestViewportElement](../../com.aspose.html.dom.svg/svggraphicselement/nearestviewportelement/) 确立当前视口的元素。通常是最近的祖先 ‘svg’ 元素。如果当前元素是最外层的 svg 元素，则为 Null。 |
...
| [getRequiredExtensions](../../com.aspose.html.dom.svg/svggraphicselement/requiredextensions/) 对给定元素的 ‘requiredExtensions’ 属性对应。 |
| [getRequiredFeatures](../../com.aspose.html.dom.svg/svggraphicselement/requiredfeatures/) 对给定元素的 ‘requiredFeatures’ 属性对应。 |
...
| [getSystemLanguage](../../com.aspose.html.dom.svg/svggraphicselement/systemlanguage/) 对给定元素的 ‘systemLanguage’ 属性对应。 |
...
| [getTransform](../../com.aspose.html.dom.svg/svggraphicselement/transform/) 对给定元素的 ‘transform’ 属性对应。 |
| [getViewportElement](../../com.aspose.html.dom.svg/svgelement/viewportelement/) 建立当前视口的元素。通常为最近的祖先 ‘svg’ 元素。如果给定元素是最外层的 svg 元素，则为 null。 |
...
| [getBBox](../../com.aspose.html.dom.svg/svggraphicselement/getbbox/)() | 返回当前用户空间（即在应用 ‘transform’ 属性后，如果有的话）中所有包含的图形元素几何形状的紧密边界框，不包括描边、裁剪、遮罩和滤镜效果。注意，getBBox 必须在调用方法时返回实际的边界框，即使元素尚未渲染。 |
| [getCTM](../../com.aspose.html.dom.svg/svggraphicselement/getctm/)() | 返回从当前用户单位（即在应用 ‘transform’ 属性后，如果有的话）到最近的 nearestViewportElement 的视口坐标系的变换矩阵。 |
...
| [getScreenCTM](../../com.aspose.html.dom.svg/svggraphicselement/getscreenctm/)() | 返回从当前用户单位（即在应用 ‘transform’ 属性后，如果有的话）到父用户代理所感知的 “像素” 的变换矩阵。对于显示设备，这理想情况下代表物理屏幕像素。对于其他设备或未知物理像素尺寸的环境，可使用类似 CSS2 中 “像素” 定义的算法。注意，如果该元素未挂载到文档树中，则返回 null。该方法本可以更恰当地命名为 getClientCTM，但出于历史原因仍保留名称 getScreenCTM。 |
