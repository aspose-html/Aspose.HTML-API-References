---
title: "SVGPathElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.dom.svg.SVGPathElement class. SVGPathElement 接口对应 path 元素。"
type: docs

url: /zh/java/com.aspose.html.dom.svg/svgpathelement/
---
## SVGPathElement class

该 SVGPathElement 接口对应于 ‘path’ 元素。
...
| 名称 | 描述 |
| --- | --- |
| [getAnimatedPathSegList](../../com.aspose.html.dom.svg/svgpathelement/animatedpathseglist/) 提供对 ‘d’ 属性当前动画内容的访问，形式与 SVG 语法一一对应。如果给定的属性或属性正在动画中，则包含该属性或属性的当前动画值，并且对象本身及其内容均为只读。如果给定的属性或属性当前未动画，则包含与 pathSegList 相同的值。 |
...
| [getChildElementCount](../../com.aspose.html.dom/element/childelementcount/) 返回当前作为此元素子节点的元素节点数量。如果此元素没有 nodeType 为 1 的子节点，则返回 0。 |
...
| [getClassName](../../com.aspose.html.dom.svg/svgelement/classname/) 对应于给定元素的 ‘class’ 属性。 |
[getClassName]
...
| [getFarthestViewportElement](../../com.aspose.html.dom.svg/svggraphicselement/farthestviewportelement/) 最远的祖先 ‘svg’ 元素。如果当前元素是最外层的 svg 元素，则为 Null。 |
...
| [getNamespaceURI](../../com.aspose.html.dom/element/packageuri/) 此节点的包 URI，如果未指定则为 null。 |
| [getNearestViewportElement](../../com.aspose.html.dom.svg/svggraphicselement/nearestviewportelement/) 建立当前视口的元素。通常是最近的祖先 ‘svg’ 元素。如果当前元素是最外层的 svg 元素，则为 Null。 |
...
| [getNodeName](../../com.aspose.html.dom/element/nodename/) 根据节点类型返回此节点的名称。 |
...
| [getOwnerSVGElement](../../com.aspose.html.dom.svg/svgelement/ownersvgelement/) 最近的祖先 ‘svg’ 元素。如果给定元素是最外层的 svg 元素，则为 Null。 |
...
| [getPathLength](../../com.aspose.html.dom.svg/svggeometryelement/pathlength/) 对应于给定元素上的属性 pathLength。 |
[getPathSegList]
...
| [getPrefix](../../com.aspose.html.dom/element/prefix/) 此节点的包前缀，如果未指定则为 null。当其被定义为 null 时，设置该属性没有任何效果。 |
...
| [getRequiredExtensions](../../com.aspose.html.dom.svg/svggraphicselement/requiredextensions/) 对应给定元素的 ‘requiredExtensions’ 属性。 |
| [getRequiredFeatures](../../com.aspose.html.dom.svg/svggraphicselement/requiredfeatures/) 对应给定元素的 ‘requiredFeatures’ 属性。 |
| [getShadowRoot](../../com.aspose.html.dom/element/shadowroot/) 返回存储在此元素上的 shadowRoot，如果它已关闭则为 null。 |
| [getStyle](../../com.aspose.html.dom.svg/svgelement/style/) 对应给定元素的 ‘style’ 属性。如果用户代理不支持使用 CSS 进行样式设置，则此属性必须始终为 null。 |
| [getSystemLanguage](../../com.aspose.html.dom.svg/svggraphicselement/systemlanguage/) 对应给定元素的 ‘systemLanguage’ 属性。 |
| [getTagName](../../com.aspose.html.dom/element/tagname/) 元素的名称。 |
| [textContent](../../com.aspose.html.dom/element/textcontent/) { get; set; } | 此属性返回该节点及其后代的文本内容。当其被定义为 null 时，设置该属性没有任何效果。设置时，节点可能拥有的所有子节点将被移除，如果新的字符串既不为空也不为 null，则会被一个包含该字符串的单一 Text 节点所取代。 |
| [getTransform](../../com.aspose.html.dom.svg/svggraphicselement/transform/) 对应给定元素的 ‘transform’ 属性。 |
| [getViewportElement](../../com.aspose.html.dom.svg/svgelement/viewportelement/) 确定当前视口的元素。通常为最近的祖先 ‘svg’ 元素。如果给定元素是最外层的 svg 元素，则为 Null。 |
...
| [createSVGPathSegArcAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegarcabs/)(float, float, float, float, float, bool, bool) | 返回一个独立的、无父级的 SVGPathSegArcAbs 对象。 |
| [createSVGPathSegArcRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegarcrel/)(float, float, float, float, float, bool, bool) | 返回一个独立的、无父级的 SVGPathSegArcRel 对象。 |
| [createSVGPathSegClosePath](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegclosepath/)() | 返回一个独立的、无父级的 SVGPathSegClosePath 对象。 |
| [createSVGPathSegCurvetoCubicAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicabs/)(float, float, float, float, float, float) | 返回一个独立的、无父级的 SVGPathSegCurvetoCubicAbs 对象。 |
| [createSVGPathSegCurvetoCubicRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicrel/)(float, float, float, float, float, float) | 返回一个独立的、无父级的 SVGPathSegCurvetoCubicRel 对象。 |
| [createSVGPathSegCurvetoCubicSmoothAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothabs/)(float, float, float, float) | 返回一个独立的、无父级的 SVGPathSegCurvetoCubicSmoothAbs 对象。 |
| [createSVGPathSegCurvetoCubicSmoothRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothrel/)(float, float, float, float) | 返回一个独立的、无父级的 SVGPathSegCurvetoCubicSmoothRel 对象。 |
| [createSVGPathSegCurvetoQuadraticAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticabs/)(float, float, float, float) | 返回一个独立的、无父级的 SVGPathSegCurvetoQuadraticAbs 对象。 |
| [createSVGPathSegCurvetoQuadraticRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticrel/)(float, float, float, float) | 返回一个独立的、无父级的 SVGPathSegCurvetoQuadraticRel 对象。 |
| [createSVGPathSegCurvetoQuadraticSmoothAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothabs/)(float, float) | 返回一个独立的、无父级的 SVGPathSegCurvetoQuadraticSmoothAbs 对象。 |
| [createSVGPathSegCurvetoQuadraticSmoothRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothrel/)(float, float) | 返回一个独立的、无父级的 SVGPathSegCurvetoQuadraticSmoothRel 对象。 |
| [createSVGPathSegLinetoAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoabs/)(float, float) | 返回一个独立的、无父级的 SVGPathSegLinetoAbs 对象。 |
| [createSVGPathSegLinetoHorizontalAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetohorizontalabs/)(float) | 返回一个独立的、无父级的 SVGPathSegLinetoHorizontalAbs 对象。 |
| [createSVGPathSegLinetoHorizontalRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetohorizontalrel/)(float) | 返回一个独立的、无父级的 SVGPathSegLinetoHorizontalRel 对象。 |
| [createSVGPathSegLinetoRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetorel/)(float, float) | 返回一个独立的、无父级的 SVGPathSegLinetoRel 对象。 |
| [createSVGPathSegLinetoVerticalAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoverticalabs/)(float) | 返回一个独立的、无父级的 SVGPathSegLinetoVerticalAbs 对象。 |
| [createSVGPathSegLinetoVerticalRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoverticalrel/)(float) | 返回一个独立的、无父级的 SVGPathSegLinetoVerticalRel 对象。 |
| [createSVGPathSegMovetoAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegmovetoabs/)(float, float) | 返回一个独立的、无父级的 SVGPathSegMovetoAbs 对象。 |
| [createSVGPathSegMovetoRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegmovetorel/)(float, float) | 返回一个独立的、无父级的 SVGPathSegMovetoRel 对象。 |
...
| [getAttributeNames](../../com.aspose.html.dom/element/getattributenames/)() | 以字符串数组的形式返回元素的属性名称。如果元素没有属性，则返回空数组。 |
...
| [getBBox](../../com.aspose.html.dom.svg/svggraphicselement/getbbox/)() | 返回当前用户空间中所有包含的图形元素的几何形状的紧密边界框（即在应用了 ‘transform’ 属性（如果有）之后），不包括描边、裁剪、遮罩和滤镜效果）。请注意，getBBox 必须在调用方法时返回实际的边界框，即使该元素尚未渲染。 |
| [getCTM](../../com.aspose.html.dom.svg/svggraphicselement/getctm/)() | 返回从当前用户单位（即在应用了 ‘transform’ 属性（如果有）之后）到最近的 nearestViewportElement 的视口坐标系的变换矩阵。 |
| [getElementsByClassName](../../com.aspose.html.dom/element/getelementsbyclassname/)(String) | 返回包含 [`element`](../../com.aspose.html.dom/element/) 中所有具有参数中指定的所有类的元素的 [`HTMLCollection`](../../com.aspose.html.collections/htmlcollection/) 对象。 |
| [getElementsByTagName](../../com.aspose.html.dom/element/getelementsbytagname/)(String) | 返回按文档顺序包含所有具有给定标签名的 [`elements`](../../com.aspose.html.dom/element/) 的 [`HTMLCollection`](../../com.aspose.html.collections/htmlcollection/) 对象。 |
| [getElementsByTagNameNS](../../com.aspose.html.dom/element/getelementsbytagnamens/)(String, String) | 返回按文档顺序包含所有具有给定本地名称和包 URI 字符串的 [`elements`](../../com.aspose.html.dom/element/) 的 [`HTMLCollection`](../../com.aspose.html.collections/htmlcollection/) 对象。 |
| [getEquivalentPath](../../com.aspose.html.dom.svg/svggeometryelement/getequivalentpath/)() | 返回一个新的 [`SVGPathSegList`](../../com.aspose.html.dom.svg.paths/svgpathseglist/) 实例，该实例将 [`SVGGeometryElement`](../svggeometryelement/) 表示为路径段。 |
| [getPlatformType](../../com.aspose.html.dom/domobject/getplatformtype/)() | 此方法用于检索 ECMAScript 对象。 |
| [getPointAtLength](../../com.aspose.html.dom.svg/svggeometryelement/getpointatlength/)(float) | 返回用户空间中的 (x,y) 坐标，该坐标是沿路径的距离单位，使用用户代理的沿路径距离算法。 |
| [getScreenCTM](../../com.aspose.html.dom.svg/svggraphicselement/getscreenctm/)() | 返回从当前用户单位（即在应用了 ‘transform’ 属性（如果有）之后）到父用户代理所感知的 \"pixel\" 的变换矩阵。对于显示设备，理想情况下这代表物理屏幕像素。对于其他设备或物理像素大小未知的环境，则可以使用类似 CSS2 对 \"pixel\" 定义的算法。注意，如果该元素未挂载到文档树中，则返回 null。该方法本可以更恰当地命名为 getClientCTM，但出于历史原因仍保留名称 getScreenCTM。 |
| [getTotalLength](../../com.aspose.html.dom.svg/svggeometryelement/gettotallength/)() | 返回用户代理使用沿路径距离算法计算的路径总长度值，以当前用户坐标系中的距离表示。 |
...
| [hasAttributes](../../com.aspose.html.dom/element/hasattributes/)() | 返回此节点（如果是元素）是否拥有任何属性 |
...
| [querySelector](../../com.aspose.html.dom/element/queryselector/)(String) | 返回文档中匹配选择器的第一个 Element。 |
| [querySelectorAll](../../com.aspose.html.dom/element/queryselectorall/)(String) | 返回文档中匹配选择器的所有 Elements 的 NodeList。 |
...
| [setAttribute](../../com.aspose.html.dom/element/setattribute/)(String, String) | 添加一个新属性。如果元素中已存在同名属性，则其值会被更改为 value 参数的值。 |
| [setAttributeNode](../../com.aspose.html.dom/element/setattributenode/)(Attr) | 添加一个新属性节点。如果元素中已存在同名属性（nodeName），则会被新属性替换。 |
| [setAttributeNodeNS](../../com.aspose.html.dom/element/setattributenodens/)(Attr) | 添加一个新属性。如果元素中已存在具有相同本地名称和包 URI 的属性，则会被新属性替换。 |
| [setAttributeNS](../../com.aspose.html.dom/element/setattributens/)(String, String, String) | 添加一个新属性。如果元素上已存在具有相同本地名称和包 URI 的属性，则其前缀会更改为 qualifiedName 的前缀部分，且其值会更改为 value 参数的值。 |
| [toggleAttribute](../../com.aspose.html.dom/element/toggleattribute/)(String) | 如果未提供 force，则切换 qualifiedName：如果已存在则移除，未存在则添加。如果 force 为 true，则添加 qualifiedName；如果 force 为 false，则移除 qualifiedName。 |
| [toggleAttribute](../../com.aspose.html.dom/element/toggleattribute/)(String, bool) | 如果未提供 force，则切换 qualifiedName：如果已存在则移除，未存在则添加。如果 force 为 true，则添加 qualifiedName；如果 force 为 false，则移除 qualifiedName。 |
