...
description: "SVGDocument 构造函数。初始化 SVGDocument 类的新实例。"
type: docs

url: /zh/java/com.aspose.html.dom.svg/svgdocument/svgdocument/
---
...
初始化 [`SVGDocument`](../) 类的新实例。构造函数同步工作，会等待所有外部资源（图像、脚本等）的加载。要异步加载文档，请使用方法 [`Navigate`](../../../com.aspose.html.dom/document/navigate/) 或其重载。或者，您可以通过在 [`Security`](../../../com.aspose.html.dom/ibrowsingcontext/security/) 中设置相应标志来禁用某些外部资源的加载。
...
初始化 [`SVGDocument`](../) 类的新实例。构造函数同步工作，会等待所有外部资源（图像、脚本等）的加载。要异步加载文档，请使用方法 [`Navigate`](../../../com.aspose.html.dom/document/navigate/) 或其重载。或者，您可以通过在 [`Security`](../../../com.aspose.html.dom/ibrowsingcontext/security/) 中设置相应标志来禁用某些外部资源的加载。文档加载从流的当前位置开始。
