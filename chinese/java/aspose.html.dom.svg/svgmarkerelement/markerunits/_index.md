...
description: "SVGMarkerElement 属性。对应于给定 marker 元素上的属性 markerUnits。此接口中定义的标记单位类型之一。"
type: docs

url: /zh/java/com.aspose.html.dom.svg/svgmarkerelement/markerunits/
---
## SVGMarkerElement.MarkerUnits property

对应于给定 ‘marker’ 元素上的属性 ‘markerUnits’。此接口中定义的标记单位类型之一。
