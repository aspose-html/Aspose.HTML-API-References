...
description: "SVGViewElement 属性。对应于给定元素上的属性 zoomAndPan。该值必须是此接口上定义的 SVG_ZOOMANDPAN_ 常量之一"
type: docs

url: /zh/java/com.aspose.html.dom.svg/svgviewelement/zoomandpan/
---
## SVGViewElement.ZoomAndPan property

对应给定元素的属性 ‘zoomAndPan’。该值必须是此接口上定义的 SVG_ZOOMANDPAN_* 常量之一。
