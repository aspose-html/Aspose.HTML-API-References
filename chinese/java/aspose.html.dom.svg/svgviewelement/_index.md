...
| [getViewTarget](../../com.aspose.html.dom.svg/svgviewelement/viewtarget/) 对应于给定 ‘view’ 元素的属性 ‘viewTarget’。一个包含 ‘viewTarget’ 属性中列出的名称的 DOMString 值列表。每个 DOMString 值可通过调用 getElementById() 方法与相应的元素关联。 |
[getZoomAndPan]
