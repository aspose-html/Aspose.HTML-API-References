...
description: "com.aspose.html.dom.svg.SVGElement 类。所有直接对应于 SVG 语言中元素的 SVG DOM 接口（例如对应 path 元素的 SVGPathElement 接口）均派生自 SVGElement 接口。"
type: docs
...
所有直接对应于 SVG 语言中元素的 SVG DOM 接口（例如对应 ‘path’ 元素的 SVGPathElement 接口）均派生自 SVGElement 接口。
