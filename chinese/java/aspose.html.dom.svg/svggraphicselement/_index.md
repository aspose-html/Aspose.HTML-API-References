---
title: "SVGGraphicsElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.dom.svg.SVGGraphicsElement 类。SVGGraphicsElement 接口表示其主要目的是直接在组中渲染图形的 SVG 元素"
type: docs

url: /zh/java/com.aspose.html.dom.svg/svggraphicselement/
---
## SVGGraphicsElement class

SVGGraphicsElement 接口表示其主要目的是直接在组中渲染图形的 SVG 元素。
