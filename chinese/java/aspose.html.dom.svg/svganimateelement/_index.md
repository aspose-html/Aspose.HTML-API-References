---
title: "SVGAnimateElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.dom.svg.SVGAnimateElement 类。SVGAnimateElement 接口对应于 animate 元素。通过 SVG DOM 对 animate 元素属性的面向对象访问不可用。"
type: docs

url: /zh/java/com.aspose.html.dom.svg/svganimateelement/
---
## SVGAnimateElement class

SVGAnimateElement 接口对应于 ‘animate’ 元素。通过 SVG DOM 进行面向对象的访问以获取 ‘animate’ 元素的属性不可用。
