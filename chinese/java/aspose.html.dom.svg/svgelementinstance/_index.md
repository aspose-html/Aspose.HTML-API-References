---
title: "SVGElementInstance 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.dom.svg.SVGElementInstance 类。每个 use-element 阴影树的根对象实现 SVGUseElementShadowRoot 接口。该接口目前未对 ShadowRoot 接口和 DocumentOrShadowRoot mixin 定义的属性和方法进行任何扩展。然而，以作者脚本的视角来看，以此节点为根的树是完全只读的。"
type: docs

url: /zh/java/com.aspose.html.dom.svg/svgelementinstance/
---
## SVGElementInstance class

每个 use-element 阴影树的根对象实现了 SVGUseElementShadowRoot 接口。该接口目前未对 ShadowRoot 接口和 DocumentOrShadowRoot 混入定义的属性和方法进行任何扩展。然而，从作者脚本的角度来看，以此节点为根的树完全是只读的。
