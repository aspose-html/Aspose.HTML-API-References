---
title: "SVGSetElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.dom.svg.SVGSetElement 类。SVGSetElement 接口对应于 set 元素。通过 SVG DOM 对 set 元素属性的面向对象访问不可用"
type: docs

url: /zh/java/com.aspose.html.dom.svg/svgsetelement/
---
## SVGSetElement class

该 SVGSetElement 接口对应于 ‘set’ 元素。通过 SVG DOM 对 ‘set’ 元素属性的面向对象访问不可用。
