---
title: "SVGGeometryElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.dom.svg.SVGGeometryElement 类。接口 SVGGeometryElement 表示渲染由几何形状及等效路径定义且可以填充和描边的 SVG 元素。这包括路径和基本形状。"
type: docs

url: /zh/java/com.aspose.html.dom.svg/svggeometryelement/
---
## SVGGeometryElement class

SVGGeometryElement 接口表示其渲染由几何形状及等价路径定义且可以填充和描边的 SVG 元素。这包括路径和基本形状。
...
| [getEquivalentPath](../../com.aspose.html.dom.svg/svggeometryelement/getequivalentpath/)() | 返回一个新的 [`SVGPathSegList`](../../com.aspose.html.dom.svg.paths/svgpathseglist/) 实例，该实例将 `SVGGeometryElement` 表示为路径段。 |
