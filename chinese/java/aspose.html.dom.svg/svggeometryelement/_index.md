...
description: "com.aspose.html.dom.svg.SVGGeometryElement 类。接口 SVGGeometryElement 表示其渲染由几何形状及等效路径定义且可以填充和描边的 SVG 元素。这包括路径和基本形状。"
type: docs
...
SVGGeometryElement 接口表示其渲染由等价路径的几何形状定义且可以填充和描边的 SVG 元素。这包括路径和基本形状。
...
| [getEquivalentPath](../../com.aspose.html.dom.svg/svggeometryelement/getequivalentpath/)() | 返回一个新的实例，该实例是 [`SVGPathSegList`](../../com.aspose.html.dom.svg.paths/svgpathseglist/)，它将 `SVGGeometryElement` 表示为路径段。 |
