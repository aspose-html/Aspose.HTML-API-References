...
description: "SVGClipPathElement 属性。对应于给定 clipPath 元素上的属性 clipPathUnits。接受 SVGUnitTypes 中定义的常量之一。"
type: docs

url: /zh/java/com.aspose.html.dom.svg/svgclippathelement/clippathunits/
---
## SVGClipPathElement.ClipPathUnits property

对应于给定 ‘clipPath’ 元素上的属性 ‘clipPathUnits’。接受 SVGUnitTypes 中定义的常量之一。
