...
description: "SVGMaskElement 属性。对应于给定 mask 元素上的属性 maskContentUnits。取自 SVGUnitTypes 中定义的常量之一"
type: docs

url: /zh/java/com.aspose.html.dom.svg/svgmaskelement/maskcontentunits/
---
## SVGMaskElement.MaskContentUnits property

对应于给定 ‘mask’ 元素上的属性 ‘maskContentUnits’。取自 SVGUnitTypes 中定义的常量之一。
