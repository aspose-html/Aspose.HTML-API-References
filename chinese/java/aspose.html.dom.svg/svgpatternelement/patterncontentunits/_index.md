...
description: "SVGPatternElement 属性。对应给定 pattern 元素上的 patternContentUnits 属性。取自 SVGUnitTypes 中定义的常量之一。"
type: docs

url: /zh/java/com.aspose.html.dom.svg/svgpatternelement/patterncontentunits/
---
## SVGPatternElement.PatternContentUnits property

对应给定 ‘pattern’ 元素上的 ‘patternContentUnits’ 属性。取自 SVGUnitTypes 中定义的常量之一。
