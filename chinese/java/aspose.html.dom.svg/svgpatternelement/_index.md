...
description: "com.aspose.html.dom.svg.SVGPatternElement 类。SVGPatternElement 接口对应于 pattern 元素。"
type: docs
...
SVGPatternElement 接口对应于 ‘pattern’ 元素。
...
| [getHeight](../../com.aspose.html.dom.svg/svgpatternelement/height/) 对应于给定 ‘pattern’ 元素的属性 ‘height’。 |
| [getHref](../../com.aspose.html.dom.svg/svgpatternelement/href/) 对应于给定元素的属性 ‘xlink:href’。 |
[getId]
...
| [getPatternContentUnits](../../com.aspose.html.dom.svg/svgpatternelement/patterncontentunits/) 对应于给定 ‘pattern’ 元素的属性 ‘patternContentUnits’。取值为 SVGUnitTypes 中定义的常量之一。 |
| [getPatternTransform](../../com.aspose.html.dom.svg/svgpatternelement/patterntransform/) 对应于给定 ‘pattern’ 元素的属性 ‘patternTransform’。 |
| [getPatternUnits](../../com.aspose.html.dom.svg/svgpatternelement/patternunits/) 对应于给定 ‘pattern’ 元素的属性 ‘patternUnits’。取值为 SVGUnitTypes 中定义的常量之一。 |
| [getPrefix](../../com.aspose.html.dom/element/prefix/) 此节点的包前缀，若未指定则为 null。当其被定义为 null 时，设置它不会产生任何影响。 |
| [getPreserveAspectRatio](../../com.aspose.html.dom.svg/svgpatternelement/preserveaspectratio/) 对应于给定元素的属性 ‘preserveAspectRatio’。 |
...
| [getRequiredExtensions](../../com.aspose.html.dom.svg/svgpatternelement/requiredextensions/) 对应于给定元素的属性 ‘requiredExtensions’。 |
| [getRequiredFeatures](../../com.aspose.html.dom.svg/svgpatternelement/requiredfeatures/) 对应于给定元素的属性 ‘requiredFeatures’。 |
...
| [getSystemLanguage](../../com.aspose.html.dom.svg/svgpatternelement/systemlanguage/) 对应于给定元素的属性 ‘systemLanguage’。 |
...
| [getViewBox](../../com.aspose.html.dom.svg/svgpatternelement/viewbox/) 对应于给定元素的属性 ‘viewBox’。 |
...
| [getWidth](../../com.aspose.html.dom.svg/svgpatternelement/width/) 对应于给定 ‘pattern’ 元素的属性 ‘width’。 |
| [X](../../com.aspose.html.dom.svg/svgpatternelement/x/) { get; } | 对应于给定 ‘pattern’ 元素的属性 ‘x’。 |
| [Y](../../com.aspose.html.dom.svg/svgpatternelement/y/) { get; } | 对应于给定 ‘pattern’ 元素的属性 ‘y’。 |
