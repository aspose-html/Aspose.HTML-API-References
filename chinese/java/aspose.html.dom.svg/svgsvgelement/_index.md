...
description: "com.aspose.html.dom.svg.SVGSVGElement 类。关键接口定义是 SVGSVGElement 接口，它对应 svg 元素。该接口包含各种常用的实用方法，例如矩阵操作以及在视觉渲染设备上控制重绘时间的能力。"
type: docs
...
| [getHeight](../../com.aspose.html.dom.svg/svgsvgelement/height/) 对应给定 ‘svg’ 元素的属性 ‘height’。 |
[getId]
...
| [getPreserveAspectRatio](../../com.aspose.html.dom.svg/svgsvgelement/preserveaspectratio/) 对应给定元素的属性 ‘preserveAspectRatio’。 |
...
| [getViewBox](../../com.aspose.html.dom.svg/svgsvgelement/viewbox/) 对应给定元素的属性 ‘viewBox’。 |
...
| [getWidth](../../com.aspose.html.dom.svg/svgsvgelement/width/) 对应给定 ‘svg’ 元素的属性 ‘width’。 |
| [X](../../com.aspose.html.dom.svg/svgsvgelement/x/) { get; } | 对应给定 ‘svg’ 元素的属性 ‘x’。 |
| [Y](../../com.aspose.html.dom.svg/svgsvgelement/y/) { get; } | 对应给定 ‘svg’ 元素的属性 ‘y’。 |
[getZoomAndPan]
...
| [createSVGTransformFromMatrix](../../com.aspose.html.dom.svg/svgsvgelement/createsvgtransformfrommatrix/)(SVGMatrix) | 在任何文档树之外创建 SVGTransform 对象。该对象初始化为给定的矩阵变换（即 SVG_TRANSFORM_MATRIX）。参数矩阵的值被复制，矩阵参数不会被采用为 SVGTransform::matrix。 |
...
| [getElementById](../../com.aspose.html.dom.svg/svgsvgelement/getelementbyid/)(String) | 在此 SVG 文档片段中搜索（即搜索限制在文档树的子集）具有由 elementId 指定的 id 的 Element。如果找到该 Element，则返回该 Element。如果不存在此类元素，则返回 null。如果多个元素拥有相同的 id，则行为未定义。 |
...
| [pauseAnimations](../../com.aspose.html.dom.svg/svgsvgelement/pauseanimations/)() | 暂停（即暂停）在对应于此 ‘svg’ 元素的 SVG 文档片段中定义的所有当前运行的动画，使该文档片段的动画时钟保持静止，直至取消暂停。 |
...
| [setCurrentTime](../../com.aspose.html.dom.svg/svgsvgelement/setcurrenttime/)(float) | 调整此 SVG 文档片段的时钟，建立新的当前时间。如果在文档时间线开始之前调用 setCurrentTime（例如，在文档的 SVGLoad 事件分发之前，由 ‘script’ 元素中的脚本运行），则该方法最后一次调用中的秒数值表示文档时间线开始后文档将要跳转的时间。 |
...
| [unpauseAnimations](../../com.aspose.html.dom.svg/svgsvgelement/unpauseanimations/)() | 取消暂停（即，恢复）当前在 SVG 文档片段中定义的正在运行的动画，使动画时钟从暂停时的时间继续。 |
