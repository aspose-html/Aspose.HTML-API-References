...
description: "com.aspose.html.dom.svg.SVGSVGElement 类。关键的接口定义是 SVGSVGElement 接口，它对应于 svg 元素。该接口包含各种常用的实用方法，例如矩阵操作以及在可视渲染设备上控制重绘时间的能力。"
type: docs

url: /zh/java/com.aspose.html.dom.svg/svgsvgelement/
---
## SVGSVGElement class

关键的接口定义是 SVGSVGElement 接口，它是对应于 ‘svg’ 元素的接口。该接口包含各种常用的实用方法，例如矩阵运算以及控制可视渲染设备重绘时间的能力。
...
| [getCurrentTranslate](../../com.aspose.html.dom.svg/svgsvgelement/currenttranslate/) 在最外层的 svg 元素上，返回考虑用户“放大”后的对应平移因子。当在非最外层的 ‘svg’ 元素上访问时，此属性的行为未定义。 |
...
| [getHeight](../../com.aspose.html.dom.svg/svgsvgelement/height/) 对给定的 ‘svg’ 元素的属性 ‘height’ 对应。 |
[getId]
...
| [getPreserveAspectRatio](../../com.aspose.html.dom.svg/svgsvgelement/preserveaspectratio/) 对给定元素的属性 ‘preserveAspectRatio’ 对应。 |
...
| [getViewBox](../../com.aspose.html.dom.svg/svgsvgelement/viewbox/) 对给定元素的属性 ‘viewBox’ 对应。 |
...
| [getWidth](../../com.aspose.html.dom.svg/svgsvgelement/width/) 对给定的 ‘svg’ 元素的属性 ‘width’ 对应。 |
| [X](../../com.aspose.html.dom.svg/svgsvgelement/x/) { get; } | 对应于给定 ‘svg’ 元素的属性 ‘x’。 |
| [Y](../../com.aspose.html.dom.svg/svgsvgelement/y/) { get; } | 对应于给定 ‘svg’ 元素的属性 ‘y’。 |
[getZoomAndPan]
...
| [animationsPaused](../../com.aspose.html.dom.svg/svgsvgelement/animationspaused/)() | 如果此 SVG 文档片段处于暂停状态，则返回 true。 |
...
| [createEvent](../../com.aspose.html.dom.svg/svgsvgelement/createevent/)(String) | 创建一个实现支持的类型的 [`Event`](../../com.aspose.html.dom.events/event/)。 |
| [createSVGAngle](../../com.aspose.html.dom.svg/svgsvgelement/createsvgangle/)() | 在任何文档树之外创建 SVGAngle 对象。该对象初始化为 0 度（无单位）。 |
| [createSVGLength](../../com.aspose.html.dom.svg/svgsvgelement/createsvglength/)() | 在任何文档树之外创建 SVGLength 对象。该对象初始化为 0 用户单位。 |
| [createSVGMatrix](../../com.aspose.html.dom.svg/svgsvgelement/createsvgmatrix/)() | 在任何文档树之外创建 SVGMatrix 对象。该对象初始化为单位矩阵。 |
| [createSVGNumber](../../com.aspose.html.dom.svg/svgsvgelement/createsvgnumber/)() | 在任何文档树之外创建 SVGNumber 对象。该对象初始化为零值。 |
| [createSVGPoint](../../com.aspose.html.dom.svg/svgsvgelement/createsvgpoint/)() | 在任何文档树之外创建 SVGPoint 对象。该对象初始化为用户坐标系中的点 (0,0)。 |
| [createSVGRect](../../com.aspose.html.dom.svg/svgsvgelement/createsvgrect/)() | 在任何文档树之外创建 SVGRect 对象。该对象初始化为所有值均为 0 用户单位。 |
| [createSVGTransform](../../com.aspose.html.dom.svg/svgsvgelement/createsvgtransform/)() | 在任何文档树之外创建 SVGTransform 对象。该对象初始化为单位矩阵变换 (SVG_TRANSFORM_MATRIX)。 |
| [createSVGTransformFromMatrix](../../com.aspose.html.dom.svg/svgsvgelement/createsvgtransformfrommatrix/)(SVGMatrix) | 在任何文档树之外创建 SVGTransform 对象。该对象初始化为给定的矩阵变换（即 SVG_TRANSFORM_MATRIX）。参数矩阵的数值被复制，矩阵参数并未被采用为 SVGTransform::matrix。 |
...
| [getCurrentTime](../../com.aspose.html.dom.svg/svgsvgelement/getcurrenttime/)() | 返回相对于当前 SVG 文档片段开始时间的当前时间（秒）。如果在文档时间线开始之前调用 getCurrentTime（例如，在 ‘script’ 元素中的脚本在文档的 SVGLoad 事件分发之前运行），则返回 0。 |
| [getElementById](../../com.aspose.html.dom.svg/svgsvgelement/getelementbyid/)(String) | 在此 SVG 文档片段中（即搜索限制在文档树的子集内）搜索 id 为 elementId 的 Element。如果找到该 Element，则返回该 Element。如果不存在此类元素，则返回 null。如果多个元素具有相同 id，则行为未定义。 |
...
| [pauseAnimations](../../com.aspose.html.dom.svg/svgsvgelement/pauseanimations/)() | 暂停（即暂停）在对应于此 ‘svg’ 元素的 SVG 文档片段中定义的所有当前运行的动画，使该文档片段的动画时钟保持静止，直到取消暂停。 |
...
| [setCurrentTime](../../com.aspose.html.dom.svg/svgsvgelement/setcurrenttime/)(float) | 调整此 SVG 文档片段的时钟，建立一个新的当前时间。如果在文档时间线开始之前调用 setCurrentTime（例如，在文档的 SVGLoad 事件分发之前，由位于 ‘script’ 元素中的脚本运行），则该方法最后一次调用中的秒数值表示文档时间线开始后文档将要跳转到的时间。 |
...
| [unpauseAnimations](../../com.aspose.html.dom.svg/svgsvgelement/unpauseanimations/)() | 取消暂停（即取消暂停）当前在 SVG 文档片段中定义的正在运行的动画，使动画时钟从被暂停的时间点继续。 |
