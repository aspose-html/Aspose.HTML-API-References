---
title: "SVGGradientElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.dom.svg.SVGGradientElement 类。SVGGradientElement 接口是 SVGLinearGradientElement 和 SVGRadialGradientElement 使用的基础接口。"
type: docs

url: /zh/java/com.aspose.html.dom.svg/svggradientelement/
---
## SVGGradientElement class

SVGGradientElement 接口是 SVGLinearGradientElement 和 SVGRadialGradientElement 使用的基础接口。
...
| 名称 | 描述 |
| --- | --- |
| const [SVG_SPREADMETHOD_PAD](../../com.aspose.html.dom.svg/svggradientelement/svg_spreadmethod_pad/) | 对应于值 'pad'。 |
| const [SVG_SPREADMETHOD_REFLECT](../../com.aspose.html.dom.svg/svggradientelement/svg_spreadmethod_reflect/) | 对应于值 'reflect'。 |
| const [SVG_SPREADMETHOD_REPEAT](../../com.aspose.html.dom.svg/svggradientelement/svg_spreadmethod_repeat/) | 对应于值 'repeat'。 |
| const [SVG_SPREADMETHOD_UNKNOWN](../../com.aspose.html.dom.svg/svggradientelement/svg_spreadmethod_unknown/) | 该类型不是预定义类型之一。尝试定义此类型的新值或尝试将现有值切换到此类型都是无效的。 |
