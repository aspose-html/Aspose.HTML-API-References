...
description: "SVGGradientElement 属性。对应给定元素上的属性 spreadMethod。此接口中定义的 Spread Method Types 之一"
type: docs

url: /zh/java/com.aspose.html.dom.svg/svggradientelement/spreadmethod/
---
## SVGGradientElement.SpreadMethod property

对应给定元素上的属性 ‘spreadMethod’。此接口中定义的 Spread Method Types 之一。
