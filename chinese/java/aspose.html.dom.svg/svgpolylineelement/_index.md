---
title: "SVGPolylineElement 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.dom.svg.SVGPolylineElement 类。SVGPolylineElement 接口对应于 polyline 元素"
type: docs

url: /zh/java/com.aspose.html.dom.svg/svgpolylineelement/
---
## SVGPolylineElement class

该 SVGPolylineElement 接口对应于 ‘polyline’ 元素。
...
| 名称 | 描述 |
| --- | --- |
| [getAnimatedPoints](../../com.aspose.html.dom.svg/svgpolylineelement/animatedpoints/) 提供对 ‘points’ 属性当前动画内容的访问。如果给定的属性或属性正在动画中，则包含该属性或属性的当前动画值。如果给定的属性或属性当前未动画，则包含与 points 相同的值。 |
...
| [getPoints](../../com.aspose.html.dom.svg/svgpolylineelement/points/) 提供对 ‘points’ 属性基础（即静态）内容的访问。 |
