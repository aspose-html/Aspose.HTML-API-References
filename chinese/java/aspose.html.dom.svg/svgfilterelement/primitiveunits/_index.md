...
description: "SVGFilterElement 属性。对应于给定 filter 元素的属性 primitiveUnits。接受 SVGUnitTypes 中定义的常量之一。"
type: docs

url: /zh/java/com.aspose.html.dom.svg/svgfilterelement/primitiveunits/
---
## SVGFilterElement.PrimitiveUnits property

对应于给定 ‘filter’ 元素的属性 ‘primitiveUnits’。接受 SVGUnitTypes 中定义的常量之一。
