...
none - 抑制听觉渲染，使元素无需时间进行渲染。但请注意，后代元素可能会覆盖此值并被朗读。（若要确保抑制元素及其后代的渲染，请使用 ['display'](https://www.w3.org/TR/1998/REC-CSS2-19980512/visuren.html#propdef-display) 属性）。normal - 使用语言相关的发音规则来渲染元素及其子元素。spell-out - 将文本逐字母拼写（对首字母缩写和缩写词有用）。
