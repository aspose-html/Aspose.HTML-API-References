...
description: "ICSS2Properties 属性。在高质量印刷中，标记通常添加在页面盒子之外。此属性指定是否应在页面盒子边缘之外渲染十字标记、裁切标记或两者兼有。"
type: docs
...
在高质量印刷中，标记通常添加在页面盒子之外。此属性指定是否应在[page box](https://www.w3.org/TR/1998/REC-CSS2-19980512/page.html#page-box) 边缘之外渲染十字标记、裁切标记或两者兼有。

裁切标记指示页面应裁剪的位置。十字标记（也称为登记标记或定位标记）用于对齐纸张。
