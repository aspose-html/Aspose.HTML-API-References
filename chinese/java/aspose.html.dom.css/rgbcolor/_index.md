...
description: "com.aspose.html.dom.css.RGBColor 类。RGBColor 接口用于表示任何 RGB 颜色值。该接口反映底层样式属性中的值。因此，对 CSSPrimitiveValue 对象所做的修改会修改样式属性。"
type: docs
...
即使样式表只能为颜色值包含整数，该整数的内部存储是浮点数，并且在指定样式或计算样式中可以将其作为浮点数使用。

颜色百分比值始终可以转换为数值，反之亦然。
