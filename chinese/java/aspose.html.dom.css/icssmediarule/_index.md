...
| [getMedia](../../com.aspose.html.dom.css/icssmediarule/media/) 只读 media 属性（`CSSMediaRule` 接口的 MediaList）表示样式信息的目标介质。 |

## 方法

| 名称 | 描述 |
| --- | --- |
| [deleteRule](../../com.aspose.html.dom.css/icssmediarule/deleterule/)(long) | CSSGroupingRule 接口的 deleteRule() 方法从子 CSS 规则列表中删除一个 CSS 规则。 |
