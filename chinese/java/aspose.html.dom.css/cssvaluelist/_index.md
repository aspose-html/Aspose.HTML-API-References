...
description: "com.aspose.html.dom.css.CSSValueList 类。CSSValueList 接口提供有序 CSS 值集合的抽象。"
type: docs
...
CSSValueList 接口提供 CSS 值有序集合的抽象。
...
| 名称 | 描述 |
| --- | --- |
| [cSSText](../../com.aspose.html.dom.css/cssvaluelist/csstext/) { get; set; } | [`CSSValue`](../cssvalue/) 接口的 cssText 属性表示当前计算的 CSS 属性值。 |
...
| [getPlatformType](../../com.aspose.html.dom.css/cssvaluelist/getplatformtype/)() | 此方法用于检索 ECMAScript 对象的 Type。 |
