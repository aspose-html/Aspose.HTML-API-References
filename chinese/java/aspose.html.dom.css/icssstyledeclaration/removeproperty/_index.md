...
description: "ICSSStyleDeclaration 方法。CSSStyleDeclaration.removeProperty 方法接口从 CSS 样式声明对象中移除属性。"
type: docs
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| propertyName | String | propertyName 是一个 String，表示要移除的属性名称。请注意，多词属性名称使用连字符而非驼峰式。 |
