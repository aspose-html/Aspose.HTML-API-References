...
description: "ICSSStyleSheet 方法。CSSStyleSheet.insertRule 方法在当前样式表中插入一个新的 CSS 规则，具有一些限制。"
type: docs
...
注意：虽然 insertRule() 仅是 [`CSSStyleSheet`](../) 的方法，但它实际上将规则插入到 CSSStyleSheet.cssRules —— 它内部的 [`CSSRuleList`](../../icssrulelist/)。
