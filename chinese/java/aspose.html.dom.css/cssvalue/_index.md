...
表示一个简单或复杂的值。CSSValue 对象仅出现在 CSS 属性的上下文中。
...
| const [CSS_PRIMITIVE_VALUE](../../com.aspose.html.dom.css/cssvalue/css_primitive_value/) | 该值是原始值，可以通过在此 CSSValue 接口实例上使用特定绑定的强制转换方法获取 CSSPrimitiveValue 接口的实例。 |
