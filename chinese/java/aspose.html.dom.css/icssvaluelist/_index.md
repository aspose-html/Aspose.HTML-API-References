...
| 名称 | 描述 |
| --- | --- |
| [getItem](../../com.aspose.html.dom.css/icssvaluelist/item/) 此方法用于通过序数索引检索 CSSValue。集合中的顺序对应 CSS 样式属性中值的顺序。如果索引大于或等于列表中值的数量，则返回 null。 |
...
该接口曾是创建类型化 CSS 对象模型尝试的一部分。此尝试已被放弃，且大多数浏览器未实现它。
