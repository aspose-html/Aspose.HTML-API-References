...
description: "IStyleSheet 属性。将此样式表与文档关联的节点。对于 HTML，这可能是相应的 LINK 或 STYLE 元素。对于 XML，这可能是链接的处理指令。对于被其他样式表包含的样式表，此属性的值为 null。"
type: docs
...
将此样式表与文档关联的节点。对于 HTML，这可能是相应的 LINK 或 STYLE 元素。对于 XML，这可能是链接的处理指令。对于被其他样式表包含的样式表，此属性的值为 null。
