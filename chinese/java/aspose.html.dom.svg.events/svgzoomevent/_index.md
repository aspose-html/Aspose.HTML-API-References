...
description: "com.aspose.html.dom.svg.events.SVGZoomEvent 类。当用户发起导致 SVG 文档片段当前视图重新缩放的操作时，会触发缩放事件。事件处理程序仅在 svg 元素上被识别。"
type: docs
...
| [getNewScale](../../com.aspose.html.dom.svg.events/svgzoomevent/newscale/) 缩放操作处理完成后将生效的比例因子。 |
| [getNewTranslate](../../com.aspose.html.dom.svg.events/svgzoomevent/newtranslate/) 缩放操作处理完成后将生效的平移值。SVGPoint 对象为只读。 |
| [getPreviousScale](../../com.aspose.html.dom.svg.events/svgzoomevent/previousscale/) 来自之前缩放操作的比例因子，在本次缩放操作发生前处于该值。 |
| [getPreviousTranslate](../../com.aspose.html.dom.svg.events/svgzoomevent/previoustranslate/) 来自之前缩放操作的平移值，在本次缩放操作发生前处于该值。SVGPoint 对象为只读。 |
...
| [getZoomRectScreen](../../com.aspose.html.dom.svg.events/svgzoomevent/zoomrectscreen/) 以屏幕单位表示的指定缩放矩形。SVGRect 对象为只读。 |
