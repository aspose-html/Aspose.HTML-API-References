...
| [setInterval](../../com.aspose.html.window/iwindowtimers/setinterval/)(object, int, params object[]) | 安排一个超时，以每 timeout 毫秒运行处理程序。任何参数将直接传递给处理程序。 |
| [setTimeout](../../com.aspose.html.window/iwindowtimers/settimeout/)(object, int, params object[]) | 安排一个超时，以在 timeout 毫秒后运行处理程序。任何参数将直接传递给处理程序。 |
