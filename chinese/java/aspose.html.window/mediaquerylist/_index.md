...
description: "com.aspose.html.window.MediaQueryList 类。MediaQueryList 对象存储应用于文档的媒体查询信息，支持对文档状态的即时匹配和事件驱动匹配。参见 CSSOM View Module 规范 https//www.w3.org/TR/cssom-view/the-mediaquerylist-interface"
type: docs
...
| [getMedia](../../com.aspose.html.window/mediaquerylist/media/) 表示序列化媒体查询的字符串。 |
