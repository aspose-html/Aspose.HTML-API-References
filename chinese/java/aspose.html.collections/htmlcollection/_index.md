...
| 名称 | 描述 |
| --- | --- |
| 抽象 [getItem](../../com.aspose.html.collections/htmlcollection/item/) 返回集合中索引位置的项。如果索引大于或等于列表中的节点数，则返回 null。 |
| 抽象 [getLength](../../com.aspose.html.collections/htmlcollection/length/) 列表中的节点数量。 |
...
| [getPlatformType](../../com.aspose.html.collections/htmlcollection/getplatformtype/)() | 此方法用于检索 ECMAScript 对象的 Type。 |
