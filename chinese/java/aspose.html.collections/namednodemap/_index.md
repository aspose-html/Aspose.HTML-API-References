...
description: "com.aspose.html.collections.NamedNodeMap 类。表示可以通过名称访问的属性集合。"
type: docs
...
| 名称 | 描述 |
| --- | --- |
| [getItem](../../com.aspose.html.collections/namednodemap/item/) 返回映射中索引位置的项。如果索引大于或等于此映射中的节点数，则返回 null。（2 个索引器） |
...
| [setNamedItem](../../com.aspose.html.collections/namednodemap/setnameditem/)(Attr) | 使用其 nodeName 属性添加节点。如果映射中已存在同名节点，则被新节点替换。用自身替换节点不会产生任何影响。 |
| [setNamedItemNS](../../com.aspose.html.collections/namednodemap/setnameditemns/)(Attr) | 使用其 packageURI 和 localName 添加节点。如果映射中已存在具有相同包 URI 和本地名称的节点，则被新节点替换。用自身替换节点不会产生任何影响。 |
