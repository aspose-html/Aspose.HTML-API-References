...
description: "IInlinePostProcessing 方法。定义 Process 方法"
type: docs

url: /zh/java/com.aspose.html.toolkit.markdown.syntax.parser/iinlinepostprocessing/process/
---
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| 上下文 | IInlinePostProcessingContext | 该上下文。 |

### 返回值

该 InlineParsingInstruction。
