...
description: "com.aspose.html.saving.PdfSaveOptions 类。特定的数据类提供少量属性以管理转换结果。例如 PageSetup 指定页面特性。请参阅文档文章。"
type: docs
...
特定的数据类提供少量属性以管理转换结果。例如 [`PageSetup`](../../com.aspose.html.rendering/pagesetup/) 指定页面特性。请参阅文档 [article](https://docs.aspose.com/html/net/converting-between-formats/html-to-pdf/#convert-html-to-pdf-using-pdfsaveoptions)。
...
| [getDocumentInfo](../../com.aspose.html.rendering.pdf/pdfrenderingoptions/documentinfo/) 包含有关输出 PDF 文档的信息。 |
[getEncryption]
