...
| 异常 | 条件 |
| --- | --- |
| InvalidOperationException | 如果 [`OutputUrl`](../../../com.aspose.html.saving/resource/outputurl/) 为 `null` 且 [`Status`](../../../com.aspose.html.saving/resource/status/) 为 Saved，则会引发此错误。已保存资源应指定 [`OutputUrl`](../../../com.aspose.html.saving/resource/outputurl/)，否则无法在引用此资源的资源中指定正确的引用。 |
