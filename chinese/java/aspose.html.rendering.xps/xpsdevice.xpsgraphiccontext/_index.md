...
description: "com.aspose.html.rendering.xps.XpsDeviceXpsGraphicContext 类。保存 XpsDevice 的当前图形控制参数。这些参数定义了图形操作执行的全局框架。"
type: docs

url: /zh/java/com.aspose.html.rendering.xps/xpsdevice.xpsgraphiccontext/
---
...
| 名称 | 描述 |
| --- | --- |
| [xpsGraphicContext](../../com.aspose.html.rendering.xps/xpsdevice.xpsgraphiccontext/.ctor)() | 默认构造函数。 |
