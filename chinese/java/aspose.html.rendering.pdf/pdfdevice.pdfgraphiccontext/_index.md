---
title: "PdfDevice.PdfGraphicContext 类"
second_title: "Aspose.HTML for Java API 参考"
description: "com.aspose.html.rendering.pdf.PdfDevicePdfGraphicContext 类。保存 PdfDevice 的当前图形控制参数。这些参数定义了图形操作执行的全局框架。"
type: docs

url: /zh/java/com.aspose.html.rendering.pdf/pdfdevice.pdfgraphiccontext/
---
## PdfDevice.PdfGraphicContext class

保存 PdfDevice 的当前图形控制参数。这些参数定义了图形操作执行的全局框架。
...
| 名称 | 描述 |
| --- | --- |
| [pdfGraphicContext](../../com.aspose.html.rendering.pdf/pdfdevice.pdfgraphiccontext/.ctor)() | 默认构造函数。 |
