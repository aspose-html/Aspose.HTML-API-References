...
description: "com.aspose.html.rendering.pdf.PdfDevice 类。表示渲染到 PDF 文档的过程"
type: docs
...
| 名称 | 描述 |
| --- | --- |
| class [PdfGraphicContext](../../com.aspose.html.rendering.pdf/pdfdevice.pdfgraphiccontext) | 保存 PdfDevice 的当前图形控制参数。这些参数定义了图形操作执行的全局框架。 |
