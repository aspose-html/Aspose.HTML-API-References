...
description: Aspose.Html.Toolkit.Markdown.Syntax.OrderedListSyntaxNode 班级. 表示有序列表语法
type: docs
weight: 5300
url: /zh/net/aspose.html.toolkit.markdown.syntax/orderedlistsyntaxnode/
---
...
| 姓名 | 描述 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/orderedlistsyntaxnode/accept/)(MarkdownSyntaxVisitor) | 定义接受访问者的接口。 |
...
| [GetDelimiter](../../aspose.html.toolkit.markdown.syntax/orderedlistsyntaxnode/getdelimiter/)() | 定义获取分隔符的接口。 |
| [GetLeadingTrivia](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/getleadingtrivia/)() | 获取领先的琐事。 |
| [GetStart](../../aspose.html.toolkit.markdown.syntax/orderedlistsyntaxnode/getstart/)() | 定义获取起始索引的接口。 |
...
| [IsTight](../../aspose.html.toolkit.markdown.syntax/listsyntaxnode/istight/)() | 定义获取接口是紧的。 |
