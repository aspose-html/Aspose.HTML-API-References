...
description: Aspose.Html.Toolkit.Markdown.Syntax.HTMLFragmentSyntax 班级. 表示 HTMLFragmentSyntax.
type: docs
weight: 5000
url: /zh/net/aspose.html.toolkit.markdown.syntax/htmlfragmentsyntax/
---
...
| 姓名 | 描述 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/htmlfragmentsyntax/accept/)(MarkdownSyntaxVisitor) | 定义接受访问者的接口。 |
...
| [GetContent](../../aspose.html.toolkit.markdown.syntax/htmlfragmentsyntax/getcontent/)() | 定义获取内容的接口。 |
...
| [SetContent](../../aspose.html.toolkit.markdown.syntax/htmlfragmentsyntax/setcontent/)(string) | 定义设置内容的接口。 |
