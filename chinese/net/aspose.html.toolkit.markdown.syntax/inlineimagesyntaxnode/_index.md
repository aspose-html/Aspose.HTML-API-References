...
description: Aspose.Html.Toolkit.Markdown.Syntax.InlineImageSyntaxNode 班级. 表示 InlineImageSyntaxNode.
type: docs
weight: 5050
url: /zh/net/aspose.html.toolkit.markdown.syntax/inlineimagesyntaxnode/
---
...
| 姓名 | 描述 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/inlineimagesyntaxnode/accept/)(MarkdownSyntaxVisitor) | 定义接受访问者的接口。 |
...
| [GetAltText](../../aspose.html.toolkit.markdown.syntax/inlineimagesyntaxnode/getalttext/)() | 定义获取所有文本的接口。 |
| [GetDestination](../../aspose.html.toolkit.markdown.syntax/inlineimagesyntaxnode/getdestination/)() | 定义获取目标的接口。 |
...
| [GetTitle](../../aspose.html.toolkit.markdown.syntax/inlineimagesyntaxnode/gettitle/)() | 定义获取标题的接口。 |
