...
description: Aspose.Html.Toolkit.Markdown.Syntax.EmptyLineSyntaxNode 班级. 表示 EmptyLineSyntaxNode
type: docs
weight: 4880
url: /zh/net/aspose.html.toolkit.markdown.syntax/emptylinesyntaxnode/
---
## EmptyLineSyntaxNode class

表示 EmptyLineSyntaxNode。
...
| 姓名 | 描述 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/emptylinesyntaxnode/accept/)(MarkdownSyntaxVisitor) | 定义接受访问者的接口。 |
