...
description: Aspose.Html.Toolkit.Markdown.Syntax.MarkdownSyntaxToken 班级. 代表 Markdown Syntax Token.
type: docs
weight: 5210
url: /zh/net/aspose.html.toolkit.markdown.syntax/markdownsyntaxtoken/
---
## MarkdownSyntaxToken class

代表 Markdown Syntax Token.
...
| [Source](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxtoken/source/) { get; } | 获取源文本。 |
| [Span](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxtoken/span/) { get; } | 获取跨度。 |
| [Text](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxtoken/text/) { get; } | 获取span. 的文本内容 |

## 方法

| 姓名 | 描述 |
| --- | --- |
| virtual [Accept](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/accept/)(MarkdownSyntaxVisitor) | 接受访客。 |
...
| [GetFullText](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxtoken/getfulltext/)() | 定义获取全文接口。 |
