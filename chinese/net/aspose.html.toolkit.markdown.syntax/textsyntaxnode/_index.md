...
description: Aspose.Html.Toolkit.Markdown.Syntax.TextSyntaxNode 班级. 实现了文本语法节点
type: docs
weight: 5670
url: /zh/net/aspose.html.toolkit.markdown.syntax/textsyntaxnode/
---
...
| 姓名 | 描述 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/textsyntaxnode/accept/)(MarkdownSyntaxVisitor) | 定义接受访问者的接口。 |
