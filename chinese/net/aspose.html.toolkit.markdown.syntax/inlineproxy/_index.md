...
description: Aspose.Html.Toolkit.Markdown.Syntax.InlineProxy 班级. 代表InlineProxy
type: docs
weight: 5070
url: /zh/net/aspose.html.toolkit.markdown.syntax/inlineproxy/
---
## InlineProxy class
...
| 姓名 | 描述 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/inlineproxy/accept/)(MarkdownSyntaxVisitor) | 定义接受访问者的接口。 |
...
| [GetTarget](../../aspose.html.toolkit.markdown.syntax/inlineproxy/gettarget/)() | 定义获取目标的接口。 |
...
| override [WriteTo](../../aspose.html.toolkit.markdown.syntax/inlineproxy/writeto/#writeto)(MarkdownTextWriter) | 写入文本编写器。 |
