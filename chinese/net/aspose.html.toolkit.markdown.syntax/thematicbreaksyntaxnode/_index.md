...
description: Aspose.Html.Toolkit.Markdown.Syntax.ThematicBreakSyntaxNode 班级. 实施了 Thematic Break Syntax Node.
type: docs
weight: 5680
url: /zh/net/aspose.html.toolkit.markdown.syntax/thematicbreaksyntaxnode/
---
## ThematicBreakSyntaxNode class

实施了 Thematic Break Syntax Node.
...
| 姓名 | 描述 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/thematicbreaksyntaxnode/accept/)(MarkdownSyntaxVisitor) | 定义接受访问者的接口。 |
