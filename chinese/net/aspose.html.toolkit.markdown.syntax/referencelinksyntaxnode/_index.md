...
description: Aspose.Html.Toolkit.Markdown.Syntax.ReferenceLinkSyntaxNode 班级. 表示参考链接语法
type: docs
weight: 5520
url: /zh/net/aspose.html.toolkit.markdown.syntax/referencelinksyntaxnode/
---
...
| 姓名 | 描述 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/referencelinksyntaxnode/accept/)(MarkdownSyntaxVisitor) | 定义接受访问者的接口。 |
...
| [GetContent](../../aspose.html.toolkit.markdown.syntax/referencelinksyntaxnode/getcontent/)() | 定义获取内容的接口。 |
| [GetLabel](../../aspose.html.toolkit.markdown.syntax/referencelinksyntaxnode/getlabel/)() | 定义获取标签的接口。 |
