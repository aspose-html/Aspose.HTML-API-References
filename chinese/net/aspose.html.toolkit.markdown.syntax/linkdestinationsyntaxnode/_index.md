...
description: Aspose.Html.Toolkit.Markdown.Syntax.LinkDestinationSyntaxNode 班级. 代表 LinkDestinationSyntaxNode.
type: docs
weight: 5110
url: /zh/net/aspose.html.toolkit.markdown.syntax/linkdestinationsyntaxnode/
---
## LinkDestinationSyntaxNode class

代表 LinkDestinationSyntaxNode.
...
| 姓名 | 描述 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/linkdestinationsyntaxnode/accept/)(MarkdownSyntaxVisitor) | 定义接受访问者的接口。 |
...
| [GetEnumerator](../../aspose.html.toolkit.markdown.syntax/inlinecontainersyntaxnode/getenumerator/)() | 返回一个遍历集合的枚举器。 |
...
| [GetValue](../../aspose.html.toolkit.markdown.syntax/linkdestinationsyntaxnode/getvalue/)() | 定义获取字符串值的接口。 |
