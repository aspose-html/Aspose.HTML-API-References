...
description: Aspose.Html.Toolkit.Markdown.Syntax.ReferenceImageSyntaxNode 班级. 参考图像语法
type: docs
weight: 5510
url: /zh/net/aspose.html.toolkit.markdown.syntax/referenceimagesyntaxnode/
---
...
| 姓名 | 描述 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/referenceimagesyntaxnode/accept/)(MarkdownSyntaxVisitor) | 定义接受访问者的接口。 |
...
| [GetAltText](../../aspose.html.toolkit.markdown.syntax/referenceimagesyntaxnode/getalttext/)() | 定义获取替代文本的接口。 |
| [GetLabel](../../aspose.html.toolkit.markdown.syntax/referenceimagesyntaxnode/getlabel/)() | 定义获取标签的接口。 |
