...
description: Aspose.Html.Toolkit.Markdown.Syntax.LineBreakSyntaxNode 班级. 表示 LineBreakSyntaxNode.
type: docs
weight: 5100
url: /zh/net/aspose.html.toolkit.markdown.syntax/linebreaksyntaxnode/
---
## LineBreakSyntaxNode class

表示 LineBreakSyntaxNode.
...
| 姓名 | 描述 |
| --- | --- |
| abstract [Accept](../../aspose.html.toolkit.markdown.syntax/inlinesyntaxnode/accept/)(MarkdownSyntaxVisitor) | 定义接受访问者的接口。 |
