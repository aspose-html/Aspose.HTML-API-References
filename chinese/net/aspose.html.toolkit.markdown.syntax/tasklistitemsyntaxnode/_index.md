...
description: Aspose.Html.Toolkit.Markdown.Syntax.TaskListItemSyntaxNode 班级. 任务列表项语法节点
type: docs
weight: 5610
url: /zh/net/aspose.html.toolkit.markdown.syntax/tasklistitemsyntaxnode/
---
...
| 姓名 | 描述 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/listitemsyntaxnode/accept/)(MarkdownSyntaxVisitor) | 定义接受访问者的接口。 |
...
| [GetLinesLeadingTrivia](../../aspose.html.toolkit.markdown.syntax/multilinecontainerblocksyntaxnode/getlinesleadingtrivia/)() | 定义用于获取引导琐事的行的接口。 |
| [GetMarker](../../aspose.html.toolkit.markdown.syntax/listitemsyntaxnode/getmarker/)() | 获取标记 |
...
| [IsChecked](../../aspose.html.toolkit.markdown.syntax/tasklistitemsyntaxnode/ischecked/)() | 定义获取检查状态的接口。 |
| [IsTight](../../aspose.html.toolkit.markdown.syntax/listitemsyntaxnode/istight/)() | 如果是 tight. 则为真 |
