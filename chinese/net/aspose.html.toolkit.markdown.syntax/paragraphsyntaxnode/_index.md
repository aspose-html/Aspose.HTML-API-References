...
description: Aspose.Html.Toolkit.Markdown.Syntax.ParagraphSyntaxNode 班级. 代表段落语法节点
type: docs
weight: 5310
url: /zh/net/aspose.html.toolkit.markdown.syntax/paragraphsyntaxnode/
---
...
| 姓名 | 描述 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/paragraphsyntaxnode/accept/)(MarkdownSyntaxVisitor) | 定义接受访问者的接口。 |
...
| [GetContent](../../aspose.html.toolkit.markdown.syntax/paragraphsyntaxnode/getcontent/)() | 定义获取内容的接口。 |
