...
description: Aspose.Html.Toolkit.Markdown.Syntax.TableRowSyntaxNode 班级. 表行语法节点
type: docs
weight: 5580
url: /zh/net/aspose.html.toolkit.markdown.syntax/tablerowsyntaxnode/
---
...
| [AppendCell](../../aspose.html.toolkit.markdown.syntax/tablerowsyntaxnode/appendcell/)(TableCellSyntaxNode) | 定义追加单元格的接口。 |
| [AppendChild](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/appendchild/)(MarkdownSyntaxNode) | 追加子节点. |
| [AppendDelimiter](../../aspose.html.toolkit.markdown.syntax/tablerowsyntaxnode/appenddelimiter/)(TableDelimiterSyntaxNode) | 定义附加分隔符的接口。 |
| [ChildNodes](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/childnodes/)() | 获取子节点集合。 |
| [GetCells](../../aspose.html.toolkit.markdown.syntax/tablerowsyntaxnode/getcells/)() | 定义获取单元格的接口。 |
