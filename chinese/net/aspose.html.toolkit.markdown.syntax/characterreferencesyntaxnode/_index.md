...
description: Aspose.Html.Toolkit.Markdown.Syntax.CharacterReferenceSyntaxNode 班级. 表示 CharacterReferenceSyntaxNode.
type: docs
weight: 4830
url: /zh/net/aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/
---
...
| [Reference](../../aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/reference/) { get; } | 获取参考。 |
| [Source](../../aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/source/) { get; } | 获取来源。 |
| [Span](../../aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/span/) { get; } | 获取跨度。 |
| [Value](../../aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/value/) { get; } | 获取值。 |

## 方法

| 姓名 | 描述 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/accept/)(MarkdownSyntaxVisitor) | 定义接受访问者的接口。 |
