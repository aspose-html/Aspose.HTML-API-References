...
description: Aspose.Html.Toolkit.Markdown.Syntax.HardBreakSyntaxNode 班级. 表示 HardBreakSyntaxNode.
type: docs
weight: 5010
url: /zh/net/aspose.html.toolkit.markdown.syntax/hardbreaksyntaxnode/
---
## HardBreakSyntaxNode class

表示 HardBreakSyntaxNode.
...
| virtual [Source](../../aspose.html.toolkit.markdown.syntax/linebreaksyntaxnode/source/) { get; } | 获取来源。 |
| virtual [Span](../../aspose.html.toolkit.markdown.syntax/linebreaksyntaxnode/span/) { get; } | 获取跨度。 |
| [Value](../../aspose.html.toolkit.markdown.syntax/linebreaksyntaxnode/value/) { get; } | 获取值。 |

## 方法

| 姓名 | 描述 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/hardbreaksyntaxnode/accept/)(MarkdownSyntaxVisitor) | 定义接受访问者的接口。 |
...
| [GetBreakingTag](../../aspose.html.toolkit.markdown.syntax/hardbreaksyntaxnode/getbreakingtag/)() | 定义get Breaking Tag 的接口 |
