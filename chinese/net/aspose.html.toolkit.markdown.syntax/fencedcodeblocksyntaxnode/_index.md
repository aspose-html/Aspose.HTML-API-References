...
description: Aspose.Html.Toolkit.Markdown.Syntax.FencedCodeBlockSyntaxNode 班级. 表示 FencedCodeBlockSyntaxNode.
type: docs
weight: 4990
url: /zh/net/aspose.html.toolkit.markdown.syntax/fencedcodeblocksyntaxnode/
---
...
| 姓名 | 描述 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/fencedcodeblocksyntaxnode/accept/)(MarkdownSyntaxVisitor) | 定义接受访问者的接口。 |
...
| [GetClosingTag](../../aspose.html.toolkit.markdown.syntax/fencedcodeblocksyntaxnode/getclosingtag/)() | 定义获取结束标签的接口。 |
| [GetContent](../../aspose.html.toolkit.markdown.syntax/fencedcodeblocksyntaxnode/getcontent/)() | 定义获取内容的接口。 |
| [GetInfo](../../aspose.html.toolkit.markdown.syntax/fencedcodeblocksyntaxnode/getinfo/)() | 定义获取信息的接口。 |
| [GetLeadingTrivia](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/getleadingtrivia/)() | 获取领先的琐事。 |
| [GetOpeningTag](../../aspose.html.toolkit.markdown.syntax/fencedcodeblocksyntaxnode/getopeningtag/)() | 定义获取开始标签的接口。 |
