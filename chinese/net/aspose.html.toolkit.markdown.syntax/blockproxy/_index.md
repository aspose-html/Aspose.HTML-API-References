...
description: Aspose.Html.Toolkit.Markdown.Syntax.BlockProxy 班级. 代表BlockProxy
type: docs
weight: 4800
url: /zh/net/aspose.html.toolkit.markdown.syntax/blockproxy/
---
## BlockProxy class
...
| 姓名 | 描述 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/blockproxy/accept/)(MarkdownSyntaxVisitor) | 定义接受访问者的接口。 |
...
| [GetTarget](../../aspose.html.toolkit.markdown.syntax/blockproxy/gettarget/)() | 获取目标节点。 |
...
| override [WriteTo](../../aspose.html.toolkit.markdown.syntax/blockproxy/writeto/#writeto)(MarkdownTextWriter) | 定义 Write To writer 的接口。 |
