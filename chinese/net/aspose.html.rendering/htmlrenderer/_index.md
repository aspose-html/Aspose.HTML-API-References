...
description: 表示 HTML 文档渲染器
type: docs
weight: 4350
url: /zh/net/aspose.html.rendering/htmlrenderer/
---
## HtmlRenderer class
...
| override [Render](../../aspose.html.rendering/htmlrenderer/render#render_5)(IDevice, TimeSpan, params Document[]) | 定义将多个[`Document`](../../aspose.html.dom/document)s 渲染为特定IDevice。 一旦没有任何用于加载资源、活动计时器、动画任务或指定超时的网络操作，将执行渲染。 |
