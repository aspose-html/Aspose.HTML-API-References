...
description: Aspose.Html.Dom.Events.UIEvent 班级. UIEvent 接口提供与用户界面事件关联的特定上下文信息
type: docs
weight: 850
url: /zh/net/aspose.html.dom.events/uievent/
---
## UIEvent class
...
| 姓名 | 描述 |
| --- | --- |
| [UIEvent](uievent/#constructor)(string) | 初始化一个新的实例`UIEvent`类. |
| [UIEvent](uievent/#constructor_1)(string, IDictionary&lt;string, object&gt;) | 初始化一个新的实例`UIEvent`类. |
