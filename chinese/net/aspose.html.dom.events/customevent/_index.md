...
description: Aspose.Html.Dom.Events.CustomEvent 班级. 使用CustomEvent接口的事件可以用来携带自定义数据
type: docs
weight: 730
url: /zh/net/aspose.html.dom.events/customevent/
---
## CustomEvent class

使用CustomEvent接口的事件可以用来携带自定义数据。
...
| 姓名 | 描述 |
| --- | --- |
| [CustomEvent](customevent/#constructor)(string) | 初始化一个新的实例`CustomEvent`类. |
| [CustomEvent](customevent/#constructor_1)(string, IDictionary&lt;string, object&gt;) | 初始化一个新的实例`CustomEvent`类. |
...
| [Detail](../../aspose.html.dom.events/customevent/detail/) { get; } | 获取自定义数据。 |
...
| [InitCustomEvent](../../aspose.html.dom.events/customevent/initcustomevent/)(string, bool, bool, object) | /// 这个[`InitEvent`](../event/initevent/)方法用于初始化一个值[`Event`](../event/)通过创建[`IDocumentEvent`](../idocumentevent/)接口. |
