...
description: 使用CustomEvent接口的事件可以用来携带自定义数据
type: docs
weight: 840
...
| 姓名 | 描述 |
| --- | --- |
| [CustomEvent](customevent#constructor)(string) | 初始化[`CustomEvent`](../customevent)类的新实例。 |
| [CustomEvent](customevent#constructor_1)(string, IDictionary&lt;string, object&gt;) | 初始化[`CustomEvent`](../customevent)类的新实例。 |
...
| [InitCustomEvent](../../aspose.html.dom.events/customevent/initcustomevent)(string, bool, bool, object) | ///[`InitEvent`](../event/initevent)方法用于初始化通过IDocumentEvent创建的R5:T:Aspose.Html.Dom.Events.Event:::的值:::界面。 |
