...
description: Aspose.Html.Dom.Events.DocumentLoadErrorEvent 班级. 的DocumentLoadErrorEvent当请求的资源不可用时发生
type: docs
weight: 750
url: /zh/net/aspose.html.dom.events/documentloaderrorevent/
---
## DocumentLoadErrorEvent class

的`DocumentLoadErrorEvent`当请求的资源不可用时发生。
