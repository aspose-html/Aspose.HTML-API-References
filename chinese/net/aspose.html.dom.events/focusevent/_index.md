...
description: Aspose.Html.Dom.Events.FocusEvent 班级. FocusEvent 接口提供与焦点事件关联的特定上下文信息
type: docs
weight: 780
url: /zh/net/aspose.html.dom.events/focusevent/
---
## FocusEvent class
...
| [RelatedTarget](../../aspose.html.dom.events/focusevent/relatedtarget/) { get; } | 用于标识与 Focus 事件相关的次要 EventTarget，具体取决于事件类型。 |
