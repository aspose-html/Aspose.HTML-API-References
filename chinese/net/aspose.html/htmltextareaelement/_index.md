...
description: Aspose.Html.HTMLTextAreaElement 班级. 多行文本字段请参阅 HTML 4.01. 中的 TEXTAREA 元素定义
type: docs
weight: 3610
...
| 姓名 | 描述 |
| --- | --- |
| [AccessKey](../../aspose.html/htmltextareaelement/accesskey/) { get; set; } | 用于访问表单控件的单个字符访问键。请参阅 HTML 4.01. 中的 accesskey 属性定义 |
...
| [Cols](../../aspose.html/htmltextareaelement/cols/) { get; set; } | 控件的宽度（以字符为单位）。请参阅 HTML 4.01. 中的 cols 属性定义 |
| [DefaultValue](../../aspose.html/htmltextareaelement/defaultvalue/) { get; set; } | 表示元素的内容。如果相应表单控件的内容在 交互式用户代理中发生更改，则此属性 的值不会更改。 @version DOM Level 2 |
| [Dir](../../aspose.html/htmlelement/dir/) { get; set; } | 指定方向性中性文本的基本方向和表格的 方向性。请参阅 HTML 4.01. 中的 dir 属性定义 |
| [Disabled](../../aspose.html/htmltextareaelement/disabled/) { get; set; } | 控件在此上下文中不可用。请参阅 HTML 4.01. 中的禁用属性 定义 |
...
| [Form](../../aspose.html/htmltextareaelement/form/) { get; } | 返回`形式`包含此控件的元素。返回 `无效的`如果此控件不在 窗体的上下文中。 |
...
| [Name](../../aspose.html/htmltextareaelement/name/) { get; set; } | 与表单一起提交时的表单控件或对象名称。请参阅 HTML 4.01. 中的名称 属性定义 |
...
| [Rows](../../aspose.html/htmltextareaelement/rows/) { get; set; } | 文本行数。请参阅 HTML 4.01. 中的行属性定义 |
...
| [TabIndex](../../aspose.html/htmltextareaelement/tabindex/) { get; set; } | 表示元素在 Tab 键顺序中的位置的索引。请参阅 HTML 4.01. 中的 tabindex 属性定义 |
...
| [Value](../../aspose.html/htmltextareaelement/value/) { get; set; } | 表示相应表单控件的当前内容，在 中是一个交互式用户代理。更改此属性会更改表单控件的 内容，但不会更改 元素的内容。如果整个数据不能放入单个 `DOM字符串` ，实现可能会截断数据。 |
