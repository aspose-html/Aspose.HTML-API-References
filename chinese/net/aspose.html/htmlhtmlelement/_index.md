...
description: HTML 文档的根请参阅 HTML 4.01 中的 HTML 元素定义
type: docs
weight: 3370
url: /zh/net/aspose.html/htmlhtmlelement/
---
...
| [Version](../../aspose.html/htmlhtmlelement/version) { get; set; } | 关于文档 DTD 的版本信息。请参阅 HTML 4.01 中的版本属性 定义。此属性在 HTML 4.01 中已弃用。 |
