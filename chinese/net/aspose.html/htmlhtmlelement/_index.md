...
description: Aspose.Html.HTMLHtmlElement 班级. HTML 文档的根目录请参阅 HTML 4.01. 中的 HTML 元素定义
type: docs
weight: 3290
...
HTML 文档的根目录。请参阅 HTML 4.01. 中的 HTML 元素定义
...
| [Version](../../aspose.html/htmlhtmlelement/version/) { get; set; } | 有关文档 DTD 的版本信息。请参阅 HTML 4.01 中的版本属性 定义。此属性在 HTML 4.01. 中已弃用 |
