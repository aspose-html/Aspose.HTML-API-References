...
description: 基本字体请参阅 HTML 4.01 中的 BASEFONT 元素定义此元素 在 HTML 4.01 中已弃用
type: docs
weight: 3190
url: /zh/net/aspose.html/htmlbasefontelement/
---
## HTMLBaseFontElement class

基本字体。请参阅 HTML 4.01 中的 BASEFONT 元素定义。此元素 在 HTML 4.01 中已弃用。
...
| [Color](../../aspose.html/htmlbasefontelement/color) { get; set; } | 字体颜色。请参阅 HTML 4.01 中的颜色属性定义。此 属性在 HTML 4.01 中已弃用。 |
| [Dir](../../aspose.html/htmlelement/dir) { get; set; } | 指定方向性中性文本的基本方向和表格的 方向性。请参阅 HTML 4.01 中的 dir 属性定义。 |
| [Face](../../aspose.html/htmlbasefontelement/face) { get; set; } | 字体标识符。请参阅 HTML 4.01 中的 face 属性定义。 此属性在 HTML 4.01 中已弃用。 |
...
| [Size](../../aspose.html/htmlbasefontelement/size) { get; set; } | 计算的字体大小。请参阅 HTML 4.01 中的 size 属性定义。 此属性在 HTML 4.01 中已弃用。 @version DOM 级别 2 |
