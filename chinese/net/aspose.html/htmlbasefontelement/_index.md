...
description: Aspose.Html.HTMLBaseFontElement 班级. 基本字体请参阅 HTML 4.01 中的 BASEFONT 元素定义此元素 在 HTML 4.01. 中已弃用
type: docs
weight: 3110
...
| [Face](../../aspose.html/htmlbasefontelement/face/) { get; set; } | 字体外观标识符。参见 HTML 4.01 中的 face 属性定义。 此属性在 HTML 4.01 中已弃用。 |
...
| [Size](../../aspose.html/htmlbasefontelement/size/) { get; set; } | 计算的字体大小。请参阅 HTML 4.01 中的大小属性定义。 此属性在 HTML 4.01 中已弃用。 @version DOM Level 2 |
