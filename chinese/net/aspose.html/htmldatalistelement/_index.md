...
description: Aspose.Html.HTMLDataListElement 班级. datalist 元素表示一组选项元素这些元素表示其他控件的预定义选项 另请参阅HTML 5.2 W3C 推荐.
type: docs
weight: 3160
...
datalist 元素表示一组选项元素，这些元素表示其他控件的预定义选项。 另请参阅[HTML 5.2 W3C 推荐](https://www.w3.org/TR/html52/sec-forms.html#elementdef-datalist).
...
| [Options](../../aspose.html/htmldatalistelement/options/) { get; } | 的集合`选项`此 元素包含的元素。 |
