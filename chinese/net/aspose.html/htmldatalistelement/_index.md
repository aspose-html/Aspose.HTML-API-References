...
description: datalist 元素代表一组选项元素代表其他控件的预定义选项 另见HTML 5.2 W3C 建议https//www.w3.org/TR/html52/sec-forms.htmlelementdef-datalist 
type: docs
weight: 3240
url: /zh/net/aspose.html/htmldatalistelement/
---
## HTMLDataListElement class

datalist 元素代表一组选项元素，代表其他控件的预定义选项。 另见[HTML 5.2 W3C 建议](https://www.w3.org/TR/html52/sec-forms.html#elementdef-datalist) 。
...
| [Options](../../aspose.html/htmldatalistelement/options) { get; } | ` 选项` 包含在这个 元素中的元素的集合。 |
