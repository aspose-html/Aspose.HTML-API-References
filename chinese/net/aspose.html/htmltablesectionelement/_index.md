...
description:  THEAD  TFOOT 和 TBODY 元素
type: docs
weight: 3670
url: /zh/net/aspose.html/htmltablesectionelement/
---
...
| 姓名 | 描述 |
| --- | --- |
| [Align](../../aspose.html/htmltablesectionelement/align) { get; set; } | 单元格中数据的水平对齐方式。有关详细信息，请参阅 HTMLTheadElement 的` align` 属性。 |
...
| [Ch](../../aspose.html/htmltablesectionelement/ch) { get; set; } | 列中单元格的对齐字符。请参阅 HTML 4.01 中的 char 属性 定义。 |
...
| [ChOff](../../aspose.html/htmltablesectionelement/choff) { get; set; } | 对齐字符的偏移量。请参阅 HTML 4.01 中的 charoff 属性定义。 |
...
| [Rows](../../aspose.html/htmltablesectionelement/rows) { get; } | 此表部分中的行集合。 |
...
| [VAlign](../../aspose.html/htmltablesectionelement/valign) { get; set; } | 单元格中数据的垂直对齐方式。有关详细信息，请参阅 HTMLTheadElement 的` valign` 属性。 |
...
| [DeleteRow](../../aspose.html/htmltablesectionelement/deleterow)(int) | 从此节中删除一行。 |
...
| [InsertRow](../../aspose.html/htmltablesectionelement/insertrow)(int) | 在此部分中插入一行。新行立即插入 在当前` 索引`本节中的第 行之前。如果 ` index` 为 -1 或等于此 部分中的行数，则新行为附加。 |
