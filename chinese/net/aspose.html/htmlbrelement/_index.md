...
description: Aspose.Html.HTMLBRElement 班级. 强制换行请参阅 HTML 4.01. 中的 BR 元素定义
type: docs
weight: 3090
...
| [Clear](../../aspose.html/htmlbrelement/clear/) { get; set; } | 控制浮动文本的流动。请参阅 HTML 4.01 中明确的属性定义 。此属性在 HTML 4.01. 中已弃用 |
