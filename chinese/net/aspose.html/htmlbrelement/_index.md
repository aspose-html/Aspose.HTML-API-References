...
description: 强制换行请参阅 HTML 4.01 中的 BR 元素定义
type: docs
weight: 3170
url: /zh/net/aspose.html/htmlbrelement/
---
## HTMLBRElement class
...
| [Clear](../../aspose.html/htmlbrelement/clear) { get; set; } | 控制浮动周围的文本流。请参阅 HTML 4.01 中的 clear 属性定义 。此属性在 HTML 4.01 中已弃用。 |
