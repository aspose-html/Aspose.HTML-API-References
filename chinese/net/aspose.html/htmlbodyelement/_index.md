...
description: HTML 文档正文此元素始终存在于 DOM API 中如果源文档中不存在标记即使 也是如此请参阅 HTML 4.01 中的 BODY 元素 定义
type: docs
weight: 3200
url: /zh/net/aspose.html/htmlbodyelement/
---
## HTMLBodyElement class

HTML 文档正文。此元素始终存在于 DOM API 中，如果源文档中不存在标记，即使 也是如此。请参阅 HTML 4.01 中的 BODY 元素 定义。
...
| 姓名 | 描述 |
| --- | --- |
| [ALink](../../aspose.html/htmlbodyelement/alink) { get; set; } | 活动链接的颜色（在鼠标按下之后，在鼠标按下 之前）。请参阅 HTML 4.01 中的 alink 属性定义。此属性 在 HTML 4.01 中已弃用。 |
| override [Attributes](../../aspose.html.dom/element/attributes) { get; } | NamedNodeMap 包含此节点的属性（如果它是一个元素），否则为 null。 |
| [Background](../../aspose.html/htmlbodyelement/background) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] 背景纹理平铺图像。请参阅 HTML 4.01 中的背景属性 定义。此属性在 HTML 4.01 中已弃用。 |
| virtual [BaseURI](../../aspose.html.dom/node/baseuri) { get; } | 此节点的绝对基本 URI 或 null 如果实现无法获得绝对 URI。 |
| [BgColor](../../aspose.html/htmlbodyelement/bgcolor) { get; set; } | 文档背景颜色。请参阅 HTML 4.01 中的 bgcolor 属性定义。此属性在 HTML 4.01 中已弃用。 |
...
| [Link](../../aspose.html/htmlbodyelement/link) { get; set; } | 非活动和未访问链接的颜色。请参阅 HTML 4.01 中的链接 属性定义。此属性在 HTML 4.01 中已弃用。 |
...
| [Text](../../aspose.html/htmlbodyelement/text) { get; set; } | 文档文本颜色。请参阅 HTML 4.01 中的文本属性定义。 此属性在 HTML 4.01 中已弃用。 |
...
| [VLink](../../aspose.html/htmlbodyelement/vlink) { get; set; } | 用户访问过的链接的颜色。请参阅 HTML 4.01 中的 vlink 属性定义。此属性在 HTML 4.01 中已弃用。 |
