...
description: Aspose.Html.HTMLBodyElement 班级. HTML 文档正文此元素始终存在于 DOM API 中如果标签不存在于源文档中即使是 也是如此请参阅 HTML 4.01. 中的 BODY 元素 定义
type: docs
weight: 3120
...
HTML 文档正文。此元素始终存在于 DOM API 中，如果标签不存在于源文档中，即使是 也是如此。请参阅 HTML 4.01. 中的 BODY 元素 定义
...
| 姓名 | 描述 |
| --- | --- |
| [ALink](../../aspose.html/htmlbodyelement/alink/) { get; set; } | 活动链接的颜色（在按下鼠标按钮之后，但在按下鼠标按钮 之前）。请参阅 HTML 4.01 中的 alink 属性定义。此属性 在 HTML 4.01. 中已弃用 |
| override [Attributes](../../aspose.html.dom/element/attributes/) { get; } | 包含此节点属性的 NamedNodeMap（如果它是一个元素）或 null 否则。 |
| [Background](../../aspose.html/htmlbodyelement/background/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] 的背景纹理平铺图像。请参阅 HTML 4.01 中的背景属性 定义。此属性在 HTML 4.01. 中已弃用 |
...
| [Link](../../aspose.html/htmlbodyelement/link/) { get; set; } | 未激活和未访问的链接的颜色。请参阅 HTML 4.01 中的链接 属性定义。此属性在 HTML 4.01. 中已弃用 |
...
| [VLink](../../aspose.html/htmlbodyelement/vlink/) { get; set; } | 用户访问过的链接颜色。请参阅 HTML 4.01 中的 vlink 属性定义。此属性在 HTML 4.01. 中已弃用 |
