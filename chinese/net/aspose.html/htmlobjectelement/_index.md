...
description: 通用嵌入对象原则上对象元素 上的所有属性都是可读写的但在某些环境中某些属性可能是只读的 一旦底层对象被实例化请参阅 HTML 4.01http//www.w3.org/TR/1999/REC-html401-19991224中的 OBJECT 元素 定义 
type: docs
weight: 3520
url: /zh/net/aspose.html/htmlobjectelement/
---
## HTMLObjectElement class

通用嵌入对象。原则上，对象元素 上的所有属性都是可读写的，但在某些环境中，某些属性可能是只读的 一旦底层对象被实例化。请参阅 [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224)中的 OBJECT 元素 定义 ]。
...
| 姓名 | 描述 |
| --- | --- |
| [Align](../../aspose.html/htmlobjectelement/align) { get; set; } | 将此对象（垂直或水平）与其周围的文本对齐。请参阅 HTML 4.01 中的 align 属性定义。此属性在 HTML 4.01 中已弃用。 |
| [Archive](../../aspose.html/htmlobjectelement/archive) { get; set; } | 以空格分隔的档案列表。请参阅 HTML 4.01 中的存档属性定义。 |
...
| [Border](../../aspose.html/htmlobjectelement/border) { get; set; } | 对象周围的边框宽度。请参阅 HTML 4.01 中的边框属性定义。此属性在 HTML 4.01 中已弃用。 |
...
| [ClassId](../../aspose.html/htmlobjectelement/classid) { get; set; } | 定义在 Windows 注册表或 URL 中设置的类 ID 值 |
...
| [Code](../../aspose.html/htmlobjectelement/code) { get; set; } | Applet 类文件。请参阅 HTMLAppletElement 的` 代码` 属性。 |
| [CodeBase](../../aspose.html/htmlobjectelement/codebase) { get; set; } | 基础 URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] 对于` 类 ID` 、` 数据` 和 ` 存档` 属性。请参阅 HTML 4.01 中的代码库属性定义 。 |
| [CodeType](../../aspose.html/htmlobjectelement/codetype) { get; set; } | 通过` classid` 属性下载的数据的内容类型。 请参阅 HTML 4.01 中的 codetype 属性定义。 |
| [Data](../../aspose.html/htmlobjectelement/data) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] 指定对象数据的位置。请参阅 HTML 4.01 中的 data 属性定义。 |
| [Declare](../../aspose.html/htmlobjectelement/declare) { get; set; } | 声明（供将来参考），但不要实例化此对象。 参见 HTML 4.01 中的 declare 属性定义。 |
...
| [Form](../../aspose.html/htmlobjectelement/form) { get; set; } | 返回包含此控件的` FORM` 元素。如果此控件不在表单的上下文中，则返回` null` 。 |
| [Height](../../aspose.html/htmlobjectelement/height) { get; set; } | 覆盖高度。请参阅 HTML 4.01 中的 height 属性定义。 |
| [Hspace](../../aspose.html/htmlobjectelement/hspace) { get; set; } | 水平空间，以像素为单位，位于此图像、 小程序或对象的左侧和右侧。请参阅 HTML 4.01 中的 hspace 属性定义。 此属性在 HTML 4.01 中已弃用。 |
...
| [Name](../../aspose.html/htmlobjectelement/name) { get; set; } | 与表单一起提交时的表单控件或对象名称。请参阅 HTML 4.01 中的 name 属性定义。 |
...
| [Standby](../../aspose.html/htmlobjectelement/standby) { get; set; } | 加载对象时要呈现的消息。请参阅 HTML 4.01 中的备用属性 定义。 |
| [Style](../../aspose.html/htmlelement/style) { get; } | 表示允许作者直接将样式信息应用于特定元素的样式属性。 |
| [TabIndex](../../aspose.html/htmlobjectelement/tabindex) { get; set; } | 表示元素在跳位顺序中的位置的索引。请参阅 HTML 4.01 中的 tabindex 属性定义。 |
...
| [Type](../../aspose.html/htmlobjectelement/type) { get; set; } | 通过` data` 属性下载的数据的内容类型。请参阅 HTML 4.01 中的 type 属性定义。 |
| [UseMap](../../aspose.html/htmlobjectelement/usemap) { get; set; } | 使用客户端图像映射。请参阅 HTML 4.01 中的 usemap 属性定义。 |
| [Vspace](../../aspose.html/htmlobjectelement/vspace) { get; set; } | 垂直空间，以像素为单位，位于此图像、小程序或对象的上方和下方。请参阅 HTML 4.01 中的 vspace 属性定义。此属性在 HTML 4.01 中已弃用。 |
| [Width](../../aspose.html/htmlobjectelement/width) { get; set; } | 覆盖宽度。请参阅 HTML 4.01 中的宽度属性定义。 |
