...
description: Aspose.Html.HTMLObjectElement 班级. 通用嵌入式对象原则上对象元素 上的所有属性都是可读写的但在某些环境中一旦基础对象被实例化某些属性可能是只读的 请参阅 中的 OBJECT 元素 定义HTML 4.01.
type: docs
weight: 3440
...
通用嵌入式对象。原则上，对象元素 上的所有属性都是可读写的，但在某些环境中，一旦基础对象被实例化，某些属性可能是只读的 。请参阅 [中的 OBJECT 元素 定义[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224)].
...
| 姓名 | 描述 |
| --- | --- |
| [Align](../../aspose.html/htmlobjectelement/align/) { get; set; } | 将此对象与其周围的文本对齐（垂直或水平）。请参阅 HTML 4.01 中的对齐属性定义。此属性在 HTML 4.01. 中已弃用 |
| [Archive](../../aspose.html/htmlobjectelement/archive/) { get; set; } | 空格分隔的档案列表。请参阅 HTML 4.01. 中的归档属性定义 |
...
| [Border](../../aspose.html/htmlobjectelement/border/) { get; set; } | 对象周围边框的宽度。请参阅 HTML 4.01 中的 border 属性定义。此属性在 HTML 4.01. 中已弃用 |
...
| [Code](../../aspose.html/htmlobjectelement/code/) { get; set; } | Applet 类文件。见`代码`HTMLAppletElement 的属性。 |
| [CodeBase](../../aspose.html/htmlobjectelement/codebase/) { get; set; } | 基本 URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] 为了`班级号`,`数据` 和 `档案`属性。请参阅 HTML 4.01. 中的代码库属性定义 |
| [CodeType](../../aspose.html/htmlobjectelement/codetype/) { get; set; } | 下载数据的内容类型`班级号`属性。 请参阅 HTML 4.01. 中的代码类型属性定义 |
| [Data](../../aspose.html/htmlobjectelement/data/) { get; set; } | 一个 URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] 指定对象数据的位置。请参阅 HTML 4.01. 中的数据 属性定义 |
| [Declare](../../aspose.html/htmlobjectelement/declare/) { get; set; } | 声明（供将来参考），但不实例化此对象。 请参阅 HTML 4.01. 中的 declare 属性定义 |
...
| [Form](../../aspose.html/htmlobjectelement/form/) { get; set; } | 返回`形式`包含此控件的元素。退货`无效的`如果此控件不在窗体的上下文中。 |
| [Height](../../aspose.html/htmlobjectelement/height/) { get; set; } | 覆盖高度。见 HTML 4.01. 中的高度属性定义 |
| [Hspace](../../aspose.html/htmlobjectelement/hspace/) { get; set; } | 此图像、 小程序或对象左右两侧的水平空间（以像素为单位）。请参阅 HTML 4.01 中的 hspace 属性定义。 此属性在 HTML 4.01 中已弃用。 |
...
| [Name](../../aspose.html/htmlobjectelement/name/) { get; set; } | 与表单一起提交时的表单控件或对象名称。请参阅 HTML 4.01. 中的名称 属性定义 |
...
| [TabIndex](../../aspose.html/htmlobjectelement/tabindex/) { get; set; } | 表示元素在 Tab 键顺序中的位置的索引。请参阅 HTML 4.01. 中的 tabindex 属性定义 |
...
| [Type](../../aspose.html/htmlobjectelement/type/) { get; set; } | 下载数据的内容类型`数据`属性。请参阅 HTML 4.01. 中的类型属性定义 |
| [UseMap](../../aspose.html/htmlobjectelement/usemap/) { get; set; } | 使用客户端图像映射。请参阅 HTML 4.01. 中的 usemap 属性定义 |
| [Vspace](../../aspose.html/htmlobjectelement/vspace/) { get; set; } | 此图像、小程序或对象上方和下方的垂直空间（以像素为单位）。请参阅 HTML 4.01 中的 vspace 属性定义。此属性在 HTML 4.01. 中已弃用 |
| [Width](../../aspose.html/htmlobjectelement/width/) { get; set; } | 覆盖宽度。参见 HTML 4.01. 中的 width 属性定义 |
