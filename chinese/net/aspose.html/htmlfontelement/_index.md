...
description: 本地更改字体请参阅 HTML 4.01 中的 FONT 元素定义这个 元素在 HTML 4.01 中已被弃用
type: docs
weight: 3300
url: /zh/net/aspose.html/htmlfontelement/
---
## HTMLFontElement class

本地更改字体。请参阅 HTML 4.01 中的 FONT 元素定义。这个 元素在 HTML 4.01 中已被弃用。
...
| [Color](../../aspose.html/htmlfontelement/color) { get; set; } | 字体颜色。请参阅 HTML 4.01 中的颜色属性定义。此 属性在 HTML 4.01 中已弃用。 |
| [Dir](../../aspose.html/htmlelement/dir) { get; set; } | 指定方向性中性文本的基本方向和表格的 方向性。请参阅 HTML 4.01 中的 dir 属性定义。 |
| [Face](../../aspose.html/htmlfontelement/face) { get; set; } | 字体标识符。请参阅 HTML 4.01 中的 face 属性定义。 此属性在 HTML 4.01 中已弃用。 |
...
| [Size](../../aspose.html/htmlfontelement/size) { get; set; } | 字体大小。请参阅 HTML 4.01 中的 size 属性定义。此 属性在 HTML 4.01 中已弃用。 |
