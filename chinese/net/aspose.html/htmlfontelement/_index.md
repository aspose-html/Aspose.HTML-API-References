...
description: Aspose.Html.HTMLFontElement 班级. 字体的本地更改请参阅 HTML 4.01 中的 FONT 元素定义此 元素在 HTML 4.01. 中已弃用
type: docs
weight: 3220
...
字体的本地更改。请参阅 HTML 4.01 中的 FONT 元素定义。此 元素在 HTML 4.01. 中已弃用
...
| [Face](../../aspose.html/htmlfontelement/face/) { get; set; } | 字体外观标识符。参见 HTML 4.01 中的 face 属性定义。 此属性在 HTML 4.01 中已弃用。 |
...
| [Size](../../aspose.html/htmlfontelement/size/) { get; set; } | 字体大小。请参阅 HTML 4.01 中的大小属性定义。此 属性在 HTML 4.01. 中已弃用 |
