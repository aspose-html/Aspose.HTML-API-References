...
description: Aspose.Html.HTMLAnchorElement 班级. 锚元素请参阅 HTML 4.01. 中的 A 元素定义
type: docs
weight: 3060
url: /zh/net/aspose.html/htmlanchorelement/
---
## HTMLAnchorElement class

锚元素。请参阅 HTML 4.01. 中的 A 元素定义
...
| 姓名 | 描述 |
| --- | --- |
| [AccessKey](../../aspose.html/htmlanchorelement/accesskey/) { get; set; } | 用于访问表单控件的单个字符访问键。请参阅 HTML 4.01. 中的 accesskey 属性定义 |
...
| [Charset](../../aspose.html/htmlanchorelement/charset/) { get; set; } | 链接资源的字符编码。请参阅 HTML 4.01. 中的字符集 属性定义 |
...
| [Coords](../../aspose.html/htmlanchorelement/coords/) { get; set; } | 以逗号分隔的长度列表，定义活动区域几何形状。 另请参阅`形状`对于区域的形状。请参阅 HTML 4.01. 中的 坐标属性定义 |
...
| [Hash](../../aspose.html/htmlanchorelement/hash/) { get; set; } | 获取或设置关联 URL 的哈希段的字符串表示。 |
| [Host](../../aspose.html/htmlanchorelement/host/) { get; set; } | 获取或设置关联 URL 的主机和端口段的字符串表示。 |
| [Hostname](../../aspose.html/htmlanchorelement/hostname/) { get; set; } | 获取或设置关联 URL 的主机段的字符串表示。 |
| [Href](../../aspose.html/htmlanchorelement/href/) { get; set; } | 绝对 URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) 的链接资源。请参阅 HTML 4.01. 中的 href 属性 定义 |
| [Hreflang](../../aspose.html/htmlanchorelement/hreflang/) { get; set; } | 链接资源的语言代码。请参阅 HTML 4.01. 中的 hreflang 属性 定义 |
...
| [Name](../../aspose.html/htmlanchorelement/name/) { get; set; } | 锚名称。见 HTML 4.01. 中的 name 属性定义 |
...
| [Origin](../../aspose.html/htmlanchorelement/origin/) { get; } | 获取关联 URL 的原始段的字符串表示。 |
...
| [Password](../../aspose.html/htmlanchorelement/password/) { get; set; } | 获取或设置关联 URL 的密码段的字符串表示。 |
| [Pathname](../../aspose.html/htmlanchorelement/pathname/) { get; set; } | 获取或设置关联 URL 的路径段的字符串表示。 |
| [Port](../../aspose.html/htmlanchorelement/port/) { get; set; } | 获取或设置关联 URL 的端口段的字符串表示。 |
...
| [Protocol](../../aspose.html/htmlanchorelement/protocol/) { get; set; } | 获取或设置关联 URL 的方案段的字符串表示。 |
| [Rel](../../aspose.html/htmlanchorelement/rel/) { get; set; } | 前向链接类型。请参阅 HTML 4.01. 中的 rel 属性定义 |
| [RelList](../../aspose.html/htmlanchorelement/rellist/) { get; } | 返回一个实时 DOMTokenList，其中包含从解析“rel”属性时收到的令牌。 |
| [Rev](../../aspose.html/htmlanchorelement/rev/) { get; set; } | 反向链接类型。请参阅 HTML 4.01. 中的 rev 属性定义 |
| [SchemaTypeInfo](../../aspose.html.dom/element/schematypeinfo/) { get; } | 与此元素关联的类型信息。 |
| [Search](../../aspose.html/htmlanchorelement/search/) { get; set; } | 获取或设置关联 URL 的搜索段的字符串表示形式。 |
| [ShadowRoot](../../aspose.html.dom/element/shadowroot/) { get; } | 返回存储在此元素上的 shadowRoot，如果关闭则返回 null。 |
| [Shape](../../aspose.html/htmlanchorelement/shape/) { get; set; } | 活动区域的形状。坐标由 给出`坐标`.请参阅 HTML 4.01. 中的形状属性定义 |
| [Style](../../aspose.html/htmlelement/style/) { get; } | 表示样式属性，允许作者将样式信息直接应用于特定元素。 |
| [TabIndex](../../aspose.html/htmlanchorelement/tabindex/) { get; set; } | 表示元素在 Tab 键顺序中的位置的索引。请参阅 HTML 4.01. 中的 tabindex 属性定义 |
| [TagName](../../aspose.html.dom/element/tagname/) { get; } | 元素的名称。 |
| [Target](../../aspose.html/htmlanchorelement/target/) { get; set; } | 在其中呈现资源的框架。请参阅 HTML 4.01. 中的目标属性定义 |
...
| [Type](../../aspose.html/htmlanchorelement/type/) { get; set; } | 咨询内容类型。请参阅 HTML 4.01. 中的类型属性定义 |
| [Username](../../aspose.html/htmlanchorelement/username/) { get; set; } | 获取或设置关联 URL 的用户名段的字符串表示。 |
...
| [Blur](../../aspose.html/htmlanchorelement/blur/)() | 从此元素移除键盘焦点。 |
...
| [Focus](../../aspose.html/htmlanchorelement/focus/)() | 为该元素提供键盘焦点。 |
