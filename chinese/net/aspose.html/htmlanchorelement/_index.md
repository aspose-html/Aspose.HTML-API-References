...
description: 锚元素请参阅 HTML 4.01 中的 A 元素定义
type: docs
weight: 3140
...
| 姓名 | 描述 |
| --- | --- |
| [AccessKey](../../aspose.html/htmlanchorelement/accesskey) { get; set; } | 用于访问表单控件的单字符访问键。请参阅 HTML 4.01 中的 accesskey 属性定义。 |
...
| [Coords](../../aspose.html/htmlanchorelement/coords) { get; set; } | 逗号分隔的长度列表，定义活动区域几何。 另请参见` shape` 以了解区域的形状。请参阅 HTML 4.01 中的 coords 属性定义。 |
...
| [Href](../../aspose.html/htmlanchorelement/href) { get; set; } | 绝对 URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] 链接资源。请参阅 HTML 4.01 中的 href 属性 定义。 |
...
| [Name](../../aspose.html/htmlanchorelement/name) { get; set; } | 锚名称。请参阅 HTML 4.01 中的 name 属性定义。 |
...
| [Rel](../../aspose.html/htmlanchorelement/rel) { get; set; } | 正向链接类型。请参阅 HTML 4.01 中的 rel 属性定义。 |
...
| [Shape](../../aspose.html/htmlanchorelement/shape) { get; set; } | 活动区域的形状。坐标由 ` coords` 给出。请参阅 HTML 4.01 中的 shape 属性定义。 |
| [Style](../../aspose.html/htmlelement/style) { get; } | 表示允许作者直接将样式信息应用于特定元素的样式属性。 |
| [TabIndex](../../aspose.html/htmlanchorelement/tabindex) { get; set; } | 表示元素在跳位顺序中的位置的索引。请参阅 HTML 4.01 中的 tabindex 属性定义。 |
| [TagName](../../aspose.html.dom/element/tagname) { get; } | 元素的名称。 |
| [Target](../../aspose.html/htmlanchorelement/target) { get; set; } | 渲染资源的框架。参见 HTML 4.01 中的目标属性定义。 |
...
| [Type](../../aspose.html/htmlanchorelement/type) { get; set; } | 咨询内容类型。请参阅 HTML 4.01 中的 type 属性定义。 |
...
| [Focus](../../aspose.html/htmlanchorelement/focus)() | 将键盘焦点赋予该元素。 |
