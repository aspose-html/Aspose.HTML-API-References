...
description:  FORM 元素包含类似于集合 和元素的行为.它提供对包含的表单控件 以及表单元素的属性的直接访问请参阅 HTML 4.01 中的 FORM 元素 定义
type: docs
weight: 3310
url: /zh/net/aspose.html/htmlformelement/
---
## HTMLFormElement class

` FORM` 元素包含类似于集合 和元素的行为.它提供对包含的表单控件 以及表单元素的属性的直接访问。请参阅 HTML 4.01 中的 FORM 元素 定义。
...
| 姓名 | 描述 |
| --- | --- |
| [AcceptCharset](../../aspose.html/htmlformelement/acceptcharset) { get; set; } | 服务器支持的字符集列表。请参阅 HTML 4.01 中的 accept-charset 属性定义。 |
| [Action](../../aspose.html/htmlformelement/action) { get; set; } | 服务器端表单处理程序。请参阅 HTML 4.01 中的 action 属性定义。 |
...
| [Elements](../../aspose.html/htmlformelement/elements) { get; } | 返回表单中所有表单控件元素的集合。 |
| [Enctype](../../aspose.html/htmlformelement/enctype) { get; set; } | 提交表单的内容类型，一般为 "application/x-www-form-urlencoded"。请参阅 HTML 4.01 中的 enctype 属性 定义。 onsubmit 偶数处理程序不能保证 在调用此方法时被触发。由于历史原因，行为是 不一致，作者不应依赖 特定的行为。 |
...
| [Length](../../aspose.html/htmlformelement/length) { get; } | 表单中的表单控件数。 |
...
| [Method](../../aspose.html/htmlformelement/method) { get; set; } | HTTP 方法 [[IETF RFC 2616](http://www.ietf.org/rfc/rfc2616.txt) ] 用于提交表单。请参阅 HTML 4.01 中的方法属性定义。 |
| [Name](../../aspose.html/htmlformelement/name) { get; set; } | 命名表单。 |
...
| [Target](../../aspose.html/htmlformelement/target) { get; set; } | 渲染资源的框架。参见 HTML 4.01 中的目标属性定义。 |
...
| [Reset](../../aspose.html/htmlformelement/reset)() | 恢复表单元素的默认值。它执行与重置按钮相同的操作 。 |
...
| [Submit](../../aspose.html/htmlformelement/submit)() | 提交表单。它执行与提交按钮相同的操作。 |
