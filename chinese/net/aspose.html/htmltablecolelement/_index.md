...
description: Aspose.Html.HTMLTableColElement 班级. 重组COL和科尔集团元素请参阅 HTML 4.01. 中的 COL 元素定义
type: docs
weight: 3560
...
重组`COL`和`科尔集团`元素。请参阅 HTML 4.01. 中的 COL 元素定义
...
| 姓名 | 描述 |
| --- | --- |
| [Align](../../aspose.html/htmltablecolelement/align/) { get; set; } | 列中单元格数据的水平对齐方式。请参阅 HTML 4.01. 中的对齐属性 定义 |
...
| [Span](../../aspose.html/htmltablecolelement/span/) { get; set; } | 指示组中或受分组影响的列数。 请参阅 HTML 4.01 中的 span 属性定义。 |
...
| [Width](../../aspose.html/htmltablecolelement/width/) { get; set; } | 默认列宽。参见 HTML 4.01. 中的 width 属性定义 |
