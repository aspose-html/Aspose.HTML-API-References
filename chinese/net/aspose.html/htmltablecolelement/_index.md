...
description: 重新组合 COL 和 COLGROUP 个元素请参阅 HTML 4.01 中的 COL 元素定义
type: docs
weight: 3640
url: /zh/net/aspose.html/htmltablecolelement/
---
## HTMLTableColElement class

重新组合` COL` 和` COLGROUP` 个元素。请参阅 HTML 4.01 中的 COL 元素定义。
...
| 姓名 | 描述 |
| --- | --- |
| [Align](../../aspose.html/htmltablecolelement/align) { get; set; } | 列中单元格数据的水平对齐。请参阅 HTML 4.01 中的 align 属性 定义。 |
...
| [Ch](../../aspose.html/htmltablecolelement/ch) { get; set; } | 列中单元格的对齐字符。请参阅 HTML 4.01 中的 char 属性 定义。 |
...
| [ChOff](../../aspose.html/htmltablecolelement/choff) { get; set; } | 对齐字符的偏移量。请参阅 HTML 4.01 中的 charoff 属性定义。 |
...
| [Span](../../aspose.html/htmltablecolelement/span) { get; set; } | 表示组中或受分组影响的列数。 参见 HTML 4.01 中的 span 属性定义。 |
...
| [VAlign](../../aspose.html/htmltablecolelement/valign) { get; set; } | 列中单元格数据的垂直对齐方式。请参阅 HTML 4.01 中的 valign 属性 定义。 |
| [Width](../../aspose.html/htmltablecolelement/width) { get; set; } | 默认列宽。请参阅 HTML 4.01 中的宽度属性定义。 |
