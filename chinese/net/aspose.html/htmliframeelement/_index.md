...
description: Aspose.Html.HTMLIFrameElement 班级. 内联子窗口请参阅 HTML 4.01. 中的 IFRAME 元素定义
type: docs
weight: 3300
url: /zh/net/aspose.html/htmliframeelement/
---
...
| 姓名 | 描述 |
| --- | --- |
| [Align](../../aspose.html/htmliframeelement/align/) { get; set; } | 相对于其 周围文本对齐此对象（垂直或水平）。请参阅 HTML 4.01 中的对齐属性定义。 此属性在 HTML 4.01 中已弃用。 |
...
| [FrameBorder](../../aspose.html/htmliframeelement/frameborder/) { get; set; } | 请求边框。参见 HTML 4.01. 中的 frameborder 属性定义 |
| [Height](../../aspose.html/htmliframeelement/height/) { get; set; } | 帧高度。见 HTML 4.01. 中的高度属性定义 |
...
| [LongDesc](../../aspose.html/htmliframeelement/longdesc/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) 指定此图像或框架的详细描述。请参阅 HTML 4.01. 中的 longdesc 属性定义 |
| [MarginHeight](../../aspose.html/htmliframeelement/marginheight/) { get; set; } | 帧边距高度，以像素为单位。请参阅 HTML 4.01. 中的 marginheight 属性 定义 |
| [MarginWidth](../../aspose.html/htmliframeelement/marginwidth/) { get; set; } | 帧边距宽度，以像素为单位。请参阅 HTML 4.01. 中的 marginwidth 属性定义 |
| [Name](../../aspose.html/htmliframeelement/name/) { get; set; } | 框架名称（对象的`目标`属性）。请参阅 HTML 4.01. 中的 name 属性定义 |
...
| [Scrolling](../../aspose.html/htmliframeelement/scrolling/) { get; set; } | 指定框架是否应该有滚动条。请参阅 HTML 4.01. 中的 滚动属性定义 |
| [ShadowRoot](../../aspose.html.dom/element/shadowroot/) { get; } | 返回存储在此元素上的 shadowRoot，如果关闭则返回 null。 |
| [Src](../../aspose.html/htmliframeelement/src/) { get; set; } | 一个 URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] 指定初始框架内容。请参阅 HTML 4.01. 中的 src 属性 定义 |
...
| [Width](../../aspose.html/htmliframeelement/width/) { get; set; } | 帧宽度。参见 HTML 4.01. 中的 width 属性定义 |
