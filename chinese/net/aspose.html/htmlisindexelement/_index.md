...
description: Aspose.Html.HTMLIsIndexElement 班级. 此元素用于单行文本输入请参阅 HTML 4.01 中的 ISINDEX 元素 定义此元素在 HTML 4.01. 中已弃用
type: docs
weight: 3330
...
| [Form](../../aspose.html/htmlisindexelement/form/) { get; } | 返回包含此控件的元素。返回 如果此控件不在 窗体的上下文中。 |
