...
description: 此元素用于单行文本输入请参阅 HTML 4.01 中的 ISINDEX 元素 定义此元素在 HTML 4.01 中已弃用
type: docs
weight: 3410
url: /zh/net/aspose.html/htmlisindexelement/
---
## HTMLIsIndexElement class

此元素用于单行文本输入。请参阅 HTML 4.01 中的 ISINDEX 元素 定义。此元素在 HTML 4.01 中已弃用。
...
| [Form](../../aspose.html/htmlisindexelement/form) { get; } | 返回包含此控件的 &lt;code&gt;FORM&lt;/code&gt; 元素。如果此控件不在 表单的上下文中，则返回 &lt;code&gt;null&lt;/code&gt;。 |
...
| [Prompt](../../aspose.html/htmlisindexelement/prompt) { get; set; } | 提示信息。请参阅 HTML 4.01 中的提示属性定义。 此属性在 HTML 4.01 中已弃用。 |
