...
description: 修改部分文档的通知请参阅 HTML 4.01 中的 INS 和 DEL 元素 定义
type: docs
weight: 3490
url: /zh/net/aspose.html/htmlmodelement/
---
## HTMLModElement class

修改部分文档的通知。请参阅 HTML 4.01 中的 INS 和 DEL 元素 定义。
...
| [Cite](../../aspose.html/htmlmodelement/cite) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] 指定描述更改原因的文档。 参见 HTML 4.01 中的 cite 属性定义。 |
...
| [DateTime](../../aspose.html/htmlmodelement/datetime) { get; set; } | 更改的日期和时间。请参阅 HTML 4.01 中的 datetime 属性定义 。 |
