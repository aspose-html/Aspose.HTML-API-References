...
description: Aspose.Html.HTMLModElement 班级. 部分文件修改通知请参阅 HTML 4.01 中的 INS 和 DEL 元素 定义
type: docs
weight: 3410
...
部分文件修改通知。请参阅 HTML 4.01 中的 INS 和 DEL 元素 定义。
...
| [Cite](../../aspose.html/htmlmodelement/cite/) { get; set; } | 一个 URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] 指定描述更改原因的文档。 请参阅 HTML 4.01 中的引用属性定义。 |
...
| [DateTime](../../aspose.html/htmlmodelement/datetime/) { get; set; } | 更改的日期和时间。请参阅 HTML 4.01. 中的日期时间属性定义 |
