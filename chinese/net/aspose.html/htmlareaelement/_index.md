...
description: 客户端图像映射区域定义请参阅 HTML 4.01 中的 AREA 元素定义
type: docs
weight: 3160
url: /zh/net/aspose.html/htmlareaelement/
---
...
| 姓名 | 描述 |
| --- | --- |
| [AccessKey](../../aspose.html/htmlareaelement/accesskey) { get; set; } | 用于访问表单控件的单字符访问键。请参阅 HTML 4.01 中的 accesskey 属性定义。 |
| [Alt](../../aspose.html/htmlareaelement/alt) { get; set; } | 用户代理的替代文本不呈现此 元素的正常内容。请参阅 HTML 4.01 中的 alt 属性定义。 |
...
| [Coords](../../aspose.html/htmlareaelement/coords) { get; set; } | 逗号分隔的长度列表，定义活动区域几何。 另请参见` shape` 以了解区域的形状。请参阅 HTML 4.01 中的 coords 属性定义。 |
...
| [Href](../../aspose.html/htmlareaelement/href) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] 链接资源。 参见 HTML 4.01 中的 href 属性定义。 |
...
| [NoHref](../../aspose.html/htmlareaelement/nohref) { get; set; } | 指定这个区域是非活动的，即没有相关的动作。 请参阅 HTML 4.01 中的 nohref 属性定义。 |
...
| [Shape](../../aspose.html/htmlareaelement/shape) { get; set; } | 活动区域的形状。坐标由 ` coords` 给出。请参阅 HTML 4.01 中的 shape 属性定义。 |
| [Style](../../aspose.html/htmlelement/style) { get; } | 表示允许作者直接将样式信息应用于特定元素的样式属性。 |
| [TabIndex](../../aspose.html/htmlareaelement/tabindex) { get; set; } | 表示元素在跳位顺序中的位置的索引。请参阅 HTML 4.01 中的 tabindex 属性定义。 |
| [TagName](../../aspose.html.dom/element/tagname) { get; } | 元素的名称。 |
| [Target](../../aspose.html/htmlareaelement/target) { get; set; } | 渲染资源的框架。参见 HTML 4.01 中的目标属性定义。 |
