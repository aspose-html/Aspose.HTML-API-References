...
description: Aspose.Html.HTMLAreaElement 班级. 客户端图像映射区域定义请参阅 HTML 4.01. 中的 AREA 元素定义
type: docs
weight: 3080
...
| 姓名 | 描述 |
| --- | --- |
| [AccessKey](../../aspose.html/htmlareaelement/accesskey/) { get; set; } | 用于访问表单控件的单个字符访问键。请参阅 HTML 4.01. 中的 accesskey 属性定义 |
...
| [Coords](../../aspose.html/htmlareaelement/coords/) { get; set; } | 以逗号分隔的长度列表，定义活动区域几何形状。 另见`形状`对于区域的形状。请参阅 HTML 4.01. 中的 坐标属性定义 |
...
| [Href](../../aspose.html/htmlareaelement/href/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] 的链接资源。 请参阅 HTML 4.01 中的 href 属性定义。 |
...
| [NoHref](../../aspose.html/htmlareaelement/nohref/) { get; set; } | 指定此区域处于非活动状态，即没有关联的操作。 请参阅 HTML 4.01. 中的 nohref 属性定义 |
...
| [RelList](../../aspose.html/htmlareaelement/rellist/) { get; } | 返回一个实时 DOMTokenList，其中包含从解析“rel”属性时收到的令牌。 |
...
| [Shape](../../aspose.html/htmlareaelement/shape/) { get; set; } | 活动区域的形状。坐标由 给出`坐标`.请参阅 HTML 4.01. 中的形状属性定义 |
| [Style](../../aspose.html/htmlelement/style/) { get; } | 表示样式属性，允许作者将样式信息直接应用于特定元素。 |
| [TabIndex](../../aspose.html/htmlareaelement/tabindex/) { get; set; } | 表示元素在 Tab 键顺序中的位置的索引。请参阅 HTML 4.01. 中的 tabindex 属性定义 |
| [TagName](../../aspose.html.dom/element/tagname/) { get; } | 元素的名称。 |
| [Target](../../aspose.html/htmlareaelement/target/) { get; set; } | 在其中呈现资源的框架。请参阅 HTML 4.01. 中的目标属性定义 |
