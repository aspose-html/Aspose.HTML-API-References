...
description: 嵌入图像请参阅 HTML 4.01 中的 IMG 元素定义
type: docs
weight: 3390
url: /zh/net/aspose.html/htmlimageelement/
---
## HTMLImageElement class

嵌入图像。请参阅 HTML 4.01 中的 IMG 元素定义。
...
| 姓名 | 描述 |
| --- | --- |
| [Align](../../aspose.html/htmlimageelement/align) { get; set; } | 相对于其 周围文本对齐此对象（垂直或水平）。请参阅 HTML 4.01 中的 align 属性定义。 此属性在 HTML 4.01 中已弃用。 |
| [Alt](../../aspose.html/htmlimageelement/alt) { get; set; } | 用户代理的替代文本不呈现此 元素的正常内容。请参阅 HTML 4.01 中的 alt 属性定义。 |
...
| [Border](../../aspose.html/htmlimageelement/border) { get; set; } | 图像周围边框的宽度。请参阅 HTML 4.01 中的边框属性定义。此属性在 HTML 4.01 中已弃用。请注意，该属性的 类型是` DOMString` 在 DOM Level 1 HTML [[DOM 级别 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ] 。 |
...
| [Height](../../aspose.html/htmlimageelement/height) { get; set; } | 图像的高度（以像素为单位）。请参阅 HTML 4.01 中的 height 属性定义。请注意，此属性的类型是 ` DOMString` in DOM Level 1 HTML [[DOM Level 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ]。 @version DOM 级别 2 |
| [Hspace](../../aspose.html/htmlimageelement/hspace) { get; set; } | 此图像左侧和右侧的水平空间（以像素为单位）。请参阅 HTML 4.01 中的 hspace 属性定义。此属性为 在 HTML 4.01 中已弃用。请注意，此属性的类型是 ` DOMString` in DOM Level 1 HTML [[DOM Level 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ]。 @version DOM 级别 2 |
...
| [IsMap](../../aspose.html/htmlimageelement/ismap) { get; set; } | 使用服务器端图像映射。请参阅 HTML 4.01 中的 ismap 属性定义。 |
...
| [LongDesc](../../aspose.html/htmlimageelement/longdesc) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] 指定此图像或框架的详细描述。请参阅 HTML 4.01 中的 longdesc 属性定义。 |
| [Name](../../aspose.html/htmlimageelement/name) { get; set; } | 元素的名称（为了向后兼容）。 |
...
| [Src](../../aspose.html/htmlimageelement/src) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] 指定此图像的来源。请参阅 HTML 4.01 中的 src 属性 定义。 |
...
| [UseMap](../../aspose.html/htmlimageelement/usemap) { get; set; } | 使用客户端图像映射。请参阅 HTML 4.01 中的 usemap 属性定义。 |
| [Vspace](../../aspose.html/htmlimageelement/vspace) { get; set; } | 此图像上方和下方的垂直空间（以像素为单位）。请参阅 HTML 4.01 中的 vspace 属性定义。此属性在 HTML 4.01 中已弃用。请注意，此属性的类型是 DOM Level 1 HTML [[DOM 级别 1](http://www.w3.org/TR/1998/REC-DOM-Level-1中的“DOMString”-19981001) ]。 @version DOM 级别 2 |
| [Width](../../aspose.html/htmlimageelement/width) { get; set; } | 图像的宽度（以像素为单位）。请参阅 HTML 4.01 中的宽度属性定义。请注意，此属性的类型是 ` DOMString` in DOM Level 1 HTML [[DOM Level 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ]。 @version DOM 级别 2 |
