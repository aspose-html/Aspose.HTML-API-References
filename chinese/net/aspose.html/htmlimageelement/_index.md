...
description: Aspose.Html.HTMLImageElement 班级. 嵌入图像请参阅 HTML 4.01. 中的 IMG 元素定义
type: docs
weight: 3310
...
| 姓名 | 描述 |
| --- | --- |
| [Align](../../aspose.html/htmlimageelement/align/) { get; set; } | 相对于其 周围文本对齐此对象（垂直或水平）。请参阅 HTML 4.01 中的对齐属性定义。 此属性在 HTML 4.01 中已弃用。 |
...
| [Border](../../aspose.html/htmlimageelement/border/) { get; set; } | 图像周围边框的宽度。请参阅 HTML 4.01 中的边框属性定义。此属性在 HTML 4.01 中已弃用。请注意，此属性的 类型是`DOM字符串`在 DOM 级别 1 HTML [[DOM 级别 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ] . |
...
| [Height](../../aspose.html/htmlimageelement/height/) { get; set; } | 图像的高度（以像素为单位）。请参阅 HTML 4.01 中的高度属性定义。请注意，此属性的类型为 `DOM字符串`在 DOM 级别 1 HTML [[DOM 级别 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ]. @version DOM 级别 2 |
| [Hspace](../../aspose.html/htmlimageelement/hspace/) { get; set; } | 此图像左侧和右侧的水平空间（以像素为单位）。请参阅 HTML 4.01 中的 hspace 属性定义。此属性在 HTML 4.01 中已 弃用。请注意，此属性的类型为 `DOM字符串`在 DOM 级别 1 HTML [[DOM 级别 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ]. @version DOM 级别 2 |
...
| [Vspace](../../aspose.html/htmlimageelement/vspace/) { get; set; } | 此图像上方和下方的垂直空间（以像素为单位）。请参阅 HTML 4.01 中的 vspace 属性定义。此属性在 HTML 4.01 中已弃用。请注意，此属性的类型在 DOM Level 1 HTML [[DOM 级别 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ]. @version DOM 级别 2 |
| [Width](../../aspose.html/htmlimageelement/width/) { get; set; } | 图像的宽度（以像素为单位）。请参阅 HTML 4.01 中的宽度属性定义。请注意，此属性的类型为 `DOM字符串`在 DOM 级别 1 HTML [[DOM 级别 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ]. @version DOM 级别 2 |
