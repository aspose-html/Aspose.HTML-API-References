...
description: 文档库 URI IETF RFC 2396http//www.ietf.org/rfc/rfc2396.txt 请参阅 HTML 4.01 中的 BASE 元素定义
type: docs
weight: 3180
url: /zh/net/aspose.html/htmlbaseelement/
---
## HTMLBaseElement class

文档库 URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ]。请参阅 HTML 4.01 中的 BASE 元素定义。
...
| [Href](../../aspose.html/htmlbaseelement/href) { get; set; } | 基础 URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ]。请参阅 HTML 4.01 中的 href 属性定义。 |
...
| [Target](../../aspose.html/htmlbaseelement/target) { get; set; } | 默认目标帧。请参阅 HTML 4.01 中的目标属性定义。 |
