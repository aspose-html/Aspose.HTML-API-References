...
| 姓名 | 描述 |
| --- | --- |
| static [FromFileExtension](../../aspose.html/mimetype/fromfileextension)(string) | 基于文件扩展名创建新的 MIME 类型。 |
| [Equals](../../aspose.html/mimetype/equals#equals)(MimeType) | 表示当前对象是否等于另一个同类型的对象。 |
| override [Equals](../../aspose.html/mimetype/equals#equals_1)(object) | 判断指定的Object是否等于当前的Object. |
| override [GetHashCode](../../aspose.html/mimetype/gethashcode)() | 返回此实例的哈希码。 |
| override [ToString](../../aspose.html/mimetype/tostring)() | 返回代表 Mime 类型的String。 |
| [operator ==](../../aspose.html/mimetype/op_equality) | 比较两个 Mime 类型并返回一个布尔值，指示两者是否匹配。 |
| [implicit operator](../../aspose.html/mimetype/op_implicit#op_implicit) | 执行从String到[`MimeType`](../mimetype)的隐式转换。 (2 operators) |
