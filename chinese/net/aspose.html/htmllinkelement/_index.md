...
description: Aspose.Html.HTMLLinkElement 班级. 的关联元素指定到外部资源的链接 定义此文档与该资源的关系反之亦然 请参阅 HTML 4.01 中的 LINK 元素定义另请参阅 链接样式样式表模块中的界面 DOM Level 2 样式表和 CSS .
type: docs
weight: 3370
...
的`关联`元素指定到外部资源的链接， 定义此文档与该资源的关系（反之亦然）。 请参阅 HTML 4.01 中的 LINK 元素定义（另请参阅 `链接样式`样式表模块中的界面 [[DOM Level 2 样式表和 CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113) ]).
...
| [Disabled](../../aspose.html/htmllinkelement/disabled/) { get; set; } | 启用/禁用链接。这目前仅用于样式表 链接，可用于激活或停用样式表。 |
...
| [Href](../../aspose.html/htmllinkelement/href/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) 的链接资源。请参阅 HTML 4.01. 中的 href 属性定义 |
...
| [Rel](../../aspose.html/htmllinkelement/rel/) { get; set; } | 前向链接类型。请参阅 HTML 4.01. 中的 rel 属性定义 |
| [RelList](../../aspose.html/htmllinkelement/rellist/) { get; } | 返回一个实时 DOMTokenList，其中包含从解析“rel”属性时收到的令牌。 |
...
| [Target](../../aspose.html/htmllinkelement/target/) { get; set; } | 在其中呈现资源的框架。请参阅 HTML 4.01. 中的目标属性定义 |
...
| [Type](../../aspose.html/htmllinkelement/type/) { get; set; } | 咨询内容类型。请参阅 HTML 4.01. 中的类型属性定义 |
