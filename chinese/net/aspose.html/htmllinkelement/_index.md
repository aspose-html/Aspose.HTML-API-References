...
description:  LINK 元素指定到外部资源的链接并且 定义此文档与该资源的关系反之亦然 请参阅 HTML 4.01 中的 LINK 元素定义另请参阅 StyleSheet 模块中的  LinkStyle 接口 DOM 2 级样式表和 CSShttp//www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113 
type: docs
weight: 3450
url: /zh/net/aspose.html/htmllinkelement/
---
## HTMLLinkElement class

` LINK` 元素指定到外部资源的链接，并且 定义此文档与该资源的关系（反之亦然）。 请参阅 HTML 4.01 中的 LINK 元素定义（另请参阅 StyleSheet 模块中的 ` LinkStyle` 接口 [[DOM 2 级样式表和 CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113) ]）。
...
| [Charset](../../aspose.html/htmllinkelement/charset) { get; set; } | 链接到的资源的字符编码。请参阅 HTML 4.01 中的字符集 属性定义。 |
...
| [Disabled](../../aspose.html/htmllinkelement/disabled) { get; set; } | 启用/禁用链接。这目前仅用于样式表 链接，并可用于激活或停用样式表。 |
...
| [Href](../../aspose.html/htmllinkelement/href) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] 链接资源。请参阅 HTML 4.01 中的 href 属性定义。 |
| [Hreflang](../../aspose.html/htmllinkelement/hreflang) { get; set; } | 链接资源的语言代码。请参阅 HTML 4.01 中的 hreflang 属性 定义。 |
...
| [Media](../../aspose.html/htmllinkelement/media) { get; set; } | 设计用于一种或多种目标媒体。请参阅 HTML 4.01 中的媒体属性 定义。 |
...
| [Rel](../../aspose.html/htmllinkelement/rel) { get; set; } | 正向链接类型。请参阅 HTML 4.01 中的 rel 属性定义。 |
| [Rev](../../aspose.html/htmllinkelement/rev) { get; set; } | 反向链接类型。请参阅 HTML 4.01 中的 rev 属性定义。 |
...
| [Sheet](../../aspose.html/htmllinkelement/sheet) { get; } | 获取关联的样式表。 |
| [Style](../../aspose.html/htmlelement/style) { get; } | 表示允许作者直接将样式信息应用于特定元素的样式属性。 |
| [TagName](../../aspose.html.dom/element/tagname) { get; } | 元素的名称。 |
| [Target](../../aspose.html/htmllinkelement/target) { get; set; } | 渲染资源的框架。参见 HTML 4.01 中的目标属性定义。 |
...
| [Type](../../aspose.html/htmllinkelement/type) { get; set; } | 咨询内容类型。请参阅 HTML 4.01 中的 type 属性定义。 |
