...
description: Aspose.Html.HTMLStyleElement 班级. 样式信息请参阅 HTML 4.01 中的 STYLE 元素定义CSS 模块 DOM Level 2 样式表和 CSS  和链接样式样式表 模块中的接口 DOM Level 2 样式表和 CSS .
type: docs
weight: 3530
...
样式信息。请参阅 HTML 4.01 中的 STYLE 元素定义，CSS 模块 [[DOM Level 2 样式表和 CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113) ] 和`链接样式`样式表 模块中的接口 [[DOM Level 2 样式表和 CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113) ].
...
| [Type](../../aspose.html/htmlstyleelement/type/) { get; set; } | 样式表语言的内容类型。请参阅 HTML 4.01. 中的类型属性 定义 |
