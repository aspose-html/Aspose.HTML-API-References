...
description: 对于 H1 到 H6 个元素请参阅 HTML 4.01 中的 H1 元素 定义
type: docs
weight: 3360
url: /zh/net/aspose.html/htmlheadingelement/
---
## HTMLHeadingElement class

对于` H1` 到` H6` 个元素。请参阅 HTML 4.01 中的 H1 元素 定义。
...
| 姓名 | 描述 |
| --- | --- |
| [Align](../../aspose.html/htmlheadingelement/align) { get; set; } | 水平文本对齐。请参阅 HTML 4.01 中的 align 属性定义。此属性在 HTML 4.01 中已弃用。 |
