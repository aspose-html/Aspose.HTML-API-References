...
description: Aspose.Html.HTMLHeadingElement 班级. 对于H1到H6元素请参阅 HTML 4.01. 中的 H1 element 定义
type: docs
weight: 3280
...
对于`H1`到`H6`元素。请参阅 HTML 4.01. 中的 H1 element 定义
...
| 姓名 | 描述 |
| --- | --- |
| [Align](../../aspose.html/htmlheadingelement/align/) { get; set; } | 文本水平对齐。请参阅 HTML 4.01 中的对齐属性定义。此属性在 HTML 4.01. 中已弃用 |
