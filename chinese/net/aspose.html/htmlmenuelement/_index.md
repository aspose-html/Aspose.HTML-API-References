...
description: 菜单列表请参阅 HTML 4.01 中的 MENU 元素定义此元素为 在 HTML 4.01 中已弃用
type: docs
weight: 3470
url: /zh/net/aspose.html/htmlmenuelement/
---
## HTMLMenuElement class

菜单列表。请参阅 HTML 4.01 中的 MENU 元素定义。此元素为 在 HTML 4.01 中已弃用。
...
| [Compact](../../aspose.html/htmlmenuelement/compact) { get; set; } | 减少列表项之间的间距。请参阅 HTML 4.01 中的紧凑属性定义 。此属性在 HTML 4.01 中已弃用。 |
