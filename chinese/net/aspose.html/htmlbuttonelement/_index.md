...
description: Aspose.Html.HTMLButtonElement 班级. 按钮请参阅 HTML 4.01. 中的 BUTTON 元素定义
type: docs
weight: 3130
...
| 姓名 | 描述 |
| --- | --- |
| [AccessKey](../../aspose.html/htmlbuttonelement/accesskey/) { get; set; } | 用于访问表单控件的单个字符访问键。请参阅 HTML 4.01. 中的 accesskey 属性定义 |
...
| [Disabled](../../aspose.html/htmlbuttonelement/disabled/) { get; set; } | 控件在此上下文中不可用。请参阅 HTML 4.01. 中的禁用属性 定义 |
...
| [Form](../../aspose.html/htmlbuttonelement/form/) { get; } | 返回`形式`包含此控件的元素。返回 `无效的`如果此控件不在 窗体的上下文中。 |
...
| [Name](../../aspose.html/htmlbuttonelement/name/) { get; set; } | 与表单一起提交时的表单控件或对象名称。请参阅 HTML 4.01. 中的名称 属性定义 |
...
| [TabIndex](../../aspose.html/htmlbuttonelement/tabindex/) { get; set; } | 表示元素在 Tab 键顺序中的位置的索引。请参阅 HTML 4.01. 中的 tabindex 属性定义 |
...
| [Value](../../aspose.html/htmlbuttonelement/value/) { get; set; } | 当前表单控件值。请参阅 HTML 4.01. 中的值属性定义 |
