...
description: 返回集合中的索引项如果 index 大于或等于列表中的节点数则返回 null
type: docs
weight: 10
url: /zh/net/aspose.html/ihtmloptionscollection/item/
---
...
方法返回集合中的索引项。如果 index 大于或等于列表中的节点数，则返回 null。 http://www.w3.org/TR/DOM-Level-2-HTML/html.html#HTMLOptionsCollection-namedItem
