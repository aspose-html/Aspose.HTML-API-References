...
description: 脚本语句请参阅 HTML 4.01 中的 SCRIPT 元素定义
type: docs
weight: 3590
url: /zh/net/aspose.html/htmlscriptelement/
---
## HTMLScriptElement class

脚本语句。请参阅 HTML 4.01 中的 SCRIPT 元素定义。
...
| [Charset](../../aspose.html/htmlscriptelement/charset) { get; set; } | 链接资源的字符编码。请参阅 HTML 4.01 中的字符集 属性定义。 |
...
| [Defer](../../aspose.html/htmlscriptelement/defer) { get; set; } | 表示用户代理可以推迟脚本的处理。请参阅 HTML 4.01 中的 defer 属性定义。 |
| [Dir](../../aspose.html/htmlelement/dir) { get; set; } | 指定方向性中性文本的基本方向和表格的 方向性。请参阅 HTML 4.01 中的 dir 属性定义。 |
| [Event](../../aspose.html/htmlscriptelement/event) { get; set; } | 保留供将来使用。 |
...
| [Src](../../aspose.html/htmlscriptelement/src) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] 指定外部脚本。请参阅 HTML 4.01 中的 src 属性定义 。 |
| [Style](../../aspose.html/htmlelement/style) { get; } | 表示允许作者直接将样式信息应用于特定元素的样式属性。 |
| [TagName](../../aspose.html.dom/element/tagname) { get; } | 元素的名称。 |
| [Text](../../aspose.html/htmlscriptelement/text) { get; set; } | 元素的脚本内容。 |
...
| [Type](../../aspose.html/htmlscriptelement/type) { get; set; } | 脚本语言的内容类型。请参阅 HTML 4.01 中的 type 属性 定义。 |
