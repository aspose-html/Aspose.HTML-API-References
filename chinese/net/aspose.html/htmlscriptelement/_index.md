...
description: Aspose.Html.HTMLScriptElement 班级. 脚本语句请参阅 HTML 4.01. 中的 SCRIPT 元素定义
type: docs
weight: 3510
...
| [Defer](../../aspose.html/htmlscriptelement/defer/) { get; set; } | 表示用户代理可以延迟脚本的处理。请参阅 HTML 4.01. 中的 defer 属性定义 |
...
| [Src](../../aspose.html/htmlscriptelement/src/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) 指定一个外部脚本。请参阅 HTML 4.01. 中的 src 属性定义 |
...
| [Type](../../aspose.html/htmlscriptelement/type/) { get; set; } | 脚本语言的内容类型。请参阅 HTML 4.01. 中的类型属性 定义 |
