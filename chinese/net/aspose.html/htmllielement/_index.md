...
description: 列表项请参阅 HTML 4.01 中的 LI 元素定义
type: docs
weight: 3420
url: /zh/net/aspose.html/htmllielement/
---
## HTMLLIElement class
...
| [Type](../../aspose.html/htmllielement/type) { get; set; } | 列表项项目符号样式。请参阅 HTML 4.01 中的 type 属性定义。 此属性在 HTML 4.01 中已弃用。 |
| [Value](../../aspose.html/htmllielement/value) { get; set; } | 在` OL` 中使用时重置序列号。请参阅 HTML 4.01 中的 value 属性定义。此属性在 HTML 4.01 中已弃用。 |
