...
description: Aspose.Html.HTMLLIElement 班级. 列表项请参阅 HTML 4.01. 中的 LI 元素定义
type: docs
weight: 3340
...
| [Type](../../aspose.html/htmllielement/type/) { get; set; } | 列表项项目符号样式。请参阅 HTML 4.01 中的类型属性定义。 此属性在 HTML 4.01 中已弃用。 |
| [Value](../../aspose.html/htmllielement/value/) { get; set; } | 在使用时重置序列号`OL`.请参阅 HTML 4.01 中的值 属性定义。此属性在 HTML 4.01. 中已弃用 |
