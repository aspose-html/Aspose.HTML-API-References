...
description: Aspose.Html.HTMLQuoteElement 班级. 对于问和块引用元素请参阅 HTML 4.01. 中的 Q 元素定义
type: docs
weight: 3500
...
对于`问`和`块引用`元素。请参阅 HTML 4.01. 中的 Q 元素定义
...
| [Cite](../../aspose.html/htmlquoteelement/cite/) { get; set; } | 一个 URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) 指定源文档或消息。请参阅 HTML 4.01. 中的引用属性 定义 |
