...
description: 对于 Q 和 BLOCKQUOTE 个元素请参阅 HTML 4.01 中的 Q 元素定义
type: docs
weight: 3580
url: /zh/net/aspose.html/htmlquoteelement/
---
## HTMLQuoteElement class

对于` Q` 和` BLOCKQUOTE` 个元素。请参阅 HTML 4.01 中的 Q 元素定义。
...
| [Cite](../../aspose.html/htmlquoteelement/cite) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] 指定源文档或消息。请参阅 HTML 4.01 中的 cite 属性 定义。 |
