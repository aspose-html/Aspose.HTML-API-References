...
description: 表格标题 请参阅 HTML 4.01 中的 CAPTION 元素定义
type: docs
weight: 3620
url: /zh/net/aspose.html/htmltablecaptionelement/
---
## HTMLTableCaptionElement class

表格标题 请参阅 HTML 4.01 中的 CAPTION 元素定义。
...
| 姓名 | 描述 |
| --- | --- |
| [Align](../../aspose.html/htmltablecaptionelement/align) { get; set; } | 相对于表格的标题对齐。请参阅 HTML 4.01 中的 align 属性 定义。此属性在 HTML 4.01 中已弃用。 |
