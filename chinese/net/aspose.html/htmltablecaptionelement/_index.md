...
description: Aspose.Html.HTMLTableCaptionElement 班级. 表格标题 请参阅 HTML 4.01. 中的 CAPTION 元素定义
type: docs
weight: 3540
...
| 姓名 | 描述 |
| --- | --- |
| [Align](../../aspose.html/htmltablecaptionelement/align/) { get; set; } | 标题相对于表格对齐。请参阅 HTML 4.01 中的对齐属性 定义。此属性在 HTML 4.01. 中已弃用 |
