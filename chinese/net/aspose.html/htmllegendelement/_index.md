...
description: 为 FIELDSET 分组提供标题请参阅 HTML 4.01 中的 LEGEND 元素定义
type: docs
weight: 3440
url: /zh/net/aspose.html/htmllegendelement/
---
...
| 姓名 | 描述 |
| --- | --- |
| [AccessKey](../../aspose.html/htmllegendelement/accesskey) { get; set; } | 用于访问表单控件的单字符访问键。请参阅 HTML 4.01 中的 accesskey 属性定义。 |
| [Align](../../aspose.html/htmllegendelement/align) { get; set; } | 相对于` FIELDSET` 的文本对齐。请参阅 HTML 4.01 中的 align 属性定义。此属性在 HTML 4.01 中已弃用。 |
...
| [Form](../../aspose.html/htmllegendelement/form) { get; } | 返回包含此控件的` FORM` 元素。如果此控件不在 表单的上下文中，则返回 ` null` 。 |
