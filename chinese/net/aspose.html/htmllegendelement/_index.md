...
description: Aspose.Html.HTMLLegendElement 班级. 提供标题现场集分组请参阅 HTML 4.01. 中的 LEGEND 元素定义
type: docs
weight: 3360
...
提供标题`现场集`分组。请参阅 HTML 4.01. 中的 LEGEND 元素定义
...
| 姓名 | 描述 |
| --- | --- |
| [AccessKey](../../aspose.html/htmllegendelement/accesskey/) { get; set; } | 用于访问表单控件的单个字符访问键。请参阅 HTML 4.01. 中的 accesskey 属性定义 |
| [Align](../../aspose.html/htmllegendelement/align/) { get; set; } | 文本对齐相对于`现场集`.请参阅 HTML 4.01 中的 align 属性定义。此属性在 HTML 4.01. 中已弃用 |
...
| [Form](../../aspose.html/htmllegendelement/form/) { get; } | 返回`形式`包含此控件的元素。返回 `无效的`如果此控件不在 窗体的上下文中。 |
