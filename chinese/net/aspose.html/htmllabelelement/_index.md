...
description: 表单字段标签文本请参阅 HTML 4.01 中的 LABEL 元素定义
type: docs
weight: 3430
url: /zh/net/aspose.html/htmllabelelement/
---
...
| 姓名 | 描述 |
| --- | --- |
| [AccessKey](../../aspose.html/htmllabelelement/accesskey) { get; set; } | 用于访问表单控件的单字符访问键。请参阅 HTML 4.01 中的 accesskey 属性定义。 |
...
| [For](../../aspose.html/htmllabelelement/for) { get; set; } | 此属性通过 ` id` 属性将此标签与另一个表单控件链接.请参阅 HTML 4.01 中的 for 属性定义。 |
| [Form](../../aspose.html/htmllabelelement/form) { get; } | 返回包含此控件的` FORM` 元素。如果此控件不在 表单的上下文中，则返回 ` null` 。 |
