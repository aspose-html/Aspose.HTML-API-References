...
description: Aspose.Html.HTMLLabelElement 班级. 表单字段标签文本请参阅 HTML 4.01. 中的 LABEL 元素定义
type: docs
weight: 3350
...
| 姓名 | 描述 |
| --- | --- |
| [AccessKey](../../aspose.html/htmllabelelement/accesskey/) { get; set; } | 用于访问表单控件的单个字符访问键。请参阅 HTML 4.01. 中的 accesskey 属性定义 |
...
| [For](../../aspose.html/htmllabelelement/for/) { get; set; } | 此属性将此标签与 的另一个表单控件链接起来`ID`属性。请参阅 HTML 4.01. 中的 for 属性定义 |
| [Form](../../aspose.html/htmllabelelement/form/) { get; } | 返回`形式`包含此控件的元素。返回 `无效的`如果此控件不在 窗体的上下文中。 |
