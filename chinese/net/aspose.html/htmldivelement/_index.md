...
description: Aspose.Html.HTMLDivElement 班级. 通用块容器请参阅 HTML 4.01. 中的 DIV 元素定义
type: docs
weight: 3180
...
| 姓名 | 描述 |
| --- | --- |
| [Align](../../aspose.html/htmldivelement/align/) { get; set; } | 文本水平对齐。请参阅 HTML 4.01 中的对齐属性定义。此属性在 HTML 4.01. 中已弃用 |
