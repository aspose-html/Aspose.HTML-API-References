...
description: 通用块容器请参阅 HTML 4.01 中的 DIV 元素定义
type: docs
weight: 3260
url: /zh/net/aspose.html/htmldivelement/
---
...
| 姓名 | 描述 |
| --- | --- |
| [Align](../../aspose.html/htmldivelement/align) { get; set; } | 水平文本对齐。请参阅 HTML 4.01 中的 align 属性定义。此属性在 HTML 4.01 中已弃用。 |
