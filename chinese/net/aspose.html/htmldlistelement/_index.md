...
description: 定义列表请参阅 HTML 4.01 中的 DL 元素定义
type: docs
weight: 3230
url: /zh/net/aspose.html/htmldlistelement/
---
...
| [Compact](../../aspose.html/htmldlistelement/compact) { get; set; } | 减少列表项之间的间距。请参阅 HTML 4.01 中的紧凑属性定义 。此属性在 HTML 4.01 中已弃用。 |
