...
description: Aspose.Html.HTMLFrameSetElement 班级. 创建框架网格请参阅 HTML 4.01. 中的 FRAMESET 元素定义
type: docs
weight: 3250
...
创建框架网格。请参阅 HTML 4.01. 中的 FRAMESET 元素定义
...
| [Rows](../../aspose.html/htmlframesetelement/rows/) { get; set; } | 框架集中框架的行数。请参阅 HTML 4.01. 中的行属性 定义 |
