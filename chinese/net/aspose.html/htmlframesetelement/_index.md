...
description: 创建一个框架网格请参阅 HTML 4.01 中的 FRAMESET 元素定义
type: docs
weight: 3330
url: /zh/net/aspose.html/htmlframesetelement/
---
...
| [Cols](../../aspose.html/htmlframesetelement/cols) { get; set; } | 框架集中框架的列数。请参阅 HTML 4.01 中的 cols 属性 定义。 |
...
| [Rows](../../aspose.html/htmlframesetelement/rows) { get; set; } | 框架集中的框架行数。请参阅 HTML 4.01 中的 rows 属性 定义。 |
