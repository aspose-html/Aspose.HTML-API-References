...
description: Aspose.Html.HTMLUListElement 班级. 无序列表请参阅 HTML 4.01. 中的 UL 元素定义
type: docs
weight: 3630
...
| [Type](../../aspose.html/htmlulistelement/type/) { get; set; } | 项目符号样式。请参阅 HTML 4.01 中的类型属性定义。此 属性在 HTML 4.01. 中已弃用 |
