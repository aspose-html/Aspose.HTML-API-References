...
description: 无序列表请参阅 HTML 4.01 中的 UL 元素定义
type: docs
weight: 3710
url: /zh/net/aspose.html/htmlulistelement/
---
...
| [Compact](../../aspose.html/htmlulistelement/compact) { get; set; } | 减少列表项之间的间距。请参阅 HTML 4.01 中的紧凑属性定义 。此属性在 HTML 4.01 中已弃用。 |
...
| [Type](../../aspose.html/htmlulistelement/type) { get; set; } | 子弹样式。请参阅 HTML 4.01 中的 type 属性定义。此 属性在 HTML 4.01 中已弃用。 |
