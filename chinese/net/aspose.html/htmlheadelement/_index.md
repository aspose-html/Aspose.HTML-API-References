...
description: 文件头信息请参阅 HTML 4.01 中的 HEAD 元素定义
type: docs
weight: 3350
url: /zh/net/aspose.html/htmlheadelement/
---
## HTMLHeadElement class

文件头信息。请参阅 HTML 4.01 中的 HEAD 元素定义。
...
| [Profile](../../aspose.html/htmlheadelement/profile) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] 指定元数据配置文件。请参阅 HTML 4.01 中的配置文件属性 定义。 |
