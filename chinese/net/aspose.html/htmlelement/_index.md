...
description: 所有 HTML 元素接口都派生自这个类仅 暴露 HTML 核心属性的元素由基本的  HTMLElement 接口表示这些元素如下 specialSUB SUP SPAN BDOfontTT I B U S STRIKE BIG SMALL 短语EM STRONG  DFN CODE SAMP KBD VAR CITE ACRONYM ABBRlist DD DTNOFRAMES NOSCRIPTADDRESS CENTER 风格 属性HTML 元素的47可通过  ElementCSSInlineStyle 接口访问该接口在 CSS47 中定义模块 DOM 2 级样式表和 CSShttp//www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113 
type: docs
weight: 3280
url: /zh/net/aspose.html/htmlelement/
---
## HTMLElement class

所有 HTML 元素接口都派生自这个类。仅 暴露 HTML 核心属性的元素由基本的 ` HTMLElement` 接口表示。这些元素如下: special:SUB, SUP, SPAN, BDOfont:TT, I, B, U, S, STRIKE, BIG, SMALL 短语:EM, STRONG , DFN, CODE, SAMP, KBD, VAR, CITE, ACRONYM, ABBRlist: DD, DTNOFRAMES, NOSCRIPTADDRESS, CENTER` 风格` 属性:HTML 元素的::47:::可通过 ` ElementCSSInlineStyle` 接口访问，该接口在 CSS:::47 中定义:::模块 [[DOM 2 级样式表和 CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113) ]。
