...
description: 提供给 OBJECT 元素的参数请参阅 HTML 4.01 中的 PARAM 元素 定义
type: docs
weight: 3560
url: /zh/net/aspose.html/htmlparamelement/
---
## HTMLParamElement class

提供给` OBJECT` 元素的参数。请参阅 HTML 4.01 中的 PARAM 元素 定义。
...
| [Name](../../aspose.html/htmlparamelement/name) { get; set; } | 运行时参数的名称。请参阅 HTML 4.01 中的 name 属性定义。 |
...
| [Type](../../aspose.html/htmlparamelement/type) { get; set; } | ` 值` 属性的内容类型 ` valuetype` 的值为“ref”。请参阅 HTML 4.01 中的 type 属性 定义。 |
| [Value](../../aspose.html/htmlparamelement/value) { get; set; } | 运行时参数的值。请参阅 HTML 4.01 中的值属性定义 。 |
| [ValueType](../../aspose.html/htmlparamelement/valuetype) { get; set; } | 有关` 值` 属性 值含义的信息。请参阅 HTML 4.01 中的 valuetype 属性定义。 |
