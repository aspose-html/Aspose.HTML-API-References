...
description: Aspose.Html.HTMLParamElement 班级. 参数馈送到目的元素请参阅 HTML 4.01. 中的 PARAM 元素 定义
type: docs
weight: 3480
...
参数馈送到`目的`元素。请参阅 HTML 4.01. 中的 PARAM 元素 定义
...
| [Name](../../aspose.html/htmlparamelement/name/) { get; set; } | 运行时参数的名称。请参阅 HTML 4.01. 中的名称属性定义 |
...
| [Type](../../aspose.html/htmlparamelement/type/) { get; set; } | 的内容类型`价值` 时的属性`值类型`具有值“ref”。请参阅 HTML 4.01. 中的类型属性 定义 |
| [Value](../../aspose.html/htmlparamelement/value/) { get; set; } | 运行时参数的值。请参阅 HTML 4.01. 中的值属性定义 |
| [ValueType](../../aspose.html/htmlparamelement/valuetype/) { get; set; } | 的含义信息`价值`属性 值。请参阅 HTML 4.01. 中的 valuetype 属性定义 |
