...
description: Aspose.Html.HTMLTableCellElement 班级. 用于表示的对象TH和TD 个元素请参阅 HTML 4.01. 中的 TD 元素定义
type: docs
weight: 3550
...
用于表示的对象`TH`和`TD` 个元素。请参阅 HTML 4.01. 中的 TD 元素定义
...
| 姓名 | 描述 |
| --- | --- |
| [Abbr](../../aspose.html/htmltablecellelement/abbr/) { get; set; } | 标题单元格的缩写。请参阅 HTML 4.01. 中的缩写属性定义 |
| [Align](../../aspose.html/htmltablecellelement/align/) { get; set; } | 单元格中数据的水平对齐方式。请参阅 HTML 4.01. 中的对齐属性定义 |
| override [Attributes](../../aspose.html.dom/element/attributes/) { get; } | 包含此节点属性的 NamedNodeMap（如果它是一个元素）或 null 否则。 |
| [Axis](../../aspose.html/htmltablecellelement/axis/) { get; set; } | 命名相关标头组。请参阅 HTML 4.01. 中的轴属性定义 |
| virtual [BaseURI](../../aspose.html.dom/node/baseuri/) { get; } | 此节点的绝对基础 URI，如果实现无法获得绝对 URI，则为 null。 |
| [BgColor](../../aspose.html/htmltablecellelement/bgcolor/) { get; set; } | 单元格背景色。请参阅 HTML 4.01 中的 bgcolor 属性定义。此属性在 HTML 4.01. 中已弃用 |
| [CellIndex](../../aspose.html/htmltablecellelement/cellindex/) { get; } | 该单元格在行中的索引，从0开始。该索引按 文档树顺序而不是显示顺序。 |
...
| [Headers](../../aspose.html/htmltablecellelement/headers/) { get; set; } | 列表`ID`标题单元格的属性值。请参阅 HTML 4.01. 中的 headers 属性定义 |
| [Height](../../aspose.html/htmltablecellelement/height/) { get; set; } | 单元格高度。请参阅 HTML 4.01 中的高度属性定义。此 属性在 HTML 4.01. 中已弃用 |
...
| [Scope](../../aspose.html/htmltablecellelement/scope/) { get; set; } | 标题单元格涵盖的范围。请参阅 HTML 4.01. 中的范围属性定义 |
...
| [Width](../../aspose.html/htmltablecellelement/width/) { get; set; } | 单元宽度。请参阅 HTML 4.01 中的 width 属性定义。此 属性在 HTML 4.01. 中已弃用 |
