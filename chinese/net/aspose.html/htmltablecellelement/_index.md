...
description: 用于表示的对象 TH 和 TD 元素 请参阅 HTML 4.01 中的 TD 元素定义
type: docs
weight: 3630
url: /zh/net/aspose.html/htmltablecellelement/
---
## HTMLTableCellElement class

用于表示`的对象 TH` 和` TD` 元素。 请参阅 HTML 4.01 中的 TD 元素定义。
...
| 姓名 | 描述 |
| --- | --- |
| [Abbr](../../aspose.html/htmltablecellelement/abbr) { get; set; } | 标题单元格的缩写。请参阅 HTML 4.01 中的 abbr 属性定义。 |
| [Align](../../aspose.html/htmltablecellelement/align) { get; set; } | 单元格中数据的水平对齐方式。请参阅 HTML 4.01 中的 align 属性定义 。 |
| override [Attributes](../../aspose.html.dom/element/attributes) { get; } | NamedNodeMap 包含此节点的属性（如果它是一个元素），否则为 null。 |
| [Axis](../../aspose.html/htmltablecellelement/axis) { get; set; } | 相关标头的名称组。请参阅 HTML 4.01 中的轴属性定义。 |
| virtual [BaseURI](../../aspose.html.dom/node/baseuri) { get; } | 此节点的绝对基本 URI 或 null 如果实现无法获得绝对 URI。 |
| [BgColor](../../aspose.html/htmltablecellelement/bgcolor) { get; set; } | 单元格背景颜色。请参阅 HTML 4.01 中的 bgcolor 属性定义。此属性在 HTML 4.01 中已弃用。 |
| [CellIndex](../../aspose.html/htmltablecellelement/cellindex) { get; } | 此单元格在行中的索引，从 0 开始。此索引处于 文档树顺序，而不是显示顺序。 |
| [Ch](../../aspose.html/htmltablecellelement/ch) { get; set; } | 列中单元格的对齐字符。请参阅 HTML 4.01 中的 char 属性 定义。 |
...
| [ChOff](../../aspose.html/htmltablecellelement/choff) { get; set; } | 对齐字符的偏移量。请参阅 HTML 4.01 中的 charoff 属性定义。 |
...
| [ColSpan](../../aspose.html/htmltablecellelement/colspan) { get; set; } | 单元格跨越的列数。请参阅 HTML 4.01 中的 colspan 属性定义 。 |
...
| [Headers](../../aspose.html/htmltablecellelement/headers) { get; set; } | ` id` 标题单元格属性值的列表。请参阅 HTML 4.01 中的 headers 属性定义。 |
| [Height](../../aspose.html/htmltablecellelement/height) { get; set; } | 单元格高度。请参阅 HTML 4.01 中的 height 属性定义。此 属性在 HTML 4.01 中已弃用。 |
...
| [NoWrap](../../aspose.html/htmltablecellelement/nowrap) { get; set; } | 禁止自动换行。请参阅 HTML 4.01 中的 nowrap 属性定义。此属性在 HTML 4.01 中已弃用。 |
...
| [RowSpan](../../aspose.html/htmltablecellelement/rowspan) { get; set; } | 单元格跨越的行数。请参阅 HTML 4.01 中的 rowspan 属性定义。 |
| [SchemaTypeInfo](../../aspose.html.dom/element/schematypeinfo) { get; } | 与此元素关联的类型信息。 |
| [Scope](../../aspose.html/htmltablecellelement/scope) { get; set; } | 标题单元格覆盖的范围。请参阅 HTML 4.01 中的范围属性定义。 |
...
| [VAlign](../../aspose.html/htmltablecellelement/valign) { get; set; } | 单元格中数据的垂直对齐方式。请参阅 HTML 4.01 中的 valign 属性定义 。 |
| [Width](../../aspose.html/htmltablecellelement/width) { get; set; } | 单元格宽度。请参阅 HTML 4.01 中的宽度属性定义。此 属性在 HTML 4.01 中已弃用。 |
