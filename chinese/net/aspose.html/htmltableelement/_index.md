...
description: 表上的 create 和 delete 方法允许作者构造和 修改表 HTML 4.01http//www.w3.org/TR/1999/REC-html401-19991224  指定每个  CAPTION  THEAD 和 TFOOT 元素 可能存在于表中因此如果存在一个并且调用了 createTHead 或 createTFoot 方法则该方法返回现有的 THead 或 TFoot 元素请参阅 HTML 4.01 中的 TABLE 元素定义
type: docs
weight: 3650
url: /zh/net/aspose.html/htmltableelement/
---
## HTMLTableElement class

表上的 create* 和 delete* 方法允许作者构造和 修改表。 [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224) ] 指定每个 ` CAPTION` ,` THEAD` 和` TFOOT` 元素 可能存在于表中。因此，如果存在一个，并且调用了 createTHead() 或 createTFoot() 方法，则该方法返回现有的 THead 或 TFoot 元素。请参阅 HTML 4.01 中的 TABLE 元素定义。
...
| 姓名 | 描述 |
| --- | --- |
| [Align](../../aspose.html/htmltableelement/align) { get; set; } | 指定表格相对于 文档其余部分的位置。请参阅 HTML 4.01 中的 align 属性定义。此 属性在 HTML 4.01 中已弃用。 |
...
| [BgColor](../../aspose.html/htmltableelement/bgcolor) { get; set; } | 单元格背景颜色。请参阅 HTML 4.01 中的 bgcolor 属性定义。此属性在 HTML 4.01 中已弃用。 |
| [Border](../../aspose.html/htmltableelement/border) { get; set; } | 表格边框的宽度。请参阅 HTML 4.01 中的边框属性 定义。 |
| [Caption](../../aspose.html/htmltableelement/caption) { get; } | 返回表的` CAPTION` ，如果不存在则为 void。 @version DOM 级别 2 |
| [CellPadding](../../aspose.html/htmltableelement/cellpadding) { get; set; } | 指定单元格内容和 单元格边框之间的水平和垂直间距。请参阅 HTML 4.01 中的 cellpadding 属性定义。 |
| [CellSpacing](../../aspose.html/htmltableelement/cellspacing) { get; set; } | 指定单元格之间的水平和垂直分隔。请参阅 HTML 4.01 中的 cellspacing 属性定义。 |
...
| [Frame](../../aspose.html/htmltableelement/frame) { get; set; } | 指定要渲染的外部表格边框。请参阅 HTML 4.01 中的 frame 属性定义。 |
...
| [Rows](../../aspose.html/htmltableelement/rows) { get; } | 返回表的` TFOOT` 或` null` 如果没有 存在。 |
| [Rules](../../aspose.html/htmltableelement/rules) { get; set; } | 指定要渲染的内部表格边框。请参阅 HTML 4.01 中的规则 属性定义。 |
...
| [Summary](../../aspose.html/htmltableelement/summary) { get; set; } | 关于表的用途或结构的描述。请参阅 HTML 4.01 中的摘要 属性定义。 |
| [TagName](../../aspose.html.dom/element/tagname) { get; } | 元素的名称。 |
| [TBodies](../../aspose.html/htmltableelement/tbodies) { get; } | 返回表体的集合（包括隐式的）。 |
...
| [TFoot](../../aspose.html/htmltableelement/tfoot) { get; } | 返回表的` THEAD` 或` null` 如果没有 存在。 |
| [THead](../../aspose.html/htmltableelement/thead) { get; } | 返回表的` CAPTION` ，如果不存在则为 void。 |
| [Title](../../aspose.html/htmlelement/title) { get; set; } | 元素的建议标题。请参阅 HTML 4.01 中的 title 属性定义。 |
| [Width](../../aspose.html/htmltableelement/width) { get; set; } | 指定所需的表格宽度。请参阅 HTML 4.01 中的宽度属性定义 。 |
...
| [CreateCaption](../../aspose.html/htmltableelement/createcaption)() | 创建一个新的表格标题对象或返回一个现有的。 |
| [CreateTFoot](../../aspose.html/htmltableelement/createtfoot)() | 创建表尾行或返回现有行。 |
| [CreateTHead](../../aspose.html/htmltableelement/createthead)() | 创建表标题行或返回现有行。 |
| [DeleteCaption](../../aspose.html/htmltableelement/deletecaption)() | 删除表格标题（如果存在）。 |
| [DeleteRow](../../aspose.html/htmltableelement/deleterow)(int) | 删除表格行。 |
| [DeleteTFoot](../../aspose.html/htmltableelement/deletetfoot)() | 从表中删除页脚（如果存在）。 |
| [DeleteTHead](../../aspose.html/htmltableelement/deletethead)() | 从表中删除表头（如果存在）。 |
...
| [InsertRow](../../aspose.html/htmltableelement/insertrow)(int) | 在表中插入一个新的空行。新行插入到 之前并与当前 ` index` 中的第桌子。如果` index` 为 -1 或 等于行数，则追加新行。此外， 当表为空时，该行被插入到` TBODY` 中，它被创建并插入根据 [[HTML 4.01 ，表格行不能为 空](http://www.w3.org/TR/1999/REC-html401-19991224) ]。 |
