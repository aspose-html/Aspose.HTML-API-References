...
description: Aspose.Html.HTMLTableElement 班级. 表上的 create 和 delete 方法允许作者构建和 修改表 HTML 4.01  指定每个 中只有一个标题头 和脚表中可能存在元素 因此如果存在则调用 createTHead 或 createTFoot 方法时该方法将返回现有的 THead 或 TFoot 元素请参阅 HTML 4.01. 中的 TABLE 元素定义
type: docs
weight: 3570
...
表上的 create* 和 delete* 方法允许作者构建和 修改表。 [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224) ] 指定每个 中只有一个`标题`,`头`， 和`脚`表中可能存在元素 。因此，如果存在，则调用 createTHead() 或 createTFoot() 方法时，该方法将返回现有的 THead 或 TFoot 元素。请参阅 HTML 4.01. 中的 TABLE 元素定义
...
| 姓名 | 描述 |
| --- | --- |
| [Align](../../aspose.html/htmltableelement/align/) { get; set; } | 指定表格相对于 文档其余部分的位置。请参阅 HTML 4.01 中的对齐属性定义。此 属性在 HTML 4.01. 中已弃用 |
...
| [BgColor](../../aspose.html/htmltableelement/bgcolor/) { get; set; } | 单元格背景色。请参阅 HTML 4.01 中的 bgcolor 属性定义。此属性在 HTML 4.01. 中已弃用 |
| [Border](../../aspose.html/htmltableelement/border/) { get; set; } | 表格周围边框的宽度。请参阅 HTML 4.01. 中的边框属性 定义 |
| [Caption](../../aspose.html/htmltableelement/caption/) { get; } | 返回表的`标题`，如果不存在则为 void。 @version DOM 级别 2 |
| [CellPadding](../../aspose.html/htmltableelement/cellpadding/) { get; set; } | 指定单元格内容和 单元格边框之间的水平和垂直空间。请参阅 HTML 4.01. 中的 cellpadding 属性定义 |
...
| [Frame](../../aspose.html/htmltableelement/frame/) { get; set; } | 指定要呈现的外部表边框。请参阅 HTML 4.01. 中的 frame 属性定义 |
...
| [Rows](../../aspose.html/htmltableelement/rows/) { get; } | 返回表的`脚`， 或者`无效的`如果不存在 。 |
| [Rules](../../aspose.html/htmltableelement/rules/) { get; set; } | 指定要呈现的内部表格边框。请参阅 HTML 4.01. 中的规则 属性定义 |
...
| [Summary](../../aspose.html/htmltableelement/summary/) { get; set; } | 有关表的用途或结构的说明。请参阅 HTML 4.01. 中的摘要 属性定义 |
...
| [TFoot](../../aspose.html/htmltableelement/tfoot/) { get; } | 返回表的`头`， 或者`无效的`如果不存在 。 |
| [THead](../../aspose.html/htmltableelement/thead/) { get; } | 返回表的`标题` ，如果不存在则为 void。 |
| [Title](../../aspose.html/htmlelement/title/) { get; set; } | 元素的咨询标题。请参阅 HTML 4.01. 中的 title 属性定义 |
| [Width](../../aspose.html/htmltableelement/width/) { get; set; } | 指定所需的表格宽度。参见 HTML 4.01. 中的宽度属性定义 |
...
| [CreateTFoot](../../aspose.html/htmltableelement/createtfoot/)() | 创建表脚行或返回现有行。 |
| [CreateTHead](../../aspose.html/htmltableelement/createthead/)() | 创建表标题行或返回现有行。 |
| [DeleteCaption](../../aspose.html/htmltableelement/deletecaption/)() | 删除表标题，如果存在的话。 |
| [DeleteRow](../../aspose.html/htmltableelement/deleterow/)(int) | 删除表格行。 |
| [DeleteTFoot](../../aspose.html/htmltableelement/deletetfoot/)() | 从表中删除页脚，如果存在的话。 |
| [DeleteTHead](../../aspose.html/htmltableelement/deletethead/)() | 从表中删除表头，如果存在的话。 |
...
| [InsertRow](../../aspose.html/htmltableelement/insertrow/)(int) | 在表中插入一个新的空行。新行被插入 紧接在当前 之前并与当前 在同一部分`指数`表中的第行。如果`指数`是 -1 或 等于行数，则追加新行。此外， 当表为空时，该行被插入到`身体` 创建并插入到表中。根据 [，表行不能为 空[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224)]. |
