...
description: Aspose.Html.HTMLMapElement 班级. 客户端图像映射请参阅 HTML 4.01. 中的 MAP 元素定义
type: docs
weight: 3380
...
| [Name](../../aspose.html/htmlmapelement/name/) { get; set; } | 命名地图（用于`使用地图`).请参阅 HTML 4.01. 中的名称 属性定义 |
