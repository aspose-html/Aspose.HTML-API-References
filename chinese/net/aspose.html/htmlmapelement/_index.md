...
description: 客户端图像映射请参阅 HTML 4.01 中的 MAP 元素定义
type: docs
weight: 3460
url: /zh/net/aspose.html/htmlmapelement/
---
## HTMLMapElement class

客户端图像映射。请参阅 HTML 4.01 中的 MAP 元素定义。
...
| 姓名 | 描述 |
| --- | --- |
| [Areas](../../aspose.html/htmlmapelement/areas) { get; } | 为图像映射定义的区域列表。 |
...
| [Name](../../aspose.html/htmlmapelement/name) { get; set; } | 命名地图（与` usemap` 一起使用）。请参阅 HTML 4.01 中的 name 属性定义。 |
