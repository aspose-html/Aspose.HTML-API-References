...
description: Aspose.Html.HTMLParagraphElement 班级. 段落请参阅 HTML 4.01. 中的 P 元素定义
type: docs
weight: 3470
...
| 姓名 | 描述 |
| --- | --- |
| [Align](../../aspose.html/htmlparagraphelement/align/) { get; set; } | 文本水平对齐。请参阅 HTML 4.01 中的对齐属性定义。此属性在 HTML 4.01. 中已弃用 |
