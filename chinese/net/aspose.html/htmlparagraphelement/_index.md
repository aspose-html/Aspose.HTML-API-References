...
description: 段落请参阅 HTML 4.01 中的 P 元素定义
type: docs
weight: 3550
url: /zh/net/aspose.html/htmlparagraphelement/
---
## HTMLParagraphElement class

段落。请参阅 HTML 4.01 中的 P 元素定义。
...
| 姓名 | 描述 |
| --- | --- |
| [Align](../../aspose.html/htmlparagraphelement/align) { get; set; } | 水平文本对齐。请参阅 HTML 4.01 中的 align 属性定义。此属性在 HTML 4.01 中已弃用。 |
