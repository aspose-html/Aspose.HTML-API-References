...
description: 预格式化文本请参阅 HTML 4.01 中的 PRE 元素定义
type: docs
weight: 3570
url: /zh/net/aspose.html/htmlpreelement/
---
## HTMLPreElement class

预格式化文本。请参阅 HTML 4.01 中的 PRE 元素定义。
...
| [Width](../../aspose.html/htmlpreelement/width) { get; set; } | 内容的固定宽度。请参阅 HTML 4.01 中的宽度属性定义。此属性在 HTML 4.01 中已弃用。 |
