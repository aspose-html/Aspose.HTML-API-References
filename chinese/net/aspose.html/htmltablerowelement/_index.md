...
description: 表中的一行请参阅 HTML 4.01 中的 TR 元素定义
type: docs
weight: 3660
url: /zh/net/aspose.html/htmltablerowelement/
---
## HTMLTableRowElement class

表中的一行。请参阅 HTML 4.01 中的 TR 元素定义。
...
| 姓名 | 描述 |
| --- | --- |
| [Align](../../aspose.html/htmltablerowelement/align) { get; set; } | 此行单元格内数据的水平对齐方式。请参阅 HTML 4.01 中的 align 属性定义。 |
...
| [BgColor](../../aspose.html/htmltablerowelement/bgcolor) { get; set; } | 行的背景颜色。请参阅 HTML 4.01 中的 bgcolor 属性定义。此属性在 HTML 4.01 中已弃用。 |
| [Cells](../../aspose.html/htmltablerowelement/cells) { get; } | 此行中的单元格集合。 @version DOM 级别 2 |
| [Ch](../../aspose.html/htmltablerowelement/ch) { get; set; } | 列中单元格的对齐字符。请参阅 HTML 4.01 中的 char 属性 定义。 |
...
| [ChOff](../../aspose.html/htmltablerowelement/choff) { get; set; } | 对齐字符的偏移量。请参阅 HTML 4.01 中的 charoff 属性定义。 |
...
| [RowIndex](../../aspose.html/htmltablerowelement/rowindex) { get; } | 这是逻辑顺序而不是文档顺序。 ` rowIndex` 确实考虑了部分（ ` THEAD` ,` TFOOT` , 或` TBODY` ) 在 表，将` THEAD` 行放在索引的第一个位置， 后跟` TBODY` 行，然后是` TFOOT` 行。 @version DOM 级别 2 |
| [SchemaTypeInfo](../../aspose.html.dom/element/schematypeinfo) { get; } | 与此元素关联的类型信息。 |
| [SectionRowIndex](../../aspose.html/htmltablerowelement/sectionrowindex) { get; } | 该行的索引，相对于当前部分（ ` THEAD` ,` TFOOT` , 或` TBODY` ), 从 0 开始. @version DOM 级别 2 |
...
| [VAlign](../../aspose.html/htmltablerowelement/valign) { get; set; } | 该行单元格内数据的垂直对齐方式。请参阅 HTML 4.01 中的 valign 属性定义。 |
...
| [DeleteCell](../../aspose.html/htmltablerowelement/deletecell)(int) | 从当前行删除一个单元格。 |
...
| [InsertCell](../../aspose.html/htmltablerowelement/insertcell)(int) | 插入一个空` TD` 单元格到这一行。 如果 ` 索引` 是 -1 或等于单元格的数量，新的 单元格被附加。 |
