...
description: Aspose.Html.HTMLTableRowElement 班级. 表中的一行请参阅 HTML 4.01. 中的 TR 元素定义
type: docs
weight: 3580
...
| 姓名 | 描述 |
| --- | --- |
| [Align](../../aspose.html/htmltablerowelement/align/) { get; set; } | 该行单元格内数据的水平对齐方式。请参阅 HTML 4.01. 中的 align 属性定义 |
...
| [RowIndex](../../aspose.html/htmltablerowelement/rowindex/) { get; } | 这是逻辑顺序而不是文档顺序。 `行索引`确实考虑了部分（ `头`,`脚`， 或者`身体` ) 在 表中，放置`头`索引中的第一行， 后跟`身体`行，其次是`脚` 行。 @version DOM 级别 2 |
| [SchemaTypeInfo](../../aspose.html.dom/element/schematypeinfo/) { get; } | 与此元素关联的类型信息。 |
| [SectionRowIndex](../../aspose.html/htmltablerowelement/sectionrowindex/) { get; } | 此行的索引，相对于当前部分 ( `头`,`脚`， 或者`身体` ), 从 0. 开始 @version DOM Level 2 |
...
| [DeleteCell](../../aspose.html/htmltablerowelement/deletecell/)(int) | 从当前行中删除一个单元格。 |
...
| [InsertCell](../../aspose.html/htmltablerowelement/insertcell/)(int) | 插入一个空的`TD`单元格到这一行。如果 `指数`为 -1 或等于单元格数，则附加新的 单元格。 |
