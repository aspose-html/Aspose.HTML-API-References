...
description: Aspose.Html.HTMLMetaElement 班级. 这包含有关文档的通用元信息请参阅 HTML 4.01. 中的 META 元素定义
type: docs
weight: 3400
...
| [Name](../../aspose.html/htmlmetaelement/name/) { get; set; } | 元信息名称。见 HTML 4.01. 中的 name 属性定义 |
...
| [Scheme](../../aspose.html/htmlmetaelement/scheme/) { get; set; } | 选择内容形式。请参阅 HTML 中的方案属性定义 4.01. |
