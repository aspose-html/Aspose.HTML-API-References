...
description: 这包含有关文档的通用元信息请参阅 HTML 4.01 中的 META 元素定义
type: docs
weight: 3480
url: /zh/net/aspose.html/htmlmetaelement/
---
## HTMLMetaElement class

这包含有关文档的通用元信息。请参阅 HTML 4.01 中的 META 元素定义。
...
| [Content](../../aspose.html/htmlmetaelement/content) { get; set; } | 相关信息。请参阅 HTML 4.01 中的内容属性定义。 |
...
| [HttpEquiv](../../aspose.html/htmlmetaelement/httpequiv) { get; set; } | HTTP 响应头名称 [[IETF RFC 2616](http://www.ietf.org/rfc/rfc2616.txt) ]。请参阅 HTML 4.01 中的 http-equiv 属性定义。 |
...
| [Name](../../aspose.html/htmlmetaelement/name) { get; set; } | 元信息名称。请参阅 HTML 4.01 中的 name 属性定义。 |
...
| [Scheme](../../aspose.html/htmlmetaelement/scheme) { get; set; } | 选择内容形式。请参阅 HTML 4.01 中的方案属性定义。 |
