...
description: 目录列表请参阅 HTML 4.01 中的 DIR 元素定义此元素 在 HTML 4.01 中已弃用
type: docs
weight: 3250
url: /zh/net/aspose.html/htmldirectoryelement/
---
## HTMLDirectoryElement class

目录列表。请参阅 HTML 4.01 中的 DIR 元素定义。此元素 在 HTML 4.01 中已弃用。
...
| [Compact](../../aspose.html/htmldirectoryelement/compact) { get; set; } | 减少列表项之间的间距。请参阅 HTML 4.01 中的紧凑属性定义 。此属性在 HTML 4.01 中已弃用。 |
