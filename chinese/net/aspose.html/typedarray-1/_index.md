...
description: Aspose.Html.TypedArray1T 班级. TypedArray 对象呈现底层二进制数据缓冲区的类数组视图
type: docs
weight: 5790
url: /zh/net/aspose.html/typedarray-1/
---
## TypedArray&lt;T&gt; class

TypedArray 对象呈现底层二进制数据缓冲区的类数组视图。
...
| abstract [Item](../../aspose.html/typedarray-1/item/) { get; set; } | 获取或设置!:T在指定的索引处. |
