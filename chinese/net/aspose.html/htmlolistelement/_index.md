...
description: Aspose.Html.HTMLOListElement 班级. 有序列表请参阅 HTML 4.01. 中的 OL 元素定义
type: docs
weight: 3430
...
| [Start](../../aspose.html/htmlolistelement/start/) { get; set; } | 起始序号。请参阅 HTML 4.01 中的开始属性定义。此属性在 HTML 4.01. 中已弃用 |
...
| [Type](../../aspose.html/htmlolistelement/type/) { get; set; } | 编号样式。请参阅 HTML 4.01 中的类型属性定义。此 属性在 HTML 4.01. 中已弃用 |
