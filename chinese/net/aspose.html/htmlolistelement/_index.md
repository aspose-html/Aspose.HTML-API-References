...
description: 有序列表请参阅 HTML 4.01 中的 OL 元素定义
type: docs
weight: 3510
url: /zh/net/aspose.html/htmlolistelement/
---
## HTMLOListElement class

有序列表。请参阅 HTML 4.01 中的 OL 元素定义。
...
| [Compact](../../aspose.html/htmlolistelement/compact) { get; set; } | 减少列表项之间的间距。请参阅 HTML 4.01 中的紧凑属性定义 。此属性在 HTML 4.01 中已弃用。 |
...
| [Start](../../aspose.html/htmlolistelement/start) { get; set; } | 起始序列号。请参阅 HTML 4.01 中的 start 属性定义。此属性在 HTML 4.01 中已弃用。 |
...
| [Type](../../aspose.html/htmlolistelement/type) { get; set; } | 编号样式。请参阅 HTML 4.01 中的 type 属性定义。此 属性在 HTML 4.01 中已弃用。 |
