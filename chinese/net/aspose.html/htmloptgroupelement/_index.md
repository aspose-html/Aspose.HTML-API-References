...
description: Aspose.Html.HTMLOptGroupElement 班级. 在逻辑细分中将选项组合在一起请参阅 HTML 4.01. 中的 OPTGROUP 元素 定义
type: docs
weight: 3450
...
| [Disabled](../../aspose.html/htmloptgroupelement/disabled/) { get; set; } | 控件在此上下文中不可用。请参阅 HTML 4.01. 中的禁用属性 定义 |
...
| [Label](../../aspose.html/htmloptgroupelement/label/) { get; set; } | 为这个选项组分配一个标签。参见 HTML 4.01. 中的标签属性定义 |
