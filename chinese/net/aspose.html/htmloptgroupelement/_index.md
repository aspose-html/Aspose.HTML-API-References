...
description: 在逻辑细分中将选项组合在一起请参阅 HTML 4.01 中的 OPTGROUP 元素 定义
type: docs
weight: 3530
url: /zh/net/aspose.html/htmloptgroupelement/
---
## HTMLOptGroupElement class

在逻辑细分中将选项组合在一起。请参阅 HTML 4.01 中的 OPTGROUP 元素 定义。
...
| [Disabled](../../aspose.html/htmloptgroupelement/disabled) { get; set; } | 控件在此上下文中不可用。请参阅 HTML 4.01 中的 disabled 属性 定义。 |
...
| [Label](../../aspose.html/htmloptgroupelement/label) { get; set; } | 为该选项组分配一个标签。请参阅 HTML 4.01 中的标签属性定义 。 |
