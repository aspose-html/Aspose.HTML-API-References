...
description: Aspose.Html.HTMLHRElement 班级. 创建水平线请参阅 HTML 4.01. 中的 HR 元素定义
type: docs
weight: 3260
...
| 姓名 | 描述 |
| --- | --- |
| [Align](../../aspose.html/htmlhrelement/align/) { get; set; } | 在页面上对齐规则。请参阅 HTML 4.01 中的对齐属性定义。此属性在 HTML 4.01. 中已弃用 |
...
| [NoShade](../../aspose.html/htmlhrelement/noshade/) { get; set; } | 向用户代理指示该元素的 渲染中不应有阴影。请参阅 HTML 4.01 中的 noshade 属性定义。此属性在 HTML 4.01. 中已弃用 |
...
| [Size](../../aspose.html/htmlhrelement/size/) { get; set; } | 规则的高度。请参阅 HTML 4.01 中的大小属性定义。 此属性在 HTML 4.01 中已弃用。 |
...
| [Width](../../aspose.html/htmlhrelement/width/) { get; set; } | 规则的宽度。请参阅 HTML 4.01 中的 width 属性定义。 此属性在 HTML 4.01 中已弃用。 |
