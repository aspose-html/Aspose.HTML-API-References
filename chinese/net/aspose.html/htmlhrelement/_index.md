...
description: 创建水平线请参阅 HTML 4.01 中的 HR 元素定义
type: docs
weight: 3340
url: /zh/net/aspose.html/htmlhrelement/
---
## HTMLHRElement class
...
| 姓名 | 描述 |
| --- | --- |
| [Align](../../aspose.html/htmlhrelement/align) { get; set; } | 对齐页面上的规则。请参阅 HTML 4.01 中的 align 属性定义。此属性在 HTML 4.01 中已弃用。 |
...
| [NoShade](../../aspose.html/htmlhrelement/noshade) { get; set; } | 向用户代理指示在该元素的 渲染中不应有阴影。请参阅 HTML 4.01 中的 noshade 属性定义。此属性在 HTML 4.01 中已弃用。 |
...
| [Size](../../aspose.html/htmlhrelement/size) { get; set; } | 规则的高度。请参阅 HTML 4.01 中的 size 属性定义。 此属性在 HTML 4.01 中已弃用。 |
...
| [Width](../../aspose.html/htmlhrelement/width) { get; set; } | 规则的宽度。请参阅 HTML 4.01 中的宽度属性定义。 此属性在 HTML 4.01 中已弃用。 |
