...
description: Aspose.Html.HTMLOptionElement 班级. 可选择的选项请参阅 HTML 4.01. 中的 OPTION 元素定义
type: docs
weight: 3460
...
可选择的选项。请参阅 HTML 4.01. 中的 OPTION 元素定义
...
| [DefaultSelected](../../aspose.html/htmloptionelement/defaultselected/) { get; set; } | 表示 HTML selected 属性的值。如果相应表单 控件的状态在交互式用户代理中发生更改，则此 属性的值不会更改。请参阅 HTML 4.01 中选定的 属性定义。 @version DOM Level 2 |
| [Dir](../../aspose.html/htmlelement/dir/) { get; set; } | 指定方向性中性文本的基本方向和表格的 方向性。请参阅 HTML 4.01. 中的 dir 属性定义 |
| [Disabled](../../aspose.html/htmloptionelement/disabled/) { get; set; } | 控件在此上下文中不可用。请参阅 HTML 4.01. 中禁用的属性定义 |
...
| [Form](../../aspose.html/htmloptionelement/form/) { get; } | 返回`形式`包含此控件的元素。返回 `无效的`如果此控件不在 窗体的上下文中。 |
| [Id](../../aspose.html/htmlelement/id/) { get; set; } | 元素的标识符。参见 HTML 4.01. 中的 id 属性定义 |
| [Index](../../aspose.html/htmloptionelement/index/) { get; } | 这个的索引`选项`在其父母`选择` ，从 0. @version DOM Level 2 开始 |
...
| [Selected](../../aspose.html/htmloptionelement/selected/) { get; set; } | 表示相应表单控件的当前状态，在 交互式用户代理中。更改此属性会更改 表单控件的状态，但不会更改元素的 HTML 选定 属性的值。 |
...
| [Value](../../aspose.html/htmloptionelement/value/) { get; set; } | 当前表单控件值。请参阅 HTML 4.01. 中的值属性定义 |
