...
description: 一个可选择的选项请参阅 HTML 4.01 中的 OPTION 元素定义
type: docs
weight: 3540
url: /zh/net/aspose.html/htmloptionelement/
---
## HTMLOptionElement class

一个可选择的选项。请参阅 HTML 4.01 中的 OPTION 元素定义。
...
| [DefaultSelected](../../aspose.html/htmloptionelement/defaultselected) { get; set; } | 表示 HTML selected 属性的值。如果交互式用户代理中相应表单 控件的状态发生更改，则此 属性的值不会更改。请参阅 HTML 4.01 中选定的 属性定义。 @version DOM 级别 2 |
| [Dir](../../aspose.html/htmlelement/dir) { get; set; } | 指定方向性中性文本的基本方向和表格的 方向性。请参阅 HTML 4.01 中的 dir 属性定义。 |
| [Disabled](../../aspose.html/htmloptionelement/disabled) { get; set; } | 控件在此上下文中不可用。请参阅 HTML 4.01 中的 disabled 属性定义。 |
...
| [Form](../../aspose.html/htmloptionelement/form) { get; } | 返回包含此控件的` FORM` 元素。如果此控件不在 表单的上下文中，则返回 ` null` 。 |
| [Id](../../aspose.html/htmlelement/id) { get; set; } | 元素的标识符。请参阅 HTML 4.01 中的 id 属性定义。 |
| [Index](../../aspose.html/htmloptionelement/index) { get; } | 这个` 的索引` 在其父` SELECT` ，从 0 开始。 @version DOM Level 2 |
| [InnerHTML](../../aspose.html.dom/element/innerhtml) { get; set; } | 返回代表元素内容的 HTML 或 XML 片段。 可以设置，用从给定字符串解析的节点替换元素的内容。 |
| [Label](../../aspose.html/htmloptionelement/label) { get; set; } | 用于分层菜单的选项标签。请参阅 HTML 4.01 中的标签属性定义。 |
...
| [Selected](../../aspose.html/htmloptionelement/selected) { get; set; } | 在 交互式用户代理中表示相应表单控件的当前状态。更改此属性会更改 表单控件的状态，但不会更改 HTML selected 元素的属性的值。 |
...
| [Text](../../aspose.html/htmloptionelement/text) { get; } | 选项元素中包含的文本。 |
...
| [Value](../../aspose.html/htmloptionelement/value) { get; set; } | 当前表单控件值。请参阅 HTML 4.01 中的 value 属性定义。 |
