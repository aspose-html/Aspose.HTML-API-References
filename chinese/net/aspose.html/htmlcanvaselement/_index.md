...
description: Aspose.Html.HTMLCanvasElement 班级. HTMLCanvasElement 接口提供了用于操纵画布元素的布局和呈现的属性和方法 HTMLCanvasElement 接口也继承了 HTMLElement 接口的属性和方法
type: docs
weight: 3140
...
HTMLCanvasElement 接口提供了用于操纵画布元素的布局和呈现的属性和方法。 HTMLCanvasElement 接口也继承了 HTMLElement 接口的属性和方法。
...
| [Height](../../aspose.html/htmlcanvaselement/height/) { get; set; } | 是一个正整数，反映以 CSS 像素解释的画布元素的高度 HTML 属性。 当未指定属性时，或者如果它设置为无效值，如负数， 使用默认值 150。 |
...
| [Width](../../aspose.html/htmlcanvaselement/width/) { get; set; } | 是一个正整数，反映以 CSS 像素解释的 canvas 元素的宽度 HTML 属性。 未指定属性时，或者设置为无效值（如负数）时，将使用默认值 300。 |
...
| [ToDataURL](../../aspose.html/htmlcanvaselement/todataurl/#todataurl)() | 返回一个数据 URI，其中包含以类型参数指定的格式表示的图像（默认为 PNG）。 返回的图像分辨率为 96 dpi. |
| [ToDataURL](../../aspose.html/htmlcanvaselement/todataurl/#todataurl_1)(string) | 返回一个数据 URI，其中包含以类型参数指定的格式表示的图像（默认为 PNG）。 返回的图像分辨率为 96 dpi. |
| [ToDataURL](../../aspose.html/htmlcanvaselement/todataurl/#todataurl_2)(string, double) | 返回一个数据 URI，其中包含以类型参数指定的格式表示的图像（默认为 PNG）。 返回的图像分辨率为 96 dpi. |
