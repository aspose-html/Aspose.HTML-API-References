...
description: HTMLCanvasElement 接口提供了用于操作画布元素的布局和表示的属性和方法 HTMLCanvasElement 接口也继承了 HTMLElement 接口的属性和方法
type: docs
weight: 3220
url: /zh/net/aspose.html/htmlcanvaselement/
---
## HTMLCanvasElement class

HTMLCanvasElement 接口提供了用于操作画布元素的布局和表示的属性和方法。 HTMLCanvasElement 接口也继承了 HTMLElement 接口的属性和方法。
...
| [Height](../../aspose.html/htmlcanvaselement/height) { get; set; } | 是一个正整数，反映以 CSS 像素解释的 canvas 元素的 height HTML 属性。 如果未指定属性，或者将其设置为无效值（如负数），则使用 默认值 150。 |
...
| [Width](../../aspose.html/htmlcanvaselement/width) { get; set; } | 是一个正整数，反映以 CSS 像素解释的 canvas 元素的宽度 HTML 属性。 当属性没有被指定，或者如果它被设置为一个无效值，比如一个负数，则使用默认值 300。 |
...
| [GetContext](../../aspose.html/htmlcanvaselement/getcontext)(string) | 返回画布上的绘图上下文，如果不支持上下文 ID，则返回 null。绘图上下文可让您在画布上绘图。 |
...
| [ToDataURL](../../aspose.html/htmlcanvaselement/todataurl#todataurl)() | 返回一个数据 URI，其中包含由 type 参数指定的格式的图像表示（默认为 PNG）。 返回图像的分辨率为 96 dpi。 |
| [ToDataURL](../../aspose.html/htmlcanvaselement/todataurl#todataurl_1)(string) | 返回一个数据 URI，其中包含由 type 参数指定的格式的图像表示（默认为 PNG）。 返回图像的分辨率为 96 dpi。 |
| [ToDataURL](../../aspose.html/htmlcanvaselement/todataurl#todataurl_2)(string, double) | 返回一个数据 URI，其中包含由 type 参数指定的格式的图像表示（默认为 PNG）。 返回图像的分辨率为 96 dpi。 |
