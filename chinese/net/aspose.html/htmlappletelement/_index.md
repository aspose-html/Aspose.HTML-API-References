...
description: Aspose.Html.HTMLAppletElement 班级. 嵌入式 Java 小程序请参阅 HTML 4.01 中的 APPLET 元素定义 此元素在 HTML 4.01 中已弃用
type: docs
weight: 3070
...
| 姓名 | 描述 |
| --- | --- |
| [Align](../../aspose.html/htmlappletelement/align/) { get; set; } | 相对于其 周围文本对齐此对象（垂直或水平）。请参阅 HTML 4.01 中的对齐属性定义。 此属性在 HTML 4.01 中已弃用。 |
...
| [CodeBase](../../aspose.html/htmlappletelement/codebase/) { get; set; } | 可选的基本 URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) 对于小程序。请参阅 HTML 4.01 中的代码库属性定义。此属性在 HTML 4.01. 中已弃用 |
...
| [Height](../../aspose.html/htmlappletelement/height/) { get; set; } | 覆盖高度。请参阅 HTML 4.01 中的高度属性定义。此 属性在 HTML 4.01. 中已弃用 |
| [Hspace](../../aspose.html/htmlappletelement/hspace/) { get; set; } | 此图像、 小程序或对象左右两侧的水平空间（以像素为单位）。请参阅 HTML 4.01 中的 hspace 属性定义。 此属性在 HTML 4.01 中已弃用。 @version DOM Level 2 |
...
| [Name](../../aspose.html/htmlappletelement/name/) { get; set; } | 小程序的名称。请参阅 HTML 4.01 中的名称属性定义。 此属性在 HTML 4.01 中已弃用。 |
...
| [Object](../../aspose.html/htmlappletelement/object/) { get; set; } | “对象”属性的值。请参阅 HTML 4.01 中的对象属性 definition 。此属性在 HTML 4.01 中已弃用。 @version DOM 级别 2 |
...
| [Vspace](../../aspose.html/htmlappletelement/vspace/) { get; set; } | 此图像、小程序或 对象上方和下方的垂直空间（以像素为单位）。请参阅 HTML 4.01 中的 vspace 属性定义。此 属性在 HTML 4.01 中已弃用。 @version DOM Level 2 |
| [Width](../../aspose.html/htmlappletelement/width/) { get; set; } | 覆盖宽度。请参阅 HTML 4.01 中的 width 属性定义。此 属性在 HTML 4.01. 中已弃用 |
