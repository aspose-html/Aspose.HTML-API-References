...
description: 嵌入式 Java 小程序请参阅 HTML 4.01 中的 APPLET 元素定义 此元素在 HTML 4.01 中已弃用
type: docs
weight: 3150
url: /zh/net/aspose.html/htmlappletelement/
---
## HTMLAppletElement class

嵌入式 Java 小程序。请参阅 HTML 4.01 中的 APPLET 元素定义。 此元素在 HTML 4.01 中已弃用。
...
| 姓名 | 描述 |
| --- | --- |
| [Align](../../aspose.html/htmlappletelement/align) { get; set; } | 相对于其 周围文本对齐此对象（垂直或水平）。请参阅 HTML 4.01 中的 align 属性定义。 此属性在 HTML 4.01 中已弃用。 |
| [Alt](../../aspose.html/htmlappletelement/alt) { get; set; } | 用户代理的替代文本不呈现此 元素的正常内容。请参阅 HTML 4.01 中的 alt 属性定义。此 属性在 HTML 4.01 中已弃用。 |
| [Archive](../../aspose.html/htmlappletelement/archive) { get; set; } | 逗号分隔的存档列表。请参阅 HTML 4.01 中的存档属性定义。此属性在 HTML 4.01 中已弃用。 |
...
| [Code](../../aspose.html/htmlappletelement/code) { get; set; } | Applet 类文件。请参阅 HTML 4.01 中的代码属性定义。此 属性在 HTML 4.01 中已弃用。 |
| [CodeBase](../../aspose.html/htmlappletelement/codebase) { get; set; } | 可选基本 URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] 用于小程序。请参阅 HTML 4.01 中的代码库属性定义。此属性在 HTML 4.01 中已弃用。 |
...
| [Height](../../aspose.html/htmlappletelement/height) { get; set; } | 覆盖高度。请参阅 HTML 4.01 中的 height 属性定义。此 属性在 HTML 4.01 中已弃用。 |
| [Hspace](../../aspose.html/htmlappletelement/hspace) { get; set; } | 水平空间，以像素为单位，位于此图像、 小程序或对象的左侧和右侧。请参阅 HTML 4.01 中的 hspace 属性定义。 此属性在 HTML 4.01 中已弃用。 @version DOM 级别 2 |
...
| [Name](../../aspose.html/htmlappletelement/name) { get; set; } | 小程序的名称。请参阅 HTML 4.01 中的 name 属性定义。 此属性在 HTML 4.01 中已弃用。 |
...
| [Object](../../aspose.html/htmlappletelement/object) { get; set; } | “对象”属性的值。请参阅 HTML 4.01 中的对象属性定义 。此属性在 HTML 4.01 中已弃用。 @version DOM 级别 2 |
...
| [Vspace](../../aspose.html/htmlappletelement/vspace) { get; set; } | 垂直空间，以像素为单位，位于此图像、小程序或 对象的上方和下方。请参阅 HTML 4.01 中的 vspace 属性定义。此 属性在 HTML 4.01 中已弃用。 @version DOM 级别 2 |
| [Width](../../aspose.html/htmlappletelement/width) { get; set; } | 覆盖宽度。请参阅 HTML 4.01 中的宽度属性定义。此 属性在 HTML 4.01 中已弃用。 |
