...
description: Aspose.Html.HTMLFrameElement 班级. 创建一个框架请参阅 HTML 4.01. 中的 FRAME 元素定义
type: docs
weight: 3240
...
| [ContentDocument](../../aspose.html/htmlframeelement/contentdocument/) { get; } | 此帧包含的文档，如果有且可用， 或`无效的`否则. @since DOM Level 2 |
...
| [FrameBorder](../../aspose.html/htmlframeelement/frameborder/) { get; set; } | 请求边框。参见 HTML 4.01. 中的 frameborder 属性定义 |
...
| [Name](../../aspose.html/htmlframeelement/name/) { get; set; } | 框架名称（对象的`目标`属性）。请参阅 HTML 4.01. 中的 name 属性定义 |
...
| [NoResize](../../aspose.html/htmlframeelement/noresize/) { get; set; } | 为真时，禁止用户调整框架大小。请参阅 HTML 4.01. 中的 noresize 属性 定义 |
...
| [Src](../../aspose.html/htmlframeelement/src/) { get; set; } | 一个 URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] 指定初始框架内容。请参阅 HTML 4.01. 中的 src 属性 定义 |
