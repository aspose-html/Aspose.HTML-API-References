...
description: 创建一个框架请参阅 HTML 4.01 中的 FRAME 元素定义
type: docs
weight: 3320
url: /zh/net/aspose.html/htmlframeelement/
---
...
| [ContentDocument](../../aspose.html/htmlframeelement/contentdocument) { get; } | 此框架包含的文档（如果有且可用） 或` null` 否则。 @since DOM Level 2 |
...
| [FrameBorder](../../aspose.html/htmlframeelement/frameborder) { get; set; } | 请求帧边框。请参阅 HTML 4.01 中的 frameborder 属性定义。 |
...
| [LongDesc](../../aspose.html/htmlframeelement/longdesc) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] 指定此图像或框架的详细描述。请参阅 HTML 4.01 中的 longdesc 属性定义。 |
| [MarginHeight](../../aspose.html/htmlframeelement/marginheight) { get; set; } | 帧边距高度，以像素为单位。请参阅 HTML 4.01 中的 marginheight 属性 定义。 |
| [MarginWidth](../../aspose.html/htmlframeelement/marginwidth) { get; set; } | 帧边距宽度，以像素为单位。请参阅 HTML 4.01 中的 marginwidth 属性定义 。 |
| [Name](../../aspose.html/htmlframeelement/name) { get; set; } | 框架名称（` 目标` 属性的对象）。请参阅 HTML 4.01 中的 name 属性定义。 |
...
| [NoResize](../../aspose.html/htmlframeelement/noresize) { get; set; } | 当为真时，禁止用户调整框架大小。请参阅 HTML 4.01 中的 noresize 属性 定义。 |
...
| [Scrolling](../../aspose.html/htmlframeelement/scrolling) { get; set; } | 指定框架是否应该有滚动条。请参阅 HTML 4.01 中的 滚动属性定义。 |
| [ShadowRoot](../../aspose.html.dom/element/shadowroot) { get; } | 返回存储在此元素上的 shadowRoot，如果它已关闭，则返回 null。 |
| [Src](../../aspose.html/htmlframeelement/src) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] 指定初始帧内容。请参阅 HTML 4.01 中的 src 属性 定义。 |
