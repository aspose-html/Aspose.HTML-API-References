...
description: Aspose.Html.Dom.Svg.Paths.SVGPathSegCurvetoQuadraticSmoothAbs 班级. SVGPathSegCurvetoQuadraticSmoothAbs 接口对应于绝对平滑三次曲线T路径数据命令
type: docs
weight: 1790
url: /zh/net/aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticsmoothabs/
---
...
| [X](../../aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticsmoothabs/x/) { get; set; } | 此路径段终点的绝对 X 坐标。 |
| [Y](../../aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticsmoothabs/y/) { get; set; } | 此路径段终点的绝对 Y 坐标。 |
