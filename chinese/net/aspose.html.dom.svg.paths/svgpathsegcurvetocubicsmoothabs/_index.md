...
description: SVGPathSegCurvetoCubicSmoothAbs 接口对应于绝对平滑三次曲线S路径数据命令
type: docs
weight: 1860
url: /zh/net/aspose.html.dom.svg.paths/svgpathsegcurvetocubicsmoothabs/
---
...
| [X](../../aspose.html.dom.svg.paths/svgpathsegcurvetocubicsmoothabs/x) { get; set; } | 此路径段终点的绝对 X 坐标。 |
| [X2](../../aspose.html.dom.svg.paths/svgpathsegcurvetocubicsmoothabs/x2) { get; set; } | 第二个控制点的绝对 X 坐标。 |
| [Y](../../aspose.html.dom.svg.paths/svgpathsegcurvetocubicsmoothabs/y) { get; set; } | 此路径段终点的绝对 Y 坐标。 |
| [Y2](../../aspose.html.dom.svg.paths/svgpathsegcurvetocubicsmoothabs/y2) { get; set; } | 第二个控制点的绝对 Y 坐标。 |
