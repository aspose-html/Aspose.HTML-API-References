...
description: Aspose.Html.Dom.Svg.Paths.SVGPathSegLinetoRel 班级. SVGPathSegLinetoRel 接口对应于相对线l路径数据命令
type: docs
weight: 1840
url: /zh/net/aspose.html.dom.svg.paths/svgpathseglinetorel/
---
## SVGPathSegLinetoRel class

SVGPathSegLinetoRel 接口对应于“相对线”（l）路径数据命令。
...
| [X](../../aspose.html.dom.svg.paths/svgpathseglinetorel/x/) { get; set; } | 此路径段终点的相对 X 坐标。 |
| [Y](../../aspose.html.dom.svg.paths/svgpathseglinetorel/y/) { get; set; } | 此路径段终点的相对 Y 坐标。 |
