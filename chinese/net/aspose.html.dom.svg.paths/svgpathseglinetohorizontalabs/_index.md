...
description: Aspose.Html.Dom.Svg.Paths.SVGPathSegLinetoHorizontalAbs 班级. SVGPathSegLinetoHorizontalAbs 接口对应于绝对水平线H路径数据命令
type: docs
weight: 1820
url: /zh/net/aspose.html.dom.svg.paths/svgpathseglinetohorizontalabs/
---
## SVGPathSegLinetoHorizontalAbs class

SVGPathSegLinetoHorizontalAbs 接口对应于“绝对水平线”（H）路径数据命令。
...
| [X](../../aspose.html.dom.svg.paths/svgpathseglinetohorizontalabs/x/) { get; set; } | 此路径段终点的绝对 X 坐标。 |
