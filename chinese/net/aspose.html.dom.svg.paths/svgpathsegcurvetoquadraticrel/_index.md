...
description: Aspose.Html.Dom.Svg.Paths.SVGPathSegCurvetoQuadraticRel 班级. SVGPathSegCurvetoQuadraticRel 接口对应于相对二次贝塞尔曲线q路径数据命令
type: docs
weight: 1780
url: /zh/net/aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticrel/
---
...
| [X](../../aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticrel/x/) { get; set; } | 此路径段终点的相对 X 坐标。 |
| [X1](../../aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticrel/x1/) { get; set; } | 第一个控制点的相对 X 坐标。 |
| [Y](../../aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticrel/y/) { get; set; } | 此路径段终点的相对 Y 坐标。 |
| [Y1](../../aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticrel/y1/) { get; set; } | 第一个控制点的相对 Y 坐标。 |
