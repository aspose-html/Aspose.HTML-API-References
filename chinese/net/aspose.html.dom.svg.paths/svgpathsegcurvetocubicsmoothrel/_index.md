...
description: SVGPathSegCurvetoCubicSmoothRel 接口对应于相对平滑三次曲线到s 路径数据命令
type: docs
weight: 1870
url: /zh/net/aspose.html.dom.svg.paths/svgpathsegcurvetocubicsmoothrel/
---
## SVGPathSegCurvetoCubicSmoothRel class

SVGPathSegCurvetoCubicSmoothRel 接口对应于“相对平滑三次曲线到”(s) 路径数据命令。
...
| [X](../../aspose.html.dom.svg.paths/svgpathsegcurvetocubicsmoothrel/x) { get; set; } | 此路径段终点的相对 X 坐标。 |
| [X2](../../aspose.html.dom.svg.paths/svgpathsegcurvetocubicsmoothrel/x2) { get; set; } | 第二个控制点的相对 X 坐标。 |
| [Y](../../aspose.html.dom.svg.paths/svgpathsegcurvetocubicsmoothrel/y) { get; set; } | 此路径段终点的相对 Y 坐标。 |
| [Y2](../../aspose.html.dom.svg.paths/svgpathsegcurvetocubicsmoothrel/y2) { get; set; } | 第二个控制点的相对 Y 坐标。 |
