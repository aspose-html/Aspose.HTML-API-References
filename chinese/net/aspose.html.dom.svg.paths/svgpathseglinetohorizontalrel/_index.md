...
description: Aspose.Html.Dom.Svg.Paths.SVGPathSegLinetoHorizontalRel 班级. SVGPathSegLinetoHorizontalRel接口对应一个相对水平linetoh路径数据命令.
type: docs
weight: 1830
url: /zh/net/aspose.html.dom.svg.paths/svgpathseglinetohorizontalrel/
---
## SVGPathSegLinetoHorizontalRel class

SVGPathSegLinetoHorizontalRel接口对应一个“相对水平lineto”(h)路径数据命令.
...
| [X](../../aspose.html.dom.svg.paths/svgpathseglinetohorizontalrel/x/) { get; set; } | 此路径段终点的相对 X 坐标。 |
