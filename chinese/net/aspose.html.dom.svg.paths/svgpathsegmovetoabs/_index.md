...
description: Aspose.Html.Dom.Svg.Paths.SVGPathSegMovetoAbs 班级. SVGPathSegMovetoAbs 接口对应于绝对移动M 路径数据命令
type: docs
weight: 1880
url: /zh/net/aspose.html.dom.svg.paths/svgpathsegmovetoabs/
---
...
| [X](../../aspose.html.dom.svg.paths/svgpathsegmovetoabs/x/) { get; set; } | 此路径段终点的绝对 X 坐标。 |
| [Y](../../aspose.html.dom.svg.paths/svgpathsegmovetoabs/y/) { get; set; } | 此路径段终点的绝对 Y 坐标。 |
