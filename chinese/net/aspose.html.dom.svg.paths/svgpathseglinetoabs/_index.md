...
description: Aspose.Html.Dom.Svg.Paths.SVGPathSegLinetoAbs 班级. SVGPathSegLinetoAbs 接口对应于绝对线L路径数据命令
type: docs
weight: 1810
url: /zh/net/aspose.html.dom.svg.paths/svgpathseglinetoabs/
---
## SVGPathSegLinetoAbs class

SVGPathSegLinetoAbs 接口对应于“绝对线”（L）路径数据命令。
...
| [X](../../aspose.html.dom.svg.paths/svgpathseglinetoabs/x/) { get; set; } | 此路径段终点的绝对 X 坐标。 |
| [Y](../../aspose.html.dom.svg.paths/svgpathseglinetoabs/y/) { get; set; } | 此路径段终点的绝对 Y 坐标。 |
