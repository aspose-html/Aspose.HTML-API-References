...
description: Aspose.Html.Net 命名空间由 类和接口是 负责帮助轻松进行网络处理
type: docs
weight: 290
url: /zh/net/aspose.html.net/
---
**Aspose.Html.Net** 命名空间由 类和接口是 负责帮助轻松进行网络处理。
...
| [MessageFilter](./messagefilter) | 表示用于查询消息的不同过滤器类的抽象基类 |
| [MessageHandler](./messagehandler) | 表示消息处理程序的基本类型。 |
| [MessageHandlerCollection](./messagehandlercollection) | 表示[`MessageHandler`](../aspose.html.net/messagehandler)的集合。 |
...
| [ResponseHeaders](./responseheaders) | 包含与响应相关的协议头。 |
