...
description: 将 Markdown 源代码转换为 html结果是HTMLDocumentaspose.html/htmldocument
type: docs
weight: 30
...
将 Markdown 源代码转换为 html。结果是html文件。
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| sourcePath | String | 源 Markdown 文件的路径。它将与当前目录路径结合形成一个绝对 URL。 |
