...
description: 保存ImageDevice./imagedevice的当前图形控制参数 这些参数定义了图形操作符执行的全局框架
type: docs
weight: 4390
...
| override [TransformationMatrix](../../aspose.html.rendering.image/imagegraphiccontext/transformationmatrix) { get; set; } | 设置或获取变换矩阵。 |

## 方法

| 姓名 | 描述 |
| --- | --- |
| override [Clone](../../aspose.html.rendering.image/imagegraphiccontext/clone)() | 使用与现有实例相同的属性值创建 GdiGraphicContext 类的新实例。 |
| override [Transform](../../aspose.html.rendering.image/imagegraphiccontext/transform)(Matrix) | 通过乘以指定矩阵来修改当前变换矩阵。 |
