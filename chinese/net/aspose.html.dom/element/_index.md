...
description: Aspose.Html.Dom.Element 班级. Element 接口表示 HTML 或 XML 文档中的元素
type: docs
weight: 690
url: /zh/net/aspose.html.dom/element/
---
## Element class
...
| 姓名 | 描述 |
| --- | --- |
| [Element](element/)(IElementInit) | 初始化一个新的实例`Element`班级。不要直接调用这个构造函数，使用[`CreateElement`](../document/createelement/)或者[`CreateElementNS`](../document/createelementns/). |
...
| [Id](../../aspose.html.dom/element/id/) { get; set; } | 元素的标识符。参见 HTML 4.01. 中的 id 属性定义 |
...
| [ParentElement](../../aspose.html.dom/node/parentelement/) { get; } | 获取父级`Element`这个节点的. |
