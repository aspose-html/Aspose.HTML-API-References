...
description: Aspose.Html.Dom.DocumentFragment 班级. DocumentFragment 是轻量级或最小文档对象希望能够提取文档树的一部分或创建文档的新片段是很常见的
type: docs
weight: 670
...
DocumentFragment 是“轻量级”或“最小”文档对象。希望能够提取文档树的一部分或创建文档的新片段是很常见的。
