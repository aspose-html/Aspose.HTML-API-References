...
description: Aspose.Html.Dom.ProcessingInstruction 班级. ProcessingInstruction 表示处理指令在 XML 中用作在文档文本中保留处理器特定信息的方式
type: docs
weight: 1020
url: /zh/net/aspose.html.dom/processinginstruction/
---
## ProcessingInstruction class

ProcessingInstruction 表示“处理指令”，在 XML 中用作在文档文本中保留处理器特定信息的方式。
...
| override [NodeName](../../aspose.html.dom/processinginstruction/nodename/) { get; } | 此节点的名称，取决于其类型。 |
| override [NodeType](../../aspose.html.dom/processinginstruction/nodetype/) { get; } | 表示底层对象类型的代码。 |
| override [NodeValue](../../aspose.html.dom/processinginstruction/nodevalue/) { get; set; } | 这个节点的值，取决于它的类型。 |
...
| [Target](../../aspose.html.dom/processinginstruction/target/) { get; } | 这条处理指令的目标。 |
| override [TextContent](../../aspose.html.dom/processinginstruction/textcontent/) { get; set; } | 该属性返回该节点及其后代的文本内容。当它被定义为空时，设置它是无效的。在设置时，此节点可能具有的任何可能的子节点都将被删除，如果新字符串不为空或为空，则替换为包含此属性设置为的字符串的单个文本节点。 |
