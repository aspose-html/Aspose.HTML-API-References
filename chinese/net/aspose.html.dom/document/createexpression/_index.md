...
type: docs
weight: 890
url: /zh/net/aspose.html.dom/document/createexpression/
---
...
| 例外 | （健康）状况 |
| --- | --- |
| [DOMException](../../domexception/) | INVALID_EXPRESSION_ERR：如果表达式 根据规则不合法则引发[`IXPathEvaluator`](../../../aspose.html.dom.xpath/ixpathevaluator/). |
| [DOMException](../../domexception/) | NAMESPACE_ERR：如果表达式包含无法由指定的命名空间 前缀解析，则引发[`IXPathNSResolver`](../../../aspose.html.dom.xpath/ixpathnsresolver/). |
