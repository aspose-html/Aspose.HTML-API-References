...
| 例外 | （健康）状况 |
| --- | --- |
| [DOMException](../../domexception) | INVALID_EXPRESSION_ERR:如果表达式不符合 合法则引发遵守[`IXPathEvaluator`](../../../aspose.html.dom.xpath/ixpathevaluator)的规则。 |
| [DOMException](../../domexception) | NAMESPACE_ERR:如果表达式包含命名空间 前缀而无法通过指定的[`IXPathNSResolver`](../../../aspose.html.dom.xpath/ixpathnsresolver)。 |
