...
| 姓名 | 描述 |
| --- | --- |
| [DocumentType](documenttype)(string, string, string, string, Document) | 初始化[`DocumentType`](../documenttype)类的新实例。 |
...
| [InternalSubset](../../aspose.html.dom/documenttype/internalsubset) { get; } | 作为字符串的内部子集，如果没有，则为 null。 |
...
| override [ToString](../../aspose.html.dom/documenttype/tostring)() | 返回代表此实例的String。 |
