...
description: Aspose.Html.Dom.DocumentType 班级. DocumentType 为为文档 定义的实体列表提供接口
type: docs
weight: 680
url: /zh/net/aspose.html.dom/documenttype/
---
## DocumentType class

DocumentType 为为文档 定义的实体列表提供接口
...
| 姓名 | 描述 |
| --- | --- |
| [DocumentType](documenttype/)(string, string, string, string, Document) | 初始化一个新的实例`DocumentType`类. |
...
| [InternalSubset](../../aspose.html.dom/documenttype/internalsubset/) { get; } | 作为字符串的内部子集，如果没有则为 null。 |
...
| [Name](../../aspose.html.dom/documenttype/name/) { get; } | DTD 的名称；即，紧跟在 DOCTYPE 关键字之后的名称。 |
...
| override [NodeName](../../aspose.html.dom/documenttype/nodename/) { get; } | 此节点的名称，取决于其类型。 |
| override [NodeType](../../aspose.html.dom/documenttype/nodetype/) { get; } | 表示底层对象类型的代码。 |
...
| [PublicId](../../aspose.html.dom/documenttype/publicid/) { get; } | 外部子集的公共标识符。 |
| [SystemId](../../aspose.html.dom/documenttype/systemid/) { get; } | 外部子集的系统标识符。这可能是绝对 URI，也可能不是。 |
...
| override [ToString](../../aspose.html.dom/documenttype/tostring/)() | 返回一个String代表这个实例. |
