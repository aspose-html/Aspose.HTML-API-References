...
description: Aspose.Html.Dom.Attr 班级. Attr 接口表示 Element 对象中的属性通常属性的允许值在与文档关联的模式中定义
type: docs
weight: 110
url: /zh/net/aspose.html.dom/attr/
---
## Attr class
...
| [IsId](../../aspose.html.dom/attr/isid/) { get; } | 返回此属性是否已知为 ID 类型（即包含其所有者元素的标识符）。 |
| [LastChild](../../aspose.html.dom/node/lastchild/) { get; } | 此节点的最后一个子节点。如果没有这样的节点，则返回 null. |
| override [LocalName](../../aspose.html.dom/attr/localname/) { get; } | 返回此节点限定名称的本地部分。 对于除 ELEMENT_NODE 和 ATTRIBUTE_NODE 以外的任何类型的节点以及使用 DOM Level 1 方法创建的节点，例如 Document.createElement()，这始终为空。 |
| [Name](../../aspose.html.dom/attr/name/) { get; } | 返回此属性的名称。 |
| override [NamespaceURI](../../aspose.html.dom/attr/namespaceuri/) { get; } | 此节点的名称空间 URI，如果未指定则为 null。 |
| [NextSibling](../../aspose.html.dom/node/nextsibling/) { get; } | 紧接此节点之后的节点。如果没有这样的节点，则返回 null. |
| override [NodeName](../../aspose.html.dom/attr/nodename/) { get; } | 此节点的名称，取决于其类型。 |
| override [NodeType](../../aspose.html.dom/attr/nodetype/) { get; } | 表示底层对象类型的代码。 |
| override [NodeValue](../../aspose.html.dom/attr/nodevalue/) { get; set; } | 这个节点的值，取决于它的类型。 |
...
| [OwnerElement](../../aspose.html.dom/attr/ownerelement/) { get; } | 此属性附加到的元素节点，如果未使用此属性，则为 null。 |
...
| override [Prefix](../../aspose.html.dom/attr/prefix/) { get; } | 此节点的名称空间前缀，如果未指定则为 null。定义为null时，设置无效 |
| [PreviousSibling](../../aspose.html.dom/node/previoussibling/) { get; } | 紧接此节点之前的节点。如果没有这样的节点，则返回 null. |
| [SchemaTypeInfo](../../aspose.html.dom/attr/schematypeinfo/) { get; } | 与此属性关联的类型信息。 |
| [Specified](../../aspose.html.dom/attr/specified/) { get; } | 如果此属性在实例文档中明确指定了一个值，则为真，否则为假。 |
| override [TextContent](../../aspose.html.dom/attr/textcontent/) { get; set; } | 该属性返回该节点及其后代的文本内容。当它被定义为空时，设置它是无效的。在设置时，此节点可能具有的任何可能的子节点都将被删除，如果新字符串不为空或为空，则替换为包含此属性设置为的字符串的单个文本节点。 |
| [Value](../../aspose.html.dom/attr/value/) { get; set; } | 在检索时，属性的值作为字符串返回。 |
