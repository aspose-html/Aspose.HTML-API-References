...
description: Node 财产. 返回此节点限定名称的本地部分 对于除 ELEMENT_NODE 和 ATTRIBUTE_NODE 以外的任何类型的节点以及使用 DOM Level 1 方法创建的节点例如 Document.createElement这始终为空
type: docs
weight: 60
url: /zh/net/aspose.html.dom/node/localname/
---
