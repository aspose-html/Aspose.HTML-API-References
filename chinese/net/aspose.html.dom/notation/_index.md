...
description: Aspose.Html.Dom.Notation 班级. 表示在 DTD 中声明的符号
type: docs
weight: 1010
url: /zh/net/aspose.html.dom/notation/
---
## Notation class
...
| override [NodeName](../../aspose.html.dom/notation/nodename/) { get; } | 此节点的名称，取决于其类型。 |
| override [NodeType](../../aspose.html.dom/notation/nodetype/) { get; } | 表示底层对象类型的代码。 |
...
| [PublicId](../../aspose.html.dom/notation/publicid/) { get; } | 此表示法的公共标识符。如果未指定公共标识符，则为 null. |
| [SystemId](../../aspose.html.dom/notation/systemid/) { get; } | 此表示法的系统标识符。如果未指定系统标识符，则为空。这可能是绝对 URI，也可能不是。 |
