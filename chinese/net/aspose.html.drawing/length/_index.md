...
description: Aspose.Html.Drawing.Length 班级. 表示长度测量单位
type: docs
weight: 2770
url: /zh/net/aspose.html.drawing/length/
---
## Length class
...
| [operator +](../../aspose.html.drawing/length/op_addition/) | 实现运算符 +. |
| [operator ==](../../aspose.html.drawing/length/op_equality/) | 实现运算符 ==. |
| [operator &gt;](../../aspose.html.drawing/length/op_greaterthan/) | 实现运算符 &gt;. |
| [operator &gt;=](../../aspose.html.drawing/length/op_greaterthanorequal/) | 实现运算符 &gt;=. |
| [operator !=](../../aspose.html.drawing/length/op_inequality/) | 实现运算符 !=. |
| [operator &lt;](../../aspose.html.drawing/length/op_lessthan/) | 实现运算符 &lt;. |
| [operator &lt;=](../../aspose.html.drawing/length/op_lessthanorequal/) | 实现运算符 &lt;=. |
| [operator -](../../aspose.html.drawing/length/op_subtraction/) | 实现运算符 -. |
