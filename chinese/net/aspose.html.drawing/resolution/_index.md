...
description: Aspose.Html.Drawing.Resolution 班级. 表示一个分辨率单位
type: docs
weight: 2820
url: /zh/net/aspose.html.drawing/resolution/
---
## Resolution class
...
| [operator +](../../aspose.html.drawing/resolution/op_addition/) | 实现运算符 +. |
| [operator ==](../../aspose.html.drawing/resolution/op_equality/) | 实现运算符 ==. |
| [operator &gt;](../../aspose.html.drawing/resolution/op_greaterthan/) | 实现运算符 &gt;. |
| [operator &gt;=](../../aspose.html.drawing/resolution/op_greaterthanorequal/) | 实现运算符 &gt;=. |
| [implicit operator](../../aspose.html.drawing/resolution/op_implicit/#op_implicit) | 执行隐式转换Double到`Resolution`. (2 operators) |
| [operator !=](../../aspose.html.drawing/resolution/op_inequality/) | 实现运算符 !=. |
| [operator &lt;](../../aspose.html.drawing/resolution/op_lessthan/) | 实现运算符 &lt;. |
| [operator &lt;=](../../aspose.html.drawing/resolution/op_lessthanorequal/) | 实现运算符 &lt;=. |
| [operator -](../../aspose.html.drawing/resolution/op_subtraction/) | 实现运算符 -. |
