...
description: Aspose.Html.Dom.Svg.DataTypes.SVGAnimatedString 班级. 用于可以设置动画的 DOMString 类型的属性
type: docs
weight: 1170
url: /zh/net/aspose.html.dom.svg.datatypes/svganimatedstring/
---
## SVGAnimatedString class

用于可以设置动画的 DOMString 类型的属性。
...
| override [ToString](../../aspose.html.dom.svg.datatypes/svganimatedstring/tostring/)() | 返回一个String代表这个实例. |
