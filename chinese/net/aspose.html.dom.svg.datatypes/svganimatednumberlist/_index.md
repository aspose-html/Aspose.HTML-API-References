...
description: Aspose.Html.Dom.Svg.DataTypes.SVGAnimatedNumberList 班级. 用于采用数字列表且可以设置动画的属性
type: docs
weight: 1140
...
| override [ToString](../../aspose.html.dom.svg.datatypes/svganimatednumberlist/tostring/)() | 返回一个String代表这个实例. |
