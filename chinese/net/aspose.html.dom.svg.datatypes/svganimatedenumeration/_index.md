...
description: Aspose.Html.Dom.Svg.DataTypes.SVGAnimatedEnumeration 班级. 用于其值必须是来自特定枚举的常量并且可以设置动画的属性
type: docs
weight: 1090
...
| override [ToString](../../aspose.html.dom.svg.datatypes/svganimatedenumeration/tostring/)() | 返回一个String代表这个实例. |
