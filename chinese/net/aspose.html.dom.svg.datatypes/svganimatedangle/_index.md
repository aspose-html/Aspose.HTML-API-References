...
description: Aspose.Html.Dom.Svg.DataTypes.SVGAnimatedAngle 班级. 用于基本数据类型angle的属性可以做动画
type: docs
weight: 1070
url: /zh/net/aspose.html.dom.svg.datatypes/svganimatedangle/
---
## SVGAnimatedAngle class

用于基本数据类型angle的属性，可以做动画。
...
| override [ToString](../../aspose.html.dom.svg.datatypes/svganimatedangle/tostring/)() | 返回一个String代表这个实例. |
