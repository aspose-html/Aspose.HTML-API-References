...
description: Aspose.Html.Dom.Svg.DataTypes.SVGAnimatedLengthList 班级. 用于可以设置动画的 SVGLengthList 类型的属性
type: docs
weight: 1120
url: /zh/net/aspose.html.dom.svg.datatypes/svganimatedlengthlist/
---
## SVGAnimatedLengthList class

用于可以设置动画的 SVGLengthList 类型的属性。
...
| override [ToString](../../aspose.html.dom.svg.datatypes/svganimatedlengthlist/tostring/)() | 返回一个String代表这个实例. |
