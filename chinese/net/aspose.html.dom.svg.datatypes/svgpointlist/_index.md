...
description: 这个接口定义了一个 SVGPoint 对象的列表
type: docs
weight: 1370
url: /zh/net/aspose.html.dom.svg.datatypes/svgpointlist/
---
## SVGPointList class

这个接口定义了一个 SVGPoint 对象的列表。
...
| override [ToString](../../aspose.html.dom.svg.datatypes/svgpointlist/tostring)() | 返回代表此实例的String。 |
