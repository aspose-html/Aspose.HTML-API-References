...
description: SVGOptimizationOptions 财产. 获取或设置删除空文本元素的选项默认情况下为真
type: docs
weight: 80
url: /zh/net/aspose.html.toolkit.optimizers/svgoptimizationoptions/removeemptytext/
---
## SVGOptimizationOptions.RemoveEmptyText property

获取或设置删除空文本元素的选项。默认情况下为“真”。
