...
| [Creator](../../aspose.html.rendering.pdf/pdfdocumentinfo/creator) { get; set; } | 创建原始文档的产品的名称。 |
| [Keywords](../../aspose.html.rendering.pdf/pdfdocumentinfo/keywords) { get; set; } | 与文档关联的关键字。 |
| [ModificationDate](../../aspose.html.rendering.pdf/pdfdocumentinfo/modificationdate) { get; set; } | 获取或设置指定为协调世界时 (UTC) 的文档修改日期。 |
