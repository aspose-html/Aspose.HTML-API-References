...
description: PdfDevice 方法. 通过将当前点移动到参数 pt 的坐标开始新的子路径省略任何连接线段 如果当前路径中之前的路径构造方法也是MoveTo则新的MoveTo覆盖它 路径中没有先前MoveTo操作的痕迹
type: docs
weight: 170
url: /zh/net/aspose.html.rendering.pdf/pdfdevice/moveto/
---
