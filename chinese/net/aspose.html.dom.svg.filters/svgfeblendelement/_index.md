...
description: SVGFEBlendElement 接口对应于 feBlend 元素
type: docs
weight: 1470
...
| [Height](../../aspose.html.dom.svg.filters/svgfeblendelement/height) { get; } | 对应于给定“过滤器”元素的属性“高度”。 |
...
| [Result](../../aspose.html.dom.svg.filters/svgfeblendelement/result) { get; } | 对应于给定“过滤器”元素的属性“结果”。 |
...
| [Width](../../aspose.html.dom.svg.filters/svgfeblendelement/width) { get; } | 对应于给定“过滤器”元素的属性“宽度”。 |
| [X](../../aspose.html.dom.svg.filters/svgfeblendelement/x) { get; } | 对应于给定“过滤器”元素的属性“x”。 |
| [Y](../../aspose.html.dom.svg.filters/svgfeblendelement/y) { get; } | 对应于给定 'filter' 元素上的属性 'y'。 |
...
| 姓名 | 描述 |
| --- | --- |
| const [SVG_FEBLEND_MODE_COLOR](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_color) | 对应于值“颜色”。 |
...
| const [SVG_FEBLEND_MODE_DARKEN](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_darken) | 对应于值“变暗”。 |
| const [SVG_FEBLEND_MODE_DIFFERENCE](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_difference) | 对应于值“差异”。 |
| const [SVG_FEBLEND_MODE_EXCLUSION](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_exclusion) | 对应于值“排除”。 |
...
| const [SVG_FEBLEND_MODE_LUMINOSITY](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_luminosity) | 对应于值“亮度”。 |
| const [SVG_FEBLEND_MODE_MULTIPLY](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_multiply) | 对应于值“乘”。 |
| const [SVG_FEBLEND_MODE_NORMAL](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_normal) | 对应于值“正常”。 |
| const [SVG_FEBLEND_MODE_OVERLAY](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_overlay) | 对应于值“覆盖”。 |
...
| const [SVG_FEBLEND_MODE_UNKNOWN](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_unknown) | 该类型不是预定义类型之一。尝试定义此类型的新值或尝试将现有值切换到此类型是无效的。 |
