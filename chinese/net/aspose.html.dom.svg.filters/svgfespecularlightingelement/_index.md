...
description: Aspose.Html.Dom.Svg.Filters.SVGFESpecularLightingElement 班级. SVGFESpecularLightingElement 接口对应于feSpecularLighting元素
type: docs
weight: 1570
url: /zh/net/aspose.html.dom.svg.filters/svgfespecularlightingelement/
---
## SVGFESpecularLightingElement class

SVGFESpecularLightingElement 接口对应于“feSpecularLighting”元素。
...
| [Height](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/height/) { get; } | 对应于给定“过滤器”元素上的属性“高度”。 |
| [Id](../../aspose.html.dom.svg/svgelement/id/) { get; set; } | 给定元素上“id”属性的值，如果“id”不存在则为空字符串。 |
| [In1](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/in1/) { get; } | 对应于给定“feSpecularLighting”元素上的属性“in”。 |
| [InnerHTML](../../aspose.html.dom/element/innerhtml/) { get; set; } | 返回表示元素内容的 HTML 或 XML 片段。 可以设置，用从给定字符串解析的节点替换元素的内容。 |
| [KernelUnitLengthX](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/kernelunitlengthx/) { get; } | 对应于给定“feSpecularLighting”元素上的属性“kernelUnitLength”。 |
| [KernelUnitLengthY](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/kernelunitlengthy/) { get; } | 对应于给定“feSpecularLighting”元素上的属性“kernelUnitLength”。 |
...
| [Result](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/result/) { get; } | 对应于给定“过滤器”元素上的属性“结果”。 |
...
| [SpecularConstant](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/specularconstant/) { get; } | 对应于给定“feSpecularLighting”元素上的属性“specularConstant”。 |
| [SpecularExponent](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/specularexponent/) { get; } | 对应于给定“feSpecularLighting”元素上的属性“specularExponent”。 |
| [Style](../../aspose.html.dom.svg/svgelement/style/) { get; } | 对应于给定元素上的属性“样式”。如果用户代理不支持 CSS 样式，则此属性的值必须始终为 null. |
| [SurfaceScale](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/surfacescale/) { get; } | 对应于给定“feSpecularLighting”元素上的属性“surfaceScale”。 |
...
| [Width](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/width/) { get; } | 对应于给定“过滤器”元素上的属性“宽度”。 |
| [X](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/x/) { get; } | 对应于给定“过滤器”元素上的属性“x”。 |
| [Y](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/y/) { get; } | 对应于给定“过滤器”元素上的属性“y”。 |
