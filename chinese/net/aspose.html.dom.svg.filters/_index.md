...
description: Aspose.Html.Dom.Svg.Filters 命名空间包含类和 SVG规范中与滤镜效果相关的接口
type: docs
weight: 180
url: /zh/net/aspose.html.dom.svg.filters/
---
**Aspose.Html.Dom.Svg.Filters** 命名空间包含类和 SVG规范中与滤镜效果相关的接口。
...
| 界面 | 描述 |
| --- | --- |
| [ISVGFilterPrimitiveStandardAttributes](./isvgfilterprimitivestandardattributes) | 该接口定义了过滤器原语接口通用的 DOM 属性集。 |
