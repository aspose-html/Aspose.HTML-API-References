...
description: SVGFEDisplacementMapElement 接口对应于 feDisplacementMap 元素
type: docs
weight: 1530
...
| [Height](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/height) { get; } | 对应于给定“过滤器”元素的属性“高度”。 |
...
| [Result](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/result) { get; } | 对应于给定“过滤器”元素的属性“结果”。 |
...
| [Width](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/width) { get; } | 对应于给定“过滤器”元素的属性“宽度”。 |
| [X](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/x) { get; } | 对应于给定“过滤器”元素的属性“x”。 |
| [XChannelSelector](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/xchannelselector) { get; } | 对应于给定 'feDisplacementMap' 元素上的属性 'xChannelSelector'。采用此接口上定义的 SVG_CHANNEL_* 常量之一。 |
| [Y](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/y) { get; } | 对应于给定 'filter' 元素上的属性 'y'。 |
| [YChannelSelector](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/ychannelselector) { get; } | 对应于给定 'feDisplacementMap' 元素上的属性 'yChannelSelector'。采用此接口上定义的 SVG_CHANNEL_* 常量之一。 |
...
| const [SVG_CHANNEL_UNKNOWN](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_unknown) | 该类型不是预定义类型之一。尝试定义此类型的新值或尝试将现有值切换到此类型是无效的。 |
