...
description: Aspose.Html.Dom.Svg.Filters.SVGFEDisplacementMapElement 班级. SVGFEDisplacementMapElement 接口对应于feDisplacementMap元素
type: docs
weight: 1420
url: /zh/net/aspose.html.dom.svg.filters/svgfedisplacementmapelement/
---
...
| [Height](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/height/) { get; } | 对应于给定“过滤器”元素上的属性“高度”。 |
| [Id](../../aspose.html.dom.svg/svgelement/id/) { get; set; } | 给定元素上“id”属性的值，如果“id”不存在则为空字符串。 |
| [In1](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/in1/) { get; } | 对应于给定“feDisplacementMap”元素上的属性“in”。 |
| [In2](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/in2/) { get; } | 对应于给定“feDisplacementMap”元素上的属性“in2”。 |
...
| [Result](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/result/) { get; } | 对应于给定“过滤器”元素上的属性“结果”。 |
| [Scale](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/scale/) { get; } | 对应于给定“feDisplacementMap”元素上的属性“scale”。 |
...
| [Width](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/width/) { get; } | 对应于给定“过滤器”元素上的属性“宽度”。 |
| [X](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/x/) { get; } | 对应于给定“过滤器”元素上的属性“x”。 |
| [XChannelSelector](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/xchannelselector/) { get; } | 对应于给定“feDisplacementMap”元素上的属性“xChannelSelector”。采用在此接口上定义的 SVG_CHANNEL_* 常量之一。 |
| [Y](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/y/) { get; } | 对应于给定“过滤器”元素上的属性“y”。 |
| [YChannelSelector](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/ychannelselector/) { get; } | 对应于给定“feDisplacementMap”元素上的属性“yChannelSelector”。采用在此接口上定义的 SVG_CHANNEL_* 常量之一。 |
...
| 姓名 | 描述 |
| --- | --- |
| const [SVG_CHANNEL_A](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_a/) | 对应于值“A”。 |
| const [SVG_CHANNEL_B](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_b/) | 对应于值“B”。 |
| const [SVG_CHANNEL_G](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_g/) | 对应于值 'G'. |
| const [SVG_CHANNEL_R](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_r/) | 对应于值 'R'. |
| const [SVG_CHANNEL_UNKNOWN](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_unknown/) | 该类型不是预定义类型之一。尝试定义此类型的新值或尝试将现有值切换为此类型是无效的。 |
