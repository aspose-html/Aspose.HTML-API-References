...
description: Aspose.Html.Dom.Svg.Filters.SVGFECompositeElement 班级. SVGFECompositeElement 接口对应于feComposite元素
type: docs
weight: 1390
url: /zh/net/aspose.html.dom.svg.filters/svgfecompositeelement/
---
...
| [Height](../../aspose.html.dom.svg.filters/svgfecompositeelement/height/) { get; } | 对应于给定“过滤器”元素上的属性“高度”。 |
| [Id](../../aspose.html.dom.svg/svgelement/id/) { get; set; } | 给定元素上“id”属性的值，如果“id”不存在则为空字符串。 |
| [In1](../../aspose.html.dom.svg.filters/svgfecompositeelement/in1/) { get; } | 对应于给定“feComposite”元素上的属性“in”。 |
| [In2](../../aspose.html.dom.svg.filters/svgfecompositeelement/in2/) { get; } | 对应于给定“feComposite”元素上的属性“in2”。 |
| [InnerHTML](../../aspose.html.dom/element/innerhtml/) { get; set; } | 返回表示元素内容的 HTML 或 XML 片段。 可以设置，用从给定字符串解析的节点替换元素的内容。 |
| [K1](../../aspose.html.dom.svg.filters/svgfecompositeelement/k1/) { get; } | 对应于给定“feComposite”元素上的属性“k1”。 |
| [K2](../../aspose.html.dom.svg.filters/svgfecompositeelement/k2/) { get; } | 对应于给定“feComposite”元素上的属性“k2”。 |
| [K3](../../aspose.html.dom.svg.filters/svgfecompositeelement/k3/) { get; } | 对应于给定“feComposite”元素上的属性“k3”。 |
| [K4](../../aspose.html.dom.svg.filters/svgfecompositeelement/k4/) { get; } | 对应于给定“feComposite”元素上的属性“k4”。 |
...
| [Operator](../../aspose.html.dom.svg.filters/svgfecompositeelement/operator/) { get; } | 对应于给定“feComposite”元素上的属性“operator”。采用在此接口上定义的 SVG_FECOMPOSITE_OPERATOR_* 常量之一。 |
...
| [Result](../../aspose.html.dom.svg.filters/svgfecompositeelement/result/) { get; } | 对应于给定“过滤器”元素上的属性“结果”。 |
...
| [Width](../../aspose.html.dom.svg.filters/svgfecompositeelement/width/) { get; } | 对应于给定“过滤器”元素上的属性“宽度”。 |
| [X](../../aspose.html.dom.svg.filters/svgfecompositeelement/x/) { get; } | 对应于给定“过滤器”元素上的属性“x”。 |
| [Y](../../aspose.html.dom.svg.filters/svgfecompositeelement/y/) { get; } | 对应于给定“过滤器”元素上的属性“y”。 |
...
| 姓名 | 描述 |
| --- | --- |
| const [SVG_FECOMPOSITE_OPERATOR_ARITHMETIC](../../aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_arithmetic/) | 对应于值 'arithmetic'. |
| const [SVG_FECOMPOSITE_OPERATOR_ATOP](../../aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_atop/) | 对应于值 'atop'. |
| const [SVG_FECOMPOSITE_OPERATOR_IN](../../aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_in/) | 对应于值 'in'. |
| const [SVG_FECOMPOSITE_OPERATOR_OUT](../../aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_out/) | 对应于值 'out'. |
| const [SVG_FECOMPOSITE_OPERATOR_OVER](../../aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_over/) | 对应于值 'over'. |
| const [SVG_FECOMPOSITE_OPERATOR_UNKNOWN](../../aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_unknown/) | 该类型不是预定义类型之一。尝试定义此类型的新值或尝试将现有值切换为此类型是无效的。 |
| const [SVG_FECOMPOSITE_OPERATOR_XOR](../../aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_xor/) | 对应于值 'xor'. |
