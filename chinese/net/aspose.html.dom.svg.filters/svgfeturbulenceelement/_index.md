...
description: Aspose.Html.Dom.Svg.Filters.SVGFETurbulenceElement 班级. SVGFETurbulenceElement 接口对应于feTurbulence元素
type: docs
weight: 1600
url: /zh/net/aspose.html.dom.svg.filters/svgfeturbulenceelement/
---
...
| [BaseFrequencyX](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/basefrequencyx/) { get; } | 对应于给定“feTurbulence”元素上的属性“baseFrequency”。包含“baseFrequency”属性的 X 分量。 |
| [BaseFrequencyY](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/basefrequencyy/) { get; } | 对应于给定“feTurbulence”元素上的属性“baseFrequency”。包含（可能自动计算的）“baseFrequency”属性的 Y 分量。 |
...
| [Height](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/height/) { get; } | 对应于给定“过滤器”元素上的属性“高度”。 |
...
| [NumOctaves](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/numoctaves/) { get; } | 对应于给定“feTurbulence”元素上的属性“numOctaves”。 |
...
| [Result](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/result/) { get; } | 对应于给定“过滤器”元素上的属性“结果”。 |
| [SchemaTypeInfo](../../aspose.html.dom/element/schematypeinfo/) { get; } | 与此元素关联的类型信息。 |
| [Seed](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/seed/) { get; } | 对应于给定“feTurbulence”元素上的属性“seed”。 |
| [ShadowRoot](../../aspose.html.dom/element/shadowroot/) { get; } | 返回存储在此元素上的 shadowRoot，如果关闭则返回 null。 |
| [StitchTiles](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/stitchtiles/) { get; } | 对应于给定“feTurbulence”元素上的属性“stitchTiles”。采用在此接口上定义的 SVG_STITCHTYPE_* 常量之一。 |
...
| [Type](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/type/) { get; } | 对应于给定“feTurbulence”元素上的属性“type”。采用在此接口上定义的 SVG_TURBULENCE_TYPE_* 常量之一。 |
| [ViewportElement](../../aspose.html.dom.svg/svgelement/viewportelement/) { get; } | 建立当前视口的元素。通常，最近的祖先“svg”元素。如果给定元素是最外层的 svg 元素，则为空。 |
| [Width](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/width/) { get; } | 对应于给定“过滤器”元素上的属性“宽度”。 |
| [X](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/x/) { get; } | 对应于给定“过滤器”元素上的属性“x”。 |
| [Y](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/y/) { get; } | 对应于给定“过滤器”元素上的属性“y”。 |
...
| 姓名 | 描述 |
| --- | --- |
| const [SVG_STITCHTYPE_NOSTITCH](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_stitchtype_nostitch/) | 对应于值“noStitch”。 |
| const [SVG_STITCHTYPE_STITCH](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_stitchtype_stitch/) | 对应值 'stitch'. |
| const [SVG_STITCHTYPE_UNKNOWN](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_stitchtype_unknown/) | 该类型不是预定义类型之一。尝试定义此类型的新值或尝试将现有值切换为此类型是无效的。 |
| const [SVG_TURBULENCE_TYPE_FRACTALNOISE](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_turbulence_type_fractalnoise/) | 对应于值 'fractalNoise'. |
| const [SVG_TURBULENCE_TYPE_TURBULENCE](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_turbulence_type_turbulence/) | 对应于值“湍流”. |
| const [SVG_TURBULENCE_TYPE_UNKNOWN](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_turbulence_type_unknown/) | 该类型不是预定义类型之一。尝试定义此类型的新值或尝试将现有值切换为此类型是无效的。 |
