...
description: Aspose.Html.Dom.Svg.Filters.SVGFEConvolveMatrixElement 班级. SVGFEConvolveMatrixElement 接口对应于feConvolveMatrix元素
type: docs
weight: 1400
url: /zh/net/aspose.html.dom.svg.filters/svgfeconvolvematrixelement/
---
...
| [Bias](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/bias/) { get; } | 对应于给定“feConvolveMatrix”元素上的属性“bias”。 |
...
| [Divisor](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/divisor/) { get; } | 对应于给定“feConvolveMatrix”元素上的属性“除数”。 |
| [EdgeMode](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/edgemode/) { get; } | 对应于给定“feConvolveMatrix”元素上的属性“edgeMode”。 |
...
| [Height](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/height/) { get; } | 对应于给定“过滤器”元素上的属性“高度”。 |
| [Id](../../aspose.html.dom.svg/svgelement/id/) { get; set; } | 给定元素上“id”属性的值，如果“id”不存在则为空字符串。 |
| [In1](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/in1/) { get; } | 对应于给定“feConvolveMatrix”元素上的属性“in”。 |
| [InnerHTML](../../aspose.html.dom/element/innerhtml/) { get; set; } | 返回表示元素内容的 HTML 或 XML 片段。 可以设置，用从给定字符串解析的节点替换元素的内容。 |
| [KernelMatrix](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelmatrix/) { get; } | 对应于给定“feConvolveMatrix”元素上的属性“kernelMatrix”。 |
| [KernelUnitLengthX](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelunitlengthx/) { get; } | 对应于给定“feConvolveMatrix”元素上的属性“kernelUnitLength”。 |
| [KernelUnitLengthY](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelunitlengthy/) { get; } | 对应于给定“feConvolveMatrix”元素上的属性“kernelUnitLength”。 |
...
| [OrderX](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/orderx/) { get; } | 对应于给定“feConvolveMatrix”元素上的属性“order”。 |
| [OrderY](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/ordery/) { get; } | 对应于给定“feConvolveMatrix”元素上的属性“order”。 |
...
| [PreserveAlpha](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/preservealpha/) { get; } | 对应于给定“feConvolveMatrix”元素上的属性“preserveAlpha”。 |
...
| [Result](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/result/) { get; } | 对应于给定“过滤器”元素上的属性“结果”。 |
...
| [TargetX](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/targetx/) { get; } | 对应于给定“feConvolveMatrix”元素上的属性“targetX”。 |
| [TargetY](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/targety/) { get; } | 对应于给定“feConvolveMatrix”元素上的属性“targetY”。 |
...
| [Width](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/width/) { get; } | 对应于给定“过滤器”元素上的属性“宽度”。 |
| [X](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/x/) { get; } | 对应于给定“过滤器”元素上的属性“x”。 |
| [Y](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/y/) { get; } | 对应于给定“过滤器”元素上的属性“y”。 |
...
| 姓名 | 描述 |
| --- | --- |
| const [SVG_EDGEMODE_DUPLICATE](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_duplicate/) | 对应于值 'duplicate'. |
| const [SVG_EDGEMODE_NONE](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_none/) | 对应于值“无”。 |
| const [SVG_EDGEMODE_UNKNOWN](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_unknown/) | 该类型不是预定义类型之一。尝试定义此类型的新值或尝试将现有值切换为此类型是无效的。 |
| const [SVG_EDGEMODE_WRAP](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_wrap/) | 对应于值 'wrap'. |
