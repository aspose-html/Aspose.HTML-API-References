...
description: Aspose.Html.Dom.Svg.Filters.SVGFEMorphologyElement 班级. SVGFEMorphologyElement 接口对应于feMorphology元素
type: docs
weight: 1540
url: /zh/net/aspose.html.dom.svg.filters/svgfemorphologyelement/
---
...
| [Height](../../aspose.html.dom.svg.filters/svgfemorphologyelement/height/) { get; } | 对应于给定“过滤器”元素上的属性“高度”。 |
| [Id](../../aspose.html.dom.svg/svgelement/id/) { get; set; } | 给定元素上“id”属性的值，如果“id”不存在则为空字符串。 |
| [In1](../../aspose.html.dom.svg.filters/svgfemorphologyelement/in1/) { get; } | 对应于给定“feMorphology”元素上的属性“in”。 |
...
| [Operator](../../aspose.html.dom.svg.filters/svgfemorphologyelement/operator/) { get; } | 对应于给定“feMorphology”元素上的属性“operator”。采用在此接口上定义的 SVG_MORPHOLOGY_OPERATOR_* 常量之一。 |
...
| [RadiusX](../../aspose.html.dom.svg.filters/svgfemorphologyelement/radiusx/) { get; } | 对应于给定“feMorphology”元素上的属性“radius”。 |
| [RadiusY](../../aspose.html.dom.svg.filters/svgfemorphologyelement/radiusy/) { get; } | 对应于给定“feMorphology”元素上的属性“radius”。 |
| [Result](../../aspose.html.dom.svg.filters/svgfemorphologyelement/result/) { get; } | 对应于给定“过滤器”元素上的属性“结果”。 |
...
| [Width](../../aspose.html.dom.svg.filters/svgfemorphologyelement/width/) { get; } | 对应于给定“过滤器”元素上的属性“宽度”。 |
| [X](../../aspose.html.dom.svg.filters/svgfemorphologyelement/x/) { get; } | 对应于给定“过滤器”元素上的属性“x”。 |
| [Y](../../aspose.html.dom.svg.filters/svgfemorphologyelement/y/) { get; } | 对应于给定“过滤器”元素上的属性“y”。 |
...
| 姓名 | 描述 |
| --- | --- |
| const [SVG_MORPHOLOGY_OPERATOR_DILATE](../../aspose.html.dom.svg.filters/svgfemorphologyelement/svg_morphology_operator_dilate/) | 对应于值 'dilate'. |
| const [SVG_MORPHOLOGY_OPERATOR_ERODE](../../aspose.html.dom.svg.filters/svgfemorphologyelement/svg_morphology_operator_erode/) | 对应于值 'erode'. |
| const [SVG_MORPHOLOGY_OPERATOR_UNKNOWN](../../aspose.html.dom.svg.filters/svgfemorphologyelement/svg_morphology_operator_unknown/) | 该类型不是预定义类型之一。尝试定义此类型的新值或尝试将现有值切换为此类型是无效的。 |
