...
description: SVGFEColorMatrixElement 接口对应于 feColorMatrix 元素
type: docs
weight: 1480
...
| [Height](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/height) { get; } | 对应于给定“过滤器”元素的属性“高度”。 |
...
| [Result](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/result) { get; } | 对应于给定“过滤器”元素的属性“结果”。 |
...
| [Type](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/type) { get; } | 对应于给定 'feColorMatrix' 元素的属性 'type'。采用在此接口上定义的 SVG_FECOLORMATRIX_TYPE_* 常量之一。 |
| [Values](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/values) { get; } | 对应于给定 'feColorMatrix' 元素上的属性 'values'。 |
| [ViewportElement](../../aspose.html.dom.svg/svgelement/viewportelement) { get; } | 建立当前视口的元素。通常，最近的祖先 'svg' 元素。如果给定元素是最外层的 svg 元素，则为 Null。 |
| [Width](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/width) { get; } | 对应于给定“过滤器”元素的属性“宽度”。 |
| [X](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/x) { get; } | 对应于给定“过滤器”元素的属性“x”。 |
| [Y](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/y) { get; } | 对应于给定 'filter' 元素上的属性 'y'。 |
...
| const [SVG_FECOLORMATRIX_TYPE_UNKNOWN](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_unknown) | 该类型不是预定义类型之一。尝试定义此类型的新值或尝试将现有值切换到此类型是无效的。 |
