...
description: Aspose.Html.Dom.Svg.SVGSetElement 班级. SVGSetElement 接口对应于set元素 通过 SVG DOM 对set元素的属性进行面向对象的访问不可用
type: docs
weight: 2280
...
SVGSetElement 接口对应于“set”元素。 通过 SVG DOM 对“set”元素的属性进行面向对象的访问不可用。
