...
description: SVGSetElement 接口对应于 set 元素 无法通过 SVG DOM 对set元素的属性进行面向对象的访问
type: docs
weight: 2390
url: /zh/net/aspose.html.dom.svg/svgsetelement/
---
## SVGSetElement class

SVGSetElement 接口对应于 'set' 元素。 无法通过 SVG DOM 对“set”元素的属性进行面向对象的访问。
