...
description: Aspose.Html.Dom.Svg.SVGComponentTransferFunctionElement 班级. 该接口定义了组件传递函数接口使用的基本接口
type: docs
weight: 1970
url: /zh/net/aspose.html.dom.svg/svgcomponenttransferfunctionelement/
---
## SVGComponentTransferFunctionElement class

该接口定义了组件传递函数接口使用的基本接口。
...
| 姓名 | 描述 |
| --- | --- |
| [Amplitude](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/amplitude/) { get; } | 对应于给定元素上的属性“振幅”。 |
...
| [Exponent](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/exponent/) { get; } | 对应于给定元素上的属性“指数”。 |
...
| [Intercept](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/intercept/) { get; } | 对应于给定元素上的属性“拦截”。 |
...
| [Offset](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/offset/) { get; } | 对应于给定元素上的属性“偏移量”。 |
...
| [Slope](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/slope/) { get; } | 对应于给定元素上的属性“斜率”。 |
| [Style](../../aspose.html.dom.svg/svgelement/style/) { get; } | 对应于给定元素上的属性“样式”。如果用户代理不支持 CSS 样式，则此属性的值必须始终为 null. |
| [TableValues](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/tablevalues/) { get; } | 对应于给定元素上的属性“tableValues”。 |
...
| [Type](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/type/) { get; } | 对应于给定元素上的属性“类型”。采用在此接口上定义的 SVG_FECOMPONENTTRANSFER_TYPE_* 常量之一。 |
...
| 姓名 | 描述 |
| --- | --- |
| const [SVG_FECOMPONENTTRANSFER_TYPE_DISCRETE](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_discrete/) | 对应于值 'discrete'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_GAMMA](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_gamma/) | 对应于值 'gamma'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_IDENTITY](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_identity/) | 对应值 'identity'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_LINEAR](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_linear/) | 对应于值“线性”。 |
| const [SVG_FECOMPONENTTRANSFER_TYPE_TABLE](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_table/) | 对应值 'table'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_UNKNOWN](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_unknown/) | 该类型不是预定义类型之一。尝试定义此类型的新值或尝试将现有值切换为此类型是无效的。 |
