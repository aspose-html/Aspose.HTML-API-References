...
description: Aspose.Html.Dom.Svg.SVGElement 班级. 所有直接对应于 SVG 语言元素的 SVG DOM 接口例如路径元素的 SVGPathElement 接口都派生自 SVGElement 接口
type: docs
weight: 2020
url: /zh/net/aspose.html.dom.svg/svgelement/
---
## SVGElement class

所有直接对应于 SVG 语言元素的 SVG DOM 接口（例如“路径”元素的 SVGPathElement 接口）都派生自 SVGElement 接口。
