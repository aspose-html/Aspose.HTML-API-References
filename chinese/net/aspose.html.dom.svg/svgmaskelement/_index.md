...
description: SVGMaskElement 接口对应于 mask 元素
type: docs
weight: 2280
...
| [Height](../../aspose.html.dom.svg/svgmaskelement/height) { get; } | 对应于给定 'mask' 元素的属性 'height'。采用 SVGUnitTypes 中定义的常量之一。 |
...
| [Width](../../aspose.html.dom.svg/svgmaskelement/width) { get; } | 对应于给定 'mask' 元素上的属性 'width'。采用 SVGUnitTypes 中定义的常量之一。 |
| [X](../../aspose.html.dom.svg/svgmaskelement/x) { get; } | 对应于给定 'mask' 元素上的属性 'x'。采用 SVGUnitTypes 中定义的常量之一。 |
| [Y](../../aspose.html.dom.svg/svgmaskelement/y) { get; } | 对应于给定 'mask' 元素上的属性 'y'。采用 SVGUnitTypes 中定义的常量之一。 |
