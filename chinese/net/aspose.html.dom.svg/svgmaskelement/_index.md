...
description: Aspose.Html.Dom.Svg.SVGMaskElement 班级. SVGMaskElement 接口对应于mask元素
type: docs
weight: 2170
url: /zh/net/aspose.html.dom.svg/svgmaskelement/
---
...
| [Height](../../aspose.html.dom.svg/svgmaskelement/height/) { get; } | 对应于给定“掩码”元素上的属性“高度”。采用 SVGUnitTypes. 中定义的常量之一 |
...
| [MaskContentUnits](../../aspose.html.dom.svg/svgmaskelement/maskcontentunits/) { get; } | 对应于给定“mask”元素上的属性“maskContentUnits”。采用 SVGUnitTypes. 中定义的常量之一 |
| [MaskUnits](../../aspose.html.dom.svg/svgmaskelement/maskunits/) { get; } | 对应于给定“mask”元素上的属性“maskUnits”。采用 SVGUnitTypes. 中定义的常量之一 |
...
| [RequiredExtensions](../../aspose.html.dom.svg/svgmaskelement/requiredextensions/) { get; } | 对应于给定元素上的属性“requiredExtensions”。 |
| [RequiredFeatures](../../aspose.html.dom.svg/svgmaskelement/requiredfeatures/) { get; } | 对应于给定元素上的属性“requiredFeatures”。 |
...
| [SystemLanguage](../../aspose.html.dom.svg/svgmaskelement/systemlanguage/) { get; } | 对应于给定元素上的属性“systemLanguage”。 |
...
| [Width](../../aspose.html.dom.svg/svgmaskelement/width/) { get; } | 对应于给定“掩码”元素上的属性“宽度”。采用 SVGUnitTypes. 中定义的常量之一 |
| [X](../../aspose.html.dom.svg/svgmaskelement/x/) { get; } | 对应于给定“掩码”元素上的属性“x”。采用 SVGUnitTypes. 中定义的常量之一 |
| [Y](../../aspose.html.dom.svg/svgmaskelement/y/) { get; } | 对应于给定“掩码”元素上的属性“y”。采用 SVGUnitTypes. 中定义的常量之一 |
