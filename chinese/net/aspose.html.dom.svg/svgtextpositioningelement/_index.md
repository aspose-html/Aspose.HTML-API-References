...
description: SVGTextPositioningElement 接口由与文本相关的接口继承SVGTextElementSVGTSpanElementSVGTRefElement 和 SVGAltGlyphElement
type: docs
weight: 2480
...
SVGTextPositioningElement 接口由与文本相关的接口继承:SVGTextElement、SVGTSpanElement、SVGTRefElement 和 SVGAltGlyphElement。
...
| [Dx](../../aspose.html.dom.svg/svgtextpositioningelement/dx) { get; } | 对应于给定元素的属性“dx”。 |
| [Dy](../../aspose.html.dom.svg/svgtextpositioningelement/dy) { get; } | 对应于给定元素的属性“dy”。 |
...
| [Rotate](../../aspose.html.dom.svg/svgtextpositioningelement/rotate) { get; } | 对应于给定元素的属性“旋转”。 |
...
| [X](../../aspose.html.dom.svg/svgtextpositioningelement/x) { get; } | 对应于给定元素的属性“x”。 |
| [Y](../../aspose.html.dom.svg/svgtextpositioningelement/y) { get; } | 对应于给定元素的属性“y”。 |
