...
description: SVGAnimateTransformElement 接口对应于 animateTransform 元素 无法通过 SVG DOM 对animateTransform元素的属性进行面向对象的访问
type: docs
weight: 2040
...
SVGAnimateTransformElement 接口对应于 'animateTransform' 元素。 无法通过 SVG DOM 对“animateTransform”元素的属性进行面向对象的访问。
