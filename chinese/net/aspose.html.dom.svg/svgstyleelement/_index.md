...
description: Aspose.Html.Dom.Svg.SVGStyleElement 班级. SVGStyleElement 接口对应于style元素
type: docs
weight: 2300
url: /zh/net/aspose.html.dom.svg/svgstyleelement/
---
...
| [Media](../../aspose.html.dom.svg/svgstyleelement/media/) { get; set; } | 对应于给定元素上的属性“媒体”。 |
...
| [Sheet](../../aspose.html.dom.svg/svgstyleelement/sheet/) { get; } | 获取关联的样式表。 |
...
| [Title](../../aspose.html.dom.svg/svgstyleelement/title/) { get; set; } | 对应于给定元素上的属性“title”。 |
| [Type](../../aspose.html.dom.svg/svgstyleelement/type/) { get; set; } | 对应于给定元素上的属性“类型”。 |
