...
description: SVGPathElement 方法. 返回一个独立的无父项的 SVGPathSegLinetoHorizontalAbs 对象
type: docs
weight: 150
...
返回一个独立的、无父项的 SVGPathSegLinetoHorizontalAbs 对象。
...
一个独立的、无父项的 SVGPathSegLinetoHorizontalAbs 对象。
