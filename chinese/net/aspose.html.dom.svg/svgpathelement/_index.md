...
description: Aspose.Html.Dom.Svg.SVGPathElement 班级. SVGPathElement 接口对应于路径元素
type: docs
weight: 2190
...
| 姓名 | 描述 |
| --- | --- |
| [AnimatedPathSegList](../../aspose.html.dom.svg/svgpathelement/animatedpathseglist/) { get; } | 以与 SVG 语法一对一匹配的形式提供对“d”属性的当前动画内容的访问。如果给定的属性或属性正在动画，则包含属性或属性的当前动画值，并且对象本身及其内容都是只读的。如果给定的属性或属性当前未进行动画处理，则包含与 pathSegList. 相同的值 |
...
| [PathSegList](../../aspose.html.dom.svg/svgpathelement/pathseglist/) { get; set; } | 以与 SVG 语法一对一匹配的形式提供对“d”属性的基本（即静态）内容的访问。 因此，如果“d”属性具有“绝对移动 (M)”和“绝对弧转 (A)”命令，则 pathSegList 将具有两个条目：SVG_PATHSEG_MOVETO_ABS 和 SVG_PATHSEG_ARC_ABS。 |
...
| [CreateSVGPathSegArcAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegarcabs/)(float, float, float, float, float, bool, bool) | 返回一个独立的、无父项的 SVGPathSegArcAbs 对象。 |
| [CreateSVGPathSegArcRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegarcrel/)(float, float, float, float, float, bool, bool) | 返回一个独立的、无父项的 SVGPathSegArcRel 对象。 |
| [CreateSVGPathSegClosePath](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegclosepath/)() | 返回一个独立的、无父项的 SVGPathSegClosePath 对象。 |
| [CreateSVGPathSegCurvetoCubicAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicabs/)(float, float, float, float, float, float) | 返回一个独立的、无父项的 SVGPathSegCurvetoCubicAbs 对象。 |
| [CreateSVGPathSegCurvetoCubicRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicrel/)(float, float, float, float, float, float) | 返回一个独立的、无父项的 SVGPathSegCurvetoCubicRel 对象。 |
| [CreateSVGPathSegCurvetoCubicSmoothAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothabs/)(float, float, float, float) | 返回一个独立的、无父项的 SVGPathSegCurvetoCubicSmoothAbs 对象。 |
| [CreateSVGPathSegCurvetoCubicSmoothRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothrel/)(float, float, float, float) | 返回一个独立的、无父项的 SVGPathSegCurvetoCubicSmoothRel 对象。 |
| [CreateSVGPathSegCurvetoQuadraticAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticabs/)(float, float, float, float) | 返回一个独立的、无父项的 SVGPathSegCurvetoQuadraticAbs 对象。 |
| [CreateSVGPathSegCurvetoQuadraticRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticrel/)(float, float, float, float) | 返回一个独立的、无父项的 SVGPathSegCurvetoQuadraticRel 对象。 |
| [CreateSVGPathSegCurvetoQuadraticSmoothAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothabs/)(float, float) | 返回一个独立的、无父项的 SVGPathSegCurvetoQuadraticSmoothAbs 对象。 |
| [CreateSVGPathSegCurvetoQuadraticSmoothRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothrel/)(float, float) | 返回一个独立的、无父项的 SVGPathSegCurvetoQuadraticSmoothRel 对象。 |
| [CreateSVGPathSegLinetoAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoabs/)(float, float) | 返回一个独立的、无父项的 SVGPathSegLinetoAbs 对象。 |
| [CreateSVGPathSegLinetoHorizontalAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetohorizontalabs/)(float) | 返回一个独立的、无父项的 SVGPathSegLinetoHorizontalAbs 对象。 |
| [CreateSVGPathSegLinetoHorizontalRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetohorizontalrel/)(float) | 返回一个独立的、无父项的 SVGPathSegLinetoHorizontalRel 对象。 |
| [CreateSVGPathSegLinetoRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetorel/)(float, float) | 返回一个独立的、无父项的 SVGPathSegLinetoRel 对象。 |
| [CreateSVGPathSegLinetoVerticalAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoverticalabs/)(float) | 返回一个独立的、无父项的 SVGPathSegLinetoVerticalAbs 对象。 |
| [CreateSVGPathSegLinetoVerticalRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoverticalrel/)(float) | 返回一个独立的、无父项的 SVGPathSegLinetoVerticalRel 对象。 |
| [CreateSVGPathSegMovetoAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegmovetoabs/)(float, float) | 返回一个独立的、无父项的 SVGPathSegMovetoAbs 对象。 |
| [CreateSVGPathSegMovetoRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegmovetorel/)(float, float) | 返回一个独立的、无父项的 SVGPathSegMovetoRel 对象。 |
