...
description: SVGPathElement 接口对应于path元素
type: docs
weight: 2300
url: /zh/net/aspose.html.dom.svg/svgpathelement/
---
...
| 姓名 | 描述 |
| --- | --- |
| [AnimatedPathSegList](../../aspose.html.dom.svg/svgpathelement/animatedpathseglist) { get; } | 以与 SVG 语法一对一匹配的形式提供对“d”属性的当前动画内容的访问。如果给定的属性或属性正在动画，则包含属性或属性的当前动画值，并且对象本身及其内容都是只读的。如果给定的属性或属性当前没有被动画化，则包含与 pathSegList 相同的值。 |
...
| [PathLength](../../aspose.html.dom.svg/svggeometryelement/pathlength) { get; } | 对应于给定元素的属性 pathLength。 |
| [PathSegList](../../aspose.html.dom.svg/svgpathelement/pathseglist) { get; set; } | 以与 SVG 语法一对一匹配的形式提供对“d”属性的基本（即静态）内容的访问。 因此，如果 'd' 属性有一个“absolute moveto (M)”和一个“absolute arcto (A)”命令，那么 pathSegList 将有两个条目:一个 SVG_PATHSEG_MOVETO_ABS 和一个 SVG_PATHSEG_ARC_ABS。 |
...
| [CreateSVGPathSegArcAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegarcabs)(float, float, float, float, float, bool, bool) | 返回一个独立的、无父对象的 SVGPathSegArcAbs 对象。 |
| [CreateSVGPathSegArcRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegarcrel)(float, float, float, float, float, bool, bool) | 返回一个独立的、无父对象的 SVGPathSegArcRel 对象。 |
| [CreateSVGPathSegClosePath](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegclosepath)() | 返回一个独立的、无父对象的 SVGPathSegClosePath 对象。 |
| [CreateSVGPathSegCurvetoCubicAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicabs)(float, float, float, float, float, float) | 返回一个独立的、无父对象的 SVGPathSegCurvetoCubicAbs 对象。 |
| [CreateSVGPathSegCurvetoCubicRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicrel)(float, float, float, float, float, float) | 返回一个独立的、无父对象的 SVGPathSegCurvetoCubicRel 对象。 |
| [CreateSVGPathSegCurvetoCubicSmoothAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothabs)(float, float, float, float) | 返回一个独立的无父 SVGPathSegCurvetoCubicSmoothAbs 对象。 |
| [CreateSVGPathSegCurvetoCubicSmoothRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothrel)(float, float, float, float) | 返回一个独立的、无父对象的 SVGPathSegCurvetoCubicSmoothRel 对象。 |
| [CreateSVGPathSegCurvetoQuadraticAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticabs)(float, float, float, float) | 返回一个独立的、无父对象的 SVGPathSegCurvetoQuadraticAbs 对象。 |
| [CreateSVGPathSegCurvetoQuadraticRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticrel)(float, float, float, float) | 返回一个独立的、无父对象的 SVGPathSegCurvetoQuadraticRel 对象。 |
| [CreateSVGPathSegCurvetoQuadraticSmoothAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothabs)(float, float) | 返回一个独立的、无父对象的 SVGPathSegCurvetoQuadraticSmoothAbs 对象。 |
| [CreateSVGPathSegCurvetoQuadraticSmoothRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothrel)(float, float) | 返回一个独立的无父 SVGPathSegCurvetoQuadraticSmoothRel 对象。 |
| [CreateSVGPathSegLinetoAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoabs)(float, float) | 返回一个独立的、无父对象的 SVGPathSegLinetoAbs 对象。 |
| [CreateSVGPathSegLinetoHorizontalAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetohorizontalabs)(float) | 返回一个独立的、无父对象的 SVGPathSegLinetoHorizontalAbs 对象。 |
| [CreateSVGPathSegLinetoHorizontalRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetohorizontalrel)(float) | 返回一个独立的、无父对象的 SVGPathSegLinetoHorizontalRel 对象。 |
| [CreateSVGPathSegLinetoRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetorel)(float, float) | 返回一个独立的、无父对象的 SVGPathSegLinetoRel 对象。 |
| [CreateSVGPathSegLinetoVerticalAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoverticalabs)(float) | 返回一个独立的、无父对象的 SVGPathSegLinetoVerticalAbs 对象。 |
| [CreateSVGPathSegLinetoVerticalRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoverticalrel)(float) | 返回一个独立的、无父对象的 SVGPathSegLinetoVerticalRel 对象。 |
| [CreateSVGPathSegMovetoAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegmovetoabs)(float, float) | 返回一个独立的、无父对象的 SVGPathSegMovetoAbs 对象。 |
| [CreateSVGPathSegMovetoRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegmovetorel)(float, float) | 返回一个独立的、无父对象的 SVGPathSegMovetoRel 对象。 |
...
| [GetPointAtLength](../../aspose.html.dom.svg/svggeometryelement/getpointatlength)(float) | 返回用户空间中的 (x,y) 坐标，它是沿路径的距离单位，利用用户代理的距离沿路径算法。 |
...
| [GetTotalLength](../../aspose.html.dom.svg/svggeometryelement/gettotallength)() | 返回用户代理使用用户代理的路径距离算法计算的路径总长度值，作为当前用户坐标系中的距离. |
