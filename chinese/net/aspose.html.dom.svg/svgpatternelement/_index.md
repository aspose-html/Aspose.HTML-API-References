...
description: Aspose.Html.Dom.Svg.SVGPatternElement 班级. SVGPatternElement 接口对应于模式元素
type: docs
weight: 2200
url: /zh/net/aspose.html.dom.svg/svgpatternelement/
---
## SVGPatternElement class

SVGPatternElement 接口对应于“模式”元素。
...
| [Height](../../aspose.html.dom.svg/svgpatternelement/height/) { get; } | 对应于给定“模式”元素上的属性“高度”。 |
| [Href](../../aspose.html.dom.svg/svgpatternelement/href/) { get; } | 对应于给定元素上的属性“xlink:href”。 |
...
| [PatternContentUnits](../../aspose.html.dom.svg/svgpatternelement/patterncontentunits/) { get; } | 对应于给定“模式”元素上的属性“patternContentUnits”。采用 SVGUnitTypes. 中定义的常量之一 |
| [PatternTransform](../../aspose.html.dom.svg/svgpatternelement/patterntransform/) { get; } | 对应于给定“模式”元素上的属性“patternTransform”。 |
| [PatternUnits](../../aspose.html.dom.svg/svgpatternelement/patternunits/) { get; } | 对应于给定“pattern”元素上的属性“patternUnits”。采用 SVGUnitTypes. 中定义的常量之一 |
| override [Prefix](../../aspose.html.dom/element/prefix/) { get; } | 此节点的名称空间前缀，如果未指定则为 null。定义为null时，设置无效 |
| [PreserveAspectRatio](../../aspose.html.dom.svg/svgpatternelement/preserveaspectratio/) { get; } | 对应于给定元素上的属性“preserveAspectRatio”。 |
...
| [RequiredExtensions](../../aspose.html.dom.svg/svgpatternelement/requiredextensions/) { get; } | 对应于给定元素上的属性“requiredExtensions”。 |
| [RequiredFeatures](../../aspose.html.dom.svg/svgpatternelement/requiredfeatures/) { get; } | 对应于给定元素上的属性“requiredFeatures”。 |
...
| [SystemLanguage](../../aspose.html.dom.svg/svgpatternelement/systemlanguage/) { get; } | 对应于给定元素上的属性“systemLanguage”。 |
...
| [ViewBox](../../aspose.html.dom.svg/svgpatternelement/viewbox/) { get; } | 对应于给定元素上的属性“viewBox”。 |
| [ViewportElement](../../aspose.html.dom.svg/svgelement/viewportelement/) { get; } | 建立当前视口的元素。通常，最近的祖先“svg”元素。如果给定元素是最外层的 svg 元素，则为空。 |
| [Width](../../aspose.html.dom.svg/svgpatternelement/width/) { get; } | 对应于给定“模式”元素上的属性“宽度”。 |
| [X](../../aspose.html.dom.svg/svgpatternelement/x/) { get; } | 对应于给定“模式”元素上的属性“x”。 |
| [Y](../../aspose.html.dom.svg/svgpatternelement/y/) { get; } | 对应于给定“模式”元素上的属性“y”。 |
