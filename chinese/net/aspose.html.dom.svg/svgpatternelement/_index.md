...
description: SVGPatternElement 接口对应于 pattern 元素
type: docs
weight: 2310
...
| [Height](../../aspose.html.dom.svg/svgpatternelement/height) { get; } | 对应于给定 'pattern' 元素的属性 'height'。 |
...
| [PatternContentUnits](../../aspose.html.dom.svg/svgpatternelement/patterncontentunits) { get; } | 对应于给定 'pattern' 元素上的属性 'patternContentUnits'。采用 SVGUnitTypes 中定义的常量之一。 |
| [PatternTransform](../../aspose.html.dom.svg/svgpatternelement/patterntransform) { get; } | 对应于给定 'pattern' 元素上的属性 'patternTransform'。 |
...
| [Width](../../aspose.html.dom.svg/svgpatternelement/width) { get; } | 对应于给定 'pattern' 元素的属性 'width'。 |
| [X](../../aspose.html.dom.svg/svgpatternelement/x) { get; } | 对应于给定 'pattern' 元素上的属性 'x'。 |
| [Y](../../aspose.html.dom.svg/svgpatternelement/y) { get; } | 对应于给定 'pattern' 元素上的属性 'y'。 |
