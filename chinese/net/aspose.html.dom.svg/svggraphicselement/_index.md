...
description: Aspose.Html.Dom.Svg.SVGGraphicsElement 班级. SVGGraphicsElement 接口表示 SVG 元素其主要目的是直接将图形渲染到一个组中
type: docs
weight: 2110
url: /zh/net/aspose.html.dom.svg/svggraphicselement/
---
## SVGGraphicsElement class

SVGGraphicsElement 接口表示 SVG 元素，其主要目的是直接将图形渲染到一个组中。
