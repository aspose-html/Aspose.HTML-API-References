...
description: Aspose.Html.Dom.Svg.SVGGradientElement 班级. SVGGradientElement 接口是 SVGLinearGradientElement 和 SVGRadialGradientElement 使用的基础接口
type: docs
weight: 2100
url: /zh/net/aspose.html.dom.svg/svggradientelement/
---
...
| 姓名 | 描述 |
| --- | --- |
| const [SVG_SPREADMETHOD_PAD](../../aspose.html.dom.svg/svggradientelement/svg_spreadmethod_pad/) | 对应于值 'pad'. |
| const [SVG_SPREADMETHOD_REFLECT](../../aspose.html.dom.svg/svggradientelement/svg_spreadmethod_reflect/) | 对应值 'reflect'. |
| const [SVG_SPREADMETHOD_REPEAT](../../aspose.html.dom.svg/svggradientelement/svg_spreadmethod_repeat/) | 对应值 'repeat'. |
| const [SVG_SPREADMETHOD_UNKNOWN](../../aspose.html.dom.svg/svggradientelement/svg_spreadmethod_unknown/) | 该类型不是预定义类型之一。尝试定义此类型的新值或尝试将现有值切换为此类型是无效的。 |
