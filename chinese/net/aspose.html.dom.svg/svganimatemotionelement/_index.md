...
description: Aspose.Html.Dom.Svg.SVGAnimateMotionElement 班级. SVGAnimateMotionElement 接口对应于animateMotion元素 无法通过 SVG DOM 面向对象访问animateMotion元素的属性
type: docs
weight: 1920
...
SVGAnimateMotionElement 接口对应于“animateMotion”元素。 无法通过 SVG DOM 面向对象访问“animateMotion”元素的属性。
