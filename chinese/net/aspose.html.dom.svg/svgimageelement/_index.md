...
description: SVGImageElement 接口对应于 image 元素
type: docs
weight: 2230
...
| [Height](../../aspose.html.dom.svg/svgimageelement/height) { get; } | 对应于给定 'image' 元素的属性 'height'。 |
...
| [PreserveAspectRatio](../../aspose.html.dom.svg/svgimageelement/preserveaspectratio) { get; } | 对应于给定 'image' 元素上的属性 'preserveAspectRatio'。 |
...
| [Width](../../aspose.html.dom.svg/svgimageelement/width) { get; } | 对应于给定 'image' 元素的属性 'width'。 |
| [X](../../aspose.html.dom.svg/svgimageelement/x) { get; } | 对应于给定 'image' 元素上的属性 'x'。 |
| [Y](../../aspose.html.dom.svg/svgimageelement/y) { get; } | 对应于给定 'image' 元素上的属性 'y'。 |
