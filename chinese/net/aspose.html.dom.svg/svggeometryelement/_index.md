...
description: 接口 SVGGeometryElement 表示 SVG 元素其渲染由具有等效路径的几何定义并且可以填充和描边这包括路径和基本形状
type: docs
weight: 2200
url: /zh/net/aspose.html.dom.svg/svggeometryelement/
---
## SVGGeometryElement class

接口 SVGGeometryElement 表示 SVG 元素，其渲染由具有等效路径的几何定义，并且可以填充和描边。这包括路径和基本形状。
