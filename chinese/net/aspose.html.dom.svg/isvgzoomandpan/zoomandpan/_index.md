...
description: ISVGZoomAndPan 财产. 对应于给定元素上的属性zoomAndPan该值必须是在此接口上定义的 SVG_ZOOMANDPAN_ 常量之一
type: docs
weight: 10
url: /zh/net/aspose.html.dom.svg/isvgzoomandpan/zoomandpan/
---
## ISVGZoomAndPan.ZoomAndPan property

对应于给定元素上的属性“zoomAndPan”。该值必须是在此接口上定义的 SVG_ZOOMANDPAN_* 常量之一。
...
* 命名空间 [Aspose.Html.Dom.Svg](../../isvgzoomandpan/)
* 部件 [Aspose.HTML](../../../)
