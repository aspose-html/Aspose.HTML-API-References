...
description: SVGFilterElement 接口对应于 filter 元素
type: docs
weight: 2170
...
| [Height](../../aspose.html.dom.svg/svgfilterelement/height) { get; } | 对应于给定“过滤器”元素的属性“高度”。 |
...
| [PrimitiveUnits](../../aspose.html.dom.svg/svgfilterelement/primitiveunits) { get; } | 对应于给定 'filter' 元素上的属性 'primitiveUnits'。采用 SVGUnitTypes 中定义的常量之一。 |
...
| [Width](../../aspose.html.dom.svg/svgfilterelement/width) { get; } | 对应于给定“过滤器”元素的属性“宽度”。 |
| [X](../../aspose.html.dom.svg/svgfilterelement/x) { get; } | 对应于给定“过滤器”元素的属性“x”。 |
| [Y](../../aspose.html.dom.svg/svgfilterelement/y) { get; } | 对应于给定 'filter' 元素上的属性 'y'。 |
