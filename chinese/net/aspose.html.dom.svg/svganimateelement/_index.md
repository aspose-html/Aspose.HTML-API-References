...
description: SVGAnimateElement 接口对应于 animate 元素 无法通过 SVG DOM 对animate元素的属性进行面向对象的访问
type: docs
weight: 2020
url: /zh/net/aspose.html.dom.svg/svganimateelement/
---
## SVGAnimateElement class

SVGAnimateElement 接口对应于 'animate' 元素。 无法通过 SVG DOM 对“animate”元素的属性进行面向对象的访问。
