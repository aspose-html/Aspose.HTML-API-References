...
description: Aspose.Html.Dom.Svg.SVGAnimateElement 班级. SVGAnimateElement 接口对应于animate元素 无法通过 SVG DOM 面向对象访问animate元素的属性
type: docs
weight: 1910
...
SVGAnimateElement 接口对应于“animate”元素。 无法通过 SVG DOM 面向对象访问“animate”元素的属性。
