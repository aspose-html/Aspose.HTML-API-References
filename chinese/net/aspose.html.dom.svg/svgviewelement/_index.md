...
description: SVGViewElement 接口对应于 view 元素
type: docs
weight: 2520
...
| [ViewTarget](../../aspose.html.dom.svg/svgviewelement/viewtarget) { get; } | 对应于给定“view”元素的属性“viewTarget”。包含在“viewTarget”属性中列出的名称的 DOMString 值列表。每个 DOMString 值都可以使用 getElementById() 方法调用与相应的元素相关联。 |
| [ZoomAndPan](../../aspose.html.dom.svg/svgviewelement/zoomandpan) { get; set; } | 对应于给定元素上的属性“zoomAndPan”。该值必须是此接口上定义的 SVG_ZOOMANDPAN_* 常量之一。 |
