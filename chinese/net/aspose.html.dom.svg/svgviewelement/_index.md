...
description: Aspose.Html.Dom.Svg.SVGViewElement 班级. SVGViewElement 接口对应于视图元素
type: docs
weight: 2410
url: /zh/net/aspose.html.dom.svg/svgviewelement/
---
## SVGViewElement class

SVGViewElement 接口对应于“视图”元素。
...
| [PreserveAspectRatio](../../aspose.html.dom.svg/svgviewelement/preserveaspectratio/) { get; } | 对应于给定元素上的属性“preserveAspectRatio”。 |
...
| [ViewBox](../../aspose.html.dom.svg/svgviewelement/viewbox/) { get; } | 对应于给定元素上的属性“viewBox”。 |
| [ViewportElement](../../aspose.html.dom.svg/svgelement/viewportelement/) { get; } | 建立当前视口的元素。通常，最近的祖先“svg”元素。如果给定元素是最外层的 svg 元素，则为空。 |
| [ViewTarget](../../aspose.html.dom.svg/svgviewelement/viewtarget/) { get; } | 对应于给定“视图”元素上的属性“viewTarget”。 DOMString 值列表，其中包含“viewTarget”属性中列出的名称。每个 DOMString 值都可以使用 getElementById() 方法调用与相应的元素相关联。 |
| [ZoomAndPan](../../aspose.html.dom.svg/svgviewelement/zoomandpan/) { get; set; } | 对应于给定元素上的属性“zoomAndPan”。该值必须是在此接口上定义的 SVG_ZOOMANDPAN_* 常量之一。 |
