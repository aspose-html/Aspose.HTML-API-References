...
| 姓名 | 描述 |
| --- | --- |
| [CSSRules](../../aspose.html.dom.css/icsskeyframesrule/cssrules) { get; } | 此属性允许访问列表中的关键帧 |
...
| 姓名 | 描述 |
| --- | --- |
| [AppendRule](../../aspose.html.dom.css/icsskeyframesrule/appendrule)(string) | appendRule 方法将传递的 CSSKeyframeRule 附加到列表中传递的键 |
| [DeleteRule](../../aspose.html.dom.css/icsskeyframesrule/deleterule)(string) | deleteRule 方法使用传递的键删除 CSSKeyframeRule。如果具有此键的规则不存在，则该方法不执行任何操作 |
