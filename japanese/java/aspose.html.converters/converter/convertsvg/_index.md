...
インラインコンテンツで提示された SVG ソースを XPS に変換します。結果は、[`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) インターフェイス実装によって生成された出力データです。
...
| パラメータ | 型 | 説明 |
| --- | --- | --- |
| コンテンツ | 文字列 | 文字列としてのインライン SVG コンテンツ。 |
...
[`SVGDocument`](../../../com.aspose.html.dom.svg/svgdocument/) で提示された SVG ソースを変換します。結果は、出力ファイルパスで作成された docx ファイルです。
...
| options | DocSaveOptions | [`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/) オブジェクトの使用により、レンダリングプロセスを調整できます。詳細は [Aspose ドキュメント](https://docs.aspose.com/html/net/converting-between-formats/svg-to-docx/#convert-svg-to-docx-using-docsaveoptions) を参照してください。 |
...
[`URL`](../../../com.aspose.html/url/) で提示された SVG ソースを変換します。結果は、出力ファイルパスで作成された docx ファイルです。
...
完全なファイルパスで指定された SVG ソースを DOCX に変換します。結果は、出力ファイルパスで作成された DOCX ファイルです。
...
完全なファイルパスで提示された SVG ソースを DOCX に変換します。結果は、[`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) インターフェイス実装によって生成された出力データです。
...
インラインコンテンツで提示された SVG ソースを DOCX に変換します。結果は、[`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) インターフェイス実装によって生成された出力データです。
...
[`SVGDocument`](../../../com.aspose.html.dom.svg/svgdocument/) で提示された SVG ソースを PDF に変換します。結果は、出力ファイルパスで作成された pdf ファイルです。
...
| --- | --- | --- |
| source | SVGDocument | [`SVGDocument`](../../../com.aspose.html.dom.svg/svgdocument/) で提示された変換ソースです。 |
| options | PdfSaveOptions | [`PdfSaveOptions`](../../../com.aspose.html.saving/pdfsaveoptions/) オブジェクトの使用により、レンダリングプロセスを調整できます。詳細は [Aspose ドキュメント](https://docs.aspose.com/html/net/converting-between-formats/svg-to-pdf/#save-options) を参照してください。 |
...
[記事](https://docs.aspose.com/html/net/converting-between-formats/svg-to-pdf/) を参照してください。そこでは、[`Converter`](../) クラスの ConvertSVG() メソッドを使用して SVG を PDF に変換する方法や、[`PdfSaveOptions`](../../../com.aspose.html.saving/pdfsaveoptions/) と [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) パラメータの適用方法についての情報が得られます。

SVG を PDF に変換

Converter クラスは、SVG から PDF への複数の特定変換を提供します。SVG を PDF に変換するには、いくつかの手順からなるシンプルなシナリオのいずれかに従う必要があります。
...
[`URL`](../../../com.aspose.html/url/) で提示された SVG ソースを変換します。結果は、出力ファイルパスで作成された pdf ファイルです。
...
完全なファイルパスで指定された SVG ソースを PDF に変換します。結果は、出力ファイルパスで作成された PDF ファイルです。
...
[`SVGDocument`](../../../com.aspose.html.dom.svg/svgdocument/) で提示された SVG ソースを PDF に変換します。結果は、[`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) インターフェイス実装によって生成された出力データです。
...
完全なファイルパスで提示された SVG ソースを PDF に変換します。結果は、[`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) インターフェイス実装によって生成された出力データです。
...
インラインコンテンツで提示された SVG ソースを PDF に変換します。結果は、[`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) インターフェイス実装によって生成された出力データです。
...
`[`SVGDocument`](../../../com.aspose.html.dom.svg/svgdocument/)`で提示されたSVGソースを変換します。結果は出力ファイルパスで作成された画像ファイルです。
...
`[`URL`](../../../com.aspose.html/url/)`で提示されたSVGソースを変換します。結果は出力ファイルパスで作成された画像ファイルです。
...
完全なファイルパスで指定された SVG ソースを画像に変換します。結果は、出力ファイルパスで作成された画像ファイルです。
...
完全なファイルパスで提示されたSVGソースを画像に変換します。結果は[`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) インターフェイス実装によって形成された出力データです。
...
インラインコンテンツで提示されたSVGソースを画像に変換します。結果は[`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) インターフェイス実装によって形成された出力データです。
...
`[`SVGDocument`](../../../com.aspose.html.dom.svg/svgdocument/)`で提示されたSVGソースを変換します。結果は出力ファイルパスで作成された XPS ファイルです。
...
`[`URL`](../../../com.aspose.html/url/)`で提示されたSVGソースを変換します。結果は出力ファイルパスで作成された XPS ファイルです。
...
完全なファイルパスで指定された SVG ソースを XPS に変換します。結果は、出力ファイルパスで作成された XPS ファイルです。
