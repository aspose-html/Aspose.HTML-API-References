...
description: "DocDevice メソッド。現在の点をパラメータ pt の座標へ移動させ、接続線分を省略して新しいサブパスを開始します。現在のパスで前のパス構築メソッドも MoveTo だった場合、新しい MoveTo がそれを上書きし、以前の MoveTo 操作の痕跡はパスに残りません。"
type: docs

url: /ja/java/com.aspose.html.rendering.doc/docdevice/moveto/
---
