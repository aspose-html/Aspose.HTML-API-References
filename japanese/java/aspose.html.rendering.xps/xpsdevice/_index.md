...
| [XpsDevice](xpsdevice/#constructor_1)(XpsRenderingOptions, ICreateStreamProvider) | レンダリングオプションとストリームプロバイダーで `XpsDevice` クラスの新しいインスタンスを初期化します。 |
| [XpsDevice](xpsdevice/#constructor_2)(XpsRenderingOptions, Stream) | レンダリングオプションと出力ストリームで `XpsDevice` クラスの新しいインスタンスを初期化します。 |
| [XpsDevice](xpsdevice/#constructor_3)(XpsRenderingOptions, String) | レンダリングオプションと出力ファイル名で `XpsDevice` クラスの新しいインスタンスを初期化します。 |
