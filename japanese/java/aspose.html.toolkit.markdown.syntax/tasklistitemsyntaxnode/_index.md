---
title: "TaskListItemSyntaxNode クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.toolkit.markdown.syntax.TaskListItemSyntaxNode クラス。タスクリスト項目構文ノード"
type: docs

url: /ja/java/com.aspose.html.toolkit.markdown.syntax/tasklistitemsyntaxnode/
---
...
| 名前 | 説明 |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/listitemsyntaxnode/accept/)(MarkdownSyntaxVisitor) | ビジターを受け入れるためのインターフェイスを定義します。 |
...
| [getLinesLeadingTrivia](../../com.aspose.html.toolkit.markdown.syntax/multilinecontainerblocksyntaxnode/getlinesleadingtrivia/)() | 行の先行トリビアを取得するためのインターフェイスを定義します。 |
| [getMarker](../../com.aspose.html.toolkit.markdown.syntax/listitemsyntaxnode/getmarker/)() | マーカーを取得 |
...
| [isChecked](../../com.aspose.html.toolkit.markdown.syntax/tasklistitemsyntaxnode/ischecked/)() | チェック状態を取得するためのインターフェイスを定義します。 |
| [isTight](../../com.aspose.html.toolkit.markdown.syntax/listitemsyntaxnode/istight/)() | タイトである場合は true を取得します。 |
