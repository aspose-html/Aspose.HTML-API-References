---
title: "ReferenceImageSyntaxNode クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.toolkit.markdown.syntax.ReferenceImageSyntaxNode クラス。参照画像構文"
type: docs

url: /ja/java/com.aspose.html.toolkit.markdown.syntax/referenceimagesyntaxnode/
---
...
| 名前 | 説明 |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/referenceimagesyntaxnode/accept/)(MarkdownSyntaxVisitor) | ビジターの受け入れのためのインターフェイスを定義します。 |
...
| [getAltText](../../com.aspose.html.toolkit.markdown.syntax/referenceimagesyntaxnode/getalttext/)() | 代替テキストを取得するためのインターフェイスを定義します。 |
| [getLabel](../../com.aspose.html.toolkit.markdown.syntax/referenceimagesyntaxnode/getlabel/)() | ラベルを取得するためのインターフェイスを定義します。 |
