---
title: "ReferenceLinkSyntaxNode クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.toolkit.markdown.syntax.ReferenceLinkSyntaxNode クラス。参照リンク構文を表します。"
type: docs

url: /ja/java/com.aspose.html.toolkit.markdown.syntax/referencelinksyntaxnode/
---
...
| 名前 | 説明 |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/referencelinksyntaxnode/accept/)(MarkdownSyntaxVisitor) | ビジターの受け入れのためのインターフェイスを定義します。 |
...
| [getContent](../../com.aspose.html.toolkit.markdown.syntax/referencelinksyntaxnode/getcontent/)() | get content 用のインターフェイスを定義します。 |
| [getLabel](../../com.aspose.html.toolkit.markdown.syntax/referencelinksyntaxnode/getlabel/)() | ラベルを取得するためのインターフェイスを定義します。 |
