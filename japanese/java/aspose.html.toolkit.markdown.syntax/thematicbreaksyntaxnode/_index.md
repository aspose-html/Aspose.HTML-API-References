...
description: "com.aspose.html.toolkit.markdown.syntax.ThematicBreakSyntaxNode クラス。Thematic Break 構文ノードを実装しています"
type: docs
...
| 名前 | 説明 |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/thematicbreaksyntaxnode/accept/)(MarkdownSyntaxVisitor) | Accept ビジターのインターフェイスを定義します。 |
