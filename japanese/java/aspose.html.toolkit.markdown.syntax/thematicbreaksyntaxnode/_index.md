---
title: "ThematicBreakSyntaxNode クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.toolkit.markdown.syntax.ThematicBreakSyntaxNode クラス。テーマブレーク構文ノードを実装しています。"
type: docs

url: /ja/java/com.aspose.html.toolkit.markdown.syntax/thematicbreaksyntaxnode/
---
## ThematicBreakSyntaxNode class

Thematic Break 構文ノードを実装しました。
...
| 名前 | 説明 |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/thematicbreaksyntaxnode/accept/)(MarkdownSyntaxVisitor) | Accept ビジターを受け入れるためのインターフェイスを定義します。 |
