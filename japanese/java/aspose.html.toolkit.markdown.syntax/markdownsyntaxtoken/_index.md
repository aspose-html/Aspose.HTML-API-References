---
title: "MarkdownSyntaxToken クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.toolkit.markdown.syntax.MarkdownSyntaxToken クラス。Markdown 構文トークンを表します"
type: docs

url: /ja/java/com.aspose.html.toolkit.markdown.syntax/markdownsyntaxtoken/
---
## MarkdownSyntaxToken class

Markdown Syntax Token を表します。
...
| [getSource](../../com.aspose.html.toolkit.markdown.syntax/markdownsyntaxtoken/source/) ソーステキストを取得します。 |
| [getSpan](../../com.aspose.html.toolkit.markdown.syntax/markdownsyntaxtoken/span/) スパンを取得します。 |
| [getText](../../com.aspose.html.toolkit.markdown.syntax/markdownsyntaxtoken/text/) スパンのテキスト内容を取得します。 |

## メソッド

| 名前 | 説明 |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/accept/)(MarkdownSyntaxVisitor) | ビジターを受け入れます。 |
...
| [getFullText](../../com.aspose.html.toolkit.markdown.syntax/markdownsyntaxtoken/getfulltext/)() | 全文テキストを取得するためのインターフェイスを定義します。 |
