---
title: "InlineImageSyntaxNode クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.toolkit.markdown.syntax.InlineImageSyntaxNode クラス。InlineImageSyntaxNode を表します"
type: docs

url: /ja/java/com.aspose.html.toolkit.markdown.syntax/inlineimagesyntaxnode/
---
## InlineImageSyntaxNode class

InlineImageSyntaxNode を表します。
...
| 名前 | 説明 |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/inlineimagesyntaxnode/accept/)(MarkdownSyntaxVisitor) | ビジター受け入れ用インターフェイスを定義します。 |
...
| [getAltText](../../com.aspose.html.toolkit.markdown.syntax/inlineimagesyntaxnode/getalttext/)() | すべてのテキストを取得するためのインターフェイスを定義します。 |
| [getDestination](../../com.aspose.html.toolkit.markdown.syntax/inlineimagesyntaxnode/getdestination/)() | 宛先を取得するためのインターフェイスを定義します。 |
...
| [getTitle](../../com.aspose.html.toolkit.markdown.syntax/inlineimagesyntaxnode/gettitle/)() | タイトルを取得するためのインターフェイスを定義します。 |
