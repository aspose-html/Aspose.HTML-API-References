...
| 名前 | 説明 |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/atxheadingsyntaxnode/accept/)(MarkdownSyntaxVisitor) | ビジター受け入れ用インターフェイスを定義します。 |
...
| [getClosingTag](../../com.aspose.html.toolkit.markdown.syntax/atxheadingsyntaxnode/getclosingtag/)() | 閉じタグを取得するためのインターフェイスを定義します。 |
| [getLeadingTrivia](../../com.aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/getleadingtrivia/)() | 先頭のトリビアを取得します。 |
| [getOpeningTag](../../com.aspose.html.toolkit.markdown.syntax/atxheadingsyntaxnode/getopeningtag/)() | 開始タグを取得するためのインターフェイスを定義します。 |
