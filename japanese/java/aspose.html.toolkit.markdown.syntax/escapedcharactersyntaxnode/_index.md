---
title: "EscapedCharacterSyntaxNode クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.toolkit.markdown.syntax.EscapedCharacterSyntaxNode クラス。エスケープ文字構文ノードを実装しました。"
type: docs

url: /ja/java/com.aspose.html.toolkit.markdown.syntax/escapedcharactersyntaxnode/
---
...
| [getSource](../../com.aspose.html.toolkit.markdown.syntax/textsyntaxnode/source/) ソーステキストを返します。 |
| [getSpan](../../com.aspose.html.toolkit.markdown.syntax/textsyntaxnode/span/) span を取得するためのインターフェイスを定義します。 |
| [getValue](../../com.aspose.html.toolkit.markdown.syntax/textsyntaxnode/value/) 文字列値を取得するプロパティを定義します。 |

## メソッド

| 名前 | 説明 |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/escapedcharactersyntaxnode/accept/)(MarkdownSyntaxVisitor) | ビジターを受け入れるためのインターフェイスを定義します。 |
