---
title: "CharacterReferenceSyntaxNode クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.toolkit.markdown.syntax.CharacterReferenceSyntaxNode クラス。CharacterReferenceSyntaxNode を表します。"
type: docs

url: /ja/java/com.aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/
---
## CharacterReferenceSyntaxNode class

CharacterReferenceSyntaxNode を表します。
...
| [getReference](../../com.aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/reference/) 参照を取得します。 |
| [getSource](../../com.aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/source/) ソースを取得します。 |
| [getSpan](../../com.aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/span/) スパンを取得します。 |
| [getValue](../../com.aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/value/) 値を取得します。 |

## メソッド

| 名前 | 説明 |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/accept/)(MarkdownSyntaxVisitor) | ビジターを受け入れるためのインターフェイスを定義します。 |
