...
| [getDelimiter](../../com.aspose.html.toolkit.markdown.syntax/orderedlistitemmarker/getdelimiter/)() | 区切り文字の取得インターフェイスを定義します。 |
| [getIndex](../../com.aspose.html.toolkit.markdown.syntax/orderedlistitemmarker/getindex/)() | 取得インデックスの取得インターフェイスを定義します。 |
