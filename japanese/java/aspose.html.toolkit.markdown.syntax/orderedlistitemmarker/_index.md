---
title: "OrderedListItemMarker クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.toolkit.markdown.syntax.OrderedListItemMarker クラス。順序付きリスト項目マーカーを表します。"
type: docs

url: /ja/java/com.aspose.html.toolkit.markdown.syntax/orderedlistitemmarker/
---
...
| [getDelimiter](../../com.aspose.html.toolkit.markdown.syntax/orderedlistitemmarker/getdelimiter/)() | 区切り文字の取得のためのインターフェイスを定義します。 |
| [getIndex](../../com.aspose.html.toolkit.markdown.syntax/orderedlistitemmarker/getindex/)() | 取得インデックスの取得のためのインターフェイスを定義します。 |
