---
title: "LinkTitleSyntaxNode クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.toolkit.markdown.syntax.LinkTitleSyntaxNode クラス。LinkTitleSyntaxNode を表します"
type: docs

url: /ja/java/com.aspose.html.toolkit.markdown.syntax/linktitlesyntaxnode/
---
## LinkTitleSyntaxNode class

LinkTitleSyntaxNode を表します。
...
| 名前 | 説明 |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/linktitlesyntaxnode/accept/)(MarkdownSyntaxVisitor) | ビジターを受け入れるためのインターフェイスを定義します。 |
...
| [getValue](../../com.aspose.html.toolkit.markdown.syntax/linktitlesyntaxnode/getvalue/)() | String 値を取得するためのインターフェイスを定義します。 |
