---
title: "UnorderedListSyntaxNode クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.toolkit.markdown.syntax.UnorderedListSyntaxNode クラス。順序なしリスト構文ノードを表します。"
type: docs

url: /ja/java/com.aspose.html.toolkit.markdown.syntax/unorderedlistsyntaxnode/
---
...
| 名前 | 説明 |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/unorderedlistsyntaxnode/accept/)(MarkdownSyntaxVisitor) | 構文ノードを訪問するためのインターフェイスを定義します。 |
...
| [getMarker](../../com.aspose.html.toolkit.markdown.syntax/unorderedlistsyntaxnode/getmarker/)() | マーカーを取得するためのインターフェイスを定義します。 |
