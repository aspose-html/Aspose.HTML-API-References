...
| 名前 | 説明 |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/hardbreaksyntaxnode/accept/)(MarkdownSyntaxVisitor) | ビジター受け入れ用インターフェイスを定義します。 |
...
| [getBreakingTag](../../com.aspose.html.toolkit.markdown.syntax/hardbreaksyntaxnode/getbreakingtag/)() | ブレークタグを取得するためのインターフェイスを定義します |
