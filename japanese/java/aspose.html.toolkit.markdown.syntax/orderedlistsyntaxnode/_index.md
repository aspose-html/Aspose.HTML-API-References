---
title: "OrderedListSyntaxNode クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.toolkit.markdown.syntax.OrderedListSyntaxNode クラス。Ordered list 構文を表します"
type: docs

url: /ja/java/com.aspose.html.toolkit.markdown.syntax/orderedlistsyntaxnode/
---
...
| 名前 | 説明 |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/orderedlistsyntaxnode/accept/)(MarkdownSyntaxVisitor) | ビジターの受け入れのためのインターフェイスを定義します。 |
...
| [getDelimiter](../../com.aspose.html.toolkit.markdown.syntax/orderedlistsyntaxnode/getdelimiter/)() | 区切り文字の取得のためのインターフェイスを定義します。 |
| [getLeadingTrivia](../../com.aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/getleadingtrivia/)() | 先頭のトリビアを取得します。 |
| [getStart](../../com.aspose.html.toolkit.markdown.syntax/orderedlistsyntaxnode/getstart/)() | 開始インデックスを取得するためのインターフェイスを定義します。 |
...
| [isTight](../../com.aspose.html.toolkit.markdown.syntax/listsyntaxnode/istight/)() | is tight を取得するためのインターフェイスを定義します。 |
