...
description: "com.aspose.html.toolkit.markdown.syntax.textSyntaxNode クラス。テキスト構文ノードを実装します"
type: docs
...
| 名前 | 説明 |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/textsyntaxnode/accept/)(MarkdownSyntaxVisitor) | ビジター受け入れ用インターフェイスを定義します。 |
