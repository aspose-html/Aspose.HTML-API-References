---
title: "InlineProxy クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.toolkit.markdown.syntax.InlineProxy クラス。InlineProxy を表します。"
type: docs

url: /ja/java/com.aspose.html.toolkit.markdown.syntax/inlineproxy/
---
## InlineProxy class
...
| 名前 | 説明 |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/inlineproxy/accept/)(MarkdownSyntaxVisitor) | ビジターを受け入れるためのインターフェイスを定義します。 |
...
| [getTarget](../../com.aspose.html.toolkit.markdown.syntax/inlineproxy/gettarget/)() | target を取得するインターフェイスを定義します。 |
...
| [writeTo](../../com.aspose.html.toolkit.markdown.syntax/inlineproxy/writeto/#writeto)(MarkdownTextWriter) | テキストライターに書き込みます。 |
