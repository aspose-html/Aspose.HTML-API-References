...
| 名前 | 説明 |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/inlineproxy/accept/)(MarkdownSyntaxVisitor) | ビジター受け入れ用インターフェイスを定義します。 |
...
| [getTarget](../../com.aspose.html.toolkit.markdown.syntax/inlineproxy/gettarget/)() | ターゲット取得のインターフェイスを定義します。 |
