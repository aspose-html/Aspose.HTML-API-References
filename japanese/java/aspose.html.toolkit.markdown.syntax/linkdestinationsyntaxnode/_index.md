...
| 名前 | 説明 |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/linkdestinationsyntaxnode/accept/)(MarkdownSyntaxVisitor) | ビジター受け入れ用インターフェイスを定義します。 |
...
| [getValue](../../com.aspose.html.toolkit.markdown.syntax/linkdestinationsyntaxnode/getvalue/)() | 文字列値を取得するためのインターフェイスを定義します。 |
