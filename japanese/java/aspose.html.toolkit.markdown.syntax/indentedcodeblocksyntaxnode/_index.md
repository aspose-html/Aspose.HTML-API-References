---
title: "IndentedCodeBlockSyntaxNode クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.toolkit.markdown.syntax.IndentedCodeBlockSyntaxNode クラス。IndentedCodeBlockSyntaxNode を表します"
type: docs

url: /ja/java/com.aspose.html.toolkit.markdown.syntax/indentedcodeblocksyntaxnode/
---
## IndentedCodeBlockSyntaxNode class

IndentedCodeBlockSyntaxNode を表します。
...
| 名前 | 説明 |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/indentedcodeblocksyntaxnode/accept/)(MarkdownSyntaxVisitor) | ビジターを受け入れるためのインターフェイスを定義します。 |
...
| [getContent](../../com.aspose.html.toolkit.markdown.syntax/indentedcodeblocksyntaxnode/getcontent/)() | コンテンツを取得するためのインターフェイスを定義します。 |
