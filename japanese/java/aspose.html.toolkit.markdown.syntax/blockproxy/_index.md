...
| 名前 | 説明 |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/blockproxy/accept/)(MarkdownSyntaxVisitor) | ビジター受け入れ用インターフェイスを定義します。 |
...
| [writeTo](../../com.aspose.html.toolkit.markdown.syntax/blockproxy/writeto/#writeto)(MarkdownTextWriter) | ライターに書き込むためのインターフェイスを定義します。 |
