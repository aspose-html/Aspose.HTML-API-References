---
title: "TableSyntaxNode クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.toolkit.markdown.syntax.TableSyntaxNode クラス。TableSyntax クラスノードです。"
type: docs

url: /ja/java/com.aspose.html.toolkit.markdown.syntax/tablesyntaxnode/
---
## TableSyntaxNode class

TableSyntax クラスノードです。
...
| 名前 | 説明 |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/tablesyntaxnode/accept/)(MarkdownSyntaxVisitor) | ビジターの受け入れのためのインターフェイスを定義します。 |
| [appendChild](../../com.aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/appendchild/)(MarkdownSyntaxNode) | 子ノードを追加します。 |
| [appendRow](../../com.aspose.html.toolkit.markdown.syntax/tablesyntaxnode/appendrow/)(TableRowSyntaxNode) | 行追加のインターフェイスを定義します。 |
| [childNodes](../../com.aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/childnodes/)() | 子ノードのコレクションを取得します。 |
| [getAlignment](../../com.aspose.html.toolkit.markdown.syntax/tablesyntaxnode/getalignment/)() | 配置取得のインターフェイスを定義します。 |
| [getBodyRows](../../com.aspose.html.toolkit.markdown.syntax/tablesyntaxnode/getbodyrows/)() | 本文行を取得するためのインターフェイスを定義します。 |
| [getHeader](../../com.aspose.html.toolkit.markdown.syntax/tablesyntaxnode/getheader/)() | テーブルヘッダーを取得するためのインターフェイスを定義します。 |
