...
description: "SVGListBase メソッド。リスト内の既存のすべての項目をクリアし、結果として空のリストになります"
type: docs

url: /ja/java/com.aspose.html.dom.svg.collections/svglistbase-1/clear/
---
## SVGListBase&lt;T&gt;.Clear method

リストからすべての既存の現在の項目をクリアし、結果として空のリストになります。
