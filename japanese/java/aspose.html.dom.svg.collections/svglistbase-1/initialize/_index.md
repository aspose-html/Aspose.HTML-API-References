...
description: "SVGListBase メソッド。リスト内のすべての既存項目をクリアし、パラメータで指定された単一の項目を保持するようにリストを再初期化します"
type: docs

url: /ja/java/com.aspose.html.dom.svg.collections/svglistbase-1/initialize/
---
