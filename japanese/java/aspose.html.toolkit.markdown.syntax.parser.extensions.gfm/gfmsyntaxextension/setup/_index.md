...
description: "GfmSyntaxExtension メソッド。Setup をオーバーライドする"
type: docs

url: /ja/java/com.aspose.html.toolkit.markdown.syntax.parser.extensions.gfm/gfmsyntaxextension/setup/
---
...
| パラメータ | 型 | 説明 |
| --- | --- | --- |
| ビルダー | IMarkdownParserBuilder | ビルダーです。 |
