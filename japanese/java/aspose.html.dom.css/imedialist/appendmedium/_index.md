...
description: "IMediaList メソッド。新しいメディア newMedium をリストの末尾に追加します。newMedium がすでに使用されている場合は、最初に削除されます。"
type: docs
...
newMedium メディアをリストの末尾に追加します。newMedium がすでに使用されている場合は、まず削除されます。
