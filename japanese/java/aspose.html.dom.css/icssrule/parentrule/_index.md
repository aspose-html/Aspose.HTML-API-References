...
description: "ICSSRule プロパティ。このルールが別のルール（例: メディアブロック内のスタイルルール）に含まれている場合、これは包含するルールです。もしこのルールが他のルールにネストされていない場合は null を返します。"
type: docs
...
このルールが別のルール（例: @media ブロック内のスタイルルール）に含まれている場合、これは包含するルールです。もしこのルールが他のルールにネストされていない場合は null を返します。
