...
description: "IXPathEvaluator メソッド。XPath 式の文字列を評価し、可能であれば指定された型の結果を返します。"
type: docs
...
| type | XPathResultType | 特定の `type` が指定された場合、結果は対応する型として返されます。XPath 1.0 の結果については、[`XPathResultType`](../../xpathresulttype/) 列挙体のいずれかの値でなければなりません。 |
...
| [dOMException](../../../com.aspose.html.dom/domexception/) | WRONG_DOCUMENT_ERR: ノードがこの [`IXPathEvaluator`](../) でサポートされていないドキュメントからのものです。 |
