...
description: "com.aspose.html.dom.events.UIEvent クラス。UIEvent インターフェイスは、ユーザーインターフェイスイベントに関連する特定のコンテキスト情報を提供します"
type: docs

url: /ja/java/com.aspose.html.dom.events/uievent/
---
## UIEvent class
