---
title: "FocusEvent クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.dom.events.FocusEvent クラス。FocusEvent インターフェイスは、フォーカスイベントに関連する特定のコンテキスト情報を提供します"
type: docs

url: /ja/java/com.aspose.html.dom.events/focusevent/
---
## FocusEvent class
...
| 名前 | 説明 |
| --- | --- |
| [FocusEvent](focusevent/#constructor)(String) | `FocusEvent` クラスの新しいインスタンスを初期化します。 |
...
| [getRelatedTarget](../../com.aspose.html.dom.events/focusevent/relatedtarget/) フォーカスイベントに関連する二次的な EventTarget を識別するために使用されます（イベントのタイプに応じて）。 |
