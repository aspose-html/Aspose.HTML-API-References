...
| [getRelatedTarget](../../com.aspose.html.dom.events/focusevent/relatedtarget/) Used to identify a secondary EventTarget related to a Focus event, depending on the type of event. |
