...
description: "FocusEvent コンストラクタ。FocusEvent クラスの新しいインスタンスを初期化します"
type: docs

url: /ja/java/com.aspose.html.dom.events/focusevent/focusevent/
---
## FocusEvent(String) {#constructor}

[`FocusEvent`](../) クラスの新しいインスタンスを初期化します。
