---
title: "SVGFETileElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.dom.svg.filters.SVGFETileElement クラス。SVGFETileElement インターフェイスは feTile 要素に対応します。"
type: docs

url: /ja/java/com.aspose.html.dom.svg.filters/svgfetileelement/
---
## SVGFETileElement class

SVGFETileElement インターフェイスは ‘feTile’ 要素に対応しています。
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfetileelement/height/) 指定された ‘filter’ 要素の属性 ‘height’ に対応します。 |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfetileelement/in1/) 指定された ‘feTile’ 要素の属性 ‘in’ に対応します。 |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfetileelement/result/) 指定された ‘filter’ 要素の ‘result’ 属性に対応します。 |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfetileelement/width/) 指定された ‘filter’ 要素の ‘width’ 属性に対応します。 |
| [X](../../com.aspose.html.dom.svg.filters/svgfetileelement/x/) { get; } | 指定された ‘filter’ 要素の ‘x’ 属性に対応します。 |
| [Y](../../com.aspose.html.dom.svg.filters/svgfetileelement/y/) { get; } | 指定された ‘filter’ 要素の ‘y’ 属性に対応します。 |
