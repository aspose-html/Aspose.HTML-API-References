---
title: "SVGFETurbulenceElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.dom.svg.filters.SVGFETurbulenceElement クラス。SVGFETurbulenceElement インターフェイスは feTurbulence 要素に対応します。"
type: docs

url: /ja/java/com.aspose.html.dom.svg.filters/svgfeturbulenceelement/
---
## SVGFETurbulenceElement class

SVGFETurbulenceElement インターフェイスは ‘feTurbulence’ 要素に対応しています。
...
| [getBaseFrequencyX](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/basefrequencyx/) 指定された ‘feTurbulence’ 要素の属性 ‘baseFrequency’ に対応します。‘baseFrequency’ 属性の X 成分を含みます。 |
| [getBaseFrequencyY](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/basefrequencyy/) 指定された ‘feTurbulence’ 要素の属性 ‘baseFrequency’ に対応します。（自動的に計算される可能性がある）‘baseFrequency’ 属性の Y 成分を含みます。 |
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/height/) 指定された ‘filter’ 要素の属性 ‘height’ に対応します。 |
[getId]
...
| [getNumOctaves](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/numoctaves/) 指定された ‘feTurbulence’ 要素の属性 ‘numOctaves’ に対応します。 |
[getOuterHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/result/) 指定された ‘filter’ 要素の属性 ‘result’ に対応します。 |
| [getSeed](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/seed/) 指定された ‘feTurbulence’ 要素の属性 ‘seed’ に対応します。 |
| [getShadowRoot](../../com.aspose.html.dom/element/shadowroot/) この要素に格納された shadowRoot を返します。閉じている場合は null。 |
| [getStitchTiles](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/stitchtiles/) 指定された ‘feTurbulence’ 要素の属性 ‘stitchTiles’ に対応します。このインターフェイスで定義されている SVG_STITCHTYPE_* 定数のいずれかを取ります。 |
...
| [getType](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/type/) 指定された ‘feTurbulence’ 要素の属性 ‘type’ に対応します。このインターフェイスで定義されている SVG_TURBULENCE_TYPE_* 定数のいずれかを取ります。 |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/width/) 指定された ‘filter’ 要素の属性 ‘width’ に対応します。 |
| [X](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/x/) { get; } | 指定された ‘filter’ 要素の ‘x’ 属性に対応します。 |
| [Y](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/y/) { get; } | 指定された ‘filter’ 要素の ‘y’ 属性に対応します。 |
...
| 名前 | 説明 |
| --- | --- |
| const [SVG_STITCHTYPE_NOSTITCH](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_stitchtype_nostitch/) | 値 'noStitch' に対応します。 |
| const [SVG_STITCHTYPE_STITCH](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_stitchtype_stitch/) | 値 'stitch' に対応します。 |
| const [SVG_STITCHTYPE_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_stitchtype_unknown/) | この型は事前定義された型のいずれでもありません。この型の新しい値を定義しようとしたり、既存の値をこの型に切り替えようとすることは無効です。 |
| const [SVG_TURBULENCE_TYPE_FRACTALNOISE](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_turbulence_type_fractalnoise/) | 値 'fractalNoise' に対応します。 |
| const [SVG_TURBULENCE_TYPE_TURBULENCE](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_turbulence_type_turbulence/) | 値 'turbulence' に対応します。 |
| const [SVG_TURBULENCE_TYPE_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_turbulence_type_unknown/) | この型は事前定義された型のいずれでもありません。この型の新しい値を定義しようとしたり、既存の値をこの型に切り替えようとすることは無効です。 |
