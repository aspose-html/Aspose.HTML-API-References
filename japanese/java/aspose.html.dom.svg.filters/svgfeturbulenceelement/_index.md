...
| [getBaseFrequencyX](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/basefrequencyx/) 対応する属性 ‘baseFrequency’ は、指定された ‘feTurbulence’ 要素です。‘baseFrequency’ 属性の X 成分を含みます。 |
| [getBaseFrequencyY](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/basefrequencyy/) 対応する属性 ‘baseFrequency’ は、指定された ‘feTurbulence’ 要素です。（自動的に計算される可能性がある）‘baseFrequency’ 属性の Y 成分を含みます。 |
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/height/) 対応する属性 ‘height’ は、指定された ‘filter’ 要素です。 |
[getId]
...
| [getNumOctaves](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/numoctaves/) 対応する属性 ‘numOctaves’ は、指定された ‘feTurbulence’ 要素です。 |
[getOuterHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/result/) 対応する属性 ‘result’ は、指定された ‘filter’ 要素です。 |
| [getSeed](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/seed/) 対応する属性 ‘seed’ は、指定された ‘feTurbulence’ 要素です。 |
| [getShadowRoot](../../com.aspose.html.dom/element/shadowroot/) この要素に格納されている shadowRoot を返します。閉じている場合は null です。 |
| [getStitchTiles](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/stitchtiles/) 対応する属性 ‘stitchTiles’ は、指定された ‘feTurbulence’ 要素です。このインターフェイスで定義されている SVG_STITCHTYPE_* 定数のいずれかを取ります。 |
...
| [getType](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/type/) 対応する属性 ‘type’ は、指定された ‘feTurbulence’ 要素です。このインターフェイスで定義されている SVG_TURBULENCE_TYPE_* 定数のいずれかを取ります。 |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/width/) 対応する属性 ‘width’ は、指定された ‘filter’ 要素です。 |
...
| 名前 | 説明 |
| --- | --- |
| const [SVG_STITCHTYPE_NOSTITCH](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_stitchtype_nostitch/) | 対応する値は 'noStitch' です。 |
| const [SVG_STITCHTYPE_STITCH](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_stitchtype_stitch/) | 対応する値は 'stitch' です。 |
...
| const [SVG_TURBULENCE_TYPE_FRACTALNOISE](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_turbulence_type_fractalnoise/) | 対応する値は 'fractalNoise' です。 |
| const [SVG_TURBULENCE_TYPE_TURBULENCE](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_turbulence_type_turbulence/) | 対応する値は 'turbulence' です。 |
