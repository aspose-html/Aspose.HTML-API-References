...
SVGFEDropShadowElement インターフェイスは ‘feDropShadow’ 要素に対応しています。
...
| [getDx](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/dx/) 指定された ‘feDropShadow’ 要素の属性 ‘dx’ に対応します。 |
| [getDy](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/dy/) 指定された ‘feDropShadow’ 要素の属性 ‘dy’ に対応します。 |
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/height/) 指定された ‘feDropShadow’ 要素の属性 ‘height’ に対応します。 |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/in1/) 指定された ‘feDropShadow’ 要素の属性 ‘in’ に対応します。 |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/result/) 指定された ‘feDropShadow’ 要素の属性 ‘result’ に対応します。 |
| [getShadowRoot](../../com.aspose.html.dom/element/shadowroot/) この要素に格納されている shadowRoot を返します。閉じている場合は null です。 |
| [getStdDeviationX](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/stddeviationx/) 指定された ‘feDropShadow’ 要素の属性 ‘stdDeviation’ に対応します。属性 ‘stdDeviation’ の X 成分を含みます。 |
| [getStdDeviationY](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/stddeviationy/) 指定された ‘feDropShadow’ 要素の属性 ‘stdDeviation’ に対応します。属性 ‘stdDeviation’ の Y 成分（自動的に計算される場合があります）を含みます。 |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/width/) 指定された ‘feDropShadow’ 要素の属性 ‘width’ に対応します。 |
