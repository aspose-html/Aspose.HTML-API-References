...
SVGFEGaussianBlurElement インターフェイスは ‘feGaussianBlur’ 要素に対応しています。
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/height/) 指定された �filter� 要素の �height� 属性に対応します。 |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/in1/) 指定された �feGaussianBlur� 要素の �in� 属性に対応します。 |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/result/) 指定された �filter� 要素の �result� 属性に対応します。 |
| [getShadowRoot](../../com.aspose.html.dom/element/shadowroot/) この要素に格納されている shadowRoot を返します。閉じている場合は null です。 |
| [getStdDeviationX](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/stddeviationx/) 指定された �feGaussianBlur� 要素の �stdDeviation� 属性に対応します。属性 �stdDeviation� の X 成分を含みます。 |
| [getStdDeviationY](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/stddeviationy/) 指定された �feGaussianBlur� 要素の �stdDeviation� 属性に対応します。属性 �stdDeviation� の Y 成分（自動的に計算される場合があります）を含みます。 |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/width/) 指定された �filter� 要素の �width� 属性に対応します。 |
| [X](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/x/) { get; } | 指定された �filter� 要素の �x� 属性に対応します。 |
| [Y](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/y/) { get; } | 指定された �filter� 要素の �y� 属性に対応します。 |
