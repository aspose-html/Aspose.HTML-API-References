---
title: "SVGFEGaussianBlurElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.dom.svg.filters.SVGFEGaussianBlurElement クラス。SVGFEGaussianBlurElement インターフェイスは feGaussianBlur 要素に対応します。"
type: docs

url: /ja/java/com.aspose.html.dom.svg.filters/svgfegaussianblurelement/
---
## SVGFEGaussianBlurElement class

SVGFEGaussianBlurElement インターフェイスは �feGaussianBlur� 要素に対応します。
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/height/) 指定された �filter� 要素の属性 �height� に対応します。 |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/in1/) 指定された �feGaussianBlur� 要素の属性 �in� に対応します。 |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/result/) 指定された �filter� 要素の属性 �result� に対応します。 |
| [getShadowRoot](../../com.aspose.html.dom/element/shadowroot/) この要素に格納された shadowRoot を返します。閉じている場合は null。 |
| [getStdDeviationX](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/stddeviationx/) 指定された �feGaussianBlur� 要素の属性 �stdDeviation� に対応します。属性 �stdDeviation� の X 成分を含みます。 |
| [getStdDeviationY](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/stddeviationy/) 指定された �feGaussianBlur� 要素の属性 �stdDeviation� に対応します。属性 �stdDeviation� の Y 成分（自動的に計算される場合があります）を含みます。 |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/width/) 指定された �filter� 要素の属性 �width� に対応します。 |
| [X](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/x/) { get; } | 指定された �filter� 要素の属性 �x� に対応します。 |
| [Y](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/y/) { get; } | 指定された �filter� 要素の属性 �y� に対応します。 |
...
| [setStdDeviation](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/setstddeviation/)(float, float) | 属性 �stdDeviation� の値を設定します。 |
