---
title: "SVGFEColorMatrixElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.dom.svg.filters.SVGFEColorMatrixElement クラス。SVGFEColorMatrixElement インターフェイスは feColorMatrix 要素に対応します。"
type: docs

url: /ja/java/com.aspose.html.dom.svg.filters/svgfecolormatrixelement/
---
## SVGFEColorMatrixElement class

SVGFEColorMatrixElement インターフェイスは ‘feColorMatrix’ 要素に対応します。
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/height/) は、指定された ‘filter’ 要素の ‘height’ 属性に対応します。 |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/in1/) は、指定された ‘feColorMatrix’ 要素の ‘in’ 属性に対応します。 |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/result/) は、指定された ‘filter’ 要素の ‘result’ 属性に対応します。 |
...
| [getType](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/type/) は、指定された ‘feColorMatrix’ 要素の ‘type’ 属性に対応します。このインターフェイスで定義された SVG_FECOLORMATRIX_TYPE_* 定数のいずれかを取ります。 |
| [getValues](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/values/) は、指定された ‘feColorMatrix’ 要素の ‘values’ 属性に対応します。 |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/width/) は、指定された ‘filter’ 要素の ‘width’ 属性に対応します。 |
| [X](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/x/) { get; } | 指定された ‘filter’ 要素の ‘x’ 属性に対応します。 |
| [Y](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/y/) { get; } | 指定された ‘filter’ 要素の ‘y’ 属性に対応します。 |
...
| 名前 | 説明 |
| --- | --- |
| const [SVG_FECOLORMATRIX_TYPE_HUEROTATE](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_huerotate/) | ‘hueRotate’ の値に対応します。 |
| const [SVG_FECOLORMATRIX_TYPE_LUMINANCETOALPHA](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_luminancetoalpha/) | ‘luminanceToAlpha’ の値に対応します。 |
| const [SVG_FECOLORMATRIX_TYPE_MATRIX](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_matrix/) | ‘matrix’ の値に対応します。 |
| const [SVG_FECOLORMATRIX_TYPE_SATURATE](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_saturate/) | 値 'saturate' に対応します。 |
| const [SVG_FECOLORMATRIX_TYPE_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_unknown/) | この型は事前定義された型のいずれでもありません。この型の新しい値を定義しようとしたり、既存の値をこの型に切り替えようとすることは無効です。 |
