...
SVGFEColorMatrixElement インターフェイスは ‘feColorMatrix’ 要素に対応しています。
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/height/) 指定された ‘filter’ 要素の属性 ‘height’ に対応します。 |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/in1/) 指定された ‘feColorMatrix’ 要素の属性 ‘in’ に対応します。 |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/result/) 指定された ‘filter’ 要素の属性 ‘result’ に対応します。 |
...
| [getType](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/type/) 指定された ‘feColorMatrix’ 要素の属性 ‘type’ に対応します。このインターフェイスで定義された SVG_FECOLORMATRIX_TYPE_* 定数のいずれかを取ります。 |
| [getValues](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/values/) 指定された ‘feColorMatrix’ 要素の属性 ‘values’ に対応します。 |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/width/) 指定された ‘filter’ 要素の属性 ‘width’ に対応します。 |
...
| 名前 | 説明 |
| --- | --- |
| const [SVG_FECOLORMATRIX_TYPE_HUEROTATE](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_huerotate/) | 値 'hueRotate' に対応します。 |
| const [SVG_FECOLORMATRIX_TYPE_LUMINANCETOALPHA](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_luminancetoalpha/) | 値 'luminanceToAlpha' に対応します。 |
| const [SVG_FECOLORMATRIX_TYPE_MATRIX](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_matrix/) | 値 'matrix' に対応します。 |
