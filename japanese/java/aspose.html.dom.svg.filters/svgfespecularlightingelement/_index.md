---
title: "SVGFESpecularLightingElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.dom.svg.filters.SVGFESpecularLightingElement クラス。SVGFESpecularLightingElement インターフェイスは feSpecularLighting 要素に対応します。"
type: docs

url: /ja/java/com.aspose.html.dom.svg.filters/svgfespecularlightingelement/
---
## SVGFESpecularLightingElement class

SVGFESpecularLightingElement インターフェイスは ‘feSpecularLighting’ 要素に対応します。
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/height/) 指定された ‘filter’ 要素の属性 ‘height’ に対応します。 |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/in1/) 指定された ‘feSpecularLighting’ 要素の属性 ‘in’ に対応します。 |
[getInnerHTML]
...
| [getKernelUnitLengthX](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/kernelunitlengthx/) 指定された ‘feSpecularLighting’ 要素の属性 ‘kernelUnitLength’ に対応します。 |
| [getKernelUnitLengthY](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/kernelunitlengthy/) 指定された ‘feSpecularLighting’ 要素の属性 ‘kernelUnitLength’ に対応します。 |
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/result/) 指定された ‘filter’ 要素の属性 ‘result’ に対応します。 |
| [getShadowRoot](../../com.aspose.html.dom/element/shadowroot/) この要素に格納された shadowRoot を返します。閉じている場合は null。 |
| [getSpecularConstant](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/specularconstant/) 指定された ‘feSpecularLighting’ 要素の属性 ‘specularConstant’ に対応します。 |
| [getSpecularExponent](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/specularexponent/) 指定された ‘feSpecularLighting’ 要素の属性 ‘specularExponent’ に対応します。 |
...
| [getSurfaceScale](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/surfacescale/) 指定された ‘feSpecularLighting’ 要素の属性 ‘surfaceScale’ に対応します。 |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/width/) 指定された ‘filter’ 要素の属性 ‘width’ に対応します。 |
| [X](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/x/) { get; } | 指定された ‘filter’ 要素の ‘x’ 属性に対応します。 |
| [Y](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/y/) { get; } | 指定された ‘filter’ 要素の ‘y’ 属性に対応します。 |
