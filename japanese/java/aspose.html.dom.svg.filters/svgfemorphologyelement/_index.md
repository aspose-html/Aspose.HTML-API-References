...
SVGFEMorphologyElement インターフェイスは ‘feMorphology’ 要素に対応しています。
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/height/) 指定された ‘filter’ 要素の ‘height’ 属性に対応します。 |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/in1/) 指定された ‘feMorphology’ 要素の ‘in’ 属性に対応します。 |
[getInnerHTML]
...
| [getOperator](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/operator/) 指定された ‘feMorphology’ 要素の属性 ‘operator’ に対応します。このインターフェイスで定義されている SVG_MORPHOLOGY_OPERATOR_* 定数のいずれかを取ります。 |
[getOuterHTML]
