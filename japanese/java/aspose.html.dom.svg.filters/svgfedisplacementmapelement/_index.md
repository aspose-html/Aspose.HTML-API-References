...
SVGFEDisplacementMapElement インターフェイスは ‘feDisplacementMap’ 要素に対応しています。
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/height/) 指定された ‘filter’ 要素の ‘height’ 属性に対応します。 |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/in1/) 指定された ‘feDisplacementMap’ 要素の ‘in’ 属性に対応します。 |
| [getIn2](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/in2/) 指定された ‘feDisplacementMap’ 要素の ‘in2’ 属性に対応します。 |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/result/) 指定された ‘filter’ 要素の ‘result’ 属性に対応します。 |
| [getScale](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/scale/) 指定された ‘feDisplacementMap’ 要素の ‘scale’ 属性に対応します。 |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/width/) 指定された ‘filter’ 要素の ‘width’ 属性に対応します。 |
| [X](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/x/) { get; } | 指定された ‘filter’ 要素の ‘x’ 属性に対応します。 |
| [getXChannelSelector](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/xchannelselector/) 指定された ‘feDisplacementMap’ 要素の ‘xChannelSelector’ 属性に対応します。このインターフェイスで定義された SVG_CHANNEL_* 定数のいずれかを受け取ります。 |
| [Y](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/y/) { get; } | 指定された ‘filter’ 要素の ‘y’ 属性に対応します。 |
| [getYChannelSelector](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/ychannelselector/) 対応する属性 ‘yChannelSelector’ は、指定された ‘feDisplacementMap’ 要素です。このインターフェイスで定義されている SVG_CHANNEL_* 定数のいずれかを取ります。 |
...
| 名前 | 説明 |
| --- | --- |
| const [SVG_CHANNEL_A](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_a/) | 対応する値は 'A' です。 |
| const [SVG_CHANNEL_B](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_b/) | 対応する値は 'B' です。 |
| const [SVG_CHANNEL_G](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_g/) | 対応する値は 'G' です。 |
| const [SVG_CHANNEL_R](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_r/) | 対応する値は 'R' です。 |
