---
title: "SVGFEDisplacementMapElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.dom.svg.filters.SVGFEDisplacementMapElement クラス。SVGFEDisplacementMapElement インターフェイスは feDisplacementMap 要素に対応します。"
type: docs

url: /ja/java/com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/
---
## SVGFEDisplacementMapElement class

SVGFEDisplacementMapElement インターフェイスは ‘feDisplacementMap’ 要素に対応します。
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/height/) 指定された ‘filter’ 要素の属性 ‘height’ に対応します。 |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/in1/) 指定された ‘feDisplacementMap’ 要素の属性 ‘in’ に対応します。 |
| [getIn2](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/in2/) 指定された ‘feDisplacementMap’ 要素の属性 ‘in2’ に対応します。 |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/result/) 指定された ‘filter’ 要素の属性 ‘result’ に対応します。 |
| [getScale](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/scale/) 指定された ‘feDisplacementMap’ 要素の属性 ‘scale’ に対応します。 |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/width/) 指定された ‘filter’ 要素の属性 ‘width’ に対応します。 |
| [X](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/x/) { get; } | 指定された ‘filter’ 要素の ‘x’ 属性に対応します。 |
| [getXChannelSelector](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/xchannelselector/) 指定された ‘feDisplacementMap’ 要素の属性 ‘xChannelSelector’ に対応します。このインターフェイスで定義された SVG_CHANNEL_* 定数のいずれかを受け取ります。 |
| [Y](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/y/) { get; } | 指定された ‘filter’ 要素の ‘y’ 属性に対応します。 |
| [getYChannelSelector](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/ychannelselector/) 指定された ‘feDisplacementMap’ 要素の属性 ‘yChannelSelector’ に対応します。このインターフェイスで定義されている SVG_CHANNEL_* 定数のいずれかを取ります。 |
...
| 名前 | 説明 |
| --- | --- |
| const [SVG_CHANNEL_A](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_a/) | 値 'A' に対応します。 |
| const [SVG_CHANNEL_B](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_b/) | 値 'B' に対応します。 |
| const [SVG_CHANNEL_G](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_g/) | 値 'G' に対応します。 |
| const [SVG_CHANNEL_R](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_r/) | 値 'R' に対応します。 |
| const [SVG_CHANNEL_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_unknown/) | この型は事前定義された型のいずれでもありません。この型の新しい値を定義しようとしたり、既存の値をこの型に切り替えようとすることは無効です。 |
