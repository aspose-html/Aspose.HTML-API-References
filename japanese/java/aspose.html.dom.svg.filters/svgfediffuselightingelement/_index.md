---
title: "SVGFEDiffuseLightingElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.dom.svg.filters.SVGFEDiffuseLightingElement クラス。SVGFEDiffuseLightingElement インターフェイスは feDiffuseLighting 要素に対応します。"
type: docs

url: /ja/java/com.aspose.html.dom.svg.filters/svgfediffuselightingelement/
---
## SVGFEDiffuseLightingElement class

SVGFEDiffuseLightingElement インターフェイスは ‘feDiffuseLighting’ 要素に対応します。
...
| [getDiffuseConstant](../../com.aspose.html.dom.svg.filters/svgfediffuselightingelement/diffuseconstant/) 指定された ‘feDiffuseLighting’ 要素の属性 ‘diffuseConstant’ に対応します。 |
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfediffuselightingelement/height/) 指定された ‘filter’ 要素の属性 ‘height’ に対応します。 |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfediffuselightingelement/in1/) 指定された ‘feDiffuseLighting’ 要素の属性 ‘in’ に対応します。 |
[getInnerHTML]
...
| [getKernelUnitLengthX](../../com.aspose.html.dom.svg.filters/svgfediffuselightingelement/kernelunitlengthx/) 指定された ‘feDiffuseLighting’ 要素の属性 ‘kernelUnitLength’ に対応します。 |
| [getKernelUnitLengthY](../../com.aspose.html.dom.svg.filters/svgfediffuselightingelement/kernelunitlengthy/) 指定された ‘feDiffuseLighting’ 要素の属性 ‘kernelUnitLength’ に対応します。 |
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfediffuselightingelement/result/) 指定された ‘filter’ 要素の属性 ‘result’ に対応します。 |
...
| [getSurfaceScale](../../com.aspose.html.dom.svg.filters/svgfediffuselightingelement/surfacescale/) 指定された ‘feDiffuseLighting’ 要素の属性 ‘surfaceScale’ に対応します。 |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfediffuselightingelement/width/) 指定された ‘filter’ 要素の属性 ‘width’ に対応します。 |
| [X](../../com.aspose.html.dom.svg.filters/svgfediffuselightingelement/x/) { get; } | 指定された ‘filter’ 要素の ‘x’ 属性に対応します。 |
| [Y](../../com.aspose.html.dom.svg.filters/svgfediffuselightingelement/y/) { get; } | 指定された ‘filter’ 要素の ‘y’ 属性に対応します。 |
