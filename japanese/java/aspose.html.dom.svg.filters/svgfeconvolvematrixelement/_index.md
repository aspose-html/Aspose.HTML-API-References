---
title: "SVGFEConvolveMatrixElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.dom.svg.filters.SVGFEConvolveMatrixElement クラス。SVGFEConvolveMatrixElement インターフェイスは feConvolveMatrix 要素に対応します"
type: docs

url: /ja/java/com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/
---
## SVGFEConvolveMatrixElement class

SVGFEConvolveMatrixElement インターフェイスは ‘feConvolveMatrix’ 要素に対応します。
...
| [getBias](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/bias/) 与えられた ‘feConvolveMatrix’ 要素の属性 ‘bias’ に対応します。 |
...
| [getDivisor](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/divisor/) 与えられた ‘feConvolveMatrix’ 要素の属性 ‘divisor’ に対応します。 |
| [getEdgeMode](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/edgemode/) 与えられた ‘feConvolveMatrix’ 要素の属性 ‘edgeMode’ に対応します。 |
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/height/) 与えられた ‘filter’ 要素の属性 ‘height’ に対応します。 |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/in1/) 与えられた ‘feConvolveMatrix’ 要素の属性 ‘in’ に対応します。 |
[getInnerHTML]
...
| [getKernelMatrix](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelmatrix/) 与えられた ‘feConvolveMatrix’ 要素の属性 ‘kernelMatrix’ に対応します。 |
| [getKernelUnitLengthX](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelunitlengthx/) 与えられた ‘feConvolveMatrix’ 要素の属性 ‘kernelUnitLength’ に対応します。 |
| [getKernelUnitLengthY](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelunitlengthy/) 与えられた ‘feConvolveMatrix’ 要素の属性 ‘kernelUnitLength’ に対応します。 |
...
| [getOrderX](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/orderx/) 与えられた ‘feConvolveMatrix’ 要素の属性 ‘order’ に対応します。 |
| [getOrderY](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/ordery/) 与えられた ‘feConvolveMatrix’ 要素の属性 ‘order’ に対応します。 |
[getOuterHTML]
...
| [getPreserveAlpha](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/preservealpha/) 与えられた ‘feConvolveMatrix’ 要素の属性 ‘preserveAlpha’ に対応します。 |
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/result/) 与えられた ‘filter’ 要素の属性 ‘result’ に対応します。 |
...
| [getTargetX](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/targetx/) 与えられた ‘feConvolveMatrix’ 要素の属性 ‘targetX’ に対応します。 |
| [getTargetY](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/targety/) 与えられた ‘feConvolveMatrix’ 要素の属性 ‘targetY’ に対応します。 |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/width/) 指定された ‘filter’ 要素の属性 ‘width’ に対応します。 |
| [X](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/x/) { get; } | 指定された ‘filter’ 要素の ‘x’ 属性に対応します。 |
| [Y](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/y/) { get; } | 指定された ‘filter’ 要素の ‘y’ 属性に対応します。 |
...
| 名前 | 説明 |
| --- | --- |
| const [SVG_EDGEMODE_DUPLICATE](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_duplicate/) | 値 'duplicate' に対応します。 |
| const [SVG_EDGEMODE_NONE](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_none/) | 値 'none' に対応します。 |
| const [SVG_EDGEMODE_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_unknown/) | この型は事前定義された型のいずれでもありません。この型の新しい値を定義しようとしたり、既存の値をこの型に切り替えようとすることは無効です。 |
| const [SVG_EDGEMODE_WRAP](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_wrap/) | 値 'wrap' に対応します。 |
