---
title: "SVGFECompositeElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.dom.svg.filters.SVGFECompositeElement クラス。SVGFECompositeElement インターフェイスは feComposite 要素に対応します。"
type: docs

url: /ja/java/com.aspose.html.dom.svg.filters/svgfecompositeelement/
---
## SVGFECompositeElement class

SVGFECompositeElement インターフェイスは ‘feComposite’ 要素に対応します。
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/height/) 指定された ‘filter’ 要素の属性 ‘height’ に対応します。 |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/in1/) 指定された ‘feComposite’ 要素の属性 ‘in’ に対応します。 |
| [getIn2](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/in2/) 指定された ‘feComposite’ 要素の属性 ‘in2’ に対応します。 |
[getInnerHTML]
...
| [getK1](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k1/) 指定された ‘feComposite’ 要素の属性 ‘k1’ に対応します。 |
| [getK2](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k2/) 指定された ‘feComposite’ 要素の属性 ‘k2’ に対応します。 |
| [getK3](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k3/) 指定された ‘feComposite’ 要素の属性 ‘k3’ に対応します。 |
| [getK4](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k4/) 指定された ‘feComposite’ 要素の属性 ‘k4’ に対応します。 |
...
| [getOperator](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/operator/) 指定された ‘feComposite’ 要素の属性 ‘operator’ に対応します。このインターフェイスで定義された SVG_FECOMPOSITE_OPERATOR_* 定数のいずれかを取ります。 |
[getOuterHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/result/) 指定された ‘filter’ 要素の属性 ‘result’ に対応します。 |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/width/) 指定された ‘filter’ 要素の属性 ‘width’ に対応します。 |
| [X](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/x/) { get; } | 指定された ‘filter’ 要素の ‘x’ 属性に対応します。 |
| [Y](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/y/) { get; } | 指定された ‘filter’ 要素の ‘y’ 属性に対応します。 |
...
| 名前 | 説明 |
| --- | --- |
| const [SVG_FECOMPOSITE_OPERATOR_ARITHMETIC](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_arithmetic/) | 値 'arithmetic' に対応します。 |
| const [SVG_FECOMPOSITE_OPERATOR_ATOP](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_atop/) | 値 'atop' に対応します。 |
| const [SVG_FECOMPOSITE_OPERATOR_IN](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_in/) | 値 'in' に対応します。 |
| const [SVG_FECOMPOSITE_OPERATOR_OUT](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_out/) | 値 'out' に対応します。 |
| const [SVG_FECOMPOSITE_OPERATOR_OVER](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_over/) | 値 'over' に対応します。 |
| const [SVG_FECOMPOSITE_OPERATOR_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_unknown/) | この型は事前定義された型のいずれでもありません。この型の新しい値を定義しようとしたり、既存の値をこの型に切り替えようとすることは無効です。 |
| const [SVG_FECOMPOSITE_OPERATOR_XOR](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_xor/) | 値 'xor' に対応します。 |
