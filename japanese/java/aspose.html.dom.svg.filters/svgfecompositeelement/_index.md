...
SVGFECompositeElement インターフェイスは ‘feComposite’ 要素に対応しています。
...
| [getOperator](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/operator/) 指定された ‘feComposite’ 要素の属性 ‘operator’ に対応します。このインターフェイスで定義されている SVG_FECOMPOSITE_OPERATOR_* 定数のいずれかを取ります。 |
[getOuterHTML]
