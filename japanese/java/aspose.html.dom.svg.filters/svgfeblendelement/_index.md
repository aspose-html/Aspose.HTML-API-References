---
title: "SVGFEBlendElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.dom.svg.filters.SVGFEBlendElement クラス。SVGFEBlendElement インターフェイスは feBlend 要素に対応します。"
type: docs

url: /ja/java/com.aspose.html.dom.svg.filters/svgfeblendelement/
---
## SVGFEBlendElement class

SVGFEBlendElement インターフェイスは ‘feBlend’ 要素に対応します。
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfeblendelement/height/) 指定された ‘filter’ 要素の属性 ‘height’ に対応します。 |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfeblendelement/in1/) 指定された ‘feBlend’ 要素の属性 ‘in’ に対応します。 |
| [getIn2](../../com.aspose.html.dom.svg.filters/svgfeblendelement/in2/) 指定された ‘feBlend’ 要素の属性 ‘in2’ に対応します。 |
[getInnerHTML]
...
| [getMode](../../com.aspose.html.dom.svg.filters/svgfeblendelement/mode/) 指定された ‘feBlend’ 要素の属性 ‘mode’ に対応します。このインターフェイスで定義されている SVG_FEBLEND_MODE_* 定数のいずれかを取ります。 |
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfeblendelement/result/) 指定された ‘filter’ 要素の属性 ‘result’ に対応します。 |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfeblendelement/width/) 指定された ‘filter’ 要素の属性 ‘width’ に対応します。 |
| [X](../../com.aspose.html.dom.svg.filters/svgfeblendelement/x/) { get; } | 指定された ‘filter’ 要素の ‘x’ 属性に対応します。 |
| [Y](../../com.aspose.html.dom.svg.filters/svgfeblendelement/y/) { get; } | 指定された ‘filter’ 要素の ‘y’ 属性に対応します。 |
...
| 名前 | 説明 |
| --- | --- |
| const [SVG_FEBLEND_MODE_COLOR](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_color/) | 値 'color' に対応します。 |
| const [SVG_FEBLEND_MODE_COLOR_BURN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_color_burn/) | 値 'color_burn' に対応します。 |
| const [SVG_FEBLEND_MODE_COLOR_DODGE](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_color_dodge/) | 値 'color_dodge' に対応します。 |
| const [SVG_FEBLEND_MODE_DARKEN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_darken/) | 値 'darken' に対応します。 |
| const [SVG_FEBLEND_MODE_DIFFERENCE](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_difference/) | 値 'difference' に対応します。 |
| const [SVG_FEBLEND_MODE_EXCLUSION](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_exclusion/) | 値 'exclusion' に対応します。 |
| const [SVG_FEBLEND_MODE_HARD_LIGHT](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_hard_light/) | 値 'hard_light' に対応します。 |
| const [SVG_FEBLEND_MODE_HUE](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_hue/) | 値 'hue' に対応します。 |
| const [SVG_FEBLEND_MODE_LIGHTEN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_lighten/) | 値 'lighten' に対応します。 |
| const [SVG_FEBLEND_MODE_LUMINOSITY](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_luminosity/) | 値 'luminosity' に対応します。 |
| const [SVG_FEBLEND_MODE_MULTIPLY](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_multiply/) | 値 'multiply' に対応します。 |
| const [SVG_FEBLEND_MODE_NORMAL](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_normal/) | 値 'normal' に対応します。 |
| const [SVG_FEBLEND_MODE_OVERLAY](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_overlay/) | 値 'overlay' に対応します。 |
| const [SVG_FEBLEND_MODE_SATURATION](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_saturation/) | 値 'saturation' に対応します。 |
| const [SVG_FEBLEND_MODE_SCREEN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_screen/) | 値 'screen' に対応します。 |
| const [SVG_FEBLEND_MODE_SOFT_LIGHT](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_soft_light/) | 値 'soft_light' に対応します。 |
| const [SVG_FEBLEND_MODE_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_unknown/) | この型は事前定義された型のいずれでもありません。この型の新しい値を定義しようとしたり、既存の値をこの型に切り替えようとすることは無効です。 |
