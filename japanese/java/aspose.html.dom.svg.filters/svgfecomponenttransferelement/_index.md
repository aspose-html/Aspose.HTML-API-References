---
title: "SVGFEComponentTransferElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.dom.svg.filters.SVGFEComponentTransferElement クラス。SVGFEComponentTransferElement インターフェイスは feComponentTransfer 要素に対応します。"
type: docs

url: /ja/java/com.aspose.html.dom.svg.filters/svgfecomponenttransferelement/
---
## SVGFEComponentTransferElement class

SVGFEComponentTransferElement インターフェイスは ‘feComponentTransfer’ 要素に対応します。
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfecomponenttransferelement/height/) 指定された ‘filter’ 要素の属性 ‘height’ に対応します。 |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfecomponenttransferelement/in1/) 指定された ‘feComponentTransfer’ 要素の属性 ‘in’ に対応します。 |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfecomponenttransferelement/result/) 指定された ‘filter’ 要素の属性 ‘result’ に対応します。 |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfecomponenttransferelement/width/) 指定された ‘filter’ 要素の属性 ‘width’ に対応します。 |
| [X](../../com.aspose.html.dom.svg.filters/svgfecomponenttransferelement/x/) { get; } | 指定された ‘filter’ 要素の ‘x’ 属性に対応します。 |
| [Y](../../com.aspose.html.dom.svg.filters/svgfecomponenttransferelement/y/) { get; } | 指定された ‘filter’ 要素の ‘y’ 属性に対応します。 |
