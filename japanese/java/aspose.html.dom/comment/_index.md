...
description: "com.aspose.html.dom.Comment クラス。CharacterData から継承し、コメントの内容、すなわち開始タグと終了タグの間のすべての文字を表します。"
type: docs
...
CharacterData を継承し、コメントの内容、すなわち開始 '' の間にあるすべての文字を表します。
...
| [getNodeName](../../com.aspose.html.dom/comment/nodename/) このノードの名前です。タイプに応じて異なります。 |
| [getNodeType](../../com.aspose.html.dom/comment/nodetype/) 基底オブジェクトのタイプを表すコードです。 |
| [nodeValue](../../com.aspose.html.dom/comment/nodevalue/) { get; set; } | このノードの値を、タイプに応じて返します。 |
...
| [textContent](../../com.aspose.html.dom/comment/textcontent/) { get; set; } | この属性は、このノードとその子孫のテキストコンテンツを返します。null に設定されている場合、設定しても効果はありません。設定すると、このノードが持つ可能性のあるすべての子ノードが削除され、かつ新しい文字列が空でなく null でもない場合は、その文字列を含む単一の Text ノードに置き換えられます。 |
