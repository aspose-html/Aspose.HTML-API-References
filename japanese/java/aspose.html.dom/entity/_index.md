...
description: "com.aspose.html.dom.Entity クラス。XML ドキュメント内の、解析済みまたは未解析の既知エンティティを表します。"
type: docs
...
| [getInputEncoding](../../com.aspose.html.dom/entity/inputencoding/) このエンティティが外部の解析済みエンティティである場合、解析時に使用されたエンコーディングを指定する属性です。内部サブセットからのエンティティ、または不明な場合は null です。 |
...
| [getNodeName](../../com.aspose.html.dom/entity/nodename/) このノードの名前です（タイプに応じて）。 |
...
| [getPublicId](../../com.aspose.html.dom/entity/publicid/) エンティティに指定された場合はその公開識別子、そうでなければ null です。 |
| [getSystemId](../../com.aspose.html.dom/entity/systemid/) エンティティに指定された場合はそのシステム識別子、そうでなければ null です。絶対 URI の場合もありますし、そうでない場合もあります。 |
| [textContent](../../com.aspose.html.dom/node/textcontent/) { get; set; } | [`Node`](../node/) インターフェイスの textContent プロパティは、ノードおよびその子孫のテキスト内容を表します。 |
| [getXmlEncoding](../../com.aspose.html.dom/entity/xmlencoding/) 外部の解析済みエンティティである場合、テキスト宣言の一部としてこのエンティティのエンコーディングを指定する属性です。それ以外の場合は null です。 |
| [getXmlVersion](../../com.aspose.html.dom/entity/xmlversion/) 外部の解析済みエンティティである場合、テキスト宣言の一部としてこのエンティティのバージョン番号を指定する属性です。それ以外の場合は null です。 |
