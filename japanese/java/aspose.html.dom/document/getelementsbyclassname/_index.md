...
[`Document`](../) インターフェイスの getElementsByClassName メソッドは、指定されたクラス名をすべて持つすべての子要素の配列に似たオブジェクトを返します。
...
見つかった要素のライブ[`HTMLCollection`](../../../com.aspose.html.collections/htmlcollection/)です。

## 備考

公式の[spec](https://dom.spec.whatwg.org/#dom-document-getelementsbyclassname)を参照してください。

ウェブ開発の実践コンテンツは[w3schools](https://www.w3schools.com/jsref/met_element_getelementsbyclassname.asp)で見つけることができます。
