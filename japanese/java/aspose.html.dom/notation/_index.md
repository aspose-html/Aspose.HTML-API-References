...
description: "com.aspose.html.dom.Notation クラス。DTD で宣言された表記法を表します。"
type: docs
...
| [getNodeName](../../com.aspose.html.dom/notation/nodename/) このノードの名前（タイプに応じて）。 |
| [getNodeType](../../com.aspose.html.dom/notation/nodetype/) 基底オブジェクトのタイプを表すコードです。 |
...
| [getPublicId](../../com.aspose.html.dom/notation/publicid/) この表記法の公開識別子です。公開識別子が指定されていない場合、null が返されます。 |
| [getSystemId](../../com.aspose.html.dom/notation/systemid/) この表記法のシステム識別子です。システム識別子が指定されていない場合、null が返されます。絶対 URI の場合もありますし、そうでない場合もあります。 |
