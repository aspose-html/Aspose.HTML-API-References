...
description: "com.aspose.html.dom.Notation クラス。DTD で宣言された表記 (notation) を表します。"
type: docs

url: /ja/java/com.aspose.html.dom/notation/
---
## Notation class

DTD で宣言された表記（notation）を表します。
...
| [getNodeName](../../com.aspose.html.dom/notation/nodename/) このノードの名前は、タイプに応じて決まります。 |
| [getNodeType](../../com.aspose.html.dom/notation/nodetype/) 基になるオブジェクトのタイプを表すコードです。 |
...
| [getPublicId](../../com.aspose.html.dom/notation/publicid/) この表記の公開識別子です。公開識別子が指定されていない場合、null が返されます。 |
| [getSystemId](../../com.aspose.html.dom/notation/systemid/) この表記のシステム識別子です。システム識別子が指定されていない場合、null が返されます。絶対 URI の場合もありますし、そうでない場合もあります。 |
