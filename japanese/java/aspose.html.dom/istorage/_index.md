...
description: "com.aspose.html.dom.IStorage インターフェイス。Web Storage API のこのインターフェイスは、特定のドメインのセッションまたはローカルストレージへのアクセスを提供します。Web Storage 仕様をご覧ください https//html.spec.whatwg.org/multipage/webstorage.htmlwebstorage"
type: docs
...
Web Storage API のこのインターフェイスは、特定ドメインのセッションまたはローカルストレージへのアクセスを提供します。Web Storage 仕様をご覧ください: [https://html.spec.whatwg.org/multipage/webstorage.html#webstorage](https://html.spec.whatwg.org/multipage/webstorage.html#webstorage)
...
| 名前 | 説明 |
| --- | --- |
| [getLength](../../com.aspose.html.dom/istorage/length/) キー/値ペアの数を返します。 |
