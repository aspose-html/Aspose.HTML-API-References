...
description: "com.aspose.html.dom.Text クラス。Text インターフェイスは CharacterData から継承され、Element または Attr の XML における文字データと呼ばれるテキストコンテンツを表します。"
type: docs
...
Text インターフェイスは CharacterData から継承され、Element または Attr のテキストコンテンツ（XML では文字データと呼ばれる）を表します。
...
| [getNodeName](../../com.aspose.html.dom/text/nodename/) このノードのタイプに応じた名前を返します。 |
