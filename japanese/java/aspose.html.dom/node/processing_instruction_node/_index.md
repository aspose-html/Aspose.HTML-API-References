...
description: "Node フィールド。xml-stylesheet のような XML ドキュメントの ProcessingInstruction"
type: docs

url: /ja/java/com.aspose.html.dom/node/processing_instruction_node/
---
## Node.PROCESSING_INSTRUCTION_NODE field

XML ドキュメントの [`ProcessingInstruction`](../../processinginstruction/)（例: &lt;?xml-stylesheet … ?&gt;）です。
