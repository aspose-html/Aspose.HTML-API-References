...
description: "Node プロパティ。prefix 読み取り専用プロパティは、指定された要素のパッケージプレフィックスを返し、プレフィックスが指定されていない場合は null を返します。"
type: docs

url: /ja/java/com.aspose.html.dom/node/prefix/
---
## Node.Prefix property

prefix 読み取り専用プロパティは、指定された要素のパッケージプレフィックスを返し、プレフィックスが指定されていない場合は null を返します。
...
このプロパティは関連付けられたパッケージプレフィックスを返します。
