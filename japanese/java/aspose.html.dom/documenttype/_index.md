...
| 名前 | 説明 |
| --- | --- |
| [DocumentType](documenttype/)(String, String, String, String, Document) | `DocumentType` クラスの新しいインスタンスを初期化します。 |
...
| [getNodeName](../../com.aspose.html.dom/documenttype/nodename/) このノードの名前（タイプに応じて）。 |
| [getNodeType](../../com.aspose.html.dom/documenttype/nodetype/) 基底オブジェクトのタイプを表すコードです。 |
