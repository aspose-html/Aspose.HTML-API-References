...
description: "com.aspose.html.saving.HTMLSaveOptions クラス。 HTML の保存オプションを表します。 特定のプロパティを設定することで、最大処理深度などリソース処理を管理できます。 詳細はドキュメント記事をご覧ください。"
type: docs
...
HTML 保存オプションを表します。特定のプロパティを設定することで、最大処理深度などのリソース処理を管理できます。詳細はドキュメントの [article](https://docs.aspose.com/html/net/working-with-documents/saving-a-document/) を参照してください。
...
| const [HTML](../../com.aspose.html.saving/htmlsaveoptions/html/) | ドキュメントは HTML として保存されます。 |
| const [XHTML](../../com.aspose.html.saving/htmlsaveoptions/xhtml/) | ドキュメントは XHTML として保存されます。 |
...
...
     // HTML ドキュメントの出力パスを準備します。
      ...
      using (var document = new HTMLDocument(documentPath))
      {
        ...
        // 値が '0' の次の行は、このインスタンスを保存する際に他のすべてのリンクされた HTML ファイルを切り捨てます
