...
description: "Resource メソッド。このリソースを Base64 にエンコードして親に埋め込みます。エンコード結果は OutputUrl に書き込まれます"
type: docs
...
このリソースを Base64 にエンコードして親に埋め込みます。エンコード結果は [`OutputUrl`](../outputurl/) に書き込まれます。
