...
description: "SVGPathElement メソッド。スタンドアロンで親のない SVGPathSegCurvetoCubicSmoothRel オブジェクトを返します"
type: docs

url: /ja/java/com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothrel/
---
## SVGPathElement.CreateSVGPathSegCurvetoCubicSmoothRel method

単独で親を持たない SVGPathSegCurvetoCubicSmoothRel オブジェクトを返します。
...
| x2 | Single | 2番目の制御点の相対 X 座標です。 |
| y2 | Single | 2番目の制御点の相対 Y 座標です。 |
