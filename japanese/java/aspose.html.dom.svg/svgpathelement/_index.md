---
title: "SVGPathElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.dom.svg.SVGPathElement クラス。SVGPathElement インターフェイスは path 要素に対応します。"
type: docs

url: /ja/java/com.aspose.html.dom.svg/svgpathelement/
---
...
| 名前 | 説明 |
| --- | --- |
| [getAnimatedPathSegList](../../com.aspose.html.dom.svg/svgpathelement/animatedpathseglist/) ‘d’ 属性の現在のアニメーション化された内容にアクセスします。この内容は SVG の構文と 1 対 1 に一致します。属性またはプロパティがアニメーション化されている場合、現在のアニメーション値を含み、オブジェクト自体とその内容は読み取り専用です。属性またはプロパティが現在アニメーション化されていない場合、pathSegList と同じ値を含みます。 |
...
| [getClassName](../../com.aspose.html.dom.svg/svgelement/classname/) 指定された要素の属性 ‘class’ に対応します。 |
[getClassName]
...
| [getFarthestViewportElement](../../com.aspose.html.dom.svg/svggraphicselement/farthestviewportelement/) 最も遠い祖先の ‘svg’ 要素。現在の要素が最外層の svg 要素である場合は null です。 |
...
| [getNearestViewportElement](../../com.aspose.html.dom.svg/svggraphicselement/nearestviewportelement/) 現在のビューポートを確立した要素。通常は最も近い祖先の ‘svg’ 要素です。現在の要素が最外層の svg 要素である場合は null です。 |
...
| [getOwnerSVGElement](../../com.aspose.html.dom.svg/svgelement/ownersvgelement/) 最も近い先祖の ‘svg’ 要素。対象要素が最外層の svg 要素の場合は Null。 |
...
| [getPathLength](../../com.aspose.html.dom.svg/svggeometryelement/pathlength/) 指定された要素の pathLength 属性に対応します。 |
[getPathSegList]
...
| [getRequiredExtensions](../../com.aspose.html.dom.svg/svggraphicselement/requiredextensions/) 指定された要素の ‘requiredExtensions’ 属性に対応します。 |
| [getRequiredFeatures](../../com.aspose.html.dom.svg/svggraphicselement/requiredfeatures/) 指定された要素の ‘requiredFeatures’ 属性に対応します。 |
| [getShadowRoot](../../com.aspose.html.dom/element/shadowroot/) この要素に格納された shadowRoot を返します。閉じている場合は null。 |
| [getStyle](../../com.aspose.html.dom.svg/svgelement/style/) 指定された要素の ‘style’ 属性に対応します。ユーザーエージェントが CSS によるスタイリングをサポートしない場合、この属性は常に null の値を持ちます。 |
| [getSystemLanguage](../../com.aspose.html.dom.svg/svggraphicselement/systemlanguage/) 指定された要素の ‘systemLanguage’ 属性に対応します。 |
...
| [getTransform](../../com.aspose.html.dom.svg/svggraphicselement/transform/) 指定された要素の ‘transform’ 属性に対応します。 |
| [getViewportElement](../../com.aspose.html.dom.svg/svgelement/viewportelement/) 現在のビューポートを設定した要素。通常は最も近い先祖の ‘svg’ 要素です。対象要素が最外層の svg 要素の場合は Null。 |
...
| [createSVGPathSegArcAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegarcabs/)(float, float, float, float, float, bool, bool) | スタンドアロンで親を持たない SVGPathSegArcAbs オブジェクトを返します。 |
| [createSVGPathSegArcRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegarcrel/)(float, float, float, float, float, bool, bool) | スタンドアロンで親を持たない SVGPathSegArcRel オブジェクトを返します。 |
| [createSVGPathSegClosePath](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegclosepath/)() | スタンドアロンで親を持たない SVGPathSegClosePath オブジェクトを返します。 |
| [createSVGPathSegCurvetoCubicAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicabs/)(float, float, float, float, float, float) | スタンドアロンで親を持たない SVGPathSegCurvetoCubicAbs オブジェクトを返します。 |
| [createSVGPathSegCurvetoCubicRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicrel/)(float, float, float, float, float, float) | スタンドアロンで親を持たない SVGPathSegCurvetoCubicRel オブジェクトを返します。 |
| [createSVGPathSegCurvetoCubicSmoothAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothabs/)(float, float, float, float) | スタンドアロンで親を持たない SVGPathSegCurvetoCubicSmoothAbs オブジェクトを返します。 |
| [createSVGPathSegCurvetoCubicSmoothRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothrel/)(float, float, float, float) | スタンドアロンで親を持たない SVGPathSegCurvetoCubicSmoothRel オブジェクトを返します。 |
| [createSVGPathSegCurvetoQuadraticAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticabs/)(float, float, float, float) | スタンドアロンで親がない SVGPathSegCurvetoQuadraticAbs オブジェクトを返します。 |
| [createSVGPathSegCurvetoQuadraticRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticrel/)(float, float, float, float) | スタンドアロンで親がない SVGPathSegCurvetoQuadraticRel オブジェクトを返します。 |
| [createSVGPathSegCurvetoQuadraticSmoothAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothabs/)(float, float) | スタンドアロンで親がない SVGPathSegCurvetoQuadraticSmoothAbs オブジェクトを返します。 |
| [createSVGPathSegCurvetoQuadraticSmoothRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothrel/)(float, float) | スタンドアロンで親がない SVGPathSegCurvetoQuadraticSmoothRel オブジェクトを返します。 |
| [createSVGPathSegLinetoAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoabs/)(float, float) | スタンドアロンで親がない SVGPathSegLinetoAbs オブジェクトを返します。 |
| [createSVGPathSegLinetoHorizontalAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetohorizontalabs/)(float) | スタンドアロンで親がない SVGPathSegLinetoHorizontalAbs オブジェクトを返します。 |
| [createSVGPathSegLinetoHorizontalRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetohorizontalrel/)(float) | スタンドアロンで親がない SVGPathSegLinetoHorizontalRel オブジェクトを返します。 |
| [createSVGPathSegLinetoRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetorel/)(float, float) | スタンドアロンで親がない SVGPathSegLinetoRel オブジェクトを返します。 |
| [createSVGPathSegLinetoVerticalAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoverticalabs/)(float) | スタンドアロンで親がない SVGPathSegLinetoVerticalAbs オブジェクトを返します。 |
| [createSVGPathSegLinetoVerticalRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoverticalrel/)(float) | スタンドアロンで親がない SVGPathSegLinetoVerticalRel オブジェクトを返します。 |
| [createSVGPathSegMovetoAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegmovetoabs/)(float, float) | スタンドアロンで親がない SVGPathSegMovetoAbs オブジェクトを返します。 |
| [createSVGPathSegMovetoRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegmovetorel/)(float, float) | スタンドアロンで親がない SVGPathSegMovetoRel オブジェクトを返します。 |
...
| [getBBox](../../com.aspose.html.dom.svg/svggraphicselement/getbbox/)() | 現在のユーザー空間（つまり、‘transform’ 属性が適用された後、もしあれば）における、すべての含まれるグラフィック要素のジオメトリのタイトなバウンディングボックスを返します。ストローク、クリッピング、マスク、フィルタ効果は除外されます。getBBox は、要素がまだ描画されていなくても、呼び出し時点での実際のバウンディングボックスを返す必要があります。 |
| [getCTM](../../com.aspose.html.dom.svg/svggraphicselement/getctm/)() | 現在のユーザー単位（つまり、‘transform’ 属性が適用された後、もしあれば）から nearestViewportElement のビューポート座標系への変換行列を返します。 |
...
| [getEquivalentPath](../../com.aspose.html.dom.svg/svggeometryelement/getequivalentpath/)() | [`SVGPathSegList`](../../com.aspose.html.dom.svg.paths/svgpathseglist/) の新しいインスタンスを返します。このインスタンスは [`SVGGeometryElement`](../svggeometryelement/) をパスセグメントとして表します。 |
| [getPlatformType](../../com.aspose.html.dom/domobject/getplatformtype/)() | このメソッドは ECMAScript オブジェクトを取得するために使用されます。 |
| [getPointAtLength](../../com.aspose.html.dom.svg/svggeometryelement/getpointatlength/)(float) | パス上の距離単位で、ユーザーエージェントの distance-along-a-path アルゴリズムを利用して、ユーザー空間の (x,y) 座標を返します。 |
| [getScreenCTM](../../com.aspose.html.dom.svg/svggraphicselement/getscreenctm/)() | 現在のユーザー単位（つまり、‘transform’ 属性が適用された後、もしあれば）から親ユーザーエージェントの「ピクセル」認識への変換行列を返します。表示デバイスの場合、理想的には物理的な画面ピクセルを表します。物理的なピクセルサイズが不明な他のデバイスや環境では、CSS2 の「ピクセル」定義に類似したアルゴリズムが使用できます。要素がドキュメントツリーに接続されていない場合は null が返されます。このメソッドは本来 getClientCTM と名付けるべきでしたが、歴史的理由で getScreenCTM という名前が残されています。 |
| [getTotalLength](../../com.aspose.html.dom.svg/svggeometryelement/gettotallength/)() | ユーザーエージェントの distance-along-a-path アルゴリズムを使用して計算されたパスの総長さを、現在のユーザー座標系の距離として返します。 |
