---
title: "SVGElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.dom.svg.SVGElement クラス。SVGPathElement インターフェイスが path 要素に対応するように、SVG 言語の要素に直接対応するすべての SVG DOM インターフェイスは SVGElement インターフェイスから派生します。"
type: docs

url: /ja/java/com.aspose.html.dom.svg/svgelement/
---
## SVGElement class

SVG 言語の要素に直接対応するすべての SVG DOM インターフェイス（例：‘path’ 要素の SVGPathElement インターフェイス）は SVGElement インターフェイスから派生します。
