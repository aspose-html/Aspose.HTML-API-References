---
title: "SVGGeometryElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.dom.svg.SVGGeometryElement クラス。インターフェイス SVGGeometryElement は、幾何形状と等価なパスで描画が定義され、塗りつぶしやストロークが可能な SVG 要素を表します。これにはパスと基本形状が含まれます。"
type: docs

url: /ja/java/com.aspose.html.dom.svg/svggeometryelement/
---
## SVGGeometryElement class

SVGGeometryElement インターフェイスは、等価パスを持つジオメトリで描画が定義され、塗りつぶしやストロークが可能な SVG 要素を表します。これにはパスや基本形状が含まれます。
...
| [getEquivalentPath](../../com.aspose.html.dom.svg/svggeometryelement/getequivalentpath/)() | [`SVGPathSegList`](../../com.aspose.html.dom.svg.paths/svgpathseglist/) の新しいインスタンスを返します。このインスタンスは `SVGGeometryElement` をパスセグメントとして表します。 |
