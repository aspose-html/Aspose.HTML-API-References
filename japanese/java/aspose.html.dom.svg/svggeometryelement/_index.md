...
description: "com.aspose.html.dom.svg.SVGGeometryElement クラス。インターフェイス SVGGeometryElement は、等価なパスで定義されたジオメトリに基づいて描画が決まる SVG 要素を表し、塗りつぶしやストロークが可能です。これにはパスと基本形状が含まれます。"
type: docs
...
SVGGeometryElement インターフェイスは、等価のパスで定義されたジオメトリにより描画が決定され、塗りつぶしやストロークが可能な SVG 要素を表します。これにはパスや基本形状が含まれます。
...
| [getEquivalentPath](../../com.aspose.html.dom.svg/svggeometryelement/getequivalentpath/)() | [`SVGPathSegList`](../../com.aspose.html.dom.svg.paths/svgpathseglist/) の新しいインスタンスを返します。これは `SVGGeometryElement` をパスセグメントとして表します。 |
