...
| [getHref](../../com.aspose.html.dom.svg/svgtextpathelement/href/) 指定された要素の ‘xlink:href’ 属性に対応します。 |
[getId]
...
| [getLengthAdjust](../../com.aspose.html.dom.svg/svgtextcontentelement/lengthadjust/) 指定された要素の属性 ‘lengthAdjust’ に対応します。このインターフェイスで定義された length adjust 定数のいずれかでなければなりません。 |
...
| [getMethod](../../com.aspose.html.dom.svg/svgtextpathelement/method/) 指定された ‘textPath’ 要素の ‘method’ 属性に対応します。 |
...
| [getSpacing](../../com.aspose.html.dom.svg/svgtextpathelement/spacing/) 指定された ‘textPath’ 要素の ‘spacing’ 属性に対応します。 |
| [getStartOffset](../../com.aspose.html.dom.svg/svgtextpathelement/startoffset/) 指定された ‘textPath’ 要素の ‘startOffset’ 属性に対応します。 |
...
| [getComputedTextLength](../../com.aspose.html.dom.svg/svgtextcontentelement/getcomputedtextlength/)() | この要素内のすべての文字をレンダリングした際の全てのアドバンス値の合計で、グリフ（水平または垂直）のアドバンス値、プロパティ ‘kerning’、‘letter-spacing’、‘word-spacing’ の効果、そして ‘tspan’ 要素の属性 ‘dx’ と ‘dy’ による調整を含みます。レンダリングを行わない環境では、ユーザーエージェントはグリフメトリックについて合理的な仮定を行うものとします。 |
...
| [getNumberOfChars](../../com.aspose.html.dom.svg/svgtextcontentelement/getnumberofchars/)() | 現在の要素内でレンダリング可能な文字数の合計を返します。これには ‘tref’ 参照からの文字も含まれ、実際にレンダリングされるかどうかは問わないです。実質的には、DOM Level 3 Core（[DOM3]、セクション 1.4）の Node::textContent 属性の長さと同等で、もしその属性が ‘tref’ 要素も展開している場合です。 |
...
| 名前 | 説明 |
| --- | --- |
| const [TEXTPATH_METHODTYPE_ALIGN](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_align/) | ‘align’ の値に対応します。 |
| const [TEXTPATH_METHODTYPE_STRETCH](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_stretch/) | ‘stretch’ の値に対応します。 |
...
| const [TEXTPATH_SPACINGTYPE_AUTO](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_auto/) | ‘auto’ の値に対応します。 |
| const [TEXTPATH_SPACINGTYPE_EXACT](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_exact/) | ‘exact’ の値に対応します。 |
