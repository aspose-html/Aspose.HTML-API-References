---
title: "SVGTextPathElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.dom.svg.SVGTextPathElement クラス。SVGTextPathElement インターフェイスは textPath 要素に対応します"
type: docs

url: /ja/java/com.aspose.html.dom.svg/svgtextpathelement/
---
## SVGTextPathElement class

SVGTextPathElement インターフェイスは ‘textPath’ 要素に対応します。
...
| [getHref](../../com.aspose.html.dom.svg/svgtextpathelement/href/) 対象の要素の属性 ‘xlink:href’ に対応します。 |
[getId]
...
| [getLengthAdjust](../../com.aspose.html.dom.svg/svgtextcontentelement/lengthadjust/) 指定された要素の属性 ‘lengthAdjust’ に対応します。このインターフェイスで定義された length adjust 定数のいずれかである必要があります。 |
...
| [getMethod](../../com.aspose.html.dom.svg/svgtextpathelement/method/) 対象の ‘textPath’ 要素の属性 ‘method’ に対応します。 |
...
| [getSpacing](../../com.aspose.html.dom.svg/svgtextpathelement/spacing/) 対象の ‘textPath’ 要素の属性 ‘spacing’ に対応します。 |
| [getStartOffset](../../com.aspose.html.dom.svg/svgtextpathelement/startoffset/) 対象の ‘textPath’ 要素の属性 ‘startOffset’ に対応します。 |
...
| [getTextLength](../../com.aspose.html.dom.svg/svgtextcontentelement/textlength/) 指定された要素の属性 ‘textLength’ に対応します。 |
...
| [getComputedTextLength](../../com.aspose.html.dom.svg/svgtextcontentelement/getcomputedtextlength/)() | この要素内のすべての文字をレンダリングした際の全進行値の合計で、グリフ（水平または垂直）の進行値、プロパティ ‘kerning’、‘letter-spacing’、‘word-spacing’ の効果、そして ‘tspan’ 要素の属性 ‘dx’ と ‘dy’ による調整を含みます。レンダリングを行わない環境では、ユーザーエージェントはグリフメトリックについて合理的な仮定を行うものとします。 |
...
| [getNumberOfChars](../../com.aspose.html.dom.svg/svgtextcontentelement/getnumberofchars/)() | 現在の要素内でレンダリング可能な文字数の合計を返します。これには ‘tref’ 参照からの文字も含まれ、レンダリングされるかどうかに関わりません。実質的には、DOM Level 3 Core（[DOM3], section 1.4）の Node::textContent 属性の長さに相当し、その属性が ‘tref’ 要素も展開している場合に同等です。 |
...
| 名前 | 説明 |
| --- | --- |
| const [TEXTPATH_METHODTYPE_ALIGN](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_align/) | 値 'align' に対応します。 |
| const [TEXTPATH_METHODTYPE_STRETCH](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_stretch/) | 値 'stretch' に対応します。 |
| const [TEXTPATH_METHODTYPE_UNKNOWN](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_unknown/) | 列挙は事前定義されたタイプのいずれでもない値に設定されました。このタイプの新しい値を定義しようとしたり、既存の値をこのタイプに切り替えようとすることは無効です。 |
| const [TEXTPATH_SPACINGTYPE_AUTO](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_auto/) | 値 'auto' に対応します。 |
| const [TEXTPATH_SPACINGTYPE_EXACT](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_exact/) | 値 'exact' に対応します。 |
| const [TEXTPATH_SPACINGTYPE_UNKNOWN](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_unknown/) | 列挙は事前定義されたタイプのいずれでもない値に設定されました。このタイプの新しい値を定義しようとしたり、既存の値をこのタイプに切り替えようとすることは無効です。 |
