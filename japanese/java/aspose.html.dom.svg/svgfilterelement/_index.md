---
title: "SVGFilterElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.dom.svg.SVGFilterElement クラス。SVGFilterElement インターフェイスは filter 要素に対応します。"
type: docs

url: /ja/java/com.aspose.html.dom.svg/svgfilterelement/
---
## SVGFilterElement class

SVGFilterElement インターフェイスは ‘filter’ 要素に対応します。
...
| [getFilterUnits](../../com.aspose.html.dom.svg/svgfilterelement/filterunits/) 指定された ‘filter’ 要素の属性 ‘filterUnits’ に対応します。SVGUnitTypes で定義された定数のいずれかを取ります。 |
...
| [getHeight](../../com.aspose.html.dom.svg/svgfilterelement/height/) 指定された ‘filter’ 要素の属性 ‘height’ に対応します。 |
| [getHref](../../com.aspose.html.dom.svg/svgfilterelement/href/) 指定された要素の属性 ‘xlink:href’ に対応します。 |
[getId]
...
| [getPrimitiveUnits](../../com.aspose.html.dom.svg/svgfilterelement/primitiveunits/) 指定された ‘filter’ 要素の属性 ‘primitiveUnits’ に対応します。SVGUnitTypes で定義された定数のいずれかを取ります。 |
...
| [getWidth](../../com.aspose.html.dom.svg/svgfilterelement/width/) 指定された ‘filter’ 要素の属性 ‘width’ に対応します。 |
| [X](../../com.aspose.html.dom.svg/svgfilterelement/x/) { get; } | 指定された ‘filter’ 要素の ‘x’ 属性に対応します。 |
| [Y](../../com.aspose.html.dom.svg/svgfilterelement/y/) { get; } | 指定された ‘filter’ 要素の ‘y’ 属性に対応します。 |
