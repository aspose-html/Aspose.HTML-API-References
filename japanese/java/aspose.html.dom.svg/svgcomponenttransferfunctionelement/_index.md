---
title: "SVGComponentTransferFunctionElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.dom.svg.SVGComponentTransferFunctionElement クラス。このインターフェイスは、コンポーネント転送関数インターフェイスで使用される基本インターフェイスを定義します。"
type: docs

url: /ja/java/com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/
---
## SVGComponentTransferFunctionElement class

このインターフェイスは、コンポーネント転送関数インターフェイスで使用される基底インターフェイスを定義します。
...
| 名前 | 説明 |
| --- | --- |
| [getAmplitude](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/amplitude/) 指定された要素の属性 ‘amplitude’ に対応します。 |
...
| [getExponent](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/exponent/) 指定された要素の属性 ‘exponent’ に対応します。 |
...
| [getIntercept](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/intercept/) 指定された要素の属性 ‘intercept’ に対応します。 |
...
| [getOffset](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/offset/) 指定された要素の属性 ‘offset’ に対応します。 |
[getOuterHTML]
...
| [getSlope](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/slope/) 指定された要素の属性 ‘slope’ に対応します。 |
...
| [getTableValues](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/tablevalues/) 指定された要素の属性 ‘tableValues’ に対応します。 |
...
| [getType](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/type/) 指定された要素の属性 ‘type’ に対応します。このインターフェイスで定義されている SVG_FECOMPONENTTRANSFER_TYPE_* 定数のいずれかを取ります。 |
...
| 名前 | 説明 |
| --- | --- |
| const [SVG_FECOMPONENTTRANSFER_TYPE_DISCRETE](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_discrete/) | 値 'discrete' に対応します。 |
| const [SVG_FECOMPONENTTRANSFER_TYPE_GAMMA](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_gamma/) | 値 'gamma' に対応します。 |
| const [SVG_FECOMPONENTTRANSFER_TYPE_IDENTITY](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_identity/) | 値 'identity' に対応します。 |
| const [SVG_FECOMPONENTTRANSFER_TYPE_LINEAR](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_linear/) | 値 'linear' に対応します。 |
| const [SVG_FECOMPONENTTRANSFER_TYPE_TABLE](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_table/) | 値 'table' に対応します。 |
| const [SVG_FECOMPONENTTRANSFER_TYPE_UNKNOWN](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_unknown/) | この型は事前定義された型のいずれでもありません。この型の新しい値を定義しようとしたり、既存の値をこの型に切り替えようとすることは無効です。 |
