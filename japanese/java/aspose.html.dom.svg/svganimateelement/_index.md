---
title: "SVGAnimateElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.dom.svg.SVGAnimateElement クラス。SVGAnimateElement インターフェイスは animate 要素に対応します。SVG DOM を介した animate 要素の属性へのオブジェクト指向アクセスは利用できません。"
type: docs

url: /ja/java/com.aspose.html.dom.svg/svganimateelement/
---
## SVGAnimateElement class

SVGAnimateElement インターフェイスは ‘animate’ 要素に対応します。SVG DOM を介した ‘animate’ 要素の属性へのオブジェクト指向アクセスは利用できません。
