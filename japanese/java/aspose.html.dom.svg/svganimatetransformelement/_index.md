---
title: "SVGAnimateTransformElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.dom.svg.SVGAnimateTransformElement クラス。SVGAnimateTransformElement インターフェイスは animateTransform 要素に対応します。SVG DOM を介した animateTransform 要素の属性へのオブジェクト指向アクセスは利用できません。"
type: docs

url: /ja/java/com.aspose.html.dom.svg/svganimatetransformelement/
---
## SVGAnimateTransformElement class

SVGAnimateTransformElement インターフェイスは ‘animateTransform’ 要素に対応します。SVG DOM を介した ‘animateTransform’ 要素の属性へのオブジェクト指向アクセスは利用できません。
