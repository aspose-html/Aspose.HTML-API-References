...
| 名前 | 説明 |
| --- | --- |
| [getAnimatedPoints](../../com.aspose.html.dom.svg/svgpolygonelement/animatedpoints/) 現在の ‘points’ 属性のアニメーション化された内容にアクセスします。対象の属性またはプロパティがアニメーション化されている場合、その現在のアニメーション値が含まれます。アニメーション化されていない場合は、points と同じ値が含まれます。 |
...
| [getPoints](../../com.aspose.html.dom.svg/svgpolygonelement/points/) ‘points’ 属性の基本（静的）内容にアクセスします。 |
