---
title: "SVGGraphicsElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.dom.svg.SVGGraphicsElement クラス。SVGGraphicsElement インターフェイスは、主にグラフィックを直接グループにレンダリングすることを目的とする SVG 要素を表します。"
type: docs

url: /ja/java/com.aspose.html.dom.svg/svggraphicselement/
---
## SVGGraphicsElement class

SVGGraphicsElement インターフェイスは、主にグループ内に直接グラフィックを描画することを目的とした SVG 要素を表します。
