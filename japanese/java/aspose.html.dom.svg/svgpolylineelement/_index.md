---
title: "SVGPolylineElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.dom.svg.SVGPolylineElement クラス。SVGPolylineElement インターフェイスは polyline 要素に対応します"
type: docs

url: /ja/java/com.aspose.html.dom.svg/svgpolylineelement/
---
## SVGPolylineElement class

SVGPolylineElement インターフェイスは ‘polyline’ 要素に対応します。
...
| 名前 | 説明 |
| --- | --- |
| [getAnimatedPoints](../../com.aspose.html.dom.svg/svgpolylineelement/animatedpoints/) 現在の ‘points’ 属性のアニメーション化された内容へのアクセスを提供します。対象の属性またはプロパティがアニメーション化されている場合、属性またはプロパティの現在のアニメーション化された値が含まれます。対象の属性またはプロパティが現在アニメーション化されていない場合、points と同じ値が含まれます。 |
...
| [getPoints](../../com.aspose.html.dom.svg/svgpolylineelement/points/) ‘points’ 属性の基本（すなわち静的）内容へのアクセスを提供します。 |
