...
| 名前 | 説明 |
| --- | --- |
| [getAnimatedPoints](../../com.aspose.html.dom.svg/svgpolylineelement/animatedpoints/) 現在の ‘points’ 属性のアニメーションされた内容にアクセスできます。対象の属性またはプロパティがアニメーション中の場合、属性またはプロパティの現在のアニメーション値が含まれます。対象の属性またはプロパティが現在アニメーションされていない場合、points と同じ値が含まれます。 |
...
| [getPoints](../../com.aspose.html.dom.svg/svgpolylineelement/points/) ‘points’ 属性の基本（すなわち静的）内容にアクセスできます。 |
