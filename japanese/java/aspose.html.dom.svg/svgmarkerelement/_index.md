---
title: "SVGMarkerElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.dom.svg.SVGMarkerElement クラス。SVGMarkerElement インターフェイスは marker 要素に対応します。"
type: docs

url: /ja/java/com.aspose.html.dom.svg/svgmarkerelement/
---
## SVGMarkerElement class

SVGMarkerElement インターフェイスは ‘marker’ 要素に対応します。
...
| [getMarkerHeight](../../com.aspose.html.dom.svg/svgmarkerelement/markerheight/) は、指定された ‘marker’ 要素の属性 ‘markerHeight’ に対応します。 |
| [getMarkerUnits](../../com.aspose.html.dom.svg/svgmarkerelement/markerunits/) は、指定された ‘marker’ 要素の属性 ‘markerUnits’ に対応します。このインターフェイスで定義されている Marker Unit Types の一つです。 |
| [getMarkerWidth](../../com.aspose.html.dom.svg/svgmarkerelement/markerwidth/) 指定された ‘marker’ 要素の属性 ‘markerWidth’ に対応します。 |
...
| [getOrientAngle](../../com.aspose.html.dom.svg/svgmarkerelement/orientangle/) 指定された ‘marker’ 要素の属性 ‘orient’ に対応します。markerUnits が SVG_MARKER_ORIENT_ANGLE の場合、属性 ‘orient’ の角度値が使用されます。そうでない場合は 0 に設定されます。 |
| [getOrientType](../../com.aspose.html.dom.svg/svgmarkerelement/orienttype/) 指定された ‘marker’ 要素の属性 ‘orient’ に対応します。このインターフェイスで定義されているマーカー方向タイプのいずれかです。 |
[getOuterHTML]
...
| [getPreserveAspectRatio](../../com.aspose.html.dom.svg/svgmarkerelement/preserveaspectratio/) 指定された要素の属性 ‘preserveAspectRatio’ に対応します。 |
...
| [getRefX](../../com.aspose.html.dom.svg/svgmarkerelement/refx/) 指定された ‘marker’ 要素の属性 ‘refX’ に対応します。 |
| [getRefY](../../com.aspose.html.dom.svg/svgmarkerelement/refy/) 指定された ‘marker’ 要素の属性 ‘refY’ に対応します。 |
...
| [getViewBox](../../com.aspose.html.dom.svg/svgmarkerelement/viewbox/) 指定された要素の属性 ‘viewBox’ に対応します。 |
...
| [setOrientToAngle](../../com.aspose.html.dom.svg/svgmarkerelement/setorienttoangle/)(SVGAngle) | 属性 ‘orient’ の値を指定された角度に設定します。 |
| [setOrientToAuto](../../com.aspose.html.dom.svg/svgmarkerelement/setorienttoauto/)() | 属性 ‘orient’ の値を 'auto' に設定します。 |
...
| 名前 | 説明 |
| --- | --- |
| const [SVG_MARKERUNITS_STROKEWIDTH](../../com.aspose.html.dom.svg/svgmarkerelement/svg_markerunits_strokewidth/) | 属性 ‘markerUnits’ の値は 'strokeWidth' です。 |
| const [SVG_MARKERUNITS_UNKNOWN](../../com.aspose.html.dom.svg/svgmarkerelement/svg_markerunits_unknown/) | マーカー単位タイプは事前定義されたタイプのいずれでもありません。このタイプの新しい値を定義しようとしたり、既存の値をこのタイプに切り替えようとすることは無効です。 |
| const [SVG_MARKERUNITS_USERSPACEONUSE](../../com.aspose.html.dom.svg/svgmarkerelement/svg_markerunits_userspaceonuse/) | 属性 ‘markerUnits’ の値は 'userSpaceOnUse' です。 |
| const [SVG_MARKER_ORIENT_ANGLE](../../com.aspose.html.dom.svg/svgmarkerelement/svg_marker_orient_angle/) | 属性 ‘orient’ には角度値があります。 |
| const [SVG_MARKER_ORIENT_AUTO](../../com.aspose.html.dom.svg/svgmarkerelement/svg_marker_orient_auto/) | 属性 ‘orient’ の値は 'auto' です。 |
| const [SVG_MARKER_ORIENT_UNKNOWN](../../com.aspose.html.dom.svg/svgmarkerelement/svg_marker_orient_unknown/) | マーカーの方向は事前定義されたタイプのいずれでもありません。このタイプの新しい値を定義しようとしたり、既存の値をこのタイプに切り替えようとすることは無効です。 |
