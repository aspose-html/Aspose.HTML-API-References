...
| [getMarkerHeight](../../com.aspose.html.dom.svg/svgmarkerelement/markerheight/) 指定された ‘marker’ 要素の属性 ‘markerHeight’ に対応します。 |
| [getMarkerUnits](../../com.aspose.html.dom.svg/svgmarkerelement/markerunits/) 指定された ‘marker’ 要素の属性 ‘markerUnits’ に対応します。このインターフェイスで定義されている Marker Unit Types の一つです。 |
| [getMarkerWidth](../../com.aspose.html.dom.svg/svgmarkerelement/markerwidth/) 対応する属性 ‘markerWidth’ は、指定された ‘marker’ 要素です。 |
...
| [getOrientAngle](../../com.aspose.html.dom.svg/svgmarkerelement/orientangle/) 対応する属性 ‘orient’ は、指定された ‘marker’ 要素です。markerUnits が SVG_MARKER_ORIENT_ANGLE の場合、属性 ‘orient’ の角度値です。そうでない場合、0 に設定されます。 |
| [getOrientType](../../com.aspose.html.dom.svg/svgmarkerelement/orienttype/) 対応する属性 ‘orient’ は、指定された ‘marker’ 要素です。このインターフェイスで定義されているマーカー方向タイプのいずれかです。 |
[getOuterHTML]
...
| [getPreserveAspectRatio](../../com.aspose.html.dom.svg/svgmarkerelement/preserveaspectratio/) 対応する属性 ‘preserveAspectRatio’ は、指定された要素です。 |
...
| [getRefX](../../com.aspose.html.dom.svg/svgmarkerelement/refx/) 対応する属性 ‘refX’ は、指定された ‘marker’ 要素です。 |
| [getRefY](../../com.aspose.html.dom.svg/svgmarkerelement/refy/) 対応する属性 ‘refY’ は、指定された ‘marker’ 要素です。 |
...
| [getViewBox](../../com.aspose.html.dom.svg/svgmarkerelement/viewbox/) 対応する属性 ‘viewBox’ は、指定された要素です。 |
