---
title: "SVGAnimateMotionElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.dom.svg.SVGAnimateMotionElement クラス。SVGAnimateMotionElement インターフェイスは animateMotion 要素に対応します。SVG DOM を介した animateMotion 要素の属性へのオブジェクト指向アクセスは利用できません。"
type: docs

url: /ja/java/com.aspose.html.dom.svg/svganimatemotionelement/
---
## SVGAnimateMotionElement class

SVGAnimateMotionElement インターフェイスは ‘animateMotion’ 要素に対応します。SVG DOM を介した ‘animateMotion’ 要素の属性へのオブジェクト指向アクセスは利用できません。
