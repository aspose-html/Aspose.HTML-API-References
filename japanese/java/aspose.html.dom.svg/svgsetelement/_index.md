---
title: "SVGSetElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.dom.svg.SVGSetElement クラス。SVGSetElement インターフェイスは set 要素に対応します。SVG DOM を介した set 要素の属性へのオブジェクト指向アクセスは利用できません。"
type: docs

url: /ja/java/com.aspose.html.dom.svg/svgsetelement/
---
## SVGSetElement class

SVGSetElement インターフェイスは ‘set’ 要素に対応します。SVG DOM を介した ‘set’ 要素の属性へのオブジェクト指向アクセスは利用できません。
