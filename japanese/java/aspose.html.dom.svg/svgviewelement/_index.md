...
| [getPreserveAspectRatio](../../com.aspose.html.dom.svg/svgviewelement/preserveaspectratio/) 指定された要素の属性 ‘preserveAspectRatio’ に対応します。 |
...
| [getViewBox](../../com.aspose.html.dom.svg/svgviewelement/viewbox/) 指定された要素の属性 ‘viewBox’ に対応します。 |
...
| [getViewTarget](../../com.aspose.html.dom.svg/svgviewelement/viewtarget/) 指定された ‘view’ 要素の属性 ‘viewTarget’ に対応します。‘viewTarget’ 属性に列挙された名前を含む DOMString 値のリストです。各 DOMString 値は getElementById() メソッド呼び出しを使用して対応する要素に関連付けることができます。 |
[getZoomAndPan]
