---
title: "SVGViewElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.dom.svg.SVGViewElement クラス。SVGViewElement インターフェイスは view 要素に対応します。"
type: docs

url: /ja/java/com.aspose.html.dom.svg/svgviewelement/
---
## SVGViewElement class

SVGViewElement インターフェイスは ‘view’ 要素に対応します。
...
| [getPreserveAspectRatio](../../com.aspose.html.dom.svg/svgviewelement/preserveaspectratio/) は、指定された要素の属性 ‘preserveAspectRatio’ に対応します。 |
...
| [getViewBox](../../com.aspose.html.dom.svg/svgviewelement/viewbox/) は、指定された要素の属性 ‘viewBox’ に対応します。 |
...
| [getViewTarget](../../com.aspose.html.dom.svg/svgviewelement/viewtarget/) は、指定された ‘view’ 要素の属性 ‘viewTarget’ に対応します。‘viewTarget’ 属性に列挙された名前を含む DOMString 値のリストです。各 DOMString 値は、getElementById() メソッド呼び出しを使用して対応する要素に関連付けることができます。 |
[getZoomAndPan]
