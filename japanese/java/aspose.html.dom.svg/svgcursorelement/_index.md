---
title: "SVGCursorElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.dom.svg.SVGCursorElement クラス。SVGCursorElement インターフェイスは cursor 要素に対応します。"
type: docs

url: /ja/java/com.aspose.html.dom.svg/svgcursorelement/
---
## SVGCursorElement class

SVGCursorElement インターフェイスは ‘cursor’ 要素に対応します。
...
| [getHref](../../com.aspose.html.dom.svg/svgcursorelement/href/) 指定された要素の属性 ‘xlink:href’ に対応します。 |
[getId]
...
| [getRequiredExtensions](../../com.aspose.html.dom.svg/svgcursorelement/requiredextensions/) 指定された要素の属性 ‘requiredExtensions’ に対応します。 |
| [getRequiredFeatures](../../com.aspose.html.dom.svg/svgcursorelement/requiredfeatures/) 指定された要素の属性 ‘requiredFeatures’ に対応します。 |
...
| [getSystemLanguage](../../com.aspose.html.dom.svg/svgcursorelement/systemlanguage/) 指定された要素の属性 ‘systemLanguage’ に対応します。 |
...
| [X](../../com.aspose.html.dom.svg/svgcursorelement/x/) { get; } | 指定された ‘cursor’ 要素の属性 ‘x’ に対応します。 |
| [Y](../../com.aspose.html.dom.svg/svgcursorelement/y/) { get; } | 指定された ‘cursor’ 要素の属性 ‘y’ に対応します。 |
