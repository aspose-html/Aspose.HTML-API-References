...
| [getHref](../../com.aspose.html.dom.svg/svgcursorelement/href/) 対応する属性 ‘xlink:href’ は、指定された要素です。 |
[getId]
...
| [getRequiredExtensions](../../com.aspose.html.dom.svg/svgcursorelement/requiredextensions/) 対応する属性 ‘requiredExtensions’ は、指定された要素です。 |
| [getRequiredFeatures](../../com.aspose.html.dom.svg/svgcursorelement/requiredfeatures/) 対応する属性 ‘requiredFeatures’ は、指定された要素です。 |
...
| [getSystemLanguage](../../com.aspose.html.dom.svg/svgcursorelement/systemlanguage/) 対応する属性 ‘systemLanguage’ は、指定された要素です。 |
...
| [X](../../com.aspose.html.dom.svg/svgcursorelement/x/) { get; } | 対応する属性 ‘x’ は、指定された ‘cursor’ 要素です。 |
