---
title: "SVGAnimationElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.dom.svg.SVGAnimationElement クラス。SVGAnimationElement インターフェイスは、すべてのアニメーション要素インターフェイス（SVGAnimateElement、SVGSetElement、SVGAnimateColorElement、SVGAnimateMotionElement、SVGAnimateTransformElement）の基本インターフェイスです。"
type: docs

url: /ja/java/com.aspose.html.dom.svg/svganimationelement/
---
## SVGAnimationElement class

SVGAnimationElement インターフェイスは、すべてのアニメーション要素インターフェイス（SVGAnimateElement、SVGSetElement、SVGAnimateColorElement、SVGAnimateMotionElement、SVGAnimateTransformElement）の基底インターフェイスです。
...
| [getRequiredExtensions](../../com.aspose.html.dom.svg/svganimationelement/requiredextensions/) は、対象要素の属性 ‘requiredExtensions’ に対応します。 |
| [getRequiredFeatures](../../com.aspose.html.dom.svg/svganimationelement/requiredfeatures/) は、対象要素の属性 ‘requiredFeatures’ に対応します。 |
...
| [getSystemLanguage](../../com.aspose.html.dom.svg/svganimationelement/systemlanguage/) は、対象要素の属性 ‘systemLanguage’ に対応します。 |
| [getTagName](../../com.aspose.html.dom/element/tagname/) 要素の名前。 |
| [getTargetElement](../../com.aspose.html.dom.svg/svganimationelement/targetelement/) アニメーション対象の要素です。 |
