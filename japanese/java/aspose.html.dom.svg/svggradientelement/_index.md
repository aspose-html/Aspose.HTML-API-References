---
title: "SVGGradientElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.dom.svg.SVGGradientElement クラス。SVGGradientElement インターフェイスは、SVGLinearGradientElement と SVGRadialGradientElement が使用する基底インターフェイスです。"
type: docs

url: /ja/java/com.aspose.html.dom.svg/svggradientelement/
---
## SVGGradientElement class

SVGGradientElement インターフェイスは SVGLinearGradientElement と SVGRadialGradientElement で使用される基底インターフェイスです。
...
| 名前 | 説明 |
| --- | --- |
| const [SVG_SPREADMETHOD_PAD](../../com.aspose.html.dom.svg/svggradientelement/svg_spreadmethod_pad/) | 'pad' の値に対応します。 |
| const [SVG_SPREADMETHOD_REFLECT](../../com.aspose.html.dom.svg/svggradientelement/svg_spreadmethod_reflect/) | 'reflect' の値に対応します。 |
| const [SVG_SPREADMETHOD_REPEAT](../../com.aspose.html.dom.svg/svggradientelement/svg_spreadmethod_repeat/) | 'repeat' の値に対応します。 |
| const [SVG_SPREADMETHOD_UNKNOWN](../../com.aspose.html.dom.svg/svggradientelement/svg_spreadmethod_unknown/) | この型は事前定義された型のいずれでもありません。この型の新しい値を定義しようとしたり、既存の値をこの型に切り替えようとすることは無効です。 |
