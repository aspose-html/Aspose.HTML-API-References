...
| [getHeight](../../com.aspose.html.dom.svg/svgpatternelement/height/) 指定された ‘pattern’ 要素の属性 ‘height’ に対応します。 |
| [getHref](../../com.aspose.html.dom.svg/svgpatternelement/href/) 指定された要素の属性 ‘xlink:href’ に対応します。 |
[getId]
...
| [getPatternContentUnits](../../com.aspose.html.dom.svg/svgpatternelement/patterncontentunits/) 指定された ‘pattern’ 要素の属性 ‘patternContentUnits’ に対応します。SVGUnitTypes で定義された定数のいずれかを取ります。 |
| [getPatternTransform](../../com.aspose.html.dom.svg/svgpatternelement/patterntransform/) 指定された ‘pattern’ 要素の属性 ‘patternTransform’ に対応します。 |
| [getPatternUnits](../../com.aspose.html.dom.svg/svgpatternelement/patternunits/) 指定された ‘pattern’ 要素の属性 ‘patternUnits’ に対応します。SVGUnitTypes で定義された定数のいずれかを取ります。 |
| [getPrefix](../../com.aspose.html.dom/element/prefix/) このノードの名前空間プレフィックスを返します。未指定の場合は null です。null に設定されている場合、設定しても効果はありません。 |
| [getPreserveAspectRatio](../../com.aspose.html.dom.svg/svgpatternelement/preserveaspectratio/) 指定された要素の属性 ‘preserveAspectRatio’ に対応します。 |
...
| [getRequiredExtensions](../../com.aspose.html.dom.svg/svgpatternelement/requiredextensions/) 指定された要素の属性 ‘requiredExtensions’ に対応します。 |
| [getRequiredFeatures](../../com.aspose.html.dom.svg/svgpatternelement/requiredfeatures/) 指定された要素の属性 ‘requiredFeatures’ に対応します。 |
...
| [getSystemLanguage](../../com.aspose.html.dom.svg/svgpatternelement/systemlanguage/) 指定された要素の属性 ‘systemLanguage’ に対応します。 |
...
| [getViewBox](../../com.aspose.html.dom.svg/svgpatternelement/viewbox/) 指定された要素の属性 ‘viewBox’ に対応します。 |
...
| [getWidth](../../com.aspose.html.dom.svg/svgpatternelement/width/) 指定された ‘pattern’ 要素の属性 ‘width’ に対応します。 |
| [X](../../com.aspose.html.dom.svg/svgpatternelement/x/) { get; } | 指定された ‘pattern’ 要素の属性 ‘x’ に対応します。 |
| [Y](../../com.aspose.html.dom.svg/svgpatternelement/y/) { get; } | 指定された ‘pattern’ 要素の属性 ‘y’ に対応します。 |
