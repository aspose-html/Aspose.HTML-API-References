---
title: "SVGPatternElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.dom.svg.SVGPatternElement クラス。SVGPatternElement インターフェイスは pattern 要素に対応します。"
type: docs

url: /ja/java/com.aspose.html.dom.svg/svgpatternelement/
---
## SVGPatternElement class

SVGPatternElement インターフェイスは ‘pattern’ 要素に対応します。
...
| [getHeight](../../com.aspose.html.dom.svg/svgpatternelement/height/) は、指定された ‘pattern’ 要素の ‘height’ 属性に対応します。 |
| [getHref](../../com.aspose.html.dom.svg/svgpatternelement/href/) は、指定された要素の ‘xlink:href’ 属性に対応します。 |
[getId]
...
| [getPatternContentUnits](../../com.aspose.html.dom.svg/svgpatternelement/patterncontentunits/) は、指定された ‘pattern’ 要素の ‘patternContentUnits’ 属性に対応します。SVGUnitTypes で定義された定数のいずれかを取ります。 |
| [getPatternTransform](../../com.aspose.html.dom.svg/svgpatternelement/patterntransform/) は、指定された ‘pattern’ 要素の ‘patternTransform’ 属性に対応します。 |
| [getPatternUnits](../../com.aspose.html.dom.svg/svgpatternelement/patternunits/) は、指定された ‘pattern’ 要素の ‘patternUnits’ 属性に対応します。SVGUnitTypes で定義された定数のいずれかを取ります。 |
| [getPrefix](../../com.aspose.html.dom/element/prefix/) このノードのパッケージプレフィックス、未指定の場合は null。null に設定されている場合、設定しても効果はありません。 |
| [getPreserveAspectRatio](../../com.aspose.html.dom.svg/svgpatternelement/preserveaspectratio/) は、指定された要素の ‘preserveAspectRatio’ 属性に対応します。 |
...
| [getRequiredExtensions](../../com.aspose.html.dom.svg/svgpatternelement/requiredextensions/) は、指定された要素の ‘requiredExtensions’ 属性に対応します。 |
| [getRequiredFeatures](../../com.aspose.html.dom.svg/svgpatternelement/requiredfeatures/) は、指定された要素の ‘requiredFeatures’ 属性に対応します。 |
...
| [getSystemLanguage](../../com.aspose.html.dom.svg/svgpatternelement/systemlanguage/) は、指定された要素の ‘systemLanguage’ 属性に対応します。 |
...
| [getViewBox](../../com.aspose.html.dom.svg/svgpatternelement/viewbox/) は、指定された要素の ‘viewBox’ 属性に対応します。 |
...
| [getWidth](../../com.aspose.html.dom.svg/svgpatternelement/width/) は、指定された ‘pattern’ 要素の ‘width’ 属性に対応します。 |
| [X](../../com.aspose.html.dom.svg/svgpatternelement/x/) { get; } | 指定された ‘pattern’ 要素の ‘x’ 属性に対応します。 |
| [Y](../../com.aspose.html.dom.svg/svgpatternelement/y/) { get; } | 指定された ‘pattern’ 要素の ‘y’ 属性に対応します。 |
