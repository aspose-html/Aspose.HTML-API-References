---
title: "OptionElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.forms.OptionElement クラス。OptionElement は HTMLOptionElement に関連付けられたラッパーを表します。"
type: docs

url: /ja/java/com.aspose.html.forms/optionelement/
---
## OptionElement class

OptionElement は、HTMLOptionElement に関連付けられたラッパーを表します。
...
| [value](../../com.aspose.html.forms/optionelement/value/) { get; set; } | 現在のフォームコントロールの値です。HTML 4.01 の value 属性の定義をご覧ください。 |
