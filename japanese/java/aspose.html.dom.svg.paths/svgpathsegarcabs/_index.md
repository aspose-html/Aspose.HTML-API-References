---
title: "SVGPathSegArcAbs クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.dom.svg.paths.SVGPathSegArcAbs クラス。SVGPathSegArcAbs インターフェイスは、絶対 arcto A パスデータコマンドに対応します"
type: docs

url: /ja/java/com.aspose.html.dom.svg.paths/svgpathsegarcabs/
---
## SVGPathSegArcAbs class

SVGPathSegArcAbs インターフェイスは、\"絶対 arcto\" (A) パスデータコマンドに対応します。
...
| [X](../../com.aspose.html.dom.svg.paths/svgpathsegarcabs/x/) { get; set; } | このパスセグメントの終点の絶対 X 座標。 |
| [Y](../../com.aspose.html.dom.svg.paths/svgpathsegarcabs/y/) { get; set; } | このパスセグメントの終点の絶対 Y 座標。 |
