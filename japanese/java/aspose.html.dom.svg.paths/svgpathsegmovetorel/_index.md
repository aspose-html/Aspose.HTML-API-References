...
description: "com.aspose.html.dom.svg.paths.SVGPathSegMovetoRel クラス。SVGPathSegMovetoRel インターフェイスは、相対的な moveto m パスデータコマンドに対応します。"
type: docs

url: /ja/java/com.aspose.html.dom.svg.paths/svgpathsegmovetorel/
---
## SVGPathSegMovetoRel class

この SVGPathSegMovetoRel インターフェイスは「相対的な移動」(m) パスデータコマンドに対応します。
...
| [X](../../com.aspose.html.dom.svg.paths/svgpathsegmovetorel/x/) { get; set; } | このパスセグメントの終点の相対 X 座標。 |
| [Y](../../com.aspose.html.dom.svg.paths/svgpathsegmovetorel/y/) { get; set; } | このパスセグメントの終点の相対 Y 座標。 |
