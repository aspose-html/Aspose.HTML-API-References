...
description: "com.aspose.html.dom.svg.paths.SVGPathSegCurvetoCubicRel クラス。SVGPathSegCurvetoCubicRel インターフェイスは、相対的な cubic Bézier curveto c パスデータコマンドに対応します。"
type: docs

url: /ja/java/com.aspose.html.dom.svg.paths/svgpathsegcurvetocubicrel/
---
...
| [X](../../com.aspose.html.dom.svg.paths/svgpathsegcurvetocubicrel/x/) { get; set; } | このパスセグメントの終点の相対 X 座標。 |
[getX1]
[setX1] The relative X coordinate for the first control point. |
[getX2]
[setX2] The relative X coordinate for the second control point. |
| [Y](../../com.aspose.html.dom.svg.paths/svgpathsegcurvetocubicrel/y/) { get; set; } | このパスセグメントの終点の相対 Y 座標。 |
[getY1]
