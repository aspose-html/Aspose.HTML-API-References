---
title: "SVGPathSegLinetoHorizontalAbs クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.dom.svg.paths.SVGPathSegLinetoHorizontalAbs クラス。SVGPathSegLinetoHorizontalAbs インターフェイスは、絶対的な水平 lineto H パスデータコマンドに対応します。"
type: docs

url: /ja/java/com.aspose.html.dom.svg.paths/svgpathseglinetohorizontalabs/
---
## SVGPathSegLinetoHorizontalAbs class

この SVGPathSegLinetoHorizontalAbs インターフェイスは「絶対的な水平直線」(H) パスデータコマンドに対応します。
...
| [X](../../com.aspose.html.dom.svg.paths/svgpathseglinetohorizontalabs/x/) { get; set; } | このパスセグメントの終点の絶対 X 座標。 |
