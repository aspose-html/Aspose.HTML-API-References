---
title: "SVGPathSegLinetoAbs クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.dom.svg.paths.SVGPathSegLinetoAbs クラス。SVGPathSegLinetoAbs インターフェイスは、絶対 lineto L パスデータコマンドに対応します。"
type: docs

url: /ja/java/com.aspose.html.dom.svg.paths/svgpathseglinetoabs/
---
## SVGPathSegLinetoAbs class

この SVGPathSegLinetoAbs インターフェイスは「絶対的な直線」(L) パスデータコマンドに対応します。
...
| [X](../../com.aspose.html.dom.svg.paths/svgpathseglinetoabs/x/) { get; set; } | このパスセグメントの終点の絶対 X 座標。 |
| [Y](../../com.aspose.html.dom.svg.paths/svgpathseglinetoabs/y/) { get; set; } | このパスセグメントの終点の絶対 Y 座標。 |
