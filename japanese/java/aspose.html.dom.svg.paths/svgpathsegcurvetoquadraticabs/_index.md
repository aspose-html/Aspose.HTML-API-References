...
description: "com.aspose.html.dom.svg.paths.SVGPathSegCurvetoQuadraticAbs クラス。SVGPathSegCurvetoQuadraticAbs インターフェイスは、絶対的な二次ベジエ curveto Q パスデータコマンドに対応します。"
type: docs
...
SVGPathSegCurvetoQuadraticAbs インターフェイスは、\"絶対 quadratic Bézier curveto\" (Q) パスデータコマンドに対応します。
...
| [X](../../com.aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticabs/x/) { get; set; } | このパスセグメントの終点の絶対 X 座標。 |
[getX1]
[setX1] The absolute X coordinate for the first control point. |
| [Y](../../com.aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticabs/y/) { get; set; } | このパスセグメントの終点の絶対 Y 座標。 |
[getY1]
