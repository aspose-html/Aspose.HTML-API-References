---
title: "HTMLPreElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.HTMLPreElement クラス。プリフォーマットされたテキストです。HTML 4.01 の PRE 要素定義を参照してください。"
type: docs

url: /ja/java/com.aspose.html/htmlpreelement/
---
## HTMLPreElement class

整形済みテキストです。HTML 4.01 の PRE 要素定義を参照してください。
