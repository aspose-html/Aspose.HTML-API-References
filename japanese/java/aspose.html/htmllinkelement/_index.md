---
title: "HTMLLinkElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.HTMLLinkElement クラス。LINK 要素は外部リソースへのリンクを指定し、この文書とそのリソースとの関係（またはその逆）を定義します。HTML 4.01 の LINK 要素の定義を参照してください。また、StyleSheet モジュールの LinkStyle インターフェイス（DOM Level 2 スタイルシートと CSS）も参照してください。"
type: docs

url: /ja/java/com.aspose.html/htmllinkelement/
---
## HTMLLinkElement class

`LINK` 要素は外部リソースへのリンクを指定し、そのリソースに対するこのドキュメントの関係（または逆）を定義します。HTML 4.01 の LINK 要素定義を参照してください（StyleSheet モジュールの `LinkStyle` インターフェイスも参照してください）[[DOM Level 2 Style Sheets and CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113)]。
...
| [getRelList](../../com.aspose.html/htmllinkelement/rellist/) 「rel」属性の解析から得られたトークンを含むライブ DOMTokenList を返します。 |
[getRev]
...
| [getSheet](../../com.aspose.html/htmllinkelement/sheet/) 関連付けられたスタイルシートを取得します。 |
