---
title: "TypedArray クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.TypedArray クラス。TypedArray オブジェクトは、基になるバイナリデータバッファの配列のようなビューを提供します。"
type: docs

url: /ja/java/com.aspose.html/typedarray/
---
## TypedArray class
