---
title: "HTMLCanvasElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.HTMLCanvasElement クラス。HTMLCanvasElement インターフェイスは、キャンバス要素のレイアウトと表示を操作するためのプロパティとメソッドを提供します。また、HTMLCanvasElement インターフェイスは HTMLElement インターフェイスのプロパティとメソッドも継承します"
type: docs

url: /ja/java/com.aspose.html/htmlcanvaselement/
---
## HTMLCanvasElement class

HTMLCanvasElement インターフェイスは、キャンバス要素のレイアウトと表示を操作するためのプロパティとメソッドを提供します。HTMLCanvasElement インターフェイスは、HTMLElement インターフェイスのプロパティとメソッドも継承します。
...
| [getContext](../../com.aspose.html/htmlcanvaselement/getcontext/)(String) | キャンバス上の描画コンテキストを返します。サポートされていないコンテキスト ID の場合は null を返します。描画コンテキストを使用するとキャンバスに描画できます。 |
...
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl)() | type パラメータで指定された形式（デフォルトは PNG）で画像の表現を含むデータ URI を返します。返される画像は 96 dpi の解像度です。 |
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl_1)(String) | type パラメータで指定された形式（デフォルトは PNG）で画像の表現を含むデータ URI を返します。返される画像は 96 dpi の解像度です。 |
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl_2)(String, double) | type パラメータで指定された形式（デフォルトは PNG）で画像の表現を含むデータ URI を返します。返される画像は 96 dpi の解像度です。 |
