---
title: "HTMLAnchorElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.HTMLAnchorElement クラス。アンカー要素です。HTML 4.01 の A 要素の定義を参照してください。"
type: docs

url: /ja/java/com.aspose.html/htmlanchorelement/
---
## HTMLAnchorElement class

anchor 要素です。HTML 4.01 の A 要素定義を参照してください。
...
| [getOrigin](../../com.aspose.html/htmlanchorelement/origin/) 関連付けられた URL のオリジンセグメントの文字列表現を取得します。 |
[getOuterHTML]
...
| [getRelList](../../com.aspose.html/htmlanchorelement/rellist/) 「rel」属性の解析から得られたトークンを含むライブ DOMTokenList を返します。 |
[getRev]
...
| [blur](../../com.aspose.html/htmlanchorelement/blur/)() | この要素からキーボードフォーカスを削除します。 |
...
| [focus](../../com.aspose.html/htmlanchorelement/focus/)() | この要素にキーボードフォーカスを設定します。 |
