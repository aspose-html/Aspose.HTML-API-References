---
title: "HTMLUListElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.HTMLUListElement クラス。順序なしリストです。HTML 4.01 の UL 要素の定義を参照してください。"
type: docs

url: /ja/java/com.aspose.html/htmlulistelement/
---
## HTMLUListElement class

順序なしリストです。HTML 4.01 の UL 要素定義を参照してください。
