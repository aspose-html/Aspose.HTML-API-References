...
| [delete](../../com.aspose.html/iurlsearchparams/delete/)(String) | 名前が `name` のすべての名前-値ペアを削除します。 |
| [get](../../com.aspose.html/iurlsearchparams/get/)(String) | 名前が `name` の最初の名前-値ペアの値を返します。 |
| [getAll](../../com.aspose.html/iurlsearchparams/getall/)(String) | 名前が `name` のすべての値を返します。 |
| [has](../../com.aspose.html/iurlsearchparams/has/)(String) | リストに名前が `name` の名前-値ペアがあるかどうかを確認します。 |
