---
title: "HTMLMenuElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.HTMLMenuElement クラス。メニューリストです。HTML 4.01 の MENU 要素の定義をご覧ください。この要素は HTML 4.01 で非推奨です。"
type: docs

url: /ja/java/com.aspose.html/htmlmenuelement/
---
## HTMLMenuElement class

メニューリストです。HTML 4.01 の MENU 要素定義を参照してください。この要素は HTML 4.01 で廃止されています。
