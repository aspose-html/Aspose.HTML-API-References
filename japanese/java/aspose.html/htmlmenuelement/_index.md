...
description: "com.aspose.html.HTMLMenuElement クラス。メニューリストです。HTML 4.01 の MENU 要素定義を参照してください。この要素は HTML 4.01 で非推奨です。"
type: docs
...
メニューリスト。HTML 4.01 の MENU 要素定義を参照してください。この要素は HTML 4.01 で非推奨です。
