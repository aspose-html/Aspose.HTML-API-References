...
description: "com.aspose.html.HTMLBaseElement クラス。文書のベース URI は IETF RFC 2396 に準拠。HTML 4.01 の BASE 要素定義を参照してください"
type: docs
...
ドキュメントの基本 URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt)]です。HTML 4.01 の BASE 要素定義を参照してください。
