---
title: "HTMLLabelElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.HTMLLabelElement クラス。フォームフィールドのラベルテキストです。HTML 4.01 の LABEL 要素定義を参照してください"
type: docs

url: /ja/java/com.aspose.html/htmllabelelement/
---
## HTMLLabelElement class

フォームフィールドのラベルテキストです。HTML 4.01 の LABEL 要素定義を参照してください。
...
| [getForm](../../com.aspose.html/htmllabelelement/form/) このコントロールを含む `FORM` 要素を返します。コントロールがフォームのコンテキスト内にない場合は `null` を返します。 |
[getId]
