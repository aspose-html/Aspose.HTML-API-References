---
title: "HTMLTableSectionElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.HTMLTableSectionElement クラス。THEAD、TFOOT、TBODYelements"
type: docs

url: /ja/java/com.aspose.html/htmltablesectionelement/
---
## HTMLTableSectionElement class

`THEAD`、`TFOOT`、および `TBODY` 要素です。
...
| [getRows](../../com.aspose.html/htmltablesectionelement/rows/) このテーブルセクションの行のコレクションです。 |
...
| [deleteRow](../../com.aspose.html/htmltablesectionelement/deleterow/)(int) | このセクションから行を削除します。 |
...
| [insertRow](../../com.aspose.html/htmltablesectionelement/insertrow/)(int) | このセクションに行を挿入します。新しい行はこのセクションの現在の `index` 番目の行の直前に挿入されます。`index` が -1 であるか、このセクションの行数と等しい場合、新しい行は末尾に追加されます。 |
