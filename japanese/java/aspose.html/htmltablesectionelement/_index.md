...
description: "com.aspose.html.HTMLTableSectionElement クラス。THEAD、TFOOT、TBODY 要素"
type: docs
...
| [getRows](../../com.aspose.html/htmltablesectionelement/rows/) このテーブルセクションの行コレクションです。 |
...
| [insertRow](../../com.aspose.html/htmltablesectionelement/insertrow/)(int) | このセクションに行を挿入します。新しい行はこのセクションの現在の `index` 番目の行の直前に挿入されます。`index` が -1 またはこのセクションの行数と等しい場合、新しい行は末尾に追加されます。 |
