---
title: "HTMLStyleElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.HTMLStyleElement クラス。スタイル情報。HTML 4.01 の STYLE 要素定義、CSS モジュール DOM Level 2 Style Sheets and CSS、そして StyleSheets モジュール DOM Level 2 Style Sheets and CSS の LinkStyle インターフェイスをご参照ください。"
type: docs

url: /ja/java/com.aspose.html/htmlstyleelement/
---
## HTMLStyleElement class

スタイル情報です。HTML 4.01 の STYLE 要素定義、CSS モジュール [[DOM Level 2 Style Sheets and CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113)]、および StyleSheets モジュールの `LinkStyle` インターフェイス [[DOM Level 2 Style Sheets and CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113)] を参照してください。
...
| [getSheet](../../com.aspose.html/htmlstyleelement/sheet/) 関連付けられたスタイルシートを取得します。 |
