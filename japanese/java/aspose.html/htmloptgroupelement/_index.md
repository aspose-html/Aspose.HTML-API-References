---
title: "HTMLOptGroupElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.HTMLOptGroupElement クラス。オプションを論理的なサブディビジョンでグループ化します。HTML 4.01 の OPTGROUP 要素定義を参照してください"
type: docs

url: /ja/java/com.aspose.html/htmloptgroupelement/
---
## HTMLOptGroupElement class

オプションを論理的な区分にまとめます。HTML 4.01 の OPTGROUP 要素定義を参照してください。
