---
title: "HTMLFrameSetElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.HTMLFrameSetElement クラス。フレームのグリッドを作成します。HTML 4.01 の FRAMESET 要素の定義を参照してください。"
type: docs

url: /ja/java/com.aspose.html/htmlframesetelement/
---
## HTMLFrameSetElement class

フレームのグリッドを作成します。HTML 4.01 の FRAMESET 要素定義を参照してください。
