---
title: "HTMLHtmlElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.HTMLHtmlElement クラス。HTML ドキュメントのルートです。HTML 4.01 の HTML 要素定義を参照してください。"
type: docs

url: /ja/java/com.aspose.html/htmlhtmlelement/
---
## HTMLHtmlElement class

HTML ドキュメントのルートです。HTML 4.01 の HTML 要素定義を参照してください。
