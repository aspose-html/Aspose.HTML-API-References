...
description: "Uint8ClampedArray コンストラクタ。Uint8ClampedArray クラスの新しいインスタンスを初期化します"
type: docs

url: /ja/java/com.aspose.html/uint8clampedarray/uint8clampedarray/
---
## Uint8ClampedArray(int) {#constructor_4}

[`Uint8ClampedArray`](../) クラスの新しいインスタンスを初期化します。
