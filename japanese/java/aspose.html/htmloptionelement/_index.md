---
title: "HTMLOptionElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.HTMLOptionElement クラス。選択可能な選択肢です。HTML 4.01 の OPTION 要素の定義を参照してください。"
type: docs

url: /ja/java/com.aspose.html/htmloptionelement/
---
## HTMLOptionElement class

選択可能な項目です。HTML 4.01 の OPTION 要素定義を参照してください。
...
| [getForm](../../com.aspose.html/htmloptionelement/form/) このコントロールを含む `FORM` 要素を返します。コントロールがフォームのコンテキスト内にない場合は `null` を返します。 |
[getId]
[setId] The element's identifier. See the id attribute definition in HTML 4.01. |
| [getIndex](../../com.aspose.html/htmloptionelement/index/) この `OPTION` が親 `SELECT` 内で占めるインデックスを 0 から開始して返します。@version DOM Level 2 |
[getInnerHTML]
...
| [getText](../../com.aspose.html/htmloptionelement/text/) オプション要素内に含まれるテキストを返します。 |
