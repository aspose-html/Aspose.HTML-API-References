---
title: "HTMLTableCellElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.HTMLTableCellElement クラス。TH と TD 要素を表すために使用されるオブジェクトです。HTML 4.01 の TD 要素定義を参照してください。"
type: docs

url: /ja/java/com.aspose.html/htmltablecellelement/
---
## HTMLTableCellElement class

`TH` と `TD` 要素を表すオブジェクトです。HTML 4.01 の TD 要素定義を参照してください。
...
| [getCellIndex](../../com.aspose.html/htmltablecellelement/cellindex/) このセルの行内でのインデックスで、0 から始まります。このインデックスは文書ツリーの順序であり、表示順序ではありません。 |
[getCh]
