---
title: "HTMLFrameElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.HTMLFrameElement クラス。フレームを作成します。HTML 4.01 の FRAME 要素定義を参照してください"
type: docs

url: /ja/java/com.aspose.html/htmlframeelement/
---
## HTMLFrameElement class

フレームを作成します。HTML 4.01 の FRAME 要素定義を参照してください。
...
| [getContentDocument](../../com.aspose.html/htmlframeelement/contentdocument/) このフレームが含むドキュメント（存在し、利用可能な場合）。利用できない場合は `null` が返ります。@since DOM Level 2 |
[getDir]
