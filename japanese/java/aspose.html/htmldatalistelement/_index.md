---
title: "HTMLDataListElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.HTMLDataListElement クラス。datalist 要素は、他のコントロール用に事前定義されたオプションを表す option 要素の集合を表します。HTML 5.2 の W3C 推奨事項も参照してください。"
type: docs

url: /ja/java/com.aspose.html/htmldatalistelement/
---
## HTMLDataListElement class

datalist 要素は、他のコントロール用に事前定義されたオプションを表す option 要素の集合を表します。こちらも [HTML 5.2 W3C Recommendation](https://www.w3.org/TR/html52/sec-forms.html#elementdef-datalist) を参照してください。
...
| [getOptions](../../com.aspose.html/htmldatalistelement/options/) この要素が含む `OPTION` 要素のコレクションです。 |
[getOuterHTML]
