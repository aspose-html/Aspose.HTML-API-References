---
title: "HTMLBRElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.HTMLBRElement クラス。改行を強制します。HTML 4.01 の BR 要素定義を参照してください"
type: docs
url: /ja/java/com.aspose.html/htmlbrelement/
---
## HTMLBRElement class

改行を強制します。HTML 4.01 の BR 要素定義を参照してください。
