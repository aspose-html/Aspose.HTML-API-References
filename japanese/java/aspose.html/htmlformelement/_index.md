---
title: "HTMLFormElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.HTMLFormElement クラス。FORM 要素はコレクションと要素に似た動作を包括します。含まれるフォームコントロールへの直接アクセスとフォーム要素の属性へのアクセスを提供します。HTML 4.01 の FORM 要素定義を参照してください。"
type: docs

url: /ja/java/com.aspose.html/htmlformelement/
---
## HTMLFormElement class

`FORM` 要素は、コレクションと要素に似た動作を包含します。含まれるフォームコントロールやフォーム要素の属性へ直接アクセスできます。HTML 4.01 の FORM 要素定義を参照してください。
...
| [getElements](../../com.aspose.html/htmlformelement/elements/) フォーム内のすべてのフォームコントロール要素のコレクションを返します。 |
[getEnctype]
...
| [getLength](../../com.aspose.html/htmlformelement/length/) フォーム内のフォームコントロールの数です。 |
...
| [reset](../../com.aspose.html/htmlformelement/reset/)() | フォーム要素のデフォルト値を復元します。リセットボタンと同じ動作を行います。 |
...
| [submit](../../com.aspose.html/htmlformelement/submit/)() | フォームを送信します。サブミットボタンと同じ動作を行います。 |
