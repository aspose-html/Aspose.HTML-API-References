---
title: "HTMLFontElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.HTMLFontElement クラス。フォントへのローカル変更。HTML 4.01 の FONT 要素定義を参照してください。この要素は HTML 4.01 で非推奨です"
type: docs

url: /ja/java/com.aspose.html/htmlfontelement/
---
## HTMLFontElement class

フォントのローカル変更。HTML 4.01 の FONT 要素定義を参照してください。この要素は HTML 4.01 で非推奨です。
