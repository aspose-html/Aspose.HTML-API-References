---
title: "HTMLMetaElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.HTMLMetaElement クラス。ドキュメントに関する一般的なメタ情報を含みます。HTML 4.01 の META 要素定義を参照してください。"
type: docs

url: /ja/java/com.aspose.html/htmlmetaelement/
---
## HTMLMetaElement class

これは文書に関する一般的なメタ情報を含みます。HTML 4.01 の META 要素定義を参照してください。
