...
description: "com.aspose.html.HTMLMetaElement クラス。ドキュメントに関する一般的なメタ情報が含まれます。HTML 4.01 の META 要素の定義を参照してください。"
type: docs
...
文書に関する一般的なメタ情報を含みます。HTML 4.01 の META 要素定義を参照してください。
