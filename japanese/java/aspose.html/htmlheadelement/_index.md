---
title: "HTMLHeadElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.HTMLHeadElement クラス。ドキュメントのヘッド情報です。HTML 4.01 の HEAD 要素の定義をご覧ください。"
type: docs

url: /ja/java/com.aspose.html/htmlheadelement/
---
## HTMLHeadElement class

ドキュメントのヘッド情報。HTML 4.01 の HEAD 要素定義を参照してください。
