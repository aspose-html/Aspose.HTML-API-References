---
title: "HTMLButtonElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.HTMLButtonElement クラス。プッシュボタンです。HTML 4.01 の BUTTON 要素の定義をご覧ください。"
type: docs

url: /ja/java/com.aspose.html/htmlbuttonelement/
---
## HTMLButtonElement class

ボタンを押してください。HTML 4.01 の BUTTON 要素定義を参照してください。
...
| [getForm](../../com.aspose.html/htmlbuttonelement/form/) このコントロールを含む `FORM` 要素を返します。コントロールがフォームのコンテキスト内にない場合は `null` を返します。 |
[getId]
