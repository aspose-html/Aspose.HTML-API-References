---
title: "HTMLElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.HTMLElement クラス。このクラスからすべての HTML 要素インターフェイスが派生します。HTML のコア属性のみを公開する要素は基本 HTMLElement インターフェイスで表されます。これらの要素は以下の通りです: 特別な SUB SUP SPAN BDO font TT I B U S STRIKE BIG SMALL phrase EM STRONG DFN CODE SAMP KBD VAR CITE ACRONYM ABBR list DD DT NOFRAMES NOSCRIPT ADDRESS CENTER。HTML 要素の style 属性は、CSS モジュール DOM Level 2 Style Sheets と CSS で定義されている ElementCSSInlineStyle インターフェイスを通じてアクセスできます。"
type: docs

url: /ja/java/com.aspose.html/htmlelement/
---
## HTMLElement class

すべての HTML 要素インターフェイスはこのクラスから派生します。HTML のコア属性のみを公開する要素は、基本の `HTMLElement` インターフェイスで表されます。これらの要素は次のとおりです: special: SUB, SUP, SPAN, BDO; font: TT, I, B, U, S, STRIKE, BIG, SMALL; phrase: EM, STRONG, DFN, CODE, SAMP, KBD, VAR, CITE, ACRONYM, ABBR; list: DD, DT; NOFRAMES, NOSCRIPT, ADDRESS, CENTER. HTML 要素の `style` 属性は、CSS モジュールで定義されている `ElementCSSInlineStyle` インターフェイスを通じてアクセスできます。[[DOM Level 2 Style Sheets and CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113)]
