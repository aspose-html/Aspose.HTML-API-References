---
title: "HTMLQuoteElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.HTMLQuoteElement クラス。Q および BLOCKQUOTE 要素用です。HTML 4.01 の Q 要素定義を参照してください"
type: docs

url: /ja/java/com.aspose.html/htmlquoteelement/
---
## HTMLQuoteElement class

`Q` と `BLOCKQUOTE` 要素用です。HTML 4.01 の Q 要素定義を参照してください。
