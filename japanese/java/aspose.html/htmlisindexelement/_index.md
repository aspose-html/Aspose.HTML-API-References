---
title: "HTMLIsIndexElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.HTMLIsIndexElement クラス。この要素は単一行テキスト入力に使用されます。HTML 4.01 の ISINDEX 要素定義を参照してください。この要素は HTML 4.01 で非推奨です。"
type: docs

url: /ja/java/com.aspose.html/htmlisindexelement/
---
## HTMLIsIndexElement class

この要素は単一行テキスト入力に使用されます。HTML 4.01 の ISINDEX 要素定義を参照してください。この要素は HTML 4.01 で非推奨です。
...
| [getForm](../../com.aspose.html/htmlisindexelement/form/) は返します。 |
[getId]
