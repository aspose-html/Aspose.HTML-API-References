---
title: "HTMLHeadingElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.HTMLHeadingElement クラス。H1 から H6 の要素用です。HTML 4.01 の H1 要素定義を参照してください。"
type: docs

url: /ja/java/com.aspose.html/htmlheadingelement/
---
## HTMLHeadingElement class

`H1` から `H6` 要素について。HTML 4.01 の H1 要素の定義を参照してください。
