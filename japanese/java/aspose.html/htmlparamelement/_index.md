---
title: "HTMLParamElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.HTMLParamElement クラス。OBJECT 要素に渡されるパラメータです。HTML 4.01 の PARAM 要素定義を参照してください"
type: docs

url: /ja/java/com.aspose.html/htmlparamelement/
---
## HTMLParamElement class

`OBJECT` 要素に渡されるパラメータです。HTML 4.01 の PARAM 要素定義を参照してください。
