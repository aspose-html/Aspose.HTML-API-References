...
description: "com.aspose.html.HTMLParamElement クラス。OBJECT 要素に供給されるパラメータです。HTML 4.01 の PARAM 要素定義を参照してください。"
type: docs
...
`OBJECT` 要素に供給されるパラメータ。HTML 4.01 の PARAM 要素定義を参照してください。
