---
title: "HTMLBodyElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.HTMLBodyElement クラス。HTML ドキュメントの本文。この要素は、ソースドキュメントにタグがなくても DOM API で常に存在します。HTML 4.01 の BODY 要素定義を参照してください。"
type: docs

url: /ja/java/com.aspose.html/htmlbodyelement/
---
## HTMLBodyElement class

HTML ドキュメントの body です。この要素は DOM API で常に存在し、ソースドキュメントにタグがなくても利用できます。HTML 4.01 の BODY 要素定義を参照してください。
