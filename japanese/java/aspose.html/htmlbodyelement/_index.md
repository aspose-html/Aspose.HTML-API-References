...
description: "com.aspose.html.HTMLBodyElement クラス。HTML ドキュメントの本文。この要素は、ソース文書にタグがなくても DOM API では常に存在します。HTML 4.01 の BODY 要素定義を参照してください。"
type: docs
...
HTML ドキュメントの body です。この要素は DOM API では常に存在し、ソースドキュメントにタグがなくても利用可能です。HTML 4.01 の BODY 要素定義を参照してください。
