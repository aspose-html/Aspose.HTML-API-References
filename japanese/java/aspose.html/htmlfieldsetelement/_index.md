---
title: "HTMLFieldSetElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.HTMLFieldSetElement クラス。フォームコントロールを論理的なグループに整理します。HTML 4.01 の FIELDSET 要素定義を参照してください"
type: docs

url: /ja/java/com.aspose.html/htmlfieldsetelement/
---
## HTMLFieldSetElement class

フォームコントロールを論理的なグループに整理します。HTML 4.01 の FIELDSET 要素定義を参照してください。
...
| [getForm](../../com.aspose.html/htmlfieldsetelement/form/) このコントロールを含む `FORM` 要素を返します。フォームのコンテキスト内にない場合は `null` を返します。 |
[getId]
