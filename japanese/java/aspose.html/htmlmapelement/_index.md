---
title: "HTMLMapElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.HTMLMapElement クラス。クライアント側イメージマップです。HTML 4.01 の MAP 要素の定義を参照してください。"
type: docs

url: /ja/java/com.aspose.html/htmlmapelement/
---
## HTMLMapElement class

クライアント側のイメージマップです。HTML 4.01 の MAP 要素定義を参照してください。
...
| 名前 | 説明 |
| --- | --- |
| [getAreas](../../com.aspose.html/htmlmapelement/areas/) イメージマップ用に定義されたエリアの一覧を返します。 |
