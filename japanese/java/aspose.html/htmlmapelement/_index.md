...
description: "com.aspose.html.HTMLMapElement クラス。クライアント側イメージマップです。HTML 4.01 の MAP 要素定義を参照してください。"
type: docs
...
クライアント側イメージマップ。HTML 4.01 の MAP 要素定義を参照してください。
...
| 名前 | 説明 |
| --- | --- |
| [getAreas](../../com.aspose.html/htmlmapelement/areas/) イメージマップ用に定義された領域のリストを取得します。 |
