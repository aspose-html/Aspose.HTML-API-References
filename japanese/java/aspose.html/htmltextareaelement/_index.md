---
title: "HTMLTextAreaElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.HTMLTextAreaElement クラス。複数行テキストフィールドです。HTML 4.01 の TEXTAREA 要素定義を参照してください。"
type: docs

url: /ja/java/com.aspose.html/htmltextareaelement/
---
## HTMLTextAreaElement class

複数行テキストフィールドです。HTML 4.01 の TEXTAREA 要素定義を参照してください。
...
| [getForm](../../com.aspose.html/htmltextareaelement/form/) このコントロールを含む `FORM` 要素を返します。コントロールがフォームのコンテキスト内にない場合は `null` を返します。 |
[getId]
...
| [getType](../../com.aspose.html/htmltextareaelement/type/) このフォームコントロールのタイプです。文字列 \"textarea\" です。 |
[getValue]
