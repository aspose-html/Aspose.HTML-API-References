...
description: "com.aspose.html.HTMLDirectoryElement クラス。ディレクトリリスト。HTML 4.01 の DIR 要素定義を参照してください。この要素は HTML 4.01 で非推奨です"
type: docs
...
ディレクトリリスト。HTML 4.01 の DIR 要素の定義を参照してください。この要素は HTML 4.01 で非推奨です。
