...
description: "com.aspose.html.HTMLSelectElement クラス。select 要素はオプションの選択を可能にします。含まれるオプションは、select 要素を通じてコレクションとして直接アクセスできます。HTML 4.01 の SELECT 要素の定義をご覧ください"
type: docs
...
select 要素はオプションの選択を可能にします。含まれるオプションはコレクションとして select 要素から直接アクセスできます。HTML 4.01 の SELECT 要素定義を参照してください。
...
| [getOptions](../../com.aspose.html/htmlselectelement/options/) この要素が含む `OPTION` 要素のコレクションです。 @version DOM Level 2 |
[getOuterHTML]
