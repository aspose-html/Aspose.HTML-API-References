---
title: "HTMLSelectElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.HTMLSelectElement クラス。select 要素はオプションの選択を可能にします。含まれるオプションは、select 要素を通じてコレクションとして直接アクセスできます。HTML 4.01 の SELECT 要素定義を参照してください。"
type: docs

url: /ja/java/com.aspose.html/htmlselectelement/
---
## HTMLSelectElement class

select 要素はオプションの選択を可能にします。含まれるオプションは select 要素をコレクションとして直接アクセスできます。HTML 4.01 の SELECT 要素定義を参照してください。
...
| [getForm](../../com.aspose.html/htmlselectelement/form/) この `SELECT` のオプション数。 |
[getId]
...
| [getOptions](../../com.aspose.html/htmlselectelement/options/) この要素が含む `OPTION` 要素のコレクション。 @version DOM Level 2 |
[getOuterHTML]
...
| [getType](../../com.aspose.html/htmlselectelement/type/) このフォームコントロールのタイプです。multiple 属性が `true` の場合は文字列 "select-multiple"、`false` の場合は文字列 "select-one" になります。 |
[getValue]
