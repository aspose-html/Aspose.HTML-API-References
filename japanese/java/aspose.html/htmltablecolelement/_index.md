---
title: "HTMLTableColElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.HTMLTableColElement クラス。COL および COLGROUP 要素を再グループ化します。HTML 4.01 の COL 要素定義を参照してください"
type: docs

url: /ja/java/com.aspose.html/htmltablecolelement/
---
## HTMLTableColElement class

`COL` と `COLGROUP` 要素を再編成します。HTML 4.01 の COL 要素定義を参照してください。
