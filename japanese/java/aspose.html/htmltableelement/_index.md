---
title: "HTMLTableElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.HTMLTableElement クラス。テーブル上の作成および削除メソッドにより、作者はテーブルを構築および変更できます。HTML 4.01 では、テーブル内に CAPTION、THEAD、TFOOT 要素はそれぞれ最大1つしか存在できないと規定されています。そのため、要素が存在し、createTHead または createTFoot メソッドが呼び出された場合、メソッドは既存の THead または TFoot 要素を返します。HTML 4.01 の TABLE 要素定義をご参照ください。"
type: docs

url: /ja/java/com.aspose.html/htmltableelement/
---
## HTMLTableElement class

テーブル上の create* および delete* メソッドは、作者がテーブルを構築および変更できるようにします。[[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224)] は、テーブル内に `CAPTION`、`THEAD`、`TFOOT` 要素がそれぞれ最大1つしか存在できないことを指定しています。そのため、既に存在し、createTHead() または createTFoot() メソッドが呼び出された場合、メソッドは既存の THead または TFoot 要素を返します。HTML 4.01 の TABLE 要素定義を参照してください。

また、[Document object Model (DOM) Level 2 HTML Specification](http://www.w3.org/TR/2003/REC-DOM-Level-2-HTML-20030109) も参照してください。
...
| [getCaption](../../com.aspose.html/htmltableelement/caption/) テーブルの `CAPTION` を返します。存在しない場合は void を返します。 @version DOM Level 2 |
[getCellPadding]
...
| [getRows](../../com.aspose.html/htmltableelement/rows/) テーブルの `TFOOT` を返します。存在しない場合は `null` を返します。 |
[getRules]
...
| [getStyle](../../com.aspose.html/htmlelement/style/) は、作者が特定の要素に直接スタイル情報を適用できるスタイル属性を表します。 |
[getSummary]
...
| [getTBodies](../../com.aspose.html/htmltableelement/tbodies/) テーブル本体のコレクション（暗黙的なものを含む）を返します。 |
...
| [getTFoot](../../com.aspose.html/htmltableelement/tfoot/) テーブルの `THEAD` を返します。存在しない場合は `null` を返します。 |
| [getTHead](../../com.aspose.html/htmltableelement/thead/) テーブルの `CAPTION` を返します。存在しない場合は void を返します。 |
[getTitle]
...
| [createCaption](../../com.aspose.html/htmltableelement/createcaption/)() | 新しいテーブルキャプションオブジェクトを作成するか、既存のものを返します。 |
| [createTFoot](../../com.aspose.html/htmltableelement/createtfoot/)() | テーブルフッタ行を作成するか、既存のものを返します。 |
| [createTHead](../../com.aspose.html/htmltableelement/createthead/)() | テーブルヘッダ行を作成するか、既存のものを返します。 |
| [deleteCaption](../../com.aspose.html/htmltableelement/deletecaption/)() | テーブルキャプションが存在する場合は削除します。 |
| [deleteRow](../../com.aspose.html/htmltableelement/deleterow/)(int) | テーブル行を削除します。 |
| [deleteTFoot](../../com.aspose.html/htmltableelement/deletetfoot/)() | テーブルにフッタが存在する場合は削除します。 |
| [deleteTHead](../../com.aspose.html/htmltableelement/deletethead/)() | テーブルにヘッダが存在する場合は削除します。 |
...
| [insertRow](../../com.aspose.html/htmltableelement/insertrow/)(int) | テーブルに新しい空の行を挿入します。新しい行はテーブル内の現在の `index` 番目の行の直前、同じセクションに挿入されます。`index` が -1 もしくは行数と同じ場合、新しい行は末尾に追加されます。さらに、テーブルが空の場合、行は作成されテーブルに挿入される `TBODY` に挿入されます。テーブル行は [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224)] によれば空にできません。 |
