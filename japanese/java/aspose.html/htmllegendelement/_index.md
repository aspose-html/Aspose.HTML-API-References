...
description: "com.aspose.html.HTMLLegendElement クラス。FIELDSET グループのキャプションを提供します。HTML 4.01 の LEGEND 要素の定義を参照してください。"
type: docs
...
`FIELDSET` グループのキャプションを提供します。HTML 4.01 の LEGEND 要素の定義を参照してください。
...
| [getForm](../../com.aspose.html/htmllegendelement/form/) このコントロールを含む `FORM` 要素を返します。フォームのコンテキスト内にこのコントロールがない場合は `null` を返します。 |
[getId]
