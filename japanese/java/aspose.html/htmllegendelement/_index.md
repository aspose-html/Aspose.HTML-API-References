---
title: "HTMLLegendElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.HTMLLegendElement クラス。FIELDSET グループのキャプションを提供します。HTML 4.01 の LEGEND 要素定義を参照してください。"
type: docs

url: /ja/java/com.aspose.html/htmllegendelement/
---
## HTMLLegendElement class

`FIELDSET` グループのキャプションを提供します。HTML 4.01 の LEGEND 要素定義を参照してください。
...
| [getForm](../../com.aspose.html/htmllegendelement/form/) このコントロールを含む `FORM` 要素を返します。コントロールがフォームのコンテキスト内にない場合は `null` を返します。 |
[getId]
