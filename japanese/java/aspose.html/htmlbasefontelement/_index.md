---
title: "HTMLBaseFontElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.HTMLBaseFontElement クラス。基本フォントです。HTML 4.01 の BASEFONT 要素定義を参照してください。この要素は HTML 4.01 で非推奨です。"
type: docs

url: /ja/java/com.aspose.html/htmlbasefontelement/
---
## HTMLBaseFontElement class

Base フォントです。HTML 4.01 の BASEFONT 要素定義を参照してください。この要素は HTML 4.01 で非推奨です。
