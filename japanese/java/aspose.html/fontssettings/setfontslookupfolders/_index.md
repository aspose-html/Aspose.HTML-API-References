...
description: "FontsSettings メソッド。フォント選択時に使用されるフォルダーの配列を設定します。"
type: docs

url: /ja/java/com.aspose.html/fontssettings/setfontslookupfolders/
---
## SetFontsLookupFolders(String[]) {#setfontslookupfolders}

フォント選択時に使用されるフォルダーの配列を設定します。
...
| Parameter | Type | 説明 |
| --- | --- | --- |
| fontsFolders | String[] | フォント フォルダーです。 |
...
| --- | --- | --- |
| fontsFolders | String[] | フォント フォルダーです。 |
| 再帰的 | Boolean | `true` に設定すると、すべてのネストされたディレクトリが使用されます。デフォルト値は `false` です。 |
