---
title: "HTMLAreaElement クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.HTMLAreaElement クラス。クライアント側イメージマップ領域の定義です。HTML 4.01 の AREA 要素定義を参照してください"
type: docs

url: /ja/java/com.aspose.html/htmlareaelement/
---
## HTMLAreaElement class

クライアント側イメージマップのエリア定義です。HTML 4.01 の AREA 要素定義を参照してください。
...
| [getRelList](../../com.aspose.html/htmlareaelement/rellist/) 解析された "rel" 属性から取得されたトークンを含むライブ DOMTokenList を返します。 |
