...
description: "WebAccessibility メソッド。特定のルールに対して、ValidationBuilder.All オブジェクトの完全なパラメータが与えられたときに AccessibilityValidator インスタンスが作成されます。"
type: docs

url: /ja/java/com.aspose.html.accessibility/webaccessibility/createvalidator/
---
## CreateValidator(IRule) {#createvalidator_1}

ValidationBuilder.All オブジェクトの完全なパラメータが与えられた特定のルール用に AccessibilityValidator インスタンスが作成されます。
...
| パラメータ | 型 | 説明 |
| --- | --- | --- |
| ルール | IRule | IRule インターフェイスを実装したルールのオブジェクト |

### 戻り値

AccessibilityValidator オブジェクト
...
AccessibilityValidator インスタンスを作成する
...
| --- | --- | --- |
| ルール | IRule | IRule インターフェイスを実装したルールのオブジェクト |
| ビルダー | ValidationBuilder | ValidationBuilder オブジェクト |
...
| --- | --- | --- |
| ルール | IRule | IRule インターフェイスを実装したルールのオブジェクト |
| ビルダー | Action`1 | ValidationBuilder オブジェクトを返すメソッド |
...
AccessibilityValidator インスタンスは、ValidationBuilder.All オブジェクトを使用してすべてのルールに従って作成されます。
...
特定のルールリスト用に AccessibilityValidator インスタンスが作成されます。
