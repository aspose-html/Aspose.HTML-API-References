...
description: "Path2D メソッド。パスに楕円を追加します。楕円は x y の位置を中心とし、半径 radiusX と radiusY で、startAngle から開始し endAngle で終了し、指定された方向（anticlockwise、デフォルトは clockwise）で描画されます。"
type: docs
