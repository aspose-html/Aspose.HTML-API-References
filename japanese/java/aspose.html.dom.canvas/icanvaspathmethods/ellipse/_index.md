...
description: "ICanvasPathMethods メソッド。パスに楕円を追加します。楕円は x y 位置を中心とし、半径 radiusX と radiusY を持ち、startAngle から始まり endAngle で終わります。方向はデフォルトで時計回りですが、反時計回りに指定することもできます。"
type: docs
