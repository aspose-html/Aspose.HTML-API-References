...
description: "ICanvasRenderingContext2D のメソッド。指定された CanvasImageSource 画像を使用してパターンを作成します。repetition 引数で指定された方向にソースを繰り返します。"
type: docs

url: /ja/java/com.aspose.html.dom.canvas/icanvasrenderingcontext2d/createpattern/
---
## CreatePattern(HTMLImageElement, String) {#createpattern_1}

指定された画像（CanvasImageSource）を使用してパターンを作成します。繰り返し引数で指定された方向にソースを繰り返します。
...
| Parameter | Type | 説明 |
| --- | --- | --- |
| 画像 | HTMLImageElement | 繰り返しに使用する画像としての HTMLImageElement。 |
| repetition | 文字列 | 画像の繰り返し方法を示す String。 |
...
| Parameter | Type | 説明 |
| --- | --- | --- |
| 画像 | HTMLCanvasElement | 繰り返しに使用する画像としての HTMLCanvasElement。 |
| repetition | 文字列 | 画像の繰り返し方法を示す String。 |
