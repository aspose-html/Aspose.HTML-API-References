---
title: "ICanvasDrawingStyles インターフェイス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.dom.canvas.ICanvasDrawingStyles インターフェイス。ICanvasDrawingStyles インターフェイスは、線の描画方法やテキストのレイアウト方法を制御するメソッドとプロパティを提供します。"
type: docs

url: /ja/java/com.aspose.html.dom.canvas/icanvasdrawingstyles/
---
## ICanvasDrawingStyles interface

ICanvasDrawingStyles インターフェイスは、線の描画方法やテキストの配置方法を制御するメソッドとプロパティを提供します。
...
| 名前 | 説明 |
| --- | --- |
| [getLineDash](../../com.aspose.html.dom.canvas/icanvasdrawingstyles/getlinedash/)() | 現在のラインダッシュパターン配列を返します。この配列は偶数個の非負数で構成されています。 |
| [setLineDash](../../com.aspose.html.dom.canvas/icanvasdrawingstyles/setlinedash/)(double[]) | 現在のラインダッシュパターンを設定します。 |
