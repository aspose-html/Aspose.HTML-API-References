...
description: "com.aspose.html.collections.DOMTokenList クラス。DOMTokenList クラスはスペースで区切られたトークンの集合を表します。JavaScript の Array オブジェクトと同様に 0 からインデックス付けされます。DOMTokenList は常に大文字小文字を区別します。"
type: docs
...
| [contains](../../com.aspose.html.collections/domtokenlist/contains/)(String) | リストが指定されたトークンを含む場合は true、そうでなければ false を返します。 |
