...
description: "SourceTextReader メソッド。Dispose インターフェイスを定義します"
type: docs

url: /ja/java/com.aspose.html.toolkit.markdown.syntax.text/sourcetextreader/dispose/
---
## SourceTextReader.Dispose method

Dispose インターフェイスを定義します。
