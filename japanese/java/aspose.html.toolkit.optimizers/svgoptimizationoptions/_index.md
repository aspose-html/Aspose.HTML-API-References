---
title: "SVGOptimizationOptions クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.toolkit.optimizers.SVGOptimizationOptions クラス。SVGOptimizationOptions は、SVG ドキュメントを最適化するためのオプションを格納するクラスです"
type: docs

url: /ja/java/com.aspose.html.toolkit.optimizers/svgoptimizationoptions/
---
## SVGOptimizationOptions class

SVGOptimizationOptions は、SVG ドキュメントを最適化するためのオプションを格納するクラスです。
...
| 名前 | 説明 |
| --- | --- |
| [SVGOptimizationOptions](svgoptimizationoptions/)() | `SVGOptimizationOptions` クラスの新しいインスタンスを初期化します。 |
