...
url: /ja/java/com.aspose.html.rendering.image/imagedevice/imagedevice/
---
...
レンダリング オプションとストリーム プロバイダーで [`ImageDevice`](../) クラスの新しいインスタンスを初期化します。
...
| Parameter | Type | 説明 |
| --- | --- | --- |
| options | ImageRenderingOptions | レンダリングオプション。 |
...
レンダリング オプションと出力ファイル名で [`ImageDevice`](../) クラスの新しいインスタンスを初期化します。
...
レンダリング オプションと出力ストリームで [`ImageDevice`](../) クラスの新しいインスタンスを初期化します。
