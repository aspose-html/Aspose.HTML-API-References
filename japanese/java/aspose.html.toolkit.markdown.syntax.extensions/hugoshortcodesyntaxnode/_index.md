---
title: "HugoShortCodeSyntaxNode クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.toolkit.markdown.syntax.extensions.HugoShortCodeSyntaxNode クラス。 HugoShortCodeSyntaxNode を定義します"
type: docs

url: /ja/java/com.aspose.html.toolkit.markdown.syntax.extensions/hugoshortcodesyntaxnode/
---
...
| 名前 | 説明 |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/inlinecontainersyntaxnode/accept/)(MarkdownSyntaxVisitor) | ビジターを受け入れるためのインターフェイスを定義します。 |
...
| [getEnumerator](../../com.aspose.html.toolkit.markdown.syntax/inlinecontainersyntaxnode/getenumerator/)() | コレクションを反復処理する列挙子を返します。 |
| [getLeadingTrivia](../../com.aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/getleadingtrivia/)() | 先頭のトリビアを取得します。 |
| [getParameter](../../com.aspose.html.toolkit.markdown.syntax.extensions/hugoshortcodesyntaxnode/getparameter/)(int) | GetParameter を定義します |
| [getParametersCount](../../com.aspose.html.toolkit.markdown.syntax.extensions/hugoshortcodesyntaxnode/getparameterscount/)() | GetParametersCount を定義します |
...
| [isEndTag](../../com.aspose.html.toolkit.markdown.syntax.extensions/hugoshortcodesyntaxnode/isendtag/)() | IsEndTag をチェックするインターフェイスを定義します |
