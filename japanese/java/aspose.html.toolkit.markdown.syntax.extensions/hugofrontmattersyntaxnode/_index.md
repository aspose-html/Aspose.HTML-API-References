...
HugoFrontMatterSyntaxNode の基底クラスを定義します。
...
| 抽象 [getFrontMatterRootNode](../../com.aspose.html.toolkit.markdown.syntax.extensions/hugofrontmattersyntaxnode/frontmatterrootnode/) RootNode を取得および設定します。 |
...
| [find](../../com.aspose.html.toolkit.markdown.syntax.extensions/hugofrontmattersyntaxnode/find/#find)(params String[]) | BaseSyntaxNode を検索するインターフェイスを定義します。 |
| abstract [Find&lt;T&gt;](../../com.aspose.html.toolkit.markdown.syntax.extensions/hugofrontmattersyntaxnode/find/#find_1)(params String[]) | T を検索するインターフェイスを定義します。 |
