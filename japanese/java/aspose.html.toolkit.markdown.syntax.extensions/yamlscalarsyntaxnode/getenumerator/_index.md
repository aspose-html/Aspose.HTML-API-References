...
description: "YamlScalarSyntaxNode メソッド。get IEnumerator のインターフェイスを定義します"
type: docs

url: /ja/java/com.aspose.html.toolkit.markdown.syntax.extensions/yamlscalarsyntaxnode/getenumerator/
---
## YamlScalarSyntaxNode.GetEnumerator method

IEnumerator の取得用インターフェイスを定義します
