---
title: "PdfEncryptionInfo クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.rendering.pdf.encryption.PdfEncryptionInfo クラス。PDF 暗号化に関する詳細を含みます"
type: docs

url: /ja/java/com.aspose.html.rendering.pdf.encryption/pdfencryptioninfo/
---
...
| 名前 | 説明 |
| --- | --- |
| [PdfEncryptionInfo](pdfencryptioninfo/)(String, String, PdfPermissions, PdfEncryptionAlgorithm) | 新しい `PdfEncryptionInfo` クラスのインスタンスを初期化します。 |
