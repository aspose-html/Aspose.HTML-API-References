...
description: "com.aspose.html.dom.svg.datatypes.SVGAnimatedNumber クラス。アニメーション可能な基本型 number の属性に使用されます。"
type: docs

url: /ja/java/com.aspose.html.dom.svg.datatypes/svganimatednumber/
---
## SVGAnimatedNumber class

アニメーション可能な number 基本型の属性に使用されます。
...
| [toString](../../com.aspose.html.dom.svg.datatypes/svganimatednumber/toString/)() | このインスタンスを表す文字列を返します。 |
