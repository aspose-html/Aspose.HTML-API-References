---
title: "SVGNumberList クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.dom.svg.datatypes.SVGNumberList クラス。このインターフェイスは SVGNumber オブジェクトのリストを定義します。"
type: docs

url: /ja/java/com.aspose.html.dom.svg.datatypes/svgnumberlist/
---
## SVGNumberList class

このインターフェイスは SVGNumber オブジェクトのリストを定義します。
...
| [toString](../../com.aspose.html.dom.svg.datatypes/svgnumberlist/toString/)() | このインスタンスを表す文字列を返します。 |
