...
description: "com.aspose.html.dom.svg.datatypes.SVGAnimatedEnumeration クラス。特定の列挙体からの定数である必要があり、かつアニメーション化できる属性に使用されます。"
type: docs

url: /ja/java/com.aspose.html.dom.svg.datatypes/svganimatedenumeration/
---
## SVGAnimatedEnumeration class

特定の列挙体からの定数である必要があり、かつアニメーション可能な属性に使用されます。
...
| [toString](../../com.aspose.html.dom.svg.datatypes/svganimatedenumeration/toString/)() | このインスタンスを表す文字列を返します。 |
