---
title: "SVGPointList クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.dom.svg.datatypes.SVGPointList クラス。このインターフェイスは SVGPoint オブジェクトのリストを定義します。"
type: docs

url: /ja/java/com.aspose.html.dom.svg.datatypes/svgpointlist/
---
## SVGPointList class

このインターフェイスは SVGPoint オブジェクトのリストを定義します。
...
| [toString](../../com.aspose.html.dom.svg.datatypes/svgpointlist/toString/)() | このインスタンスを表す文字列を返します。 |
