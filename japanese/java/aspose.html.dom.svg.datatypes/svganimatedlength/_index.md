...
description: "com.aspose.html.dom.svg.datatypes.SVGAnimatedLength クラス。アニメーション可能な基本型 length の属性に使用されます。"
type: docs

url: /ja/java/com.aspose.html.dom.svg.datatypes/svganimatedlength/
---
## SVGAnimatedLength class

アニメーション可能な length 基本型の属性に使用されます。
...
| [toString](../../com.aspose.html.dom.svg.datatypes/svganimatedlength/toString/)() | このインスタンスを表す文字列を返します。 |
