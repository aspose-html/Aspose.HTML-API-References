---
title: "SVGAnimatedAngle クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.dom.svg.datatypes.SVGAnimatedAngle クラス。基本データ型 angle の属性で、アニメーション可能なものに使用されます"
type: docs

url: /ja/java/com.aspose.html.dom.svg.datatypes/svganimatedangle/
---
## SVGAnimatedAngle class

アニメーション可能な angle 基本データ型の属性に使用されます。
...
| [toString](../../com.aspose.html.dom.svg.datatypes/svganimatedangle/toString/)() | このインスタンスを表す文字列を返します。 |
