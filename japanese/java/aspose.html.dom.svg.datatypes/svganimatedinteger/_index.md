---
title: "SVGAnimatedInteger クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.dom.svg.datatypes.SVGAnimatedInteger クラス。アニメーション可能な基本型整数の属性に使用されます"
type: docs

url: /ja/java/com.aspose.html.dom.svg.datatypes/svganimatedinteger/
---
## SVGAnimatedInteger class

アニメーション可能な基本型 integer の属性に使用されます。
...
| [toString](../../com.aspose.html.dom.svg.datatypes/svganimatedinteger/toString/)() | このインスタンスを表す文字列を返します。 |
