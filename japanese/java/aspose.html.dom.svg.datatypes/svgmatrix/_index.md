...
description: "com.aspose.html.dom.svg.datatypes.SVGMatrix クラス。SVG の多くのグラフィック操作は、形式 a c e b d f の 2x3 行列を利用し、行列演算の目的で 3x3 行列に拡張すると a c e b d f 0 0 1 となります。"
type: docs
...
SVG の多くのグラフィック操作は、次の形の 2x3 行列を利用します: [a c e] [b d f]。行列演算のために 3x3 行列に拡張すると、次のようになります: [a c e] [b d f] [0 0 1]
