...
description: "com.aspose.html.dom.svg.datatypes.SVGAnimatedValue1T クラス。アニメーション可能な型の属性に使用されます。"
type: docs

url: /ja/java/com.aspose.html.dom.svg.datatypes/svganimatedvalue-1/
---
## SVGAnimatedValue&lt;T&gt; class

アニメーション可能な型の属性に使用されます。
...
| 名前 | 説明 |
| --- | --- |
| [getAnimVal](../../com.aspose.html.dom.svg.datatypes/svganimatedvalue-1/animval/) 指定された属性またはプロパティがアニメーション中の場合、その属性またはプロパティの現在のアニメーション値を含みます。指定された属性またはプロパティが現在アニメーションされていない場合、baseVal と同じ値を含みます。 |
[getBaseVal]
