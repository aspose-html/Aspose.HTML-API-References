---
title: "SVGAnimatedString クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.dom.svg.datatypes.SVGAnimatedString クラス。DOMString 型の属性で、アニメーション可能なものに使用されます。"
type: docs

url: /ja/java/com.aspose.html.dom.svg.datatypes/svganimatedString/
---
## SVGAnimatedString class

アニメーション可能な DOMString 型の属性に使用されます。
...
| [toString](../../com.aspose.html.dom.svg.datatypes/svganimatedString/toString/)() | このインスタンスを表す文字列を返します。 |
