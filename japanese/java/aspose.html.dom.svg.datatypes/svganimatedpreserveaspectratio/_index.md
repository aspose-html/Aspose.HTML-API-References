---
title: "SVGAnimatedPreserveAspectRatio クラス"
second_title: "Aspose.HTML for Java API リファレンス"
description: "com.aspose.html.dom.svg.datatypes.SVGAnimatedPreserveAspectRatio クラス。アニメーション化できる SVGPreserveAspectRatio 型の属性に使用されます。"
type: docs

url: /ja/java/com.aspose.html.dom.svg.datatypes/svganimatedpreserveaspectratio/
---
## SVGAnimatedPreserveAspectRatio class

アニメーション可能な SVGPreserveAspectRatio 型の属性に使用されます。
...
| [toString](../../com.aspose.html.dom.svg.datatypes/svganimatedpreserveaspectratio/toString/)() | このインスタンスを表す文字列を返します。 |
