...
description: "IDevice メソッド。 パラメータ pt の座標へ現在の点を移動させ、新しいサブパスを開始します。接続線分は省略されます。現在のパス内の前のパス構築メソッドが MoveTo でも、新しい MoveTo がそれを上書きし、以前の MoveTo 操作の痕跡はパスに残りません。"
type: docs

url: /ja/java/com.aspose.html.rendering/idevice/moveto/
---
