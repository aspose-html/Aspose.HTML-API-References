...
description: "com.aspose.html.rendering.GraphicContext クラス。現在のグラフィック制御パラメータを保持します。これらのパラメータは、グラフィック演算子が実行されるグローバルフレームワークを定義します。"
type: docs

url: /ja/java/com.aspose.html.rendering/graphiccontext/
---
...
| [getTextInfo](../../com.aspose.html.rendering/graphiccontext/textinfo/) レンダリングされたテキストに関する情報を含む [`TextInfo`](../textinfo/) オブジェクトを取得します。 |
