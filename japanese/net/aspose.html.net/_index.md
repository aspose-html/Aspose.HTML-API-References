...
description: Aspose.Html.Net名前空間は簡単なネットワーク処理を支援する クラスとインターフェイスによって提供されます.
type: docs
weight: 250
url: /ja/net/aspose.html.net/
---
**Aspose.Html.Net**名前空間は、簡単なネットワーク処理を支援する クラスとインターフェイスによって提供されます.
...
| [MessageHandlerCollection](./messagehandlercollection/) | のコレクションを表します[`MessageHandler`](../aspose.html.net/messagehandler/). |
