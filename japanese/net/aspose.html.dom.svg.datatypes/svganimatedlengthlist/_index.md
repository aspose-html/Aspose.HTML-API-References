...
description: Aspose.Html.Dom.Svg.DataTypes.SVGAnimatedLengthList クラス. アニメーション化できるタイプ SVGLengthList の属性に使用されます
type: docs
weight: 1120
url: /ja/net/aspose.html.dom.svg.datatypes/svganimatedlengthlist/
---
## SVGAnimatedLengthList class

アニメーション化できるタイプ SVGLengthList の属性に使用されます。
...
| override [ToString](../../aspose.html.dom.svg.datatypes/svganimatedlengthlist/tostring/)() | を返しますStringこのインスタンスを表す. |
