...
description: Aspose.Html.Dom.Svg.DataTypes.SVGAnimatedRect クラス. アニメート可能なタイプ SVGRect の属性に使用されます
type: docs
weight: 1160
url: /ja/net/aspose.html.dom.svg.datatypes/svganimatedrect/
---
## SVGAnimatedRect class

アニメート可能なタイプ SVGRect の属性に使用されます。
...
| override [ToString](../../aspose.html.dom.svg.datatypes/svganimatedrect/tostring/)() | を返しますStringこのインスタンスを表す. |
