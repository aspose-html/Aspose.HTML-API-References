...
description: Aspose.Html.Dom.Svg.DataTypes.SVGAnimatedInteger クラス. アニメートできる基本型整数の属性に使用されます
type: docs
weight: 1100
url: /ja/net/aspose.html.dom.svg.datatypes/svganimatedinteger/
---
## SVGAnimatedInteger class

アニメートできる基本型整数の属性に使用されます。
...
| override [ToString](../../aspose.html.dom.svg.datatypes/svganimatedinteger/tostring/)() | を返しますStringこのインスタンスを表す. |
