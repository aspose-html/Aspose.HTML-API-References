...
description: Aspose.Html.Dom.Svg.DataTypes.SVGAnimatedBoolean クラス. アニメート可能なブール型の属性に使用されます
type: docs
weight: 1080
url: /ja/net/aspose.html.dom.svg.datatypes/svganimatedboolean/
---
## SVGAnimatedBoolean class

アニメート可能なブール型の属性に使用されます。
...
| override [ToString](../../aspose.html.dom.svg.datatypes/svganimatedboolean/tostring/)() | を返しますStringこのインスタンスを表す. |
