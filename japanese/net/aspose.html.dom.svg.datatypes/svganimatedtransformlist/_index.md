...
description: Aspose.Html.Dom.Svg.DataTypes.SVGAnimatedTransformList クラス. SVG の多くの要素で使用できアニメーション化できるtransform属性など一連の変換を指定するさまざまな属性に使用されます
type: docs
weight: 1180
url: /ja/net/aspose.html.dom.svg.datatypes/svganimatedtransformlist/
---
## SVGAnimatedTransformList class

SVG の多くの要素で使用でき、アニメーション化できる「transform」属性など、一連の変換を指定するさまざまな属性に使用されます。
...
| override [ToString](../../aspose.html.dom.svg.datatypes/svganimatedtransformlist/tostring/)() | を返しますStringこのインスタンスを表す. |
