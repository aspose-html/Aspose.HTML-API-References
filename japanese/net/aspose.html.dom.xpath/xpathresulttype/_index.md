...
description: Aspose.Html.Dom.XPath.XPathResultType 列挙. 結果のタイプを示す unsigned short特定の タイプが指定されている場合必要かつ可能な場合は XPath 型変換を使用して対応する 型として結果が返されます
type: docs
weight: 2610
url: /ja/net/aspose.html.dom.xpath/xpathresulttype/
---
