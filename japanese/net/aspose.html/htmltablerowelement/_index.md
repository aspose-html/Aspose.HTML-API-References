...
description: Aspose.Html.HTMLTableRowElement クラス. テーブル内の行 HTML 4.01. の TR 要素の定義を参照してください
type: docs
weight: 3580
url: /ja/net/aspose.html/htmltablerowelement/
---
## HTMLTableRowElement class

テーブル内の行。 HTML 4.01. の TR 要素の定義を参照してください。
...
| 名前 | 説明 |
| --- | --- |
| [Align](../../aspose.html/htmltablerowelement/align/) { get; set; } | この行のセル内のデータの水平方向の配置。 HTML 4.01. の align 属性定義を参照してください。 |
...
| [BgColor](../../aspose.html/htmltablerowelement/bgcolor/) { get; set; } | 行の背景色。 HTML 4.01 の bgcolor 属性の定義を参照してください。この属性は、HTML 4.01. で廃止されました。 |
| [Cells](../../aspose.html/htmltablerowelement/cells/) { get; } | この行のセルのコレクション。 @version DOM レベル 2 |
| [Ch](../../aspose.html/htmltablerowelement/ch/) { get; set; } | 列内のセルの配置文字。 HTML 4.01. の char 属性 定義を参照してください。 |
...
| [ChOff](../../aspose.html/htmltablerowelement/choff/) { get; set; } | 整列文字のオフセット。 HTML 4.01. の charoff 属性の定義を参照してください。 |
...
| [RowIndex](../../aspose.html/htmltablerowelement/rowindex/) { get; } | これは論理的な順序であり、ドキュメントの順序ではありません。 `行インデックス`セクションを考慮します ( `宣伝`、`TFOOT`、 また`TBODY` ) テーブル内に、`宣伝`インデックスの最初の行、 の後に`TBODY`行、続いて`TFOOT` rows. @version DOM レベル 2 |
| [SchemaTypeInfo](../../aspose.html.dom/element/schematypeinfo/) { get; } | この要素に関連付けられた型情報。 |
| [SectionRowIndex](../../aspose.html/htmltablerowelement/sectionrowindex/) { get; } | 現在のセクションに対するこの行のインデックス ( `宣伝`、`TFOOT`、 また`TBODY` )、0. から始まる @version DOM レベル 2 |
...
| [VAlign](../../aspose.html/htmltablerowelement/valign/) { get; set; } | この行のセル内のデータの垂直方向の配置。 HTML 4.01. の valign 属性定義を参照してください。 |
...
| [DeleteCell](../../aspose.html/htmltablerowelement/deletecell/)(int) | 現在の行からセルを削除します。 |
...
| [InsertCell](../../aspose.html/htmltablerowelement/insertcell/)(int) | 空の挿入`TD`セルをこの行に追加します。 の場合`索引`-1 またはセルの数に等しい場合、新しい セルが追加されます。 |
