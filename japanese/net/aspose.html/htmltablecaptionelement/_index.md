...
description: Aspose.Html.HTMLTableCaptionElement クラス. 表のキャプション HTML 4.01 の CAPTION 要素の定義を参照してください
type: docs
weight: 3540
url: /ja/net/aspose.html/htmltablecaptionelement/
---
## HTMLTableCaptionElement class

表のキャプション HTML 4.01 の CAPTION 要素の定義を参照してください。
...
| 名前 | 説明 |
| --- | --- |
| [Align](../../aspose.html/htmltablecaptionelement/align/) { get; set; } | 表に対するキャプションの配置。 HTML 4.01 の align 属性 の定義を参照してください。この属性は、HTML 4.01. で廃止されました。 |
