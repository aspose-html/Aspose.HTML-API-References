...
description: Aspose.Html.HTMLMetaElement クラス. これにはドキュメントに関する一般的なメタ情報が含まれます HTML 4.01. の META 要素の定義を参照してください
type: docs
weight: 3400
url: /ja/net/aspose.html/htmlmetaelement/
---
## HTMLMetaElement class

これには、ドキュメントに関する一般的なメタ情報が含まれます。 HTML 4.01. の META 要素の定義を参照してください。
...
| [Content](../../aspose.html/htmlmetaelement/content/) { get; set; } | 関連情報。 HTML 4.01. の content 属性の定義を参照してください。 |
...
| [HttpEquiv](../../aspose.html/htmlmetaelement/httpequiv/) { get; set; } | HTTP 応答ヘッダー名 [[IETF RFC 2616](http://www.ietf.org/rfc/rfc2616.txt) ]。 HTML 4.01. の http-equiv 属性の定義を参照してください。 |
...
| [Name](../../aspose.html/htmlmetaelement/name/) { get; set; } | メタ情報名。 HTML 4.01. の name 属性の定義を参照してください。 |
...
| [Scheme](../../aspose.html/htmlmetaelement/scheme/) { get; set; } | コンテンツの形式を選択します。 HTML 4.01. のスキーム属性の定義を参照してください。 |
