...
description: Aspose.Html.HTMLAreaElement クラス. クライアント側のイメージ マップ エリアの定義 HTML 4.01. の AREA 要素の定義を参照してください
type: docs
weight: 3080
url: /ja/net/aspose.html/htmlareaelement/
---
## HTMLAreaElement class

クライアント側のイメージ マップ エリアの定義。 HTML 4.01. の AREA 要素の定義を参照してください。
...
| 名前 | 説明 |
| --- | --- |
| [AccessKey](../../aspose.html/htmlareaelement/accesskey/) { get; set; } | フォーム コントロールにアクセスするための 1 文字のアクセス キー。 HTML 4.01 の accesskey 属性の定義を参照してください。 |
| [Alt](../../aspose.html/htmlareaelement/alt/) { get; set; } | この 要素の通常のコンテンツをレンダリングしないユーザー エージェントの代替テキスト。 HTML 4.01. の alt 属性の定義を参照してください。 |
...
| [Coords](../../aspose.html/htmlareaelement/coords/) { get; set; } | アクティブな領域のジオメトリを定義する、長さのカンマ区切りリスト。 も参照`形`地域の形のために。 HTML 4.01. の coords 属性定義を参照してください。 |
...
| [Href](../../aspose.html/htmlareaelement/href/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] リンクされたリソースの。 HTML 4.01 の href 属性の定義を参照してください。 |
...
| [NoHref](../../aspose.html/htmlareaelement/nohref/) { get; set; } | この領域が非アクティブであること、つまり関連するアクションがないことを指定します。 HTML 4.01 の nohref 属性の定義を参照してください。 |
...
| [RelList](../../aspose.html/htmlareaelement/rellist/) { get; } | 「rel」属性の解析から受け取ったトークンを含むライブ DOMTokenList を返します。 |
...
| [Shape](../../aspose.html/htmlareaelement/shape/) { get; set; } | アクティブ領域の形状。座標は で与えられます`座標` HTML 4.01. の shape 属性の定義を参照してください。 |
| [Style](../../aspose.html/htmlelement/style/) { get; } | 作成者がスタイル情報を特定の要素に直接適用できるようにするスタイル属性を表します. |
| [TabIndex](../../aspose.html/htmlareaelement/tabindex/) { get; set; } | タブ順序での要素の位置を表すインデックス。 HTML 4.01 の tabindex 属性定義を参照してください。 |
| [TagName](../../aspose.html.dom/element/tagname/) { get; } | 要素の名前。 |
| [Target](../../aspose.html/htmlareaelement/target/) { get; set; } | リソースをレンダリングするフレーム。 HTML 4.01. のターゲット属性の定義を参照してください。 |
