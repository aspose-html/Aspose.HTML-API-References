...
description: Aspose.Html.HTMLScriptElement クラス. スクリプト ステートメント HTML 4.01. の SCRIPT 要素の定義を参照してください
type: docs
weight: 3510
url: /ja/net/aspose.html/htmlscriptelement/
---
## HTMLScriptElement class

スクリプト ステートメント。 HTML 4.01. の SCRIPT 要素の定義を参照してください。
...
| [Charset](../../aspose.html/htmlscriptelement/charset/) { get; set; } | リンクされたリソースの文字エンコード。 HTML 4.01. の charset 属性の定義を参照してください。 |
...
| [Defer](../../aspose.html/htmlscriptelement/defer/) { get; set; } | ユーザー エージェントがスクリプトの処理を延期できることを示します。 HTML 4.01. の defer 属性定義を参照してください。 |
| [Dir](../../aspose.html/htmlelement/dir/) { get; set; } | 方向的にニュートラルなテキストのベース方向とテーブルの 方向性を指定します。 HTML 4.01. の dir 属性の定義を参照してください。 |
| [Event](../../aspose.html/htmlscriptelement/event/) { get; set; } | 将来の使用のために予約されています。 |
...
| [Src](../../aspose.html/htmlscriptelement/src/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] 外部スクリプトを指定します。 HTML 4.01. の src 属性定義 を参照してください。 |
...
| [Text](../../aspose.html/htmlscriptelement/text/) { get; set; } | 要素のスクリプト コンテンツ。 |
...
| [Type](../../aspose.html/htmlscriptelement/type/) { get; set; } | スクリプト言語のコンテンツ タイプ。 HTML 4.01. の type 属性 定義を参照してください。 |
