...
description: Aspose.Html.HTMLAddressElement クラス. アドレス要素 HTML 4.01. の ADDRESS 要素の定義を参照してください
type: docs
weight: 3050
url: /ja/net/aspose.html/htmladdresselement/
---
## HTMLAddressElement class

アドレス要素。 HTML 4.01. の ADDRESS 要素の定義を参照してください。
