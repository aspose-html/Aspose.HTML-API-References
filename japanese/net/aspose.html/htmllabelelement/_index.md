...
description: Aspose.Html.HTMLLabelElement クラス. フォーム フィールド ラベル テキスト HTML 4.01. の LABEL 要素の定義を参照してください
type: docs
weight: 3350
url: /ja/net/aspose.html/htmllabelelement/
---
## HTMLLabelElement class

フォーム フィールド ラベル テキスト。 HTML 4.01. の LABEL 要素の定義を参照してください。
...
| 名前 | 説明 |
| --- | --- |
| [AccessKey](../../aspose.html/htmllabelelement/accesskey/) { get; set; } | フォーム コントロールにアクセスするための 1 文字のアクセス キー。 HTML 4.01 の accesskey 属性の定義を参照してください。 |
...
| [For](../../aspose.html/htmllabelelement/for/) { get; set; } | この属性は、このラベルを による別のフォーム コントロールにリンクします`ID`属性。 HTML 4.01. の for 属性定義を参照してください。 |
| [Form](../../aspose.html/htmllabelelement/form/) { get; } | を返します`形状`このコントロールを含む要素。 を返します`ヌル`このコントロールが フォームのコンテキスト内にない場合。 |
