...
description: Aspose.Html.HTMLCanvasElement クラス. HTMLCanvasElement インターフェイスはキャンバス要素のレイアウトと表示を操作するためのプロパティとメソッドを提供します HTMLCanvasElement インターフェイスはHTMLElement インターフェイスのプロパティとメソッドも継承します
type: docs
weight: 3140
url: /ja/net/aspose.html/htmlcanvaselement/
---
...
| [Height](../../aspose.html/htmlcanvaselement/height/) { get; set; } | CSS ピクセルで解釈される canvas 要素の高さ HTML 属性を反映する正の整数です。 属性が指定されていない場合、または負の値などの無効な値に設定されている場合、 デフォルト値の 150 が使用されます。 |
...
| [Width](../../aspose.html/htmlcanvaselement/width/) { get; set; } | CSS ピクセルで解釈される canvas 要素の幅 HTML 属性を反映する正の整数です。 属性が指定されていない場合、または負の値などの無効な値に設定されている場合、デフォルト値の 300 が使用されます。 |
...
| [GetContext](../../aspose.html/htmlcanvaselement/getcontext/)(string) | キャンバス上の描画コンテキストを返します。コンテキスト ID がサポートされていない場合は null を返します。描画コンテキストを使用すると、キャンバスに描画できます. |
...
| [ToDataURL](../../aspose.html/htmlcanvaselement/todataurl/#todataurl)() | は、type パラメーターで指定された形式 (デフォルトは PNG) で画像の表現を含むデータ URI を返します。 返された画像の解像度は 96 dpi です。 |
| [ToDataURL](../../aspose.html/htmlcanvaselement/todataurl/#todataurl_1)(string) | は、type パラメーターで指定された形式 (デフォルトは PNG) で画像の表現を含むデータ URI を返します。 返された画像の解像度は 96 dpi です。 |
| [ToDataURL](../../aspose.html/htmlcanvaselement/todataurl/#todataurl_2)(string, double) | は、type パラメーターで指定された形式 (デフォルトは PNG) で画像の表現を含むデータ URI を返します。 返された画像の解像度は 96 dpi です。 |
