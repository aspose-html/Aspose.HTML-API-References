...
description: Aspose.Html.HTMLMenuElement クラス. メニュー一覧 HTML 4.01 の MENU 要素の定義を参照してくださいこの要素は HTML 4.01. で非推奨の です
type: docs
weight: 3390
url: /ja/net/aspose.html/htmlmenuelement/
---
## HTMLMenuElement class

メニュー一覧。 HTML 4.01 の MENU 要素の定義を参照してください。この要素は HTML 4.01. で非推奨の です。
...
| [Compact](../../aspose.html/htmlmenuelement/compact/) { get; set; } | リスト項目間のスペースを減らします。 HTML 4.01 のコンパクト属性定義 を参照してください。この属性は、HTML 4.01. で廃止されました。 |
