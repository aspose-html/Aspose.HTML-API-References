...
description: Aspose.Html.HTMLParagraphElement クラス. 段落 HTML 4.01. の P 要素の定義を参照してください
type: docs
weight: 3470
url: /ja/net/aspose.html/htmlparagraphelement/
---
## HTMLParagraphElement class

段落。 HTML 4.01. の P 要素の定義を参照してください。
...
| 名前 | 説明 |
| --- | --- |
| [Align](../../aspose.html/htmlparagraphelement/align/) { get; set; } | 水平方向のテキスト配置。 HTML 4.01 の align 属性の定義を参照してください。この属性は、HTML 4.01. で廃止されました。 |
