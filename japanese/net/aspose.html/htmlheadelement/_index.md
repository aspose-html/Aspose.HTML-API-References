...
description: Aspose.Html.HTMLHeadElement クラス. ドキュメントの先頭情報 HTML 4.01. の HEAD 要素の定義を参照してください
type: docs
weight: 3270
url: /ja/net/aspose.html/htmlheadelement/
---
## HTMLHeadElement class

ドキュメントの先頭情報。 HTML 4.01. の HEAD 要素の定義を参照してください。
...
| [Profile](../../aspose.html/htmlheadelement/profile/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] メタデータ プロファイルを指定します。 HTML 4.01. のプロファイル属性 定義を参照してください。 |
