...
description: Aspose.Html.HTMLOListElement クラス. 順序付きリスト HTML 4.01. の OL 要素の定義を参照してください
type: docs
weight: 3430
url: /ja/net/aspose.html/htmlolistelement/
---
## HTMLOListElement class

順序付きリスト。 HTML 4.01. の OL 要素の定義を参照してください。
...
| [Compact](../../aspose.html/htmlolistelement/compact/) { get; set; } | リスト項目間のスペースを減らします。 HTML 4.01 のコンパクト属性定義 を参照してください。この属性は、HTML 4.01. で廃止されました。 |
...
| [Start](../../aspose.html/htmlolistelement/start/) { get; set; } | 開始シーケンス番号。 HTML 4.01 の start 属性の定義を参照してください。この属性は、HTML 4.01. で廃止されました。 |
...
| [Type](../../aspose.html/htmlolistelement/type/) { get; set; } | 番号付けスタイル。 HTML 4.01 の type 属性の定義を参照してください。この 属性は、HTML 4.01. で廃止されました。 |
