...
description: Aspose.Html.HTMLFrameElement クラス. フレームを作成します HTML 4.01. の FRAME 要素の定義を参照してください
type: docs
weight: 3240
url: /ja/net/aspose.html/htmlframeelement/
---
## HTMLFrameElement class

フレームを作成します。 HTML 4.01. の FRAME 要素の定義を参照してください。
...
| [ContentDocument](../../aspose.html/htmlframeelement/contentdocument/) { get; } | このフレームに含まれるドキュメントがあり、利用可能な場合は、 または`ヌル`そうでなければ. @since DOM Level 2 |
...
| [FrameBorder](../../aspose.html/htmlframeelement/frameborder/) { get; set; } | フレーム枠をリクエストします。 HTML 4.01. の frameborder 属性の定義を参照してください。 |
...
| [LongDesc](../../aspose.html/htmlframeelement/longdesc/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] この画像またはフレームの長い説明を指定します。 HTML 4.01. の longdesc 属性の定義を参照してください。 |
| [MarginHeight](../../aspose.html/htmlframeelement/marginheight/) { get; set; } | フレーム マージンの高さ (ピクセル単位)。 HTML 4.01. の marginheight 属性 定義を参照してください。 |
| [MarginWidth](../../aspose.html/htmlframeelement/marginwidth/) { get; set; } | フレーム マージンの幅 (ピクセル単位)。 HTML 4.01. の marginwidth 属性定義 を参照してください。 |
| [Name](../../aspose.html/htmlframeelement/name/) { get; set; } | フレーム名 (オブジェクトの`目標`属性）。 HTML 4.01. の name 属性の定義を参照してください。 |
...
| [NoResize](../../aspose.html/htmlframeelement/noresize/) { get; set; } | true の場合、ユーザーによるフレームのサイズ変更を禁止します。 HTML 4.01. の noresize 属性 定義を参照してください。 |
...
| [Scrolling](../../aspose.html/htmlframeelement/scrolling/) { get; set; } | フレームにスクロールバーを表示するかどうかを指定します。 HTML 4.01. の スクロール属性の定義を参照してください。 |
| [ShadowRoot](../../aspose.html.dom/element/shadowroot/) { get; } | この要素に格納されている shadowRoot を返すか、閉じている場合は null を返します。 |
| [Src](../../aspose.html/htmlframeelement/src/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] 初期フレームの内容を指定します。 HTML 4.01. の src 属性 定義を参照してください。 |
