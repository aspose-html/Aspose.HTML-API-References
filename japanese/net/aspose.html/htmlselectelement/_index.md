...
description: Aspose.Html.HTMLSelectElement クラス. select 要素を使用するとオプションを選択できます含まれているオプション はselect 要素を介してコレクションとして直接アクセスできます HTML 4.01. の SELECT 要素の定義を参照してください
type: docs
weight: 3520
url: /ja/net/aspose.html/htmlselectelement/
---
## HTMLSelectElement class

select 要素を使用すると、オプションを選択できます。含まれているオプション は、select 要素を介してコレクションとして直接アクセスできます。 HTML 4.01. の SELECT 要素の定義を参照してください。
...
| [Disabled](../../aspose.html/htmlselectelement/disabled/) { get; set; } | このコンテキストではコントロールを使用できません。 HTML 4.01. の無効な属性 の定義を参照してください。 |
...
| [Form](../../aspose.html/htmlselectelement/form/) { get; } | このオプションの数`選択する` . |
...
| [Length](../../aspose.html/htmlselectelement/length/) { get; set; } | このオプションの数`選択する` @version DOM レベル 2 |
...
| [Multiple](../../aspose.html/htmlselectelement/multiple/) { get; set; } | true の場合、複数`オプション`ここで要素を選択できます`選択する` HTML 4.01. の multiple 属性の定義を参照してください。 |
| [Name](../../aspose.html/htmlselectelement/name/) { get; set; } | フォームで送信された場合のフォーム コントロールまたはオブジェクト名。 HTML 4.01. の name 属性の定義を参照してください。 |
...
| [Options](../../aspose.html/htmlselectelement/options/) { get; } | のコレクション`オプション`この 要素に含まれる要素。 @version DOM レベル 2 |
...
| [SelectedIndex](../../aspose.html/htmlselectelement/selectedindex/) { get; set; } | 0 から始まる、選択されたオプションの序数インデックス。要素が選択されていない場合、値 -1 が返されます。複数のオプションが選択されている場合、最初に選択されたオプションのインデックスが返されます。 |
| [ShadowRoot](../../aspose.html.dom/element/shadowroot/) { get; } | この要素に格納されている shadowRoot を返すか、閉じている場合は null を返します。 |
| [Size](../../aspose.html/htmlselectelement/size/) { get; set; } | 表示される行の数。 HTML 4.01. の size 属性の定義を参照してください。 |
| [Style](../../aspose.html/htmlelement/style/) { get; } | 作成者がスタイル情報を特定の要素に直接適用できるようにするスタイル属性を表します. |
| [TabIndex](../../aspose.html/htmlselectelement/tabindex/) { get; set; } | タブ順序での要素の位置を表すインデックス。 HTML 4.01 の tabindex 属性定義を参照してください。 |
...
| [Type](../../aspose.html/htmlselectelement/type/) { get; } | このフォーム コントロールのタイプ。これは、multiple 属性が`真実`および文字列「select-one」の場合`間違い`. |
| [Value](../../aspose.html/htmlselectelement/value/) { get; set; } | 現在のフォーム コントロール値 (つまり、現在 選択されているオプションの値)。複数のオプションが選択されている場合、これは最初に選択されたオプションの値 です。 |
