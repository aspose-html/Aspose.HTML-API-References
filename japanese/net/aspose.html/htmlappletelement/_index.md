...
description: Aspose.Html.HTMLAppletElement クラス. 組み込み Java アプレット HTML 4.01 の APPLET 要素の定義を参照してください この要素は HTML 4.01. で廃止されました
type: docs
weight: 3070
url: /ja/net/aspose.html/htmlappletelement/
---
## HTMLAppletElement class

組み込み Java アプレット。 HTML 4.01 の APPLET 要素の定義を参照してください。 この要素は HTML 4.01. で廃止されました。
...
| 名前 | 説明 |
| --- | --- |
| [Align](../../aspose.html/htmlappletelement/align/) { get; set; } | 周囲のテキストに対して このオブジェクトを (垂直または水平に) 揃えます。 HTML 4.01 の align 属性の定義を参照してください。 この属性は、HTML 4.01. で廃止されました。 |
| [Alt](../../aspose.html/htmlappletelement/alt/) { get; set; } | この 要素の通常のコンテンツをレンダリングしないユーザー エージェントの代替テキスト。 HTML 4.01 の alt 属性の定義を参照してください。この 属性は、HTML 4.01. で廃止されました。 |
| [Archive](../../aspose.html/htmlappletelement/archive/) { get; set; } | コンマ区切りのアーカイブ リスト。 HTML 4.01 のアーカイブ属性の定義を参照してください。この属性は、HTML 4.01. で廃止されました。 |
...
| [Code](../../aspose.html/htmlappletelement/code/) { get; set; } | アプレット クラス ファイル。 HTML 4.01 の code 属性の定義を参照してください。この 属性は、HTML 4.01. で廃止されました。 |
| [CodeBase](../../aspose.html/htmlappletelement/codebase/) { get; set; } | オプションのベース URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) アプレットの場合。 HTML 4.01 の codebase 属性の定義を参照してください。この属性は、HTML 4.01. で廃止されました。 |
...
| [Height](../../aspose.html/htmlappletelement/height/) { get; set; } | 高さをオーバーライドします。 HTML 4.01 の height 属性の定義を参照してください。この 属性は、HTML 4.01. で廃止されました。 |
| [Hspace](../../aspose.html/htmlappletelement/hspace/) { get; set; } | このイメージ、 アプレット、またはオブジェクトの左右の水平方向のスペース (ピクセル単位)。 HTML 4.01 の hspace 属性の定義を参照してください。 この属性は HTML 4.01 で非推奨です。 @version DOM Level 2 |
...
| [Name](../../aspose.html/htmlappletelement/name/) { get; set; } | アプレットの名前。 HTML 4.01 の name 属性の定義を参照してください。 この属性は、HTML 4.01. で廃止されました。 |
...
| [Object](../../aspose.html/htmlappletelement/object/) { get; set; } | 「オブジェクト」属性の値。 HTML 4.01 のオブジェクト属性 definition を参照してください。この属性は、HTML 4.01 では推奨されていません。 @version DOM レベル 2 |
...
| [Vspace](../../aspose.html/htmlappletelement/vspace/) { get; set; } | このイメージ、アプレット、または オブジェクトの上下の垂直スペース (ピクセル単位)。 HTML 4.01 の vspace 属性の定義を参照してください。この 属性は、HTML 4.01. @version DOM Level 2 で廃止されました。 |
| [Width](../../aspose.html/htmlappletelement/width/) { get; set; } | 幅をオーバーライドします。 HTML 4.01 の width 属性の定義を参照してください。この 属性は、HTML 4.01. で廃止されました。 |
