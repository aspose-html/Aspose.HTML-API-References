...
description: Aspose.Html.HTMLHRElement クラス. 横罫線を作成します HTML 4.01. の HR 要素の定義を参照してください
type: docs
weight: 3260
url: /ja/net/aspose.html/htmlhrelement/
---
## HTMLHRElement class

横罫線を作成します。 HTML 4.01. の HR 要素の定義を参照してください。
...
| 名前 | 説明 |
| --- | --- |
| [Align](../../aspose.html/htmlhrelement/align/) { get; set; } | ページ上の罫線を揃えます。 HTML 4.01 の align 属性の定義を参照してください。この属性は、HTML 4.01. で廃止されました。 |
...
| [NoShade](../../aspose.html/htmlhrelement/noshade/) { get; set; } | は、この要素の レンダリングでシェーディングがあってはならないことをユーザー エージェントに示します。 HTML 4.01 の noshade 属性の定義を参照してください。この属性は、HTML 4.01. で廃止されました。 |
...
| [Size](../../aspose.html/htmlhrelement/size/) { get; set; } | 罫線の高さ。 HTML 4.01 の size 属性の定義を参照してください。 この属性は、HTML 4.01. で廃止されました。 |
...
| [Width](../../aspose.html/htmlhrelement/width/) { get; set; } | 罫線の幅。 HTML 4.01 の width 属性の定義を参照してください。 この属性は、HTML 4.01. で廃止されました。 |
