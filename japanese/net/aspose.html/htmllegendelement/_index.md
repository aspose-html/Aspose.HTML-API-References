...
description: Aspose.Html.HTMLLegendElement クラス. のキャプションを提供しますフィールドセットグループ化 HTML 4.01. の LEGEND 要素の定義を参照してください
type: docs
weight: 3360
url: /ja/net/aspose.html/htmllegendelement/
---
## HTMLLegendElement class

のキャプションを提供します`フィールドセット`グループ化。 HTML 4.01. の LEGEND 要素の定義を参照してください。
...
| 名前 | 説明 |
| --- | --- |
| [AccessKey](../../aspose.html/htmllegendelement/accesskey/) { get; set; } | フォーム コントロールにアクセスするための 1 文字のアクセス キー。 HTML 4.01 の accesskey 属性の定義を参照してください。 |
| [Align](../../aspose.html/htmllegendelement/align/) { get; set; } | テキストの位置合わせ`フィールドセット` HTML 4.01 の align 属性の定義を参照してください。この属性は、 HTML 4.01. で廃止されました。 |
...
| [Form](../../aspose.html/htmllegendelement/form/) { get; } | を返します`形状`このコントロールを含む要素。 を返します`ヌル`このコントロールが フォームのコンテキスト内にない場合。 |
