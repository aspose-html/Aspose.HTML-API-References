...
description: Aspose.Html.HTMLOptGroupElement クラス. オプションを論理的な下位区分にグループ化します HTML 4.01. の OPTGROUP 要素 定義を参照してください
type: docs
weight: 3450
url: /ja/net/aspose.html/htmloptgroupelement/
---
## HTMLOptGroupElement class

オプションを論理的な下位区分にグループ化します。 HTML 4.01. の OPTGROUP 要素 定義を参照してください。
...
| [Disabled](../../aspose.html/htmloptgroupelement/disabled/) { get; set; } | このコンテキストではコントロールを使用できません。 HTML 4.01. の無効な属性 の定義を参照してください。 |
...
| [Label](../../aspose.html/htmloptgroupelement/label/) { get; set; } | このオプション グループにラベルを割り当てます。 HTML 4.01. の label 属性 definition を参照してください。 |
