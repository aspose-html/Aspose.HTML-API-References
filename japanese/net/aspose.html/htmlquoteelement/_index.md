...
description: Aspose.Html.HTMLQuoteElement クラス. Qとブロッククォート要素 HTML 4.01. の Q 要素の定義を参照してください
type: docs
weight: 3500
url: /ja/net/aspose.html/htmlquoteelement/
---
## HTMLQuoteElement class

`Q`と`ブロッククォート`要素。 HTML 4.01. の Q 要素の定義を参照してください。
...
| [Cite](../../aspose.html/htmlquoteelement/cite/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ソース ドキュメントまたはメッセージを指定します。 HTML 4.01. の cite 属性 の定義を参照してください。 |
