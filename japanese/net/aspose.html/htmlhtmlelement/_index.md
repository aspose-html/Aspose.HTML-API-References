...
description: Aspose.Html.HTMLHtmlElement クラス. HTML ドキュメントのルート HTML 4.01. の HTML 要素の定義を参照してください
type: docs
weight: 3290
url: /ja/net/aspose.html/htmlhtmlelement/
---
...
| [Version](../../aspose.html/htmlhtmlelement/version/) { get; set; } | ドキュメントの DTD に関するバージョン情報。 HTML 4.01 の version 属性 定義を参照してください。この属性は、HTML 4.01. で廃止されました。 |
