...
description: Aspose.Html.HTMLDListElement クラス. 定義リスト HTML 4.01. の DL 要素の定義を参照してください
type: docs
weight: 3150
url: /ja/net/aspose.html/htmldlistelement/
---
...
| [Compact](../../aspose.html/htmldlistelement/compact/) { get; set; } | リスト項目間のスペースを減らします。 HTML 4.01 のコンパクト属性定義 を参照してください。この属性は、HTML 4.01. で廃止されました。 |
