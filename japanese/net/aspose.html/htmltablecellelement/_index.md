...
description: Aspose.Html.HTMLTableCellElement クラス. を表すために使用されるオブジェクトTHとTD 要素 HTML 4.01. の TD 要素の定義を参照してください
type: docs
weight: 3550
url: /ja/net/aspose.html/htmltablecellelement/
---
## HTMLTableCellElement class

を表すために使用されるオブジェクト`TH`と`TD` 要素。 HTML 4.01. の TD 要素の定義を参照してください。
...
| 名前 | 説明 |
| --- | --- |
| [Abbr](../../aspose.html/htmltablecellelement/abbr/) { get; set; } | ヘッダー セルの略。 HTML 4.01. の abbr 属性の定義を参照してください。 |
| [Align](../../aspose.html/htmltablecellelement/align/) { get; set; } | セル内のデータの水平方向の配置。 HTML 4.01. の align 属性定義 を参照してください。 |
| override [Attributes](../../aspose.html.dom/element/attributes/) { get; } | このノードの属性を含む NamedNodeMap (要素の場合)、またはそれ以外の場合は null. |
| [Axis](../../aspose.html/htmltablecellelement/axis/) { get; set; } | 関連ヘッダーの名前グループ。 HTML 4.01. の軸属性の定義を参照してください。 |
| virtual [BaseURI](../../aspose.html.dom/node/baseuri/) { get; } | このノードの絶対ベース URI、または実装が絶対 URI を取得できなかった場合は null。 |
| [BgColor](../../aspose.html/htmltablecellelement/bgcolor/) { get; set; } | セルの背景色。 HTML 4.01 の bgcolor 属性の定義を参照してください。この属性は、HTML 4.01. で廃止されました。 |
| [CellIndex](../../aspose.html/htmltablecellelement/cellindex/) { get; } | 0 から始まる、行内のこのセルのインデックス。このインデックスは、 ドキュメント ツリー順であり、表示順ではありません。 |
| [Ch](../../aspose.html/htmltablecellelement/ch/) { get; set; } | 列内のセルの配置文字。 HTML 4.01. の char 属性 定義を参照してください。 |
...
| [ChOff](../../aspose.html/htmltablecellelement/choff/) { get; set; } | 整列文字のオフセット。 HTML 4.01. の charoff 属性の定義を参照してください。 |
...
| [ColSpan](../../aspose.html/htmltablecellelement/colspan/) { get; set; } | セルがまたがる列の数。 HTML 4.01. の colspan 属性定義 を参照してください。 |
...
| [Headers](../../aspose.html/htmltablecellelement/headers/) { get; set; } | のリスト`ID`ヘッダー セルの属性値。 HTML 4.01. の ヘッダー属性の定義を参照してください。 |
| [Height](../../aspose.html/htmltablecellelement/height/) { get; set; } | セルの高さ。 HTML 4.01 の height 属性の定義を参照してください。この 属性は、HTML 4.01. で廃止されました。 |
...
| [NoWrap](../../aspose.html/htmltablecellelement/nowrap/) { get; set; } | ワードラップを抑制します。 HTML 4.01 の nowrap 属性の定義を参照してください。この属性は、HTML 4.01. で廃止されました。 |
...
| [RowSpan](../../aspose.html/htmltablecellelement/rowspan/) { get; set; } | セルがまたがる行数。 HTML 4.01. の rowspan 属性の定義を参照してください。 |
| [SchemaTypeInfo](../../aspose.html.dom/element/schematypeinfo/) { get; } | この要素に関連付けられた型情報。 |
| [Scope](../../aspose.html/htmltablecellelement/scope/) { get; set; } | ヘッダー セルでカバーされるスコープ。 HTML 4.01. のスコープ属性の定義を参照してください。 |
...
| [VAlign](../../aspose.html/htmltablecellelement/valign/) { get; set; } | セル内のデータの垂直方向の配置。 HTML 4.01. の valign 属性定義 を参照してください。 |
| [Width](../../aspose.html/htmltablecellelement/width/) { get; set; } | セル幅。 HTML 4.01 の width 属性の定義を参照してください。この 属性は、HTML 4.01. で廃止されました。 |
