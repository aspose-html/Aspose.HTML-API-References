...
description: Aspose.Html.HTMLBaseFontElement クラス. 基本フォント HTML 4.01 の BASEFONT 要素の定義を参照してくださいこの要素 はHTML 4.01. で廃止されました
type: docs
weight: 3110
url: /ja/net/aspose.html/htmlbasefontelement/
---
## HTMLBaseFontElement class

基本フォント。 HTML 4.01 の BASEFONT 要素の定義を参照してください。この要素 は、HTML 4.01. で廃止されました。
...
| [Color](../../aspose.html/htmlbasefontelement/color/) { get; set; } | フォントの色。 HTML 4.01 の color 属性の定義を参照してください。この 属性は、HTML 4.01. で廃止されました。 |
| [Dir](../../aspose.html/htmlelement/dir/) { get; set; } | 方向的にニュートラルなテキストのベース方向とテーブルの 方向性を指定します。 HTML 4.01. の dir 属性の定義を参照してください。 |
| [Face](../../aspose.html/htmlbasefontelement/face/) { get; set; } | フォント フェース識別子。 HTML 4.01 の face 属性の定義を参照してください。 この属性は、HTML 4.01. で廃止されました。 |
...
| [Size](../../aspose.html/htmlbasefontelement/size/) { get; set; } | 計算されたフォント サイズ。 HTML 4.01 の size 属性の定義を参照してください。 この属性は HTML 4.01 で非推奨です。 @version DOM Level 2 |
