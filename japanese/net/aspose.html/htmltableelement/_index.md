...
description: Aspose.Html.HTMLTableElement クラス. テーブルの create および delete メソッドにより作成者はテーブルを作成し 変更できます HTML4.01  は のそれぞれの 1 つだけを指定しますキャプション宣伝  とTFOOT要素 がテーブルに存在する可能性がありますしたがって存在する場合に createTHead または createTFoot メソッドが呼び出されるとメソッドは既存の THead または TFoot 要素を返します HTML 4.01. の TABLE 要素の定義を参照してください
type: docs
weight: 3570
url: /ja/net/aspose.html/htmltableelement/
---
## HTMLTableElement class

テーブルの create* および delete* メソッドにより、作成者はテーブルを作成し、 変更できます。 [[HTML4.01](http://www.w3.org/TR/1999/REC-html401-19991224) ] は、 のそれぞれの 1 つだけを指定します。`キャプション`、`宣伝` 、 と`TFOOT`要素 がテーブルに存在する可能性があります。したがって、存在する場合に createTHead() または createTFoot() メソッドが呼び出されると、メソッドは既存の THead または TFoot 要素を返します。 HTML 4.01. の TABLE 要素の定義を参照してください。
...
| 名前 | 説明 |
| --- | --- |
| [Align](../../aspose.html/htmltableelement/align/) { get; set; } | 残りの ドキュメントに対するテーブルの位置を指定します。 HTML 4.01 の align 属性の定義を参照してください。この 属性は、HTML 4.01. で廃止されました。 |
...
| [BgColor](../../aspose.html/htmltableelement/bgcolor/) { get; set; } | セルの背景色。 HTML 4.01 の bgcolor 属性の定義を参照してください。この属性は、HTML 4.01. で廃止されました。 |
| [Border](../../aspose.html/htmltableelement/border/) { get; set; } | 表の周囲の境界線の幅。 HTML 4.01. の境界属性 定義を参照してください。 |
| [Caption](../../aspose.html/htmltableelement/caption/) { get; } | テーブルの`キャプション`、存在しない場合は無効。 @version DOM レベル 2 |
| [CellPadding](../../aspose.html/htmltableelement/cellpadding/) { get; set; } | セルのコンテンツと セルの境界線の間の水平および垂直方向のスペースを指定します。 HTML 4.01. の cellpadding 属性の定義を参照してください。 |
| [CellSpacing](../../aspose.html/htmltableelement/cellspacing/) { get; set; } | セル間の水平方向と垂直方向の間隔を指定します。 HTML 4.01. の cellspacing 属性の定義を参照してください。 |
...
| [Frame](../../aspose.html/htmltableelement/frame/) { get; set; } | レンダリングする外部テーブルの境界線を指定します。 HTML 4.01. のフレーム 属性定義を参照してください。 |
...
| [Rows](../../aspose.html/htmltableelement/rows/) { get; } | テーブルの`TFOOT`、 また`ヌル` が存在しない場合。 |
| [Rules](../../aspose.html/htmltableelement/rules/) { get; set; } | レンダリングする内部テーブル ボーダーを指定します。 HTML 4.01. の rules 属性定義を参照してください。 |
...
| [Summary](../../aspose.html/htmltableelement/summary/) { get; set; } | テーブルの目的または構造に関する説明。 HTML 4.01. の要約 属性定義を参照してください。 |
| [TagName](../../aspose.html.dom/element/tagname/) { get; } | 要素の名前。 |
| [TBodies](../../aspose.html/htmltableelement/tbodies/) { get; } | テーブル本体 (暗黙のものを含む) のコレクションを返します。 |
...
| [TFoot](../../aspose.html/htmltableelement/tfoot/) { get; } | テーブルの`宣伝`、 また`ヌル` が存在しない場合。 |
| [THead](../../aspose.html/htmltableelement/thead/) { get; } | テーブルの`キャプション` 、存在しない場合は無効。 |
| [Title](../../aspose.html/htmlelement/title/) { get; set; } | 要素の勧告のタイトル。 HTML 4.01. の title 属性の定義を参照してください。 |
| [Width](../../aspose.html/htmltableelement/width/) { get; set; } | 目的のテーブル幅を指定します。 HTML 4.01. の width 属性定義 を参照してください。 |
...
| [CreateCaption](../../aspose.html/htmltableelement/createcaption/)() | 新しいテーブル キャプション オブジェクトを作成するか、既存のものを返します。 |
| [CreateTFoot](../../aspose.html/htmltableelement/createtfoot/)() | テーブル フッター行を作成するか、既存の行を返します。 |
| [CreateTHead](../../aspose.html/htmltableelement/createthead/)() | テーブルのヘッダー行を作成するか、既存のものを返します。 |
| [DeleteCaption](../../aspose.html/htmltableelement/deletecaption/)() | テーブル キャプションが存在する場合は削除します。 |
| [DeleteRow](../../aspose.html/htmltableelement/deleterow/)(int) | テーブル行を削除します。 |
| [DeleteTFoot](../../aspose.html/htmltableelement/deletetfoot/)() | フッターが存在する場合、テーブルからフッターを削除します。 |
| [DeleteTHead](../../aspose.html/htmltableelement/deletethead/)() | ヘッダーが存在する場合、テーブルからヘッダーを削除します。 |
...
| [InsertRow](../../aspose.html/htmltableelement/insertrow/)(int) | テーブルに新しい空の行を挿入します。新しい行は、現在の の直前の同じセクションに 挿入されます。`索引`表の th 行。もしも`索引`-1 または が行数に等しい場合、新しい行が追加されます。さらに、 テーブルが空の場合、行が`TBODY` が作成され、テーブルに挿入されます。[[HTML4.01](http://www.w3.org/TR/1999/REC-html401-19991224) ]。 |
