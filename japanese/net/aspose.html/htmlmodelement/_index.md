...
description: Aspose.Html.HTMLModElement クラス. 文書の一部変更のお知らせ HTML 4.01 の INS 要素と DEL 要素 の定義を参照してください
type: docs
weight: 3410
url: /ja/net/aspose.html/htmlmodelement/
---
## HTMLModElement class

文書の一部変更のお知らせ。 HTML 4.01 の INS 要素と DEL 要素 の定義を参照してください。
...
| [Cite](../../aspose.html/htmlmodelement/cite/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] 変更の理由を説明する文書を指定します。 HTML 4.01 の cite 属性の定義を参照してください。 |
...
| [DateTime](../../aspose.html/htmlmodelement/datetime/) { get; set; } | 変更の日時。 HTML 4.01. の datetime 属性定義 を参照してください。 |
