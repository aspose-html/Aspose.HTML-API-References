...
description: Aspose.Html.HTMLLIElement クラス. リスト項目 HTML 4.01. の LI 要素の定義を参照してください
type: docs
weight: 3340
url: /ja/net/aspose.html/htmllielement/
---
## HTMLLIElement class
...
| [Type](../../aspose.html/htmllielement/type/) { get; set; } | リスト アイテムの箇条書きスタイル。 HTML 4.01 の type 属性の定義を参照してください。 この属性は、HTML 4.01. で廃止されました。 |
| [Value](../../aspose.html/htmllielement/value/) { get; set; } | 使用時にシーケンス番号をリセット`OL` HTML 4.01 の value 属性の定義を参照してください。この属性は、 HTML 4.01. で廃止されました。 |
