...
description: Aspose.Html.HTMLDivElement クラス. ジェネリック ブロック コンテナー HTML 4.01. の DIV 要素の定義を参照してください
type: docs
weight: 3180
url: /ja/net/aspose.html/htmldivelement/
---
## HTMLDivElement class

ジェネリック ブロック コンテナー。 HTML 4.01. の DIV 要素の定義を参照してください。
...
| 名前 | 説明 |
| --- | --- |
| [Align](../../aspose.html/htmldivelement/align/) { get; set; } | 水平方向のテキスト配置。 HTML 4.01 の align 属性の定義を参照してください。この属性は、HTML 4.01. で廃止されました。 |
