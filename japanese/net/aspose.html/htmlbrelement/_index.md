...
description: Aspose.Html.HTMLBRElement クラス. 改行を強制します HTML 4.01. の BR 要素の定義を参照してください
type: docs
weight: 3090
url: /ja/net/aspose.html/htmlbrelement/
---
## HTMLBRElement class

改行を強制します。 HTML 4.01. の BR 要素の定義を参照してください。
...
| [Clear](../../aspose.html/htmlbrelement/clear/) { get; set; } | float の周りのテキストの流れを制御します。 HTML 4.01 の clear 属性定義 を参照してください。この属性は、HTML 4.01. で廃止されました。 |
