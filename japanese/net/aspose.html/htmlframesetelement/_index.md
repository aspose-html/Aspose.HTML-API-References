...
description: Aspose.Html.HTMLFrameSetElement クラス. フレームのグリッドを作成します HTML 4.01. の FRAMESET 要素の定義を参照してください
type: docs
weight: 3250
url: /ja/net/aspose.html/htmlframesetelement/
---
## HTMLFrameSetElement class

フレームのグリッドを作成します。 HTML 4.01. の FRAMESET 要素の定義を参照してください。
...
| [Cols](../../aspose.html/htmlframesetelement/cols/) { get; set; } | フレームセット内のフレームの列数。 HTML 4.01. の cols 属性 定義を参照してください。 |
...
| [Rows](../../aspose.html/htmlframesetelement/rows/) { get; set; } | フレームセット内のフレームの行数。 HTML 4.01. の行属性 定義を参照してください。 |
