...
description: Aspose.Html.HTMLTextAreaElement クラス. 複数行のテキスト フィールド HTML 4.01. の TEXTAREA 要素の定義を参照してください
type: docs
weight: 3610
url: /ja/net/aspose.html/htmltextareaelement/
---
## HTMLTextAreaElement class

複数行のテキスト フィールド。 HTML 4.01. の TEXTAREA 要素の定義を参照してください。
...
| 名前 | 説明 |
| --- | --- |
| [AccessKey](../../aspose.html/htmltextareaelement/accesskey/) { get; set; } | フォーム コントロールにアクセスするための 1 文字のアクセス キー。 HTML 4.01 の accesskey 属性の定義を参照してください。 |
...
| [Cols](../../aspose.html/htmltextareaelement/cols/) { get; set; } | コントロールの幅 (文字数)。 HTML 4.01. の cols 属性の定義を参照してください。 |
| [DefaultValue](../../aspose.html/htmltextareaelement/defaultvalue/) { get; set; } | 要素の内容を表します。この属性 の値は、対話型ユーザー エージェント 内の対応するフォーム コントロールのコンテンツが変更されても変更されません。 @version DOM Level 2 |
| [Dir](../../aspose.html/htmlelement/dir/) { get; set; } | 方向的にニュートラルなテキストのベース方向とテーブルの 方向性を指定します。 HTML 4.01. の dir 属性の定義を参照してください。 |
| [Disabled](../../aspose.html/htmltextareaelement/disabled/) { get; set; } | このコンテキストではコントロールを使用できません。 HTML 4.01. の無効な属性 の定義を参照してください。 |
...
| [Form](../../aspose.html/htmltextareaelement/form/) { get; } | を返します`形状`このコントロールを含む要素。 を返します`ヌル`このコントロールが フォームのコンテキスト内にない場合。 |
...
| [Name](../../aspose.html/htmltextareaelement/name/) { get; set; } | フォームで送信された場合のフォーム コントロールまたはオブジェクト名。 HTML 4.01. の name 属性の定義を参照してください。 |
...
| [ReadOnly](../../aspose.html/htmltextareaelement/readonly/) { get; set; } | このコントロールは読み取り専用です。 HTML 4.01. の readonly 属性の定義を参照してください。 |
| [Rows](../../aspose.html/htmltextareaelement/rows/) { get; set; } | テキスト行の数。 HTML 4.01. の rows 属性の定義を参照してください。 |
...
| [TabIndex](../../aspose.html/htmltextareaelement/tabindex/) { get; set; } | タブ順序での要素の位置を表すインデックス。 HTML 4.01 の tabindex 属性定義を参照してください。 |
...
| [Type](../../aspose.html/htmltextareaelement/type/) { get; } | このフォーム コントロールのタイプ。これは文字列「textarea」. |
| [Value](../../aspose.html/htmltextareaelement/value/) { get; set; } | の対話型ユーザー エージェントで、対応するフォーム コントロールの現在の内容を表します。この属性を変更すると、フォーム コントロールの コンテンツが変更されますが、 要素のコンテンツは変更されません。データ全体が 1 つの に収まらない場合`DOM文字列`、実装はデータを切り捨てる可能性があります. |
