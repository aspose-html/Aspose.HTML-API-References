...
description: Aspose.Html.HTMLButtonElement クラス. 押しボタン HTML 4.01. の BUTTON 要素の定義を参照してください
type: docs
weight: 3130
url: /ja/net/aspose.html/htmlbuttonelement/
---
## HTMLButtonElement class

押しボタン。 HTML 4.01. の BUTTON 要素の定義を参照してください。
...
| 名前 | 説明 |
| --- | --- |
| [AccessKey](../../aspose.html/htmlbuttonelement/accesskey/) { get; set; } | フォーム コントロールにアクセスするための 1 文字のアクセス キー。 HTML 4.01 の accesskey 属性の定義を参照してください。 |
...
| [Disabled](../../aspose.html/htmlbuttonelement/disabled/) { get; set; } | このコンテキストではコントロールを使用できません。 HTML 4.01. の無効な属性 の定義を参照してください。 |
...
| [Form](../../aspose.html/htmlbuttonelement/form/) { get; } | を返します`形状`このコントロールを含む要素。 を返します`ヌル`このコントロールが フォームのコンテキスト内にない場合。 |
...
| [Name](../../aspose.html/htmlbuttonelement/name/) { get; set; } | フォームで送信された場合のフォーム コントロールまたはオブジェクト名。 HTML 4.01. の name 属性の定義を参照してください。 |
...
| [TabIndex](../../aspose.html/htmlbuttonelement/tabindex/) { get; set; } | タブ順序での要素の位置を表すインデックス。 HTML 4.01 の tabindex 属性定義を参照してください。 |
...
| [Type](../../aspose.html/htmlbuttonelement/type/) { get; set; } | ボタンのタイプ (すべて小文字)。 HTML 4.01. の type 属性定義 を参照してください。 |
| [Value](../../aspose.html/htmlbuttonelement/value/) { get; set; } | 現在のフォーム コントロール値。 HTML 4.01. の value 属性の定義を参照してください。 |
