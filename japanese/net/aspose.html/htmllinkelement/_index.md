...
description: Aspose.Html.HTMLLinkElement クラス. リンク要素は外部リソースへのリンクを指定し はこのドキュメントとそのリソースとの関係 またはその逆 を定義します HTML 4.01 の LINK 要素の定義を参照してください  も参照してくださいリンクスタイル StyleSheet モジュールのインターフェース DOM レベル 2 スタイル シートと CSS .
type: docs
weight: 3370
url: /ja/net/aspose.html/htmllinkelement/
---
## HTMLLinkElement class

`リンク`要素は外部リソースへのリンクを指定し、 はこのドキュメントとそのリソースとの関係 (またはその逆) を定義します。 HTML 4.01 の LINK 要素の定義を参照してください ( も参照してください)。`リンクスタイル` StyleSheet モジュールのインターフェース [[DOM レベル 2 スタイル シートと CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113) ]).
...
| [Charset](../../aspose.html/htmllinkelement/charset/) { get; set; } | リンク先のリソースの文字エンコード。 HTML 4.01. の charset 属性の定義を参照してください。 |
...
| [Disabled](../../aspose.html/htmllinkelement/disabled/) { get; set; } | リンクを有効/無効にします。これは現在、スタイル シート リンクにのみ使用され、スタイル シートをアクティブ化または非アクティブ化するために使用できます。 |
...
| [Href](../../aspose.html/htmllinkelement/href/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] リンクされたリソースの。 HTML 4.01. の href 属性の定義を参照してください。 |
| [Hreflang](../../aspose.html/htmllinkelement/hreflang/) { get; set; } | リンクされたリソースの言語コード。 HTML 4.01. の hreflang 属性 定義を参照してください。 |
...
| [Media](../../aspose.html/htmllinkelement/media/) { get; set; } | 1 つ以上のターゲット メディアで使用するように設計されています。 HTML 4.01. のメディア属性 定義を参照してください。 |
...
| [Rel](../../aspose.html/htmllinkelement/rel/) { get; set; } | フォワード リンク タイプ。 HTML 4.01. の rel 属性の定義を参照してください。 |
| [RelList](../../aspose.html/htmllinkelement/rellist/) { get; } | 「rel」属性の解析から受け取ったトークンを含むライブ DOMTokenList を返します。 |
| [Rev](../../aspose.html/htmllinkelement/rev/) { get; set; } | リバース リンク タイプ。 HTML 4.01. の rev 属性の定義を参照してください。 |
...
| [Sheet](../../aspose.html/htmllinkelement/sheet/) { get; } | 関連付けられたスタイル シートを取得します。 |
...
| [Target](../../aspose.html/htmllinkelement/target/) { get; set; } | リソースをレンダリングするフレーム。 HTML 4.01. のターゲット属性の定義を参照してください。 |
...
| [Type](../../aspose.html/htmllinkelement/type/) { get; set; } | アドバイザリ コンテンツ タイプ。 HTML 4.01. の type 属性の定義を参照してください。 |
