...
description: Aspose.Html.HTMLImageElement クラス. 埋め込み画像 HTML 4.01. の IMG 要素の定義を参照してください
type: docs
weight: 3310
url: /ja/net/aspose.html/htmlimageelement/
---
## HTMLImageElement class

埋め込み画像。 HTML 4.01. の IMG 要素の定義を参照してください。
...
| 名前 | 説明 |
| --- | --- |
| [Align](../../aspose.html/htmlimageelement/align/) { get; set; } | 周囲のテキストに対して このオブジェクトを (垂直または水平に) 揃えます。 HTML 4.01 の align 属性の定義を参照してください。 この属性は、HTML 4.01. で廃止されました。 |
| [Alt](../../aspose.html/htmlimageelement/alt/) { get; set; } | この 要素の通常のコンテンツをレンダリングしないユーザー エージェントの代替テキスト。 HTML 4.01. の alt 属性の定義を参照してください。 |
...
| [Border](../../aspose.html/htmlimageelement/border/) { get; set; } | 画像周囲の境界線の幅。 HTML 4.01 の境界属性の定義を参照してください。この属性は、HTML 4.01 では推奨されていません。この属性の タイプは`DOM文字列`DOM レベル 1 の HTML [[DOM レベル 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ] . |
...
| [Height](../../aspose.html/htmlimageelement/height/) { get; set; } | 画像の高さ (ピクセル単位)。 HTML 4.01 の高さ属性の定義を参照してください。この属性のタイプは であることに注意してください`DOM文字列`DOM レベル 1 の HTML [[DOM レベル 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001)]. @version DOM レベル 2 |
| [Hspace](../../aspose.html/htmlimageelement/hspace/) { get; set; } | この画像の左右の水平スペース (ピクセル単位)。 HTML 4.01 の hspace 属性の定義を参照してください。この属性は、HTML 4.01 で廃止予定の です。この属性のタイプは であることに注意してください`DOM文字列`DOM レベル 1 の HTML [[DOM レベル 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001)]. @version DOM レベル 2 |
...
| [IsMap](../../aspose.html/htmlimageelement/ismap/) { get; set; } | サーバー側のイメージ マップを使用します。 HTML 4.01. の ismap 属性定義を参照してください。 |
...
| [LongDesc](../../aspose.html/htmlimageelement/longdesc/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] この画像またはフレームの長い説明を指定します。 HTML 4.01. の longdesc 属性の定義を参照してください。 |
| [Name](../../aspose.html/htmlimageelement/name/) { get; set; } | 要素の名前 (下位互換性のため)。 |
...
| [Src](../../aspose.html/htmlimageelement/src/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] この画像のソースを指定します。 HTML 4.01. の src 属性 定義を参照してください。 |
...
| [UseMap](../../aspose.html/htmlimageelement/usemap/) { get; set; } | クライアント側のイメージ マップを使用します。 HTML 4.01. の usemap 属性の定義を参照してください。 |
| [Vspace](../../aspose.html/htmlimageelement/vspace/) { get; set; } | この画像の上下の垂直スペース (ピクセル単位)。 HTML 4.01 の vspace 属性の定義を参照してください。この属性は、 HTML 4.01 で廃止されました。 DOM Level 1 HTML [[DOM レベル 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001)]. @version DOM レベル 2 |
| [Width](../../aspose.html/htmlimageelement/width/) { get; set; } | 画像の幅 (ピクセル単位)。 HTML 4.01 の width 属性の定義を参照してください。この属性のタイプは であることに注意してください`DOM文字列`DOM レベル 1 の HTML [[DOM レベル 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001)]. @version DOM レベル 2 |
