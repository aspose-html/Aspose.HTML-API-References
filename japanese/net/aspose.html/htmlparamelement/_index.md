...
description: Aspose.Html.HTMLParamElement クラス. に供給されるパラメータ物体エレメント HTML 4.01. の PARAM 要素 定義を参照してください
type: docs
weight: 3480
url: /ja/net/aspose.html/htmlparamelement/
---
## HTMLParamElement class

に供給されるパラメータ`物体`エレメント。 HTML 4.01. の PARAM 要素 定義を参照してください。
...
| [Name](../../aspose.html/htmlparamelement/name/) { get; set; } | 実行時パラメーターの名前。 HTML 4.01. の name 属性の定義を参照してください。 |
...
| [Type](../../aspose.html/htmlparamelement/type/) { get; set; } | のコンテンツ タイプ`価値` の場合の属性`値の種類`値は「ref」です。 HTML 4.01. の type 属性 定義を参照してください。 |
| [Value](../../aspose.html/htmlparamelement/value/) { get; set; } | 実行時パラメーターの値。 HTML 4.01. の value 属性定義 を参照してください。 |
| [ValueType](../../aspose.html/htmlparamelement/valuetype/) { get; set; } | の意味に関する情報`価値`属性 値。 HTML 4.01. の valuetype 属性の定義を参照してください。 |
