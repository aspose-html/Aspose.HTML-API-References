...
description: Aspose.Html.HTMLIsIndexElement クラス. この要素は1 行のテキスト入力に使用されます HTML 4.01 の ISINDEX 要素 定義を参照してくださいこの要素はHTML 4.01. で廃止されました
type: docs
weight: 3330
url: /ja/net/aspose.html/htmlisindexelement/
---
## HTMLIsIndexElement class

この要素は、1 行のテキスト入力に使用されます。 HTML 4.01 の ISINDEX 要素 定義を参照してください。この要素は、HTML 4.01. で廃止されました。
...
| [Form](../../aspose.html/htmlisindexelement/form/) { get; } | を返しますこのコントロールを含む要素。 を返しますこのコントロールが フォームのコンテキスト内にない場合。 |
...
| [Prompt](../../aspose.html/htmlisindexelement/prompt/) { get; set; } | プロンプト メッセージ。 HTML 4.01 のプロンプト属性の定義を参照してください。 この属性は、HTML 4.01. で廃止されました。 |
