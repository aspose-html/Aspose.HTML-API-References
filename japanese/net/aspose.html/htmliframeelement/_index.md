...
description: Aspose.Html.HTMLIFrameElement クラス. インライン サブウィンドウ HTML 4.01. の IFRAME 要素の定義を参照してください
type: docs
weight: 3300
url: /ja/net/aspose.html/htmliframeelement/
---
## HTMLIFrameElement class

インライン サブウィンドウ。 HTML 4.01. の IFRAME 要素の定義を参照してください。
...
| 名前 | 説明 |
| --- | --- |
| [Align](../../aspose.html/htmliframeelement/align/) { get; set; } | 周囲のテキストに対して このオブジェクトを (垂直または水平に) 揃えます。 HTML 4.01 の align 属性の定義を参照してください。 この属性は、HTML 4.01. で廃止されました。 |
...
| [FrameBorder](../../aspose.html/htmliframeelement/frameborder/) { get; set; } | フレーム枠をリクエストします。 HTML 4.01. の frameborder 属性の定義を参照してください。 |
| [Height](../../aspose.html/htmliframeelement/height/) { get; set; } | フレームの高さ。 HTML 4.01. の高さ属性の定義を参照してください。 |
...
| [LongDesc](../../aspose.html/htmliframeelement/longdesc/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] この画像またはフレームの長い説明を指定します。 HTML 4.01. の longdesc 属性の定義を参照してください。 |
| [MarginHeight](../../aspose.html/htmliframeelement/marginheight/) { get; set; } | フレーム マージンの高さ (ピクセル単位)。 HTML 4.01. の marginheight 属性 定義を参照してください。 |
| [MarginWidth](../../aspose.html/htmliframeelement/marginwidth/) { get; set; } | フレーム マージンの幅 (ピクセル単位)。 HTML 4.01. の marginwidth 属性定義 を参照してください。 |
| [Name](../../aspose.html/htmliframeelement/name/) { get; set; } | フレーム名 (オブジェクトの`目標`属性）。 HTML 4.01. の name 属性の定義を参照してください。 |
...
| [Scrolling](../../aspose.html/htmliframeelement/scrolling/) { get; set; } | フレームにスクロールバーを表示するかどうかを指定します。 HTML 4.01. の スクロール属性の定義を参照してください。 |
| [ShadowRoot](../../aspose.html.dom/element/shadowroot/) { get; } | この要素に格納されている shadowRoot を返すか、閉じている場合は null を返します。 |
| [Src](../../aspose.html/htmliframeelement/src/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] 初期フレームの内容を指定します。 HTML 4.01. の src 属性 定義を参照してください。 |
...
| [Width](../../aspose.html/htmliframeelement/width/) { get; set; } | フレーム幅。 HTML 4.01. の width 属性の定義を参照してください。 |
