...
description: Aspose.Html.HTMLMapElement クラス. クライアント側のイメージ マップ HTML 4.01. の MAP 要素の定義を参照してください
type: docs
weight: 3380
url: /ja/net/aspose.html/htmlmapelement/
---
## HTMLMapElement class

クライアント側のイメージ マップ。 HTML 4.01. の MAP 要素の定義を参照してください。
...
| 名前 | 説明 |
| --- | --- |
| [Areas](../../aspose.html/htmlmapelement/areas/) { get; } | イメージ マップ用に定義された領域のリスト。 |
...
| [Name](../../aspose.html/htmlmapelement/name/) { get; set; } | マップに名前を付けます (`使用マップ` ）。 HTML 4.01. の name 属性の定義を参照してください。 |
