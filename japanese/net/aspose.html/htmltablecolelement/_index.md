...
description: Aspose.Html.HTMLTableColElement クラス. はコルとコルグループ要素 HTML 4.01. の COL 要素の定義を参照してください
type: docs
weight: 3560
url: /ja/net/aspose.html/htmltablecolelement/
---
## HTMLTableColElement class

は、`コル`と`コルグループ`要素。 HTML 4.01. の COL 要素の定義を参照してください。
...
| 名前 | 説明 |
| --- | --- |
| [Align](../../aspose.html/htmltablecolelement/align/) { get; set; } | 列のセル データの水平方向の配置。 HTML 4.01. の align 属性 定義を参照してください。 |
...
| [Ch](../../aspose.html/htmltablecolelement/ch/) { get; set; } | 列内のセルの配置文字。 HTML 4.01. の char 属性 定義を参照してください。 |
...
| [ChOff](../../aspose.html/htmltablecolelement/choff/) { get; set; } | 整列文字のオフセット。 HTML 4.01. の charoff 属性の定義を参照してください。 |
...
| [Span](../../aspose.html/htmltablecolelement/span/) { get; set; } | グループ内またはグループ化の影響を受ける列の数を示します。 HTML 4.01 の span 属性の定義を参照してください。 |
...
| [VAlign](../../aspose.html/htmltablecolelement/valign/) { get; set; } | 列のセル データの垂直方向の配置。 HTML 4.01. の valign 属性 定義を参照してください。 |
| [Width](../../aspose.html/htmltablecolelement/width/) { get; set; } | デフォルトの列幅。 HTML 4.01. の width 属性の定義を参照してください。 |
