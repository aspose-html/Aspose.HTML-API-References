...
description: Aspose.Html.HTMLTableSectionElement クラス. 宣伝TFOOT  とTBODY 要素
type: docs
weight: 3590
url: /ja/net/aspose.html/htmltablesectionelement/
---
...
| 名前 | 説明 |
| --- | --- |
| [Align](../../aspose.html/htmltablesectionelement/align/) { get; set; } | セル内のデータの水平方向の配置。を参照してください`整列する`詳細については、HTMLTheadElement の 属性を参照してください。 |
...
| [Ch](../../aspose.html/htmltablesectionelement/ch/) { get; set; } | 列内のセルの配置文字。 HTML 4.01. の char 属性 定義を参照してください。 |
...
| [ChOff](../../aspose.html/htmltablesectionelement/choff/) { get; set; } | 整列文字のオフセット。 HTML 4.01. の charoff 属性の定義を参照してください。 |
...
| [Rows](../../aspose.html/htmltablesectionelement/rows/) { get; } | このテーブル セクションの行のコレクション。 |
...
| [VAlign](../../aspose.html/htmltablesectionelement/valign/) { get; set; } | セル内のデータの垂直方向の配置。を参照してください`不正な`詳細については、HTMLTheadElement の 属性を参照してください。 |
...
| [DeleteRow](../../aspose.html/htmltablesectionelement/deleterow/)(int) | このセクションから行を削除します。 |
...
| [InsertRow](../../aspose.html/htmltablesectionelement/insertrow/)(int) | このセクションに行を挿入します。新しい行は、現在の 直前に挿入されます`索引`このセクションの th 行。 の場合`索引`-1 またはこの セクションの行数に等しい場合、新しい行が追加されます。 |
