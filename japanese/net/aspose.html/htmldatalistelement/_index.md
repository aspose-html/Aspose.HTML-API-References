...
description: Aspose.Html.HTMLDataListElement クラス. datalist 要素は他のコントロールの定義済みオプションを表すオプション要素のセットを表します も参照してくださいHTML 5.2 W3C 勧告.
type: docs
weight: 3160
url: /ja/net/aspose.html/htmldatalistelement/
---
## HTMLDataListElement class

datalist 要素は、他のコントロールの定義済みオプションを表すオプション要素のセットを表します。 も参照してください。[HTML 5.2 W3C 勧告](https://www.w3.org/TR/html52/sec-forms.html#elementdef-datalist).
...
| [Options](../../aspose.html/htmldatalistelement/options/) { get; } | のコレクション`オプション`この 要素に含まれる要素。 |
