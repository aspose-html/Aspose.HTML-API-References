...
description: Aspose.Html.HTMLPreElement クラス. 整形済みテキスト HTML 4.01. の PRE 要素の定義を参照してください
type: docs
weight: 3490
url: /ja/net/aspose.html/htmlpreelement/
---
## HTMLPreElement class

整形済みテキスト。 HTML 4.01. の PRE 要素の定義を参照してください。
...
| [Width](../../aspose.html/htmlpreelement/width/) { get; set; } | コンテンツの固定幅。 HTML 4.01 の width 属性の定義を参照してください。この属性は、HTML 4.01. で廃止されました。 |
