...
description: Aspose.Html.HTMLOptionElement クラス. 選択可能な選択肢 HTML 4.01. の OPTION 要素の定義を参照してください
type: docs
weight: 3460
url: /ja/net/aspose.html/htmloptionelement/
---
## HTMLOptionElement class

選択可能な選択肢。 HTML 4.01. の OPTION 要素の定義を参照してください。
...
| [DefaultSelected](../../aspose.html/htmloptionelement/defaultselected/) { get; set; } | HTML の selected 属性の値を表します。この 属性の値は、対話型ユーザー エージェント内の対応するフォーム コントロールの状態が変化しても変化しません。 HTML 4.01. @version DOM Level 2 で選択された 属性定義を参照してください。 |
| [Dir](../../aspose.html/htmlelement/dir/) { get; set; } | 方向的にニュートラルなテキストのベース方向とテーブルの 方向性を指定します。 HTML 4.01. の dir 属性の定義を参照してください。 |
| [Disabled](../../aspose.html/htmloptionelement/disabled/) { get; set; } | このコンテキストではコントロールを使用できません。 HTML 4.01. の disabled 属性の定義を参照してください。 |
...
| [Form](../../aspose.html/htmloptionelement/form/) { get; } | を返します`形状`このコントロールを含む要素。 を返します`ヌル`このコントロールが フォームのコンテキスト内にない場合。 |
| [Id](../../aspose.html/htmlelement/id/) { get; set; } | 要素の識別子。 HTML 4.01. の id 属性の定義を参照してください。 |
| [Index](../../aspose.html/htmloptionelement/index/) { get; } | このインデックス`オプション`その親で`選択する`0. から始まる @version DOM Level 2 |
...
| [Label](../../aspose.html/htmloptionelement/label/) { get; set; } | 階層メニューで使用するオプション ラベル。 HTML 4.01. の label 属性の定義を参照してください。 |
...
| [Selected](../../aspose.html/htmloptionelement/selected/) { get; set; } | 対話型ユーザー エージェントで、対応するフォーム コントロールの現在の状態を表します。この属性を変更すると、フォーム コントロールの の状態が変更されますが、要素の HTML selected 属性の値は変更されません。 |
...
| [Text](../../aspose.html/htmloptionelement/text/) { get; } | オプション要素に含まれるテキスト。 |
...
| [Value](../../aspose.html/htmloptionelement/value/) { get; set; } | 現在のフォーム コントロール値。 HTML 4.01. の value 属性の定義を参照してください。 |
