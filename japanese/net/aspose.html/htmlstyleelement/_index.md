...
description: Aspose.Html.HTMLStyleElement クラス. スタイル情報 HTML 4.01 の STYLE 要素定義CSS モジュール DOM レベル 2 スタイル シートと CSS  そしてそのリンクスタイルStyleSheets モジュールのインターフェース DOM レベル 2 スタイル シートと CSS 
type: docs
weight: 3530
url: /ja/net/aspose.html/htmlstyleelement/
---
## HTMLStyleElement class

スタイル情報。 HTML 4.01 の STYLE 要素定義、CSS モジュール [[DOM レベル 2 スタイル シートと CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113) ] そしてその`リンクスタイル`StyleSheets モジュールのインターフェース [[DOM レベル 2 スタイル シートと CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113) ]。
...
| [Disabled](../../aspose.html/htmlstyleelement/disabled/) { get; set; } | スタイルシートを有効/無効にします。 |
...
| [Media](../../aspose.html/htmlstyleelement/media/) { get; set; } | 1 つ以上のターゲット メディアで使用するように設計されています。 HTML 4.01. のメディア属性 定義を参照してください。 |
...
| [Sheet](../../aspose.html/htmlstyleelement/sheet/) { get; } | 関連付けられたスタイル シートを取得します。 |
...
| [Type](../../aspose.html/htmlstyleelement/type/) { get; set; } | スタイル シート言語のコンテンツ タイプ。 HTML 4.01. の type 属性 定義を参照してください。 |
