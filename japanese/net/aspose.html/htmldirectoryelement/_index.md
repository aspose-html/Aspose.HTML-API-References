...
description: Aspose.Html.HTMLDirectoryElement クラス. ディレクトリ リスト HTML 4.01 の DIR 要素の定義を参照してくださいこの要素 はHTML 4.01. で廃止されました
type: docs
weight: 3170
url: /ja/net/aspose.html/htmldirectoryelement/
---
## HTMLDirectoryElement class

ディレクトリ リスト。 HTML 4.01 の DIR 要素の定義を参照してください。この要素 は、HTML 4.01. で廃止されました。
...
| [Compact](../../aspose.html/htmldirectoryelement/compact/) { get; set; } | リスト項目間のスペースを減らします。 HTML 4.01 のコンパクト属性定義 を参照してください。この属性は、HTML 4.01. で廃止されました。 |
