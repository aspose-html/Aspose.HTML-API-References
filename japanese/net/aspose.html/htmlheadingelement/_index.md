...
description: Aspose.Html.HTMLHeadingElement クラス. H1にH6要素 HTML 4.01. の H1 element 定義を参照してください
type: docs
weight: 3280
url: /ja/net/aspose.html/htmlheadingelement/
---
## HTMLHeadingElement class

`H1`に`H6`要素。 HTML 4.01. の H1 element 定義を参照してください。
...
| 名前 | 説明 |
| --- | --- |
| [Align](../../aspose.html/htmlheadingelement/align/) { get; set; } | 水平方向のテキスト配置。 HTML 4.01 の align 属性の定義を参照してください。この属性は、HTML 4.01. で廃止されました。 |
