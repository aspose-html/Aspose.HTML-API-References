...
description: Aspose.Html.HTMLAnchorElement クラス. アンカー要素 HTML 4.01. の A 要素の定義を参照してください
type: docs
weight: 3060
url: /ja/net/aspose.html/htmlanchorelement/
---
## HTMLAnchorElement class

アンカー要素。 HTML 4.01. の A 要素の定義を参照してください。
...
| 名前 | 説明 |
| --- | --- |
| [AccessKey](../../aspose.html/htmlanchorelement/accesskey/) { get; set; } | フォーム コントロールにアクセスするための 1 文字のアクセス キー。 HTML 4.01 の accesskey 属性の定義を参照してください。 |
...
| [Charset](../../aspose.html/htmlanchorelement/charset/) { get; set; } | リンクされたリソースの文字エンコード。 HTML 4.01. の charset 属性の定義を参照してください。 |
...
| [Coords](../../aspose.html/htmlanchorelement/coords/) { get; set; } | アクティブな領域の形状を定義する長さのカンマ区切りリスト。 も参照`形`地域の形のために。 HTML 4.01. の coords 属性定義を参照してください。 |
...
| [Hash](../../aspose.html/htmlanchorelement/hash/) { get; set; } | 関連付けられた URL のハッシュ セグメントの文字列表現を取得または設定します。 |
| [Host](../../aspose.html/htmlanchorelement/host/) { get; set; } | 関連付けられた URL のホスト セグメントとポート セグメントの文字列表現を取得または設定します。 |
| [Hostname](../../aspose.html/htmlanchorelement/hostname/) { get; set; } | 関連付けられた URL のホスト セグメントの文字列表現を取得または設定します。 |
| [Href](../../aspose.html/htmlanchorelement/href/) { get; set; } | 絶対 URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) リンクされたリソースの。 HTML 4.01. の href 属性 定義を参照してください。 |
| [Hreflang](../../aspose.html/htmlanchorelement/hreflang/) { get; set; } | リンクされたリソースの言語コード。 HTML 4.01. の hreflang 属性 定義を参照してください。 |
...
| [Name](../../aspose.html/htmlanchorelement/name/) { get; set; } | アンカー名。 HTML 4.01. の name 属性の定義を参照してください。 |
...
| [Origin](../../aspose.html/htmlanchorelement/origin/) { get; } | 関連付けられた URL の元のセグメントの文字列表現を取得します。 |
...
| [Password](../../aspose.html/htmlanchorelement/password/) { get; set; } | 関連付けられた URL のパスワード セグメントの文字列表現を取得または設定します。 |
| [Pathname](../../aspose.html/htmlanchorelement/pathname/) { get; set; } | 関連付けられた URL のパス セグメントの文字列表現を取得または設定します。 |
| [Port](../../aspose.html/htmlanchorelement/port/) { get; set; } | 関連付けられた URL のポート セグメントの文字列表現を取得または設定します。 |
...
| [Protocol](../../aspose.html/htmlanchorelement/protocol/) { get; set; } | 関連付けられた URL のスキーム セグメントの文字列表現を取得または設定します。 |
| [Rel](../../aspose.html/htmlanchorelement/rel/) { get; set; } | フォワード リンク タイプ。 HTML 4.01. の rel 属性の定義を参照してください。 |
| [RelList](../../aspose.html/htmlanchorelement/rellist/) { get; } | 「rel」属性の解析から受け取ったトークンを含むライブ DOMTokenList を返します。 |
| [Rev](../../aspose.html/htmlanchorelement/rev/) { get; set; } | リバース リンク タイプ。 HTML 4.01. の rev 属性の定義を参照してください。 |
| [SchemaTypeInfo](../../aspose.html.dom/element/schematypeinfo/) { get; } | この要素に関連付けられた型情報。 |
| [Search](../../aspose.html/htmlanchorelement/search/) { get; set; } | 関連付けられた URL の検索セグメントの文字列表現を取得または設定します。 |
| [ShadowRoot](../../aspose.html.dom/element/shadowroot/) { get; } | この要素に格納されている shadowRoot を返すか、閉じている場合は null を返します。 |
| [Shape](../../aspose.html/htmlanchorelement/shape/) { get; set; } | アクティブ領域の形状。座標は で与えられます`座標` HTML 4.01. の shape 属性の定義を参照してください。 |
| [Style](../../aspose.html/htmlelement/style/) { get; } | 作成者がスタイル情報を特定の要素に直接適用できるようにするスタイル属性を表します. |
| [TabIndex](../../aspose.html/htmlanchorelement/tabindex/) { get; set; } | タブ順序での要素の位置を表すインデックス。 HTML 4.01 の tabindex 属性定義を参照してください。 |
| [TagName](../../aspose.html.dom/element/tagname/) { get; } | 要素の名前。 |
| [Target](../../aspose.html/htmlanchorelement/target/) { get; set; } | リソースをレンダリングするフレーム。 HTML 4.01. のターゲット属性の定義を参照してください。 |
...
| [Type](../../aspose.html/htmlanchorelement/type/) { get; set; } | アドバイザリ コンテンツ タイプ。 HTML 4.01. の type 属性の定義を参照してください。 |
| [Username](../../aspose.html/htmlanchorelement/username/) { get; set; } | 関連付けられた URL のユーザー名セグメントの文字列表現を取得または設定します。 |
...
| [Blur](../../aspose.html/htmlanchorelement/blur/)() | この要素からキーボード フォーカスを削除します。 |
...
| [Focus](../../aspose.html/htmlanchorelement/focus/)() | この要素にキーボード フォーカスを与えます。 |
