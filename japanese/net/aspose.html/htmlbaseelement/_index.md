...
description: Aspose.Html.HTMLBaseElement クラス. ドキュメント ベース URI IETF RFC 2396  HTML 4.01. の BASE 要素の定義を参照してください
type: docs
weight: 3100
url: /ja/net/aspose.html/htmlbaseelement/
---
## HTMLBaseElement class

ドキュメント ベース URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ]。 HTML 4.01. の BASE 要素の定義を参照してください。
...
| [Href](../../aspose.html/htmlbaseelement/href/) { get; set; } | ベース URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ]。 HTML 4.01. の href 属性の定義を参照してください。 |
...
| [Target](../../aspose.html/htmlbaseelement/target/) { get; set; } | デフォルトのターゲット フレーム。 HTML 4.01. の target 属性の定義を参照してください。 |
