...
description: Aspose.Html.HTMLFormElement クラス. 形状要素にはコレクション および要素と同様の動作が含まれます含まれているフォーム コントロール およびフォーム要素の属性への直接アクセスを提供します HTML 4.01. の FORM 要素 定義を参照してください
type: docs
weight: 3230
url: /ja/net/aspose.html/htmlformelement/
---
## HTMLFormElement class

`形状`要素には、コレクション および要素と同様の動作が含まれます。含まれているフォーム コントロール およびフォーム要素の属性への直接アクセスを提供します。 HTML 4.01. の FORM 要素 定義を参照してください。
...
| 名前 | 説明 |
| --- | --- |
| [AcceptCharset](../../aspose.html/htmlformelement/acceptcharset/) { get; set; } | サーバーがサポートする文字セットのリスト。 HTML 4.01. の accept-charset 属性の定義を参照してください。 |
| [Action](../../aspose.html/htmlformelement/action/) { get; set; } | サーバー側のフォーム ハンドラー。 HTML 4.01. の action 属性の定義を参照してください。 |
...
| [Elements](../../aspose.html/htmlformelement/elements/) { get; } | フォーム内のすべてのフォーム コントロール要素のコレクションを返します。 |
| [Enctype](../../aspose.html/htmlformelement/enctype/) { get; set; } | 送信されたフォームのコンテンツ タイプ。通常は "application/x-www-form-urlencoded" です。 HTML 4.01 の enctype 属性 定義を参照してください。 onsubmit イベント ハンドラーは、このメソッドの呼び出し時に がトリガーされる保証はありません。動作は歴史的な理由から 矛盾しており、作者は 特定のものに依存すべきではありません. |
...
| [Length](../../aspose.html/htmlformelement/length/) { get; } | フォーム内のフォーム コントロールの数。 |
...
| [Method](../../aspose.html/htmlformelement/method/) { get; set; } | HTTP メソッド [[IETF RFC 2616](http://www.ietf.org/rfc/rfc2616.txt) フォームの送信に使用されます。 HTML 4.01. のメソッド属性定義を参照してください。 |
| [Name](../../aspose.html/htmlformelement/name/) { get; set; } | フォームに名前を付けます。 |
...
| [Target](../../aspose.html/htmlformelement/target/) { get; set; } | リソースをレンダリングするフレーム。 HTML 4.01. のターゲット属性の定義を参照してください。 |
...
| [Reset](../../aspose.html/htmlformelement/reset/)() | フォーム要素のデフォルト値を復元します。リセットボタンと同じアクション を実行します. |
...
| [Submit](../../aspose.html/htmlformelement/submit/)() | フォームを送信します。送信ボタンと同じアクションを実行します. |
