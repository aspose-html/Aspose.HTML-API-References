...
description: Aspose.Html.HTMLFontElement クラス. ローカルでフォントを変更 HTML 4.01 の FONT 要素の定義を参照してくださいこの 要素はHTML 4.01. で廃止されました
type: docs
weight: 3220
url: /ja/net/aspose.html/htmlfontelement/
---
## HTMLFontElement class

ローカルでフォントを変更。 HTML 4.01 の FONT 要素の定義を参照してください。この 要素は、HTML 4.01. で廃止されました。
...
| [Color](../../aspose.html/htmlfontelement/color/) { get; set; } | フォントの色。 HTML 4.01 の color 属性の定義を参照してください。この 属性は、HTML 4.01. で廃止されました。 |
| [Dir](../../aspose.html/htmlelement/dir/) { get; set; } | 方向的にニュートラルなテキストのベース方向とテーブルの 方向性を指定します。 HTML 4.01. の dir 属性の定義を参照してください。 |
| [Face](../../aspose.html/htmlfontelement/face/) { get; set; } | フォント フェース識別子。 HTML 4.01 の face 属性の定義を参照してください。 この属性は、HTML 4.01. で廃止されました。 |
...
| [Size](../../aspose.html/htmlfontelement/size/) { get; set; } | フォント サイズ。 HTML 4.01 の size 属性の定義を参照してください。この 属性は、HTML 4.01. で廃止されました。 |
