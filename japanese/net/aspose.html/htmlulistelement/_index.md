...
description: Aspose.Html.HTMLUListElement クラス. 順序付けられていないリスト HTML 4.01. の UL 要素の定義を参照してください
type: docs
weight: 3630
url: /ja/net/aspose.html/htmlulistelement/
---
## HTMLUListElement class

順序付けられていないリスト。 HTML 4.01. の UL 要素の定義を参照してください。
...
| [Compact](../../aspose.html/htmlulistelement/compact/) { get; set; } | リスト項目間のスペースを減らします。 HTML 4.01 のコンパクト属性定義 を参照してください。この属性は、HTML 4.01. で廃止されました。 |
...
| [Type](../../aspose.html/htmlulistelement/type/) { get; set; } | 箇条書きスタイル。 HTML 4.01 の type 属性の定義を参照してください。この 属性は、HTML 4.01. で廃止されました。 |
