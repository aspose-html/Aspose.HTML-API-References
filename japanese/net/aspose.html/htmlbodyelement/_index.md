...
description: Aspose.Html.HTMLBodyElement クラス. HTML ドキュメントの本文この要素は常に DOM API に存在しソース ドキュメントにタグが存在しない場合は であっても存在します HTML 4.01. の BODY 要素 定義を参照してください
type: docs
weight: 3120
url: /ja/net/aspose.html/htmlbodyelement/
---
## HTMLBodyElement class

HTML ドキュメントの本文。この要素は常に DOM API に存在し、ソース ドキュメントにタグが存在しない場合は であっても存在します。 HTML 4.01. の BODY 要素 定義を参照してください。
...
| 名前 | 説明 |
| --- | --- |
| [ALink](../../aspose.html/htmlbodyelement/alink/) { get; set; } | アクティブなリンクの色 (マウス ボタンを押した後、マウス ボタンを アップする前)。 HTML 4.01 の alink 属性の定義を参照してください。この属性 は、HTML 4.01. で廃止されました。 |
| override [Attributes](../../aspose.html.dom/element/attributes/) { get; } | このノードの属性を含む NamedNodeMap (要素の場合)、またはそれ以外の場合は null. |
| [Background](../../aspose.html/htmlbodyelement/background/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] 背景テクスチャ タイル イメージの。 HTML 4.01 の background 属性 の定義を参照してください。この属性は、HTML 4.01. で廃止されました。 |
| virtual [BaseURI](../../aspose.html.dom/node/baseuri/) { get; } | このノードの絶対ベース URI、または実装が絶対 URI を取得できなかった場合は null。 |
| [BgColor](../../aspose.html/htmlbodyelement/bgcolor/) { get; set; } | ドキュメントの背景色。 HTML 4.01 の bgcolor 属性の定義を参照してください。この属性は、HTML 4.01. で廃止されました。 |
...
| [Link](../../aspose.html/htmlbodyelement/link/) { get; set; } | アクティブでなく、未訪問のリンクの色。 HTML 4.01 のリンク 属性定義を参照してください。この属性は、 HTML 4.01. で廃止されました。 |
...
| [Text](../../aspose.html/htmlbodyelement/text/) { get; set; } | ドキュメントのテキストの色。 HTML 4.01 の text 属性の定義を参照してください。 この属性は、HTML 4.01. で廃止されました。 |
...
| [VLink](../../aspose.html/htmlbodyelement/vlink/) { get; set; } | ユーザーが訪問したリンクの色。 HTML 4.01 の vlink 属性の定義を参照してください。この属性は、 HTML 4.01. で廃止されました。 |
