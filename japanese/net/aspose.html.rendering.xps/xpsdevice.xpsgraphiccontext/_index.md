...
description: Aspose.Html.Rendering.Xps.XpsDeviceXpsGraphicContext クラス. XpsDevice の現在のグラフィック コントロール パラメータを保持します これらのパラメータはグラフィック オペレータが実行されるグローバル フレームワークを定義します
type: docs
weight: 4540
url: /ja/net/aspose.html.rendering.xps/xpsdevice.xpsgraphiccontext/
---
## XpsDevice.XpsGraphicContext class

XpsDevice の現在のグラフィック コントロール パラメータを保持します。 これらのパラメータは、グラフィック オペレータが実行されるグローバル フレームワークを定義します。
...
| 名前 | 説明 |
| --- | --- |
| [XpsGraphicContext](xpsgraphiccontext/)() | デフォルトのコンストラクター。 |
...
| 名前 | 説明 |
| --- | --- |
| override [Clone](../../aspose.html.rendering.xps/xpsgraphiccontext/clone/)() | 既存のインスタンスと同じプロパティ値を持つ XpsGraphicContext クラスの新しいインスタンスを作成します。 |
