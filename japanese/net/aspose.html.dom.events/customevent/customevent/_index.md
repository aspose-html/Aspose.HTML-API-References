...
description: CustomEvent コンストラクタ. の新しいインスタンスを初期化しますCustomEvent class.
type: docs
weight: 10
url: /ja/net/aspose.html.dom.events/customevent/customevent/
---
## CustomEvent(string) {#constructor}

の新しいインスタンスを初期化します[`CustomEvent`](../) class.
...
* class [CustomEvent](../)
* 名前空間 [Aspose.Html.Dom.Events](../../customevent/)
* 組み立て [Aspose.HTML](../../../)
