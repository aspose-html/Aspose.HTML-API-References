...
description: UIEvent コンストラクタ. の新しいインスタンスを初期化しますUIEvent class.
type: docs
weight: 10
url: /ja/net/aspose.html.dom.events/uievent/uievent/
---
## UIEvent(string) {#constructor}

の新しいインスタンスを初期化します[`UIEvent`](../) class.
...
* class [UIEvent](../)
* 名前空間 [Aspose.Html.Dom.Events](../../uievent/)
* 組み立て [Aspose.HTML](../../../)
