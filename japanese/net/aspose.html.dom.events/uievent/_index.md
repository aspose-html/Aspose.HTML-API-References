...
description: Aspose.Html.Dom.Events.UIEvent クラス. UIEvent インターフェイスはユーザー インターフェイス イベントに関連する特定のコンテキスト情報を提供します
type: docs
weight: 850
url: /ja/net/aspose.html.dom.events/uievent/
---
## UIEvent class

UIEvent インターフェイスは、ユーザー インターフェイス イベントに関連する特定のコンテキスト情報を提供します。
...
| 名前 | 説明 |
| --- | --- |
| [UIEvent](uievent/#constructor)(string) | の新しいインスタンスを初期化します`UIEvent` class. |
| [UIEvent](uievent/#constructor_1)(string, IDictionary&lt;string, object&gt;) | の新しいインスタンスを初期化します`UIEvent` class. |
