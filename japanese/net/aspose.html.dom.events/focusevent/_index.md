...
description: Aspose.Html.Dom.Events.FocusEvent クラス. FocusEvent インターフェイスはFocus イベントに関連する特定のコンテキスト情報を提供します
type: docs
weight: 780
url: /ja/net/aspose.html.dom.events/focusevent/
---
## FocusEvent class
...
| [RelatedTarget](../../aspose.html.dom.events/focusevent/relatedtarget/) { get; } | イベントのタイプに応じて、Focus イベントに関連するセカンダリ EventTarget を識別するために使用されます。 |
