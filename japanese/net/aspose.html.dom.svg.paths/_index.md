...
description: Aspose.Html.Dom.Svg.Paths名前空間は 塗りつぶしまたはストロークできる形状のアウトラインの表現のクラスを記述します. パスはクリッピング パスとしても使用できアニメーションを記述します またはテキストを配置します.
type: docs
weight: 150
url: /ja/net/aspose.html.dom.svg.paths/
---
**Aspose.Html.Dom.Svg.Paths**名前空間は、 塗りつぶしまたはストロークできる形状のアウトラインの表現のクラスを記述します. パスはクリッピング パスとしても使用でき、アニメーションを記述します またはテキストを配置します.
