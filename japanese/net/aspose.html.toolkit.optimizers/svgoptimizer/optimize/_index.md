...
type: docs
weight: 10
url: /ja/net/aspose.html.toolkit.optimizers/svgoptimizer/optimize/
---
## Optimize(SVGDocument) {#optimize}

最適化[`SVGDocument`](../../../aspose.html.dom.svg/svgdocument/)デフォルトの最適化オプションのセットを適用する.
...
* class [SVGOptimizer](../)
* 名前空間 [Aspose.Html.Toolkit.Optimizers](../../svgoptimizer/)
* 組み立て [Aspose.HTML](../../../)
...
最適化[`SVGDocument`](../../../aspose.html.dom.svg/svgdocument/)指定された最適化オプションのセットを適用することによって.
