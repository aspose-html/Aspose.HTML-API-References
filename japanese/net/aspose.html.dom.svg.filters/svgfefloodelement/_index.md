...
description: Aspose.Html.Dom.Svg.Filters.SVGFEFloodElement クラス. SVGFEFloodElement インターフェイスはfeFlood要素に対応します
type: docs
weight: 1450
url: /ja/net/aspose.html.dom.svg.filters/svgfefloodelement/
---
...
| [Height](../../aspose.html.dom.svg.filters/svgfefloodelement/height/) { get; } | 指定された「フィルター」要素の属性「高さ」に対応します。 |
...
| [Result](../../aspose.html.dom.svg.filters/svgfefloodelement/result/) { get; } | 指定された「フィルター」要素の属性「結果」に対応します。 |
...
| [Width](../../aspose.html.dom.svg.filters/svgfefloodelement/width/) { get; } | 指定された「フィルター」要素の属性「幅」に対応します。 |
| [X](../../aspose.html.dom.svg.filters/svgfefloodelement/x/) { get; } | 指定された「フィルター」要素の属性「x」に対応します。 |
| [Y](../../aspose.html.dom.svg.filters/svgfefloodelement/y/) { get; } | 指定された「フィルター」要素の属性「y」に対応します。 |
