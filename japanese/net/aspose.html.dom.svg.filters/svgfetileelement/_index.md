...
description: Aspose.Html.Dom.Svg.Filters.SVGFETileElement クラス. SVGFETileElement インターフェイスはfeTile要素に対応します
type: docs
weight: 1590
url: /ja/net/aspose.html.dom.svg.filters/svgfetileelement/
---
...
| [Height](../../aspose.html.dom.svg.filters/svgfetileelement/height/) { get; } | 指定された「フィルター」要素の属性「高さ」に対応します。 |
| [Id](../../aspose.html.dom.svg/svgelement/id/) { get; set; } | 指定された要素の 'id' 属性の値、または 'id' が存在しない場合は空の文字列. |
| [In1](../../aspose.html.dom.svg.filters/svgfetileelement/in1/) { get; } | 指定された「feTile」要素の属性「in」に対応します。 |
...
| [Result](../../aspose.html.dom.svg.filters/svgfetileelement/result/) { get; } | 指定された「フィルター」要素の属性「結果」に対応します。 |
...
| [Width](../../aspose.html.dom.svg.filters/svgfetileelement/width/) { get; } | 指定された「フィルター」要素の属性「幅」に対応します。 |
| [X](../../aspose.html.dom.svg.filters/svgfetileelement/x/) { get; } | 指定された「フィルター」要素の属性「x」に対応します。 |
| [Y](../../aspose.html.dom.svg.filters/svgfetileelement/y/) { get; } | 指定された「フィルター」要素の属性「y」に対応します。 |
