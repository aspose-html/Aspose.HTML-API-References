...
description: Aspose.Html.Dom.Svg.Filters.SVGFEBlendElement クラス. SVGFEBlendElement インターフェイスはfeBlend要素に対応します
type: docs
weight: 1360
url: /ja/net/aspose.html.dom.svg.filters/svgfeblendelement/
---
...
| [Height](../../aspose.html.dom.svg.filters/svgfeblendelement/height/) { get; } | 指定された「フィルター」要素の属性「高さ」に対応します。 |
| [Id](../../aspose.html.dom.svg/svgelement/id/) { get; set; } | 指定された要素の 'id' 属性の値、または 'id' が存在しない場合は空の文字列. |
| [In1](../../aspose.html.dom.svg.filters/svgfeblendelement/in1/) { get; } | 指定された「feBlend」要素の属性「in」に対応します。 |
| [In2](../../aspose.html.dom.svg.filters/svgfeblendelement/in2/) { get; } | 指定された「feBlend」要素の属性「in2」に対応します。 |
...
| [Mode](../../aspose.html.dom.svg.filters/svgfeblendelement/mode/) { get; } | 指定された 'feBlend' 要素の属性 'mode' に対応します。このインターフェイスで定義された SVG_FEBLEND_MODE_* 定数の 1 つを取ります。 |
...
| [Result](../../aspose.html.dom.svg.filters/svgfeblendelement/result/) { get; } | 指定された「フィルター」要素の属性「結果」に対応します。 |
...
| [Width](../../aspose.html.dom.svg.filters/svgfeblendelement/width/) { get; } | 指定された「フィルター」要素の属性「幅」に対応します。 |
| [X](../../aspose.html.dom.svg.filters/svgfeblendelement/x/) { get; } | 指定された「フィルター」要素の属性「x」に対応します。 |
| [Y](../../aspose.html.dom.svg.filters/svgfeblendelement/y/) { get; } | 指定された「フィルター」要素の属性「y」に対応します。 |
...
| 名前 | 説明 |
| --- | --- |
| const [SVG_FEBLEND_MODE_COLOR](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_color/) | 値「色」に対応します。 |
| const [SVG_FEBLEND_MODE_COLOR_BURN](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_color_burn/) | 値「color_burn」に対応します。 |
| const [SVG_FEBLEND_MODE_COLOR_DODGE](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_color_dodge/) | 値「color_dodge」に対応します。 |
| const [SVG_FEBLEND_MODE_DARKEN](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_darken/) | 値 'darken' に対応します。 |
| const [SVG_FEBLEND_MODE_DIFFERENCE](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_difference/) | 値「差」に対応します。 |
| const [SVG_FEBLEND_MODE_EXCLUSION](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_exclusion/) | 値「除外」に対応します。 |
| const [SVG_FEBLEND_MODE_HARD_LIGHT](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_hard_light/) | 値「hard_light」に対応します。 |
| const [SVG_FEBLEND_MODE_HUE](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_hue/) | 値「色相」に対応します。 |
| const [SVG_FEBLEND_MODE_LIGHTEN](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_lighten/) | 値「lighten」に対応します。 |
| const [SVG_FEBLEND_MODE_LUMINOSITY](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_luminosity/) | 値「輝度」に対応します。 |
| const [SVG_FEBLEND_MODE_MULTIPLY](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_multiply/) | 値「乗算」に対応します。 |
| const [SVG_FEBLEND_MODE_NORMAL](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_normal/) | 値「通常」に対応します。 |
| const [SVG_FEBLEND_MODE_OVERLAY](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_overlay/) | 値「overlay」に対応します。 |
| const [SVG_FEBLEND_MODE_SATURATION](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_saturation/) | 値「彩度」に対応します。 |
| const [SVG_FEBLEND_MODE_SCREEN](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_screen/) | 値「screen」に対応します。 |
| const [SVG_FEBLEND_MODE_SOFT_LIGHT](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_soft_light/) | 値「soft_light」に対応します。 |
| const [SVG_FEBLEND_MODE_UNKNOWN](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_unknown/) | タイプは定義済みのタイプではありません。この型の新しい値を定義しようとしたり、既存の値をこの型に切り替えようとしたりすることは無効です. |
...
* 名前空間 [Aspose.Html.Dom.Svg.Filters](../../aspose.html.dom.svg.filters/)
* 組み立て [Aspose.HTML](../../)
