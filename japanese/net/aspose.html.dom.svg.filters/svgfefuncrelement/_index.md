...
description: Aspose.Html.Dom.Svg.Filters.SVGFEFuncRElement クラス. SVGFEFuncRElement インターフェイスはfeFuncR要素に対応します
type: docs
weight: 1490
url: /ja/net/aspose.html.dom.svg.filters/svgfefuncrelement/
---
## SVGFEFuncRElement class

SVGFEFuncRElement インターフェイスは「feFuncR」要素に対応します。
