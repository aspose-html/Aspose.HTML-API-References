...
description: Aspose.Html.Dom.Svg.Filters.SVGFEDropShadowElement クラス. SVGFEDropShadowElement インターフェイスはfeDropShadow要素に対応します
type: docs
weight: 1440
url: /ja/net/aspose.html.dom.svg.filters/svgfedropshadowelement/
---
...
| [Dx](../../aspose.html.dom.svg.filters/svgfedropshadowelement/dx/) { get; } | 指定された「feDropShadow」要素の属性「dx」に対応します。 |
| [Dy](../../aspose.html.dom.svg.filters/svgfedropshadowelement/dy/) { get; } | 指定された「feDropShadow」要素の属性「dy」に対応します。 |
...
| [Height](../../aspose.html.dom.svg.filters/svgfedropshadowelement/height/) { get; } | 指定された「feDropShadow」要素の属性「高さ」に対応します。 |
| [Id](../../aspose.html.dom.svg/svgelement/id/) { get; set; } | 指定された要素の 'id' 属性の値、または 'id' が存在しない場合は空の文字列. |
| [In1](../../aspose.html.dom.svg.filters/svgfedropshadowelement/in1/) { get; } | 指定された「feDropShadow」要素の属性「in」に対応します。 |
...
| [Result](../../aspose.html.dom.svg.filters/svgfedropshadowelement/result/) { get; } | 指定された「feDropShadow」要素の属性「result」に対応します。 |
...
| [StdDeviationX](../../aspose.html.dom.svg.filters/svgfedropshadowelement/stddeviationx/) { get; } | 指定された「feDropShadow」要素の属性「stdDeviation」に対応します。属性 'stdDeviation'. の X コンポーネントを含みます |
| [StdDeviationY](../../aspose.html.dom.svg.filters/svgfedropshadowelement/stddeviationy/) { get; } | 指定された「feDropShadow」要素の属性「stdDeviation」に対応します。属性 'stdDeviation'. の Y コンポーネント (自動的に計算される可能性があります) を含みます。 |
...
| [Width](../../aspose.html.dom.svg.filters/svgfedropshadowelement/width/) { get; } | 指定された「feDropShadow」要素の属性「幅」に対応します。 |
| [X](../../aspose.html.dom.svg.filters/svgfedropshadowelement/x/) { get; } | 指定された「feDropShadow」要素の属性「x」に対応します。 |
| [Y](../../aspose.html.dom.svg.filters/svgfedropshadowelement/y/) { get; } | 指定された「feDropShadow」要素の属性「y」に対応します。 |
...
| [SetStdDeviation](../../aspose.html.dom.svg.filters/svgfedropshadowelement/setstddeviation/)(float, float) | 属性「stdDeviation」の値を設定します。 |
