...
description: Aspose.Html.Dom.CDATASection クラス. CDATA セクションはマークアップと見なされる文字を含むテキストのブロックをエスケープするために使用されます
type: docs
weight: 200
url: /ja/net/aspose.html.dom/cdatasection/
---
## CDATASection class
...
| override [NodeName](../../aspose.html.dom/cdatasection/nodename/) { get; } | タイプに応じたこのノードの名前. |
| override [NodeType](../../aspose.html.dom/cdatasection/nodetype/) { get; } | 基礎となるオブジェクトのタイプを表すコード. |
