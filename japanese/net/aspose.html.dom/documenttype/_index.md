...
description: Aspose.Html.Dom.DocumentType クラス. DocumentType はdocument に対して定義されているエンティティのリストへのインターフェイスを提供します
type: docs
weight: 680
url: /ja/net/aspose.html.dom/documenttype/
---
## DocumentType class

DocumentType は、document に対して定義されているエンティティのリストへのインターフェイスを提供します。
...
| 名前 | 説明 |
| --- | --- |
| [DocumentType](documenttype/)(string, string, string, string, Document) | の新しいインスタンスを初期化します`DocumentType` class. |
...
| [InternalSubset](../../aspose.html.dom/documenttype/internalsubset/) { get; } | 文字列としての内部サブセット、または存在しない場合は null. |
...
| [Name](../../aspose.html.dom/documenttype/name/) { get; } | DTD の名前。つまり、DOCTYPE キーワードの直後の名前. |
...
| override [NodeName](../../aspose.html.dom/documenttype/nodename/) { get; } | タイプに応じたこのノードの名前. |
| override [NodeType](../../aspose.html.dom/documenttype/nodetype/) { get; } | 基礎となるオブジェクトのタイプを表すコード. |
...
| [PublicId](../../aspose.html.dom/documenttype/publicid/) { get; } | 外部サブセットの公開識別子. |
| [SystemId](../../aspose.html.dom/documenttype/systemid/) { get; } | 外部サブセットのシステム識別子。これは、絶対 URI である場合とそうでない場合があります。 |
...
| override [ToString](../../aspose.html.dom/documenttype/tostring/)() | を返しますStringこのインスタンスを表す. |
