...
description: Aspose.Html.Dom.CharacterData クラス. CharacterData はDOM 内の文字データにアクセスするための一連の属性とメソッドで Node を拡張します
type: docs
weight: 300
url: /ja/net/aspose.html.dom/characterdata/
---
## CharacterData class

CharacterData は、DOM 内の文字データにアクセスするための一連の属性とメソッドで Node を拡張します。
