...
description: Document 方法. 引数で指定されたすべてのクラスを持つドキュメント内のすべての要素を含むライブ NodeList オブジェクトを返します http//www.w3.org/TR/dom/
type: docs
weight: 970
url: /ja/net/aspose.html.dom/document/getelementsbyclassname/
---
