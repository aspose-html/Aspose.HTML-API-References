...
description: Aspose.Html.Dom.Notation クラス. DTD で宣言されている表記を表します
type: docs
weight: 1010
url: /ja/net/aspose.html.dom/notation/
---
## Notation class
...
| override [NodeName](../../aspose.html.dom/notation/nodename/) { get; } | タイプに応じたこのノードの名前. |
| override [NodeType](../../aspose.html.dom/notation/nodetype/) { get; } | 基礎となるオブジェクトのタイプを表すコード. |
...
| [PublicId](../../aspose.html.dom/notation/publicid/) { get; } | この表記の公開識別子。公開識別子が指定されていない場合、これは null. です。 |
| [SystemId](../../aspose.html.dom/notation/systemid/) { get; } | この表記のシステム識別子。システム ID が指定されていない場合、これはヌルです。これは、絶対 URI である場合とそうでない場合があります。 |
