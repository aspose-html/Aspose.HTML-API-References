...
description: Aspose.Html.Dom.Element クラス. Element インターフェイスはHTML または XML ドキュメント内の要素を表します
type: docs
weight: 690
url: /ja/net/aspose.html.dom/element/
---
## Element class
...
| 名前 | 説明 |
| --- | --- |
| [Element](element/)(IElementInit) | の新しいインスタンスを初期化します`Element`クラス。このコンストラクターを直接呼び出さないでください。[`CreateElement`](../document/createelement/)また[`CreateElementNS`](../document/createelementns/). |
...
| [Id](../../aspose.html.dom/element/id/) { get; set; } | 要素の識別子。 HTML 4.01. の id 属性の定義を参照してください。 |
...
| [ParentElement](../../aspose.html.dom/node/parentelement/) { get; } | 親を取得します`Element`このノードの. |
