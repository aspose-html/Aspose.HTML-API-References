...
description: Aspose.Html.Dom.Node クラス. Node インターフェイスはDocument オブジェクト モデル全体の主要なデータ型ですドキュメント ツリー内の単一のノードを表します
type: docs
weight: 1000
url: /ja/net/aspose.html.dom/node/
---
## Node class
...
| abstract [NodeName](../../aspose.html.dom/node/nodename/) { get; } | タイプに応じたこのノードの名前. |
| abstract [NodeType](../../aspose.html.dom/node/nodetype/) { get; } | 基礎となるオブジェクトのタイプを表すコード. |
...
| [CloneNode](../../aspose.html.dom/node/clonenode/#clonenode)() | このノードの複製を返します。つまり、ノードの汎用コピー コンストラクタとして機能します。複製ノードには親がなく (parentNode が null)、ユーザー データもありません。 |
| [CloneNode](../../aspose.html.dom/node/clonenode/#clonenode_1)(bool) | このノードの複製を返します。つまり、ノードの汎用コピー コンストラクタとして機能します。複製ノードには親がなく (parentNode が null)、ユーザー データもありません。 |
...
| 名前 | 説明 |
| --- | --- |
| const [ATTRIBUTE_NODE](../../aspose.html.dom/node/attribute_node/) | 属性 node |
| const [CDATA_SECTION_NODE](../../aspose.html.dom/node/cdata_section_node/) | cdata セクション node |
| const [COMMENT_NODE](../../aspose.html.dom/node/comment_node/) | コメント node |
| const [DOCUMENT_FRAGMENT_NODE](../../aspose.html.dom/node/document_fragment_node/) | ドキュメントフラグメント node |
| const [DOCUMENT_NODE](../../aspose.html.dom/node/document_node/) | ドキュメント node |
| const [DOCUMENT_TYPE_NODE](../../aspose.html.dom/node/document_type_node/) | ドキュメント タイプ node |
| const [ELEMENT_NODE](../../aspose.html.dom/node/element_node/) | 要素 node |
| const [ENTITY_NODE](../../aspose.html.dom/node/entity_node/) | エンティティ node |
| const [ENTITY_REFERENCE_NODE](../../aspose.html.dom/node/entity_reference_node/) | エンティティ参照 node |
| const [NOTATION_NODE](../../aspose.html.dom/node/notation_node/) | 表記 node |
| const [PROCESSING_INSTRUCTION_NODE](../../aspose.html.dom/node/processing_instruction_node/) | 処理命令 node |
| const [TEXT_NODE](../../aspose.html.dom/node/text_node/) | テキストノード |
