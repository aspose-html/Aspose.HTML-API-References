...
description: Aspose.Html.Dom.EntityReference クラス. EntityReference ノードを使用してツリー内のエンティティ参照を表すことができます
type: docs
weight: 710
url: /ja/net/aspose.html.dom/entityreference/
---
## EntityReference class

EntityReference ノードを使用して、ツリー内のエンティティ参照を表すことができます。
...
| override [NodeName](../../aspose.html.dom/entityreference/nodename/) { get; } | タイプに応じたこのノードの名前. |
| override [NodeType](../../aspose.html.dom/entityreference/nodetype/) { get; } | 基礎となるオブジェクトのタイプを表すコード. |
