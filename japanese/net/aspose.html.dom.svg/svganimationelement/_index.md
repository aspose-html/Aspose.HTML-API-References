...
description: Aspose.Html.Dom.Svg.SVGAnimationElement クラス. SVGAnimationElement インターフェイスはすべてのアニメーション要素インターフェイスの基本インターフェイスです SVGAnimateElementSVGSetElementSVGAnimateColorElementSVGAnimateMotionElementおよび SVGAnimateTransformElement.
type: docs
weight: 1940
url: /ja/net/aspose.html.dom.svg/svganimationelement/
---
## SVGAnimationElement class

SVGAnimationElement インターフェイスは、すべてのアニメーション要素インターフェイスの基本インターフェイスです: SVGAnimateElement、SVGSetElement、SVGAnimateColorElement、SVGAnimateMotionElement、および SVGAnimateTransformElement.
...
| [RequiredExtensions](../../aspose.html.dom.svg/svganimationelement/requiredextensions/) { get; } | 指定された要素の属性「requiredExtensions」に対応します。 |
| [RequiredFeatures](../../aspose.html.dom.svg/svganimationelement/requiredfeatures/) { get; } | 指定された要素の属性「requiredFeatures」に対応します。 |
...
| [SystemLanguage](../../aspose.html.dom.svg/svganimationelement/systemlanguage/) { get; } | 指定された要素の属性「systemLanguage」に対応します。 |
| [TagName](../../aspose.html.dom/element/tagname/) { get; } | 要素の名前。 |
| [TargetElement](../../aspose.html.dom.svg/svganimationelement/targetelement/) { get; } | アニメ化されている要素. |
