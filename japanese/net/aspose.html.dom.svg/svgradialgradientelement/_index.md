...
description: Aspose.Html.Dom.Svg.SVGRadialGradientElement クラス. SVGRadialGradientElement インターフェイスはradialGradient要素に対応します
type: docs
weight: 2230
url: /ja/net/aspose.html.dom.svg/svgradialgradientelement/
---
...
| [Cx](../../aspose.html.dom.svg/svgradialgradientelement/cx/) { get; } | 指定された「radialGradient」要素の属性「cx」に対応します。 |
| [Cy](../../aspose.html.dom.svg/svgradialgradientelement/cy/) { get; } | 指定された「radialGradient」要素の属性「cy」に対応します。 |
...
| [Fr](../../aspose.html.dom.svg/svgradialgradientelement/fr/) { get; } | 指定された「radialGradient」要素の属性「fr」に対応します。 |
| [Fx](../../aspose.html.dom.svg/svgradialgradientelement/fx/) { get; } | 指定された「radialGradient」要素の属性「fx」に対応します。 |
| [Fy](../../aspose.html.dom.svg/svgradialgradientelement/fy/) { get; } | 指定された「radialGradient」要素の属性「fy」に対応します。 |
| [GradientTransform](../../aspose.html.dom.svg/svggradientelement/gradienttransform/) { get; } | 指定された要素の属性「gradientTransform」に対応します。 |
| [GradientUnits](../../aspose.html.dom.svg/svggradientelement/gradientunits/) { get; } | 指定された要素の属性「gradientUnits」に対応します。 SVGUnitTypes. で定義された定数の 1 つを取ります |
| [Href](../../aspose.html.dom.svg/svggradientelement/href/) { get; } | 指定された要素の属性 'xlink:href' に対応します。 |
...
| [R](../../aspose.html.dom.svg/svgradialgradientelement/r/) { get; } | 指定された「radialGradient」要素の属性「r」に対応します。 |
...
| [SpreadMethod](../../aspose.html.dom.svg/svggradientelement/spreadmethod/) { get; } | 指定された要素の属性 'spreadMethod' に対応します。このインターフェイスで定義されている拡散方法タイプの 1 つ。 |
