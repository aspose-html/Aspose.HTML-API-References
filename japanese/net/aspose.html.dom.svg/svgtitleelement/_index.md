...
description: Aspose.Html.Dom.Svg.SVGTitleElement クラス. SVGTitleElement インターフェイスはタイトル要素に対応します
type: docs
weight: 2380
url: /ja/net/aspose.html.dom.svg/svgtitleelement/
---
## SVGTitleElement class

SVGTitleElement インターフェイスは「タイトル」要素に対応します。
