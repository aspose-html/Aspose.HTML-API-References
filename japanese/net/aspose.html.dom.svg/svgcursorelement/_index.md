...
description: Aspose.Html.Dom.Svg.SVGCursorElement クラス. SVGCursorElement インターフェイスはcursor要素に対応します
type: docs
weight: 1980
url: /ja/net/aspose.html.dom.svg/svgcursorelement/
---
...
| [Href](../../aspose.html.dom.svg/svgcursorelement/href/) { get; } | 指定された要素の属性 'xlink:href' に対応します。 |
...
| [RequiredExtensions](../../aspose.html.dom.svg/svgcursorelement/requiredextensions/) { get; } | 指定された要素の属性「requiredExtensions」に対応します。 |
| [RequiredFeatures](../../aspose.html.dom.svg/svgcursorelement/requiredfeatures/) { get; } | 指定された要素の属性「requiredFeatures」に対応します。 |
...
| [SystemLanguage](../../aspose.html.dom.svg/svgcursorelement/systemlanguage/) { get; } | 指定された要素の属性「systemLanguage」に対応します。 |
...
| [X](../../aspose.html.dom.svg/svgcursorelement/x/) { get; } | 指定された「カーソル」要素の属性「x」に対応します。 |
| [Y](../../aspose.html.dom.svg/svgcursorelement/y/) { get; } | 指定された「cursor」要素の属性「y」に対応します。 |
