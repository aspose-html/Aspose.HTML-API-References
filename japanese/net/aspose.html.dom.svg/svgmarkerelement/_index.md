...
description: Aspose.Html.Dom.Svg.SVGMarkerElement クラス. SVGMarkerElement インターフェイスはマーカー要素に対応します
type: docs
weight: 2160
url: /ja/net/aspose.html.dom.svg/svgmarkerelement/
---
## SVGMarkerElement class

SVGMarkerElement インターフェイスは「マーカー」要素に対応します。
...
| [MarkerHeight](../../aspose.html.dom.svg/svgmarkerelement/markerheight/) { get; } | 指定された「マーカー」要素の属性「markerHeight」に対応します。 |
| [MarkerUnits](../../aspose.html.dom.svg/svgmarkerelement/markerunits/) { get; } | 指定された「marker」要素の属性「markerUnits」に対応します。このインターフェイスで定義されているマーカー ユニット タイプの 1 つ。 |
| [MarkerWidth](../../aspose.html.dom.svg/svgmarkerelement/markerwidth/) { get; } | 指定された「マーカー」要素の属性「markerWidth」に対応します。 |
...
| [OrientAngle](../../aspose.html.dom.svg/svgmarkerelement/orientangle/) { get; } | 指定された「マーカー」要素の属性「方向」に対応します。 markerUnits が SVG_MARKER_ORIENT_ANGLE の場合、属性「orient」の角度値。それ以外の場合は、ゼロに設定されます. |
| [OrientType](../../aspose.html.dom.svg/svgmarkerelement/orienttype/) { get; } | 指定された「マーカー」要素の属性「方向」に対応します。このインターフェイスで定義されているマーカー方向タイプの 1 つ。 |
...
| [PreserveAspectRatio](../../aspose.html.dom.svg/svgmarkerelement/preserveaspectratio/) { get; } | 指定された要素の属性「preserveAspectRatio」に対応します。 |
...
| [RefX](../../aspose.html.dom.svg/svgmarkerelement/refx/) { get; } | 指定された「マーカー」要素の属性「refX」に対応します。 |
| [RefY](../../aspose.html.dom.svg/svgmarkerelement/refy/) { get; } | 指定された「マーカー」要素の属性「refY」に対応します。 |
...
| [ViewBox](../../aspose.html.dom.svg/svgmarkerelement/viewbox/) { get; } | 指定された要素の属性「viewBox」に対応します。 |
...
| [SetOrientToAngle](../../aspose.html.dom.svg/svgmarkerelement/setorienttoangle/)(SVGAngle) | 属性 'orient' の値を指定された角度に設定します. |
| [SetOrientToAuto](../../aspose.html.dom.svg/svgmarkerelement/setorienttoauto/)() | 属性「orient」の値を「auto」に設定します。 |
...
| 名前 | 説明 |
| --- | --- |
| const [SVG_MARKERUNITS_STROKEWIDTH](../../aspose.html.dom.svg/svgmarkerelement/svg_markerunits_strokewidth/) | 属性「markerUnits」の値は「strokeWidth」です。 |
| const [SVG_MARKERUNITS_UNKNOWN](../../aspose.html.dom.svg/svgmarkerelement/svg_markerunits_unknown/) | マーカー ユニットのタイプが事前定義されたタイプの 1 つではありません。この型の新しい値を定義しようとしたり、既存の値をこの型に切り替えようとしたりすることは無効です. |
| const [SVG_MARKERUNITS_USERSPACEONUSE](../../aspose.html.dom.svg/svgmarkerelement/svg_markerunits_userspaceonuse/) | 属性「markerUnits」の値は「userSpaceOnUse」です。 |
| const [SVG_MARKER_ORIENT_ANGLE](../../aspose.html.dom.svg/svgmarkerelement/svg_marker_orient_angle/) | 属性 'orient' には角度値があります. |
| const [SVG_MARKER_ORIENT_AUTO](../../aspose.html.dom.svg/svgmarkerelement/svg_marker_orient_auto/) | 属性「orient」の値は「auto」です。 |
| const [SVG_MARKER_ORIENT_UNKNOWN](../../aspose.html.dom.svg/svgmarkerelement/svg_marker_orient_unknown/) | マーカーの向きは事前定義されたタイプの 1 つではありません。この型の新しい値を定義しようとしたり、既存の値をこの型に切り替えようとしたりすることは無効です. |
