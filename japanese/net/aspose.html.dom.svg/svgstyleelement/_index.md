...
description: Aspose.Html.Dom.Svg.SVGStyleElement クラス. SVGStyleElement インターフェイスはスタイル要素に対応します
type: docs
weight: 2300
url: /ja/net/aspose.html.dom.svg/svgstyleelement/
---
## SVGStyleElement class

SVGStyleElement インターフェイスは「スタイル」要素に対応します。
...
| [Media](../../aspose.html.dom.svg/svgstyleelement/media/) { get; set; } | 指定された要素の属性「メディア」に対応します。 |
...
| [Sheet](../../aspose.html.dom.svg/svgstyleelement/sheet/) { get; } | 関連付けられたスタイル シートを取得します。 |
...
| [Title](../../aspose.html.dom.svg/svgstyleelement/title/) { get; set; } | 指定された要素の属性「タイトル」に対応します。 |
| [Type](../../aspose.html.dom.svg/svgstyleelement/type/) { get; set; } | 指定された要素の属性「タイプ」に対応します。 |
