...
description: Aspose.Html.Dom.Svg.SVGSymbolElement クラス. SVGSymbolElement インターフェイスはシンボル要素に対応します
type: docs
weight: 2320
url: /ja/net/aspose.html.dom.svg/svgsymbolelement/
---
## SVGSymbolElement class

SVGSymbolElement インターフェイスは「シンボル」要素に対応します。
...
| [PreserveAspectRatio](../../aspose.html.dom.svg/svgsymbolelement/preserveaspectratio/) { get; } | 指定された要素の属性「preserveAspectRatio」に対応します。 |
...
| [ViewBox](../../aspose.html.dom.svg/svgsymbolelement/viewbox/) { get; } | 指定された要素の属性「viewBox」に対応します。 |
