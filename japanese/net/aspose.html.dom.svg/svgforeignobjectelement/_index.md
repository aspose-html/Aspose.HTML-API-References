...
description: Aspose.Html.Dom.Svg.SVGForeignObjectElement クラス. SVGForeignObjectElement インターフェイスはforeignObject要素に対応します
type: docs
weight: 2070
url: /ja/net/aspose.html.dom.svg/svgforeignobjectelement/
---
...
| [Height](../../aspose.html.dom.svg/svgforeignobjectelement/height/) { get; } | 指定された「foreignObject」要素の属性「height」に対応します。 |
...
| [Width](../../aspose.html.dom.svg/svgforeignobjectelement/width/) { get; } | 指定された「foreignObject」要素の属性「幅」に対応します。 |
| [X](../../aspose.html.dom.svg/svgforeignobjectelement/x/) { get; } | 指定された「foreignObject」要素の属性「x」に対応します。 |
| [Y](../../aspose.html.dom.svg/svgforeignobjectelement/y/) { get; } | 指定された「foreignObject」要素の属性「y」に対応します。 |
