...
description: Aspose.Html.Dom.Svg.SVGComponentTransferFunctionElement クラス. このインターフェイスはコンポーネント伝達関数インターフェイスで使用される基本インターフェイスを定義します
type: docs
weight: 1970
url: /ja/net/aspose.html.dom.svg/svgcomponenttransferfunctionelement/
---
## SVGComponentTransferFunctionElement class

このインターフェイスは、コンポーネント伝達関数インターフェイスで使用される基本インターフェイスを定義します。
...
| 名前 | 説明 |
| --- | --- |
| [Amplitude](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/amplitude/) { get; } | 指定された要素の属性「振幅」に対応します。 |
...
| [Exponent](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/exponent/) { get; } | 指定された要素の属性「指数」に対応します。 |
...
| [Intercept](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/intercept/) { get; } | 指定された要素の属性「インターセプト」に対応します。 |
...
| [Offset](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/offset/) { get; } | 指定された要素の属性「オフセット」に対応します。 |
...
| [Slope](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/slope/) { get; } | 指定された要素の属性「勾配」に対応します。 |
...
| [TableValues](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/tablevalues/) { get; } | 指定された要素の属性「tableValues」に対応します。 |
...
| [Type](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/type/) { get; } | 指定された要素の属性 'type' に対応します。このインターフェイスで定義された SVG_FECOMPONENTTRANSFER_TYPE_* 定数の 1 つを取ります。 |
...
| 名前 | 説明 |
| --- | --- |
| const [SVG_FECOMPONENTTRANSFER_TYPE_DISCRETE](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_discrete/) | 値「discrete」に対応します。 |
| const [SVG_FECOMPONENTTRANSFER_TYPE_GAMMA](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_gamma/) | 値「ガンマ」に対応します。 |
| const [SVG_FECOMPONENTTRANSFER_TYPE_IDENTITY](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_identity/) | 値「identity」に対応します。 |
| const [SVG_FECOMPONENTTRANSFER_TYPE_LINEAR](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_linear/) | 値「linear」に対応します。 |
| const [SVG_FECOMPONENTTRANSFER_TYPE_TABLE](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_table/) | 値「テーブル」に対応します。 |
| const [SVG_FECOMPONENTTRANSFER_TYPE_UNKNOWN](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_unknown/) | タイプは定義済みのタイプではありません。この型の新しい値を定義しようとしたり、既存の値をこの型に切り替えようとしたりすることは無効です. |
