...
description: Aspose.Html.Dom.Svg.SVGGraphicsElement クラス. SVGGraphicsElement インターフェイスはグラフィックスをグループに直接レンダリングすることを主な目的とする SVG 要素を表します
type: docs
weight: 2110
url: /ja/net/aspose.html.dom.svg/svggraphicselement/
---
## SVGGraphicsElement class

SVGGraphicsElement インターフェイスは、グラフィックスをグループに直接レンダリングすることを主な目的とする SVG 要素を表します。
