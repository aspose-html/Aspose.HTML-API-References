...
description: Aspose.Html.Dom.Svg.SVGMaskElement クラス. SVGMaskElement インターフェイスはマスク要素に対応します
type: docs
weight: 2170
url: /ja/net/aspose.html.dom.svg/svgmaskelement/
---
## SVGMaskElement class

SVGMaskElement インターフェイスは「マスク」要素に対応します。
...
| [Height](../../aspose.html.dom.svg/svgmaskelement/height/) { get; } | 指定された「マスク」要素の属性「高さ」に対応します。 SVGUnitTypes. で定義された定数の 1 つを取ります |
...
| [MaskContentUnits](../../aspose.html.dom.svg/svgmaskelement/maskcontentunits/) { get; } | 指定された「マスク」要素の属性「maskContentUnits」に対応します。 SVGUnitTypes. で定義された定数の 1 つを取ります |
| [MaskUnits](../../aspose.html.dom.svg/svgmaskelement/maskunits/) { get; } | 指定された「マスク」要素の属性「maskUnits」に対応します。 SVGUnitTypes. で定義された定数の 1 つを取ります |
...
| [RequiredExtensions](../../aspose.html.dom.svg/svgmaskelement/requiredextensions/) { get; } | 指定された要素の属性「requiredExtensions」に対応します。 |
| [RequiredFeatures](../../aspose.html.dom.svg/svgmaskelement/requiredfeatures/) { get; } | 指定された要素の属性「requiredFeatures」に対応します。 |
...
| [SystemLanguage](../../aspose.html.dom.svg/svgmaskelement/systemlanguage/) { get; } | 指定された要素の属性「systemLanguage」に対応します。 |
...
| [Width](../../aspose.html.dom.svg/svgmaskelement/width/) { get; } | 指定された「マスク」要素の属性「幅」に対応します。 SVGUnitTypes. で定義された定数の 1 つを取ります |
| [X](../../aspose.html.dom.svg/svgmaskelement/x/) { get; } | 指定された「マスク」要素の属性「x」に対応します。 SVGUnitTypes. で定義された定数の 1 つを取ります |
| [Y](../../aspose.html.dom.svg/svgmaskelement/y/) { get; } | 指定された「マスク」要素の属性「y」に対応します。 SVGUnitTypes. で定義された定数の 1 つを取ります |
