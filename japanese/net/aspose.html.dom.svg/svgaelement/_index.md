...
description: Aspose.Html.Dom.Svg.SVGAElement クラス. SVGAElement インターフェイスはa要素に対応します
type: docs
weight: 1900
url: /ja/net/aspose.html.dom.svg/svgaelement/
---
## SVGAElement class
...
| [Href](../../aspose.html.dom.svg/svgaelement/href/) { get; } | 指定された要素の属性 'xlink:href' に対応します。 |
...
| [Target](../../aspose.html.dom.svg/svgaelement/target/) { get; } | 指定された 'a' 要素の属性 'target' に対応します。 |
