...
description: Aspose.Html.Dom.Svg.SVGElement クラス. SVG 言語の要素に直接対応するすべての SVG DOM インターフェイス パス要素の SVGPathElement インターフェイスなど はSVGElement インターフェイスから派生します
type: docs
weight: 2020
url: /ja/net/aspose.html.dom.svg/svgelement/
---
## SVGElement class

SVG 言語の要素に直接対応するすべての SVG DOM インターフェイス (「パス」要素の SVGPathElement インターフェイスなど) は、SVGElement インターフェイスから派生します。
