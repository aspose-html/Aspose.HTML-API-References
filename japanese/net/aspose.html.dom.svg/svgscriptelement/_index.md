...
description: Aspose.Html.Dom.Svg.SVGScriptElement クラス. SVGScriptElement インターフェイスはscript要素に対応します
type: docs
weight: 2270
url: /ja/net/aspose.html.dom.svg/svgscriptelement/
---
...
| [CrossOrigin](../../aspose.html.dom.svg/svgscriptelement/crossorigin/) { get; set; } | 指定された「script」要素の属性「crossorigin」に対応します。 |
...
| [Href](../../aspose.html.dom.svg/svgscriptelement/href/) { get; } | 指定された要素の属性 'xlink:href' に対応します。 |
...
| [Type](../../aspose.html.dom.svg/svgscriptelement/type/) { get; set; } | 指定された「スクリプト」要素の属性「タイプ」に対応します。 |
