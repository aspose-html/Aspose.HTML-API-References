...
description: Aspose.Html.Dom.Svg.SVGStopElement クラス. SVGStopElement インターフェイスは停止要素に対応します
type: docs
weight: 2290
url: /ja/net/aspose.html.dom.svg/svgstopelement/
---
## SVGStopElement class

SVGStopElement インターフェイスは「停止」要素に対応します。
...
| [Offset](../../aspose.html.dom.svg/svgstopelement/offset/) { get; } | 指定された「radialGradient」要素の属性「オフセット」に対応します。 |
