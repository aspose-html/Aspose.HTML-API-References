...
description: Aspose.Html.Dom.Svg.SVGCircleElement クラス. SVGCircleElement インターフェイスはcircle要素に対応します
type: docs
weight: 1950
url: /ja/net/aspose.html.dom.svg/svgcircleelement/
---
...
| [Cx](../../aspose.html.dom.svg/svgcircleelement/cx/) { get; } | 指定された「circle」要素の属性「cx」に対応します。 |
| [Cy](../../aspose.html.dom.svg/svgcircleelement/cy/) { get; } | 指定された「circle」要素の属性「cy」に対応します。 |
...
| [R](../../aspose.html.dom.svg/svgcircleelement/r/) { get; } | 指定された「円」要素の属性「r」に対応します。 |
