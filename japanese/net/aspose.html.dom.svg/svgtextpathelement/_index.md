...
description: Aspose.Html.Dom.Svg.SVGTextPathElement クラス. SVGTextPathElement インターフェイスはtextPath要素に対応します
type: docs
weight: 2360
url: /ja/net/aspose.html.dom.svg/svgtextpathelement/
---
...
| [Href](../../aspose.html.dom.svg/svgtextpathelement/href/) { get; } | 指定された要素の属性 'xlink:href' に対応します。 |
...
| [LengthAdjust](../../aspose.html.dom.svg/svgtextcontentelement/lengthadjust/) { get; } | 指定された要素の属性「lengthAdjust」に対応します。値は、このインターフェイスで定義された長さ調整定数のいずれかでなければなりません. |
...
| [Method](../../aspose.html.dom.svg/svgtextpathelement/method/) { get; } | 指定された「textPath」要素の属性「method」に対応します。 |
...
| [Spacing](../../aspose.html.dom.svg/svgtextpathelement/spacing/) { get; } | 指定された 'textPath' 要素の属性 'spacing' に対応します。 |
| [StartOffset](../../aspose.html.dom.svg/svgtextpathelement/startoffset/) { get; } | 指定された「textPath」要素の属性「startOffset」に対応します。 |
...
| [TextLength](../../aspose.html.dom.svg/svgtextcontentelement/textlength/) { get; } | 指定された要素の属性「textLength」に対応します。 |
...
| [GetComputedTextLength](../../aspose.html.dom.svg/svgtextcontentelement/getcomputedtextlength/)() | この要素内のすべての文字をレンダリングすることによるすべてのアドバンス値の合計。これにはグリフ (水平または垂直) のアドバンス値、プロパティ「kerning」、「letter-spacing」、および「word-」の効果が含まれます。 'tspan' 要素の属性 'dx' および 'dy' による調整。非レンダリング環境の場合、ユーザー エージェントは、グリフ メトリックについて合理的な仮定を行うものとします。 |
...
| [GetNumberOfChars](../../aspose.html.dom.svg/svgtextcontentelement/getnumberofchars/)() | 現在の要素内でレンダリングできる文字の総数を返します。これには、レンダリングされるかどうかに関係なく、「tref」参照から参照される文字が含まれます。事実上、これは DOM レベル 3 コア ([DOM3]、セクション 1.4) の Node::textContent 属性の長さと同じです (その属性が 'tref' 要素も展開されている場合)。 |
...
| 名前 | 説明 |
| --- | --- |
| const [TEXTPATH_METHODTYPE_ALIGN](../../aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_align/) | 値「align」に対応します。 |
| const [TEXTPATH_METHODTYPE_STRETCH](../../aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_stretch/) | 値「ストレッチ」に対応します。 |
| const [TEXTPATH_METHODTYPE_UNKNOWN](../../aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_unknown/) | 列挙型が事前定義されたタイプではない値に設定されました。この型の新しい値を定義しようとしたり、既存の値をこの型に切り替えようとしたりすることは無効です. |
| const [TEXTPATH_SPACINGTYPE_AUTO](../../aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_auto/) | 値「auto」に対応します。 |
| const [TEXTPATH_SPACINGTYPE_EXACT](../../aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_exact/) | 値「exact」に対応します。 |
| const [TEXTPATH_SPACINGTYPE_UNKNOWN](../../aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_unknown/) | 列挙型が事前定義されたタイプではない値に設定されました。この型の新しい値を定義しようとしたり、既存の値をこの型に切り替えようとしたりすることは無効です. |
