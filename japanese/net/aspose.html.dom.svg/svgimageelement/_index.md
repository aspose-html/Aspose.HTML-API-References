...
description: Aspose.Html.Dom.Svg.SVGImageElement クラス. SVGImageElement インターフェイスはimage要素に対応します
type: docs
weight: 2120
url: /ja/net/aspose.html.dom.svg/svgimageelement/
---
...
| [Height](../../aspose.html.dom.svg/svgimageelement/height/) { get; } | 指定された「イメージ」要素の属性「高さ」に対応します。 |
| [Href](../../aspose.html.dom.svg/svgimageelement/href/) { get; } | 指定された要素の属性 'xlink:href' に対応します。 |
...
| [PreserveAspectRatio](../../aspose.html.dom.svg/svgimageelement/preserveaspectratio/) { get; } | 指定された「イメージ」要素の属性「preserveAspectRatio」に対応します。 |
...
| [Width](../../aspose.html.dom.svg/svgimageelement/width/) { get; } | 指定された「イメージ」要素の属性「幅」に対応します。 |
| [X](../../aspose.html.dom.svg/svgimageelement/x/) { get; } | 指定された「画像」要素の属性「x」に対応します。 |
| [Y](../../aspose.html.dom.svg/svgimageelement/y/) { get; } | 指定された「イメージ」要素の属性「y」に対応します。 |
