...
description: Aspose.Html.Dom.Svg.SVGPatternElement クラス. SVGPatternElement インターフェイスはpattern要素に対応します
type: docs
weight: 2200
url: /ja/net/aspose.html.dom.svg/svgpatternelement/
---
...
| [Height](../../aspose.html.dom.svg/svgpatternelement/height/) { get; } | 指定された「パターン」要素の属性「高さ」に対応します。 |
| [Href](../../aspose.html.dom.svg/svgpatternelement/href/) { get; } | 指定された要素の属性 'xlink:href' に対応します。 |
...
| [PatternContentUnits](../../aspose.html.dom.svg/svgpatternelement/patterncontentunits/) { get; } | 指定された「pattern」要素の属性「patternContentUnits」に対応します。 SVGUnitTypes. で定義された定数の 1 つを取ります |
| [PatternTransform](../../aspose.html.dom.svg/svgpatternelement/patterntransform/) { get; } | 指定された「パターン」要素の属性「patternTransform」に対応します。 |
| [PatternUnits](../../aspose.html.dom.svg/svgpatternelement/patternunits/) { get; } | 指定された「pattern」要素の属性「patternUnits」に対応します。 SVGUnitTypes. で定義された定数の 1 つを取ります |
| override [Prefix](../../aspose.html.dom/element/prefix/) { get; } | このノードの名前空間プレフィックス、または指定されていない場合は null。 null と定義されている場合、設定しても効果はありません |
| [PreserveAspectRatio](../../aspose.html.dom.svg/svgpatternelement/preserveaspectratio/) { get; } | 指定された要素の属性「preserveAspectRatio」に対応します。 |
...
| [RequiredExtensions](../../aspose.html.dom.svg/svgpatternelement/requiredextensions/) { get; } | 指定された要素の属性「requiredExtensions」に対応します。 |
| [RequiredFeatures](../../aspose.html.dom.svg/svgpatternelement/requiredfeatures/) { get; } | 指定された要素の属性「requiredFeatures」に対応します。 |
...
| [SystemLanguage](../../aspose.html.dom.svg/svgpatternelement/systemlanguage/) { get; } | 指定された要素の属性「systemLanguage」に対応します。 |
...
| [ViewBox](../../aspose.html.dom.svg/svgpatternelement/viewbox/) { get; } | 指定された要素の属性「viewBox」に対応します。 |
...
| [Width](../../aspose.html.dom.svg/svgpatternelement/width/) { get; } | 指定された「パターン」要素の属性「幅」に対応します。 |
| [X](../../aspose.html.dom.svg/svgpatternelement/x/) { get; } | 指定された「パターン」要素の属性「x」に対応します。 |
| [Y](../../aspose.html.dom.svg/svgpatternelement/y/) { get; } | 指定された「パターン」要素の属性「y」に対応します。 |
