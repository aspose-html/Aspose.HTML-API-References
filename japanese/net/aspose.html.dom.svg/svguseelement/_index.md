...
description: Aspose.Html.Dom.Svg.SVGUseElement クラス. SVGUseElement インターフェイスはuse要素に対応します
type: docs
weight: 2400
url: /ja/net/aspose.html.dom.svg/svguseelement/
---
## SVGUseElement class
...
| [Height](../../aspose.html.dom.svg/svguseelement/height/) { get; } | 指定された「use」要素の属性「height」に対応します。 |
| [Href](../../aspose.html.dom.svg/svguseelement/href/) { get; } | 指定された要素の属性 'xlink:href' に対応します。 |
...
| [Width](../../aspose.html.dom.svg/svguseelement/width/) { get; } | 指定された「use」要素の属性「width」に対応します。 |
| [X](../../aspose.html.dom.svg/svguseelement/x/) { get; } | 指定された「use」要素の属性「x」に対応します。 |
| [Y](../../aspose.html.dom.svg/svguseelement/y/) { get; } | 指定された「use」要素の属性「y」に対応します。 |
