...
description: Aspose.Html.Dom.Svg.SVGRectElement クラス. SVGRectElement インターフェイスはrect要素に対応します
type: docs
weight: 2240
url: /ja/net/aspose.html.dom.svg/svgrectelement/
---
...
| [Height](../../aspose.html.dom.svg/svgrectelement/height/) { get; } | 指定された 'rect' 要素の属性 'height' に対応します。 |
...
| [Rx](../../aspose.html.dom.svg/svgrectelement/rx/) { get; } | 指定された「rect」要素の属性「rx」に対応します。 |
| [Ry](../../aspose.html.dom.svg/svgrectelement/ry/) { get; } | 指定された「rect」要素の属性「ry」に対応します。 |
...
| [Width](../../aspose.html.dom.svg/svgrectelement/width/) { get; } | 指定された 'rect' 要素の属性 'width' に対応します。 |
| [X](../../aspose.html.dom.svg/svgrectelement/x/) { get; } | 指定された「rect」要素の属性「x」に対応します。 |
| [Y](../../aspose.html.dom.svg/svgrectelement/y/) { get; } | 指定された「rect」要素の属性「y」に対応します。 |
