...
description: Aspose.Html.Dom.Svg.SVGTextPositioningElement クラス. SVGTextPositioningElement インターフェイスはテキスト関連のインターフェイス SVGTextElementSVGTSpanElementSVGTRefElementおよび SVGAltGlyphElement によって継承されます
type: docs
weight: 2370
url: /ja/net/aspose.html.dom.svg/svgtextpositioningelement/
---
## SVGTextPositioningElement class

SVGTextPositioningElement インターフェイスは、テキスト関連のインターフェイス (SVGTextElement、SVGTSpanElement、SVGTRefElement、および SVGAltGlyphElement) によって継承されます。
...
| [Dx](../../aspose.html.dom.svg/svgtextpositioningelement/dx/) { get; } | 指定された要素の属性 'dx' に対応します。 |
| [Dy](../../aspose.html.dom.svg/svgtextpositioningelement/dy/) { get; } | 指定された要素の属性「dy」に対応します。 |
...
| [Rotate](../../aspose.html.dom.svg/svgtextpositioningelement/rotate/) { get; } | 指定された要素の属性「回転」に対応します。 |
...
| [X](../../aspose.html.dom.svg/svgtextpositioningelement/x/) { get; } | 指定された要素の属性 'x' に対応します。 |
| [Y](../../aspose.html.dom.svg/svgtextpositioningelement/y/) { get; } | 指定された要素の属性 'y' に対応します。 |
