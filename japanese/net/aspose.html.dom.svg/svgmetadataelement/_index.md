...
description: Aspose.Html.Dom.Svg.SVGMetadataElement クラス. SVGMetadataElement インターフェイスはメタデータ要素に対応します
type: docs
weight: 2180
url: /ja/net/aspose.html.dom.svg/svgmetadataelement/
---
## SVGMetadataElement class

SVGMetadataElement インターフェイスは「メタデータ」要素に対応します。
