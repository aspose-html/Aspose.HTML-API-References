...
description: Aspose.Html.Dom.Svg.SVGEllipseElement クラス. SVGEllipseElement インターフェイスは楕円要素に対応します
type: docs
weight: 2040
url: /ja/net/aspose.html.dom.svg/svgellipseelement/
---
## SVGEllipseElement class

SVGEllipseElement インターフェイスは「楕円」要素に対応します。
...
| [Cx](../../aspose.html.dom.svg/svgellipseelement/cx/) { get; } | 指定された「circle」要素の属性「cx」に対応します。 |
| [Cy](../../aspose.html.dom.svg/svgellipseelement/cy/) { get; } | 指定された「circle」要素の属性「cy」に対応します。 |
...
| [Rx](../../aspose.html.dom.svg/svgellipseelement/rx/) { get; } | 指定された「circle」要素の属性「cx」に対応します。 |
| [Ry](../../aspose.html.dom.svg/svgellipseelement/ry/) { get; } | 指定された「circle」要素の属性「ry」に対応します。 |
