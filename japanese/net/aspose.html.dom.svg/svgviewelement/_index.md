...
description: Aspose.Html.Dom.Svg.SVGViewElement クラス. SVGViewElement インターフェイスはview要素に対応します
type: docs
weight: 2410
url: /ja/net/aspose.html.dom.svg/svgviewelement/
---
...
| [PreserveAspectRatio](../../aspose.html.dom.svg/svgviewelement/preserveaspectratio/) { get; } | 指定された要素の属性「preserveAspectRatio」に対応します。 |
...
| [ViewBox](../../aspose.html.dom.svg/svgviewelement/viewbox/) { get; } | 指定された要素の属性「viewBox」に対応します。 |
...
| [ViewTarget](../../aspose.html.dom.svg/svgviewelement/viewtarget/) { get; } | 指定された「view」要素の属性「viewTarget」に対応します。 「viewTarget」属性にリストされた名前を含む DOMString 値のリスト。 getElementById() メソッド call. を使用して、各 DOMString 値を対応する要素に関連付けることができます。 |
| [ZoomAndPan](../../aspose.html.dom.svg/svgviewelement/zoomandpan/) { get; set; } | 指定された要素の属性「zoomAndPan」に対応します。値は、このインターフェイスで定義された SVG_ZOOMANDPAN_* 定数のいずれかでなければなりません. |
