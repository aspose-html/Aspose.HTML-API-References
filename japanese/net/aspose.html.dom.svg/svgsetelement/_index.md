...
description: Aspose.Html.Dom.Svg.SVGSetElement クラス. SVGSetElement インターフェイスはset要素に対応します SVG DOM を介したset要素の属性へのオブジェクト指向アクセスは利用できません
type: docs
weight: 2280
url: /ja/net/aspose.html.dom.svg/svgsetelement/
---
## SVGSetElement class
