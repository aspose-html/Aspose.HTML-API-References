...
description: Aspose.Html.Dom.Svg.SVGFilterElement クラス. SVGFilterElement インターフェイスはfilter要素に対応します
type: docs
weight: 2060
url: /ja/net/aspose.html.dom.svg/svgfilterelement/
---
...
| [FilterUnits](../../aspose.html.dom.svg/svgfilterelement/filterunits/) { get; } | 指定された「filter」要素の属性「filterUnits」に対応します。 SVGUnitTypes. で定義された定数の 1 つを取ります |
...
| [Height](../../aspose.html.dom.svg/svgfilterelement/height/) { get; } | 指定された「フィルター」要素の属性「高さ」に対応します。 |
| [Href](../../aspose.html.dom.svg/svgfilterelement/href/) { get; } | 指定された要素の属性 'xlink:href' に対応します。 |
...
| [PrimitiveUnits](../../aspose.html.dom.svg/svgfilterelement/primitiveunits/) { get; } | 指定された「filter」要素の属性「primitiveUnits」に対応します。 SVGUnitTypes. で定義された定数の 1 つを取ります |
...
| [Width](../../aspose.html.dom.svg/svgfilterelement/width/) { get; } | 指定された「フィルター」要素の属性「幅」に対応します。 |
| [X](../../aspose.html.dom.svg/svgfilterelement/x/) { get; } | 指定された「フィルター」要素の属性「x」に対応します。 |
| [Y](../../aspose.html.dom.svg/svgfilterelement/y/) { get; } | 指定された「フィルター」要素の属性「y」に対応します。 |
