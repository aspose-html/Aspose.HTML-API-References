...
description: Aspose.Html.Toolkit.Markdown.Syntax.EmphasisSyntaxNode クラス. EmphasisSyntaxNode を表します
type: docs
weight: 4870
url: /ja/net/aspose.html.toolkit.markdown.syntax/emphasissyntaxnode/
---
...
| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/emphasissyntaxnode/accept/)(MarkdownSyntaxVisitor) | 訪問者を受け入れるためのインターフェイスを定義します. |
...
| [GetEmphasisType](../../aspose.html.toolkit.markdown.syntax/emphasissyntaxnode/getemphasistype/)() | get Emphasis Type のインターフェイスを定義します |
