...
description: Aspose.Html.Toolkit.Markdown.Syntax.UnorderedListSyntaxNode クラス. 順序なしリスト構文ノードを表します
type: docs
weight: 5730
url: /ja/net/aspose.html.toolkit.markdown.syntax/unorderedlistsyntaxnode/
---
...
| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/unorderedlistsyntaxnode/accept/)(MarkdownSyntaxVisitor) | 構文のノードを訪問するためのインターフェイスを定義します. |
...
| [GetMarker](../../aspose.html.toolkit.markdown.syntax/unorderedlistsyntaxnode/getmarker/)() | マーカーを取得するためのインターフェイスを定義します。 |
