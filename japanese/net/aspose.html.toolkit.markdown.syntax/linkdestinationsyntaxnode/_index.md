...
description: Aspose.Html.Toolkit.Markdown.Syntax.LinkDestinationSyntaxNode クラス. LinkDestinationSyntaxNode を表します
type: docs
weight: 5110
url: /ja/net/aspose.html.toolkit.markdown.syntax/linkdestinationsyntaxnode/
---
...
| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/linkdestinationsyntaxnode/accept/)(MarkdownSyntaxVisitor) | 訪問者を受け入れるためのインターフェイスを定義します. |
...
| [GetValue](../../aspose.html.toolkit.markdown.syntax/linkdestinationsyntaxnode/getvalue/)() | 文字列値を取得するためのインターフェイスを定義します。 |
