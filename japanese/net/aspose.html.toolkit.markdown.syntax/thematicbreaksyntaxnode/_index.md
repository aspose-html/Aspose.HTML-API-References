...
description: Aspose.Html.Toolkit.Markdown.Syntax.ThematicBreakSyntaxNode クラス. テーマ分割構文ノードを実装しました
type: docs
weight: 5680
url: /ja/net/aspose.html.toolkit.markdown.syntax/thematicbreaksyntaxnode/
---
...
| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/thematicbreaksyntaxnode/accept/)(MarkdownSyntaxVisitor) | 訪問者を受け入れるためのインターフェイスを定義します。 |
