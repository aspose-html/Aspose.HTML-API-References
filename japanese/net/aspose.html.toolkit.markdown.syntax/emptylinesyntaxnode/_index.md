...
description: Aspose.Html.Toolkit.Markdown.Syntax.EmptyLineSyntaxNode クラス. EmptyLineSyntaxNode を表します
type: docs
weight: 4880
url: /ja/net/aspose.html.toolkit.markdown.syntax/emptylinesyntaxnode/
---
...
| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/emptylinesyntaxnode/accept/)(MarkdownSyntaxVisitor) | 訪問者を受け入れるためのインターフェイスを定義します. |
