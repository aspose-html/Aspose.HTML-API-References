...
description: Aspose.Html.Toolkit.Markdown.Syntax.TableSyntaxNode クラス. TableSyntax クラス ノード
type: docs
weight: 5590
url: /ja/net/aspose.html.toolkit.markdown.syntax/tablesyntaxnode/
---
...
| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/tablesyntaxnode/accept/)(MarkdownSyntaxVisitor) | 訪問者を受け入れるためのインターフェイスを定義します. |
| [AppendChild](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/appendchild/)(MarkdownSyntaxNode) | 子ノードを追加します。 |
| [AppendRow](../../aspose.html.toolkit.markdown.syntax/tablesyntaxnode/appendrow/)(TableRowSyntaxNode) | 追加行のインターフェイスを定義します。 |
| [ChildNodes](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/childnodes/)() | 子ノード コレクションを取得します。 |
| [GetAlignment](../../aspose.html.toolkit.markdown.syntax/tablesyntaxnode/getalignment/)() | get アライメントのインターフェイスを定義します。 |
| [GetBodyRows](../../aspose.html.toolkit.markdown.syntax/tablesyntaxnode/getbodyrows/)() | 本体行を取得するためのインターフェイスを定義します。 |
| [GetHeader](../../aspose.html.toolkit.markdown.syntax/tablesyntaxnode/getheader/)() | テーブル ヘッダーを取得するためのインターフェイスを定義します。 |
