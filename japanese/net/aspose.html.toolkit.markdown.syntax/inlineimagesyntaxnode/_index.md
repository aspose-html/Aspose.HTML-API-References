...
description: Aspose.Html.Toolkit.Markdown.Syntax.InlineImageSyntaxNode クラス. InlineImageSyntaxNode を表します
type: docs
weight: 5050
url: /ja/net/aspose.html.toolkit.markdown.syntax/inlineimagesyntaxnode/
---
...
| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/inlineimagesyntaxnode/accept/)(MarkdownSyntaxVisitor) | 訪問者を受け入れるためのインターフェイスを定義します. |
...
| [GetAltText](../../aspose.html.toolkit.markdown.syntax/inlineimagesyntaxnode/getalttext/)() | すべてのテキストを取得するためのインターフェイスを定義します。 |
| [GetDestination](../../aspose.html.toolkit.markdown.syntax/inlineimagesyntaxnode/getdestination/)() | get 宛先のインターフェイスを定義します。 |
...
| [GetTitle](../../aspose.html.toolkit.markdown.syntax/inlineimagesyntaxnode/gettitle/)() | タイトルを取得するためのインターフェイスを定義します。 |
