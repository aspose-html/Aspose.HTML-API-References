...
description: Aspose.Html.Toolkit.Markdown.Syntax.TaskListItemSyntaxNode クラス. タスクリスト項目の構文ノード.
type: docs
weight: 5610
url: /ja/net/aspose.html.toolkit.markdown.syntax/tasklistitemsyntaxnode/
---
...
| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/listitemsyntaxnode/accept/)(MarkdownSyntaxVisitor) | 訪問者を受け入れるためのインターフェイスを定義します. |
...
| [GetLinesLeadingTrivia](../../aspose.html.toolkit.markdown.syntax/multilinecontainerblocksyntaxnode/getlinesleadingtrivia/)() | トリビアの先頭行を取得するためのインターフェイスを定義します。 |
| [GetMarker](../../aspose.html.toolkit.markdown.syntax/listitemsyntaxnode/getmarker/)() | マーカーを取得 |
...
| [IsChecked](../../aspose.html.toolkit.markdown.syntax/tasklistitemsyntaxnode/ischecked/)() | チェックされたステータスを取得するためのインターフェイスを定義します. |
| [IsTight](../../aspose.html.toolkit.markdown.syntax/listitemsyntaxnode/istight/)() | タイトな場合は true を取得します。 |
