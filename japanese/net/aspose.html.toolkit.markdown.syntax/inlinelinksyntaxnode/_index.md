...
description: Aspose.Html.Toolkit.Markdown.Syntax.InlineLinkSyntaxNode クラス. InlineLinkSyntaxNode を表します
type: docs
weight: 5060
url: /ja/net/aspose.html.toolkit.markdown.syntax/inlinelinksyntaxnode/
---
...
| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/inlinelinksyntaxnode/accept/)(MarkdownSyntaxVisitor) | 訪問者を受け入れるためのインターフェイスを定義します. |
...
| [GetDestination](../../aspose.html.toolkit.markdown.syntax/inlinelinksyntaxnode/getdestination/)() | get 宛先のインターフェイスを定義します。 |
...
| [GetTitle](../../aspose.html.toolkit.markdown.syntax/inlinelinksyntaxnode/gettitle/)() | タイトルを取得するためのインターフェイスを定義します。 |
