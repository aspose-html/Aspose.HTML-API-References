...
description: Aspose.Html.Toolkit.Markdown.Syntax.CodeSpanSyntaxNode クラス. CodeSpanSyntaxNode を表します
type: docs
weight: 4840
url: /ja/net/aspose.html.toolkit.markdown.syntax/codespansyntaxnode/
---
...
| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/codespansyntaxnode/accept/)(MarkdownSyntaxVisitor) | 訪問者を受け入れるためのインターフェイスを定義します. |
...
| [GetContent](../../aspose.html.toolkit.markdown.syntax/codespansyntaxnode/getcontent/)() | get Content. のインターフェイスを定義します。 |
