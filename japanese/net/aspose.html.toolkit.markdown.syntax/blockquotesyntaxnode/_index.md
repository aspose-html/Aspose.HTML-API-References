...
description: Aspose.Html.Toolkit.Markdown.Syntax.BlockQuoteSyntaxNode クラス. BlockQuoteSyntaxNode を表します
type: docs
weight: 4810
url: /ja/net/aspose.html.toolkit.markdown.syntax/blockquotesyntaxnode/
---
...
| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/blockquotesyntaxnode/accept/)(MarkdownSyntaxVisitor) | 訪問者を受け入れるためのインターフェイスを定義します. |
