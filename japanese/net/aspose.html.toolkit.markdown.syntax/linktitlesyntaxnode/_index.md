...
description: Aspose.Html.Toolkit.Markdown.Syntax.LinkTitleSyntaxNode クラス. LinkTitleSyntaxNode を表します
type: docs
weight: 5130
url: /ja/net/aspose.html.toolkit.markdown.syntax/linktitlesyntaxnode/
---
...
| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/linktitlesyntaxnode/accept/)(MarkdownSyntaxVisitor) | 訪問者を受け入れるためのインターフェイスを定義します. |
...
| [GetValue](../../aspose.html.toolkit.markdown.syntax/linktitlesyntaxnode/getvalue/)() | 文字列値を取得するためのインターフェイスを定義します。 |
