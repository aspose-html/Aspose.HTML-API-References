...
description: Aspose.Html.Toolkit.Markdown.Syntax.HTMLFragmentSyntax クラス. HTMLFragmentSyntax を表します
type: docs
weight: 5000
url: /ja/net/aspose.html.toolkit.markdown.syntax/htmlfragmentsyntax/
---
...
| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/htmlfragmentsyntax/accept/)(MarkdownSyntaxVisitor) | 訪問者を受け入れるためのインターフェイスを定義します. |
...
| [GetContent](../../aspose.html.toolkit.markdown.syntax/htmlfragmentsyntax/getcontent/)() | get Content. のインターフェイスを定義します。 |
...
| [SetContent](../../aspose.html.toolkit.markdown.syntax/htmlfragmentsyntax/setcontent/)(string) | セット内容のインターフェースを定義します。 |
