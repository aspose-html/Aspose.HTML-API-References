...
description: Aspose.Html.Toolkit.Markdown.Syntax.ReferenceLinkSyntaxNode クラス. 参照リンクの構文を表します
type: docs
weight: 5520
url: /ja/net/aspose.html.toolkit.markdown.syntax/referencelinksyntaxnode/
---
...
| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/referencelinksyntaxnode/accept/)(MarkdownSyntaxVisitor) | 訪問者を受け入れるためのインターフェイスを定義します. |
...
| [GetContent](../../aspose.html.toolkit.markdown.syntax/referencelinksyntaxnode/getcontent/)() | コンテンツを取得するためのインターフェイスを定義します。 |
| [GetLabel](../../aspose.html.toolkit.markdown.syntax/referencelinksyntaxnode/getlabel/)() | get label のインターフェイスを定義します。 |
