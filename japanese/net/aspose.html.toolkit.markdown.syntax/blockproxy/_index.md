...
description: Aspose.Html.Toolkit.Markdown.Syntax.BlockProxy クラス. BlockProxy を表します
type: docs
weight: 4800
url: /ja/net/aspose.html.toolkit.markdown.syntax/blockproxy/
---
## BlockProxy class
...
| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/blockproxy/accept/)(MarkdownSyntaxVisitor) | 訪問者を受け入れるためのインターフェイスを定義します. |
...
| [GetTarget](../../aspose.html.toolkit.markdown.syntax/blockproxy/gettarget/)() | ターゲット ノードを取得します。 |
...
| override [WriteTo](../../aspose.html.toolkit.markdown.syntax/blockproxy/writeto/#writeto)(MarkdownTextWriter) | Write To writer のインターフェイスを定義します。 |
