...
description: Aspose.Html.Toolkit.Markdown.Syntax.LinkReferenceDefinitionSyntaxNode クラス. LinkReferenceDefinitionSyntaxNode を表します
type: docs
weight: 5120
url: /ja/net/aspose.html.toolkit.markdown.syntax/linkreferencedefinitionsyntaxnode/
---
...
| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/linkreferencedefinitionsyntaxnode/accept/)(MarkdownSyntaxVisitor) | 訪問者を受け入れるためのインターフェイスを定義します. |
...
| [GetDestination](../../aspose.html.toolkit.markdown.syntax/linkreferencedefinitionsyntaxnode/getdestination/)() | get 宛先のインターフェイスを定義します。 |
| [GetLabel](../../aspose.html.toolkit.markdown.syntax/linkreferencedefinitionsyntaxnode/getlabel/)() | get label のインターフェイスを定義します。 |
...
| [GetTitle](../../aspose.html.toolkit.markdown.syntax/linkreferencedefinitionsyntaxnode/gettitle/)() | タイトルを取得するためのインターフェイスを定義します。 |
