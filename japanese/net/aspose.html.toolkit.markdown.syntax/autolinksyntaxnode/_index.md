...
description: Aspose.Html.Toolkit.Markdown.Syntax.AutoLinkSyntaxNode クラス. AutoLinkSyntaxNode を表します
type: docs
weight: 4790
url: /ja/net/aspose.html.toolkit.markdown.syntax/autolinksyntaxnode/
---
...
| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/autolinksyntaxnode/accept/)(MarkdownSyntaxVisitor) | 訪問者を受け入れるためのインターフェイスを定義します. |
...
| [GetUri](../../aspose.html.toolkit.markdown.syntax/autolinksyntaxnode/geturi/)() | uri. を取得します |
...
| [IsMail](../../aspose.html.toolkit.markdown.syntax/autolinksyntaxnode/ismail/)() | メールの場合は true を取得します。 |
