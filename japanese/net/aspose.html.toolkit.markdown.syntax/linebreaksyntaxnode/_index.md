...
description: Aspose.Html.Toolkit.Markdown.Syntax.LineBreakSyntaxNode クラス. LineBreakSyntaxNode を表します
type: docs
weight: 5100
url: /ja/net/aspose.html.toolkit.markdown.syntax/linebreaksyntaxnode/
---
...
| 名前 | 説明 |
| --- | --- |
| abstract [Accept](../../aspose.html.toolkit.markdown.syntax/inlinesyntaxnode/accept/)(MarkdownSyntaxVisitor) | 訪問者を受け入れるためのインターフェイスを定義します. |
