...
description: Aspose.Html.Toolkit.Markdown.Syntax.InlineProxy クラス. InlineProxy を表します
type: docs
weight: 5070
url: /ja/net/aspose.html.toolkit.markdown.syntax/inlineproxy/
---
## InlineProxy class
...
| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/inlineproxy/accept/)(MarkdownSyntaxVisitor) | 訪問者を受け入れるためのインターフェイスを定義します. |
...
| [GetTarget](../../aspose.html.toolkit.markdown.syntax/inlineproxy/gettarget/)() | get target のインターフェイスを定義します。 |
...
| override [WriteTo](../../aspose.html.toolkit.markdown.syntax/inlineproxy/writeto/#writeto)(MarkdownTextWriter) | テキストライターに書き込みます。 |
