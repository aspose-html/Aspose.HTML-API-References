...
description: Aspose.Html.Toolkit.Markdown.Syntax.HardBreakSyntaxNode クラス. HardBreakSyntaxNode を表します
type: docs
weight: 5010
url: /ja/net/aspose.html.toolkit.markdown.syntax/hardbreaksyntaxnode/
---
## HardBreakSyntaxNode class

HardBreakSyntaxNode を表します。
...
| virtual [Source](../../aspose.html.toolkit.markdown.syntax/linebreaksyntaxnode/source/) { get; } | ソースを取得します。 |
| virtual [Span](../../aspose.html.toolkit.markdown.syntax/linebreaksyntaxnode/span/) { get; } | スパンを取得します。 |
| [Value](../../aspose.html.toolkit.markdown.syntax/linebreaksyntaxnode/value/) { get; } | 値を取得します。 |

## メソッド

| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/hardbreaksyntaxnode/accept/)(MarkdownSyntaxVisitor) | 訪問者を受け入れるためのインターフェイスを定義します. |
...
| [GetBreakingTag](../../aspose.html.toolkit.markdown.syntax/hardbreaksyntaxnode/getbreakingtag/)() | Breaking Tag を取得するためのインターフェイスを定義します |
