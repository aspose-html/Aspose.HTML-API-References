...
description: Aspose.Html.Toolkit.Markdown.Syntax.TaskListItemMarker クラス. タスク リスト アイテム マーカー
type: docs
weight: 5600
url: /ja/net/aspose.html.toolkit.markdown.syntax/tasklistitemmarker/
---
...
| [IsChecked](../../aspose.html.toolkit.markdown.syntax/tasklistitemmarker/ischecked/)() | チェックされたステータスを取得するためのインターフェイスを定義します. |
