...
description: Aspose.Html.Toolkit.Markdown.Syntax.SoftBreakSyntaxNode クラス. ソフト ブレーク構文を表します
type: docs
weight: 5540
url: /ja/net/aspose.html.toolkit.markdown.syntax/softbreaksyntaxnode/
---
...
| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/softbreaksyntaxnode/accept/)(MarkdownSyntaxVisitor) | 訪問者を受け入れるためのインターフェイスを定義します. |
