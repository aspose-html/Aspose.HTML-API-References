...
description: Aspose.Html.Toolkit.Markdown.Syntax.WhitespaceSyntaxNode クラス. 空白構文ノードを表します
type: docs
weight: 5740
url: /ja/net/aspose.html.toolkit.markdown.syntax/whitespacesyntaxnode/
---
...
| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/whitespacesyntaxnode/accept/)(MarkdownSyntaxVisitor) | 構文のノードを訪問するためのインターフェイスを定義します. |
