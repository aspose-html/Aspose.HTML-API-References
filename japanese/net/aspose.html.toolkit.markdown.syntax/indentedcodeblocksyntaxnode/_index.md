...
description: Aspose.Html.Toolkit.Markdown.Syntax.IndentedCodeBlockSyntaxNode クラス. IndentedCodeBlockSyntaxNode を表します
type: docs
weight: 5030
url: /ja/net/aspose.html.toolkit.markdown.syntax/indentedcodeblocksyntaxnode/
---
...
| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/indentedcodeblocksyntaxnode/accept/)(MarkdownSyntaxVisitor) | 訪問者を受け入れるためのインターフェイスを定義します. |
...
| [GetContent](../../aspose.html.toolkit.markdown.syntax/indentedcodeblocksyntaxnode/getcontent/)() | get Content. のインターフェイスを定義します。 |
