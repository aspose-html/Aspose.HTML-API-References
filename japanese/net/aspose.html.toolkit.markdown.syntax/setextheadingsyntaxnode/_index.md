...
description: Aspose.Html.Toolkit.Markdown.Syntax.SetextHeadingSyntaxNode クラス. Setext 見出し構文ノードを表します
type: docs
weight: 5530
url: /ja/net/aspose.html.toolkit.markdown.syntax/setextheadingsyntaxnode/
---
...
| [Level](../../aspose.html.toolkit.markdown.syntax/setextheadingsyntaxnode/level/) { get; } | 現在の構文のレベルを取得します。 |
...
| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/setextheadingsyntaxnode/accept/)(MarkdownSyntaxVisitor) | 訪問者を受け入れるためのインターフェイスを定義します. |
