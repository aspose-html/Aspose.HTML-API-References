...
description: Aspose.Html.Toolkit.Markdown.Syntax.TableCellSyntaxNode クラス. テーブル セルの構文ノードを表します
type: docs
weight: 5560
url: /ja/net/aspose.html.toolkit.markdown.syntax/tablecellsyntaxnode/
---
...
| [GetValue](../../aspose.html.toolkit.markdown.syntax/tablecellsyntaxnode/getvalue/)() | 文字列値を取得するためのインターフェイスを定義します。 |
