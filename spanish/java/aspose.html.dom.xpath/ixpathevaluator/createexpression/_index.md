...
description: "Método IXPathEvaluator. Crea una expresión XPath analizada con paquetes resueltos. Esto es útil cuando una expresión se reutilizará en una aplicación, ya que permite compilar la cadena de expresión en una forma interna más eficiente y prerresolver todos los prefijos de paquetes que aparecen dentro de la expresión."
type: docs
