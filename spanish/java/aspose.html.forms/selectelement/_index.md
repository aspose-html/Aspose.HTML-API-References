...
El SelectElement representa un contenedor asociado con el HTMLSelectElement.
...
| [id](../../com.aspose.html.forms/selectelement/id/) { get; set; } | Representa el atributo Id del elemento de entrada. |
[getMultiple]
...
| [name](../../com.aspose.html.forms/selectelement/name/) { get; set; } | Representa el atributo name del elemento de entrada. |
