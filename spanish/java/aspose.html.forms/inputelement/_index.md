...
El InputElement representa un contenedor que está asociado con el HTMLInputElement.
...
| [id](../../com.aspose.html.forms/inputelement/id/) { get; set; } | Representa el atributo Id del elemento input. |
| [getList](../../com.aspose.html.forms/inputelement/list/) Representa una lista de opciones |
| [name](../../com.aspose.html.forms/inputelement/name/) { get; set; } | Representa el atributo name del elemento input. |
[getType]
