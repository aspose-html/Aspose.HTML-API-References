---
title: "Clase DocRenderingOptions"
second_title: "Referencia de la API de Aspose.HTML para Java"
description: "com.aspose.html.rendering.doc.DocRenderingOptions clase. Representa las opciones de renderizado para DocDevice"
type: docs

url: /es/java/com.aspose.html.rendering.doc/docrenderingoptions/
---
...
| Nombre | Descripción |
| --- | --- |
| [DocRenderingOptions](docrenderingoptions/#constructor)() | Inicializa una nueva instancia de la clase `DocRenderingOptions`. |
| [DocRenderingOptions](docrenderingoptions/#constructor_1)(FontEmbeddingRule) | Inicializa una nueva instancia de la clase `DocRenderingOptions` con la regla de incrustación de fuentes especificada. |
