...
| Nombre | Descripción |
| --- | --- |
| [ImageSaveOptions](imagesaveoptions/#constructor)() | Inicializa una nueva instancia de la clase `ImageSaveOptions`; Png se utilizará como formato de imagen predeterminado. |
...
| [horizontalResolution](../../com.aspose.html.rendering.image/imagerenderingoptions/horizontalresolution/) { get; set; } | Establece o obtiene la resolución horizontal para imágenes de salida e internas (que se utilizan durante el procesamiento de filtros), en píxeles por pulgada. Por defecto, esta propiedad es 300 ppp. |
...
| [getText](../../com.aspose.html.rendering.image/imagerenderingoptions/text/) Obtiene un objeto [`TextOptions`](../../com.aspose.html.rendering.image/textoptions/) que se utiliza para la configuración del renderizado de texto. |
[getUseAntialiasing]
[setUseAntialiasing] Specifies whether to use antialiasing. By default, antialiasing is enabled. |
| [verticalResolution](../../com.aspose.html.rendering.image/imagerenderingoptions/verticalresolution/) { get; set; } | Establece o obtiene la resolución vertical para imágenes de salida e internas (que se utilizan durante el procesamiento de filtros), en píxeles por pulgada. Por defecto, esta propiedad es 300 ppp. |
