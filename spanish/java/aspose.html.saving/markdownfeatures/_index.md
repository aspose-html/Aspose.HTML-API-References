---
title: "Enumeración MarkdownFeatures"
second_title: "Referencia de la API de Aspose.HTML para Java"
description: "Enumeración com.aspose.html.saving.MarkdownFeatures. Un conjunto de banderas MarkdownFeatures es un conjunto de cero o más de las siguientes banderas que se utilizan para seleccionar los elementos convertidos a markdown."
type: docs
...
| Emphasis | `100` | Esta bandera habilita la conversión de elementos `emphasis`. |
| InlineCode | `200` | Esta bandera habilita la conversión de elementos `code`. |
| Image | `400` | Esta bandera habilita la conversión de elementos `img`. |
| LineBreak | `800` | Esta bandera habilita la conversión de elementos `br`. |
| Video | `1000` | Esta bandera habilita la conversión de elementos `video`. |
| Table | `2000` | Esta bandera habilita la conversión de elementos `table`. |
| TaskList | `4000` | Esta bandera habilita la conversión de listas de tareas. La lista de tareas consiste en el elemento `input`, que debe ser el primer hijo del elemento `list` y cuyo valor del atributo `type` debe ser igual a `checkbox`. |
| Strikethrough | `8000` | Esta bandera habilita la conversión de elementos `del`. |
| Strong | `10000` | Esta bandera habilita la conversión de elementos `strong`. |
