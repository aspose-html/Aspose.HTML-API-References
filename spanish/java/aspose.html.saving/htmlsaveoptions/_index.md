...
description: "com.aspose.html.saving.HTMLSaveOptions class. Representa las opciones de guardado HTML. Al asignar propiedades específicas puedes gestionar el procesamiento de recursos, como la profundidad máxima de manejo, etc. Más información en el artículo de documentación"
type: docs
...
Representa opciones de guardado HTML. Al asignar propiedades específicas puedes gestionar el procesamiento de recursos, como la profundidad máxima de manejo, entre otros. Más información en la documentación [artículo](https://docs.aspose.com/html/net/working-with-documents/saving-a-document/).
