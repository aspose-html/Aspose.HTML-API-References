...
description: "Clase com.aspose.html.saving.PdfSaveOptions. Esta clase de datos específica proporciona algunas propiedades para gestionar el resultado de la conversión. Por ejemplo, PageSetup especifica las características de la página. Consulte el artículo de documentación."
type: docs
...
La clase de datos específica proporciona algunas propiedades para gestionar el resultado de la conversión. Por ejemplo, [`PageSetup`](../../com.aspose.html.rendering/pagesetup/) especifica las características de la página. Consulte la documentación del [artículo](https://docs.aspose.com/html/net/converting-between-formats/html-to-pdf/#convert-html-to-pdf-using-pdfsaveoptions).
