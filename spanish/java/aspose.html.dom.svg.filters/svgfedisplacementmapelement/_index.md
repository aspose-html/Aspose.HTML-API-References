---
title: "Clase SVGFEDisplacementMapElement"
second_title: "Referencia de la API de Aspose.HTML para Java"
description: "Clase com.aspose.html.dom.svg.filters.SVGFEDisplacementMapElement. La interfaz SVGFEDisplacementMapElement corresponde al elemento feDisplacementMap."
type: docs

url: /es/java/com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/
---
## SVGFEDisplacementMapElement class

La interfaz SVGFEDisplacementMapElement corresponde al elemento ‘feDisplacementMap’.
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/height/) Corresponde al atributo ‘height’ en el elemento ‘filter’ dado. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/in1/) Corresponde al atributo ‘in’ en el elemento ‘feDisplacementMap’ dado. |
| [getIn2](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/in2/) Corresponde al atributo ‘in2’ en el elemento ‘feDisplacementMap’ dado. |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/result/) Corresponde al atributo ‘result’ en el elemento ‘filter’ dado. |
| [getScale](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/scale/) Corresponde al atributo ‘scale’ en el elemento ‘feDisplacementMap’ dado. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/width/) Corresponde al atributo ‘width’ en el elemento ‘filter’ dado. |
| [X](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/x/) { get; } | Corresponds to attribute ‘x’ on the given ‘filter’ element. Corresponde al atributo ‘x’ del elemento ‘filter’ dado. |
| [getXChannelSelector](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/xchannelselector/) Corresponde al atributo ‘xChannelSelector’ en el elemento ‘feDisplacementMap’ dado. Acepta una de las constantes SVG_CHANNEL_* definidas en esta interfaz. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/y/) { get; } | Corresponds to attribute ‘y’ on the given ‘filter’ element. Corresponde al atributo ‘y’ del elemento ‘filter’ dado. |
| [getYChannelSelector](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/ychannelselector/) Corresponde al atributo ‘yChannelSelector’ del elemento ‘feDisplacementMap’ proporcionado. Acepta una de las constantes SVG_CHANNEL_* definidas en esta interfaz. |
...
| Nombre | Descripción |
| --- | --- |
| const [SVG_CHANNEL_A](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_a/) | Corresponde al valor 'A'. |
| const [SVG_CHANNEL_B](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_b/) | Corresponde al valor 'B'. |
| const [SVG_CHANNEL_G](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_g/) | Corresponde al valor 'G'. |
| const [SVG_CHANNEL_R](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_r/) | Corresponde al valor 'R'. |
| const [SVG_CHANNEL_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_unknown/) | El tipo no es uno de los tipos predefinidos. Es inválido intentar definir un nuevo valor de este tipo o intentar cambiar un valor existente a este tipo. |
