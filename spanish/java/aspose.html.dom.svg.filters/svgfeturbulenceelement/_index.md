---
title: "Clase SVGFETurbulenceElement"
second_title: "Referencia de la API de Aspose.HTML para Java"
description: "Clase com.aspose.html.dom.svg.filters.SVGFETurbulenceElement. La interfaz SVGFETurbulenceElement corresponde al elemento feTurbulence."
type: docs

url: /es/java/com.aspose.html.dom.svg.filters/svgfeturbulenceelement/
---
## SVGFETurbulenceElement class

La interfaz SVGFETurbulenceElement corresponde al elemento ‘feTurbulence’.
...
| [getBaseFrequencyX](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/basefrequencyx/) Corresponde al atributo ‘baseFrequency’ del elemento ‘feTurbulence’ proporcionado. Contiene el componente X del atributo ‘baseFrequency’. |
| [getBaseFrequencyY](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/basefrequencyy/) Corresponde al atributo ‘baseFrequency’ del elemento ‘feTurbulence’ proporcionado. Contiene el componente Y del atributo ‘baseFrequency’ (posiblemente calculado automáticamente). |
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/height/) Corresponde al atributo ‘height’ del elemento ‘filter’ proporcionado. |
[getId]
...
| [getNumOctaves](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/numoctaves/) Corresponde al atributo ‘numOctaves’ del elemento ‘feTurbulence’ proporcionado. |
[getOuterHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/result/) Corresponde al atributo ‘result’ del elemento ‘filter’ proporcionado. |
| [getSeed](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/seed/) Corresponde al atributo ‘seed’ del elemento ‘feTurbulence’ proporcionado. |
...
| [getStitchTiles](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/stitchtiles/) Corresponde al atributo ‘stitchTiles’ del elemento ‘feTurbulence’ proporcionado. Acepta una de las constantes SVG_STITCHTYPE_* definidas en esta interfaz. |
...
| [getType](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/type/) Corresponde al atributo ‘type’ del elemento ‘feTurbulence’ proporcionado. Acepta una de las constantes SVG_TURBULENCE_TYPE_* definidas en esta interfaz. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/width/) Corresponde al atributo ‘width’ del elemento ‘filter’ proporcionado. |
| [X](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/x/) { get; } | Corresponds to attribute ‘x’ on the given ‘filter’ element. Corresponde al atributo ‘x’ del elemento ‘filter’ dado. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/y/) { get; } | Corresponds to attribute ‘y’ on the given ‘filter’ element. Corresponde al atributo ‘y’ del elemento ‘filter’ dado. |
...
| Nombre | Descripción |
| --- | --- |
| const [SVG_STITCHTYPE_NOSTITCH](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_stitchtype_nostitch/) | Corresponde al valor 'noStitch'. |
| const [SVG_STITCHTYPE_STITCH](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_stitchtype_stitch/) | Corresponde al valor 'stitch'. |
| const [SVG_STITCHTYPE_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_stitchtype_unknown/) | El tipo no es uno de los tipos predefinidos. Es inválido intentar definir un nuevo valor de este tipo o intentar cambiar un valor existente a este tipo. |
| const [SVG_TURBULENCE_TYPE_FRACTALNOISE](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_turbulence_type_fractalnoise/) | Corresponde al valor 'fractalNoise'. |
| const [SVG_TURBULENCE_TYPE_TURBULENCE](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_turbulence_type_turbulence/) | Corresponde al valor 'turbulence'. |
| const [SVG_TURBULENCE_TYPE_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_turbulence_type_unknown/) | El tipo no es uno de los tipos predefinidos. Es inválido intentar definir un nuevo valor de este tipo o intentar cambiar un valor existente a este tipo. |
