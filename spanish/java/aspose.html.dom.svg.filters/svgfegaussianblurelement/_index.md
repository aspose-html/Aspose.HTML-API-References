---
title: "Clase SVGFEGaussianBlurElement"
second_title: "Referencia de la API de Aspose.HTML para Java"
description: "Clase com.aspose.html.dom.svg.filters.SVGFEGaussianBlurElement. La interfaz SVGFEGaussianBlurElement corresponde al elemento feGaussianBlur."
type: docs

url: /es/java/com.aspose.html.dom.svg.filters/svgfegaussianblurelement/
---
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/height/) Corresponde al atributo �height� en el elemento �filter� dado. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/in1/) Corresponde al atributo �in� en el elemento �feGaussianBlur� dado. |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/result/) Corresponde al atributo �result� en el elemento �filter� dado. |
...
| [getStdDeviationX](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/stddeviationx/) Corresponde al atributo �stdDeviation� en el elemento �feGaussianBlur� dado. Contiene el componente X del atributo �stdDeviation�. |
| [getStdDeviationY](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/stddeviationy/) Corresponde al atributo �stdDeviation� en el elemento �feGaussianBlur� dado. Contiene el componente Y (posiblemente calculado automáticamente) del atributo �stdDeviation�. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/width/) Corresponde al atributo �width� en el elemento �filter� dado. |
| [X](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/x/) { get; } | Corresponde al atributo �x� en el elemento �filter� dado. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/y/) { get; } | Corresponde al atributo �y� en el elemento �filter� dado. |
...
| [setStdDeviation](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/setstddeviation/)(float, float) | Establece los valores para el atributo �stdDeviation�. |
