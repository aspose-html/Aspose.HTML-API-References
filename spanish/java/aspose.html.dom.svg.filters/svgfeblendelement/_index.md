---
title: "Clase SVGFEBlendElement"
second_title: "Referencia de la API de Aspose.HTML para Java"
description: "com.aspose.html.dom.svg.filters.SVGFEBlendElement clase. La interfaz SVGFEBlendElement corresponde al elemento feBlend"
type: docs

url: /es/java/com.aspose.html.dom.svg.filters/svgfeblendelement/
---
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfeblendelement/height/) Corresponde al atributo ‘height’ en el elemento ‘filter’ dado. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfeblendelement/in1/) Corresponde al atributo ‘in’ en el elemento ‘feBlend’ dado. |
| [getIn2](../../com.aspose.html.dom.svg.filters/svgfeblendelement/in2/) Corresponde al atributo ‘in2’ en el elemento ‘feBlend’ dado. |
[getInnerHTML]
...
| [getMode](../../com.aspose.html.dom.svg.filters/svgfeblendelement/mode/) Corresponde al atributo ‘mode’ en el elemento ‘feBlend’ dado. Acepta una de las constantes SVG_FEBLEND_MODE_* definidas en esta interfaz. |
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfeblendelement/result/) Corresponde al atributo ‘result’ en el elemento ‘filter’ dado. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfeblendelement/width/) Corresponde al atributo ‘width’ en el elemento ‘filter’ dado. |
| [X](../../com.aspose.html.dom.svg.filters/svgfeblendelement/x/) { get; } | Corresponds to attribute ‘x’ on the given ‘filter’ element. Corresponde al atributo ‘x’ del elemento ‘filter’ dado. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfeblendelement/y/) { get; } | Corresponds to attribute ‘y’ on the given ‘filter’ element. Corresponde al atributo ‘y’ del elemento ‘filter’ dado. |
...
| Nombre | Descripción |
| --- | --- |
| const [SVG_FEBLEND_MODE_COLOR](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_color/) | Corresponde al valor 'color'. |
| const [SVG_FEBLEND_MODE_COLOR_BURN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_color_burn/) | Corresponde al valor 'color_burn'. |
| const [SVG_FEBLEND_MODE_COLOR_DODGE](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_color_dodge/) | Corresponde al valor 'color_dodge'. |
| const [SVG_FEBLEND_MODE_DARKEN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_darken/) | Corresponde al valor 'darken'. |
| const [SVG_FEBLEND_MODE_DIFFERENCE](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_difference/) | Corresponde al valor 'difference'. |
| const [SVG_FEBLEND_MODE_EXCLUSION](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_exclusion/) | Corresponde al valor 'exclusion'. |
| const [SVG_FEBLEND_MODE_HARD_LIGHT](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_hard_light/) | Corresponde al valor 'hard_light'. |
| const [SVG_FEBLEND_MODE_HUE](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_hue/) | Corresponde al valor 'hue'. |
| const [SVG_FEBLEND_MODE_LIGHTEN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_lighten/) | Corresponde al valor 'lighten'. |
| const [SVG_FEBLEND_MODE_LUMINOSITY](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_luminosity/) | Corresponde al valor 'luminosity'. |
| const [SVG_FEBLEND_MODE_MULTIPLY](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_multiply/) | Corresponde al valor 'multiply'. |
| const [SVG_FEBLEND_MODE_NORMAL](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_normal/) | Corresponde al valor 'normal'. |
| const [SVG_FEBLEND_MODE_OVERLAY](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_overlay/) | Corresponde al valor 'overlay'. |
| const [SVG_FEBLEND_MODE_SATURATION](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_saturation/) | Corresponde al valor 'saturation'. |
| const [SVG_FEBLEND_MODE_SCREEN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_screen/) | Corresponde al valor 'screen'. |
| const [SVG_FEBLEND_MODE_SOFT_LIGHT](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_soft_light/) | Corresponde al valor 'soft_light'. |
| const [SVG_FEBLEND_MODE_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_unknown/) | El tipo no es uno de los tipos predefinidos. Es inválido intentar definir un nuevo valor de este tipo o intentar cambiar un valor existente a este tipo. |
