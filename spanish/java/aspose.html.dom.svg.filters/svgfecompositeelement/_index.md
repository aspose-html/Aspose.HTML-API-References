---
title: "Clase SVGFECompositeElement"
second_title: "Referencia de la API de Aspose.HTML para Java"
description: "Clase com.aspose.html.dom.svg.filters.SVGFECompositeElement. La interfaz SVGFECompositeElement corresponde al elemento feComposite"
type: docs

url: /es/java/com.aspose.html.dom.svg.filters/svgfecompositeelement/
---
## SVGFECompositeElement class

La interfaz SVGFECompositeElement corresponde al elemento ‘feComposite’.
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/height/) Corresponde al atributo ‘height’ en el elemento ‘filter’ dado. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/in1/) Corresponde al atributo ‘in’ en el elemento ‘feComposite’ dado. |
| [getIn2](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/in2/) Corresponde al atributo ‘in2’ en el elemento ‘feComposite’ dado. |
[getInnerHTML]
...
| [getK1](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k1/) Corresponde al atributo ‘k1’ en el elemento ‘feComposite’ dado. |
| [getK2](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k2/) Corresponde al atributo ‘k2’ en el elemento ‘feComposite’ dado. |
| [getK3](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k3/) Corresponde al atributo ‘k3’ en el elemento ‘feComposite’ dado. |
| [getK4](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k4/) Corresponde al atributo ‘k4’ en el elemento ‘feComposite’ dado. |
...
| [getOperator](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/operator/) Corresponde al atributo ‘operator’ en el elemento ‘feComposite’ dado. Toma una de las constantes SVG_FECOMPOSITE_OPERATOR_* definidas en esta interfaz. |
[getOuterHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/result/) Corresponde al atributo ‘result’ en el elemento ‘filter’ dado. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/width/) Corresponde al atributo ‘width’ en el elemento ‘filter’ dado. |
| [X](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/x/) { get; } | Corresponds to attribute ‘x’ on the given ‘filter’ element. Corresponde al atributo ‘x’ del elemento ‘filter’ dado. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/y/) { get; } | Corresponds to attribute ‘y’ on the given ‘filter’ element. Corresponde al atributo ‘y’ del elemento ‘filter’ dado. |
...
| Nombre | Descripción |
| --- | --- |
| const [SVG_FECOMPOSITE_OPERATOR_ARITHMETIC](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_arithmetic/) | Corresponde al valor 'arithmetic'. |
| const [SVG_FECOMPOSITE_OPERATOR_ATOP](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_atop/) | Corresponde al valor 'atop'. |
| const [SVG_FECOMPOSITE_OPERATOR_IN](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_in/) | Corresponde al valor 'in'. |
| const [SVG_FECOMPOSITE_OPERATOR_OUT](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_out/) | Corresponde al valor 'out'. |
| const [SVG_FECOMPOSITE_OPERATOR_OVER](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_over/) | Corresponde al valor 'over'. |
| const [SVG_FECOMPOSITE_OPERATOR_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_unknown/) | El tipo no es uno de los tipos predefinidos. Es inválido intentar definir un nuevo valor de este tipo o intentar cambiar un valor existente a este tipo. |
| const [SVG_FECOMPOSITE_OPERATOR_XOR](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_xor/) | Corresponde al valor 'xor'. |
