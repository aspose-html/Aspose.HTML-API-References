---
title: "Clase SVGFEColorMatrixElement"
second_title: "Referencia de la API de Aspose.HTML para Java"
description: "Clase com.aspose.html.dom.svg.filters.SVGFEColorMatrixElement. La interfaz SVGFEColorMatrixElement corresponde al elemento feColorMatrix"
type: docs

url: /es/java/com.aspose.html.dom.svg.filters/svgfecolormatrixelement/
---
## SVGFEColorMatrixElement class

La interfaz SVGFEColorMatrixElement corresponde al elemento ‘feColorMatrix’.
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/height/) Corresponde al atributo ‘height’ del elemento ‘filter’ dado. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/in1/) Corresponde al atributo ‘in’ del elemento ‘feColorMatrix’ dado. |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/result/) Corresponde al atributo ‘result’ del elemento ‘filter’ dado. |
...
| [getType](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/type/) Corresponde al atributo ‘type’ del elemento ‘feColorMatrix’ dado. Toma una de las constantes SVG_FECOLORMATRIX_TYPE_* definidas en esta interfaz. |
| [getValues](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/values/) Corresponde al atributo ‘values’ del elemento ‘feColorMatrix’ dado. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/width/) Corresponde al atributo ‘width’ del elemento ‘filter’ dado. |
| [X](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/x/) { get; } | Corresponds to attribute ‘x’ on the given ‘filter’ element. Corresponde al atributo ‘x’ del elemento ‘filter’ dado. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/y/) { get; } | Corresponds to attribute ‘y’ on the given ‘filter’ element. Corresponde al atributo ‘y’ del elemento ‘filter’ dado. |
...
| Nombre | Descripción |
| --- | --- |
| const [SVG_FECOLORMATRIX_TYPE_HUEROTATE](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_huerotate/) | Corresponde al valor 'hueRotate'. |
| const [SVG_FECOLORMATRIX_TYPE_LUMINANCETOALPHA](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_luminancetoalpha/) | Corresponde al valor 'luminanceToAlpha'. |
| const [SVG_FECOLORMATRIX_TYPE_MATRIX](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_matrix/) | Corresponde al valor 'matrix'. |
| const [SVG_FECOLORMATRIX_TYPE_SATURATE](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_saturate/) | Corresponde al valor 'saturate'. |
| const [SVG_FECOLORMATRIX_TYPE_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_unknown/) | El tipo no es uno de los tipos predefinidos. Es inválido intentar definir un nuevo valor de este tipo o intentar cambiar un valor existente a este tipo. |
