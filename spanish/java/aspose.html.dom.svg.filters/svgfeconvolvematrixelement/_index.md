---
title: "Clase SVGFEConvolveMatrixElement"
second_title: "Referencia de la API de Aspose.HTML para Java"
description: "Clase com.aspose.html.dom.svg.filters.SVGFEConvolveMatrixElement. La interfaz SVGFEConvolveMatrixElement corresponde al elemento feConvolveMatrix."
type: docs

url: /es/java/com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/
---
## SVGFEConvolveMatrixElement class

La interfaz SVGFEConvolveMatrixElement corresponde al elemento ‘feConvolveMatrix’.
...
| [getBias](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/bias/) Corresponde al atributo ‘bias’ del elemento ‘feConvolveMatrix’ especificado. |
...
| [getDivisor](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/divisor/) Corresponde al atributo ‘divisor’ del elemento ‘feConvolveMatrix’ especificado. |
| [getEdgeMode](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/edgemode/) Corresponde al atributo ‘edgeMode’ del elemento ‘feConvolveMatrix’ especificado. |
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/height/) Corresponde al atributo ‘height’ del elemento ‘filter’ especificado. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/in1/) Corresponde al atributo ‘in’ del elemento ‘feConvolveMatrix’ especificado. |
[getInnerHTML]
...
| [getKernelMatrix](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelmatrix/) Corresponde al atributo ‘kernelMatrix’ del elemento ‘feConvolveMatrix’ especificado. |
| [getKernelUnitLengthX](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelunitlengthx/) Corresponde al atributo ‘kernelUnitLength’ del elemento ‘feConvolveMatrix’ especificado. |
| [getKernelUnitLengthY](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelunitlengthy/) Corresponde al atributo ‘kernelUnitLength’ del elemento ‘feConvolveMatrix’ especificado. |
...
| [getOrderX](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/orderx/) Corresponde al atributo ‘order’ del elemento ‘feConvolveMatrix’ especificado. |
| [getOrderY](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/ordery/) Corresponde al atributo ‘order’ del elemento ‘feConvolveMatrix’ especificado. |
[getOuterHTML]
...
| [getPreserveAlpha](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/preservealpha/) Corresponde al atributo ‘preserveAlpha’ del elemento ‘feConvolveMatrix’ especificado. |
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/result/) Corresponde al atributo ‘result’ del elemento ‘filter’ especificado. |
...
| [getTargetX](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/targetx/) Corresponde al atributo ‘targetX’ del elemento ‘feConvolveMatrix’ especificado. |
| [getTargetY](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/targety/) Corresponde al atributo ‘targetY’ del elemento ‘feConvolveMatrix’ especificado. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/width/) Corresponde al atributo ‘width’ en el elemento ‘filter’ dado. |
| [X](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/x/) { get; } | Corresponde al atributo ‘x’ del elemento ‘filter’ dado. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/y/) { get; } | Corresponde al atributo ‘y’ del elemento ‘filter’ dado. |
...
| Nombre | Descripción |
| --- | --- |
| const [SVG_EDGEMODE_DUPLICATE](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_duplicate/) | Corresponde al valor 'duplicate'. |
| const [SVG_EDGEMODE_NONE](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_none/) | Corresponde al valor 'none'. |
| const [SVG_EDGEMODE_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_unknown/) | El tipo no es uno de los tipos predefinidos. Es inválido intentar definir un nuevo valor de este tipo o intentar cambiar un valor existente a este tipo. |
| const [SVG_EDGEMODE_WRAP](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_wrap/) | Corresponde al valor 'wrap'. |
