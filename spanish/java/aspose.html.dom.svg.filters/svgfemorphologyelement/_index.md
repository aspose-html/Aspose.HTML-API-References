---
title: "Clase SVGFEMorphologyElement"
second_title: "Referencia de la API de Aspose.HTML para Java"
description: "clase com.aspose.html.dom.svg.filters.SVGFEMorphologyElement. La interfaz SVGFEMorphologyElement corresponde al elemento feMorphology."
type: docs

url: /es/java/com.aspose.html.dom.svg.filters/svgfemorphologyelement/
---
## SVGFEMorphologyElement class

La interfaz SVGFEMorphologyElement corresponde al elemento ‘feMorphology’.
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/height/) Corresponde al atributo ‘height’ en el elemento ‘filter’ dado. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/in1/) Corresponde al atributo ‘in’ en el elemento ‘feMorphology’ dado. |
[getInnerHTML]
...
| [getOperator](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/operator/) Corresponde al atributo ‘operator’ en el elemento ‘feMorphology’ dado. Toma una de las constantes SVG_MORPHOLOGY_OPERATOR_* definidas en esta interfaz. |
[getOuterHTML]
...
| [getRadiusX](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/radiusx/) Corresponde al atributo ‘radius’ en el elemento ‘feMorphology’ dado. |
| [getRadiusY](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/radiusy/) Corresponde al atributo ‘radius’ en el elemento ‘feMorphology’ dado. |
| [getResult](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/result/) Corresponde al atributo ‘result’ en el elemento ‘filter’ dado. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/width/) Corresponde al atributo ‘width’ en el elemento ‘filter’ dado. |
| [X](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/x/) { get; } | Corresponds to attribute ‘x’ on the given ‘filter’ element. Corresponde al atributo ‘x’ del elemento ‘filter’ dado. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/y/) { get; } | Corresponds to attribute ‘y’ on the given ‘filter’ element. Corresponde al atributo ‘y’ del elemento ‘filter’ dado. |
...
| Nombre | Descripción |
| --- | --- |
| const [SVG_MORPHOLOGY_OPERATOR_DILATE](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/svg_morphology_operator_dilate/) | Corresponde al valor 'dilate'. |
| const [SVG_MORPHOLOGY_OPERATOR_ERODE](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/svg_morphology_operator_erode/) | Corresponde al valor 'erode'. |
| const [SVG_MORPHOLOGY_OPERATOR_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/svg_morphology_operator_unknown/) | El tipo no es uno de los tipos predefinidos. Es inválido intentar definir un nuevo valor de este tipo o intentar cambiar un valor existente a este tipo. |
