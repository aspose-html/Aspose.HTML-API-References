...
Define un método para renderizar múltiples [`HTMLDocument`](../../../com.aspose.html/htmldocument/)s en un [`IDevice`](../../idevice/) específico, utilizando un token de cancelación para solicitar la cancelación de la operación.
