...
| [clip](../../com.aspose.html.rendering/device-2/clip/)(FillRule) | Modifica la ruta de recorte actual intersectándola con la ruta actual, usando la FillRule para determinar la región a rellenar. Este método termina la ruta actual. |
...
| [dispose](../../com.aspose.html.rendering/device-2/dispose/)() | Realiza tareas definidas por la aplicación asociadas con la liberación, el desbloqueo o el restablecimiento de recursos no administrados. |
...
| [endPage](../../com.aspose.html.rendering/device-2/endpage/)() | Finaliza el renderizado de la página actual. |
| [fill](../../com.aspose.html.rendering/device-2/fill/)(FillRule) | Rellena toda la región delimitada por la ruta actual. Si la ruta consta de varios subtrazos desconectados, rellena el interior de todos los subtrazos, considerados en conjunto. Este método finaliza la ruta actual. |
...
| [flush](../../com.aspose.html.rendering/device-2/flush/)() | Vierte todos los datos al flujo de salida. |
...
| enum [PageWritingStrategy&lt;TGraphicContext,TRenderingOptions&gt;](../../com.aspose.html.rendering/device-2.pagewritingstrategy-2) | Especifica tipos de estrategias para escribir páginas en streams de salida\streams. |
