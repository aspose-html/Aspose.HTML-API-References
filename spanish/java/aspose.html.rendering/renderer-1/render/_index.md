...
description: "Método Renderer. Define un método para renderizar TDocument en el IDevice especificado"
type: docs
...
Define un método para renderizar !:TDocument en el [`IDevice`](../../idevice/) especificado.
...
Define un método para renderizar !:TDocument en el [`IDevice`](../../idevice/) especificado. El renderizado se realizará una vez que no haya operaciones de red para cargar recursos, temporizadores activos, tareas de animación o que haya transcurrido el tiempo de espera especificado.
...
| dispositivo | IDevice | El dispositivo de salida. |
| documento | TSource | El documento. |
| tiempo de espera | Int32 | Una cantidad de milisegundos que representa la cantidad de milisegundos a esperar, o -1 milisegundo para esperar indefinidamente. |
