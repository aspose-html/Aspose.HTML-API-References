...
Una hoja de estilo consta de una colección de objetos [`ICSSRule`](../icssrule/) que representan cada una de las reglas en la hoja de estilo. Las reglas se encuentran en una [`ICSSRuleList`](../icssrulelist/), que puede obtenerse a través de la propiedad cssRules de la hoja de estilo.
...
Otra regla podría ser una regla at-rule como @import o @media, entre otras.
