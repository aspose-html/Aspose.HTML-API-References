...
Nota: Aunque insertRule() es exclusivamente un método de [`CSSStyleSheet`](../), en realidad inserta la regla en CSSStyleSheet.cssRules — su interno [`CSSRuleList`](../../icssrulelist/).
...
| --- | --- | --- |
| regla | String | Una String que contiene la regla a insertar. Lo que la regla insertada debe contener depende de su tipo: |
