...
Esta propiedad acepta una lista separada por comas de efectos de sombra que se aplicarán al texto del elemento. Los efectos de sombra se aplican en el orden especificado y pueden superponerse entre sí, pero nunca superpondrán el propio texto. Los efectos de sombra no alteran el tamaño de una caja, pero pueden extenderse más allá de sus límites. El [stack level](https://www.w3.org/TR/1998/REC-CSS2-19980512/visuren.html#stack-level) de los efectos de sombra es el mismo que el del propio elemento.
