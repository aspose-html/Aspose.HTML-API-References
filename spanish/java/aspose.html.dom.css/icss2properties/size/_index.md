...
El tamaño de un cuadro de página puede ser "absolute" (tamaño fijo) o "relative" (escalable, es decir, ajustándose a los tamaños de hoja disponibles). Los cuadros de página relativos permiten a los agentes de usuario escalar un documento y hacer un uso óptimo del tamaño objetivo.
