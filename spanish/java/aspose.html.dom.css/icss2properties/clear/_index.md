...
Esta propiedad solo puede especificarse para elementos de nivel de bloque (incluidos los flotantes). Para cajas compactas y de inserción, esta propiedad se aplica a la caja de bloque final a la que pertenece la caja compacta o de inserción.

Los valores tienen los siguientes significados cuando se aplican a cajas de bloque no flotantes:

left - El margen superior de la caja generada se incrementa lo suficiente como para que el borde superior quede por debajo del borde externo inferior de cualquier caja flotante a la izquierda que provenga de elementos anteriores en el documento fuente. right - El margen superior de la caja generada se incrementa lo suficiente como para que el borde superior quede por debajo del borde externo inferior de cualquier caja flotante a la derecha que provenga de elementos anteriores en el documento fuente. both - La caja generada se desplaza por debajo de todas las cajas flotantes de elementos anteriores en el documento fuente. none - No hay restricción sobre la posición de la caja con respecto a los flotantes.
