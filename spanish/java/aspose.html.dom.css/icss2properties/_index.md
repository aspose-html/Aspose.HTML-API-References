---
title: "Interfaz ICSS2Properties"
second_title: "Referencia de la API de Aspose.HTML para Java"
description: "com.aspose.html.dom.css.ICSS2Properties interface. La interfaz CSS2Properties representa un mecanismo conveniente para obtener y establecer propiedades dentro de una CSSStyleDeclaration. Los atributos de esta interfaz corresponden a todas las propiedades especificadas en CSS2. Obtener un atributo de esta interfaz es equivalente a llamar al método getPropertyValue de la interfaz CSSStyleDeclaration. Establecer un atributo de esta interfaz es equivalente a llamar al método setProperty de la interfaz CSSStyleDeclaration."
type: docs

url: /es/java/com.aspose.html.dom.css/icss2properties/
---
## ICSS2Properties interface

La interfaz CSS2Properties representa un mecanismo conveniente para obtener y establecer propiedades dentro de un [`CSSStyleDeclaration`](../icssstyledeclaration/). Los atributos de esta interfaz corresponden a todas las propiedades especificadas en CSS2. Obtener un atributo de esta interfaz es equivalente a llamar al método getPropertyValue de la interfaz [`CSSStyleDeclaration`](../icssstyledeclaration/). Establecer un atributo de esta interfaz es equivalente a llamar al método setProperty de la interfaz [`CSSStyleDeclaration`](../icssstyledeclaration/).
