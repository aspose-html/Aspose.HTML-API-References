...
description: "Propiedad ICSS2Properties. Esta propiedad afecta la posición vertical dentro de una caja de línea de los cuadros generados por un elemento de nivel en línea. Los siguientes valores solo tienen significado con respecto a un elemento padre de nivel en línea o a un elemento padre de nivel de bloque si ese elemento genera cajas en línea anónimas; no tienen efecto si no existe tal padre."
type: docs
