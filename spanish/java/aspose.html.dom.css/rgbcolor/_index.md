...
Aunque una hoja de estilo solo pueda contener un entero para un valor de color, el almacenamiento interno de ese entero es un número de punto flotante, y puede usarse como flotante en el estilo especificado o calculado.
