...
A través de HTMLElement.style, que maneja los estilos en línea de un solo elemento. A través de la API [`CSSStyleSheet`](../icssstylesheet/). Por ejemplo, document.styleSheets[0].cssRules[0].style devuelve un objeto `CSSStyleDeclaration` en la primera regla CSS del primer hoja de estilos del documento. A través de Window.getComputedStyle(), que expone el objeto `CSSStyleDeclaration` como una interfaz de solo lectura.
...
| [getPropertyPriority](../../com.aspose.html.dom.css/icssstyledeclaration/getpropertypriority/)(String) | Se usa para recuperar la prioridad de una propiedad CSS (p. ej., el calificador "important") si la propiedad ha sido establecida explícitamente en este bloque de declaración. |
