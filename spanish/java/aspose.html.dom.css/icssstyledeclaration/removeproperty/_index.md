...
| --- | --- | --- |
| propertyName | Cadena | propertyName es una cadena que representa el nombre de la propiedad a eliminar. Tenga en cuenta que los nombres de propiedades compuestos se escriben con guiones y no en camelCase. |
