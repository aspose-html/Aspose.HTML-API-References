...
description: "interfaz com.aspose.html.dom.css.ICSSValueList. La interfaz CSSValueList hereda de la interfaz CSSValue y proporciona la abstracción de una colección ordenada de valores CSS."
type: docs
...
La interfaz CSSValueList hereda de la interfaz [`CSSValue`](../cssvalue/) y proporciona la abstracción de una colección ordenada de valores CSS.
...
| Nombre | Descripción |
| --- | --- |
| [getItem](../../com.aspose.html.dom.css/icssvaluelist/item/) Este método se utiliza para obtener un CSSValue por índice ordinal. El orden en esta colección representa el orden de los valores en la propiedad de estilo CSS. Si el índice es mayor o igual que el número de valores en la lista, devuelve null. |
