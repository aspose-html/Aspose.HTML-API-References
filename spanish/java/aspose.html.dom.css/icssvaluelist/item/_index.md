...
description: "Propiedad ICSSValueList. Este método se usa para obtener un CSSValue por índice ordinal. El orden en esta colección representa el orden de los valores en la propiedad de estilo CSS. Si el índice es mayor o igual que el número de valores en la lista, devuelve nulo."
type: docs
