...
| [getParentStyleSheet](../../com.aspose.html.dom.css/istylesheet/parentstylesheet/) Para los lenguajes de hojas de estilo que soportan el concepto de inclusión de hojas de estilo, este atributo representa la hoja de estilo que incluye, si existe. Si la hoja de estilo es una hoja de nivel superior, o el lenguaje de hojas de estilo no soporta inclusión, el valor de este atributo es null. |
| [getTitle](../../com.aspose.html.dom.css/istylesheet/title/) La propiedad title de la interfaz `StyleSheet` devuelve el título informativo de la hoja de estilo actual. |
| [getType](../../com.aspose.html.dom.css/istylesheet/type/) Esto especifica el lenguaje de hoja de estilo para esta hoja de estilo. El lenguaje de hoja de estilo se especifica como un tipo de contenido (p.ej. "text/css"). |
