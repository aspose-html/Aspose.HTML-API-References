---
title: "CSSValue Clase"
second_title: "Referencia de la API de Aspose.HTML para Java"
description: "com.aspose.html.dom.css.CSSValue clase. Representa un valor simple o complejo. Un objeto CSSValue solo ocurre en el contexto de una propiedad CSS."
type: docs
...
| const [CSS_PRIMITIVE_VALUE](../../com.aspose.html.dom.css/cssvalue/css_primitive_value/) | El valor es un valor primitivo y se puede obtener una instancia de la interfaz CSSPrimitiveValue mediante el uso de métodos de casting específicos del enlace en esta instancia de la interfaz CSSValue. |
| const [CSS_VALUE_LIST](../../com.aspose.html.dom.css/cssvalue/css_value_list/) | El valor es una lista de CSSValue y se puede obtener una instancia de la interfaz CSSValueList utilizando métodos de conversión específicos del enlace en esta instancia de la interfaz CSSValue. |
