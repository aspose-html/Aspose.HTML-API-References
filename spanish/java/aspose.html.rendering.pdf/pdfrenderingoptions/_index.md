---
title: "Clase PdfRenderingOptions"
second_title: "Referencia de la API de Aspose.HTML para Java"
description: "Clase com.aspose.html.rendering.pdf.PdfRenderingOptions. Representa opciones de renderizado para PdfDevice"
type: docs

url: /es/java/com.aspose.html.rendering.pdf/pdfrenderingoptions/
---
## PdfRenderingOptions class

Representa opciones de renderizado para [`PdfDevice`](../pdfdevice/).
...
| Nombre | Descripción |
| --- | --- |
| [PdfRenderingOptions](pdfrenderingoptions/)() | Inicializa una nueva instancia de la clase `PdfRenderingOptions`. |
