---
title: "HTMLDataListElement Clase"
second_title: "Referencia de la API de Aspose.HTML para Java"
description: "com.aspose.html.HTMLDataListElement class. El elemento datalist representa un conjunto de elementos option que representan opciones predefinidas para otros controles. Consulte también la Recomendación W3C HTML 5.2"
type: docs

url: /es/java/com.aspose.html/htmldatalistelement/
---
## HTMLDataListElement class

El elemento datalist representa un conjunto de elementos option que representan opciones predefinidas para otros controles. Consulte también la [HTML 5.2 W3C Recommendation](https://www.w3.org/TR/html52/sec-forms.html#elementdef-datalist).
...
| [getOptions](../../com.aspose.html/htmldatalistelement/options/) La colección de elementos `OPTION` contenidos por este elemento. |
[getOuterHTML]
