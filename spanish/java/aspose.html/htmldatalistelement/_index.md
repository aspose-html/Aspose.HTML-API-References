...
description: "com.aspose.html.HTMLDataListElement clase. El elemento datalist representa un conjunto de elementos option que representan opciones predefinidas para otros controles. Consulte también la Recomendación W3C HTML 5.2"
type: docs
...
El elemento datalist representa un conjunto de elementos option que representan opciones predefinidas para otros controles. Vea también la [HTML 5.2 W3C Recommendation](https://www.w3.org/TR/html52/sec-forms.html#elementdef-datalist).
...
| [getOptions](../../com.aspose.html/htmldatalistelement/options/) La colección de elementos `OPTION` contenidos en este elemento. |
[getOuterHTML]
