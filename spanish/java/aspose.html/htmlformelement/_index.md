...
El elemento `FORM` abarca un comportamiento similar al de una colección y un elemento. Proporciona acceso directo a los controles de formulario contenidos así como a los atributos del elemento formulario. Vea la definición del elemento FORM en HTML 4.01.
