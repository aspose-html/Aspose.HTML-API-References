---
title: "Clase HTMLElement"
second_title: "Referencia de la API de Aspose.HTML para Java"
description: "Clase com.aspose.html.HTMLElement. Todas las interfaces de elementos HTML derivan de esta clase. Los elementos que solo exponen los atributos básicos de HTML están representados por la interfaz base HTMLElement. Estos elementos son los siguientes especiales SUB SUP SPAN BDO font TT I B U S STRIKE BIG SMALL phrase EM STRONG DFN CODE SAMP KBD VAR CITE ACRONYM ABBRlist DD DTNOFRAMES NOSCRIPTADDRESS CENTER. El atributo style de un elemento HTML es accesible a través de la interfaz ElementCSSInlineStyle, que está definida en el módulo CSS DOM Level 2 Style Sheets and CSS"
type: docs

url: /es/java/com.aspose.html/htmlelement/
---
## HTMLElement class

Todas las interfaces de elementos HTML derivan de esta clase. Los elementos que solo exponen los atributos básicos de HTML están representados por la interfaz base `HTMLElement`. Estos elementos son los siguientes: special: SUB, SUP, SPAN, BDOfont: TT, I, B, U, S, STRIKE, BIG, SMALL phrase: EM, STRONG, DFN, CODE, SAMP, KBD, VAR, CITE, ACRONYM, ABBRlist: DD, DTNOFRAMES, NOSCRIPTADDRESS, CENTER. El atributo `style` de un elemento HTML es accesible a través de la interfaz `ElementCSSInlineStyle`, que está definida en el módulo CSS [[DOM Level 2 Style Sheets and CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113)].
