---
title: "Clase HTMLLabelElement"
second_title: "Referencia de la API de Aspose.HTML para Java"
description: "Clase com.aspose.html.HTMLLabelElement. Texto de la etiqueta del campo de formulario. Consulte la definición del elemento LABEL en HTML 4.01"
type: docs

url: /es/java/com.aspose.html/htmllabelelement/
---
## HTMLLabelElement class

Texto de etiqueta de campo de formulario. Consulte la definición del elemento LABEL en HTML 4.01.
...
| [getForm](../../com.aspose.html/htmllabelelement/form/) Devuelve el elemento `FORM` que contiene este control. Devuelve `null` si este control no está dentro del contexto de un formulario. |
[getId]
