...
description: "Constructor de Float32Array. Inicializa una nueva instancia de la clase Float32Array"
type: docs

url: /es/java/com.aspose.html/float32array/float32array/
---
## Float32Array(int) {#constructor_3}

Inicializa una nueva instancia de la clase [`Float32Array`](../).
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| datos | Single[] | Los datos del arreglo. |
