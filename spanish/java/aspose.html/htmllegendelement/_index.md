---
title: "Clase HTMLLegendElement"
second_title: "Referencia de la API de Aspose.HTML para Java"
description: "Clase com.aspose.html.HTMLLegendElement. Proporciona una leyenda para un agrupamiento FIELDSET. Consulte la definición del elemento LEGEND en HTML 4.01"
type: docs

url: /es/java/com.aspose.html/htmllegendelement/
---
## HTMLLegendElement class

Proporciona una leyenda para un agrupamiento `FIELDSET`. Consulte la definición del elemento LEGEND en HTML 4.01.
...
| [getForm](../../com.aspose.html/htmllegendelement/form/) Devuelve el elemento `FORM` que contiene este control. Devuelve `null` si este control no está dentro del contexto de un formulario. |
[getId]
