---
title: "Clase HTMLButtonElement"
second_title: "Referencia de la API de Aspose.HTML para Java"
description: "Clase com.aspose.html.HTMLButtonElement. Botón pulsador. Consulte la definición del elemento BUTTON en HTML 4.01"
type: docs

url: /es/java/com.aspose.html/htmlbuttonelement/
---
## HTMLButtonElement class

Botón pulsable. Consulte la definición del elemento BUTTON en HTML 4.01.
...
| [getForm](../../com.aspose.html/htmlbuttonelement/form/) Devuelve el elemento `FORM` que contiene este control. Devuelve `null` si este control no está dentro del contexto de un formulario. |
[getId]
