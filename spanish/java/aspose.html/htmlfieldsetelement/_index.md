---
title: "HTMLFieldSetElement Clase"
second_title: "Referencia de la API de Aspose.HTML para Java"
description: "com.aspose.html.HTMLFieldSetElement clase. Organiza los controles de formulario en grupos lógicos. Consulte la definición del elemento FIELDSET en HTML 4.01"
type: docs

url: /es/java/com.aspose.html/htmlfieldsetelement/
---
## HTMLFieldSetElement class

Organiza los controles de formulario en grupos lógicos. Vea la definición del elemento FIELDSET en HTML 4.01.
...
| [getForm](../../com.aspose.html/htmlfieldsetelement/form/) Devuelve el elemento `FORM` que contiene este control. Devuelve `null` si este control no está dentro del contexto de un formulario. |
[getId]
