...
description: "com.aspose.html.HTMLAnchorElement class. El elemento de ancla. Consulte la definición del elemento A en HTML 4.01"
type: docs
...
El elemento anchor. Consulte la definición del elemento A en HTML 4.01.
...
| [getRelList](../../com.aspose.html/htmlanchorelement/rellist/) Devuelve un DOMTokenList en vivo que contiene los tokens obtenidos al analizar el atributo "rel". |
[getRev]
