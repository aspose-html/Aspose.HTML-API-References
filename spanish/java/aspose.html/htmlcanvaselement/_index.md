...
La interfaz HTMLCanvasElement proporciona propiedades y métodos para manipular el diseño y la presentación de los elementos canvas. La interfaz HTMLCanvasElement también hereda las propiedades y métodos de la interfaz HTMLElement.
...
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl)() | devuelve un URI de datos que contiene una representación de la imagen en el formato especificado por el parámetro type (por defecto PNG). La imagen devuelta tiene una resolución de 96 ppp. |
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl_1)(String) | devuelve un URI de datos que contiene una representación de la imagen en el formato especificado por el parámetro type (por defecto PNG). La imagen devuelta tiene una resolución de 96 ppp. |
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl_2)(String, double) | devuelve un URI de datos que contiene una representación de la imagen en el formato especificado por el parámetro type (por defecto PNG). La imagen devuelta tiene una resolución de 96 ppp. |
