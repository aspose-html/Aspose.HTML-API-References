---
title: "Clase HTMLCanvasElement"
second_title: "Referencia de la API de Aspose.HTML para Java"
description: "Clase com.aspose.html.HTMLCanvasElement. La interfaz HTMLCanvasElement proporciona propiedades y métodos para manipular el diseño y la presentación de los elementos canvas. La interfaz HTMLCanvasElement también hereda las propiedades y métodos de la interfaz HTMLElement"
type: docs

url: /es/java/com.aspose.html/htmlcanvaselement/
---
## HTMLCanvasElement class

El interfaz HTMLCanvasElement proporciona propiedades y métodos para manipular el diseño y la presentación de los elementos canvas. El interfaz HTMLCanvasElement también hereda las propiedades y métodos del interfaz HTMLElement.
...
| [getContext](../../com.aspose.html/htmlcanvaselement/getcontext/)(String) | Devuelve un contexto de dibujo en el canvas, o null si el ID de contexto no es compatible. Un contexto de dibujo le permite dibujar en el canvas. |
...
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl)() | devuelve una URI de datos que contiene una representación de la imagen en el formato especificado por el parámetro type (por defecto PNG). La imagen devuelta tiene una resolución de 96 dpi. |
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl_1)(String) | devuelve una URI de datos que contiene una representación de la imagen en el formato especificado por el parámetro type (por defecto PNG). La imagen devuelta tiene una resolución de 96 dpi. |
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl_2)(String, double) | devuelve una URI de datos que contiene una representación de la imagen en el formato especificado por el parámetro type (por defecto PNG). La imagen devuelta tiene una resolución de 96 dpi. |
