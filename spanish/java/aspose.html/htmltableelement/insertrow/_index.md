...
| --- | --- | --- |
| index | Int32 | El número de fila donde insertar una nueva fila. Este índice comienza en 0 y es relativo al orden lógico (no al orden del documento) de todas las filas contenidas en la tabla. |
...
| excepción | condición |
| --- | --- |
| [dOMException](../../../com.aspose.html.dom/domexception/) | INDEX_SIZE_ERR: Generado si el índice especificado es mayor que el número de filas o si el índice es un número negativo distinto de -1. @version DOM Level 2 |
