---
title: "Clase HTMLTableElement"
second_title: "Referencia de la API de Aspose.HTML para Java"
description: "Clase com.aspose.html.HTMLTableElement. Los métodos crear y eliminar en la tabla permiten a los autores construir y modificar tablas. HTML 4.01 especifica que solo puede existir uno de cada uno de los elementos CAPTION, THEAD y TFOOT en una tabla. Por lo tanto, si existe uno y se llama al método createTHead o createTFoot, el método devuelve el elemento THead o TFoot existente. Consulte la definición del elemento TABLE en HTML 4.01."
type: docs

url: /es/java/com.aspose.html/htmltableelement/
---
...
| [getCaption](../../com.aspose.html/htmltableelement/caption/) Devuelve el `CAPTION` de la tabla, o void si no existe. @version DOM Level 2 |
[getCellPadding]
...
| [getRows](../../com.aspose.html/htmltableelement/rows/) Devuelve el `TFOOT` de la tabla, o `null` si no existe. |
[getRules]
...
| [getTBodies](../../com.aspose.html/htmltableelement/tbodies/) Devuelve una colección de los cuerpos de la tabla (incluyendo los implícitos). |
...
| [getTFoot](../../com.aspose.html/htmltableelement/tfoot/) Devuelve el `THEAD` de la tabla, o `null` si no existe. |
| [getTHead](../../com.aspose.html/htmltableelement/thead/) Devuelve el `CAPTION` de la tabla, o void si no existe. |
[getTitle]
...
| [createCaption](../../com.aspose.html/htmltableelement/createcaption/)() | Crea un nuevo objeto de caption de tabla o devuelve uno existente. |
| [createTFoot](../../com.aspose.html/htmltableelement/createtfoot/)() | Crea una fila de pie de tabla o devuelve una existente. |
| [createTHead](../../com.aspose.html/htmltableelement/createthead/)() | Crea una fila de encabezado de tabla o devuelve una existente. |
| [deleteCaption](../../com.aspose.html/htmltableelement/deletecaption/)() | Elimina el caption de la tabla, si existe. |
| [deleteRow](../../com.aspose.html/htmltableelement/deleterow/)(int) | Elimina una fila de tabla. |
| [deleteTFoot](../../com.aspose.html/htmltableelement/deletetfoot/)() | Elimina el pie de la tabla, si existe. |
| [deleteTHead](../../com.aspose.html/htmltableelement/deletethead/)() | Elimina el encabezado de la tabla, si existe. |
