---
title: "Clase HTMLBodyElement"
second_title: "Referencia de la API de Aspose.HTML para Java"
description: "Clase com.aspose.html.HTMLBodyElement. El cuerpo del documento HTML. Este elemento siempre está presente en la API DOM incluso si las etiquetas no están presentes en el documento fuente. Consulte la definición del elemento BODY en HTML 4.01"
type: docs

url: /es/java/com.aspose.html/htmlbodyelement/
---
## HTMLBodyElement class

El cuerpo del documento HTML. Este elemento siempre está presente en la API DOM, incluso si las etiquetas no están presentes en el documento fuente. Consulte la definición del elemento BODY en HTML 4.01.
