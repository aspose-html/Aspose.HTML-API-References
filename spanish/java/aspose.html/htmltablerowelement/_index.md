---
title: "Clase HTMLTableRowElement"
second_title: "Referencia de la API de Aspose.HTML para Java"
description: "Clase com.aspose.html.HTMLTableRowElement. Una fila en una tabla. Consulte la definición del elemento TR en HTML 4.01"
type: docs

url: /es/java/com.aspose.html/htmltablerowelement/
---
## HTMLTableRowElement class

Una fila en una tabla. Consulte la definición del elemento TR en HTML 4.01.
...
| [getCells](../../com.aspose.html/htmltablerowelement/cells/) La colección de celdas en esta fila. @version DOM Level 2 |
[getCh]
...
| [getRowIndex](../../com.aspose.html/htmltablerowelement/rowindex/) Esto está en orden lógico y no en orden de documento. El `rowIndex` tiene en cuenta las secciones (`THEAD`, `TFOOT`, o `TBODY`) dentro de la tabla, colocando primero las filas `THEAD` en el índice, seguidas de las filas `TBODY`, y luego las filas `TFOOT`. @version DOM Level 2 |
| [getSectionRowIndex](../../com.aspose.html/htmltablerowelement/sectionrowindex/) El índice de esta fila, relativo a la sección actual (`THEAD`, `TFOOT` o `TBODY`), comenzando desde 0. @version DOM Level 2 |
...
| [deleteCell](../../com.aspose.html/htmltablerowelement/deletecell/)(int) | Eliminar una celda de la fila actual. |
...
| [insertCell](../../com.aspose.html/htmltablerowelement/insertcell/)(int) | Insertar una celda `TD` vacía en esta fila. Si `index` es -1 o igual al número de celdas, la nueva celda se agrega al final. |
