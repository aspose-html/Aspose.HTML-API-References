...
| excepción | condición |
| --- | --- |
| [dOMException](../../../com.aspose.html.dom/domexception/) | INDEX_SIZE_ERR: Se genera si el `index` especificado es mayor que el número de celdas o si el índice es un número negativo distinto de -1. @version DOM Level 2 |
