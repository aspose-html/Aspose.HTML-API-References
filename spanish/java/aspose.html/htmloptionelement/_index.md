---
title: "Clase HTMLOptionElement"
second_title: "Referencia de la API de Aspose.HTML para Java"
description: "com.aspose.html.HTMLOptionElement clase. Una opción seleccionable. Consulte la definición del elemento OPTION en HTML 4.01"
type: docs

url: /es/java/com.aspose.html/htmloptionelement/
---
## HTMLOptionElement class

Una opción seleccionable. Consulte la definición del elemento OPTION en HTML 4.01.
...
| [getForm](../../com.aspose.html/htmloptionelement/form/) Devuelve el elemento `FORM` que contiene este control. Devuelve `null` si este control no está dentro del contexto de un formulario. |
[getId]
[setId] The element's identifier. See the id attribute definition in HTML 4.01. |
| [getIndex](../../com.aspose.html/htmloptionelement/index/) El índice de este `OPTION` en su elemento padre `SELECT`, comenzando desde 0. @version DOM Level 2 |
[getInnerHTML]
...
| [getText](../../com.aspose.html/htmloptionelement/text/) El texto contenido dentro del elemento de opción. |
