---
title: "HTMLTextAreaElement Clase"
second_title: "Referencia de la API de Aspose.HTML para Java"
description: "com.aspose.html.HTMLTextAreaElement clase. Campo de texto multilínea. Consulte la definición del elemento TEXTAREA en HTML 4.01"
type: docs

url: /es/java/com.aspose.html/htmltextareaelement/
---
## HTMLTextAreaElement class

Campo de texto multilínea. Consulte la definición del elemento TEXTAREA en HTML 4.01.
...
| [getForm](../../com.aspose.html/htmltextareaelement/form/) Devuelve el elemento `FORM` que contiene este control. Devuelve `null` si este control no está dentro del contexto de un formulario. |
[getId]
...
| [getType](../../com.aspose.html/htmltextareaelement/type/) El tipo de este control de formulario. Es la cadena "textarea". |
[getValue]
