...
description: "método de HTMLTableSectionElement. Insertar una fila en esta sección. La nueva fila se inserta inmediatamente antes de la fila actual de índice en esta sección. Si el índice es -1 o igual al número de filas en esta sección, la nueva fila se agrega al final"
type: docs
...
Insertar una fila en esta sección. La nueva fila se inserta inmediatamente antes de la fila actual número `index` en esta sección. Si `index` es -1 o igual al número de filas en esta sección, la nueva fila se agrega al final.
