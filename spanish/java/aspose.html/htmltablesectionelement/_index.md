...
description: "Clase com.aspose.html.HTMLTableSectionElement. Los elementos THEAD, TFOOT y TBODY"
type: docs
...
| [deleteRow](../../com.aspose.html/htmltablesectionelement/deleterow/)(int) | Elimina una fila de esta sección. |
...
| [insertRow](../../com.aspose.html/htmltablesectionelement/insertrow/)(int) | Inserta una fila en esta sección. La nueva fila se inserta inmediatamente antes de la fila actual número `index` en esta sección. Si `index` es -1 o igual al número de filas en esta sección, la nueva fila se agrega al final. |
