...
Crea un marco. Vea la definición del elemento FRAME en HTML 4.01.
...
| [getContentDocument](../../com.aspose.html/htmlframeelement/contentdocument/) El documento que este marco contiene, si hay alguno y está disponible, o `null` de lo contrario. @since DOM Level 2 |
[getDir]
