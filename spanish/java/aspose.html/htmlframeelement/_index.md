---
title: "Clase HTMLFrameElement"
second_title: "Referencia de la API de Aspose.HTML para Java"
description: "Clase com.aspose.html.HTMLFrameElement. Crea un marco. Consulte la definición del elemento FRAME en HTML 4.01"
type: docs

url: /es/java/com.aspose.html/htmlframeelement/
---
## HTMLFrameElement class

Crea un marco. Consulte la definición del elemento FRAME en HTML 4.01.
...
| [getContentDocument](../../com.aspose.html/htmlframeelement/contentdocument/) El documento que contiene este marco, si existe y está disponible, o `null` en caso contrario. @since DOM Level 2 |
[getDir]
