---
title: "Clase HTMLAreaElement"
second_title: "Referencia de la API de Aspose.HTML para Java"
description: "Clase com.aspose.html.HTMLAreaElement. Definición de área de mapa de imagen del lado del cliente. Consulte la definición del elemento AREA en HTML 4.01"
type: docs

url: /es/java/com.aspose.html/htmlareaelement/
---
## HTMLAreaElement class

Definición de área de mapa de imagen del lado del cliente. Consulte la definición del elemento AREA en HTML 4.01.
...
| [getRelList](../../com.aspose.html/htmlareaelement/rellist/) Devuelve una DOMTokenList en vivo que contiene los tokens obtenidos al analizar el atributo "rel". |
