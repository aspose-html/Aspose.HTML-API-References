---
title: "Clase HTMLSelectElement"
second_title: "Referencia de la API de Aspose.HTML para Java"
description: "Clase com.aspose.html.HTMLSelectElement. El elemento select permite la selección de una opción. Las opciones contenidas pueden ser accedidas directamente a través del elemento select como una colección. Consulte la definición del elemento SELECT en HTML 4.01"
type: docs

url: /es/java/com.aspose.html/htmlselectelement/
---
## HTMLSelectElement class

El elemento select permite la selección de una opción. Las opciones contenidas pueden accederse directamente a través del elemento select como una colección. Consulte la definición del elemento SELECT en HTML 4.01.
...
| [getForm](../../com.aspose.html/htmlselectelement/form/) El número de opciones en este `SELECT`. |
[getId]
...
| [getOptions](../../com.aspose.html/htmlselectelement/options/) La colección de elementos `OPTION` contenidos por este elemento. @version DOM Level 2 |
[getOuterHTML]
...
| [getType](../../com.aspose.html/htmlselectelement/type/) El tipo de este control de formulario. Es la cadena "select-multiple" cuando el atributo multiple es `true` y la cadena "select-one" cuando es `false`. |
[getValue]
