---
title: "Clase HTMLTableCellElement"
second_title: "Referencia de la API de Aspose.HTML para Java"
description: "com.aspose.html.HTMLTableCellElement class. El objeto usado para representar los elementos TH y TD. Consulte la definición del elemento TD en HTML 4.01"
type: docs

url: /es/java/com.aspose.html/htmltablecellelement/
---
## HTMLTableCellElement class

El objeto usado para representar los elementos `TH` y `TD`. Consulte la definición del elemento TD en HTML 4.01.
...
| [getCellIndex](../../com.aspose.html/htmltablecellelement/cellindex/) El índice de esta celda en la fila, comenzando desde 0. Este índice está en el orden del árbol del documento y no en el orden de visualización. |
[getCh]
