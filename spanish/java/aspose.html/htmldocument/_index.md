---
title: "Clase HTMLDocument"
second_title: "Referencia de la API de Aspose.HTML para Java"
description: "Clase com.aspose.html.HTMLDocument. Representa un documento HTML. Todos los objetos HTML de nivel superior se añaden a este objeto. Esta clase representa la página HTML tal como la vemos en el navegador. Todos los formularios, tablas, scripts... se añaden a la página HTML a través de las interfaces de esta clase. HTMLDocument es la implementación HTML de la interfaz Document más general y ambas son el núcleo o punto raíz del DOM - Document Object Model. Estos conceptos están en plena conformidad con los fundamentos y estándares oficiales del desarrollo web. A efectos del desarrollo web, puede considerar HTMLDocument como un alias de Document del cual HTMLDocument se basa."
type: docs

url: /es/java/com.aspose.html/htmldocument/
---
## HTMLDocument class

Representa un documento HTML. Todos los objetos HTML de nivel superior se añaden a este objeto. Esta clase representa la página HTML tal como la vemos en el navegador. Todos los formularios, tablas, scripts, ... se añaden a la página HTML a través de las interfaces de esta clase. [HTMLDocument](https://dom.spec.whatwg.org/#ref-for-dom-domimplementation-createhtmldocument) es la implementación html del interfaz más general [Document](https://dom.spec.whatwg.org/#document) y ambos son el punto central o raíz del [DOM](https://dom.spec.whatwg.org/) - Document Object Model. Estos conceptos están en total conformidad con la base oficial de desarrollo web o estándares. Para los propósitos del desarrollo web, generalmente puede pensar en HTMLDocument como un alias de Document, sobre el cual se basa HTMLDocument.
...
| Nombre | Descripción |
| --- | --- |
| [HTMLDocument](htmldocument/#constructor)() | El constructor HTMLDocument crea un nuevo objeto HTML Document que es una página web cargada en el navegador y que sirve como punto de entrada al contenido de la página. |
| [HTMLDocument](htmldocument/#constructor_1)(Configuration) | El constructor HTMLDocument crea un nuevo objeto HTML Document que es una página web cargada en el navegador y que sirve como punto de entrada al contenido de la página. |
| [HTMLDocument](htmldocument/#constructor_2)(RequestMessage) | Crea un documento HTML a partir del objeto [`RequestMessage`](../../com.aspose.html.net/requestmessage/). |
| [HTMLDocument](htmldocument/#constructor_10)(String) | Carga el documento HTML desde una dirección. |
| [HTMLDocument](htmldocument/#constructor_4)(Url) | Carga el documento HTML desde una URL. |
| [HTMLDocument](htmldocument/#constructor_3)(RequestMessage, Configuration) | Crea un documento HTML a partir del objeto [RequestMessage](T:com.aspose.html.net.RequestMessage). |
| [HTMLDocument](htmldocument/#constructor_8)(Stream, String) | Crea un documento HTML a partir de un contenido de [Stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream) con la base-uri especificada que se utiliza para resolver la ruta de los recursos relativos. |
| [HTMLDocument](htmldocument/#constructor_6)(Stream, Url) | Crea un documento HTML a partir de un contenido de [Stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream) con la base-uri especificada que se utiliza para resolver la ruta de los recursos relativos. |
| [HTMLDocument](htmldocument/#constructor_11)(String, Configuration) | Carga el documento HTML desde una dirección con la configuración de entorno especificada. |
| [HTMLDocument](htmldocument/#constructor_14)(String, String) | Crea un documento HTML a partir de un contenido de cadena (String) con la base-uri especificada. |
| [HTMLDocument](htmldocument/#constructor_12)(String, Url) | Crea un documento HTML a partir de un contenido de cadena (String) con la base-uri especificada. |
| [HTMLDocument](htmldocument/#constructor_5)(Url, Configuration) | Carga el documento HTML desde una URL con la configuración de entorno especificada. |
| [HTMLDocument](htmldocument/#constructor_9)(Stream, String, Configuration) | Crea un documento HTML a partir de un contenido de [Stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream) con la base-uri y la configuración de entorno especificadas. |
| [HTMLDocument](htmldocument/#constructor_7)(Stream, Url, Configuration) | Crea un documento HTML a partir de un contenido de [Stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream) con la base-uri y la configuración de entorno especificadas. |
| [HTMLDocument](htmldocument/#constructor_15)(String, String, Configuration) | Crea un documento HTML a partir de un contenido de cadena (String) con la base-uri y la configuración de entorno especificadas. |
| [HTMLDocument](htmldocument/#constructor_13)(String, Url, Configuration) | Crea un documento HTML a partir de un contenido de cadena (String) con la base-uri y la configuración de entorno especificadas. |

## Propiedades

| Nombre | Descripción |
| --- | --- |
| [getAnchors](../../com.aspose.html/htmldocument/anchors/) Una colección de todos los elementos de ancla (`A`) en un documento que tienen un valor para el atributo `name`. Por razones de compatibilidad hacia atrás, el conjunto devuelto de anclas solo contiene aquellas creadas con el atributo `name`, no las creadas con el atributo `id`. Tenga en cuenta que en [[XHTML 1.0](http://www.w3.org/TR/2002/REC-xhtml1-20020801)], el atributo `name` (ver sección 4.10) no tiene semántica y solo está presente para agentes de usuario heredados: en su lugar se utiliza el atributo `id`. Los usuarios deberían preferir los mecanismos de iteración proporcionados por [[DOM Level 2 Traversal](http://www.w3.org/TR/2000/REC-DOM-Level-2-Traversal-Range-20001113)] en su lugar. |
| [getApplets](../../com.aspose.html/htmldocument/applets/) Una colección de todos los elementos `OBJECT` que incluyen applets y elementos `APPLET` (obsoletos) en un documento. |
| [getBaseURI](../../com.aspose.html.dom/document/baseuri/) El URI base absoluto de este nodo o nulo si la implementación no pudo obtener un URI absoluto. |
[getBody]
...
| [getDocumentElement](../../com.aspose.html.dom/document/documentelement/) Este es un atributo de conveniencia que permite el acceso directo al nodo hijo que es el document element del documento. |
...
| [getDomain](../../com.aspose.html/htmldocument/domain/) El nombre de dominio del servidor que entregó el documento, o `null` si el servidor no puede ser identificado por un nombre de dominio. |
...
| [getForms](../../com.aspose.html/htmldocument/forms/) Una colección de todos los formularios de un documento. |
| [getImages](../../com.aspose.html/htmldocument/images/) Una colección de todos los elementos `IMG` en un documento. El comportamiento se limita a los elementos `IMG` por compatibilidad hacia atrás. Según lo sugerido por [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224)], para incluir imágenes, los autores pueden usar el elemento `OBJECT` o el elemento `IMG`. Por lo tanto, se recomienda no usar este atributo para encontrar imágenes en el documento, sino utilizar `getElementsByTagName` con HTML 4.01 o `getElementsByTagNameNS` con XHTML 1.0. |
...
| [getLinks](../../com.aspose.html/htmldocument/links/) Una colección de todos los elementos `AREA` y de ancla (`A`) en un documento que tienen un valor para el atributo `href`. |
| [getLocalName](../../com.aspose.html.dom/node/localname/) Devuelve la parte local del nombre calificado de este nodo. Para nodos de cualquier tipo que no sean [`ELEMENT_NODE`](../../com.aspose.html.dom/node/element_node/) y [`ATTRIBUTE_NODE`](../../com.aspose.html.dom/node/attribute_node/) y nodos creados con un método de DOM Level 1, como [`Document.createElement()`](../../com.aspose.html.dom/document/createelement/), esto siempre es null. |
...
| [getNodeName](../../com.aspose.html.dom/document/nodename/) El nombre de este nodo, dependiendo de su tipo. |
...
| [getReadyState](../../com.aspose.html.dom/document/readystate/) Devuelve el estado de preparación del documento. "loading" mientras el Document se está cargando, "interactive" una vez que ha terminado de analizar pero aún carga subrecursos, y "complete" una vez que se ha cargado. |
| [getReferrer](../../com.aspose.html/htmldocument/referrer/) Devuelve el URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt)] de la página que enlazó a esta página. El valor es una cadena vacía si el usuario navegó a la página directamente (no a través de un enlace, sino, por ejemplo, mediante un marcador). |
...
| [textContent](../../com.aspose.html.dom/node/textcontent/) { get; set; } | La propiedad textContent de la interfaz [`Node`](../../com.aspose.html.dom/node/) representa el contenido de texto del nodo y sus descendientes. |
[getTitle]
...
| [createAttribute](../../com.aspose.html.dom/document/createattribute/)(String) | El método Document.createAttribute() crea un nuevo nodo de atributo y lo devuelve. El objeto crea un nodo que implementa la interfaz [`Attr`](../../com.aspose.html.dom/attr/). El DOM no impone qué tipo de atributos pueden añadirse a un elemento particular de esta manera. |
| [createAttributeNS](../../com.aspose.html.dom/document/createattributens/)(String, String) | El método Document.createAttribute() crea un nuevo nodo de atributo y lo devuelve. El objeto crea un nodo que implementa la interfaz [Attr](T:com.aspose.html.dom.Attr). El DOM no impone qué tipo de atributos pueden añadirse a un elemento particular de esta manera. |
| [createCDATASection](../../com.aspose.html.dom/document/createcdatasection/)(String) | Crea un nodo [`CDATASection`](../../com.aspose.html.dom/cdatasection/) cuyo valor es la cadena especificada. |
| [createComment](../../com.aspose.html.dom/document/createcomment/)(String) | Crea un nodo [`Comment`](../../com.aspose.html.dom/comment/) a partir de la cadena especificada. |
| [createDocumentFragment](../../com.aspose.html.dom/document/createdocumentfragment/)() | Crea un nuevo [`DocumentFragment`](../../com.aspose.html.dom/documentfragment/) vacío en el que se pueden añadir nodos DOM para construir un árbol DOM fuera de pantalla. |
| [createDocumentType](../../com.aspose.html.dom/document/createdocumenttype/)(String, String, String, String) | El método devuelve un objeto [`DocumentType`](../../com.aspose.html.dom/documenttype/) que puede usarse con DOMImplementation.createDocument al crear el documento o insertarse en el documento mediante métodos como Node.insertBefore() o Node.replaceChild(). |
| [createElement](../../com.aspose.html.dom/document/createelement/)(String) | En un documento HTML, el método document.createElement() crea el elemento HTML especificado por tagName, o un [`HTMLUnknownElement`](../htmlunknownelement/) si tagName no es reconocido. |
| [createElementNS](../../com.aspose.html.dom/document/createelementns/)(String, String) | Crea un elemento con el nombre calificado y el URI del paquete especificados. |
...
| [createNodeIterator](../../com.aspose.html.dom/document/createnodeiterator/)(Node) | Crea un nuevo NodeIterator sobre el subárbol cuya raíz es el nodo especificado. |
| [createNodeIterator](../../com.aspose.html.dom/document/createnodeiterator/)(Node, long) | Crea un nuevo NodeIterator sobre el subárbol cuya raíz es el nodo especificado. |
| [createNodeIterator](../../com.aspose.html.dom/document/createnodeiterator/)(Node, long, INodeFilter) | Crea un nuevo NodeIterator sobre el subárbol cuya raíz es el nodo especificado. |
...
| [createProcessingInstruction](../../com.aspose.html.dom/document/createprocessinginstruction/)(String, String) | Crea un nodo ProcessingInstruction a partir de los nombres y datos especificados. |
| [createTextNode](../../com.aspose.html.dom/document/createtextnode/)(String) | Crea un nodo Text a partir de la cadena especificada. |
| [createTreeWalker](../../com.aspose.html.dom/document/createtreewalker/)(Node) | Crea un nuevo TreeWalker sobre el subárbol cuya raíz es el nodo especificado. |
| [createTreeWalker](../../com.aspose.html.dom/document/createtreewalker/)(Node, long) | Crea un nuevo TreeWalker sobre el subárbol cuya raíz es el nodo especificado. |
| [createTreeWalker](../../com.aspose.html.dom/document/createtreewalker/)(Node, long, INodeFilter) | Crea un nuevo TreeWalker sobre el subárbol cuya raíz es el nodo especificado. |
...
| [getElementById](../../com.aspose.html.dom/document/getelementbyid/)(String) | El método getElementById() del Document devuelve un objeto [`Element`](../../com.aspose.html.dom/element/) que representa el elemento cuya propiedad id coincide con la cadena especificada. Dado que los IDs de los elementos deben ser únicos si se especifican, son una forma útil de acceder rápidamente a un elemento específico. |
| [getElementsByClassName](../../com.aspose.html.dom/document/getelementsbyclassname/)(String) | El método getElementsByClassName de la interfaz [`Document`](../../com.aspose.html.dom/document/) devuelve un objeto similar a una matriz con todos los elementos hijos que tienen todos los nombres de clase proporcionados. |
| [getElementsByTagName](../../com.aspose.html.dom/document/getelementsbytagname/)(String) | El método getElementsByTagName de la interfaz [`Document`](../../com.aspose.html.dom/document/) devuelve una [`HTMLCollection`](../../com.aspose.html.collections/htmlcollection/) de elementos con el nombre de etiqueta especificado. |
| [getElementsByTagNameNS](../../com.aspose.html.dom/document/getelementsbytagnamens/)(String, String) | Devuelve una lista de elementos con el nombre de etiqueta especificado que pertenecen al paquete indicado. Se busca en todo el documento, incluido el nodo raíz. |
| [getOverrideStyle](../../com.aspose.html/htmldocument/getoverridestyle/)(Element, String) | Este método se usa para recuperar la declaración de estilo de sobrescritura para un elemento especificado y un pseudo‑elemento especificado. |
...
| [navigate](../../com.aspose.html.dom/document/navigate/)(RequestMessage) | Carga el documento según el objeto de solicitud especificado, reemplazando el contenido anterior. |
| [navigate](../../com.aspose.html.dom/document/navigate/)(String) | Carga el documento en la Uniform Resource Locator (URL) especificada en la instancia actual, reemplazando el contenido anterior. |
| [navigate](../../com.aspose.html.dom/document/navigate/)(Url) | Carga el documento en la Uniform Resource Locator (URL) especificada en la instancia actual, reemplazando el contenido anterior. |
| [navigate](../../com.aspose.html.dom/document/navigate/)(Stream, String) | Carga el documento desde el contenido especificado y usando baseUri para resolver recursos relativos, reemplazando el contenido anterior. La carga del documento comienza desde la posición actual en el flujo. |
| [navigate](../../com.aspose.html.dom/document/navigate/)(Stream, Url) | Carga el documento desde el contenido especificado y usando baseUri para resolver recursos relativos, reemplazando el contenido anterior. La carga del documento comienza desde la posición actual en el flujo. |
| [navigate](../../com.aspose.html.dom/document/navigate/)(String, String) | Carga el documento desde el contenido especificado y usando baseUri para resolver recursos relativos, reemplazando el contenido anterior. |
| [navigate](../../com.aspose.html.dom/document/navigate/)(String, Url) | Carga el documento desde el contenido especificado y usando baseUri para resolver recursos relativos, reemplazando el contenido anterior. |
...
| [renderTo](../../com.aspose.html/htmldocument/renderto/)(IDevice) | Este método se utiliza para imprimir el contenido del documento actual en el dispositivo especificado. |
...
| [save](../../com.aspose.html/htmldocument/save/#save)(ResourceHandler) | Guarda el contenido y los recursos del documento usando el [`ResourceHandler`](../../com.aspose.html.saving.resourcehandlers/resourcehandler/). |
| [save](../../com.aspose.html/htmldocument/save/#save_10)(String) | Guarda el documento en un archivo local especificado por la ruta. Todos los recursos utilizados en este documento se guardarán en una carpeta adyacente, cuyo nombre se construirá como: nombre_del_archivo_de_salida + "_files". |
| [save](../../com.aspose.html/htmldocument/save/#save_5)(Url) | Guarda el documento en un archivo local especificado por url. Todos los recursos utilizados en este documento se guardarán en una carpeta adyacente, cuyo nombre se construirá como output_file_name + "_files". |
| [save](../../com.aspose.html/htmldocument/save/#save_1)(ResourceHandler, HTMLSaveFormat) | Guarda el contenido y los recursos del documento usando el [`ResourceHandler`](../../com.aspose.html.saving.resourcehandlers/resourcehandler/). |
| [save](../../com.aspose.html/htmldocument/save/#save_2)(ResourceHandler, HTMLSaveOptions) | Guarda el contenido y los recursos del documento usando el [`ResourceHandler`](../../com.aspose.html.saving.resourcehandlers/resourcehandler/). |
| [save](../../com.aspose.html/htmldocument/save/#save_3)(ResourceHandler, MarkdownSaveOptions) | Guarda el contenido y los recursos del documento usando el [`ResourceHandler`](../../com.aspose.html.saving.resourcehandlers/resourcehandler/). |
| [save](../../com.aspose.html/htmldocument/save/#save_4)(ResourceHandler, MHTMLSaveOptions) | Guarda el contenido y los recursos del documento usando el [`ResourceHandler`](../../com.aspose.html.saving.resourcehandlers/resourcehandler/). |
| [save](../../com.aspose.html/htmldocument/save/#save_11)(String, HTMLSaveFormat) | Guarda el documento en un archivo local especificado por path. Todos los recursos utilizados en este documento se guardarán en una carpeta adyacente, cuyo nombre se construirá como output_file_name + "_files". |
| [save](../../com.aspose.html/htmldocument/save/#save_12)(String, HTMLSaveOptions) | Guarda el documento en un archivo local especificado por la ruta. Todos los recursos utilizados en este documento se guardarán en una carpeta adyacente, cuyo nombre se construirá como: nombre_del_archivo_de_salida + "_files". |
| [save](../../com.aspose.html/htmldocument/save/#save_13)(String, MarkdownSaveOptions) | Guarda el documento en un archivo local especificado por la ruta. Todos los recursos utilizados en este documento se guardarán en una carpeta adyacente, cuyo nombre se construirá como: nombre_del_archivo_de_salida + "_files". |
| [save](../../com.aspose.html/htmldocument/save/#save_14)(String, MHTMLSaveOptions) | Guarda el documento en un archivo local especificado por la ruta. Todos los recursos utilizados en este documento se guardarán en una carpeta adyacente, cuyo nombre se construirá como: nombre_del_archivo_de_salida + "_files". |
| [save](../../com.aspose.html/htmldocument/save/#save_6)(Url, HTMLSaveFormat) | Guarda el documento en un archivo local especificado por url. Todos los recursos utilizados en este documento se guardarán en una carpeta adyacente, cuyo nombre se construirá como output_file_name + "_files". |
| [save](../../com.aspose.html/htmldocument/save/#save_7)(Url, HTMLSaveOptions) | Guarda el documento en un archivo local especificado por url. Todos los recursos utilizados en este documento se guardarán en una carpeta adyacente, cuyo nombre se construirá como: output_file_name + "_files". |
| [save](../../com.aspose.html/htmldocument/save/#save_8)(Url, MarkdownSaveOptions) | Guarda el documento en un archivo local especificado por url. Todos los recursos utilizados en este documento se guardarán en una carpeta adyacente, cuyo nombre se construirá como: output_file_name + "_files". |
| [save](../../com.aspose.html/htmldocument/save/#save_9)(Url, MHTMLSaveOptions) | Guarda el documento en un archivo local especificado por url. Todos los recursos utilizados en este documento se guardarán en una carpeta adyacente, cuyo nombre se construirá como: output_file_name + "_files". |
| [toString](../../com.aspose.html.dom/node/toString/)() | Devuelve una cadena que representa esta instancia. |
| [write](../../com.aspose.html.dom/document/write/)(params String[]) | Escribe una cadena de texto en un flujo de documento abierto con open(). Tenga en cuenta que la función producirá un documento que no está necesariamente controlado por un DTD y, por lo tanto, podría generar un resultado inválido en el contexto del documento. |
...
Más información sobre HTMLDocument, Document y DOM se puede obtener en recursos populares de desarrollo web:
...
```java
    // Crea una instancia de un documento HTML
	using (var document = new HTMLDocument())
      {
        // Crea un elemento style y asigna el color verde a todos los elementos con class-name igual a 'gr'.
        var style = document.CreateElement("style");
        style.TextContent = ".gr { color: green }";

        // Encuentra el elemento header del documento y agrega el elemento style al encabezado
        var head = document.GetElementsByTagName("head").First();
        head.AppendChild(style);

        // Crea un elemento párrafo con class-name 'gr'.
        ...
        // Agrega el párrafo al elemento body del documento
        document.Body.AppendChild(p);

        // Guarda el documento HTML en un archivo 
        document.Save(Path.Combine(OutputDir, "using-dom.html"));

        // Crea una instancia del dispositivo de salida PDF y renderiza el documento en este dispositivo
