...
Representa un documento HTML. Todos los objetos HTML de nivel superior se añaden a este objeto. Esta clase representa la página HTML tal como la vemos en el navegador. Todos los formularios, tablas, scripts, ... se añaden a la página HTML a través de las interfaces de esta clase. [HTMLDocument](https://dom.spec.whatwg.org/#ref-for-dom-domimplementation-createhtmldocument) es la implementación HTML de la interfaz [Document](https://dom.spec.whatwg.org/#document) más general y ambas son el punto central o raíz del [DOM](https://dom.spec.whatwg.org/) - Document Object Model. Estos conceptos están en total conformidad con la base o los estándares oficiales de desarrollo web. A efectos del desarrollo web, puede considerar generalmente a HTMLDocument como un alias de Document, sobre el cual se basa HTMLDocument.
...
| Nombre | Descripción |
| --- | --- |
| [HTMLDocument](htmldocument/#constructor)() | El constructor de HTMLDocument crea un nuevo objeto HTML Document que es una página web cargada en el navegador y que sirve como punto de entrada al contenido de la página. |
| [HTMLDocument](htmldocument/#constructor_1)(Configuration) | El constructor de HTMLDocument crea un nuevo objeto HTML Document que es una página web cargada en el navegador y que sirve como punto de entrada al contenido de la página. |
...
| [HTMLDocument](htmldocument/#constructor_8)(Stream, String) | Crea un documento HTML a partir del contenido de un [Stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream) con la base‑uri especificada que se utiliza para resolver la ruta de los recursos relativos. |
| [HTMLDocument](htmldocument/#constructor_6)(Stream, Url) | Crea un documento HTML a partir del contenido de un [Stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream) con la base‑uri especificada que se utiliza para resolver la ruta de los recursos relativos. |
...
| [HTMLDocument](htmldocument/#constructor_14)(String, String) | Crea un documento HTML a partir de un contenido String con la base‑uri especificada. |
| [HTMLDocument](htmldocument/#constructor_12)(String, Url) | Crea un documento HTML a partir de un contenido String con la base‑uri especificada. |
...
| [HTMLDocument](htmldocument/#constructor_9)(Stream, String, Configuration) | Crea un documento HTML a partir del contenido de un [Stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream) con la base‑uri y la configuración de entorno especificadas. |
| [HTMLDocument](htmldocument/#constructor_7)(Stream, Url, Configuration) | Crea un documento HTML a partir del contenido de un [Stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream) con la base‑uri y la configuración de entorno especificadas. |
| [HTMLDocument](htmldocument/#constructor_15)(String, String, Configuration) | Crea un documento HTML a partir de un contenido String con la base‑uri y la configuración de entorno especificadas. |
| [HTMLDocument](htmldocument/#constructor_13)(String, Url, Configuration) | Crea un documento HTML a partir de un contenido String con la base‑uri y la configuración de entorno especificadas. |

## Propiedades

| Nombre | Descripción |
| --- | --- |
| [getAnchors](../../com.aspose.html/htmldocument/anchors/) Una colección de todos los elementos de ancla (`A`) en un documento que tienen un valor para el atributo `name`. Por razones de compatibilidad hacia atrás, el conjunto devuelto de anclas solo contiene aquellas creadas con el atributo `name`, no las creadas con el atributo `id`. Tenga en cuenta que en [[XHTML 1.0](http://www.w3.org/TR/2002/REC-xhtml1-20020801)], el atributo `name` (ver sección 4.10) no tiene semántica y solo está presente para agentes de usuario heredados: se utiliza en su lugar el atributo `id`. Los usuarios deberían preferir los mecanismos de iteración proporcionados por [[DOM Level 2 Traversal](http://www.w3.org/TR/2000/REC-DOM-Level-2-Traversal-Range-20001113)] en su lugar. |
...
| [getLocalName](../../com.aspose.html.dom/node/localname/) Devuelve la parte local del nombre calificado de este nodo. Para nodos de cualquier tipo que no sea [`ELEMENT_NODE`](../../com.aspose.html.dom/node/element_node/) ni [`ATTRIBUTE_NODE`](../../com.aspose.html.dom/node/attribute_node/) y nodos creados con un método de DOM Level 1, como [`Document.createElement()`](../../com.aspose.html.dom/document/createelement/), esto siempre es null. |
...
| [createAttribute](../../com.aspose.html.dom/document/createattribute/)(String) | El método Document.createAttribute() crea un nuevo nodo de atributo y lo devuelve. El objeto creado es un nodo que implementa la interfaz [`Attr`](../../com.aspose.html.dom/attr/). El DOM no impone qué tipo de atributos pueden añadirse a un elemento concreto de esta manera. |
...
| [getElementById](../../com.aspose.html.dom/document/getelementbyid/)(String) | El método Document getElementById() devuelve un objeto [`Element`](../../com.aspose.html.dom/element/) que representa el elemento cuya propiedad id coincide con la cadena especificada. Dado que los IDs de los elementos deben ser únicos si se especifican, son una forma útil de acceder rápidamente a un elemento concreto. |
| [getElementsByClassName](../../com.aspose.html.dom/document/getelementsbyclassname/)(String) | El método getElementsByClassName de la interfaz [`Document`](../../com.aspose.html.dom/document/) devuelve un objeto similar a una matriz con todos los elementos hijos que poseen todos los nombres de clase proporcionados. |
| [getElementsByTagName](../../com.aspose.html.dom/document/getelementsbytagname/)(String) | El método getElementsByTagName de la interfaz [`Document`](../../com.aspose.html.dom/document/) devuelve una [`HTMLCollection`](../../com.aspose.html.collections/htmlcollection/) de elementos con el nombre de etiqueta proporcionado. |
...
| [getOverrideStyle](../../com.aspose.html/htmldocument/getoverridestyle/)(Element, String) | Este método se usa para obtener la declaración de estilo de sobrescritura para un elemento especificado y un pseudo‑elemento especificado. |
...
| [navigate](../../com.aspose.html.dom/document/navigate/)(String) | Carga el documento en el Uniform Resource Locator (URL) especificado en la instancia actual, reemplazando el contenido anterior. |
| [navigate](../../com.aspose.html.dom/document/navigate/)(Url) | Carga el documento en el Uniform Resource Locator (URL) especificado en la instancia actual, reemplazando el contenido anterior. |
| [navigate](../../com.aspose.html.dom/document/navigate/)(Stream, String) | Carga el documento a partir del contenido especificado y usando baseUri para resolver recursos relativos, reemplazando el contenido anterior. La carga del documento comienza desde la posición actual en el flujo. |
| [navigate](../../com.aspose.html.dom/document/navigate/)(Stream, Url) | Carga el documento a partir del contenido especificado y usando baseUri para resolver recursos relativos, reemplazando el contenido anterior. La carga del documento comienza desde la posición actual en el flujo. |
| [navigate](../../com.aspose.html.dom/document/navigate/)(String, String) | Carga el documento a partir del contenido especificado y usando baseUri para resolver recursos relativos, reemplazando el contenido anterior. |
| [navigate](../../com.aspose.html.dom/document/navigate/)(String, Url) | Carga el documento a partir del contenido especificado y usando baseUri para resolver recursos relativos, reemplazando el contenido anterior. |
...
| [save](../../com.aspose.html/htmldocument/save/#save)(ResourceHandler) | Guarda el contenido del documento y los recursos usando el [`ResourceHandler`](../../com.aspose.html.saving.resourcehandlers/resourcehandler/). |
| [save](../../com.aspose.html/htmldocument/save/#save_10)(String) | Guarda el documento en un archivo local especificado por la ruta. Todos los recursos utilizados en este documento se guardarán en una carpeta adyacente, cuyo nombre se construirá como: output_file_name + "_files". |
...
| [save](../../com.aspose.html/htmldocument/save/#save_1)(ResourceHandler, HTMLSaveFormat) | Guarda el contenido del documento y los recursos usando el [`ResourceHandler`](../../com.aspose.html.saving.resourcehandlers/resourcehandler/). |
| [save](../../com.aspose.html/htmldocument/save/#save_2)(ResourceHandler, HTMLSaveOptions) | Guarda el contenido del documento y los recursos usando el [`ResourceHandler`](../../com.aspose.html.saving.resourcehandlers/resourcehandler/). |
| [save](../../com.aspose.html/htmldocument/save/#save_3)(ResourceHandler, MarkdownSaveOptions) | Guarda el contenido del documento y los recursos usando el [`ResourceHandler`](../../com.aspose.html.saving.resourcehandlers/resourcehandler/). |
| [save](../../com.aspose.html/htmldocument/save/#save_4)(ResourceHandler, MHTMLSaveOptions) | Guarda el contenido del documento y los recursos usando el [`ResourceHandler`](../../com.aspose.html.saving.resourcehandlers/resourcehandler/). |
| [save](../../com.aspose.html/htmldocument/save/#save_11)(String, HTMLSaveFormat) | Guarda el documento en un archivo local especificado por ruta. Todos los recursos utilizados en este documento se guardarán en una carpeta adyacente, cuyo nombre se construirá como output_file_name + "_files". |
| [save](../../com.aspose.html/htmldocument/save/#save_12)(String, HTMLSaveOptions) | Guarda el documento en un archivo local especificado por la ruta. Todos los recursos utilizados en este documento se guardarán en una carpeta adyacente, cuyo nombre se construirá como: output_file_name + "_files". |
| [save](../../com.aspose.html/htmldocument/save/#save_13)(String, MarkdownSaveOptions) | Guarda el documento en un archivo local especificado por la ruta. Todos los recursos utilizados en este documento se guardarán en una carpeta adyacente, cuyo nombre se construirá como: output_file_name + "_files". |
| [save](../../com.aspose.html/htmldocument/save/#save_14)(String, MHTMLSaveOptions) | Guarda el documento en un archivo local especificado por la ruta. Todos los recursos utilizados en este documento se guardarán en una carpeta adyacente, cuyo nombre se construirá como: output_file_name + "_files". |
...
```java
	...
	using (var document = new HTMLDocument())
      {
        // Crea un elemento style y asigna el color verde a todos los elementos cuyo class-name sea 'gr'.
        var style = document.CreateElement("style");
        style.TextContent = ".gr { color: green }";

        // Encuentra el elemento header del documento y agrega el elemento style al header
