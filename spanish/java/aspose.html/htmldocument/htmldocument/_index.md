...
El constructor HTMLDocument crea un nuevo objeto HTML Document que es una página web cargada en el navegador y que sirve como punto de entrada al contenido de la página.
...
Una vez creado el objeto documento, se puede rellenar posteriormente con elementos HTML. El siguiente fragmento de código muestra el uso del constructor predeterminado HTMLDocument() para crear un documento HTML vacío y guardarlo en un archivo.
...
| --- | --- | --- |
| configuración | Configuración | La configuración del entorno, como la política de scripts, la hoja de estilo personalizada del usuario, etc. |
...
```java
// Prepara el código HTML y guárdalo en un archivo
...
Nota: En caso de que proporcione una URL incorrecta que no se pueda alcanzar en este momento, la biblioteca lanza la [`DOMException`](../../../com.aspose.html.dom/domexception/) con el código especializado ‘NetworkError’ para informarle que el recurso seleccionado no se puede encontrar.
...
Nota: En caso de que proporcione una URL incorrecta que no se pueda alcanzar en este momento, la biblioteca lanza la [DOMException](T:com.aspose.html.dom.DOMException) con el código especializado ‘NetworkError’ para informarle que el recurso seleccionado no se puede encontrar.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| dirección | String | La dirección del documento HTML a abrir. |
...
Crea un documento HTML a partir de un contenido de cadena (String) con la base-uri especificada.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| contenido | String | El contenido String con el que cargar el documento. |
| baseUri | String | El URI base del documento. |
...
Crea un documento HTML a partir de un contenido de cadena (String) con la base-uri y la configuración de entorno especificadas.
...
Crea un documento HTML a partir de un contenido de [Stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream) con la base-uri especificada que se utiliza para resolver la ruta de los recursos relativos.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| content | Stream | El contenido [Stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream) con el que cargar el documento. |
| baseUri | String | El URI base del documento. |
...
Crea un documento HTML a partir de un contenido de [Stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream) con la base-uri y la configuración de entorno especificadas.
