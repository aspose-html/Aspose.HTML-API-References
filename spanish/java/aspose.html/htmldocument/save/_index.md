...
| --- | --- | --- |
| url | Url | Local [`URL`](../../url/) al archivo de salida. |
...
Guarda el documento en un archivo local especificado por la ruta. Todos los recursos utilizados en este documento se guardarán en una carpeta adyacente, cuyo nombre se construirá como: nombre_del_archivo_de_salida + "_files".
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| ruta | String | Ruta del sistema de archivos local al archivo de salida. |
...
Guarda el documento en un archivo local especificado por path. Todos los recursos utilizados en este documento se guardarán en una carpeta adyacente, cuyo nombre se construirá como output_file_name + "_files".
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| ruta | String | Ruta local del archivo al archivo de salida. |
...
El método Save(String, HTMLSaveFormat) toma como parámetros una ruta del sistema de archivos local para el archivo de salida y saveFormat. La enumeración [`HTMLSaveFormat`](../../../com.aspose.html.saving/htmlsaveformat/) especifica el formato en el que se guarda el documento; puede ser HTML, MHTML y MD. El método guarda el documento HTML en el formato especificado en el archivo local indicado por la ruta. Todos los recursos utilizados en el documento se guardarán en una carpeta adyacente.
...
&lt;div class="custom-class"&gt;Personalizado por contenedor de clase CSS&lt;/div&gt;
...
Método Save(String, MHTMLSaveOptions)

Es necesario especificar una ruta del sistema de archivos local para el archivo de salida al guardar el documento. El constructor MHTMLSaveOptions() inicializa una instancia de la clase [`MHTMLSaveOptions`](../../../com.aspose.html.saving/mhtmlsaveoptions/) que tiene la propiedad ResourceHandlingOptions, la cual se usa para la configuración del manejo de recursos. El método Save(path, saveOptions) recibe como parámetros una ruta del sistema de archivos local para el archivo de salida y una instancia de opciones de guardado, y guarda el HTML como un documento MHTML en el archivo local especificado por la ruta.
