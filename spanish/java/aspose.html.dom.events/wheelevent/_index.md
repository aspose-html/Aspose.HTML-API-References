...
description: "clase com.aspose.html.dom.events.WheelEvent. La interfaz WheelEvent proporciona información contextual específica asociada a eventos de rueda. Para crear una instancia de la interfaz WheelEvent, use el constructor WheelEvent pasando un diccionario opcional WheelEventInit."
type: docs
...
La interfaz WheelEvent proporciona información contextual específica asociada a los eventos de rueda. Para crear una instancia de la interfaz WheelEvent, use el constructor WheelEvent, pasando un diccionario opcional WheelEventInit.
