...
description: "Propiedad Text. Este atributo devuelve el contenido de texto de este nodo y sus descendientes. Cuando se define como nulo, establecerlo no tiene efecto. Al establecerlo, cualquier hijo posible que tenga este nodo se elimina y, si la nueva cadena no está vacía ni es nula, se reemplaza por un único nodo Text que contiene la cadena; este atributo se establece en ella."
type: docs

url: /es/java/com.aspose.html.dom/text/textcontent/
---
