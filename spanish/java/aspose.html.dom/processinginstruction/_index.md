...
La ProcessingInstruction representa una "instrucción de procesamiento", utilizada en XML como una forma de mantener información específica del procesador en el texto del documento.
