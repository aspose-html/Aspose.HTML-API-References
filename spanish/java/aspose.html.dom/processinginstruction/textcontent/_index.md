...
description: "Propiedad ProcessingInstruction. Este atributo devuelve el contenido de texto de este nodo y sus descendientes. Cuando está definido como null, establecerlo no tiene efecto. Al establecerlo, cualquier posible hijo que este nodo pueda tener se elimina y si la nueva cadena no está vacía o es null, se reemplaza por un único nodo de Texto que contiene la cadena; este atributo se establece en"
type: docs

url: /es/java/com.aspose.html.dom/processinginstruction/textcontent/
---
