...
description: "Clase com.aspose.html.dom.Entity. Representa una entidad conocida ya sea analizada o no analizada en un documento XML."
type: docs

url: /es/java/com.aspose.html.dom/entity/
---
## Entity class

Representa una entidad conocida, ya sea analizada o no analizada, en un documento XML.
...
| [getInputEncoding](../../com.aspose.html.dom/entity/inputencoding/) Un atributo que especifica la codificación utilizada para esta entidad en el momento del análisis, cuando es una entidad externa analizada. Es nulo si es una entidad del subconjunto interno o si no se conoce. |
...
| [getNodeName](../../com.aspose.html.dom/entity/nodename/) El nombre de este nodo, según su tipo. |
| [getNodeType](../../com.aspose.html.dom/entity/nodetype/) Un código que representa el tipo del objeto subyacente. |
...
| [getNotationName](../../com.aspose.html.dom/entity/notationname/) Para entidades no analizadas, el nombre de la notación de la entidad. Para entidades analizadas, es nulo. |
...
| [getPublicId](../../com.aspose.html.dom/entity/publicid/) El identificador público asociado a la entidad si se especifica, y nulo en caso contrario. |
| [getSystemId](../../com.aspose.html.dom/entity/systemid/) El identificador del sistema asociado a la entidad si se especifica, y nulo en caso contrario. Puede ser un URI absoluto o no. |
...
| [getXmlEncoding](../../com.aspose.html.dom/entity/xmlencoding/) Un atributo que especifica, como parte de la declaración de texto, la codificación de esta entidad, cuando es una entidad externa analizada. Es nulo en caso contrario. |
| [getXmlVersion](../../com.aspose.html.dom/entity/xmlversion/) Un atributo que especifica, como parte de la declaración de texto, el número de versión de esta entidad, cuando es una entidad externa analizada. Es nulo en caso contrario. |
