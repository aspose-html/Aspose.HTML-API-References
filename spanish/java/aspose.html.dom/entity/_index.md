...
| [getSystemId](../../com.aspose.html.dom/entity/systemid/) El identificador del sistema asociado a la entidad si se especifica, y nulo en caso contrario. Puede ser una URI absoluta o no. |
