...
Devuelve una lista de elementos con el nombre de etiqueta especificado que pertenecen al paquete indicado. Se busca en todo el documento, incluido el nodo raíz.
...
| --- | --- | --- |
| packageURI | String | El URI del paquete de los elementos a buscar. |
| localName | String | Ya sea el nombre local de los elementos a buscar o el valor especial *, que coincide con todos los elementos. |
...
Consulte la [spec](https://dom.spec.whatwg.org/#dom-document-getelementsbytagnamens) oficial.
