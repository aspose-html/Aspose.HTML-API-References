...
| --- | --- | --- |
| nombre | Cadena | Es una DOMString que contiene el nombre calificado, como svg:svg. |
| publicId | Cadena | Es una DOMString que contiene el identificador PUBLIC. |
| systemId | Cadena | Es una DOMString que contiene los identificadores SYSTEM. |
