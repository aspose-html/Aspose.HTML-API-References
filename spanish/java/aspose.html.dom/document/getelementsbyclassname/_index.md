...
description: "Método del documento. El método getElementsByClassName de la interfaz Document devuelve un objeto similar a una matriz con todos los elementos hijos que tienen todos los nombres de clase proporcionados"
type: docs
...
El método getElementsByClassName de la interfaz [`Document`](../) devuelve un objeto similar a una matriz con todos los elementos hijos que tienen todos los nombres de clase proporcionados.

Cuando se llama sobre el objeto documento, se busca en todo el documento, incluido el nodo raíz. También puede llamar a getElementsByClassName() sobre cualquier elemento; devolverá solo los elementos que son descendientes del elemento raíz especificado con los nombres de clase proporcionados.
...
| --- | --- | --- |
| classNames | String | La String String que contiene un conjunto no ordenado de tokens únicos separados por espacios que representan clases (nombres de clases) |

### Valor de retorno

Una [`HTMLCollection`](../../../com.aspose.html.collections/htmlcollection/) en vivo de elementos encontrados.

## Observaciones

Consulte la [especificación](https://dom.spec.whatwg.org/#dom-document-getelementsbyclassname) oficial.
