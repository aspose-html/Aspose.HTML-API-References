...
| --- | --- | --- |
| tagname | Cadena | Una cadena que representa el nombre de los elementos. La cadena especial "*" representa todos los elementos. |
...
Párrafo con estilo por el nombre de clase =kkk fff=
