...
| resolver | IXPathNSResolver | El resolver permite la traducción de todos los prefijos, incluido el prefijo del paquete xml, dentro de la expresión XPath a URIs de paquete apropiados. |
| type | XPathResultType | Si se especifica un tipo específico, entonces el resultado se devolverá como el tipo correspondiente. |
