...
| [getLocalName](../../com.aspose.html.dom/attr/localname/) Devuelve la parte local del nombre calificado de este nodo. Para nodos de cualquier tipo que no sea ELEMENT_NODE o ATTRIBUTE_NODE y nodos creados con un método DOM Level 1, como Document.createElement(), esto siempre es null. |
