...
description: "Clase com.aspose.html.dom.Attr. La interfaz Attr representa un atributo en un objeto Element. Normalmente, los valores permitidos para el atributo se definen en un esquema asociado al documento."
type: docs

url: /es/java/com.aspose.html.dom/attr/
---
## Attr class

La interfaz Attr representa un atributo en un objeto Element. Normalmente, los valores permitidos para el atributo se definen en un esquema asociado al documento.
...
| [getLocalName](../../com.aspose.html.dom/attr/localname/) Devuelve la parte local del nombre calificado de este nodo. Para nodos de cualquier tipo que no sea ELEMENT_NODE o ATTRIBUTE_NODE y nodos creados con un método DOM Level 1, como Document.createElement(), siempre es null. |
| [getName](../../com.aspose.html.dom/attr/name/) Devuelve el nombre de este atributo. |
| [getNamespaceURI](../../com.aspose.html.dom/attr/packageuri/) El URI del paquete de este nodo, o null si no está especificado. |
...
| [getNodeName](../../com.aspose.html.dom/attr/nodename/) El nombre de este nodo, según su tipo. |
| [getNodeType](../../com.aspose.html.dom/attr/nodetype/) Un código que representa el tipo del objeto subyacente. |
| [nodeValue](../../com.aspose.html.dom/attr/nodevalue/) { get; set; } | El valor de este nodo, según su tipo. |
...
| [getOwnerElement](../../com.aspose.html.dom/attr/ownerelement/) El nodo Element al que está adjunto este atributo o null si este atributo no está en uso. |
...
| [getPrefix](../../com.aspose.html.dom/attr/prefix/) El prefijo del paquete de este nodo, o null si no está especificado. Cuando se define como null, establecerlo no tiene efecto. |
