...
DocumentFragment es un objeto Document "ligero" o "mínimo". Es muy común querer extraer una porción del árbol de un documento o crear un nuevo fragmento de un documento.
