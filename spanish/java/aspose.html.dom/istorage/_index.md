...
description: "Interfaz com.aspose.html.dom.IStorage. Esta interfaz de la API Web Storage proporciona acceso a la sesión o almacenamiento local de un dominio particular. Consulte la especificación Web Storage https//html.spec.whatwg.org/multipage/webstorage.htmlwebstorage"
type: docs
...
Esta interfaz de la API Web Storage proporciona acceso al almacenamiento de sesión o local de un dominio particular. Vea la especificación de Web Storage: [https://html.spec.whatwg.org/multipage/webstorage.html#webstorage](https://html.spec.whatwg.org/multipage/webstorage.html#webstorage)
...
| [getItem](../../com.aspose.html.dom/istorage/getitem/)(String) | Devuelve el valor actual asociado a la clave proporcionada, o null si la clave proporcionada no existe. |
