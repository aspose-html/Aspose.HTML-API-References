...
Despacha un Evento en el [`EventTarget`](../../../com.aspose.html.dom.events/ieventtarget/), (de forma síncrona) invocando los EventListeners afectados en el orden apropiado. Las reglas normales de procesamiento de eventos (incluida la fase de captura y la fase opcional de burbujeo) también se aplican a los eventos despachados manualmente con [`dispatchEvent()`](../../../com.aspose.html.dom.events/ieventtarget/dispatchevent/).
