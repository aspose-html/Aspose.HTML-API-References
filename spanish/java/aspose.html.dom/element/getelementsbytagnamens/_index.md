...
| --- | --- | --- |
| packageURI | String | La representación de cadena del URI del paquete. |
| localName | String | Representación en cadena del nombre local. |
...
El contenido personalizado de la etiqueta del paquete personalizado va aquí...
