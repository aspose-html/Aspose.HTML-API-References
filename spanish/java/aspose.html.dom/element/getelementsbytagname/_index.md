...
description: "Método del elemento. Devuelve un objeto HTMLCollection que contiene todos los elementos con un nombre de etiqueta dado en orden de documento"
type: docs
...
| --- | --- | --- |
| nombre | Cadena | El nombre de la etiqueta. Representación en cadena del nombre de la etiqueta. |
...
Consulte la [especificación](https://dom.spec.whatwg.org/#dom-element-getelementsbytagname) oficial.
