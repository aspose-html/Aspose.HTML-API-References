...
description: "Clase com.aspose.html.dom.Comment. Hereda de CharacterData y representa el contenido de un comentario, es decir, todos los caracteres entre el inicio"
type: docs

url: /es/java/com.aspose.html.dom/comment/
---
## Comment class

Hereda de CharacterData y representa el contenido de un comentario, es decir, todos los caracteres entre las comillas iniciales ''.
...
| [getNodeName](../../com.aspose.html.dom/comment/nodename/) El nombre de este nodo, según su tipo. |
| [getNodeType](../../com.aspose.html.dom/comment/nodetype/) Un código que representa el tipo del objeto subyacente. |
| [nodeValue](../../com.aspose.html.dom/comment/nodevalue/) { get; set; } | El valor de este nodo, según su tipo. |
