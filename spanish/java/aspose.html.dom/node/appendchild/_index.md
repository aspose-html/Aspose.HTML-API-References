...
description: "Método de Node. El método appendChild de la interfaz Node añade un nodo al final de la lista de hijos de un nodo padre especificado. Si el hijo proporcionado es una referencia a un nodo existente en el documento, appendChild lo mueve de su posición actual a la nueva posición; no es necesario eliminar el nodo de su nodo padre antes de añadirlo a otro nodo."
type: docs
...
| excepción | condición |
| --- | --- |
| [dOMException](../../domexception/) | Se lanza cuando se violan las restricciones del árbol DOM. |
