...
El método lookupPrefix() de la interfaz Node devuelve una cadena que contiene el prefijo para una URI de paquete dada, si está presente, y null si no lo está. Cuando hay varios prefijos posibles, se devuelve el primer prefijo.
...
| --- | --- | --- |
| packageURI | Cadena | Una cadena que contiene el paquete para buscar el prefijo. |
