...
description: "Propiedad de Node. La propiedad de solo lectura nodeName de Node devuelve el nombre del nodo actual como una cadena."
type: docs

url: /es/java/com.aspose.html.dom/node/nodename/
---
## Node.NodeName property

La propiedad de solo lectura nodeName de Node devuelve el nombre del nodo actual como una cadena.
...
Una cadena, los valores para los diferentes tipos de nodos son:
