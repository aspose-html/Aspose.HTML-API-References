...
description: "Propiedad de Node. La propiedad de solo lectura childNodes de la interfaz Node devuelve una NodeList en vivo de los nodos hijos del elemento dado, donde el primer nodo hijo tiene el índice 0. Los nodos hijos incluyen elementos, texto y comentarios."
type: docs
...
Nota: Que la [`NodeList`](../../../com.aspose.html.collections/nodelist/) sea en vivo significa que su contenido cambia cada vez que se añaden o eliminan nuevos hijos.
