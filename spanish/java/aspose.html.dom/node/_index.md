...
| [getLastChild](../../com.aspose.html.dom/node/lastchild/) La propiedad de solo lectura lastChild de la interfaz `Node` devuelve el último hijo del nodo. Si su padre es un elemento, entonces el hijo suele ser un nodo de elemento, un nodo de texto o un nodo de comentario. Devuelve null si no hay elementos hijos |
| [getLocalName](../../com.aspose.html.dom/node/localname/) Devuelve la parte local del nombre calificado de este nodo. Para nodos de cualquier tipo que no sea [`ELEMENT_NODE`](./element_node/) y [`ATTRIBUTE_NODE`](./attribute_node/) y nodos creados con un método de DOM Nivel 1, como [`Document.createElement()`](../document/createelement/), esto siempre es null. |
