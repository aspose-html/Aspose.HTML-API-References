...
description: "clase com.aspose.html.dom.Node. La interfaz Node es el tipo de dato principal para todo el Document Object Model. Representa un único nodo en el árbol del documento. Aunque todos los objetos que implementan la interfaz Node exponen métodos para manejar hijos, no todos los objetos que implementan la interfaz Node pueden tener hijos. Por ejemplo, los nodos Text pueden no tener hijos y añadir hijos a dichos nodos produce una DOMException."
type: docs

url: /es/java/com.aspose.html.dom/node/
---
## Node class

La interfaz Node es el tipo de dato principal para todo el Modelo de Objeto del Documento. Representa un único nodo en el árbol del documento. Mientras todos los objetos que implementan la interfaz Node exponen métodos para manejar hijos, no todos los objetos que implementan la interfaz Node pueden tener hijos. Por ejemplo, los nodos [`Text`](../text/) pueden no tener hijos, y agregar hijos a dichos nodos produce que se lance una [`DOMException`](../domexception/).

Los atributos [`nodeName`](./nodename/), [`nodeValue`](./nodevalue/) y atributos se incluyen como un mecanismo para obtener información del nodo sin convertir al interfaz derivada específica. En los casos donde no hay una asignación obvia de estos atributos para un [`nodeType`](./nodetype/) específico (p. ej., nodeValue para un [`Element`](../element/) o atributos para un [`Comment`](../comment/)), esto devuelve null. Tenga en cuenta que las interfaces especializadas pueden contener mecanismos adicionales y más convenientes para obtener y establecer la información relevante.
...
| [getFirstChild](../../com.aspose.html.dom/node/firstchild/) La propiedad de solo lectura firstChild de la interfaz `Node` devuelve el primer hijo del nodo en el árbol, o null si el nodo no tiene hijos. |
| [getLastChild](../../com.aspose.html.dom/node/lastchild/) La propiedad de solo lectura lastChild de la interfaz `Node` devuelve el último hijo del nodo. Si su padre es un elemento, entonces el hijo es generalmente un nodo de elemento, un nodo de texto o un nodo de comentario. Devuelve null si no hay elementos hijos |
| [getLocalName](../../com.aspose.html.dom/node/localname/) Devuelve la parte local del nombre calificado de este nodo. Para nodos de cualquier tipo que no sea [`ELEMENT_NODE`](./element_node/) y [`ATTRIBUTE_NODE`](./attribute_node/) y nodos creados con un método DOM Level 1, como [`Document.createElement()`](../document/createelement/), esto siempre es null. |
...
| [getNextSibling](../../com.aspose.html.dom/node/nextsibling/) La propiedad de solo lectura nextSibling de la interfaz `Node` devuelve el nodo que sigue inmediatamente al especificado en los [`childNodes`](./childnodes/) de su padre, o devuelve null si el nodo especificado es el último hijo del elemento padre. |
| abstract [getNodeName](../../com.aspose.html.dom/node/nodename/) La propiedad de solo lectura nodeName de Node devuelve el nombre del nodo actual como una cadena. |
| abstract [getNodeType](../../com.aspose.html.dom/node/nodetype/) Un código que representa el tipo del objeto subyacente. |
| [nodeValue](../../com.aspose.html.dom/node/nodevalue/) { get; set; } | La propiedad nodeValue de la interfaz `Node ` devuelve o establece el valor del nodo actual. |
...
| [getParentElement](../../com.aspose.html.dom/node/parentelement/) La propiedad de solo lectura parentElement de la interfaz `Node` devuelve el padre del nodo DOM [`Element`](../element/), o null si el nodo no tiene padre, o su padre no es un Element DOM. |
...
| [getPreviousSibling](../../com.aspose.html.dom/node/previoussibling/) La propiedad de solo lectura previousSibling de la interfaz `Node` devuelve el nodo que precede inmediatamente al especificado en la lista de [`childNodes`](./firstchild/) de su padre, o null si el nodo especificado es el primero de esa lista. |
| [textContent](../../com.aspose.html.dom/node/textcontent/) { get; set; } | La propiedad textContent de la interfaz `Node` representa el contenido de texto del nodo y sus descendientes. |
...
| [cloneNode](../../com.aspose.html.dom/node/clonenode/#clonenode)() | El método cloneNode() de la interfaz Node devuelve un duplicado del nodo sobre el cual se llamó este método. Su parámetro controla si el subárbol contenido en un nodo también se clona o no. |
| [cloneNode](../../com.aspose.html.dom/node/clonenode/#clonenode_1)(bool) | El método cloneNode() de la interfaz Node devuelve un duplicado del nodo sobre el cual se llamó este método. Su parámetro controla si el subárbol contenido en un nodo también se clona o no. |
...
| [hasChildNodes](../../com.aspose.html.dom/node/haschildnodes/)() | El método hasChildNodes() de la interfaz Node devuelve un valor booleano que indica si el `Node` dado tiene nodos hijos o no. |
...
| [isEqualNode](../../com.aspose.html.dom/node/isequalnode/)(Node) | El método isEqualNode() de la interfaz `Node` prueba si dos nodos son iguales. Dos nodos son iguales cuando tienen el mismo tipo, características definitorias (para elementos, esto sería su ID, número de hijos, etc.), sus atributos coinciden, y así sucesivamente. El conjunto específico de puntos de datos que deben coincidir varía según los tipos de los nodos. |
...
| Nombre | Descripción |
| --- | --- |
| const [ATTRIBUTE_NODE](../../com.aspose.html.dom/node/attribute_node/) | Un [`Attribute`](../attr/) de un [`Element`](../element/). |
| const [CDATA_SECTION_NODE](../../com.aspose.html.dom/node/cdata_section_node/) | Una [`CDATASection`](../cdatasection/), como &lt;!CDATA[[ … ]]&gt;. |
| const [COMMENT_NODE](../../com.aspose.html.dom/node/comment_node/) | Un nodo [`Comment`](../comment/), como &lt;!-- … --&gt;. |
...
| const [DOCUMENT_TYPE_NODE](../../com.aspose.html.dom/node/document_type_node/) | Un nodo [`DocumentType`](../documenttype/), como &lt;!DOCTYPE html&gt;. |
| const [ELEMENT_NODE](../../com.aspose.html.dom/node/element_node/) | Un nodo [`Element`](../element/) como &lt;p&gt; o &lt;div&gt;. |
...
| const [PROCESSING_INSTRUCTION_NODE](../../com.aspose.html.dom/node/processing_instruction_node/) | Una [`ProcessingInstruction`](../processinginstruction/) de un documento XML, como &lt;?xml-stylesheet … ?&gt;. |
| const [TEXT_NODE](../../com.aspose.html.dom/node/text_node/) | El [`Text`](../text/) real dentro de un [`Element`](../element/) o [`Attr`](../attr/). |
