...
description: "Método de Node. El método insertBefore de la interfaz Node inserta un nodo antes de un nodo de referencia como hijo de un nodo padre especificado."
type: docs
...
Si el nodo proporcionado ya existe en el documento, insertBefore() lo mueve de su posición actual a la nueva posición. (Es decir, será eliminado automáticamente de su padre actual antes de añadirlo al nuevo padre especificado.)
