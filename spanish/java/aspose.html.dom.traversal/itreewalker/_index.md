...
Omitir nodos de la vista lógica de un subárbol puede producir una estructura sustancialmente diferente de la misma subestructura en el documento completo y sin filtrar. Los nodos que son hermanos en la vista del TreeWalker pueden ser hijos de diferentes nodos, ampliamente separados, en la vista original. Por ejemplo, considere un NodeFilter que omite todos los nodos excepto los nodos de Texto y el nodo raíz de un documento. En la vista lógica resultante, todos los nodos de texto serán hermanos y aparecerán como hijos directos del nodo raíz, sin importar cuán profundamente anidada esté la estructura del documento original.
...
| [nextNode](../../com.aspose.html.dom.traversal/itreewalker/nextnode/)() | Mueve el TreeWalker al siguiente nodo visible en orden de documento relativo al nodo actual y devuelve el nuevo nodo. Si el nodo actual no tiene nodo siguiente, o si la búsqueda de nextNode intenta subir desde el nodo raíz del TreeWalker, devuelve null y conserva el nodo actual. |
| [nextSibling](../../com.aspose.html.dom.traversal/itreewalker/nextsibling/)() | Mueve el TreeWalker al siguiente hermano visible del nodo actual y devuelve el nuevo nodo. Si el nodo actual no tiene siguiente hermano visible, devuelve null y conserva el nodo actual. |
| [parentNode](../../com.aspose.html.dom.traversal/itreewalker/parentnode/)() | Mueve y devuelve el nodo ancestro visible más cercano del nodo actual. Si la búsqueda de parentNode intenta subir desde el nodo raíz del TreeWalker, o si no logra encontrar un ancestro visible, este método conserva la posición actual y devuelve null. |
...
| [previousSibling](../../com.aspose.html.dom.traversal/itreewalker/previoussibling/)() | Mueve el TreeWalker al hermano anterior del nodo actual y devuelve el nuevo nodo. Si el nodo actual no tiene hermano anterior visible, devuelve null y conserva el nodo actual. |
