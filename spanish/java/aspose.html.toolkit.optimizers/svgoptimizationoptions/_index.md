---
title: "Clase SVGOptimizationOptions"
second_title: "Referencia de la API de Aspose.HTML para Java"
description: "Clase com.aspose.html.toolkit.optimizers.SVGOptimizationOptions. SVGOptimizationOptions es una clase para almacenar opciones de optimización de documentos SVG"
type: docs

url: /es/java/com.aspose.html.toolkit.optimizers/svgoptimizationoptions/
---
## SVGOptimizationOptions class

SVGOptimizationOptions es una clase para almacenar opciones de optimización de documentos SVG.
...
| Nombre | Descripción |
| --- | --- |
| [SVGOptimizationOptions](svgoptimizationoptions/)() | Inicializa una nueva instancia de la clase `SVGOptimizationOptions`. |
