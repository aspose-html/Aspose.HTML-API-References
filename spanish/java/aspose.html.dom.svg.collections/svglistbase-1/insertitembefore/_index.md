...
description: "Método SVGListBase. Inserta un nuevo elemento en la lista en la posición especificada. El primer elemento es el número 0"
type: docs
...
| index | UInt64 | El índice del elemento antes del cual se insertará el nuevo elemento. El primer elemento es el número 0. Si el índice es igual a 0, entonces el nuevo elemento se inserta al principio de la lista. Si el índice es mayor o igual que numberOfItems, entonces el nuevo elemento se agrega al final de la lista. |
