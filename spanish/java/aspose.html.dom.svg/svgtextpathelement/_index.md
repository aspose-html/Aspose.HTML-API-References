---
title: "Clase SVGTextPathElement"
second_title: "Referencia de la API de Aspose.HTML para Java"
description: "com.aspose.html.dom.svg.SVGTextPathElement clase. La interfaz SVGTextPathElement corresponde al elemento textPath."
type: docs

url: /es/java/com.aspose.html.dom.svg/svgtextpathelement/
---
## SVGTextPathElement class

La interfaz SVGTextPathElement corresponde al elemento ‘textPath’.
...
| [getHref](../../com.aspose.html.dom.svg/svgtextpathelement/href/) Corresponde al atributo ‘xlink:href’ en el elemento dado. |
[getId]
...
| [getLengthAdjust](../../com.aspose.html.dom.svg/svgtextcontentelement/lengthadjust/) Corresponde al atributo ‘lengthAdjust’ en el elemento dado. El valor debe ser una de las constantes de ajuste de longitud definidas en esta interfaz. |
...
| [getMethod](../../com.aspose.html.dom.svg/svgtextpathelement/method/) Corresponde al atributo ‘method’ en el elemento ‘textPath’ dado. |
...
| [getSpacing](../../com.aspose.html.dom.svg/svgtextpathelement/spacing/) Corresponde al atributo ‘spacing’ en el elemento ‘textPath’ dado. |
| [getStartOffset](../../com.aspose.html.dom.svg/svgtextpathelement/startoffset/) Corresponde al atributo ‘startOffset’ en el elemento ‘textPath’ dado. |
...
| [getTextLength](../../com.aspose.html.dom.svg/svgtextcontentelement/textlength/) Corresponde al atributo ‘textLength’ en el elemento dado. |
...
| [getComputedTextLength](../../com.aspose.html.dom.svg/svgtextcontentelement/getcomputedtextlength/)() | La suma total de todos los valores de avance resultantes de renderizar todos los caracteres dentro de este elemento, incluyendo el valor de avance en los glifos (horizontal o vertical), el efecto de las propiedades ‘kerning’, ‘letter-spacing’ y ‘word-spacing’ y los ajustes debidos a los atributos ‘dx’ y ‘dy’ en los elementos ‘tspan’. Para entornos que no realizan renderizado, el agente de usuario deberá hacer suposiciones razonables sobre las métricas de los glifos. |
...
| [getNumberOfChars](../../com.aspose.html.dom.svg/svgtextcontentelement/getnumberofchars/)() | Devuelve el número total de caracteres disponibles para renderizar dentro del elemento actual, lo que incluye los caracteres referenciados mediante la referencia ‘tref’, independientemente de si se renderizarán o no. En esencia, esto equivale a la longitud del atributo Node::textContent del DOM Level 3 Core ([DOM3], sección 1.4), si ese atributo también expandió los elementos ‘tref’. |
...
| Nombre | Descripción |
| --- | --- |
| const [TEXTPATH_METHODTYPE_ALIGN](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_align/) | Corresponde al valor 'align'. |
| const [TEXTPATH_METHODTYPE_STRETCH](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_stretch/) | Corresponde al valor 'stretch'. |
| const [TEXTPATH_METHODTYPE_UNKNOWN](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_unknown/) | La enumeración se estableció a un valor que no es uno de los tipos predefinidos. Es inválido intentar definir un nuevo valor de este tipo o intentar cambiar un valor existente a este tipo. |
| const [TEXTPATH_SPACINGTYPE_AUTO](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_auto/) | Corresponde al valor 'auto'. |
| const [TEXTPATH_SPACINGTYPE_EXACT](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_exact/) | Corresponde al valor 'exact'. |
| const [TEXTPATH_SPACINGTYPE_UNKNOWN](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_unknown/) | La enumeración se estableció a un valor que no es uno de los tipos predefinidos. Es inválido intentar definir un nuevo valor de este tipo o intentar cambiar un valor existente a este tipo. |
