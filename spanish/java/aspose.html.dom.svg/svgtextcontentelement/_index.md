...
| [getComputedTextLength](../../com.aspose.html.dom.svg/svgtextcontentelement/getcomputedtextlength/)() | La suma total de todos los valores de avance obtenidos al renderizar todos los caracteres dentro de este elemento, incluyendo el valor de avance en los glifos (horizontal o vertical), el efecto de las propiedades ‘kerning’, ‘letter-spacing’ y ‘word-spacing’ y los ajustes debidos a los atributos ‘dx’ y ‘dy’ en los elementos ‘tspan’. Para entornos que no realizan renderizado, el agente de usuario deberá hacer suposiciones razonables sobre las métricas de los glifos. |
...
| [getNumberOfChars](../../com.aspose.html.dom.svg/svgtextcontentelement/getnumberofchars/)() | Devuelve el número total de caracteres disponibles para renderizar dentro del elemento actual, que incluye los caracteres referenciados desde la referencia ‘tref’, independientemente de si se renderizarán o no. En efecto, esto equivale a la longitud del atributo Node::textContent del DOM Level 3 Core ([DOM3], sección 1.4), si ese atributo también expandió los elementos ‘tref’. |
...
| Nombre | Descripción |
| --- | --- |
| const [LENGTHADJUST_SPACING](../../com.aspose.html.dom.svg/svgtextcontentelement/lengthadjust_spacing/) | Corresponde al valor 'spacing'. |
| const [LENGTHADJUST_SPACINGANDGLYPHS](../../com.aspose.html.dom.svg/svgtextcontentelement/lengthadjust_spacingandglyphs/) | Corresponde al valor 'spacingAndGlyphs'. |
| const [LENGTHADJUST_UNKNOWN](../../com.aspose.html.dom.svg/svgtextcontentelement/lengthadjust_unknown/) | La enumeración se estableció a un valor que no es uno de los tipos predefinidos. Es inválido intentar definir un nuevo valor de este tipo o intentar cambiar un valor existente a este tipo. |
