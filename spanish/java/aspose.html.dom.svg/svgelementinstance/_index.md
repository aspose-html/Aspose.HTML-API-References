---
title: "Clase SVGElementInstance"
second_title: "Referencia de la API de Aspose.HTML para Java"
description: "Clase com.aspose.html.dom.svg.SVGElementInstance. El objeto raíz de cada árbol sombra de elemento use implementa la interfaz SVGUseElementShadowRoot. Esta interfaz no define actualmente extensiones a las propiedades y métodos definidos para la interfaz ShadowRoot y el mixin DocumentOrShadowRoot. Sin embargo, el árbol enraizado en este nodo es completamente de solo lectura desde la perspectiva de los scripts del autor."
type: docs

url: /es/java/com.aspose.html.dom.svg/svgelementinstance/
---
## SVGElementInstance class

El objeto raíz de cada árbol sombra de elemento use implementa la interfaz SVGUseElementShadowRoot. Esta interfaz no define actualmente extensiones a las propiedades y métodos definidos para la interfaz ShadowRoot y el mixin DocumentOrShadowRoot. Sin embargo, el árbol cuya raíz es este nodo es completamente de solo lectura desde la perspectiva de los scripts del autor.
...
| [getHost](../../com.aspose.html.dom/shadowroot/host/) Host es un elemento que contiene este ShadowRoot. |
[getInnerHTML]
...
| [getMode](../../com.aspose.html.dom/shadowroot/mode/) Modo en el que opera este ShadowRoot. |
