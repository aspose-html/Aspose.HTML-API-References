---
title: "Clase SVGMarkerElement"
second_title: "Referencia de la API de Aspose.HTML para Java"
description: "com.aspose.html.dom.svg.SVGMarkerElement clase. La interfaz SVGMarkerElement corresponde al elemento marker."
type: docs

url: /es/java/com.aspose.html.dom.svg/svgmarkerelement/
---
...
| [getMarkerHeight](../../com.aspose.html.dom.svg/svgmarkerelement/markerheight/) Corresponde al atributo ‘markerHeight’ en el elemento ‘marker’ dado. |
| [getMarkerUnits](../../com.aspose.html.dom.svg/svgmarkerelement/markerunits/) Corresponde al atributo ‘markerUnits’ en el elemento ‘marker’ dado. Uno de los tipos de unidad de marcador definidos en esta interfaz. |
| [getMarkerWidth](../../com.aspose.html.dom.svg/svgmarkerelement/markerwidth/) Corresponde al atributo ‘markerWidth’ en el elemento ‘marker’ dado. |
...
| [getOrientAngle](../../com.aspose.html.dom.svg/svgmarkerelement/orientangle/) Corresponde al atributo ‘orient’ en el elemento ‘marker’ dado. Si markerUnits es SVG_MARKER_ORIENT_ANGLE, el valor angular para el atributo ‘orient’; de lo contrario, se establecerá a cero. |
| [getOrientType](../../com.aspose.html.dom.svg/svgmarkerelement/orienttype/) Corresponde al atributo ‘orient’ en el elemento ‘marker’ dado. Uno de los Tipos de Orientación de Marcador definidos en esta interfaz. |
[getOuterHTML]
...
| [getPreserveAspectRatio](../../com.aspose.html.dom.svg/svgmarkerelement/preserveaspectratio/) Corresponde al atributo ‘preserveAspectRatio’ en el elemento dado. |
...
| [getRefX](../../com.aspose.html.dom.svg/svgmarkerelement/refx/) Corresponde al atributo ‘refX’ en el elemento ‘marker’ dado. |
| [getRefY](../../com.aspose.html.dom.svg/svgmarkerelement/refy/) Corresponde al atributo ‘refY’ en el elemento ‘marker’ dado. |
...
| [getViewBox](../../com.aspose.html.dom.svg/svgmarkerelement/viewbox/) Corresponde al atributo ‘viewBox’ en el elemento dado. |
...
| [setOrientToAngle](../../com.aspose.html.dom.svg/svgmarkerelement/setorienttoangle/)(SVGAngle) | Establece el valor del atributo ‘orient’ al ángulo dado. |
| [setOrientToAuto](../../com.aspose.html.dom.svg/svgmarkerelement/setorienttoauto/)() | Establece el valor del atributo ‘orient’ a 'auto'. |
...
| Nombre | Descripción |
| --- | --- |
| const [SVG_MARKERUNITS_STROKEWIDTH](../../com.aspose.html.dom.svg/svgmarkerelement/svg_markerunits_strokewidth/) | El valor del atributo ‘markerUnits’ es 'strokeWidth'. |
| const [SVG_MARKERUNITS_UNKNOWN](../../com.aspose.html.dom.svg/svgmarkerelement/svg_markerunits_unknown/) | El tipo de unidad de marcador no es uno de los tipos predefinidos. Es inválido intentar definir un nuevo valor de este tipo o intentar cambiar un valor existente a este tipo. |
| const [SVG_MARKERUNITS_USERSPACEONUSE](../../com.aspose.html.dom.svg/svgmarkerelement/svg_markerunits_userspaceonuse/) | El valor del atributo ‘markerUnits’ es 'userSpaceOnUse'. |
| const [SVG_MARKER_ORIENT_ANGLE](../../com.aspose.html.dom.svg/svgmarkerelement/svg_marker_orient_angle/) | El atributo ‘orient’ tiene un valor angular. |
| const [SVG_MARKER_ORIENT_AUTO](../../com.aspose.html.dom.svg/svgmarkerelement/svg_marker_orient_auto/) | El atributo ‘orient’ tiene el valor 'auto'. |
| const [SVG_MARKER_ORIENT_UNKNOWN](../../com.aspose.html.dom.svg/svgmarkerelement/svg_marker_orient_unknown/) | La orientación del marcador no es uno de los tipos predefinidos. Es inválido intentar definir un nuevo valor de este tipo o intentar cambiar un valor existente a este tipo. |
