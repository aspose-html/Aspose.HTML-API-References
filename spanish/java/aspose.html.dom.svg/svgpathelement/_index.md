---
title: "SVGPathElement Clase"
second_title: "Referencia de la API de Aspose.HTML para Java"
description: "com.aspose.html.dom.svg.SVGPathElement class. La interfaz SVGPathElement corresponde al elemento path."
type: docs

url: /es/java/com.aspose.html.dom.svg/svgpathelement/
---
## SVGPathElement class

La interfaz SVGPathElement corresponde al elemento ‘path’.
...
| [getPathLength](../../com.aspose.html.dom.svg/svggeometryelement/pathlength/) Corresponde al atributo pathLength en el elemento dado. |
[getPathSegList]
...
| [createSVGPathSegArcAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegarcabs/)(float, float, float, float, float, bool, bool) | Devuelve un objeto SVGPathSegArcAbs independiente y sin padre. |
| [createSVGPathSegArcRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegarcrel/)(float, float, float, float, float, bool, bool) | Devuelve un objeto SVGPathSegArcRel independiente y sin padre. |
| [createSVGPathSegClosePath](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegclosepath/)() | Devuelve un objeto SVGPathSegClosePath independiente y sin padre. |
| [createSVGPathSegCurvetoCubicAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicabs/)(float, float, float, float, float, float) | Devuelve un objeto SVGPathSegCurvetoCubicAbs independiente y sin padre. |
| [createSVGPathSegCurvetoCubicRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicrel/)(float, float, float, float, float, float) | Devuelve un objeto SVGPathSegCurvetoCubicRel independiente y sin padre. |
| [createSVGPathSegCurvetoCubicSmoothAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothabs/)(float, float, float, float) | Devuelve un objeto SVGPathSegCurvetoCubicSmoothAbs independiente y sin padre. |
| [createSVGPathSegCurvetoCubicSmoothRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothrel/)(float, float, float, float) | Devuelve un objeto SVGPathSegCurvetoCubicSmoothRel independiente y sin padre. |
| [createSVGPathSegCurvetoQuadraticAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticabs/)(float, float, float, float) | Devuelve un objeto independiente y sin padre SVGPathSegCurvetoQuadraticAbs. |
| [createSVGPathSegCurvetoQuadraticRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticrel/)(float, float, float, float) | Devuelve un objeto independiente y sin padre SVGPathSegCurvetoQuadraticRel. |
| [createSVGPathSegCurvetoQuadraticSmoothAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothabs/)(float, float) | Devuelve un objeto independiente y sin padre SVGPathSegCurvetoQuadraticSmoothAbs. |
| [createSVGPathSegCurvetoQuadraticSmoothRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothrel/)(float, float) | Devuelve un objeto independiente y sin padre SVGPathSegCurvetoQuadraticSmoothRel. |
| [createSVGPathSegLinetoAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoabs/)(float, float) | Devuelve un objeto independiente y sin padre SVGPathSegLinetoAbs. |
| [createSVGPathSegLinetoHorizontalAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetohorizontalabs/)(float) | Devuelve un objeto independiente y sin padre SVGPathSegLinetoHorizontalAbs. |
| [createSVGPathSegLinetoHorizontalRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetohorizontalrel/)(float) | Devuelve un objeto independiente y sin padre SVGPathSegLinetoHorizontalRel. |
| [createSVGPathSegLinetoRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetorel/)(float, float) | Devuelve un objeto independiente y sin padre SVGPathSegLinetoRel. |
| [createSVGPathSegLinetoVerticalAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoverticalabs/)(float) | Devuelve un objeto independiente y sin padre SVGPathSegLinetoVerticalAbs. |
| [createSVGPathSegLinetoVerticalRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoverticalrel/)(float) | Devuelve un objeto independiente y sin padre SVGPathSegLinetoVerticalRel. |
| [createSVGPathSegMovetoAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegmovetoabs/)(float, float) | Devuelve un objeto independiente y sin padre SVGPathSegMovetoAbs. |
| [createSVGPathSegMovetoRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegmovetorel/)(float, float) | Devuelve un objeto independiente y sin padre SVGPathSegMovetoRel. |
...
| [getEquivalentPath](../../com.aspose.html.dom.svg/svggeometryelement/getequivalentpath/)() | Devuelve una nueva instancia de [`SVGPathSegList`](../../com.aspose.html.dom.svg.paths/svgpathseglist/) que representa a [`SVGGeometryElement`](../svggeometryelement/) como segmentos de ruta. |
| [getPlatformType](../../com.aspose.html.dom/domobject/getplatformtype/)() | Este método se utiliza para obtener el objeto ECMAScript. |
| [getPointAtLength](../../com.aspose.html.dom.svg/svggeometryelement/getpointatlength/)(float) | Devuelve la coordenada (x,y) en el espacio del usuario que está en unidades de distancia a lo largo de la ruta, utilizando el algoritmo de distancia-a-través-de-una-ruta del agente de usuario. |
...
| [getTotalLength](../../com.aspose.html.dom.svg/svggeometryelement/gettotallength/)() | Devuelve el valor calculado por el agente de usuario para la longitud total de la ruta usando el algoritmo de distancia-a-través-de-una-ruta del agente de usuario, como una distancia en el sistema de coordenadas del usuario actual. |
