...
description: "Clase com.aspose.html.dom.svg.SVGSVGElement. Una definición clave de interfaz es la interfaz SVGSVGElement, que es la interfaz que corresponde al elemento svg. Esta interfaz contiene varios métodos utilitarios misceláneos de uso común, como operaciones de matrices y la capacidad de controlar el tiempo de redibujado en dispositivos de renderizado visual."
type: docs
...
| [getCurrentTranslate](../../com.aspose.html.dom.svg/svgsvgelement/currenttranslate/) En un elemento svg más externo, el factor de traducción correspondiente que tiene en cuenta la "magnificación" del usuario. Cuando se accede a un elemento ‘svg’ que no es el más externo, el comportamiento de este atributo es indefinido. |
| [getFarthestViewportElement](../../com.aspose.html.dom.svg/svggraphicselement/farthestviewportelement/) El elemento ancestro ‘svg’ más lejano. Nulo si el elemento actual es el elemento svg más externo. |
...
| [getNearestViewportElement](../../com.aspose.html.dom.svg/svggraphicselement/nearestviewportelement/) El elemento que estableció el viewport actual. A menudo, el elemento ‘svg’ ancestro más cercano. Nulo si el elemento actual es el elemento svg más externo. |
...
| [getStyle](../../com.aspose.html.dom.svg/svgelement/style/) Corresponde al atributo ‘style’ del elemento dado. Si el agente de usuario no admite estilos con CSS, entonces este atributo siempre debe tener el valor null. |
...
| [createSVGAngle](../../com.aspose.html.dom.svg/svgsvgelement/createsvgangle/)() | Crea un objeto SVGAngle fuera de cualquier árbol de documentos. El objeto se inicializa con el valor 0 grados (sin unidades). |
...
| [createSVGPoint](../../com.aspose.html.dom.svg/svgsvgelement/createsvgpoint/)() | Crea un objeto SVGPoint fuera de cualquier árbol de documentos. El objeto se inicializa en el punto (0,0) del sistema de coordenadas del usuario. |
...
| [getBBox](../../com.aspose.html.dom.svg/svggraphicselement/getbbox/)() | Devuelve el cuadro delimitador ajustado en el espacio de usuario actual (es decir, después de aplicar el atributo ‘transform’, si lo hay) sobre la geometría de todos los elementos gráficos contenidos, excluyendo trazos, recortes, máscaras y efectos de filtro). Observe que getBBox debe devolver el cuadro delimitador real en el momento en que se llama al método, incluso si el elemento aún no se ha renderizado. |
| [getCTM](../../com.aspose.html.dom.svg/svggraphicselement/getctm/)() | Devuelve la matriz de transformación desde las unidades de usuario actuales (es decir, después de aplicar el atributo ‘transform’, si lo hay) al sistema de coordenadas del viewport para el nearestViewportElement. |
...
| [getElementById](../../com.aspose.html.dom.svg/svgsvgelement/getelementbyid/)(String) | Busca en este fragmento de documento SVG (es decir, la búsqueda se restringe a un subconjunto del árbol del documento) un Element cuyo id está dado por elementId. Si se encuentra un Element, se devuelve ese Element. Si no existe tal elemento, se devuelve null. El comportamiento no está definido si más de un elemento tiene este id. |
