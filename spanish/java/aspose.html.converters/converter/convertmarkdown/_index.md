...
description: "Método Converter. Convierte la fuente markdown MD presentada por el flujo de entrada a html. El resultado es HTMLDocument que puede guardarse mediante la ruta de archivo de salida."
type: docs
...
Convierte la fuente MD (markdown) presentada por el flujo de entrada a html. El resultado es [`HTMLDocument`](../../../com.aspose.html/htmldocument/) que puede guardarse mediante la ruta de archivo de salida.
...
| --- | --- | --- |
| flujo | Flujo | Flujo de datos de entrada de conversión MD (Markdown). |
...
Convierte la fuente MD (markdown) presentada por la ruta completa del archivo a html. El resultado es [`HTMLDocument`](../../../com.aspose.html/htmldocument/) que puede guardarse mediante la ruta de archivo de salida.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| sourcePath | String | Ruta completa del archivo fuente MD (Markdown). |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| sourcePath | String | Ruta al archivo Markdown fuente. Se combinará con la ruta del directorio actual para formar una URL absoluta. |
| outputPath | String | Ruta completa del archivo html como resultado de salida de la conversión. |
