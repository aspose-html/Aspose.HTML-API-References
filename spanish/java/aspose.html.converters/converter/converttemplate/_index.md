...
description: "Método del convertidor. Fusiona la fuente de plantilla presentada por HTMLDocument con los datos de plantilla XML JSON. El resultado es un archivo html formado por la ruta de archivo de salida."
type: docs
...
Fusionar la fuente de plantilla presentada por [`HTMLDocument`](../../../com.aspose.html/htmldocument/) con los datos de plantilla (XML, JSON). El resultado es un archivo html formado por la ruta de archivo de salida.
...
| --- | --- | --- |
| template | HTMLDocument | Fusionando el esqueleto de la fuente presentado por [`HTMLDocument`](../../../com.aspose.html/htmldocument/). |
| datos | TemplateData | Datos de plantilla para la fusión - sustitución (XML, JSON). |
| options | TemplateLoadOptions | [`TemplateLoadOptions`](../../../com.aspose.html.loading/templateloadoptions/) instancia de objeto. Se utiliza para determinar si los nombres de la plantilla y los elementos de datos coinciden, sin importar mayúsculas o minúsculas (opciones). |
...
Fuente de plantilla. Defina la fuente de la plantilla HTML mediante archivo, [`URL`](../../../com.aspose.html/url/), instancia de objeto [`HTMLDocument`](../../../com.aspose.html/htmldocument/) o incluso mediante contenido en línea. Resultado de la conversión. Puede obtener directamente el HTMLDocument resultante o definir la ruta del archivo de salida del resultado según la firma del método. Cree una instancia de [`TemplateLoadOptions`](../../../com.aspose.html.loading/templateloadoptions/). Utilice el método ConvertTemplate() de la clase Converter para combinar la plantilla con los datos. También puede agregar [`configuration`](../../../com.aspose.html/configuration/) como parámetro de opción. Código fuente
...
...
      // Ruta del archivo de origen HTML del esqueleto del formulario
      ...
      // Defina la instancia del objeto TemplateData
...
Combine la fuente HTML de la plantilla presentada por [`URL`](../../../com.aspose.html/url/) con los datos de la plantilla (XML, JSON). El resultado es un archivo HTML formado por la ruta del archivo de salida.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| url | Url | Fusionando el esqueleto de la fuente HTML presentado por [`URL`](../../../com.aspose.html/url/). |
| datos | TemplateData | Datos de plantilla para la fusión - sustitución (XML, JSON). |
| options | TemplateLoadOptions | [`TemplateLoadOptions`](../../../com.aspose.html.loading/templateloadoptions/) instancia de objeto. Se utiliza para determinar si los nombres de la plantilla y los elementos de datos coinciden, sin importar mayúsculas o minúsculas (opciones). |
| outputPath | Cadena | Ruta completa del archivo html como resultado de salida de la conversión. |
...
import com.aspose.html.converters;  
...
      // URL del origen HTML del esqueleto del formulario
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| sourcePath | Cadena | Fusionando el esqueleto de la fuente HTML presentado por la ruta completa del archivo. |
| datos | TemplateData | Datos de plantilla para la fusión - sustitución (XML, JSON). |
| options | TemplateLoadOptions | [`TemplateLoadOptions`](../../../com.aspose.html.loading/templateloadoptions/) instancia de objeto. Se utiliza para determinar si los nombres de la plantilla y los elementos de datos coinciden, sin importar mayúsculas o minúsculas (opciones). |
| outputPath | Cadena | Ruta completa del archivo html como resultado de salida de la conversión. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| contenido | Cadena | Fusionando el esqueleto de la fuente HTML presentado por contenido de cadena en línea. |
| baseUrl | Cadena | URI base de la plantilla HTML. Se combinará con la ruta del directorio actual para formar una URL absoluta. |
| datos | TemplateData | Datos de plantilla para la fusión - sustitución (XML, JSON). |
| options | TemplateLoadOptions | [`TemplateLoadOptions`](../../../com.aspose.html.loading/templateloadoptions/) instancia de objeto. Se utiliza para determinar si los nombres de la plantilla y los elementos de datos coinciden, sin importar mayúsculas o minúsculas (opciones). |
| outputPath | Cadena | Ruta completa del archivo html como resultado de salida de la conversión. |
...
import com.aspose.html.converters;  
...
	  // Contenido de origen en línea del formulario como plantilla
...
...
   ...
   // Defina la instancia del objeto configuration
...
Combina la fuente de plantilla presentada por [`HTMLDocument`](../../../com.aspose.html/htmldocument/) con los datos de plantilla (XML, JSON). El resultado es un nuevo HTMLDocument formado que puede guardarse como archivo.
...
Combina la fuente HTML de plantilla presentada por [`URL`](../../../com.aspose.html/url/) con los datos de plantilla (XML, JSON). El resultado es un nuevo [`HTMLDocument`](../../../com.aspose.html/htmldocument/) formado que puede guardarse como archivo.
...
import com.aspose.html.converters;  
...
      // Crear URL para el archivo fuente HTML esqueleto
      var sourceUrl = new Url(Path.Combine(InputFolder, "source.html"));
...
Combina la fuente HTML de plantilla presentada por la ruta completa del archivo con los datos de plantilla (XML, JSON). El resultado es un nuevo [`HTMLDocument`](../../../com.aspose.html/htmldocument/) formado que puede guardarse como archivo.
...
Combina la fuente HTML de plantilla presentada por contenido en línea con los datos de plantilla (XML, JSON). El resultado es un nuevo [`HTMLDocument`](../../../com.aspose.html/htmldocument/) formado que puede guardarse como archivo.
