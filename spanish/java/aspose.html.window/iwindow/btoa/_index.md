...
Toma los datos de entrada, en forma de una cadena Unicode que contiene solo caracteres en el rango U+0000 a U+00FF, cada uno representando un byte binario con valores de 0x00 a 0xFF respectivamente, y los convierte a su representación base64, la cual devuelve.
...
| excepción | condición |
| --- | --- |
| [dOMException](../../../com.aspose.html.dom/domexception/) | Lanza una excepción DOMException "InvalidCharacterError" si la cadena de entrada contiene caracteres fuera de rango. |
