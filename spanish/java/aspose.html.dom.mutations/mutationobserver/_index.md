...
| Nombre | Descripción |
| --- | --- |
| [MutationObserver](mutationobserver/)(MutationCallback) | Construye un objeto MutationObserver y establece su [`MutationCallback`](../mutationcallback/) como callback. El callback se invoca con una lista de objetos MutationRecord como primer argumento y el objeto MutationObserver construido como segundo argumento. Se invoca después de que los nodos registrados con el método !:Observe(Node, IMutationObserverInit) sean mutados. |

## Métodos

| Nombre | Descripción |
| --- | --- |
| [disconnect](../../com.aspose.html.dom.mutations/mutationobserver/disconnect/)() | Detiene al observador de observar cualquier mutación. Hasta que el método observe() se use nuevamente, el callback del observador no será invocado. |
| [getPlatformType](../../com.aspose.html.dom/domobject/getplatformtype/)() | Este método se usa para recuperar el objeto ECMAScript. |
| [observe](../../com.aspose.html.dom.mutations/mutationobserver/observe/#observe)(Node) | Indica al agente de usuario que observe un objetivo dado (un nodo) e informe cualquier mutación según los criterios proporcionados por options (un objeto). El argumento options permite establecer opciones de observación de mutaciones mediante los miembros del objeto. |
