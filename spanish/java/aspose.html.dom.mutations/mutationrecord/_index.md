...
description: "com.aspose.html.dom.mutations.MutationRecord class. Un MutationRecord representa una mutación individual del DOM. Es el objeto que se pasa al MutationCallback de los MutationObservers."
type: docs
...
Un MutationRecord representa una mutación individual del DOM. Es el objeto que se pasa al [`MutationObserver`](../mutationobserver/) de su [`MutationCallback`](../mutationcallback/).
