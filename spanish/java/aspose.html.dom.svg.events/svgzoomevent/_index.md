...
description: "Clase com.aspose.html.dom.svg.events.SVGZoomEvent. El evento de zoom ocurre cuando el usuario inicia una acción que hace que la vista actual del fragmento del documento SVG se vuelva a escalar. Los manejadores de eventos solo se reconocen en elementos svg."
type: docs
...
| [getCurrentTarget](../../com.aspose.html.dom.events/event/currenttarget/) Se usa para indicar el [`IEventTarget`](../../com.aspose.html.dom.events/ieventtarget/) cuyo [`IEventListener`](../../com.aspose.html.dom.events/ieventlistener/) están siendo procesados actualmente. Esto es particularmente útil durante la captura y el bubbling. |
...
| [getNewScale](../../com.aspose.html.dom.svg.events/svgzoomevent/newscale/) El factor de escala que estará en vigor después de que la operación de zoom se haya procesado. |
| [getNewTranslate](../../com.aspose.html.dom.svg.events/svgzoomevent/newtranslate/) Los valores de traslación que estarán en vigor después de que la operación de zoom se haya procesado. El objeto SVGPoint es de solo lectura. |
...
| [getTarget](../../com.aspose.html.dom.events/event/target/) Se usa para indicar el [`IEventTarget`](../../com.aspose.html.dom.events/ieventtarget/) al que se envió originalmente el evento. |
...
| [stopPropagation](../../com.aspose.html.dom.events/event/stoppropagation/)() | El método [`StopPropagation`](../../com.aspose.html.dom.events/event/stoppropagation/) se usa para evitar la propagación adicional de un evento durante el flujo de eventos. |
