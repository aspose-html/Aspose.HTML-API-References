...
La interfaz SVGPathSeg es una interfaz base que corresponde a un único comando dentro de una especificación de datos de ruta.
...
| const [PATHSEG_CURVETO_QUADRATIC_SMOOTH_REL](../../com.aspose.html.dom.svg.paths/svgpathseg/pathseg_curveto_quadratic_smooth_rel/) | Corresponde a un "relative smooth quadratic curveto" (t) comando de datos de ruta. |
| const [PATHSEG_LINETO_ABS](../../com.aspose.html.dom.svg.paths/svgpathseg/pathseg_lineto_abs/) | Corresponde a un "absolute lineto" (L) comando de datos de ruta. |
| const [PATHSEG_LINETO_HORIZONTAL_ABS](../../com.aspose.html.dom.svg.paths/svgpathseg/pathseg_lineto_horizontal_abs/) | Corresponde a un " absolute horizontal lineto" (H) comando de datos de ruta. |
| const [PATHSEG_LINETO_HORIZONTAL_REL](../../com.aspose.html.dom.svg.paths/svgpathseg/pathseg_lineto_horizontal_rel/) | Corresponde a un "relative horizontal lineto" (h) comando de datos de ruta. |
| const [PATHSEG_LINETO_REL](../../com.aspose.html.dom.svg.paths/svgpathseg/pathseg_lineto_rel/) | Corresponde a un "relative lineto" (l) comando de datos de ruta. |
| const [PATHSEG_LINETO_VERTICAL_ABS](../../com.aspose.html.dom.svg.paths/svgpathseg/pathseg_lineto_vertical_abs/) | Corresponde a un "absolute vertical lineto" (V) comando de datos de ruta. |
| const [PATHSEG_LINETO_VERTICAL_REL](../../com.aspose.html.dom.svg.paths/svgpathseg/pathseg_lineto_vertical_rel/) | Corresponde a un "relative vertical lineto" (v) comando de datos de ruta. |
| const [PATHSEG_MOVETO_ABS](../../com.aspose.html.dom.svg.paths/svgpathseg/pathseg_moveto_abs/) | Corresponde a un "absolute moveto" (M) comando de datos de ruta. |
| const [PATHSEG_MOVETO_REL](../../com.aspose.html.dom.svg.paths/svgpathseg/pathseg_moveto_rel/) | Corresponde a un "relative moveto" (m) comando de datos de ruta. |
