---
title: "Clase XpsRenderingOptions"
second_title: "Referencia de la API de Aspose.HTML para Java"
description: "Clase com.aspose.html.rendering.xps.XpsRenderingOptions. Representa las opciones de renderizado para XpsDevice"
type: docs

url: /es/java/com.aspose.html.rendering.xps/xpsrenderingoptions/
---
## XpsRenderingOptions class

Representa las opciones de renderizado para [`XpsDevice`](../xpsdevice/).
...
| Nombre | Descripción |
| --- | --- |
| [XpsRenderingOptions](xpsrenderingoptions/)() | El constructor predeterminado. |
