...
description: "Método MarkdownSyntaxFactory. Crea ReferenceImageSyntaxNode"
type: docs

url: /es/java/com.aspose.html.toolkit.markdown.syntax/markdownsyntaxfactory/referenceimage/
---
## MarkdownSyntaxFactory.ReferenceImage method

Crea [`ReferenceImageSyntaxNode`](../../referenceimagesyntaxnode/).
...
| etiqueta | InlineContainerSyntaxNode | La etiqueta. |
| labelClosing | MarkdownSyntaxToken | El labelClosing. |

### Valor devuelto

El ReferenceImageSyntax.
