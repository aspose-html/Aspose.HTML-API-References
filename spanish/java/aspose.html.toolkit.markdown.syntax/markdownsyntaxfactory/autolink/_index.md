...
description: "Método MarkdownSyntaxFactory. Crea AutoLinkSyntaxNode"
type: docs

url: /es/java/com.aspose.html.toolkit.markdown.syntax/markdownsyntaxfactory/autolink/
---
## AutoLink(MarkdownSyntaxToken, TextSyntaxNode, MarkdownSyntaxToken) {#autolink}

Crea [`AutoLinkSyntaxNode`](../../autolinksyntaxnode/).
...
| --- | --- | --- |
| opening | MarkdownSyntaxToken | El MarkdownSyntaxToken. |
| contenido | TextSyntaxNode | El TextSyntax. |
| closing | MarkdownSyntaxToken | El MarkdownSyntaxToken. |
...
| contenido | TextSyntaxNode | El TextSyntax. |
| closing | MarkdownSyntaxToken | El MarkdownSyntaxToken. |
| correo | Boolean | La bandera booleana. |
