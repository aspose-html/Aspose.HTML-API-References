...
description: "Método MarkdownSyntaxFactory. Crea ListItemMarker"
type: docs

url: /es/java/com.aspose.html.toolkit.markdown.syntax/markdownsyntaxfactory/listitemmarker/
---
...
| --- | --- | --- |
| number | MarkdownSyntaxToken | El número. |
| delimitador | MarkdownSyntaxToken | El delimitador. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| token | MarkdownSyntaxToken | El token. |
