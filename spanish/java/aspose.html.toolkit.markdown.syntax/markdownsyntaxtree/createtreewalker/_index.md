...
description: "Método MarkdownSyntaxTree. Define la interfaz para crear el caminante del árbol"
type: docs

url: /es/java/com.aspose.html.toolkit.markdown.syntax/markdownsyntaxtree/createtreewalker/
---
## CreateTreeWalker(MarkdownSyntaxNodeFilter) {#createtreewalker_2}

Define la interfaz para crear el walker del árbol.
