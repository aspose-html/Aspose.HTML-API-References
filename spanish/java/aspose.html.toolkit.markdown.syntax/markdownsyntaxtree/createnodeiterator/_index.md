...
description: "Método MarkdownSyntaxTree. Define la interfaz para crear el iterador de nodos"
type: docs

url: /es/java/com.aspose.html.toolkit.markdown.syntax/markdownsyntaxtree/createnodeiterator/
---
## CreateNodeIterator(MarkdownSyntaxNodeFilter) {#createnodeiterator_2}

Define la interfaz para crear el iterador de nodos.
...
| --- | --- | --- |
| filtro | MarkdownSyntaxNodeFilter | El filtro. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| raíz | MarkdownSyntaxNode | El MarkdownSyntaxNode. |
...
| --- | --- | --- |
| raíz | MarkdownSyntaxNode | El MarkdownSyntaxNode. |
| filtro | MarkdownSyntaxNodeFilter | El MarkdownSyntaxNodeFilter. |
