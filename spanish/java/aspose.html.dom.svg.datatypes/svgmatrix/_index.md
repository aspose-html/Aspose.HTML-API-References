...
Muchas de las operaciones gráficas de SVG utilizan matrices 2x3 de la forma: [a c e] [b d f] que, al expandirse a una matriz 3x3 para fines de aritmética matricial, se convierten en: [a c e] [b d f] [0 0 1]
