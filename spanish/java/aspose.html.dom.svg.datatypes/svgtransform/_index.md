...
SVGTransform es la interfaz para una de las transformaciones componentes dentro de una SVGTransformList; por lo tanto, un objeto SVGTransform corresponde a un único componente (p. ej., 'scale(…)' o 'matrix(…)') dentro de una especificación del atributo ‘transform’.
