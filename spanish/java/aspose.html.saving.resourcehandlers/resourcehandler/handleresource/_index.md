...
description: "Método ResourceHandler. Este método es responsable de manejar el recurso. En él puede guardar el Resource en el flujo o incrustarlo en el recurso padre."
type: docs

url: /es/java/com.aspose.html.saving.resourcehandlers/resourcehandler/handleresource/
---
## ResourceHandler.HandleResource method

Este método es responsable de manejar el recurso. En él puede guardar el [`Resource`](../../../com.aspose.html.saving/resource/) en el flujo o incrustarlo en el recurso padre.
