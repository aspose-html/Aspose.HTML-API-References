...
description: Color método. Devuelve un nuevo Color con la luminosidad solicitada valores A B.
type: docs
weight: 120
url: /es/net/aspose.html.drawing/color/fromlab/
---
## Color.FromLab method

Devuelve un nuevo Color con la luminosidad solicitada, valores A, B.
