...
description: Contiene los parámetros de control de gráficos actuales para elImageDevice./imagedevice . Estos parámetros definen el marco global dentro del cual se ejecutan los operadores gráficos.
type: docs
weight: 4300
