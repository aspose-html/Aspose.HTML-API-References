...
description: Pinta los datos del objeto ImageData dado en el mapa de bits. Si se proporciona un rectángulo sucio solo se pintan los píxeles de ese rectángulo. Este método no se ve afectado por la matriz de transformación del lienzo.
type: docs
weight: 290
