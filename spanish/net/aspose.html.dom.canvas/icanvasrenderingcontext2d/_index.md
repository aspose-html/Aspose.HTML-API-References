...
description: La interfaz ICanvasRenderingContext2D se utiliza para dibujar rectángulos texto imágenes y otros objetos en el elemento del lienzo. Proporciona el contexto de representación 2D para la superficie de dibujo de un elemento de lienzo.
type: docs
weight: 270
