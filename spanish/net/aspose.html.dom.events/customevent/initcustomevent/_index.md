...
description: CustomEvent método. /// ElInitEvent El método se utiliza para inicializar el valor de unEvent creado a través de laIDocumentEvent interfaz.
type: docs
weight: 30
url: /es/net/aspose.html.dom.events/customevent/initcustomevent/
---
