...
description: Los eventos que usan la interfaz CustomEvent se pueden usar para transportar datos personalizados.
type: docs
weight: 740
...
| Nombre | Descripción |
| --- | --- |
| [CustomEvent](customevent#constructor)(string) | Inicializa una nueva instancia del[`CustomEvent`](../customevent) clase. |
| [CustomEvent](customevent#constructor_1)(string, IDictionary&lt;string, object&gt;) | Inicializa una nueva instancia del[`CustomEvent`](../customevent) clase. |
