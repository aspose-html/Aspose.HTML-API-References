...
description: Aspose.Html.Dom.Events.CustomEvent clase. Los eventos que usan la interfaz CustomEvent se pueden usar para transportar datos personalizados.
type: docs
weight: 730
url: /es/net/aspose.html.dom.events/customevent/
---
## CustomEvent class

Los eventos que usan la interfaz CustomEvent se pueden usar para transportar datos personalizados.
...
| Nombre | Descripción |
| --- | --- |
| [CustomEvent](customevent/#constructor)(string) | Inicializa una nueva instancia del`CustomEvent` clase. |
| [CustomEvent](customevent/#constructor_1)(string, IDictionary&lt;string, object&gt;) | Inicializa una nueva instancia del`CustomEvent` clase. |
...
| [Detail](../../aspose.html.dom.events/customevent/detail/) { get; } | Obtiene los datos personalizados. |
...
| [InitCustomEvent](../../aspose.html.dom.events/customevent/initcustomevent/)(string, bool, bool, object) | /// El[`InitEvent`](../event/initevent/) El método se utiliza para inicializar el valor de un[`Event`](../event/) creado a través de la[`IDocumentEvent`](../idocumentevent/) interfaz. |
