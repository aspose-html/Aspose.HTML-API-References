...
| [InitEvent](../../aspose.html.dom.events/event/initevent)(string, bool, bool) | El[`InitEvent`](./initevent) El método se utiliza para inicializar el valor de un[`Event`](../event) creado a través de the [`IDocumentEvent`](../idocumentevent) interfaz. |
