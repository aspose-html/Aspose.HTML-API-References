...
description: La interfaz MouseEvent proporciona información contextual específica asociada con los eventos del mouse.
type: docs
weight: 850
url: /es/net/aspose.html.dom.events/mouseevent/
---
## MouseEvent class
...
| Nombre | Descripción |
| --- | --- |
| [MouseEvent](mouseevent#constructor)(string) | Inicializa una nueva instancia del[`MouseEvent`](../mouseevent) clase. |
| [MouseEvent](mouseevent#constructor_1)(string, IDictionary&lt;string, object&gt;) | Inicializa una nueva instancia del[`MouseEvent`](../mouseevent) clase. |
