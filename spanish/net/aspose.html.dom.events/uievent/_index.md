...
description: Aspose.Html.Dom.Events.UIEvent clase. La interfaz UIEvent proporciona información contextual específica asociada con los eventos de la interfaz de usuario.
type: docs
weight: 850
url: /es/net/aspose.html.dom.events/uievent/
---
## UIEvent class
...
| Nombre | Descripción |
| --- | --- |
| [UIEvent](uievent/#constructor)(string) | Inicializa una nueva instancia del`UIEvent` clase. |
| [UIEvent](uievent/#constructor_1)(string, IDictionary&lt;string, object&gt;) | Inicializa una nueva instancia del`UIEvent` clase. |
