...
type: docs
weight: 10
url: /es/net/aspose.html.dom.events/idocumentevent/createevent/
---
...
| excepción | condición |
| --- | --- |
| [DOMException](../../../aspose.html.dom/domexception/) | NOT_SUPPORTED_ERR: se genera si la implementación no admite el tipo de[`Event`](../../event/) interfaz solicitada |

### Ver también

* class [Event](../../event/)
* interface [IDocumentEvent](../)
* espacio de nombres [Aspose.Html.Dom.Events](../../idocumentevent/)
