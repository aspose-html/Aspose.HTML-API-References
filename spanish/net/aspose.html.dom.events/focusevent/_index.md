...
description: Aspose.Html.Dom.Events.FocusEvent clase. La interfaz FocusEvent proporciona información contextual específica asociada con eventos Focus.
type: docs
weight: 780
url: /es/net/aspose.html.dom.events/focusevent/
---
## FocusEvent class

La interfaz FocusEvent proporciona información contextual específica asociada con eventos Focus.
...
| Nombre | Descripción |
| --- | --- |
| [FocusEvent](focusevent/#constructor)(string) | Inicializa una nueva instancia del`FocusEvent` clase. |
| [FocusEvent](focusevent/#constructor_1)(string, IDictionary&lt;string, object&gt;) | Inicializa una nueva instancia del`FocusEvent` clase. |
...
| [RelatedTarget](../../aspose.html.dom.events/focusevent/relatedtarget/) { get; } | Se utiliza para identificar un EventTarget secundario relacionado con un evento Focus, según el tipo de evento. |
