...
description: La interfaz FocusEvent proporciona información contextual específica asociada con eventos Focus.
type: docs
weight: 790
...
| Nombre | Descripción |
| --- | --- |
| [FocusEvent](focusevent#constructor)(string) | Inicializa una nueva instancia del[`FocusEvent`](../focusevent) clase. |
| [FocusEvent](focusevent#constructor_1)(string, IDictionary&lt;string, object&gt;) | Inicializa una nueva instancia del[`FocusEvent`](../focusevent) clase. |
