...
description: La interfaz SVGPathSegLinetoHorizontalAbs corresponde a un comando de datos de ruta línea horizontal absoluta a H.
type: docs
weight: 1830
url: /es/net/aspose.html.dom.svg.paths/svgpathseglinetohorizontalabs/
---
## SVGPathSegLinetoHorizontalAbs class

La interfaz SVGPathSegLinetoHorizontalAbs corresponde a un comando de datos de ruta "línea horizontal absoluta a" (H).
...
| [X](../../aspose.html.dom.svg.paths/svgpathseglinetohorizontalabs/x) { get; set; } | La coordenada X absoluta para el punto final de este segmento de ruta. |
