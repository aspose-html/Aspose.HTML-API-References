...
description: Aspose.Html.Dom.Svg.Paths.SVGPathSegMovetoRel clase. La interfaz SVGPathSegMovetoRel corresponde a un comando de datos de ruta de movimiento relativo m.
type: docs
weight: 1890
url: /es/net/aspose.html.dom.svg.paths/svgpathsegmovetorel/
---
## SVGPathSegMovetoRel class

La interfaz SVGPathSegMovetoRel corresponde a un comando de datos de ruta de "movimiento relativo" (m).
...
| [X](../../aspose.html.dom.svg.paths/svgpathsegmovetorel/x/) { get; set; } | La coordenada X relativa para el punto final de este segmento de ruta. |
| [Y](../../aspose.html.dom.svg.paths/svgpathsegmovetorel/y/) { get; set; } | La coordenada Y relativa para el punto final de este segmento de ruta. |
