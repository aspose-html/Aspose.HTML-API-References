...
description: La interfaz SVGPathSegClosePath corresponde a un comando de datos de ruta closepath z.
type: docs
weight: 1730
url: /es/net/aspose.html.dom.svg.paths/svgpathsegclosepath/
---
## SVGPathSegClosePath class

La interfaz SVGPathSegClosePath corresponde a un comando de datos de ruta "closepath" (z).
