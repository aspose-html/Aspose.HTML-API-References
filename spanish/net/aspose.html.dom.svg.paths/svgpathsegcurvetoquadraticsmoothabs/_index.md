...
description: La interfaz SVGPathSegCurvetoQuadraticSmoothAbs corresponde a un comando de datos de ruta absolute smooth cubic curveto T.
type: docs
weight: 1800
url: /es/net/aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticsmoothabs/
---
## SVGPathSegCurvetoQuadraticSmoothAbs class

La interfaz SVGPathSegCurvetoQuadraticSmoothAbs corresponde a un comando de datos de ruta "absolute smooth cubic curveto" (T).
...
| [X](../../aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticsmoothabs/x) { get; set; } | La coordenada X absoluta para el punto final de este segmento de ruta. |
| [Y](../../aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticsmoothabs/y) { get; set; } | La coordenada Y absoluta para el punto final de este segmento de ruta. |
