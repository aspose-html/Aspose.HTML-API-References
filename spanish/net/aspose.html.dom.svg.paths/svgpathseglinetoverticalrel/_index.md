...
description: Aspose.Html.Dom.Svg.Paths.SVGPathSegLinetoVerticalRel clase. La interfaz SVGPathSegLinetoVerticalRel corresponde a un comando de datos de ruta de línea vertical relativa a v.
type: docs
weight: 1860
url: /es/net/aspose.html.dom.svg.paths/svgpathseglinetoverticalrel/
---
## SVGPathSegLinetoVerticalRel class

La interfaz SVGPathSegLinetoVerticalRel corresponde a un comando de datos de ruta de "línea vertical relativa a" (v).
...
| [Y](../../aspose.html.dom.svg.paths/svgpathseglinetoverticalrel/y/) { get; set; } | La coordenada Y relativa para el punto final de este segmento de ruta. |
