...
description: El evento de zoom ocurre cuando el usuario inicia una acción que hace que la vista actual del fragmento del documento SVG se reescale. Los controladores de eventos solo se reconocen en elementos svg.
type: docs
weight: 1340
