...
description: Aspose.Html.Dom.Node clase. La interfaz de nodo es el tipo de datos principal para todo el modelo de objetos de documento. Representa un solo nodo en el árbol del documento.
type: docs
weight: 1000
url: /es/net/aspose.html.dom/node/
---
## Node class
...
| abstract [NodeName](../../aspose.html.dom/node/nodename/) { get; } | El nombre de este nodo, dependiendo de su tipo. |
| abstract [NodeType](../../aspose.html.dom/node/nodetype/) { get; } | Un código que representa el tipo del objeto subyacente. |
...
| [CloneNode](../../aspose.html.dom/node/clonenode/#clonenode)() | Devuelve un duplicado de este nodo, es decir, sirve como constructor de copia genérico para nodos. El nodo duplicado no tiene padre (parentNode es nulo) y no tiene datos de usuario. |
| [CloneNode](../../aspose.html.dom/node/clonenode/#clonenode_1)(bool) | Devuelve un duplicado de este nodo, es decir, sirve como constructor de copia genérico para nodos. El nodo duplicado no tiene padre (parentNode es nulo) y no tiene datos de usuario. |
...
| Nombre | Descripción |
| --- | --- |
| const [ATTRIBUTE_NODE](../../aspose.html.dom/node/attribute_node/) | Un atributo node |
| const [CDATA_SECTION_NODE](../../aspose.html.dom/node/cdata_section_node/) | Una sección cdata node |
| const [COMMENT_NODE](../../aspose.html.dom/node/comment_node/) | Un nodo de comentario |
| const [DOCUMENT_FRAGMENT_NODE](../../aspose.html.dom/node/document_fragment_node/) | Un fragmento de documento node |
| const [DOCUMENT_NODE](../../aspose.html.dom/node/document_node/) | Un nodo de documento |
| const [DOCUMENT_TYPE_NODE](../../aspose.html.dom/node/document_type_node/) | Un tipo de documento node |
| const [ELEMENT_NODE](../../aspose.html.dom/node/element_node/) | Un elemento node |
| const [ENTITY_NODE](../../aspose.html.dom/node/entity_node/) | Un nodo de entidad |
| const [ENTITY_REFERENCE_NODE](../../aspose.html.dom/node/entity_reference_node/) | Un nodo de referencia de entidad |
| const [NOTATION_NODE](../../aspose.html.dom/node/notation_node/) | Un nodo de notación |
| const [PROCESSING_INSTRUCTION_NODE](../../aspose.html.dom/node/processing_instruction_node/) | Una instrucción de procesamiento node |
| const [TEXT_NODE](../../aspose.html.dom/node/text_node/) | Un nodo de texto |
