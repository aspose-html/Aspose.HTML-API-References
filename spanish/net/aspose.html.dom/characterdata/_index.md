...
description: Aspose.Html.Dom.CharacterData clase. CharacterData amplía el nodo con un conjunto de atributos y métodos para acceder a los datos de caracteres en el DOM.
type: docs
weight: 300
url: /es/net/aspose.html.dom/characterdata/
---
## CharacterData class

CharacterData amplía el nodo con un conjunto de atributos y métodos para acceder a los datos de caracteres en el DOM.
