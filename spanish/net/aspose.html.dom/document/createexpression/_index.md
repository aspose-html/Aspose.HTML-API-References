...
type: docs
weight: 890
url: /es/net/aspose.html.dom/document/createexpression/
---
...
| excepción | condición |
| --- | --- |
| [DOMException](../../domexception/) | INVALID_EXPRESSION_ERR: Se genera si la expresión no es legal de acuerdo con las reglas de la[`IXPathEvaluator`](../../../aspose.html.dom.xpath/ixpathevaluator/). |
| [DOMException](../../domexception/) | NAMESPACE_ERR: se genera si la expresión contiene prefijos de espacio de nombres que no pueden ser resueltos por el especificado[`IXPathNSResolver`](../../../aspose.html.dom.xpath/ixpathnsresolver/). |
