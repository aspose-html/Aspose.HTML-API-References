...
description: Aspose.Html.Dom.ShadowRoot clase. ShadowRoot es un nodo raíz del árbol de sombra.
type: docs
weight: 1030
url: /es/net/aspose.html.dom/shadowroot/
---
## ShadowRoot class

ShadowRoot es un nodo raíz del árbol de sombra.
