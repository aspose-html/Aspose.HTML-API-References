...
type: docs
weight: 20
url: /es/net/aspose.html.dom/eventtarget/dispatchevent/
---
...
El valor de retorno de`DispatchEvent` indica si alguno de los oyentes que manejaron el evento llamado[`PreventDefault`](../../../aspose.html.dom.events/event/preventdefault/) . Si[`PreventDefault`](../../../aspose.html.dom.events/event/preventdefault/) fue llamado el valor es falso, de lo contrario el valor es verdadero.
