...
description: Aspose.Html.Dom.Text clase. La interfaz de texto hereda de CharacterData y representa el contenido textual denominado datos de caracteres en XML de un elemento o atributo.
type: docs
weight: 2450
url: /es/net/aspose.html.dom/text/
---
## Text class

La interfaz de texto hereda de CharacterData y representa el contenido textual (denominado datos de caracteres en XML) de un elemento o atributo.
...
| virtual [Data](../../aspose.html.dom/characterdata/data/) { get; set; } | Los datos de carácter del nodo que implementa esta interfaz. |
| [FirstChild](../../aspose.html.dom/node/firstchild/) { get; } | El primer hijo de este nodo. Si no existe tal nodo, esto devuelve nulo. |
| [IsElementContentWhitespace](../../aspose.html.dom/text/iselementcontentwhitespace/) { get; } | Devuelve si este nodo de texto contiene espacios en blanco del contenido del elemento, a menudo llamados abusivamente "espacios en blanco ignorables". |
| [LastChild](../../aspose.html.dom/node/lastchild/) { get; } | El último hijo de este nodo. Si no existe tal nodo, esto devuelve nulo. |
| [Length](../../aspose.html.dom/characterdata/length/) { get; } | El número de unidades de 16 bits que están disponibles a través de los datos y el método substringData a continuación. Esto puede tener el valor cero, es decir, los nodos CharacterData pueden estar vacíos. |
...
| override [NodeName](../../aspose.html.dom/text/nodename/) { get; } | El nombre de este nodo, dependiendo de su tipo. |
| override [NodeType](../../aspose.html.dom/text/nodetype/) { get; } | Un código que representa el tipo del objeto subyacente. |
| override [NodeValue](../../aspose.html.dom/text/nodevalue/) { get; set; } | El valor de este nodo, según su tipo. |
...
| [WholeText](../../aspose.html.dom/text/wholetext/) { get; } | Devuelve todo el texto de los nodos de texto lógicamente adyacentes a este nodo, concatenados en el orden del documento. |
...
| virtual [AppendData](../../aspose.html.dom/characterdata/appenddata/)(string) | Agrega la cadena al final de los datos de carácter del nodo. |
...
| virtual [DeleteData](../../aspose.html.dom/characterdata/deletedata/)(int, int) | Eliminar un rango de unidades de 16 bits del nodo. |
...
| virtual [InsertData](../../aspose.html.dom/characterdata/insertdata/)(int, string) | Inserta una cadena en el desplazamiento de unidad de 16 bits especificado. |
...
| virtual [ReplaceData](../../aspose.html.dom/characterdata/replacedata/)(int, int, string) | Reemplace los caracteres que comienzan en el desplazamiento de unidad de 16 bits especificado con la cadena especificada. |
...
| [SplitText](../../aspose.html.dom/text/splittext/)(int) | Divide este nodo en dos nodos en el desplazamiento especificado, manteniendo ambos en el árbol como hermanos. |
| virtual [SubstringData](../../aspose.html.dom/characterdata/substringdata/)(int, int) | Extrae un rango de datos del nodo. |
| override [ToString](../../aspose.html.dom/characterdata/tostring/)() | Devuelve unString que representa esta instancia. |
