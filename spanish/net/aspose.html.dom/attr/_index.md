...
description: Aspose.Html.Dom.Attr clase. La interfaz Attr representa un atributo en un objeto Element. Normalmente los valores permitidos para el atributo se definen en un esquema asociado con el documento.
type: docs
weight: 110
url: /es/net/aspose.html.dom/attr/
---
## Attr class
...
| [IsId](../../aspose.html.dom/attr/isid/) { get; } | Devuelve si se sabe que este atributo es de tipo ID (es decir, si contiene un identificador para su elemento propietario) o no. |
| [LastChild](../../aspose.html.dom/node/lastchild/) { get; } | El último hijo de este nodo. Si no existe tal nodo, esto devuelve nulo. |
| override [LocalName](../../aspose.html.dom/attr/localname/) { get; } | Devuelve la parte local del nombre calificado de este nodo. Para los nodos de cualquier tipo que no sean ELEMENT_NODE y ATTRIBUTE_NODE y los nodos creados con un método DOM Nivel 1, como Document.createElement(), esto siempre es nulo. |
| [Name](../../aspose.html.dom/attr/name/) { get; } | Devuelve el nombre de este atributo. |
| override [NamespaceURI](../../aspose.html.dom/attr/namespaceuri/) { get; } | El URI del espacio de nombres de este nodo, o nulo si no se especifica. |
...
| override [NodeName](../../aspose.html.dom/attr/nodename/) { get; } | El nombre de este nodo, dependiendo de su tipo. |
| override [NodeType](../../aspose.html.dom/attr/nodetype/) { get; } | Un código que representa el tipo del objeto subyacente. |
| override [NodeValue](../../aspose.html.dom/attr/nodevalue/) { get; set; } | El valor de este nodo, según su tipo. |
...
| [OwnerElement](../../aspose.html.dom/attr/ownerelement/) { get; } | El nodo Elemento al que está asociado este atributo o nulo si este atributo no está en uso. |
...
| override [Prefix](../../aspose.html.dom/attr/prefix/) { get; } | El prefijo del espacio de nombres de este nodo, o nulo si no se especifica. Cuando se define como nulo, configurarlo no tiene efecto |
...
| [SchemaTypeInfo](../../aspose.html.dom/attr/schematypeinfo/) { get; } | La información de tipo asociada con este atributo. |
| [Specified](../../aspose.html.dom/attr/specified/) { get; } | Verdadero si a este atributo se le dio explícitamente un valor en el documento de instancia, falso en caso contrario. |
| override [TextContent](../../aspose.html.dom/attr/textcontent/) { get; set; } | Este atributo devuelve el contenido de texto de este nodo y sus descendientes. Cuando se define como nulo, establecerlo no tiene ningún efecto. En la configuración, se eliminan todos los posibles elementos secundarios que este nodo pueda tener y, si la nueva cadena no está vacía o es nula, se reemplaza por un solo nodo de texto que contiene la cadena en la que se establece este atributo. |
| [Value](../../aspose.html.dom/attr/value/) { get; set; } | En la recuperación, el valor del atributo se devuelve como una cadena. |
