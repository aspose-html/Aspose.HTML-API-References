...
description: Aspose.Html.Dom.Entity clase. Representa una entidad conocida analizada o no analizada en un documento XML.
type: docs
weight: 700
url: /es/net/aspose.html.dom/entity/
---
## Entity class
...
| [InputEncoding](../../aspose.html.dom/entity/inputencoding/) { get; } | Un atributo que especifica la codificación utilizada para esta entidad en el momento del análisis, cuando se trata de una entidad analizada externa. Esto es nulo si es una entidad del subconjunto interno o si no se conoce. |
...
| override [NodeName](../../aspose.html.dom/entity/nodename/) { get; } | El nombre de este nodo, dependiendo de su tipo. |
| override [NodeType](../../aspose.html.dom/entity/nodetype/) { get; } | Un código que representa el tipo del objeto subyacente. |
| virtual [NodeValue](../../aspose.html.dom/node/nodevalue/) { get; set; } | El valor de este nodo, según su tipo. |
| [NotationName](../../aspose.html.dom/entity/notationname/) { get; } | Para entidades no analizadas, el nombre de la notación para la entidad. Para entidades analizadas, esto es nulo. |
...
| [PublicId](../../aspose.html.dom/entity/publicid/) { get; } | El identificador público asociado con la entidad si se especifica, y nulo en caso contrario. |
| [SystemId](../../aspose.html.dom/entity/systemid/) { get; } | El identificador del sistema asociado con la entidad si se especifica, y nulo en caso contrario. Puede ser un URI absoluto o no. |
...
| [XmlEncoding](../../aspose.html.dom/entity/xmlencoding/) { get; } | Un atributo que especifica, como parte de la declaración de texto, la codificación de esta entidad, cuando se trata de una entidad analizada externa. Esto es nulo de lo contrario. |
| [XmlVersion](../../aspose.html.dom/entity/xmlversion/) { get; } | Un atributo que especifica, como parte de la declaración de texto, el número de versión de esta entidad, cuando se trata de una entidad analizada externa. Esto es nulo de lo contrario. |
