...
description: DocumentFragment es un objeto de documento ligero o mínimo. Es muy común querer poder extraer una parte del árbol de un documento o crear un nuevo fragmento de un documento.
type: docs
weight: 680
