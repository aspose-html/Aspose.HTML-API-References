...
description: Aspose.Html.Dom.ProcessingInstruction clase. ProcessingInstruction representa una instrucción de procesamiento utilizada en XML como una forma de mantener información específica del procesador en el texto del documento.
type: docs
weight: 1020
url: /es/net/aspose.html.dom/processinginstruction/
---
...
| override [NodeName](../../aspose.html.dom/processinginstruction/nodename/) { get; } | El nombre de este nodo, dependiendo de su tipo. |
| override [NodeType](../../aspose.html.dom/processinginstruction/nodetype/) { get; } | Un código que representa el tipo del objeto subyacente. |
| override [NodeValue](../../aspose.html.dom/processinginstruction/nodevalue/) { get; set; } | El valor de este nodo, según su tipo. |
