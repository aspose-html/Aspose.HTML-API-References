...
description: Aspose.Html.Dom.EntityReference clase. Los nodos EntityReference se pueden usar para representar una referencia de entidad en el árbol.
type: docs
weight: 710
url: /es/net/aspose.html.dom/entityreference/
---
## EntityReference class

Los nodos EntityReference se pueden usar para representar una referencia de entidad en el árbol.
...
| override [NodeName](../../aspose.html.dom/entityreference/nodename/) { get; } | El nombre de este nodo, dependiendo de su tipo. |
| override [NodeType](../../aspose.html.dom/entityreference/nodetype/) { get; } | Un código que representa el tipo del objeto subyacente. |
