...
description: Aspose.Html.Dom.Comment clase. Hereda de CharacterData y representa el contenido de un comentario es decir todos los caracteres entre el inicio  .
type: docs
weight: 310
url: /es/net/aspose.html.dom/comment/
---
## Comment class

Hereda de CharacterData y representa el contenido de un comentario, es decir, todos los caracteres entre el inicio ' .
...
| override [NodeName](../../aspose.html.dom/comment/nodename/) { get; } | El nombre de este nodo, dependiendo de su tipo. |
| override [NodeType](../../aspose.html.dom/comment/nodetype/) { get; } | Un código que representa el tipo del objeto subyacente. |
| override [NodeValue](../../aspose.html.dom/comment/nodevalue/) { get; set; } | El valor de este nodo, según su tipo. |
