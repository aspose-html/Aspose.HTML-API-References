...
description: DocumentType proporciona una interfaz a la lista de entidades definidas para document
type: docs
weight: 690
...
| Nombre | Descripción |
| --- | --- |
| [DocumentType](documenttype)(string, string, string, string, Document) | Inicializa una nueva instancia del[`DocumentType`](../documenttype) clase. |
