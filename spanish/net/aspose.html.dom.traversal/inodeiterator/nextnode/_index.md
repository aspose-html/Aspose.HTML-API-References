...
description: Devuelve el siguiente nodo del conjunto y avanza la posición del iterador en el conjunto. Después de crear un NodeIterator la primera llamada a nextNode devuelve el primer nodo en el conjunto.
type: docs
weight: 40
