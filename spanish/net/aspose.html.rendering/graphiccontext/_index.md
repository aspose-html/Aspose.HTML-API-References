...
description: Contiene los parámetros de control de gráficos actuales. Estos parámetros definen el marco global dentro del cual se ejecutan los operadores de gráficos.
type: docs
weight: 4250
...
| Nombre | Descripción |
| --- | --- |
| [GraphicContext](graphiccontext)() | Inicializa una nueva instancia del[`GraphicContext`](../graphiccontext) clase. |
