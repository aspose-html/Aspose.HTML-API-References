...
description: Aspose.Html.Rendering.GraphicContext clase. Contiene los parámetros de control de gráficos actuales. Estos parámetros definen el marco global dentro del cual se ejecutan los operadores de gráficos.
type: docs
weight: 4260
url: /es/net/aspose.html.rendering/graphiccontext/
---
## GraphicContext class

Contiene los parámetros de control de gráficos actuales. Estos parámetros definen el marco global dentro del cual se ejecutan los operadores de gráficos.
...
| Nombre | Descripción |
| --- | --- |
| [GraphicContext](graphiccontext/)() | Inicializa una nueva instancia del`GraphicContext` clase. |
...
| virtual [TextInfo](../../aspose.html.rendering/graphiccontext/textinfo/) { get; } | Obtiene un[`TextInfo`](../textinfo/) objeto que contiene información sobre el texto renderizado. |
| virtual [TransformationMatrix](../../aspose.html.rendering/graphiccontext/transformationmatrix/) { get; set; } | Establece u obtiene la matriz de transformación. |

## Métodos

| Nombre | Descripción |
| --- | --- |
| virtual [Clone](../../aspose.html.rendering/graphiccontext/clone/)() | Crea una nueva instancia de una clase GraphicContext con los mismos valores de propiedad que una instancia existente. |
| virtual [Transform](../../aspose.html.rendering/graphiccontext/transform/)(Matrix) | Modifica la matriz de transformación actual multiplicando la matriz especificada. |
