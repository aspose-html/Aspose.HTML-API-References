...
description: Aspose.Html.Dom.Svg.SVGPatternElement clase. La interfaz SVGPatternElement corresponde al elemento patrón.
type: docs
weight: 2200
url: /es/net/aspose.html.dom.svg/svgpatternelement/
---
## SVGPatternElement class

La interfaz SVGPatternElement corresponde al elemento 'patrón'.
...
| [Height](../../aspose.html.dom.svg/svgpatternelement/height/) { get; } | Corresponde al atributo 'altura' en el elemento 'patrón' dado. |
| [Href](../../aspose.html.dom.svg/svgpatternelement/href/) { get; } | Corresponde al atributo 'xlink:href' en el elemento dado. |
...
| [PatternContentUnits](../../aspose.html.dom.svg/svgpatternelement/patterncontentunits/) { get; } | Corresponde al atributo 'patternContentUnits' en el elemento 'pattern' dado. Toma una de las constantes definidas en SVGUnitTypes. |
| [PatternTransform](../../aspose.html.dom.svg/svgpatternelement/patterntransform/) { get; } | Corresponde al atributo 'patternTransform' en el elemento 'pattern' dado. |
| [PatternUnits](../../aspose.html.dom.svg/svgpatternelement/patternunits/) { get; } | Corresponde al atributo 'patternUnits' en el elemento 'pattern' dado. Toma una de las constantes definidas en SVGUnitTypes. |
...
| [PreserveAspectRatio](../../aspose.html.dom.svg/svgpatternelement/preserveaspectratio/) { get; } | Corresponde al atributo 'preserveAspectRatio' en el elemento dado. |
...
| [RequiredExtensions](../../aspose.html.dom.svg/svgpatternelement/requiredextensions/) { get; } | Corresponde al atributo 'extensiones requeridas' en el elemento dado. |
| [RequiredFeatures](../../aspose.html.dom.svg/svgpatternelement/requiredfeatures/) { get; } | Corresponde al atributo 'requiredFeatures' en el elemento dado. |
...
| [SystemLanguage](../../aspose.html.dom.svg/svgpatternelement/systemlanguage/) { get; } | Corresponde al atributo 'systemLanguage' en el elemento dado. |
...
| [ViewBox](../../aspose.html.dom.svg/svgpatternelement/viewbox/) { get; } | Corresponde al atributo 'viewBox' en el elemento dado. |
...
| [Width](../../aspose.html.dom.svg/svgpatternelement/width/) { get; } | Corresponde al atributo 'ancho' en el elemento 'patrón' dado. |
| [X](../../aspose.html.dom.svg/svgpatternelement/x/) { get; } | Corresponde al atributo 'x' en el elemento 'patrón' dado. |
| [Y](../../aspose.html.dom.svg/svgpatternelement/y/) { get; } | Corresponde al atributo 'y' en el elemento 'patrón' dado. |
