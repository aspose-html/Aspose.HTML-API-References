...
| [Height](../../aspose.html.dom.svg/svgsvgelement/height/) { get; } | Corresponde al atributo 'altura' en el elemento 'svg' dado. |
...
| [PreserveAspectRatio](../../aspose.html.dom.svg/svgsvgelement/preserveaspectratio/) { get; } | Corresponde al atributo 'preserveAspectRatio' en el elemento dado. |
...
| [ViewBox](../../aspose.html.dom.svg/svgsvgelement/viewbox/) { get; } | Corresponde al atributo 'viewBox' en el elemento dado. |
...
| [Width](../../aspose.html.dom.svg/svgsvgelement/width/) { get; } | Corresponde al atributo 'ancho' en el elemento 'svg' dado. |
| [X](../../aspose.html.dom.svg/svgsvgelement/x/) { get; } | Corresponde al atributo 'x' en el elemento 'svg' dado. |
| [Y](../../aspose.html.dom.svg/svgsvgelement/y/) { get; } | Corresponde al atributo 'y' en el elemento 'svg' dado. |
| [ZoomAndPan](../../aspose.html.dom.svg/svgsvgelement/zoomandpan/) { get; set; } | Corresponde al atributo 'zoomAndPan' en el elemento dado. El valor debe ser una de las constantes SVG_ZOOMANDPAN_* definidas en esta interfaz. |
...
| [AnimationsPaused](../../aspose.html.dom.svg/svgsvgelement/animationspaused/)() | Devuelve verdadero si este fragmento de documento SVG está en estado de pausa. |
...
| [CreateEvent](../../aspose.html.dom.svg/svgsvgelement/createevent/)(string) | Crea un[`Event`](../../aspose.html.dom.events/event/) de un tipo soportado por la implementación. |
| [CreateSVGAngle](../../aspose.html.dom.svg/svgsvgelement/createsvgangle/)() | Crea un objeto SVGAngle fuera de cualquier árbol de documentos. El objeto se inicializa con el valor 0 grados (sin unidades). |
| [CreateSVGLength](../../aspose.html.dom.svg/svgsvgelement/createsvglength/)() | Crea un objeto SVGLength fuera de cualquier árbol de documentos. El objeto se inicializa con el valor de 0 unidades de usuario. |
| [CreateSVGMatrix](../../aspose.html.dom.svg/svgsvgelement/createsvgmatrix/)() | Crea un objeto SVGMatrix fuera de cualquier árbol de documentos. El objeto se inicializa en la matriz de identidad. |
| [CreateSVGNumber](../../aspose.html.dom.svg/svgsvgelement/createsvgnumber/)() | Crea un objeto SVGNumber fuera de cualquier árbol de documentos. El objeto se inicializa con un valor de cero. |
| [CreateSVGPoint](../../aspose.html.dom.svg/svgsvgelement/createsvgpoint/)() | Crea un objeto SVGPoint fuera de cualquier árbol de documentos. El objeto se inicializa en el punto (0,0) en el sistema de coordenadas del usuario. |
| [CreateSVGRect](../../aspose.html.dom.svg/svgsvgelement/createsvgrect/)() | Crea un objeto SVGRect fuera de cualquier árbol de documentos. El objeto se inicializa de modo que todos los valores se establezcan en 0 unidades de usuario. |
| [CreateSVGTransform](../../aspose.html.dom.svg/svgsvgelement/createsvgtransform/)() | Crea un objeto SVGTransform fuera de cualquier árbol de documentos. El objeto se inicializa en una transformación de matriz de identidad (SVG_TRANSFORM_MATRIX). |
...
| [UnpauseAnimations](../../aspose.html.dom.svg/svgsvgelement/unpauseanimations/)() | Reactiva la suspensión (es decir, reanuda) las animaciones que se están ejecutando actualmente y que están definidas en el fragmento del documento SVG, lo que hace que el reloj de la animación continúe desde el momento en que se suspendió. |
