...
description: Aspose.Html.Dom.Svg.SVGGraphicsElement clase. La interfaz SVGGraphicsElement representa elementos SVG cuyo objetivo principal es representar gráficos directamente en un grupo.
type: docs
weight: 2110
url: /es/net/aspose.html.dom.svg/svggraphicselement/
---
## SVGGraphicsElement class

La interfaz SVGGraphicsElement representa elementos SVG cuyo objetivo principal es representar gráficos directamente en un grupo.
