...
description: Aspose.Html.Dom.Svg.SVGSetElement clase. La interfaz SVGSetElement corresponde al elemento set. El acceso orientado a objetos a los atributos del elemento set a través del DOM SVG no está disponible.
type: docs
weight: 2280
url: /es/net/aspose.html.dom.svg/svgsetelement/
---
## SVGSetElement class

La interfaz SVGSetElement corresponde al elemento 'set'. El acceso orientado a objetos a los atributos del elemento 'set' a través del DOM SVG no está disponible.
