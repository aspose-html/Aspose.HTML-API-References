...
description: La interfaz SVGSetElement corresponde al elemento set. El acceso orientado a objetos a los atributos del elemento set a través del DOM SVG no está disponible.
type: docs
weight: 2290
