...
description: Aspose.Html.Dom.Svg.SVGAnimationElement clase. La interfaz SVGAnimationElement es la interfaz base para todas las interfaces de elementos de animación SVGAnimateElement SVGSetElement SVGAnimateColorElement SVGAnimateMotionElement y SVGAnimateTransformElement.
type: docs
weight: 1940
url: /es/net/aspose.html.dom.svg/svganimationelement/
---
## SVGAnimationElement class

La interfaz SVGAnimationElement es la interfaz base para todas las interfaces de elementos de animación: SVGAnimateElement, SVGSetElement, SVGAnimateColorElement, SVGAnimateMotionElement y SVGAnimateTransformElement.
...
| [RequiredExtensions](../../aspose.html.dom.svg/svganimationelement/requiredextensions/) { get; } | Corresponde al atributo 'extensiones requeridas' en el elemento dado. |
| [RequiredFeatures](../../aspose.html.dom.svg/svganimationelement/requiredfeatures/) { get; } | Corresponde al atributo 'requiredFeatures' en el elemento dado. |
...
| [SystemLanguage](../../aspose.html.dom.svg/svganimationelement/systemlanguage/) { get; } | Corresponde al atributo 'systemLanguage' en el elemento dado. |
| [TagName](../../aspose.html.dom/element/tagname/) { get; } | El nombre del elemento. |
| [TargetElement](../../aspose.html.dom.svg/svganimationelement/targetelement/) { get; } | El elemento que se está animando. |
