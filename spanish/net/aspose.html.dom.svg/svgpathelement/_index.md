...
description: Aspose.Html.Dom.Svg.SVGPathElement clase. La interfaz SVGPathElement corresponde al elemento ruta.
type: docs
weight: 2190
url: /es/net/aspose.html.dom.svg/svgpathelement/
---
## SVGPathElement class

La interfaz SVGPathElement corresponde al elemento 'ruta'.
...
| [ClassName](../../aspose.html.dom.svg/svgelement/classname/) { get; } | Corresponde al atributo 'clase' en el elemento dado. |
| [ClassName](../../aspose.html.dom/element/classname/) { get; set; } | El atributo de clase del elemento. Este atributo se ha renombrado debido debido a conflictos con la palabra clave "clase" expuesta por muchos idiomas. Ver la definición del atributo de clase en HTML 4.01. |
| [FarthestViewportElement](../../aspose.html.dom.svg/svggraphicselement/farthestviewportelement/) { get; } | El elemento 'svg' del ancestro más lejano. Nulo si el elemento actual es el elemento svg más externo. |
...
| [Id](../../aspose.html.dom.svg/svgelement/id/) { get; set; } | El valor del atributo 'id' en el elemento dado, o la cadena vacía si 'id' no está presente. |
...
| [NearestViewportElement](../../aspose.html.dom.svg/svggraphicselement/nearestviewportelement/) { get; } | El elemento que estableció la ventana gráfica actual. A menudo, el elemento 'svg' del ancestro más cercano. Nulo si el elemento actual es el elemento svg más externo. |
...
| [OwnerSVGElement](../../aspose.html.dom.svg/svgelement/ownersvgelement/) { get; } | El elemento 'svg' del ancestro más cercano. Nulo si el elemento dado es el elemento svg más externo. |
...
| [PathLength](../../aspose.html.dom.svg/svggeometryelement/pathlength/) { get; } | Corresponde al atributo pathLength en el elemento dado. |
| [PathSegList](../../aspose.html.dom.svg/svgpathelement/pathseglist/) { get; set; } | Proporciona acceso al contenido base (es decir, estático) del atributo 'd' en una forma que coincide uno a uno con la sintaxis de SVG. Por lo tanto, si el atributo 'd' tiene un comando "absolute moveto (M)" y "absolute arcto (A)", entonces pathSegList tendrá dos entradas: un SVG_PATHSEG_MOVETO_ABS y un SVG_PATHSEG_ARC_ABS. |
...
| [RequiredExtensions](../../aspose.html.dom.svg/svggraphicselement/requiredextensions/) { get; } | Corresponde al atributo 'extensiones requeridas' en el elemento dado. |
| [RequiredFeatures](../../aspose.html.dom.svg/svggraphicselement/requiredfeatures/) { get; } | Corresponde al atributo 'requiredFeatures' en el elemento dado. |
...
| [Style](../../aspose.html.dom.svg/svgelement/style/) { get; } | Corresponde al atributo 'estilo' en el elemento dado. Si la aplicación de usuario no admite estilos con CSS, este atributo siempre debe tener el valor null. |
| [SystemLanguage](../../aspose.html.dom.svg/svggraphicselement/systemlanguage/) { get; } | Corresponde al atributo 'systemLanguage' en el elemento dado. |
...
| [Transform](../../aspose.html.dom.svg/svggraphicselement/transform/) { get; } | Corresponde al atributo 'transformar' en el elemento dado. |
| [ViewportElement](../../aspose.html.dom.svg/svgelement/viewportelement/) { get; } | El elemento que estableció la ventana gráfica actual. A menudo, el elemento 'svg' del ancestro más cercano. Nulo si el elemento dado es el elemento svg más externo. |
...
| [CreateSVGPathSegArcAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegarcabs/)(float, float, float, float, float, bool, bool) | Devuelve un objeto SVGPathSegArcAbs independiente y sin padres. |
| [CreateSVGPathSegArcRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegarcrel/)(float, float, float, float, float, bool, bool) | Devuelve un objeto SVGPathSegArcRel independiente y sin padres. |
| [CreateSVGPathSegClosePath](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegclosepath/)() | Devuelve un objeto SVGPathSegClosePath independiente y sin padres. |
| [CreateSVGPathSegCurvetoCubicAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicabs/)(float, float, float, float, float, float) | Devuelve un objeto SVGPathSegCurvetoCubicAbs independiente y sin padres. |
| [CreateSVGPathSegCurvetoCubicRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicrel/)(float, float, float, float, float, float) | Devuelve un objeto SVGPathSegCurvetoCubicRel independiente y sin padres. |
| [CreateSVGPathSegCurvetoCubicSmoothAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothabs/)(float, float, float, float) | Devuelve un objeto SVGPathSegCurvetoCubicSmoothAbs independiente y sin padres. |
| [CreateSVGPathSegCurvetoCubicSmoothRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothrel/)(float, float, float, float) | Devuelve un objeto SVGPathSegCurvetoCubicSmoothRel independiente y sin padre. |
| [CreateSVGPathSegCurvetoQuadraticAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticabs/)(float, float, float, float) | Devuelve un objeto SVGPathSegCurvetoQuadraticAbs independiente y sin padres. |
| [CreateSVGPathSegCurvetoQuadraticRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticrel/)(float, float, float, float) | Devuelve un objeto SVGPathSegCurvetoQuadraticRel independiente y sin padres. |
| [CreateSVGPathSegCurvetoQuadraticSmoothAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothabs/)(float, float) | Devuelve un objeto SVGPathSegCurvetoQuadraticSmoothAbs independiente y sin padre. |
| [CreateSVGPathSegCurvetoQuadraticSmoothRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothrel/)(float, float) | Devuelve un objeto SVGPathSegCurvetoQuadraticSmoothRel independiente y sin padre. |
| [CreateSVGPathSegLinetoAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoabs/)(float, float) | Devuelve un objeto SVGPathSegLinetoAbs independiente y sin padres. |
| [CreateSVGPathSegLinetoHorizontalAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetohorizontalabs/)(float) | Devuelve un objeto SVGPathSegLinetoHorizontalAbs independiente y sin padre. |
| [CreateSVGPathSegLinetoHorizontalRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetohorizontalrel/)(float) | Devuelve un objeto SVGPathSegLinetoHorizontalRel independiente y sin padre. |
| [CreateSVGPathSegLinetoRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetorel/)(float, float) | Devuelve un objeto SVGPathSegLinetoRel independiente y sin padre. |
| [CreateSVGPathSegLinetoVerticalAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoverticalabs/)(float) | Devuelve un objeto SVGPathSegLinetoVerticalAbs independiente y sin padres. |
| [CreateSVGPathSegLinetoVerticalRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoverticalrel/)(float) | Devuelve un objeto SVGPathSegLinetoVerticalRel independiente y sin padres. |
| [CreateSVGPathSegMovetoAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegmovetoabs/)(float, float) | Devuelve un objeto SVGPathSegMovetoAbs independiente y sin padres. |
| [CreateSVGPathSegMovetoRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegmovetorel/)(float, float) | Devuelve un objeto SVGPathSegMovetoRel independiente y sin padres. |
...
| [GetEquivalentPath](../../aspose.html.dom.svg/svggeometryelement/getequivalentpath/)() | Devuelve una nueva instancia instancia del[`SVGPathSegList`](../../aspose.html.dom.svg.paths/svgpathseglist/) que representa[`SVGGeometryElement`](../svggeometryelement/) como segmentos de ruta. |
...
| [GetPointAtLength](../../aspose.html.dom.svg/svggeometryelement/getpointatlength/)(float) | Devuelve la coordenada (x,y) en el espacio del usuario, que son unidades de distancia a lo largo de la ruta, utilizando el algoritmo de distancia a lo largo de una ruta del agente de usuario. |
| [GetScreenCTM](../../aspose.html.dom.svg/svggraphicselement/getscreenctm/)() | Devuelve la matriz de transformación de las unidades de usuario actuales (es decir, después de la aplicación del atributo 'transformar', si corresponde) al aviso del agente de usuario principal de un "píxel". Para dispositivos de visualización, idealmente esto representa un píxel de pantalla física. Para otros dispositivos o entornos en los que no se conocen los tamaños de píxeles físicos, se puede usar un algoritmo similar a la definición CSS2 de un "píxel". Tenga en cuenta que se devuelve un valor nulo si este elemento no está vinculado al árbol del documento. Este método se habría llamado más acertadamente como getClientCTM, pero el nombre getScreenCTM se mantiene por razones históricas. |
| [GetTotalLength](../../aspose.html.dom.svg/svggeometryelement/gettotallength/)() | Devuelve el valor calculado por el agente de usuario para la longitud total de la ruta usando el algoritmo de distancia a lo largo de un camino del agente de usuario, como una distancia en el sistema de coordenadas del usuario actual. |
