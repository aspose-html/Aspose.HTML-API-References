...
description: Aspose.Html.Dom.Svg.SVGAnimateElement clase. La interfaz SVGAnimateElement corresponde al elemento animado. El acceso orientado a objetos a los atributos del elemento animado a través del DOM SVG no está disponible.
type: docs
weight: 1910
url: /es/net/aspose.html.dom.svg/svganimateelement/
---
## SVGAnimateElement class

La interfaz SVGAnimateElement corresponde al elemento 'animado'. El acceso orientado a objetos a los atributos del elemento 'animado' a través del DOM SVG no está disponible.
