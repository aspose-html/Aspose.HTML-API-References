...
description: Aspose.Html.Dom.Svg.SVGElement clase. Todas las interfaces SVGDOM que corresponden directamente a elementos en el lenguaje SVG como la interfaz SVGPathElement para el elemento ruta se derivan de la interfaz SVGElement.
type: docs
weight: 2020
url: /es/net/aspose.html.dom.svg/svgelement/
---
## SVGElement class

Todas las interfaces SVGDOM que corresponden directamente a elementos en el lenguaje SVG (como la interfaz SVGPathElement para el elemento 'ruta') se derivan de la interfaz SVGElement.
