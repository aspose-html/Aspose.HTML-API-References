...
description: Aspose.Html.HTMLMenuElement clase. Lista de menú. Consulte la definición del elemento MENU en HTML 4.01. Este elemento está en desuso en HTML 4.01.
type: docs
weight: 3390
url: /es/net/aspose.html/htmlmenuelement/
---
## HTMLMenuElement class

Lista de menú. Consulte la definición del elemento MENU en HTML 4.01. Este elemento está en desuso en HTML 4.01.
...
| [Compact](../../aspose.html/htmlmenuelement/compact/) { get; set; } | Reducir el espacio entre los elementos de la lista. Consulte la definición de atributo compacto en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
