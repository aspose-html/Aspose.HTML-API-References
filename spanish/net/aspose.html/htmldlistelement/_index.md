...
description: Aspose.Html.HTMLDListElement clase. Lista de definiciones. Ver la definición del elemento DL en HTML 4.01.
type: docs
weight: 3150
url: /es/net/aspose.html/htmldlistelement/
---
## HTMLDListElement class

Lista de definiciones. Ver la definición del elemento DL en HTML 4.01.
...
| [Compact](../../aspose.html/htmldlistelement/compact/) { get; set; } | Reducir el espacio entre los elementos de la lista. Consulte la definición de atributo compacto en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
