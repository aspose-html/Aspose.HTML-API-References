...
description: Aspose.Html.HTMLBRElement clase. Forzar un salto de línea. Ver la definición del elemento BR en HTML 4.01.
type: docs
weight: 3090
url: /es/net/aspose.html/htmlbrelement/
---
## HTMLBRElement class

Forzar un salto de línea. Ver la definición del elemento BR en HTML 4.01.
...
| [Clear](../../aspose.html/htmlbrelement/clear/) { get; set; } | Controla el flujo de texto alrededor de los flotantes. Consulte la definición clara del atributo en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
