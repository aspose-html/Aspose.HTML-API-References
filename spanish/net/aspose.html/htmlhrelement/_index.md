...
description: Aspose.Html.HTMLHRElement clase. Crear una regla horizontal. Ver la definición del elemento HR en HTML 4.01.
type: docs
weight: 3260
url: /es/net/aspose.html/htmlhrelement/
---
## HTMLHRElement class

Crear una regla horizontal. Ver la definición del elemento HR en HTML 4.01.
...
| Nombre | Descripción |
| --- | --- |
| [Align](../../aspose.html/htmlhrelement/align/) { get; set; } | Alinee la regla en la página. Consulte la definición del atributo de alineación en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
...
| [NoShade](../../aspose.html/htmlhrelement/noshade/) { get; set; } | Indica al agente de usuario que no debe haber sombreado en la representación de este elemento. Consulte la definición del atributo noshade en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
...
| [Size](../../aspose.html/htmlhrelement/size/) { get; set; } | La altura de la regla. Consulte la definición del atributo de tamaño en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
...
| [Width](../../aspose.html/htmlhrelement/width/) { get; set; } | El ancho de la regla. Consulte la definición del atributo ancho en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
