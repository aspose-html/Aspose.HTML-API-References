...
description: Aspose.Html.HTMLDocument clase. UnHTMLDocumento es la raíz de la jerarquía HTML y contiene todo el contenido. Además de proporcionar acceso a la jerarquía también proporciona algunos métodos convenientes para acceder a ciertos conjuntos de información del documento.
type: docs
weight: 3190
url: /es/net/aspose.html/htmldocument/
---
## HTMLDocument class

Un`HTMLDocumento` es la raíz de la jerarquía HTML y contiene todo el contenido. Además de proporcionar acceso a la jerarquía, también proporciona algunos métodos convenientes para acceder a ciertos conjuntos de información del documento.

Las siguientes propiedades han quedado obsoletas en favor de las correspondientes para el`CUERPO` element. En DOM Nivel 2, el método`getElementById` se hereda de la`Documento` interfaz a la que se movió.
...
| Nombre | Descripción |
| --- | --- |
| [HTMLDocument](htmldocument/#constructor)() | Inicializa una nueva instancia del`HTMLDocument` clase. |
| [HTMLDocument](htmldocument/#constructor_1)(Configuration) | Inicializa una nueva instancia del`HTMLDocument` clase. |
| [HTMLDocument](htmldocument/#constructor_2)(RequestMessage) | Inicializa una nueva instancia del`HTMLDocument` clase. Constructor funciona de forma sincrónica, espera la carga de todos los recursos externos (imágenes, scripts, etc.). Para cargar el documento de forma asincrónica, use el método[`Navigate`](../../aspose.html.dom/document/navigate/) o sus sobrecargas. O puede deshabilitar la carga de algunos recursos externos configurando los indicadores apropiados en[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_10)(string) | Inicializa una nueva instancia del`HTMLDocument` clase. Constructor funciona de forma sincrónica, espera la carga de todos los recursos externos (imágenes, scripts, etc.). Para cargar el documento de forma asincrónica, use el método[`Navigate`](../../aspose.html.dom/document/navigate/) o sus sobrecargas. O puede deshabilitar la carga de algunos recursos externos configurando los indicadores apropiados en[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_4)(Url) | Inicializa una nueva instancia del`HTMLDocument` clase. Constructor funciona de forma sincrónica, espera la carga de todos los recursos externos (imágenes, scripts, etc.). Para cargar el documento de forma asincrónica, use el método[`Navigate`](../../aspose.html.dom/document/navigate/) o sus sobrecargas. O puede deshabilitar la carga de algunos recursos externos configurando los indicadores apropiados en[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_3)(RequestMessage, Configuration) | Inicializa una nueva instancia del`HTMLDocument` clase. Constructor funciona de forma sincrónica, espera la carga de todos los recursos externos (imágenes, scripts, etc.). Para cargar el documento de forma asincrónica, use el método[`Navigate`](../../aspose.html.dom/document/navigate/) o sus sobrecargas. O puede deshabilitar la carga de algunos recursos externos configurando los indicadores apropiados en[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_8)(Stream, string) | Inicializa una nueva instancia del`HTMLDocument` clase. Constructor funciona de forma sincrónica, espera la carga de todos los recursos externos (imágenes, scripts, etc.). Para cargar el documento de forma asincrónica, use el método[`Navigate`](../../aspose.html.dom/document/navigate/) o sus sobrecargas. O puede deshabilitar la carga de algunos recursos externos configurando los indicadores apropiados en[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . La carga del documento comienza desde la posición actual en el flujo. |
| [HTMLDocument](htmldocument/#constructor_6)(Stream, Url) | Inicializa una nueva instancia del`HTMLDocument` clase. Constructor funciona de forma sincrónica, espera la carga de todos los recursos externos (imágenes, scripts, etc.). Para cargar el documento de forma asincrónica, use el método[`Navigate`](../../aspose.html.dom/document/navigate/) o sus sobrecargas. O puede deshabilitar la carga de algunos recursos externos configurando los indicadores apropiados en[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . La carga del documento comienza desde la posición actual en el flujo. |
| [HTMLDocument](htmldocument/#constructor_11)(string, Configuration) | Inicializa una nueva instancia del`HTMLDocument` clase. Constructor funciona de forma sincrónica, espera la carga de todos los recursos externos (imágenes, scripts, etc.). Para cargar el documento de forma asincrónica, use el método[`Navigate`](../../aspose.html.dom/document/navigate/) o sus sobrecargas. O puede deshabilitar la carga de algunos recursos externos configurando los indicadores apropiados en[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_14)(string, string) | Inicializa una nueva instancia del`HTMLDocument` clase. Constructor funciona de forma sincrónica, espera la carga de todos los recursos externos (imágenes, scripts, etc.). Para cargar el documento de forma asincrónica, use el método[`Navigate`](../../aspose.html.dom/document/navigate/) o sus sobrecargas. O puede deshabilitar la carga de algunos recursos externos configurando los indicadores apropiados en[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_12)(string, Url) | Inicializa una nueva instancia del`HTMLDocument` clase. Constructor funciona de forma sincrónica, espera la carga de todos los recursos externos (imágenes, scripts, etc.). Para cargar el documento de forma asincrónica, use el método[`Navigate`](../../aspose.html.dom/document/navigate/) o sus sobrecargas. O puede deshabilitar la carga de algunos recursos externos configurando los indicadores apropiados en[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_5)(Url, Configuration) | Inicializa una nueva instancia del`HTMLDocument` clase. Constructor funciona de forma sincrónica, espera la carga de todos los recursos externos (imágenes, scripts, etc.). Para cargar el documento de forma asincrónica, use el método[`Navigate`](../../aspose.html.dom/document/navigate/) o sus sobrecargas. O puede deshabilitar la carga de algunos recursos externos configurando los indicadores apropiados en[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_9)(Stream, string, Configuration) | Inicializa una nueva instancia del`HTMLDocument` clase. Constructor funciona de forma sincrónica, espera la carga de todos los recursos externos (imágenes, scripts, etc.). Para cargar el documento de forma asincrónica, use el método[`Navigate`](../../aspose.html.dom/document/navigate/) o sus sobrecargas. O puede deshabilitar la carga de algunos recursos externos configurando los indicadores apropiados en[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . La carga del documento comienza desde la posición actual en el flujo. |
| [HTMLDocument](htmldocument/#constructor_7)(Stream, Url, Configuration) | Inicializa una nueva instancia del`HTMLDocument` clase. Constructor funciona de forma sincrónica, espera la carga de todos los recursos externos (imágenes, scripts, etc.). Para cargar el documento de forma asincrónica, use el método[`Navigate`](../../aspose.html.dom/document/navigate/) o sus sobrecargas. O puede deshabilitar la carga de algunos recursos externos configurando los indicadores apropiados en[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . La carga del documento comienza desde la posición actual en el flujo. |
| [HTMLDocument](htmldocument/#constructor_15)(string, string, Configuration) | Inicializa una nueva instancia del`HTMLDocument` clase. Constructor funciona de forma sincrónica, espera la carga de todos los recursos externos (imágenes, scripts, etc.). Para cargar el documento de forma asincrónica, use el método[`Navigate`](../../aspose.html.dom/document/navigate/) o sus sobrecargas. O puede deshabilitar la carga de algunos recursos externos configurando los indicadores apropiados en[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_13)(string, Url, Configuration) | Inicializa una nueva instancia del`HTMLDocument` clase. Constructor funciona de forma sincrónica, espera la carga de todos los recursos externos (imágenes, scripts, etc.). Para cargar el documento de forma asincrónica, use el método[`Navigate`](../../aspose.html.dom/document/navigate/) o sus sobrecargas. O puede deshabilitar la carga de algunos recursos externos configurando los indicadores apropiados en[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |

## Propiedades

| Nombre | Descripción |
| --- | --- |
| [Anchors](../../aspose.html/htmldocument/anchors/) { get; } | Una colección de todas las anclas (`A` ) elementos en un documento con un valor para el`nombre`atributo. Por motivos de compatibilidad con versiones anteriores de , el conjunto de anclas devuelto solo contiene aquellas anclas creadas con el`nombre` atributo, no los creados con el`identificación` atributo. Tenga en cuenta que en [[XHTML 1.0](http://www.w3.org/TR/2002/REC-xhtml1-20020801) ], el `nombre` El atributo (consulte la sección 4.10) no tiene semántica y solo está presente para los agentes de usuario heredados: el`identificación` en su lugar se utiliza el atributo . Los usuarios deben preferir los mecanismos iteradores proporcionados por [[Transversal de nivel 2 de DOM](http://www.w3.org/TR/2000/REC-DOM-Level-2-Traversal-Range-20001113) ] en cambio. |
| [Applets](../../aspose.html/htmldocument/applets/) { get; } | Una colección de todos los`OBJETO` elementos que incluyen applets y`APPLET` (en desuso) elementos en un documento. |
...
| [Body](../../aspose.html/htmldocument/body/) { get; set; } | El elemento que contiene el contenido del documento. En documentos con`CUERPO` contenido, devuelve el`CUERPO` elemento . En documentos de conjunto de marcos, esto devuelve el más externo`MARCO` elemento. |
...
| [Domain](../../aspose.html/htmldocument/domain/) { get; } | El nombre de dominio del servidor que entregó el documento, o `nulo` si el servidor no se puede identificar con un nombre de dominio . |
...
| [Links](../../aspose.html/htmldocument/links/) { get; } | Una colección de todos`ÁREA` elementos y ancla ( `A` ) elementos en un documento con un valor para el `href` atributo. |
...
| [Referrer](../../aspose.html/htmldocument/referrer/) { get; } | Devuelve la URI [[IETFRFC 2396](http://www.ietf.org/rfc/rfc2396.txt) de la página que enlaza con esta página. El valor es una cadena vacía si el usuario navegó a la página directamente (no a través de un enlace , sino, por ejemplo, a través de un marcador). |
...
| [Title](../../aspose.html/htmldocument/title/) { get; set; } | El título de un documento según lo especificado por el`TÍTULO` elemento en el encabezado del documento. |
...
| [GetOverrideStyle](../../aspose.html/htmldocument/getoverridestyle/)(Element, string) | Este método se utiliza para recuperar la declaración de estilo anulada para un elemento especificado y un pseudoelemento especificado. |
...
| override [RenderTo](../../aspose.html/htmldocument/renderto/)(IDevice) | Este método se utiliza para imprimir el contenido del documento actual en el dispositivo especificado. |
...
| [Save](../../aspose.html/htmldocument/save/#save)(IOutputStorage) | Guarda el contenido y los recursos del documento en el almacenamiento de salida. |
| [Save](../../aspose.html/htmldocument/save/#save_10)(string) | Guarda el documento en el archivo local especificado por`camino` Todos los recursos utilizados en este documento se guardarán en en la carpeta adyacente, cuyo nombre se construirá como: nombre_archivo_salida + "_archivos". |
| [Save](../../aspose.html/htmldocument/save/#save_5)(Url) | Guarda el documento en el archivo local especificado por`URL` Todos los recursos utilizados en este documento se guardarán en en la carpeta adyacente, cuyo nombre se construirá como: nombre_archivo_salida + "_archivos". |
| [Save](../../aspose.html/htmldocument/save/#save_1)(IOutputStorage, HTMLSaveFormat) | Guarda el contenido y los recursos del documento en el almacenamiento de salida. |
| [Save](../../aspose.html/htmldocument/save/#save_2)(IOutputStorage, HTMLSaveOptions) | Guarda el contenido y los recursos del documento en el almacenamiento de salida. |
| [Save](../../aspose.html/htmldocument/save/#save_3)(IOutputStorage, MarkdownSaveOptions) | Guarda el contenido y los recursos del documento en el almacenamiento de salida. |
| [Save](../../aspose.html/htmldocument/save/#save_4)(IOutputStorage, MHTMLSaveOptions) | Guarda el contenido y los recursos del documento en el almacenamiento de salida. |
| [Save](../../aspose.html/htmldocument/save/#save_11)(string, HTMLSaveFormat) | Guarda el documento en el archivo local especificado por`camino` Todos los recursos utilizados en este documento se guardarán en en la carpeta adyacente, cuyo nombre se construirá como: nombre_archivo_salida + "_archivos". |
| [Save](../../aspose.html/htmldocument/save/#save_12)(string, HTMLSaveOptions) | Guarda el documento en el archivo local especificado por`camino` Todos los recursos utilizados en este documento se guardarán en en la carpeta adyacente, cuyo nombre se construirá como: nombre_archivo_salida + "_archivos". |
| [Save](../../aspose.html/htmldocument/save/#save_13)(string, MarkdownSaveOptions) | Guarda el documento en el archivo local especificado por`camino` Todos los recursos utilizados en este documento se guardarán en en la carpeta adyacente, cuyo nombre se construirá como: nombre_archivo_salida + "_archivos". |
| [Save](../../aspose.html/htmldocument/save/#save_14)(string, MHTMLSaveOptions) | Guarda el documento en el archivo local especificado por`camino` Todos los recursos utilizados en este documento se guardarán en en la carpeta adyacente, cuyo nombre se construirá como: nombre_archivo_salida + "_archivos". |
| [Save](../../aspose.html/htmldocument/save/#save_6)(Url, HTMLSaveFormat) | Guarda el documento en el archivo local especificado por`URL` Todos los recursos utilizados en este documento se guardarán en en la carpeta adyacente, cuyo nombre se construirá como: nombre_archivo_salida + "_archivos". |
| [Save](../../aspose.html/htmldocument/save/#save_7)(Url, HTMLSaveOptions) | Guarda el documento en el archivo local especificado por`URL` Todos los recursos utilizados en este documento se guardarán en en la carpeta adyacente, cuyo nombre se construirá como: nombre_archivo_salida + "_archivos". |
| [Save](../../aspose.html/htmldocument/save/#save_8)(Url, MarkdownSaveOptions) | Guarda el documento en el archivo local especificado por`URL` Todos los recursos utilizados en este documento se guardarán en en la carpeta adyacente, cuyo nombre se construirá como: nombre_archivo_salida + "_archivos". |
| [Save](../../aspose.html/htmldocument/save/#save_9)(Url, MHTMLSaveOptions) | Guarda el documento en el archivo local especificado por`URL` Todos los recursos utilizados en este documento se guardarán en en la carpeta adyacente, cuyo nombre se construirá como: nombre_archivo_salida + "_archivos". |
