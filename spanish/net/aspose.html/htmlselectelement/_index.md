...
description: El elemento select permite seleccionar una opción. Se puede acceder directamente a las opciones contenidas a través del elemento de selección como una colección. Ver la definición del elemento SELECT en HTML 4.01.
type: docs
weight: 3510
...
| [Form](../../aspose.html/htmlselectelement/form) { get; } | El número de opciones en este`SELECCIONE` . |
...
| [Length](../../aspose.html/htmlselectelement/length) { get; set; } | El número de opciones en este`SELECCIONE` . @versión DOM Nivel 2 |
...
| [Multiple](../../aspose.html/htmlselectelement/multiple) { get; set; } | Si es verdadero, múltiples`OPCIÓN` los elementos pueden ser seleccionados en este`SELECCIONE` . Ver la definición de múltiples atributos en HTML 4.01. |
