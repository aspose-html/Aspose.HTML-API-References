...
description: Aspose.Html.HTMLSelectElement clase. El elemento select permite seleccionar una opción. Se puede acceder directamente a las opciones contenidas a través del elemento de selección como una colección. Ver la definición del elemento SELECT en HTML 4.01.
type: docs
weight: 3520
url: /es/net/aspose.html/htmlselectelement/
---
## HTMLSelectElement class

El elemento select permite seleccionar una opción. Se puede acceder directamente a las opciones contenidas a través del elemento de selección como una colección. Ver la definición del elemento SELECT en HTML 4.01.
...
| [Disabled](../../aspose.html/htmlselectelement/disabled/) { get; set; } | El control no está disponible en este contexto. Consulte la definición del atributo deshabilitado en HTML 4.01. |
...
| [Form](../../aspose.html/htmlselectelement/form/) { get; } | El número de opciones en este`SELECCIONAR` . |
...
| [Length](../../aspose.html/htmlselectelement/length/) { get; set; } | El número de opciones en este`SELECCIONAR` . @versión DOM Nivel 2 |
...
| [Multiple](../../aspose.html/htmlselectelement/multiple/) { get; set; } | Si es verdadero, múltiples`OPCIÓN` los elementos pueden ser seleccionados en este`SELECCIONAR` . Ver la definición de múltiples atributos en HTML 4.01. |
| [Name](../../aspose.html/htmlselectelement/name/) { get; set; } | Control de formulario o nombre de objeto cuando se envía con un formulario. Ver la definición del atributo name en HTML 4.01. |
...
| [Options](../../aspose.html/htmlselectelement/options/) { get; } | La colección de`OPCIÓN` elementos contenidos en este elemento . @versión DOM Nivel 2 |
...
| [SelectedIndex](../../aspose.html/htmlselectelement/selectedindex/) { get; set; } | El índice ordinal de la opción seleccionada, comenzando desde 0. El valor -1 se devuelve si no se selecciona ningún elemento. Si se seleccionan varias opciones , se devuelve el índice de la primera opción seleccionada. |
| [ShadowRoot](../../aspose.html.dom/element/shadowroot/) { get; } | Devuelve shadowRoot almacenado en este elemento o nulo si está cerrado. |
| [Size](../../aspose.html/htmlselectelement/size/) { get; set; } | Número de filas visibles. Consulte la definición del atributo de tamaño en HTML 4.01. |
...
| [TabIndex](../../aspose.html/htmlselectelement/tabindex/) { get; set; } | Índice que representa la posición del elemento en el orden de tabulación. Ver la definición del atributo tabindex en HTML 4.01. |
...
| [Type](../../aspose.html/htmlselectelement/type/) { get; } | El tipo de este control de formulario. Esta es la cadena "select-multiple" cuando el atributo multiple es`verdadero` y la cadena "select-one" cuando`FALSO` . |
| [Value](../../aspose.html/htmlselectelement/value/) { get; set; } | El valor de control de formulario actual (es decir, el valor de la opción actualmente seleccionada), si se seleccionan varias opciones, este es el valor de la primera opción seleccionada. |
