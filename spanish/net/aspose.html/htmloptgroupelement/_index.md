...
description: Aspose.Html.HTMLOptGroupElement clase. Agrupar opciones en subdivisiones lógicas. Consulte la definición del elemento OPTGROUP en HTML 4.01.
type: docs
weight: 3450
url: /es/net/aspose.html/htmloptgroupelement/
---
## HTMLOptGroupElement class

Agrupar opciones en subdivisiones lógicas. Consulte la definición del elemento OPTGROUP en HTML 4.01.
...
| [Disabled](../../aspose.html/htmloptgroupelement/disabled/) { get; set; } | El control no está disponible en este contexto. Consulte la definición del atributo deshabilitado en HTML 4.01. |
...
| [Label](../../aspose.html/htmloptgroupelement/label/) { get; set; } | Asigna una etiqueta a este grupo de opciones. Consulte la definición de atributo de etiqueta en HTML 4.01. |
