...
description: Aspose.Html.HTMLDirectoryElement clase. Lista de directorios. Consulte la definición del elemento DIR en HTML 4.01. Este elemento está obsoleto en HTML 4.01.
type: docs
weight: 3170
url: /es/net/aspose.html/htmldirectoryelement/
---
## HTMLDirectoryElement class

Lista de directorios. Consulte la definición del elemento DIR en HTML 4.01. Este elemento está obsoleto en HTML 4.01.
...
| [Compact](../../aspose.html/htmldirectoryelement/compact/) { get; set; } | Reducir el espacio entre los elementos de la lista. Consulte la definición de atributo compacto en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
