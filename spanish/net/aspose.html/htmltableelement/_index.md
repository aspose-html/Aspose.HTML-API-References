...
| Nombre | Descripción |
| --- | --- |
| [Align](../../aspose.html/htmltableelement/align/) { get; set; } | Especifica la posición de la tabla con respecto al resto del documento . Consulte la definición del atributo de alineación en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
...
| [BgColor](../../aspose.html/htmltableelement/bgcolor/) { get; set; } | Color de fondo de celda. Consulte la definición del atributo bgcolor en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
| [Border](../../aspose.html/htmltableelement/border/) { get; set; } | El ancho del borde alrededor de la mesa. Consulte la definición del atributo de borde en HTML 4.01. |
| [Caption](../../aspose.html/htmltableelement/caption/) { get; } | Devuelve la tabla`SUBTÍTULO` , o nulo si no existe ninguno. @versión DOM Nivel 2 |
| [CellPadding](../../aspose.html/htmltableelement/cellpadding/) { get; set; } | Especifica el espacio horizontal y vertical entre el contenido de la celda y los bordes de la celda . Consulte la definición del atributo cellpadding en HTML 4.01. |
| [CellSpacing](../../aspose.html/htmltableelement/cellspacing/) { get; set; } | Especifica la separación horizontal y vertical entre celdas. Consulte la definición del atributo de espaciado de celdas en HTML 4.01. |
...
| [Frame](../../aspose.html/htmltableelement/frame/) { get; set; } | Especifica qué bordes de tabla externa se deben representar. Ver la definición del atributo frame en HTML 4.01. |
...
| [Rows](../../aspose.html/htmltableelement/rows/) { get; } | Devuelve la tabla`PIE` , o`nulo` si no existe . |
| [Rules](../../aspose.html/htmltableelement/rules/) { get; set; } | Especifica qué bordes internos de la tabla se deben representar. Consulte la definición del atributo rules en HTML 4.01. |
...
| [Summary](../../aspose.html/htmltableelement/summary/) { get; set; } | Descripción sobre el propósito o estructura de una tabla. Consulte la definición del atributo resumen en HTML 4.01. |
| [TagName](../../aspose.html.dom/element/tagname/) { get; } | El nombre del elemento. |
| [TBodies](../../aspose.html/htmltableelement/tbodies/) { get; } | Devuelve una colección de los cuerpos de la tabla (incluidos los implícitos). |
...
| [TFoot](../../aspose.html/htmltableelement/tfoot/) { get; } | Devuelve la tabla`CABEZA` , o`nulo` si no existe . |
| [THead](../../aspose.html/htmltableelement/thead/) { get; } | Devuelve la tabla`SUBTÍTULO` , o nulo si no existe ninguno. |
...
| [Width](../../aspose.html/htmltableelement/width/) { get; set; } | Especifica el ancho de tabla deseado. Consulte la definición del atributo de ancho en HTML 4.01. |
...
| [CreateCaption](../../aspose.html/htmltableelement/createcaption/)() | Crea un nuevo objeto de título de tabla o devuelve uno existente. |
| [CreateTFoot](../../aspose.html/htmltableelement/createtfoot/)() | Crea una fila de pie de tabla o devuelve una existente. |
| [CreateTHead](../../aspose.html/htmltableelement/createthead/)() | Crea una fila de encabezado de tabla o devuelve una existente. |
| [DeleteCaption](../../aspose.html/htmltableelement/deletecaption/)() | Eliminar el título de la tabla, si existe. |
| [DeleteRow](../../aspose.html/htmltableelement/deleterow/)(int) | Eliminar una fila de la tabla. |
| [DeleteTFoot](../../aspose.html/htmltableelement/deletetfoot/)() | Eliminar el pie de página de la tabla, si existe. |
| [DeleteTHead](../../aspose.html/htmltableelement/deletethead/)() | Eliminar el encabezado de la tabla, si existe. |
