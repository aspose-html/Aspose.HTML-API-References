...
description: Los métodos create y delete de la tabla permiten a los autores construir y modificar tablas. HTML 4.01http//www.w3.org/TR/1999/REChtml40119991224  especifica que solo uno de cada uno de los SUBTÍTULO CABEZA  yPIE los elementos pueden existir en una tabla. Por lo tanto si existe uno y se llama al método createTHead o createTFoot el método devuelve el elemento THead o TFoot existente. Ver la definición del elemento TABLE en HTML 4.01.
type: docs
weight: 3560
