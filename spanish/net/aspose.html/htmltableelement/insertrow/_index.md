...
description: Inserta una nueva fila vacía en la tabla. La nueva fila se inserta inmediatamente antes y en la misma sección que la actual índice th fila en la tabla. Siíndice es 1 o igual al número de filas se agrega la nueva fila. Además cuando la tabla está vacía la fila se inserta en unTBODY que se crea e inserta en la tabla. Una fila de la tabla no puede estar vacía según HTML 4.01http//www.w3.org/TR/1999/REChtml40119991224 .
type: docs
weight: 220
