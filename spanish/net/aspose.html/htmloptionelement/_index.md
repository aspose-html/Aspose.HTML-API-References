...
description: Aspose.Html.HTMLOptionElement clase. Una opción seleccionable. Ver la definición del elemento OPCIÓN en HTML 4.01.
type: docs
weight: 3460
url: /es/net/aspose.html/htmloptionelement/
---
## HTMLOptionElement class

Una opción seleccionable. Ver la definición del elemento OPCIÓN en HTML 4.01.
...
| [DefaultSelected](../../aspose.html/htmloptionelement/defaultselected/) { get; set; } | Representa el valor del atributo HTML seleccionado. El valor de este atributo no cambia si cambia el estado del control de formulario correspondiente, en un agente de usuario interactivo. Ver la definición del atributo seleccionado en HTML 4.01. @version DOM Nivel 2 |
...
| [Disabled](../../aspose.html/htmloptionelement/disabled/) { get; set; } | El control no está disponible en este contexto. Ver la definición de atributo deshabilitado en HTML 4.01. |
...
| [Form](../../aspose.html/htmloptionelement/form/) { get; } | Devuelve el`FORMA` elemento que contiene este control. Devuelve `nulo` si este control no está dentro del contexto de un formulario . |
| [Id](../../aspose.html/htmlelement/id/) { get; set; } | El identificador del elemento. Consulte la definición del atributo id en HTML 4.01. |
| [Index](../../aspose.html/htmloptionelement/index/) { get; } | El índice de este`OPCIÓN` en su padre`SELECCIONAR` , a partir de 0. @versión DOM Nivel 2 |
...
| [Label](../../aspose.html/htmloptionelement/label/) { get; set; } | Etiqueta de opción para uso en menús jerárquicos. Consulte la definición del atributo de etiqueta en HTML 4.01. |
...
| [Selected](../../aspose.html/htmloptionelement/selected/) { get; set; } | Representa el estado actual del control de formulario correspondiente, en un agente de usuario interactivo . Cambiar este atributo cambia el estado de el control de formulario, pero no cambia el valor del atributo HTML seleccionado del elemento. |
...
| [Text](../../aspose.html/htmloptionelement/text/) { get; } | El texto contenido dentro del elemento de opción. |
...
| [Value](../../aspose.html/htmloptionelement/value/) { get; set; } | El valor de control de formulario actual. Consulte la definición del atributo de valor en HTML 4.01. |
