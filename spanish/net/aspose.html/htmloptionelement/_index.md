...
description: Una opción seleccionable. Ver la definición del elemento OPCIÓN en HTML 4.01.
type: docs
weight: 3450
...
| [Index](../../aspose.html/htmloptionelement/index) { get; } | El índice de este`OPCIÓN` en su padre`SELECCIONE` , a partir de 0. @versión DOM Nivel 2 |
