...
description: Aspose.Html.HTMLDataListElement clase. El elemento datalist representa un conjunto de elementos de opciones que representan opciones predefinidas para otros controles. Consulte también laRecomendación HTML 5.2 W3C .
type: docs
weight: 3160
url: /es/net/aspose.html/htmldatalistelement/
---
## HTMLDataListElement class

El elemento datalist representa un conjunto de elementos de opciones que representan opciones predefinidas para otros controles. Consulte también la[Recomendación HTML 5.2 W3C](https://www.w3.org/TR/html52/sec-forms.html#elementdef-datalist) .
...
| [Options](../../aspose.html/htmldatalistelement/options/) { get; } | La colección de`OPCIÓN`elementos contenidos en este elemento . |
