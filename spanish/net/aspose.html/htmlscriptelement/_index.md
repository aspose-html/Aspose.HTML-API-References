...
description: Aspose.Html.HTMLScriptElement clase. Sentencias de script. Ver la definición del elemento SCRIPT en HTML 4.01.
type: docs
weight: 3510
url: /es/net/aspose.html/htmlscriptelement/
---
## HTMLScriptElement class

Sentencias de script. Ver la definición del elemento SCRIPT en HTML 4.01.
...
| [Charset](../../aspose.html/htmlscriptelement/charset/) { get; set; } | La codificación de caracteres del recurso vinculado. Consulte la definición del atributo charset en HTML 4.01. |
...
| [Defer](../../aspose.html/htmlscriptelement/defer/) { get; set; } | Indica que el agente de usuario puede diferir el procesamiento del script. Ver la definición del atributo diferido en HTML 4.01. |
...
| [Event](../../aspose.html/htmlscriptelement/event/) { get; set; } | Reservado para uso futuro. |
...
| [Src](../../aspose.html/htmlscriptelement/src/) { get; set; } | URL [[IETFRFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] designando un script externo. Consulte la definición del atributo src en HTML 4.01. |
...
| [Text](../../aspose.html/htmlscriptelement/text/) { get; set; } | El contenido del script del elemento. |
...
| [Type](../../aspose.html/htmlscriptelement/type/) { get; set; } | El tipo de contenido del lenguaje de script. Consulte la definición del atributo de tipo en HTML 4.01. |
