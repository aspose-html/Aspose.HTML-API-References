...
description: Un applet de Java incrustado. Consulte la definición del elemento APPLET en HTML 4.01. Este elemento está en desuso en HTML 4.01.
type: docs
weight: 3060
url: /es/net/aspose.html/htmlappletelement/
---
## HTMLAppletElement class

Un applet de Java incrustado. Consulte la definición del elemento APPLET en HTML 4.01. Este elemento está en desuso en HTML 4.01.
...
| Nombre | Descripción |
| --- | --- |
| [Align](../../aspose.html/htmlappletelement/align) { get; set; } | Alinea este objeto (vertical u horizontalmente) con respecto al texto que lo rodea . Consulte la definición del atributo de alineación en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
| [Alt](../../aspose.html/htmlappletelement/alt) { get; set; } | Texto alternativo para agentes de usuario que no presentan el contenido normal de este elemento . Consulte la definición del atributo alt en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
| [Archive](../../aspose.html/htmlappletelement/archive) { get; set; } | Lista de archivos separados por comas. Consulte la definición del atributo de archivo en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
...
| [Code](../../aspose.html/htmlappletelement/code) { get; set; } | Archivo de clase de applet. Consulte la definición de atributo de código en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
| [CodeBase](../../aspose.html/htmlappletelement/codebase) { get; set; } | URI base opcional [[IETFRFC 2396](http://www.ietf.org/rfc/rfc2396.txt) para subprograma. Consulte la definición del atributo de la base de código en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
...
| [Height](../../aspose.html/htmlappletelement/height) { get; set; } | Anular altura. Consulte la definición del atributo de altura en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
| [Hspace](../../aspose.html/htmlappletelement/hspace) { get; set; } | Espacio horizontal, en píxeles, a la izquierda y derecha de esta imagen, subprograma u objeto. Consulte la definición del atributo hspace en HTML 4.01. Este atributo está obsoleto en HTML 4.01. @version DOM Nivel 2 |
...
| [Name](../../aspose.html/htmlappletelement/name) { get; set; } | El nombre del subprograma. Consulte la definición del atributo de nombre en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
...
| [Object](../../aspose.html/htmlappletelement/object) { get; set; } | El valor del atributo "objeto". Consulte el atributo de objeto definition en HTML 4.01. Este atributo está obsoleto en HTML 4.01. @versión DOM Nivel 2 |
...
| [Vspace](../../aspose.html/htmlappletelement/vspace) { get; set; } | Espacio vertical, en píxeles, arriba y abajo de esta imagen, subprograma u objeto . Consulte la definición del atributo vspace en HTML 4.01. Este atributo está obsoleto en HTML 4.01. @version DOM Nivel 2 |
| [Width](../../aspose.html/htmlappletelement/width) { get; set; } | Anular ancho. Consulte la definición del atributo ancho en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
