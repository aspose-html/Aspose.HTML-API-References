...
description: Aspose.Html.HTMLStyleElement clase. Información de estilo. Consulte la definición del elemento STYLE en HTML 4.01 el módulo CSS Hojas de estilo DOM Nivel 2 y CSS  y elLinkStyle interfaz en el módulo StyleSheets Hojas de estilo DOM Nivel 2 y CSS .
type: docs
weight: 3530
url: /es/net/aspose.html/htmlstyleelement/
---
...
| [Disabled](../../aspose.html/htmlstyleelement/disabled/) { get; set; } | Habilita/deshabilita la hoja de estilo. |
...
| [Media](../../aspose.html/htmlstyleelement/media/) { get; set; } | Diseñado para usar con uno o más medios de destino. Consulte la definición del atributo multimedia en HTML 4.01. |
...
| [Sheet](../../aspose.html/htmlstyleelement/sheet/) { get; } | Obtiene la hoja de estilo asociada. |
...
| [Type](../../aspose.html/htmlstyleelement/type/) { get; set; } | El tipo de contenido del lenguaje de hojas de estilo. Consulte la definición del atributo de tipo en HTML 4.01. |
