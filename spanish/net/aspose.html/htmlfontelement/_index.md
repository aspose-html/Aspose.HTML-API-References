...
description: Aspose.Html.HTMLFontElement clase. Cambio local de fuente. Consulte la definición del elemento FONT en HTML 4.01. Este elemento está obsoleto en HTML 4.01.
type: docs
weight: 3220
url: /es/net/aspose.html/htmlfontelement/
---
## HTMLFontElement class

Cambio local de fuente. Consulte la definición del elemento FONT en HTML 4.01. Este elemento está obsoleto en HTML 4.01.
...
| [Color](../../aspose.html/htmlfontelement/color/) { get; set; } | Color de fuente. Consulte la definición del atributo de color en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
...
| [Face](../../aspose.html/htmlfontelement/face/) { get; set; } | Identificador de cara de fuente. Consulte la definición del atributo de cara en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
...
| [Size](../../aspose.html/htmlfontelement/size/) { get; set; } | Tamaño de fuente. Consulte la definición del atributo de tamaño en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
