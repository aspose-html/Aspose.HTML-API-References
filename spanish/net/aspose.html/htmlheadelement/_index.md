...
description: Aspose.Html.HTMLHeadElement clase. Información del encabezado del documento. Ver la definición del elemento HEAD en HTML 4.01.
type: docs
weight: 3270
url: /es/net/aspose.html/htmlheadelement/
---
## HTMLHeadElement class

Información del encabezado del documento. Ver la definición del elemento HEAD en HTML 4.01.
...
| [Profile](../../aspose.html/htmlheadelement/profile/) { get; set; } | URL [[IETFRFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] designando un perfil de metadatos. Consulte la definición del atributo de perfil en HTML 4.01. |
