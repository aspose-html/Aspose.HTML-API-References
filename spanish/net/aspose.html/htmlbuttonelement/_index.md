...
description: Aspose.Html.HTMLButtonElement clase. Pulsador. Ver la definición del elemento BUTTON en HTML 4.01.
type: docs
weight: 3130
url: /es/net/aspose.html/htmlbuttonelement/
---
## HTMLButtonElement class

Pulsador. Ver la definición del elemento BUTTON en HTML 4.01.
...
| Nombre | Descripción |
| --- | --- |
| [AccessKey](../../aspose.html/htmlbuttonelement/accesskey/) { get; set; } | Una clave de acceso de un solo carácter para dar acceso al control de formulario. Consulte la definición del atributo de clave de acceso en HTML 4.01. |
...
| [Disabled](../../aspose.html/htmlbuttonelement/disabled/) { get; set; } | El control no está disponible en este contexto. Consulte la definición del atributo deshabilitado en HTML 4.01. |
...
| [Form](../../aspose.html/htmlbuttonelement/form/) { get; } | Devuelve el`FORMA` elemento que contiene este control. Devuelve `nulo` si este control no está dentro del contexto de un formulario . |
...
| [Name](../../aspose.html/htmlbuttonelement/name/) { get; set; } | Control de formulario o nombre de objeto cuando se envía con un formulario. Ver la definición del atributo name en HTML 4.01. |
...
| [TabIndex](../../aspose.html/htmlbuttonelement/tabindex/) { get; set; } | Índice que representa la posición del elemento en el orden de tabulación. Ver la definición del atributo tabindex en HTML 4.01. |
...
| [Type](../../aspose.html/htmlbuttonelement/type/) { get; set; } | El tipo de botón (todo en minúsculas). Consulte la definición del atributo de tipo en HTML 4.01. |
| [Value](../../aspose.html/htmlbuttonelement/value/) { get; set; } | El valor de control de formulario actual. Consulte la definición del atributo de valor en HTML 4.01. |
