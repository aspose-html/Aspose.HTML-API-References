...
description: Aspose.Html.HTMLParagraphElement clase. Párrafos. Ver la definición del elemento P en HTML 4.01.
type: docs
weight: 3470
url: /es/net/aspose.html/htmlparagraphelement/
---
## HTMLParagraphElement class

Párrafos. Ver la definición del elemento P en HTML 4.01.
...
| Nombre | Descripción |
| --- | --- |
| [Align](../../aspose.html/htmlparagraphelement/align/) { get; set; } | Alineación de texto horizontal. Consulte la definición del atributo de alineación en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
