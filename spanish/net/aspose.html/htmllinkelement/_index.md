...
description: Aspose.Html.HTMLLinkElement clase. ElENLACEEl elemento especifica un enlace a un recurso externo y define la relación de este documento con ese recurso o viceversa. Ver la definición del elemento LINK en HTML 4.01 ver también el LinkStyle interfaz en el módulo StyleSheet Hojas de estilo DOM Nivel 2 y CSS .
type: docs
weight: 3370
url: /es/net/aspose.html/htmllinkelement/
---
## HTMLLinkElement class

El`ENLACE`El elemento especifica un enlace a un recurso externo y define la relación de este documento con ese recurso (o viceversa). Ver la definición del elemento LINK en HTML 4.01 (ver también el `LinkStyle` interfaz en el módulo StyleSheet [[Hojas de estilo DOM Nivel 2 y CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113) ]).
...
| [Charset](../../aspose.html/htmllinkelement/charset/) { get; set; } | La codificación de caracteres del recurso al que se vincula. Consulte la definición del atributo charset en HTML 4.01. |
...
| [Disabled](../../aspose.html/htmllinkelement/disabled/) { get; set; } | Habilita/deshabilita el enlace. Actualmente, esto solo se usa para los enlaces de la hoja de estilo y se puede usar para activar o desactivar las hojas de estilo. |
...
| [Href](../../aspose.html/htmllinkelement/href/) { get; set; } | El URI [[IETFRFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] del recurso vinculado. Consulte la definición del atributo href en HTML 4.01. |
| [Hreflang](../../aspose.html/htmllinkelement/hreflang/) { get; set; } | Código de idioma del recurso vinculado. Consulte la definición del atributo hreflang en HTML 4.01. |
...
| [Media](../../aspose.html/htmllinkelement/media/) { get; set; } | Diseñado para usar con uno o más medios de destino. Consulte la definición del atributo multimedia en HTML 4.01. |
...
| [Rel](../../aspose.html/htmllinkelement/rel/) { get; set; } | Tipo de vínculo directo. Ver la definición del atributo rel en HTML 4.01. |
| [RelList](../../aspose.html/htmllinkelement/rellist/) { get; } | Devuelve una DOMTokenList en vivo que contiene los tokens recibidos al analizar el atributo "rel". |
| [Rev](../../aspose.html/htmllinkelement/rev/) { get; set; } | Tipo de vínculo inverso. Consulte la definición del atributo rev en HTML 4.01. |
...
| [Sheet](../../aspose.html/htmllinkelement/sheet/) { get; } | Obtiene la hoja de estilo asociada. |
...
| [Target](../../aspose.html/htmllinkelement/target/) { get; set; } | Marco para representar el recurso. Consulte la definición del atributo de destino en HTML 4.01. |
...
| [Type](../../aspose.html/htmllinkelement/type/) { get; set; } | Tipo de contenido de aviso. Consulte la definición del atributo de tipo en HTML 4.01. |
