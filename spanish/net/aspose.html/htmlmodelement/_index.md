...
description: Aspose.Html.HTMLModElement clase. Aviso de modificación de parte de un documento. Consulte las definiciones de los elementos INS y DEL en HTML 4.01.
type: docs
weight: 3410
url: /es/net/aspose.html/htmlmodelement/
---
## HTMLModElement class

Aviso de modificación de parte de un documento. Consulte las definiciones de los elementos INS y DEL en HTML 4.01.
...
| [Cite](../../aspose.html/htmlmodelement/cite/) { get; set; } | URI [[IETFRFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] designando un documento que describa el motivo del cambio. Ver la definición del atributo de cita en HTML 4.01. |
...
| [DateTime](../../aspose.html/htmlmodelement/datetime/) { get; set; } | La fecha y hora del cambio. Consulte la definición del atributo de fecha y hora en HTML 4.01. |
