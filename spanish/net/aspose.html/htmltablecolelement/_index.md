...
description: Aspose.Html.HTMLTableColElement clase. Reagrupa elCOLUMNA yCOLGRUPO elementos. Consulte la definición del elemento COL en HTML 4.01.
type: docs
weight: 3560
url: /es/net/aspose.html/htmltablecolelement/
---
## HTMLTableColElement class

Reagrupa el`COLUMNA` y`COLGRUPO` elementos. Consulte la definición del elemento COL en HTML 4.01.
...
| Nombre | Descripción |
| --- | --- |
| [Align](../../aspose.html/htmltablecolelement/align/) { get; set; } | Alineación horizontal de datos de celda en columna. Consulte la definición del atributo de alineación en HTML 4.01. |
...
| [Ch](../../aspose.html/htmltablecolelement/ch/) { get; set; } | Carácter de alineación para celdas en una columna. Consulte la definición del atributo char en HTML 4.01. |
...
| [ChOff](../../aspose.html/htmltablecolelement/choff/) { get; set; } | Desplazamiento del carácter de alineación. Consulte la definición del atributo charoff en HTML 4.01. |
...
| [Span](../../aspose.html/htmltablecolelement/span/) { get; set; } | Indica el número de columnas en un grupo o afectadas por una agrupación. Ver la definición del atributo span en HTML 4.01. |
...
| [VAlign](../../aspose.html/htmltablecolelement/valign/) { get; set; } | Alineación vertical de datos de celda en columna. Consulte la definición del atributo valign en HTML 4.01. |
| [Width](../../aspose.html/htmltablecolelement/width/) { get; set; } | Ancho de columna predeterminado. Ver la definición del atributo ancho en HTML 4.01. |
