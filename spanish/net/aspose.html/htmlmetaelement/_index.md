...
description: Aspose.Html.HTMLMetaElement clase. Contiene metainformación genérica sobre el documento. Consulte la definición del elemento META en HTML 4.01.
type: docs
weight: 3400
url: /es/net/aspose.html/htmlmetaelement/
---
## HTMLMetaElement class

Contiene metainformación genérica sobre el documento. Consulte la definición del elemento META en HTML 4.01.
...
| [Content](../../aspose.html/htmlmetaelement/content/) { get; set; } | Información asociada. Ver la definición de atributos de contenido en HTML 4.01. |
...
| [HttpEquiv](../../aspose.html/htmlmetaelement/httpequiv/) { get; set; } | nombre del encabezado de respuesta HTTP [[RFC 2616 de la IETF](http://www.ietf.org/rfc/rfc2616.txt) ]. Consulte la definición del atributo http-equiv en HTML 4.01. |
...
| [Name](../../aspose.html/htmlmetaelement/name/) { get; set; } | Nombre de la metainformación. Consulte la definición del atributo de nombre en HTML 4.01. |
...
| [Scheme](../../aspose.html/htmlmetaelement/scheme/) { get; set; } | Seleccionar forma de contenido. Ver la definición de atributo de esquema en HTML 4.01. |
