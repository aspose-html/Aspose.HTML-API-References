...
description: Definición del área del mapa de imágenes del lado del cliente. Consulte la definición del elemento AREA en HTML 4.01.
type: docs
weight: 3070
...
| [Alt](../../aspose.html/htmlareaelement/alt) { get; set; } | Texto alternativo para agentes de usuario que no muestran el contenido normal de este elemento . Ver la definición del atributo alt en HTML 4.01. |
