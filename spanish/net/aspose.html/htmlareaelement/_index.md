...
description: Aspose.Html.HTMLAreaElement clase. Definición del área del mapa de imágenes del lado del cliente. Consulte la definición del elemento AREA en HTML 4.01.
type: docs
weight: 3080
url: /es/net/aspose.html/htmlareaelement/
---
## HTMLAreaElement class

Definición del área del mapa de imágenes del lado del cliente. Consulte la definición del elemento AREA en HTML 4.01.
...
| Nombre | Descripción |
| --- | --- |
| [AccessKey](../../aspose.html/htmlareaelement/accesskey/) { get; set; } | Una clave de acceso de un solo carácter para dar acceso al control de formulario. Consulte la definición del atributo de clave de acceso en HTML 4.01. |
| [Alt](../../aspose.html/htmlareaelement/alt/) { get; set; } | Texto alternativo para agentes de usuario que no presentan el contenido normal de este elemento . Ver la definición del atributo alt en HTML 4.01. |
...
| [Coords](../../aspose.html/htmlareaelement/coords/) { get; set; } | Lista de longitudes separadas por comas, que define una geometría de región activa. Ver también`forma` por la forma de la región. Consulte la definición del atributo de coordenadas en HTML 4.01. |
...
| [Href](../../aspose.html/htmlareaelement/href/) { get; set; } | El URI [[IETFRFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] del recurso vinculado. Ver la definición del atributo href en HTML 4.01. |
...
| [NoHref](../../aspose.html/htmlareaelement/nohref/) { get; set; } | Especifica que esta área está inactiva, es decir, no tiene acción asociada. Ver la definición del atributo nohref en HTML 4.01. |
...
| [RelList](../../aspose.html/htmlareaelement/rellist/) { get; } | Devuelve una DOMTokenList en vivo que contiene los tokens recibidos al analizar el atributo "rel". |
...
| [Shape](../../aspose.html/htmlareaelement/shape/) { get; set; } | La forma del área activa. Las coordenadas vienen dadas por `coordenadas` . Ver la definición del atributo de forma en HTML 4.01. |
...
| [TabIndex](../../aspose.html/htmlareaelement/tabindex/) { get; set; } | Índice que representa la posición del elemento en el orden de tabulación. Ver la definición del atributo tabindex en HTML 4.01. |
| [TagName](../../aspose.html.dom/element/tagname/) { get; } | El nombre del elemento. |
| [Target](../../aspose.html/htmlareaelement/target/) { get; set; } | Marco para representar el recurso. Consulte la definición del atributo de destino en HTML 4.01. |
