...
description: Todas las interfaces de elementos HTML derivan de esta clase. Los elementos que solo exponen los atributos principales de HTML están representados por la base Elemento HTMLinterfaz. Estos elementos son los siguientes especial SUB SUP SPAN BDOfont TT I B U S STRIKE BIG SMALL frase EM STRONG DFN CODE SAMP KBD VAR CITE SIGLAS ABBRlist DD DTNOFRAMES NOSCRIPTADDRESS CENTERTheestilo Se puede acceder al atributo de un elemento HTML a través de ElementoCSSInlineStyle interfaz que se define en el módulo CSS Hojas de estilo DOM Nivel 2 y CSShttp//www.w3.org/TR/2000/RECDOMLevel2Style20001113 .
type: docs
weight: 3190
