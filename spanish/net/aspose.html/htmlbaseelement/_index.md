...
description: Aspose.Html.HTMLBaseElement clase. URI base del documento IETFRFC 2396 . Ver la definición del elemento BASE en HTML 4.01.
type: docs
weight: 3100
url: /es/net/aspose.html/htmlbaseelement/
---
## HTMLBaseElement class

URI base del documento [[IETFRFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ]. Ver la definición del elemento BASE en HTML 4.01.
...
| [Href](../../aspose.html/htmlbaseelement/href/) { get; set; } | El URI base [[IETFRFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ]. Ver la definición del atributo href en HTML 4.01. |
...
| [Target](../../aspose.html/htmlbaseelement/target/) { get; set; } | El marco de destino predeterminado. Consulte la definición del atributo de destino en HTML 4.01. |
