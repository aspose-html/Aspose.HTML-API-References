...
description: Aspose.Html.HTMLLabelElement clase. Texto de etiqueta de campo de formulario. Ver la definición del elemento LABEL en HTML 4.01.
type: docs
weight: 3350
url: /es/net/aspose.html/htmllabelelement/
---
## HTMLLabelElement class

Texto de etiqueta de campo de formulario. Ver la definición del elemento LABEL en HTML 4.01.
...
| Nombre | Descripción |
| --- | --- |
| [AccessKey](../../aspose.html/htmllabelelement/accesskey/) { get; set; } | Una clave de acceso de un solo carácter para dar acceso al control de formulario. Consulte la definición del atributo de clave de acceso en HTML 4.01. |
...
| [For](../../aspose.html/htmllabelelement/for/) { get; set; } | Este atributo vincula esta etiqueta con otro control de formulario por `identificación`atributo. Consulte la definición del atributo for en HTML 4.01. |
| [Form](../../aspose.html/htmllabelelement/form/) { get; } | Devuelve el`FORMA` elemento que contiene este control. Devuelve `nulo` si este control no está dentro del contexto de un formulario . |
