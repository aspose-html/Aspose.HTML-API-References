...
description: Aspose.Html.HTMLCanvasElement clase. La interfaz HTMLCanvasElement proporciona propiedades y métodos para manipular el diseño y la presentación de los elementos del lienzo. La interfaz HTMLCanvasElement también hereda las propiedades y métodos de la interfaz HTMLElement.
type: docs
weight: 3140
url: /es/net/aspose.html/htmlcanvaselement/
---
## HTMLCanvasElement class

La interfaz HTMLCanvasElement proporciona propiedades y métodos para manipular el diseño y la presentación de los elementos del lienzo. La interfaz HTMLCanvasElement también hereda las propiedades y métodos de la interfaz HTMLElement.
...
| [Height](../../aspose.html/htmlcanvaselement/height/) { get; set; } | Es un número entero positivo que refleja el atributo HTML de altura del elemento de lienzo interpretado en píxeles CSS. Cuando no se especifica el atributo, o si se establece en un valor no válido, como un negativo, se usa el valor predeterminado de 150. |
...
| [Width](../../aspose.html/htmlcanvaselement/width/) { get; set; } | Es un número entero positivo que refleja el atributo HTML de ancho del elemento de lienzo interpretado en píxeles CSS. Cuando no se especifica el atributo, o si se establece en un valor no válido, como un negativo, se utiliza el valor predeterminado de 300. |
...
| [GetContext](../../aspose.html/htmlcanvaselement/getcontext/)(string) | Devuelve un contexto de dibujo en el lienzo o nulo si no se admite el ID de contexto. Un contexto de dibujo le permite dibujar en el lienzo. |
...
| [ToDataURL](../../aspose.html/htmlcanvaselement/todataurl/#todataurl)() | devuelve un URI de datos que contiene una representación de la imagen en el formato especificado por el parámetro de tipo (el valor predeterminado es PNG). La imagen devuelta tiene una resolución de 96 ppp. |
| [ToDataURL](../../aspose.html/htmlcanvaselement/todataurl/#todataurl_1)(string) | devuelve un URI de datos que contiene una representación de la imagen en el formato especificado por el parámetro de tipo (el valor predeterminado es PNG). La imagen devuelta tiene una resolución de 96 ppp. |
| [ToDataURL](../../aspose.html/htmlcanvaselement/todataurl/#todataurl_2)(string, double) | devuelve un URI de datos que contiene una representación de la imagen en el formato especificado por el parámetro de tipo (el valor predeterminado es PNG). La imagen devuelta tiene una resolución de 96 ppp. |
