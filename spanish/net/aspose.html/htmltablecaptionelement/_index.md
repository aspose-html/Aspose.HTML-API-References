...
description: Aspose.Html.HTMLTableCaptionElement clase. Título de la tabla Consulte la definición del elemento CAPTION en HTML 4.01.
type: docs
weight: 3540
url: /es/net/aspose.html/htmltablecaptionelement/
---
## HTMLTableCaptionElement class

Título de la tabla Consulte la definición del elemento CAPTION en HTML 4.01.
...
| Nombre | Descripción |
| --- | --- |
| [Align](../../aspose.html/htmltablecaptionelement/align/) { get; set; } | Alineación del título con respecto a la tabla. Consulte la definición del atributo de alineación en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
