...
description: Aspose.Html.HTMLImageElement clase. Imagen incrustada. Ver la definición del elemento IMG en HTML 4.01.
type: docs
weight: 3310
url: /es/net/aspose.html/htmlimageelement/
---
## HTMLImageElement class

Imagen incrustada. Ver la definición del elemento IMG en HTML 4.01.
...
| Nombre | Descripción |
| --- | --- |
| [Align](../../aspose.html/htmlimageelement/align/) { get; set; } | Alinea este objeto (vertical u horizontalmente) con respecto al texto que lo rodea . Consulte la definición del atributo de alineación en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
| [Alt](../../aspose.html/htmlimageelement/alt/) { get; set; } | Texto alternativo para agentes de usuario que no presentan el contenido normal de este elemento . Ver la definición del atributo alt en HTML 4.01. |
...
| [Border](../../aspose.html/htmlimageelement/border/) { get; set; } | Ancho del borde alrededor de la imagen. Consulte la definición del atributo de borde en HTML 4.01. Este atributo está obsoleto en HTML 4.01. Tenga en cuenta que el tipo de este atributo fue`DOMString` en DOM Nivel 1 HTML [[DOM Nivel 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ] . |
...
| [Height](../../aspose.html/htmlimageelement/height/) { get; set; } | Altura de la imagen en píxeles. Consulte la definición del atributo de altura en HTML 4.01. Tenga en cuenta que el tipo de este atributo era `DOMString` en DOM Nivel 1 HTML [[DOM Nivel 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ]. @versión DOM Nivel 2 |
| [Hspace](../../aspose.html/htmlimageelement/hspace/) { get; set; } | Espacio horizontal a la izquierda y derecha de esta imagen en píxeles. Consulte la definición del atributo hspace en HTML 4.01. Este atributo está en desuso en HTML 4.01. Tenga en cuenta que el tipo de este atributo era `DOMString` en DOM Nivel 1 HTML [[DOM Nivel 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ]. @versión DOM Nivel 2 |
...
| [IsMap](../../aspose.html/htmlimageelement/ismap/) { get; set; } | Usar mapa de imagen del lado del servidor. Consulte la definición del atributo ismap en HTML 4.01. |
...
| [LongDesc](../../aspose.html/htmlimageelement/longdesc/) { get; set; } | URL [[IETFRFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] que designa una descripción larga de esta imagen o cuadro. Consulte la definición del atributo longdesc en HTML 4.01. |
| [Name](../../aspose.html/htmlimageelement/name/) { get; set; } | El nombre del elemento (para compatibilidad con versiones anteriores). |
...
| [Src](../../aspose.html/htmlimageelement/src/) { get; set; } | URL [[IETFRFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] que designa la fuente de esta imagen. Consulte la definición del atributo src en HTML 4.01. |
...
| [UseMap](../../aspose.html/htmlimageelement/usemap/) { get; set; } | Usar mapa de imágenes del lado del cliente. Consulte la definición del atributo usemap en HTML 4.01. |
| [Vspace](../../aspose.html/htmlimageelement/vspace/) { get; set; } | Espacio vertical por encima y por debajo de esta imagen en píxeles. Consulte la definición del atributo vspace en HTML 4.01. Este atributo está obsoleto en HTML 4.01. Tenga en cuenta que el tipo de este atributo era "DOMString" en DOM Nivel 1 HTML [[DOM Nivel 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ]. @versión DOM Nivel 2 |
| [Width](../../aspose.html/htmlimageelement/width/) { get; set; } | El ancho de la imagen en píxeles. Consulte la definición del atributo ancho en HTML 4.01. Tenga en cuenta que el tipo de este atributo era `DOMString` en DOM Nivel 1 HTML [[DOM Nivel 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ]. @versión DOM Nivel 2 |
