...
description: Imagen incrustada. Ver la definición del elemento IMG en HTML 4.01.
type: docs
weight: 3300
...
| [Alt](../../aspose.html/htmlimageelement/alt) { get; set; } | Texto alternativo para agentes de usuario que no muestran el contenido normal de este elemento . Ver la definición del atributo alt en HTML 4.01. |
...
| [LongDesc](../../aspose.html/htmlimageelement/longdesc) { get; set; } | URL [[IETFRFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] que designa una descripción larga de esta imagen o fotograma. Consulte la definición del atributo longdesc en HTML 4.01. |
