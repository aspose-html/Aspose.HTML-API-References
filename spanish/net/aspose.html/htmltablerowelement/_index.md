...
description: Aspose.Html.HTMLTableRowElement clase. Una fila en una tabla. Ver la definición del elemento TR en HTML 4.01.
type: docs
weight: 3580
url: /es/net/aspose.html/htmltablerowelement/
---
## HTMLTableRowElement class

Una fila en una tabla. Ver la definición del elemento TR en HTML 4.01.
...
| Nombre | Descripción |
| --- | --- |
| [Align](../../aspose.html/htmltablerowelement/align/) { get; set; } | Alineación horizontal de datos dentro de las celdas de esta fila. Consulte la definición del atributo align en HTML 4.01. |
...
| [BgColor](../../aspose.html/htmltablerowelement/bgcolor/) { get; set; } | Color de fondo para filas. Consulte la definición del atributo bgcolor en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
| [Cells](../../aspose.html/htmltablerowelement/cells/) { get; } | La colección de celdas en esta fila. @versión DOM Nivel 2 |
| [Ch](../../aspose.html/htmltablerowelement/ch/) { get; set; } | Carácter de alineación para celdas en una columna. Consulte la definición del atributo char en HTML 4.01. |
...
| [ChOff](../../aspose.html/htmltablerowelement/choff/) { get; set; } | Desplazamiento del carácter de alineación. Consulte la definición del atributo charoff en HTML 4.01. |
...
| [RowIndex](../../aspose.html/htmltablerowelement/rowindex/) { get; } | Esto está en orden lógico y no en el orden del documento. El `índice de fila` tiene en cuenta secciones ( `CABEZA` ,`PIE` , o`TBODY` ) dentro de la tabla, colocando`CABEZA` filas primero en el índice, seguido de`TBODY` filas, seguido de`PIE` filas. @versión DOM Nivel 2 |
| [SchemaTypeInfo](../../aspose.html.dom/element/schematypeinfo/) { get; } | La información de tipo asociada con este elemento. |
| [SectionRowIndex](../../aspose.html/htmltablerowelement/sectionrowindex/) { get; } | El índice de esta fila, relativo a la sección actual ( `CABEZA` ,`PIE` , o`TBODY` ), a partir de 0. @versión DOM Nivel 2 |
...
| [VAlign](../../aspose.html/htmltablerowelement/valign/) { get; set; } | Alineación vertical de datos dentro de las celdas de esta fila. Consulte la definición del atributo valign en HTML 4.01. |
...
| [DeleteCell](../../aspose.html/htmltablerowelement/deletecell/)(int) | Elimina una celda de la fila actual. |
...
| [InsertCell](../../aspose.html/htmltablerowelement/insertcell/)(int) | Insertar un vacío`DT` celda en esta fila. Si `índice` es -1 o igual al número de celdas, se agrega la nueva celda . |
