...
description: Aspose.Html.HTMLAnchorElement clase. El elemento ancla. Consulte la definición del elemento A en HTML 4.01.
type: docs
weight: 3060
url: /es/net/aspose.html/htmlanchorelement/
---
## HTMLAnchorElement class

El elemento ancla. Consulte la definición del elemento A en HTML 4.01.
...
| Nombre | Descripción |
| --- | --- |
| [AccessKey](../../aspose.html/htmlanchorelement/accesskey/) { get; set; } | Una clave de acceso de un solo carácter para dar acceso al control de formulario. Consulte la definición del atributo de clave de acceso en HTML 4.01. |
...
| [Charset](../../aspose.html/htmlanchorelement/charset/) { get; set; } | La codificación de caracteres del recurso vinculado. Consulte la definición del atributo charset en HTML 4.01. |
...
| [Coords](../../aspose.html/htmlanchorelement/coords/) { get; set; } | Lista de longitudes separadas por comas, que define una geometría de región activa. Véase también`forma` por la forma de la región. Consulte la definición del atributo de coords en HTML 4.01. |
...
| [Hash](../../aspose.html/htmlanchorelement/hash/) { get; set; } | Obtiene o establece una representación de cadena del segmento hash de la URL asociada. |
| [Host](../../aspose.html/htmlanchorelement/host/) { get; set; } | Obtiene o establece una representación de cadena de los segmentos de host y puerto de la URL asociada. |
| [Hostname](../../aspose.html/htmlanchorelement/hostname/) { get; set; } | Obtiene o establece una representación de cadena del segmento de host de la URL asociada. |
| [Href](../../aspose.html/htmlanchorelement/href/) { get; set; } | El URI absoluto [[IETFRFC 2396](http://www.ietf.org/rfc/rfc2396.txt) del recurso vinculado. Consulte la definición del atributo href en HTML 4.01. |
| [Hreflang](../../aspose.html/htmlanchorelement/hreflang/) { get; set; } | Código de idioma del recurso vinculado. Consulte la definición del atributo hreflang en HTML 4.01. |
...
| [Name](../../aspose.html/htmlanchorelement/name/) { get; set; } | Nombre del ancla. Consulte la definición del atributo de nombre en HTML 4.01. |
...
| [Origin](../../aspose.html/htmlanchorelement/origin/) { get; } | Obtiene una representación de cadena del segmento de origen de la URL asociada. |
...
| [Password](../../aspose.html/htmlanchorelement/password/) { get; set; } | Obtiene o establece una representación de cadena del segmento de contraseña de la URL asociada. |
| [Pathname](../../aspose.html/htmlanchorelement/pathname/) { get; set; } | Obtiene o establece una representación de cadena del segmento de ruta de la URL asociada. |
| [Port](../../aspose.html/htmlanchorelement/port/) { get; set; } | Obtiene o establece una representación de cadena del segmento de puerto de la URL asociada. |
...
| [Protocol](../../aspose.html/htmlanchorelement/protocol/) { get; set; } | Obtiene o establece una representación de cadena del segmento de esquema de la URL asociada. |
| [Rel](../../aspose.html/htmlanchorelement/rel/) { get; set; } | Tipo de vínculo directo. Ver la definición del atributo rel en HTML 4.01. |
| [RelList](../../aspose.html/htmlanchorelement/rellist/) { get; } | Devuelve una DOMTokenList en vivo que contiene los tokens recibidos al analizar el atributo "rel". |
| [Rev](../../aspose.html/htmlanchorelement/rev/) { get; set; } | Tipo de vínculo inverso. Consulte la definición del atributo rev en HTML 4.01. |
| [SchemaTypeInfo](../../aspose.html.dom/element/schematypeinfo/) { get; } | La información de tipo asociada con este elemento. |
| [Search](../../aspose.html/htmlanchorelement/search/) { get; set; } | Obtiene o establece una representación de cadena del segmento de búsqueda de la URL asociada. |
| [ShadowRoot](../../aspose.html.dom/element/shadowroot/) { get; } | Devuelve shadowRoot almacenado en este elemento o nulo si está cerrado. |
| [Shape](../../aspose.html/htmlanchorelement/shape/) { get; set; } | La forma del área activa. Las coordenadas vienen dadas por `coordenadas` . Ver la definición del atributo de forma en HTML 4.01. |
...
| [TabIndex](../../aspose.html/htmlanchorelement/tabindex/) { get; set; } | Índice que representa la posición del elemento en el orden de tabulación. Ver la definición del atributo tabindex en HTML 4.01. |
| [TagName](../../aspose.html.dom/element/tagname/) { get; } | El nombre del elemento. |
| [Target](../../aspose.html/htmlanchorelement/target/) { get; set; } | Marco para representar el recurso. Consulte la definición del atributo de destino en HTML 4.01. |
...
| [Type](../../aspose.html/htmlanchorelement/type/) { get; set; } | Tipo de contenido de aviso. Consulte la definición del atributo de tipo en HTML 4.01. |
| [Username](../../aspose.html/htmlanchorelement/username/) { get; set; } | Obtiene o establece una representación de cadena del segmento de nombre de usuario de la URL asociada. |
...
| [Blur](../../aspose.html/htmlanchorelement/blur/)() | Elimina el foco del teclado de este elemento. |
...
| [Focus](../../aspose.html/htmlanchorelement/focus/)() | Da foco de teclado a este elemento. |
...
| Nombre | Descripción |
| --- | --- |
| event [OnAbort](../../aspose.html/htmlelement/onabort/) | Obtiene o establece el controlador de eventos para el evento OnAbort. |
| event [OnBlur](../../aspose.html/htmlelement/onblur/) | Obtiene o establece el controlador de eventos para el evento OnBlur. |
| event [OnCancel](../../aspose.html/htmlelement/oncancel/) | Obtiene o establece el controlador de eventos para el evento OnCancel. |
| event [OnCanplay](../../aspose.html/htmlelement/oncanplay/) | Obtiene o establece el controlador de eventos para el evento OnCanplay. |
| event [OnCanPlayThrough](../../aspose.html/htmlelement/oncanplaythrough/) | Obtiene o establece el controlador de eventos para el evento OnCanPlayThrough. |
| event [OnChange](../../aspose.html/htmlelement/onchange/) | Obtiene o establece el controlador de eventos para el evento OnChange. |
| event [OnClick](../../aspose.html/htmlelement/onclick/) | Obtiene o establece el controlador de eventos para el evento OnClick. |
| event [OnCueChange](../../aspose.html/htmlelement/oncuechange/) | Obtiene o establece el controlador de eventos para el evento OnCueChange. |
| event [OnDblClick](../../aspose.html/htmlelement/ondblclick/) | Obtiene o establece el controlador de eventos para el evento OnDblClick. |
| event [OnDurationChange](../../aspose.html/htmlelement/ondurationchange/) | Obtiene o establece el controlador de eventos para el evento OnDurationChange. |
| event [OnEmptied](../../aspose.html/htmlelement/onemptied/) | Obtiene o establece el controlador de eventos para el evento OnEmptied. |
| event [OnEnded](../../aspose.html/htmlelement/onended/) | Obtiene o establece el controlador de eventos para el evento OnEnded. |
| event [OnError](../../aspose.html/htmlelement/onerror/) | Obtiene o establece el controlador de eventos para el evento OnError. |
| event [OnFocus](../../aspose.html/htmlelement/onfocus/) | Obtiene o establece el controlador de eventos para el evento OnFocus. |
| event [OnInput](../../aspose.html/htmlelement/oninput/) | Obtiene o establece el controlador de eventos para el evento OnInput. |
| event [OnInvalid](../../aspose.html/htmlelement/oninvalid/) | Obtiene o establece el controlador de eventos para el evento OnInvalid. |
| event [OnKeyDown](../../aspose.html/htmlelement/onkeydown/) | Obtiene o establece el controlador de eventos para el evento OnKeyDown. |
| event [OnKeyPress](../../aspose.html/htmlelement/onkeypress/) | Obtiene o establece el controlador de eventos para el evento OnKeyPress. |
| event [OnKeyUp](../../aspose.html/htmlelement/onkeyup/) | Obtiene o establece el controlador de eventos para el evento OnKeyUp. |
| event [OnLoad](../../aspose.html/htmlelement/onload/) | Obtiene o establece el controlador de eventos para el evento OnLoad. |
| event [OnLoadedData](../../aspose.html/htmlelement/onloadeddata/) | Obtiene o establece el controlador de eventos para el evento OnLoadedData. |
| event [OnLoadedMetadata](../../aspose.html/htmlelement/onloadedmetadata/) | Obtiene o establece el controlador de eventos para el evento OnLoadedMetadata. |
| event [OnLoadStart](../../aspose.html/htmlelement/onloadstart/) | Obtiene o establece el controlador de eventos para el evento OnLoadStart. |
| event [OnMouseDown](../../aspose.html/htmlelement/onmousedown/) | Obtiene o establece el controlador de eventos para el evento OnMouseDown. |
| event [OnMouseEnter](../../aspose.html/htmlelement/onmouseenter/) | Obtiene o establece el controlador de eventos para el evento OnMouseEnter. |
| event [OnMouseLeave](../../aspose.html/htmlelement/onmouseleave/) | Obtiene o establece el controlador de eventos para el evento OnMouseLeave. |
| event [OnMouseMove](../../aspose.html/htmlelement/onmousemove/) | Obtiene o establece el controlador de eventos para el evento OnMouseMove. |
| event [OnMouseOut](../../aspose.html/htmlelement/onmouseout/) | Obtiene o establece el controlador de eventos para el evento OnMouseOut. |
| event [OnMouseOver](../../aspose.html/htmlelement/onmouseover/) | Obtiene o establece el controlador de eventos para el evento OnMouseOver. |
| event [OnMouseUp](../../aspose.html/htmlelement/onmouseup/) | Obtiene o establece el controlador de eventos para el evento OnMouseUp. |
| event [OnMouseWheel](../../aspose.html/htmlelement/onmousewheel/) | Obtiene o establece el controlador de eventos para el evento OnMouseWheel. |
| event [OnPause](../../aspose.html/htmlelement/onpause/) | Obtiene o establece el controlador de eventos para el evento OnPause. |
| event [OnPlay](../../aspose.html/htmlelement/onplay/) | Obtiene o establece el controlador de eventos para el evento OnPlay. |
| event [OnPlaying](../../aspose.html/htmlelement/onplaying/) | Obtiene o establece el controlador de eventos para el evento OnPlaying. |
| event [OnProgress](../../aspose.html/htmlelement/onprogress/) | Obtiene o establece el controlador de eventos para el evento OnProgress. |
| event [OnRateChange](../../aspose.html/htmlelement/onratechange/) | Obtiene o establece el controlador de eventos para el evento OnRateChange. |
| event [OnReset](../../aspose.html/htmlelement/onreset/) | Obtiene o establece el controlador de eventos para el evento OnReset. |
| event [OnResize](../../aspose.html/htmlelement/onresize/) | Obtiene o establece el controlador de eventos para el evento OnResize. |
| event [OnScroll](../../aspose.html/htmlelement/onscroll/) | Obtiene o establece el controlador de eventos para el evento OnScroll. |
| event [OnSeeked](../../aspose.html/htmlelement/onseeked/) | Obtiene o establece el controlador de eventos para el evento OnSeeked. |
| event [OnSeeking](../../aspose.html/htmlelement/onseeking/) | Obtiene o establece el controlador de eventos para el evento OnSeeking. |
| event [OnSelect](../../aspose.html/htmlelement/onselect/) | Obtiene o establece el controlador de eventos para el evento OnSelect. |
| event [OnShow](../../aspose.html/htmlelement/onshow/) | Obtiene o establece el controlador de eventos para el evento OnShow. |
| event [OnStalled](../../aspose.html/htmlelement/onstalled/) | Obtiene o establece el controlador de eventos para el evento OnStalled. |
| event [OnSubmit](../../aspose.html/htmlelement/onsubmit/) | Obtiene o establece el controlador de eventos para el evento OnSubmit. |
| event [OnSuspend](../../aspose.html/htmlelement/onsuspend/) | Obtiene o establece el controlador de eventos para el evento OnSuspend. |
| event [OnTimeUpdate](../../aspose.html/htmlelement/ontimeupdate/) | Obtiene o establece el controlador de eventos para el evento OnTimeUpdate. |
| event [OnToggle](../../aspose.html/htmlelement/ontoggle/) | Obtiene o establece el controlador de eventos para el evento OnToggle. |
| event [OnVolumeChange](../../aspose.html/htmlelement/onvolumechange/) | Obtiene o establece el controlador de eventos para el evento OnVolumeChange. |
| event [OnWaiting](../../aspose.html/htmlelement/onwaiting/) | Obtiene o establece el controlador de eventos para el evento OnWaiting. |
