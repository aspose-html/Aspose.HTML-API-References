...
description: Aspose.Html.HTMLUListElement clase. Lista desordenada. Consulte la definición del elemento UL en HTML 4.01.
type: docs
weight: 3630
url: /es/net/aspose.html/htmlulistelement/
---
## HTMLUListElement class

Lista desordenada. Consulte la definición del elemento UL en HTML 4.01.
...
| [Compact](../../aspose.html/htmlulistelement/compact/) { get; set; } | Reducir el espacio entre los elementos de la lista. Consulte la definición de atributo compacto en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
...
| [Type](../../aspose.html/htmlulistelement/type/) { get; set; } | Estilo viñeta. Consulte la definición del atributo de tipo en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
