...
description: Aspose.Html.HTMLDivElement clase. Contenedor de bloques genérico. Consulte la definición del elemento DIV en HTML 4.01.
type: docs
weight: 3180
url: /es/net/aspose.html/htmldivelement/
---
## HTMLDivElement class

Contenedor de bloques genérico. Consulte la definición del elemento DIV en HTML 4.01.
...
| Nombre | Descripción |
| --- | --- |
| [Align](../../aspose.html/htmldivelement/align/) { get; set; } | Alineación de texto horizontal. Consulte la definición del atributo de alineación en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
