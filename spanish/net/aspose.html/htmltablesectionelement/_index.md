...
description: Aspose.Html.HTMLTableSectionElement clase. ElCABEZA PIE  yTBODY elementos.
type: docs
weight: 3590
url: /es/net/aspose.html/htmltablesectionelement/
---
## HTMLTableSectionElement class

El`CABEZA` ,`PIE` , y`TBODY` elementos.
...
| Nombre | Descripción |
| --- | --- |
| [Align](../../aspose.html/htmltablesectionelement/align/) { get; set; } | Alineación horizontal de datos en celdas. Ver el`alinear` Atributo para HTMLTheadElement para más detalles. |
...
| [Ch](../../aspose.html/htmltablesectionelement/ch/) { get; set; } | Carácter de alineación para celdas en una columna. Consulte la definición del atributo char en HTML 4.01. |
...
| [ChOff](../../aspose.html/htmltablesectionelement/choff/) { get; set; } | Desplazamiento del carácter de alineación. Consulte la definición del atributo charoff en HTML 4.01. |
...
| [Rows](../../aspose.html/htmltablesectionelement/rows/) { get; } | La colección de filas en esta sección de la tabla. |
...
| [VAlign](../../aspose.html/htmltablesectionelement/valign/) { get; set; } | Alineación vertical de datos en celdas. Ver el`valeroso` Atributo para HTMLTheadElement para más detalles. |
...
| [DeleteRow](../../aspose.html/htmltablesectionelement/deleterow/)(int) | Eliminar una fila de esta sección. |
...
| [InsertRow](../../aspose.html/htmltablesectionelement/insertrow/)(int) | Inserta una fila en esta sección. La nueva fila se inserta inmediatamente antes de la actual`índice` fila en esta sección. Si `índice` es -1 o igual al número de filas en esta sección , se agrega la nueva fila. |
