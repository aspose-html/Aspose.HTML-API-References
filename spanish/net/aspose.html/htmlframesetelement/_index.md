...
description: Aspose.Html.HTMLFrameSetElement clase. Crea una cuadrícula de marcos. Ver la definición del elemento FRAMESET en HTML 4.01.
type: docs
weight: 3250
url: /es/net/aspose.html/htmlframesetelement/
---
## HTMLFrameSetElement class

Crea una cuadrícula de marcos. Ver la definición del elemento FRAMESET en HTML 4.01.
...
| [Cols](../../aspose.html/htmlframesetelement/cols/) { get; set; } | El número de columnas de marcos en el conjunto de marcos. Consulte la definición del atributo cols en HTML 4.01. |
...
| [Rows](../../aspose.html/htmlframesetelement/rows/) { get; set; } | El número de filas de marcos en el conjunto de marcos. Consulte la definición del atributo de filas en HTML 4.01. |
