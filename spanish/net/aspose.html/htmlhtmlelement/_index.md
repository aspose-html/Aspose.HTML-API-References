...
description: Aspose.Html.HTMLHtmlElement clase. Raíz de un documento HTML. Ver la definición del elemento HTML en HTML 4.01.
type: docs
weight: 3290
url: /es/net/aspose.html/htmlhtmlelement/
---
## HTMLHtmlElement class

Raíz de un documento HTML. Ver la definición del elemento HTML en HTML 4.01.
...
| [Version](../../aspose.html/htmlhtmlelement/version/) { get; set; } | Información de versión sobre la DTD del documento. Consulte la definición del atributo de versión en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
