...
description: Aspose.Html.HTMLIsIndexElement clase. Este elemento se utiliza para la entrada de texto de una sola línea. Consulte la definición del elemento ISINDEX en HTML 4.01. Este elemento está en desuso en HTML 4.01.
type: docs
weight: 3330
url: /es/net/aspose.html/htmlisindexelement/
---
## HTMLIsIndexElement class

Este elemento se utiliza para la entrada de texto de una sola línea. Consulte la definición del elemento ISINDEX en HTML 4.01. Este elemento está en desuso en HTML 4.01.
...
| [Form](../../aspose.html/htmlisindexelement/form/) { get; } | Devuelve el elemento que contiene este control. Devuelve si este control no está dentro del contexto de un formulario . |
...
| [Prompt](../../aspose.html/htmlisindexelement/prompt/) { get; set; } | El mensaje de solicitud. Consulte la definición del atributo de solicitud en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
