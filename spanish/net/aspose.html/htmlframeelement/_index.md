...
description: Aspose.Html.HTMLFrameElement clase. Crea un marco. Ver la definición del elemento FRAME en HTML 4.01.
type: docs
weight: 3240
url: /es/net/aspose.html/htmlframeelement/
---
## HTMLFrameElement class

Crea un marco. Ver la definición del elemento FRAME en HTML 4.01.
...
| [ContentDocument](../../aspose.html/htmlframeelement/contentdocument/) { get; } | El documento que contiene este marco, si lo hay y está disponible, o`nulo` de lo contrario. @desde DOM Nivel 2 |
...
| [FrameBorder](../../aspose.html/htmlframeelement/frameborder/) { get; set; } | Solicitar bordes de marco. Ver la definición del atributo frameborder en HTML 4.01. |
...
| [LongDesc](../../aspose.html/htmlframeelement/longdesc/) { get; set; } | URL [[IETFRFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] que designa una descripción larga de esta imagen o cuadro. Consulte la definición del atributo longdesc en HTML 4.01. |
| [MarginHeight](../../aspose.html/htmlframeelement/marginheight/) { get; set; } | Altura del margen del marco, en píxeles. Consulte la definición del atributo marginheight en HTML 4.01. |
| [MarginWidth](../../aspose.html/htmlframeelement/marginwidth/) { get; set; } | Ancho del margen del marco, en píxeles. Consulte la definición del atributo marginwidth en HTML 4.01. |
| [Name](../../aspose.html/htmlframeelement/name/) { get; set; } | El nombre del marco (objeto del`objetivo` atributo). Consulte la definición del atributo de nombre en HTML 4.01. |
...
| [NoResize](../../aspose.html/htmlframeelement/noresize/) { get; set; } | Cuando es verdadero, prohíbe al usuario cambiar el tamaño del marco. Consulte la definición del atributo noresize en HTML 4.01. |
...
| [Scrolling](../../aspose.html/htmlframeelement/scrolling/) { get; set; } | Especifica si el marco debe tener o no barras de desplazamiento. Consulte la definición del atributo de desplazamiento en HTML 4.01. |
| [ShadowRoot](../../aspose.html.dom/element/shadowroot/) { get; } | Devuelve shadowRoot almacenado en este elemento o nulo si está cerrado. |
| [Src](../../aspose.html/htmlframeelement/src/) { get; set; } | URI [[IETFRFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] que designa el contenido del cuadro inicial. Consulte la definición del atributo src en HTML 4.01. |
