...
description: Aspose.Html.HTMLTextAreaElement clase. Campo de texto de varias líneas. Ver la definición del elemento TEXTAREA en HTML 4.01.
type: docs
weight: 3610
url: /es/net/aspose.html/htmltextareaelement/
---
## HTMLTextAreaElement class

Campo de texto de varias líneas. Ver la definición del elemento TEXTAREA en HTML 4.01.
...
| Nombre | Descripción |
| --- | --- |
| [AccessKey](../../aspose.html/htmltextareaelement/accesskey/) { get; set; } | Una clave de acceso de un solo carácter para dar acceso al control de formulario. Consulte la definición del atributo de clave de acceso en HTML 4.01. |
...
| [Cols](../../aspose.html/htmltextareaelement/cols/) { get; set; } | Ancho de control (en caracteres). Consulte la definición del atributo cols en HTML 4.01. |
| [DefaultValue](../../aspose.html/htmltextareaelement/defaultvalue/) { get; set; } | Representa el contenido del elemento. El valor de este atributo no cambia si el contenido del control de formulario correspondiente, en un agente de usuario interactivo, cambia. @version DOM Nivel 2 |
...
| [Disabled](../../aspose.html/htmltextareaelement/disabled/) { get; set; } | El control no está disponible en este contexto. Consulte la definición del atributo deshabilitado en HTML 4.01. |
...
| [Form](../../aspose.html/htmltextareaelement/form/) { get; } | Devuelve el`FORMA` elemento que contiene este control. Devuelve `nulo` si este control no está dentro del contexto de un formulario . |
...
| [Name](../../aspose.html/htmltextareaelement/name/) { get; set; } | Control de formulario o nombre de objeto cuando se envía con un formulario. Ver la definición del atributo name en HTML 4.01. |
...
| [ReadOnly](../../aspose.html/htmltextareaelement/readonly/) { get; set; } | Este control es de solo lectura. Consulte la definición del atributo de solo lectura en HTML 4.01. |
| [Rows](../../aspose.html/htmltextareaelement/rows/) { get; set; } | Número de filas de texto. Ver la definición de atributos de filas en HTML 4.01. |
...
| [TabIndex](../../aspose.html/htmltextareaelement/tabindex/) { get; set; } | Índice que representa la posición del elemento en el orden de tabulación. Ver la definición del atributo tabindex en HTML 4.01. |
