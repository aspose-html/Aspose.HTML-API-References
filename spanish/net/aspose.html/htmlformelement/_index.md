...
description: Aspose.Html.HTMLFormElement clase. ElFORMA element abarca un comportamiento similar a una colección y un elemento. Proporciona acceso directo a los controles de formulario contenidos así como a los atributos del elemento de formulario. Ver la definición del elemento FORM en HTML 4.01.
type: docs
weight: 3230
url: /es/net/aspose.html/htmlformelement/
---
## HTMLFormElement class

El`FORMA` element abarca un comportamiento similar a una colección y un elemento. Proporciona acceso directo a los controles de formulario contenidos así como a los atributos del elemento de formulario. Ver la definición del elemento FORM en HTML 4.01.
...
| Nombre | Descripción |
| --- | --- |
| [AcceptCharset](../../aspose.html/htmlformelement/acceptcharset/) { get; set; } | Lista de conjuntos de caracteres admitidos por el servidor. Consulte la definición del atributo accept-charset en HTML 4.01. |
| [Action](../../aspose.html/htmlformelement/action/) { get; set; } | Manejador de formularios del lado del servidor. Ver la definición del atributo de acción en HTML 4.01. |
...
| [Elements](../../aspose.html/htmlformelement/elements/) { get; } | Devuelve una colección de todos los elementos de control de formulario en el formulario. |
| [Enctype](../../aspose.html/htmlformelement/enctype/) { get; set; } | El tipo de contenido del formulario enviado, generalmente "aplicación/x-www-form-urlencoded". Consulte la definición del atributo enctype en HTML 4.01. No se garantiza que el controlador onsubmit even se active al invocar este método. El comportamiento es inconsistente por razones históricas y los autores no deben confiar en un en particular. |
...
| [Length](../../aspose.html/htmlformelement/length/) { get; } | El número de controles de formulario en el formulario. |
...
| [Method](../../aspose.html/htmlformelement/method/) { get; set; } | método HTTP [[RFC 2616 de la IETF](http://www.ietf.org/rfc/rfc2616.txt) utilizado para enviar el formulario. Ver la definición de atributo de método en HTML 4.01. |
| [Name](../../aspose.html/htmlformelement/name/) { get; set; } | Nombra el formulario. |
...
| [Target](../../aspose.html/htmlformelement/target/) { get; set; } | Marco para representar el recurso. Consulte la definición del atributo de destino en HTML 4.01. |
...
| [Reset](../../aspose.html/htmlformelement/reset/)() | Restaura los valores predeterminados de un elemento de formulario. Realiza la misma acción que un botón de reinicio. |
...
| [Submit](../../aspose.html/htmlformelement/submit/)() | Envía el formulario. Realiza la misma acción que un botón de envío. |
