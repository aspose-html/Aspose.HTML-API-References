...
description: Aspose.Html.HTMLParamElement clase. Parámetros alimentados alOBJETO elemento. Consulte la definición del elemento PARAM en HTML 4.01.
type: docs
weight: 3480
url: /es/net/aspose.html/htmlparamelement/
---
## HTMLParamElement class

Parámetros alimentados al`OBJETO` elemento. Consulte la definición del elemento PARAM en HTML 4.01.
...
| [Name](../../aspose.html/htmlparamelement/name/) { get; set; } | El nombre de un parámetro de tiempo de ejecución. Consulte la definición del atributo de nombre en HTML 4.01. |
...
| [Type](../../aspose.html/htmlparamelement/type/) { get; set; } | Tipo de contenido para el`valor` atributo cuando `tipo de valor` tiene el valor "ref". Consulte la definición del atributo de tipo en HTML 4.01. |
| [Value](../../aspose.html/htmlparamelement/value/) { get; set; } | El valor de un parámetro de tiempo de ejecución. Consulte la definición del atributo de valor en HTML 4.01. |
| [ValueType](../../aspose.html/htmlparamelement/valuetype/) { get; set; } | Información sobre el significado de la`valor` atributo valor. Consulte la definición del atributo valuetype en HTML 4.01. |
