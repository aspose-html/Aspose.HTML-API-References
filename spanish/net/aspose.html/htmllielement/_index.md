...
description: Aspose.Html.HTMLLIElement clase. Elemento de lista. Ver la definición del elemento LI en HTML 4.01.
type: docs
weight: 3340
url: /es/net/aspose.html/htmllielement/
---
## HTMLLIElement class

Elemento de lista. Ver la definición del elemento LI en HTML 4.01.
...
| [Type](../../aspose.html/htmllielement/type/) { get; set; } | Estilo de viñeta de elemento de lista. Consulte la definición del atributo de tipo en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
| [Value](../../aspose.html/htmllielement/value/) { get; set; } | Restablece el número de secuencia cuando se usa en`OL` . Consulte la definición del atributo value en HTML 4.01. Este atributo está en desuso en HTML 4.01. |
