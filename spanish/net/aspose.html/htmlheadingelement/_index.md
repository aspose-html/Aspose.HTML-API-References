...
description: Aspose.Html.HTMLHeadingElement clase. Para elH1 aH6 elementos. Ver la definición H1 element en HTML 4.01.
type: docs
weight: 3280
url: /es/net/aspose.html/htmlheadingelement/
---
## HTMLHeadingElement class

Para el`H1` a`H6` elementos. Ver la definición H1 element en HTML 4.01.
...
| Nombre | Descripción |
| --- | --- |
| [Align](../../aspose.html/htmlheadingelement/align/) { get; set; } | Alineación de texto horizontal. Consulte la definición del atributo de alineación en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
