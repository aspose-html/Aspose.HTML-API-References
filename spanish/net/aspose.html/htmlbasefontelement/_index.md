...
description: Aspose.Html.HTMLBaseFontElement clase. Fuente base. Consulte la definición del elemento BASEFONT en HTML 4.01. Este elemento está obsoleto en HTML 4.01.
type: docs
weight: 3110
url: /es/net/aspose.html/htmlbasefontelement/
---
## HTMLBaseFontElement class

Fuente base. Consulte la definición del elemento BASEFONT en HTML 4.01. Este elemento está obsoleto en HTML 4.01.
...
| [Color](../../aspose.html/htmlbasefontelement/color/) { get; set; } | Color de fuente. Consulte la definición del atributo de color en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
...
| [Face](../../aspose.html/htmlbasefontelement/face/) { get; set; } | Identificador de cara de fuente. Consulte la definición del atributo de cara en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
...
| [Size](../../aspose.html/htmlbasefontelement/size/) { get; set; } | Tamaño de fuente calculado. Consulte la definición del atributo de tamaño en HTML 4.01. Este atributo está obsoleto en HTML 4.01. @version DOM Nivel 2 |
