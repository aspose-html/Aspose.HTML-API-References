...
description: Aspose.Html.HTMLLegendElement clase. Proporciona un título para unCONJUNTO DE CAMPO agrupamiento. Consulte la definición del elemento LEGEND en HTML 4.01.
type: docs
weight: 3360
url: /es/net/aspose.html/htmllegendelement/
---
## HTMLLegendElement class

Proporciona un título para un`CONJUNTO DE CAMPO` agrupamiento. Consulte la definición del elemento LEGEND en HTML 4.01.
...
| Nombre | Descripción |
| --- | --- |
| [AccessKey](../../aspose.html/htmllegendelement/accesskey/) { get; set; } | Una clave de acceso de un solo carácter para dar acceso al control de formulario. Consulte la definición del atributo de clave de acceso en HTML 4.01. |
| [Align](../../aspose.html/htmllegendelement/align/) { get; set; } | Alineación de texto relativa a`CONJUNTO DE CAMPO` . Consulte la definición del atributo align en HTML 4.01. Este atributo está en desuso en HTML 4.01. |
...
| [Form](../../aspose.html/htmllegendelement/form/) { get; } | Devuelve el`FORMA` elemento que contiene este control. Devuelve `nulo` si este control no está dentro del contexto de un formulario . |
