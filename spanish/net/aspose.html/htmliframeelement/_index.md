...
description: Subventanas en línea. Consulte la definición del elemento IFRAME en HTML 4.01.
type: docs
weight: 3290
...
| [LongDesc](../../aspose.html/htmliframeelement/longdesc) { get; set; } | URL [[IETFRFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] que designa una descripción larga de esta imagen o fotograma. Consulte la definición del atributo longdesc en HTML 4.01. |
