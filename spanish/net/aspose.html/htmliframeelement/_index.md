...
description: Aspose.Html.HTMLIFrameElement clase. Subventanas en línea. Consulte la definición del elemento IFRAME en HTML 4.01.
type: docs
weight: 3300
url: /es/net/aspose.html/htmliframeelement/
---
## HTMLIFrameElement class

Subventanas en línea. Consulte la definición del elemento IFRAME en HTML 4.01.
...
| Nombre | Descripción |
| --- | --- |
| [Align](../../aspose.html/htmliframeelement/align/) { get; set; } | Alinea este objeto (vertical u horizontalmente) con respecto al texto que lo rodea . Consulte la definición del atributo de alineación en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
...
| [FrameBorder](../../aspose.html/htmliframeelement/frameborder/) { get; set; } | Solicitar bordes de marco. Ver la definición del atributo frameborder en HTML 4.01. |
| [Height](../../aspose.html/htmliframeelement/height/) { get; set; } | Altura del marco. Ver la definición del atributo de altura en HTML 4.01. |
...
| [LongDesc](../../aspose.html/htmliframeelement/longdesc/) { get; set; } | URL [[IETFRFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] que designa una descripción larga de esta imagen o cuadro. Consulte la definición del atributo longdesc en HTML 4.01. |
| [MarginHeight](../../aspose.html/htmliframeelement/marginheight/) { get; set; } | Altura del margen del marco, en píxeles. Consulte la definición del atributo marginheight en HTML 4.01. |
| [MarginWidth](../../aspose.html/htmliframeelement/marginwidth/) { get; set; } | Ancho del margen del marco, en píxeles. Consulte la definición del atributo marginwidth en HTML 4.01. |
| [Name](../../aspose.html/htmliframeelement/name/) { get; set; } | El nombre del marco (objeto del`objetivo` atributo). Consulte la definición del atributo de nombre en HTML 4.01. |
...
| [Scrolling](../../aspose.html/htmliframeelement/scrolling/) { get; set; } | Especifica si el marco debe tener o no barras de desplazamiento. Consulte la definición del atributo de desplazamiento en HTML 4.01. |
| [ShadowRoot](../../aspose.html.dom/element/shadowroot/) { get; } | Devuelve shadowRoot almacenado en este elemento o nulo si está cerrado. |
| [Src](../../aspose.html/htmliframeelement/src/) { get; set; } | URI [[IETFRFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] que designa el contenido del cuadro inicial. Consulte la definición del atributo src en HTML 4.01. |
...
| [Width](../../aspose.html/htmliframeelement/width/) { get; set; } | Ancho del marco. Ver la definición del atributo ancho en HTML 4.01. |
