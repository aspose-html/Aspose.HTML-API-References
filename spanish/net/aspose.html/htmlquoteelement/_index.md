...
description: Aspose.Html.HTMLQuoteElement clase. Para elq yBLOQUEOelementos. Consulte la definición del elemento Q en HTML 4.01.
type: docs
weight: 3500
url: /es/net/aspose.html/htmlquoteelement/
---
## HTMLQuoteElement class

Para el`q` y`BLOQUEO`elementos. Consulte la definición del elemento Q en HTML 4.01.
...
| [Cite](../../aspose.html/htmlquoteelement/cite/) { get; set; } | URI [[IETFRFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] designando un documento o mensaje fuente. Consulte la definición del atributo de cita en HTML 4.01. |
