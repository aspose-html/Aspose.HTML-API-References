...
description: Aspose.Html.HTMLTableCellElement clase. El objeto utilizado para representar elJU yDT elementos. Ver la definición del elemento TD en HTML 4.01.
type: docs
weight: 3550
url: /es/net/aspose.html/htmltablecellelement/
---
## HTMLTableCellElement class

El objeto utilizado para representar el`JU` y`DT` elementos. Ver la definición del elemento TD en HTML 4.01.
...
| Nombre | Descripción |
| --- | --- |
| [Abbr](../../aspose.html/htmltablecellelement/abbr/) { get; set; } | Abreviatura de celdas de encabezado. Consulte la definición del atributo abbr en HTML 4.01. |
| [Align](../../aspose.html/htmltablecellelement/align/) { get; set; } | Alineación horizontal de datos en celda. Ver el atributo de alineación definición en HTML 4.01. |
...
| [Axis](../../aspose.html/htmltablecellelement/axis/) { get; set; } | Grupo de nombres de encabezados relacionados. Consulte la definición del atributo del eje en HTML 4.01. |
...
| [BgColor](../../aspose.html/htmltablecellelement/bgcolor/) { get; set; } | Color de fondo de celda. Consulte la definición del atributo bgcolor en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
| [CellIndex](../../aspose.html/htmltablecellelement/cellindex/) { get; } | El índice de esta celda en la fila, comenzando desde 0. Este índice está en el orden del árbol del documento y no en el orden de visualización. |
| [Ch](../../aspose.html/htmltablecellelement/ch/) { get; set; } | Carácter de alineación para celdas en una columna. Consulte la definición del atributo char en HTML 4.01. |
...
| [ChOff](../../aspose.html/htmltablecellelement/choff/) { get; set; } | Desplazamiento del carácter de alineación. Consulte la definición del atributo charoff en HTML 4.01. |
...
| [ColSpan](../../aspose.html/htmltablecellelement/colspan/) { get; set; } | Número de columnas distribuidas por celda. Consulte la definición del atributo colspan en HTML 4.01. |
...
| [Headers](../../aspose.html/htmltablecellelement/headers/) { get; set; } | Lista de`identificación` valores de atributo para las celdas de encabezado. Consulte la definición de atributos de encabezados en HTML 4.01. |
| [Height](../../aspose.html/htmltablecellelement/height/) { get; set; } | Altura de celda. Consulte la definición del atributo de altura en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
...
| [NoWrap](../../aspose.html/htmltablecellelement/nowrap/) { get; set; } | Suprimir ajuste de palabras. Consulte la definición del atributo nowrap en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
...
| [RowSpan](../../aspose.html/htmltablecellelement/rowspan/) { get; set; } | Número de filas que abarca la celda. Consulte la definición del atributo de rango de filas en HTML 4.01. |
| [SchemaTypeInfo](../../aspose.html.dom/element/schematypeinfo/) { get; } | La información de tipo asociada con este elemento. |
| [Scope](../../aspose.html/htmltablecellelement/scope/) { get; set; } | Ámbito cubierto por celdas de encabezado. Consulte la definición del atributo de alcance en HTML 4.01. |
...
| [VAlign](../../aspose.html/htmltablecellelement/valign/) { get; set; } | Alineación vertical de datos en celda. Consulte la definición del atributo valign en HTML 4.01. |
| [Width](../../aspose.html/htmltablecellelement/width/) { get; set; } | Ancho de celda. Consulte la definición del atributo ancho en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
