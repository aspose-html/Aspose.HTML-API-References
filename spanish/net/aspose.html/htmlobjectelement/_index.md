...
| Nombre | Descripción |
| --- | --- |
| [Align](../../aspose.html/htmlobjectelement/align/) { get; set; } | Alinea este objeto (vertical u horizontalmente) con respecto al texto que lo rodea. Consulte la definición del atributo de alineación en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
| [Archive](../../aspose.html/htmlobjectelement/archive/) { get; set; } | Lista de archivos separados por espacios. Ver la definición de atributo de archivo en HTML 4.01. |
...
| [Border](../../aspose.html/htmlobjectelement/border/) { get; set; } | Ancho del borde alrededor del objeto. Consulte la definición del atributo de borde en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
...
| [ClassId](../../aspose.html/htmlobjectelement/classid/) { get; set; } | Define un valor de ID de clase como se establece en el Registro de Windows o una URL |
...
| [Code](../../aspose.html/htmlobjectelement/code/) { get; set; } | Archivo de clase de applet. Ver el`código` atributo para HTMLAppletElement. |
| [CodeBase](../../aspose.html/htmlobjectelement/codebase/) { get; set; } | URI base [[IETFRFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] para`identificador de clase` ,`datos` , y `archivo` atributos Consulte el atributo de código base definition en HTML 4.01. |
| [CodeType](../../aspose.html/htmlobjectelement/codetype/) { get; set; } | Tipo de contenido para datos descargados a través de`identificador de clase` atributo. Consulte la definición del atributo de tipo de código en HTML 4.01. |
| [Data](../../aspose.html/htmlobjectelement/data/) { get; set; } | URI [[IETFRFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] especificando la ubicación de los datos del objeto. Ver la definición del atributo data en HTML 4.01. |
| [Declare](../../aspose.html/htmlobjectelement/declare/) { get; set; } | Declare (para futuras referencias), pero no cree una instancia, de este objeto. Consulte la definición del atributo de declaración en HTML 4.01. |
...
| [Form](../../aspose.html/htmlobjectelement/form/) { get; set; } | Devuelve el`FORMA` elemento que contiene este control. Devoluciones`nulo` si este control no está dentro del contexto de un formulario. |
| [Height](../../aspose.html/htmlobjectelement/height/) { get; set; } | Anular altura. Ver la definición del atributo de altura en HTML 4.01. |
| [Hspace](../../aspose.html/htmlobjectelement/hspace/) { get; set; } | Espacio horizontal, en píxeles, a la izquierda y derecha de esta imagen, subprograma u objeto. Consulte la definición del atributo hspace en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
...
| [Name](../../aspose.html/htmlobjectelement/name/) { get; set; } | Control de formulario o nombre de objeto cuando se envía con un formulario. Ver la definición del atributo name en HTML 4.01. |
...
| [Standby](../../aspose.html/htmlobjectelement/standby/) { get; set; } | Mensaje para renderizar al cargar el objeto. Consulte la definición del atributo en espera en HTML 4.01. |
...
| [TabIndex](../../aspose.html/htmlobjectelement/tabindex/) { get; set; } | Índice que representa la posición del elemento en el orden de tabulación. Ver la definición del atributo tabindex en HTML 4.01. |
...
| [Type](../../aspose.html/htmlobjectelement/type/) { get; set; } | Tipo de contenido para datos descargados a través de`datos` atributo. Consulte la definición del atributo de tipo en HTML 4.01. |
| [UseMap](../../aspose.html/htmlobjectelement/usemap/) { get; set; } | Usar mapa de imágenes del lado del cliente. Consulte la definición del atributo usemap en HTML 4.01. |
| [Vspace](../../aspose.html/htmlobjectelement/vspace/) { get; set; } | Espacio vertical, en píxeles, arriba y abajo de esta imagen, subprograma u objeto. Consulte la definición del atributo vspace en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
| [Width](../../aspose.html/htmlobjectelement/width/) { get; set; } | Anular ancho. Ver la definición del atributo ancho en HTML 4.01. |
