...
description: Aspose.Html.HTMLOListElement clase. Lista ordenada. Ver la definición del elemento OL en HTML 4.01.
type: docs
weight: 3430
url: /es/net/aspose.html/htmlolistelement/
---
## HTMLOListElement class

Lista ordenada. Ver la definición del elemento OL en HTML 4.01.
...
| [Compact](../../aspose.html/htmlolistelement/compact/) { get; set; } | Reducir el espacio entre los elementos de la lista. Consulte la definición de atributo compacto en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
...
| [Start](../../aspose.html/htmlolistelement/start/) { get; set; } | Número de secuencia inicial. Consulte la definición del atributo de inicio en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
...
| [Type](../../aspose.html/htmlolistelement/type/) { get; set; } | Estilo de numeración. Consulte la definición del atributo de tipo en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
