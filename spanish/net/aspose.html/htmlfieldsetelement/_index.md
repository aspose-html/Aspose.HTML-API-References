...
description: Aspose.Html.HTMLFieldSetElement clase. Organiza los controles de formulario en grupos lógicos. Consulte la definición del elemento FIELDSET en HTML 4.01.
type: docs
weight: 3210
url: /es/net/aspose.html/htmlfieldsetelement/
---
## HTMLFieldSetElement class

Organiza los controles de formulario en grupos lógicos. Consulte la definición del elemento FIELDSET en HTML 4.01.
...
| [Form](../../aspose.html/htmlfieldsetelement/form/) { get; } | Devuelve el`FORMA` elemento que contiene este control. Devuelve `nulo` si este control no está dentro del contexto de un formulario . |
