...
description: Aspose.Html.HTMLPreElement clase. Texto preformateado. Ver la definición del elemento PRE en HTML 4.01.
type: docs
weight: 3490
url: /es/net/aspose.html/htmlpreelement/
---
## HTMLPreElement class

Texto preformateado. Ver la definición del elemento PRE en HTML 4.01.
...
| [Width](../../aspose.html/htmlpreelement/width/) { get; set; } | Ancho fijo para el contenido. Consulte la definición del atributo ancho en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
