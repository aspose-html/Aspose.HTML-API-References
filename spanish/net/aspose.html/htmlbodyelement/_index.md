...
description: El cuerpo del documento HTML. Este elemento siempre está presente en la API DOM incluso si las etiquetas no están presentes en el documento de origen. Consulte la definición del elemento BODY en HTML 4.01.
type: docs
weight: 3110
