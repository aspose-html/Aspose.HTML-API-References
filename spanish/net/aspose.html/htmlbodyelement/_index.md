...
description: Aspose.Html.HTMLBodyElement clase. El cuerpo del documento HTML. Este elemento siempre está presente en la API DOM incluso si las etiquetas no están presentes en el documento de origen. Consulte la definición del elemento BODY en HTML 4.01.
type: docs
weight: 3120
url: /es/net/aspose.html/htmlbodyelement/
---
## HTMLBodyElement class

El cuerpo del documento HTML. Este elemento siempre está presente en la API DOM, incluso si las etiquetas no están presentes en el documento de origen. Consulte la definición del elemento BODY en HTML 4.01.
...
| Nombre | Descripción |
| --- | --- |
| [ALink](../../aspose.html/htmlbodyelement/alink/) { get; set; } | Color de los enlaces activos (después del botón del mouse hacia abajo, pero antes del botón del mouse hacia arriba). Consulte la definición del atributo alink en HTML 4.01. Este atributo está en desuso en HTML 4.01. |
...
| [Background](../../aspose.html/htmlbodyelement/background/) { get; set; } | URL [[IETFRFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] de la imagen de mosaico de textura de fondo. Consulte la definición del atributo de fondo en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
...
| [BgColor](../../aspose.html/htmlbodyelement/bgcolor/) { get; set; } | Color de fondo del documento. Consulte la definición del atributo bgcolor en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
...
| [Link](../../aspose.html/htmlbodyelement/link/) { get; set; } | Color de enlaces que no están activos y no visitados. Consulte la definición del atributo del enlace en HTML 4.01. Este atributo está en desuso en HTML 4.01. |
...
| [Text](../../aspose.html/htmlbodyelement/text/) { get; set; } | Color del texto del documento. Consulte la definición de atributos de texto en HTML 4.01. Este atributo está obsoleto en HTML 4.01. |
...
| [VLink](../../aspose.html/htmlbodyelement/vlink/) { get; set; } | Color de los enlaces que ha visitado el usuario. Consulte la definición del atributo vlink en HTML 4.01. Este atributo está en desuso en HTML 4.01. |
