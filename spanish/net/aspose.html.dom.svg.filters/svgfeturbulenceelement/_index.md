...
description: Aspose.Html.Dom.Svg.Filters.SVGFETurbulenceElement clase. La interfaz SVGFETurbulenceElement corresponde al elemento feTurbulence.
type: docs
weight: 1600
url: /es/net/aspose.html.dom.svg.filters/svgfeturbulenceelement/
---
...
| [BaseFrequencyX](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/basefrequencyx/) { get; } | Corresponde al atributo 'baseFrequency' en el elemento 'feTurbulence' dado. Contiene el componente X del atributo 'baseFrequency'. |
| [BaseFrequencyY](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/basefrequencyy/) { get; } | Corresponde al atributo 'baseFrequency' en el elemento 'feTurbulence' dado. Contiene el componente Y del atributo 'baseFrequency' (posiblemente calculado automáticamente). |
...
| [Height](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/height/) { get; } | Corresponde al atributo 'altura' en el elemento 'filtro' dado. |
...
| [NumOctaves](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/numoctaves/) { get; } | Corresponde al atributo 'numOctaves' en el elemento 'feTurbulence' dado. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/result/) { get; } | Corresponde al atributo 'resultado' en el elemento 'filtro' dado. |
| [SchemaTypeInfo](../../aspose.html.dom/element/schematypeinfo/) { get; } | La información de tipo asociada con este elemento. |
| [Seed](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/seed/) { get; } | Corresponde al atributo 'seed' en el elemento 'feTurbulence' dado. |
| [ShadowRoot](../../aspose.html.dom/element/shadowroot/) { get; } | Devuelve shadowRoot almacenado en este elemento o nulo si está cerrado. |
| [StitchTiles](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/stitchtiles/) { get; } | Corresponde al atributo 'stitchTiles' en el elemento 'feTurbulence' dado. Toma una de las constantes SVG_STITCHTYPE_* definidas en esta interfaz. |
...
| [Type](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/type/) { get; } | Corresponde al atributo 'tipo' en el elemento 'feTurbulence' dado. Toma una de las constantes SVG_TURBULENCE_TYPE_* definidas en esta interfaz. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/width/) { get; } | Corresponde al atributo 'ancho' en el elemento 'filtro' dado. |
| [X](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/x/) { get; } | Corresponde al atributo 'x' en el elemento 'filtro' dado. |
| [Y](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/y/) { get; } | Corresponde al atributo 'y' en el elemento 'filtro' dado. |
...
| Nombre | Descripción |
| --- | --- |
| const [SVG_STITCHTYPE_NOSTITCH](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_stitchtype_nostitch/) | Corresponde al valor 'noStitch'. |
| const [SVG_STITCHTYPE_STITCH](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_stitchtype_stitch/) | Corresponde al valor 'puntada'. |
| const [SVG_STITCHTYPE_UNKNOWN](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_stitchtype_unknown/) | El tipo no es uno de los tipos predefinidos. No es válido intentar definir un nuevo valor de este tipo o intentar cambiar un valor existente a este tipo. |
| const [SVG_TURBULENCE_TYPE_FRACTALNOISE](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_turbulence_type_fractalnoise/) | Corresponde al valor 'fractalNoise'. |
| const [SVG_TURBULENCE_TYPE_TURBULENCE](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_turbulence_type_turbulence/) | Corresponde al valor 'turbulencia'. |
| const [SVG_TURBULENCE_TYPE_UNKNOWN](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_turbulence_type_unknown/) | El tipo no es uno de los tipos predefinidos. No es válido intentar definir un nuevo valor de este tipo o intentar cambiar un valor existente a este tipo. |
