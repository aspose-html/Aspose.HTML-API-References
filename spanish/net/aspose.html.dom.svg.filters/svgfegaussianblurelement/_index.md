...
description: Aspose.Html.Dom.Svg.Filters.SVGFEGaussianBlurElement clase. La interfaz SVGFEGaussianBlurElement corresponde al elemento feGaussianBlur.
type: docs
weight: 1500
url: /es/net/aspose.html.dom.svg.filters/svgfegaussianblurelement/
---
## SVGFEGaussianBlurElement class

La interfaz SVGFEGaussianBlurElement corresponde al elemento �feGaussianBlur�.
...
| [Height](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/height/) { get; } | Corresponde al atributo �altura� en el elemento �filtro� dado. |
...
| [In1](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/in1/) { get; } | Corresponde al atributo �in� en el elemento �feGaussianBlur� dado. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/result/) { get; } | Corresponde al atributo �resultado� en el elemento �filtro� dado. |
...
| [StdDeviationX](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/stddeviationx/) { get; } | Corresponde al atributo �stdDeviation� en el elemento �feGaussianBlur� dado. Contiene el componente X del atributo �stdDeviation�. |
| [StdDeviationY](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/stddeviationy/) { get; } | Corresponde al atributo �stdDeviation� en el elemento �feGaussianBlur� dado. Contiene el componente Y (posiblemente calculado automáticamente) del atributo �stdDeviation�. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/width/) { get; } | Corresponde al atributo �ancho� en el elemento �filtro� dado. |
| [X](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/x/) { get; } | Corresponde al atributo �x� en el elemento �filtro� dado. |
| [Y](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/y/) { get; } | Corresponde al atributo �y� en el elemento �filtro� dado. |
...
| [SetStdDeviation](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/setstddeviation/)(float, float) | Establece los valores para el atributo �stdDeviation�. |
