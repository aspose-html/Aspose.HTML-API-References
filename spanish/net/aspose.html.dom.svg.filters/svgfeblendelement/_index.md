...
description: Aspose.Html.Dom.Svg.Filters.SVGFEBlendElement clase. La interfaz SVGFEBlendElement corresponde al elemento feBlend.
type: docs
weight: 1360
url: /es/net/aspose.html.dom.svg.filters/svgfeblendelement/
---
...
| [Height](../../aspose.html.dom.svg.filters/svgfeblendelement/height/) { get; } | Corresponde al atributo 'altura' en el elemento 'filtro' dado. |
...
| [In1](../../aspose.html.dom.svg.filters/svgfeblendelement/in1/) { get; } | Corresponde al atributo 'in' en el elemento 'feBlend' dado. |
| [In2](../../aspose.html.dom.svg.filters/svgfeblendelement/in2/) { get; } | Corresponde al atributo 'in2' en el elemento 'feBlend' dado. |
...
| [Mode](../../aspose.html.dom.svg.filters/svgfeblendelement/mode/) { get; } | Corresponde al atributo 'modo' en el elemento 'feBlend' dado. Toma una de las constantes SVG_FEBLEND_MODE_* definidas en esta interfaz. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfeblendelement/result/) { get; } | Corresponde al atributo 'resultado' en el elemento 'filtro' dado. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfeblendelement/width/) { get; } | Corresponde al atributo 'ancho' en el elemento 'filtro' dado. |
| [X](../../aspose.html.dom.svg.filters/svgfeblendelement/x/) { get; } | Corresponde al atributo 'x' en el elemento 'filtro' dado. |
| [Y](../../aspose.html.dom.svg.filters/svgfeblendelement/y/) { get; } | Corresponde al atributo 'y' en el elemento 'filtro' dado. |
...
| Nombre | Descripción |
| --- | --- |
| const [SVG_FEBLEND_MODE_COLOR](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_color/) | Corresponde al valor 'color'. |
| const [SVG_FEBLEND_MODE_COLOR_BURN](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_color_burn/) | Corresponde al valor 'color_burn'. |
| const [SVG_FEBLEND_MODE_COLOR_DODGE](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_color_dodge/) | Corresponde al valor 'color_dodge'. |
| const [SVG_FEBLEND_MODE_DARKEN](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_darken/) | Corresponde al valor 'oscurecer'. |
| const [SVG_FEBLEND_MODE_DIFFERENCE](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_difference/) | Corresponde al valor 'diferencia'. |
| const [SVG_FEBLEND_MODE_EXCLUSION](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_exclusion/) | Corresponde al valor 'exclusión'. |
| const [SVG_FEBLEND_MODE_HARD_LIGHT](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_hard_light/) | Corresponde al valor 'hard_light'. |
| const [SVG_FEBLEND_MODE_HUE](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_hue/) | Corresponde al valor 'tono'. |
| const [SVG_FEBLEND_MODE_LIGHTEN](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_lighten/) | Corresponde al valor 'claro'. |
| const [SVG_FEBLEND_MODE_LUMINOSITY](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_luminosity/) | Corresponde al valor 'luminosidad'. |
| const [SVG_FEBLEND_MODE_MULTIPLY](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_multiply/) | Corresponde al valor 'multiplicar'. |
| const [SVG_FEBLEND_MODE_NORMAL](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_normal/) | Corresponde al valor 'normal'. |
| const [SVG_FEBLEND_MODE_OVERLAY](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_overlay/) | Corresponde al valor 'superposición'. |
| const [SVG_FEBLEND_MODE_SATURATION](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_saturation/) | Corresponde al valor 'saturación'. |
| const [SVG_FEBLEND_MODE_SCREEN](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_screen/) | Corresponde al valor 'pantalla'. |
| const [SVG_FEBLEND_MODE_SOFT_LIGHT](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_soft_light/) | Corresponde al valor 'soft_light'. |
| const [SVG_FEBLEND_MODE_UNKNOWN](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_unknown/) | El tipo no es uno de los tipos predefinidos. No es válido intentar definir un nuevo valor de este tipo o intentar cambiar un valor existente a este tipo. |
...
* espacio de nombres [Aspose.Html.Dom.Svg.Filters](../../aspose.html.dom.svg.filters/)
