...
description: Aspose.Html.Dom.Svg.Filters.SVGFEDropShadowElement clase. La interfaz SVGFEDropShadowElement corresponde al elemento feDropShadow.
type: docs
weight: 1440
url: /es/net/aspose.html.dom.svg.filters/svgfedropshadowelement/
---
...
| [Dx](../../aspose.html.dom.svg.filters/svgfedropshadowelement/dx/) { get; } | Corresponde al atributo 'dx' en el elemento 'feDropShadow' dado. |
| [Dy](../../aspose.html.dom.svg.filters/svgfedropshadowelement/dy/) { get; } | Corresponde al atributo 'dy' en el elemento 'feDropShadow' dado. |
...
| [Height](../../aspose.html.dom.svg.filters/svgfedropshadowelement/height/) { get; } | Corresponde al atributo 'altura' en el elemento 'feDropShadow' dado. |
...
| [In1](../../aspose.html.dom.svg.filters/svgfedropshadowelement/in1/) { get; } | Corresponde al atributo 'in' en el elemento 'feDropShadow' dado. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfedropshadowelement/result/) { get; } | Corresponde al atributo 'resultado' en el elemento 'feDropShadow' dado. |
...
| [StdDeviationX](../../aspose.html.dom.svg.filters/svgfedropshadowelement/stddeviationx/) { get; } | Corresponde al atributo 'stdDeviation' en el elemento 'feDropShadow' dado. Contiene el componente X del atributo 'stdDeviation'. |
| [StdDeviationY](../../aspose.html.dom.svg.filters/svgfedropshadowelement/stddeviationy/) { get; } | Corresponde al atributo 'stdDeviation' en el elemento 'feDropShadow' dado. Contiene el componente Y (posiblemente calculado automáticamente) del atributo 'stdDeviation'. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfedropshadowelement/width/) { get; } | Corresponde al atributo 'ancho' en el elemento 'feDropShadow' dado. |
| [X](../../aspose.html.dom.svg.filters/svgfedropshadowelement/x/) { get; } | Corresponde al atributo 'x' en el elemento 'feDropShadow' dado. |
| [Y](../../aspose.html.dom.svg.filters/svgfedropshadowelement/y/) { get; } | Corresponde al atributo 'y' en el elemento 'feDropShadow' dado. |
...
| [SetStdDeviation](../../aspose.html.dom.svg.filters/svgfedropshadowelement/setstddeviation/)(float, float) | Establece los valores para el atributo 'stdDeviation'. |
