...
description: Converter método. Convierte fuente epub en imagen. El resultado es un archivo de imagen.
type: docs
weight: 10
url: /es/net/aspose.html.converters/converter/convertepub/
---
## ConvertEPUB(string, ImageSaveOptions, ICreateStreamProvider) {#convertepub_42}

Convierte fuente epub en imagen. El resultado es un archivo de imagen.
...
| Parámetro | Escribe | Descripción |
| --- | --- | --- |
| stream | Stream | Fuente de conversión. |
...
Convierte fuente epub a xps. El resultado es un archivo xps.
...
Convierta la fuente EPUB a DOCX. El resultado es un archivo docx.
...
Convertir fuente epub a pdf. El resultado es un archivo pdf.
