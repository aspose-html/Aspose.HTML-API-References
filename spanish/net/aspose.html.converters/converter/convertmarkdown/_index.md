...
Convierte la fuente de Markdown a html. El resultado es un archivo html.
...
| Parámetro | Escribe | Descripción |
| --- | --- | --- |
| sourcePath | String | Ruta al archivo Markdown de origen. Se combinará con la ruta del directorio actual para formar una URL absoluta. |
