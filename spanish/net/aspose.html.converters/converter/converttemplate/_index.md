...
description: Converter método. Combinar plantilla html con datos de usuario. El resultado es un archivo html.
type: docs
weight: 60
url: /es/net/aspose.html.converters/converter/converttemplate/
---
## ConvertTemplate(HTMLDocument, TemplateData, TemplateLoadOptions, string) {#converttemplate_7}

Combinar plantilla html con datos de usuario. El resultado es un archivo html.
...
| --- | --- | --- |
| template | HTMLDocument | Fuente esqueleto html doc. |
| data | TemplateData | Datos para fusionar (XML, JSON). |
| options | TemplateLoadOptions | Objeto de opciones de fusión. |
...
| Parámetro | Escribe | Descripción |
| --- | --- | --- |
| url | Url | URL del documento de origen de la plantilla. |
| data | TemplateData | Datos para fusionar (XML, JSON). |
| options | TemplateLoadOptions | Objeto de opciones de fusión. |
| outputPath | String | Ruta del archivo de salida. |
...
| Parámetro | Escribe | Descripción |
| --- | --- | --- |
| sourcePath | String | Ruta al archivo html de origen de la plantilla. Se combinará con la ruta del directorio actual para formar una URL absoluta. |
| data | TemplateData | Datos para fusionar (XML, JSON). |
| options | TemplateLoadOptions | Objeto de opciones de fusión. |
| outputPath | String | Ruta del archivo de salida. |
...
| Parámetro | Escribe | Descripción |
| --- | --- | --- |
| content | String | Plantilla html en línea - esqueleto. |
...
Combinar plantilla html con datos de usuario. El resultado es[`HTMLDocument`](../../../aspose.html/htmldocument/) .
...
Resultado de la conversión HTMLDocument.
