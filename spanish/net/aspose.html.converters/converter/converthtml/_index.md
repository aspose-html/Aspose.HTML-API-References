...
description: Convierte el documento fuente HTML a DOCX. El resultado es un archivo docx.
type: docs
weight: 20
url: /es/net/aspose.html.converters/converter/converthtml/
---
## ConvertHTML(HTMLDocument, DocSaveOptions, string) {#converthtml_1}

Convierte el documento fuente HTML a DOCX. El resultado es un archivo docx.
...
| --- | --- | --- |
| document | HTMLDocument | Fuente de conversión[`HTMLDocument`](../../../aspose.html/htmldocument). |
...
| Parámetro | Escribe | Descripción |
| --- | --- | --- |
| content | String | Contenido HTML de cadena en línea. |
...
Convierte el documento fuente html a PDF. El resultado es un archivo pdf.
...
Convertir documento html a mhtml. El resultado es un archivo mhtml.
...
| Parámetro | Escribe | Descripción |
| --- | --- | --- |
| document | HTMLDocument | Fuente de conversión. |
| options | MHTMLSaveOptions | Opciones de conversión. |
| outputPath | String | Ruta del archivo de salida. |
...
Convertir documento html a descuento. El resultado es archivo md.
...
| --- | --- | --- |
| document | HTMLDocument | Fuente de conversión. |
| options | MarkdownSaveOptions | Opciones de conversión. |
| outputPath | String | Ruta del archivo de salida. |
...
Convertir fuente html a rebajas. El resultado es archivo md.
...
Convertir documento html a xps. El resultado es un archivo xps.
...
Convertir fuente html a xps. El resultado es un archivo xps.
...
Convertir documento html en imagen. El resultado es un archivo de imagen.
...
Convertir fuente html en imagen. El resultado es un archivo de imagen.
