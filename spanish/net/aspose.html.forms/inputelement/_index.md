...
description: Aspose.Html.Forms.InputElement clase. InputElement representa un contenedor asociado con HTMLInputElement.
type: docs
weight: 2980
...
| [GetTimeValue](../../aspose.html.forms/inputelement/gettimevalue/)() | Este método se utiliza para obtener el valor comoTimeSpan objeto. Este método es válido si solo el tipo del elemento de entrada es "tiempo" |
...
| [SetDateTimeLocalValue](../../aspose.html.forms/inputelement/setdatetimelocalvalue/)(DateTime) | Este método se utiliza para configurarDateTimeobjeto como un valor para el elemento de entrada. Este método es válido si solo el tipo del elemento de entrada es "datetime-local" |
| [SetDateValue](../../aspose.html.forms/inputelement/setdatevalue/)(DateTime) | Este método se utiliza para configurarDateTime objeto como un valor para el elemento de entrada. Este método es válido si solo el tipo del elemento de entrada es "fecha" |
...
| [SetMonthValue](../../aspose.html.forms/inputelement/setmonthvalue/)(DateTime) | Este método se utiliza para configurarDateTimeobjeto como un valor para el elemento de entrada. Este método es válido si solo el tipo del elemento de entrada es "mes" |
...
| [SetTimeValue](../../aspose.html.forms/inputelement/settimevalue/)(TimeSpan) | Este método se utiliza para configurarTimeSpan objeto como un valor para el elemento de entrada. Este método es válido si solo el tipo del elemento de entrada es "tiempo" |
| [SetUrlValue](../../aspose.html.forms/inputelement/seturlvalue/)(Url) | Este método se utiliza para configurar[`Url`](../../aspose.html/url/) objeto como un valor para el elemento de entrada. Este método es válido si solo el tipo del elemento de entrada es "url" |
