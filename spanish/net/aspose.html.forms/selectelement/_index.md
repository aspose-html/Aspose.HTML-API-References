...
description: SelectElement representa un contenedor que está asociado con HTMLSelectElement
type: docs
weight: 3010
...
| [Multiple](../../aspose.html.forms/selectelement/multiple) { get; set; } | Si es verdadero, múltiples`OPCIÓN` los elementos pueden ser seleccionados en este`SELECCIONE` . Ver la definición de múltiples atributos en HTML 4.01. |
