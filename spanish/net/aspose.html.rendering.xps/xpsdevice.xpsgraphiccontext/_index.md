...
description: Aspose.Html.Rendering.Xps.XpsDeviceXpsGraphicContext clase. Contiene los parámetros de control de gráficos actuales para XpsDevice. Estos parámetros definen el marco global dentro del cual se ejecutan los operadores de gráficos.
type: docs
weight: 4540
url: /es/net/aspose.html.rendering.xps/xpsdevice.xpsgraphiccontext/
---
...
| Nombre | Descripción |
| --- | --- |
| override [Clone](../../aspose.html.rendering.xps/xpsgraphiccontext/clone/)() | Crea una nueva instancia de una clase XpsGraphicContext con los mismos valores de propiedad que una instancia existente. |
