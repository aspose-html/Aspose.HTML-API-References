...
description: Aspose.Html.Toolkit.Markdown.Syntax.InlineProxy clase. Representa InlineProxy.
type: docs
weight: 5070
url: /es/net/aspose.html.toolkit.markdown.syntax/inlineproxy/
---
## InlineProxy class
...
| Nombre | Descripción |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/inlineproxy/accept/)(MarkdownSyntaxVisitor) | Define la interfaz para aceptar visitante. |
...
| [GetTarget](../../aspose.html.toolkit.markdown.syntax/inlineproxy/gettarget/)() | Define la interfaz para obtener el destino. |
...
| override [WriteTo](../../aspose.html.toolkit.markdown.syntax/inlineproxy/writeto/#writeto)(MarkdownTextWriter) | Escribir en escritor de texto. |
