...
description: Aspose.Html.Toolkit.Markdown.Syntax.MultiLineContainerBlockSyntaxNode clase. Implementación base de un nodo de sintaxis de bloque contenedor multilínea
type: docs
weight: 5250
url: /es/net/aspose.html.toolkit.markdown.syntax/multilinecontainerblocksyntaxnode/
---
## MultiLineContainerBlockSyntaxNode class

Implementación base de un nodo de sintaxis de bloque contenedor multilínea
