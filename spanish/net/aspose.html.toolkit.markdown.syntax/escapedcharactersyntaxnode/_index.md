...
description: Aspose.Html.Toolkit.Markdown.Syntax.EscapedCharacterSyntaxNode clase. Implementado el nodo de sintaxis de caracteres de escape.
type: docs
weight: 4890
url: /es/net/aspose.html.toolkit.markdown.syntax/escapedcharactersyntaxnode/
---
## EscapedCharacterSyntaxNode class

Implementado el nodo de sintaxis de caracteres de escape.
...
| virtual [Source](../../aspose.html.toolkit.markdown.syntax/textsyntaxnode/source/) { get; } | Devuelve el texto fuente. |
| virtual [Span](../../aspose.html.toolkit.markdown.syntax/textsyntaxnode/span/) { get; } | Define la interfaz para get span. |
| [Value](../../aspose.html.toolkit.markdown.syntax/textsyntaxnode/value/) { get; } | Define la propiedad para obtener valor de cadena. |

## Métodos

| Nombre | Descripción |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/escapedcharactersyntaxnode/accept/)(MarkdownSyntaxVisitor) | Define la interfaz para aceptar visitante. |
