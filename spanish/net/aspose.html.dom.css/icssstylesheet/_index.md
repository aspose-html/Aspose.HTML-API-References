...
description: La interfaz CSSStyleSheet es una interfaz concreta que se utiliza para representar una hoja de estilo CSS es decir una hoja de estilo cuyo tipo de contenido es texto/css.
type: docs
weight: 520
