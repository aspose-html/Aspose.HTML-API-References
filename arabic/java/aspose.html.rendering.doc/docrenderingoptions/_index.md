---
title: "فئة DocRenderingOptions"
second_title: "مرجع API لـ Aspose.HTML للـ Java"
description: "الفئة com.aspose.html.rendering.doc.DocRenderingOptions. تمثل خيارات العرض لجهاز DocDevice"
type: docs

url: /ar/java/com.aspose.html.rendering.doc/docrenderingoptions/
---
...
| الاسم | الوصف |
| --- | --- |
| [DocRenderingOptions](docrenderingoptions/#constructor)() | ينشئ نسخة جديدة من الفئة `DocRenderingOptions`. |
| [DocRenderingOptions](docrenderingoptions/#constructor_1)(FontEmbeddingRule) | ينشئ نسخة جديدة من الفئة `DocRenderingOptions` مع قاعدة تضمين الخط المحددة. |
