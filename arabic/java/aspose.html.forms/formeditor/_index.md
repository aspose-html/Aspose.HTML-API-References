...
description: "الفئة com.aspose.html.forms.FormEditor. تمثل هذه الفئة المحرر فوق HTMLFormElement الذي يوفر طريقة أسهل لمطوري .net لتعديل نماذج html."
type: docs
...
| [getForm](../../com.aspose.html.forms/formeditor/form/) العنصر الأصلي [`HTMLFormElement`](../../com.aspose.html/htmlformelement/) المرتبط بالمثيل الحالي لـ `FormEditor`. |
| [getItem](../../com.aspose.html.forms/formeditor/item/) يرجع العنصر حسب الفهرس المحدد. (مؤشرين) |
[getMethod]
...
| الاسم | الوصف |
| --- | --- |
| static [Create](../../com.aspose.html.forms/formeditor/create/#create_2)(HTMLFormElement) | ينشئ `FormEditor` جديدًا بناءً على [`HTMLFormElement`](../../com.aspose.html/htmlformelement/). |
| static [Create](../../com.aspose.html.forms/formeditor/create/#create)(HTMLDocument, int) | ينشئ `FormEditor` جديدًا بناءً على [`HTMLFormElement`](../../com.aspose.html/htmlformelement/) المحدد من مجموعة [`Forms`](../../com.aspose.html/htmldocument/forms/) حسب الفهرس. |
| static [Create](../../com.aspose.html.forms/formeditor/create/#create_1)(HTMLDocument, String) | ينشئ `FormEditor` جديدًا بناءً على [`HTMLFormElement`](../../com.aspose.html/htmlformelement/) المحدد من المستند حسب المعرف. |
...
| [dispose](../../com.aspose.html.forms/formeditor/dispose/)() | يطلق الموارد غير المدارة والمدارة. |
| [fill](../../com.aspose.html.forms/formeditor/fill/)(Dictionary&lt;String, String&gt;) |  |
| [GetElement&lt;T&gt;](../../com.aspose.html.forms/formeditor/getelement/#getelement)(int) | يرجع العنصر حسب الفهرس المحدد. |
| [GetElement&lt;T&gt;](../../com.aspose.html.forms/formeditor/getelement/#getelement_1)(String) | يرجع العنصر حسب الاسم المحدد. |
| [getEnumerator](../../com.aspose.html.forms/formeditor/getenumerator/)() | يحصل على المُعدِّد. |
