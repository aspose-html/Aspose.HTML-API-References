...
description: "طريقة الحدث. إذا كان الحدث قابلًا للإلغاء تُستخدم طريقة PreventDefault للدلالة على أن الحدث سيُلغى مما يعني أن أي إجراء افتراضي عادةً ما تتخذه التنفيذ نتيجةً للحدث لن يحدث."
type: docs
