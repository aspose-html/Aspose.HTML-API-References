---
title: "CustomEvent فئة"
second_title: "مرجع API لـ Aspose.HTML for Java"
description: "com.aspose.html.dom.events.CustomEvent فئة. يمكن استخدام الأحداث التي تستند إلى واجهة CustomEvent لحمل بيانات مخصصة."
type: docs
...
| الاسم | الوصف |
| --- | --- |
| [CustomEvent](customevent/#constructor)(String) | ينشئ مثيلًا جديدًا من الفئة `CustomEvent`. |
...
| [initCustomEvent](../../com.aspose.html.dom.events/customevent/initcustomevent/)(String, bool, bool, object) | /// تُستخدم طريقة [`InitEvent`](../event/initevent/) لتهيئة قيمة [`Event`](../event/) تم إنشاؤها عبر واجهة [`IDocumentEvent`](../idocumentevent/). |
