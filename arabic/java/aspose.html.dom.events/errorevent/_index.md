...
description: "فئة com.aspose.html.dom.events.ErrorEvent. توفر ErrorEvent معلومات سياقية حول الأخطاء التي حدثت أثناء وقت التشغيل"
type: docs
...
| الاسم | الوصف |
| --- | --- |
| [ErrorEvent](errorevent/#constructor_1)(Exception) | يهيئ مثيلاً جديداً من الفئة `ErrorEvent`. |
