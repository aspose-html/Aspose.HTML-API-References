...
description: "com.aspose.html.dom.events.UIEvent فئة. توفر واجهة UIEvent معلومات سياقية محددة مرتبطة بأحداث واجهة المستخدم."
type: docs
...
| الاسم | الوصف |
| --- | --- |
| [UIEvent](uievent/#constructor)(String) | ينشئ مثيلًا جديدًا من الفئة `UIEvent`. |
