...
description: "com.aspose.html.dom.events.UIEvent الفئة. توفر واجهة UIEvent معلومات سياقية محددة مرتبطة بأحداث واجهة المستخدم."
type: docs

url: /ar/java/com.aspose.html.dom.events/uievent/
---
## UIEvent class
...
| الاسم | الوصف |
| --- | --- |
| [UIEvent](uievent/#constructor)(String) | يُنشئ مثيلًا جديدًا من الفئة `UIEvent`. |
