---
title: "FocusEvent فئة"
second_title: "مرجع API لـ Aspose.HTML for Java"
description: "com.aspose.html.dom.events.FocusEvent فئة. توفر واجهة FocusEvent معلومات سياقية محددة مرتبطة بأحداث التركيز."
type: docs
...
| الاسم | الوصف |
| --- | --- |
| [FocusEvent](focusevent/#constructor)(String) | ينشئ مثيلًا جديدًا من الفئة `FocusEvent`. |
...
| [getRelatedTarget](../../com.aspose.html.dom.events/focusevent/relatedtarget/) يُستخدم لتحديد EventTarget ثانوي مرتبط بحدث تركيز، حسب نوع الحدث. |
