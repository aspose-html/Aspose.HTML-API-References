---
title: "FocusEvent الفئة"
second_title: "مرجع API لـ Aspose.HTML للـ Java"
description: "com.aspose.html.dom.events.FocusEvent الفئة. توفر واجهة FocusEvent معلومات سياقية محددة مرتبطة بأحداث التركيز."
type: docs

url: /ar/java/com.aspose.html.dom.events/focusevent/
---
## FocusEvent class
...
| الاسم | الوصف |
| --- | --- |
| [FocusEvent](focusevent/#constructor)(String) | يُنشئ مثيلًا جديدًا من الفئة `FocusEvent`. |
...
| [getRelatedTarget](../../com.aspose.html.dom.events/focusevent/relatedtarget/) يُستخدم لتحديد هدف حدث ثانوي مرتبط بحدث تركيز، حسب نوع الحدث. |
