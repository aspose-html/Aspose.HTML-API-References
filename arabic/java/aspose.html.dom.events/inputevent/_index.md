---
title: "InputEvent الفئة"
second_title: "مرجع API لـ Aspose.HTML للـ Java"
description: "com.aspose.html.dom.events.InputEvent الفئة. تُرسل أحداث الإدخال كإشعارات كلما تم تحديث DOM."
type: docs
...
| الاسم | الوصف |
| --- | --- |
| [InputEvent](inputevent/#constructor)(String) | يُنشئ مثيلًا جديدًا من الفئة `InputEvent`. |
...
| [getData](../../com.aspose.html.dom.events/inputevent/data/) البيانات تحتفظ بقيمة الأحرف التي يولدها طريقة الإدخال. قد تكون هذه حرف Unicode واحد أو تسلسل غير فارغ من أحرف Unicode [Unicode]. يجب أن يتم تطبيع الأحرف كما هو معرف في نموذج تطبيع Unicode NFC، المعرف في [UAX15]. قد يحتوي هذا السمة على سلسلة فارغة. |
