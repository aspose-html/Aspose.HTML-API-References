...
description: "فئة com.aspose.html.dom.DocumentFragment. DocumentFragment هو كائن مستند خفيف الوزن أو بسيط. من الشائع جدًا الرغبة في استخراج جزء من شجرة المستند أو إنشاء جزء جديد من مستند."
type: docs
