---
title: "فئة CDATASection"
second_title: "مرجع API لـ Aspose.HTML for Java"
description: "فئة com.aspose.html.dom.CDATASection. تُستخدم أقسام CDATA لتجاوز كتل النص التي تحتوي على أحرف قد تُعتبر عادةً تعليمات ترميز."
type: docs

url: /ar/java/com.aspose.html.dom/cdatasection/
---
## CDATASection class

تُستخدم أقسام CDATA للهروب من كتل النص التي تحتوي على أحرف قد تُعتبر علامة إذا لم تُعامل كبيانات.
...
| [getNodeName](../../com.aspose.html.dom/cdatasection/nodename/) اسم هذه العقدة، حسب نوعها. |
| [getNodeType](../../com.aspose.html.dom/cdatasection/nodetype/) رمز يمثل نوع الكائن الأساسي. |
