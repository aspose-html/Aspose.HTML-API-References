...
description: "الفئة com.aspose.html.dom.CDATASection. تُستخدم أقسام CDATA لتجاوز كتل النص التي تحتوي على أحرف قد تُعتبر عادةً تعليمات ترميز."
type: docs
...
تُستخدم أقسام CDATA لتجاوز كتل النص التي تحتوي على أحرف قد تُعتبر علامات.
