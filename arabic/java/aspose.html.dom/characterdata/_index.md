...
description: "الفئة com.aspose.html.dom.CharacterData. الـ CharacterData يمدّ Node بمجموعة من السمات والطرق للوصول إلى بيانات الأحرف في DOM"
type: docs

url: /ar/java/com.aspose.html.dom/characterdata/
---
## CharacterData class

تُوسّع CharacterData فئة Node بمجموعة من السمات والطرق للوصول إلى بيانات الأحرف في الـ DOM.
