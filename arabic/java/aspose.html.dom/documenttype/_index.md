---
title: "فئة DocumentType"
second_title: "مرجع API لـ Aspose.HTML للـ Java"
description: "فئة com.aspose.html.dom.DocumentType. الـ DocumentType يوفّر واجهة لقائمة الكيانات المعرفة للمستند"
type: docs

url: /ar/java/com.aspose.html.dom/documenttype/
---
## DocumentType class

توفر DocumentType واجهة لقائمة الكيانات المعرفة للمستند.
...
| الاسم | الوصف |
| --- | --- |
| [DocumentType](documenttype/)(String, String, String, String, Document) | يُنشئ مثالًا جديدًا من فئة `DocumentType`. |
...
| [getInternalSubset](../../com.aspose.html.dom/documenttype/internalsubset/) المجموعة الداخلية كسلسلة نصية، أو null إذا لم توجد. |
...
| [getName](../../com.aspose.html.dom/documenttype/name/) اسم الـ DTD؛ أي الاسم الذي يلي مباشرة كلمة DOCTYPE. |
...
| [getNodeName](../../com.aspose.html.dom/documenttype/nodename/) اسم هذه العقدة، حسب نوعها. |
| [getNodeType](../../com.aspose.html.dom/documenttype/nodetype/) رمز يُمثّل نوع الكائن الأساسي. |
...
| [getPublicId](../../com.aspose.html.dom/documenttype/publicid/) المعرف العام للمجموعة الخارجية. |
| [getSystemId](../../com.aspose.html.dom/documenttype/systemid/) المعرف النظامي للمجموعة الخارجية. قد يكون هذا URI مطلقًا أو لا. |
...
| [toString](../../com.aspose.html.dom/documenttype/toString/)() | يعيد سلسلة تمثل هذا الكائن. |
