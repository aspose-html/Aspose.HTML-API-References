...
description: "الفئة com.aspose.html.dom.DocumentType. الـ DocumentType يوفّر واجهة لقائمة الكيانات المعرفة للمستند."
type: docs
...
| الاسم | الوصف |
| --- | --- |
| [DocumentType](documenttype/)(String, String, String, String, Document) | يُنشئ مثيلًا جديدًا من الفئة `DocumentType`. |
...
| [getName](../../com.aspose.html.dom/documenttype/name/) اسم DTD؛ أي الاسم الذي يلي مباشرة كلمة DOCTYPE. |
...
| [getNodeType](../../com.aspose.html.dom/documenttype/nodetype/) رمز يمثل نوع الكائن الأساسي. |
...
| [getSystemId](../../com.aspose.html.dom/documenttype/systemid/) المعرف النظامي للمجموعة الخارجية. قد يكون URI مطلقًا أو لا. |
...
| [toString](../../com.aspose.html.dom/documenttype/toString/)() | يرجع سلسلة تمثل هذا الكائن. |
