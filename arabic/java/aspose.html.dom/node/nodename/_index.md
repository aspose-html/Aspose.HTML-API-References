...
description: "خاصية Node. الخاصية nodeName للقراءة فقط في Node تُرجع اسم العقدة الحالية كسلسلة نصية."
type: docs
...
الخاصية nodeName للقراءة فقط في Node تُرجع اسم العقدة الحالية كسلسلة نصية.
