...
description: "خاصية Node. الخاصية parentNode للقراءة فقط في واجهة Node تُرجع العنصر الأب للعقدة المحددة في شجرة DOM."
type: docs
...
الخاصية parentNode للقراءة فقط في واجهة Node تُرجع العنصر الأب للعقدة المحددة في شجرة DOM.
...
عقدة Node هي العنصر الأب للعقدة الحالية. العنصر الأب لعنصر ما هو عقدة [`Element`](../../element/)، أو عقدة [`Document`](../../document/)، أو عقدة [`DocumentFragment`](../../documentfragment/).
