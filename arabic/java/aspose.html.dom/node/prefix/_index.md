...
description: "خاصية Node. الخاصية للقراءة فقط prefix تُرجع بادئة الحزمة للعنصر المحدد أو null إذا لم يتم تحديد أي بادئة."
type: docs

url: /ar/java/com.aspose.html.dom/node/prefix/
---
## Node.Prefix property

خاصية prefix للقراءة فقط تُعيد بادئة الحزمة للعنصر المحدد، أو null إذا لم تُحدد أي بادئة.
...
تُرجع الخاصية بادئة الحزمة المرتبطة.
