...
يقوم بتحميل المستند من عنوان الموارد الموحد (URL) المحدد إلى النسخة الحالية، مستبدلاً المحتوى السابق.
...
| baseUri | String | مسار URI الأساسي لحل الموارد النسبية. سيتم دمجه مع مسار الدليل الحالي لتكوين عنوان URL مطلق. |
...
| --- | --- | --- |
| المحتوى | String | محتوى المستند. |
| baseUri | Url | مسار URI الأساسي لحل الموارد النسبية. |
