...
| معامل | نوع | الوصف |
| --- | --- | --- |
| localName | String | سلسلة تحدد نوع العنصر الذي سيتم إنشاؤه. يتم تهيئة nodeName للعنصر المُنشأ بقيمة tagName. لا تستخدم الأسماء المؤهلة (مثل \"html:a\") مع هذه الطريقة. عند استدعائها على مستند HTML، تقوم createElement() بتحويل tagName إلى أحرف صغيرة قبل إنشاء العنصر. |
