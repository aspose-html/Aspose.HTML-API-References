...
| resolver | IXPathNSResolver | يسمح المحلّل بترجمة جميع البوادئ، بما في ذلك بادئة حزمة xml، داخل تعبير XPath إلى عناوين URI للحزمة المناسبة. |
| النوع | XPathResultType | إذا تم تحديد نوع محدد، فستُعاد النتيجة كنوع مطابق. |
