...
description: "طريقة Document. تُرجع قائمة من العناصر التي لها اسم العلامة المحدد والتي تنتمي إلى الحزمة المحددة. يتم البحث في المستند الكامل بما في ذلك عقدة الجذر"
type: docs
...
قائمة حية [`NodeList`](../../../com.aspose.html.collections/nodelist/) (ولكن راجع الملاحظة أدناه) للعناصر التي تم العثور عليها بالترتيب الذي تظهر به في الشجرة.

## ملاحظات

ارجع إلى [المواصفة](https://dom.spec.whatwg.org/#dom-document-getelementsbytagnamens) الرسمية.

يمكن العثور على محتوى تطوير الويب العملي في [w3schools](https://www.w3schools.com/xml/met_document_getelementsbytagnamens.asp).
