...
description: "فئة com.aspose.html.dom.Entity. تمثل كيانًا معروفًا إما مُحللاً أو غير مُحلل في مستند XML."
type: docs

url: /ar/java/com.aspose.html.dom/entity/
---
## Entity class

يمثل كيانًا معروفًا، إما مُحلَّلًا أو غير مُحلَّل، في مستند XML.
...
| [getInputEncoding](../../com.aspose.html.dom/entity/inputencoding/) سمة تحدد الترميز المستخدم لهذا الكيان عند التحليل، عندما يكون كيانًا مُحللاً خارجيًا. تكون القيمة null إذا كان الكيان من المجموعة الداخلية أو إذا لم يكن معروفًا. |
...
| [getNodeName](../../com.aspose.html.dom/entity/nodename/) اسم هذه العقدة، حسب نوعها. |
| [getNodeType](../../com.aspose.html.dom/entity/nodetype/) رمز يمثل نوع الكائن الأساسي. |
...
| [getNotationName](../../com.aspose.html.dom/entity/notationname/) بالنسبة للكيانات غير المُحللة، اسم الترميز للكيان. بالنسبة للكيانات المُحللة، تكون القيمة null. |
...
| [getPublicId](../../com.aspose.html.dom/entity/publicid/) المعرف العام المرتبط بالكيان إذا تم تحديده، وإلا تكون القيمة null. |
| [getSystemId](../../com.aspose.html.dom/entity/systemid/) المعرف النظامي المرتبط بالكيان إذا تم تحديده، وإلا تكون القيمة null. قد يكون هذا URI مطلقًا أو لا. |
...
| [getXmlEncoding](../../com.aspose.html.dom/entity/xmlencoding/) سمة تحدد، كجزء من إعلان النص، ترميز هذا الكيان عندما يكون كيانًا مُحللاً خارجيًا. تكون القيمة null في غير ذلك. |
| [getXmlVersion](../../com.aspose.html.dom/entity/xmlversion/) سمة تحدد، كجزء من إعلان النص، رقم إصدار هذا الكيان عندما يكون كيانًا مُحللاً خارجيًا. تكون القيمة null في غير ذلك. |
