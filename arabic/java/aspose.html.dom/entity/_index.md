...
| [getInputEncoding](../../com.aspose.html.dom/entity/inputencoding/) سمة تحدد الترميز المستخدم لهذا الكيان عند التحليل، عندما يكون كيانًا مُحللاً خارجيًا. تكون القيمة null إذا كان كيانًا من المجموعة الداخلية أو إذا لم يكن معروفًا. |
...
| [getNotationName](../../com.aspose.html.dom/entity/notationname/) للكيانات غير المُحللة، اسم الترميز للكيان. للكيانات المُحللة، تكون القيمة null. |
...
| [getPublicId](../../com.aspose.html.dom/entity/publicid/) المعرف العام المرتبط بالكيان إذا تم تحديده، وإلا يكون null. |
| [getSystemId](../../com.aspose.html.dom/entity/systemid/) المعرف النظامي المرتبط بالكيان إذا تم تحديده، وإلا يكون null. قد يكون URI مطلقًا أو لا. |
...
| [getXmlEncoding](../../com.aspose.html.dom/entity/xmlencoding/) سمة تحدد، كجزء من إعلان النص، ترميز هذا الكيان عندما يكون كيانًا مُحللاً خارجيًا. تكون القيمة null خلاف ذلك. |
| [getXmlVersion](../../com.aspose.html.dom/entity/xmlversion/) سمة تحدد، كجزء من إعلان النص، رقم إصدار هذا الكيان عندما يكون كيانًا مُحللاً خارجيًا. تكون القيمة null خلاف ذلك. |
