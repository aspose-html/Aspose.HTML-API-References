...
description: "طريقة العنصر. تُعيد كائن HTMLCollection يحتوي على جميع العناصر ذات الاسم الوسمي المحدد بترتيب المستند"
type: docs
...
تُعيد كائن [`HTMLCollection`](../../../com.aspose.html.collections/htmlcollection/) الذي يحتوي على جميع [`elements`](../) ذات الاسم الوسمي المحدد، بترتيب المستند.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| name | String | اسم الوسم. تمثيل السلسلة لاسم الوسم. |
