...
description: "فئة com.aspose.html.dom.Notation. تمثّل notation معلنة في DTD"
type: docs

url: /ar/java/com.aspose.html.dom/notation/
---
## Notation class

يمثل تدوينًا تم إعلانه في DTD.
...
| [getNodeName](../../com.aspose.html.dom/notation/nodename/) اسم هذه العقدة، حسب نوعها. |
| [getNodeType](../../com.aspose.html.dom/notation/nodetype/) رمز يُمثّل نوع الكائن الأساسي. |
...
| [getPublicId](../../com.aspose.html.dom/notation/publicid/) المعرف العام لهذا notation. إذا لم يُحدّد المعرف العام، يكون هذا null. |
| [getSystemId](../../com.aspose.html.dom/notation/systemid/) المعرف النظامي لهذا notation. إذا لم يُحدّد المعرف النظامي، يكون هذا null. قد يكون هذا URI مطلقًا أو لا. |
