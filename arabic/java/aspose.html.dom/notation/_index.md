...
description: "الفئة com.aspose.html.dom.Notation. تمثّل Notation معلنة في DTD"
type: docs
...
| [getNodeType](../../com.aspose.html.dom/notation/nodetype/) رمز يمثل نوع الكائن الأساسي. |
...
| [getPublicId](../../com.aspose.html.dom/notation/publicid/) المعرف العام لهذه Notation. إذا لم يُحدد المعرف العام، يكون هذا null. |
| [getSystemId](../../com.aspose.html.dom/notation/systemid/) المعرف النظامي لهذه Notation. إذا لم يُحدد المعرف النظامي، يكون هذا null. قد يكون هذا URI مطلقًا أو لا. |
