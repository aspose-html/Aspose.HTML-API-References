...
description: "فئة com.aspose.html.dom.Comment. ترث من CharacterData وتمثل محتوى التعليق أي جميع الأحرف بين البداية."
type: docs

url: /ar/java/com.aspose.html.dom/comment/
---
## Comment class

تورث من CharacterData وتمثل محتوى التعليق، أي جميع الأحرف بين العلامتين '' البداية.
...
| [getNodeName](../../com.aspose.html.dom/comment/nodename/) اسم هذه العقدة، حسب نوعها. |
| [getNodeType](../../com.aspose.html.dom/comment/nodetype/) رمز يمثل نوع الكائن الأساسي. |
| [nodeValue](../../com.aspose.html.dom/comment/nodevalue/) { get; set; } | قيمة هذه العقدة، حسب نوعها. |
