...
description: "فئة com.aspose.html.dom.Comment. ترث من CharacterData وتمثل محتوى التعليق أي جميع الأحرف بين بداية"
type: docs
...
تورث من CharacterData وتمثّل محتوى التعليق، أي جميع الأحرف بين العلامتين '' البداية.
