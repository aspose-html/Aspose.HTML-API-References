...
description: "فئة com.aspose.html.dom.Attr. تمثّل واجهة Attr سمة في كائن Element. عادةً ما تُحدّد القيم المسموح بها للسمة في مخطط مرتبط بالمستند."
type: docs
...
واجهة Attr تمثل سمة في كائن Element. عادةً ما تُحدَّد القيم المسموح بها للسمة في مخطط مرتبط بالمستند.
...
| [getLocalName](../../com.aspose.html.dom/attr/localname/) تُعيد الجزء المحلي من الاسم المؤهل لهذه العقدة. بالنسبة للعقد من أي نوع غير ELEMENT_NODE و ATTRIBUTE_NODE والعقد التي تم إنشاؤها باستخدام طريقة DOM المستوى 1، مثل Document.createElement()، تكون القيمة دائمًا null. |
| [getName](../../com.aspose.html.dom/attr/name/) تُعيد اسم هذه السمة. |
| [getNamespaceURI](../../com.aspose.html.dom/attr/packageuri/) URI الحزمة لهذه العقدة، أو null إذا لم يُحدّد. |
...
| [getNodeType](../../com.aspose.html.dom/attr/nodetype/) رمز يُمثّل نوع الكائن الأساسي. |
...
| [getOwnerElement](../../com.aspose.html.dom/attr/ownerelement/) عقدة Element التي تُرفق بها هذه السمة أو null إذا لم تُستَخدم السمة. |
...
| [getPrefix](../../com.aspose.html.dom/attr/prefix/) بادئة الحزمة لهذه العقدة، أو null إذا لم تُحدّد. عندما تُعرّف بأنها null، لا يؤثر ضبطها. |
...
| [getSpecified](../../com.aspose.html.dom/attr/specified/) true إذا تم إعطاء هذه السمة قيمة صريحة في المستند المثيل، وإلا false. |
