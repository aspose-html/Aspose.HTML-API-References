---
title: "الفئة SVGOptimizationOptions"
second_title: "مرجع API لـ Aspose.HTML for Java"
description: "الفئة com.aspose.html.toolkit.optimizers.SVGOptimizationOptions. SVGOptimizationOptions هي فئة لتخزين الخيارات الخاصة بتحسين مستندات SVG."
type: docs

url: /ar/java/com.aspose.html.toolkit.optimizers/svgoptimizationoptions/
---
## SVGOptimizationOptions class

SVGOptimizationOptions هي فئة لتخزين الخيارات الخاصة بتحسين مستندات SVG.
...
| الاسم | الوصف |
| --- | --- |
| [SVGOptimizationOptions](svgoptimizationoptions/)() | ينشئ مثلاً جديداً من الفئة `SVGOptimizationOptions`. |
