...
description: "منشئ XpsDevice. يهيئ نسخة جديدة من فئة XpsDevice."
type: docs

url: /ar/java/com.aspose.html.rendering.xps/xpsdevice/xpsdevice/
---
## XpsDevice(ICreateStreamProvider) {#constructor}

يهيئ نسخة جديدة من الفئة [`XpsDevice`](../).
...
يهيئ نسخة جديدة من الفئة [`XpsDevice`](../) باستخدام خيارات العرض وموفر التدفق.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| الخيارات | XpsRenderingOptions | خيارات العرض. |
...
يُنشئ مثيلاً جديداً من الفئة [`XpsDevice`](../) باستخدام خيارات العرض واسم ملف الإخراج.
...
يُنشئ مثيلاً جديداً من الفئة [`XpsDevice`](../) باستخدام خيارات العرض ومجرى الإخراج.
