...
description: "فئة com.aspose.html.dom.svg.filters.SVGFEMorphologyElement. تتطابق واجهة SVGFEMorphologyElement مع العنصر feMorphology."
type: docs
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/height/) يتطابق مع السمة ‘height’ على العنصر ‘filter’ المعطى. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/in1/) يتطابق مع السمة ‘in’ على العنصر ‘feMorphology’ المعطى. |
[getInnerHTML]
...
| [getOperator](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/operator/) يتطابق مع السمة ‘operator’ في عنصر ‘feMorphology’ المحدد. يأخذ أحد ثابتات SVG_MORPHOLOGY_OPERATOR_* المعرفة في هذه الواجهة. |
[getOuterHTML]
...
| [getRadiusX](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/radiusx/) يتطابق مع السمة ‘radius’ في عنصر ‘feMorphology’ المحدد. |
| [getRadiusY](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/radiusy/) يتطابق مع السمة ‘radius’ في عنصر ‘feMorphology’ المحدد. |
| [getResult](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/result/) يتطابق مع السمة ‘result’ في عنصر ‘filter’ المحدد. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/width/) يتطابق مع السمة ‘width’ في عنصر ‘filter’ المحدد. |
| [X](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/x/) { get; } | يتطابق مع السمة ‘x’ في عنصر ‘filter’ المعطى. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/y/) { get; } | يتطابق مع السمة ‘y’ في عنصر ‘filter’ المعطى. |
