---
title: "فئة SVGFEMorphologyElement"
second_title: "مرجع API لـ Aspose.HTML for Java"
description: "فئة com.aspose.html.dom.svg.filters.SVGFEMorphologyElement. تتطابق واجهة SVGFEMorphologyElement مع عنصر feMorphology."
type: docs

url: /ar/java/com.aspose.html.dom.svg.filters/svgfemorphologyelement/
---
## SVGFEMorphologyElement class

واجهة SVGFEMorphologyElement تتطابق مع العنصر ‘feMorphology’.
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/height/) يتطابق مع السمة ‘height’ في عنصر ‘filter’ المعطى. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/in1/) يتطابق مع السمة ‘in’ في عنصر ‘feMorphology’ المعطى. |
[getInnerHTML]
...
| [getOperator](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/operator/) يتطابق مع السمة ‘operator’ في العنصر ‘feMorphology’ المحدد. يأخذ أحد الثوابت SVG_MORPHOLOGY_OPERATOR_* المعرفة في هذه الواجهة. |
[getOuterHTML]
...
| [getRadiusX](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/radiusx/) يتطابق مع السمة ‘radius’ في العنصر ‘feMorphology’ المحدد. |
| [getRadiusY](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/radiusy/) يتطابق مع السمة ‘radius’ في العنصر ‘feMorphology’ المحدد. |
| [getResult](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/result/) يتطابق مع السمة ‘result’ في العنصر ‘filter’ المحدد. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/width/) يتطابق مع السمة ‘width’ في العنصر ‘filter’ المحدد. |
| [X](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/x/) { get; } | يتوافق مع السمة ‘x’ في عنصر ‘filter’ المعطى. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/y/) { get; } | يتوافق مع السمة ‘y’ في عنصر ‘filter’ المعطى. |
...
| الاسم | الوصف |
| --- | --- |
| const [SVG_MORPHOLOGY_OPERATOR_DILATE](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/svg_morphology_operator_dilate/) | يتطابق مع القيمة 'dilate'. |
| const [SVG_MORPHOLOGY_OPERATOR_ERODE](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/svg_morphology_operator_erode/) | يتطابق مع القيمة 'erode'. |
| const [SVG_MORPHOLOGY_OPERATOR_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/svg_morphology_operator_unknown/) | النوع ليس أحد الأنواع المعرفة مسبقًا. من غير الصالح محاولة تعريف قيمة جديدة لهذا النوع أو محاولة تحويل قيمة موجودة إلى هذا النوع. |
