...
description: "com.aspose.html.dom.svg.filters.SVGFEComponentTransferElement فئة. واجهة SVGFEComponentTransferElement تتطابق مع عنصر feComponentTransfer"
type: docs
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfecomponenttransferelement/height/) يتطابق مع السمة ‘height’ في عنصر ‘filter’ المحدد. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfecomponenttransferelement/in1/) يتطابق مع السمة ‘in’ في عنصر ‘feComponentTransfer’ المحدد. |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfecomponenttransferelement/result/) يتطابق مع السمة ‘result’ في عنصر ‘filter’ المحدد. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfecomponenttransferelement/width/) يتطابق مع السمة ‘width’ في عنصر ‘filter’ المحدد. |
| [X](../../com.aspose.html.dom.svg.filters/svgfecomponenttransferelement/x/) { get; } | يتطابق مع السمة ‘x’ في عنصر ‘filter’ المعطى. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfecomponenttransferelement/y/) { get; } | يتطابق مع السمة ‘y’ في عنصر ‘filter’ المعطى. |
