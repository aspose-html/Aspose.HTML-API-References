...
description: "فئة com.aspose.html.dom.svg.filters.SVGFEColorMatrixElement. واجهة SVGFEColorMatrixElement تتطابق مع العنصر feColorMatrix"
type: docs
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/height/) يتطابق مع السمة ‘height’ على العنصر ‘filter’ المحدد. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/in1/) يتطابق مع السمة ‘in’ على العنصر ‘feColorMatrix’ المحدد. |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/result/) يتطابق مع السمة ‘result’ على العنصر ‘filter’ المحدد. |
...
| [getType](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/type/) يتطابق مع السمة ‘type’ على العنصر ‘feColorMatrix’ المحدد. يأخذ أحد الثوابت SVG_FECOLORMATRIX_TYPE_* المعرفة في هذه الواجهة. |
| [getValues](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/values/) يتطابق مع السمة ‘values’ على العنصر ‘feColorMatrix’ المحدد. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/width/) يتطابق مع السمة ‘width’ على العنصر ‘filter’ المحدد. |
| [X](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/x/) { get; } | يتطابق مع السمة ‘x’ في عنصر ‘filter’ المعطى. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/y/) { get; } | يتطابق مع السمة ‘y’ في عنصر ‘filter’ المعطى. |
