---
title: "فئة SVGFEColorMatrixElement"
second_title: "مرجع API لـ Aspose.HTML for Java"
description: "الفئة com.aspose.html.dom.svg.filters.SVGFEColorMatrixElement. واجهة SVGFEColorMatrixElement تتطابق مع عنصر feColorMatrix"
type: docs

url: /ar/java/com.aspose.html.dom.svg.filters/svgfecolormatrixelement/
---
## SVGFEColorMatrixElement class

واجهة SVGFEColorMatrixElement تتطابق مع العنصر ‘feColorMatrix’.
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/height/) يتطابق مع السمة ‘height’ على عنصر ‘filter’ المعطى. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/in1/) يتطابق مع السمة ‘in’ على عنصر ‘feColorMatrix’ المعطى. |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/result/) يتطابق مع السمة ‘result’ على عنصر ‘filter’ المعطى. |
...
| [getType](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/type/) يتطابق مع السمة ‘type’ على عنصر ‘feColorMatrix’ المعطى. يأخذ أحد الثوابت SVG_FECOLORMATRIX_TYPE_* المعرفة في هذه الواجهة. |
| [getValues](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/values/) يتطابق مع السمة ‘values’ على عنصر ‘feColorMatrix’ المعطى. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/width/) يتطابق مع السمة ‘width’ على عنصر ‘filter’ المعطى. |
| [X](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/x/) { get; } | يتوافق مع السمة ‘x’ في عنصر ‘filter’ المعطى. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/y/) { get; } | يتوافق مع السمة ‘y’ في عنصر ‘filter’ المعطى. |
...
| الاسم | الوصف |
| --- | --- |
| const [SVG_FECOLORMATRIX_TYPE_HUEROTATE](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_huerotate/) | يتطابق مع القيمة 'hueRotate'. |
| const [SVG_FECOLORMATRIX_TYPE_LUMINANCETOALPHA](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_luminancetoalpha/) | يتطابق مع القيمة 'luminanceToAlpha'. |
| const [SVG_FECOLORMATRIX_TYPE_MATRIX](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_matrix/) | يتطابق مع القيمة 'matrix'. |
| const [SVG_FECOLORMATRIX_TYPE_SATURATE](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_saturate/) | يتطابق مع القيمة 'saturate'. |
| const [SVG_FECOLORMATRIX_TYPE_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_unknown/) | النوع ليس أحد الأنواع المعرفة مسبقًا. من غير الصالح محاولة تعريف قيمة جديدة لهذا النوع أو محاولة تحويل قيمة موجودة إلى هذا النوع. |
