---
title: "فئة SVGFEGaussianBlurElement"
second_title: "مرجع API لـ Aspose.HTML for Java"
description: "الفئة com.aspose.html.dom.svg.filters.SVGFEGaussianBlurElement. الواجهة SVGFEGaussianBlurElement تتطابق مع العنصر feGaussianBlur"
type: docs

url: /ar/java/com.aspose.html.dom.svg.filters/svgfegaussianblurelement/
---
## SVGFEGaussianBlurElement class

واجهة SVGFEGaussianBlurElement تتطابق مع العنصر �feGaussianBlur� العنصر.
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/height/) يتطابق مع السمة �height� على العنصر �filter� المعطى. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/in1/) يتطابق مع السمة �in� على العنصر �feGaussianBlur� المعطى. |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/result/) يتطابق مع السمة �result� على العنصر �filter� المعطى. |
| [getShadowRoot](../../com.aspose.html.dom/element/shadowroot/) يرجع shadowRoot المخزن على هذا العنصر أو null إذا كان مغلقًا. |
| [getStdDeviationX](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/stddeviationx/) يتطابق مع السمة �stdDeviation� على العنصر �feGaussianBlur� المعطى. يحتوي على المكوّن X للسمة �stdDeviation�. |
| [getStdDeviationY](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/stddeviationy/) يتطابق مع السمة �stdDeviation� على العنصر �feGaussianBlur� المعطى. يحتوي على المكوّن Y (قد يُحسب تلقائيًا) للسمة �stdDeviation�. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/width/) يتطابق مع السمة �width� على العنصر �filter� المعطى. |
| [X](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/x/) { get; } | يتطابق مع السمة �x� على العنصر �filter� المعطى. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/y/) { get; } | يتطابق مع السمة �y� على العنصر �filter� المعطى. |
...
| [setStdDeviation](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/setstddeviation/)(float, float) | يضبط القيم للسمة �stdDeviation�. |
