...
واجهة SVGFEGaussianBlurElement تتطابق مع العنصر ‘feGaussianBlur’.
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/height/) يتطابق مع السمة �height� في عنصر �filter� المحدد. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/in1/) يتطابق مع السمة �in� في عنصر �feGaussianBlur� المحدد. |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/result/) يتطابق مع السمة �result� في عنصر �filter� المحدد. |
| [getShadowRoot](../../com.aspose.html.dom/element/shadowroot/) يعيد shadowRoot المخزن على هذا العنصر أو null إذا كان مغلقًا. |
| [getStdDeviationX](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/stddeviationx/) يتطابق مع السمة �stdDeviation� في عنصر �feGaussianBlur� المحدد. يحتوي على المكوّن X للخاصية �stdDeviation�. |
| [getStdDeviationY](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/stddeviationy/) يتطابق مع السمة �stdDeviation� في عنصر �feGaussianBlur� المحدد. يحتوي على المكوّن Y (قد يُحسب تلقائيًا) للخاصية �stdDeviation�. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/width/) يتطابق مع السمة �width� في عنصر �filter� المحدد. |
| [X](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/x/) { get; } | يتطابق مع السمة �x� في عنصر �filter� المحدد. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/y/) { get; } | يتطابق مع السمة �y� في عنصر �filter� المحدد. |
...
| [setStdDeviation](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/setstddeviation/)(float, float) | يضبط القيم للخاصية �stdDeviation�. |
