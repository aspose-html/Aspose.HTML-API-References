---
title: "فئة SVGFEBlendElement"
second_title: "مرجع API لـ Aspose.HTML for Java"
description: "الفئة com.aspose.html.dom.svg.filters.SVGFEBlendElement. الواجهة SVGFEBlendElement تتطابق مع العنصر feBlend"
type: docs

url: /ar/java/com.aspose.html.dom.svg.filters/svgfeblendelement/
---
## SVGFEBlendElement class

واجهة SVGFEBlendElement تتطابق مع العنصر ‘feBlend’.
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfeblendelement/height/) يتطابق مع السمة ‘height’ في العنصر ‘filter’ المحدد. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfeblendelement/in1/) يتطابق مع السمة ‘in’ في العنصر ‘feBlend’ المحدد. |
| [getIn2](../../com.aspose.html.dom.svg.filters/svgfeblendelement/in2/) يتطابق مع السمة ‘in2’ في العنصر ‘feBlend’ المحدد. |
[getInnerHTML]
...
| [getMode](../../com.aspose.html.dom.svg.filters/svgfeblendelement/mode/) يتطابق مع السمة ‘mode’ في العنصر ‘feBlend’ المحدد. يأخذ أحد الثوابت SVG_FEBLEND_MODE_* المعرفة في هذه الواجهة. |
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfeblendelement/result/) يتطابق مع السمة ‘result’ في العنصر ‘filter’ المحدد. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfeblendelement/width/) يتطابق مع السمة ‘width’ في العنصر ‘filter’ المحدد. |
| [X](../../com.aspose.html.dom.svg.filters/svgfeblendelement/x/) { get; } | يتوافق مع السمة ‘x’ في عنصر ‘filter’ المعطى. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfeblendelement/y/) { get; } | يتوافق مع السمة ‘y’ في عنصر ‘filter’ المعطى. |
...
| الاسم | الوصف |
| --- | --- |
| const [SVG_FEBLEND_MODE_COLOR](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_color/) | يتطابق مع القيمة 'color'. |
| const [SVG_FEBLEND_MODE_COLOR_BURN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_color_burn/) | يتطابق مع القيمة 'color_burn'. |
| const [SVG_FEBLEND_MODE_COLOR_DODGE](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_color_dodge/) | يتطابق مع القيمة 'color_dodge'. |
| const [SVG_FEBLEND_MODE_DARKEN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_darken/) | يتطابق مع القيمة 'darken'. |
| const [SVG_FEBLEND_MODE_DIFFERENCE](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_difference/) | يتطابق مع القيمة 'difference'. |
| const [SVG_FEBLEND_MODE_EXCLUSION](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_exclusion/) | يتطابق مع القيمة 'exclusion'. |
| const [SVG_FEBLEND_MODE_HARD_LIGHT](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_hard_light/) | يتطابق مع القيمة 'hard_light'. |
| const [SVG_FEBLEND_MODE_HUE](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_hue/) | يتطابق مع القيمة 'hue'. |
| const [SVG_FEBLEND_MODE_LIGHTEN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_lighten/) | يتطابق مع القيمة 'lighten'. |
| const [SVG_FEBLEND_MODE_LUMINOSITY](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_luminosity/) | يتطابق مع القيمة 'luminosity'. |
| const [SVG_FEBLEND_MODE_MULTIPLY](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_multiply/) | يتطابق مع القيمة 'multiply'. |
| const [SVG_FEBLEND_MODE_NORMAL](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_normal/) | يتطابق مع القيمة 'normal'. |
| const [SVG_FEBLEND_MODE_OVERLAY](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_overlay/) | يتطابق مع القيمة 'overlay'. |
| const [SVG_FEBLEND_MODE_SATURATION](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_saturation/) | يتطابق مع القيمة 'saturation'. |
| const [SVG_FEBLEND_MODE_SCREEN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_screen/) | يتطابق مع القيمة 'screen'. |
| const [SVG_FEBLEND_MODE_SOFT_LIGHT](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_soft_light/) | يتطابق مع القيمة 'soft_light'. |
| const [SVG_FEBLEND_MODE_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_unknown/) | النوع ليس أحد الأنواع المعرفة مسبقًا. من غير الصالح محاولة تعريف قيمة جديدة لهذا النوع أو محاولة تحويل قيمة موجودة إلى هذا النوع. |
