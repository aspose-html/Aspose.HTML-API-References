---
title: "فئة SVGFEConvolveMatrixElement"
second_title: "مرجع API لـ Aspose.HTML for Java"
description: "com.aspose.html.dom.svg.filters.SVGFEConvolveMatrixElement فئة. الواجهة SVGFEConvolveMatrixElement تتطابق مع العنصر feConvolveMatrix."
type: docs

url: /ar/java/com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/
---
## SVGFEConvolveMatrixElement class

واجهة SVGFEConvolveMatrixElement تتطابق مع العنصر ‘feConvolveMatrix’.
...
| [getBias](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/bias/) يتطابق مع السمة ‘bias’ على العنصر ‘feConvolveMatrix’ المعطى. |
...
| [getDivisor](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/divisor/) يتطابق مع السمة ‘divisor’ على العنصر ‘feConvolveMatrix’ المعطى. |
| [getEdgeMode](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/edgemode/) يتطابق مع السمة ‘edgeMode’ على العنصر ‘feConvolveMatrix’ المعطى. |
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/height/) يتطابق مع السمة ‘height’ على العنصر ‘filter’ المعطى. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/in1/) يتطابق مع السمة ‘in’ على العنصر ‘feConvolveMatrix’ المعطى. |
[getInnerHTML]
...
| [getKernelMatrix](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelmatrix/) يتطابق مع السمة ‘kernelMatrix’ على العنصر ‘feConvolveMatrix’ المعطى. |
| [getKernelUnitLengthX](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelunitlengthx/) يتطابق مع السمة ‘kernelUnitLength’ على العنصر ‘feConvolveMatrix’ المعطى. |
| [getKernelUnitLengthY](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelunitlengthy/) يتطابق مع السمة ‘kernelUnitLength’ على العنصر ‘feConvolveMatrix’ المعطى. |
...
| [getOrderX](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/orderx/) يتطابق مع السمة ‘order’ على العنصر ‘feConvolveMatrix’ المعطى. |
| [getOrderY](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/ordery/) يتطابق مع السمة ‘order’ على العنصر ‘feConvolveMatrix’ المعطى. |
[getOuterHTML]
...
| [getPreserveAlpha](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/preservealpha/) يتطابق مع السمة ‘preserveAlpha’ على العنصر ‘feConvolveMatrix’ المعطى. |
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/result/) يتطابق مع السمة ‘result’ على العنصر ‘filter’ المعطى. |
...
| [getTargetX](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/targetx/) يتطابق مع السمة ‘targetX’ على العنصر ‘feConvolveMatrix’ المعطى. |
| [getTargetY](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/targety/) يتطابق مع السمة ‘targetY’ على العنصر ‘feConvolveMatrix’ المعطى. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/width/) يتطابق مع السمة ‘width’ في عنصر ‘filter’ المعطى. |
| [X](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/x/) { get; } | يتوافق مع السمة ‘x’ في عنصر ‘filter’ المعطى. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/y/) { get; } | يتوافق مع السمة ‘y’ في عنصر ‘filter’ المعطى. |
...
| الاسم | الوصف |
| --- | --- |
| const [SVG_EDGEMODE_DUPLICATE](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_duplicate/) | يتطابق مع القيمة 'duplicate'. |
| const [SVG_EDGEMODE_NONE](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_none/) | يتطابق مع القيمة 'none'. |
| const [SVG_EDGEMODE_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_unknown/) | النوع ليس أحد الأنواع المعرفة مسبقًا. من غير الصالح محاولة تعريف قيمة جديدة لهذا النوع أو محاولة تحويل قيمة موجودة إلى هذا النوع. |
| const [SVG_EDGEMODE_WRAP](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_wrap/) | يتطابق مع القيمة 'wrap'. |
