---
title: "فئة SVGFETurbulenceElement"
second_title: "مرجع API لـ Aspose.HTML for Java"
description: "الفئة com.aspose.html.dom.svg.filters.SVGFETurbulenceElement. الواجهة SVGFETurbulenceElement تتطابق مع عنصر feTurbulence."
type: docs

url: /ar/java/com.aspose.html.dom.svg.filters/svgfeturbulenceelement/
---
## SVGFETurbulenceElement class

واجهة SVGFETurbulenceElement تتطابق مع العنصر ‘feTurbulence’.
...
| [getBaseFrequencyX](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/basefrequencyx/) يتطابق مع السمة ‘baseFrequency’ في عنصر ‘feTurbulence’ المعطى. يحتوي على المكوّن X لسمة ‘baseFrequency’. |
| [getBaseFrequencyY](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/basefrequencyy/) يتطابق مع السمة ‘baseFrequency’ في عنصر ‘feTurbulence’ المعطى. يحتوي على المكوّن Y لسمة ‘baseFrequency’ (قد يتم حسابه تلقائيًا). |
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/height/) يتطابق مع السمة ‘height’ في عنصر ‘filter’ المعطى. |
[getId]
...
| [getNumOctaves](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/numoctaves/) يتطابق مع السمة ‘numOctaves’ في عنصر ‘feTurbulence’ المعطى. |
[getOuterHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/result/) يتطابق مع السمة ‘result’ في عنصر ‘filter’ المعطى. |
| [getSeed](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/seed/) يتطابق مع السمة ‘seed’ في عنصر ‘feTurbulence’ المعطى. |
| [getShadowRoot](../../com.aspose.html.dom/element/shadowroot/) يرجع shadowRoot المخزن على هذا العنصر أو null إذا كان مغلقًا. |
| [getStitchTiles](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/stitchtiles/) يتطابق مع السمة ‘stitchTiles’ في عنصر ‘feTurbulence’ المعطى. يأخذ أحد ثوابت SVG_STITCHTYPE_* المعرفة في هذه الواجهة. |
...
| [getType](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/type/) يتطابق مع السمة ‘type’ في عنصر ‘feTurbulence’ المعطى. يأخذ أحد ثوابت SVG_TURBULENCE_TYPE_* المعرفة في هذه الواجهة. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/width/) يتطابق مع السمة ‘width’ في عنصر ‘filter’ المعطى. |
| [X](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/x/) { get; } | يتوافق مع السمة ‘x’ في عنصر ‘filter’ المعطى. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/y/) { get; } | يتوافق مع السمة ‘y’ في عنصر ‘filter’ المعطى. |
...
| الاسم | الوصف |
| --- | --- |
| const [SVG_STITCHTYPE_NOSTITCH](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_stitchtype_nostitch/) | يتطابق مع القيمة 'noStitch'. |
| const [SVG_STITCHTYPE_STITCH](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_stitchtype_stitch/) | يتطابق مع القيمة 'stitch'. |
| const [SVG_STITCHTYPE_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_stitchtype_unknown/) | النوع ليس أحد الأنواع المعرفة مسبقًا. من غير الصالح محاولة تعريف قيمة جديدة لهذا النوع أو محاولة تحويل قيمة موجودة إلى هذا النوع. |
| const [SVG_TURBULENCE_TYPE_FRACTALNOISE](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_turbulence_type_fractalnoise/) | يتطابق مع القيمة 'fractalNoise'. |
| const [SVG_TURBULENCE_TYPE_TURBULENCE](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_turbulence_type_turbulence/) | يتطابق مع القيمة 'turbulence'. |
| const [SVG_TURBULENCE_TYPE_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_turbulence_type_unknown/) | النوع ليس أحد الأنواع المعرفة مسبقًا. من غير الصالح محاولة تعريف قيمة جديدة لهذا النوع أو محاولة تحويل قيمة موجودة إلى هذا النوع. |
