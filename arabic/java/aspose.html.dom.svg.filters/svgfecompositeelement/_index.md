---
title: "SVGFECompositeElement فئة"
second_title: "مرجع API لـ Aspose.HTML for Java"
description: "com.aspose.html.dom.svg.filters.SVGFECompositeElement class. الواجهة SVGFECompositeElement تتطابق مع العنصر feComposite"
type: docs

url: /ar/java/com.aspose.html.dom.svg.filters/svgfecompositeelement/
---
## SVGFECompositeElement class

واجهة SVGFECompositeElement تتطابق مع العنصر ‘feComposite’.
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/height/) يتطابق مع السمة ‘height’ في العنصر ‘filter’ المحدد. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/in1/) يتطابق مع السمة ‘in’ في العنصر ‘feComposite’ المحدد. |
| [getIn2](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/in2/) يتطابق مع السمة ‘in2’ في العنصر ‘feComposite’ المحدد. |
[getInnerHTML]
...
| [getK1](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k1/) يتطابق مع السمة ‘k1’ في العنصر ‘feComposite’ المحدد. |
| [getK2](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k2/) يتطابق مع السمة ‘k2’ في العنصر ‘feComposite’ المحدد. |
| [getK3](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k3/) يتطابق مع السمة ‘k3’ في العنصر ‘feComposite’ المحدد. |
| [getK4](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k4/) يتطابق مع السمة ‘k4’ في العنصر ‘feComposite’ المحدد. |
...
| [getOperator](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/operator/) يتطابق مع السمة ‘operator’ في العنصر ‘feComposite’ المحدد. يأخذ أحد الثوابت SVG_FECOMPOSITE_OPERATOR_* المعرفة في هذه الواجهة. |
[getOuterHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/result/) يتطابق مع السمة ‘result’ في العنصر ‘filter’ المحدد. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/width/) يتطابق مع السمة ‘width’ في العنصر ‘filter’ المحدد. |
| [X](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/x/) { get; } | يتوافق مع السمة ‘x’ في عنصر ‘filter’ المعطى. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/y/) { get; } | يتوافق مع السمة ‘y’ في عنصر ‘filter’ المعطى. |
...
| الاسم | الوصف |
| --- | --- |
| const [SVG_FECOMPOSITE_OPERATOR_ARITHMETIC](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_arithmetic/) | يتطابق مع القيمة 'arithmetic'. |
| const [SVG_FECOMPOSITE_OPERATOR_ATOP](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_atop/) | يتطابق مع القيمة 'atop'. |
| const [SVG_FECOMPOSITE_OPERATOR_IN](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_in/) | يتطابق مع القيمة 'in'. |
| const [SVG_FECOMPOSITE_OPERATOR_OUT](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_out/) | يتطابق مع القيمة 'out'. |
| const [SVG_FECOMPOSITE_OPERATOR_OVER](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_over/) | يتطابق مع القيمة 'over'. |
| const [SVG_FECOMPOSITE_OPERATOR_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_unknown/) | النوع ليس أحد الأنواع المعرفة مسبقًا. من غير الصالح محاولة تعريف قيمة جديدة لهذا النوع أو محاولة تحويل قيمة موجودة إلى هذا النوع. |
| const [SVG_FECOMPOSITE_OPERATOR_XOR](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_xor/) | يتطابق مع القيمة 'xor'. |
