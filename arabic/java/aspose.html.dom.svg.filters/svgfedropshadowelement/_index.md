---
title: "SVGFEDropShadowElement فئة"
second_title: "مرجع API لـ Aspose.HTML for Java"
description: "com.aspose.html.dom.svg.filters.SVGFEDropShadowElement فئة. ال SVGFEDropShadowElement واجهة تتطابق مع العنصر feDropShadow"
type: docs

url: /ar/java/com.aspose.html.dom.svg.filters/svgfedropshadowelement/
---
## SVGFEDropShadowElement class

واجهة SVGFEDropShadowElement تتطابق مع العنصر ‘feDropShadow’.
...
| [getDx](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/dx/) يتطابق مع السمة ‘dx’ في العنصر ‘feDropShadow’ المحدد. |
| [getDy](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/dy/) يتطابق مع السمة ‘dy’ في العنصر ‘feDropShadow’ المحدد. |
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/height/) يتطابق مع السمة ‘height’ في العنصر ‘feDropShadow’ المحدد. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/in1/) يتطابق مع السمة ‘in’ في العنصر ‘feDropShadow’ المحدد. |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/result/) يتطابق مع السمة ‘result’ في العنصر ‘feDropShadow’ المحدد. |
| [getShadowRoot](../../com.aspose.html.dom/element/shadowroot/) يرجع shadowRoot المخزن على هذا العنصر أو null إذا كان مغلقًا. |
| [getStdDeviationX](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/stddeviationx/) يتطابق مع السمة ‘stdDeviation’ في العنصر ‘feDropShadow’ المحدد. يحتوي على المكوّن X للسمة ‘stdDeviation’. |
| [getStdDeviationY](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/stddeviationy/) يتطابق مع السمة ‘stdDeviation’ في العنصر ‘feDropShadow’ المحدد. يحتوي على المكوّن Y (قد يُحسب تلقائيًا) للسمة ‘stdDeviation’. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/width/) يتطابق مع السمة ‘width’ في العنصر ‘feDropShadow’ المحدد. |
| [X](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/x/) { get; } | يتطابق مع السمة ‘x’ في العنصر ‘feDropShadow’ المحدد. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/y/) { get; } | يتطابق مع السمة ‘y’ في العنصر ‘feDropShadow’ المحدد. |
...
| [setStdDeviation](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/setstddeviation/)(float, float) | يضبط القيم للسمة ‘stdDeviation’. |
