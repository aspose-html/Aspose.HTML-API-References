---
title: "فئة SVGFEDisplacementMapElement"
second_title: "مرجع API لـ Aspose.HTML for Java"
description: "الفئة com.aspose.html.dom.svg.filters.SVGFEDisplacementMapElement. الواجهة SVGFEDisplacementMapElement تتطابق مع العنصر feDisplacementMap"
type: docs

url: /ar/java/com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/
---
## SVGFEDisplacementMapElement class

واجهة SVGFEDisplacementMapElement تتطابق مع العنصر ‘feDisplacementMap’.
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/height/) يتطابق مع السمة ‘height’ على العنصر ‘filter’ المعطى. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/in1/) يتطابق مع السمة ‘in’ على العنصر ‘feDisplacementMap’ المعطى. |
| [getIn2](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/in2/) يتطابق مع السمة ‘in2’ على العنصر ‘feDisplacementMap’ المعطى. |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/result/) يتطابق مع السمة ‘result’ على العنصر ‘filter’ المعطى. |
| [getScale](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/scale/) يتطابق مع السمة ‘scale’ على العنصر ‘feDisplacementMap’ المعطى. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/width/) يتطابق مع السمة ‘width’ على العنصر ‘filter’ المعطى. |
| [X](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/x/) { get; } | يتوافق مع السمة ‘x’ في عنصر ‘filter’ المعطى. |
| [getXChannelSelector](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/xchannelselector/) يتطابق مع السمة ‘xChannelSelector’ على العنصر ‘feDisplacementMap’ المعطى. يأخذ أحد ثوابت SVG_CHANNEL_* المعرفة في هذه الواجهة. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/y/) { get; } | يتوافق مع السمة ‘y’ في عنصر ‘filter’ المعطى. |
| [getYChannelSelector](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/ychannelselector/) يتطابق مع السمة ‘yChannelSelector’ في عنصر ‘feDisplacementMap’ المعطى. يأخذ أحد ثوابت SVG_CHANNEL_* المعرفة في هذه الواجهة. |
...
| الاسم | الوصف |
| --- | --- |
| const [SVG_CHANNEL_A](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_a/) | يتطابق مع القيمة 'A'. |
| const [SVG_CHANNEL_B](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_b/) | يتطابق مع القيمة 'B'. |
| const [SVG_CHANNEL_G](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_g/) | يتطابق مع القيمة 'G'. |
| const [SVG_CHANNEL_R](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_r/) | يتطابق مع القيمة 'R'. |
| const [SVG_CHANNEL_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_unknown/) | النوع ليس أحد الأنواع المعرفة مسبقًا. من غير الصالح محاولة تعريف قيمة جديدة لهذا النوع أو محاولة تحويل قيمة موجودة إلى هذا النوع. |
