...
description: "طريقة FileSystemResourceHandler. هذه الطريقة مسؤولة عن معالجة المورد. يمكنك من خلالها حفظ الـResource إلى التيار أو تضمينه في المورد الأب."
type: docs

url: /ar/java/com.aspose.html.saving.resourcehandlers/filesystemresourcehandler/handleresource/
---
## FileSystemResourceHandler.HandleResource method

هذه الطريقة مسؤولة عن معالجة المورد. يمكنك من خلالها حفظ الـ[`Resource`](../../../com.aspose.html.saving/resource/) إلى التيار أو تضمينه في المورد الأب.
