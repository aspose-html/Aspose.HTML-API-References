...
| معامل | نوع | الوصف |
| --- | --- | --- |
| propertyName | String | propertyName هو String يمثل اسم الخاصية التي سيتم إزالتها. لاحظ أن أسماء الخصائص متعددة الكلمات تُكتب بشرطة ولا تُكتب بصيغة camelCase. |
