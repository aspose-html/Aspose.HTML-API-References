...
description: "واجهة com.aspose.html.dom.css.ICSSCharsetRule. تمثل واجهة CSSCharsetRule قاعدة charset في ورقة أنماط CSS. لا يؤثر قيمة سمة الترميز (encoding) على ترميز بيانات النص في كائنات DOM؛ هذا الترميز دائمًا UTF-16. بعد تحميل ورقة الأنماط، تكون قيمة سمة الترميز هي القيمة الموجودة في قاعدة charset. إذا لم يكن هناك charset في المستند الأصلي فلن تُنشأ أي CSSCharsetRule. قد تُستخدم قيمة سمة الترميز أيضًا كإشارة للترميز المستخدم عند تسلسل ورقة الأنماط."
type: docs

url: /ar/java/com.aspose.html.dom.css/icsscharsetrule/
---
