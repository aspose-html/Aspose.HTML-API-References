...
description: "خاصية ICSS2Properties. تحدد هذه الخاصية عرض المحتوى للصناديق التي تُنشئها العناصر ذات المستوى الكتلي والعناصر المستبدلة."
type: docs
...
تحدد هذه الخاصية [عرض المحتوى](https://www.w3.org/TR/1998/REC-CSS2-19980512/box.html#content-width) للصناديق التي تُنشئها العناصر ذات المستوى الكتلي و[العناصر المستبدلة](https://www.w3.org/TR/1998/REC-CSS2-19980512/conform.html#replaced-element).

هذه الخاصية لا تنطبق على العناصر غير المستبدلة [inline-level](https://www.w3.org/TR/1998/REC-CSS2-19980512/visuren.html#inline-level) elements. عرض صناديق العنصر غير المستبدل هو عرض المحتوى المُعرض داخلها (قبل أي إزاحة نسبية للأطفال). تذكر أن صناديق السطر تتدفق إلى [line boxes](https://www.w3.org/TR/1998/REC-CSS2-19980512/visuren.html#line-box). عرض صناديق السطر يُحدد بواسطة [containing block](https://www.w3.org/TR/1998/REC-CSS2-19980512/visuren.html#containing-block)، لكن قد يتم تقصيره بوجود [floats](https://www.w3.org/TR/1998/REC-CSS2-19980512/visuren.html#floats).
