...
description: "واجهة com.aspose.html.dom.css.ICSS2Properties. تمثل واجهة CSS2Properties آلية مريحة لاسترجاع وتعيين الخصائص داخل CSSStyleDeclaration. تتطابق سمات هذه الواجهة مع جميع الخصائص المحددة في CSS2. الحصول على سمة من هذه الواجهة يعادل استدعاء طريقة getPropertyValue في واجهة CSSStyleDeclaration. تعيين سمة في هذه الواجهة يعادل استدعاء طريقة setProperty في واجهة CSSStyleDeclaration."
type: docs
