...
description: "فئة com.aspose.html.dom.css.CSSPrimitiveValue. تُشتق واجهة CSSPrimitiveValue من واجهة CSSValue وتمثل القيمة المحسوبة الحالية لخاصية CSS."
type: docs
...
تشتق واجهة CSSPrimitiveValue من واجهة CSSValue وتمثل القيمة المحسوبة الحالية لخاصية CSS.

ملاحظة: كانت هذه الواجهة جزءًا من محاولة لإنشاء نموذج كائن CSS مكتوب بنوع. تم التخلي عن هذه المحاولة، ومعظم المتصفحات لا تنفّذها.
...
| [getPrimitiveType](../../com.aspose.html.dom.css/cssprimitivevalue/primitivetype/) نوع القيمة كما هو مُعرّف بالثوابت المحددة أعلاه. |
...
| abstract [GetCounterValue](../../com.aspose.html.dom.css/cssprimitivevalue/getcountervalue/)() | تُستخدم هذه الطريقة للحصول على قيمة Counter. إذا لم تحتوي قيمة CSS هذه على قيمة عداد، يتم رفع DOMException. يمكن تعديل الخاصية النمطية المقابلة باستخدام واجهة Counter. |
...
| abstract [GetRectValue](../../com.aspose.html.dom.css/cssprimitivevalue/getrectvalue/)() | يُستخدم هذا الأسلوب للحصول على قيمة Rect. إذا لم تحتوي قيمة CSS هذه على قيمة rect، يتم رفع استثناء DOMException. يمكن تعديل الخاصية النمطية المقابلة باستخدام واجهة Rect. |
...
| abstract [GetStringValue](../../com.aspose.html.dom.css/cssprimitivevalue/getStringvalue/)() | يُستخدم هذا الأسلوب للحصول على قيمة سلسلة. إذا لم تحتوي قيمة CSS على قيمة سلسلة، يتم رفع استثناء DOMException. |
...
| abstract [SetIntValue](../../com.aspose.html.dom.css/cssprimitivevalue/setintvalue/)(ushort, int) | طريقة لتعيين القيمة العددية الصحيحة بوحدة محددة. إذا لم تستطع الخاصية المرتبطة بهذه القيمة قبول الوحدة المحددة أو القيمة العددية الصحيحة، ستبقى القيمة دون تغيير وسيتم رفع استثناء DOMException. |
| abstract [SetStringValue](../../com.aspose.html.dom.css/cssprimitivevalue/setStringvalue/)(ushort, String) | طريقة لتعيين قيمة السلسلة بالوحدة المحددة. إذا لم تستطع الخاصية المرتبطة بهذه القيمة قبول الوحدة المحددة أو قيمة السلسلة، ستبقى القيمة دون تغيير وسيتم رفع استثناء DOMException. |
...
| const [CSS_DIMENSION](../../com.aspose.html.dom.css/cssprimitivevalue/css_dimension/) | القيمة هي رقم بعدد غير معروف. يمكن الحصول على القيمة باستخدام طريقة getFloatValue. |
...
| const [CSS_UNKNOWN](../../com.aspose.html.dom.css/cssprimitivevalue/css_unknown/) | القيمة ليست قيمة CSS2 معروفة. لا يمكن الحصول على القيمة إلا باستخدام الخاصية cssText. |
...
| const [CSS_VH](../../com.aspose.html.dom.css/cssprimitivevalue/css_vh/) | القيمة هي نسبة مئوية من ارتفاع نافذة العرض الكامل. |
| const [CSS_VMAX](../../com.aspose.html.dom.css/cssprimitivevalue/css_vmax/) | القيمة هي نسبة مئوية من عرض أو ارتفاع نافذة العرض، أيهما أكبر. |
| const [CSS_VMIN](../../com.aspose.html.dom.css/cssprimitivevalue/css_vmin/) | القيمة هي نسبة مئوية من عرض أو ارتفاع نافذة العرض، أيهما أصغر. |
| const [CSS_VW](../../com.aspose.html.dom.css/cssprimitivevalue/css_vw/) | القيمة هي نسبة مئوية من عرض نافذة العرض الكامل. |
