...
مؤشرات الخصائص المدعومة للكائن هي الأرقام في النطاق من الصفر إلى واحد أقل من عدد أوراق الأنماط CSS التي تمثلها المجموعة. إذا لم توجد مثل هذه أوراق الأنماط CSS، فلا توجد مؤشرات خصائص مدعومة.
...
| [getLength](../../com.aspose.html.dom.css/istylesheetlist/length/) يجب أن تُعيد خاصية length عدد أوراق الأنماط CSS التي تمثلها المجموعة. النطاق الصالح لمؤشرات أوراق الأنماط الفرعية هو من 0 إلى length-1 شاملًا. |
