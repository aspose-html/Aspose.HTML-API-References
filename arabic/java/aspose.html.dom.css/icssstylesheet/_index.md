...
| الاسم | الوصف |
| --- | --- |
| [getCSSRules](../../com.aspose.html.dom.css/icssstylesheet/cssrules/) الخاصية للقراءة فقط cssRules في CSSStyleSheet تُرجع [`CSSRuleList`](../icssrulelist/) حيًا يوفر قائمة محدثة في الوقت الحقيقي بكل قاعدة CSS التي تشكل ورقة الأنماط. كل عنصر في القائمة هو [`CSSRule`](../icssrule/) يعرّف قاعدة واحدة. |
...
| الاسم | الوصف |
| --- | --- |
| [deleteRule](../../com.aspose.html.dom.css/icssstylesheet/deleterule/)(int) | طريقة `CSSStyleSheet` deleteRule() تزيل قاعدة من كائن ورقة الأنماط. |
