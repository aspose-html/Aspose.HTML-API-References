---
title: "الفئة PdfRenderingOptions"
second_title: "مرجع API لـ Aspose.HTML للـ Java"
description: "الفئة com.aspose.html.rendering.pdf.PdfRenderingOptions. تمثل خيارات التصيير لـ PdfDevice"
type: docs

url: /ar/java/com.aspose.html.rendering.pdf/pdfrenderingoptions/
---
## PdfRenderingOptions class

تمثل خيارات التصيير لـ [`PdfDevice`](../pdfdevice/).
...
| الاسم | الوصف |
| --- | --- |
| [PdfRenderingOptions](pdfrenderingoptions/)() | ينشئ مثلاً جديداً من الفئة `PdfRenderingOptions`. |
