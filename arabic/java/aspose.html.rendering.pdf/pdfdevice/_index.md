...
يمثل عملية العرض إلى مستند PDF.
...
| [PdfDevice](pdfdevice/#constructor_1)(PdfRenderingOptions, ICreateStreamProvider) | ينشئ مثلاً جديداً من الفئة `PdfDevice` باستخدام خيارات التصيير ومزود الدفق. |
...
| الاسم | الوصف |
| --- | --- |
| class [PdfGraphicContext](../../com.aspose.html.rendering.pdf/pdfdevice.pdfgraphiccontext) | تحتفظ بمعلمات التحكم الرسومية الحالية لجهاز PdfDevice. هذه المعلمات تحدد الإطار العام الذي تنفذ ضمنه عمليات الرسوميات. |
