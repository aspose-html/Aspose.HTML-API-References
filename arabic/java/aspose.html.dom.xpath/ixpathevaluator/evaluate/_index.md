...
description: "طريقة IXPathEvaluator. تُقيم سلسلة تعبير XPath وتُعيد النتيجة من النوع المحدد إذا كان ذلك ممكنًا."
type: docs
...
| type | XPathResultType | إذا تم تحديد `type` معين، فستُعاد النتيجة كنوعه المقابل. بالنسبة لنتائج XPath 1.0، يجب أن يكون ذلك أحد قيم تعداد [`XPathResultType`](../../xpathresulttype/). |
