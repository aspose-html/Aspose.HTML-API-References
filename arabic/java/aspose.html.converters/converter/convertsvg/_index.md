...
description: "طريقة Converter. تحويل مصدر SVG المقدم بواسطة SVGDocument. النتيجة هي بيانات إخراج تم تشكيلها بواسطة تنفيذ واجهة ICreateStreamProvider"
type: docs
...
تحويل مصدر SVG المقدم بواسطة [`SVGDocument`](../../../com.aspose.html.dom.svg/svgdocument/). النتيجة هي بيانات إخراج تم تشكيلها بواسطة تنفيذ واجهة [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/).
...
فئة Converter تقدم تحويلات متعددة مخصصة لـ SVG إلى XPS. لتحويل SVG إلى XPS، يجب عليك اتباع أحد السيناريوهات البسيطة التي تتكون من عدة خطوات:

مصدر التحويل. اكتشف ملف SVG محلي موجود أو بعيد [`Url`](../../../com.aspose.html/url/) كمصدر للتحويل. يمكنك أيضًا تعريف [`SVGDocument`](../../../com.aspose.html.dom.svg/svgdocument/) كمصدر للتحويل أو حتى استخدام محتوى SVG مضمن مقدم بواسطة مصدر سلسلة. نتيجة التحويل. حدد مسار ملف الإخراج أو استخدم تنفيذ واجهة [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) المعروف أو المخصص كذاكرة بيانات إخراج. أنشئ كائنًا جديدًا من [`XpsSaveOptions`](../../../com.aspose.html.saving/xpssaveoptions/) بإعدادات محددة أو افتراضية. يمكنك أيضًا إضافة [`configuration`](../../../com.aspose.html/configuration/) كمعامل خيار. استخدم طريقة ConvertSVG() في فئة Converter لحفظ SVG كنتيجة XPS مع ثلاثة أو أكثر من المعلمات حسب سيناريو المستخدم. محول SVG عبر الإنترنت

توفر Aspose.HTML محولًا مجانيًا عبر الإنترنت لـ [SVG to XPS Converter](https://products.aspose.app/svg/en/conversion/svg-to-xps) يقوم بتحويل SVG إلى XPS بجودة عالية، بسهولة وسرعة. فقط قم بتحميل ملفاتك، تحويلها واحصل على النتائج في بضع ثوانٍ!
...
تحويل مصدر SVG المقدم بواسطة [`URL`](../../../com.aspose.html/url/). النتيجة هي بيانات إخراج تم تشكيلها بواسطة تنفيذ واجهة [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/).
...
تحويل مصدر SVG المقدم بواسطة مسار ملف كامل إلى XPS. النتيجة هي بيانات إخراج تم تشكيلها بواسطة تنفيذ واجهة [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/).
...
تحويل مصدر SVG المقدم عبر [`SVGDocument`](../../../com.aspose.html.dom.svg/svgdocument/). النتيجة هي ملف docx تم إنشاؤه بواسطة مسار ملف الإخراج.
...
| options | DocSaveOptions | استخدام كائن [`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/) يتيح لك ضبط عملية العرض. لمزيد من المعلومات راجع [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/svg-to-docx/#convert-svg-to-docx-using-docsaveoptions). |
...
توفر فئة Converter تحويلات متعددة مخصصة لـ SVG إلى DOCX. لتحويل SVG إلى DOCX، يجب عليك اتباع أحد السيناريوهات البسيطة التي تتكون من بضع خطوات:

مصدر التحويل. اكتشف ملف SVG محلي موجود أو رابط بعيد [`Url`](../../../com.aspose.html/url/) كمصدر للتحويل. يمكنك أيضًا تحديد [`SVGDocument`](../../../com.aspose.html.dom.svg/svgdocument/) كمصدر للتحويل أو حتى استخدام محتوى SVG مضمن يُقدَّم كسلسلة مصدر. نتيجة التحويل. حدد مسار ملف الإخراج أو استخدم تنفيذ واجهة [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) المعروف أو المخصص كذاكرة مؤقتة لبيانات الإخراج. أنشئ كائنًا جديدًا من [`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/) بإعدادات محددة أو افتراضية. يمكنك أيضًا إضافة [`configuration`](../../../com.aspose.html/configuration/) كمعامل خيار. استخدم طريقة ConvertSVG() في فئة Converter لحفظ SVG كنتيجة DOCX مع ثلاثة أو أكثر من المعلمات حسب سيناريو المستخدم. محول SVG عبر الإنترنت

توفر Aspose.HTML محولًا مجانيًا عبر الإنترنت [SVG to DOCX Converter](https://products.aspose.app/svg/en/conversion/svg) يقوم بتحويل SVG إلى DOCX بجودة عالية، بسهولة وسرعة. فقط قم بتحميل ملفاتك، تحويلها واحصل على النتائج خلال بضع ثوانٍ!
...
تحويل مصدر SVG المقدم عبر [`URL`](../../../com.aspose.html/url/). النتيجة هي ملف docx تم إنشاؤه بواسطة مسار ملف الإخراج.
...
تحويل مصدر SVG المقدم بمسار ملف كامل إلى DOCX. النتيجة هي ملف DOCX تم تكوينه بواسطة مسار ملف الإخراج.
...
تحويل مصدر SVG المقدم عبر المحتوى المضمن. النتيجة هي ملف docx يتم إنشاؤه بواسطة مسار ملف الإخراج.
...
تحويل مصدر SVG المقدم عبر [`SVGDocument`](../../../com.aspose.html.dom.svg/svgdocument/) إلى PDF. النتيجة هي ملف pdf تم إنشاؤه بواسطة مسار ملف الإخراج.
...
| --- | --- | --- |
| source | SVGDocument | مصدر التحويل المقدم بواسطة [`SVGDocument`](../../../com.aspose.html.dom.svg/svgdocument/). |
| options | PdfSaveOptions | استخدام كائن [`PdfSaveOptions`](../../../com.aspose.html.saving/pdfsaveoptions/) يتيح لك ضبط عملية العرض. لمزيد من المعلومات راجع [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/svg-to-pdf/#save-options). |
...
توفر فئة Converter تحويلات متعددة مخصصة لـ SVG إلى PDF. لتحويل SVG إلى PDF، يجب عليك اتباع أحد السيناريوهات البسيطة التي تتكون من بضع خطوات:

مصدر التحويل. اكتشف ملف SVG محلي موجود أو رابط بعيد [`Url`](../../../com.aspose.html/url/) كمصدر للتحويل. يمكنك أيضًا تحديد [`SVGDocument`](../../../com.aspose.html.dom.svg/svgdocument/) كمصدر للتحويل أو حتى استخدام محتوى SVG مضمن يُقدَّم كسلسلة مصدر. نتيجة التحويل. حدد مسار ملف الإخراج أو استخدم تنفيذ واجهة [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) المعروف أو المخصص كذاكرة مؤقتة لبيانات الإخراج. أنشئ كائنًا جديدًا من [`PdfSaveOptions`](../../../com.aspose.html.saving/pdfsaveoptions/) بإعدادات محددة أو افتراضية. يمكنك أيضًا إضافة [`configuration`](../../../com.aspose.html/configuration/) كمعامل خيار. استخدم طريقة ConvertSVG() في فئة Converter لحفظ SVG كنتيجة PDF مع ثلاثة أو أكثر من المعلمات حسب سيناريو المستخدم. محول SVG عبر الإنترنت

توفر Aspose.HTML محولًا مجانيًا عبر الإنترنت [SVG to PDF Converter](https://products.aspose.app/svg/en/conversion/svg-to-pdf) يقوم بتحويل SVG إلى PDF بجودة عالية، بسهولة وسرعة. فقط قم بتحميل ملفاتك، تحويلها واحصل على النتائج خلال بضع ثوانٍ!
...
تحويل مصدر SVG المقدم عبر [`URL`](../../../com.aspose.html/url/). النتيجة هي ملف pdf تم إنشاؤه بواسطة مسار ملف الإخراج.
...
تحويل مصدر SVG المقدم بمسار ملف كامل إلى PDF. النتيجة هي ملف PDF تم تكوينه بواسطة مسار ملف الإخراج.
...
تحويل مصدر SVG المقدم عبر المحتوى المضمن إلى PDF. النتيجة هي ملف pdf يتم إنشاؤه بواسطة مسار ملف الإخراج.
...
ارجع إلى [مقال](https://docs.aspose.com/html/net/converting-between-formats/svg-to-jpg/) حيث تجد معلومات حول كيفية تحويل SVG إلى JPG باستخدام طرق ConvertSVG() في الفئة [`Converter`](../) وكيفية تطبيق معلمات [`ImageSaveOptions`](../../../com.aspose.html.saving/imagesaveoptions/) و [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/). مقالات أخرى متعلقة بتنسيقات الصور الشائعة: [تحويل SVG إلى PNG](https://docs.aspose.com/html/net/converting-between-formats/svg-to-png/), [تحويل SVG إلى BMP](https://docs.aspose.com/html/net/converting-between-formats/svg-to-bmp/), [تحويل SVG إلى GIF](https://docs.aspose.com/html/net/converting-between-formats/svg-to-gif/) و [تحويل SVG إلى TIFF](https://docs.aspose.com/html/net/converting-between-formats/svg-to-tiff/).

تحويل SVG إلى صورة

توفر فئة Converter عدة تحويلات محددة لـ SVG إلى صورة في تنسيقات شائعة. لتحويل SVG إلى صورة، يجب عليك اتباع أحد السيناريوهات البسيطة التي تتكون من بضع خطوات:

مصدر التحويل. اكتشف ملف SVG محلي موجود أو مصدر بعيد [`Url`](../../../com.aspose.html/url/) كمصدر للتحويل. يمكنك أيضًا تعريف [`SVGDocument`](../../../com.aspose.html.dom.svg/svgdocument/) كمصدر للتحويل أو حتى استخدام محتوى SVG مضمن مقدم كسلسلة نصية. نتيجة التحويل. حدد مسار ملف الإخراج أو استخدم تنفيذ واجهة [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) المعروفة أو المخصصة كمنطقة تخزين بيانات الإخراج. أنشئ كائنًا جديدًا من [`ImageSaveOptions`](../../../com.aspose.html.saving/imagesaveoptions/) بإعدادات محددة أو افتراضية. لاحظ أن تنسيق الصورة الافتراضي هو PNG. يمكنك أيضًا إضافة [`configuration`](../../../com.aspose.html/configuration/) كمعامل خيار. استخدم طريقة ConvertSVG() من فئة Converter لحفظ SVG كنتيجة صورة مع ثلاثة أو أكثر من المعلمات حسب سيناريو المستخدم. محول SVG عبر الإنترنت

توفر Aspose.HTML محولًا مجانيًا عبر الإنترنت [SVG to JPG Converter](https://products.aspose.app/svg/en/conversion/svg-to-jpg) الذي يحول SVG إلى JPG بجودة عالية، بسهولة وسرعة. ما عليك سوى تحميل ملفاتك، تحويلها والحصول على النتائج في بضع ثوانٍ!
...
تحويل مصدر SVG المقدم بمسار ملف كامل إلى صورة. النتيجة هي ملف صورة تم تكوينه بواسطة مسار ملف الإخراج.
...
تحويل مصدر SVG المقدم عبر المحتوى المضمن إلى صورة. النتيجة هي ملف صورة يتم إنشاؤه بواسطة مسار ملف الإخراج.
...
تحويل مصدر SVG المقدم بمسار ملف كامل إلى XPS. النتيجة هي ملف XPS تم تكوينه بواسطة مسار ملف الإخراج.
...
تحويل مصدر SVG المقدم عبر المحتوى المضمن إلى XPS. النتيجة هي ملف xps يتم إنشاؤه بواسطة مسار ملف الإخراج.
