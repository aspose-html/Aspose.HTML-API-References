...
تحويل مصدر MHTML المقدم عبر [تدفق](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream?view=net-5.0). النتيجة هي ملف xps تم إنشاؤه عبر مسار ملف الإخراج.
...
| options | XpsSaveOptions | [`XpsSaveOptions`](../../../com.aspose.html.saving/xpssaveoptions/) يتيح لك ضبط عملية العرض. لمزيد من المعلومات راجع [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/mhtml-to-xps/#save-options). |
...
MHTML إلى [XPS](https://docs.fileformat.com/page-description-language/xps/) التحويل غالبًا ما يكون مطلوبًا للاستفادة من تنسيق XPS لمهام محددة. ملف XPS يمثل ملفات تخطيط الصفحات التي تستند إلى مواصفات XML Paper، التي أنشأتها Microsoft.

ارجع إلى [مقال](https://docs.aspose.com/html/net/converting-between-formats/mhtml-to-xps/) حيث تجد معلومات حول كيفية تحويل MHTML إلى XPS باستخدام طرق ConvertHTML() في الفئة [`Converter`](../) وكيفية تطبيق معلمات [`XpsSaveOptions`](../../../com.aspose.html.saving/xpssaveoptions/) و [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/).

تحويل MHTML إلى XPS

توفر فئة Converter عددًا قليلًا من التحويلات المحددة لـ MHTML إلى XPS. لتحويل MHTML إلى XPS، يجب عليك اتباع أحد السيناريوهات البسيطة التي تتكون من بضع خطوات:

مصدر التحويل. اكتشف ملف MHTML (.mht) محلي موجود أو مصدر بعيد [`Url`](../../../com.aspose.html/url/) كمصدر للتحويل. يمكنك أيضًا استخدام تدفق قياسي أو مخصص كمصدر للتحويل. نتيجة التحويل. حدد مسار ملف الإخراج أو استخدم تنفيذ واجهة [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) المعروفة أو المخصصة كمنطقة تخزين بيانات الإخراج. أنشئ كائنًا جديدًا من [`XpsSaveOptions`](../../../com.aspose.html.saving/xpssaveoptions/) بإعدادات محددة أو افتراضية. يمكنك أيضًا إضافة [`configuration`](../../../com.aspose.html/configuration/) كمعامل خيار. استخدم طريقة ConvertMHTML() من فئة Converter لحفظ MHTML كنتيجة XPS مع ثلاثة أو أكثر من المعلمات حسب سيناريو المستخدم. محول MHTML عبر الإنترنت

توفر Aspose.HTML محولًا مجانيًا عبر الإنترنت [MHTML to XPS Converter](https://products.aspose.app/html/en/conversion/mhtml-to-xps) الذي يحول MHTML إلى XPS بجودة عالية، بسهولة وسرعة. ما عليك سوى تحميل ملفاتك، تحويلها والحصول على النتائج في بضع ثوانٍ!
...
... 
      ...
      // تحديد كائن XpsSaveOptions الافتراضي
...
تحويل مصدر MHTML المقدم بمسار ملف كامل إلى XPS. النتيجة هي ملف XPS تم تكوينه بواسطة مسار ملف الإخراج.
...
تحويل مصدر MHTML المقدم عبر URL. النتيجة هي ملف XPS تم تكوينه بواسطة مسار ملف الإخراج.
...
تحويل مصدر MHTML المقدم عبر [stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream?view=net-6.0) الإدخال. النتيجة هي ملف XPS تم تكوينه بواسطة مسار ملف الإخراج.
...
... 
      ...
      // استخدام أحد تطبيقات ICreateStreamProvider
...
تحويل مصدر MHTML المقدم عبر تدفق الإدخال. النتيجة هي ملف docx تم إنشاؤه عبر مسار ملف الإخراج.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| دفق | دفق | تدفق بيانات الإدخال للتحويل MHTML. |
| options | DocSaveOptions | استخدام كائن [`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/) يتيح لك ضبط عملية العرض. لمزيد من المعلومات راجع [توثيق Aspose](https://docs.aspose.com/html/net/converting-between-formats/mhtml-to-docx/#save-options). |
...
غالبًا ما يكون تحويل MHTML إلى DOCX مطلوبًا للاستفادة من تنسيق [DOCX](https://docs.fileformat.com/word-processing/docx/) لمهام محددة. DOCX هو تنسيق معروف جيدًا لمستندات Microsoft Word. يمكنه احتواء مجموعة واسعة من البيانات، بما في ذلك النصوص والجداول والرسومات النقطية والمتجهة والفيديو والأصوات والرسوم التخطيطية. هذا التنسيق شائع لأنه يدعم ميزات تنسيق معقدة ويوفر للمستخدمين مجموعة متنوعة من الخيارات لكتابة أي نوع من المستندات.
...
مصدر التحويل. اكتشف ملف MHTML (.mht) محلي موجود أو [`Url`](../../../com.aspose.html/url/) بعيد كمصدر للتحويل. يمكنك أيضًا استخدام تدفق قياسي أو مخصص كمصدر للتحويل. نتيجة التحويل. حدد مسار ملف الإخراج للنتيجة أو استخدم تنفيذ واجهة [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) المعروف أو المخصص كذاكرة مؤقتة لبيانات الإخراج. أنشئ كائنًا جديدًا من [`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/) بإعدادات محددة أو افتراضية. يمكنك أيضًا إضافة [`configuration`](../../../com.aspose.html/configuration/) كمعامل خيار. استخدم طريقة ConvertMHTML() في فئة Converter لحفظ MHTML كنتيجة DOCX مع ثلاثة أو أكثر من المعلمات حسب سيناريو المستخدم. محول MHTML عبر الإنترنت

تقدم Aspose.HTML محولًا مجانيًا عبر الإنترنت لـ [محول MHTML إلى DOCX](https://products.aspose.app/html/en/conversion/mhtml-to-docx) يقوم بتحويل MHTML إلى DOCX بجودة عالية، وسهولة وسرعة. ما عليك سوى تحميل ملفاتك، تحويلها والحصول على النتائج في بضع ثوانٍ!
...
... 
      ...
      // حدد كائن DocSaveOptions الافتراضي
...
تحويل مصدر MHTML المقدم عبر مسار ملف كامل إلى DOCX. النتيجة هي ملف docx تم إنشاؤه عبر مسار ملف الإخراج.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| sourcePath | String | مسار ملف مصدر MHTML. سيتم دمجه مع مسار الدليل الحالي لتشكيل عنوان URL مطلق. |
| options | DocSaveOptions | استخدام كائن [`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/) يتيح لك ضبط عملية العرض. لمزيد من المعلومات راجع [توثيق Aspose](https://docs.aspose.com/html/net/converting-between-formats/mhtml-to-docx/#save-options). |
| outputPath | String | مسار ملف docx الكامل كنتيجة تحويل الإخراج. |
...
تحويل مصدر MHTML المقدم عبر URL. النتيجة هي ملف DOCX تم تكوينه بواسطة مسار ملف الإخراج.
...
مصدر التحويل. اكتشف ملف MHTML (.mht) محلي موجود أو [`Url`](../../../com.aspose.html/url/) بعيد كمصدر للتحويل. يمكنك أيضًا استخدام تدفق قياسي أو مخصص كمصدر للتحويل. نتيجة التحويل. حدد مسار ملف الإخراج للنتيجة أو استخدم تنفيذ واجهة [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) المعروف أو المخصص كذاكرة مؤقتة لبيانات الإخراج. أنشئ كائنًا جديدًا من [`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/) بإعدادات محددة أو افتراضية. يمكنك أيضًا إضافة configuration كمعامل خيار. استخدم طريقة ConvertMHTML() في فئة Converter لحفظ MHTML كنتيجة DOCX مع ثلاثة أو أكثر من المعلمات حسب سيناريو المستخدم. محول MHTML عبر الإنترنت
...
تحويل مصدر MHTML المقدم عبر تدفق الإدخال. النتيجة هي ملف pdf تم إنشاؤه عبر مسار ملف الإخراج.
...
| --- | --- | --- |
| دفق | دفق | تدفق بيانات الإدخال للتحويل MHTML. |
| options | PdfSaveOptions | استخدام كائن [`PdfSaveOptions`](../../../com.aspose.html.saving/pdfsaveoptions/) يتيح لك ضبط عملية العرض. لمزيد من المعلومات راجع [توثيق Aspose](https://docs.aspose.com/html/net/converting-between-formats/mhtml-to-pdf/#save-options). |
...
غالبًا ما يكون تحويل MHTML إلى PDF مطلوبًا للاستفادة من تنسيق [PDF](https://docs.fileformat.com/pdf/) لمهام محددة. يتميز PDF بالعديد من الفوائد التي لا تتوفر في الملفات الأخرى. على سبيل المثال، تدعم العديد من البرامج والتطبيقات مستندات PDF؛ ملفات PDF مُحسّنة للطباعة، وهي مثالية لإنشاء نسخ مادية من مستنداتك؛ يمكنك تكوين إعدادات الأمان لملفات PDF - تعطيل الطباعة، التحرير، استخدام التوقيع الإلكتروني، إلخ.
...
تقدم فئة Converter عددًا قليلًا من التحويلات الخاصة بـ MHTML إلى PDF. لتحويل MHTML إلى PDF، يجب عليك اتباع أحد السيناريوهات البسيطة التي تتكون من بضع خطوات:

مصدر التحويل. اكتشف ملف MHTML (.mht) محلي موجود أو عنوان URL بعيد كمصدر للتحويل. يمكنك أيضًا استخدام [stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream?view=net-6.0) قياسي أو مخصص كمصدر. نتيجة التحويل. حدد مسار ملف الإخراج أو استخدم واجهة تنفيذ [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) المعروفة أو المخصصة كذاكرة مؤقتة لبيانات الإخراج. أنشئ كائنًا جديدًا من [`PdfSaveOptions`](../../../com.aspose.html.saving/pdfsaveoptions/) بإعدادات محددة أو افتراضية. يمكنك أيضًا إضافة [`configuration`](../../../com.aspose.html/configuration/) كمعامل اختياري. استخدم طريقة ConvertMHTML() في فئة Converter لحفظ MHTML كنتيجة PDF مع ثلاثة أو أكثر من المعلمات حسب سيناريو المستخدم. محول MHTML عبر الإنترنت

توفر Aspose.HTML أداة مجانية عبر الإنترنت [MHTML to PDF Converter](https://products.aspose.app/html/en/conversion/mhtml-to-pdf) تقوم بتحويل MHTML إلى PDF بجودة عالية، بسهولة وسرعة. ما عليك سوى تحميل ملفاتك، تحويلها والحصول على النتائج خلال بضع ثوانٍ!
...
تحويل مصدر MHTML المقدم بمسار ملف كامل إلى PDF. النتيجة هي ملف PDF تم تكوينه بواسطة مسار ملف الإخراج.
...
تحويل مصدر MHTML المقدم عبر URL. النتيجة هي ملف PDF تم تكوينه بواسطة مسار ملف الإخراج.
...
تحويل مصدر MHTML المقدم بمسار ملف كامل إلى PDF. النتيجة هي بيانات إخراج تم تشكيلها بواسطة تنفيذ واجهة [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/).
...
تحويل مصدر MHTML المقدم عبر تدفق الإدخال إلى صورة. النتيجة هي ملف صورة تم إنشاؤه عبر مسار ملف الإخراج.
...
الملفات ذات امتداد [MHTML](https://docs.fileformat.com/web/mhtml/) تمثل تنسيق أرشيف صفحات الويب الذي يمكن لعدد من التطبيقات المختلفة إنشاؤه. يُعرف هذا التنسيق كتنسيق أرشيف لأنه يحفظ كود HTML للويب والموارد المرتبطة به في ملف واحد. تشمل هذه الموارد أي شيء مرتبط بصفحة الويب مثل الصور، التطبيقات الصغيرة، الرسوم المتحركة، ملفات الصوت وما إلى ذلك. يمكن فتح ملفات MHTML في مجموعة متنوعة من التطبيقات مثل Internet Explorer وMicrosoft Word. يتم تفصيل مواصفات التنسيق الفعلية في [RFC 2557](https://datatracker.ietf.org/doc/html/rfc2557).
...
تقدم فئة Converter عددًا قليلًا من التحويلات الخاصة بـ MHTML إلى صور. الصيغ المدعومة هي [JPEG](https://docs.fileformat.com/image/jpeg/)، [PNG](https://docs.fileformat.com/image/png/)، [BMP](https://docs.fileformat.com/image/bmp/)، [GIF](https://docs.fileformat.com/image/gif/) و[TIFF](https://docs.fileformat.com/image/tiff/). لتحويل MHTML إلى صورة، يجب عليك اتباع أحد السيناريوهات البسيطة التي تتكون من بضع خطوات:

مصدر التحويل. اكتشف ملف MHTML (.mht) محلي موجود أو عنوان URL بعيد كمصدر للتحويل. يمكنك أيضًا استخدام [`Url`](../../../com.aspose.html/url/) قياسي أو مخصص كمصدر. نتيجة التحويل. حدد مسار ملف الإخراج أو استخدم واجهة تنفيذ [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) المعروفة أو المخصصة كذاكرة مؤقتة لبيانات الإخراج. أنشئ كائنًا جديدًا من [`ImageSaveOptions`](../../../com.aspose.html.saving/imagesaveoptions/) بإعدادات محددة أو افتراضية. الصيغة الافتراضية للصورة هي PNG. يمكنك أيضًا إضافة configuration كمعامل اختياري. استخدم طريقة ConvertMHTML() في فئة Converter لحفظ MHTML كنتيجة صورة مع ثلاثة أو أكثر من المعلمات حسب سيناريو المستخدم. محول MHTML عبر الإنترنت

توفر Aspose.HTML أداة مجانية عبر الإنترنت [MHTML to JPEG Converter](https://products.aspose.app/html/en/conversion/mhtml-to-jpg) تقوم بتحويل MHTML إلى ملف jpeg بجودة عالية، بسهولة وسرعة. ما عليك سوى تحميل ملفاتك، تحويلها والحصول على النتائج خلال بضع ثوانٍ!
...
تحويل مصدر MHTML المقدم عبر مسار ملف كامل. النتيجة هي ملف صورة تم إنشاؤه عبر مسار ملف الإخراج.
...
تحويل مصدر MHTML المقدم عبر URL. النتيجة هي ملف صورة تم تكوينه بواسطة مسار ملف الإخراج.
...
تحويل مصدر MHTML المقدم بمسار ملف كامل إلى صورة. النتيجة هي بيانات إخراج تم تشكيلها بواسطة تنفيذ واجهة [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/).
