...
description: "تعداد com.aspose.html.saving.HTMLSaveFormat. يحدد الصيغة التي يُحفظ بها المستند. يمكنك العثور على مزيد من المعلومات حول حفظ HTMLDocument في المقالة"
type: docs
