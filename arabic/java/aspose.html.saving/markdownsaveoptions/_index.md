---
title: "MarkdownSaveOptions فئة"
second_title: "مرجع API لـ Aspose.HTML for Java"
description: "الفئة com.aspose.html.saving.MarkdownSaveOptions. تمثل خيارات حفظ Markdown. على سبيل المثال يمكنك ضبط نمط تنسيق markdown باستخدام خيارات متوافقة مسبقًا مع GitLab Flavored Markdown وتكوين معالجة الموارد. راجع المزيد من المعلومات في المقال."
type: docs
...
| الاسم | الوصف |
| --- | --- |
| [MarkdownSaveOptions](markdownsaveoptions/)() | يُنشئ مثيلًا جديدًا من الفئة `MarkdownSaveOptions`. |
