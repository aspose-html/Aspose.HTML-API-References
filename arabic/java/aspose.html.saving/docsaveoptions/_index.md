...
فئة بيانات خيارات محددة. من خلال تعيين الخصائص يمكنك إدارة خصائص العرض مثل الدقة، حجم الصفحة، لون الخلفية بالإضافة إلى خيارات خاصة بالمستند مثل تضمين الخطوط. لمزيد من المعلومات راجع الوثائق في [article](https://docs.aspose.com/html/net/converting-between-formats/html-to-docx/#save-options).
...
...
 // جهّز مسارًا إلى ملف HTML المصدر
      ...
      // تهيئة DocSaveOptions. اضبط حجم الصفحة 600x400 بكسل والهوامش
