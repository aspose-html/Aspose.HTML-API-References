...
description: "الفئة com.aspose.html.saving.ImageSaveOptions. فئة بيانات خيارات محددة. توفر خصائص لإدارة دقة نتيجة الصورة، التنعيم، الجودة، الصيغة بالإضافة إلى إعدادات الصفحة وغيرها. يمكن الحصول على مزيد من المعلومات في مقالة الوثائق"
type: docs
...
فئة بيانات خيارات محددة. توفر خصائص لإدارة دقة صورة النتيجة، جودة التنعيم، الصيغة بالإضافة إلى إعدادات الصفحة وغيرها. يمكنك الحصول على مزيد من المعلومات في الوثائق [article](https://docs.aspose.com/html/net/converting-between-formats/html-to-jpg/#save-options).
