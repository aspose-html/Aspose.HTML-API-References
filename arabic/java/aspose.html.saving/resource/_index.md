...
| الاسم | الوصف |
| --- | --- |
| [embed](../../com.aspose.html.saving/resource/embed/)(ResourceHandlingContext) | يضم هذا المورد داخل العنصر الأب عن طريق ترميزه كـ Base64. سيتم كتابة نتيجة الترميز إلى [`OutputUrl`](./outputurl/). |
