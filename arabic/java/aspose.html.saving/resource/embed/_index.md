...
description: "طريقة Resource. تُضمّن هذا المورد داخل العنصر الأصلي عن طريق ترميزه كـBase64. سيتم كتابة نتيجة الترميز إلى OutputUrl"
type: docs
...
تُضمّن هذا المورد داخل العنصر الأصلي عن طريق ترميزه كـBase64. سيتم كتابة نتيجة الترميز إلى [`OutputUrl`](../outputurl/).
