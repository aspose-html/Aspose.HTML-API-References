...
description: "الفئة com.aspose.html.saving.SaveOptions. هذه فئة أساسية مجردة للفئات التي تسمح للمستخدم بتحديد خيارات إضافية عند حفظ مستند بتنسيق معين"
type: docs

url: /ar/java/com.aspose.html.saving/saveoptions/
---
## SaveOptions class
