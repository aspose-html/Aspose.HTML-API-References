...
description: "الفئة com.aspose.html.saving.PdfSaveOptions. فئة البيانات المحددة توفر عددًا قليلاً من الخصائص لإدارة نتيجة التحويل. على سبيل المثال، PageSetup يحدد خصائص الصفحة. راجع مقالة الوثائق."
type: docs
...
فئة البيانات المحددة توفر عددًا قليلًا من الخصائص لإدارة نتيجة التحويل. على سبيل المثال [`PageSetup`](../../com.aspose.html.rendering/pagesetup/) يحدد خصائص الصفحة. راجع وثائق [مقالة](https://docs.aspose.com/html/net/converting-between-formats/html-to-pdf/#convert-html-to-pdf-using-pdfsaveoptions).
