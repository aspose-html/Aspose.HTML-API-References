...
description: "طريقة Path2D. تُضيف إهليلجًا إلى المسار يتمركز عند إحداثيات x y بنصف القطر radiusX و radiusY يبدأ عند startAngle وينتهي عند endAngle ويتجه في الاتجاه المحدد عكس عقارب الساعة مع الافتراضية باتجاه عقارب الساعة"
type: docs
