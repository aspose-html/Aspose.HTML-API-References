...
description: "طريقة Path2D. تضيف قوسًا إلى المسار يكون مركزه عند إحداثيات x y بنصف قطر r يبدأ عند startAngle وينتهي عند endAngle تتحرك في الاتجاه المحدد عكس اتجاه عقارب الساعة مع الافتراضية باتجاه عقارب الساعة"
type: docs

url: /ar/java/com.aspose.html.dom.canvas/path2d/arc/
---
