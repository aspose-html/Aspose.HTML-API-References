...
description: "الفئة com.aspose.html.rendering.image.ImageDevice. تمثل عملية التصيير إلى تنسيقات نقطية jpeg png bmp gif tiff"
type: docs
...
يمثل العرض إلى صيغ نقطية: jpeg، png، bmp، gif، tiff.
...
| الاسم | الوصف |
| --- | --- |
| class [ImageGraphicContext](../../com.aspose.html.rendering.image/imagedevice.imagegraphiccontext) | يحتفظ بمعلمات التحكم الرسومية الحالية لـ `ImageDevice`. تُعرّف هذه المعلمات الإطار العالمي الذي تُنفّذ فيه عمليات الرسوميات. |
