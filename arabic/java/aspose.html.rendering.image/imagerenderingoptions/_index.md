...
description: "الفئة com.aspose.html.rendering.image.ImageRenderingOptions. تمثّل خيارات التصيير لـ ImageDevice. تُستخدم هذه الخيارات لتحديد تنسيق الصورة الناتجة، الضغط، الدقة، إلخ"
type: docs
...
تمثّل خيارات التصيير لـ [`ImageDevice`](../imagedevice/). تُستخدم هذه الخيارات لتحديد تنسيق الصورة الناتجة، الضغط، الدقة، إلخ.
...
| الاسم | الوصف |
| --- | --- |
| [ImageRenderingOptions](imagerenderingoptions/#constructor)() | يُنشئ مثيلاً جديدًا لفئة `ImageRenderingOptions`؛ سيُستخدم PNG كتنسيق صورة افتراضي. |
| [ImageRenderingOptions](imagerenderingoptions/#constructor_1)(ImageFormat) | يُنشئ مثيلاً جديدًا لفئة `ImageRenderingOptions` بالتنسيق الصورة المحدد. |
