...
description: "فئة com.aspose.html.dom.svg.datatypes.SVGAnimatedTransformList. تُستخدم للسمات المختلفة التي تحدد مجموعة من التحويلات مثل سمة transform المتاحة للعديد من عناصر SVG والتي يمكن تحريكها"
type: docs

url: /ar/java/com.aspose.html.dom.svg.datatypes/svganimatedtransformlist/
---
## SVGAnimatedTransformList class

يُستخدم للسمات المتنوعة التي تحدد مجموعة من التحويلات، مثل السمة ‘transform’ المتوفرة للعديد من عناصر SVG، والتي يمكن تحريكها.
...
| [toString](../../com.aspose.html.dom.svg.datatypes/svganimatedtransformlist/toString/)() | يعيد سلسلة تمثل هذا الكائن. |
