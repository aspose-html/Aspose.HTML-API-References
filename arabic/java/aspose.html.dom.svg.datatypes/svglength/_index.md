...
description: "فئة com.aspose.html.dom.svg.datatypes.SVGLength. واجهة SVGLength تتطابق مع نوع البيانات الأساسي للطول. يمكن تعيين كائن SVGLength كقراءة فقط مما يعني أن محاولات تعديل الكائن ستؤدي إلى رمي استثناء كما هو موضح أدناه"
type: docs
...
واجهة SVGLength تتطابق مع نوع البيانات الأساسي للطول. يمكن تعيين كائن SVGLength كقراءة فقط، مما يعني أن محاولات تعديل الكائن ستؤدي إلى رمي استثناء، كما هو موضح أدناه.
...
| الاسم | الوصف |
| --- | --- |
| [getUnitType](../../com.aspose.html.dom.svg.datatypes/svglength/unittype/) نوع القيمة كما هو محدد بأحد الثوابت SVG_LENGTHTYPE_* المعرفة في هذه الواجهة. |
[getValue]
...
| [newValueSpecifiedUnits](../../com.aspose.html.dom.svg.datatypes/svglength/newvaluespecifiedunits/)(ushort, float) | أعد تعيين القيمة كعدد مع unitType مرتبط، وبالتالي استبدال القيم لجميع السمات على الكائن. |
| [toString](../../com.aspose.html.dom.svg.datatypes/svglength/toString/)() | يعيد سلسلة تمثل هذا الكائن. |
...
| const [SVG_LENGTHTYPE_PERCENTAGE](../../com.aspose.html.dom.svg.datatypes/svglength/svg_lengthtype_percentage/) | تم تحديد قيمة كنسبة مئوية. |
...
| const [SVG_LENGTHTYPE_UNKNOWN](../../com.aspose.html.dom.svg.datatypes/svglength/svg_lengthtype_unknown/) | نوع الوحدة ليس أحد أنواع الوحدات المعرفة مسبقًا. من غير الصالح محاولة تعريف قيمة جديدة من هذا النوع أو محاولة تحويل قيمة موجودة إلى هذا النوع. |
