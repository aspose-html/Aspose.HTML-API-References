...
description: "طريقة MarkdownSyntaxFactory. ينشئ AutoLinkSyntaxNode"
type: docs

url: /ar/java/com.aspose.html.toolkit.markdown.syntax/markdownsyntaxfactory/autolink/
---
## AutoLink(MarkdownSyntaxToken, TextSyntaxNode, MarkdownSyntaxToken) {#autolink}

ينشئ [`AutoLinkSyntaxNode`](../../autolinksyntaxnode/).
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| opening | MarkdownSyntaxToken | الـ MarkdownSyntaxToken. |
| المحتوى | TextSyntaxNode | الـ TextSyntax. |
| closing | MarkdownSyntaxToken | الـ MarkdownSyntaxToken. |
