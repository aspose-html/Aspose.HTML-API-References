...
description: "طريقة MarkdownSyntaxFactory. ينشئ FencedCodeBlockSyntaxNode"
type: docs

url: /ar/java/com.aspose.html.toolkit.markdown.syntax/markdownsyntaxfactory/fencedcodeblock/
---
## FencedCodeBlock(MarkdownSyntaxToken, TextSyntaxNode) {#fencedcodeblock}

ينشئ [`FencedCodeBlockSyntaxNode`](../../fencedcodeblocksyntaxnode/).
...
| معلومات | TextSyntaxNode | الـ TextSyntax. |

### قيمة الإرجاع

ال FencedCodeBlockSyntax.
