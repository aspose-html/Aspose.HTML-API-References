...
description: "طريقة MarkdownSyntaxFactory. ينشئ TextSyntaxNode"
type: docs

url: /ar/java/com.aspose.html.toolkit.markdown.syntax/markdownsyntaxfactory/escapedcharacter/
---
## EscapedCharacter(char) {#escapedcharacter_1}

ينشئ [`TextSyntaxNode`](../../textsyntaxnode/).
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| escapedChar | حرف | الـ escapedChar. |
