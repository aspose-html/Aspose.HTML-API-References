...
description: "طريقة MarkdownSyntaxFactory. ينشئ ListItemMarker"
type: docs

url: /ar/java/com.aspose.html.toolkit.markdown.syntax/markdownsyntaxfactory/listitemmarker/
---
## ListItemMarker(MarkdownSyntaxToken, MarkdownSyntaxToken) {#listitemmarker_1}

ينشئ [`ListItemMarker`](../../listitemmarker/).
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| رقم | MarkdownSyntaxToken | الرقم. |
| الفاصل | MarkdownSyntaxToken | الفاصل. |

### قيمة الإرجاع

علامة ListItemMarker.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| الرمز | MarkdownSyntaxToken | الرمز. |
