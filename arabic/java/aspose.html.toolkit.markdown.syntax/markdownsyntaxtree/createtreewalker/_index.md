...
description: "طريقة MarkdownSyntaxTree. تُعرّف الواجهة لإنشاء متجول الشجرة"
type: docs

url: /ar/java/com.aspose.html.toolkit.markdown.syntax/markdownsyntaxtree/createtreewalker/
---
## CreateTreeWalker(MarkdownSyntaxNodeFilter) {#createtreewalker_2}

يحدد الواجهة لإنشاء متجول الشجرة.
