...
description: "طريقة WebAccessibility. يتم إنشاء مثيل AccessibilityValidator لقاعدة محددة مع توفير جميع معلمات كائن ValidationBuilder.All"
type: docs

url: /ar/java/com.aspose.html.accessibility/webaccessibility/createvalidator/
---
## CreateValidator(IRule) {#createvalidator_1}

يتم إنشاء نسخة من AccessibilityValidator لقاعدة محددة، مع إعطاء جميع معلمات كائن ValidationBuilder.All.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قاعدة | IRule | كائن القاعدة الذي يطبق واجهة IRule |

### قيمة الإرجاع

كائن AccessibilityValidator
...
إنشاء نسخة من AccessibilityValidator
...
| --- | --- | --- |
| قاعدة | IRule | كائن القاعدة الذي يطبق واجهة IRule |
| الباني | ValidationBuilder | كائن ValidationBuilder |
...
| --- | --- | --- |
| قاعدة | IRule | كائن القاعدة الذي يطبق واجهة IRule |
| الباني | Action`1 | طريقة تُعيد كائن ValidationBuilder |
...
يتم إنشاء نسخة من AccessibilityValidator وفقًا لجميع القواعد باستخدام كائن ValidationBuilder.All.
...
يتم إنشاء نسخة من AccessibilityValidator لقائمة قواعد محددة.
