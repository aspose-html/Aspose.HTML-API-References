...
description: "طريقة Renderer. تحدد طريقة لتصيير TDocument إلى IDevice المحدد"
type: docs
...
يحدد طريقة لتصيير !:TDocument إلى [`IDevice`](../../idevice/) المحدد.
...
يحدد طريقة لتصيير !:TDocument إلى [`IDevice`](../../idevice/) المحدد. سيتم تنفيذ التصيير بمجرد عدم وجود أي عمليات شبكة لتحميل الموارد، أو مؤقتات نشطة، أو مهام رسوم متحركة أو انتهاء المهلة المحددة.
...
| الجهاز | IDevice | جهاز الإخراج. |
| مستند | TSource | المستند. |
| مهلة | Int32 | عدد من المللي ثانية يمثل عدد المللي ثانية للانتظار، أو -1 مللي ثانية للانتظار إلى ما لا نهاية. |
