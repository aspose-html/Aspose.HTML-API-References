---
title: "فئة HTMLLegendElement"
second_title: "مرجع API لـ Aspose.HTML للـ Java"
description: "فئة com.aspose.html.HTMLLegendElement. يوفر تسمية توضيحية لتجميع FIELDSET. راجع تعريف العنصر LEGEND في HTML 4.01"
type: docs

url: /ar/java/com.aspose.html/htmllegendelement/
---
## HTMLLegendElement class

يوفر تسمية لمجموعة `FIELDSET`. راجع تعريف العنصر LEGEND في HTML 4.01.
...
| [getForm](../../com.aspose.html/htmllegendelement/form/) يرجع العنصر `FORM` الذي يحتوي على هذا التحكم. يرجع `null` إذا لم يكن هذا التحكم ضمن سياق نموذج. |
[getId]
