...
description: "فئة com.aspose.html.HTMLInputElement. عنصر تحكم في النموذج. اعتمادًا على البيئة التي تُعرض فيها الصفحة قد تكون خاصية القيمة للنوع file upload للمدخل للقراءة فقط. بالنسبة لنوع مدخل كلمة المرور قد يتم إخفاء القيمة الفعلية لمنع الاستخدام غير المصرح به. راجع تعريف العنصر INPUT في HTML 4.01. راجع أيضًا مواصفة Document object Model DOM Level 2 HTML."
type: docs
...
| [getFiles](../../com.aspose.html/htmlinputelement/files/) سمة IDL للملفات تسمح للسكريبتات بالوصول إلى الملفات المختارة للعنصر. عند الاستدعاء، إذا كانت سمة IDL تنطبق، يجب أن تُعيد كائن FileList يمثل الملفات المختارة حاليًا. يجب إرجاع نفس الكائن حتى يتغير قائمة الملفات المختارة. إذا لم تنطبق سمة IDL، يجب إرجاع null بدلاً من ذلك. [FILEAPI] |
