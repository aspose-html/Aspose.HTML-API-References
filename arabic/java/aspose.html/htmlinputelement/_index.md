---
title: "فئة HTMLInputElement"
second_title: "مرجع API لـ Aspose.HTML للـ Java"
description: "فئة com.aspose.html.HTMLInputElement. عنصر تحكم في النموذج. اعتماداً على البيئة التي تُعرض فيها الصفحة قد تكون خاصية القيمة للنوع file upload للمدخل للقراءة فقط. بالنسبة لنوع مدخل كلمة المرور قد يتم إخفاء القيمة الفعلية التي تُرجع لمنع الاستخدام غير المصرح به. راجع تعريف العنصر INPUT في HTML 4.01. راجع أيضاً مواصفات نموذج كائن المستند DOM Level 2 HTML."
type: docs

url: /ar/java/com.aspose.html/htmlinputelement/
---
## HTMLInputElement class

عنصر تحكم في النموذج. اعتمادًا على البيئة التي يُعرض فيها الصفحة، قد تكون خاصية القيمة read-only لنوع إدخال رفع الملف. بالنسبة لنوع الإدخال \"password\"، قد يتم إخفاء القيمة الفعلية لمنع الاستخدام غير المصرح به. راجع تعريف العنصر INPUT في [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224)]. انظر أيضًا إلى [Document object Model (DOM) Level 2 HTML Specification](http://www.w3.org/TR/2003/REC-DOM-Level-2-HTML-20030109).
...
| [getFiles](../../com.aspose.html/htmlinputelement/files/) سمة IDL للملفات تسمح للسكريبتات بالوصول إلى الملفات المختارة للعنصر. عند الحصول، إذا كانت سمة IDL تنطبق، يجب أن تُرجع كائن FileList يمثل الملفات المختارة حالياً. يجب إرجاع نفس الكائن حتى يتغير قائمة الملفات المختارة. إذا لم تنطبق سمة IDL، يجب إرجاع null بدلاً من ذلك. [FILEAPI] |
