...
description: "الفئة com.aspose.html.HTMLBodyElement. جسم مستند HTML. هذا العنصر موجود دائمًا في واجهة DOM API حتى إذا لم تكن العلامات موجودة في المستند الأصلي. راجع تعريف عنصر BODY في HTML 4.01"
type: docs
