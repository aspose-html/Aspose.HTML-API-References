---
title: "فئة HTMLBodyElement"
second_title: "مرجع API لـ Aspose.HTML for Java"
description: "فئة com.aspose.html.HTMLBodyElement. جسم مستند HTML. هذا العنصر موجود دائمًا في واجهة برمجة تطبيقات DOM حتى إذا لم تكن الوسوم موجودة في المستند الأصلي. راجع تعريف عنصر BODY في HTML 4.01"
type: docs

url: /ar/java/com.aspose.html/htmlbodyelement/
---
## HTMLBodyElement class

جسم مستند HTML. هذا العنصر موجود دائمًا في واجهة DOM API، حتى إذا لم تكن الوسوم موجودة في مستند المصدر. راجع تعريف العنصر BODY في HTML 4.01.
