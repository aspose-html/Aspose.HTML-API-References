...
description: "com.aspose.html.HTMLTextAreaElement class. حقل نص متعدد الأسطر. راجع تعريف عنصر TEXTAREA في HTML 4.01"
type: docs
...
| [getForm](../../com.aspose.html/htmltextareaelement/form/) يعيد عنصر `FORM` الذي يحتوي على هذا التحكم. يعيد `null` إذا لم يكن هذا التحكم ضمن سياق نموذج. |
[getId]
