---
title: "فئة HTMLFieldSetElement"
second_title: "مرجع API لـ Aspose.HTML للـ Java"
description: "الفئة com.aspose.html.HTMLFieldSetElement. تنظم عناصر التحكم في النموذج في مجموعات منطقية. راجع تعريف العنصر FIELDSET في HTML 4.01"
type: docs

url: /ar/java/com.aspose.html/htmlfieldsetelement/
---
## HTMLFieldSetElement class

ينظم عناصر التحكم في النموذج في مجموعات منطقية. راجع تعريف العنصر FIELDSET في HTML 4.01.
...
| [getForm](../../com.aspose.html/htmlfieldsetelement/form/) يُرجِع العنصر `FORM` الذي يحتوي على هذا التحكم. يُرجِع `null` إذا لم يكن هذا التحكم ضمن سياق نموذج. |
[getId]
