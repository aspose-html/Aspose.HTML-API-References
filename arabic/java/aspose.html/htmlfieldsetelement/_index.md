...
description: "فئة com.aspose.html.HTMLFieldSetElement. تنظم عناصر التحكم في النموذج في مجموعات منطقية. راجع تعريف العنصر FIELDSET في HTML 4.01"
type: docs
...
ينظم عناصر التحكم في النماذج في مجموعات منطقية. راجع تعريف العنصر FIELDSET في HTML 4.01.
...
| [getForm](../../com.aspose.html/htmlfieldsetelement/form/) يُعيد العنصر `FORM` الذي يحتوي على هذا التحكم. يُعيد `null` إذا لم يكن هذا التحكم ضمن سياق نموذج. |
[getId]
