...
description: "الفئة com.aspose.html.HTMLIsIndexElement. يُستخدم هذا العنصر لإدخال نص سطر واحد. راجع تعريف عنصر ISINDEX في HTML 4.01. هذا العنصر مهمل في HTML 4.01"
type: docs
...
يُستخدم هذا العنصر لإدخال نص سطر واحد. راجع تعريف العنصر ISINDEX في HTML 4.01. هذا العنصر مهمل في HTML 4.01.
...
| [getForm](../../com.aspose.html/htmlisindexelement/form/) يُعيد الـ |
[getId]
