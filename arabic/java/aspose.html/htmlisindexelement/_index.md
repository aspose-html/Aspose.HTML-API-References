---
title: "فئة HTMLIsIndexElement"
second_title: "مرجع API لـ Aspose.HTML for Java"
description: "فئة com.aspose.html.HTMLIsIndexElement. يُستخدم هذا العنصر لإدخال نص سطر واحد. راجع تعريف عنصر ISINDEX في HTML 4.01. هذا العنصر مهمل في HTML 4.01"
type: docs

url: /ar/java/com.aspose.html/htmlisindexelement/
---
## HTMLIsIndexElement class

يُستخدم هذا العنصر لإدخال نص أحادي السطر. راجع تعريف العنصر ISINDEX في HTML 4.01. هذا العنصر مهمل في HTML 4.01.
...
| [getForm](../../com.aspose.html/htmlisindexelement/form/) يعيد الـ |
[getId]
