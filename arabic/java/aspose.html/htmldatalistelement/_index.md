---
title: "HTMLDataListElement فئة"
second_title: "مرجع API لـ Aspose.HTML للـ Java"
description: "com.aspose.html.HTMLDataListElement فئة. عنصر datalist يمثل مجموعة من عناصر option التي تمثل خيارات مسبقة التعريف لعناصر تحكم أخرى. راجع أيضًا توصية W3C HTML 5.2"
type: docs

url: /ar/java/com.aspose.html/htmldatalistelement/
---
## HTMLDataListElement class

العنصر datalist يمثل مجموعة من عناصر option التي تمثل خيارات مسبقة التعريف لعناصر التحكم الأخرى. انظر أيضًا إلى [HTML 5.2 W3C Recommendation](https://www.w3.org/TR/html52/sec-forms.html#elementdef-datalist).
...
| [getOptions](../../com.aspose.html/htmldatalistelement/options/) مجموعة عناصر `OPTION` الموجودة داخل هذا العنصر. |
[getOuterHTML]
