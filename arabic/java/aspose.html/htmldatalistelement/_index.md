...
description: "com.aspose.html.HTMLDataListElement class. عنصر datalist يمثل مجموعة من عناصر option التي تمثل خيارات مسبقة التعريف لعناصر تحكم أخرى. راجع أيضًا توصية W3C HTML 5.2"
type: docs
...
العنصر datalist يمثل مجموعة من عناصر option التي تمثل خيارات مسبقة التعريف لعناصر تحكم أخرى. راجع أيضًا [توصية W3C HTML 5.2](https://www.w3.org/TR/html52/sec-forms.html#elementdef-datalist).
