---
title: "HTMLButtonElement فئة"
second_title: "مرجع API لـ Aspose.HTML for Java"
description: "com.aspose.html.HTMLButtonElement فئة. زر ضغط. راجع تعريف عنصر BUTTON في HTML 4.01"
type: docs
...
| [getForm](../../com.aspose.html/htmlbuttonelement/form/) يُرجع عنصر `FORM` الذي يحتوي على هذا التحكم. يُرجع `null` إذا لم يكن هذا التحكم ضمن سياق نموذج. |
[getId]
