...
description: "فئة com.aspose.html.HTMLCanvasElement. توفر واجهة HTMLCanvasElement خصائص وطرق للتلاعب بتخطيط وعرض عناصر canvas. كما ترث واجهة HTMLCanvasElement خصائص وطرق واجهة HTMLElement."
type: docs
...
توفر واجهة HTMLCanvasElement الخصائص والطرق للتلاعب بتخطيط وعرض عناصر الـ canvas. كما ترث واجهة HTMLCanvasElement الخصائص والطرق من واجهة HTMLElement.
...
| [getContext](../../com.aspose.html/htmlcanvaselement/getcontext/)(String) | تُرجع سياق رسم على الـ canvas، أو null إذا لم يكن معرف السياق مدعومًا. يسمح لك سياق الرسم بالرسم على الـ canvas. |
...
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl)() | تُرجع URI بيانات يحتوي على تمثيل للصورة بالتنسيق المحدد بواسطة معامل النوع (الافتراضي PNG). الصورة المرجعة بدقة 96 نقطة في البوصة. |
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl_1)(String) | تُرجع URI بيانات يحتوي على تمثيل للصورة بالتنسيق المحدد بواسطة معامل النوع (الافتراضي PNG). الصورة المرجعة بدقة 96 نقطة في البوصة. |
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl_2)(String, double) | تُرجع URI بيانات يحتوي على تمثيل للصورة بالتنسيق المحدد بواسطة معامل النوع (الافتراضي PNG). الصورة المرجعة بدقة 96 نقطة في البوصة. |
