---
title: "فئة HTMLCanvasElement"
second_title: "مرجع API لـ Aspose.HTML for Java"
description: "فئة com.aspose.html.HTMLCanvasElement. توفر واجهة HTMLCanvasElement خصائص وطرق للتعامل مع تخطيط وعرض عناصر canvas. كما ترث واجهة HTMLCanvasElement خصائص وطرق واجهة HTMLElement."
type: docs

url: /ar/java/com.aspose.html/htmlcanvaselement/
---
## HTMLCanvasElement class

توفر واجهة HTMLCanvasElement الخصائص والطرق للتعامل مع تخطيط وعرض عناصر canvas. كما ترث واجهة HTMLCanvasElement الخصائص والطرق من واجهة HTMLElement.
...
| [getContext](../../com.aspose.html/htmlcanvaselement/getcontext/)(String) | تُرجع سياق رسم على الـ canvas، أو null إذا لم يكن معرف السياق مدعومًا. يتيح لك سياق الرسم الرسم على الـ canvas. |
...
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl)() | تُرجع URI بيانات يحتوي على تمثيل الصورة بالتنسيق المحدد بواسطة معامل النوع (الافتراضي PNG). الصورة المُرجعة بدقة 96 نقطة في البوصة. |
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl_1)(String) | تُرجع URI بيانات يحتوي على تمثيل الصورة بالتنسيق المحدد بواسطة معامل النوع (الافتراضي PNG). الصورة المُرجعة بدقة 96 نقطة في البوصة. |
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl_2)(String, double) | تُرجع URI بيانات يحتوي على تمثيل الصورة بالتنسيق المحدد بواسطة معامل النوع (الافتراضي PNG). الصورة المُرجعة بدقة 96 نقطة في البوصة. |
