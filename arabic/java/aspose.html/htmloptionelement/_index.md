---
title: "الفئة HTMLOptionElement"
second_title: "مرجع API لـ Aspose.HTML للـ Java"
description: "الفئة com.aspose.html.HTMLOptionElement. خيار قابل للاختيار. راجع تعريف العنصر OPTION في HTML 4.01"
type: docs

url: /ar/java/com.aspose.html/htmloptionelement/
---
## HTMLOptionElement class

خيار قابل للتحديد. راجع تعريف العنصر OPTION في HTML 4.01.
...
| [getForm](../../com.aspose.html/htmloptionelement/form/) يُرجع العنصر `FORM` الذي يحتوي على هذا التحكم. يُرجع `null` إذا لم يكن هذا التحكم داخل سياق نموذج. |
[getId]
[setId] The element's identifier. See the id attribute definition in HTML 4.01. |
| [getIndex](../../com.aspose.html/htmloptionelement/index/) الفهرس لهذا `OPTION` في العنصر الأب `SELECT`، يبدأ من 0. @version DOM Level 2 |
[getInnerHTML]
...
| [getText](../../com.aspose.html/htmloptionelement/text/) النص الموجود داخل عنصر الخيار. |
