---
title: "HTMLOptionElement فئة"
second_title: "مرجع API لـ Aspose.HTML for Java"
description: "com.aspose.html.HTMLOptionElement فئة. خيار قابل للاختيار. راجع تعريف عنصر OPTION في HTML 4.01"
type: docs
...
| [getForm](../../com.aspose.html/htmloptionelement/form/) يُرجع عنصر `FORM` الذي يحتوي على هذا التحكم. يُرجع `null` إذا لم يكن هذا التحكم ضمن سياق نموذج. |
[getId]
...
| [getText](../../com.aspose.html/htmloptionelement/text/) النص الموجود داخل عنصر OPTION. |
