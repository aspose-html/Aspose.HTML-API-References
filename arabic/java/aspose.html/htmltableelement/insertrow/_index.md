...
description: "طريقة HTMLTableElement. أدخل صفًا جديدًا فارغًا في الجدول. يُدرج الصف الجديد مباشرةً قبل الصف الحالي في الفهرس نفسه وفي نفس القسم داخل الجدول. إذا كان الفهرس -1 أو يساوي عدد الصفوف، يُضاف الصف الجديد في النهاية. بالإضافة إلى ذلك، عندما يكون الجدول فارغًا يُدرج الصف في TBODY يتم إنشاؤه وإدراجه في الجدول. لا يمكن أن يكون صف الجدول فارغًا وفقًا لـ HTML 4.01"
type: docs
