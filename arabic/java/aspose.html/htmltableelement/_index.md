---
title: "الفئة HTMLTableElement"
second_title: "مرجع API لـ Aspose.HTML for Java"
description: "الفئة com.aspose.html.HTMLTableElement. تسمح طرق الإنشاء والحذف على الجدول للمؤلفين بإنشاء الجداول وتعديلها. يحدد HTML 4.01 أن كل من عناصر CAPTION و THEAD و TFOOT يمكن أن توجد مرة واحدة فقط في الجدول. لذلك إذا كان أحدها موجودًا وتم استدعاء طريقة createTHead أو createTFoot، تُعيد الطريقة العنصر THead أو TFoot الموجود. راجع تعريف عنصر TABLE في HTML 4.01"
type: docs

url: /ar/java/com.aspose.html/htmltableelement/
---
## HTMLTableElement class

طرق create* و delete* على الجدول تسمح للمؤلفين بإنشاء وتعديل الجداول. [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224)] يحدد أنه يمكن أن يكون هناك عنصر واحد فقط من كل من عناصر `CAPTION` و `THEAD` و `TFOOT` في الجدول. لذلك، إذا كان أحدها موجودًا، وتم استدعاء طريقة createTHead() أو createTFoot()، فإن الطريقة تُعيد عنصر THead أو TFoot الموجود. راجع تعريف العنصر TABLE في HTML 4.01.
...
| [getCaption](../../com.aspose.html/htmltableelement/caption/) يعيد `CAPTION` الخاص بالجدول، أو لا شيء إذا لم يكن موجودًا. @version DOM Level 2 |
[getCellPadding]
...
| [getRows](../../com.aspose.html/htmltableelement/rows/) يعيد `TFOOT` الخاص بالجدول، أو `null` إذا لم يكن موجودًا. |
[getRules]
...
| [getTBodies](../../com.aspose.html/htmltableelement/tbodies/) يعيد مجموعة من أجسام الجدول (بما في ذلك الضمنية). |
...
| [getTFoot](../../com.aspose.html/htmltableelement/tfoot/) يعيد `THEAD` الخاص بالجدول، أو `null` إذا لم يكن موجودًا. |
| [getTHead](../../com.aspose.html/htmltableelement/thead/) يعيد `CAPTION` الخاص بالجدول، أو لا شيء إذا لم يكن موجودًا. |
[getTitle]
...
| [createCaption](../../com.aspose.html/htmltableelement/createcaption/)() | إنشاء كائن توضيح جدول جديد أو إرجاع كائن موجود. |
| [createTFoot](../../com.aspose.html/htmltableelement/createtfoot/)() | إنشاء صف تذييل جدول أو إرجاع صف موجود. |
| [createTHead](../../com.aspose.html/htmltableelement/createthead/)() | إنشاء صف رأس جدول أو إرجاع صف موجود. |
| [deleteCaption](../../com.aspose.html/htmltableelement/deletecaption/)() | حذف توضيح الجدول إذا كان موجودًا. |
| [deleteRow](../../com.aspose.html/htmltableelement/deleterow/)(int) | حذف صف جدول. |
| [deleteTFoot](../../com.aspose.html/htmltableelement/deletetfoot/)() | حذف التذييل من الجدول إذا كان موجودًا. |
| [deleteTHead](../../com.aspose.html/htmltableelement/deletethead/)() | حذف الرأس من الجدول إذا كان موجودًا. |
