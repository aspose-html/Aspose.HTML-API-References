---
title: "فئة HTMLTableElement"
second_title: "مرجع API لـ Aspose.HTML للـ Java"
description: "الفئة com.aspose.html.HTMLTableElement. تسمح طرق الإنشاء والحذف على الجدول للمؤلفين بإنشاء وتعديل الجداول. يحدد HTML 4.01 أن كل عنصر من عناصر CAPTION وTHEAD وTFOOT يمكن أن يوجد مرة واحدة فقط في الجدول. لذلك إذا كان أحدها موجودًا وتم استدعاء طريقة createTHead أو createTFoot، فإن الطريقة تُعيد عنصر THead أو TFoot الموجود. راجع تعريف عنصر TABLE في HTML 4.01"
type: docs
...
طرق create* و delete* على الجدول تسمح للمؤلفين بإنشاء وتعديل الجداول. [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224)] يحدد أنه يمكن أن يوجد عنصر واحد فقط من كل من عناصر `CAPTION` و `THEAD` و `TFOOT` في الجدول. لذلك، إذا كان أحدها موجودًا، وتم استدعاء طريقة createTHead() أو createTFoot()، فإن الطريقة تُعيد عنصر THead أو TFoot الموجود. راجع تعريف العنصر TABLE في HTML 4.01.
...
| [getCaption](../../com.aspose.html/htmltableelement/caption/) يرجع `CAPTION` الخاص بالجدول، أو void إذا لم يكن موجودًا. @version DOM Level 2 |
[getCellPadding]
...
| [getRows](../../com.aspose.html/htmltableelement/rows/) يرجع `TFOOT` الخاص بالجدول، أو `null` إذا لم يكن موجودًا. |
[getRules]
...
| [getTBodies](../../com.aspose.html/htmltableelement/tbodies/) يرجع مجموعة من أجسام الجدول (بما في ذلك الضمنية). |
...
| [getTFoot](../../com.aspose.html/htmltableelement/tfoot/) يرجع `THEAD` الخاص بالجدول، أو `null` إذا لم يكن موجودًا. |
| [getTHead](../../com.aspose.html/htmltableelement/thead/) يرجع `CAPTION` الخاص بالجدول، أو void إذا لم يكن موجودًا. |
[getTitle]
...
| [createCaption](../../com.aspose.html/htmltableelement/createcaption/)() | إنشاء كائن CAPTION جدول جديد أو إرجاع كائن موجود. |
