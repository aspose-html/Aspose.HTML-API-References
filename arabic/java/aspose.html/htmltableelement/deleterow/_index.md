...
| معامل | نوع | الوصف |
| --- | --- | --- |
| index | Int32 | فهرس الصف الذي سيتم حذفه. يبدأ هذا الفهرس من 0 وهو نسبي للترتيب المنطقي (ليس ترتيب المستند) لجميع الصفوف الموجودة داخل الجدول. إذا كان الفهرس -1 يتم حذف آخر صف في الجدول. |
