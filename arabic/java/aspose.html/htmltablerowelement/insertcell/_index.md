...
description: "طريقة HTMLTableRowElement. إدراج خلية TD فارغة في هذا الصف. إذا كان index يساوي -1 أو يساوي عدد الخلايا، يتم إلحاق الخلية الجديدة."
type: docs
...
| استثناء | شرط |
| --- | --- |
| [dOMException](../../../com.aspose.html.dom/domexception/) | INDEX_SIZE_ERR: يُرفع إذا كان `index` المحدد أكبر من عدد الخلايا أو إذا كان index رقمًا سالبًا غير -1. @version DOM Level 2 |
