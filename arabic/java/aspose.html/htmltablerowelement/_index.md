---
title: "فئة HTMLTableRowElement"
second_title: "مرجع API لـ Aspose.HTML للـ Java"
description: "فئة com.aspose.html.HTMLTableRowElement. صف في جدول. راجع تعريف العنصر TR في HTML 4.01"
type: docs

url: /ar/java/com.aspose.html/htmltablerowelement/
---
## HTMLTableRowElement class

صف في جدول. راجع تعريف العنصر TR في HTML 4.01.
...
| [getCells](../../com.aspose.html/htmltablerowelement/cells/) مجموعة الخلايا في هذا الصف. @version DOM Level 2 |
[getCh]
...
| [getRowIndex](../../com.aspose.html/htmltablerowelement/rowindex/) هذا بترتيب منطقي وليس بترتيب المستند. يأخذ `rowIndex` في الاعتبار الأقسام (`THEAD`، `TFOOT`، أو `TBODY`) داخل الجدول، حيث يضع صفوف `THEAD` أولاً في الفهرس، تليها صفوف `TBODY`، ثم صفوف `TFOOT`. @version DOM Level 2 |
| [getSectionRowIndex](../../com.aspose.html/htmltablerowelement/sectionrowindex/) فهرس هذا الصف، بالنسبة إلى القسم الحالي (`THEAD`، `TFOOT`، أو `TBODY`)، يبدأ من 0. @version DOM Level 2 |
...
| [deleteCell](../../com.aspose.html/htmltablerowelement/deletecell/)(int) | احذف خلية من الصف الحالي. |
...
| [insertCell](../../com.aspose.html/htmltablerowelement/insertcell/)(int) | أدرج خلية `TD` فارغة في هذا الصف. إذا كان `index` يساوي -1 أو يساوي عدد الخلايا، تُضاف الخلية الجديدة في النهاية. |
