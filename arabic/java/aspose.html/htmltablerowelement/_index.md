---
title: "HTMLTableRowElement فئة"
second_title: "مرجع API لـ Aspose.HTML for Java"
description: "com.aspose.html.HTMLTableRowElement فئة. صف في جدول. راجع تعريف عنصر TR في HTML 4.01"
type: docs
...
| [getRowIndex](../../com.aspose.html/htmltablerowelement/rowindex/) هذا بترتيب منطقي وليس بترتيب المستند. يأخذ `rowIndex` في الاعتبار الأقسام (`THEAD`، `TFOOT` أو `TBODY`) داخل الجدول، حيث يضع صفوف `THEAD` أولاً في الفهرس، ثم صفوف `TBODY`، ثم صفوف `TFOOT`. @version DOM Level 2 |
| [getSectionRowIndex](../../com.aspose.html/htmltablerowelement/sectionrowindex/) فهرس هذا الصف بالنسبة إلى القسم الحالي (`THEAD`، `TFOOT` أو `TBODY`)، بدءًا من 0. @version DOM Level 2 |
