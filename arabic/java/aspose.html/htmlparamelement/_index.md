...
description: "فئة com.aspose.html.HTMLParamElement. المعلمات المرسلة إلى عنصر OBJECT. راجع تعريف العنصر PARAM في HTML 4.01"
type: docs
...
معلمات تُغذّى إلى عنصر `OBJECT`. راجع تعريف العنصر PARAM في HTML 4.01.
