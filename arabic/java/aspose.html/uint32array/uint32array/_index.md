...
description: "منشئ Uint32Array. يُنشئ مثيلاً جديداً من فئة Uint32Array"
type: docs

url: /ar/java/com.aspose.html/uint32array/uint32array/
---
## Uint32Array(int) {#constructor_3}

يُنشئ مثيلاً جديداً من فئة [`Uint32Array`](../).
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| البيانات | UInt32[] | بيانات المصفوفة. |
