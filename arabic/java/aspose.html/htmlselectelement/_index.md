...
description: "com.aspose.html.HTMLSelectElement فئة. العنصر select يسمح باختيار خيار. يمكن الوصول إلى الخيارات المحتواة مباشرةً عبر العنصر select كمجموعة. راجع تعريف عنصر SELECT في HTML 4.01"
type: docs
...
عنصر select يتيح اختيار خيار. يمكن الوصول إلى الخيارات المحتواة مباشرة عبر عنصر select كمجموعة. راجع تعريف العنصر SELECT في HTML 4.01.
...
| [getType](../../com.aspose.html/htmlselectelement/type/) نوع عنصر التحكم في النموذج هذا. هذه هي السلسلة "select-multiple" عندما تكون الخاصية multiple `true` والسلسلة "select-one" عندما تكون `false`. |
[getValue]
