---
title: "فئة HTMLSelectElement"
second_title: "مرجع API لـ Aspose.HTML for Java"
description: "الفئة com.aspose.html.HTMLSelectElement. يسمح عنصر select باختيار خيار. يمكن الوصول إلى الخيارات المحتواة مباشرةً عبر عنصر select كمجموعة. راجع تعريف عنصر SELECT في HTML 4.01"
type: docs

url: /ar/java/com.aspose.html/htmlselectelement/
---
## HTMLSelectElement class

العنصر select يسمح باختيار خيار. يمكن الوصول إلى الخيارات المحتواة مباشرةً عبر عنصر select كمجموعة. راجع تعريف العنصر SELECT في HTML 4.01.
...
| [getForm](../../com.aspose.html/htmlselectelement/form/) عدد الخيارات في هذا `SELECT`. |
[getId]
...
| [getOptions](../../com.aspose.html/htmlselectelement/options/) مجموعة عناصر `OPTION` المحتواة في هذا العنصر. @version DOM Level 2 |
[getOuterHTML]
...
| [getType](../../com.aspose.html/htmlselectelement/type/) نوع عنصر التحكم في النموذج هذا. يكون هذا هو السلسلة "select-multiple" عندما تكون الخاصية multiple مساوية لـ `true` والسلسلة "select-one" عندما تكون `false`. |
[getValue]
