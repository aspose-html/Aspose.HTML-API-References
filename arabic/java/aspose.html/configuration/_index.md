...
description: "com.aspose.html.Configuration فئة. تمثل كائن سياق التكوين الذي يُستخدم لإعداد إعدادات البيئة للتطبيق. من خلال إدارة التكوين يمكنك تجاوز نمط المستند بتطبيق ورقة أنماط مستخدم مخصصة أو معالجة أي طلبات ويب من التطبيق وكذلك تكوين سياسة السكريبتات. التفاصيل موجودة في دليل تكوين البيئة."
type: docs
...
| الاسم | الوصف |
| --- | --- |
| [Configuration](configuration/)() | يُنشئ نسخة جديدة من `class`. |
...
| الاسم | الوصف |
| --- | --- |
| static [Create](../../com.aspose.html/configuration/create/#create)() | إنشاء وتكوين نسخة من كائن Configuration. |
| static [Create](../../com.aspose.html/configuration/create/#create_1)(Action&lt;IConfigurationBuilder&gt;) | إنشاء وتكوين نسخة من كائن Configuration. |
| [dispose](../../com.aspose.html/configuration/dispose/)() | ينفّذ مهامًا معرفة من قبل التطبيق مرتبطة بتحرير أو تحرير أو إعادة ضبط الموارد غير المُدارة. |
...
import com.aspose.html.services;
    ...
    // معالج الرسائل هذا يطبع رسالة حول بدء وإنهاء معالجة الطلب.
    public class LogMessageHandler : MessageHandler
    {
      ...
      public void Invoke(INetworkOperationContext context)
      {
        ...
        // استدعِ معالج الرسائل التالي في السلسلة.
        Next(context);
