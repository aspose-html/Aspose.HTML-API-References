---
title: "فئة HTMLObjectElement"
second_title: "مرجع API لـ Aspose.HTML for Java"
description: "فئة com.aspose.html.HTMLObjectElement. كائن مدمج عام. من حيث المبدأ جميع الخصائص في عنصر الكائن قابلة للقراءة والكتابة لكن في بعض البيئات قد تكون بعض الخصائص للقراءة فقط بمجرد إنشاء الكائن الأساسي. راجع تعريف عنصر OBJECT في HTML 4.01"
type: docs

url: /ar/java/com.aspose.html/htmlobjectelement/
---
## HTMLObjectElement class

كائن مضمّن عام. من حيث المبدأ، جميع الخصائص في عنصر الكائن قابلة للقراءة والكتابة ولكن في بعض البيئات قد تكون بعض الخصائص للقراءة فقط بمجرد إنشاء الكائن الأساسي. راجع تعريف العنصر OBJECT في [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224)].
