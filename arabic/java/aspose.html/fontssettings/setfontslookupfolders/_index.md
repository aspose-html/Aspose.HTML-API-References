...
description: "طريقة FontsSettings. يضبط مصفوفة من المجلدات المستخدمة أثناء اختيار الخطوط"
type: docs

url: /ar/java/com.aspose.html/fontssettings/setfontslookupfolders/
---
...
| --- | --- | --- |
| fontsFolders | String[] | مجلدات الخطوط. |
| متكرر | Boolean | إذا تم تعيينه إلى `true` سيتم استخدام جميع الأدلة المتداخلة. القيمة الافتراضية هي `false`. |
