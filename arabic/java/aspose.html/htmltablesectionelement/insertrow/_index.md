...
description: "طريقة HTMLTableSectionElement. إدراج صف في هذا القسم. يتم إدراج الصف الجديد مباشرةً قبل الصف الحالي رقم index في هذا القسم. إذا كان index يساوي -1 أو يساوي عدد الصفوف في هذا القسم يتم إلحاق الصف الجديد"
type: docs
...
أدرج صفًا في هذا القسم. يتم إدراج الصف الجديد مباشرةً قبل الصف الحالي رقم `index` في هذا القسم. إذا كان `index` يساوي -1 أو يساوي عدد الصفوف في هذا القسم، يتم إلحاق الصف الجديد.
