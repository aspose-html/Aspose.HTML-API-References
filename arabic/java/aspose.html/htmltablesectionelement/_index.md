...
description: "فئة com.aspose.html.HTMLTableSectionElement. عناصر THEAD و TFOOT و TBODY"
type: docs
...
| [deleteRow](../../com.aspose.html/htmltablesectionelement/deleterow/)(int) | احذف صفًا من هذا القسم. |
...
| [insertRow](../../com.aspose.html/htmltablesectionelement/insertrow/)(int) | أدرج صفًا في هذا القسم. يتم إدراج الصف الجديد مباشرةً قبل الصف الحالي رقم `index` في هذا القسم. إذا كان `index` يساوي -1 أو يساوي عدد الصفوف في هذا القسم، يتم إلحاق الصف الجديد. |
