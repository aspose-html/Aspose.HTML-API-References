---
title: "فئة HTMLLabelElement"
second_title: "مرجع API لـ Aspose.HTML للـ Java"
description: "الفئة com.aspose.html.HTMLLabelElement. نص تسمية حقل النموذج. راجع تعريف عنصر LABEL في HTML 4.01"
type: docs

url: /ar/java/com.aspose.html/htmllabelelement/
---
## HTMLLabelElement class

نص تسمية حقل النموذج. راجع تعريف العنصر LABEL في HTML 4.01.
...
| [getForm](../../com.aspose.html/htmllabelelement/form/) يُرجع عنصر `FORM` الذي يحتوي على هذا التحكم. يُرجع `null` إذا لم يكن هذا التحكم ضمن سياق نموذج. |
[getId]
