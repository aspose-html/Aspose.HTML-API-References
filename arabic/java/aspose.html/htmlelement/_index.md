...
description: "فئة com.aspose.html.HTMLElement. جميع واجهات عناصر HTML تستمد من هذه الفئة. العناصر التي تعرض فقط سمات HTML الأساسية ممثلة بواجهة HTMLElement الأساسية. هذه العناصر هي كما يلي: SUB، SUP، SPAN، BDO، font، TT، I، B، U، S، STRIKE، BIG، SMALL، phrase، EM، STRONG، DFN، CODE، SAMP، KBD، VAR، CITE، ACRONYM، ABBR، list، DD، DT، NOFRAMES، NOSCRIPT، ADDRESS، CENTER. سمة style لعنصر HTML يمكن الوصول إليها عبر واجهة ElementCSSInlineStyle التي تم تعريفها في وحدة CSS ضمن DOM Level 2 Style Sheets and CSS."
type: docs
...
جميع واجهات عناصر HTML تُشتق من هذه الفئة. العناصر التي تُظهر فقط سمات HTML الأساسية ممثلة بواجهة `HTMLElement` الأساسية. هذه العناصر هي كما يلي: خاصة: SUB, SUP, SPAN, BDOfont: TT, I, B, U, S, STRIKE, BIG, SMALL عبارة: EM, STRONG, DFN, CODE, SAMP, KBD, VAR, CITE, ACRONYM, ABBR قائمة: DD, DTNOFRAMES, NOSCRIPTADDRESS, CENTER. سمة `style` لعنصر HTML يمكن الوصول إليها عبر واجهة `ElementCSSInlineStyle` التي تُعرّف في وحدة CSS [[DOM Level 2 Style Sheets and CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113)].
