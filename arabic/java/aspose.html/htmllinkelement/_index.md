---
title: "HTMLLinkElement فئة"
second_title: "مرجع API لـ Aspose.HTML for Java"
description: "com.aspose.html.HTMLLinkElement فئة. عنصر LINK يحدد رابطًا إلى مورد خارجي ويعرّف علاقة هذا المستند بذلك المورد أو العكس. راجع تعريف عنصر LINK في HTML 4.01، وانظر أيضًا إلى واجهة LinkStyle في وحدة StyleSheet مستوى DOM 2 أوراق الأنماط وCSS."
type: docs
...
العنصر `LINK` يحدد ارتباطًا بمورد خارجي، ويعرّف علاقة هذا المستند بذلك المورد (أو العكس). راجع تعريف العنصر LINK في HTML 4.01 (راجع أيضًا واجهة `LinkStyle` في وحدة StyleSheet [[DOM Level 2 Style Sheets and CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113)]).
