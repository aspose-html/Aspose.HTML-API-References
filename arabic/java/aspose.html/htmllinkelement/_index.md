---
title: "الفئة HTMLLinkElement"
second_title: "مرجع API لـ Aspose.HTML للـ Java"
description: "الفئة com.aspose.html.HTMLLinkElement. يحدد العنصر LINK رابطًا إلى مورد خارجي ويعرّف علاقة هذا المستند بذلك المورد أو العكس. راجع تعريف العنصر LINK في HTML 4.01، وانظر أيضًا إلى واجهة LinkStyle في وحدة StyleSheet مستوى DOM 2 أنماط الأنماط وCSS."
type: docs

url: /ar/java/com.aspose.html/htmllinkelement/
---
## HTMLLinkElement class

العنصر `LINK` يحدد ارتباطًا بمورد خارجي، ويعرف علاقة هذا المستند بذلك المورد (أو العكس). راجع تعريف العنصر LINK في HTML 4.01 (انظر أيضًا إلى واجهة `LinkStyle` في وحدة StyleSheet [[DOM Level 2 Style Sheets and CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113)]).
...
| [getRelList](../../com.aspose.html/htmllinkelement/rellist/) يُرجع DOMTokenList حي يحتوي على الرموز المستخرجة من تحليل السمة "rel". |
[getRev]
...
| [getSheet](../../com.aspose.html/htmllinkelement/sheet/) يحصل على ورقة الأنماط المرتبطة. |
