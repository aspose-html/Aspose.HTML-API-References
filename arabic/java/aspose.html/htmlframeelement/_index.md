---
title: "فئة HTMLFrameElement"
second_title: "مرجع API لـ Aspose.HTML للـ Java"
description: "فئة com.aspose.html.HTMLFrameElement. إنشاء إطار. راجع تعريف العنصر FRAME في HTML 4.01"
type: docs

url: /ar/java/com.aspose.html/htmlframeelement/
---
## HTMLFrameElement class

إنشاء إطار. راجع تعريف العنصر FRAME في HTML 4.01.
...
| [getContentDocument](../../com.aspose.html/htmlframeelement/contentdocument/) المستند الذي يحتويه هذا الإطار، إذا كان موجودًا ومتوافرًا، أو `null` خلاف ذلك. @since DOM Level 2 |
[getDir]
