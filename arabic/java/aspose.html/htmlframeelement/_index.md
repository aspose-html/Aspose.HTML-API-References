...
description: "فئة com.aspose.html.HTMLFrameElement. إنشاء إطار. راجع تعريف عنصر FRAME في HTML 4.01"
type: docs
...
| [getContentDocument](../../com.aspose.html/htmlframeelement/contentdocument/) المستند الذي يحتويه هذا الإطار، إذا كان موجودًا ومتوفرًا، أو `null` خلاف ذلك. @since DOM Level 2 |
[getDir]
