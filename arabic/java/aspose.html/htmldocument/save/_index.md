...
description: "طريقة HTMLDocument. تحفظ المستند إلى ملف محلي محدد بواسطة URL. سيتم حفظ جميع الموارد المستخدمة في هذا المستند في مجلد مجاور يُنشأ اسمه كـ output_file_name_files."
type: docs
...
من الضروري تحديد مسار URL كامل - 'outputFilePath' لحفظ مستند HTML. يُنشئ المُنشئ Url(url) مثلاً من فئة [`Url`](../../url/) بالـ URL المحدد. ثم يجب تمرير هذا المثال إلى طريقة Save(Url). سيتم حفظ المستند إلى الملف المحلي المحدد بالـ URL. سيتم حفظ جميع الموارد المستخدمة في هذا المستند في مجلد مجاور، يُنشأ اسمه كـ output_file_name + \"_files\".
...
يحفظ المستند إلى ملف محلي محدد بالمسار. سيتم حفظ جميع الموارد المستخدمة في هذا المستند في مجلد مجاور، يُنشأ اسمه كالتالي: output_file_name + \"_files\".
...
طريقة Save(String) تأخذ كمعامل مسار نظام ملفات محلي إلى ملف الإخراج وتُحفظ مستند HTML إلى الملف المحلي المحدد بالمسار. سيتم حفظ جميع الموارد المستخدمة في المستند في مجلد مجاور.
...
يحفظ المستند إلى ملف محلي محدد بواسطة path. سيتم حفظ جميع الموارد المستخدمة في هذا المستند في مجلد مجاور، سيتم إنشاء اسمه كـ output_file_name + "_files".
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| المسار | String | مسار ملف محلي إلى ملف الإخراج. |
| saveFormat | HTMLSaveFormat | الصيغة التي يُحفظ بها المستند. |
...
طريقة Save(String, HTMLSaveFormat) تأخذ كمعلمات مسار نظام ملفات محلي لملف الإخراج و saveFormat. الـ [`HTMLSaveFormat`](../../../com.aspose.html.saving/htmlsaveformat/) تعداد يحدد الصيغة التي يُحفظ بها المستند، ويمكن أن تكون HTML أو MHTML أو صيغ MD. الطريقة تحفظ مستند HTML بالصِيغة المحددة إلى الملف المحلي المحدد بالمسار. جميع الموارد المستخدمة في المستند سيتم حفظها في مجلد مجاور.
...
&lt;p id="p1" class="ddd kkk"&gt;فقرة تم تنسيقها بواسطة اسم الفئة =ddd kkk=&lt;/p&gt;

&lt;p id="p2" class="ddd fff"&gt;فقرة تم تنسيقها بواسطة اسم الفئة =ddd fff=&lt;/p&gt;

&lt;p id="p3" class="kkk fff"&gt;فقرة تم تنسيقها بواسطة اسم الفئة =kkk fff=&lt;/p&gt;
...
من الضروري تحديد مسار Url كامل - 'outputFilePath' لحفظ مستند HTML. يقوم المُنشئ Url(url) بإنشاء مثال من الفئة [`Url`](../../url/) بالعنوان المحدد. تحدد تعداد [`HTMLSaveFormat`](../../../com.aspose.html.saving/htmlsaveformat/) الصيغة التي يُحفظ بها المستند، ويمكن أن تكون HTML أو MHTML أو MD. ثم يجب تمرير المعلمات إلى طريقة Save(url, saveFormat). سيتم حفظ المستند بالصيغ المحددة إلى الملف المحلي المحدد بالعنوان.
...
طريقة Save(String, HTMLSaveOptions) تأخذ كمعلمات مسار نظام ملفات محلي إلى ملف الإخراج، ومثال من الفئة [HTMLSaveOptions](https://docs.aspose.com/html/net/working-with-documents/saving-a-document/)، وتقوم بحفظ مستند HTML مع الموارد إلى الملف المحلي المحدد بالمسار. يقوم المُنشئ HTMLSaveOptions() بإنشاء مثال لخيارات الحفظ يحتوي على خصائص [`ResourceHandlingOptions`](../../../com.aspose.html.saving/htmlsaveoptions/) التي تُستخدم لتكوين معالجة الموارد. سيتم حفظ جميع الموارد المستخدمة في المستند في مجلد مجاور.
...
من الضروري تحديد مسار Url كامل لحفظ مستند HTML. يقوم المُنشئ Url(url) بإنشاء مثال من الفئة [`Url`](../../url/) بالعنوان المحدد. يقوم المُنشئ HTMLSaveOptions() بإنشاء مثال من الفئة [`HTMLSaveOptions`](../../../com.aspose.html.saving/htmlsaveoptions/) التي تحتوي على خصائص ResourceHandlingOptions تُستخدم لتكوين معالجة الموارد. طريقة Save(url, saveOptions) تأخذ المعلمات وتقوم بحفظ مستند HTML مع الموارد إلى الملف المحلي المحدد بالعنوان.
...
من الضروري تحديد مسار نظام ملفات محلي إلى ملف الإخراج لحفظ المستند. يقوم المُنشئ MarkdownSaveOptions() بإنشاء مثال من الفئة [`MarkdownSaveOptions`](../../../com.aspose.html.saving/markdownsaveoptions/) التي تحتوي على مجموعة من الخصائص. على سبيل المثال، يمكنك تعيين نمط تنسيق markdown، واستخدام خيارات متوافقة مع GitLab Flavored Markdown المحددة مسبقًا وتكوين معالجة الموارد. طريقة Save(path, saveOptions) تأخذ مسار نظام الملفات المحلي إلى ملف الإخراج ومثال الخيارات كمعلمات وتقوم بحفظ HTML كمستند Markdown مع الموارد إلى الملف المحلي المحدد بالمسار.
...
من الضروري تحديد مسار Url كامل لحفظ المستند. يقوم المُنشئ Url(url) بإنشاء مثال من الفئة [`Url`](../../url/) بالعنوان المحدد. يقوم المُنشئ MarkdownSaveOptions() بإنشاء مثال من الفئة [`MarkdownSaveOptions`](../../../com.aspose.html.saving/markdownsaveoptions/) التي تحتوي على مجموعة من الخصائص. على سبيل المثال، يمكنك تعيين نمط تنسيق Markdown، واستخدام خيارات متوافقة مع GitLab Flavored Markdown المحددة مسبقًا وتكوين معالجة الموارد. طريقة Save(url, saveOptions) تأخذ عنوان URL ومثيلات خيارات الحفظ كمعلمات وتقوم بحفظ المستند مع الموارد إلى الملف المحلي المحدد بالعنوان.
...
من الضروري تحديد مسار نظام ملفات محلي لملف الإخراج عند حفظ المستند. يقوم مُنشئ MHTMLSaveOptions() بإنشاء مثال من الفئة [`MHTMLSaveOptions`](../../../com.aspose.html.saving/mhtmlsaveoptions/) التي تحتوي على الخاصية ResourceHandlingOptions والتي تُستخدم لتكوين معالجة الموارد. تأخذ طريقة Save(path, saveOptions) مسار نظام ملفات محلي لملف الإخراج ومثيل خيارات الحفظ كمعاملين وتقوم بحفظ HTML كمستند MHTML إلى الملف المحلي المحدد بالمسار.
...
من الضروري تحديد مسار Url كامل لحفظ المستند. يقوم مُنشئ Url(url) بإنشاء مثال من الفئة [`Url`](../../url/) باستخدام الـ url المحدد. يقوم مُنشئ MHTMLSaveOptions() بإنشاء مثال من الفئة [`MHTMLSaveOptions`](../../../com.aspose.html.saving/mhtmlsaveoptions/) التي تحتوي على الخاصية ResourceHandlingOptions والتي تُستخدم لتكوين معالجة الموارد. تأخذ طريقة Save(url, saveOptions) الـ url والخيارات كمعاملين وتقوم بحفظ HTML كمستند MHTML إلى الملف المحلي المحدد بالـ url.
