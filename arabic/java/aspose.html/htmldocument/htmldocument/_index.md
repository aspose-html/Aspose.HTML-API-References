...
description: "منشئ HTMLDocument. يقوم منشئ HTMLDocument بإنشاء كائن HTML Document جديد وهو صفحة ويب تم تحميلها في المتصفح وتعمل كنقطة دخول إلى محتوى الصفحات."
type: docs
...
بمجرد إنشاء كائن المستند، يمكن ملؤه لاحقًا بعناصر HTML. يوضح مقطع الشيفرة التالي كيفية استخدام منشئ HTMLDocument() الافتراضي لإنشاء مستند HTML فارغ وحفظه إلى ملف.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| الإعدادات | الإعدادات | تكوين البيئة مثل سياسة السكريبتات، ورقة الأنماط المخصصة للمستخدم، إلخ. |
...
ملاحظة: في حال تمرير عنوان URL خاطئ لا يمكن الوصول إليه في الوقت الحالي، تقوم المكتبة برمي [`DOMException`](../../../com.aspose.html.dom/domexception/) مع رمز متخصص ‘NetworkError’ لإبلاغك بأنه لا يمكن العثور على المورد المحدد.
...
ملاحظة: في حال تمرير عنوان URL خاطئ لا يمكن الوصول إليه في الوقت الحالي، تقوم المكتبة برمي [DOMException](T:com.aspose.html.dom.DOMException) مع رمز متخصص ‘NetworkError’ لإبلاغك بأنه لا يمكن العثور على المورد المحدد.
...
ينشئ مستند HTML من محتوى سلسلة نصية مع base-uri محدد.
...
| استثناء | شرط |
| --- | --- |
| ArgumentNullException | يرمي استثناء إذا كان معامل base-uri فارغًا (null). |
...
ينشئ مستند HTML من محتوى سلسلة نصية مع base-uri محدد وإعدادات تكوين البيئة.
...
حسب التعريف، معالج الرسائل هو فئة تستقبل طلب ويب وتعيد استجابة ويب. بعبارة أخرى، يُستخدم معالج الرسائل لمعالجة طلب خدمة ويب أثناء الإدخال و/أو لمعالجة الاستجابة أثناء الإخراج.
