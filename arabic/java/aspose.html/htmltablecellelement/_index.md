---
title: "فئة HTMLTableCellElement"
second_title: "مرجع API لـ Aspose.HTML للـ Java"
description: "com.aspose.html.HTMLTableCellElement فئة. الكائن المستخدم لتمثيل عناصر TH و TD. راجع تعريف عنصر TD في HTML 4.01"
type: docs

url: /ar/java/com.aspose.html/htmltablecellelement/
---
## HTMLTableCellElement class

الكائن المستخدم لتمثيل عناصر `TH` و `TD`. راجع تعريف العنصر TD في HTML 4.01.
...
| [getCellIndex](../../com.aspose.html/htmltablecellelement/cellindex/) الفهرس لهذه الخلية في الصف، يبدأ من 0. هذا الفهرس هو بترتيب شجرة المستند وليس بترتيب العرض. |
[getCh]
