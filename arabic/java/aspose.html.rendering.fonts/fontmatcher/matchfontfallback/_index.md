...
description: "طريقة FontMatcher. يتم استدعاء هذه الطريقة إذا لم يتم العثور على خط مناسب في مجلدات البحث عن الخطوط. يجب أن تُرجع خطًا من النوع true بناءً على fontMatchingProperties التي يمكنها عرض charCode أو null إذا لم يتوفر مثل هذا الخط."
type: docs
