...
description: "منشئ Margin. يهيئ نسخة جديدة من فئة Margin"
type: docs

url: /ar/java/com.aspose.html.drawing/margin/margin/
---
## Margin() {#constructor}

يهيئ نسخة جديدة من فئة [`Margin`](../).
...
| left | Int32 | حجم left. |
| top | Int32 | حجم top. |
| right | Int32 | حجم right. |
| الأسفل | Int32 | حجم الجزء السفلي. |
...
| left | الطول | حجم left. |
| top | الطول | حجم top. |
| right | الطول | حجم right. |
| الأسفل | الطول | حجم الجزء السفلي. |
