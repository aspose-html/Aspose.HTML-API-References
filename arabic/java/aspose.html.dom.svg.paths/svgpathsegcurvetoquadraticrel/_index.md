---
title: "SVGPathSegCurvetoQuadraticRel فئة"
second_title: "مرجع API لـ Aspose.HTML للـ Java"
description: "com.aspose.html.dom.svg.paths.SVGPathSegCurvetoQuadraticRel فئة. الواجهة SVGPathSegCurvetoQuadraticRel تتطابق مع أمر بيانات مسار منحنى بيزيه تربيعي نسبي q"
type: docs

url: /ar/java/com.aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticrel/
---
## SVGPathSegCurvetoQuadraticRel class

The interface SVGPathSegCurvetoQuadraticRel تتطابق مع أمر بيانات المسار "منحنى بيزييه رباعي نسبي" (q).
...
| [X](../../com.aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticrel/x/) { get; set; } | الإحداثي X النسبي لنقطة النهاية لهذا مقطع المسار. |
[getX1]
[setX1] The relative X coordinate for the first control point. |
| [Y](../../com.aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticrel/y/) { get; set; } | الإحداثي Y النسبي لنقطة النهاية لهذا مقطع المسار. |
[getY1]
