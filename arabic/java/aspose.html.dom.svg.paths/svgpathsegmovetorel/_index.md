---
title: "SVGPathSegMovetoRel فئة"
second_title: "مرجع API لـ Aspose.HTML للـ Java"
description: "com.aspose.html.dom.svg.paths.SVGPathSegMovetoRel فئة. الواجهة SVGPathSegMovetoRel تتطابق مع أمر بيانات مسار تحريك نسبي m"
type: docs

url: /ar/java/com.aspose.html.dom.svg.paths/svgpathsegmovetorel/
---
## SVGPathSegMovetoRel class

The interface SVGPathSegMovetoRel تتطابق مع أمر بيانات المسار "نقطة انتقال نسبية" (m).
...
| [X](../../com.aspose.html.dom.svg.paths/svgpathsegmovetorel/x/) { get; set; } | الإحداثي X النسبي لنقطة النهاية لهذا مقطع المسار. |
| [Y](../../com.aspose.html.dom.svg.paths/svgpathsegmovetorel/y/) { get; set; } | الإحداثي Y النسبي لنقطة النهاية لهذا مقطع المسار. |
