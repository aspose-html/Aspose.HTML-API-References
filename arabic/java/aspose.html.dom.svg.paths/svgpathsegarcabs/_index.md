---
title: "SVGPathSegArcAbs الفئة"
second_title: "مرجع API لـ Aspose.HTML للـ Java"
description: "com.aspose.html.dom.svg.paths.SVGPathSegArcAbs الفئة. الواجهة SVGPathSegArcAbs تمثل أمر بيانات مسار من نوع arcto مطلق A"
type: docs

url: /ar/java/com.aspose.html.dom.svg.paths/svgpathsegarcabs/
---
## SVGPathSegArcAbs class

واجهة SVGPathSegArcAbs تتطابق مع أمر مسار "absolute arcto" (A).
...
| [X](../../com.aspose.html.dom.svg.paths/svgpathsegarcabs/x/) { get; set; } | الإحداثي X المطلق لنقطة النهاية لهذا المقطع المساري. |
| [Y](../../com.aspose.html.dom.svg.paths/svgpathsegarcabs/y/) { get; set; } | الإحداثي Y المطلق لنقطة النهاية لهذا المقطع المساري. |
