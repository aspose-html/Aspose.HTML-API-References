...
description: "خاصية SVGPathSegArcRel. نصف القطر على المحور السيني للإهليلج أي r1"
type: docs

url: /ar/java/com.aspose.html.dom.svg.paths/svgpathsegarcrel/r1/
---
## SVGPathSegArcRel.R1 property

نصف القطر على المحور السيني للإهليلج (أي r1).
