---
title: "SVGPathSegArcRel الفئة"
second_title: "مرجع API لـ Aspose.HTML للـ Java"
description: "com.aspose.html.dom.svg.paths.SVGPathSegArcRel الفئة. الواجهة SVGPathSegArcRel تمثل أمر بيانات مسار من نوع arcto نسبي"
type: docs

url: /ar/java/com.aspose.html.dom.svg.paths/svgpathsegarcrel/
---
## SVGPathSegArcRel class

واجهة SVGPathSegArcRel تتطابق مع أمر مسار "relative arcto" (a).
...
| [X](../../com.aspose.html.dom.svg.paths/svgpathsegarcrel/x/) { get; set; } | الإحداثي X النسبي لنقطة النهاية لهذا مقطع المسار. |
| [Y](../../com.aspose.html.dom.svg.paths/svgpathsegarcrel/y/) { get; set; } | الإحداثي Y النسبي لنقطة النهاية لهذا مقطع المسار. |
