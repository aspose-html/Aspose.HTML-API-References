---
title: "فئة SVGComponentTransferFunctionElement"
second_title: "مرجع API لـ Aspose.HTML for Java"
description: "com.aspose.html.dom.svg.SVGComponentTransferFunctionElement فئة. هذه الواجهة تعرف واجهة أساسية تُستخدم بواسطة واجهات وظائف نقل المكوّن"
type: docs

url: /ar/java/com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/
---
## SVGComponentTransferFunctionElement class

هذه الواجهة تعرف واجهة أساسية تُستخدم بواسطة واجهات وظائف نقل المكوّن.
...
| الاسم | الوصف |
| --- | --- |
| [getAmplitude](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/amplitude/) يتطابق مع السمة ‘amplitude’ في العنصر المحدد. |
...
| [getExponent](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/exponent/) يتطابق مع السمة ‘exponent’ في العنصر المحدد. |
...
| [getIntercept](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/intercept/) يتطابق مع السمة ‘intercept’ في العنصر المحدد. |
...
| [getOffset](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/offset/) يتطابق مع السمة ‘offset’ في العنصر المحدد. |
[getOuterHTML]
...
| [getSlope](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/slope/) يتطابق مع السمة ‘slope’ في العنصر المحدد. |
...
| [getTableValues](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/tablevalues/) يتطابق مع السمة ‘tableValues’ في العنصر المحدد. |
...
| [getType](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/type/) يتطابق مع السمة ‘type’ في العنصر المحدد. يأخذ أحد الثوابت SVG_FECOMPONENTTRANSFER_TYPE_* المعرفة في هذه الواجهة. |
...
| الاسم | الوصف |
| --- | --- |
| const [SVG_FECOMPONENTTRANSFER_TYPE_DISCRETE](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_discrete/) | يتطابق مع القيمة 'discrete'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_GAMMA](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_gamma/) | يتطابق مع القيمة 'gamma'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_IDENTITY](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_identity/) | يتطابق مع القيمة 'identity'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_LINEAR](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_linear/) | يتطابق مع القيمة 'linear'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_TABLE](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_table/) | يتطابق مع القيمة 'table'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_UNKNOWN](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_unknown/) | النوع ليس أحد الأنواع المعرفة مسبقًا. من غير الصالح محاولة تعريف قيمة جديدة لهذا النوع أو محاولة تحويل قيمة موجودة إلى هذا النوع. |
