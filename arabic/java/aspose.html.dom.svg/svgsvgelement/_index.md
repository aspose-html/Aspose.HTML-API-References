---
title: "فئة SVGSVGElement"
second_title: "مرجع API لـ Aspose.HTML for Java"
description: "الفئة com.aspose.html.dom.svg.SVGSVGElement. تعريف الواجهة الرئيسية هو واجهة SVGSVGElement التي هي الواجهة التي تتطابق مع عنصر svg. تحتوي هذه الواجهة على طرق مساعدة متنوعة وشائعة الاستخدام مثل عمليات المصفوفات والقدرة على التحكم في وقت إعادة الرسم على أجهزة العرض البصرية."
type: docs

url: /ar/java/com.aspose.html.dom.svg/svgsvgelement/
---
## SVGSVGElement class

تعريف الواجهة الرئيسي هو واجهة SVGSVGElement، وهي الواجهة التي تتطابق مع العنصر ‘svg’. تحتوي هذه الواجهة على طرق مساعدة متنوعة وشائعة الاستخدام، مثل عمليات المصفوفات والقدرة على التحكم في وقت إعادة الرسم على أجهزة العرض البصرية.
...
| [getCurrentTranslate](../../com.aspose.html.dom.svg/svgsvgelement/currenttranslate/) على عنصر svg الخارجي، عامل الترجمة المقابل الذي يأخذ في الاعتبار \"magnification\" المستخدم. عند الوصول إلى عنصر ‘svg’ ليس عنصرًا خارجيًا، يكون سلوك هذه السمة غير معرف. |
...
| [getHeight](../../com.aspose.html.dom.svg/svgsvgelement/height/) يتطابق مع السمة ‘height’ على عنصر ‘svg’ المعطى. |
[getId]
...
| [getPreserveAspectRatio](../../com.aspose.html.dom.svg/svgsvgelement/preserveaspectratio/) يتطابق مع السمة ‘preserveAspectRatio’ على العنصر المعطى. |
...
| [getViewBox](../../com.aspose.html.dom.svg/svgsvgelement/viewbox/) يتطابق مع السمة ‘viewBox’ على العنصر المعطى. |
...
| [getWidth](../../com.aspose.html.dom.svg/svgsvgelement/width/) يتطابق مع السمة ‘width’ على عنصر ‘svg’ المعطى. |
| [X](../../com.aspose.html.dom.svg/svgsvgelement/x/) { get; } | يتطابق مع السمة ‘x’ على عنصر ‘svg’ المعطى. |
| [Y](../../com.aspose.html.dom.svg/svgsvgelement/y/) { get; } | يتطابق مع السمة ‘y’ على عنصر ‘svg’ المعطى. |
[getZoomAndPan]
...
| [animationsPaused](../../com.aspose.html.dom.svg/svgsvgelement/animationspaused/)() | يرجع true إذا كان جزء مستند SVG هذا في حالة إيقاف مؤقت. |
...
| [createEvent](../../com.aspose.html.dom.svg/svgsvgelement/createevent/)(String) | ينشئ [`Event`](../../com.aspose.html.dom.events/event/) من نوع يدعمه التنفيذ. |
| [createSVGAngle](../../com.aspose.html.dom.svg/svgsvgelement/createsvgangle/)() | ينشئ كائن SVGAngle خارج أي شجرة مستندات. يتم تهيئة الكائن إلى القيمة 0 درجة (بدون وحدة). |
| [createSVGLength](../../com.aspose.html.dom.svg/svgsvgelement/createsvglength/)() | ينشئ كائن SVGLength خارج أي شجرة مستندات. يتم تهيئة الكائن إلى القيمة 0 وحدة مستخدم. |
| [createSVGMatrix](../../com.aspose.html.dom.svg/svgsvgelement/createsvgmatrix/)() | ينشئ كائن SVGMatrix خارج أي شجرة مستندات. يتم تهيئة الكائن إلى مصفوفة الهوية. |
| [createSVGNumber](../../com.aspose.html.dom.svg/svgsvgelement/createsvgnumber/)() | ينشئ كائن SVGNumber خارج أي شجرة مستندات. يتم تهيئة الكائن إلى القيمة صفر. |
| [createSVGPoint](../../com.aspose.html.dom.svg/svgsvgelement/createsvgpoint/)() | ينشئ كائن SVGPoint خارج أي شجرة مستندات. يتم تهيئة الكائن إلى النقطة (0,0) في نظام إحداثيات المستخدم. |
| [createSVGRect](../../com.aspose.html.dom.svg/svgsvgelement/createsvgrect/)() | ينشئ كائن SVGRect خارج أي شجرة مستندات. يتم تهيئة الكائن بحيث تُضبط جميع القيم إلى 0 وحدة مستخدم. |
| [createSVGTransform](../../com.aspose.html.dom.svg/svgsvgelement/createsvgtransform/)() | ينشئ كائن SVGTransform خارج أي شجرة مستندات. يتم تهيئة الكائن إلى تحويل مصفوفة هوية (SVG_TRANSFORM_MATRIX). |
| [createSVGTransformFromMatrix](../../com.aspose.html.dom.svg/svgsvgelement/createsvgtransformfrommatrix/)(SVGMatrix) | ينشئ كائن SVGTransform خارج أي شجرة مستندات. يتم تهيئة الكائن إلى تحويل المصفوفة المعطى (أي SVG_TRANSFORM_MATRIX). تُنسخ القيم من مصفوفة المعامل، ولا يتم اعتماد معلمة المصفوفة كـ SVGTransform::matrix. |
...
| [getCurrentTime](../../com.aspose.html.dom.svg/svgsvgelement/getcurrenttime/)() | يرجع الوقت الحالي بالثواني بالنسبة إلى وقت البدء لجزء مستند SVG الحالي. إذا تم استدعاء getCurrentTime قبل بدء الجدول الزمني للمستند (على سبيل المثال، بواسطة سكريبت يعمل في عنصر ‘script’ قبل إرسال حدث SVGLoad للمستند)، فسيتم إرجاع 0. |
| [getElementById](../../com.aspose.html.dom.svg/svgsvgelement/getelementbyid/)(String) | يبحث في جزء مستند SVG هذا (أي أن البحث يقتصر على جزء من شجرة المستند) عن عنصر Element whose id is given by elementId. إذا تم العثور على عنصر، يتم إرجاع ذلك العنصر. إذا لم يوجد مثل هذا العنصر، يرجع null. السلوك غير معرف إذا كان هناك أكثر من عنصر يحمل هذا المعرف. |
...
| [pauseAnimations](../../com.aspose.html.dom.svg/svgsvgelement/pauseanimations/)() | يعلق (أي يوقف مؤقتًا) جميع الرسوم المتحركة الجارية حاليًا والمحددة داخل جزء مستند SVG المتطابق مع عنصر ‘svg’ هذا، مما يجعل ساعة الرسوم المتحركة المتطابقة مع هذا الجزء ثابتة حتى يتم إلغاء الإيقاف. |
...
| [setCurrentTime](../../com.aspose.html.dom.svg/svgsvgelement/setcurrenttime/)(float) | يضبط الساعة لهذا الجزء من مستند SVG، مُنشئًا وقتًا حاليًا جديدًا. إذا تم استدعاء setCurrentTime قبل بدء خط الزمن للمستند (على سبيل المثال، بواسطة سكريبت يعمل في عنصر ‘script’ قبل إرسال حدث SVGLoad للمستند)، فإن قيمة الثواني في آخر استدعاء للطريقة تعطي الوقت الذي سيتجه إليه المستند بمجرد بدء خط الزمن للمستند. |
...
| [unpauseAnimations](../../com.aspose.html.dom.svg/svgsvgelement/unpauseanimations/)() | يفكّ التعليق (أي يزيل الإيقاف المؤقت) للرسوم المتحركة التي تعمل حاليًا والمُعرفة داخل جزء مستند SVG، مما يجعل ساعة الرسوم المتحركة تستمر من الوقت الذي تم إيقافها فيه. |
