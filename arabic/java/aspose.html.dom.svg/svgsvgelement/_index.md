---
title: "SVGSVGElement فئة"
second_title: "مرجع API لـ Aspose.HTML للـ Java"
description: "com.aspose.html.dom.svg.SVGSVGElement فئة. تعريف الواجهة الرئيسية هو واجهة SVGSVGElement التي هي الواجهة التي تتطابق مع عنصر svg. تحتوي هذه الواجهة على طرق مساعدة متنوعة وشائعة الاستخدام مثل عمليات المصفوفة والقدرة على التحكم في زمن إعادة الرسم على أجهزة العرض البصرية."
type: docs
...
| [getCurrentTranslate](../../com.aspose.html.dom.svg/svgsvgelement/currenttranslate/) على عنصر svg الخارجي، عامل الترجمة المقابل الذي يأخذ في الاعتبار "تكبير" المستخدم. عند الوصول إلى عنصر ‘svg’ ليس عنصرًا خارجيًا، يكون سلوك هذه السمة غير معرف. |
...
| [getHeight](../../com.aspose.html.dom.svg/svgsvgelement/height/) يتطابق مع السمة ‘height’ على عنصر ‘svg’ المحدد. |
[getId]
...
| [getPreserveAspectRatio](../../com.aspose.html.dom.svg/svgsvgelement/preserveaspectratio/) يتطابق مع السمة ‘preserveAspectRatio’ على العنصر المحدد. |
...
| [getViewBox](../../com.aspose.html.dom.svg/svgsvgelement/viewbox/) يتطابق مع السمة ‘viewBox’ على العنصر المحدد. |
...
| [getWidth](../../com.aspose.html.dom.svg/svgsvgelement/width/) يتطابق مع السمة ‘width’ على عنصر ‘svg’ المحدد. |
| [X](../../com.aspose.html.dom.svg/svgsvgelement/x/) { get; } | يتطابق مع السمة ‘x’ على عنصر ‘svg’ المحدد. |
| [Y](../../com.aspose.html.dom.svg/svgsvgelement/y/) { get; } | يتطابق مع السمة ‘y’ على عنصر ‘svg’ المحدد. |
[getZoomAndPan]
...
| [animationsPaused](../../com.aspose.html.dom.svg/svgsvgelement/animationspaused/)() | يعيد true إذا كان جزء مستند SVG هذا في حالة إيقاف مؤقت. |
...
| [createSVGAngle](../../com.aspose.html.dom.svg/svgsvgelement/createsvgangle/)() | ينشئ كائن SVGAngle خارج أي شجرة مستندات. يتم تهيئته إلى القيمة 0 درجة (بدون وحدة). |
| [createSVGLength](../../com.aspose.html.dom.svg/svgsvgelement/createsvglength/)() | ينشئ كائن SVGLength خارج أي شجرة مستندات. يتم تهيئته إلى القيمة 0 وحدة مستخدم. |
| [createSVGMatrix](../../com.aspose.html.dom.svg/svgsvgelement/createsvgmatrix/)() | ينشئ كائن SVGMatrix خارج أي شجرة مستندات. يتم تهيئته إلى مصفوفة الهوية. |
| [createSVGNumber](../../com.aspose.html.dom.svg/svgsvgelement/createsvgnumber/)() | ينشئ كائن SVGNumber خارج أي شجرة مستندات. يتم تهيئته إلى القيمة صفر. |
| [createSVGPoint](../../com.aspose.html.dom.svg/svgsvgelement/createsvgpoint/)() | ينشئ كائن SVGPoint خارج أي شجرة مستندات. يتم تهيئته إلى النقطة (0,0) في نظام إحداثيات المستخدم. |
| [createSVGRect](../../com.aspose.html.dom.svg/svgsvgelement/createsvgrect/)() | ينشئ كائن SVGRect خارج أي شجرة مستندات. يتم تهيئته بحيث تُضبط جميع القيم إلى 0 وحدة مستخدم. |
| [createSVGTransform](../../com.aspose.html.dom.svg/svgsvgelement/createsvgtransform/)() | ينشئ كائن SVGTransform خارج أي شجرة مستندات. يتم تهيئته إلى تحويل مصفوفة هوية (SVG_TRANSFORM_MATRIX). |
| [createSVGTransformFromMatrix](../../com.aspose.html.dom.svg/svgsvgelement/createsvgtransformfrommatrix/)(SVGMatrix) | ينشئ كائن SVGTransform خارج أي شجرة مستندات. يتم تهيئته إلى تحويل المصفوفة المعطى (أي SVG_TRANSFORM_MATRIX). تُنسخ القيم من مصفوفة المعامل، ولا يتم اعتماد معامل المصفوفة كـ SVGTransform::matrix. |
...
| [getCurrentTime](../../com.aspose.html.dom.svg/svgsvgelement/getcurrenttime/)() | يعيد الوقت الحالي بالثواني بالنسبة إلى وقت البدء لجزء مستند SVG الحالي. إذا تم استدعاء getCurrentTime قبل بدء خط الزمن للمستند (مثلاً، بواسطة سكريبت يعمل في عنصر ‘script’ قبل إرسال حدث SVGLoad للمستند)، يتم إرجاع 0. |
| [getElementById](../../com.aspose.html.dom.svg/svgsvgelement/getelementbyid/)(String) | يبحث في جزء مستند SVG هذا (أي أن البحث يقتصر على جزء من شجرة المستند) عن عنصر Element whose id is given by elementId. إذا تم العثور على عنصر، يتم إرجاعه. إذا لم يوجد مثل هذا العنصر، يرجع null. السلوك غير معرف إذا كان هناك أكثر من عنصر واحد يحمل هذا المعرف. |
...
| [pauseAnimations](../../com.aspose.html.dom.svg/svgsvgelement/pauseanimations/)() | يعلق (أي يوقف مؤقتًا) جميع الرسوم المتحركة التي تعمل حاليًا والمحددة داخل جزء مستند SVG المقابل لهذا العنصر ‘svg’، مما يجعل ساعة الرسوم المتحركة المقابلة لهذا الجزء تتوقف حتى يتم إلغاء الإيقاف. |
...
| [setCurrentTime](../../com.aspose.html.dom.svg/svgsvgelement/setcurrenttime/)(float) | يضبط الساعة لهذا الجزء من مستند SVG، ويحدد وقتًا حاليًا جديدًا. إذا تم استدعاء setCurrentTime قبل أن يبدأ خط الزمن للمستند (على سبيل المثال، بواسطة برنامج نصي يعمل في عنصر ‘script’ قبل أن يتم إرسال حدث SVGLoad للمستند)، فإن قيمة الثواني في آخر استدعاء للطريقة تعطي الوقت الذي سيسعى المستند إلى الوصول إليه بمجرد بدء خط الزمن للمستند. |
...
| [unpauseAnimations](../../com.aspose.html.dom.svg/svgsvgelement/unpauseanimations/)() | يفكّ التعليق (أي يزيل الإيقاف المؤقت) للرسوم المتحركة التي تعمل حاليًا والمُعرّفة داخل جزء مستند SVG، مما يجعل ساعة الرسوم المتحركة تستمر من الوقت الذي تم إيقافها فيه. |
