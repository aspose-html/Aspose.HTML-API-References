...
description: "الفئة com.aspose.html.dom.svg.SVGGeometryElement. تمثل الواجهة SVGGeometryElement عناصر SVG التي يتم تعريف عرضها بواسطة الهندسة مع مسار مكافئ ويمكن تعبئتها وتحديد حدها. يشمل ذلك المسارات والأشكال الأساسية."
type: docs
...
| [getEquivalentPath](../../com.aspose.html.dom.svg/svggeometryelement/getequivalentpath/)() | يرجع نسخة جديدة من [`SVGPathSegList`](../../com.aspose.html.dom.svg.paths/svgpathseglist/) التي تمثل `SVGGeometryElement` كشرائح مسار. |
