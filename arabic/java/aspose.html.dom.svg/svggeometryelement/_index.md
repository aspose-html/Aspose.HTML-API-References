---
title: "فئة SVGGeometryElement"
second_title: "مرجع API لـ Aspose.HTML for Java"
description: "الفئة com.aspose.html.dom.svg.SVGGeometryElement. تمثل الواجهة SVGGeometryElement عناصر SVG التي يتم تعريف عرضها بالهندسة مع مسار مكافئ ويمكن تعبئتها وتحديدها. يشمل ذلك المسارات والأشكال الأساسية"
type: docs

url: /ar/java/com.aspose.html.dom.svg/svggeometryelement/
---
## SVGGeometryElement class

واجهة SVGGeometryElement تمثل عناصر SVG التي يُعرّف عرضها بالهندسة مع مسار مكافئ، ويمكن تعبئتها وتحديد حدودها. يشمل ذلك المسارات والأشكال الأساسية.
...
| [getEquivalentPath](../../com.aspose.html.dom.svg/svggeometryelement/getequivalentpath/)() | يعيد كائنًا جديدًا من [`SVGPathSegList`](../../com.aspose.html.dom.svg.paths/svgpathseglist/) الذي يمثل `SVGGeometryElement` كقطاعات مسار. |
