---
title: "فئة SVGPathElement"
second_title: "مرجع API لـ Aspose.HTML for Java"
description: "com.aspose.html.dom.svg.SVGPathElement class. تتطابق واجهة SVGPathElement مع عنصر path"
type: docs

url: /ar/java/com.aspose.html.dom.svg/svgpathelement/
---
## SVGPathElement class

واجهة SVGPathElement تتطابق مع العنصر ‘path’.
...
| الاسم | الوصف |
| --- | --- |
| [getAnimatedPathSegList](../../com.aspose.html.dom.svg/svgpathelement/animatedpathseglist/) يوفّر الوصول إلى المحتويات المتحركة الحالية للسمة ‘d’ بصيغة تتطابق واحدًا لواحد مع صياغة SVG. إذا كانت السمة أو الخاصية المحددة قيد التحريك، فإنها تحتوي على القيمة المتحركة الحالية لتلك السمة أو الخاصية، ويكون كل من الكائن نفسه ومحتوياته للقراءة فقط. إذا لم تكن السمة أو الخاصية المحددة قيد التحريك حاليًا، فإنها تحتوي على نفس القيمة كما في pathSegList. |
...
| [getClassName](../../com.aspose.html.dom.svg/svgelement/classname/) يتطابق مع السمة ‘class’ على العنصر المعطى. |
[getClassName]
...
| [getFarthestViewportElement](../../com.aspose.html.dom.svg/svggraphicselement/farthestviewportelement/) العنصر الأب البعيد ‘svg’. يكون null إذا كان العنصر الحالي هو العنصر svg الخارجي. |
...
| [getNearestViewportElement](../../com.aspose.html.dom.svg/svggraphicselement/nearestviewportelement/) العنصر الذي أنشأ مساحة العرض الحالية. غالبًا ما يكون العنصر الأب الأقرب ‘svg’. يكون null إذا كان العنصر الحالي هو العنصر svg الخارجي. |
...
| [getOwnerSVGElement](../../com.aspose.html.dom.svg/svgelement/ownersvgelement/) أقرب عنصر ‘svg’ سلف. Null إذا كان العنصر المعطى هو العنصر svg الخارجي الأكثر. |
...
| [getPathLength](../../com.aspose.html.dom.svg/svggeometryelement/pathlength/) يتطابق مع السمة pathLength على العنصر المحدد. |
[getPathSegList]
...
| [getRequiredExtensions](../../com.aspose.html.dom.svg/svggraphicselement/requiredextensions/) يتطابق مع السمة ‘requiredExtensions’ في العنصر المعطى. |
| [getRequiredFeatures](../../com.aspose.html.dom.svg/svggraphicselement/requiredfeatures/) يتطابق مع السمة ‘requiredFeatures’ في العنصر المعطى. |
| [getShadowRoot](../../com.aspose.html.dom/element/shadowroot/) يرجع shadowRoot المخزن على هذا العنصر أو null إذا كان مغلقًا. |
| [getStyle](../../com.aspose.html.dom.svg/svgelement/style/) يتوافق مع السمة ‘style’ في العنصر المعطى. إذا لم يدعم عميل المستخدم التنسيق باستخدام CSS، يجب أن تكون قيمة هذه السمة دائمًا null. |
| [getSystemLanguage](../../com.aspose.html.dom.svg/svggraphicselement/systemlanguage/) يتطابق مع السمة ‘systemLanguage’ في العنصر المعطى. |
...
| [getTransform](../../com.aspose.html.dom.svg/svggraphicselement/transform/) يتطابق مع السمة ‘transform’ في العنصر المعطى. |
| [getViewportElement](../../com.aspose.html.dom.svg/svgelement/viewportelement/) العنصر الذي أنشأ نافذة العرض الحالية. غالبًا ما يكون أقرب عنصر ‘svg’ سلف. Null إذا كان العنصر المعطى هو العنصر svg الخارجي الأكثر. |
...
| [createSVGPathSegArcAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegarcabs/)(float, float, float, float, float, bool, bool) | يرجع كائن SVGPathSegArcAbs مستقل ولا يملك أبًا. |
| [createSVGPathSegArcRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegarcrel/)(float, float, float, float, float, bool, bool) | يرجع كائن SVGPathSegArcRel مستقل ولا يملك أبًا. |
| [createSVGPathSegClosePath](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegclosepath/)() | يرجع كائن SVGPathSegClosePath مستقل ولا يملك أبًا. |
| [createSVGPathSegCurvetoCubicAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicabs/)(float, float, float, float, float, float) | يرجع كائن SVGPathSegCurvetoCubicAbs مستقل ولا يملك أبًا. |
| [createSVGPathSegCurvetoCubicRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicrel/)(float, float, float, float, float, float) | يرجع كائن SVGPathSegCurvetoCubicRel مستقل ولا يملك أبًا. |
| [createSVGPathSegCurvetoCubicSmoothAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothabs/)(float, float, float, float) | يرجع كائن SVGPathSegCurvetoCubicSmoothAbs مستقل ولا يملك أبًا. |
| [createSVGPathSegCurvetoCubicSmoothRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothrel/)(float, float, float, float) | يرجع كائن SVGPathSegCurvetoCubicSmoothRel مستقل ولا يملك أبًا. |
| [createSVGPathSegCurvetoQuadraticAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticabs/)(float, float, float, float) | يرجع كائن SVGPathSegCurvetoQuadraticAbs مستقل بدون أصل. |
| [createSVGPathSegCurvetoQuadraticRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticrel/)(float, float, float, float) | يرجع كائن SVGPathSegCurvetoQuadraticRel مستقل بدون أصل. |
| [createSVGPathSegCurvetoQuadraticSmoothAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothabs/)(float, float) | يرجع كائن SVGPathSegCurvetoQuadraticSmoothAbs مستقل بدون أصل. |
| [createSVGPathSegCurvetoQuadraticSmoothRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothrel/)(float, float) | يرجع كائن SVGPathSegCurvetoQuadraticSmoothRel مستقل بدون أصل. |
| [createSVGPathSegLinetoAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoabs/)(float, float) | يرجع كائن SVGPathSegLinetoAbs مستقل بدون أصل. |
| [createSVGPathSegLinetoHorizontalAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetohorizontalabs/)(float) | يرجع كائن SVGPathSegLinetoHorizontalAbs مستقل بدون أصل. |
| [createSVGPathSegLinetoHorizontalRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetohorizontalrel/)(float) | يرجع كائن SVGPathSegLinetoHorizontalRel مستقل بدون أصل. |
| [createSVGPathSegLinetoRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetorel/)(float, float) | يرجع كائن SVGPathSegLinetoRel مستقل بدون أصل. |
| [createSVGPathSegLinetoVerticalAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoverticalabs/)(float) | يرجع كائن SVGPathSegLinetoVerticalAbs مستقل بدون أصل. |
| [createSVGPathSegLinetoVerticalRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoverticalrel/)(float) | يرجع كائن SVGPathSegLinetoVerticalRel مستقل بدون أصل. |
| [createSVGPathSegMovetoAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegmovetoabs/)(float, float) | يرجع كائن SVGPathSegMovetoAbs مستقل بدون أصل. |
| [createSVGPathSegMovetoRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegmovetorel/)(float, float) | يرجع كائن SVGPathSegMovetoRel مستقل بدون أصل. |
...
| [getBBox](../../com.aspose.html.dom.svg/svggraphicselement/getbbox/)() | يرجع الصندوق المحيط الضيق في مساحة المستخدم الحالية (أي بعد تطبيق سمة ‘transform’ إذا وجدت) على هندسة جميع عناصر الرسومات المتضمنة، مستثنياً تأثيرات التحديد، والقص، والتمويه، والفلاتر. لاحظ أن getBBox يجب أن تُعيد الصندوق المحيط الفعلي في الوقت الذي تم استدعاء الطريقة فيه، حتى في حال لم يتم عرض العنصر بعد. |
| [getCTM](../../com.aspose.html.dom.svg/svggraphicselement/getctm/)() | يرجع مصفوفة التحويل من وحدات المستخدم الحالية (أي بعد تطبيق سمة ‘transform’ إذا وجدت) إلى نظام إحداثيات مساحة العرض لعنصر nearestViewportElement. |
...
| [getEquivalentPath](../../com.aspose.html.dom.svg/svggeometryelement/getequivalentpath/)() | يعيد نسخة جديدة من [`SVGPathSegList`](../../com.aspose.html.dom.svg.paths/svgpathseglist/) التي تمثل [`SVGGeometryElement`](../svggeometryelement/) كقطاعات مسار. |
| [getPlatformType](../../com.aspose.html.dom/domobject/getplatformtype/)() | يُستخدم هذا الأسلوب لاسترجاع كائن ECMAScript. |
| [getPointAtLength](../../com.aspose.html.dom.svg/svggeometryelement/getpointatlength/)(float) | يعيد إحداثيات (x,y) في مساحة المستخدم والتي تمثل وحدات المسافة على طول المسار، باستخدام خوارزمية المسافة-على-المسار الخاصة بوكيل المستخدم. |
| [getScreenCTM](../../com.aspose.html.dom.svg/svggraphicselement/getscreenctm/)() | يرجع مصفوفة التحويل من وحدات المستخدم الحالية (أي بعد تطبيق سمة ‘transform’ إذا وجدت) إلى ملاحظة وكيل المستخدم الأب لـ "pixel". لأجهزة العرض، يمثل عادة بكسل الشاشة الفعلي. للأجهزة أو البيئات الأخرى التي لا تُعرف أحجام البكسل الفعلية، يمكن استخدام خوارزمية مشابهة لتعريف CSS2 للـ "pixel". لاحظ أن القيمة null تُعاد إذا لم يكن هذا العنصر مرتبطًا بشجرة المستند. كان من الأنسب تسمية هذه الطريقة getClientCTM، لكن تم الإبقاء على الاسم getScreenCTM لأسباب تاريخية. |
| [getTotalLength](../../com.aspose.html.dom.svg/svggeometryelement/gettotallength/)() | يعيد القيمة المحسوبة من قبل وكيل المستخدم للطول الكلي للمسار باستخدام خوارزمية المسافة-على-المسار الخاصة بوكيل المستخدم، كمسافة في نظام إحداثيات المستخدم الحالي. |
