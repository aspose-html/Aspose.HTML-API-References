...
description: "com.aspose.html.dom.svg.SVGPathElement class. واجهة SVGPathElement تتطابق مع عنصر path."
type: docs
...
| الاسم | الوصف |
| --- | --- |
| [getAnimatedPathSegList](../../com.aspose.html.dom.svg/svgpathelement/animatedpathseglist/) يوفر الوصول إلى المحتويات المتحركة الحالية للسمة ‘d’ بصيغة تتطابق واحدًا لواحد مع صياغة SVG. إذا كانت السمة أو الخاصية المحددة قيد التحريك، فإنها تحتوي على القيمة المتحركة الحالية للسمة أو الخاصية، وكلا من الكائن نفسه ومحتوياته للقراءة فقط. إذا لم تكن السمة أو الخاصية المحددة قيد التحريك حاليًا، فإنها تحتوي على نفس القيمة كما في pathSegList. |
...
| [getClassName](../../com.aspose.html.dom.svg/svgelement/classname/) يتطابق مع السمة ‘class’ على العنصر المحدد. |
[getClassName]
...
| [getFarthestViewportElement](../../com.aspose.html.dom.svg/svggraphicselement/farthestviewportelement/) العنصر الأب الأبعد ‘svg’. Null إذا كان العنصر الحالي هو العنصر svg الخارجي. |
...
| [getNearestViewportElement](../../com.aspose.html.dom.svg/svggraphicselement/nearestviewportelement/) العنصر الذي أنشأ مساحة العرض الحالية. غالبًا ما يكون أقرب عنصر أب ‘svg’. Null إذا كان العنصر الحالي هو العنصر svg الخارجي. |
...
| [getOwnerSVGElement](../../com.aspose.html.dom.svg/svgelement/ownersvgelement/) أقرب عنصر ‘svg’ سلف. Null إذا كان العنصر المعطى هو عنصر svg الخارجي. |
...
| [getRequiredExtensions](../../com.aspose.html.dom.svg/svggraphicselement/requiredextensions/) يتطابق مع السمة ‘requiredExtensions’ على العنصر المعطى. |
| [getRequiredFeatures](../../com.aspose.html.dom.svg/svggraphicselement/requiredfeatures/) يتطابق مع السمة ‘requiredFeatures’ على العنصر المعطى. |
| [getShadowRoot](../../com.aspose.html.dom/element/shadowroot/) يعيد shadowRoot المخزن على هذا العنصر أو null إذا كان مغلقًا. |
| [getStyle](../../com.aspose.html.dom.svg/svgelement/style/) يتطابق مع السمة ‘style’ في العنصر المعطى. إذا لم يدعم عميل المستخدم التنسيق باستخدام CSS، يجب أن تكون قيمة هذه السمة دائمًا null. |
| [getSystemLanguage](../../com.aspose.html.dom.svg/svggraphicselement/systemlanguage/) يتطابق مع السمة ‘systemLanguage’ على العنصر المعطى. |
...
| [getTransform](../../com.aspose.html.dom.svg/svggraphicselement/transform/) يتطابق مع السمة ‘transform’ على العنصر المعطى. |
| [getViewportElement](../../com.aspose.html.dom.svg/svgelement/viewportelement/) العنصر الذي أنشأ نافذة العرض الحالية. غالبًا ما يكون أقرب عنصر ‘svg’ سلف. Null إذا كان العنصر المعطى هو عنصر svg الخارجي. |
...
| [createSVGPathSegArcAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegarcabs/)(float, float, float, float, float, bool, bool) | يعيد كائن SVGPathSegArcAbs مستقل بدون أصل. |
| [createSVGPathSegArcRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegarcrel/)(float, float, float, float, float, bool, bool) | يعيد كائن SVGPathSegArcRel مستقل بدون أصل. |
| [createSVGPathSegClosePath](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegclosepath/)() | يعيد كائن SVGPathSegClosePath مستقل بدون أصل. |
| [createSVGPathSegCurvetoCubicAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicabs/)(float, float, float, float, float, float) | يعيد كائن SVGPathSegCurvetoCubicAbs مستقل بدون أصل. |
| [createSVGPathSegCurvetoCubicRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicrel/)(float, float, float, float, float, float) | يعيد كائن SVGPathSegCurvetoCubicRel مستقل بدون أصل. |
| [createSVGPathSegCurvetoCubicSmoothAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothabs/)(float, float, float, float) | يعيد كائن SVGPathSegCurvetoCubicSmoothAbs مستقل بدون أصل. |
| [createSVGPathSegCurvetoCubicSmoothRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothrel/)(float, float, float, float) | يعيد كائن SVGPathSegCurvetoCubicSmoothRel مستقل بدون أصل. |
| [createSVGPathSegCurvetoQuadraticAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticabs/)(float, float, float, float) | يرجع كائن SVGPathSegCurvetoQuadraticAbs مستقل بدون أب. |
| [createSVGPathSegCurvetoQuadraticRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticrel/)(float, float, float, float) | يرجع كائن SVGPathSegCurvetoQuadraticRel مستقل بدون أب. |
| [createSVGPathSegCurvetoQuadraticSmoothAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothabs/)(float, float) | يرجع كائن SVGPathSegCurvetoQuadraticSmoothAbs مستقل بدون أب. |
| [createSVGPathSegCurvetoQuadraticSmoothRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothrel/)(float, float) | يرجع كائن SVGPathSegCurvetoQuadraticSmoothRel مستقل بدون أب. |
| [createSVGPathSegLinetoAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoabs/)(float, float) | يرجع كائن SVGPathSegLinetoAbs مستقل بدون أب. |
| [createSVGPathSegLinetoHorizontalAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetohorizontalabs/)(float) | يرجع كائن SVGPathSegLinetoHorizontalAbs مستقل بدون أب. |
| [createSVGPathSegLinetoHorizontalRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetohorizontalrel/)(float) | يرجع كائن SVGPathSegLinetoHorizontalRel مستقل بدون أب. |
| [createSVGPathSegLinetoRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetorel/)(float, float) | يرجع كائن SVGPathSegLinetoRel مستقل بدون أب. |
| [createSVGPathSegLinetoVerticalAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoverticalabs/)(float) | يرجع كائن SVGPathSegLinetoVerticalAbs مستقل بدون أب. |
| [createSVGPathSegLinetoVerticalRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoverticalrel/)(float) | يرجع كائن SVGPathSegLinetoVerticalRel مستقل بدون أب. |
| [createSVGPathSegMovetoAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegmovetoabs/)(float, float) | يرجع كائن SVGPathSegMovetoAbs مستقل بدون أب. |
| [createSVGPathSegMovetoRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegmovetorel/)(float, float) | يرجع كائن SVGPathSegMovetoRel مستقل بدون أب. |
...
| [getBBox](../../com.aspose.html.dom.svg/svggraphicselement/getbbox/)() | يرجع الصندوق الحدّي الضيق في مساحة المستخدم الحالية (أي بعد تطبيق سمة ‘transform’ إن وجدت) على هندسة جميع عناصر الرسومات المتضمنة، مستثنياً التحديد، القص، القناع وتأثيرات الفلتر). لاحظ أن getBBox يجب أن يُعيد الصندوق الحدّي الفعلي في الوقت الذي تم فيه استدعاء الطريقة، حتى إذا لم يتم بعد رسم العنصر. |
| [getCTM](../../com.aspose.html.dom.svg/svggraphicselement/getctm/)() | يرجع مصفوفة التحويل من وحدات المستخدم الحالية (أي بعد تطبيق سمة ‘transform’ إن وجدت) إلى نظام إحداثيات مساحة العرض للعنصر nearestViewportElement. |
...
| [getEquivalentPath](../../com.aspose.html.dom.svg/svggeometryelement/getequivalentpath/)() | يعيد كائنًا جديدًا من [`SVGPathSegList`](../../com.aspose.html.dom.svg.paths/svgpathseglist/) الذي يمثل [`SVGGeometryElement`](../svggeometryelement/) كقطاعات مسار. |
...
| [getScreenCTM](../../com.aspose.html.dom.svg/svggraphicselement/getscreenctm/)() | يرجع مصفوفة التحويل من وحدات المستخدم الحالية (أي بعد تطبيق سمة ‘transform’ إن وجدت) إلى ملاحظة الوكيل المستخدم الأب للـ \"pixel\". بالنسبة لأجهزة العرض، يمثل هذا عادةً بكسل الشاشة الفعلي. بالنسبة للأجهزة أو البيئات الأخرى التي لا تُعرف فيها أحجام البكسل الفعلية، يمكن استخدام خوارزمية مشابهة لتعريف CSS2 للـ \"pixel\". لاحظ أن القيمة Null تُعاد إذا لم يكن هذا العنصر مرتبطًا بشجرة المستند. كان من الأنسب تسمية هذه الطريقة getClientCTM، لكن تم الإبقاء على الاسم getScreenCTM لأسباب تاريخية. |
