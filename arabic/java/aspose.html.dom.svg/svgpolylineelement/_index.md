...
| الاسم | الوصف |
| --- | --- |
| [getAnimatedPoints](../../com.aspose.html.dom.svg/svgpolylineelement/animatedpoints/) يوفر الوصول إلى المحتويات المتحركة الحالية لخاصية ‘points’. إذا كانت الخاصية أو السمة المحددة قيد التحريك، يحتوي على القيمة المتحركة الحالية. إذا لم تكن الخاصية أو السمة قيد التحريك حالياً، يحتوي على نفس قيمة points. |
