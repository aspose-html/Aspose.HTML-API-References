---
title: "فئة SVGPolygonElement"
second_title: "مرجع API لـ Aspose.HTML for Java"
description: "الفئة com.aspose.html.dom.svg.SVGPolygonElement. واجهة SVGPolygonElement تتطابق مع عنصر المضلع."
type: docs

url: /ar/java/com.aspose.html.dom.svg/svgpolygonelement/
---
## SVGPolygonElement class

واجهة SVGPolygonElement تتطابق مع العنصر ‘polygon’.
...
| الاسم | الوصف |
| --- | --- |
| [getAnimatedPoints](../../com.aspose.html.dom.svg/svgpolygonelement/animatedpoints/) يوفر الوصول إلى المحتويات المتحركة الحالية لخاصية ‘points’. إذا كانت الخاصية أو السمة المحددة تُحرك حاليًا، فإنه يحتوي على القيمة المتحركة الحالية للخاصية أو السمة. إذا لم تكن الخاصية أو السمة تُحرك حاليًا، فإنه يحتوي على نفس القيمة كما في points. |
...
| [getPoints](../../com.aspose.html.dom.svg/svgpolygonelement/points/) يوفر الوصول إلى المحتويات الأساسية (أي الثابتة) لخاصية ‘points’. |
