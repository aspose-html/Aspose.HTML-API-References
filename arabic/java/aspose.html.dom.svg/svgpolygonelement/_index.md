...
| الاسم | الوصف |
| --- | --- |
| [getAnimatedPoints](../../com.aspose.html.dom.svg/svgpolygonelement/animatedpoints/) يوفر وصولًا إلى المحتوى المتحرك الحالي لخاصية ‘points’. إذا كانت الخاصية أو السمة المحددة متحركة، فإنها تحتوي على القيمة المتحركة الحالية للخاصية أو السمة. إذا لم تكن الخاصية أو السمة متحركة حاليًا، فإنها تحتوي على نفس قيمة points. |
...
| [getPoints](../../com.aspose.html.dom.svg/svgpolygonelement/points/) يوفر وصولًا إلى المحتوى الأساسي (أي الثابت) لخاصية ‘points’. |
