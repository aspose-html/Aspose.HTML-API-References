...
يحفظ المستند إلى ملف محلي محدد بـ `url`. سيتم حفظ جميع الموارد المستخدمة في هذا المستند في مجلد مجاور، سيُنشأ اسمه كالتالي: output_file_name + \"_files\".
...
يحفظ المستند إلى ملف محلي محدد بـ `path`. سيتم حفظ جميع الموارد المستخدمة في هذا المستند في مجلد مجاور، سيُنشأ اسمه كالتالي: output_file_name + \"_files\".
...
| --- | --- | --- |
| المسار | String | المسار المحلي لملف الإخراج. |
| saveFormat | SVGSaveFormat | الصيغة التي يتم حفظ المستند بها. |
