---
title: "فئة SVGMarkerElement"
second_title: "مرجع API لـ Aspose.HTML for Java"
description: "الفئة com.aspose.html.dom.svg.SVGMarkerElement. الواجهة SVGMarkerElement تتطابق مع عنصر marker."
type: docs

url: /ar/java/com.aspose.html.dom.svg/svgmarkerelement/
---
## SVGMarkerElement class

واجهة SVGMarkerElement تتطابق مع العنصر ‘marker’.
...
| [getMarkerHeight](../../com.aspose.html.dom.svg/svgmarkerelement/markerheight/) يتطابق مع السمة ‘markerHeight’ على عنصر ‘marker’ المحدد. |
| [getMarkerUnits](../../com.aspose.html.dom.svg/svgmarkerelement/markerunits/) يتطابق مع السمة ‘markerUnits’ على عنصر ‘marker’ المحدد. أحد أنواع وحدة العلامة (Marker Unit Types) المعرفة في هذه الواجهة. |
| [getMarkerWidth](../../com.aspose.html.dom.svg/svgmarkerelement/markerwidth/) يتطابق مع السمة ‘markerWidth’ على العنصر ‘marker’ المعطى. |
...
| [getOrientAngle](../../com.aspose.html.dom.svg/svgmarkerelement/orientangle/) يتطابق مع السمة ‘orient’ على العنصر ‘marker’ المعطى. إذا كان markerUnits هو SVG_MARKER_ORIENT_ANGLE، فإن قيمة الزاوية للسمة ‘orient’; وإلا، سيتم تعيينها إلى صفر. |
| [getOrientType](../../com.aspose.html.dom.svg/svgmarkerelement/orienttype/) يتطابق مع السمة ‘orient’ على العنصر ‘marker’ المعطى. أحد أنواع توجيه العلامة المعرفة في هذه الواجهة. |
[getOuterHTML]
...
| [getPreserveAspectRatio](../../com.aspose.html.dom.svg/svgmarkerelement/preserveaspectratio/) يتطابق مع السمة ‘preserveAspectRatio’ على العنصر المعطى. |
...
| [getRefX](../../com.aspose.html.dom.svg/svgmarkerelement/refx/) يتطابق مع السمة ‘refX’ على العنصر ‘marker’ المعطى. |
| [getRefY](../../com.aspose.html.dom.svg/svgmarkerelement/refy/) يتطابق مع السمة ‘refY’ على العنصر ‘marker’ المعطى. |
...
| [getViewBox](../../com.aspose.html.dom.svg/svgmarkerelement/viewbox/) يتطابق مع السمة ‘viewBox’ على العنصر المعطى. |
...
| [setOrientToAngle](../../com.aspose.html.dom.svg/svgmarkerelement/setorienttoangle/)(SVGAngle) | يضبط قيمة السمة ‘orient’ إلى الزاوية المعطاة. |
| [setOrientToAuto](../../com.aspose.html.dom.svg/svgmarkerelement/setorienttoauto/)() | يضبط قيمة السمة ‘orient’ إلى 'auto'. |
...
| الاسم | الوصف |
| --- | --- |
| const [SVG_MARKERUNITS_STROKEWIDTH](../../com.aspose.html.dom.svg/svgmarkerelement/svg_markerunits_strokewidth/) | قيمة السمة ‘markerUnits’ هي 'strokeWidth'. |
| const [SVG_MARKERUNITS_UNKNOWN](../../com.aspose.html.dom.svg/svgmarkerelement/svg_markerunits_unknown/) | نوع وحدة العلامة ليس أحد الأنواع المعرفة مسبقًا. من غير الصالح محاولة تعريف قيمة جديدة من هذا النوع أو محاولة تحويل قيمة موجودة إلى هذا النوع. |
| const [SVG_MARKERUNITS_USERSPACEONUSE](../../com.aspose.html.dom.svg/svgmarkerelement/svg_markerunits_userspaceonuse/) | قيمة السمة ‘markerUnits’ هي 'userSpaceOnUse'. |
| const [SVG_MARKER_ORIENT_ANGLE](../../com.aspose.html.dom.svg/svgmarkerelement/svg_marker_orient_angle/) | السمة ‘orient’ لها قيمة زاوية. |
| const [SVG_MARKER_ORIENT_AUTO](../../com.aspose.html.dom.svg/svgmarkerelement/svg_marker_orient_auto/) | السمة ‘orient’ لها القيمة 'auto'. |
| const [SVG_MARKER_ORIENT_UNKNOWN](../../com.aspose.html.dom.svg/svgmarkerelement/svg_marker_orient_unknown/) | توجيه العلامة ليس أحد الأنواع المعرفة مسبقًا. من غير الصالح محاولة تعريف قيمة جديدة من هذا النوع أو محاولة تحويل قيمة موجودة إلى هذا النوع. |
