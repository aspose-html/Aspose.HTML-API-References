---
title: "فئة SVGGradientElement"
second_title: "مرجع API لـ Aspose.HTML for Java"
description: "الفئة com.aspose.html.dom.svg.SVGGradientElement. الواجهة SVGGradientElement هي واجهة أساسية تُستخدم بواسطة SVGLinearGradientElement و SVGRadialGradientElement."
type: docs

url: /ar/java/com.aspose.html.dom.svg/svggradientelement/
---
## SVGGradientElement class

واجهة SVGGradientElement هي واجهة أساسية تُستخدم بواسطة SVGLinearGradientElement و SVGRadialGradientElement.
...
| [getGradientTransform](../../com.aspose.html.dom.svg/svggradientelement/gradienttransform/) يتطابق مع السمة ‘gradientTransform’ في العنصر المحدد. |
| [getGradientUnits](../../com.aspose.html.dom.svg/svggradientelement/gradientunits/) يتطابق مع السمة ‘gradientUnits’ في العنصر المحدد. يأخذ واحدة من الثوابت المعرفة في SVGUnitTypes. |
| [getHref](../../com.aspose.html.dom.svg/svggradientelement/href/) يتطابق مع السمة ‘xlink:href’ في العنصر المحدد. |
[getId]
...
| [getSpreadMethod](../../com.aspose.html.dom.svg/svggradientelement/spreadmethod/) يتطابق مع السمة ‘spreadMethod’ على العنصر المعطى. أحد أنواع طريقة الانتشار المحددة في هذه الواجهة. |
...
| الاسم | الوصف |
| --- | --- |
| const [SVG_SPREADMETHOD_PAD](../../com.aspose.html.dom.svg/svggradientelement/svg_spreadmethod_pad/) | يتطابق مع القيمة 'pad'. |
| const [SVG_SPREADMETHOD_REFLECT](../../com.aspose.html.dom.svg/svggradientelement/svg_spreadmethod_reflect/) | يتطابق مع القيمة 'reflect'. |
| const [SVG_SPREADMETHOD_REPEAT](../../com.aspose.html.dom.svg/svggradientelement/svg_spreadmethod_repeat/) | يتطابق مع القيمة 'repeat'. |
| const [SVG_SPREADMETHOD_UNKNOWN](../../com.aspose.html.dom.svg/svggradientelement/svg_spreadmethod_unknown/) | النوع ليس أحد الأنواع المعرفة مسبقًا. من غير الصالح محاولة تعريف قيمة جديدة لهذا النوع أو محاولة تحويل قيمة موجودة إلى هذا النوع. |
