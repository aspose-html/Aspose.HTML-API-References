---
title: "الفئة SVGElement"
second_title: "مرجع API لـ Aspose.HTML for Java"
description: "الفئة com.aspose.html.dom.svg.SVGElement. جميع واجهات SVG DOM التي تتطابق مباشرةً مع العناصر في لغة SVG مثل واجهة SVGPathElement لعنصر path، تُشتق من واجهة SVGElement."
type: docs

url: /ar/java/com.aspose.html.dom.svg/svgelement/
---
## SVGElement class

جميع واجهات SVG DOM التي تتطابق مباشرةً مع العناصر في لغة SVG (مثل واجهة SVGPathElement للعنصر ‘path’) تُشتق من واجهة SVGElement.
