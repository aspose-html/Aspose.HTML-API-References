---
title: "فئة SVGElement"
second_title: "مرجع API لـ Aspose.HTML للـ Java"
description: "الفئة com.aspose.html.dom.svg.SVGElement. جميع واجهات DOM الخاصة بـ SVG التي تتطابق مباشرةً مع العناصر في لغة SVG مثل واجهة SVGPathElement لعنصر path، تُشتق من واجهة SVGElement."
type: docs
...
جميع واجهات SVG DOM التي تتطابق مباشرةً مع عناصر لغة SVG (مثل واجهة SVGPathElement للعنصر ‘path’) تُشتق من واجهة SVGElement.
