...
description: "com.aspose.html.dom.svg.SVGTextContentElement class. الـ SVGTextContentElement موروث من قبل واجهات متعددة متعلقة بالنص مثل SVGTextElement و SVGTSpanElement و SVGTRefElement و SVGAltGlyphElement و SVGTextPathElement. بالنسبة للطرق في هذه الواجهة التي تشير إلى فهرس حرف أو عدد أحرف، يجب تفسير هذه الإشارات كفهرس إلى وحدة شفرة UTF-16 أو عدد وحدات شفرة UTF-16 على التوالي. هذا لضمان التوافق مع DOM Level 2 Core حيث تستخدم الطرق في واجهة CharacterData وحدات شفرة UTF-16 كفهارس وعدّ داخل بيانات الأحرف. وبالتالي، على سبيل المثال، إذا كان محتوى نص عنصر نص هو حرف واحد غير BMP مثل U10000، فإن استدعاء getNumberOfChars على ذلك العنصر سيعيد 2 لأن هناك وحدتي شفرة UTF-16 (الزوج البديل) المستخدمة لتمثيل ذلك الحرف الواحد."
type: docs
...
تُورّث واجهة SVGTextContentElement من قبل واجهات متعددة متعلقة بالنص، مثل SVGTextElement و SVGTSpanElement و SVGTRefElement و SVGAltGlyphElement و SVGTextPathElement. بالنسبة للطرق في هذه الواجهة التي تشير إلى فهرس حرف أو عدد أحرف، يجب تفسير هذه الإشارات كفهرس لوحدة شفرة UTF-16 أو عدد وحدات شفرة UTF-16، على التوالي. هذا لتوافق مع DOM Level 2 Core، حيث تستخدم طرق واجهة CharacterData وحدات شفرة UTF-16 كفهارس وعدّ داخل بيانات الأحرف. وبالتالي، على سبيل المثال، إذا كان محتوى النص لعنصر ‘text’ هو حرف واحد غير موجود في BMP، مثل U+10000، فإن استدعاء getNumberOfChars على ذلك العنصر سيعيد 2 لأن هناك وحدتي شفرة UTF-16 (الزوج البديل) تُستخدم لتمثيل ذلك الحرف الواحد.
...
| [getComputedTextLength](../../com.aspose.html.dom.svg/svgtextcontentelement/getcomputedtextlength/)() | المجموع الكلي لجميع قيم التقدم الناتجة عن عرض جميع الأحرف داخل هذا العنصر، بما في ذلك قيمة التقدم على الرموز (أفقية أو عمودية)، وتأثير الخصائص ‘kerning’ و‘letter-spacing’ و‘word-spacing’ والتعديلات الناتجة عن السمات ‘dx’ و‘dy’ في عناصر ‘tspan’. في بيئات غير العرض، يجب على وكيل المستخدم إجراء افتراضات معقولة حول مقاييس الرموز. |
...
| [getNumberOfChars](../../com.aspose.html.dom.svg/svgtextcontentelement/getnumberofchars/)() | يعيد العدد الإجمالي للأحرف المتاحة للعرض داخل العنصر الحالي، والتي تشمل الأحرف المشار إليها من مرجع ‘tref’، بغض النظر عما إذا كانت ستُعرض أم لا. عمليًا، هذا يعادل طول سمة Node::textContent من DOM المستوى 3 Core ([DOM3]، القسم 1.4)، إذا كانت تلك السمة توسع أيضًا عناصر ‘tref’. |
