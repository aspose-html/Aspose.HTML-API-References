---
title: "فئة SVGTextContentElement"
second_title: "مرجع API لـ Aspose.HTML for Java"
description: "com.aspose.html.dom.svg.SVGTextContentElement class. تُورّث فئة SVGTextContentElement من قبل واجهات متعددة متعلقة بالنص مثل SVGTextElement و SVGTSpanElement و SVGTRefElement و SVGAltGlyphElement و SVGTextPathElement. بالنسبة للطرق في هذه الواجهة التي تشير إلى فهرس حرف أو عدد أحرف، يجب تفسير هذه الإشارات على أنها فهرس إلى وحدة شفرة UTF-16 أو عدد وحدات شفرة UTF-16 على التوالي. هذا للتوافق مع DOM Level 2 Core حيث تستخدم طرق واجهة CharacterData وحدات شفرة UTF-16 كفهارس وعدّ داخل بيانات الأحرف. وبالتالي، على سبيل المثال، إذا كان محتوى النص لعنصر نص هو حرف واحد غير BMP مثل U10000، فإن استدعاء getNumberOfChars على ذلك العنصر سيعيد 2 لأن هناك وحدتي شفرة UTF-16 (الزوج البديل) المستخدمة لتمثيل ذلك الحرف الواحد."
type: docs

url: /ar/java/com.aspose.html.dom.svg/svgtextcontentelement/
---
## SVGTextContentElement class

يتم توريث SVGTextContentElement من قبل واجهات متعددة متعلقة بالنص، مثل SVGTextElement و SVGTSpanElement و SVGTRefElement و SVGAltGlyphElement و SVGTextPathElement. بالنسبة للطرق في هذه الواجهة التي تشير إلى فهرس حرف أو عدد أحرف، يجب تفسير هذه الإشارات كفهرس إلى وحدة شفرة UTF-16 أو عدد وحدات شفرة UTF-16، على التوالي. هذا لضمان التوافق مع DOM Level 2 Core، حيث تستخدم طرق واجهة CharacterData وحدات شفرة UTF-16 كفهارس وعدّ داخل بيانات الأحرف. وبالتالي، على سبيل المثال، إذا كان محتوى النص لعنصر ‘text’ هو حرف واحد غير موجود في BMP، مثل U+10000، فإن استدعاء getNumberOfChars على ذلك العنصر سيعيد 2 لأن هناك وحدتي شفرة UTF-16 (الزوج البديل) تُستخدم لتمثيل ذلك الحرف الواحد.
...
| [getLengthAdjust](../../com.aspose.html.dom.svg/svgtextcontentelement/lengthadjust/) يتطابق مع السمة ‘lengthAdjust’ في العنصر المحدد. يجب أن تكون القيمة واحدة من الثوابت الخاصة بضبط الطول المعرفة في هذه الواجهة. |
...
| [getTextLength](../../com.aspose.html.dom.svg/svgtextcontentelement/textlength/) يتطابق مع السمة ‘textLength’ في العنصر المحدد. |
...
| [getComputedTextLength](../../com.aspose.html.dom.svg/svgtextcontentelement/getcomputedtextlength/)() | المجموع الكلي لجميع قيم التقدم الناتجة عن عرض جميع الأحرف داخل هذا العنصر، بما في ذلك قيمة التقدم على الحروف (أفقية أو عمودية)، وتأثير الخصائص ‘kerning’ و‘letter-spacing’ و‘word-spacing’ والتعديلات الناجمة عن السمات ‘dx’ و‘dy’ على عناصر ‘tspan’. بالنسبة للبيئات غير العارضة، يجب على وكيل المستخدم أن يقوم بفرض افتراضات معقولة حول مقاييس الحروف. |
...
| [getNumberOfChars](../../com.aspose.html.dom.svg/svgtextcontentelement/getnumberofchars/)() | يعيد العدد الإجمالي للأحرف المتاحة للعرض داخل العنصر الحالي، بما يشمل الأحرف المشار إليها من مرجع ‘tref’، بغض النظر عما إذا كانت ستُعرض أم لا. عمليًا، هذا يعادل طول سمة Node::textContent من DOM Level 3 Core ([DOM3]، القسم 1.4)، إذا كانت تلك السمة توسّعت أيضًا لتشمل عناصر ‘tref’. |
...
| الاسم | الوصف |
| --- | --- |
| const [LENGTHADJUST_SPACING](../../com.aspose.html.dom.svg/svgtextcontentelement/lengthadjust_spacing/) | يتطابق مع القيمة 'spacing'. |
| const [LENGTHADJUST_SPACINGANDGLYPHS](../../com.aspose.html.dom.svg/svgtextcontentelement/lengthadjust_spacingandglyphs/) | يتطابق مع القيمة 'spacingAndGlyphs'. |
| const [LENGTHADJUST_UNKNOWN](../../com.aspose.html.dom.svg/svgtextcontentelement/lengthadjust_unknown/) | تم تعيين التعداد إلى قيمة ليست أحد الأنواع المعرفة مسبقًا. من غير الصالح محاولة تعريف قيمة جديدة لهذا النوع أو محاولة تحويل قيمة موجودة إلى هذا النوع. |
