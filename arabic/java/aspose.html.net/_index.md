...
description: "حزمة com.aspose.html.net تُقدَّم بواسطة فئات وواجهات مسؤولة عن تسهيل معالجة الشبكة."
type: docs

url: /ar/java/com.aspose.html.net/
---
الحزمة **com.aspose.html.net** تتكون من فئات وواجهات مسؤولة عن تسهيل معالجة الشبكة.
...
| [MessageFilter](./messagefilter/) | يمثل الفئة الأساسية المجردة لفئات الفلاتر المختلفة المستخدمة لاستعلام الرسائل |
| [MessageHandler](./messagehandler/) | يمثل نوعًا أساسيًا لمعالجات الرسائل. |
| [MessageHandlerCollection](./messagehandlercollection/) | يمثل مجموعة من [`MessageHandler`](../com.aspose.html.net/messagehandler/). |
