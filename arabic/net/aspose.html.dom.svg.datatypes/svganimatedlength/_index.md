...
description: تُستخدم للسمات ذات طول النوع الأساسي التي يمكن تحريكها.
type: docs
weight: 1120
url: /ar/net/aspose.html.dom.svg.datatypes/svganimatedlength/
---
## SVGAnimatedLength class

تُستخدم للسمات ذات طول النوع الأساسي التي يمكن تحريكها.
...
| override [ToString](../../aspose.html.dom.svg.datatypes/svganimatedlength/tostring)() | إرجاع أString الذي يمثل هذا المثال. |
