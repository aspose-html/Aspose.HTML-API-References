...
description: Aspose.Html.Dom.Svg.DataTypes.SVGTransformList فصل. تحدد هذه الواجهة قائمة بكائنات SVGTransform.
type: docs
weight: 1310
...
| اسم | وصف |
| --- | --- |
| [SVGTransformList](svgtransformlist/#constructor)() | يقوم بتهيئة مثيل جديد لملف`SVGTransformList` فئة . |
| [SVGTransformList](svgtransformlist/#constructor_1)(IEnumerable&lt;SVGTransform&gt;) | يقوم بتهيئة مثيل جديد لملف`SVGTransformList` فئة . |
