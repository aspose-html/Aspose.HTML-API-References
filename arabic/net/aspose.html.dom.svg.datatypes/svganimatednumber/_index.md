...
description: تُستخدم لسمات رقم النوع الأساسي التي يمكن تحريكها.
type: docs
weight: 1140
url: /ar/net/aspose.html.dom.svg.datatypes/svganimatednumber/
---
## SVGAnimatedNumber class

تُستخدم لسمات رقم النوع الأساسي التي يمكن تحريكها.
...
| override [ToString](../../aspose.html.dom.svg.datatypes/svganimatednumber/tostring)() | إرجاع أString الذي يمثل هذا المثال. |
