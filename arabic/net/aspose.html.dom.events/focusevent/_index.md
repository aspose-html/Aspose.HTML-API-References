...
description: توفر واجهة FocusEvent معلومات سياقية محددة مرتبطة بأحداث التركيز.
type: docs
weight: 790
...
| اسم | وصف |
| --- | --- |
| [FocusEvent](focusevent#constructor)(string) | يقوم بتهيئة مثيل جديد لملف[`FocusEvent`](../focusevent) فئة . |
| [FocusEvent](focusevent#constructor_1)(string, IDictionary&lt;string, object&gt;) | يقوم بتهيئة مثيل جديد لملف[`FocusEvent`](../focusevent) فئة . |
