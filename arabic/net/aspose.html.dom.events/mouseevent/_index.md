...
description: Aspose.Html.Dom.Events.MouseEvent فصل. توفر واجهة MouseEvent معلومات سياقية محددة مرتبطة بأحداث الماوس.
type: docs
weight: 840
url: /ar/net/aspose.html.dom.events/mouseevent/
---
## MouseEvent class
...
| اسم | وصف |
| --- | --- |
| [MouseEvent](mouseevent/#constructor)(string) | يقوم بتهيئة مثيل جديد لملف`MouseEvent` فئة . |
| [MouseEvent](mouseevent/#constructor_1)(string, IDictionary&lt;string, object&gt;) | يقوم بتهيئة مثيل جديد لملف`MouseEvent` فئة . |
