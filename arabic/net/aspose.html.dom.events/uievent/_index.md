...
description: Aspose.Html.Dom.Events.UIEvent فصل. توفر واجهة UIEvent معلومات سياقية محددة مرتبطة بأحداث واجهة المستخدم.
type: docs
weight: 850
...
| اسم | وصف |
| --- | --- |
| [UIEvent](uievent/#constructor)(string) | يقوم بتهيئة مثيل جديد لملف`UIEvent` فئة . |
| [UIEvent](uievent/#constructor_1)(string, IDictionary&lt;string, object&gt;) | يقوم بتهيئة مثيل جديد لملف`UIEvent` فئة . |
