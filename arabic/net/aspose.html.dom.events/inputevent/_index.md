...
description: Aspose.Html.Dom.Events.InputEvent فصل. يتم إرسال أحداث الإدخال كإخطارات عندما يتم تحديث DOM.
type: docs
weight: 820
url: /ar/net/aspose.html.dom.events/inputevent/
---
## InputEvent class
...
| [Data](../../aspose.html.dom.events/inputevent/data/) { get; } | تحتفظ البيانات بقيمة الأحرف التي تم إنشاؤها بواسطة أسلوب الإدخال. قد يكون هذا حرف Unicode واحدًا أو سلسلة غير فارغة من أحرف Unicode [Unicode]. يجب تطبيع الأحرف على النحو المحدد في نموذج تسوية Unicode NFC ، المحدد في [UAX15]. قد تحتوي هذه السمة على سلسلة فارغة. |
...
| [IsComposing](../../aspose.html.dom.events/inputevent/iscomposing/) { get; } | يكون صحيحًا إذا حدث حدث الإدخال كجزء من جلسة تكوين ، أي بعد حدث مقطوعة موسيقية وقبل حدث التكوين المقابل. يجب أن تكون القيمة غير المهيأة لهذه السمة خاطئة. |
