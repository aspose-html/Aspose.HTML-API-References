...
description: يتم إرسال أحداث الإدخال كإخطارات عندما يتم تحديث DOM.
type: docs
weight: 830
...
| اسم | وصف |
| --- | --- |
| [InputEvent](inputevent#constructor)(string) | يقوم بتهيئة مثيل جديد لملف[`InputEvent`](../inputevent) فئة . |
| [InputEvent](inputevent#constructor_1)(string, IDictionary&lt;string, object&gt;) | يقوم بتهيئة مثيل جديد لملف[`InputEvent`](../inputevent) فئة . |
...
| [Data](../../aspose.html.dom.events/inputevent/data) { get; } | تحتفظ البيانات بقيمة الأحرف التي تم إنشاؤها بواسطة أسلوب الإدخال. قد يكون هذا حرف Unicode واحدًا أو سلسلة غير فارغة من أحرف Unicode [Unicode]. يجب تسوية الأحرف على النحو المحدد في نموذج تسوية Unicode NFC ، المحدد في [UAX15]. قد تحتوي هذه السمة على سلسلة فارغة. |
...
| [IsComposing](../../aspose.html.dom.events/inputevent/iscomposing) { get; } | true إذا وقع حدث الإدخال كجزء من جلسة مقطوعة موسيقية ، أي بعد حدث مقطوعة موسيقية وقبل حدث التكوين المقابل. يجب أن تكون القيمة غير المهيأة لهذه السمة خاطئة. |
