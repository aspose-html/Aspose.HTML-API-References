...
description: إذا كان الحدث قابلاً للإلغاء  فإن ملفPreventDefaultaspose.html.dom.events/event/preventdefault يتم استخدام الطريقة للدلالة على أن الحدث سيتم إلغاؤه  مما يعني أن أي إجراء افتراضي يتم اتخاذه عادةً بواسطة التنفيذ نتيجة للحدث لن يحدث.
type: docs
weight: 120
