...
description: ملفEvent./event يستخدم لتوفير معلومات سياقية حول حدث للمعالج الذي يقوم بمعالجة الحدث.
type: docs
weight: 780
...
ملف[`Event`](../event) يستخدم لتوفير معلومات سياقية حول حدث للمعالج الذي يقوم بمعالجة الحدث.
...
| اسم | وصف |
| --- | --- |
| [Event](event#constructor)(string) | يقوم بتهيئة مثيل جديد لملف[`Event`](../event) فئة . |
| [Event](event#constructor_1)(string, IDictionary&lt;string, object&gt;) | يقوم بتهيئة مثيل جديد لملف[`Event`](../event) فئة . |
...
| [InitEvent](../../aspose.html.dom.events/event/initevent)(string, bool, bool) | ملف[`InitEvent`](./initevent) يتم استخدام طريقة لتهيئة قيمة[`Event`](../event) تم إنشاؤه من خلال [`IDocumentEvent`](../idocumentevent) الواجهة . |
...
كائن يقوم بتنفيذ ملف[`Event`](../event) بشكل عام يتم تمريره كمعامل أول إلى معالج الأحداث . يتم تمرير معلومات سياق أكثر تحديدًا إلى معالجات الأحداث من خلال اشتقاق واجهات إضافية من[`Event`](../event) التي تحتوي على معلومات تتعلق مباشرة بنوع الحدث المصاحب. يتم أيضًا تنفيذ هذه الواجهات المشتقة بواسطة الكائن الذي تم تمريره إلى مستمع الحدث.
