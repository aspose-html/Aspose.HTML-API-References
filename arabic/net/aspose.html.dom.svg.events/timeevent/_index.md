...
| [CurrentTarget](../../aspose.html.dom.events/event/currenttarget) { get; } | يُستخدم للإشارة إلى ملف[`IEventTarget`](../../aspose.html.dom.events/ieventtarget) ملك من[`IEventListener`](../../aspose.html.dom.events/ieventlistener) يتم حاليًا معالجة الصورة . هذا مفيد بشكل خاص أثناء الالتقاط والفقاعات. |
