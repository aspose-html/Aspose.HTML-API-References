...
description: Aspose.Html.Dom.Svg.Events.TimeEvent فصل. توفر واجهة TimeEvent معلومات سياقية محددة مرتبطة بأحداث الوقت. الأنواع المختلفة من الأحداث التي يمكن أن تحدث هي startEvent و endEvent و RepEvent.
type: docs
weight: 1340
url: /ar/net/aspose.html.dom.svg.events/timeevent/
---
## TimeEvent class
...
| [Detail](../../aspose.html.dom.svg.events/timeevent/detail/) { get; } | تحديد بعض المعلومات التفصيلية حول الحدث ، اعتمادًا على نوع الحدث. بالنسبة لنوع الحدث هذا ، يشير إلى رقم التكرار للرسوم المتحركة. |
...
| [View](../../aspose.html.dom.svg.events/timeevent/view/) { get; } | تحدد سمة العرض AbstractView [DOM2VIEWS] الذي تم إنشاء الحدث منه. |
