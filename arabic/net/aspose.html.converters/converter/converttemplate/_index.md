...
دمج قالب html مع بيانات المستخدم. النتيجة هي ملف html.
...
| معامل | يكتب | وصف |
| --- | --- | --- |
| template | HTMLDocument | مصدر الهيكل العظمي html doc. |
...
| معامل | يكتب | وصف |
| --- | --- | --- |
| url | Url | عنوان URL لمستند مصدر القالب. |
| data | TemplateData | بيانات الدمج (XML ، JSON). |
| options | TemplateLoadOptions | دمج كائن الخيارات. |
| outputPath | String | مسار ملف الإخراج. |
...
| معامل | يكتب | وصف |
| --- | --- | --- |
| content | String | قالب HTML المضمن - هيكل عظمي. |
| baseUrl | String | عنوان URI الأساسي لقالب html. سيتم دمجه مع مسار الدليل الحالي لتكوين عنوان URL مطلق. |
| data | TemplateData | بيانات الدمج (XML ، JSON). |
| options | TemplateLoadOptions | دمج كائن الخيارات. |
| outputPath | String | مسار ملف الإخراج. |
