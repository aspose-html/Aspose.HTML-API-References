...
description: تحويل مستند مصدر HTML إلى DOCX. النتيجة هي ملف docx.
type: docs
weight: 20
url: /ar/net/aspose.html.converters/converter/converthtml/
---
## ConvertHTML(HTMLDocument, DocSaveOptions, string) {#converthtml_1}

تحويل مستند مصدر HTML إلى DOCX. النتيجة هي ملف docx.
...
| معامل | يكتب | وصف |
| --- | --- | --- |
| document | HTMLDocument | مصدر التحويل[`HTMLDocument`](../../../aspose.html/htmldocument). |
...
| معامل | يكتب | وصف |
| --- | --- | --- |
| sourcePath | String | مسار مصدر ملف HTML. سيتم دمجه مع مسار الدليل الحالي لتكوين عنوان URL مطلق. |
| options | DocSaveOptions | خيارات التحويل. |
| outputPath | String | مسار ملف الإخراج. |
...
| معامل | يكتب | وصف |
| --- | --- | --- |
| content | String | مضمنة سلسلة محتوى HTML. |
...
تحويل مستند مصدر html إلى PDF. النتيجة هي ملف pdf.
...
تحويل مستند html إلى mhtml. النتيجة هي mhtml file.
...
| معامل | يكتب | وصف |
| --- | --- | --- |
| document | HTMLDocument | مصدر التحويل. |
| options | MHTMLSaveOptions | خيارات التحويل. |
| outputPath | String | مسار ملف الإخراج. |
...
تحويل مستند html إلى تخفيض السعر. النتيجة هي ملف md.
...
| --- | --- | --- |
| document | HTMLDocument | مصدر التحويل. |
| options | MarkdownSaveOptions | خيارات التحويل. |
| outputPath | String | مسار ملف الإخراج. |
...
تحويل مصدر html إلى تخفيض السعر. النتيجة هي ملف md.
...
تحويل مستند html إلى xps. النتيجة هي ملف xps.
...
تحويل مصدر html إلى xps. النتيجة هي ملف xps.
...
تحويل مستند html إلى صورة. النتيجة هي ملف الصورة.
...
تحويل مصدر html إلى صورة. النتيجة هي ملف الصورة.
