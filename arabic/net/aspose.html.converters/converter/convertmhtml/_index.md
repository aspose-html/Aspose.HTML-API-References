...
description: Converter طريقة. تحويل مصدر mhtml إلى xps. النتيجة هي ملف xps.
type: docs
weight: 40
url: /ar/net/aspose.html.converters/converter/convertmhtml/
---
## ConvertMHTML(Stream, XpsSaveOptions, string) {#convertmhtml_31}

تحويل مصدر mhtml إلى xps. النتيجة هي ملف xps.
...
تحويل مصدر MHTML إلى DOCX. النتيجة هي ملف docx.
...
تحويل مصدر mhtml إلى pdf. النتيجة هي ملف pdf.
...
تحويل مصدر mhtml إلى صورة. النتيجة هي ملف الصورة.
