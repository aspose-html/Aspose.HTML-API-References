...
description: يمثل InputElement غلافًا مرتبطًا بـ HTMLInputElement.
type: docs
weight: 2970
...
| [GetColorValue](../../aspose.html.forms/inputelement/getcolorvalue)() | تُستخدم هذه الطريقة للحصول على القيمة كلون. هذه الطريقة صالحة فقط إذا كان نوع عنصر الإدخال هو "اللون" |
...
| [GetNumberValue](../../aspose.html.forms/inputelement/getnumbervalue)() | تُستخدم هذه الطريقة للحصول على القيمة كرقم. هذه الطريقة صالحة فقط إذا كان نوع عنصر الإدخال هو "رقم" |
...
| [GetTimeValue](../../aspose.html.forms/inputelement/gettimevalue)() | تُستخدم هذه الطريقة للحصول على القيمة كملفTimeSpanهدف. هذه الطريقة صالحة فقط إذا كان نوع عنصر الإدخال فقط هو "الوقت" |
...
| [SetColorValue](../../aspose.html.forms/inputelement/setcolorvalue)(Color) | تُستخدم هذه الطريقة لتعيين اللون كقيمة لعنصر الإدخال. هذه الطريقة صالحة فقط إذا كان نوع عنصر الإدخال هو "اللون" |
| [SetDateTimeLocalValue](../../aspose.html.forms/inputelement/setdatetimelocalvalue)(DateTime) | تُستخدم هذه الطريقة للتعيينDateTime الكائن كقيمة لعنصر الإدخال. هذه الطريقة صالحة فقط إذا كان نوع عنصر الإدخال هو "datetime-local" |
...
| [SetMonthValue](../../aspose.html.forms/inputelement/setmonthvalue)(DateTime) | تُستخدم هذه الطريقة للتعيينDateTime الكائن كقيمة لعنصر الإدخال. هذه الطريقة صالحة فقط إذا كان نوع عنصر الإدخال هو "شهر" |
