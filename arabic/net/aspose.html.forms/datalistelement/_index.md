...
description: Aspose.Html.Forms.DataListElement فصل. يمثل DataListElement غلافًا مرتبطًا بـ HTMLDataListElement
type: docs
weight: 2920
...
| اسم | وصف |
| --- | --- |
| [DataListElement](datalistelement/)(HTMLDataListElement) | يقوم بتهيئة مثيل جديد لملف`DataListElement` فئة . |
