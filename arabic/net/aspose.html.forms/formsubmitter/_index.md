...
description: هذه الفئة تسمح للتحضير المحددHTMLFormElement../aspose.html/htmlformelement  يجمع القيم من عنصر النموذج  ويرسلها إلى الخادم البعيد ويتلقى استجابة.
type: docs
weight: 2960
...
هذه الفئة تسمح للتحضير المحدد[`HTMLFormElement`](../../aspose.html/htmlformelement) ، يجمع القيم من عنصر النموذج ، ويرسلها إلى الخادم البعيد ويتلقى استجابة.
...
| اسم | وصف |
| --- | --- |
| [FormSubmitter](formsubmitter#constructor)(FormEditor) | يقوم بتهيئة مثيل جديد لملف[`FormSubmitter`](../formsubmitter) فئة . |
| [FormSubmitter](formsubmitter#constructor_3)(HTMLFormElement) | يقوم بتهيئة مثيل جديد لملف[`FormSubmitter`](../formsubmitter) فئة على أساس[`HTMLFormElement`](../../aspose.html/htmlformelement) . |
| [FormSubmitter](formsubmitter#constructor_1)(HTMLDocument, int) | يقوم بتهيئة مثيل جديد لملف[`FormSubmitter`](../formsubmitter) فئة على أساس[`HTMLFormElement`](../../aspose.html/htmlformelement) تم التحديد بواسطة الفهرس من[`HTMLDocument`](../../aspose.html/htmldocument) . |
| [FormSubmitter](formsubmitter#constructor_2)(HTMLDocument, string) | يقوم بتهيئة مثيل جديد لملف[`FormSubmitter`](../formsubmitter) فئة على أساس[`HTMLFormElement`](../../aspose.html/htmlformelement) المحدد بواسطة المعرف من[`HTMLDocument`](../../aspose.html/htmldocument) . |
