...
description: يمثل SelectElement غلافًا مرتبطًا بـ HTMLSelectElement
type: docs
weight: 3010
...
| [Multiple](../../aspose.html.forms/selectelement/multiple) { get; set; } | إذا كان صحيحًا ، متعدد`اختيار` يمكن تحديد العناصر في هذا`تحديد` . راجع تعريف السمات المتعددة في HTML 4.01. |
...
| [Type](../../aspose.html.forms/selectelement/type) { get; } | نوع عنصر تحكم النموذج هذا. هذه هي السلسلة "select-multiple" عندما تكون السمة المتعددة هي`حقيقي` والسلسلة "حدد واحد" عندما`خاطئة` . |
