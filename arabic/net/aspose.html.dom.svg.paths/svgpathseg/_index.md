...
| const [PATHSEG_CURVETO_QUADRATIC_ABS](../../aspose.html.dom.svg.paths/svgpathseg/pathseg_curveto_quadratic_abs) | يتوافق مع أمر "منحنيات بيزيير من الدرجة الثانية المطلقة" (Q) لبيانات المسار. |
...
| const [PATHSEG_CURVETO_QUADRATIC_SMOOTH_REL](../../aspose.html.dom.svg.paths/svgpathseg/pathseg_curveto_quadratic_smooth_rel) | يتطابق مع أمر "انحناء تربيعي سلس نسبي" (t) لأمر بيانات المسار. |
