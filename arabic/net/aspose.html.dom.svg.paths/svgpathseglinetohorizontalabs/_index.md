...
description: Aspose.Html.Dom.Svg.Paths.SVGPathSegLinetoHorizontalAbs فصل. تتوافق واجهة SVGPathSegLinetoHorizontalAbs مع أمر بيانات مسار خط أفقي مطلق H.
type: docs
weight: 1820
url: /ar/net/aspose.html.dom.svg.paths/svgpathseglinetohorizontalabs/
---
## SVGPathSegLinetoHorizontalAbs class

تتوافق واجهة SVGPathSegLinetoHorizontalAbs مع أمر بيانات مسار "خط أفقي مطلق" (H).
...
| [X](../../aspose.html.dom.svg.paths/svgpathseglinetohorizontalabs/x/) { get; set; } | إحداثي X المطلق لنقطة نهاية مقطع المسار هذا. |
