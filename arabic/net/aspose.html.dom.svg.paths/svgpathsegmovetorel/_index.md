...
description: Aspose.Html.Dom.Svg.Paths.SVGPathSegMovetoRel فصل. تتوافق واجهة SVGPathSegMovetoRel مع أمر بيانات المسار النسبي moveto m.
type: docs
weight: 1890
url: /ar/net/aspose.html.dom.svg.paths/svgpathsegmovetorel/
---
...
| [X](../../aspose.html.dom.svg.paths/svgpathsegmovetorel/x/) { get; set; } | إحداثي X النسبي لنقطة نهاية مقطع المسار هذا. |
| [Y](../../aspose.html.dom.svg.paths/svgpathsegmovetorel/y/) { get; set; } | إحداثي Y النسبي لنقطة نهاية مقطع المسار هذا. |
