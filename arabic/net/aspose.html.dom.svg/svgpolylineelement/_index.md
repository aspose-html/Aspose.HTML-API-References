...
description: واجهة SVGPolylineElement تتوافق مع عنصر متعدد الخطوط.
type: docs
weight: 2230
url: /ar/net/aspose.html.dom.svg/svgpolylineelement/
---
## SVGPolylineElement class

واجهة SVGPolylineElement تتوافق مع عنصر "متعدد الخطوط".
...
| اسم | وصف |
| --- | --- |
| [AnimatedPoints](../../aspose.html.dom.svg/svgpolylineelement/animatedpoints) { get; } | يوفر الوصول إلى المحتويات المتحركة الحالية لسمة "النقاط". إذا تم تحريك السمة أو الخاصية المحددة ، فإنها تحتوي على القيمة المتحركة الحالية للسمة أو الخاصية. إذا لم يتم تحريك السمة أو الخاصية المحددة حاليًا ، فستحتوي على نفس قيمة النقاط. |
...
| [Points](../../aspose.html.dom.svg/svgpolylineelement/points) { get; } | يوفر الوصول إلى المحتويات الأساسية (أي الثابتة) لسمة "النقاط". |
