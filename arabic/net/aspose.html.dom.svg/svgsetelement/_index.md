...
description: Aspose.Html.Dom.Svg.SVGSetElement فصل. تتوافق واجهة SVGSetElement مع عنصر set. لا يتوفر الوصول الموجه للكائنات إلى سمات عنصر set عبر SVG DOM .
type: docs
weight: 2280
