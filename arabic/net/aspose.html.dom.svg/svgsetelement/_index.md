...
description: تتوافق واجهة SVGSetElement مع عنصر set. لا يتوفر الوصول الموجه للكائنات إلى سمات عنصر set عبر SVG DOM .
type: docs
weight: 2290
url: /ar/net/aspose.html.dom.svg/svgsetelement/
---
## SVGSetElement class

تتوافق واجهة SVGSetElement مع عنصر "set". لا يتوفر الوصول الموجه للكائنات إلى سمات عنصر "set" عبر SVG DOM .
