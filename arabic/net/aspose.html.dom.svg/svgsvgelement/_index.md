...
description: Aspose.Html.Dom.Svg.SVGSVGElement فصل. تعريف الواجهة الرئيسية هو واجهة SVGSVGElement  وهي الواجهة التي تتوافق مع عنصر svg. تحتوي هذه الواجهة على طرق مساعدة متنوعة شائعة الاستخدام  مثل عمليات المصفوفة والقدرة على التحكم في وقت إعادة الرسم على أجهزة العرض المرئي.
type: docs
weight: 2260
...
تعريف الواجهة الرئيسية هو واجهة SVGSVGElement ، وهي الواجهة التي تتوافق مع عنصر "svg". تحتوي هذه الواجهة على طرق مساعدة متنوعة شائعة الاستخدام ، مثل عمليات المصفوفة والقدرة على التحكم في وقت إعادة الرسم على أجهزة العرض المرئي.
...
| [Height](../../aspose.html.dom.svg/svgsvgelement/height/) { get; } | يتوافق مع سمة "الارتفاع" على عنصر "svg" المحدد . |
...
| [PreserveAspectRatio](../../aspose.html.dom.svg/svgsvgelement/preserveaspectratio/) { get; } | يتوافق مع السمة "saveAspectRatio" للعنصر المحدد. |
...
| [Y](../../aspose.html.dom.svg/svgsvgelement/y/) { get; } | يتوافق مع السمة "y" في عنصر "svg" المحدد . |
...
| [CreateSVGPoint](../../aspose.html.dom.svg/svgsvgelement/createsvgpoint/)() | لتكوين كائن SVGPoint خارج أي شجرة مستندات. يتم تهيئة الكائن إلى النقطة (0،0) في نظام إحداثيات المستخدم. |
| [CreateSVGRect](../../aspose.html.dom.svg/svgsvgelement/createsvgrect/)() | لتكوين كائن SVGRect خارج أي شجرة مستندات. تتم تهيئة الكائن بحيث يتم تعيين جميع القيم على 0 وحدة مستخدم. |
| [CreateSVGTransform](../../aspose.html.dom.svg/svgsvgelement/createsvgtransform/)() | لتكوين كائن SVGTransform خارج أية شجرات مستندات. تتم تهيئة الكائن لتحويل مصفوفة الهوية (SVG_TRANSFORM_MATRIX) . |
| [CreateSVGTransformFromMatrix](../../aspose.html.dom.svg/svgsvgelement/createsvgtransformfrommatrix/)(SVGMatrix) | لتكوين كائن SVGTransform خارج أية شجرات مستندات. يتم تهيئة الكائن إلى تحويل المصفوفة المحدد (على سبيل المثال ، SVG_TRANSFORM_MATRIX). يتم نسخ القيم من مصفوفة المعلمة ، ولا يتم اعتماد معلمة المصفوفة على أنها SVGTransform :: matrix. |
...
| [PauseAnimations](../../aspose.html.dom.svg/svgsvgelement/pauseanimations/)() | يوقف (على سبيل المثال ، الإيقاف المؤقت) جميع الرسوم المتحركة قيد التشغيل حاليًا والمحددة داخل جزء مستند SVG المقابل لعنصر "svg" هذا ، مما يتسبب في بقاء ساعة الرسوم المتحركة المقابلة لجزء المستند ثابتة حتى يتم إلغاء الإيقاف المؤقت . |
...
| [UnpauseAnimations](../../aspose.html.dom.svg/svgsvgelement/unpauseanimations/)() | Unsuspends (على سبيل المثال ، إلغاء الإيقاف المؤقت) قيد التشغيل حاليًا للرسوم المتحركة المحددة داخل جزء مستند SVG ، مما يتسبب في استمرار ساعة الرسوم المتحركة من وقت تعليقها. |
