...
description: تعريف الواجهة الرئيسية هو واجهة SVGSVGElement  وهي الواجهة التي تتوافق مع عنصر svg. تحتوي هذه الواجهة على العديد من الأساليب المساعدة المتنوعة الشائعة الاستخدام  مثل عمليات المصفوفة والقدرة على التحكم في وقت إعادة الرسم على أجهزة العرض المرئي.
type: docs
weight: 2270
url: /ar/net/aspose.html.dom.svg/svgsvgelement/
---
## SVGSVGElement class

تعريف الواجهة الرئيسية هو واجهة SVGSVGElement ، وهي الواجهة التي تتوافق مع عنصر "svg". تحتوي هذه الواجهة على العديد من الأساليب المساعدة المتنوعة الشائعة الاستخدام ، مثل عمليات المصفوفة والقدرة على التحكم في وقت إعادة الرسم على أجهزة العرض المرئي.
...
| [ChildElementCount](../../aspose.html.dom/element/childelementcount) { get; } | إرجاع العدد الحالي لعُقد العناصر التابعة لهذا العنصر. 0 إذا كان هذا العنصر لا يحتوي على عقد فرعية من نوع العقدة 1. |
...
| [CurrentScale](../../aspose.html.dom.svg/svgsvgelement/currentscale) { get; set; } | في عنصر svg الخارجي ، تشير هذه السمة إلى عامل المقياس الحالي بالنسبة إلى العرض الأولي لمراعاة عمليات التكبير والتحريك التي يقوم بها المستخدم ، كما هو موضح ضمن التكبير والتحريك. سمات DOM currentScale و currentTranslate مكافئة لمصفوفة 2x3 [abcdef] = [currentScale 0 0 currentScale currentTranslate.x currentTranslate.y]. إذا تم تمكين "التكبير" (على سبيل المثال ، ZoomAndPan = "تكبير") ، فسيكون التأثير كما لو تم وضع تحويل إضافي في المستوى الخارجي على جزء مستند SVG (على سبيل المثال ، خارج عنصر svg الخارجي) . عند الوصول إليه في عنصر 'svg' ليس عنصر svg خارجيًا ، فهو غير محدد ما هو سلوك هذه السمة. |
| [CurrentTranslate](../../aspose.html.dom.svg/svgsvgelement/currenttranslate) { get; } | على عنصر svg الخارجي ، عامل الترجمة المقابل الذي يأخذ في الاعتبار "تكبير" المستخدم . عند الوصول إلى عنصر "svg" ليس عنصر svg خارجيًا ، فإنه غير محدد سلوك هذه السمة. |
...
| [Height](../../aspose.html.dom.svg/svgsvgelement/height) { get; } | يتوافق مع السمة "الارتفاع" على عنصر "svg" المحدد . |
| [Id](../../aspose.html.dom.svg/svgelement/id) { get; set; } | قيمة السمة "id" في العنصر المحدد ، أو السلسلة الفارغة إذا لم يكن "id" موجودًا . |
...
| [NextElementSibling](../../aspose.html.dom/element/nextelementsibling) { get; } | إرجاع عقدة العنصر الشقيق التالية لهذا العنصر. خالية إذا كان هذا العنصر لا يحتوي على عقد شقيقة لعنصر تأتي بعد هذا في شجرة الوثيقة. |
...
| [OwnerSVGElement](../../aspose.html.dom.svg/svgelement/ownersvgelement) { get; } | أقرب عنصر "svg" للأصل. لاغية إذا كان العنصر المحدد هو عنصر svg الأبعد. |
...
| override [Prefix](../../aspose.html.dom/element/prefix) { get; } | بادئة مساحة الاسم لهذه العقدة ، أو فارغة إذا كانت غير محددة. عندما يتم تعريفه على أنه فارغ ، فإن الإعداد ليس له أي تأثير |
| [PreserveAspectRatio](../../aspose.html.dom.svg/svgsvgelement/preserveaspectratio) { get; } | يتوافق مع السمة "saveAspectRatio" على العنصر المحدد. |
...
| [Style](../../aspose.html.dom.svg/svgelement/style) { get; } | يتوافق مع السمة "النمط" في العنصر المحدد. إذا كان وكيل المستخدم لا يدعم التصميم باستخدام CSS ، فيجب أن يكون لهذه السمة دائمًا قيمة خالية. |
...
| [ViewBox](../../aspose.html.dom.svg/svgsvgelement/viewbox) { get; } | يتوافق مع السمة "viewBox" في العنصر المحدد. |
| [ViewportElement](../../aspose.html.dom.svg/svgelement/viewportelement) { get; } | العنصر الذي أنشأ إطار العرض الحالي. في كثير من الأحيان ، أقرب عنصر "svg" سلف. لاغية إذا كان العنصر المحدد هو عنصر svg الأبعد. |
| [Width](../../aspose.html.dom.svg/svgsvgelement/width) { get; } | يتوافق مع السمة "العرض" على عنصر "svg" المحدد . |
| [X](../../aspose.html.dom.svg/svgsvgelement/x) { get; } | يتوافق مع السمة "x" في عنصر "svg" المحدد . |
| [Y](../../aspose.html.dom.svg/svgsvgelement/y) { get; } | يتوافق مع السمة "y" على عنصر "svg" المحدد . |
| [ZoomAndPan](../../aspose.html.dom.svg/svgsvgelement/zoomandpan) { get; set; } | يتوافق مع السمة "zoomAndPan" على العنصر المحدد. يجب أن تكون القيمة واحدة من ثوابت SVG_ZOOMANDPAN_ * المحددة في هذه الواجهة. |
...
| [AnimationsPaused](../../aspose.html.dom.svg/svgsvgelement/animationspaused)() | إرجاع صحيح إذا كان جزء مستند SVG في حالة إيقاف مؤقت. |
...
| [AttachShadow](../../aspose.html.dom/element/attachshadow)(ShadowRootMode) | إنشاء جذر الظل وإرفاقه بالعنصر الحالي. |
...
| [CreateEvent](../../aspose.html.dom.svg/svgsvgelement/createevent)(string) | ينشئ ملف[`Event`](../../aspose.html.dom.events/event) من النوع الذي يدعمه التنفيذ . |
| [CreateSVGAngle](../../aspose.html.dom.svg/svgsvgelement/createsvgangle)() | لتكوين كائن SVGAngle خارج أي شجرة مستندات. يتم تهيئة الكائن إلى القيمة 0 درجة (بدون وحدة) . |
| [CreateSVGLength](../../aspose.html.dom.svg/svgsvgelement/createsvglength)() | لتكوين كائن SVGLength خارج أية شجرات مستندات. تمت تهيئة الكائن إلى قيمة 0 وحدة مستخدم. |
| [CreateSVGMatrix](../../aspose.html.dom.svg/svgsvgelement/createsvgmatrix)() | لتكوين كائن SVGMatrix خارج أية شجرات مستندات. يتم تهيئة الكائن إلى مصفوفة الهوية. |
| [CreateSVGNumber](../../aspose.html.dom.svg/svgsvgelement/createsvgnumber)() | لتكوين كائن SVGNumber خارج أية شجرات مستندات. تمت تهيئة الكائن إلى قيمة صفر. |
| [CreateSVGPoint](../../aspose.html.dom.svg/svgsvgelement/createsvgpoint)() | لتكوين كائن SVGPoint خارج أية شجرات مستندات. تتم تهيئة الكائن إلى النقطة (0،0) في نظام إحداثيات المستخدم. |
| [CreateSVGRect](../../aspose.html.dom.svg/svgsvgelement/createsvgrect)() | لتكوين كائن SVGRect خارج أية شجرات مستندات. تتم تهيئة الكائن بحيث يتم تعيين جميع القيم على 0 وحدة مستخدم. |
| [CreateSVGTransform](../../aspose.html.dom.svg/svgsvgelement/createsvgtransform)() | لتكوين كائن SVGTransform خارج أية شجرات مستندات. يتم تهيئة الكائن لتحويل مصفوفة الهوية (SVG_TRANSFORM_MATRIX) . |
| [CreateSVGTransformFromMatrix](../../aspose.html.dom.svg/svgsvgelement/createsvgtransformfrommatrix)(SVGMatrix) | لتكوين كائن SVGTransform خارج أية شجرات مستندات. تتم تهيئة الكائن إلى تحويل المصفوفة المحدد (على سبيل المثال ، SVG_TRANSFORM_MATRIX). يتم نسخ القيم من مصفوفة المعلمة ، ولا يتم اعتماد معلمة المصفوفة على أنها SVGTransform :: matrix. |
...
| [GetBBox](../../aspose.html.dom.svg/svggraphicselement/getbbox)() | إرجاع مربع الإحاطة الضيق في مساحة المستخدم الحالية (أي بعد تطبيق سمة "التحويل" ، إن وجدت) على هندسة جميع عناصر الرسومات المضمنة ، باستثناء تأثيرات التمسيد والقص والإخفاء والتصفية). لاحظ أن getBBox يجب أن يعيد مربع الإحاطة الفعلي في وقت استدعاء الطريقة ، حتى في حالة عدم تقديم العنصر بعد. |
| [GetCTM](../../aspose.html.dom.svg/svggraphicselement/getctm)() | إرجاع مصفوفة التحويل من وحدات المستخدم الحالية (على سبيل المثال ، بعد تطبيق سمة "التحويل" ، إن وجدت) إلى نظام إحداثي منفذ العرض لأقرب منفذ عرض. |
| [GetCurrentTime](../../aspose.html.dom.svg/svgsvgelement/getcurrenttime)() | إرجاع الوقت الحالي بالثواني بالنسبة إلى وقت البدء لجزء مستند SVG الحالي. إذا تم استدعاء getCurrentTime قبل بدء المخطط الزمني للمستند (على سبيل المثال ، من خلال تشغيل البرنامج النصي في عنصر "البرنامج النصي" قبل إرسال حدث SVGLoad الخاص بالمستند) ، فسيتم إرجاع القيمة 0. |
...
| [GetElementsByTagName](../../aspose.html.dom/element/getelementsbytagname)(string) | إرجاع NodeList لجميع العناصر التابعة مع اسم علامة معين ، بترتيب المستند. |
...
| [PauseAnimations](../../aspose.html.dom.svg/svgsvgelement/pauseanimations)() | يوقف (على سبيل المثال ، الإيقاف المؤقت) جميع الرسوم المتحركة قيد التشغيل حاليًا والتي تم تحديدها داخل جزء مستند SVG المقابل لعنصر "svg" ، مما يتسبب في بقاء ساعة الرسوم المتحركة المقابلة لجزء المستند ثابتة حتى يتم إلغاء الإيقاف المؤقت . |
...
| [Remove](../../aspose.html.dom/element/remove)() | يزيل هذا المثال. |
...
| [SetAttributeNode](../../aspose.html.dom/element/setattributenode)(Attr) | إضافة عقدة سمة جديدة. إذا كانت هناك سمة بهذا الاسم (nodeName) موجودة بالفعل في العنصر ، فسيتم استبدالها بالسمة الجديدة. |
...
| [UnpauseAnimations](../../aspose.html.dom.svg/svgsvgelement/unpauseanimations)() | Unsuspends (على سبيل المثال ، إلغاء الإيقاف المؤقت) قيد التشغيل حاليًا للرسوم المتحركة المحددة داخل جزء مستند SVG ، مما يتسبب في استمرار ساعة الرسوم المتحركة من الوقت الذي تم فيه تعليقها. |
