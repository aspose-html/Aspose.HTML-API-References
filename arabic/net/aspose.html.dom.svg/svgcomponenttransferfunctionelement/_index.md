...
description: تحدد هذه الواجهة واجهة أساسية تستخدمها واجهات وظيفة نقل المكون.
type: docs
weight: 1980
url: /ar/net/aspose.html.dom.svg/svgcomponenttransferfunctionelement/
---
## SVGComponentTransferFunctionElement class

تحدد هذه الواجهة واجهة أساسية تستخدمها واجهات وظيفة نقل المكون.
...
| اسم | وصف |
| --- | --- |
| [Amplitude](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/amplitude) { get; } | يتوافق مع السمة "السعة" على العنصر المحدد. |
...
| [Exponent](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/exponent) { get; } | يتوافق مع السمة "الأس" على العنصر المحدد. |
...
| [Intercept](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/intercept) { get; } | يتوافق مع السمة "التقاطع" على العنصر المحدد. |
...
| [Offset](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/offset) { get; } | يتوافق مع السمة "الإزاحة" في العنصر المحدد. |
...
| [Slope](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/slope) { get; } | يتوافق مع السمة "المنحدر" على العنصر المحدد. |
...
| [TableValues](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/tablevalues) { get; } | يتوافق مع السمة "tableValues" على العنصر المحدد. |
...
| [Type](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/type) { get; } | يتوافق مع السمة "النوع" في العنصر المحدد. يأخذ أحد ثوابت SVG_FECOMPONENTTRANSFER_TYPE_ * المحددة في هذه الواجهة. |
...
| اسم | وصف |
| --- | --- |
| const [SVG_FECOMPONENTTRANSFER_TYPE_DISCRETE](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_discrete) | يتوافق مع القيمة "المنفصلة" . |
| const [SVG_FECOMPONENTTRANSFER_TYPE_GAMMA](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_gamma) | يتوافق مع قيمة "جاما" . |
| const [SVG_FECOMPONENTTRANSFER_TYPE_IDENTITY](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_identity) | يتوافق مع "هوية" القيمة . |
| const [SVG_FECOMPONENTTRANSFER_TYPE_LINEAR](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_linear) | يتوافق مع القيمة "الخطية" . |
| const [SVG_FECOMPONENTTRANSFER_TYPE_TABLE](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_table) | يتوافق مع "جدول" القيمة . |
| const [SVG_FECOMPONENTTRANSFER_TYPE_UNKNOWN](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_unknown) | النوع ليس من الأنواع المحددة مسبقًا. من غير الصحيح محاولة تحديد قيمة جديدة من هذا النوع أو محاولة تبديل قيمة موجودة إلى هذا النوع. |
