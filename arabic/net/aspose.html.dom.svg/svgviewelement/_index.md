...
description: تتوافق واجهة SVGViewElement مع عنصر العرض.
type: docs
weight: 2420
url: /ar/net/aspose.html.dom.svg/svgviewelement/
---
## SVGViewElement class

تتوافق واجهة SVGViewElement مع عنصر "العرض".
...
| [PreserveAspectRatio](../../aspose.html.dom.svg/svgviewelement/preserveaspectratio) { get; } | يتوافق مع السمة "saveAspectRatio" على العنصر المحدد. |
...
| [ViewBox](../../aspose.html.dom.svg/svgviewelement/viewbox) { get; } | يتوافق مع السمة "viewBox" في العنصر المحدد. |
...
| [ViewTarget](../../aspose.html.dom.svg/svgviewelement/viewtarget) { get; } | يتوافق مع السمة "viewTarget" في عنصر "view" المحدد. قائمة بقيم DOMString التي تحتوي على الأسماء المدرجة في السمة "viewTarget". يمكن ربط كل من قيم سلسلة DOM بالعنصر المقابل باستخدام استدعاء أسلوب getElementById (). |
| [ZoomAndPan](../../aspose.html.dom.svg/svgviewelement/zoomandpan) { get; set; } | يتوافق مع السمة "zoomAndPan" على العنصر المحدد. يجب أن تكون القيمة واحدة من ثوابت SVG_ZOOMANDPAN_ * المحددة في هذه الواجهة. |
