...
description: Aspose.Html.Dom.Svg.SVGViewElement فصل. تتوافق واجهة SVGViewElement مع عنصر العرض.
type: docs
weight: 2410
...
| [PreserveAspectRatio](../../aspose.html.dom.svg/svgviewelement/preserveaspectratio/) { get; } | يتوافق مع السمة "saveAspectRatio" للعنصر المحدد. |
...
| [ViewTarget](../../aspose.html.dom.svg/svgviewelement/viewtarget/) { get; } | يتوافق مع السمة "viewTarget" في عنصر "العرض" المحدد. قائمة بقيم DOMString التي تحتوي على الأسماء المدرجة في السمة "viewTarget". يمكن ربط كل من قيم سلسلة DOM بالعنصر المقابل باستخدام استدعاء أسلوب getElementById (). |
