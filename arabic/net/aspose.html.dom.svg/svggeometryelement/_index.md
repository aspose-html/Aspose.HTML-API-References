...
description: Interface SVGGeometryElement يمثل عناصر SVG التي يتم تحديد عرضها بواسطة الهندسة بمسار مكافئ  والتي يمكن تعبئتها والحد منها. يتضمن ذلك المسارات والأشكال الأساسية.
type: docs
weight: 2100
url: /ar/net/aspose.html.dom.svg/svggeometryelement/
---
## SVGGeometryElement class

Interface SVGGeometryElement يمثل عناصر SVG التي يتم تحديد عرضها بواسطة الهندسة بمسار مكافئ ، والتي يمكن تعبئتها والحد منها. يتضمن ذلك المسارات والأشكال الأساسية.
