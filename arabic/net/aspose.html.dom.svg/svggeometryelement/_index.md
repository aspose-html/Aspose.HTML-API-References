...
description: Aspose.Html.Dom.Svg.SVGGeometryElement فصل. Interface SVGeometryElement يمثل عناصر SVG التي يتم تحديد عرضها بواسطة الهندسة بمسار مكافئ  والتي يمكن تعبئتها والحد منها. يتضمن ذلك المسارات والأشكال الأساسية.
type: docs
weight: 2090
...
Interface SVGeometryElement يمثل عناصر SVG التي يتم تحديد عرضها بواسطة الهندسة بمسار مكافئ ، والتي يمكن تعبئتها والحد منها. يتضمن ذلك المسارات والأشكال الأساسية.
...
| [GetEquivalentPath](../../aspose.html.dom.svg/svggeometryelement/getequivalentpath/)() | إرجاع مثيل جديد لملف[`SVGPathSegList`](../../aspose.html.dom.svg.paths/svgpathseglist/) التي تمثل`SVGGeometryElement` مقاطع المسار . |
