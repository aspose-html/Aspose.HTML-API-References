...
description: تتوافق واجهة SVGMarkerElement مع عنصر العلامة.
type: docs
weight: 2170
url: /ar/net/aspose.html.dom.svg/svgmarkerelement/
---
## SVGMarkerElement class

تتوافق واجهة SVGMarkerElement مع عنصر "العلامة".
...
| [MarkerHeight](../../aspose.html.dom.svg/svgmarkerelement/markerheight) { get; } | يتوافق مع السمة "markerHeight" على عنصر "العلامة" المحدد . |
| [MarkerUnits](../../aspose.html.dom.svg/svgmarkerelement/markerunits) { get; } | يتوافق مع السمة "markerUnits" على عنصر "العلامة" المحدد. أحد أنواع وحدات العلامات المحددة في هذه الواجهة. |
| [MarkerWidth](../../aspose.html.dom.svg/svgmarkerelement/markerwidth) { get; } | يتوافق مع السمة "markerWidth" على عنصر "العلامة" المحدد . |
...
| [OrientAngle](../../aspose.html.dom.svg/svgmarkerelement/orientangle) { get; } | يتوافق مع السمة "orient" على عنصر "العلامة" المحدد. إذا كانت markerUnits هي SVG_MARKER_ORIENT_ANGLE ، فإن قيمة الزاوية للسمة "orient" ؛ وإلا فسيتم ضبطه على صفر. |
| [OrientType](../../aspose.html.dom.svg/svgmarkerelement/orienttype) { get; } | يتوافق مع السمة "orient" على عنصر "العلامة" المحدد. أحد أنواع اتجاه العلامة المحددة في هذه الواجهة. |
...
| [PreserveAspectRatio](../../aspose.html.dom.svg/svgmarkerelement/preserveaspectratio) { get; } | يتوافق مع السمة "saveAspectRatio" على العنصر المحدد. |
...
| [RefX](../../aspose.html.dom.svg/svgmarkerelement/refx) { get; } | يتوافق مع السمة "refX" على عنصر "العلامة" المحدد . |
| [RefY](../../aspose.html.dom.svg/svgmarkerelement/refy) { get; } | يتوافق مع السمة "refY" على عنصر "العلامة" المحدد . |
...
| [ViewBox](../../aspose.html.dom.svg/svgmarkerelement/viewbox) { get; } | يتوافق مع السمة "viewBox" في العنصر المحدد. |
...
| [SetOrientToAngle](../../aspose.html.dom.svg/svgmarkerelement/setorienttoangle)(SVGAngle) | يضبط قيمة السمة "الاتجاه" على الزاوية المحددة. |
| [SetOrientToAuto](../../aspose.html.dom.svg/svgmarkerelement/setorienttoauto)() | يضبط قيمة السمة "orient" على "auto" . |
...
| اسم | وصف |
| --- | --- |
| const [SVG_MARKERUNITS_STROKEWIDTH](../../aspose.html.dom.svg/svgmarkerelement/svg_markerunits_strokewidth) | قيمة السمة "markerUnits" هي "strokeWidth" . |
| const [SVG_MARKERUNITS_UNKNOWN](../../aspose.html.dom.svg/svgmarkerelement/svg_markerunits_unknown) | نوع وحدة العلامة ليس من الأنواع المحددة مسبقًا. من غير الصحيح محاولة تحديد قيمة جديدة من هذا النوع أو محاولة تبديل قيمة موجودة إلى هذا النوع. |
| const [SVG_MARKERUNITS_USERSPACEONUSE](../../aspose.html.dom.svg/svgmarkerelement/svg_markerunits_userspaceonuse) | قيمة السمة "markerUnits" هي "userSpaceOnUse" . |
| const [SVG_MARKER_ORIENT_ANGLE](../../aspose.html.dom.svg/svgmarkerelement/svg_marker_orient_angle) | السمة "الاتجاه" لها قيمة زاوية . |
| const [SVG_MARKER_ORIENT_AUTO](../../aspose.html.dom.svg/svgmarkerelement/svg_marker_orient_auto) | السمة "المشرق" لها قيمة "تلقائية" . |
| const [SVG_MARKER_ORIENT_UNKNOWN](../../aspose.html.dom.svg/svgmarkerelement/svg_marker_orient_unknown) | اتجاه العلامة ليس أحد الأنواع المحددة مسبقًا. من غير الصحيح محاولة تحديد قيمة جديدة من هذا النوع أو محاولة تبديل قيمة موجودة إلى هذا النوع. |
