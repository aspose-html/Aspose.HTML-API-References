...
description: جميع واجهات SVG DOM التي تتوافق مباشرةً مع العناصر في لغة SVG مثل واجهة SVGPathElement لعنصر المسار مشتقة من واجهة SVGElement.
type: docs
weight: 2030
url: /ar/net/aspose.html.dom.svg/svgelement/
---
## SVGElement class

جميع واجهات SVG DOM التي تتوافق مباشرةً مع العناصر في لغة SVG (مثل واجهة SVGPathElement لعنصر "المسار") مشتقة من واجهة SVGElement.
