...
description: يتم توريث SVGTextContentElement بواسطة واجهات متعددة متعلقة بالنص  مثل SVGTextElement و SVGTSpanElement و SVGTRefElement و SVGAltGlyphElement و SVGTextPathElement. بالنسبة للأساليب الموجودة على هذه الواجهة والتي تشير إلى فهرس لحرف أو عدد من الأحرف  يجب أن تكون هذه المراجع يتم تفسيره على أنه فهرس لوحدة رمز UTF16 أو عدد من وحدات رمز UTF16  على التوالي. هذا للتوافق مع DOM Level 2 Core  حيث تستخدم الطرق الموجودة على واجهة CharacterData وحدات كود UTF16 كفهرس وحساب ضمن بيانات الأحرف  وبالتالي  على سبيل المثال  إذا كان محتوى النص لعنصر نصي عنصرًا واحدًا غير حرف BMP  مثل U  10000  ثم استدعاء getNumberOfChars على هذا العنصر سيعيد 2 نظرًا لوجود وحدتي رمز UTF16 الزوج البديل يستخدمان لتمثيل هذا الحرف الواحد.
type: docs
weight: 2350
url: /ar/net/aspose.html.dom.svg/svgtextcontentelement/
---
## SVGTextContentElement class

يتم توريث SVGTextContentElement بواسطة واجهات متعددة متعلقة بالنص ، مثل SVGTextElement و SVGTSpanElement و SVGTRefElement و SVGAltGlyphElement و SVGTextPathElement. بالنسبة للأساليب الموجودة على هذه الواجهة والتي تشير إلى فهرس لحرف أو عدد من الأحرف ، يجب أن تكون هذه المراجع يتم تفسيره على أنه فهرس لوحدة رمز UTF-16 أو عدد من وحدات رمز UTF-16 ، على التوالي. هذا للتوافق مع DOM Level 2 Core ، حيث تستخدم الطرق الموجودة على واجهة CharacterData وحدات كود UTF-16 كفهرس وحساب ضمن بيانات الأحرف ، وبالتالي ، على سبيل المثال ، إذا كان محتوى النص لعنصر "نصي" عنصرًا واحدًا غير- حرف BMP ، مثل U + 10000 ، ثم استدعاء getNumberOfChars على هذا العنصر سيعيد 2 نظرًا لوجود وحدتي رمز UTF-16 (الزوج البديل) يستخدمان لتمثيل هذا الحرف الواحد.
...
| اسم | وصف |
| --- | --- |
| const [LENGTHADJUST_SPACING](../../aspose.html.dom.svg/svgtextcontentelement/lengthadjust_spacing) | يتوافق مع القيمة "تباعد" . |
| const [LENGTHADJUST_SPACINGANDGLYPHS](../../aspose.html.dom.svg/svgtextcontentelement/lengthadjust_spacingandglyphs) | يتوافق مع القيمة "spacingAndGlyphs" . |
| const [LENGTHADJUST_UNKNOWN](../../aspose.html.dom.svg/svgtextcontentelement/lengthadjust_unknown) | تم تعيين التعداد على قيمة ليست من الأنواع المحددة مسبقًا. من غير الصحيح محاولة تحديد قيمة جديدة من هذا النوع أو محاولة تبديل قيمة موجودة إلى هذا النوع. |
