...
description: تتوافق واجهة SVGMaskElement مع عنصر القناع.
type: docs
weight: 2180
url: /ar/net/aspose.html.dom.svg/svgmaskelement/
---
## SVGMaskElement class

تتوافق واجهة SVGMaskElement مع عنصر "القناع".
...
| [Height](../../aspose.html.dom.svg/svgmaskelement/height) { get; } | يتوافق مع سمة "الارتفاع" على عنصر "القناع" المحدد. يأخذ أحد الثوابت المعرفة في SVGUnitTypes. |
...
| [MaskContentUnits](../../aspose.html.dom.svg/svgmaskelement/maskcontentunits) { get; } | يتوافق مع السمة "maskContentUnits" في عنصر "القناع" المحدد. يأخذ أحد الثوابت المعرفة في SVGUnitTypes. |
| [MaskUnits](../../aspose.html.dom.svg/svgmaskelement/maskunits) { get; } | يتوافق مع السمة "maskUnits" على عنصر "القناع" المحدد. يأخذ أحد الثوابت المعرفة في SVGUnitTypes. |
...
| [RequiredExtensions](../../aspose.html.dom.svg/svgmaskelement/requiredextensions) { get; } | يتوافق مع السمة "requiredExtensions" في العنصر المحدد. |
| [RequiredFeatures](../../aspose.html.dom.svg/svgmaskelement/requiredfeatures) { get; } | يتوافق مع السمة "requiredFeatures" في العنصر المحدد . |
...
| [SystemLanguage](../../aspose.html.dom.svg/svgmaskelement/systemlanguage) { get; } | يتوافق مع السمة "systemLanguage" على العنصر المحدد. |
...
| [Width](../../aspose.html.dom.svg/svgmaskelement/width) { get; } | يتوافق مع السمة "العرض" على عنصر "القناع" المحدد. يأخذ أحد الثوابت المعرفة في SVGUnitTypes. |
| [X](../../aspose.html.dom.svg/svgmaskelement/x) { get; } | يتوافق مع السمة "x" في عنصر "القناع" المحدد. يأخذ أحد الثوابت المعرفة في SVGUnitTypes. |
| [Y](../../aspose.html.dom.svg/svgmaskelement/y) { get; } | يتوافق مع السمة "y" في عنصر "القناع" المحدد. يأخذ أحد الثوابت المعرفة في SVGUnitTypes. |
