...
description: Aspose.Html.Dom.Svg.SVGMaskElement فصل. تتوافق واجهة SVGMaskElement مع عنصر القناع.
type: docs
weight: 2170
...
| [MaskUnits](../../aspose.html.dom.svg/svgmaskelement/maskunits/) { get; } | يتوافق مع السمة "maskUnits" في عنصر "القناع" المحدد. يأخذ أحد الثوابت المعرفة في SVGUnitTypes. |
