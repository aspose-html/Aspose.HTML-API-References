...
description: تتوافق واجهة SVGFilterElement مع عنصر عامل التصفية.
type: docs
weight: 2070
url: /ar/net/aspose.html.dom.svg/svgfilterelement/
---
## SVGFilterElement class

تتوافق واجهة SVGFilterElement مع عنصر "عامل التصفية".
...
| [FilterUnits](../../aspose.html.dom.svg/svgfilterelement/filterunits) { get; } | يتوافق مع السمة "filterUnits" في عنصر "التصفية" المحدد. يأخذ أحد الثوابت المعرفة في SVGUnitTypes. |
...
| [Height](../../aspose.html.dom.svg/svgfilterelement/height) { get; } | يتوافق مع السمة "الارتفاع" على عنصر "الفلتر" المحدد . |
| [Href](../../aspose.html.dom.svg/svgfilterelement/href) { get; } | يتوافق مع السمة "xlink: href" في العنصر المحدد. |
...
| [PrimitiveUnits](../../aspose.html.dom.svg/svgfilterelement/primitiveunits) { get; } | يتوافق مع السمة "primitiveUnits" على عنصر "مرشح" المحدد. يأخذ أحد الثوابت المعرفة في SVGUnitTypes. |
...
| [Width](../../aspose.html.dom.svg/svgfilterelement/width) { get; } | يتوافق مع السمة "العرض" على عنصر "الفلتر" المحدد . |
| [X](../../aspose.html.dom.svg/svgfilterelement/x) { get; } | يتوافق مع السمة "x" في عنصر "عامل التصفية" المحدد . |
| [Y](../../aspose.html.dom.svg/svgfilterelement/y) { get; } | يتوافق مع السمة "y" في عنصر "عامل التصفية" المحدد . |
