...
description: تتوافق واجهة SVGTextPathElement مع عنصر مسار النص.
type: docs
weight: 2370
url: /ar/net/aspose.html.dom.svg/svgtextpathelement/
---
## SVGTextPathElement class

تتوافق واجهة SVGTextPathElement مع عنصر "مسار النص".
...
| [Href](../../aspose.html.dom.svg/svgtextpathelement/href) { get; } | يتوافق مع السمة "xlink: href" في العنصر المحدد. |
...
| [LengthAdjust](../../aspose.html.dom.svg/svgtextcontentelement/lengthadjust) { get; } | يتوافق مع السمة "lengthAdjust" على العنصر المحدد. يجب أن تكون القيمة أحد ثوابت ضبط الطول المحددة في هذه الواجهة. |
...
| [Method](../../aspose.html.dom.svg/svgtextpathelement/method) { get; } | يتوافق مع السمة "الطريقة" في عنصر "مسار النص" المحدد . |
...
| [Spacing](../../aspose.html.dom.svg/svgtextpathelement/spacing) { get; } | يتوافق مع السمة "التباعد" على عنصر "مسار النص" المحدد. |
| [StartOffset](../../aspose.html.dom.svg/svgtextpathelement/startoffset) { get; } | يتوافق مع السمة "startOffset" على عنصر "textPath" المحدد. |
...
| [TextLength](../../aspose.html.dom.svg/svgtextcontentelement/textlength) { get; } | يتوافق مع السمة "textLength" في العنصر المحدد. |
...
| [GetNumberOfChars](../../aspose.html.dom.svg/svgtextcontentelement/getnumberofchars)() | إرجاع العدد الإجمالي للأحرف المتاحة للعرض داخل العنصر الحالي ، والذي يتضمن الأحرف المشار إليها من مرجع "tref" ، بصرف النظر عما إذا كان سيتم تقديمها أم لا. على نحو فعال ، هذا يعادل طول سمة Node :: textContent من DOM Level 3 Core ([DOM3] ، القسم 1.4) ، إذا وسعت هذه السمة أيضًا عناصر 'tref'. |
...
| اسم | وصف |
| --- | --- |
| const [TEXTPATH_METHODTYPE_ALIGN](../../aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_align) | يتوافق مع القيمة "محاذاة" . |
| const [TEXTPATH_METHODTYPE_STRETCH](../../aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_stretch) | يتوافق مع القيمة "امتداد" . |
| const [TEXTPATH_METHODTYPE_UNKNOWN](../../aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_unknown) | تم تعيين التعداد على قيمة ليست من الأنواع المحددة مسبقًا. من غير الصحيح محاولة تحديد قيمة جديدة من هذا النوع أو محاولة تبديل قيمة موجودة إلى هذا النوع. |
| const [TEXTPATH_SPACINGTYPE_AUTO](../../aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_auto) | يتوافق مع القيمة "auto" . |
| const [TEXTPATH_SPACINGTYPE_EXACT](../../aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_exact) | يتوافق مع القيمة "بالضبط" . |
| const [TEXTPATH_SPACINGTYPE_UNKNOWN](../../aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_unknown) | تم تعيين التعداد على قيمة ليست من الأنواع المحددة مسبقًا. من غير الصحيح محاولة تحديد قيمة جديدة من هذا النوع أو محاولة تبديل قيمة موجودة إلى هذا النوع. |
