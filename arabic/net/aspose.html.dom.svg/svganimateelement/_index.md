...
description: تتوافق واجهة SVGAnimateElement مع عنصر animate . لا يتوفر الوصول الموجه للكائنات إلى سمات العنصر animate عبر SVG DOM .
type: docs
weight: 1920
url: /ar/net/aspose.html.dom.svg/svganimateelement/
---
## SVGAnimateElement class

تتوافق واجهة SVGAnimateElement مع عنصر "animate" . لا يتوفر الوصول الموجه للكائنات إلى سمات العنصر "animate" عبر SVG DOM .
