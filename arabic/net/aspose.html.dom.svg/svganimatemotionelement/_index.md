...
description: تتوافق واجهة SVGAnimateMotionElement مع عنصر animateMotion. لا يتوفر الوصول الموجه للكائنات إلى سمات عنصر animateMotion عبر SVG DOM .
type: docs
weight: 1930
url: /ar/net/aspose.html.dom.svg/svganimatemotionelement/
---
## SVGAnimateMotionElement class

تتوافق واجهة SVGAnimateMotionElement مع عنصر "animateMotion". لا يتوفر الوصول الموجه للكائنات إلى سمات عنصر "animateMotion" عبر SVG DOM .
