...
description: يحدد ملفIParentNode./iparentnode واجهة يتم تنفيذها من قبل أي من الوالدين المحتملين .
type: docs
weight: 960
...
يحدد ملف[`IParentNode`](../iparentnode) واجهة يتم تنفيذها من قبل أي من الوالدين المحتملين .
