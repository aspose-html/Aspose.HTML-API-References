...
description: Aspose.Html.Dom.Node فصل. واجهة العقدة هي نوع البيانات الأساسي لنموذج كائن المستند بأكمله. يمثل عقدة واحدة في شجرة الوثيقة.
type: docs
weight: 1000
url: /ar/net/aspose.html.dom/node/
---
## Node class
...
| abstract [NodeName](../../aspose.html.dom/node/nodename/) { get; } | اسم هذه العقدة حسب نوعها. |
| abstract [NodeType](../../aspose.html.dom/node/nodetype/) { get; } | رمز يمثل نوع الكائن الأساسي. |
...
| [CloneNode](../../aspose.html.dom/node/clonenode/#clonenode)() | إرجاع نسخة مكررة من هذه العقدة ، على سبيل المثال ، بمثابة مُنشئ نسخة عام للعقد. لا تحتوي العقدة المكررة على أصل (العقدة الأم خالية) ولا توجد بيانات مستخدم. |
| [CloneNode](../../aspose.html.dom/node/clonenode/#clonenode_1)(bool) | إرجاع نسخة مكررة من هذه العقدة ، على سبيل المثال ، بمثابة مُنشئ نسخة عام للعقد. لا تحتوي العقدة المكررة على أصل (العقدة الأم خالية) ولا توجد بيانات مستخدم. |
...
| اسم | وصف |
| --- | --- |
| const [ATTRIBUTE_NODE](../../aspose.html.dom/node/attribute_node/) | السمة node |
| const [CDATA_SECTION_NODE](../../aspose.html.dom/node/cdata_section_node/) | عقدة قسم cdata |
| const [COMMENT_NODE](../../aspose.html.dom/node/comment_node/) | عقدة تعليق |
| const [DOCUMENT_FRAGMENT_NODE](../../aspose.html.dom/node/document_fragment_node/) | عقدة جزء من المستند |
| const [DOCUMENT_NODE](../../aspose.html.dom/node/document_node/) | وثيقة عقدة |
| const [DOCUMENT_TYPE_NODE](../../aspose.html.dom/node/document_type_node/) | نوع المستند node |
| const [ELEMENT_NODE](../../aspose.html.dom/node/element_node/) | عقدة عنصر |
| const [ENTITY_NODE](../../aspose.html.dom/node/entity_node/) | عقدة كيان |
| const [ENTITY_REFERENCE_NODE](../../aspose.html.dom/node/entity_reference_node/) | عقدة مرجعية لكيان |
| const [NOTATION_NODE](../../aspose.html.dom/node/notation_node/) | عقدة تدوين |
| const [PROCESSING_INSTRUCTION_NODE](../../aspose.html.dom/node/processing_instruction_node/) | عقدة تعليمات المعالجة |
| const [TEXT_NODE](../../aspose.html.dom/node/text_node/) | عقدة نصية |
