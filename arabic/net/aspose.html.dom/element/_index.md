...
description: Aspose.Html.Dom.Element فصل. تمثل واجهة العنصر عنصرًا في مستند HTML أو XML.
type: docs
weight: 690
...
| اسم | وصف |
| --- | --- |
| [Element](element/)(IElementInit) | يقوم بتهيئة مثيل جديد لملف`Element`فصل. لا تستدعي هذا المنشئ مباشرة ، استخدم[`CreateElement`](../document/createelement/) أو[`CreateElementNS`](../document/createelementns/) . |
...
| [ParentElement](../../aspose.html.dom/node/parentelement/) { get; } | يحصل على الوالد`Element` من هذه العقدة. |
