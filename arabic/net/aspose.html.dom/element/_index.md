...
description: تمثل واجهة العنصر عنصرًا في مستند HTML أو XML.
type: docs
weight: 700
url: /ar/net/aspose.html.dom/element/
---
## Element class

تمثل واجهة العنصر عنصرًا في مستند HTML أو XML.
...
| اسم | وصف |
| --- | --- |
| [Element](element)(IElementInit) | يقوم بتهيئة مثيل جديد لملف[`Element`](../element)صف دراسي. لا تستدعي هذا المنشئ مباشرة ، استخدم[`CreateElement`](../document/createelement) أو[`CreateElementNS`](../document/createelementns) . |
...
| [Id](../../aspose.html.dom/element/id) { get; set; } | معرف العنصر. راجع تعريف سمة المعرف في HTML 4.01. |
