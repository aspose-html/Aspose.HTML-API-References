...
description: يوفر DocumentType واجهة لقائمة الكيانات المحددة للمستند document
type: docs
weight: 690
...
| اسم | وصف |
| --- | --- |
| [DocumentType](documenttype)(string, string, string, string, Document) | يقوم بتهيئة مثيل جديد لملف[`DocumentType`](../documenttype) فئة . |
