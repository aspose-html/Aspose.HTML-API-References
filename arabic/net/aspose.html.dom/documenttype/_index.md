...
description: Aspose.Html.Dom.DocumentType فصل. يوفر DocumentType واجهة لقائمة الكيانات المحددة للمستند document
type: docs
weight: 680
url: /ar/net/aspose.html.dom/documenttype/
---
## DocumentType class

يوفر DocumentType واجهة لقائمة الكيانات المحددة للمستند document
...
| اسم | وصف |
| --- | --- |
| [DocumentType](documenttype/)(string, string, string, string, Document) | يقوم بتهيئة مثيل جديد لملف`DocumentType` فئة . |
...
| [InternalSubset](../../aspose.html.dom/documenttype/internalsubset/) { get; } | المجموعة الفرعية الداخلية كسلسلة ، أو فارغة إذا لم يكن هناك أي منها. |
...
| [Name](../../aspose.html.dom/documenttype/name/) { get; } | اسم DTD ؛ على سبيل المثال ، الاسم الذي يلي الكلمة الأساسية DOCTYPE مباشرة. |
...
| override [NodeName](../../aspose.html.dom/documenttype/nodename/) { get; } | اسم هذه العقدة حسب نوعها. |
| override [NodeType](../../aspose.html.dom/documenttype/nodetype/) { get; } | رمز يمثل نوع الكائن الأساسي. |
...
| [PublicId](../../aspose.html.dom/documenttype/publicid/) { get; } | المعرف العام للمجموعة الفرعية الخارجية . |
| [SystemId](../../aspose.html.dom/documenttype/systemid/) { get; } | معرّف النظام الخاص بالمجموعة الفرعية الخارجية. قد يكون هذا URI مطلقًا أم لا. |
...
| override [ToString](../../aspose.html.dom/documenttype/tostring/)() | إرجاع أString الذي يمثل هذا المثال. |
