...
description: Aspose.Html.Dom.CDATASection فصل. يتم استخدام أقسام CDATA للتخلص من كتل النص التي تحتوي على أحرف يمكن اعتبارها ترميزًا.
type: docs
weight: 200
url: /ar/net/aspose.html.dom/cdatasection/
---
## CDATASection class
...
| override [NodeName](../../aspose.html.dom/cdatasection/nodename/) { get; } | اسم هذه العقدة حسب نوعها. |
| override [NodeType](../../aspose.html.dom/cdatasection/nodetype/) { get; } | رمز يمثل نوع الكائن الأساسي. |
