...
description: Aspose.Html.Dom.EntityReference فصل. يمكن استخدام عقد EntityReference لتمثيل مرجع كيان في الشجرة.
type: docs
weight: 710
url: /ar/net/aspose.html.dom/entityreference/
---
## EntityReference class

يمكن استخدام عقد EntityReference لتمثيل مرجع كيان في الشجرة.
...
| override [NodeName](../../aspose.html.dom/entityreference/nodename/) { get; } | اسم هذه العقدة حسب نوعها. |
| override [NodeType](../../aspose.html.dom/entityreference/nodetype/) { get; } | رمز يمثل نوع الكائن الأساسي. |
