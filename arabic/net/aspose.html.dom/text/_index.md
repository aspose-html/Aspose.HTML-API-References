...
description: Aspose.Html.Dom.Text فصل. ترث واجهة النص من CharacterData وتمثل المحتوى النصي بيانات الأحرف المسماة في XML لعنصر أو Attr.
type: docs
weight: 2450
url: /ar/net/aspose.html.dom/text/
---
## Text class

ترث واجهة النص من CharacterData وتمثل المحتوى النصي (بيانات الأحرف المسماة في XML) لعنصر أو Attr.
...
| [IsElementContentWhitespace](../../aspose.html.dom/text/iselementcontentwhitespace/) { get; } | يعرض ما إذا كانت عقدة النص هذه تحتوي على مسافة بيضاء لمحتوى عنصر ، وغالبًا ما يطلق عليها بشكل مسيء "مسافة بيضاء يمكن تجاهلها" . |
...
| override [NodeName](../../aspose.html.dom/text/nodename/) { get; } | اسم هذه العقدة حسب نوعها. |
| override [NodeType](../../aspose.html.dom/text/nodetype/) { get; } | رمز يمثل نوع الكائن الأساسي. |
| override [NodeValue](../../aspose.html.dom/text/nodevalue/) { get; set; } | قيمة هذه العقدة حسب نوعها. |
...
| [WholeText](../../aspose.html.dom/text/wholetext/) { get; } | إرجاع كل نص العقد النصية المتجاورة منطقيًا إلى هذه العقدة ، متسلسلة بترتيب المستند. |
...
| [ReplaceWholeText](../../aspose.html.dom/text/replacewholetext/)(string) | يستبدل نص العقدة الحالية وكل عقد النص المتجاورة منطقيًا بالنص المحدد. تتم إزالة جميع العقد النصية المتجاورة منطقيًا بما في ذلك العقدة الحالية ما لم تكن مستلم النص البديل. |
| [SplitText](../../aspose.html.dom/text/splittext/)(int) | يكسر هذه العقدة إلى عقدتين عند الإزاحة المحددة ، مع الاحتفاظ بكل منهما في الشجرة كأشقاء . |
