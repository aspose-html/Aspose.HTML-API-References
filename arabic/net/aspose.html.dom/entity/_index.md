...
description: Aspose.Html.Dom.Entity فصل. يمثل كيانًا معروفًا  سواء تم تحليله أو عدم تحليله  في مستند XML.
type: docs
weight: 700
url: /ar/net/aspose.html.dom/entity/
---
## Entity class

يمثل كيانًا معروفًا ، سواء تم تحليله أو عدم تحليله ، في مستند XML.
...
| [InputEncoding](../../aspose.html.dom/entity/inputencoding/) { get; } | سمة تحدد الترميز المستخدم لهذا الكيان في وقت التحليل ، عندما يكون كيانًا خارجيًا محللًا. يعد هذا فارغًا إذا كان كيانًا من مجموعة فرعية داخلية أو إذا كان غير معروف. |
...
| override [NodeName](../../aspose.html.dom/entity/nodename/) { get; } | اسم هذه العقدة حسب نوعها. |
| override [NodeType](../../aspose.html.dom/entity/nodetype/) { get; } | رمز يمثل نوع الكائن الأساسي. |
| virtual [NodeValue](../../aspose.html.dom/node/nodevalue/) { get; set; } | قيمة هذه العقدة حسب نوعها. |
| [NotationName](../../aspose.html.dom/entity/notationname/) { get; } | بالنسبة للكيانات التي لم يتم تحليلها ، اسم الترميز الخاص بالكيان. بالنسبة للكيانات التي تم تحليلها ، يعد هذا فارغًا . |
...
| [PublicId](../../aspose.html.dom/entity/publicid/) { get; } | المعرف العام المرتبط بالكيان إذا تم تحديده ، وخالٍ بخلاف ذلك. |
| [SystemId](../../aspose.html.dom/entity/systemid/) { get; } | معرّف النظام المرتبط بالكيان إذا تم تحديده ، وخالٍ بخلاف ذلك. قد يكون هذا URI مطلقًا أم لا. |
...
| [XmlEncoding](../../aspose.html.dom/entity/xmlencoding/) { get; } | سمة تحدد ، كجزء من الإعلان النصي ، ترميز هذا الكيان ، عندما يكون كيانًا خارجيًا محللًا. هذا لاغى خلاف ذلك. |
| [XmlVersion](../../aspose.html.dom/entity/xmlversion/) { get; } | سمة تحدد ، كجزء من الإعلان النصي ، رقم إصدار هذا الكيان ، عندما يكون كيانًا خارجيًا محللًا. هذا لاغى خلاف ذلك. |
