...
description: Aspose.Html.Dom.Notation فصل. يمثل تدوينًا معلنًا في DTD.
type: docs
weight: 1010
url: /ar/net/aspose.html.dom/notation/
---
## Notation class
...
| override [NodeName](../../aspose.html.dom/notation/nodename/) { get; } | اسم هذه العقدة حسب نوعها. |
| override [NodeType](../../aspose.html.dom/notation/nodetype/) { get; } | رمز يمثل نوع الكائن الأساسي. |
...
| [PublicId](../../aspose.html.dom/notation/publicid/) { get; } | المعرف العام لهذا الترميز. إذا لم يتم تحديد المعرف العام ، فسيكون هذا فارغًا. |
| [SystemId](../../aspose.html.dom/notation/systemid/) { get; } | معرّف النظام الخاص بهذا الترميز. إذا لم يتم تحديد معرّف النظام ، فسيكون هذا فارغًا. قد يكون هذا URI مطلقًا أم لا. |
