...
description: Aspose.Html.Dom.DocumentFragment فصل. DocumentFragment هو كائن مستند خفيف الوزن أو بسيط. من الشائع جدًا أن تكون قادرًا على استخراج جزء من شجرة المستند أو إنشاء جزء جديد من المستند.
type: docs
weight: 670
