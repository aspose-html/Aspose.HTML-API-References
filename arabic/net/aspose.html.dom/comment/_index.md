...
description: Aspose.Html.Dom.Comment فصل. يرث من CharacterData ويمثل محتوى التعليق  أي جميع الأحرف بين البداية  .
type: docs
weight: 310
url: /ar/net/aspose.html.dom/comment/
---
## Comment class

يرث من CharacterData ويمثل محتوى التعليق ، أي جميع الأحرف بين البداية ' .
...
| override [NodeName](../../aspose.html.dom/comment/nodename/) { get; } | اسم هذه العقدة حسب نوعها. |
| override [NodeType](../../aspose.html.dom/comment/nodetype/) { get; } | رمز يمثل نوع الكائن الأساسي. |
| override [NodeValue](../../aspose.html.dom/comment/nodevalue/) { get; set; } | قيمة هذه العقدة حسب نوعها. |
