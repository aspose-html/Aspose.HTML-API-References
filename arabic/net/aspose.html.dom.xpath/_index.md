...
| [IXPathExpression](./ixpathexpression) | ملف`XPathExpression`تمثل الواجهة تعبير XPath الذي تم تحليله وتم حله. |
...
| [IXPathResult](./ixpathresult) | ملف`XPathResult` تمثل الواجهة نتيجة تقييم تعبير XPath 1.0 ضمن سياق عقدة معينة. نظرًا لأن تقييم لتعبير XPath يمكن أن يؤدي إلى أنواع نتائج مختلفة ، فإن هذا الكائن يجعل من الممكن اكتشاف نوع وقيمة النتيجة ومعالجتها. |
## تعداد
