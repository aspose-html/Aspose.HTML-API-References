...
description: Aspose.Html.Toolkit.Markdown.Syntax.OrderedListItemMarker فصل. تمثيل علامة عنصر القائمة المطلوبة .
type: docs
weight: 5290
url: /ar/net/aspose.html.toolkit.markdown.syntax/orderedlistitemmarker/
---
## OrderedListItemMarker class

تمثيل علامة عنصر القائمة المطلوبة .
...
| اسم | وصف |
| --- | --- |
| virtual [Accept](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/accept/)(MarkdownSyntaxVisitor) | قبول الزائر . |
...
| [GetDelimiter](../../aspose.html.toolkit.markdown.syntax/orderedlistitemmarker/getdelimiter/)() | يحدد واجهة الحصول على المحدد. |
| [GetIndex](../../aspose.html.toolkit.markdown.syntax/orderedlistitemmarker/getindex/)() | يحدد واجهة الحصول على فهرس get . |
