...
description: Aspose.Html.Toolkit.Markdown.Syntax.ReferenceImageSyntaxNode فصل. صيغة الصورة المرجعية .
type: docs
weight: 5510
url: /ar/net/aspose.html.toolkit.markdown.syntax/referenceimagesyntaxnode/
---
## ReferenceImageSyntaxNode class

صيغة الصورة المرجعية .
...
| اسم | وصف |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/referenceimagesyntaxnode/accept/)(MarkdownSyntaxVisitor) | يحدد الواجهة لقبول الزائر. |
...
| [GetAltText](../../aspose.html.toolkit.markdown.syntax/referenceimagesyntaxnode/getalttext/)() | يحدد الواجهة للحصول على النص البديل. |
| [GetLabel](../../aspose.html.toolkit.markdown.syntax/referenceimagesyntaxnode/getlabel/)() | يحدد الواجهة للحصول على التسمية . |
