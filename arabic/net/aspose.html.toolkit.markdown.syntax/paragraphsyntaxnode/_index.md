...
description: Aspose.Html.Toolkit.Markdown.Syntax.ParagraphSyntaxNode فصل. تمثيل عقدة بناء جملة الفقرة .
type: docs
weight: 5310
url: /ar/net/aspose.html.toolkit.markdown.syntax/paragraphsyntaxnode/
---
## ParagraphSyntaxNode class

تمثيل عقدة بناء جملة الفقرة .
...
| اسم | وصف |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/paragraphsyntaxnode/accept/)(MarkdownSyntaxVisitor) | يحدد الواجهة لقبول الزائر. |
...
| [GetContent](../../aspose.html.toolkit.markdown.syntax/paragraphsyntaxnode/getcontent/)() | يحدد الواجهة للحصول على المحتوى . |
