...
description: Aspose.Html.Toolkit.Markdown.Syntax.HardBreakSyntaxNode فصل. يمثل HardBreakSyntaxNode.
type: docs
weight: 5010
url: /ar/net/aspose.html.toolkit.markdown.syntax/hardbreaksyntaxnode/
---
...
| virtual [Source](../../aspose.html.toolkit.markdown.syntax/linebreaksyntaxnode/source/) { get; } | احصل على المصدر . |
| virtual [Span](../../aspose.html.toolkit.markdown.syntax/linebreaksyntaxnode/span/) { get; } | احصل على الامتداد . |
| [Value](../../aspose.html.toolkit.markdown.syntax/linebreaksyntaxnode/value/) { get; } | احصل على القيمة . |

## طُرق

| اسم | وصف |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/hardbreaksyntaxnode/accept/)(MarkdownSyntaxVisitor) | يحدد الواجهة لقبول الزائر . |
...
| [GetBreakingTag](../../aspose.html.toolkit.markdown.syntax/hardbreaksyntaxnode/getbreakingtag/)() | يحدد الواجهة للحصول على Breaking Tag |
