...
description: Aspose.Html.Toolkit.Markdown.Syntax.ThematicBreakSyntaxNode فصل. تم استكمال عقدة بناء الجملة الموضوعية.
type: docs
weight: 5680
url: /ar/net/aspose.html.toolkit.markdown.syntax/thematicbreaksyntaxnode/
---
## ThematicBreakSyntaxNode class

تم استكمال عقدة بناء الجملة الموضوعية.
...
| اسم | وصف |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/thematicbreaksyntaxnode/accept/)(MarkdownSyntaxVisitor) | يحدد واجهة قبول الزائر. |
