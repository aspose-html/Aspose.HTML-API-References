...
description: Aspose.Html.Toolkit.Markdown.Syntax.SetextHeadingSyntaxNode فصل. تمثل عقدة بناء جملة عنوان Setext .
type: docs
weight: 5530
url: /ar/net/aspose.html.toolkit.markdown.syntax/setextheadingsyntaxnode/
---
## SetextHeadingSyntaxNode class

تمثل عقدة بناء جملة عنوان Setext .
...
| [Level](../../aspose.html.toolkit.markdown.syntax/setextheadingsyntaxnode/level/) { get; } | احصل على مستوى بناء الجملة الحالي . |
...
| اسم | وصف |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/setextheadingsyntaxnode/accept/)(MarkdownSyntaxVisitor) | يحدد الواجهة لقبول الزائر. |
