...
description: Aspose.Html.Toolkit.Markdown.Syntax.LinkDestinationSyntaxNode فصل. تمثيل LinkDestinationSyntaxNode .
type: docs
weight: 5110
url: /ar/net/aspose.html.toolkit.markdown.syntax/linkdestinationsyntaxnode/
---
## LinkDestinationSyntaxNode class

تمثيل LinkDestinationSyntaxNode .
...
| اسم | وصف |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/linkdestinationsyntaxnode/accept/)(MarkdownSyntaxVisitor) | يحدد الواجهة لقبول الزائر . |
...
| [GetEnumerator](../../aspose.html.toolkit.markdown.syntax/inlinecontainersyntaxnode/getenumerator/)() | إرجاع عداد يتكرر خلال المجموعة. |
...
| [GetValue](../../aspose.html.toolkit.markdown.syntax/linkdestinationsyntaxnode/getvalue/)() | يحدد الواجهة للحصول على قيمة السلسلة . |
