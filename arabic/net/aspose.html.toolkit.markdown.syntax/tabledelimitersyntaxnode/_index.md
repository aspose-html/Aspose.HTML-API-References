...
description: Aspose.Html.Toolkit.Markdown.Syntax.TableDelimiterSyntaxNode فصل. تمثيل عقدة بناء جملة محدد الجدول .
type: docs
weight: 5570
url: /ar/net/aspose.html.toolkit.markdown.syntax/tabledelimitersyntaxnode/
---
## TableDelimiterSyntaxNode class

تمثيل عقدة بناء جملة محدد الجدول .
