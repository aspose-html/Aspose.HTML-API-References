...
description: Aspose.Html.Toolkit.Markdown.Syntax.TextSyntaxNode فصل. تنفيذ عقدة بناء جملة النص .
type: docs
weight: 5670
url: /ar/net/aspose.html.toolkit.markdown.syntax/textsyntaxnode/
---
## TextSyntaxNode class

تنفيذ عقدة بناء جملة النص .
...
| اسم | وصف |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/textsyntaxnode/accept/)(MarkdownSyntaxVisitor) | يحدد الواجهة لقبول الزائر . |
