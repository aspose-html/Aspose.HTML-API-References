...
description: Aspose.Html.Toolkit.Markdown.Syntax.TaskListItemSyntaxNode فصل. عقدة بناء جملة عنصر قائمة المهام .
type: docs
weight: 5610
url: /ar/net/aspose.html.toolkit.markdown.syntax/tasklistitemsyntaxnode/
---
...
| اسم | وصف |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/listitemsyntaxnode/accept/)(MarkdownSyntaxVisitor) | يحدد الواجهة لقبول الزائر . |
...
| [GetLinesLeadingTrivia](../../aspose.html.toolkit.markdown.syntax/multilinecontainerblocksyntaxnode/getlinesleadingtrivia/)() | يحدد الواجهة للحصول على خطوط تؤدي إلى المعلومات التافهة . |
| [GetMarker](../../aspose.html.toolkit.markdown.syntax/listitemsyntaxnode/getmarker/)() | احصل على علامة |
...
| [IsChecked](../../aspose.html.toolkit.markdown.syntax/tasklistitemsyntaxnode/ischecked/)() | يحدد الواجهة للحصول على حالة الفحص . |
| [IsTight](../../aspose.html.toolkit.markdown.syntax/listitemsyntaxnode/istight/)() | تحقق مما إذا كان ضيقًا . |
