...
description: Aspose.Html.Toolkit.Markdown.Syntax.EscapedCharacterSyntaxNode فصل. تم تنفيذ عقدة بناء جملة أحرف الهروب.
type: docs
weight: 4890
url: /ar/net/aspose.html.toolkit.markdown.syntax/escapedcharactersyntaxnode/
---
## EscapedCharacterSyntaxNode class

تم تنفيذ عقدة بناء جملة أحرف الهروب.
...
| virtual [Source](../../aspose.html.toolkit.markdown.syntax/textsyntaxnode/source/) { get; } | إرجاع النص المصدر . |
| virtual [Span](../../aspose.html.toolkit.markdown.syntax/textsyntaxnode/span/) { get; } | يحدد الواجهة للحصول على الامتداد . |
| [Value](../../aspose.html.toolkit.markdown.syntax/textsyntaxnode/value/) { get; } | يحدد خاصية الحصول على قيمة السلسلة . |

## طُرق

| اسم | وصف |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/escapedcharactersyntaxnode/accept/)(MarkdownSyntaxVisitor) | يحدد الواجهة لقبول الزائر . |
