...
description: Aspose.Html.Toolkit.Markdown.Syntax.InlineProxy فصل. يمثل InlineProxy.
type: docs
weight: 5070
url: /ar/net/aspose.html.toolkit.markdown.syntax/inlineproxy/
---
## InlineProxy class
...
| اسم | وصف |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/inlineproxy/accept/)(MarkdownSyntaxVisitor) | يحدد الواجهة لقبول الزائر . |
...
| [GetTarget](../../aspose.html.toolkit.markdown.syntax/inlineproxy/gettarget/)() | يحدد الواجهة للحصول على الهدف . |
...
| override [WriteTo](../../aspose.html.toolkit.markdown.syntax/inlineproxy/writeto/#writeto)(MarkdownTextWriter) | الكتابة إلى كاتب النص. |
