...
description: Aspose.Html.Rendering.Device2TGraphicContextTRenderingOptions فصل. يمثل فئة أساسية لتنفيذ أجهزة عرض معينة.
type: docs
weight: 4140
...
| abstract [Clip](../../aspose.html.rendering/device-2/clip/)(FillMode) | يعدل مسار القطع الحالي عن طريق تقاطعه مع المسار الحالي ، باستخدام قاعدة FillMode لتحديد المنطقة المراد تعبئتها. تنهي هذه الطريقة المسار الحالي. |
