...
description: Aspose.Html.Dom.Svg.Filters.SVGFETurbulenceElement فصل. تتوافق واجهة SVGFETurbulenceElement مع عنصر feTurbulence.
type: docs
weight: 1600
...
| [BaseFrequencyY](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/basefrequencyy/) { get; } | يتوافق مع السمة "baseFrequency" على عنصر "feTurbulence" المحدد. يحتوي على المكوِّن Y لسمة "baseFrequency" (ربما يتم حسابها تلقائيًا). |
...
| const [SVG_STITCHTYPE_STITCH](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_stitchtype_stitch/) | يتوافق مع القيمة "غرزة" . |
