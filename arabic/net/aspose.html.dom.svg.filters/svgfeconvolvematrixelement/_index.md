...
description: تتوافق واجهة SVGFEConvolveMatrixElement مع عنصر feConvolveMatrix.
type: docs
weight: 1410
url: /ar/net/aspose.html.dom.svg.filters/svgfeconvolvematrixelement/
---
## SVGFEConvolveMatrixElement class

تتوافق واجهة SVGFEConvolveMatrixElement مع عنصر "feConvolveMatrix".
...
| [Bias](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/bias) { get; } | يتوافق مع السمة "التحيز" على عنصر "feConvolveMatrix" المحدد. |
...
| [Divisor](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/divisor) { get; } | يتوافق مع السمة "القاسم" على عنصر "feConvolveMatrix" المحدد. |
| [EdgeMode](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/edgemode) { get; } | يتوافق مع السمة "edgeMode" في عنصر "feConvolveMatrix" المحدد. |
...
| [Height](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/height) { get; } | يتوافق مع السمة "الارتفاع" على عنصر "الفلتر" المحدد . |
| [Id](../../aspose.html.dom.svg/svgelement/id) { get; set; } | قيمة السمة "id" في العنصر المحدد ، أو السلسلة الفارغة إذا لم يكن "id" موجودًا . |
| [In1](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/in1) { get; } | يتوافق مع السمة "in" في عنصر "feConvolveMatrix" المحدد . |
...
| [KernelMatrix](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelmatrix) { get; } | يتوافق مع السمة "kernelMatrix" على عنصر "feConvolveMatrix" المحدد. |
| [KernelUnitLengthX](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelunitlengthx) { get; } | يتوافق مع السمة "kernelUnitLength" في عنصر "feConvolveMatrix" المحدد. |
| [KernelUnitLengthY](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelunitlengthy) { get; } | يتوافق مع السمة "kernelUnitLength" في عنصر "feConvolveMatrix" المحدد. |
...
| [OrderX](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/orderx) { get; } | يتوافق مع السمة "الترتيب" على عنصر "feConvolveMatrix" المحدد . |
| [OrderY](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/ordery) { get; } | يتوافق مع السمة "الترتيب" على عنصر "feConvolveMatrix" المحدد . |
...
| [PreserveAlpha](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/preservealpha) { get; } | يتوافق مع السمة "keepAlpha" على عنصر "feConvolveMatrix" المحدد . |
...
| [Result](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/result) { get; } | يتوافق مع السمة "نتيجة" على عنصر "عامل التصفية" المحدد . |
...
| [TargetX](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/targetx) { get; } | يتوافق مع السمة "targetX" في عنصر "feConvolveMatrix" المحدد . |
| [TargetY](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/targety) { get; } | يتوافق مع السمة "targetY" في عنصر "feConvolveMatrix" المحدد . |
...
| [Width](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/width) { get; } | يتوافق مع السمة "العرض" على عنصر "الفلتر" المحدد . |
| [X](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/x) { get; } | يتوافق مع السمة "x" في عنصر "عامل التصفية" المحدد . |
| [Y](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/y) { get; } | يتوافق مع السمة "y" في عنصر "عامل التصفية" المحدد . |
...
| اسم | وصف |
| --- | --- |
| const [SVG_EDGEMODE_DUPLICATE](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_duplicate) | يتوافق مع القيمة "مكررة" . |
| const [SVG_EDGEMODE_NONE](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_none) | يتوافق مع القيمة "لا شيء" . |
| const [SVG_EDGEMODE_UNKNOWN](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_unknown) | النوع ليس من الأنواع المحددة مسبقًا. من غير الصحيح محاولة تحديد قيمة جديدة من هذا النوع أو محاولة تبديل قيمة موجودة إلى هذا النوع. |
| const [SVG_EDGEMODE_WRAP](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_wrap) | يتوافق مع القيمة "التفاف". |
