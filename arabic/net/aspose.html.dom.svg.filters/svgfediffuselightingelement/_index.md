...
description: واجهة SVGFEDiffuseLightingElement تتوافق مع عنصر feDiffuseLighting.
type: docs
weight: 1420
url: /ar/net/aspose.html.dom.svg.filters/svgfediffuselightingelement/
---
## SVGFEDiffuseLightingElement class

واجهة SVGFEDiffuseLightingElement تتوافق مع عنصر "feDiffuseLighting".
...
| [DiffuseConstant](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/diffuseconstant) { get; } | يتوافق مع السمة "diffuseConstant" على عنصر "feDiffuseLighting" المحدد. |
...
| [Height](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/height) { get; } | يتوافق مع السمة "الارتفاع" على عنصر "الفلتر" المحدد . |
| [Id](../../aspose.html.dom.svg/svgelement/id) { get; set; } | قيمة السمة "id" في العنصر المحدد ، أو السلسلة الفارغة إذا لم يكن "id" موجودًا . |
| [In1](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/in1) { get; } | يتوافق مع السمة "in" في عنصر "feDiffuseLighting" المحدد . |
...
| [KernelUnitLengthX](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/kernelunitlengthx) { get; } | يتوافق مع السمة "kernelUnitLength" في عنصر "feDiffuseLighting" المحدد. |
| [KernelUnitLengthY](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/kernelunitlengthy) { get; } | يتوافق مع السمة "kernelUnitLength" في عنصر "feDiffuseLighting" المحدد. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/result) { get; } | يتوافق مع السمة "نتيجة" على عنصر "عامل التصفية" المحدد . |
...
| [SurfaceScale](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/surfacescale) { get; } | يتوافق مع السمة "SurfaceScale" على عنصر "feDiffuseLighting" المحدد. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/width) { get; } | يتوافق مع السمة "العرض" على عنصر "الفلتر" المحدد . |
| [X](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/x) { get; } | يتوافق مع السمة "x" في عنصر "عامل التصفية" المحدد . |
| [Y](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/y) { get; } | يتوافق مع السمة "y" في عنصر "عامل التصفية" المحدد . |
