...
description: تتوافق واجهة SVGFETileElement مع عنصر feTile.
type: docs
weight: 1600
url: /ar/net/aspose.html.dom.svg.filters/svgfetileelement/
---
## SVGFETileElement class

تتوافق واجهة SVGFETileElement مع عنصر "feTile".
...
| [Height](../../aspose.html.dom.svg.filters/svgfetileelement/height) { get; } | يتوافق مع السمة "الارتفاع" على عنصر "الفلتر" المحدد . |
| [Id](../../aspose.html.dom.svg/svgelement/id) { get; set; } | قيمة السمة "id" في العنصر المحدد ، أو السلسلة الفارغة إذا لم يكن "id" موجودًا . |
| [In1](../../aspose.html.dom.svg.filters/svgfetileelement/in1) { get; } | يتوافق مع السمة "in" في عنصر "feTile" المحدد . |
...
| [Result](../../aspose.html.dom.svg.filters/svgfetileelement/result) { get; } | يتوافق مع السمة "نتيجة" على عنصر "عامل التصفية" المحدد . |
...
| [Width](../../aspose.html.dom.svg.filters/svgfetileelement/width) { get; } | يتوافق مع السمة "العرض" على عنصر "الفلتر" المحدد . |
| [X](../../aspose.html.dom.svg.filters/svgfetileelement/x) { get; } | يتوافق مع السمة "x" في عنصر "عامل التصفية" المحدد . |
| [Y](../../aspose.html.dom.svg.filters/svgfetileelement/y) { get; } | يتوافق مع السمة "y" في عنصر "عامل التصفية" المحدد . |
