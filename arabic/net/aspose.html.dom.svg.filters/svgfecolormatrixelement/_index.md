...
description: تتوافق واجهة SVGFEColorMatrixElement مع عنصر feColorMatrix.
type: docs
weight: 1380
url: /ar/net/aspose.html.dom.svg.filters/svgfecolormatrixelement/
---
## SVGFEColorMatrixElement class

تتوافق واجهة SVGFEColorMatrixElement مع عنصر "feColorMatrix".
...
| [Height](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/height) { get; } | يتوافق مع السمة "الارتفاع" على عنصر "الفلتر" المحدد . |
| [Id](../../aspose.html.dom.svg/svgelement/id) { get; set; } | قيمة السمة "id" في العنصر المحدد ، أو السلسلة الفارغة إذا لم يكن "id" موجودًا . |
| [In1](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/in1) { get; } | يتوافق مع السمة "in" في عنصر "feColorMatrix" المحدد . |
...
| [Result](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/result) { get; } | يتوافق مع السمة "نتيجة" على عنصر "عامل التصفية" المحدد . |
...
| [Type](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/type) { get; } | يتوافق مع السمة "النوع" على عنصر "feColorMatrix" المحدد. يأخذ أحد ثوابت SVG_FECOLORMATRIX_TYPE_ * المحددة في هذه الواجهة. |
| [Values](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/values) { get; } | يتوافق مع السمة "قيم" على عنصر "feColorMatrix" المحدد. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/width) { get; } | يتوافق مع السمة "العرض" على عنصر "الفلتر" المحدد . |
| [X](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/x) { get; } | يتوافق مع السمة "x" في عنصر "عامل التصفية" المحدد . |
| [Y](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/y) { get; } | يتوافق مع السمة "y" في عنصر "عامل التصفية" المحدد . |
...
| اسم | وصف |
| --- | --- |
| const [SVG_FECOLORMATRIX_TYPE_HUEROTATE](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_huerotate) | يتوافق مع قيمة "hueRotate" . |
| const [SVG_FECOLORMATRIX_TYPE_LUMINANCETOALPHA](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_luminancetoalpha) | يتوافق مع قيمة "luminanceToAlpha" . |
| const [SVG_FECOLORMATRIX_TYPE_MATRIX](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_matrix) | يتوافق مع قيمة "المصفوفة" . |
| const [SVG_FECOLORMATRIX_TYPE_SATURATE](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_saturate) | يتوافق مع القيمة "التشبع" . |
| const [SVG_FECOLORMATRIX_TYPE_UNKNOWN](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_unknown) | النوع ليس من الأنواع المحددة مسبقًا. من غير الصحيح محاولة تحديد قيمة جديدة من هذا النوع أو محاولة تبديل قيمة موجودة إلى هذا النوع. |
