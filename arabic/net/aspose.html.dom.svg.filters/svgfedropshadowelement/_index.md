...
description: واجهة SVGFEDropShadowElement تتوافق مع عنصر feDropShadow.
type: docs
weight: 1450
url: /ar/net/aspose.html.dom.svg.filters/svgfedropshadowelement/
---
## SVGFEDropShadowElement class

واجهة SVGFEDropShadowElement تتوافق مع عنصر "feDropShadow".
...
| [Dx](../../aspose.html.dom.svg.filters/svgfedropshadowelement/dx) { get; } | يتوافق مع السمة "dx" على عنصر "feDropShadow" المحدد. |
| [Dy](../../aspose.html.dom.svg.filters/svgfedropshadowelement/dy) { get; } | يتوافق مع السمة "dy" على عنصر "feDropShadow" المحدد. |
...
| [Height](../../aspose.html.dom.svg.filters/svgfedropshadowelement/height) { get; } | يتوافق مع سمة "الارتفاع" على عنصر "feDropShadow" المحدد . |
| [Id](../../aspose.html.dom.svg/svgelement/id) { get; set; } | قيمة السمة "id" في العنصر المحدد ، أو السلسلة الفارغة إذا لم يكن "id" موجودًا . |
| [In1](../../aspose.html.dom.svg.filters/svgfedropshadowelement/in1) { get; } | يتوافق مع السمة "in" في عنصر "feDropShadow" المحدد . |
...
| [Result](../../aspose.html.dom.svg.filters/svgfedropshadowelement/result) { get; } | يتوافق مع السمة "نتيجة" على عنصر "feDropShadow" المحدد . |
...
| [StdDeviationX](../../aspose.html.dom.svg.filters/svgfedropshadowelement/stddeviationx) { get; } | يتوافق مع السمة "الانحراف القياسي" على عنصر "feDropShadow" المحدد. يحتوي على المكون X للسمة "الانحراف القياسي" . |
| [StdDeviationY](../../aspose.html.dom.svg.filters/svgfedropshadowelement/stddeviationy) { get; } | يتوافق مع السمة "الانحراف القياسي" على عنصر "feDropShadow" المحدد. يحتوي على المكون Y (ربما يتم حسابه تلقائيًا) للسمة "الانحراف المعياري" . |
...
| [Width](../../aspose.html.dom.svg.filters/svgfedropshadowelement/width) { get; } | يتوافق مع السمة "العرض" على عنصر "feDropShadow" المحدد . |
| [X](../../aspose.html.dom.svg.filters/svgfedropshadowelement/x) { get; } | يتوافق مع السمة "x" في عنصر "feDropShadow" المحدد . |
| [Y](../../aspose.html.dom.svg.filters/svgfedropshadowelement/y) { get; } | يتوافق مع السمة "y" في عنصر "feDropShadow" المحدد . |
...
| [SetStdDeviation](../../aspose.html.dom.svg.filters/svgfedropshadowelement/setstddeviation)(float, float) | يضبط قيم السمة "الانحراف القياسي" . |
