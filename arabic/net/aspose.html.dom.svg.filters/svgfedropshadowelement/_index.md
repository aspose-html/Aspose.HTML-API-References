...
description: Aspose.Html.Dom.Svg.Filters.SVGFEDropShadowElement فصل. واجهة SVGFEDropShadowElement تتوافق مع عنصر feDropShadow.
type: docs
weight: 1440
...
| [StdDeviationY](../../aspose.html.dom.svg.filters/svgfedropshadowelement/stddeviationy/) { get; } | يتوافق مع السمة "الانحراف القياسي" على عنصر "feDropShadow" المحدد. يحتوي على المكوِّن Y (الذي يُحسب تلقائيًا) للسمة "الانحراف المعياري" . |
