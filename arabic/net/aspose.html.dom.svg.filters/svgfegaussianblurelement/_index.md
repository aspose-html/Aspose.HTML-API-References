...
description: تتوافق واجهة SVGFEGaussianBlurElement مع العنصر feGaussianBlur .
type: docs
weight: 1510
url: /ar/net/aspose.html.dom.svg.filters/svgfegaussianblurelement/
---
## SVGFEGaussianBlurElement class

تتوافق واجهة SVGFEGaussianBlurElement مع العنصر �feGaussianBlur� .
...
| [Height](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/height) { get; } | يتوافق مع السمة "الارتفاع" على عنصر "عامل التصفية" المحدد . |
| [Id](../../aspose.html.dom.svg/svgelement/id) { get; set; } | قيمة السمة "id" في العنصر المحدد ، أو السلسلة الفارغة إذا لم يكن "id" موجودًا . |
| [In1](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/in1) { get; } | يتوافق مع السمة �في العنصر المحدد �� FeGaussianBlur� . |
...
| [Result](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/result) { get; } | يتوافق مع السمة �النتيجة على عنصر التصفية� المحدد . |
...
| [StdDeviationX](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/stddeviationx) { get; } | يتوافق مع السمة �stdDeviation� على عنصر �feGaussianBlur� المحدد. يحتوي على المكون X للسمة �stdDeviation�. |
| [StdDeviationY](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/stddeviationy) { get; } | يتوافق مع السمة �stdDeviation� على عنصر �feGaussianBlur� المحدد. يحتوي على المكون Y (ربما يتم حسابه تلقائيًا) للسمة �stdDeviation�. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/width) { get; } | يتوافق مع السمة "العرض" على عنصر التصفية "المحدد . |
| [X](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/x) { get; } | يتوافق مع السمة × على عنصر التصفية المحدد المحدد . |
| [Y](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/y) { get; } | يتوافق مع السمة � ص� على عنصر التصفية� المحدد . |
...
| [SetStdDeviation](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/setstddeviation)(float, float) | يعيّن قيم السمة �الانحراف القياسي� . |
