...
description: تتوافق واجهة SVGFECompositeElement مع عنصر feComposite.
type: docs
weight: 1400
url: /ar/net/aspose.html.dom.svg.filters/svgfecompositeelement/
---
## SVGFECompositeElement class

تتوافق واجهة SVGFECompositeElement مع عنصر "feComposite".
...
| [Height](../../aspose.html.dom.svg.filters/svgfecompositeelement/height) { get; } | يتوافق مع السمة "الارتفاع" على عنصر "الفلتر" المحدد . |
| [Id](../../aspose.html.dom.svg/svgelement/id) { get; set; } | قيمة السمة "id" في العنصر المحدد ، أو السلسلة الفارغة إذا لم يكن "id" موجودًا . |
| [In1](../../aspose.html.dom.svg.filters/svgfecompositeelement/in1) { get; } | يتوافق مع السمة "in" في عنصر "feComposite" المحدد . |
| [In2](../../aspose.html.dom.svg.filters/svgfecompositeelement/in2) { get; } | يتوافق مع السمة "in2" على عنصر "feComposite" المحدد . |
...
| [K1](../../aspose.html.dom.svg.filters/svgfecompositeelement/k1) { get; } | يتوافق مع السمة "k1" على عنصر "feComposite" المحدد . |
| [K2](../../aspose.html.dom.svg.filters/svgfecompositeelement/k2) { get; } | يتوافق مع السمة "k2" على عنصر "feComposite" المحدد. |
| [K3](../../aspose.html.dom.svg.filters/svgfecompositeelement/k3) { get; } | يتوافق مع السمة "k3" على عنصر "feComposite" المحدد . |
| [K4](../../aspose.html.dom.svg.filters/svgfecompositeelement/k4) { get; } | يتوافق مع السمة "k4" على عنصر "feComposite" المحدد. |
...
| [Operator](../../aspose.html.dom.svg.filters/svgfecompositeelement/operator) { get; } | يتوافق مع السمة "عامل التشغيل" على عنصر "feComposite" المحدد. يأخذ أحد ثوابت SVG_FECOMPOSITE_OPERATOR_ * المحددة في هذه الواجهة. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfecompositeelement/result) { get; } | يتوافق مع السمة "نتيجة" على عنصر "عامل التصفية" المحدد . |
...
| [Width](../../aspose.html.dom.svg.filters/svgfecompositeelement/width) { get; } | يتوافق مع السمة "العرض" على عنصر "الفلتر" المحدد . |
| [X](../../aspose.html.dom.svg.filters/svgfecompositeelement/x) { get; } | يتوافق مع السمة "x" في عنصر "عامل التصفية" المحدد . |
| [Y](../../aspose.html.dom.svg.filters/svgfecompositeelement/y) { get; } | يتوافق مع السمة "y" في عنصر "عامل التصفية" المحدد . |
...
| اسم | وصف |
| --- | --- |
| const [SVG_FECOMPOSITE_OPERATOR_ARITHMETIC](../../aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_arithmetic) | يتوافق مع القيمة "الحسابية" . |
| const [SVG_FECOMPOSITE_OPERATOR_ATOP](../../aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_atop) | يتوافق مع القيمة "أعلى" . |
| const [SVG_FECOMPOSITE_OPERATOR_IN](../../aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_in) | يتوافق مع القيمة "في" . |
| const [SVG_FECOMPOSITE_OPERATOR_OUT](../../aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_out) | يتوافق مع القيمة "out" . |
| const [SVG_FECOMPOSITE_OPERATOR_OVER](../../aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_over) | يتوافق مع القيمة "أكثر" . |
| const [SVG_FECOMPOSITE_OPERATOR_UNKNOWN](../../aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_unknown) | النوع ليس من الأنواع المحددة مسبقًا. من غير الصحيح محاولة تحديد قيمة جديدة من هذا النوع أو محاولة تبديل قيمة موجودة إلى هذا النوع. |
| const [SVG_FECOMPOSITE_OPERATOR_XOR](../../aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_xor) | يتوافق مع القيمة "xor" . |
