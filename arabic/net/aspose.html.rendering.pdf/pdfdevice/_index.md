...
description: Aspose.Html.Rendering.Pdf.PdfDevice فصل. يمثل التقديم إلى مستند pdf .
type: docs
weight: 4440
...
| override [Clip](../../aspose.html.rendering.pdf/pdfdevice/clip/)(FillMode) | يعدل مسار القطع الحالي عن طريق تقاطعه مع المسار الحالي ، باستخدام قاعدة FillMode لتحديد المنطقة المراد تعبئتها. تنهي هذه الطريقة المسار الحالي. |
