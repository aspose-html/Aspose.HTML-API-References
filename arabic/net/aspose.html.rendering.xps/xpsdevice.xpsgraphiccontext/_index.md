...
description: يحمل معلمات التحكم في الرسومات الحالية لجهاز XpsDevice. تحدد هذه المعلمات إطار العمل العام الذي ينفذ فيه مشغلو الرسومات.
type: docs
weight: 4520
url: /ar/net/aspose.html.rendering.xps/xpsdevice.xpsgraphiccontext/
---
## XpsDevice.XpsGraphicContext class

يحمل معلمات التحكم في الرسومات الحالية لجهاز XpsDevice. تحدد هذه المعلمات إطار العمل العام الذي ينفذ فيه مشغلو الرسومات.
...
| اسم | وصف |
| --- | --- |
| override [Clone](../../aspose.html.rendering.xps/xpsgraphiccontext/clone)() | إنشاء مثيل جديد لفئة XpsGraphicContext بنفس قيم الخصائص كمثيل موجود. |
