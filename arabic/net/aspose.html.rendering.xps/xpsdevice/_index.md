...
description: Aspose.Html.Rendering.Xps.XpsDevice فصل. يمثل التقديم إلى مستند xps .
type: docs
weight: 4530
...
| override [Clip](../../aspose.html.rendering.xps/xpsdevice/clip/)(FillMode) | يعدل مسار القطع الحالي عن طريق تقاطعه مع المسار الحالي ، باستخدام قاعدة FillMode لتحديد المنطقة المراد تعبئتها. تنهي هذه الطريقة المسار الحالي. |
