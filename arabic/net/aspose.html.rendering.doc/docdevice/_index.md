...
description: يمثل التقديم إلى مستند DOCX.
type: docs
weight: 4160
...
| اسم | وصف |
| --- | --- |
| [DocDevice](docdevice#constructor)(ICreateStreamProvider) | يقوم بتهيئة مثيل جديد لملف[`DocDevice`](../docdevice) فئة . |
| [DocDevice](docdevice#constructor_4)(Stream) | يقوم بتهيئة مثيل جديد لملف[`DocDevice`](../docdevice) فئة من خلال تيار الإخراج. |
| [DocDevice](docdevice#constructor_5)(string) | يقوم بتهيئة مثيل جديد لملف[`DocDevice`](../docdevice) فئة حسب اسم ملف الإخراج. |
| [DocDevice](docdevice#constructor_1)(DocRenderingOptions, ICreateStreamProvider) | يقوم بتهيئة مثيل جديد لملف[`DocDevice`](../docdevice) class عن طريق تقديم الخيارات وموفر البث. |
| [DocDevice](docdevice#constructor_2)(DocRenderingOptions, Stream) | يقوم بتهيئة مثيل جديد لملف[`DocDevice`](../docdevice) class عن طريق تقديم الخيارات ودفق الإخراج. |
| [DocDevice](docdevice#constructor_3)(DocRenderingOptions, string) | يقوم بتهيئة مثيل جديد لملف[`DocDevice`](../docdevice) class عن طريق تقديم الخيارات واسم ملف الإخراج. |
...
| override [Clip](../../aspose.html.rendering.doc/docdevice/clip)(FillMode) | يعدل مسار القطع الحالي من خلال تقاطعه مع المسار الحالي ، باستخدام قاعدة FillMode لتحديد المنطقة المراد تعبئتها. تنهي هذه الطريقة المسار الحالي. |
...
| اسم | وصف |
| --- | --- |
| class [DocGraphicContext](docdevice.docgraphiccontext) | يحمل معلمات التحكم في الرسومات الحالية لـ DocDevice. تحدد هذه المعلمات الإطار العام الذي ينفذ فيه مشغلو الرسومات. |
