...
description: لتكوين كائن ImageData من Uint8ClampedArray معطى وحجم الصورة التي يحتوي عليها. في حالة عدم وجود مصفوفة  يتم إنشاء صورة لمستطيل أسود.
type: docs
weight: 280
...
| [Height](../../aspose.html.dom.canvas/iimagedata/height) { get; } | طول بدون توقيع يمثل الارتفاع الفعلي ، بالبكسل ، لبيانات الصورة. |
