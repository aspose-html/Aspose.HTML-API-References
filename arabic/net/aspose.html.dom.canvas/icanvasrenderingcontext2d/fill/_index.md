...
description: يملأ المسارات الفرعية بنمط التعبئة الحالي والخوارزمية الافتراضية CanvasFillRule.Nonzero.
type: docs
weight: 220
url: /ar/net/aspose.html.dom.canvas/icanvasrenderingcontext2d/fill/
---
## Fill() {#fill}
...
| معامل | يكتب | وصف |
| --- | --- | --- |
| path | Path2D | مسار Path2D المراد تعبئته. |
