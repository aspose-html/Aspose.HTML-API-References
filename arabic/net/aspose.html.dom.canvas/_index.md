...
| فصل | وصف |
| --- | --- |
| [Path2D](./path2d) | يتم استخدام واجهة Path2D لواجهة Canvas 2D API لتعريف المسارات التي يتم استخدامها لاحقًا في كائنات CanvasRenderingContext2D. توجد طرق مسار واجهة CanvasRenderingContext2D على هذه الواجهة أيضًا وتسمح لك بإنشاء مسارات يمكنك الاحتفاظ بها وإعادة تشغيلها كما هو مطلوب على لوحة الرسم. |
## واجهات
