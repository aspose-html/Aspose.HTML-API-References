...
| override [Read](../../aspose.html.io/outputstream/read)(byte[], int, int) | يقرأ تسلسل البايت من تيار الإخراج المغلف ويقدم الموضع داخل الدفق بعدد وحدات البايت المقروءة. |
