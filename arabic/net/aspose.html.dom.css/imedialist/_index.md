...
description: توفر واجهة MediaList تجريدًا لمجموعة مرتبة من الوسائط  دون تعريف أو تقييد كيفية تنفيذ هذه المجموعة. القائمة الفارغة هي نفس القائمة التي تحتوي على الوسيط الكل.
type: docs
weight: 590
...
توفر واجهة MediaList تجريدًا لمجموعة مرتبة من الوسائط ، دون تعريف أو تقييد كيفية تنفيذ هذه المجموعة. القائمة الفارغة هي نفس القائمة التي تحتوي على الوسيط "الكل".
...
| [DeleteMedium](../../aspose.html.dom.css/imedialist/deletemedium)(string) | يحذف الوسيط المشار إليه بواسطة oldMedium من القائمة. |
