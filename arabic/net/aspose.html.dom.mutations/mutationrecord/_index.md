...
description: يمثل سجل الطفرة طفرة DOM فردية. إنه الكائن الذي يتم تمريره إليهMutationObserver./mutationobserver سMutationCallback./mutationcallback .
type: docs
weight: 1000
...
| [AttributeName](../../aspose.html.dom.mutations/mutationrecord/attributename) { get; } | إرجاع الاسم المحلي للسمة التي تم تغييرها ، وإرجاع القيمة الفارغة بخلاف ذلك. |
