...
description: Aspose.Html.Rendering.Image.ImageDevice فصل. يمثل التقديم إلى التنسيقات النقطية jpeg  png  bmp  gif  tiff .
type: docs
weight: 4300
...
| override [Clip](../../aspose.html.rendering.image/imagedevice/clip/)(FillMode) | يعدل مسار القطع الحالي عن طريق تقاطعه مع المسار الحالي ، باستخدام قاعدة FillMode لتحديد المنطقة المراد تعبئتها. تنهي هذه الطريقة المسار الحالي. |
