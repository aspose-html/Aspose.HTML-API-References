...
description: Aspose.Html.HTMLPreElement فصل. نص منسق مسبقًا. راجع تعريف عنصر PRE في HTML 4.01.
type: docs
weight: 3490
url: /ar/net/aspose.html/htmlpreelement/
---
## HTMLPreElement class

نص منسق مسبقًا. راجع تعريف عنصر PRE في HTML 4.01.
...
| [Width](../../aspose.html/htmlpreelement/width/) { get; set; } | عرض ثابت للمحتوى. راجع تعريف سمة العرض في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
