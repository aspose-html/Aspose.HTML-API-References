...
description: Aspose.Html.HTMLIsIndexElement فصل. يُستخدم هذا العنصر لإدخال نص أحادي السطر. راجع تعريف عنصر ISINDEX في HTML 4.01. تم إهمال هذا العنصر في HTML 4.01.
type: docs
weight: 3330
url: /ar/net/aspose.html/htmlisindexelement/
---
## HTMLIsIndexElement class

يُستخدم هذا العنصر لإدخال نص أحادي السطر. راجع تعريف عنصر ISINDEX في HTML 4.01. تم إهمال هذا العنصر في HTML 4.01.
...
| [Form](../../aspose.html/htmlisindexelement/form/) { get; } | إرجاع ملف عنصر يحتوي على عنصر التحكم هذا. إرجاع إذا لم يكن عنصر التحكم هذا ضمن سياق نموذج . |
...
| [Prompt](../../aspose.html/htmlisindexelement/prompt/) { get; set; } | الرسالة الفورية. راجع تعريف سمة المطالبة في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
