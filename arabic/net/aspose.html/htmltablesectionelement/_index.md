...
description: Aspose.Html.HTMLTableSectionElement فصل. ملفثياد وTFOOT  وTBODY عناصر.
type: docs
weight: 3590
url: /ar/net/aspose.html/htmltablesectionelement/
---
## HTMLTableSectionElement class

ملف`ثياد` و`TFOOT` ، و`TBODY` عناصر.
...
| اسم | وصف |
| --- | --- |
| [Align](../../aspose.html/htmltablesectionelement/align/) { get; set; } | محاذاة أفقية للبيانات في الخلايا. انظر`محاذاة` للحصول على تفاصيل HTMLTheadElement. |
...
| [Ch](../../aspose.html/htmltablesectionelement/ch/) { get; set; } | حرف المحاذاة للخلايا الموجودة في عمود. انظر تعريف السمة char في HTML 4.01. |
...
| [ChOff](../../aspose.html/htmltablesectionelement/choff/) { get; set; } | إزاحة حرف المحاذاة. راجع تعريف سمة charoff في HTML 4.01. |
...
| [Rows](../../aspose.html/htmltablesectionelement/rows/) { get; } | مجموعة الصفوف في قسم الجدول هذا. |
...
| [VAlign](../../aspose.html/htmltablesectionelement/valign/) { get; set; } | المحاذاة العمودية للبيانات في الخلايا. انظر`فالين` للحصول على تفاصيل HTMLTheadElement. |
...
| [DeleteRow](../../aspose.html/htmltablesectionelement/deleterow/)(int) | حذف صف من هذا القسم. |
...
| [InsertRow](../../aspose.html/htmltablesectionelement/insertrow/)(int) | أدخل صفًا في هذا القسم. يتم إدخال الصف الجديد مباشرة قبل الحالي`فِهرِس` الصف العاشر في هذا القسم. إذا `فِهرِس` هو -1 أو يساوي عدد الصفوف في قسم هذا ، يتم إلحاق الصف الجديد. |
