...
description: ملفثياد وTFOOT  وTBODY عناصر.
type: docs
weight: 3580
...
| اسم | وصف |
| --- | --- |
| [Align](../../aspose.html/htmltablesectionelement/align) { get; set; } | المحاذاة الأفقية للبيانات في الخلايا. انظر`محاذاة` السمة لـ HTMLTheadElement لمزيد من التفاصيل. |
...
| [Ch](../../aspose.html/htmltablesectionelement/ch) { get; set; } | حرف المحاذاة للخلايا الموجودة في عمود. راجع تعريف السمة char في HTML 4.01. |
...
| [VAlign](../../aspose.html/htmltablesectionelement/valign) { get; set; } | المحاذاة العمودية للبيانات في الخلايا. انظر`فالين` السمة لـ HTMLTheadElement لمزيد من التفاصيل. |
...
| [InsertRow](../../aspose.html/htmltablesectionelement/insertrow)(int) | أدخل صفًا في هذا القسم. يتم إدخال الصف الجديد مباشرة قبل الحالي`فهرس` الصف العاشر في هذا القسم. إذا `فهرس` هو -1 أو يساوي عدد الصفوف في قسم هذا ، يتم إلحاق الصف الجديد. |
