...
description: Aspose.Html.HTMLQuoteElement فصل. لملفس وبلوك كويوتعناصر. راجع تعريف عنصر Q في HTML 4.01.
type: docs
weight: 3500
url: /ar/net/aspose.html/htmlquoteelement/
---
## HTMLQuoteElement class

لملف`س` و`بلوك كويوت`عناصر. راجع تعريف عنصر Q في HTML 4.01.
...
| [Cite](../../aspose.html/htmlquoteelement/cite/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] تعيين مستند أو رسالة مصدر. راجع تعريف سمة الاستشهاد في HTML 4.01. |
