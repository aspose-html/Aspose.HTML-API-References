...
description: لملفس وبلوك كويوتعناصر. راجع تعريف عنصر Q في HTML 4.01.
type: docs
weight: 3490
...
| [Cite](../../aspose.html/htmlquoteelement/cite) { get; set; } | عنوان URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] تعيين مصدر أو رسالة. راجع تعريف سمة الاستشهاد في HTML 4.01. |
