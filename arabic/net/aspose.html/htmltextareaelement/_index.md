...
description: Aspose.Html.HTMLTextAreaElement فصل. حقل نص متعدد الأسطر. راجع تعريف عنصر TEXTAREA في HTML 4.01.
type: docs
weight: 3610
url: /ar/net/aspose.html/htmltextareaelement/
---
## HTMLTextAreaElement class

حقل نص متعدد الأسطر. راجع تعريف عنصر TEXTAREA في HTML 4.01.
...
| اسم | وصف |
| --- | --- |
| [AccessKey](../../aspose.html/htmltextareaelement/accesskey/) { get; set; } | مفتاح وصول ذو حرف واحد لمنح حق الوصول إلى عنصر التحكم في النموذج. راجع تعريف سمة مفتاح الوصول في HTML 4.01. |
...
| [Cols](../../aspose.html/htmltextareaelement/cols/) { get; set; } | عرض عنصر التحكم (بالأحرف). راجع تعريف السمة cols في HTML 4.01. |
| [DefaultValue](../../aspose.html/htmltextareaelement/defaultvalue/) { get; set; } | يمثل محتويات العنصر. لا تتغير قيمة هذه السمة إذا تغيرت محتويات عنصر تحكم النموذج المقابل ، في وكيل مستخدم تفاعلي . @ الإصدار DOM المستوى 2 |
...
| [Disabled](../../aspose.html/htmltextareaelement/disabled/) { get; set; } | عنصر التحكم غير متوفر في هذا السياق. راجع تعريف السمة المعطلة في HTML 4.01. |
...
| [Form](../../aspose.html/htmltextareaelement/form/) { get; } | إرجاع ملف`استمارة` عنصر يحتوي على عنصر التحكم هذا. إرجاع `باطل` إذا لم يكن عنصر التحكم هذا ضمن سياق نموذج . |
...
| [Name](../../aspose.html/htmltextareaelement/name/) { get; set; } | عنصر تحكم النموذج أو اسم الكائن عند إرساله مع نموذج. راجع اسم تعريف السمة في HTML 4.01. |
...
| [ReadOnly](../../aspose.html/htmltextareaelement/readonly/) { get; set; } | عنصر التحكم هذا للقراءة فقط. راجع تعريف السمة للقراءة فقط في HTML 4.01. |
| [Rows](../../aspose.html/htmltextareaelement/rows/) { get; set; } | عدد صفوف النص. راجع تعريف سمة الصفوف في HTML 4.01. |
...
| [TabIndex](../../aspose.html/htmltextareaelement/tabindex/) { get; set; } | الفهرس الذي يمثل موضع العنصر في ترتيب الجدولة. راجع تعريف السمة tabindex في HTML 4.01. |
...
| [Type](../../aspose.html/htmltextareaelement/type/) { get; } | نوع عنصر تحكم النموذج هذا. هذه السلسلة "textarea" . |
| [Value](../../aspose.html/htmltextareaelement/value/) { get; set; } | يمثل المحتويات الحالية لعنصر تحكم النموذج المقابل ، في وكيل مستخدم تفاعلي. يؤدي تغيير هذه السمة إلى تغيير محتويات لعنصر تحكم النموذج ، ولكنه لا يغير محتويات عنصر . إذا كانت البيانات بأكملها لا يمكن أن تتناسب مع ملف واحد`DOMString` ، قد يقوم التطبيق باقتطاع البيانات. |
