...
description: حقل نص متعدد الأسطر. راجع تعريف عنصر TEXTAREA في HTML 4.01.
type: docs
weight: 3600
...
| [Cols](../../aspose.html/htmltextareaelement/cols) { get; set; } | عرض عنصر التحكم (بالأحرف). راجع تعريف سمة cols في HTML 4.01. |
...
| [Form](../../aspose.html/htmltextareaelement/form) { get; } | إرجاع ملف`شكل` عنصر يحتوي على عنصر التحكم هذا. إرجاع `لا شيء` إذا لم يكن عنصر التحكم هذا ضمن سياق نموذج . |
