...
description: Aspose.Html.HTMLLegendElement فصل. يوفر شرحًا لملفالحقول التجمع. راجع تعريف عنصر LEGEND في HTML 4.01.
type: docs
weight: 3360
url: /ar/net/aspose.html/htmllegendelement/
---
## HTMLLegendElement class

يوفر شرحًا لملف`الحقول` التجمع. راجع تعريف عنصر LEGEND في HTML 4.01.
...
| اسم | وصف |
| --- | --- |
| [AccessKey](../../aspose.html/htmllegendelement/accesskey/) { get; set; } | مفتاح وصول ذو حرف واحد لمنح حق الوصول إلى عنصر التحكم في النموذج. راجع تعريف سمة مفتاح الوصول في HTML 4.01. |
| [Align](../../aspose.html/htmllegendelement/align/) { get; set; } | محاذاة النص بالنسبة إلى`الحقول` . راجع تعريف السمة align في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
...
| [Form](../../aspose.html/htmllegendelement/form/) { get; } | إرجاع ملف`استمارة` عنصر يحتوي على عنصر التحكم هذا. إرجاع `باطل` إذا لم يكن عنصر التحكم هذا ضمن سياق نموذج . |
