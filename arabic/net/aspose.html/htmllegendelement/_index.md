...
description: يوفر شرحًا لملفالحقول التجمع. راجع تعريف عنصر LEGEND في HTML 4.01.
type: docs
weight: 3350
...
| [Form](../../aspose.html/htmllegendelement/form) { get; } | إرجاع ملف`شكل` عنصر يحتوي على عنصر التحكم هذا. إرجاع `لا شيء` إذا لم يكن عنصر التحكم هذا ضمن سياق نموذج . |
