...
description: Aspose.Html.HTMLDListElement فصل. قائمة التعريفات. راجع تعريف عنصر DL في HTML 4.01.
type: docs
weight: 3150
url: /ar/net/aspose.html/htmldlistelement/
---
## HTMLDListElement class

قائمة التعريفات. راجع تعريف عنصر DL في HTML 4.01.
...
| [Compact](../../aspose.html/htmldlistelement/compact/) { get; set; } | تقليل التباعد بين عناصر القائمة. راجع تعريف السمة المدمجة في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
