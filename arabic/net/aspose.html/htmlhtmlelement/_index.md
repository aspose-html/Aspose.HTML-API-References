...
description: Aspose.Html.HTMLHtmlElement فصل. جذر مستند HTML. راجع تعريف عنصر HTML في HTML 4.01.
type: docs
weight: 3290
url: /ar/net/aspose.html/htmlhtmlelement/
---
## HTMLHtmlElement class

جذر مستند HTML. راجع تعريف عنصر HTML في HTML 4.01.
...
| [Version](../../aspose.html/htmlhtmlelement/version/) { get; set; } | معلومات الإصدار حول DTD للمستند. راجع تعريف سمة الإصدار في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
