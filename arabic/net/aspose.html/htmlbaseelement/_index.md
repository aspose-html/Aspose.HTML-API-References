...
description: عنوان URL لقاعدة المستند IETF RFC 2396http//www.ietf.org/rfc/rfc2396.txt . راجع تعريف عنصر BASE في HTML 4.01.
type: docs
weight: 3090
...
| [Href](../../aspose.html/htmlbaseelement/href) { get; set; } | معرّف الموارد المنتظم الأساسي [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ]. راجع تعريف سمة href في HTML 4.01. |
