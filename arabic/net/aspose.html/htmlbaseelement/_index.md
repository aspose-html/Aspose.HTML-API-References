...
description: Aspose.Html.HTMLBaseElement فصل. عنوان URL لقاعدة المستند IETF RFC 2396 . راجع تعريف عنصر BASE في HTML 4.01.
type: docs
weight: 3100
url: /ar/net/aspose.html/htmlbaseelement/
---
## HTMLBaseElement class

عنوان URL لقاعدة المستند [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ]. راجع تعريف عنصر BASE في HTML 4.01.
...
| [Href](../../aspose.html/htmlbaseelement/href/) { get; set; } | URI الأساسي [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ]. راجع تعريف سمة href في HTML 4.01. |
...
| [Target](../../aspose.html/htmlbaseelement/target/) { get; set; } | الإطار الهدف الافتراضي. راجع تعريف السمة الهدف في HTML 4.01. |
