...
description: Aspose.Html.HTMLIFrameElement فصل. النوافذ الفرعية المضمنة. راجع تعريف عنصر IFRAME في HTML 4.01.
type: docs
weight: 3300
url: /ar/net/aspose.html/htmliframeelement/
---
## HTMLIFrameElement class

النوافذ الفرعية المضمنة. راجع تعريف عنصر IFRAME في HTML 4.01.
...
| اسم | وصف |
| --- | --- |
| [Align](../../aspose.html/htmliframeelement/align/) { get; set; } | محاذاة هذا الكائن (عموديًا أو أفقيًا) فيما يتعلق بالنص المحيط به . راجع تعريف سمة المحاذاة في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
...
| [FrameBorder](../../aspose.html/htmliframeelement/frameborder/) { get; set; } | طلب حدود الإطار. راجع تعريف سمة إطار العمل في HTML 4.01. |
| [Height](../../aspose.html/htmliframeelement/height/) { get; set; } | ارتفاع الإطار. راجع تعريف سمة الارتفاع في HTML 4.01. |
...
| [LongDesc](../../aspose.html/htmliframeelement/longdesc/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] تعيين وصف طويل لهذه الصورة أو الإطار. راجع تعريف السمة longdesc في HTML 4.01. |
| [MarginHeight](../../aspose.html/htmliframeelement/marginheight/) { get; set; } | ارتفاع هامش الإطار بالبكسل. راجع تعريف السمة marginheight في HTML 4.01. |
| [MarginWidth](../../aspose.html/htmliframeelement/marginwidth/) { get; set; } | عرض هامش الإطار بالبكسل. راجع تعريف سمة عرض الهامش في HTML 4.01. |
| [Name](../../aspose.html/htmliframeelement/name/) { get; set; } | اسم الإطار (كائن من`هدف` يصف). راجع تعريف سمة الاسم في HTML 4.01. |
...
| [Scrolling](../../aspose.html/htmliframeelement/scrolling/) { get; set; } | حدد ما إذا كان يجب أن يحتوي الإطار على أشرطة تمرير أم لا. راجع تعريف سمة التمرير في HTML 4.01. |
| [ShadowRoot](../../aspose.html.dom/element/shadowroot/) { get; } | تُرجع shadowRoot المخزنة في هذا العنصر أو تُرجع فارغة إذا كان مغلقًا. |
| [Src](../../aspose.html/htmliframeelement/src/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] تعيين محتويات الإطار الأولي. راجع تعريف السمة src في HTML 4.01. |
...
| [Width](../../aspose.html/htmliframeelement/width/) { get; set; } | عرض الإطار. راجع تعريف سمة العرض في HTML 4.01. |
