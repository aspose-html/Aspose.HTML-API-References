...
description: النوافذ الفرعية المضمنة. راجع تعريف عنصر IFRAME في HTML 4.01.
type: docs
weight: 3290
...
| [Name](../../aspose.html/htmliframeelement/name) { get; set; } | اسم الإطار (كائن من`استهداف` ينسب). راجع تعريف سمة الاسم في HTML 4.01. |
...
| [Src](../../aspose.html/htmliframeelement/src) { get; set; } | عنوان URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] تعيين محتويات الإطار الأولي. راجع تعريف السمة src في HTML 4.01. |
