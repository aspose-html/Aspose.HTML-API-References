...
description: الكائن المستخدم لتمثيلالعاشر وTD عناصر. راجع تعريف عنصر TD في HTML 4.01.
type: docs
weight: 3540
...
الكائن المستخدم لتمثيل`العاشر` و`TD` عناصر. راجع تعريف عنصر TD في HTML 4.01.
...
| [Ch](../../aspose.html/htmltablecellelement/ch) { get; set; } | حرف المحاذاة للخلايا الموجودة في عمود. راجع تعريف السمة char في HTML 4.01. |
...
| [Headers](../../aspose.html/htmltablecellelement/headers) { get; set; } | قائمة`هوية شخصية` قيم السمات لخلايا الرأس. راجع تعريف السمة headers في HTML 4.01. |
