...
description: Aspose.Html.HTMLTableCellElement فصل. الكائن المستخدم لتمثيلذ وTD عناصر. راجع تعريف عنصر TD في HTML 4.01.
type: docs
weight: 3550
url: /ar/net/aspose.html/htmltablecellelement/
---
## HTMLTableCellElement class

الكائن المستخدم لتمثيل`ذ` و`TD` عناصر. راجع تعريف عنصر TD في HTML 4.01.
...
| اسم | وصف |
| --- | --- |
| [Abbr](../../aspose.html/htmltablecellelement/abbr/) { get; set; } | اختصار لخلايا الرأس. راجع تعريف سمة الاختصار في HTML 4.01. |
| [Align](../../aspose.html/htmltablecellelement/align/) { get; set; } | محاذاة أفقية للبيانات في الخلية. راجع تعريف سمة المحاذاة في HTML 4.01. |
...
| [Axis](../../aspose.html/htmltablecellelement/axis/) { get; set; } | مجموعة أسماء الرؤوس ذات الصلة. راجع تعريف سمة المحور في HTML 4.01. |
...
| [BgColor](../../aspose.html/htmltablecellelement/bgcolor/) { get; set; } | لون خلفية الخلية. راجع تعريف سمة bgcolor في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
| [CellIndex](../../aspose.html/htmltablecellelement/cellindex/) { get; } | فهرس هذه الخلية في الصف ، بدءًا من 0. هذا الفهرس بترتيب شجرة المستندات وليس ترتيب العرض . |
| [Ch](../../aspose.html/htmltablecellelement/ch/) { get; set; } | حرف المحاذاة للخلايا الموجودة في عمود. انظر تعريف السمة char في HTML 4.01. |
...
| [ChOff](../../aspose.html/htmltablecellelement/choff/) { get; set; } | إزاحة حرف المحاذاة. راجع تعريف سمة charoff في HTML 4.01. |
...
| [ColSpan](../../aspose.html/htmltablecellelement/colspan/) { get; set; } | عدد الأعمدة الممتدة بواسطة الخلية. راجع تعريف سمة colspan في HTML 4.01. |
...
| [Headers](../../aspose.html/htmltablecellelement/headers/) { get; set; } | قائمة`بطاقة تعريف` قيم السمات لخلايا الرأس. راجع تعريف السمة headers في HTML 4.01. |
| [Height](../../aspose.html/htmltablecellelement/height/) { get; set; } | ارتفاع الخلية. راجع تعريف سمة الارتفاع في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
...
| [NoWrap](../../aspose.html/htmltablecellelement/nowrap/) { get; set; } | منع التفاف الكلمات. راجع تعريف السمة nowrap في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
...
| [RowSpan](../../aspose.html/htmltablecellelement/rowspan/) { get; set; } | عدد الصفوف الممتدة بواسطة الخلية. راجع تعريف سمة rowspan في HTML 4.01. |
| [SchemaTypeInfo](../../aspose.html.dom/element/schematypeinfo/) { get; } | نوع المعلومات المرتبطة بهذا العنصر . |
| [Scope](../../aspose.html/htmltablecellelement/scope/) { get; set; } | النطاق مغطى بخلايا الرأس. راجع تعريف سمة النطاق في HTML 4.01. |
...
| [VAlign](../../aspose.html/htmltablecellelement/valign/) { get; set; } | محاذاة عمودية للبيانات في الخلية. راجع تعريف سمة valign في HTML 4.01. |
| [Width](../../aspose.html/htmltablecellelement/width/) { get; set; } | عرض الخلية. راجع تعريف سمة العرض في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
