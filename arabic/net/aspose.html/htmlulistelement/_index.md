...
description: Aspose.Html.HTMLUListElement فصل. قائمة غير مرتبة. راجع تعريف عنصر UL في HTML 4.01.
type: docs
weight: 3630
url: /ar/net/aspose.html/htmlulistelement/
---
## HTMLUListElement class

قائمة غير مرتبة. راجع تعريف عنصر UL في HTML 4.01.
...
| [Compact](../../aspose.html/htmlulistelement/compact/) { get; set; } | تقليل التباعد بين عناصر القائمة. راجع تعريف السمة المدمجة في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
...
| [Type](../../aspose.html/htmlulistelement/type/) { get; set; } | نمط رصاصة. راجع تعريف سمة النوع في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
