...
description: Aspose.Html.HTMLHRElement فصل. أنشئ قاعدة أفقية. راجع تعريف عنصر الموارد البشرية في HTML 4.01.
type: docs
weight: 3260
url: /ar/net/aspose.html/htmlhrelement/
---
## HTMLHRElement class

أنشئ قاعدة أفقية. راجع تعريف عنصر الموارد البشرية في HTML 4.01.
...
| اسم | وصف |
| --- | --- |
| [Align](../../aspose.html/htmlhrelement/align/) { get; set; } | قم بمحاذاة القاعدة في الصفحة. راجع تعريف سمة المحاذاة في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
...
| [NoShade](../../aspose.html/htmlhrelement/noshade/) { get; set; } | يشير إلى وكيل المستخدم أنه يجب ألا يكون هناك تظليل في عرض لهذا العنصر. راجع تعريف سمة noshade في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
...
| [Size](../../aspose.html/htmlhrelement/size/) { get; set; } | ارتفاع القاعدة. راجع تعريف سمة الحجم في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
...
| [Width](../../aspose.html/htmlhrelement/width/) { get; set; } | عرض القاعدة. راجع تعريف سمة العرض في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
