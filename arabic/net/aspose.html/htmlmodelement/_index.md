...
description: إشعار بتعديل جزء من المستند. راجع تعريفات INS و DEL في HTML 4.01.
type: docs
weight: 3400
...
| [Cite](../../aspose.html/htmlmodelement/cite) { get; set; } | عنوان URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] تعيين مستند يصف سبب التغيير. راجع تعريف سمة الاستشهاد في HTML 4.01. |
