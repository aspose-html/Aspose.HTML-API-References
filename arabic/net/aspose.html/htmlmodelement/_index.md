...
description: Aspose.Html.HTMLModElement فصل. إشعار بتعديل جزء من المستند. راجع تعريفات INS و DEL في HTML 4.01.
type: docs
weight: 3410
url: /ar/net/aspose.html/htmlmodelement/
---
## HTMLModElement class

إشعار بتعديل جزء من المستند. راجع تعريفات INS و DEL في HTML 4.01.
...
| [Cite](../../aspose.html/htmlmodelement/cite/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] تعيين مستند يصف سبب التغيير. راجع تعريف سمة الاستشهاد في HTML 4.01. |
...
| [DateTime](../../aspose.html/htmlmodelement/datetime/) { get; set; } | تاريخ التغيير ووقته. راجع تعريف سمة التاريخ والوقت في HTML 4.01. |
