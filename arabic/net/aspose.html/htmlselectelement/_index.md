...
description: يسمح عنصر التحديد بتحديد خيار. يمكن الوصول إلى الخيارات المضمنة مباشرة من خلال عنصر التحديد كمجموعة. راجع تعريف عنصر SELECT في HTML 4.01.
type: docs
weight: 3510
...
| [Form](../../aspose.html/htmlselectelement/form) { get; } | عدد الخيارات في هذا`تحديد` . |
...
| [Length](../../aspose.html/htmlselectelement/length) { get; set; } | عدد الخيارات في هذا`تحديد` . @ إصدار DOM المستوى 2 |
...
| [Multiple](../../aspose.html/htmlselectelement/multiple) { get; set; } | إذا كان صحيحًا ، متعدد`اختيار` يمكن تحديد العناصر في هذا`تحديد` . راجع تعريف السمات المتعددة في HTML 4.01. |
...
| [Options](../../aspose.html/htmlselectelement/options) { get; } | مجموعة ملفات`اختيار` العناصر التي يحتوي عليها هذا العنصر . @ إصدار DOM المستوى 2 |
...
| [Type](../../aspose.html/htmlselectelement/type) { get; } | نوع عنصر تحكم النموذج هذا. هذه هي السلسلة "select-multiple" عندما تكون السمة المتعددة هي`حقيقي` والسلسلة "حدد واحد" عندما`خاطئة` . |
