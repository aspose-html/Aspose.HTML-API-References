...
description: Aspose.Html.HTMLSelectElement فصل. يسمح عنصر التحديد بتحديد خيار. يمكن الوصول إلى الخيارات المضمنة مباشرة من خلال عنصر التحديد كمجموعة. راجع تعريف عنصر SELECT في HTML 4.01.
type: docs
weight: 3520
url: /ar/net/aspose.html/htmlselectelement/
---
## HTMLSelectElement class

يسمح عنصر التحديد بتحديد خيار. يمكن الوصول إلى الخيارات المضمنة مباشرة من خلال عنصر التحديد كمجموعة. راجع تعريف عنصر SELECT في HTML 4.01.
...
| [Disabled](../../aspose.html/htmlselectelement/disabled/) { get; set; } | عنصر التحكم غير متوفر في هذا السياق. راجع تعريف السمة المعطلة في HTML 4.01. |
...
| [Form](../../aspose.html/htmlselectelement/form/) { get; } | عدد الخيارات في هذا`يختار` . |
...
| [Length](../../aspose.html/htmlselectelement/length/) { get; set; } | عدد الخيارات في هذا`يختار` . @ إصدار DOM المستوى 2 |
...
| [Multiple](../../aspose.html/htmlselectelement/multiple/) { get; set; } | إذا كان صحيحًا ، متعدد`خيار` يمكن تحديد العناصر في هذا`يختار` . راجع تعريف السمات المتعددة في HTML 4.01. |
| [Name](../../aspose.html/htmlselectelement/name/) { get; set; } | عنصر تحكم النموذج أو اسم الكائن عند إرساله مع نموذج. راجع اسم تعريف السمة في HTML 4.01. |
...
| [Options](../../aspose.html/htmlselectelement/options/) { get; } | مجموعة ملفات`خيار` العناصر التي يحتوي عليها هذا العنصر . @ إصدار DOM المستوى 2 |
...
| [SelectedIndex](../../aspose.html/htmlselectelement/selectedindex/) { get; set; } | الفهرس الترتيبي للخيار المحدد ، بدءًا من 0. يتم إرجاع القيمة -1 إذا لم يتم تحديد أي عنصر. إذا تم تحديد خيارات متعددة ، فسيتم إرجاع فهرس الخيار الأول المحدد. |
| [ShadowRoot](../../aspose.html.dom/element/shadowroot/) { get; } | تُرجع shadowRoot المخزنة في هذا العنصر أو تُرجع فارغة إذا كان مغلقًا. |
| [Size](../../aspose.html/htmlselectelement/size/) { get; set; } | عدد الصفوف المرئية. راجع تعريف سمة الحجم في HTML 4.01. |
| [Style](../../aspose.html/htmlelement/style/) { get; } | يمثل سمة نمط تسمح للمؤلف بتطبيق معلومات النمط مباشرة على عنصر معين. |
| [TabIndex](../../aspose.html/htmlselectelement/tabindex/) { get; set; } | الفهرس الذي يمثل موضع العنصر في ترتيب الجدولة. راجع تعريف السمة tabindex في HTML 4.01. |
...
| [Type](../../aspose.html/htmlselectelement/type/) { get; } | نوع عنصر تحكم النموذج هذا. هذه هي السلسلة "select-multiple" عندما تكون السمة المتعددة هي`حقيقي` والسلسلة "حدد واحد" عندما`خطأ شنيع` . |
| [Value](../../aspose.html/htmlselectelement/value/) { get; set; } | قيمة التحكم في النموذج الحالية (أي قيمة الخيار المحدد حاليًا ) ، إذا تم تحديد خيارات متعددة ، فهذه هي القيمة للخيار الأول المحدد. |
