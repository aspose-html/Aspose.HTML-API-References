...
description: يوفر طرقًا للعمل مع سلسلة استعلام عناوين URL .
type: docs
weight: 3760
...
| اسم | وصف |
| --- | --- |
| [Append](../../aspose.html/iurlsearchparams/append)(string, string) | يتم إلحاق زوج جديد من الاسم والقيمة اسمه`اسم` والقيمة`القيمة` . |
...
| [Has](../../aspose.html/iurlsearchparams/has)(string) | للتحقق مما إذا كان هناك زوج اسم-قيمة اسمه`اسم` في القائمة . |
