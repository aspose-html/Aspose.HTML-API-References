...
description: أنمستند HTML هو جذر التسلسل الهرمي لـ HTML ويحمل المحتوى بأكمله. إلى جانب توفير الوصول إلى التسلسل الهرمي  فإنه يوفر أيضًا بعض الطرق الملائمة للوصول إلى مجموعات معينة من معلومات من المستند.
type: docs
weight: 3180
...
تم إهمال الخصائص التالية لصالح المناظرة لـ`هيئة` element. في DOM المستوى 2 ، الطريقة`getElementById` موروث من`وثيقة` الواجهة التي تم نقلها إليها .

راجع أيضًا ملف[نموذج كائن المستند (DOM) المستوى 2 مواصفات HTML](http://www.w3.org/TR/2003/REC-DOM-Level-2-HTML-20030109) .
...
| اسم | وصف |
| --- | --- |
| [HTMLDocument](htmldocument#constructor)() | يقوم بتهيئة مثيل جديد لملف[`HTMLDocument`](../htmldocument) فئة . |
| [HTMLDocument](htmldocument#constructor_1)(Configuration) | يقوم بتهيئة مثيل جديد لملف[`HTMLDocument`](../htmldocument) فئة . |
| [HTMLDocument](htmldocument#constructor_2)(RequestMessage) | يقوم بتهيئة مثيل جديد لملف[`HTMLDocument`](../htmldocument) صف دراسي. يعمل المُنشئ بشكل متزامن ، وينتظر تحميل جميع الموارد الخارجية (الصور ، والنصوص ، وما إلى ذلك) . لتحميل المستند بطريقة غير متزامنة ، استخدم الطريقة[`Navigate`](../../aspose.html.dom/document/navigate) أو overloads. أو يمكنك تعطيل تحميل بعض الموارد الخارجية عن طريق تعيين العلامات المناسبة في[`Security`](../../aspose.html.dom/ibrowsingcontext/security) . |
| [HTMLDocument](htmldocument#constructor_10)(string) | يقوم بتهيئة مثيل جديد لملف[`HTMLDocument`](../htmldocument) صف دراسي. يعمل المُنشئ بشكل متزامن ، وينتظر تحميل جميع الموارد الخارجية (الصور ، والنصوص ، وما إلى ذلك) . لتحميل المستند بطريقة غير متزامنة ، استخدم الطريقة[`Navigate`](../../aspose.html.dom/document/navigate) أو overloads. أو يمكنك تعطيل تحميل بعض الموارد الخارجية عن طريق تعيين العلامات المناسبة في[`Security`](../../aspose.html.dom/ibrowsingcontext/security) . |
| [HTMLDocument](htmldocument#constructor_4)(Url) | يقوم بتهيئة مثيل جديد لملف[`HTMLDocument`](../htmldocument) صف دراسي. يعمل المُنشئ بشكل متزامن ، وينتظر تحميل جميع الموارد الخارجية (الصور ، والنصوص ، وما إلى ذلك) . لتحميل المستند بطريقة غير متزامنة ، استخدم الطريقة[`Navigate`](../../aspose.html.dom/document/navigate) أو overloads. أو يمكنك تعطيل تحميل بعض الموارد الخارجية عن طريق تعيين العلامات المناسبة في[`Security`](../../aspose.html.dom/ibrowsingcontext/security) . |
| [HTMLDocument](htmldocument#constructor_3)(RequestMessage, Configuration) | يقوم بتهيئة مثيل جديد لملف[`HTMLDocument`](../htmldocument) صف دراسي. يعمل المُنشئ بشكل متزامن ، وينتظر تحميل جميع الموارد الخارجية (الصور ، والنصوص ، وما إلى ذلك) . لتحميل المستند بطريقة غير متزامنة ، استخدم الطريقة[`Navigate`](../../aspose.html.dom/document/navigate) أو overloads. أو يمكنك تعطيل تحميل بعض الموارد الخارجية عن طريق تعيين العلامات المناسبة في[`Security`](../../aspose.html.dom/ibrowsingcontext/security) . |
...
| [HTMLDocument](htmldocument#constructor_6)(Stream, Url) | يقوم بتهيئة مثيل جديد لملف[`HTMLDocument`](../htmldocument) صف دراسي. يعمل المُنشئ بشكل متزامن ، وينتظر تحميل جميع الموارد الخارجية (الصور ، والنصوص ، وما إلى ذلك) . لتحميل المستند بطريقة غير متزامنة ، استخدم الطريقة[`Navigate`](../../aspose.html.dom/document/navigate) أو overloads. أو يمكنك تعطيل تحميل بعض الموارد الخارجية عن طريق تعيين العلامات المناسبة في[`Security`](../../aspose.html.dom/ibrowsingcontext/security) . يبدأ تحميل المستند من الموضع الحالي في الدفق. |
| [HTMLDocument](htmldocument#constructor_11)(string, Configuration) | يقوم بتهيئة مثيل جديد لملف[`HTMLDocument`](../htmldocument) صف دراسي. يعمل المُنشئ بشكل متزامن ، وينتظر تحميل جميع الموارد الخارجية (الصور ، والنصوص ، وما إلى ذلك) . لتحميل المستند بطريقة غير متزامنة ، استخدم الطريقة[`Navigate`](../../aspose.html.dom/document/navigate) أو overloads. أو يمكنك تعطيل تحميل بعض الموارد الخارجية عن طريق تعيين العلامات المناسبة في[`Security`](../../aspose.html.dom/ibrowsingcontext/security) . |
| [HTMLDocument](htmldocument#constructor_14)(string, string) | يقوم بتهيئة مثيل جديد لملف[`HTMLDocument`](../htmldocument) صف دراسي. يعمل المُنشئ بشكل متزامن ، وينتظر تحميل جميع الموارد الخارجية (الصور ، والنصوص ، وما إلى ذلك) . لتحميل المستند بطريقة غير متزامنة ، استخدم الطريقة[`Navigate`](../../aspose.html.dom/document/navigate) أو overloads. أو يمكنك تعطيل تحميل بعض الموارد الخارجية عن طريق تعيين العلامات المناسبة في[`Security`](../../aspose.html.dom/ibrowsingcontext/security) . |
| [HTMLDocument](htmldocument#constructor_12)(string, Url) | يقوم بتهيئة مثيل جديد لملف[`HTMLDocument`](../htmldocument) صف دراسي. يعمل المُنشئ بشكل متزامن ، وينتظر تحميل جميع الموارد الخارجية (الصور ، والنصوص ، وما إلى ذلك) . لتحميل المستند بطريقة غير متزامنة ، استخدم الطريقة[`Navigate`](../../aspose.html.dom/document/navigate) أو overloads. أو يمكنك تعطيل تحميل بعض الموارد الخارجية عن طريق تعيين العلامات المناسبة في[`Security`](../../aspose.html.dom/ibrowsingcontext/security) . |
| [HTMLDocument](htmldocument#constructor_5)(Url, Configuration) | يقوم بتهيئة مثيل جديد لملف[`HTMLDocument`](../htmldocument) صف دراسي. يعمل المُنشئ بشكل متزامن ، وينتظر تحميل جميع الموارد الخارجية (الصور ، والنصوص ، وما إلى ذلك) . لتحميل المستند بطريقة غير متزامنة ، استخدم الطريقة[`Navigate`](../../aspose.html.dom/document/navigate) أو overloads. أو يمكنك تعطيل تحميل بعض الموارد الخارجية عن طريق تعيين العلامات المناسبة في[`Security`](../../aspose.html.dom/ibrowsingcontext/security) . |
| [HTMLDocument](htmldocument#constructor_9)(Stream, string, Configuration) | يقوم بتهيئة مثيل جديد لملف[`HTMLDocument`](../htmldocument) صف دراسي. يعمل المُنشئ بشكل متزامن ، وينتظر تحميل جميع الموارد الخارجية (الصور ، والنصوص ، وما إلى ذلك) . لتحميل المستند بطريقة غير متزامنة ، استخدم الطريقة[`Navigate`](../../aspose.html.dom/document/navigate) أو overloads. أو يمكنك تعطيل تحميل بعض الموارد الخارجية عن طريق تعيين العلامات المناسبة في[`Security`](../../aspose.html.dom/ibrowsingcontext/security) . يبدأ تحميل المستند من الموضع الحالي في الدفق. |
| [HTMLDocument](htmldocument#constructor_7)(Stream, Url, Configuration) | يقوم بتهيئة مثيل جديد لملف[`HTMLDocument`](../htmldocument) صف دراسي. يعمل المُنشئ بشكل متزامن ، وينتظر تحميل جميع الموارد الخارجية (الصور ، والنصوص ، وما إلى ذلك) . لتحميل المستند بطريقة غير متزامنة ، استخدم الطريقة[`Navigate`](../../aspose.html.dom/document/navigate) أو overloads. أو يمكنك تعطيل تحميل بعض الموارد الخارجية عن طريق تعيين العلامات المناسبة في[`Security`](../../aspose.html.dom/ibrowsingcontext/security) . يبدأ تحميل المستند من الموضع الحالي في الدفق. |
| [HTMLDocument](htmldocument#constructor_15)(string, string, Configuration) | يقوم بتهيئة مثيل جديد لملف[`HTMLDocument`](../htmldocument) صف دراسي. يعمل المُنشئ بشكل متزامن ، وينتظر تحميل جميع الموارد الخارجية (الصور ، والنصوص ، وما إلى ذلك) . لتحميل المستند بطريقة غير متزامنة ، استخدم الطريقة[`Navigate`](../../aspose.html.dom/document/navigate) أو overloads. أو يمكنك تعطيل تحميل بعض الموارد الخارجية عن طريق تعيين العلامات المناسبة في[`Security`](../../aspose.html.dom/ibrowsingcontext/security) . |
| [HTMLDocument](htmldocument#constructor_13)(string, Url, Configuration) | يقوم بتهيئة مثيل جديد لملف[`HTMLDocument`](../htmldocument) صف دراسي. يعمل المُنشئ بشكل متزامن ، وينتظر تحميل جميع الموارد الخارجية (الصور ، والنصوص ، وما إلى ذلك) . لتحميل المستند بطريقة غير متزامنة ، استخدم الطريقة[`Navigate`](../../aspose.html.dom/document/navigate) أو overloads. أو يمكنك تعطيل تحميل بعض الموارد الخارجية عن طريق تعيين العلامات المناسبة في[`Security`](../../aspose.html.dom/ibrowsingcontext/security) . |
...
| [Body](../../aspose.html/htmldocument/body) { get; set; } | العنصر الذي يحتوي على محتويات الوثيقة. في المستندات مع`هيئة` المحتويات ، وإرجاع`هيئة` عنصر . في مستندات مجموعة الإطارات ، يؤدي هذا إلى إرجاع الأبعد`مجموعة الإطارات` عنصر. |
...
| [Domain](../../aspose.html/htmldocument/domain) { get; } | اسم المجال للخادم الذي خدم المستند ، أو `لا شيء` إذا كان لا يمكن تحديد الخادم من خلال اسم المجال . |
...
| [Links](../../aspose.html/htmldocument/links) { get; } | مجموعة من الكل`منطقة` العناصر والمرساة ( `أ` ) في مستند بقيمة `href` ينسب. |
...
| [Title](../../aspose.html/htmldocument/title) { get; set; } | عنوان المستند كما هو محدد بواسطة`لقب` عنصر في رأس المستند. |
