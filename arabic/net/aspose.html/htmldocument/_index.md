...
description: Aspose.Html.HTMLDocument فصل. أنمستند HTML هو جذر التسلسل الهرمي لـ HTML ويحمل المحتوى بأكمله. إلى جانب توفير الوصول إلى التسلسل الهرمي  فإنه يوفر أيضًا بعض الطرق الملائمة للوصول إلى مجموعات معينة من معلومات من المستند.
type: docs
weight: 3190
url: /ar/net/aspose.html/htmldocument/
---
## HTMLDocument class

أن`مستند HTML` هو جذر التسلسل الهرمي لـ HTML ويحمل المحتوى بأكمله. إلى جانب توفير الوصول إلى التسلسل الهرمي ، فإنه يوفر أيضًا بعض الطرق الملائمة للوصول إلى مجموعات معينة من معلومات من المستند.

تم إهمال الخصائص التالية لصالح المناظرة لـ`جسم` element. في DOM المستوى 2 ، الطريقة`getElementById` موروث من`وثيقة` الواجهة التي تم نقلها إليها .

انظر أيضا[نموذج كائن المستند (DOM) المستوى 2 مواصفات HTML](http://www.w3.org/TR/2003/REC-DOM-Level-2-HTML-20030109) .
...
| اسم | وصف |
| --- | --- |
| [HTMLDocument](htmldocument/#constructor)() | يقوم بتهيئة مثيل جديد لملف`HTMLDocument` فئة . |
| [HTMLDocument](htmldocument/#constructor_1)(Configuration) | يقوم بتهيئة مثيل جديد لملف`HTMLDocument` فئة . |
| [HTMLDocument](htmldocument/#constructor_2)(RequestMessage) | يقوم بتهيئة مثيل جديد لملف`HTMLDocument` فصل. يعمل المُنشئ بشكل متزامن ، وينتظر تحميل جميع الموارد الخارجية (الصور ، البرامج النصية ، إلخ.) . لتحميل المستند بطريقة غير متزامنة ، استخدم الطريقة[`Navigate`](../../aspose.html.dom/document/navigate/) أو overloads. أو يمكنك تعطيل تحميل بعض الموارد الخارجية عن طريق تعيين العلامات المناسبة في[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_10)(string) | يقوم بتهيئة مثيل جديد لملف`HTMLDocument` فصل. يعمل المُنشئ بشكل متزامن ، وينتظر تحميل جميع الموارد الخارجية (الصور ، البرامج النصية ، إلخ.) . لتحميل المستند بطريقة غير متزامنة ، استخدم الطريقة[`Navigate`](../../aspose.html.dom/document/navigate/) أو overloads. أو يمكنك تعطيل تحميل بعض الموارد الخارجية عن طريق تعيين العلامات المناسبة في[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_4)(Url) | يقوم بتهيئة مثيل جديد لملف`HTMLDocument` فصل. يعمل المُنشئ بشكل متزامن ، وينتظر تحميل جميع الموارد الخارجية (الصور ، البرامج النصية ، إلخ.) . لتحميل المستند بطريقة غير متزامنة ، استخدم الطريقة[`Navigate`](../../aspose.html.dom/document/navigate/) أو overloads. أو يمكنك تعطيل تحميل بعض الموارد الخارجية عن طريق تعيين العلامات المناسبة في[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_3)(RequestMessage, Configuration) | يقوم بتهيئة مثيل جديد لملف`HTMLDocument` فصل. يعمل المُنشئ بشكل متزامن ، وينتظر تحميل جميع الموارد الخارجية (الصور ، البرامج النصية ، إلخ.) . لتحميل المستند بطريقة غير متزامنة ، استخدم الطريقة[`Navigate`](../../aspose.html.dom/document/navigate/) أو overloads. أو يمكنك تعطيل تحميل بعض الموارد الخارجية عن طريق تعيين العلامات المناسبة في[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_8)(Stream, string) | يقوم بتهيئة مثيل جديد لملف`HTMLDocument` فصل. يعمل المُنشئ بشكل متزامن ، وينتظر تحميل جميع الموارد الخارجية (الصور ، البرامج النصية ، إلخ.) . لتحميل المستند بطريقة غير متزامنة ، استخدم الطريقة[`Navigate`](../../aspose.html.dom/document/navigate/) أو overloads. أو يمكنك تعطيل تحميل بعض الموارد الخارجية عن طريق تعيين العلامات المناسبة في[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . يبدأ تحميل المستند من الموضع الحالي في الدفق. |
| [HTMLDocument](htmldocument/#constructor_6)(Stream, Url) | يقوم بتهيئة مثيل جديد لملف`HTMLDocument` فصل. يعمل المُنشئ بشكل متزامن ، وينتظر تحميل جميع الموارد الخارجية (الصور ، البرامج النصية ، إلخ.) . لتحميل المستند بطريقة غير متزامنة ، استخدم الطريقة[`Navigate`](../../aspose.html.dom/document/navigate/) أو overloads. أو يمكنك تعطيل تحميل بعض الموارد الخارجية عن طريق تعيين العلامات المناسبة في[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . يبدأ تحميل المستند من الموضع الحالي في الدفق. |
| [HTMLDocument](htmldocument/#constructor_11)(string, Configuration) | يقوم بتهيئة مثيل جديد لملف`HTMLDocument` فصل. يعمل المُنشئ بشكل متزامن ، وينتظر تحميل جميع الموارد الخارجية (الصور ، البرامج النصية ، إلخ.) . لتحميل المستند بطريقة غير متزامنة ، استخدم الطريقة[`Navigate`](../../aspose.html.dom/document/navigate/) أو overloads. أو يمكنك تعطيل تحميل بعض الموارد الخارجية عن طريق تعيين العلامات المناسبة في[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_14)(string, string) | يقوم بتهيئة مثيل جديد لملف`HTMLDocument` فصل. يعمل المُنشئ بشكل متزامن ، وينتظر تحميل جميع الموارد الخارجية (الصور ، البرامج النصية ، إلخ.) . لتحميل المستند بطريقة غير متزامنة ، استخدم الطريقة[`Navigate`](../../aspose.html.dom/document/navigate/) أو overloads. أو يمكنك تعطيل تحميل بعض الموارد الخارجية عن طريق تعيين العلامات المناسبة في[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_12)(string, Url) | يقوم بتهيئة مثيل جديد لملف`HTMLDocument` فصل. يعمل المُنشئ بشكل متزامن ، وينتظر تحميل جميع الموارد الخارجية (الصور ، البرامج النصية ، إلخ.) . لتحميل المستند بطريقة غير متزامنة ، استخدم الطريقة[`Navigate`](../../aspose.html.dom/document/navigate/) أو overloads. أو يمكنك تعطيل تحميل بعض الموارد الخارجية عن طريق تعيين العلامات المناسبة في[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_5)(Url, Configuration) | يقوم بتهيئة مثيل جديد لملف`HTMLDocument` فصل. يعمل المُنشئ بشكل متزامن ، وينتظر تحميل جميع الموارد الخارجية (الصور ، البرامج النصية ، إلخ.) . لتحميل المستند بطريقة غير متزامنة ، استخدم الطريقة[`Navigate`](../../aspose.html.dom/document/navigate/) أو overloads. أو يمكنك تعطيل تحميل بعض الموارد الخارجية عن طريق تعيين العلامات المناسبة في[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_9)(Stream, string, Configuration) | يقوم بتهيئة مثيل جديد لملف`HTMLDocument` فصل. يعمل المُنشئ بشكل متزامن ، وينتظر تحميل جميع الموارد الخارجية (الصور ، البرامج النصية ، إلخ.) . لتحميل المستند بطريقة غير متزامنة ، استخدم الطريقة[`Navigate`](../../aspose.html.dom/document/navigate/) أو overloads. أو يمكنك تعطيل تحميل بعض الموارد الخارجية عن طريق تعيين العلامات المناسبة في[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . يبدأ تحميل المستند من الموضع الحالي في الدفق. |
| [HTMLDocument](htmldocument/#constructor_7)(Stream, Url, Configuration) | يقوم بتهيئة مثيل جديد لملف`HTMLDocument` فصل. يعمل المُنشئ بشكل متزامن ، وينتظر تحميل جميع الموارد الخارجية (الصور ، البرامج النصية ، إلخ.) . لتحميل المستند بطريقة غير متزامنة ، استخدم الطريقة[`Navigate`](../../aspose.html.dom/document/navigate/) أو overloads. أو يمكنك تعطيل تحميل بعض الموارد الخارجية عن طريق تعيين العلامات المناسبة في[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . يبدأ تحميل المستند من الموضع الحالي في الدفق. |
| [HTMLDocument](htmldocument/#constructor_15)(string, string, Configuration) | يقوم بتهيئة مثيل جديد لملف`HTMLDocument` فصل. يعمل المُنشئ بشكل متزامن ، وينتظر تحميل جميع الموارد الخارجية (الصور ، البرامج النصية ، إلخ.) . لتحميل المستند بطريقة غير متزامنة ، استخدم الطريقة[`Navigate`](../../aspose.html.dom/document/navigate/) أو overloads. أو يمكنك تعطيل تحميل بعض الموارد الخارجية عن طريق تعيين العلامات المناسبة في[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_13)(string, Url, Configuration) | يقوم بتهيئة مثيل جديد لملف`HTMLDocument` فصل. يعمل المُنشئ بشكل متزامن ، وينتظر تحميل جميع الموارد الخارجية (الصور ، البرامج النصية ، إلخ.) . لتحميل المستند بطريقة غير متزامنة ، استخدم الطريقة[`Navigate`](../../aspose.html.dom/document/navigate/) أو overloads. أو يمكنك تعطيل تحميل بعض الموارد الخارجية عن طريق تعيين العلامات المناسبة في[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |

## الخصائص

| اسم | وصف |
| --- | --- |
| [Anchors](../../aspose.html/htmldocument/anchors/) { get; } | مجموعة من كل المرساة (`أ` ) في مستند بقيمة لـ`اسم`يصف. لأسباب تتعلق بالتوافق مع الإصدارات السابقة من ، فإن مجموعة الارتساء التي تم إرجاعها تحتوي فقط على تلك الارتساءات التي تم إنشاؤها باستخدام`اسم` السمة ، وليس تلك التي تم إنشاؤها باستخدام ملف`بطاقة تعريف` يصف. لاحظ أنه في [[XHTML 1.0.0 تحديث](http://www.w3.org/TR/2002/REC-xhtml1-20020801) ] ، `اسم` السمة (انظر القسم 4.10) لا تحتوي على دلالات و موجودة فقط لوكلاء المستخدم القدامى:`بطاقة تعريف` السمة بدلاً من ذلك. يجب على المستخدمين تفضيل آليات المكرر المقدمة بواسطة [[اجتياز DOM من المستوى 2](http://www.w3.org/TR/2000/REC-DOM-Level-2-Traversal-Range-20001113) ] بدلاً من. |
| [Applets](../../aspose.html/htmldocument/applets/) { get; } | مجموعة من جميع ملفات`هدف` العناصر التي تتضمن تطبيقات و`APPLET` (مهملة) في المستند. |
...
| [Body](../../aspose.html/htmldocument/body/) { get; set; } | العنصر الذي يحتوي على محتويات الوثيقة. في المستندات مع`جسم` المحتويات ، وإرجاع`جسم` عنصر . في مستندات مجموعة الإطارات ، يؤدي هذا إلى إرجاع الأبعد`مجموعة الإطارات` عنصر. |
...
| [ChildElementCount](../../aspose.html.dom/document/childelementcount/) { get; } | إرجاع العدد الحالي لعقد العناصر التي هي عناصر فرعية لهذا العنصر. 0 إذا كان هذا العنصر لا يحتوي على عقد فرعية من نوع العقدة 1. |
...
| [Domain](../../aspose.html/htmldocument/domain/) { get; } | اسم المجال للخادم الذي خدم المستند ، أو `باطل` إذا كان لا يمكن تحديد الخادم من خلال اسم المجال . |
...
| [Forms](../../aspose.html/htmldocument/forms/) { get; } | مجموعة من كافة أشكال المستند. |
| [Images](../../aspose.html/htmldocument/images/) { get; } | مجموعة من جميع ملفات`IMG` العناصر الموجودة في المستند. السلوك يقتصر على`IMG` عناصر للتوافق مع الإصدارات السابقة . على النحو الذي اقترحه [[أتش تي أم أل 4.01](http://www.w3.org/TR/1999/REC-html401-19991224) ، لتضمين الصور ، قد يستخدم المؤلفون ملف`هدف` عنصر أو`IMG` عنصر. لذلك ، يوصى بعدم استخدام هذه السمة للعثور على صور في المستند ولكن`getElementsByTagName` مع HTML 4.01 أو`getElementsByTagNameNS` مع XHTML 1.0. |
...
| [Links](../../aspose.html/htmldocument/links/) { get; } | مجموعة من الكل`منطقة` العناصر والمرساة ( `أ` ) في مستند بقيمة `href` يصف. |
...
| [NextElementSibling](../../aspose.html.dom/document/nextelementsibling/) { get; } | إرجاع عقدة العنصر الشقيقة التالية لهذا العنصر. خالية إذا كان هذا العنصر لا يحتوي على عقد شقيقة لعنصر تأتي بعد هذا في شجرة المستند. |
...
| virtual [Prefix](../../aspose.html.dom/node/prefix/) { get; set; } | بادئة مساحة الاسم لهذه العقدة ، أو فارغة إذا كانت غير محددة. عندما يتم تعريفه على أنه فارغ ، فإن الإعداد ليس له تأثير |
...
| [Referrer](../../aspose.html/htmldocument/referrer/) { get; } | إرجاع URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) من الصفحة المرتبطة بهذه الصفحة. القيمة عبارة عن سلسلة فارغة إذا انتقل المستخدم إلى الصفحة مباشرةً (ليس من خلال رابط ، ولكن ، على سبيل المثال ، عبر إشارة مرجعية). |
...
| [StyleSheets](../../aspose.html.dom/document/stylesheets/) { get; } | قائمة تحتوي على كافة أوراق الأنماط المرتبطة أو المضمنة في مستند بشكل صريح. بالنسبة لمستندات HTML ، يتضمن ذلك أوراق الأنماط الخارجية ، المضمنة عبر عنصر HTML LINK ، وعناصر النمط المضمنة. |
...
| [Title](../../aspose.html/htmldocument/title/) { get; set; } | عنوان المستند كما هو محدد بواسطة`عنوان` عنصر في رأس المستند. |
...
| [CreateEntityReference](../../aspose.html.dom/document/createentityreference/)(string) | إنشاء كائن EntityReference. بالإضافة إلى ذلك ، إذا كان الكيان المُشار إليه معروفًا ، فستكون القائمة الفرعية لعقدة EntityReference مماثلة لقائمة عقدة الكيان المقابلة. |
...
| [CreateTextNode](../../aspose.html.dom/document/createtextnode/)(string) | يقوم بإنشاء عقدة نصية بالسلسلة المحددة . |
...
| [GetElementsByTagName](../../aspose.html.dom/document/getelementsbytagname/)(string) | إرجاع قائمة NodeList لجميع العناصر بترتيب المستند مع اسم علامة محدد ومضمنة في المستند. |
...
| [GetOverrideStyle](../../aspose.html/htmldocument/getoverridestyle/)(Element, string) | تُستخدم هذه الطريقة لاسترداد إعلان نمط التجاوز لعنصر محدد وعنصر زائف محدد. |
...
| [Navigate](../../aspose.html.dom/document/navigate/)(RequestMessage) | يتم تحميل المستند بناءً على كائن الطلب المحدد ، مع استبدال المحتوى السابق. |
...
| override [RenderTo](../../aspose.html/htmldocument/renderto/)(IDevice) | تُستخدم هذه الطريقة لطباعة محتويات المستند الحالي على الجهاز المحدد. |
...
| [Save](../../aspose.html/htmldocument/save/#save)(IOutputStorage) | يحفظ محتوى الوثيقة والموارد في تخزين المخرجات. |
| [Save](../../aspose.html/htmldocument/save/#save_10)(string) | يحفظ المستند في الملف المحلي المحدد بواسطة`طريق` سيتم حفظ جميع الموارد المستخدمة في هذا المستند في إلى المجلد المجاور ، والذي سيتم إنشاء اسمه على النحو التالي: output_file_name + "_files" . |
| [Save](../../aspose.html/htmldocument/save/#save_5)(Url) | يحفظ المستند في الملف المحلي المحدد بواسطة`عنوان url` سيتم حفظ جميع الموارد المستخدمة في هذا المستند في إلى المجلد المجاور ، والذي سيتم إنشاء اسمه على النحو التالي: output_file_name + "_files" . |
| [Save](../../aspose.html/htmldocument/save/#save_1)(IOutputStorage, HTMLSaveFormat) | يحفظ محتوى الوثيقة والموارد في تخزين المخرجات. |
| [Save](../../aspose.html/htmldocument/save/#save_2)(IOutputStorage, HTMLSaveOptions) | يحفظ محتوى الوثيقة والموارد في تخزين المخرجات. |
| [Save](../../aspose.html/htmldocument/save/#save_3)(IOutputStorage, MarkdownSaveOptions) | يحفظ محتوى الوثيقة والموارد في تخزين المخرجات. |
| [Save](../../aspose.html/htmldocument/save/#save_4)(IOutputStorage, MHTMLSaveOptions) | يحفظ محتوى الوثيقة والموارد في تخزين المخرجات. |
| [Save](../../aspose.html/htmldocument/save/#save_11)(string, HTMLSaveFormat) | يحفظ المستند في الملف المحلي المحدد بواسطة`طريق` سيتم حفظ جميع الموارد المستخدمة في هذا المستند في إلى المجلد المجاور ، والذي سيتم إنشاء اسمه على النحو التالي: output_file_name + "_files" . |
| [Save](../../aspose.html/htmldocument/save/#save_12)(string, HTMLSaveOptions) | يحفظ المستند في الملف المحلي المحدد بواسطة`طريق` سيتم حفظ جميع الموارد المستخدمة في هذا المستند في إلى المجلد المجاور ، والذي سيتم إنشاء اسمه على النحو التالي: output_file_name + "_files" . |
| [Save](../../aspose.html/htmldocument/save/#save_13)(string, MarkdownSaveOptions) | يحفظ المستند في الملف المحلي المحدد بواسطة`طريق` سيتم حفظ جميع الموارد المستخدمة في هذا المستند في إلى المجلد المجاور ، والذي سيتم إنشاء اسمه على النحو التالي: output_file_name + "_files" . |
| [Save](../../aspose.html/htmldocument/save/#save_14)(string, MHTMLSaveOptions) | يحفظ المستند في الملف المحلي المحدد بواسطة`طريق` سيتم حفظ جميع الموارد المستخدمة في هذا المستند في إلى المجلد المجاور ، والذي سيتم إنشاء اسمه على النحو التالي: output_file_name + "_files" . |
| [Save](../../aspose.html/htmldocument/save/#save_6)(Url, HTMLSaveFormat) | يحفظ المستند في الملف المحلي المحدد بواسطة`عنوان url` سيتم حفظ جميع الموارد المستخدمة في هذا المستند في إلى المجلد المجاور ، والذي سيتم إنشاء اسمه على النحو التالي: output_file_name + "_files" . |
| [Save](../../aspose.html/htmldocument/save/#save_7)(Url, HTMLSaveOptions) | يحفظ المستند في الملف المحلي المحدد بواسطة`عنوان url` سيتم حفظ جميع الموارد المستخدمة في هذا المستند في إلى المجلد المجاور ، والذي سيتم إنشاء اسمه على النحو التالي: output_file_name + "_files" . |
| [Save](../../aspose.html/htmldocument/save/#save_8)(Url, MarkdownSaveOptions) | يحفظ المستند في الملف المحلي المحدد بواسطة`عنوان url` سيتم حفظ جميع الموارد المستخدمة في هذا المستند في إلى المجلد المجاور ، والذي سيتم إنشاء اسمه على النحو التالي: output_file_name + "_files" . |
| [Save](../../aspose.html/htmldocument/save/#save_9)(Url, MHTMLSaveOptions) | يحفظ المستند في الملف المحلي المحدد بواسطة`عنوان url` سيتم حفظ جميع الموارد المستخدمة في هذا المستند في إلى المجلد المجاور ، والذي سيتم إنشاء اسمه على النحو التالي: output_file_name + "_files" . |
| override [ToString](../../aspose.html.dom/node/tostring/)() | إرجاع أString الذي يمثل هذا المثال. |
| [Write](../../aspose.html.dom/document/write/)(params string[]) | اكتب سلسلة نصية إلى تدفق مستند تم فتحه بواسطة open (). لاحظ أن الوظيفة ستنتج document الذي لا يكون بالضرورة مدفوعًا بـ DTD وبالتالي قد ينتج عن ذلك نتيجة غير صالحة في سياق المستند. |
| [WriteLn](../../aspose.html.dom/document/writeln/)(params string[]) | اكتب سلسلة نصية متبوعة بحرف سطر جديد إلى دفق document مفتوح بواسطة open (). لاحظ أن الوظيفة will تنتج مستندًا ليس بالضرورة مدفوعًا بـ DTD و لذلك قد ينتج نتيجة غير صالحة في سياق document |

## الأحداث

| اسم | وصف |
| --- | --- |
| event [OnAbort](../../aspose.html.dom/document/onabort/) | الحصول على معالج الحدث أو تعيينه لحدث OnAbort. |
| event [OnBlur](../../aspose.html.dom/document/onblur/) | الحصول على معالج الحدث أو تعيينه لحدث OnBlur. |
| event [OnCancel](../../aspose.html.dom/document/oncancel/) | الحصول على أو تعيين معالج الأحداث لحدث OnCancel. |
| event [OnCanplay](../../aspose.html.dom/document/oncanplay/) | الحصول على معالج الحدث أو تعيينه لحدث OnCanplay. |
| event [OnCanPlayThrough](../../aspose.html.dom/document/oncanplaythrough/) | الحصول على معالج الحدث أو تعيينه لحدث OnCanPlayThrough. |
| event [OnChange](../../aspose.html.dom/document/onchange/) | الحصول على معالج الحدث لحدث OnChange أو تعيينه. |
| event [OnClick](../../aspose.html.dom/document/onclick/) | الحصول على معالج الحدث لحدث OnClick أو تعيينه. |
| event [OnCueChange](../../aspose.html.dom/document/oncuechange/) | الحصول على معالج الحدث أو تعيينه لحدث OnCueChange. |
| event [OnDblClick](../../aspose.html.dom/document/ondblclick/) | الحصول على أو تعيين معالج الأحداث لحدث OnDblClick. |
| event [OnDurationChange](../../aspose.html.dom/document/ondurationchange/) | الحصول على معالج الحدث لحدث OnDurationChange أو تعيينه. |
| event [OnEmptied](../../aspose.html.dom/document/onemptied/) | الحصول على أو تعيين معالج الأحداث لحدث OnEmptied. |
| event [OnEnded](../../aspose.html.dom/document/onended/) | الحصول على معالج الأحداث أو تعيينه لحدث OnEnded. |
| event [OnError](../../aspose.html.dom/document/onerror/) | الحصول على معالج الحدث لحدث OnError أو تعيينه. |
| event [OnFocus](../../aspose.html.dom/document/onfocus/) | الحصول على أو تعيين معالج الأحداث لحدث OnFocus. |
| event [OnInput](../../aspose.html.dom/document/oninput/) | الحصول على أو تعيين معالج الأحداث لحدث OnInput. |
| event [OnInvalid](../../aspose.html.dom/document/oninvalid/) | الحصول على معالج الحدث أو تعيينه لحدث OnInvalid . |
| event [OnKeyDown](../../aspose.html.dom/document/onkeydown/) | الحصول على معالج الحدث أو تعيينه لحدث OnKeyDown. |
| event [OnKeyPress](../../aspose.html.dom/document/onkeypress/) | الحصول على معالج الحدث أو تعيينه لحدث OnKeyPress. |
| event [OnKeyUp](../../aspose.html.dom/document/onkeyup/) | الحصول على معالج الحدث أو تعيينه لحدث OnKeyUp. |
| event [OnLoad](../../aspose.html.dom/document/onload/) | الحصول على معالج الحدث أو تعيينه لحدث OnLoad. |
| event [OnLoadedData](../../aspose.html.dom/document/onloadeddata/) | الحصول على معالج الحدث أو تعيينه لحدث OnLoadedData. |
| event [OnLoadedMetadata](../../aspose.html.dom/document/onloadedmetadata/) | الحصول على معالج الحدث لحدث OnLoadedMetadata أو تعيينه. |
| event [OnLoadStart](../../aspose.html.dom/document/onloadstart/) | الحصول على أو تعيين معالج الأحداث لحدث OnLoadStart. |
| event [OnMouseDown](../../aspose.html.dom/document/onmousedown/) | الحصول على معالج الحدث أو تعيينه لحدث OnMouseDown. |
| event [OnMouseEnter](../../aspose.html.dom/document/onmouseenter/) | الحصول على معالج الحدث أو تعيينه لحدث OnMouseEnter. |
| event [OnMouseLeave](../../aspose.html.dom/document/onmouseleave/) | الحصول على معالج الأحداث أو تعيينه لحدث OnMouseLeave. |
| event [OnMouseMove](../../aspose.html.dom/document/onmousemove/) | الحصول على معالج الحدث أو تعيينه لحدث OnMouseMove. |
| event [OnMouseOut](../../aspose.html.dom/document/onmouseout/) | الحصول على معالج الحدث أو تعيينه لحدث OnMouseOut. |
| event [OnMouseOver](../../aspose.html.dom/document/onmouseover/) | الحصول على معالج الحدث أو تعيينه لحدث OnMouseOver. |
| event [OnMouseUp](../../aspose.html.dom/document/onmouseup/) | الحصول على معالج الحدث أو تعيينه لحدث OnMouseUp. |
| event [OnMouseWheel](../../aspose.html.dom/document/onmousewheel/) | الحصول على معالج الحدث أو تعيينه لحدث OnMouseWheel. |
| event [OnPause](../../aspose.html.dom/document/onpause/) | الحصول على معالج الحدث أو تعيينه لحدث OnPause. |
| event [OnPlay](../../aspose.html.dom/document/onplay/) | الحصول على معالج الحدث أو تعيينه لحدث OnPlay. |
| event [OnPlaying](../../aspose.html.dom/document/onplaying/) | الحصول على معالج الحدث أو تعيينه لحدث OnPlaying. |
| event [OnProgress](../../aspose.html.dom/document/onprogress/) | الحصول على معالج الحدث أو تعيينه لحدث OnProgress . |
| event [OnRateChange](../../aspose.html.dom/document/onratechange/) | الحصول على معالج الحدث لحدث OnRateChange أو تعيينه. |
| event [OnReadyStateChange](../../aspose.html.dom/document/onreadystatechange/) | الحصول على أو تعيين معالج الأحداث لحدث OnReadyStateChange. |
| event [OnReset](../../aspose.html.dom/document/onreset/) | الحصول على معالج الحدث لحدث OnReset أو تعيينه. |
| event [OnResize](../../aspose.html.dom/document/onresize/) | الحصول على معالج الحدث لحدث OnResize أو تعيينه. |
| event [OnScroll](../../aspose.html.dom/document/onscroll/) | الحصول على أو تعيين معالج الأحداث لحدث OnScroll. |
| event [OnSeeked](../../aspose.html.dom/document/onseeked/) | الحصول على معالج الحدث لحدث OnSeeked أو تعيينه. |
| event [OnSeeking](../../aspose.html.dom/document/onseeking/) | الحصول على معالج الحدث لحدث OnSeeking أو تعيينه. |
| event [OnSelect](../../aspose.html.dom/document/onselect/) | الحصول على معالج الحدث لحدث OnSelect أو تعيينه. |
| event [OnShow](../../aspose.html.dom/document/onshow/) | الحصول على معالج الحدث لحدث OnShow أو تعيينه. |
| event [OnStalled](../../aspose.html.dom/document/onstalled/) | الحصول على معالج الحدث للحدث OnStalled أو تعيينه. |
| event [OnSubmit](../../aspose.html.dom/document/onsubmit/) | الحصول على معالج الحدث أو تعيينه لحدث OnSubmit. |
| event [OnSuspend](../../aspose.html.dom/document/onsuspend/) | الحصول على معالج الحدث أو تعيينه لحدث OnSuspend. |
| event [OnTimeUpdate](../../aspose.html.dom/document/ontimeupdate/) | الحصول على أو تعيين معالج الأحداث لحدث OnTimeUpdate. |
| event [OnToggle](../../aspose.html.dom/document/ontoggle/) | الحصول على أو تعيين معالج الأحداث لحدث OnToggle. |
| event [OnVolumeChange](../../aspose.html.dom/document/onvolumechange/) | الحصول على معالج الحدث لحدث OnVolumeChange أو تعيينه. |
| event [OnWaiting](../../aspose.html.dom/document/onwaiting/) | الحصول على معالج الحدث للحدث OnWaiting أو تعيينه. |
