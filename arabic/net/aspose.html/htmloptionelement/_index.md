...
description: اختيار قابل للتحديد. راجع تعريف عنصر OPTION في HTML 4.01.
type: docs
weight: 3450
...
| [Form](../../aspose.html/htmloptionelement/form) { get; } | إرجاع ملف`شكل` عنصر يحتوي على عنصر التحكم هذا. إرجاع `لا شيء` إذا لم يكن عنصر التحكم هذا ضمن سياق نموذج . |
| [Id](../../aspose.html/htmlelement/id) { get; set; } | معرف العنصر. راجع تعريف سمة المعرف في HTML 4.01. |
| [Index](../../aspose.html/htmloptionelement/index) { get; } | فهرس هذا`اختيار` في والدها`تحديد` ، بدءًا من 0. @ إصدار DOM المستوى 2 |
