...
description: Aspose.Html.HTMLOptionElement فصل. اختيار قابل للتحديد. راجع تعريف عنصر OPTION في HTML 4.01.
type: docs
weight: 3460
url: /ar/net/aspose.html/htmloptionelement/
---
## HTMLOptionElement class

اختيار قابل للتحديد. راجع تعريف عنصر OPTION في HTML 4.01.
...
| [DefaultSelected](../../aspose.html/htmloptionelement/defaultselected/) { get; set; } | يمثل قيمة سمة HTML المحددة. لا تتغير قيمة هذه السمة إذا تغيرت حالة التحكم في النموذج المقابل ، في وكيل مستخدم تفاعلي. راجع تعريف السمة المحدد في HTML 4.01. @ الإصدار DOM المستوى 2 |
...
| [Disabled](../../aspose.html/htmloptionelement/disabled/) { get; set; } | عنصر التحكم غير متوفر في هذا السياق. راجع تعريف السمة المعطلة في HTML 4.01. |
...
| [Form](../../aspose.html/htmloptionelement/form/) { get; } | إرجاع ملف`استمارة` عنصر يحتوي على عنصر التحكم هذا. إرجاع `باطل` إذا لم يكن عنصر التحكم هذا ضمن سياق نموذج . |
| [Id](../../aspose.html/htmlelement/id/) { get; set; } | معرف العنصر. راجع تعريف سمة المعرف في HTML 4.01. |
| [Index](../../aspose.html/htmloptionelement/index/) { get; } | فهرس هذا`خيار` في والدها`يختار` ، بدءًا من 0. @ إصدار DOM المستوى 2 |
...
| [Label](../../aspose.html/htmloptionelement/label/) { get; set; } | تسمية الخيار للاستخدام في القوائم الهرمية. راجع تعريف سمة التسمية في HTML 4.01. |
...
| [Selected](../../aspose.html/htmloptionelement/selected/) { get; set; } | يمثل الحالة الحالية لعنصر تحكم النموذج المقابل ، في وكيل مستخدم تفاعلي . يؤدي تغيير هذه السمة إلى تغيير حالة عنصر تحكم النموذج ، ولكنه لا يغير قيمة سمة المحددة في HTML للعنصر. |
...
| [Text](../../aspose.html/htmloptionelement/text/) { get; } | النص الموجود داخل عنصر الخيار. |
...
| [Value](../../aspose.html/htmloptionelement/value/) { get; set; } | قيمة عنصر التحكم في النموذج الحالي. راجع تعريف سمة القيمة في HTML 4.01. |
