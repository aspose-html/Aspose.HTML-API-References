...
description: Aspose.Html.HTMLDirectoryElement فصل. قائمة الدليل. راجع تعريف عنصر DIR في HTML 4.01. تم إهمال هذا العنصر في HTML 4.01.
type: docs
weight: 3170
url: /ar/net/aspose.html/htmldirectoryelement/
---
## HTMLDirectoryElement class

قائمة الدليل. راجع تعريف عنصر DIR في HTML 4.01. تم إهمال هذا العنصر في HTML 4.01.
...
| [Compact](../../aspose.html/htmldirectoryelement/compact/) { get; set; } | تقليل التباعد بين عناصر القائمة. راجع تعريف السمة المدمجة في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
