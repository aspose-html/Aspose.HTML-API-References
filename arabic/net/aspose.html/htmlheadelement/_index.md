...
description: Aspose.Html.HTMLHeadElement فصل. معلومات رأس المستند. راجع تعريف عنصر HEAD في HTML 4.01.
type: docs
weight: 3270
url: /ar/net/aspose.html/htmlheadelement/
---
## HTMLHeadElement class

معلومات رأس المستند. راجع تعريف عنصر HEAD في HTML 4.01.
...
| [Profile](../../aspose.html/htmlheadelement/profile/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] تعيين ملف تعريف البيانات الوصفية. راجع تعريف سمة ملف التعريف في HTML 4.01. |
