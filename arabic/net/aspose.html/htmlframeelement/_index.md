...
description: Aspose.Html.HTMLFrameElement فصل. قم بإنشاء إطار. راجع تعريف عنصر الإطار في HTML 4.01.
type: docs
weight: 3240
url: /ar/net/aspose.html/htmlframeelement/
---
## HTMLFrameElement class

قم بإنشاء إطار. راجع تعريف عنصر الإطار في HTML 4.01.
...
| [ContentDocument](../../aspose.html/htmlframeelement/contentdocument/) { get; } | المستند الذي يحتوي عليه هذا الإطار ، إذا كان موجودًا ومتاحًا ، أو`باطل` على خلاف ذلك. @ منذ DOM المستوى 2 |
...
| [FrameBorder](../../aspose.html/htmlframeelement/frameborder/) { get; set; } | طلب حدود الإطار. راجع تعريف سمة إطار العمل في HTML 4.01. |
...
| [LongDesc](../../aspose.html/htmlframeelement/longdesc/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] تعيين وصف طويل لهذه الصورة أو الإطار. راجع تعريف السمة longdesc في HTML 4.01. |
| [MarginHeight](../../aspose.html/htmlframeelement/marginheight/) { get; set; } | ارتفاع هامش الإطار بالبكسل. راجع تعريف السمة marginheight في HTML 4.01. |
| [MarginWidth](../../aspose.html/htmlframeelement/marginwidth/) { get; set; } | عرض هامش الإطار بالبكسل. راجع تعريف سمة عرض الهامش في HTML 4.01. |
| [Name](../../aspose.html/htmlframeelement/name/) { get; set; } | اسم الإطار (كائن من`هدف` يصف). راجع تعريف سمة الاسم في HTML 4.01. |
...
| [NoResize](../../aspose.html/htmlframeelement/noresize/) { get; set; } | عندما يكون هذا صحيحًا ، امنع المستخدم من تغيير حجم الإطار. راجع تعريف السمة noresize في HTML 4.01. |
...
| [Scrolling](../../aspose.html/htmlframeelement/scrolling/) { get; set; } | حدد ما إذا كان يجب أن يحتوي الإطار على أشرطة تمرير أم لا. راجع تعريف سمة التمرير في HTML 4.01. |
| [ShadowRoot](../../aspose.html.dom/element/shadowroot/) { get; } | تُرجع shadowRoot المخزنة في هذا العنصر أو تُرجع فارغة إذا كان مغلقًا. |
| [Src](../../aspose.html/htmlframeelement/src/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] تعيين محتويات الإطار الأولي. راجع تعريف السمة src في HTML 4.01. |
