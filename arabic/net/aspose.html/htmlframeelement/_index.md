...
description: قم بإنشاء إطار. راجع تعريف عنصر الإطار في HTML 4.01.
type: docs
weight: 3230
...
| [ContentDocument](../../aspose.html/htmlframeelement/contentdocument) { get; } | المستند الذي يحتوي عليه هذا الإطار ، إذا كان موجودًا ومتاحًا ، أو`لا شيء` على خلاف ذلك. @ منذ DOM المستوى 2 |
...
| [Name](../../aspose.html/htmlframeelement/name) { get; set; } | اسم الإطار (كائن من`استهداف` ينسب). راجع تعريف سمة الاسم في HTML 4.01. |
...
| [Src](../../aspose.html/htmlframeelement/src) { get; set; } | عنوان URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] تعيين محتويات الإطار الأولي. راجع تعريف السمة src في HTML 4.01. |
