...
description: تجميع الخيارات معًا في تقسيمات منطقية. راجع تعريف عنصر OPTGROUP في HTML 4.01.
type: docs
weight: 3440
...
| [Label](../../aspose.html/htmloptgroupelement/label) { get; set; } | يقوم بتعيين تسمية لمجموعة الخيارات هذه. راجع تعريف سمة التسمية في HTML 4.01. |
