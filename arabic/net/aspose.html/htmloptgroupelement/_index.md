...
description: Aspose.Html.HTMLOptGroupElement فصل. تجميع الخيارات معًا في تقسيمات منطقية. راجع تعريف عنصر OPTGROUP في HTML 4.01.
type: docs
weight: 3450
url: /ar/net/aspose.html/htmloptgroupelement/
---
## HTMLOptGroupElement class

تجميع الخيارات معًا في تقسيمات منطقية. راجع تعريف عنصر OPTGROUP في HTML 4.01.
...
| [Disabled](../../aspose.html/htmloptgroupelement/disabled/) { get; set; } | عنصر التحكم غير متوفر في هذا السياق. راجع تعريف السمة المعطلة في HTML 4.01. |
...
| [Label](../../aspose.html/htmloptgroupelement/label/) { get; set; } | يقوم بتعيين تسمية لمجموعة الخيارات هذه. انظر تعريف سمة التسمية في HTML 4.01. |
