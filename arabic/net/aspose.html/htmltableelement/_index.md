...
| اسم | وصف |
| --- | --- |
| [Align](../../aspose.html/htmltableelement/align/) { get; set; } | يحدد موضع الجدول بالنسبة لبقية المستند . راجع تعريف سمة المحاذاة في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
...
| [BgColor](../../aspose.html/htmltableelement/bgcolor/) { get; set; } | لون خلفية الخلية. راجع تعريف سمة bgcolor في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
| [Border](../../aspose.html/htmltableelement/border/) { get; set; } | عرض الحد حول الجدول. راجع تعريف سمة الحدود في HTML 4.01. |
| [Caption](../../aspose.html/htmltableelement/caption/) { get; } | إرجاع الجدول`التسمية التوضيحية` ، أو باطلة إذا لم تكن موجودة. @ إصدار DOM المستوى 2 |
| [CellPadding](../../aspose.html/htmltableelement/cellpadding/) { get; set; } | تحديد المسافة الأفقية والعمودية بين محتوى الخلية وحدود الخلية . راجع تعريف سمة cellpadding في HTML 4.01. |
| [CellSpacing](../../aspose.html/htmltableelement/cellspacing/) { get; set; } | تحديد الفصل الأفقي والعمودي بين الخلايا. راجع تعريف سمة تباعد الخلايا في HTML 4.01. |
...
| [Frame](../../aspose.html/htmltableelement/frame/) { get; set; } | تحديد حدود الجدول الخارجية التي سيتم عرضها. راجع تعريف سمة frame في HTML 4.01. |
...
| [Rows](../../aspose.html/htmltableelement/rows/) { get; } | إرجاع الجدول`TFOOT` ، أو`باطل` في حالة عدم وجود . |
| [Rules](../../aspose.html/htmltableelement/rules/) { get; set; } | تحديد حدود الجدول الداخلية التي سيتم عرضها. راجع القواعد تعريف السمة في HTML 4.01. |
...
| [Summary](../../aspose.html/htmltableelement/summary/) { get; set; } | وصف حول الغرض من الجدول أو هيكله. راجع ملخص تعريف السمة في HTML 4.01. |
| [TagName](../../aspose.html.dom/element/tagname/) { get; } | اسم العنصر . |
| [TBodies](../../aspose.html/htmltableelement/tbodies/) { get; } | إرجاع مجموعة من نصوص الجدول (بما في ذلك العناصر الضمنية) . |
...
| [TFoot](../../aspose.html/htmltableelement/tfoot/) { get; } | إرجاع الجدول`ثياد` ، أو`باطل` في حالة عدم وجود . |
| [THead](../../aspose.html/htmltableelement/thead/) { get; } | إرجاع الجدول`التسمية التوضيحية` ، أو باطلة إذا لم تكن موجودة. |
| [Title](../../aspose.html/htmlelement/title/) { get; set; } | العنوان الاستشاري للعنصر. راجع تعريف سمة العنوان في HTML 4.01. |
| [Width](../../aspose.html/htmltableelement/width/) { get; set; } | يحدد عرض الجدول المطلوب. راجع تعريف سمة العرض في HTML 4.01. |
...
| [CreateCaption](../../aspose.html/htmltableelement/createcaption/)() | قم بإنشاء كائن تسمية توضيحية لجدول جديد أو أعد كائنًا موجودًا. |
| [CreateTFoot](../../aspose.html/htmltableelement/createtfoot/)() | قم بإنشاء صف تذييل للجدول أو أعد صفًا موجودًا. |
| [CreateTHead](../../aspose.html/htmltableelement/createthead/)() | قم بإنشاء صف رأس جدول أو أعد صفًا موجودًا. |
| [DeleteCaption](../../aspose.html/htmltableelement/deletecaption/)() | احذف التسمية التوضيحية للجدول ، إن وجدت. |
| [DeleteRow](../../aspose.html/htmltableelement/deleterow/)(int) | حذف صف في الجدول. |
| [DeleteTFoot](../../aspose.html/htmltableelement/deletetfoot/)() | احذف التذييل من الجدول ، إن وجد. |
| [DeleteTHead](../../aspose.html/htmltableelement/deletethead/)() | احذف العنوان من الجدول ، إن وجد. |
...
| [InsertRow](../../aspose.html/htmltableelement/insertrow/)(int) | أدخل صفًا فارغًا جديدًا في الجدول. يتم إدراج الصف الجديد مباشرة قبل وفي نفس القسم مثل الحالية`فِهرِس` الصف العاشر في الجدول. لو`فِهرِس` يساوي -1 أو عدد الصفوف ، يتم إلحاق الصف الجديد. بالإضافة إلى ذلك ، عندما يكون الجدول فارغًا ، يتم إدراج الصف في ملف`TBODY` الذي يتم إنشاؤه وإدراجه في الجدول. لا يمكن أن يكون صف الجدول فارغًا وفقًا لـ [[أتش تي أم أل 4.01](http://www.w3.org/TR/1999/REC-html401-19991224) ]. |
