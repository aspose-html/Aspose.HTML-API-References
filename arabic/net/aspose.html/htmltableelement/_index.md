...
description: تسمح أساليب الإنشاء  والحذف  الموجودة في الجدول للمؤلفين بتكوين الجداول وتعديلها . أتش تي أم أل 4.01http//www.w3.org/TR/1999/REChtml40119991224  يحدد أن واحدًا فقط من كل من شرح وثياد  وTFOOT قد توجد عناصر في جدول. لذلك  إذا كان هناك أحد  وتم استدعاء طريقة createTHead  أو createTFoot   تقوم الطريقة بإرجاع عنصر THead أو TFoot الموجود. راجع تعريف عنصر TABLE في HTML 4.01.
type: docs
weight: 3560
...
| [Caption](../../aspose.html/htmltableelement/caption) { get; } | إرجاع الجدول`شرح` ، أو باطلة إذا لم تكن موجودة. @ إصدار DOM المستوى 2 |
...
| [Rows](../../aspose.html/htmltableelement/rows) { get; } | إرجاع الجدول`TFOOT` ، أو`لا شيء` في حالة عدم وجود . |
...
| [TFoot](../../aspose.html/htmltableelement/tfoot) { get; } | إرجاع الجدول`ثياد` ، أو`لا شيء` في حالة عدم وجود . |
| [THead](../../aspose.html/htmltableelement/thead) { get; } | إرجاع الجدول`شرح` ، أو باطلة إذا لم تكن موجودة. |
...
| [InsertRow](../../aspose.html/htmltableelement/insertrow)(int) | أدخل صفًا فارغًا جديدًا في الجدول. يتم إدراج الصف الجديد مباشرة قبل وفي نفس القسم مثل الحالية`فهرس` الصف العاشر في الجدول. إذا`فهرس` يساوي -1 أو عدد الصفوف ، يتم إلحاق الصف الجديد. بالإضافة إلى ذلك ، عندما يكون الجدول فارغًا ، يتم إدراج الصف في ملف`TBODY` الذي يتم إنشاؤه وإدراجه في الجدول. لا يمكن أن يكون صف الجدول فارغًا وفقًا لـ [[أتش تي أم أل 4.01](http://www.w3.org/TR/1999/REC-html401-19991224) ]. |
