...
description: Aspose.Html.HTMLCanvasElement فصل. توفر واجهة HTMLCanvasElement خصائص وطرق لمعالجة تخطيط عناصر لوحة الرسم وعرضها. ترث واجهة HTMLCanvasElement أيضًا خصائص وأساليب واجهة HTMLElement.
type: docs
weight: 3140
url: /ar/net/aspose.html/htmlcanvaselement/
---
## HTMLCanvasElement class

توفر واجهة HTMLCanvasElement خصائص وطرق لمعالجة تخطيط عناصر لوحة الرسم وعرضها. ترث واجهة HTMLCanvasElement أيضًا خصائص وأساليب واجهة HTMLElement.
...
| [Height](../../aspose.html/htmlcanvaselement/height/) { get; set; } | هو عدد صحيح موجب يعكس سمة ارتفاع HTML لعنصر لوحة الرسم المفسر بوحدات بكسل CSS. عندما لا يتم تحديد السمة ، أو إذا تم تعيينها على قيمة غير صالحة ، مثل قيمة سالبة ، يتم استخدام القيمة الافتراضية 150. |
...
| [Width](../../aspose.html/htmlcanvaselement/width/) { get; set; } | هو عدد صحيح موجب يعكس سمة عرض HTML لعنصر قماش الرسم المفسر بوحدات بكسل CSS. عندما لا يتم تحديد السمة ، أو إذا تم تعيينها على قيمة غير صالحة ، مثل قيمة سالبة ، يتم استخدام القيمة الافتراضية 300. |
...
| [GetContext](../../aspose.html/htmlcanvaselement/getcontext/)(string) | تُرجع سياق الرسم على اللوحة القماشية ، أو فارغة إذا لم يكن معرّف السياق مدعومًا. يتيح لك سياق الرسم الرسم على القماش. |
...
| [ToDataURL](../../aspose.html/htmlcanvaselement/todataurl/#todataurl)() | يعرض عنوان URI للبيانات يحتوي على تمثيل للصورة بالتنسيق المحدد بواسطة معلمة النوع (الإعدادات الافتراضية لـ PNG). دقة الصورة التي تم إرجاعها 96 نقطة في البوصة . |
| [ToDataURL](../../aspose.html/htmlcanvaselement/todataurl/#todataurl_1)(string) | يعرض عنوان URI للبيانات يحتوي على تمثيل للصورة بالتنسيق المحدد بواسطة معلمة النوع (الإعدادات الافتراضية لـ PNG). دقة الصورة التي تم إرجاعها 96 نقطة في البوصة . |
| [ToDataURL](../../aspose.html/htmlcanvaselement/todataurl/#todataurl_2)(string, double) | يعرض عنوان URI للبيانات يحتوي على تمثيل للصورة بالتنسيق المحدد بواسطة معلمة النوع (الإعدادات الافتراضية لـ PNG). دقة الصورة التي تم إرجاعها 96 نقطة في البوصة . |
