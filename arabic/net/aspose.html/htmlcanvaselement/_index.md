...
description: توفر واجهة HTMLCanvasElement خصائص وطرق لمعالجة تخطيط عناصر لوحة الرسم وعرضها. ترث واجهة HTMLCanvasElement أيضًا خصائص وأساليب واجهة HTMLElement.
type: docs
weight: 3130
...
| [Width](../../aspose.html/htmlcanvaselement/width) { get; set; } | هو عدد صحيح موجب يعكس سمة عرض HTML لعنصر لوحة الرسم المفسرة بوحدات بكسل CSS. عندما لا يتم تحديد السمة ، أو إذا تم تعيينها على قيمة غير صالحة ، مثل القيمة السالبة ، يتم استخدام القيمة الافتراضية 300. |
