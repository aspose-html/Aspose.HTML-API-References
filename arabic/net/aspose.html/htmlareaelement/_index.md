...
description: Aspose.Html.HTMLAreaElement فصل. تعريف منطقة خريطة الصورة من جانب العميل. راجع تعريف عنصر AREA في HTML 4.01.
type: docs
weight: 3080
url: /ar/net/aspose.html/htmlareaelement/
---
## HTMLAreaElement class

تعريف منطقة خريطة الصورة من جانب العميل. راجع تعريف عنصر AREA في HTML 4.01.
...
| اسم | وصف |
| --- | --- |
| [AccessKey](../../aspose.html/htmlareaelement/accesskey/) { get; set; } | مفتاح وصول ذو حرف واحد لمنح حق الوصول إلى عنصر التحكم في النموذج. راجع تعريف سمة مفتاح الوصول في HTML 4.01. |
| [Alt](../../aspose.html/htmlareaelement/alt/) { get; set; } | لا يعرض النص البديل لوكلاء المستخدم المحتوى العادي لعنصر هذا. راجع تعريف سمة النص البديل في HTML 4.01. |
...
| [Coords](../../aspose.html/htmlareaelement/coords/) { get; set; } | قائمة أطوال مفصولة بفواصل تحدد هندسة منطقة نشطة. انظر أيضًا`شكل` لشكل المنطقة. راجع تعريف السمة coords في HTML 4.01. |
...
| [Href](../../aspose.html/htmlareaelement/href/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] من المورد المرتبط. راجع تعريف سمة href في HTML 4.01. |
...
| [NoHref](../../aspose.html/htmlareaelement/nohref/) { get; set; } | تحديد أن هذه المنطقة غير نشطة ، أي ليس لها أي إجراء مرتبط بها. راجع تعريف سمة nohref في HTML 4.01. |
...
| [RelList](../../aspose.html/htmlareaelement/rellist/) { get; } | إرجاع قائمة DOMTokenList الحية التي تحتوي على الرموز المميزة المستلمة من تحليل السمة "rel" . |
...
| [Shape](../../aspose.html/htmlareaelement/shape/) { get; set; } | شكل المنطقة النشطة. يتم إعطاء الإحداثيات بواسطة `كورد` . راجع تعريف سمة الشكل في HTML 4.01. |
| [Style](../../aspose.html/htmlelement/style/) { get; } | يمثل سمة نمط تسمح للمؤلف بتطبيق معلومات النمط مباشرة على عنصر معين. |
| [TabIndex](../../aspose.html/htmlareaelement/tabindex/) { get; set; } | الفهرس الذي يمثل موضع العنصر في ترتيب الجدولة. راجع تعريف السمة tabindex في HTML 4.01. |
| [TagName](../../aspose.html.dom/element/tagname/) { get; } | اسم العنصر . |
| [Target](../../aspose.html/htmlareaelement/target/) { get; set; } | إطار لعرض المورد فيه. راجع تعريف السمة الهدف في HTML 4.01. |
