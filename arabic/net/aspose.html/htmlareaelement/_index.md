...
description: تعريف منطقة خريطة الصورة من جانب العميل. راجع تعريف عنصر AREA في HTML 4.01.
type: docs
weight: 3070
...
| [NoHref](../../aspose.html/htmlareaelement/nohref) { get; set; } | تحديد أن هذه المنطقة غير نشطة ، أي ليس لها أي إجراء مرتبط. راجع تعريف سمة nohref في HTML 4.01. |
