...
description: Aspose.Html.HTMLInputElement فصل. التحكم في النموذج اعتمادًا على البيئة التي يتم فيها عرض الصفحة  قد تكون خاصية القيمة للقراءة فقط لإدخال تحميل الملف من النوع . بالنسبة لنوع إدخال كلمة المرور  قد تكون القيمة الفعلية التي تم إرجاعها مقنعة لمنع الاستخدام غير المصرح به. راجع تعريف عنصر INPUT في أتش تي أم أل 4.01  .
type: docs
weight: 3320
url: /ar/net/aspose.html/htmlinputelement/
---
## HTMLInputElement class

التحكم في النموذج: اعتمادًا على البيئة التي يتم فيها عرض الصفحة ، قد تكون خاصية القيمة للقراءة فقط لإدخال تحميل الملف من النوع . بالنسبة لنوع إدخال "كلمة المرور" ، قد تكون القيمة الفعلية التي تم إرجاعها مقنعة لمنع الاستخدام غير المصرح به. راجع تعريف عنصر INPUT في [[أتش تي أم أل 4.01](http://www.w3.org/TR/1999/REC-html401-19991224) ] .
...
| اسم | وصف |
| --- | --- |
| [Accept](../../aspose.html/htmlinputelement/accept/) { get; set; } | قائمة بأنواع المحتويات مفصولة بفواصل والتي سيعالجها الخادم الذي يعالج هذا النموذج بشكل صحيح. راجع تعريف سمة القبول في HTML 4.01. |
| [AccessKey](../../aspose.html/htmlinputelement/accesskey/) { get; set; } | مفتاح وصول ذو حرف واحد لمنح حق الوصول إلى عنصر التحكم في النموذج. راجع تعريف سمة مفتاح الوصول في HTML 4.01. |
| [Align](../../aspose.html/htmlinputelement/align/) { get; set; } | محاذاة هذا الكائن (عموديًا أو أفقيًا) فيما يتعلق بالنص المحيط به . راجع تعريف سمة المحاذاة في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
| [Alt](../../aspose.html/htmlinputelement/alt/) { get; set; } | لا يعرض النص البديل لوكلاء المستخدم المحتوى العادي لعنصر هذا. راجع تعريف سمة النص البديل في HTML 4.01. |
...
| [ClassName](../../aspose.html/htmlelement/classname/) { get; set; } | سمة الفئة الخاصة بالعنصر. تمت إعادة تسمية هذه السمة بسبب لتعارضها مع الكلمة الأساسية "class" التي تعرضها العديد من اللغات. راجع تعريف سمة الفئة في HTML 4.01. |
| [DefaultChecked](../../aspose.html/htmlinputelement/defaultchecked/) { get; set; } | متى`يكتب` له القيمة "راديو" أو "مربع اختيار" ، يمثل السمة المحددة في HTML للعنصر. لا تتغير قيمة هذه السمة إذا تغيرت حالة التحكم في النموذج المقابل ، في وكيل مستخدم تفاعلي. راجع تعريف السمة المحدد في HTML 4.01. |
| [DefaultValue](../../aspose.html/htmlinputelement/defaultvalue/) { get; set; } | عندما يكون ملف`يكتب`سمة العنصر لها القيمة "نص" أو "ملف" أو "كلمة مرور" ، وهذا يمثل سمة قيمة لقيمة HTML للعنصر. لا تتغير قيمة هذه السمة إذا تغيرت محتويات عنصر تحكم النموذج المقابل ، في وكيل مستخدم تفاعلي . راجع تعريف سمة القيمة في HTML 4.01. |
| [Dir](../../aspose.html/htmlelement/dir/) { get; set; } | يحدد الاتجاه الأساسي للنص المحايد الاتجاهي و اتجاه الجداول. راجع تعريف سمة dir في HTML 4.01. |
| [Disabled](../../aspose.html/htmlinputelement/disabled/) { get; set; } | عنصر التحكم غير متوفر في هذا السياق. راجع تعريف السمة المعطلة في HTML 4.01. |
| [Files](../../aspose.html/htmlinputelement/files/) { get; } | تسمح سمة IDL للملفات للنصوص بالوصول إلى ملفات العنصر المحددة. يجب إرجاع نفس الكائن حتى تتغير قائمة الملفات المحددة. إذا لم يتم تطبيق سمة IDL ، فيجب أن تُرجع فارغة بدلاً من ذلك. [ملف] |
...
| [Form](../../aspose.html/htmlinputelement/form/) { get; set; } | إرجاع ملف`استمارة` عنصر يحتوي على عنصر التحكم هذا. إرجاع `باطل` إذا لم يكن عنصر التحكم هذا ضمن سياق نموذج . |
| [Id](../../aspose.html/htmlelement/id/) { get; set; } | معرف العنصر. راجع تعريف سمة المعرف في HTML 4.01. |
...
| [Lang](../../aspose.html/htmlelement/lang/) { get; set; } | رمز اللغة المحدد في RFC 1766. راجع تعريف سمة lang في HTML 4.01. |
...
| [List](../../aspose.html/htmlinputelement/list/) { get; set; } | تُستخدم سمة القائمة لتحديد عنصر يسرد الخيارات المحددة مسبقًا المقترحة للمستخدم. |
...
| [MaxLength](../../aspose.html/htmlinputelement/maxlength/) { get; set; } | الحد الأقصى لعدد الأحرف لحقول النص ، متى`يكتب` لها قيمة "نص" أو "كلمة مرور". راجع تعريف السمة maxlength في HTML 4.01. |
| [Name](../../aspose.html/htmlinputelement/name/) { get; set; } | عنصر تحكم النموذج أو اسم الكائن عند إرساله مع نموذج. راجع اسم تعريف السمة في HTML 4.01. |
...
| [ReadOnly](../../aspose.html/htmlinputelement/readonly/) { get; set; } | عنصر التحكم هذا للقراءة فقط. ذات الصلة فقط عندما`يكتب` له قيمة "نص" أو "كلمة مرور". راجع تعريف السمة للقراءة فقط في HTML 4.01. |
...
| [Size](../../aspose.html/htmlinputelement/size/) { get; set; } | معلومات الحجم. المعنى الدقيق خاص بكل نوع من أنواع الحقول . راجع تعريف سمة الحجم في HTML 4.01. @ الإصدار DOM المستوى 2 |
| [Src](../../aspose.html/htmlinputelement/src/) { get; set; } | عندما يكون ملف`يكتب`السمة لها قيمة "صورة" ، تحدد هذه السمة موقع الصورة المراد استخدامها لتزيين زر الإرسال الرسومي . راجع تعريف سمة src في HTML 4.01. |
| [Style](../../aspose.html/htmlelement/style/) { get; } | يمثل سمة نمط تسمح للمؤلف بتطبيق معلومات النمط مباشرة على عنصر معين. |
| [TabIndex](../../aspose.html/htmlinputelement/tabindex/) { get; set; } | الفهرس الذي يمثل موضع العنصر في ترتيب الجدولة. راجع تعريف السمة tabindex في HTML 4.01. |
...
| [Title](../../aspose.html/htmlelement/title/) { get; set; } | العنوان الاستشاري للعنصر. راجع تعريف سمة العنوان في HTML 4.01. |
| [Type](../../aspose.html/htmlinputelement/type/) { get; set; } | نوع عنصر التحكم الذي تم إنشاؤه (كل الأحرف الصغيرة). راجع تعريف سمة النوع في HTML 4.01. @ الإصدار DOM المستوى 2 |
| [UseMap](../../aspose.html/htmlinputelement/usemap/) { get; set; } | استخدم مخطط الصورة من جانب العميل. راجع تعريف سمة خريطة المستخدم في HTML 4.01. |
| [Value](../../aspose.html/htmlinputelement/value/) { get; set; } | عندما يكون ملف`يكتب` سمة العنصر لها القيمة "نص" أو "ملف" أو "كلمة مرور" ، وهذا يمثل المحتويات الحالية لـ عنصر تحكم النموذج المقابل ، في وكيل مستخدم تفاعلي. يؤدي تغيير هذه السمة إلى تغيير محتويات عنصر تحكم النموذج ، ولكن لا يغير قيمة سمة قيمة HTML للعنصر. عندما يكون ملف`يكتب`سمة العنصر لها القيمة "زر" أو "مخفي" أو "إرسال" أو "إعادة تعيين" أو "صورة" أو "مربع اختيار" أو "راديو" ، وهذا يمثل سمة قيمة HTML للعنصر. راجع تعريف سمة القيمة في HTML 4.01. |
...
| اسم | وصف |
| --- | --- |
| event [OnAbort](../../aspose.html/htmlelement/onabort/) | الحصول على معالج الحدث أو تعيينه لحدث OnAbort. |
| event [OnBlur](../../aspose.html/htmlelement/onblur/) | الحصول على معالج الحدث أو تعيينه لحدث OnBlur. |
| event [OnCancel](../../aspose.html/htmlelement/oncancel/) | الحصول على أو تعيين معالج الأحداث لحدث OnCancel. |
| event [OnCanplay](../../aspose.html/htmlelement/oncanplay/) | الحصول على معالج الحدث أو تعيينه لحدث OnCanplay. |
| event [OnCanPlayThrough](../../aspose.html/htmlelement/oncanplaythrough/) | الحصول على معالج الحدث أو تعيينه لحدث OnCanPlayThrough. |
| event [OnChange](../../aspose.html/htmlelement/onchange/) | الحصول على معالج الحدث لحدث OnChange أو تعيينه. |
| event [OnClick](../../aspose.html/htmlelement/onclick/) | الحصول على معالج الحدث لحدث OnClick أو تعيينه. |
| event [OnCueChange](../../aspose.html/htmlelement/oncuechange/) | الحصول على معالج الحدث أو تعيينه لحدث OnCueChange. |
| event [OnDblClick](../../aspose.html/htmlelement/ondblclick/) | الحصول على أو تعيين معالج الأحداث لحدث OnDblClick. |
| event [OnDurationChange](../../aspose.html/htmlelement/ondurationchange/) | الحصول على معالج الحدث لحدث OnDurationChange أو تعيينه. |
| event [OnEmptied](../../aspose.html/htmlelement/onemptied/) | الحصول على أو تعيين معالج الأحداث لحدث OnEmptied. |
| event [OnEnded](../../aspose.html/htmlelement/onended/) | الحصول على معالج الأحداث أو تعيينه لحدث OnEnded. |
| event [OnError](../../aspose.html/htmlelement/onerror/) | الحصول على معالج الحدث لحدث OnError أو تعيينه. |
| event [OnFocus](../../aspose.html/htmlelement/onfocus/) | الحصول على أو تعيين معالج الأحداث لحدث OnFocus. |
| event [OnInput](../../aspose.html/htmlelement/oninput/) | الحصول على أو تعيين معالج الأحداث لحدث OnInput. |
| event [OnInvalid](../../aspose.html/htmlelement/oninvalid/) | الحصول على معالج الحدث أو تعيينه لحدث OnInvalid . |
| event [OnKeyDown](../../aspose.html/htmlelement/onkeydown/) | الحصول على معالج الحدث أو تعيينه لحدث OnKeyDown. |
| event [OnKeyPress](../../aspose.html/htmlelement/onkeypress/) | الحصول على معالج الحدث أو تعيينه لحدث OnKeyPress. |
| event [OnKeyUp](../../aspose.html/htmlelement/onkeyup/) | الحصول على معالج الحدث أو تعيينه لحدث OnKeyUp. |
| event [OnLoad](../../aspose.html/htmlelement/onload/) | الحصول على معالج الحدث أو تعيينه لحدث OnLoad. |
| event [OnLoadedData](../../aspose.html/htmlelement/onloadeddata/) | الحصول على معالج الحدث أو تعيينه لحدث OnLoadedData. |
| event [OnLoadedMetadata](../../aspose.html/htmlelement/onloadedmetadata/) | الحصول على معالج الحدث لحدث OnLoadedMetadata أو تعيينه. |
| event [OnLoadStart](../../aspose.html/htmlelement/onloadstart/) | الحصول على أو تعيين معالج الأحداث لحدث OnLoadStart. |
| event [OnMouseDown](../../aspose.html/htmlelement/onmousedown/) | الحصول على معالج الحدث أو تعيينه لحدث OnMouseDown. |
| event [OnMouseEnter](../../aspose.html/htmlelement/onmouseenter/) | الحصول على معالج الحدث أو تعيينه لحدث OnMouseEnter. |
| event [OnMouseLeave](../../aspose.html/htmlelement/onmouseleave/) | الحصول على معالج الأحداث أو تعيينه لحدث OnMouseLeave. |
| event [OnMouseMove](../../aspose.html/htmlelement/onmousemove/) | الحصول على معالج الحدث أو تعيينه لحدث OnMouseMove. |
| event [OnMouseOut](../../aspose.html/htmlelement/onmouseout/) | الحصول على معالج الحدث أو تعيينه لحدث OnMouseOut. |
| event [OnMouseOver](../../aspose.html/htmlelement/onmouseover/) | الحصول على معالج الحدث أو تعيينه لحدث OnMouseOver. |
| event [OnMouseUp](../../aspose.html/htmlelement/onmouseup/) | الحصول على معالج الحدث أو تعيينه لحدث OnMouseUp. |
| event [OnMouseWheel](../../aspose.html/htmlelement/onmousewheel/) | الحصول على معالج الحدث أو تعيينه لحدث OnMouseWheel. |
| event [OnPause](../../aspose.html/htmlelement/onpause/) | الحصول على معالج الحدث أو تعيينه لحدث OnPause. |
| event [OnPlay](../../aspose.html/htmlelement/onplay/) | الحصول على معالج الحدث أو تعيينه لحدث OnPlay. |
| event [OnPlaying](../../aspose.html/htmlelement/onplaying/) | الحصول على معالج الحدث أو تعيينه لحدث OnPlaying. |
| event [OnProgress](../../aspose.html/htmlelement/onprogress/) | الحصول على معالج الحدث أو تعيينه لحدث OnProgress . |
| event [OnRateChange](../../aspose.html/htmlelement/onratechange/) | الحصول على معالج الحدث لحدث OnRateChange أو تعيينه. |
| event [OnReset](../../aspose.html/htmlelement/onreset/) | الحصول على معالج الحدث لحدث OnReset أو تعيينه. |
| event [OnResize](../../aspose.html/htmlelement/onresize/) | الحصول على معالج الحدث لحدث OnResize أو تعيينه. |
| event [OnScroll](../../aspose.html/htmlelement/onscroll/) | الحصول على أو تعيين معالج الأحداث لحدث OnScroll. |
| event [OnSeeked](../../aspose.html/htmlelement/onseeked/) | الحصول على معالج الحدث لحدث OnSeeked أو تعيينه. |
| event [OnSeeking](../../aspose.html/htmlelement/onseeking/) | الحصول على معالج الحدث لحدث OnSeeking أو تعيينه. |
| event [OnSelect](../../aspose.html/htmlelement/onselect/) | الحصول على معالج الحدث لحدث OnSelect أو تعيينه. |
| event [OnShow](../../aspose.html/htmlelement/onshow/) | الحصول على معالج الحدث لحدث OnShow أو تعيينه. |
| event [OnStalled](../../aspose.html/htmlelement/onstalled/) | الحصول على معالج الحدث للحدث OnStalled أو تعيينه. |
| event [OnSubmit](../../aspose.html/htmlelement/onsubmit/) | الحصول على معالج الحدث أو تعيينه لحدث OnSubmit. |
| event [OnSuspend](../../aspose.html/htmlelement/onsuspend/) | الحصول على معالج الحدث أو تعيينه لحدث OnSuspend. |
| event [OnTimeUpdate](../../aspose.html/htmlelement/ontimeupdate/) | الحصول على أو تعيين معالج الأحداث لحدث OnTimeUpdate. |
| event [OnToggle](../../aspose.html/htmlelement/ontoggle/) | الحصول على أو تعيين معالج الأحداث لحدث OnToggle. |
| event [OnVolumeChange](../../aspose.html/htmlelement/onvolumechange/) | الحصول على معالج الحدث لحدث OnVolumeChange أو تعيينه. |
| event [OnWaiting](../../aspose.html/htmlelement/onwaiting/) | الحصول على معالج الحدث للحدث OnWaiting أو تعيينه. |
