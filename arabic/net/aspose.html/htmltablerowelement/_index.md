...
description: صف في جدول. راجع تعريف عنصر TR في HTML 4.01.
type: docs
weight: 3570
...
| [Ch](../../aspose.html/htmltablerowelement/ch) { get; set; } | حرف المحاذاة للخلايا الموجودة في عمود. راجع تعريف السمة char في HTML 4.01. |
...
| [InsertCell](../../aspose.html/htmltablerowelement/insertcell)(int) | أدخل ملفًا فارغًا`TD` خلية في هذا الصف. إذا `فهرس` هي -1 أو يساوي عدد الخلايا ، يتم إلحاق الخلية الجديدة. |
