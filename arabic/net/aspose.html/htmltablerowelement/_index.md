...
description: Aspose.Html.HTMLTableRowElement فصل. صف في جدول. راجع تعريف عنصر TR في HTML 4.01.
type: docs
weight: 3580
url: /ar/net/aspose.html/htmltablerowelement/
---
## HTMLTableRowElement class

صف في جدول. راجع تعريف عنصر TR في HTML 4.01.
...
| اسم | وصف |
| --- | --- |
| [Align](../../aspose.html/htmltablerowelement/align/) { get; set; } | محاذاة أفقية للبيانات داخل خلايا هذا الصف. راجع تعريف السمة align في HTML 4.01. |
...
| [BgColor](../../aspose.html/htmltablerowelement/bgcolor/) { get; set; } | لون الخلفية للصفوف. راجع تعريف سمة bgcolor في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
| [Cells](../../aspose.html/htmltablerowelement/cells/) { get; } | مجموعة الخلايا في هذا الصف. @ إصدار DOM المستوى 2 |
| [Ch](../../aspose.html/htmltablerowelement/ch/) { get; set; } | حرف المحاذاة للخلايا الموجودة في عمود. انظر تعريف السمة char في HTML 4.01. |
...
| [ChOff](../../aspose.html/htmltablerowelement/choff/) { get; set; } | إزاحة حرف المحاذاة. راجع تعريف سمة charoff في HTML 4.01. |
...
| [RowIndex](../../aspose.html/htmltablerowelement/rowindex/) { get; } | هذا بترتيب منطقي وليس بترتيب المستند. `RowIndex` تأخذ في الاعتبار الأقسام ( `ثياد` و`TFOOT` ، أو`TBODY` ) داخل الجدول ، ووضع`ثياد` أولًا من الصفوف في الفهرس ، متبوعًا بـ`TBODY` من الصفوف متبوعة بـ`TFOOT` rows. @ إصدار DOM المستوى 2 |
| [SchemaTypeInfo](../../aspose.html.dom/element/schematypeinfo/) { get; } | نوع المعلومات المرتبطة بهذا العنصر . |
| [SectionRowIndex](../../aspose.html/htmltablerowelement/sectionrowindex/) { get; } | فهرس هذا الصف المتعلق بالقسم الحالي ( `ثياد` و`TFOOT` ، أو`TBODY` ) ، بدءًا من 0. @ إصدار DOM المستوى 2 |
...
| [VAlign](../../aspose.html/htmltablerowelement/valign/) { get; set; } | محاذاة عمودية للبيانات داخل خلايا هذا الصف. راجع تعريف السمة valign في HTML 4.01. |
...
| [DeleteCell](../../aspose.html/htmltablerowelement/deletecell/)(int) | حذف خلية من الصف الحالي. |
...
| [InsertCell](../../aspose.html/htmltablerowelement/insertcell/)(int) | أدخل ملفًا فارغًا`TD` خلية في هذا الصف. إذا `فِهرِس` هي -1 أو يساوي عدد الخلايا ، يتم إلحاق الخلية الجديدة. |
