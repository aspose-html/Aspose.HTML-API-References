...
description: نص تسمية حقل النموذج. راجع تعريف عنصر LABEL في HTML 4.01.
type: docs
weight: 3340
...
| [For](../../aspose.html/htmllabelelement/for) { get; set; } | تربط هذه السمة هذه التسمية بعنصر تحكم آخر في النموذج بواسطة `هوية شخصية`ينسب. راجع تعريف السمة في HTML 4.01. |
| [Form](../../aspose.html/htmllabelelement/form) { get; } | إرجاع ملف`شكل` عنصر يحتوي على عنصر التحكم هذا. إرجاع `لا شيء` إذا لم يكن عنصر التحكم هذا ضمن سياق نموذج . |
