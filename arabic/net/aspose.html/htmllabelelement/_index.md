...
description: Aspose.Html.HTMLLabelElement فصل. نص تسمية حقل النموذج. راجع تعريف عنصر LABEL في HTML 4.01.
type: docs
weight: 3350
url: /ar/net/aspose.html/htmllabelelement/
---
## HTMLLabelElement class

نص تسمية حقل النموذج. راجع تعريف عنصر LABEL في HTML 4.01.
...
| اسم | وصف |
| --- | --- |
| [AccessKey](../../aspose.html/htmllabelelement/accesskey/) { get; set; } | مفتاح وصول ذو حرف واحد لمنح حق الوصول إلى عنصر التحكم في النموذج. راجع تعريف سمة مفتاح الوصول في HTML 4.01. |
...
| [For](../../aspose.html/htmllabelelement/for/) { get; set; } | تربط هذه السمة هذه التسمية بعنصر تحكم آخر في النموذج بواسطة `بطاقة تعريف`يصف. راجع تعريف السمة في HTML 4.01. |
| [Form](../../aspose.html/htmllabelelement/form/) { get; } | إرجاع ملف`استمارة` عنصر يحتوي على عنصر التحكم هذا. إرجاع `باطل` إذا لم يكن عنصر التحكم هذا ضمن سياق نموذج . |
