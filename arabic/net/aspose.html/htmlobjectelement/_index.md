...
description: كائن مضمن عام. من حيث المبدأ  تكون جميع الخصائص الموجودة في عنصر الكائن للقراءة والكتابة ولكن في بعض البيئات قد تكون بعض الخصائص للقراءة فقط بمجرد إنشاء الكائن الأساسي. راجع تعريف عنصر OBJECT في أتش تي أم أل 4.01http//www.w3.org/TR/1999/REChtml40119991224  .
type: docs
weight: 3430
...
| [ClassId](../../aspose.html/htmlobjectelement/classid) { get; set; } | يحدد قيمة معرف فئة كما تم تعيينها في سجل Windows أو URL |
...
| [Code](../../aspose.html/htmlobjectelement/code) { get; set; } | ملف فئة التطبيق الصغير. انظر`الشفرة` سمة لـ HTMLAppletElement. |
| [CodeBase](../../aspose.html/htmlobjectelement/codebase) { get; set; } | Base URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] إلى عن على`أنيق` و`بيانات` و `أرشيف` صفات. راجع تعريف سمة قاعدة البيانات في HTML 4.01. |
| [CodeType](../../aspose.html/htmlobjectelement/codetype) { get; set; } | نوع محتوى البيانات التي تم تنزيلها عبر`أنيق` ينسب. راجع تعريف سمة نوع التعليمات البرمجية في HTML 4.01. |
| [Data](../../aspose.html/htmlobjectelement/data) { get; set; } | عنوان URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] تحديد موقع بيانات الكائن. راجع تعريف سمة البيانات في HTML 4.01. |
...
| [Form](../../aspose.html/htmlobjectelement/form) { get; set; } | إرجاع ملف`شكل` عنصر يحتوي على عنصر التحكم هذا. عائدات`لا شيء` إذا لم يكن عنصر التحكم هذا ضمن سياق النموذج. |
...
| [Type](../../aspose.html/htmlobjectelement/type) { get; set; } | نوع محتوى البيانات التي تم تنزيلها عبر`بيانات` ينسب. راجع تعريف سمة النوع في HTML 4.01. |
