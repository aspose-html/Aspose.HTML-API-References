...
description: Aspose.Html.HTMLObjectElement فصل. كائن مضمن عام. من حيث المبدأ  تكون جميع الخصائص الموجودة في عنصر الكائن للقراءة والكتابة ولكن في بعض البيئات قد تكون بعض الخصائص للقراءة فقط بمجرد إنشاء الكائن الأساسي. راجع تعريف عنصر OBJECT في أتش تي أم أل 4.01  .
type: docs
weight: 3440
url: /ar/net/aspose.html/htmlobjectelement/
---
## HTMLObjectElement class

كائن مضمن عام. من حيث المبدأ ، تكون جميع الخصائص الموجودة في عنصر الكائن للقراءة والكتابة ولكن في بعض البيئات قد تكون بعض الخصائص للقراءة فقط بمجرد إنشاء الكائن الأساسي. راجع تعريف عنصر OBJECT في [[أتش تي أم أل 4.01](http://www.w3.org/TR/1999/REC-html401-19991224) ] .
...
| اسم | وصف |
| --- | --- |
| [Align](../../aspose.html/htmlobjectelement/align/) { get; set; } | محاذاة هذا الكائن (عموديًا أو أفقيًا) بالنسبة للنص المحيط به. راجع تعريف سمة المحاذاة في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
| [Archive](../../aspose.html/htmlobjectelement/archive/) { get; set; } | قائمة المحفوظات مفصولة بمسافات. راجع تعريف سمة الأرشيف في HTML 4.01. |
...
| [Border](../../aspose.html/htmlobjectelement/border/) { get; set; } | عرض الحد حول الكائن. راجع تعريف سمة الحدود في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
...
| [ClassId](../../aspose.html/htmlobjectelement/classid/) { get; set; } | يحدد قيمة معرف الفئة كما تم تعيينها في سجل Windows أو URL |
...
| [Code](../../aspose.html/htmlobjectelement/code/) { get; set; } | ملف فئة التطبيق الصغير. انظر`شفرة` سمة لـ HTMLAppletElement. |
| [CodeBase](../../aspose.html/htmlobjectelement/codebase/) { get; set; } | Base URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] ل`أنيق` و`بيانات` و `أرشيف` صفات. راجع تعريف سمة قاعدة البيانات في HTML 4.01. |
| [CodeType](../../aspose.html/htmlobjectelement/codetype/) { get; set; } | نوع محتوى البيانات التي تم تنزيلها عبر`أنيق` يصف. راجع تعريف سمة نوع التعليمات البرمجية في HTML 4.01. |
| [Data](../../aspose.html/htmlobjectelement/data/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] تحديد موقع بيانات الكائن. راجع تعريف سمة البيانات في HTML 4.01. |
| [Declare](../../aspose.html/htmlobjectelement/declare/) { get; set; } | قم بتعريف (للرجوع إليه في المستقبل) ، لكن لا تقم بإنشاء مثيل لهذا الكائن. راجع تعريف تعريف السمة في HTML 4.01. |
...
| [Form](../../aspose.html/htmlobjectelement/form/) { get; set; } | إرجاع ملف`استمارة` عنصر يحتوي على عنصر التحكم هذا. عائدات`باطل` إذا لم يكن عنصر التحكم هذا ضمن سياق النموذج. |
| [Height](../../aspose.html/htmlobjectelement/height/) { get; set; } | تجاوز الارتفاع. راجع تعريف سمة الارتفاع في HTML 4.01. |
| [Hspace](../../aspose.html/htmlobjectelement/hspace/) { get; set; } | مسافة أفقية ، بالبكسل ، على يسار ويمين هذه الصورة ، صغيرة ، أو كائن. راجع تعريف سمة hspace في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
...
| [Name](../../aspose.html/htmlobjectelement/name/) { get; set; } | عنصر تحكم النموذج أو اسم الكائن عند إرساله مع نموذج. راجع اسم تعريف السمة في HTML 4.01. |
...
| [Standby](../../aspose.html/htmlobjectelement/standby/) { get; set; } | رسالة ليتم عرضها أثناء تحميل الكائن. راجع تعريف السمة الاحتياطية في HTML 4.01. |
| [Style](../../aspose.html/htmlelement/style/) { get; } | يمثل سمة نمط تسمح للمؤلف بتطبيق معلومات النمط مباشرة على عنصر معين. |
| [TabIndex](../../aspose.html/htmlobjectelement/tabindex/) { get; set; } | الفهرس الذي يمثل موضع العنصر في ترتيب الجدولة. راجع تعريف السمة tabindex في HTML 4.01. |
...
| [Type](../../aspose.html/htmlobjectelement/type/) { get; set; } | نوع محتوى البيانات التي تم تنزيلها عبر`بيانات` يصف. راجع تعريف سمة النوع في HTML 4.01. |
| [UseMap](../../aspose.html/htmlobjectelement/usemap/) { get; set; } | استخدم مخطط الصورة من جانب العميل. راجع تعريف سمة خريطة المستخدم في HTML 4.01. |
| [Vspace](../../aspose.html/htmlobjectelement/vspace/) { get; set; } | مساحة عمودية ، بالبكسل ، فوق وتحت هذه الصورة أو التطبيق الصغير أو الكائن. راجع تعريف سمة vspace في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
| [Width](../../aspose.html/htmlobjectelement/width/) { get; set; } | تجاوز العرض. راجع تعريف سمة العرض في HTML 4.01. |
