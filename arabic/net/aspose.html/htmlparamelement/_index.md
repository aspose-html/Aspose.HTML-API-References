...
description: تغذية المعلمات لملفهدف عنصر. راجع تعريف عنصر PARAM في HTML 4.01.
type: docs
weight: 3470
...
| [Type](../../aspose.html/htmlparamelement/type) { get; set; } | نوع المحتوى لملف`القيمة` السمة عندما `نوع القيمة` له قيمة "المرجع". راجع تعريف سمة النوع في HTML 4.01. |
| [Value](../../aspose.html/htmlparamelement/value) { get; set; } | قيمة معلمة وقت التشغيل. راجع تعريف سمة القيمة في HTML 4.01. |
| [ValueType](../../aspose.html/htmlparamelement/valuetype) { get; set; } | معلومات حول معنى ملف`القيمة` قيمة السمة . راجع تعريف سمة valuetype في HTML 4.01. |
