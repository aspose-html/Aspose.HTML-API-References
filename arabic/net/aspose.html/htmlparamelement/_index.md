...
description: Aspose.Html.HTMLParamElement فصل. تغذية المعلمات لملفهدف عنصر. راجع تعريف عنصر PARAM في HTML 4.01.
type: docs
weight: 3480
url: /ar/net/aspose.html/htmlparamelement/
---
## HTMLParamElement class

تغذية المعلمات لملف`هدف` عنصر. راجع تعريف عنصر PARAM في HTML 4.01.
...
| [Name](../../aspose.html/htmlparamelement/name/) { get; set; } | اسم معلمة وقت التشغيل. راجع تعريف سمة الاسم في HTML 4.01. |
...
| [Type](../../aspose.html/htmlparamelement/type/) { get; set; } | نوع المحتوى لملف`قيمة` السمة عندما `نوع القيمة` له قيمة "المرجع". راجع تعريف سمة النوع في HTML 4.01. |
| [Value](../../aspose.html/htmlparamelement/value/) { get; set; } | قيمة معلمة وقت التشغيل. راجع تعريف سمة القيمة في HTML 4.01. |
| [ValueType](../../aspose.html/htmlparamelement/valuetype/) { get; set; } | معلومات حول معنى ملف`قيمة` السمة القيمة. راجع تعريف سمة valuetype في HTML 4.01. |
