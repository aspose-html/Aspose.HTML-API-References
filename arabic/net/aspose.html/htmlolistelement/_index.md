...
description: Aspose.Html.HTMLOListElement فصل. القائمة المطلوبة. راجع تعريف عنصر OL في HTML 4.01.
type: docs
weight: 3430
url: /ar/net/aspose.html/htmlolistelement/
---
## HTMLOListElement class

القائمة المطلوبة. راجع تعريف عنصر OL في HTML 4.01.
...
| [Compact](../../aspose.html/htmlolistelement/compact/) { get; set; } | تقليل التباعد بين عناصر القائمة. راجع تعريف السمة المدمجة في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
...
| [Start](../../aspose.html/htmlolistelement/start/) { get; set; } | رقم تسلسل البداية. راجع تعريف سمة البدء في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
...
| [Type](../../aspose.html/htmlolistelement/type/) { get; set; } | نمط الترقيم. راجع تعريف سمة النوع في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
