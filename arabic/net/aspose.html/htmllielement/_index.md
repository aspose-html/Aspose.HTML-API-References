...
description: Aspose.Html.HTMLLIElement فصل. عنصر قائمة. راجع تعريف عنصر LI في HTML 4.01.
type: docs
weight: 3340
url: /ar/net/aspose.html/htmllielement/
---
## HTMLLIElement class

عنصر قائمة. راجع تعريف عنصر LI في HTML 4.01.
...
| [Type](../../aspose.html/htmllielement/type/) { get; set; } | نمط التعداد النقطي لعنصر القائمة. راجع تعريف سمة النوع في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
| [Value](../../aspose.html/htmllielement/value/) { get; set; } | إعادة تعيين رقم التسلسل عند استخدامه بتنسيق`OL` . راجع تعريف سمة القيمة في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
