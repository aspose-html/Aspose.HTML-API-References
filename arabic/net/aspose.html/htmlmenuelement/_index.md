...
description: Aspose.Html.HTMLMenuElement فصل. قائمة القائمة. راجع تعريف عنصر القائمة في HTML 4.01. هذا العنصر مهمل في HTML 4.01.
type: docs
weight: 3390
url: /ar/net/aspose.html/htmlmenuelement/
---
## HTMLMenuElement class

قائمة القائمة. راجع تعريف عنصر القائمة في HTML 4.01. هذا العنصر مهمل في HTML 4.01.
...
| [Compact](../../aspose.html/htmlmenuelement/compact/) { get; set; } | تقليل التباعد بين عناصر القائمة. راجع تعريف السمة المدمجة في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
