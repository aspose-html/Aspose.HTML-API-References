...
description: Aspose.Html.HTMLTableCaptionElement فصل. التسمية التوضيحية للجدول راجع تعريف عنصر CAPTION في HTML 4.01.
type: docs
weight: 3540
url: /ar/net/aspose.html/htmltablecaptionelement/
---
## HTMLTableCaptionElement class

التسمية التوضيحية للجدول راجع تعريف عنصر CAPTION في HTML 4.01.
...
| اسم | وصف |
| --- | --- |
| [Align](../../aspose.html/htmltablecaptionelement/align/) { get; set; } | محاذاة التسمية التوضيحية فيما يتعلق بالجدول. راجع تعريف سمة المحاذاة في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
