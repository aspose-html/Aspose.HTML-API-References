...
description: Aspose.Html.HTMLScriptElement فصل. عبارات البرنامج النصي. راجع تعريف عنصر البرنامج النصي في HTML 4.01.
type: docs
weight: 3510
url: /ar/net/aspose.html/htmlscriptelement/
---
## HTMLScriptElement class

عبارات البرنامج النصي. راجع تعريف عنصر البرنامج النصي في HTML 4.01.
...
| [Charset](../../aspose.html/htmlscriptelement/charset/) { get; set; } | ترميز الأحرف للمورد المرتبط. راجع تعريف سمة charset في HTML 4.01. |
...
| [Defer](../../aspose.html/htmlscriptelement/defer/) { get; set; } | يشير إلى أن وكيل المستخدم يمكنه تأجيل معالجة البرنامج النصي. راجع تعريف سمة defer في HTML 4.01. |
...
| [Event](../../aspose.html/htmlscriptelement/event/) { get; set; } | محجوزة للاستخدام في المستقبل. |
...
| [Src](../../aspose.html/htmlscriptelement/src/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] تعيين نص خارجي. راجع تعريف سمة src في HTML 4.01. |
...
| [Text](../../aspose.html/htmlscriptelement/text/) { get; set; } | محتوى البرنامج النصي للعنصر. |
...
| [Type](../../aspose.html/htmlscriptelement/type/) { get; set; } | نوع محتوى لغة البرنامج النصي. راجع تعريف سمة النوع في HTML 4.01. |
