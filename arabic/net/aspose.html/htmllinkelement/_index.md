...
description: Aspose.Html.HTMLLinkElement فصل. ملفوصلةيحدد العنصر ارتباطًا بمصدر خارجي  ويحدد علاقة هذا المستند بهذا المورد أو العكس بالعكس. راجع تعريف عنصر LINK في HTML 4.01 راجع أيضًا LinkStyle واجهة في وحدة StyleSheet أوراق أنماط DOM من المستوى 2 و CSS  .
type: docs
weight: 3370
url: /ar/net/aspose.html/htmllinkelement/
---
## HTMLLinkElement class

ملف`وصلة`يحدد العنصر ارتباطًا بمصدر خارجي ، ويحدد علاقة هذا المستند بهذا المورد (أو العكس بالعكس). راجع تعريف عنصر LINK في HTML 4.01 (راجع أيضًا `LinkStyle` واجهة في وحدة StyleSheet [[أوراق أنماط DOM من المستوى 2 و CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113) ]) .
...
| [Charset](../../aspose.html/htmllinkelement/charset/) { get; set; } | ترميز الأحرف للمورد المرتبط به. راجع تعريف سمة charset في HTML 4.01. |
...
| [Disabled](../../aspose.html/htmllinkelement/disabled/) { get; set; } | لتمكين / تعطيل الارتباط. يُستخدم هذا حاليًا فقط لروابط ورقة الأنماط ، ويمكن استخدامه لتنشيط أوراق الأنماط أو إلغاء تنشيطها. |
...
| [Href](../../aspose.html/htmllinkelement/href/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] من المورد المرتبط. راجع تعريف سمة href في HTML 4.01. |
| [Hreflang](../../aspose.html/htmllinkelement/hreflang/) { get; set; } | رمز اللغة للمورد المرتبط. راجع تعريف السمة hreflang في HTML 4.01. |
...
| [Media](../../aspose.html/htmllinkelement/media/) { get; set; } | مصمم للاستخدام مع واحد أو أكثر من الوسائط المستهدفة. راجع تعريف سمة الوسائط في HTML 4.01. |
...
| [Rel](../../aspose.html/htmllinkelement/rel/) { get; set; } | نوع الارتباط الأمامي. راجع تعريف سمة rel في HTML 4.01. |
| [RelList](../../aspose.html/htmllinkelement/rellist/) { get; } | إرجاع قائمة DOMTokenList الحية التي تحتوي على الرموز المميزة المستلمة من تحليل السمة "rel" . |
| [Rev](../../aspose.html/htmllinkelement/rev/) { get; set; } | نوع الارتباط العكسي. راجع تعريف سمة rev في HTML 4.01. |
...
| [Sheet](../../aspose.html/htmllinkelement/sheet/) { get; } | الحصول على ورقة الأنماط المرتبطة. |
...
| [Target](../../aspose.html/htmllinkelement/target/) { get; set; } | إطار لعرض المورد فيه. راجع تعريف السمة الهدف في HTML 4.01. |
...
| [Type](../../aspose.html/htmllinkelement/type/) { get; set; } | نوع المحتوى الاستشاري. راجع تعريف سمة النوع في HTML 4.01. |
