...
description: ملفحلقة الوصليحدد العنصر ارتباطًا بمصدر خارجي  ويحدد علاقة هذا المستند بهذا المورد أو العكس. راجع تعريف عنصر LINK في HTML 4.01 راجع أيضًا LinkStyle واجهة في وحدة StyleSheet أوراق أنماط DOM من المستوى 2 و CSShttp//www.w3.org/TR/2000/RECDOMLevel2Style20001113  .
type: docs
weight: 3360
...
ملف`حلقة الوصل`يحدد العنصر ارتباطًا بمصدر خارجي ، ويحدد علاقة هذا المستند بهذا المورد (أو العكس). راجع تعريف عنصر LINK في HTML 4.01 (راجع أيضًا `LinkStyle` واجهة في وحدة StyleSheet [[أوراق أنماط DOM من المستوى 2 و CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113) ]) .
