...
description: نص مستند HTML. هذا العنصر موجود دائمًا في واجهة برمجة تطبيقات DOM  حتى إذا لم تكن العلامات موجودة في المستند المصدر. راجع تعريف عنصر BODY في HTML 4.01.
type: docs
weight: 3110
