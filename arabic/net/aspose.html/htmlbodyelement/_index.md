...
description: Aspose.Html.HTMLBodyElement فصل. نص مستند HTML. هذا العنصر موجود دائمًا في واجهة برمجة تطبيقات DOM  حتى إذا لم تكن العلامات موجودة في المستند المصدر. راجع تعريف عنصر BODY في HTML 4.01.
type: docs
weight: 3120
url: /ar/net/aspose.html/htmlbodyelement/
---
## HTMLBodyElement class

نص مستند HTML. هذا العنصر موجود دائمًا في واجهة برمجة تطبيقات DOM ، حتى إذا لم تكن العلامات موجودة في المستند المصدر. راجع تعريف عنصر BODY في HTML 4.01.
...
| اسم | وصف |
| --- | --- |
| [ALink](../../aspose.html/htmlbodyelement/alink/) { get; set; } | لون الروابط النشطة (بعد زر الماوس لأسفل ، ولكن قبل زر الماوس لأعلى). راجع تعريف سمة الرابط في HTML 4.01. هذه السمة مهملة في HTML 4.01. |
...
| [Background](../../aspose.html/htmlbodyelement/background/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] لصورة بلاط الخلفية الملمس. راجع تعريف سمة الخلفية في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
...
| [BgColor](../../aspose.html/htmlbodyelement/bgcolor/) { get; set; } | لون خلفية المستند. راجع تعريف سمة bgcolor في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
...
| [Link](../../aspose.html/htmlbodyelement/link/) { get; set; } | لون الروابط غير النشطة وغير المرغوب فيها. راجع الارتباط تعريف السمة في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
...
| [Text](../../aspose.html/htmlbodyelement/text/) { get; set; } | لون نص المستند. راجع تعريف سمة النص في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
...
| [VLink](../../aspose.html/htmlbodyelement/vlink/) { get; set; } | لون الروابط التي قام المستخدم بزيارتها. راجع تعريف سمة vlink في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
