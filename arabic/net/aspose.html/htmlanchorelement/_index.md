...
description: عنصر الارتساء. راجع تعريف العنصر A في HTML 4.01.
type: docs
weight: 3050
...
| [Coords](../../aspose.html/htmlanchorelement/coords) { get; set; } | قائمة أطوال مفصولة بفواصل ، وتحديد هندسة منطقة نشطة. راجع أيضًا`شكل` لشكل المنطقة. راجع تعريف سمة coords في HTML 4.01. |
...
| [Hash](../../aspose.html/htmlanchorelement/hash) { get; set; } | الحصول على تمثيل سلسلة لمقطع التجزئة لعنوان URL المرتبط أو تعيينه. |
...
| [Password](../../aspose.html/htmlanchorelement/password) { get; set; } | الحصول على أو تعيين سلسلة تمثيل لمقطع كلمة المرور لعنوان URL المرتبط. |
