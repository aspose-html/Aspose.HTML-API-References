...
description: Aspose.Html.HTMLAnchorElement فصل. عنصر الارتساء. راجع تعريف العنصر A في HTML 4.01.
type: docs
weight: 3060
url: /ar/net/aspose.html/htmlanchorelement/
---
## HTMLAnchorElement class

عنصر الارتساء. راجع تعريف العنصر A في HTML 4.01.
...
| اسم | وصف |
| --- | --- |
| [AccessKey](../../aspose.html/htmlanchorelement/accesskey/) { get; set; } | مفتاح وصول ذو حرف واحد لمنح حق الوصول إلى عنصر التحكم في النموذج. راجع تعريف سمة مفتاح الوصول في HTML 4.01. |
...
| [Charset](../../aspose.html/htmlanchorelement/charset/) { get; set; } | ترميز الأحرف للمورد المرتبط. راجع تعريف سمة charset في HTML 4.01. |
...
| [Coords](../../aspose.html/htmlanchorelement/coords/) { get; set; } | قائمة أطوال مفصولة بفواصل ، تحدد هندسة منطقة نشطة. راجع أيضًا`شكل` لشكل المنطقة. راجع تعريف سمة coords في HTML 4.01. |
...
| [Hash](../../aspose.html/htmlanchorelement/hash/) { get; set; } | الحصول على أو تعيين تمثيل سلسلة لمقطع التجزئة لعنوان URL المرتبط. |
| [Host](../../aspose.html/htmlanchorelement/host/) { get; set; } | الحصول على أو تعيين تمثيل سلسلة للمضيف ومقاطع المنفذ لعنوان URL المرتبط. |
| [Hostname](../../aspose.html/htmlanchorelement/hostname/) { get; set; } | الحصول على أو تعيين تمثيل سلسلة لمقطع المضيف لعنوان URL المرتبط. |
| [Href](../../aspose.html/htmlanchorelement/href/) { get; set; } | URI المطلق [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) من المورد المرتبط. راجع تعريف السمة href في HTML 4.01. |
| [Hreflang](../../aspose.html/htmlanchorelement/hreflang/) { get; set; } | رمز اللغة للمورد المرتبط. راجع تعريف السمة hreflang في HTML 4.01. |
...
| [Name](../../aspose.html/htmlanchorelement/name/) { get; set; } | اسم المرساة. راجع تعريف سمة الاسم في HTML 4.01. |
...
| [Origin](../../aspose.html/htmlanchorelement/origin/) { get; } | يحصل على تمثيل سلسلة للمقطع الأصلي لعنوان URL المرتبط. |
...
| [Password](../../aspose.html/htmlanchorelement/password/) { get; set; } | الحصول على أو تعيين تمثيل سلسلة لمقطع كلمة المرور لعنوان URL المرتبط. |
| [Pathname](../../aspose.html/htmlanchorelement/pathname/) { get; set; } | الحصول على أو تعيين سلسلة تمثيل لمقطع المسار لعنوان URL المرتبط. |
| [Port](../../aspose.html/htmlanchorelement/port/) { get; set; } | الحصول على أو تعيين تمثيل سلسلة لمقطع المنفذ لعنوان URL المرتبط. |
...
| [Protocol](../../aspose.html/htmlanchorelement/protocol/) { get; set; } | الحصول على أو تعيين تمثيل سلسلة لمقطع المخطط لعنوان URL المرتبط. |
| [Rel](../../aspose.html/htmlanchorelement/rel/) { get; set; } | نوع الارتباط الأمامي. راجع تعريف سمة rel في HTML 4.01. |
| [RelList](../../aspose.html/htmlanchorelement/rellist/) { get; } | إرجاع قائمة DOMTokenList الحية التي تحتوي على الرموز المميزة المستلمة من تحليل السمة "rel" . |
| [Rev](../../aspose.html/htmlanchorelement/rev/) { get; set; } | نوع الارتباط العكسي. راجع تعريف سمة rev في HTML 4.01. |
| [SchemaTypeInfo](../../aspose.html.dom/element/schematypeinfo/) { get; } | نوع المعلومات المرتبطة بهذا العنصر . |
| [Search](../../aspose.html/htmlanchorelement/search/) { get; set; } | الحصول على أو تعيين تمثيل سلسلة لمقطع البحث لعنوان URL المرتبط. |
| [ShadowRoot](../../aspose.html.dom/element/shadowroot/) { get; } | تُرجع shadowRoot المخزنة في هذا العنصر أو تُرجع فارغة إذا كان مغلقًا. |
| [Shape](../../aspose.html/htmlanchorelement/shape/) { get; set; } | شكل المنطقة النشطة. يتم إعطاء الإحداثيات بواسطة `كورد` . راجع تعريف سمة الشكل في HTML 4.01. |
| [Style](../../aspose.html/htmlelement/style/) { get; } | يمثل سمة نمط تسمح للمؤلف بتطبيق معلومات النمط مباشرة على عنصر معين. |
| [TabIndex](../../aspose.html/htmlanchorelement/tabindex/) { get; set; } | الفهرس الذي يمثل موضع العنصر في ترتيب الجدولة. راجع تعريف السمة tabindex في HTML 4.01. |
| [TagName](../../aspose.html.dom/element/tagname/) { get; } | اسم العنصر . |
| [Target](../../aspose.html/htmlanchorelement/target/) { get; set; } | إطار لعرض المورد فيه. راجع تعريف السمة الهدف في HTML 4.01. |
...
| [Type](../../aspose.html/htmlanchorelement/type/) { get; set; } | نوع المحتوى الاستشاري. راجع تعريف سمة النوع في HTML 4.01. |
| [Username](../../aspose.html/htmlanchorelement/username/) { get; set; } | الحصول على أو تعيين تمثيل سلسلة لمقطع اسم المستخدم لعنوان URL المرتبط. |
...
| [Blur](../../aspose.html/htmlanchorelement/blur/)() | يزيل تركيز لوحة المفاتيح من هذا العنصر. |
...
| [Focus](../../aspose.html/htmlanchorelement/focus/)() | يعطي تركيز لوحة المفاتيح لهذا العنصر. |
