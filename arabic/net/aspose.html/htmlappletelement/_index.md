...
description: برنامج Java صغير مضمن. راجع تعريف عنصر APPLET في HTML 4.01. تم إهمال هذا العنصر في HTML 4.01.
type: docs
weight: 3060
...
| [CodeBase](../../aspose.html/htmlappletelement/codebase) { get; set; } | معرّف URI أساسي اختياري [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) عن التطبيق الصغير. راجع تعريف سمة قاعدة البيانات في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
