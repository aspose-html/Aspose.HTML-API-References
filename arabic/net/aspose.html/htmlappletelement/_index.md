...
description: Aspose.Html.HTMLAppletElement فصل. برنامج Java صغير مضمن. راجع تعريف عنصر APPLET في HTML 4.01. تم إهمال هذا العنصر في HTML 4.01.
type: docs
weight: 3070
url: /ar/net/aspose.html/htmlappletelement/
---
## HTMLAppletElement class

برنامج Java صغير مضمن. راجع تعريف عنصر APPLET في HTML 4.01. تم إهمال هذا العنصر في HTML 4.01.
...
| اسم | وصف |
| --- | --- |
| [Align](../../aspose.html/htmlappletelement/align/) { get; set; } | محاذاة هذا الكائن (عموديًا أو أفقيًا) فيما يتعلق بالنص المحيط به . راجع تعريف سمة المحاذاة في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
| [Alt](../../aspose.html/htmlappletelement/alt/) { get; set; } | لا يعرض النص البديل لوكلاء المستخدم المحتوى العادي لعنصر هذا. راجع تعريف سمة النص البديل في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
| [Archive](../../aspose.html/htmlappletelement/archive/) { get; set; } | قائمة أرشيف مفصولة بفواصل. راجع تعريف سمة الأرشيف في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
...
| [Code](../../aspose.html/htmlappletelement/code/) { get; set; } | ملف فئة التطبيق الصغير. راجع تعريف سمة التعليمات البرمجية في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
| [CodeBase](../../aspose.html/htmlappletelement/codebase/) { get; set; } | URI أساسي اختياري [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) عن التطبيق الصغير. راجع تعريف سمة قاعدة البيانات في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
...
| [Height](../../aspose.html/htmlappletelement/height/) { get; set; } | تجاوز الارتفاع. راجع تعريف سمة الارتفاع في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
| [Hspace](../../aspose.html/htmlappletelement/hspace/) { get; set; } | مسافة أفقية ، بالبكسل ، على يسار ويمين هذه الصورة ، صغيرة ، أو كائن. راجع تعريف سمة hspace في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. @ الإصدار DOM المستوى 2 |
...
| [Name](../../aspose.html/htmlappletelement/name/) { get; set; } | اسم التطبيق الصغير. راجع تعريف سمة الاسم في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
...
| [Object](../../aspose.html/htmlappletelement/object/) { get; set; } | قيمة سمة "الكائن". انظر تعريف سمة الكائن في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. @ إصدار DOM المستوى 2 |
...
| [Vspace](../../aspose.html/htmlappletelement/vspace/) { get; set; } | مساحة عمودية ، بالبكسل ، فوق وتحت هذه الصورة ، أو التطبيق الصغير ، أو كائن . راجع تعريف سمة vspace في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. @ الإصدار DOM المستوى 2 |
| [Width](../../aspose.html/htmlappletelement/width/) { get; set; } | تجاوز العرض. راجع تعريف سمة العرض في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
