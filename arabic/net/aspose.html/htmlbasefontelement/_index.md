...
description: Aspose.Html.HTMLBaseFontElement فصل. الخط الأساسي. راجع تعريف عنصر BASEFONT في HTML 4.01. تم إهمال هذا العنصر في HTML 4.01.
type: docs
weight: 3110
url: /ar/net/aspose.html/htmlbasefontelement/
---
## HTMLBaseFontElement class

الخط الأساسي. راجع تعريف عنصر BASEFONT في HTML 4.01. تم إهمال هذا العنصر في HTML 4.01.
...
| [Color](../../aspose.html/htmlbasefontelement/color/) { get; set; } | لون الخط. راجع تعريف سمة اللون في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
...
| [Face](../../aspose.html/htmlbasefontelement/face/) { get; set; } | معرف شكل الخط. راجع تعريف سمة الوجه في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
...
| [Size](../../aspose.html/htmlbasefontelement/size/) { get; set; } | حجم الخط المحسوب. راجع تعريف سمة الحجم في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. @ الإصدار DOM المستوى 2 |
