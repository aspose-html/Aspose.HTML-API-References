...
description: Aspose.Html.HTMLMapElement فصل. مخطط صورة من جانب العميل. راجع تعريف عنصر MAP في HTML 4.01.
type: docs
weight: 3380
url: /ar/net/aspose.html/htmlmapelement/
---
## HTMLMapElement class

مخطط صورة من جانب العميل. راجع تعريف عنصر MAP في HTML 4.01.
...
| اسم | وصف |
| --- | --- |
| [Areas](../../aspose.html/htmlmapelement/areas/) { get; } | قائمة المناطق المحددة لخريطة الصورة. |
...
| [Name](../../aspose.html/htmlmapelement/name/) { get; set; } | يسمي الخريطة (للاستخدام مع`usemap` ). راجع اسم تعريف السمة في HTML 4.01. |
