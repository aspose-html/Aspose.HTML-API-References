...
description: Aspose.Html.HTMLDataListElement فصل. يمثل عنصر البيانات مجموعة من عناصر الخيار التي تمثل خيارات محددة مسبقًا لعناصر تحكم أخرى.توصية HTML 5.2 W3C .
type: docs
weight: 3160
url: /ar/net/aspose.html/htmldatalistelement/
---
## HTMLDataListElement class

يمثل عنصر البيانات مجموعة من عناصر الخيار التي تمثل خيارات محددة مسبقًا لعناصر تحكم أخرى.[توصية HTML 5.2 W3C](https://www.w3.org/TR/html52/sec-forms.html#elementdef-datalist) .
...
| [Options](../../aspose.html/htmldatalistelement/options/) { get; } | مجموعة ملفات`خيار`العناصر التي يحتوي عليها هذا العنصر . |
