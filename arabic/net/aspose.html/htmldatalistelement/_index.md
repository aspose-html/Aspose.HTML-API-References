...
description: يمثل عنصر البيانات مجموعة من عناصر الخيار التي تمثل خيارات محددة مسبقًا لعناصر تحكم أخرى.توصية HTML 5.2 W3Chttps//www.w3.org/TR/html52/secforms.htmlelementdefdatalist .
type: docs
weight: 3150
...
| [Options](../../aspose.html/htmldatalistelement/options) { get; } | مجموعة ملفات`اختيار`العناصر التي يحتوي عليها هذا العنصر . |
