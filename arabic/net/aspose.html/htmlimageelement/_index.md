...
description: Aspose.Html.HTMLImageElement فصل. صورة مضمنة. راجع تعريف عنصر IMG في HTML 4.01.
type: docs
weight: 3310
url: /ar/net/aspose.html/htmlimageelement/
---
## HTMLImageElement class

صورة مضمنة. راجع تعريف عنصر IMG في HTML 4.01.
...
| اسم | وصف |
| --- | --- |
| [Align](../../aspose.html/htmlimageelement/align/) { get; set; } | محاذاة هذا الكائن (عموديًا أو أفقيًا) فيما يتعلق بالنص المحيط به . راجع تعريف سمة المحاذاة في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
| [Alt](../../aspose.html/htmlimageelement/alt/) { get; set; } | لا يعرض النص البديل لوكلاء المستخدم المحتوى العادي لعنصر هذا. راجع تعريف سمة النص البديل في HTML 4.01. |
...
| [Border](../../aspose.html/htmlimageelement/border/) { get; set; } | عرض الحد حول الصورة. راجع تعريف سمة الحدود في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. لاحظ أن نوع لهذه السمة كان`DOMString` في DOM المستوى 1 HTML [[DOM المستوى 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ] . |
...
| [Height](../../aspose.html/htmlimageelement/height/) { get; set; } | ارتفاع الصورة بالبكسل. راجع تعريف سمة الارتفاع في HTML 4.01. لاحظ أن نوع هذه السمة كان `DOMString` في DOM المستوى 1 HTML [[DOM المستوى 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ] . @ الإصدار DOM المستوى 2 |
| [Hspace](../../aspose.html/htmlimageelement/hspace/) { get; set; } | مسافة أفقية على يسار ويمين هذه الصورة بالبكسل. راجع تعريف السمة hspace في HTML 4.01. هذه السمة مهملة في HTML 4.01. لاحظ أن نوع هذه السمة كان `DOMString` في DOM المستوى 1 HTML [[DOM المستوى 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ] . @ الإصدار DOM المستوى 2 |
...
| [IsMap](../../aspose.html/htmlimageelement/ismap/) { get; set; } | استخدم مخطط صورة من جانب الخادم. راجع تعريف سمة ismap في HTML 4.01. |
...
| [LongDesc](../../aspose.html/htmlimageelement/longdesc/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] تعيين وصف طويل لهذه الصورة أو الإطار. راجع تعريف السمة longdesc في HTML 4.01. |
| [Name](../../aspose.html/htmlimageelement/name/) { get; set; } | اسم العنصر (للتوافق مع الإصدارات السابقة). |
...
| [Src](../../aspose.html/htmlimageelement/src/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] تحديد مصدر هذه الصورة. راجع تعريف السمة src في HTML 4.01. |
...
| [UseMap](../../aspose.html/htmlimageelement/usemap/) { get; set; } | استخدم مخطط الصورة من جانب العميل. راجع تعريف سمة خريطة المستخدم في HTML 4.01. |
| [Vspace](../../aspose.html/htmlimageelement/vspace/) { get; set; } | مسافة عمودية أعلى وأسفل هذه الصورة بالبكسل. راجع تعريف السمة vspace في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. لاحظ أن نوع هذه السمة كان "DOMString" في DOM المستوى 1 HTML [[DOM المستوى 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ] . @ الإصدار DOM المستوى 2 |
| [Width](../../aspose.html/htmlimageelement/width/) { get; set; } | عرض الصورة بالبكسل. راجع تعريف سمة العرض في HTML 4.01. لاحظ أن نوع هذه السمة كان `DOMString` في DOM المستوى 1 HTML [[DOM المستوى 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ] . @ الإصدار DOM المستوى 2 |
