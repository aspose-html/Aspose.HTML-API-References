...
description: زر ضغط. راجع تعريف عنصر BUTTON في HTML 4.01.
type: docs
weight: 3120
...
| [Form](../../aspose.html/htmlbuttonelement/form) { get; } | إرجاع ملف`شكل` عنصر يحتوي على عنصر التحكم هذا. إرجاع `لا شيء` إذا لم يكن عنصر التحكم هذا ضمن سياق نموذج . |
