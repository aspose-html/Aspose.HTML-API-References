...
description: Aspose.Html.HTMLButtonElement فصل. زر ضغط. راجع تعريف عنصر BUTTON في HTML 4.01.
type: docs
weight: 3130
url: /ar/net/aspose.html/htmlbuttonelement/
---
## HTMLButtonElement class

زر ضغط. راجع تعريف عنصر BUTTON في HTML 4.01.
...
| اسم | وصف |
| --- | --- |
| [AccessKey](../../aspose.html/htmlbuttonelement/accesskey/) { get; set; } | مفتاح وصول ذو حرف واحد لمنح حق الوصول إلى عنصر التحكم في النموذج. راجع تعريف سمة مفتاح الوصول في HTML 4.01. |
...
| [Disabled](../../aspose.html/htmlbuttonelement/disabled/) { get; set; } | عنصر التحكم غير متوفر في هذا السياق. راجع تعريف السمة المعطلة في HTML 4.01. |
...
| [Form](../../aspose.html/htmlbuttonelement/form/) { get; } | إرجاع ملف`استمارة` عنصر يحتوي على عنصر التحكم هذا. إرجاع `باطل` إذا لم يكن عنصر التحكم هذا ضمن سياق نموذج . |
...
| [Name](../../aspose.html/htmlbuttonelement/name/) { get; set; } | عنصر تحكم النموذج أو اسم الكائن عند إرساله مع نموذج. راجع اسم تعريف السمة في HTML 4.01. |
...
| [TabIndex](../../aspose.html/htmlbuttonelement/tabindex/) { get; set; } | الفهرس الذي يمثل موضع العنصر في ترتيب الجدولة. راجع تعريف السمة tabindex في HTML 4.01. |
...
| [Type](../../aspose.html/htmlbuttonelement/type/) { get; set; } | نوع الزر (كل الأحرف الصغيرة). راجع تعريف سمة النوع في HTML 4.01. |
| [Value](../../aspose.html/htmlbuttonelement/value/) { get; set; } | قيمة عنصر التحكم في النموذج الحالي. راجع تعريف سمة القيمة في HTML 4.01. |
