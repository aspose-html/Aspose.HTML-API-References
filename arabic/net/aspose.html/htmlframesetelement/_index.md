...
description: Aspose.Html.HTMLFrameSetElement فصل. إنشاء شبكة من الإطارات. راجع تعريف عنصر FRAMESET في HTML 4.01.
type: docs
weight: 3250
url: /ar/net/aspose.html/htmlframesetelement/
---
## HTMLFrameSetElement class

إنشاء شبكة من الإطارات. راجع تعريف عنصر FRAMESET في HTML 4.01.
...
| [Cols](../../aspose.html/htmlframesetelement/cols/) { get; set; } | عدد أعمدة الإطارات في مجموعة الإطارات. انظر تعريف السمة cols في HTML 4.01. |
...
| [Rows](../../aspose.html/htmlframesetelement/rows/) { get; set; } | عدد صفوف الإطارات في مجموعة الإطارات. راجع تعريف الصفوف في HTML 4.01. |
