...
description: Aspose.Html.HTMLBRElement فصل. فرض فاصل سطر. راجع تعريف عنصر BR في HTML 4.01.
type: docs
weight: 3090
url: /ar/net/aspose.html/htmlbrelement/
---
## HTMLBRElement class

فرض فاصل سطر. راجع تعريف عنصر BR في HTML 4.01.
...
| [Clear](../../aspose.html/htmlbrelement/clear/) { get; set; } | التحكم في تدفق النص حول العوامات. راجع تعريف السمة الواضح في HTML 4.01. تم إهمال هذه السمة في HTML 4.01. |
