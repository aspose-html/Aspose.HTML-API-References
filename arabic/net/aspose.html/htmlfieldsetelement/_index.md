...
description: ينظم عناصر التحكم في النموذج في مجموعات منطقية. راجع تعريف عنصر FIELDSET في HTML 4.01.
type: docs
weight: 3200
...
| [Form](../../aspose.html/htmlfieldsetelement/form) { get; } | إرجاع ملف`شكل` عنصر يحتوي على عنصر التحكم هذا. إرجاع `لا شيء` إذا لم يكن عنصر التحكم هذا ضمن سياق نموذج . |
