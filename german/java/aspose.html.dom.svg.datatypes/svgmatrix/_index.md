...
description: "com.aspose.html.dom.svg.datatypes.SVGMatrix Klasse. Viele der SVG-Grafikoperationen verwenden 2x3-Matrizen der Form a c e b d f, die bei Erweiterung zu einer 3x3-Matrix für die Zwecke der Matrixarithmetik zu a c e b d f 0 0 1 werden."
type: docs
...
| [scale](../../com.aspose.html.dom.svg.datatypes/svgmatrix/scale/)(float) | Post-multipliziert eine gleichmäßige Skalierungstransformation auf die aktuelle Matrix und gibt die resultierende Matrix zurück. |
| [scaleNonUniform](../../com.aspose.html.dom.svg.datatypes/svgmatrix/scalenonuniform/)(float, float) | Post-multipliziert eine nicht-gleichmäßige Skalierungstransformation auf die aktuelle Matrix und gibt die resultierende Matrix zurück. |
| [skewX](../../com.aspose.html.dom.svg.datatypes/svgmatrix/skewx/)(float) | Multipliziert eine skewX-Transformation nachträglich mit der aktuellen Matrix und gibt die resultierende Matrix zurück. |
| [skewY](../../com.aspose.html.dom.svg.datatypes/svgmatrix/skewy/)(float) | Multipliziert eine skewY-Transformation nachträglich mit der aktuellen Matrix und gibt die resultierende Matrix zurück. |
| [toString](../../com.aspose.html.dom.svg.datatypes/svgmatrix/toString/)() | Gibt einen String zurück, der diese Instanz darstellt. |
| [translate](../../com.aspose.html.dom.svg.datatypes/svgmatrix/translate/)(float, float) | Multipliziert eine translation-Transformation nachträglich mit der aktuellen Matrix und gibt die resultierende Matrix zurück. |
