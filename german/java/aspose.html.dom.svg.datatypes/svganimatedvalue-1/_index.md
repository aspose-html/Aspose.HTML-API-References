...
description: "com.aspose.html.dom.svg.datatypes.SVGAnimatedValue1T Klasse. Wird für Attribute von Typen verwendet, die animiert werden können."
type: docs

url: /de/java/com.aspose.html.dom.svg.datatypes/svganimatedvalue-1/
---
...
| --- | --- |
| T | Das SVG-Wert-Objekt. |

## Eigenschaften

| Name | Beschreibung |
| --- | --- |
| [getAnimVal](../../com.aspose.html.dom.svg.datatypes/svganimatedvalue-1/animval/) Wenn das angegebene Attribut oder die Eigenschaft animiert wird, enthält es den aktuellen animierten Wert des Attributs oder der Eigenschaft. Wenn das angegebene Attribut oder die Eigenschaft derzeit nicht animiert wird, enthält es denselben Wert wie baseVal. |
[getBaseVal]
