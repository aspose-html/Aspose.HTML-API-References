...
url: /de/java/com.aspose.html.rendering.pdf/pdfdevice/pdfdevice/
---
...
Erstellt eine neue Instanz der [`PdfDevice`](../)-Klasse anhand von Rendering-Optionen und Stream-Provider.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Optionen | PdfRenderingOptions | Renderoptionen. |
...
Erstellt eine neue Instanz der [`PdfDevice`](../)-Klasse anhand von Rendering-Optionen und Ausgabedateinamen.
...
Erstellt eine neue Instanz der [`PdfDevice`](../)-Klasse anhand von Rendering-Optionen und Ausgabestream.
