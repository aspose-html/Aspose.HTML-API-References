...
Die ValidationBuilder‑Klasse liefert konkrete Implementierungen der Konfigurationsschritte. Sie definiert Methoden und Einstellungen für die Klasse ValidationSettings.
...
| static [getDefault](../../com.aspose.html.accessibility/validationbuilder/default/) Standard-Einstellungen: Es werden nur allgemeine Technologien verwendet und für das niedrigste Kriteriumsniveau. |
...
| Name | Beschreibung |
| --- | --- |
| [allLevels](../../com.aspose.html.accessibility/validationbuilder/alllevels/)() | Eine Methode, die alle Kriteriumsebenen festlegt. Und anzeigt, dass das Dokument gemäß den Kriterien aller drei Ebenen geprüft wird. |
| [allTechnologies](../../com.aspose.html.accessibility/validationbuilder/alltechnologies/)() | Eine Methode, die alle Technologien zum Testkriterium festlegt. |
| [setHTMLTags](../../com.aspose.html.accessibility/validationbuilder/sethtmltags/)(params String[]) | Liste der zu prüfenden HTML-Tags. Wenn die Tags nicht explizit angegeben sind, ist das Tag-Array leer und die Prüfung wird für alle durchgeführt. |
