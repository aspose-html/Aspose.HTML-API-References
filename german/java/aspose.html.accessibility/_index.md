...
description: "Das Paket com.aspose.html.accessibility dient allen Web-Accessibility-bezogenen Manipulationen. Es entspricht den internationalen Standards der W3C Web Accessibility Initiative."
type: docs
...
| [Principle](./principle/) | Barrierefreiheitsprinzip – Die höchsten Ebenen, die die Grundlage der Web-Accessibility bilden, enthalten eine Liste von Richtlinien vom Typ RuleCollection{Guideline}. Das Objekt darf nicht außerhalb der Assembly erstellt werden. https://www.w3.org/WAI/fundamentals/accessibility-principles/ |
| [Rule](./rule/) | Eine abstrakte Klasse, die die Merkmale einer Regel definiert und das Interface IRule implementiert. |
| [Target](./target/) | Die Klasse enthält das Element (HTML oder CSS), in dem der Fehler gefunden wurde. |
| [ValidationBuilder](./validationbuilder/) | Die ValidationBuilder‑Klasse liefert konkrete Implementierungen der Konfigurationsschritte. Sie definiert Methoden und Einstellungen für die Klasse ValidationSettings. |
