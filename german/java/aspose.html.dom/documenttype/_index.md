...
description: "com.aspose.html.dom.DocumentType Klasse. Der DocumentType bietet eine Schnittstelle zur Liste der Entitäten, die für das Dokument definiert sind."
type: docs

url: /de/java/com.aspose.html.dom/documenttype/
---
## DocumentType class

Der DocumentType stellt eine Schnittstelle zur Liste der für das Dokument definierten Entitäten bereit.
...
| Name | Beschreibung |
| --- | --- |
| [DocumentType](documenttype/)(String, String, String, String, Document) | Initialisiert eine neue Instanz der `DocumentType` Klasse. |
...
| [getInternalSubset](../../com.aspose.html.dom/documenttype/internalsubset/) Das interne Subset als String, oder null, falls keines vorhanden ist. |
...
| [getName](../../com.aspose.html.dom/documenttype/name/) Der Name des DTD; d.h., der Name, der unmittelbar nach dem Schlüsselwort DOCTYPE folgt. |
...
| [getNodeName](../../com.aspose.html.dom/documenttype/nodename/) Der Name dieses Knotens, abhängig von seinem Typ. |
| [getNodeType](../../com.aspose.html.dom/documenttype/nodetype/) Ein Code, der den Typ des zugrunde liegenden Objekts darstellt. |
...
| [getPublicId](../../com.aspose.html.dom/documenttype/publicid/) Der öffentliche Bezeichner des externen Subsets. |
| [getSystemId](../../com.aspose.html.dom/documenttype/systemid/) Der Systembezeichner des externen Subsets. Dies kann ein absoluter URI sein oder nicht. |
...
| [toString](../../com.aspose.html.dom/documenttype/toString/)() | Gibt einen String zurück, der diese Instanz darstellt. |
