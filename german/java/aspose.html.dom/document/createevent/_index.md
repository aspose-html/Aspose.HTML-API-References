...
description: "Document-Methode. Erstellt ein Event eines Typs, der von der Implementierung unterstützt wird."
type: docs
...
| --- | --- | --- |
| eventType | String | Der Parameter eventType gibt den Typ der zu erstellenden [`Event`](../../../com.aspose.html.dom.events/event/)-Schnittstelle an. Wenn die angegebene [`Event`](../../../com.aspose.html.dom.events/event/)-Schnittstelle von der Implementierung unterstützt wird, gibt diese Methode ein neues [`Event`](../../../com.aspose.html.dom.events/event/) des angeforderten Schnittstellentyps zurück. Wenn das [`Event`](../../../com.aspose.html.dom.events/event/) über die Methode [`DispatchEvent`](../../../com.aspose.html.dom.events/ieventtarget/dispatchevent/) gesendet werden soll, muss nach der Erstellung die entsprechende [`InitEvent`](../../../com.aspose.html.dom.events/event/initevent/)-Methode aufgerufen werden, um die Werte des [`Event`](../../../com.aspose.html.dom.events/event/) zu initialisieren. |
