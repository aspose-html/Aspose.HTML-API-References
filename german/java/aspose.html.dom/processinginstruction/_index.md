...
description: "com.aspose.html.dom.ProcessingInstruction Klasse. Die ProcessingInstruction stellt eine Verarbeitungsanweisung dar, die in XML verwendet wird, um prozessor-spezifische Informationen im Text des Dokuments zu speichern"
type: docs

url: /de/java/com.aspose.html.dom/processinginstruction/
---
## ProcessingInstruction class

Die ProcessingInstruction stellt eine „Verarbeitungsanweisung“ dar, die in XML verwendet wird, um prozessor-spezifische Informationen im Text des Dokuments zu speichern.
...
| [getNodeName](../../com.aspose.html.dom/processinginstruction/nodename/) Der Name dieses Knotens, abhängig von seinem Typ. |
| [getNodeType](../../com.aspose.html.dom/processinginstruction/nodetype/) Ein Code, der den Typ des zugrunde liegenden Objekts darstellt. |
| [nodeValue](../../com.aspose.html.dom/processinginstruction/nodevalue/) { get; set; } | Der Wert dieses Knotens, abhängig von seinem Typ. |
...
| [getTarget](../../com.aspose.html.dom/processinginstruction/target/) Das Ziel dieser Verarbeitungsanweisung. |
...
| [normalize](../../com.aspose.html.dom/node/normalize/)() | Setzt alle [`Text`](../text/)‑Knoten in der vollen Tiefe des Unterbaums unterhalb dieses Knotens, einschließlich Attributknoten, in eine "normale" Form, bei der nur die Struktur (z. B. [`elements`](../element/), [`comments`](../comment/), `processing instructions`, [`CDATA sections`](../cdatasection/) und [`entity references`](../entityreference/)) die [`Text`](../text/)‑Knoten trennt, d. h. es gibt weder benachbarte Textknoten noch leere Textknoten. Dies kann verwendet werden, um sicherzustellen, dass die DOM‑Ansicht eines Dokuments dieselbe ist, als wäre es gespeichert und erneut geladen worden, und ist nützlich, wenn Operationen (wie XPointer‑[XPointer]‑Nachschlagen), die von einer bestimmten Dokumentbaumstruktur abhängen, verwendet werden sollen. Wenn der Parameter "normalize-characters" des [`DOMConfiguration`](../../com.aspose.html/configuration/)‑Objekts, das an das [`Node.ownerDocument`](../node/ownerdocument/) angehängt ist, wahr ist, normalisiert diese Methode auch vollständig die Zeichen der Textknoten. |
