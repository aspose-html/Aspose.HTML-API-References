...
description: "com.aspose.html.dom.IStorage Interface. Dieses Interface der Web Storage API bietet Zugriff auf die Sitzungs- oder lokalen Speicher eines bestimmten Domänen. Siehe Web Storage Spezifikation https//html.spec.whatwg.org/multipage/webstorage.htmlwebstorage"
type: docs
...
Dieses Interface der Web‑Storage‑API bietet Zugriff auf den Sitzungs‑ oder lokalen Speicher einer bestimmten Domain. Siehe die Web‑Storage‑Spezifikation: [https://html.spec.whatwg.org/multipage/webstorage.html#webstorage](https://html.spec.whatwg.org/multipage/webstorage.html#webstorage)
