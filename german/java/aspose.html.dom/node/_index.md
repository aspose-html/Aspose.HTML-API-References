...
Die Attribute [`nodeName`](./nodename/), [`nodeValue`](./nodevalue/) und weitere Attribute sind als Mechanismus enthalten, um auf Knoteninformationen zuzugreifen, ohne auf die spezifische abgeleitete Schnittstelle zu casten. In Fällen, in denen es keine offensichtliche Zuordnung dieser Attribute für einen bestimmten [`nodeType`](./nodetype/) gibt (z. B. nodeValue für ein [`Element`](../element/) oder attributes für einen [`Comment`](../comment/)), gibt dies null zurück. Beachten Sie, dass die spezialisierten Schnittstellen zusätzliche und bequemere Mechanismen zum Abrufen und Setzen der relevanten Informationen enthalten können.
...
| abstract [getNodeType](../../com.aspose.html.dom/node/nodetype/) Ein Code, der den Typ des zugrunde liegenden Objekts repräsentiert. |
...
| [hasChildNodes](../../com.aspose.html.dom/node/haschildnodes/)() | Die Methode hasChildNodes() der Node‑Schnittstelle gibt einen booleschen Wert zurück, der angibt, ob der gegebene `Node` Kindknoten hat oder nicht. |
...
| [isEqualNode](../../com.aspose.html.dom/node/isequalnode/)(Node) | Die Methode isEqualNode() der `Node`‑Schnittstelle prüft, ob zwei Knoten gleich sind. Zwei Knoten sind gleich, wenn sie denselben Typ, dieselben definierenden Merkmale (bei Elementen wären das ihre ID, die Anzahl der Kinder usw.), ihre Attribute übereinstimmen usw. Der genaue Satz von Datenpunkten, die übereinstimmen müssen, variiert je nach Knotentyp. |
...
| const [CDATA_SECTION_NODE](../../com.aspose.html.dom/node/cdata_section_node/) | Eine [`CDATASection`](../cdatasection/), z. B. &lt;!CDATA[[ … ]]&gt;. |
| const [COMMENT_NODE](../../com.aspose.html.dom/node/comment_node/) | Ein [`Comment`](../comment/)‑Knoten, z. B. &lt;!-- … --&gt;. |
...
| const [DOCUMENT_TYPE_NODE](../../com.aspose.html.dom/node/document_type_node/) | Ein [`DocumentType`](../documenttype/)‑Knoten, z. B. &lt;!DOCTYPE html&gt;. |
...
| const [TEXT_NODE](../../com.aspose.html.dom/node/text_node/) | Der tatsächliche [`Text`](../text/) innerhalb eines [`Element`](../element/) oder [`Attr`](../attr/). |
