...
description: "Node-Eigenschaft. Die schreibgeschützte parentNode‑Eigenschaft des Node-Interfaces gibt den Elternknoten des angegebenen Knotens im DOM‑Baum zurück."
type: docs
...
Die schreibgeschützte parentNode‑Eigenschaft des Node-Interfaces gibt den Elternknoten des angegebenen Knotens im DOM‑Baum zurück.
...
Ein Node, der das Elternteil des aktuellen Knotens ist. Das Elternteil eines Elements ist ein [`Element`](../../element/)-Knoten, ein [`Document`](../../document/)-Knoten oder ein [`DocumentFragment`](../../documentfragment/)-Knoten.
