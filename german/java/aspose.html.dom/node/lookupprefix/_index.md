...
Die lookupPrefix()-Methode des Node-Interface gibt einen String zurück, der das Präfix für einen angegebenen Package‑URI enthält, falls vorhanden, andernfalls null. Wenn mehrere Präfixe möglich sind, wird das erste Präfix zurückgegeben.
...
Ist der Knoten ein [`DocumentType`](../../documenttype/) oder ein [`DocumentFragment`](../../documentfragment/), gibt lookupPrefix() stets null zurück.
