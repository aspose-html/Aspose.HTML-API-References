...
Wenn der angegebene Knoten bereits im Dokument existiert, verschiebt insertBefore() ihn von seiner aktuellen Position zur neuen Position. (Das heißt, er wird automatisch aus seinem bestehenden Elternknoten entfernt, bevor er an den angegebenen neuen Elternknoten angehängt wird.)
...
| Kind | Node | Der Knoten, vor dem newNode eingefügt wird. Ist dieser null, wird newNode am Ende der Kindknoten von node eingefügt. |
