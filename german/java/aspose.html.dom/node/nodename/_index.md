...
description: "Node-Eigenschaft. Die schreibgeschützte nodeName-Eigenschaft von Node gibt den Namen des aktuellen Knotens als String zurück."
type: docs

url: /de/java/com.aspose.html.dom/node/nodename/
---
## Node.NodeName property

Die schreibgeschützte nodeName-Eigenschaft von Node gibt den Namen des aktuellen Knotens als String zurück.
...
Ein String, Werte für die verschiedenen Knotentypen sind:
