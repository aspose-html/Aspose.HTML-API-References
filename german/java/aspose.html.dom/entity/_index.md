...
Stellt eine bekannte Entität dar, die entweder geparst oder ungeparst ist, in einem XML-Dokument.
...
| [getInputEncoding](../../com.aspose.html.dom/entity/inputencoding/) Ein Attribut, das die beim Parsen verwendete Kodierung für diese Entität angibt, wenn es sich um eine externe geparste Entität handelt. Dies ist null, wenn es sich um eine Entität aus dem internen Subset handelt oder wenn sie nicht bekannt ist. |
...
| [getNotationName](../../com.aspose.html.dom/entity/notationname/) Für ungeparste Entitäten der Name der Notation für die Entität. Für geparste Entitäten ist dies null. |
...
| [getPublicId](../../com.aspose.html.dom/entity/publicid/) Der öffentliche Bezeichner, der mit der Entität verknüpft ist, falls angegeben, sonst null. |
| [getSystemId](../../com.aspose.html.dom/entity/systemid/) Der Systembezeichner, der mit der Entität verknüpft ist, falls angegeben, sonst null. Dies kann ein absoluter URI sein oder nicht. |
...
| [getXmlEncoding](../../com.aspose.html.dom/entity/xmlencoding/) Ein Attribut, das als Teil der Textdeklaration die Kodierung dieser Entität angibt, wenn es sich um eine externe geparste Entität handelt. Andernfalls ist dies null. |
| [getXmlVersion](../../com.aspose.html.dom/entity/xmlversion/) Ein Attribut, das als Teil der Textdeklaration die Versionsnummer dieser Entität angibt, wenn es sich um eine externe geparste Entität handelt. Andernfalls ist dies null. |
