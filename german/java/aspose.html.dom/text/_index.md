...
description: "com.aspose.html.dom.Text‑Klasse. Das Text‑Interface erbt von CharacterData und stellt den textuellen Inhalt, der in XML als CharacterData eines Elements oder Attributs bezeichnet wird, dar."
type: docs
...
| [getIsElementContentWhitespace](../../com.aspose.html.dom/text/iselementcontentwhitespace/) Gibt zurück, ob dieser Textknoten Element‑Inhalts‑Whitespace enthält, oft missbräuchlich "ignorierbarer Whitespace" genannt. |
...
| [getNodeType](../../com.aspose.html.dom/text/nodetype/) Ein Code, der den Typ des zugrunde liegenden Objekts darstellt. |
...
| [splitText](../../com.aspose.html.dom/text/splittext/)(int) | Teilt diesen Knoten an der angegebenen Position in zwei Knoten und behält beide als Geschwister im Baum. |
