...
description: "Element-Methode. Gibt ein HTMLCollection-Objekt zurück, das alle Elemente mit einem angegebenen Tag-Namen in Dokumentreihenfolge enthält."
type: docs
...
Gibt ein [`HTMLCollection`](../../../com.aspose.html.collections/htmlcollection/)‑Objekt zurück, das alle [`elements`](../) mit einem angegebenen Tag-Namen in Dokumentreihenfolge enthält.
...
| --- | --- | --- |
| name | String | Der Tag-Name. String‑Darstellung des Tag-Namens. |
