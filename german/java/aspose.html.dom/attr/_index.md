...
description: "com.aspose.html.dom.Attr Klasse. Das Attr-Interface stellt ein Attribut in einem Element-Objekt dar. Typischerweise werden die zulässigen Werte für das Attribut in einem dem Dokument zugeordneten Schema definiert."
type: docs

url: /de/java/com.aspose.html.dom/attr/
---
## Attr class

Die Attr‑Schnittstelle repräsentiert ein Attribut in einem Element‑Objekt. Typischerweise werden die zulässigen Werte für das Attribut in einem mit dem Dokument verbundenen Schema definiert.
...
| [getLocalName](../../com.aspose.html.dom/attr/localname/) Gibt den lokalen Teil des qualifizierten Namens dieses Knotens zurück. Für Knoten jeglichen Typs außer ELEMENT_NODE und ATTRIBUTE_NODE sowie für mit einer DOM‑Level‑1‑Methode erstellte Knoten, wie Document.createElement(), ist dies stets null. |
| [getName](../../com.aspose.html.dom/attr/name/) Gibt den Namen dieses Attributs zurück. |
| [getNamespaceURI](../../com.aspose.html.dom/attr/packageuri/) Die Paket‑URI dieses Knotens, oder null, wenn sie nicht angegeben ist. |
...
| [getNodeName](../../com.aspose.html.dom/attr/nodename/) Der Name dieses Knotens, abhängig von seinem Typ. |
| [getNodeType](../../com.aspose.html.dom/attr/nodetype/) Ein Code, der den Typ des zugrunde liegenden Objekts darstellt. |
| [nodeValue](../../com.aspose.html.dom/attr/nodevalue/) { get; set; } | Der Wert dieses Knotens, abhängig von seinem Typ. |
...
| [getOwnerElement](../../com.aspose.html.dom/attr/ownerelement/) Der Element‑Knoten, an den dieses Attribut angehängt ist, oder null, wenn das Attribut nicht verwendet wird. |
...
| [getPrefix](../../com.aspose.html.dom/attr/prefix/) Das Paket‑Präfix dieses Knotens, oder null, wenn es nicht angegeben ist. Wenn es auf null gesetzt ist, hat das Setzen keine Wirkung. |
...
| [getSpecified](../../com.aspose.html.dom/attr/specified/) Wahr, wenn diesem Attribut im Instanzdokument explizit ein Wert zugewiesen wurde, andernfalls falsch. |
| [textContent](../../com.aspose.html.dom/attr/textcontent/) { get; set; } | Dieses Attribut gibt den Textinhalt dieses Knotens und seiner Nachkommen zurück. Wenn es auf null gesetzt ist, hat das Setzen keine Wirkung. Beim Setzen werden alle möglichen Kindknoten dieses Knotens entfernt und, falls die neue Zeichenkette nicht leer oder null ist, durch einen einzelnen Textknoten ersetzt, der die Zeichenkette enthält, auf die dieses Attribut gesetzt wird. |
[getValue]
