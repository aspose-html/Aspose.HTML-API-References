...
description: "com.aspose.html.HTMLInputElement Klasse. Formularelement. Je nach Umgebung, in der die Seite angezeigt wird, kann die Eigenschaft value für den Dateiupload‑Eingabetyp schreibgeschützt sein. Für den Passwort‑Eingabetyp kann der tatsächlich zurückgegebene Wert maskiert sein, um unbefugte Nutzung zu verhindern. Siehe die Definition des INPUT‑Elements in HTML 4.01. Siehe außerdem die Document Object Model DOM Level 2 HTML‑Spezifikation"
type: docs

url: /de/java/com.aspose.html/htmlinputelement/
---
## HTMLInputElement class

Formularsteuerelement. Je nach Umgebung, in der die Seite angezeigt wird, kann die Eigenschaft value für den Dateiupload‑Eingabetyp schreibgeschützt sein. Beim Eingabetyp "password" kann der tatsächlich zurückgegebene Wert maskiert werden, um unbefugte Nutzung zu verhindern. Siehe die Definition des INPUT-Elements in [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224)]. Siehe außerdem die [Document object Model (DOM) Level 2 HTML Specification](http://www.w3.org/TR/2003/REC-DOM-Level-2-HTML-20030109).
...
| [getFiles](../../com.aspose.html/htmlinputelement/files/) Das IDL‑Attribut files ermöglicht Skripten den Zugriff auf die vom Element ausgewählten Dateien. Beim Abrufen muss, falls das IDL‑Attribut zutrifft, ein FileList‑Objekt zurückgegeben werden, das die aktuell ausgewählten Dateien darstellt. Dasselbe Objekt muss zurückgegeben werden, bis sich die Liste der ausgewählten Dateien ändert. Falls das IDL‑Attribut nicht zutrifft, muss stattdessen null zurückgegeben werden. [FILEAPI] |
