...
Formularsteuerelement. Je nach Umgebung, in der die Seite angezeigt wird, kann die Eigenschaft value für den Dateiupload‑Input‑Typ schreibgeschützt sein. Für den Eingabetyp "password" kann der tatsächlich zurückgegebene Wert maskiert sein, um unbefugte Nutzung zu verhindern. Siehe die Definition des INPUT-Elements in [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224)]. Siehe auch die [Document object Model (DOM) Level 2 HTML Specification](http://www.w3.org/TR/2003/REC-DOM-Level-2-HTML-20030109).
...
| [getFiles](../../com.aspose.html/htmlinputelement/files/) Das files IDL-Attribut ermöglicht Skripten den Zugriff auf die ausgewählten Dateien des Elements. Beim Abrufen muss, falls das IDL-Attribut zutrifft, ein FileList‑Objekt zurückgegeben werden, das die aktuell ausgewählten Dateien darstellt. Dasselbe Objekt muss zurückgegeben werden, bis sich die Liste der ausgewählten Dateien ändert. Wenn das IDL-Attribut nicht zutrifft, muss stattdessen null zurückgegeben werden. [FILEAPI] |
