...
| --- | --- | --- |
| index | Int32 | Der Index der zu löschenden Zeile, oder -1, um die letzte Zeile zu löschen. Dieser Index beginnt bei 0 und bezieht sich nur auf die Zeilen, die in diesem Abschnitt enthalten sind, nicht auf alle Zeilen in der Tabelle. |
