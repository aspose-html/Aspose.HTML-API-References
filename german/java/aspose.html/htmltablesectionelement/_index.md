...
description: "com.aspose.html.HTMLTableSectionElement Klasse. Die THEAD-, TFOOT- und TBODY‑Elemente"
type: docs

url: /de/java/com.aspose.html/htmltablesectionelement/
---
## HTMLTableSectionElement class

Die `THEAD`-, `TFOOT`- und `TBODY`-Elemente.
...
| [getRows](../../com.aspose.html/htmltablesectionelement/rows/) Die Sammlung von Zeilen in diesem Tabellenabschnitt. |
...
| [deleteRow](../../com.aspose.html/htmltablesectionelement/deleterow/)(int) | Lösche eine Zeile aus diesem Abschnitt. |
...
| [insertRow](../../com.aspose.html/htmltablesectionelement/insertrow/)(int) | Füge eine Zeile in diesen Abschnitt ein. Die neue Zeile wird unmittelbar vor der aktuellen `index`‑ten Zeile in diesem Abschnitt eingefügt. Wenn `index` -1 ist oder der Anzahl der Zeilen in diesem Abschnitt entspricht, wird die neue Zeile angehängt. |
