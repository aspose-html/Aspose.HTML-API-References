...
| [getRows](../../com.aspose.html/htmltablesectionelement/rows/) Die Sammlung von Zeilen in diesem Tabellensektion. |
...
| [insertRow](../../com.aspose.html/htmltablesectionelement/insertrow/)(int) | Füge eine Zeile in diesen Abschnitt ein. Die neue Zeile wird sofort vor der aktuellen `index`‑ten Zeile in diesem Abschnitt eingefügt. Wenn `index` -1 ist oder gleich der Anzahl der Zeilen in diesem Abschnitt, wird die neue Zeile angehängt. |
