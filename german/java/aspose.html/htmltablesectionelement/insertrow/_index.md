...
Füge eine Zeile in diesen Abschnitt ein. Die neue Zeile wird unmittelbar vor der aktuellen `index`‑ten Zeile in diesem Abschnitt eingefügt. Wenn `index` -1 ist oder der Anzahl der Zeilen in diesem Abschnitt entspricht, wird die neue Zeile angehängt.
...
| --- | --- | --- |
| index | Int32 | Die Zeilennummer, an der eine neue Zeile eingefügt werden soll. Dieser Index beginnt bei 0 und bezieht sich nur auf die Zeilen, die in diesem Abschnitt enthalten sind, nicht auf alle Zeilen in der Tabelle. |
