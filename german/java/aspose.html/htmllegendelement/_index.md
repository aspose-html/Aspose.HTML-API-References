...
description: "com.aspose.html.HTMLLegendElement Klasse. Stellt eine Beschriftung für eine FIELDSET‑Gruppe bereit. Siehe die Definition des LEGEND-Elements in HTML 4.01"
type: docs

url: /de/java/com.aspose.html/htmllegendelement/
---
## HTMLLegendElement class

Stellt eine Beschriftung für eine `FIELDSET`‑Gruppe bereit. Siehe die Definition des LEGEND-Elements in HTML 4.01.
...
| [getForm](../../com.aspose.html/htmllegendelement/form/) Gibt das `FORM`‑Element zurück, das diese Steuerung enthält. Gibt `null` zurück, wenn diese Steuerung nicht im Kontext eines Formulars ist. |
[getId]
