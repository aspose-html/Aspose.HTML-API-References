...
description: "com.aspose.html.HTMLTableColElement Klasse. Gruppiert die COL- und COLGROUP-Elemente neu. Siehe die COL-Elementdefinition in HTML 4.01"
type: docs

url: /de/java/com.aspose.html/htmltablecolelement/
---
## HTMLTableColElement class

Gruppiert die `COL`- und `COLGROUP`-Elemente neu. Siehe die COL-Elementdefinition in HTML 4.01.
