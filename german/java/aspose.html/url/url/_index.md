...
url: /de/java/com.aspose.html/url/url/
---
...
| Ausnahme | Bedingung |
| --- | --- |
| Fehler | TypeError: ausgelöst, wenn `url` nicht als gültige URL geparst werden kann. |
...
| Ausnahme | Bedingung |
| --- | --- |
| Fehler | TypeError: ausgelöst, wenn `url` oder `baseUrl` nicht als gültige URL geparst werden können. |
