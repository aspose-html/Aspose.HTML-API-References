...
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl)() | gibt eine Daten-URI zurück, die eine Darstellung des Bildes im durch den Typ-Parameter angegebenen Format enthält (standardmäßig PNG). Das zurückgegebene Bild hat eine Auflösung von 96 dpi. |
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl_1)(String) | gibt eine Daten-URI zurück, die eine Darstellung des Bildes im durch den Typ-Parameter angegebenen Format enthält (standardmäßig PNG). Das zurückgegebene Bild hat eine Auflösung von 96 dpi. |
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl_2)(String, double) | gibt eine Daten-URI zurück, die eine Darstellung des Bildes im durch den Typ-Parameter angegebenen Format enthält (standardmäßig PNG). Das zurückgegebene Bild hat eine Auflösung von 96 dpi. |
