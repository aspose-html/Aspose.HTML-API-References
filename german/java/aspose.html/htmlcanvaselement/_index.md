...
description: "com.aspose.html.HTMLCanvasElement Klasse. Das HTMLCanvasElement-Interface bietet Eigenschaften und Methoden zur Manipulation von Layout und Darstellung von Canvas-Elementen. Das HTMLCanvasElement-Interface erbt außerdem die Eigenschaften und Methoden des HTMLElement-Interfaces"
type: docs

url: /de/java/com.aspose.html/htmlcanvaselement/
---
## HTMLCanvasElement class

Das HTMLCanvasElement-Interface stellt Eigenschaften und Methoden zum Manipulieren des Layouts und der Darstellung von Canvas-Elementen bereit. Das HTMLCanvasElement-Interface erbt außerdem die Eigenschaften und Methoden des HTMLElement-Interfaces.
...
| [getContext](../../com.aspose.html/htmlcanvaselement/getcontext/)(String) | Gibt einen Zeichenkontext für das Canvas zurück, oder null, wenn die Kontext-ID nicht unterstützt wird. Ein Zeichenkontext ermöglicht das Zeichnen auf dem Canvas. |
...
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl)() | gibt eine Daten-URI zurück, die eine Darstellung des Bildes im durch den Typ-Parameter angegebenen Format enthält (Standard ist PNG). Das zurückgegebene Bild hat eine Auflösung von 96 dpi. |
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl_1)(String) | gibt eine Daten-URI zurück, die eine Darstellung des Bildes im durch den Typ-Parameter angegebenen Format enthält (Standard ist PNG). Das zurückgegebene Bild hat eine Auflösung von 96 dpi. |
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl_2)(String, double) | gibt eine Daten-URI zurück, die eine Darstellung des Bildes im durch den Typ-Parameter angegebenen Format enthält (Standard ist PNG). Das zurückgegebene Bild hat eine Auflösung von 96 dpi. |
