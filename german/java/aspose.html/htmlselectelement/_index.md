...
description: "com.aspose.html.HTMLSelectElement Klasse. Das select-Element ermöglicht die Auswahl einer Option. Die enthaltenen Optionen können direkt über das select-Element als Sammlung zugegriffen werden. Siehe die SELECT-Elementdefinition in HTML 4.01"
type: docs

url: /de/java/com.aspose.html/htmlselectelement/
---
## HTMLSelectElement class

Das select-Element ermöglicht die Auswahl einer Option. Die enthaltenen Optionen können direkt über das select-Element als Sammlung zugegriffen werden. Siehe die SELECT-Elementdefinition in HTML 4.01.
...
| [getForm](../../com.aspose.html/htmlselectelement/form/) Die Anzahl der Optionen in diesem `SELECT`. |
[getId]
...
| [getOptions](../../com.aspose.html/htmlselectelement/options/) Die Sammlung der `OPTION`-Elemente, die von diesem Element enthalten sind. @version DOM Level 2 |
[getOuterHTML]
...
| [getType](../../com.aspose.html/htmlselectelement/type/) Der Typ dieser Form-Steuerung. Dies ist die Zeichenkette "select-multiple", wenn das multiple-Attribut `true` ist, und die Zeichenkette "select-one", wenn `false`. |
[getValue]
