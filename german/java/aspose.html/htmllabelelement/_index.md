...
description: "com.aspose.html.HTMLLabelElement Klasse. Beschriftungstext für Formularelemente. Siehe die LABEL-Elementdefinition in HTML 4.01"
type: docs

url: /de/java/com.aspose.html/htmllabelelement/
---
## HTMLLabelElement class

Beschriftungstext eines Formularfeldes. Siehe die Definition des LABEL-Elements in HTML 4.01.
...
| [getForm](../../com.aspose.html/htmllabelelement/form/) Gibt das `FORM`‑Element zurück, das diese Steuerung enthält. Gibt `null` zurück, wenn diese Steuerung nicht im Kontext eines Formulars ist. |
[getId]
