...
description: "HTMLDocument-Konstruktor. Der HTMLDocument-Konstruktor erstellt ein neues HTML-Dokument-Objekt, das eine im Browser geladene Webseite ist und als Einstiegspunkt in den Seiteninhalt dient."
type: docs
...
Sobald das Dokumentobjekt erstellt ist, kann es später mit HTML-Elementen gefüllt werden. Das folgende Code‑Snippet zeigt die Verwendung des Standard‑HTMLDocument()‑Konstruktors, um ein leeres HTML-Dokument zu erstellen und es in einer Datei zu speichern.
...
Das folgende Beispiel zeigt, wie das Konfigurationsobjekt verwendet wird, um Skripte zu deaktivieren:
...
Hinweis: Falls Sie eine falsche URL übergeben, die im Moment nicht erreichbar ist, wirft die Bibliothek die [`DOMException`](../../../com.aspose.html.dom/domexception/) mit dem speziellen Code ‘NetworkError’, um Sie darüber zu informieren, dass die ausgewählte Ressource nicht gefunden werden kann.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| url | Url | Die URL des HTML-Dokuments, das geöffnet werden soll. |
...
Lädt das HTML‑Dokument von einer URL mit angegebenen Umgebungskonfigurationseinstellungen.

Hinweis: Falls Sie eine falsche URL übergeben, die im Moment nicht erreichbar ist, wirft die Bibliothek die [DOMException](T:com.aspose.html.dom.DOMException) mit dem speziellen Code ‘NetworkError’, um Sie darüber zu informieren, dass die ausgewählte Ressource nicht gefunden werden kann.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Adresse | String | Die Adresse des HTML-Dokuments, das geöffnet werden soll. |
...
Lädt das HTML‑Dokument von einer Adresse mit angegebenen Umgebungskonfigurationseinstellungen.
...
Erstellt ein HTML‑Dokument aus einem String‑Inhalt mit angegebenem base‑uri.
...
Erstellt ein HTML‑Dokument aus einem String‑Inhalt mit angegebenem base‑uri und Umgebungskonfigurationseinstellungen.
...
Erstellt ein HTML‑Dokument aus einem [Stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream)‑Inhalt mit angegebenem base‑uri, das zum Auflösen des Pfads relativer Ressourcen verwendet wird.
...
import (var sw = new StreamWriter(mem))
{
	...
	// Es ist wichtig, die Position auf den Anfang zu setzen, da HTMLDocument das Lesen genau von der aktuellen Position im Stream startet.
	sw.Flush();
...
Erstellt ein HTML‑Dokument aus einem [Stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream)‑Inhalt mit angegebenem base‑uri und Umgebungskonfigurationseinstellungen.
...
Per Definition ist ein Message‑Handler eine Klasse, die eine Web‑Anfrage empfängt und eine Web‑Antwort zurückgibt. Mit anderen Worten wird ein Message‑Handler verwendet, um eine Web‑Service‑Anfrage während der Eingabe und/oder die Antwort während der Ausgabe zu verarbeiten.
...
Erstellt ein HTML‑Dokument aus einem [RequestMessage](T:com.aspose.html.net.RequestMessage)‑Objekt.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| request | RequestMessage | Die Anforderungsnachricht, die ein [body](P:com.aspose.html.net.RequestMessage.Content) mit Dokumentinhalt enthält. |
| Konfiguration | Konfiguration | Die Umgebungskonfiguration wie Skript‑Richtlinie, benutzerdefiniertes Benutzer‑Stylesheet usw. |
