...
description: "com.aspose.html.HTMLDocument Klasse. Stellt ein HTML-Dokument dar. Alle HTML-Objekte der obersten Ebene werden zu diesem Objekt hinzugefügt. Diese Klasse repräsentiert die HTML-Seite so, wie wir sie im Browser sehen. Alle Formulare, Tabellen, Skripte … werden über die Schnittstellen dieser Klasse zur HTML-Seite hinzugefügt. HTMLDocument ist die HTML-Implementierung der allgemeinsten Document‑Schnittstelle und beide bilden den Kern bzw. Ausgangspunkt des DOM – Document Object Model. Diese Konzepte entsprechen vollständig den offiziellen Grundlagen bzw. Standards der Webentwicklung. Für die Webentwicklung kann man im Allgemeinen HTMLDocument als Alias für Document betrachten, auf dem HTMLDocument basiert."
type: docs
...
| [HTMLDocument](htmldocument/#constructor_3)(RequestMessage, Configuration) | Erstellt ein HTML‑Dokument aus dem [RequestMessage](T:com.aspose.html.net.RequestMessage) Objekt. |
| [HTMLDocument](htmldocument/#constructor_8)(Stream, String) | Erstellt ein HTML‑Dokument aus einem [Stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream)‑Inhalt mit angegebener Basis‑URI, die zum Auflösen des Pfads relativer Ressourcen verwendet wird. |
| [HTMLDocument](htmldocument/#constructor_6)(Stream, Url) | Erstellt ein HTML‑Dokument aus einem [Stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream)‑Inhalt mit angegebener Basis‑URI, die zum Auflösen des Pfads relativer Ressourcen verwendet wird. |
| [HTMLDocument](htmldocument/#constructor_11)(String, Configuration) | Lädt das HTML‑Dokument von einer Adresse mit angegebenen Umgebungs‑Konfigurationseinstellungen. |
| [HTMLDocument](htmldocument/#constructor_14)(String, String) | Erstellt ein HTML‑Dokument aus einem String‑Inhalt mit angegebener Basis‑URI. |
| [HTMLDocument](htmldocument/#constructor_12)(String, Url) | Erstellt ein HTML‑Dokument aus einem String‑Inhalt mit angegebener Basis‑URI. |
| [HTMLDocument](htmldocument/#constructor_5)(Url, Configuration) | Lädt das HTML‑Dokument von einer URL mit angegebenen Umgebungs‑Konfigurationseinstellungen. |
| [HTMLDocument](htmldocument/#constructor_9)(Stream, String, Configuration) | Erstellt ein HTML‑Dokument aus einem [Stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream)‑Inhalt mit angegebener Basis‑URI und Umgebungs‑Konfigurationseinstellungen. |
| [HTMLDocument](htmldocument/#constructor_7)(Stream, Url, Configuration) | Erstellt ein HTML‑Dokument aus einem [Stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream)‑Inhalt mit angegebener Basis‑URI und Umgebungs‑Konfigurationseinstellungen. |
| [HTMLDocument](htmldocument/#constructor_15)(String, String, Configuration) | Erstellt ein HTML‑Dokument aus einem String‑Inhalt mit angegebener Basis‑URI und Umgebungs‑Konfigurationseinstellungen. |
| [HTMLDocument](htmldocument/#constructor_13)(String, Url, Configuration) | Erstellt ein HTML‑Dokument aus einem String‑Inhalt mit angegebener Basis‑URI und Umgebungs‑Konfigurationseinstellungen. |

## Eigenschaften

| Name | Beschreibung |
| --- | --- |
| [getAnchors](../../com.aspose.html/htmldocument/anchors/) Eine Sammlung aller Anker‑(`A`)‑Elemente in einem Dokument, die einen Wert für das Attribut `name` besitzen. Aus Gründen der Rückwärtskompatibilität enthält die zurückgegebene Menge von Ankern nur jene, die mit dem Attribut `name` erstellt wurden, nicht jene, die mit dem Attribut `id` erstellt wurden. Beachten Sie, dass im [[XHTML 1.0](http://www.w3.org/TR/2002/REC-xhtml1-20020801)] das Attribut `name` (siehe Abschnitt 4.10) keine Semantik hat und nur für veraltete Benutzeragenten vorhanden ist: Stattdessen wird das Attribut `id` verwendet. Benutzer sollten stattdessen die von [[DOM Level 2 Traversal](http://www.w3.org/TR/2000/REC-DOM-Level-2-Traversal-Range-20001113)] bereitgestellten Iterator‑Mechanismen bevorzugen. |
...
| [getDomain](../../com.aspose.html/htmldocument/domain/) Der Domänenname des Servers, der das Dokument bereitgestellt hat, oder `null`, wenn der Server nicht über einen Domänennamen identifiziert werden kann. |
...
| [getImages](../../com.aspose.html/htmldocument/images/) Eine Sammlung aller `IMG`‑Elemente in einem Dokument. Das Verhalten ist aus Gründen der Rückwärtskompatibilität auf `IMG`‑Elemente beschränkt. Wie in [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224)] vorgeschlagen, können Autoren zum Einbinden von Bildern das `OBJECT`‑Element oder das `IMG`‑Element verwenden. Daher wird empfohlen, dieses Attribut nicht zu nutzen, um Bilder im Dokument zu finden, sondern `getElementsByTagName` mit HTML 4.01 oder `getElementsByTagNameNS` mit XHTML 1.0. |
...
| [getLinks](../../com.aspose.html/htmldocument/links/) Eine Sammlung aller `AREA`‑Elemente und Anker‑(`A`)‑Elemente in einem Dokument, die einen Wert für das Attribut `href` besitzen. |
...
| [createElement](../../com.aspose.html.dom/document/createelement/)(String) | In einem HTML‑Dokument erzeugt die Methode document.createElement() das HTML‑Element, das durch tagName angegeben ist, oder ein [`HTMLUnknownElement`](../htmlunknownelement/), wenn tagName nicht erkannt wird. |
...
| [save](../../com.aspose.html/htmldocument/save/#save_10)(String) | Speichert das Dokument in einer lokalen Datei, die durch den Pfad angegeben ist. Alle in diesem Dokument verwendeten Ressourcen werden in einen angrenzenden Ordner gespeichert, dessen Name wie folgt zusammengesetzt wird: output_file_name + "_files". |
...
```java
    // Erstelle eine Instanz eines HTML-Dokuments
	using (var document = new HTMLDocument())
      {
        // Erstelle ein style-Element und weise allen Elementen mit dem Klassennamen 'gr' die grüne Farbe zu.
        var style = document.CreateElement("style");
        style.TextContent = ".gr { color: green }";

        // Finde das Header-Element des Dokuments und hänge das style-Element an den Header an
        var head = document.GetElementsByTagName("head").First();
        head.AppendChild(style);

        // Erstelle ein Absatz-Element mit dem Klassennamen 'gr'.
        ...
        // Füge den Textknoten dem Absatz hinzu
        p.AppendChild(text);

        // Füge den Absatz dem Body-Element des Dokuments hinzu
        document.Body.AppendChild(p);

        // Speichere das HTML-Dokument in einer Datei 
        document.Save(Path.Combine(OutputDir, "using-dom.html"));

        // Erstelle eine Instanz des PDF-Ausgabegeräts und rendere das Dokument in dieses Gerät
        using (var device = new PdfDevice(Path.Combine(OutputDir, "using-dom.pdf")))
        {
          // HTML nach PDF rendern
