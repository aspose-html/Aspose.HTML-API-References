...
Der HTML‑Dokument‑Body. Dieses Element ist immer in der DOM‑API vorhanden, selbst wenn die Tags im Quell‑Dokument nicht vorhanden sind. Siehe die BODY‑Elementdefinition in HTML 4.01.
