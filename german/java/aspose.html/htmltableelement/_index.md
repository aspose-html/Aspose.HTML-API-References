...
description: "com.aspose.html.HTMLTableElement Klasse. Die Erstellungs‑ und Löschmethoden der Tabelle ermöglichen es Autoren, Tabellen zu konstruieren und zu ändern. HTML 4.01 legt fest, dass von jedem der Elemente CAPTION, THEAD und TFOOT höchstens eines in einer Tabelle existieren darf. Daher gibt die Methode, wenn ein solches Element bereits existiert und die Methode createTHead oder createTFoot aufgerufen wird, das bereits vorhandene THead‑ bzw. TFoot‑Element zurück. Siehe die Definition des TABLE‑Elements in HTML 4.01."
type: docs
...
Die create*- und delete*-Methoden der Tabelle ermöglichen es Autoren, Tabellen zu erstellen und zu ändern. [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224)] legt fest, dass von jedem der `CAPTION`-, `THEAD`- und `TFOOT`-Elemente höchstens eines in einer Tabelle existieren darf. Daher wird, wenn eines existiert und die Methode createTHead() oder createTFoot() aufgerufen wird, das bereits vorhandene THead- bzw. TFoot-Element zurückgegeben. Siehe die TABLE-Elementdefinition in HTML 4.01.
...
| [getCaption](../../com.aspose.html/htmltableelement/caption/) Gibt die `CAPTION` der Tabelle zurück, oder void, wenn keine existiert. @version DOM Level 2 |
[getCellPadding]
...
| [getRows](../../com.aspose.html/htmltableelement/rows/) Gibt die `TFOOT` der Tabelle zurück, oder `null`, wenn keine existiert. |
[getRules]
...
| [getTFoot](../../com.aspose.html/htmltableelement/tfoot/) Gibt die `THEAD` der Tabelle zurück, oder `null`, wenn keine existiert. |
| [getTHead](../../com.aspose.html/htmltableelement/thead/) Gibt die `CAPTION` der Tabelle zurück, oder void, wenn keine existiert. |
[getTitle]
...
| event [OnInvalid](../../com.aspose.html/htmlelement/oninvalid/) | Liest oder setzt den Ereignishandler für das OnInvalid-Ereignis. |
| event [OnKeyDown](../../com.aspose.html/htmlelement/onkeydown/) | Liest oder setzt den Ereignishandler für das OnKeyDown-Ereignis. |
| event [OnKeyPress](../../com.aspose.html/htmlelement/onkeypress/) | Liest oder setzt den Ereignishandler für das OnKeyPress-Ereignis. |
| event [OnKeyUp](../../com.aspose.html/htmlelement/onkeyup/) | Liest oder setzt den Ereignishandler für das OnKeyUp-Ereignis. |
| event [OnLoad](../../com.aspose.html/htmlelement/onload/) | Liest oder setzt den Ereignishandler für das OnLoad-Ereignis. |
| event [OnLoadedData](../../com.aspose.html/htmlelement/onloadeddata/) | Liest oder setzt den Ereignishandler für das OnLoadedData-Ereignis. |
| event [OnLoadedMetadata](../../com.aspose.html/htmlelement/onloadedmetadata/) | Liest oder setzt den Ereignishandler für das OnLoadedMetadata-Ereignis. |
| event [OnLoadStart](../../com.aspose.html/htmlelement/onloadstart/) | Liest oder setzt den Ereignishandler für das OnLoadStart-Ereignis. |
| event [OnMouseDown](../../com.aspose.html/htmlelement/onmousedown/) | Liest oder setzt den Ereignishandler für das OnMouseDown-Ereignis. |
| event [OnMouseEnter](../../com.aspose.html/htmlelement/onmouseenter/) | Liest oder setzt den Ereignishandler für das OnMouseEnter-Ereignis. |
| event [OnMouseLeave](../../com.aspose.html/htmlelement/onmouseleave/) | Liest oder setzt den Ereignishandler für das OnMouseLeave-Ereignis. |
| event [OnMouseMove](../../com.aspose.html/htmlelement/onmousemove/) | Liest oder setzt den Ereignishandler für das OnMouseMove-Ereignis. |
| event [OnMouseOut](../../com.aspose.html/htmlelement/onmouseout/) | Liest oder setzt den Ereignishandler für das OnMouseOut-Ereignis. |
| event [OnMouseOver](../../com.aspose.html/htmlelement/onmouseover/) | Liest oder setzt den Ereignishandler für das OnMouseOver-Ereignis. |
| event [OnMouseUp](../../com.aspose.html/htmlelement/onmouseup/) | Liest oder setzt den Ereignishandler für das OnMouseUp-Ereignis. |
| event [OnMouseWheel](../../com.aspose.html/htmlelement/onmousewheel/) | Liest oder setzt den Ereignishandler für das OnMouseWheel-Ereignis. |
| event [OnPause](../../com.aspose.html/htmlelement/onpause/) | Liest oder setzt den Ereignishandler für das OnPause-Ereignis. |
| event [OnPlay](../../com.aspose.html/htmlelement/onplay/) | Liest oder setzt den Ereignishandler für das OnPlay-Ereignis. |
| event [OnPlaying](../../com.aspose.html/htmlelement/onplaying/) | Liest oder setzt den Ereignishandler für das OnPlaying-Ereignis. |
| event [OnProgress](../../com.aspose.html/htmlelement/onprogress/) | Liest oder setzt den Ereignishandler für das OnProgress-Ereignis. |
| event [OnRateChange](../../com.aspose.html/htmlelement/onratechange/) | Liest oder setzt den Ereignishandler für das OnRateChange-Ereignis. |
| event [OnReset](../../com.aspose.html/htmlelement/onreset/) | Liest oder setzt den Ereignishandler für das OnReset-Ereignis. |
| event [OnResize](../../com.aspose.html/htmlelement/onresize/) | Liest oder setzt den Ereignishandler für das OnResize-Ereignis. |
| event [OnScroll](../../com.aspose.html/htmlelement/onscroll/) | Liest oder setzt den Ereignishandler für das OnScroll-Ereignis. |
