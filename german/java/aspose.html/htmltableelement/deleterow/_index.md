...
| --- | --- | --- |
| index | Int32 | Der Index der zu löschenden Zeile. Dieser Index beginnt bei 0 und bezieht sich auf die logische Reihenfolge (nicht die Dokumentenreihenfolge) aller Zeilen, die in der Tabelle enthalten sind. Wenn der Index -1 ist, wird die letzte Zeile in der Tabelle gelöscht. |
