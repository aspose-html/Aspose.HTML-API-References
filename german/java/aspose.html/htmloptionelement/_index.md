...
description: "com.aspose.html.HTMLOptionElement Klasse. Eine auswählbare Option. Siehe die Definition des OPTION‑Elements in HTML 4.01"
type: docs

url: /de/java/com.aspose.html/htmloptionelement/
---
## HTMLOptionElement class

Eine auswählbare Option. Siehe die OPTION-Elementdefinition in HTML 4.01.
...
| [getForm](../../com.aspose.html/htmloptionelement/form/) Gibt das `FORM`‑Element zurück, das diese Steuerung enthält. Gibt `null` zurück, wenn diese Steuerung nicht im Kontext eines Formulars steht. |
[getId]
[setId] The element's identifier. See the id attribute definition in HTML 4.01. |
| [getIndex](../../com.aspose.html/htmloptionelement/index/) Der Index dieses `OPTION` im übergeordneten `SELECT`, beginnend bei 0. @version DOM Level 2 |
[getInnerHTML]
...
| [getText](../../com.aspose.html/htmloptionelement/text/) Der Text, der im Options‑Element enthalten ist. |
