...
description: "com.aspose.html.HTMLTableRowElement Klasse. Eine Zeile in einer Tabelle. Siehe die Definition des TR‑Elements in HTML 4.01."
type: docs

url: /de/java/com.aspose.html/htmltablerowelement/
---
## HTMLTableRowElement class

Eine Zeile in einer Tabelle. Siehe die TR-Elementdefinition in HTML 4.01.
...
| [getCells](../../com.aspose.html/htmltablerowelement/cells/) Die Sammlung von Zellen in dieser Zeile. @version DOM Level 2 |
[getCh]
...
| [getRowIndex](../../com.aspose.html/htmltablerowelement/rowindex/) Dies ist in logischer Reihenfolge und nicht in Dokumentenreihenfolge. Der `rowIndex` berücksichtigt Abschnitte (`THEAD`, `TFOOT` oder `TBODY`) innerhalb der Tabelle und platziert `THEAD`‑Zeilen zuerst im Index, gefolgt von `TBODY`‑Zeilen und danach `TFOOT`‑Zeilen. @version DOM Level 2 |
| [getSectionRowIndex](../../com.aspose.html/htmltablerowelement/sectionrowindex/) Der Index dieser Zeile relativ zum aktuellen Abschnitt (`THEAD`, `TFOOT` oder `TBODY`), beginnend bei 0. @version DOM Level 2 |
...
| [deleteCell](../../com.aspose.html/htmltablerowelement/deletecell/)(int) | Lösche eine Zelle aus der aktuellen Zeile. |
...
| [insertCell](../../com.aspose.html/htmltablerowelement/insertcell/)(int) | Füge eine leere `TD`‑Zelle in diese Zeile ein. Wenn `index` -1 ist oder der Anzahl der Zellen entspricht, wird die neue Zelle angehängt. |
