...
description: "Das Aspose.Html-Paket enthält Klassen und Methoden zur Manipulation von HTML‑Dokumentenaspose.html/htmldocument/, egal ob einfach oder komplex und in Echtzeit. Aspose.HTML für Java ermöglicht Entwicklern das Insert Remove Replace HTML nodes extract CSS style information Navigate through HTML documentaspose.html/htmldocument/ either by NodeIteratoraspose.html.dom.traversal/inodeiterator/ TreeWalkeraspose.html.dom.traversal/itreewalker/ that are provided by Traversal Specifications XPath or CSS selector queries. Es bietet außerdem das Scripting, das die Manipulation des HTML‑DOM via JavaScript ermöglicht. Zusätzlich zu HTML stellt diese API die Möglichkeit bereit, EPUB und MHTML zu laden. Aspose APIs sind für ihre inter file format conversion features bekannt und diese API ermöglicht ebenfalls das Laden von HTML‑Dateien und das Rendern der Ausgabe in PDF XPS und Raster‑Bildformate einschließlich JPEG PNG BMP und TIFF"
type: docs
...
| Klasse | Beschreibung |
| --- | --- |
| [ArrayBuffer](./arraybuffer/) | Das ArrayBuffer-Objekt wird verwendet, um einen generischen, fest‑längen‑rohen Binärdatenpuffer darzustellen. |
| [Configuration](./configuration/) | Stellt das Konfigurations‑Kontextobjekt dar, das verwendet wird, um die Umgebungseinstellungen für die Anwendung einzurichten. Durch die Verwaltung der Konfiguration können Sie den Dokumentstil überschreiben, indem Sie ein benutzerdefiniertes Stylesheet anwenden, oder Web‑Anfragen der Anwendung behandeln sowie die Skript‑Richtlinie konfigurieren. Details finden Sie im [Environment Configuration guide](https://docs.aspose.com/html/net/working-with-documents/environment-configuration/). |
| [Float32Array](./float32array/) | Stellt ein Array von 32‑Bit‑Gleitkommazahlen (entsprechend dem C float Datentyp) in der Plattform‑Byte‑Reihenfolge dar. |
| [Float64Array](./float64array/) | Stellt ein Array von 64‑Bit‑Gleitkommazahlen (entsprechend dem C float Datentyp) in der Plattform‑Byte‑Reihenfolge dar. |
| [FontsSettings](./fontssettings/) | Stellt Einstellungen für die Schriftartenverwaltung dar. |
| [HTMLAddressElement](./htmladdresselement/) | Das address‑Element. Siehe die ADDRESS‑Elementdefinition in HTML 4.01. |
| [HTMLAnchorElement](./htmlanchorelement/) | Das anchor‑Element. Siehe die A‑Elementdefinition in HTML 4.01. |
...
| [HTMLAreaElement](./htmlareaelement/) | Client‑seitige Image‑Map‑Flächen‑Definition. Siehe die AREA‑Elementdefinition in HTML 4.01. |
| [HTMLBaseElement](./htmlbaseelement/) | Dokument‑Basis‑URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt)]. Siehe die BASE‑Elementdefinition in HTML 4.01. |
| [HTMLBaseFontElement](./htmlbasefontelement/) | Basis‑Schriftart. Siehe die BASEFONT‑Elementdefinition in HTML 4.01. Dieses Element ist in HTML 4.01 veraltet. |
| [HTMLBodyElement](./htmlbodyelement/) | Der HTML‑Dokument‑Body. Dieses Element ist immer in der DOM‑API vorhanden, selbst wenn die Tags im Quell‑Dokument nicht vorhanden sind. Siehe die BODY‑Elementdefinition in HTML 4.01. |
| [HTMLBRElement](./htmlbrelement/) | Erzwingt einen Zeilenumbruch. Siehe die BR‑Elementdefinition in HTML 4.01. |
| [HTMLButtonElement](./htmlbuttonelement/) | Schaltfläche drücken. Siehe die Definition des BUTTON-Elements in HTML 4.01. |
...
| [HTMLFontElement](./htmlfontelement/) | Lokale Änderung der Schrift. Siehe die Definition des FONT-Elements in HTML 4.01. Dieses Element ist in HTML 4.01 veraltet. |
...
| [HTMLHeadingElement](./htmlheadingelement/) | Für die `H1`- bis `H6`-Elemente. Siehe die Definition des H1-Elements in HTML 4.01. |
...
| [HTMLLabelElement](./htmllabelelement/) | Beschriftungstext für Formularfeld. Siehe die Definition des LABEL-Elements in HTML 4.01. |
...
| [HTMLOptGroupElement](./htmloptgroupelement/) | Optionen in logische Unterteilungen gruppieren. Siehe die OPTGROUP-Elementdefinition in HTML 4.01. |
...
| [HTMLTableCellElement](./htmltablecellelement/) | Das Objekt, das verwendet wird, um die `TH`- und `TD`-Elemente darzustellen. Siehe die TD-Elementdefinition in HTML 4.01. |
...
| [Int16Array](./int16array/) | Stellt ein Array von Zweierkomplement‑16‑Bit‑Ganzzahlen mit Vorzeichen in der Byte‑Reihenfolge der Plattform dar. |
| [Int32Array](./int32array/) | Stellt ein Array von Zweierkomplement‑32‑Bit‑Ganzzahlen mit Vorzeichen in der Byte‑Reihenfolge der Plattform dar. |
| [Int8Array](./int8array/) | Stellt ein Array von Zweierkomplement‑8‑Bit‑Ganzzahlen mit Vorzeichen dar. |
...
| [MimeType](./mimetype/) | Stellt einen Internet-Medientyp dar. |
...
| [TypedArray](./typedarray/) | TypedArray-Objekte bieten eine array‑ähnliche Ansicht eines zugrunde liegenden binären Datenpuffers. |
| [TypedArray&lt;T&gt;](./typedarray-1/) | TypedArray-Objekte bieten eine array‑ähnliche Ansicht eines zugrunde liegenden binären Datenpuffers. |
| [Uint16Array](./uint16array/) | Stellt ein Array von Zweierkomplement‑16‑Bit‑Ganzzahlen ohne Vorzeichen in der Byte‑Reihenfolge der Plattform dar. |
| [Uint32Array](./uint32array/) | Stellt ein Array von Zweierkomplement‑32‑Bit‑Ganzzahlen ohne Vorzeichen in der Byte‑Reihenfolge der Plattform dar. |
| [Uint8Array](./uint8array/) | Stellt ein Array von Zweierkomplement‑8‑Bit‑Ganzzahlen ohne Vorzeichen dar. |
| [Uint8ClampedArray](./uint8clampedarray/) | Stellt ein Array von 8‑Bit‑Ganzzahlen ohne Vorzeichen dar, das auf 0‑255 begrenzt ist; wenn Sie einen Wert außerhalb des Bereichs [0,255] angeben, wird stattdessen 0 oder 255 gesetzt; |
| [Url](./url/) | Stellt eine Objektrepräsentation eines universellen Identifikators (URL) bereit. |
## Schnittstellen

| Schnittstelle | Beschreibung |
| --- | --- |
| [IConfigurationBuilder](./iconfigurationbuilder/) | Stellt einen Builder für Konfigurationsobjekte dar. |
| [IDocumentFragmentElement](./idocumentfragmentelement/) | Stellt eine gemeinsame Schnittstelle für alle Document‑Fragment‑Elemente dar. |
...
| [IHTMLOptionsCollection](./ihtmloptionscollection/) | Ein `HTMLOptionsCollection` ist eine Liste von Knoten, die ein HTML‑Option‑Element darstellen. Auf einen einzelnen Knoten kann entweder über den ordinalen Index oder über die Attribute `name` oder `id` des Knotens zugegriffen werden. Sammlungen im HTML‑DOM werden als live angenommen, das heißt, sie werden automatisch aktualisiert, wenn das zugrunde liegende Dokument geändert wird. |
| [IUrlSearchParams](./iurlsearchparams/) | Stellt Methoden zur Arbeit mit der Abfragezeichenfolge von URLs bereit. |
## Aufzählung
