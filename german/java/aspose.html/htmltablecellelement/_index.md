...
description: "com.aspose.html.HTMLTableCellElement Klasse. Das Objekt wird verwendet, um die TH- und TD-Elemente darzustellen. Siehe die TD-Elementdefinition in HTML 4.01"
type: docs
...
Das Objekt, das verwendet wird, um die `TH`- und `TD`-Elemente darzustellen. Siehe die TD-Elementdefinition in HTML 4.01.
