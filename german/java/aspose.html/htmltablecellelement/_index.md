...
description: "com.aspose.html.HTMLTableCellElement Klasse. Das Objekt, das verwendet wird, um die TH- und TD-Elemente darzustellen. Siehe die TD-Elementdefinition in HTML 4.01."
type: docs

url: /de/java/com.aspose.html/htmltablecellelement/
---
## HTMLTableCellElement class

Das Objekt, das die `TH`- und `TD`-Elemente repräsentiert. Siehe die TD-Elementdefinition in HTML 4.01.
...
| [getCellIndex](../../com.aspose.html/htmltablecellelement/cellindex/) Der Index dieser Zelle in der Zeile, beginnend bei 0. Dieser Index folgt der Reihenfolge des Dokumentbaums und nicht der Anzeigereihenfolge. |
[getCh]
