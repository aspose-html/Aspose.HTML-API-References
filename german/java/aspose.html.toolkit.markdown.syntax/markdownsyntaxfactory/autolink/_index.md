...
description: "MarkdownSyntaxFactory-Methode. Erstellt AutoLinkSyntaxNode"
type: docs

url: /de/java/com.aspose.html.toolkit.markdown.syntax/markdownsyntaxfactory/autolink/
---
## AutoLink(MarkdownSyntaxToken, TextSyntaxNode, MarkdownSyntaxToken) {#autolink}

Erstellt [`AutoLinkSyntaxNode`](../../autolinksyntaxnode/).
...
| --- | --- | --- |
| opening | MarkdownSyntaxToken | Das MarkdownSyntaxToken. |
| Inhalt | TextSyntaxNode | Der TextSyntax. |
| closing | MarkdownSyntaxToken | Das MarkdownSyntaxToken. |
...
| Inhalt | TextSyntaxNode | Der TextSyntax. |
| closing | MarkdownSyntaxToken | Das MarkdownSyntaxToken. |
| E‑Mail | Boolean | Das boolesche Flag. |
