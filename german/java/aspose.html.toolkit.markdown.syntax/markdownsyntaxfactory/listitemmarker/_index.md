...
description: "MarkdownSyntaxFactory-Methode. Erstellt ListItemMarker"
type: docs

url: /de/java/com.aspose.html.toolkit.markdown.syntax/markdownsyntaxfactory/listitemmarker/
---
## ListItemMarker(MarkdownSyntaxToken, MarkdownSyntaxToken) {#listitemmarker_1}

Erstellt [`ListItemMarker`](../../listitemmarker/).
...
| --- | --- | --- |
| Zahl | MarkdownSyntaxToken | Die Zahl. |
| Trennzeichen | MarkdownSyntaxToken | Das Trennzeichen. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Token | MarkdownSyntaxToken | Das Token. |
