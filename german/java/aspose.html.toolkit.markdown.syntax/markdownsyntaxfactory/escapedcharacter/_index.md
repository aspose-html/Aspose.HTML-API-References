...
description: "MarkdownSyntaxFactory-Methode. Erstellt TextSyntaxNode"
type: docs

url: /de/java/com.aspose.html.toolkit.markdown.syntax/markdownsyntaxfactory/escapedcharacter/
---
## EscapedCharacter(char) {#escapedcharacter_1}

Erstellt [`TextSyntaxNode`](../../textsyntaxnode/).
...
| --- | --- | --- |
| escapedChar | Char | Das escapedChar. |
