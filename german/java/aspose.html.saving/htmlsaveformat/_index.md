...
description: "com.aspose.html.saving.HTMLSaveFormat Enum. Gibt das Format an, in dem das Dokument gespeichert wird. Weitere Informationen zum Speichern von HTMLDocument finden Sie im Artikel."
type: docs
...
| Markdown | `1` | Das Dokument wird als Markdown gespeichert. |
| MHTML | `2` | Das Dokument wird als MHTML gespeichert. |
