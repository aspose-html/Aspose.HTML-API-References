...
| Name | Beschreibung |
| --- | --- |
| static [getDefault](../../com.aspose.html.saving/markdownsaveoptions/default/) Gibt ein Satz von Optionen zurück, die mit der Standard-Markdown-Dokumentation kompatibel sind. |
| static [getGit](../../com.aspose.html.saving/markdownsaveoptions/git/) Gibt ein Satz von Optionen zurück, die mit GitLab Flavored Markdown kompatibel sind. |
[getFeatures]
...
...
	 // Bereiten Sie einen Pfad für das Speichern der konvertierten Datei vor
      ...
      // Rufen Sie die ConvertHTML-Methode auf, um das HTML in Markdown zu konvertieren.
