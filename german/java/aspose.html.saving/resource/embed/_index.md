...
| Ausnahme | Bedingung |
| --- | --- |
| InvalidOperationException | Ausgelöst, wenn es keinen [`ParentResource`](../../resourcehandlingcontext/parentresource/) gibt, weil es keinen Ort gibt, um das Ergebnis einzubetten. |
