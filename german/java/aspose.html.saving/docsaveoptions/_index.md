...
Spezifische Optionsdatenklasse. Durch Zuweisen von Eigenschaften können Sie Rendering‑Charakteristiken wie Auflösung, Seitengröße, Hintergrundfarbe sowie dokumentspezifische Optionen wie Schriftart‑Einbettung verwalten. Weitere Informationen siehe in der Dokumentation [article](https://docs.aspose.com/html/net/converting-between-formats/html-to-docx/#save-options).
...
...
 // Bereiten Sie einen Pfad zu einer Quell-HTML-Datei vor
      ...
      // Initialisieren Sie DocSaveOptions. Richten Sie die Seitengröße von 600 x 400 Pixeln und die Ränder ein
