...
description: "com.aspose.html.dom.svg.events.TimeEvent-Klasse. Das TimeEvent-Interface liefert spezifische Kontextinformationen, die mit Zeitereignissen verbunden sind. Die verschiedenen Ereignistypen, die auftreten können, sind beginEvent, endEvent und repeatEvent."
type: docs
...
Das TimeEvent-Interface liefert spezifische Kontextinformationen, die mit Zeitevents verbunden sind. Die verschiedenen Ereignistypen, die auftreten können, sind: beginEvent, endEvent und repeatEvent.
...
| [getDetail](../../com.aspose.html.dom.svg.events/timeevent/detail/) Gibt einige Detailinformationen zum Ereignis an, abhängig vom Typ des Ereignisses. Für diesen Ereignistyp gibt es die Wiederholungszahl für die Animation an. |
