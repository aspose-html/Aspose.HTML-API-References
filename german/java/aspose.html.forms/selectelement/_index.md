...
| [getType](../../com.aspose.html.forms/selectelement/type/) Der Typ dieses Formularelements. Dies ist der String "select-multiple", wenn das multiple-Attribut `true` ist und der String "select-one", wenn `false`. |
| [value](../../com.aspose.html.forms/selectelement/value/) { get; set; } | Beim Abrufen muss der Wert des ersten Options-Elements in der Optionsliste in Baumreihenfolge zurückgegeben werden, das auf ausgewählt (`true`) gesetzt ist, falls vorhanden. |
