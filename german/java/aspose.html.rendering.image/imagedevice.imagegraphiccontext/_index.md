...
description: "com.aspose.html.rendering.image.ImageDeviceImageGraphicContext Klasse. Enthält aktuelle Grafiksteuerungsparameter für das ImageDevice. Diese Parameter definieren den globalen Rahmen, in dem die Grafikoperatoren ausgeführt werden."
type: docs

url: /de/java/com.aspose.html.rendering.image/imagedevice.imagegraphiccontext/
---
## ImageDevice.ImageGraphicContext class

Enthält aktuelle Grafiksteuerungsparameter für das [`ImageDevice`](../imagedevice/). Diese Parameter definieren den globalen Rahmen, in dem die Grafikoperatoren ausgeführt werden.
...
| Name | Beschreibung |
| --- | --- |
| [imageGraphicContext](../../com.aspose.html.rendering.image/imagedevice.imagegraphiccontext/.ctor)() | Der Standardkonstruktor. |
