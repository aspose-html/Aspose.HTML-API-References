...
description: "com.aspose.html.dom.traversal.INodeFilter‑Schnittstelle. Filter sind Objekte, die wissen, wie man Knoten herausfiltert. Wenn einem NodeIterator oder TreeWalker ein NodeFilter übergeben wird, wendet er den Filter an, bevor er den nächsten Knoten zurückgibt. Wenn der Filter entscheidet, den Knoten zu akzeptieren, gibt die Traversal‑Logik ihn zurück, andernfalls sucht die Traversierung nach dem nächsten Knoten und tut so, als wäre der abgelehnte Knoten nicht vorhanden."
type: docs
...
NodeFilters müssen nicht wissen, wie man von Knoten zu Knoten traversiert, noch müssen sie etwas über die Datenstruktur wissen, die traversiert wird. Das macht das Schreiben von Filtern sehr einfach, da das Einzige, was sie wissen müssen, die Auswertung eines einzelnen Knotens ist. Ein Filter kann mit verschiedenen Arten von Traversierungen verwendet werden, was die Wiederverwendung von Code fördert.
