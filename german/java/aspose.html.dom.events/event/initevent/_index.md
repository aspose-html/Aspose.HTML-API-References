...
description: "Event-Methode. Die InitEvent-Methode wird verwendet, um den Wert eines Ereignisses zu initialisieren, das über die IDocumentEvent‑Schnittstelle erstellt wurde."
type: docs
