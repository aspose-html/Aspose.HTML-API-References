...
description: "com.aspose.html.dom.events.FocusEvent Klasse. Die FocusEvent‑Schnittstelle liefert spezifische Kontextinformationen, die mit Fokus‑Ereignissen verbunden sind."
type: docs

url: /de/java/com.aspose.html.dom.events/focusevent/
---
## FocusEvent class

Das FocusEvent-Interface liefert spezifische kontextbezogene Informationen, die mit Fokusereignissen verbunden sind.
...
| Name | Beschreibung |
| --- | --- |
| [FocusEvent](focusevent/#constructor)(String) | Initialisiert eine neue Instanz der `FocusEvent`‑Klasse. |
...
| [getRelatedTarget](../../com.aspose.html.dom.events/focusevent/relatedtarget/) Wird verwendet, um ein sekundäres EventTarget zu identifizieren, das mit einem Focus‑Ereignis verbunden ist, abhängig vom Ereignistyp. |
