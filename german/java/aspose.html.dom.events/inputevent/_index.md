...
description: "com.aspose.html.dom.events.InputEvent Klasse. Eingabeereignisse werden als Benachrichtigungen gesendet, sobald das DOM aktualisiert wird."
type: docs
...
| [getData](../../com.aspose.html.dom.events/inputevent/data/) Die Daten enthalten den Wert der durch eine Eingabemethode erzeugten Zeichen. Dies KANN ein einzelnes Unicode‑Zeichen oder eine nicht‑leere Sequenz von Unicode‑Zeichen [Unicode] sein. Zeichen SOLLTEN gemäß der Unicode‑Normalisierungsform NFC normalisiert werden, definiert in [UAX15]. Dieses Attribut KANN die leere Zeichenkette enthalten. |
