...
Das disabled-Attribut muss beim Lesen true zurückgeben, wenn das disabled-Flag gesetzt ist, sonst false. Beim Schreiben muss das disabled-Attribut das disabled-Flag setzen, wenn der neue Wert true ist, andernfalls das disabled-Flag zurücksetzen.
