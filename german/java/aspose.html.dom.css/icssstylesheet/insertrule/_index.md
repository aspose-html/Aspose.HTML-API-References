...
Hinweis: Obwohl insertRule() ausschließlich eine Methode von [`CSSStyleSheet`](../) ist, fügt sie die Regel tatsächlich in CSSStyleSheet.cssRules ein – ihre interne [`CSSRuleList`](../../icssrulelist/).
