---
title: "ICSS2Properties Schnittstelle"
second_title: "Aspose.HTML für Java API-Referenz"
description: "com.aspose.html.dom.css.ICSS2Properties Schnittstelle. Die CSS2Properties Schnittstelle stellt einen bequemen Mechanismus zum Abrufen und Setzen von Eigenschaften innerhalb einer CSSStyleDeclaration dar. Die Attribute dieser Schnittstelle entsprechen allen in CSS2 spezifizierten Eigenschaften. Das Abrufen eines Attributs dieser Schnittstelle ist äquivalent zum Aufruf der Methode getPropertyValue der CSSStyleDeclaration Schnittstelle. Das Setzen eines Attributs dieser Schnittstelle ist äquivalent zum Aufruf der Methode setProperty der CSSStyleDeclaration Schnittstelle."
type: docs

url: /de/java/com.aspose.html.dom.css/icss2properties/
---
## ICSS2Properties interface

Die CSS2Properties Schnittstelle stellt einen bequemen Mechanismus zum Abrufen und Setzen von Eigenschaften innerhalb eines [`CSSStyleDeclaration`](../icssstyledeclaration/) dar. Die Attribute dieser Schnittstelle entsprechen allen in CSS2 spezifizierten Eigenschaften. Das Abrufen eines Attributs dieser Schnittstelle ist äquivalent zum Aufruf der Methode getPropertyValue der [`CSSStyleDeclaration`](../icssstyledeclaration/) Schnittstelle. Das Setzen eines Attributs dieser Schnittstelle ist äquivalent zum Aufruf der Methode setProperty der [`CSSStyleDeclaration`](../icssstyledeclaration/) Schnittstelle.
