...
| --- | --- | --- |
| propertyName | String | propertyName ist ein String, der den zu entfernenden Eigenschaftsnamen darstellt. Beachten Sie, dass mehrteilige Eigenschaftsnamen mit Bindestrichen geschrieben und nicht im CamelCase-Format angegeben werden. |
...
| Ausnahme | Bedingung |
| --- | --- |
| DOMException | NO_MODIFICATION_ALLOWED_ERR: falls die Eigenschaft oder der Deklarationsblock schreibgeschützt ist. |
