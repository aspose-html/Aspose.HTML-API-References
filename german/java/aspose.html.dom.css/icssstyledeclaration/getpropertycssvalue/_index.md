...
description: "ICSSStyleDeclaration-Methode. Wird verwendet, um die Objektrepräsentation des Werts einer CSS‑Eigenschaft abzurufen, wenn sie innerhalb dieses Deklarationsblocks explizit gesetzt wurde. Diese Methode gibt null zurück, wenn es sich bei der Eigenschaft um eine Kurzschreibweise handelt. Werte von Kurzschreibungs‑Eigenschaften können nur als Strings über die Methoden getPropertyValue und setProperty abgerufen und geändert werden."
type: docs
