...
| Name | Beschreibung |
| --- | --- |
| abstract [CSSText](../../com.aspose.html.dom.css/cssvalue/csstext/) { get; set; } | Die cssText‑Eigenschaft des `CSSValue`-Interfaces stellt den aktuell berechneten CSS‑Eigenschaftswert dar. |
...
| const [CSS_INHERIT](../../com.aspose.html.dom.css/cssvalue/css_inherit/) | Der Wert ist vererbt und das cssText enthält "inherit". |
| const [CSS_PRIMITIVE_VALUE](../../com.aspose.html.dom.css/cssvalue/css_primitive_value/) | Der Wert ist ein primitiver Wert und eine Instanz des CSSPrimitiveValue-Interfaces kann durch Verwendung bindungsspezifischer Cast‑Methoden auf dieser Instanz des CSSValue-Interfaces erhalten werden. |
| const [CSS_VALUE_LIST](../../com.aspose.html.dom.css/cssvalue/css_value_list/) | Der Wert ist eine CSSValue-Liste und eine Instanz des CSSValueList-Interfaces kann durch Verwendung bindungsspezifischer Cast-Methoden auf dieser Instanz des CSSValue-Interfaces erhalten werden. |
