...
description: "IViewCSS-Methode. Die Methode IViewCSS.getComputedStyle gibt ein Objekt zurück, das die Werte aller CSS-Eigenschaften eines Elements enthält, nachdem aktive Stylesheets angewendet und etwaige Grundrechnungen dieser Werte aufgelöst wurden."
type: docs
...
Die IViewCSS.getComputedStyle()‑Methode gibt ein Objekt zurück, das die Werte aller CSS‑Eigenschaften eines Elements enthält, nachdem aktive Stylesheets angewendet und etwaige grundlegende Berechnungen dieser Werte aufgelöst wurden.
...
Der zurückgegebene Stil ist ein lebendes [`CSSStyleDeclaration`](../../icssstyledeclaration/)-Objekt, das sich automatisch aktualisiert, wenn sich die Stile des Elements ändern.

### Ausnahmen

| Ausnahme | Bedingung |
| --- | --- |
| Typfehler | Wenn das übergebene Objekt kein Element ist oder pseudoElt kein gültiger Pseudo-Element-Selektor ist. |
