...
Die Methode getOverrideStyle bietet einen Mechanismus, mit dem ein DOM‑Autor sofortige Änderungen am Stil eines Elements vornehmen kann, ohne die explizit verknüpften Stylesheets eines Dokuments oder den Inline‑Stil von Elementen in den Stylesheets zu ändern. Dieses Stylesheet wird nach dem Author‑Stylesheet im Kaskaden‑Algorithmus eingefügt und wird Override‑Stylesheet genannt. Das Override‑Stylesheet hat Vorrang vor Author‑Stylesheets. Eine "!important"-Deklaration hat weiterhin Vorrang vor einer normalen Deklaration. Override‑, Author‑ und User‑Stylesheets können alle "!important"-Deklarationen enthalten. User‑"!important"-Regeln haben Vorrang vor sowohl Override‑ als auch Author‑"!important"-Regeln, und Override‑"!important"-Regeln haben Vorrang vor Author‑"!important"-Regeln.

Es wird erwartet, dass eine Instanz der DocumentCSS interface durch bindungsspezifische Casting‑Methoden auf einer Instanz der Document interface erhalten werden kann.
