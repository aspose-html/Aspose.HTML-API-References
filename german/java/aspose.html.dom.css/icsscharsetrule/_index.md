...
description: "com.aspose.html.dom.css.ICSSCharsetRule Interface. Das CSSCharsetRule-Interface repräsentiert eine Charset-Regel in einem CSS-Stylesheet. Der Wert des encoding-Attributs beeinflusst nicht die Kodierung von Textdaten in den DOM-Objekten; diese Kodierung ist immer UTF-16. Nachdem ein Stylesheet geladen wurde, entspricht der Wert des encoding-Attributs dem im Charset-Rule gefundenen Wert. Wenn im Originaldokument kein Charset vorhanden war, wird kein CSSCharsetRule erstellt. Der Wert des encoding-Attributs kann auch als Hinweis für die bei der Serialisierung des Stylesheets verwendete Kodierung dienen."
type: docs
