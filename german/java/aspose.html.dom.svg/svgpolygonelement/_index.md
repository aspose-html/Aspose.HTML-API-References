...
Die SVGPolygonElement-Schnittstelle entspricht dem ‘polygon’-Element.
...
| Name | Beschreibung |
| --- | --- |
| [getAnimatedPoints](../../com.aspose.html.dom.svg/svgpolygonelement/animatedpoints/) Bietet Zugriff auf die aktuellen animierten Inhalte des Attributs ‘points’. Wenn das angegebene Attribut oder die Eigenschaft animiert wird, enthält es den aktuellen animierten Wert des Attributs oder der Eigenschaft. Wenn das angegebene Attribut oder die Eigenschaft derzeit nicht animiert wird, enthält es denselben Wert wie points. |
...
| [getPoints](../../com.aspose.html.dom.svg/svgpolygonelement/points/) Bietet Zugriff auf die Basis (d.h. statische) Inhalte des Attributs ‘points’. |
