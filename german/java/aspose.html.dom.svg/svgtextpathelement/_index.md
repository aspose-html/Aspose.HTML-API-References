...
description: "com.aspose.html.dom.svg.SVGTextPathElement Klasse. Das SVGTextPathElement-Interface entspricht dem textPath-Element"
type: docs

url: /de/java/com.aspose.html.dom.svg/svgtextpathelement/
---
...
| [getFarthestViewportElement](../../com.aspose.html.dom.svg/svggraphicselement/farthestviewportelement/) Das am weitesten entfernte übergeordnete ‘svg’-Element. Null, wenn das aktuelle Element das äußerste svg-Element ist. |
...
| [getHref](../../com.aspose.html.dom.svg/svgtextpathelement/href/) Entspricht dem Attribut ‘xlink:href’ des angegebenen Elements. |
[getId]
...
| [getLengthAdjust](../../com.aspose.html.dom.svg/svgtextcontentelement/lengthadjust/) Entspricht dem Attribut ‘lengthAdjust’ des angegebenen Elements. Der Wert muss einer der auf diesem Interface definierten lengthAdjust-Konstanten entsprechen. |
...
| [getMethod](../../com.aspose.html.dom.svg/svgtextpathelement/method/) Entspricht dem Attribut ‘method’ des angegebenen ‘textPath’-Elements. |
...
| [getNearestViewportElement](../../com.aspose.html.dom.svg/svggraphicselement/nearestviewportelement/) Das Element, das den aktuellen Ansichtsbereich festgelegt hat. Oft das nächstgelegene übergeordnete ‘svg’-Element. Null, wenn das aktuelle Element das äußerste svg-Element ist. |
...
| [getRequiredExtensions](../../com.aspose.html.dom.svg/svggraphicselement/requiredextensions/) Entspricht dem Attribut ‘requiredExtensions’ des angegebenen Elements. |
| [getRequiredFeatures](../../com.aspose.html.dom.svg/svggraphicselement/requiredfeatures/) Entspricht dem Attribut ‘requiredFeatures’ des angegebenen Elements. |
...
| [getSpacing](../../com.aspose.html.dom.svg/svgtextpathelement/spacing/) Entspricht dem Attribut ‘spacing’ des angegebenen ‘textPath’-Elements. |
| [getStartOffset](../../com.aspose.html.dom.svg/svgtextpathelement/startoffset/) Entspricht dem Attribut ‘startOffset’ des angegebenen ‘textPath’-Elements. |
...
| [getSystemLanguage](../../com.aspose.html.dom.svg/svggraphicselement/systemlanguage/) Entspricht dem Attribut ‘systemLanguage’ des angegebenen Elements. |
...
| [getTextLength](../../com.aspose.html.dom.svg/svgtextcontentelement/textlength/) Entspricht dem Attribut ‘textLength’ des angegebenen Elements. |
| [getTransform](../../com.aspose.html.dom.svg/svggraphicselement/transform/) Entspricht dem Attribut ‘transform’ des angegebenen Elements. |
...
| [getBBox](../../com.aspose.html.dom.svg/svggraphicselement/getbbox/)() | Gibt das enge Begrenzungsrechteck im aktuellen Benutzerraum zurück (d. i. nach Anwendung des Attributs ‘transform’, falls vorhanden) für die Geometrie aller enthaltenen Grafikelemente, ohne Strichführung, Clipping, Maskierung und Filtereffekte. Hinweis: getBBox muss das tatsächliche Begrenzungsrechteck zum Zeitpunkt des Aufrufs zurückgeben, selbst wenn das Element noch nicht gerendert wurde. |
| [getComputedTextLength](../../com.aspose.html.dom.svg/svgtextcontentelement/getcomputedtextlength/)() | Die Gesamtsumme aller Vorlaufwerte, die beim Rendern aller Zeichen innerhalb dieses Elements entstehen, einschließlich des Vorlaufswertes der Glyphen (horizontal oder vertikal), der Wirkung der Eigenschaften ‘kerning’, ‘letter-spacing’ und ‘word-spacing’ sowie Anpassungen durch die Attribute ‘dx’ und ‘dy’ bei ‘tspan’-Elementen. Für nicht rendernde Umgebungen muss der User-Agent vernünftige Annahmen über Glyphenmetriken treffen. |
| [getCTM](../../com.aspose.html.dom.svg/svggraphicselement/getctm/)() | Gibt die Transformationsmatrix von den aktuellen Benutzereinheiten (d. i. nach Anwendung des Attributs ‘transform’, falls vorhanden) zum Ansichtsfenster‑Koordinatensystem für das nearestViewportElement zurück. |
...
| [getNumberOfChars](../../com.aspose.html.dom.svg/svgtextcontentelement/getnumberofchars/)() | Gibt die Gesamtzahl der für das Rendern im aktuellen Element verfügbaren Zeichen zurück, einschließlich der über ‘tref’-Referenzen referenzierten Zeichen, unabhängig davon, ob sie gerendert werden. Im Wesentlichen entspricht dies der Länge des Node::textContent-Attributs aus DOM Level 3 Core ([DOM3], Abschnitt 1.4), sofern dieses Attribut auch ‘tref’-Elemente expandiert. |
...
| Name | Beschreibung |
| --- | --- |
| const [TEXTPATH_METHODTYPE_ALIGN](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_align/) | Entspricht dem Wert 'align'. |
| const [TEXTPATH_METHODTYPE_STRETCH](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_stretch/) | Entspricht dem Wert 'stretch'. |
| const [TEXTPATH_METHODTYPE_UNKNOWN](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_unknown/) | Die Aufzählung wurde auf einen Wert gesetzt, der keiner der vordefinierten Typen ist. Es ist ungültig, zu versuchen, einen neuen Wert dieses Typs zu definieren oder einen bestehenden Wert zu diesem Typ zu wechseln. |
| const [TEXTPATH_SPACINGTYPE_AUTO](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_auto/) | Entspricht dem Wert 'auto'. |
| const [TEXTPATH_SPACINGTYPE_EXACT](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_exact/) | Entspricht dem Wert 'exact'. |
| const [TEXTPATH_SPACINGTYPE_UNKNOWN](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_unknown/) | Die Aufzählung wurde auf einen Wert gesetzt, der keiner der vordefinierten Typen ist. Es ist ungültig, zu versuchen, einen neuen Wert dieses Typs zu definieren oder einen bestehenden Wert zu diesem Typ zu wechseln. |
