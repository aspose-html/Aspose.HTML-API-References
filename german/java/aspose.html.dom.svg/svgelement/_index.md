...
description: "com.aspose.html.dom.svg.SVGElement Klasse. Alle SVG-DOM-Interfaces, die direkt den Elementen der SVG-Sprache entsprechen, wie das SVGPathElement-Interface für das path-Element, erben vom SVGElement-Interface"
type: docs

url: /de/java/com.aspose.html.dom.svg/svgelement/
---
## SVGElement class

Alle SVG-DOM-Interfaces, die direkt den Elementen der SVG-Sprache entsprechen (wie das SVGPathElement-Interface für das ‘path’-Element), erben vom SVGElement-Interface.
