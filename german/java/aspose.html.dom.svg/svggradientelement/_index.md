...
description: "com.aspose.html.dom.svg.SVGGradientElement Klasse. Das Interface SVGGradientElement ist ein Basis‑Interface, das von SVGLinearGradientElement und SVGRadialGradientElement verwendet wird."
type: docs

url: /de/java/com.aspose.html.dom.svg/svggradientelement/
---
## SVGGradientElement class

Das SVGGradientElement-Interface ist ein Basis-Interface, das von SVGLinearGradientElement und SVGRadialGradientElement verwendet wird.
...
| Name | Beschreibung |
| --- | --- |
| const [SVG_SPREADMETHOD_PAD](../../com.aspose.html.dom.svg/svggradientelement/svg_spreadmethod_pad/) | Entspricht dem Wert 'pad'. |
| const [SVG_SPREADMETHOD_REFLECT](../../com.aspose.html.dom.svg/svggradientelement/svg_spreadmethod_reflect/) | Entspricht dem Wert 'reflect'. |
| const [SVG_SPREADMETHOD_REPEAT](../../com.aspose.html.dom.svg/svggradientelement/svg_spreadmethod_repeat/) | Entspricht dem Wert 'repeat'. |
| const [SVG_SPREADMETHOD_UNKNOWN](../../com.aspose.html.dom.svg/svggradientelement/svg_spreadmethod_unknown/) | Der Typ ist keiner der vordefinierten Typen. Es ist ungültig, einen neuen Wert dieses Typs zu definieren oder zu versuchen, einen bestehenden Wert zu diesem Typ zu wechseln. |
