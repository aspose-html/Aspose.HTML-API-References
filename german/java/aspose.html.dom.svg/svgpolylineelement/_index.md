...
Die SVGPolylineElement-Schnittstelle entspricht dem ‘polyline’-Element.
...
| Name | Beschreibung |
| --- | --- |
| [getAnimatedPoints](../../com.aspose.html.dom.svg/svgpolylineelement/animatedpoints/) Bietet Zugriff auf die aktuellen animierten Inhalte des Attributs ‘points’. Wenn das angegebene Attribut oder die Eigenschaft animiert wird, enthält es den aktuellen animierten Wert des Attributs oder der Eigenschaft. Wenn das angegebene Attribut oder die Eigenschaft derzeit nicht animiert wird, enthält es denselben Wert wie points. |
...
| [getPoints](../../com.aspose.html.dom.svg/svgpolylineelement/points/) Bietet Zugriff auf die Basis (d. h. statischen) Inhalte des Attributs ‘points’. |
