...
description: "com.aspose.html.dom.svg.SVGComponentTransferFunctionElement Klasse. Dieses Interface definiert eine Basisschnittstelle, die von den Komponenten‑Transferfunktion‑Interfaces verwendet wird."
type: docs

url: /de/java/com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/
---
## SVGComponentTransferFunctionElement class

Dieses Interface definiert ein Basis-Interface, das von den Komponenten-Transferfunktion-Interfaces verwendet wird.
...
| Name | Beschreibung |
| --- | --- |
| [getAmplitude](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/amplitude/) Entspricht dem Attribut ‘amplitude’ im angegebenen Element. |
...
| [getExponent](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/exponent/) Entspricht dem Attribut ‘exponent’ im angegebenen Element. |
...
| [getIntercept](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/intercept/) Entspricht dem Attribut ‘intercept’ im angegebenen Element. |
...
| [getOffset](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/offset/) Entspricht dem Attribut ‘offset’ im angegebenen Element. |
[getOuterHTML]
...
| [getSlope](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/slope/) Entspricht dem Attribut ‘slope’ im angegebenen Element. |
...
| [getTableValues](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/tablevalues/) Entspricht dem Attribut ‘tableValues’ im angegebenen Element. |
...
| [getType](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/type/) Entspricht dem Attribut ‘type’ im angegebenen Element. Akzeptiert einen der auf diesem Interface definierten SVG_FECOMPONENTTRANSFER_TYPE_*-Konstanten. |
...
| Name | Beschreibung |
| --- | --- |
| const [SVG_FECOMPONENTTRANSFER_TYPE_DISCRETE](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_discrete/) | Entspricht dem Wert 'discrete'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_GAMMA](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_gamma/) | Entspricht dem Wert 'gamma'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_IDENTITY](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_identity/) | Entspricht dem Wert 'identity'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_LINEAR](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_linear/) | Entspricht dem Wert 'linear'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_TABLE](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_table/) | Entspricht dem Wert 'table'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_UNKNOWN](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_unknown/) | Der Typ ist keiner der vordefinierten Typen. Es ist ungültig, einen neuen Wert dieses Typs zu definieren oder zu versuchen, einen bestehenden Wert zu diesem Typ zu wechseln. |
