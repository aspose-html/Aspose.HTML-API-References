...
Die SVGRectElement-Schnittstelle entspricht dem ‘rect’-Element.
...
| [getPointAtLength](../../com.aspose.html.dom.svg/svggeometryelement/getpointatlength/)(float) | Gibt die (x,y)-Koordinate im Benutzerraum zurück, die in Abstandseinheiten entlang des Pfads liegt und den distance-along-a-path-Algorithmus des Benutzeragents verwendet. |
...
| [getTotalLength](../../com.aspose.html.dom.svg/svggeometryelement/gettotallength/)() | Gibt den vom Benutzeragenten berechneten Wert für die Gesamtlänge des Pfads zurück, wobei der distance-along-a-path-Algorithmus des Benutzeragents verwendet wird, als Abstand im aktuellen Benutzerkoordinatensystem. |
