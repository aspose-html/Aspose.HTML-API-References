...
description: "com.aspose.html.dom.svg.SVGElementInstance Klasse. Das Wurzelobjekt jedes use-element Schattenbaums implementiert das SVGUseElementShadowRoot Interface. Dieses Interface definiert derzeit keine Erweiterungen zu den Eigenschaften und Methoden, die für das ShadowRoot Interface und das DocumentOrShadowRoot Mixin definiert sind. Der Baum, der an diesem Knoten wurzelt, ist jedoch aus Sicht von Autorenskripten vollständig schreibgeschützt."
type: docs
...
Das Wurzelobjekt jedes use-Element-Shadow-Baums implementiert das SVGUseElementShadowRoot-Interface. Dieses Interface definiert derzeit keine Erweiterungen zu den für das ShadowRoot-Interface und das DocumentOrShadowRoot-Mixin definierten Eigenschaften und Methoden. Der Baum, der an diesem Knoten verwurzelt ist, ist jedoch aus Sicht von Autorenskripten vollständig schreibgeschützt.
