...
| [XpsDevice](xpsdevice/#constructor_1)(XpsRenderingOptions, ICreateStreamProvider) | Initialisiert eine neue Instanz der `XpsDevice`‑Klasse mittels Rendering‑Optionen und Stream‑Provider. |
| [XpsDevice](xpsdevice/#constructor_2)(XpsRenderingOptions, Stream) | Initialisiert eine neue Instanz der `XpsDevice`‑Klasse mittels Rendering‑Optionen und Ausgabestream. |
| [XpsDevice](xpsdevice/#constructor_3)(XpsRenderingOptions, String) | Initialisiert eine neue Instanz der `XpsDevice`‑Klasse mittels Rendering‑Optionen und Ausgabedateinamen. |
...
| Name | Beschreibung |
| --- | --- |
| class [XpsGraphicContext](../../com.aspose.html.rendering.xps/xpsdevice.xpsgraphiccontext) | Enthält aktuelle Grafiksteuerungsparameter für das XpsDevice. Diese Parameter definieren das globale Framework, innerhalb dessen die Grafikoperatoren ausgeführt werden. |
