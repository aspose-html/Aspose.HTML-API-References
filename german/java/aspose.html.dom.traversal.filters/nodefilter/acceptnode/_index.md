...
description: "NodeFilter-Methode. Prüft, ob ein bestimmter Knoten in der logischen Ansicht eines TreeWalker oder NodeIterator sichtbar ist. Diese Funktion wird von der Implementierung von TreeWalker und NodeIterator aufgerufen und wird normalerweise nicht direkt aus dem Benutzercode heraus aufgerufen. Sie könnten dies jedoch tun, wenn Sie denselben Filter verwenden möchten, um Ihre Anwendungslogik zu steuern."
type: docs
