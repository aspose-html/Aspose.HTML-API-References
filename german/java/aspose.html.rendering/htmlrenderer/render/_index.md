...
Definiert eine Methode zum Rendern mehrerer [`HTMLDocument`](../../../com.aspose.html/htmldocument/)s in ein bestimmtes [`IDevice`](../../idevice/), wobei ein Cancellation‑Token verwendet wird, um den Abbruch der Operation anzufordern.
