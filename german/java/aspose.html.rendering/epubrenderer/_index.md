...
| [render](../../com.aspose.html.rendering/epubrenderer/render/#render_9)(IDevice, CancellationToken, params Stream[]) | Definiert eine Methode zum Rendern mehrerer EPub‑Dokumente in ein bestimmtes [`IDevice`](../idevice/), wobei ein Cancellation‑Token verwendet wird, um die Stornierung des Vorgangs anzufordern. |
