...
description: "Converter-Methode. Füge die Vorlagenquelle, die durch HTMLDocument bereitgestellt wird, mit den Vorlagendaten XML JSON zusammen. Das Ergebnis ist eine HTML-Datei, die über den Ausgabepfad erstellt wird."
type: docs
...
Füge die Vorlagenquelle, die durch [`HTMLDocument`](../../../com.aspose.html/htmldocument/) bereitgestellt wird, mit den Vorlagendaten (XML, JSON) zusammen. Das Ergebnis ist eine HTML-Datei, die über den Ausgabepfad erstellt wird.
...
| Daten | TemplateData | Vorlagendaten zum Zusammenführen – Substitution (XML, JSON). |
| options | TemplateLoadOptions | [`TemplateLoadOptions`](../../../com.aspose.html.loading/templateloadoptions/) Objektinstanz. Es wird verwendet, um zu bestimmen, ob die Vorlagen- und Datenelementnamen übereinstimmen, unabhängig von Groß‑ und Kleinschreibung (Optionen). |
...
...
      ...
      // Definieren Sie ein Standard‑TemplateLoadOptions‑Objekt
...
Führen Sie die HTML‑Vorlage, die über [`URL`](../../../com.aspose.html/url/) bereitgestellt wird, mit den Vorlagendaten (XML, JSON) zusammen. Das Ergebnis ist eine HTML‑Datei, die über den Ausgabepfad erstellt wird.
...
Führen Sie die HTML-Vorlagenquelle, die über einen vollständigen Dateipfad bereitgestellt wird, mit den Vorlagendaten (XML, JSON) zusammen. Ergebnis ist eine HTML-Datei, die über den Ausgabepfad erstellt wird.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| sourcePath | String | Zusammenführen des HTML‑Skeletons, das über einen vollständigen Dateipfad bereitgestellt wird. |
| Daten | TemplateData | Vorlagendaten zum Zusammenführen – Substitution (XML, JSON). |
| options | TemplateLoadOptions | [`TemplateLoadOptions`](../../../com.aspose.html.loading/templateloadoptions/) Objektinstanz. Es wird verwendet, um zu bestimmen, ob die Vorlagen- und Datenelementnamen übereinstimmen, unabhängig von Groß‑ und Kleinschreibung (Optionen). |
| outputPath | String | Vollständiger HTML-Dateipfad als Ausgabekonvertierungsergebnis. |
...
Führen Sie die HTML-Vorlagenquelle, die als Inline-Inhalt bereitgestellt wird, mit den Vorlagendaten (XML, JSON) zusammen. Ergebnis ist eine HTML-Datei, die über den Ausgabepfad erstellt wird.
...
Führen Sie die Vorlagen‑HTML‑Quelle, die durch einen vollständigen Dateipfad dargestellt wird, mit den Vorlagendaten (XML, JSON) zusammen. Das Ergebnis ist ein neu erstelltes [`HTMLDocument`](../../../com.aspose.html/htmldocument/), das als Datei gespeichert werden kann.
