...
description: "Converter‑Methode. Konvertiert die von HTMLDocument bereitgestellte HTML‑Quelle. Ergebnis ist eine docx‑Datei, die am Ausgabepfad erstellt wird."
type: docs
...
Konvertiert die von [`HTMLDocument`](../../../com.aspose.html/htmldocument/) bereitgestellte HTML‑Quelle. Ergebnis ist eine docx‑Datei, die am Ausgabepfad erstellt wird.
...
Wie man HTML nach DOCX konvertiert
...
Das Hauptmerkmal von Aspose.HTML ist die Konvertierungsfunktion. Das Konvertieren zwischen Formaten ist aus verschiedenen Gründen erforderlich: um in einem vertrauten, praktischen Format zu arbeiten oder um die Vorteile verschiedener Formate für bestimmte Aufgaben zu nutzen. Das Paket com.aspose.html.converters bietet einfachen Zugriff auf Konvertierungsmethoden. Es stellt eine breite Palette von HTML‑Konvertierungen in gängige Formate bereit, wie z. B. [PDF](https://docs.fileformat.com/pdf/), [XPS](https://docs.fileformat.com/page-description-language/xps/), [DOCX](https://docs.fileformat.com/word-processing/docx/), [JPEG](https://docs.fileformat.com/image/jpeg/), [PNG](https://docs.fileformat.com/image/png/), [BMP](https://docs.fileformat.com/image/bmp/), [TIFF](https://docs.fileformat.com/image/tiff/), [GIF](https://docs.fileformat.com/image/gif/), [MHTML](https://docs.fileformat.com/web/mhtml/), und [MD](https://docs.fileformat.com/word-processing/md/).

Dieser Artikel liefert Informationen zur Liste der unterstützten HTML‑Konvertierungen und wie man sie mithilfe der Klasse [`Converter`](../) ausführt, die alle Low‑Level‑Konvertierungsoperationen in einer einzigen Klasse zusammenfasst, um sie bequem und einfach zu nutzen. Im HTML‑Converter‑Leitfaden finden Sie die folgenden Artikel:

DOCX‑Konvertierung

Eine DOCX-Datei ist ein Microsoft‑Word‑Dokument, das typischerweise den Text enthält, aber eine breite Palette von Daten umfassen kann, einschließlich Tabellen, Raster‑ und Vektorgrafiken, Video, Sounds und Diagramme. Die DOCX‑Datei ist hochgradig editierbar, einfach zu benutzen und in der Größe handhabbar. Dieses Format ist beliebt wegen der Vielzahl von Optionen, die es Benutzern bietet, jede Art von Dokumenten zu erstellen. Dieses Dateiformat ist eines der am weitesten verbreiteten und über zahlreiche Programme verfügbar.
...
Andere beliebte Formatkonvertierungen
...
Konvertiere die HTML-Quelle, die über eine URL bereitgestellt wird. Das Ergebnis ist eine DOCX-Datei, die über den Ausgabepfad erstellt wird.
...
Konvertiere die HTML-Quelle, die über einen vollständigen Dateipfad bereitgestellt wird, zu DOCX. Das Ergebnis ist eine DOCX-Datei, die über den Ausgabepfad erstellt wird.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| sourcePath | String | Html‑vollständiger Dateiquellpfad. |
| options | DocSaveOptions | [`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/) Objektverwendung ermöglicht es Ihnen, den Rendering‑Prozess anzupassen. Weitere Informationen finden Sie in der [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/html-to-docx/#convert-html-to-docx-using-docsaveoptions). |
| outputPath | String | Vollständiger docx‑Dateipfad als Ergebnis der Ausgabe‑Konvertierung. |
...
HTML-Quelle, die als Inline-Inhalt bereitgestellt wird, konvertieren. Ergebnis ist eine docx-Datei, die über den Ausgabedateipfad erstellt wird.
...
Konvertiere die HTML‑Quelle, die durch [`HTMLDocument`](../../../com.aspose.html/htmldocument/) bereitgestellt wird. Das Ergebnis ist eine PDF‑Datei, die über den Ausgabepfad erzeugt wird.
...
Portable Document Format (PDF) ist ein Dokumenttyp, der von Adobe in den 1990er‑Jahren erstellt wurde. Der Zweck dieses Dateiformats war es, einen Standard für die Darstellung von Dokumenten und anderem Referenzmaterial in einem Format einzuführen, das unabhängig von Anwendungssoftware, Hardware sowie Betriebssystem ist. Eine PDF‑Datei ist eine Menge von Bytes, die gemäß den Syntaxregeln der PDF‑Spezifikationen zu Tokens gruppiert werden können. Sobald ein oder mehrere Tokens zu höherstufigen syntaktischen Entitäten, hauptsächlich Objekten, kombiniert werden, bilden diese die grundlegenden Datenwerte, aus denen ein PDF‑Dokument aufgebaut ist.
...
Aspose.HTML bietet einen kostenlosen Online‑[HTML to PDF Converter](https://products.aspose.app/html/en/conversion/html-to-pdf), der HTML mit hoher Qualität, einfach und schnell zu PDF konvertiert. Laden Sie einfach Ihre Dateien hoch, konvertieren Sie sie und erhalten Sie die Ergebnisse in wenigen Sekunden!
...
... 
      ...
      // HTML‑Dokument auf eine von mehreren Arten erstellen
      using (var document = new HTMLDocument(sourcePath, configuration))
      {
		// Formular für Ergebnisdateipfad
		...
		// Konvertierungsprozess instanziieren
        Converter.ConvertHTML(document, options, resultPath);
      }
```
...
HTML-Quelle, die über eine URL bereitgestellt wird, konvertieren. Ergebnis ist eine pdf-Datei, die über den Ausgabedateipfad erstellt wird.
...
import com.aspose.html.converters;  
...      
      // Dateibasierte Quell‑Url erstellen
      var sourceUrl = new Url(Path.Combine(InputFolder, "source.html"));
...
Konvertiere die HTML-Quelle, die über einen vollständigen Dateipfad bereitgestellt wird, zu PDF. Das Ergebnis ist eine PDF-Datei, die über den Ausgabepfad erstellt wird.
...
HTML-Quelle, die als Inline-Inhalt bereitgestellt wird, in PDF konvertieren. Ergebnis ist eine pdf-Datei, die über den Ausgabedateipfad erstellt wird.
...
Konvertieren Sie die HTML‑Quelle, die durch [`HTMLDocument`](../../../com.aspose.html/htmldocument/) bereitgestellt wird, zu PDF. Das Ergebnis ist Ausgabedaten, die durch die [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) Schnittstellenimplementierung erzeugt werden.
...
Konvertieren Sie die HTML‑Quelle, die über einen vollständigen Dateipfad bereitgestellt wird, zu PDF. Das Ergebnis ist Ausgabedaten, die durch die [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) Schnittstellenimplementierung erzeugt werden.
...
Konvertieren Sie die HTML‑Quelle, die durch Inline‑Inhalt bereitgestellt wird, zu PDF. Das Ergebnis ist Ausgabedaten, die durch die [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) Schnittstellenimplementierung erzeugt werden.
...
| --- | --- | --- |
| document | HTMLDocument | Konvertierungsquelle, die durch [`HTMLDocument`](../../../com.aspose.html/htmldocument/) bereitgestellt wird. |
| options | MHTMLSaveOptions | Die Verwendung des [`MHTMLSaveOptions`](../../../com.aspose.html.saving/mhtmlsaveoptions/) Objekts ermöglicht es Ihnen, den Rendering‑Prozess anzupassen. Weitere Informationen finden Sie in der [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/html-to-mhtml/#convert-html-to-mhtml-using-mhtmlsaveoptions). |
| outputPath | String | Vollständiger mhtml‑(.mht‑)Dateipfad als Ergebnis der Ausgabeumwandlung. |

## Hinweise

Wie man HTML zu MHTML konvertiert
...
Aspose.HTML bietet einen kostenlosen Online‑[HTML to MHTML Converter](https://products.aspose.app/html/en/conversion/html-to-mhtml), der HTML mit hoher Qualität, einfach und schnell zu MHTML konvertiert. Laden Sie einfach Ihre Dateien hoch, konvertieren Sie sie und erhalten Sie die Ergebnisse in wenigen Sekunden!
...
... 
	...
	{
		// Definiere Standard-MHTMLSaveOptions-Objekt
...
Konvertiere die HTML-Quelle, die über eine URL bereitgestellt wird. Das Ergebnis ist eine MHTML‑Datei (.mht), die über den Ausgabepfad erstellt wird.
...
Konvertiere die HTML-Quelle, die über einen vollständigen Dateipfad bereitgestellt wird, zu MHTML. Das Ergebnis ist eine MHTML‑Datei (.mht), die über den Ausgabepfad erstellt wird.
...
HTML-Quelle, die als Inline-Inhalt bereitgestellt wird, in MHTML konvertieren. Ergebnis ist eine mhtml-Datei (.mht), die über den Ausgabedateipfad erstellt wird.
...
... 
	...
	// Definiere Standard-Speicheroptionen-Objekt
  	var options = new MHTMLSaveOptions();
...
Konvertierungsquelle. Erkenne eine vorhandene lokale HTML-Datei oder eine entfernte URL als Konvertierungsquelle. Du kannst sogar Inline-HTML-Inhalt als Konvertierungsquelle definieren oder ein HTML-Dokument ([`HTMLDocument`](../../../com.aspose.html/htmldocument/)) auf beliebige Weise erstellen. Konvertierungsergebnis. Definiere den Ausgabedateipfad des Ergebnisses oder verwende eine bekannte oder benutzerdefinierte [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) Schnittstellenimplementierung als Ausgabedatenpuffer. Erstelle ein neues [`MHTMLSaveOptions`](../../../com.aspose.html.saving/mhtmlsaveoptions/) Objekt mit benutzerdefinierten oder Standard‑Einstellungen. Du kannst außerdem [`configuration`](../../../com.aspose.html/configuration/) als Optionsparameter hinzufügen. Verwende die ConvertHTML()-Methode der Converter‑Klasse, um HTML als MHTML‑Ergebnis zu speichern; dies erfordert drei oder mehr Parameter, abhängig vom Anwendungsszenario. Online‑HTML‑Konverter
...
Konvertiere HTML-Quelle, die durch [`HTMLDocument`](../../../com.aspose.html/htmldocument/) präsentiert wird. Das Ergebnis ist eine Markdown‑(.md)‑Datei, die durch den Ausgabedateipfad erstellt wird.
...
Konvertierungsquelle. Erkenne eine vorhandene lokale HTML-Datei oder eine entfernte URL als Konvertierungsquelle. Du kannst sogar Inline-HTML-Inhalt als Konvertierungsquelle definieren oder ein HTML-Dokument ([`HTMLDocument`](../../../com.aspose.html/htmldocument/)) auf beliebige Weise erstellen. Konvertierungsergebnis. Definiere den Ausgabedateipfad des Ergebnisses oder verwende eine bekannte oder benutzerdefinierte [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) Schnittstellenimplementierung als Ausgabedatenpuffer. Erstelle ein neues [MarkdownSaveOptions](https://apireference.aspose.com/html/net/aspose.html.saving/markdownsaveoptions) Objekt mit benutzerdefinierten oder Standard‑Einstellungen. Du kannst außerdem [`configuration`](../../../com.aspose.html/configuration/) als Optionsparameter hinzufügen. Verwende die ConvertHTML()-Methode der Converter‑Klasse, um HTML als Markdown‑Ergebnis zu speichern; dies erfordert drei oder mehr Parameter, abhängig vom Anwendungsszenario. Online‑HTML‑Konverter

Aspose.HTML bietet einen kostenlosen Online‑[HTML‑zu‑Markdown](https://products.aspose.app/html/en/conversion/html-to-md) Dienst, der HTML mit hoher Qualität, einfach und schnell in MD konvertiert. Lade einfach deine Dateien hoch, konvertiere sie und erhalte die Ergebnisse in wenigen Sekunden!
...
... 
		...
		using (HTMLDocument document = new HTMLDocument(sourcePath, new Configuration()))
		{
			// Definiere Instanz des Speicheroptionen-Objekts
...
Konvertiere die HTML-Quelle, die über eine URL bereitgestellt wird. Das Ergebnis ist eine Markdown‑Datei (.md), die über den Ausgabepfad erstellt wird.
...
Konvertiere die HTML-Quelle, die über einen vollständigen Dateipfad bereitgestellt wird, zu Markdown. Das Ergebnis ist eine Markdown‑Datei (.md), die über den Ausgabepfad erstellt wird.
...
HTML-Quelle, die als Inline-Inhalt bereitgestellt wird, in Markdown konvertieren. Ergebnis ist eine mhtml-Datei (.mht), die über den Ausgabedateipfad erstellt wird.
...
Konvertiere HTML-Quelle, die durch [`HTMLDocument`](../../../com.aspose.html/htmldocument/) präsentiert wird. Das Ergebnis ist eine XPS-Datei, die durch den Ausgabedateipfad erstellt wird.
...
Konvertierungsquelle. Erkenne eine vorhandene lokale HTML-Datei oder eine entfernte URL als Konvertierungsquelle. Du kannst sogar Inline-HTML-Inhalt als Konvertierungsquelle definieren oder ein HTML-Dokument (HTMLDocument) auf beliebige Weise erstellen. Konvertierungsergebnis. Definiere den Ausgabedateipfad des Ergebnisses oder verwende eine bekannte oder benutzerdefinierte [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) Schnittstellenimplementierung als Ausgabedatenpuffer. Erstelle ein neues [`XpsSaveOptions`](../../../com.aspose.html.saving/xpssaveoptions/) Objekt mit benutzerdefinierten oder Standard‑Einstellungen. Du kannst außerdem [`configuration`](../../../com.aspose.html/configuration/) als Optionsparameter hinzufügen. Verwende die ConvertHTML()-Methode der Converter‑Klasse, um HTML als XPS‑Ergebnis zu speichern; dies erfordert drei oder mehr Parameter, abhängig vom Anwendungsszenario. Online‑HTML‑Konverter

Aspose.HTML bietet einen kostenlosen Online‑[HTML‑zu‑XPS‑Konverter](https://products.aspose.app/html/en/conversion/html-to-xps), der HTML mit hoher Qualität, einfach und schnell in XPS konvertiert. Lade einfach deine Dateien hoch, konvertiere sie und erhalte die Ergebnisse in wenigen Sekunden!
...
HTML-Quelle, die über eine URL bereitgestellt wird, konvertieren. Ergebnis ist eine xps-Datei, die über den Ausgabedateipfad erstellt wird.
...
| url | Url | HTML‑Quelldokument‑URL – liefert eine Objekt‑Darstellung eines universellen Identifikators (URL). |
| configuration | Configuration | Die Umgebungs‑Konfiguration. Stellt das [`configuration`](../../../com.aspose.html/configuration/) Kontextobjekt dar, das verwendet wird, um die Umgebungseinstellungen für die Anwendung festzulegen. |
| options | XpsSaveOptions | [`XpsSaveOptions`](../../../com.aspose.html.saving/xpssaveoptions/) Objektverwendung ermöglicht es dir, den Rendering‑Prozess anzupassen. |
| outputPath | String | Vollständiger xps-Dateipfad als Ausgabe‑Konvertierungsergebnis. |
...
Konvertiere die HTML-Quelle, die über einen vollständigen Dateipfad bereitgestellt wird, zu XPS. Das Ergebnis ist eine XPS-Datei, die über den Ausgabepfad erstellt wird.
...
HTML-Quelle, die als Inline-Inhalt bereitgestellt wird, in XPS konvertieren. Ergebnis ist eine xps-Datei, die über den Ausgabedateipfad erstellt wird.
...
Konvertiere HTML-Quelle, die durch den vollständigen Dateipfad präsentiert wird, zu XPS. Das Ergebnis sind Ausgabedaten, die durch eine [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) Schnittstellenimplementierung erstellt werden.
...
HTML-Quelle, die durch Inline-Inhalt bereitgestellt wird, in XPS konvertieren. Ergebnis ist Ausgabedaten, die durch die Implementierung des [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) Interface erzeugt werden.
...
Aspose.HTML bietet einen kostenlosen Online-[HTML to XPS](https://products.aspose.app/html/en/conversion/html-to-xps) Konverter, der HTML mit hoher Qualität, einfach und schnell in XPS umwandelt. Laden Sie einfach Ihre Dateien hoch, konvertieren Sie sie und erhalten Sie Ergebnisse in wenigen Sekunden!
...
HTML-Quelle, die durch [`HTMLDocument`](../../../com.aspose.html/htmldocument/) bereitgestellt wird, konvertieren. Ergebnis ist eine Bilddatei, die über den Ausgabepfad erstellt wird.
...
| --- | --- | --- |
| document | HTMLDocument | Konvertierungsquelle, die durch [`HTMLDocument`](../../../com.aspose.html/htmldocument/) bereitgestellt wird. |
| options | ImageSaveOptions | Die Verwendung des [`ImageSaveOptions`](../../../com.aspose.html.saving/imagesaveoptions/)‑Objekts ermöglicht es Ihnen, den Rendering‑Prozess anzupassen. |
...
Konvertierungsquelle. Erkennen Sie eine vorhandene lokale HTML‑Datei oder eine entfernte URL als Konvertierungsquelle. Sie können sogar Inline‑HTML‑Inhalt als Konvertierungsquelle definieren oder ein HTML‑Dokument (HTMLDocument) auf beliebige Weise erstellen. Konvertierungsergebnis. Definieren Sie den Ausgabedateipfad des Ergebnisses oder verwenden Sie eine bekannte oder benutzerdefinierte Implementierung des [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) Interfaces als Ausgabedatenpuffer. Erstellen Sie ein neues [`ImageSaveOptions`](../../../com.aspose.html.saving/imagesaveoptions/)‑Objekt mit dem erforderlichen [`ImageFormat`](../../../com.aspose.html.rendering.image/imageformat/). Standardmäßig ist die Format‑Eigenschaft PNG. Sie können auch [`configuration`](../../../com.aspose.html/configuration/) als Optionsparameter hinzufügen. Verwenden Sie die Methode ConvertHTML() der Klasse Converter, um HTML als Bild mit drei oder mehr Parametern zu speichern, abhängig vom Anwendungsszenario. Online‑HTML‑Konverter

Aspose.HTML bietet einen kostenlosen Online-[HTML to PNG Converter](https://products.aspose.app/html/en/conversion/html-to-png) der HTML mit hoher Qualität, einfach und schnell in Bilder umwandelt. Laden Sie einfach Ihre Dateien hoch, konvertieren Sie sie und erhalten Sie Ergebnisse in wenigen Sekunden!
...
Konvertiere die HTML-Quelle, die über eine URL bereitgestellt wird. Das Ergebnis ist eine Bilddatei, die über den Ausgabepfad erstellt wird.
...
Konvertiere die HTML-Quelle, die über einen vollständigen Dateipfad bereitgestellt wird, in ein Bild. Das Ergebnis ist eine Bilddatei, die über den Ausgabepfad erstellt wird.
...
... 
	...
	// Definieren Sie die Instanz des Speicheroptions‑Objekts. PNG ist standardmäßig das Bildformat.
...
HTML-Quelle, die als Inline-Inhalt bereitgestellt wird, in ein Bild konvertieren. Ergebnis ist eine Bilddatei, die über den Ausgabedateipfad erstellt wird.
...
| configuration | Configuration | Die Umgebungs‑Konfiguration. Stellt das [`configuration`](../../../com.aspose.html/configuration/) Kontextobjekt dar, das verwendet wird, um die Umgebungseinstellungen für die Anwendung festzulegen. |
| options | ImageSaveOptions | Die Verwendung von ImageSaveOptions ermöglicht es Ihnen, den Rendering‑Prozess anzupassen. Sie können die [`page size`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/), die [`margins`](../../../com.aspose.html.drawing/page/margin/) und den [`CSS media-type`](../../../com.aspose.html.rendering/mediatype/) usw. festlegen. |
| provider | ICreateStreamProvider | Implementierung des Interfaces, das verwendet wird, um einen Ausgabestream zu erhalten. Weitere Informationen zu Anbietern finden Sie in der [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/html-to-jpg/#output-stream-providers). |
...
HTML-Quelle, die über den vollständigen Dateipfad bereitgestellt wird, in ein Bild konvertieren. Ergebnis sind Ausgabedaten, die durch die Implementierung des [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) Interfaces erzeugt werden.
...
| options | ImageSaveOptions | Die Verwendung von ImageSaveOptions ermöglicht es Ihnen, den Rendering‑Prozess anzupassen. Sie können die [`page size`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/), die [`margins`](../../../com.aspose.html.drawing/page/margin/) und den [`CSS media-type`](../../../com.aspose.html.rendering/mediatype/) usw. festlegen. |
| provider | ICreateStreamProvider | Implementierung des [`interface`](../../../com.aspose.html.io/icreatestreamprovider/)‑Interfaces, das verwendet wird, um einen Ausgabestream zu erhalten. Weitere Informationen zu Anbietern finden Sie in der [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/html-to-jpg/#output-stream-providers). |
