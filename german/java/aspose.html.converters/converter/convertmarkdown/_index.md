...
description: "Converter-Methode. Konvertiere die MD-Markdown-Quelle, die über einen Eingabestream bereitgestellt wird, zu HTML. Das Ergebnis ist ein HTMLDocument, das über den Ausgabepfad gespeichert werden kann."
type: docs
...
Konvertiere die MD (Markdown)-Quelle, die über einen Eingabestream bereitgestellt wird, zu HTML. Das Ergebnis ist [`HTMLDocument`](../../../com.aspose.html/htmldocument/), das über den Ausgabepfad gespeichert werden kann.
...
| --- | --- | --- |
| stream | Stream | MD (Markdown)-Konvertierungs-Eingabedatenstrom. |
...
Konvertierungsquelle. Erkennen Sie eine vorhandene lokale MD-Datei oder erstellen Sie einen Eingabedatenstrom als Konvertierungsquelle. Konvertierungsergebnis. Sie können direkt [`HTMLDocument`](../../../com.aspose.html/htmldocument/) erhalten oder den Ausgabepfad des Ergebnisses abhängig von der Methodensignatur festlegen. Verwenden Sie die Methode ConvertMarkdown() der Klasse Converter, um MD als HTML-Ergebnis zu speichern. Sie können auch [`configuration`](../../../com.aspose.html/configuration/) als optionalen Parameter hinzufügen. Online MD-Konverter

Vielleicht sind Sie auch an einem kostenlosen Online-[MD to HTML Converter](https://products.aspose.app/html/en/conversion/md-to-html) interessiert, der MD zu HTML mit hoher Qualität, einfach und schnell konvertiert. Laden Sie einfach Ihre Dateien hoch, konvertieren Sie sie und erhalten Sie die Ergebnisse in wenigen Sekunden! Außerdem können Sie weitere Online-MD-Konverter prüfen: [MD to PDF](https://products.aspose.app/html/en/conversion/md-to-pdf), [MD to DOCX](https://products.aspose.app/html/en/conversion/md-to-docx), [MD to XPS](https://products.aspose.app/html/en/conversion/md-to-xps) und passende [MD to image converters](https://docs.aspose.com/html/net/converting-between-formats/markdown-to-image/).
...
Konvertiere MD (Markdown)-Quelle, die über einen Eingabestream bereitgestellt wird, zu HTML. Ergebnis ist eine html-Datei, die über den Ausgabedateipfad erstellt wird.
...
Konvertiere die MD (Markdown)-Quelle, die über einen vollständigen Dateipfad bereitgestellt wird, zu HTML. Das Ergebnis ist [`HTMLDocument`](../../../com.aspose.html/htmldocument/), das über den Ausgabepfad gespeichert werden kann.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| sourcePath | String | MD (Markdown)-Quellpfad (vollständiger Dateipfad). |
...
Konvertiere MD (Markdown)-Quelle, die über einen vollständigen Dateipfad bereitgestellt wird, zu HTML. Ergebnis ist eine html-Datei, die über den Ausgabedateipfad erstellt wird.
