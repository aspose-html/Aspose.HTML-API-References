...
description: "com.aspose.html.dom.svg.filters.SVGFETurbulenceElement Klasse. Das SVGFETurbulenceElement‑Interface entspricht dem feTurbulence‑Element."
type: docs

url: /de/java/com.aspose.html.dom.svg.filters/svgfeturbulenceelement/
---
## SVGFETurbulenceElement class

Das SVGFETurbulenceElement-Interface entspricht dem ‘feTurbulence’-Element.
...
| [getBaseFrequencyX](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/basefrequencyx/) Entspricht dem Attribut ‘baseFrequency’ des angegebenen ‘feTurbulence’-Elements. Enthält die X‑Komponente des Attributs ‘baseFrequency’. |
| [getBaseFrequencyY](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/basefrequencyy/) Entspricht dem Attribut ‘baseFrequency’ des angegebenen ‘feTurbulence’-Elements. Enthält die Y‑Komponente des (möglicherweise automatisch berechneten) Attributs ‘baseFrequency’. |
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/height/) Entspricht dem Attribut ‘height’ des angegebenen ‘filter’-Elements. |
[getId]
...
| [getNumOctaves](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/numoctaves/) Entspricht dem Attribut ‘numOctaves’ des angegebenen ‘feTurbulence’-Elements. |
[getOuterHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/result/) Entspricht dem Attribut ‘result’ des angegebenen ‘filter’-Elements. |
| [getSeed](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/seed/) Entspricht dem Attribut ‘seed’ des angegebenen ‘feTurbulence’-Elements. |
...
| [getStitchTiles](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/stitchtiles/) Entspricht dem Attribut ‘stitchTiles’ des angegebenen ‘feTurbulence’-Elements. Akzeptiert einen der auf diesem Interface definierten SVG_STITCHTYPE_*‑Konstanten. |
...
| [getType](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/type/) Entspricht dem Attribut ‘type’ des angegebenen ‘feTurbulence’-Elements. Akzeptiert einen der auf diesem Interface definierten SVG_TURBULENCE_TYPE_*‑Konstanten. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/width/) Entspricht dem Attribut ‘width’ des angegebenen ‘filter’-Elements. |
| [X](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/x/) { get; } | Corresponds to attribute ‘x’ on the given ‘filter’ element. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/y/) { get; } | Corresponds to attribute ‘y’ on the given ‘filter’ element. |
...
| Name | Beschreibung |
| --- | --- |
| const [SVG_STITCHTYPE_NOSTITCH](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_stitchtype_nostitch/) | Entspricht dem Wert 'noStitch'. |
| const [SVG_STITCHTYPE_STITCH](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_stitchtype_stitch/) | Entspricht dem Wert 'stitch'. |
| const [SVG_STITCHTYPE_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_stitchtype_unknown/) | Der Typ ist keiner der vordefinierten Typen. Es ist ungültig, einen neuen Wert dieses Typs zu definieren oder zu versuchen, einen bestehenden Wert zu diesem Typ zu wechseln. |
| const [SVG_TURBULENCE_TYPE_FRACTALNOISE](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_turbulence_type_fractalnoise/) | Entspricht dem Wert 'fractalNoise'. |
| const [SVG_TURBULENCE_TYPE_TURBULENCE](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_turbulence_type_turbulence/) | Entspricht dem Wert 'turbulence'. |
| const [SVG_TURBULENCE_TYPE_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_turbulence_type_unknown/) | Der Typ ist keiner der vordefinierten Typen. Es ist ungültig, einen neuen Wert dieses Typs zu definieren oder zu versuchen, einen bestehenden Wert zu diesem Typ zu wechseln. |
