...
description: "com.aspose.html.dom.svg.filters.SVGFEDisplacementMapElement Klasse. Das SVGFEDisplacementMapElement-Interface entspricht dem feDisplacementMap-Element."
type: docs

url: /de/java/com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/
---
## SVGFEDisplacementMapElement class

Das SVGFEDisplacementMapElement-Interface entspricht dem ‘feDisplacementMap’-Element.
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/height/) Entspricht dem Attribut ‘height’ im angegebenen ‘filter’-Element. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/in1/) Entspricht dem Attribut ‘in’ im angegebenen ‘feDisplacementMap’-Element. |
| [getIn2](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/in2/) Entspricht dem Attribut ‘in2’ im angegebenen ‘feDisplacementMap’-Element. |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/result/) Entspricht dem Attribut ‘result’ im angegebenen ‘filter’-Element. |
| [getScale](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/scale/) Entspricht dem Attribut ‘scale’ im angegebenen ‘feDisplacementMap’-Element. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/width/) Entspricht dem Attribut ‘width’ im angegebenen ‘filter’-Element. |
| [X](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/x/) { get; } | Corresponds to attribute ‘x’ on the given ‘filter’ element. |
| [getXChannelSelector](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/xchannelselector/) Entspricht dem Attribut ‘xChannelSelector’ im angegebenen ‘feDisplacementMap’-Element. Akzeptiert einen der auf diesem Interface definierten SVG_CHANNEL_*‑Konstanten. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/y/) { get; } | Corresponds to attribute ‘y’ on the given ‘filter’ element. |
| [getYChannelSelector](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/ychannelselector/) Entspricht dem Attribut ‘yChannelSelector’ des angegebenen ‘feDisplacementMap’-Elements. Akzeptiert einen der auf diesem Interface definierten SVG_CHANNEL_*‑Konstanten. |
...
| Name | Beschreibung |
| --- | --- |
| const [SVG_CHANNEL_A](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_a/) | Entspricht dem Wert 'A'. |
| const [SVG_CHANNEL_B](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_b/) | Entspricht dem Wert 'B'. |
| const [SVG_CHANNEL_G](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_g/) | Entspricht dem Wert 'G'. |
| const [SVG_CHANNEL_R](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_r/) | Entspricht dem Wert 'R'. |
| const [SVG_CHANNEL_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_unknown/) | Der Typ ist keiner der vordefinierten Typen. Es ist ungültig, einen neuen Wert dieses Typs zu definieren oder zu versuchen, einen bestehenden Wert zu diesem Typ zu wechseln. |
