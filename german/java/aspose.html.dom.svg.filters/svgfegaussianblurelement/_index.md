...
description: "com.aspose.html.dom.svg.filters.SVGFEGaussianBlurElement Klasse. Die SVGFEGaussianBlurElement Schnittstelle entspricht dem feGaussianBlur-Element."
type: docs
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/height/) Entspricht dem Attribut ‘height’ des angegebenen ‘filter’-Elements. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/in1/) Entspricht dem Attribut ‘in’ des angegebenen ‘feGaussianBlur’-Elements. |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/result/) Entspricht dem Attribut ‘result’ des angegebenen ‘filter’-Elements. |
...
| [getStdDeviationX](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/stddeviationx/) Entspricht dem Attribut ‘stdDeviation’ des angegebenen ‘feGaussianBlur’-Elements. Enthält die X‑Komponente des Attributs ‘stdDeviation’. |
| [getStdDeviationY](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/stddeviationy/) Entspricht dem Attribut ‘stdDeviation’ des angegebenen ‘feGaussianBlur’-Elements. Enthält die Y‑Komponente (möglicherweise automatisch berechnet) des Attributs ‘stdDeviation’. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/width/) Entspricht dem Attribut ‘width’ des angegebenen ‘filter’-Elements. |
| [X](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/x/) { get; } | Entspricht dem Attribut ‘x’ des angegebenen ‘filter’-Elements. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/y/) { get; } | Entspricht dem Attribut ‘y’ des angegebenen ‘filter’-Elements. |
