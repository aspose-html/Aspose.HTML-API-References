...
description: "com.aspose.html.dom.svg.filters.SVGFECompositeElement Klasse. Das SVGFECompositeElement‑Interface entspricht dem feComposite‑Element"
type: docs

url: /de/java/com.aspose.html.dom.svg.filters/svgfecompositeelement/
---
## SVGFECompositeElement class

Das SVGFECompositeElement-Interface entspricht dem ‘feComposite’-Element.
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/height/) Entspricht dem Attribut ‘height’ des angegebenen ‘filter’-Elements. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/in1/) Entspricht dem Attribut ‘in’ des angegebenen ‘feComposite’-Elements. |
| [getIn2](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/in2/) Entspricht dem Attribut ‘in2’ des angegebenen ‘feComposite’-Elements. |
[getInnerHTML]
...
| [getK1](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k1/) Entspricht dem Attribut ‘k1’ des angegebenen ‘feComposite’-Elements. |
| [getK2](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k2/) Entspricht dem Attribut ‘k2’ des angegebenen ‘feComposite’-Elements. |
| [getK3](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k3/) Entspricht dem Attribut ‘k3’ des angegebenen ‘feComposite’-Elements. |
| [getK4](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k4/) Entspricht dem Attribut ‘k4’ des angegebenen ‘feComposite’-Elements. |
...
| [getOperator](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/operator/) Entspricht dem Attribut ‘operator’ des angegebenen ‘feComposite’-Elements. Akzeptiert einen der auf diesem Interface definierten SVG_FECOMPOSITE_OPERATOR_*‑Konstanten. |
[getOuterHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/result/) Entspricht dem Attribut ‘result’ des angegebenen ‘filter’-Elements. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/width/) Entspricht dem Attribut ‘width’ des angegebenen ‘filter’-Elements. |
| [X](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/x/) { get; } | Corresponds to attribute ‘x’ on the given ‘filter’ element. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/y/) { get; } | Corresponds to attribute ‘y’ on the given ‘filter’ element. |
...
| Name | Beschreibung |
| --- | --- |
| const [SVG_FECOMPOSITE_OPERATOR_ARITHMETIC](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_arithmetic/) | Entspricht dem Wert 'arithmetic'. |
| const [SVG_FECOMPOSITE_OPERATOR_ATOP](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_atop/) | Entspricht dem Wert 'atop'. |
| const [SVG_FECOMPOSITE_OPERATOR_IN](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_in/) | Entspricht dem Wert 'in'. |
| const [SVG_FECOMPOSITE_OPERATOR_OUT](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_out/) | Entspricht dem Wert 'out'. |
| const [SVG_FECOMPOSITE_OPERATOR_OVER](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_over/) | Entspricht dem Wert 'over'. |
| const [SVG_FECOMPOSITE_OPERATOR_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_unknown/) | Der Typ ist keiner der vordefinierten Typen. Es ist ungültig, einen neuen Wert dieses Typs zu definieren oder zu versuchen, einen bestehenden Wert zu diesem Typ zu wechseln. |
| const [SVG_FECOMPOSITE_OPERATOR_XOR](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_xor/) | Entspricht dem Wert 'xor'. |
