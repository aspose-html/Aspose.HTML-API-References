...
description: "com.aspose.html.dom.svg.filters.SVGFEBlendElement Klasse. Das SVGFEBlendElement-Interface entspricht dem feBlend-Element"
type: docs

url: /de/java/com.aspose.html.dom.svg.filters/svgfeblendelement/
---
## SVGFEBlendElement class

Das SVGFEBlendElement-Interface entspricht dem ‘feBlend’-Element.
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfeblendelement/height/) Entspricht dem Attribut ‘height’ im angegebenen ‘filter’-Element. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfeblendelement/in1/) Entspricht dem Attribut ‘in’ im angegebenen ‘feBlend’-Element. |
| [getIn2](../../com.aspose.html.dom.svg.filters/svgfeblendelement/in2/) Entspricht dem Attribut ‘in2’ im angegebenen ‘feBlend’-Element. |
[getInnerHTML]
...
| [getMode](../../com.aspose.html.dom.svg.filters/svgfeblendelement/mode/) Entspricht dem Attribut ‘mode’ im angegebenen ‘feBlend’-Element. Akzeptiert einen der auf diesem Interface definierten SVG_FEBLEND_MODE_*-Konstanten. |
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfeblendelement/result/) Entspricht dem Attribut ‘result’ im angegebenen ‘filter’-Element. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfeblendelement/width/) Entspricht dem Attribut ‘width’ im angegebenen ‘filter’-Element. |
| [X](../../com.aspose.html.dom.svg.filters/svgfeblendelement/x/) { get; } | Corresponds to attribute ‘x’ on the given ‘filter’ element. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfeblendelement/y/) { get; } | Corresponds to attribute ‘y’ on the given ‘filter’ element. |
...
| Name | Beschreibung |
| --- | --- |
| const [SVG_FEBLEND_MODE_COLOR](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_color/) | Entspricht dem Wert 'color'. |
| const [SVG_FEBLEND_MODE_COLOR_BURN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_color_burn/) | Entspricht dem Wert 'color_burn'. |
| const [SVG_FEBLEND_MODE_COLOR_DODGE](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_color_dodge/) | Entspricht dem Wert 'color_dodge'. |
| const [SVG_FEBLEND_MODE_DARKEN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_darken/) | Entspricht dem Wert 'darken'. |
| const [SVG_FEBLEND_MODE_DIFFERENCE](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_difference/) | Entspricht dem Wert 'difference'. |
| const [SVG_FEBLEND_MODE_EXCLUSION](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_exclusion/) | Entspricht dem Wert 'exclusion'. |
| const [SVG_FEBLEND_MODE_HARD_LIGHT](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_hard_light/) | Entspricht dem Wert 'hard_light'. |
| const [SVG_FEBLEND_MODE_HUE](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_hue/) | Entspricht dem Wert 'hue'. |
| const [SVG_FEBLEND_MODE_LIGHTEN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_lighten/) | Entspricht dem Wert 'lighten'. |
| const [SVG_FEBLEND_MODE_LUMINOSITY](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_luminosity/) | Entspricht dem Wert 'luminosity'. |
| const [SVG_FEBLEND_MODE_MULTIPLY](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_multiply/) | Entspricht dem Wert 'multiply'. |
| const [SVG_FEBLEND_MODE_NORMAL](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_normal/) | Entspricht dem Wert 'normal'. |
| const [SVG_FEBLEND_MODE_OVERLAY](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_overlay/) | Entspricht dem Wert 'overlay'. |
| const [SVG_FEBLEND_MODE_SATURATION](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_saturation/) | Entspricht dem Wert 'saturation'. |
| const [SVG_FEBLEND_MODE_SCREEN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_screen/) | Entspricht dem Wert 'screen'. |
| const [SVG_FEBLEND_MODE_SOFT_LIGHT](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_soft_light/) | Entspricht dem Wert 'soft_light'. |
| const [SVG_FEBLEND_MODE_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_unknown/) | Der Typ ist keiner der vordefinierten Typen. Es ist ungültig, einen neuen Wert dieses Typs zu definieren oder zu versuchen, einen bestehenden Wert zu diesem Typ zu wechseln. |
