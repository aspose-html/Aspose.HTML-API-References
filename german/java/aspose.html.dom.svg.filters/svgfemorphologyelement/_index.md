...
description: "com.aspose.html.dom.svg.filters.SVGFEMorphologyElement Klasse. Die SVGFEMorphologyElement Schnittstelle entspricht dem feMorphology-Element."
type: docs

url: /de/java/com.aspose.html.dom.svg.filters/svgfemorphologyelement/
---
## SVGFEMorphologyElement class

Das SVGFEMorphologyElement-Interface entspricht dem ‘feMorphology’-Element.
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/height/) Entspricht dem Attribut ‘height’ im angegebenen ‘filter’-Element. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/in1/) Entspricht dem Attribut ‘in’ im angegebenen ‘feMorphology’-Element. |
[getInnerHTML]
...
| [getOperator](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/operator/) Entspricht dem Attribut ‘operator’ des angegebenen ‘feMorphology’-Elements. Akzeptiert einen der auf diesem Interface definierten SVG_MORPHOLOGY_OPERATOR_*‑Konstanten. |
[getOuterHTML]
...
| [getRadiusX](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/radiusx/) Entspricht dem Attribut ‘radius’ des angegebenen ‘feMorphology’-Elements. |
| [getRadiusY](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/radiusy/) Entspricht dem Attribut ‘radius’ des angegebenen ‘feMorphology’-Elements. |
| [getResult](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/result/) Entspricht dem Attribut ‘result’ des angegebenen ‘filter’-Elements. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/width/) Entspricht dem Attribut ‘width’ des angegebenen ‘filter’-Elements. |
| [X](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/x/) { get; } | Corresponds to attribute ‘x’ on the given ‘filter’ element. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/y/) { get; } | Corresponds to attribute ‘y’ on the given ‘filter’ element. |
...
| Name | Beschreibung |
| --- | --- |
| const [SVG_MORPHOLOGY_OPERATOR_DILATE](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/svg_morphology_operator_dilate/) | Entspricht dem Wert 'dilate'. |
| const [SVG_MORPHOLOGY_OPERATOR_ERODE](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/svg_morphology_operator_erode/) | Entspricht dem Wert 'erode'. |
| const [SVG_MORPHOLOGY_OPERATOR_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/svg_morphology_operator_unknown/) | Der Typ ist keiner der vordefinierten Typen. Es ist ungültig, einen neuen Wert dieses Typs zu definieren oder zu versuchen, einen bestehenden Wert zu diesem Typ zu wechseln. |
