...
description: "com.aspose.html.dom.svg.filters.SVGFEColorMatrixElement Klasse. Das SVGFEColorMatrixElement‑Interface entspricht dem feColorMatrix‑Element"
type: docs

url: /de/java/com.aspose.html.dom.svg.filters/svgfecolormatrixelement/
---
## SVGFEColorMatrixElement class

Das SVGFEColorMatrixElement-Interface entspricht dem ‘feColorMatrix’-Element.
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/height/) Entspricht dem Attribut ‘height’ des angegebenen ‘filter’-Elements. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/in1/) Entspricht dem Attribut ‘in’ des angegebenen ‘feColorMatrix’-Elements. |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/result/) Entspricht dem Attribut ‘result’ des angegebenen ‘filter’-Elements. |
...
| [getType](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/type/) Entspricht dem Attribut ‘type’ des angegebenen ‘feColorMatrix’-Elements. Akzeptiert einen der auf diesem Interface definierten SVG_FECOLORMATRIX_TYPE_*‑Konstanten. |
| [getValues](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/values/) Entspricht dem Attribut ‘values’ des angegebenen ‘feColorMatrix’-Elements. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/width/) Entspricht dem Attribut ‘width’ des angegebenen ‘filter’-Elements. |
| [X](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/x/) { get; } | Corresponds to attribute ‘x’ on the given ‘filter’ element. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/y/) { get; } | Corresponds to attribute ‘y’ on the given ‘filter’ element. |
...
| Name | Beschreibung |
| --- | --- |
| const [SVG_FECOLORMATRIX_TYPE_HUEROTATE](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_huerotate/) | Entspricht dem Wert 'hueRotate'. |
| const [SVG_FECOLORMATRIX_TYPE_LUMINANCETOALPHA](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_luminancetoalpha/) | Entspricht dem Wert 'luminanceToAlpha'. |
| const [SVG_FECOLORMATRIX_TYPE_MATRIX](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_matrix/) | Entspricht dem Wert 'matrix'. |
| const [SVG_FECOLORMATRIX_TYPE_SATURATE](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_saturate/) | Entspricht dem Wert 'saturate'. |
| const [SVG_FECOLORMATRIX_TYPE_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_unknown/) | Der Typ ist keiner der vordefinierten Typen. Es ist ungültig, einen neuen Wert dieses Typs zu definieren oder zu versuchen, einen bestehenden Wert zu diesem Typ zu wechseln. |
