...
description: "FontMatcher-Methode. Diese Methode wird aufgerufen, wenn im Schriftarten‑Suchordner keine passende Schriftart gefunden wird. Sie sollte eine True‑Type‑Schrift basierend auf den fontMatchingProperties zurückgeben, die den charCode rendern kann, oder null, wenn eine solche Schriftart nicht verfügbar ist."
type: docs
...
Diese Methode wird aufgerufen, wenn im Schriftarten‑Suchordner keine passende Schriftart gefunden wird. Sie sollte eine TrueType-Schrift basierend auf den *fontMatchingProperties* zurückgeben, die *charCode* rendern kann, oder `null`, wenn eine solche Schriftart nicht verfügbar ist.
