...
description: Aspose.Html.Dom.Css.IStyleSheet koppel. Die StyleSheetSchnittstelle ist die abstrakte Basisschnittstelle für jede Art von Stylesheet. Es stellt ein einzelnes Stylesheet dar das einem strukturierten Dokument zugeordnet ist.
type: docs
weight: 590
url: /de/net/aspose.html.dom.css/istylesheet/
---
...
| [Href](../../aspose.html.dom.css/istylesheet/href/) { get; } | Wenn das Stylesheet ein verknüpftes Stylesheet ist, ist der Wert seines Attributs sein Speicherort. Für Inline-Stylesheets ist der Wert dieses Attributs null. |
| [Media](../../aspose.html.dom.css/istylesheet/media/) { get; } | Das beabsichtigte Zielmedium für Stilinformationen. |
...
| [Title](../../aspose.html.dom.css/istylesheet/title/) { get; } | Der Beratungstitel. |
| [Type](../../aspose.html.dom.css/istylesheet/type/) { get; } | Dies gibt die Stylesheet-Sprache für dieses Stylesheet an. Als Inhaltstyp wird die Stylesheet-Sprache angegeben (zB "text/css"). |
