...
description: Aspose.Html.Dom.Svg.SVGViewElement klas. Die SVGViewElementSchnittstelle entspricht dem viewElement.
type: docs
weight: 2410
url: /de/net/aspose.html.dom.svg/svgviewelement/
---
## SVGViewElement class

Die SVGViewElement-Schnittstelle entspricht dem 'view'-Element.
...
| [PreserveAspectRatio](../../aspose.html.dom.svg/svgviewelement/preserveaspectratio/) { get; } | Entspricht dem Attribut „preserveAspectRatio“ für das angegebene Element. |
...
| [ViewBox](../../aspose.html.dom.svg/svgviewelement/viewbox/) { get; } | Entspricht dem Attribut 'viewBox' des angegebenen Elements. |
...
| [ViewTarget](../../aspose.html.dom.svg/svgviewelement/viewtarget/) { get; } | Entspricht dem Attribut 'viewTarget' des angegebenen 'view'-Elements. Eine Liste von DOMString-Werten, die die im 'viewTarget'-Attribut aufgelisteten Namen enthalten. Jeder der DOMString-Werte kann mithilfe des Methodenaufrufs getElementById() mit dem entsprechenden Element verknüpft werden. |
| [ZoomAndPan](../../aspose.html.dom.svg/svgviewelement/zoomandpan/) { get; set; } | Entspricht dem Attribut 'zoomAndPan' des angegebenen Elements. Der Wert muss eine der auf dieser Schnittstelle definierten SVG_ZOOMANDPAN_*-Konstanten sein. |
