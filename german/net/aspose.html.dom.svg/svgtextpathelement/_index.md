...
description: Aspose.Html.Dom.Svg.SVGTextPathElement klas. Die SVGTextPathElementSchnittstelle entspricht dem textPathElement.
type: docs
weight: 2360
url: /de/net/aspose.html.dom.svg/svgtextpathelement/
---
...
| [Href](../../aspose.html.dom.svg/svgtextpathelement/href/) { get; } | Entspricht dem Attribut 'xlink:href' des angegebenen Elements. |
...
| [LengthAdjust](../../aspose.html.dom.svg/svgtextcontentelement/lengthadjust/) { get; } | Entspricht dem Attribut „lengthAdjust“ des angegebenen Elements. Der Wert muss eine der Längenanpassungskonstanten sein, die auf dieser Schnittstelle definiert sind. |
...
| [Method](../../aspose.html.dom.svg/svgtextpathelement/method/) { get; } | Entspricht dem Attribut „method“ des angegebenen „textPath“-Elements. |
...
| [Spacing](../../aspose.html.dom.svg/svgtextpathelement/spacing/) { get; } | Entspricht dem Attribut „spacing“ des angegebenen „textPath“-Elements. |
| [StartOffset](../../aspose.html.dom.svg/svgtextpathelement/startoffset/) { get; } | Entspricht dem Attribut „startOffset“ des angegebenen „textPath“-Elements. |
...
| [TextLength](../../aspose.html.dom.svg/svgtextcontentelement/textlength/) { get; } | Entspricht dem Attribut 'textLength' des angegebenen Elements. |
...
| Name | Beschreibung |
| --- | --- |
| const [TEXTPATH_METHODTYPE_ALIGN](../../aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_align/) | Entspricht Wert 'align'. |
| const [TEXTPATH_METHODTYPE_STRETCH](../../aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_stretch/) | Entspricht dem Wert 'stretch'. |
| const [TEXTPATH_METHODTYPE_UNKNOWN](../../aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_unknown/) | Die Enumeration wurde auf einen Wert gesetzt, der nicht zu den vordefinierten Typen gehört. Es ist ungültig, einen neuen Wert dieses Typs zu definieren oder einen vorhandenen Wert auf diesen Typ umzustellen. |
| const [TEXTPATH_SPACINGTYPE_AUTO](../../aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_auto/) | Entspricht Wert 'auto'. |
| const [TEXTPATH_SPACINGTYPE_EXACT](../../aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_exact/) | Entspricht Wert 'exakt'. |
| const [TEXTPATH_SPACINGTYPE_UNKNOWN](../../aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_unknown/) | Die Enumeration wurde auf einen Wert gesetzt, der nicht zu den vordefinierten Typen gehört. Es ist ungültig, einen neuen Wert dieses Typs zu definieren oder einen vorhandenen Wert auf diesen Typ umzustellen. |
