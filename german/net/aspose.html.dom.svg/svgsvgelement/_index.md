...
description: Eine Schlüsselschnittstellendefinition ist die SVGSVGElementSchnittstelle die dem svgElement entspricht. Diese Schnittstelle enthält verschiedene verschiedene häufig verwendete Hilfsmethoden wie z. B. Matrixoperationen und die Möglichkeit die Zeit des Neuzeichnens auf visuellen Wiedergabegeräten zu steuern.
type: docs
weight: 2270
url: /de/net/aspose.html.dom.svg/svgsvgelement/
---
## SVGSVGElement class
...
| [CurrentScale](../../aspose.html.dom.svg/svgsvgelement/currentscale) { get; set; } | Bei einem äußersten SVG-Element gibt dieses Attribut den aktuellen Skalierungsfaktor relativ zur ursprünglichen Ansicht an, um Vergrößerungs- und Schwenkvorgänge des Benutzers zu berücksichtigen, wie unter Vergrößerung und Schwenken beschrieben. Die DOM-Attribute currentScale und currentTranslate entsprechen der 2x3-Matrix [abcdef] = [currentScale 0 0 currentScale currentTranslate.x currentTranslate.y]. Wenn "Vergrößerung" aktiviert ist (dh zoomAndPan="magnify"), dann ist der Effekt so, als ob eine zusätzliche Transformation auf der äußersten Ebene des SVG-Dokumentfragments platziert wurde (dh außerhalb des äußersten SVG-Elements). Wenn darauf zugegriffen wird ein 'svg'-Element, das kein äußerstes svg-Element ist, es ist nicht definiert, welches Verhalten dieses Attribut hat. |
| [CurrentTranslate](../../aspose.html.dom.svg/svgsvgelement/currenttranslate) { get; } | Bei einem äußersten SVG-Element der entsprechende Übersetzungsfaktor, der die „Vergrößerung“ des Benutzers berücksichtigt. Wenn auf ein „svg“-Element zugegriffen wird, das kein äußerstes SVG-Element ist, ist nicht definiert, welches Verhalten dieses Attribut hat. |
...
| [Height](../../aspose.html.dom.svg/svgsvgelement/height) { get; } | Entspricht dem Attribut „Höhe“ des angegebenen „svg“-Elements. |
...
| [PreserveAspectRatio](../../aspose.html.dom.svg/svgsvgelement/preserveaspectratio) { get; } | Entspricht dem Attribut „preserveAspectRatio“ für das angegebene Element. |
...
| [ViewBox](../../aspose.html.dom.svg/svgsvgelement/viewbox) { get; } | Entspricht dem Attribut 'viewBox' des angegebenen Elements. |
...
| [Width](../../aspose.html.dom.svg/svgsvgelement/width) { get; } | Entspricht dem Attribut „Breite“ des angegebenen „svg“-Elements. |
| [X](../../aspose.html.dom.svg/svgsvgelement/x) { get; } | Entspricht dem Attribut 'x' des angegebenen 'svg'-Elements. |
| [Y](../../aspose.html.dom.svg/svgsvgelement/y) { get; } | Entspricht dem Attribut „y“ des angegebenen „svg“-Elements. |
| [ZoomAndPan](../../aspose.html.dom.svg/svgsvgelement/zoomandpan) { get; set; } | Entspricht dem Attribut 'zoomAndPan' des angegebenen Elements. Der Wert muss eine der auf dieser Schnittstelle definierten SVG_ZOOMANDPAN_*-Konstanten sein. |
...
| [AnimationsPaused](../../aspose.html.dom.svg/svgsvgelement/animationspaused)() | Gibt „true“ zurück, wenn sich dieses SVG-Dokumentfragment im angehaltenen Zustand befindet. |
...
| [CreateEvent](../../aspose.html.dom.svg/svgsvgelement/createevent)(string) | Erstellt eine[`Event`](../../aspose.html.dom.events/event) eines Typs, der von der Implementierung unterstützt wird. |
| [CreateSVGAngle](../../aspose.html.dom.svg/svgsvgelement/createsvgangle)() | Erstellt ein SVGAngle-Objekt außerhalb von Dokumentbäumen. Das Objekt wird auf den Wert 0 Grad (ohne Einheit) initialisiert. |
| [CreateSVGLength](../../aspose.html.dom.svg/svgsvgelement/createsvglength)() | Erstellt ein SVGLength-Objekt außerhalb von Dokumentbäumen. Das Objekt wird auf den Wert 0 Benutzereinheiten initialisiert. |
| [CreateSVGMatrix](../../aspose.html.dom.svg/svgsvgelement/createsvgmatrix)() | Erstellt ein SVGMatrix-Objekt außerhalb von Dokumentbäumen. Das Objekt wird mit der Identitätsmatrix initialisiert. |
| [CreateSVGNumber](../../aspose.html.dom.svg/svgsvgelement/createsvgnumber)() | Erstellt ein SVGNumber-Objekt außerhalb von Dokumentbäumen. Das Objekt wird auf einen Wert von Null initialisiert. |
| [CreateSVGPoint](../../aspose.html.dom.svg/svgsvgelement/createsvgpoint)() | Erstellt ein SVGPoint-Objekt außerhalb von Dokumentbäumen. Das Objekt wird auf den Punkt (0,0) im Benutzerkoordinatensystem initialisiert. |
| [CreateSVGRect](../../aspose.html.dom.svg/svgsvgelement/createsvgrect)() | Erstellt ein SVGRect-Objekt außerhalb von Dokumentbäumen. Das Objekt wird so initialisiert, dass alle Werte auf 0 Benutzereinheiten gesetzt werden. |
| [CreateSVGTransform](../../aspose.html.dom.svg/svgsvgelement/createsvgtransform)() | Erstellt ein SVGTransform-Objekt außerhalb von Dokumentbäumen. Das Objekt wird mit einer Identitätsmatrixtransformation (SVG_TRANSFORM_MATRIX) initialisiert. |
| [CreateSVGTransformFromMatrix](../../aspose.html.dom.svg/svgsvgelement/createsvgtransformfrommatrix)(SVGMatrix) | Erstellt ein SVGTransform-Objekt außerhalb von Dokumentbäumen. Das Objekt wird mit der gegebenen Matrixtransformation (dh SVG_TRANSFORM_MATRIX) initialisiert. Die Werte aus der Parametermatrix werden kopiert, der Matrixparameter wird nicht als SVGTransform::matrix. übernommen |
...
| [PauseAnimations](../../aspose.html.dom.svg/svgsvgelement/pauseanimations)() | Unterbricht (dh pausiert) alle derzeit laufenden Animationen, die innerhalb des SVG-Dokumentfragments definiert sind, das diesem 'svg'-Element entspricht, wodurch die diesem Dokumentfragment entsprechende Animationsuhr stillsteht, bis sie nicht mehr angehalten wird. |
...
| [UnpauseAnimations](../../aspose.html.dom.svg/svgsvgelement/unpauseanimations)() | Hebt die Unterbrechung auf (d. h. setzt die Pause fort) aktuell ausgeführter Animationen, die im SVG-Dokumentfragment definiert sind, wodurch die Animationsuhr ab dem Zeitpunkt fortgesetzt wird, zu dem sie unterbrochen wurde. |
