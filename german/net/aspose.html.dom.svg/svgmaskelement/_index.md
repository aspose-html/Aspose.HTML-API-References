...
description: Aspose.Html.Dom.Svg.SVGMaskElement klas. Die SVGMaskElementSchnittstelle entspricht dem maskElement.
type: docs
weight: 2170
url: /de/net/aspose.html.dom.svg/svgmaskelement/
---
...
| [Height](../../aspose.html.dom.svg/svgmaskelement/height/) { get; } | Entspricht dem Attribut 'height' auf dem gegebenen 'mask'-Element. Akzeptiert eine der in SVGUnitTypes. definierten Konstanten |
...
| [MaskContentUnits](../../aspose.html.dom.svg/svgmaskelement/maskcontentunits/) { get; } | Entspricht dem Attribut 'maskContentUnits' des angegebenen 'mask'-Elements. Akzeptiert eine der in SVGUnitTypes. definierten Konstanten |
| [MaskUnits](../../aspose.html.dom.svg/svgmaskelement/maskunits/) { get; } | Entspricht dem Attribut 'maskUnits' des angegebenen 'mask'-Elements. Akzeptiert eine der in SVGUnitTypes. definierten Konstanten |
...
| [RequiredExtensions](../../aspose.html.dom.svg/svgmaskelement/requiredextensions/) { get; } | Entspricht dem Attribut 'requiredExtensions' für das angegebene Element. |
| [RequiredFeatures](../../aspose.html.dom.svg/svgmaskelement/requiredfeatures/) { get; } | Entspricht dem Attribut 'requiredFeatures' für das angegebene Element. |
...
| [SystemLanguage](../../aspose.html.dom.svg/svgmaskelement/systemlanguage/) { get; } | Entspricht dem Attribut 'systemLanguage' des angegebenen Elements. |
...
| [Width](../../aspose.html.dom.svg/svgmaskelement/width/) { get; } | Entspricht dem Attribut 'width' auf dem gegebenen 'mask'-Element. Akzeptiert eine der in SVGUnitTypes. definierten Konstanten |
| [X](../../aspose.html.dom.svg/svgmaskelement/x/) { get; } | Entspricht dem Attribut 'x' auf dem gegebenen 'mask'-Element. Akzeptiert eine der in SVGUnitTypes. definierten Konstanten |
| [Y](../../aspose.html.dom.svg/svgmaskelement/y/) { get; } | Entspricht dem Attribut 'y' des angegebenen 'mask'-Elements. Akzeptiert eine der in SVGUnitTypes. definierten Konstanten |
