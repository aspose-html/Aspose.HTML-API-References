...
description: Aspose.Html.Dom.Svg.SVGPathElement klas. Die SVGPathElementSchnittstelle entspricht dem PfadElement.
type: docs
weight: 2190
url: /de/net/aspose.html.dom.svg/svgpathelement/
---
## SVGPathElement class

Die SVGPathElement-Schnittstelle entspricht dem 'Pfad'-Element.
...
| [FarthestViewportElement](../../aspose.html.dom.svg/svggraphicselement/farthestviewportelement/) { get; } | Das am weitesten entfernte 'svg'-Element. Null, wenn das aktuelle Element das äußerste SVG-Element ist. |
...
| [NearestViewportElement](../../aspose.html.dom.svg/svggraphicselement/nearestviewportelement/) { get; } | Das Element, das das aktuelle Ansichtsfenster festgelegt hat. Oft das nächste Vorfahren-'svg'-Element. Null, wenn das aktuelle Element das äußerste SVG-Element ist. |
...
| [RequiredExtensions](../../aspose.html.dom.svg/svggraphicselement/requiredextensions/) { get; } | Entspricht dem Attribut 'requiredExtensions' für das angegebene Element. |
| [RequiredFeatures](../../aspose.html.dom.svg/svggraphicselement/requiredfeatures/) { get; } | Entspricht dem Attribut 'requiredFeatures' für das angegebene Element. |
...
| [SystemLanguage](../../aspose.html.dom.svg/svggraphicselement/systemlanguage/) { get; } | Entspricht dem Attribut 'systemLanguage' des angegebenen Elements. |
...
| [Transform](../../aspose.html.dom.svg/svggraphicselement/transform/) { get; } | Entspricht dem Attribut 'transform' des angegebenen Elements. |
...
| [CreateSVGPathSegArcAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegarcabs/)(float, float, float, float, float, bool, bool) | Gibt ein eigenständiges, übergeordnetes SVGPathSegArcAbs-Objekt zurück. |
| [CreateSVGPathSegArcRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegarcrel/)(float, float, float, float, float, bool, bool) | Gibt ein eigenständiges, übergeordnetes SVGPathSegArcRel-Objekt zurück. |
| [CreateSVGPathSegClosePath](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegclosepath/)() | Gibt ein eigenständiges, übergeordnetes SVGPathSegClosePath-Objekt zurück. |
| [CreateSVGPathSegCurvetoCubicAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicabs/)(float, float, float, float, float, float) | Gibt ein eigenständiges, übergeordnetes SVGPathSegCurvetoCubicAbs-Objekt zurück. |
| [CreateSVGPathSegCurvetoCubicRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicrel/)(float, float, float, float, float, float) | Gibt ein eigenständiges, übergeordnetes SVGPathSegCurvetoCubicRel-Objekt zurück. |
| [CreateSVGPathSegCurvetoCubicSmoothAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothabs/)(float, float, float, float) | Gibt ein eigenständiges, übergeordnetes SVGPathSegCurvetoCubicSmoothAbs-Objekt zurück. |
| [CreateSVGPathSegCurvetoCubicSmoothRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothrel/)(float, float, float, float) | Gibt ein eigenständiges, übergeordnetes SVGPathSegCurvetoCubicSmoothRel-Objekt zurück. |
| [CreateSVGPathSegCurvetoQuadraticAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticabs/)(float, float, float, float) | Gibt ein eigenständiges, übergeordnetes SVGPathSegCurvetoQuadraticAbs-Objekt zurück. |
| [CreateSVGPathSegCurvetoQuadraticRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticrel/)(float, float, float, float) | Gibt ein eigenständiges, übergeordnetes SVGPathSegCurvetoQuadraticRel-Objekt zurück. |
| [CreateSVGPathSegCurvetoQuadraticSmoothAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothabs/)(float, float) | Gibt ein eigenständiges, übergeordnetes SVGPathSegCurvetoQuadraticSmoothAbs-Objekt zurück. |
| [CreateSVGPathSegCurvetoQuadraticSmoothRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothrel/)(float, float) | Gibt ein eigenständiges, übergeordnetes SVGPathSegCurvetoQuadraticSmoothRel-Objekt zurück. |
| [CreateSVGPathSegLinetoAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoabs/)(float, float) | Gibt ein eigenständiges, übergeordnetes SVGPathSegLinetoAbs-Objekt zurück. |
| [CreateSVGPathSegLinetoHorizontalAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetohorizontalabs/)(float) | Gibt ein eigenständiges, übergeordnetes SVGPathSegLinetoHorizontalAbs-Objekt zurück. |
| [CreateSVGPathSegLinetoHorizontalRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetohorizontalrel/)(float) | Gibt ein eigenständiges, übergeordnetes SVGPathSegLinetoHorizontalRel-Objekt zurück. |
| [CreateSVGPathSegLinetoRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetorel/)(float, float) | Gibt ein eigenständiges, übergeordnetes SVGPathSegLinetoRel-Objekt zurück. |
| [CreateSVGPathSegLinetoVerticalAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoverticalabs/)(float) | Gibt ein eigenständiges, übergeordnetes SVGPathSegLinetoVerticalAbs-Objekt zurück. |
| [CreateSVGPathSegLinetoVerticalRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoverticalrel/)(float) | Gibt ein eigenständiges, übergeordnetes SVGPathSegLinetoVerticalRel-Objekt zurück. |
| [CreateSVGPathSegMovetoAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegmovetoabs/)(float, float) | Gibt ein eigenständiges, übergeordnetes SVGPathSegMovetoAbs-Objekt zurück. |
| [CreateSVGPathSegMovetoRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegmovetorel/)(float, float) | Gibt ein eigenständiges, übergeordnetes SVGPathSegMovetoRel-Objekt zurück. |
...
| [GetEquivalentPath](../../aspose.html.dom.svg/svggeometryelement/getequivalentpath/)() | Gibt eine neue Instanzinstanz von zurück[`SVGPathSegList`](../../aspose.html.dom.svg.paths/svgpathseglist/) was darstellt[`SVGGeometryElement`](../svggeometryelement/) als Pfadsegmente. |
...
| [GetPointAtLength](../../aspose.html.dom.svg/svggeometryelement/getpointatlength/)(float) | Gibt die (x,y)-Koordinate im Benutzerraum zurück, die Entfernungseinheiten entlang des Pfads sind, unter Verwendung des Entfernungs-entlang-eines-Pfad-Algorithmus des Benutzeragenten. |
| [GetScreenCTM](../../aspose.html.dom.svg/svggraphicselement/getscreenctm/)() | Gibt die Transformationsmatrix von aktuellen Benutzereinheiten (dh nach Anwendung des 'transform'-Attributs, falls vorhanden) zur Mitteilung eines "Pixels" des übergeordneten Benutzeragenten zurück. Bei Anzeigegeräten entspricht dies idealerweise einem physischen Bildschirmpixel. Für andere Geräte oder Umgebungen, in denen die physikalischen Pixelgrößen nicht bekannt sind, kann stattdessen ein Algorithmus ähnlich der CSS2-Definition eines „Pixels“ verwendet werden. Beachten Sie, dass null zurückgegeben wird, wenn dieses Element nicht in den Dokumentbaum eingebunden ist. Diese Methode hätte besser als getClientCTM bezeichnet werden können, aber der Name getScreenCTM wird aus historischen Gründen beibehalten. |
| [GetTotalLength](../../aspose.html.dom.svg/svggeometryelement/gettotallength/)() | Gibt den berechneten Wert des Benutzeragenten für die Gesamtlänge des Pfads unter Verwendung des Entfernung-auf-einem-Pfad-Algorithmus des Benutzeragenten als Entfernung im aktuellen Benutzerkoordinatensystem zurück. |
