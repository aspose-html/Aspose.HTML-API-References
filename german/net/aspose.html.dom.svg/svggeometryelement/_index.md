...
description: Aspose.Html.Dom.Svg.SVGGeometryElement klas. Schnittstelle SVGGeometryElement stellt SVGElemente dar deren Wiedergabe durch Geometrie mit einem äquivalenten Pfad definiert ist und die gefüllt und gezeichnet werden können. Dazu gehören Pfade und die Grundformen.
type: docs
weight: 2090
url: /de/net/aspose.html.dom.svg/svggeometryelement/
---
## SVGGeometryElement class

Schnittstelle SVGGeometryElement stellt SVG-Elemente dar, deren Wiedergabe durch Geometrie mit einem äquivalenten Pfad definiert ist und die gefüllt und gezeichnet werden können. Dazu gehören Pfade und die Grundformen.
...
| [GetEquivalentPath](../../aspose.html.dom.svg/svggeometryelement/getequivalentpath/)() | Gibt eine neue Instanzinstanz von zurück[`SVGPathSegList`](../../aspose.html.dom.svg.paths/svgpathseglist/) was darstellt`SVGGeometryElement` als Pfadsegmente. |
