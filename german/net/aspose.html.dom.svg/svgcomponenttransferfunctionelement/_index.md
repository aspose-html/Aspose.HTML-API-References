...
description: Aspose.Html.Dom.Svg.SVGComponentTransferFunctionElement klas. Diese Schnittstelle definiert eine Basisschnittstelle die von den Schnittstellen der Komponentenübertragungsfunktion verwendet wird.
type: docs
weight: 1970
url: /de/net/aspose.html.dom.svg/svgcomponenttransferfunctionelement/
---
## SVGComponentTransferFunctionElement class

Diese Schnittstelle definiert eine Basisschnittstelle, die von den Schnittstellen der Komponentenübertragungsfunktion verwendet wird.
...
| Name | Beschreibung |
| --- | --- |
| [Amplitude](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/amplitude/) { get; } | Entspricht dem Attribut „Amplitude“ des angegebenen Elements. |
...
| [Exponent](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/exponent/) { get; } | Entspricht dem Attribut 'exponent' auf dem gegebenen Element. |
...
| [Intercept](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/intercept/) { get; } | Entspricht dem Attribut 'Intercept' auf dem angegebenen Element. |
...
| [Offset](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/offset/) { get; } | Entspricht dem Attribut 'offset' des angegebenen Elements. |
...
| [Slope](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/slope/) { get; } | Entspricht dem Attribut „Steigung“ des angegebenen Elements. |
...
| [TableValues](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/tablevalues/) { get; } | Entspricht dem Attribut 'tableValues' des angegebenen Elements. |
...
| [Type](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/type/) { get; } | Entspricht dem Attribut 'type' des angegebenen Elements. Akzeptiert eine der auf dieser Schnittstelle definierten SVG_FECOMPONENTTRANSFER_TYPE_*-Konstanten. |
...
| Name | Beschreibung |
| --- | --- |
| const [SVG_FECOMPONENTTRANSFER_TYPE_DISCRETE](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_discrete/) | Entspricht dem Wert 'diskret'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_GAMMA](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_gamma/) | Entspricht Wert 'Gamma'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_IDENTITY](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_identity/) | Entspricht Wert 'Identität'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_LINEAR](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_linear/) | Entspricht Wert 'linear'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_TABLE](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_table/) | Entspricht Wert 'Tabelle'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_UNKNOWN](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_unknown/) | Der Typ ist keiner der vordefinierten Typen. Es ist ungültig, einen neuen Wert dieses Typs zu definieren oder einen vorhandenen Wert auf diesen Typ umzustellen. |
