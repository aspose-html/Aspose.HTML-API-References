...
description: Aspose.Html.Dom.Svg.SVGPatternElement klas. Die SVGPatternElementSchnittstelle entspricht dem patternElement.
type: docs
weight: 2200
url: /de/net/aspose.html.dom.svg/svgpatternelement/
---
...
| [Height](../../aspose.html.dom.svg/svgpatternelement/height/) { get; } | Entspricht dem Attribut „Höhe“ des angegebenen „Muster“-Elements. |
| [Href](../../aspose.html.dom.svg/svgpatternelement/href/) { get; } | Entspricht dem Attribut 'xlink:href' des angegebenen Elements. |
...
| [PatternContentUnits](../../aspose.html.dom.svg/svgpatternelement/patterncontentunits/) { get; } | Entspricht dem Attribut 'patternContentUnits' des angegebenen 'pattern'-Elements. Akzeptiert eine der in SVGUnitTypes. definierten Konstanten |
| [PatternTransform](../../aspose.html.dom.svg/svgpatternelement/patterntransform/) { get; } | Entspricht dem Attribut 'patternTransform' des angegebenen 'pattern'-Elements. |
| [PatternUnits](../../aspose.html.dom.svg/svgpatternelement/patternunits/) { get; } | Entspricht dem Attribut 'patternUnits' des angegebenen 'pattern'-Elements. Akzeptiert eine der in SVGUnitTypes. definierten Konstanten |
...
| [PreserveAspectRatio](../../aspose.html.dom.svg/svgpatternelement/preserveaspectratio/) { get; } | Entspricht dem Attribut „preserveAspectRatio“ für das angegebene Element. |
...
| [RequiredExtensions](../../aspose.html.dom.svg/svgpatternelement/requiredextensions/) { get; } | Entspricht dem Attribut 'requiredExtensions' für das angegebene Element. |
| [RequiredFeatures](../../aspose.html.dom.svg/svgpatternelement/requiredfeatures/) { get; } | Entspricht dem Attribut 'requiredFeatures' für das angegebene Element. |
...
| [SystemLanguage](../../aspose.html.dom.svg/svgpatternelement/systemlanguage/) { get; } | Entspricht dem Attribut 'systemLanguage' des angegebenen Elements. |
...
| [ViewBox](../../aspose.html.dom.svg/svgpatternelement/viewbox/) { get; } | Entspricht dem Attribut 'viewBox' des angegebenen Elements. |
...
| [Width](../../aspose.html.dom.svg/svgpatternelement/width/) { get; } | Entspricht dem Attribut „Breite“ des angegebenen „Muster“-Elements. |
| [X](../../aspose.html.dom.svg/svgpatternelement/x/) { get; } | Entspricht dem Attribut 'x' auf dem gegebenen 'Muster'-Element. |
| [Y](../../aspose.html.dom.svg/svgpatternelement/y/) { get; } | Entspricht dem Attribut 'y' auf dem gegebenen 'pattern'-Element. |
