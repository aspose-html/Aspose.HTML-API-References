...
description: Aspose.Html.Dom.Svg.SVGRadialGradientElement klas. Die SVGRadialGradientElementSchnittstelle entspricht dem radialGradientElement.
type: docs
weight: 2230
url: /de/net/aspose.html.dom.svg/svgradialgradientelement/
---
...
| [Cx](../../aspose.html.dom.svg/svgradialgradientelement/cx/) { get; } | Entspricht dem Attribut 'cx' auf dem gegebenen 'radialGradient'-Element. |
| [Cy](../../aspose.html.dom.svg/svgradialgradientelement/cy/) { get; } | Entspricht dem Attribut 'cy' des angegebenen 'radialGradient'-Elements. |
...
| [Fr](../../aspose.html.dom.svg/svgradialgradientelement/fr/) { get; } | Entspricht dem Attribut „fr“ des angegebenen „radialGradient“-Elements. |
| [Fx](../../aspose.html.dom.svg/svgradialgradientelement/fx/) { get; } | Entspricht dem Attribut 'fx' des angegebenen 'radialGradient'-Elements. |
| [Fy](../../aspose.html.dom.svg/svgradialgradientelement/fy/) { get; } | Entspricht dem Attribut 'fy' des angegebenen 'radialGradient'-Elements. |
| [GradientTransform](../../aspose.html.dom.svg/svggradientelement/gradienttransform/) { get; } | Entspricht dem Attribut „gradientTransform“ des angegebenen Elements. |
| [GradientUnits](../../aspose.html.dom.svg/svggradientelement/gradientunits/) { get; } | Entspricht dem Attribut 'gradientUnits' des angegebenen Elements. Akzeptiert eine der in SVGUnitTypes. definierten Konstanten |
| [Href](../../aspose.html.dom.svg/svggradientelement/href/) { get; } | Entspricht dem Attribut 'xlink:href' des angegebenen Elements. |
...
| [R](../../aspose.html.dom.svg/svgradialgradientelement/r/) { get; } | Entspricht dem Attribut 'r' des angegebenen 'radialGradient'-Elements. |
...
| [SpreadMethod](../../aspose.html.dom.svg/svggradientelement/spreadmethod/) { get; } | Entspricht dem Attribut 'spreadMethod' des angegebenen Elements. Einer der auf dieser Schnittstelle definierten Spread-Methodentypen. |
