...
description: Aspose.Html.Dom.Svg.SVGAnimationElement klas. Die SVGAnimationElementSchnittstelle ist die Basisschnittstelle für alle Animationselementschnittstellen SVGAnimateElement SVGSetElement SVGAnimateColorElement SVGAnimateMotionElement und SVGAnimateTransformElement.
type: docs
weight: 1940
url: /de/net/aspose.html.dom.svg/svganimationelement/
---
## SVGAnimationElement class

Die SVGAnimationElement-Schnittstelle ist die Basisschnittstelle für alle Animationselementschnittstellen: SVGAnimateElement, SVGSetElement, SVGAnimateColorElement, SVGAnimateMotionElement und SVGAnimateTransformElement.
...
| [RequiredExtensions](../../aspose.html.dom.svg/svganimationelement/requiredextensions/) { get; } | Entspricht dem Attribut 'requiredExtensions' für das angegebene Element. |
| [RequiredFeatures](../../aspose.html.dom.svg/svganimationelement/requiredfeatures/) { get; } | Entspricht dem Attribut 'requiredFeatures' für das angegebene Element. |
...
| [SystemLanguage](../../aspose.html.dom.svg/svganimationelement/systemlanguage/) { get; } | Entspricht dem Attribut 'systemLanguage' des angegebenen Elements. |
| [TagName](../../aspose.html.dom/element/tagname/) { get; } | Der Name des Elements. |
| [TargetElement](../../aspose.html.dom.svg/svganimationelement/targetelement/) { get; } | Das Element, das animiert wird. |
