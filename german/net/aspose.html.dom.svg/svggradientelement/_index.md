...
description: Aspose.Html.Dom.Svg.SVGGradientElement klas. Die SVGGradientElementSchnittstelle ist eine Basisschnittstelle die von SVGLinearGradientElement und SVGRadialGradientElement verwendet wird.
type: docs
weight: 2100
url: /de/net/aspose.html.dom.svg/svggradientelement/
---
## SVGGradientElement class

Die SVGGradientElement-Schnittstelle ist eine Basisschnittstelle, die von SVGLinearGradientElement und SVGRadialGradientElement verwendet wird.
...
| Name | Beschreibung |
| --- | --- |
| const [SVG_SPREADMETHOD_PAD](../../aspose.html.dom.svg/svggradientelement/svg_spreadmethod_pad/) | Entspricht Wert 'pad'. |
| const [SVG_SPREADMETHOD_REFLECT](../../aspose.html.dom.svg/svggradientelement/svg_spreadmethod_reflect/) | Entspricht Wert 'reflektieren'. |
| const [SVG_SPREADMETHOD_REPEAT](../../aspose.html.dom.svg/svggradientelement/svg_spreadmethod_repeat/) | Entspricht dem Wert „wiederholen“. |
| const [SVG_SPREADMETHOD_UNKNOWN](../../aspose.html.dom.svg/svggradientelement/svg_spreadmethod_unknown/) | Der Typ ist keiner der vordefinierten Typen. Es ist ungültig, einen neuen Wert dieses Typs zu definieren oder einen vorhandenen Wert auf diesen Typ umzustellen. |
