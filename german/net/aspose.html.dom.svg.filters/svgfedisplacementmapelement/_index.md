...
description: Aspose.Html.Dom.Svg.Filters.SVGFEDisplacementMapElement klas. Die SVGFEDisplacementMapElementSchnittstelle entspricht dem feDisplacementMapElement.
type: docs
weight: 1420
url: /de/net/aspose.html.dom.svg.filters/svgfedisplacementmapelement/
---
## SVGFEDisplacementMapElement class

Die SVGFEDisplacementMapElement-Schnittstelle entspricht dem 'feDisplacementMap'-Element.
...
| [Height](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/height/) { get; } | Entspricht dem Attribut „Höhe“ des angegebenen „Filter“-Elements. |
...
| [In1](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/in1/) { get; } | Entspricht dem Attribut 'in' auf dem gegebenen 'feDisplacementMap'-Element. |
| [In2](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/in2/) { get; } | Entspricht dem Attribut 'in2' auf dem gegebenen 'feDisplacementMap'-Element. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/result/) { get; } | Entspricht dem Attribut „Ergebnis“ des angegebenen „Filter“-Elements. |
| [Scale](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/scale/) { get; } | Entspricht dem Attribut 'scale' auf dem gegebenen 'feDisplacementMap'-Element. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/width/) { get; } | Entspricht dem Attribut „Breite“ des angegebenen „Filter“-Elements. |
| [X](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/x/) { get; } | Entspricht dem Attribut 'x' im angegebenen 'filter'-Element. |
| [XChannelSelector](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/xchannelselector/) { get; } | Entspricht dem Attribut 'xChannelSelector' auf dem angegebenen Element 'feDisplacementMap'. Akzeptiert eine der auf dieser Schnittstelle definierten SVG_CHANNEL_*-Konstanten. |
| [Y](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/y/) { get; } | Entspricht dem Attribut 'y' des angegebenen 'filter'-Elements. |
| [YChannelSelector](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/ychannelselector/) { get; } | Entspricht dem Attribut 'yChannelSelector' auf dem gegebenen 'feDisplacementMap'-Element. Akzeptiert eine der auf dieser Schnittstelle definierten SVG_CHANNEL_*-Konstanten. |
...
| Name | Beschreibung |
| --- | --- |
| const [SVG_CHANNEL_A](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_a/) | Entspricht dem Wert 'A'. |
| const [SVG_CHANNEL_B](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_b/) | Entspricht Wert 'B'. |
| const [SVG_CHANNEL_G](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_g/) | Entspricht Wert 'G'. |
| const [SVG_CHANNEL_R](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_r/) | Entspricht Wert 'R'. |
| const [SVG_CHANNEL_UNKNOWN](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_unknown/) | Der Typ ist keiner der vordefinierten Typen. Es ist ungültig, einen neuen Wert dieses Typs zu definieren oder einen vorhandenen Wert auf diesen Typ umzustellen. |
