...
description: Aspose.Html.Dom.Svg.Filters.SVGFETurbulenceElement klas. Die SVGFETurbulenceElementSchnittstelle entspricht dem feTurbulenceElement.
type: docs
weight: 1600
url: /de/net/aspose.html.dom.svg.filters/svgfeturbulenceelement/
---
## SVGFETurbulenceElement class

Die SVGFETurbulenceElement-Schnittstelle entspricht dem 'feTurbulence'-Element.
...
| [BaseFrequencyX](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/basefrequencyx/) { get; } | Entspricht dem Attribut „baseFrequency“ des angegebenen „feTurbulence“-Elements. Enthält die X-Komponente des Attributs „baseFrequency“. |
| [BaseFrequencyY](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/basefrequencyy/) { get; } | Entspricht dem Attribut „baseFrequency“ des angegebenen „feTurbulence“-Elements. Enthält die Y-Komponente des (evtl. automatisch berechneten) 'baseFrequency'-Attributs. |
...
| [Height](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/height/) { get; } | Entspricht dem Attribut „Höhe“ des angegebenen „Filter“-Elements. |
...
| [NumOctaves](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/numoctaves/) { get; } | Entspricht dem Attribut 'numOctaves' auf dem gegebenen 'feTurbulence'-Element. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/result/) { get; } | Entspricht dem Attribut „Ergebnis“ des angegebenen „Filter“-Elements. |
| [SchemaTypeInfo](../../aspose.html.dom/element/schematypeinfo/) { get; } | Die diesem Element zugeordneten Typinformationen. |
| [Seed](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/seed/) { get; } | Entspricht dem Attribut 'Seed' auf dem angegebenen Element 'feTurbulence'. |
...
| [StitchTiles](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/stitchtiles/) { get; } | Entspricht dem Attribut 'stitchTiles' auf dem gegebenen 'feTurbulence'-Element. Akzeptiert eine der SVG_STITCHTYPE_*-Konstanten, die auf dieser Schnittstelle definiert sind. |
...
| [Type](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/type/) { get; } | Entspricht dem Attribut 'type' des angegebenen 'feTurbulence'-Elements. Akzeptiert eine der SVG_TURBULENCE_TYPE_*-Konstanten, die auf dieser Schnittstelle definiert sind. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/width/) { get; } | Entspricht dem Attribut „Breite“ des angegebenen „Filter“-Elements. |
| [X](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/x/) { get; } | Entspricht dem Attribut 'x' im angegebenen 'filter'-Element. |
| [Y](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/y/) { get; } | Entspricht dem Attribut 'y' des angegebenen 'filter'-Elements. |
...
| Name | Beschreibung |
| --- | --- |
| const [SVG_STITCHTYPE_NOSTITCH](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_stitchtype_nostitch/) | Entspricht Wert 'noStitch'. |
| const [SVG_STITCHTYPE_STITCH](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_stitchtype_stitch/) | Entspricht dem Wert 'Stich'. |
| const [SVG_STITCHTYPE_UNKNOWN](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_stitchtype_unknown/) | Der Typ ist keiner der vordefinierten Typen. Es ist ungültig, einen neuen Wert dieses Typs zu definieren oder einen vorhandenen Wert auf diesen Typ umzustellen. |
| const [SVG_TURBULENCE_TYPE_FRACTALNOISE](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_turbulence_type_fractalnoise/) | Entspricht dem Wert 'fractalNoise'. |
| const [SVG_TURBULENCE_TYPE_TURBULENCE](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_turbulence_type_turbulence/) | Entspricht Wert 'Turbulenz'. |
| const [SVG_TURBULENCE_TYPE_UNKNOWN](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_turbulence_type_unknown/) | Der Typ ist keiner der vordefinierten Typen. Es ist ungültig, einen neuen Wert dieses Typs zu definieren oder einen vorhandenen Wert auf diesen Typ umzustellen. |
