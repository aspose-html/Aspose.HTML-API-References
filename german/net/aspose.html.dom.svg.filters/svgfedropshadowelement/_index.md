...
description: Aspose.Html.Dom.Svg.Filters.SVGFEDropShadowElement klas. Die SVGFEDropShadowElementSchnittstelle entspricht dem feDropShadowElement.
type: docs
weight: 1440
url: /de/net/aspose.html.dom.svg.filters/svgfedropshadowelement/
---
## SVGFEDropShadowElement class

Die SVGFEDropShadowElement-Schnittstelle entspricht dem 'feDropShadow'-Element.
...
| [Dx](../../aspose.html.dom.svg.filters/svgfedropshadowelement/dx/) { get; } | Entspricht dem Attribut „dx“ des angegebenen „feDropShadow“-Elements. |
| [Dy](../../aspose.html.dom.svg.filters/svgfedropshadowelement/dy/) { get; } | Entspricht dem Attribut „dy“ des angegebenen „feDropShadow“-Elements. |
...
| [Height](../../aspose.html.dom.svg.filters/svgfedropshadowelement/height/) { get; } | Entspricht dem Attribut 'height' auf dem gegebenen 'feDropShadow'-Element. |
...
| [In1](../../aspose.html.dom.svg.filters/svgfedropshadowelement/in1/) { get; } | Entspricht dem Attribut „in“ des angegebenen „feDropShadow“-Elements. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfedropshadowelement/result/) { get; } | Entspricht dem Attribut 'result' auf dem gegebenen 'feDropShadow'-Element. |
...
| [StdDeviationX](../../aspose.html.dom.svg.filters/svgfedropshadowelement/stddeviationx/) { get; } | Entspricht dem Attribut „stdDeviation“ des angegebenen „feDropShadow“-Elements. Enthält die X-Komponente des Attributs 'stdDeviation'. |
| [StdDeviationY](../../aspose.html.dom.svg.filters/svgfedropshadowelement/stddeviationy/) { get; } | Entspricht dem Attribut „stdDeviation“ des angegebenen „feDropShadow“-Elements. Enthält die Y-Komponente (evtl. automatisch berechnet) des Attributs 'stdDeviation'. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfedropshadowelement/width/) { get; } | Entspricht dem Attribut 'width' auf dem gegebenen 'feDropShadow'-Element. |
| [X](../../aspose.html.dom.svg.filters/svgfedropshadowelement/x/) { get; } | Entspricht Attribut 'x' auf dem gegebenen 'feDropShadow'-Element. |
| [Y](../../aspose.html.dom.svg.filters/svgfedropshadowelement/y/) { get; } | Entspricht dem Attribut 'y' auf dem gegebenen 'feDropShadow'-Element. |
...
| [SetStdDeviation](../../aspose.html.dom.svg.filters/svgfedropshadowelement/setstddeviation/)(float, float) | Setzt die Werte für das Attribut 'stdDeviation'. |
