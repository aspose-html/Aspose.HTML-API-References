...
description: Aspose.Html.Dom.Svg.Filters.SVGFEColorMatrixElement klas. Die SVGFEColorMatrixElementSchnittstelle entspricht dem feColorMatrixElement.
type: docs
weight: 1370
url: /de/net/aspose.html.dom.svg.filters/svgfecolormatrixelement/
---
## SVGFEColorMatrixElement class

Die SVGFEColorMatrixElement-Schnittstelle entspricht dem 'feColorMatrix'-Element.
...
| [Height](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/height/) { get; } | Entspricht dem Attribut „Höhe“ des angegebenen „Filter“-Elements. |
...
| [In1](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/in1/) { get; } | Entspricht dem Attribut „in“ des angegebenen „feColorMatrix“-Elements. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/result/) { get; } | Entspricht dem Attribut „Ergebnis“ des angegebenen „Filter“-Elements. |
...
| [Type](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/type/) { get; } | Entspricht dem Attribut 'type' des angegebenen 'feColorMatrix'-Elements. Akzeptiert eine der auf dieser Schnittstelle definierten SVG_FECOLORMATRIX_TYPE_*-Konstanten. |
| [Values](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/values/) { get; } | Entspricht dem Attribut 'values' auf dem gegebenen 'feColorMatrix'-Element. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/width/) { get; } | Entspricht dem Attribut „Breite“ des angegebenen „Filter“-Elements. |
| [X](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/x/) { get; } | Entspricht dem Attribut 'x' im angegebenen 'filter'-Element. |
| [Y](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/y/) { get; } | Entspricht dem Attribut 'y' des angegebenen 'filter'-Elements. |
...
| Name | Beschreibung |
| --- | --- |
| const [SVG_FECOLORMATRIX_TYPE_HUEROTATE](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_huerotate/) | Entspricht Wert 'hueRotate'. |
| const [SVG_FECOLORMATRIX_TYPE_LUMINANCETOALPHA](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_luminancetoalpha/) | Entspricht Wert 'luminanceToAlpha'. |
| const [SVG_FECOLORMATRIX_TYPE_MATRIX](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_matrix/) | Entspricht Wert 'Matrix'. |
| const [SVG_FECOLORMATRIX_TYPE_SATURATE](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_saturate/) | Entspricht Wert 'sättigen'. |
| const [SVG_FECOLORMATRIX_TYPE_UNKNOWN](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_unknown/) | Der Typ ist keiner der vordefinierten Typen. Es ist ungültig, einen neuen Wert dieses Typs zu definieren oder einen vorhandenen Wert auf diesen Typ umzustellen. |
