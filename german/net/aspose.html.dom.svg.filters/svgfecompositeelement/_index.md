...
description: Aspose.Html.Dom.Svg.Filters.SVGFECompositeElement klas. Die SVGFECompositeElementSchnittstelle entspricht dem feCompositeElement.
type: docs
weight: 1390
url: /de/net/aspose.html.dom.svg.filters/svgfecompositeelement/
---
## SVGFECompositeElement class

Die SVGFECompositeElement-Schnittstelle entspricht dem 'feComposite'-Element.
...
| [Height](../../aspose.html.dom.svg.filters/svgfecompositeelement/height/) { get; } | Entspricht dem Attribut „Höhe“ des angegebenen „Filter“-Elements. |
...
| [In1](../../aspose.html.dom.svg.filters/svgfecompositeelement/in1/) { get; } | Entspricht dem Attribut „in“ des angegebenen „feComposite“-Elements. |
| [In2](../../aspose.html.dom.svg.filters/svgfecompositeelement/in2/) { get; } | Entspricht dem Attribut „in2“ des angegebenen „feComposite“-Elements. |
...
| [K1](../../aspose.html.dom.svg.filters/svgfecompositeelement/k1/) { get; } | Entspricht dem Attribut „k1“ des angegebenen „feComposite“-Elements. |
| [K2](../../aspose.html.dom.svg.filters/svgfecompositeelement/k2/) { get; } | Entspricht dem Attribut „k2“ des angegebenen „feComposite“-Elements. |
| [K3](../../aspose.html.dom.svg.filters/svgfecompositeelement/k3/) { get; } | Entspricht dem Attribut „k3“ des angegebenen „feComposite“-Elements. |
| [K4](../../aspose.html.dom.svg.filters/svgfecompositeelement/k4/) { get; } | Entspricht dem Attribut 'k4' des angegebenen 'feComposite'-Elements. |
...
| [Operator](../../aspose.html.dom.svg.filters/svgfecompositeelement/operator/) { get; } | Entspricht dem Attribut 'operator' des angegebenen 'feComposite'-Elements. Akzeptiert eine der SVG_FECOMPOSITE_OPERATOR_*-Konstanten, die auf dieser Schnittstelle definiert sind. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfecompositeelement/result/) { get; } | Entspricht dem Attribut „Ergebnis“ des angegebenen „Filter“-Elements. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfecompositeelement/width/) { get; } | Entspricht dem Attribut „Breite“ des angegebenen „Filter“-Elements. |
| [X](../../aspose.html.dom.svg.filters/svgfecompositeelement/x/) { get; } | Entspricht dem Attribut 'x' im angegebenen 'filter'-Element. |
| [Y](../../aspose.html.dom.svg.filters/svgfecompositeelement/y/) { get; } | Entspricht dem Attribut 'y' des angegebenen 'filter'-Elements. |
...
| Name | Beschreibung |
| --- | --- |
| const [SVG_FECOMPOSITE_OPERATOR_ARITHMETIC](../../aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_arithmetic/) | Entspricht dem Wert 'arithmetic'. |
| const [SVG_FECOMPOSITE_OPERATOR_ATOP](../../aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_atop/) | Entspricht Wert 'atop'. |
| const [SVG_FECOMPOSITE_OPERATOR_IN](../../aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_in/) | Entspricht Wert 'in'. |
| const [SVG_FECOMPOSITE_OPERATOR_OUT](../../aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_out/) | Entspricht dem Wert 'out'. |
| const [SVG_FECOMPOSITE_OPERATOR_OVER](../../aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_over/) | Entspricht Wert 'über'. |
| const [SVG_FECOMPOSITE_OPERATOR_UNKNOWN](../../aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_unknown/) | Der Typ ist keiner der vordefinierten Typen. Es ist ungültig, einen neuen Wert dieses Typs zu definieren oder einen vorhandenen Wert auf diesen Typ umzustellen. |
| const [SVG_FECOMPOSITE_OPERATOR_XOR](../../aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_xor/) | Entspricht Wert 'xor'. |
