...
description: Aspose.Html.Dom.Events.FocusEvent klas. Die FocusEventSchnittstelle bietet spezifische kontextbezogene Informationen zu FocusEreignissen.
type: docs
weight: 780
...
| Name | Beschreibung |
| --- | --- |
| [FocusEvent](focusevent/#constructor)(string) | Initialisiert eine neue Instanz von`FocusEvent` Klasse. |
| [FocusEvent](focusevent/#constructor_1)(string, IDictionary&lt;string, object&gt;) | Initialisiert eine neue Instanz von`FocusEvent` Klasse. |
