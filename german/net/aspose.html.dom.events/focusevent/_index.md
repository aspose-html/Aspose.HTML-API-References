...
description: Die FocusEventSchnittstelle bietet spezifische kontextbezogene Informationen zu FocusEreignissen.
type: docs
weight: 790
url: /de/net/aspose.html.dom.events/focusevent/
---
## FocusEvent class

Die FocusEvent-Schnittstelle bietet spezifische kontextbezogene Informationen zu Focus-Ereignissen.
...
| Name | Beschreibung |
| --- | --- |
| [FocusEvent](focusevent#constructor)(string) | Initialisiert eine neue Instanz von[`FocusEvent`](../focusevent) Klasse. |
| [FocusEvent](focusevent#constructor_1)(string, IDictionary&lt;string, object&gt;) | Initialisiert eine neue Instanz von[`FocusEvent`](../focusevent) Klasse. |
...
| [RelatedTarget](../../aspose.html.dom.events/focusevent/relatedtarget) { get; } | Wird verwendet, um je nach Art des Ereignisses ein sekundäres Ereignisziel in Bezug auf ein Fokusereignis zu identifizieren. |
