...
description: Ereignisse die die CustomEventSchnittstelle verwenden können verwendet werden um benutzerdefinierte Daten zu übertragen.
type: docs
weight: 740
...
| Name | Beschreibung |
| --- | --- |
| [CustomEvent](customevent#constructor)(string) | Initialisiert eine neue Instanz von[`CustomEvent`](../customevent) Klasse. |
| [CustomEvent](customevent#constructor_1)(string, IDictionary&lt;string, object&gt;) | Initialisiert eine neue Instanz von[`CustomEvent`](../customevent) Klasse. |
