...
description: Aspose.Html.Dom.Events.ErrorEvent klas. DieErrorEvent liefert kontextbezogene Informationen zu Fehlern die während der Laufzeit aufgetreten sind.
type: docs
weight: 760
...
Die`ErrorEvent` liefert kontextbezogene Informationen zu Fehlern, die während der Laufzeit aufgetreten sind.
...
| Name | Beschreibung |
| --- | --- |
| [ErrorEvent](errorevent/#constructor_1)(Exception) | Initialisiert eine neue Instanz von`ErrorEvent` Klasse. |
| [ErrorEvent](errorevent/#constructor)(IDictionary&lt;string, object&gt;) | Initialisiert eine neue Instanz von`ErrorEvent` Klasse. |
