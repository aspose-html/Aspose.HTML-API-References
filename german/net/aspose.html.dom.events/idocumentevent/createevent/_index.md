...
type: docs
weight: 10
url: /de/net/aspose.html.dom.events/idocumentevent/createevent/
---
...
| Ausnahme | Bedingung |
| --- | --- |
| [DOMException](../../../aspose.html.dom/domexception/) | NOT_SUPPORTED_ERR: Wird ausgelöst, wenn die Implementierung den Typ von nicht unterstützt[`Event`](../../event/) Schnittstelle angefordert |

### Siehe auch

* class [Event](../../event/)
* interface [IDocumentEvent](../)
* namensraum [Aspose.Html.Dom.Events](../../idocumentevent/)
* Montage [Aspose.HTML](../../../)
