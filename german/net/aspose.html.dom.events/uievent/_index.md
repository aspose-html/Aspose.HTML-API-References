...
description: Aspose.Html.Dom.Events.UIEvent klas. Die UIEventSchnittstelle stellt spezifische Kontextinformationen bereit die mit Ereignissen der Benutzeroberfläche verknüpft sind.
type: docs
weight: 850
...
| Name | Beschreibung |
| --- | --- |
| [UIEvent](uievent/#constructor)(string) | Initialisiert eine neue Instanz von`UIEvent` Klasse. |
| [UIEvent](uievent/#constructor_1)(string, IDictionary&lt;string, object&gt;) | Initialisiert eine neue Instanz von`UIEvent` Klasse. |
