...
description: Die UIEventSchnittstelle stellt spezifische Kontextinformationen bereit die mit Ereignissen der Benutzeroberfläche verknüpft sind.
type: docs
weight: 860
url: /de/net/aspose.html.dom.events/uievent/
---
## UIEvent class

Die UIEvent-Schnittstelle stellt spezifische Kontextinformationen bereit, die mit Ereignissen der Benutzeroberfläche verknüpft sind.
...
| Name | Beschreibung |
| --- | --- |
| [UIEvent](uievent#constructor)(string) | Initialisiert eine neue Instanz von[`UIEvent`](../uievent) Klasse. |
| [UIEvent](uievent#constructor_1)(string, IDictionary&lt;string, object&gt;) | Initialisiert eine neue Instanz von[`UIEvent`](../uievent) Klasse. |
