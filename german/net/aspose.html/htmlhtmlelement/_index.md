...
description: Aspose.Html.HTMLHtmlElement klas. Wurzel eines HTMLDokuments. Siehe die HTMLElementdefinition in HTML 4.01.
type: docs
weight: 3290
url: /de/net/aspose.html/htmlhtmlelement/
---
## HTMLHtmlElement class

Wurzel eines HTML-Dokuments. Siehe die HTML-Elementdefinition in HTML 4.01.
...
| [Version](../../aspose.html/htmlhtmlelement/version/) { get; set; } | Versionsinformationen über die DTD des Dokuments. Siehe Definition des Versionsattributs in HTML 4.01. Dieses Attribut ist in HTML 4.01 veraltet. |
