...
description: Aspose.Html.HTMLLegendElement klas. Bietet eine Beschriftung für aFELDSATZ Gruppierung. Siehe Elementdefinition LEGENDE in HTML 4.01.
type: docs
weight: 3360
url: /de/net/aspose.html/htmllegendelement/
---
## HTMLLegendElement class

Bietet eine Beschriftung für a`FELDSATZ` Gruppierung. Siehe Elementdefinition LEGENDE in HTML 4.01.
...
| Name | Beschreibung |
| --- | --- |
| [AccessKey](../../aspose.html/htmllegendelement/accesskey/) { get; set; } | Ein aus einem Zeichen bestehender Zugriffsschlüssel für den Zugriff auf die Formularsteuerung. Siehe die accesskey-Attributdefinition in HTML 4.01. |
| [Align](../../aspose.html/htmllegendelement/align/) { get; set; } | Textausrichtung relativ zu`FELDSATZ` . Siehe die Attributdefinition von align in HTML 4.01. Dieses Attribut ist in HTML 4.01. veraltet. |
...
| [Form](../../aspose.html/htmllegendelement/form/) { get; } | Gibt die zurück`FORM` Element, das dieses Steuerelement enthält. Gibt zurück`Null` wenn sich dieses Steuerelement nicht im Kontext eines -Formulars befindet. |
