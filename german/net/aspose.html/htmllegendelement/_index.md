...
description: Bietet eine Beschriftung für aFELDSATZ Gruppierung. Siehe Elementdefinition LEGENDE in HTML 4.01.
type: docs
weight: 3350
...
| [Form](../../aspose.html/htmllegendelement/form) { get; } | Gibt die zurück`BILDEN` Element, das dieses Steuerelement enthält. Gibt zurück`Null` wenn sich dieses Steuerelement nicht im Kontext eines -Formulars befindet. |
