...
description: Aspose.Html.HTMLMenuElement klas. Menüliste. Siehe die Definition des MENUElements in HTML 4.01. Dieses Element ist in HTML 4.01 veraltet.
type: docs
weight: 3390
url: /de/net/aspose.html/htmlmenuelement/
---
## HTMLMenuElement class

Menüliste. Siehe die Definition des MENU-Elements in HTML 4.01. Dieses Element ist in HTML 4.01 veraltet.
...
| [Compact](../../aspose.html/htmlmenuelement/compact/) { get; set; } | Reduzieren Sie den Abstand zwischen Listenelementen. Siehe die kompakte Attributdefinition in HTML 4.01. Dieses Attribut ist in HTML 4.01 veraltet. |
