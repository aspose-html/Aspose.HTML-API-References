...
description: Aspose.Html.HTMLLinkElement klas. DieVERKNÜPFUNGelement gibt einen Link zu einer externen Ressource an und definiert die Beziehung dieses Dokuments zu dieser Ressource oder umgekehrt. Siehe die LINKElementdefinition in HTML 4.01 siehe auch die LinkStyle Schnittstelle im StyleSheetModul DOM Level 2 Stylesheets und CSS .
type: docs
weight: 3370
url: /de/net/aspose.html/htmllinkelement/
---
## HTMLLinkElement class

Die`VERKNÜPFUNG`element gibt einen Link zu einer externen Ressource an, und definiert die Beziehung dieses Dokuments zu dieser Ressource (oder umgekehrt). Siehe die LINK-Elementdefinition in HTML 4.01 (siehe auch die `LinkStyle` Schnittstelle im StyleSheet-Modul [[DOM Level 2 Stylesheets und CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113) ]).
...
| [Charset](../../aspose.html/htmllinkelement/charset/) { get; set; } | Die Zeichenkodierung der Ressource, mit der gelinkt wird. Siehe die charset Attributdefinition in HTML 4.01. |
...
| [Disabled](../../aspose.html/htmllinkelement/disabled/) { get; set; } | Aktiviert/deaktiviert den Link. Dies wird derzeit nur für Links zu Stylesheets verwendet und kann zum Aktivieren oder Deaktivieren von Stylesheets verwendet werden. |
...
| [Href](../../aspose.html/htmllinkelement/href/) { get; set; } | Der URI [[IETF-RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] der verlinkten Ressource. Siehe die href-Attributdefinition in HTML 4.01. |
| [Hreflang](../../aspose.html/htmllinkelement/hreflang/) { get; set; } | Sprachcode der verlinkten Ressource. Siehe die Definition des hreflang-Attributs in HTML 4.01. |
...
| [Media](../../aspose.html/htmllinkelement/media/) { get; set; } | Konzipiert für die Verwendung mit einem oder mehreren Zielmedien. Siehe Definition des Medienattributs in HTML 4.01. |
...
| [Rel](../../aspose.html/htmllinkelement/rel/) { get; set; } | Forward-Link-Typ. Siehe die rel-Attributdefinition in HTML 4.01. |
| [RelList](../../aspose.html/htmllinkelement/rellist/) { get; } | Gibt eine Live-DOMTokenList zurück, die Token enthält, die durch das Parsen des „rel“-Attributs empfangen wurden. |
| [Rev](../../aspose.html/htmllinkelement/rev/) { get; set; } | Reverse-Link-Typ. Siehe die rev-Attributdefinition in HTML 4.01. |
...
| [Sheet](../../aspose.html/htmllinkelement/sheet/) { get; } | Ruft das zugehörige Stylesheet ab. |
...
| [Target](../../aspose.html/htmllinkelement/target/) { get; set; } | Frame zum Rendern der Ressource. Siehe Zielattributdefinition in HTML 4.01. |
...
| [Type](../../aspose.html/htmllinkelement/type/) { get; set; } | Advisory-Inhaltstyp. Siehe die Typattributdefinition in HTML 4.01. |
