...
description: Aspose.Html.HTMLOptionElement klas. Eine wählbare Auswahl. Siehe Definition des OPTIONElements in HTML 4.01.
type: docs
weight: 3460
url: /de/net/aspose.html/htmloptionelement/
---
## HTMLOptionElement class

Eine wählbare Auswahl. Siehe Definition des OPTION-Elements in HTML 4.01.
...
| [DefaultSelected](../../aspose.html/htmloptionelement/defaultselected/) { get; set; } | Repräsentiert den Wert des ausgewählten HTML-Attributs. Der Wert dieses Attributs ändert sich nicht, wenn sich der Zustand des entsprechenden Steuerelements des Formulars in einem interaktiven Benutzeragenten ändert. Siehe die ausgewählte -Attributdefinition in HTML 4.01. @version DOM Level 2 |
...
| [Disabled](../../aspose.html/htmloptionelement/disabled/) { get; set; } | Das Steuerelement ist in diesem Kontext nicht verfügbar. Siehe die deaktivierte Attributdefinition in HTML 4.01. |
...
| [Form](../../aspose.html/htmloptionelement/form/) { get; } | Gibt die zurück`FORM` Element, das dieses Steuerelement enthält. Gibt zurück`Null` wenn sich dieses Steuerelement nicht im Kontext eines -Formulars befindet. |
| [Id](../../aspose.html/htmlelement/id/) { get; set; } | Der Bezeichner des Elements. Siehe die ID-Attributdefinition in HTML 4.01. |
| [Index](../../aspose.html/htmloptionelement/index/) { get; } | Der Index davon`MÖGLICHKEIT` in seinem Elternteil`WÄHLEN` , ab 0. @version DOM Level 2 |
...
| [Label](../../aspose.html/htmloptionelement/label/) { get; set; } | Optionsbezeichnung zur Verwendung in hierarchischen Menüs. Siehe Definition des Label-Attributs in HTML 4.01. |
...
| [Selected](../../aspose.html/htmloptionelement/selected/) { get; set; } | Repräsentiert den aktuellen Status des entsprechenden Formularsteuerelements in einem interaktiven -Benutzeragenten. Das Ändern dieses Attributs ändert den Status von des Formularsteuerelements, ändert jedoch nicht den Wert des HTML-ausgewählten -Attributs des Elements. |
...
| [Text](../../aspose.html/htmloptionelement/text/) { get; } | Der im Optionselement enthaltene Text. |
...
| [Value](../../aspose.html/htmloptionelement/value/) { get; set; } | Der aktuelle Formularsteuerwert. Siehe Definition des Wertattributs in HTML 4.01. |
