...
description: Eine wählbare Auswahl. Siehe Definition des OPTIONElements in HTML 4.01.
type: docs
weight: 3450
...
| [Form](../../aspose.html/htmloptionelement/form) { get; } | Gibt die zurück`BILDEN` Element, das dieses Steuerelement enthält. Gibt zurück`Null` wenn sich dieses Steuerelement nicht im Kontext eines -Formulars befindet. |
| [Id](../../aspose.html/htmlelement/id) { get; set; } | Der Bezeichner des Elements. Siehe die ID-Attributdefinition in HTML 4.01. |
| [Index](../../aspose.html/htmloptionelement/index) { get; } | Der Index davon`MÖGLICHKEIT` in seinem Elternteil`AUSWÄHLEN` , ab 0. @version DOM Level 2 |
