...
description: Aspose.Html.HTMLLabelElement klas. Beschriftungstext des Formularfelds. Siehe die Definition des LABELElements in HTML 4.01.
type: docs
weight: 3350
url: /de/net/aspose.html/htmllabelelement/
---
## HTMLLabelElement class

Beschriftungstext des Formularfelds. Siehe die Definition des LABEL-Elements in HTML 4.01.
...
| Name | Beschreibung |
| --- | --- |
| [AccessKey](../../aspose.html/htmllabelelement/accesskey/) { get; set; } | Ein aus einem Zeichen bestehender Zugriffsschlüssel für den Zugriff auf die Formularsteuerung. Siehe die accesskey-Attributdefinition in HTML 4.01. |
...
| [For](../../aspose.html/htmllabelelement/for/) { get; set; } | Dieses Attribut verknüpft dieses Label mit einem anderen Formularsteuerelement von `Ausweis`Attribut. Siehe die for-Attributdefinition in HTML 4.01. |
| [Form](../../aspose.html/htmllabelelement/form/) { get; } | Gibt die zurück`FORM` Element, das dieses Steuerelement enthält. Gibt zurück`Null` wenn sich dieses Steuerelement nicht im Kontext eines -Formulars befindet. |
