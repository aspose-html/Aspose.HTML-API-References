...
description: Beschriftungstext des Formularfelds. Siehe die Definition des LABELElements in HTML 4.01.
type: docs
weight: 3340
...
| [For](../../aspose.html/htmllabelelement/for) { get; set; } | Dieses Attribut verknüpft dieses Label mit einem anderen Formularsteuerelement von `Ich würde`Attribut. Siehe die for-Attributdefinition in HTML 4.01. |
| [Form](../../aspose.html/htmllabelelement/form) { get; } | Gibt die zurück`BILDEN` Element, das dieses Steuerelement enthält. Gibt zurück`Null` wenn sich dieses Steuerelement nicht im Kontext eines -Formulars befindet. |
