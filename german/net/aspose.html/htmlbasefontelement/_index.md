...
description: Aspose.Html.HTMLBaseFontElement klas. Basisschriftart. Siehe die BASEFONTElementdefinition in HTML 4.01. Dieses Element ist in HTML 4.01 veraltet.
type: docs
weight: 3110
url: /de/net/aspose.html/htmlbasefontelement/
---
## HTMLBaseFontElement class

Basisschriftart. Siehe die BASEFONT-Elementdefinition in HTML 4.01. Dieses Element ist in HTML 4.01 veraltet.
...
| [Color](../../aspose.html/htmlbasefontelement/color/) { get; set; } | Schriftfarbe. Siehe die Farbattributdefinition in HTML 4.01. Dieses -Attribut ist in HTML 4.01 veraltet. |
...
| [Face](../../aspose.html/htmlbasefontelement/face/) { get; set; } | Kennung der Schriftart. Siehe die Gesichtsattributdefinition in HTML 4.01. Dieses Attribut ist in HTML 4.01 veraltet. |
...
| [Size](../../aspose.html/htmlbasefontelement/size/) { get; set; } | Berechnete Schriftgröße. Siehe Definition des Größenattributs in HTML 4.01. Dieses Attribut ist in HTML 4.01 veraltet. @Version DOM Level 2 |
