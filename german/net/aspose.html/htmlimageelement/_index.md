...
description: Aspose.Html.HTMLImageElement klas. Eingebettetes Bild. Siehe IMGElementdefinition in HTML 4.01.
type: docs
weight: 3310
url: /de/net/aspose.html/htmlimageelement/
---
## HTMLImageElement class

Eingebettetes Bild. Siehe IMG-Elementdefinition in HTML 4.01.
...
| Name | Beschreibung |
| --- | --- |
| [Align](../../aspose.html/htmlimageelement/align/) { get; set; } | Richtet dieses Objekt (vertikal oder horizontal) in Bezug auf seinen umgebenden Text aus. Siehe die Alignment-Attributdefinition in HTML 4.01. Dieses Attribut ist in HTML 4.01 veraltet. |
| [Alt](../../aspose.html/htmlimageelement/alt/) { get; set; } | Alternativer Text für Benutzeragenten, die den normalen Inhalt dieses -Elements nicht wiedergeben. Siehe die alt-Attributdefinition in HTML 4.01. |
...
| [Border](../../aspose.html/htmlimageelement/border/) { get; set; } | Breite des Rahmens um das Bild. Siehe Definition des Rahmenattributs in HTML 4.01. Dieses Attribut ist in HTML 4.01 veraltet. Beachten Sie, dass der Typ dieses Attributs war`DOMString` in DOM Level 1 HTML [[DOM-Level 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ] . |
...
| [Height](../../aspose.html/htmlimageelement/height/) { get; set; } | Höhe des Bildes in Pixel. Siehe Definition des Höhenattributs in HTML 4.01. Beachten Sie, dass der Typ dieses Attributs war.`DOMString` in DOM Level 1 HTML [[DOM-Level 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ]. @Version DOM Level 2 |
| [Hspace](../../aspose.html/htmlimageelement/hspace/) { get; set; } | Horizontaler Abstand links und rechts von diesem Bild in Pixel. Siehe die hspace-Attributdefinition in HTML 4.01. Dieses Attribut ist in HTML 4.01 veraltet. Beachten Sie, dass der Typ dieses Attributs war.`DOMString` in DOM Level 1 HTML [[DOM-Level 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ]. @Version DOM Level 2 |
...
| [IsMap](../../aspose.html/htmlimageelement/ismap/) { get; set; } | Serverseitige Imagemap verwenden. Siehe die ismap-Attributdefinition in HTML 4.01. |
...
| [LongDesc](../../aspose.html/htmlimageelement/longdesc/) { get; set; } | -URI [[IETF-RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] bezeichnet eine lange Beschreibung dieses Bildes oder Rahmens. Siehe die Definition des Attributs longdesc in HTML 4.01. |
| [Name](../../aspose.html/htmlimageelement/name/) { get; set; } | Der Name des Elements (aus Gründen der Abwärtskompatibilität). |
...
| [Src](../../aspose.html/htmlimageelement/src/) { get; set; } | -URI [[IETF-RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] Angabe der Quelle dieses Bildes. Siehe Definition des src-Attributs in HTML 4.01. |
...
| [UseMap](../../aspose.html/htmlimageelement/usemap/) { get; set; } | Clientseitige Imagemap verwenden. Siehe die usemap-Attributdefinition in HTML 4.01. |
| [Vspace](../../aspose.html/htmlimageelement/vspace/) { get; set; } | Vertikaler Abstand über und unter diesem Bild in Pixel. Siehe die Attributdefinition vspace in HTML 4.01. Dieses Attribut ist in HTML 4.01 veraltet. Beachten Sie, dass der Typ dieses Attributs in DOM Level 1 HTML [[DOM-Level 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ]. @Version DOM Level 2 |
| [Width](../../aspose.html/htmlimageelement/width/) { get; set; } | Die Breite des Bildes in Pixel. Siehe Definition des width-Attributs in HTML 4.01. Beachten Sie, dass der Typ dieses Attributs war.`DOMString` in DOM Level 1 HTML [[DOM-Level 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ]. @Version DOM Level 2 |
