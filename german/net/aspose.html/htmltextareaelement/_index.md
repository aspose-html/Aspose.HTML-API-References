...
description: Mehrzeiliges Textfeld. Siehe die Definition des TEXTAREAElements in HTML 4.01.
type: docs
weight: 3600
...
| [Form](../../aspose.html/htmltextareaelement/form) { get; } | Gibt die zurück`BILDEN` Element, das dieses Steuerelement enthält. Gibt zurück`Null` wenn sich dieses Steuerelement nicht im Kontext eines -Formulars befindet. |
