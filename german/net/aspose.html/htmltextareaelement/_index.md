...
description: Aspose.Html.HTMLTextAreaElement klas. Mehrzeiliges Textfeld. Siehe die Definition des TEXTAREAElements in HTML 4.01.
type: docs
weight: 3610
url: /de/net/aspose.html/htmltextareaelement/
---
## HTMLTextAreaElement class

Mehrzeiliges Textfeld. Siehe die Definition des TEXTAREA-Elements in HTML 4.01.
...
| Name | Beschreibung |
| --- | --- |
| [AccessKey](../../aspose.html/htmltextareaelement/accesskey/) { get; set; } | Ein aus einem Zeichen bestehender Zugriffsschlüssel für den Zugriff auf die Formularsteuerung. Siehe die accesskey-Attributdefinition in HTML 4.01. |
...
| [Cols](../../aspose.html/htmltextareaelement/cols/) { get; set; } | Breite des Steuerelements (in Zeichen). Siehe die cols-Attributdefinition in HTML 4.01. |
| [DefaultValue](../../aspose.html/htmltextareaelement/defaultvalue/) { get; set; } | Repräsentiert den Inhalt des Elements. Der Wert dieses Attributs ändert sich nicht, wenn sich der Inhalt des entsprechenden Formularsteuerelements in einem interaktiven Benutzeragenten ändert. @version DOM Level 2 |
...
| [Disabled](../../aspose.html/htmltextareaelement/disabled/) { get; set; } | Das Steuerelement ist in diesem Kontext nicht verfügbar. Siehe die Definition des deaktivierten Attributs in HTML 4.01. |
...
| [Form](../../aspose.html/htmltextareaelement/form/) { get; } | Gibt die zurück`FORM` Element, das dieses Steuerelement enthält. Gibt zurück`Null` wenn sich dieses Steuerelement nicht im Kontext eines -Formulars befindet. |
...
| [Name](../../aspose.html/htmltextareaelement/name/) { get; set; } | Formularsteuerelement oder Objektname bei Übermittlung mit einem Formular. Siehe die Attributdefinition name in HTML 4.01. |
...
| [ReadOnly](../../aspose.html/htmltextareaelement/readonly/) { get; set; } | Dieses Steuerelement ist schreibgeschützt. Siehe die Readonly-Attributdefinition in HTML 4.01. |
| [Rows](../../aspose.html/htmltextareaelement/rows/) { get; set; } | Anzahl Textzeilen. Siehe Definition des rows-Attributs in HTML 4.01. |
...
| [TabIndex](../../aspose.html/htmltextareaelement/tabindex/) { get; set; } | Index, der die Position des Elements in der Tab-Reihenfolge darstellt. Siehe die tabindex-Attributdefinition in HTML 4.01. |
