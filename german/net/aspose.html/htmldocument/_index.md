...
description: Aspose.Html.HTMLDocument klas. EinHTMLDokument ist die Wurzel der HTMLHierarchie und enthält den gesamten Inhalt. Neben dem Zugriff auf die Hierarchie bietet es auch einige praktische Methoden für den Zugriff auf bestimmte Sätze von Informationen aus dem Dokument.
type: docs
weight: 3190
url: /de/net/aspose.html/htmldocument/
---
## HTMLDocument class

Ein`HTMLDokument` ist die Wurzel der HTML-Hierarchie und enthält den gesamten Inhalt. Neben dem Zugriff auf die Hierarchie bietet es auch einige praktische Methoden für den Zugriff auf bestimmte Sätze von Informationen aus dem Dokument.

Die folgenden Eigenschaften wurden zugunsten der entsprechenden für die veraltet`KÖRPER` element. In DOM Level 2 die Methode`getElementById` wird von der vererbt`Dokumentieren` Schnittstelle, wohin es verschoben wurde.
...
| Name | Beschreibung |
| --- | --- |
| [HTMLDocument](htmldocument/#constructor)() | Initialisiert eine neue Instanz von`HTMLDocument` Klasse. |
| [HTMLDocument](htmldocument/#constructor_1)(Configuration) | Initialisiert eine neue Instanz von`HTMLDocument` Klasse. |
| [HTMLDocument](htmldocument/#constructor_2)(RequestMessage) | Initialisiert eine neue Instanz von`HTMLDocument` Klasse. Der Konstruktor arbeitet synchron, er wartet auf das Laden aller externen Ressourcen (Bilder, Skripte usw.). Um das Dokument asynchron zu laden, verwenden Sie die Methode[`Navigate`](../../aspose.html.dom/document/navigate/) oder seine Überladungen. Oder Sie können das Laden einiger externer Ressourcen deaktivieren, indem Sie entsprechende Flags setzen[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_10)(string) | Initialisiert eine neue Instanz von`HTMLDocument` Klasse. Der Konstruktor arbeitet synchron, er wartet auf das Laden aller externen Ressourcen (Bilder, Skripte usw.). Um das Dokument asynchron zu laden, verwenden Sie die Methode[`Navigate`](../../aspose.html.dom/document/navigate/) oder seine Überladungen. Oder Sie können das Laden einiger externer Ressourcen deaktivieren, indem Sie entsprechende Flags setzen[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_4)(Url) | Initialisiert eine neue Instanz von`HTMLDocument` Klasse. Der Konstruktor arbeitet synchron, er wartet auf das Laden aller externen Ressourcen (Bilder, Skripte usw.). Um das Dokument asynchron zu laden, verwenden Sie die Methode[`Navigate`](../../aspose.html.dom/document/navigate/) oder seine Überladungen. Oder Sie können das Laden einiger externer Ressourcen deaktivieren, indem Sie entsprechende Flags setzen[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_3)(RequestMessage, Configuration) | Initialisiert eine neue Instanz von`HTMLDocument` Klasse. Der Konstruktor arbeitet synchron, er wartet auf das Laden aller externen Ressourcen (Bilder, Skripte usw.). Um das Dokument asynchron zu laden, verwenden Sie die Methode[`Navigate`](../../aspose.html.dom/document/navigate/) oder seine Überladungen. Oder Sie können das Laden einiger externer Ressourcen deaktivieren, indem Sie entsprechende Flags setzen[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_8)(Stream, string) | Initialisiert eine neue Instanz von`HTMLDocument` Klasse. Der Konstruktor arbeitet synchron, er wartet auf das Laden aller externen Ressourcen (Bilder, Skripte usw.). Um das Dokument asynchron zu laden, verwenden Sie die Methode[`Navigate`](../../aspose.html.dom/document/navigate/) oder seine Überladungen. Oder Sie können das Laden einiger externer Ressourcen deaktivieren, indem Sie entsprechende Flags setzen[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . Das Laden des Dokuments beginnt an der aktuellen Position im Stream. |
| [HTMLDocument](htmldocument/#constructor_6)(Stream, Url) | Initialisiert eine neue Instanz von`HTMLDocument` Klasse. Der Konstruktor arbeitet synchron, er wartet auf das Laden aller externen Ressourcen (Bilder, Skripte usw.). Um das Dokument asynchron zu laden, verwenden Sie die Methode[`Navigate`](../../aspose.html.dom/document/navigate/) oder seine Überladungen. Oder Sie können das Laden einiger externer Ressourcen deaktivieren, indem Sie entsprechende Flags setzen[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . Das Laden des Dokuments beginnt an der aktuellen Position im Stream. |
| [HTMLDocument](htmldocument/#constructor_11)(string, Configuration) | Initialisiert eine neue Instanz von`HTMLDocument` Klasse. Der Konstruktor arbeitet synchron, er wartet auf das Laden aller externen Ressourcen (Bilder, Skripte usw.). Um das Dokument asynchron zu laden, verwenden Sie die Methode[`Navigate`](../../aspose.html.dom/document/navigate/) oder seine Überladungen. Oder Sie können das Laden einiger externer Ressourcen deaktivieren, indem Sie entsprechende Flags setzen[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_14)(string, string) | Initialisiert eine neue Instanz von`HTMLDocument` Klasse. Der Konstruktor arbeitet synchron, er wartet auf das Laden aller externen Ressourcen (Bilder, Skripte usw.). Um das Dokument asynchron zu laden, verwenden Sie die Methode[`Navigate`](../../aspose.html.dom/document/navigate/) oder seine Überladungen. Oder Sie können das Laden einiger externer Ressourcen deaktivieren, indem Sie entsprechende Flags setzen[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_12)(string, Url) | Initialisiert eine neue Instanz von`HTMLDocument` Klasse. Der Konstruktor arbeitet synchron, er wartet auf das Laden aller externen Ressourcen (Bilder, Skripte usw.). Um das Dokument asynchron zu laden, verwenden Sie die Methode[`Navigate`](../../aspose.html.dom/document/navigate/) oder seine Überladungen. Oder Sie können das Laden einiger externer Ressourcen deaktivieren, indem Sie entsprechende Flags setzen[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_5)(Url, Configuration) | Initialisiert eine neue Instanz von`HTMLDocument` Klasse. Der Konstruktor arbeitet synchron, er wartet auf das Laden aller externen Ressourcen (Bilder, Skripte usw.). Um das Dokument asynchron zu laden, verwenden Sie die Methode[`Navigate`](../../aspose.html.dom/document/navigate/) oder seine Überladungen. Oder Sie können das Laden einiger externer Ressourcen deaktivieren, indem Sie entsprechende Flags setzen[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_9)(Stream, string, Configuration) | Initialisiert eine neue Instanz von`HTMLDocument` Klasse. Der Konstruktor arbeitet synchron, er wartet auf das Laden aller externen Ressourcen (Bilder, Skripte usw.). Um das Dokument asynchron zu laden, verwenden Sie die Methode[`Navigate`](../../aspose.html.dom/document/navigate/) oder seine Überladungen. Oder Sie können das Laden einiger externer Ressourcen deaktivieren, indem Sie entsprechende Flags setzen[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . Das Laden des Dokuments beginnt an der aktuellen Position im Stream. |
| [HTMLDocument](htmldocument/#constructor_7)(Stream, Url, Configuration) | Initialisiert eine neue Instanz von`HTMLDocument` Klasse. Der Konstruktor arbeitet synchron, er wartet auf das Laden aller externen Ressourcen (Bilder, Skripte usw.). Um das Dokument asynchron zu laden, verwenden Sie die Methode[`Navigate`](../../aspose.html.dom/document/navigate/) oder seine Überladungen. Oder Sie können das Laden einiger externer Ressourcen deaktivieren, indem Sie entsprechende Flags setzen[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . Das Laden des Dokuments beginnt an der aktuellen Position im Stream. |
...
| Name | Beschreibung |
| --- | --- |
| [Anchors](../../aspose.html/htmldocument/anchors/) { get; } | Eine Sammlung aller Anker (`A` ) Elemente in einem Dokument mit einem Wert für die`Name`Attribut. Aus Gründen der Abwärtskompatibilität enthält der zurückgegebene Satz von Ankern nur die Anker, die mit erstellt wurden`Name` Attribut, nicht die mit dem erstellten`Ausweis` Attribut. Beachten Sie, dass in [[XHTML 1.0](http://www.w3.org/TR/2002/REC-xhtml1-20020801) ], die `Name` -Attribut (siehe Abschnitt 4.10) hat keine Semantik und ist nur für Legacy-Benutzeragenten vorhanden: the`Ausweis` stattdessen wird das Attribut verwendet. Benutzer sollten die Iterator-Mechanismen bevorzugen, die von [[DOM Level 2 Traversierung](http://www.w3.org/TR/2000/REC-DOM-Level-2-Traversal-Range-20001113) ] stattdessen. |
| [Applets](../../aspose.html/htmldocument/applets/) { get; } | Eine Sammlung aller`OBJEKT` Elemente, die Applets und enthalten`APPLET` (veraltete) Elemente in einem Dokument. |
...
| [Body](../../aspose.html/htmldocument/body/) { get; set; } | Das Element, das den Inhalt für das Dokument enthält. In Dokumenten mit`KÖRPER` Inhalt, gibt die zurück`KÖRPER` Element. In Frameset-Dokumenten gibt dies das äußerste zurück`RAHMENSET` Element. |
...
| [Domain](../../aspose.html/htmldocument/domain/) { get; } | Der Domänenname des Servers, der das Dokument bereitgestellt hat, oder `Null` wenn der Server nicht durch einen Domänennamen identifiziert werden kann. |
...
| [Links](../../aspose.html/htmldocument/links/) { get; } | Eine Sammlung von allen`BEREICH` Elemente und Anker ( `A` ) Elemente in einem Dokument mit einem Wert für `href` Attribut. |
...
| [Referrer](../../aspose.html/htmldocument/referrer/) { get; } | Gibt den URI zurück [[IETF-RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) der Seite, die auf diese Seite verlinkt hat. Der Wert ist ein leerer String, wenn der Benutzer direkt auf die Seite navigiert ist (nicht über einen Link, sondern beispielsweise über ein Lesezeichen). |
...
| [Title](../../aspose.html/htmldocument/title/) { get; set; } | Der Titel eines Dokuments, wie vom angegeben`TITEL` Element im Kopf des Dokuments. |
...
| [GetOverrideStyle](../../aspose.html/htmldocument/getoverridestyle/)(Element, string) | Diese Methode wird verwendet, um die Überschreibungsstildeklaration für ein bestimmtes Element und ein bestimmtes Pseudoelement abzurufen. |
...
| override [RenderTo](../../aspose.html/htmldocument/renderto/)(IDevice) | Diese Methode wird verwendet, um den Inhalt des aktuellen Dokuments auf dem angegebenen Gerät zu drucken. |
...
| [Save](../../aspose.html/htmldocument/save/#save)(IOutputStorage) | Speichert den Dokumentinhalt und die Ressourcen im Ausgabespeicher. |
| [Save](../../aspose.html/htmldocument/save/#save_10)(string) | Speichert das Dokument in der durch angegebenen lokalen Datei`Weg` Alle in diesem Dokument verwendeten Ressourcen werden in im angrenzenden Ordner gespeichert, dessen Name wie folgt aufgebaut ist: output_file_name + "_files". |
| [Save](../../aspose.html/htmldocument/save/#save_5)(Url) | Speichert das Dokument in der durch angegebenen lokalen Datei`URL` Alle in diesem Dokument verwendeten Ressourcen werden in im angrenzenden Ordner gespeichert, dessen Name wie folgt aufgebaut ist: output_file_name + "_files". |
| [Save](../../aspose.html/htmldocument/save/#save_1)(IOutputStorage, HTMLSaveFormat) | Speichert den Dokumentinhalt und die Ressourcen im Ausgabespeicher. |
| [Save](../../aspose.html/htmldocument/save/#save_2)(IOutputStorage, HTMLSaveOptions) | Speichert den Dokumentinhalt und die Ressourcen im Ausgabespeicher. |
| [Save](../../aspose.html/htmldocument/save/#save_3)(IOutputStorage, MarkdownSaveOptions) | Speichert den Dokumentinhalt und die Ressourcen im Ausgabespeicher. |
| [Save](../../aspose.html/htmldocument/save/#save_4)(IOutputStorage, MHTMLSaveOptions) | Speichert den Dokumentinhalt und die Ressourcen im Ausgabespeicher. |
| [Save](../../aspose.html/htmldocument/save/#save_11)(string, HTMLSaveFormat) | Speichert das Dokument in der durch angegebenen lokalen Datei`Weg` Alle in diesem Dokument verwendeten Ressourcen werden in im angrenzenden Ordner gespeichert, dessen Name wie folgt aufgebaut ist: output_file_name + "_files". |
| [Save](../../aspose.html/htmldocument/save/#save_12)(string, HTMLSaveOptions) | Speichert das Dokument in der durch angegebenen lokalen Datei`Weg` Alle in diesem Dokument verwendeten Ressourcen werden in im angrenzenden Ordner gespeichert, dessen Name wie folgt aufgebaut ist: output_file_name + "_files". |
| [Save](../../aspose.html/htmldocument/save/#save_13)(string, MarkdownSaveOptions) | Speichert das Dokument in der durch angegebenen lokalen Datei`Weg` Alle in diesem Dokument verwendeten Ressourcen werden in im angrenzenden Ordner gespeichert, dessen Name wie folgt aufgebaut ist: output_file_name + "_files". |
| [Save](../../aspose.html/htmldocument/save/#save_14)(string, MHTMLSaveOptions) | Speichert das Dokument in der durch angegebenen lokalen Datei`Weg` Alle in diesem Dokument verwendeten Ressourcen werden in im angrenzenden Ordner gespeichert, dessen Name wie folgt aufgebaut ist: output_file_name + "_files". |
| [Save](../../aspose.html/htmldocument/save/#save_6)(Url, HTMLSaveFormat) | Speichert das Dokument in der durch angegebenen lokalen Datei`URL` Alle in diesem Dokument verwendeten Ressourcen werden in im angrenzenden Ordner gespeichert, dessen Name wie folgt aufgebaut ist: output_file_name + "_files". |
| [Save](../../aspose.html/htmldocument/save/#save_7)(Url, HTMLSaveOptions) | Speichert das Dokument in der durch angegebenen lokalen Datei`URL` Alle in diesem Dokument verwendeten Ressourcen werden in im angrenzenden Ordner gespeichert, dessen Name wie folgt aufgebaut ist: output_file_name + "_files". |
| [Save](../../aspose.html/htmldocument/save/#save_8)(Url, MarkdownSaveOptions) | Speichert das Dokument in der durch angegebenen lokalen Datei`URL` Alle in diesem Dokument verwendeten Ressourcen werden in im angrenzenden Ordner gespeichert, dessen Name wie folgt aufgebaut ist: output_file_name + "_files". |
| [Save](../../aspose.html/htmldocument/save/#save_9)(Url, MHTMLSaveOptions) | Speichert das Dokument in der durch angegebenen lokalen Datei`URL` Alle in diesem Dokument verwendeten Ressourcen werden in im angrenzenden Ordner gespeichert, dessen Name wie folgt aufgebaut ist: output_file_name + "_files". |
