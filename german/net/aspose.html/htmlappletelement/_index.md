...
description: Aspose.Html.HTMLAppletElement klas. Ein eingebettetes JavaApplet. Siehe die APPLETElementdefinition in HTML 4.01. Dieses Element ist in HTML 4.01 veraltet.
type: docs
weight: 3070
url: /de/net/aspose.html/htmlappletelement/
---
## HTMLAppletElement class

Ein eingebettetes Java-Applet. Siehe die APPLET-Elementdefinition in HTML 4.01. Dieses Element ist in HTML 4.01 veraltet.
...
| Name | Beschreibung |
| --- | --- |
| [Align](../../aspose.html/htmlappletelement/align/) { get; set; } | Richtet dieses Objekt (vertikal oder horizontal) in Bezug auf seinen umgebenden Text aus. Siehe die Alignment-Attributdefinition in HTML 4.01. Dieses Attribut ist in HTML 4.01 veraltet. |
| [Alt](../../aspose.html/htmlappletelement/alt/) { get; set; } | Alternativer Text für Benutzeragenten, die den normalen Inhalt dieses -Elements nicht wiedergeben. Siehe die alt-Attributdefinition in HTML 4.01. Dieses -Attribut ist in HTML 4.01 veraltet. |
| [Archive](../../aspose.html/htmlappletelement/archive/) { get; set; } | Kommagetrennte Archivliste. Siehe die Archivattributdefinition in HTML 4.01. Dieses Attribut ist in HTML 4.01 veraltet. |
...
| [Code](../../aspose.html/htmlappletelement/code/) { get; set; } | Applet-Klassendatei. Siehe die code-Attributdefinition in HTML 4.01. Dieses -Attribut ist in HTML 4.01 veraltet. |
| [CodeBase](../../aspose.html/htmlappletelement/codebase/) { get; set; } | Optionaler Basis-URI [[IETF-RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) für Applets. Siehe die Codebase-Attributdefinition in HTML 4.01. Dieses Attribut ist in HTML 4.01 veraltet. |
...
| [Height](../../aspose.html/htmlappletelement/height/) { get; set; } | Höhe überschreiben. Siehe Definition des Höhenattributs in HTML 4.01. Dieses -Attribut ist in HTML 4.01 veraltet. |
| [Hspace](../../aspose.html/htmlappletelement/hspace/) { get; set; } | Horizontaler Abstand in Pixel links und rechts von diesem Bild, Applet oder Objekt. Siehe die hspace-Attributdefinition in HTML 4.01. Dieses Attribut ist in HTML 4.01 veraltet. @Version DOM Level 2 |
...
| [Name](../../aspose.html/htmlappletelement/name/) { get; set; } | Der Name des Applets. Siehe die Namensattributdefinition in HTML 4.01. Dieses Attribut ist in HTML 4.01 veraltet. |
...
| [Object](../../aspose.html/htmlappletelement/object/) { get; set; } | Der Wert des Attributs "Objekt". Siehe das Objektattribut definition in HTML 4.01. Dieses Attribut ist in HTML 4.01 veraltet. @version DOM Level 2 |
...
| [Vspace](../../aspose.html/htmlappletelement/vspace/) { get; set; } | Vertikaler Abstand in Pixeln über und unter diesem Bild, Applet oder -Objekt. Siehe die vspace-Attributdefinition in HTML 4.01. Dieses -Attribut ist in HTML 4.01 veraltet. @Version DOM Level 2 |
| [Width](../../aspose.html/htmlappletelement/width/) { get; set; } | Breite überschreiben. Siehe Definition des width-Attributs in HTML 4.01. Dieses -Attribut ist in HTML 4.01 veraltet. |
