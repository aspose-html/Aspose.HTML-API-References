...
description: Aspose.Html.HTMLDataListElement klas. Das DatalistElement stellt eine Reihe von Optionselementen dar die vordefinierte Optionen für andere Steuerelemente darstellen. Siehe auch dieHTML 5.2 W3CEmpfehlung .
type: docs
weight: 3160
url: /de/net/aspose.html/htmldatalistelement/
---
## HTMLDataListElement class

Das Datalist-Element stellt eine Reihe von Optionselementen dar, die vordefinierte Optionen für andere Steuerelemente darstellen. Siehe auch die[HTML 5.2 W3C-Empfehlung](https://www.w3.org/TR/html52/sec-forms.html#elementdef-datalist) .
...
| [Options](../../aspose.html/htmldatalistelement/options/) { get; } | Die Sammlung von`MÖGLICHKEIT`Elemente, die in diesem -Element enthalten sind. |
