...
description: Aspose.Html.HTMLSelectElement klas. Das SelectElement ermöglicht die Auswahl einer Option. Auf die enthaltenen Optionen kann direkt über das selectElement als Collection zugegriffen werden. Siehe die SELECTElementdefinition in HTML 4.01.
type: docs
weight: 3520
url: /de/net/aspose.html/htmlselectelement/
---
## HTMLSelectElement class

Das Select-Element ermöglicht die Auswahl einer Option. Auf die enthaltenen Optionen kann direkt über das select-Element als Collection zugegriffen werden. Siehe die SELECT-Elementdefinition in HTML 4.01.
...
| [Disabled](../../aspose.html/htmlselectelement/disabled/) { get; set; } | Das Steuerelement ist in diesem Kontext nicht verfügbar. Siehe die Definition des deaktivierten Attributs in HTML 4.01. |
...
| [Form](../../aspose.html/htmlselectelement/form/) { get; } | Die Anzahl der Optionen darin`WÄHLEN` . |
...
| [Length](../../aspose.html/htmlselectelement/length/) { get; set; } | Die Anzahl der Optionen darin`WÄHLEN` . @version DOM Level 2 |
...
| [Multiple](../../aspose.html/htmlselectelement/multiple/) { get; set; } | Wenn wahr, mehrere`MÖGLICHKEIT` Darin können Elemente ausgewählt werden`WÄHLEN` . Siehe die Definition mehrerer Attribute in HTML 4.01. |
| [Name](../../aspose.html/htmlselectelement/name/) { get; set; } | Formularsteuerelement oder Objektname bei Übermittlung mit einem Formular. Siehe die Attributdefinition name in HTML 4.01. |
...
| [Options](../../aspose.html/htmlselectelement/options/) { get; } | Die Sammlung von`MÖGLICHKEIT` Elemente, die in diesem -Element enthalten sind. @version DOM Level 2 |
...
| [SelectedIndex](../../aspose.html/htmlselectelement/selectedindex/) { get; set; } | Der Ordnungsindex der ausgewählten Option, beginnend bei 0. Der Wert -1 wird zurückgegeben, wenn kein Element ausgewählt ist. Wenn mehrere Optionen ausgewählt sind, wird der Index der ersten ausgewählten Option zurückgegeben. |
...
| [Size](../../aspose.html/htmlselectelement/size/) { get; set; } | Anzahl der sichtbaren Zeilen. Siehe Definition des Größenattributs in HTML 4.01. |
...
| [TabIndex](../../aspose.html/htmlselectelement/tabindex/) { get; set; } | Index, der die Position des Elements in der Tab-Reihenfolge darstellt. Siehe die tabindex-Attributdefinition in HTML 4.01. |
...
| [Type](../../aspose.html/htmlselectelement/type/) { get; } | Der Typ dieses Formularsteuerelements. Dies ist die Zeichenfolge „select-multiple“, wenn es sich um das Multiple-Attribut handelt`WAHR` und die Zeichenfolge "select-one", wenn`FALSCH` . |
| [Value](../../aspose.html/htmlselectelement/value/) { get; set; } | Der aktuelle Formularsteuerwert (dh der Wert der aktuell ausgewählten Option), wenn mehrere Optionen ausgewählt sind, ist dies der Wert der ersten ausgewählten Option. |
