...
description: Das SelectElement ermöglicht die Auswahl einer Option. Auf die enthaltenen Optionen kann direkt über das selectElement als Collection zugegriffen werden. Siehe die SELECTElementdefinition in HTML 4.01.
type: docs
weight: 3510
...
| [Form](../../aspose.html/htmlselectelement/form) { get; } | Die Anzahl der Optionen darin`AUSWÄHLEN` . |
...
| [Length](../../aspose.html/htmlselectelement/length) { get; set; } | Die Anzahl der Optionen darin`AUSWÄHLEN` . @version DOM Level 2 |
...
| [Multiple](../../aspose.html/htmlselectelement/multiple) { get; set; } | Wenn wahr, mehrere`MÖGLICHKEIT` Darin können Elemente ausgewählt werden`AUSWÄHLEN` . Siehe die Definition mehrerer Attribute in HTML 4.01. |
...
| [Type](../../aspose.html/htmlselectelement/type) { get; } | Der Typ dieses Formularsteuerelements. Dies ist die Zeichenfolge „select-multiple“, wenn es sich um das Multiple-Attribut handelt`Stimmt` und die Zeichenfolge "select-one", wenn`FALSCH` . |
