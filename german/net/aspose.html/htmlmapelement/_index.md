...
description: Aspose.Html.HTMLMapElement klas. Clientseitige Imagemap. Siehe die Definition des MAPElements in HTML 4.01.
type: docs
weight: 3380
url: /de/net/aspose.html/htmlmapelement/
---
## HTMLMapElement class

Clientseitige Imagemap. Siehe die Definition des MAP-Elements in HTML 4.01.
...
| Name | Beschreibung |
| --- | --- |
| [Areas](../../aspose.html/htmlmapelement/areas/) { get; } | Die Liste der für die Imagemap definierten Bereiche. |
...
| [Name](../../aspose.html/htmlmapelement/name/) { get; set; } | Benennt die Map (zur Verwendung mit`Verwendungskarte` ). Siehe die Attributdefinition name in HTML 4.01. |
