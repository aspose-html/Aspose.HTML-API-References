...
description: Aspose.Html.HTMLLIElement klas. Listenelement. Siehe Definition des LIElements in HTML 4.01.
type: docs
weight: 3340
url: /de/net/aspose.html/htmllielement/
---
## HTMLLIElement class

Listenelement. Siehe Definition des LI-Elements in HTML 4.01.
...
| [Type](../../aspose.html/htmllielement/type/) { get; set; } | Aufzählungszeichen für Listenelemente. Siehe die Typattributdefinition in HTML 4.01. Dieses Attribut ist in HTML 4.01 veraltet. |
| [Value](../../aspose.html/htmllielement/value/) { get; set; } | Sequenznummer zurücksetzen, wenn verwendet in`OL` . Siehe die Definition des Attributs value in HTML 4.01. Dieses Attribut ist in HTML 4.01. veraltet. |
