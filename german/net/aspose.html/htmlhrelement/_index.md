...
description: Aspose.Html.HTMLHRElement klas. Erstellen Sie eine horizontale Linie. Siehe HRElementdefinition in HTML 4.01.
type: docs
weight: 3260
url: /de/net/aspose.html/htmlhrelement/
---
## HTMLHRElement class

Erstellen Sie eine horizontale Linie. Siehe HR-Elementdefinition in HTML 4.01.
...
| Name | Beschreibung |
| --- | --- |
| [Align](../../aspose.html/htmlhrelement/align/) { get; set; } | Richten Sie die Linie auf der Seite aus. Siehe Definition des Attributs align in HTML 4.01. Dieses Attribut ist in HTML 4.01 veraltet. |
...
| [NoShade](../../aspose.html/htmlhrelement/noshade/) { get; set; } | Zeigt dem Benutzeragenten an, dass es keine Schattierung in der -Wiedergabe dieses Elements geben soll. Siehe die noshade-Attributdefinition in HTML 4.01. Dieses Attribut ist in HTML 4.01 veraltet. |
...
| [Size](../../aspose.html/htmlhrelement/size/) { get; set; } | Die Höhe der Linie. Siehe Definition des Größenattributs in HTML 4.01. Dieses Attribut ist in HTML 4.01 veraltet. |
...
| [Width](../../aspose.html/htmlhrelement/width/) { get; set; } | Die Breite der Linie. Siehe Definition des width-Attributs in HTML 4.01. Dieses Attribut ist in HTML 4.01 veraltet. |
