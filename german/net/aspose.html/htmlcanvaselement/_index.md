...
description: Aspose.Html.HTMLCanvasElement klas. Die HTMLCanvasElementSchnittstelle bietet Eigenschaften und Methoden zum Bearbeiten des Layouts und der Darstellung von CanvasElementen. Die HTMLCanvasElementSchnittstelle erbt auch die Eigenschaften und Methoden der HTMLElementSchnittstelle.
type: docs
weight: 3140
url: /de/net/aspose.html/htmlcanvaselement/
---
## HTMLCanvasElement class

Die HTMLCanvasElement-Schnittstelle bietet Eigenschaften und Methoden zum Bearbeiten des Layouts und der Darstellung von Canvas-Elementen. Die HTMLCanvasElement-Schnittstelle erbt auch die Eigenschaften und Methoden der HTMLElement-Schnittstelle.
...
| [Height](../../aspose.html/htmlcanvaselement/height/) { get; set; } | Ist eine positive ganze Zahl, die das HTML-Attribut height des Canvas-Elements widerspiegelt, das in CSS-Pixeln interpretiert wird. Wenn das Attribut nicht angegeben ist oder wenn es auf einen ungültigen Wert gesetzt ist, wie z. B. negativ, wird der Standardwert von 150 verwendet. |
...
| [Width](../../aspose.html/htmlcanvaselement/width/) { get; set; } | Ist eine positive ganze Zahl, die das HTML-Attribut width des Canvas-Elements widerspiegelt, das in CSS-Pixeln interpretiert wird. Wenn das Attribut nicht angegeben ist oder auf einen ungültigen Wert gesetzt ist, z. B. negativ, wird der Standardwert 300 verwendet. |
...
| [GetContext](../../aspose.html/htmlcanvaselement/getcontext/)(string) | Gibt einen Zeichenkontext auf der Leinwand zurück oder null, wenn die Kontext-ID nicht unterstützt wird. Mit einem Zeichenkontext können Sie auf der Leinwand zeichnen. |
...
| [ToDataURL](../../aspose.html/htmlcanvaselement/todataurl/#todataurl)() | gibt einen Daten-URI zurück, der eine Darstellung des Bildes in dem durch den Typparameter angegebenen Format enthält (standardmäßig PNG). Das zurückgegebene Bild hat eine Auflösung von 96 dpi. |
| [ToDataURL](../../aspose.html/htmlcanvaselement/todataurl/#todataurl_1)(string) | gibt einen Daten-URI zurück, der eine Darstellung des Bildes in dem durch den Typparameter angegebenen Format enthält (standardmäßig PNG). Das zurückgegebene Bild hat eine Auflösung von 96 dpi. |
| [ToDataURL](../../aspose.html/htmlcanvaselement/todataurl/#todataurl_2)(string, double) | gibt einen Daten-URI zurück, der eine Darstellung des Bildes in dem durch den Typparameter angegebenen Format enthält (standardmäßig PNG). Das zurückgegebene Bild hat eine Auflösung von 96 dpi. |
