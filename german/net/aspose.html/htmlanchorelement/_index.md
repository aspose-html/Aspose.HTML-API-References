...
description: Das Ankerelement. Siehe die Definition des AElements in HTML 4.01.
type: docs
weight: 3050
url: /de/net/aspose.html/htmlanchorelement/
---
## HTMLAnchorElement class

Das Ankerelement. Siehe die Definition des A-Elements in HTML 4.01.
...
| Name | Beschreibung |
| --- | --- |
| [AccessKey](../../aspose.html/htmlanchorelement/accesskey) { get; set; } | Ein aus einem Zeichen bestehender Zugriffsschlüssel für den Zugriff auf die Formularsteuerung. Siehe die accesskey-Attributdefinition in HTML 4.01. |
...
| [Charset](../../aspose.html/htmlanchorelement/charset) { get; set; } | Die Zeichencodierung der verknüpften Ressource. Siehe die charset Attributdefinition in HTML 4.01. |
...
| [Coords](../../aspose.html/htmlanchorelement/coords) { get; set; } | Durch Komma getrennte Liste von Längen, die eine aktive Bereichsgeometrie definieren. Siehe auch`Form` für die Gestalt der Region. Siehe the coords-Attributdefinition in HTML 4.01. |
...
| [Hash](../../aspose.html/htmlanchorelement/hash) { get; set; } | Ruft eine Zeichenfolgendarstellung des Hash-Segments der zugehörigen URL ab oder legt sie fest. |
| [Host](../../aspose.html/htmlanchorelement/host) { get; set; } | Ruft eine Zeichenfolgendarstellung der Host- und Portsegmente der zugeordneten URL ab oder legt sie fest. |
| [Hostname](../../aspose.html/htmlanchorelement/hostname) { get; set; } | Ruft eine Zeichenfolgendarstellung des Hostsegments der zugeordneten URL ab oder legt sie fest. |
| [Href](../../aspose.html/htmlanchorelement/href) { get; set; } | Der absolute URI [[IETF-RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) der verlinkten Ressource. Siehe die Definition des href-Attributs in HTML 4.01. |
| [Hreflang](../../aspose.html/htmlanchorelement/hreflang) { get; set; } | Sprachcode der verlinkten Ressource. Siehe die Definition des hreflang-Attributs in HTML 4.01. |
...
| [Name](../../aspose.html/htmlanchorelement/name) { get; set; } | Ankername. Siehe Definition des Namensattributs in HTML 4.01. |
...
| [Origin](../../aspose.html/htmlanchorelement/origin) { get; } | Ruft eine Zeichenfolgendarstellung des Ursprungssegments der zugeordneten URL ab. |
...
| [Password](../../aspose.html/htmlanchorelement/password) { get; set; } | Ruft eine Zeichenfolgendarstellung des Kennwortsegments der zugehörigen URL ab oder legt sie fest. |
| [Pathname](../../aspose.html/htmlanchorelement/pathname) { get; set; } | Ruft eine Zeichenfolgendarstellung des Pfadsegments der zugeordneten URL ab oder legt sie fest. |
| [Port](../../aspose.html/htmlanchorelement/port) { get; set; } | Ruft eine Zeichenfolgendarstellung des Portsegments der zugehörigen URL ab oder legt sie fest. |
...
| [Protocol](../../aspose.html/htmlanchorelement/protocol) { get; set; } | Ruft eine Zeichenfolgendarstellung des Schemasegments der zugehörigen URL ab oder legt sie fest. |
| [Rel](../../aspose.html/htmlanchorelement/rel) { get; set; } | Forward-Link-Typ. Siehe die rel-Attributdefinition in HTML 4.01. |
| [RelList](../../aspose.html/htmlanchorelement/rellist) { get; } | Gibt eine Live-DOMTokenList zurück, die Token enthält, die durch das Parsen des „rel“-Attributs empfangen wurden. |
| [Rev](../../aspose.html/htmlanchorelement/rev) { get; set; } | Reverse-Link-Typ. Siehe die rev-Attributdefinition in HTML 4.01. |
| [SchemaTypeInfo](../../aspose.html.dom/element/schematypeinfo) { get; } | Die diesem Element zugeordneten Typinformationen. |
| [Search](../../aspose.html/htmlanchorelement/search) { get; set; } | Ruft eine Zeichenfolgendarstellung des Suchsegments der zugeordneten URL ab oder legt sie fest. |
...
| [Shape](../../aspose.html/htmlanchorelement/shape) { get; set; } | Die Form des aktiven Bereichs. Die Koordinaten sind gegeben durch `Koordinaten` . Siehe die Shape-Attributdefinition in HTML 4.01. |
...
| [TabIndex](../../aspose.html/htmlanchorelement/tabindex) { get; set; } | Index, der die Position des Elements in der Tab-Reihenfolge darstellt. Siehe die tabindex-Attributdefinition in HTML 4.01. |
| [TagName](../../aspose.html.dom/element/tagname) { get; } | Der Name des Elements. |
| [Target](../../aspose.html/htmlanchorelement/target) { get; set; } | Frame zum Rendern der Ressource. Siehe Zielattributdefinition in HTML 4.01. |
...
| [Type](../../aspose.html/htmlanchorelement/type) { get; set; } | Advisory-Inhaltstyp. Siehe die Typattributdefinition in HTML 4.01. |
| [Username](../../aspose.html/htmlanchorelement/username) { get; set; } | Ruft eine Zeichenfolgendarstellung des Benutzernamensegments der zugehörigen URL ab oder legt sie fest. |
...
| [Blur](../../aspose.html/htmlanchorelement/blur)() | Entfernt den Tastaturfokus von diesem Element. |
...
| [Focus](../../aspose.html/htmlanchorelement/focus)() | Gibt diesem Element den Tastaturfokus. |
