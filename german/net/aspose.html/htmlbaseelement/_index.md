...
description: Aspose.Html.HTMLBaseElement klas. BasisURI des Dokuments IETFRFC 2396 . Siehe die BASEElementdefinition in HTML 4.01.
type: docs
weight: 3100
url: /de/net/aspose.html/htmlbaseelement/
---
## HTMLBaseElement class

Basis-URI des Dokuments [[IETF-RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ]. Siehe die BASE-Elementdefinition in HTML 4.01.
...
| [Href](../../aspose.html/htmlbaseelement/href/) { get; set; } | Der Basis-URI [[IETF-RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ]. Siehe die href-Attributdefinition in HTML 4.01. |
...
| [Target](../../aspose.html/htmlbaseelement/target/) { get; set; } | Der Standard-Zielframe. Siehe Definition des Zielattributs in HTML 4.01. |
