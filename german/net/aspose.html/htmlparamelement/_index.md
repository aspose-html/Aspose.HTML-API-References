...
description: Aspose.Html.HTMLParamElement klas. Parameter die dem zugeführt werdenOBJEKT Element. Siehe Definition des PARAMElements in HTML 4.01.
type: docs
weight: 3480
url: /de/net/aspose.html/htmlparamelement/
---
## HTMLParamElement class

Parameter, die dem zugeführt werden`OBJEKT` Element. Siehe Definition des PARAM-Elements in HTML 4.01.
...
| [Name](../../aspose.html/htmlparamelement/name/) { get; set; } | Der Name eines Laufzeitparameters. Siehe Definition des Namensattributs in HTML 4.01. |
...
| [Type](../../aspose.html/htmlparamelement/type/) { get; set; } | Inhaltstyp für die`Wert` Attribut wenn `Werttyp` hat den Wert "ref". Siehe Definition des Typattributs in HTML 4.01. |
| [Value](../../aspose.html/htmlparamelement/value/) { get; set; } | Der Wert eines Laufzeitparameters. Siehe die Wertattributdefinition in HTML 4.01. |
| [ValueType](../../aspose.html/htmlparamelement/valuetype/) { get; set; } | Informationen über die Bedeutung der`Wert` Attribut Wert. Siehe die valuetype-Attributdefinition in HTML 4.01. |
