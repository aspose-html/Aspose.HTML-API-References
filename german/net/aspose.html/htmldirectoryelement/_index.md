...
description: Aspose.Html.HTMLDirectoryElement klas. Verzeichnisliste. Siehe DIRElementdefinition in HTML 4.01. Dieses Element ist in HTML 4.01 veraltet.
type: docs
weight: 3170
url: /de/net/aspose.html/htmldirectoryelement/
---
## HTMLDirectoryElement class

Verzeichnisliste. Siehe DIR-Elementdefinition in HTML 4.01. Dieses Element ist in HTML 4.01 veraltet.
...
| [Compact](../../aspose.html/htmldirectoryelement/compact/) { get; set; } | Reduzieren Sie den Abstand zwischen Listenelementen. Siehe die kompakte Attributdefinition in HTML 4.01. Dieses Attribut ist in HTML 4.01 veraltet. |
