...
description: Aspose.Html.HTMLStyleElement klas. Stilinformationen. Siehe die STYLEElementdefinition in HTML 4.01 das CSS Modul DOM Level 2 Stylesheets und CSS  und dasLinkStyle Schnittstelle im StyleSheets Modul DOM Level 2 Stylesheets und CSS .
type: docs
weight: 3530
url: /de/net/aspose.html/htmlstyleelement/
---
## HTMLStyleElement class

Stilinformationen. Siehe die STYLE-Elementdefinition in HTML 4.01, das CSS -Modul [[DOM Level 2 Stylesheets und CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113) ] und das`LinkStyle` Schnittstelle im StyleSheets Modul [[DOM Level 2 Stylesheets und CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113) ].
...
| [Disabled](../../aspose.html/htmlstyleelement/disabled/) { get; set; } | Aktiviert/deaktiviert das Stylesheet. |
...
| [Media](../../aspose.html/htmlstyleelement/media/) { get; set; } | Konzipiert für die Verwendung mit einem oder mehreren Zielmedien. Siehe Definition des Medienattributs in HTML 4.01. |
...
| [Sheet](../../aspose.html/htmlstyleelement/sheet/) { get; } | Ruft das zugehörige Stylesheet ab. |
...
| [Type](../../aspose.html/htmlstyleelement/type/) { get; set; } | Der Inhaltstyp der Stylesheet-Sprache. Siehe Definition des Typattributs in HTML 4.01. |
