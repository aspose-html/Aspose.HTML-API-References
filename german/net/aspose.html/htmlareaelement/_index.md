...
description: Aspose.Html.HTMLAreaElement klas. Clientseitige ImagemapBereichsdefinition. Siehe Definition des AREAElements in HTML 4.01.
type: docs
weight: 3080
url: /de/net/aspose.html/htmlareaelement/
---
## HTMLAreaElement class

Clientseitige Imagemap-Bereichsdefinition. Siehe Definition des AREA-Elements in HTML 4.01.
...
| Name | Beschreibung |
| --- | --- |
| [AccessKey](../../aspose.html/htmlareaelement/accesskey/) { get; set; } | Ein aus einem Zeichen bestehender Zugriffsschlüssel für den Zugriff auf die Formularsteuerung. Siehe die accesskey-Attributdefinition in HTML 4.01. |
| [Alt](../../aspose.html/htmlareaelement/alt/) { get; set; } | Alternativer Text für Benutzeragenten, die den normalen Inhalt dieses -Elements nicht wiedergeben. Siehe die alt-Attributdefinition in HTML 4.01. |
...
| [Coords](../../aspose.html/htmlareaelement/coords/) { get; set; } | Durch Komma getrennte Liste von Längen, die eine aktive Bereichsgeometrie definieren. Siehe auch`Form` für die Gestalt der Region. Siehe die Definition des Attributs coords in HTML 4.01. |
...
| [Href](../../aspose.html/htmlareaelement/href/) { get; set; } | Der URI [[IETF-RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] der verlinkten Ressource. Siehe die href-Attributdefinition in HTML 4.01. |
...
| [NoHref](../../aspose.html/htmlareaelement/nohref/) { get; set; } | Gibt an, dass dieser Bereich inaktiv ist, dh keine zugeordnete Aktion hat. Siehe die nohref-Attributdefinition in HTML 4.01. |
...
| [RelList](../../aspose.html/htmlareaelement/rellist/) { get; } | Gibt eine Live-DOMTokenList zurück, die Token enthält, die durch das Parsen des „rel“-Attributs empfangen wurden. |
...
| [Shape](../../aspose.html/htmlareaelement/shape/) { get; set; } | Die Form des aktiven Bereichs. Die Koordinaten sind gegeben durch `Koordinaten` . Siehe die Shape-Attributdefinition in HTML 4.01. |
...
| [TabIndex](../../aspose.html/htmlareaelement/tabindex/) { get; set; } | Index, der die Position des Elements in der Tab-Reihenfolge darstellt. Siehe die tabindex-Attributdefinition in HTML 4.01. |
| [TagName](../../aspose.html.dom/element/tagname/) { get; } | Der Name des Elements. |
| [Target](../../aspose.html/htmlareaelement/target/) { get; set; } | Frame zum Rendern der Ressource. Siehe Zielattributdefinition in HTML 4.01. |
