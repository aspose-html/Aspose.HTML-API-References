...
description: Aspose.Html.HTMLButtonElement klas. Druckknopf. Siehe die BUTTONElementdefinition in HTML 4.01.
type: docs
weight: 3130
url: /de/net/aspose.html/htmlbuttonelement/
---
## HTMLButtonElement class

Druckknopf. Siehe die BUTTON-Elementdefinition in HTML 4.01.
...
| Name | Beschreibung |
| --- | --- |
| [AccessKey](../../aspose.html/htmlbuttonelement/accesskey/) { get; set; } | Ein aus einem Zeichen bestehender Zugriffsschlüssel für den Zugriff auf die Formularsteuerung. Siehe die accesskey-Attributdefinition in HTML 4.01. |
...
| [Disabled](../../aspose.html/htmlbuttonelement/disabled/) { get; set; } | Das Steuerelement ist in diesem Kontext nicht verfügbar. Siehe die Definition des deaktivierten Attributs in HTML 4.01. |
...
| [Form](../../aspose.html/htmlbuttonelement/form/) { get; } | Gibt die zurück`FORM` Element, das dieses Steuerelement enthält. Gibt zurück`Null` wenn sich dieses Steuerelement nicht im Kontext eines -Formulars befindet. |
...
| [Name](../../aspose.html/htmlbuttonelement/name/) { get; set; } | Formularsteuerelement oder Objektname bei Übermittlung mit einem Formular. Siehe die Attributdefinition name in HTML 4.01. |
...
| [TabIndex](../../aspose.html/htmlbuttonelement/tabindex/) { get; set; } | Index, der die Position des Elements in der Tab-Reihenfolge darstellt. Siehe die tabindex-Attributdefinition in HTML 4.01. |
...
| [Type](../../aspose.html/htmlbuttonelement/type/) { get; set; } | Der Typ der Schaltfläche (alles Kleinbuchstaben). Siehe Typattributdefinition in HTML 4.01. |
| [Value](../../aspose.html/htmlbuttonelement/value/) { get; set; } | Der aktuelle Formularsteuerwert. Siehe Definition des Wertattributs in HTML 4.01. |
