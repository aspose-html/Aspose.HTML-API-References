...
description: Druckknopf. Siehe die BUTTONElementdefinition in HTML 4.01.
type: docs
weight: 3120
...
| [Form](../../aspose.html/htmlbuttonelement/form) { get; } | Gibt die zurück`BILDEN` Element, das dieses Steuerelement enthält. Gibt zurück`Null` wenn sich dieses Steuerelement nicht im Kontext eines -Formulars befindet. |
