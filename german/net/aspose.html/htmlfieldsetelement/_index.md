...
description: Aspose.Html.HTMLFieldSetElement klas. Organisiert Formularsteuerelemente in logischen Gruppen. Siehe Definition des FIELDSETElements in HTML 4.01.
type: docs
weight: 3210
url: /de/net/aspose.html/htmlfieldsetelement/
---
## HTMLFieldSetElement class

Organisiert Formularsteuerelemente in logischen Gruppen. Siehe Definition des FIELDSET-Elements in HTML 4.01.
...
| [Form](../../aspose.html/htmlfieldsetelement/form/) { get; } | Gibt die zurück`FORM` Element, das dieses Steuerelement enthält. Gibt zurück`Null` wenn sich dieses Steuerelement nicht im Kontext eines -Formulars befindet. |
