...
description: Organisiert Formularsteuerelemente in logischen Gruppen. Siehe Definition des FIELDSETElements in HTML 4.01.
type: docs
weight: 3200
...
| [Form](../../aspose.html/htmlfieldsetelement/form) { get; } | Gibt die zurück`BILDEN` Element, das dieses Steuerelement enthält. Gibt zurück`Null` wenn sich dieses Steuerelement nicht im Kontext eines -Formulars befindet. |
