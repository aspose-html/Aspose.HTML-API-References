...
description: Aspose.Html.HTMLBodyElement klas. Der Hauptteil des HTMLDokuments. Dieses Element ist immer in der DOMAPI vorhanden sogar  wenn die Tags nicht im Quelldokument vorhanden sind. Siehe Definition des BODYElements in HTML 4.01.
type: docs
weight: 3120
url: /de/net/aspose.html/htmlbodyelement/
---
## HTMLBodyElement class

Der Hauptteil des HTML-Dokuments. Dieses Element ist immer in der DOM-API vorhanden, sogar , wenn die Tags nicht im Quelldokument vorhanden sind. Siehe Definition des BODY-Elements in HTML 4.01.
...
| Name | Beschreibung |
| --- | --- |
| [ALink](../../aspose.html/htmlbodyelement/alink/) { get; set; } | Farbe aktiver Links (nach Maustaste gedrückt, aber vor Maustaste oben). Siehe die alink-Attributdefinition in HTML 4.01. Dieses Attribut ist in HTML 4.01 veraltet. |
...
| [Background](../../aspose.html/htmlbodyelement/background/) { get; set; } | -URI [[IETF-RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] des Kachelbildes der Hintergrundtextur. Siehe die Definition des Hintergrundattributs in HTML 4.01. Dieses Attribut ist in HTML 4.01 veraltet. |
...
| [BgColor](../../aspose.html/htmlbodyelement/bgcolor/) { get; set; } | Hintergrundfarbe des Dokuments. Siehe die bgcolor-Attributdefinition in HTML 4.01. Dieses Attribut ist in HTML 4.01 veraltet. |
...
| [Link](../../aspose.html/htmlbodyelement/link/) { get; set; } | Farbe von Links, die nicht aktiv und nicht besucht sind. Siehe die Attributdefinition link in HTML 4.01. Dieses Attribut ist in HTML 4.01. veraltet. |
...
| [Text](../../aspose.html/htmlbodyelement/text/) { get; set; } | Textfarbe des Dokuments. Siehe Textattributdefinition in HTML 4.01. Dieses Attribut ist in HTML 4.01 veraltet. |
...
| [VLink](../../aspose.html/htmlbodyelement/vlink/) { get; set; } | Farbe der Links, die der Benutzer besucht hat. Siehe die Attributdefinition vlink in HTML 4.01. Dieses Attribut ist in HTML 4.01. veraltet. |
