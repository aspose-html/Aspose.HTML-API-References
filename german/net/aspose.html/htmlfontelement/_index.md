...
description: Aspose.Html.HTMLFontElement klas. Lokale Änderung der Schriftart. Siehe die FONTElementdefinition in HTML 4.01. Dieses Element ist in HTML 4.01 veraltet.
type: docs
weight: 3220
url: /de/net/aspose.html/htmlfontelement/
---
## HTMLFontElement class

Lokale Änderung der Schriftart. Siehe die FONT-Elementdefinition in HTML 4.01. Dieses -Element ist in HTML 4.01 veraltet.
...
| [Color](../../aspose.html/htmlfontelement/color/) { get; set; } | Schriftfarbe. Siehe die Farbattributdefinition in HTML 4.01. Dieses -Attribut ist in HTML 4.01 veraltet. |
...
| [Face](../../aspose.html/htmlfontelement/face/) { get; set; } | Kennung der Schriftart. Siehe die Gesichtsattributdefinition in HTML 4.01. Dieses Attribut ist in HTML 4.01 veraltet. |
...
| [Size](../../aspose.html/htmlfontelement/size/) { get; set; } | Schriftgröße. Siehe Definition des Größenattributs in HTML 4.01. Dieses -Attribut ist in HTML 4.01 veraltet. |
