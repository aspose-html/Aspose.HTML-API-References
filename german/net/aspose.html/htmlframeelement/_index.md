...
description: Aspose.Html.HTMLFrameElement klas. Erstellen Sie einen Rahmen. Siehe FRAMEElementdefinition in HTML 4.01.
type: docs
weight: 3240
url: /de/net/aspose.html/htmlframeelement/
---
## HTMLFrameElement class

Erstellen Sie einen Rahmen. Siehe FRAME-Elementdefinition in HTML 4.01.
...
| [ContentDocument](../../aspose.html/htmlframeelement/contentdocument/) { get; } | Das Dokument, das dieser Rahmen enthält, falls vorhanden und verfügbar, oder`Null` andernfalls. @seit DOM Level 2 |
...
| [FrameBorder](../../aspose.html/htmlframeelement/frameborder/) { get; set; } | Rahmengrenzen anfordern. Siehe die frameborder-Attributdefinition in HTML 4.01. |
...
| [LongDesc](../../aspose.html/htmlframeelement/longdesc/) { get; set; } | -URI [[IETF-RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] bezeichnet eine lange Beschreibung dieses Bildes oder Rahmens. Siehe die Definition des Attributs longdesc in HTML 4.01. |
| [MarginHeight](../../aspose.html/htmlframeelement/marginheight/) { get; set; } | Rahmenrandhöhe in Pixel. Siehe Definition des marginheight-Attributs in HTML 4.01. |
| [MarginWidth](../../aspose.html/htmlframeelement/marginwidth/) { get; set; } | Rahmenrandbreite in Pixel. Siehe Definition des Attributs marginwidth in HTML 4.01. |
| [Name](../../aspose.html/htmlframeelement/name/) { get; set; } | Der Framename (Objekt der`Ziel` Attribut). Siehe die Definition des Namensattributs in HTML 4.01. |
...
| [NoResize](../../aspose.html/htmlframeelement/noresize/) { get; set; } | Wenn wahr, verbieten Sie dem Benutzer, die Größe des Rahmens zu ändern. Siehe die Definition des noresize-Attributs in HTML 4.01. |
...
| [Scrolling](../../aspose.html/htmlframeelement/scrolling/) { get; set; } | Geben Sie an, ob der Rahmen Bildlaufleisten haben soll oder nicht. Siehe die Definition des -Scrolling-Attributs in HTML 4.01. |
...
| [Src](../../aspose.html/htmlframeelement/src/) { get; set; } | Ein URI [[IETF-RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ], der die anfänglichen Rahmeninhalte bezeichnet. Siehe Definition des src-Attributs in HTML 4.01. |
