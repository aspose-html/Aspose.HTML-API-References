...
| [CodeBase](../../aspose.html/htmlobjectelement/codebase) { get; set; } | Basis-URI [[IETF-RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] zum`Klasse` ,`Daten` , und `Archiv` Attribute. Siehe Codebase-Attribut definition in HTML 4.01. |
...
| [Form](../../aspose.html/htmlobjectelement/form) { get; set; } | Gibt die zurück`BILDEN` Element, das dieses Steuerelement enthält. Kehrt zurück`Null` wenn sich dieses Steuerelement nicht im Kontext eines Formulars befindet. |
