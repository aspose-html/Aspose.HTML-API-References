...
| Name | Beschreibung |
| --- | --- |
| [Align](../../aspose.html/htmlobjectelement/align/) { get; set; } | Richtet dieses Objekt (vertikal oder horizontal) in Bezug auf den umgebenden Text aus. Siehe die Alignment-Attributdefinition in HTML 4.01. Dieses Attribut ist in HTML 4.01 veraltet. |
| [Archive](../../aspose.html/htmlobjectelement/archive/) { get; set; } | Durch Leerzeichen getrennte Liste von Archiven. Siehe die Archivattributdefinition in HTML 4.01. |
...
| [Border](../../aspose.html/htmlobjectelement/border/) { get; set; } | Breite des Rahmens um das Objekt. Siehe Definition des Border-Attributs in HTML 4.01. Dieses Attribut ist in HTML 4.01 veraltet. |
...
| [ClassId](../../aspose.html/htmlobjectelement/classid/) { get; set; } | Definiert einen Klassen-ID-Wert, wie er in der Windows-Registrierung oder einer URL festgelegt ist |
...
| [Code](../../aspose.html/htmlobjectelement/code/) { get; set; } | Applet-Klassendatei. Siehe die`Code` -Attribut für HTMLAppletElement. |
| [CodeBase](../../aspose.html/htmlobjectelement/codebase/) { get; set; } | Basis-URI [[IETF-RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] für`Klasse` ,`Daten` , und `Archiv` Attribute. Siehe Codebase-Attribut definition in HTML 4.01. |
| [CodeType](../../aspose.html/htmlobjectelement/codetype/) { get; set; } | Inhaltstyp für heruntergeladene Daten über`Klasse` Attribut. Siehe die Codetyp-Attributdefinition in HTML 4.01. |
| [Data](../../aspose.html/htmlobjectelement/data/) { get; set; } | Ein URI [[IETF-RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ], der den Speicherort der Objektdaten angibt. Siehe die data -Attributdefinition in HTML 4.01. |
| [Declare](../../aspose.html/htmlobjectelement/declare/) { get; set; } | Dieses Objekt deklarieren (für zukünftige Referenzzwecke), aber nicht instanziieren. Siehe Deklarationsattributdefinition in HTML 4.01. |
...
| [Form](../../aspose.html/htmlobjectelement/form/) { get; set; } | Gibt die zurück`FORM` Element, das dieses Steuerelement enthält. Kehrt zurück`Null` wenn sich dieses Steuerelement nicht im Kontext eines Formulars befindet. |
| [Height](../../aspose.html/htmlobjectelement/height/) { get; set; } | Höhe überschreiben. Siehe Definition des Höhenattributs in HTML 4.01. |
| [Hspace](../../aspose.html/htmlobjectelement/hspace/) { get; set; } | Horizontaler Abstand in Pixel links und rechts von diesem Bild, Applet oder Objekt. Siehe die hspace-Attributdefinition in HTML 4.01. Dieses Attribut ist in HTML 4.01 veraltet. |
...
| [Name](../../aspose.html/htmlobjectelement/name/) { get; set; } | Formularsteuerelement oder Objektname bei Übermittlung mit einem Formular. Siehe die Attributdefinition name in HTML 4.01. |
...
| [Standby](../../aspose.html/htmlobjectelement/standby/) { get; set; } | Beim Laden des Objekts zu rendernde Nachricht. Siehe Definition des Standby-Attributs in HTML 4.01. |
...
| [TabIndex](../../aspose.html/htmlobjectelement/tabindex/) { get; set; } | Index, der die Position des Elements in der Tab-Reihenfolge darstellt. Siehe die tabindex-Attributdefinition in HTML 4.01. |
...
| [Type](../../aspose.html/htmlobjectelement/type/) { get; set; } | Inhaltstyp für heruntergeladene Daten über`Daten` Attribut. Siehe die Typattributdefinition in HTML 4.01. |
| [UseMap](../../aspose.html/htmlobjectelement/usemap/) { get; set; } | Clientseitige Imagemap verwenden. Siehe die usemap-Attributdefinition in HTML 4.01. |
| [Vspace](../../aspose.html/htmlobjectelement/vspace/) { get; set; } | Vertikaler Abstand in Pixel über und unter diesem Bild, Applet oder Objekt. Siehe die vspace-Attributdefinition in HTML 4.01. Dieses Attribut ist in HTML 4.01 veraltet. |
| [Width](../../aspose.html/htmlobjectelement/width/) { get; set; } | Breite überschreiben. Siehe Definition des width-Attributs in HTML 4.01. |
