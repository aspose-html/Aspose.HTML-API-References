...
description: Aspose.Html.HTMLTableSectionElement klas. DieTHEAD TFUSS  UndKÖRPER Elemente.
type: docs
weight: 3590
url: /de/net/aspose.html/htmltablesectionelement/
---
## HTMLTableSectionElement class

Die`THEAD` ,`TFUSS` , Und`KÖRPER` Elemente.
...
| Name | Beschreibung |
| --- | --- |
| [Align](../../aspose.html/htmltablesectionelement/align/) { get; set; } | Horizontale Ausrichtung von Daten in Zellen. Siehe die`ausrichten` Attribut für HTMLTheadElement für Details. |
...
| [Ch](../../aspose.html/htmltablesectionelement/ch/) { get; set; } | Ausrichtungszeichen für Zellen in einer Spalte. Siehe Definition des char-Attributs in HTML 4.01. |
...
| [ChOff](../../aspose.html/htmltablesectionelement/choff/) { get; set; } | Offset des Ausrichtungszeichens. Siehe Definition des Charoff-Attributs in HTML 4.01. |
...
| [Rows](../../aspose.html/htmltablesectionelement/rows/) { get; } | Die Sammlung von Zeilen in diesem Tabellenabschnitt. |
...
| [VAlign](../../aspose.html/htmltablesectionelement/valign/) { get; set; } | Vertikale Ausrichtung von Daten in Zellen. Siehe die`gültig` Attribut für HTMLTheadElement für Details. |
...
| [DeleteRow](../../aspose.html/htmltablesectionelement/deleterow/)(int) | Löschen Sie eine Zeile aus diesem Abschnitt. |
...
| [InsertRow](../../aspose.html/htmltablesectionelement/insertrow/)(int) | Fügen Sie eine Zeile in diesen Abschnitt ein. Die neue Zeile wird unmittelbar vor der aktuellen eingefügt`Index` Reihe in diesem Abschnitt. Wenn `Index` -1 oder gleich der Anzahl der Zeilen in diesem -Abschnitt ist, wird die neue Zeile angehängt. |
