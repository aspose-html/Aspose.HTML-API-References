...
description: Aspose.Html.HTMLInputElement klas. Formularsteuerung. Abhängig von der Umgebung in der die Seite angezeigt wird kann die Eigenschaft value für den DateiUploadEingabetyp schreibgeschützt sein. Für den Eingabetyp Passwort kann der tatsächlich zurückgegebene Wert maskiert werden um eine unbefugte Verwendung zu verhindern. Siehe die Definition des INPUTElements in HTML4.01 .
type: docs
weight: 3320
url: /de/net/aspose.html/htmlinputelement/
---
## HTMLInputElement class

Formularsteuerung. Abhängig von der Umgebung, in der die Seite angezeigt wird, kann die Eigenschaft value für den Datei-Upload-Eingabetyp schreibgeschützt sein. Für den Eingabetyp "Passwort" kann der tatsächlich zurückgegebene Wert maskiert werden, um eine unbefugte Verwendung zu verhindern. Siehe die Definition des INPUT-Elements in [[HTML4.01](http://www.w3.org/TR/1999/REC-html401-19991224) ].
...
| Name | Beschreibung |
| --- | --- |
| [Accept](../../aspose.html/htmlinputelement/accept/) { get; set; } | Eine durch Kommas getrennte Liste von Inhaltstypen, die ein Server, der dieses -Formular verarbeitet, korrekt verarbeiten wird. Siehe Definition des Accept-Attributs in HTML 4.01. |
| [AccessKey](../../aspose.html/htmlinputelement/accesskey/) { get; set; } | Ein aus einem Zeichen bestehender Zugriffsschlüssel für den Zugriff auf die Formularsteuerung. Siehe die accesskey-Attributdefinition in HTML 4.01. |
| [Align](../../aspose.html/htmlinputelement/align/) { get; set; } | Richtet dieses Objekt (vertikal oder horizontal) in Bezug auf seinen umgebenden Text aus. Siehe die Alignment-Attributdefinition in HTML 4.01. Dieses Attribut ist in HTML 4.01 veraltet. |
| [Alt](../../aspose.html/htmlinputelement/alt/) { get; set; } | Alternativer Text für Benutzeragenten, die den normalen Inhalt dieses -Elements nicht wiedergeben. Siehe die alt-Attributdefinition in HTML 4.01. |
...
| [DefaultChecked](../../aspose.html/htmlinputelement/defaultchecked/) { get; set; } | Wann`Typ` den Wert "radio" oder "checkbox" hat, repräsentiert dieses das HTML-checked-Attribut des Elements. Der Wert von dieses Attributs ändert sich nicht, wenn sich der Zustand des entsprechenden Formular-Steuerelements in einem interaktiven Benutzeragenten ändert. Siehe die Definition des Attributs „checked “ in HTML 4.01. |
| [DefaultValue](../../aspose.html/htmlinputelement/defaultvalue/) { get; set; } | Wenn die`Typ`Attribut des Elements den Wert "text", "file" oder "password" hat, repräsentiert dies den HTML-Wert des Attributs des Elements. Der Wert dieses Attributs ändert sich nicht , wenn sich der Inhalt des entsprechenden Formularsteuerelements in einem interaktiven -Benutzeragenten ändert. Siehe Definition des Wertattributs in HTML 4.01. |
...
| [Form](../../aspose.html/htmlinputelement/form/) { get; set; } | Gibt die zurück`FORM` Element, das dieses Steuerelement enthält. Gibt zurück`Null` wenn sich dieses Steuerelement nicht im Kontext eines -Formulars befindet. |
...
| [List](../../aspose.html/htmlinputelement/list/) { get; set; } | Das Listenattribut wird verwendet, um ein Element zu identifizieren, das vordefinierte Optionen auflistet, die dem Benutzer vorgeschlagen werden. Falls vorhanden, muss sein Wert die ID eines Datenlistenelements im selben Dokument sein. |
...
| [MaxLength](../../aspose.html/htmlinputelement/maxlength/) { get; set; } | Maximale Zeichenanzahl für Textfelder, wenn`Typ` hat den Wert "Text" oder "Passwort". Siehe die Definition des maxlength-Attributs in HTML 4.01. |
| [Name](../../aspose.html/htmlinputelement/name/) { get; set; } | Formularsteuerelement oder Objektname bei Übermittlung mit einem Formular. Siehe die Attributdefinition name in HTML 4.01. |
...
| [ReadOnly](../../aspose.html/htmlinputelement/readonly/) { get; set; } | Dieses Steuerelement ist schreibgeschützt. Relevant nur wann`Typ` hat den Wert "Text" oder "Passwort". Siehe die Readonly-Attributdefinition in HTML 4.01. |
...
| [Size](../../aspose.html/htmlinputelement/size/) { get; set; } | Größeninformationen. Die genaue Bedeutung ist für jeden Feldtyp spezifisch. Siehe Definition des Größenattributs in HTML 4.01. @version DOM Level 2 |
| [Src](../../aspose.html/htmlinputelement/src/) { get; set; } | Wenn die`Typ`-Attribut den Wert "image" hat, dieses -Attribut gibt die Position des Bildes an, das verwendet werden soll, um den grafischen Submit-Button zu schmücken. Siehe die src-Attributdefinition in HTML 4.01. |
...
| [TabIndex](../../aspose.html/htmlinputelement/tabindex/) { get; set; } | Index, der die Position des Elements in der Tab-Reihenfolge darstellt. Siehe die tabindex-Attributdefinition in HTML 4.01. |
...
| Name | Beschreibung |
| --- | --- |
| event [OnAbort](../../aspose.html/htmlelement/onabort/) | Ruft den Event-Handler für das OnAbort-Ereignis ab oder legt ihn fest. |
| event [OnBlur](../../aspose.html/htmlelement/onblur/) | Ruft den Event-Handler für das OnBlur-Ereignis ab oder legt ihn fest. |
| event [OnCancel](../../aspose.html/htmlelement/oncancel/) | Ruft den Ereignishandler für das OnCancel-Ereignis ab oder legt ihn fest. |
| event [OnCanplay](../../aspose.html/htmlelement/oncanplay/) | Ruft den Ereignishandler für das OnCanplay-Ereignis ab oder legt ihn fest. |
| event [OnCanPlayThrough](../../aspose.html/htmlelement/oncanplaythrough/) | Ruft den Ereignishandler für das OnCanPlayThrough-Ereignis ab oder legt ihn fest. |
| event [OnChange](../../aspose.html/htmlelement/onchange/) | Ruft den Event-Handler für das OnChange-Ereignis ab oder legt ihn fest. |
| event [OnClick](../../aspose.html/htmlelement/onclick/) | Ruft den Event-Handler für das OnClick-Ereignis ab oder legt ihn fest. |
| event [OnCueChange](../../aspose.html/htmlelement/oncuechange/) | Ruft den Event-Handler für das OnCueChange-Ereignis ab oder legt ihn fest. |
| event [OnDblClick](../../aspose.html/htmlelement/ondblclick/) | Ruft den Ereignishandler für das OnDblClick-Ereignis ab oder legt ihn fest. |
| event [OnDurationChange](../../aspose.html/htmlelement/ondurationchange/) | Ruft den Ereignishandler für das OnDurationChange-Ereignis ab oder legt ihn fest. |
| event [OnEmptied](../../aspose.html/htmlelement/onemptied/) | Ruft den Ereignishandler für das OnEmptied-Ereignis ab oder legt ihn fest. |
| event [OnEnded](../../aspose.html/htmlelement/onended/) | Ruft Ereignishandler für OnEnded-Ereignis ab oder legt sie fest. |
| event [OnError](../../aspose.html/htmlelement/onerror/) | Ruft den Event-Handler für das OnError-Ereignis ab oder legt ihn fest. |
| event [OnFocus](../../aspose.html/htmlelement/onfocus/) | Ruft den Event-Handler für das OnFocus-Ereignis ab oder legt ihn fest. |
| event [OnInput](../../aspose.html/htmlelement/oninput/) | Ruft den Ereignishandler für das OnInput-Ereignis ab oder legt ihn fest. |
| event [OnInvalid](../../aspose.html/htmlelement/oninvalid/) | Ruft Ereignishandler für das OnInvalid-Ereignis ab oder legt es fest. |
| event [OnKeyDown](../../aspose.html/htmlelement/onkeydown/) | Ruft den Event-Handler für das OnKeyDown-Ereignis ab oder legt ihn fest. |
| event [OnKeyPress](../../aspose.html/htmlelement/onkeypress/) | Ruft den Event-Handler für das OnKeyPress-Ereignis ab oder legt ihn fest. |
| event [OnKeyUp](../../aspose.html/htmlelement/onkeyup/) | Ruft den Event-Handler für das OnKeyUp-Ereignis ab oder legt ihn fest. |
| event [OnLoad](../../aspose.html/htmlelement/onload/) | Ruft den Ereignishandler für das OnLoad-Ereignis ab oder legt ihn fest. |
| event [OnLoadedData](../../aspose.html/htmlelement/onloadeddata/) | Ruft den Ereignishandler für das OnLoadedData-Ereignis ab oder legt ihn fest. |
| event [OnLoadedMetadata](../../aspose.html/htmlelement/onloadedmetadata/) | Ruft den Event-Handler für das OnLoadedMetadata-Ereignis ab oder legt ihn fest. |
| event [OnLoadStart](../../aspose.html/htmlelement/onloadstart/) | Ruft den Ereignishandler für das OnLoadStart-Ereignis ab oder legt ihn fest. |
| event [OnMouseDown](../../aspose.html/htmlelement/onmousedown/) | Ruft den Ereignishandler für das OnMouseDown-Ereignis ab oder legt ihn fest. |
| event [OnMouseEnter](../../aspose.html/htmlelement/onmouseenter/) | Ruft Ereignishandler für das OnMouseEnter-Ereignis ab oder legt es fest. |
| event [OnMouseLeave](../../aspose.html/htmlelement/onmouseleave/) | Ruft den Ereignishandler für das OnMouseLeave-Ereignis ab oder legt ihn fest. |
| event [OnMouseMove](../../aspose.html/htmlelement/onmousemove/) | Ruft Ereignishandler für das OnMouseMove-Ereignis ab oder legt es fest. |
| event [OnMouseOut](../../aspose.html/htmlelement/onmouseout/) | Ruft den Event-Handler für das OnMouseOut-Ereignis ab oder legt ihn fest. |
| event [OnMouseOver](../../aspose.html/htmlelement/onmouseover/) | Ruft den Ereignishandler für das OnMouseOver-Ereignis ab oder legt ihn fest. |
| event [OnMouseUp](../../aspose.html/htmlelement/onmouseup/) | Ruft Ereignishandler für das OnMouseUp-Ereignis ab oder legt es fest. |
| event [OnMouseWheel](../../aspose.html/htmlelement/onmousewheel/) | Ruft Ereignishandler für das OnMouseWheel-Ereignis ab oder legt es fest. |
| event [OnPause](../../aspose.html/htmlelement/onpause/) | Ruft den Ereignishandler für das OnPause-Ereignis ab oder legt ihn fest. |
| event [OnPlay](../../aspose.html/htmlelement/onplay/) | Ruft den Ereignishandler für das OnPlay-Ereignis ab oder legt ihn fest. |
| event [OnPlaying](../../aspose.html/htmlelement/onplaying/) | Ruft den Event-Handler für das OnPlaying-Ereignis ab oder legt ihn fest. |
| event [OnProgress](../../aspose.html/htmlelement/onprogress/) | Ruft den Ereignishandler für das OnProgress-Ereignis ab oder legt ihn fest. |
| event [OnRateChange](../../aspose.html/htmlelement/onratechange/) | Ruft den Ereignishandler für das OnRateChange-Ereignis ab oder legt ihn fest. |
| event [OnReset](../../aspose.html/htmlelement/onreset/) | Ruft den Ereignishandler für das OnReset-Ereignis ab oder legt ihn fest. |
| event [OnResize](../../aspose.html/htmlelement/onresize/) | Ruft den Event-Handler für das OnResize-Ereignis ab oder legt ihn fest. |
| event [OnScroll](../../aspose.html/htmlelement/onscroll/) | Ruft den Event-Handler für das OnScroll-Ereignis ab oder legt ihn fest. |
| event [OnSeeked](../../aspose.html/htmlelement/onseeked/) | Ruft den Ereignishandler für das OnSeeked-Ereignis ab oder legt ihn fest. |
| event [OnSeeking](../../aspose.html/htmlelement/onseeking/) | Ruft den Event-Handler für das OnSeeking-Ereignis ab oder legt ihn fest. |
| event [OnSelect](../../aspose.html/htmlelement/onselect/) | Ruft den Ereignishandler für das OnSelect-Ereignis ab oder legt ihn fest. |
| event [OnShow](../../aspose.html/htmlelement/onshow/) | Ruft den Ereignishandler für das OnShow-Ereignis ab oder legt ihn fest. |
| event [OnStalled](../../aspose.html/htmlelement/onstalled/) | Ruft den Event-Handler für das OnStalled-Ereignis ab oder legt ihn fest. |
| event [OnSubmit](../../aspose.html/htmlelement/onsubmit/) | Ruft den Event-Handler für das OnSubmit-Ereignis ab oder legt ihn fest. |
| event [OnSuspend](../../aspose.html/htmlelement/onsuspend/) | Ruft den Ereignishandler für das OnSuspend-Ereignis ab oder legt ihn fest. |
| event [OnTimeUpdate](../../aspose.html/htmlelement/ontimeupdate/) | Ruft Ereignishandler für das OnTimeUpdate-Ereignis ab oder legt es fest. |
| event [OnToggle](../../aspose.html/htmlelement/ontoggle/) | Ruft den Event-Handler für das OnToggle-Ereignis ab oder legt ihn fest. |
| event [OnVolumeChange](../../aspose.html/htmlelement/onvolumechange/) | Ruft Ereignishandler für das OnVolumeChange-Ereignis ab oder legt es fest. |
| event [OnWaiting](../../aspose.html/htmlelement/onwaiting/) | Ruft den Ereignishandler für das OnWaiting-Ereignis ab oder legt ihn fest. |
