...
description: Aspose.Html.HTMLIsIndexElement klas. Dieses Element dient zur einzeiligen Texteingabe. Siehe Definition des ISINDEXElements in HTML 4.01. Dieses Element ist in HTML 4.01 veraltet.
type: docs
weight: 3330
url: /de/net/aspose.html/htmlisindexelement/
---
## HTMLIsIndexElement class

Dieses Element dient zur einzeiligen Texteingabe. Siehe Definition des ISINDEX-Elements in HTML 4.01. Dieses Element ist in HTML 4.01 veraltet.
...
| [Form](../../aspose.html/htmlisindexelement/form/) { get; } | Gibt die zurück Element, das dieses Steuerelement enthält. Gibt zurück wenn sich dieses Steuerelement nicht im Kontext eines -Formulars befindet. |
...
| [Prompt](../../aspose.html/htmlisindexelement/prompt/) { get; set; } | Die Eingabeaufforderung. Siehe die Eingabeaufforderungsattributdefinition in HTML 4.01. Dieses Attribut ist in HTML 4.01 veraltet. |
