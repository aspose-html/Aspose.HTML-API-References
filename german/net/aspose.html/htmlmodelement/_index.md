...
description: Aspose.Html.HTMLModElement klas. Änderungsmitteilung an einem Teil eines Dokuments. Siehe die INS und DELElement Definitionen in HTML 4.01.
type: docs
weight: 3410
url: /de/net/aspose.html/htmlmodelement/
---
## HTMLModElement class

Änderungsmitteilung an einem Teil eines Dokuments. Siehe die INS- und DEL-Element- -Definitionen in HTML 4.01.
...
| [Cite](../../aspose.html/htmlmodelement/cite/) { get; set; } | Ein URI [[IETF-RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] bezeichnet ein Dokument, das den Grund für die Änderung beschreibt. Siehe die Definition des Zitierattributs in HTML 4.01. |
...
| [DateTime](../../aspose.html/htmlmodelement/datetime/) { get; set; } | Datum und Uhrzeit der Änderung. Siehe die datetime-Attributdefinition in HTML 4.01. |
