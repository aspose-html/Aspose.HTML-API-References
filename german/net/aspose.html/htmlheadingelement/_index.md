...
description: Aspose.Html.HTMLHeadingElement klas. Für dieH1 ZuH6 Elemente. Siehe die Definition von H1 element in HTML 4.01.
type: docs
weight: 3280
url: /de/net/aspose.html/htmlheadingelement/
---
## HTMLHeadingElement class

Für die`H1` Zu`H6` Elemente. Siehe die Definition von H1 element in HTML 4.01.
...
| Name | Beschreibung |
| --- | --- |
| [Align](../../aspose.html/htmlheadingelement/align/) { get; set; } | Horizontale Textausrichtung. Siehe Definition des Attributs align in HTML 4.01. Dieses Attribut ist in HTML 4.01 veraltet. |
