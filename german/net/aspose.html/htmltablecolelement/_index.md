...
description: Aspose.Html.HTMLTableColElement klas. Gruppiert dieCOL UndCOLGROUP Elemente. Siehe die COLElementdefinition in HTML 4.01.
type: docs
weight: 3560
url: /de/net/aspose.html/htmltablecolelement/
---
## HTMLTableColElement class

Gruppiert die`COL` Und`COLGROUP` Elemente. Siehe die COL-Elementdefinition in HTML 4.01.
...
| Name | Beschreibung |
| --- | --- |
| [Align](../../aspose.html/htmltablecolelement/align/) { get; set; } | Horizontale Ausrichtung der Zelldaten in der Spalte. Siehe Definition des align-Attributs in HTML 4.01. |
...
| [Ch](../../aspose.html/htmltablecolelement/ch/) { get; set; } | Ausrichtungszeichen für Zellen in einer Spalte. Siehe Definition des char-Attributs in HTML 4.01. |
...
| [ChOff](../../aspose.html/htmltablecolelement/choff/) { get; set; } | Offset des Ausrichtungszeichens. Siehe Definition des Charoff-Attributs in HTML 4.01. |
...
| [Span](../../aspose.html/htmltablecolelement/span/) { get; set; } | Gibt die Anzahl der Spalten in einer Gruppe an oder die von einer Gruppierung betroffen sind. Siehe die span-Attributdefinition in HTML 4.01. |
...
| [VAlign](../../aspose.html/htmltablecolelement/valign/) { get; set; } | Vertikale Ausrichtung der Zelldaten in der Spalte. Siehe Definition des valign-Attributs in HTML 4.01. |
| [Width](../../aspose.html/htmltablecolelement/width/) { get; set; } | Standardspaltenbreite. Siehe Definition des width-Attributs in HTML 4.01. |
