...
description: Aspose.Html.HTMLTableRowElement klas. Eine Zeile in einer Tabelle. Siehe die Definition des TRElements in HTML 4.01.
type: docs
weight: 3580
url: /de/net/aspose.html/htmltablerowelement/
---
## HTMLTableRowElement class

Eine Zeile in einer Tabelle. Siehe die Definition des TR-Elements in HTML 4.01.
...
| Name | Beschreibung |
| --- | --- |
| [Align](../../aspose.html/htmltablerowelement/align/) { get; set; } | Horizontale Ausrichtung der Daten innerhalb der Zellen dieser Zeile. Siehe die Attributdefinition von align in HTML 4.01. |
...
| [BgColor](../../aspose.html/htmltablerowelement/bgcolor/) { get; set; } | Hintergrundfarbe für Zeilen. Siehe die bgcolor-Attributdefinition in HTML 4.01. Dieses Attribut ist in HTML 4.01 veraltet. |
| [Cells](../../aspose.html/htmltablerowelement/cells/) { get; } | Die Sammlung von Zellen in dieser Zeile. @version DOM Level 2 |
| [Ch](../../aspose.html/htmltablerowelement/ch/) { get; set; } | Ausrichtungszeichen für Zellen in einer Spalte. Siehe Definition des char-Attributs in HTML 4.01. |
...
| [ChOff](../../aspose.html/htmltablerowelement/choff/) { get; set; } | Offset des Ausrichtungszeichens. Siehe Definition des Charoff-Attributs in HTML 4.01. |
...
| [RowIndex](../../aspose.html/htmltablerowelement/rowindex/) { get; } | Dies ist in logischer Reihenfolge und nicht in Dokumentenreihenfolge. Die `Zeilenindex` berücksichtigt Abschnitte ( `THEAD` ,`TFUSS` , oder`KÖRPER` ) innerhalb von der Tabelle, Platzierung`THEAD` Zeilen zuerst im Index, gefolgt von`KÖRPER` Reihen, gefolgt von`TFUSS` Zeilen. @Version DOM Level 2 |
| [SchemaTypeInfo](../../aspose.html.dom/element/schematypeinfo/) { get; } | Die diesem Element zugeordneten Typinformationen. |
| [SectionRowIndex](../../aspose.html/htmltablerowelement/sectionrowindex/) { get; } | Der Index dieser Zeile relativ zum aktuellen Abschnitt ( `THEAD` ,`TFUSS` , oder`KÖRPER` ), ab 0. @version DOM Level 2 |
...
| [VAlign](../../aspose.html/htmltablerowelement/valign/) { get; set; } | Vertikale Ausrichtung der Daten innerhalb der Zellen dieser Zeile. Siehe die Attributdefinition valign in HTML 4.01. |
...
| [DeleteCell](../../aspose.html/htmltablerowelement/deletecell/)(int) | Löscht eine Zelle aus der aktuellen Zeile. |
...
| [InsertCell](../../aspose.html/htmltablerowelement/insertcell/)(int) | Fügen Sie ein Leerzeichen ein`TD` Zelle in diese Zeile. Wenn `Index` -1 oder gleich der Anzahl der Zellen ist, wird die neue Zelle angehängt. |
