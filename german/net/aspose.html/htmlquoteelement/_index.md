...
description: Aspose.Html.HTMLQuoteElement klas. Für dieQ UndBLOCKQUOTEElemente. Siehe Elementdefinition Q in HTML 4.01.
type: docs
weight: 3500
url: /de/net/aspose.html/htmlquoteelement/
---
## HTMLQuoteElement class

Für die`Q` Und`BLOCKQUOTE`Elemente. Siehe Elementdefinition Q in HTML 4.01.
...
| [Cite](../../aspose.html/htmlquoteelement/cite/) { get; set; } | Ein URI [[IETF-RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] bezeichnet ein Quelldokument oder eine Nachricht. Siehe Definition des Zitierattributs in HTML 4.01. |
