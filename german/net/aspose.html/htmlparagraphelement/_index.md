...
description: Aspose.Html.HTMLParagraphElement klas. Absätze. Siehe die Definition des PElements in HTML 4.01.
type: docs
weight: 3470
url: /de/net/aspose.html/htmlparagraphelement/
---
## HTMLParagraphElement class

Absätze. Siehe die Definition des P-Elements in HTML 4.01.
...
| Name | Beschreibung |
| --- | --- |
| [Align](../../aspose.html/htmlparagraphelement/align/) { get; set; } | Horizontale Textausrichtung. Siehe Definition des Attributs align in HTML 4.01. Dieses Attribut ist in HTML 4.01 veraltet. |
