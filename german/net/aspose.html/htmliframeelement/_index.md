...
description: Aspose.Html.HTMLIFrameElement klas. InlineUnterfenster. Siehe die IFRAMEElementdefinition in HTML 4.01.
type: docs
weight: 3300
url: /de/net/aspose.html/htmliframeelement/
---
## HTMLIFrameElement class

Inline-Unterfenster. Siehe die IFRAME-Elementdefinition in HTML 4.01.
...
| Name | Beschreibung |
| --- | --- |
| [Align](../../aspose.html/htmliframeelement/align/) { get; set; } | Richtet dieses Objekt (vertikal oder horizontal) in Bezug auf seinen umgebenden Text aus. Siehe die Alignment-Attributdefinition in HTML 4.01. Dieses Attribut ist in HTML 4.01 veraltet. |
...
| [FrameBorder](../../aspose.html/htmliframeelement/frameborder/) { get; set; } | Rahmengrenzen anfordern. Siehe die frameborder-Attributdefinition in HTML 4.01. |
| [Height](../../aspose.html/htmliframeelement/height/) { get; set; } | Rahmenhöhe. Siehe Definition des Höhenattributs in HTML 4.01. |
...
| [LongDesc](../../aspose.html/htmliframeelement/longdesc/) { get; set; } | -URI [[IETF-RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] bezeichnet eine lange Beschreibung dieses Bildes oder Rahmens. Siehe die Definition des Attributs longdesc in HTML 4.01. |
| [MarginHeight](../../aspose.html/htmliframeelement/marginheight/) { get; set; } | Rahmenrandhöhe in Pixel. Siehe Definition des marginheight-Attributs in HTML 4.01. |
| [MarginWidth](../../aspose.html/htmliframeelement/marginwidth/) { get; set; } | Rahmenrandbreite in Pixel. Siehe Definition des Attributs marginwidth in HTML 4.01. |
| [Name](../../aspose.html/htmliframeelement/name/) { get; set; } | Der Framename (Objekt der`Ziel` Attribut). Siehe die Definition des Namensattributs in HTML 4.01. |
...
| [Scrolling](../../aspose.html/htmliframeelement/scrolling/) { get; set; } | Geben Sie an, ob der Rahmen Bildlaufleisten haben soll oder nicht. Siehe die Definition des -Scrolling-Attributs in HTML 4.01. |
...
| [Src](../../aspose.html/htmliframeelement/src/) { get; set; } | Ein URI [[IETF-RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ], der die anfänglichen Rahmeninhalte bezeichnet. Siehe Definition des src-Attributs in HTML 4.01. |
...
| [Width](../../aspose.html/htmliframeelement/width/) { get; set; } | Rahmenbreite. Siehe Definition des width-Attributs in HTML 4.01. |
