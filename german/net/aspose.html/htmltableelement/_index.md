...
description: Die create und deleteMethoden für die Tabelle ermöglichen es Autoren Tabellen zu erstellen und zu ändern. HTML4.01http//www.w3.org/TR/1999/REChtml40119991224  gibt an dass jeweils nur einer der BILDBESCHRIFTUNG THEAD  undTFUSS Elemente können in einer Tabelle vorhanden sein. Wenn also eines vorhanden ist und die Methode createTHead oder createTFoot aufgerufen wird gibt die Methode das vorhandene THead oder TFootElement zurück. Siehe die TABLEElementdefinition in HTML 4.01.
type: docs
weight: 3560
...
Die create*- und delete*-Methoden für die Tabelle ermöglichen es Autoren, Tabellen zu erstellen und zu ändern. [[HTML4.01](http://www.w3.org/TR/1999/REC-html401-19991224) ] gibt an, dass jeweils nur einer der `BILDBESCHRIFTUNG` ,`THEAD` , und`TFUSS` Elemente können in einer Tabelle vorhanden sein. Wenn also eines vorhanden ist und die Methode createTHead() oder createTFoot() aufgerufen wird, gibt die Methode das vorhandene THead- oder TFoot-Element zurück. Siehe die TABLE-Elementdefinition in HTML 4.01.
...
| [Caption](../../aspose.html/htmltableelement/caption) { get; } | Gibt die der Tabelle zurück`BILDBESCHRIFTUNG` , oder ungültig, wenn keine vorhanden ist. @version DOM Level 2 |
...
| [THead](../../aspose.html/htmltableelement/thead) { get; } | Gibt die der Tabelle zurück`BILDBESCHRIFTUNG` , oder ungültig, wenn keine vorhanden ist. |
