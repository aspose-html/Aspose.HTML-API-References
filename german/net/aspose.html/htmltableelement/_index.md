...
description: Aspose.Html.HTMLTableElement klas. Die create und deleteMethoden für die Tabelle ermöglichen es Autoren Tabellen zu erstellen und zu ändern. HTML4.01  gibt an dass jeweils nur einer der UNTERTITEL THEAD  UndTFUSS Elemente können in einer Tabelle vorhanden sein. Wenn also eines vorhanden ist und die Methode createTHead oder createTFoot aufgerufen wird gibt die Methode das vorhandene THead oder TFootElement zurück. Siehe die TABLEElementdefinition in HTML 4.01.
type: docs
weight: 3570
url: /de/net/aspose.html/htmltableelement/
---
## HTMLTableElement class

Die create*- und delete*-Methoden für die Tabelle ermöglichen es Autoren, Tabellen zu erstellen und zu ändern. [[HTML4.01](http://www.w3.org/TR/1999/REC-html401-19991224) ] gibt an, dass jeweils nur einer der `UNTERTITEL` ,`THEAD` , Und`TFUSS` Elemente können in einer Tabelle vorhanden sein. Wenn also eines vorhanden ist und die Methode createTHead() oder createTFoot() aufgerufen wird, gibt die Methode das vorhandene THead- oder TFoot-Element zurück. Siehe die TABLE-Elementdefinition in HTML 4.01.
...
| Name | Beschreibung |
| --- | --- |
| [Align](../../aspose.html/htmltableelement/align/) { get; set; } | Gibt die Position der Tabelle in Bezug auf den Rest des -Dokuments an. Siehe die Alignment-Attributdefinition in HTML 4.01. Dieses -Attribut ist in HTML 4.01 veraltet. |
...
| [BgColor](../../aspose.html/htmltableelement/bgcolor/) { get; set; } | Hintergrundfarbe der Zelle. Siehe die bgcolor-Attributdefinition in HTML 4.01. Dieses Attribut ist in HTML 4.01 veraltet. |
| [Border](../../aspose.html/htmltableelement/border/) { get; set; } | Die Breite des Rahmens um die Tabelle. Siehe Definition des Rahmenattributs in HTML 4.01. |
| [Caption](../../aspose.html/htmltableelement/caption/) { get; } | Gibt die der Tabelle zurück`UNTERTITEL` , oder ungültig, wenn keine vorhanden ist. @version DOM Level 2 |
| [CellPadding](../../aspose.html/htmltableelement/cellpadding/) { get; set; } | Gibt den horizontalen und vertikalen Abstand zwischen Zellinhalt und Zellgrenzen an. Siehe die cellpadding-Attributdefinition in HTML 4.01. |
| [CellSpacing](../../aspose.html/htmltableelement/cellspacing/) { get; set; } | Gibt die horizontale und vertikale Trennung zwischen Zellen an. Siehe die Definition des Attributs cellpacing in HTML 4.01. |
...
| [Frame](../../aspose.html/htmltableelement/frame/) { get; set; } | Gibt an, welche externen Tabellenrahmen wiedergegeben werden sollen. Siehe die Frame-Attributdefinition in HTML 4.01. |
...
| [Rows](../../aspose.html/htmltableelement/rows/) { get; } | Gibt die der Tabelle zurück`TFUSS` , oder`Null` wenn keine existiert. |
| [Rules](../../aspose.html/htmltableelement/rules/) { get; set; } | Gibt an, welche internen Tabellenrahmen dargestellt werden sollen. Siehe die Attributdefinition von rules in HTML 4.01. |
...
| [Summary](../../aspose.html/htmltableelement/summary/) { get; set; } | Beschreibung über den Zweck oder die Struktur einer Tabelle. Siehe die Zusammenfassung des Attributs in HTML 4.01. |
| [TagName](../../aspose.html.dom/element/tagname/) { get; } | Der Name des Elements. |
| [TBodies](../../aspose.html/htmltableelement/tbodies/) { get; } | Gibt eine Auflistung der Tabellenkörper zurück (einschließlich der impliziten). |
...
| [TFoot](../../aspose.html/htmltableelement/tfoot/) { get; } | Gibt die der Tabelle zurück`THEAD` , oder`Null` wenn keine existiert. |
| [THead](../../aspose.html/htmltableelement/thead/) { get; } | Gibt die der Tabelle zurück`UNTERTITEL` , oder ungültig, wenn keine vorhanden ist. |
...
| [Width](../../aspose.html/htmltableelement/width/) { get; set; } | Gibt die gewünschte Tabellenbreite an. Siehe Definition des width-Attributs in HTML 4.01. |
...
| [CreateCaption](../../aspose.html/htmltableelement/createcaption/)() | Erstellen Sie ein neues Tabellenbeschriftungsobjekt oder geben Sie ein vorhandenes zurück. |
| [CreateTFoot](../../aspose.html/htmltableelement/createtfoot/)() | Erstellen Sie eine Tabellenfußzeile oder geben Sie eine vorhandene zurück. |
| [CreateTHead](../../aspose.html/htmltableelement/createthead/)() | Erstellen Sie eine Tabellenkopfzeile oder geben Sie eine vorhandene zurück. |
| [DeleteCaption](../../aspose.html/htmltableelement/deletecaption/)() | Löschen Sie die Tabellenüberschrift, falls vorhanden. |
| [DeleteRow](../../aspose.html/htmltableelement/deleterow/)(int) | Löschen einer Tabellenzeile. |
| [DeleteTFoot](../../aspose.html/htmltableelement/deletetfoot/)() | Fußzeile aus der Tabelle löschen, falls vorhanden. |
| [DeleteTHead](../../aspose.html/htmltableelement/deletethead/)() | Löschen Sie die Kopfzeile aus der Tabelle, falls vorhanden. |
