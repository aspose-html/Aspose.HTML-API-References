...
description: Aspose.Html.HTMLTableCaptionElement klas. Tabellenbeschriftung Siehe Definition des CAPTIONElements in HTML 4.01.
type: docs
weight: 3540
url: /de/net/aspose.html/htmltablecaptionelement/
---
## HTMLTableCaptionElement class

Tabellenbeschriftung Siehe Definition des CAPTION-Elements in HTML 4.01.
...
| Name | Beschreibung |
| --- | --- |
| [Align](../../aspose.html/htmltablecaptionelement/align/) { get; set; } | Beschriftungsausrichtung in Bezug auf die Tabelle. Siehe die Definition des align-Attributs in HTML 4.01. Dieses Attribut ist in HTML 4.01 veraltet. |
