...
description: Aspose.Html.HTMLTableCellElement klas. Das Objekt das zur Darstellung von verwendet wirdTH UndTD Elemente. Siehe die Definition des TDElements in HTML 4.01.
type: docs
weight: 3550
url: /de/net/aspose.html/htmltablecellelement/
---
## HTMLTableCellElement class

Das Objekt, das zur Darstellung von verwendet wird`TH` Und`TD` Elemente. Siehe die Definition des TD-Elements in HTML 4.01.
...
| Name | Beschreibung |
| --- | --- |
| [Abbr](../../aspose.html/htmltablecellelement/abbr/) { get; set; } | Abkürzung für Kopfzellen. Siehe die abbr-Attributdefinition in HTML 4.01. |
| [Align](../../aspose.html/htmltablecellelement/align/) { get; set; } | Horizontale Ausrichtung der Daten in der Zelle. Siehe die Ausrichtungsattributdefinition in HTML 4.01. |
...
| [Axis](../../aspose.html/htmltablecellelement/axis/) { get; set; } | Benennt eine Gruppe verwandter Header. Siehe Definition des Achsenattributs in HTML 4.01. |
...
| [BgColor](../../aspose.html/htmltablecellelement/bgcolor/) { get; set; } | Hintergrundfarbe der Zelle. Siehe die bgcolor-Attributdefinition in HTML 4.01. Dieses Attribut ist in HTML 4.01 veraltet. |
| [CellIndex](../../aspose.html/htmltablecellelement/cellindex/) { get; } | Der Index dieser Zelle in der Zeile, beginnend bei 0. Dieser Index ist in der Dokumentbaumreihenfolge und nicht in der Anzeigereihenfolge. |
| [Ch](../../aspose.html/htmltablecellelement/ch/) { get; set; } | Ausrichtungszeichen für Zellen in einer Spalte. Siehe Definition des char-Attributs in HTML 4.01. |
...
| [ChOff](../../aspose.html/htmltablecellelement/choff/) { get; set; } | Offset des Ausrichtungszeichens. Siehe Definition des Charoff-Attributs in HTML 4.01. |
...
| [ColSpan](../../aspose.html/htmltablecellelement/colspan/) { get; set; } | Anzahl der Spalten, die von einer Zelle überspannt werden. Siehe die colspan-Attributdefinition in HTML 4.01. |
...
| [Headers](../../aspose.html/htmltablecellelement/headers/) { get; set; } | Liste von`Ausweis` Attributwerte für Kopfzellen. Siehe die Definition des Header-Attributs in HTML 4.01. |
| [Height](../../aspose.html/htmltablecellelement/height/) { get; set; } | Zellenhöhe. Siehe Definition des Höhenattributs in HTML 4.01. Dieses -Attribut ist in HTML 4.01 veraltet. |
...
| [NoWrap](../../aspose.html/htmltablecellelement/nowrap/) { get; set; } | Zeilenumbruch unterdrücken. Siehe die nowrap-Attributdefinition in HTML 4.01. Dieses Attribut ist in HTML 4.01 veraltet. |
...
| [RowSpan](../../aspose.html/htmltablecellelement/rowspan/) { get; set; } | Anzahl der Zeilen, die von einer Zelle überspannt werden. Siehe die rowspan-Attributdefinition in HTML 4.01. |
| [SchemaTypeInfo](../../aspose.html.dom/element/schematypeinfo/) { get; } | Die diesem Element zugeordneten Typinformationen. |
| [Scope](../../aspose.html/htmltablecellelement/scope/) { get; set; } | Bereich, der von Header-Zellen abgedeckt wird. Siehe Definition des Bereichsattributs in HTML 4.01. |
...
| [VAlign](../../aspose.html/htmltablecellelement/valign/) { get; set; } | Vertikale Ausrichtung der Daten in der Zelle. Siehe die Valign-Attributdefinition in HTML 4.01. |
| [Width](../../aspose.html/htmltablecellelement/width/) { get; set; } | Zellenbreite. Siehe Definition des width-Attributs in HTML 4.01. Dieses -Attribut ist in HTML 4.01 veraltet. |
