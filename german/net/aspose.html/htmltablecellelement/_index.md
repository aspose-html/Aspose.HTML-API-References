...
description: Das Objekt das zur Darstellung von verwendet wirdTH undTD Elemente. Siehe die Definition des TDElements in HTML 4.01.
type: docs
weight: 3540
...
| [Headers](../../aspose.html/htmltablecellelement/headers) { get; set; } | Liste von`Ich würde` Attributwerte für Kopfzellen. Siehe die Definition des Header-Attributs in HTML 4.01. |
