...
description: Aspose.Html.HTMLOptGroupElement klas. Gruppieren Sie Optionen in logischen Unterteilungen. Siehe die Definition des OPTGROUPElements in HTML 4.01.
type: docs
weight: 3450
url: /de/net/aspose.html/htmloptgroupelement/
---
## HTMLOptGroupElement class

Gruppieren Sie Optionen in logischen Unterteilungen. Siehe die Definition des OPTGROUP-Elements in HTML 4.01.
...
| [Disabled](../../aspose.html/htmloptgroupelement/disabled/) { get; set; } | Das Steuerelement ist in diesem Kontext nicht verfügbar. Siehe die Definition des deaktivierten Attributs in HTML 4.01. |
...
| [Label](../../aspose.html/htmloptgroupelement/label/) { get; set; } | Weist dieser Optionsgruppe ein Label zu. Siehe Labelattribut definition in HTML 4.01. |
