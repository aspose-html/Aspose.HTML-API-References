...
description: Enthält aktuelle Grafiksteuerungsparameter. Diese Parameter definieren den globalen Rahmen in dem die Grafikoperatoren ausgeführt werden.
type: docs
weight: 4250
url: /de/net/aspose.html.rendering/graphiccontext/
---
...
| Name | Beschreibung |
| --- | --- |
| [GraphicContext](graphiccontext)() | Initialisiert eine neue Instanz von[`GraphicContext`](../graphiccontext) Klasse. |
...
| virtual [TextInfo](../../aspose.html.rendering/graphiccontext/textinfo) { get; } | erhält a[`TextInfo`](../textinfo) Objekt, das Informationen über gerenderten Text enthält. |
...
| Name | Beschreibung |
| --- | --- |
| virtual [Clone](../../aspose.html.rendering/graphiccontext/clone)() | Erstellt eine neue Instanz einer GraphicContext-Klasse mit denselben Eigenschaftswerten wie eine vorhandene Instanz. |
