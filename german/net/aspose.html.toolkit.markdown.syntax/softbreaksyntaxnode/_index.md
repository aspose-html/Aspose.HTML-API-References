...
description: Aspose.Html.Toolkit.Markdown.Syntax.SoftBreakSyntaxNode klas. Repräsentiert die SoftBreakingSyntax.
type: docs
weight: 5540
url: /de/net/aspose.html.toolkit.markdown.syntax/softbreaksyntaxnode/
---
## SoftBreakSyntaxNode class

Repräsentiert die Soft-Breaking-Syntax.
...
| virtual [Source](../../aspose.html.toolkit.markdown.syntax/linebreaksyntaxnode/source/) { get; } | Holen Sie sich die Quelle. |
| virtual [Span](../../aspose.html.toolkit.markdown.syntax/linebreaksyntaxnode/span/) { get; } | Holen Sie sich die Spanne. |
| [Value](../../aspose.html.toolkit.markdown.syntax/linebreaksyntaxnode/value/) { get; } | Holen Sie sich den Wert. |

## Methoden

| Name | Beschreibung |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/softbreaksyntaxnode/accept/)(MarkdownSyntaxVisitor) | Definiert die Schnittstelle zur Annahme des Besuchers. |
