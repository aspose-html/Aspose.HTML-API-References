...
description: Aspose.Html.Toolkit.Markdown.Syntax.CharacterReferenceSyntaxNode klas. Repräsentiert den CharacterReferenceSyntaxNode.
type: docs
weight: 4830
url: /de/net/aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/
---
## CharacterReferenceSyntaxNode class

Repräsentiert den CharacterReferenceSyntaxNode.
...
| [Reference](../../aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/reference/) { get; } | Holen Sie sich die Referenz. |
| [Source](../../aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/source/) { get; } | Holen Sie sich die Quelle. |
| [Span](../../aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/span/) { get; } | Holen Sie sich die Spanne. |
| [Value](../../aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/value/) { get; } | Holen Sie sich den Wert. |

## Methoden

| Name | Beschreibung |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/accept/)(MarkdownSyntaxVisitor) | Definiert die Schnittstelle zum Akzeptieren von Besuchern. |
