...
description: Aspose.Html.Toolkit.Markdown.Syntax.SetextHeadingSyntaxNode klas. Stellt den SetextÜberschriftsyntaxknoten dar.
type: docs
weight: 5530
url: /de/net/aspose.html.toolkit.markdown.syntax/setextheadingsyntaxnode/
---
## SetextHeadingSyntaxNode class

Stellt den Setext-Überschriftsyntaxknoten dar.
...
| [Level](../../aspose.html.toolkit.markdown.syntax/setextheadingsyntaxnode/level/) { get; } | Abrufen der Ebene der aktuellen Syntax. |
...
| Name | Beschreibung |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/setextheadingsyntaxnode/accept/)(MarkdownSyntaxVisitor) | Definiert die Schnittstelle zur Annahme des Besuchers. |
