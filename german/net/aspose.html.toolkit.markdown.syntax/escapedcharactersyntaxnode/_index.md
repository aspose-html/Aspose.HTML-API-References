...
description: Aspose.Html.Toolkit.Markdown.Syntax.EscapedCharacterSyntaxNode klas. Syntaxknoten für EscapeZeichen implementiert.
type: docs
weight: 4890
url: /de/net/aspose.html.toolkit.markdown.syntax/escapedcharactersyntaxnode/
---
## EscapedCharacterSyntaxNode class

Syntaxknoten für Escape-Zeichen implementiert.
...
| virtual [Source](../../aspose.html.toolkit.markdown.syntax/textsyntaxnode/source/) { get; } | Gibt den Quelltext zurück. |
| virtual [Span](../../aspose.html.toolkit.markdown.syntax/textsyntaxnode/span/) { get; } | Definiert die Schnittstelle für get span. |
| [Value](../../aspose.html.toolkit.markdown.syntax/textsyntaxnode/value/) { get; } | Definiert die Eigenschaft zum Abrufen des Zeichenfolgenwerts. |

## Methoden

| Name | Beschreibung |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/escapedcharactersyntaxnode/accept/)(MarkdownSyntaxVisitor) | Definiert die Schnittstelle zum Akzeptieren von Besuchern. |
