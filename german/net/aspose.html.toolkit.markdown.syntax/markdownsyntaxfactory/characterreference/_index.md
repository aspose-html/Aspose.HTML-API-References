...
description: MarkdownSyntaxFactory methode. Erstellt Objekte mit CharacterReferenceSyntax.CreateInstance.
type: docs
weight: 50
url: /de/net/aspose.html.toolkit.markdown.syntax/markdownsyntaxfactory/characterreference/
---
## MarkdownSyntaxFactory.CharacterReference method

Erstellt Objekte mit CharacterReferenceSyntax.CreateInstance.
...
| --- | --- | --- |
| source | SourceText | Der Quelltext. |
| span | TextSpan | Die TextSpan. |
| value | String | Der Zeichenfolgenwert. |

### Rückgabewert

Die CharacterReferenceSyntax.
