...
description: Aspose.Html.Dom.Svg.Events.TimeEvent klas. Die TimeEventSchnittstelle stellt spezifische Kontextinformationen bereit die Zeitereignissen zugeordnet sind. Die verschiedenen Arten von Ereignissen die auftreten können sind beginEvent endEvent und repeatEvent.
type: docs
weight: 1340
url: /de/net/aspose.html.dom.svg.events/timeevent/
---
## TimeEvent class
...
| [CurrentTarget](../../aspose.html.dom.events/event/currenttarget/) { get; } | Wird verwendet, um die anzuzeigen[`IEventTarget`](../../aspose.html.dom.events/ieventtarget/) wessen[`IEventListener`](../../aspose.html.dom.events/ieventlistener/) s werden gerade verarbeitet. Dies ist besonders nützlich beim Erfassen und Bubbling. |
...
| [Detail](../../aspose.html.dom.svg.events/timeevent/detail/) { get; } | Gibt je nach Art des Ereignisses einige Detailinformationen zum Ereignis an. Gibt für diesen Ereignistyp die Wiederholungsnummer für die Animation an. |
...
| [View](../../aspose.html.dom.svg.events/timeevent/view/) { get; } | Das Ansichtsattribut identifiziert die AbstractView [DOM2VIEWS], aus der das Ereignis generiert wurde. |
