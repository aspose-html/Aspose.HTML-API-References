...
description: Zusätzlich zu StandardIO InputOutput Tools die Aspose.Html.IO Namespace enthält Hilfsklassen und Schnittstellen.
type: docs
weight: 230
url: /de/net/aspose.html.io/
---
Zusätzlich zu Standard-IO (Input-Output) Tools die **Aspose.Html.IO** Namespace enthält Hilfsklassen und Schnittstellen.
...
| [OutputStream](./outputstream) | Ein Surrogat-Stream umschließt den echten Ausgabestream und steuert den Zugriff darauf. [`OutputStream`](../aspose.html.io/outputstream) enthält URI-Daten, die den Speicherort des Ausgabestreams beschreiben. |
...
| [IOutputStorage](./ioutputstorage) | Bietet die Erstellung und Verwaltung von Ausgabeströmen[`OutputStream`](../aspose.html.io/outputstream) . |
