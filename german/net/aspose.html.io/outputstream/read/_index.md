...
description: Liest eine Folge von Bytes aus dem umschlossenen Ausgabestream und erhöht die Position innerhalb des Streams um die Anzahl der gelesenen Bytes.
type: docs
weight: 100
...
| --- | --- | --- |
| buffer | Byte[] | Ein Array von Bytes. Wenn diese Methode zurückkehrt, enthält der Puffer das angegebene Byte-Array mit den Werten zwischen Offset und (Offset + Anzahl - 1), ersetzt durch die Bytes, die aus dem umschlossenen Ausgabestream gelesen werden. |
