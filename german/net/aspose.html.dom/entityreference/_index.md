...
description: Aspose.Html.Dom.EntityReference klas. EntityReferenceKnoten können verwendet werden um eine Entitätsreferenz im Baum darzustellen.
type: docs
weight: 710
url: /de/net/aspose.html.dom/entityreference/
---
## EntityReference class

EntityReference-Knoten können verwendet werden, um eine Entitätsreferenz im Baum darzustellen.
...
| override [NodeName](../../aspose.html.dom/entityreference/nodename/) { get; } | Der Name dieses Knotens, abhängig von seinem Typ. |
| override [NodeType](../../aspose.html.dom/entityreference/nodetype/) { get; } | Ein Code, der den Typ des zugrunde liegenden Objekts darstellt. |
