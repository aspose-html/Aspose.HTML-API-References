...
description: Aspose.Html.Dom.Entity klas. Repräsentiert eine bekannte Entität entweder geparst oder nicht geparst in einem XMLDokument.
type: docs
weight: 700
url: /de/net/aspose.html.dom/entity/
---
## Entity class

Repräsentiert eine bekannte Entität, entweder geparst oder nicht geparst, in einem XML-Dokument.
...
| [InputEncoding](../../aspose.html.dom/entity/inputencoding/) { get; } | Ein Attribut, das die Codierung angibt, die für diese Entität zum Zeitpunkt der Analyse verwendet wurde, wenn es sich um eine externe analysierte Entität handelt. Dies ist null, wenn es sich um eine Entität aus der internen Teilmenge handelt oder wenn sie nicht bekannt ist. |
...
| override [NodeName](../../aspose.html.dom/entity/nodename/) { get; } | Der Name dieses Knotens, abhängig von seinem Typ. |
| override [NodeType](../../aspose.html.dom/entity/nodetype/) { get; } | Ein Code, der den Typ des zugrunde liegenden Objekts darstellt. |
| virtual [NodeValue](../../aspose.html.dom/node/nodevalue/) { get; set; } | Der Wert dieses Knotens, abhängig von seinem Typ. |
| [NotationName](../../aspose.html.dom/entity/notationname/) { get; } | Für nicht geparste Entitäten der Name der Notation für die Entität. Für geparste Entitäten ist dies null. |
...
| [PublicId](../../aspose.html.dom/entity/publicid/) { get; } | Der öffentliche Bezeichner, der der Entität zugeordnet ist, falls angegeben, andernfalls null. |
| [SystemId](../../aspose.html.dom/entity/systemid/) { get; } | Die der Entität zugeordnete Systemkennung, falls angegeben, andernfalls null. Dies kann ein absoluter URI sein oder nicht. |
...
| [XmlEncoding](../../aspose.html.dom/entity/xmlencoding/) { get; } | Ein Attribut, das als Teil der Textdeklaration die Codierung dieser Entität angibt, wenn es sich um eine externe geparste Entität handelt. Andernfalls ist dies null. |
| [XmlVersion](../../aspose.html.dom/entity/xmlversion/) { get; } | Ein Attribut, das als Teil der Textdeklaration die Versionsnummer dieser Entität angibt, wenn es sich um eine externe geparste Entität handelt. Andernfalls ist dies null. |
