...
description: Aspose.Html.Dom.CDATASection klas. CDATAAbschnitte werden verwendet um Textblöcke zu maskieren die Zeichen enthalten die andernfalls als Markup betrachtet würden.
type: docs
weight: 200
url: /de/net/aspose.html.dom/cdatasection/
---
## CDATASection class

CDATA-Abschnitte werden verwendet, um Textblöcke zu maskieren, die Zeichen enthalten, die andernfalls als Markup betrachtet würden.
...
| override [NodeName](../../aspose.html.dom/cdatasection/nodename/) { get; } | Der Name dieses Knotens, abhängig von seinem Typ. |
| override [NodeType](../../aspose.html.dom/cdatasection/nodetype/) { get; } | Ein Code, der den Typ des zugrunde liegenden Objekts darstellt. |
