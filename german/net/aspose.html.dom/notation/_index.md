...
description: Aspose.Html.Dom.Notation klas. Repräsentiert eine in der DTD deklarierte Notation.
type: docs
weight: 1010
url: /de/net/aspose.html.dom/notation/
---
## Notation class

Repräsentiert eine in der DTD deklarierte Notation.
...
| override [NodeName](../../aspose.html.dom/notation/nodename/) { get; } | Der Name dieses Knotens, abhängig von seinem Typ. |
| override [NodeType](../../aspose.html.dom/notation/nodetype/) { get; } | Ein Code, der den Typ des zugrunde liegenden Objekts darstellt. |
...
| [PublicId](../../aspose.html.dom/notation/publicid/) { get; } | Die öffentliche Kennung dieser Notation. Wenn die öffentliche Kennung nicht angegeben wurde, ist dies null. |
| [SystemId](../../aspose.html.dom/notation/systemid/) { get; } | Die Systemkennung dieser Notation. Wenn die Systemkennung nicht angegeben wurde, ist dies null. Dies kann ein absoluter URI sein oder nicht. |
