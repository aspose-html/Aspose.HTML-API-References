...
description: Die ElementSchnittstelle repräsentiert ein Element in einem HTML oder XMLDokument.
type: docs
weight: 700
...
| Name | Beschreibung |
| --- | --- |
| [Element](element)(IElementInit) | Initialisiert eine neue Instanz von[`Element`](../element)Klasse. Rufen Sie diesen Konstruktor nicht direkt auf, verwenden Sie[`CreateElement`](../document/createelement) oder[`CreateElementNS`](../document/createelementns) . |
