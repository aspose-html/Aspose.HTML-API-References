...
description: Aspose.Html.Dom.Element klas. Die ElementSchnittstelle repräsentiert ein Element in einem HTML oder XMLDokument.
type: docs
weight: 690
url: /de/net/aspose.html.dom/element/
---
## Element class
...
| Name | Beschreibung |
| --- | --- |
| [Element](element/)(IElementInit) | Initialisiert eine neue Instanz von`Element`Klasse. Rufen Sie diesen Konstruktor nicht direkt auf, verwenden Sie[`CreateElement`](../document/createelement/) oder[`CreateElementNS`](../document/createelementns/) . |
...
| [Id](../../aspose.html.dom/element/id/) { get; set; } | Der Bezeichner des Elements. Siehe die ID-Attributdefinition in HTML 4.01. |
...
| [ParentElement](../../aspose.html.dom/node/parentelement/) { get; } | Ruft das übergeordnete Element ab`Element` dieses Knotens. |
