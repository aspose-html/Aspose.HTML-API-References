...
description: Aspose.Html.Dom.Node klas. Die NodeSchnittstelle ist der primäre Datentyp für das gesamte Dokumentobjektmodell. Es stellt einen einzelnen Knoten im Dokumentbaum dar.
type: docs
weight: 1000
url: /de/net/aspose.html.dom/node/
---
## Node class
...
| abstract [NodeName](../../aspose.html.dom/node/nodename/) { get; } | Der Name dieses Knotens, abhängig von seinem Typ. |
| abstract [NodeType](../../aspose.html.dom/node/nodetype/) { get; } | Ein Code, der den Typ des zugrunde liegenden Objekts darstellt. |
...
| [CloneNode](../../aspose.html.dom/node/clonenode/#clonenode)() | Gibt ein Duplikat dieses Knotens zurück, dh dient als generischer Kopierkonstruktor für Knoten. Der doppelte Knoten hat keinen übergeordneten Knoten (parentNode ist null) und keine Benutzerdaten. |
| [CloneNode](../../aspose.html.dom/node/clonenode/#clonenode_1)(bool) | Gibt ein Duplikat dieses Knotens zurück, dh dient als generischer Kopierkonstruktor für Knoten. Der doppelte Knoten hat keinen übergeordneten Knoten (parentNode ist null) und keine Benutzerdaten. |
...
| Name | Beschreibung |
| --- | --- |
| const [ATTRIBUTE_NODE](../../aspose.html.dom/node/attribute_node/) | Ein Attributknoten |
| const [CDATA_SECTION_NODE](../../aspose.html.dom/node/cdata_section_node/) | Ein cdata-Abschnitt node |
| const [COMMENT_NODE](../../aspose.html.dom/node/comment_node/) | Ein Kommentar node |
| const [DOCUMENT_FRAGMENT_NODE](../../aspose.html.dom/node/document_fragment_node/) | Ein Dokumentfragment node |
| const [DOCUMENT_NODE](../../aspose.html.dom/node/document_node/) | Ein Dokumentknoten |
| const [DOCUMENT_TYPE_NODE](../../aspose.html.dom/node/document_type_node/) | Ein Dokumenttyp node |
| const [ELEMENT_NODE](../../aspose.html.dom/node/element_node/) | Ein Elementknoten |
| const [ENTITY_NODE](../../aspose.html.dom/node/entity_node/) | Ein Entitätsknoten |
| const [ENTITY_REFERENCE_NODE](../../aspose.html.dom/node/entity_reference_node/) | Ein Entitätsreferenzknoten |
| const [NOTATION_NODE](../../aspose.html.dom/node/notation_node/) | Eine Notation node |
| const [PROCESSING_INSTRUCTION_NODE](../../aspose.html.dom/node/processing_instruction_node/) | Ein Verarbeitungsanweisungsknoten |
| const [TEXT_NODE](../../aspose.html.dom/node/text_node/) | Ein Textknoten |
