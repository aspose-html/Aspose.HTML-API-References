...
description: Converter methode. HTMLQuelldokument in DOCX konvertieren. Ergebnis ist eine docxDatei.
type: docs
weight: 20
url: /de/net/aspose.html.converters/converter/converthtml/
---
## ConvertHTML(HTMLDocument, DocSaveOptions, string) {#converthtml_1}

HTML-Quelldokument in DOCX konvertieren. Ergebnis ist eine docx-Datei.
...
| --- | --- | --- |
| document | HTMLDocument | Konvertierungsquelle[`HTMLDocument`](../../../aspose.html/htmldocument/). |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| sourcePath | String | Quellpfad der HTML-Datei. Er wird mit dem aktuellen Verzeichnispfad zu einer absoluten URL kombiniert. |
| options | DocSaveOptions | Konvertierungsoptionen. |
| outputPath | String | Pfad der Ausgabedatei. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| content | String | Inline-String-HTML-Inhalt. |
...
HTML-Quelldokument in PDF konvertieren. Ergebnis ist eine PDF-Datei.
...
HTML-Dokument in mhtml konvertieren. Das Ergebnis ist eine mhtml-Datei.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| document | HTMLDocument | Konvertierungsquelle. |
| options | MHTMLSaveOptions | Konvertierungsoptionen. |
| outputPath | String | Pfad der Ausgabedatei. |
...
HTML-Dokument in Markdown umwandeln. Ergebnis ist MD-Datei.
...
| --- | --- | --- |
| document | HTMLDocument | Konvertierungsquelle. |
| options | MarkdownSaveOptions | Konvertierungsoptionen. |
| outputPath | String | Pfad der Ausgabedatei. |
...
HTML-Quelle in Markdown umwandeln. Ergebnis ist MD-Datei.
...
HTML-Dokument in xps umwandeln. Das Ergebnis ist eine xps-Datei.
...
Konvertieren Sie den HTML-Quelltext in XPS. Das Ergebnis ist eine xps-Datei.
...
HTML-Dokument in Bild umwandeln. Ergebnis ist Bilddatei.
...
HTML-Quelle in Bild umwandeln. Ergebnis ist Bilddatei.
