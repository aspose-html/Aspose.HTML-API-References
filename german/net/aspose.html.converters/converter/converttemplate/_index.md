...
description: HTMLVorlage mit Benutzerdaten zusammenführen. Das Ergebnis ist eine HTMLDatei.
type: docs
weight: 60
url: /de/net/aspose.html.converters/converter/converttemplate/
---
## ConvertTemplate(HTMLDocument, TemplateData, TemplateLoadOptions, string) {#converttemplate_7}

HTML-Vorlage mit Benutzerdaten zusammenführen. Das Ergebnis ist eine HTML-Datei.
...
| --- | --- | --- |
| template | HTMLDocument | Quellskelett html doc. |
| data | TemplateData | Daten zum Zusammenführen (XML, JSON). |
| options | TemplateLoadOptions | Optionsobjekt zusammenführen. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| url | Url | URL des Vorlagenquelldokuments. |
| data | TemplateData | Daten zum Zusammenführen (XML, JSON). |
| options | TemplateLoadOptions | Optionsobjekt zusammenführen. |
| outputPath | String | Pfad der Ausgabedatei. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| sourcePath | String | Pfad zur HTML-Quelldatei der Vorlage. Er wird mit dem aktuellen Verzeichnispfad zu einer absoluten URL kombiniert. |
| data | TemplateData | Daten zum Zusammenführen (XML, JSON). |
| options | TemplateLoadOptions | Optionsobjekt zusammenführen. |
| outputPath | String | Pfad der Ausgabedatei. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| content | String | Inline-HTML-Vorlage - Skelett. |
| baseUrl | String | Basis-URI der HTML-Vorlage. Er wird mit dem aktuellen Verzeichnispfad zu einer absoluten URL kombiniert. |
| data | TemplateData | Daten zum Zusammenführen (XML, JSON). |
| options | TemplateLoadOptions | Optionsobjekt zusammenführen. |
| outputPath | String | Pfad der Ausgabedatei. |
...
HTML-Vorlage mit Benutzerdaten zusammenführen. Ergebnis ist[`HTMLDocument`](../../../aspose.html/htmldocument) .
...
Konvertierungsergebnis HTMLDocument.
