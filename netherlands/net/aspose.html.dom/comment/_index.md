...
description: Aspose.Html.Dom.Comment klas. Neemt over van CharacterData en vertegenwoordigt de inhoud van een opmerking dwz alle tekens tussen het begin  .
type: docs
weight: 310
url: /nl/net/aspose.html.dom/comment/
---
## Comment class

Neemt over van CharacterData en vertegenwoordigt de inhoud van een opmerking, dwz alle tekens tussen het begin ' .
...
| override [NodeName](../../aspose.html.dom/comment/nodename/) { get; } | De naam van dit knooppunt, afhankelijk van het type. |
| override [NodeType](../../aspose.html.dom/comment/nodetype/) { get; } | Een code die het type van het onderliggende object vertegenwoordigt. |
| override [NodeValue](../../aspose.html.dom/comment/nodevalue/) { get; set; } | De waarde van dit knooppunt, afhankelijk van het type. |
