...
description: Aspose.Html.Dom.Node klas. De Nodeinterface is het primaire datatype voor het gehele documentobjectmodel. Het vertegenwoordigt een enkel knooppunt in de documentstructuur.
type: docs
weight: 1000
url: /nl/net/aspose.html.dom/node/
---
## Node class
...
| abstract [NodeName](../../aspose.html.dom/node/nodename/) { get; } | De naam van dit knooppunt, afhankelijk van het type. |
| abstract [NodeType](../../aspose.html.dom/node/nodetype/) { get; } | Een code die het type van het onderliggende object vertegenwoordigt. |
...
| [CloneNode](../../aspose.html.dom/node/clonenode/#clonenode)() | Retourneert een duplicaat van dit knooppunt, dwz dient als generieke kopieerconstructor voor knooppunten. Het gedupliceerde knooppunt heeft geen ouder (parentNode is null) en geen gebruikersgegevens. |
| [CloneNode](../../aspose.html.dom/node/clonenode/#clonenode_1)(bool) | Retourneert een duplicaat van dit knooppunt, dwz dient als generieke kopieerconstructor voor knooppunten. Het gedupliceerde knooppunt heeft geen ouder (parentNode is null) en geen gebruikersgegevens. |
...
| Naam | Beschrijving |
| --- | --- |
| const [ATTRIBUTE_NODE](../../aspose.html.dom/node/attribute_node/) | Een attribuut node |
| const [CDATA_SECTION_NODE](../../aspose.html.dom/node/cdata_section_node/) | Een cdata sectie node |
| const [COMMENT_NODE](../../aspose.html.dom/node/comment_node/) | Een commentaar node |
| const [DOCUMENT_FRAGMENT_NODE](../../aspose.html.dom/node/document_fragment_node/) | Een documentfragment node |
| const [DOCUMENT_NODE](../../aspose.html.dom/node/document_node/) | Een documentknooppunt |
| const [DOCUMENT_TYPE_NODE](../../aspose.html.dom/node/document_type_node/) | Een documenttype node |
| const [ELEMENT_NODE](../../aspose.html.dom/node/element_node/) | Een element node |
| const [ENTITY_NODE](../../aspose.html.dom/node/entity_node/) | Een entiteitsknooppunt |
| const [ENTITY_REFERENCE_NODE](../../aspose.html.dom/node/entity_reference_node/) | Een entiteitsreferentieknooppunt |
| const [NOTATION_NODE](../../aspose.html.dom/node/notation_node/) | Een notatie node |
| const [PROCESSING_INSTRUCTION_NODE](../../aspose.html.dom/node/processing_instruction_node/) | Een verwerkingsinstructie node |
| const [TEXT_NODE](../../aspose.html.dom/node/text_node/) | Een tekstknooppunt |
