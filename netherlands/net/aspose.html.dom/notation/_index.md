...
description: Aspose.Html.Dom.Notation klas. Vertegenwoordigt een notatie gedeclareerd in de DTD.
type: docs
weight: 1010
url: /nl/net/aspose.html.dom/notation/
---
## Notation class

Vertegenwoordigt een notatie gedeclareerd in de DTD.
...
| override [NodeName](../../aspose.html.dom/notation/nodename/) { get; } | De naam van dit knooppunt, afhankelijk van het type. |
| override [NodeType](../../aspose.html.dom/notation/nodetype/) { get; } | Een code die het type van het onderliggende object vertegenwoordigt. |
...
| [PublicId](../../aspose.html.dom/notation/publicid/) { get; } | De publieke identifier van deze notatie. Als de openbare identificatie niet is opgegeven, is dit null. |
| [SystemId](../../aspose.html.dom/notation/systemid/) { get; } | De systeem-ID van deze notatie. Als de systeem-ID niet is opgegeven, is dit null. Dit kan een absolute URI zijn of niet. |
