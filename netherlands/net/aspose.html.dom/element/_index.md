...
description: Aspose.Html.Dom.Element klas. De Elementinterface vertegenwoordigt een element in een HTML of XMLdocument.
type: docs
weight: 690
url: /nl/net/aspose.html.dom/element/
---
## Element class
...
| Naam | Beschrijving |
| --- | --- |
| [Element](element/)(IElementInit) | Initialiseert een nieuw exemplaar van het`Element`klas. Noem deze constructor niet rechtstreeks, gebruik[`CreateElement`](../document/createelement/) of[`CreateElementNS`](../document/createelementns/) . |
...
| [Id](../../aspose.html.dom/element/id/) { get; set; } | De identificatie van het element. Zie de definitie van het id-kenmerk in HTML 4.01. |
...
| [ParentElement](../../aspose.html.dom/node/parentelement/) { get; } | Haalt de ouder op`Element` van dit knooppunt. |
