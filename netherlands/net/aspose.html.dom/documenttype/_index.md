...
description: Aspose.Html.Dom.DocumentType klas. Het DocumentType biedt een interface naar de lijst met entiteiten die zijn gedefinieerd voor het document
type: docs
weight: 680
url: /nl/net/aspose.html.dom/documenttype/
---
## DocumentType class

Het DocumentType biedt een interface naar de lijst met entiteiten die zijn gedefinieerd voor het document
...
| Naam | Beschrijving |
| --- | --- |
| [DocumentType](documenttype/)(string, string, string, string, Document) | Initialiseert een nieuw exemplaar van het`DocumentType` klasse. |
...
| [InternalSubset](../../aspose.html.dom/documenttype/internalsubset/) { get; } | De interne subset als een string, of null als er geen is. |
...
| [Name](../../aspose.html.dom/documenttype/name/) { get; } | De naam van DTD; dwz de naam die onmiddellijk volgt op het trefwoord DOCTYPE. |
...
| override [NodeName](../../aspose.html.dom/documenttype/nodename/) { get; } | De naam van dit knooppunt, afhankelijk van het type. |
| override [NodeType](../../aspose.html.dom/documenttype/nodetype/) { get; } | Een code die het type van het onderliggende object vertegenwoordigt. |
...
| [PublicId](../../aspose.html.dom/documenttype/publicid/) { get; } | De publieke identifier van de externe subset. |
| [SystemId](../../aspose.html.dom/documenttype/systemid/) { get; } | De systeem-ID van de externe subset. Dit kan een absolute URI zijn of niet. |
...
| override [ToString](../../aspose.html.dom/documenttype/tostring/)() | Geeft als resultaat eenString die deze instantie vertegenwoordigt. |
