...
description: Aspose.Html.Dom.Document klas. Het document vertegenwoordigt het volledige HTML XML of SVGdocument. Conceptueel is het de root van de documentstructuur en biedt het de primaire toegang tot de documentgegevens.
type: docs
weight: 660
url: /nl/net/aspose.html.dom/document/
---
## Document class
...
| [CreateNodeIterator](../../aspose.html.dom/document/createnodeiterator/#createnodeiterator)(Node) | Maak een nieuwe NodeIterator over de substructuur die is geworteld in het gespecificeerde knooppunt. |
| [CreateNodeIterator](../../aspose.html.dom/document/createnodeiterator/#createnodeiterator_1)(Node, long) | Maak een nieuwe NodeIterator over de substructuur die is geworteld in het gespecificeerde knooppunt. |
| [CreateNodeIterator](../../aspose.html.dom/document/createnodeiterator/#createnodeiterator_2)(Node, long, INodeFilter) | Maak een nieuwe NodeIterator over de substructuur die is geworteld in het gespecificeerde knooppunt. |
...
| [CreateTreeWalker](../../aspose.html.dom/document/createtreewalker/#createtreewalker)(Node) | Maak een nieuwe TreeWalker over de subboom die is geroot op het gespecificeerde knooppunt. |
| [CreateTreeWalker](../../aspose.html.dom/document/createtreewalker/#createtreewalker_1)(Node, long) | Maak een nieuwe TreeWalker over de subboom die is geroot op het gespecificeerde knooppunt. |
| [CreateTreeWalker](../../aspose.html.dom/document/createtreewalker/#createtreewalker_2)(Node, long, INodeFilter) | Maak een nieuwe TreeWalker over de subboom die is geroot op het gespecificeerde knooppunt. |
...
| [Navigate](../../aspose.html.dom/document/navigate/#navigate)(RequestMessage) | Laadt het document op basis van het opgegeven verzoekobject en vervangt de vorige inhoud. |
| [Navigate](../../aspose.html.dom/document/navigate/#navigate_4)(string) | Laadt het document op de gespecificeerde Uniform Resource Locator (URL) in de huidige instantie en vervangt de vorige inhoud. |
| [Navigate](../../aspose.html.dom/document/navigate/#navigate_1)(Url) | Laadt het document op de gespecificeerde Uniform Resource Locator (URL) in de huidige instantie en vervangt de vorige inhoud. |
| [Navigate](../../aspose.html.dom/document/navigate/#navigate_3)(Stream, string) | Laadt het document vanuit gespecificeerde inhoud en gebruikt baseUri om relatieve bronnen op te lossen, waarbij de vorige inhoud wordt vervangen. Het laden van documenten begint vanaf de huidige positie in de stroom. |
| [Navigate](../../aspose.html.dom/document/navigate/#navigate_2)(Stream, Url) | Laadt het document vanuit gespecificeerde inhoud en gebruikt baseUri om relatieve bronnen op te lossen, waarbij de vorige inhoud wordt vervangen. Het laden van documenten begint vanaf de huidige positie in de stroom. |
| [Navigate](../../aspose.html.dom/document/navigate/#navigate_6)(string, string) | Laadt het document vanuit gespecificeerde inhoud en gebruikt baseUri om relatieve bronnen op te lossen, waarbij de vorige inhoud wordt vervangen. |
| [Navigate](../../aspose.html.dom/document/navigate/#navigate_5)(string, Url) | Laadt het document vanuit gespecificeerde inhoud en gebruikt baseUri om relatieve bronnen op te lossen, waarbij de vorige inhoud wordt vervangen. |
...
| virtual [RenderTo](../../aspose.html.dom/document/renderto/)(IDevice) | Deze methode wordt gebruikt om de inhoud van het huidige document weer te geven op een opgegeven grafisch apparaat. |
