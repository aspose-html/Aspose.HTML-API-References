...
description: Aspose.Html.Dom.Attr klas. De Attrinterface vertegenwoordigt een attribuut in een Elementobject. Meestal worden de toegestane waarden voor het kenmerk gedefinieerd in een schema dat aan het document is gekoppeld.
type: docs
weight: 110
url: /nl/net/aspose.html.dom/attr/
---
## Attr class
...
| [IsId](../../aspose.html.dom/attr/isid/) { get; } | Retourneert of bekend is dat dit attribuut van het type ID is (dwz dat het een identifier bevat voor het eigenaarselement) of niet. |
...
| override [LocalName](../../aspose.html.dom/attr/localname/) { get; } | Retourneert het lokale deel van de gekwalificeerde naam van dit knooppunt. Voor knooppunten van een ander type dan ELEMENT_NODE en ATTRIBUTE_NODE en knooppunten gemaakt met een DOM Level 1-methode, zoals Document.createElement(), is dit altijd null. |
| [Name](../../aspose.html.dom/attr/name/) { get; } | Retourneert de naam van dit attribuut. |
| override [NamespaceURI](../../aspose.html.dom/attr/namespaceuri/) { get; } | De naamruimte-URI van dit knooppunt, of null als deze niet is gespecificeerd. |
...
| override [NodeName](../../aspose.html.dom/attr/nodename/) { get; } | De naam van dit knooppunt, afhankelijk van het type. |
| override [NodeType](../../aspose.html.dom/attr/nodetype/) { get; } | Een code die het type van het onderliggende object vertegenwoordigt. |
| override [NodeValue](../../aspose.html.dom/attr/nodevalue/) { get; set; } | De waarde van dit knooppunt, afhankelijk van het type. |
...
| [OwnerElement](../../aspose.html.dom/attr/ownerelement/) { get; } | Het elementknooppunt waaraan dit attribuut is gekoppeld of null als dit attribuut niet in gebruik is. |
...
| override [Prefix](../../aspose.html.dom/attr/prefix/) { get; } | Het naamruimtevoorvoegsel van dit knooppunt, of null als het niet is gespecificeerd. Als het is gedefinieerd als null, heeft het instellen ervan geen effect |
...
| [SchemaTypeInfo](../../aspose.html.dom/attr/schematypeinfo/) { get; } | De type-informatie die aan dit attribuut is gekoppeld. |
| [Specified](../../aspose.html.dom/attr/specified/) { get; } | Waar als dit attribuut expliciet een waarde heeft gekregen in het instantiedocument, anders onwaar. |
| override [TextContent](../../aspose.html.dom/attr/textcontent/) { get; set; } | Dit attribuut retourneert de tekstinhoud van dit knooppunt en zijn afstammelingen. Als het is gedefinieerd als null, heeft het instellen ervan geen effect. Bij het instellen worden alle mogelijke kinderen die dit knooppunt heeft verwijderd en, als de nieuwe tekenreeks niet leeg of null is, vervangen door een enkel tekstknooppunt dat de tekenreeks bevat waarop dit kenmerk is ingesteld. |
| [Value](../../aspose.html.dom/attr/value/) { get; set; } | Bij het ophalen wordt de waarde van het attribuut geretourneerd als een tekenreeks. |
