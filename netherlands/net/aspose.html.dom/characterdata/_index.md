...
description: Aspose.Html.Dom.CharacterData klas. De CharacterData breidt Node uit met een set attributen en methoden voor toegang tot karaktergegevens in de DOM.
type: docs
weight: 300
url: /nl/net/aspose.html.dom/characterdata/
---
## CharacterData class

De CharacterData breidt Node uit met een set attributen en methoden voor toegang tot karaktergegevens in de DOM.
