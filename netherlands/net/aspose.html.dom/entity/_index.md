...
description: Aspose.Html.Dom.Entity klas. Vertegenwoordigt een bekende entiteit al dan niet geparseerd in een XMLdocument.
type: docs
weight: 700
url: /nl/net/aspose.html.dom/entity/
---
## Entity class

Vertegenwoordigt een bekende entiteit, al dan niet geparseerd, in een XML-document.
...
| [InputEncoding](../../aspose.html.dom/entity/inputencoding/) { get; } | Een attribuut dat de codering specificeert die voor deze entiteit is gebruikt op het moment van parseren, wanneer het een externe geparseerde entiteit is. Dit is null als het een entiteit is uit de interne subset of als het niet bekend is. |
...
| override [NodeName](../../aspose.html.dom/entity/nodename/) { get; } | De naam van dit knooppunt, afhankelijk van het type. |
| override [NodeType](../../aspose.html.dom/entity/nodetype/) { get; } | Een code die het type van het onderliggende object vertegenwoordigt. |
| virtual [NodeValue](../../aspose.html.dom/node/nodevalue/) { get; set; } | De waarde van dit knooppunt, afhankelijk van het type. |
| [NotationName](../../aspose.html.dom/entity/notationname/) { get; } | Voor niet-geparseerde entiteiten, de naam van de notatie voor de entiteit. Voor geparseerde entiteiten is dit null. |
...
| [PublicId](../../aspose.html.dom/entity/publicid/) { get; } | De publieke identifier die aan de entiteit is gekoppeld, indien gespecificeerd, en anders null. |
| [SystemId](../../aspose.html.dom/entity/systemid/) { get; } | De systeem-ID die aan de entiteit is gekoppeld, indien gespecificeerd, en anders null. Dit kan een absolute URI zijn of niet. |
...
| [XmlEncoding](../../aspose.html.dom/entity/xmlencoding/) { get; } | Een attribuut dat, als onderdeel van de tekstdeclaratie, de codering van deze entiteit specificeert, wanneer het een externe geparseerde entiteit is. Dit is anders nul. |
| [XmlVersion](../../aspose.html.dom/entity/xmlversion/) { get; } | Een attribuut dat, als onderdeel van de tekstdeclaratie, het versienummer van deze entiteit specificeert, wanneer het een externe geparseerde entiteit is. Dit is anders nul. |
