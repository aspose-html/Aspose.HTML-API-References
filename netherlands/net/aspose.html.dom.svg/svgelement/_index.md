...
description: Aspose.Html.Dom.Svg.SVGElement klas. Alle SVG DOMinterfaces die rechtstreeks overeenkomen met elementen in de SVGtaal zoals de SVGPathElementinterface voor het pathelement zijn afgeleid van de SVGElementinterface.
type: docs
weight: 2020
url: /nl/net/aspose.html.dom.svg/svgelement/
---
## SVGElement class

Alle SVG DOM-interfaces die rechtstreeks overeenkomen met elementen in de SVG-taal (zoals de SVGPathElement-interface voor het 'path'-element) zijn afgeleid van de SVGElement-interface.
