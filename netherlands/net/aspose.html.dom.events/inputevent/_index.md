...
description: Aspose.Html.Dom.Events.InputEvent klas. Invoergebeurtenissen worden verzonden als meldingen wanneer de DOM wordt bijgewerkt.
type: docs
weight: 820
url: /nl/net/aspose.html.dom.events/inputevent/
---
## InputEvent class

Invoergebeurtenissen worden verzonden als meldingen wanneer de DOM wordt bijgewerkt.
...
| Naam | Beschrijving |
| --- | --- |
| [InputEvent](inputevent/#constructor)(string) | Initialiseert een nieuw exemplaar van het`InputEvent` klasse. |
| [InputEvent](inputevent/#constructor_1)(string, IDictionary&lt;string, object&gt;) | Initialiseert een nieuw exemplaar van het`InputEvent` klasse. |
...
| [Data](../../aspose.html.dom.events/inputevent/data/) { get; } | De gegevens bevatten de waarde van de tekens die zijn gegenereerd door een invoermethode. Dit KAN een enkel Unicode-teken zijn of een niet-lege reeks Unicode-tekens [Unicode]. Tekens MOETEN worden genormaliseerd zoals gedefinieerd door de Unicode-normalisatievorm NFC, gedefinieerd in [UAX15]. Dit attribuut KAN de lege string bevatten. |
...
| [IsComposing](../../aspose.html.dom.events/inputevent/iscomposing/) { get; } | waar als de invoergebeurtenis plaatsvindt als onderdeel van een compositiesessie, dwz na een compositiestartgebeurtenis en vóór de overeenkomstige compositieeindgebeurtenis. De niet-geïnitialiseerde waarde van dit kenmerk MOET onwaar zijn. |
