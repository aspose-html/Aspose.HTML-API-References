...
description: Aspose.Html.Dom.Svg.Paths.SVGPathSegCurvetoQuadraticSmoothAbs klas. De SVGPathSegCurvetoQuadraticSmoothAbsinterface komt overeen met een absolute gladde kubieke curve naar T padgegevensopdracht.
type: docs
weight: 1790
url: /nl/net/aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticsmoothabs/
---
## SVGPathSegCurvetoQuadraticSmoothAbs class

De SVGPathSegCurvetoQuadraticSmoothAbs-interface komt overeen met een "absolute gladde kubieke curve naar" (T) padgegevensopdracht.
...
| [X](../../aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticsmoothabs/x/) { get; set; } | De absolute X-coördinaat voor het eindpunt van dit padsegment. |
| [Y](../../aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticsmoothabs/y/) { get; set; } | De absolute Y-coördinaat voor het eindpunt van dit baansegment. |
