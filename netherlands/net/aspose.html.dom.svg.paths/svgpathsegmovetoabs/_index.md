...
description: Aspose.Html.Dom.Svg.Paths.SVGPathSegMovetoAbs klas. De SVGPathSegMovetoAbsinterface komt overeen met een absolute moveto M opdracht voor padgegevens.
type: docs
weight: 1880
url: /nl/net/aspose.html.dom.svg.paths/svgpathsegmovetoabs/
---
## SVGPathSegMovetoAbs class

De SVGPathSegMovetoAbs-interface komt overeen met een "absolute moveto" (M) opdracht voor padgegevens.
...
| [X](../../aspose.html.dom.svg.paths/svgpathsegmovetoabs/x/) { get; set; } | De absolute X-coördinaat voor het eindpunt van dit padsegment. |
| [Y](../../aspose.html.dom.svg.paths/svgpathsegmovetoabs/y/) { get; set; } | De absolute Y-coördinaat voor het eindpunt van dit baansegment. |
