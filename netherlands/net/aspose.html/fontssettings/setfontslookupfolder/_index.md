...
description: FontsSettings methode. Stelt de map in die wordt gebruikt tijdens de selectie van lettertypen.
type: docs
weight: 30
url: /nl/net/aspose.html/fontssettings/setfontslookupfolder/
---
...
| --- | --- | --- |
| fontsFolder | String | De fonts-map. |

### Zie ook

* class [FontsSettings](../)
* naamruimte [Aspose.Html](../../fontssettings/)
* montage [Aspose.HTML](../../../)
