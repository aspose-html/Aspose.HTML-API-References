...
description: Aspose.Html.Toolkit.Markdown.Syntax.EscapedCharacterSyntaxNode klas. Het syntaxisknooppunt voor escapetekens geïmplementeerd.
type: docs
weight: 4890
url: /nl/net/aspose.html.toolkit.markdown.syntax/escapedcharactersyntaxnode/
---
## EscapedCharacterSyntaxNode class

Het syntaxisknooppunt voor escape-tekens geïmplementeerd.
...
| virtual [Source](../../aspose.html.toolkit.markdown.syntax/textsyntaxnode/source/) { get; } | Retourneert de brontekst. |
| virtual [Span](../../aspose.html.toolkit.markdown.syntax/textsyntaxnode/span/) { get; } | Definieert de interface voor get span. |
| [Value](../../aspose.html.toolkit.markdown.syntax/textsyntaxnode/value/) { get; } | Definieert de eigenschap voor get string value. |

## methoden

| Naam | Beschrijving |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/escapedcharactersyntaxnode/accept/)(MarkdownSyntaxVisitor) | Definieert de interface voor het accepteren van bezoekers. |
