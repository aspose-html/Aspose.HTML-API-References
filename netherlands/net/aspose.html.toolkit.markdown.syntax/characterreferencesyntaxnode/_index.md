...
description: Aspose.Html.Toolkit.Markdown.Syntax.CharacterReferenceSyntaxNode klas. Vertegenwoordigt de CharacterReferenceSyntaxNode.
type: docs
weight: 4830
url: /nl/net/aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/
---
## CharacterReferenceSyntaxNode class

Vertegenwoordigt de CharacterReferenceSyntaxNode.
...
| [Reference](../../aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/reference/) { get; } | Verkrijg de referentie. |
| [Source](../../aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/source/) { get; } | Haal de bron op. |
| [Span](../../aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/span/) { get; } | Haal het bereik op. |
| [Value](../../aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/value/) { get; } | Haal de waarde op. |

## methoden

| Naam | Beschrijving |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/accept/)(MarkdownSyntaxVisitor) | Definieert de interface voor het accepteren van bezoekers. |
