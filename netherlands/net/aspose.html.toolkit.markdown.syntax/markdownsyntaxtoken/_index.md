---
title: Class MarkdownSyntaxToken
second_title: Aspose.HTML voor .NET API-referentie
description: Aspose.Html.Toolkit.Markdown.Syntax.MarkdownSyntaxToken klas. Vertegenwoordigen de Markdown Syntax Token.
type: docs
weight: 5210
url: /nl/net/aspose.html.toolkit.markdown.syntax/markdownsyntaxtoken/
---
## MarkdownSyntaxToken class

Vertegenwoordigen de Markdown Syntax Token.
...
| [Source](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxtoken/source/) { get; } | Haal de brontekst op. |
| [Span](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxtoken/span/) { get; } | Haal het bereik op. |
| [Text](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxtoken/text/) { get; } | Haal de tekstinhoud op van span. |

## methoden

| Naam | Beschrijving |
| --- | --- |
| virtual [Accept](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/accept/)(MarkdownSyntaxVisitor) | Accepteer de bezoeker. |
...
| [GetFullText](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxtoken/getfulltext/)() | Definieert de interface om de volledige tekst op te halen. |
