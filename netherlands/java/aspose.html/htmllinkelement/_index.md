---
title: "HTMLLinkElement Klasse"
second_title: "Aspose.HTML voor Java API-referentie"
description: "com.aspose.html.HTMLLinkElement class. Het LINK‑element specificeert een koppeling naar een externe bron en definieert de relatie van dit document tot die bron of omgekeerd. Zie de definitie van het LINK‑element in HTML 4.01 zie ook de LinkStyle‑interface in de StyleSheet‑module DOM Level 2 Style Sheets en CSS"
type: docs

url: /nl/java/com.aspose.html/htmllinkelement/
---
## HTMLLinkElement class

Het `LINK`‑element specificeert een koppeling naar een externe bron en definieert de relatie van dit document tot die bron (of omgekeerd). Zie de definitie van het LINK‑element in HTML 4.01 (zie ook de interface `LinkStyle` in de StyleSheet‑module [[DOM Level 2 Style Sheets and CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113)]).
...
| [getRelList](../../com.aspose.html/htmllinkelement/rellist/) Retourneert een live DOMTokenList die tokens bevat die verkregen zijn door het parsen van het "rel"‑attribuut. |
[getRev]
...
| [getSheet](../../com.aspose.html/htmllinkelement/sheet/) Haalt het gekoppelde stijlblad op. |
