...
description: "com.aspose.html.HTMLTableColElement klasse. Groepeert de COL- en COLGROUP-elementen opnieuw. Zie de definitie van het COL-element in HTML 4.01"
type: docs
...
Groepeert de `COL`- en `COLGROUP`-elementen opnieuw. Zie de definitie van het COL-element in HTML 4.01.
