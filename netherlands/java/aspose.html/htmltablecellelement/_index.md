...
description: "com.aspose.html.HTMLTableCellElement class. Het object dat wordt gebruikt om de TH- en TD-elementen te vertegenwoordigen. Zie de definitie van het TD-element in HTML 4.01"
type: docs
...
Het object dat wordt gebruikt om de `TH`- en `TD`-elementen te vertegenwoordigen. Zie de definitie van het TD-element in HTML 4.01.
