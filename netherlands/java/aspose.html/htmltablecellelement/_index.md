---
title: "HTMLTableCellElement Klasse"
second_title: "Aspose.HTML voor Java API-referentie"
description: "com.aspose.html.HTMLTableCellElement class. Het object dat wordt gebruikt om de TH- en TD-elementen weer te geven. Zie de definitie van het TD-element in HTML 4.01"
type: docs

url: /nl/java/com.aspose.html/htmltablecellelement/
---
## HTMLTableCellElement class

Het object dat wordt gebruikt om de `TH`- en `TD`-elementen te vertegenwoordigen. Zie de TD-elementdefinitie in HTML 4.01.
...
| [getCellIndex](../../com.aspose.html/htmltablecellelement/cellindex/) De index van deze cel in de rij, beginnend bij 0. Deze index is in de volgorde van de documentboom en niet in de weergavevolgorde. |
[getCh]
