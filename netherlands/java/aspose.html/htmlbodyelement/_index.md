---
title: "HTMLBodyElement‑klasse"
second_title: "Aspose.HTML voor Java API-referentie"
description: "com.aspose.html.HTMLBodyElement‑klasse. Het HTML‑documentlichaam. Dit element is altijd aanwezig in de DOM‑API, zelfs als de tags niet aanwezig zijn in het bron‑document. Zie de definitie van het BODY‑element in HTML 4.01"
type: docs

url: /nl/java/com.aspose.html/htmlbodyelement/
---
## HTMLBodyElement class

Het HTML‑document‑body. Dit element is altijd aanwezig in de DOM‑API, zelfs als de tags niet aanwezig zijn in het bron‑document. Zie de definitie van het BODY‑element in HTML 4.01.
