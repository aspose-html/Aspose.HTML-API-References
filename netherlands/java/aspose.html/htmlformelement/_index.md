...
Het `FORM`‑element omvat gedrag dat vergelijkbaar is met een collectie en een element. Het biedt directe toegang tot de ingesloten formulierbesturingselementen evenals de attributen van het formulier‑element. Zie de definitie van het FORM‑element in HTML 4.01.
...
| [reset](../../com.aspose.html/htmlformelement/reset/)() | Herstelt de standaardwaarden van een formulierelement. Het voert dezelfde actie uit als een reset‑knop. |
...
| [submit](../../com.aspose.html/htmlformelement/submit/)() | Verzendt het formulier. Het voert dezelfde actie uit als een verzend‑knop. |
