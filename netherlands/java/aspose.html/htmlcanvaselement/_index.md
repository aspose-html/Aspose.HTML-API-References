...
description: "com.aspose.html.HTMLCanvasElement class. De HTMLCanvasElement-interface biedt eigenschappen en methoden voor het manipuleren van de lay-out en presentatie van canvas-elementen. De HTMLCanvasElement-interface erft ook de eigenschappen en methoden van de HTMLElement-interface."
type: docs
...
De HTMLCanvasElement-interface biedt eigenschappen en methoden voor het manipuleren van de lay‑out en presentatie van canvas‑elementen. De HTMLCanvasElement-interface erft ook de eigenschappen en methoden van de HTMLElement-interface.
