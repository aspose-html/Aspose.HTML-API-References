---
title: "HTMLCanvasElement Klasse"
second_title: "Aspose.HTML voor Java API-referentie"
description: "com.aspose.html.HTMLCanvasElement klasse. De HTMLCanvasElement-interface biedt eigenschappen en methoden voor het manipuleren van de lay-out en presentatie van canvas-elementen. De HTMLCanvasElement-interface erft ook de eigenschappen en methoden van de HTMLElement-interface"
type: docs

url: /nl/java/com.aspose.html/htmlcanvaselement/
---
## HTMLCanvasElement class

De interface **HTMLCanvasElement** biedt eigenschappen en methoden voor het manipuleren van de lay-out en presentatie van canvas‑elementen. De interface **HTMLCanvasElement** erft ook de eigenschappen en methoden van de interface **HTMLElement**.
...
| [getContext](../../com.aspose.html/htmlcanvaselement/getcontext/)(String) | Retourneert een tekencontext op het canvas, of null als de context-ID niet wordt ondersteund. Een tekencontext stelt je in staat om op het canvas te tekenen. |
...
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl)() | retourneert een data-URI die een weergave van de afbeelding bevat in het formaat gespecificeerd door de typeparameter (standaard PNG). De geretourneerde afbeelding heeft een resolutie van 96 dpi. |
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl_1)(String) | retourneert een data-URI die een weergave van de afbeelding bevat in het formaat gespecificeerd door de typeparameter (standaard PNG). De geretourneerde afbeelding heeft een resolutie van 96 dpi. |
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl_2)(String, double) | retourneert een data-URI die een weergave van de afbeelding bevat in het formaat gespecificeerd door de typeparameter (standaard PNG). De geretourneerde afbeelding heeft een resolutie van 96 dpi. |
