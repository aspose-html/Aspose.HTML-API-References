...
description: "com.aspose.html.HTMLFieldSetElement-klasse. Organiseert formulierbesturingselementen in logische groepen. Zie de definitie van het FIELDSET-element in HTML 4.01"
type: docs
...
Organiseert formulierbesturingselementen in logische groepen. Zie de definitie van het FIELDSET-element in HTML 4.01.
...
| [getForm](../../com.aspose.html/htmlfieldsetelement/form/) Retourneert het `FORM`-element dat dit besturingselement bevat. Retourneert `null` als dit besturingselement zich niet binnen de context van een formulier bevindt. |
[getId]
