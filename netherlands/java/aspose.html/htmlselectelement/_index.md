---
title: "HTMLSelectElement Klasse"
second_title: "Aspose.HTML voor Java API-referentie"
description: "com.aspose.html.HTMLSelectElement klasse. Het select-element maakt de selectie van een optie mogelijk. De aanwezige opties kunnen rechtstreeks worden benaderd via het select-element als een collectie. Zie de definitie van het SELECT-element in HTML 4.01"
type: docs

url: /nl/java/com.aspose.html/htmlselectelement/
---
## HTMLSelectElement class

Het select-element maakt de selectie van een optie mogelijk. De aanwezige opties kunnen rechtstreeks via het select-element als een collectie worden benaderd. Zie de SELECT-elementdefinitie in HTML 4.01.
...
| [getForm](../../com.aspose.html/htmlselectelement/form/) Het aantal opties in deze `SELECT`. |
[getId]
...
| [getOptions](../../com.aspose.html/htmlselectelement/options/) De collectie van `OPTION`-elementen die dit element bevat. @version DOM Level 2 |
[getOuterHTML]
...
| [getType](../../com.aspose.html/htmlselectelement/type/) Het type van deze formulierbesturing. Dit is de String "select-multiple" wanneer het multiple-attribuut `true` is en de String "select-one" wanneer `false`. |
[getValue]
