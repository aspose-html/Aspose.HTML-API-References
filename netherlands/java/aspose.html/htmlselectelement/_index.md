...
description: "com.aspose.html.HTMLSelectElement klasse. Het select-element maakt het mogelijk een optie te selecteren. De ingesloten opties kunnen rechtstreeks worden benaderd via het select-element als een collectie. Zie de definitie van het SELECT-element in HTML 4.01"
type: docs
...
Het select-element maakt de selectie van een optie mogelijk. De aanwezige opties kunnen rechtstreeks via het select-element als een collectie worden benaderd. Zie de definitie van het SELECT-element in HTML 4.01.
