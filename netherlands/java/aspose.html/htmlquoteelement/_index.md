...
description: "com.aspose.html.HTMLQuoteElement klasse. Voor de Q- en BLOCKQUOTE-elementen. Zie de definitie van het Q-element in HTML 4.01"
type: docs
...
Voor de `Q`- en `BLOCKQUOTE`-elementen. Zie de definitie van het Q-element in HTML 4.01.
