---
title: "HTMLInputElement Klasse"
second_title: "Aspose.HTML voor Java API-referentie"
description: "com.aspose.html.HTMLInputElement klasse. Formulierelement. Afhankelijk van de omgeving waarin de pagina wordt bekeken, kan de eigenschap value alleen-lezen zijn voor het invoertype voor bestandsupload. Voor het wachtwoord-invoertype kan de werkelijke geretourneerde waarde gemaskeerd zijn om ongeautoriseerd gebruik te voorkomen. Zie de definitie van het INPUT-element in HTML 4.01. Zie ook de Document Object Model DOM Level 2 HTML Specificatie"
type: docs

url: /nl/java/com.aspose.html/htmlinputelement/
---
## HTMLInputElement class

Formulierelement. Afhankelijk van de omgeving waarin de pagina wordt bekeken, kan de eigenschap value alleen‑lezen zijn voor het invoertype voor bestandsupload. Voor het invoertype "password" kan de werkelijke waarde worden gemaskeerd om ongeautoriseerd gebruik te voorkomen. Zie de definitie van het INPUT‑element in [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224)]. Zie ook de [Document object Model (DOM) Level 2 HTML Specification](http://www.w3.org/TR/2003/REC-DOM-Level-2-HTML-20030109).
...
| [getFiles](../../com.aspose.html/htmlinputelement/files/) Het files IDL-attribuut stelt scripts in staat om toegang te krijgen tot de geselecteerde bestanden van het element. Bij ophalen, als het IDL-attribuut van toepassing is, moet het een FileList-object retourneren dat de momenteel geselecteerde bestanden vertegenwoordigt. Hetzelfde object moet worden geretourneerd totdat de lijst met geselecteerde bestanden verandert. Als het IDL-attribuut niet van toepassing is, moet het in plaats daarvan `null` retourneren. [FILEAPI] |
