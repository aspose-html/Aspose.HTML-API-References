...
url: /nl/java/com.aspose.html/url/url/
---
...
| --- | --- |
| Fout | TypeError: opgeworpen als `url` niet als geldige URL kan worden geparseerd. |
...
| uitzondering | conditie |
| --- | --- |
| Fout | TypeError: opgeworpen als `url` of `baseUrl` niet als geldige URL kan worden geparseerd. |
