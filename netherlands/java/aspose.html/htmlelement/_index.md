...
description: "com.aspose.html.HTMLElement-klasse. Alle HTML-elementinterfaces zijn afgeleid van deze klasse. Elementen die alleen de kernattributen van HTML blootleggen, worden weergegeven door de basis-HTMLElement-interface. Deze elementen zijn onder andere speciale SUB SUP SPAN BDOfont TT I B U S STRIKE BIG SMALL phrase EM STRONG DFN CODE SAMP KBD VAR CITE ACRONYM ABBRlist DD DTNOFRAMES NOSCRIPTADDRESS CENTER. Het style-attribuut van een HTML-element is toegankelijk via de ElementCSSInlineStyle-interface, die is gedefinieerd in de CSS-module DOM Level 2 Style Sheets and CSS"
type: docs
