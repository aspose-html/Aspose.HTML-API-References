---
title: "HTMLElement-klasse"
second_title: "Aspose.HTML voor Java API-referentie"
description: "com.aspose.html.HTMLElement klasse. Alle HTML-elementinterfaces zijn afgeleid van deze klasse. Elementen die alleen de kern‑HTML‑attributen blootstellen, worden weergegeven door de basis‑HTMLElement‑interface. Deze elementen zijn onder andere speciale SUB SUP SPAN BDO font TT I B U S STRIKE BIG SMALL phrase EM STRONG DFN CODE SAMP KBD VAR CITE ACRONYM ABBR list DD DT NOFRAMES NOSCRIPT ADDRESS CENTER. Het style‑attribuut van een HTML‑element is toegankelijk via de ElementCSSInlineStyle‑interface, die is gedefinieerd in de CSS‑module DOM Level 2 Style Sheets and CSS"
type: docs

url: /nl/java/com.aspose.html/htmlelement/
---
## HTMLElement class

Alle HTML‑elementinterfaces zijn afgeleid van deze klasse. Elementen die alleen de kern‑attributen van HTML blootleggen, worden weergegeven door de basisinterface `HTMLElement`. Deze elementen zijn als volgt: speciaal: SUB, SUP, SPAN, BDO; lettertype: TT, I, B, U, S, STRIKE, BIG, SMALL; frase: EM, STRONG, DFN, CODE, SAMP, KBD, VAR, CITE, ACRONYM, ABBR; lijst: DD, DT, NOFRAMES, NOSCRIPT, ADDRESS, CENTER. Het `style`‑attribuut van een HTML‑element is toegankelijk via de interface `ElementCSSInlineStyle`, die is gedefinieerd in de CSS‑module [[DOM Level 2 Style Sheets and CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113)].
