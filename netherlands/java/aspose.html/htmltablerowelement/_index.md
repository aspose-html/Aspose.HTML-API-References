---
title: "HTMLTableRowElement Klasse"
second_title: "Aspose.HTML voor Java API-referentie"
description: "com.aspose.html.HTMLTableRowElement class. Een rij in een tabel. Zie de definitie van het TR-element in HTML 4.01"
type: docs

url: /nl/java/com.aspose.html/htmltablerowelement/
---
...
| [getCells](../../com.aspose.html/htmltablerowelement/cells/) De verzameling cellen in deze rij. @version DOM Level 2 |
[getCh]
...
| [getRowIndex](../../com.aspose.html/htmltablerowelement/rowindex/) Dit is in logische volgorde en niet in documentvolgorde. De `rowIndex` houdt rekening met secties (`THEAD`, `TFOOT` of `TBODY`) binnen de tabel, waarbij `THEAD`-rijen eerst in de index worden geplaatst, gevolgd door `TBODY`-rijen, gevolgd door `TFOOT`-rijen. @version DOM Level 2 |
| [getSectionRowIndex](../../com.aspose.html/htmltablerowelement/sectionrowindex/) De index van deze rij, relatief ten opzichte van de huidige sectie (`THEAD`, `TFOOT` of `TBODY`), beginnend bij 0. @version DOM Level 2 |
...
| [deleteCell](../../com.aspose.html/htmltablerowelement/deletecell/)(int) | Verwijder een cel uit de huidige rij. |
...
| [insertCell](../../com.aspose.html/htmltablerowelement/insertcell/)(int) | Voeg een lege `TD`-cel toe aan deze rij. Als `index` -1 is of gelijk aan het aantal cellen, wordt de nieuwe cel toegevoegd. |
