...
| --- | --- |
| [dOMException](../../../com.aspose.html.dom/domexception/) | INDEX_SIZE_ERR: Opgeworpen als de opgegeven `index` groter is dan het aantal cellen of als de index een negatief getal is anders dan -1. @version DOM Level 2 |
