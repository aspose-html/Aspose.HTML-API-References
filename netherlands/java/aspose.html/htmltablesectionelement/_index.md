...
description: "com.aspose.html.HTMLTableSectionElement klasse. De THEAD-, TFOOT- en TBODY-elementen"
type: docs
...
| [getRows](../../com.aspose.html/htmltablesectionelement/rows/) De collectie rijen in deze tabelsectie. |
...
| [insertRow](../../com.aspose.html/htmltablesectionelement/insertrow/)(int) | Voeg een rij toe aan deze sectie. De nieuwe rij wordt onmiddellijk vóór de huidige `index`-de rij in deze sectie ingevoegd. Als `index` -1 is of gelijk aan het aantal rijen in deze sectie, wordt de nieuwe rij toegevoegd. |
