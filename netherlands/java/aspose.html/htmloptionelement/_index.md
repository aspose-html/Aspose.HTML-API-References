...
Een selecteerbare keuze. Zie de definitie van het OPTION-element in HTML 4.01.
...
| [getForm](../../com.aspose.html/htmloptionelement/form/) Retourneert het `FORM`‑element dat deze besturing bevat. Retourneert `null` als deze besturing zich niet binnen de context van een formulier bevindt. |
[getId]
[setId] The element's identifier. See the id attribute definition in HTML 4.01. |
| [getIndex](../../com.aspose.html/htmloptionelement/index/) De index van deze `OPTION` in de bovenliggende `SELECT`, beginnend bij 0. @version DOM Level 2 |
[getInnerHTML]
...
| [getText](../../com.aspose.html/htmloptionelement/text/) De tekst die zich in het option‑element bevindt. |
