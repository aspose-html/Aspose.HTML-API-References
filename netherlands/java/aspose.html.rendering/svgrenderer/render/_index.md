...
| documenten | SVGDocument[] | De documenten om weer te geven. |
...
Definieert een methode voor het renderen van meerdere [`SVGDocument`](../../../com.aspose.html.dom.svg/svgdocument/)s naar een specifiek [`IDevice`](../../idevice/), met behulp van een annulerings‑token om annulering van de bewerking aan te vragen.
...
| sources | SVGDocument[] | De SVG‑documenten die gerenderd moeten worden. |
