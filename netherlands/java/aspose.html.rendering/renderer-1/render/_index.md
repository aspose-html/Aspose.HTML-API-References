...
description: "Renderer-methode. Definieert een methode voor het renderen van TDocument naar een gespecificeerd IDevice"
type: docs
...
Definieert een methode voor het renderen van !:TDocument naar een gespecificeerd [`IDevice`](../../idevice/).
...
Definieert een methode voor het renderen van !:TDocument naar een gespecificeerd [`IDevice`](../../idevice/). Het renderen wordt uitgevoerd zodra er geen netwerkbewerkingen meer zijn voor het laden van bronnen, actieve timers, animatietaken of de opgegeven time-out is verstreken.
