...
description: "MhtmlRenderer-methode. Rendert meerdere MHTML-documenten naar een opgegeven IDevice. Het renderen wordt uitgevoerd zodra er geen netwerkbewerkingen meer zijn voor het laden van bronnen, actieve timers, animatietaken of wanneer de opgegeven timeout is verstreken."
type: docs
...
Rendert meerdere MHTML-documenten naar een opgegeven [`IDevice`](../../idevice/). Het renderen wordt uitgevoerd zodra er geen netwerkbewerkingen meer zijn voor het laden van bronnen, actieve timers, animatietaken of wanneer de opgegeven timeout is verstreken.
...
| bronnen | Stream[] | De MHTML-documenten om te renderen. |
