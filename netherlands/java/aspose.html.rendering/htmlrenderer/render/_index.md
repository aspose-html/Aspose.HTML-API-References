...
description: "HtmlRenderer‑methode. Definieert een methode voor het renderen van meerdere HTMLDocumenten naar een specifiek IDevice"
type: docs
...
Definieert een methode voor het renderen van meerdere [`HTMLDocument`](../../../com.aspose.html/htmldocument/)s naar een specifiek [`IDevice`](../../idevice/).
...
| bronnen | HTMLDocument[] | De HTML-documenten om te renderen. |
...
Definieert een methode voor het renderen van meerdere [`HTMLDocument`](../../../com.aspose.html/htmldocument/)s naar een specifiek [`IDevice`](../../idevice/), met behulp van een annulerings‑token om annulering van de bewerking aan te vragen.
