...
description: "com.aspose.html.toolkit.optimizers.SVGPathOptimizationOptions klasse. SVGPathOptimizationOptions is een klasse voor het opslaan van opties voor het optimaliseren van segmenten van SVG-pad elementen"
type: docs

url: /nl/java/com.aspose.html.toolkit.optimizers/svgpathoptimizationoptions/
---
## SVGPathOptimizationOptions class

SVGPathOptimizationOptions is een klasse voor het opslaan van opties voor het optimaliseren van segmenten van SVG-pad-elementen.
...
| Naam | Beschrijving |
| --- | --- |
| [SVGPathOptimizationOptions](svgpathoptimizationoptions/)() | Initialiseert een nieuw exemplaar van de `SVGPathOptimizationOptions` klasse. |
