...
description: "MarkdownSyntaxTree-methode. Definieert de interface voor het creëren van de tree walker."
type: docs

url: /nl/java/com.aspose.html.toolkit.markdown.syntax/markdownsyntaxtree/createtreewalker/
---
## CreateTreeWalker(MarkdownSyntaxNodeFilter) {#createtreewalker_2}

Definieert de interface voor het maken van de boomwalker.
