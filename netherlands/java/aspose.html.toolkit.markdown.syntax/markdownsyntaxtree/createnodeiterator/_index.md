...
description: "MarkdownSyntaxTree-methode. Definieert de interface voor het aanmaken van de node-iterator"
type: docs

url: /nl/java/com.aspose.html.toolkit.markdown.syntax/markdownsyntaxtree/createnodeiterator/
---
## CreateNodeIterator(MarkdownSyntaxNodeFilter) {#createnodeiterator_2}

Definieert de interface voor het maken van de knooppuntiterator.
...
| --- | --- | --- |
| filter | MarkdownSyntaxNodeFilter | De filter. |
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| root | MarkdownSyntaxNode | De MarkdownSyntaxNode. |
...
| --- | --- | --- |
| root | MarkdownSyntaxNode | De MarkdownSyntaxNode. |
| filter | MarkdownSyntaxNodeFilter | De MarkdownSyntaxNodeFilter. |
