...
description: "MarkdownSyntaxFactory methode. Maakt InlineImageSyntaxNode"
type: docs

url: /nl/java/com.aspose.html.toolkit.markdown.syntax/markdownsyntaxfactory/inlineimage/
---
## InlineImage(String, String, String) {#inlineimage_1}

Maakt [`InlineImageSyntaxNode`](../../inlineimagesyntaxnode/).
...
| --- | --- | --- |
| altText | String | De alternatieve tekst. |
| href | String | De URL van afbeelding. |
...
| destination | LinkDestinationSyntaxNode | De destination. |
