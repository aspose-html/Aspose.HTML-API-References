---
title: "SVGFECompositeElement Klasse"
second_title: "Aspose.HTML voor Java API-referentie"
description: "com.aspose.html.dom.svg.filters.SVGFECompositeElement klasse. De SVGFECompositeElement interface komt overeen met het feComposite element"
type: docs

url: /nl/java/com.aspose.html.dom.svg.filters/svgfecompositeelement/
---
## SVGFECompositeElement class

De SVGFECompositeElement-interface komt overeen met het ‘feComposite’-element.
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/height/) Komt overeen met attribuut ‘height’ op het opgegeven ‘filter’ element. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/in1/) Komt overeen met attribuut ‘in’ op het opgegeven ‘feComposite’ element. |
| [getIn2](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/in2/) Komt overeen met attribuut ‘in2’ op het opgegeven ‘feComposite’ element. |
[getInnerHTML]
...
| [getK1](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k1/) Komt overeen met attribuut ‘k1’ op het opgegeven ‘feComposite’ element. |
| [getK2](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k2/) Komt overeen met attribuut ‘k2’ op het opgegeven ‘feComposite’ element. |
| [getK3](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k3/) Komt overeen met attribuut ‘k3’ op het opgegeven ‘feComposite’ element. |
| [getK4](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k4/) Komt overeen met attribuut ‘k4’ op het opgegeven ‘feComposite’ element. |
...
| [getOperator](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/operator/) Komt overeen met attribuut ‘operator’ op het opgegeven ‘feComposite’ element. Neemt een van de SVG_FECOMPOSITE_OPERATOR_* constanten die op deze interface zijn gedefinieerd. |
[getOuterHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/result/) Komt overeen met attribuut ‘result’ op het opgegeven ‘filter’ element. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/width/) Komt overeen met attribuut ‘width’ op het opgegeven ‘filter’ element. |
| [X](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/x/) { get; } | Komt overeen met het attribuut ‘x’ op het opgegeven ‘filter’-element. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/y/) { get; } | Komt overeen met het attribuut ‘y’ op het opgegeven ‘filter’-element. |
...
| Naam | Beschrijving |
| --- | --- |
| const [SVG_FECOMPOSITE_OPERATOR_ARITHMETIC](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_arithmetic/) | Komt overeen met waarde 'arithmetic'. |
| const [SVG_FECOMPOSITE_OPERATOR_ATOP](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_atop/) | Komt overeen met waarde 'atop'. |
| const [SVG_FECOMPOSITE_OPERATOR_IN](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_in/) | Komt overeen met waarde 'in'. |
| const [SVG_FECOMPOSITE_OPERATOR_OUT](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_out/) | Komt overeen met waarde 'out'. |
| const [SVG_FECOMPOSITE_OPERATOR_OVER](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_over/) | Komt overeen met waarde 'over'. |
| const [SVG_FECOMPOSITE_OPERATOR_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_unknown/) | Het type is niet een van de vooraf gedefinieerde types. Het is ongeldig om te proberen een nieuwe waarde van dit type te definiëren of om te proberen een bestaande waarde naar dit type te wijzigen. |
| const [SVG_FECOMPOSITE_OPERATOR_XOR](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_xor/) | Komt overeen met waarde 'xor'. |
