---
title: "SVGFEBlendElement Klasse"
second_title: "Aspose.HTML voor Java API-referentie"
description: "com.aspose.html.dom.svg.filters.SVGFEBlendElement klasse. De SVGFEBlendElement interface komt overeen met het feBlend-element."
type: docs

url: /nl/java/com.aspose.html.dom.svg.filters/svgfeblendelement/
---
## SVGFEBlendElement class

De SVGFEBlendElement-interface komt overeen met het ‘feBlend’-element.
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfeblendelement/height/) Komt overeen met attribuut ‘height’ op het opgegeven ‘filter’-element. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfeblendelement/in1/) Komt overeen met attribuut ‘in’ op het opgegeven ‘feBlend’-element. |
| [getIn2](../../com.aspose.html.dom.svg.filters/svgfeblendelement/in2/) Komt overeen met attribuut ‘in2’ op het opgegeven ‘feBlend’-element. |
[getInnerHTML]
...
| [getMode](../../com.aspose.html.dom.svg.filters/svgfeblendelement/mode/) Komt overeen met attribuut ‘mode’ op het opgegeven ‘feBlend’-element. Neemt een van de SVG_FEBLEND_MODE_* constanten die op deze interface zijn gedefinieerd. |
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfeblendelement/result/) Komt overeen met attribuut ‘result’ op het opgegeven ‘filter’-element. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfeblendelement/width/) Komt overeen met attribuut ‘width’ op het opgegeven ‘filter’-element. |
| [X](../../com.aspose.html.dom.svg.filters/svgfeblendelement/x/) { get; } | Komt overeen met het attribuut ‘x’ op het opgegeven ‘filter’-element. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfeblendelement/y/) { get; } | Komt overeen met het attribuut ‘y’ op het opgegeven ‘filter’-element. |
...
| Naam | Beschrijving |
| --- | --- |
| const [SVG_FEBLEND_MODE_COLOR](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_color/) | Komt overeen met waarde 'color'. |
| const [SVG_FEBLEND_MODE_COLOR_BURN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_color_burn/) | Komt overeen met waarde 'color_burn'. |
| const [SVG_FEBLEND_MODE_COLOR_DODGE](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_color_dodge/) | Komt overeen met waarde 'color_dodge'. |
| const [SVG_FEBLEND_MODE_DARKEN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_darken/) | Komt overeen met waarde 'darken'. |
| const [SVG_FEBLEND_MODE_DIFFERENCE](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_difference/) | Komt overeen met waarde 'difference'. |
| const [SVG_FEBLEND_MODE_EXCLUSION](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_exclusion/) | Komt overeen met waarde 'exclusion'. |
| const [SVG_FEBLEND_MODE_HARD_LIGHT](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_hard_light/) | Komt overeen met waarde 'hard_light'. |
| const [SVG_FEBLEND_MODE_HUE](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_hue/) | Komt overeen met waarde 'hue'. |
| const [SVG_FEBLEND_MODE_LIGHTEN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_lighten/) | Komt overeen met waarde 'lighten'. |
| const [SVG_FEBLEND_MODE_LUMINOSITY](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_luminosity/) | Komt overeen met waarde 'luminosity'. |
| const [SVG_FEBLEND_MODE_MULTIPLY](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_multiply/) | Komt overeen met waarde 'multiply'. |
| const [SVG_FEBLEND_MODE_NORMAL](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_normal/) | Komt overeen met waarde 'normal'. |
| const [SVG_FEBLEND_MODE_OVERLAY](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_overlay/) | Komt overeen met waarde 'overlay'. |
| const [SVG_FEBLEND_MODE_SATURATION](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_saturation/) | Komt overeen met waarde 'saturation'. |
| const [SVG_FEBLEND_MODE_SCREEN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_screen/) | Komt overeen met waarde 'screen'. |
| const [SVG_FEBLEND_MODE_SOFT_LIGHT](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_soft_light/) | Komt overeen met waarde 'soft_light'. |
| const [SVG_FEBLEND_MODE_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_unknown/) | Het type is niet een van de vooraf gedefinieerde types. Het is ongeldig om te proberen een nieuwe waarde van dit type te definiëren of om te proberen een bestaande waarde naar dit type te wijzigen. |
