---
title: "SVGFEMorphologyElement Klasse"
second_title: "Aspose.HTML voor Java API-referentie"
description: "com.aspose.html.dom.svg.filters.SVGFEMorphologyElement class. De SVGFEMorphologyElement interface komt overeen met het feMorphology-element."
type: docs

url: /nl/java/com.aspose.html.dom.svg.filters/svgfemorphologyelement/
---
## SVGFEMorphologyElement class

De SVGFEMorphologyElement-interface komt overeen met het ‘feMorphology’-element.
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/height/) Komt overeen met attribuut ‘height’ op het opgegeven ‘filter’ element. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/in1/) Komt overeen met attribuut ‘in’ op het opgegeven ‘feMorphology’ element. |
[getInnerHTML]
...
| [getOperator](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/operator/) Komt overeen met attribuut ‘operator’ op het opgegeven ‘feMorphology’ element. Neemt een van de SVG_MORPHOLOGY_OPERATOR_* constanten die op deze interface zijn gedefinieerd. |
[getOuterHTML]
...
| [getRadiusX](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/radiusx/) Komt overeen met attribuut ‘radius’ op het opgegeven ‘feMorphology’ element. |
| [getRadiusY](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/radiusy/) Komt overeen met attribuut ‘radius’ op het opgegeven ‘feMorphology’ element. |
| [getResult](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/result/) Komt overeen met attribuut ‘result’ op het opgegeven ‘filter’ element. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/width/) Komt overeen met attribuut ‘width’ op het opgegeven ‘filter’ element. |
| [X](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/x/) { get; } | Komt overeen met het attribuut ‘x’ op het opgegeven ‘filter’-element. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/y/) { get; } | Komt overeen met het attribuut ‘y’ op het opgegeven ‘filter’-element. |
...
| Naam | Beschrijving |
| --- | --- |
| const [SVG_MORPHOLOGY_OPERATOR_DILATE](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/svg_morphology_operator_dilate/) | Komt overeen met waarde 'dilate'. |
| const [SVG_MORPHOLOGY_OPERATOR_ERODE](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/svg_morphology_operator_erode/) | Komt overeen met waarde 'erode'. |
| const [SVG_MORPHOLOGY_OPERATOR_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/svg_morphology_operator_unknown/) | Het type is niet een van de vooraf gedefinieerde types. Het is ongeldig om te proberen een nieuwe waarde van dit type te definiëren of om te proberen een bestaande waarde naar dit type te wijzigen. |
