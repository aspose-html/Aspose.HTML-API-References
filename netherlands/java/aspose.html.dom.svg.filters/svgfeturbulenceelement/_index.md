---
title: "SVGFETurbulenceElement Klasse"
second_title: "Aspose.HTML voor Java API-referentie"
description: "com.aspose.html.dom.svg.filters.SVGFETurbulenceElement klasse. De SVGFETurbulenceElement interface komt overeen met het feTurbulence-element."
type: docs

url: /nl/java/com.aspose.html.dom.svg.filters/svgfeturbulenceelement/
---
## SVGFETurbulenceElement class

De SVGFETurbulenceElement interface komt overeen met het ‘feTurbulence’ element.
...
| [getBaseFrequencyX](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/basefrequencyx/) Komt overeen met attribuut ‘baseFrequency’ op het opgegeven ‘feTurbulence’-element. Bevat het X-component van het ‘baseFrequency’-attribuut. |
| [getBaseFrequencyY](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/basefrequencyy/) Komt overeen met attribuut ‘baseFrequency’ op het opgegeven ‘feTurbulence’-element. Bevat het Y-component van het (mogelijk automatisch berekende) ‘baseFrequency’-attribuut. |
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/height/) Komt overeen met attribuut ‘height’ op het opgegeven ‘filter’-element. |
[getId]
...
| [getNumOctaves](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/numoctaves/) Komt overeen met attribuut ‘numOctaves’ op het opgegeven ‘feTurbulence’-element. |
[getOuterHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/result/) Komt overeen met attribuut ‘result’ op het opgegeven ‘filter’-element. |
| [getSeed](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/seed/) Komt overeen met attribuut ‘seed’ op het opgegeven ‘feTurbulence’-element. |
...
| [getStitchTiles](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/stitchtiles/) Komt overeen met attribuut ‘stitchTiles’ op het opgegeven ‘feTurbulence’-element. Neemt een van de SVG_STITCHTYPE_* constanten die op deze interface zijn gedefinieerd. |
...
| [getType](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/type/) Komt overeen met attribuut ‘type’ op het opgegeven ‘feTurbulence’-element. Neemt een van de SVG_TURBULENCE_TYPE_* constanten die op deze interface zijn gedefinieerd. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/width/) Komt overeen met attribuut ‘width’ op het opgegeven ‘filter’-element. |
| [X](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/x/) { get; } | Komt overeen met het attribuut ‘x’ op het opgegeven ‘filter’-element. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/y/) { get; } | Komt overeen met het attribuut ‘y’ op het opgegeven ‘filter’-element. |
...
| Naam | Beschrijving |
| --- | --- |
| const [SVG_STITCHTYPE_NOSTITCH](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_stitchtype_nostitch/) | Komt overeen met waarde 'noStitch'. |
| const [SVG_STITCHTYPE_STITCH](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_stitchtype_stitch/) | Komt overeen met waarde 'stitch'. |
| const [SVG_STITCHTYPE_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_stitchtype_unknown/) | Het type is niet een van de vooraf gedefinieerde types. Het is ongeldig om te proberen een nieuwe waarde van dit type te definiëren of om te proberen een bestaande waarde naar dit type te wijzigen. |
| const [SVG_TURBULENCE_TYPE_FRACTALNOISE](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_turbulence_type_fractalnoise/) | Komt overeen met waarde 'fractalNoise'. |
| const [SVG_TURBULENCE_TYPE_TURBULENCE](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_turbulence_type_turbulence/) | Komt overeen met waarde 'turbulence'. |
| const [SVG_TURBULENCE_TYPE_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_turbulence_type_unknown/) | Het type is niet een van de vooraf gedefinieerde types. Het is ongeldig om te proberen een nieuwe waarde van dit type te definiëren of om te proberen een bestaande waarde naar dit type te wijzigen. |
