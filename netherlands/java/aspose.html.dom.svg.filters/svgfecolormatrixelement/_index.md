---
title: "SVGFEColorMatrixElement Klasse"
second_title: "Aspose.HTML voor Java API-referentie"
description: "com.aspose.html.dom.svg.filters.SVGFEColorMatrixElement klasse. De SVGFEColorMatrixElement interface correspondeert met het feColorMatrix-element"
type: docs

url: /nl/java/com.aspose.html.dom.svg.filters/svgfecolormatrixelement/
---
## SVGFEColorMatrixElement class

De SVGFEColorMatrixElement-interface komt overeen met het ‘feColorMatrix’-element.
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/height/) Komt overeen met het attribuut ‘height’ op het opgegeven ‘filter’-element. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/in1/) Komt overeen met het attribuut ‘in’ op het opgegeven ‘feColorMatrix’-element. |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/result/) Komt overeen met het attribuut ‘result’ op het opgegeven ‘filter’-element. |
...
| [getType](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/type/) Komt overeen met het attribuut ‘type’ op het opgegeven ‘feColorMatrix’-element. Neemt een van de SVG_FECOLORMATRIX_TYPE_* constanten die op deze interface zijn gedefinieerd. |
| [getValues](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/values/) Komt overeen met het attribuut ‘values’ op het opgegeven ‘feColorMatrix’-element. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/width/) Komt overeen met het attribuut ‘width’ op het opgegeven ‘filter’-element. |
| [X](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/x/) { get; } | Komt overeen met het attribuut ‘x’ op het opgegeven ‘filter’-element. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/y/) { get; } | Komt overeen met het attribuut ‘y’ op het opgegeven ‘filter’-element. |
...
| Naam | Beschrijving |
| --- | --- |
| const [SVG_FECOLORMATRIX_TYPE_HUEROTATE](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_huerotate/) | Komt overeen met de waarde 'hueRotate'. |
| const [SVG_FECOLORMATRIX_TYPE_LUMINANCETOALPHA](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_luminancetoalpha/) | Komt overeen met de waarde 'luminanceToAlpha'. |
| const [SVG_FECOLORMATRIX_TYPE_MATRIX](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_matrix/) | Komt overeen met de waarde 'matrix'. |
| const [SVG_FECOLORMATRIX_TYPE_SATURATE](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_saturate/) | Komt overeen met de waarde 'saturate'. |
| const [SVG_FECOLORMATRIX_TYPE_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_unknown/) | Het type is niet een van de vooraf gedefinieerde types. Het is ongeldig om te proberen een nieuwe waarde van dit type te definiëren of om te proberen een bestaande waarde naar dit type te wijzigen. |
