...
url: /nl/java/com.aspose.html.rendering.pdf/pdfdevice/pdfdevice/
---
...
| --- | --- | --- |
| streamProvider | ICreateStreamProvider | De streamprovider. |
...
Initialiseert een nieuw exemplaar van de [`PdfDevice`](../) klasse met renderopties en uitvoerbestandsnaam.
...
| --- | --- | --- |
| options | PdfRenderingOptions | Renderopties. |
| stroom | Stream | De uitvoerstream. |
