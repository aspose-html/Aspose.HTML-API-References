---
title: "Entiteit Klasse"
second_title: "Aspose.HTML voor Java API-referentie"
description: "com.aspose.html.dom.Entity class. Vertegenwoordigt een bekende entiteit, geparseerd of niet-geparseerd, in een XML-document."
type: docs

url: /nl/java/com.aspose.html.dom/entity/
---
## Entity class

Stelt een bekende entiteit voor, ofwel geparseerd of niet-geparseerd, in een XML-document.
...
| [getInputEncoding](../../com.aspose.html.dom/entity/inputencoding/) Een attribuut dat de codering aangeeft die voor deze entiteit wordt gebruikt op het moment van parseren, wanneer het een externe geparseerde entiteit is. Dit is null als het een entiteit uit de interne subset is of als deze niet bekend is. |
...
| [getNodeName](../../com.aspose.html.dom/entity/nodename/) De naam van dit knooppunt, afhankelijk van het type. |
| [getNodeType](../../com.aspose.html.dom/entity/nodetype/) Een code die het type van het onderliggende object vertegenwoordigt. |
...
| [getNotationName](../../com.aspose.html.dom/entity/notationname/) Voor niet-geparseerde entiteiten, de naam van de notatie voor de entiteit. Voor geparseerde entiteiten is dit null. |
...
| [getPublicId](../../com.aspose.html.dom/entity/publicid/) De openbare identifier gekoppeld aan de entiteit indien gespecificeerd, anders null. |
| [getSystemId](../../com.aspose.html.dom/entity/systemid/) De systeemidentifier gekoppeld aan de entiteit indien gespecificeerd, anders null. Dit kan een absolute URI zijn of niet. |
...
| [getXmlEncoding](../../com.aspose.html.dom/entity/xmlencoding/) Een attribuut dat, als onderdeel van de tekstaanduiding, de codering van deze entiteit aangeeft, wanneer het een externe geparseerde entiteit is. Anders is dit null. |
| [getXmlVersion](../../com.aspose.html.dom/entity/xmlversion/) Een attribuut dat, als onderdeel van de tekstaanduiding, het versienummer van deze entiteit aangeeft, wanneer het een externe geparseerde entiteit is. Anders is dit null. |
