...
description: "com.aspose.html.dom.Entity class. Vertegenwoordigt een bekende entiteit, al dan niet geparseerd, in een XML-document."
type: docs
...
| [getInputEncoding](../../com.aspose.html.dom/entity/inputencoding/) Een attribuut dat de codering specificeert die voor deze entiteit wordt gebruikt op het moment van ontleden, wanneer het een externe geparseerde entiteit is. Dit is null als het een entiteit uit de interne subset is of als het niet bekend is. |
...
| [getPublicId](../../com.aspose.html.dom/entity/publicid/) De publieke identifier die aan de entiteit is gekoppeld indien gespecificeerd, anders null. |
| [getSystemId](../../com.aspose.html.dom/entity/systemid/) De systeemidentifier die aan de entiteit is gekoppeld indien gespecificeerd, anders null. Dit kan een absolute URI zijn of niet. |
...
| [getXmlEncoding](../../com.aspose.html.dom/entity/xmlencoding/) Een attribuut dat, als onderdeel van de tekstaanduiding, de codering van deze entiteit specificeert, wanneer het een externe geparseerde entiteit is. Anders is dit null. |
| [getXmlVersion](../../com.aspose.html.dom/entity/xmlversion/) Een attribuut dat, als onderdeel van de tekstaanduiding, het versienummer van deze entiteit specificeert, wanneer het een externe geparseerde entiteit is. Anders is dit null. |
