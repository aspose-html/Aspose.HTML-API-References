...
description: "EventTarget‑methode. Deze methode maakt het verwijderen van event listeners van het event‑target mogelijk. Als een listener wordt verwijderd terwijl er een gebeurtenis wordt verwerkt, zal deze niet worden geactiveerd door de huidige acties. Event‑listeners kunnen nooit meer worden aangeroepen nadat ze zijn verwijderd."
type: docs
