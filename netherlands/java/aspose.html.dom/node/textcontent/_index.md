...
description: "Node property. De textContent-eigenschap van de Node-interface vertegenwoordigt de tekstinhoud van de knoop en zijn afstammelingen"
type: docs
...
De textContent-eigenschap van de [`Node`](../) interface vertegenwoordigt de tekstinhoud van de knoop en zijn afstammelingen.
