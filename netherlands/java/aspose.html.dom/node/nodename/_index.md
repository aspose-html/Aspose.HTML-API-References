...
description: "Node eigenschap. De alleen-lezen nodeName‑eigenschap van Node retourneert de naam van de huidige node als een String"
type: docs

url: /nl/java/com.aspose.html.dom/node/nodename/
---
## Node.NodeName property

De alleen-lezen nodeName‑eigenschap van Node retourneert de naam van de huidige node als een String.
...
Een String, waarden voor de verschillende typen nodes zijn:
