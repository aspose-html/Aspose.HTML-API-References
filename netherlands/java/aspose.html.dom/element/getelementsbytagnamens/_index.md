...
description: "Element-methode. Retourneert een HTMLCollection‑object dat alle elementen met een opgegeven lokale naam en package‑URI‑String in documentvolgorde bevat."
type: docs
...
Retourneert een [`HTMLCollection`](../../../com.aspose.html.collections/htmlcollection/) object dat alle [`elements`](../) met een opgegeven lokale naam en package‑URI‑String in documentvolgorde bevat.
...
| --- | --- | --- |
| packageURI | String | De weergave van de package‑URI‑String. |
...
Aangepaste package aangepaste taginhoud gaat hier...
