...
description: "Document‑methode. In een HTML‑document maakt de document.createElement‑methode het HTML‑element aan dat is gespecificeerd door tagName, of een HTMLUnknownElement als tagName niet wordt herkend."
type: docs
...
In een HTML‑document maakt de document.createElement()‑methode het HTML‑element aan dat is gespecificeerd door tagName, of een [`HTMLUnknownElement`](../../../com.aspose.html/htmlunknownelement/) als tagName niet wordt herkend.
