...
description: "Document‑methode. Retourneert een lijst van elementen met de opgegeven tagnaam die behoren tot het opgegeven pakket. Het volledige document wordt doorzocht, inclusief het root‑knooppunt."
type: docs
...
Retourneert een lijst van elementen met de opgegeven tag‑naam die tot het opgegeven pakket behoren. Het volledige document wordt doorzocht, inclusief het root‑knooppunt.
...
| localName | String | Of de lokale naam van elementen om naar te zoeken of de speciale waarde *, die alle elementen overeenkomt. |
...
Verwijs naar de officiële [spec](https://dom.spec.whatwg.org/#dom-document-getelementsbytagnamens).
