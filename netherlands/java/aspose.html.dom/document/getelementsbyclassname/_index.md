...
description: "Document‑methode. De getElementsByClassName‑methode van de Document‑interface retourneert een array‑achtig object van alle kindelementen die alle opgegeven klassennamen hebben."
type: docs
...
De getElementsByClassName‑methode van de [`Document`](../)‑interface retourneert een array‑achtig object van alle kindelementen die alle opgegeven klassenaam(en) hebben.

Wanneer aangeroepen op het documentobject, wordt het volledige document doorzocht, inclusief de root‑knoop. Je kunt ook getElementsByClassName() aanroepen op elk element; het zal alleen elementen retourneren die afstammelingen zijn van het opgegeven root‑element met de opgegeven klassenaam(en).
...
| --- | --- | --- |
| classNames | String | De String String die een ongeordende set van unieke door spaties gescheiden tokens bevat die klassen (klassenamen) vertegenwoordigen |
...
Alinea gestyled door classnaam =ddd kkk=

Elementtype: Aspose.Html.HTMLParagraphElement

Alinea gestyled door classnaam =ddd fff=
...
Eerste gestyled door pStyle class alinea

Elementtype: Aspose.Html.HTMLParagraphElement

Tweede gestyled door pStyle class alinea

Elementtype: Aspose.Html.HTMLParagraphElement

Derde gestyled door pStyle class alinea
