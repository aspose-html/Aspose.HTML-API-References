...
description: "Document-methode. Evalueert een XPath-expressiestring en retourneert een resultaat van het opgegeven type indien mogelijk."
type: docs
...
| resolver | IXPathNSResolver | De resolver staat vertaling van alle prefixes toe, inclusief de xml-pakketprefix, binnen de XPath-expressie naar de juiste pakket-URI's. |
