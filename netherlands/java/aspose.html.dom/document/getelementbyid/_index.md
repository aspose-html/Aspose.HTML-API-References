...
description: "Document-methode. De Document-methode getElementById retourneert een Element-object dat het element vertegenwoordigt waarvan de id-eigenschap overeenkomt met de opgegeven String. Aangezien element-ID's uniek moeten zijn wanneer ze zijn opgegeven, vormen ze een handige manier om snel toegang te krijgen tot een specifiek element."
type: docs
...
| --- | --- | --- |
| elementId | String | De ID van het te lokaliseren element. De ID is een hoofdlettergevoelige String die uniek is binnen het document; slechts één element kan een bepaalde ID hebben. |
