...
description: "WebAccessibility-methode. Een AccessibilityValidator‑instantie wordt gemaakt voor een specifieke regel met de volledige parameters van het ValidationBuilder.All‑object"
type: docs

url: /nl/java/com.aspose.html.accessibility/webaccessibility/createvalidator/
---
## CreateValidator(IRule) {#createvalidator_1}

Een AccessibilityValidator instance wordt gecreëerd voor een specifieke regel, gegeven de volledige parameters van het ValidationBuilder.All‑object.
...
| --- | --- | --- |
| regel | IRule | object van regel dat de IRule‑interface implementeert |
...
Maak AccessibilityValidator instantie
...
| --- | --- | --- |
| regel | IRule | object van regel dat de IRule‑interface implementeert |
| bouwer | ValidationBuilder | object ValidationBuilder |
...
| --- | --- | --- |
| regel | IRule | object van regel dat de IRule‑interface implementeert |
| bouwer | Action`1 | methode die een ValidationBuilder‑object retourneert |
...
Een AccessibilityValidator instance wordt gecreëerd volgens alle regels met een ValidationBuilder.All object.
...
Een AccessibilityValidator instance wordt gecreëerd voor een specifieke regels‑lijst.
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| regels | IList`1 | lijst van regels |
