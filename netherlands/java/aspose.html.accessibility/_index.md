...
---
Het **com.aspose.html.accessibility**-pakket is bedoeld voor alle webtoegankelijkheidsgerelateerde bewerkingen. Het voldoet aan de internationale normen van de W3C Web Accessibility Initiative.
...
| [AccessibilityValidator](./accessibilityvalidator/) | De validator-klasse behandelt snelle referentieregels. Bevat een Validate-methode om toegankelijkheid te controleren. |
| [Criterion](./criterion/) | Verifieerbare succescriteria worden geleverd voor elke aanbeveling, zodat WCAG 2.0 kan worden toegepast in gebieden waar compliance-testen vereist zijn. https://www.w3.org/WAI/WCAG21/Understanding/understanding-techniques |
...
| [Rule](./rule/) | Een abstracte klasse die de kenmerken van een regel definieert en de interface IRule implementeert. |
...
| [WebAccessibility](./webaccessibility/) | Object naar de Web Content Accessibility Guidelines (WCAG) 2-vereisten (succescriteria) en technieken. https://www.w3.org/WAI/WCAG21/quickref/ |
## Interfaces
