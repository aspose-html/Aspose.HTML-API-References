...
description: "Converter‑methode. Converteer MHTML-bron gepresenteerd door een invoerstroom. Het resultaat is een XPS‑bestand dat wordt aangemaakt op het opgegeven uitvoerpad."
type: docs
...
Converteer MHTML-bron die wordt gepresenteerd via invoer [stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream?view=net-5.0). Resultaat is een xps-bestand dat is gevormd door het uitvoerbestandspad.
...
| --- | --- | --- |
| stroom | Stream | Invoergegevensstroom voor mhtml (.mht). |
| options | XpsSaveOptions | Gebruik van het [`XpsSaveOptions`](../../../com.aspose.html.saving/xpssaveoptions/) object stelt u in staat het renderproces af te stemmen. Voor meer informatie zie [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/mhtml-to-xps/#save-options). |
...
MHTML naar [XPS](https://docs.fileformat.com/page-description-language/xps/) conversie is vaak nodig om gebruik te maken van het XPS‑formaat voor specifieke taken. Een XPS‑bestand vertegenwoordigt paginalay-outbestanden die gebaseerd zijn op XML Paper Specifications, gemaakt door Microsoft.
...
Conversiebron. Detecteer een bestaand lokaal MHTML‑bestand (.mht) of een externe [`Url`](../../../com.aspose.html/url/) als conversiebron. U kunt ook een standaard of aangepaste specifieke stream gebruiken als conversiebron. Conversieresultaat. Definieer het uitvoerpad voor het resultaat of gebruik een bekende of aangepaste implementatie van de interface [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) als uitvoer‑databuffer. Maak een nieuw [`XpsSaveOptions`](../../../com.aspose.html.saving/xpssaveoptions/) object aan met specifieke of standaardinstellingen. U kunt ook [`configuration`](../../../com.aspose.html/configuration/) toevoegen als optionele parameter. Gebruik de ConvertMHTML()-methode van de Converter‑klasse om MHTML op te slaan als een XPS‑resultaat met drie of meer parameters, afhankelijk van het gebruiksscenario. Online MHTML‑converter
...
Converteer MHTML-bron die wordt gepresenteerd via volledig bestandspad naar XPS. Resultaat is een xps-bestand dat is gevormd door het uitvoerbestandspad.
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| sourcePath | String | Volledig bestandspad van MHTML-bron. |
| options | XpsSaveOptions | Gebruik van het [`XpsSaveOptions`](../../../com.aspose.html.saving/xpssaveoptions/) object stelt u in staat het renderproces af te stemmen. Voor meer informatie zie [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/mhtml-to-xps/#save-options). |
| outputPath | String | Volledig xps‑bestandspad als uitvoerconversieresultaat. |
...
Converteer MHTML-bron die wordt gepresenteerd via URL. Resultaat is een xps-bestand dat is gevormd door het uitvoerbestandspad.
...
Converteer MHTML-bron die wordt gepresenteerd via invoer-[stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream?view=net-6.0). Resultaat is een xps-bestand dat is gevormd door het uitvoerbestandspad.
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| stroom | Stream | Conversiebron mhtml (.mht) gegevensstroom. |
...
Converteer MHTML-bron gepresenteerd via invoerstroom. Het resultaat is uitvoergegevens gevormd door de implementatie van de [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) interface.
...
Converteer MHTML-bron gepresenteerd via volledig bestandspad naar XPS. Het resultaat is uitvoergegevens gevormd door de implementatie van de [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) interface.
...
Converteer MHTML-bron gepresenteerd via [`URL`](../../../com.aspose.html/url/). Het resultaat is uitvoergegevens gevormd door de implementatie van de [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) interface.
...
Converteer MHTML-bron gepresenteerd via URL. Het resultaat is uitvoergegevens gevormd door de implementatie van de [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) interface.
...
Converteer MHTML-bron die wordt gepresenteerd via invoerstroom. Resultaat is een docx-bestand dat is gevormd door het uitvoerbestandspad.
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| stroom | Stream | MHTML-conversie invoergegevensstroom. |
| options | DocSaveOptions | `DocSaveOptions`-objectgebruik stelt u in staat het renderproces af te stemmen. Voor meer info zie [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/mhtml-to-docx/#save-options). |
...
Conversiebron. Detecteer een bestaand lokaal MHTML‑bestand (.mht) of een externe [`Url`](../../../com.aspose.html/url/) als conversiebron. U kunt ook een standaard of aangepaste specifieke stream gebruiken als conversiebron. Conversieresultaat. Definieer het uitvoerbestandspad of gebruik een bekende of aangepaste implementatie van de [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) interface als uitvoergegevensbuffer. Maak een nieuw [`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/)‑object met specifieke of standaardinstellingen. U kunt ook [`configuration`](../../../com.aspose.html/configuration/) toevoegen als optionele parameter. Gebruik de ConvertMHTML()-methode van de Converter‑klasse om MHTML op te slaan als een DOCX‑resultaat met drie of meer parameters, afhankelijk van het gebruikersscenario. Online MHTML‑converter

Aspose.HTML biedt een gratis online [MHTML to DOCX Converter](https://products.aspose.app/html/en/conversion/mhtml-to-docx) die MHTML naar DOCX converteert met hoge kwaliteit, eenvoudig en snel. Upload gewoon, converteer uw bestanden en ontvang resultaten binnen enkele seconden!
...
Converteer MHTML-bron die wordt gepresenteerd via volledig bestandspad naar DOCX. Resultaat is een docx-bestand dat is gevormd door het uitvoerbestandspad.
...
Converteer MHTML-bron die wordt gepresenteerd via URL. Resultaat is een docx-bestand dat is gevormd door het uitvoerbestandspad.
...
Converteer MHTML-bron gepresenteerd via volledig bestandspad naar DOCX. Het resultaat is uitvoergegevens gevormd door de implementatie van de [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) interface.
...
Converteer MHTML-bron die wordt gepresenteerd via invoerstroom. Resultaat is een pdf-bestand dat is gevormd door het uitvoerbestandspad.
...
| --- | --- | --- |
| stroom | Stream | MHTML-conversie invoergegevensstroom. |
| options | PdfSaveOptions | `PdfSaveOptions`-objectgebruik stelt u in staat het renderproces af te stemmen. Voor meer info zie [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/mhtml-to-pdf/#save-options). |
...
Conversie van MHTML naar PDF is vaak vereist om te profiteren van het [PDF](https://docs.fileformat.com/pdf/)‑formaat voor specifieke taken. PDF biedt veel voordelen die andere bestanden niet hebben. Bijvoorbeeld, veel programma’s en apps ondersteunen PDF‑documenten; PDF‑bestanden zijn geoptimaliseerd voor afdrukken en zijn ideaal voor het maken van fysieke kopieën van uw documenten; u kunt de beveiligingsinstellingen voor PDF‑bestanden configureren – afdrukken, bewerken, een elektronische handtekening gebruiken, enzovoort.

Zie [article](https://docs.aspose.com/html/net/converting-between-formats/mhtml-to-pdf/), waar u informatie vindt over hoe u MHTML naar PDF kunt converteren met de ConvertMHTML()-methoden van de [`Converter`](../)‑klasse en hoe u de parameters [`PdfSaveOptions`](../../../com.aspose.html.saving/pdfsaveoptions/) en [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) kunt toepassen.

Converteer MHTML naar PDF

De Converter-klasse biedt enkele MHTML-specifieke conversies naar PDF. Om MHTML naar PDF te converteren, moet u een van de eenvoudige scenario's volgen die uit enkele stappen bestaan:

Conversiebron. Detecteer een bestaand lokaal MHTML (.mht)-bestand of een externe Url als conversiebron. U kunt ook een standaard of aangepaste specifieke [stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream?view=net-6.0) als bron gebruiken. Conversieresultaat. Definieer het uitvoerpad van het resultaatbestand of gebruik een bekende of aangepaste [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) interface-implementatie als uitvoergegevensbuffer. Maak een nieuw [`PdfSaveOptions`](../../../com.aspose.html.saving/pdfsaveoptions/) object met specifieke of standaardinstellingen. U kunt ook [`configuration`](../../../com.aspose.html/configuration/) als optionele parameter toevoegen. Gebruik de ConvertMHTML()‑methode van de Converter‑klasse om MHTML op te slaan als een PDF‑resultaat met drie of meer parameters, afhankelijk van het gebruikersscenario. Online MHTML-converter

Aspose.HTML biedt een gratis online [MHTML naar PDF Converter](https://products.aspose.app/html/en/conversion/mhtml-to-pdf) die MHTML naar PDF converteert met hoge kwaliteit, eenvoudig en snel. Upload gewoon, converteer uw bestanden en ontvang de resultaten binnen enkele seconden!
...
Converteer MHTML-bron die wordt gepresenteerd via volledig bestandspad naar PDF. Resultaat is een pdf-bestand dat is gevormd door het uitvoerbestandspad.
...
Conversiebron. Detecteer een bestaand lokaal MHTML (.mht)-bestand of een externe Url als conversiebron. U kunt ook een standaard of aangepaste specifieke [stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream?view=net-6.0) als bron gebruiken. Conversieresultaat. Definieer het uitvoerpad van het resultaatbestand of gebruik een bekende of aangepaste [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) interface-implementatie als uitvoergegevensbuffer. Maak een nieuw [`PdfSaveOptions`](../../../com.aspose.html.saving/pdfsaveoptions/) object met specifieke of standaardinstellingen. U kunt ook configuratie als optionele parameter toevoegen. Gebruik de ConvertMHTML()‑methode van de Converter‑klasse om MHTML op te slaan als een PDF‑resultaat met drie of meer parameters, afhankelijk van het gebruikersscenario. Online MHTML-converter
...
Converteer MHTML-bron die wordt gepresenteerd via URL. Resultaat is een pdf-bestand dat is gevormd door het uitvoerbestandspad.
...
Converteer MHTML-bron die wordt opgegeven via het volledige bestandspad naar PDF. Het resultaat is uitvoergegevens gevormd door de [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) interface-implementatie.
...
Converteer MHTML-bron die wordt gepresenteerd via invoerstroom naar afbeelding. Resultaat is een afbeeldingsbestand dat is gevormd door het uitvoerbestandspad.
...
Bestanden met de [MHTML](https://docs.fileformat.com/web/mhtml/) extensie vertegenwoordigen een webpagina-archiefformaat dat door verschillende applicaties kan worden aangemaakt. Het formaat staat bekend als archiefformaat omdat het de web‑HTML‑code en bijbehorende bronnen in één bestand opslaat. Deze bronnen omvatten alles wat aan de webpagina is gekoppeld, zoals afbeeldingen, applets, animaties, audiobestanden enzovoort. MHTML‑bestanden kunnen worden geopend in diverse applicaties zoals Internet Explorer en Microsoft Word. De feitelijke specificaties van het formaat worden gedetailleerd beschreven in [RFC 2557](https://datatracker.ietf.org/doc/html/rfc2557).

Verwijs naar het artikel, waar u informatie vindt over hoe u MHTML naar afbeeldingen in verschillende formaten kunt converteren met behulp van de ConvertMHTML()-methoden van de Converter‑klasse en hoe u de parameters [`ImageSaveOptions`](../../../com.aspose.html.saving/imagesaveoptions/) en [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) kunt toepassen.

Converteer MHTML naar afbeelding

De Converter‑klasse biedt enkele MHTML‑specifieke conversies naar afbeeldingen. Ondersteunde formaten zijn [JPEG](https://docs.fileformat.com/image/jpeg/), [PNG](https://docs.fileformat.com/image/png/), [BMP](https://docs.fileformat.com/image/bmp/), [GIF](https://docs.fileformat.com/image/gif/) en [TIFF](https://docs.fileformat.com/image/tiff/). Om MHTML naar een afbeelding te converteren, moet u een van de eenvoudige scenario's volgen die uit enkele stappen bestaan:

Conversiebron. Detecteer een bestaand lokaal MHTML (.mht)-bestand of een externe [`Url`](../../../com.aspose.html/url/) als conversiebron. U kunt ook een standaard of aangepaste specifieke stream als bron gebruiken. Conversieresultaat. Definieer het uitvoerpad van het resultaatbestand of gebruik een bekende of aangepaste [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) interface‑implementatie als uitvoergegevensbuffer. Maak een nieuw [`ImageSaveOptions`](../../../com.aspose.html.saving/imagesaveoptions/) object met specifieke of standaardinstellingen. Het standaardafbeeldingsformaat is PNG. U kunt ook configuratie als optionele parameter toevoegen. Gebruik de ConvertMHTML()‑methode van de Converter‑klasse om MHTML op te slaan als een afbeeldingsresultaat met drie of meer parameters, afhankelijk van het gebruikersscenario. Online MHTML-converter

Aspose.HTML biedt een gratis online [MHTML naar JPEG Converter](https://products.aspose.app/html/en/conversion/mhtml-to-jpg) die MHTML naar een JPEG‑bestand converteert met hoge kwaliteit, eenvoudig en snel. Upload gewoon, converteer uw bestanden en ontvang de resultaten binnen enkele seconden!
...
Converteer MHTML-bron die wordt gepresenteerd via volledig bestandspad. Resultaat is een afbeeldingsbestand dat is gevormd door het uitvoerbestandspad.
...
Converteer MHTML-bron die wordt gepresenteerd via URL. Resultaat is een afbeeldingsbestand dat is gevormd door het uitvoerbestandspad.
...
Converteer MHTML-bron die wordt opgegeven via het volledige bestandspad naar een afbeelding. Het resultaat is uitvoergegevens gevormd door de [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) interface‑implementatie.
