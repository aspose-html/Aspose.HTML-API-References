...
| --- | --- | --- |
| stroom | Stroom | MD (Markdown) conversie-invoergegevensstroom. |
...
Je bent misschien ook geïnteresseerd in een gratis online [MD to HTML Converter](https://products.aspose.app/html/en/conversion/md-to-html) die MD naar HTML converteert met hoge kwaliteit, eenvoudig en snel. Upload gewoon, converteer je bestanden en krijg resultaten binnen enkele seconden! Je kunt ook andere online MD-converters bekijken: [MD to PDF](https://products.aspose.app/html/en/conversion/md-to-pdf), [MD to DOCX](https://products.aspose.app/html/en/conversion/md-to-docx), [MD to XPS](https://products.aspose.app/html/en/conversion/md-to-xps) en geschikte [MD to image converters](https://docs.aspose.com/html/net/converting-between-formats/markdown-to-image/) vinden.
...
Converteer MD (markdown)-bron gepresenteerd via invoerstroom naar html. Resultaat is html-bestand gemaakt via het uitvoerbestandspad.
...
Converteer MD (markdown)-bron gepresenteerd via volledig bestandspad naar html. Resultaat is html-bestand gemaakt via het uitvoerbestandspad.
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| sourcePath | String | Pad naar bron Markdown-bestand. Het wordt gecombineerd met het huidige mappad om een absolute URL te vormen. |
| outputPath | String | Volledig HTML-bestandspad als uitvoerconversieresultaat. |
