...
description: "Converter‑methode. Converteer EPUB‑bron, gepresenteerd via een gegevens‑invoerstroom. Het resultaat is een bestand gevormd door het uitvoerpad."
type: docs
...
Converteer EPUB‑bron opgegeven via gegevens‑invoerstroom. Resultaat is een bestand gevormd door het uitvoer‑bestandspad.
...
| --- | --- | --- |
| stroom | Stroom | Invoerstroom als conversiebron. |
| options | ImageSaveOptions | Nieuw gevormde afbeeldingsopties zoals formaat, resolutie enzovoort. Zie de klasse [`ImageSaveOptions`](../../../com.aspose.html.saving/imagesaveoptions/) en de [Aspose Documentatie](https://docs.aspose.com/html/net/converting-between-formats/epub-to-png/#save-options). |
...
EPUB is een e‑book bestandsformaat dat een standaard digitaal publicatieformaat biedt. Het werd gecreëerd door de International Digital Publishing Forum (IDPF) en wordt nu ondersteund door veel e‑readers en softwaretoepassingen.

Het converteren van EPUB‑bestanden naar het PNG‑formaat kan handig zijn als je bestanden in een PowerPoint‑presentatie wilt opnemen of per e‑mail wilt versturen. Converteer ze alstublieft naar het afbeeldingsformaat en gebruik ze zoals je wilt! Je kunt extra conversie‑parameters gebruiken om het gewenste resultaat te verkrijgen.

Het belangrijkste kenmerk van Aspose.HTML is de conversiefunctie. EPUB is een open op XML gebaseerd formaat voor digitale boeken en publicaties, dat kan worden bekeken en gelezen op smartphones, tablets en computers. Het pakket com.aspose.html.converters biedt gemakkelijke toegang tot conversiemethoden. Het levert een breed scala aan [EPUB](https://docs.fileformat.com/ebook/epub/) conversies naar populaire formaten, zoals [PDF](https://docs.fileformat.com/pdf/), [XPS](https://docs.fileformat.com/page-description-language/xps/), [DOCX](https://docs.fileformat.com/word-processing/docx/), [JPEG](https://docs.fileformat.com/image/jpeg/), [PNG](https://docs.fileformat.com/image/png/), [BMP](https://docs.fileformat.com/image/bmp/), [TIFF](https://docs.fileformat.com/image/tiff/), en [GIF](https://docs.fileformat.com/image/gif/).

Deze sectie biedt informatie over de lijst met ondersteunde EPUB-conversiescenario's en hoe je ze kunt uitvoeren met behulp van een Converter‑klasse die alle low‑level conversie‑operaties in één klasse groepeert om ze comfortabel en eenvoudig te gebruiken. In de EPUB‑Converter‑gids vind je de volgende artikelen:
...
Om EPUB naar een afbeeldingsformaat te converteren, moet je een paar stappen volgen:

Definieer de Url op basis van het bestaande EPUB‑bestand op het opgegeven pad. Definieer het uitvoer‑bestandspad. Maak een nieuw [`ImageSaveOptions`](../../../com.aspose.html.saving/imagesaveoptions/) object aan met het vereiste ImageFormat. Standaard is de eigenschap Format PNG. Gebruik de ConvertEPUB()‑methode van de Converter‑klasse om EPUB als een afbeelding op te slaan. Je moet ook ImageSaveOptions en het Configuration‑object doorgeven aan de afbeeldingconversie. Online EPUB‑converters

Aspose.HTML biedt een gratis online [EPUB naar PNG](https://products.aspose.app/html/en/conversion/epub-to-png) converter die EPUB naar een PNG‑afbeelding converteert met hoge kwaliteit, eenvoudig en snel. Upload gewoon, converteer je bestanden en krijg resultaten binnen enkele seconden!
...
Converteer EPUB-bron gepresenteerd door volledig bestandspad. Resultaat is afbeeldingsbestand gevormd door uitvoerbestandspad. Afbeeldingsformaat wordt gespecificeerd door ImageSaveOptions-object.
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| sourcePath | String | Pad van het EPUB‑bronbestand als invoerparameter. |
...
// Stel het uitvoer‑resultaatbestandspad samen
var resultPath = Path.Combine(OutputFolder, "sample.png"); 
...
| options | ImageSaveOptions | Het gebruik van het ImageSaveOptions‑object stelt je in staat het renderproces af te stemmen. Je kunt de [`page size`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/), [`margins`](../../../com.aspose.html.drawing/page/margin/), [`CSS media-type`](../../../com.aspose.html.rendering/mediatype/) enz. specificeren. Zie de [`ImageSaveOptions `](../../../com.aspose.html.saving/imagesaveoptions/)klasse. |
| outputPath | String | Volledig afbeeldingsbestandspad als uitvoerconversieresultaat. |
...
Converteer EPUB-bron gepresenteerd door gegevensinvoerstroom. Resultaat is afbeeldingsbestand gevormd door uitvoerbestandspad. Afbeeldingsformaat wordt gespecificeerd door ImageSaveOptions-object.
...
| --- | --- | --- |
| sourcePath | String | Pad van het EPUB‑bronbestand als invoerparameter. |
| configuration | Configuration | De omgevingsconfiguratie. Vertegenwoordigt het [configuration](https://apireference.aspose.com/html/net/aspose.html/configuration) contextobject dat wordt gebruikt om de omgevingsinstellingen voor de applicatie in te stellen. |
| options | ImageSaveOptions | Het gebruik van het ImageSaveOptions‑object stelt je in staat het renderproces af te stemmen. Je kunt de [`page size`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/), [`margins`](../../../com.aspose.html.drawing/page/margin/), [`CSS media-type`](../../../com.aspose.html.rendering/mediatype/) enz. specificeren. Zie de [`ImageSaveOptions `](../../../com.aspose.html.saving/imagesaveoptions/)klasse. |
| outputPath | String | Volledig afbeeldingsbestandspad als uitvoerconversieresultaat. |
...
| sourceUrl | Url | EPUB‑bron‑URL – biedt een objectrepresentatie van een universele identifier (URL). |
| configuration | Configuration | De omgevingsconfiguratie. Vertegenwoordigt het [`configuration`](../../../com.aspose.html/configuration/) contextobject dat wordt gebruikt om de omgevingsinstellingen voor de toepassing in te stellen. |
| options | ImageSaveOptions | Het gebruik van het ImageSaveOptions‑object stelt je in staat het renderproces af te stemmen. Je kunt de [page size](https://apireference.aspose.com/html/net/aspose.html.rendering/renderingoptions/properties/pagesetup), [margins](https://apireference.aspose.com/html/net/aspose.html.drawing/page/properties/margin) en [CSS media-type](https://apireference.aspose.com/html/net/aspose.html.rendering/mediatype) specificeren, enz. Zie de [ImageSaveOptions ](https://apireference.aspose.com/html/net/aspose.html.saving/imagesaveoptions)klasse. |
| outputPath | String | Volledig afbeeldingsbestandspad als uitvoerconversieresultaat. |
...
Open een bestaand EPUB‑bestand. In het voorbeeld gebruiken we de OpenRead()‑methode van de System.IO.FileStream‑klasse om een EPUB‑bestand te openen en te lezen vanuit het bestandssysteem op het opgegeven pad. Gebruik een bekende of aangepaste implementatie van de [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) interface als uitvoer‑databuffer. Maak een nieuw [`ImageSaveOptions`](../../../com.aspose.html.saving/imagesaveoptions/) object aan met het vereiste ImageFormat. Standaard is de eigenschap Format PNG. Gebruik de ConvertEPUB()‑methode van de Converter‑klasse om EPUB als een afbeelding op te slaan. Je moet de EPUB‑inputStream, ImageSaveOptions en de uitvoer‑stream doorgeven aan de ConvertEPUB()‑methode voor EPUB‑naar‑afbeeldingconversie. Online EPUB‑converters
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| sourcePath | String | Pad van het EPUB‑bronbestand. Het wordt gecombineerd met het huidige mappad om een absolute URL te vormen. |
| options | ImageSaveOptions | Nieuw gevormde afbeeldingsopties zoals formaat, resolutie enzovoort. Zie de klasse [`ImageSaveOptions`](../../../com.aspose.html.saving/imagesaveoptions/) en de [Aspose Documentatie](https://docs.aspose.com/html/net/converting-between-formats/epub-to-png/#save-options). |
| provider | ICreateStreamProvider | Implementatie van de interface, die wordt gebruikt om een uitvoer‑stream te verkrijgen. Meer informatie over providers vind je in de [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-jpg/#output-stream-providers). |
...
Open een bestaand EPUB‑bestand. In het voorbeeld gebruiken we de OpenRead()‑methode van de System.IO.FileStream‑klasse om een EPUB‑bestand te openen en te lezen vanuit het bestandssysteem op het opgegeven pad. Gebruik een bekende of aangepaste ICreateStreamProvider‑interface‑implementatie als uitvoer‑databuffer. Maak een nieuw ImageSaveOptions‑object aan met het vereiste ImageFormat. Standaard is de eigenschap Format PNG. Gebruik de ConvertEPUB()‑methode van de Converter‑klasse om EPUB als een afbeelding op te slaan. Je moet de EPUB‑inputStream, ImageSaveOptions en de uitvoer‑stream doorgeven aan de ConvertEPUB()‑methode voor EPUB‑naar‑afbeeldingconversie. Online EPUB‑converters
...
// Roep de ConvertEPUB-methode aan om de EPUB-code naar een JPG-afbeelding te converteren.
...
Converteer de EPUB-bron die via URL wordt gepresenteerd naar een afbeelding. Het resultaat is een afbeeldingsbestand dat wordt gevormd door de implementatie van de [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) interface.
...
| configuration | Configuration | De omgevingsconfiguratie. Vertegenwoordigt het [`configuration`](../../../com.aspose.html/configuration/) contextobject dat wordt gebruikt om de omgevingsinstellingen voor de toepassing in te stellen. |
| options | ImageSaveOptions | Het gebruik van het ImageSaveOptions‑object stelt u in staat het renderproces af te stemmen. U kunt de [`page size`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/), [`margins`](../../../com.aspose.html.drawing/page/margin/), [`CSS media-type`](../../../com.aspose.html.rendering/mediatype/), enz. specificeren. |
| provider | ICreateStreamProvider | Implementatie van de interface, die wordt gebruikt om een uitvoerstroom te verkrijgen. |
...
| configuration | Configuration | De omgevingsconfiguratie. Vertegenwoordigt het [`configuration`](../../../com.aspose.html/configuration/) contextobject dat wordt gebruikt om de omgevingsinstellingen voor de toepassing in te stellen. |
| options | ImageSaveOptions | Het gebruik van het ImageSaveOptions‑object stelt u in staat het renderproces af te stemmen. U kunt de [`page size`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/), [`margins`](../../../com.aspose.html.drawing/page/margin/), [`CSS media-type`](../../../com.aspose.html.rendering/mediatype/), enz. specificeren. |
| provider | ICreateStreamProvider | Implementatie van de interface, die wordt gebruikt om een uitvoerstroom te verkrijgen. Zie het voorbeeld van de ICreateStreamProvider-implementatie in de [Aspose-documentatie](https://docs.aspose.com/html/net/converting-between-formats/epub-to-jpg/#output-stream-providers). |
...
Converteer epub-bron gepresenteerd via URL naar afbeelding. Resultaat is een afbeeldingsbestand gevormd door implementatie van [ICreateStreamProvider](https://apireference.aspose.com/html/net/aspose.html.io/icreatestreamprovider) interface.
...
import com.aspose.html.converters;
...
// Stel de bron‑URL samen via het invoer‑bestandspad.
var sourceUrl = new Url(Path.Combine(InputFolder, "sample.epub"));
...
Converteer epub-bron gepresenteerd door invoerstroom naar xps. Resultaat is xps-bestand gedefinieerd door volledig pad.
...
| options | XpsSaveOptions | Conversie‑opties. Het gebruik van het [`XpsSaveOptions `](../../../com.aspose.html.saving/xpssaveoptions/)‑object stelt u in staat het renderproces af te stemmen; u kunt de paginagrootte, marges, CSS, enz. specificeren. |
...
Een XPS‑bestand vertegenwoordigt paginalay‑outbestanden die gebaseerd zijn op XML Paper Specifications, gemaakt door Microsoft. Het is ontwikkeld als vervanging van het EMF‑bestandformaat en is vergelijkbaar met het PDF‑bestandformaat, maar gebruikt XML voor de lay‑out, weergave en afdrukinformatie van een document.

Het belangrijkste kenmerk van Aspose.HTML is de conversiefunctie. EPUB is een open op XML gebaseerd formaat voor digitale boeken en publicaties, dat kan worden bekeken en gelezen op smartphones, tablets en computers. Het pakket com.aspose.html.converters biedt gemakkelijke toegang tot conversiemethoden. Het levert een breed scala aan [EPUB](https://docs.fileformat.com/ebook/epub/) conversies naar populaire formaten, zoals [PDF](https://docs.fileformat.com/pdf/), [XPS](https://docs.fileformat.com/page-description-language/xps/), [DOCX](https://docs.fileformat.com/word-processing/docx/), [JPEG](https://docs.fileformat.com/image/jpeg/), [PNG](https://docs.fileformat.com/image/png/), [BMP](https://docs.fileformat.com/image/bmp/), [TIFF](https://docs.fileformat.com/image/tiff/), en [GIF](https://docs.fileformat.com/image/gif/).

Deze sectie biedt informatie over de lijst met ondersteunde EPUB-conversiescenario's en hoe u deze kunt uitvoeren met behulp van een [`Converter`](../)‑klasse die alle low‑level conversie‑bewerkingen in één klasse groepeert om ze comfortabel en eenvoudig te gebruiken. In de specifieke gids voor EPUB‑Converter XPS vindt u het volgende artikel:
...
Om EPUB naar het XPS‑bestandformaat te converteren, moet u een paar stappen volgen:

Open een bestaand EPUB‑bestand. Als voorbeeld kunnen we het bron‑bestandspad definiëren als de eerste parameter van de ConvertEPUB‑methode. Gebruik een bekende of aangepaste ICreateStreamProvider‑interface‑implementatie als uitvoer‑databuffer. We kunnen een eenvoudigere alternatieve aanpak gebruiken als het resultaat‑uitvoerbestandspad. Maak een nieuw XpsSaveOptions‑object aan met een aantal gewenste parameters zoals paginagrootte, marges, CSS, enz. Het is mogelijk om de standaardinstantie van de XpsSaveOptions‑klasse te gebruiken. Gebruik de ConvertEPUB()‑methode van de statische Converter‑klasse om EPUB op te slaan als een xps‑bestand. U moet de EPUB‑brondatum, XpsSaveOptions en de uitvoer‑databuffer in welke vorm dan ook doorgeven om het conversieproces te starten. Online EPUB‑naar‑XPS‑converter

Aspose.HTML biedt een gratis online [EPUB naar XPS](https://products.aspose.app/html/en/conversion/epub-to-xps)‑converter die EPUB naar een XPS‑bestand converteert met hoge kwaliteit, eenvoudig en snel. Upload gewoon, converteer uw bestanden en ontvang resultaten binnen enkele seconden!
...
Converteer epub-bron gepresenteerd door invoer EPUB-bestandspad naar xps. Resultaat is xps-bestand gedefinieerd door volledig pad.
...
| --- | --- | --- |
| sourcePath | String | Pad van het EPUB‑bronbestand. Het wordt gecombineerd met het huidige mappad om een absolute URL te vormen. |
| options | XpsSaveOptions | Conversie‑opties. Het gebruik van het [`XpsSaveOptions `](../../../com.aspose.html.saving/xpssaveoptions/)‑object stelt u in staat het renderproces af te stemmen; u kunt de [`paginagrootte`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/), de [`marges`](../../../com.aspose.html.drawing/page/margin/), het [`CSS‑mediatype`](../../../com.aspose.html.rendering/mediatype/), enz. specificeren. |
| outputPath | String | Volledig .xps‑bestandspad als uitvoer van de conversieresultaat. |
...
Open een bestaand EPUB‑bestand. Als voorbeeld kunnen we het bron‑bestandspad definiëren als de eerste parameter van de ConvertEPUB‑methode. Gebruik een bekende of aangepaste ICreateStreamProvider‑interface‑implementatie als uitvoer‑databuffer. We kunnen een eenvoudigere alternatieve aanpak gebruiken als het resultaat‑uitvoerbestandspad. Maak een nieuw XpsSaveOptions‑object aan met een aantal gewenste parameters zoals paginagrootte, marges, CSS, enz. Het is mogelijk om de standaardinstantie van de XpsSaveOptions‑klasse te gebruiken. Gebruik de ConvertEPUB()‑methode van de statische Converter‑klasse om EPUB op te slaan als een xps‑bestand. U moet de EPUB‑brondatum, [`XpsSaveOptions`](../../../com.aspose.html.saving/xpssaveoptions/), en de uitvoer‑databuffer in welke vorm dan ook doorgeven om het conversieproces te starten. Online EPUB‑naar‑XPS‑converter
...
Converteer epub-bron gepresenteerd door URL naar xps-bestand gedefinieerd door volledig pad. Zie [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-xps/).
...
Open een bestaand EPUB-bestand. Voor een voorbeeld kunnen we het bronbestandspad definiëren als eerste parameter van de ConvertEPUB-methode.Use bekende of aangepaste ICreateStreamProvider-interface-implementatie als uitvoer‑databuffer. We kunnen een eenvoudigere alternatieve gebruiken als resultaat‑uitvoerbestandspad.Create een nieuw XpsSaveOptions-object met een aantal voorkeursparameters zoals paginagrootte, marges, CSS enzovoort. Het is mogelijk om de standaardinstantie van de XpsSaveOptions‑klasse te gebruiken.Use de ConvertEPUB()-methode van de statische Converter‑klasse om EPUB op te slaan als een xps‑bestand. U moet de EPUB-bron datum, XpsSaveOptions en de uitvoer‑databuffer in welke vorm dan ook doorgeven om het conversieproces te starten.
...
Converteer epub-bron gepresenteerd door invoer [Stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream?view=net-5.0) naar xps. Resultaat is xps-bestand gedefinieerd door volledig pad.
...
Open een bestaand EPUB-bestand. Voor een voorbeeld kunnen we het bronbestandspad definiëren als eerste parameter van de ConvertEPUB-methode.Use bekende of aangepaste ICreateStreamProvider-interface-implementatie als uitvoer‑databuffer. We kunnen een eenvoudigere alternatieve gebruiken als resultaat‑uitvoerbestandspad.Create een nieuw XpsSaveOptions-object met een aantal voorkeursparameters zoals paginagrootte, marges, CSS enzovoort. Het is mogelijk om de standaardinstantie van de XpsSaveOptions‑klasse te gebruiken.Use de ConvertEPUB()-methode van de statische Converter‑klasse om EPUB op te slaan als een xps‑bestand. U moet de EPUB-bron datum, XpsSaveOptions en de uitvoer‑databuffer in welke vorm dan ook doorgeven om het conversieproces te starten. U kunt configuratie gebruiken die het [`configuration`](../../../com.aspose.html/configuration/) contextobject vertegenwoordigt dat wordt gebruikt om de omgevingsinstellingen voor de toepassing in te stellen. Online EPUB naar XPS converter
...
| sourcePath | String | Pad van het EPUB‑bronbestand. Het wordt gecombineerd met het huidige mappad om een absolute URL te vormen. |
| configuration | Configuration | De omgevingsconfiguratie. Vertegenwoordigt het [configuration](https://apireference.aspose.com/html/net/aspose.html/configuration) contextobject dat wordt gebruikt om de omgevingsinstellingen voor de applicatie in te stellen. |
| options | XpsSaveOptions | Conversie‑opties. [XpsSaveOptions ](https://apireference.aspose.com/html/net/aspose.html.saving/xpssaveoptions)object gebruik stelt u in staat het renderproces af te stemmen; u kunt de paginagrootte, marges, CSS, enz. specificeren. |
| outputPath | String | Volledig .xps‑bestandspad als uitvoer van de conversieresultaat. |
...
Converteer de epub‑bron die wordt gepresenteerd door de invoer-[Stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream?view=net-5.0) naar xps. Het resultaat is xps‑uitvoerdata gedefinieerd door een bekende of aangepaste [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) interface‑implementatie.
...
| --- | --- | --- |
| stroom | Stroom | Invoerstroom als conversiebron. |
| options | XpsSaveOptions | Conversie‑opties. [`XpsSaveOptions `](../../../com.aspose.html.saving/xpssaveoptions/)object gebruik stelt u in staat het renderproces af te stemmen; u kunt de [`page size`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/), [`margins`](../../../com.aspose.html.drawing/page/margin/), [`CSS media-type`](../../../com.aspose.html.rendering/mediatype/), enz. specificeren. |
| provider | ICreateStreamProvider | Implementatie van de interface die wordt gebruikt om een uitvoerstroom te verkrijgen. Zie het ICreateStreamProvider‑implementatievoorbeeld in [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-xps/#output-stream-providers). |
...
...
 ...
 // Converteer EPUB naar XPS door de MemoryStreamProvider‑klasse te gebruiken
...
Converteer de epub‑bron die wordt gepresenteerd door het invoer‑EPUB‑bestandspad naar xps. Het resultaat is xps‑uitvoerdata gedefinieerd door een bekende of aangepaste [`ICreateStreamProvider `](../../../com.aspose.html.io/icreatestreamprovider/) interface‑implementatie.
...
| sourcePath | String | Pad van het EPUB‑bronbestand. Het wordt gecombineerd met het huidige mappad om een absolute URL te vormen. |
| options | XpsSaveOptions | Conversie‑opties. [XpsSaveOptions ](https://apireference.aspose.com/html/net/aspose.html.saving/xpssaveoptions)object gebruik stelt u in staat het renderproces af te stemmen; u kunt de paginagrootte, marges, CSS, enz. specificeren. |
| provider | ICreateStreamProvider | Implementatie van de interface die wordt gebruikt om een uitvoerstroom te verkrijgen. Zie een geavanceerd voorbeeld in [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-xps/#output-stream-providers). |
...
Converteer de epub‑bron die wordt gepresenteerd door een URL naar een xps‑bestand gedefinieerd door het volledige pad. Het resultaat is xps‑uitvoerdata gedefinieerd door een bekende of aangepaste [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) interface‑implementatie.
...
| --- | --- | --- |
| sourceUrl | Url | EPUB‑bron‑URL – biedt een objectrepresentatie van een universele identifier (URL). |
| options | XpsSaveOptions | Conversie‑opties. [`XpsSaveOptions `](../../../com.aspose.html.saving/xpssaveoptions/)object gebruik stelt u in staat het renderproces af te stemmen; u kunt de paginagrootte, marges, CSS, enz. specificeren. Zie [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-xps/#save-options). |
| provider | ICreateStreamProvider | Implementatie van de [`interface`](../../../com.aspose.html.io/icreatestreamprovider/) die wordt gebruikt om een uitvoerstroom te verkrijgen. Zie een geavanceerd voorbeeld in [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-xps/#output-stream-providers). |
...
Open een bestaand EPUB-bestand. Voor een voorbeeld kunnen we het bronbestandspad definiëren als eerste parameter van de ConvertEPUB-methode.Use bekende of aangepaste [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) interface-implementatie als uitvoer‑databuffer. We kunnen een eenvoudigere alternatieve gebruiken als resultaat‑uitvoerbestandspad.Create een nieuw XpsSaveOptions-object met een aantal voorkeursparameters zoals paginagrootte, marges, CSS enzovoort. Het is mogelijk om de standaardinstantie van de XpsSaveOptions‑klasse te gebruiken.Use de ConvertEPUB()-methode van de statische Converter‑klasse om EPUB op te slaan als een xps‑bestand. U moet de EPUB-bron datum, XpsSaveOptions en de uitvoer‑databuffer in welke vorm dan ook doorgeven om het conversieproces te starten.Online EPUB naar XPS converter
...
| configuration | Configuration | De omgevingsconfiguratie. Vertegenwoordigt het [`configuration`](../../../com.aspose.html/configuration/) contextobject dat wordt gebruikt om de omgevingsinstellingen voor de toepassing in te stellen. |
| options | XpsSaveOptions | Conversie‑opties. [`XpsSaveOptions `](../../../com.aspose.html.saving/xpssaveoptions/)object gebruik stelt u in staat het renderproces af te stemmen; u kunt de [`page size`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/), [`margins`](../../../com.aspose.html.drawing/page/margin/), [`CSS media-type`](../../../com.aspose.html.rendering/mediatype/), enz. specificeren. |
| provider | ICreateStreamProvider | Implementatie van [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) interface die wordt gebruikt om een uitvoerstroom te verkrijgen. Zie een geavanceerd voorbeeld in [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-xps/#output-stream-providers). |
...
Converteer EPUB‑bronbestand opgegeven via volledig pad naar DOCX. Resultaat is een docx‑bestand gedefinieerd door het volledige pad.
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| stream | Stream | Conversie‑bron gepresenteerd door invoer-[Stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream?view=net-5.0). |
| options | DocSaveOptions | Conversie-opties. [`DocSaveOptions `](../../../com.aspose.html.saving/docsaveoptions/)objectgebruik stelt u in staat het renderproces af te stemmen; u kunt de [`page size`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/), [`margins`](../../../com.aspose.html.drawing/page/margin/), [`CSS media-type`](../../../com.aspose.html.rendering/mediatype/), enz. Zie [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-docx/#save-options). |
| outputPath | String | Volledig .docx-bestandspad als uitvoerconversieresultaat. |

## Opmerkingen

Hoe EPUB naar DOCX converteren

DOCX is een bekend formaat voor Microsoft Word-documenten. Dit formaat is populair omdat het een breed scala aan opmaakfuncties ondersteunt en gebruikers verschillende opties biedt om elk type document te schrijven. DOCX-bestanden kunnen worden geopend met Word 2007 en latere versies, maar niet met de eerdere versies van MS Word, die DOC-bestandsextensies ondersteunen. Conversie van EPUB naar DOCX is vaak vereist om gebruik te maken van het DOCX-formaat voor specifieke gebruikers taken.

Het belangrijkste kenmerk van Aspose.HTML is de conversiefunctie. EPUB is een open op XML gebaseerd formaat voor digitale boeken en publicaties, dat kan worden bekeken en gelezen op smartphones, tablets en computers. Het pakket com.aspose.html.converters biedt gemakkelijke toegang tot conversiemethoden. Het levert een breed scala aan [EPUB](https://docs.fileformat.com/ebook/epub/) conversies naar populaire formaten, zoals [PDF](https://docs.fileformat.com/pdf/), [XPS](https://docs.fileformat.com/page-description-language/xps/), [DOCX](https://docs.fileformat.com/word-processing/docx/), [JPEG](https://docs.fileformat.com/image/jpeg/), [PNG](https://docs.fileformat.com/image/png/), [BMP](https://docs.fileformat.com/image/bmp/), [TIFF](https://docs.fileformat.com/image/tiff/), en [GIF](https://docs.fileformat.com/image/gif/).

Deze sectie biedt informatie over de lijst met ondersteunde EPUB-conversiescenario's en hoe u deze kunt uitvoeren met behulp van de [`Converter`](../)-klasse die alle low-level conversie‑operaties in één klasse groepeert om ze comfortabel en eenvoudig te gebruiken. In de EPUB Converter DOCX‑specifieke gids vindt u het volgende artikel:
...
Open een bestaand EPUB‑bestand. Als voorbeeld kunnen we het bronbestandspad definiëren als eerste parameter van de ConvertEPUB‑methode. Gebruik een bekende of aangepaste ICreateStreamProvider‑interface‑implementatie als uitvoer‑databuffer. We kunnen ook een eenvoudigere alternatieve uitvoer‑bestandspad gebruiken. Maak een nieuw DocSaveOptions‑object aan met een aantal gewenste parameters zoals paginagrootte, marges, CSS, enz. Het is mogelijk om de standaardinstantie van de DocSaveOptions‑klasse te gebruiken. Gebruik de ConvertEPUB()‑methode van de statische Converter‑klasse om EPUB op te slaan als een docx‑bestand. U moet de EPUB‑brondatum doorgeven als bestandspad of invoerstroom, evenals Url, DocSaveOptions‑instantie en uitvoer‑databuffer in welke vorm dan ook om het conversieproces te starten. U kunt een configuratie gebruiken die het [`configuration`](../../../com.aspose.html/configuration/)‑contextobject vertegenwoordigt dat wordt gebruikt om de omgevingsinstellingen voor de applicatie in te stellen. Online EPUB‑naar‑DOCX‑converter
...
Converteer EPUB-bron gepresenteerd door volledig bestandspad naar DOCX. Resultaat is docx-bestand gevormd door uitvoerbestandspad.
...
Converteer EPUB-bron gepresenteerd door URL. Resultaat is docx-bestand gevormd door uitvoerbestandspad.
...
Converteer EPUB-bron gepresenteerd door gegevensinvoerstroom. Resultaat is docx-bestand gevormd door uitvoerbestandspad.
...
// Bestandspad van conversieresultaatformulier
var resultPath = Path.Combine(OutputFolder, "sample.docx");
...
Converteer EPUB‑bron als invoerstroom naar DOCX. Resultaat is een docx‑bestand gevormd door een ICreateStreamProvider‑implementatie.
...
Converteer EPUB‑bron die wordt opgegeven via een volledig bestandspad naar DOCX. Het resultaat is uitvoergegevens gevormd door een [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/)‑implementatie.
...
Converteer EPUB-bron gepresenteerd door URL. Resultaat is uitvoergegevens gevormd door ICreateStreamProvider interface-implementatie.
...
Converteer EPUB-bron gepresenteerd door gegevensinvoerstroom. Resultaat is uitvoergegevens gevormd door ICreateStreamProvider interface-implementatie.
...
Converteer EPUB‑bron die wordt opgegeven via een volledig bestandspad naar DOCX. Het resultaat is uitvoergegevens gevormd door een [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/)‑interface‑implementatie.
...
Converteer EPUB‑bron die wordt opgegeven via een URL. Het resultaat is uitvoergegevens gevormd door een [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/)‑interface‑implementatie.
...
Converteer EPUB‑bron opgegeven via gegevens‑invoerstroom. Resultaat is een pdf‑bestand gevormd door het uitvoer‑bestandspad.
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| stroom | Stroom | Pad van het EPUB‑bronbestand als invoerparameter. |
...
Hoe EPUB naar PDF converteren

EPUB is een e‑book‑bestandformaat dat een standaard digitaal publicatieformaat biedt. Het is gemaakt door het International Digital Publishing Forum ([IDPF](http://idpf.org/)), en wordt nu ondersteund door veel e‑readers en softwaretoepassingen. Conversie van EPUB naar PDF is vaak vereist om gebruik te maken van het PDF‑formaat. Het PDF‑bestandformaat heeft volledige mogelijkheden om informatie te bevatten zoals tekst, afbeeldingen, hyperlinks, formulier‑velden, rich media, metadata, enz. PDF‑bestanden kunnen worden geopend in Adobe Acrobat Reader/Writer en de meeste moderne browsers zoals Chrome, Safari, Firefox. Ze zijn geoptimaliseerd voor afdrukken en zijn ideaal voor het maken van fysieke kopieën van uw documenten; u kunt ook de beveiligingsinstellingen voor PDF configureren.

Het belangrijkste kenmerk van Aspose.HTML is de conversiefunctie. EPUB is een open op XML gebaseerd formaat voor digitale boeken en publicaties, dat kan worden bekeken en gelezen op smartphones, tablets en computers. Het pakket com.aspose.html.converters biedt gemakkelijke toegang tot conversiemethoden. Het levert een breed scala aan [EPUB](https://docs.fileformat.com/ebook/epub/) conversies naar populaire formaten, zoals [PDF](https://docs.fileformat.com/pdf/), [XPS](https://docs.fileformat.com/page-description-language/xps/), [DOCX](https://docs.fileformat.com/word-processing/docx/), [JPEG](https://docs.fileformat.com/image/jpeg/), [PNG](https://docs.fileformat.com/image/png/), [BMP](https://docs.fileformat.com/image/bmp/), [TIFF](https://docs.fileformat.com/image/tiff/), en [GIF](https://docs.fileformat.com/image/gif/).

Deze sectie biedt informatie over de lijst met ondersteunde EPUB-conversiescenario's en hoe u ze kunt uitvoeren met behulp van een [`Converter`](../) klasse die alle low-level conversie‑operaties in één klasse groepeert om ze comfortabel en eenvoudig te gebruiken. In de specifieke gids voor EPUB Converter PDF vindt u het volgende artikel:
...
Om het EPUB‑formaat naar PDF te converteren, moet u een paar stappen volgen:

Open een bestaand EPUB‑bestand. Als voorbeeld kunnen we het bronbestandspad definiëren als eerste parameter van de ConvertEPUB‑methode. Als alternatief kunnen we een invoerstroom of Url‑objectinstantie gebruiken. Gebruik een bekende of aangepaste implementatie van de ICreateStreamProvider‑interface als uitvoergegevensbuffer. We kunnen ook een eenvoudigere alternatieve optie gebruiken, namelijk het resultaat‑uitvoerbestandspad. Maak een nieuw PdfSaveOptions‑object aan met een aantal gewenste parameters, zoals paginagrootte, marges, CSS enzovoort. Het is mogelijk de standaardinstantie van de PdfSaveOptions‑klasse te gebruiken. Gebruik de ConvertEPUB()‑methode van de statische Converter‑klasse om EPUB op te slaan als een pdf‑bestand. U moet de EPUB‑brondatum doorgeven als bestandspad of invoerstroom, evenals Url, een PdfSaveOptions‑instantie en de uitvoergegevensbuffer in welke vorm dan ook om het conversieproces te starten. U kunt de configuratie gebruiken die het [`configuration`](../../../com.aspose.html/configuration/) contextobject vertegenwoordigt en dat wordt gebruikt om de omgevingsinstellingen voor de applicatie in te stellen. Online EPUB‑naar‑PDF‑converter

Aspose.HTML biedt een gratis online [EPUB to PDF](https://products.aspose.app/html/en/conversion/epub-to-pdf) Converter die EPUB naar PDF converteert met hoge kwaliteit, eenvoudig en snel. Upload gewoon, converteer uw bestanden en krijg resultaten binnen enkele seconden!
...
// Formulier resultaatsbestandspad  
...
Converteer EPUB-bron gepresenteerd door volledig bestandspad naar PDF. Resultaat is pdf-bestand gevormd door uitvoerbestandspad.
...
Converteer EPUB-bron gepresenteerd door URL. Resultaat is pdf-bestand gevormd door uitvoerbestandspad.
...
| --- | --- | --- |
| sourceUrl | Url | EPUB‑bron‑URL – biedt een objectrepresentatie van een universele identifier (URL). |
| options | PdfSaveOptions | Het gebruik van [`PdfSaveOptions`](../../../com.aspose.html.saving/pdfsaveoptions/) stelt u in staat het renderproces af te stemmen; u kunt de [`page size`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/) , de [`margins`](../../../com.aspose.html.drawing/page/margin/) , de [`file permissions`](../../../com.aspose.html.rendering.pdf.encryption/pdfencryptioninfo/) , het [`CSS media-type`](../../../com.aspose.html.rendering/mediatype/) , enzovoort specificeren. Zie [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-pdf/#save-options). |
| outputPath | String | Volledig .pdf-bestandspad als uitvoerconversieresultaat. |
...
Converteer EPUB‑bron gepresenteerd via een gegevens‑invoerstroom. Het resultaat is uitvoergegevens gevormd door een implementatie van de [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) interface.
...
Converteer EPUB‑bron gepresenteerd via een volledig bestandspad naar PDF. Het resultaat is uitvoergegevens gevormd door een implementatie van de [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) interface.
...
| sourceUrl | Url | EPUB‑bron‑URL – biedt een objectrepresentatie van een universele identifier (URL). |
| options | PdfSaveOptions | Het gebruik van [`PdfSaveOptions`](../../../com.aspose.html.saving/pdfsaveoptions/) stelt u in staat het renderproces af te stemmen; u kunt de [`page size`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/) , de [`margins`](../../../com.aspose.html.drawing/page/margin/) , de [`file permissions`](../../../com.aspose.html.rendering.pdf.encryption/pdfencryptioninfo/) , het [`CSS media-type`](../../../com.aspose.html.rendering/mediatype/) , enzovoort specificeren. Zie [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-pdf/#save-options). |
| provider | ICreateStreamProvider | Implementatie van de [ICreateStreamProvider](https://apireference.aspose.com/svg/net/aspose.svg.io/icreatestreamprovider) interface, die wordt gebruikt om een uitvoerstroom te verkrijgen. Zie een geavanceerd voorbeeld in [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-pdf/#output-stream-providers). |
...
Het belangrijkste kenmerk van Aspose.HTML is de conversiefunctie. EPUB is een open op XML gebaseerd formaat voor digitale boeken en publicaties, dat kan worden bekeken en gelezen op smartphones, tablets en computers. Het [`com.aspose.html.converters`](../) pakket biedt gemakkelijke toegang tot conversiemethoden. Het biedt een breed scala aan [EPUB](https://docs.fileformat.com/ebook/epub/) conversies naar populaire formaten, zoals [PDF](https://docs.fileformat.com/pdf/), [XPS](https://docs.fileformat.com/page-description-language/xps/), [DOCX](https://docs.fileformat.com/word-processing/docx/), [JPEG](https://docs.fileformat.com/image/jpeg/), [PNG](https://docs.fileformat.com/image/png/), [BMP](https://docs.fileformat.com/image/bmp/), [TIFF](https://docs.fileformat.com/image/tiff/), en [GIF](https://docs.fileformat.com/image/gif/).
...
Converteer EPUB-bron gepresenteerd door volledig bestandspad naar PDF. Resultaat is uitvoergegevens gevormd door ICreateStreamProvider interface-implementatie.
...
| sourcePath | String | Pad van het EPUB‑bronbestand. Het wordt gecombineerd met het huidige mappad om een absolute URL te vormen. |
| configuration | Configuration | De omgevingsconfiguratie. Vertegenwoordigt het [configuration](https://apireference.aspose.com/html/net/aspose.html/configuration) contextobject dat wordt gebruikt om de omgevingsinstellingen voor de applicatie in te stellen. |
| options | PdfSaveOptions | Conversie‑opties. Het gebruik van het [PdfSaveOption](https://apireference.aspose.com/html/net/aspose.html.saving/pdfsaveoptions) object stelt u in staat het renderproces af te stemmen; u kunt de paginagrootte, marges, CSS, enzovoort specificeren. Zie [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-pdf/#save-options). |
| provider | ICreateStreamProvider | Implementatie van de [ICreateStreamProvider](https://apireference.aspose.com/svg/net/aspose.svg.io/icreatestreamprovider) interface, die wordt gebruikt om een uitvoerstroom te verkrijgen. Zie een geavanceerd voorbeeld in [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-pdf/#output-stream-providers). |
