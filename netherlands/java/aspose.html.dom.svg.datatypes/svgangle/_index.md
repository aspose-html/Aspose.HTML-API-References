...
| Naam | Beschrijving |
| --- | --- |
| [convertToSpecifiedUnits](../../com.aspose.html.dom.svg.datatypes/svgangle/converttospecifiedunits/)(ushort) | Behoud dezelfde onderliggende opgeslagen waarde, maar reset de opgeslagen eenheidsidentificator naar de opgegeven unitType. Objectattributen unitType, valueInSpecifiedUnits en valueAsString kunnen als gevolg van deze methode worden aangepast. |
...
| [newValueSpecifiedUnits](../../com.aspose.html.dom.svg.datatypes/svgangle/newvaluespecifiedunits/)(ushort, float) | Reset de waarde als een getal met een bijbehorende unitType, waardoor de waarden voor alle attributen op het object worden vervangen. |
| [toString](../../com.aspose.html.dom.svg.datatypes/svgangle/toString/)() | Retourneert een String die dit exemplaar vertegenwoordigt. |
...
| const [SVG_ANGLETYPE_UNKNOWN](../../com.aspose.html.dom.svg.datatypes/svgangle/svg_angletype_unknown/) | Het eenheidstype behoort niet tot de vooraf gedefinieerde eenheidstypen. Het is ongeldig om te proberen een nieuwe waarde van dit type te definiëren of om te proberen een bestaande waarde naar dit type te wijzigen. |
| const [SVG_ANGLETYPE_UNSPECIFIED](../../com.aspose.html.dom.svg.datatypes/svgangle/svg_angletype_unspecified/) | Er is geen eenheidstype opgegeven (d.w.z. een eenheidsloze waarde werd gespecificeerd). Voor hoeken wordt een eenheidsloze waarde behandeld alsof graden zijn opgegeven. |
