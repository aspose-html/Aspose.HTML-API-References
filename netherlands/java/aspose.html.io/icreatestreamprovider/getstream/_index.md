...
url: /nl/java/com.aspose.html.io/icreatestreamprovider/getstream/
---
## GetStream(String, String) {#getstream}

Levert een stream voor rendering.
...
| --- | --- | --- |
| name | String | De naam van de stream. |
| extensie | String | De bestandsnaamextensie die moet worden gebruikt als er een bestandsstream wordt aangemaakt |
