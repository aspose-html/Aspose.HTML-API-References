...
Een File-object is een Blob-object met een name-atribuut, dat een String is; het kan binnen de webapplicatie worden aangemaakt via een constructor, of is een verwijzing naar een bytevolgorde uit een bestand van het onderliggende (OS) bestandssysteem.
...
| Naam | Beschrijving |
| --- | --- |
| [getLastModified](../../com.aspose.html.io/ifile/lastmodified/) De datum van laatste wijziging van het bestand. Bij ophalen, als user agents deze informatie beschikbaar kunnen stellen, moet dit een long long retourneren die is ingesteld op de tijd waarop het bestand voor het laatst is gewijzigd, uitgedrukt in milliseconden sinds de Unix‑epoch. |
