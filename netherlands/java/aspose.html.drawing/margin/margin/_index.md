...
description: "Margin-constructeur. Initialiseert een nieuw exemplaar van de Margin-klasse"
type: docs

url: /nl/java/com.aspose.html.drawing/margin/margin/
---
## Margin() {#constructor}
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| links | Int32 | De linkergrootte. |
| boven | Int32 | De bovengrootte. |
| rechts | Int32 | De rechtergrootte. |
| onderkant | Int32 | De grootte van de onderkant. |
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| links | Length | De linkergrootte. |
| boven | Length | De bovengrootte. |
| rechts | Length | De rechtergrootte. |
| onderkant | Length | De grootte van de onderkant. |
