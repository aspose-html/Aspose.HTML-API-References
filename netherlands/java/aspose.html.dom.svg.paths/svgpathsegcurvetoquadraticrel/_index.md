...
description: "com.aspose.html.dom.svg.paths.SVGPathSegCurvetoQuadraticRel klasse. De SVGPathSegCurvetoQuadraticRel interface komt overeen met een relatieve kwadratische Bézier curveto q padgegevenscommando"
type: docs

url: /nl/java/com.aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticrel/
---
...
| [X](../../com.aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticrel/x/) { get; set; } | De relatieve X‑coördinaat voor het eindpunt van dit padsegment. |
[getX1]
[setX1] The relative X coordinate for the first control point. |
| [Y](../../com.aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticrel/y/) { get; set; } | De relatieve Y‑coördinaat voor het eindpunt van dit padsegment. |
[getY1]
