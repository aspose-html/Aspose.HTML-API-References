...
description: "com.aspose.html.dom.svg.paths.SVGPathSegLinetoHorizontalAbs klasse. De SVGPathSegLinetoHorizontalAbs interface komt overeen met een absolute horizontale lineto H padgegevenscommando"
type: docs

url: /nl/java/com.aspose.html.dom.svg.paths/svgpathseglinetohorizontalabs/
---
## SVGPathSegLinetoHorizontalAbs class

De SVGPathSegLinetoHorizontalAbs interface komt overeen met een "absolute horizontale lineto" (H) padgegevensopdracht.
...
| [X](../../com.aspose.html.dom.svg.paths/svgpathseglinetohorizontalabs/x/) { get; set; } | De absolute X-coördinaat voor het eindpunt van dit padsegment. |
