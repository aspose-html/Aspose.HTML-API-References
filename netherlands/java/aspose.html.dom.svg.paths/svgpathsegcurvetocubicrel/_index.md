...
description: "com.aspose.html.dom.svg.paths.SVGPathSegCurvetoCubicRel-klasse. De SVGPathSegCurvetoCubicRel-interface komt overeen met een relatieve kubieke Bézier curveto‑c‑padgegevensopdracht."
type: docs

url: /nl/java/com.aspose.html.dom.svg.paths/svgpathsegcurvetocubicrel/
---
## SVGPathSegCurvetoCubicRel class

De SVGPathSegCurvetoCubicRel-interface komt overeen met een \"relative cubic Bézier curveto\" (c) pad‑datacomando.
...
| [X](../../com.aspose.html.dom.svg.paths/svgpathsegcurvetocubicrel/x/) { get; set; } | De relatieve X‑coördinaat voor het eindpunt van dit padsegment. |
[getX1]
[setX1] The relative X coordinate for the first control point. |
[getX2]
[setX2] The relative X coordinate for the second control point. |
| [Y](../../com.aspose.html.dom.svg.paths/svgpathsegcurvetocubicrel/y/) { get; set; } | De relatieve Y‑coördinaat voor het eindpunt van dit padsegment. |
[getY1]
