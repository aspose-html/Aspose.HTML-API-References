...
| Naam | Beschrijving |
| --- | --- |
| [getAnimatedPathSegList](../../com.aspose.html.dom.svg.paths/isvganimatedpathdata/animatedpathseglist/) Biedt toegang tot de huidige geanimeerde inhoud van het ‘d’-attribuut in een vorm die één-op-één overeenkomt met de syntaxis van SVG. Als het opgegeven attribuut of eigenschap wordt geanimeerd, bevat het de huidige geanimeerde waarde van het attribuut of de eigenschap, en zowel het object zelf als de inhoud zijn alleen-lezen. Als het opgegeven attribuut of eigenschap momenteel niet wordt geanimeerd, bevat het dezelfde waarde als pathSegList. |
