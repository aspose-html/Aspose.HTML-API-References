...
description: "com.aspose.html.dom.svg.paths.SVGPathSegArcAbs klasse. De SVGPathSegArcAbs interface komt overeen met een absolute arcto A padgegevenscommando"
type: docs

url: /nl/java/com.aspose.html.dom.svg.paths/svgpathsegarcabs/
---
## SVGPathSegArcAbs class

De SVGPathSegArcAbs-interface komt overeen met een \"absolute arcto\" (A) pad‑datacomando.
...
| [X](../../com.aspose.html.dom.svg.paths/svgpathsegarcabs/x/) { get; set; } | De absolute X-coördinaat voor het eindpunt van dit padsegment. |
| [Y](../../com.aspose.html.dom.svg.paths/svgpathsegarcabs/y/) { get; set; } | De absolute Y-coördinaat voor het eindpunt van dit padsegment. |
