...
Het SelectElement vertegenwoordigt een wrapper die geassocieerd is met het HTMLSelectElement.
...
| [getType](../../com.aspose.html.forms/selectelement/type/) Het type van deze formuliercontrole. Dit is de string \"select-multiple\" wanneer het multiple-attribuut `true` is en de string \"select-one\" wanneer `false`. |
...
| Naam | Beschrijving |
| --- | --- |
| [selectItems](../../com.aspose.html.forms/selectelement/selectitems/#selectitems)(params int[]) | Deze methode maakt het mogelijk meerdere opties te selecteren op basis van hun indexen. |
| [selectItems](../../com.aspose.html.forms/selectelement/selectitems/#selectitems_1)(params String[]) | Deze methode maakt het mogelijk meerdere opties te selecteren op basis van hun waarden. |
