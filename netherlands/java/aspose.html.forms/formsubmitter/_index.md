...
description: "com.aspose.html.forms.FormSubmitter klasse. Deze klasse maakt het mogelijk om een opgegeven HTMLFormElement voor te bereiden, waarden van het formulierelement te verzamelen, ze naar de externe server te verzenden en een respons te ontvangen"
type: docs
...
Deze klasse maakt het mogelijk om een opgegeven [`HTMLFormElement`](../../com.aspose.html/htmlformelement/) voor te bereiden, waarden van het formulierelement te verzamelen, ze naar de externe server te verzenden en een respons te ontvangen.
...
| [FormSubmitter](formsubmitter/#constructor_2)(HTMLDocument, String) | Initialiseert een nieuw exemplaar van de `FormSubmitter` klasse op basis van [`HTMLFormElement`](../../com.aspose.html/htmlformelement/) geselecteerd op identificatie uit [`HTMLDocument`](../../com.aspose.html/htmldocument/). |
...
| Naam | Beschrijving |
| --- | --- |
| [dispose](../../com.aspose.html.forms/formsubmitter/dispose/)() | Vrijgeeft niet-beheerde en - optioneel - beheerde bronnen. |
