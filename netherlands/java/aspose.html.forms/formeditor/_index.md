...
| [getCount](../../com.aspose.html.forms/formeditor/count/) Het aantal formulierelementen in het formulier. |
...
| static [CreateNew](../../com.aspose.html.forms/formeditor/createnew/)(HTMLDocument) | Maakt een nieuw [`HTMLFormElement`](../../com.aspose.html/htmlformelement/) aan en koppelt het aan `FormEditor`. [`HTMLFormElement`](../../com.aspose.html/htmlformelement/) wordt gecreëerd in een losgekoppelde toestand van het document; om het aan het document toe te voegen, selecteer de juiste locatie en gebruik de [`AppendChild`](../../com.aspose.html.dom/node/appendchild/)‑methode. |
...
| [dispose](../../com.aspose.html.forms/formeditor/dispose/)() | Geeft niet‑beheerde en beheerde bronnen vrij. |
