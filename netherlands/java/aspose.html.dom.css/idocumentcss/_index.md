...
De getOverrideStyle‑methode biedt een mechanisme waarmee een DOM‑auteur een onmiddellijke wijziging van de stijl van een element kan doorvoeren zonder de expliciet gekoppelde stylesheets van een document of de inline‑stijl van elementen in de stylesheets aan te passen. Deze stylesheet komt na de auteurs‑stylesheet in het cascade‑algoritme en wordt een override‑stylesheet genoemd. De override‑stylesheet heeft voorrang op auteurs‑stylesheets. Een "!important"‑declaratie heeft nog steeds voorrang op een normale declaratie. Override‑, auteur‑ en gebruikers‑stylesheets kunnen allemaal "!important"‑declaraties bevatten. Gebruikers‑"!important"‑regels hebben voorrang op zowel override‑ als auteur‑"!important"‑regels, en override‑"!important"‑regels hebben voorrang op auteur‑"!important"‑regels.

De verwachting is dat een instantie van de DocumentCSS‑interface kan worden verkregen door bindingspecifieke cast‑methoden te gebruiken op een instantie van de Document‑interface.
