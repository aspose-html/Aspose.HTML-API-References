...
propertyName is een String die de naam van de CSS-eigenschap op de opgegeven index is.

### Property Value

index is de index van het op te halen knooppunt. De index begint bij nul.
