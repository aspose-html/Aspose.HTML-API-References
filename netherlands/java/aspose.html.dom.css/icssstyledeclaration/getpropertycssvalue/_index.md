...
| --- | --- | --- |
| propertyName | String | propertyName is een String die de naam van de op te halen eigenschap vertegenwoordigt. |

### Retourwaarde

value is een CSSValue die de CSS-waarde voor een eigenschap bevat. Als er geen bestaat, wordt null geretourneerd.
