...
Hoewel het CSSRuleList‑object alleen‑lees is en niet direct kan worden gewijzigd, wordt het beschouwd als een live‑object, omdat de inhoud in de loop van de tijd kan veranderen.
...
| Naam | Beschrijving |
| --- | --- |
| [getItem](../../com.aspose.html.dom.css/icssrulelist/item/) Wordt gebruikt om een CSS‑regel op te halen met de methode item() (http://www.w3.org/TR/DOM-Level-2-Style/css.html#CSS-CSSRuleList). De volgorde in deze collectie geeft de volgorde van de regels in de CSS‑stylesheet weer. Als index groter dan of gelijk is aan het aantal regels in de lijst, wordt null geretourneerd. |
| [getLength](../../com.aspose.html.dom.css/icssrulelist/length/) De length‑eigenschap van de `CSSRuleList` interface retourneert het aantal [`CSSRule`](../icssrule/) objecten in de lijst. |
