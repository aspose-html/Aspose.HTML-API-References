...
description: "com.aspose.html.dom.css.ICSS2Properties interface. De CSS2Properties‑interface vertegenwoordigt een handig mechanisme voor het ophalen en instellen van eigenschappen binnen een CSSStyleDeclaration. De attributen van deze interface komen overeen met alle eigenschappen die in CSS2 zijn gespecificeerd. Het ophalen van een attribuut van deze interface is gelijk aan het aanroepen van de getPropertyValue‑methode van de CSSStyleDeclaration‑interface. Het instellen van een attribuut van deze interface is gelijk aan het aanroepen van de setProperty‑methode van de CSSStyleDeclaration‑interface."
type: docs
...
De CSS2Properties‑interface vertegenwoordigt een handig mechanisme voor het ophalen en instellen van eigenschappen binnen een [`CSSStyleDeclaration`](../icssstyledeclaration/). De attributen van deze interface komen overeen met alle eigenschappen die in CSS2 zijn gespecificeerd. Het ophalen van een attribuut van deze interface is gelijk aan het aanroepen van de getPropertyValue‑methode van de [`CSSStyleDeclaration`](../icssstyledeclaration/) interface. Het instellen van een attribuut van deze interface is gelijk aan het aanroepen van de setProperty‑methode van de [`CSSStyleDeclaration`](../icssstyledeclaration/) interface.
