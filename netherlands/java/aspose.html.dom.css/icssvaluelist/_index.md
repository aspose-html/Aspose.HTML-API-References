...
Sommige eigenschappen staan een lege lijst toe in hun syntaxis. In dat geval gebruiken deze eigenschappen de identifier none. Een lege lijst betekent dus dat de eigenschap de waarde none heeft.

De items in de CSSValueList zijn toegankelijk via een gehele index, beginnend bij 0.
