...
description: "com.aspose.html.dom.svg.events.SVGZoomEvent klasse. Het zoom‑evenement treedt op wanneer de gebruiker een actie start die ervoor zorgt dat de huidige weergave van het SVG‑documentfragment wordt herschaald. Event‑handlers worden alleen herkend op svg‑elementen."
type: docs
...
De zoomgebeurtenis treedt op wanneer de gebruiker een actie start die ervoor zorgt dat de huidige weergave van het SVG-documentfragment wordt herschaald. Eventhandlers worden alleen herkend op ‘svg’-elementen.
...
| [getNewScale](../../com.aspose.html.dom.svg.events/svgzoomevent/newscale/) De schaalfactor die van kracht zal zijn nadat de zoombewerking is verwerkt. |
| [getNewTranslate](../../com.aspose.html.dom.svg.events/svgzoomevent/newtranslate/) De translatiewaarden die van kracht zullen zijn nadat de zoombewerking is verwerkt. Het SVGPoint‑object is alleen-lezen. |
| [getPreviousScale](../../com.aspose.html.dom.svg.events/svgzoomevent/previousscale/) De schaalfactor van eerdere zoombewerkingen die van kracht was voordat de zoombewerking plaatsvond. |
| [getPreviousTranslate](../../com.aspose.html.dom.svg.events/svgzoomevent/previoustranslate/) De translatiewaarden van eerdere zoombewerkingen die van kracht waren voordat de zoombewerking plaatsvond. Het SVGPoint‑object is alleen-lezen. |
...
| [getZoomRectScreen](../../com.aspose.html.dom.svg.events/svgzoomevent/zoomrectscreen/) Het opgegeven zoom‑rechthoek in schermeenheden. Het SVGRect‑object is alleen-lezen. |
