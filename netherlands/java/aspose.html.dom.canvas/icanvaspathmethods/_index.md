...
| [arcTo](../../com.aspose.html.dom.canvas/icanvaspathmethods/arcto/)(double, double, double, double, double) | Voegt een boog toe aan het pad met de opgegeven controlepunten en straal, verbonden met het vorige punt door een rechte lijn. |
...
| [lineTo](../../com.aspose.html.dom.canvas/icanvaspathmethods/lineto/)(double, double) | Verbindt het laatste punt in het subpad met de x, y-coördinaten door een rechte lijn. |
...
| [rect](../../com.aspose.html.dom.canvas/icanvaspathmethods/rect/)(double, double, double, double) | Maakt een pad voor een rechthoek op positie (x, y) met een grootte die wordt bepaald door breedte en hoogte. |
