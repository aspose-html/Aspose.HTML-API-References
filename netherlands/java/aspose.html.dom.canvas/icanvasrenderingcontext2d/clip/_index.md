...
description: "ICanvasRenderingContext2D methode. Maakt een nieuwe knipregio door de intersectie te berekenen van de huidige knipregio en het gebied dat wordt beschreven door het pad, met behulp van de niet-nul winding-nummerregel. Open subpaden moeten impliciet worden gesloten bij het berekenen van de knipregio zonder de daadwerkelijke subpaden te beïnvloeden. De nieuwe knipregio vervangt de huidige knipregio."
type: docs
...
| fillRule | CanvasFillRule | Het algoritme waarmee wordt bepaald of een punt zich binnen of buiten een pad bevindt. |
