...
description: "com.aspose.html.dom.svg.SVGMarkerElement class. De SVGMarkerElement interface komt overeen met het marker-element."
type: docs

url: /nl/java/com.aspose.html.dom.svg/svgmarkerelement/
---
...
| [getMarkerHeight](../../com.aspose.html.dom.svg/svgmarkerelement/markerheight/) Komt overeen met attribuut ‘markerHeight’ op het opgegeven ‘marker’-element. |
| [getMarkerUnits](../../com.aspose.html.dom.svg/svgmarkerelement/markerunits/) Komt overeen met attribuut ‘markerUnits’ op het opgegeven ‘marker’-element. Een van de Marker Unit Types die op deze interface zijn gedefinieerd. |
| [getMarkerWidth](../../com.aspose.html.dom.svg/svgmarkerelement/markerwidth/) Komt overeen met attribuut ‘markerWidth’ op het opgegeven ‘marker’-element. |
...
| [getOrientAngle](../../com.aspose.html.dom.svg/svgmarkerelement/orientangle/) Komt overeen met attribuut ‘orient’ op het opgegeven ‘marker’-element. Als markerUnits SVG_MARKER_ORIENT_ANGLE is, de hoekwaarde voor attribuut ‘orient’; anders wordt deze op nul gezet. |
| [getOrientType](../../com.aspose.html.dom.svg/svgmarkerelement/orienttype/) Komt overeen met attribuut ‘orient’ op het opgegeven ‘marker’-element. Een van de Marker Orientation Types die op deze interface zijn gedefinieerd. |
[getOuterHTML]
...
| [getPreserveAspectRatio](../../com.aspose.html.dom.svg/svgmarkerelement/preserveaspectratio/) Komt overeen met attribuut ‘preserveAspectRatio’ op het opgegeven element. |
...
| [getRefX](../../com.aspose.html.dom.svg/svgmarkerelement/refx/) Komt overeen met attribuut ‘refX’ op het opgegeven ‘marker’-element. |
| [getRefY](../../com.aspose.html.dom.svg/svgmarkerelement/refy/) Komt overeen met attribuut ‘refY’ op het opgegeven ‘marker’-element. |
...
| [getViewBox](../../com.aspose.html.dom.svg/svgmarkerelement/viewbox/) Komt overeen met attribuut ‘viewBox’ op het opgegeven element. |
...
| [setOrientToAngle](../../com.aspose.html.dom.svg/svgmarkerelement/setorienttoangle/)(SVGAngle) | Stelt de waarde van attribuut ‘orient’ in op de opgegeven hoek. |
| [setOrientToAuto](../../com.aspose.html.dom.svg/svgmarkerelement/setorienttoauto/)() | Stelt de waarde van attribuut ‘orient’ in op 'auto'. |
...
| Naam | Beschrijving |
| --- | --- |
| const [SVG_MARKERUNITS_STROKEWIDTH](../../com.aspose.html.dom.svg/svgmarkerelement/svg_markerunits_strokewidth/) | De waarde van attribuut ‘markerUnits’ is 'strokeWidth'. |
| const [SVG_MARKERUNITS_UNKNOWN](../../com.aspose.html.dom.svg/svgmarkerelement/svg_markerunits_unknown/) | Het marker-eenheidstype is geen van de vooraf gedefinieerde typen. Het is ongeldig om te proberen een nieuwe waarde van dit type te definiëren of om een bestaande waarde naar dit type te wijzigen. |
| const [SVG_MARKERUNITS_USERSPACEONUSE](../../com.aspose.html.dom.svg/svgmarkerelement/svg_markerunits_userspaceonuse/) | De waarde van attribuut ‘markerUnits’ is 'userSpaceOnUse'. |
| const [SVG_MARKER_ORIENT_ANGLE](../../com.aspose.html.dom.svg/svgmarkerelement/svg_marker_orient_angle/) | Attribuut ‘orient’ heeft een hoekwaarde. |
| const [SVG_MARKER_ORIENT_AUTO](../../com.aspose.html.dom.svg/svgmarkerelement/svg_marker_orient_auto/) | Attribuut ‘orient’ heeft de waarde 'auto'. |
| const [SVG_MARKER_ORIENT_UNKNOWN](../../com.aspose.html.dom.svg/svgmarkerelement/svg_marker_orient_unknown/) | De markeroriëntatie is geen van de vooraf gedefinieerde typen. Het is ongeldig om te proberen een nieuwe waarde van dit type te definiëren of om een bestaande waarde naar dit type te wijzigen. |
