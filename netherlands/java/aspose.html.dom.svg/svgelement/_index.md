...
Alle SVG DOM‑interfaces die direct overeenkomen met elementen in de SVG‑taal (zoals de SVGPathElement interface voor het ‘path’-element) zijn afgeleid van de SVGElement interface.
