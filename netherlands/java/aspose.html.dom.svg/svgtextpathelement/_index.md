...
description: "com.aspose.html.dom.svg.SVGTextPathElement class. De SVGTextPathElement interface komt overeen met het textPath‑element"
type: docs
...
| [getNumberOfChars](../../com.aspose.html.dom.svg/svgtextcontentelement/getnumberofchars/)() | Geeft het totale aantal tekens terug dat beschikbaar is voor weergave binnen het huidige element, inclusief de gerefereerde tekens uit de ‘tref’-referentie, ongeacht of ze worden gerenderd. In feite is dit gelijk aan de lengte van het Node::textContent-attribuut uit DOM Level 3 Core ([DOM3], sectie 1.4), als dat attribuut ook ‘tref’-elementen uitbreidt. |
