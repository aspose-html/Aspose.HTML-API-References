---
title: "SVGTextPathElement Klasse"
second_title: "Aspose.HTML voor Java API-referentie"
description: "com.aspose.html.dom.svg.SVGTextPathElement klasse. De SVGTextPathElement interface komt overeen met het textPath-element"
type: docs

url: /nl/java/com.aspose.html.dom.svg/svgtextpathelement/
---
...
| [getHref](../../com.aspose.html.dom.svg/svgtextpathelement/href/) Komt overeen met het attribuut ‘xlink:href’ op het opgegeven element. |
[getId]
...
| [getLengthAdjust](../../com.aspose.html.dom.svg/svgtextcontentelement/lengthadjust/) Komt overeen met attribuut ‘lengthAdjust’ op het opgegeven element. De waarde moet een van de length adjust-constanten zijn die op deze interface zijn gedefinieerd. |
...
| [getMethod](../../com.aspose.html.dom.svg/svgtextpathelement/method/) Komt overeen met het attribuut ‘method’ op het opgegeven ‘textPath’-element. |
...
| [getSpacing](../../com.aspose.html.dom.svg/svgtextpathelement/spacing/) Komt overeen met het attribuut ‘spacing’ op het opgegeven ‘textPath’-element. |
| [getStartOffset](../../com.aspose.html.dom.svg/svgtextpathelement/startoffset/) Komt overeen met het attribuut ‘startOffset’ op het opgegeven ‘textPath’-element. |
...
| [getTextLength](../../com.aspose.html.dom.svg/svgtextcontentelement/textlength/) Komt overeen met attribuut ‘textLength’ op het opgegeven element. |
...
| [getComputedTextLength](../../com.aspose.html.dom.svg/svgtextcontentelement/getcomputedtextlength/)() | De totale som van alle voortschrijdende waarden bij het renderen van alle tekens binnen dit element, inclusief de voortschrijdende waarde op de glyphs (horizontaal of verticaal), het effect van de eigenschappen ‘kerning’, ‘letter-spacing’ en ‘word-spacing’ en aanpassingen door de attributen ‘dx’ en ‘dy’ op ‘tspan’-elementen. Voor niet-renderende omgevingen moet de user agent redelijke aannames maken over glyph-metrieken. |
...
| [getNumberOfChars](../../com.aspose.html.dom.svg/svgtextcontentelement/getnumberofchars/)() | Retourneert het totale aantal tekens dat beschikbaar is voor weergave binnen het huidige element, inclusief verwijzende tekens van de ‘tref’-referentie, ongeacht of ze worden gerenderd. In feite is dit gelijk aan de lengte van het Node::textContent-attribuut uit DOM Level 3 Core ([DOM3], sectie 1.4), als dat attribuut ook ‘tref’-elementen uitbreidt. |
...
| Naam | Beschrijving |
| --- | --- |
| const [TEXTPATH_METHODTYPE_ALIGN](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_align/) | Komt overeen met de waarde 'align'. |
| const [TEXTPATH_METHODTYPE_STRETCH](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_stretch/) | Komt overeen met de waarde 'stretch'. |
| const [TEXTPATH_METHODTYPE_UNKNOWN](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_unknown/) | De enumeratie is ingesteld op een waarde die geen van de vooraf gedefinieerde typen is. Het is ongeldig om te proberen een nieuwe waarde van dit type te definiëren of om te proberen een bestaande waarde naar dit type te wijzigen. |
| const [TEXTPATH_SPACINGTYPE_AUTO](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_auto/) | Komt overeen met de waarde 'auto'. |
| const [TEXTPATH_SPACINGTYPE_EXACT](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_exact/) | Komt overeen met de waarde 'exact'. |
| const [TEXTPATH_SPACINGTYPE_UNKNOWN](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_unknown/) | De enumeratie is ingesteld op een waarde die geen van de vooraf gedefinieerde typen is. Het is ongeldig om te proberen een nieuwe waarde van dit type te definiëren of om te proberen een bestaande waarde naar dit type te wijzigen. |
