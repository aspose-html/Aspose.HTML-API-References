...
| [getHeight](../../com.aspose.html.dom.svg/svgrectelement/height/) Komt overeen met attribuut ‘height’ op het opgegeven ‘rect’-element. |
[getId]
...
| [getRx](../../com.aspose.html.dom.svg/svgrectelement/rx/) Komt overeen met attribuut ‘rx’ op het opgegeven ‘rect’-element. |
...
| [getEquivalentPath](../../com.aspose.html.dom.svg/svggeometryelement/getequivalentpath/)() | Retourneert een nieuw exemplaar van de [`SVGPathSegList`](../../com.aspose.html.dom.svg.paths/svgpathseglist/) die de [`SVGGeometryElement`](../svggeometryelement/) weergeeft als padsegmenten. |
...
| [getPointAtLength](../../com.aspose.html.dom.svg/svggeometryelement/getpointatlength/)(float) | Retourneert de (x,y)-coördinaat in de gebruikersruimte, uitgedrukt in afstandseenheden langs het pad, met gebruikmaking van het distance‑along‑a‑path‑algoritme van de user agent. |
...
| [getTotalLength](../../com.aspose.html.dom.svg/svggeometryelement/gettotallength/)() | Retourneert de door de user agent berekende waarde voor de totale lengte van het pad met behulp van het distance‑along‑a‑path‑algoritme van de user agent, als een afstand in het huidige gebruikerscoördinatensysteem. |
