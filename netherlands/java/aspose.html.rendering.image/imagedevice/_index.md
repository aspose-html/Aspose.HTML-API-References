...
| [ImageDevice](imagedevice/#constructor_2)(ImageRenderingOptions, Stream) | Initialiseert een nieuw exemplaar van de `ImageDevice`-klasse met renderopties en uitvoerstream. |
