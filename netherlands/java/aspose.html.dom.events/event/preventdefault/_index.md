...
Als een gebeurtenis annuleerbaar is, wordt de `PreventDefault`-methode gebruikt om aan te geven dat de gebeurtenis moet worden geannuleerd, wat betekent dat elke standaardactie die normaal door de implementatie als gevolg van de gebeurtenis wordt uitgevoerd, niet zal plaatsvinden.
