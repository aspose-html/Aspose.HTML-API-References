...
De WheelEvent-interface biedt specifieke contextuele informatie die verband houdt met wielgebeurtenissen. Om een instantie van de WheelEvent-interface te maken, gebruik de WheelEvent-constructor en geef een optioneel WheelEventInit-woordenboek door.
...
| const [DOM_DELTA_PAGE](../../com.aspose.html.dom.events/wheelevent/dom_delta_page/) | De meeteenheid voor de delta MOET pagina’s zijn, gedefinieerd als één enkel scherm of als een afgebakende pagina. |
