...
description: "com.aspose.html.dom.events.WheelEvent class. De WheelEvent‑interface biedt specifieke contextuele informatie die verband houdt met wiel‑events. Om een instantie van de WheelEvent‑interface te maken, gebruik de WheelEvent‑constructor met een optioneel WheelEventInit‑woordenboek."
type: docs

url: /nl/java/com.aspose.html.dom.events/wheelevent/
---
## WheelEvent class

De WheelEvent interface biedt specifieke contextuele informatie die verband houdt met wielgebeurtenissen. Om een instantie van de WheelEvent interface te maken, gebruik je de WheelEvent‑constructor en geef je een optioneel WheelEventInit‑woordenboek door.
...
| [getDeltaMode](../../com.aspose.html.dom.events/wheelevent/deltamode/) Het deltaMode‑attribuut bevat een indicatie van de meeteenheden voor de delta‑waarden. De standaardwaarde is DOM_DELTA_PIXEL (pixels). |
| [getDeltaX](../../com.aspose.html.dom.events/wheelevent/deltax/) In user agents waarbij de standaardactie van het wiel‑event scrollen is, moet de waarde de meting langs de x-as (in pixels, regels of pagina's) zijn die moet worden gescrold wanneer het event niet wordt geannuleerd. Anders is dit een implementatie‑specifieke meting (in pixels, regels of pagina's) van de beweging van een wiel‑apparaat rond de x-as. |
| [getDeltaY](../../com.aspose.html.dom.events/wheelevent/deltay/) In user agents waarbij de standaardactie van het wiel‑event scrollen is, moet de waarde de meting langs de y-as (in pixels, regels of pagina's) zijn die moet worden gescrold wanneer het event niet wordt geannuleerd. Anders is dit een implementatie‑specifieke meting (in pixels, regels of pagina's) van de beweging van een wiel‑apparaat rond de y-as. |
| [getDeltaZ](../../com.aspose.html.dom.events/wheelevent/deltaz/) In user agents waarbij de standaardactie van het wiel‑event scrollen is, moet de waarde de meting langs de z-as (in pixels, regels of pagina's) zijn die moet worden gescrold wanneer het event niet wordt geannuleerd. Anders is dit een implementatie‑specifieke meting (in pixels, regels of pagina's) van de beweging van een wiel‑apparaat rond de z-as. |
...
| Naam | Beschrijving |
| --- | --- |
| const [DOM_DELTA_LINE](../../com.aspose.html.dom.events/wheelevent/dom_delta_line/) | De meeteenheid voor de delta MOET individuele tekstregels zijn. Dit is het geval voor veel formulierelementen. |
| const [DOM_DELTA_PAGE](../../com.aspose.html.dom.events/wheelevent/dom_delta_page/) | De meeteenheid voor de delta MOET pagina's zijn, gedefinieerd als één scherm of als een afgebakende pagina. |
| const [DOM_DELTA_PIXEL](../../com.aspose.html.dom.events/wheelevent/dom_delta_pixel/) | De meeteenheid voor de delta MOET pixels zijn. Dit is het meest voorkomende geval in de meeste besturingssystemen en implementatie‑configuraties. |
