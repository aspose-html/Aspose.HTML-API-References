...
description: "com.aspose.html.saving.HTMLSaveFormat enum. Specificeert het formaat waarin het document wordt opgeslagen. U kunt meer informatie vinden over het opslaan van HTMLDocument in een artikel"
type: docs
...
Specificeert het formaat waarin het document wordt opgeslagen. U kunt meer informatie vinden over het opslaan van [`HTMLDocument`](../../com.aspose.html/htmldocument/) in [artikel](https://docs.aspose.com/html/net/working-with-documents/saving-a-document/).
...
...
  // Bereid een uitvoerpad voor het opslaan van een document.
