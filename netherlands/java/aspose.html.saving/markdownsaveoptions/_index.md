...
description: "com.aspose.html.saving.MarkdownSaveOptions klasse. Vertegenwoordigt Markdown‑opslagopties. Bijvoorbeeld je kunt de markdown‑opmaakstijl instellen, vooraf gedefinieerde GitLab Flavored Markdown‑compatibele opties gebruiken en de verwerking van bronnen configureren. Zie meer info in het artikel"
type: docs
...
Stelt Markdown-opslagopties voor. Bijvoorbeeld, je kunt de opmaakstijl van Markdown instellen, vooraf gedefinieerde GitLab Flavored Markdown-compatibele opties gebruiken en de verwerking van bronnen configureren. Raadpleeg meer info in [article](https://docs.aspose.com/html/net/converting-between-formats/html-to-markdown/#save-options).
...
| Naam | Beschrijving |
| --- | --- |
| [MarkdownSaveOptions](markdownsaveoptions/)() | Initialiseert een nieuw exemplaar van de `MarkdownSaveOptions` klasse. |
...
...
	 // Bereid een pad voor voor het opslaan van het geconverteerde bestand 
      ...
      // Maak een exemplaar van SaveOptions aan en stel de regel in: 
