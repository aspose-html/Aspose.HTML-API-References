...
| AutomaticParagraph | `2` | Deze vlag schakelt de conversie van `paragraph`‑elementen in. De inhoud van dergelijke elementen wordt op afzonderlijke regels geplaatst, zodat markdown‑verwerkers deze omsluiten. |
...
| CodeBlock | `20` | Deze vlag schakelt de conversie van codeblokken in. Een codeblok bestaat uit 2 elementen `pre` en `code`; de inhoud van een dergelijke constructie wordt verwerkt "as is". |
