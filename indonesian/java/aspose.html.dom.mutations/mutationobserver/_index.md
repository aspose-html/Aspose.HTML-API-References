...
| Nama | Deskripsi |
| --- | --- |
| [MutationObserver](mutationobserver/)(MutationCallback) | Membuat objek MutationObserver dan mengatur [`MutationCallback`](../mutationcallback/)‑nya menjadi callback. Callback dipanggil dengan daftar objek MutationRecord sebagai argumen pertama dan objek MutationObserver yang dibuat sebagai argumen kedua. Callback dipanggil setelah node yang terdaftar dengan metode !:Observe(Node, IMutationObserverInit) mengalami mutasi. |
...
| [takeRecords](../../com.aspose.html.dom.mutations/mutationobserver/takerecords/)() | Metode ini mengembalikan salinan antrian rekaman dan kemudian mengosongkan antrian rekaman. |
