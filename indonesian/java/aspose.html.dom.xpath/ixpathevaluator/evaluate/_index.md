...
| type | XPathResultType | Jika `type` tertentu ditentukan, maka hasil akan dikembalikan sebagai tipe yang sesuai. Untuk hasil XPath 1.0, ini harus menjadi salah satu nilai dari enum [`XPathResultType`](../../xpathresulttype/). |
