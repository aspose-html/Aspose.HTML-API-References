...
description: "IXPathEvaluator method. Menyesuaikan setiap node DOM untuk menyelesaikan paket sehingga ekspresi XPath dapat dievaluasi dengan mudah relatif terhadap konteks node tempat ia muncul dalam dokumen. Adapter ini bekerja seperti metode DOM Level 3 lookupNamespaceURI pada node dalam menyelesaikan packageURI dari sebuah prefiks menggunakan informasi terkini yang tersedia dalam hierarki node pada saat lookupNamespaceURI dipanggil serta secara tepat menyelesaikan prefiks xml implisit"
type: docs
