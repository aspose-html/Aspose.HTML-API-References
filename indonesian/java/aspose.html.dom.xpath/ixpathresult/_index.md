...
Antarmuka `XPathResult` mewakili hasil evaluasi ekspresi XPath 1.0 dalam konteks sebuah node tertentu. Karena evaluasi ekspresi XPath dapat menghasilkan berbagai tipe hasil, objek ini memungkinkan untuk menemukan dan memanipulasi tipe serta nilai hasil.
...
| Nama | Deskripsi |
| --- | --- |
| [getBooleanValue](../../com.aspose.html.dom.xpath/ixpathresult/booleanvalue/) Nilai hasil boolean ini. |
| [getInvalidIteratorState](../../com.aspose.html.dom.xpath/ixpathresult/invaliditeratorstate/) Menandakan bahwa iterator telah menjadi tidak valid. True jika `resultType` adalah tipe `UnorderedNodeIterator` atau `OrderedNodeIterator` dan dokumen telah dimodifikasi sejak hasil ini dikembalikan. |
| [getNumberValue](../../com.aspose.html.dom.xpath/ixpathresult/numbervalue/) Nilai hasil angka ini. |
...
| [getSnapshotLength](../../com.aspose.html.dom.xpath/ixpathresult/snapshotlength/) Jumlah node dalam snapshot hasil. Nilai yang valid untuk indeks snapshotItem adalah `0` hingga `snapshotLength-1` termasuk. |
