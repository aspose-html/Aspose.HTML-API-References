...
description: "kelas com.aspose.html.dom.css.CSSPrimitiveValue. Antarmuka CSSPrimitiveValue diturunkan dari antarmuka CSSValue dan mewakili nilai terhitung saat ini dari sebuah properti CSS."
type: docs
...
| abstract [GetCounterValue](../../com.aspose.html.dom.css/cssprimitivevalue/getcountervalue/)() | Metode ini digunakan untuk mendapatkan nilai Counter. Jika nilai CSS ini tidak mengandung nilai counter, DOMException akan dilempar. Modifikasi pada properti gaya yang bersangkutan dapat dilakukan menggunakan antarmuka Counter. |
...
| const [CSS_DPPX](../../com.aspose.html.dom.css/cssprimitivevalue/css_dppx/) | Nilai ini adalah titik per unit ‘px’ (dppx). |
