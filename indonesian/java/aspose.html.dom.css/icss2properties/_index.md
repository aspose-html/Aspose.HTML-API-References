...
Antarmuka CSS2Properties mewakili mekanisme kemudahan untuk mengambil dan mengatur properti dalam [`CSSStyleDeclaration`](../icssstyledeclaration/). Atribut-atribut antarmuka ini sesuai dengan semua properti yang ditentukan dalam CSS2. Mengambil atribut dari antarmuka ini setara dengan memanggil metode getPropertyValue pada antarmuka [`CSSStyleDeclaration`](../icssstyledeclaration/). Mengatur atribut pada antarmuka ini setara dengan memanggil metode setProperty pada antarmuka [`CSSStyleDeclaration`](../icssstyledeclaration/).
