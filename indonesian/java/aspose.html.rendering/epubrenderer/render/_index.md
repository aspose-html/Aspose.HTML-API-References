...
description: "Metode EpubRenderer. Mendefinisikan metode untuk merender beberapa Stream EPub ke IDevice tertentu. Rendering akan dilakukan setelah tidak ada operasi jaringan untuk memuat sumber daya, timer aktif, tugas animasi, atau batas waktu yang ditentukan telah berlalu"
type: docs
...
Mendefinisikan metode untuk merender beberapa Stream EPub ke [`IDevice`](../../idevice/). Rendering akan dilakukan setelah tidak ada operasi jaringan untuk memuat sumber daya, timer aktif, tugas animasi, atau batas waktu yang ditentukan telah berlalu
...
Merender dokumen EPub ke [`IDevice`](../../idevice/) yang ditentukan. Rendering akan dilakukan setelah tidak ada operasi jaringan untuk memuat sumber daya, timer aktif, tugas animasi, atau batas waktu yang ditentukan telah berlalu.
...
Merender beberapa dokumen EPub ke [`IDevice`](../../idevice/) yang ditentukan. Rendering akan dilakukan setelah tidak ada operasi jaringan untuk memuat sumber daya, timer aktif, tugas animasi, atau batas waktu yang ditentukan telah berlalu.
