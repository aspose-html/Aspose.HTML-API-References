...
description: "kelas com.aspose.html.rendering.Renderer1TSource. Mewakili kelas abstrak untuk semua perender"
type: docs
...
| [render](../../com.aspose.html.rendering/renderer-1/render/#render_4)(IDevice, TSource, int) | Mendefinisikan metode untuk merender !:TDocument ke [`IDevice`](../idevice/). Rendering akan dilakukan setelah tidak ada operasi jaringan untuk memuat sumber daya, timer aktif, tugas animasi, atau batas waktu yang ditentukan telah berlalu. |
| [render](../../com.aspose.html.rendering/renderer-1/render/#render_5)(IDevice, TSource, TimeSpan) | Mendefinisikan metode untuk merender !:TDocument ke [`IDevice`](../idevice/). Rendering akan dilakukan setelah tidak ada operasi jaringan untuk memuat sumber daya, timer aktif, tugas animasi, atau batas waktu yang ditentukan telah berlalu. |
