---
title: "Kelas SVGFEColorMatrixElement"
second_title: "Referensi API Aspose.HTML untuk Java"
description: "kelas com.aspose.html.dom.svg.filters.SVGFEColorMatrixElement. Antarmuka SVGFEColorMatrixElement sesuai dengan elemen feColorMatrix."
type: docs

url: /id/java/com.aspose.html.dom.svg.filters/svgfecolormatrixelement/
---
## SVGFEColorMatrixElement class

Antarmuka SVGFEColorMatrixElement sesuai dengan elemen ‘feColorMatrix’
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/height/) Mengacu pada atribut ‘height’ pada elemen ‘filter’ yang diberikan. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/in1/) Mengacu pada atribut ‘in’ pada elemen ‘feColorMatrix’ yang diberikan. |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/result/) Mengacu pada atribut ‘result’ pada elemen ‘filter’ yang diberikan. |
...
| [getType](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/type/) Mengacu pada atribut ‘type’ pada elemen ‘feColorMatrix’ yang diberikan. Mengambil salah satu konstanta SVG_FECOLORMATRIX_TYPE_* yang didefinisikan pada antarmuka ini. |
| [getValues](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/values/) Mengacu pada atribut ‘values’ pada elemen ‘feColorMatrix’ yang diberikan. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/width/) Mengacu pada atribut ‘width’ pada elemen ‘filter’ yang diberikan. |
| [X](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/x/) { get; } | Menyatakan atribut ‘x’ pada elemen ‘filter’ yang diberikan. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/y/) { get; } | Menyatakan atribut ‘y’ pada elemen ‘filter’ yang diberikan. |
...
| Nama | Deskripsi |
| --- | --- |
| const [SVG_FECOLORMATRIX_TYPE_HUEROTATE](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_huerotate/) | Mengacu pada nilai 'hueRotate'. |
| const [SVG_FECOLORMATRIX_TYPE_LUMINANCETOALPHA](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_luminancetoalpha/) | Mengacu pada nilai 'luminanceToAlpha'. |
| const [SVG_FECOLORMATRIX_TYPE_MATRIX](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_matrix/) | Mengacu pada nilai 'matrix'. |
| const [SVG_FECOLORMATRIX_TYPE_SATURATE](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_saturate/) | Berhubungan dengan nilai 'saturate'. |
| const [SVG_FECOLORMATRIX_TYPE_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_unknown/) | Tipe ini bukan salah satu tipe yang telah ditentukan. Tidak valid mencoba mendefinisikan nilai baru dari tipe ini atau mencoba mengubah nilai yang ada ke tipe ini. |
