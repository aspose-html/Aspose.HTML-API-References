---
title: "Kelas SVGFETurbulenceElement"
second_title: "Referensi API Aspose.HTML untuk Java"
description: "kelas com.aspose.html.dom.svg.filters.SVGFETurbulenceElement. Antarmuka SVGFETurbulenceElement mengacu pada elemen feTurbulence."
type: docs

url: /id/java/com.aspose.html.dom.svg.filters/svgfeturbulenceelement/
---
## SVGFETurbulenceElement class

Antarmuka SVGFETurbulenceElement sesuai dengan elemen ‘feTurbulence’.
...
| [getBaseFrequencyX](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/basefrequencyx/) Mengacu pada atribut ‘baseFrequency’ pada elemen ‘feTurbulence’ yang diberikan. Berisi komponen X dari atribut ‘baseFrequency’. |
| [getBaseFrequencyY](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/basefrequencyy/) Mengacu pada atribut ‘baseFrequency’ pada elemen ‘feTurbulence’ yang diberikan. Berisi komponen Y dari atribut ‘baseFrequency’ (mungkin dihitung secara otomatis). |
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/height/) Mengacu pada atribut ‘height’ pada elemen ‘filter’ yang diberikan. |
[getId]
...
| [getNumOctaves](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/numoctaves/) Mengacu pada atribut ‘numOctaves’ pada elemen ‘feTurbulence’ yang diberikan. |
[getOuterHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/result/) Mengacu pada atribut ‘result’ pada elemen ‘filter’ yang diberikan. |
| [getSeed](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/seed/) Mengacu pada atribut ‘seed’ pada elemen ‘feTurbulence’ yang diberikan. |
...
| [getStitchTiles](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/stitchtiles/) Mengacu pada atribut ‘stitchTiles’ pada elemen ‘feTurbulence’ yang diberikan. Menerima salah satu konstanta SVG_STITCHTYPE_* yang didefinisikan pada antarmuka ini. |
...
| [getType](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/type/) Mengacu pada atribut ‘type’ pada elemen ‘feTurbulence’ yang diberikan. Menerima salah satu konstanta SVG_TURBULENCE_TYPE_* yang didefinisikan pada antarmuka ini. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/width/) Mengacu pada atribut ‘width’ pada elemen ‘filter’ yang diberikan. |
| [X](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/x/) { get; } | Menyatakan atribut ‘x’ pada elemen ‘filter’ yang diberikan. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/y/) { get; } | Menyatakan atribut ‘y’ pada elemen ‘filter’ yang diberikan. |
...
| Nama | Deskripsi |
| --- | --- |
| const [SVG_STITCHTYPE_NOSTITCH](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_stitchtype_nostitch/) | Mengacu pada nilai 'noStitch'. |
| const [SVG_STITCHTYPE_STITCH](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_stitchtype_stitch/) | Mengacu pada nilai 'stitch'. |
| const [SVG_STITCHTYPE_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_stitchtype_unknown/) | Tipe ini bukan salah satu tipe yang telah ditentukan. Tidak valid mencoba mendefinisikan nilai baru dari tipe ini atau mencoba mengubah nilai yang ada ke tipe ini. |
| const [SVG_TURBULENCE_TYPE_FRACTALNOISE](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_turbulence_type_fractalnoise/) | Mengacu pada nilai 'fractalNoise'. |
| const [SVG_TURBULENCE_TYPE_TURBULENCE](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_turbulence_type_turbulence/) | Mengacu pada nilai 'turbulence'. |
| const [SVG_TURBULENCE_TYPE_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_turbulence_type_unknown/) | Tipe ini bukan salah satu tipe yang telah ditentukan. Tidak valid mencoba mendefinisikan nilai baru dari tipe ini atau mencoba mengubah nilai yang ada ke tipe ini. |
