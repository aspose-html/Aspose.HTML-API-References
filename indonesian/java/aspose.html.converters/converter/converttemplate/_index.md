...
description: "Metode Converter. Menggabungkan sumber templat yang disajikan oleh HTMLDocument dengan data templat XML JSON. Hasilnya adalah file html yang dibentuk oleh jalur file keluaran."
type: docs
...
Gabungkan sumber templat yang disajikan oleh [`HTMLDocument`](../../../com.aspose.html/htmldocument/) dengan data templat (XML, JSON). Hasilnya adalah file html yang dibentuk oleh jalur file keluaran.
...
| options | TemplateLoadOptions | [`TemplateLoadOptions`](../../../com.aspose.html.loading/templateloadoptions/) instance objek. Ini digunakan untuk menentukan apakah nama templat dan item data cocok, terlepas dari huruf besar/kecil atau tidak (opsi). |
| outputPath | String | Jalur file html lengkap sebagai hasil konversi keluaran. |

## Catatan

Penggabung Templat

Ide penggabungan templat adalah membuat dokumen HTML berdasarkan templat HTML dan mengisinya dari sumber data. Aspose.HTML menyediakan sintaks ekspresi inline untuk bekerja dengan templat dan berbagai jenis sumber data, seperti XML dan JSON. Lihat [article](https://docs.aspose.com/html/net/converting-between-formats/html-template/) di mana Anda dapat menemukan informasi lebih lanjut tentang penggabungan templat dan penggunaan metode ConvertTemplate().
...
Sumber templat. Tentukan sumber templat HTML melalui file, [`URL`](../../../com.aspose.html/url/), instance objek [`HTMLDocument`](../../../com.aspose.html/htmldocument/) atau bahkan melalui konten inline. Hasil konversi. Anda dapat memperoleh langsung HTMLDocument yang dihasilkan atau menentukan jalur file output hasil tergantung pada tanda tangan metode. Buat instance dari [`TemplateLoadOptions`](../../../com.aspose.html.loading/templateloadoptions/). Gunakan metode ConvertTemplate() dari kelas Converter untuk menggabungkan templat dengan data. Anda juga dapat menambahkan [`configuration`](../../../com.aspose.html/configuration/) sebagai parameter opsi. Kode sumber
...
Gabungkan sumber HTML templat yang disajikan oleh jalur file lengkap dengan data templat (XML, JSON). Hasilnya adalah file html yang dibuat berdasarkan jalur file output.
...
Gabungkan sumber HTML templat yang disajikan oleh konten inline dengan data templat (XML, JSON). Hasilnya adalah file html yang dibuat berdasarkan jalur file output.
...
| baseUrl | String | URI dasar templat html. Ini akan digabungkan dengan jalur direktori saat ini untuk membentuk URL absolut. |
| data | TemplateData | Data templat untuk penggabungan - substitusi (XML, JSON). |
| options | TemplateLoadOptions | [`TemplateLoadOptions`](../../../com.aspose.html.loading/templateloadoptions/) instance objek. Ini digunakan untuk menentukan apakah nama templat dan item data cocok, terlepas dari huruf besar/kecil atau tidak (opsi). |
| outputPath | String | Jalur file html lengkap sebagai hasil konversi keluaran. |
...
[`HTMLDocument`](../../../com.aspose.html/htmldocument/) baru yang terbentuk sebagai hasil konversi yang dapat disimpan melalui jalur file keluaran.
...
...
      ...
      using (var template = new HTMLDocument(sourcePath, new Configuration()))
      {
        ...
        // Simpan hasil dengan sumber daya yang ditautkan
...
import com.aspose.html.converters;  
...
      // Buat Url ke file sumber html kerangka
      var sourceUrl = new Url(Path.Combine(InputFolder, "source.html"));
...
...
      ...
      // Inisialisasi proses konversi dan simpan hasil
