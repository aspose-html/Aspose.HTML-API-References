...
description: "Metode Converter. Mengonversi sumber markdown MD yang disajikan oleh aliran masukan ke html. Hasilnya adalah HTMLDocument yang dapat disimpan melalui jalur file keluaran."
type: docs
...
Konversi sumber MD (markdown) yang disajikan oleh aliran masukan ke html. Hasilnya adalah [`HTMLDocument`](../../../com.aspose.html/htmldocument/) yang dapat disimpan melalui jalur file keluaran.
...
Konversi sumber MD (markdown) yang disajikan oleh jalur file lengkap ke html. Hasilnya adalah [`HTMLDocument`](../../../com.aspose.html/htmldocument/) yang dapat disimpan melalui jalur file keluaran.
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| sourcePath | String | Jalur ke file Markdown sumber. Ini akan digabungkan dengan jalur direktori saat ini untuk membentuk URL absolut. |
| outputPath | String | Jalur file html lengkap sebagai hasil konversi keluaran. |
