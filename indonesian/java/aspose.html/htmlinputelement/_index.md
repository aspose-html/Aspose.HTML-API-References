---
title: "Kelas HTMLInputElement"
second_title: "Referensi API Aspose.HTML untuk Java"
description: "kelas com.aspose.html.HTMLInputElement. Kontrol formulir. Tergantung pada lingkungan tempat halaman dilihat, properti nilai mungkin hanya-baca untuk tipe input unggah file. Untuk tipe input kata sandi, nilai yang dikembalikan sebenarnya dapat disamarkan untuk mencegah penggunaan tidak sah. Lihat definisi elemen INPUT dalam HTML 4.01. Lihat juga Spesifikasi Document Object Model DOM Level 2 HTML."
type: docs

url: /id/java/com.aspose.html/htmlinputelement/
---
## HTMLInputElement class

Kontrol formulir. Tergantung pada lingkungan tempat halaman dilihat, properti value mungkin hanya-baca untuk tipe input unggah berkas. Untuk tipe input "password", nilai sebenarnya yang dikembalikan dapat disamarkan untuk mencegah penggunaan tidak sah. Lihat definisi elemen INPUT dalam [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224)]. Lihat juga [Document object Model (DOM) Level 2 HTML Specification](http://www.w3.org/TR/2003/REC-DOM-Level-2-HTML-20030109).
...
| [getFiles](../../com.aspose.html/htmlinputelement/files/) Atribut IDL files memungkinkan skrip mengakses file yang dipilih elemen. Pada saat pengambilan, jika atribut IDL berlaku, harus mengembalikan objek FileList yang mewakili file terpilih saat ini. Objek yang sama harus dikembalikan sampai daftar file terpilih berubah. Jika atribut IDL tidak berlaku, maka harus mengembalikan null. [FILEAPI] |
...
import (var document = new HTMLDocument(inputHtmlPath))
{
	...
	// Elemen Input untuk Nama belakang
