...
description: "Uint8ClampedArray konstruktor. Menginisialisasi sebuah instance baru dari kelas Uint8ClampedArray"
type: docs

url: /id/java/com.aspose.html/uint8clampedarray/uint8clampedarray/
---
## Uint8ClampedArray(int) {#constructor_4}

Menginisialisasi sebuah instance baru dari kelas [`Uint8ClampedArray`](../).
...
| --- | --- | --- |
| panjang | Int32 | Panjang (jumlah elemen). |
