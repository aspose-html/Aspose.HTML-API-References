...
description: "kelas com.aspose.html.HTMLTableSectionElement. Elemen THEAD, TFOOT, dan TBODYelements"
type: docs
...
| [deleteRow](../../com.aspose.html/htmltablesectionelement/deleterow/)(int) | Hapus satu baris dari bagian ini. |
...
| [insertRow](../../com.aspose.html/htmltablesectionelement/insertrow/)(int) | Sisipkan satu baris ke dalam bagian ini. Baris baru dimasukkan tepat sebelum baris ke-`index` saat ini dalam bagian ini. Jika `index` adalah -1 atau sama dengan jumlah baris dalam bagian ini, baris baru akan ditambahkan di akhir. |
