---
title: "Kelas HTMLDocument"
second_title: "Referensi API Aspose.HTML untuk Java"
description: "kelas com.aspose.html.HTMLDocument. Mewakili sebuah dokumen HTML. Semua objek HTML tingkat atas ditambahkan ke objek ini. Kelas ini mewakili halaman HTML sebagaimana yang kita lihat di peramban. Semua formulir, tabel, skrip ... ditambahkan ke halaman HTML melalui antarmuka kelas ini. HTMLDocument adalah implementasi HTML dari antarmuka Document yang paling umum dan keduanya merupakan titik inti atau akar dari DOM - Document Object Model. Konsep-konsep ini sepenuhnya sesuai dengan dasar atau standar pengembangan web resmi. Untuk keperluan pengembangan web, Anda dapat secara umum menganggap HTMLDocument sebagai alias untuk Document yang menjadi dasar HTMLDocument."
type: docs

url: /id/java/com.aspose.html/htmldocument/
---
## HTMLDocument class

Mewakili sebuah dokumen HTML. Semua objek HTML tingkat atas ditambahkan ke objek ini. Kelas ini mewakili halaman HTML sebagaimana yang kita lihat di peramban. Semua formulir, tabel, skrip, ... ditambahkan ke halaman HTML melalui antarmuka kelas ini. [HTMLDocument](https://dom.spec.whatwg.org/#ref-for-dom-domimplementation-createhtmldocument) adalah implementasi HTML dari antarmuka [Document](https://dom.spec.whatwg.org/#document) yang paling umum dan keduanya merupakan inti atau titik akar dari [DOM](https://dom.spec.whatwg.org/) - Document Object Model. Konsep-konsep ini sepenuhnya sesuai dengan dasar atau standar resmi pengembangan web. Untuk keperluan pengembangan web, Anda dapat menganggap HTMLDocument sebagai alias untuk Document, yang menjadi dasar HTMLDocument.
...
| Nama | Deskripsi |
| --- | --- |
| [HTMLDocument](htmldocument/#constructor)() | Konstruktor HTMLDocument membuat objek Dokumen HTML baru yang merupakan halaman web yang dimuat di peramban dan berfungsi sebagai titik masuk ke konten halaman. |
| [HTMLDocument](htmldocument/#constructor_1)(Configuration) | Konstruktor HTMLDocument membuat objek Dokumen HTML baru yang merupakan halaman web yang dimuat di peramban dan berfungsi sebagai titik masuk ke konten halaman. |
| [HTMLDocument](htmldocument/#constructor_2)(RequestMessage) | Membuat dokumen HTML dari objek [`RequestMessage`](../../com.aspose.html.net/requestmessage/). |
| [HTMLDocument](htmldocument/#constructor_10)(String) | Memuat dokumen HTML dari sebuah alamat. |
| [HTMLDocument](htmldocument/#constructor_4)(Url) | Memuat dokumen HTML dari sebuah URL. |
| [HTMLDocument](htmldocument/#constructor_3)(RequestMessage, Configuration) | Membuat dokumen HTML dari objek [RequestMessage](T:com.aspose.html.net.RequestMessage). |
| [HTMLDocument](htmldocument/#constructor_8)(Stream, String) | Membuat dokumen HTML dari konten [Stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream) dengan base-uri yang ditentukan yang digunakan untuk menyelesaikan jalur sumber daya relatif. |
| [HTMLDocument](htmldocument/#constructor_6)(Stream, Url) | Membuat dokumen HTML dari konten [Stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream) dengan base-uri yang ditentukan yang digunakan untuk menyelesaikan jalur sumber daya relatif. |
| [HTMLDocument](htmldocument/#constructor_11)(String, Configuration) | Memuat dokumen HTML dari sebuah alamat dengan pengaturan konfigurasi lingkungan yang ditentukan. |
| [HTMLDocument](htmldocument/#constructor_14)(String, String) | Membuat dokumen HTML dari konten String dengan base-uri yang ditentukan. |
| [HTMLDocument](htmldocument/#constructor_12)(String, Url) | Membuat dokumen HTML dari konten String dengan base-uri yang ditentukan. |
| [HTMLDocument](htmldocument/#constructor_5)(Url, Configuration) | Memuat dokumen HTML dari sebuah URL dengan pengaturan konfigurasi lingkungan yang ditentukan. |
| [HTMLDocument](htmldocument/#constructor_9)(Stream, String, Configuration) | Membuat dokumen HTML dari konten [Stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream) dengan base-uri dan pengaturan konfigurasi lingkungan yang ditentukan. |
| [HTMLDocument](htmldocument/#constructor_7)(Stream, Url, Configuration) | Membuat dokumen HTML dari konten [Stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream) dengan base-uri dan pengaturan konfigurasi lingkungan yang ditentukan. |
| [HTMLDocument](htmldocument/#constructor_15)(String, String, Configuration) | Membuat dokumen HTML dari konten String dengan base-uri dan pengaturan konfigurasi lingkungan yang ditentukan. |
| [HTMLDocument](htmldocument/#constructor_13)(String, Url, Configuration) | Membuat dokumen HTML dari konten String dengan base-uri dan pengaturan konfigurasi lingkungan yang ditentukan. |

## Properti

| Nama | Deskripsi |
| --- | --- |
| [getAnchors](../../com.aspose.html/htmldocument/anchors/) Sekumpulan semua elemen jangkar (`A`) dalam sebuah dokumen dengan nilai untuk atribut `name`. Karena alasan kompatibilitas mundur, kumpulan jangkar yang dikembalikan hanya berisi jangkar yang dibuat dengan atribut `name`, bukan yang dibuat dengan atribut `id`. Catatan bahwa dalam [[XHTML 1.0](http://www.w3.org/TR/2002/REC-xhtml1-20020801)], atribut `name` (lihat bagian 4.10) tidak memiliki semantik dan hanya ada untuk agen pengguna lama: atribut `id` digunakan sebagai gantinya. Pengguna sebaiknya lebih memilih mekanisme iterator yang disediakan oleh [[DOM Level 2 Traversal](http://www.w3.org/TR/2000/REC-DOM-Level-2-Traversal-Range-20001113)] sebagai gantinya. |
| [getApplets](../../com.aspose.html/htmldocument/applets/) Sekumpulan semua elemen `OBJECT` yang mencakup applet dan elemen `APPLET` (usang) dalam sebuah dokumen. |
| [getBaseURI](../../com.aspose.html.dom/document/baseuri/) URI basis absolut dari node ini atau null jika implementasi tidak dapat memperoleh URI absolut. |
[getBody]
...
| [getChildElementCount](../../com.aspose.html.dom/document/childelementcount/) Mengembalikan jumlah saat ini dari node elemen yang menjadi anak dari elemen ini. 0 jika elemen ini tidak memiliki node anak dengan nodeType 1. |
...
| [getContext](../../com.aspose.html.dom/document/context/) Mendapatkan konteks penelusuran saat ini. |
| [getDefaultView](../../com.aspose.html.dom/document/defaultview/) Atribut IDL defaultView dari antarmuka Document, saat diakses, harus mengembalikan objek WindowProxy dari konteks penelusuran Document ini, jika Document ini memiliki konteks penelusuran yang terkait, atau null jika tidak. |
...
| [getDocumentURI](../../com.aspose.html.dom/document/documenturi/) Lokasi dokumen atau null jika tidak terdefinisi atau jika Document dibuat menggunakan DOMImplementation.createDocument. |
| [getDomain](../../com.aspose.html/htmldocument/domain/) Nama domain server yang menyajikan dokumen, atau `null` jika server tidak dapat diidentifikasi dengan nama domain. |
...
| [getForms](../../com.aspose.html/htmldocument/forms/) Sekumpulan semua formulir dalam sebuah dokumen. |
| [getImages](../../com.aspose.html/htmldocument/images/) Sekumpulan semua elemen `IMG` dalam sebuah dokumen. Perilaku dibatasi pada elemen `IMG` untuk kompatibilitas mundur. Seperti yang disarankan oleh [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224)], untuk menyertakan gambar, penulis dapat menggunakan elemen `OBJECT` atau elemen `IMG`. Oleh karena itu, disarankan untuk tidak menggunakan atribut ini untuk menemukan gambar dalam dokumen, melainkan menggunakan `getElementsByTagName` dengan HTML 4.01 atau `getElementsByTagNameNS` dengan XHTML 1.0. |
...
| [getLinks](../../com.aspose.html/htmldocument/links/) Sekumpulan semua elemen `AREA` dan jangkar (`A`) dalam sebuah dokumen dengan nilai untuk atribut `href`. |
...
| [getNextElementSibling](../../com.aspose.html.dom/document/nextelementsibling/) Mengembalikan node elemen saudara berikutnya dari elemen ini. null jika elemen ini tidak memiliki node elemen saudara yang datang setelahnya dalam pohon dokumen. |
...
| [getPreviousElementSibling](../../com.aspose.html.dom/document/previouselementsibling/) Mengembalikan node elemen saudara sebelumnya dari elemen ini. null jika elemen ini tidak memiliki node elemen saudara yang datang sebelum elemen ini dalam pohon dokumen. |
...
| [getReadyState](../../com.aspose.html.dom/document/readystate/) Mengembalikan status kesiapan dokumen. "loading" saat Document sedang dimuat, "interactive" setelah selesai parsing namun masih memuat sub-sumber daya, dan "complete" setelah selesai dimuat. |
| [getReferrer](../../com.aspose.html/htmldocument/referrer/) Mengembalikan URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt)] dari halaman yang menautkan ke halaman ini. Nilainya adalah String kosong jika pengguna menavigasi ke halaman secara langsung (bukan melalui tautan, tetapi, misalnya, melalui bookmark). |
...
| [textContent](../../com.aspose.html.dom/node/textcontent/) { get; set; } | Properti textContent dari antarmuka [`Node`](../../com.aspose.html.dom/node/) mewakili konten teks dari node dan turunannya. |
[getTitle]
...
| [createDocumentFragment](../../com.aspose.html.dom/document/createdocumentfragment/)() | Membuat sebuah [`DocumentFragment`](../../com.aspose.html.dom/documentfragment/) kosong baru yang dapat ditambahkan node DOM untuk membangun pohon DOM di luar layar. |
...
| [createElement](../../com.aspose.html.dom/document/createelement/)(String) | Dalam dokumen HTML, metode document.createElement() membuat elemen HTML yang ditentukan oleh tagName, atau sebuah [`HTMLUnknownElement`](../htmlunknownelement/) jika tagName tidak dikenali. |
...
| [createExpression](../../com.aspose.html.dom/document/createexpression/)(String, IXPathNSResolver) | Membuat ekspresi XPath yang telah diparse dengan paket yang terresolusi. Ini berguna ketika ekspresi akan digunakan kembali dalam aplikasi karena memungkinkan mengkompilasi String ekspresi menjadi bentuk internal yang lebih efisien dan mempraresolusi semua prefiks paket yang muncul dalam ekspresi. |
| [createNodeIterator](../../com.aspose.html.dom/document/createnodeiterator/)(Node) | Buat NodeIterator baru pada subtree yang berakar di node yang ditentukan. |
| [createNodeIterator](../../com.aspose.html.dom/document/createnodeiterator/)(Node, long) | Buat NodeIterator baru pada subtree yang berakar di node yang ditentukan. |
| [createNodeIterator](../../com.aspose.html.dom/document/createnodeiterator/)(Node, long, INodeFilter) | Buat NodeIterator baru pada subtree yang berakar di node yang ditentukan. |
...
| [createTreeWalker](../../com.aspose.html.dom/document/createtreewalker/)(Node) | Buat TreeWalker baru pada subtree yang berakar di node yang ditentukan. |
| [createTreeWalker](../../com.aspose.html.dom/document/createtreewalker/)(Node, long) | Buat TreeWalker baru pada subtree yang berakar di node yang ditentukan. |
| [createTreeWalker](../../com.aspose.html.dom/document/createtreewalker/)(Node, long, INodeFilter) | Buat TreeWalker baru pada subtree yang berakar di node yang ditentukan. |
...
| [getElementsByTagName](../../com.aspose.html.dom/document/getelementsbytagname/)(String) | Metode getElementsByTagName dari antarmuka [`Document`](../../com.aspose.html.dom/document/) mengembalikan sebuah [`HTMLCollection`](../../com.aspose.html.collections/htmlcollection/) dari elemen dengan nama tag yang diberikan. |
| [getElementsByTagNameNS](../../com.aspose.html.dom/document/getelementsbytagnamens/)(String, String) | Mengembalikan daftar elemen dengan nama tag yang diberikan yang termasuk dalam paket yang diberikan. Seluruh dokumen dicari, termasuk node akar. |
| [getOverrideStyle](../../com.aspose.html/htmldocument/getoverridestyle/)(Element, String) | Metode ini digunakan untuk mengambil deklarasi gaya override untuk elemen tertentu dan pseudo-elemen tertentu. |
...
| [renderTo](../../com.aspose.html/htmldocument/renderto/)(IDevice) | Metode ini digunakan untuk mencetak isi dokumen saat ini ke perangkat yang ditentukan. |
...
| [save](../../com.aspose.html/htmldocument/save/#save)(ResourceHandler) | Menyimpan konten dokumen dan sumber daya menggunakan [`ResourceHandler`](../../com.aspose.html.saving.resourcehandlers/resourcehandler/). |
| [save](../../com.aspose.html/htmldocument/save/#save_10)(String) | Menyimpan dokumen ke file lokal yang ditentukan oleh path. Semua sumber daya yang digunakan dalam dokumen ini akan disimpan ke dalam folder terdekat, yang namanya akan dibangun sebagai: output_file_name + "_files". |
| [save](../../com.aspose.html/htmldocument/save/#save_5)(Url) | Menyimpan dokumen ke file lokal yang ditentukan oleh url. Semua sumber daya yang digunakan dalam dokumen ini akan disimpan ke dalam folder bersebelahan, yang namanya akan dibangun sebagai output_file_name + "_files". |
| [save](../../com.aspose.html/htmldocument/save/#save_1)(ResourceHandler, HTMLSaveFormat) | Menyimpan konten dokumen dan sumber daya menggunakan [`ResourceHandler`](../../com.aspose.html.saving.resourcehandlers/resourcehandler/). |
| [save](../../com.aspose.html/htmldocument/save/#save_2)(ResourceHandler, HTMLSaveOptions) | Menyimpan konten dokumen dan sumber daya menggunakan [`ResourceHandler`](../../com.aspose.html.saving.resourcehandlers/resourcehandler/). |
| [save](../../com.aspose.html/htmldocument/save/#save_3)(ResourceHandler, MarkdownSaveOptions) | Menyimpan konten dokumen dan sumber daya menggunakan [`ResourceHandler`](../../com.aspose.html.saving.resourcehandlers/resourcehandler/). |
| [save](../../com.aspose.html/htmldocument/save/#save_4)(ResourceHandler, MHTMLSaveOptions) | Menyimpan konten dokumen dan sumber daya menggunakan [`ResourceHandler`](../../com.aspose.html.saving.resourcehandlers/resourcehandler/). |
| [save](../../com.aspose.html/htmldocument/save/#save_11)(String, HTMLSaveFormat) | Menyimpan dokumen ke file lokal yang ditentukan oleh path. Semua sumber daya yang digunakan dalam dokumen ini akan disimpan ke dalam folder bersebelahan, yang namanya akan dibangun sebagai output_file_name + "_files". |
| [save](../../com.aspose.html/htmldocument/save/#save_12)(String, HTMLSaveOptions) | Menyimpan dokumen ke file lokal yang ditentukan oleh path. Semua sumber daya yang digunakan dalam dokumen ini akan disimpan ke dalam folder terdekat, yang namanya akan dibangun sebagai: output_file_name + "_files". |
| [save](../../com.aspose.html/htmldocument/save/#save_13)(String, MarkdownSaveOptions) | Menyimpan dokumen ke file lokal yang ditentukan oleh path. Semua sumber daya yang digunakan dalam dokumen ini akan disimpan ke dalam folder terdekat, yang namanya akan dibangun sebagai: output_file_name + "_files". |
| [save](../../com.aspose.html/htmldocument/save/#save_14)(String, MHTMLSaveOptions) | Menyimpan dokumen ke file lokal yang ditentukan oleh path. Semua sumber daya yang digunakan dalam dokumen ini akan disimpan ke dalam folder terdekat, yang namanya akan dibangun sebagai: output_file_name + "_files". |
| [save](../../com.aspose.html/htmldocument/save/#save_6)(Url, HTMLSaveFormat) | Menyimpan dokumen ke file lokal yang ditentukan oleh url. Semua sumber daya yang digunakan dalam dokumen ini akan disimpan ke dalam folder bersebelahan, yang namanya akan dibangun sebagai output_file_name + "_files". |
| [save](../../com.aspose.html/htmldocument/save/#save_7)(Url, HTMLSaveOptions) | Menyimpan dokumen ke file lokal yang ditentukan oleh url. Semua sumber daya yang digunakan dalam dokumen ini akan disimpan ke dalam folder bersebelahan, yang namanya akan dibangun sebagai: output_file_name + "_files". |
| [save](../../com.aspose.html/htmldocument/save/#save_8)(Url, MarkdownSaveOptions) | Menyimpan dokumen ke file lokal yang ditentukan oleh url. Semua sumber daya yang digunakan dalam dokumen ini akan disimpan ke dalam folder bersebelahan, yang namanya akan dibangun sebagai: output_file_name + "_files". |
| [save](../../com.aspose.html/htmldocument/save/#save_9)(Url, MHTMLSaveOptions) | Menyimpan dokumen ke file lokal yang ditentukan oleh url. Semua sumber daya yang digunakan dalam dokumen ini akan disimpan ke dalam folder bersebelahan, yang namanya akan dibangun sebagai: output_file_name + "_files". |
| [toString](../../com.aspose.html.dom/node/toString/)() | Mengembalikan String yang mewakili instance ini. |
| [write](../../com.aspose.html.dom/document/write/)(params String[]) | Menulis sebuah String teks ke aliran dokumen yang dibuka oleh open(). Perhatikan bahwa fungsi ini akan menghasilkan dokumen yang tidak selalu didorong oleh DTD sehingga mungkin menghasilkan hasil yang tidak valid dalam konteks dokumen. |
| [writeLn](../../com.aspose.html.dom/document/writeln/)(params String[]) | Menulis sebuah String teks yang diikuti oleh karakter baris baru ke aliran dokumen yang dibuka oleh open(). Perhatikan bahwa fungsi ini akan menghasilkan dokumen yang tidak selalu didorong oleh DTD sehingga mungkin menghasilkan hasil yang tidak valid dalam konteks dokumen. |

## Peristiwa

| Nama | Deskripsi |
| --- | --- |
| event [OnAbort](../../com.aspose.html.dom/document/onabort/) | Mendapatkan atau mengatur penangan peristiwa untuk event OnAbort. |
| event [OnBlur](../../com.aspose.html.dom/document/onblur/) | Mendapatkan atau mengatur penangan peristiwa untuk event OnBlur. |
| event [OnCancel](../../com.aspose.html.dom/document/oncancel/) | Mendapatkan atau mengatur penangan peristiwa untuk event OnCancel. |
| event [OnCanplay](../../com.aspose.html.dom/document/oncanplay/) | Mendapatkan atau mengatur penangan peristiwa untuk event OnCanplay. |
| event [OnCanPlayThrough](../../com.aspose.html.dom/document/oncanplaythrough/) | Mendapatkan atau mengatur penangan peristiwa untuk event OnCanPlayThrough. |
| event [OnChange](../../com.aspose.html.dom/document/onchange/) | Mendapatkan atau mengatur penangan peristiwa untuk event OnChange. |
| event [OnClick](../../com.aspose.html.dom/document/onclick/) | Mendapatkan atau mengatur penangan peristiwa untuk event OnClick. |
| event [OnCueChange](../../com.aspose.html.dom/document/oncuechange/) | Mendapatkan atau mengatur penangan peristiwa untuk event OnCueChange. |
| event [OnDblClick](../../com.aspose.html.dom/document/ondblclick/) | Mendapatkan atau mengatur penangan peristiwa untuk event OnDblClick. |
| event [OnDurationChange](../../com.aspose.html.dom/document/ondurationchange/) | Mendapatkan atau mengatur penangan peristiwa untuk event OnDurationChange. |
| event [OnEmptied](../../com.aspose.html.dom/document/onemptied/) | Mendapatkan atau mengatur penangan peristiwa untuk event OnEmptied. |
| event [OnEnded](../../com.aspose.html.dom/document/onended/) | Mendapatkan atau mengatur penangan peristiwa untuk event OnEnded. |
| event [OnError](../../com.aspose.html.dom/document/onerror/) | Mendapatkan atau mengatur penangan peristiwa untuk event OnError. |
| event [OnFocus](../../com.aspose.html.dom/document/onfocus/) | Mendapatkan atau mengatur penangan peristiwa untuk event OnFocus. |
| event [OnInput](../../com.aspose.html.dom/document/oninput/) | Mendapatkan atau mengatur penangan peristiwa untuk event OnInput. |
...
Informasi lebih lanjut tentang HTMLDocument, Document, dan DOM dapat diperoleh di sumber daya pengembangan web populer:
...
```java
	...
	using (var document = new HTMLDocument())
      {
        // Buat elemen style dan tetapkan warna hijau untuk semua elemen dengan class-name yang sama dengan 'gr'.
        var style = document.CreateElement("style");
        style.TextContent = ".gr { color: green }";

        // Temukan elemen header dokumen dan tambahkan elemen style ke header
        var head = document.GetElementsByTagName("head").First();
        head.AppendChild(style);

        // Buat elemen paragraf dengan class-name 'gr'.
        ...
        // Tambahkan paragraf ke elemen body dokumen
        document.Body.AppendChild(p);

        // Simpan dokumen HTML ke file 
        document.Save(Path.Combine(OutputDir, "using-dom.html"));

        // Buat sebuah instance dari perangkat output PDF dan render dokumen ke dalam perangkat ini
