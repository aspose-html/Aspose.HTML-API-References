...
| Nama | Deskripsi |
| --- | --- |
| [getAnchors](../../com.aspose.html/htmldocument/anchors/) Kumpulan semua elemen jangkar (`A`) dalam sebuah dokumen dengan nilai untuk atribut `name`. Karena alasan kompatibilitas mundur, kumpulan jangkar yang dikembalikan hanya berisi jangkar yang dibuat dengan atribut `name`, bukan yang dibuat dengan atribut `id`. Perhatikan bahwa dalam [[XHTML 1.0](http://www.w3.org/TR/2002/REC-xhtml1-20020801)], atribut `name` (lihat bagian 4.10) tidak memiliki makna semantik dan hanya ada untuk agen pengguna lama: atribut `id` digunakan sebagai gantinya. Pengguna sebaiknya menggunakan mekanisme iterator yang disediakan oleh [[DOM Level 2 Traversal](http://www.w3.org/TR/2000/REC-DOM-Level-2-Traversal-Range-20001113)] sebagai gantinya. |
| [getApplets](../../com.aspose.html/htmldocument/applets/) Kumpulan semua elemen `OBJECT` yang mencakup applet dan elemen `APPLET` (usang) dalam sebuah dokumen. |
...
| [getForms](../../com.aspose.html/htmldocument/forms/) Kumpulan semua formulir dalam sebuah dokumen. |
| [getImages](../../com.aspose.html/htmldocument/images/) Kumpulan semua elemen `IMG` dalam sebuah dokumen. Perilaku dibatasi pada elemen `IMG` untuk kompatibilitas mundur. Seperti yang disarankan oleh [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224)], untuk menyertakan gambar, penulis dapat menggunakan elemen `OBJECT` atau elemen `IMG`. Oleh karena itu, disarankan untuk tidak menggunakan atribut ini untuk menemukan gambar dalam dokumen tetapi menggunakan `getElementsByTagName` dengan HTML 4.01 atau `getElementsByTagNameNS` dengan XHTML 1.0. |
...
| [getLinks](../../com.aspose.html/htmldocument/links/) Kumpulan semua elemen `AREA` dan jangkar (`A`) dalam sebuah dokumen dengan nilai untuk atribut `href`. |
...
Info lebih lanjut tentang HTMLDocument, Document, dan DOM dapat diperoleh di sumber daya pengembangan web populer:
...
```java
	...
	using (var document = new HTMLDocument())
      {
        // Buat elemen style dan tetapkan warna hijau untuk semua elemen dengan class-name sama dengan 'gr'.
        ...
        // Simpan dokumen HTML ke sebuah file 
