...
description: "kelas com.aspose.html.HTMLElement. Semua antarmuka elemen HTML diturunkan dari kelas ini. Elemen yang hanya menampilkan atribut inti HTML diwakili oleh antarmuka dasar HTMLElement. Elemen-elemen ini adalah sebagai berikut khusus SUB SUP SPAN BDOfont TT I B U S STRIKE BIG SMALL phrase EM STRONG DFN CODE SAMP KBD VAR CITE ACRONYM ABBRlist DD DTNOFRAMES NOSCRIPTADDRESS CENTER. Atribut style dari sebuah elemen HTML dapat diakses melalui antarmuka ElementCSSInlineStyle yang didefinisikan dalam modul CSS DOM Level 2 Style Sheets dan CSS"
type: docs
...
Semua antarmuka elemen HTML diturunkan dari kelas ini. Elemen yang hanya menampilkan atribut inti HTML diwakili oleh antarmuka dasar `HTMLElement`. Elemen‑elemen tersebut adalah sebagai berikut: khusus: SUB, SUP, SPAN, BDOfont: TT, I, B, U, S, STRIKE, BIG, SMALL frasa: EM, STRONG, DFN, CODE, SAMP, KBD, VAR, CITE, ACRONYM, ABBR daftar: DD, DTNOFRAMES, NOSCRIPTADDRESS, CENTERAtribut `style` dari sebuah elemen HTML dapat diakses melalui antarmuka `ElementCSSInlineStyle` yang didefinisikan dalam modul CSS [[DOM Level 2 Style Sheets and CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113)].
