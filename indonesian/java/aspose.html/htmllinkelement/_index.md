---
title: "HTMLLinkElement Kelas"
second_title: "Referensi API Aspose.HTML untuk Java"
description: "com.aspose.html.HTMLLinkElement class. Elemen LINK menentukan tautan ke sumber eksternal dan mendefinisikan hubungan dokumen ini dengan sumber tersebut atau sebaliknya. Lihat definisi elemen LINK dalam HTML 4.01, lihat juga antarmuka LinkStyle dalam modul StyleSheet DOM Level 2 Style Sheets dan CSS."
type: docs

url: /id/java/com.aspose.html/htmllinkelement/
---
## HTMLLinkElement class

Elemen `LINK` menentukan tautan ke sumber eksternal, dan mendefinisikan hubungan dokumen ini dengan sumber tersebut (atau sebaliknya). Lihat definisi elemen LINK dalam HTML 4.01 (lihat juga antarmuka `LinkStyle` dalam modul StyleSheet [[DOM Level 2 Style Sheets and CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113)]).
...
| [getRelList](../../com.aspose.html/htmllinkelement/rellist/) Mengembalikan DOMTokenList yang hidup yang berisi token yang diperoleh dari parsing atribut "rel". |
[getRev]
...
| [getSheet](../../com.aspose.html/htmllinkelement/sheet/) Mendapatkan style sheet yang terkait. |
