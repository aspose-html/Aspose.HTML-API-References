---
title: "Kelas HTMLTableElement"
second_title: "Referensi API Aspose.HTML untuk Java"
description: "kelas com.aspose.html.HTMLTableElement. Metode create dan delete pada tabel memungkinkan penulis untuk membuat dan memodifikasi tabel. HTML 4.01 menentukan bahwa hanya satu elemen masing‑masing CAPTION, THEAD, dan TFOOT yang dapat ada dalam sebuah tabel. Oleh karena itu, jika satu sudah ada dan metode createTHead atau createTFoot dipanggil, metode tersebut mengembalikan elemen THead atau TFoot yang sudah ada. Lihat definisi elemen TABLE dalam HTML 4.01."
type: docs

url: /id/java/com.aspose.html/htmltableelement/
---
## HTMLTableElement class

Metode create* dan delete* pada tabel memungkinkan penulis untuk membuat dan memodifikasi tabel. [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224)] menentukan bahwa hanya satu dari masing‑masing elemen `CAPTION`, `THEAD`, dan `TFOOT` yang boleh ada dalam sebuah tabel. Oleh karena itu, jika satu sudah ada, dan metode createTHead() atau createTFoot() dipanggil, metode tersebut mengembalikan elemen THead atau TFoot yang sudah ada. Lihat definisi elemen TABLE dalam HTML 4.01.
...
| [getCaption](../../com.aspose.html/htmltableelement/caption/) Mengembalikan `CAPTION` tabel, atau void jika tidak ada. @version DOM Level 2 |
[getCellPadding]
...
| [getRows](../../com.aspose.html/htmltableelement/rows/) Mengembalikan `TFOOT` tabel, atau `null` jika tidak ada. |
[getRules]
...
| [getStyle](../../com.aspose.html/htmlelement/style/) Mewakili atribut style yang memungkinkan penulis untuk langsung menerapkan informasi style pada elemen tertentu. |
[getSummary]
...
| [getTBodies](../../com.aspose.html/htmltableelement/tbodies/) Mengembalikan koleksi tubuh tabel (termasuk yang implisit). |
...
| [getTFoot](../../com.aspose.html/htmltableelement/tfoot/) Mengembalikan `THEAD` tabel, atau `null` jika tidak ada. |
| [getTHead](../../com.aspose.html/htmltableelement/thead/) Mengembalikan `CAPTION` tabel, atau void jika tidak ada. |
[getTitle]
...
| [createCaption](../../com.aspose.html/htmltableelement/createcaption/)() | Buat objek caption tabel baru atau kembalikan yang sudah ada. |
| [createTFoot](../../com.aspose.html/htmltableelement/createtfoot/)() | Buat baris footer tabel atau kembalikan yang sudah ada. |
| [createTHead](../../com.aspose.html/htmltableelement/createthead/)() | Buat baris header tabel atau kembalikan yang sudah ada. |
| [deleteCaption](../../com.aspose.html/htmltableelement/deletecaption/)() | Hapus caption tabel, jika ada. |
| [deleteRow](../../com.aspose.html/htmltableelement/deleterow/)(int) | Hapus baris tabel. |
| [deleteTFoot](../../com.aspose.html/htmltableelement/deletetfoot/)() | Hapus footer dari tabel, jika ada. |
| [deleteTHead](../../com.aspose.html/htmltableelement/deletethead/)() | Hapus header dari tabel, jika ada. |
...
| Nama | Deskripsi |
| --- | --- |
| event [OnAbort](../../com.aspose.html/htmlelement/onabort/) | Mendapatkan atau mengatur penangan acara untuk acara OnAbort. |
| event [OnBlur](../../com.aspose.html/htmlelement/onblur/) | Mendapatkan atau mengatur penangan acara untuk acara OnBlur. |
| event [OnCancel](../../com.aspose.html/htmlelement/oncancel/) | Mendapatkan atau mengatur penangan acara untuk acara OnCancel. |
| event [OnCanplay](../../com.aspose.html/htmlelement/oncanplay/) | Mendapatkan atau mengatur penangan acara untuk acara OnCanplay. |
| event [OnCanPlayThrough](../../com.aspose.html/htmlelement/oncanplaythrough/) | Mendapatkan atau mengatur penangan acara untuk acara OnCanPlayThrough. |
| event [OnChange](../../com.aspose.html/htmlelement/onchange/) | Mendapatkan atau mengatur penangan acara untuk acara OnChange. |
| event [OnClick](../../com.aspose.html/htmlelement/onclick/) | Mendapatkan atau mengatur penangan acara untuk acara OnClick. |
| event [OnCueChange](../../com.aspose.html/htmlelement/oncuechange/) | Mendapatkan atau mengatur penangan acara untuk acara OnCueChange. |
| event [OnDblClick](../../com.aspose.html/htmlelement/ondblclick/) | Mendapatkan atau mengatur penangan acara untuk acara OnDblClick. |
| event [OnDurationChange](../../com.aspose.html/htmlelement/ondurationchange/) | Mendapatkan atau mengatur penangan acara untuk acara OnDurationChange. |
| event [OnEmptied](../../com.aspose.html/htmlelement/onemptied/) | Mendapatkan atau mengatur penangan acara untuk acara OnEmptied. |
| event [OnEnded](../../com.aspose.html/htmlelement/onended/) | Mendapatkan atau mengatur penangan acara untuk acara OnEnded. |
| event [OnError](../../com.aspose.html/htmlelement/onerror/) | Mendapatkan atau mengatur penangan acara untuk acara OnError. |
| event [OnFocus](../../com.aspose.html/htmlelement/onfocus/) | Mendapatkan atau mengatur penangan acara untuk acara OnFocus. |
| event [OnInput](../../com.aspose.html/htmlelement/oninput/) | Mendapatkan atau mengatur penangan acara untuk acara OnInput. |
