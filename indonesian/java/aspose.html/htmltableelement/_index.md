...
description: "com.aspose.html.HTMLTableElement class. Metode create dan delete pada tabel memungkinkan penulis untuk membuat dan memodifikasi tabel. HTML 4.01 menentukan bahwa hanya satu elemen CAPTION, THEAD, dan TFOOT yang dapat ada dalam sebuah tabel. Oleh karena itu, jika salah satu sudah ada dan metode createTHead atau createTFoot dipanggil, metode tersebut mengembalikan elemen THead atau TFoot yang sudah ada. Lihat definisi elemen TABLE dalam HTML 4.01"
type: docs
...
| [getTBodies](../../com.aspose.html/htmltableelement/tbodies/) Mengembalikan koleksi badan tabel (termasuk yang implisit). |
