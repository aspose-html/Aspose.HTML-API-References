...
| --- | --- | --- |
| index | Int32 | Indeks baris yang akan dihapus. Indeks ini dimulai dari 0 dan relatif terhadap urutan logis (bukan urutan dokumen) semua baris yang terdapat dalam tabel. Jika indeks adalah -1, baris terakhir dalam tabel akan dihapus. |
