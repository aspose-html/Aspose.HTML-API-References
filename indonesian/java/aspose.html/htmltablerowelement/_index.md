...
description: "com.aspose.html.HTMLTableRowElement kelas. Sebuah baris dalam tabel. Lihat definisi elemen TR dalam HTML 4.01"
type: docs
...
Baris dalam tabel. Lihat definisi elemen TR dalam HTML 4.01.
...
| [getCells](../../com.aspose.html/htmltablerowelement/cells/) Kumpulan sel dalam baris ini. @version DOM Level 2 |
[getCh]
...
| [getRowIndex](../../com.aspose.html/htmltablerowelement/rowindex/) Ini dalam urutan logis dan bukan urutan dokumen. `rowIndex` memperhitungkan bagian (`THEAD`, `TFOOT`, atau `TBODY`) dalam tabel, menempatkan baris `THEAD` pertama dalam indeks, diikuti oleh baris `TBODY`, kemudian baris `TFOOT`. @version DOM Level 2 |
...
| [deleteCell](../../com.aspose.html/htmltablerowelement/deletecell/)(int) | Hapus sel dari baris saat ini. |
