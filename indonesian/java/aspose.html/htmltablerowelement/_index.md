---
title: "Kelas HTMLTableRowElement"
second_title: "Referensi API Aspose.HTML untuk Java"
description: "kelas com.aspose.html.HTMLTableRowElement. Sebuah baris dalam tabel. Lihat definisi elemen TR dalam HTML 4.01"
type: docs

url: /id/java/com.aspose.html/htmltablerowelement/
---
## HTMLTableRowElement class

Baris dalam sebuah tabel. Lihat definisi elemen TR dalam HTML 4.01.
...
| [getCells](../../com.aspose.html/htmltablerowelement/cells/) Koleksi sel dalam baris ini. @version DOM Level 2 |
[getCh]
...
| [getRowIndex](../../com.aspose.html/htmltablerowelement/rowindex/) Ini dalam urutan logis dan bukan urutan dokumen. `rowIndex` memperhitungkan bagian (`THEAD`, `TFOOT`, atau `TBODY`) dalam tabel, menempatkan baris `THEAD` pertama dalam indeks, diikuti oleh baris `TBODY`, diikuti oleh baris `TFOOT`. @version DOM Level 2 |
| [getSectionRowIndex](../../com.aspose.html/htmltablerowelement/sectionrowindex/) Indeks baris ini, relatif terhadap bagian saat ini (`THEAD`, `TFOOT`, atau `TBODY`), dimulai dari 0. @version DOM Level 2 |
...
| [deleteCell](../../com.aspose.html/htmltablerowelement/deletecell/)(int) | Hapus sebuah sel dari baris saat ini. |
...
| [insertCell](../../com.aspose.html/htmltablerowelement/insertcell/)(int) | Sisipkan sel `TD` kosong ke dalam baris ini. Jika `index` bernilai -1 atau sama dengan jumlah sel, sel baru akan ditambahkan di akhir. |
