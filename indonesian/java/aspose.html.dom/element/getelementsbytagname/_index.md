...
| --- | --- | --- |
| nama | String | Nama tag. Representasi string dari nama tag. |
...
Lihat [spec](https://dom.spec.whatwg.org/#dom-element-getelementsbytagname) resmi.
...
Konten paragraf kedua...

Konten paragraf ketiga...
