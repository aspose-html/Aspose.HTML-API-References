...
description: "kelas com.aspose.html.dom.Element. Antarmuka Element mewakili sebuah elemen dalam dokumen HTML atau XML"
type: docs

url: /id/java/com.aspose.html.dom/element/
---
## Element class

Antarmuka Element merepresentasikan sebuah elemen dalam dokumen HTML atau XML.
...
| Nama | Deskripsi |
| --- | --- |
| [Element](element/)(QualifiedName, Document) | Menginisialisasi instance baru dari kelas `Element`. Jangan panggil konstruktor ini secara langsung, gunakan [`CreateElement`](../document/createelement/) atau [`CreateElementNS`](../document/createelementns/). |
...
| [getParentElement](../../com.aspose.html.dom/node/parentelement/) Properti read-only parentElement dari antarmuka [`Node`](../node/) mengembalikan `Element` induk node DOM, atau null jika node tidak memiliki induk, atau induknya bukan Element DOM. |
...
| [getElementsByClassName](../../com.aspose.html.dom/element/getelementsbyclassname/)(String) | Mengembalikan objek [`HTMLCollection`](../../com.aspose.html.collections/htmlcollection/) yang berisi semua elemen dalam `element` yang memiliki semua kelas yang ditentukan dalam argumen. |
| [getElementsByTagName](../../com.aspose.html.dom/element/getelementsbytagname/)(String) | Mengembalikan objek [`HTMLCollection`](../../com.aspose.html.collections/htmlcollection/) yang berisi semua `elements` dengan nama tag tertentu, dalam urutan dokumen. |
| [getElementsByTagNameNS](../../com.aspose.html.dom/element/getelementsbytagnamens/)(String, String) | Mengembalikan objek [`HTMLCollection`](../../com.aspose.html.collections/htmlcollection/) yang berisi semua `elements` dengan nama lokal dan string URI paket tertentu, dalam urutan dokumen. |
...
| [toggleAttribute](../../com.aspose.html.dom/element/toggleattribute/#toggleattribute)(String) | Jika force tidak diberikan, "toggles" qualifiedName, menghapusnya jika ada dan menambahkannya jika tidak ada. Jika force bernilai true, menambahkan qualifiedName. Jika force bernilai false, menghapus qualifiedName. |
| [toggleAttribute](../../com.aspose.html.dom/element/toggleattribute/#toggleattribute_1)(String, bool) | Jika force tidak diberikan, "toggles" qualifiedName, menghapusnya jika ada dan menambahkannya jika tidak ada. Jika force bernilai true, menambahkan qualifiedName. Jika force bernilai false, menghapus qualifiedName. |
