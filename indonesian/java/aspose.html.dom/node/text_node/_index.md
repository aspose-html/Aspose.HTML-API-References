...
description: "Bidang Node. Teks sebenarnya di dalam Element atau Attr."
type: docs

url: /id/java/com.aspose.html.dom/node/text_node/
---
## Node.TEXT_NODE field

Teks sebenarnya [`Text`](../../text/) di dalam [`Element`](../../element/) atau [`Attr`](../../attr/).
