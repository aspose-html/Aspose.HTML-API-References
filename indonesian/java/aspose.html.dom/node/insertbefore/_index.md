...
Jika node yang diberikan sudah ada dalam dokumen, insertBefore() memindahkannya dari posisi saat ini ke posisi baru. (Artinya, node tersebut secara otomatis akan dihapus dari induk yang ada sebelum ditambahkan ke induk baru yang ditentukan.)
...
Mengembalikan anak yang ditambahkan (kecuali newNode adalah [`DocumentFragment`](../../documentfragment/), dalam hal ini [`DocumentFragment`](../../documentfragment/) kosong yang dikembalikan).
