...
| --- | --- | --- |
| localName | String | String yang menentukan jenis elemen yang akan dibuat. nodeName dari elemen yang dibuat diinisialisasi dengan nilai tagName. Jangan gunakan nama yang memenuhi syarat (seperti "html:a") dengan metode ini. Ketika dipanggil pada dokumen HTML, createElement() mengubah tagName menjadi huruf kecil sebelum membuat elemen. |
