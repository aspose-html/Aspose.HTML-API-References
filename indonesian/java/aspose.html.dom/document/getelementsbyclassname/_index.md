...
| --- | --- | --- |
| classNames | String | String String yang berisi sekumpulan token unik yang dipisahkan spasi secara tidak berurutan yang mewakili kelas (nama kelas) |
...
Lihat spesifikasi resmi [spec](https://dom.spec.whatwg.org/#dom-document-getelementsbyclassname).
...
Disesuaikan oleh kontainer kelas css
...
Span yang diberi gaya oleh pStyle
