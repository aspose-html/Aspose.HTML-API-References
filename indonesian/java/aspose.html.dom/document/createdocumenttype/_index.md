...
| --- | --- | --- |
| name | String | Adalah DOMString yang berisi nama yang memenuhi syarat, seperti svg:svg. |
| publicId | String | Adalah DOMString yang berisi pengidentifikasi PUBLIC. |
| systemId | String | Adalah DOMString yang berisi pengidentifikasi SYSTEM. |
