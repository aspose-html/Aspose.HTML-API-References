...
Seluruh dokumen dicari, termasuk node akar. [`HTMLCollection`](../../../com.aspose.html.collections/htmlcollection/) yang dikembalikan bersifat live, artinya ia memperbarui dirinya secara otomatis untuk tetap sinkron dengan pohon DOM tanpa harus memanggil document.getElementsByTagName() lagi.
...
Sebuah [`HTMLCollection`](../../../com.aspose.html.collections/htmlcollection/) yang live dari elemen yang ditemukan dalam urutan mereka muncul di pohon.

## Catatan

Lihat spesifikasi resmi [spec](https://dom.spec.whatwg.org/#dom-document-getelementsbytagname).
