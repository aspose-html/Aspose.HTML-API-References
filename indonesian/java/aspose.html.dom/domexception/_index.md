---
title: "DOMException Kelas"
second_title: "Referensi API Aspose.HTML untuk Java"
description: "kelas com.aspose.html.dom.DOMException. Antarmuka DOMException mewakili peristiwa abnormal yang disebut pengecualian yang terjadi sebagai hasil pemanggilan metode atau mengakses properti dari sebuah web API. Ini pada dasarnya cara kondisi error dijelaskan dalam web API."
type: docs
...
Antarmuka DOMException mewakili peristiwa abnormal (disebut pengecualian) yang terjadi sebagai akibat pemanggilan metode atau akses properti dari API web. Ini pada dasarnya cara kondisi kesalahan dijelaskan dalam API web.
...
| Nama | Deskripsi |
| --- | --- |
| [getCode](../../com.aspose.html.dom/domexception/code/) Mengembalikan nilai yang berisi salah satu konstanta kode error, atau 0 jika tidak ada yang cocok. Field ini digunakan untuk alasan historis. |
| [getMessage](../../com.aspose.html.dom/domexception/message/) Mengembalikan String yang mewakili pesan atau deskripsi yang terkait dengan nama error yang diberikan. |
| [getName](../../com.aspose.html.dom/domexception/name/) Mengembalikan String yang berisi salah satu String yang terkait dengan nama error. |
...
| const [INVALID_ACCESS_ERR](../../com.aspose.html.dom/domexception/invalid_access_err/) | Jika parameter atau operasi tidak didukung oleh objek dasar. |
...
| const [INVALID_EXPRESSION_ERR](../../com.aspose.html.dom/domexception/invalid_expression_err/) | Ekspresi memiliki kesalahan sintaks atau tidak merupakan ekspresi yang sah menurut aturan XPathEvaluator spesifik atau mengandung fungsi ekstensi khusus atau variabel yang tidak didukung oleh implementasi ini. |
...
| const [INVALID_STATE_ERR](../../com.aspose.html.dom/domexception/invalid_state_err/) | Jika ada upaya untuk menggunakan objek yang tidak, atau tidak lagi, dapat digunakan. |
| const [NAMESPACE_ERR](../../com.aspose.html.dom/domexception/package_err/) | Jika ada upaya untuk membuat atau mengubah objek dengan cara yang tidak tepat terkait paket. |
| const [NETWORK_ERR](../../com.aspose.html.dom/domexception/network_err/) | Terjadi kesalahan jaringan. |
| const [NOT_FOUND_ERR](../../com.aspose.html.dom/domexception/not_found_err/) | Jika ada upaya untuk merujuk Node dalam konteks di mana Node tersebut tidak ada. |
...
| const [NO_MODIFICATION_ALLOWED_ERR](../../com.aspose.html.dom/domexception/no_modification_allowed_err/) | Jika ada upaya untuk memodifikasi objek di mana modifikasi tidak diizinkan. |
| const [QUOTA_EXCEEDED_ERR](../../com.aspose.html.dom/domexception/quota_exceeded_err/) | Kuota telah terlampaui. |
| const [SECURITY_ERR](../../com.aspose.html.dom/domexception/security_err/) | Operasi ini tidak aman. |
| const [SYNTAX_ERR](../../com.aspose.html.dom/domexception/syntax_err/) | Jika String yang tidak valid atau ilegal ditentukan. |
| const [TIMEOUT_ERR](../../com.aspose.html.dom/domexception/timeout_err/) | Operasi mengalami batas waktu. |
