...
Jika skema dokumen adalah DTD atau tidak ada skema yang terkait dengan dokumen, metode ini selalu mengembalikan false. Jika skema dokumen adalah XML Schema, metode ini akan mengembalikan true jika definisi tipe referensi diturunkan dari definisi tipe lain menurut parameter derivasi. Jika nilai parameter adalah 0 (tidak ada bit yang diset ke 1 untuk parameter derivationMethod), metode ini akan mengembalikan true jika definisi tipe lain dapat dicapai dengan merekursi kombinasi apa pun dari {base type definition}, {item type definition}, atau {member type definitions} dari definisi tipe referensi.
