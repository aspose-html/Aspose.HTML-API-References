---
title: "Kelas CDATASection"
second_title: "Referensi API Aspose.HTML untuk Java"
description: "Kelas com.aspose.html.dom.CDATASection. Seksi CDATA digunakan untuk meloloskan blok teks yang berisi karakter yang sebaliknya akan dianggap sebagai markup"
type: docs

url: /id/java/com.aspose.html.dom/cdatasection/
---
## CDATASection class

Bagian CDATA digunakan untuk meng-escape blok teks yang berisi karakter yang seharusnya dianggap sebagai markup.
...
| [getIsElementContentWhitespace](../../com.aspose.html.dom/text/iselementcontentwhitespace/) Mengembalikan apakah node teks ini berisi spasi konten elemen, yang sering disebut secara tidak tepat \"ignorable whitespace\". |
...
| [getNodeName](../../com.aspose.html.dom/cdatasection/nodename/) Nama node ini, tergantung pada tipenya. |
| [getNodeType](../../com.aspose.html.dom/cdatasection/nodetype/) Kode yang mewakili tipe objek dasar. |
...
| [replaceWholeText](../../com.aspose.html.dom/text/replacewholetext/)(String) | Mengganti teks node saat ini dan semua node teks yang secara logis berdekatan dengan teks yang ditentukan. Semua node teks yang secara logis berdekatan dihapus termasuk node saat ini kecuali jika node tersebut menjadi penerima teks pengganti. |
