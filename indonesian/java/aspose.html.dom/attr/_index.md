...
description: "kelas com.aspose.html.dom.Attr. Antarmuka Attr mewakili sebuah atribut dalam objek Element. Biasanya nilai yang diizinkan untuk atribut tersebut didefinisikan dalam skema yang terkait dengan dokumen."
type: docs

url: /id/java/com.aspose.html.dom/attr/
---
## Attr class

Antarmuka Attr merepresentasikan atribut dalam objek Element. Biasanya nilai yang diizinkan untuk atribut tersebut didefinisikan dalam skema yang terkait dengan dokumen.
...
| [getLocalName](../../com.aspose.html.dom/attr/localname/) Mengembalikan bagian lokal dari nama terkwalifikasi node ini. Untuk node dengan tipe apa pun selain ELEMENT_NODE dan ATTRIBUTE_NODE serta node yang dibuat dengan metode DOM Level 1, seperti Document.createElement(), nilai ini selalu null. |
| [getName](../../com.aspose.html.dom/attr/name/) Mengembalikan nama atribut ini. |
| [getNamespaceURI](../../com.aspose.html.dom/attr/packageuri/) URI paket dari node ini, atau null jika tidak ditentukan. |
...
| [getNodeName](../../com.aspose.html.dom/attr/nodename/) Nama node ini, tergantung pada tipenya. |
| [getNodeType](../../com.aspose.html.dom/attr/nodetype/) Kode yang mewakili tipe objek dasar. |
| [nodeValue](../../com.aspose.html.dom/attr/nodevalue/) { get; set; } | Nilai node ini, tergantung pada tipenya. |
...
| [getOwnerElement](../../com.aspose.html.dom/attr/ownerelement/) Node Element tempat atribut ini terpasang atau null jika atribut ini tidak digunakan. |
...
| [getPrefix](../../com.aspose.html.dom/attr/prefix/) Prefiks paket dari node ini, atau null jika tidak ditentukan. Ketika diatur menjadi null, pengaturannya tidak berpengaruh. |
...
| [getSpecified](../../com.aspose.html.dom/attr/specified/) True jika atribut ini secara eksplisit diberikan nilai dalam dokumen instance, false jika tidak. |
| [textContent](../../com.aspose.html.dom/attr/textcontent/) { get; set; } | Atribut ini mengembalikan konten teks dari node ini dan turunannya. Ketika diatur menjadi null, pengaturannya tidak berpengaruh. Saat diatur, semua anak yang mungkin dimiliki node ini dihapus dan, jika String baru tidak kosong atau null, digantikan dengan satu node Text yang berisi String yang ditetapkan pada atribut ini. |
[getValue]
