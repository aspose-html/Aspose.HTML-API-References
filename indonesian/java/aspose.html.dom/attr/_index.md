...
description: "kelas com.aspose.html.dom.Attr. Antarmuka Attr mewakili sebuah atribut dalam objek Elemen. Biasanya nilai yang diizinkan untuk atribut tersebut didefinisikan dalam skema yang terkait dengan dokumen."
type: docs
...
Antarmuka Attr mewakili atribut dalam objek Element. Biasanya nilai yang diizinkan untuk atribut tersebut didefinisikan dalam skema yang terkait dengan dokumen.
...
| [getLocalName](../../com.aspose.html.dom/attr/localname/) Mengembalikan bagian lokal dari nama yang memenuhi syarat dari node ini. Untuk node dengan tipe apa pun selain ELEMENT_NODE dan ATTRIBUTE_NODE serta node yang dibuat dengan metode DOM Level 1, seperti Document.createElement(), nilai ini selalu null. |
...
| [getOwnerElement](../../com.aspose.html.dom/attr/ownerelement/) Node Elemen yang menjadi tempat atribut ini terpasang atau null jika atribut ini tidak digunakan. |
...
| [getSpecified](../../com.aspose.html.dom/attr/specified/) Benar jika atribut ini secara eksplisit diberikan nilai dalam dokumen contoh, jika tidak maka salah. |
