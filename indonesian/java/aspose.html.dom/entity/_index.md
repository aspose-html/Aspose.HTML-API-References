...
description: "kelas com.aspose.html.dom.Entity. Mewakili entitas yang dikenal baik yang diparse maupun tidak diparse dalam dokumen XML"
type: docs

url: /id/java/com.aspose.html.dom/entity/
---
## Entity class

Mewakili entitas yang dikenal, baik yang diparsing maupun tidak diparsing, dalam dokumen XML.
...
| [getInputEncoding](../../com.aspose.html.dom/entity/inputencoding/) Sebuah atribut yang menentukan enkoding yang digunakan untuk entitas ini pada saat parsing, ketika itu merupakan entitas eksternal yang diparse. Nilai ini null jika entitas berasal dari subset internal atau jika tidak diketahui. |
...
| [getNodeName](../../com.aspose.html.dom/entity/nodename/) Nama node ini, tergantung pada tipenya. |
| [getNodeType](../../com.aspose.html.dom/entity/nodetype/) Kode yang mewakili tipe objek dasar. |
...
| [getNotationName](../../com.aspose.html.dom/entity/notationname/) Untuk entitas yang tidak diparse, nama notasi untuk entitas tersebut. Untuk entitas yang diparse, nilai ini null. |
...
| [getPublicId](../../com.aspose.html.dom/entity/publicid/) Pengidentifikasi publik yang terkait dengan entitas jika ditentukan, dan null jika tidak. |
| [getSystemId](../../com.aspose.html.dom/entity/systemid/) Pengidentifikasi sistem yang terkait dengan entitas jika ditentukan, dan null jika tidak. Ini dapat berupa URI absolut atau tidak. |
...
| [getXmlEncoding](../../com.aspose.html.dom/entity/xmlencoding/) Sebuah atribut yang menentukan, sebagai bagian dari deklarasi teks, enkoding entitas ini, ketika itu merupakan entitas eksternal yang diparse. Nilai ini null jika tidak. |
| [getXmlVersion](../../com.aspose.html.dom/entity/xmlversion/) Sebuah atribut yang menentukan, sebagai bagian dari deklarasi teks, nomor versi entitas ini, ketika itu merupakan entitas eksternal yang diparse. Nilai ini null jika tidak. |
