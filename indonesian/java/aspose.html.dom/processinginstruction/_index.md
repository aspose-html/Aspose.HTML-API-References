---
title: "Kelas ProcessingInstruction"
second_title: "Referensi API Aspose.HTML untuk Java"
description: "Kelas com.aspose.html.dom.ProcessingInstruction. ProcessingInstruction mewakili instruksi pemrosesan yang digunakan dalam XML sebagai cara untuk menyimpan informasi spesifik prosesor dalam teks dokumen."
type: docs

url: /id/java/com.aspose.html.dom/processinginstruction/
---
## ProcessingInstruction class

**ProcessingInstruction** mewakili "processing instruction", yang digunakan dalam XML sebagai cara untuk menyimpan informasi spesifik prosesor dalam teks dokumen.
...
| [getLength](../../com.aspose.html.dom/characterdata/length/) Jumlah unit 16-bit yang tersedia melalui data dan metode subStringData di bawah ini. Nilainya dapat menjadi nol, yaitu node CharacterData dapat kosong. |
...
| [getNodeName](../../com.aspose.html.dom/processinginstruction/nodename/) Nama node ini, tergantung pada tipenya. |
| [getNodeType](../../com.aspose.html.dom/processinginstruction/nodetype/) Kode yang mewakili tipe objek dasar. |
| [nodeValue](../../com.aspose.html.dom/processinginstruction/nodevalue/) { get; set; } | Nilai node ini, tergantung pada tipenya. |
...
| [getTarget](../../com.aspose.html.dom/processinginstruction/target/) Target dari instruksi pemrosesan ini. |
| [textContent](../../com.aspose.html.dom/processinginstruction/textcontent/) { get; set; } | Atribut ini mengembalikan konten teks dari node ini dan turunannya. Ketika diatur menjadi null, pengaturannya tidak berpengaruh. Saat diatur, semua anak yang mungkin dimiliki node ini dihapus dan, jika String baru tidak kosong atau null, digantikan dengan satu node Text yang berisi String yang ditetapkan pada atribut ini. |
...
| [replaceData](../../com.aspose.html.dom/characterdata/replacedata/)(int, int, String) | Ganti karakter yang dimulai pada offset unit 16-bit yang ditentukan dengan String yang ditentukan. |
