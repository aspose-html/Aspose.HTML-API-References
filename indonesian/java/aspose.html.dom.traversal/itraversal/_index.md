...
| [getWhatToShow](../../com.aspose.html.dom.traversal/itraversal/whattoshow/) Atribut ini menentukan jenis node mana yang disajikan melalui iterator. Set konstan yang tersedia didefinisikan dalam antarmuka NodeFilter. Node yang tidak diterima oleh whatToShow akan dilewati, tetapi anaknya masih dapat dipertimbangkan. Perhatikan bahwa pengabaian ini memiliki prioritas lebih tinggi daripada filter, jika ada. |
