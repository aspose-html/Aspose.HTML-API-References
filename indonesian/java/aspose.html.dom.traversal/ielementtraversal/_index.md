...
Antarmuka ElementTraversal adalah sekumpulan atribut hanya-baca yang memungkinkan penulis dengan mudah menavigasi antar elemen dalam sebuah dokumen. Pada implementasi yang mematuhi Element Traversal, semua objek yang mengimplementasikan Element juga harus mengimplementasikan antarmuka ElementTraversal.
...
| Nama | Deskripsi |
| --- | --- |
| [getChildElementCount](../../com.aspose.html.dom.traversal/ielementtraversal/childelementcount/) Mengembalikan jumlah saat ini dari node elemen yang merupakan anak dari elemen ini. 0 jika elemen ini tidak memiliki node anak yang berjenis nodeType 1. |
