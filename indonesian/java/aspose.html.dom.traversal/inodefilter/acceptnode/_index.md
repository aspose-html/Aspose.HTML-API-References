...
description: "Metode INodeFilter. Menguji apakah sebuah node tertentu terlihat dalam tampilan logis TreeWalker atau NodeIterator. Fungsi ini akan dipanggil oleh implementasi TreeWalker dan NodeIterator; biasanya tidak dipanggil langsung dari kode pengguna. Namun Anda dapat melakukannya jika ingin menggunakan filter yang sama untuk mengarahkan logika aplikasi Anda."
type: docs
