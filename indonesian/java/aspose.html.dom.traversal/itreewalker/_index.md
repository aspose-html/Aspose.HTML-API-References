...
Menghilangkan node dari tampilan logis sebuah subpohon dapat menghasilkan struktur yang secara substansial berbeda dari subpohon yang sama dalam dokumen lengkap yang tidak difilter. Node yang merupakan saudara dalam tampilan TreeWalker mungkin menjadi anak dari node yang berbeda dan jauh terpisah dalam tampilan asli. Misalnya, pertimbangkan sebuah NodeFilter yang melewatkan semua node kecuali node Teks dan node akar sebuah dokumen. Dalam tampilan logis yang dihasilkan, semua node teks akan menjadi saudara dan muncul sebagai anak langsung node akar, tidak peduli seberapa dalam struktur dokumen asli.
