...
| ExtractContent | `10` | (Penangani keamanan revisi 2) Menyalin atau mengekstrak teks dan grafik dari dokumen, termasuk mengekstrak teks dan grafik (untuk mendukung aksesibilitas bagi pengguna dengan disabilitas atau untuk tujuan lain). (Penangani keamanan revisi 3 atau lebih) Menyalin atau mengekstrak teks dan grafik dari dokumen dengan operasi selain yang dikendalikan oleh ExtractContentWithDisabilities. |
...
| ExtractContentWithDisabilities | `200` | (Penangani keamanan revisi 3 atau lebih) Mengekstrak teks dan grafik (untuk mendukung aksesibilitas bagi pengguna dengan disabilitas atau untuk tujuan lain). |
