...
description: "Kelas com.aspose.html.dom.events.Event. Ini digunakan untuk menyediakan informasi kontekstual tentang sebuah peristiwa kepada penangan yang memproses peristiwa tersebut."
type: docs
...
Ini digunakan untuk menyediakan informasi kontekstual tentang suatu peristiwa kepada penangan yang memproses peristiwa tersebut.
...
| const [NonePhase](../../com.aspose.html.dom.events/event/nonephase/) | Peristiwa yang tidak sedang dikirim berada dalam fase ini. |

## Catatan

Objek yang mengimplementasikan itu biasanya diteruskan sebagai parameter pertama ke penangan peristiwa. Informasi konteks yang lebih spesifik diteruskan ke penangan peristiwa dengan menurunkan antarmuka tambahan yang berisi informasi yang langsung terkait dengan jenis peristiwa yang menyertainya. Antarmuka yang diturunkan ini juga diimplementasikan oleh objek yang diteruskan ke pendengar peristiwa.
