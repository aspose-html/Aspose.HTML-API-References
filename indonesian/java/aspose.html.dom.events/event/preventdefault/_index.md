...
Jika, selama tahap apa pun dari alur peristiwa, metode `PreventDefault` dipanggil, peristiwa tersebut dibatalkan. Setiap aksi default yang terkait dengan peristiwa tidak akan terjadi. Memanggil metode ini untuk peristiwa yang tidak dapat dibatalkan tidak berpengaruh. Setelah `PreventDefault` dipanggil, ia akan tetap berlaku selama sisa propagasi peristiwa. Metode ini dapat digunakan selama tahap apa pun dari alur peristiwa.
