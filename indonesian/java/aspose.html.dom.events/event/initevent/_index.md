...
description: "Metode Event. Metode InitEvent digunakan untuk menginisialisasi nilai Event yang dibuat melalui antarmuka IDocumentEvent."
type: docs
...
Metode `InitEvent` digunakan untuk menginisialisasi nilai [`Event`](../) yang dibuat melalui antarmuka [`IDocumentEvent`](../../idocumentevent/).
