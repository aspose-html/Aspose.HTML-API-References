...
| [ImageDevice](imagedevice/#constructor_2)(ImageRenderingOptions, Stream) | Menginisialisasi instance baru dari kelas `ImageDevice` dengan opsi rendering dan aliran output. |
| [ImageDevice](imagedevice/#constructor_3)(ImageRenderingOptions, String) | Menginisialisasi instance baru dari kelas `ImageDevice` dengan opsi rendering dan nama file output. |
