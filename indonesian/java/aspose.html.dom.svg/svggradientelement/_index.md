...
description: "com.aspose.html.dom.svg.SVGGradientElement class. Antarmuka SVGGradientElement adalah antarmuka dasar yang digunakan oleh SVGLinearGradientElement dan SVGRadialGradientElement."
type: docs
...
| Nama | Deskripsi |
| --- | --- |
| const [SVG_SPREADMETHOD_PAD](../../com.aspose.html.dom.svg/svggradientelement/svg_spreadmethod_pad/) | Mengacu pada nilai 'pad'. |
| const [SVG_SPREADMETHOD_REFLECT](../../com.aspose.html.dom.svg/svggradientelement/svg_spreadmethod_reflect/) | Mengacu pada nilai 'reflect'. |
| const [SVG_SPREADMETHOD_REPEAT](../../com.aspose.html.dom.svg/svggradientelement/svg_spreadmethod_repeat/) | Mengacu pada nilai 'repeat'. |
| const [SVG_SPREADMETHOD_UNKNOWN](../../com.aspose.html.dom.svg/svggradientelement/svg_spreadmethod_unknown/) | Tipe ini bukan salah satu tipe yang telah ditentukan. Tidak sah mencoba mendefinisikan nilai baru dari tipe ini atau mencoba mengubah nilai yang ada ke tipe ini. |
