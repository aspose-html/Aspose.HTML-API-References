---
title: "SVGTextContentElement Kelas"
second_title: "Referensi API Aspose.HTML untuk Java"
description: "com.aspose.html.dom.svg.SVGTextContentElement class. SVGTextContentElement diwariskan oleh berbagai antarmuka terkait teks seperti SVGTextElement, SVGTSpanElement, SVGTRefElement, SVGAltGlyphElement, dan SVGTextPathElement. Untuk metode pada antarmuka ini yang merujuk pada indeks karakter atau jumlah karakter, referensi tersebut harus diinterpretasikan sebagai indeks ke unit kode UTF-16 atau jumlah unit kode UTF-16 masing‑masing. Ini untuk konsistensi dengan DOM Level 2 Core dimana metode pada antarmuka CharacterData menggunakan unit kode UTF-16 sebagai indeks dan hitungan dalam data karakter. Jadi, misalnya jika konten teks dari elemen teks adalah satu karakter non‑BMP seperti U10000, maka memanggil getNumberOfChars pada elemen tersebut akan mengembalikan 2 karena ada dua unit kode UTF-16, pasangan surrogate yang digunakan untuk merepresentasikan satu karakter tersebut."
type: docs
...
| [getLengthAdjust](../../com.aspose.html.dom.svg/svgtextcontentelement/lengthadjust/) Mengacu pada atribut ‘lengthAdjust’ pada elemen yang diberikan. Nilai harus salah satu dari konstanta penyesuaian panjang yang didefinisikan pada antarmuka ini. |
...
| [getNumberOfChars](../../com.aspose.html.dom.svg/svgtextcontentelement/getnumberofchars/)() | Mengembalikan total jumlah karakter yang tersedia untuk dirender dalam elemen saat ini, yang mencakup karakter yang direferensikan dari referensi ‘tref’, terlepas apakah mereka akan dirender atau tidak. Secara efektif, ini setara dengan panjang atribut Node::textContent dari DOM Level 3 Core ([DOM3], bagian 1.4), jika atribut tersebut juga memperluas elemen ‘tref’. |
...
| const [LENGTHADJUST_UNKNOWN](../../com.aspose.html.dom.svg/svgtextcontentelement/lengthadjust_unknown/) | Enumerasi diatur ke nilai yang bukan salah satu tipe yang telah ditentukan. Tidak valid mencoba mendefinisikan nilai baru dari tipe ini atau mencoba mengubah nilai yang ada ke tipe ini. |
