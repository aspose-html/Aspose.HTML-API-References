---
title: "Kelas SVGTextContentElement"
second_title: "Referensi API Aspose.HTML untuk Java"
description: "com.aspose.html.dom.svg.SVGTextContentElement class. SVGTextContentElement diwariskan oleh berbagai antarmuka terkait teks seperti SVGTextElement, SVGTSpanElement, SVGTRefElement, SVGAltGlyphElement, dan SVGTextPathElement. Untuk metode pada antarmuka ini yang merujuk pada indeks ke sebuah karakter atau jumlah karakter, referensi tersebut harus diinterpretasikan sebagai indeks ke unit kode UTF-16 atau jumlah unit kode UTF-16 masing‑masing. Hal ini untuk konsistensi dengan DOM Level 2 Core dimana metode pada antarmuka CharacterData menggunakan unit kode UTF-16 sebagai indeks dan hitungan dalam data karakter. Jadi, misalnya jika konten teks dari sebuah elemen teks adalah satu karakter non‑BMP seperti U+10000, maka memanggil getNumberOfChars pada elemen tersebut akan mengembalikan 2 karena ada dua unit kode UTF-16, pasangan surrogate yang digunakan untuk merepresentasikan satu karakter tersebut."
type: docs

url: /id/java/com.aspose.html.dom.svg/svgtextcontentelement/
---
## SVGTextContentElement class

SVGTextContentElement diwarisi oleh berbagai antarmuka terkait teks, seperti SVGTextElement, SVGTSpanElement, SVGTRefElement, SVGAltGlyphElement, dan SVGTextPathElement. Untuk metode pada antarmuka ini yang merujuk pada indeks ke sebuah karakter atau jumlah karakter, referensi tersebut harus ditafsirkan sebagai indeks ke unit kode UTF-16 atau jumlah unit kode UTF-16, masing‑masing. Hal ini untuk konsistensi dengan DOM Level 2 Core, di mana metode pada antarmuka CharacterData menggunakan unit kode UTF-16 sebagai indeks dan hitungan dalam data karakter. Jadi, misalnya, jika konten teks dari elemen ‘text’ adalah satu karakter non‑BMP, seperti U+10000, maka memanggil getNumberOfChars pada elemen tersebut akan mengembalikan 2 karena ada dua unit kode UTF-16 (pasangan surrogate) yang digunakan untuk merepresentasikan satu karakter itu.
...
| [getLengthAdjust](../../com.aspose.html.dom.svg/svgtextcontentelement/lengthadjust/) Mengacu pada atribut ‘lengthAdjust’ pada elemen yang diberikan. Nilainya harus salah satu dari konstanta penyesuaian panjang yang didefinisikan pada antarmuka ini. |
...
| [getTextLength](../../com.aspose.html.dom.svg/svgtextcontentelement/textlength/) Mengacu pada atribut ‘textLength’ pada elemen yang diberikan. |
...
| [getComputedTextLength](../../com.aspose.html.dom.svg/svgtextcontentelement/getcomputedtextlength/)() | Jumlah total semua nilai advance dari merender semua karakter dalam elemen ini, termasuk nilai advance pada glif (horizontal atau vertikal), efek properti ‘kerning’, ‘letter-spacing’ dan ‘word-spacing’, serta penyesuaian akibat atribut ‘dx’ dan ‘dy’ pada elemen ‘tspan’. Untuk lingkungan non-rendering, agen pengguna harus membuat asumsi yang wajar tentang metrik glif. |
...
| [getNumberOfChars](../../com.aspose.html.dom.svg/svgtextcontentelement/getnumberofchars/)() | Mengembalikan total jumlah karakter yang tersedia untuk dirender dalam elemen saat ini, yang mencakup karakter yang direferensikan dari referensi ‘tref’, terlepas dari apakah mereka akan dirender atau tidak. Secara efektif, ini setara dengan panjang atribut Node::textContent dari DOM Level 3 Core ([DOM3], bagian 1.4), jika atribut tersebut juga memperluas elemen ‘tref’. |
...
| Nama | Deskripsi |
| --- | --- |
| const [LENGTHADJUST_SPACING](../../com.aspose.html.dom.svg/svgtextcontentelement/lengthadjust_spacing/) | Mengacu pada nilai 'spacing'. |
| const [LENGTHADJUST_SPACINGANDGLYPHS](../../com.aspose.html.dom.svg/svgtextcontentelement/lengthadjust_spacingandglyphs/) | Mengacu pada nilai 'spacingAndGlyphs'. |
| const [LENGTHADJUST_UNKNOWN](../../com.aspose.html.dom.svg/svgtextcontentelement/lengthadjust_unknown/) | Enumerasi diatur ke nilai yang bukan salah satu tipe yang telah ditentukan. Tidak valid mencoba mendefinisikan nilai baru untuk tipe ini atau mencoba mengubah nilai yang ada ke tipe ini. |
