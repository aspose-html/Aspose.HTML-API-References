---
title: "Kelas SVGMarkerElement"
second_title: "Referensi API Aspose.HTML untuk Java"
description: "com.aspose.html.dom.svg.SVGMarkerElement class. Antarmuka SVGMarkerElement mengacu pada elemen marker."
type: docs

url: /id/java/com.aspose.html.dom.svg/svgmarkerelement/
---
## SVGMarkerElement class

Antarmuka SVGMarkerElement sesuai dengan elemen ‘marker’.
...
| [getMarkerHeight](../../com.aspose.html.dom.svg/svgmarkerelement/markerheight/) Mengacu pada atribut ‘markerHeight’ pada elemen ‘marker’ yang diberikan. |
| [getMarkerUnits](../../com.aspose.html.dom.svg/svgmarkerelement/markerunits/) Mengacu pada atribut ‘markerUnits’ pada elemen ‘marker’ yang diberikan. Salah satu Tipe Unit Marker yang didefinisikan pada antarmuka ini. |
| [getMarkerWidth](../../com.aspose.html.dom.svg/svgmarkerelement/markerwidth/) Mengacu pada atribut ‘markerWidth’ pada elemen ‘marker’ yang diberikan. |
...
| [getOrientAngle](../../com.aspose.html.dom.svg/svgmarkerelement/orientangle/) Mengacu pada atribut ‘orient’ pada elemen ‘marker’ yang diberikan. Jika markerUnits adalah SVG_MARKER_ORIENT_ANGLE, nilai sudut untuk atribut ‘orient’; jika tidak, akan diatur menjadi nol. |
| [getOrientType](../../com.aspose.html.dom.svg/svgmarkerelement/orienttype/) Mengacu pada atribut ‘orient’ pada elemen ‘marker’ yang diberikan. Salah satu Tipe Orientasi Penanda yang didefinisikan pada antarmuka ini. |
[getOuterHTML]
...
| [getPreserveAspectRatio](../../com.aspose.html.dom.svg/svgmarkerelement/preserveaspectratio/) Mengacu pada atribut ‘preserveAspectRatio’ pada elemen yang diberikan. |
...
| [getRefX](../../com.aspose.html.dom.svg/svgmarkerelement/refx/) Mengacu pada atribut ‘refX’ pada elemen ‘marker’ yang diberikan. |
| [getRefY](../../com.aspose.html.dom.svg/svgmarkerelement/refy/) Mengacu pada atribut ‘refY’ pada elemen ‘marker’ yang diberikan. |
...
| [getViewBox](../../com.aspose.html.dom.svg/svgmarkerelement/viewbox/) Mengacu pada atribut ‘viewBox’ pada elemen yang diberikan. |
...
| [setOrientToAngle](../../com.aspose.html.dom.svg/svgmarkerelement/setorienttoangle/)(SVGAngle) | Mengatur nilai atribut ‘orient’ ke sudut yang diberikan. |
| [setOrientToAuto](../../com.aspose.html.dom.svg/svgmarkerelement/setorienttoauto/)() | Mengatur nilai atribut ‘orient’ menjadi 'auto'. |
...
| Nama | Deskripsi |
| --- | --- |
| const [SVG_MARKERUNITS_STROKEWIDTH](../../com.aspose.html.dom.svg/svgmarkerelement/svg_markerunits_strokewidth/) | Nilai atribut ‘markerUnits’ adalah 'strokeWidth'. |
| const [SVG_MARKERUNITS_UNKNOWN](../../com.aspose.html.dom.svg/svgmarkerelement/svg_markerunits_unknown/) | Tipe unit penanda bukan salah satu tipe yang telah ditentukan. Tidak valid mencoba mendefinisikan nilai baru untuk tipe ini atau mencoba mengubah nilai yang ada ke tipe ini. |
| const [SVG_MARKERUNITS_USERSPACEONUSE](../../com.aspose.html.dom.svg/svgmarkerelement/svg_markerunits_userspaceonuse/) | Nilai atribut ‘markerUnits’ adalah 'userSpaceOnUse'. |
| const [SVG_MARKER_ORIENT_ANGLE](../../com.aspose.html.dom.svg/svgmarkerelement/svg_marker_orient_angle/) | Atribut ‘orient’ memiliki nilai sudut. |
| const [SVG_MARKER_ORIENT_AUTO](../../com.aspose.html.dom.svg/svgmarkerelement/svg_marker_orient_auto/) | Atribut ‘orient’ memiliki nilai 'auto'. |
| const [SVG_MARKER_ORIENT_UNKNOWN](../../com.aspose.html.dom.svg/svgmarkerelement/svg_marker_orient_unknown/) | Orientasi penanda bukan salah satu tipe yang telah ditentukan. Tidak valid mencoba mendefinisikan nilai baru untuk tipe ini atau mencoba mengubah nilai yang ada ke tipe ini. |
