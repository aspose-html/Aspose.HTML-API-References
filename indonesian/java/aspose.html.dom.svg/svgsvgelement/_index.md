...
description: "kelas com.aspose.html.dom.svg.SVGSVGElement. Definisi antarmuka kunci adalah antarmuka SVGSVGElement yang merupakan antarmuka yang mengacu pada elemen svg. Antarmuka ini berisi berbagai metode utilitas umum yang sering digunakan seperti operasi matriks dan kemampuan mengontrol waktu penggambaran ulang pada perangkat rendering visual."
type: docs
...
Definisi antarmuka kunci adalah antarmuka SVGSVGElement, yang merupakan antarmuka yang sesuai dengan elemen ‘svg’. Antarmuka ini berisi berbagai metode utilitas umum yang beragam, seperti operasi matriks dan kemampuan mengontrol waktu penggambaran ulang pada perangkat rendering visual.
...
| [createSVGAngle](../../com.aspose.html.dom.svg/svgsvgelement/createsvgangle/)() | Membuat objek SVGAngle di luar pohon dokumen apa pun. Objek ini diinisialisasi dengan nilai 0 derajat (tanpa satuan). |
| [createSVGLength](../../com.aspose.html.dom.svg/svgsvgelement/createsvglength/)() | Membuat objek SVGLength di luar pohon dokumen apa pun. Objek ini diinisialisasi dengan nilai 0 satuan pengguna. |
| [createSVGMatrix](../../com.aspose.html.dom.svg/svgsvgelement/createsvgmatrix/)() | Membuat objek SVGMatrix di luar pohon dokumen apa pun. Objek ini diinisialisasi ke matriks identitas. |
| [createSVGNumber](../../com.aspose.html.dom.svg/svgsvgelement/createsvgnumber/)() | Membuat objek SVGNumber di luar pohon dokumen apa pun. Objek ini diinisialisasi dengan nilai nol. |
| [createSVGPoint](../../com.aspose.html.dom.svg/svgsvgelement/createsvgpoint/)() | Membuat objek SVGPoint di luar pohon dokumen apa pun. Objek ini diinisialisasi ke titik (0,0) dalam sistem koordinat pengguna. |
| [createSVGRect](../../com.aspose.html.dom.svg/svgsvgelement/createsvgrect/)() | Membuat objek SVGRect di luar pohon dokumen apa pun. Objek ini diinisialisasi sehingga semua nilai diatur ke 0 satuan pengguna. |
| [createSVGTransform](../../com.aspose.html.dom.svg/svgsvgelement/createsvgtransform/)() | Membuat objek SVGTransform di luar pohon dokumen apa pun. Objek ini diinisialisasi ke transformasi matriks identitas (SVG_TRANSFORM_MATRIX). |
| [createSVGTransformFromMatrix](../../com.aspose.html.dom.svg/svgsvgelement/createsvgtransformfrommatrix/)(SVGMatrix) | Membuat objek SVGTransform di luar pohon dokumen apa pun. Objek ini diinisialisasi ke transformasi matriks yang diberikan (misalnya, SVG_TRANSFORM_MATRIX). Nilai-nilai dari matriks parameter disalin, parameter matriks tidak diadopsi sebagai SVGTransform::matrix. |
...
| [getElementById](../../com.aspose.html.dom.svg/svgsvgelement/getelementbyid/)(String) | Mencari dalam fragmen dokumen SVG ini (yaitu, pencarian dibatasi pada subset pohon dokumen) sebuah Elemen yang id‑nya diberikan oleh elementId. Jika Elemen ditemukan, Elemen tersebut dikembalikan. Jika tidak ada elemen semacam itu, mengembalikan null. Perilaku tidak terdefinisi jika lebih dari satu elemen memiliki id ini. |
...
| [pauseAnimations](../../com.aspose.html.dom.svg/svgsvgelement/pauseanimations/)() | Menghentikan (yaitu, menjeda) semua animasi yang sedang berjalan yang didefinisikan dalam fragmen dokumen SVG yang sesuai dengan elemen ‘svg’ ini, menyebabkan jam animasi yang terkait dengan fragmen dokumen ini berhenti sampai dijeda kembali. |
