...
| [getPathLength](../../com.aspose.html.dom.svg/svggeometryelement/pathlength/) Sesuai dengan atribut pathLength pada elemen yang diberikan. |
[getPathSegList]
...
| [getRequiredExtensions](../../com.aspose.html.dom.svg/svggraphicselement/requiredextensions/) Mengacu pada atribut ‘requiredExtensions’ pada elemen yang diberikan. |
| [getRequiredFeatures](../../com.aspose.html.dom.svg/svggraphicselement/requiredfeatures/) Mengacu pada atribut ‘requiredFeatures’ pada elemen yang diberikan. |
...
| [getSystemLanguage](../../com.aspose.html.dom.svg/svggraphicselement/systemlanguage/) Mengacu pada atribut ‘systemLanguage’ pada elemen yang diberikan. |
...
| [getTransform](../../com.aspose.html.dom.svg/svggraphicselement/transform/) Mengacu pada atribut ‘transform’ pada elemen yang diberikan. |
...
| [createSVGPathSegArcAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegarcabs/)(float, float, float, float, float, bool, bool) | Mengembalikan objek SVGPathSegArcAbs yang berdiri sendiri dan tanpa induk. |
| [createSVGPathSegArcRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegarcrel/)(float, float, float, float, float, bool, bool) | Mengembalikan objek SVGPathSegArcRel yang berdiri sendiri dan tanpa induk. |
| [createSVGPathSegClosePath](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegclosepath/)() | Mengembalikan objek SVGPathSegClosePath yang berdiri sendiri dan tanpa induk. |
| [createSVGPathSegCurvetoCubicAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicabs/)(float, float, float, float, float, float) | Mengembalikan objek SVGPathSegCurvetoCubicAbs yang berdiri sendiri dan tanpa induk. |
| [createSVGPathSegCurvetoCubicRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicrel/)(float, float, float, float, float, float) | Mengembalikan objek SVGPathSegCurvetoCubicRel yang berdiri sendiri dan tanpa induk. |
| [createSVGPathSegCurvetoCubicSmoothAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothabs/)(float, float, float, float) | Mengembalikan objek SVGPathSegCurvetoCubicSmoothAbs yang berdiri sendiri dan tanpa induk. |
| [createSVGPathSegCurvetoCubicSmoothRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothrel/)(float, float, float, float) | Mengembalikan objek SVGPathSegCurvetoCubicSmoothRel yang berdiri sendiri dan tanpa induk. |
...
| [getEquivalentPath](../../com.aspose.html.dom.svg/svggeometryelement/getequivalentpath/)() | Mengembalikan sebuah instance baru dari [`SVGPathSegList`](../../com.aspose.html.dom.svg.paths/svgpathseglist/) yang merepresentasikan [`SVGGeometryElement`](../svggeometryelement/) sebagai segmen jalur. |
...
| [getScreenCTM](../../com.aspose.html.dom.svg/svggraphicselement/getscreenctm/)() | Mengembalikan matriks transformasi dari unit pengguna saat ini (yaitu, setelah penerapan atribut ‘transform’, jika ada) ke pengenalan \"pixel\" oleh agen pengguna induk. Untuk perangkat tampilan, idealnya ini mewakili pixel layar fisik. Untuk perangkat atau lingkungan lain dimana ukuran pixel fisik tidak diketahui, maka algoritma serupa definisi \"pixel\" CSS2 dapat digunakan sebagai gantinya. Perhatikan bahwa null dikembalikan jika elemen ini tidak terhubung ke pohon dokumen. Metode ini seharusnya lebih tepat dinamai getClientCTM, tetapi nama getScreenCTM dipertahankan demi alasan historis. |
