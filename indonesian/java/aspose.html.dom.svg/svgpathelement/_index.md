---
title: "Kelas SVGPathElement"
second_title: "Referensi API Aspose.HTML untuk Java"
description: "com.aspose.html.dom.svg.SVGPathElement class. Antarmuka SVGPathElement mengacu pada elemen path."
type: docs

url: /id/java/com.aspose.html.dom.svg/svgpathelement/
---
## SVGPathElement class

Antarmuka SVGPathElement sesuai dengan elemen ‘path’.
...
| [getClassName](../../com.aspose.html.dom.svg/svgelement/classname/) Sesuai dengan atribut ‘class’ pada elemen yang diberikan. |
[getClassName]
...
| [getFarthestViewportElement](../../com.aspose.html.dom.svg/svggraphicselement/farthestviewportelement/) Elemen ‘svg’ nenek moyang terjauh. Null jika elemen saat ini adalah elemen svg terluar. |
...
| [getNearestViewportElement](../../com.aspose.html.dom.svg/svggraphicselement/nearestviewportelement/) Elemen yang menetapkan viewport saat ini. Seringkali, elemen ‘svg’ nenek moyang terdekat. Null jika elemen saat ini adalah elemen svg terluar. |
| [getNextElementSibling](../../com.aspose.html.dom/element/nextelementsibling/) Mengembalikan node elemen saudara berikutnya dari elemen ini. null jika elemen ini tidak memiliki node elemen saudara yang muncul setelahnya dalam pohon dokumen. |
...
| [getOwnerSVGElement](../../com.aspose.html.dom.svg/svgelement/ownersvgelement/) Elemen ‘svg’ terdekat yang menjadi nenek moyang. Null jika elemen yang diberikan adalah elemen svg terluar. |
...
| [getPathLength](../../com.aspose.html.dom.svg/svggeometryelement/pathlength/) Berhubungan dengan atribut pathLength pada elemen yang diberikan. |
[getPathSegList]
...
| [getPreviousElementSibling](../../com.aspose.html.dom/element/previouselementsibling/) Mengembalikan node elemen saudara sebelumnya dari elemen ini. null jika elemen ini tidak memiliki node elemen saudara yang muncul sebelumnya dalam pohon dokumen. |
...
| [getRequiredExtensions](../../com.aspose.html.dom.svg/svggraphicselement/requiredextensions/) Berhubungan dengan atribut ‘requiredExtensions’ pada elemen yang diberikan. |
| [getRequiredFeatures](../../com.aspose.html.dom.svg/svggraphicselement/requiredfeatures/) Berhubungan dengan atribut ‘requiredFeatures’ pada elemen yang diberikan. |
...
| [getStyle](../../com.aspose.html.dom.svg/svgelement/style/) Menyatakan atribut ‘style’ pada elemen yang diberikan. Jika agen pengguna tidak mendukung penataan dengan CSS, maka atribut ini harus selalu bernilai null. |
| [getSystemLanguage](../../com.aspose.html.dom.svg/svggraphicselement/systemlanguage/) Berhubungan dengan atribut ‘systemLanguage’ pada elemen yang diberikan. |
| [getTagName](../../com.aspose.html.dom/element/tagname/) Nama elemen. |
| [textContent](../../com.aspose.html.dom/element/textcontent/) { get; set; } | Atribut ini mengembalikan konten teks dari node ini dan turunannya. Ketika diatur menjadi null, pengaturannya tidak berpengaruh. Saat diatur, semua anak yang mungkin dimiliki node ini dihapus dan, jika String baru tidak kosong atau null, digantikan dengan satu node Text yang berisi String yang ditetapkan pada atribut ini. |
| [getTransform](../../com.aspose.html.dom.svg/svggraphicselement/transform/) Berhubungan dengan atribut ‘transform’ pada elemen yang diberikan. |
| [getViewportElement](../../com.aspose.html.dom.svg/svgelement/viewportelement/) Elemen yang menetapkan viewport saat ini. Seringkali, elemen ‘svg’ terdekat yang menjadi nenek moyang. Null jika elemen yang diberikan adalah elemen svg terluar. |
...
| [createSVGPathSegArcAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegarcabs/)(float, float, float, float, float, bool, bool) | Mengembalikan objek SVGPathSegArcAbs yang berdiri sendiri, tanpa induk. |
| [createSVGPathSegArcRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegarcrel/)(float, float, float, float, float, bool, bool) | Mengembalikan objek SVGPathSegArcRel yang berdiri sendiri, tanpa induk. |
| [createSVGPathSegClosePath](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegclosepath/)() | Mengembalikan objek SVGPathSegClosePath yang berdiri sendiri, tanpa induk. |
| [createSVGPathSegCurvetoCubicAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicabs/)(float, float, float, float, float, float) | Mengembalikan objek SVGPathSegCurvetoCubicAbs yang berdiri sendiri, tanpa induk. |
| [createSVGPathSegCurvetoCubicRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicrel/)(float, float, float, float, float, float) | Mengembalikan objek SVGPathSegCurvetoCubicRel yang berdiri sendiri, tanpa induk. |
| [createSVGPathSegCurvetoCubicSmoothAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothabs/)(float, float, float, float) | Mengembalikan objek SVGPathSegCurvetoCubicSmoothAbs yang berdiri sendiri, tanpa induk. |
| [createSVGPathSegCurvetoCubicSmoothRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothrel/)(float, float, float, float) | Mengembalikan objek SVGPathSegCurvetoCubicSmoothRel yang berdiri sendiri, tanpa induk. |
| [createSVGPathSegCurvetoQuadraticAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticabs/)(float, float, float, float) | Mengembalikan objek SVGPathSegCurvetoQuadraticAbs yang berdiri sendiri, tanpa induk. |
| [createSVGPathSegCurvetoQuadraticRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticrel/)(float, float, float, float) | Mengembalikan objek SVGPathSegCurvetoQuadraticRel yang berdiri sendiri, tanpa induk. |
| [createSVGPathSegCurvetoQuadraticSmoothAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothabs/)(float, float) | Mengembalikan objek SVGPathSegCurvetoQuadraticSmoothAbs yang berdiri sendiri, tanpa induk. |
| [createSVGPathSegCurvetoQuadraticSmoothRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothrel/)(float, float) | Mengembalikan objek SVGPathSegCurvetoQuadraticSmoothRel yang berdiri sendiri, tanpa induk. |
| [createSVGPathSegLinetoAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoabs/)(float, float) | Mengembalikan objek SVGPathSegLinetoAbs yang berdiri sendiri, tanpa induk. |
| [createSVGPathSegLinetoHorizontalAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetohorizontalabs/)(float) | Mengembalikan objek SVGPathSegLinetoHorizontalAbs yang berdiri sendiri, tanpa induk. |
| [createSVGPathSegLinetoHorizontalRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetohorizontalrel/)(float) | Mengembalikan objek SVGPathSegLinetoHorizontalRel yang berdiri sendiri, tanpa induk. |
| [createSVGPathSegLinetoRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetorel/)(float, float) | Mengembalikan objek SVGPathSegLinetoRel yang berdiri sendiri, tanpa induk. |
| [createSVGPathSegLinetoVerticalAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoverticalabs/)(float) | Mengembalikan objek SVGPathSegLinetoVerticalAbs yang berdiri sendiri, tanpa induk. |
| [createSVGPathSegLinetoVerticalRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoverticalrel/)(float) | Mengembalikan objek SVGPathSegLinetoVerticalRel yang berdiri sendiri, tanpa induk. |
| [createSVGPathSegMovetoAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegmovetoabs/)(float, float) | Mengembalikan objek SVGPathSegMovetoAbs yang berdiri sendiri, tanpa induk. |
| [createSVGPathSegMovetoRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegmovetorel/)(float, float) | Mengembalikan objek SVGPathSegMovetoRel yang berdiri sendiri, tanpa induk. |
...
| [getBBox](../../com.aspose.html.dom.svg/svggraphicselement/getbbox/)() | Mengembalikan kotak pembatas ketat dalam ruang pengguna saat ini (yaitu, setelah penerapan atribut ‘transform’, jika ada) pada geometri semua elemen grafis yang terkandung, tidak termasuk efek goresan, pemotongan, masking, dan filter). Perhatikan bahwa getBBox harus mengembalikan kotak pembatas aktual pada saat metode dipanggil, bahkan jika elemen belum dirender. |
| [getCTM](../../com.aspose.html.dom.svg/svggraphicselement/getctm/)() | Mengembalikan matriks transformasi dari unit pengguna saat ini (yaitu, setelah penerapan atribut ‘transform’, jika ada) ke sistem koordinat viewport untuk nearestViewportElement. |
| [getElementsByClassName](../../com.aspose.html.dom/element/getelementsbyclassname/)(String) | Mengembalikan objek [`HTMLCollection`](../../com.aspose.html.collections/htmlcollection/) yang berisi semua elemen dalam [`element`](../../com.aspose.html.dom/element/) yang memiliki semua kelas yang ditentukan dalam argumen. |
...
| [getEquivalentPath](../../com.aspose.html.dom.svg/svggeometryelement/getequivalentpath/)() | Mengembalikan sebuah instance baru dari [`SVGPathSegList`](../../com.aspose.html.dom.svg.paths/svgpathseglist/) yang mewakili [`SVGGeometryElement`](../svggeometryelement/) sebagai segmen jalur. |
| [getPlatformType](../../com.aspose.html.dom/domobject/getplatformtype/)() | Metode ini digunakan untuk mengambil objek ECMAScript. |
| [getPointAtLength](../../com.aspose.html.dom.svg/svggeometryelement/getpointatlength/)(float) | Mengembalikan koordinat (x,y) dalam ruang pengguna yang merupakan satuan jarak sepanjang jalur, menggunakan algoritma distance-along-a-path dari agen pengguna. |
| [getScreenCTM](../../com.aspose.html.dom.svg/svggraphicselement/getscreenctm/)() | Mengembalikan matriks transformasi dari unit pengguna saat ini (yaitu, setelah penerapan atribut ‘transform’, jika ada) ke notasi "pixel" agen pengguna induk. Untuk perangkat tampilan, idealnya ini mewakili pixel layar fisik. Untuk perangkat atau lingkungan lain dimana ukuran pixel fisik tidak diketahui, maka algoritma serupa definisi "pixel" CSS2 dapat digunakan sebagai gantinya. Perhatikan bahwa null dikembalikan jika elemen ini tidak terhubung ke pohon dokumen. Metode ini seharusnya lebih tepat dinamai getClientCTM, tetapi nama getScreenCTM dipertahankan karena alasan historis. |
| [getTotalLength](../../com.aspose.html.dom.svg/svggeometryelement/gettotallength/)() | Mengembalikan nilai yang dihitung oleh agen pengguna untuk total panjang jalur menggunakan algoritma distance-along-a-path agen pengguna, sebagai jarak dalam sistem koordinat pengguna saat ini. |
| [hasAttribute](../../com.aspose.html.dom/element/hasattribute/)(String) | Mengembalikan true ketika atribut dengan nama tertentu ditentukan pada elemen ini atau memiliki nilai default, false jika tidak. |
| [hasAttributeNS](../../com.aspose.html.dom/element/hasattributens/)(String, String) | Mengembalikan true ketika atribut dengan nama lokal dan URI paket tertentu ditentukan pada elemen ini atau memiliki nilai default, false jika tidak. |
...
| [setAttribute](../../com.aspose.html.dom/element/setattribute/)(String, String) | Menambahkan atribut baru. Jika ada atribut dengan nama tersebut sudah ada dalam elemen, nilainya diubah menjadi nilai parameter |
| [setAttributeNode](../../com.aspose.html.dom/element/setattributenode/)(Attr) | Menambahkan node atribut baru. Jika ada atribut dengan nama tersebut (nodeName) sudah ada dalam elemen, ia digantikan oleh yang baru. |
| [setAttributeNodeNS](../../com.aspose.html.dom/element/setattributenodens/)(Attr) | Menambahkan atribut baru. Jika ada atribut dengan nama lokal dan URI paket tersebut sudah ada dalam elemen, ia digantikan oleh yang baru. |
| [setAttributeNS](../../com.aspose.html.dom/element/setattributens/)(String, String, String) | Menambahkan atribut baru. Jika ada atribut dengan nama lokal dan URI paket yang sama sudah ada pada elemen, prefiksnya diubah menjadi bagian prefiks dari qualifiedName, dan nilainya diubah menjadi nilai parameter. |
| [toggleAttribute](../../com.aspose.html.dom/element/toggleattribute/)(String) | Jika force tidak diberikan, "toggles" qualifiedName, menghapusnya jika ada dan menambahkannya jika tidak ada. Jika force bernilai true, menambahkan qualifiedName. Jika force bernilai false, menghapus qualifiedName. |
| [toggleAttribute](../../com.aspose.html.dom/element/toggleattribute/)(String, bool) | Jika force tidak diberikan, "toggles" qualifiedName, menghapusnya jika ada dan menambahkannya jika tidak ada. Jika force bernilai true, menambahkan qualifiedName. Jika force bernilai false, menghapus qualifiedName. |
