...
description: Aspose.Html.Dom.Events.CustomEvent kelas. Acara yang menggunakan antarmuka CustomEvent dapat digunakan untuk membawa data khusus.
type: docs
weight: 730
url: /id/net/aspose.html.dom.events/customevent/
---
## CustomEvent class
...
| [Detail](../../aspose.html.dom.events/customevent/detail/) { get; } | Mendapatkan data khusus. |
...
| [InitCustomEvent](../../aspose.html.dom.events/customevent/initcustomevent/)(string, bool, bool, object) | /// Itu[`InitEvent`](../event/initevent/) Metode ini digunakan untuk menginisialisasi nilai an[`Event`](../event/) diciptakan melalui[`IDocumentEvent`](../idocumentevent/) antarmuka. |
