...
description: Aspose.Html.Dom.Events.UIEvent kelas. Antarmuka UIEvent menyediakan informasi kontekstual khusus yang terkait dengan peristiwa Antarmuka Pengguna.
type: docs
weight: 850
url: /id/net/aspose.html.dom.events/uievent/
---
## UIEvent class

Antarmuka UIEvent menyediakan informasi kontekstual khusus yang terkait dengan peristiwa Antarmuka Pengguna.
...
| Nama | Keterangan |
| --- | --- |
| [UIEvent](uievent/#constructor)(string) | Menginisialisasi instance baru dari`UIEvent` kelas. |
| [UIEvent](uievent/#constructor_1)(string, IDictionary&lt;string, object&gt;) | Menginisialisasi instance baru dari`UIEvent` kelas. |
