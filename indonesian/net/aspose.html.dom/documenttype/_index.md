...
description: Aspose.Html.Dom.DocumentType kelas. DocumentType menyediakan antarmuka ke daftar entitas yang ditentukan untuk document
type: docs
weight: 680
url: /id/net/aspose.html.dom/documenttype/
---
## DocumentType class
...
| [InternalSubset](../../aspose.html.dom/documenttype/internalsubset/) { get; } | Subset internal sebagai string, atau null jika tidak ada. |
...
| [Name](../../aspose.html.dom/documenttype/name/) { get; } | Nama DTD; yaitu, nama yang langsung mengikuti kata kunci DOCTYPE. |
...
| override [NodeName](../../aspose.html.dom/documenttype/nodename/) { get; } | Nama node ini, tergantung jenisnya. |
| override [NodeType](../../aspose.html.dom/documenttype/nodetype/) { get; } | Kode yang mewakili jenis objek yang mendasarinya. |
...
| [PublicId](../../aspose.html.dom/documenttype/publicid/) { get; } | Pengenal publik dari subset eksternal. |
| [SystemId](../../aspose.html.dom/documenttype/systemid/) { get; } | Pengidentifikasi sistem dari subset eksternal. Ini mungkin URI mutlak atau tidak. |
...
| override [ToString](../../aspose.html.dom/documenttype/tostring/)() | Mengembalikan aString yang mewakili instance ini. |
