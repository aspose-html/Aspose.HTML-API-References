...
description: Aspose.Html.Dom.Text kelas. Antarmuka Teks mewarisi dari CharacterData dan mewakili konten tekstual disebut data karakter dalam XML dari Elemen atau Attr.
type: docs
weight: 2450
url: /id/net/aspose.html.dom/text/
---
## Text class

Antarmuka Teks mewarisi dari CharacterData dan mewakili konten tekstual (disebut data karakter dalam XML) dari Elemen atau Attr.
...
| override [NodeName](../../aspose.html.dom/text/nodename/) { get; } | Nama node ini, tergantung jenisnya. |
| override [NodeType](../../aspose.html.dom/text/nodetype/) { get; } | Kode yang mewakili jenis objek yang mendasarinya. |
