...
description: Aspose.Html.Dom.Node kelas. Antarmuka Node adalah tipe data utama untuk seluruh Model objek Dokumen. Ini mewakili satu simpul di pohon dokumen.
type: docs
weight: 1000
url: /id/net/aspose.html.dom/node/
---
## Node class

Antarmuka Node adalah tipe data utama untuk seluruh Model objek Dokumen. Ini mewakili satu simpul di pohon dokumen.
...
| abstract [NodeName](../../aspose.html.dom/node/nodename/) { get; } | Nama node ini, tergantung jenisnya. |
| abstract [NodeType](../../aspose.html.dom/node/nodetype/) { get; } | Kode yang mewakili jenis objek yang mendasarinya. |
...
| [CloneNode](../../aspose.html.dom/node/clonenode/#clonenode)() | Mengembalikan duplikat dari node ini, misalnya berfungsi sebagai pembuat salinan umum untuk node. Node duplikat tidak memiliki induk (parentNode adalah null) dan tidak ada data pengguna. |
| [CloneNode](../../aspose.html.dom/node/clonenode/#clonenode_1)(bool) | Mengembalikan duplikat dari node ini, misalnya berfungsi sebagai pembuat salinan umum untuk node. Node duplikat tidak memiliki induk (parentNode adalah null) dan tidak ada data pengguna. |
...
| Nama | Keterangan |
| --- | --- |
| const [ATTRIBUTE_NODE](../../aspose.html.dom/node/attribute_node/) | Node atribut |
| const [CDATA_SECTION_NODE](../../aspose.html.dom/node/cdata_section_node/) | Node bagian cdata |
| const [COMMENT_NODE](../../aspose.html.dom/node/comment_node/) | Node komentar |
| const [DOCUMENT_FRAGMENT_NODE](../../aspose.html.dom/node/document_fragment_node/) | Node fragmen dokumen |
| const [DOCUMENT_NODE](../../aspose.html.dom/node/document_node/) | Simpul dokumen |
| const [DOCUMENT_TYPE_NODE](../../aspose.html.dom/node/document_type_node/) | Node tipe dokumen |
| const [ELEMENT_NODE](../../aspose.html.dom/node/element_node/) | Simpul elemen |
| const [ENTITY_NODE](../../aspose.html.dom/node/entity_node/) | Sebuah node entitas |
| const [ENTITY_REFERENCE_NODE](../../aspose.html.dom/node/entity_reference_node/) | Node referensi entitas |
| const [NOTATION_NODE](../../aspose.html.dom/node/notation_node/) | Node notasi |
| const [PROCESSING_INSTRUCTION_NODE](../../aspose.html.dom/node/processing_instruction_node/) | Node instruksi pemrosesan |
| const [TEXT_NODE](../../aspose.html.dom/node/text_node/) | Simpul teks |
