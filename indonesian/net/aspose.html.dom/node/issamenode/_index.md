...
| --- | --- | --- |
| otherNode | Node | Simpul lainnya. |

### Nilai Pengembalian

`BENAR`if [adalah simpul yang sama] [lain yang ditentukan]; jika tidak,`PALSU` .
