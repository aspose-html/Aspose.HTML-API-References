...
description: Aspose.Html.Dom.Element kelas. Antarmuka Elemen mewakili elemen dalam dokumen HTML atau XML.
type: docs
weight: 690
url: /id/net/aspose.html.dom/element/
---
## Element class

Antarmuka Elemen mewakili elemen dalam dokumen HTML atau XML.
...
| Nama | Keterangan |
| --- | --- |
| [Element](element/)(IElementInit) | Menginisialisasi instance baru dari`Element`kelas. Jangan panggil konstruktor ini secara langsung, gunakan[`CreateElement`](../document/createelement/) atau[`CreateElementNS`](../document/createelementns/) . |
...
| [Id](../../aspose.html.dom/element/id/) { get; set; } | Pengidentifikasi elemen. Lihat definisi atribut id di HTML 4.01. |
...
| [ParentElement](../../aspose.html.dom/node/parentelement/) { get; } | Mendapatkan induknya`Element` dari simpul ini. |
