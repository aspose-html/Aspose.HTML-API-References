...
description: Aspose.Html.Dom.Entity kelas. Mewakili entitas yang dikenal baik diurai atau tidak diurai dalam dokumen XML.
type: docs
weight: 700
url: /id/net/aspose.html.dom/entity/
---
## Entity class
...
| [InputEncoding](../../aspose.html.dom/entity/inputencoding/) { get; } | Atribut yang menentukan pengkodean yang digunakan untuk entitas ini pada saat penguraian, jika ini adalah entitas yang diurai eksternal. Ini null jika merupakan entitas dari subset internal atau jika tidak diketahui. |
...
| override [NodeName](../../aspose.html.dom/entity/nodename/) { get; } | Nama node ini, tergantung jenisnya. |
| override [NodeType](../../aspose.html.dom/entity/nodetype/) { get; } | Kode yang mewakili jenis objek yang mendasarinya. |
| virtual [NodeValue](../../aspose.html.dom/node/nodevalue/) { get; set; } | Nilai simpul ini, tergantung pada jenisnya. |
| [NotationName](../../aspose.html.dom/entity/notationname/) { get; } | Untuk entitas yang tidak diurai, nama notasi untuk entitas tersebut. Untuk entitas yang diurai, ini adalah null. |
...
| [PublicId](../../aspose.html.dom/entity/publicid/) { get; } | Pengenal publik terkait dengan entitas jika ditentukan, dan null jika tidak. |
| [SystemId](../../aspose.html.dom/entity/systemid/) { get; } | Pengidentifikasi sistem terkait dengan entitas jika ditentukan, dan null jika tidak. Ini mungkin URI mutlak atau tidak. |
...
| [XmlEncoding](../../aspose.html.dom/entity/xmlencoding/) { get; } | Atribut yang menentukan, sebagai bagian dari deklarasi teks, penyandian entitas ini, jika ini adalah entitas yang diurai eksternal. Jika tidak, ini nihil. |
| [XmlVersion](../../aspose.html.dom/entity/xmlversion/) { get; } | Atribut yang menentukan, sebagai bagian dari deklarasi teks, nomor versi entitas ini, jika merupakan entitas yang diurai eksternal. Jika tidak, ini nihil. |
