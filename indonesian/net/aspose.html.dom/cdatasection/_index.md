...
description: Aspose.Html.Dom.CDATASection kelas. Bagian CDATA digunakan untuk keluar dari blok teks yang berisi karakter yang seharusnya dianggap sebagai markup.
type: docs
weight: 200
url: /id/net/aspose.html.dom/cdatasection/
---
## CDATASection class

Bagian CDATA digunakan untuk keluar dari blok teks yang berisi karakter yang seharusnya dianggap sebagai markup.
...
| [IsElementContentWhitespace](../../aspose.html.dom/text/iselementcontentwhitespace/) { get; } | Mengembalikan apakah simpul teks ini berisi spasi kosong konten elemen, sering kali secara kasar disebut "spasi kosong yang tidak dapat diabaikan". |
...
| override [NodeName](../../aspose.html.dom/cdatasection/nodename/) { get; } | Nama node ini, tergantung jenisnya. |
| override [NodeType](../../aspose.html.dom/cdatasection/nodetype/) { get; } | Kode yang mewakili jenis objek yang mendasarinya. |
| override [NodeValue](../../aspose.html.dom/text/nodevalue/) { get; set; } | Nilai simpul ini, tergantung pada jenisnya. |
...
| override [TextContent](../../aspose.html.dom/text/textcontent/) { get; set; } | Atribut ini mengembalikan konten teks dari node ini dan turunannya. Ketika didefinisikan sebagai nol, pengaturan itu tidak berpengaruh. Pada pengaturan, setiap anak yang mungkin dimiliki simpul ini dihapus dan, jika string baru tidak kosong atau nol, diganti dengan simpul Teks tunggal yang berisi string yang disetel ke atribut ini. |
| [WholeText](../../aspose.html.dom/text/wholetext/) { get; } | Mengembalikan semua teks node Teks yang berdekatan secara logis dengan node teks ke node ini, digabungkan dalam urutan dokumen. |
...
| [ReplaceWholeText](../../aspose.html.dom/text/replacewholetext/)(string) | Mengganti teks dari node saat ini dan semua node teks yang berdekatan secara logis dengan teks yang ditentukan. Semua node teks yang berdekatan secara logis dihapus termasuk node saat ini kecuali node tersebut adalah penerima teks pengganti. |
| [SplitText](../../aspose.html.dom/text/splittext/)(int) | Memecah simpul ini menjadi dua simpul pada offset yang ditentukan, mempertahankan keduanya di pohon sebagai saudara kandung. |
