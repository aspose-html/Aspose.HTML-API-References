...
description: Aspose.Html.Dom.Svg.Filters.SVGFEDisplacementMapElement kelas. Antarmuka SVGFEDisplacementMapElement sesuai dengan elemen feDisplacementMap.
type: docs
weight: 1420
url: /id/net/aspose.html.dom.svg.filters/svgfedisplacementmapelement/
---
...
| [Height](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/height/) { get; } | Sesuai dengan atribut 'height' pada elemen 'filter' yang diberikan. |
...
| [In1](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/in1/) { get; } | Sesuai dengan atribut 'in' pada elemen 'feDisplacementMap' yang diberikan. |
| [In2](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/in2/) { get; } | Sesuai dengan atribut 'in2' pada elemen 'feDisplacementMap' yang diberikan. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/result/) { get; } | Sesuai dengan atribut 'hasil' pada elemen 'filter' yang diberikan. |
| [Scale](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/scale/) { get; } | Sesuai dengan atribut 'skala' pada elemen 'feDisplacementMap' yang diberikan. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/width/) { get; } | Sesuai dengan atribut 'width' pada elemen 'filter' yang diberikan. |
| [X](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/x/) { get; } | Sesuai dengan atribut 'x' pada elemen 'filter' yang diberikan. |
| [XChannelSelector](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/xchannelselector/) { get; } | Sesuai dengan atribut 'xChannelSelector' pada elemen 'feDisplacementMap' yang diberikan. Mengambil salah satu konstanta SVG_CHANNEL_* yang ditentukan pada antarmuka ini. |
| [Y](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/y/) { get; } | Sesuai dengan atribut 'y' pada elemen 'filter' yang diberikan. |
| [YChannelSelector](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/ychannelselector/) { get; } | Sesuai dengan atribut 'yChannelSelector' pada elemen 'feDisplacementMap' yang diberikan. Mengambil salah satu konstanta SVG_CHANNEL_* yang ditentukan pada antarmuka ini. |
...
| Nama | Keterangan |
| --- | --- |
| const [SVG_CHANNEL_A](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_a/) | Sesuai dengan nilai 'A'. |
| const [SVG_CHANNEL_B](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_b/) | Sesuai dengan nilai 'B'. |
| const [SVG_CHANNEL_G](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_g/) | Sesuai dengan nilai 'G'. |
| const [SVG_CHANNEL_R](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_r/) | Sesuai dengan nilai 'R'. |
| const [SVG_CHANNEL_UNKNOWN](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_unknown/) | Jenisnya bukan salah satu dari jenis yang telah ditentukan sebelumnya. Tidak valid mencoba menentukan nilai baru dari jenis ini atau mencoba mengalihkan nilai yang ada ke jenis ini. |
