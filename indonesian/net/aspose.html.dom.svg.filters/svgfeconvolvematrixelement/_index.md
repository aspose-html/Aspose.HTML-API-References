...
description: Aspose.Html.Dom.Svg.Filters.SVGFEConvolveMatrixElement kelas. Antarmuka SVGFEConvolveMatrixElement sesuai dengan elemen feConvolveMatrix.
type: docs
weight: 1400
url: /id/net/aspose.html.dom.svg.filters/svgfeconvolvematrixelement/
---
...
| [Bias](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/bias/) { get; } | Sesuai dengan atribut 'bias' pada elemen 'feConvolveMatrix' yang diberikan. |
...
| [Divisor](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/divisor/) { get; } | Sesuai dengan atribut 'pembagi' pada elemen 'feConvolveMatrix' yang diberikan. |
| [EdgeMode](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/edgemode/) { get; } | Sesuai dengan atribut 'edgeMode' pada elemen 'feConvolveMatrix' yang diberikan. |
...
| [Height](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/height/) { get; } | Sesuai dengan atribut 'height' pada elemen 'filter' yang diberikan. |
...
| [In1](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/in1/) { get; } | Sesuai dengan atribut 'in' pada elemen 'feConvolveMatrix' yang diberikan. |
...
| [KernelMatrix](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelmatrix/) { get; } | Sesuai dengan atribut 'kernelMatrix' pada elemen 'feConvolveMatrix' yang diberikan. |
| [KernelUnitLengthX](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelunitlengthx/) { get; } | Sesuai dengan atribut 'kernelUnitLength' pada elemen 'feConvolveMatrix' yang diberikan. |
| [KernelUnitLengthY](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelunitlengthy/) { get; } | Sesuai dengan atribut 'kernelUnitLength' pada elemen 'feConvolveMatrix' yang diberikan. |
...
| [OrderX](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/orderx/) { get; } | Sesuai dengan atribut 'pesanan' pada elemen 'feConvolveMatrix' yang diberikan. |
| [OrderY](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/ordery/) { get; } | Sesuai dengan atribut 'pesanan' pada elemen 'feConvolveMatrix' yang diberikan. |
...
| [PreserveAlpha](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/preservealpha/) { get; } | Sesuai dengan atribut 'preserveAlpha' pada elemen 'feConvolveMatrix' yang diberikan. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/result/) { get; } | Sesuai dengan atribut 'hasil' pada elemen 'filter' yang diberikan. |
...
| [TargetX](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/targetx/) { get; } | Sesuai dengan atribut 'targetX' pada elemen 'feConvolveMatrix' yang diberikan. |
| [TargetY](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/targety/) { get; } | Sesuai dengan atribut 'targetY' pada elemen 'feConvolveMatrix' yang diberikan. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/width/) { get; } | Sesuai dengan atribut 'width' pada elemen 'filter' yang diberikan. |
| [X](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/x/) { get; } | Sesuai dengan atribut 'x' pada elemen 'filter' yang diberikan. |
| [Y](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/y/) { get; } | Sesuai dengan atribut 'y' pada elemen 'filter' yang diberikan. |
...
| Nama | Keterangan |
| --- | --- |
| const [SVG_EDGEMODE_DUPLICATE](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_duplicate/) | Sesuai dengan nilai 'duplikat'. |
| const [SVG_EDGEMODE_NONE](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_none/) | Sesuai dengan nilai 'tidak ada'. |
| const [SVG_EDGEMODE_UNKNOWN](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_unknown/) | Jenisnya bukan salah satu dari jenis yang telah ditentukan sebelumnya. Tidak valid mencoba menentukan nilai baru dari jenis ini atau mencoba mengalihkan nilai yang ada ke jenis ini. |
| const [SVG_EDGEMODE_WRAP](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_wrap/) | Sesuai dengan nilai 'bungkus'. |
