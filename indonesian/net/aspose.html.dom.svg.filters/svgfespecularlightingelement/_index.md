...
description: Aspose.Html.Dom.Svg.Filters.SVGFESpecularLightingElement kelas. Antarmuka SVGFESpecularLightingElement sesuai dengan elemen feSpecularLighting.
type: docs
weight: 1570
url: /id/net/aspose.html.dom.svg.filters/svgfespecularlightingelement/
---
...
| [Height](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/height/) { get; } | Sesuai dengan atribut 'height' pada elemen 'filter' yang diberikan. |
...
| [In1](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/in1/) { get; } | Sesuai dengan atribut 'in' pada elemen 'feSpecularLighting' yang diberikan. |
...
| [KernelUnitLengthX](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/kernelunitlengthx/) { get; } | Sesuai dengan atribut 'kernelUnitLength' pada elemen 'feSpecularLighting' yang diberikan. |
| [KernelUnitLengthY](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/kernelunitlengthy/) { get; } | Sesuai dengan atribut 'kernelUnitLength' pada elemen 'feSpecularLighting' yang diberikan. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/result/) { get; } | Sesuai dengan atribut 'hasil' pada elemen 'filter' yang diberikan. |
...
| [SpecularConstant](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/specularconstant/) { get; } | Sesuai dengan atribut 'specularConstant' pada elemen 'feSpecularLighting' yang diberikan. |
| [SpecularExponent](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/specularexponent/) { get; } | Sesuai dengan atribut 'specularExponent' pada elemen 'feSpecularLighting' yang diberikan. |
...
| [SurfaceScale](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/surfacescale/) { get; } | Sesuai dengan atribut 'surfaceScale' pada elemen 'feSpecularLighting' yang diberikan. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/width/) { get; } | Sesuai dengan atribut 'width' pada elemen 'filter' yang diberikan. |
| [X](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/x/) { get; } | Sesuai dengan atribut 'x' pada elemen 'filter' yang diberikan. |
| [Y](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/y/) { get; } | Sesuai dengan atribut 'y' pada elemen 'filter' yang diberikan. |
