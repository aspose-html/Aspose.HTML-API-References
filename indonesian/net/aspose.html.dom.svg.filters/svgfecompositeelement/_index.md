...
description: Aspose.Html.Dom.Svg.Filters.SVGFECompositeElement kelas. Antarmuka SVGFECompositeElement sesuai dengan elemen feComposite.
type: docs
weight: 1390
url: /id/net/aspose.html.dom.svg.filters/svgfecompositeelement/
---
...
| [Height](../../aspose.html.dom.svg.filters/svgfecompositeelement/height/) { get; } | Sesuai dengan atribut 'height' pada elemen 'filter' yang diberikan. |
...
| [In1](../../aspose.html.dom.svg.filters/svgfecompositeelement/in1/) { get; } | Sesuai dengan atribut 'in' pada elemen 'feComposite' yang diberikan. |
| [In2](../../aspose.html.dom.svg.filters/svgfecompositeelement/in2/) { get; } | Sesuai dengan atribut 'in2' pada elemen 'feComposite' yang diberikan. |
...
| [K1](../../aspose.html.dom.svg.filters/svgfecompositeelement/k1/) { get; } | Sesuai dengan atribut 'k1' pada elemen 'feComposite' yang diberikan. |
| [K2](../../aspose.html.dom.svg.filters/svgfecompositeelement/k2/) { get; } | Sesuai dengan atribut 'k2' pada elemen 'feComposite' yang diberikan. |
| [K3](../../aspose.html.dom.svg.filters/svgfecompositeelement/k3/) { get; } | Sesuai dengan atribut 'k3' pada elemen 'feComposite' yang diberikan. |
| [K4](../../aspose.html.dom.svg.filters/svgfecompositeelement/k4/) { get; } | Sesuai dengan atribut 'k4' pada elemen 'feComposite' yang diberikan. |
...
| [Operator](../../aspose.html.dom.svg.filters/svgfecompositeelement/operator/) { get; } | Sesuai dengan atribut 'operator' pada elemen 'feComposite' yang diberikan. Mengambil salah satu konstanta SVG_FECOMPOSITE_OPERATOR_* yang ditentukan pada antarmuka ini. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfecompositeelement/result/) { get; } | Sesuai dengan atribut 'hasil' pada elemen 'filter' yang diberikan. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfecompositeelement/width/) { get; } | Sesuai dengan atribut 'width' pada elemen 'filter' yang diberikan. |
| [X](../../aspose.html.dom.svg.filters/svgfecompositeelement/x/) { get; } | Sesuai dengan atribut 'x' pada elemen 'filter' yang diberikan. |
| [Y](../../aspose.html.dom.svg.filters/svgfecompositeelement/y/) { get; } | Sesuai dengan atribut 'y' pada elemen 'filter' yang diberikan. |
...
| Nama | Keterangan |
| --- | --- |
| const [SVG_FECOMPOSITE_OPERATOR_ARITHMETIC](../../aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_arithmetic/) | Sesuai dengan nilai 'aritmatika'. |
| const [SVG_FECOMPOSITE_OPERATOR_ATOP](../../aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_atop/) | Sesuai dengan nilai 'di atas'. |
| const [SVG_FECOMPOSITE_OPERATOR_IN](../../aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_in/) | Sesuai dengan nilai 'in'. |
| const [SVG_FECOMPOSITE_OPERATOR_OUT](../../aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_out/) | Sesuai dengan nilai 'keluar'. |
| const [SVG_FECOMPOSITE_OPERATOR_OVER](../../aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_over/) | Sesuai dengan nilai 'over'. |
| const [SVG_FECOMPOSITE_OPERATOR_UNKNOWN](../../aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_unknown/) | Jenisnya bukan salah satu dari jenis yang telah ditentukan sebelumnya. Tidak valid mencoba menentukan nilai baru dari jenis ini atau mencoba mengalihkan nilai yang ada ke jenis ini. |
| const [SVG_FECOMPOSITE_OPERATOR_XOR](../../aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_xor/) | Sesuai dengan nilai 'xor'. |
