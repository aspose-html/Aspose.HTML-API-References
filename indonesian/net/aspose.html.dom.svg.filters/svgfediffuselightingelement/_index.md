...
description: Aspose.Html.Dom.Svg.Filters.SVGFEDiffuseLightingElement kelas. Antarmuka SVGFEDiffuseLightingElement sesuai dengan elemen feDiffuseLighting.
type: docs
weight: 1410
url: /id/net/aspose.html.dom.svg.filters/svgfediffuselightingelement/
---
...
| [DiffuseConstant](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/diffuseconstant/) { get; } | Sesuai dengan atribut 'diffuseConstant' pada elemen 'feDifuseLighting' yang diberikan. |
...
| [Height](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/height/) { get; } | Sesuai dengan atribut 'height' pada elemen 'filter' yang diberikan. |
...
| [In1](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/in1/) { get; } | Sesuai dengan atribut 'in' pada elemen 'feDifuseLighting' yang diberikan. |
...
| [KernelUnitLengthX](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/kernelunitlengthx/) { get; } | Sesuai dengan atribut 'kernelUnitLength' pada elemen 'feDifuseLighting' yang diberikan. |
| [KernelUnitLengthY](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/kernelunitlengthy/) { get; } | Sesuai dengan atribut 'kernelUnitLength' pada elemen 'feDifuseLighting' yang diberikan. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/result/) { get; } | Sesuai dengan atribut 'hasil' pada elemen 'filter' yang diberikan. |
...
| [SurfaceScale](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/surfacescale/) { get; } | Sesuai dengan atribut 'surfaceScale' pada elemen 'feDiffuseLighting' yang diberikan. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/width/) { get; } | Sesuai dengan atribut 'width' pada elemen 'filter' yang diberikan. |
| [X](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/x/) { get; } | Sesuai dengan atribut 'x' pada elemen 'filter' yang diberikan. |
| [Y](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/y/) { get; } | Sesuai dengan atribut 'y' pada elemen 'filter' yang diberikan. |
