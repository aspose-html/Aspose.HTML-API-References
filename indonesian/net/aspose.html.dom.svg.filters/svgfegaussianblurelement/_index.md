...
description: Aspose.Html.Dom.Svg.Filters.SVGFEGaussianBlurElement kelas. Antarmuka SVGFEGaussianBlurElement sesuai dengan elemen feGaussianBlur.
type: docs
weight: 1500
url: /id/net/aspose.html.dom.svg.filters/svgfegaussianblurelement/
---
...
| [Height](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/height/) { get; } | Sesuai dengan atribut �height� pada elemen �filter� yang diberikan. |
...
| [In1](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/in1/) { get; } | Sesuai dengan atribut �in� pada elemen �feGaussianBlur� yang diberikan. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/result/) { get; } | Sesuai dengan atribut �hasil� pada elemen �filter� yang diberikan. |
...
| [StdDeviationX](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/stddeviationx/) { get; } | Sesuai dengan atribut �stdDeviation� pada elemen �feGaussianBlur� yang diberikan. Berisi komponen X dari atribut �stdDeviation�. |
| [StdDeviationY](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/stddeviationy/) { get; } | Sesuai dengan atribut �stdDeviation� pada elemen �feGaussianBlur� yang diberikan. Berisi komponen Y (mungkin dihitung secara otomatis) dari atribut �stdDeviation�. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/width/) { get; } | Sesuai dengan atribut �width� pada elemen �filter� yang diberikan. |
| [X](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/x/) { get; } | Sesuai dengan atribut �x� pada elemen �filter� yang diberikan. |
| [Y](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/y/) { get; } | Sesuai dengan atribut �y� pada elemen �filter� yang diberikan. |
...
| [SetStdDeviation](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/setstddeviation/)(float, float) | Menetapkan nilai untuk atribut �stdDeviation�. |
