...
description: Aspose.Html.Dom.Svg.Filters.SVGFEDropShadowElement kelas. Antarmuka SVGFEDropShadowElement sesuai dengan elemen feDropShadow.
type: docs
weight: 1440
url: /id/net/aspose.html.dom.svg.filters/svgfedropshadowelement/
---
...
| [Dx](../../aspose.html.dom.svg.filters/svgfedropshadowelement/dx/) { get; } | Sesuai dengan atribut 'dx' pada elemen 'feDropShadow' yang diberikan. |
| [Dy](../../aspose.html.dom.svg.filters/svgfedropshadowelement/dy/) { get; } | Sesuai dengan atribut 'dy' pada elemen 'feDropShadow' yang diberikan. |
...
| [Height](../../aspose.html.dom.svg.filters/svgfedropshadowelement/height/) { get; } | Sesuai dengan atribut 'height' pada elemen 'feDropShadow' yang diberikan. |
...
| [In1](../../aspose.html.dom.svg.filters/svgfedropshadowelement/in1/) { get; } | Sesuai dengan atribut 'in' pada elemen 'feDropShadow' yang diberikan. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfedropshadowelement/result/) { get; } | Sesuai dengan atribut 'hasil' pada elemen 'feDropShadow' yang diberikan. |
...
| [StdDeviationX](../../aspose.html.dom.svg.filters/svgfedropshadowelement/stddeviationx/) { get; } | Sesuai dengan atribut 'stdDeviation' pada elemen 'feDropShadow' yang diberikan. Berisi komponen X dari atribut 'stdDeviation'. |
| [StdDeviationY](../../aspose.html.dom.svg.filters/svgfedropshadowelement/stddeviationy/) { get; } | Sesuai dengan atribut 'stdDeviation' pada elemen 'feDropShadow' yang diberikan. Berisi komponen Y (mungkin dihitung secara otomatis) dari atribut 'stdDeviation'. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfedropshadowelement/width/) { get; } | Sesuai dengan atribut 'width' pada elemen 'feDropShadow' yang diberikan. |
| [X](../../aspose.html.dom.svg.filters/svgfedropshadowelement/x/) { get; } | Sesuai dengan atribut 'x' pada elemen 'feDropShadow' yang diberikan. |
| [Y](../../aspose.html.dom.svg.filters/svgfedropshadowelement/y/) { get; } | Sesuai dengan atribut 'y' pada elemen 'feDropShadow' yang diberikan. |
...
| [SetStdDeviation](../../aspose.html.dom.svg.filters/svgfedropshadowelement/setstddeviation/)(float, float) | Menetapkan nilai untuk atribut 'stdDeviation'. |
