...
description: Aspose.Html.HTMLBaseElement kelas. URI basis dokumen IETF RFC 2396 . Lihat definisi elemen BASE di HTML 4.01.
type: docs
weight: 3100
url: /id/net/aspose.html/htmlbaseelement/
---
## HTMLBaseElement class

URI basis dokumen [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ]. Lihat definisi elemen BASE di HTML 4.01.
...
| [Href](../../aspose.html/htmlbaseelement/href/) { get; set; } | URI dasar [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ]. Lihat definisi atribut href di HTML 4.01. |
...
| [Target](../../aspose.html/htmlbaseelement/target/) { get; set; } | Bingkai target default. Lihat definisi atribut target di HTML 4.01. |
