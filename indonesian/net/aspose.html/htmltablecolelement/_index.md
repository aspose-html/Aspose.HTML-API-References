...
description: Aspose.Html.HTMLTableColElement kelas. Mengelompokkan ulangKOL DanCOLGROUP elemen. Lihat definisi elemen COL di HTML 4.01.
type: docs
weight: 3560
url: /id/net/aspose.html/htmltablecolelement/
---
## HTMLTableColElement class

Mengelompokkan ulang`KOL` Dan`COLGROUP` elemen. Lihat definisi elemen COL di HTML 4.01.
...
| Nama | Keterangan |
| --- | --- |
| [Align](../../aspose.html/htmltablecolelement/align/) { get; set; } | Perataan horizontal data sel dalam kolom. Lihat definisi align atribut di HTML 4.01. |
...
| [Ch](../../aspose.html/htmltablecolelement/ch/) { get; set; } | Perataan karakter untuk sel dalam kolom. Lihat atribut char definisi di HTML 4.01. |
...
| [ChOff](../../aspose.html/htmltablecolelement/choff/) { get; set; } | Offset karakter perataan. Lihat definisi atribut charoff di HTML 4.01. |
...
| [Span](../../aspose.html/htmltablecolelement/span/) { get; set; } | Menunjukkan jumlah kolom dalam grup atau dipengaruhi oleh pengelompokan. Lihat definisi atribut span di HTML 4.01. |
...
| [VAlign](../../aspose.html/htmltablecolelement/valign/) { get; set; } | Perataan vertikal data sel dalam kolom. Lihat definisi atribut valign di HTML 4.01. |
| [Width](../../aspose.html/htmltablecolelement/width/) { get; set; } | Lebar kolom default. Lihat definisi atribut lebar di HTML 4.01. |
