...
description: Aspose.Html.HTMLSelectElement kelas. Elemen pilih memungkinkan pemilihan opsi. Opsi yang terkandung dapat langsung diakses melalui elemen pilih sebagai koleksi. Lihat definisi elemen SELECT di HTML 4.01.
type: docs
weight: 3520
url: /id/net/aspose.html/htmlselectelement/
---
## HTMLSelectElement class

Elemen pilih memungkinkan pemilihan opsi. Opsi yang terkandung dapat langsung diakses melalui elemen pilih sebagai koleksi. Lihat definisi elemen SELECT di HTML 4.01.
...
| [Disabled](../../aspose.html/htmlselectelement/disabled/) { get; set; } | Kontrol tidak tersedia dalam konteks ini. Lihat definisi atribut yang dinonaktifkan di HTML 4.01. |
...
| [Form](../../aspose.html/htmlselectelement/form/) { get; } | Jumlah opsi di sini`PILIH` . |
...
| [Length](../../aspose.html/htmlselectelement/length/) { get; set; } | Jumlah opsi di sini`PILIH` . @versi DOM Tingkat 2 |
...
| [Multiple](../../aspose.html/htmlselectelement/multiple/) { get; set; } | Jika benar, banyak`PILIHAN` elemen dapat dipilih dalam hal ini`PILIH` . Lihat definisi multi atribut dalam HTML 4.01. |
| [Name](../../aspose.html/htmlselectelement/name/) { get; set; } | Kontrol formulir atau nama objek saat dikirimkan dengan formulir. Lihat definisi atribut nama di HTML 4.01. |
...
| [Options](../../aspose.html/htmlselectelement/options/) { get; } | Koleksi dari`PILIHAN` elemen yang dikandung oleh elemen ini. @versi DOM Tingkat 2 |
...
| [SelectedIndex](../../aspose.html/htmlselectelement/selectedindex/) { get; set; } | Indeks ordinal dari opsi yang dipilih, mulai dari 0. Nilai -1 dikembalikan jika tidak ada elemen yang dipilih. Jika beberapa opsi dipilih, indeks dari opsi yang dipilih pertama dikembalikan. |
...
| [Size](../../aspose.html/htmlselectelement/size/) { get; set; } | Jumlah baris yang terlihat. Lihat definisi atribut ukuran di HTML 4.01. |
...
| [TabIndex](../../aspose.html/htmlselectelement/tabindex/) { get; set; } | Indeks yang mewakili posisi elemen dalam urutan tab. Lihat definisi atribut tabindex di HTML 4.01. |
...
| [Type](../../aspose.html/htmlselectelement/type/) { get; } | Jenis kontrol formulir ini. Ini adalah string "pilih-banyak" ketika beberapa atribut`BENAR` dan string "pilih-satu" kapan`PALSU` . |
| [Value](../../aspose.html/htmlselectelement/value/) { get; set; } | Nilai kontrol formulir saat ini (yaitu nilai dari opsi yang saat ini dipilih), jika beberapa opsi dipilih, ini adalah nilai dari opsi yang dipilih pertama. |
