...
description: Aspose.Html.HTMLFontElement kelas. Perubahan lokal ke font. Lihat definisi elemen FONT di HTML 4.01. Elemen ini tidak digunakan lagi di HTML 4.01.
type: docs
weight: 3220
url: /id/net/aspose.html/htmlfontelement/
---
## HTMLFontElement class

Perubahan lokal ke font. Lihat definisi elemen FONT di HTML 4.01. Elemen ini tidak digunakan lagi di HTML 4.01.
...
| [Color](../../aspose.html/htmlfontelement/color/) { get; set; } | Warna huruf. Lihat definisi atribut warna dalam HTML 4.01. Atribut ini tidak digunakan lagi di HTML 4.01. |
...
| [Face](../../aspose.html/htmlfontelement/face/) { get; set; } | Pengidentifikasi wajah font. Lihat definisi atribut wajah di HTML 4.01. Atribut ini tidak digunakan lagi di HTML 4.01. |
...
| [Size](../../aspose.html/htmlfontelement/size/) { get; set; } | Ukuran huruf. Lihat definisi atribut ukuran dalam HTML 4.01. Atribut ini tidak digunakan lagi di HTML 4.01. |
