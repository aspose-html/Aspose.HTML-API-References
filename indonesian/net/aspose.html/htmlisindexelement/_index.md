...
description: Aspose.Html.HTMLIsIndexElement kelas. Elemen ini digunakan untuk input teks satu baris. Lihat definisi elemen ISINDEX di HTML 4.01. Elemen ini tidak digunakan lagi dalam HTML 4.01.
type: docs
weight: 3330
url: /id/net/aspose.html/htmlisindexelement/
---
## HTMLIsIndexElement class

Elemen ini digunakan untuk input teks satu baris. Lihat definisi elemen ISINDEX di HTML 4.01. Elemen ini tidak digunakan lagi dalam HTML 4.01.
...
| [Form](../../aspose.html/htmlisindexelement/form/) { get; } | Mengembalikan elemen yang mengandung kontrol ini. Pengembalian jika kontrol ini tidak dalam konteks formulir . |
...
| [Prompt](../../aspose.html/htmlisindexelement/prompt/) { get; set; } | Pesan prompt. Lihat definisi atribut prompt dalam HTML 4.01. Atribut ini tidak digunakan lagi di HTML 4.01. |
