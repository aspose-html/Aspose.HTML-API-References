...
description: Aspose.Html.HTMLBaseFontElement kelas. Font dasar. Lihat definisi elemen BASEFONT di HTML 4.01. Elemen ini tidak digunakan lagi dalam HTML 4.01.
type: docs
weight: 3110
url: /id/net/aspose.html/htmlbasefontelement/
---
## HTMLBaseFontElement class

Font dasar. Lihat definisi elemen BASEFONT di HTML 4.01. Elemen ini tidak digunakan lagi dalam HTML 4.01.
...
| [Color](../../aspose.html/htmlbasefontelement/color/) { get; set; } | Warna huruf. Lihat definisi atribut warna dalam HTML 4.01. Atribut ini tidak digunakan lagi di HTML 4.01. |
...
| [Face](../../aspose.html/htmlbasefontelement/face/) { get; set; } | Pengidentifikasi wajah font. Lihat definisi atribut wajah di HTML 4.01. Atribut ini tidak digunakan lagi di HTML 4.01. |
...
| [Size](../../aspose.html/htmlbasefontelement/size/) { get; set; } | Ukuran font yang dihitung. Lihat definisi atribut ukuran dalam HTML 4.01. Atribut ini tidak digunakan lagi di HTML 4.01. @version DOM Level 2 |
