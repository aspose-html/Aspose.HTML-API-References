...
description: Aspose.Html.HTMLModElement kelas. Pemberitahuan modifikasi pada bagian dokumen. Lihat definisi elemen INS dan DEL di HTML 4.01.
type: docs
weight: 3410
url: /id/net/aspose.html/htmlmodelement/
---
## HTMLModElement class

Pemberitahuan modifikasi pada bagian dokumen. Lihat definisi elemen INS dan DEL di HTML 4.01.
...
| [Cite](../../aspose.html/htmlmodelement/cite/) { get; set; } | Sebuah URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] menunjuk dokumen yang menjelaskan alasan perubahan. Lihat definisi atribut kutipan di HTML 4.01. |
...
| [DateTime](../../aspose.html/htmlmodelement/datetime/) { get; set; } | Tanggal dan waktu perubahan. Lihat definisi atribut datetime di HTML 4.01. |
