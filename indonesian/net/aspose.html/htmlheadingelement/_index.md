...
description: Aspose.Html.HTMLHeadingElement kelas. UntukH1 keH6 elemen. Lihat definisi H1 element di HTML 4.01.
type: docs
weight: 3280
url: /id/net/aspose.html/htmlheadingelement/
---
## HTMLHeadingElement class

Untuk`H1` ke`H6` elemen. Lihat definisi H1 element di HTML 4.01.
...
| Nama | Keterangan |
| --- | --- |
| [Align](../../aspose.html/htmlheadingelement/align/) { get; set; } | Perataan teks horizontal. Lihat definisi atribut align di HTML 4.01. Atribut ini tidak digunakan lagi dalam HTML 4.01. |
