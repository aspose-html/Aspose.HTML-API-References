...
description: Aspose.Html.HTMLDocument kelas. AnDokumen HTML adalah akar dari hierarki HTML dan menampung seluruh konten. Selain menyediakan akses ke hierarki itu juga menyediakan beberapa metode kemudahan untuk mengakses kumpulan informasi tertentu dari dokumen.
type: docs
weight: 3190
url: /id/net/aspose.html/htmldocument/
---
## HTMLDocument class

An`Dokumen HTML` adalah akar dari hierarki HTML dan menampung seluruh konten. Selain menyediakan akses ke hierarki, itu juga menyediakan beberapa metode kemudahan untuk mengakses kumpulan informasi tertentu dari dokumen.

Properti berikut telah ditinggalkan demi properti yang sesuai untuk`TUBUH` element. Di DOM Level 2, metode`getElementById` diwariskan dari`Dokumen` antarmuka tempatnya dipindahkan.
...
| Nama | Keterangan |
| --- | --- |
| [HTMLDocument](htmldocument/#constructor)() | Menginisialisasi instance baru dari`HTMLDocument` kelas. |
| [HTMLDocument](htmldocument/#constructor_1)(Configuration) | Menginisialisasi instance baru dari`HTMLDocument` kelas. |
| [HTMLDocument](htmldocument/#constructor_2)(RequestMessage) | Menginisialisasi instance baru dari`HTMLDocument` kelas. Konstruktor bekerja secara sinkron, menunggu pemuatan semua sumber daya eksternal (gambar, skrip, dll.). Untuk memuat dokumen secara asinkron, gunakan metode[`Navigate`](../../aspose.html.dom/document/navigate/) atau kelebihannya. Atau Anda dapat menonaktifkan pemuatan beberapa sumber daya eksternal dengan menyetel bendera yang sesuai[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_10)(string) | Menginisialisasi instance baru dari`HTMLDocument` kelas. Konstruktor bekerja secara sinkron, menunggu pemuatan semua sumber daya eksternal (gambar, skrip, dll.). Untuk memuat dokumen secara asinkron, gunakan metode[`Navigate`](../../aspose.html.dom/document/navigate/) atau kelebihannya. Atau Anda dapat menonaktifkan pemuatan beberapa sumber daya eksternal dengan menyetel bendera yang sesuai[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_4)(Url) | Menginisialisasi instance baru dari`HTMLDocument` kelas. Konstruktor bekerja secara sinkron, menunggu pemuatan semua sumber daya eksternal (gambar, skrip, dll.). Untuk memuat dokumen secara asinkron, gunakan metode[`Navigate`](../../aspose.html.dom/document/navigate/) atau kelebihannya. Atau Anda dapat menonaktifkan pemuatan beberapa sumber daya eksternal dengan menyetel bendera yang sesuai[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_3)(RequestMessage, Configuration) | Menginisialisasi instance baru dari`HTMLDocument` kelas. Konstruktor bekerja secara sinkron, menunggu pemuatan semua sumber daya eksternal (gambar, skrip, dll.). Untuk memuat dokumen secara asinkron, gunakan metode[`Navigate`](../../aspose.html.dom/document/navigate/) atau kelebihannya. Atau Anda dapat menonaktifkan pemuatan beberapa sumber daya eksternal dengan menyetel bendera yang sesuai[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_8)(Stream, string) | Menginisialisasi instance baru dari`HTMLDocument` kelas. Konstruktor bekerja secara sinkron, menunggu pemuatan semua sumber daya eksternal (gambar, skrip, dll.). Untuk memuat dokumen secara asinkron, gunakan metode[`Navigate`](../../aspose.html.dom/document/navigate/) atau kelebihannya. Atau Anda dapat menonaktifkan pemuatan beberapa sumber daya eksternal dengan menyetel bendera yang sesuai[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . Pemuatan dokumen dimulai dari posisi arus saat ini. |
| [HTMLDocument](htmldocument/#constructor_6)(Stream, Url) | Menginisialisasi instance baru dari`HTMLDocument` kelas. Konstruktor bekerja secara sinkron, menunggu pemuatan semua sumber daya eksternal (gambar, skrip, dll.). Untuk memuat dokumen secara asinkron, gunakan metode[`Navigate`](../../aspose.html.dom/document/navigate/) atau kelebihannya. Atau Anda dapat menonaktifkan pemuatan beberapa sumber daya eksternal dengan menyetel bendera yang sesuai[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . Pemuatan dokumen dimulai dari posisi arus saat ini. |
| [HTMLDocument](htmldocument/#constructor_11)(string, Configuration) | Menginisialisasi instance baru dari`HTMLDocument` kelas. Konstruktor bekerja secara sinkron, menunggu pemuatan semua sumber daya eksternal (gambar, skrip, dll.). Untuk memuat dokumen secara asinkron, gunakan metode[`Navigate`](../../aspose.html.dom/document/navigate/) atau kelebihannya. Atau Anda dapat menonaktifkan pemuatan beberapa sumber daya eksternal dengan menyetel bendera yang sesuai[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_14)(string, string) | Menginisialisasi instance baru dari`HTMLDocument` kelas. Konstruktor bekerja secara sinkron, menunggu pemuatan semua sumber daya eksternal (gambar, skrip, dll.). Untuk memuat dokumen secara asinkron, gunakan metode[`Navigate`](../../aspose.html.dom/document/navigate/) atau kelebihannya. Atau Anda dapat menonaktifkan pemuatan beberapa sumber daya eksternal dengan menyetel bendera yang sesuai[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_12)(string, Url) | Menginisialisasi instance baru dari`HTMLDocument` kelas. Konstruktor bekerja secara sinkron, menunggu pemuatan semua sumber daya eksternal (gambar, skrip, dll.). Untuk memuat dokumen secara asinkron, gunakan metode[`Navigate`](../../aspose.html.dom/document/navigate/) atau kelebihannya. Atau Anda dapat menonaktifkan pemuatan beberapa sumber daya eksternal dengan menyetel bendera yang sesuai[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_5)(Url, Configuration) | Menginisialisasi instance baru dari`HTMLDocument` kelas. Konstruktor bekerja secara sinkron, menunggu pemuatan semua sumber daya eksternal (gambar, skrip, dll.). Untuk memuat dokumen secara asinkron, gunakan metode[`Navigate`](../../aspose.html.dom/document/navigate/) atau kelebihannya. Atau Anda dapat menonaktifkan pemuatan beberapa sumber daya eksternal dengan menyetel bendera yang sesuai[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_9)(Stream, string, Configuration) | Menginisialisasi instance baru dari`HTMLDocument` kelas. Konstruktor bekerja secara sinkron, menunggu pemuatan semua sumber daya eksternal (gambar, skrip, dll.). Untuk memuat dokumen secara asinkron, gunakan metode[`Navigate`](../../aspose.html.dom/document/navigate/) atau kelebihannya. Atau Anda dapat menonaktifkan pemuatan beberapa sumber daya eksternal dengan menyetel bendera yang sesuai[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . Pemuatan dokumen dimulai dari posisi arus saat ini. |
| [HTMLDocument](htmldocument/#constructor_7)(Stream, Url, Configuration) | Menginisialisasi instance baru dari`HTMLDocument` kelas. Konstruktor bekerja secara sinkron, menunggu pemuatan semua sumber daya eksternal (gambar, skrip, dll.). Untuk memuat dokumen secara asinkron, gunakan metode[`Navigate`](../../aspose.html.dom/document/navigate/) atau kelebihannya. Atau Anda dapat menonaktifkan pemuatan beberapa sumber daya eksternal dengan menyetel bendera yang sesuai[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . Pemuatan dokumen dimulai dari posisi arus saat ini. |
| [HTMLDocument](htmldocument/#constructor_15)(string, string, Configuration) | Menginisialisasi instance baru dari`HTMLDocument` kelas. Konstruktor bekerja secara sinkron, menunggu pemuatan semua sumber daya eksternal (gambar, skrip, dll.). Untuk memuat dokumen secara asinkron, gunakan metode[`Navigate`](../../aspose.html.dom/document/navigate/) atau kelebihannya. Atau Anda dapat menonaktifkan pemuatan beberapa sumber daya eksternal dengan menyetel bendera yang sesuai[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
...
| Nama | Keterangan |
| --- | --- |
| [Anchors](../../aspose.html/htmldocument/anchors/) { get; } | Kumpulan semua jangkar (`A` ) elemen dalam dokumen dengan nilai untuk`nama`atribut. Untuk alasan kompatibilitas mundur , set jangkar yang dikembalikan hanya berisi jangkar yang dibuat dengan`nama` atribut, bukan yang dibuat dengan`pengenal` atribut. Perhatikan bahwa di [[XHTML 1.0](http://www.w3.org/TR/2002/REC-xhtml1-20020801) ], `nama` atribut (lihat bagian 4.10) tidak memiliki semantik dan hanya ada untuk agen pengguna lama:`pengenal` atribut digunakan sebagai gantinya. Pengguna sebaiknya memilih mekanisme iterator yang disediakan oleh [[DOM Tingkat 2 Traversal](http://www.w3.org/TR/2000/REC-DOM-Level-2-Traversal-Range-20001113) ] alih-alih. |
| [Applets](../../aspose.html/htmldocument/applets/) { get; } | Koleksi dari semua`OBYEK` elemen yang menyertakan applet dan`APPLET` (usang) elemen dalam dokumen. |
...
| [Body](../../aspose.html/htmldocument/body/) { get; set; } | Elemen yang berisi konten dokumen. Dalam dokumen dengan`TUBUH` isi, mengembalikan`TUBUH` elemen . Dalam dokumen frameset, ini mengembalikan terluar`FRAMESET` elemen. |
...
| [Domain](../../aspose.html/htmldocument/domain/) { get; } | Nama domain dari server yang menyajikan dokumen, atau `batal` jika server tidak dapat diidentifikasi dengan nama domain . |
...
| [Forms](../../aspose.html/htmldocument/forms/) { get; } | Kumpulan semua bentuk dokumen. |
| [Images](../../aspose.html/htmldocument/images/) { get; } | Koleksi dari semua`IMG` elemen dalam sebuah dokumen. Perilaku terbatas pada`IMG` elemen untuk kompatibilitas mundur. Seperti yang disarankan oleh [[HTML4.01](http://www.w3.org/TR/1999/REC-html401-19991224)], untuk menyertakan gambar, penulis dapat menggunakan `OBYEK` elemen atau`IMG` elemen. Oleh karena itu, disarankan untuk tidak menggunakan atribut ini untuk menemukan gambar dalam dokumen tetapi`getElementsByTagName` dengan HTML 4.01 atau`getElementsByTagNameNS` dengan XHTML 1.0. |
...
| [Links](../../aspose.html/htmldocument/links/) { get; } | Koleksi semua`DAERAH` elemen dan jangkar ( `A` ) elemen dalam dokumen dengan nilai untuk `href` atribut. |
...
| [Referrer](../../aspose.html/htmldocument/referrer/) { get; } | Mengembalikan URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) dari halaman yang ditautkan ke halaman ini. Nilainya adalah string kosong jika pengguna membuka halaman secara langsung (tidak melalui tautan, tetapi, misalnya, melalui bookmark). |
...
| [Title](../../aspose.html/htmldocument/title/) { get; set; } | Judul dokumen seperti yang ditentukan oleh`JUDUL` elemen di kepala dokumen. |
...
| [GetOverrideStyle](../../aspose.html/htmldocument/getoverridestyle/)(Element, string) | Metode ini digunakan untuk mengambil deklarasi gaya override untuk elemen tertentu dan elemen semu tertentu. |
...
| override [RenderTo](../../aspose.html/htmldocument/renderto/)(IDevice) | Metode ini digunakan untuk mencetak isi dokumen saat ini ke perangkat yang ditentukan. |
...
| [Save](../../aspose.html/htmldocument/save/#save)(IOutputStorage) | Menyimpan konten dokumen dan sumber daya ke penyimpanan keluaran. |
| [Save](../../aspose.html/htmldocument/save/#save_10)(string) | Menyimpan dokumen ke file lokal yang ditentukan oleh`jalur` Semua sumber daya yang digunakan dalam dokumen ini akan disimpan dalam ke folder yang berdekatan, yang namanya akan dibuat sebagai: nama_file_output + "_files". |
| [Save](../../aspose.html/htmldocument/save/#save_5)(Url) | Menyimpan dokumen ke file lokal yang ditentukan oleh`url` Semua sumber daya yang digunakan dalam dokumen ini akan disimpan dalam ke folder yang berdekatan, yang namanya akan dibuat sebagai: nama_file_output + "_files". |
| [Save](../../aspose.html/htmldocument/save/#save_1)(IOutputStorage, HTMLSaveFormat) | Menyimpan konten dokumen dan sumber daya ke penyimpanan keluaran. |
| [Save](../../aspose.html/htmldocument/save/#save_2)(IOutputStorage, HTMLSaveOptions) | Menyimpan konten dokumen dan sumber daya ke penyimpanan keluaran. |
| [Save](../../aspose.html/htmldocument/save/#save_3)(IOutputStorage, MarkdownSaveOptions) | Menyimpan konten dokumen dan sumber daya ke penyimpanan keluaran. |
| [Save](../../aspose.html/htmldocument/save/#save_4)(IOutputStorage, MHTMLSaveOptions) | Menyimpan konten dokumen dan sumber daya ke penyimpanan keluaran. |
| [Save](../../aspose.html/htmldocument/save/#save_11)(string, HTMLSaveFormat) | Menyimpan dokumen ke file lokal yang ditentukan oleh`jalur` Semua sumber daya yang digunakan dalam dokumen ini akan disimpan dalam ke folder yang berdekatan, yang namanya akan dibuat sebagai: nama_file_output + "_files". |
| [Save](../../aspose.html/htmldocument/save/#save_12)(string, HTMLSaveOptions) | Menyimpan dokumen ke file lokal yang ditentukan oleh`jalur` Semua sumber daya yang digunakan dalam dokumen ini akan disimpan dalam ke folder yang berdekatan, yang namanya akan dibuat sebagai: nama_file_output + "_files". |
| [Save](../../aspose.html/htmldocument/save/#save_13)(string, MarkdownSaveOptions) | Menyimpan dokumen ke file lokal yang ditentukan oleh`jalur` Semua sumber daya yang digunakan dalam dokumen ini akan disimpan dalam ke folder yang berdekatan, yang namanya akan dibuat sebagai: nama_file_output + "_files". |
| [Save](../../aspose.html/htmldocument/save/#save_14)(string, MHTMLSaveOptions) | Menyimpan dokumen ke file lokal yang ditentukan oleh`jalur` Semua sumber daya yang digunakan dalam dokumen ini akan disimpan dalam ke folder yang berdekatan, yang namanya akan dibuat sebagai: nama_file_output + "_files". |
| [Save](../../aspose.html/htmldocument/save/#save_6)(Url, HTMLSaveFormat) | Menyimpan dokumen ke file lokal yang ditentukan oleh`url` Semua sumber daya yang digunakan dalam dokumen ini akan disimpan dalam ke folder yang berdekatan, yang namanya akan dibuat sebagai: nama_file_output + "_files". |
| [Save](../../aspose.html/htmldocument/save/#save_7)(Url, HTMLSaveOptions) | Menyimpan dokumen ke file lokal yang ditentukan oleh`url` Semua sumber daya yang digunakan dalam dokumen ini akan disimpan dalam ke folder yang berdekatan, yang namanya akan dibuat sebagai: nama_file_output + "_files". |
| [Save](../../aspose.html/htmldocument/save/#save_8)(Url, MarkdownSaveOptions) | Menyimpan dokumen ke file lokal yang ditentukan oleh`url` Semua sumber daya yang digunakan dalam dokumen ini akan disimpan dalam ke folder yang berdekatan, yang namanya akan dibuat sebagai: nama_file_output + "_files". |
| [Save](../../aspose.html/htmldocument/save/#save_9)(Url, MHTMLSaveOptions) | Menyimpan dokumen ke file lokal yang ditentukan oleh`url` Semua sumber daya yang digunakan dalam dokumen ini akan disimpan dalam ke folder yang berdekatan, yang namanya akan dibuat sebagai: nama_file_output + "_files". |
