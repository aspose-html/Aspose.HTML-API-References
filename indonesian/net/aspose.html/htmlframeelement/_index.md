...
description: Aspose.Html.HTMLFrameElement kelas. Buat bingkai. Lihat definisi elemen FRAME di HTML 4.01.
type: docs
weight: 3240
url: /id/net/aspose.html/htmlframeelement/
---
## HTMLFrameElement class

Buat bingkai. Lihat definisi elemen FRAME di HTML 4.01.
...
| [ContentDocument](../../aspose.html/htmlframeelement/contentdocument/) { get; } | Dokumen yang berisi bingkai ini, jika ada dan tersedia, atau`batal` sebaliknya. @sejak DOM Level 2 |
...
| [FrameBorder](../../aspose.html/htmlframeelement/frameborder/) { get; set; } | Minta batas bingkai. Lihat definisi atribut frameborder di HTML 4.01. |
...
| [LongDesc](../../aspose.html/htmlframeelement/longdesc/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] menunjukkan deskripsi panjang tentang gambar atau bingkai ini. Lihat definisi atribut longdesc di HTML 4.01. |
| [MarginHeight](../../aspose.html/htmlframeelement/marginheight/) { get; set; } | Tinggi margin bingkai, dalam piksel. Lihat definisi atribut marginheight di HTML 4.01. |
| [MarginWidth](../../aspose.html/htmlframeelement/marginwidth/) { get; set; } | Lebar margin bingkai, dalam piksel. Lihat definisi atribut marginwidth di HTML 4.01. |
| [Name](../../aspose.html/htmlframeelement/name/) { get; set; } | Nama bingkai (objek dari`target` atribut). Lihat definisi atribut nama di HTML 4.01. |
...
| [NoResize](../../aspose.html/htmlframeelement/noresize/) { get; set; } | Jika benar, larang pengguna mengubah ukuran bingkai. Lihat definisi atribut noresize di HTML 4.01. |
...
| [Scrolling](../../aspose.html/htmlframeelement/scrolling/) { get; set; } | Tentukan apakah frame harus memiliki scrollbar atau tidak. Lihat definisi atribut bergulir di HTML 4.01. |
...
| [Src](../../aspose.html/htmlframeelement/src/) { get; set; } | Sebuah URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] menunjuk konten bingkai awal. Lihat atribut src definisi di HTML 4.01. |
