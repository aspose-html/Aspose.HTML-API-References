...
description: Aspose.Html.HTMLLIElement kelas. Daftar item. Lihat definisi elemen LI di HTML 4.01.
type: docs
weight: 3340
url: /id/net/aspose.html/htmllielement/
---
## HTMLLIElement class

Daftar item. Lihat definisi elemen LI di HTML 4.01.
...
| [Type](../../aspose.html/htmllielement/type/) { get; set; } | Cantumkan gaya peluru item. Lihat definisi atribut tipe di HTML 4.01. Atribut ini tidak digunakan lagi di HTML 4.01. |
| [Value](../../aspose.html/htmllielement/value/) { get; set; } | Setel ulang nomor urut saat digunakan di`OL` . Lihat definisi atribut nilai di HTML 4.01. Atribut ini tidak digunakan lagi di HTML 4.01. |
