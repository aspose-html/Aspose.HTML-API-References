...
description: Aspose.Html.HTMLTableCaptionElement kelas. Keterangan tabel Lihat definisi elemen CAPTION di HTML 4.01.
type: docs
weight: 3540
url: /id/net/aspose.html/htmltablecaptionelement/
---
## HTMLTableCaptionElement class

Keterangan tabel Lihat definisi elemen CAPTION di HTML 4.01.
...
| Nama | Keterangan |
| --- | --- |
| [Align](../../aspose.html/htmltablecaptionelement/align/) { get; set; } | Perataan teks sehubungan dengan tabel. Lihat definisi align atribut di HTML 4.01. Atribut ini tidak digunakan lagi dalam HTML 4.01. |
