...
description: Aspose.Html.HTMLPreElement kelas. Teks yang telah diformat sebelumnya. Lihat definisi elemen PRE di HTML 4.01.
type: docs
weight: 3490
url: /id/net/aspose.html/htmlpreelement/
---
## HTMLPreElement class

Teks yang telah diformat sebelumnya. Lihat definisi elemen PRE di HTML 4.01.
...
| [Width](../../aspose.html/htmlpreelement/width/) { get; set; } | Lebar tetap untuk konten. Lihat definisi atribut lebar di HTML 4.01. Atribut ini tidak digunakan lagi dalam HTML 4.01. |
