...
description: Aspose.Html.HTMLDirectoryElement kelas. Daftar direktori. Lihat definisi elemen DIR di HTML 4.01. Elemen ini tidak digunakan lagi dalam HTML 4.01.
type: docs
weight: 3170
url: /id/net/aspose.html/htmldirectoryelement/
---
## HTMLDirectoryElement class

Daftar direktori. Lihat definisi elemen DIR di HTML 4.01. Elemen ini tidak digunakan lagi dalam HTML 4.01.
...
| [Compact](../../aspose.html/htmldirectoryelement/compact/) { get; set; } | Kurangi spasi antar item daftar. Lihat definisi atribut kompak di HTML 4.01. Atribut ini tidak digunakan lagi dalam HTML 4.01. |
