...
description: Aspose.Html.HTMLMenuElement kelas. Daftar menu. Lihat definisi elemen MENU di HTML 4.01. Elemen ini tidak digunakan lagi di HTML 4.01.
type: docs
weight: 3390
url: /id/net/aspose.html/htmlmenuelement/
---
## HTMLMenuElement class

Daftar menu. Lihat definisi elemen MENU di HTML 4.01. Elemen ini tidak digunakan lagi di HTML 4.01.
...
| [Compact](../../aspose.html/htmlmenuelement/compact/) { get; set; } | Kurangi spasi antar item daftar. Lihat definisi atribut kompak di HTML 4.01. Atribut ini tidak digunakan lagi dalam HTML 4.01. |
