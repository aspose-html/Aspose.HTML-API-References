...
description: Aspose.Html.HTMLAreaElement kelas. Definisi area peta gambar sisi klien. Lihat definisi elemen AREA di HTML 4.01.
type: docs
weight: 3080
url: /id/net/aspose.html/htmlareaelement/
---
## HTMLAreaElement class

Definisi area peta gambar sisi klien. Lihat definisi elemen AREA di HTML 4.01.
...
| Nama | Keterangan |
| --- | --- |
| [AccessKey](../../aspose.html/htmlareaelement/accesskey/) { get; set; } | Kunci akses karakter tunggal untuk memberikan akses ke kontrol formulir. Lihat definisi atribut accesskey di HTML 4.01. |
| [Alt](../../aspose.html/htmlareaelement/alt/) { get; set; } | Teks alternatif untuk agen pengguna yang tidak merender konten normal elemen ini. Lihat definisi atribut alt di HTML 4.01. |
...
| [Coords](../../aspose.html/htmlareaelement/coords/) { get; set; } | daftar panjang yang dipisahkan koma, menentukan geometri wilayah aktif. Lihat juga`membentuk` untuk bentuk wilayah. Lihat definisi atribut coords di HTML 4.01. |
...
| [Href](../../aspose.html/htmlareaelement/href/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] dari sumber daya yang ditautkan. Lihat definisi atribut href di HTML 4.01. |
...
| [NoHref](../../aspose.html/htmlareaelement/nohref/) { get; set; } | Menentukan bahwa area ini tidak aktif, misalnya, tidak memiliki tindakan terkait. Lihat definisi atribut nohref di HTML 4.01. |
...
| [RelList](../../aspose.html/htmlareaelement/rellist/) { get; } | Mengembalikan DOMTokenList langsung yang berisi token yang diterima dari penguraian atribut "rel". |
...
| [Shape](../../aspose.html/htmlareaelement/shape/) { get; set; } | Bentuk area aktif. Koordinat diberikan oleh `coord` . Lihat definisi atribut bentuk di HTML 4.01. |
...
| [TabIndex](../../aspose.html/htmlareaelement/tabindex/) { get; set; } | Indeks yang mewakili posisi elemen dalam urutan tab. Lihat definisi atribut tabindex di HTML 4.01. |
| [TagName](../../aspose.html.dom/element/tagname/) { get; } | Nama elemen. |
| [Target](../../aspose.html/htmlareaelement/target/) { get; set; } | Bingkai untuk merender sumber daya. Lihat definisi atribut target di HTML 4.01. |
