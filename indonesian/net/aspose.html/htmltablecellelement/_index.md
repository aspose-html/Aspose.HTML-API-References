...
description: Aspose.Html.HTMLTableCellElement kelas. Objek yang digunakan untuk mewakiliTH DanTD elemen. Lihat definisi elemen TD di HTML 4.01.
type: docs
weight: 3550
url: /id/net/aspose.html/htmltablecellelement/
---
## HTMLTableCellElement class

Objek yang digunakan untuk mewakili`TH` Dan`TD` elemen. Lihat definisi elemen TD di HTML 4.01.
...
| Nama | Keterangan |
| --- | --- |
| [Abbr](../../aspose.html/htmltablecellelement/abbr/) { get; set; } | Singkatan untuk sel header. Lihat definisi atribut abbr di HTML 4.01. |
| [Align](../../aspose.html/htmltablecellelement/align/) { get; set; } | Perataan horizontal data dalam sel. Lihat definisi atribut align di HTML 4.01. |
...
| [Axis](../../aspose.html/htmltablecellelement/axis/) { get; set; } | Beri nama grup dari header terkait. Lihat definisi atribut sumbu di HTML 4.01. |
...
| [BgColor](../../aspose.html/htmltablecellelement/bgcolor/) { get; set; } | Warna latar sel. Lihat definisi atribut bgcolor di HTML 4.01. Atribut ini tidak digunakan lagi dalam HTML 4.01. |
| [CellIndex](../../aspose.html/htmltablecellelement/cellindex/) { get; } | Indeks sel ini dalam baris, mulai dari 0. Indeks ini dalam urutan pohon dokumen dan bukan urutan tampilan. |
| [Ch](../../aspose.html/htmltablecellelement/ch/) { get; set; } | Perataan karakter untuk sel dalam kolom. Lihat atribut char definisi di HTML 4.01. |
...
| [ChOff](../../aspose.html/htmltablecellelement/choff/) { get; set; } | Offset karakter perataan. Lihat definisi atribut charoff di HTML 4.01. |
...
| [ColSpan](../../aspose.html/htmltablecellelement/colspan/) { get; set; } | Jumlah kolom yang dibentang oleh sel. Lihat definisi atribut colspan di HTML 4.01. |
...
| [Headers](../../aspose.html/htmltablecellelement/headers/) { get; set; } | Daftar`pengenal` nilai atribut untuk sel header. Lihat definisi atribut header di HTML 4.01. |
| [Height](../../aspose.html/htmltablecellelement/height/) { get; set; } | Tinggi sel. Lihat definisi atribut ketinggian di HTML 4.01. Atribut ini tidak digunakan lagi di HTML 4.01. |
...
| [NoWrap](../../aspose.html/htmltablecellelement/nowrap/) { get; set; } | Menekan pembungkusan kata. Lihat definisi atribut nowrap di HTML 4.01. Atribut ini tidak digunakan lagi dalam HTML 4.01. |
...
| [RowSpan](../../aspose.html/htmltablecellelement/rowspan/) { get; set; } | Jumlah baris yang dibentangkan oleh sel. Lihat definisi atribut rowspan di HTML 4.01. |
| [SchemaTypeInfo](../../aspose.html.dom/element/schematypeinfo/) { get; } | Jenis informasi yang terkait dengan elemen ini. |
| [Scope](../../aspose.html/htmltablecellelement/scope/) { get; set; } | Cakupan dicakup oleh sel header. Lihat definisi atribut cakupan di HTML 4.01. |
...
| [VAlign](../../aspose.html/htmltablecellelement/valign/) { get; set; } | Perataan vertikal data dalam sel. Lihat definisi atribut valign di HTML 4.01. |
| [Width](../../aspose.html/htmltablecellelement/width/) { get; set; } | Lebar sel. Lihat definisi atribut lebar dalam HTML 4.01. Atribut ini tidak digunakan lagi di HTML 4.01. |
