...
description: Aspose.Html.HTMLFrameSetElement kelas. Buat kotak bingkai. Lihat definisi elemen FRAMESET di HTML 4.01.
type: docs
weight: 3250
url: /id/net/aspose.html/htmlframesetelement/
---
## HTMLFrameSetElement class

Buat kotak bingkai. Lihat definisi elemen FRAMESET di HTML 4.01.
...
| [Cols](../../aspose.html/htmlframesetelement/cols/) { get; set; } | Jumlah kolom frame dalam frameset. Lihat atribut cols definisi di HTML 4.01. |
...
| [Rows](../../aspose.html/htmlframesetelement/rows/) { get; set; } | Jumlah baris frame dalam frameset. Lihat definisi baris atribut di HTML 4.01. |
