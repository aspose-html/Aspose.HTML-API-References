...
description: Aspose.Html.HTMLButtonElement kelas. Tekan tombol. Lihat definisi elemen BUTTON di HTML 4.01.
type: docs
weight: 3130
url: /id/net/aspose.html/htmlbuttonelement/
---
## HTMLButtonElement class

Tekan tombol. Lihat definisi elemen BUTTON di HTML 4.01.
...
| Nama | Keterangan |
| --- | --- |
| [AccessKey](../../aspose.html/htmlbuttonelement/accesskey/) { get; set; } | Kunci akses karakter tunggal untuk memberikan akses ke kontrol formulir. Lihat definisi atribut accesskey di HTML 4.01. |
...
| [Disabled](../../aspose.html/htmlbuttonelement/disabled/) { get; set; } | Kontrol tidak tersedia dalam konteks ini. Lihat definisi atribut yang dinonaktifkan di HTML 4.01. |
...
| [Form](../../aspose.html/htmlbuttonelement/form/) { get; } | Mengembalikan`MEMBENTUK` elemen yang mengandung kontrol ini. Pengembalian `batal` jika kontrol ini tidak dalam konteks formulir . |
...
| [Name](../../aspose.html/htmlbuttonelement/name/) { get; set; } | Kontrol formulir atau nama objek saat dikirimkan dengan formulir. Lihat definisi atribut nama di HTML 4.01. |
...
| [TabIndex](../../aspose.html/htmlbuttonelement/tabindex/) { get; set; } | Indeks yang mewakili posisi elemen dalam urutan tab. Lihat definisi atribut tabindex di HTML 4.01. |
...
| [Type](../../aspose.html/htmlbuttonelement/type/) { get; set; } | Jenis tombol (semua huruf kecil). Lihat definisi atribut tipe di HTML 4.01. |
| [Value](../../aspose.html/htmlbuttonelement/value/) { get; set; } | Nilai kontrol formulir saat ini. Lihat definisi atribut nilai di HTML 4.01. |
