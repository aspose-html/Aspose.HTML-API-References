...
description: Aspose.Html.HTMLFormElement kelas. ItuMEMBENTUK elemen mencakup perilaku yang mirip dengan koleksi dan elemen. Ini memberikan akses langsung ke kontrol formulir yang terkandung serta atribut elemen formulir. Lihat definisi elemen FORM di HTML 4.01.
type: docs
weight: 3230
url: /id/net/aspose.html/htmlformelement/
---
## HTMLFormElement class

Itu`MEMBENTUK` elemen mencakup perilaku yang mirip dengan koleksi dan elemen. Ini memberikan akses langsung ke kontrol formulir yang terkandung serta atribut elemen formulir. Lihat definisi elemen FORM di HTML 4.01.
...
| Nama | Keterangan |
| --- | --- |
| [AcceptCharset](../../aspose.html/htmlformelement/acceptcharset/) { get; set; } | Daftar kumpulan karakter yang didukung oleh server. Lihat definisi atribut accept-charset di HTML 4.01. |
| [Action](../../aspose.html/htmlformelement/action/) { get; set; } | Pengendali formulir sisi server. Lihat definisi atribut tindakan dalam HTML 4.01. |
...
| [Elements](../../aspose.html/htmlformelement/elements/) { get; } | Mengembalikan kumpulan semua elemen kontrol formulir di formulir. |
| [Enctype](../../aspose.html/htmlformelement/enctype/) { get; set; } | Jenis konten dari formulir yang dikirimkan, umumnya "application/x-www-form-urlencoded". Lihat definisi atribut enctype di HTML 4.01. Onsubmit even handler tidak dijamin dipicu saat memanggil metode ini. Perilaku tidak konsisten karena alasan historis dan penulis tidak boleh mengandalkan perilaku tertentu. |
...
| [Length](../../aspose.html/htmlformelement/length/) { get; } | Jumlah kontrol formulir dalam formulir. |
...
| [Method](../../aspose.html/htmlformelement/method/) { get; set; } | metode HTTP [[IETF RFC 2616](http://www.ietf.org/rfc/rfc2616.txt) digunakan untuk mengirimkan formulir. Lihat definisi atribut metode dalam HTML 4.01. |
| [Name](../../aspose.html/htmlformelement/name/) { get; set; } | Beri nama formulir. |
...
| [Target](../../aspose.html/htmlformelement/target/) { get; set; } | Bingkai untuk merender sumber daya. Lihat definisi atribut target di HTML 4.01. |
...
| [Reset](../../aspose.html/htmlformelement/reset/)() | Mengembalikan nilai default elemen formulir. Itu melakukan tindakan yang sama sebagai tombol reset. |
...
| [Submit](../../aspose.html/htmlformelement/submit/)() | Mengirimkan formulir. Ini melakukan tindakan yang sama seperti tombol kirim. |
