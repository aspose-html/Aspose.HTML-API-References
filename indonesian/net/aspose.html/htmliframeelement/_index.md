...
description: Aspose.Html.HTMLIFrameElement kelas. Subjendela sebaris. Lihat definisi elemen IFRAME di HTML 4.01.
type: docs
weight: 3300
url: /id/net/aspose.html/htmliframeelement/
---
## HTMLIFrameElement class

Subjendela sebaris. Lihat definisi elemen IFRAME di HTML 4.01.
...
| Nama | Keterangan |
| --- | --- |
| [Align](../../aspose.html/htmliframeelement/align/) { get; set; } | Meratakan objek ini (vertikal atau horizontal) sehubungan dengan teks di sekitarnya. Lihat definisi atribut align di HTML 4.01. Atribut ini tidak digunakan lagi di HTML 4.01. |
...
| [FrameBorder](../../aspose.html/htmliframeelement/frameborder/) { get; set; } | Minta batas bingkai. Lihat definisi atribut frameborder di HTML 4.01. |
| [Height](../../aspose.html/htmliframeelement/height/) { get; set; } | Tinggi bingkai. Lihat definisi atribut ketinggian di HTML 4.01. |
...
| [LongDesc](../../aspose.html/htmliframeelement/longdesc/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] menunjukkan deskripsi panjang tentang gambar atau bingkai ini. Lihat definisi atribut longdesc di HTML 4.01. |
| [MarginHeight](../../aspose.html/htmliframeelement/marginheight/) { get; set; } | Tinggi margin bingkai, dalam piksel. Lihat definisi atribut marginheight di HTML 4.01. |
| [MarginWidth](../../aspose.html/htmliframeelement/marginwidth/) { get; set; } | Lebar margin bingkai, dalam piksel. Lihat definisi atribut marginwidth di HTML 4.01. |
| [Name](../../aspose.html/htmliframeelement/name/) { get; set; } | Nama bingkai (objek dari`target` atribut). Lihat definisi atribut nama di HTML 4.01. |
...
| [Scrolling](../../aspose.html/htmliframeelement/scrolling/) { get; set; } | Tentukan apakah frame harus memiliki scrollbar atau tidak. Lihat definisi atribut bergulir di HTML 4.01. |
...
| [Src](../../aspose.html/htmliframeelement/src/) { get; set; } | Sebuah URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] menunjuk konten bingkai awal. Lihat atribut src definisi di HTML 4.01. |
...
| [Width](../../aspose.html/htmliframeelement/width/) { get; set; } | Lebar bingkai. Lihat definisi atribut lebar di HTML 4.01. |
