...
description: Aspose.Html.HTMLOptionElement kelas. Pilihan yang dapat dipilih. Lihat definisi elemen OPTION di HTML 4.01.
type: docs
weight: 3460
url: /id/net/aspose.html/htmloptionelement/
---
## HTMLOptionElement class

Pilihan yang dapat dipilih. Lihat definisi elemen OPTION di HTML 4.01.
...
| [DefaultSelected](../../aspose.html/htmloptionelement/defaultselected/) { get; set; } | Mewakili nilai atribut HTML yang dipilih. Nilai atribut ini tidak berubah jika status kontrol formulir yang sesuai, dalam agen pengguna interaktif, berubah. Lihat definisi atribut yang dipilih di HTML 4.01. @version DOM Level 2 |
...
| [Disabled](../../aspose.html/htmloptionelement/disabled/) { get; set; } | Kontrol tidak tersedia dalam konteks ini. Lihat definisi atribut yang dinonaktifkan di HTML 4.01. |
...
| [Form](../../aspose.html/htmloptionelement/form/) { get; } | Mengembalikan`MEMBENTUK` elemen yang mengandung kontrol ini. Pengembalian `batal` jika kontrol ini tidak dalam konteks formulir . |
| [Id](../../aspose.html/htmlelement/id/) { get; set; } | Pengidentifikasi elemen. Lihat definisi atribut id di HTML 4.01. |
| [Index](../../aspose.html/htmloptionelement/index/) { get; } | Indeks ini`PILIHAN` dalam induknya`PILIH` , mulai dari 0. @version DOM Level 2 |
...
| [Label](../../aspose.html/htmloptionelement/label/) { get; set; } | Label opsi untuk digunakan dalam menu hierarkis. Lihat definisi atribut label di HTML 4.01. |
...
| [Selected](../../aspose.html/htmloptionelement/selected/) { get; set; } | Mewakili status saat ini dari kontrol formulir terkait, dalam agen pengguna interaktif . Mengubah atribut ini akan mengubah status kontrol formulir, tetapi tidak mengubah nilai atribut HTML yang dipilih dari elemen tersebut. |
...
| [Text](../../aspose.html/htmloptionelement/text/) { get; } | Teks yang terkandung dalam elemen opsi. |
...
| [Value](../../aspose.html/htmloptionelement/value/) { get; set; } | Nilai kontrol formulir saat ini. Lihat definisi atribut nilai dalam HTML 4.01. |
