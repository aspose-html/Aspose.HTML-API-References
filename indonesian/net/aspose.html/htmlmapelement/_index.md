...
description: Aspose.Html.HTMLMapElement kelas. Peta gambar sisi klien. Lihat definisi elemen MAP di HTML 4.01.
type: docs
weight: 3380
url: /id/net/aspose.html/htmlmapelement/
---
## HTMLMapElement class

Peta gambar sisi klien. Lihat definisi elemen MAP di HTML 4.01.
...
| Nama | Keterangan |
| --- | --- |
| [Areas](../../aspose.html/htmlmapelement/areas/) { get; } | Daftar area yang ditentukan untuk peta gambar. |
...
| [Name](../../aspose.html/htmlmapelement/name/) { get; set; } | Memberi nama peta (untuk digunakan dengan`usemap` ). Lihat definisi atribut nama di HTML 4.01. |
