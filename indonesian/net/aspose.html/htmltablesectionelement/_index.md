...
description: Aspose.Html.HTMLTableSectionElement kelas. ItuTHEAD TFOOT  DanTBODY elemen.
type: docs
weight: 3590
url: /id/net/aspose.html/htmltablesectionelement/
---
## HTMLTableSectionElement class

Itu`THEAD` ,`TFOOT` , Dan`TBODY` elemen.
...
| Nama | Keterangan |
| --- | --- |
| [Align](../../aspose.html/htmltablesectionelement/align/) { get; set; } | Perataan horizontal data dalam sel. Lihat`meluruskan` untuk HTMLTheadElement untuk detailnya. |
...
| [Ch](../../aspose.html/htmltablesectionelement/ch/) { get; set; } | Perataan karakter untuk sel dalam kolom. Lihat atribut char definisi di HTML 4.01. |
...
| [ChOff](../../aspose.html/htmltablesectionelement/choff/) { get; set; } | Offset karakter perataan. Lihat definisi atribut charoff di HTML 4.01. |
...
| [Rows](../../aspose.html/htmltablesectionelement/rows/) { get; } | Kumpulan baris pada bagian tabel ini. |
...
| [VAlign](../../aspose.html/htmltablesectionelement/valign/) { get; set; } | Perataan vertikal data dalam sel. Lihat`valign` untuk HTMLTheadElement untuk detailnya. |
...
| [DeleteRow](../../aspose.html/htmltablesectionelement/deleterow/)(int) | Hapus satu baris dari bagian ini. |
...
| [InsertRow](../../aspose.html/htmltablesectionelement/insertrow/)(int) | Masukkan baris ke bagian ini. Baris baru dimasukkan segera sebelum arus`indeks` baris ke-th di bagian ini. Jika `indeks` adalah -1 atau sama dengan jumlah baris di bagian ini, baris baru ditambahkan. |
