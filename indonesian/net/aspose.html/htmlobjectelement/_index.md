...
description: Aspose.Html.HTMLObjectElement kelas. Objek tertanam generik.Pada prinsipnya semua properti pada elemen objek adalah bacatulis tetapi di beberapa lingkungan beberapa properti mungkin hanyabaca setelah objek yang mendasarinya dibuat. Lihat definisi elemen OBJEK di HTML4.01 .
type: docs
weight: 3440
url: /id/net/aspose.html/htmlobjectelement/
---
## HTMLObjectElement class

Objek tertanam generik.Pada prinsipnya, semua properti pada elemen objek adalah baca-tulis tetapi di beberapa lingkungan beberapa properti mungkin hanya-baca setelah objek yang mendasarinya dibuat. Lihat definisi elemen OBJEK di [[HTML4.01](http://www.w3.org/TR/1999/REC-html401-19991224) ].
...
| Nama | Keterangan |
| --- | --- |
| [Align](../../aspose.html/htmlobjectelement/align/) { get; set; } | Meratakan objek ini (vertikal atau horizontal) sehubungan dengan teks di sekitarnya. Lihat definisi atribut align di HTML 4.01. Atribut ini tidak digunakan lagi dalam HTML 4.01. |
| [Archive](../../aspose.html/htmlobjectelement/archive/) { get; set; } | Daftar arsip yang dipisahkan ruang. Lihat definisi atribut arsip di HTML 4.01. |
...
| [Border](../../aspose.html/htmlobjectelement/border/) { get; set; } | Lebar batas di sekeliling objek. Lihat definisi atribut border di HTML 4.01. Atribut ini tidak digunakan lagi dalam HTML 4.01. |
...
| [ClassId](../../aspose.html/htmlobjectelement/classid/) { get; set; } | Menentukan nilai ID kelas seperti yang diatur dalam Registri Windows atau URL |
...
| [Code](../../aspose.html/htmlobjectelement/code/) { get; set; } | file kelas Applet. Lihat`kode` atribut untuk HTMLAppletElement. |
| [CodeBase](../../aspose.html/htmlobjectelement/codebase/) { get; set; } | Basis URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] untuk`identitas kelas` ,`data` , dan `arsip` atribut. Lihat definisi atribut basis kode di HTML 4.01. |
| [CodeType](../../aspose.html/htmlobjectelement/codetype/) { get; set; } | Jenis konten untuk data yang diunduh melalui`identitas kelas` atribut. Lihat definisi atribut codetype di HTML 4.01. |
| [Data](../../aspose.html/htmlobjectelement/data/) { get; set; } | Sebuah URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] menentukan lokasi data objek. Lihat definisi atribut data di HTML 4.01. |
| [Declare](../../aspose.html/htmlobjectelement/declare/) { get; set; } | Deklarasikan (untuk referensi di masa mendatang), tetapi jangan membuat instance, objek ini. Lihat definisi atribut deklarasi di HTML 4.01. |
...
| [Form](../../aspose.html/htmlobjectelement/form/) { get; set; } | Mengembalikan`MEMBENTUK` elemen yang mengandung kontrol ini. Pengembalian`batal` jika kontrol ini tidak berada dalam konteks formulir. |
| [Height](../../aspose.html/htmlobjectelement/height/) { get; set; } | Kesampingkan ketinggian. Lihat definisi atribut ketinggian di HTML 4.01. |
| [Hspace](../../aspose.html/htmlobjectelement/hspace/) { get; set; } | Ruang horizontal, dalam piksel, di kiri dan kanan gambar ini, applet , atau objek. Lihat definisi atribut hspace di HTML 4.01. Atribut ini tidak digunakan lagi di HTML 4.01. |
...
| [Name](../../aspose.html/htmlobjectelement/name/) { get; set; } | Kontrol formulir atau nama objek saat dikirimkan dengan formulir. Lihat definisi atribut nama di HTML 4.01. |
...
| [Standby](../../aspose.html/htmlobjectelement/standby/) { get; set; } | Pesan untuk dirender saat memuat objek. Lihat atribut siaga definisi di HTML 4.01. |
...
| [TabIndex](../../aspose.html/htmlobjectelement/tabindex/) { get; set; } | Indeks yang mewakili posisi elemen dalam urutan tab. Lihat definisi atribut tabindex di HTML 4.01. |
...
| [Type](../../aspose.html/htmlobjectelement/type/) { get; set; } | Jenis konten untuk data yang diunduh melalui`data` atribut. Lihat definisi atribut tipe di HTML 4.01. |
| [UseMap](../../aspose.html/htmlobjectelement/usemap/) { get; set; } | Gunakan peta gambar sisi klien. Lihat definisi atribut usemap di HTML 4.01. |
| [Vspace](../../aspose.html/htmlobjectelement/vspace/) { get; set; } | Ruang vertikal, dalam piksel, di atas dan di bawah gambar, applet, atau objek ini. Lihat definisi atribut vspace di HTML 4.01. Atribut ini tidak digunakan lagi dalam HTML 4.01. |
| [Width](../../aspose.html/htmlobjectelement/width/) { get; set; } | Ganti lebar. Lihat definisi atribut lebar di HTML 4.01. |
