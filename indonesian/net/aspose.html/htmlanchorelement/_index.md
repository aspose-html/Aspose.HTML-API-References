...
description: Aspose.Html.HTMLAnchorElement kelas. Elemen jangkar. Lihat definisi elemen A dalam HTML 4.01.
type: docs
weight: 3060
url: /id/net/aspose.html/htmlanchorelement/
---
## HTMLAnchorElement class

Elemen jangkar. Lihat definisi elemen A dalam HTML 4.01.
...
| Nama | Keterangan |
| --- | --- |
| [AccessKey](../../aspose.html/htmlanchorelement/accesskey/) { get; set; } | Kunci akses karakter tunggal untuk memberikan akses ke kontrol formulir. Lihat definisi atribut accesskey di HTML 4.01. |
...
| [Charset](../../aspose.html/htmlanchorelement/charset/) { get; set; } | Pengkodean karakter dari sumber tertaut. Lihat definisi atribut charset di HTML 4.01. |
...
| [Coords](../../aspose.html/htmlanchorelement/coords/) { get; set; } | daftar panjang yang dipisahkan koma, menentukan geometri wilayah aktif. Lihat juga`membentuk` untuk bentuk wilayah. Lihat definisi atribut coords di HTML 4.01. |
...
| [Hash](../../aspose.html/htmlanchorelement/hash/) { get; set; } | Mendapat atau menetapkan representasi string dari segmen hash dari URL terkait. |
| [Host](../../aspose.html/htmlanchorelement/host/) { get; set; } | Mendapat atau menetapkan representasi string dari segmen host dan port dari URL terkait. |
| [Hostname](../../aspose.html/htmlanchorelement/hostname/) { get; set; } | Mendapat atau menetapkan representasi string dari segmen host dari URL terkait. |
| [Href](../../aspose.html/htmlanchorelement/href/) { get; set; } | URI absolut [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) dari sumber daya yang ditautkan. Lihat atribut href definisi di HTML 4.01. |
| [Hreflang](../../aspose.html/htmlanchorelement/hreflang/) { get; set; } | Kode bahasa sumber tertaut. Lihat definisi atribut hreflang di HTML 4.01. |
...
| [Name](../../aspose.html/htmlanchorelement/name/) { get; set; } | Nama jangkar. Lihat definisi atribut nama dalam HTML 4.01. |
...
| [Origin](../../aspose.html/htmlanchorelement/origin/) { get; } | Mendapat representasi string dari segmen asal dari URL terkait. |
...
| [Password](../../aspose.html/htmlanchorelement/password/) { get; set; } | Mendapat atau menetapkan representasi string dari segmen kata sandi dari URL terkait. |
| [Pathname](../../aspose.html/htmlanchorelement/pathname/) { get; set; } | Mendapat atau menyetel representasi string dari segmen jalur URL terkait. |
| [Port](../../aspose.html/htmlanchorelement/port/) { get; set; } | Mendapat atau menetapkan representasi string dari segmen port dari URL terkait. |
...
| [Protocol](../../aspose.html/htmlanchorelement/protocol/) { get; set; } | Mendapat atau menetapkan representasi string dari segmen skema dari URL terkait. |
| [Rel](../../aspose.html/htmlanchorelement/rel/) { get; set; } | Jenis tautan maju. Lihat definisi atribut rel di HTML 4.01. |
| [RelList](../../aspose.html/htmlanchorelement/rellist/) { get; } | Mengembalikan DOMTokenList langsung yang berisi token yang diterima dari penguraian atribut "rel". |
| [Rev](../../aspose.html/htmlanchorelement/rev/) { get; set; } | Jenis tautan terbalik. Lihat definisi atribut rev di HTML 4.01. |
| [SchemaTypeInfo](../../aspose.html.dom/element/schematypeinfo/) { get; } | Jenis informasi yang terkait dengan elemen ini. |
| [Search](../../aspose.html/htmlanchorelement/search/) { get; set; } | Mendapat atau menetapkan representasi string dari segmen pencarian URL terkait. |
...
| [Shape](../../aspose.html/htmlanchorelement/shape/) { get; set; } | Bentuk area aktif. Koordinat diberikan oleh `coord` . Lihat definisi atribut bentuk di HTML 4.01. |
...
| [TabIndex](../../aspose.html/htmlanchorelement/tabindex/) { get; set; } | Indeks yang mewakili posisi elemen dalam urutan tab. Lihat definisi atribut tabindex di HTML 4.01. |
| [TagName](../../aspose.html.dom/element/tagname/) { get; } | Nama elemen. |
| [Target](../../aspose.html/htmlanchorelement/target/) { get; set; } | Bingkai untuk merender sumber daya. Lihat definisi atribut target di HTML 4.01. |
...
| [Type](../../aspose.html/htmlanchorelement/type/) { get; set; } | Jenis konten penasehat. Lihat definisi atribut tipe di HTML 4.01. |
| [Username](../../aspose.html/htmlanchorelement/username/) { get; set; } | Mendapat atau menetapkan representasi string dari segmen nama pengguna dari URL terkait. |
...
| [Blur](../../aspose.html/htmlanchorelement/blur/)() | Menghapus fokus keyboard dari elemen ini. |
...
| [Focus](../../aspose.html/htmlanchorelement/focus/)() | Memberikan fokus keyboard ke elemen ini. |
