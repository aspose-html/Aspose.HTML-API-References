...
description: Aspose.Html.HTMLLegendElement kelas. Memberikan keterangan untuk aLAPANGAN pengelompokan. Lihat definisi elemen LEGEND di HTML 4.01.
type: docs
weight: 3360
url: /id/net/aspose.html/htmllegendelement/
---
## HTMLLegendElement class

Memberikan keterangan untuk a`LAPANGAN` pengelompokan. Lihat definisi elemen LEGEND di HTML 4.01.
...
| Nama | Keterangan |
| --- | --- |
| [AccessKey](../../aspose.html/htmllegendelement/accesskey/) { get; set; } | Kunci akses karakter tunggal untuk memberikan akses ke kontrol formulir. Lihat definisi atribut accesskey di HTML 4.01. |
| [Align](../../aspose.html/htmllegendelement/align/) { get; set; } | Perataan teks relatif terhadap`LAPANGAN` . Lihat definisi atribut align di HTML 4.01. Atribut ini tidak digunakan lagi di HTML 4.01. |
...
| [Form](../../aspose.html/htmllegendelement/form/) { get; } | Mengembalikan`MEMBENTUK` elemen yang mengandung kontrol ini. Pengembalian `batal` jika kontrol ini tidak dalam konteks formulir . |
