...
description: Aspose.Html.HTMLLabelElement kelas. Teks label bidang formulir. Lihat definisi elemen LABEL di HTML 4.01.
type: docs
weight: 3350
url: /id/net/aspose.html/htmllabelelement/
---
## HTMLLabelElement class

Teks label bidang formulir. Lihat definisi elemen LABEL di HTML 4.01.
...
| Nama | Keterangan |
| --- | --- |
| [AccessKey](../../aspose.html/htmllabelelement/accesskey/) { get; set; } | Kunci akses karakter tunggal untuk memberikan akses ke kontrol formulir. Lihat definisi atribut accesskey di HTML 4.01. |
...
| [For](../../aspose.html/htmllabelelement/for/) { get; set; } | Atribut ini menautkan label ini dengan kontrol formulir lain dengan `pengenal`atribut. Lihat definisi atribut for dalam HTML 4.01. |
| [Form](../../aspose.html/htmllabelelement/form/) { get; } | Mengembalikan`MEMBENTUK` elemen yang mengandung kontrol ini. Pengembalian `batal` jika kontrol ini tidak dalam konteks formulir . |
