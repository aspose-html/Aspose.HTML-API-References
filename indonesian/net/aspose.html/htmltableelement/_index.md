...
description: Aspose.Html.HTMLTableElement kelas. Metode create dan delete pada tabel memungkinkan penulis untuk membuat dan memodifikasi tabel. HTML4.01  menentukan bahwa hanya satu dari masingmasing KETERANGAN THEAD  DanTFOOT elemen mungkin ada dalam sebuah tabel. Oleh karena itu jika ada dan metode createTHead atau createTFoot dipanggil metode mengembalikan elemen THead atau TFoot yang ada. Lihat definisi elemen TABEL dalam HTML 4.01.
type: docs
weight: 3570
url: /id/net/aspose.html/htmltableelement/
---
## HTMLTableElement class

Metode create* dan delete* pada tabel memungkinkan penulis untuk membuat dan memodifikasi tabel. [[HTML4.01](http://www.w3.org/TR/1999/REC-html401-19991224) ] menentukan bahwa hanya satu dari masing-masing `KETERANGAN` ,`THEAD` , Dan`TFOOT` elemen mungkin ada dalam sebuah tabel. Oleh karena itu, jika ada, dan metode createTHead() atau createTFoot() dipanggil, metode mengembalikan elemen THead atau TFoot yang ada. Lihat definisi elemen TABEL dalam HTML 4.01.
...
| Nama | Keterangan |
| --- | --- |
| [Align](../../aspose.html/htmltableelement/align/) { get; set; } | Menentukan posisi tabel sehubungan dengan sisa dokumen . Lihat definisi atribut align di HTML 4.01. Atribut ini tidak digunakan lagi di HTML 4.01. |
...
| [BgColor](../../aspose.html/htmltableelement/bgcolor/) { get; set; } | Warna latar sel. Lihat definisi atribut bgcolor di HTML 4.01. Atribut ini tidak digunakan lagi dalam HTML 4.01. |
| [Border](../../aspose.html/htmltableelement/border/) { get; set; } | Lebar batas di sekeliling meja. Lihat definisi atribut border di HTML 4.01. |
| [Caption](../../aspose.html/htmltableelement/caption/) { get; } | Mengembalikan tabel`KETERANGAN` , atau batal jika tidak ada. @versi DOM Tingkat 2 |
| [CellPadding](../../aspose.html/htmltableelement/cellpadding/) { get; set; } | Menentukan ruang horizontal dan vertikal antara konten sel dan batas sel. Lihat definisi atribut cellpadding di HTML 4.01. |
| [CellSpacing](../../aspose.html/htmltableelement/cellspacing/) { get; set; } | Menentukan pemisahan horizontal dan vertikal antar sel. Lihat definisi atribut cellspacing di HTML 4.01. |
...
| [Frame](../../aspose.html/htmltableelement/frame/) { get; set; } | Menentukan batas tabel eksternal mana yang akan dirender. Lihat definisi atribut frame di HTML 4.01. |
...
| [Rows](../../aspose.html/htmltableelement/rows/) { get; } | Mengembalikan tabel`TFOOT` , atau`batal` jika tidak ada ada. |
| [Rules](../../aspose.html/htmltableelement/rules/) { get; set; } | Menentukan batas tabel internal mana yang akan dirender. Lihat definisi atribut aturan di HTML 4.01. |
...
| [Summary](../../aspose.html/htmltableelement/summary/) { get; set; } | Deskripsi tentang tujuan atau struktur dari sebuah tabel. Lihat ringkasan definisi atribut di HTML 4.01. |
| [TagName](../../aspose.html.dom/element/tagname/) { get; } | Nama elemen. |
| [TBodies](../../aspose.html/htmltableelement/tbodies/) { get; } | Mengembalikan kumpulan badan tabel (termasuk yang implisit). |
...
| [TFoot](../../aspose.html/htmltableelement/tfoot/) { get; } | Mengembalikan tabel`THEAD` , atau`batal` jika tidak ada ada. |
| [THead](../../aspose.html/htmltableelement/thead/) { get; } | Mengembalikan tabel`KETERANGAN` , atau batal jika tidak ada. |
| [Title](../../aspose.html/htmlelement/title/) { get; set; } | Judul penasehat elemen. Lihat definisi atribut judul di HTML 4.01. |
| [Width](../../aspose.html/htmltableelement/width/) { get; set; } | Menentukan lebar tabel yang diinginkan. Lihat definisi atribut lebar di HTML 4.01. |
...
| [CreateCaption](../../aspose.html/htmltableelement/createcaption/)() | Buat objek keterangan tabel baru atau kembalikan yang sudah ada. |
| [CreateTFoot](../../aspose.html/htmltableelement/createtfoot/)() | Buat baris footer tabel atau kembalikan yang sudah ada. |
| [CreateTHead](../../aspose.html/htmltableelement/createthead/)() | Buat baris tajuk tabel atau kembalikan yang sudah ada. |
| [DeleteCaption](../../aspose.html/htmltableelement/deletecaption/)() | Hapus judul tabel, jika ada. |
| [DeleteRow](../../aspose.html/htmltableelement/deleterow/)(int) | Menghapus baris tabel. |
| [DeleteTFoot](../../aspose.html/htmltableelement/deletetfoot/)() | Hapus footer dari tabel, jika ada. |
| [DeleteTHead](../../aspose.html/htmltableelement/deletethead/)() | Hapus tajuk dari tabel, jika ada. |
