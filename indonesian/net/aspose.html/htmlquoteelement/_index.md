...
description: Aspose.Html.HTMLQuoteElement kelas. UntukQ DanBLOCKQUOTEelemen. Lihat definisi elemen Q di HTML 4.01.
type: docs
weight: 3500
url: /id/net/aspose.html/htmlquoteelement/
---
## HTMLQuoteElement class

Untuk`Q` Dan`BLOCKQUOTE`elemen. Lihat definisi elemen Q di HTML 4.01.
...
| [Cite](../../aspose.html/htmlquoteelement/cite/) { get; set; } | Sebuah URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] menunjuk dokumen sumber atau pesan. Lihat definisi atribut kutipan di HTML 4.01. |
