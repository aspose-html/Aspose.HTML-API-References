...
description: Aspose.Html.HTMLBodyElement kelas. Badan dokumen HTML. Elemen ini selalu ada di DOM API bahkan jika tag tidak ada di dokumen sumber. Lihat definisi elemen BODY di HTML 4.01.
type: docs
weight: 3120
url: /id/net/aspose.html/htmlbodyelement/
---
## HTMLBodyElement class

Badan dokumen HTML. Elemen ini selalu ada di DOM API, bahkan jika tag tidak ada di dokumen sumber. Lihat definisi elemen BODY di HTML 4.01.
...
| Nama | Keterangan |
| --- | --- |
| [ALink](../../aspose.html/htmlbodyelement/alink/) { get; set; } | Warna tautan aktif (setelah tombol mouse ke bawah, tetapi sebelum tombol mouse ke atas). Lihat definisi atribut alink di HTML 4.01. Atribut ini tidak digunakan lagi di HTML 4.01. |
...
| [Background](../../aspose.html/htmlbodyelement/background/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] dari gambar ubin tekstur latar belakang. Lihat atribut background definisi dalam HTML 4.01. Atribut ini tidak digunakan lagi dalam HTML 4.01. |
...
| [BgColor](../../aspose.html/htmlbodyelement/bgcolor/) { get; set; } | Warna latar belakang dokumen. Lihat definisi atribut bgcolor di HTML 4.01. Atribut ini tidak digunakan lagi dalam HTML 4.01. |
...
| [Link](../../aspose.html/htmlbodyelement/link/) { get; set; } | Warna link yang tidak aktif dan belum dikunjungi. Lihat definisi atribut link di HTML 4.01. Atribut ini tidak digunakan lagi di HTML 4.01. |
...
| [Text](../../aspose.html/htmlbodyelement/text/) { get; set; } | Warna teks dokumen. Lihat definisi atribut teks dalam HTML 4.01. Atribut ini tidak digunakan lagi di HTML 4.01. |
...
| [VLink](../../aspose.html/htmlbodyelement/vlink/) { get; set; } | Warna link yang telah dikunjungi oleh pengguna. Lihat definisi atribut vlink di HTML 4.01. Atribut ini tidak digunakan lagi di HTML 4.01. |
