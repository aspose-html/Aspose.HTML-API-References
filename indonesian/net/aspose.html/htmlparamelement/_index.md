...
description: Aspose.Html.HTMLParamElement kelas. Parameter diumpankan keOBYEK elemen. Lihat definisi elemen PARAM di HTML 4.01.
type: docs
weight: 3480
url: /id/net/aspose.html/htmlparamelement/
---
## HTMLParamElement class

Parameter diumpankan ke`OBYEK` elemen. Lihat definisi elemen PARAM di HTML 4.01.
...
| [Name](../../aspose.html/htmlparamelement/name/) { get; set; } | Nama parameter run-time. Lihat definisi atribut nama di HTML 4.01. |
...
| [Type](../../aspose.html/htmlparamelement/type/) { get; set; } | Jenis konten untuk`nilai` atribut saat `tipe nilai` memiliki nilai "ref". Lihat definisi atribut tipe di HTML 4.01. |
| [Value](../../aspose.html/htmlparamelement/value/) { get; set; } | Nilai parameter run-time. Lihat definisi atribut nilai di HTML 4.01. |
| [ValueType](../../aspose.html/htmlparamelement/valuetype/) { get; set; } | Informasi tentang arti dari`nilai` nilai atribut . Lihat definisi atribut valuetype di HTML 4.01. |
