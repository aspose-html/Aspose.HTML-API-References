...
description: Aspose.Html.HTMLCanvasElement kelas. Antarmuka HTMLCanvasElement menyediakan properti dan metode untuk memanipulasi tata letak dan penyajian elemen kanvas. Antarmuka HTMLCanvasElement juga mewarisi properti dan metode antarmuka HTMLElement.
type: docs
weight: 3140
url: /id/net/aspose.html/htmlcanvaselement/
---
## HTMLCanvasElement class

Antarmuka HTMLCanvasElement menyediakan properti dan metode untuk memanipulasi tata letak dan penyajian elemen kanvas. Antarmuka HTMLCanvasElement juga mewarisi properti dan metode antarmuka HTMLElement.
...
| [Height](../../aspose.html/htmlcanvaselement/height/) { get; set; } | Adalah bilangan bulat positif yang mencerminkan atribut HTML tinggi dari elemen kanvas yang ditafsirkan dalam piksel CSS. Saat atribut tidak ditentukan, atau jika disetel ke nilai yang tidak valid, seperti negatif, nilai default 150 digunakan. |
...
| [Width](../../aspose.html/htmlcanvaselement/width/) { get; set; } | Adalah bilangan bulat positif yang mencerminkan atribut HTML lebar dari elemen kanvas yang ditafsirkan dalam piksel CSS. Saat atribut tidak ditentukan, atau jika disetel ke nilai yang tidak valid, seperti negatif, nilai default 300 digunakan. |
...
| [GetContext](../../aspose.html/htmlcanvaselement/getcontext/)(string) | Mengembalikan konteks gambar pada kanvas, atau null jika ID konteks tidak didukung. Konteks menggambar memungkinkan Anda menggambar di kanvas. |
...
| [ToDataURL](../../aspose.html/htmlcanvaselement/todataurl/#todataurl)() | mengembalikan URI data yang berisi representasi gambar dalam format yang ditentukan oleh parameter tipe (default pada PNG). Gambar yang dikembalikan beresolusi 96 dpi. |
| [ToDataURL](../../aspose.html/htmlcanvaselement/todataurl/#todataurl_1)(string) | mengembalikan URI data yang berisi representasi gambar dalam format yang ditentukan oleh parameter tipe (default pada PNG). Gambar yang dikembalikan beresolusi 96 dpi. |
| [ToDataURL](../../aspose.html/htmlcanvaselement/todataurl/#todataurl_2)(string, double) | mengembalikan URI data yang berisi representasi gambar dalam format yang ditentukan oleh parameter tipe (default pada PNG). Gambar yang dikembalikan beresolusi 96 dpi. |
