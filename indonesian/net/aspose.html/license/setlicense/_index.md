...
type: docs
weight: 20
url: /id/net/aspose.html/license/setlicense/
---
...
| --- | --- | --- |
| licenseName | String | Bisa berupa nama file lengkap atau pendek atau nama sumber daya tertanam. Gunakan string kosong untuk beralih ke mode evaluasi. |
...
* class [License](../)
* ruang nama [Aspose.Html](../../license/)
