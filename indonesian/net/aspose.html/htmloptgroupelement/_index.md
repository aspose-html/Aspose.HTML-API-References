...
description: Aspose.Html.HTMLOptGroupElement kelas. Opsi grup bersama dalam subdivisi logis. Lihat definisi elemen OPTGROUP dalam HTML 4.01.
type: docs
weight: 3450
url: /id/net/aspose.html/htmloptgroupelement/
---
## HTMLOptGroupElement class

Opsi grup bersama dalam subdivisi logis. Lihat definisi elemen OPTGROUP dalam HTML 4.01.
...
| [Disabled](../../aspose.html/htmloptgroupelement/disabled/) { get; set; } | Kontrol tidak tersedia dalam konteks ini. Lihat definisi atribut yang dinonaktifkan di HTML 4.01. |
...
| [Label](../../aspose.html/htmloptgroupelement/label/) { get; set; } | Menetapkan label ke grup opsi ini. Lihat atribut label definition di HTML 4.01. |
