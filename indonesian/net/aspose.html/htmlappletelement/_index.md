...
description: Aspose.Html.HTMLAppletElement kelas. Applet Java tertanam. Lihat definisi elemen APPLET di HTML 4.01. Elemen ini tidak digunakan lagi di HTML 4.01.
type: docs
weight: 3070
url: /id/net/aspose.html/htmlappletelement/
---
## HTMLAppletElement class

Applet Java tertanam. Lihat definisi elemen APPLET di HTML 4.01. Elemen ini tidak digunakan lagi di HTML 4.01.
...
| Nama | Keterangan |
| --- | --- |
| [Align](../../aspose.html/htmlappletelement/align/) { get; set; } | Meratakan objek ini (vertikal atau horizontal) sehubungan dengan teks di sekitarnya. Lihat definisi atribut align di HTML 4.01. Atribut ini tidak digunakan lagi di HTML 4.01. |
| [Alt](../../aspose.html/htmlappletelement/alt/) { get; set; } | Teks alternatif untuk agen pengguna yang tidak merender konten normal elemen ini. Lihat definisi atribut alt di HTML 4.01. Atribut ini tidak digunakan lagi di HTML 4.01. |
| [Archive](../../aspose.html/htmlappletelement/archive/) { get; set; } | Daftar arsip yang dipisahkan koma. Lihat definisi atribut arsip di HTML 4.01. Atribut ini tidak digunakan lagi dalam HTML 4.01. |
...
| [Code](../../aspose.html/htmlappletelement/code/) { get; set; } | file kelas Applet. Lihat definisi atribut kode di HTML 4.01. Atribut ini tidak digunakan lagi di HTML 4.01. |
| [CodeBase](../../aspose.html/htmlappletelement/codebase/) { get; set; } | URI basis opsional [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) untuk applet. Lihat definisi atribut basis kode di HTML 4.01. Atribut ini tidak digunakan lagi dalam HTML 4.01. |
...
| [Height](../../aspose.html/htmlappletelement/height/) { get; set; } | Kesampingkan ketinggian. Lihat definisi atribut ketinggian di HTML 4.01. Atribut ini tidak digunakan lagi di HTML 4.01. |
| [Hspace](../../aspose.html/htmlappletelement/hspace/) { get; set; } | Ruang horizontal, dalam piksel, di kiri dan kanan gambar ini, applet , atau objek. Lihat definisi atribut hspace di HTML 4.01. Atribut ini tidak digunakan lagi di HTML 4.01. @version DOM Level 2 |
...
| [Name](../../aspose.html/htmlappletelement/name/) { get; set; } | Nama applet. Lihat definisi atribut nama dalam HTML 4.01. Atribut ini tidak digunakan lagi di HTML 4.01. |
...
| [Object](../../aspose.html/htmlappletelement/object/) { get; set; } | Nilai atribut "objek". Lihat definisi atribut objek di HTML 4.01. Atribut ini tidak digunakan lagi dalam HTML 4.01. @versi DOM Tingkat 2 |
...
| [Vspace](../../aspose.html/htmlappletelement/vspace/) { get; set; } | Ruang vertikal, dalam piksel, di atas dan di bawah gambar, applet, atau objek ini. Lihat definisi atribut vspace di HTML 4.01. Atribut ini tidak digunakan lagi di HTML 4.01. @version DOM Level 2 |
| [Width](../../aspose.html/htmlappletelement/width/) { get; set; } | Ganti lebar. Lihat definisi atribut lebar dalam HTML 4.01. Atribut ini tidak digunakan lagi di HTML 4.01. |
