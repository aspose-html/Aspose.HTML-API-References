...
description: Aspose.Html.HTMLBRElement kelas. Paksa jeda baris. Lihat definisi elemen BR di HTML 4.01.
type: docs
weight: 3090
url: /id/net/aspose.html/htmlbrelement/
---
## HTMLBRElement class

Paksa jeda baris. Lihat definisi elemen BR di HTML 4.01.
...
| [Clear](../../aspose.html/htmlbrelement/clear/) { get; set; } | Kontrol aliran teks di sekitar pelampung. Lihat definisi atribut yang jelas di HTML 4.01. Atribut ini tidak digunakan lagi dalam HTML 4.01. |
