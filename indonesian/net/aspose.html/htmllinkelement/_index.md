...
description: Aspose.Html.HTMLLinkElement kelas. ItuTAUTANelemen menentukan tautan ke sumber daya eksternal dan menentukan hubungan dokumen ini dengan sumber daya tersebut atau sebaliknya. Lihat definisi elemen LINK di HTML 4.01 lihat juga LinkStyle antarmuka dalam modul StyleSheet Lembar Gaya DOM Level 2 dan CSS .
type: docs
weight: 3370
url: /id/net/aspose.html/htmllinkelement/
---
## HTMLLinkElement class

Itu`TAUTAN`elemen menentukan tautan ke sumber daya eksternal, dan menentukan hubungan dokumen ini dengan sumber daya tersebut (atau sebaliknya). Lihat definisi elemen LINK di HTML 4.01 (lihat juga `LinkStyle` antarmuka dalam modul StyleSheet [[Lembar Gaya DOM Level 2 dan CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113) ]).
...
| [Charset](../../aspose.html/htmllinkelement/charset/) { get; set; } | Pengkodean karakter dari sumber daya yang ditautkan. Lihat definisi atribut charset di HTML 4.01. |
...
| [Disabled](../../aspose.html/htmllinkelement/disabled/) { get; set; } | Mengaktifkan/menonaktifkan tautan. Ini saat ini hanya digunakan untuk tautan style sheet, dan dapat digunakan untuk mengaktifkan atau menonaktifkan style sheet. |
...
| [Href](../../aspose.html/htmllinkelement/href/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] dari sumber daya yang ditautkan. Lihat definisi atribut href di HTML 4.01. |
| [Hreflang](../../aspose.html/htmllinkelement/hreflang/) { get; set; } | Kode bahasa sumber tertaut. Lihat definisi atribut hreflang di HTML 4.01. |
...
| [Media](../../aspose.html/htmllinkelement/media/) { get; set; } | Dirancang untuk digunakan dengan satu atau lebih media target. Lihat atribut media definisi dalam HTML 4.01. |
...
| [Rel](../../aspose.html/htmllinkelement/rel/) { get; set; } | Jenis tautan maju. Lihat definisi atribut rel di HTML 4.01. |
| [RelList](../../aspose.html/htmllinkelement/rellist/) { get; } | Mengembalikan DOMTokenList langsung yang berisi token yang diterima dari penguraian atribut "rel". |
| [Rev](../../aspose.html/htmllinkelement/rev/) { get; set; } | Jenis tautan terbalik. Lihat definisi atribut rev di HTML 4.01. |
...
| [Sheet](../../aspose.html/htmllinkelement/sheet/) { get; } | Mendapat style sheet terkait. |
...
| [Target](../../aspose.html/htmllinkelement/target/) { get; set; } | Bingkai untuk merender sumber daya. Lihat definisi atribut target di HTML 4.01. |
...
| [Type](../../aspose.html/htmllinkelement/type/) { get; set; } | Jenis konten penasehat. Lihat definisi atribut tipe di HTML 4.01. |
