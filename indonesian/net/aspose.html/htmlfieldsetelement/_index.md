...
description: Aspose.Html.HTMLFieldSetElement kelas. Atur kontrol formulir ke dalam grup logis. Lihat definisi elemen FIELDSET di HTML 4.01.
type: docs
weight: 3210
url: /id/net/aspose.html/htmlfieldsetelement/
---
## HTMLFieldSetElement class

Atur kontrol formulir ke dalam grup logis. Lihat definisi elemen FIELDSET di HTML 4.01.
...
| [Form](../../aspose.html/htmlfieldsetelement/form/) { get; } | Mengembalikan`MEMBENTUK` elemen yang mengandung kontrol ini. Pengembalian `batal` jika kontrol ini tidak dalam konteks formulir . |
