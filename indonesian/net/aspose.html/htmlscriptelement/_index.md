...
description: Aspose.Html.HTMLScriptElement kelas. Pernyataan skrip. Lihat definisi elemen SCRIPT di HTML 4.01.
type: docs
weight: 3510
url: /id/net/aspose.html/htmlscriptelement/
---
## HTMLScriptElement class

Pernyataan skrip. Lihat definisi elemen SCRIPT di HTML 4.01.
...
| [Charset](../../aspose.html/htmlscriptelement/charset/) { get; set; } | Pengkodean karakter dari sumber tertaut. Lihat definisi atribut charset di HTML 4.01. |
...
| [Defer](../../aspose.html/htmlscriptelement/defer/) { get; set; } | Menunjukkan bahwa agen pengguna dapat menunda pemrosesan skrip. Lihat definisi atribut defer di HTML 4.01. |
...
| [Event](../../aspose.html/htmlscriptelement/event/) { get; set; } | Dicadangkan untuk penggunaan di masa mendatang. |
...
| [Src](../../aspose.html/htmlscriptelement/src/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] menunjuk skrip eksternal. Lihat definisi atribut src di HTML 4.01. |
...
| [Text](../../aspose.html/htmlscriptelement/text/) { get; set; } | Konten skrip elemen. |
...
| [Type](../../aspose.html/htmlscriptelement/type/) { get; set; } | Jenis konten bahasa skrip. Lihat definisi atribut tipe di HTML 4.01. |
