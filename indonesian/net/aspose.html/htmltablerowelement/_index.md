...
description: Aspose.Html.HTMLTableRowElement kelas. Sebuah baris dalam sebuah tabel. Lihat definisi elemen TR di HTML 4.01.
type: docs
weight: 3580
url: /id/net/aspose.html/htmltablerowelement/
---
## HTMLTableRowElement class

Sebuah baris dalam sebuah tabel. Lihat definisi elemen TR di HTML 4.01.
...
| Nama | Keterangan |
| --- | --- |
| [Align](../../aspose.html/htmltablerowelement/align/) { get; set; } | Perataan horizontal data di dalam sel baris ini. Lihat definisi atribut align di HTML 4.01. |
...
| [BgColor](../../aspose.html/htmltablerowelement/bgcolor/) { get; set; } | Warna latar belakang untuk baris. Lihat definisi atribut bgcolor di HTML 4.01. Atribut ini tidak digunakan lagi dalam HTML 4.01. |
| [Cells](../../aspose.html/htmltablerowelement/cells/) { get; } | Kumpulan sel di baris ini. @versi DOM Tingkat 2 |
| [Ch](../../aspose.html/htmltablerowelement/ch/) { get; set; } | Perataan karakter untuk sel dalam kolom. Lihat atribut char definisi di HTML 4.01. |
...
| [ChOff](../../aspose.html/htmltablerowelement/choff/) { get; set; } | Offset karakter perataan. Lihat definisi atribut charoff di HTML 4.01. |
...
| [RowIndex](../../aspose.html/htmltablerowelement/rowindex/) { get; } | Ini dalam urutan logis dan bukan dalam urutan dokumen. `indeksbaris` tidak memperhitungkan bagian akun ( `THEAD` ,`TFOOT` , atau`TBODY` ) dalam tabel, penempatan`THEAD` baris pertama dalam indeks, diikuti oleh`TBODY` baris, diikuti oleh`TFOOT` baris. @versi Tingkat DOM 2 |
| [SchemaTypeInfo](../../aspose.html.dom/element/schematypeinfo/) { get; } | Jenis informasi yang terkait dengan elemen ini. |
| [SectionRowIndex](../../aspose.html/htmltablerowelement/sectionrowindex/) { get; } | Indeks baris ini, relatif terhadap bagian saat ini ( `THEAD` ,`TFOOT` , atau`TBODY` ), mulai dari 0. @version DOM Level 2 |
...
| [VAlign](../../aspose.html/htmltablerowelement/valign/) { get; set; } | Perataan vertikal data dalam sel baris ini. Lihat definisi atribut yang valid di HTML 4.01. |
...
| [DeleteCell](../../aspose.html/htmltablerowelement/deletecell/)(int) | Hapus sel dari baris saat ini. |
...
| [InsertCell](../../aspose.html/htmltablerowelement/insertcell/)(int) | Masukkan kosong`TD` sel ke dalam baris ini. Jika `indeks` adalah -1 atau sama dengan jumlah sel, sel baru ditambahkan. |
