...
description: Aspose.Html.HTMLTextAreaElement kelas. Bidang teks multibaris. Lihat definisi elemen TEXTARE dalam HTML 4.01.
type: docs
weight: 3610
url: /id/net/aspose.html/htmltextareaelement/
---
## HTMLTextAreaElement class

Bidang teks multi-baris. Lihat definisi elemen TEXTARE dalam HTML 4.01.
...
| Nama | Keterangan |
| --- | --- |
| [AccessKey](../../aspose.html/htmltextareaelement/accesskey/) { get; set; } | Kunci akses karakter tunggal untuk memberikan akses ke kontrol formulir. Lihat definisi atribut accesskey di HTML 4.01. |
...
| [Cols](../../aspose.html/htmltextareaelement/cols/) { get; set; } | Lebar kontrol (dalam karakter). Lihat definisi atribut cols di HTML 4.01. |
| [DefaultValue](../../aspose.html/htmltextareaelement/defaultvalue/) { get; set; } | Mewakili isi elemen. Nilai atribut ini tidak berubah jika konten kontrol formulir terkait, di agen pengguna interaktif, berubah. @version DOM Level 2 |
...
| [Disabled](../../aspose.html/htmltextareaelement/disabled/) { get; set; } | Kontrol tidak tersedia dalam konteks ini. Lihat definisi atribut yang dinonaktifkan di HTML 4.01. |
...
| [Form](../../aspose.html/htmltextareaelement/form/) { get; } | Mengembalikan`MEMBENTUK` elemen yang mengandung kontrol ini. Pengembalian `batal` jika kontrol ini tidak dalam konteks formulir . |
...
| [Name](../../aspose.html/htmltextareaelement/name/) { get; set; } | Kontrol formulir atau nama objek saat dikirimkan dengan formulir. Lihat definisi atribut nama di HTML 4.01. |
...
| [ReadOnly](../../aspose.html/htmltextareaelement/readonly/) { get; set; } | Kontrol ini hanya bisa dibaca. Lihat definisi atribut readonly di HTML 4.01. |
| [Rows](../../aspose.html/htmltextareaelement/rows/) { get; set; } | Jumlah baris teks. Lihat definisi atribut baris dalam HTML 4.01. |
...
| [TabIndex](../../aspose.html/htmltextareaelement/tabindex/) { get; set; } | Indeks yang mewakili posisi elemen dalam urutan tab. Lihat definisi atribut tabindex di HTML 4.01. |
...
| [Type](../../aspose.html/htmltextareaelement/type/) { get; } | Jenis kontrol formulir ini. Ini string "textarea". |
| [Value](../../aspose.html/htmltextareaelement/value/) { get; set; } | Mewakili konten saat ini dari kontrol formulir yang sesuai, di agen pengguna interaktif. Mengubah atribut ini mengubah konten dari kontrol formulir, tetapi tidak mengubah konten elemen . Jika keseluruhan data tidak dapat masuk ke dalam satu `DOMString` , penerapannya dapat memotong data. |
