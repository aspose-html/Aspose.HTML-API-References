...
description: Aspose.Html.HTMLDataListElement kelas. Elemen datalist mewakili kumpulan elemen opsi yang mewakili opsi yang telah ditentukan sebelumnya untuk kontrol lain. Lihat jugaRekomendasi HTML 5.2 W3C .
type: docs
weight: 3160
url: /id/net/aspose.html/htmldatalistelement/
---
## HTMLDataListElement class

Elemen datalist mewakili kumpulan elemen opsi yang mewakili opsi yang telah ditentukan sebelumnya untuk kontrol lain. Lihat juga[Rekomendasi HTML 5.2 W3C](https://www.w3.org/TR/html52/sec-forms.html#elementdef-datalist) .
...
| [Options](../../aspose.html/htmldatalistelement/options/) { get; } | Koleksi dari`PILIHAN`elemen yang dikandung oleh elemen ini. |
