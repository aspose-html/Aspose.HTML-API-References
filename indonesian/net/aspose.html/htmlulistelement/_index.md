...
description: Aspose.Html.HTMLUListElement kelas. Daftar tidak berurutan. Lihat definisi elemen UL di HTML 4.01.
type: docs
weight: 3630
url: /id/net/aspose.html/htmlulistelement/
---
## HTMLUListElement class

Daftar tidak berurutan. Lihat definisi elemen UL di HTML 4.01.
...
| [Compact](../../aspose.html/htmlulistelement/compact/) { get; set; } | Kurangi spasi antar item daftar. Lihat definisi atribut kompak di HTML 4.01. Atribut ini tidak digunakan lagi dalam HTML 4.01. |
...
| [Type](../../aspose.html/htmlulistelement/type/) { get; set; } | Gaya peluru. Lihat definisi atribut tipe di HTML 4.01. Atribut ini tidak digunakan lagi di HTML 4.01. |
