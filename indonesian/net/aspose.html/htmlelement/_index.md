...
description: Aspose.Html.HTMLElement kelas. Semua antarmuka elemen HTML berasal dari kelas ini. Elemen yang hanya menampilkan atribut inti HTML diwakili oleh basis HTMLElementantarmuka. Elemenelemen tersebut adalah sebagai berikut khusus SUB SUP SPAN BDOfont TT I B U S STRIKE BESAR KECIL frasa EM KUAT DFN KODE SAMP KBD VAR CITE AKRONIM daftar ABBR DD DTNOFRAMES NOSCRIPTADDRESS CENTERThegaya atribut dari elemen HTML dapat diakses melalui ElementCSSInlineStyle antarmuka yang didefinisikan dalam modul CSS Lembar Gaya DOM Level 2 dan CSS .
type: docs
weight: 3200
url: /id/net/aspose.html/htmlelement/
---
## HTMLElement class

Semua antarmuka elemen HTML berasal dari kelas ini. Elemen yang hanya menampilkan atribut inti HTML diwakili oleh basis `HTMLElement`antarmuka. Elemen-elemen tersebut adalah sebagai berikut: khusus: SUB, SUP, SPAN, BDOfont: TT, I, B, U, S, STRIKE, BESAR, KECIL frasa: EM, KUAT, DFN, KODE, SAMP, KBD, VAR, CITE, AKRONIM, daftar ABBR: DD, DTNOFRAMES, NOSCRIPTADDRESS, CENTERThe`gaya` atribut dari elemen HTML dapat diakses melalui `ElementCSSInlineStyle` antarmuka yang didefinisikan dalam modul CSS [[Lembar Gaya DOM Level 2 dan CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113) ].
