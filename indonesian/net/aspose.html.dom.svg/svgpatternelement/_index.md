...
description: Aspose.Html.Dom.Svg.SVGPatternElement kelas. Antarmuka SVGPaternElement sesuai dengan elemen pola.
type: docs
weight: 2200
url: /id/net/aspose.html.dom.svg/svgpatternelement/
---
## SVGPatternElement class

Antarmuka SVGPaternElement sesuai dengan elemen 'pola'.
...
| [Height](../../aspose.html.dom.svg/svgpatternelement/height/) { get; } | Sesuai dengan atribut 'tinggi' pada elemen 'pola' yang diberikan. |
| [Href](../../aspose.html.dom.svg/svgpatternelement/href/) { get; } | Sesuai dengan atribut 'xlink:href' pada elemen yang diberikan. |
...
| [PatternContentUnits](../../aspose.html.dom.svg/svgpatternelement/patterncontentunits/) { get; } | Sesuai dengan atribut 'patternContentUnits' pada elemen 'pola' yang diberikan. Mengambil salah satu konstanta yang ditentukan dalam SVGUnitTypes. |
| [PatternTransform](../../aspose.html.dom.svg/svgpatternelement/patterntransform/) { get; } | Sesuai dengan atribut 'patternTransform' pada elemen 'pattern' yang diberikan. |
| [PatternUnits](../../aspose.html.dom.svg/svgpatternelement/patternunits/) { get; } | Sesuai dengan atribut 'patternUnits' pada elemen 'pattern' yang diberikan. Mengambil salah satu konstanta yang ditentukan dalam SVGUnitTypes. |
...
| [PreserveAspectRatio](../../aspose.html.dom.svg/svgpatternelement/preserveaspectratio/) { get; } | Sesuai dengan atribut 'preserveAspectRatio' pada elemen yang diberikan. |
...
| [RequiredExtensions](../../aspose.html.dom.svg/svgpatternelement/requiredextensions/) { get; } | Sesuai dengan atribut 'requiredExtensions' pada elemen yang diberikan. |
| [RequiredFeatures](../../aspose.html.dom.svg/svgpatternelement/requiredfeatures/) { get; } | Sesuai dengan atribut 'requiredFeatures' pada elemen yang diberikan. |
...
| [SystemLanguage](../../aspose.html.dom.svg/svgpatternelement/systemlanguage/) { get; } | Sesuai dengan atribut 'systemLanguage' pada elemen yang diberikan. |
...
| [ViewBox](../../aspose.html.dom.svg/svgpatternelement/viewbox/) { get; } | Sesuai dengan atribut 'viewBox' pada elemen yang diberikan. |
...
| [Width](../../aspose.html.dom.svg/svgpatternelement/width/) { get; } | Sesuai dengan atribut 'width' pada elemen 'pattern' yang diberikan. |
| [X](../../aspose.html.dom.svg/svgpatternelement/x/) { get; } | Sesuai dengan atribut 'x' pada elemen 'pola' yang diberikan. |
| [Y](../../aspose.html.dom.svg/svgpatternelement/y/) { get; } | Sesuai dengan atribut 'y' pada elemen 'pola' yang diberikan. |
