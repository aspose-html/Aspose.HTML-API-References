...
description: Aspose.Html.Dom.Svg.SVGViewElement kelas. Antarmuka SVGViewElement sesuai dengan elemen tampilan.
type: docs
weight: 2410
url: /id/net/aspose.html.dom.svg/svgviewelement/
---
## SVGViewElement class

Antarmuka SVGViewElement sesuai dengan elemen 'tampilan'.
...
| [PreserveAspectRatio](../../aspose.html.dom.svg/svgviewelement/preserveaspectratio/) { get; } | Sesuai dengan atribut 'preserveAspectRatio' pada elemen yang diberikan. |
...
| [ViewBox](../../aspose.html.dom.svg/svgviewelement/viewbox/) { get; } | Sesuai dengan atribut 'viewBox' pada elemen yang diberikan. |
...
| [ViewTarget](../../aspose.html.dom.svg/svgviewelement/viewtarget/) { get; } | Sesuai dengan atribut 'viewTarget' pada elemen 'view' yang diberikan. Daftar nilai DOMString yang berisi nama yang tercantum dalam atribut 'viewTarget'. Setiap nilai DOMString dapat diasosiasikan dengan elemen terkait menggunakan panggilan metode getElementById(). |
| [ZoomAndPan](../../aspose.html.dom.svg/svgviewelement/zoomandpan/) { get; set; } | Sesuai dengan atribut 'zoomAndPan' pada elemen yang diberikan. Nilai harus berupa salah satu konstanta SVG_ZOOMANDPAN_* yang ditentukan pada antarmuka ini. |
