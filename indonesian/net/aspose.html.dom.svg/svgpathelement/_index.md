...
description: Aspose.Html.Dom.Svg.SVGPathElement kelas. Antarmuka SVGPathElement sesuai dengan elemen jalur.
type: docs
weight: 2190
url: /id/net/aspose.html.dom.svg/svgpathelement/
---
## SVGPathElement class

Antarmuka SVGPathElement sesuai dengan elemen 'jalur'.
...
| [PathLength](../../aspose.html.dom.svg/svggeometryelement/pathlength/) { get; } | Sesuai dengan pathLength atribut pada elemen yang diberikan. |
| [PathSegList](../../aspose.html.dom.svg/svgpathelement/pathseglist/) { get; set; } | Menyediakan akses ke konten dasar (yaitu, statis) dari atribut 'd' dalam bentuk yang cocok satu-untuk-satu dengan sintaks SVG. Jadi, jika atribut 'd' memiliki perintah "absolute moveto (M)" dan "absolute arcto (A)", maka pathSegList akan memiliki dua entri: SVG_PATHSEG_MOVETO_ABS dan SVG_PATHSEG_ARC_ABS. |
...
| [CreateSVGPathSegArcAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegarcabs/)(float, float, float, float, float, bool, bool) | Mengembalikan objek SVGPathSegArcAbs yang berdiri sendiri dan tanpa orang tua. |
| [CreateSVGPathSegArcRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegarcrel/)(float, float, float, float, float, bool, bool) | Mengembalikan objek SVGPathSegArcRel yang berdiri sendiri dan tanpa orang tua. |
| [CreateSVGPathSegClosePath](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegclosepath/)() | Mengembalikan objek SVGPathSegClosePath yang berdiri sendiri dan tanpa orang tua. |
| [CreateSVGPathSegCurvetoCubicAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicabs/)(float, float, float, float, float, float) | Mengembalikan objek SVGPathSegCurvetoCubicAbs yang berdiri sendiri dan tanpa orang tua. |
| [CreateSVGPathSegCurvetoCubicRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicrel/)(float, float, float, float, float, float) | Mengembalikan objek SVGPathSegCurvetoCubicRel yang berdiri sendiri dan tanpa orang tua. |
| [CreateSVGPathSegCurvetoCubicSmoothAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothabs/)(float, float, float, float) | Mengembalikan objek SVGPathSegCurvetoCubicSmoothAbs yang berdiri sendiri dan tanpa orang tua. |
| [CreateSVGPathSegCurvetoCubicSmoothRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothrel/)(float, float, float, float) | Mengembalikan objek SVGPathSegCurvetoCubicSmoothRel yang berdiri sendiri dan tanpa orang tua. |
| [CreateSVGPathSegCurvetoQuadraticAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticabs/)(float, float, float, float) | Mengembalikan objek SVGPathSegCurvetoQuadraticAbs yang berdiri sendiri dan tanpa orang tua. |
| [CreateSVGPathSegCurvetoQuadraticRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticrel/)(float, float, float, float) | Mengembalikan objek SVGPathSegCurvetoQuadraticRel yang berdiri sendiri dan tanpa orang tua. |
| [CreateSVGPathSegCurvetoQuadraticSmoothAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothabs/)(float, float) | Mengembalikan objek SVGPathSegCurvetoQuadraticSmoothAbs yang berdiri sendiri dan tanpa orang tua. |
| [CreateSVGPathSegCurvetoQuadraticSmoothRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothrel/)(float, float) | Mengembalikan objek SVGPathSegCurvetoQuadraticSmoothRel yang berdiri sendiri dan tanpa orang tua. |
| [CreateSVGPathSegLinetoAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoabs/)(float, float) | Mengembalikan objek SVGPathSegLinetoAbs yang berdiri sendiri dan tanpa orang tua. |
| [CreateSVGPathSegLinetoHorizontalAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetohorizontalabs/)(float) | Mengembalikan objek SVGPathSegLinetoHorizontalAbs yang berdiri sendiri dan tanpa orang tua. |
| [CreateSVGPathSegLinetoHorizontalRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetohorizontalrel/)(float) | Mengembalikan objek SVGPathSegLinetoHorizontalRel yang berdiri sendiri dan tanpa orang tua. |
| [CreateSVGPathSegLinetoRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetorel/)(float, float) | Mengembalikan objek SVGPathSegLinetoRel yang berdiri sendiri dan tanpa orang tua. |
| [CreateSVGPathSegLinetoVerticalAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoverticalabs/)(float) | Mengembalikan objek SVGPathSegLinetoVerticalAbs yang berdiri sendiri dan tanpa orang tua. |
| [CreateSVGPathSegLinetoVerticalRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoverticalrel/)(float) | Mengembalikan objek SVGPathSegLinetoVerticalRel yang berdiri sendiri dan tanpa orang tua. |
| [CreateSVGPathSegMovetoAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegmovetoabs/)(float, float) | Mengembalikan objek SVGPathSegMovetoAbs yang berdiri sendiri dan tanpa orang tua. |
| [CreateSVGPathSegMovetoRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegmovetorel/)(float, float) | Mengembalikan objek SVGPathSegMovetoRel yang berdiri sendiri dan tanpa orang tua. |
...
| [GetEquivalentPath](../../aspose.html.dom.svg/svggeometryelement/getequivalentpath/)() | Mengembalikan instance instance baru dari[`SVGPathSegList`](../../aspose.html.dom.svg.paths/svgpathseglist/) yang mewakili[`SVGGeometryElement`](../svggeometryelement/) sebagai segmen jalur. |
...
| [GetPointAtLength](../../aspose.html.dom.svg/svggeometryelement/getpointatlength/)(float) | Mengembalikan koordinat (x,y) di ruang pengguna yang merupakan satuan jarak di sepanjang jalur, memanfaatkan algoritme jarak sepanjang jalur agen pengguna. |
...
| [GetTotalLength](../../aspose.html.dom.svg/svggeometryelement/gettotallength/)() | Mengembalikan nilai terhitung agen pengguna untuk panjang total jalur menggunakan algoritme jarak sepanjang jalur agen pengguna, sebagai jarak dalam sistem koordinat pengguna saat ini. |
