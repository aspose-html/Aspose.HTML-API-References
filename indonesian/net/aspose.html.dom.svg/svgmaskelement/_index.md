...
description: Aspose.Html.Dom.Svg.SVGMaskElement kelas. Antarmuka SVGMaskElement sesuai dengan elemen topeng.
type: docs
weight: 2170
url: /id/net/aspose.html.dom.svg/svgmaskelement/
---
## SVGMaskElement class

Antarmuka SVGMaskElement sesuai dengan elemen 'topeng'.
...
| [Height](../../aspose.html.dom.svg/svgmaskelement/height/) { get; } | Sesuai dengan atribut 'height' pada elemen 'mask' yang diberikan. Mengambil salah satu konstanta yang ditentukan dalam SVGUnitTypes. |
...
| [MaskContentUnits](../../aspose.html.dom.svg/svgmaskelement/maskcontentunits/) { get; } | Sesuai dengan atribut 'maskContentUnits' pada elemen 'mask' yang diberikan. Mengambil salah satu konstanta yang ditentukan dalam SVGUnitTypes. |
| [MaskUnits](../../aspose.html.dom.svg/svgmaskelement/maskunits/) { get; } | Sesuai dengan atribut 'maskUnits' pada elemen 'mask' yang diberikan. Mengambil salah satu konstanta yang ditentukan dalam SVGUnitTypes. |
...
| [RequiredExtensions](../../aspose.html.dom.svg/svgmaskelement/requiredextensions/) { get; } | Sesuai dengan atribut 'requiredExtensions' pada elemen yang diberikan. |
| [RequiredFeatures](../../aspose.html.dom.svg/svgmaskelement/requiredfeatures/) { get; } | Sesuai dengan atribut 'requiredFeatures' pada elemen yang diberikan. |
...
| [SystemLanguage](../../aspose.html.dom.svg/svgmaskelement/systemlanguage/) { get; } | Sesuai dengan atribut 'systemLanguage' pada elemen yang diberikan. |
...
| [Width](../../aspose.html.dom.svg/svgmaskelement/width/) { get; } | Sesuai dengan atribut 'width' pada elemen 'mask' yang diberikan. Mengambil salah satu konstanta yang ditentukan dalam SVGUnitTypes. |
| [X](../../aspose.html.dom.svg/svgmaskelement/x/) { get; } | Sesuai dengan atribut 'x' pada elemen 'mask' yang diberikan. Mengambil salah satu konstanta yang ditentukan dalam SVGUnitTypes. |
| [Y](../../aspose.html.dom.svg/svgmaskelement/y/) { get; } | Sesuai dengan atribut 'y' pada elemen 'mask' yang diberikan. Mengambil salah satu konstanta yang ditentukan dalam SVGUnitTypes. |
