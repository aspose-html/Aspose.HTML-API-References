...
description: Aspose.Html.Dom.Svg.SVGMarkerElement kelas. Antarmuka SVGMarkerElement sesuai dengan elemen penanda.
type: docs
weight: 2160
url: /id/net/aspose.html.dom.svg/svgmarkerelement/
---
## SVGMarkerElement class

Antarmuka SVGMarkerElement sesuai dengan elemen 'penanda'.
...
| [MarkerHeight](../../aspose.html.dom.svg/svgmarkerelement/markerheight/) { get; } | Sesuai dengan atribut 'markerHeight' pada elemen 'marker' yang diberikan. |
| [MarkerUnits](../../aspose.html.dom.svg/svgmarkerelement/markerunits/) { get; } | Sesuai dengan atribut 'markerUnits' pada elemen 'marker' yang diberikan. Salah satu Jenis Unit Penanda yang ditentukan pada antarmuka ini. |
| [MarkerWidth](../../aspose.html.dom.svg/svgmarkerelement/markerwidth/) { get; } | Sesuai dengan atribut 'markerWidth' pada elemen 'marker' yang diberikan. |
...
| [OrientAngle](../../aspose.html.dom.svg/svgmarkerelement/orientangle/) { get; } | Sesuai dengan atribut 'orient' pada elemen 'marker' yang diberikan. Jika markerUnits adalah SVG_MARKER_ORIENT_ANGLE, nilai sudut untuk atribut 'orient'; jika tidak, akan disetel ke nol. |
| [OrientType](../../aspose.html.dom.svg/svgmarkerelement/orienttype/) { get; } | Sesuai dengan atribut 'orient' pada elemen 'marker' yang diberikan. Salah satu Jenis Orientasi Penanda yang ditentukan pada antarmuka ini. |
...
| [PreserveAspectRatio](../../aspose.html.dom.svg/svgmarkerelement/preserveaspectratio/) { get; } | Sesuai dengan atribut 'preserveAspectRatio' pada elemen yang diberikan. |
...
| [RefX](../../aspose.html.dom.svg/svgmarkerelement/refx/) { get; } | Sesuai dengan atribut 'refX' pada elemen 'penanda' yang diberikan. |
| [RefY](../../aspose.html.dom.svg/svgmarkerelement/refy/) { get; } | Sesuai dengan atribut 'refY' pada elemen 'marker' yang diberikan. |
...
| [ViewBox](../../aspose.html.dom.svg/svgmarkerelement/viewbox/) { get; } | Sesuai dengan atribut 'viewBox' pada elemen yang diberikan. |
...
| [SetOrientToAngle](../../aspose.html.dom.svg/svgmarkerelement/setorienttoangle/)(SVGAngle) | Menetapkan nilai atribut 'orient' ke sudut yang diberikan. |
| [SetOrientToAuto](../../aspose.html.dom.svg/svgmarkerelement/setorienttoauto/)() | Menetapkan nilai atribut 'orient' ke 'auto'. |
...
| Nama | Keterangan |
| --- | --- |
| const [SVG_MARKERUNITS_STROKEWIDTH](../../aspose.html.dom.svg/svgmarkerelement/svg_markerunits_strokewidth/) | Nilai atribut 'markerUnits' adalah 'strokeWidth'. |
| const [SVG_MARKERUNITS_UNKNOWN](../../aspose.html.dom.svg/svgmarkerelement/svg_markerunits_unknown/) | Jenis unit penanda bukan salah satu dari jenis yang telah ditentukan sebelumnya. Tidak valid mencoba menentukan nilai baru dari jenis ini atau mencoba mengalihkan nilai yang ada ke jenis ini. |
| const [SVG_MARKERUNITS_USERSPACEONUSE](../../aspose.html.dom.svg/svgmarkerelement/svg_markerunits_userspaceonuse/) | Nilai atribut 'markerUnits' adalah 'userSpaceOnUse'. |
| const [SVG_MARKER_ORIENT_ANGLE](../../aspose.html.dom.svg/svgmarkerelement/svg_marker_orient_angle/) | Atribut 'orient' memiliki nilai sudut. |
| const [SVG_MARKER_ORIENT_AUTO](../../aspose.html.dom.svg/svgmarkerelement/svg_marker_orient_auto/) | Atribut 'orient' memiliki nilai 'auto'. |
| const [SVG_MARKER_ORIENT_UNKNOWN](../../aspose.html.dom.svg/svgmarkerelement/svg_marker_orient_unknown/) | Orientasi marker bukan salah satu dari tipe yang telah ditentukan sebelumnya. Tidak valid mencoba menentukan nilai baru dari jenis ini atau mencoba mengalihkan nilai yang ada ke jenis ini. |
