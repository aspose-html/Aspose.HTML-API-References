...
description: Aspose.Html.Dom.Svg.SVGComponentTransferFunctionElement kelas. Antarmuka ini mendefinisikan antarmuka dasar yang digunakan oleh antarmuka fungsi transfer komponen.
type: docs
weight: 1970
url: /id/net/aspose.html.dom.svg/svgcomponenttransferfunctionelement/
---
...
| Nama | Keterangan |
| --- | --- |
| [Amplitude](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/amplitude/) { get; } | Sesuai dengan atribut 'amplitudo' pada elemen yang diberikan. |
...
| [Exponent](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/exponent/) { get; } | Sesuai dengan atribut 'eksponen' pada elemen yang diberikan. |
...
| [Intercept](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/intercept/) { get; } | Sesuai dengan atribut 'intercept' pada elemen yang diberikan. |
...
| [Offset](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/offset/) { get; } | Sesuai dengan atribut 'offset' pada elemen yang diberikan. |
...
| [Slope](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/slope/) { get; } | Sesuai dengan atribut 'kemiringan' pada elemen yang diberikan. |
...
| [TableValues](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/tablevalues/) { get; } | Sesuai dengan atribut 'tableValues' pada elemen yang diberikan. |
...
| [Type](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/type/) { get; } | Sesuai dengan atribut 'ketik' pada elemen yang diberikan. Mengambil salah satu konstanta SVG_FECOMPONENTTRANSFER_TYPE_* yang ditentukan pada antarmuka ini. |
...
| Nama | Keterangan |
| --- | --- |
| const [SVG_FECOMPONENTTRANSFER_TYPE_DISCRETE](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_discrete/) | Sesuai dengan nilai 'diskrit'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_GAMMA](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_gamma/) | Sesuai dengan nilai 'gamma'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_IDENTITY](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_identity/) | Sesuai dengan nilai 'identitas'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_LINEAR](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_linear/) | Sesuai dengan nilai 'linear'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_TABLE](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_table/) | Sesuai dengan nilai 'tabel'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_UNKNOWN](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_unknown/) | Jenisnya bukan salah satu dari jenis yang telah ditentukan sebelumnya. Tidak valid mencoba menentukan nilai baru dari jenis ini atau mencoba mengalihkan nilai yang ada ke jenis ini. |
