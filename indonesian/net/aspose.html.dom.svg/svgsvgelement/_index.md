...
description: Aspose.Html.Dom.Svg.SVGSVGElement kelas. Definisi antarmuka utama adalah antarmuka SVGSVGElement yang merupakan antarmuka yang sesuai dengan elemen svg. Antarmuka ini berisi berbagai macam metode utilitas yang biasa digunakan seperti operasi matriks dan kemampuan untuk mengontrol waktu menggambar ulang pada perangkat rendering visual.
type: docs
weight: 2260
url: /id/net/aspose.html.dom.svg/svgsvgelement/
---
## SVGSVGElement class

Definisi antarmuka utama adalah antarmuka SVGSVGElement, yang merupakan antarmuka yang sesuai dengan elemen 'svg'. Antarmuka ini berisi berbagai macam metode utilitas yang biasa digunakan, seperti operasi matriks dan kemampuan untuk mengontrol waktu menggambar ulang pada perangkat rendering visual.
...
| [CurrentScale](../../aspose.html.dom.svg/svgsvgelement/currentscale/) { get; set; } | Pada elemen svg terluar, atribut ini menunjukkan faktor skala saat ini relatif terhadap tampilan awal untuk mempertimbangkan pembesaran pengguna dan operasi panning, seperti yang dijelaskan di bawah Pembesaran dan panning. Atribut DOM currentScale dan currentTranslate setara dengan matriks 2x3 [abcdef] = [currentScale 0 0 currentScale currentTranslate.x currentTranslate.y]. Jika "pembesaran" diaktifkan (yaitu, zoomAndPan="memperbesar"), maka efeknya adalah seolah-olah transformasi ekstra ditempatkan pada tingkat terluar pada fragmen dokumen SVG (yaitu, di luar elemen svg terluar). Saat diakses di elemen 'svg' yang bukan elemen svg terluar, tidak ditentukan perilaku apa yang dimiliki atribut ini. |
| [CurrentTranslate](../../aspose.html.dom.svg/svgsvgelement/currenttranslate/) { get; } | Pada elemen svg terluar, faktor terjemahan terkait yang memperhitungkan "pembesaran" pengguna. Ketika diakses pada elemen 'svg' yang bukan elemen svg terluar, tidak ditentukan perilaku apa yang dimiliki atribut ini. |
...
| [Height](../../aspose.html.dom.svg/svgsvgelement/height/) { get; } | Sesuai dengan atribut 'tinggi' pada elemen 'svg' yang diberikan. |
...
| [PreserveAspectRatio](../../aspose.html.dom.svg/svgsvgelement/preserveaspectratio/) { get; } | Sesuai dengan atribut 'preserveAspectRatio' pada elemen yang diberikan. |
...
| [ViewBox](../../aspose.html.dom.svg/svgsvgelement/viewbox/) { get; } | Sesuai dengan atribut 'viewBox' pada elemen yang diberikan. |
...
| [Width](../../aspose.html.dom.svg/svgsvgelement/width/) { get; } | Sesuai dengan atribut 'width' pada elemen 'svg' yang diberikan. |
| [X](../../aspose.html.dom.svg/svgsvgelement/x/) { get; } | Sesuai dengan atribut 'x' pada elemen 'svg' yang diberikan. |
| [Y](../../aspose.html.dom.svg/svgsvgelement/y/) { get; } | Sesuai dengan atribut 'y' pada elemen 'svg' yang diberikan. |
| [ZoomAndPan](../../aspose.html.dom.svg/svgsvgelement/zoomandpan/) { get; set; } | Sesuai dengan atribut 'zoomAndPan' pada elemen yang diberikan. Nilai harus berupa salah satu konstanta SVG_ZOOMANDPAN_* yang ditentukan pada antarmuka ini. |
...
| [AnimationsPaused](../../aspose.html.dom.svg/svgsvgelement/animationspaused/)() | Mengembalikan nilai true jika fragmen dokumen SVG ini dalam keadaan dijeda. |
...
| [CreateEvent](../../aspose.html.dom.svg/svgsvgelement/createevent/)(string) | Membuat sebuah[`Event`](../../aspose.html.dom.events/event/) dari jenis yang didukung oleh implementasi. |
| [CreateSVGAngle](../../aspose.html.dom.svg/svgsvgelement/createsvgangle/)() | Membuat objek SVGAngle di luar pohon dokumen apa pun. Objek diinisialisasi ke nilai 0 derajat (tanpa unit). |
| [CreateSVGLength](../../aspose.html.dom.svg/svgsvgelement/createsvglength/)() | Membuat objek SVGLength di luar pohon dokumen apa pun. Objek diinisialisasi ke nilai 0 unit pengguna. |
| [CreateSVGMatrix](../../aspose.html.dom.svg/svgsvgelement/createsvgmatrix/)() | Membuat objek SVGMatrix di luar pohon dokumen apa pun. Objek diinisialisasi ke matriks identitas. |
| [CreateSVGNumber](../../aspose.html.dom.svg/svgsvgelement/createsvgnumber/)() | Membuat objek SVGNumber di luar pohon dokumen apa pun. Objek diinisialisasi ke nilai nol. |
| [CreateSVGPoint](../../aspose.html.dom.svg/svgsvgelement/createsvgpoint/)() | Membuat objek SVGPoint di luar pohon dokumen apa pun. Objek diinisialisasi ke titik (0,0) di sistem koordinat pengguna. |
| [CreateSVGRect](../../aspose.html.dom.svg/svgsvgelement/createsvgrect/)() | Membuat objek SVGRect di luar pohon dokumen apa pun. Objek diinisialisasi sedemikian rupa sehingga semua nilai disetel ke 0 unit pengguna. |
| [CreateSVGTransform](../../aspose.html.dom.svg/svgsvgelement/createsvgtransform/)() | Membuat objek SVGTransform di luar pohon dokumen apa pun. Objek diinisialisasi ke transformasi matriks identitas (SVG_TRANSFORM_MATRIX). |
| [CreateSVGTransformFromMatrix](../../aspose.html.dom.svg/svgsvgelement/createsvgtransformfrommatrix/)(SVGMatrix) | Membuat objek SVGTransform di luar pohon dokumen apa pun. Objek diinisialisasi ke transformasi matriks yang diberikan (yaitu, SVG_TRANSFORM_MATRIX). Nilai dari matriks parameter disalin, parameter matriks tidak diadopsi sebagai SVGTransform::matrix. |
...
| [GetCurrentTime](../../aspose.html.dom.svg/svgsvgelement/getcurrenttime/)() | Mengembalikan waktu saat ini dalam detik relatif terhadap waktu mulai fragmen dokumen SVG saat ini. Jika getCurrentTime dipanggil sebelum garis waktu dokumen dimulai (misalnya, dengan skrip berjalan di elemen 'skrip' sebelum acara SVGLoad dokumen dikirim), maka 0 dikembalikan. |
| [GetElementById](../../aspose.html.dom.svg/svgsvgelement/getelementbyid/)(string) | Mencari fragmen dokumen SVG ini (yakni, pencarian dibatasi pada subset pohon dokumen) untuk Elemen yang id-nya diberikan oleh elementId. Jika Elemen ditemukan, Elemen tersebut dikembalikan. Jika tidak ada elemen seperti itu, kembalikan nol. Perilaku tidak ditentukan jika lebih dari satu elemen memiliki id ini. |
...
| [PauseAnimations](../../aspose.html.dom.svg/svgsvgelement/pauseanimations/)() | Menangguhkan (yaitu, menjeda) semua animasi yang sedang berjalan yang ditentukan dalam fragmen dokumen SVG yang terkait dengan elemen 'svg' ini, menyebabkan jam animasi yang terkait dengan fragmen dokumen ini tidak bergerak hingga tidak dihentikan sementara. |
...
| [SetCurrentTime](../../aspose.html.dom.svg/svgsvgelement/setcurrenttime/)(float) | Menyesuaikan jam untuk fragmen dokumen SVG ini, menetapkan waktu saat ini yang baru. Jika setCurrentTime dipanggil sebelum garis waktu dokumen dimulai (misalnya, dengan skrip yang berjalan di elemen 'skrip' sebelum acara SVGLoad dokumen dikirim), maka nilai detik dalam pemanggilan terakhir metode memberikan waktu dokumen akan mencari setelah garis waktu dokumen dimulai. |
...
| [UnpauseAnimations](../../aspose.html.dom.svg/svgsvgelement/unpauseanimations/)() | Membatalkan penangguhan (yaitu, membatalkan jeda) animasi yang sedang berjalan yang ditentukan dalam fragmen dokumen SVG, menyebabkan jam animasi berlanjut dari waktu penangguhannya. |
