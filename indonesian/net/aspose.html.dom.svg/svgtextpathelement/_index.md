...
description: Aspose.Html.Dom.Svg.SVGTextPathElement kelas. Antarmuka SVGTextPathElement sesuai dengan elemen textPath.
type: docs
weight: 2360
url: /id/net/aspose.html.dom.svg/svgtextpathelement/
---
...
| [Href](../../aspose.html.dom.svg/svgtextpathelement/href/) { get; } | Sesuai dengan atribut 'xlink:href' pada elemen yang diberikan. |
...
| [LengthAdjust](../../aspose.html.dom.svg/svgtextcontentelement/lengthadjust/) { get; } | Sesuai dengan atribut 'lengthAdjust' pada elemen yang diberikan. Nilai harus berupa salah satu konstanta penyetelan panjang yang ditentukan pada antarmuka ini. |
...
| [Method](../../aspose.html.dom.svg/svgtextpathelement/method/) { get; } | Sesuai dengan atribut 'method' pada elemen 'textPath' yang diberikan. |
...
| [Spacing](../../aspose.html.dom.svg/svgtextpathelement/spacing/) { get; } | Sesuai dengan atribut 'spasi' pada elemen 'textPath' yang diberikan. |
| [StartOffset](../../aspose.html.dom.svg/svgtextpathelement/startoffset/) { get; } | Sesuai dengan atribut 'startOffset' pada elemen 'textPath' yang diberikan. |
...
| [TextLength](../../aspose.html.dom.svg/svgtextcontentelement/textlength/) { get; } | Sesuai dengan atribut 'textLength' pada elemen yang diberikan. |
...
| [GetComputedTextLength](../../aspose.html.dom.svg/svgtextcontentelement/getcomputedtextlength/)() | Jumlah total semua nilai lanjutan dari merender semua karakter dalam elemen ini, termasuk nilai lanjutan pada mesin terbang (horizontal atau vertikal), efek properti 'kerning', 'huruf-spasi' dan 'word- spasi' dan penyesuaian karena atribut 'dx' dan 'dy' pada elemen 'tspan'. Untuk lingkungan non-rendering, agen pengguna harus membuat asumsi yang masuk akal tentang metrik mesin terbang. |
...
| [GetNumberOfChars](../../aspose.html.dom.svg/svgtextcontentelement/getnumberofchars/)() | Mengembalikan jumlah total karakter yang tersedia untuk rendering dalam elemen saat ini, yang menyertakan karakter referensi dari referensi 'tref', terlepas dari apakah mereka akan dirender. Secara efektif, ini setara dengan panjang atribut Node::textContent dari DOM Level 3 Core ([DOM3], bagian 1.4), jika atribut tersebut juga memperluas elemen 'tref'. |
...
| Nama | Keterangan |
| --- | --- |
| const [TEXTPATH_METHODTYPE_ALIGN](../../aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_align/) | Sesuai dengan nilai 'sejajarkan'. |
| const [TEXTPATH_METHODTYPE_STRETCH](../../aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_stretch/) | Sesuai dengan nilai 'stretch'. |
| const [TEXTPATH_METHODTYPE_UNKNOWN](../../aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_unknown/) | Pencacahan disetel ke nilai yang bukan salah satu dari tipe yang telah ditentukan sebelumnya. Tidak valid mencoba menentukan nilai baru dari jenis ini atau mencoba mengalihkan nilai yang ada ke jenis ini. |
| const [TEXTPATH_SPACINGTYPE_AUTO](../../aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_auto/) | Sesuai dengan nilai 'otomatis'. |
| const [TEXTPATH_SPACINGTYPE_EXACT](../../aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_exact/) | Sesuai dengan nilai 'tepat'. |
| const [TEXTPATH_SPACINGTYPE_UNKNOWN](../../aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_unknown/) | Pencacahan disetel ke nilai yang bukan salah satu dari tipe yang telah ditentukan sebelumnya. Tidak valid mencoba menentukan nilai baru dari jenis ini atau mencoba mengalihkan nilai yang ada ke jenis ini. |
