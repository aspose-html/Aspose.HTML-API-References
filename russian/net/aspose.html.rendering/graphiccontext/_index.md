...
description: Aspose.Html.Rendering.GraphicContext сорт. Содержит текущие параметры управления графикой. Эти параметры определяют глобальную структуру в которой выполняются графические операторы.
type: docs
weight: 4260
url: /ru/net/aspose.html.rendering/graphiccontext/
---
...
| virtual [TextInfo](../../aspose.html.rendering/graphiccontext/textinfo/) { get; } | Получает[`TextInfo`](../textinfo/) объект, который содержит информацию о отображаемом тексте. |
...
| Имя | Описание |
| --- | --- |
| virtual [Clone](../../aspose.html.rendering/graphiccontext/clone/)() | Создает новый экземпляр класса GraphicContext с теми же значениями свойств, что и существующий экземпляр. |
