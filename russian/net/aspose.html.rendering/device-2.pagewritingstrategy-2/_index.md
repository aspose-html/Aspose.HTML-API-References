...
description: Aspose.Html.Rendering.Device2PageWritingStrategyTGraphicContextTRenderingOptions перечисление. Определяет типы стратегий записи страниц в выходной потокпотоки.
type: docs
weight: 4160
url: /ru/net/aspose.html.rendering/device-2.pagewritingstrategy-2/
---
