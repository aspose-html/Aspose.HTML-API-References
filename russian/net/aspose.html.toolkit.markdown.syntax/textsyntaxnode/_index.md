...
description: Aspose.Html.Toolkit.Markdown.Syntax.TextSyntaxNode сорт. Реализован узел текстового синтаксиса.
type: docs
weight: 5670
url: /ru/net/aspose.html.toolkit.markdown.syntax/textsyntaxnode/
---
## TextSyntaxNode class

Реализован узел текстового синтаксиса.
...
| Имя | Описание |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/textsyntaxnode/accept/)(MarkdownSyntaxVisitor) | Определяет интерфейс для приема посетителей. |
