...
description: Aspose.Html.Toolkit.Markdown.Syntax.MarkdownSyntaxNode сорт. Базовая реализация MarkdownSyntaxNode.
type: docs
weight: 5190
url: /ru/net/aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/
---
...
| Имя | Описание |
| --- | --- |
| virtual [Accept](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/accept/)(MarkdownSyntaxVisitor) | Принять посетителя. |
...
| virtual [WriteTo](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/writeto/#writeto)(MarkdownTextWriter) | Запись в MarkdownTextWriter. |
| [WriteTo](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/writeto/#writeto_1)(TextWriter) | Запись узлов в модуль записи текста. |
