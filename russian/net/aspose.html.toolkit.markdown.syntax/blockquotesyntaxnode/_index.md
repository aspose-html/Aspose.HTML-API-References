...
description: Aspose.Html.Toolkit.Markdown.Syntax.BlockQuoteSyntaxNode сорт. Представляет узел синтаксиса BlockQuoteSyntaxNode.
type: docs
weight: 4810
url: /ru/net/aspose.html.toolkit.markdown.syntax/blockquotesyntaxnode/
---
## BlockQuoteSyntaxNode class

Представляет узел синтаксиса BlockQuoteSyntaxNode.
...
| Имя | Описание |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/blockquotesyntaxnode/accept/)(MarkdownSyntaxVisitor) | Определяет интерфейс для приема посетителей. |
