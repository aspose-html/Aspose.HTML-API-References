...
description: Aspose.Html.Toolkit.Markdown.Syntax.ReferenceLinkSyntaxNode сорт. Представляет синтаксис ссылки ссылки.
type: docs
weight: 5520
url: /ru/net/aspose.html.toolkit.markdown.syntax/referencelinksyntaxnode/
---
## ReferenceLinkSyntaxNode class

Представляет синтаксис ссылки ссылки.
...
| Имя | Описание |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/referencelinksyntaxnode/accept/)(MarkdownSyntaxVisitor) | Определяет интерфейс для приема посетителя. |
...
| [GetContent](../../aspose.html.toolkit.markdown.syntax/referencelinksyntaxnode/getcontent/)() | Определяет интерфейс для получения содержимого. |
| [GetLabel](../../aspose.html.toolkit.markdown.syntax/referencelinksyntaxnode/getlabel/)() | Определяет интерфейс для получения метки. |
