...
description: Aspose.Html.Toolkit.Markdown.Syntax.LineBreakSyntaxNode сорт. Представляет LineBreakSyntaxNode.
type: docs
weight: 5100
url: /ru/net/aspose.html.toolkit.markdown.syntax/linebreaksyntaxnode/
---
...
| Имя | Описание |
| --- | --- |
| abstract [Accept](../../aspose.html.toolkit.markdown.syntax/inlinesyntaxnode/accept/)(MarkdownSyntaxVisitor) | Определяет интерфейс для приема посетителей. |
