...
description: Aspose.Html.Toolkit.Markdown.Syntax.TableRowSyntaxNode сорт. Узел синтаксиса строки таблицы.
type: docs
weight: 5580
url: /ru/net/aspose.html.toolkit.markdown.syntax/tablerowsyntaxnode/
---
...
| [AppendCell](../../aspose.html.toolkit.markdown.syntax/tablerowsyntaxnode/appendcell/)(TableCellSyntaxNode) | Определяет интерфейс для добавления ячейки. |
| [AppendChild](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/appendchild/)(MarkdownSyntaxNode) | Добавить дочерний узел. |
| [AppendDelimiter](../../aspose.html.toolkit.markdown.syntax/tablerowsyntaxnode/appenddelimiter/)(TableDelimiterSyntaxNode) | Определяет интерфейс для разделителя добавления. |
| [ChildNodes](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/childnodes/)() | Получить коллекцию дочерних узлов. |
| [GetCells](../../aspose.html.toolkit.markdown.syntax/tablerowsyntaxnode/getcells/)() | Определяет интерфейс для получения ячеек. |
