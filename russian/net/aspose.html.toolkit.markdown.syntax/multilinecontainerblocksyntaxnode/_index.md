...
description: Aspose.Html.Toolkit.Markdown.Syntax.MultiLineContainerBlockSyntaxNode сорт. Базовая реализация синтаксиса многострочного контейнерного блока Node
type: docs
weight: 5250
url: /ru/net/aspose.html.toolkit.markdown.syntax/multilinecontainerblocksyntaxnode/
---
## MultiLineContainerBlockSyntaxNode class

Базовая реализация синтаксиса многострочного контейнерного блока Node
