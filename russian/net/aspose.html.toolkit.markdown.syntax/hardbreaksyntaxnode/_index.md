...
description: Aspose.Html.Toolkit.Markdown.Syntax.HardBreakSyntaxNode сорт. Представляет HardBreakSyntaxNode.
type: docs
weight: 5010
url: /ru/net/aspose.html.toolkit.markdown.syntax/hardbreaksyntaxnode/
---
...
| virtual [Source](../../aspose.html.toolkit.markdown.syntax/linebreaksyntaxnode/source/) { get; } | Получить исходник. |
| virtual [Span](../../aspose.html.toolkit.markdown.syntax/linebreaksyntaxnode/span/) { get; } | Получить диапазон. |
| [Value](../../aspose.html.toolkit.markdown.syntax/linebreaksyntaxnode/value/) { get; } | Получить значение. |

## Методы

| Имя | Описание |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/hardbreaksyntaxnode/accept/)(MarkdownSyntaxVisitor) | Определяет интерфейс для приема посетителей. |
...
| [GetBreakingTag](../../aspose.html.toolkit.markdown.syntax/hardbreaksyntaxnode/getbreakingtag/)() | Определяет интерфейс для получения Breaking Tag |
