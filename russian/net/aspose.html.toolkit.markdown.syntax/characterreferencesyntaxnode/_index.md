...
description: Aspose.Html.Toolkit.Markdown.Syntax.CharacterReferenceSyntaxNode сорт. Представляет синтаксический узел CharacterReferenceSyntaxNode.
type: docs
weight: 4830
url: /ru/net/aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/
---
## CharacterReferenceSyntaxNode class

Представляет синтаксический узел CharacterReferenceSyntaxNode.
...
| [Reference](../../aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/reference/) { get; } | Получить ссылку. |
| [Source](../../aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/source/) { get; } | Получить исходник. |
| [Span](../../aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/span/) { get; } | Получить диапазон. |
| [Value](../../aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/value/) { get; } | Получить значение. |

## Методы

| Имя | Описание |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/accept/)(MarkdownSyntaxVisitor) | Определяет интерфейс для приема посетителей. |
