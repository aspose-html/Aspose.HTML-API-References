...
description: Aspose.Html.Toolkit.Markdown.Syntax.LinkReferenceDefinitionSyntaxNode сорт. Представляет LinkReferenceDefinitionSyntaxNode.
type: docs
weight: 5120
url: /ru/net/aspose.html.toolkit.markdown.syntax/linkreferencedefinitionsyntaxnode/
---
## LinkReferenceDefinitionSyntaxNode class

Представляет LinkReferenceDefinitionSyntaxNode.
...
| Имя | Описание |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/linkreferencedefinitionsyntaxnode/accept/)(MarkdownSyntaxVisitor) | Определяет интерфейс для приема посетителей. |
...
| [GetDestination](../../aspose.html.toolkit.markdown.syntax/linkreferencedefinitionsyntaxnode/getdestination/)() | Определяет интерфейс для получения пункта назначения. |
| [GetLabel](../../aspose.html.toolkit.markdown.syntax/linkreferencedefinitionsyntaxnode/getlabel/)() | Определяет интерфейс для получения метки. |
...
| [GetTitle](../../aspose.html.toolkit.markdown.syntax/linkreferencedefinitionsyntaxnode/gettitle/)() | Определяет интерфейс для получения заголовка. |
