...
description: Aspose.Html.Toolkit.Markdown.Syntax.ThematicBreakSyntaxNode сорт. Реализован синтаксический узел Thematic Break.
type: docs
weight: 5680
url: /ru/net/aspose.html.toolkit.markdown.syntax/thematicbreaksyntaxnode/
---
## ThematicBreakSyntaxNode class

Реализован синтаксический узел Thematic Break.
...
| Имя | Описание |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/thematicbreaksyntaxnode/accept/)(MarkdownSyntaxVisitor) | Определяет интерфейс для приема посетителей. |
