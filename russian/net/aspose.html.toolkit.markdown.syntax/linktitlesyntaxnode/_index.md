...
description: Aspose.Html.Toolkit.Markdown.Syntax.LinkTitleSyntaxNode сорт. Представляет LinkTitleSyntaxNode.
type: docs
weight: 5130
url: /ru/net/aspose.html.toolkit.markdown.syntax/linktitlesyntaxnode/
---
...
| Имя | Описание |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/linktitlesyntaxnode/accept/)(MarkdownSyntaxVisitor) | Определяет интерфейс для приема посетителей. |
...
| [GetValue](../../aspose.html.toolkit.markdown.syntax/linktitlesyntaxnode/getvalue/)() | Определяет интерфейс для получения строкового значения. |
