...
description: Aspose.Html.Toolkit.Markdown.Syntax.EmptyLineSyntaxNode сорт. Представляет EmptyLineSyntaxNode.
type: docs
weight: 4880
url: /ru/net/aspose.html.toolkit.markdown.syntax/emptylinesyntaxnode/
---
...
| Имя | Описание |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/emptylinesyntaxnode/accept/)(MarkdownSyntaxVisitor) | Определяет интерфейс для приема посетителей. |
