...
description: Aspose.Html.Toolkit.Markdown.Syntax.LeafBlockSyntaxNode сорт. Базовая реализация узла LeafBlockSyntaxNode.
type: docs
weight: 5090
url: /ru/net/aspose.html.toolkit.markdown.syntax/leafblocksyntaxnode/
---
## LeafBlockSyntaxNode class

Базовая реализация узла LeafBlockSyntaxNode.
