...
description: Aspose.Html.Toolkit.Markdown.Syntax.AtxHeadingSyntaxNode сорт. Представляет AtxHeadingSyntaxNode.
type: docs
weight: 4780
url: /ru/net/aspose.html.toolkit.markdown.syntax/atxheadingsyntaxnode/
---
...
| Имя | Описание |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/atxheadingsyntaxnode/accept/)(MarkdownSyntaxVisitor) | Определяет интерфейс для приема посетителей. |
...
| [GetClosingTag](../../aspose.html.toolkit.markdown.syntax/atxheadingsyntaxnode/getclosingtag/)() | Определяет интерфейс для получения ClosingTag. |
| [GetLeadingTrivia](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/getleadingtrivia/)() | Получите главные мелочи. |
| [GetOpeningTag](../../aspose.html.toolkit.markdown.syntax/atxheadingsyntaxnode/getopeningtag/)() | Определяет интерфейс для получения OpeningTag. |
