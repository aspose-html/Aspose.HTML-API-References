...
description: Aspose.Html.Toolkit.Markdown.Syntax.EscapedCharacterSyntaxNode сорт. Реализован узел синтаксиса escapeсимволов.
type: docs
weight: 4890
url: /ru/net/aspose.html.toolkit.markdown.syntax/escapedcharactersyntaxnode/
---
## EscapedCharacterSyntaxNode class

Реализован узел синтаксиса escape-символов.
...
| virtual [Source](../../aspose.html.toolkit.markdown.syntax/textsyntaxnode/source/) { get; } | Вернуть исходный текст. |
| virtual [Span](../../aspose.html.toolkit.markdown.syntax/textsyntaxnode/span/) { get; } | Определяет интерфейс для получения диапазона. |
| [Value](../../aspose.html.toolkit.markdown.syntax/textsyntaxnode/value/) { get; } | Определяет свойство для получения строкового значения. |

## Методы

| Имя | Описание |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/escapedcharactersyntaxnode/accept/)(MarkdownSyntaxVisitor) | Определяет интерфейс для приема посетителей. |
