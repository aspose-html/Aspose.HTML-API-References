...
description: Aspose.Html.Toolkit.Markdown.Syntax.CodeSpanSyntaxNode сорт. Представляет CodeSpanSyntaxNode
type: docs
weight: 4840
url: /ru/net/aspose.html.toolkit.markdown.syntax/codespansyntaxnode/
---
...
| Имя | Описание |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/codespansyntaxnode/accept/)(MarkdownSyntaxVisitor) | Определяет интерфейс для приема посетителей. |
...
| [GetContent](../../aspose.html.toolkit.markdown.syntax/codespansyntaxnode/getcontent/)() | Определяет интерфейс для получения содержимого. |
