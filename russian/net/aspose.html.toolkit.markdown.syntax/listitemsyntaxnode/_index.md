...
description: Aspose.Html.Toolkit.Markdown.Syntax.ListItemSyntaxNode сорт. Представляет ListItemSyntaxNode.
type: docs
weight: 5150
url: /ru/net/aspose.html.toolkit.markdown.syntax/listitemsyntaxnode/
---
## ListItemSyntaxNode class

Представляет ListItemSyntaxNode.
...
| Имя | Описание |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/listitemsyntaxnode/accept/)(MarkdownSyntaxVisitor) | Определяет интерфейс для приема посетителей. |
...
| [GetLinesLeadingTrivia](../../aspose.html.toolkit.markdown.syntax/multilinecontainerblocksyntaxnode/getlinesleadingtrivia/)() | Определяет интерфейс для получения строк, ведущих к мелочам. |
| [GetMarker](../../aspose.html.toolkit.markdown.syntax/listitemsyntaxnode/getmarker/)() | Получить маркер |
...
| [IsTight](../../aspose.html.toolkit.markdown.syntax/listitemsyntaxnode/istight/)() | Получить true, если тайт. |
