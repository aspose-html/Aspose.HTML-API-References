...
description: Aspose.Html.Toolkit.Markdown.Syntax.TaskListItemMarker сорт. Маркер элемента списка задач.
type: docs
weight: 5600
url: /ru/net/aspose.html.toolkit.markdown.syntax/tasklistitemmarker/
---
...
| [IsChecked](../../aspose.html.toolkit.markdown.syntax/tasklistitemmarker/ischecked/)() | Определяет интерфейс для получения статуса проверки. |
