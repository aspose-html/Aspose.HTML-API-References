...
description: Aspose.Html.Toolkit.Markdown.Syntax.EmphasisSyntaxNode сорт. Представляет EmphasisSyntaxNode.
type: docs
weight: 4870
url: /ru/net/aspose.html.toolkit.markdown.syntax/emphasissyntaxnode/
---
...
| Имя | Описание |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/emphasissyntaxnode/accept/)(MarkdownSyntaxVisitor) | Определяет интерфейс для приема посетителей. |
...
| [GetEmphasisType](../../aspose.html.toolkit.markdown.syntax/emphasissyntaxnode/getemphasistype/)() | Определяет интерфейс для получения Emphasis Type |
| [GetEnumerator](../../aspose.html.toolkit.markdown.syntax/inlinecontainersyntaxnode/getenumerator/)() | Возвращает перечислитель, который выполняет итерацию по коллекции. |
