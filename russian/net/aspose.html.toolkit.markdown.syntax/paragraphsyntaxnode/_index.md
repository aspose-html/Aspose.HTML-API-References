...
description: Aspose.Html.Toolkit.Markdown.Syntax.ParagraphSyntaxNode сорт. Представляет узел синтаксиса абзаца.
type: docs
weight: 5310
url: /ru/net/aspose.html.toolkit.markdown.syntax/paragraphsyntaxnode/
---
## ParagraphSyntaxNode class

Представляет узел синтаксиса абзаца.
...
| Имя | Описание |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/paragraphsyntaxnode/accept/)(MarkdownSyntaxVisitor) | Определяет интерфейс для приема посетителя. |
...
| [GetContent](../../aspose.html.toolkit.markdown.syntax/paragraphsyntaxnode/getcontent/)() | Определяет интерфейс для получения содержимого. |
