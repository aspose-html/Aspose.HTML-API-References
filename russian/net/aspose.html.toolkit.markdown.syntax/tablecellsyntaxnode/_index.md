...
description: Aspose.Html.Toolkit.Markdown.Syntax.TableCellSyntaxNode сорт. Представляет узел синтаксиса ячейки таблицы.
type: docs
weight: 5560
url: /ru/net/aspose.html.toolkit.markdown.syntax/tablecellsyntaxnode/
---
...
| [GetValue](../../aspose.html.toolkit.markdown.syntax/tablecellsyntaxnode/getvalue/)() | Определяет интерфейс для получения строкового значения. |
