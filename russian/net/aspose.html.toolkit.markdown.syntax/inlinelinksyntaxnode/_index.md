...
description: Aspose.Html.Toolkit.Markdown.Syntax.InlineLinkSyntaxNode сорт. Представляет InlineLinkSyntaxNode.
type: docs
weight: 5060
url: /ru/net/aspose.html.toolkit.markdown.syntax/inlinelinksyntaxnode/
---
...
| Имя | Описание |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/inlinelinksyntaxnode/accept/)(MarkdownSyntaxVisitor) | Определяет интерфейс для приема посетителей. |
...
| [GetDestination](../../aspose.html.toolkit.markdown.syntax/inlinelinksyntaxnode/getdestination/)() | Определяет интерфейс для получения пункта назначения. |
...
| [GetTitle](../../aspose.html.toolkit.markdown.syntax/inlinelinksyntaxnode/gettitle/)() | Определяет интерфейс для получения заголовка. |
