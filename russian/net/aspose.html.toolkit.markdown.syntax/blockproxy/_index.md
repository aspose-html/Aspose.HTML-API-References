...
description: Aspose.Html.Toolkit.Markdown.Syntax.BlockProxy сорт. Представляет BlockProxy.
type: docs
weight: 4800
url: /ru/net/aspose.html.toolkit.markdown.syntax/blockproxy/
---
## BlockProxy class
...
| Имя | Описание |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/blockproxy/accept/)(MarkdownSyntaxVisitor) | Определяет интерфейс для приема посетителей. |
...
| [GetTarget](../../aspose.html.toolkit.markdown.syntax/blockproxy/gettarget/)() | Получить целевой узел. |
...
| override [WriteTo](../../aspose.html.toolkit.markdown.syntax/blockproxy/writeto/#writeto)(MarkdownTextWriter) | Определяет интерфейс для записи в модуль записи. |
