...
type: docs
weight: 2000
url: /ru/net/aspose.html.dom.svg.paths/svgpathsegmovetorel/
---
...
| [X](../../aspose.html.dom.svg.paths/svgpathsegmovetorel/x) { get; set; } | Относительная координата X для конечной точки этого сегмента пути. |
| [Y](../../aspose.html.dom.svg.paths/svgpathsegmovetorel/y) { get; set; } | Относительная координата Y для конечной точки этого сегмента пути. |
