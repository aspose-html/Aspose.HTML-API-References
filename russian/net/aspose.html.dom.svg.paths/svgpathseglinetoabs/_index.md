...
type: docs
weight: 1920
url: /ru/net/aspose.html.dom.svg.paths/svgpathseglinetoabs/
---
...
| [X](../../aspose.html.dom.svg.paths/svgpathseglinetoabs/x) { get; set; } | Абсолютная координата X для конечной точки этого сегмента пути. |
| [Y](../../aspose.html.dom.svg.paths/svgpathseglinetoabs/y) { get; set; } | Абсолютная координата Y для конечной точки этого сегмента пути. |
