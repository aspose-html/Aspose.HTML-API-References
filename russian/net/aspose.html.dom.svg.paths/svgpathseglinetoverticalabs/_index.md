...
description: Aspose.Html.Dom.Svg.Paths.SVGPathSegLinetoVerticalAbs сорт. Интерфейс SVGPathSegLinetoVerticalAbs соответствует команде данных пути абсолютная вертикальная линия до V.
type: docs
weight: 1850
...
| [Y](../../aspose.html.dom.svg.paths/svgpathseglinetoverticalabs/y/) { get; set; } | Абсолютная координата Y конечной точки этого сегмента пути. |
