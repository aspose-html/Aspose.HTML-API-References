...
description: Интерфейс SVGPathSegLinetoHorizontalRel соответствует команде данных пути относительная горизонтальная линия к h.
type: docs
weight: 1940
url: /ru/net/aspose.html.dom.svg.paths/svgpathseglinetohorizontalrel/
---
## SVGPathSegLinetoHorizontalRel class

Интерфейс SVGPathSegLinetoHorizontalRel соответствует команде данных пути "относительная горизонтальная линия к" (h).
...
| [X](../../aspose.html.dom.svg.paths/svgpathseglinetohorizontalrel/x) { get; set; } | Относительная координата X для конечной точки этого сегмента пути. |
