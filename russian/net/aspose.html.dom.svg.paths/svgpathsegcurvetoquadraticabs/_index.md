...
type: docs
weight: 1880
url: /ru/net/aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticabs/
---
...
| [X](../../aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticabs/x) { get; set; } | Абсолютная координата X для конечной точки этого сегмента пути. |
| [X1](../../aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticabs/x1) { get; set; } | Абсолютная координата X для первой контрольной точки. |
| [Y](../../aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticabs/y) { get; set; } | Абсолютная координата Y для конечной точки этого сегмента пути. |
| [Y1](../../aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticabs/y1) { get; set; } | Абсолютная координата Y для первой контрольной точки. |
