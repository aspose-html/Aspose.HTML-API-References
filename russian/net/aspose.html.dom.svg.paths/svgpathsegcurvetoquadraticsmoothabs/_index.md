...
type: docs
weight: 1900
url: /ru/net/aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticsmoothabs/
---
...
| [X](../../aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticsmoothabs/x) { get; set; } | Абсолютная координата X для конечной точки этого сегмента пути. |
| [Y](../../aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticsmoothabs/y) { get; set; } | Абсолютная координата Y для конечной точки этого сегмента пути. |
