...
description: Color метод. Возвращает новый цвет с запрошенным оттенком насыщенностью значением альфаканалом.
type: docs
weight: 80
url: /ru/net/aspose.html.drawing/color/fromhsva/
---
