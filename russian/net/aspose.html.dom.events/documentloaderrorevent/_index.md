...
description: Aspose.Html.Dom.Events.DocumentLoadErrorEvent сорт. DocumentLoadErrorEvent возникает когда запрошенный ресурс недоступен.
type: docs
weight: 750
url: /ru/net/aspose.html.dom.events/documentloaderrorevent/
---
## DocumentLoadErrorEvent class

`DocumentLoadErrorEvent` возникает, когда запрошенный ресурс недоступен.
