...
description: Aspose.Html.Dom.Events.MouseEvent сорт. Интерфейс MouseEvent предоставляет конкретную контекстную информацию связанную с событиями мыши.
type: docs
weight: 840
...
| Имя | Описание |
| --- | --- |
| [MouseEvent](mouseevent/#constructor)(string) | Инициализирует новый экземпляр`MouseEvent` класс. |
| [MouseEvent](mouseevent/#constructor_1)(string, IDictionary&lt;string, object&gt;) | Инициализирует новый экземпляр`MouseEvent` класс. |
