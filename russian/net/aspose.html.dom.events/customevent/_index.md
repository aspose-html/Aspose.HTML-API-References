...
description: Aspose.Html.Dom.Events.CustomEvent сорт. События использующие интерфейс CustomEvent могут использоваться для переноса пользовательских данных.
type: docs
weight: 730
url: /ru/net/aspose.html.dom.events/customevent/
---
## CustomEvent class
...
| Имя | Описание |
| --- | --- |
| [CustomEvent](customevent/#constructor)(string) | Инициализирует новый экземпляр`CustomEvent` класс. |
| [CustomEvent](customevent/#constructor_1)(string, IDictionary&lt;string, object&gt;) | Инициализирует новый экземпляр`CustomEvent` класс. |
...
| [Detail](../../aspose.html.dom.events/customevent/detail/) { get; } | Получает пользовательские данные. |
...
| [InitCustomEvent](../../aspose.html.dom.events/customevent/initcustomevent/)(string, bool, bool, object) | ///[`InitEvent`](../event/initevent/) метод используется для инициализации значения[`Event`](../event/) созданный с помощью[`IDocumentEvent`](../idocumentevent/) интерфейс. |
