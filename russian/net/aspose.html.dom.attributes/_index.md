...
description: Aspose.Html.Dom.Attributes пространство имен содержит унифицированные классы атрибутов которые определяют или квалифицируют свойства или поведение любого объекта узла элемента и т. д..
type: docs
weight: 50
url: /ru/net/aspose.html.dom.attributes/
---
**Aspose.Html.Dom.Attributes** пространство имен содержит унифицированные классы атрибутов, которые определяют или квалифицируют свойства или поведение любого объекта (узла, элемента и т. д.).
