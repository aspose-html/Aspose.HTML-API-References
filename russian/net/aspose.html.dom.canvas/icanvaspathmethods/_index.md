...
description: Интерфейс ICanvasPathMethods используется для управления путями объектов.
type: docs
weight: 350
...
| [Rect](../../aspose.html.dom.canvas/icanvaspathmethods/rect)(double, double, double, double) | Создает путь для прямоугольника в позиции (x, y) с размером, который определяется шириной и высотой. |
