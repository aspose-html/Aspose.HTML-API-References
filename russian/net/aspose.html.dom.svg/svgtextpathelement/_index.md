...
description: Интерфейс SVGTextPathElement соответствует элементу textPath.
type: docs
weight: 2470
url: /ru/net/aspose.html.dom.svg/svgtextpathelement/
---
...
| [Href](../../aspose.html.dom.svg/svgtextpathelement/href) { get; } | Соответствует атрибуту 'xlink:href' данного элемента. |
...
| [LengthAdjust](../../aspose.html.dom.svg/svgtextcontentelement/lengthadjust) { get; } | Соответствует атрибуту lengthAdjust данного элемента. Значение должно быть одной из констант регулировки длины, определенных в этом интерфейсе. |
...
| [Method](../../aspose.html.dom.svg/svgtextpathelement/method) { get; } | Соответствует атрибуту 'method' данного элемента 'textPath'. |
...
| [Spacing](../../aspose.html.dom.svg/svgtextpathelement/spacing) { get; } | Соответствует атрибуту 'spacing' данного элемента 'textPath'. |
| [StartOffset](../../aspose.html.dom.svg/svgtextpathelement/startoffset) { get; } | Соответствует атрибуту 'startOffset' данного элемента 'textPath'. |
...
| [TextLength](../../aspose.html.dom.svg/svgtextcontentelement/textlength) { get; } | Соответствует атрибуту 'textLength' данного элемента. |
...
| Имя | Описание |
| --- | --- |
| const [TEXTPATH_METHODTYPE_ALIGN](../../aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_align) | Соответствует значению 'align'. |
| const [TEXTPATH_METHODTYPE_STRETCH](../../aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_stretch) | Соответствует значению 'растяжение'. |
| const [TEXTPATH_METHODTYPE_UNKNOWN](../../aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_unknown) | Перечисление было установлено на значение, которое не является одним из предопределенных типов. Недопустимо пытаться определить новое значение этого типа или пытаться переключить существующее значение на этот тип. |
| const [TEXTPATH_SPACINGTYPE_AUTO](../../aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_auto) | Соответствует значению 'auto'. |
| const [TEXTPATH_SPACINGTYPE_EXACT](../../aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_exact) | Соответствует значению 'exact'. |
| const [TEXTPATH_SPACINGTYPE_UNKNOWN](../../aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_unknown) | Перечисление было установлено на значение, которое не является одним из предопределенных типов. Недопустимо пытаться определить новое значение этого типа или пытаться переключить существующее значение на этот тип. |
