...
description: Aspose.Html.Dom.Svg.SVGPathElement сорт. Интерфейс SVGPathElement соответствует элементу path.
type: docs
weight: 2190
url: /ru/net/aspose.html.dom.svg/svgpathelement/
---
...
| [PathSegList](../../aspose.html.dom.svg/svgpathelement/pathseglist/) { get; set; } | Предоставляет доступ к базовому (т.е. статическому) содержимому атрибута 'd' в форме, которая полностью соответствует синтаксису SVG. Таким образом, если атрибут 'd' имеет команду "абсолютный переход (M)" и "абсолютный arcto (A)", то pathSegList будет иметь две записи: SVG_PATHSEG_MOVETO_ABS и SVG_PATHSEG_ARC_ABS. |
...
| [CreateSVGPathSegArcAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegarcabs/)(float, float, float, float, float, bool, bool) | Возвращает автономный объект SVGPathSegArcAbs без родителей. |
| [CreateSVGPathSegArcRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegarcrel/)(float, float, float, float, float, bool, bool) | Возвращает автономный объект SVGPathSegArcRel без родителей. |
| [CreateSVGPathSegClosePath](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegclosepath/)() | Возвращает автономный объект SVGPathSegClosePath без родителей. |
| [CreateSVGPathSegCurvetoCubicAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicabs/)(float, float, float, float, float, float) | Возвращает автономный объект SVGPathSegCurvetoCubicAbs без родителей. |
| [CreateSVGPathSegCurvetoCubicRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicrel/)(float, float, float, float, float, float) | Возвращает автономный объект SVGPathSegCurvetoCubicRel без родителей. |
| [CreateSVGPathSegCurvetoCubicSmoothAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothabs/)(float, float, float, float) | Возвращает автономный объект SVGPathSegCurvetoCubicSmoothAbs без родителей. |
| [CreateSVGPathSegCurvetoCubicSmoothRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothrel/)(float, float, float, float) | Возвращает автономный объект SVGPathSegCurvetoCubicSmoothRel без родителей. |
| [CreateSVGPathSegCurvetoQuadraticAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticabs/)(float, float, float, float) | Возвращает автономный объект SVGPathSegCurvetoQuadraticAbs без родителей. |
| [CreateSVGPathSegCurvetoQuadraticRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticrel/)(float, float, float, float) | Возвращает автономный объект SVGPathSegCurvetoQuadraticRel без родителей. |
| [CreateSVGPathSegCurvetoQuadraticSmoothAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothabs/)(float, float) | Возвращает автономный объект SVGPathSegCurvetoQuadraticSmoothAbs без родителей. |
| [CreateSVGPathSegCurvetoQuadraticSmoothRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothrel/)(float, float) | Возвращает автономный объект SVGPathSegCurvetoQuadraticSmoothRel без родителей. |
| [CreateSVGPathSegLinetoAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoabs/)(float, float) | Возвращает автономный объект SVGPathSegLinetoAbs без родителей. |
| [CreateSVGPathSegLinetoHorizontalAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetohorizontalabs/)(float) | Возвращает автономный объект SVGPathSegLinetoHorizontalAbs без родителей. |
| [CreateSVGPathSegLinetoHorizontalRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetohorizontalrel/)(float) | Возвращает автономный объект SVGPathSegLinetoHorizontalRel без родителей. |
| [CreateSVGPathSegLinetoRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetorel/)(float, float) | Возвращает автономный объект SVGPathSegLinetoRel без родителей. |
| [CreateSVGPathSegLinetoVerticalAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoverticalabs/)(float) | Возвращает автономный объект SVGPathSegLinetoVerticalAbs без родителей. |
| [CreateSVGPathSegLinetoVerticalRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoverticalrel/)(float) | Возвращает автономный объект SVGPathSegLinetoVerticalRel без родителей. |
| [CreateSVGPathSegMovetoAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegmovetoabs/)(float, float) | Возвращает автономный объект SVGPathSegMovetoAbs без родителей. |
| [CreateSVGPathSegMovetoRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegmovetorel/)(float, float) | Возвращает автономный объект SVGPathSegMovetoRel без родителей. |
...
| [GetEquivalentPath](../../aspose.html.dom.svg/svggeometryelement/getequivalentpath/)() | Возвращает новый экземпляр экземпляра[`SVGPathSegList`](../../aspose.html.dom.svg.paths/svgpathseglist/) который представляет[`SVGGeometryElement`](../svggeometryelement/) как сегменты пути. |
...
| [GetPointAtLength](../../aspose.html.dom.svg/svggeometryelement/getpointatlength/)(float) | Возвращает координату (x,y) в пользовательском пространстве, которая является единицами расстояния вдоль пути, используя алгоритм пользовательского агента расстояния вдоль пути. |
...
| [GetTotalLength](../../aspose.html.dom.svg/svggeometryelement/gettotallength/)() | Возвращает вычисленное агентом пользователя значение общей длины пути с использованием алгоритма расстояния вдоль пути агента пользователя в виде расстояния в текущей системе координат пользователя. |
