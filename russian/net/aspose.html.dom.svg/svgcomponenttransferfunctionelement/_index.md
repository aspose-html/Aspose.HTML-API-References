...
description: Этот интерфейс определяет базовый интерфейс используемый интерфейсами функции передачи компонентов.
type: docs
weight: 2080
...
| [Exponent](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/exponent) { get; } | Соответствует атрибуту exponent данного элемента. |
...
| [Intercept](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/intercept) { get; } | Соответствует атрибуту 'intercept' данного элемента. |
...
| [Offset](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/offset) { get; } | Соответствует атрибуту 'смещение' данного элемента. |
...
| [Type](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/type) { get; } | Соответствует атрибуту 'type' данного элемента. Принимает одну из констант SVG_FECOMPONENTTRANSFER_TYPE_*, определенных в этом интерфейсе. |
...
| const [SVG_FECOMPONENTTRANSFER_TYPE_GAMMA](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_gamma) | Соответствует значению 'gamma'. |
