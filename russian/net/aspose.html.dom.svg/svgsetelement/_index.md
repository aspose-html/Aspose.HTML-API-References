...
description: Aspose.Html.Dom.Svg.SVGSetElement сорт. Интерфейс SVGSetElement соответствует элементу set. Объектноориентированный доступ к атрибутам элемента set через SVG DOM недоступен.
type: docs
weight: 2280
url: /ru/net/aspose.html.dom.svg/svgsetelement/
---
## SVGSetElement class
