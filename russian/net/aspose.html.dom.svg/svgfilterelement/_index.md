...
description: Интерфейс SVGFilterElement соответствует элементу filter.
type: docs
weight: 2170
...
| [Width](../../aspose.html.dom.svg/svgfilterelement/width) { get; } | Соответствует атрибуту 'width' данного элемента 'filter'. |
| [X](../../aspose.html.dom.svg/svgfilterelement/x) { get; } | Соответствует атрибуту 'x' данного элемента 'filter'. |
