...
description: Aspose.Html.Dom.Svg.SVGFilterElement сорт. Интерфейс SVGFilterElement соответствует элементу filter.
type: docs
weight: 2060
url: /ru/net/aspose.html.dom.svg/svgfilterelement/
---
...
| [FilterUnits](../../aspose.html.dom.svg/svgfilterelement/filterunits/) { get; } | Соответствует атрибуту filterUnits данного элемента filter. Принимает одну из констант, определенных в SVGUnitTypes. |
...
| [Height](../../aspose.html.dom.svg/svgfilterelement/height/) { get; } | Соответствует атрибуту "высота" данного элемента "фильтра". |
| [Href](../../aspose.html.dom.svg/svgfilterelement/href/) { get; } | Соответствует атрибуту 'xlink:href' данного элемента. |
...
| [PrimitiveUnits](../../aspose.html.dom.svg/svgfilterelement/primitiveunits/) { get; } | Соответствует атрибуту 'primitiveUnits' данного элемента 'filter'. Принимает одну из констант, определенных в SVGUnitTypes. |
...
| [Width](../../aspose.html.dom.svg/svgfilterelement/width/) { get; } | Соответствует атрибуту «ширина» данного элемента «фильтр». |
| [X](../../aspose.html.dom.svg/svgfilterelement/x/) { get; } | Соответствует атрибуту «x» данного элемента «фильтр». |
| [Y](../../aspose.html.dom.svg/svgfilterelement/y/) { get; } | Соответствует атрибуту 'y' данного элемента 'filter'. |
