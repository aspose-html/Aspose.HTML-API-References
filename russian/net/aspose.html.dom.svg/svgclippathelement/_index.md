...
description: Aspose.Html.Dom.Svg.SVGClipPathElement сорт. Интерфейс SVGClipPathElement соответствует элементу clipPath.
type: docs
weight: 1960
url: /ru/net/aspose.html.dom.svg/svgclippathelement/
---
...
| [ClipPathUnits](../../aspose.html.dom.svg/svgclippathelement/clippathunits/) { get; } | Соответствует атрибуту clipPathUnits данного элемента clipPath. Принимает одну из констант, определенных в SVGUnitTypes. |
...
| [Transform](../../aspose.html.dom.svg/svgclippathelement/transform/) { get; } | Соответствует атрибуту «преобразование» данного элемента. |
