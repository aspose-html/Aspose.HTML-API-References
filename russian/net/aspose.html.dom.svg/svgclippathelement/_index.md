...
description: Интерфейс SVGClipPathElement соответствует элементу clipPath.
type: docs
weight: 2070
...
| [Transform](../../aspose.html.dom.svg/svgclippathelement/transform) { get; } | Соответствует атрибуту 'transform' данного элемента. |
