...
description: Интерфейс SVGForeignObjectElement соответствует элементу foreignObject.
type: docs
weight: 2180
...
| [Height](../../aspose.html.dom.svg/svgforeignobjectelement/height) { get; } | Соответствует атрибуту 'height' данного элемента 'foreignObject'. |
