...
description: Aspose.Html.Dom.Svg.SVGForeignObjectElement сорт. Интерфейс SVGForeignObjectElement соответствует элементу foreignObject.
type: docs
weight: 2070
url: /ru/net/aspose.html.dom.svg/svgforeignobjectelement/
---
...
| [Height](../../aspose.html.dom.svg/svgforeignobjectelement/height/) { get; } | Соответствует атрибуту «высота» данного элемента «foreignObject». |
...
| [Width](../../aspose.html.dom.svg/svgforeignobjectelement/width/) { get; } | Соответствует атрибуту «width» данного элемента «foreignObject». |
| [X](../../aspose.html.dom.svg/svgforeignobjectelement/x/) { get; } | Соответствует атрибуту «x» данного элемента «foreignObject». |
| [Y](../../aspose.html.dom.svg/svgforeignobjectelement/y/) { get; } | Соответствует атрибуту «y» данного элемента «foreignObject». |
