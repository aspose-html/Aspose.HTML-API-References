...
description: Aspose.Html.Dom.Svg.SVGMarkerElement сорт. Интерфейс SVGMarkerElement соответствует элементу маркер.
type: docs
weight: 2160
url: /ru/net/aspose.html.dom.svg/svgmarkerelement/
---
## SVGMarkerElement class

Интерфейс SVGMarkerElement соответствует элементу «маркер».
...
| [MarkerHeight](../../aspose.html.dom.svg/svgmarkerelement/markerheight/) { get; } | Соответствует атрибуту 'markerHeight' данного элемента 'marker'. |
| [MarkerUnits](../../aspose.html.dom.svg/svgmarkerelement/markerunits/) { get; } | Соответствует атрибуту 'markerUnits' данного элемента 'marker'. Один из типов маркеров, определенных в этом интерфейсе. |
| [MarkerWidth](../../aspose.html.dom.svg/svgmarkerelement/markerwidth/) { get; } | Соответствует атрибуту 'markerWidth' данного элемента 'marker'. |
...
| [OrientAngle](../../aspose.html.dom.svg/svgmarkerelement/orientangle/) { get; } | Соответствует атрибуту «ориентация» данного элемента «маркер». Если markerUnits равно SVG_MARKER_ORIENT_ANGLE, значение угла для атрибута 'ориентация'; в противном случае он будет равен нулю. |
| [OrientType](../../aspose.html.dom.svg/svgmarkerelement/orienttype/) { get; } | Соответствует атрибуту «ориентация» данного элемента «маркер». Один из типов ориентации маркера, определенных в этом интерфейсе. |
...
| [PreserveAspectRatio](../../aspose.html.dom.svg/svgmarkerelement/preserveaspectratio/) { get; } | Соответствует атрибуту preserveAspectRatio данного элемента. |
...
| [RefX](../../aspose.html.dom.svg/svgmarkerelement/refx/) { get; } | Соответствует атрибуту 'refX' данного элемента 'marker'. |
| [RefY](../../aspose.html.dom.svg/svgmarkerelement/refy/) { get; } | Соответствует атрибуту 'refY' данного элемента 'marker'. |
...
| [ViewBox](../../aspose.html.dom.svg/svgmarkerelement/viewbox/) { get; } | Соответствует атрибуту viewBox данного элемента. |
...
| [SetOrientToAngle](../../aspose.html.dom.svg/svgmarkerelement/setorienttoangle/)(SVGAngle) | Устанавливает значение атрибута 'ориентация' на заданный угол. |
| [SetOrientToAuto](../../aspose.html.dom.svg/svgmarkerelement/setorienttoauto/)() | Устанавливает значение атрибута 'ориентация' на 'авто'. |
...
| Имя | Описание |
| --- | --- |
| const [SVG_MARKERUNITS_STROKEWIDTH](../../aspose.html.dom.svg/svgmarkerelement/svg_markerunits_strokewidth/) | Значением атрибута 'markerUnits' является 'strokeWidth'. |
| const [SVG_MARKERUNITS_UNKNOWN](../../aspose.html.dom.svg/svgmarkerelement/svg_markerunits_unknown/) | Тип единицы маркера не является одним из предопределенных типов. Недопустимо пытаться определить новое значение этого типа или пытаться переключить существующее значение на этот тип. |
| const [SVG_MARKERUNITS_USERSPACEONUSE](../../aspose.html.dom.svg/svgmarkerelement/svg_markerunits_userspaceonuse/) | Значение атрибута 'markerUnits' равно 'userSpaceOnUse'. |
| const [SVG_MARKER_ORIENT_ANGLE](../../aspose.html.dom.svg/svgmarkerelement/svg_marker_orient_angle/) | Атрибут 'ориентация' имеет значение угла. |
| const [SVG_MARKER_ORIENT_AUTO](../../aspose.html.dom.svg/svgmarkerelement/svg_marker_orient_auto/) | Атрибут "ориентация" имеет значение "авто". |
| const [SVG_MARKER_ORIENT_UNKNOWN](../../aspose.html.dom.svg/svgmarkerelement/svg_marker_orient_unknown/) | Ориентация маркера не является одним из предопределенных типов. Недопустимо пытаться определить новое значение этого типа или пытаться переключить существующее значение на этот тип. |
