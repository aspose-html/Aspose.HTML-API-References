...
description: Интерфейс SVGMarkerElement соответствует элементу marker.
type: docs
weight: 2270
...
| [OrientAngle](../../aspose.html.dom.svg/svgmarkerelement/orientangle) { get; } | Соответствует атрибуту 'ориентация' данного элемента 'маркер'. Если markerUnits равно SVG_MARKER_ORIENT_ANGLE, значение угла для атрибута 'ориентация'; в противном случае он будет установлен равным нулю. |
...
| [SetOrientToAuto](../../aspose.html.dom.svg/svgmarkerelement/setorienttoauto)() | Устанавливает значение атрибута 'ориентация' в 'авто'. |
...
| const [SVG_MARKERUNITS_UNKNOWN](../../aspose.html.dom.svg/svgmarkerelement/svg_markerunits_unknown) | Тип маркера не является одним из предопределенных типов. Недопустимо пытаться определить новое значение этого типа или пытаться переключить существующее значение на этот тип. |
| const [SVG_MARKERUNITS_USERSPACEONUSE](../../aspose.html.dom.svg/svgmarkerelement/svg_markerunits_userspaceonuse) | Значением атрибута 'markerUnits' является 'userSpaceOnUse'. |
