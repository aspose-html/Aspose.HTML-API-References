...
description: Aspose.Html.Dom.Svg.SVGMaskElement сорт. Интерфейс SVGMaskElement соответствует элементу маска.
type: docs
weight: 2170
url: /ru/net/aspose.html.dom.svg/svgmaskelement/
---
## SVGMaskElement class

Интерфейс SVGMaskElement соответствует элементу "маска".
...
| [Height](../../aspose.html.dom.svg/svgmaskelement/height/) { get; } | Соответствует атрибуту «высота» данного элемента «маски». Принимает одну из констант, определенных в SVGUnitTypes. |
...
| [MaskContentUnits](../../aspose.html.dom.svg/svgmaskelement/maskcontentunits/) { get; } | Соответствует атрибуту «maskContentUnits» данного элемента «маска». Принимает одну из констант, определенных в SVGUnitTypes. |
| [MaskUnits](../../aspose.html.dom.svg/svgmaskelement/maskunits/) { get; } | Соответствует атрибуту «maskUnits» данного элемента «маска». Принимает одну из констант, определенных в SVGUnitTypes. |
...
| [RequiredExtensions](../../aspose.html.dom.svg/svgmaskelement/requiredextensions/) { get; } | Соответствует атрибуту «requiredExtensions» данного элемента. |
| [RequiredFeatures](../../aspose.html.dom.svg/svgmaskelement/requiredfeatures/) { get; } | Соответствует атрибуту «requiredFeatures» данного элемента. |
...
| [SystemLanguage](../../aspose.html.dom.svg/svgmaskelement/systemlanguage/) { get; } | Соответствует атрибуту systemLanguage данного элемента. |
...
| [Width](../../aspose.html.dom.svg/svgmaskelement/width/) { get; } | Соответствует атрибуту «ширина» данного элемента «маска». Принимает одну из констант, определенных в SVGUnitTypes. |
| [X](../../aspose.html.dom.svg/svgmaskelement/x/) { get; } | Соответствует атрибуту «x» данного элемента «маска». Принимает одну из констант, определенных в SVGUnitTypes. |
| [Y](../../aspose.html.dom.svg/svgmaskelement/y/) { get; } | Соответствует атрибуту «y» данного элемента «маска». Принимает одну из констант, определенных в SVGUnitTypes. |
