...
description: Интерфейс SVGMaskElement соответствует элементу маска.
type: docs
weight: 2280
...
| [MaskContentUnits](../../aspose.html.dom.svg/svgmaskelement/maskcontentunits) { get; } | Соответствует атрибуту 'maskContentUnits' данного элемента 'mask'. Принимает одну из констант, определенных в SVGUnitTypes. |
| [MaskUnits](../../aspose.html.dom.svg/svgmaskelement/maskunits) { get; } | Соответствует атрибуту 'maskUnits' данного элемента 'mask'. Принимает одну из констант, определенных в SVGUnitTypes. |
...
| [Width](../../aspose.html.dom.svg/svgmaskelement/width) { get; } | Соответствует атрибуту 'width' данного элемента 'маски'. Принимает одну из констант, определенных в SVGUnitTypes. |
| [X](../../aspose.html.dom.svg/svgmaskelement/x) { get; } | Соответствует атрибуту 'x' данного элемента 'маски'. Принимает одну из констант, определенных в SVGUnitTypes. |
| [Y](../../aspose.html.dom.svg/svgmaskelement/y) { get; } | Соответствует атрибуту 'y' данного элемента 'маски'. Принимает одну из констант, определенных в SVGUnitTypes. |
