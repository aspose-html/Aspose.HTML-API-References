...
description: Aspose.Html.Dom.Svg.SVGStyleElement сорт. Интерфейс SVGStyleElement соответствует элементу style.
type: docs
weight: 2300
url: /ru/net/aspose.html.dom.svg/svgstyleelement/
---
...
| [Media](../../aspose.html.dom.svg/svgstyleelement/media/) { get; set; } | Соответствует атрибуту 'media' данного элемента. |
...
| [Sheet](../../aspose.html.dom.svg/svgstyleelement/sheet/) { get; } | Получает связанную таблицу стилей. |
...
| [Title](../../aspose.html.dom.svg/svgstyleelement/title/) { get; set; } | Соответствует атрибуту title данного элемента. |
| [Type](../../aspose.html.dom.svg/svgstyleelement/type/) { get; set; } | Соответствует типу атрибута данного элемента. |
