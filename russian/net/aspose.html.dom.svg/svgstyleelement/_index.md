...
description: Интерфейс SVGStyleElement соответствует элементу style.
type: docs
weight: 2410
...
| [Type](../../aspose.html.dom.svg/svgstyleelement/type) { get; set; } | Соответствует атрибуту 'type' данного элемента. |
