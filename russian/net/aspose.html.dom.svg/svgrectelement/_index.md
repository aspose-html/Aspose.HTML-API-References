...
description: Интерфейс SVGRectElement соответствует элементу rect.
type: docs
weight: 2350
...
| [Height](../../aspose.html.dom.svg/svgrectelement/height) { get; } | Соответствует атрибуту 'height' данного элемента 'rect'. |
...
| [Width](../../aspose.html.dom.svg/svgrectelement/width) { get; } | Соответствует атрибуту 'width' данного элемента 'rect'. |
