...
description: Aspose.Html.Dom.Svg.SVGPatternElement сорт. Интерфейс SVGPatternElement соответствует элементу шаблон.
type: docs
weight: 2200
url: /ru/net/aspose.html.dom.svg/svgpatternelement/
---
## SVGPatternElement class

Интерфейс SVGPatternElement соответствует элементу «шаблон».
...
| [Height](../../aspose.html.dom.svg/svgpatternelement/height/) { get; } | Соответствует атрибуту "высота" данного элемента "шаблона". |
| [Href](../../aspose.html.dom.svg/svgpatternelement/href/) { get; } | Соответствует атрибуту 'xlink:href' данного элемента. |
...
| [PatternContentUnits](../../aspose.html.dom.svg/svgpatternelement/patterncontentunits/) { get; } | Соответствует атрибуту «patternContentUnits» данного элемента «pattern». Принимает одну из констант, определенных в SVGUnitTypes. |
| [PatternTransform](../../aspose.html.dom.svg/svgpatternelement/patterntransform/) { get; } | Соответствует атрибуту «patternTransform» данного элемента «pattern». |
| [PatternUnits](../../aspose.html.dom.svg/svgpatternelement/patternunits/) { get; } | Соответствует атрибуту 'patternUnits' данного элемента 'шаблона'. Принимает одну из констант, определенных в SVGUnitTypes. |
...
| [PreserveAspectRatio](../../aspose.html.dom.svg/svgpatternelement/preserveaspectratio/) { get; } | Соответствует атрибуту preserveAspectRatio данного элемента. |
...
| [RequiredExtensions](../../aspose.html.dom.svg/svgpatternelement/requiredextensions/) { get; } | Соответствует атрибуту «requiredExtensions» данного элемента. |
| [RequiredFeatures](../../aspose.html.dom.svg/svgpatternelement/requiredfeatures/) { get; } | Соответствует атрибуту «requiredFeatures» данного элемента. |
...
| [SystemLanguage](../../aspose.html.dom.svg/svgpatternelement/systemlanguage/) { get; } | Соответствует атрибуту systemLanguage данного элемента. |
...
| [ViewBox](../../aspose.html.dom.svg/svgpatternelement/viewbox/) { get; } | Соответствует атрибуту viewBox данного элемента. |
...
| [Width](../../aspose.html.dom.svg/svgpatternelement/width/) { get; } | Соответствует атрибуту «ширина» данного элемента «шаблона». |
| [X](../../aspose.html.dom.svg/svgpatternelement/x/) { get; } | Соответствует атрибуту «x» данного элемента «шаблона». |
| [Y](../../aspose.html.dom.svg/svgpatternelement/y/) { get; } | Соответствует атрибуту 'y' данного элемента 'pattern'. |
