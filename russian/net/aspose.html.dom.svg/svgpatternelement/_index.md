...
description: Интерфейс SVGPatternElement соответствует элементу pattern.
type: docs
weight: 2310
...
| [PatternUnits](../../aspose.html.dom.svg/svgpatternelement/patternunits) { get; } | Соответствует атрибуту 'patternUnits' данного элемента 'pattern'. Принимает одну из констант, определенных в SVGUnitTypes. |
...
| [Width](../../aspose.html.dom.svg/svgpatternelement/width) { get; } | Соответствует атрибуту 'width' данного элемента 'pattern'. |
| [X](../../aspose.html.dom.svg/svgpatternelement/x) { get; } | Соответствует атрибуту 'x' данного элемента 'pattern'. |
