...
description: Aspose.Html.Dom.Svg.SVGElement сорт. Все интерфейсы SVG DOM которые непосредственно соответствуют элементам языка SVG например интерфейс SVGPathElement для элемента path являются производными от интерфейса SVGElement.
type: docs
weight: 2020
url: /ru/net/aspose.html.dom.svg/svgelement/
---
## SVGElement class

Все интерфейсы SVG DOM, которые непосредственно соответствуют элементам языка SVG (например, интерфейс SVGPathElement для элемента path), являются производными от интерфейса SVGElement.
