...
description: Интерфейс SVGAnimateMotionElement соответствует элементу animateMotion. Объектно-ориентированный доступ к атрибутам элемента animateMotion через SVG DOM недоступен.
type: docs
weight: 2030
