...
description: Aspose.Html.Dom.Svg.SVGAnimateMotionElement сорт. Интерфейс SVGAnimateMotionElement соответствует элементу animateMotion. Объектноориентированный доступ к атрибутам элемента animateMotion через SVG DOM недоступен.
type: docs
weight: 1920
url: /ru/net/aspose.html.dom.svg/svganimatemotionelement/
---
