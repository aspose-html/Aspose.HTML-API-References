...
description: Aspose.Html.Dom.Svg.SVGRadialGradientElement сорт. Интерфейс SVGRadialGradientElement соответствует элементу radialGradient.
type: docs
weight: 2230
url: /ru/net/aspose.html.dom.svg/svgradialgradientelement/
---
...
| [Cx](../../aspose.html.dom.svg/svgradialgradientelement/cx/) { get; } | Соответствует атрибуту 'cx' данного элемента 'radialGradient'. |
| [Cy](../../aspose.html.dom.svg/svgradialgradientelement/cy/) { get; } | Соответствует атрибуту 'cy' данного элемента 'radialGradient'. |
...
| [Fr](../../aspose.html.dom.svg/svgradialgradientelement/fr/) { get; } | Соответствует атрибуту 'fr' данного элемента 'radialGradient'. |
| [Fx](../../aspose.html.dom.svg/svgradialgradientelement/fx/) { get; } | Соответствует атрибуту fx данного элемента 'radialGradient'. |
| [Fy](../../aspose.html.dom.svg/svgradialgradientelement/fy/) { get; } | Соответствует атрибуту 'fy' данного элемента 'radialGradient'. |
| [GradientTransform](../../aspose.html.dom.svg/svggradientelement/gradienttransform/) { get; } | Соответствует атрибуту 'gradientTransform' данного элемента. |
| [GradientUnits](../../aspose.html.dom.svg/svggradientelement/gradientunits/) { get; } | Соответствует атрибуту 'gradientUnits' данного элемента. Принимает одну из констант, определенных в SVGUnitTypes. |
| [Href](../../aspose.html.dom.svg/svggradientelement/href/) { get; } | Соответствует атрибуту 'xlink:href' данного элемента. |
...
| [R](../../aspose.html.dom.svg/svgradialgradientelement/r/) { get; } | Соответствует атрибуту 'r' данного элемента 'radialGradient'. |
...
| [SpreadMethod](../../aspose.html.dom.svg/svggradientelement/spreadmethod/) { get; } | Соответствует атрибуту «spreadMethod» данного элемента. Один из типов метода распространения, определенных в этом интерфейсе. |
