...
description: Aspose.Html.Dom.Svg.SVGGraphicsElement сорт. Интерфейс SVGGraphicsElement представляет элементы SVG основной целью которых является непосредственное отображение графики в группе.
type: docs
weight: 2110
url: /ru/net/aspose.html.dom.svg/svggraphicselement/
---
## SVGGraphicsElement class

Интерфейс SVGGraphicsElement представляет элементы SVG, основной целью которых является непосредственное отображение графики в группе.
