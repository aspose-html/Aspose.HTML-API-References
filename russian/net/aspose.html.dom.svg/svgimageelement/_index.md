...
description: Aspose.Html.Dom.Svg.SVGImageElement сорт. Интерфейс SVGImageElement соответствует элементу изображения.
type: docs
weight: 2120
url: /ru/net/aspose.html.dom.svg/svgimageelement/
---
## SVGImageElement class

Интерфейс SVGImageElement соответствует элементу изображения.
...
| [Height](../../aspose.html.dom.svg/svgimageelement/height/) { get; } | Соответствует атрибуту "высота" данного элемента "изображения". |
| [Href](../../aspose.html.dom.svg/svgimageelement/href/) { get; } | Соответствует атрибуту 'xlink:href' данного элемента. |
...
| [PreserveAspectRatio](../../aspose.html.dom.svg/svgimageelement/preserveaspectratio/) { get; } | Соответствует атрибуту preserveAspectRatio данного элемента изображения. |
...
| [Width](../../aspose.html.dom.svg/svgimageelement/width/) { get; } | Соответствует атрибуту «ширина» данного элемента «изображения». |
| [X](../../aspose.html.dom.svg/svgimageelement/x/) { get; } | Соответствует атрибуту «x» данного элемента «изображения». |
| [Y](../../aspose.html.dom.svg/svgimageelement/y/) { get; } | Соответствует атрибуту 'y' данного элемента 'image'. |
