...
description: Интерфейс SVGImageElement соответствует элементу image.
type: docs
weight: 2230
...
| [PreserveAspectRatio](../../aspose.html.dom.svg/svgimageelement/preserveaspectratio) { get; } | Соответствует атрибуту 'preserveAspectRatio' данного элемента 'image'. |
...
| [X](../../aspose.html.dom.svg/svgimageelement/x) { get; } | Соответствует атрибуту 'x' данного элемента 'image'. |
