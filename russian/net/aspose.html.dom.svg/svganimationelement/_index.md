...
description: Интерфейс SVGAnimationElement является базовым интерфейсом для всех интерфейсов элементов анимацииSVGAnimateElement SVGSetElement SVGAnimateColorElement SVGAnimateMotionElement и SVGAnimateTransformElement.
type: docs
weight: 2050
