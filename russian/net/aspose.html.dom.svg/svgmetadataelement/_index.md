...
description: Aspose.Html.Dom.Svg.SVGMetadataElement сорт. Интерфейс SVGMetadataElement соответствует элементу метаданные.
type: docs
weight: 2180
url: /ru/net/aspose.html.dom.svg/svgmetadataelement/
---
## SVGMetadataElement class

Интерфейс SVGMetadataElement соответствует элементу «метаданные».
