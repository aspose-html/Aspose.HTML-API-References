...
description: Aspose.Html.Dom.Svg.SVGAElement сорт. Интерфейс SVGAElement соответствует элементу a.
type: docs
weight: 1900
url: /ru/net/aspose.html.dom.svg/svgaelement/
---
## SVGAElement class
...
| [Href](../../aspose.html.dom.svg/svgaelement/href/) { get; } | Соответствует атрибуту 'xlink:href' данного элемента. |
...
| [Target](../../aspose.html.dom.svg/svgaelement/target/) { get; } | Соответствует атрибуту 'target' данного элемента 'a'. |
