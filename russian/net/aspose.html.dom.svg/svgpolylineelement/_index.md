...
description: Aspose.Html.Dom.Svg.SVGPolylineElement сорт. Интерфейс SVGPolylineElement соответствует элементу полилинии.
type: docs
weight: 2220
url: /ru/net/aspose.html.dom.svg/svgpolylineelement/
---
## SVGPolylineElement class

Интерфейс SVGPolylineElement соответствует элементу полилинии.
...
| Имя | Описание |
| --- | --- |
| [AnimatedPoints](../../aspose.html.dom.svg/svgpolylineelement/animatedpoints/) { get; } | Предоставляет доступ к текущему анимированному содержимому атрибута «точки». Если данный атрибут или свойство анимируются, содержит текущее анимированное значение атрибута или свойства. Если данный атрибут или свойство в настоящее время не анимируются, содержит то же значение, что и точки. |
...
| [Points](../../aspose.html.dom.svg/svgpolylineelement/points/) { get; } | Предоставляет доступ к базовому (т.е. статическому) содержимому атрибута «точки». |
