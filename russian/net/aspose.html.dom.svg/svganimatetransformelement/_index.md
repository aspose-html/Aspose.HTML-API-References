...
description: Aspose.Html.Dom.Svg.SVGAnimateTransformElement сорт. Интерфейс SVGAnimateTransformElement соответствует элементу animateTransform. Объектноориентированный доступ к атрибутам элемента animateTransform через SVG DOM недоступен.
type: docs
weight: 1930
url: /ru/net/aspose.html.dom.svg/svganimatetransformelement/
---
