...
description: Aspose.Html.Dom.Svg.SVGViewElement сорт. Интерфейс SVGViewElement соответствует элементу представление.
type: docs
weight: 2410
url: /ru/net/aspose.html.dom.svg/svgviewelement/
---
## SVGViewElement class

Интерфейс SVGViewElement соответствует элементу «представление».
...
| [PreserveAspectRatio](../../aspose.html.dom.svg/svgviewelement/preserveaspectratio/) { get; } | Соответствует атрибуту preserveAspectRatio данного элемента. |
...
| [ViewBox](../../aspose.html.dom.svg/svgviewelement/viewbox/) { get; } | Соответствует атрибуту viewBox данного элемента. |
...
| [ViewTarget](../../aspose.html.dom.svg/svgviewelement/viewtarget/) { get; } | Соответствует атрибуту «viewTarget» данного элемента «представление». Список значений DOMString, содержащих имена, перечисленные в атрибуте viewTarget. Каждое из значений DOMString может быть связано с соответствующим элементом с помощью вызова метода getElementById(). |
| [ZoomAndPan](../../aspose.html.dom.svg/svgviewelement/zoomandpan/) { get; set; } | Соответствует атрибуту zoomAndPan данного элемента. Значение должно быть одной из констант SVG_ZOOMANDPAN_*, определенных в этом интерфейсе. |
