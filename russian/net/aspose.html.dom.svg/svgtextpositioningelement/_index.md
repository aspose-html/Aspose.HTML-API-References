...
description: Aspose.Html.Dom.Svg.SVGTextPositioningElement сорт. Интерфейс SVGTextPositioningElement наследуется текстовыми интерфейсами SVGTextElement SVGTSpanElement SVGTRefElement и SVGAltGlyphElement.
type: docs
weight: 2370
...
| [Rotate](../../aspose.html.dom.svg/svgtextpositioningelement/rotate/) { get; } | Соответствует атрибуту «поворот» данного элемента. |
