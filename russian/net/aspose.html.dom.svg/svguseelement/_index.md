...
description: Aspose.Html.Dom.Svg.SVGUseElement сорт. Интерфейс SVGUseElement соответствует элементу use.
type: docs
weight: 2400
url: /ru/net/aspose.html.dom.svg/svguseelement/
---
## SVGUseElement class
...
| [Height](../../aspose.html.dom.svg/svguseelement/height/) { get; } | Соответствует атрибуту "высота" данного элемента "использования". |
| [Href](../../aspose.html.dom.svg/svguseelement/href/) { get; } | Соответствует атрибуту 'xlink:href' данного элемента. |
...
| [Width](../../aspose.html.dom.svg/svguseelement/width/) { get; } | Соответствует атрибуту 'width' данного элемента 'use'. |
| [X](../../aspose.html.dom.svg/svguseelement/x/) { get; } | Соответствует атрибуту 'x' данного элемента 'use'. |
| [Y](../../aspose.html.dom.svg/svguseelement/y/) { get; } | Соответствует атрибуту 'y' данного элемента 'use'. |
