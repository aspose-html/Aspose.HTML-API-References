...
description: Интерфейс SVGUseElement соответствует элементу use.
type: docs
weight: 2510
...
| [Height](../../aspose.html.dom.svg/svguseelement/height) { get; } | Соответствует атрибуту «высота» данного элемента «использовать». |
