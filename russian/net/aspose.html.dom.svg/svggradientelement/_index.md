...
description: Интерфейс SVGGradientElement  это базовый интерфейс используемый SVGLinearGradientElement и SVGRadialGradientElement.
type: docs
weight: 2210
...
| const [SVG_SPREADMETHOD_REPEAT](../../aspose.html.dom.svg/svggradientelement/svg_spreadmethod_repeat) | Соответствует значению 'repeat'. |
