...
description: Интерфейс SVGAnimateElement соответствует элементу animate. Объектно-ориентированный доступ к атрибутам анимируемого элемента через SVG DOM недоступен.
type: docs
weight: 2020
...
Интерфейс SVGAnimateElement соответствует элементу 'animate'. Объектно-ориентированный доступ к атрибутам 'анимируемого' элемента через SVG DOM недоступен.
