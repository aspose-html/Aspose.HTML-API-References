...
description: Aspose.Html.Dom.Svg.SVGAnimateElement сорт. Интерфейс SVGAnimateElement соответствует анимируемому элементу. Объектноориентированный доступ к атрибутам анимируемого элемента через SVG DOM недоступен.
type: docs
weight: 1910
url: /ru/net/aspose.html.dom.svg/svganimateelement/
---
## SVGAnimateElement class

Интерфейс SVGAnimateElement соответствует анимируемому элементу. Объектно-ориентированный доступ к атрибутам анимируемого элемента через SVG DOM недоступен.
