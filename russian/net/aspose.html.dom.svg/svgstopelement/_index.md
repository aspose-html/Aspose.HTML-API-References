...
description: Aspose.Html.Dom.Svg.SVGStopElement сорт. Интерфейс SVGStopElement соответствует элементу стоп.
type: docs
weight: 2290
url: /ru/net/aspose.html.dom.svg/svgstopelement/
---
## SVGStopElement class

Интерфейс SVGStopElement соответствует элементу «стоп».
...
| [Offset](../../aspose.html.dom.svg/svgstopelement/offset/) { get; } | Соответствует атрибуту 'offset' данного элемента 'radialGradient'. |
