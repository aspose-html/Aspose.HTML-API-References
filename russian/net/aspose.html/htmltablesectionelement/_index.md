...
description: Aspose.Html.HTMLTableSectionElement сорт. ГОЛОВА ТФУТ  иTBODY элементов.
type: docs
weight: 3590
url: /ru/net/aspose.html/htmltablesectionelement/
---
## HTMLTableSectionElement class

`ГОЛОВА` ,`ТФУТ` , и`TBODY` элементов.
...
| Имя | Описание |
| --- | --- |
| [Align](../../aspose.html/htmltablesectionelement/align/) { get; set; } | Горизонтальное выравнивание данных в ячейках. См.`выровнять` атрибут для HTMLTheadElement для получения подробной информации. |
...
| [Ch](../../aspose.html/htmltablesectionelement/ch/) { get; set; } | Символ выравнивания для ячеек в столбце. См. определение атрибута char в HTML 4.01. . |
...
| [ChOff](../../aspose.html/htmltablesectionelement/choff/) { get; set; } | Смещение символа выравнивания. См. определение атрибута charoff в HTML 4.01. . |
...
| [Rows](../../aspose.html/htmltablesectionelement/rows/) { get; } | Набор строк в этом разделе таблицы. |
...
| [VAlign](../../aspose.html/htmltablesectionelement/valign/) { get; set; } | Вертикальное выравнивание данных в ячейках. См.`выровнять` атрибут для HTMLTheadElement для получения подробной информации. |
...
| [DeleteRow](../../aspose.html/htmltablesectionelement/deleterow/)(int) | Удалить строку из этого раздела. |
...
| [InsertRow](../../aspose.html/htmltablesectionelement/insertrow/)(int) | Вставьте строку в этот раздел. Новая строка вставляется сразу за перед текущей`индекс` й ряд в этом разделе. Если `индекс` равно -1 или равно количеству строк в этом разделе , добавляется новая строка. |
