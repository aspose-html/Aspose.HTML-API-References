...
description: The THEAD  TFOOT и TBODY элементы.
type: docs
weight: 3670
...
The` THEAD` ,` TFOOT` и` TBODY` элементы.
...
| Имя | Описание |
| --- | --- |
| [Align](../../aspose.html/htmltablesectionelement/align) { get; set; } | Горизонтальное выравнивание данных в ячейках. Подробности смотрите в атрибуте` align` для HTMLTheadElement. |
...
| [VAlign](../../aspose.html/htmltablesectionelement/valign) { get; set; } | Вертикальное выравнивание данных в ячейках. Подробности смотрите в атрибуте` valign` для HTMLTheadElement. |
...
| [InsertRow](../../aspose.html/htmltablesectionelement/insertrow)(int) | Вставьте строку в этот раздел. Новая строка вставляется сразу перед текущей` index` й строкой в этом разделе. Если ` index` равно -1 или равно количеству строк в этом разделе , новая строка добавлено. |
