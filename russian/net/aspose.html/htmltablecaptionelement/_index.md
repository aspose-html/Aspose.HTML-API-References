...
description: Aspose.Html.HTMLTableCaptionElement сорт. Заголовок таблицы См. определение элемента CAPTION в HTML 4.01.
type: docs
weight: 3540
url: /ru/net/aspose.html/htmltablecaptionelement/
---
## HTMLTableCaptionElement class

Заголовок таблицы См. определение элемента CAPTION в HTML 4.01.
...
| Имя | Описание |
| --- | --- |
| [Align](../../aspose.html/htmltablecaptionelement/align/) { get; set; } | Выравнивание заголовка относительно таблицы. См. определение атрибута align в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
