...
description: Параметры передаваемые в элемент OBJECT . См. определение элемента PARAM в HTML 4.01.
type: docs
weight: 3560
...
Параметры, передаваемые в элемент` OBJECT` . См. определение элемента PARAM в HTML 4.01.
...
| [Type](../../aspose.html/htmlparamelement/type) { get; set; } | Тип содержимого для атрибута , когда ` valuetype` имеет значение "ref". См. определение атрибута type в HTML 4.01. |
...
| [ValueType](../../aspose.html/htmlparamelement/valuetype) { get; set; } | Информация о значении атрибута значения. См. определение атрибута valuetype в HTML 4.01. |
