...
description: Aspose.Html.HTMLParamElement сорт. Параметры переданные вОБЪЕКТ элемент. См. определение элемента PARAM в HTML 4.01. .
type: docs
weight: 3480
url: /ru/net/aspose.html/htmlparamelement/
---
## HTMLParamElement class

Параметры, переданные в`ОБЪЕКТ` элемент. См. определение элемента PARAM в HTML 4.01. .
...
| [Name](../../aspose.html/htmlparamelement/name/) { get; set; } | Имя параметра времени выполнения. См. определение атрибута имени в HTML 4.01. . |
...
| [Type](../../aspose.html/htmlparamelement/type/) { get; set; } | Тип контента для`ценить` атрибут когда `тип значения` имеет значение «ref». См. определение атрибута типа в HTML 4.01. . |
| [Value](../../aspose.html/htmlparamelement/value/) { get; set; } | Значение параметра времени выполнения. См. определение атрибута значения в HTML 4.01. . |
| [ValueType](../../aspose.html/htmlparamelement/valuetype/) { get; set; } | Информация о значении`ценить` значение атрибута . См. определение атрибута valuetype в HTML 4.01. . |
