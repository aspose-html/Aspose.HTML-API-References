...
description: Элемент списка. См. определение элемента LI в HTML 4.01.
type: docs
weight: 3420
...
| [Value](../../aspose.html/htmllielement/value) { get; set; } | Сбросить порядковый номер при использовании в` OL` . См. определение атрибута value в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
