...
description: Aspose.Html.HTMLLIElement сорт. Элемент списка. См. определение элемента LI в HTML 4.01. .
type: docs
weight: 3340
url: /ru/net/aspose.html/htmllielement/
---
## HTMLLIElement class

Элемент списка. См. определение элемента LI в HTML 4.01. .
...
| [Type](../../aspose.html/htmllielement/type/) { get; set; } | Стиль маркера элемента списка. См. определение атрибута type в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
| [Value](../../aspose.html/htmllielement/value/) { get; set; } | Сброс порядкового номера при использовании в`ПР` . См. определение атрибута value в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
