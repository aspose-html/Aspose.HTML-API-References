...
description: Aspose.Html.HTMLHtmlElement сорт. Корень документа HTML. См. определение элемента HTML в HTML 4.01. .
type: docs
weight: 3290
url: /ru/net/aspose.html/htmlhtmlelement/
---
## HTMLHtmlElement class

Корень документа HTML. См. определение элемента HTML в HTML 4.01. .
...
| [Version](../../aspose.html/htmlhtmlelement/version/) { get; set; } | Информация о версии DTD документа. См. определение атрибута версии в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
