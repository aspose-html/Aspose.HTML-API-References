...
description: Aspose.Html.HTMLAppletElement сорт. Встроенный Javaапплет. См. определение элемента APPLET в HTML 4.01. Этот элемент устарел в HTML 4.01.
type: docs
weight: 3070
url: /ru/net/aspose.html/htmlappletelement/
---
## HTMLAppletElement class

Встроенный Java-апплет. См. определение элемента APPLET в HTML 4.01. Этот элемент устарел в HTML 4.01.
...
| Имя | Описание |
| --- | --- |
| [Align](../../aspose.html/htmlappletelement/align/) { get; set; } | Выравнивает этот объект (вертикально или горизонтально) относительно окружающего его текста . См. определение атрибута align в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
| [Alt](../../aspose.html/htmlappletelement/alt/) { get; set; } | Альтернативный текст для пользовательских агентов, не отображающих обычное содержимое этого элемента . См. определение атрибута alt в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
| [Archive](../../aspose.html/htmlappletelement/archive/) { get; set; } | Список архивов, разделенных запятыми. См. определение атрибута архива в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
...
| [Code](../../aspose.html/htmlappletelement/code/) { get; set; } | Файл класса апплета. См. определение атрибута кода в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
| [CodeBase](../../aspose.html/htmlappletelement/codebase/) { get; set; } | Необязательный базовый URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) для апплета. См. определение атрибута кодовой базы в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
...
| [Height](../../aspose.html/htmlappletelement/height/) { get; set; } | Высота переопределения. См. определение атрибута высоты в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
| [Hspace](../../aspose.html/htmlappletelement/hspace/) { get; set; } | Горизонтальное пространство в пикселях слева и справа от этого изображения, апплета или объекта. См. определение атрибута hspace в HTML 4.01. Этот атрибут устарел в HTML 4.01. @version DOM Level 2 |
...
| [Name](../../aspose.html/htmlappletelement/name/) { get; set; } | Имя апплета. См. определение атрибута имени в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
...
| [Object](../../aspose.html/htmlappletelement/object/) { get; set; } | Значение атрибута "объект". См. атрибут объекта Definition в HTML 4.01. Этот атрибут устарел в HTML 4.01. @версия Уровень DOM 2 |
...
| [Vspace](../../aspose.html/htmlappletelement/vspace/) { get; set; } | Пространство по вертикали, в пикселях, над и под этим изображением, апплетом или объектом . См. определение атрибута vspace в HTML 4.01. Этот атрибут устарел в HTML 4.01. @version DOM Level 2 |
| [Width](../../aspose.html/htmlappletelement/width/) { get; set; } | Ширина переопределения. См. определение атрибута ширины в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
