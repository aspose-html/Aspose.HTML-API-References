...
description: Встроенный Java-апплет. См. определение элемента APPLET в HTML 4.01. Этот элемент устарел в HTML 4.01.
type: docs
weight: 3150
...
| Имя | Описание |
| --- | --- |
| [Align](../../aspose.html/htmlappletelement/align) { get; set; } | Выравнивает этот объект (вертикально или горизонтально) относительно его окружающего текста. См. определение атрибута align в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
...
| [Hspace](../../aspose.html/htmlappletelement/hspace) { get; set; } | Горизонтальное пространство, в пикселях, слева и справа от этого изображения, апплет или объект. См. определение атрибута hspace в HTML 4.01. Этот атрибут устарел в HTML 4.01. @version DOM Level 2 |
...
| [Object](../../aspose.html/htmlappletelement/object) { get; set; } | Значение атрибута "объект". См. определение атрибута объекта в HTML 4.01. Этот атрибут устарел в HTML 4.01. @version DOM Level 2 |
...
| [Width](../../aspose.html/htmlappletelement/width) { get; set; } | Переопределить ширину. См. определение атрибута ширины в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
