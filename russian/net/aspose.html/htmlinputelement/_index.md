...
| Имя | Описание |
| --- | --- |
| [Accept](../../aspose.html/htmlinputelement/accept/) { get; set; } | Список типов содержимого, разделенных запятыми, которые сервер, обрабатывающий эту форму , будет правильно обрабатывать. См. определение атрибута accept в HTML 4.01. . |
| [AccessKey](../../aspose.html/htmlinputelement/accesskey/) { get; set; } | Односимвольный ключ доступа для предоставления доступа к управлению формой. См. определение атрибута доступа в HTML 4.01. |
| [Align](../../aspose.html/htmlinputelement/align/) { get; set; } | Выравнивает этот объект (вертикально или горизонтально) относительно окружающего его текста . См. определение атрибута align в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
| [Alt](../../aspose.html/htmlinputelement/alt/) { get; set; } | Альтернативный текст для пользовательских агентов, не отображающих обычное содержимое этого элемента . См. определение атрибута alt в HTML 4.01. . |
...
| [ClassName](../../aspose.html/htmlelement/classname/) { get; set; } | Атрибут класса элемента. Этот атрибут был переименован из-за конфликта с ключевым словом class во многих языках. См. определение атрибута класса в HTML 4.01. |
| [DefaultChecked](../../aspose.html/htmlinputelement/defaultchecked/) { get; set; } | Когда`тип` имеет значение «радио» или «флажок», этот представляет атрибут HTML checked элемента. Значение этого атрибута не изменяется, если изменяется состояние соответствующего элемента управления формы в интерактивном пользовательском агенте. См. определение проверенного атрибута в HTML 4.01. . |
| [DefaultValue](../../aspose.html/htmlinputelement/defaultvalue/) { get; set; } | Когда`тип`Атрибут элемента имеет значение "текст", "файл" или "пароль", это представляет значение HTML-атрибута элемента. Значение этого атрибута не изменяется , если изменяется содержимое соответствующего элемента управления формы в интерактивном пользовательском агенте . См. определение атрибута value в HTML 4.01. . |
| [Dir](../../aspose.html/htmlelement/dir/) { get; set; } | Определяет базовое направление нейтрального по направленности текста и направленность таблиц. См. определение атрибута dir в HTML 4.01. . |
| [Disabled](../../aspose.html/htmlinputelement/disabled/) { get; set; } | В этом контексте элемент управления недоступен. См. определение отключенного атрибута в HTML 4.01. . |
| [Files](../../aspose.html/htmlinputelement/files/) { get; } | IDL-атрибут files позволяет сценариям обращаться к выбранным файлам элемента. При получении, если применим IDL-атрибут, он должен возвращать объект FileList, представляющий текущие выбранные файлы. Этот же объект должен быть возвращен до тех пор, пока не изменится список выбранных файлов. Если атрибут IDL не применяется, вместо этого он должен возвращать значение null. [FILEAPI] |
...
| [Form](../../aspose.html/htmlinputelement/form/) { get; set; } | Возвращает`ФОРМА` элемент, содержащий этот элемент управления. Возвращает `нулевой` если этот элемент управления не находится в контексте формы . |
...
| [List](../../aspose.html/htmlinputelement/list/) { get; set; } | Атрибут списка используется для идентификации элемента, в котором перечислены предопределенные параметры, предлагаемые пользователю. Если он присутствует, его значение должно быть идентификатором элемента списка данных в том же документе. |
...
| [MaxLength](../../aspose.html/htmlinputelement/maxlength/) { get; set; } | Максимальное количество символов для текстовых полей, когда`тип` имеет значение «текст» или «пароль». См. определение атрибута maxlength в HTML 4.01. . |
| [Name](../../aspose.html/htmlinputelement/name/) { get; set; } | Элемент управления формой или имя объекта при отправке с формой. См. определение атрибута name в HTML 4.01. . |
...
| [ReadOnly](../../aspose.html/htmlinputelement/readonly/) { get; set; } | Этот элемент управления доступен только для чтения. Актуально только тогда, когда`тип` имеет значение "текст" или "пароль". См. определение атрибута только для чтения в HTML 4.01. . |
...
| [Size](../../aspose.html/htmlinputelement/size/) { get; set; } | Информация о размере. Точное значение зависит от каждого типа поля . См. определение атрибута размера в HTML 4.01. @version DOM Level 2 |
| [Src](../../aspose.html/htmlinputelement/src/) { get; set; } | Когда`тип`атрибут имеет значение "image", этот атрибут указывает местоположение изображения, которое будет использоваться для украшения графической кнопки отправки. См. определение атрибута src в HTML 4.01. |
...
| [TabIndex](../../aspose.html/htmlinputelement/tabindex/) { get; set; } | Индекс, представляющий позицию элемента в порядке табуляции. См. определение атрибута tabindex в HTML 4.01. |
...
| [Type](../../aspose.html/htmlinputelement/type/) { get; set; } | Тип созданного элемента управления (все в нижнем регистре). См. определение атрибута type в HTML 4.01. @версия DOM Уровень 2 |
| [UseMap](../../aspose.html/htmlinputelement/usemap/) { get; set; } | Использовать карту изображения на стороне клиента. См. определение атрибута карты использования в HTML 4.01. . |
| [Value](../../aspose.html/htmlinputelement/value/) { get; set; } | Когда`тип` Атрибут элемента имеет значение "текст", "файл" или "пароль", это представляет текущее содержимое соответствующего элемента управления формы в интерактивном пользовательском агенте. Изменение этого атрибута изменяет содержимое элемента управления формы, но не изменяет значение атрибута значения HTML элемента. Когда`тип`атрибут элемента имеет значение "кнопка", "скрытый", "отправить", "сброс", "изображение", "флажок" или "радио", это представляет атрибут значения HTML элемента. См. определение атрибута значения в HTML 4.01. |
...
| Имя | Описание |
| --- | --- |
| event [OnAbort](../../aspose.html/htmlelement/onabort/) | Получает или задает обработчик события OnAbort. |
| event [OnBlur](../../aspose.html/htmlelement/onblur/) | Получает или задает обработчик события OnBlur. |
| event [OnCancel](../../aspose.html/htmlelement/oncancel/) | Получает или задает обработчик события OnCancel. |
| event [OnCanplay](../../aspose.html/htmlelement/oncanplay/) | Получает или задает обработчик события OnCanplay. |
| event [OnCanPlayThrough](../../aspose.html/htmlelement/oncanplaythrough/) | Получает или задает обработчик события OnCanPlayThrough. |
| event [OnChange](../../aspose.html/htmlelement/onchange/) | Получает или задает обработчик события OnChange. |
| event [OnClick](../../aspose.html/htmlelement/onclick/) | Получает или задает обработчик события OnClick. |
| event [OnCueChange](../../aspose.html/htmlelement/oncuechange/) | Получает или задает обработчик события OnCueChange. |
| event [OnDblClick](../../aspose.html/htmlelement/ondblclick/) | Получает или задает обработчик события OnDblClick. |
| event [OnDurationChange](../../aspose.html/htmlelement/ondurationchange/) | Получает или задает обработчик события OnDurationChange. |
| event [OnEmptied](../../aspose.html/htmlelement/onemptied/) | Получает или задает обработчик события OnEmptied. |
| event [OnEnded](../../aspose.html/htmlelement/onended/) | Получает или задает обработчик события OnEnded. |
| event [OnError](../../aspose.html/htmlelement/onerror/) | Получает или задает обработчик события OnError. |
| event [OnFocus](../../aspose.html/htmlelement/onfocus/) | Получает или задает обработчик события OnFocus. |
| event [OnInput](../../aspose.html/htmlelement/oninput/) | Получает или задает обработчик события OnInput. |
| event [OnInvalid](../../aspose.html/htmlelement/oninvalid/) | Получает или задает обработчик события OnInvalid. |
| event [OnKeyDown](../../aspose.html/htmlelement/onkeydown/) | Получает или задает обработчик события OnKeyDown. |
| event [OnKeyPress](../../aspose.html/htmlelement/onkeypress/) | Получает или задает обработчик события OnKeyPress. |
| event [OnKeyUp](../../aspose.html/htmlelement/onkeyup/) | Получает или задает обработчик события OnKeyUp. |
| event [OnLoad](../../aspose.html/htmlelement/onload/) | Получает или задает обработчик события OnLoad. |
| event [OnLoadedData](../../aspose.html/htmlelement/onloadeddata/) | Получает или задает обработчик события OnLoadedData. |
| event [OnLoadedMetadata](../../aspose.html/htmlelement/onloadedmetadata/) | Получает или задает обработчик события OnLoadedMetadata. |
| event [OnLoadStart](../../aspose.html/htmlelement/onloadstart/) | Получает или задает обработчик события OnLoadStart. |
| event [OnMouseDown](../../aspose.html/htmlelement/onmousedown/) | Получает или задает обработчик события OnMouseDown. |
| event [OnMouseEnter](../../aspose.html/htmlelement/onmouseenter/) | Получает или задает обработчик события OnMouseEnter. |
| event [OnMouseLeave](../../aspose.html/htmlelement/onmouseleave/) | Получает или задает обработчик события OnMouseLeave. |
| event [OnMouseMove](../../aspose.html/htmlelement/onmousemove/) | Получает или задает обработчик события OnMouseMove. |
| event [OnMouseOut](../../aspose.html/htmlelement/onmouseout/) | Получает или задает обработчик события OnMouseOut. |
| event [OnMouseOver](../../aspose.html/htmlelement/onmouseover/) | Получает или задает обработчик события OnMouseOver. |
| event [OnMouseUp](../../aspose.html/htmlelement/onmouseup/) | Получает или задает обработчик события OnMouseUp. |
| event [OnMouseWheel](../../aspose.html/htmlelement/onmousewheel/) | Получает или задает обработчик события OnMouseWheel. |
| event [OnPause](../../aspose.html/htmlelement/onpause/) | Получает или задает обработчик события OnPause. |
| event [OnPlay](../../aspose.html/htmlelement/onplay/) | Получает или задает обработчик события OnPlay. |
| event [OnPlaying](../../aspose.html/htmlelement/onplaying/) | Получает или задает обработчик события OnPlaying. |
| event [OnProgress](../../aspose.html/htmlelement/onprogress/) | Получает или задает обработчик события OnProgress. |
| event [OnRateChange](../../aspose.html/htmlelement/onratechange/) | Получает или задает обработчик события OnRateChange. |
| event [OnReset](../../aspose.html/htmlelement/onreset/) | Получает или задает обработчик события OnReset. |
| event [OnResize](../../aspose.html/htmlelement/onresize/) | Получает или задает обработчик события OnResize. |
| event [OnScroll](../../aspose.html/htmlelement/onscroll/) | Получает или задает обработчик события OnScroll. |
| event [OnSeeked](../../aspose.html/htmlelement/onseeked/) | Получает или задает обработчик события OnSeeked. |
| event [OnSeeking](../../aspose.html/htmlelement/onseeking/) | Получает или задает обработчик события OnSeeking. |
| event [OnSelect](../../aspose.html/htmlelement/onselect/) | Получает или задает обработчик события OnSelect. |
| event [OnShow](../../aspose.html/htmlelement/onshow/) | Получает или задает обработчик события OnShow. |
| event [OnStalled](../../aspose.html/htmlelement/onstalled/) | Получает или задает обработчик события OnStalled. |
| event [OnSubmit](../../aspose.html/htmlelement/onsubmit/) | Получает или задает обработчик события OnSubmit. |
| event [OnSuspend](../../aspose.html/htmlelement/onsuspend/) | Получает или задает обработчик события OnSuspend. |
| event [OnTimeUpdate](../../aspose.html/htmlelement/ontimeupdate/) | Получает или задает обработчик события OnTimeUpdate. |
| event [OnToggle](../../aspose.html/htmlelement/ontoggle/) | Получает или задает обработчик события OnToggle. |
| event [OnVolumeChange](../../aspose.html/htmlelement/onvolumechange/) | Получает или задает обработчик события OnVolumeChange. |
| event [OnWaiting](../../aspose.html/htmlelement/onwaiting/) | Получает или задает обработчик события OnWaiting. |
