...
description: Уведомление об изменении части документа. См. определения элементов INS и DEL в HTML 4.01.
type: docs
weight: 3490
...
| [Cite](../../aspose.html/htmlmodelement/cite) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] обозначающий документ, описывающий причину изменения. См. определение атрибута cite в HTML 4.01. |
