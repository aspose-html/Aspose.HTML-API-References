...
description: Aspose.Html.HTMLModElement сорт. Уведомление об изменении части документа. См. определения элементов INS и DEL в HTML 4.01.
type: docs
weight: 3410
url: /ru/net/aspose.html/htmlmodelement/
---
## HTMLModElement class

Уведомление об изменении части документа. См. определения элементов INS и DEL в HTML 4.01.
...
| [Cite](../../aspose.html/htmlmodelement/cite/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] обозначение документа, описывающего причину изменения. См. определение атрибута cite в HTML 4.01. |
...
| [DateTime](../../aspose.html/htmlmodelement/datetime/) { get; set; } | Дата и время изменения. См. определение атрибута datetime в HTML 4.01. . |
