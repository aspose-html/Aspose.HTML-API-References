...
description: Aspose.Html.HTMLHeadingElement сорт. ДляH1 кH6 элементы. См. определение element H1 в HTML 4.01. .
type: docs
weight: 3280
url: /ru/net/aspose.html/htmlheadingelement/
---
## HTMLHeadingElement class

Для`H1` к`H6` элементы. См. определение element H1 в HTML 4.01. .
...
| Имя | Описание |
| --- | --- |
| [Align](../../aspose.html/htmlheadingelement/align/) { get; set; } | Горизонтальное выравнивание текста. См. определение атрибута align в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
