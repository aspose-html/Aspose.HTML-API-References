...
description: Aspose.Html.HTMLLabelElement сорт. Текст метки поля формы. См. определение элемента LABEL в HTML 4.01. .
type: docs
weight: 3350
url: /ru/net/aspose.html/htmllabelelement/
---
## HTMLLabelElement class

Текст метки поля формы. См. определение элемента LABEL в HTML 4.01. .
...
| Имя | Описание |
| --- | --- |
| [AccessKey](../../aspose.html/htmllabelelement/accesskey/) { get; set; } | Односимвольный ключ доступа для предоставления доступа к управлению формой. См. определение атрибута доступа в HTML 4.01. |
...
| [For](../../aspose.html/htmllabelelement/for/) { get; set; } | Этот атрибут связывает эту метку с другим элементом управления формы с помощью `идентификатор`атрибут. См. определение атрибута for в HTML 4.01. |
| [Form](../../aspose.html/htmllabelelement/form/) { get; } | Возвращает`ФОРМА` элемент, содержащий этот элемент управления. Возвращает `нулевой` если этот элемент управления не находится в контексте формы . |
