...
description: Aspose.Html.HTMLTextAreaElement сорт. Многострочное текстовое поле. См. определение элемента TEXTAREA в HTML 4.01. .
type: docs
weight: 3610
url: /ru/net/aspose.html/htmltextareaelement/
---
## HTMLTextAreaElement class

Многострочное текстовое поле. См. определение элемента TEXTAREA в HTML 4.01. .
...
| Имя | Описание |
| --- | --- |
| [AccessKey](../../aspose.html/htmltextareaelement/accesskey/) { get; set; } | Односимвольный ключ доступа для предоставления доступа к управлению формой. См. определение атрибута доступа в HTML 4.01. |
...
| [Cols](../../aspose.html/htmltextareaelement/cols/) { get; set; } | Ширина элемента управления (в символах). См. определение атрибута cols в HTML 4.01. . |
| [DefaultValue](../../aspose.html/htmltextareaelement/defaultvalue/) { get; set; } | Представляет содержимое элемента. Значение этого атрибута не изменяется, если изменяется содержимое соответствующего элемента управления формы в интерактивном пользовательском агенте. @version DOM Level 2 |
...
| [Disabled](../../aspose.html/htmltextareaelement/disabled/) { get; set; } | В этом контексте элемент управления недоступен. См. определение отключенного атрибута в HTML 4.01. . |
...
| [Form](../../aspose.html/htmltextareaelement/form/) { get; } | Возвращает`ФОРМА` элемент, содержащий этот элемент управления. Возвращает `нулевой` если этот элемент управления не находится в контексте формы . |
...
| [Name](../../aspose.html/htmltextareaelement/name/) { get; set; } | Элемент управления формой или имя объекта при отправке с формой. См. определение атрибута name в HTML 4.01. . |
...
| [ReadOnly](../../aspose.html/htmltextareaelement/readonly/) { get; set; } | Этот элемент управления доступен только для чтения. См. определение атрибута только для чтения в HTML 4.01. . |
| [Rows](../../aspose.html/htmltextareaelement/rows/) { get; set; } | Количество строк текста. См. определение атрибута rows в HTML 4.01. . |
...
| [TabIndex](../../aspose.html/htmltextareaelement/tabindex/) { get; set; } | Индекс, представляющий позицию элемента в порядке табуляции. См. определение атрибута tabindex в HTML 4.01. |
...
| [Type](../../aspose.html/htmltextareaelement/type/) { get; } | Тип этого элемента управления формы. Это строка "textarea". |
| [Value](../../aspose.html/htmltextareaelement/value/) { get; set; } | Представляет текущее содержимое соответствующего элемента управления формы, в интерактивный пользовательский агент. Изменение этого атрибута изменяет содержимое элемента управления формы, но не изменяет содержимое элемента . Если все данные не помещаются в один `DOMString` , реализация может обрезать данные. |
