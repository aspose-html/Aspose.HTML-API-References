...
description: Aspose.Html.HTMLParagraphElement сорт. Пункты. См. определение элемента P в HTML 4.01. .
type: docs
weight: 3470
url: /ru/net/aspose.html/htmlparagraphelement/
---
## HTMLParagraphElement class

Пункты. См. определение элемента P в HTML 4.01. .
...
| Имя | Описание |
| --- | --- |
| [Align](../../aspose.html/htmlparagraphelement/align/) { get; set; } | Горизонтальное выравнивание текста. См. определение атрибута align в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
