...
description: Aspose.Html.HTMLLegendElement сорт. Предоставляет заголовок дляПОЛЕВОЙ НАБОР группировка. См. определение элемента LEGEND в HTML 4.01. .
type: docs
weight: 3360
url: /ru/net/aspose.html/htmllegendelement/
---
## HTMLLegendElement class

Предоставляет заголовок для`ПОЛЕВОЙ НАБОР` группировка. См. определение элемента LEGEND в HTML 4.01. .
...
| Имя | Описание |
| --- | --- |
| [AccessKey](../../aspose.html/htmllegendelement/accesskey/) { get; set; } | Односимвольный ключ доступа для предоставления доступа к управлению формой. См. определение атрибута доступа в HTML 4.01. |
| [Align](../../aspose.html/htmllegendelement/align/) { get; set; } | Выравнивание текста относительно`ПОЛЕВОЙ НАБОР` . См. определение атрибута align в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
...
| [Form](../../aspose.html/htmllegendelement/form/) { get; } | Возвращает`ФОРМА` элемент, содержащий этот элемент управления. Возвращает `нулевой` если этот элемент управления не находится в контексте формы . |
