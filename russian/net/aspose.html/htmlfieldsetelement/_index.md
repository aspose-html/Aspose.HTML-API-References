...
description: Aspose.Html.HTMLFieldSetElement сорт. Организует элементы управления формы в логические группы. См. определение элемента FIELDSET в HTML 4.01. .
type: docs
weight: 3210
url: /ru/net/aspose.html/htmlfieldsetelement/
---
## HTMLFieldSetElement class

Организует элементы управления формы в логические группы. См. определение элемента FIELDSET в HTML 4.01. .
...
| [Form](../../aspose.html/htmlfieldsetelement/form/) { get; } | Возвращает`ФОРМА` элемент, содержащий этот элемент управления. Возвращает `нулевой` если этот элемент управления не находится в контексте формы . |
