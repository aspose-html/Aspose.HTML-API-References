...
description: Организует элементы управления формы в логические группы. См. определение элемента FIELDSET в HTML 4.01.
type: docs
weight: 3290
...
| [Form](../../aspose.html/htmlfieldsetelement/form) { get; } | Возвращает элемент` FORM` , содержащий этот элемент управления. Возвращает ` null` , если этот элемент управления не находится в контексте формы . |
