...
description: Тело HTML-документа. Этот элемент всегда присутствует в DOM API даже если теги отсутствуют в исходном документе. См. определение элемента BODY в HTML 4.01.
type: docs
weight: 3200
...
| [Background](../../aspose.html/htmlbodyelement/background) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] изображения фрагмента фоновой текстуры. См. определение атрибута фона в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
...
| [Link](../../aspose.html/htmlbodyelement/link) { get; set; } | Цвет неактивных и непосещенных ссылок. См. ссылку определение атрибута в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
...
| [VLink](../../aspose.html/htmlbodyelement/vlink) { get; set; } | Цвет ссылок, которые посетил пользователь. См. определение атрибута vlink в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
