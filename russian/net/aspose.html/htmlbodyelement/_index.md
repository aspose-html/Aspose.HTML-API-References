...
description: Aspose.Html.HTMLBodyElement сорт. Тело HTMLдокумента. Этот элемент всегда присутствует в DOM API даже  если теги отсутствуют в исходном документе. См. определение элемента BODY в HTML 4.01. .
type: docs
weight: 3120
url: /ru/net/aspose.html/htmlbodyelement/
---
## HTMLBodyElement class

Тело HTML-документа. Этот элемент всегда присутствует в DOM API, даже , если теги отсутствуют в исходном документе. См. определение элемента BODY в HTML 4.01. .
...
| Имя | Описание |
| --- | --- |
| [ALink](../../aspose.html/htmlbodyelement/alink/) { get; set; } | Цвет активных ссылок (после нажатия кнопки мыши, но до нажатия кнопки мыши вверх). См. определение атрибута alink в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
...
| [Background](../../aspose.html/htmlbodyelement/background/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] изображения фрагмента фоновой текстуры. См. определение фонового атрибута в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
...
| [BgColor](../../aspose.html/htmlbodyelement/bgcolor/) { get; set; } | Цвет фона документа. См. определение атрибута bgcolor в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
...
| [Link](../../aspose.html/htmlbodyelement/link/) { get; set; } | Цвет неактивных и непосещенных ссылок. См. определение атрибута ссылки в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
...
| [Text](../../aspose.html/htmlbodyelement/text/) { get; set; } | Цвет текста документа. См. определение текстового атрибута в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
...
| [VLink](../../aspose.html/htmlbodyelement/vlink/) { get; set; } | Цвет ссылок, которые посещал пользователь. См. определение атрибута vlink в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
