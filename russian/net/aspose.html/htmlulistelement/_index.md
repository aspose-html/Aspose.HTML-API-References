...
description: Aspose.Html.HTMLUListElement сорт. Ненумерованный список. См. определение элемента UL в HTML 4.01. .
type: docs
weight: 3630
url: /ru/net/aspose.html/htmlulistelement/
---
## HTMLUListElement class

Ненумерованный список. См. определение элемента UL в HTML 4.01. .
...
| [Compact](../../aspose.html/htmlulistelement/compact/) { get; set; } | Уменьшить расстояние между элементами списка. См. определение компактного атрибута в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
...
| [Type](../../aspose.html/htmlulistelement/type/) { get; set; } | Стиль пули. См. определение атрибута type в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
