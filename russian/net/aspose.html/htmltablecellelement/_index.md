...
description: Aspose.Html.HTMLTableCellElement сорт. Объект используемый для представленияTH иТД элементов. См. определение элемента TD в HTML 4.01. .
type: docs
weight: 3550
url: /ru/net/aspose.html/htmltablecellelement/
---
## HTMLTableCellElement class

Объект, используемый для представления`TH` и`ТД` элементов. См. определение элемента TD в HTML 4.01. .
...
| Имя | Описание |
| --- | --- |
| [Abbr](../../aspose.html/htmltablecellelement/abbr/) { get; set; } | Аббревиатура для ячеек заголовка. См. определение атрибута abbr в HTML 4.01. . |
| [Align](../../aspose.html/htmltablecellelement/align/) { get; set; } | Горизонтальное выравнивание данных в ячейке. См. определение атрибута align в HTML 4.01. . |
...
| [Axis](../../aspose.html/htmltablecellelement/axis/) { get; set; } | Именует группу связанных заголовков. См. определение атрибута оси в HTML 4.01. . |
...
| [BgColor](../../aspose.html/htmltablecellelement/bgcolor/) { get; set; } | Цвет фона ячейки. См. определение атрибута bgcolor в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
| [CellIndex](../../aspose.html/htmltablecellelement/cellindex/) { get; } | Индекс этой ячейки в строке, начиная с 0. Этот индекс находится в порядке дерева документа , а не в порядке отображения. |
| [Ch](../../aspose.html/htmltablecellelement/ch/) { get; set; } | Символ выравнивания для ячеек в столбце. См. определение атрибута char в HTML 4.01. . |
...
| [ChOff](../../aspose.html/htmltablecellelement/choff/) { get; set; } | Смещение символа выравнивания. См. определение атрибута charoff в HTML 4.01. . |
...
| [ColSpan](../../aspose.html/htmltablecellelement/colspan/) { get; set; } | Количество столбцов, охваченных ячейкой. См. определение атрибута colspan в HTML 4.01. . |
...
| [Headers](../../aspose.html/htmltablecellelement/headers/) { get; set; } | Список`идентификатор` значения атрибутов для ячеек заголовка. См. определение атрибута заголовков в HTML 4.01. . |
| [Height](../../aspose.html/htmltablecellelement/height/) { get; set; } | Высота ячейки. См. определение атрибута высоты в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
...
| [NoWrap](../../aspose.html/htmltablecellelement/nowrap/) { get; set; } | Подавить перенос слов. См. определение атрибута nowrap в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
...
| [RowSpan](../../aspose.html/htmltablecellelement/rowspan/) { get; set; } | Количество строк, охваченных ячейкой. См. определение атрибута rowspan в HTML 4.01. . |
| [SchemaTypeInfo](../../aspose.html.dom/element/schematypeinfo/) { get; } | Информация о типе, связанная с этим элементом. |
| [Scope](../../aspose.html/htmltablecellelement/scope/) { get; set; } | Область охвата ячеек заголовка. См. определение атрибута области действия в HTML 4.01. . |
...
| [VAlign](../../aspose.html/htmltablecellelement/valign/) { get; set; } | Вертикальное выравнивание данных в ячейке. См. определение атрибута valign в HTML 4.01. . |
| [Width](../../aspose.html/htmltablecellelement/width/) { get; set; } | Ширина ячейки. См. определение атрибута ширины в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
