...
description: Объект используемый для представления TH и TD элементы. См. определение элемента TD в HTML 4.01.
type: docs
weight: 3630
...
Объект, используемый для представления` TH` и` TD` элементы. См. определение элемента TD в HTML 4.01.
...
| [Axis](../../aspose.html/htmltablecellelement/axis) { get; set; } | Называет группу связанных заголовков. См. определение атрибута оси в HTML 4.01. |
...
| [Headers](../../aspose.html/htmltablecellelement/headers) { get; set; } | Список значений атрибута` id` для ячеек заголовков. См. определение атрибута заголовков в HTML 4.01. |
...
| [Scope](../../aspose.html/htmltablecellelement/scope) { get; set; } | Область охвата ячеек заголовка. См. определение атрибута области видимости в HTML 4.01. |
