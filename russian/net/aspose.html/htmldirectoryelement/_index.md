...
description: Aspose.Html.HTMLDirectoryElement сорт. Список каталогов. См. определение элемента DIR в HTML 4.01. Этот элемент устарел в HTML 4.01.
type: docs
weight: 3170
url: /ru/net/aspose.html/htmldirectoryelement/
---
## HTMLDirectoryElement class

Список каталогов. См. определение элемента DIR в HTML 4.01. Этот элемент устарел в HTML 4.01.
...
| [Compact](../../aspose.html/htmldirectoryelement/compact/) { get; set; } | Уменьшить расстояние между элементами списка. См. определение компактного атрибута в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
