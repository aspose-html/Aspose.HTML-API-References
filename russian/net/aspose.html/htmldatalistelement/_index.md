...
description: Aspose.Html.HTMLDataListElement сорт. Элемент datalist представляет собой набор элементов option которые представляют предопределенные опции для других элементов управления. См. такжеHTML 5.2 Рекомендация W3C .
type: docs
weight: 3160
url: /ru/net/aspose.html/htmldatalistelement/
---
## HTMLDataListElement class

Элемент datalist представляет собой набор элементов option, которые представляют предопределенные опции для других элементов управления. См. также[HTML 5.2 Рекомендация W3C](https://www.w3.org/TR/html52/sec-forms.html#elementdef-datalist) .
...
| [Options](../../aspose.html/htmldatalistelement/options/) { get; } | Коллекция`ВАРИАНТ`элементы, содержащиеся в этом элементе . |
