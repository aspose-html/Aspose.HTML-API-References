...
description: Элемент datalist представляет собой набор элементов option которые представляют предопределенные опции для других элементов управления. См. такжеHTML 5.2 Рекомендация W3Chttps//www.w3.org/TR/html52/sec-forms.htmlelementdef-datalist .
type: docs
weight: 3240
...
| [Options](../../aspose.html/htmldatalistelement/options) { get; } | Набор элементов` OPTION` , содержащихся в этом элементе. |
