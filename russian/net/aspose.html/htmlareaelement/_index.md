...
description: Aspose.Html.HTMLAreaElement сорт. Определение области карты изображения на стороне клиента. См. определение элемента AREA в HTML 4.01. .
type: docs
weight: 3080
url: /ru/net/aspose.html/htmlareaelement/
---
## HTMLAreaElement class

Определение области карты изображения на стороне клиента. См. определение элемента AREA в HTML 4.01. .
...
| Имя | Описание |
| --- | --- |
| [AccessKey](../../aspose.html/htmlareaelement/accesskey/) { get; set; } | Односимвольный ключ доступа для предоставления доступа к управлению формой. См. определение атрибута доступа в HTML 4.01. |
| [Alt](../../aspose.html/htmlareaelement/alt/) { get; set; } | Альтернативный текст для пользовательских агентов, не отображающих обычное содержимое этого элемента . См. определение атрибута alt в HTML 4.01. . |
...
| [Coords](../../aspose.html/htmlareaelement/coords/) { get; set; } | Список длин, разделенных запятыми, определяющий геометрию активной области. См. также`форма` для формы области. См. определение атрибута coords в HTML 4.01. . |
...
| [Href](../../aspose.html/htmlareaelement/href/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] связанного ресурса. См. определение атрибута href в HTML 4.01. |
...
| [NoHref](../../aspose.html/htmlareaelement/nohref/) { get; set; } | Указывает, что эта область неактивна, т. е. не имеет связанного с ней действия. См. определение атрибута nohref в HTML 4.01. |
...
| [RelList](../../aspose.html/htmlareaelement/rellist/) { get; } | Возвращает активный DOMTokenList, содержащий токены, полученные в результате анализа атрибута "rel". |
...
| [Shape](../../aspose.html/htmlareaelement/shape/) { get; set; } | Форма активной области. Координаты даны `координаты` . См. определение атрибута формы в HTML 4.01. . |
...
| [TabIndex](../../aspose.html/htmlareaelement/tabindex/) { get; set; } | Индекс, представляющий позицию элемента в порядке табуляции. См. определение атрибута tabindex в HTML 4.01. |
| [TagName](../../aspose.html.dom/element/tagname/) { get; } | Имя элемента. |
| [Target](../../aspose.html/htmlareaelement/target/) { get; set; } | Кадр для рендеринга ресурса. См. определение целевого атрибута в HTML 4.01. |
