...
description: Aspose.Html.HTMLElement сорт. Все интерфейсы элементов HTML являются производными от этого класса. Элементы которые только раскрывают основные атрибуты HTML представлены базой HTMLЭлементинтерфейс. Эти элементы следующие специальный SUB SUP SPAN BDO шрифт TT I B U S STRIKE BIG SMALL фраза EM STRONG DFN CODE SAMP KBD VAR CITE ACRONYM ABBRlist DD DTNOFRAMES NOSCRIPTADDRESS CENTERTheстиль атрибут элемента HTML доступен через ЭлементCSSInlineStyle интерфейс который определен в модуле CSS Таблицы стилей DOM Level 2 и CSS .
type: docs
weight: 3200
url: /ru/net/aspose.html/htmlelement/
---
## HTMLElement class

Все интерфейсы элементов HTML являются производными от этого класса. Элементы, которые только раскрывают основные атрибуты HTML, представлены базой `HTMLЭлемент`интерфейс. Эти элементы следующие: специальный: SUB, SUP, SPAN, BDO, шрифт: TT, I, B, U, S, STRIKE, BIG, SMALL фраза: EM, STRONG, DFN, CODE, SAMP, KBD, VAR, CITE, ACRONYM, ABBRlist: DD, DTNOFRAMES, NOSCRIPTADDRESS, CENTERThe`стиль` атрибут элемента HTML доступен через `ЭлементCSSInlineStyle` интерфейс, который определен в модуле CSS [[Таблицы стилей DOM Level 2 и CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113) ].
