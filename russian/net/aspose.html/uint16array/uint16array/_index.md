...
description: Uint16Array строитель. Инициализирует новый экземплярUint16Array класс.
type: docs
weight: 10
...
Инициализирует новый экземпляр[`Uint16Array`](../) класс.
...
| --- | --- | --- |
| buffer | ArrayBuffer | Буфер данных. |
| byteOffset | Int32 | Байтовое смещение. |
