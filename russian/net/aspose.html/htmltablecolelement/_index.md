...
description: Aspose.Html.HTMLTableColElement сорт. ПерегруппируетЦВЕТ иКОЛГРУПП элементы. См. определение элемента COL в HTML 4.01. .
type: docs
weight: 3560
url: /ru/net/aspose.html/htmltablecolelement/
---
## HTMLTableColElement class

Перегруппирует`ЦВЕТ` и`КОЛГРУПП` элементы. См. определение элемента COL в HTML 4.01. .
...
| Имя | Описание |
| --- | --- |
| [Align](../../aspose.html/htmltablecolelement/align/) { get; set; } | Горизонтальное выравнивание данных ячейки в столбце. См. определение атрибута align в HTML 4.01. . |
...
| [Ch](../../aspose.html/htmltablecolelement/ch/) { get; set; } | Символ выравнивания для ячеек в столбце. См. определение атрибута char в HTML 4.01. . |
...
| [ChOff](../../aspose.html/htmltablecolelement/choff/) { get; set; } | Смещение символа выравнивания. См. определение атрибута charoff в HTML 4.01. . |
...
| [Span](../../aspose.html/htmltablecolelement/span/) { get; set; } | Указывает количество столбцов в группе или затронутых группировкой. См. определение атрибута span в HTML 4.01. |
...
| [VAlign](../../aspose.html/htmltablecolelement/valign/) { get; set; } | Вертикальное выравнивание данных ячеек в столбце. См. определение атрибута valign в HTML 4.01. . |
| [Width](../../aspose.html/htmltablecolelement/width/) { get; set; } | Ширина столбца по умолчанию. См. определение атрибута ширины в HTML 4.01. . |
