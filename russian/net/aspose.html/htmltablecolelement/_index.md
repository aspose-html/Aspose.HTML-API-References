...
description: Перегруппировывает COL и COLGROUP элементов. См. определение элемента COL в HTML 4.01.
type: docs
weight: 3640
...
Перегруппировывает` COL` и` COLGROUP` элементов. См. определение элемента COL в HTML 4.01.
...
| Имя | Описание |
| --- | --- |
| [Align](../../aspose.html/htmltablecolelement/align) { get; set; } | Горизонтальное выравнивание данных ячеек в столбце. См. определение атрибута align в HTML 4.01. |
...
| [VAlign](../../aspose.html/htmltablecolelement/valign) { get; set; } | Вертикальное выравнивание данных ячейки в столбце. См. определение атрибута valign в HTML 4.01. |
