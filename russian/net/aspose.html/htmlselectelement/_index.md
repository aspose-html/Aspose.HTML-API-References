...
description: Aspose.Html.HTMLSelectElement сорт. Элемент select позволяет выбрать опцию. Доступ к содержащимся опциям можно получить напрямую через элемент select в виде коллекции. См. определение элемента SELECT в HTML 4.01.
type: docs
weight: 3520
url: /ru/net/aspose.html/htmlselectelement/
---
## HTMLSelectElement class

Элемент select позволяет выбрать опцию. Доступ к содержащимся опциям можно получить напрямую через элемент select в виде коллекции. См. определение элемента SELECT в HTML 4.01.
...
| [Disabled](../../aspose.html/htmlselectelement/disabled/) { get; set; } | В этом контексте элемент управления недоступен. См. определение отключенного атрибута в HTML 4.01. . |
...
| [Form](../../aspose.html/htmlselectelement/form/) { get; } | Количество опций в этом`ВЫБИРАТЬ` . |
...
| [Length](../../aspose.html/htmlselectelement/length/) { get; set; } | Количество опций в этом`ВЫБИРАТЬ` . @версия Уровень DOM 2 |
...
| [Multiple](../../aspose.html/htmlselectelement/multiple/) { get; set; } | Если правда, несколько`ВАРИАНТ` элементы могут быть выбраны в этом`ВЫБИРАТЬ` . См. определение нескольких атрибутов в HTML 4.01. . |
| [Name](../../aspose.html/htmlselectelement/name/) { get; set; } | Элемент управления формой или имя объекта при отправке с формой. См. определение атрибута name в HTML 4.01. . |
...
| [Options](../../aspose.html/htmlselectelement/options/) { get; } | Коллекция`ВАРИАНТ` элементы, содержащиеся в этом элементе . @версия Уровень DOM 2 |
...
| [SelectedIndex](../../aspose.html/htmlselectelement/selectedindex/) { get; set; } | Порядковый индекс выбранной опции, начиная с 0. Значение -1 возвращается, если ни один элемент не выбран. Если выбрано несколько параметров , возвращается индекс первого выбранного параметра. |
...
| [Size](../../aspose.html/htmlselectelement/size/) { get; set; } | Количество видимых строк. См. определение атрибута размера в HTML 4.01. . |
...
| [TabIndex](../../aspose.html/htmlselectelement/tabindex/) { get; set; } | Индекс, представляющий позицию элемента в порядке табуляции. См. определение атрибута tabindex в HTML 4.01. |
...
| [Type](../../aspose.html/htmlselectelement/type/) { get; } | Тип этого элемента управления формы. Это строка "select-multiple", когда множественный атрибут`истинный` и строка "выберите один", когда`ЛОЖЬ` . |
| [Value](../../aspose.html/htmlselectelement/value/) { get; set; } | Текущее значение элемента управления формой (т. е. значение текущей выбранной опции ), если выбрано несколько опций, это значение первой выбранной опции. |
