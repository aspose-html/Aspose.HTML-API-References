...
description: Элемент select позволяет выбрать опцию. Доступ к содержащимся опциям можно получить напрямую через элемент select как коллекцию. См. определение элемента SELECT в HTML 4.01.
type: docs
weight: 3600
...
Элемент select позволяет выбрать опцию. Доступ к содержащимся опциям можно получить напрямую через элемент select как коллекцию. См. определение элемента SELECT в HTML 4.01.
...
| [Disabled](../../aspose.html/htmlselectelement/disabled) { get; set; } | В этом контексте элемент управления недоступен. См. определение атрибута disabled в HTML 4.01. |
...
| [Form](../../aspose.html/htmlselectelement/form) { get; } | Количество опций в этом` SELECT` . |
...
| [Length](../../aspose.html/htmlselectelement/length) { get; set; } | Количество опций в этом` SELECT` . @version DOM Level 2 |
...
| [Multiple](../../aspose.html/htmlselectelement/multiple) { get; set; } | Если true, несколько элементов` ОПЦИЯ` могут быть выбраны в этом` ВЫБРАТЬ` . См. определение нескольких атрибутов в HTML 4.01. |
| [Name](../../aspose.html/htmlselectelement/name) { get; set; } | Управление формой или имя объекта при отправке с формой. См. определение атрибута name в HTML 4.01. |
...
| [Options](../../aspose.html/htmlselectelement/options) { get; } | Набор элементов` OPTION` , содержащихся в этом элементе. @version DOM Level 2 |
...
| [SelectedIndex](../../aspose.html/htmlselectelement/selectedindex) { get; set; } | Порядковый индекс выбранной опции, начиная с 0. Значение -1 возвращается, если ни один элемент не выбран. Если выбрано несколько опций , возвращается индекс первой выбранной опции. |
...
| [Type](../../aspose.html/htmlselectelement/type) { get; } | Тип этого элемента управления формы. Это строка "select-multiple", когда множественный атрибут имеет значение` true` , и строка "select-one", когда` false` . |
| [Value](../../aspose.html/htmlselectelement/value) { get; set; } | Текущее значение элемента управления формы (т. е. значение текущей выбранной опции), если выбрано несколько опций, это значение первого выбранного варианта. |
