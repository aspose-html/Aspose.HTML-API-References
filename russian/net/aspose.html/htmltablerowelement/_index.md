...
description: Aspose.Html.HTMLTableRowElement сорт. Строка в таблице. См. определение элемента TR в HTML 4.01. .
type: docs
weight: 3580
url: /ru/net/aspose.html/htmltablerowelement/
---
## HTMLTableRowElement class

Строка в таблице. См. определение элемента TR в HTML 4.01. .
...
| Имя | Описание |
| --- | --- |
| [Align](../../aspose.html/htmltablerowelement/align/) { get; set; } | Горизонтальное выравнивание данных внутри ячеек этой строки. См. определение атрибута align в HTML 4.01. . |
...
| [BgColor](../../aspose.html/htmltablerowelement/bgcolor/) { get; set; } | Цвет фона для строк. См. определение атрибута bgcolor в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
| [Cells](../../aspose.html/htmltablerowelement/cells/) { get; } | Набор ячеек в этой строке. @версия Уровень DOM 2 |
| [Ch](../../aspose.html/htmltablerowelement/ch/) { get; set; } | Символ выравнивания для ячеек в столбце. См. определение атрибута char в HTML 4.01. . |
...
| [ChOff](../../aspose.html/htmltablerowelement/choff/) { get; set; } | Смещение символа выравнивания. См. определение атрибута charoff в HTML 4.01. . |
...
| [RowIndex](../../aspose.html/htmltablerowelement/rowindex/) { get; } | Это в логическом порядке, а не в порядке документа. `индекс строки` учитывает разделы ( `ГОЛОВА` ,`ТФУТ` , или`TBODY` ) в пределах таблицы, размещая`ГОЛОВА` сначала строки в индексе, , за которыми следует`TBODY` ряды, а затем`ТФУТ` rows. @версия уровня DOM 2 |
| [SchemaTypeInfo](../../aspose.html.dom/element/schematypeinfo/) { get; } | Информация о типе, связанная с этим элементом. |
| [SectionRowIndex](../../aspose.html/htmltablerowelement/sectionrowindex/) { get; } | Индекс этой строки относительно текущего раздела ( `ГОЛОВА` ,`ТФУТ` , или`TBODY` ), начиная с 0. @версия уровня DOM 2 |
...
| [VAlign](../../aspose.html/htmltablerowelement/valign/) { get; set; } | Вертикальное выравнивание данных в ячейках этой строки. См. определение атрибута valign в HTML 4.01. . |
...
| [DeleteCell](../../aspose.html/htmltablerowelement/deletecell/)(int) | Удалить ячейку из текущей строки. |
...
| [InsertCell](../../aspose.html/htmltablerowelement/insertcell/)(int) | Вставить пустой`ТД` ячейку в эту строку. Если `индекс` равно -1 или равно количеству ячеек, добавляется новая ячейка . |
