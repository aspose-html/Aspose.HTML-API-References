...
description: Aspose.Html.HTMLObjectElement сорт. Универсальный встроенный объект. В принципе все свойства элемента объекта доступны для чтения и записи но в некоторых средах некоторые свойства могут быть доступны только для чтения после создания экземпляра базового объекта. См. определение элемента OBJECT в HTML 4.01 .
type: docs
weight: 3440
...
Универсальный встроенный объект. В принципе, все свойства элемента объекта доступны для чтения и записи, но в некоторых средах некоторые свойства могут быть доступны только для чтения после создания экземпляра базового объекта. См. определение элемента OBJECT в [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224) ].
...
| [ClassId](../../aspose.html/htmlobjectelement/classid/) { get; set; } | Определяет значение идентификатора класса, установленное в реестре Windows или URL |
...
| [Code](../../aspose.html/htmlobjectelement/code/) { get; set; } | Файл класса апплета. См.`код` атрибут для HTMLAppletElement. |
| [CodeBase](../../aspose.html/htmlobjectelement/codebase/) { get; set; } | Базовый URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] для`ID класса` ,`данные` и `архив` атрибуты. См. определение атрибута codebase в HTML 4.01. . |
| [CodeType](../../aspose.html/htmlobjectelement/codetype/) { get; set; } | Тип содержимого для данных, загружаемых через`ID класса` атрибут. См. определение атрибута codetype в HTML 4.01. |
| [Data](../../aspose.html/htmlobjectelement/data/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] указание местоположения данных объекта. См. определение атрибута data в HTML 4.01. . |
| [Declare](../../aspose.html/htmlobjectelement/declare/) { get; set; } | Объявить (для дальнейшего использования), но не создавать экземпляр этого объекта. См. определение атрибута объявления в HTML 4.01. |
...
| [Form](../../aspose.html/htmlobjectelement/form/) { get; set; } | Возвращает`ФОРМА` элемент, содержащий этот элемент управления. Возвращает`нулевой` если этот элемент управления не находится в контексте формы. |
| [Height](../../aspose.html/htmlobjectelement/height/) { get; set; } | Высота переопределения. См. определение атрибута высоты в HTML 4.01. . |
| [Hspace](../../aspose.html/htmlobjectelement/hspace/) { get; set; } | Горизонтальное пространство в пикселях слева и справа от этого изображения, апплета или объекта. См. определение атрибута hspace в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
...
| [Name](../../aspose.html/htmlobjectelement/name/) { get; set; } | Элемент управления формой или имя объекта при отправке с формой. См. определение атрибута name в HTML 4.01. . |
...
| [Standby](../../aspose.html/htmlobjectelement/standby/) { get; set; } | Сообщение для рендеринга при загрузке объекта. См. определение резервного атрибута в HTML 4.01. . |
...
| [Type](../../aspose.html/htmlobjectelement/type/) { get; set; } | Тип содержимого для данных, загружаемых через`данные` атрибут. См. определение атрибута типа в HTML 4.01. |
| [UseMap](../../aspose.html/htmlobjectelement/usemap/) { get; set; } | Использовать карту изображения на стороне клиента. См. определение атрибута карты использования в HTML 4.01. . |
...
| [Width](../../aspose.html/htmlobjectelement/width/) { get; set; } | Ширина переопределения. См. определение атрибута ширины в HTML 4.01. . |
