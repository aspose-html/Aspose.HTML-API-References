...
description: Aspose.Html.HTMLAnchorElement сорт. Элемент привязки. См. определение элемента A в HTML 4.01. .
type: docs
weight: 3060
url: /ru/net/aspose.html/htmlanchorelement/
---
## HTMLAnchorElement class

Элемент привязки. См. определение элемента A в HTML 4.01. .
...
| Имя | Описание |
| --- | --- |
| [AccessKey](../../aspose.html/htmlanchorelement/accesskey/) { get; set; } | Односимвольный ключ доступа для предоставления доступа к управлению формой. См. определение атрибута доступа в HTML 4.01. |
...
| [Charset](../../aspose.html/htmlanchorelement/charset/) { get; set; } | Кодировка символов связанного ресурса. См. определение атрибута charset в HTML 4.01. . |
...
| [Coords](../../aspose.html/htmlanchorelement/coords/) { get; set; } | Список длин, разделенных запятыми, определяющий геометрию активной области. См. также`форма` для формы области. См. определение атрибута координат в HTML 4.01. . |
...
| [Hash](../../aspose.html/htmlanchorelement/hash/) { get; set; } | Получает или задает строковое представление хеш-сегмента связанного URL-адреса. |
| [Host](../../aspose.html/htmlanchorelement/host/) { get; set; } | Получает или задает строковое представление сегментов узла и порта связанного URL-адреса. |
| [Hostname](../../aspose.html/htmlanchorelement/hostname/) { get; set; } | Получает или задает строковое представление сегмента хоста связанного URL-адреса. |
| [Href](../../aspose.html/htmlanchorelement/href/) { get; set; } | Абсолютный URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) связанного ресурса. См. определение атрибута href в HTML 4.01. . |
| [Hreflang](../../aspose.html/htmlanchorelement/hreflang/) { get; set; } | Код языка связанного ресурса. См. определение атрибута hreflang в HTML 4.01. . |
...
| [Name](../../aspose.html/htmlanchorelement/name/) { get; set; } | Имя привязки. См. определение атрибута имени в HTML 4.01. . |
...
| [Origin](../../aspose.html/htmlanchorelement/origin/) { get; } | Получает строковое представление исходного сегмента связанного URL-адреса. |
...
| [Password](../../aspose.html/htmlanchorelement/password/) { get; set; } | Получает или задает строковое представление сегмента пароля связанного URL-адреса. |
| [Pathname](../../aspose.html/htmlanchorelement/pathname/) { get; set; } | Получает или задает строковое представление сегмента пути связанного URL-адреса. |
| [Port](../../aspose.html/htmlanchorelement/port/) { get; set; } | Получает или задает строковое представление сегмента порта связанного URL-адреса. |
...
| [Protocol](../../aspose.html/htmlanchorelement/protocol/) { get; set; } | Получает или задает строковое представление сегмента схемы связанного URL-адреса. |
| [Rel](../../aspose.html/htmlanchorelement/rel/) { get; set; } | Тип прямой ссылки. См. определение атрибута rel в HTML 4.01. . |
| [RelList](../../aspose.html/htmlanchorelement/rellist/) { get; } | Возвращает активный DOMTokenList, содержащий токены, полученные в результате анализа атрибута "rel". |
| [Rev](../../aspose.html/htmlanchorelement/rev/) { get; set; } | Тип обратной ссылки. См. определение атрибута rev в HTML 4.01. . |
| [SchemaTypeInfo](../../aspose.html.dom/element/schematypeinfo/) { get; } | Информация о типе, связанная с этим элементом. |
| [Search](../../aspose.html/htmlanchorelement/search/) { get; set; } | Получает или задает строковое представление сегмента поиска связанного URL-адреса. |
...
| [Shape](../../aspose.html/htmlanchorelement/shape/) { get; set; } | Форма активной области. Координаты даны `координаты` . См. определение атрибута формы в HTML 4.01. . |
...
| [TabIndex](../../aspose.html/htmlanchorelement/tabindex/) { get; set; } | Индекс, представляющий позицию элемента в порядке табуляции. См. определение атрибута tabindex в HTML 4.01. |
| [TagName](../../aspose.html.dom/element/tagname/) { get; } | Имя элемента. |
| [Target](../../aspose.html/htmlanchorelement/target/) { get; set; } | Кадр для рендеринга ресурса. См. определение целевого атрибута в HTML 4.01. |
...
| [Type](../../aspose.html/htmlanchorelement/type/) { get; set; } | Тип содержимого рекомендаций. См. определение атрибута типа в HTML 4.01. . |
| [Username](../../aspose.html/htmlanchorelement/username/) { get; set; } | Получает или задает строковое представление сегмента имени пользователя связанного URL-адреса. |
...
| [Blur](../../aspose.html/htmlanchorelement/blur/)() | Убирает фокус клавиатуры с этого элемента. |
...
| [Focus](../../aspose.html/htmlanchorelement/focus/)() | Дает фокус клавиатуры этому элементу. |
