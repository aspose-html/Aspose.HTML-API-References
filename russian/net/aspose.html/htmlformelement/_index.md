...
description: Aspose.Html.HTMLFormElement сорт. ФОРМА element включает в себя поведение аналогичное коллекции и элементу. Он обеспечивает прямой доступ к содержащимся элементам управления формы  а также к атрибутам элемента формы. См. определение элемента FORM в HTML 4.01. .
type: docs
weight: 3230
url: /ru/net/aspose.html/htmlformelement/
---
## HTMLFormElement class

`ФОРМА` element включает в себя поведение, аналогичное коллекции и элементу. Он обеспечивает прямой доступ к содержащимся элементам управления формы , а также к атрибутам элемента формы. См. определение элемента FORM в HTML 4.01. .
...
| Имя | Описание |
| --- | --- |
| [AcceptCharset](../../aspose.html/htmlformelement/acceptcharset/) { get; set; } | Список наборов символов, поддерживаемых сервером. См. определение атрибута accept-charset в HTML 4.01. . |
| [Action](../../aspose.html/htmlformelement/action/) { get; set; } | Обработчик форм на стороне сервера. См. определение атрибута действия в HTML 4.01. . |
...
| [Elements](../../aspose.html/htmlformelement/elements/) { get; } | Возвращает коллекцию всех элементов управления формой в форме. |
| [Enctype](../../aspose.html/htmlformelement/enctype/) { get; set; } | Тип содержимого отправленной формы, обычно "application/x-www-form-urlencoded". См. определение атрибута enctype в HTML 4.01. Обработчик onsubmit даже не гарантирует, что будет запущен при вызове этого метода. Поведение непоследовательно по историческим причинам, и авторам не следует полагаться на конкретное . |
...
| [Length](../../aspose.html/htmlformelement/length/) { get; } | Количество элементов управления формы в форме. |
...
| [Method](../../aspose.html/htmlformelement/method/) { get; set; } | HTTP-метод [[IETF RFC 2616](http://www.ietf.org/rfc/rfc2616.txt) используется для отправки формы. См. определение атрибута метода в HTML 4.01. . |
| [Name](../../aspose.html/htmlformelement/name/) { get; set; } | Называет форму. |
...
| [Target](../../aspose.html/htmlformelement/target/) { get; set; } | Кадр для рендеринга ресурса. См. определение целевого атрибута в HTML 4.01. |
...
| [Reset](../../aspose.html/htmlformelement/reset/)() | Восстанавливает значения по умолчанию элемента формы. Она выполняет то же действие , что и кнопка сброса. |
...
| [Submit](../../aspose.html/htmlformelement/submit/)() | Отправляет форму. Она выполняет то же действие, что и кнопка отправки. |
