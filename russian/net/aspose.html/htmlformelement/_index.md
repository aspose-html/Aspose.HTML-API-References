...
description: Элемент FORM включает в себя поведение аналогичное коллекции и элементу . Он обеспечивает прямой доступ к содержащимся элементам управления формы  а также к атрибутам элемента формы. См. определение элемента FORM в HTML 4.01.
type: docs
weight: 3310
...
Элемент` FORM` включает в себя поведение, аналогичное коллекции и элементу . Он обеспечивает прямой доступ к содержащимся элементам управления формы , а также к атрибутам элемента формы. См. определение элемента FORM в HTML 4.01.
...
| [Action](../../aspose.html/htmlformelement/action) { get; set; } | Серверный обработчик форм. См. определение атрибута действия в HTML 4.01. |
...
| [Length](../../aspose.html/htmlformelement/length) { get; } | Количество элементов управления в форме. |
...
| [Method](../../aspose.html/htmlformelement/method) { get; set; } | Метод HTTP [[IETF RFC 2616](http://www.ietf.org/rfc/rfc2616.txt) ] используется для отправки формы. См. определение атрибута метода в HTML 4.01. |
...
| [Target](../../aspose.html/htmlformelement/target) { get; set; } | Кадр для отображения ресурса. См. определение целевого атрибута в HTML 4.01. |
...
| [Reset](../../aspose.html/htmlformelement/reset)() | Восстанавливает значения элемента формы по умолчанию. Она выполняет то же действие , что и кнопка сброса. |
