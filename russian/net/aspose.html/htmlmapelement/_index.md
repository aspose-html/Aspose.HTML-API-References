...
description: Карта изображения на стороне клиента. См. определение элемента MAP в HTML 4.01.
type: docs
weight: 3460
...
| Имя | Описание |
| --- | --- |
| [Areas](../../aspose.html/htmlmapelement/areas) { get; } | Список областей, определенных для карты изображений. |
...
| [Name](../../aspose.html/htmlmapelement/name) { get; set; } | Называет карту (для использования с` usemap` ). См. определение атрибута name в HTML 4.01. |
