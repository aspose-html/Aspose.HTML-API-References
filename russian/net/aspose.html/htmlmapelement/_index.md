...
description: Aspose.Html.HTMLMapElement сорт. Карта изображения на стороне клиента. См. определение элемента MAP в HTML 4.01. .
type: docs
weight: 3380
url: /ru/net/aspose.html/htmlmapelement/
---
## HTMLMapElement class

Карта изображения на стороне клиента. См. определение элемента MAP в HTML 4.01. .
...
| Имя | Описание |
| --- | --- |
| [Areas](../../aspose.html/htmlmapelement/areas/) { get; } | Список областей, определенных для карты изображения. |
...
| [Name](../../aspose.html/htmlmapelement/name/) { get; set; } | Именует карту (для использования с`карта использования` ). См. определение атрибута name в HTML 4.01. . |
