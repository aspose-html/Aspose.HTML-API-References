...
description: Aspose.Html.HTMLBaseFontElement сорт. Базовый шрифт. См. определение элемента BASEFONT в HTML 4.01. Этот элемент устарел в HTML 4.01.
type: docs
weight: 3110
url: /ru/net/aspose.html/htmlbasefontelement/
---
## HTMLBaseFontElement class

Базовый шрифт. См. определение элемента BASEFONT в HTML 4.01. Этот элемент устарел в HTML 4.01.
...
| [Color](../../aspose.html/htmlbasefontelement/color/) { get; set; } | Цвет шрифта. См. определение атрибута цвета в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
...
| [Face](../../aspose.html/htmlbasefontelement/face/) { get; set; } | Идентификатор начертания шрифта. См. определение атрибута лица в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
...
| [Size](../../aspose.html/htmlbasefontelement/size/) { get; set; } | Вычисленный размер шрифта. См. определение атрибута размера в HTML 4.01. Этот атрибут устарел в HTML 4.01. @version DOM Level 2 |
