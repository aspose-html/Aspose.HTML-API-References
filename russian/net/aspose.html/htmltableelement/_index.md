...
description: Методы create и delete таблицы позволяют авторам создавать и изменять таблицы. HTML 4.01http//www.w3.org/TR/1999/REC-html401-19991224  указывает что только один из каждого из  CAPTION  THEAD и TFOOT элементов может существовать в таблице. Следовательно если он существует и вызывается метод createTHead или createTFoot метод возвращает существующий элемент THead или TFoot. См. определение элемента TABLE в HTML 4.01.
type: docs
weight: 3650
...
Методы create* и delete* таблицы позволяют авторам создавать и изменять таблицы. [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224) ] указывает, что только один из каждого из ` CAPTION` ,` THEAD` и` TFOOT` элементов может существовать в таблице. Следовательно, если он существует и вызывается метод createTHead() или createTFoot(), метод возвращает существующий элемент THead или TFoot. См. определение элемента TABLE в HTML 4.01.
...
| Имя | Описание |
| --- | --- |
| [Align](../../aspose.html/htmltableelement/align) { get; set; } | Определяет положение таблицы относительно остальной части документа . См. определение атрибута align в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
...
| [Caption](../../aspose.html/htmltableelement/caption) { get; } | Возвращает заголовок таблицы` CAPTION` или void, если он не существует. @version DOM Level 2 |
| [CellPadding](../../aspose.html/htmltableelement/cellpadding) { get; set; } | Задает расстояние по горизонтали и вертикали между содержимым ячейки и границами ячейки . См. определение атрибута cellpadding в HTML 4.01. |
| [CellSpacing](../../aspose.html/htmltableelement/cellspacing) { get; set; } | Задает горизонтальное и вертикальное разделение между ячейками. См. определение атрибута Cellspacing в HTML 4.01. |
...
| [Frame](../../aspose.html/htmltableelement/frame) { get; set; } | Указывает, какие внешние границы таблицы отображать. См. определение атрибута frame в HTML 4.01. |
...
| [Rows](../../aspose.html/htmltableelement/rows) { get; } | Возвращает таблицу` TFOOT` или` null` если нет существует. |
| [Rules](../../aspose.html/htmltableelement/rules) { get; set; } | Указывает, какие внутренние границы таблицы отображать. См. правила определения атрибута в HTML 4.01. |
...
| [Summary](../../aspose.html/htmltableelement/summary) { get; set; } | Описание назначения или структуры таблицы. См. сводку определение атрибута в HTML 4.01. |
| [TagName](../../aspose.html.dom/element/tagname) { get; } | Имя элемента. |
| [TBodies](../../aspose.html/htmltableelement/tbodies) { get; } | Возвращает набор тел таблиц (включая неявные). |
...
| [TFoot](../../aspose.html/htmltableelement/tfoot) { get; } | Возвращает таблицу` THEAD` или` null` если нет существует. |
| [THead](../../aspose.html/htmltableelement/thead) { get; } | Возвращает заголовок таблицы` CAPTION` или void, если он не существует. |
