...
| Имя | Описание |
| --- | --- |
| [Align](../../aspose.html/htmltableelement/align/) { get; set; } | Определяет позицию таблицы по отношению к остальной части документа . См. определение атрибута align в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
...
| [BgColor](../../aspose.html/htmltableelement/bgcolor/) { get; set; } | Цвет фона ячейки. См. определение атрибута bgcolor в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
| [Border](../../aspose.html/htmltableelement/border/) { get; set; } | Ширина границы вокруг таблицы. См. определение атрибута границы в HTML 4.01. . |
| [Caption](../../aspose.html/htmltableelement/caption/) { get; } | Возвращает таблицу`ПОДПИСЬ` или void, если его не существует. @версия Уровень DOM 2 |
| [CellPadding](../../aspose.html/htmltableelement/cellpadding/) { get; set; } | Определяет расстояние по горизонтали и вертикали между содержимым ячейки и границами ячейки . См. определение атрибута cellpadding в HTML 4.01. . |
| [CellSpacing](../../aspose.html/htmltableelement/cellspacing/) { get; set; } | Задает горизонтальное и вертикальное разделение ячеек. См. определение атрибута cellpacing в HTML 4.01. . |
...
| [Frame](../../aspose.html/htmltableelement/frame/) { get; set; } | Указывает, какие внешние границы таблицы отображать. См. определение атрибута фрейма в HTML 4.01. . |
...
| [Rows](../../aspose.html/htmltableelement/rows/) { get; } | Возвращает таблицу`ТФУТ` , или`нулевой` если не существует. |
| [Rules](../../aspose.html/htmltableelement/rules/) { get; set; } | Указывает, какие внутренние границы таблицы отображать. См. определение атрибута rules в HTML 4.01. . |
...
| [Summary](../../aspose.html/htmltableelement/summary/) { get; set; } | Описание назначения или структуры таблицы. См. сводное определение атрибута в HTML 4.01. . |
| [TagName](../../aspose.html.dom/element/tagname/) { get; } | Имя элемента. |
| [TBodies](../../aspose.html/htmltableelement/tbodies/) { get; } | Возвращает коллекцию тел таблиц (включая неявные). |
...
| [TFoot](../../aspose.html/htmltableelement/tfoot/) { get; } | Возвращает таблицу`ГОЛОВА` , или`нулевой` если не существует. |
| [THead](../../aspose.html/htmltableelement/thead/) { get; } | Возвращает таблицу`ПОДПИСЬ` или void, если его не существует. |
| [Title](../../aspose.html/htmlelement/title/) { get; set; } | Консультативный заголовок элемента. См. определение атрибута title в HTML 4.01. . |
| [Width](../../aspose.html/htmltableelement/width/) { get; set; } | Указывает желаемую ширину таблицы. См. определение атрибута ширины в HTML 4.01. . |
...
| [CreateCaption](../../aspose.html/htmltableelement/createcaption/)() | Создать новый объект заголовка таблицы или вернуть существующий. |
| [CreateTFoot](../../aspose.html/htmltableelement/createtfoot/)() | Создать строку нижнего колонтитула таблицы или вернуть существующую. |
| [CreateTHead](../../aspose.html/htmltableelement/createthead/)() | Создать строку заголовка таблицы или вернуть существующую. |
| [DeleteCaption](../../aspose.html/htmltableelement/deletecaption/)() | Удалить заголовок таблицы, если он существует. |
| [DeleteRow](../../aspose.html/htmltableelement/deleterow/)(int) | Удалить строку таблицы. |
| [DeleteTFoot](../../aspose.html/htmltableelement/deletetfoot/)() | Удалить нижний колонтитул из таблицы, если он существует. |
| [DeleteTHead](../../aspose.html/htmltableelement/deletethead/)() | Удалить заголовок из таблицы, если он существует. |
