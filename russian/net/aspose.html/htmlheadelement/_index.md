...
description: Информация о заголовке документа. См. определение элемента HEAD в HTML 4.01.
type: docs
weight: 3350
...
| [Profile](../../aspose.html/htmlheadelement/profile) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ], обозначающий профиль метаданных. См. определение атрибута профиля в HTML 4.01. |
