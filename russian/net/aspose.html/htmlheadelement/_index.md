...
description: Aspose.Html.HTMLHeadElement сорт. Информация о заголовке документа. См. определение элемента HEAD в HTML 4.01. .
type: docs
weight: 3270
url: /ru/net/aspose.html/htmlheadelement/
---
## HTMLHeadElement class

Информация о заголовке документа. См. определение элемента HEAD в HTML 4.01. .
...
| [Profile](../../aspose.html/htmlheadelement/profile/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] назначение профиля метаданных. См. определение атрибута профиля в HTML 4.01. . |
