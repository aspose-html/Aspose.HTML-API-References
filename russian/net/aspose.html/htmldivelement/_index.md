...
description: Aspose.Html.HTMLDivElement сорт. Общий блокконтейнер. См. определение элемента DIV в HTML 4.01. .
type: docs
weight: 3180
url: /ru/net/aspose.html/htmldivelement/
---
## HTMLDivElement class

Общий блок-контейнер. См. определение элемента DIV в HTML 4.01. .
...
| Имя | Описание |
| --- | --- |
| [Align](../../aspose.html/htmldivelement/align/) { get; set; } | Горизонтальное выравнивание текста. См. определение атрибута align в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
