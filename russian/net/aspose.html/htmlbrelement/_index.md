...
description: Принудительный разрыв строки. См. определение элемента BR в HTML 4.01.
type: docs
weight: 3170
...
| [Clear](../../aspose.html/htmlbrelement/clear) { get; set; } | Управление потоком текста вокруг поплавков. См. определение атрибута clear в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
