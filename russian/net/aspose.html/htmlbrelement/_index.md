...
description: Aspose.Html.HTMLBRElement сорт. Принудительный разрыв строки. См. определение элемента BR в HTML 4.01. .
type: docs
weight: 3090
url: /ru/net/aspose.html/htmlbrelement/
---
## HTMLBRElement class

Принудительный разрыв строки. См. определение элемента BR в HTML 4.01. .
...
| [Clear](../../aspose.html/htmlbrelement/clear/) { get; set; } | Управление потоком текста вокруг поплавков. См. определение ясного атрибута в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
