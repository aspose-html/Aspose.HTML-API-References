...
description: Aspose.Html.HTMLTitleElement сорт. Элемент заголовка. См. определение элемента TITLE в HTML 4.01. .
type: docs
weight: 3620
url: /ru/net/aspose.html/htmltitleelement/
---
## HTMLTitleElement class

Элемент заголовка. См. определение элемента TITLE в HTML 4.01. .
