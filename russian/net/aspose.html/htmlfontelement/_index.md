...
description: Aspose.Html.HTMLFontElement сорт. Локальное изменение шрифта. См. определение элемента FONT в HTML 4.01. Этот элемент устарел в HTML 4.01.
type: docs
weight: 3220
url: /ru/net/aspose.html/htmlfontelement/
---
## HTMLFontElement class

Локальное изменение шрифта. См. определение элемента FONT в HTML 4.01. Этот элемент устарел в HTML 4.01.
...
| [Color](../../aspose.html/htmlfontelement/color/) { get; set; } | Цвет шрифта. См. определение атрибута цвета в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
...
| [Face](../../aspose.html/htmlfontelement/face/) { get; set; } | Идентификатор начертания шрифта. См. определение атрибута лица в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
...
| [Size](../../aspose.html/htmlfontelement/size/) { get; set; } | Размер шрифта. См. определение атрибута размера в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
