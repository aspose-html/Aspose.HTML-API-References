...
description: Элемент LINK указывает ссылку на внешний ресурс а определяет отношение этого документа к этому ресурсу или наоборот. См. определение элемента LINK в HTML 4.01 см. также интерфейс  LinkStyle в модуле StyleSheet Таблицы стилей DOM уровня 2 и CSShttp//www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113 .
type: docs
weight: 3450
...
Элемент` LINK` указывает ссылку на внешний ресурс, а определяет отношение этого документа к этому ресурсу (или наоборот). См. определение элемента LINK в HTML 4.01 (см. также интерфейс ` LinkStyle` в модуле StyleSheet [[Таблицы стилей DOM уровня 2 и CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113) ]).
...
| [Disabled](../../aspose.html/htmllinkelement/disabled) { get; set; } | Включает/отключает ссылку. В настоящее время используется только для ссылок таблицы стилей и может использоваться для активации или деактивации таблиц стилей. |
...
| [Media](../../aspose.html/htmllinkelement/media) { get; set; } | Предназначен для использования с одним или несколькими целевыми носителями. См. определение атрибута media в HTML 4.01. |
...
| [Target](../../aspose.html/htmllinkelement/target) { get; set; } | Кадр для отображения ресурса. См. определение целевого атрибута в HTML 4.01. |
...
| [Type](../../aspose.html/htmllinkelement/type) { get; set; } | Консультативный тип контента. См. определение атрибута type в HTML 4.01. |
