...
description: Aspose.Html.HTMLLinkElement сорт. СВЯЗЬelement указывает ссылку на внешний ресурс а определяет отношение этого документа к этому ресурсу или наоборот. См. определение элемента LINK в HTML 4.01 см. также стиль ссылки интерфейс в модуле StyleSheet Таблицы стилей DOM Level 2 и CSS .
type: docs
weight: 3370
url: /ru/net/aspose.html/htmllinkelement/
---
## HTMLLinkElement class

`СВЯЗЬ`element указывает ссылку на внешний ресурс, а определяет отношение этого документа к этому ресурсу (или наоборот). См. определение элемента LINK в HTML 4.01 (см. также `стиль ссылки` интерфейс в модуле StyleSheet [[Таблицы стилей DOM Level 2 и CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113) ]).
...
| [Charset](../../aspose.html/htmllinkelement/charset/) { get; set; } | Кодировка символов ресурса, на который делается ссылка. См. определение атрибута charset в HTML 4.01. . |
...
| [Disabled](../../aspose.html/htmllinkelement/disabled/) { get; set; } | Включает/отключает ссылку. В настоящее время это используется только для ссылок на таблицы стилей и может использоваться для активации или деактивации таблиц стилей. |
...
| [Href](../../aspose.html/htmllinkelement/href/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] связанного ресурса. См. определение атрибута href в HTML 4.01. . |
| [Hreflang](../../aspose.html/htmllinkelement/hreflang/) { get; set; } | Код языка связанного ресурса. См. определение атрибута hreflang в HTML 4.01. . |
...
| [Media](../../aspose.html/htmllinkelement/media/) { get; set; } | Предназначен для использования с одним или несколькими целевыми носителями. См. определение медиа-атрибута в HTML 4.01. . |
...
| [Rel](../../aspose.html/htmllinkelement/rel/) { get; set; } | Тип прямой ссылки. См. определение атрибута rel в HTML 4.01. . |
| [RelList](../../aspose.html/htmllinkelement/rellist/) { get; } | Возвращает активный DOMTokenList, содержащий токены, полученные в результате анализа атрибута "rel". |
| [Rev](../../aspose.html/htmllinkelement/rev/) { get; set; } | Тип обратной ссылки. См. определение атрибута rev в HTML 4.01. . |
...
| [Sheet](../../aspose.html/htmllinkelement/sheet/) { get; } | Получает связанную таблицу стилей. |
...
| [Target](../../aspose.html/htmllinkelement/target/) { get; set; } | Кадр для рендеринга ресурса. См. определение целевого атрибута в HTML 4.01. |
...
| [Type](../../aspose.html/htmllinkelement/type/) { get; set; } | Тип содержимого рекомендаций. См. определение атрибута типа в HTML 4.01. . |
