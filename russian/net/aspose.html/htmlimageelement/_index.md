...
description: Встроенное изображение. См. определение элемента IMG в HTML 4.01.
type: docs
weight: 3390
...
| Имя | Описание |
| --- | --- |
| [Align](../../aspose.html/htmlimageelement/align) { get; set; } | Выравнивает этот объект (вертикально или горизонтально) относительно его окружающего текста. См. определение атрибута align в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
...
| [Border](../../aspose.html/htmlimageelement/border) { get; set; } | Ширина рамки вокруг изображения. См. определение атрибута границы в HTML 4.01. Этот атрибут устарел в HTML 4.01. Обратите внимание, что тип этого атрибута был` DOMString` в HTML уровня 1 DOM [[DOM Уровень 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ] . |
...
| [Height](../../aspose.html/htmlimageelement/height) { get; set; } | Высота изображения в пикселях. См. определение атрибута высоты в HTML 4.01. Обратите внимание, что тип этого атрибута был ` DOMString` в DOM Level 1 HTML [[DOM Level 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ]. @version DOM Level 2 |
...
| [IsMap](../../aspose.html/htmlimageelement/ismap) { get; set; } | Использовать карту изображения на стороне сервера. См. определение атрибута ismap в HTML 4.01. |
...
| [LongDesc](../../aspose.html/htmlimageelement/longdesc) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ], обозначающий длинное описание этого изображения или кадра. См. определение атрибута longdesc в HTML 4.01. |
...
| [Src](../../aspose.html/htmlimageelement/src) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] обозначающий источник этого изображения. См. определение атрибута src в HTML 4.01. |
...
| [UseMap](../../aspose.html/htmlimageelement/usemap) { get; set; } | Использовать карту изображения на стороне клиента. См. определение атрибута usemap в HTML 4.01. |
| [Vspace](../../aspose.html/htmlimageelement/vspace) { get; set; } | Отступ по вертикали над и под этим изображением в пикселях. См. определение атрибута vspace в HTML 4.01. Этот атрибут устарел в HTML 4.01. Обратите внимание, что тип этого атрибута был "DOMString" в DOM Level 1 HTML [[DOM Уровень 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ]. @version DOM Level 2 |
| [Width](../../aspose.html/htmlimageelement/width) { get; set; } | Ширина изображения в пикселях. См. определение атрибута ширины в HTML 4.01. Обратите внимание, что тип этого атрибута был ` DOMString` в DOM Level 1 HTML [[DOM Level 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ]. @version DOM Level 2 |
