...
description: Aspose.Html.HTMLImageElement сорт. Встроенное изображение. См. определение элемента IMG в HTML 4.01. .
type: docs
weight: 3310
url: /ru/net/aspose.html/htmlimageelement/
---
## HTMLImageElement class

Встроенное изображение. См. определение элемента IMG в HTML 4.01. .
...
| Имя | Описание |
| --- | --- |
| [Align](../../aspose.html/htmlimageelement/align/) { get; set; } | Выравнивает этот объект (вертикально или горизонтально) относительно окружающего его текста . См. определение атрибута align в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
| [Alt](../../aspose.html/htmlimageelement/alt/) { get; set; } | Альтернативный текст для пользовательских агентов, не отображающих обычное содержимое этого элемента . См. определение атрибута alt в HTML 4.01. . |
...
| [Border](../../aspose.html/htmlimageelement/border/) { get; set; } | Ширина рамки вокруг изображения. См. определение атрибута границы в HTML 4.01. Этот атрибут устарел в HTML 4.01. Обратите внимание, что тип этого атрибута был`DOMString` в DOM Уровень 1 HTML [[ДОМ Уровень 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ] . |
...
| [Height](../../aspose.html/htmlimageelement/height/) { get; set; } | Высота изображения в пикселях. См. определение атрибута высоты в HTML 4.01. Обратите внимание, что тип этого атрибута был .`DOMString` в DOM Уровень 1 HTML [[ДОМ Уровень 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ]. @версия Уровень DOM 2 |
| [Hspace](../../aspose.html/htmlimageelement/hspace/) { get; set; } | Горизонтальное пространство слева и справа от этого изображения в пикселях. См. определение атрибута hspace в HTML 4.01. Этот атрибут устарел в HTML 4.01. Обратите внимание, что тип этого атрибута был .`DOMString` в DOM Уровень 1 HTML [[ДОМ Уровень 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ]. @версия Уровень DOM 2 |
...
| [IsMap](../../aspose.html/htmlimageelement/ismap/) { get; set; } | Использовать карту изображений на стороне сервера. См. определение атрибута ismap в HTML 4.01. |
...
| [LongDesc](../../aspose.html/htmlimageelement/longdesc/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] обозначая длинное описание этого изображения или кадра. См. определение атрибута longdesc в HTML 4.01. . |
| [Name](../../aspose.html/htmlimageelement/name/) { get; set; } | Имя элемента (для обратной совместимости). |
...
| [Src](../../aspose.html/htmlimageelement/src/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] с указанием источника этого изображения. См. определение атрибута src в HTML 4.01. . |
...
| [UseMap](../../aspose.html/htmlimageelement/usemap/) { get; set; } | Использовать карту изображения на стороне клиента. См. определение атрибута карты использования в HTML 4.01. . |
| [Vspace](../../aspose.html/htmlimageelement/vspace/) { get; set; } | Пространство по вертикали над и под этим изображением в пикселях. См. определение атрибута vspace в HTML 4.01. Этот атрибут устарел в HTML 4.01. Обратите внимание, что тип этого атрибута был «DOMString» в DOM Level 1 HTML [[ДОМ Уровень 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ]. @версия Уровень DOM 2 |
| [Width](../../aspose.html/htmlimageelement/width/) { get; set; } | Ширина изображения в пикселях. См. определение атрибута ширины в HTML 4.01. Обратите внимание, что тип этого атрибута был .`DOMString` в DOM Уровень 1 HTML [[ДОМ Уровень 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ]. @версия Уровень DOM 2 |
