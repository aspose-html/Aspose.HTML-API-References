...
description: Aspose.Html.HTMLPreElement сорт. Предварительно отформатированный текст. См. определение элемента PRE в HTML 4.01. .
type: docs
weight: 3490
url: /ru/net/aspose.html/htmlpreelement/
---
## HTMLPreElement class

Предварительно отформатированный текст. См. определение элемента PRE в HTML 4.01. .
...
| [Width](../../aspose.html/htmlpreelement/width/) { get; set; } | Фиксированная ширина содержимого. См. определение атрибута ширины в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
