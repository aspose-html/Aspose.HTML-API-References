...
description: Для Q и BLOCKQUOTE элементов. См. определение элемента Q в HTML 4.01.
type: docs
weight: 3580
...
Для` Q` и` BLOCKQUOTE` элементов. См. определение элемента Q в HTML 4.01.
...
| [Cite](../../aspose.html/htmlquoteelement/cite) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] обозначающий исходный документ или сообщение. См. определение атрибута cite в HTML 4.01. |
