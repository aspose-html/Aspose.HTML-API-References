...
description: Aspose.Html.HTMLQuoteElement сорт. ДляВопрос иБЛОКЦИТАТАэлементы. См. определение элемента Q в HTML 4.01. .
type: docs
weight: 3500
url: /ru/net/aspose.html/htmlquoteelement/
---
## HTMLQuoteElement class

Для`Вопрос` и`БЛОКЦИТАТА`элементы. См. определение элемента Q в HTML 4.01. .
...
| [Cite](../../aspose.html/htmlquoteelement/cite/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] обозначение исходного документа или сообщения. См. определение атрибута cite в HTML 4.01. . |
