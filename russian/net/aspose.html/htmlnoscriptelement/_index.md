...
description: Aspose.Html.HTMLNoScriptElement сорт. Операторы сценария. См. определение элемента NOSCRIPT в HTML 4.01. .
type: docs
weight: 3420
url: /ru/net/aspose.html/htmlnoscriptelement/
---
## HTMLNoScriptElement class

Операторы сценария. См. определение элемента NOSCRIPT в HTML 4.01. .
