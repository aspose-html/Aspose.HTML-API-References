...
description: Нажать кнопку. См. определение элемента BUTTON в HTML 4.01.
type: docs
weight: 3210
...
| Имя | Описание |
| --- | --- |
| [AccessKey](../../aspose.html/htmlbuttonelement/accesskey) { get; set; } | Односимвольный ключ доступа для предоставления доступа к управлению формой. См. определение атрибута accesskey в HTML 4.01. |
...
| [Disabled](../../aspose.html/htmlbuttonelement/disabled) { get; set; } | В этом контексте элемент управления недоступен. См. определение атрибута disabled в HTML 4.01. |
...
| [Form](../../aspose.html/htmlbuttonelement/form) { get; } | Возвращает элемент` FORM` , содержащий этот элемент управления. Возвращает ` null` , если этот элемент управления не находится в контексте формы . |
...
| [Name](../../aspose.html/htmlbuttonelement/name) { get; set; } | Управление формой или имя объекта при отправке с формой. См. определение атрибута name в HTML 4.01. |
...
| [Value](../../aspose.html/htmlbuttonelement/value) { get; set; } | Текущее значение элемента управления формы. См. определение атрибута value в HTML 4.01. |
