...
description: Aspose.Html.HTMLOListElement сорт. Нумерованный список. См. определение элемента OL в HTML 4.01. .
type: docs
weight: 3430
url: /ru/net/aspose.html/htmlolistelement/
---
## HTMLOListElement class

Нумерованный список. См. определение элемента OL в HTML 4.01. .
...
| [Compact](../../aspose.html/htmlolistelement/compact/) { get; set; } | Уменьшить расстояние между элементами списка. См. определение компактного атрибута в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
...
| [Start](../../aspose.html/htmlolistelement/start/) { get; set; } | Начальный порядковый номер. См. определение начального атрибута в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
...
| [Type](../../aspose.html/htmlolistelement/type/) { get; set; } | Стиль нумерации. См. определение атрибута type в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
