...
description: Нумерованный список. См. определение элемента OL в HTML 4.01.
type: docs
weight: 3510
...
| [Start](../../aspose.html/htmlolistelement/start) { get; set; } | Начальный порядковый номер. См. определение атрибута start в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
