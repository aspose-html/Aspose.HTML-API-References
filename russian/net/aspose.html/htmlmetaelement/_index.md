...
description: Содержит общую метаинформацию о документе. См. определение элемента META в HTML 4.01.
type: docs
weight: 3480
...
| [Content](../../aspose.html/htmlmetaelement/content) { get; set; } | Сопутствующая информация. См. определение атрибута содержимого в HTML 4.01. |
...
| [Scheme](../../aspose.html/htmlmetaelement/scheme) { get; set; } | Выберите форму содержания. См. определение атрибута схемы в HTML 4.01. |
