...
description: Aspose.Html.HTMLStyleElement сорт. Информация о стиле. См. определение элемента STYLE в HTML 4.01 модуль CSS Таблицы стилей DOM Level 2 и CSS  истиль ссылки интерфейс в модуле StyleSheets Таблицы стилей DOM Level 2 и CSS .
type: docs
weight: 3530
url: /ru/net/aspose.html/htmlstyleelement/
---
## HTMLStyleElement class

Информация о стиле. См. определение элемента STYLE в HTML 4.01, модуль CSS [[Таблицы стилей DOM Level 2 и CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113) ] и`стиль ссылки` интерфейс в модуле StyleSheets [[Таблицы стилей DOM Level 2 и CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113) ].
...
| [Disabled](../../aspose.html/htmlstyleelement/disabled/) { get; set; } | Включает/отключает таблицу стилей. |
...
| [Media](../../aspose.html/htmlstyleelement/media/) { get; set; } | Предназначен для использования с одним или несколькими целевыми носителями. См. определение медиа-атрибута в HTML 4.01. . |
...
| [Sheet](../../aspose.html/htmlstyleelement/sheet/) { get; } | Получает связанную таблицу стилей. |
...
| [Type](../../aspose.html/htmlstyleelement/type/) { get; set; } | Тип содержимого языка таблицы стилей. См. определение атрибута типа в HTML 4.01. . |
