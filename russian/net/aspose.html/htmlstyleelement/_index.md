...
description: Информация о стиле. См. определение элемента STYLE в HTML 4.01 модуль CSS Таблицы стилей DOM уровня 2 и CSShttp//www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113  и интерфейс LinkStyle в модуле StyleSheets Таблицы стилей DOM уровня 2 и CSShttp//www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113  .
type: docs
weight: 3610
...
Информация о стиле. См. определение элемента STYLE в HTML 4.01, модуль CSS [[Таблицы стилей DOM уровня 2 и CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113) ] и интерфейс` LinkStyle` в модуле StyleSheets [[Таблицы стилей DOM уровня 2 и CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113) ] .
...
| [Disabled](../../aspose.html/htmlstyleelement/disabled) { get; set; } | Включает/выключает таблицу стилей. |
...
| [Media](../../aspose.html/htmlstyleelement/media) { get; set; } | Предназначен для использования с одним или несколькими целевыми носителями. См. определение атрибута media в HTML 4.01. |
...
| [Type](../../aspose.html/htmlstyleelement/type) { get; set; } | Тип содержимого языка таблицы стилей. См. определение атрибута type в HTML 4.01. |
