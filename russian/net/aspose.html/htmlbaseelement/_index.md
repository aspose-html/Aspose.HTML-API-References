...
description: Aspose.Html.HTMLBaseElement сорт. Базовый URI документа IETF RFC 2396 . См. определение элемента BASE в HTML 4.01. .
type: docs
weight: 3100
url: /ru/net/aspose.html/htmlbaseelement/
---
## HTMLBaseElement class

Базовый URI документа [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ]. См. определение элемента BASE в HTML 4.01. .
...
| [Href](../../aspose.html/htmlbaseelement/href/) { get; set; } | Базовый URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ]. См. определение атрибута href в HTML 4.01. . |
...
| [Target](../../aspose.html/htmlbaseelement/target/) { get; set; } | Целевой кадр по умолчанию. См. определение целевого атрибута в HTML 4.01. . |
