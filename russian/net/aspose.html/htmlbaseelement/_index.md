...
description: URI базы документов IETF RFC 2396http//www.ietf.org/rfc/rfc2396.txt . См. определение элемента BASE в HTML 4.01.
type: docs
weight: 3180
...
URI базы документов [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ]. См. определение элемента BASE в HTML 4.01.
