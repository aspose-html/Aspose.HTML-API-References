...
description: Aspose.Html.HTMLFrameSetElement сорт. Создать сетку кадров. См. определение элемента FRAMESET в HTML 4.01. .
type: docs
weight: 3250
url: /ru/net/aspose.html/htmlframesetelement/
---
...
| [Cols](../../aspose.html/htmlframesetelement/cols/) { get; set; } | Количество столбцов фреймов в наборе фреймов. См. определение атрибута cols в HTML 4.01. . |
...
| [Rows](../../aspose.html/htmlframesetelement/rows/) { get; set; } | Количество строк кадров в наборе кадров. См. определение атрибута rows в HTML 4.01. . |
