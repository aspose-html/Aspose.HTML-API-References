...
description: Aspose.Html.HTMLDocument сорт. АнHTMLдокумент является корнем иерархии HTML и содержит все содержимое. Помимо предоставления доступа к иерархии он также предоставляет некоторые удобные методы для доступа к определенным наборам информации из документа.
type: docs
weight: 3190
...
Ан`HTML-документ` является корнем иерархии HTML и содержит все содержимое. Помимо предоставления доступа к иерархии, он также предоставляет некоторые удобные методы для доступа к определенным наборам информации из документа.

Следующие свойства устарели в пользу соответствующих для`ТЕЛО` element. На уровне DOM 2 метод`получитьэлементбиид` наследуется от`Документ` интерфейс, куда он был перемещен.

См. также[Объектная модель документа (DOM) Уровень 2 HTML-спецификация](http://www.w3.org/TR/2003/REC-DOM-Level-2-HTML-20030109) .
...
| Имя | Описание |
| --- | --- |
| [HTMLDocument](htmldocument/#constructor)() | Инициализирует новый экземпляр`HTMLDocument` класс. |
| [HTMLDocument](htmldocument/#constructor_1)(Configuration) | Инициализирует новый экземпляр`HTMLDocument` класс. |
| [HTMLDocument](htmldocument/#constructor_2)(RequestMessage) | Инициализирует новый экземпляр`HTMLDocument` сорт. Конструктор работает синхронно, он ожидает загрузки всех внешних ресурсов (изображений, скриптов и т.д.). Для асинхронной загрузки документа используйте метод[`Navigate`](../../aspose.html.dom/document/navigate/) или его перегрузки. Либо можно отключить загрузку некоторых внешних ресурсов, установив соответствующие флаги в[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_10)(string) | Инициализирует новый экземпляр`HTMLDocument` сорт. Конструктор работает синхронно, он ожидает загрузки всех внешних ресурсов (изображений, скриптов и т.д.). Для асинхронной загрузки документа используйте метод[`Navigate`](../../aspose.html.dom/document/navigate/) или его перегрузки. Либо можно отключить загрузку некоторых внешних ресурсов, установив соответствующие флаги в[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_4)(Url) | Инициализирует новый экземпляр`HTMLDocument` сорт. Конструктор работает синхронно, он ожидает загрузки всех внешних ресурсов (изображений, скриптов и т.д.). Для асинхронной загрузки документа используйте метод[`Navigate`](../../aspose.html.dom/document/navigate/) или его перегрузки. Либо можно отключить загрузку некоторых внешних ресурсов, установив соответствующие флаги в[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_3)(RequestMessage, Configuration) | Инициализирует новый экземпляр`HTMLDocument` сорт. Конструктор работает синхронно, он ожидает загрузки всех внешних ресурсов (изображений, скриптов и т.д.). Для асинхронной загрузки документа используйте метод[`Navigate`](../../aspose.html.dom/document/navigate/) или его перегрузки. Либо можно отключить загрузку некоторых внешних ресурсов, установив соответствующие флаги в[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_8)(Stream, string) | Инициализирует новый экземпляр`HTMLDocument` сорт. Конструктор работает синхронно, он ожидает загрузки всех внешних ресурсов (изображений, скриптов и т.д.). Для асинхронной загрузки документа используйте метод[`Navigate`](../../aspose.html.dom/document/navigate/) или его перегрузки. Либо можно отключить загрузку некоторых внешних ресурсов, установив соответствующие флаги в[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . Загрузка документа начинается с текущей позиции в потоке. |
| [HTMLDocument](htmldocument/#constructor_6)(Stream, Url) | Инициализирует новый экземпляр`HTMLDocument` сорт. Конструктор работает синхронно, он ожидает загрузки всех внешних ресурсов (изображений, скриптов и т.д.). Для асинхронной загрузки документа используйте метод[`Navigate`](../../aspose.html.dom/document/navigate/) или его перегрузки. Либо можно отключить загрузку некоторых внешних ресурсов, установив соответствующие флаги в[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . Загрузка документа начинается с текущей позиции в потоке. |
| [HTMLDocument](htmldocument/#constructor_11)(string, Configuration) | Инициализирует новый экземпляр`HTMLDocument` сорт. Конструктор работает синхронно, он ожидает загрузки всех внешних ресурсов (изображений, скриптов и т.д.). Для асинхронной загрузки документа используйте метод[`Navigate`](../../aspose.html.dom/document/navigate/) или его перегрузки. Либо можно отключить загрузку некоторых внешних ресурсов, установив соответствующие флаги в[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_14)(string, string) | Инициализирует новый экземпляр`HTMLDocument` сорт. Конструктор работает синхронно, он ожидает загрузки всех внешних ресурсов (изображений, скриптов и т.д.). Для асинхронной загрузки документа используйте метод[`Navigate`](../../aspose.html.dom/document/navigate/) или его перегрузки. Либо можно отключить загрузку некоторых внешних ресурсов, установив соответствующие флаги в[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_12)(string, Url) | Инициализирует новый экземпляр`HTMLDocument` сорт. Конструктор работает синхронно, он ожидает загрузки всех внешних ресурсов (изображений, скриптов и т.д.). Для асинхронной загрузки документа используйте метод[`Navigate`](../../aspose.html.dom/document/navigate/) или его перегрузки. Либо можно отключить загрузку некоторых внешних ресурсов, установив соответствующие флаги в[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_5)(Url, Configuration) | Инициализирует новый экземпляр`HTMLDocument` сорт. Конструктор работает синхронно, он ожидает загрузки всех внешних ресурсов (изображений, скриптов и т.д.). Для асинхронной загрузки документа используйте метод[`Navigate`](../../aspose.html.dom/document/navigate/) или его перегрузки. Либо можно отключить загрузку некоторых внешних ресурсов, установив соответствующие флаги в[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_9)(Stream, string, Configuration) | Инициализирует новый экземпляр`HTMLDocument` сорт. Конструктор работает синхронно, он ожидает загрузки всех внешних ресурсов (изображений, скриптов и т.д.). Для асинхронной загрузки документа используйте метод[`Navigate`](../../aspose.html.dom/document/navigate/) или его перегрузки. Либо можно отключить загрузку некоторых внешних ресурсов, установив соответствующие флаги в[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . Загрузка документа начинается с текущей позиции в потоке. |
| [HTMLDocument](htmldocument/#constructor_7)(Stream, Url, Configuration) | Инициализирует новый экземпляр`HTMLDocument` сорт. Конструктор работает синхронно, он ожидает загрузки всех внешних ресурсов (изображений, скриптов и т.д.). Для асинхронной загрузки документа используйте метод[`Navigate`](../../aspose.html.dom/document/navigate/) или его перегрузки. Либо можно отключить загрузку некоторых внешних ресурсов, установив соответствующие флаги в[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . Загрузка документа начинается с текущей позиции в потоке. |
| [HTMLDocument](htmldocument/#constructor_15)(string, string, Configuration) | Инициализирует новый экземпляр`HTMLDocument` сорт. Конструктор работает синхронно, он ожидает загрузки всех внешних ресурсов (изображений, скриптов и т.д.). Для асинхронной загрузки документа используйте метод[`Navigate`](../../aspose.html.dom/document/navigate/) или его перегрузки. Либо можно отключить загрузку некоторых внешних ресурсов, установив соответствующие флаги в[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_13)(string, Url, Configuration) | Инициализирует новый экземпляр`HTMLDocument` сорт. Конструктор работает синхронно, он ожидает загрузки всех внешних ресурсов (изображений, скриптов и т.д.). Для асинхронной загрузки документа используйте метод[`Navigate`](../../aspose.html.dom/document/navigate/) или его перегрузки. Либо можно отключить загрузку некоторых внешних ресурсов, установив соответствующие флаги в[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |

## Характеристики

| Имя | Описание |
| --- | --- |
| [Anchors](../../aspose.html/htmldocument/anchors/) { get; } | Сборник всех якорей(`А` ) элементы в документе со значением для`имя`атрибут. Из соображений обратной совместимости возвращаемый набор анкоров содержит только тех анкоров, созданных с помощью`имя` атрибут, а не те , созданные с помощью`идентификатор` атрибут. Обратите внимание, что в [[XHTML 1.0](http://www.w3.org/TR/2002/REC-xhtml1-20020801) ], `имя` атрибут (см. раздел 4.10) не имеет семантики, а присутствует только для устаревших пользовательских агентов:`идентификатор` вместо этого используется атрибут . Пользователям следует предпочесть механизмы итераторов, предоставляемые компанией [[Обход уровня DOM 2](http://www.w3.org/TR/2000/REC-DOM-Level-2-Traversal-Range-20001113) ] вместо. |
| [Applets](../../aspose.html/htmldocument/applets/) { get; } | Коллекция всех`ОБЪЕКТ` элементы, которые включают апплеты и`АППЛЕТ` (устаревшие) элементы в документе. |
...
| [Body](../../aspose.html/htmldocument/body/) { get; set; } | Элемент, содержащий содержимое документа. В документах с`ТЕЛО` содержимое, возвращает`ТЕЛО` элемент. В документах с набором фреймов это возвращает самый внешний `РАМКА` элемент. |
...
| [Domain](../../aspose.html/htmldocument/domain/) { get; } | Доменное имя сервера, который обслуживал документ, или `нулевой` если сервер не может быть идентифицирован по доменному имени . |
...
| [Images](../../aspose.html/htmldocument/images/) { get; } | Коллекция всех`ИМГ` элементы в документе. Поведение ограничено`ИМГ` элементы для обратной совместимости с . Как предложил [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224)], чтобы включить изображения, авторы могут использовать `ОБЪЕКТ` элемент или`ИМГ` элемент. Поэтому рекомендуется не использовать этот атрибут для поиска изображений в документе, а`getElementsByTagName` с HTML 4.01 или`getElementsByTagNameNS` с XHTML 1.0. |
...
| [Links](../../aspose.html/htmldocument/links/) { get; } | Коллекция всех`ОБЛАСТЬ` элементы и якорь ( `А` ) элементы в документе со значением для `href` атрибут. |
...
| [Title](../../aspose.html/htmldocument/title/) { get; set; } | Заголовок документа, указанный`ЗАГОЛОВОК` элемент в заголовке документа. |
...
| [GetOverrideStyle](../../aspose.html/htmldocument/getoverridestyle/)(Element, string) | Этот метод используется для получения объявления стиля переопределения для указанного элемента и указанного псевдоэлемента. |
...
| [Save](../../aspose.html/htmldocument/save/#save_10)(string) | Сохраняет документ в локальный файл, указанный`путь` Все ресурсы, используемые в этом документе, будут сохранены в в соседней папке, имя которой будет построено как: output_file_name + "_files". |
| [Save](../../aspose.html/htmldocument/save/#save_5)(Url) | Сохраняет документ в локальный файл, указанный`URL` Все ресурсы, используемые в этом документе, будут сохранены в в соседней папке, имя которой будет построено как: output_file_name + "_files". |
...
| [Save](../../aspose.html/htmldocument/save/#save_11)(string, HTMLSaveFormat) | Сохраняет документ в локальный файл, указанный`путь` Все ресурсы, используемые в этом документе, будут сохранены в в соседней папке, имя которой будет построено как: output_file_name + "_files". |
| [Save](../../aspose.html/htmldocument/save/#save_12)(string, HTMLSaveOptions) | Сохраняет документ в локальный файл, указанный`путь` Все ресурсы, используемые в этом документе, будут сохранены в в соседней папке, имя которой будет построено как: output_file_name + "_files". |
| [Save](../../aspose.html/htmldocument/save/#save_13)(string, MarkdownSaveOptions) | Сохраняет документ в локальный файл, указанный`путь` Все ресурсы, используемые в этом документе, будут сохранены в в соседней папке, имя которой будет построено как: output_file_name + "_files". |
| [Save](../../aspose.html/htmldocument/save/#save_14)(string, MHTMLSaveOptions) | Сохраняет документ в локальный файл, указанный`путь` Все ресурсы, используемые в этом документе, будут сохранены в в соседней папке, имя которой будет построено как: output_file_name + "_files". |
| [Save](../../aspose.html/htmldocument/save/#save_6)(Url, HTMLSaveFormat) | Сохраняет документ в локальный файл, указанный`URL` Все ресурсы, используемые в этом документе, будут сохранены в в соседней папке, имя которой будет построено как: output_file_name + "_files". |
| [Save](../../aspose.html/htmldocument/save/#save_7)(Url, HTMLSaveOptions) | Сохраняет документ в локальный файл, указанный`URL` Все ресурсы, используемые в этом документе, будут сохранены в в соседней папке, имя которой будет построено как: output_file_name + "_files". |
| [Save](../../aspose.html/htmldocument/save/#save_8)(Url, MarkdownSaveOptions) | Сохраняет документ в локальный файл, указанный`URL` Все ресурсы, используемые в этом документе, будут сохранены в в соседней папке, имя которой будет построено как: output_file_name + "_files". |
| [Save](../../aspose.html/htmldocument/save/#save_9)(Url, MHTMLSaveOptions) | Сохраняет документ в локальный файл, указанный`URL` Все ресурсы, используемые в этом документе, будут сохранены в в соседней папке, имя которой будет построено как: output_file_name + "_files". |
