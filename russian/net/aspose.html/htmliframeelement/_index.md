...
description: Aspose.Html.HTMLIFrameElement сорт. Встроенные подокна. См. определение элемента IFRAME в HTML 4.01. .
type: docs
weight: 3300
url: /ru/net/aspose.html/htmliframeelement/
---
## HTMLIFrameElement class

Встроенные подокна. См. определение элемента IFRAME в HTML 4.01. .
...
| Имя | Описание |
| --- | --- |
| [Align](../../aspose.html/htmliframeelement/align/) { get; set; } | Выравнивает этот объект (вертикально или горизонтально) относительно окружающего его текста . См. определение атрибута align в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
...
| [FrameBorder](../../aspose.html/htmliframeelement/frameborder/) { get; set; } | Запросить границы кадра. См. определение атрибута frameborder в HTML 4.01. |
| [Height](../../aspose.html/htmliframeelement/height/) { get; set; } | Высота кадра. См. определение атрибута высоты в HTML 4.01. . |
...
| [LongDesc](../../aspose.html/htmliframeelement/longdesc/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] обозначая длинное описание этого изображения или кадра. См. определение атрибута longdesc в HTML 4.01. . |
| [MarginHeight](../../aspose.html/htmliframeelement/marginheight/) { get; set; } | Высота поля кадра в пикселях. См. определение атрибута marginheight в HTML 4.01. . |
| [MarginWidth](../../aspose.html/htmliframeelement/marginwidth/) { get; set; } | Ширина поля кадра в пикселях. См. определение атрибута marginwidth в HTML 4.01. . |
| [Name](../../aspose.html/htmliframeelement/name/) { get; set; } | Имя фрейма (объект`цель` атрибут). См. определение атрибута имени в HTML 4.01. . |
...
| [Scrolling](../../aspose.html/htmliframeelement/scrolling/) { get; set; } | Укажите, должны ли фреймы иметь полосы прокрутки. См. определение атрибута прокрутки в HTML 4.01. . |
...
| [Src](../../aspose.html/htmliframeelement/src/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] обозначая начальное содержимое кадра. См. определение атрибута src в HTML 4.01. . |
...
| [Width](../../aspose.html/htmliframeelement/width/) { get; set; } | Ширина кадра. См. определение атрибута ширины в HTML 4.01. . |
