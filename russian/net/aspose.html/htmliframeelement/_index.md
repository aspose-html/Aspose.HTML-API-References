...
description: Встроенные подокна. См. определение элемента IFRAME в HTML 4.01.
type: docs
weight: 3380
...
| Имя | Описание |
| --- | --- |
| [Align](../../aspose.html/htmliframeelement/align) { get; set; } | Выравнивает этот объект (вертикально или горизонтально) относительно его окружающего текста. См. определение атрибута align в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
...
| [LongDesc](../../aspose.html/htmliframeelement/longdesc) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ], обозначающий длинное описание этого изображения или кадра. См. определение атрибута longdesc в HTML 4.01. |
...
| [Name](../../aspose.html/htmliframeelement/name) { get; set; } | Имя фрейма (объект атрибута` target` ). См. определение атрибута name в HTML 4.01. |
...
| [Src](../../aspose.html/htmliframeelement/src) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ], обозначающее начальное содержимое кадра. См. определение атрибута src в HTML 4.01. |
