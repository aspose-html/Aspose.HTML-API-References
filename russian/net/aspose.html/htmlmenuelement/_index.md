...
description: Aspose.Html.HTMLMenuElement сорт. Список меню. См. определение элемента MENU в HTML 4.01. Этот элемент устарел в HTML 4.01.
type: docs
weight: 3390
url: /ru/net/aspose.html/htmlmenuelement/
---
## HTMLMenuElement class

Список меню. См. определение элемента MENU в HTML 4.01. Этот элемент устарел в HTML 4.01.
...
| [Compact](../../aspose.html/htmlmenuelement/compact/) { get; set; } | Уменьшить расстояние между элементами списка. См. определение компактного атрибута в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
