...
description: Список меню. См. определение элемента MENU в HTML 4.01. Этот элемент объявлен устаревшим в HTML 4.01.
type: docs
weight: 3470
...
Список меню. См. определение элемента MENU в HTML 4.01. Этот элемент объявлен устаревшим в HTML 4.01.
