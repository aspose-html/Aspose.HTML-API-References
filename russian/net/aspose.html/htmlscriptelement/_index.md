...
description: Операторы сценария. См. определение элемента SCRIPT в HTML 4.01.
type: docs
weight: 3590
...
| [Defer](../../aspose.html/htmlscriptelement/defer) { get; set; } | Указывает, что пользовательский агент может отложить обработку сценария. См. определение атрибута defer в HTML 4.01. |
...
| [Event](../../aspose.html/htmlscriptelement/event) { get; set; } | Зарезервировано для использования в будущем. |
...
| [Src](../../aspose.html/htmlscriptelement/src) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] обозначающий внешний скрипт. См. определение атрибута src в HTML 4.01. |
...
| [Type](../../aspose.html/htmlscriptelement/type) { get; set; } | Тип содержимого скриптового языка. См. определение атрибута type в HTML 4.01. |
