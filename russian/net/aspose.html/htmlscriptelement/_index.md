...
description: Aspose.Html.HTMLScriptElement сорт. Операторы сценария. См. определение элемента SCRIPT в HTML 4.01. .
type: docs
weight: 3510
url: /ru/net/aspose.html/htmlscriptelement/
---
## HTMLScriptElement class

Операторы сценария. См. определение элемента SCRIPT в HTML 4.01. .
...
| [Charset](../../aspose.html/htmlscriptelement/charset/) { get; set; } | Кодировка символов связанного ресурса. См. определение атрибута charset в HTML 4.01. . |
...
| [Defer](../../aspose.html/htmlscriptelement/defer/) { get; set; } | Указывает, что пользовательский агент может отложить обработку сценария. См. определение атрибута отсрочки в HTML 4.01. |
...
| [Event](../../aspose.html/htmlscriptelement/event/) { get; set; } | Зарезервировано для будущего использования. |
...
| [Src](../../aspose.html/htmlscriptelement/src/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] обозначение внешнего скрипта. См. определение атрибута src в HTML 4.01. . |
...
| [Text](../../aspose.html/htmlscriptelement/text/) { get; set; } | Содержимое скрипта элемента. |
...
| [Type](../../aspose.html/htmlscriptelement/type/) { get; set; } | Тип содержимого скриптового языка. См. определение атрибута типа в HTML 4.01. . |
