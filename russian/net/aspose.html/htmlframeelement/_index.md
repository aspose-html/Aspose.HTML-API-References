...
description: Создать кадр. См. определение элемента FRAME в HTML 4.01.
type: docs
weight: 3320
...
| [ContentDocument](../../aspose.html/htmlframeelement/contentdocument) { get; } | Документ, который содержит этот фрейм, если он есть и доступен, или` null` иначе. @since DOM Level 2 |
...
| [LongDesc](../../aspose.html/htmlframeelement/longdesc) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ], обозначающий длинное описание этого изображения или кадра. См. определение атрибута longdesc в HTML 4.01. |
...
| [Name](../../aspose.html/htmlframeelement/name) { get; set; } | Имя фрейма (объект атрибута` target` ). См. определение атрибута name в HTML 4.01. |
...
| [Src](../../aspose.html/htmlframeelement/src) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ], обозначающее начальное содержимое кадра. См. определение атрибута src в HTML 4.01. |
