...
description: Aspose.Html.HTMLFrameElement сорт. Создать рамку. См. определение элемента FRAME в HTML 4.01. .
type: docs
weight: 3240
url: /ru/net/aspose.html/htmlframeelement/
---
## HTMLFrameElement class

Создать рамку. См. определение элемента FRAME в HTML 4.01. .
...
| [ContentDocument](../../aspose.html/htmlframeelement/contentdocument/) { get; } | Документ, который содержит этот фрейм, если он есть и доступен, или`нулевой` иначе. @начиная с уровня DOM 2 |
...
| [FrameBorder](../../aspose.html/htmlframeelement/frameborder/) { get; set; } | Запросить границы кадра. См. определение атрибута frameborder в HTML 4.01. |
...
| [LongDesc](../../aspose.html/htmlframeelement/longdesc/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] обозначая длинное описание этого изображения или кадра. См. определение атрибута longdesc в HTML 4.01. . |
| [MarginHeight](../../aspose.html/htmlframeelement/marginheight/) { get; set; } | Высота поля кадра в пикселях. См. определение атрибута marginheight в HTML 4.01. . |
| [MarginWidth](../../aspose.html/htmlframeelement/marginwidth/) { get; set; } | Ширина поля кадра в пикселях. См. определение атрибута marginwidth в HTML 4.01. . |
| [Name](../../aspose.html/htmlframeelement/name/) { get; set; } | Имя фрейма (объект`цель` атрибут). См. определение атрибута имени в HTML 4.01. . |
...
| [NoResize](../../aspose.html/htmlframeelement/noresize/) { get; set; } | При значении true запретить пользователю изменять размер кадра. См. определение атрибута noresize в HTML 4.01. . |
...
| [Scrolling](../../aspose.html/htmlframeelement/scrolling/) { get; set; } | Укажите, должны ли фреймы иметь полосы прокрутки. См. определение атрибута прокрутки в HTML 4.01. . |
...
| [Src](../../aspose.html/htmlframeelement/src/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] обозначая начальное содержимое кадра. См. определение атрибута src в HTML 4.01. . |
