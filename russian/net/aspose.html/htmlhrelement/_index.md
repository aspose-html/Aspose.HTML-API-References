...
description: Создать горизонтальную линейку. См. определение элемента HR в HTML 4.01.
type: docs
weight: 3340
...
Создать горизонтальную линейку. См. определение элемента HR в HTML 4.01.
...
| [NoShade](../../aspose.html/htmlhrelement/noshade) { get; set; } | Указывает пользовательскому агенту, что в рендеринге этого элемента не должно быть затенения. См. определение атрибута noshade в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
