...
description: Aspose.Html.HTMLHRElement сорт. Создайте горизонтальную линейку. См. определение элемента HR в HTML 4.01. .
type: docs
weight: 3260
url: /ru/net/aspose.html/htmlhrelement/
---
## HTMLHRElement class

Создайте горизонтальную линейку. См. определение элемента HR в HTML 4.01. .
...
| Имя | Описание |
| --- | --- |
| [Align](../../aspose.html/htmlhrelement/align/) { get; set; } | Выровняйте правило на странице. См. определение атрибута align в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
...
| [NoShade](../../aspose.html/htmlhrelement/noshade/) { get; set; } | Указывает пользовательскому агенту, что при рендеринге этого элемента не должно быть затенения. См. определение атрибута noshade в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
...
| [Size](../../aspose.html/htmlhrelement/size/) { get; set; } | Высота правила. См. определение атрибута размера в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
...
| [Width](../../aspose.html/htmlhrelement/width/) { get; set; } | Ширина правила. См. определение атрибута ширины в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
