...
description: Выбираемый вариант. См. определение элемента OPTION в HTML 4.01.
type: docs
weight: 3540
...
| [Form](../../aspose.html/htmloptionelement/form) { get; } | Возвращает элемент` FORM` , содержащий этот элемент управления. Возвращает ` null` , если этот элемент управления не находится в контексте формы . |
| [Id](../../aspose.html/htmlelement/id) { get; set; } | Идентификатор элемента. См. определение атрибута id в HTML 4.01. |
| [Index](../../aspose.html/htmloptionelement/index) { get; } | Индекс этого` OPTION` в его родительском` SELECT` , начиная с 0. @version DOM Level 2 |
...
| [Label](../../aspose.html/htmloptionelement/label) { get; set; } | Метка опции для использования в иерархических меню. См. определение атрибута label в HTML 4.01. |
...
| [Selected](../../aspose.html/htmloptionelement/selected) { get; set; } | Представляет текущее состояние соответствующего элемента управления формы в интерактивном пользовательском агенте. Изменение этого атрибута изменяет состояние элемента управления формы, но не изменяет значение выбранного атрибута HTML элемента. |
