...
description: Aspose.Html.HTMLOptionElement сорт. Выбираемый вариант. См. определение элемента OPTION в HTML 4.01. .
type: docs
weight: 3460
url: /ru/net/aspose.html/htmloptionelement/
---
## HTMLOptionElement class

Выбираемый вариант. См. определение элемента OPTION в HTML 4.01. .
...
| [DefaultSelected](../../aspose.html/htmloptionelement/defaultselected/) { get; set; } | Представляет значение атрибута selected HTML. Значение этого атрибута не изменяется, если изменяется состояние соответствующего элемента управления формы в интерактивном пользовательском агенте. См. определение выбранного атрибута в HTML 4.01. @version DOM Level 2 |
...
| [Disabled](../../aspose.html/htmloptionelement/disabled/) { get; set; } | В этом контексте элемент управления недоступен. См. определение отключенного атрибута в HTML 4.01. . |
...
| [Form](../../aspose.html/htmloptionelement/form/) { get; } | Возвращает`ФОРМА` элемент, содержащий этот элемент управления. Возвращает `нулевой` если этот элемент управления не находится в контексте формы . |
| [Id](../../aspose.html/htmlelement/id/) { get; set; } | Идентификатор элемента. См. определение атрибута id в HTML 4.01. . |
| [Index](../../aspose.html/htmloptionelement/index/) { get; } | Индекс этого`ВАРИАНТ` в его родительском`ВЫБИРАТЬ` , начиная с 0. @версия уровня DOM 2 |
...
| [Label](../../aspose.html/htmloptionelement/label/) { get; set; } | Метка опции для использования в иерархических меню. См. определение атрибута метки в HTML 4.01. . |
...
| [Selected](../../aspose.html/htmloptionelement/selected/) { get; set; } | Представляет текущее состояние соответствующего элемента управления формы в интерактивном пользовательском агенте . Изменение этого атрибута изменяет состояние элемента управления формы, но не изменяет значение атрибута HTML selected элемента. |
...
| [Text](../../aspose.html/htmloptionelement/text/) { get; } | Текст, содержащийся в элементе option. |
...
| [Value](../../aspose.html/htmloptionelement/value/) { get; set; } | Текущее значение элемента управления формы. См. определение атрибута value в HTML 4.01. . |
