...
description: Aspose.Html.HTMLDListElement сорт. Список определений. См. определение элемента DL в HTML 4.01. .
type: docs
weight: 3150
url: /ru/net/aspose.html/htmldlistelement/
---
## HTMLDListElement class

Список определений. См. определение элемента DL в HTML 4.01. .
...
| [Compact](../../aspose.html/htmldlistelement/compact/) { get; set; } | Уменьшить расстояние между элементами списка. См. определение компактного атрибута в HTML 4.01. Этот атрибут устарел в HTML 4.01. |
