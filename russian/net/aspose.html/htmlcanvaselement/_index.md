...
description: Интерфейс HTMLCanvasElement предоставляет свойства и методы для управления макетом и представлением элементов холста. Интерфейс HTMLCanvasElement также наследует свойства и методы интерфейса HTMLElement.
type: docs
weight: 3220
...
| [Height](../../aspose.html/htmlcanvaselement/height) { get; set; } | Положительное целое число, отражающее HTML-атрибут высоты элемента холста, интерпретируемый в пикселях CSS. Когда атрибут не указан или для него установлено недопустимое значение, например отрицательное, используется значение по умолчанию 150. |
