...
description: Aspose.Html.HTMLCanvasElement сорт. Интерфейс HTMLCanvasElement предоставляет свойства и методы для управления макетом и представлением элементов холста. Интерфейс HTMLCanvasElement также наследует свойства и методы интерфейса HTMLElement.
type: docs
weight: 3140
url: /ru/net/aspose.html/htmlcanvaselement/
---
## HTMLCanvasElement class

Интерфейс HTMLCanvasElement предоставляет свойства и методы для управления макетом и представлением элементов холста. Интерфейс HTMLCanvasElement также наследует свойства и методы интерфейса HTMLElement.
...
| [Height](../../aspose.html/htmlcanvaselement/height/) { get; set; } | — положительное целое число, отражающее HTML-атрибут высоты элемента холста, интерпретируемый в пикселях CSS. Если атрибут не указан или для него задано недопустимое значение, например отрицательное, используется значение по умолчанию 150. |
...
| [Width](../../aspose.html/htmlcanvaselement/width/) { get; set; } | — положительное целое число, отражающее HTML-атрибут ширины элемента холста, интерпретируемый в пикселях CSS. Если атрибут не указан или для него задано недопустимое значение, например отрицательное, используется значение по умолчанию 300. |
...
| [GetContext](../../aspose.html/htmlcanvaselement/getcontext/)(string) | Возвращает контекст рисования на холсте или null, если идентификатор контекста не поддерживается. Контекст рисования позволяет рисовать на холсте. |
...
| [ToDataURL](../../aspose.html/htmlcanvaselement/todataurl/#todataurl)() | возвращает URI данных, содержащий представление изображения в формате, заданном параметром типа (по умолчанию PNG). Возвращаемое изображение имеет разрешение 96 dpi. |
| [ToDataURL](../../aspose.html/htmlcanvaselement/todataurl/#todataurl_1)(string) | возвращает URI данных, содержащий представление изображения в формате, заданном параметром типа (по умолчанию PNG). Возвращаемое изображение имеет разрешение 96 dpi. |
| [ToDataURL](../../aspose.html/htmlcanvaselement/todataurl/#todataurl_2)(string, double) | возвращает URI данных, содержащий представление изображения в формате, заданном параметром типа (по умолчанию PNG). Возвращаемое изображение имеет разрешение 96 dpi. |
