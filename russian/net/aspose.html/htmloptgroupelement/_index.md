...
description: Aspose.Html.HTMLOptGroupElement сорт. Сгруппируйте параметры вместе в логические подразделения. См. определение элемента OPTGROUP в HTML 4.01. .
type: docs
weight: 3450
url: /ru/net/aspose.html/htmloptgroupelement/
---
## HTMLOptGroupElement class

Сгруппируйте параметры вместе в логические подразделения. См. определение элемента OPTGROUP в HTML 4.01. .
...
| [Disabled](../../aspose.html/htmloptgroupelement/disabled/) { get; set; } | В этом контексте элемент управления недоступен. См. определение отключенного атрибута в HTML 4.01. . |
...
| [Label](../../aspose.html/htmloptgroupelement/label/) { get; set; } | Назначает метку этой группе опций. См. атрибут метки Definition в HTML 4.01. . |
