...
description: Группировать параметры вместе в логические подразделения. См. определение элемента OPTGROUP в HTML 4.01.
type: docs
weight: 3530
...
Группировать параметры вместе в логические подразделения. См. определение элемента OPTGROUP в HTML 4.01.
...
| [Disabled](../../aspose.html/htmloptgroupelement/disabled) { get; set; } | В этом контексте элемент управления недоступен. См. определение атрибута disabled в HTML 4.01. |
...
| [Label](../../aspose.html/htmloptgroupelement/label) { get; set; } | Назначает метку этой группе опций. См. определение атрибута label в HTML 4.01. |
