...
description: Пространство имен Aspose.Html.Net представлено классами и интерфейсы которые отвечают за упрощение сетевой обработки.
type: docs
weight: 290
url: /ru/net/aspose.html.net/
---
Пространство имен **Aspose.Html.Net** представлено классами и интерфейсы, которые отвечают за упрощение сетевой обработки.
...
| [MultipartFormDataContent](./multipartformdatacontent) | Представляет содержимое для алгоритма кодирования multipart/form-data |
