...
description: ProcessingInstruction представляет собой инструкцию по обработке используемую в XML как способ сохранения информации относящейся к процессору в тексте документа.
type: docs
weight: 1130
...
ProcessingInstruction представляет собой "инструкцию по обработке", используемую в XML как способ сохранения информации, относящейся к процессору, в тексте документа.
