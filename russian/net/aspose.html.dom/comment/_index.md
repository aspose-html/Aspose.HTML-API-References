...
description: Наследуется от CharacterData и представляет содержимое комментария т. е. все символы между начальным lt-- и конечным --gt.
type: docs
weight: 420
url: /ru/net/aspose.html.dom/comment/
---
## Comment class

Наследуется от CharacterData и представляет содержимое комментария, т. е. все символы между начальным '&lt;!--' и конечным '--&gt;'.
...
| override [NodeName](../../aspose.html.dom/comment/nodename) { get; } | Имя этого узла в зависимости от его типа. |
| override [NodeType](../../aspose.html.dom/comment/nodetype) { get; } | Код, представляющий тип базового объекта. |
| override [NodeValue](../../aspose.html.dom/comment/nodevalue) { get; set; } | Значение этого узла в зависимости от его типа. |
