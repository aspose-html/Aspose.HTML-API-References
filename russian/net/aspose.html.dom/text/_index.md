...
description: Aspose.Html.Dom.Text сорт. Текстовый интерфейс наследуется от CharacterData и представляет текстовое содержимое называемое символьными данными в XML элемента или атрибута.
type: docs
weight: 2450
