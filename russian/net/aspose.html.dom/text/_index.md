...
description: Текстовый интерфейс наследуется от CharacterData и представляет текстовое содержимое называемое символьными данными в XML элемента или атрибута.
type: docs
weight: 2560
url: /ru/net/aspose.html.dom/text/
---
## Text class

Текстовый интерфейс наследуется от CharacterData и представляет текстовое содержимое (называемое символьными данными в XML) элемента или атрибута.
...
| override [NodeName](../../aspose.html.dom/text/nodename) { get; } | Имя этого узла в зависимости от его типа. |
| override [NodeType](../../aspose.html.dom/text/nodetype) { get; } | Код, представляющий тип базового объекта. |
