...
description: Представляет известную сущность проанализированную или не проанализированную в XML-документе.
type: docs
weight: 810
...
| [InputEncoding](../../aspose.html.dom/entity/inputencoding) { get; } | Атрибут, указывающий кодировку, используемую для этого объекта во время синтаксического анализа, когда он является внешним анализируемым объектом. Это нуль, если это сущность из внутреннего подмножества или если она неизвестна. |
...
| [NotationName](../../aspose.html.dom/entity/notationname) { get; } | Для неразобранных сущностей имя нотации для сущности. Для проанализированных сущностей это значение равно null. |
...
| [SystemId](../../aspose.html.dom/entity/systemid) { get; } | Системный идентификатор, связанный с объектом, если он указан, и null в противном случае. Это может быть абсолютный URI или нет. |
