...
description: Aspose.Html.Dom.Entity сорт. Представляет известную сущность проанализированную или не проанализированную в XMLдокументе.
type: docs
weight: 700
url: /ru/net/aspose.html.dom/entity/
---
## Entity class
...
| [InputEncoding](../../aspose.html.dom/entity/inputencoding/) { get; } | Атрибут, указывающий кодировку, используемую для этого объекта во время синтаксического анализа, когда он является внешним анализируемым объектом. Это значение null, если это сущность из внутреннего подмножества или если она неизвестна. |
...
| override [NodeName](../../aspose.html.dom/entity/nodename/) { get; } | Имя этого узла в зависимости от его типа. |
| override [NodeType](../../aspose.html.dom/entity/nodetype/) { get; } | Код, представляющий тип базового объекта. |
| virtual [NodeValue](../../aspose.html.dom/node/nodevalue/) { get; set; } | Значение этого узла в зависимости от его типа. |
| [NotationName](../../aspose.html.dom/entity/notationname/) { get; } | Для неразобранных сущностей имя нотации для сущности. Для проанализированных сущностей это null. |
...
| [PublicId](../../aspose.html.dom/entity/publicid/) { get; } | Общедоступный идентификатор, связанный с объектом, если он указан, и null в противном случае. |
| [SystemId](../../aspose.html.dom/entity/systemid/) { get; } | Системный идентификатор, связанный с сущностью, если он указан, и null в противном случае. Это может быть абсолютный URI или нет. |
...
| [XmlEncoding](../../aspose.html.dom/entity/xmlencoding/) { get; } | Атрибут, указывающий, как часть текстового объявления, кодировку этого объекта, когда он является внешним анализируемым объектом. В противном случае это null. |
| [XmlVersion](../../aspose.html.dom/entity/xmlversion/) { get; } | Атрибут, указывающий, как часть текстового объявления, номер версии этого объекта, когда он является внешним анализируемым объектом. В противном случае это null. |
