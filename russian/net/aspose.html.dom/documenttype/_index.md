...
description: DocumentType предоставляет интерфейс к списку сущностей определенных для документа
type: docs
weight: 790
...
DocumentType предоставляет интерфейс к списку сущностей, определенных для документа
...
| Имя | Описание |
| --- | --- |
| [DocumentType](documenttype)(string, string, string, string, Document) | Инициализирует новый экземпляр класса[`DocumentType`](../documenttype). |
...
| override [ToString](../../aspose.html.dom/documenttype/tostring)() | ВозвращаетString, представляющий этот экземпляр. |
