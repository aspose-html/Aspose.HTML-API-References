...
description: Aspose.Html.Dom.DocumentType сорт. DocumentType предоставляет интерфейс к списку сущностей определенных для document
type: docs
weight: 680
url: /ru/net/aspose.html.dom/documenttype/
---
## DocumentType class

DocumentType предоставляет интерфейс к списку сущностей, определенных для document
...
| Имя | Описание |
| --- | --- |
| [DocumentType](documenttype/)(string, string, string, string, Document) | Инициализирует новый экземпляр`DocumentType` класс. |
...
| [InternalSubset](../../aspose.html.dom/documenttype/internalsubset/) { get; } | Внутреннее подмножество в виде строки или null, если его нет. |
...
| [Name](../../aspose.html.dom/documenttype/name/) { get; } | Имя DTD; т. е. имя, непосредственно следующее за ключевым словом DOCTYPE. |
...
| override [NodeName](../../aspose.html.dom/documenttype/nodename/) { get; } | Имя этого узла в зависимости от его типа. |
| override [NodeType](../../aspose.html.dom/documenttype/nodetype/) { get; } | Код, представляющий тип базового объекта. |
...
| [PublicId](../../aspose.html.dom/documenttype/publicid/) { get; } | Общедоступный идентификатор внешнего подмножества. |
| [SystemId](../../aspose.html.dom/documenttype/systemid/) { get; } | Системный идентификатор внешнего подмножества. Это может быть абсолютный URI или нет. |
...
| override [ToString](../../aspose.html.dom/documenttype/tostring/)() | ВозвращаетString который представляет этот экземпляр. |
