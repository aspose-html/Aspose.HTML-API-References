...
description: Aspose.Html.Dom.CDATASection сорт. Разделы CDATA используются для экранирования блоков текста содержащих символы которые в противном случае считались бы разметкой.
type: docs
weight: 200
...
Разделы CDATA используются для экранирования блоков текста, содержащих символы, которые в противном случае считались бы разметкой.
...
| [IsElementContentWhitespace](../../aspose.html.dom/text/iselementcontentwhitespace/) { get; } | Возвращает, содержит ли этот текстовый узел пробелы в содержимом элемента, часто оскорбительно называемые «игнорируемыми пробелами». |
