...
description: Документ представляет собой весь документ HTML XML или SVG. Концептуально это корень дерева документов обеспечивающий основной доступ к данным документа.
type: docs
weight: 770
...
Документ представляет собой весь документ HTML, XML или SVG. Концептуально это корень дерева документов, обеспечивающий основной доступ к данным документа.
...
| virtual [RenderTo](../../aspose.html.dom/document/renderto)(IDevice) | Этот метод используется для отображения содержимого текущего документа на указанном графическом устройстве. |
