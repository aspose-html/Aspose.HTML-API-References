...
description: Интерфейс Element представляет элемент в документе HTML или XML.
type: docs
weight: 800
...
| Имя | Описание |
| --- | --- |
| [Element](element)(IElementInit) | Инициализирует новый экземпляр класса[`Element`](../element). Не вызывайте этот конструктор напрямую, используйте[`CreateElement`](../document/createelement)илиСтрока). |
