...
description: Aspose.Html.Dom.Element сорт. Интерфейс Element представляет элемент в документе HTML или XML.
type: docs
weight: 690
url: /ru/net/aspose.html.dom/element/
---
## Element class
...
| Имя | Описание |
| --- | --- |
| [Element](element/)(IElementInit) | Инициализирует новый экземпляр`Element`сорт. Не вызывайте этот конструктор напрямую, используйте[`CreateElement`](../document/createelement/) или[`CreateElementNS`](../document/createelementns/) . |
...
| [Id](../../aspose.html.dom/element/id/) { get; set; } | Идентификатор элемента. См. определение атрибута id в HTML 4.01. . |
...
| [ParentElement](../../aspose.html.dom/node/parentelement/) { get; } | Получает родителя`Element` этого узла. |
