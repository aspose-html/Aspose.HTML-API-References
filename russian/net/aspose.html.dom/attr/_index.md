...
| override [NamespaceURI](../../aspose.html.dom/attr/namespaceuri) { get; } | URI пространства имен этого узла или нуль, если он не указан. |
...
| override [Prefix](../../aspose.html.dom/attr/prefix) { get; } | Префикс пространства имен этого узла или ноль, если он не указан. Когда он определен как нуль, его установка не имеет никакого эффекта |
...
| [Specified](../../aspose.html.dom/attr/specified) { get; } | Истина, если этому атрибуту было явно присвоено значение в экземпляре документа, в противном случае - ложь. |
