...
description: Aspose.Html.Dom.EntityReference сорт. Узлы EntityReference могут использоваться для представления ссылки на объект в дереве.
type: docs
weight: 710
url: /ru/net/aspose.html.dom/entityreference/
---
## EntityReference class

Узлы EntityReference могут использоваться для представления ссылки на объект в дереве.
...
| override [NodeName](../../aspose.html.dom/entityreference/nodename/) { get; } | Имя этого узла в зависимости от его типа. |
| override [NodeType](../../aspose.html.dom/entityreference/nodetype/) { get; } | Код, представляющий тип базового объекта. |
