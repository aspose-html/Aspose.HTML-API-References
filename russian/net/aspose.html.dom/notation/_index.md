...
description: Aspose.Html.Dom.Notation сорт. Представляет нотацию объявленную в DTD.
type: docs
weight: 1010
url: /ru/net/aspose.html.dom/notation/
---
## Notation class
...
| override [NodeName](../../aspose.html.dom/notation/nodename/) { get; } | Имя этого узла в зависимости от его типа. |
| override [NodeType](../../aspose.html.dom/notation/nodetype/) { get; } | Код, представляющий тип базового объекта. |
...
| [PublicId](../../aspose.html.dom/notation/publicid/) { get; } | Общедоступный идентификатор этой нотации. Если общедоступный идентификатор не был указан, это значение null. |
| [SystemId](../../aspose.html.dom/notation/systemid/) { get; } | Системный идентификатор этой нотации. Если идентификатор системы не был указан, это значение равно null. Это может быть абсолютный URI или нет. |
