...
description: Aspose.Html.Dom.Node сорт. Интерфейс узла является основным типом данных для всей объектной модели документа. Он представляет один узел в дереве документа.
type: docs
weight: 1000
...
| [CloneNode](../../aspose.html.dom/node/clonenode/#clonenode)() | Возвращает дубликат этого узла, т. е. служит универсальным конструктором копирования для узлов. Дублирующий узел не имеет родителя (parentNode имеет значение null) и пользовательских данных. |
| [CloneNode](../../aspose.html.dom/node/clonenode/#clonenode_1)(bool) | Возвращает дубликат этого узла, т. е. служит универсальным конструктором копирования для узлов. Дублирующий узел не имеет родителя (parentNode имеет значение null) и пользовательских данных. |
...
| Имя | Описание |
| --- | --- |
| const [ATTRIBUTE_NODE](../../aspose.html.dom/node/attribute_node/) | Атрибут node |
| const [CDATA_SECTION_NODE](../../aspose.html.dom/node/cdata_section_node/) | Раздел cdata node |
| const [COMMENT_NODE](../../aspose.html.dom/node/comment_node/) | Комментарий node |
| const [DOCUMENT_FRAGMENT_NODE](../../aspose.html.dom/node/document_fragment_node/) | Фрагмент документа node |
| const [DOCUMENT_NODE](../../aspose.html.dom/node/document_node/) | Документ node |
| const [DOCUMENT_TYPE_NODE](../../aspose.html.dom/node/document_type_node/) | Тип документа node |
| const [ELEMENT_NODE](../../aspose.html.dom/node/element_node/) | Элемент node |
| const [ENTITY_NODE](../../aspose.html.dom/node/entity_node/) | Сущность node |
| const [ENTITY_REFERENCE_NODE](../../aspose.html.dom/node/entity_reference_node/) | Ссылка на сущность node |
| const [NOTATION_NODE](../../aspose.html.dom/node/notation_node/) | Нотация node |
| const [PROCESSING_INSTRUCTION_NODE](../../aspose.html.dom/node/processing_instruction_node/) | Инструкция по обработке node |
