...
description: Aspose.Html.Dom.Svg.Filters.SVGFEPointLightElement сорт. Интерфейс SVGFEPointLightElement соответствует элементу fePointLight.
type: docs
weight: 1560
url: /ru/net/aspose.html.dom.svg.filters/svgfepointlightelement/
---
...
| [X](../../aspose.html.dom.svg.filters/svgfepointlightelement/x/) { get; } | Соответствует атрибуту «x» данного элемента «fePointLight». |
| [Y](../../aspose.html.dom.svg.filters/svgfepointlightelement/y/) { get; } | Соответствует атрибуту 'y' данного элемента fePointLight. |
| [Z](../../aspose.html.dom.svg.filters/svgfepointlightelement/z/) { get; } | Соответствует атрибуту 'z' данного элемента 'fePointLight'. |
