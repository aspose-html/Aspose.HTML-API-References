...
description: Aspose.Html.Dom.Svg.Filters.SVGFEDropShadowElement сорт. Интерфейс SVGFEDropShadowElement соответствует элементу feDropShadow.
type: docs
weight: 1440
url: /ru/net/aspose.html.dom.svg.filters/svgfedropshadowelement/
---
...
| [Dx](../../aspose.html.dom.svg.filters/svgfedropshadowelement/dx/) { get; } | Соответствует атрибуту 'dx' данного элемента feDropShadow. |
| [Dy](../../aspose.html.dom.svg.filters/svgfedropshadowelement/dy/) { get; } | Соответствует атрибуту dy в данном элементе feDropShadow. |
...
| [Height](../../aspose.html.dom.svg.filters/svgfedropshadowelement/height/) { get; } | Соответствует атрибуту «высота» данного элемента «feDropShadow». |
...
| [In1](../../aspose.html.dom.svg.filters/svgfedropshadowelement/in1/) { get; } | Соответствует атрибуту 'in' данного элемента feDropShadow. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfedropshadowelement/result/) { get; } | Соответствует атрибуту «результат» данного элемента «feDropShadow». |
...
| [StdDeviationX](../../aspose.html.dom.svg.filters/svgfedropshadowelement/stddeviationx/) { get; } | Соответствует атрибуту 'stdDeviation' данного элемента feDropShadow. Содержит компонент X атрибута 'stdDeviation'. |
| [StdDeviationY](../../aspose.html.dom.svg.filters/svgfedropshadowelement/stddeviationy/) { get; } | Соответствует атрибуту 'stdDeviation' данного элемента feDropShadow. Содержит компонент Y (возможно, вычисляемый автоматически) атрибута 'stdDeviation'. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfedropshadowelement/width/) { get; } | Соответствует атрибуту 'width' данного элемента feDropShadow. |
| [X](../../aspose.html.dom.svg.filters/svgfedropshadowelement/x/) { get; } | Соответствует атрибуту 'x' данного элемента feDropShadow. |
| [Y](../../aspose.html.dom.svg.filters/svgfedropshadowelement/y/) { get; } | Соответствует атрибуту 'y' данного элемента feDropShadow. |
...
| [SetStdDeviation](../../aspose.html.dom.svg.filters/svgfedropshadowelement/setstddeviation/)(float, float) | Устанавливает значения для атрибута 'stdDeviation'. |
