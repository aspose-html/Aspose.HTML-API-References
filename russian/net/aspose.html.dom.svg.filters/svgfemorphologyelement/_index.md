...
description: Интерфейс SVGFEMorphologyElement соответствует элементу feMorphology.
type: docs
weight: 1650
...
| [Operator](../../aspose.html.dom.svg.filters/svgfemorphologyelement/operator) { get; } | Соответствует атрибуту 'operator' данного элемента 'feMorphology'. Принимает одну из констант SVG_MORPHOLOGY_OPERATOR_*, определенных в этом интерфейсе. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfemorphologyelement/result) { get; } | Соответствует атрибуту 'result' данного элемента 'filter'. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfemorphologyelement/width) { get; } | Соответствует атрибуту 'width' данного элемента 'filter'. |
| [X](../../aspose.html.dom.svg.filters/svgfemorphologyelement/x) { get; } | Соответствует атрибуту 'x' данного элемента 'filter'. |
...
| const [SVG_MORPHOLOGY_OPERATOR_ERODE](../../aspose.html.dom.svg.filters/svgfemorphologyelement/svg_morphology_operator_erode) | Соответствует значению 'erode'. |
