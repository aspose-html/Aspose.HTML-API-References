...
description: Aspose.Html.Dom.Svg.Filters.SVGFEDistantLightElement сорт. Интерфейс SVGFEDistantLightElement соответствует элементу feDistantLight.
type: docs
weight: 1430
url: /ru/net/aspose.html.dom.svg.filters/svgfedistantlightelement/
---
...
| [Azimuth](../../aspose.html.dom.svg.filters/svgfedistantlightelement/azimuth/) { get; } | Соответствует атрибуту азимут данного элемента feDistantLight. |
...
| [Elevation](../../aspose.html.dom.svg.filters/svgfedistantlightelement/elevation/) { get; } | Соответствует атрибуту «высота» данного элемента «feDistantLight». |
