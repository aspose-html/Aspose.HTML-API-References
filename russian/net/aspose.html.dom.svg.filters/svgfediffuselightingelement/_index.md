...
description: Интерфейс SVGFEDiffuseLightingElement соответствует элементу feDiffuseLighting.
type: docs
weight: 1520
...
| [Result](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/result) { get; } | Соответствует атрибуту 'result' данного элемента 'filter'. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/width) { get; } | Соответствует атрибуту 'width' данного элемента 'filter'. |
| [X](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/x) { get; } | Соответствует атрибуту 'x' данного элемента 'filter'. |
