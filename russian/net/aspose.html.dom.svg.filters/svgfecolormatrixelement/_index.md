...
description: Интерфейс SVGFEColorMatrixElement соответствует элементу feColorMatrix.
type: docs
weight: 1480
...
| [Result](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/result) { get; } | Соответствует атрибуту 'result' данного элемента 'filter'. |
...
| [Values](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/values) { get; } | Соответствует атрибуту 'values' данного элемента 'feColorMatrix'. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/width) { get; } | Соответствует атрибуту 'width' данного элемента 'filter'. |
| [X](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/x) { get; } | Соответствует атрибуту 'x' данного элемента 'filter'. |
...
| const [SVG_FECOLORMATRIX_TYPE_MATRIX](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_matrix) | Соответствует значению 'matrix'. |
| const [SVG_FECOLORMATRIX_TYPE_SATURATE](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_saturate) | Соответствует значению «насыщенность». |
