...
description: Интерфейс SVGFEGaussianBlurElement соответствует элементу feGaussianBlur.
type: docs
weight: 1610
...
| [Height](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/height) { get; } | Соответствует атрибуту «высота» данного элемента «фильтр». |
...
| [Width](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/width) { get; } | Соответствует атрибуту «ширина» данного элемента «фильтр». |
| [X](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/x) { get; } | Соответствует атрибуту «x» данного элемента «фильтр». |
