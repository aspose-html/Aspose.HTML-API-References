...
description: Aspose.Html.Dom.Svg.Filters.SVGFEGaussianBlurElement сорт. Интерфейс SVGFEGaussianBlurElement соответствует элементу feGaussianBlur.
type: docs
weight: 1500
url: /ru/net/aspose.html.dom.svg.filters/svgfegaussianblurelement/
---
...
| [Height](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/height/) { get; } | Соответствует атрибуту «высота» данного элемента «фильтра». |
...
| [In1](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/in1/) { get; } | Соответствует атрибуту in данного элемента feGaussianBlur. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/result/) { get; } | Соответствует атрибуту «результат» данного элемента «фильтр». |
...
| [StdDeviationX](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/stddeviationx/) { get; } | Соответствует атрибуту stdDeviation данного элемента feGaussianBlur. Содержит компонент X атрибута «stdDeviation». |
| [StdDeviationY](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/stddeviationy/) { get; } | Соответствует атрибуту stdDeviation данного элемента feGaussianBlur. Содержит компонент Y (возможно, вычисляемый автоматически) атрибута «stdDeviation». |
...
| [Width](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/width/) { get; } | Соответствует атрибуту «width» данного элемента «filter». |
| [X](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/x/) { get; } | Соответствует атрибуту "x" данного элемента "filter". |
| [Y](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/y/) { get; } | Соответствует атрибуту "y" данного элемента "фильтр". |
...
| [SetStdDeviation](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/setstddeviation/)(float, float) | Устанавливает значения для атрибута «stdDeviation». |
