...
description: Интерфейс SVGFEDisplacementMapElement соответствует элементу feDisplacementMap.
type: docs
weight: 1530
...
| [Result](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/result) { get; } | Соответствует атрибуту 'result' данного элемента 'filter'. |
| [Scale](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/scale) { get; } | Соответствует атрибуту 'scale' данного элемента 'feDisplacementMap'. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/width) { get; } | Соответствует атрибуту 'width' данного элемента 'filter'. |
| [X](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/x) { get; } | Соответствует атрибуту 'x' данного элемента 'filter'. |
| [XChannelSelector](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/xchannelselector) { get; } | Соответствует атрибуту xChannelSelector данного элемента feDisplacementMap. Принимает одну из констант SVG_CHANNEL_*, определенных в этом интерфейсе. |
| [Y](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/y) { get; } | Соответствует атрибуту 'y' данного элемента 'filter'. |
| [YChannelSelector](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/ychannelselector) { get; } | Соответствует атрибуту yChannelSelector данного элемента feDisplacementMap. Принимает одну из констант SVG_CHANNEL_*, определенных в этом интерфейсе. |
