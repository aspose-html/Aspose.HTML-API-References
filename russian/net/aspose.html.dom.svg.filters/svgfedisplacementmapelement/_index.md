...
description: Aspose.Html.Dom.Svg.Filters.SVGFEDisplacementMapElement сорт. Интерфейс SVGFEDisplacementMapElement соответствует элементу feDisplacementMap.
type: docs
weight: 1420
url: /ru/net/aspose.html.dom.svg.filters/svgfedisplacementmapelement/
---
...
| [Height](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/height/) { get; } | Соответствует атрибуту "высота" данного элемента "фильтра". |
...
| [In1](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/in1/) { get; } | Соответствует атрибуту 'in' данного элемента 'feDisplacementMap'. |
| [In2](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/in2/) { get; } | Соответствует атрибуту in2 данного элемента feDisplacementMap. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/result/) { get; } | Соответствует атрибуту «результат» данного элемента «фильтр». |
| [Scale](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/scale/) { get; } | Соответствует атрибуту «масштаб» данного элемента «feDisplacementMap». |
...
| [Width](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/width/) { get; } | Соответствует атрибуту «ширина» данного элемента «фильтр». |
| [X](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/x/) { get; } | Соответствует атрибуту «x» данного элемента «фильтр». |
| [XChannelSelector](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/xchannelselector/) { get; } | Соответствует атрибуту xChannelSelector данного элемента feDisplacementMap. Принимает одну из констант SVG_CHANNEL_*, определенных на этом интерфейсе. |
| [Y](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/y/) { get; } | Соответствует атрибуту 'y' данного элемента 'filter'. |
| [YChannelSelector](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/ychannelselector/) { get; } | Соответствует атрибуту yChannelSelector данного элемента feDisplacementMap. Принимает одну из констант SVG_CHANNEL_*, определенных на этом интерфейсе. |
...
| Имя | Описание |
| --- | --- |
| const [SVG_CHANNEL_A](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_a/) | Соответствует значению 'A'. |
| const [SVG_CHANNEL_B](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_b/) | Соответствует значению 'B'. |
| const [SVG_CHANNEL_G](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_g/) | Соответствует значению 'G'. |
| const [SVG_CHANNEL_R](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_r/) | Соответствует значению 'R'. |
| const [SVG_CHANNEL_UNKNOWN](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_unknown/) | Тип не является одним из предопределенных типов. Недопустимо пытаться определить новое значение этого типа или пытаться переключить существующее значение на этот тип. |
