...
description: Aspose.Html.Dom.Svg.Filters.SVGFEImageElement сорт. Интерфейс SVGFEImageElement соответствует элементу feImage.
type: docs
weight: 1510
url: /ru/net/aspose.html.dom.svg.filters/svgfeimageelement/
---
...
| [Height](../../aspose.html.dom.svg.filters/svgfeimageelement/height/) { get; } | Соответствует атрибуту "высота" данного элемента "фильтра". |
| [Href](../../aspose.html.dom.svg.filters/svgfeimageelement/href/) { get; } | Соответствует атрибуту 'xlink:href' данного элемента. |
...
| [PreserveAspectRatio](../../aspose.html.dom.svg.filters/svgfeimageelement/preserveaspectratio/) { get; } | Соответствует атрибуту preserveAspectRatio данного элемента feImage. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfeimageelement/result/) { get; } | Соответствует атрибуту «результат» данного элемента «фильтр». |
...
| [Width](../../aspose.html.dom.svg.filters/svgfeimageelement/width/) { get; } | Соответствует атрибуту «ширина» данного элемента «фильтр». |
| [X](../../aspose.html.dom.svg.filters/svgfeimageelement/x/) { get; } | Соответствует атрибуту «x» данного элемента «фильтр». |
| [Y](../../aspose.html.dom.svg.filters/svgfeimageelement/y/) { get; } | Соответствует атрибуту 'y' данного элемента 'filter'. |
