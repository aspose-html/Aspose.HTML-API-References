...
description: Aspose.Html.Dom.Svg.Filters.SVGFETurbulenceElement сорт. Интерфейс SVGFETurbulenceElement соответствует элементу feTurbulence.
type: docs
weight: 1600
url: /ru/net/aspose.html.dom.svg.filters/svgfeturbulenceelement/
---
...
| [BaseFrequencyX](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/basefrequencyx/) { get; } | Соответствует атрибуту baseFrequency данного элемента feTurbulence. Содержит компонент X атрибута baseFrequency. |
| [BaseFrequencyY](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/basefrequencyy/) { get; } | Соответствует атрибуту baseFrequency данного элемента feTurbulence. Содержит компонент Y атрибута baseFrequency (возможно, вычисляемый автоматически). |
...
| [Height](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/height/) { get; } | Соответствует атрибуту "высота" данного элемента "фильтра". |
...
| [NumOctaves](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/numoctaves/) { get; } | Соответствует атрибуту numOctaves данного элемента feTurbulence. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/result/) { get; } | Соответствует атрибуту «результат» данного элемента «фильтр». |
| [SchemaTypeInfo](../../aspose.html.dom/element/schematypeinfo/) { get; } | Информация о типе, связанная с этим элементом. |
| [Seed](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/seed/) { get; } | Соответствует атрибуту "seed" данного элемента "feTurbulence". |
...
| [StitchTiles](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/stitchtiles/) { get; } | Соответствует атрибуту 'stitchTiles' данного элемента 'feTurbulence'. Принимает одну из констант SVG_STITCHTYPE_*, определенных в этом интерфейсе. |
...
| [Type](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/type/) { get; } | Соответствует атрибуту type данного элемента feTurbulence. Принимает одну из констант SVG_TURBULENCE_TYPE_*, определенных в этом интерфейсе. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/width/) { get; } | Соответствует атрибуту «ширина» данного элемента «фильтр». |
| [X](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/x/) { get; } | Соответствует атрибуту «x» данного элемента «фильтр». |
| [Y](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/y/) { get; } | Соответствует атрибуту 'y' данного элемента 'filter'. |
...
| Имя | Описание |
| --- | --- |
| const [SVG_STITCHTYPE_NOSTITCH](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_stitchtype_nostitch/) | Соответствует значению 'noStitch'. |
| const [SVG_STITCHTYPE_STITCH](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_stitchtype_stitch/) | Соответствует значению 'stitch'. |
| const [SVG_STITCHTYPE_UNKNOWN](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_stitchtype_unknown/) | Тип не является одним из предопределенных типов. Недопустимо пытаться определить новое значение этого типа или пытаться переключить существующее значение на этот тип. |
| const [SVG_TURBULENCE_TYPE_FRACTALNOISE](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_turbulence_type_fractalnoise/) | Соответствует значению fractalNoise. |
| const [SVG_TURBULENCE_TYPE_TURBULENCE](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_turbulence_type_turbulence/) | Соответствует значению «турбулентность». |
| const [SVG_TURBULENCE_TYPE_UNKNOWN](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_turbulence_type_unknown/) | Тип не является одним из предопределенных типов. Недопустимо пытаться определить новое значение этого типа или пытаться переключить существующее значение на этот тип. |
