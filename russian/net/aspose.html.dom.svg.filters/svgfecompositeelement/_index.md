...
description: Интерфейс SVGFECompositeElement соответствует элементу feComposite.
type: docs
weight: 1500
...
| [Operator](../../aspose.html.dom.svg.filters/svgfecompositeelement/operator) { get; } | Соответствует атрибуту 'operator' данного элемента 'feComposite'. Принимает одну из констант SVG_FECOMPOSITE_OPERATOR_*, определенных в этом интерфейсе. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfecompositeelement/result) { get; } | Соответствует атрибуту 'result' данного элемента 'filter'. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfecompositeelement/width) { get; } | Соответствует атрибуту 'width' данного элемента 'filter'. |
| [X](../../aspose.html.dom.svg.filters/svgfecompositeelement/x) { get; } | Соответствует атрибуту 'x' данного элемента 'filter'. |
