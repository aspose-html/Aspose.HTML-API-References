...
description: Aspose.Html.Dom.Svg.Filters.SVGFECompositeElement сорт. Интерфейс SVGFECompositeElement соответствует элементу feComposite.
type: docs
weight: 1390
url: /ru/net/aspose.html.dom.svg.filters/svgfecompositeelement/
---
...
| [Height](../../aspose.html.dom.svg.filters/svgfecompositeelement/height/) { get; } | Соответствует атрибуту "высота" данного элемента "фильтра". |
...
| [In1](../../aspose.html.dom.svg.filters/svgfecompositeelement/in1/) { get; } | Соответствует атрибуту 'in' данного элемента 'feComposite'. |
| [In2](../../aspose.html.dom.svg.filters/svgfecompositeelement/in2/) { get; } | Соответствует атрибуту in2 данного элемента feComposite. |
...
| [K1](../../aspose.html.dom.svg.filters/svgfecompositeelement/k1/) { get; } | Соответствует атрибуту «k1» данного элемента «feComposite». |
| [K2](../../aspose.html.dom.svg.filters/svgfecompositeelement/k2/) { get; } | Соответствует атрибуту «k2» данного элемента «feComposite». |
| [K3](../../aspose.html.dom.svg.filters/svgfecompositeelement/k3/) { get; } | Соответствует атрибуту «k3» данного элемента «feComposite». |
| [K4](../../aspose.html.dom.svg.filters/svgfecompositeelement/k4/) { get; } | Соответствует атрибуту «k4» данного элемента «feComposite». |
...
| [Operator](../../aspose.html.dom.svg.filters/svgfecompositeelement/operator/) { get; } | Соответствует атрибуту «оператор» данного элемента «feComposite». Принимает одну из констант SVG_FECOMPOSITE_OPERATOR_*, определенных в этом интерфейсе. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfecompositeelement/result/) { get; } | Соответствует атрибуту «результат» данного элемента «фильтр». |
...
| [Width](../../aspose.html.dom.svg.filters/svgfecompositeelement/width/) { get; } | Соответствует атрибуту «ширина» данного элемента «фильтр». |
| [X](../../aspose.html.dom.svg.filters/svgfecompositeelement/x/) { get; } | Соответствует атрибуту «x» данного элемента «фильтр». |
| [Y](../../aspose.html.dom.svg.filters/svgfecompositeelement/y/) { get; } | Соответствует атрибуту 'y' данного элемента 'filter'. |
...
| Имя | Описание |
| --- | --- |
| const [SVG_FECOMPOSITE_OPERATOR_ARITHMETIC](../../aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_arithmetic/) | Соответствует значению «арифметика». |
| const [SVG_FECOMPOSITE_OPERATOR_ATOP](../../aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_atop/) | Соответствует значению "поверх". |
| const [SVG_FECOMPOSITE_OPERATOR_IN](../../aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_in/) | Соответствует значению 'in'. |
| const [SVG_FECOMPOSITE_OPERATOR_OUT](../../aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_out/) | Соответствует значению 'out'. |
| const [SVG_FECOMPOSITE_OPERATOR_OVER](../../aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_over/) | Соответствует значению «больше». |
| const [SVG_FECOMPOSITE_OPERATOR_UNKNOWN](../../aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_unknown/) | Тип не является одним из предопределенных типов. Недопустимо пытаться определить новое значение этого типа или пытаться переключить существующее значение на этот тип. |
| const [SVG_FECOMPOSITE_OPERATOR_XOR](../../aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_xor/) | Соответствует значению 'xor'. |
