...
description: Aspose.Html.Dom.Svg.Filters.SVGFESpecularLightingElement сорт. Интерфейс SVGFESpecularLightingElement соответствует элементу feSpecularLighting.
type: docs
weight: 1570
url: /ru/net/aspose.html.dom.svg.filters/svgfespecularlightingelement/
---
...
| [Height](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/height/) { get; } | Соответствует атрибуту "высота" данного элемента "фильтра". |
...
| [In1](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/in1/) { get; } | Соответствует атрибуту "in" данного элемента "feSpecularLighting". |
...
| [KernelUnitLengthX](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/kernelunitlengthx/) { get; } | Соответствует атрибуту 'kernelUnitLength' данного элемента 'feSpecularLighting'. |
| [KernelUnitLengthY](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/kernelunitlengthy/) { get; } | Соответствует атрибуту 'kernelUnitLength' данного элемента 'feSpecularLighting'. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/result/) { get; } | Соответствует атрибуту «результат» данного элемента «фильтр». |
...
| [SpecularConstant](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/specularconstant/) { get; } | Соответствует атрибуту specularConstant данного элемента feSpecularLighting. |
| [SpecularExponent](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/specularexponent/) { get; } | Соответствует атрибуту specularExponent данного элемента feSpecularLighting. |
...
| [SurfaceScale](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/surfacescale/) { get; } | Соответствует атрибуту 'surfaceScale' данного элемента 'feSpecularLighting'. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/width/) { get; } | Соответствует атрибуту «ширина» данного элемента «фильтр». |
| [X](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/x/) { get; } | Соответствует атрибуту «x» данного элемента «фильтр». |
| [Y](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/y/) { get; } | Соответствует атрибуту 'y' данного элемента 'filter'. |
