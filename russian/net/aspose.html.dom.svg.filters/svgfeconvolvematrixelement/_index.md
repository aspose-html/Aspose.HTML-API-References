...
description: Aspose.Html.Dom.Svg.Filters.SVGFEConvolveMatrixElement сорт. Интерфейс SVGFEConvolveMatrixElement соответствует элементу feConvolveMatrix.
type: docs
weight: 1400
url: /ru/net/aspose.html.dom.svg.filters/svgfeconvolvematrixelement/
---
...
| [Bias](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/bias/) { get; } | Соответствует атрибуту 'bias' данного элемента 'feConvolveMatrix'. |
...
| [Divisor](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/divisor/) { get; } | Соответствует атрибуту divisor данного элемента feConvolveMatrix. |
| [EdgeMode](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/edgemode/) { get; } | Соответствует атрибуту "edgeMode" данного элемента "feConvolveMatrix". |
...
| [Height](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/height/) { get; } | Соответствует атрибуту "высота" данного элемента "фильтра". |
...
| [In1](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/in1/) { get; } | Соответствует атрибуту "in" данного элемента "feConvolveMatrix". |
...
| [KernelMatrix](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelmatrix/) { get; } | Соответствует атрибуту 'kernelMatrix' данного элемента feConvolveMatrix. |
| [KernelUnitLengthX](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelunitlengthx/) { get; } | Соответствует атрибуту 'kernelUnitLength' данного элемента 'feConvolveMatrix'. |
| [KernelUnitLengthY](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelunitlengthy/) { get; } | Соответствует атрибуту 'kernelUnitLength' данного элемента 'feConvolveMatrix'. |
...
| [OrderX](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/orderx/) { get; } | Соответствует атрибуту «порядок» данного элемента «feConvolveMatrix». |
| [OrderY](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/ordery/) { get; } | Соответствует атрибуту «порядок» данного элемента «feConvolveMatrix». |
...
| [PreserveAlpha](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/preservealpha/) { get; } | Соответствует атрибуту preserveAlpha данного элемента feConvolveMatrix. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/result/) { get; } | Соответствует атрибуту «результат» данного элемента «фильтр». |
...
| [TargetX](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/targetx/) { get; } | Соответствует атрибуту targetX данного элемента feConvolveMatrix. |
| [TargetY](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/targety/) { get; } | Соответствует атрибуту targetY данного элемента feConvolveMatrix. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/width/) { get; } | Соответствует атрибуту «ширина» данного элемента «фильтр». |
| [X](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/x/) { get; } | Соответствует атрибуту «x» данного элемента «фильтр». |
| [Y](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/y/) { get; } | Соответствует атрибуту 'y' данного элемента 'filter'. |
...
| Имя | Описание |
| --- | --- |
| const [SVG_EDGEMODE_DUPLICATE](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_duplicate/) | Соответствует значению «дубликат». |
| const [SVG_EDGEMODE_NONE](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_none/) | Соответствует значению «нет». |
| const [SVG_EDGEMODE_UNKNOWN](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_unknown/) | Тип не является одним из предопределенных типов. Недопустимо пытаться определить новое значение этого типа или пытаться переключить существующее значение на этот тип. |
| const [SVG_EDGEMODE_WRAP](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_wrap/) | Соответствует значению "обтекание". |
