...
description: Aspose.Html.Dom.Svg.DataTypes.SVGTransformList сорт. Этот интерфейс определяет список объектов SVGTransform.
type: docs
weight: 1310
...
| Имя | Описание |
| --- | --- |
| [SVGTransformList](svgtransformlist/#constructor)() | Инициализирует новый экземпляр`SVGTransformList` класс. |
| [SVGTransformList](svgtransformlist/#constructor_1)(IEnumerable&lt;SVGTransform&gt;) | Инициализирует новый экземпляр`SVGTransformList` класс. |
...
| override [ToString](../../aspose.html.dom.svg.datatypes/svgtransformlist/tostring/)() | ВозвращаетString который представляет этот экземпляр. |
