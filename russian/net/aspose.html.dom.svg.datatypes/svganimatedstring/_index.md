...
description: Aspose.Html.Dom.Svg.DataTypes.SVGAnimatedString сорт. Используется для атрибутов типа DOMString которые можно анимировать.
type: docs
weight: 1170
url: /ru/net/aspose.html.dom.svg.datatypes/svganimatedstring/
---
## SVGAnimatedString class

Используется для атрибутов типа DOMString, которые можно анимировать.
...
| override [ToString](../../aspose.html.dom.svg.datatypes/svganimatedstring/tostring/)() | ВозвращаетString который представляет этот экземпляр. |
