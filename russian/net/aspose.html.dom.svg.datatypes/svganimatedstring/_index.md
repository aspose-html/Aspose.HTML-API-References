...
description: Используется для атрибутов типа DOMString которые можно анимировать.
type: docs
weight: 1280
...
| override [ToString](../../aspose.html.dom.svg.datatypes/svganimatedstring/tostring)() | ВозвращаетString, представляющий этот экземпляр. |
