...
description: Aspose.Html.Dom.Svg.DataTypes.SVGAnimatedBoolean сорт. Используется для атрибутов логического типа которые можно анимировать.
type: docs
weight: 1080
...
| override [ToString](../../aspose.html.dom.svg.datatypes/svganimatedboolean/tostring/)() | ВозвращаетString который представляет этот экземпляр. |
