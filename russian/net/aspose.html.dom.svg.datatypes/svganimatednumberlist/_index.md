...
description: Aspose.Html.Dom.Svg.DataTypes.SVGAnimatedNumberList сорт. Используется для атрибутов которые принимают список чисел и могут быть анимированы.
type: docs
weight: 1140
...
| override [ToString](../../aspose.html.dom.svg.datatypes/svganimatednumberlist/tostring/)() | ВозвращаетString который представляет этот экземпляр. |
