...
description: Aspose.Html.Dom.Svg.DataTypes.SVGNumberList сорт. Этот интерфейс определяет список объектов SVGNumber.
type: docs
weight: 1240
...
| override [ToString](../../aspose.html.dom.svg.datatypes/svgnumberlist/tostring/)() | ВозвращаетString который представляет этот экземпляр. |
