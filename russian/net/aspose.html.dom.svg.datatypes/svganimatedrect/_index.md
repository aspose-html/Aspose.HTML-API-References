...
description: Используется для атрибутов типа SVGRect которые можно анимировать.
type: docs
weight: 1270
url: /ru/net/aspose.html.dom.svg.datatypes/svganimatedrect/
---
## SVGAnimatedRect class

Используется для атрибутов типа SVGRect, которые можно анимировать.
...
| override [ToString](../../aspose.html.dom.svg.datatypes/svganimatedrect/tostring)() | ВозвращаетString, представляющий этот экземпляр. |
