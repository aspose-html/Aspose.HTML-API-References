...
description: Используется для атрибутов с номером базового типа которые можно анимировать.
type: docs
weight: 1240
url: /ru/net/aspose.html.dom.svg.datatypes/svganimatednumber/
---
## SVGAnimatedNumber class

Используется для атрибутов с номером базового типа, которые можно анимировать.
...
| override [ToString](../../aspose.html.dom.svg.datatypes/svganimatednumber/tostring)() | ВозвращаетString, представляющий этот экземпляр. |
