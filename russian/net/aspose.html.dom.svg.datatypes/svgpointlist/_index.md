...
description: Aspose.Html.Dom.Svg.DataTypes.SVGPointList сорт. Этот интерфейс определяет список объектов SVGPoint.
type: docs
weight: 1260
...
| override [ToString](../../aspose.html.dom.svg.datatypes/svgpointlist/tostring/)() | ВозвращаетString который представляет этот экземпляр. |
