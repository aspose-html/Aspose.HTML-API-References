...
description: "Метод FontMatcher. Этот метод вызывается, если в папках поиска шрифтов не найден подходящий шрифт. Он должен возвращать шрифт TrueType на основе fontMatchingProperties, который может отрисовать charCode или null, если такой шрифт недоступен."
type: docs
