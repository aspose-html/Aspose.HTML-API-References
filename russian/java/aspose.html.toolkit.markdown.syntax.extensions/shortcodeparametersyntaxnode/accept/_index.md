...
description: "Метод ShortCodeParameterSyntaxNode. Определяет интерфейс для принятия посетителя"
type: docs

url: /ru/java/com.aspose.html.toolkit.markdown.syntax.extensions/shortcodeparametersyntaxnode/accept/
---
