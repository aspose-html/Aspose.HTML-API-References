---
title: "HugoShortCodeSyntaxNode Класс"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.toolkit.markdown.syntax.extensions.HugoShortCodeSyntaxNode класс. Определяет HugoShortCodeSyntaxNode"
type: docs

url: /ru/java/com.aspose.html.toolkit.markdown.syntax.extensions/hugoshortcodesyntaxnode/
---
## HugoShortCodeSyntaxNode class

Определяет HugoShortCodeSyntaxNode
...
| Имя | Описание |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/inlinecontainersyntaxnode/accept/)(MarkdownSyntaxVisitor) | Определяет интерфейс для принятия посетителя. |
...
| [getEnumerator](../../com.aspose.html.toolkit.markdown.syntax/inlinecontainersyntaxnode/getenumerator/)() | Возвращает перечислитель, который проходит по коллекции. |
...
| [getParameter](../../com.aspose.html.toolkit.markdown.syntax.extensions/hugoshortcodesyntaxnode/getparameter/)(int) | Определяет GetParameter |
| [getParametersCount](../../com.aspose.html.toolkit.markdown.syntax.extensions/hugoshortcodesyntaxnode/getparameterscount/)() | Определяет GetParametersCount |
...
| [isEndTag](../../com.aspose.html.toolkit.markdown.syntax.extensions/hugoshortcodesyntaxnode/isendtag/)() | Определяет интерфейс для проверки IsEndTag |
