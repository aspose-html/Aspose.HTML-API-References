...
description: "com.aspose.html.dom.mutations.MutationRecord class. MutationRecord представляет отдельную мутацию DOM. Это объект, который передаётся в MutationObserver'ов MutationCallback."
type: docs
...
| [getAttributeNamespace](../../com.aspose.html.dom.mutations/mutationrecord/attributepackage/) Возвращает пространство имён изменённого атрибута, иначе null. |
| [getNextSibling](../../com.aspose.html.dom.mutations/mutationrecord/nextsibling/) Возвращает следующего соседа добавленных или удалённых узлов, либо null. |
...
| [getPreviousSibling](../../com.aspose.html.dom.mutations/mutationrecord/previoussibling/) Возвращает предыдущего соседа добавленных или удалённых узлов, либо null. |
