---
title: "Интерфейс IUserAgentService"
second_title: "Справочник API Aspose.HTML для Java"
description: "Интерфейс com.aspose.html.services.IUserAgentService. Интерфейс, описывающий окружение пользовательского агента."
type: docs

url: /ru/java/com.aspose.html.services/iuseragentservice/
---
...
| [getFontsSettings](../../com.aspose.html.services/iuseragentservice/fontssettings/) Получает объект [`FontsSettings`](../../com.aspose.html/fontssettings/), который используется для настройки обработки шрифтов. |
[getLanguage]
