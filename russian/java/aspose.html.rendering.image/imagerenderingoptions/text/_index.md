...
description: "Свойство ImageRenderingOptions. Возвращает объект TextOptions, который используется для настройки отображения текста."
type: docs

url: /ru/java/com.aspose.html.rendering.image/imagerenderingoptions/text/
---
