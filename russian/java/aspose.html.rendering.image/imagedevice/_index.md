---
title: "ImageDevice Класс"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.rendering.image.ImageDevice класс. Представляет рендеринг в растровые форматы jpeg png bmp gif tiff."
type: docs
...
| [ImageDevice](imagedevice/#constructor_1)(ImageRenderingOptions, ICreateStreamProvider) | Инициализирует новый экземпляр класса `ImageDevice` с помощью параметров рендеринга и поставщика потока. |
| [ImageDevice](imagedevice/#constructor_2)(ImageRenderingOptions, Stream) | Инициализирует новый экземпляр класса `ImageDevice` с помощью параметров рендеринга и выходного потока. |
| [ImageDevice](imagedevice/#constructor_3)(ImageRenderingOptions, String) | Инициализирует новый экземпляр класса `ImageDevice` с помощью параметров рендеринга и имени выходного файла. |
