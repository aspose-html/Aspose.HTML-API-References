...
description: "Интерфейс com.aspose.html.drawing.IInterpolationColor. Объявляет методы для получения цвета интерполяции."
type: docs

url: /ru/java/com.aspose.html.drawing/iinterpolationcolor/
---
## IInterpolationColor interface

Объявляет методы для получения цвета интерполяции.
