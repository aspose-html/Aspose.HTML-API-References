...
url: /ru/java/com.aspose.html.drawing/color/color/
---
## Color() {#constructor}
...
Инициализирует новый экземпляр класса [`Color`](../). Все компоненты цвета должны находиться в диапазоне от 0 до 1.
...
| зеленый | Single | Зелёный компонент цвета. |
...
Инициализирует новый экземпляр класса [`Color`](../). Все компоненты цвета должны находиться в диапазоне от 0 до 255.
...
| зеленый | Byte | Зелёный компонент цвета. |
...
| зеленый | Int32 | Зелёный компонент цвета. |
