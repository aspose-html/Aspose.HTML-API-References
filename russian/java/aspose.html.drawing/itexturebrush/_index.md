...
description: "Интерфейс com.aspose.html.drawing.ITextureBrush. Определяет интерфейс кисти, использующий изображение для заполнения внутренней части фигуры."
type: docs
