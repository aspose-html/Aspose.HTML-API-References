---
title: "Класс DocRenderingOptions"
second_title: "Справочник API Aspose.HTML для Java"
description: "Класс com.aspose.html.rendering.doc.DocRenderingOptions. Представляет параметры рендеринга для DocDevice"
type: docs

url: /ru/java/com.aspose.html.rendering.doc/docrenderingoptions/
---
...
| Имя | Описание |
| --- | --- |
| [DocRenderingOptions](docrenderingoptions/#constructor)() | Инициализирует новый экземпляр класса `DocRenderingOptions`. |
| [DocRenderingOptions](docrenderingoptions/#constructor_1)(FontEmbeddingRule) | Инициализирует новый экземпляр класса `DocRenderingOptions` с указанным правилом встраивания шрифтов. |
