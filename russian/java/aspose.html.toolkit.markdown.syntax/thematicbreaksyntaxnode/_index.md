---
title: "ThematicBreakSyntaxNode Класс"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.toolkit.markdown.syntax.ThematicBreakSyntaxNode класс. Реализует синтаксический узел тематического разрыва"
type: docs

url: /ru/java/com.aspose.html.toolkit.markdown.syntax/thematicbreaksyntaxnode/
---
## ThematicBreakSyntaxNode class

Реализован узел синтаксиса тематического разрыва.
...
| Имя | Описание |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/thematicbreaksyntaxnode/accept/)(MarkdownSyntaxVisitor) | Определяет интерфейс для посетителя Accept. |
