---
title: "Класс HardBreakSyntaxNode"
second_title: "Справочник API Aspose.HTML для Java"
description: "Класс com.aspose.html.toolkit.markdown.syntax.HardBreakSyntaxNode. Представляет HardBreakSyntaxNode"
type: docs

url: /ru/java/com.aspose.html.toolkit.markdown.syntax/hardbreaksyntaxnode/
---
## HardBreakSyntaxNode class

Представляет HardBreakSyntaxNode.
...
| [getSource](../../com.aspose.html.toolkit.markdown.syntax/linebreaksyntaxnode/source/) Получить источник. |
| [getSpan](../../com.aspose.html.toolkit.markdown.syntax/linebreaksyntaxnode/span/) Получить диапазон. |
| [getValue](../../com.aspose.html.toolkit.markdown.syntax/linebreaksyntaxnode/value/) Получить значение. |

## Методы

| Имя | Описание |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/hardbreaksyntaxnode/accept/)(MarkdownSyntaxVisitor) | Определяет интерфейс для принятия посетителя. |
...
| [getBreakingTag](../../com.aspose.html.toolkit.markdown.syntax/hardbreaksyntaxnode/getbreakingtag/)() | Определяет интерфейс для получения тега разрыва |
