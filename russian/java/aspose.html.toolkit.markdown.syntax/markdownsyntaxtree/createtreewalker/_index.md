...
description: "Метод MarkdownSyntaxTree. Определяет интерфейс для создания обходчика дерева"
type: docs

url: /ru/java/com.aspose.html.toolkit.markdown.syntax/markdownsyntaxtree/createtreewalker/
---
## CreateTreeWalker(MarkdownSyntaxNodeFilter) {#createtreewalker_2}

Определяет интерфейс для создания обходчика дерева.
