---
title: "Класс ReferenceLinkSyntaxNode"
second_title: "Справочник API Aspose.HTML для Java"
description: "Класс com.aspose.html.toolkit.markdown.syntax.ReferenceLinkSyntaxNode. Представляет синтаксис ссылочного ReferenceLinkSyntaxNode"
type: docs

url: /ru/java/com.aspose.html.toolkit.markdown.syntax/referencelinksyntaxnode/
---
## ReferenceLinkSyntaxNode class

Представляет синтаксис ссылочной ссылки.
...
| Имя | Описание |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/referencelinksyntaxnode/accept/)(MarkdownSyntaxVisitor) | Определяет интерфейс для приёма посетителя. |
...
| [getContent](../../com.aspose.html.toolkit.markdown.syntax/referencelinksyntaxnode/getcontent/)() | Определяет интерфейс для get content. |
| [getLabel](../../com.aspose.html.toolkit.markdown.syntax/referencelinksyntaxnode/getlabel/)() | Определяет интерфейс для получения метки. |
