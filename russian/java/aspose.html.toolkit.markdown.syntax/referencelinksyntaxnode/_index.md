---
title: "ReferenceLinkSyntaxNode Класс"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.toolkit.markdown.syntax.ReferenceLinkSyntaxNode класс. Представляет синтаксис ссылочного узла"
type: docs
...
Представляет синтаксис ссылочного гиперссылки.
...
| Имя | Описание |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/referencelinksyntaxnode/accept/)(MarkdownSyntaxVisitor) | Определяет интерфейс для принятия посетителя. |
