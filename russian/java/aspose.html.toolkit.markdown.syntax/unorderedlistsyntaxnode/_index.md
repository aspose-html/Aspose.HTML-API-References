---
title: "UnorderedListSyntaxNode Класс"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.toolkit.markdown.syntax.UnorderedListSyntaxNode класс. Представляет узел синтаксиса неупорядоченного списка"
type: docs

url: /ru/java/com.aspose.html.toolkit.markdown.syntax/unorderedlistsyntaxnode/
---
## UnorderedListSyntaxNode class

Представляет узел синтаксиса неупорядоченного списка.
...
| Имя | Описание |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/unorderedlistsyntaxnode/accept/)(MarkdownSyntaxVisitor) | Определяет интерфейс для посещения узлов синтаксиса. |
...
| [getMarker](../../com.aspose.html.toolkit.markdown.syntax/unorderedlistsyntaxnode/getmarker/)() | Определяет интерфейс для получения маркера. |
...
| [isTight](../../com.aspose.html.toolkit.markdown.syntax/listsyntaxnode/istight/)() | Определяет интерфейс для получения is tight. |
