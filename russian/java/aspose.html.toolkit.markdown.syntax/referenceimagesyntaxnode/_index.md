---
title: "ReferenceImageSyntaxNode класс"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.toolkit.markdown.syntax.ReferenceImageSyntaxNode класс. Синтаксис ссылочного изображения"
type: docs

url: /ru/java/com.aspose.html.toolkit.markdown.syntax/referenceimagesyntaxnode/
---
## ReferenceImageSyntaxNode class

Синтаксис ссылочного изображения.
...
| Имя | Описание |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/referenceimagesyntaxnode/accept/)(MarkdownSyntaxVisitor) | Определяет интерфейс для принятия посетителя. |
...
| [getAltText](../../com.aspose.html.toolkit.markdown.syntax/referenceimagesyntaxnode/getalttext/)() | Определяет интерфейс для получения альтернативного текста. |
| [getLabel](../../com.aspose.html.toolkit.markdown.syntax/referenceimagesyntaxnode/getlabel/)() | Определяет интерфейс для получения метки. |
