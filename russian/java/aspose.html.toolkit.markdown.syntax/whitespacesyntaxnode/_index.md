---
title: "Класс WhitespaceSyntaxNode"
second_title: "Справочник API Aspose.HTML для Java"
description: "Класс com.aspose.html.toolkit.markdown.syntax.WhitespaceSyntaxNode. Представляет узел синтаксиса пробела"
type: docs

url: /ru/java/com.aspose.html.toolkit.markdown.syntax/whitespacesyntaxnode/
---
## WhitespaceSyntaxNode class

Представляет синтаксический узел пробельных символов.
...
| Имя | Описание |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/whitespacesyntaxnode/accept/)(MarkdownSyntaxVisitor) | Определяет интерфейс для посещения узлов синтаксиса. |
