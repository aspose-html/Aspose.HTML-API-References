...
description: "Метод SoftBreakSyntaxNode. Определяет интерфейс для принятия посетителя"
type: docs

url: /ru/java/com.aspose.html.toolkit.markdown.syntax/softbreaksyntaxnode/accept/
---
