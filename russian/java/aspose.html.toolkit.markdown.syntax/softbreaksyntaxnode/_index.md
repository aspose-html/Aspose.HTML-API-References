---
title: "SoftBreakSyntaxNode класс"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.toolkit.markdown.syntax.SoftBreakSyntaxNode класс. Представляет синтаксис мягкого разрыва"
type: docs

url: /ru/java/com.aspose.html.toolkit.markdown.syntax/softbreaksyntaxnode/
---
## SoftBreakSyntaxNode class

Представляет синтаксис мягкого разрыва.
...
| Имя | Описание |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/softbreaksyntaxnode/accept/)(MarkdownSyntaxVisitor) | Определяет интерфейс для принятия посетителя. |
