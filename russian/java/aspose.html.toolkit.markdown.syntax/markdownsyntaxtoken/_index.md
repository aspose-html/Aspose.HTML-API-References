---
title: "Класс MarkdownSyntaxToken"
second_title: "Справочник API Aspose.HTML для Java"
description: "Класс com.aspose.html.toolkit.markdown.syntax.MarkdownSyntaxToken. Представляет токен синтаксиса Markdown"
type: docs

url: /ru/java/com.aspose.html.toolkit.markdown.syntax/markdownsyntaxtoken/
---
## MarkdownSyntaxToken class

Представляет токен синтаксиса Markdown.
...
| [getSource](../../com.aspose.html.toolkit.markdown.syntax/markdownsyntaxtoken/source/) Получить исходный текст. |
| [getSpan](../../com.aspose.html.toolkit.markdown.syntax/markdownsyntaxtoken/span/) Получить диапазон. |
| [getText](../../com.aspose.html.toolkit.markdown.syntax/markdownsyntaxtoken/text/) Получить текстовое содержимое диапазона. |

## Методы

| Имя | Описание |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/accept/)(MarkdownSyntaxVisitor) | Принять посетителя. |
...
| [getFullText](../../com.aspose.html.toolkit.markdown.syntax/markdownsyntaxtoken/getfulltext/)() | Определяет интерфейс для получения полного текста. |
