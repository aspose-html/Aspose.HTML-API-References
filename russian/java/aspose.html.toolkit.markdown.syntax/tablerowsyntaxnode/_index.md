---
title: "Класс TableRowSyntaxNode"
second_title: "Справочник API Aspose.HTML для Java"
description: "Класс com.aspose.html.toolkit.markdown.syntax.TableRowSyntaxNode. Синтаксический узел строки таблицы."
type: docs

url: /ru/java/com.aspose.html.toolkit.markdown.syntax/tablerowsyntaxnode/
---
## TableRowSyntaxNode class

Узел синтаксиса строки таблицы.
...
| [appendCell](../../com.aspose.html.toolkit.markdown.syntax/tablerowsyntaxnode/appendcell/)(TableCellSyntaxNode) | Определяет интерфейс для добавления ячейки. |
...
| [appendDelimiter](../../com.aspose.html.toolkit.markdown.syntax/tablerowsyntaxnode/appenddelimiter/)(TableDelimiterSyntaxNode) | Определяет интерфейс для добавления разделителя. |
| [childNodes](../../com.aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/childnodes/)() | Получить коллекцию дочерних узлов. |
| [getCells](../../com.aspose.html.toolkit.markdown.syntax/tablerowsyntaxnode/getcells/)() | Определяет интерфейс для получения ячеек. |
