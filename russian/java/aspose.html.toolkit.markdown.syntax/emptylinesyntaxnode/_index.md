---
title: "Класс EmptyLineSyntaxNode"
second_title: "Справочник API Aspose.HTML для Java"
description: "Класс com.aspose.html.toolkit.markdown.syntax.EmptyLineSyntaxNode. Представляет EmptyLineSyntaxNode"
type: docs

url: /ru/java/com.aspose.html.toolkit.markdown.syntax/emptylinesyntaxnode/
---
## EmptyLineSyntaxNode class

Представляет EmptyLineSyntaxNode.
...
| Имя | Описание |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/emptylinesyntaxnode/accept/)(MarkdownSyntaxVisitor) | Определяет интерфейс для принятия посетителя. |
