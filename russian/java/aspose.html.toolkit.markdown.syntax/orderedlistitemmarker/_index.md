---
title: "Класс OrderedListItemMarker"
second_title: "Справочник API Aspose.HTML для Java"
description: "Класс com.aspose.html.toolkit.markdown.syntax.OrderedListItemMarker. Представляет маркер элемента упорядоченного списка"
type: docs

url: /ru/java/com.aspose.html.toolkit.markdown.syntax/orderedlistitemmarker/
---
## OrderedListItemMarker class

Представляет маркер элемента упорядоченного списка.
...
| [getDelimiter](../../com.aspose.html.toolkit.markdown.syntax/orderedlistitemmarker/getdelimiter/)() | Определяет интерфейс для получения разделителя. |
| [getIndex](../../com.aspose.html.toolkit.markdown.syntax/orderedlistitemmarker/getindex/)() | Определяет интерфейс для получения индекса. |
