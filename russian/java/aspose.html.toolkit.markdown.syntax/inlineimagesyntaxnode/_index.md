---
title: "InlineImageSyntaxNode класс"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.toolkit.markdown.syntax.InlineImageSyntaxNode класс. Представляет InlineImageSyntaxNode"
type: docs

url: /ru/java/com.aspose.html.toolkit.markdown.syntax/inlineimagesyntaxnode/
---
## InlineImageSyntaxNode class

Представляет InlineImageSyntaxNode.
...
| Имя | Описание |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/inlineimagesyntaxnode/accept/)(MarkdownSyntaxVisitor) | Определяет интерфейс для принятия посетителя. |
...
| [getAltText](../../com.aspose.html.toolkit.markdown.syntax/inlineimagesyntaxnode/getalttext/)() | Определяет интерфейс для получения всего текста. |
| [getDestination](../../com.aspose.html.toolkit.markdown.syntax/inlineimagesyntaxnode/getdestination/)() | Определяет интерфейс для получения назначения. |
...
| [getTitle](../../com.aspose.html.toolkit.markdown.syntax/inlineimagesyntaxnode/gettitle/)() | Определяет интерфейс для получения заголовка. |
