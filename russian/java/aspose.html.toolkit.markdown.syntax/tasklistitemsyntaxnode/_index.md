...
description: "com.aspose.html.toolkit.markdown.syntax.TaskListItemSyntaxNode класс. Синтаксический узел элемента списка задач"
type: docs
...
| [getLinesLeadingTrivia](../../com.aspose.html.toolkit.markdown.syntax/multilinecontainerblocksyntaxnode/getlinesleadingtrivia/)() | Определяет интерфейс для получения строк leading trivia. |
...
| [isTight](../../com.aspose.html.toolkit.markdown.syntax/listitemsyntaxnode/istight/)() | Получить true, если сжат. |
