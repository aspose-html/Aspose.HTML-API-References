---
title: "TaskListItemSyntaxNode класс"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.toolkit.markdown.syntax.TaskListItemSyntaxNode класс. Узел синтаксиса элемента списка задач"
type: docs

url: /ru/java/com.aspose.html.toolkit.markdown.syntax/tasklistitemsyntaxnode/
---
## TaskListItemSyntaxNode class

Узел синтаксиса элемента списка задач.
...
| Имя | Описание |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/listitemsyntaxnode/accept/)(MarkdownSyntaxVisitor) | Определяет интерфейс для принятия посетителя. |
...
| [getLinesLeadingTrivia](../../com.aspose.html.toolkit.markdown.syntax/multilinecontainerblocksyntaxnode/getlinesleadingtrivia/)() | Определяет интерфейс для получения ведущих строк тривиа |
| [getMarker](../../com.aspose.html.toolkit.markdown.syntax/listitemsyntaxnode/getmarker/)() | Получить маркер |
...
| [isChecked](../../com.aspose.html.toolkit.markdown.syntax/tasklistitemsyntaxnode/ischecked/)() | Определяет интерфейс для получения статуса проверки. |
| [isTight](../../com.aspose.html.toolkit.markdown.syntax/listitemsyntaxnode/istight/)() | Возвращает true, если является плотным. |
