---
title: "Класс LinkDestinationSyntaxNode"
second_title: "Справочник API Aspose.HTML для Java"
description: "Класс com.aspose.html.toolkit.markdown.syntax.LinkDestinationSyntaxNode. Представляет LinkDestinationSyntaxNode"
type: docs

url: /ru/java/com.aspose.html.toolkit.markdown.syntax/linkdestinationsyntaxnode/
---
## LinkDestinationSyntaxNode class

Представляет LinkDestinationSyntaxNode.
...
| Имя | Описание |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/linkdestinationsyntaxnode/accept/)(MarkdownSyntaxVisitor) | Определяет интерфейс для принятия посетителя. |
...
| [getEnumerator](../../com.aspose.html.toolkit.markdown.syntax/inlinecontainersyntaxnode/getenumerator/)() | Возвращает перечислитель, который перебирает элементы коллекции. |
...
| [getValue](../../com.aspose.html.toolkit.markdown.syntax/linkdestinationsyntaxnode/getvalue/)() | Определяет интерфейс для получения значения типа String. |
