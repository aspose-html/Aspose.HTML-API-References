---
title: "TextSyntaxNode класс"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.toolkit.markdown.syntax.textSyntaxNode класс. Реализует текстовый синтаксический узел"
type: docs

url: /ru/java/com.aspose.html.toolkit.markdown.syntax/textsyntaxnode/
---
## TextSyntaxNode class

Реализован узел синтаксиса текста.
...
| Имя | Описание |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/textsyntaxnode/accept/)(MarkdownSyntaxVisitor) | Определяет интерфейс для принятия посетителя. |
