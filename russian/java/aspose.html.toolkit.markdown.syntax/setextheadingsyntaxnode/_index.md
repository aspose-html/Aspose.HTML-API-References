...
description: "com.aspose.html.toolkit.markdown.syntax.SetextHeadingSyntaxNode класс. Представляет узел синтаксиса заголовка Setext"
type: docs
...
| Имя | Описание |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/setextheadingsyntaxnode/accept/)(MarkdownSyntaxVisitor) | Определяет интерфейс для приёма посетителя. |
