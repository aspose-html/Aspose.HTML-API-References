---
title: "SetextHeadingSyntaxNode Класс"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.toolkit.markdown.syntax.SetextHeadingSyntaxNode класс. Представляет синтаксический узел заголовка Setext"
type: docs

url: /ru/java/com.aspose.html.toolkit.markdown.syntax/setextheadingsyntaxnode/
---
## SetextHeadingSyntaxNode class

Представляет узел синтаксиса заголовка Setext.
...
| [getLevel](../../com.aspose.html.toolkit.markdown.syntax/setextheadingsyntaxnode/level/) Получить уровень текущего синтаксиса. |
...
| Имя | Описание |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/setextheadingsyntaxnode/accept/)(MarkdownSyntaxVisitor) | Определяет интерфейс для принятия посетителя. |
