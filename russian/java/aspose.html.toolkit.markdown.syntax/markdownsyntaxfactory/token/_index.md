...
description: "Метод MarkdownSyntaxFactory. Создает MarkdownSyntaxToken"
type: docs

url: /ru/java/com.aspose.html.toolkit.markdown.syntax/markdownsyntaxfactory/token/
---
## Token(SourceText, TextSpan) {#token_1}

Создает [`MarkdownSyntaxToken`](../../markdownsyntaxtoken/).
