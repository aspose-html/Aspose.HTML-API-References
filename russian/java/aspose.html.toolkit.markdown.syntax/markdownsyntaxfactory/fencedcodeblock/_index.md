...
description: "Метод MarkdownSyntaxFactory. Создаёт FencedCodeBlockSyntaxNode"
type: docs

url: /ru/java/com.aspose.html.toolkit.markdown.syntax/markdownsyntaxfactory/fencedcodeblock/
---
## FencedCodeBlock(MarkdownSyntaxToken, TextSyntaxNode) {#fencedcodeblock}

Создаёт [`FencedCodeBlockSyntaxNode`](../../fencedcodeblocksyntaxnode/).
...
| информация | TextSyntaxNode | Элемент TextSyntax. |

### Возвращаемое значение

Элемент FencedCodeBlockSyntax.
