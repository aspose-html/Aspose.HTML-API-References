...
description: "Метод MarkdownSyntaxFactory. Создает TextSyntaxNode"
type: docs

url: /ru/java/com.aspose.html.toolkit.markdown.syntax/markdownsyntaxfactory/escapedcharacter/
---
## EscapedCharacter(char) {#escapedcharacter_1}

Создает [`TextSyntaxNode`](../../textsyntaxnode/).
...
| --- | --- | --- |
| escapedChar | Char | Элемент escapedChar. |
