...
description: "Метод MarkdownSyntaxFactory. Создает ListItemMarker"
type: docs

url: /ru/java/com.aspose.html.toolkit.markdown.syntax/markdownsyntaxfactory/listitemmarker/
---
## ListItemMarker(MarkdownSyntaxToken, MarkdownSyntaxToken) {#listitemmarker_1}

Создает [`ListItemMarker`](../../listitemmarker/).
...
| --- | --- | --- |
| число | MarkdownSyntaxToken | Число. |
| разделитель | MarkdownSyntaxToken | Разделитель. |

### Возвращаемое значение

Маркер ListItemMarker.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| токен | MarkdownSyntaxToken | Токен. |
