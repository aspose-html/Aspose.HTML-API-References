...
description: "Метод MarkdownSyntaxFactory. Создает WhitespaceSyntaxNode"
type: docs

url: /ru/java/com.aspose.html.toolkit.markdown.syntax/markdownsyntaxfactory/characterreference/
---
## MarkdownSyntaxFactory.CharacterReference method

Создает [`WhitespaceSyntaxNode`](../../whitespacesyntaxnode/).
...
| значение | String | Значение String. |
