---
title: "Класс TableCellSyntaxNode"
second_title: "Справочник API Aspose.HTML для Java"
description: "Класс com.aspose.html.toolkit.markdown.syntax.TableCellSyntaxNode. Представляет узел синтаксиса ячейки таблицы"
type: docs

url: /ru/java/com.aspose.html.toolkit.markdown.syntax/tablecellsyntaxnode/
---
## TableCellSyntaxNode class

Представляет узел синтаксиса ячейки таблицы.
...
| [getValue](../../com.aspose.html.toolkit.markdown.syntax/tablecellsyntaxnode/getvalue/)() | Определяет интерфейс для получения значения типа String. |
