---
title: "Класс BlockProxy"
second_title: "Справочник API Aspose.HTML для Java"
description: "Класс com.aspose.html.toolkit.markdown.syntax.BlockProxy. Представляет BlockProxy"
type: docs

url: /ru/java/com.aspose.html.toolkit.markdown.syntax/blockproxy/
---
## BlockProxy class

Представляет BlockProxy.
...
| Имя | Описание |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/blockproxy/accept/)(MarkdownSyntaxVisitor) | Определяет интерфейс для принятия посетителя. |
...
| [getTarget](../../com.aspose.html.toolkit.markdown.syntax/blockproxy/gettarget/)() | Получить целевой узел. |
...
| [writeTo](../../com.aspose.html.toolkit.markdown.syntax/blockproxy/writeto/#writeto)(MarkdownTextWriter) | Определяет интерфейс для записи в writer. |
