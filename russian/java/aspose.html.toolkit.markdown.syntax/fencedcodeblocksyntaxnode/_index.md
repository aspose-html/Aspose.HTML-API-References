---
title: "Класс FencedCodeBlockSyntaxNode"
second_title: "Справочник API Aspose.HTML для Java"
description: "Класс com.aspose.html.toolkit.markdown.syntax.FencedCodeBlockSyntaxNode. Представляет FencedCodeBlockSyntaxNode"
type: docs

url: /ru/java/com.aspose.html.toolkit.markdown.syntax/fencedcodeblocksyntaxnode/
---
## FencedCodeBlockSyntaxNode class

Представляет FencedCodeBlockSyntaxNode.
...
| Имя | Описание |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/fencedcodeblocksyntaxnode/accept/)(MarkdownSyntaxVisitor) | Определяет интерфейс для принятия посетителя. |
...
| [getClosingTag](../../com.aspose.html.toolkit.markdown.syntax/fencedcodeblocksyntaxnode/getclosingtag/)() | Определяет интерфейс для получения закрывающего тега. |
| [getContent](../../com.aspose.html.toolkit.markdown.syntax/fencedcodeblocksyntaxnode/getcontent/)() | Определяет интерфейс для получения содержимого. |
| [getInfo](../../com.aspose.html.toolkit.markdown.syntax/fencedcodeblocksyntaxnode/getinfo/)() | Определяет интерфейс для получения информации. |
...
| [getOpeningTag](../../com.aspose.html.toolkit.markdown.syntax/fencedcodeblocksyntaxnode/getopeningtag/)() | Определяет интерфейс для получения открывающего тега. |
