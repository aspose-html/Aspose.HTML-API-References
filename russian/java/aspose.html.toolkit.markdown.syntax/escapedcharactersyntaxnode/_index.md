---
title: "EscapedCharacterSyntaxNode класс"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.toolkit.markdown.syntax.EscapedCharacterSyntaxNode класс. Реализован узел синтаксиса экранированного символа"
type: docs

url: /ru/java/com.aspose.html.toolkit.markdown.syntax/escapedcharactersyntaxnode/
---
## EscapedCharacterSyntaxNode class

Реализован узел синтаксиса символа экранирования.
...
| [getSource](../../com.aspose.html.toolkit.markdown.syntax/textsyntaxnode/source/) Возвращает исходный текст. |
| [getSpan](../../com.aspose.html.toolkit.markdown.syntax/textsyntaxnode/span/) Определяет интерфейс для получения span. |
| [getValue](../../com.aspose.html.toolkit.markdown.syntax/textsyntaxnode/value/) Определяет свойство для получения строкового значения. |

## Методы

| Имя | Описание |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/escapedcharactersyntaxnode/accept/)(MarkdownSyntaxVisitor) | Определяет интерфейс для принятия посетителя. |
