---
title: "Класс ContainerBlockSyntaxNode"
second_title: "Справочник API Aspose.HTML для Java"
description: "Класс com.aspose.html.toolkit.markdown.syntax.ContainerBlockSyntaxNode. Базовая реализация ContainerBlockSyntaxNode"
type: docs

url: /ru/java/com.aspose.html.toolkit.markdown.syntax/containerblocksyntaxnode/
---
## ContainerBlockSyntaxNode class

Базовая реализация ContainerBlockSyntaxNode.
