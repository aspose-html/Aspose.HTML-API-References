---
title: "Класс TableDelimiterSyntaxNode"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.toolkit.markdown.syntax.TableDelimiterSyntaxNode класс. Представляет узел синтаксиса разделителя таблицы"
type: docs

url: /ru/java/com.aspose.html.toolkit.markdown.syntax/tabledelimitersyntaxnode/
---
## TableDelimiterSyntaxNode class

Представляет узел синтаксиса разделителя таблицы.
