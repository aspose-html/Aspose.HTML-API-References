---
title: "Класс LineBreakSyntaxNode"
second_title: "Справочник API Aspose.HTML для Java"
description: "Класс com.aspose.html.toolkit.markdown.syntax.LineBreakSyntaxNode. Представляет LineBreakSyntaxNode."
type: docs

url: /ru/java/com.aspose.html.toolkit.markdown.syntax/linebreaksyntaxnode/
---
## LineBreakSyntaxNode class

Представляет LineBreakSyntaxNode.
...
| Имя | Описание |
| --- | --- |
| abstract [Accept](../../com.aspose.html.toolkit.markdown.syntax/inlinesyntaxnode/accept/)(MarkdownSyntaxVisitor) | Определяет интерфейс для принятия посетителя. |
