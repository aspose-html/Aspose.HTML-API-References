...
description: "Метод DOMTokenList. Возвращает перечислитель, который проходит по коллекции"
type: docs

url: /ru/java/com.aspose.html.collections/domtokenlist/getenumerator/
---
