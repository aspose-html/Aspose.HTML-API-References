...
description: "com.aspose.html.collections.DOMTokenList класс. Класс DOMTokenList представляет набор токенов, разделённых пробелами. Он индексируется, начиная с 0, как и объекты JavaScript Array. DOMTokenList всегда чувствителен к регистру"
type: docs
...
| Имя | Описание |
| --- | --- |
| [add](../../com.aspose.html.collections/domtokenlist/add/)(params String[]) | Добавляет указанные токен(ы) в список. |
...
| [getEnumerator](../../com.aspose.html.collections/domtokenlist/getenumerator/)() | Возвращает перечислитель, который перебирает элементы коллекции. |
| [getPlatformType](../../com.aspose.html.dom/domobject/getplatformtype/)() | Этот метод используется для получения объекта ECMAScript. |
| [remove](../../com.aspose.html.collections/domtokenlist/remove/)(params String[]) | Удаляет указанные токен(ы) из списка. |
