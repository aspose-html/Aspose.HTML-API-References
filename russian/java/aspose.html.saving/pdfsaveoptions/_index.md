...
description: "Класс com.aspose.html.saving.PdfSaveOptions. Этот конкретный класс данных предоставляет несколько свойств для управления результатом конвертации. Например, PageSetup задаёт характеристики страницы. Обратитесь к статье документации."
type: docs
...
Конкретный класс данных предоставляет несколько свойств для управления результатом конвертации. Например, [`PageSetup`](../../com.aspose.html.rendering/pagesetup/) задаёт характеристики страницы. Обратитесь к статье документации [статья](https://docs.aspose.com/html/net/converting-between-formats/html-to-pdf/#convert-html-to-pdf-using-pdfsaveoptions).
