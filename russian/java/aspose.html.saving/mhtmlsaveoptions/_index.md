...
Представляет параметры сохранения MHTML. Устанавливая конкретные свойства, вы можете управлять обработкой ресурсов, например максимальной глубиной обработки и т.д. Подробнее см. в документации [article](https://docs.aspose.com/html/net/converting-between-formats/html-to-mhtml/#save-options).
