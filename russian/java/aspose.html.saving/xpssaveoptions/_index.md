...
description: "com.aspose.html.saving.XpsSaveOptions класс. Специфический класс данных параметров предоставляет несколько свойств для управления результатом конвертации. Например, PageSetup задаёт характеристики страницы. Обратитесь к статье документации."
type: docs
...
Специфический класс данных параметров предоставляет несколько свойств для управления результатом конвертации. Например, [`PageSetup`](../../com.aspose.html.rendering/pagesetup/) задаёт характеристики страницы. Обратитесь к документации [статья](https://docs.aspose.com/html/net/converting-between-formats/html-to-xps/#save-options).
...
...
      ...
      // Установите размер страницы, поля и измените цвет фона на AntiqueWhite
