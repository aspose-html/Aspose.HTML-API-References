...
description: "Класс com.aspose.html.saving.ImageSaveOptions. Этот конкретный класс данных параметров предоставляет свойства для управления разрешением результата изображения, сглаживанием, качеством, форматом, а также настройками страницы и т.д. Дополнительную информацию можно получить в статье документации."
type: docs
...
| [getText](../../com.aspose.html.rendering.image/imagerenderingoptions/text/) Возвращает объект [`TextOptions`](../../com.aspose.html.rendering.image/textoptions/), который используется для настройки отрисовки текста. |
[getUseAntialiasing]
