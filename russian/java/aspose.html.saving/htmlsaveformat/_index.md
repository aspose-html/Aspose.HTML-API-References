...
description: "Перечисление com.aspose.html.saving.HTMLSaveFormat. Указывает формат, в котором сохраняется документ. Вы можете найти дополнительную информацию о сохранении HTMLDocument в статье"
type: docs
...
| --- | --- | --- |
| Original | `0` | Документ будет сохранён в оригинальном формате. |
