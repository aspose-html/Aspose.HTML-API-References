...
description: "Класс com.aspose.html.saving.MarkdownSaveOptions. Представляет параметры сохранения Markdown. Например, вы можете задать стиль форматирования markdown, использовать предопределённые совместимые с GitLab Flavored Markdown параметры и настроить обработку ресурсов. Подробнее см. в статье."
type: docs
...
| Имя | Описание |
| --- | --- |
| static [getDefault](../../com.aspose.html.saving/markdownsaveoptions/default/) Возвращает набор параметров, совместимых с документацией по умолчанию Markdown. |
