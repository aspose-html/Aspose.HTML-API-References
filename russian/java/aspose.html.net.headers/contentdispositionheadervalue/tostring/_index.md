...
description: "ContentDispositionHeaderValue метод. Возвращает String, представляющий этот экземпляр"
type: docs

url: /ru/java/com.aspose.html.net.headers/contentdispositionheadervalue/toString/
---
