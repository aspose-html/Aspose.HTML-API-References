---
title: "SVGComponentTransferFunctionElement Класс"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.dom.svg.SVGComponentTransferFunctionElement класс. Этот интерфейс определяет базовый интерфейс, используемый интерфейсами функции передачи компонентов"
type: docs

url: /ru/java/com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/
---
## SVGComponentTransferFunctionElement class

Этот интерфейс определяет базовый интерфейс, используемый интерфейсами функций передачи компонентов.
...
| Имя | Описание |
| --- | --- |
| [getAmplitude](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/amplitude/) Соответствует атрибуту ‘amplitude’ в данном элементе. |
...
| [getExponent](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/exponent/) Соответствует атрибуту ‘exponent’ в данном элементе. |
...
| [getIntercept](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/intercept/) Соответствует атрибуту ‘intercept’ в данном элементе. |
...
| [getOffset](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/offset/) Соответствует атрибуту ‘offset’ в данном элементе. |
[getOuterHTML]
...
| [getSlope](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/slope/) Соответствует атрибуту ‘slope’ в данном элементе. |
...
| [getTableValues](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/tablevalues/) Соответствует атрибуту ‘tableValues’ в данном элементе. |
...
| [getType](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/type/) Соответствует атрибуту ‘type’ в данном элементе. Принимает одну из констант SVG_FECOMPONENTTRANSFER_TYPE_*, определённых в этом интерфейсе. |
...
| Имя | Описание |
| --- | --- |
| const [SVG_FECOMPONENTTRANSFER_TYPE_DISCRETE](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_discrete/) | Соответствует значению 'discrete'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_GAMMA](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_gamma/) | Соответствует значению 'gamma'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_IDENTITY](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_identity/) | Соответствует значению 'identity'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_LINEAR](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_linear/) | Соответствует значению 'linear'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_TABLE](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_table/) | Соответствует значению 'table'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_UNKNOWN](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_unknown/) | Тип не является одним из предопределённых типов. Недопустимо пытаться определить новое значение этого типа или пытаться переключить существующее значение на этот тип. |
