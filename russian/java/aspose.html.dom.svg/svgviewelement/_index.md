---
title: "Класс SVGViewElement"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.dom.svg.SVGViewElement класс. Интерфейс SVGViewElement соответствует элементу view"
type: docs

url: /ru/java/com.aspose.html.dom.svg/svgviewelement/
---
## SVGViewElement class

Интерфейс SVGViewElement соответствует элементу ‘view’.
...
| [getPreserveAspectRatio](../../com.aspose.html.dom.svg/svgviewelement/preserveaspectratio/) Соответствует атрибуту ‘preserveAspectRatio’ данного элемента. |
...
| [getViewBox](../../com.aspose.html.dom.svg/svgviewelement/viewbox/) Соответствует атрибуту ‘viewBox’ данного элемента. |
...
| [getViewTarget](../../com.aspose.html.dom.svg/svgviewelement/viewtarget/) Соответствует атрибуту ‘viewTarget’ данного элемента ‘view’. Список значений DOMString, содержащих имена, указанные в атрибуте ‘viewTarget’. Каждое из значений DOMString может быть связано с соответствующим элементом с помощью вызова метода getElementById(). |
[getZoomAndPan]
