---
title: "Класс SVGPathElement"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.dom.svg.SVGPathElement класс. Интерфейс SVGPathElement соответствует элементу path."
type: docs

url: /ru/java/com.aspose.html.dom.svg/svgpathelement/
---
## SVGPathElement class

Интерфейс SVGPathElement соответствует элементу ‘path’.
...
| Имя | Описание |
| --- | --- |
| [getAnimatedPathSegList](../../com.aspose.html.dom.svg/svgpathelement/animatedpathseglist/) Предоставляет доступ к текущему анимированному содержимому атрибута ‘d’ в форме, полностью соответствующей синтаксису SVG. Если указанный атрибут или свойство анимируется, содержит текущее анимированное значение атрибута или свойства, и как сам объект, так и его содержимое доступны только для чтения. Если указанный атрибут или свойство в данный момент не анимируется, содержит то же значение, что и pathSegList. |
...
| [getFarthestViewportElement](../../com.aspose.html.dom.svg/svggraphicselement/farthestviewportelement/) Самый дальний предок ‘svg’ элемент. Null, если текущий элемент является самым внешним svg элементом. |
...
| [getNearestViewportElement](../../com.aspose.html.dom.svg/svggraphicselement/nearestviewportelement/) Элемент, который установил текущий viewport. Чаще всего ближайший предок ‘svg’ элемент. Null, если текущий элемент является самым внешним svg элементом. |
...
| [getPathLength](../../com.aspose.html.dom.svg/svggeometryelement/pathlength/) Соответствует атрибуту pathLength на данном элементе. |
[getPathSegList]
...
| [getStyle](../../com.aspose.html.dom.svg/svgelement/style/) Соответствует атрибуту ‘style’ указанного элемента. Если пользовательский агент не поддерживает стилизацию с помощью CSS, этот атрибут всегда должен иметь значение null. |
...
| [getViewportElement](../../com.aspose.html.dom.svg/svgelement/viewportelement/) Элемент, задающий текущий viewport. Обычно это ближайший предок‑элемент ‘svg’. Null, если данный элемент является самым внешним элементом svg. |
...
| [createSVGPathSegArcAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegarcabs/)(float, float, float, float, float, bool, bool) | Возвращает отдельный, безродительский объект SVGPathSegArcAbs. |
| [createSVGPathSegArcRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegarcrel/)(float, float, float, float, float, bool, bool) | Возвращает отдельный, безродительский объект SVGPathSegArcRel. |
| [createSVGPathSegClosePath](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegclosepath/)() | Возвращает отдельный, безродительский объект SVGPathSegClosePath. |
| [createSVGPathSegCurvetoCubicAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicabs/)(float, float, float, float, float, float) | Возвращает отдельный, безродительский объект SVGPathSegCurvetoCubicAbs. |
| [createSVGPathSegCurvetoCubicRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicrel/)(float, float, float, float, float, float) | Возвращает отдельный, безродительский объект SVGPathSegCurvetoCubicRel. |
| [createSVGPathSegCurvetoCubicSmoothAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothabs/)(float, float, float, float) | Возвращает отдельный, безродительский объект SVGPathSegCurvetoCubicSmoothAbs. |
| [createSVGPathSegCurvetoCubicSmoothRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothrel/)(float, float, float, float) | Возвращает отдельный, безродительский объект SVGPathSegCurvetoCubicSmoothRel. |
| [createSVGPathSegCurvetoQuadraticAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticabs/)(float, float, float, float) | Возвращает автономный, безродительский объект SVGPathSegCurvetoQuadraticAbs. |
| [createSVGPathSegCurvetoQuadraticRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticrel/)(float, float, float, float) | Возвращает автономный, безродительский объект SVGPathSegCurvetoQuadraticRel. |
| [createSVGPathSegCurvetoQuadraticSmoothAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothabs/)(float, float) | Возвращает автономный, безродительский объект SVGPathSegCurvetoQuadraticSmoothAbs. |
| [createSVGPathSegCurvetoQuadraticSmoothRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothrel/)(float, float) | Возвращает автономный, безродительский объект SVGPathSegCurvetoQuadraticSmoothRel. |
| [createSVGPathSegLinetoAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoabs/)(float, float) | Возвращает автономный, безродительский объект SVGPathSegLinetoAbs. |
| [createSVGPathSegLinetoHorizontalAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetohorizontalabs/)(float) | Возвращает автономный, безродительский объект SVGPathSegLinetoHorizontalAbs. |
| [createSVGPathSegLinetoHorizontalRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetohorizontalrel/)(float) | Возвращает автономный, безродительский объект SVGPathSegLinetoHorizontalRel. |
| [createSVGPathSegLinetoRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetorel/)(float, float) | Возвращает автономный, безродительский объект SVGPathSegLinetoRel. |
| [createSVGPathSegLinetoVerticalAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoverticalabs/)(float) | Возвращает автономный, безродительский объект SVGPathSegLinetoVerticalAbs. |
| [createSVGPathSegLinetoVerticalRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoverticalrel/)(float) | Возвращает автономный, безродительский объект SVGPathSegLinetoVerticalRel. |
| [createSVGPathSegMovetoAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegmovetoabs/)(float, float) | Возвращает автономный, безродительский объект SVGPathSegMovetoAbs. |
| [createSVGPathSegMovetoRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegmovetorel/)(float, float) | Возвращает автономный, безродительский объект SVGPathSegMovetoRel. |
...
| [getBBox](../../com.aspose.html.dom.svg/svggraphicselement/getbbox/)() | Возвращает плотный ограничивающий прямоугольник в текущем пользовательском пространстве (т.е. после применения атрибута ‘transform’, если он присутствует) по геометрии всех вложенных графических элементов, исключая обводку, обрезку, маскирование и эффекты фильтров). Обратите внимание, что getBBox должен возвращать фактический ограничивающий прямоугольник в момент вызова метода, даже если элемент ещё не был отрисован. |
| [getCTM](../../com.aspose.html.dom.svg/svggraphicselement/getctm/)() | Возвращает матрицу преобразования от текущих пользовательских единиц (т.е. после применения атрибута ‘transform’, если он присутствует) к системе координат viewport для nearestViewportElement. |
...
| [getEquivalentPath](../../com.aspose.html.dom.svg/svggeometryelement/getequivalentpath/)() | Возвращает новый экземпляр [`SVGPathSegList`](../../com.aspose.html.dom.svg.paths/svgpathseglist/), который представляет [`SVGGeometryElement`](../svggeometryelement/) в виде сегментов пути. |
| [getPlatformType](../../com.aspose.html.dom/domobject/getplatformtype/)() | Этот метод используется для получения объекта ECMAScript. |
| [getPointAtLength](../../com.aspose.html.dom.svg/svggeometryelement/getpointatlength/)(float) | Возвращает координату (x,y) в пользовательском пространстве, измеряемую в единицах расстояния вдоль пути, используя алгоритм расстояния вдоль пути пользовательского агента. |
| [getScreenCTM](../../com.aspose.html.dom.svg/svggraphicselement/getscreenctm/)() | Возвращает матрицу преобразования от текущих пользовательских единиц (т.е. после применения атрибута ‘transform’, если он присутствует) к «пикселю», определяемому родительским пользовательским агентом. Для дисплейных устройств это, как правило, физический пиксель экрана. Для других устройств или сред, где размеры физических пикселей неизвестны, может использоваться алгоритм, аналогичный определению «пикселя» в CSS2. Обратите внимание, что возвращается null, если этот элемент не включён в дерево документа. Этот метод мог бы быть более точно назван getClientCTM, но имя getScreenCTM сохраняется по историческим причинам. |
| [getTotalLength](../../com.aspose.html.dom.svg/svggeometryelement/gettotallength/)() | Возвращает вычисленное пользовательским агентом значение общей длины пути с использованием алгоритма расстояния вдоль пути пользовательского агента, в виде расстояния в текущей пользовательской системе координат. |
