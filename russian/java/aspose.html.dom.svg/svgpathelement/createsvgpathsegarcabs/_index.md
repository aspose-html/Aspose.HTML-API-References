...
description: "Метод SVGPathElement. Возвращает отдельный объект SVGPathSegArcAbs без родителя"
type: docs
...
| угол | Single | Угол вращения в градусах оси X эллипса относительно оси X системы координат пользователя. |
| largeArcFlag | Boolean | Значение параметра large-arc-flag. |
| sweepFlag | Boolean | Значение параметра large-arc-flag. |

### Возвращаемое значение

Отдельный объект SVGPathSegArcAbs без родителя.
