---
title: "Класс SVGAnimationElement"
second_title: "Справочник API Aspose.HTML для Java"
description: "Класс com.aspose.html.dom.svg.SVGAnimationElement. Интерфейс SVGAnimationElement является базовым интерфейсом для всех интерфейсов анимационных элементов SVGAnimateElement, SVGSetElement, SVGAnimateColorElement, SVGAnimateMotionElement и SVGAnimateTransformElement"
type: docs

url: /ru/java/com.aspose.html.dom.svg/svganimationelement/
---
## SVGAnimationElement class

Интерфейс SVGAnimationElement является базовым интерфейсом для всех интерфейсов анимационных элементов: SVGAnimateElement, SVGSetElement, SVGAnimateColorElement, SVGAnimateMotionElement и SVGAnimateTransformElement.
...
| [getRequiredExtensions](../../com.aspose.html.dom.svg/svganimationelement/requiredextensions/) Соответствует атрибуту ‘requiredExtensions’ данного элемента. |
| [getRequiredFeatures](../../com.aspose.html.dom.svg/svganimationelement/requiredfeatures/) Соответствует атрибуту ‘requiredFeatures’ данного элемента. |
...
| [getSystemLanguage](../../com.aspose.html.dom.svg/svganimationelement/systemlanguage/) Соответствует атрибуту ‘systemLanguage’ данного элемента. |
| [getTagName](../../com.aspose.html.dom/element/tagname/) Имя элемента. |
| [getTargetElement](../../com.aspose.html.dom.svg/svganimationelement/targetelement/) Элемент, который анимируется. |
