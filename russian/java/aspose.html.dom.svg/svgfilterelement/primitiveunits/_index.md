...
description: "Свойство SVGFilterElement. Соответствует атрибуту primitiveUnits в данном элементе filter. Принимает одну из констант, определённых в SVGUnitTypes."
type: docs

url: /ru/java/com.aspose.html.dom.svg/svgfilterelement/primitiveunits/
---
