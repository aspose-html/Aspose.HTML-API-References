...
description: "com.aspose.html.dom.svg.SVGFilterElement класс. Интерфейс SVGFilterElement соответствует элементу filter."
type: docs
...
| [X](../../com.aspose.html.dom.svg/svgfilterelement/x/) { get; } | Соответствует атрибуту ‘x’ данного элемента ‘filter’. |
| [Y](../../com.aspose.html.dom.svg/svgfilterelement/y/) { get; } | Соответствует атрибуту ‘y’ данного элемента ‘filter’. |
