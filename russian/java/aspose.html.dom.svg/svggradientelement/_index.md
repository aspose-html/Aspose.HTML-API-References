...
description: "com.aspose.html.dom.svg.SVGGradientElement class. Интерфейс SVGGradientElement является базовым интерфейсом, используемым SVGLinearGradientElement и SVGRadialGradientElement."
type: docs
