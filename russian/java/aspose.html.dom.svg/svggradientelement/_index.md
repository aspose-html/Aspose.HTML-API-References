---
title: "Класс SVGGradientElement"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.dom.svg.SVGGradientElement класс. Интерфейс SVGGradientElement является базовым интерфейсом, используемым SVGLinearGradientElement и SVGRadialGradientElement"
type: docs

url: /ru/java/com.aspose.html.dom.svg/svggradientelement/
---
## SVGGradientElement class

Интерфейс SVGGradientElement является базовым интерфейсом, используемым SVGLinearGradientElement и SVGRadialGradientElement.
...
| [getGradientTransform](../../com.aspose.html.dom.svg/svggradientelement/gradienttransform/) Соответствует атрибуту ‘gradientTransform’ в данном элементе. |
| [getGradientUnits](../../com.aspose.html.dom.svg/svggradientelement/gradientunits/) Соответствует атрибуту ‘gradientUnits’ в данном элементе. Принимает одну из констант, определённых в SVGUnitTypes. |
| [getHref](../../com.aspose.html.dom.svg/svggradientelement/href/) Соответствует атрибуту ‘xlink:href’ в данном элементе. |
[getId]
...
| [getSpreadMethod](../../com.aspose.html.dom.svg/svggradientelement/spreadmethod/) Соответствует атрибуту ‘spreadMethod’ данного элемента. Один из типов Spread Method, определённых в этом интерфейсе. |
...
| Имя | Описание |
| --- | --- |
| const [SVG_SPREADMETHOD_PAD](../../com.aspose.html.dom.svg/svggradientelement/svg_spreadmethod_pad/) | Соответствует значению 'pad'. |
| const [SVG_SPREADMETHOD_REFLECT](../../com.aspose.html.dom.svg/svggradientelement/svg_spreadmethod_reflect/) | Соответствует значению 'reflect'. |
| const [SVG_SPREADMETHOD_REPEAT](../../com.aspose.html.dom.svg/svggradientelement/svg_spreadmethod_repeat/) | Соответствует значению 'repeat'. |
| const [SVG_SPREADMETHOD_UNKNOWN](../../com.aspose.html.dom.svg/svggradientelement/svg_spreadmethod_unknown/) | Тип не является одним из предопределённых типов. Недопустимо пытаться определить новое значение этого типа или пытаться переключить существующее значение на этот тип. |
