...
description: "Метод SVGGraphicsElement. Возвращает плотный ограничивающий прямоугольник в текущем пользовательском пространстве, т.е. после применения атрибута transform, если он присутствует, к геометрии всех вложенных графических элементов, исключая обводку, обрезку, маскирование и эффекты фильтра. Обратите внимание, что getBBox должен возвращать фактический ограничивающий прямоугольник в момент вызова метода, даже если элемент ещё не был отрисован."
type: docs
