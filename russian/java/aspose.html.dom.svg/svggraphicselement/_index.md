...
description: "com.aspose.html.dom.svg.SVGGraphicsElement class. Интерфейс SVGGraphicsElement представляет SVG‑элементы, основное назначение которых — непосредственное отрисовывание графики в группу"
type: docs
...
Интерфейс SVGGraphicsElement представляет SVG‑элементы, основной целью которых является непосредственное отрисовывание графики в группу.
