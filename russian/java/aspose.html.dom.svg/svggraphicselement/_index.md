---
title: "Класс SVGGraphicsElement"
second_title: "Справочник API Aspose.HTML для Java"
description: "Класс com.aspose.html.dom.svg.SVGGraphicsElement. Интерфейс SVGGraphicsElement представляет SVG‑элементы, основная цель которых — непосредственно отрисовывать графику в группу."
type: docs

url: /ru/java/com.aspose.html.dom.svg/svggraphicselement/
---
## SVGGraphicsElement class

Интерфейс SVGGraphicsElement представляет SVG‑элементы, основное назначение которых — непосредственно отрисовывать графику в группе.
