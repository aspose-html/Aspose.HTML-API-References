---
title: "Класс SVGAnimateElement"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.dom.svg.SVGAnimateElement class. Интерфейс SVGAnimateElement соответствует элементу animate. Объектно-ориентированный доступ к атрибутам элемента animate через SVG DOM недоступен"
type: docs
