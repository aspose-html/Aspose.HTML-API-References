---
title: "SVGAnimateElement Класс"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.dom.svg.SVGAnimateElement класс. Интерфейс SVGAnimateElement соответствует элементу animate. Объектно-ориентированный доступ к атрибутам элемента animate через SVG DOM недоступен"
type: docs

url: /ru/java/com.aspose.html.dom.svg/svganimateelement/
---
## SVGAnimateElement class

Интерфейс SVGAnimateElement соответствует элементу ‘animate’. Объектно-ориентированный доступ к атрибутам элемента ‘animate’ через SVG DOM недоступен.
