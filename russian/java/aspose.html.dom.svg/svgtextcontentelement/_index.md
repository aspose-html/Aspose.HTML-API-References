...
description: "com.aspose.html.dom.svg.SVGTextContentElement class. Класс SVGTextContentElement наследуется различными интерфейсами, связанными с текстом, такими как SVGTextElement, SVGTSpanElement, SVGTRefElement, SVGAltGlyphElement и SVGTextPathElement. Для методов этого интерфейса, которые ссылаются на индекс символа или количество символов, эти ссылки следует интерпретировать как индекс кода UTF‑16 или количество кодовых единиц UTF‑16 соответственно. Это сделано для согласованности с DOM Level 2 Core, где методы интерфейса CharacterData используют кодовые единицы UTF‑16 в качестве индексов и счётчиков внутри символьных данных. Таким образом, например, если текстовое содержимое текстового элемента представляет собой один символ за пределами BMP, например U10000, то вызов getNumberOfChars для этого элемента вернёт 2, поскольку для представления этого одного символа используется пара суррогатных кодовых единиц UTF‑16."
type: docs
...
Интерфейс SVGTextContentElement наследуется различными интерфейсами, связанными с текстом, такими как SVGTextElement, SVGTSpanElement, SVGTRefElement, SVGAltGlyphElement и SVGTextPathElement. Для методов этого интерфейса, которые ссылаются на индекс символа или количество символов, эти ссылки следует интерпретировать соответственно как индекс кода UTF‑16 или количество кодов UTF‑16. Это сделано для согласованности с DOM Level 2 Core, где методы интерфейса CharacterData используют коды UTF‑16 в качестве индексов и счётчиков внутри символьных данных. Таким образом, например, если текстовое содержимое элемента ‘text’ представляет собой один символ за пределами BMP, например U+10000, то вызов getNumberOfChars для этого элемента вернёт 2, поскольку для представления этого одного символа используется два кода UTF‑16 (суррогатная пара).
