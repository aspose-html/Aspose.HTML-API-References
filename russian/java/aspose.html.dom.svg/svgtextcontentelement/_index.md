---
title: "Класс SVGTextContentElement"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.dom.svg.SVGTextContentElement класс. SVGTextContentElement наследуется различными интерфейсами, связанными с текстом, такими как SVGTextElement, SVGTSpanElement, SVGTRefElement, SVGAltGlyphElement и SVGTextPathElement. Для методов этого интерфейса, которые ссылаются на индекс символа или количество символов, эти ссылки следует трактовать как индекс кода UTF‑16 или количество кодовых единиц UTF‑16 соответственно. Это делается для согласованности с DOM Level 2 Core, где методы интерфейса CharacterData используют кодовые единицы UTF‑16 в качестве индексов и счётчиков внутри данных символов. Таким образом, например, если содержимое текстового элемента представляет собой один символ за пределами BMP, например U10000, то вызов getNumberOfChars для этого элемента вернёт 2, поскольку для представления этого одного символа используется пара суррогатных кодовых единиц UTF‑16."
type: docs

url: /ru/java/com.aspose.html.dom.svg/svgtextcontentelement/
---
...
| [getLengthAdjust](../../com.aspose.html.dom.svg/svgtextcontentelement/lengthadjust/) Соответствует атрибуту ‘lengthAdjust’ в данном элементе. Значение должно быть одним из констант length adjust, определённых в этом интерфейсе. |
...
| [getTextLength](../../com.aspose.html.dom.svg/svgtextcontentelement/textlength/) Соответствует атрибуту ‘textLength’ в данном элементе. |
...
| [getComputedTextLength](../../com.aspose.html.dom.svg/svgtextcontentelement/getcomputedtextlength/)() | Общая сумма всех значений advance, полученных при рендеринге всех символов внутри этого элемента, включая значение advance глифов (горизонтальное или вертикальное), влияние свойств ‘kerning’, ‘letter-spacing’ и ‘word-spacing’ и корректировки, вызванные атрибутами ‘dx’ и ‘dy’ в элементах ‘tspan’. Для сред, не выполняющих рендеринг, пользовательский агент должен делать разумные предположения о метриках глифов. |
...
| [getNumberOfChars](../../com.aspose.html.dom.svg/svgtextcontentelement/getnumberofchars/)() | Возвращает общее количество символов, доступных для рендеринга в текущем элементе, включая символы, полученные из ссылки ‘tref’, независимо от того, будут ли они отрисованы. По сути, это эквивалентно длине атрибута Node::textContent из DOM Level 3 Core ([DOM3], раздел 1.4), если этот атрибут также раскрывает элементы ‘tref’. |
...
| Имя | Описание |
| --- | --- |
| const [LENGTHADJUST_SPACING](../../com.aspose.html.dom.svg/svgtextcontentelement/lengthadjust_spacing/) | Соответствует значению 'spacing'. |
| const [LENGTHADJUST_SPACINGANDGLYPHS](../../com.aspose.html.dom.svg/svgtextcontentelement/lengthadjust_spacingandglyphs/) | Соответствует значению 'spacingAndGlyphs'. |
| const [LENGTHADJUST_UNKNOWN](../../com.aspose.html.dom.svg/svgtextcontentelement/lengthadjust_unknown/) | Перечисление было установлено в значение, которое не является одним из предопределённых типов. Недопустимо пытаться определить новое значение этого типа или пытаться переключить существующее значение на этот тип. |
