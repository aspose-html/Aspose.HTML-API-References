...
description: "Класс com.aspose.html.dom.svg.SVGElementInstance. Корневой объект каждого теневого дерева элемента use реализует интерфейс SVGUseElementShadowRoot. В настоящее время этот интерфейс не определяет никаких расширений свойств и методов, определённых для интерфейса ShadowRoot и миксина DocumentOrShadowRoot. Однако дерево, корневое в этом узле, полностью доступно только для чтения с точки зрения скриптов автора."
type: docs
