...
| [getClipPathUnits](../../com.aspose.html.dom.svg/svgclippathelement/clippathunits/) Соответствует атрибуту ‘clipPathUnits’ у указанного элемента ‘clipPath’. Принимает одну из констант, определённых в SVGUnitTypes. |
...
| [getTransform](../../com.aspose.html.dom.svg/svgclippathelement/transform/) Соответствует атрибуту ‘transform’ у указанного элемента. |
