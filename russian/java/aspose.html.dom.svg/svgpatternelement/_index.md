---
title: "SVGPatternElement класс"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.dom.svg.SVGPatternElement class. Интерфейс SVGPatternElement соответствует элементу pattern."
type: docs
...
| [getHeight](../../com.aspose.html.dom.svg/svgpatternelement/height/) Соответствует атрибуту ‘height’ указанного элемента ‘pattern’. |
| [getHref](../../com.aspose.html.dom.svg/svgpatternelement/href/) Соответствует атрибуту ‘xlink:href’ указанного элемента. |
[getId]
...
| [getPatternContentUnits](../../com.aspose.html.dom.svg/svgpatternelement/patterncontentunits/) Соответствует атрибуту ‘patternContentUnits’ указанного элемента ‘pattern’. Принимает одну из констант, определённых в SVGUnitTypes. |
| [getPatternTransform](../../com.aspose.html.dom.svg/svgpatternelement/patterntransform/) Соответствует атрибуту ‘patternTransform’ указанного элемента ‘pattern’. |
| [getPatternUnits](../../com.aspose.html.dom.svg/svgpatternelement/patternunits/) Соответствует атрибуту ‘patternUnits’ указанного элемента ‘pattern’. Принимает одну из констант, определённых в SVGUnitTypes. |
...
| [getPreserveAspectRatio](../../com.aspose.html.dom.svg/svgpatternelement/preserveaspectratio/) Соответствует атрибуту ‘preserveAspectRatio’ указанного элемента. |
...
| [getRequiredExtensions](../../com.aspose.html.dom.svg/svgpatternelement/requiredextensions/) Соответствует атрибуту ‘requiredExtensions’ указанного элемента. |
| [getRequiredFeatures](../../com.aspose.html.dom.svg/svgpatternelement/requiredfeatures/) Соответствует атрибуту ‘requiredFeatures’ указанного элемента. |
...
| [getSystemLanguage](../../com.aspose.html.dom.svg/svgpatternelement/systemlanguage/) Соответствует атрибуту ‘systemLanguage’ указанного элемента. |
...
| [getViewBox](../../com.aspose.html.dom.svg/svgpatternelement/viewbox/) Соответствует атрибуту ‘viewBox’ указанного элемента. |
...
| [getWidth](../../com.aspose.html.dom.svg/svgpatternelement/width/) Соответствует атрибуту ‘width’ указанного элемента ‘pattern’. |
| [X](../../com.aspose.html.dom.svg/svgpatternelement/x/) { get; } | Соответствует атрибуту ‘x’ указанного элемента ‘pattern’. |
| [Y](../../com.aspose.html.dom.svg/svgpatternelement/y/) { get; } | Соответствует атрибуту ‘y’ указанного элемента ‘pattern’. |
