---
title: "Класс SVGAnimateTransformElement"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.dom.svg.SVGAnimateTransformElement класс. Интерфейс SVGAnimateTransformElement соответствует элементу animateTransform. Объектно-ориентированный доступ к атрибутам элемента animateTransform через SVG DOM недоступен."
type: docs

url: /ru/java/com.aspose.html.dom.svg/svganimatetransformelement/
---
## SVGAnimateTransformElement class

Интерфейс SVGAnimateTransformElement соответствует элементу ‘animateTransform’. Объектно-ориентированный доступ к атрибутам элемента ‘animateTransform’ через SVG DOM недоступен.
