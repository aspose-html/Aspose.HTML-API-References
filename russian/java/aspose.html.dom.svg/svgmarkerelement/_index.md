...
description: "com.aspose.html.dom.svg.SVGMarkerElement class. Интерфейс SVGMarkerElement соответствует элементу marker."
type: docs
...
| [getMarkerWidth](../../com.aspose.html.dom.svg/svgmarkerelement/markerwidth/) Соответствует атрибуту ‘markerWidth’ в заданном элементе ‘marker’. |
...
| [getOrientAngle](../../com.aspose.html.dom.svg/svgmarkerelement/orientangle/) Соответствует атрибуту ‘orient’ в заданном элементе ‘marker’. Если markerUnits равно SVG_MARKER_ORIENT_ANGLE, используется значение угла для атрибута ‘orient’; в противном случае будет установлено ноль. |
| [getOrientType](../../com.aspose.html.dom.svg/svgmarkerelement/orienttype/) Соответствует атрибуту ‘orient’ в заданном элементе ‘marker’. Одна из типов ориентации маркера, определённых в этом интерфейсе. |
[getOuterHTML]
...
| [getPreserveAspectRatio](../../com.aspose.html.dom.svg/svgmarkerelement/preserveaspectratio/) Соответствует атрибуту ‘preserveAspectRatio’ в заданном элементе. |
...
| [getRefX](../../com.aspose.html.dom.svg/svgmarkerelement/refx/) Соответствует атрибуту ‘refX’ в заданном элементе ‘marker’. |
| [getRefY](../../com.aspose.html.dom.svg/svgmarkerelement/refy/) Соответствует атрибуту ‘refY’ в заданном элементе ‘marker’. |
...
| [getViewBox](../../com.aspose.html.dom.svg/svgmarkerelement/viewbox/) Соответствует атрибуту ‘viewBox’ в заданном элементе. |
...
| const [SVG_MARKERUNITS_UNKNOWN](../../com.aspose.html.dom.svg/svgmarkerelement/svg_markerunits_unknown/) | Тип единицы маркера не является одним из предопределённых типов. Недопустимо пытаться определить новое значение этого типа или переключать существующее значение на этот тип. |
...
| const [SVG_MARKER_ORIENT_UNKNOWN](../../com.aspose.html.dom.svg/svgmarkerelement/svg_marker_orient_unknown/) | Ориентация маркера не является одним из предопределённых типов. Недопустимо пытаться определить новое значение этого типа или переключать существующее значение на этот тип. |
