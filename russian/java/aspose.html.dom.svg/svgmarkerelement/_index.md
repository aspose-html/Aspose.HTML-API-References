---
title: "Класс SVGMarkerElement"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.dom.svg.SVGMarkerElement класс. Интерфейс SVGMarkerElement соответствует элементу marker"
type: docs

url: /ru/java/com.aspose.html.dom.svg/svgmarkerelement/
---
## SVGMarkerElement class

Интерфейс SVGMarkerElement соответствует элементу ‘marker’.
...
| [getMarkerHeight](../../com.aspose.html.dom.svg/svgmarkerelement/markerheight/) Соответствует атрибуту ‘markerHeight’ данного элемента ‘marker’. |
| [getMarkerUnits](../../com.aspose.html.dom.svg/svgmarkerelement/markerunits/) Соответствует атрибуту ‘markerUnits’ данного элемента ‘marker’. Один из типов единиц маркера, определённых в этом интерфейсе. |
| [getMarkerWidth](../../com.aspose.html.dom.svg/svgmarkerelement/markerwidth/) Соответствует атрибуту ‘markerWidth’ в данном элементе ‘marker’. |
...
| [getOrientAngle](../../com.aspose.html.dom.svg/svgmarkerelement/orientangle/) Соответствует атрибуту ‘orient’ в данном элементе ‘marker’. Если markerUnits имеет значение SVG_MARKER_ORIENT_ANGLE, используется значение угла для атрибута ‘orient’; в противном случае будет установлено ноль. |
| [getOrientType](../../com.aspose.html.dom.svg/svgmarkerelement/orienttype/) Соответствует атрибуту ‘orient’ в данном элементе ‘marker’. Одна из типов ориентации маркера, определённых в этом интерфейсе. |
[getOuterHTML]
...
| [getPreserveAspectRatio](../../com.aspose.html.dom.svg/svgmarkerelement/preserveaspectratio/) Соответствует атрибуту ‘preserveAspectRatio’ в данном элементе. |
...
| [getRefX](../../com.aspose.html.dom.svg/svgmarkerelement/refx/) Соответствует атрибуту ‘refX’ в данном элементе ‘marker’. |
| [getRefY](../../com.aspose.html.dom.svg/svgmarkerelement/refy/) Соответствует атрибуту ‘refY’ в данном элементе ‘marker’. |
...
| [getViewBox](../../com.aspose.html.dom.svg/svgmarkerelement/viewbox/) Соответствует атрибуту ‘viewBox’ в данном элементе. |
...
| [setOrientToAngle](../../com.aspose.html.dom.svg/svgmarkerelement/setorienttoangle/)(SVGAngle) | Устанавливает значение атрибута ‘orient’ в заданный угол. |
| [setOrientToAuto](../../com.aspose.html.dom.svg/svgmarkerelement/setorienttoauto/)() | Устанавливает значение атрибута ‘orient’ в 'auto'. |
...
| Имя | Описание |
| --- | --- |
| const [SVG_MARKERUNITS_STROKEWIDTH](../../com.aspose.html.dom.svg/svgmarkerelement/svg_markerunits_strokewidth/) | Значение атрибута ‘markerUnits’ равно 'strokeWidth'. |
| const [SVG_MARKERUNITS_UNKNOWN](../../com.aspose.html.dom.svg/svgmarkerelement/svg_markerunits_unknown/) | Тип единицы маркера не относится к предопределённым типам. Недопустимо пытаться определить новое значение этого типа или переключать существующее значение на этот тип. |
| const [SVG_MARKERUNITS_USERSPACEONUSE](../../com.aspose.html.dom.svg/svgmarkerelement/svg_markerunits_userspaceonuse/) | Значение атрибута ‘markerUnits’ равно 'userSpaceOnUse'. |
| const [SVG_MARKER_ORIENT_ANGLE](../../com.aspose.html.dom.svg/svgmarkerelement/svg_marker_orient_angle/) | Атрибут ‘orient’ имеет значение угла. |
| const [SVG_MARKER_ORIENT_AUTO](../../com.aspose.html.dom.svg/svgmarkerelement/svg_marker_orient_auto/) | Атрибут ‘orient’ имеет значение 'auto'. |
| const [SVG_MARKER_ORIENT_UNKNOWN](../../com.aspose.html.dom.svg/svgmarkerelement/svg_marker_orient_unknown/) | Ориентация маркера не относится к предопределённым типам. Недопустимо пытаться определить новое значение этого типа или переключать существующее значение на этот тип. |
