...
description: "com.aspose.html.dom.svg.SVGElement class. Все интерфейсы SVG DOM, которые напрямую соответствуют элементам SVG, такие как интерфейс SVGPathElement для элемента path, наследуются от интерфейса SVGElement"
type: docs
