---
title: "Класс SVGElement"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.dom.svg.SVGElement class. Все интерфейсы SVG DOM, которые напрямую соответствуют элементам языка SVG, такие как интерфейс SVGPathElement для элемента path, наследуются от интерфейса SVGElement"
type: docs

url: /ru/java/com.aspose.html.dom.svg/svgelement/
---
## SVGElement class

Все интерфейсы SVG DOM, которые напрямую соответствуют элементам языка SVG (например, интерфейс SVGPathElement для элемента ‘path’), наследуются от интерфейса SVGElement.
