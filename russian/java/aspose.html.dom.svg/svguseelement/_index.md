...
description: "Класс com.aspose.html.dom.svg.SVGUseElement. Интерфейс SVGUseElement соответствует элементу use."
type: docs
...
| [getHeight](../../com.aspose.html.dom.svg/svguseelement/height/) Соответствует атрибуту ‘height’ указанного элемента ‘use’. |
| [getHref](../../com.aspose.html.dom.svg/svguseelement/href/) Соответствует атрибуту ‘xlink:href’ указанного элемента. |
[getId]
...
| [getWidth](../../com.aspose.html.dom.svg/svguseelement/width/) Соответствует атрибуту ‘width’ указанного элемента ‘use’. |
| [X](../../com.aspose.html.dom.svg/svguseelement/x/) { get; } | Соответствует атрибуту ‘x’ указанного элемента ‘use’. |
| [Y](../../com.aspose.html.dom.svg/svguseelement/y/) { get; } | Соответствует атрибуту ‘y’ указанного элемента ‘use’. |
