---
title: "Класс SVGGeometryElement"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.dom.svg.SVGGeometryElement класс. Интерфейс SVGGeometryElement представляет SVG‑элементы, рендеринг которых определяется геометрией с эквивалентным путём и которые могут быть заполнены и обведены. Это включает пути и базовые формы"
type: docs

url: /ru/java/com.aspose.html.dom.svg/svggeometryelement/
---
## SVGGeometryElement class

Интерфейс SVGGeometryElement представляет SVG‑элементы, рендеринг которых определяется геометрией с эквивалентным путём и которые могут быть заполнены и обведены. Это включает пути и базовые фигуры.
...
| [getEquivalentPath](../../com.aspose.html.dom.svg/svggeometryelement/getequivalentpath/)() | Возвращает новый экземпляр [`SVGPathSegList`](../../com.aspose.html.dom.svg.paths/svgpathseglist/), который представляет `SVGGeometryElement` в виде сегментов пути. |
