---
title: "Класс SVGSetElement"
second_title: "Справочник API Aspose.HTML для Java"
description: "Класс com.aspose.html.dom.svg.SVGSetElement. Интерфейс SVGSetElement соответствует элементу set. Объектно-ориентированный доступ к атрибутам элемента set через SVG DOM недоступен"
type: docs

url: /ru/java/com.aspose.html.dom.svg/svgsetelement/
---
## SVGSetElement class

Интерфейс SVGSetElement соответствует элементу ‘set’. Объектно-ориентированный доступ к атрибутам элемента ‘set’ через SVG DOM недоступен.
