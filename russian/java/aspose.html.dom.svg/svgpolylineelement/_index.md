---
title: "SVGPolylineElement Класс"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.dom.svg.SVGPolylineElement класс. Интерфейс SVGPolylineElement соответствует элементу polyline"
type: docs

url: /ru/java/com.aspose.html.dom.svg/svgpolylineelement/
---
## SVGPolylineElement class

Интерфейс SVGPolylineElement соответствует элементу ‘polyline’.
...
| Имя | Описание |
| --- | --- |
| [getAnimatedPoints](../../com.aspose.html.dom.svg/svgpolylineelement/animatedpoints/) Предоставляет доступ к текущему анимированному содержимому атрибута ‘points’. Если данный атрибут или свойство анимируется, содержит текущее анимированное значение атрибута или свойства. Если данный атрибут или свойство в данный момент не анимируется, содержит то же значение, что и points. |
...
| [getPoints](../../com.aspose.html.dom.svg/svgpolylineelement/points/) Предоставляет доступ к базовому (т.е. статическому) содержимому атрибута ‘points’. |
