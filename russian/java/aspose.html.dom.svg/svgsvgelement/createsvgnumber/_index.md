...
description: "Метод SVGSVGElement. Создаёт объект SVGNumber вне любых деревьев документа. Объект инициализируется значением ноль."
type: docs

url: /ru/java/com.aspose.html.dom.svg/svgsvgelement/createsvgnumber/
---
