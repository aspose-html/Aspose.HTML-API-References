...
description: "Метод SVGSVGElement. Создаёт объект SVGTransform вне любых деревьев документа. Объект инициализируется преобразованием матрицы единичного преобразования SVG_TRANSFORM_MATRIX"
type: docs

url: /ru/java/com.aspose.html.dom.svg/svgsvgelement/createsvgtransform/
---
