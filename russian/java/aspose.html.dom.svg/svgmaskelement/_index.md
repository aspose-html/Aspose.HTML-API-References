...
| [getHeight](../../com.aspose.html.dom.svg/svgmaskelement/height/) Соответствует атрибуту ‘height’ у заданного элемента ‘mask’. Принимает одну из констант, определённых в SVGUnitTypes. |
[getId]
...
| [getMaskContentUnits](../../com.aspose.html.dom.svg/svgmaskelement/maskcontentunits/) Соответствует атрибуту ‘maskContentUnits’ у заданного элемента ‘mask’. Принимает одну из констант, определённых в SVGUnitTypes. |
| [getMaskUnits](../../com.aspose.html.dom.svg/svgmaskelement/maskunits/) Соответствует атрибуту ‘maskUnits’ у заданного элемента ‘mask’. Принимает одну из констант, определённых в SVGUnitTypes. |
...
| [getRequiredExtensions](../../com.aspose.html.dom.svg/svgmaskelement/requiredextensions/) Соответствует атрибуту ‘requiredExtensions’ у заданного элемента. |
| [getRequiredFeatures](../../com.aspose.html.dom.svg/svgmaskelement/requiredfeatures/) Соответствует атрибуту ‘requiredFeatures’ у заданного элемента. |
...
| [getSystemLanguage](../../com.aspose.html.dom.svg/svgmaskelement/systemlanguage/) Соответствует атрибуту ‘systemLanguage’ у заданного элемента. |
...
| [getWidth](../../com.aspose.html.dom.svg/svgmaskelement/width/) Соответствует атрибуту ‘width’ у заданного элемента ‘mask’. Принимает одну из констант, определённых в SVGUnitTypes. |
| [X](../../com.aspose.html.dom.svg/svgmaskelement/x/) { get; } | Соответствует атрибуту ‘x’ у заданного элемента ‘mask’. Принимает одну из констант, определённых в SVGUnitTypes. |
| [Y](../../com.aspose.html.dom.svg/svgmaskelement/y/) { get; } | Соответствует атрибуту ‘y’ у заданного элемента ‘mask’. Принимает одну из констант, определённых в SVGUnitTypes. |
