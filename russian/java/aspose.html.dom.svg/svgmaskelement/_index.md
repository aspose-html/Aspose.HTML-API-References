---
title: "SVGMaskElement Класс"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.dom.svg.SVGMaskElement класс. Интерфейс SVGMaskElement соответствует элементу mask."
type: docs

url: /ru/java/com.aspose.html.dom.svg/svgmaskelement/
---
## SVGMaskElement class

Интерфейс SVGMaskElement соответствует элементу ‘mask’.
...
| [getHeight](../../com.aspose.html.dom.svg/svgmaskelement/height/) Соответствует атрибуту ‘height’ у указанного элемента ‘mask’. Принимает одну из констант, определённых в SVGUnitTypes. |
[getId]
...
| [getMaskContentUnits](../../com.aspose.html.dom.svg/svgmaskelement/maskcontentunits/) Соответствует атрибуту ‘maskContentUnits’ у указанного элемента ‘mask’. Принимает одну из констант, определённых в SVGUnitTypes. |
| [getMaskUnits](../../com.aspose.html.dom.svg/svgmaskelement/maskunits/) Соответствует атрибуту ‘maskUnits’ у указанного элемента ‘mask’. Принимает одну из констант, определённых в SVGUnitTypes. |
...
| [getRequiredExtensions](../../com.aspose.html.dom.svg/svgmaskelement/requiredextensions/) Соответствует атрибуту ‘requiredExtensions’ у указанного элемента. |
| [getRequiredFeatures](../../com.aspose.html.dom.svg/svgmaskelement/requiredfeatures/) Соответствует атрибуту ‘requiredFeatures’ у указанного элемента. |
...
| [getSystemLanguage](../../com.aspose.html.dom.svg/svgmaskelement/systemlanguage/) Соответствует атрибуту ‘systemLanguage’ у указанного элемента. |
...
| [getWidth](../../com.aspose.html.dom.svg/svgmaskelement/width/) Соответствует атрибуту ‘width’ у указанного элемента ‘mask’. Принимает одну из констант, определённых в SVGUnitTypes. |
| [X](../../com.aspose.html.dom.svg/svgmaskelement/x/) { get; } | Соответствует атрибуту ‘x’ у указанного элемента ‘mask’. Принимает одну из констант, определённых в SVGUnitTypes. |
| [Y](../../com.aspose.html.dom.svg/svgmaskelement/y/) { get; } | Соответствует атрибуту ‘y’ у указанного элемента ‘mask’. Принимает одну из констант, определённых в SVGUnitTypes. |
