...
| --- | --- | --- |
| propertyName | String | propertyName — это String, представляющий имя свойства, которое следует удалить. Обратите внимание, что многословные имена свойств пишутся через дефис, а не в camelCase. |

### Возвращаемое значение

oldValue — это DOMString, равный значению CSS‑свойства до его удаления.
