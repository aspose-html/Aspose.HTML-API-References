...
Этот метод используется для получения CSSValue по порядковому индексу. Порядок в этой коллекции соответствует порядку значений в CSS‑свойстве стиля. Если индекс больше или равен количеству значений в списке, метод возвращает null.
