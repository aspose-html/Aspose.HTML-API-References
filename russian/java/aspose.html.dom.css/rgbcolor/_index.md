...
Даже если таблица стилей может содержать только целое число для значения цвета, внутреннее хранение этого целого представлено как float, и его можно использовать как float в указанном или вычисленном стиле.
