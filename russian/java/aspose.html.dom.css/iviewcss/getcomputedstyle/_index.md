...
| --- | --- | --- |
| element | Element | Элемент [`Element`](../../../com.aspose.html.dom/element/) для получения вычисленного стиля. Этот параметр не может быть null. |

### Возвращаемое значение

Возвращаемый стиль — живой объект [`CSSStyleDeclaration`](../../icssstyledeclaration/), который автоматически обновляется при изменении стилей элемента.

### Исключения

| исключение | условие |
| --- | --- |
| TypeError | Если переданный объект не является Element, либо pseudoElt не является допустимым селектором псевдо‑элемента. |
