...
description: "Интерфейс com.aspose.html.dom.css.ICSSImportRule. Интерфейс CSSImportRule представляет правило импорта в таблице стилей CSS. Правило импорта используется для импорта правил стилей из других таблиц стилей."
type: docs
...
| Имя | Описание |
| --- | --- |
| [getHref](../../com.aspose.html.dom.css/icssimportrule/href/) Свойство href только для чтения интерфейса CSSImportRule возвращает URL, указанный в директиве @import. |
...
| [getStyleSheet](../../com.aspose.html.dom.css/icssimportrule/stylesheet/) Таблица стилей, на которую ссылается это правило, если она загружена. Значение этого атрибута равно null, если таблица стилей ещё не загружена или не будет загружена (например, если таблица стилей предназначена для типа media, не поддерживаемого пользовательским агентом). |
