---
title: "Интерфейс ICSS2Properties"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.dom.css.ICSS2Properties интерфейс. Интерфейс CSS2Properties представляет удобный механизм получения и установки свойств внутри CSSStyleDeclaration. Атрибуты этого интерфейса соответствуют всем свойствам, указанным в CSS2. Получение атрибута этого интерфейса эквивалентно вызову метода getPropertyValue интерфейса CSSStyleDeclaration. Установка атрибута этого интерфейса эквивалентна вызову метода setProperty интерфейса CSSStyleDeclaration."
type: docs
...
Интерфейс CSS2Properties представляет удобный механизм получения и установки свойств внутри [`CSSStyleDeclaration`](../icssstyledeclaration/). Атрибуты этого интерфейса соответствуют всем свойствам, указанным в CSS2. Получение атрибута этого интерфейса эквивалентно вызову метода getPropertyValue интерфейса [`CSSStyleDeclaration`](../icssstyledeclaration/). Установка атрибута этого интерфейса эквивалентна вызову метода setProperty интерфейса [`CSSStyleDeclaration`](../icssstyledeclaration/).
