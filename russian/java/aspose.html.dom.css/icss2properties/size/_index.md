...
description: "Свойство ICSS2Properties. Это свойство указывает размер и ориентацию page box"
type: docs
...
auto - page box будет установлен к размеру и ориентации целевого листа.landscape - переопределяет ориентацию цели. page box имеет тот же размер, что и цель, а более длинные стороны находятся горизонтально.portrait - переопределяет ориентацию цели. page box имеет тот же размер, что и цель, а более короткие стороны находятся горизонтально.
