...
description: "интерфейс com.aspose.html.dom.css.ICSSRuleList. CSSRuleList представляет упорядоченную коллекцию только для чтения объектов CSSRule."
type: docs
...
Хотя объект CSSRuleList только для чтения и не может быть изменён напрямую, он считается живым объектом, поскольку его содержимое может изменяться со временем.
