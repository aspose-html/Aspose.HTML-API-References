...
Свойство name интерфейса CSSKeyframeRule получает и задаёт имя анимации, используемое свойством animation-name.
...
| [deleteRule](../../com.aspose.html.dom.css/icsskeyframesrule/deleterule/)(String) | Метод deleteRule удаляет [`CSSKeyframeRule`](../icsskeyframerule/) с переданным ключом. Если правило с этим ключом не существует, метод ничего не делает. |
| [findRule](../../com.aspose.html.dom.css/icsskeyframesrule/findrule/)(String) | Метод findRule возвращает правило с ключом, совпадающим с переданным ключом. Если такого правила нет, возвращается значение null. |
