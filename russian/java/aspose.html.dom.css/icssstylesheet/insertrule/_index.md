...
description: "Метод ICSSStyleSheet. Метод CSSStyleSheet.insertRule вставляет новое CSS‑правило в текущую таблицу стилей с некоторыми ограничениями."
type: docs
...
Индекс нового вставленного правила в списке правил таблицы стилей.
