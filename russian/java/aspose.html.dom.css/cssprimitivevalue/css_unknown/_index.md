...
description: "Поле CSSPrimitiveValue. Значение не является распознанным значением CSS2. Значение можно получить только с помощью атрибута cssText."
type: docs

url: /ru/java/com.aspose.html.dom.css/cssprimitivevalue/css_unknown/
---
