...
| [clear](../../com.aspose.html.dom.svg.collections/svglistbase-1/clear/)() | Очищает все существующие текущие элементы из списка, в результате получая пустой список. |
...
| [initialize](../../com.aspose.html.dom.svg.collections/svglistbase-1/initialize/)(T) | Очищает все существующие текущие элементы из списка и переинициализирует список, чтобы содержать единственный элемент, указанный параметром. |
