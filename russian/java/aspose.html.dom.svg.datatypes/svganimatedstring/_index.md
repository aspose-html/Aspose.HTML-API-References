---
title: "Класс SVGAnimatedString"
second_title: "Справочник API Aspose.HTML для Java"
description: "Класс com.aspose.html.dom.svg.datatypes.SVGAnimatedString. Используется для атрибутов типа DOMString, которые могут анимироваться"
type: docs

url: /ru/java/com.aspose.html.dom.svg.datatypes/svganimatedString/
---
## SVGAnimatedString class

Используется для атрибутов типа DOMString, которые могут анимироваться.
...
| [toString](../../com.aspose.html.dom.svg.datatypes/svganimatedString/toString/)() | Возвращает строку, представляющую этот экземпляр. |
