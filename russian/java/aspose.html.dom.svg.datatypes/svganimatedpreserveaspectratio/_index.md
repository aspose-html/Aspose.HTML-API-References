...
description: "com.aspose.html.dom.svg.datatypes.SVGAnimatedPreserveAspectRatio class. Используется для атрибутов типа SVGPreserveAspectRatio, которые могут быть анимированы."
type: docs

url: /ru/java/com.aspose.html.dom.svg.datatypes/svganimatedpreserveaspectratio/
---
## SVGAnimatedPreserveAspectRatio class

Используется для атрибутов типа SVGPreserveAspectRatio, которые могут анимироваться.
...
| [toString](../../com.aspose.html.dom.svg.datatypes/svganimatedpreserveaspectratio/toString/)() | Возвращает строку, представляющую этот экземпляр. |
