---
title: "Класс SVGAnimatedLength"
second_title: "Справочник API Aspose.HTML для Java"
description: "Класс com.aspose.html.dom.svg.datatypes.SVGAnimatedLength. Используется для атрибутов базового типа length, которые могут быть анимированы"
type: docs

url: /ru/java/com.aspose.html.dom.svg.datatypes/svganimatedlength/
---
## SVGAnimatedLength class

Используется для атрибутов базового типа length, которые могут анимироваться.
...
| [toString](../../com.aspose.html.dom.svg.datatypes/svganimatedlength/toString/)() | Возвращает строку, представляющую этот экземпляр. |
