...
Сохраните то же самое базовое сохранённое значение, но сбросьте идентификатор единицы измерения на указанный unitType. Атрибуты объекта unitType, valueInSpecifiedUnits и valueAsString могут быть изменены в результате вызова этого метода.
