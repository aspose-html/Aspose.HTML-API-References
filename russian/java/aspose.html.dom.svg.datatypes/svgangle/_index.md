...
description: "Класс com.aspose.html.dom.svg.datatypes.SVGAngle. Интерфейс SVGAngle соответствует базовому типу данных angle"
type: docs
...
| Имя | Описание |
| --- | --- |
| [convertToSpecifiedUnits](../../com.aspose.html.dom.svg.datatypes/svgangle/converttospecifiedunits/)(ushort) | Сохраните то же самое базовое сохранённое значение, но сбросьте идентификатор единицы измерения на указанный unitType. Атрибуты объекта unitType, valueInSpecifiedUnits и valueAsString могут быть изменены в результате вызова этого метода. |
