---
title: "SVGStringList класс"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.dom.svg.datatypes.SVGStringList класс. SVGStringList имеет те же атрибуты и методы, что и другие интерфейсы SVGxxxList. Реализаторы могут рассмотреть возможность использования единого базового класса для реализации различных интерфейсов SVGxxxList."
type: docs

url: /ru/java/com.aspose.html.dom.svg.datatypes/svgStringlist/
---
## SVGStringList class

SVGStringList имеет те же атрибуты и методы, что и другие интерфейсы SVGxxxList. Реализаторы могут рассмотреть возможность использования единого базового класса для реализации различных интерфейсов SVGxxxList.
...
| Имя | Описание |
| --- | --- |
| [SVGStringList](svgStringlist/#constructor)() | Инициализирует новый экземпляр класса `SVGStringList`. |
| [SVGStringList](svgStringlist/#constructor_1)(IEnumerable&lt;String&gt;) | Инициализирует новый экземпляр класса `SVGStringList`. |
...
| [toString](../../com.aspose.html.dom.svg.datatypes/svgStringlist/toString/)() | Возвращает строку, представляющую этот экземпляр. |
