---
title: "Класс SVGAnimatedBoolean"
second_title: "Справочник API Aspose.HTML для Java"
description: "Класс com.aspose.html.dom.svg.datatypes.SVGAnimatedBoolean. Используется для атрибутов типа boolean, которые могут быть анимированы."
type: docs

url: /ru/java/com.aspose.html.dom.svg.datatypes/svganimatedboolean/
---
## SVGAnimatedBoolean class

Используется для атрибутов типа boolean, которые могут анимироваться.
...
| [toString](../../com.aspose.html.dom.svg.datatypes/svganimatedboolean/toString/)() | Возвращает строку, представляющую этот экземпляр. |
