---
title: "Класс SVGAnimatedRect"
second_title: "Справочник API Aspose.HTML для Java"
description: "Класс com.aspose.html.dom.svg.datatypes.SVGAnimatedRect. Используется для атрибутов типа SVGRect, которые могут быть анимированы"
type: docs

url: /ru/java/com.aspose.html.dom.svg.datatypes/svganimatedrect/
---
## SVGAnimatedRect class

Используется для атрибутов типа SVGRect, которые могут анимироваться.
...
| [toString](../../com.aspose.html.dom.svg.datatypes/svganimatedrect/toString/)() | Возвращает строку, представляющую этот экземпляр. |
