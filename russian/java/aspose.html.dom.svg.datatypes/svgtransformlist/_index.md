---
title: "SVGTransformList Класс"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.dom.svg.datatypes.SVGTransformList class. Этот интерфейс определяет список объектов SVGTransform."
type: docs

url: /ru/java/com.aspose.html.dom.svg.datatypes/svgtransformlist/
---
...
| Имя | Описание |
| --- | --- |
| [SVGTransformList](svgtransformlist/#constructor)() | Инициализирует новый экземпляр класса `SVGTransformList`. |
| [SVGTransformList](svgtransformlist/#constructor_1)(IEnumerable&lt;SVGTransform&gt;) | Инициализирует новый экземпляр класса `SVGTransformList`. |
...
| [toString](../../com.aspose.html.dom.svg.datatypes/svgtransformlist/toString/)() | Возвращает строку, представляющую этот экземпляр. |
