...
description: "Свойство SVGAnimatedValue. Если указанный атрибут или свойство анимируется, содержит текущее анимированное значение атрибута или свойства. Если указанный атрибут или свойство в данный момент не анимируется, содержит то же значение, что и baseVal"
type: docs

url: /ru/java/com.aspose.html.dom.svg.datatypes/svganimatedvalue-1/animval/
---
