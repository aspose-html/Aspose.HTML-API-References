---
title: "SVGLength Класс"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.dom.svg.datatypes.SVGLength класс. Интерфейс SVGLength соответствует базовому типу данных length. Объект SVGLength может быть помечен как только для чтения, что означает, что попытки изменить объект приведут к выбросу исключения, как описано ниже"
type: docs
...
Интерфейс SVGLength соответствует базовому типу данных длина. Объект SVGLength может быть объявлен только для чтения, что означает, что попытки изменить объект приведут к выбросу исключения, как описано ниже.
...
| Имя | Описание |
| --- | --- |
| [getUnitType](../../com.aspose.html.dom.svg.datatypes/svglength/unittype/) Тип значения, указанный одной из констант SVG_LENGTHTYPE_* определённых в этом интерфейсе. |
[getValue]
