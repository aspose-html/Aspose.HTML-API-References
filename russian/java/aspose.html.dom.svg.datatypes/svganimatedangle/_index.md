---
title: "Класс SVGAnimatedAngle"
second_title: "Справочник API Aspose.HTML для Java"
description: "Класс com.aspose.html.dom.svg.datatypes.SVGAnimatedAngle. Используется для атрибутов базового типа данных угол, которые могут анимироваться"
type: docs

url: /ru/java/com.aspose.html.dom.svg.datatypes/svganimatedangle/
---
## SVGAnimatedAngle class

Используется для атрибутов базового типа angle, которые могут анимироваться.
...
| [toString](../../com.aspose.html.dom.svg.datatypes/svganimatedangle/toString/)() | Возвращает строку, представляющую этот экземпляр. |
