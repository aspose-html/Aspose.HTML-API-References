---
title: "Класс SVGAnimatedNumber"
second_title: "Справочник API Aspose.HTML для Java"
description: "Класс com.aspose.html.dom.svg.datatypes.SVGAnimatedNumber. Используется для атрибутов базового типа number, которые могут быть анимированы"
type: docs

url: /ru/java/com.aspose.html.dom.svg.datatypes/svganimatednumber/
---
## SVGAnimatedNumber class

Используется для атрибутов базового типа number, которые могут анимироваться.
...
| [toString](../../com.aspose.html.dom.svg.datatypes/svganimatednumber/toString/)() | Возвращает строку, представляющую этот экземпляр. |
