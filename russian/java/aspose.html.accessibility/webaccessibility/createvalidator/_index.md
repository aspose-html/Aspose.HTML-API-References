...
description: "Метод WebAccessibility. Создается экземпляр AccessibilityValidator для конкретного правила, используя полные параметры объекта ValidationBuilder.All"
type: docs

url: /ru/java/com.aspose.html.accessibility/webaccessibility/createvalidator/
---
## CreateValidator(IRule) {#createvalidator_1}

Экземпляр AccessibilityValidator создаётся для конкретного правила, используя полные параметры объекта ValidationBuilder.All.
...
| --- | --- | --- |
| правило | IRule | объект правила, реализующий интерфейс IRule |

### Возвращаемое значение

объект AccessibilityValidator
...
Создать экземпляр AccessibilityValidator
...
| --- | --- | --- |
| правило | IRule | объект правила, реализующий интерфейс IRule |
| строитель | ValidationBuilder | объект ValidationBuilder |
...
| --- | --- | --- |
| правило | IRule | объект правила, реализующий интерфейс IRule |
| строитель | Action`1 | метод, который возвращает объект ValidationBuilder |
...
Экземпляр AccessibilityValidator создаётся в соответствии со всеми правилами с объектом ValidationBuilder.All.
...
Экземпляр AccessibilityValidator создаётся для конкретного списка правил.
