...
description: "com.aspose.html.accessibility.ValidationBuilder class. Класс ValidationBuilder предоставляет конкретные реализации шагов конфигурации. Определяет методы и настройки для класса ValidationSettings"
type: docs
...
| Имя | Описание |
| --- | --- |
| static [getAll](../../com.aspose.html.accessibility/validationbuilder/all/) Включает все уровни и настройки всех технологий |
| static [getDefault](../../com.aspose.html.accessibility/validationbuilder/default/) Настройки по умолчанию: используется только общие технологии и уровень самого низкого критерия |
| static [getNone](../../com.aspose.html.accessibility/validationbuilder/none/) Нет настроек — параметры не указаны. |
...
| [useCSS](../../com.aspose.html.accessibility/validationbuilder/usecss/)() | Метод, который включает CSS‑технологии в набор правил |
| [useFailures](../../com.aspose.html.accessibility/validationbuilder/usefailures/)() | Метод, который включает сбои в набор правил |
| [useGeneral](../../com.aspose.html.accessibility/validationbuilder/usegeneral/)() | Метод, который включает общие технологии в набор правил |
...
| [useHTML](../../com.aspose.html.accessibility/validationbuilder/usehtml/)() | Метод, который включает HTML‑технологии в набор правил |
