...
| Класс | Описание |
| --- | --- |
| [AccessibilityRules](./accessibilityrules/) | Быстрая справка по требованиям (критериям успеха) и техникам Руководства по доступности веб‑контента (WCAG) 2. Содержит список принципов. https://www.w3.org/WAI/WCAG21/quickref/ |
| [AccessibilityValidator](./accessibilityvalidator/) | Класс валидатора обрабатывает правила быстрой справки. Содержит метод Validate для проверки доступности. |
...
| [Guideline](./guideline/) | Руководства — следующий уровень после принципов. Они не подлежат тестированию, но описывают рамки и общие цели, помогающие авторам понять критерии успеха и лучше применять техники. Руководства представляют собой список критериев приемки с типом RuleDirectory{Criterion}. |
