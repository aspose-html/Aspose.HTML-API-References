...
description: "Метод ResourceHandler. Этот метод отвечает за обработку ресурса. В нём вы можете сохранить Resource в поток или встроить его в родительский ресурс."
type: docs

url: /ru/java/com.aspose.html.saving.resourcehandlers/resourcehandler/handleresource/
---
