...
| исключение | условие |
| --- | --- |
| InvalidOperationException | Вызывается, если [`OutputUrl`](../../../com.aspose.html.saving/resource/outputurl/) равно `null` и [`Status`](../../../com.aspose.html.saving/resource/status/) имеет значение Saved. [`OutputUrl`](../../../com.aspose.html.saving/resource/outputurl/) должен быть указан для сохранённого ресурса, иначе невозможно задать корректную ссылку в ресурсах, ссылающихся на него. |
