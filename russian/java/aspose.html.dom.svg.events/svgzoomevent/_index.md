...
description: "Класс com.aspose.html.dom.svg.events.SVGZoomEvent. Событие масштабирования происходит, когда пользователь инициирует действие, вызывающее изменение масштаба текущего представления фрагмента SVG‑документа. Обработчики событий распознаются только на элементах svg."
type: docs
...
| [getNewScale](../../com.aspose.html.dom.svg.events/svgzoomevent/newscale/) Коэффициент масштабирования, который будет применён после обработки операции масштабирования. |
| [getNewTranslate](../../com.aspose.html.dom.svg.events/svgzoomevent/newtranslate/) Значения трансляции, которые будут применены после обработки операции масштабирования. Объект SVGPoint доступен только для чтения. |
