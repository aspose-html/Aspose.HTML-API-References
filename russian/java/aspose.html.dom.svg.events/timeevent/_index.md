...
description: "Класс com.aspose.html.dom.svg.events.TimeEvent. Интерфейс TimeEvent предоставляет конкретную контекстную информацию, связанную со событиями времени. Различные типы событий, которые могут возникать, это beginEvent, endEvent и repeatEvent."
type: docs
...
Интерфейс TimeEvent предоставляет специфическую контекстную информацию, связанную со временными событиями. Различные типы событий, которые могут возникать, это: beginEvent, endEvent и repeatEvent.
...
| [getDetail](../../com.aspose.html.dom.svg.events/timeevent/detail/) Указывает некоторую подробную информацию о событии, в зависимости от типа события. Для этого типа события указывает номер повторения анимации. |
...
| [getView](../../com.aspose.html.dom.svg.events/timeevent/view/) Атрибут view идентифицирует AbstractView [DOM2VIEWS], из которого было сгенерировано событие. |
