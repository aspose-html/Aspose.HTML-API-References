...
description: "Класс com.aspose.html.HTMLAppletElement. Встроенный Java‑апплет. Смотрите определение элемента APPLET в HTML 4.01. Этот элемент устарел в HTML 4.01"
type: docs
