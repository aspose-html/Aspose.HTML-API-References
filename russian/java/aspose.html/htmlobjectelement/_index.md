---
title: "Класс HTMLObjectElement"
second_title: "Справочник API Aspose.HTML для Java"
description: "Класс com.aspose.html.HTMLObjectElement. Универсальный встроенный объект. По принципу все свойства элемента object доступны для чтения и записи, но в некоторых средах некоторые свойства могут стать только для чтения после создания базового объекта. См. определение элемента OBJECT в HTML 4.01"
type: docs

url: /ru/java/com.aspose.html/htmlobjectelement/
---
## HTMLObjectElement class

Общий встроенный объект. По принципу все свойства элемента object доступны для чтения и записи, но в некоторых средах некоторые свойства могут стать только для чтения после создания базового объекта. См. определение элемента OBJECT в [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224)].
