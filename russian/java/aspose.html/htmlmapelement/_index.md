---
title: "HTMLMapElement класс"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.HTMLMapElement класс. Карта изображений на стороне клиента. См. определение элемента MAP в HTML 4.01"
type: docs

url: /ru/java/com.aspose.html/htmlmapelement/
---
## HTMLMapElement class

Карта изображений на стороне клиента. См. определение элемента MAP в HTML 4.01.
...
| Имя | Описание |
| --- | --- |
| [getAreas](../../com.aspose.html/htmlmapelement/areas/) Список областей, определённых для карты изображения. |
