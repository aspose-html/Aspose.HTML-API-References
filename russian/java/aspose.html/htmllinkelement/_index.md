...
description: "com.aspose.html.HTMLLinkElement class. Элемент LINK указывает ссылку на внешний ресурс и определяет отношение этого документа к этому ресурсу или наоборот. См. определение элемента LINK в HTML 4.01, также см. интерфейс LinkStyle в модуле StyleSheet, DOM Level 2 Style Sheets и CSS."
type: docs
