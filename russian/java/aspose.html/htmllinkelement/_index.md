---
title: "HTMLLinkElement класс"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.HTMLLinkElement класс. Элемент LINK указывает ссылку на внешний ресурс и определяет отношение этого документа к этому ресурсу или наоборот. См. определение элемента LINK в HTML 4.01, также смотрите интерфейс LinkStyle в модуле StyleSheet, DOM Level 2 Style Sheets и CSS."
type: docs

url: /ru/java/com.aspose.html/htmllinkelement/
---
## HTMLLinkElement class

Элемент `LINK` указывает ссылку на внешний ресурс и определяет отношение этого документа к этому ресурсу (или наоборот). См. определение элемента LINK в HTML 4.01 (см. также интерфейс `LinkStyle` в модуле StyleSheet [[DOM Level 2 Style Sheets and CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113)]).
...
| [getRelList](../../com.aspose.html/htmllinkelement/rellist/) Возвращает живой DOMTokenList, содержащий токены, полученные при разборе атрибута \"rel\". |
[getRev]
...
| [getSheet](../../com.aspose.html/htmllinkelement/sheet/) Получает связанную таблицу стилей. |
