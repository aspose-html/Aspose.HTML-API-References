...
description: "com.aspose.html.HTMLTableSectionElement class. Элементы THEAD, TFOOT и TBODY"
type: docs
...
| [insertRow](../../com.aspose.html/htmltablesectionelement/insertrow/)(int) | Вставить строку в этот раздел. Новая строка вставляется непосредственно перед текущей строкой с индексом `index` в этом разделе. Если `index` равен -1 или равен количеству строк в этом разделе, новая строка добавляется в конец. |
