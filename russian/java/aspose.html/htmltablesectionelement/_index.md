---
title: "HTMLTableSectionElement класс"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.HTMLTableSectionElement класс. Элементы THEAD, TFOOT и TBODY"
type: docs

url: /ru/java/com.aspose.html/htmltablesectionelement/
---
...
| [getRows](../../com.aspose.html/htmltablesectionelement/rows/) Коллекция строк в этом разделе таблицы. |
...
| [deleteRow](../../com.aspose.html/htmltablesectionelement/deleterow/)(int) | Удалить строку из этого раздела. |
...
| [insertRow](../../com.aspose.html/htmltablesectionelement/insertrow/)(int) | Вставить строку в этот раздел. Новая строка вставляется непосредственно перед текущей `index`‑й строкой в этом разделе. Если `index` равно -1 или равно количеству строк в этом разделе, новая строка добавляется в конец. |
