...
| --- | --- | --- |
| index | Int32 | Индекс строки, которую нужно удалить, или -1 для удаления последней строки. Этот индекс начинается с 0 и относится только к строкам, находящимся внутри этого раздела, а не ко всем строкам в таблице. |
