...
description: "Класс com.aspose.html.HTMLFrameElement. Создайте кадр. Смотрите определение элемента FRAME в HTML 4.01"
type: docs
...
| [getContentDocument](../../com.aspose.html/htmlframeelement/contentdocument/) Документ, содержащийся в этом кадре, если он существует и доступен, иначе `null`. @since DOM Level 2 |
[getDir]
