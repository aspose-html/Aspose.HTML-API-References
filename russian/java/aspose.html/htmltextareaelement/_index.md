---
title: "HTMLTextAreaElement класс"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.HTMLTextAreaElement класс. Многострочное текстовое поле. См. определение элемента TEXTAREA в HTML 4.01"
type: docs

url: /ru/java/com.aspose.html/htmltextareaelement/
---
...
| [getForm](../../com.aspose.html/htmltextareaelement/form/) Возвращает элемент `FORM`, содержащий этот элемент управления. Возвращает `null`, если этот элемент управления не находится в контексте формы. |
[getId]
...
| [getType](../../com.aspose.html/htmltextareaelement/type/) Тип этого элемента управления формой. Это строка "textarea". |
[getValue]
