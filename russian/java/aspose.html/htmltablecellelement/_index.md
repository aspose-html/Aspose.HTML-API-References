---
title: "HTMLTableCellElement класс"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.HTMLTableCellElement класс. Объект, используемый для представления элементов TH и TD. См. определение элемента TD в HTML 4.01"
type: docs

url: /ru/java/com.aspose.html/htmltablecellelement/
---
## HTMLTableCellElement class

Объект, используемый для представления элементов `TH` и `TD`. См. определение элемента TD в HTML 4.01.
...
| [getCellIndex](../../com.aspose.html/htmltablecellelement/cellindex/) Индекс этой ячейки в строке, начиная с 0. Этот индекс соответствует порядку в дереве документа, а не порядку отображения. |
[getCh]
