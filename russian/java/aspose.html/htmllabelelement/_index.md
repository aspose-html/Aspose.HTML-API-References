...
description: "Класс com.aspose.html.HTMLLabelElement. Текст метки поля формы. См. определение элемента LABEL в HTML 4.01"
type: docs
...
| [getForm](../../com.aspose.html/htmllabelelement/form/) Возвращает элемент `FORM`, содержащий этот элемент управления. Возвращает `null`, если этот элемент управления не находится в контексте формы. |
[getId]
