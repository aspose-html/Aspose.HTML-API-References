---
title: "Класс HTMLLabelElement"
second_title: "Справочник API Aspose.HTML для Java"
description: "Класс com.aspose.html.HTMLLabelElement. Текст подписи поля формы. См. определение элемента LABEL в HTML 4.01."
type: docs

url: /ru/java/com.aspose.html/htmllabelelement/
---
...
| [getForm](../../com.aspose.html/htmllabelelement/form/) Возвращает элемент `FORM`, содержащий этот контрол. Возвращает `null`, если этот контрол не находится в контексте формы. |
[getId]
