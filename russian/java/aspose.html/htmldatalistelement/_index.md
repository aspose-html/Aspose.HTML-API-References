---
title: "HTMLDataListElement класс"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.HTMLDataListElement класс. Элемент datalist представляет набор элементов option, которые представляют предопределённые варианты для других элементов управления. См. также рекомендацию W3C HTML 5.2"
type: docs

url: /ru/java/com.aspose.html/htmldatalistelement/
---
## HTMLDataListElement class

Элемент datalist представляет набор элементов option, которые задают предопределённые варианты для других элементов управления. См. также [HTML 5.2 W3C Recommendation](https://www.w3.org/TR/html52/sec-forms.html#elementdef-datalist).
...
| [getOptions](../../com.aspose.html/htmldatalistelement/options/) Коллекция элементов `OPTION`, содержащихся в этом элементе. |
[getOuterHTML]
