...
description: "com.aspose.html.HTMLDataListElement class. Элемент datalist представляет набор элементов option, которые представляют предопределённые варианты для других элементов управления. См. также рекомендацию W3C HTML 5.2"
type: docs
