...
description: "com.aspose.html.HTMLAnchorElement class. Элемент якоря. См. определение элемента A в HTML 4.01"
type: docs
...
| [getOrigin](../../com.aspose.html/htmlanchorelement/origin/) Получает строковое представление сегмента origin связанного URL. |
[getOuterHTML]
...
| [focus](../../com.aspose.html/htmlanchorelement/focus/)() | Устанавливает клавиатурный фокус на этом элементе. |
