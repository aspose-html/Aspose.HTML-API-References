---
title: "Класс HTMLCanvasElement"
second_title: "Справочник API Aspose.HTML для Java"
description: "Класс com.aspose.html.HTMLCanvasElement. Интерфейс HTMLCanvasElement предоставляет свойства и методы для управления расположением и представлением элементов canvas. Интерфейс HTMLCanvasElement также наследует свойства и методы интерфейса HTMLElement."
type: docs

url: /ru/java/com.aspose.html/htmlcanvaselement/
---
## HTMLCanvasElement class

Интерфейс HTMLCanvasElement предоставляет свойства и методы для управления расположением и отображением элементов canvas. Интерфейс HTMLCanvasElement также наследует свойства и методы интерфейса HTMLElement.
...
| [getContext](../../com.aspose.html/htmlcanvaselement/getcontext/)(String) | Возвращает контекст рисования на canvas, или null, если указанный ID контекста не поддерживается. Контекст рисования позволяет рисовать на canvas. |
...
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl)() | Возвращает URI данных, содержащий представление изображения в формате, указанном параметром type (по умолчанию PNG). Возвращаемое изображение имеет разрешение 96 dpi. |
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl_1)(String) | Возвращает URI данных, содержащий представление изображения в формате, указанном параметром type (по умолчанию PNG). Возвращаемое изображение имеет разрешение 96 dpi. |
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl_2)(String, double) | Возвращает URI данных, содержащий представление изображения в формате, указанном параметром type (по умолчанию PNG). Возвращаемое изображение имеет разрешение 96 dpi. |
