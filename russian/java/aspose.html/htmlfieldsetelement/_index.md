---
title: "Класс HTMLFieldSetElement"
second_title: "Справочник API Aspose.HTML для Java"
description: "Класс com.aspose.html.HTMLFieldSetElement. Организует элементы управления формой в логические группы. См. определение элемента FIELDSET в HTML 4.01"
type: docs

url: /ru/java/com.aspose.html/htmlfieldsetelement/
---
## HTMLFieldSetElement class

Организует элементы управления формой в логические группы. См. определение элемента FIELDSET в HTML 4.01.
...
| [getForm](../../com.aspose.html/htmlfieldsetelement/form/) Возвращает элемент `FORM`, содержащий этот элемент управления. Возвращает `null`, если данный элемент управления не находится в контексте формы. |
[getId]
