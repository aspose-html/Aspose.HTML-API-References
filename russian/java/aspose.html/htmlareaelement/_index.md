---
title: "Класс HTMLAreaElement"
second_title: "Справочник API Aspose.HTML для Java"
description: "Класс com.aspose.html.HTMLAreaElement. Определение области клиентской карты изображений. См. определение элемента AREA в HTML 4.01"
type: docs

url: /ru/java/com.aspose.html/htmlareaelement/
---
## HTMLAreaElement class

Определение области клиентской карты изображений. См. определение элемента AREA в HTML 4.01.
...
| [getRelList](../../com.aspose.html/htmlareaelement/rellist/) Возвращает живой DOMTokenList, содержащий токены, полученные при разборе атрибута \"rel\". |
