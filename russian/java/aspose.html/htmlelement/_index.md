---
title: "Класс HTMLElement"
second_title: "Справочник API Aspose.HTML для Java"
description: "Класс com.aspose.html.HTMLElement. Все интерфейсы HTML‑элементов наследуются от этого класса. Элементы, которые раскрывают только базовые атрибуты HTML, представлены базовым интерфейсом HTMLElement. К таким элементам относятся специальные SUB SUP SPAN BDO font TT I B U S STRIKE BIG SMALL phrase EM STRONG DFN CODE SAMP KBD VAR CITE ACRONYM ABBR list DD DT NOFRAMES NOSCRIPT ADDRESS CENTER. Атрибут style HTML‑элемента доступен через интерфейс ElementCSSInlineStyle, определённый в модуле CSS DOM Level 2 Style Sheets and CSS"
type: docs

url: /ru/java/com.aspose.html/htmlelement/
---
## HTMLElement class

Все интерфейсы HTML‑элементов наследуются от этого класса. Элементы, которые раскрывают только базовые атрибуты HTML, представлены базовым интерфейсом `HTMLElement`. Эти элементы следующие: special: SUB, SUP, SPAN, BDO; font: TT, I, B, U, S, STRIKE, BIG, SMALL; phrase: EM, STRONG, DFN, CODE, SAMP, KBD, VAR, CITE, ACRONYM, ABBR; list: DD, DT, NOFRAMES, NOSCRIPT, ADDRESS, CENTER. Атрибут `style` HTML‑элемента доступен через интерфейс `ElementCSSInlineStyle`, определённый в модуле CSS [[DOM Level 2 Style Sheets and CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113)].
