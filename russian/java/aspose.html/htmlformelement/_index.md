---
title: "Класс HTMLFormElement"
second_title: "Справочник API Aspose.HTML для Java"
description: "Класс com.aspose.html.HTMLFormElement. Элемент FORM объединяет поведение, схожее с коллекцией и элементом. Он предоставляет прямой доступ к содержащимся элементам управления формой, а также к атрибутам элемента формы. См. определение элемента FORM в HTML 4.01."
type: docs

url: /ru/java/com.aspose.html/htmlformelement/
---
## HTMLFormElement class

Элемент `FORM` объединяет поведение, похожее на коллекцию и элемент. Он предоставляет прямой доступ к содержащимся элементам управления формой, а также к атрибутам элемента формы. См. определение элемента FORM в HTML 4.01.
...
| [getElements](../../com.aspose.html/htmlformelement/elements/) Возвращает коллекцию всех элементов управления формой в форме. |
[getEnctype]
...
| [getLength](../../com.aspose.html/htmlformelement/length/) Количество элементов управления формой в форме. |
...
| [reset](../../com.aspose.html/htmlformelement/reset/)() | Восстанавливает значения по умолчанию элемента формы. Выполняет то же действие, что и кнопка сброса. |
...
| [submit](../../com.aspose.html/htmlformelement/submit/)() | Отправляет форму. Выполняет то же действие, что и кнопка отправки. |
