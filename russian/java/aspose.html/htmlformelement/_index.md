...
description: "Класс com.aspose.html.HTMLFormElement. Элемент FORM объединяет поведение, схожее с коллекцией и элементом. Он обеспечивает прямой доступ к содержащимся элементам управления формой, а также к атрибутам элемента формы. См. определение элемента FORM в HTML 4.01"
type: docs
...
Элемент `FORM` объединяет поведение, похожее на коллекцию и элемент. Он предоставляет прямой доступ к содержащимся элементам управления формы, а также к атрибутам элемента формы. См. определение элемента FORM в HTML 4.01.
