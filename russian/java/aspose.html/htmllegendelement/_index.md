---
title: "Класс HTMLLegendElement"
second_title: "Справочник API Aspose.HTML для Java"
description: "Класс com.aspose.html.HTMLLegendElement. Предоставляет подпись для группы FIELDSET. См. определение элемента LEGEND в HTML 4.01"
type: docs

url: /ru/java/com.aspose.html/htmllegendelement/
---
## HTMLLegendElement class

Предоставляет подпись для группы `FIELDSET`. См. определение элемента LEGEND в HTML 4.01.
...
| [getForm](../../com.aspose.html/htmllegendelement/form/) Возвращает элемент `FORM`, содержащий этот элемент управления. Возвращает `null`, если элемент управления не находится в контексте формы. |
[getId]
