---
title: "Класс HTMLSelectElement"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.HTMLSelectElement class. Элемент select позволяет выбирать вариант. Содержимые варианты можно напрямую получить через элемент select как коллекцию. См. определение элемента SELECT в HTML 4.01"
type: docs

url: /ru/java/com.aspose.html/htmlselectelement/
---
## HTMLSelectElement class

Элемент select позволяет выбирать вариант. Содержимые варианты могут быть напрямую доступны через элемент select как коллекция. См. определение элемента SELECT в HTML 4.01.
...
| [getForm](../../com.aspose.html/htmlselectelement/form/) Количество вариантов в этом `SELECT`. |
[getId]
...
| [getOptions](../../com.aspose.html/htmlselectelement/options/) Коллекция элементов `OPTION`, содержащихся в этом элементе. @version DOM Level 2 |
[getOuterHTML]
...
| [getType](../../com.aspose.html/htmlselectelement/type/) Тип этого элемента формы. Это строка "select-multiple", когда атрибут multiple имеет значение `true`, и строка "select-one", когда `false`. |
[getValue]
