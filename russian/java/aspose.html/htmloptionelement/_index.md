---
title: "HTMLOptionElement класс"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.HTMLOptionElement класс. Выбираемый вариант. См. определение элемента OPTION в HTML 4.01"
type: docs

url: /ru/java/com.aspose.html/htmloptionelement/
---
...
| [getForm](../../com.aspose.html/htmloptionelement/form/) Возвращает элемент `FORM`, содержащий этот элемент управления. Возвращает `null`, если этот элемент управления не находится в контексте формы. |
[getId]
[setId] The element's identifier. See the id attribute definition in HTML 4.01. |
| [getIndex](../../com.aspose.html/htmloptionelement/index/) Индекс этого `OPTION` в его родительском `SELECT`, начиная с 0. @version DOM Level 2 |
[getInnerHTML]
...
| [getText](../../com.aspose.html/htmloptionelement/text/) Текст, содержащийся в элементе option. |
