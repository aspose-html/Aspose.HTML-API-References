---
title: "Класс HTMLParamElement"
second_title: "Справочник API Aspose.HTML для Java"
description: "Класс com.aspose.html.HTMLParamElement. Параметры, передаваемые элементу OBJECT. См. определение элемента PARAM в HTML 4.01"
type: docs

url: /ru/java/com.aspose.html/htmlparamelement/
---
## HTMLParamElement class

Параметры, передаваемые элементу `OBJECT`. См. определение элемента PARAM в HTML 4.01.
