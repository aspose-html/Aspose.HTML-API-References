...
description: "Интерфейс com.aspose.html.IHTMLOptionsCollection. HTMLOptionsCollection представляет собой список узлов, представляющих элемент option HTML. Отдельный узел может быть доступен либо по порядковому индексу, либо по имени или атрибуту id узла. Предполагается, что коллекции в HTML‑DOM являются «живыми», то есть они автоматически обновляются при изменении базового документа."
type: docs
...
Смотрите также [Document object Model (DOM) Level 2 HTML Specification](http://www.w3.org/TR/2003/REC-DOM-Level-2-HTML-20030109). @since DOM Level 2
