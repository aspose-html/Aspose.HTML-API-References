...
description: "Float64Array constructor. Инициализирует новый экземпляр класса Float64Array"
type: docs

url: /ru/java/com.aspose.html/float64array/float64array/
---
## Float64Array(int) {#constructor_4}

Инициализирует новый экземпляр класса [`Float64Array`](../).
...
| --- | --- | --- |
| длина | Int32 | Длина (количество элементов). |
