---
title: "Класс HTMLTableRowElement"
second_title: "Справочник API Aspose.HTML для Java"
description: "Класс com.aspose.html.HTMLTableRowElement. Строка в таблице. См. определение элемента TR в HTML 4.01"
type: docs

url: /ru/java/com.aspose.html/htmltablerowelement/
---
...
| [getCells](../../com.aspose.html/htmltablerowelement/cells/) Коллекция ячеек в этой строке. @version DOM Level 2 |
[getCh]
...
| [getRowIndex](../../com.aspose.html/htmltablerowelement/rowindex/) Это логический порядок, а не порядок в документе. `rowIndex` учитывает секции (`THEAD`, `TFOOT`, или `TBODY`) внутри таблицы, помещая строки `THEAD` первыми в индексе, затем строки `TBODY`, затем строки `TFOOT`. @version DOM Level 2 |
| [getSectionRowIndex](../../com.aspose.html/htmltablerowelement/sectionrowindex/) Индекс этой строки относительно текущей секции (`THEAD`, `TFOOT`, или `TBODY`), начиная с 0. @version DOM Level 2 |
...
| [deleteCell](../../com.aspose.html/htmltablerowelement/deletecell/)(int) | Удалить ячейку из текущей строки. |
...
| [insertCell](../../com.aspose.html/htmltablerowelement/insertcell/)(int) | Вставить пустую ячейку `TD` в эту строку. Если `index` равен -1 или количеству ячеек, новая ячейка добавляется в конец. |
