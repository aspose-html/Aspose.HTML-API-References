...
description: "Класс com.aspose.html.HTMLIsIndexElement. Этот элемент используется для однострочного ввода текста. См. определение элемента ISINDEX в HTML 4.01. Этот элемент устарел в HTML 4.01"
type: docs
...
Этот элемент используется для ввода однострочного текста. См. определение элемента ISINDEX в HTML 4.01. Этот элемент устарел в HTML 4.01.
