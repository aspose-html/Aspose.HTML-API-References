---
title: "Класс HTMLIsIndexElement"
second_title: "Справочник API Aspose.HTML для Java"
description: "Класс com.aspose.html.HTMLIsIndexElement. Этот элемент используется для ввода однострочного текста. См. определение элемента ISINDEX в HTML 4.01. Этот элемент устарел в HTML 4.01"
type: docs

url: /ru/java/com.aspose.html/htmlisindexelement/
---
## HTMLIsIndexElement class

Этот элемент используется для однострочного ввода текста. См. определение элемента ISINDEX в HTML 4.01. Этот элемент устарел в HTML 4.01.
...
| [getForm](../../com.aspose.html/htmlisindexelement/form/) Возвращает |
[getId]
