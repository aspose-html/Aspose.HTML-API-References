...
description: "Класс com.aspose.html.Metered. Предоставляет методы для установки метрированного ключа"
type: docs
