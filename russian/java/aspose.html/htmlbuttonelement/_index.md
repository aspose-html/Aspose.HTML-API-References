---
title: "Класс HTMLButtonElement"
second_title: "Справочник API Aspose.HTML для Java"
description: "Класс com.aspose.html.HTMLButtonElement. Кнопка push. См. определение элемента BUTTON в HTML 4.01"
type: docs

url: /ru/java/com.aspose.html/htmlbuttonelement/
---
## HTMLButtonElement class

Нажмите кнопку. См. определение элемента BUTTON в HTML 4.01.
...
| [getForm](../../com.aspose.html/htmlbuttonelement/form/) Возвращает элемент `FORM`, содержащий этот элемент управления. Возвращает `null`, если этот элемент управления не находится в контексте формы. |
[getId]
