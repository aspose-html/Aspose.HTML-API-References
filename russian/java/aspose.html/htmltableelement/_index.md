...
| [getTHead](../../com.aspose.html/htmltableelement/thead/) Возвращает `CAPTION` таблицы или void, если он отсутствует. |
[getTitle]
...
| [createTFoot](../../com.aspose.html/htmltableelement/createtfoot/)() | Создает строку нижнего колонтитула таблицы или возвращает существующую. |
| [createTHead](../../com.aspose.html/htmltableelement/createthead/)() | Создает строку верхнего колонтитула таблицы или возвращает существующую. |
...
| [deleteTFoot](../../com.aspose.html/htmltableelement/deletetfoot/)() | Удаляет нижний колонтитул из таблицы, если он существует. |
| [deleteTHead](../../com.aspose.html/htmltableelement/deletethead/)() | Удаляет верхний колонтитул из таблицы, если он существует. |
...
| [insertRow](../../com.aspose.html/htmltableelement/insertrow/)(int) | Вставляет новую пустую строку в таблицу. Новая строка вставляется непосредственно перед текущей строкой с индексом `index` и в том же разделе таблицы. Если `index` равен -1 или количеству строк, новая строка добавляется в конец. Кроме того, когда таблица пуста, строка вставляется в `TBODY`, который создаётся и вставляется в таблицу. Строка таблицы не может быть пустой согласно [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224)]. |
