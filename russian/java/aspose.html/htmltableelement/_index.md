---
title: "Класс HTMLTableElement"
second_title: "Справочник API Aspose.HTML для Java"
description: "Класс com.aspose.html.HTMLTableElement. Методы создания и удаления в таблице позволяют авторам конструировать и изменять таблицы. HTML 4.01 указывает, что в таблице может существовать только один элемент каждого из CAPTION, THEAD и TFOOT. Поэтому, если такой элемент уже существует и вызывается метод createTHead или createTFoot, метод возвращает существующий элемент THead или TFoot. См. определение элемента TABLE в HTML 4.01."
type: docs

url: /ru/java/com.aspose.html/htmltableelement/
---
## HTMLTableElement class

Методы create* и delete* у таблицы позволяют авторам создавать и изменять таблицы. [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224)] указывает, что в таблице может существовать только один из элементов `CAPTION`, `THEAD` и `TFOOT`. Поэтому, если такой элемент уже существует, и вызывается метод createTHead() или createTFoot(), метод возвращает существующий элемент THead или TFoot. См. определение элемента TABLE в HTML 4.01.
...
| [getCaption](../../com.aspose.html/htmltableelement/caption/) Возвращает `CAPTION` таблицы, или void, если он отсутствует. @version DOM Level 2 |
[getCellPadding]
...
| [getRows](../../com.aspose.html/htmltableelement/rows/) Возвращает `TFOOT` таблицы, или `null`, если он отсутствует. |
[getRules]
...
| [getStyle](../../com.aspose.html/htmlelement/style/) Представляет атрибут стиля, который позволяет автору напрямую применять информацию о стиле к конкретному элементу. |
[getSummary]
...
| [getTBodies](../../com.aspose.html/htmltableelement/tbodies/) Возвращает коллекцию тел таблицы (включая неявные). |
...
| [getTFoot](../../com.aspose.html/htmltableelement/tfoot/) Возвращает `THEAD` таблицы, или `null`, если он отсутствует. |
| [getTHead](../../com.aspose.html/htmltableelement/thead/) Возвращает `CAPTION` таблицы, иначе void, если он отсутствует. |
[getTitle]
...
| [createCaption](../../com.aspose.html/htmltableelement/createcaption/)() | Создает новый объект подписи таблицы или возвращает существующий. |
| [createTFoot](../../com.aspose.html/htmltableelement/createtfoot/)() | Создает строку подвала таблицы или возвращает существующую. |
| [createTHead](../../com.aspose.html/htmltableelement/createthead/)() | Создает строку заголовка таблицы или возвращает существующую. |
| [deleteCaption](../../com.aspose.html/htmltableelement/deletecaption/)() | Удаляет подпись таблицы, если она существует. |
| [deleteRow](../../com.aspose.html/htmltableelement/deleterow/)(int) | Удаляет строку таблицы. |
| [deleteTFoot](../../com.aspose.html/htmltableelement/deletetfoot/)() | Удаляет подвал из таблицы, если он существует. |
| [deleteTHead](../../com.aspose.html/htmltableelement/deletethead/)() | Удаляет заголовок из таблицы, если он существует. |
...
| [insertRow](../../com.aspose.html/htmltableelement/insertrow/)(int) | Вставляет новую пустую строку в таблицу. Новая строка вставляется непосредственно перед текущей строкой с индексом `index` и в том же разделе таблицы. Если `index` равен -1 или равен количеству строк, новая строка добавляется в конец. Кроме того, когда таблица пуста, строка вставляется в `TBODY`, который создаётся и вставляется в таблицу. Строка таблицы не может быть пустой согласно [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224)]. |
...
| Имя | Описание |
| --- | --- |
| event [OnAbort](../../com.aspose.html/htmlelement/onabort/) | Получает или задает обработчик события OnAbort. |
| event [OnBlur](../../com.aspose.html/htmlelement/onblur/) | Получает или задает обработчик события OnBlur. |
| event [OnCancel](../../com.aspose.html/htmlelement/oncancel/) | Получает или задает обработчик события OnCancel. |
| event [OnCanplay](../../com.aspose.html/htmlelement/oncanplay/) | Получает или задает обработчик события OnCanplay. |
| event [OnCanPlayThrough](../../com.aspose.html/htmlelement/oncanplaythrough/) | Получает или задает обработчик события OnCanPlayThrough. |
| event [OnChange](../../com.aspose.html/htmlelement/onchange/) | Получает или задает обработчик события OnChange. |
| event [OnClick](../../com.aspose.html/htmlelement/onclick/) | Получает или задает обработчик события OnClick. |
| event [OnCueChange](../../com.aspose.html/htmlelement/oncuechange/) | Получает или задает обработчик события OnCueChange. |
| event [OnDblClick](../../com.aspose.html/htmlelement/ondblclick/) | Получает или задает обработчик события OnDblClick. |
| event [OnDurationChange](../../com.aspose.html/htmlelement/ondurationchange/) | Получает или задает обработчик события OnDurationChange. |
| event [OnEmptied](../../com.aspose.html/htmlelement/onemptied/) | Получает или задает обработчик события OnEmptied. |
| event [OnEnded](../../com.aspose.html/htmlelement/onended/) | Получает или задает обработчик события OnEnded. |
| event [OnError](../../com.aspose.html/htmlelement/onerror/) | Получает или задает обработчик события OnError. |
| event [OnFocus](../../com.aspose.html/htmlelement/onfocus/) | Получает или задает обработчик события OnFocus. |
| event [OnInput](../../com.aspose.html/htmlelement/oninput/) | Получает или задает обработчик события OnInput. |
...
| event [OnSeeked](../../com.aspose.html/htmlelement/onseeked/) | Получает или задает обработчик события OnSeeked. |
| event [OnSeeking](../../com.aspose.html/htmlelement/onseeking/) | Получает или задает обработчик события OnSeeking. |
| event [OnSelect](../../com.aspose.html/htmlelement/onselect/) | Получает или задает обработчик события OnSelect. |
| event [OnShow](../../com.aspose.html/htmlelement/onshow/) | Получает или задает обработчик события OnShow. |
| event [OnStalled](../../com.aspose.html/htmlelement/onstalled/) | Получает или задает обработчик события OnStalled. |
| event [OnSubmit](../../com.aspose.html/htmlelement/onsubmit/) | Получает или задает обработчик события OnSubmit. |
| event [OnSuspend](../../com.aspose.html/htmlelement/onsuspend/) | Получает или задает обработчик события OnSuspend. |
| event [OnTimeUpdate](../../com.aspose.html/htmlelement/ontimeupdate/) | Получает или задает обработчик события OnTimeUpdate. |
| event [OnToggle](../../com.aspose.html/htmlelement/ontoggle/) | Получает или задает обработчик события OnToggle. |
| event [OnVolumeChange](../../com.aspose.html/htmlelement/onvolumechange/) | Получает или задает обработчик события OnVolumeChange. |
| event [OnWaiting](../../com.aspose.html/htmlelement/onwaiting/) | Получает или задает обработчик события OnWaiting. |
