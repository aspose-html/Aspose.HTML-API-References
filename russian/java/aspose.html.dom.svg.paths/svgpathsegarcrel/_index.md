...
description: "com.aspose.html.dom.svg.paths.SVGPathSegArcRel класс. Интерфейс SVGPathSegArcRel соответствует относительной команде arcto a в данных пути."
type: docs

url: /ru/java/com.aspose.html.dom.svg.paths/svgpathsegarcrel/
---
## SVGPathSegArcRel class

Интерфейс SVGPathSegArcRel соответствует команде данных пути "relative arcto" (a).
...
| [X](../../com.aspose.html.dom.svg.paths/svgpathsegarcrel/x/) { get; set; } | Относительная координата X конечной точки этого сегмента пути. |
| [Y](../../com.aspose.html.dom.svg.paths/svgpathsegarcrel/y/) { get; set; } | Относительная координата Y конечной точки этого сегмента пути. |
