---
title: "SVGPathSegMovetoAbs Класс"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.dom.svg.paths.SVGPathSegMovetoAbs класс. Интерфейс SVGPathSegMovetoAbs соответствует абсолютной команде данных пути moveto M."
type: docs

url: /ru/java/com.aspose.html.dom.svg.paths/svgpathsegmovetoabs/
---
## SVGPathSegMovetoAbs class

Интерфейс SVGPathSegMovetoAbs соответствует команде данных пути "абсолютный moveto" (M).
...
| [X](../../com.aspose.html.dom.svg.paths/svgpathsegmovetoabs/x/) { get; set; } | Абсолютная координата X конечной точки этого сегмента пути. |
| [Y](../../com.aspose.html.dom.svg.paths/svgpathsegmovetoabs/y/) { get; set; } | Абсолютная координата Y конечной точки этого сегмента пути. |
