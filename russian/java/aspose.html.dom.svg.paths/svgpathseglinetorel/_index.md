---
title: "Класс SVGPathSegLinetoRel"
second_title: "Справочник API Aspose.HTML для Java"
description: "Класс com.aspose.html.dom.svg.paths.SVGPathSegLinetoRel. Интерфейс SVGPathSegLinetoRel соответствует относительной команде данных пути lineto l."
type: docs

url: /ru/java/com.aspose.html.dom.svg.paths/svgpathseglinetorel/
---
## SVGPathSegLinetoRel class

Интерфейс SVGPathSegLinetoRel соответствует команде данных пути "относительный lineto" (l).
...
| [X](../../com.aspose.html.dom.svg.paths/svgpathseglinetorel/x/) { get; set; } | Относительная координата X конечной точки этого сегмента пути. |
| [Y](../../com.aspose.html.dom.svg.paths/svgpathseglinetorel/y/) { get; set; } | Относительная координата Y конечной точки этого сегмента пути. |
