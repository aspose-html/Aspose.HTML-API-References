---
title: "SVGPathSegMovetoRel класс"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.dom.svg.paths.SVGPathSegMovetoRel класс. Интерфейс SVGPathSegMovetoRel соответствует относительной команде moveto m данных пути."
type: docs

url: /ru/java/com.aspose.html.dom.svg.paths/svgpathsegmovetorel/
---
## SVGPathSegMovetoRel class

Интерфейс SVGPathSegMovetoRel соответствует команде данных пути "относительный moveto" (m).
...
| [X](../../com.aspose.html.dom.svg.paths/svgpathsegmovetorel/x/) { get; set; } | Относительная координата X конечной точки этого сегмента пути. |
| [Y](../../com.aspose.html.dom.svg.paths/svgpathsegmovetorel/y/) { get; set; } | Относительная координата Y конечной точки этого сегмента пути. |
