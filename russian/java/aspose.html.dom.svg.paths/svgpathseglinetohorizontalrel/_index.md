---
title: "SVGPathSegLinetoHorizontalRel класс"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.dom.svg.paths.SVGPathSegLinetoHorizontalRel класс. Интерфейс SVGPathSegLinetoHorizontalRel соответствует относительной горизонтальной командой lineto h в данных пути"
type: docs

url: /ru/java/com.aspose.html.dom.svg.paths/svgpathseglinetohorizontalrel/
---
## SVGPathSegLinetoHorizontalRel class

Интерфейс SVGPathSegLinetoHorizontalRel соответствует команде данных пути "относительный горизонтальный lineto" (h).
...
| [X](../../com.aspose.html.dom.svg.paths/svgpathseglinetohorizontalrel/x/) { get; set; } | Относительная координата X конечной точки этого сегмента пути. |
