---
title: "SVGPathSegArcAbs Класс"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.dom.svg.paths.SVGPathSegArcAbs класс. Интерфейс SVGPathSegArcAbs соответствует абсолютной команде arcto A в данных пути."
type: docs

url: /ru/java/com.aspose.html.dom.svg.paths/svgpathsegarcabs/
---
## SVGPathSegArcAbs class

Интерфейс SVGPathSegArcAbs соответствует команде данных пути «абсолютный arcto» (A).
...
| [X](../../com.aspose.html.dom.svg.paths/svgpathsegarcabs/x/) { get; set; } | Абсолютная координата X конечной точки этого сегмента пути. |
| [Y](../../com.aspose.html.dom.svg.paths/svgpathsegarcabs/y/) { get; set; } | Абсолютная координата Y конечной точки этого сегмента пути. |
