---
title: "SVGPathSegLinetoVerticalAbs класс"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.dom.svg.paths.SVGPathSegLinetoVerticalAbs класс. Интерфейс SVGPathSegLinetoVerticalAbs соответствует абсолютной вертикальной команде lineto V данных пути."
type: docs

url: /ru/java/com.aspose.html.dom.svg.paths/svgpathseglinetoverticalabs/
---
## SVGPathSegLinetoVerticalAbs class

Интерфейс SVGPathSegLinetoVerticalAbs соответствует команде данных пути "абсолютный вертикальный lineto" (V).
...
| [Y](../../com.aspose.html.dom.svg.paths/svgpathseglinetoverticalabs/y/) { get; set; } | Абсолютная координата Y конечной точки этого сегмента пути. |
