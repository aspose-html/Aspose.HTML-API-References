---
title: "SVGPathSegCurvetoQuadraticAbs класс"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.dom.svg.paths.SVGPathSegCurvetoQuadraticAbs класс. Интерфейс SVGPathSegCurvetoQuadraticAbs соответствует абсолютной квадратичной Bézier‑команде curveto Q в данных пути"
type: docs

url: /ru/java/com.aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticabs/
---
## SVGPathSegCurvetoQuadraticAbs class

Интерфейс SVGPathSegCurvetoQuadraticAbs соответствует команде данных пути «абсолютный квадратичный Bézier curveto» (Q).
...
| [X](../../com.aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticabs/x/) { get; set; } | Абсолютная координата X конечной точки этого сегмента пути. |
[getX1]
[setX1] The absolute X coordinate for the first control point. |
| [Y](../../com.aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticabs/y/) { get; set; } | Абсолютная координата Y конечной точки этого сегмента пути. |
[getY1]
