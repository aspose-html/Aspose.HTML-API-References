...
description: "TypeInfo поле. Если схема документа является XML Schema (часть 1), эта константа представляет объединение, если задействованы простые типы."
type: docs

url: /ru/java/com.aspose.html.dom/typeinfo/derivation_union/
---
