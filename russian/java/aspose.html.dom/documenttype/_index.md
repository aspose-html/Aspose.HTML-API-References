---
title: "DocumentType класс"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.dom.DocumentType класс. DocumentType предоставляет интерфейс к списку сущностей, определённых для документа"
type: docs

url: /ru/java/com.aspose.html.dom/documenttype/
---
## DocumentType class

DocumentType предоставляет интерфейс к списку сущностей, определённых для документа.
...
| Имя | Описание |
| --- | --- |
| [DocumentType](documenttype/)(String, String, String, String, Document) | Инициализирует новый экземпляр класса `DocumentType`. |
...
| [getInternalSubset](../../com.aspose.html.dom/documenttype/internalsubset/) Внутреннее подмножество в виде строки, или null, если его нет. |
...
| [getName](../../com.aspose.html.dom/documenttype/name/) Имя DTD; то есть имя, непосредственно следующее за ключевым словом DOCTYPE. |
...
| [getNodeName](../../com.aspose.html.dom/documenttype/nodename/) Имя этого узла, в зависимости от его типа. |
| [getNodeType](../../com.aspose.html.dom/documenttype/nodetype/) Код, представляющий тип базового объекта. |
...
| [getPublicId](../../com.aspose.html.dom/documenttype/publicid/) Публичный идентификатор внешнего подмножества. |
| [getSystemId](../../com.aspose.html.dom/documenttype/systemid/) Системный идентификатор внешнего подмножества. Это может быть абсолютный URI или нет. |
...
| [toString](../../com.aspose.html.dom/documenttype/toString/)() | Возвращает строку, представляющую этот экземпляр. |
