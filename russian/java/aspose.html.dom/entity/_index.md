...
description: "Класс com.aspose.html.dom.Entity. Представляет известную сущность, либо разобранную, либо неразобранную в XML‑документе."
type: docs

url: /ru/java/com.aspose.html.dom/entity/
---
## Entity class

Представляет известную сущность, либо разобранную, либо неразобранную, в XML‑документе.
...
| [getInputEncoding](../../com.aspose.html.dom/entity/inputencoding/) Атрибут, указывающий кодировку, используемую для этой сущности во время разбора, когда это внешняя разобранная сущность. Значение null, если это сущность из внутреннего подмножества или если она неизвестна. |
...
| [getNodeName](../../com.aspose.html.dom/entity/nodename/) Имя этого узла, в зависимости от его типа. |
| [getNodeType](../../com.aspose.html.dom/entity/nodetype/) Код, представляющий тип базового объекта. |
...
| [getNotationName](../../com.aspose.html.dom/entity/notationname/) Для неразобранных сущностей — имя обозначения для сущности. Для разобранных сущностей значение null. |
...
| [getPublicId](../../com.aspose.html.dom/entity/publicid/) Публичный идентификатор, связанный с сущностью, если указан, иначе null. |
| [getSystemId](../../com.aspose.html.dom/entity/systemid/) Системный идентификатор, связанный с сущностью, если указан, иначе null. Это может быть абсолютный URI или нет. |
...
| [getXmlEncoding](../../com.aspose.html.dom/entity/xmlencoding/) Атрибут, указывающий, как часть текстового объявления, кодировку этой сущности, когда это внешняя разобранная сущность. В остальных случаях значение null. |
| [getXmlVersion](../../com.aspose.html.dom/entity/xmlversion/) Атрибут, указывающий, как часть текстового объявления, номер версии этой сущности, когда это внешняя разобранная сущность. В остальных случаях значение null. |
