...
| [getNotationName](../../com.aspose.html.dom/entity/notationname/) Для неразобранных сущностей — имя нотации для сущности. Для разобранных сущностей значение null. |
...
| [getSystemId](../../com.aspose.html.dom/entity/systemid/) Системный идентификатор, связанный с сущностью, если указан, иначе null. Может быть абсолютным URI или нет. |
