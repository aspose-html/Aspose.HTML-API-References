...
description: "Метод Document. Возвращает список элементов с заданным именем тега, принадлежащих указанному пакету. Поиск производится по всему документу, включая корневой узел."
type: docs
...
| --- | --- | --- |
| packageURI | String | URI пакета элементов, которые необходимо найти. |
...
Живой [`NodeList`](../../../com.aspose.html.collections/nodelist/) (но см. примечание ниже) найденных элементов в порядке их появления в дереве.
