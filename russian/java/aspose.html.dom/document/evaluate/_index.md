...
description: "Метод Document. Выполняет оценку строки XPath-выражения и возвращает результат указанного типа, если это возможно"
type: docs
...
| contextNode | Node | Контекст — это контекстный узел для оценки этого XPath-выражения. |
