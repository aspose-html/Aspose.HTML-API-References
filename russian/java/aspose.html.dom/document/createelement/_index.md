...
description: "Метод Document. В HTML‑документе метод document.createElement создаёт HTML‑элемент, указанный в tagName, или HTMLUnknownElement, если tagName не распознан."
type: docs
...
В HTML‑документе метод document.createElement() создаёт HTML‑элемент, указанный в tagName, или [`HTMLUnknownElement`](../../../com.aspose.html/htmlunknownelement/), если tagName не распознан.
