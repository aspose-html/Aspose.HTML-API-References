...
При вызове на объекте документа производится поиск по всему документу, включая корневой узел. Вы также можете вызвать getElementsByClassName() на любом элементе; он вернёт только те элементы, которые являются потомками указанного корневого элемента с заданными именами классов.
