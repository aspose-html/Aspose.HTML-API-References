...
description: "DOMException поле. Если тип объекта несовместим с ожидаемым типом параметра, связанным с объектом"
type: docs

url: /ru/java/com.aspose.html.dom/domexception/type_mismatch_err/
---
