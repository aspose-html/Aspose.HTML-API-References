...
description: "Класс com.aspose.html.dom.EntityReference. Узлы EntityReference могут использоваться для представления ссылки на сущность в дереве"
type: docs

url: /ru/java/com.aspose.html.dom/entityreference/
---
...
| [getNodeName](../../com.aspose.html.dom/entityreference/nodename/) Имя этого узла, в зависимости от его типа. |
| [getNodeType](../../com.aspose.html.dom/entityreference/nodetype/) Код, представляющий тип базового объекта. |
