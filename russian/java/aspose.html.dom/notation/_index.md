---
title: "Notation класс"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.dom.Notation класс. Представляет обозначение, объявленное в DTD"
type: docs

url: /ru/java/com.aspose.html.dom/notation/
---
## Notation class

Представляет обозначение, объявленное в DTD.
...
| [getNodeName](../../com.aspose.html.dom/notation/nodename/) Имя этого узла, в зависимости от его типа. |
| [getNodeType](../../com.aspose.html.dom/notation/nodetype/) Код, представляющий тип базового объекта. |
...
| [getPublicId](../../com.aspose.html.dom/notation/publicid/) Публичный идентификатор этого обозначения. Если публичный идентификатор не был указан, значение равно null. |
| [getSystemId](../../com.aspose.html.dom/notation/systemid/) Системный идентификатор этого обозначения. Если системный идентификатор не был указан, значение равно null. Это может быть абсолютный URI или нет. |
