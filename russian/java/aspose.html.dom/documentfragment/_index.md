...
DocumentFragment — это "легковесный" или "минимальный" объект Document. Очень часто требуется возможность извлечь часть дерева документа или создать новый фрагмент документа.
