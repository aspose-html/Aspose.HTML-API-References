...
description: "IGlobalEventHandlers событие. Получает или задает обработчик события для события OnSubmit"
type: docs

url: /ru/java/com.aspose.html.dom/iglobaleventhandlers/onsubmit/
---
