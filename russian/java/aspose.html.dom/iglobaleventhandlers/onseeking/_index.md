...
description: "IGlobalEventHandlers событие. Получает или задает обработчик события для OnSeeking события"
type: docs

url: /ru/java/com.aspose.html.dom/iglobaleventhandlers/onseeking/
---
