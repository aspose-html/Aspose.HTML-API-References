...
description: "IGlobalEventHandlers событие. Получает или задает обработчик события OnDblClick event"
type: docs

url: /ru/java/com.aspose.html.dom/iglobaleventhandlers/ondblclick/
---
