...
description: "IGlobalEventHandlers событие. Получает или задает обработчик события для события OnCanPlayThrough."
type: docs

url: /ru/java/com.aspose.html.dom/iglobaleventhandlers/oncanplaythrough/
---
