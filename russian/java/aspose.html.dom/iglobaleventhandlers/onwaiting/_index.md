...
description: "IGlobalEventHandlers событие. Получает или задает обработчик события для события OnWaiting"
type: docs

url: /ru/java/com.aspose.html.dom/iglobaleventhandlers/onwaiting/
---
