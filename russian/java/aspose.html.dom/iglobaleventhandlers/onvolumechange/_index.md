...
description: "IGlobalEventHandlers событие. Получает или задает обработчик события OnVolumeChange."
type: docs

url: /ru/java/com.aspose.html.dom/iglobaleventhandlers/onvolumechange/
---
