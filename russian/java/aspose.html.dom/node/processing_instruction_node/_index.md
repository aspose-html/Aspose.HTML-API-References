...
description: "Поле Node. Объект ProcessingInstruction XML‑документа, такой как xml-stylesheet"
type: docs

url: /ru/java/com.aspose.html.dom/node/processing_instruction_node/
---
## Node.PROCESSING_INSTRUCTION_NODE field

Объект [`ProcessingInstruction`](../../processinginstruction/) XML‑документа, такой как &lt;?xml-stylesheet … ?&gt;.
