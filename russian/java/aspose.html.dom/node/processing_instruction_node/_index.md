...
description: "Поле Node. ProcessingInstruction XML‑документа, например xml-stylesheet"
type: docs
...
[`ProcessingInstruction`](../../processinginstruction/) XML‑документа, такой как &lt;?xml-stylesheet … ?&gt;.
