...
description: "Метод ICanvasRenderingContext2D. Рисует обводку заданного текста в указанной позиции x y."
type: docs
