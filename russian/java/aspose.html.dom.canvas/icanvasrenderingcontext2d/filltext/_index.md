...
| x | Double | Ось x координаты начальной точки текста. |
| y | Double | Ось y координаты начальной точки текста. |
| maxWidth | Double | Максимальная ширина для отрисовки. Если указана и вычисленная строка оказывается шире этой ширины, шрифт корректируется, используя более горизонтально сжатый шрифт (если такой доступен или если его можно синтезировать, масштабируя текущий шрифт по горизонтали) или более маленький шрифт. |
