...
| [arc](../../com.aspose.html.dom.canvas/path2d/arc/#arc)(double, double, double, double, double) | Добавляет дугу к пути, центрированной в позиции (x, y) с радиусом r, начиная с угла startAngle и заканчивая углом endAngle, движущуюся в указанном направлении против часовой стрелки (по умолчанию по часовой). |
| [arc](../../com.aspose.html.dom.canvas/path2d/arc/#arc_1)(double, double, double, double, double, bool) | Добавляет дугу к пути, центрированной в позиции (x, y) с радиусом r, начиная с угла startAngle и заканчивая углом endAngle, движущуюся в указанном направлении против часовой стрелки (по умолчанию по часовой). |
