...
description: "Пакет com.aspose.html.net представлен классами и интерфейсами, отвечающими за упрощённую обработку сети."
type: docs

url: /ru/java/com.aspose.html.net/
---
Пакет **com.aspose.html.net** представлен классами и интерфейсами, отвечающими за упрощённую обработку сетевых операций.

## Классы

| Класс | Описание |
| --- | --- |
| [ByteArrayContent](./bytearraycontent/) | Представляет содержимое, основанное на массиве байтов. |
| [Content](./content/) | Представляет базовый класс для тела HTTP‑сущности и заголовков содержимого. |
...
| [HttpMethod](./httpmethod/) | Представляет вспомогательный класс для получения и сравнения стандартных методов HTTP. |
...
| [MessageHandlerCollection](./messagehandlercollection/) | Представляет коллекцию [`MessageHandler`](../com.aspose.html.net/messagehandler/). |
...
| [UrlResolver](./urlresolver/) | Представляет вспомогательный класс для разрешения абсолютного URL по Универсальному идентификатору ресурса (URI). |
## Интерфейсы
