...
description: "Метод MultipartFormDataContent. Добавляет содержимое в класс MultipartFormDataContent."
type: docs

url: /ru/java/com.aspose.html.net/multipartformdatacontent/add/
---
## Add(Content) {#add}
