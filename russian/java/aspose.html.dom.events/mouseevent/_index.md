...
description: "com.aspose.html.dom.events.MouseEvent class. Интерфейс MouseEvent предоставляет специфическую контекстную информацию, связанную с событиями мыши."
type: docs
