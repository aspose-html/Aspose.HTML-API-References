---
title: "InputEvent Класс"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.dom.events.InputEvent класс. События ввода отправляются в виде уведомлений каждый раз, когда DOM обновляется."
type: docs
...
| [getIsComposing](../../com.aspose.html.dom.events/inputevent/iscomposing/) true, если событие ввода происходит в рамках сессии композиции, то есть после события compositionstart и до соответствующего события compositionend. Неинициализированное значение этого атрибута ДОЛЖНО быть false. |
