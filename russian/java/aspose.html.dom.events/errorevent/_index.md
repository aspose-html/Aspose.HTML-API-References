---
title: "Класс ErrorEvent"
second_title: "Справочник API Aspose.HTML для Java"
description: "Класс com.aspose.html.dom.events.ErrorEvent. ErrorEvent предоставляет контекстную информацию об ошибках, произошедших во время выполнения"
type: docs

url: /ru/java/com.aspose.html.dom.events/errorevent/
---
## ErrorEvent class

ErrorEvent предоставляет контекстную информацию об ошибках, произошедших во время выполнения.
...
| Имя | Описание |
| --- | --- |
| [ErrorEvent](errorevent/#constructor_1)(Exception) | Инициализирует новый экземпляр класса `ErrorEvent`. |
...
| [getColNo](../../com.aspose.html.dom.events/errorevent/colno/) Атрибут colno должен возвращать значение, с которым он был инициализирован. При создании объекта этот атрибут должен быть инициализирован нулём. Он представляет номер столбца, в котором ошибка произошла в скрипте. |
...
| [getLineNo](../../com.aspose.html.dom.events/errorevent/lineno/) Атрибут lineno должен возвращать значение, с которым он был инициализирован. При создании объекта этот атрибут должен быть инициализирован нулём. Он представляет номер строки, где произошла ошибка в скрипте. |
