...
description: "Класс com.aspose.html.dom.events.CustomEvent. События, использующие интерфейс CustomEvent, могут использоваться для передачи пользовательских данных."
type: docs
