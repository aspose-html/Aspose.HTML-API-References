...
| Имя | Описание |
| --- | --- |
| [XpsDevice](xpsdevice/#constructor)(ICreateStreamProvider) | Создаёт новый экземпляр класса `XpsDevice`. |
| [XpsDevice](xpsdevice/#constructor_4)(Stream) | Создаёт новый экземпляр класса `XpsDevice`. |
| [XpsDevice](xpsdevice/#constructor_5)(String) | Создаёт новый экземпляр класса `XpsDevice`. |
| [XpsDevice](xpsdevice/#constructor_1)(XpsRenderingOptions, ICreateStreamProvider) | Создаёт новый экземпляр класса `XpsDevice` с параметрами рендеринга и поставщиком потока. |
| [XpsDevice](xpsdevice/#constructor_2)(XpsRenderingOptions, Stream) | Создаёт новый экземпляр класса `XpsDevice` с параметрами рендеринга и выходным потоком. |
| [XpsDevice](xpsdevice/#constructor_3)(XpsRenderingOptions, String) | Создаёт новый экземпляр класса `XpsDevice` с параметрами рендеринга и именем выходного файла. |
