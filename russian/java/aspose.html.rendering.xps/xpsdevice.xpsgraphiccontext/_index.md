---
title: "Класс XpsDevice.XpsGraphicContext"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.rendering.xps.XpsDeviceXpsGraphicContext класс. Содержит текущие параметры управления графикой для XpsDevice. Эти параметры определяют глобальную структуру, в которой выполняются графические операторы."
type: docs

url: /ru/java/com.aspose.html.rendering.xps/xpsdevice.xpsgraphiccontext/
---
...
| Имя | Описание |
| --- | --- |
| [xpsGraphicContext](../../com.aspose.html.rendering.xps/xpsdevice.xpsgraphiccontext/.ctor)() | Конструктор по умолчанию. |
