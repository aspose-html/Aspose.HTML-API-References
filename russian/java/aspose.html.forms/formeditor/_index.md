...
| [getForm](../../com.aspose.html.forms/formeditor/form/) Исходный [`HTMLFormElement`](../../com.aspose.html/htmlformelement/), связанный с текущим экземпляром `FormEditor`. |
...
| Имя | Описание |
| --- | --- |
| static [Create](../../com.aspose.html.forms/formeditor/create/#create_2)(HTMLFormElement) | Создаёт новый `FormEditor`, основанный на [`HTMLFormElement`](../../com.aspose.html/htmlformelement/). |
| static [Create](../../com.aspose.html.forms/formeditor/create/#create)(HTMLDocument, int) | Создаёт новый `FormEditor`, основанный на [`HTMLFormElement`](../../com.aspose.html/htmlformelement/), выбранном из коллекции [`Forms`](../../com.aspose.html/htmldocument/forms/) по индексу. |
| static [Create](../../com.aspose.html.forms/formeditor/create/#create_1)(HTMLDocument, String) | Создаёт новый `FormEditor`, основанный на [`HTMLFormElement`](../../com.aspose.html/htmlformelement/), выбранном из документа по id. |
| static [CreateNew](../../com.aspose.html.forms/formeditor/createnew/)(HTMLDocument) | Создаёт новый [`HTMLFormElement`](../../com.aspose.html/htmlformelement/) и связывает его с `FormEditor`. [`HTMLFormElement`](../../com.aspose.html/htmlformelement/) создаётся в отсоединённом от документа состоянии; чтобы присоединить его к документу, пожалуйста, выберите подходящее место и используйте метод [`AppendChild`](../../com.aspose.html.dom/node/appendchild/). |
