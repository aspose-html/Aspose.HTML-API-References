...
description: "Класс com.aspose.html.forms.FormSubmitter. Этот класс позволяет подготовить указанный HTMLFormElement, собрать значения из элемента формы, отправить их на удалённый сервер и получить ответ."
type: docs
...
| Имя | Описание |
| --- | --- |
| [dispose](../../com.aspose.html.forms/formsubmitter/dispose/)() | Освобождает неуправляемые и — при необходимости — управляемые ресурсы. |
