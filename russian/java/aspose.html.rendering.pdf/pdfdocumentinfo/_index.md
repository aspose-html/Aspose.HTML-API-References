...
description: "Класс com.aspose.html.rendering.pdf.PdfDocumentInfo. Представляет информацию о PDF‑документе."
type: docs

url: /ru/java/com.aspose.html.rendering.pdf/pdfdocumentinfo/
---
## PdfDocumentInfo class

Представляет информацию о PDF‑документе.
