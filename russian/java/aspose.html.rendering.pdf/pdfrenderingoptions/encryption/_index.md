...
description: "Свойство PdfRenderingOptions. Получает или задаёт параметры шифрования. Если не задано, шифрование не будет выполнено."
type: docs

url: /ru/java/com.aspose.html.rendering.pdf/pdfrenderingoptions/encryption/
---
