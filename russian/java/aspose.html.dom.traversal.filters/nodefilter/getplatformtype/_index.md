...
description: "Метод NodeFilter. Этот метод используется для получения типа объекта ECMAScript."
type: docs

url: /ru/java/com.aspose.html.dom.traversal.filters/nodefilter/getplatformtype/
---
