---
title: "Класс SVGFEMorphologyElement"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.dom.svg.filters.SVGFEMorphologyElement class. Интерфейс SVGFEMorphologyElement соответствует элементу feMorphology."
type: docs

url: /ru/java/com.aspose.html.dom.svg.filters/svgfemorphologyelement/
---
## SVGFEMorphologyElement class

Интерфейс SVGFEMorphologyElement соответствует элементу ‘feMorphology’
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/height/) Соответствует атрибуту ‘height’ в данном элементе ‘filter’. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/in1/) Соответствует атрибуту ‘in’ в данном элементе ‘feMorphology’. |
[getInnerHTML]
...
| [getOperator](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/operator/) Соответствует атрибуту ‘operator’ данного элемента ‘feMorphology’. Принимает одну из констант SVG_MORPHOLOGY_OPERATOR_* , определённых в этом интерфейсе. |
[getOuterHTML]
...
| [getRadiusX](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/radiusx/) Соответствует атрибуту ‘radius’ данного элемента ‘feMorphology’. |
| [getRadiusY](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/radiusy/) Соответствует атрибуту ‘radius’ данного элемента ‘feMorphology’. |
| [getResult](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/result/) Соответствует атрибуту ‘result’ данного элемента ‘filter’. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/width/) Соответствует атрибуту ‘width’ данного элемента ‘filter’. |
| [X](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/x/) { get; } | Соответствует атрибуту ‘x’ указанного элемента ‘filter’. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/y/) { get; } | Соответствует атрибуту ‘y’ указанного элемента ‘filter’. |
...
| Имя | Описание |
| --- | --- |
| const [SVG_MORPHOLOGY_OPERATOR_DILATE](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/svg_morphology_operator_dilate/) | Соответствует значению 'dilate'. |
| const [SVG_MORPHOLOGY_OPERATOR_ERODE](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/svg_morphology_operator_erode/) | Соответствует значению 'erode'. |
| const [SVG_MORPHOLOGY_OPERATOR_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/svg_morphology_operator_unknown/) | Тип не является одним из предопределённых типов. Недопустимо пытаться определить новое значение этого типа или пытаться переключить существующее значение на этот тип. |
