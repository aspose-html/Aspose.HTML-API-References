...
description: "com.aspose.html.dom.svg.filters.SVGFEMorphologyElement класс. Интерфейс SVGFEMorphologyElement соответствует элементу feMorphology."
type: docs
...
| [getOperator](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/operator/) Соответствует атрибуту ‘operator’ у указанного элемента ‘feMorphology’. Принимает одну из констант SVG_MORPHOLOGY_OPERATOR_* , определённых в этом интерфейсе. |
[getOuterHTML]
...
| [getRadiusX](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/radiusx/) Соответствует атрибуту ‘radius’ у указанного элемента ‘feMorphology’. |
| [getRadiusY](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/radiusy/) Соответствует атрибуту ‘radius’ у указанного элемента ‘feMorphology’. |
| [getResult](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/result/) Соответствует атрибуту ‘result’ у указанного элемента ‘filter’. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/width/) Соответствует атрибуту ‘width’ у указанного элемента ‘filter’. |
| [X](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/x/) { get; } | Соответствует атрибуту ‘x’ данного элемента ‘filter’. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/y/) { get; } | Соответствует атрибуту ‘y’ данного элемента ‘filter’. |
