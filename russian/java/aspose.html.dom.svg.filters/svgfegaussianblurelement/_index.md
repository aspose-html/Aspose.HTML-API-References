---
title: "Класс SVGFEGaussianBlurElement"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.dom.svg.filters.SVGFEGaussianBlurElement класс. Интерфейс SVGFEGaussianBlurElement соответствует элементу feGaussianBlur"
type: docs

url: /ru/java/com.aspose.html.dom.svg.filters/svgfegaussianblurelement/
---
## SVGFEGaussianBlurElement class

Интерфейс SVGFEGaussianBlurElement соответствует элементу �feGaussianBlur�
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/height/) Соответствует атрибуту �height� в данном элементе �filter�. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/in1/) Соответствует атрибуту �in� в данном элементе �feGaussianBlur�. |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/result/) Соответствует атрибуту �result� в данном элементе �filter�. |
...
| [getStdDeviationX](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/stddeviationx/) Соответствует атрибуту �stdDeviation� в данном элементе �feGaussianBlur�. Содержит X‑компонент атрибута �stdDeviation�. |
| [getStdDeviationY](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/stddeviationy/) Соответствует атрибуту �stdDeviation� в данном элементе �feGaussianBlur�. Содержит Y‑компонент (возможно вычисляемый автоматически) атрибута �stdDeviation�. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/width/) Соответствует атрибуту �width� в данном элементе �filter�. |
| [X](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/x/) { get; } | Соответствует атрибуту �x� в данном элементе �filter�. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/y/) { get; } | Соответствует атрибуту �y� в данном элементе �filter�. |
...
| [setStdDeviation](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/setstddeviation/)(float, float) | Устанавливает значения атрибута �stdDeviation�. |
