...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/height/) Соответствует атрибуту ‘height’ указанного элемента ‘filter’. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/in1/) Соответствует атрибуту ‘in’ указанного элемента ‘feColorMatrix’. |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/result/) Соответствует атрибуту ‘result’ указанного элемента ‘filter’. |
...
| [getType](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/type/) Соответствует атрибуту ‘type’ указанного элемента ‘feColorMatrix’. Принимает одну из констант SVG_FECOLORMATRIX_TYPE_*, определённых в этом интерфейсе. |
| [getValues](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/values/) Соответствует атрибуту ‘values’ указанного элемента ‘feColorMatrix’. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/width/) Соответствует атрибуту ‘width’ указанного элемента ‘filter’. |
| [X](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/x/) { get; } | Соответствует атрибуту ‘x’ данного элемента ‘filter’. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/y/) { get; } | Соответствует атрибуту ‘y’ данного элемента ‘filter’. |
