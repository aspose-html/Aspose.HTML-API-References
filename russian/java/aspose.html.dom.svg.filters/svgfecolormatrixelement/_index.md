---
title: "Класс SVGFEColorMatrixElement"
second_title: "Справочник API Aspose.HTML для Java"
description: "Класс com.aspose.html.dom.svg.filters.SVGFEColorMatrixElement. Интерфейс SVGFEColorMatrixElement соответствует элементу feColorMatrix."
type: docs

url: /ru/java/com.aspose.html.dom.svg.filters/svgfecolormatrixelement/
---
## SVGFEColorMatrixElement class

Интерфейс SVGFEColorMatrixElement соответствует элементу ‘feColorMatrix’
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/height/) Соответствует атрибуту ‘height’ у указанного элемента ‘filter’. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/in1/) Соответствует атрибуту ‘in’ у указанного элемента ‘feColorMatrix’. |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/result/) Соответствует атрибуту ‘result’ у указанного элемента ‘filter’. |
...
| [getType](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/type/) Соответствует атрибуту ‘type’ у указанного элемента ‘feColorMatrix’. Принимает одну из констант SVG_FECOLORMATRIX_TYPE_*, определённых в этом интерфейсе. |
| [getValues](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/values/) Соответствует атрибуту ‘values’ у указанного элемента ‘feColorMatrix’. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/width/) Соответствует атрибуту ‘width’ у указанного элемента ‘filter’. |
| [X](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/x/) { get; } | Соответствует атрибуту ‘x’ указанного элемента ‘filter’. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/y/) { get; } | Соответствует атрибуту ‘y’ указанного элемента ‘filter’. |
...
| Имя | Описание |
| --- | --- |
| const [SVG_FECOLORMATRIX_TYPE_HUEROTATE](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_huerotate/) | Соответствует значению 'hueRotate'. |
| const [SVG_FECOLORMATRIX_TYPE_LUMINANCETOALPHA](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_luminancetoalpha/) | Соответствует значению 'luminanceToAlpha'. |
| const [SVG_FECOLORMATRIX_TYPE_MATRIX](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_matrix/) | Соответствует значению 'matrix'. |
| const [SVG_FECOLORMATRIX_TYPE_SATURATE](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_saturate/) | Соответствует значению 'saturate'. |
| const [SVG_FECOLORMATRIX_TYPE_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_unknown/) | Тип не является одним из предопределённых типов. Недопустимо пытаться определить новое значение этого типа или пытаться переключить существующее значение на этот тип. |
