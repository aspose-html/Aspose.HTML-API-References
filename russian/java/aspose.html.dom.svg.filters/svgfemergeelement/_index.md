...
description: "com.aspose.html.dom.svg.filters.SVGFEMergeElement класс. Интерфейс SVGFEMergeElement соответствует элементу feMerge."
type: docs
...
| [X](../../com.aspose.html.dom.svg.filters/svgfemergeelement/x/) { get; } | Соответствует атрибуту ‘x’ данного элемента ‘filter’. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfemergeelement/y/) { get; } | Соответствует атрибуту ‘y’ данного элемента ‘filter’. |
