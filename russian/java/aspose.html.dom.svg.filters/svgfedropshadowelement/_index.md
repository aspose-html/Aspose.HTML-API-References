---
title: "SVGFEDropShadowElement Класс"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.dom.svg.filters.SVGFEDropShadowElement класс. Интерфейс SVGFEDropShadowElement соответствует элементу feDropShadow"
type: docs
...
| [getDx](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/dx/) Соответствует атрибуту ‘dx’ указанного элемента ‘feDropShadow’. |
| [getDy](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/dy/) Соответствует атрибуту ‘dy’ указанного элемента ‘feDropShadow’. |
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/height/) Соответствует атрибуту ‘height’ указанного элемента ‘feDropShadow’. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/in1/) Соответствует атрибуту ‘in’ указанного элемента ‘feDropShadow’. |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/result/) Соответствует атрибуту ‘result’ указанного элемента ‘feDropShadow’. |
...
| [getStdDeviationX](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/stddeviationx/) Соответствует атрибуту ‘stdDeviation’ указанного элемента ‘feDropShadow’. Содержит X‑компонент атрибута ‘stdDeviation’. |
| [getStdDeviationY](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/stddeviationy/) Соответствует атрибуту ‘stdDeviation’ указанного элемента ‘feDropShadow’. Содержит Y‑компонент (возможно вычисляемый автоматически) атрибута ‘stdDeviation’. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/width/) Соответствует атрибуту ‘width’ указанного элемента ‘feDropShadow’. |
| [X](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/x/) { get; } | Соответствует атрибуту ‘x’ указанного элемента ‘feDropShadow’. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/y/) { get; } | Соответствует атрибуту ‘y’ указанного элемента ‘feDropShadow’. |
