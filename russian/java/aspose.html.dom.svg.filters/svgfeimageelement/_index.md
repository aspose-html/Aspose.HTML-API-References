...
description: "com.aspose.html.dom.svg.filters.SVGFEImageElement класс. Интерфейс SVGFEImageElement соответствует элементу feImage."
type: docs
...
| [X](../../com.aspose.html.dom.svg.filters/svgfeimageelement/x/) { get; } | Соответствует атрибуту ‘x’ данного элемента ‘filter’. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfeimageelement/y/) { get; } | Соответствует атрибуту ‘y’ данного элемента ‘filter’. |
