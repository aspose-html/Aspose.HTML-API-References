---
title: "Класс SVGFEDisplacementMapElement"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.dom.svg.filters.SVGFEDisplacementMapElement класс. Интерфейс SVGFEDisplacementMapElement соответствует элементу feDisplacementMap"
type: docs

url: /ru/java/com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/
---
## SVGFEDisplacementMapElement class

Интерфейс SVGFEDisplacementMapElement соответствует элементу ‘feDisplacementMap’
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/height/) Соответствует атрибуту ‘height’ в данном элементе ‘filter’. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/in1/) Соответствует атрибуту ‘in’ в данном элементе ‘feDisplacementMap’. |
| [getIn2](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/in2/) Соответствует атрибуту ‘in2’ в данном элементе ‘feDisplacementMap’. |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/result/) Соответствует атрибуту ‘result’ в данном элементе ‘filter’. |
| [getScale](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/scale/) Соответствует атрибуту ‘scale’ в данном элементе ‘feDisplacementMap’. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/width/) Соответствует атрибуту ‘width’ в данном элементе ‘filter’. |
| [X](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/x/) { get; } | Соответствует атрибуту ‘x’ указанного элемента ‘filter’. |
| [getXChannelSelector](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/xchannelselector/) Соответствует атрибуту ‘xChannelSelector’ в данном элементе ‘feDisplacementMap’. Принимает одну из констант SVG_CHANNEL_*, определённых в этом интерфейсе. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/y/) { get; } | Соответствует атрибуту ‘y’ указанного элемента ‘filter’. |
| [getYChannelSelector](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/ychannelselector/) Соответствует атрибуту ‘yChannelSelector’ заданного элемента ‘feDisplacementMap’. Принимает одну из констант SVG_CHANNEL_* , определённых в этом интерфейсе. |
...
| Имя | Описание |
| --- | --- |
| const [SVG_CHANNEL_A](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_a/) | Соответствует значению 'A'. |
| const [SVG_CHANNEL_B](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_b/) | Соответствует значению 'B'. |
| const [SVG_CHANNEL_G](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_g/) | Соответствует значению 'G'. |
| const [SVG_CHANNEL_R](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_r/) | Соответствует значению 'R'. |
| const [SVG_CHANNEL_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_unknown/) | Тип не является одним из предопределённых типов. Недопустимо пытаться определить новое значение этого типа или пытаться переключить существующее значение на этот тип. |
