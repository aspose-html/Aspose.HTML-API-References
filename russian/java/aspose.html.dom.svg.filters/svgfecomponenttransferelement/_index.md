---
title: "Класс SVGFEComponentTransferElement"
second_title: "Справочник API Aspose.HTML для Java"
description: "Класс com.aspose.html.dom.svg.filters.SVGFEComponentTransferElement. Интерфейс SVGFEComponentTransferElement соответствует элементу feComponentTransfer."
type: docs
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfecomponenttransferelement/height/) Соответствует атрибуту ‘height’ у указанного элемента ‘filter’. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfecomponenttransferelement/in1/) Соответствует атрибуту ‘in’ у указанного элемента ‘feComponentTransfer’. |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfecomponenttransferelement/result/) Соответствует атрибуту ‘result’ у указанного элемента ‘filter’. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfecomponenttransferelement/width/) Соответствует атрибуту ‘width’ у указанного элемента ‘filter’. |
| [X](../../com.aspose.html.dom.svg.filters/svgfecomponenttransferelement/x/) { get; } | Соответствует атрибуту ‘x’ данного элемента ‘filter’. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfecomponenttransferelement/y/) { get; } | Соответствует атрибуту ‘y’ данного элемента ‘filter’. |
