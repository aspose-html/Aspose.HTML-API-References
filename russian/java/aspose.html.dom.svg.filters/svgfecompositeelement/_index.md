---
title: "Класс SVGFECompositeElement"
second_title: "Справочник API Aspose.HTML для Java"
description: "Класс com.aspose.html.dom.svg.filters.SVGFECompositeElement. Интерфейс SVGFECompositeElement соответствует элементу feComposite."
type: docs
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/height/) Соответствует атрибуту ‘height’ у указанного элемента ‘filter’. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/in1/) Соответствует атрибуту ‘in’ у указанного элемента ‘feComposite’. |
| [getIn2](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/in2/) Соответствует атрибуту ‘in2’ у указанного элемента ‘feComposite’. |
[getInnerHTML]
...
| [getK1](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k1/) Соответствует атрибуту ‘k1’ у указанного элемента ‘feComposite’. |
| [getK2](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k2/) Соответствует атрибуту ‘k2’ у указанного элемента ‘feComposite’. |
| [getK3](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k3/) Соответствует атрибуту ‘k3’ у указанного элемента ‘feComposite’. |
| [getK4](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k4/) Соответствует атрибуту ‘k4’ у указанного элемента ‘feComposite’. |
...
| [getOperator](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/operator/) Соответствует атрибуту ‘operator’ у указанного элемента ‘feComposite’. Принимает одну из констант SVG_FECOMPOSITE_OPERATOR_* , определённых в этом интерфейсе. |
[getOuterHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/result/) Соответствует атрибуту ‘result’ у указанного элемента ‘filter’. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/width/) Соответствует атрибуту ‘width’ у указанного элемента ‘filter’. |
| [X](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/x/) { get; } | Соответствует атрибуту ‘x’ данного элемента ‘filter’. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/y/) { get; } | Соответствует атрибуту ‘y’ данного элемента ‘filter’. |
