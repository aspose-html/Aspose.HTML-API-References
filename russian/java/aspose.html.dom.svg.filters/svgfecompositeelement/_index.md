---
title: "SVGFECompositeElement Класс"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.dom.svg.filters.SVGFECompositeElement класс. Интерфейс SVGFECompositeElement соответствует элементу feComposite."
type: docs

url: /ru/java/com.aspose.html.dom.svg.filters/svgfecompositeelement/
---
## SVGFECompositeElement class

Интерфейс SVGFECompositeElement соответствует элементу ‘feComposite’
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/height/) Соответствует атрибуту ‘height’ данного элемента ‘filter’. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/in1/) Соответствует атрибуту ‘in’ данного элемента ‘feComposite’. |
| [getIn2](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/in2/) Соответствует атрибуту ‘in2’ данного элемента ‘feComposite’. |
[getInnerHTML]
...
| [getK1](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k1/) Соответствует атрибуту ‘k1’ данного элемента ‘feComposite’. |
| [getK2](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k2/) Соответствует атрибуту ‘k2’ данного элемента ‘feComposite’. |
| [getK3](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k3/) Соответствует атрибуту ‘k3’ данного элемента ‘feComposite’. |
| [getK4](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k4/) Соответствует атрибуту ‘k4’ данного элемента ‘feComposite’. |
...
| [getOperator](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/operator/) Соответствует атрибуту ‘operator’ данного элемента ‘feComposite’. Принимает одну из констант SVG_FECOMPOSITE_OPERATOR_* , определённых в этом интерфейсе. |
[getOuterHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/result/) Соответствует атрибуту ‘result’ данного элемента ‘filter’. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/width/) Соответствует атрибуту ‘width’ данного элемента ‘filter’. |
| [X](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/x/) { get; } | Соответствует атрибуту ‘x’ указанного элемента ‘filter’. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/y/) { get; } | Соответствует атрибуту ‘y’ указанного элемента ‘filter’. |
...
| Имя | Описание |
| --- | --- |
| const [SVG_FECOMPOSITE_OPERATOR_ARITHMETIC](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_arithmetic/) | Соответствует значению 'arithmetic'. |
| const [SVG_FECOMPOSITE_OPERATOR_ATOP](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_atop/) | Соответствует значению 'atop'. |
| const [SVG_FECOMPOSITE_OPERATOR_IN](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_in/) | Соответствует значению 'in'. |
| const [SVG_FECOMPOSITE_OPERATOR_OUT](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_out/) | Соответствует значению 'out'. |
| const [SVG_FECOMPOSITE_OPERATOR_OVER](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_over/) | Соответствует значению 'over'. |
| const [SVG_FECOMPOSITE_OPERATOR_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_unknown/) | Тип не является одним из предопределённых типов. Недопустимо пытаться определить новое значение этого типа или пытаться переключить существующее значение на этот тип. |
| const [SVG_FECOMPOSITE_OPERATOR_XOR](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_xor/) | Соответствует значению 'xor'. |
