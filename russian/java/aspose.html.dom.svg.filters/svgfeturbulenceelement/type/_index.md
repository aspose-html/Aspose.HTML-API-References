...
description: "SVGFETurbulenceElement свойство. Соответствует атрибуту type в данном элементе feTurbulence. Принимает одну из констант SVG_TURBULENCE_TYPE_ определённых в этом интерфейсе"
type: docs

url: /ru/java/com.aspose.html.dom.svg.filters/svgfeturbulenceelement/type/
---
