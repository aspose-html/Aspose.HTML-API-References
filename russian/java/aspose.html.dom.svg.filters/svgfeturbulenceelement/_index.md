---
title: "SVGFETurbulenceElement класс"
second_title: "Справочник API Aspose.HTML для Java"
description: "com.aspose.html.dom.svg.filters.SVGFETurbulenceElement класс. Интерфейс SVGFETurbulenceElement соответствует элементу feTurbulence."
type: docs

url: /ru/java/com.aspose.html.dom.svg.filters/svgfeturbulenceelement/
---
## SVGFETurbulenceElement class

Интерфейс SVGFETurbulenceElement соответствует элементу ‘feTurbulence’.
...
| [getBaseFrequencyX](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/basefrequencyx/) Соответствует атрибуту ‘baseFrequency’ заданного элемента ‘feTurbulence’. Содержит X‑компонент атрибута ‘baseFrequency’. |
| [getBaseFrequencyY](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/basefrequencyy/) Соответствует атрибуту ‘baseFrequency’ заданного элемента ‘feTurbulence’. Содержит Y‑компонент (возможно вычисленного автоматически) атрибута ‘baseFrequency’. |
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/height/) Соответствует атрибуту ‘height’ заданного элемента ‘filter’. |
[getId]
...
| [getNumOctaves](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/numoctaves/) Соответствует атрибуту ‘numOctaves’ заданного элемента ‘feTurbulence’. |
[getOuterHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/result/) Соответствует атрибуту ‘result’ заданного элемента ‘filter’. |
| [getSeed](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/seed/) Соответствует атрибуту ‘seed’ заданного элемента ‘feTurbulence’. |
...
| [getStitchTiles](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/stitchtiles/) Соответствует атрибуту ‘stitchTiles’ заданного элемента ‘feTurbulence’. Принимает одну из констант SVG_STITCHTYPE_* , определённых в этом интерфейсе. |
...
| [getType](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/type/) Соответствует атрибуту ‘type’ заданного элемента ‘feTurbulence’. Принимает одну из констант SVG_TURBULENCE_TYPE_* , определённых в этом интерфейсе. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/width/) Соответствует атрибуту ‘width’ заданного элемента ‘filter’. |
| [X](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/x/) { get; } | Соответствует атрибуту ‘x’ указанного элемента ‘filter’. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/y/) { get; } | Соответствует атрибуту ‘y’ указанного элемента ‘filter’. |
...
| Имя | Описание |
| --- | --- |
| const [SVG_STITCHTYPE_NOSTITCH](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_stitchtype_nostitch/) | Соответствует значению 'noStitch'. |
| const [SVG_STITCHTYPE_STITCH](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_stitchtype_stitch/) | Соответствует значению 'stitch'. |
| const [SVG_STITCHTYPE_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_stitchtype_unknown/) | Тип не является одним из предопределённых типов. Недопустимо пытаться определить новое значение этого типа или пытаться переключить существующее значение на этот тип. |
| const [SVG_TURBULENCE_TYPE_FRACTALNOISE](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_turbulence_type_fractalnoise/) | Соответствует значению 'fractalNoise'. |
| const [SVG_TURBULENCE_TYPE_TURBULENCE](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_turbulence_type_turbulence/) | Соответствует значению 'turbulence'. |
| const [SVG_TURBULENCE_TYPE_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_turbulence_type_unknown/) | Тип не является одним из предопределённых типов. Недопустимо пытаться определить новое значение этого типа или пытаться переключить существующее значение на этот тип. |
