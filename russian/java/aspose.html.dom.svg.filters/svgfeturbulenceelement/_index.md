...
| [getBaseFrequencyX](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/basefrequencyx/) Соответствует атрибуту ‘baseFrequency’ в данном элементе ‘feTurbulence’. Содержит X‑компонент атрибута ‘baseFrequency’. |
| [getBaseFrequencyY](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/basefrequencyy/) Соответствует атрибуту ‘baseFrequency’ в данном элементе ‘feTurbulence’. Содержит Y‑компонент (возможно вычисляемый автоматически) атрибута ‘baseFrequency’. |
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/height/) Соответствует атрибуту ‘height’ в данном элементе ‘filter’. |
[getId]
...
| [getNumOctaves](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/numoctaves/) Соответствует атрибуту ‘numOctaves’ в данном элементе ‘feTurbulence’. |
[getOuterHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/result/) Соответствует атрибуту ‘result’ в данном элементе ‘filter’. |
| [getSeed](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/seed/) Соответствует атрибуту ‘seed’ в данном элементе ‘feTurbulence’. |
...
| [getStitchTiles](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/stitchtiles/) Соответствует атрибуту ‘stitchTiles’ в данном элементе ‘feTurbulence’. Принимает одну из констант SVG_STITCHTYPE_*, определённых в этом интерфейсе. |
...
| [getType](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/type/) Соответствует атрибуту ‘type’ в данном элементе ‘feTurbulence’. Принимает одну из констант SVG_TURBULENCE_TYPE_*, определённых в этом интерфейсе. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/width/) Соответствует атрибуту ‘width’ в данном элементе ‘filter’. |
| [X](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/x/) { get; } | Соответствует атрибуту ‘x’ данного элемента ‘filter’. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/y/) { get; } | Соответствует атрибуту ‘y’ данного элемента ‘filter’. |
