...
| [getBias](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/bias/) Соответствует атрибуту ‘bias’ данного элемента ‘feConvolveMatrix’. |
...
| [getDivisor](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/divisor/) Соответствует атрибуту ‘divisor’ данного элемента ‘feConvolveMatrix’. |
| [getEdgeMode](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/edgemode/) Соответствует атрибуту ‘edgeMode’ данного элемента ‘feConvolveMatrix’. |
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/height/) Соответствует атрибуту ‘height’ данного элемента ‘filter’. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/in1/) Соответствует атрибуту ‘in’ данного элемента ‘feConvolveMatrix’. |
[getInnerHTML]
...
| [getKernelMatrix](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelmatrix/) Соответствует атрибуту ‘kernelMatrix’ данного элемента ‘feConvolveMatrix’. |
| [getKernelUnitLengthX](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelunitlengthx/) Соответствует атрибуту ‘kernelUnitLength’ данного элемента ‘feConvolveMatrix’. |
| [getKernelUnitLengthY](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelunitlengthy/) Соответствует атрибуту ‘kernelUnitLength’ данного элемента ‘feConvolveMatrix’. |
...
| [getOrderX](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/orderx/) Соответствует атрибуту ‘order’ данного элемента ‘feConvolveMatrix’. |
| [getOrderY](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/ordery/) Соответствует атрибуту ‘order’ данного элемента ‘feConvolveMatrix’. |
[getOuterHTML]
...
| [getPreserveAlpha](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/preservealpha/) Соответствует атрибуту ‘preserveAlpha’ данного элемента ‘feConvolveMatrix’. |
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/result/) Соответствует атрибуту ‘result’ данного элемента ‘filter’. |
...
| [getTargetX](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/targetx/) Соответствует атрибуту ‘targetX’ данного элемента ‘feConvolveMatrix’. |
| [getTargetY](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/targety/) Соответствует атрибуту ‘targetY’ данного элемента ‘feConvolveMatrix’. |
...
| [X](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/x/) { get; } | Соответствует атрибуту ‘x’ данного элемента ‘filter’. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/y/) { get; } | Соответствует атрибуту ‘y’ данного элемента ‘filter’. |
