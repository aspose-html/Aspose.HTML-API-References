...
description: "com.aspose.html.rendering.RenderingOptions класс. Представляет параметры рендеринга."
type: docs

url: /ru/java/com.aspose.html.rendering/renderingoptions/
---
...
| Имя | Описание |
| --- | --- |
| [RenderingOptions](renderingoptions/)() | Инициализирует новый экземпляр класса `RenderingOptions`. |
...
| [getCss](../../com.aspose.html.rendering/renderingoptions/css/) Получает объект [`CssOptions`](../cssoptions/), который используется для настройки обработки свойств CSS. |
