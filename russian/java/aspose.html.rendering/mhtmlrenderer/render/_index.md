...
description: "Метод MhtmlRenderer. Рендерит несколько MHTML‑документов в указанное IDevice. Рендеринг будет выполнен, когда не будет никаких сетевых операций по загрузке ресурсов, активных таймеров, анимационных задач или когда истечёт указанный тайм‑аут."
type: docs
...
Рендерит несколько MHTML‑документов в указанное [`IDevice`](../../idevice/). Рендеринг будет выполнен, когда не будет никаких сетевых операций по загрузке ресурсов, активных таймеров, анимационных задач или когда истечёт указанный тайм‑аут.
...
Рендерит MHTML документ в указанный [`IDevice`](../../idevice/).
...
Рендерит MHTML документ в указанный [`IDevice`](../../idevice/). Рендеринг будет выполнен, когда не будет никаких сетевых операций по загрузке ресурсов, активных таймеров, анимационных задач или когда истечёт указанный тайм‑аут.
...
Рендерит несколько MHTML документов в указанный [`IDevice`](../../idevice/).
