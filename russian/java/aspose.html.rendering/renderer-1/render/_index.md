...
description: "Метод Renderer. Определяет метод для рендеринга TDocument в указанное IDevice."
type: docs
...
Определяет метод для рендеринга !:TDocument в указанное [`IDevice`](../../idevice/).
...
Определяет метод для рендеринга !:TDocument в указанное [`IDevice`](../../idevice/). Рендеринг будет выполнен, когда не будет никаких сетевых операций по загрузке ресурсов, активных таймеров, анимационных задач или когда истечёт указанный тайм‑аут.
