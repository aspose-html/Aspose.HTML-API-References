...
description: "com.aspose.html.rendering.PageSetup class. Представляет объект настройки страницы, используемый для конфигурации вывода набора страниц"
type: docs
...
| [getLeftPage](../../com.aspose.html.rendering/pagesetup/leftpage/) Получает конфигурацию нечётных страниц. |
...
| [getRightPage](../../com.aspose.html.rendering/pagesetup/rightpage/) Получает конфигурацию чётных страниц. |
