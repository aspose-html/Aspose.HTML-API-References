...
description: "Метод Converter. Преобразует SVG‑источник, представленный SVGDocument. Результатом являются выходные данные, сформированные реализацией интерфейса ICreateStreamProvider."
type: docs
...
Преобразуйте SVG‑источник, представленный [`SVGDocument`](../../../com.aspose.html.dom.svg/svgdocument/). Результатом являются выходные данные, сформированные реализацией интерфейса [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/).
...
Преобразовать SVG в XPS

Класс Converter предлагает несколько специфических для SVG конвертаций в XPS. Чтобы преобразовать SVG в XPS, следует выполнить один из простых сценариев, состоящий из нескольких шагов:

Источник конвертации. Обнаружьте существующий локальный SVG‑файл или удалённый [`Url`](../../../com.aspose.html/url/) в качестве источника конвертации. Вы также можете задать [`SVGDocument`](../../../com.aspose.html.dom.svg/svgdocument/) как источник конвертации или даже использовать встроенное SVG‑содержимое, представленное строковым источником. Результат конвертации. Укажите путь к выходному файлу результата или используйте известную либо пользовательскую реализацию интерфейса [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) в качестве буфера выходных данных. Создайте новый объект [`XpsSaveOptions`](../../../com.aspose.html.saving/xpssaveoptions/) с конкретными или настройками по умолчанию. Вы также можете добавить [`configuration`](../../../com.aspose.html/configuration/) в качестве параметра опции. Используйте метод `ConvertSVG()` класса Converter, чтобы сохранить SVG как результат XPS с тремя или более параметрами в зависимости от сценария пользователя. Онлайн‑конвертер SVG

Aspose.HTML предлагает бесплатный онлайн‑[SVG to XPS Converter](https://products.aspose.app/svg/en/conversion/svg-to-xps), который преобразует SVG в XPS с высоким качеством, быстро и просто. Просто загрузите, конвертируйте ваши файлы и получите результаты за несколько секунд!
...
Преобразуйте SVG‑источник, представленный [`URL`](../../../com.aspose.html/url/). Результатом являются выходные данные, сформированные реализацией интерфейса [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/).
...
Преобразуйте SVG‑источник, указанный полным путем к файлу, в XPS. Результатом являются выходные данные, сформированные реализацией интерфейса [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/).
...
Обратитесь к [article](https://docs.aspose.com/html/net/converting-between-formats/svg-to-docx/) , где вы найдете информацию о том, как преобразовать SVG в [DOCX](https://docs.fileformat.com/word-processing/docx/) с помощью методов ConvertSVG() класса Converter, а также как применить параметры [`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/) и [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/).
...
Источник преобразования. Обнаружьте существующий локальный файл SVG или удалённый [`Url`](../../../com.aspose.html/url/) в качестве источника преобразования. Вы также можете указать [`SVGDocument`](../../../com.aspose.html.dom.svg/svgdocument/) в качестве источника преобразования или даже использовать встроенное SVG‑содержимое, представленное строковым источником. Результат преобразования. Укажите путь к выходному файлу результата или используйте известную либо пользовательскую реализацию интерфейса [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) в качестве буфера выходных данных. Создайте новый объект [`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/) с конкретными или настройками по умолчанию. Также можно добавить [`configuration`](../../../com.aspose.html/configuration/) в качестве параметра опций. Используйте метод ConvertSVG() класса Converter, чтобы сохранить SVG как результат DOCX с тремя или более параметрами в зависимости от сценария пользователя. Онлайн‑конвертер SVG
...
Преобразовать источник SVG, представленный [`URL`](../../../com.aspose.html/url/), в DOCX. Результатом является файл docx, сформированный по пути выходного файла.
...
Преобразовать SVG‑источник, представленный полным путем к файлу, в DOCX. Результат — DOCX‑файл, сформированный путём к файлу вывода.
...
Преобразовать источник SVG, представленный полным путем к файлу, в DOCX. Результатом являются выходные данные, сформированные реализацией интерфейса [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/).
...
Источник преобразования. Обнаружьте существующий локальный файл SVG или удалённый [`Url`](../../../com.aspose.html/url/) в качестве источника преобразования. Вы также можете указать [`SVGDocument`](../../../com.aspose.html.dom.svg/svgdocument/) в качестве источника преобразования или даже использовать встроенное SVG‑содержимое, представленное строковым источником. Результат преобразования. Укажите путь к выходному файлу результата или используйте известную либо пользовательскую реализацию интерфейса [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) в качестве буфера выходных данных. Создайте новый объект [`PdfSaveOptions`](../../../com.aspose.html.saving/pdfsaveoptions/) с конкретными или настройками по умолчанию. Также можно добавить [`configuration`](../../../com.aspose.html/configuration/) в качестве параметра опций. Используйте метод ConvertSVG() класса Converter, чтобы сохранить SVG как результат PDF с тремя или более параметрами в зависимости от сценария пользователя. Онлайн‑конвертер SVG
...
Преобразовать источник SVG, представленный [`URL`](../../../com.aspose.html/url/), в PDF. Результатом является файл pdf, сформированный по пути выходного файла.
...
Преобразовать SVG‑источник, представленный полным путем к файлу, в PDF. Результат — PDF‑файл, сформированный путём к файлу вывода.
...
Преобразовать источник SVG, представленный полным путем к файлу, в PDF. Результатом являются выходные данные, сформированные реализацией интерфейса [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/).
...
Преобразуйте источник SVG, представленный объектом [`SVGDocument`](../../../com.aspose.html.dom.svg/svgdocument/). Результатом будет файл изображения, сформированный по пути выходного файла.
...
Источник преобразования. Обнаружьте существующий локальный файл SVG или удалённый [`Url`](../../../com.aspose.html/url/) в качестве источника преобразования. Вы также можете задать [`SVGDocument`](../../../com.aspose.html.dom.svg/svgdocument/) как источник преобразования или даже использовать встроенное SVG‑содержимое, представленное строкой‑источником. Результат преобразования. Укажите путь выходного файла или используйте известную или пользовательскую реализацию интерфейса [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) в качестве буфера выходных данных. Создайте новый объект [`ImageSaveOptions`](../../../com.aspose.html.saving/imagesaveoptions/) с конкретными или стандартными настройками. Обратите внимание, что формат изображения по умолчанию — PNG. Вы также можете добавить [`configuration`](../../../com.aspose.html/configuration/) в качестве параметра опции. Используйте метод ConvertSVG() класса Converter, чтобы сохранить SVG как результат изображения с тремя и более параметрами в зависимости от сценария пользователя. Онлайн‑конвертер SVG

Aspose.HTML предлагает бесплатный онлайн [конвертер SVG в JPG](https://products.aspose.app/svg/en/conversion/svg-to-jpg), который преобразует SVG в JPG с высоким качеством, быстро и просто. Просто загрузите файлы, выполните конвертацию и получите результаты через несколько секунд!

Другие популярные конвертеры изображений для разных форматов можно найти здесь: [конвертер SVG в PNG](https://products.aspose.app/svg/en/conversion/svg-to-png), [конвертер SVG в BMP](https://products.aspose.app/svg/en/conversion/svg-to-bmp), [конвертер SVG в GIF](https://products.aspose.app/svg/en/conversion/svg-to-gif) и [конвертер SVG в TIFF](https://products.aspose.app/svg/en/conversion/svg-to-tiff).
...
Преобразуйте источник SVG, представленный [`URL`](../../../com.aspose.html/url/). Результатом будет файл изображения, сформированный по пути выходного файла.
...
Преобразовать SVG‑источник, представленный полным путем к файлу, в изображение. Результат — файл изображения, сформированный путём к файлу вывода.
...
Преобразуйте источник SVG, представленный полным путем к файлу, в изображение. Результатом будут выходные данные, сформированные реализацией интерфейса [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/).
...
Преобразуйте источник SVG, представленный встроенным содержимым, в изображение. Результатом будут выходные данные, сформированные реализацией интерфейса [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/).
...
Преобразуйте источник SVG, представленный [`SVGDocument`](../../../com.aspose.html.dom.svg/svgdocument/). Результатом будет файл XPS, сформированный по пути выходного файла.
...
Преобразуйте источник SVG, представленный [`URL`](../../../com.aspose.html/url/). Результатом будет файл XPS, сформированный по пути выходного файла.
...
Преобразовать SVG‑источник, представленный полным путем к файлу, в XPS. Результат — XPS‑файл, сформированный путём к файлу вывода.
