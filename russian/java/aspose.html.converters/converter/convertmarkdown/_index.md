...
description: "Метод Converter. Преобразовать источник MD markdown, представленный входным потоком, в html. Результатом является HTMLDocument, который можно сохранить по пути вывода файла."
type: docs
...
Преобразовать источник MD (markdown), представленный входным потоком, в html. Результатом является [`HTMLDocument`](../../../com.aspose.html/htmldocument/), который можно сохранить по пути вывода файла.
...
| --- | --- | --- |
| поток | Поток | Входной поток данных конвертации MD (Markdown). |
...
Источник конвертации. Обнаружить существующий локальный файл MD или создать входной поток данных в качестве источника конвертации. Результат конвертации. Вы можете получить непосредственно [`HTMLDocument`](../../../com.aspose.html/htmldocument/) или задать путь вывода файла результата в зависимости от сигнатуры метода. Используйте метод ConvertMarkdown() класса Converter, чтобы сохранить MD как html‑результат. Вы также можете добавить [`configuration`](../../../com.aspose.html/configuration/) в качестве параметра опции. Онлайн‑конвертер MD
...
Преобразовать источник MD (markdown), представленный полным путем к файлу, в html. Результатом является [`HTMLDocument`](../../../com.aspose.html/htmldocument/), который можно сохранить по пути вывода файла.
