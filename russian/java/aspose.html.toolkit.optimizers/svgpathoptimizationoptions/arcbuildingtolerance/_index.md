...
description: "Свойство SVGPathOptimizationOptions. Получает или задает значение параметра, используемого в качестве процента радиуса при замене сегментов Безье на дуговые сегменты. По умолчанию равно 0.5"
type: docs

url: /ru/java/com.aspose.html.toolkit.optimizers/svgpathoptimizationoptions/arcbuildingtolerance/
---
