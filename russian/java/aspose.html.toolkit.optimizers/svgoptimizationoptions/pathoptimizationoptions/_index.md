...
description: "Свойство SVGOptimizationOptions. Получает или задает параметр SVGPathOptimizationOptions. Если этот параметр равен null, оптимизация элементов пути не будет выполнена."
type: docs

url: /ru/java/com.aspose.html.toolkit.optimizers/svgoptimizationoptions/pathoptimizationoptions/
---
