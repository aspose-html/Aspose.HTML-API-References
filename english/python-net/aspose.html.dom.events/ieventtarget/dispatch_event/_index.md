...
type: docs
weight: 30
url: /python-net/aspose.html.dom.events/ieventtarget/dispatch_event/
is_root: false
---
...
| :- | :- | :- |
| event | [`Event`](/html/python-net/aspose.html.dom.events/event) | Specifies the event type, behavior, and contextual information to be used in processing the event. |
### Remarks
