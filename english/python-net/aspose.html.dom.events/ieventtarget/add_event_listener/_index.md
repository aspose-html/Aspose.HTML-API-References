...
type: docs
weight: 20
url: /python-net/aspose.html.dom.events/ieventtarget/add_event_listener/
is_root: false
---
...
| listener | [`IEventListener`](/html/python-net/aspose.html.dom.events/ieventlistener) | Takes an interface implemented by the user which contains the methods to be called when the event occurs. |
### Remarks
...
[`IEventTarget.remove_event_listener`](/html/python-net/aspose.html.dom.events/ieventtarget/remove_event_listener)
method.
