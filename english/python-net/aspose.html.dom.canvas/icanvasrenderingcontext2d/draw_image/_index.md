...
type: docs
weight: 150
url: /aspose.html.dom.canvas/icanvasrenderingcontext2d/draw_image/
is_root: false
---

## draw_image {#aspose.html.HTMLImageElement-float-float}
...
| :- | :- | :- |
| image | [`HTMLImageElement`](/html/python-net/aspose.html/htmlimageelement) | The HTMLImageElement to draw into the context. |
...
## draw_image {#aspose.html.HTMLCanvasElement-float-float}
...
| Parameter | Type | Description |
| :- | :- | :- |
| image | [`HTMLCanvasElement`](/html/python-net/aspose.html/htmlcanvaselement) | The HTMLCanvasElement to draw into the context. |
| dx | float | The X coordinate in the destination canvas at which to place the top-left corner of the source image. |
| dy | float | The Y coordinate in the destination canvas at which to place the top-left corner of the source image. |


## draw_image {#aspose.html.HTMLImageElement-float-float-float-float}
...
## draw_image {#aspose.html.HTMLCanvasElement-float-float-float-float}
...
## draw_image {#aspose.html.HTMLImageElement-float-float-float-float-float-float-float-float}
...
## draw_image {#aspose.html.HTMLCanvasElement-float-float-float-float-float-float-float-float}
