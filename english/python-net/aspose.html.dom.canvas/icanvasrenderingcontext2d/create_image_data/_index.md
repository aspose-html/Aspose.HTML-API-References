---
title: create_image_data method
second_title: Aspose.HTML for Python via .NET API References
description: 
type: docs
weight: 100
url: /python-net/aspose.html.dom.canvas/icanvasrenderingcontext2d/create_image_data/
is_root: false
---

## create_image_data {#aspose.html.dom.canvas.IImageData}
...
| :- | :- | :- |
| imagedata | [`IImageData`](/html/python-net/aspose.html.dom.canvas/iimagedata) | An existing ImageData object from which to copy the width and height. The image itself is not copied. |


## create_image_data {#float-float}
