...
The [`IUserAgentService.language`](/html/python-net/aspose.html.services/iuseragentservice#language) specifies the primary language for the element's contents and for any of the element's attributes that contain text. 
