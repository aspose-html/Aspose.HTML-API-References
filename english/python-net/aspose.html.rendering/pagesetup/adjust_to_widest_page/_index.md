---
title: adjust_to_widest_page property
...
take place only if widest page in document is wider than page size determined in [`PageSetup`](/html/python-net/aspose.html.rendering/pagesetup). Adjusted
