...
| [scale_limit](/html/python-net/aspose.html.rendering/pagesetup/scale_limit) | A value between 0 and 1 specifies the limit to which the document content is scaled relative to the original size.<br/>The default value is 0.<br/>The default value in Chrome is approximately 0.7 (i.e. the scaled content size cannot be less than 70% of the original size). |
