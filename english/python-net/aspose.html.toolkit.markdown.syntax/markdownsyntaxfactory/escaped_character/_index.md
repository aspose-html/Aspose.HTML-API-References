---
title: escaped_character method
second_title: Aspose.HTML for Python via .NET API References
description: 
type: docs
weight: 120
url: /python-net/aspose.html.toolkit.markdown.syntax/markdownsyntaxfactory/escaped_character/
is_root: false
---

## escaped_character {#char}

Creates [`TextSyntaxNode`](/html/python-net/aspose.html.toolkit.markdown.syntax/textsyntaxnode).
...
## escaped_character {#aspose.html.toolkit.markdown.syntax.text.SourceText-aspose.html.toolkit.markdown.syntax.text.TextSpan}
