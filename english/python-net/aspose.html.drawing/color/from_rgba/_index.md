---
title: from_rgba method
second_title: Aspose.HTML for Python via .NET API References
description: 
type: docs
weight: 230
url: /python-net/aspose.html.drawing/color/from_rgba/
is_root: false
---

## from_rgba {#byte-byte-byte-byte}
...
A new instance of the [`Color`](/html/python-net/aspose.html.drawing/color) class
...
## from_rgba {#float-float-float-float}
