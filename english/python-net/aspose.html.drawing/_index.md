...
type: docs
weight: 10
url: /python-net/aspose.html.drawing/
is_root: false
---

The **Aspose.Html.Drawing**  namespace contains objects and
...
| Class | Description |
| :- | :- |
| [`Angle`](/html/python-net/aspose.html.drawing/angle) | The angle data type |
| [`Color`](/html/python-net/aspose.html.drawing/color) | The Color class lets you specify colors as <br/>Red-Green-Blue (RGB) values,<br/>Hue-Saturation-Luminosity (HSL) values,<br/>Hue-Saturation-Value (HSV) values,<br/>Hue-Whiteness-Blackness (HWB) values,<br/>lightness-A-B (LAB) values,<br/>Luminance-Chroma-Hue (LCH) values,<br/>Cyan-Magenta-Yellow-Key (CMYK) values,<br/>Natural colors (NCOL) values,<br/>or with a color name. <br/>An Alpha channel is also available to indicate transparency. |
| [`Dimension`](/html/python-net/aspose.html.drawing/dimension) | Provides the base class for dimensions. <br/>The general term 'dimension' refers to a number with a unit attached to it, and are denoted by [`UnitType`](/html/python-net/aspose.html.drawing/unittype). |
...
| [`Numeric`](/html/python-net/aspose.html.drawing/numeric) | Provides the base class for numeric types. |
| [`Page`](/html/python-net/aspose.html.drawing/page) | Represents a page object is used for configuration output page.<br/>The lacuna value for page size is A4(210x297mm) |
| [`Resolution`](/html/python-net/aspose.html.drawing/resolution) | Represents a resolution unit. |
| [`Size`](/html/python-net/aspose.html.drawing/size) | Stores a values which specify a Height and Width. |
| [`Time`](/html/python-net/aspose.html.drawing/time) | Represents a time unit. |
| [`Unit`](/html/python-net/aspose.html.drawing/unit) | Provides the base class for units of measurement. |
| [`UnitType`](/html/python-net/aspose.html.drawing/unittype) | Specifies the unit of measurement. |
