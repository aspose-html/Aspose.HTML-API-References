...
| [offset_width](/html/python-net/aspose.html/htmlformelement/offset_width) | Gets the layout width of the element in pixels. |
| [offset_height](/html/python-net/aspose.html/htmlformelement/offset_height) | Gets the layout height of the element in pixels. |
...
| [matches](/html/python-net/aspose.html/htmlformelement/matches/#str) | Determines whether the element matches the specified CSS selector. |
| [closest](/html/python-net/aspose.html/htmlformelement/closest/#str) | Returns the closest ancestor element (or the element itself) that matches the specified CSS selector. |
