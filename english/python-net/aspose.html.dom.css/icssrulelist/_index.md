---
title: ICSSRuleList class
second_title: Aspose.HTML for Python via .NET API References
description: 
type: docs
weight: 160
url: /python-net/aspose.html.dom.css/icssrulelist/
is_root: false
---
...
The ICSSRuleList type exposes the following members:

### Properties
| Property | Description |
| :- | :- |
| [length](/html/python-net/aspose.html.dom.css/icssrulelist/length) | The number of CSSRules in the list. The range of valid child rule indices is 0 to length-1 inclusive. |
