...
type: docs
weight: 30
url: /python-net/aspose.html.dom.svg/svgcomponenttransferfunctionelement/append_child/
is_root: false
---
...
| :- | :- | :- |
| node | [`Node`](/html/python-net/aspose.html.dom/node) | The node to append to the given parent node (commonly an element). |
### Exceptions
