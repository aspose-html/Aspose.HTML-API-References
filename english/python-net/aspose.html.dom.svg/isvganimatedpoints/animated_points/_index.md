---
title: animated_points property
second_title: Aspose.HTML for Python via .NET API References
description: 
type: docs
weight: 30
url: /python-net/aspose.html.dom.svg/isvganimatedpoints/animated_points/
is_root: false
---

## animated_points property
...
```python
@property
def animated_points(self):
    ...
```

### See Also
* module [`aspose.html.dom.svg`](../../)
* class [`ISVGAnimatedPoints`](/html/python-net/aspose.html.dom.svg/isvganimatedpoints)
