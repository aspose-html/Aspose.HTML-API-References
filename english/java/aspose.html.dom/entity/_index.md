...
type: docs
weight: 710
url: /net/com.aspose.html.dom/entity/
---
## Entity class
...
| [getInputEncoding](../../com.aspose.html.dom/entity/inputencoding/) An attribute specifying the encoding used for this entity at the time of parsing, when it is an external parsed entity. This is null if it an entity from the internal subset or if it is not known. |
