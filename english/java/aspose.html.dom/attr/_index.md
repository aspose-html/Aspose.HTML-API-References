...
| [getIsId](../../com.aspose.html.dom/attr/isid/) Returns whether this attribute is known to be of type ID (i.e. to contain an identifier for its owner element) or not. |
...
| [getLocalName](../../com.aspose.html.dom/attr/localname/) Returns the local part of the qualified name of this node. For nodes of any type other than ELEMENT_NODE and ATTRIBUTE_NODE and nodes created with a DOM Level 1 method, such as Document.createElement(), this is always null. |
| [getName](../../com.aspose.html.dom/attr/name/) Returns the name of this attribute. |
| [getNamespaceURI](../../com.aspose.html.dom/attr/packageuri/) The package URI of this node, or null if it is unspecified. |
...
| [getNodeName](../../com.aspose.html.dom/attr/nodename/) The name of this node, depending on its type. |
| [getNodeType](../../com.aspose.html.dom/attr/nodetype/) A code representing the type of the underlying object. |
[getNodeValue]
...
| [getOwnerElement](../../com.aspose.html.dom/attr/ownerelement/) The Element node this attribute is attached to or null if this attribute is not in use. |
...
| [getPrefix](../../com.aspose.html.dom/attr/prefix/) The package prefix of this node, or null if it is unspecified. When it is defined to be null, setting it has no effect |
...
| [getSchemaTypeInfo](../../com.aspose.html.dom/attr/schematypeinfo/) The type information associated with this attribute. |
| [getSpecified](../../com.aspose.html.dom/attr/specified/) True if this attribute was explicitly given a value in the instance document, false otherwise. |
[getTextContent]
