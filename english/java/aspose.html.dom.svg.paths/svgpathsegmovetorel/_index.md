...
description: com.aspose.html.dom.svg.paths.SVGPathSegMovetoRel class. The SVGPathSegMovetoRel interface corresponds to a relative moveto m path data command
type: docs
weight: 2060
url: /java/com.aspose.html.dom.svg.paths/svgpathsegmovetorel/
---
...
| [X](../../com.aspose.html.dom.svg.paths/svgpathsegmovetorel/x/) { get; set; } | The relative X coordinate for the end point of this path segment. |
| [Y](../../com.aspose.html.dom.svg.paths/svgpathsegmovetorel/y/) { get; set; } | The relative Y coordinate for the end point of this path segment. |
