...
description: com.aspose.html.dom.svg.paths.SVGPathSegCurvetoQuadraticSmoothRel class. The SVGPathSegCurvetoQuadraticSmoothRel interface corresponds to a relative smooth cubic curveto t path data command
type: docs
weight: 1810
url: /java/com.aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticsmoothrel/
---
...
| [X](../../com.aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticsmoothrel/x/) { get; set; } | The relative X coordinate for the end point of this path segment. |
| [Y](../../com.aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticsmoothrel/y/) { get; set; } | The relative Y coordinate for the end point of this path segment. |
