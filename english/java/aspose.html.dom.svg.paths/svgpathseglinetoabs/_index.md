...
description: com.aspose.html.dom.svg.paths.SVGPathSegLinetoAbs class. The SVGPathSegLinetoAbs interface corresponds to an absolute lineto L path data command
type: docs

url: /java/com.aspose.html.dom.svg.paths/svgpathseglinetoabs/
---
...
| [X](../../com.aspose.html.dom.svg.paths/svgpathseglinetoabs/x/) { get; set; } | The absolute X coordinate for the end point of this path segment. |
| [Y](../../com.aspose.html.dom.svg.paths/svgpathseglinetoabs/y/) { get; set; } | The absolute Y coordinate for the end point of this path segment. |
