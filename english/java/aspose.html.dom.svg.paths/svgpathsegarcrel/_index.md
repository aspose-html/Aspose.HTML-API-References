...
| [X](../../com.aspose.html.dom.svg.paths/svgpathsegarcrel/x/) { get; set; } | The relative X coordinate for the end point of this path segment. |
| [Y](../../com.aspose.html.dom.svg.paths/svgpathsegarcrel/y/) { get; set; } | The relative Y coordinate for the end point of this path segment. |
