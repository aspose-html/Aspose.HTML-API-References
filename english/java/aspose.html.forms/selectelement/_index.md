...
| [id](../../com.aspose.html.forms/selectelement/id/) { get; set; } | Represents the Id attribute of the input element. |
[getMultiple]
...
| [name](../../com.aspose.html.forms/selectelement/name/) { get; set; } | Represent the name attribute of the input element. |
...
| [value](../../com.aspose.html.forms/selectelement/value/) { get; set; } | On getting, must return the value of the first option element in the list of options in tree order that has its selectedness set to true, if any. |
