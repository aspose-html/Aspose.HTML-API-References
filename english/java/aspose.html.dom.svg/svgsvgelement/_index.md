...
| [getCurrentTranslate](../../com.aspose.html.dom.svg/svgsvgelement/currenttranslate/) On an outermost svg element, the corresponding translation factor that takes into account user "magnification". When accessed on an ‘svg’ element that is not an outermost svg element, it is undefined what behavior this attribute has. |
...
| [getHeight](../../com.aspose.html.dom.svg/svgsvgelement/height/) Corresponds to attribute ‘height’ on the given ‘svg’ element. |
[getId]
...
| [getPreserveAspectRatio](../../com.aspose.html.dom.svg/svgsvgelement/preserveaspectratio/) Corresponds to attribute ‘preserveAspectRatio’ on the given element. |
...
| [getWidth](../../com.aspose.html.dom.svg/svgsvgelement/width/) Corresponds to attribute ‘width’ on the given ‘svg’ element. |
| [X](../../com.aspose.html.dom.svg/svgsvgelement/x/) { get; } | Corresponds to attribute ‘x’ on the given ‘svg’ element. |
| [Y](../../com.aspose.html.dom.svg/svgsvgelement/y/) { get; } | Corresponds to attribute ‘y’ on the given ‘svg’ element. |
[getZoomAndPan]
...
| [createEvent](../../com.aspose.html.dom.svg/svgsvgelement/createevent/)(String) | Creates an [`Event`](../../com.aspose.html.dom.events/event/) of a type supported by the implementation. |
| [createSVGAngle](../../com.aspose.html.dom.svg/svgsvgelement/createsvgangle/)() | Creates an SVGAngle object outside of any document trees. The object is initialized to the value 0 degrees (unitless). |
| [createSVGLength](../../com.aspose.html.dom.svg/svgsvgelement/createsvglength/)() | Creates an SVGLength object outside of any document trees. The object is initialized to the value of 0 user units. |
| [createSVGMatrix](../../com.aspose.html.dom.svg/svgsvgelement/createsvgmatrix/)() | Creates an SVGMatrix object outside of any document trees. The object is initialized to the identity matrix. |
| [createSVGNumber](../../com.aspose.html.dom.svg/svgsvgelement/createsvgnumber/)() | Creates an SVGNumber object outside of any document trees. The object is initialized to a value of zero. |
| [createSVGPoint](../../com.aspose.html.dom.svg/svgsvgelement/createsvgpoint/)() | Creates an SVGPoint object outside of any document trees. The object is initialized to the point (0,0) in the user coordinate system. |
| [createSVGRect](../../com.aspose.html.dom.svg/svgsvgelement/createsvgrect/)() | Creates an SVGRect object outside of any document trees. The object is initialized such that all values are set to 0 user units. |
| [createSVGTransform](../../com.aspose.html.dom.svg/svgsvgelement/createsvgtransform/)() | Creates an SVGTransform object outside of any document trees. The object is initialized to an identity matrix transform (SVG_TRANSFORM_MATRIX). |
