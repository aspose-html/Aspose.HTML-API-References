...
type: docs
weight: 1400
url: /net/com.aspose.html.dom.svg.filters/svgfecompositeelement/
---
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/height/) Corresponds to attribute ‘height’ on the given ‘filter’ element. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/in1/) Corresponds to attribute ‘in’ on the given ‘feComposite’ element. |
| [getIn2](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/in2/) Corresponds to attribute ‘in2’ on the given ‘feComposite’ element. |
[getInnerHTML]
...
| [getK1](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k1/) Corresponds to attribute ‘k1’ on the given ‘feComposite’ element. |
| [getK2](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k2/) Corresponds to attribute ‘k2’ on the given ‘feComposite’ element. |
| [getK3](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k3/) Corresponds to attribute ‘k3’ on the given ‘feComposite’ element. |
| [getK4](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k4/) Corresponds to attribute ‘k4’ on the given ‘feComposite’ element. |
...
| [getOperator](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/operator/) Corresponds to attribute ‘operator’ on the given ‘feComposite’ element. Takes one of the SVG_FECOMPOSITE_OPERATOR_* constants defined on this interface. |
[getOuterHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/result/) Corresponds to attribute ‘result’ on the given ‘filter’ element. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/width/) Corresponds to attribute ‘width’ on the given ‘filter’ element. |
...
| Name | Description |
| --- | --- |
| const [SVG_FECOMPOSITE_OPERATOR_ARITHMETIC](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_arithmetic/) | Corresponds to value 'arithmetic'. |
| const [SVG_FECOMPOSITE_OPERATOR_ATOP](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_atop/) | Corresponds to value 'atop'. |
| const [SVG_FECOMPOSITE_OPERATOR_IN](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_in/) | Corresponds to value 'in'. |
| const [SVG_FECOMPOSITE_OPERATOR_OUT](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_out/) | Corresponds to value 'out'. |
| const [SVG_FECOMPOSITE_OPERATOR_OVER](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_over/) | Corresponds to value 'over'. |
| const [SVG_FECOMPOSITE_OPERATOR_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_unknown/) | The type is not one of predefined types. It is invalid to attempt to define a new value of this type or to attempt to switch an existing value to this type. |
| const [SVG_FECOMPOSITE_OPERATOR_XOR](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_xor/) | Corresponds to value 'xor'. |
