...
type: docs
weight: 1370
url: /net/com.aspose.html.dom.svg.filters/svgfeblendelement/
---
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfeblendelement/height/) Corresponds to attribute ‘height’ on the given ‘filter’ element. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfeblendelement/in1/) Corresponds to attribute ‘in’ on the given ‘feBlend’ element. |
| [getIn2](../../com.aspose.html.dom.svg.filters/svgfeblendelement/in2/) Corresponds to attribute ‘in2’ on the given ‘feBlend’ element. |
[getInnerHTML]
...
| [getMode](../../com.aspose.html.dom.svg.filters/svgfeblendelement/mode/) Corresponds to attribute ‘mode’ on the given ‘feBlend’ element. Takes one of the SVG_FEBLEND_MODE_* constants defined on this interface. |
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfeblendelement/result/) Corresponds to attribute ‘result’ on the given ‘filter’ element. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfeblendelement/width/) Corresponds to attribute ‘width’ on the given ‘filter’ element. |
...
| Name | Description |
| --- | --- |
| const [SVG_FEBLEND_MODE_COLOR](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_color/) | Corresponds to value 'color'. |
| const [SVG_FEBLEND_MODE_COLOR_BURN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_color_burn/) | Corresponds to value 'color_burn'. |
| const [SVG_FEBLEND_MODE_COLOR_DODGE](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_color_dodge/) | Corresponds to value 'color_dodge'. |
| const [SVG_FEBLEND_MODE_DARKEN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_darken/) | Corresponds to value 'darken'. |
| const [SVG_FEBLEND_MODE_DIFFERENCE](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_difference/) | Corresponds to value 'difference'. |
| const [SVG_FEBLEND_MODE_EXCLUSION](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_exclusion/) | Corresponds to value 'exclusion'. |
| const [SVG_FEBLEND_MODE_HARD_LIGHT](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_hard_light/) | Corresponds to value 'hard_light'. |
| const [SVG_FEBLEND_MODE_HUE](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_hue/) | Corresponds to value 'hue'. |
| const [SVG_FEBLEND_MODE_LIGHTEN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_lighten/) | Corresponds to value 'lighten'. |
| const [SVG_FEBLEND_MODE_LUMINOSITY](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_luminosity/) | Corresponds to value 'luminosity'. |
| const [SVG_FEBLEND_MODE_MULTIPLY](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_multiply/) | Corresponds to value 'multiply'. |
| const [SVG_FEBLEND_MODE_NORMAL](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_normal/) | Corresponds to value 'normal'. |
| const [SVG_FEBLEND_MODE_OVERLAY](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_overlay/) | Corresponds to value 'overlay'. |
| const [SVG_FEBLEND_MODE_SATURATION](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_saturation/) | Corresponds to value 'saturation'. |
| const [SVG_FEBLEND_MODE_SCREEN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_screen/) | Corresponds to value 'screen'. |
| const [SVG_FEBLEND_MODE_SOFT_LIGHT](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_soft_light/) | Corresponds to value 'soft_light'. |
| const [SVG_FEBLEND_MODE_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_unknown/) | The type is not one of predefined types. It is invalid to attempt to define a new value of this type or to attempt to switch an existing value to this type. |
