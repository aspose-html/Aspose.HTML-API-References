...
type: docs
weight: 1380
url: /net/com.aspose.html.dom.svg.filters/svgfecolormatrixelement/
---
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/height/) Corresponds to attribute ‘height’ on the given ‘filter’ element. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/in1/) Corresponds to attribute ‘in’ on the given ‘feColorMatrix’ element. |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/result/) Corresponds to attribute ‘result’ on the given ‘filter’ element. |
...
| [getType](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/type/) Corresponds to attribute ‘type’ on the given ‘feColorMatrix’ element. Takes one of the SVG_FECOLORMATRIX_TYPE_* constants defined on this interface. |
| [getValues](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/values/) Corresponds to attribute ‘values’ on the given ‘feColorMatrix’ element. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/width/) Corresponds to attribute ‘width’ on the given ‘filter’ element. |
...
| Name | Description |
| --- | --- |
| const [SVG_FECOLORMATRIX_TYPE_HUEROTATE](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_huerotate/) | Corresponds to value 'hueRotate'. |
| const [SVG_FECOLORMATRIX_TYPE_LUMINANCETOALPHA](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_luminancetoalpha/) | Corresponds to value 'luminanceToAlpha'. |
| const [SVG_FECOLORMATRIX_TYPE_MATRIX](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_matrix/) | Corresponds to value 'matrix'. |
| const [SVG_FECOLORMATRIX_TYPE_SATURATE](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_saturate/) | Corresponds to value 'saturate'. |
| const [SVG_FECOLORMATRIX_TYPE_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_unknown/) | The type is not one of predefined types. It is invalid to attempt to define a new value of this type or to attempt to switch an existing value to this type. |
