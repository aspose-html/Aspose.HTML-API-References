...
type: docs
weight: 1410
url: /net/com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/
---
...
| [getBias](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/bias/) Corresponds to attribute ‘bias’ on the given ‘feConvolveMatrix’ element. |
...
| [getDivisor](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/divisor/) Corresponds to attribute ‘divisor’ on the given ‘feConvolveMatrix’ element. |
| [getEdgeMode](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/edgemode/) Corresponds to attribute ‘edgeMode’ on the given ‘feConvolveMatrix’ element. |
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/height/) Corresponds to attribute ‘height’ on the given ‘filter’ element. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/in1/) Corresponds to attribute ‘in’ on the given ‘feConvolveMatrix’ element. |
[getInnerHTML]
...
| [getKernelMatrix](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelmatrix/) Corresponds to attribute ‘kernelMatrix’ on the given ‘feConvolveMatrix’ element. |
| [getKernelUnitLengthX](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelunitlengthx/) Corresponds to attribute ‘kernelUnitLength’ on the given ‘feConvolveMatrix’ element. |
| [getKernelUnitLengthY](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelunitlengthy/) Corresponds to attribute ‘kernelUnitLength’ on the given ‘feConvolveMatrix’ element. |
...
| [getOrderX](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/orderx/) Corresponds to attribute ‘order’ on the given ‘feConvolveMatrix’ element. |
| [getOrderY](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/ordery/) Corresponds to attribute ‘order’ on the given ‘feConvolveMatrix’ element. |
[getOuterHTML]
...
| [getPreserveAlpha](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/preservealpha/) Corresponds to attribute ‘preserveAlpha’ on the given ‘feConvolveMatrix’ element. |
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/result/) Corresponds to attribute ‘result’ on the given ‘filter’ element. |
...
| [getTargetX](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/targetx/) Corresponds to attribute ‘targetX’ on the given ‘feConvolveMatrix’ element. |
| [getTargetY](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/targety/) Corresponds to attribute ‘targetY’ on the given ‘feConvolveMatrix’ element. |
[getTextContent]
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/width/) Corresponds to attribute ‘width’ on the given ‘filter’ element. |
...
| Name | Description |
| --- | --- |
| const [SVG_EDGEMODE_DUPLICATE](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_duplicate/) | Corresponds to value 'duplicate'. |
| const [SVG_EDGEMODE_NONE](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_none/) | Corresponds to value 'none'. |
| const [SVG_EDGEMODE_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_unknown/) | The type is not one of predefined types. It is invalid to attempt to define a new value of this type or to attempt to switch an existing value to this type. |
| const [SVG_EDGEMODE_WRAP](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_wrap/) | Corresponds to value 'wrap'. |
