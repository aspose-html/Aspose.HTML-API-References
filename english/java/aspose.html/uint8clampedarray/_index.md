...
| [item](../../com.aspose.html/uint8clampedarray/item/) { get; set; } | Gets or sets the Byte at the specified index. |
...
| Name | Description |
| --- | --- |
| static readonly [BYTES_PER_ELEMENT](../../com.aspose.html/uint8clampedarray/bytes_per_element/) | The property represents the size in bytes of each element in an typed array. |
