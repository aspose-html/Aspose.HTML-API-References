...
| [getCaption](../../com.aspose.html/htmltableelement/caption/) Returns the table's `CAPTION`, or void if none exists. @version DOM Level 2 |
[getCellPadding]
...
| [getRows](../../com.aspose.html/htmltableelement/rows/) Returns the table's `TFOOT`, or `null` if none exists. |
[getRules]
...
| [getTBodies](../../com.aspose.html/htmltableelement/tbodies/) Returns a collection of the table bodies (including implicit ones). |
...
| [getTFoot](../../com.aspose.html/htmltableelement/tfoot/) Returns the table's `THEAD`, or `null` if none exists. |
| [getTHead](../../com.aspose.html/htmltableelement/thead/) Returns the table's `CAPTION`, or void if none exists. |
[getTitle]
...
| [createCaption](../../com.aspose.html/htmltableelement/createcaption/)() | Create a new table caption object or return an existing one. |
| [createTFoot](../../com.aspose.html/htmltableelement/createtfoot/)() | Create a table footer row or return an existing one. |
| [createTHead](../../com.aspose.html/htmltableelement/createthead/)() | Create a table header row or return an existing one. |
| [deleteCaption](../../com.aspose.html/htmltableelement/deletecaption/)() | Delete the table caption, if one exists. |
| [deleteRow](../../com.aspose.html/htmltableelement/deleterow/)(int) | Delete a table row. |
| [deleteTFoot](../../com.aspose.html/htmltableelement/deletetfoot/)() | Delete the footer from the table, if one exists. |
| [deleteTHead](../../com.aspose.html/htmltableelement/deletethead/)() | Delete the header from the table, if one exists. |
