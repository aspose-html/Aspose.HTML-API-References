...
| [item](../../com.aspose.html/float32array/item/) { get; set; } | Gets or sets the Single at the specified index. |
...
| Name | Description |
| --- | --- |
| static readonly [BYTES_PER_ELEMENT](../../com.aspose.html/float32array/bytes_per_element/) | The property represents the size in bytes of each element in an typed array. |
