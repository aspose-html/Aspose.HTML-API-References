...
type: docs
weight: 3590
url: /net/com.aspose.html/htmltablerowelement/
---
...
| [getCells](../../com.aspose.html/htmltablerowelement/cells/) The collection of cells in this row. @version DOM Level 2 |
[getCh]
...
| [getRowIndex](../../com.aspose.html/htmltablerowelement/rowindex/) This is in logical order and not in document order. The `rowIndex` does take into account sections (`THEAD`, `TFOOT`, or `TBODY`) within the table, placing `THEAD` rows first in the index, followed by `TBODY` rows, followed by `TFOOT`rows. @version DOM Level 2 |
| [getSchemaTypeInfo](../../com.aspose.html.dom/element/schematypeinfo/) The type information associated with this element. |
| [getSectionRowIndex](../../com.aspose.html/htmltablerowelement/sectionrowindex/) The index of this row, relative to the current section (`THEAD`, `TFOOT`, or `TBODY`), starting from 0. @version DOM Level 2 |
...
| [deleteCell](../../com.aspose.html/htmltablerowelement/deletecell/)(int) | Delete a cell from the current row. |
...
| [insertCell](../../com.aspose.html/htmltablerowelement/insertcell/)(int) | Insert an empty `TD` cell into this row. If `index` is -1 or equal to the number of cells, the new cell is appended. |
