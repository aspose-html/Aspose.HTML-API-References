...
type: docs
weight: 3600
url: /net/com.aspose.html/htmltablesectionelement/
---
...
| [getRows](../../com.aspose.html/htmltablesectionelement/rows/) The collection of rows in this table section. |
...
| [deleteRow](../../com.aspose.html/htmltablesectionelement/deleterow/)(int) | Delete a row from this section. |
...
| [insertRow](../../com.aspose.html/htmltablesectionelement/insertrow/)(int) | Insert a row into this section. The new row is inserted immediately before the current `index`th row in this section. If `index` is -1 or equal to the number of rows in this section, the new row is appended. |
