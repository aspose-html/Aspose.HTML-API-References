...
description: com.aspose.html.HTMLLegendElement class. Provides a caption for a FIELDSET grouping. See the LEGEND element definition in HTML 4.01
type: docs

url: /java/com.aspose.html/htmllegendelement/
---
...
| [getForm](../../com.aspose.html/htmllegendelement/form/) Returns the `FORM` element containing this control. Returns `null` if this control is not within the context of a form. |
[getId]
