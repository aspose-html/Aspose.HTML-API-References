...
| [getForm](../../com.aspose.html/htmloptionelement/form/) Returns the `FORM` element containing this control. Returns `null` if this control is not within the context of a form. |
[getId]
[setId] The element's identifier. See the id attribute definition in HTML 4.01. |
| [getIndex](../../com.aspose.html/htmloptionelement/index/) The index of this `OPTION` in its parent `SELECT`, starting from 0. @version DOM Level 2 |
[getInnerHTML]
...
| [getText](../../com.aspose.html/htmloptionelement/text/) The text contained within the option element. |
