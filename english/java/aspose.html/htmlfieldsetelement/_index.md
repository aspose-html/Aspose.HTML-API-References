...
| [getForm](../../com.aspose.html/htmlfieldsetelement/form/) Returns the `FORM` element containing this control. Returns `null` if this control is not within the context of a form. |
[getId]
