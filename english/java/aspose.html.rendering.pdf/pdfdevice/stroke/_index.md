...
description: PdfDevice method. Strokes a line along the current path. The stroked line follows each straight or curved segment in the path centered on the segment with sides parallel to it. Each of the paths subpaths is treated separately. This method terminates current path
type: docs
weight: 200
url: /java/com.aspose.html.rendering.pdf/pdfdevice/stroke/
---
