...
| Name | Description |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/tablesyntaxnode/accept/)(MarkdownSyntaxVisitor) | Defines the interface for accept of the visitor. |
| [appendChild](../../com.aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/appendchild/)(MarkdownSyntaxNode) | Append child node. |
| [appendRow](../../com.aspose.html.toolkit.markdown.syntax/tablesyntaxnode/appendrow/)(TableRowSyntaxNode) | Defines the interface for append row. |
| [childNodes](../../com.aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/childnodes/)() | Get the child nodes collection. |
| [getAlignment](../../com.aspose.html.toolkit.markdown.syntax/tablesyntaxnode/getalignment/)() | Defines the interface for get aligment. |
| [getBodyRows](../../com.aspose.html.toolkit.markdown.syntax/tablesyntaxnode/getbodyrows/)() | Defines the interface for get body rows. |
| [getHeader](../../com.aspose.html.toolkit.markdown.syntax/tablesyntaxnode/getheader/)() | Defines the interface for get table header. |
