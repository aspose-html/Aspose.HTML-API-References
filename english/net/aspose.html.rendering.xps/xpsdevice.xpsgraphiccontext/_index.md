...
| Name | Description |
| --- | --- |
| override [Clone](../../aspose.html.rendering.xps/xpsdevice.xpsgraphiccontext/clone)() | Creates a new instance of a XpsGraphicContext class with the same property values as an existing instance. |
