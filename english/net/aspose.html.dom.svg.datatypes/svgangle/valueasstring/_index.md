...
type: docs
weight: 30
url: /net/aspose.html.dom.svg.datatypes/svgangle/valueasstring/
---
...
| exception | condition |
| --- | --- |
| [DOMException](../../../aspose.html.dom/domexception/) | Code [`SYNTAX_ERR`](../../../aspose.html.dom/domexception/syntax_err/)Raised if the assigned string cannot be parsed as a valid angle. |
