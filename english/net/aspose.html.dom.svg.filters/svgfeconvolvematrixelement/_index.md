...
description: Aspose.Html.Dom.Svg.Filters.SVGFEConvolveMatrixElement class. The SVGFEConvolveMatrixElement interface corresponds to the feConvolveMatrix element
type: docs
weight: 1570
...
| [Bias](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/bias/) { get; } | Corresponds to attribute ‘bias’ on the given ‘feConvolveMatrix’ element. |
...
| [EdgeMode](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/edgemode/) { get; } | Corresponds to attribute ‘edgeMode’ on the given ‘feConvolveMatrix’ element. |
...
| [Height](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/height/) { get; } | Corresponds to attribute ‘height’ on the given ‘filter’ element. |
...
| [In1](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/in1/) { get; } | Corresponds to attribute ‘in’ on the given ‘feConvolveMatrix’ element. |
...
| [KernelMatrix](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelmatrix/) { get; } | Corresponds to attribute ‘kernelMatrix’ on the given ‘feConvolveMatrix’ element. |
| [KernelUnitLengthX](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelunitlengthx/) { get; } | Corresponds to attribute ‘kernelUnitLength’ on the given ‘feConvolveMatrix’ element. |
| [KernelUnitLengthY](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelunitlengthy/) { get; } | Corresponds to attribute ‘kernelUnitLength’ on the given ‘feConvolveMatrix’ element. |
...
| [OrderX](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/orderx/) { get; } | Corresponds to attribute ‘order’ on the given ‘feConvolveMatrix’ element. |
| [OrderY](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/ordery/) { get; } | Corresponds to attribute ‘order’ on the given ‘feConvolveMatrix’ element. |
...
| [PreserveAlpha](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/preservealpha/) { get; } | Corresponds to attribute ‘preserveAlpha’ on the given ‘feConvolveMatrix’ element. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/result/) { get; } | Corresponds to attribute ‘result’ on the given ‘filter’ element. |
...
| [TargetX](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/targetx/) { get; } | Corresponds to attribute ‘targetX’ on the given ‘feConvolveMatrix’ element. |
| [TargetY](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/targety/) { get; } | Corresponds to attribute ‘targetY’ on the given ‘feConvolveMatrix’ element. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/width/) { get; } | Corresponds to attribute ‘width’ on the given ‘filter’ element. |
...
| Name | Description |
| --- | --- |
| const [SVG_EDGEMODE_DUPLICATE](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_duplicate/) | Corresponds to value 'duplicate'. |
| const [SVG_EDGEMODE_NONE](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_none/) | Corresponds to value 'none'. |
| const [SVG_EDGEMODE_UNKNOWN](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_unknown/) | The type is not one of predefined types. It is invalid to attempt to define a new value of this type or to attempt to switch an existing value to this type. |
| const [SVG_EDGEMODE_WRAP](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_wrap/) | Corresponds to value 'wrap'. |
