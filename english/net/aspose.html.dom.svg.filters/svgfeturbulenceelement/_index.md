...
description: Aspose.Html.Dom.Svg.Filters.SVGFETurbulenceElement class. The SVGFETurbulenceElement interface corresponds to the feTurbulence element
type: docs
weight: 1770
url: /net/aspose.html.dom.svg.filters/svgfeturbulenceelement/
---
...
| [BaseFrequencyX](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/basefrequencyx/) { get; } | Corresponds to attribute ‘baseFrequency’ on the given ‘feTurbulence’ element. Contains the X component of the ‘baseFrequency’ attribute. |
| [BaseFrequencyY](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/basefrequencyy/) { get; } | Corresponds to attribute ‘baseFrequency’ on the given ‘feTurbulence’ element. Contains the Y component of the (possibly computed automatically) ‘baseFrequency’ attribute. |
...
| [Height](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/height/) { get; } | Corresponds to attribute ‘height’ on the given ‘filter’ element. |
...
| [NumOctaves](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/numoctaves/) { get; } | Corresponds to attribute ‘numOctaves’ on the given ‘feTurbulence’ element. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/result/) { get; } | Corresponds to attribute ‘result’ on the given ‘filter’ element. |
| [Seed](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/seed/) { get; } | Corresponds to attribute ‘seed’ on the given ‘feTurbulence’ element. |
| [ShadowRoot](../../aspose.html.dom/element/shadowroot/) { get; } | Returns shadowRoot stored on this element or null if it's closed. |
| [StitchTiles](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/stitchtiles/) { get; } | Corresponds to attribute ‘stitchTiles’ on the given ‘feTurbulence’ element. Takes one of the SVG_STITCHTYPE_* constants defined on this interface. |
...
| [Type](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/type/) { get; } | Corresponds to attribute ‘type’ on the given ‘feTurbulence’ element. Takes one of the SVG_TURBULENCE_TYPE_* constants defined on this interface. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/width/) { get; } | Corresponds to attribute ‘width’ on the given ‘filter’ element. |
| [X](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/x/) { get; } | Corresponds to attribute ‘x’ on the given ‘filter’ element. |
| [Y](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/y/) { get; } | Corresponds to attribute ‘y’ on the given ‘filter’ element. |
...
| Name | Description |
| --- | --- |
| const [SVG_STITCHTYPE_NOSTITCH](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_stitchtype_nostitch/) | Corresponds to value 'noStitch'. |
| const [SVG_STITCHTYPE_STITCH](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_stitchtype_stitch/) | Corresponds to value 'stitch'. |
| const [SVG_STITCHTYPE_UNKNOWN](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_stitchtype_unknown/) | The type is not one of predefined types. It is invalid to attempt to define a new value of this type or to attempt to switch an existing value to this type. |
| const [SVG_TURBULENCE_TYPE_FRACTALNOISE](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_turbulence_type_fractalnoise/) | Corresponds to value 'fractalNoise'. |
| const [SVG_TURBULENCE_TYPE_TURBULENCE](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_turbulence_type_turbulence/) | Corresponds to value 'turbulence'. |
| const [SVG_TURBULENCE_TYPE_UNKNOWN](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_turbulence_type_unknown/) | The type is not one of predefined types. It is invalid to attempt to define a new value of this type or to attempt to switch an existing value to this type. |
