...
description: Aspose.Html.Toolkit.Markdown.Syntax.Text.SourceText class. Base class implements the SourceText
type: docs
weight: 5870
...
| Name | Description |
| --- | --- |
| abstract [Encoding](../../aspose.html.toolkit.markdown.syntax.text/sourcetext/encoding/) { get; } | Get encoding. |
| abstract [Item](../../aspose.html.toolkit.markdown.syntax.text/sourcetext/item/) { get; } | Gets the value at the given index. |
| abstract [Length](../../aspose.html.toolkit.markdown.syntax.text/sourcetext/length/) { get; } | Get the length. |
