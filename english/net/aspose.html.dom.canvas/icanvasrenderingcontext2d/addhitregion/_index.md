...
description: ICanvasRenderingContext2D AddHitRegion method. Adds a hit region to the canvas. This allows you to make hit detection easier lets you route events to DOM elements and makes it possible for users to explore the canvas without seeing it
type: docs
weight: 110
