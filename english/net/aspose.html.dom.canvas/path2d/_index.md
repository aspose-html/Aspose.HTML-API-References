...
| Name | Description |
| --- | --- |
| [AddPath](../../aspose.html.dom.canvas/path2d/addpath)(Path2D) | Adds to the path the path given by the argument. |
| [AddPath](../../aspose.html.dom.canvas/path2d/addpath)(Path2D, SVGMatrix) | Adds to the path the path given by the argument. |
| [Arc](../../aspose.html.dom.canvas/path2d/arc)(double, double, double, double, double) | Adds an arc to the path which is centered at (x, y) position with radius r starting at startAngle and ending at endAngle going in the given direction by anticlockwise (defaulting to clockwise). |
| [Arc](../../aspose.html.dom.canvas/path2d/arc)(double, double, double, double, double, bool) | Adds an arc to the path which is centered at (x, y) position with radius r starting at startAngle and ending at endAngle going in the given direction by anticlockwise (defaulting to clockwise). |
