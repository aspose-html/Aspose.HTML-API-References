...
description: Aspose.Html.HTMLOListElement class. Ordered list. See the OL element definition in HTML 4.01
type: docs
weight: 3660
...
| [Compact](../../aspose.html/htmlolistelement/compact/) { get; set; } | Reduce spacing between list items. See the compact attribute definition in HTML 4.01. This attribute is deprecated in HTML 4.01. |
...
| [Start](../../aspose.html/htmlolistelement/start/) { get; set; } | Starting sequence number. See the start attribute definition in HTML 4.01. This attribute is deprecated in HTML 4.01. |
...
| [Type](../../aspose.html/htmlolistelement/type/) { get; set; } | Numbering style. See the type attribute definition in HTML 4.01. This attribute is deprecated in HTML 4.01. |
