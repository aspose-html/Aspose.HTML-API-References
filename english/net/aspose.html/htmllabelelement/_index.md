...
description: Aspose.Html.HTMLLabelElement class. Form field label text. See the LABEL element definition in HTML 4.01
type: docs
weight: 3580
...
| Name | Description |
| --- | --- |
| [AccessKey](../../aspose.html/htmllabelelement/accesskey/) { get; set; } | A single character access key to give access to the form control. See the accesskey attribute definition in HTML 4.01. |
...
| [For](../../aspose.html/htmllabelelement/for/) { get; set; } | This attribute links this label with another form control by `id` attribute. See the for attribute definition in HTML 4.01. |
| [Form](../../aspose.html/htmllabelelement/form/) { get; } | Returns the `FORM` element containing this control. Returns `null` if this control is not within the context of a form. |
