...
| [Charset](../../aspose.html/htmlscriptelement/charset/) { get; set; } | The character encoding of the linked resource. See the charset attribute definition in HTML 4.01. |
...
| [Defer](../../aspose.html/htmlscriptelement/defer/) { get; set; } | Indicates that the user agent can defer processing of the script. See the defer attribute definition in HTML 4.01. |
...
| [Event](../../aspose.html/htmlscriptelement/event/) { get; set; } | Reserved for future use. |
...
| [Src](../../aspose.html/htmlscriptelement/src/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt)] designating an external script. See the src attribute definition in HTML 4.01. |
...
| [Text](../../aspose.html/htmlscriptelement/text/) { get; set; } | The script content of the element. |
...
| [Type](../../aspose.html/htmlscriptelement/type/) { get; set; } | The content type of the script language. See the type attribute definition in HTML 4.01. |
