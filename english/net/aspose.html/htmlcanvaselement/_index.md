...
description: Aspose.Html.HTMLCanvasElement class. The HTMLCanvasElement interface provides properties and methods for manipulating the layout and presentation of canvas elements. The HTMLCanvasElement interface also inherits the properties and methods of the HTMLElement interface
type: docs
weight: 3370
...
| [Height](../../aspose.html/htmlcanvaselement/height/) { get; set; } | Is a positive integer reflecting the height HTML attribute of the canvas element interpreted in CSS pixels. When the attribute is not specified, or if it is set to an invalid value, like a negative, the default value of 150 is used. |
...
| [GetContext](../../aspose.html/htmlcanvaselement/getcontext/)(*string*) | Returns a drawing context on the canvas, or null if the context ID is not supported. A drawing context lets you draw on the canvas. |
