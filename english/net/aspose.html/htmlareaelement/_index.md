...
| Name | Description |
| --- | --- |
| [AccessKey](../../aspose.html/htmlareaelement/accesskey/) { get; set; } | A single character access key to give access to the form control. See the accesskey attribute definition in HTML 4.01. |
| [Alt](../../aspose.html/htmlareaelement/alt/) { get; set; } | Alternate text for user agents not rendering the normal content of this element. See the alt attribute definition in HTML 4.01. |
...
| [Coords](../../aspose.html/htmlareaelement/coords/) { get; set; } | Comma-separated list of lengths, defining an active region geometry. See also `shape` for the shape of the region. See the coords attribute definition in HTML 4.01. |
...
| [Href](../../aspose.html/htmlareaelement/href/) { get; set; } | The URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt)] of the linked resource. See the href attribute definition in HTML 4.01. |
...
| [NoHref](../../aspose.html/htmlareaelement/nohref/) { get; set; } | Specifies that this area is inactive, i.e., has no associated action. See the nohref attribute definition in HTML 4.01. |
...
| [TabIndex](../../aspose.html/htmlareaelement/tabindex/) { get; set; } | Index that represents the element's position in the tabbing order. See the tabindex attribute definition in HTML 4.01. |
| [TagName](../../aspose.html.dom/element/tagname/) { get; } | The name of the element. |
| [Target](../../aspose.html/htmlareaelement/target/) { get; set; } | Frame to render the resource in. See the target attribute definition in HTML 4.01. |
