...
description: Aspose.Html.HTMLParamElement class. Parameters fed to the OBJECT element. See the PARAM element definition in HTML 4.01
type: docs
weight: 3710
...
| [Name](../../aspose.html/htmlparamelement/name/) { get; set; } | The name of a run-time parameter. See the name attribute definition in HTML 4.01. |
...
| [Type](../../aspose.html/htmlparamelement/type/) { get; set; } | Content type for the `value` attribute when `valuetype` has the value "ref". See the type attribute definition in HTML 4.01. |
