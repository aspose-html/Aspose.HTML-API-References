...
| [Caption](../../aspose.html/htmltableelement/caption/) { get; } | Returns the table's `CAPTION`, or void if none exists. @version DOM Level 2 |
| [CellPadding](../../aspose.html/htmltableelement/cellpadding/) { get; set; } | Specifies the horizontal and vertical space between cell content and cell borders. See the cellpadding attribute definition in HTML 4.01. |
| [CellSpacing](../../aspose.html/htmltableelement/cellspacing/) { get; set; } | Specifies the horizontal and vertical separation between cells. See the cellspacing attribute definition in HTML 4.01. |
...
| [Frame](../../aspose.html/htmltableelement/frame/) { get; set; } | Specifies which external table borders to render. See the frame attribute definition in HTML 4.01. |
...
| [TBodies](../../aspose.html/htmltableelement/tbodies/) { get; } | Returns a collection of the table bodies (including implicit ones). |
...
| [TFoot](../../aspose.html/htmltableelement/tfoot/) { get; } | Returns the table's `THEAD`, or `null` if none exists. |
| [THead](../../aspose.html/htmltableelement/thead/) { get; } | Returns the table's `CAPTION`, or void if none exists. |
| [Title](../../aspose.html/htmlelement/title/) { get; set; } | The element's advisory title. See the title attribute definition in HTML 4.01. |
| [Width](../../aspose.html/htmltableelement/width/) { get; set; } | Specifies the desired table width. See the width attribute definition in HTML 4.01. |
...
| [CreateCaption](../../aspose.html/htmltableelement/createcaption/)() | Create a new table caption object or return an existing one. |
| [CreateTFoot](../../aspose.html/htmltableelement/createtfoot/)() | Create a table footer row or return an existing one. |
| [CreateTHead](../../aspose.html/htmltableelement/createthead/)() | Create a table header row or return an existing one. |
| [DeleteCaption](../../aspose.html/htmltableelement/deletecaption/)() | Delete the table caption, if one exists. |
| [DeleteRow](../../aspose.html/htmltableelement/deleterow/)(*int*) | Delete a table row. |
| [DeleteTFoot](../../aspose.html/htmltableelement/deletetfoot/)() | Delete the footer from the table, if one exists. |
| [DeleteTHead](../../aspose.html/htmltableelement/deletethead/)() | Delete the header from the table, if one exists. |
