...
| [Save](../../aspose.html/htmldocument/save/#save)(ResourceHandler) | Saves the document content and resources using the [`ResourceHandler`](../../aspose.html.saving.resourcehandlers/resourcehandler/). |
...
| [Save](../../aspose.html/htmldocument/save/#save_1)(ResourceHandler, HTMLSaveFormat) | Saves the document content and resources using the [`ResourceHandler`](../../aspose.html.saving.resourcehandlers/resourcehandler/). |
| [Save](../../aspose.html/htmldocument/save/#save_2)(ResourceHandler, HTMLSaveOptions) | Saves the document content and resources using the [`ResourceHandler`](../../aspose.html.saving.resourcehandlers/resourcehandler/). |
| [Save](../../aspose.html/htmldocument/save/#save_3)(ResourceHandler, MarkdownSaveOptions) | Saves the document content and resources using the [`ResourceHandler`](../../aspose.html.saving.resourcehandlers/resourcehandler/). |
| [Save](../../aspose.html/htmldocument/save/#save_4)(ResourceHandler, MHTMLSaveOptions) | Saves the document content and resources using the [`ResourceHandler`](../../aspose.html.saving.resourcehandlers/resourcehandler/). |
