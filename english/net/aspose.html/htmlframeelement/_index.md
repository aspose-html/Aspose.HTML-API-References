...
description: Aspose.Html.HTMLFrameElement class. Create a frame. See the FRAME element definition in HTML 4.01
type: docs
weight: 3470
...
| [ContentDocument](../../aspose.html/htmlframeelement/contentdocument/) { get; } | The document this frame contains, if there is any and it is available, or `null` otherwise. @since DOM Level 2 |
...
| [FrameBorder](../../aspose.html/htmlframeelement/frameborder/) { get; set; } | Request frame borders. See the frameborder attribute definition in HTML 4.01. |
...
| [LongDesc](../../aspose.html/htmlframeelement/longdesc/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt)] designating a long description of this image or frame. See the longdesc attribute definition in HTML 4.01. |
| [MarginHeight](../../aspose.html/htmlframeelement/marginheight/) { get; set; } | Frame margin height, in pixels. See the marginheight attribute definition in HTML 4.01. |
| [MarginWidth](../../aspose.html/htmlframeelement/marginwidth/) { get; set; } | Frame margin width, in pixels. See the marginwidth attribute definition in HTML 4.01. |
| [Name](../../aspose.html/htmlframeelement/name/) { get; set; } | The frame name (object of the `target` attribute). See the name attribute definition in HTML 4.01. |
...
| [NoResize](../../aspose.html/htmlframeelement/noresize/) { get; set; } | When true, forbid user from resizing frame. See the noresize attribute definition in HTML 4.01. |
...
| [Scrolling](../../aspose.html/htmlframeelement/scrolling/) { get; set; } | Specify whether or not the frame should have scrollbars. See the scrolling attribute definition in HTML 4.01. |
| [ShadowRoot](../../aspose.html.dom/element/shadowroot/) { get; } | Returns shadowRoot stored on this element or null if it's closed. |
| [Src](../../aspose.html/htmlframeelement/src/) { get; set; } | A URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt)] designating the initial frame contents. See the src attribute definition in HTML 4.01. |
