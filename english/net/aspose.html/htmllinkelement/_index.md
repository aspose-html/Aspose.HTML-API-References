...
description: Aspose.Html.HTMLLinkElement class. The LINK element specifies a link to an external resource and defines this documents relationship to that resource or vice versa. See the LINK element definition in HTML 4.01 see also the LinkStyle interface in the StyleSheet module DOM Level 2 Style Sheets and CSS
type: docs
weight: 3600
...
| [Charset](../../aspose.html/htmllinkelement/charset/) { get; set; } | The character encoding of the resource being linked to. See the charset attribute definition in HTML 4.01. |
...
| [Disabled](../../aspose.html/htmllinkelement/disabled/) { get; set; } | Enables/disables the link. This is currently only used for style sheet links, and may be used to activate or deactivate style sheets. |
...
| [Href](../../aspose.html/htmllinkelement/href/) { get; set; } | The URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt)] of the linked resource. See the href attribute definition in HTML 4.01. |
| [Hreflang](../../aspose.html/htmllinkelement/hreflang/) { get; set; } | Language code of the linked resource. See the hreflang attribute definition in HTML 4.01. |
...
| [Media](../../aspose.html/htmllinkelement/media/) { get; set; } | Designed for use with one or more target media. See the media attribute definition in HTML 4.01. |
...
| [Sheet](../../aspose.html/htmllinkelement/sheet/) { get; } | Gets the associated style sheet. |
...
| [Target](../../aspose.html/htmllinkelement/target/) { get; set; } | Frame to render the resource in. See the target attribute definition in HTML 4.01. |
...
| [Type](../../aspose.html/htmllinkelement/type/) { get; set; } | Advisory content type. See the type attribute definition in HTML 4.01. |
