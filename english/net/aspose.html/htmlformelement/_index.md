...
description: Aspose.Html.HTMLFormElement class. The FORM element encompasses behavior similar to a collection and an element. It provides direct access to the contained form controls as well as the attributes of the form element. See the FORM element definition in HTML 4.01
type: docs
weight: 3460
...
| Name | Description |
| --- | --- |
| [AcceptCharset](../../aspose.html/htmlformelement/acceptcharset/) { get; set; } | List of character sets supported by the server. See the accept-charset attribute definition in HTML 4.01. |
| [Action](../../aspose.html/htmlformelement/action/) { get; set; } | Server-side form handler. See the action attribute definition in HTML 4.01. |
...
| [Elements](../../aspose.html/htmlformelement/elements/) { get; } | Returns a collection of all form control elements in the form. |
| [Enctype](../../aspose.html/htmlformelement/enctype/) { get; set; } | The content type of the submitted form, generally "application/x-www-form-urlencoded". See the enctype attribute definition in HTML 4.01. The onsubmit even handler is not guaranteed to be triggered when invoking this method. The behavior is inconsistent for historical reasons and authors should not rely on a particular one. |
...
| [Length](../../aspose.html/htmlformelement/length/) { get; } | The number of form controls in the form. |
...
| [Method](../../aspose.html/htmlformelement/method/) { get; set; } | HTTP method [[IETF RFC 2616](http://www.ietf.org/rfc/rfc2616.txt)] used to submit form. See the method attribute definition in HTML 4.01. |
| [Name](../../aspose.html/htmlformelement/name/) { get; set; } | Names the form. |
...
| [Target](../../aspose.html/htmlformelement/target/) { get; set; } | Frame to render the resource in. See the target attribute definition in HTML 4.01. |
...
| [Reset](../../aspose.html/htmlformelement/reset/)() | Restores a form element's default values. It performs the same action as a reset button. |
...
| [Submit](../../aspose.html/htmlformelement/submit/)() | Submits the form. It performs the same action as a submit button. |
