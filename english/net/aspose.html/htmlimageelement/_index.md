...
description: Aspose.Html.HTMLImageElement class. Embedded image. See the IMG element definition in HTML 4.01
type: docs
weight: 3540
...
| Name | Description |
| --- | --- |
| [Align](../../aspose.html/htmlimageelement/align/) { get; set; } | Aligns this object (vertically or horizontally) with respect to its surrounding text. See the align attribute definition in HTML 4.01. This attribute is deprecated in HTML 4.01. |
| [Alt](../../aspose.html/htmlimageelement/alt/) { get; set; } | Alternate text for user agents not rendering the normal content of this element. See the alt attribute definition in HTML 4.01. |
...
| [Border](../../aspose.html/htmlimageelement/border/) { get; set; } | Width of border around image. See the border attribute definition in HTML 4.01. This attribute is deprecated in HTML 4.01. Note that the type of this attribute was `DOMString` in DOM Level 1 HTML [[DOM Level 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001)] . |
...
| [Height](../../aspose.html/htmlimageelement/height/) { get; set; } | Height of the image in pixels. See the height attribute definition in HTML 4.01. Note that the type of this attribute was `DOMString` in DOM Level 1 HTML [[DOM Level 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001)]. @version DOM Level 2 |
| [Hspace](../../aspose.html/htmlimageelement/hspace/) { get; set; } | Horizontal space to the left and right of this image in pixels. See the hspace attribute definition in HTML 4.01. This attribute is deprecated in HTML 4.01. Note that the type of this attribute was `DOMString` in DOM Level 1 HTML [[DOM Level 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001)]. @version DOM Level 2 |
...
| [IsMap](../../aspose.html/htmlimageelement/ismap/) { get; set; } | Use server-side image map. See the ismap attribute definition in HTML 4.01. |
...
| [LongDesc](../../aspose.html/htmlimageelement/longdesc/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt)] designating a long description of this image or frame. See the longdesc attribute definition in HTML 4.01. |
| [Name](../../aspose.html/htmlimageelement/name/) { get; set; } | The name of the element (for backwards compatibility). |
...
| [Src](../../aspose.html/htmlimageelement/src/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt)] designating the source of this image. See the src attribute definition in HTML 4.01. |
...
| [UseMap](../../aspose.html/htmlimageelement/usemap/) { get; set; } | Use client-side image map. See the usemap attribute definition in HTML 4.01. |
