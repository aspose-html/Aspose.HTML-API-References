...
description: Aspose.Html.HTMLOptionElement class. A selectable choice. See the OPTION element definition in HTML 4.01
type: docs
weight: 3690
...
| [Disabled](../../aspose.html/htmloptionelement/disabled/) { get; set; } | The control is unavailable in this context. See the disabled attribute definition in HTML 4.01. |
...
| [Form](../../aspose.html/htmloptionelement/form/) { get; } | Returns the `FORM` element containing this control. Returns `null` if this control is not within the context of a form. |
| [Id](../../aspose.html/htmlelement/id/) { get; set; } | The element's identifier. See the id attribute definition in HTML 4.01. |
| [Index](../../aspose.html/htmloptionelement/index/) { get; } | The index of this `OPTION` in its parent `SELECT`, starting from 0. @version DOM Level 2 |
...
| [Label](../../aspose.html/htmloptionelement/label/) { get; set; } | Option label for use in hierarchical menus. See the label attribute definition in HTML 4.01. |
...
| [Selected](../../aspose.html/htmloptionelement/selected/) { get; set; } | Represents the current state of the corresponding form control, in an interactive user agent. Changing this attribute changes the state of the form control, but does not change the value of the HTML selected attribute of the element. |
...
| [Text](../../aspose.html/htmloptionelement/text/) { get; } | The text contained within the option element. |
