...
description: Aspose.Html.HTMLIFrameElement class. Inline subwindows. See the IFRAME element definition in HTML 4.01
type: docs
weight: 3530
...
| Name | Description |
| --- | --- |
| [Align](../../aspose.html/htmliframeelement/align/) { get; set; } | Aligns this object (vertically or horizontally) with respect to its surrounding text. See the align attribute definition in HTML 4.01. This attribute is deprecated in HTML 4.01. |
...
| [FrameBorder](../../aspose.html/htmliframeelement/frameborder/) { get; set; } | Request frame borders. See the frameborder attribute definition in HTML 4.01. |
| [Height](../../aspose.html/htmliframeelement/height/) { get; set; } | Frame height. See the height attribute definition in HTML 4.01. |
...
| [LongDesc](../../aspose.html/htmliframeelement/longdesc/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt)] designating a long description of this image or frame. See the longdesc attribute definition in HTML 4.01. |
| [MarginHeight](../../aspose.html/htmliframeelement/marginheight/) { get; set; } | Frame margin height, in pixels. See the marginheight attribute definition in HTML 4.01. |
| [MarginWidth](../../aspose.html/htmliframeelement/marginwidth/) { get; set; } | Frame margin width, in pixels. See the marginwidth attribute definition in HTML 4.01. |
| [Name](../../aspose.html/htmliframeelement/name/) { get; set; } | The frame name (object of the `target` attribute). See the name attribute definition in HTML 4.01. |
...
| [Scrolling](../../aspose.html/htmliframeelement/scrolling/) { get; set; } | Specify whether or not the frame should have scrollbars. See the scrolling attribute definition in HTML 4.01. |
| [ShadowRoot](../../aspose.html.dom/element/shadowroot/) { get; } | Returns shadowRoot stored on this element or null if it's closed. |
| [Src](../../aspose.html/htmliframeelement/src/) { get; set; } | A URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt)] designating the initial frame contents. See the src attribute definition in HTML 4.01. |
...
| [Width](../../aspose.html/htmliframeelement/width/) { get; set; } | Frame width. See the width attribute definition in HTML 4.01. |
