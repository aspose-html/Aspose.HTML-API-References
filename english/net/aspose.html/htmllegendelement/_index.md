...
| Name | Description |
| --- | --- |
| [AccessKey](../../aspose.html/htmllegendelement/accesskey/) { get; set; } | A single character access key to give access to the form control. See the accesskey attribute definition in HTML 4.01. |
| [Align](../../aspose.html/htmllegendelement/align/) { get; set; } | Text alignment relative to `FIELDSET`. See the align attribute definition in HTML 4.01. This attribute is deprecated in HTML 4.01. |
...
| [Form](../../aspose.html/htmllegendelement/form/) { get; } | Returns the `FORM` element containing this control. Returns `null` if this control is not within the context of a form. |
