...
| Name | Description |
| --- | --- |
| [AccessKey](../../aspose.html/htmlbuttonelement/accesskey/) { get; set; } | A single character access key to give access to the form control. See the accesskey attribute definition in HTML 4.01. |
...
| [Disabled](../../aspose.html/htmlbuttonelement/disabled/) { get; set; } | The control is unavailable in this context. See the disabled attribute definition in HTML 4.01. |
...
| [Form](../../aspose.html/htmlbuttonelement/form/) { get; } | Returns the `FORM` element containing this control. Returns `null` if this control is not within the context of a form. |
...
| [Name](../../aspose.html/htmlbuttonelement/name/) { get; set; } | Form control or object name when submitted with a form. See the name attribute definition in HTML 4.01. |
...
| [TabIndex](../../aspose.html/htmlbuttonelement/tabindex/) { get; set; } | Index that represents the element's position in the tabbing order. See the tabindex attribute definition in HTML 4.01. |
