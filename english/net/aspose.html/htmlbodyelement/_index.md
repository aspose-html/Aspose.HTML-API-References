...
description: Aspose.Html.HTMLBodyElement class. The HTML document body. This element is always present in the DOM API even if the tags are not present in the source document. See the BODY element definition in HTML 4.01
type: docs
weight: 3350
...
| Name | Description |
| --- | --- |
| [ALink](../../aspose.html/htmlbodyelement/alink/) { get; set; } | Color of active links (after mouse-button down, but before mouse-button up). See the alink attribute definition in HTML 4.01. This attribute is deprecated in HTML 4.01. |
...
| [Background](../../aspose.html/htmlbodyelement/background/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt)] of the background texture tile image. See the background attribute definition in HTML 4.01. This attribute is deprecated in HTML 4.01. |
...
| [BgColor](../../aspose.html/htmlbodyelement/bgcolor/) { get; set; } | Document background color. See the bgcolor attribute definition in HTML 4.01. This attribute is deprecated in HTML 4.01. |
...
| [Link](../../aspose.html/htmlbodyelement/link/) { get; set; } | Color of links that are not active and unvisited. See the link attribute definition in HTML 4.01. This attribute is deprecated in HTML 4.01. |
...
| [Text](../../aspose.html/htmlbodyelement/text/) { get; set; } | Document text color. See the text attribute definition in HTML 4.01. This attribute is deprecated in HTML 4.01. |
...
| [VLink](../../aspose.html/htmlbodyelement/vlink/) { get; set; } | Color of links that have been visited by the user. See the vlink attribute definition in HTML 4.01. This attribute is deprecated in HTML 4.01. |
