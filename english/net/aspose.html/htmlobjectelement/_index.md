...
| Name | Description |
| --- | --- |
| [Align](../../aspose.html/htmlobjectelement/align/) { get; set; } | Aligns this object (vertically or horizontally) with respect to its surrounding text. See the align attribute definition in HTML 4.01. This attribute is deprecated in HTML 4.01. |
| [Archive](../../aspose.html/htmlobjectelement/archive/) { get; set; } | Space-separated list of archives. See the archive attribute definition in HTML 4.01. |
...
| [Border](../../aspose.html/htmlobjectelement/border/) { get; set; } | Width of border around the object. See the border attribute definition in HTML 4.01. This attribute is deprecated in HTML 4.01. |
...
| [CodeType](../../aspose.html/htmlobjectelement/codetype/) { get; set; } | Content type for data downloaded via `classid` attribute. See the codetype attribute definition in HTML 4.01. |
| [Data](../../aspose.html/htmlobjectelement/data/) { get; set; } | A URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt)] specifying the location of the object's data. See the data attribute definition in HTML 4.01. |
| [Declare](../../aspose.html/htmlobjectelement/declare/) { get; set; } | Declare (for future reference), but do not instantiate, this object. See the declare attribute definition in HTML 4.01. |
...
| [Form](../../aspose.html/htmlobjectelement/form/) { get; set; } | Returns the `FORM` element containing this control. Returns `null` if this control is not within the context of a form. |
| [Height](../../aspose.html/htmlobjectelement/height/) { get; set; } | Override height. See the height attribute definition in HTML 4.01. |
| [Hspace](../../aspose.html/htmlobjectelement/hspace/) { get; set; } | Horizontal space, in pixels, to the left and right of this image, applet, or object. See the hspace attribute definition in HTML 4.01. This attribute is deprecated in HTML 4.01. |
...
| [Name](../../aspose.html/htmlobjectelement/name/) { get; set; } | Form control or object name when submitted with a form. See the name attribute definition in HTML 4.01. |
...
| [Standby](../../aspose.html/htmlobjectelement/standby/) { get; set; } | Message to render while loading the object. See the standby attribute definition in HTML 4.01. |
...
| [TabIndex](../../aspose.html/htmlobjectelement/tabindex/) { get; set; } | Index that represents the element's position in the tabbing order. See the tabindex attribute definition in HTML 4.01. |
...
| [Type](../../aspose.html/htmlobjectelement/type/) { get; set; } | Content type for data downloaded via `data` attribute. See the type attribute definition in HTML 4.01. |
| [UseMap](../../aspose.html/htmlobjectelement/usemap/) { get; set; } | Use client-side image map. See the usemap attribute definition in HTML 4.01. |
| [Vspace](../../aspose.html/htmlobjectelement/vspace/) { get; set; } | Vertical space, in pixels, above and below this image, applet, or object. See the vspace attribute definition in HTML 4.01. This attribute is deprecated in HTML 4.01. |
| [Width](../../aspose.html/htmlobjectelement/width/) { get; set; } | Override width. See the width attribute definition in HTML 4.01. |
