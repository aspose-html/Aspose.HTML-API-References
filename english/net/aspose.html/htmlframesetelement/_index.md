...
| [Cols](../../aspose.html/htmlframesetelement/cols/) { get; set; } | The number of columns of frames in the frameset. See the cols attribute definition in HTML 4.01. |
...
| [Rows](../../aspose.html/htmlframesetelement/rows/) { get; set; } | The number of rows of frames in the frameset. See the rows attribute definition in HTML 4.01. |
