...
description: Aspose.Html.HTMLTextAreaElement class. Multi-line text field. See the TEXTAREA element definition in HTML 4.01
type: docs
weight: 3840
...
| Name | Description |
| --- | --- |
| [AccessKey](../../aspose.html/htmltextareaelement/accesskey/) { get; set; } | A single character access key to give access to the form control. See the accesskey attribute definition in HTML 4.01. |
...
| [Disabled](../../aspose.html/htmltextareaelement/disabled/) { get; set; } | The control is unavailable in this context. See the disabled attribute definition in HTML 4.01. |
...
| [Form](../../aspose.html/htmltextareaelement/form/) { get; } | Returns the `FORM` element containing this control. Returns `null` if this control is not within the context of a form. |
...
| [Name](../../aspose.html/htmltextareaelement/name/) { get; set; } | Form control or object name when submitted with a form. See the name attribute definition in HTML 4.01. |
...
| [ReadOnly](../../aspose.html/htmltextareaelement/readonly/) { get; set; } | This control is read-only. See the readonly attribute definition in HTML 4.01. |
| [Rows](../../aspose.html/htmltextareaelement/rows/) { get; set; } | Number of text rows. See the rows attribute definition in HTML 4.01. |
...
| [TabIndex](../../aspose.html/htmltextareaelement/tabindex/) { get; set; } | Index that represents the element's position in the tabbing order. See the tabindex attribute definition in HTML 4.01. |
