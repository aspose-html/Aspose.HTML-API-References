...
description: Aspose.Html.HTMLTableSectionElement class. The THEAD TFOOT and TBODYelements
type: docs
weight: 3820
...
| Name | Description |
| --- | --- |
| [Align](../../aspose.html/htmltablesectionelement/align/) { get; set; } | Horizontal alignment of data in cells. See the `align`attribute for HTMLTheadElement for details. |
...
| [Ch](../../aspose.html/htmltablesectionelement/ch/) { get; set; } | Alignment character for cells in a column. See the char attribute definition in HTML 4.01. |
...
| [ChOff](../../aspose.html/htmltablesectionelement/choff/) { get; set; } | Offset of alignment character. See the charoff attribute definition in HTML 4.01. |
...
| [Rows](../../aspose.html/htmltablesectionelement/rows/) { get; } | The collection of rows in this table section. |
...
| [DeleteRow](../../aspose.html/htmltablesectionelement/deleterow/)(*int*) | Delete a row from this section. |
...
| [InsertRow](../../aspose.html/htmltablesectionelement/insertrow/)(*int*) | Insert a row into this section. The new row is inserted immediately before the current `index`th row in this section. If `index` is -1 or equal to the number of rows in this section, the new row is appended. |
