...
| Name | Description |
| --- | --- |
| [Configuration](configuration)() | Initializes a new instance of the [`class`](../configuration). |

## Properties

| Name | Description |
| --- | --- |
| [Security](security) { get; set; } | Gets or sets the sandboxing flag of the configuration. Refer to article about [sandboxing](https://docs.aspose.com/html/net/working-with-documents/environment-configuration/#sandboxing). |
