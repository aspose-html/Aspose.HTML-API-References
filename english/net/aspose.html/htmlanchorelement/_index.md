...
| Name | Description |
| --- | --- |
| [AccessKey](../../aspose.html/htmlanchorelement/accesskey/) { get; set; } | A single character access key to give access to the form control. See the accesskey attribute definition in HTML 4.01. |
...
| [Charset](../../aspose.html/htmlanchorelement/charset/) { get; set; } | The character encoding of the linked resource. See the charset attribute definition in HTML 4.01. |
...
| [Coords](../../aspose.html/htmlanchorelement/coords/) { get; set; } | Comma-separated list of lengths, defining an active region geometry. See also `shape` for the shape of the region. See the coords attribute definition in HTML 4.01. |
...
| [Name](../../aspose.html/htmlanchorelement/name/) { get; set; } | Anchor name. See the name attribute definition in HTML 4.01. |
...
| [TabIndex](../../aspose.html/htmlanchorelement/tabindex/) { get; set; } | Index that represents the element's position in the tabbing order. See the tabindex attribute definition in HTML 4.01. |
| [TagName](../../aspose.html.dom/element/tagname/) { get; } | The name of the element. |
| [Target](../../aspose.html/htmlanchorelement/target/) { get; set; } | Frame to render the resource in. See the target attribute definition in HTML 4.01. |
...
| [Blur](../../aspose.html/htmlanchorelement/blur/)() | Removes keyboard focus from this element. |
...
| [Focus](../../aspose.html/htmlanchorelement/focus/)() | Gives keyboard focus to this element. |
