...
description: InputElement SetColorValue method. This method is used to set color as a value for input element. This method is valid if only the type of the input element is color
type: docs
weight: 200
