...
description: InputElement SetTimeValue method. This method is used to set TimeSpan object as a value for input element. This method is valid if only the type of the input element is time
type: docs
weight: 280
