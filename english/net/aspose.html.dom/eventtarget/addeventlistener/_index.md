...
description: The addEventListener method of the EventTarget TAspose.Html.Dom.EventTargetinterface sets up a function that will be called whenever the specified event is delivered to the target.
type: docs
weight: 10
