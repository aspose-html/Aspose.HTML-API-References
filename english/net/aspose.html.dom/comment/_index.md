...
description: Aspose.Html.Dom.Comment class. Inherits from CharacterData and represents the content of a comment i.e. all the characters between the starting 
type: docs
weight: 480
...
| override [NodeName](../../aspose.html.dom/comment/nodename/) { get; } | The name of this node, depending on its type. |
| override [NodeType](../../aspose.html.dom/comment/nodetype/) { get; } | A code representing the type of the underlying object. |
| override [NodeValue](../../aspose.html.dom/comment/nodevalue/) { get; set; } | The value of this node, depending on its type. |
