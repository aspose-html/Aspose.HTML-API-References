...
description: The readonly previousSibling property of the Nodeaspose.html.dom/node/ interface returns the node immediately preceding the specified one in its parents childNodesaspose.html.dom/node/firstchild/ list or null if the specified node is the first in that list.
type: docs
weight: 160
