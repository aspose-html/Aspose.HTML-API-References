...
description: The readonly nextSibling property of the Nodeaspose.html.dom/node/ interface returns the node immediately following the specified one in their parents childNodesaspose.html.dom/node/childnodes/ or returns null if the specified node is the last child in the parent element.
type: docs
weight: 80
