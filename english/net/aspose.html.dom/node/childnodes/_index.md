...
description: The readonly childNodes property of the Node interface returns a live NodeListaspose.html.collections/nodelist/ of child nodes of the given element where the first child node is assigned index 0. Child nodes include elements text and comments.
type: docs
weight: 30
