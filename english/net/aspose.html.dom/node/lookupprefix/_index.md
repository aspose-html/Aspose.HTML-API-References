...
description: The lookupPrefix method of the Node interface returns a String containing the prefix for a given namespace URI if present and null if not. When multiple prefixes are possible the first prefix is returned.
type: docs
weight: 270
