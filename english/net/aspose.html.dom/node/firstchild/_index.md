...
The read-only firstChild property of the [`Node`](../../node) interface returns the node's first child in the tree, or null if the node has no children.
...
A [`Node`](../../node), or null if there are none.
