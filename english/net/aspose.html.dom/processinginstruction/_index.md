...
description: The ProcessingInstruction represents a processing instruction used in XML as a way to keep processorspecific information in the text of the document.
type: docs
weight: 1020
