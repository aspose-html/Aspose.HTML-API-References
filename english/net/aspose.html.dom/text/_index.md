...
description: Aspose.Html.Dom.Text class. The Text interface inherits from CharacterData and represents the textual content termed character data in XML of an Element or Attr
type: docs
weight: 2620
...
| override [NodeName](../../aspose.html.dom/text/nodename/) { get; } | The name of this node, depending on its type. |
| override [NodeType](../../aspose.html.dom/text/nodetype/) { get; } | A code representing the type of the underlying object. |
