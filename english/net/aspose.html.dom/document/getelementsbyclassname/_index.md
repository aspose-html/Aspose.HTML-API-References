...
The getElementsByClassName method of [`Document`](../../document) interface returns an array-like object of all child elements which have all of the given class name(s).
