...
| [NavigateAsync](../../aspose.html.dom/document/navigateasync/#navigateasync)(*[RequestMessage](../../aspose.html.net/requestmessage/), CancellationToken*) | Asynchronously loads the document based on the specified request object. |
| [NavigateAsync](../../aspose.html.dom/document/navigateasync/#navigateasync_6)(*string, CancellationToken*) | Asynchronously loads the document at the specified Uniform Resource Locator (URL) into the current instance. |
| [NavigateAsync](../../aspose.html.dom/document/navigateasync/#navigateasync_1)(*[Url](../../aspose.html/url/), CancellationToken*) | Asynchronously loads the document at the specified Uniform Resource Locator (URL) into the current instance. |
| [NavigateAsync](../../aspose.html.dom/document/navigateasync/#navigateasync_3)(*Stream, string, CancellationToken*) | Asynchronously loads the document from specified content and using baseUri to resolve relative resources. |
| [NavigateAsync](../../aspose.html.dom/document/navigateasync/#navigateasync_2)(*Stream, [Url](../../aspose.html/url/), CancellationToken*) | Asynchronously loads the document from specified content and using baseUri to resolve relative resources. |
| [NavigateAsync](../../aspose.html.dom/document/navigateasync/#navigateasync_5)(*string, string, CancellationToken*) | Asynchronously loads the document from specified content and using baseUri to resolve relative resources. |
| [NavigateAsync](../../aspose.html.dom/document/navigateasync/#navigateasync_4)(*string, [Url](../../aspose.html/url/), CancellationToken*) | Asynchronously loads the document from specified content and using baseUri to resolve relative resources. |
