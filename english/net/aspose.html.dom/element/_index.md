...
| [ParentElement](../../aspose.html.dom/node/parentelement/) { get; } | Returns the DOM node's parent `Element`, or null if the node either has no parent, or its parent isn't a DOM Element. |
