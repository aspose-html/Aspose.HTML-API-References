...
description: Returns HTMLCollectionaspose.html.collections/htmlcollection object containing all the elements within elementaspose.html.dom/element that have all the classes specified in argument.
type: docs
weight: 280
...
Returns [`HTMLCollection`](../../../aspose.html.collections/htmlcollection) object containing all the elements within [`element`](../../element) that have all the classes specified in argument.
...
An [`HTMLCollection`](../../../aspose.html.collections/htmlcollection) object is an array-like list of [`elements`](../../element).
