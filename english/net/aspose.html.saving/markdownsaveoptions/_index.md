...
description: Represents Markdown save options. For example you can set markdown formatting style use predefined GitLab Flavored Markdown compatible options and configurate resources handling. Refer to more info in articlehttps//docs.aspose.com/html/net/convertingbetweenformats/htmltomarkdown/saveoptions.
type: docs
weight: 4630
