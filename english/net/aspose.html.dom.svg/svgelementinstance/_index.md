...
| virtual [LocalName](../../aspose.html.dom/node/localname/) { get; } | Returns the local part of the qualified name of this node. For nodes of any type other than [`ELEMENT_NODE`](../../aspose.html.dom/node/element_node/) and [`ATTRIBUTE_NODE`](../../aspose.html.dom/node/attribute_node/) and nodes created with a DOM Level 1 method, such as [`CreateElement`](../../aspose.html.dom/document/createelement/), this is always null. |
