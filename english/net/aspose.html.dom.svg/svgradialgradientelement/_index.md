...
description: Aspose.Html.Dom.Svg.SVGRadialGradientElement class. The SVGRadialGradientElement interface corresponds to the radialGradient element
type: docs
weight: 2400
...
| [Cx](../../aspose.html.dom.svg/svgradialgradientelement/cx/) { get; } | Corresponds to attribute ‘cx’ on the given ‘radialGradient’ element. |
| [Cy](../../aspose.html.dom.svg/svgradialgradientelement/cy/) { get; } | Corresponds to attribute ‘cy’ on the given ‘radialGradient’ element. |
...
| [Fr](../../aspose.html.dom.svg/svgradialgradientelement/fr/) { get; } | Corresponds to attribute ‘fr’ on the given ‘radialGradient’ element. |
| [Fx](../../aspose.html.dom.svg/svgradialgradientelement/fx/) { get; } | Corresponds to attribute ‘fx’ on the given ‘radialGradient’ element. |
| [Fy](../../aspose.html.dom.svg/svgradialgradientelement/fy/) { get; } | Corresponds to attribute ‘fy’ on the given ‘radialGradient’ element. |
| [GradientTransform](../../aspose.html.dom.svg/svggradientelement/gradienttransform/) { get; } | Corresponds to attribute ‘gradientTransform’ on the given element. |
| [GradientUnits](../../aspose.html.dom.svg/svggradientelement/gradientunits/) { get; } | Corresponds to attribute ‘gradientUnits’ on the given element. Takes one of the constants defined in SVGUnitTypes. |
| [Href](../../aspose.html.dom.svg/svggradientelement/href/) { get; } | Corresponds to attribute ‘xlink:href’ on the given element. |
...
| [R](../../aspose.html.dom.svg/svgradialgradientelement/r/) { get; } | Corresponds to attribute ‘r’ on the given ‘radialGradient’ element. |
| [ShadowRoot](../../aspose.html.dom/element/shadowroot/) { get; } | Returns shadowRoot stored on this element or null if it's closed. |
| [SpreadMethod](../../aspose.html.dom.svg/svggradientelement/spreadmethod/) { get; } | Corresponds to attribute ‘spreadMethod’ on the given element. One of the Spread Method Types defined on this interface. |
