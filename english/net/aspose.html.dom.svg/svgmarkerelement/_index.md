...
description: Aspose.Html.Dom.Svg.SVGMarkerElement class. The SVGMarkerElement interface corresponds to the marker element
type: docs
weight: 2330
...
| [MarkerHeight](../../aspose.html.dom.svg/svgmarkerelement/markerheight/) { get; } | Corresponds to attribute ‘markerHeight’ on the given ‘marker’ element. |
| [MarkerUnits](../../aspose.html.dom.svg/svgmarkerelement/markerunits/) { get; } | Corresponds to attribute ‘markerUnits’ on the given ‘marker’ element. One of the Marker Unit Types defined on this interface. |
| [MarkerWidth](../../aspose.html.dom.svg/svgmarkerelement/markerwidth/) { get; } | Corresponds to attribute ‘markerWidth’ on the given ‘marker’ element. |
...
| [OrientAngle](../../aspose.html.dom.svg/svgmarkerelement/orientangle/) { get; } | Corresponds to attribute ‘orient’ on the given ‘marker’ element. If markerUnits is SVG_MARKER_ORIENT_ANGLE, the angle value for attribute ‘orient’; otherwise, it will be set to zero. |
| [OrientType](../../aspose.html.dom.svg/svgmarkerelement/orienttype/) { get; } | Corresponds to attribute ‘orient’ on the given ‘marker’ element. One of the Marker Orientation Types defined on this interface. |
...
| [PreserveAspectRatio](../../aspose.html.dom.svg/svgmarkerelement/preserveaspectratio/) { get; } | Corresponds to attribute ‘preserveAspectRatio’ on the given element. |
...
| [RefX](../../aspose.html.dom.svg/svgmarkerelement/refx/) { get; } | Corresponds to attribute ‘refX’ on the given ‘marker’ element. |
| [RefY](../../aspose.html.dom.svg/svgmarkerelement/refy/) { get; } | Corresponds to attribute ‘refY’ on the given ‘marker’ element. |
...
| [SetOrientToAngle](../../aspose.html.dom.svg/svgmarkerelement/setorienttoangle/)(*[SVGAngle](../../aspose.html.dom.svg.datatypes/svgangle/)*) | Sets the value of attribute ‘orient’ to the given angle. |
