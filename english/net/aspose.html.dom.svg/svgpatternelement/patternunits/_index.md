...
description: SVGPatternElement PatternUnits property. Corresponds to attribute patternUnits on the given pattern element. Takes one of the constants defined in SVGUnitTypes
type: docs
weight: 50
