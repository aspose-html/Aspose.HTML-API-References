...
| [Height](../../aspose.html.dom.svg/svgpatternelement/height/) { get; } | Corresponds to attribute ‘height’ on the given ‘pattern’ element. |
| [Href](../../aspose.html.dom.svg/svgpatternelement/href/) { get; } | Corresponds to attribute ‘xlink:href’ on the given element. |
...
| [PatternContentUnits](../../aspose.html.dom.svg/svgpatternelement/patterncontentunits/) { get; } | Corresponds to attribute ‘patternContentUnits’ on the given ‘pattern’ element. Takes one of the constants defined in SVGUnitTypes. |
| [PatternTransform](../../aspose.html.dom.svg/svgpatternelement/patterntransform/) { get; } | Corresponds to attribute ‘patternTransform’ on the given ‘pattern’ element. |
| [PatternUnits](../../aspose.html.dom.svg/svgpatternelement/patternunits/) { get; } | Corresponds to attribute ‘patternUnits’ on the given ‘pattern’ element. Takes one of the constants defined in SVGUnitTypes. |
...
| [PreserveAspectRatio](../../aspose.html.dom.svg/svgpatternelement/preserveaspectratio/) { get; } | Corresponds to attribute ‘preserveAspectRatio’ on the given element. |
...
| [RequiredExtensions](../../aspose.html.dom.svg/svgpatternelement/requiredextensions/) { get; } | Corresponds to attribute ‘requiredExtensions’ on the given element. |
| [RequiredFeatures](../../aspose.html.dom.svg/svgpatternelement/requiredfeatures/) { get; } | Corresponds to attribute ‘requiredFeatures’ on the given element. |
...
| [SystemLanguage](../../aspose.html.dom.svg/svgpatternelement/systemlanguage/) { get; } | Corresponds to attribute ‘systemLanguage’ on the given element. |
...
| [ViewBox](../../aspose.html.dom.svg/svgpatternelement/viewbox/) { get; } | Corresponds to attribute ‘viewBox’ on the given element. |
...
| [Width](../../aspose.html.dom.svg/svgpatternelement/width/) { get; } | Corresponds to attribute ‘width’ on the given ‘pattern’ element. |
