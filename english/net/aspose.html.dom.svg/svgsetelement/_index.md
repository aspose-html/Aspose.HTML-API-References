...
description: The SVGSetElement interface corresponds to the set element. Objectoriented access to the attributes of the set element via the SVG DOM is not available.
type: docs
weight: 2280
