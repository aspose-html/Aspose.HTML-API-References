...
Initializes a new instance of the [`Color`](../../color) class. By default color is black.
...
Initializes a new instance of the [`Color`](../../color) class. All color components must be in the range 0-1.
...
Initializes a new instance of the [`Color`](../../color) class. All color components must be in the range 0-255.
