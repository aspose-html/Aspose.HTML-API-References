...
| [IColorComponents](./icolorcomponents) | Declares method and propertis for processing color components. |
...
| [ColorModel](./colormodel) | This enumeration is used to select the color model for woking with color components. |
