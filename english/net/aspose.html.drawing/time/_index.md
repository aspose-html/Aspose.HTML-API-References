...
| [operator +](../../aspose.html.drawing/time/op_addition/) | Implements the operator +. |
| [operator ==](../../aspose.html.drawing/time/op_equality/) | Implements the operator ==. |
| [operator >](../../aspose.html.drawing/time/op_greaterthan/) | Implements the operator &gt;. |
| [operator >=](../../aspose.html.drawing/time/op_greaterthanorequal/) | Implements the operator &gt;=. |
| [operator !=](../../aspose.html.drawing/time/op_inequality/) | Implements the operator !=. |
| [operator <](../../aspose.html.drawing/time/op_lessthan/) | Implements the operator &lt;. |
| [operator <=](../../aspose.html.drawing/time/op_lessthanorequal/) | Implements the operator &lt;=. |
| [operator -](../../aspose.html.drawing/time/op_subtraction/) | Implements the operator -. |
