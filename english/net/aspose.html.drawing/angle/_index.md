...
description: Aspose.Html.Drawing.Angle class. The angle data type
type: docs
weight: 2800
...
| [operator +](../../aspose.html.drawing/angle/op_addition/) | Implements the operator +. |
| [operator ==](../../aspose.html.drawing/angle/op_equality/) | Implements the operator ==. |
| [operator >](../../aspose.html.drawing/angle/op_greaterthan/) | Implements the operator &gt;. |
| [operator >=](../../aspose.html.drawing/angle/op_greaterthanorequal/) | Implements the operator &gt;=. |
| [operator !=](../../aspose.html.drawing/angle/op_inequality/) | Implements the operator !=. |
| [operator <](../../aspose.html.drawing/angle/op_lessthan/) | Implements the operator &lt;. |
| [operator <=](../../aspose.html.drawing/angle/op_lessthanorequal/) | Implements the operator &lt;=. |
| [operator -](../../aspose.html.drawing/angle/op_subtraction/) | Implements the operator -. |
