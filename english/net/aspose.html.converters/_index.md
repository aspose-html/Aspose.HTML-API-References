...
| Class | Description |
| --- | --- |
| static class [Converter](./converter) | Shared facade only for most often conversion scenarios. It provides a wide range of conversions to the popular formats, such as PDF, XPS, image formats, etc. More specific conversion (rendering, saving) user cases are presented by well known and documented low level API functions. |
| class [TemplateContentOptions](./templatecontentoptions) | Inline content object for merging processing. |
| class [TemplateData](./templatedata) | Merging (User) data object. |
## Enumeration

| Enumeration | Description |
| --- | --- |
| enum [TemplateContent](./templatecontent) | Content type identifier. |
