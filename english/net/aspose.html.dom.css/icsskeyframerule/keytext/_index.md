...
description: The keyText property of the CSSKeyframeRule interface represents the keyframe selector as a commaseparated list of percentage values. The from and to keywords map to 0 and 100 respectively.
type: docs
weight: 10
