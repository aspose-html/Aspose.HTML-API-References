...
description: CSSPrimitiveValue SetFloatValue method. A method to set the float value with a specified unit. If the property attached with this value can not accept the specified unit or the float value the value will be unchanged and a DOMException will be raised
type: docs
weight: 80
