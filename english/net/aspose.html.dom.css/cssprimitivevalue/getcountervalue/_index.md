...
description: CSSPrimitiveValue GetCounterValue method. This method is used to get the Counter value. If this CSS value doesnt contain a counter value a DOMException is raised. Modification to the corresponding style property can be achieved using the Counter interface
type: docs
weight: 20
