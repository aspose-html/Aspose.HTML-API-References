...
description: CSSPrimitiveValue GetRGBColorValue method. This method is used to get the RGB color. If this CSS value doesnt contain a RGB color value a DOMException is raised. Modification to the corresponding style property can be achieved using the RGBColor interface
type: docs
weight: 60
