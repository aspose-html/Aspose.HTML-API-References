...
| Name | Description |
| --- | --- |
| [Item](item) { get; } | The item(index) method must return the indexth [`CSS style sheet`](../icssstylesheet) in the collection. If there is no indexth object in the collection, then the method must return null. |
| [Length](length) { get; } | The length attribute must return the number of CSS style sheets represented by the collection. The range of valid child stylesheet indices is 0 to length-1 inclusive. |
