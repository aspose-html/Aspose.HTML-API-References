...
| Name | Description |
| --- | --- |
| [Item](item) { get; } | Used to retrieve a CSS rule by method item() (http://www.w3.org/TR/DOM-Level-2-Style/css.html#CSS-CSSRuleList). The order in this collection represents the order of the rules in the CSS style sheet. If index is greater than or equal to the number of rules in the list, this returns null. |
| [Length](length) { get; } | The length property of the [`CSSRuleList`](../icssrulelist) interface returns the number of [`CSSRule`](../icssrule) objects in the list. |
