...
description: This property specifies whether the content of a block-level element is clipped when it overflows the elements box which is acting as a containing block for the content. Values have the following meanings
type: docs
weight: 790
