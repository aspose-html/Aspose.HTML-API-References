...
description: ICSS2Properties Clear property. This property indicates which sides of an elements boxes may not be adjacent to an earlier floating box. It may be that the element itself has floating descendants the clear property has no effect on those
type: docs
weight: 320
