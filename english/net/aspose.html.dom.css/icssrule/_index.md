...
description: The CSSRule interface is the abstract base interface for any type of CSS statement. This includes both rule sets and at-rules. An implementation is expected to preserve all rules specified in a CSS style sheet even if the rule is not recognized by the parser. Unrecognized rules are represented using the interface.
type: docs
weight: 590
...
| Name | Description |
| --- | --- |
| [CSSText](../../aspose.html.dom.css/icssrule/csstext) { get; set; } | The cssText property of the [`CSSRule`](../icssrule) interface returns the actual text of a [`CSSStyleSheet`](../icssstylesheet) style-rule. |
...
| [ParentStyleSheet](../../aspose.html.dom.css/icssrule/parentstylesheet) { get; } | The parentStyleSheet property of the [`CSSRule`](../icssrule) interface returns the [`StyleSheet`](../istylesheet) object in which the current rule is defined. |
