...
| [Media](../../aspose.html.dom.css/icssmediarule/media) { get; } | The read-only media property of the [`CSSMediaRule`](../icssmediarule) interface MediaList represents the intended destination medium for style information. |
