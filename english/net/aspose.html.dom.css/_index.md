...
| [Rect](./rect/) | The Rect interface is used to represent any rect value. This interface reflects the values in the underlying style property. Hence, modifications made to the [`CSSPrimitiveValue`](../aspose.html.dom.css/cssprimitivevalue/) objects modify the style property. |
...
| [ICSSKeyframeRule](./icsskeyframerule/) | The [`CSSKeyframeRule`](../aspose.html.dom.css/icsskeyframerule/) interface describes an object representing a set of styles for a given keyframe. It corresponds to the contents of a single keyframe of a @keyframes at-rule. |
...
| [IStyleSheetList](./istylesheetlist/) | The StyleSheetList interface represents a list of [`CSSStyleSheet`](../aspose.html.dom.css/icssstylesheet/) objects. An instance of this object can be returned by [`Document.styleSheets`](../aspose.html.dom/document/stylesheets/). |
