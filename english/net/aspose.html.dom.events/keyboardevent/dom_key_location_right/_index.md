...
description: KeyboardEvent DOM_KEY_LOCATION_RIGHT field. The key activation originated from the right key location when there is more than one possible location for this key
type: docs
weight: 130
