...
description: Aspose.Html.Dom.Events.InputEvent class. Input events are sent as notifications whenever the DOM is being updated
type: docs
weight: 990
...
| [IsComposing](../../aspose.html.dom.events/inputevent/iscomposing/) { get; } | true if the input event occurs as part of a composition session, i.e., after a compositionstart event and before the corresponding compositionend event. The un-initialized value of this attribute MUST be false. |
