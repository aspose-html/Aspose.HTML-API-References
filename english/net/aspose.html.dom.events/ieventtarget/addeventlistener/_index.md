...
description: IEventTarget AddEventListener method. The EventTarget method addEventListener sets up a function that will be called whenever the specified event is delivered to the target
type: docs
weight: 10
