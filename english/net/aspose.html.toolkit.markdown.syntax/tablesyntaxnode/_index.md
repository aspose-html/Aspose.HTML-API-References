...
description: Aspose.Html.Toolkit.Markdown.Syntax.TableSyntaxNode class. The TableSyntax class node
type: docs
weight: 5860
...
| Name | Description |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/tablesyntaxnode/accept/)(*[MarkdownSyntaxVisitor](../markdownsyntaxvisitor/)*) | Defines the interface for accept of the visitor. |
...
| [AppendRow](../../aspose.html.toolkit.markdown.syntax/tablesyntaxnode/appendrow/)(*[TableRowSyntaxNode](../tablerowsyntaxnode/)*) | Defines the interface for append row. |
| [ChildNodes](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/childnodes/)() | Get the child nodes collection. |
| [GetAlignment](../../aspose.html.toolkit.markdown.syntax/tablesyntaxnode/getalignment/)() | Defines the interface for get aligment. |
| [GetBodyRows](../../aspose.html.toolkit.markdown.syntax/tablesyntaxnode/getbodyrows/)() | Defines the interface for get body rows. |
| [GetHeader](../../aspose.html.toolkit.markdown.syntax/tablesyntaxnode/getheader/)() | Defines the interface for get table header. |
