...
| Name | Description |
| --- | --- |
| [Hash](../../aspose.html.window/location/hash/) { get; set; } |  |
| [Host](../../aspose.html.window/location/host/) { get; set; } |  |
| [Hostname](../../aspose.html.window/location/hostname/) { get; set; } |  |
| [Href](../../aspose.html.window/location/href/) { get; set; } |  |
| [Origin](../../aspose.html.window/location/origin/) { get; } |  |
| [Pathname](../../aspose.html.window/location/pathname/) { get; set; } |  |
| [Port](../../aspose.html.window/location/port/) { get; set; } |  |
