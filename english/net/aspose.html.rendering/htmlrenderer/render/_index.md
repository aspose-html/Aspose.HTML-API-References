...
Defines a method for rendering multiple [`Document`](../../../aspose.html.dom/document/)s into a specific [`IDevice`](../../idevice/), using a cancellation token to request cancellation of the operation.
