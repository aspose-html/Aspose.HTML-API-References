...
Defines a method for rendering multiple [`SVGDocument`](../../../aspose.html.dom.svg/svgdocument/)s into a specific [`IDevice`](../../idevice/), using a cancellation token to request cancellation of the operation.
