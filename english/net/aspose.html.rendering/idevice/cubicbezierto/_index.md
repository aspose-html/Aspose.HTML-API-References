...
description: IDevice CubicBezierTo method. Appends a cubic Bézier curve to the current path. The curve extends from the current point to the point pt3 using pt1 and pt2 as the Bézier control points. The new current point is pt3
type: docs
weight: 90
