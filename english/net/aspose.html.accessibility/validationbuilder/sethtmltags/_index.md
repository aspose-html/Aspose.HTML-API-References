...
description: ValidationBuilder SetHTMLTags method. List of html tags to check If the tags are not specified explicitly then the tags array is empty and the check passes through all
type: docs
weight: 60
url: /net/aspose.html.accessibility/validationbuilder/sethtmltags/
---
