...
| Nome | Descrizione |
| --- | --- |
| class [XpsGraphicContext](../../com.aspose.html.rendering.xps/xpsdevice.xpsgraphiccontext) | Contiene i parametri di controllo grafico attuali per XpsDevice. Questi parametri definiscono il framework globale entro il quale gli operatori grafici vengono eseguiti. |
