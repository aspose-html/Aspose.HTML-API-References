...
description: "classe com.aspose.html.net.ByteArrayContent. Rappresenta un contenuto basato su un array di byte."
type: docs

url: /it/java/com.aspose.html.net/bytearraycontent/
---
## ByteArrayContent class

Rappresenta contenuto basato su un array di byte.
...
| Nome | Descrizione |
| --- | --- |
| [ByteArrayContent](bytearraycontent/)(byte[]) | Inizializza una nuova istanza della classe `ByteArrayContent`. |
