...
description: "Metodo MarkdownSyntaxFactory. Crea MarkdownSyntaxToken"
type: docs

url: /it/java/com.aspose.html.toolkit.markdown.syntax/markdownsyntaxfactory/token/
---
## Token(SourceText, TextSpan) {#token_1}

Crea [`MarkdownSyntaxToken`](../../markdownsyntaxtoken/).
