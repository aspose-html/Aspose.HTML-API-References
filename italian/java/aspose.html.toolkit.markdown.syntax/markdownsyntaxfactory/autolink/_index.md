...
description: "Metodo MarkdownSyntaxFactory. Crea AutoLinkSyntaxNode"
type: docs

url: /it/java/com.aspose.html.toolkit.markdown.syntax/markdownsyntaxfactory/autolink/
---
...
| --- | --- | --- |
| opening | MarkdownSyntaxToken | Il MarkdownSyntaxToken. |
| contenuto | TextSyntaxNode | Il TextSyntax. |
| closing | MarkdownSyntaxToken | Il MarkdownSyntaxToken. |
...
| contenuto | TextSyntaxNode | Il TextSyntax. |
| closing | MarkdownSyntaxToken | Il MarkdownSyntaxToken. |
| posta | Boolean | Il flag booleano. |
