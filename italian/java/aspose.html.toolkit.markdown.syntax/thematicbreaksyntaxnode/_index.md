---
title: "ThematicBreakSyntaxNode Classe"
second_title: "Riferimento API Aspose.HTML per Java"
description: "classe com.aspose.html.toolkit.markdown.syntax.ThematicBreakSyntaxNode. Implementa il nodo di sintassi di interruzione tematica"
type: docs

url: /it/java/com.aspose.html.toolkit.markdown.syntax/thematicbreaksyntaxnode/
---
## ThematicBreakSyntaxNode class

Implementato il nodo di sintassi di interruzione tematica.
...
| Nome | Descrizione |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/thematicbreaksyntaxnode/accept/)(MarkdownSyntaxVisitor) | Definisce l'interfaccia per il visitatore Accept. |
