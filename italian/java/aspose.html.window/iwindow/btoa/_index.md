...
Accetta i dati di input, sotto forma di stringa Unicode contenente solo caratteri nell'intervallo U+0000 a U+00FF, ciascuno dei quali rappresenta un byte binario con valori da 0x00 a 0xFF rispettivamente, e lo converte nella sua rappresentazione base64, che restituisce.
...
| --- | --- |
| [dOMException](../../../com.aspose.html.dom/domexception/) | Genera un'eccezione "InvalidCharacterError" DOMException se la String di input contiene caratteri fuori dall'intervallo. |
