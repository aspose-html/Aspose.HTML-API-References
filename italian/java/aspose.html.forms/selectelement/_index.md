...
description: "classe com.aspose.html.forms.SelectElement. Il SelectElement rappresenta un wrapper associato all'HTMLSelectElement."
type: docs
...
| [getType](../../com.aspose.html.forms/selectelement/type/) Il tipo di questo controllo di modulo. È la stringa "select-multiple" quando l'attributo multiple è `true` e la stringa "select-one" quando è `false`. |
| [value](../../com.aspose.html.forms/selectelement/value/) { get; set; } | Durante il recupero, deve restituire il valore del primo elemento option nell'elenco delle opzioni in ordine di albero che ha la proprietà selected impostata su true, se presente. |
