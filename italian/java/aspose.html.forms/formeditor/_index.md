...
description: "classe com.aspose.html.forms.FormEditor. Questa classe rappresenta l'editor sull'HTMLFormElement che offre un modo più semplice per gli sviluppatori .net di modificare i moduli HTML"
type: docs
...
Questa classe rappresenta l'editor sull'[`HTMLFormElement`](../../com.aspose.html/htmlformelement/) che offre un modo più semplice per gli sviluppatori .net di modificare i moduli HTML.
