...
description: "Metodo TimeEvent. Il metodo initTimeEvent è usato per inizializzare il valore di un TimeEvent creato tramite l'interfaccia DocumentEvent. Questo metodo può essere chiamato solo prima che il TimeEvent sia stato distribuito tramite il metodo dispatchEvent, sebbene possa essere chiamato più volte durante quella fase, se necessario. Se chiamato più volte, l'ultima invocazione ha la precedenza"
type: docs
