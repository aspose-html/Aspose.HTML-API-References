...
description: "classe com.aspose.html.toolkit.optimizers.SVGOptimizationOptions. SVGOptimizationOptions è una classe per memorizzare le opzioni per ottimizzare i documenti SVG"
type: docs

url: /it/java/com.aspose.html.toolkit.optimizers/svgoptimizationoptions/
---
## SVGOptimizationOptions class

SVGOptimizationOptions è una classe per memorizzare le opzioni di ottimizzazione dei documenti SVG.
...
| Nome | Descrizione |
| --- | --- |
| [SVGOptimizationOptions](svgoptimizationoptions/)() | Inizializza una nuova istanza della classe `SVGOptimizationOptions`. |
