---
title: "Classe SVGPathOptimizationOptions"
second_title: "Aspose.HTML per Java Riferimento API"
description: "classe com.aspose.html.toolkit.optimizers.SVGPathOptimizationOptions. SVGPathOptimizationOptions è una classe per memorizzare le opzioni per ottimizzare i segmenti degli elementi di percorso SVG"
type: docs

url: /it/java/com.aspose.html.toolkit.optimizers/svgpathoptimizationoptions/
---
## SVGPathOptimizationOptions class

SVGPathOptimizationOptions è una classe per memorizzare le opzioni di ottimizzazione dei segmenti degli elementi percorso SVG.
...
| Nome | Descrizione |
| --- | --- |
| [SVGPathOptimizationOptions](svgpathoptimizationoptions/)() | Inizializza una nuova istanza della classe `SVGPathOptimizationOptions`. |
