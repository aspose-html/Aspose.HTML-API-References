...
description: "classe com.aspose.html.rendering.pdf.PdfDevice. Rappresenta il rendering verso un documento pdf"
type: docs
...
| [PdfDevice](pdfdevice/#constructor_1)(PdfRenderingOptions, ICreateStreamProvider) | Inizializza una nuova istanza della classe `PdfDevice` mediante opzioni di rendering e provider di stream. |
| [PdfDevice](pdfdevice/#constructor_2)(PdfRenderingOptions, Stream) | Inizializza una nuova istanza della classe `PdfDevice` mediante opzioni di rendering e stream di output. |
| [PdfDevice](pdfdevice/#constructor_3)(PdfRenderingOptions, String) | Inizializza una nuova istanza della classe `PdfDevice` mediante opzioni di rendering e nome file di output. |
...
| Nome | Descrizione |
| --- | --- |
| class [PdfGraphicContext](../../com.aspose.html.rendering.pdf/pdfdevice.pdfgraphiccontext) | Contiene i parametri di controllo grafico correnti per il PdfDevice. Questi parametri definiscono il quadro globale entro il quale gli operatori grafici vengono eseguiti. |
