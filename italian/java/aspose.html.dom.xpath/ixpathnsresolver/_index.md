...
| Nome | Descrizione |
| --- | --- |
| [lookupNamespaceURI](../../com.aspose.html.dom.xpath/ixpathnsresolver/lookuppackageuri/)(String) | Cerca l'URI del pacchetto associato al prefisso di pacchetto fornito. L'evaluatore XPath non deve mai chiamare questo metodo con un argomento `null` o vuoto, poiché il risultato di tale operazione è indefinito. |
