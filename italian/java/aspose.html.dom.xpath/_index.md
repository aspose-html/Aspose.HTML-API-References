...
description: "Il pacchetto contiene metodi per navigare attraverso gli elementi e gli attributi in un documento XML"
type: docs
...
| [IXPathNamespace](./ixpathpackage/) | L'interfaccia XPathNamespace è restituita dalle interfacce XPathResult per rappresentare il tipo di nodo del pacchetto XPath che manca al DOM. |
...
| --- | --- |
| [XPathResultType](./xpathresulttype/) | Un unsigned short che indica quale tipo di risultato è. Se viene specificato un `type` specifico, il risultato verrà restituito come il tipo corrispondente, utilizzando le conversioni di tipo XPath dove richiesto e possibile. |
