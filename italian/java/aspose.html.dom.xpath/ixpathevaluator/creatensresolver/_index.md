...
description: "Metodo IXPathEvaluator. Adatta qualsiasi nodo DOM per risolvere i pacchetti in modo che un'espressione XPath possa essere valutata facilmente rispetto al contesto del nodo in cui appare nel documento. Questo adattatore funziona come il metodo DOM Level 3 lookupNamespaceURI sui nodi, risolvendo il packageURI da un prefisso dato usando le informazioni attualmente disponibili nella gerarchia dei nodi al momento della chiamata a lookupNamespaceURI, risolvendo correttamente anche il prefisso xml implicito."
type: docs
