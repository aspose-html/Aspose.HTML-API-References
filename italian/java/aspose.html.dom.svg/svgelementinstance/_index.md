---
title: "SVGElementInstance Classe"
second_title: "Riferimento API Aspose.HTML per Java"
description: "com.aspose.html.dom.svg.SVGElementInstance class. L'oggetto radice di ogni albero ombra use-element implementa l'interfaccia SVGUseElementShadowRoot. Questa interfaccia attualmente non definisce alcuna estensione alle proprietà e ai metodi definiti per l'interfaccia ShadowRoot e al mixin DocumentOrShadowRoot. Tuttavia l'albero radicato in questo nodo è interamente di sola lettura dal punto di vista degli script dell'autore."
type: docs

url: /it/java/com.aspose.html.dom.svg/svgelementinstance/
---
## SVGElementInstance class

L'oggetto radice di ogni albero ombra use-element implementa l'interfaccia SVGUseElementShadowRoot. Questa interfaccia attualmente non definisce alcuna estensione alle proprietà e ai metodi definiti per l'interfaccia ShadowRoot e al mixin DocumentOrShadowRoot. Tuttavia, l'albero radicato in questo nodo è interamente di sola lettura dal punto di vista degli script dell'autore.
...
| [getHost](../../com.aspose.html.dom/shadowroot/host/) Host è un elemento che contiene questo ShadowRoot. |
[getInnerHTML]
...
| [getMode](../../com.aspose.html.dom/shadowroot/mode/) Modalità in cui opera questo ShadowRoot. |
...
| [getNextElementSibling](../../com.aspose.html.dom/documentfragment/nextelementsibling/) Restituisce il nodo elemento fratello successivo di questo elemento. null se questo elemento non ha nodi elemento fratelli che seguono questo nella struttura del documento. |
...
| [getPreviousElementSibling](../../com.aspose.html.dom/documentfragment/previouselementsibling/) Restituisce il nodo elemento fratello precedente di questo elemento. null se questo elemento non ha nodi elemento fratelli che precedono questo nella struttura del documento. |
...
| [textContent](../../com.aspose.html.dom/documentfragment/textcontent/) { get; set; } | Questo attributo restituisce il contenuto testuale di questo nodo e dei suoi discendenti. Quando è definito come null, impostarlo non ha alcun effetto. All'impostazione, tutti i possibili figli che questo nodo potrebbe avere vengono rimossi e, se la nuova stringa non è vuota o null, viene sostituito da un unico nodo Text contenente la stringa impostata. |
...
| [querySelector](../../com.aspose.html.dom/documentfragment/queryselector/)(String) | Restituisce il primo Element nel documento che corrisponde al selettore |
| [querySelectorAll](../../com.aspose.html.dom/documentfragment/queryselectorall/)(String) | Restituisce un NodeList di tutti gli Elements nel documento che corrispondono al selettore |
