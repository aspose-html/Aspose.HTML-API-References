...
description: "Metodo SVGDocument. Salva il documento in un file locale specificato da url. Tutte le risorse utilizzate in questo documento saranno salvate in una cartella adiacente il cui nome sarà costruito come output_file_name  _files"
type: docs

url: /it/java/com.aspose.html.dom.svg/svgdocument/save/
---
## Save(Url) {#save_3}

Salva il documento in un file locale specificato da `url`. Tutte le risorse utilizzate in questo documento saranno salvate in una cartella adiacente, il cui nome sarà costruito come: output_file_name + "_files".
...
Salva il documento in un file locale specificato da `path`. Tutte le risorse utilizzate in questo documento saranno salvate in una cartella adiacente, il cui nome sarà costruito come: output_file_name + "_files".
...
| --- | --- | --- |
| percorso | String | Percorso locale del file di output. |
| saveFormat | SVGSaveFormat | Formato in cui il documento viene salvato. |
