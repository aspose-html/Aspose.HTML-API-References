...
description: "Costruttore SVGDocument. Inizializza una nuova istanza della classe SVGDocument"
type: docs

url: /it/java/com.aspose.html.dom.svg/svgdocument/svgdocument/
---
## SVGDocument() {#constructor}

Inizializza una nuova istanza della classe [`SVGDocument`](../).
...
Inizializza una nuova istanza della classe [`SVGDocument`](../). Il costruttore funziona in modo sincrono, attendendo il caricamento di tutte le risorse esterne (immagini, script, ecc.). Per caricare il documento in modo asincrono utilizza il metodo [`Navigate`](../../../com.aspose.html.dom/document/navigate/) o le sue sovraccariche. Oppure è possibile disabilitare il caricamento di alcune risorse esterne impostando i flag appropriati in [`Security`](../../../com.aspose.html.dom/ibrowsingcontext/security/).
...
Inizializza una nuova istanza della classe [`SVGDocument`](../). Il costruttore funziona in modo sincrono, attendendo il caricamento di tutte le risorse esterne (immagini, script, ecc.). Per caricare il documento in modo asincrono utilizza il metodo [`Navigate`](../../../com.aspose.html.dom/document/navigate/) o le sue sovraccariche. Oppure è possibile disabilitare il caricamento di alcune risorse esterne impostando i flag appropriati in [`Security`](../../../com.aspose.html.dom/ibrowsingcontext/security/). Il caricamento del documento inizia dalla posizione corrente nello stream.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| richiesta | RequestMessage | La richiesta. |
