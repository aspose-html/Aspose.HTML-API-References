---
title: "InputEvent Classe"
second_title: "Aspose.HTML per Java Riferimento API"
description: "com.aspose.html.dom.events.InputEvent classe. Gli eventi di input vengono inviati come notifiche ogni volta che il DOM viene aggiornato."
type: docs
...
| [getIsComposing](../../com.aspose.html.dom.events/inputevent/iscomposing/) vero se l'evento di input si verifica come parte di una sessione di composizione, cioè dopo un evento compositionstart e prima dell'evento compositionend corrispondente. Il valore non inizializzato di questo attributo DEVE essere false. |
