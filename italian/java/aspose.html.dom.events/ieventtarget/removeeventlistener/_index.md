...
description: "Metodo IEventTarget. Questo metodo consente la rimozione degli ascoltatori di eventi dal target dell'evento. Se un ascoltatore viene rimosso da un target mentre sta elaborando un evento, non verrà attivato dalle azioni correnti. Gli ascoltatori di eventi non possono mai essere invocati dopo essere stati rimossi"
type: docs
