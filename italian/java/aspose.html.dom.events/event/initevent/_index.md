...
description: "Metodo Event. Il metodo InitEvent è usato per inizializzare il valore di un Event creato tramite l'interfaccia theIDocumentEvent."
type: docs
...
Il metodo `InitEvent` è usato per inizializzare il valore di un [`Event`](../) creato tramite l'interfaccia [`IDocumentEvent`](../../idocumentevent/).
