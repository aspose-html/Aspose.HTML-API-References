...
description: "Metodo IDocumentEvent. Il metodo `createEvent` è usato per creare Event quando è scomodo o non necessario che l'utente crei un Event da solo."
type: docs
