---
title: "Classe SVGPathSegCurvetoCubicRel"
second_title: "Aspose.HTML per Java Riferimento API"
description: "classe com.aspose.html.dom.svg.paths.SVGPathSegCurvetoCubicRel. L'interfaccia SVGPathSegCurvetoCubicRel corrisponde a un comando di dati di percorso curveto c cubico Bézier relativo."
type: docs

url: /it/java/com.aspose.html.dom.svg.paths/svgpathsegcurvetocubicrel/
---
## SVGPathSegCurvetoCubicRel class

L'interfaccia SVGPathSegCurvetoCubicRel corrisponde a un comando di dati di percorso "curveto Bézier cubico relativo" (c).
...
| [X](../../com.aspose.html.dom.svg.paths/svgpathsegcurvetocubicrel/x/) { get; set; } | La coordinata X relativa per il punto finale di questo segmento di percorso. |
[getX1]
[setX1] The relative X coordinate for the first control point. |
[getX2]
[setX2] The relative X coordinate for the second control point. |
| [Y](../../com.aspose.html.dom.svg.paths/svgpathsegcurvetocubicrel/y/) { get; set; } | La coordinata Y relativa per il punto finale di questo segmento di percorso. |
[getY1]
