---
title: "Classe SVGPathSegLinetoVerticalRel"
second_title: "Aspose.HTML per Java Riferimento API"
description: "classe com.aspose.html.dom.svg.paths.SVGPathSegLinetoVerticalRel. L'interfaccia SVGPathSegLinetoVerticalRel corrisponde a un comando di dati di percorso lineto verticale relativo (v)"
type: docs

url: /it/java/com.aspose.html.dom.svg.paths/svgpathseglinetoverticalrel/
---
## SVGPathSegLinetoVerticalRel class

L'interfaccia SVGPathSegLinetoVerticalRel corrisponde a un comando di dati di percorso "lineto verticale relativo" (v).
...
| [Y](../../com.aspose.html.dom.svg.paths/svgpathseglinetoverticalrel/y/) { get; set; } | La coordinata Y relativa per il punto finale di questo segmento di percorso. |
