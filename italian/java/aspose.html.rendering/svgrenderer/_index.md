...
description: "com.aspose.html.rendering.SvgRenderer class. Rappresenta il renderer di documenti SVG"
type: docs

url: /it/java/com.aspose.html.rendering/svgrenderer/
---
## SvgRenderer class

Rappresenta un renderer di documenti SVG.
...
| Nome | Descrizione |
| --- | --- |
| [SvgRenderer](svgrenderer/)() | Il costruttore predefinito. |
...
| [render](../../com.aspose.html.rendering/svgrenderer/render/#render_5)(IDevice, CancellationToken, params SVGDocument[]) | Definisce un metodo per il rendering di più [`SVGDocument`](../../com.aspose.html.dom.svg/svgdocument/) in un specifico [`IDevice`](../idevice/), utilizzando un token di cancellazione per richiedere l'annullamento dell'operazione. |
...
| [render](../../com.aspose.html.rendering/svgrenderer/render/#render_6)(IDevice, TimeSpan, params SVGDocument[]) | Definisce un metodo per il rendering di più [`SVGDocument`](../../com.aspose.html.dom.svg/svgdocument/) in uno specifico [`IDevice`](../idevice/). Il rendering verrà eseguito una volta che non vi sono operazioni di rete per il caricamento delle risorse, timer attivi, attività di animazione o il timeout specificato è trascorso. |
