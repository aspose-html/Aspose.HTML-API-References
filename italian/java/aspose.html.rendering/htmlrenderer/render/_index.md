...
Definisce un metodo per il rendering di più [`HTMLDocument`](../../../com.aspose.html/htmldocument/)s in uno specifico [`IDevice`](../../idevice/), usando un token di cancellazione per richiedere l'annullamento dell'operazione.
