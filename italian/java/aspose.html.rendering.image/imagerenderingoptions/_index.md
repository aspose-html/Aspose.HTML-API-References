...
description: "classe com.aspose.html.rendering.image.ImageRenderingOptions. Rappresenta le opzioni di rendering per ImageDevice. Queste opzioni sono usate per specificare il formato dell'immagine di output, la compressione, la risoluzione, ecc."
type: docs
...
Rappresenta le opzioni di rendering per [`ImageDevice`](../imagedevice/). Queste opzioni sono usate per specificare il formato dell'immagine di output, la compressione, la risoluzione, ecc.
