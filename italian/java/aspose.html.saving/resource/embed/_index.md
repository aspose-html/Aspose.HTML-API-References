...
| --- | --- |
| InvalidOperationException | Generato se non esiste [`ParentResource`](../../resourcehandlingcontext/parentresource/) perché non c'è alcun luogo in cui incorporare il risultato. |
