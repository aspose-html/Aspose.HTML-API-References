...
Rappresenta le opzioni di salvataggio MHTML. Assegnando proprietà specifiche è possibile gestire l'elaborazione delle risorse, come la profondità massima di gestione e così via. Maggiori informazioni nella documentazione [article](https://docs.aspose.com/html/net/converting-between-formats/html-to-mhtml/#save-options).
