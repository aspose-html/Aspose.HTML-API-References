...
description: "classe com.aspose.html.saving.DocSaveOptions. Classe di dati per opzioni specifiche. Assegnando le proprietà è possibile gestire le caratteristiche di rendering come risoluzione, dimensione della pagina, colore di sfondo così come opzioni specifiche del documento come l'incorporamento dei font. Per ulteriori informazioni vedere l'articolo della documentazione"
type: docs
