...
description: "com.aspose.html.saving.PdfSaveOptions classe. Questa classe di dati specifica fornisce alcune proprietà per gestire il risultato della conversione. Ad esempio PageSetup specifica le caratteristiche della pagina. Fare riferimento all'articolo della documentazione"
type: docs
...
Questa classe di dati specifica fornisce alcune proprietà per gestire il risultato della conversione. Ad esempio [`PageSetup`](../../com.aspose.html.rendering/pagesetup/) specifica le caratteristiche della pagina. Fare riferimento alla documentazione [articolo](https://docs.aspose.com/html/net/converting-between-formats/html-to-pdf/#convert-html-to-pdf-using-pdfsaveoptions).
...
| [getPageSetup](../../com.aspose.html.rendering/renderingoptions/pagesetup/) Ottiene un oggetto di configurazione della pagina utilizzato per la configurazione dell'output del page-set. |
...
import System;
...
 	 // Prepara un percorso verso un file HTML di origine
      ...
      // Inizializza PdfSaveOptions. Imposta la dimensione della pagina a 600x300 pixel, i margini, 
      // risoluzioni e cambia il colore di sfondo in AliceBlue 
