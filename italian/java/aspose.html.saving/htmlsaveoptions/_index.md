...
description: "com.aspose.html.saving.HTMLSaveOptions class. Rappresenta le opzioni di salvataggio HTML. Assegnando proprietà specifiche è possibile gestire l'elaborazione delle risorse, come la profondità massima di gestione e così via. Per ulteriori informazioni vedere l'articolo della documentazione"
type: docs
...
Rappresenta le opzioni di salvataggio HTML. Assegnando proprietà specifiche è possibile gestire l'elaborazione delle risorse, come la profondità massima di gestione e così via. Maggiori informazioni nella documentazione [article](https://docs.aspose.com/html/net/working-with-documents/saving-a-document/).
...
...
     // Prepara un percorso di output per un documento HTML 
      ...
      using (var document = new HTMLDocument(documentPath))
      {
        ...
        // La riga seguente con valore '0' interrompe tutti gli altri file HTML collegati durante il salvataggio di questa istanza
