...
description: "Metodo Converter. Converte la sorgente HTML presentata da HTMLDocument. Il risultato è un file docx generato dal percorso del file di output."
type: docs

url: /it/java/com.aspose.html.converters/converter/converthtml/
---
## ConvertHTML(HTMLDocument, DocSaveOptions, String) {#converthtml_1}

Converti la sorgente HTML presentata da [`HTMLDocument`](../../../com.aspose.html/htmldocument/). Il risultato è un file docx generato dal percorso del file di output.
...
| --- | --- | --- |
| document | HTMLDocument | Istanza di [`HTMLDocument`](../../../com.aspose.html/htmldocument/) come sorgente di conversione. |
| options | DocSaveOptions | L'utilizzo dell'oggetto [`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/) consente di regolare il processo di rendering. Per ulteriori informazioni vedere [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/html-to-docx/#convert-html-to-docx-using-docsaveoptions). |
| outputPath | String | Percorso completo del file docx come risultato della conversione di output. |

## Osservazioni

Come convertire HTML in DOCX
...
Il principale punto di forza di Aspose.HTML è la funzionalità di conversione. Convertire tra formati è necessario per vari motivi: lavorare in un formato familiare e comodo o sfruttare formati diversi per compiti specifici. Il pacchetto com.aspose.html.converters offre un facile accesso ai metodi di conversione. Fornisce un'ampia gamma di conversioni HTML verso formati popolari, come [PDF](https://docs.fileformat.com/pdf/), [XPS](https://docs.fileformat.com/page-description-language/xps/), [DOCX](https://docs.fileformat.com/word-processing/docx/), [JPEG](https://docs.fileformat.com/image/jpeg/), [PNG](https://docs.fileformat.com/image/png/), [BMP](https://docs.fileformat.com/image/bmp/), [TIFF](https://docs.fileformat.com/image/tiff/), [GIF](https://docs.fileformat.com/image/gif/), [MHTML](https://docs.fileformat.com/web/mhtml/), e [MD](https://docs.fileformat.com/word-processing/md/).

Questo articolo fornisce informazioni sull'elenco delle conversioni HTML supportate e su come eseguirle utilizzando la classe [`Converter`](../) che raggruppa tutte le operazioni di conversione di basso livello in un'unica classe per renderle comode e facili da usare. Nella guida HTML Converter, trovi i seguenti articoli:

Conversione DOCX

Un file DOCX è un documento Microsoft Word che tipicamente contiene il testo ma può contenere una vasta gamma di dati, incluse tabelle, grafica raster e vettoriale, video, suoni e diagrammi. Il file DOCX è altamente modificabile, facile da usare e di dimensioni gestibili. Questo formato è popolare per la varietà di opzioni che offre agli utenti per scrivere qualsiasi tipo di documento. Questo formato di file è uno dei più ampiamente utilizzati ed è disponibile attraverso numerosi programmi.
...
Altre conversioni di formati popolari
...
Origine della conversione. Rileva un file HTML locale esistente o un Url remoto come origine della conversione. Puoi anche definire contenuto HTML inline come origine della conversione o creare un documento HTML ([`HTMLDocument`](../../../com.aspose.html/htmldocument/)) in qualsiasi modo. Risultato della conversione. Definisci il percorso del file di output del risultato o utilizza un'implementazione dell'interfaccia [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) nota o personalizzata come buffer dei dati di output. Crea un nuovo oggetto [`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/) con impostazioni personalizzate o predefinite. Puoi aggiungere anche [`configuration`](../../../com.aspose.html/configuration/) come parametro opzionale. Usa il metodo ConvertHTML() della classe Converter per salvare l'HTML come risultato DOCX con tre o più parametri a seconda dello scenario dell'utente. Convertitori HTML online

Aspose.HTML offre un gratuito [HTML to DOCX Converter](https://products.aspose.app/html/en/conversion/html-to-docx) online che converte HTML in DOCX con alta qualità, in modo semplice e veloce. Basta caricare, convertire i tuoi file e ottenere i risultati in pochi secondi!

Prova a utilizzare altre conversioni di formati popolari
...
Potresti essere interessato anche a conversioni specifiche di formati immagine
...
...
    ...
    // Istanzia l'oggetto di configurazione predefinito
...
Converti la sorgente HTML presentata da URL. Il risultato è un file docx generato dal percorso del file di output.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| url | Url | URL del documento sorgente HTML - fornisce una rappresentazione oggetto di un identificatore universale (URL). |
| options | DocSaveOptions | L'utilizzo dell'oggetto [`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/) consente di regolare il processo di rendering. Per ulteriori informazioni vedere [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/html-to-docx/#convert-html-to-docx-using-docsaveoptions). |
| outputPath | String | Percorso completo del file docx come risultato della conversione di output. |
...
Converti la sorgente HTML presentata da percorso file completo in DOCX. Il risultato è un file docx generato dal percorso del file di output.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| sourcePath | String | Percorso completo del file sorgente Html. |
| options | DocSaveOptions | L'utilizzo dell'oggetto [`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/) consente di regolare il processo di rendering. Per ulteriori informazioni vedere [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/html-to-docx/#convert-html-to-docx-using-docsaveoptions). |
| outputPath | String | Percorso completo del file docx come risultato della conversione di output. |
...
Converti la sorgente HTML presentata tramite contenuto inline. Il risultato è un file docx creato dal percorso del file di output.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| contenuto | String | Stringa come contenuto HTML inline. |
...
import com.aspose.html.converters;  
... 
	// Definisci contenuto HTML inline		
...
Converti la sorgente HTML presentata da [`HTMLDocument`](../../../com.aspose.html/htmldocument/). Il risultato è un dato di output generato dall'implementazione dell'interfaccia [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/).
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| document | HTMLDocument | Sorgente di conversione presentata da [`HTMLDocument`](../../../com.aspose.html/htmldocument/). |
| options | DocSaveOptions | L'utilizzo dell'oggetto [`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/) consente di regolare il processo di rendering. Per ulteriori informazioni vedere [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/html-to-docx/#convert-html-to-docx-using-docsaveoptions). |
...
... 
		// Definisci contenuto HTML inline
      	...
      	// Crea documento HTML in uno dei diversi modi
      	using (var document = new HTMLDocument(content, String.Empty, configuration))
     	 {
        	// Definisci il percorso del file di risultato senza estensione
...
Converti la sorgente HTML presentata da URL. Il risultato è un dato di output generato dall'implementazione dell'interfaccia [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/).
...
import com.aspose.html.converters;  
... 	 
 	  // Definisci URL di origine
      var sourceUrl = new Url(Path.Combine(InputFolder, "source.html"));

      // Definisci il percorso del file di risultato senza estensione
      var resultPath = Path.Combine(OutputFolder, "result");

      // Usa un'implementazione conosciuta di ICreateStreamProvider
      ICreateStreamProvider provider = new FileCreateStreamProvider(resultPath);
...
Converti la sorgente HTML presentata da percorso file completo a DOCX. Il risultato è un dato di output generato dall'implementazione dell'interfaccia [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/).
...
import com.aspose.html.converters;  
... 
      // Definisci percorso file HTML di origine
      var sourcePath = Path.Combine(InputFolder, "source.html");

      // Definisci il percorso del file di risultato
      var resultPath = Path.Combine(OutputFolder, "result");

      // Usa l'implementazione predefinita di ICreateStreamProvider
      ICreateStreamProvider provider = new FileCreateStreamProvider(resultPath);
...
| configuration | Configuration | La configurazione dell'ambiente. Rappresenta l'oggetto contesto [`configuration`](../../../com.aspose.html/configuration/) che viene utilizzato per impostare le impostazioni dell'ambiente per l'applicazione. |
| options | DocSaveOptions | L'utilizzo dell'oggetto [`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/) consente di regolare il processo di rendering. Per ulteriori informazioni vedere [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/html-to-docx/#convert-html-to-docx-using-docsaveoptions). |
| provider | ICreateStreamProvider | Conosciuto (vedi [`FileCreateStreamProvider`](../../../com.aspose.html.io/filecreatestreamprovider/)) o implementazione personalizzata dell'interfaccia [`ICreateStreamP﻿rovider`](../../../com.aspose.html.io/icreatestreamprovider/). |
...
Converti la sorgente HTML presentata da contenuto inline a DOCX. Il risultato è un dato di output generato dall'implementazione dell'interfaccia [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/).
...
... 
      ...
      // Usa un'implementazione conosciuta di ICreateStreamProvider orientata ai file locali
      ICreateStreamProvider provider = new FileCreateStreamProvider(resultPath);

      // Istanzia l'oggetto predefinito DocSaveOptions
      var options = new DocSaveOptions();
...
Converti la sorgente HTML presentata da [`HTMLDocument`](../../../com.aspose.html/htmldocument/). Il risultato è un file PDF generato dal percorso del file di output.
...
| --- | --- | --- |
| document | HTMLDocument | Sorgente di conversione presentata da [`HTMLDocument`](../../../com.aspose.html/htmldocument/). |
| options | PdfSaveOptions | L'utilizzo dell'oggetto [`PdfSaveOptions`](../../../com.aspose.html.saving/pdfsaveoptions/) consente di regolare il processo di rendering. Per ulteriori informazioni, vedi [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/html-to-pdf/#convert-html-to-pdf-using-pdfsaveoptions). |
...
Il Portable Document Format (PDF) è un tipo di documento creato da Adobe negli anni ’90. Lo scopo di questo formato di file era introdurre uno standard per la rappresentazione di documenti e altri materiali di riferimento in un formato indipendente dal software applicativo, dall'hardware e dal sistema operativo. Un file PDF è un insieme di byte che può essere raggruppato in token secondo le regole sintattiche definite dalle specifiche PDF. Uno o più token vengono combinati per formare entità sintattiche di livello superiore, principalmente oggetti, che sono i valori di dati di base da cui è costruito un documento PDF.
...
Origine della conversione. Rileva un file HTML locale esistente o un URL remoto come origine della conversione. Puoi anche definire contenuto HTML inline come origine della conversione o creare un documento HTML (HTMLDocument) in qualsiasi modo. Risultato della conversione. Definisci il percorso del file di output del risultato o utilizza un'implementazione nota o personalizzata dell'interfaccia [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) come buffer dei dati di output. Crea un nuovo oggetto [`PdfSaveOptions`](../../../com.aspose.html.saving/pdfsaveoptions/) con impostazioni personalizzate o predefinite. Puoi aggiungere anche la [`configuration`](../../../com.aspose.html/configuration/) come parametro opzionale. Usa il metodo ConvertHTML() della classe Converter per salvare l'HTML come risultato PDF con tre o più parametri a seconda dello scenario dell'utente. Convertitori HTML online

Aspose.HTML offre un convertitore online gratuito [HTML to PDF Converter](https://products.aspose.app/html/en/conversion/html-to-pdf) che converte HTML in PDF con alta qualità, semplice e veloce. Basta caricare, convertire i tuoi file e ottenere i risultati in pochi secondi!
...
... 
      ...
      // Crea un documento html in uno dei diversi modi
      using (var document = new HTMLDocument(sourcePath, configuration))
      {
		// Percorso del file risultato del modulo
		...
		// Istanzia il processo di conversione
        Converter.ConvertHTML(document, options, resultPath);
      }
```
...
Converti la sorgente HTML presentata tramite URL. Il risultato è un file pdf creato dal percorso del file di output.
...
import com.aspose.html.converters;  
...      
      // Forma URL di origine basato su file
      var sourceUrl = new Url(Path.Combine(InputFolder, "source.html"));
...
Converti la sorgente HTML presentata da percorso file completo in PDF. Il risultato è un file pdf generato dal percorso del file di output.
...
Converti la sorgente HTML presentata tramite contenuto inline in PDF. Il risultato è un file pdf creato dal percorso del file di output.
...
Converti la sorgente HTML presentata da [`HTMLDocument`](../../../com.aspose.html/htmldocument/) in PDF. Il risultato è il dato di output formato dall'implementazione dell'interfaccia [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/).
...
Converti la sorgente HTML presentata da un percorso file completo in PDF. Il risultato è il dato di output formato dall'implementazione dell'interfaccia [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/).
...
import com.aspose.html.converters;  
... 
   // Crea percorso del file di origine
   var sourcePath = Path.Combine(InputFolder, "source.html");
...
Converti la sorgente HTML presentata da contenuto inline in PDF. Il risultato è il dato di output formato dall'implementazione dell'interfaccia [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/).
...
| baseUri | String | L'URI di base del documento. Verrà combinato con il percorso della directory corrente per formare un URL assoluto. |
| options | PdfSaveOptions | L'utilizzo dell'oggetto [`PdfSaveOptions`](../../../com.aspose.html.saving/pdfsaveoptions/) consente di regolare il processo di rendering. Per ulteriori informazioni, vedi [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/html-to-pdf/#convert-html-to-pdf-using-pdfsaveoptions). |
| provider | ICreateStreamProvider | Conosciuta (vedi [`FileCreateStreamProvider`](../../../com.aspose.html.io/filecreatestreamprovider/)) o implementazione personalizzata dell'interfaccia [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/). |
...
Converti la sorgente HTML presentata da [`HTMLDocument`](../../../com.aspose.html/htmldocument/). Il risultato è un file mhtml (.mht) formato dal percorso del file di output.
...
| --- | --- | --- |
| document | HTMLDocument | Sorgente di conversione presentata da [`HTMLDocument`](../../../com.aspose.html/htmldocument/). |
| options | MHTMLSaveOptions | L'utilizzo dell'oggetto [`MHTMLSaveOptions`](../../../com.aspose.html.saving/mhtmlsaveoptions/) ti consente di regolare il processo di rendering. Per ulteriori informazioni vedi [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/html-to-mhtml/#convert-html-to-mhtml-using-mhtmlsaveoptions). |
| outputPath | String | Percorso completo del file mhtml (.mht) come risultato della conversione in output. |

## Osservazioni

Come convertire HTML in MHTML
...
Origine della conversione. Rileva un file HTML locale esistente o un URL remoto come origine della conversione. Puoi anche definire contenuto HTML inline come origine della conversione o creare un documento HTML ([`HTMLDocument`](../../../com.aspose.html/htmldocument/)) in qualsiasi modo. Risultato della conversione. Definisci il percorso del file di output del risultato o utilizza un'implementazione nota o personalizzata dell'interfaccia [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) come buffer dei dati di output. Crea un nuovo oggetto [`MHTMLSaveOptions`](../../../com.aspose.html.saving/mhtmlsaveoptions/) con impostazioni personalizzate o predefinite. Puoi aggiungere anche la [`configuration`](../../../com.aspose.html/configuration/) come parametro opzionale. Usa il metodo ConvertHTML() della classe Converter per salvare l'HTML come risultato MHTML con tre o più parametri a seconda dello scenario dell'utente. Convertitori HTML online

Aspose.HTML offre un convertitore online gratuito [HTML to MHTML Converter](https://products.aspose.app/html/en/conversion/html-to-mhtml) che converte HTML in MHTML con alta qualità, in modo semplice e veloce. Basta caricare, convertire i tuoi file e ottenere i risultati in pochi secondi!
...
Converti la sorgente HTML presentata da URL. Il risultato è un file mhtml (.mht) generato dal percorso del file di output.
...
Converti la sorgente HTML presentata da percorso file completo in MHTML. Il risultato è un file mhtml (.mht) generato dal percorso del file di output.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| sourcePath | String | Percorso del file HTML di origine. Verrà combinato con il percorso della directory corrente per formare un URL assoluto. |
| options | MHTMLSaveOptions | L'utilizzo dell'oggetto [`MHTMLSaveOptions`](../../../com.aspose.html.saving/mhtmlsaveoptions/) ti consente di regolare il processo di rendering. Per ulteriori informazioni vedi [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/html-to-mhtml/#convert-html-to-mhtml-using-mhtmlsaveoptions). |
| outputPath | String | Percorso completo del file mhtml (.mht) come risultato della conversione in output. |
...
Converti la sorgente HTML presentata tramite contenuto inline in MHTML. Il risultato è un file mhtml (.mht) creato dal percorso del file di output.
...
... 
	...
	// Definisci l'oggetto delle opzioni di salvataggio predefinito
  	var options = new MHTMLSaveOptions();
...
Fonte di conversione. Rileva un file HTML locale esistente o un URL remoto come fonte di conversione. Puoi anche definire contenuto HTML inline come fonte di conversione o creare un documento HTML ([`HTMLDocument`](../../../com.aspose.html/htmldocument/)) in qualsiasi modo. Risultato della conversione. Definisci il percorso del file di output del risultato o utilizza un'implementazione dell'interfaccia [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) nota o personalizzata come buffer dei dati di output. Crea un nuovo oggetto [`MHTMLSaveOptions`](../../../com.aspose.html.saving/mhtmlsaveoptions/) con impostazioni personalizzate o predefinite. Puoi anche aggiungere [`configuration`](../../../com.aspose.html/configuration/) come parametro opzionale. Usa il metodo ConvertHTML() della classe Converter per salvare l'HTML come risultato MHTML con tre o più parametri a seconda dello scenario dell'utente. Convertitori HTML online
...
Converti la sorgente HTML presentata da [`HTMLDocument`](../../../com.aspose.html/htmldocument/). Il risultato è un file markdown (.md) generato dal percorso del file di output.
...
| --- | --- | --- |
| document | HTMLDocument | Sorgente di conversione presentata da [`HTMLDocument`](../../../com.aspose.html/htmldocument/). |
| options | MarkdownSaveOptions | L'utilizzo dell'oggetto [`MarkdownSaveOptions`](../../../com.aspose.html.saving/markdownsaveoptions/) consente di regolare il processo di rendering. Per ulteriori informazioni, consulta la [Documentazione Aspose](https://docs.aspose.com/html/net/converting-between-formats/html-to-markdown/#convert-html-to-markdown-using-markdownsaveoptions). |
| outputPath | String | Percorso completo del file md come risultato della conversione. |
...
Fonte di conversione. Rileva un file HTML locale esistente o un URL remoto come fonte di conversione. Puoi anche definire contenuto HTML inline come fonte di conversione o creare un documento HTML ([`HTMLDocument`](../../../com.aspose.html/htmldocument/)) in qualsiasi modo. Risultato della conversione. Definisci il percorso del file di output del risultato o utilizza un'implementazione dell'interfaccia [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) nota o personalizzata come buffer dei dati di output. Crea un nuovo oggetto [MarkdownSaveOptions](https://apireference.aspose.com/html/net/aspose.html.saving/markdownsaveoptions) con impostazioni personalizzate o predefinite. Puoi anche aggiungere [`configuration`](../../../com.aspose.html/configuration/) come parametro opzionale. Usa il metodo ConvertHTML() della classe Converter per salvare l'HTML come risultato Markdown con tre o più parametri a seconda dello scenario dell'utente. Convertitori HTML online

Aspose.HTML offre un [HTML to Markdown](https://products.aspose.app/html/en/conversion/html-to-md) gratuito online che converte HTML in MD con alta qualità, in modo semplice e veloce. Basta caricare, convertire i tuoi file e ottenere i risultati in pochi secondi!
...
... 
		...
		using (HTMLDocument document = new HTMLDocument(sourcePath, new Configuration()))
		{
			// Definisci l'istanza dell'oggetto delle opzioni di salvataggio
...
Converti la sorgente HTML presentata da URL. Il risultato è un file markdown (.md) generato dal percorso del file di output.
...
Converti la sorgente HTML presentata da percorso file completo in Markdown. Il risultato è un file markdown (.md) generato dal percorso del file di output.
...
Converti la sorgente HTML presentata tramite contenuto inline in Markdown. Il risultato è un file mhtml (.mht) creato dal percorso del file di output.
...
Converti la sorgente HTML presentata da [`HTMLDocument`](../../../com.aspose.html/htmldocument/). Il risultato è un file xps generato dal percorso del file di output.
...
| --- | --- | --- |
| document | HTMLDocument | Sorgente di conversione presentata da [`HTMLDocument`](../../../com.aspose.html/htmldocument/). |
| options | XpsSaveOptions | L'utilizzo dell'oggetto [`XpsSaveOptions`](../../../com.aspose.html.saving/xpssaveoptions/) consente di regolare il processo di rendering. Per ulteriori informazioni, consulta la [Documentazione Aspose](https://docs.aspose.com/html/net/converting-between-formats/html-to-xps/#convert-html-to-xps-using-xpssaveoptions). |
...
Fonte di conversione. Rileva un file HTML locale esistente o un URL remoto come fonte di conversione. Puoi anche definire contenuto HTML inline come fonte di conversione o creare un documento HTML (HTMLDocument) in qualsiasi modo. Risultato della conversione. Definisci il percorso del file di output del risultato o utilizza un'implementazione dell'interfaccia [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) nota o personalizzata come buffer dei dati di output. Crea un nuovo oggetto [`XpsSaveOptions`](../../../com.aspose.html.saving/xpssaveoptions/) con impostazioni personalizzate o predefinite. Puoi anche aggiungere [`configuration`](../../../com.aspose.html/configuration/) come parametro opzionale. Usa il metodo ConvertHTML() della classe Converter per salvare l'HTML come risultato XPS con tre o più parametri a seconda dello scenario dell'utente. Convertitori HTML online

Aspose.HTML offre un [HTML to XPS Converter](https://products.aspose.app/html/en/conversion/html-to-xps) gratuito online che converte HTML in XPS con alta qualità, in modo semplice e veloce. Basta caricare, convertire i tuoi file e ottenere i risultati in pochi secondi!
...
Converti la sorgente HTML presentata tramite URL. Il risultato è un file xps creato dal percorso del file di output.
...
Converti la sorgente HTML presentata da percorso file completo in XPS. Il risultato è un file xps generato dal percorso del file di output.
...
Converti la sorgente HTML presentata tramite contenuto inline in XPS. Il risultato è un file xps creato dal percorso del file di output.
...
... 
	...
	// Crea documento HTML in uno dei diversi modi
   	using (HTMLDocument document = new HTMLDocument(sourcePath, new Configuration()))
   	{
		...
		// Usa una delle implementazioni note di ICreateStreamProvider
  		ICreateStreamProvider provider = new FileCreateStreamProvider(resultPath);
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| url | Url | URL della sorgente HTML - fornisce una rappresentazione oggetto di un identificatore universale (URL). |
| configuration | Configuration | La configurazione dell'ambiente. Rappresenta l'oggetto contesto [`configuration`](../../../com.aspose.html/configuration/) che viene utilizzato per impostare le impostazioni dell'ambiente per l'applicazione. |
| options | XpsSaveOptions | L'utilizzo dell'oggetto [`XpsSaveOptions`](../../../com.aspose.html.saving/xpssaveoptions/) consente di regolare il processo di rendering. |
| provider | ICreateStreamProvider | Implementazione dell'[`interface`](../../../com.aspose.html.io/icreatestreamprovider/), che verrà utilizzata per ottenere un flusso di output. |
...
Converti la sorgente HTML presentata dal percorso completo del file in XPS. Il risultato sono i dati di output generati dall'implementazione dell'interfaccia [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/).
...
Converti la sorgente HTML presentata tramite contenuto inline in XPS. Il risultato è dato di output generato dall'implementazione dell'interfaccia [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/).
...
Aspose.HTML offre un convertitore online gratuito [HTML to XPS](https://products.aspose.app/html/en/conversion/html-to-xps) che converte HTML in XPS con alta qualità, in modo semplice e veloce. Basta caricare, convertire i tuoi file e ottenere i risultati in pochi secondi!
...
Converti la sorgente HTML presentata da [`HTMLDocument`](../../../com.aspose.html/htmldocument/). Il risultato è un file immagine generato dal percorso del file di output.
...
| --- | --- | --- |
| document | HTMLDocument | Sorgente di conversione presentata da [`HTMLDocument`](../../../com.aspose.html/htmldocument/). |
| options | ImageSaveOptions | L'uso dell'oggetto [`ImageSaveOptions`](../../../com.aspose.html.saving/imagesaveoptions/) consente di regolare il processo di rendering. |
| outputPath | String | Percorso completo del file immagine come risultato della conversione. |

## Osservazioni

Come convertire HTML in immagine
...
Fonte di conversione. Rileva un file HTML locale esistente o un URL remoto come fonte di conversione. Puoi anche definire contenuto HTML inline come fonte di conversione o creare un documento HTML (HTMLDocument) in qualsiasi modo. Risultato della conversione. Definisci il percorso del file di output del risultato o utilizza un'implementazione dell'interfaccia [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) nota o personalizzata come buffer di dati di output. Crea un nuovo oggetto [`ImageSaveOptions`](../../../com.aspose.html.saving/imagesaveoptions/) con il [`ImageFormat`](../../../com.aspose.html.rendering.image/imageformat/) richiesto. Per impostazione predefinita, la proprietà Format è PNG. Puoi anche aggiungere la [`configuration`](../../../com.aspose.html/configuration/) come parametro opzionale. Usa il metodo ConvertHTML() della classe Converter per salvare l'HTML come immagine con tre o più parametri a seconda dello scenario dell'utente. Convertitori HTML online

Aspose.HTML offre un convertitore online gratuito [HTML to PNG Converter](https://products.aspose.app/html/en/conversion/html-to-png) che converte HTML in immagini con alta qualità, in modo semplice e veloce. Basta caricare, convertire i tuoi file e ottenere i risultati in pochi secondi!
...
Converti la sorgente HTML presentata da URL. Il risultato è un file immagine generato dal percorso del file di output.
...
| --- | --- | --- |
| url | Url | URL della sorgente HTML - fornisce una rappresentazione oggetto di un identificatore universale (URL). |
| options | ImageSaveOptions | L'uso dell'oggetto [`ImageSaveOptions`](../../../com.aspose.html.saving/imagesaveoptions/) consente di regolare il processo di rendering. Puoi specificare la [`page size`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/), i [`margins`](../../../com.aspose.html.drawing/page/margin/), il [`CSS media-type`](../../../com.aspose.html.rendering/mediatype/), ecc. |
| outputPath | String | Percorso completo del file immagine come risultato della conversione. |
...
| url | Url | URL della sorgente HTML - fornisce una rappresentazione oggetto di un identificatore universale (URL). |
| configuration | Configuration | La configurazione dell'ambiente. Rappresenta l'oggetto contesto [`configuration`](../../../com.aspose.html/configuration/) che viene utilizzato per impostare le impostazioni dell'ambiente per l'applicazione. |
| options | ImageSaveOptions | L'uso dell'oggetto ImageSaveOptions consente di regolare il processo di rendering. Puoi specificare la [`page size`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/), i [`margins`](../../../com.aspose.html.drawing/page/margin/), il [`CSS media-type`](../../../com.aspose.html.rendering/mediatype/), ecc. |
| outputPath | String | Percorso completo del file immagine come risultato della conversione. |
...
Converti la sorgente HTML presentata da percorso file completo in immagine. Il risultato è un file immagine generato dal percorso del file di output.
...
| --- | --- | --- |
| sourcePath | String | Percorso del file HTML di origine. Verrà combinato con il percorso della directory corrente per formare un URL assoluto. |
| options | ImageSaveOptions | Per saperne di più sulla classe [`ImageSaveOptions`](../../../com.aspose.html.saving/imagesaveoptions/) leggi l'articolo [Fine-Tuning Converters](https://docs.aspose.com/html/net/converting-between-formats/fine-tuning-converters/). |
| outputPath | String | Percorso completo del file immagine come risultato della conversione. |
...
... 
	...
	// Definisci l'istanza dell'oggetto delle opzioni di salvataggio. PNG è il formato immagine predefinito.
...
Converti la sorgente HTML presentata tramite contenuto inline in immagine. Il risultato è un file immagine creato dal percorso del file di output.
...
| contenuto | String | Stringa come contenuto HTML inline. |
| baseUri | String | L'URI di base del documento. Verrà combinato con il percorso della directory corrente per formare un URL assoluto. |
| options | ImageSaveOptions | Nuove opzioni immagine create, come formato, risoluzione, ecc. Vedi la classe [`ImageSaveOptions`](../../../com.aspose.html.saving/imagesaveoptions/) e la [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/html-to-jpg/#output-stream-providers). |
| outputPath | String | Percorso completo del file immagine come risultato della conversione. |
...
| configuration | Configuration | La configurazione dell'ambiente. Rappresenta l'oggetto contesto [`configuration`](../../../com.aspose.html/configuration/) che viene utilizzato per impostare le impostazioni dell'ambiente per l'applicazione. |
| options | ImageSaveOptions | L'uso dell'oggetto ImageSaveOptions consente di regolare il processo di rendering. Puoi specificare la [`page size`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/), i [`margins`](../../../com.aspose.html.drawing/page/margin/), il [`CSS media-type`](../../../com.aspose.html.rendering/mediatype/), ecc. |
| provider | ICreateStreamProvider | Implementazione dell'interfaccia, che sarà usata per ottenere un flusso di output. Maggiori informazioni sui provider sono disponibili nella [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/html-to-jpg/#output-stream-providers). |
...
Converti la sorgente HTML presentata tramite percorso file completo in immagine. Il risultato è dato di output generato dall'implementazione dell'interfaccia [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/).
...
Converti la sorgente HTML presentata tramite contenuto inline in immagine. Il risultato è dato di output generato dall'implementazione dell'interfaccia [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/).
...
| contenuto | String | Stringa come contenuto HTML inline. |
| baseUri | String | L'URI di base del documento. Verrà combinato con il percorso della directory corrente per formare un URL assoluto. |
| configuration | Configuration | La configurazione dell'ambiente. Rappresenta l'oggetto di contesto [`configuration `](../../../com.aspose.html/configuration/) che viene usato per impostare le impostazioni dell'ambiente per l'applicazione. |
| options | ImageSaveOptions | L'uso dell'oggetto ImageSaveOptions consente di regolare il processo di rendering. Puoi specificare la [`page size`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/), i [`margins`](../../../com.aspose.html.drawing/page/margin/), il [`CSS media-type`](../../../com.aspose.html.rendering/mediatype/), ecc. |
| provider | ICreateStreamProvider | Implementazione della [`interface`](../../../com.aspose.html.io/icreatestreamprovider/) che sarà usata per ottenere un flusso di output. Maggiori informazioni sui provider sono disponibili nella [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/html-to-jpg/#output-stream-providers). |
...
Converti il documento html in testo. Il risultato è un file TXT.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| documento | HTMLDocument | Fonte di conversione. |
| options | TextSaveOptions | Opzioni di conversione. |
...
| --- | --- | --- |
| url | Url | L'URL del documento. |
| configurazione | Configurazione | La configurazione dell'ambiente. |
| options | TextSaveOptions | Opzioni di conversione. |
| outputPath | String | Percorso del file di output. |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| contenuto | String | Contenuto HTML inline di tipo stringa. |
| baseUri | String | L'URI di base del documento. Verrà combinato con il percorso della directory corrente per formare un URL assoluto. |
| options | TextSaveOptions | Opzioni di conversione. |
| outputPath | String | Percorso del file di output. |
