...
description: "Metodo Converter. Converte la sorgente EPUB presentata tramite stream di input dati. Il risultato è un file generato dal percorso del file di output."
type: docs
...
Converti la sorgente EPUB fornita tramite stream di dati di input. Il risultato è un file generato dal percorso del file di output.
...
EPUB è un formato di file per e-book che fornisce un formato di pubblicazione digitale standard. È stato creato dall'International Digital Publishing Forum (IDPF) e ora è supportato da molti e-reader e applicazioni software.

Convertire i file EPUB nel formato PNG può essere utile se devi includere i file in una presentazione PowerPoint o inviarli via email. Converti i file nel formato immagine e usali come desideri! Puoi utilizzare parametri di conversione aggiuntivi per ottenere il risultato desiderato.

Il punto forte principale di Aspose.HTML è la funzionalità di conversione. EPUB è un formato basato su XML aperto per libri e pubblicazioni digitali, che può essere visualizzato e letto su smartphone, tablet e computer. Il pacchetto com.aspose.html.converters implementa un facile accesso ai metodi di conversione. Offre un'ampia gamma di conversioni [EPUB](https://docs.fileformat.com/ebook/epub/) verso formati popolari, come [PDF](https://docs.fileformat.com/pdf/), [XPS](https://docs.fileformat.com/page-description-language/xps/), [DOCX](https://docs.fileformat.com/word-processing/docx/), [JPEG](https://docs.fileformat.com/image/jpeg/), [PNG](https://docs.fileformat.com/image/png/), [BMP](https://docs.fileformat.com/image/bmp/), [TIFF](https://docs.fileformat.com/image/tiff/), e [GIF](https://docs.fileformat.com/image/gif/).
...
Per convertire EPUB in formato immagine, dovresti seguire alcuni passaggi:

Definisci l'Url basandoti sul file EPUB esistente nel percorso specificato. Definisci il percorso del file di output risultato. Crea un nuovo oggetto [`ImageSaveOptions`](../../../com.aspose.html.saving/imagesaveoptions/) con il formato immagine richiesto. Per impostazione predefinita, la proprietà Format è PNG. Usa il metodo ConvertEPUB() della classe Converter per salvare EPUB come immagine. È necessario anche passare l'oggetto ImageSaveOptions e l'oggetto Configuration alla conversione immagine. Convertitori EPUB online

Aspose.HTML offre un convertitore online gratuito [EPUB to PNG](https://products.aspose.app/html/en/conversion/epub-to-png) che converte EPUB in immagine PNG con alta qualità, in modo semplice e veloce. Basta caricare, convertire i tuoi file e ottenere i risultati in pochi secondi!
...
Converti la sorgente EPUB presentata da percorso file completo. Il risultato è un file immagine generato dal percorso file di output. Il formato dell'immagine è specificato dall'oggetto ImageSaveOptions.
...
// Crea il percorso del file di risultato di output
var resultPath = Path.Combine(OutputFolder, "sample.png"); 
...
Converti la sorgente EPUB definita da URL. Il risultato è un file immagine generato dal percorso file di output. Il formato dell'immagine è specificato dall'oggetto ImageSaveOptions.
...
Converti la sorgente EPUB presentata da stream di input dati. Il risultato è un file immagine generato dal percorso file di output. Il formato dell'immagine è specificato dall'oggetto ImageSaveOptions.
...
| --- | --- | --- |
| sourcePath | String | Percorso del file sorgente EPUB come parametro di input. |
| configuration | Configuration | La configurazione dell'ambiente. Rappresenta l'oggetto contesto [configuration](https://apireference.aspose.com/html/net/aspose.html/configuration) che viene utilizzato per impostare le impostazioni dell'ambiente per l'applicazione. |
| options | ImageSaveOptions | L'uso dell'oggetto ImageSaveOptions ti consente di regolare il processo di rendering. Puoi specificare la [`page size`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/), i [`margins`](../../../com.aspose.html.drawing/page/margin/), il [`CSS media-type`](../../../com.aspose.html.rendering/mediatype/), ecc. Vedi la classe [`ImageSaveOptions `](../../../com.aspose.html.saving/imagesaveoptions/). |
| outputPath | String | Percorso completo del file immagine come risultato della conversione. |
...
Apri un file EPUB esistente. Nell'esempio, utilizziamo il metodo OpenRead() della classe System.IO.FileStream per aprire e leggere un file EPUB dal file system nel percorso specificato. Usa un'implementazione nota o personalizzata dell'interfaccia [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) come buffer di dati di output. Crea un nuovo oggetto [`ImageSaveOptions`](../../../com.aspose.html.saving/imagesaveoptions/) con il formato immagine richiesto. Per impostazione predefinita, la proprietà Format è PNG. Usa il metodo ConvertEPUB() della classe Converter per salvare EPUB come immagine. È necessario passare l'EPUB inputStream, ImageSaveOptions e lo stream di output al metodo ConvertEPUB() per la conversione da EPUB a immagine. Convertitori EPUB online
...
// Riferisciti all'implementazione dell'interfaccia ICreateStreamProvider  
...
Converti la sorgente EPUB fornita dal percorso file in immagine. Il risultato è un file immagine generato dall'implementazione dell'interfaccia [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/).
...
| options | ImageSaveOptions | Nuove opzioni immagine create come formato, risoluzione, ecc. Vedi la classe [`ImageSaveOptions `](../../../com.aspose.html.saving/imagesaveoptions/) e la [Documentazione Aspose](https://docs.aspose.com/html/net/converting-between-formats/epub-to-png/#save-options). |
| provider | ICreateStreamProvider | Implementazione dell'interfaccia, che verrà utilizzata per ottenere uno stream di output. Per ulteriori informazioni sui provider, vedi la [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-jpg/#output-stream-providers). |
...
Apri un file EPUB esistente. Nell'esempio, utilizziamo il metodo OpenRead() della classe System.IO.FileStream per aprire e leggere un file EPUB dal file system nel percorso specificato. Usa un'implementazione nota o personalizzata dell'interfaccia ICreateStreamProvider come buffer di dati di output. Crea un nuovo oggetto ImageSaveOptions con il formato immagine richiesto. Per impostazione predefinita, la proprietà Format è PNG. Usa il metodo ConvertEPUB() della classe Converter per salvare EPUB come immagine. È necessario passare l'EPUB inputStream, ImageSaveOptions e lo stream di output al metodo ConvertEPUB() per la conversione da EPUB a immagine. Convertitori EPUB online
...
Converti la sorgente epub fornita tramite URL in immagine. Il risultato è un file immagine generato dall'implementazione dell'interfaccia [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/)
...
| configuration | Configuration | La configurazione dell'ambiente. Rappresenta l'oggetto contesto [`configuration`](../../../com.aspose.html/configuration/) che viene utilizzato per impostare le impostazioni dell'ambiente per l'applicazione. |
| options | ImageSaveOptions | L'uso dell'oggetto ImageSaveOptions consente di regolare il processo di rendering. Puoi specificare la [`page size`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/), i [`margins`](../../../com.aspose.html.drawing/page/margin/), il [`CSS media-type`](../../../com.aspose.html.rendering/mediatype/), ecc. |
| provider | ICreateStreamProvider | Implementazione dell'interfaccia, che verrà utilizzata per ottenere uno stream di output. |
...
Converti la sorgente epub fornita tramite percorso file in immagine. Il risultato è un file immagine generato dall'implementazione dell'interfaccia [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/)
...
| configuration | Configuration | La configurazione dell'ambiente. Rappresenta l'oggetto contesto [`configuration`](../../../com.aspose.html/configuration/) che viene utilizzato per impostare le impostazioni dell'ambiente per l'applicazione. |
| options | ImageSaveOptions | L'uso dell'oggetto ImageSaveOptions consente di regolare il processo di rendering. Puoi specificare la [`page size`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/), i [`margins`](../../../com.aspose.html.drawing/page/margin/), il [`CSS media-type`](../../../com.aspose.html.rendering/mediatype/), ecc. |
| provider | ICreateStreamProvider | Implementazione dell'interfaccia, che verrà utilizzata per ottenere uno stream di output. Vedi l'esempio di implementazione di ICreateStreamProvider nella [documentazione Aspose](https://docs.aspose.com/html/net/converting-between-formats/epub-to-jpg/#output-stream-providers). |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| stream | Stream | Stream di input come sorgente di conversione. Vedi la specifica dello Stream nella [fonte ufficiale](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream?view=net-5.0). |
...
Un file XPS rappresenta file di layout di pagina basati sulle Specifiche XML Paper create da Microsoft. È stato sviluppato come sostituto del formato EMF ed è simile al formato PDF, ma utilizza XML per il layout, l'aspetto e le informazioni di stampa di un documento.

Il punto forte principale di Aspose.HTML è la funzionalità di conversione. EPUB è un formato basato su XML aperto per libri e pubblicazioni digitali, che può essere visualizzato e letto su smartphone, tablet e computer. Il pacchetto com.aspose.html.converters implementa un facile accesso ai metodi di conversione. Offre un'ampia gamma di conversioni [EPUB](https://docs.fileformat.com/ebook/epub/) verso formati popolari, come [PDF](https://docs.fileformat.com/pdf/), [XPS](https://docs.fileformat.com/page-description-language/xps/), [DOCX](https://docs.fileformat.com/word-processing/docx/), [JPEG](https://docs.fileformat.com/image/jpeg/), [PNG](https://docs.fileformat.com/image/png/), [BMP](https://docs.fileformat.com/image/bmp/), [TIFF](https://docs.fileformat.com/image/tiff/), e [GIF](https://docs.fileformat.com/image/gif/).

Questa sezione fornisce informazioni sull'elenco degli scenari di conversione EPUB supportati e su come eseguirli utilizzando la classe [`Converter`](../) che raggruppa tutte le operazioni di conversione di basso livello in un'unica classe per renderle comode e facili da usare. Nella guida specifica per l'EPUB Converter XPS trovi l'articolo seguente:
...
Apri un file EPUB esistente. Per esempio, possiamo definire il percorso del file sorgente come primo parametro del metodo ConvertEPUB. Usa un'implementazione conosciuta o personalizzata dell'interfaccia ICreateStreamProvider come buffer di dati di output. Possiamo utilizzare un'alternativa più semplice come percorso del file di output. Crea un nuovo oggetto [`XpsSaveOptions`](../../../com.aspose.html.saving/xpssaveoptions/) con i parametri preferiti, come dimensione della pagina, margini, CSS, ecc. È possibile utilizzare l'istanza predefinita della classe XpsSaveOptions. Usa il metodo ConvertEPUB() della classe statica Converter per salvare l'EPUB come file xps. È necessario passare i dati sorgente EPUB, [`XpsSaveOptions`](../../../com.aspose.html.saving/xpssaveoptions/), e il buffer di dati di output in qualsiasi forma per avviare il processo di conversione. Convertitore EPUB in XPS online
...
Converti la sorgente epub presentata da URL in file xps definito da percorso completo. Vedi [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-xps/).
...
Apri un file EPUB esistente. Per esempio, possiamo definire il percorso del file sorgente come primo parametro del metodo ConvertEPUB. Usa un'implementazione conosciuta o personalizzata dell'interfaccia `ICreateStreamProvider` come buffer di dati di output. Possiamo utilizzare un'alternativa più semplice come percorso del file di output. Crea un nuovo oggetto XpsSaveOptions con i numeri dei parametri preferiti come dimensione della pagina, margini, CSS, ecc. È possibile utilizzare l'istanza predefinita della classe XpsSaveOptions. Usa il metodo ConvertEPUB() della classe statica Converter per salvare l'EPUB come file xps. È necessario fornire la data di origine dell'EPUB, XpsSaveOptions e il buffer di dati di output in qualsiasi forma per avviare il processo di conversione.

Convertitore EPUB in XPS online
...
Converti la sorgente EPUB fornita tramite l'[Stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream?view=net-5.0) di input in xps. Il risultato è un dato di output xps definito da un'implementazione conosciuta o personalizzata dell'interfaccia [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/).
...
...
 ...
 // Ottieni l'accesso al flusso di memoria che contiene i dati del risultato
...
Converti la sorgente EPUB fornita tramite il percorso del file EPUB di input in xps. Il risultato è un dato di output xps definito da un'implementazione conosciuta o personalizzata dell'interfaccia [`ICreateStreamProvider `](../../../com.aspose.html.io/icreatestreamprovider/).
...
Converti la sorgente EPUB fornita tramite URL in un file xps definito da un percorso completo. Il risultato è un dato di output xps definito da un'implementazione conosciuta o personalizzata dell'interfaccia [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/).
...
Converti il file sorgente EPUB fornito tramite percorso completo in DOCX. Il risultato è un file docx definito dal percorso completo.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| stream | Stream | Sorgente di conversione fornita tramite l'[Stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream?view=net-5.0) di input. |
| options | DocSaveOptions | Opzioni di conversione. L'utilizzo dell'oggetto [`DocSaveOptions `](../../../com.aspose.html.saving/docsaveoptions/) consente di regolare il processo di rendering; è possibile specificare la [`dimensione pagina`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/), i [`margini`](../../../com.aspose.html.drawing/page/margin/), il [`tipo di media CSS`](../../../com.aspose.html.rendering/mediatype/), ecc. Vedi la [Documentazione Aspose](https://docs.aspose.com/html/net/converting-between-formats/epub-to-docx/#save-options). |
...
DOCX è un formato ben noto per i documenti Microsoft Word. Questo formato è popolare perché supporta un'ampia gamma di funzionalità di formattazione e offre agli utenti una varietà di opzioni per scrivere qualsiasi tipo di documento. I file DOCX possono essere aperti con Word 2007 e versioni successive ma non con le versioni precedenti di MS Word, che supportano le estensioni di file DOC. La conversione da EPUB a DOCX è spesso necessaria per sfruttare il formato DOCX per compiti specifici dell'utente.
...
Apri un file EPUB esistente. Per esempio, possiamo definire il percorso del file sorgente come primo parametro del metodo ConvertEPUB. Usa un'implementazione nota o personalizzata dell'interfaccia ICreateStreamProvider come buffer di dati di output. Possiamo anche utilizzare un'alternativa più semplice come percorso del file di output. Crea un nuovo oggetto DocSaveOptions con diversi parametri preferiti come dimensione pagina, margini, CSS, ecc. È possibile utilizzare l'istanza predefinita della classe DocSaveOptions. Usa il metodo ConvertEPUB() della classe statica Converter per salvare l'EPUB come file docx. È necessario passare la data sorgente EPUB come percorso file o stream di input, così come Url, istanza di DocSaveOptions e buffer di dati di output in qualsiasi forma per avviare il processo di conversione. Puoi utilizzare la configuration che rappresenta l'oggetto di contesto [`configuration`](../../../com.aspose.html/configuration/) usato per impostare le impostazioni ambientali dell'applicazione. Convertitore EPUB in DOCX online

Aspose.HTML offre un convertitore online gratuito [EPUB in DOC](https://products.aspose.app/html/en/conversion/epub-to-docx)[X](https://products.aspose.app/html/en/conversion/epub-to-xps) che converte i file EPUB in DOCX con alta qualità, in modo semplice e veloce. Basta caricare, convertire i tuoi file e ottenere i risultati in pochi secondi!
...
| --- | --- | --- |
| sourcePath | String | Percorso del file sorgente EPUB come parametro di input. |
| options | DocSaveOptions | Opzioni di conversione. L'utilizzo dell'oggetto [`DocSaveOptions `](../../../com.aspose.html.saving/docsaveoptions/) consente di regolare il processo di rendering; è possibile specificare la [`dimensione pagina`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/),[` margini`](../../../com.aspose.html.drawing/page/margin/), il [`tipo di media CSS`](../../../com.aspose.html.rendering/mediatype/), ecc. Vedi la [Documentazione Aspose](https://docs.aspose.com/html/net/converting-between-formats/epub-to-docx/#save-options). |
| outputPath | String | Percorso completo del file .docx come risultato della conversione in output. |
...
| --- | --- | --- |
| sourceUrl | Url | URL sorgente EPUB - fornisce una rappresentazione oggetto di un identificatore universale (URL). |
| options | DocSaveOptions | L'utilizzo di [`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/) consente di regolare il processo di rendering; è possibile specificare la [`dimensione pagina`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/), i [`margini`](../../../com.aspose.html.drawing/page/margin/), le [`risoluzioni`](../../../com.aspose.html.rendering.image/imagerenderingoptions/), il [`tipo di media CSS`](../../../com.aspose.html.rendering/mediatype/), ecc. Vedi la [Documentazione Aspose](https://docs.aspose.com/html/net/converting-between-formats/epub-to-docx/#save-options). |
| outputPath | String | Percorso completo del file .docx come risultato della conversione in output. |
...
| sourcePath | String | Percorso del file sorgente EPUB. Verrà combinato con il percorso della directory corrente per formare un URL assoluto. |
| configuration | Configuration | La configurazione dell'ambiente. Rappresenta l'oggetto contesto [`configuration`](../../../com.aspose.html/configuration/) che viene utilizzato per impostare le impostazioni dell'ambiente per l'applicazione. |
| options | DocSaveOptions | Opzioni di conversione. L'utilizzo dell'oggetto [DocSaveOptions ](https://apireference.aspose.com/html/net/aspose.html.saving/docsaveoptions) consente di regolare il processo di rendering; è possibile specificare la dimensione pagina, i margini, il CSS, ecc. Vedi la [Documentazione Aspose](https://docs.aspose.com/html/net/converting-between-formats/epub-to-docx/#save-options). |
| outputPath | String | Percorso completo del file .docx come risultato della conversione in output. |
...
Converti la sorgente EPUB presentata tramite percorso file completo in DOCX. Il risultato è costituito dai dati di output generati dall'implementazione di [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/).
...
| --- | --- | --- |
| sourceUrl | Url | URL sorgente EPUB - fornisce una rappresentazione oggetto di un identificatore universale (URL). |
| options | DocSaveOptions | L'utilizzo di [`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/) consente di regolare il processo di rendering; è possibile specificare la dimensione pagina, i margini, le risoluzioni, il CSS, ecc. Vedi la [Documentazione Aspose](https://docs.aspose.com/html/net/converting-between-formats/epub-to-docx/#save-options). |
| provider | ICreateStreamProvider | Implementazione dell'interfaccia [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) che verrà utilizzata per ottenere uno stream di output. Vedi esempio avanzato nella [Documentazione Aspose](https://docs.aspose.com/html/net/converting-between-formats/epub-to-docx/#output-stream-providers). |
...
Apri un file EPUB esistente. Per esempio, possiamo definire il percorso del file sorgente come primo parametro del metodo ConvertEPUB. Usa un'implementazione nota o personalizzata dell'interfaccia ICreateStreamProvider come buffer di dati di output. Possiamo anche utilizzare un'alternativa più semplice come percorso del file di output. Crea un nuovo oggetto [`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/) con diversi parametri preferiti come dimensione pagina, margini, CSS, ecc. È possibile utilizzare l'istanza predefinita della classe DocSaveOptions. Usa il metodo ConvertEPUB() della classe statica Converter per salvare l'EPUB come file docx. È necessario passare la data sorgente EPUB come percorso file o stream di input, così come Url, istanza di DocSaveOptions e buffer di dati di output in qualsiasi forma per avviare il processo di conversione. Puoi utilizzare la configuration che rappresenta l'oggetto di contesto [`configuration`](../../../com.aspose.html/configuration/) usato per impostare le impostazioni ambientali dell'applicazione. Convertitore EPUB in DOCX online
...
Converti la sorgente EPUB presentata tramite percorso file completo in DOCX. Il risultato è costituito dai dati di output generati dall'implementazione dell'interfaccia [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/).
...
Converti la sorgente EPUB fornita tramite stream di dati di input. Il risultato è un file pdf generato dal percorso del file di output.
...
| options | PdfSaveOptions | Opzioni di conversione. L'utilizzo dell'oggetto [`PdfSaveOption`](../../../com.aspose.html.saving/pdfsaveoptions/) consente di regolare il processo di rendering; è possibile specificare la [`dimensione pagina`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/), i [`margini`](../../../com.aspose.html.drawing/page/margin/), il [`tipo di media CSS`](../../../com.aspose.html.rendering/mediatype/), ecc. Vedi la [Documentazione Aspose](https://docs.aspose.com/html/net/converting-between-formats/epub-to-pdf/#save-options). |
...
Questa sezione fornisce informazioni sull'elenco degli scenari di conversione EPUB supportati e su come eseguirli utilizzando una classe [`Converter`](../) che raggruppa tutte le operazioni di conversione a basso livello in un'unica classe per renderle comode e facili da usare. Nella guida specifica per il convertitore EPUB in PDF, trovi il seguente articolo:
...
Apri un file EPUB esistente. Per esempio, possiamo definire il percorso del file sorgente come primo parametro del metodo ConvertEPUB. In alternativa possiamo utilizzare uno stream di input o un'istanza di oggetto Url. Usa un'implementazione dell'interfaccia ICreateStreamProvider, nota o personalizzata, come buffer di dati in output. Possiamo usare un'alternativa più semplice come percorso del file di output del risultato. Crea un nuovo oggetto PdfSaveOptions con una serie di parametri preferiti come dimensione della pagina, margini, CSS, ecc. È possibile utilizzare l'istanza predefinita della classe PdfSaveOptions. Usa il metodo ConvertEPUB() della classe statica Converter per salvare l'EPUB come file PDF. È necessario passare la data di origine dell'EPUB come percorso del file o stream di input, così come Url, istanza di PdfSaveOptions e buffer di dati in output in qualsiasi forma per avviare il processo di conversione. Puoi utilizzare la configurazione che rappresenta l'oggetto di contesto [`configuration`](../../../com.aspose.html/configuration/) usato per impostare le impostazioni ambientali dell'applicazione. Convertitore EPUB in PDF online

Aspose.HTML offre un convertitore online gratuito [EPUB to PDF](https://products.aspose.app/html/en/conversion/epub-to-pdf) che converte i file EPUB in PDF con alta qualità, in modo semplice e veloce. Basta caricare, convertire i tuoi file e ottenere i risultati in pochi secondi!
...
// Percorso del file di risultato del modulo  
...
Apri un file EPUB esistente. Per esempio, possiamo definire il percorso del file sorgente come primo parametro del metodo ConvertEPUB. In alternativa possiamo utilizzare uno stream di input o un'istanza di oggetto Url. Usa un'implementazione dell'interfaccia ICreateStreamProvider, nota o personalizzata, come buffer di dati in output. Possiamo usare un'alternativa più semplice come percorso del file di output del risultato. Crea un nuovo oggetto [`PdfSaveOptions`](../../../com.aspose.html.saving/pdfsaveoptions/) con una serie di parametri preferiti come dimensione della pagina, margini, CSS, ecc. È possibile utilizzare l'istanza predefinita della classe PdfSaveOptions. Usa il metodo ConvertEPUB() della classe statica Converter per salvare l'EPUB come file PDF. È necessario passare la data di origine dell'EPUB come percorso del file o stream di input, così come Url, istanza di PdfSaveOptions e buffer di dati in output in qualsiasi forma per avviare il processo di conversione. Puoi utilizzare la configurazione che rappresenta l'oggetto di contesto [`configuration`](../../../com.aspose.html/configuration/) usato per impostare le impostazioni ambientali dell'applicazione. Convertitore EPUB in PDF online
