...
Fonte di conversione. Rileva un file MD locale esistente o crea lo stream di dati di input come fonte di conversione. Risultato della conversione. Puoi ottenere direttamente [`HTMLDocument`](../../../com.aspose.html/htmldocument/) o definire il percorso del file di output del risultato in base alla firma del metodo. Usa il metodo ConvertMarkdown() della classe Converter per salvare MD come risultato html. Puoi anche aggiungere [`configuration`](../../../com.aspose.html/configuration/) come parametro opzionale. Convertitore MD online

Potresti essere interessato anche a un gratuito [MD to HTML Converter](https://products.aspose.app/html/en/conversion/md-to-html) online che converte MD in HTML con alta qualità, in modo semplice e veloce. Basta caricare, convertire i tuoi file e ottenere i risultati in pochi secondi! Inoltre puoi consultare altri convertitori MD online: [MD to PDF](https://products.aspose.app/html/en/conversion/md-to-pdf), [MD to DOCX](https://products.aspose.app/html/en/conversion/md-to-docx), [MD to XPS](https://products.aspose.app/html/en/conversion/md-to-xps) e trovare i relativi [MD to image converters](https://docs.aspose.com/html/net/converting-between-formats/markdown-to-image/).
...
Converti la sorgente MD (markdown) presentata tramite stream di input in html. Il risultato è un file html generato dal percorso del file di output.
...
Converti la sorgente MD (markdown) presentata da un percorso file completo in html. Il risultato è [`HTMLDocument`](../../../com.aspose.html/htmldocument/) che può essere salvato tramite il percorso del file di output.
...
...
      ...
      {
        // Salva il risultato della conversione come file locale
        document.Save(resultPath);
      }
```
...
Converti la sorgente MD (markdown) presentata tramite percorso completo del file in html. Il risultato è un file html generato dal percorso del file di output.
