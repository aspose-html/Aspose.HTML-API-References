...
description: "Metodo Converter. Unisce la sorgente del modello presentata da HTMLDocument con i dati del modello XML JSON. Il risultato è un file html generato dal percorso di output."
type: docs
...
Unisci la sorgente del modello presentata da [`HTMLDocument`](../../../com.aspose.html/htmldocument/) con i dati del modello (XML, JSON). Il risultato è un file html generato dal percorso di output.
...
| options | TemplateLoadOptions | [`TemplateLoadOptions`](../../../com.aspose.html.loading/templateloadoptions/) object instance. Viene utilizzata per determinare se i nomi del modello e degli elementi dati corrispondono, indipendentemente dal maiuscolo/minuscolo (opzioni). |
...
Origine del modello. Definisci la sorgente del modello HTML tramite file, oggetto [`URL`](../../../com.aspose.html/url/), oggetto [`HTMLDocument`](../../../com.aspose.html/htmldocument/) o anche tramite contenuto inline. Risultato della conversione. Puoi ottenere direttamente l'HTMLDocument risultante o definire il percorso del file di output in base alla firma del metodo. Crea un'istanza di [`TemplateLoadOptions`](../../../com.aspose.html.loading/templateloadoptions/). Usa il metodo ConvertTemplate() della classe Converter per unire il modello con i dati. Puoi anche aggiungere [`configuration`](../../../com.aspose.html/configuration/) come parametro opzionale. Codice sorgente
...
...
      ...
      // Definisci un'istanza dell'oggetto TemplateData
      ...
      // Definisci l'oggetto predefinito TemplateLoadOptions
      var options = new TemplateLoadOptions();

      // Definisci il documento HTML come sorgente di conversione
...
import com.aspose.html.converters;  
...
      // Definisci l'URL della sorgente skeleton html del modulo
...
Unisci la sorgente HTML del modello presentata da un percorso completo del file con i dati del modello (XML, JSON). Il risultato è un file html generato dal percorso del file di output.
...
import com.aspose.html.converters;  
...
	  // Definisci il contenuto sorgente inline come modello
      ...
      // Definisci l'output come risultato dell'unione
...
...
   ...
   // Definisci un'istanza dell'oggetto configuration
...
Di seguito il file dati da unire con la sorgente come modello
...
Unisci la sorgente HTML del modello presentata da [`URL`](../../../com.aspose.html/url/) con i dati del modello (XML, JSON). Il risultato è un nuovo [`HTMLDocument`](../../../com.aspose.html/htmldocument/) che può essere salvato come file.
...
Unisci la sorgente HTML del modello presentata da un percorso file completo con i dati del modello (XML, JSON). Il risultato è un nuovo [`HTMLDocument`](../../../com.aspose.html/htmldocument/) che può essere salvato come file.
...
Unisci la sorgente HTML del modello presentata da contenuto inline con i dati del modello (XML, JSON). Il risultato è un nuovo [`HTMLDocument`](../../../com.aspose.html/htmldocument/) che può essere salvato come file.
