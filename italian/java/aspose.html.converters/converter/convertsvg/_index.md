...
| options | XpsSaveOptions | L'utilizzo dell'oggetto [`XpsSaveOptions`](../../../com.aspose.html.saving/xpssaveoptions/) ti consente di regolare il processo di rendering. Per ulteriori informazioni vedi [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/svg-to-xps/#save-options). |
...
La classe Converter offre molteplici conversioni specifiche SVG in XPS. Per convertire SVG in XPS, dovresti seguire uno dei semplici scenari composto da pochi passaggi:

Sorgente di conversione. Rileva un file SVG locale esistente o un [`Url`](../../../com.aspose.html/url/) remoto come sorgente di conversione. Puoi anche definire un [`SVGDocument`](../../../com.aspose.html.dom.svg/svgdocument/) come sorgente di conversione o persino utilizzare contenuto SVG inline presentato da una stringa sorgente. Risultato della conversione. Definisci il percorso del file di output o utilizza un'implementazione dell'interfaccia [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) nota o personalizzata come buffer dei dati di output. Crea un nuovo oggetto [`XpsSaveOptions`](../../../com.aspose.html.saving/xpssaveoptions/) con impostazioni specifiche o predefinite. Puoi aggiungere anche [`configuration`](../../../com.aspose.html/configuration/) come parametro opzionale. Usa il metodo ConvertSVG() della classe Converter per salvare SVG come risultato XPS con tre o più parametri a seconda dello scenario dell'utente. Convertitore SVG online
...
Converti la sorgente SVG presentata tramite contenuto inline in XPS. Il risultato è un dato di output formato dall'implementazione dell'interfaccia [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) .
...
La classe Converter offre diverse conversioni specifiche per SVG in DOCX. Per convertire SVG in DOCX, dovresti seguire uno dei semplici scenari costituiti da pochi passaggi:

Fonte di conversione. Rileva un file SVG locale esistente o un [`Url`](../../../com.aspose.html/url/) remoto come fonte di conversione. Puoi anche definire un [`SVGDocument`](../../../com.aspose.html.dom.svg/svgdocument/) come fonte di conversione o persino utilizzare contenuto SVG inline fornito da una stringa sorgente. Risultato della conversione. Definisci il percorso del file di output o utilizza un'implementazione dell'interfaccia [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) nota o personalizzata come buffer dei dati di output. Crea un nuovo oggetto [`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/) con impostazioni specifiche o predefinite. Puoi aggiungere anche la [`configuration`](../../../com.aspose.html/configuration/) come parametro opzionale. Usa il metodo ConvertSVG() della classe Converter per salvare SVG come risultato DOCX con tre o più parametri a seconda dello scenario dell'utente. Convertitore SVG online

Aspose.HTML offre un [Convertitore SVG in DOCX](https://products.aspose.app/svg/en/conversion/svg) online gratuito che converte SVG in DOCX con alta qualità, in modo semplice e veloce. Basta caricare, convertire i file e ottenere i risultati in pochi secondi!
...
Fonte di conversione. Rileva un file SVG locale esistente o un [`Url`](../../../com.aspose.html/url/) remoto. Puoi anche definire un [`SVGDocument`](../../../com.aspose.html.dom.svg/svgdocument/) come fonte di conversione o persino utilizzare contenuto SVG inline fornito da una stringa sorgente. Risultato della conversione. Definisci il percorso del file di output o utilizza un'implementazione dell'interfaccia [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) nota o personalizzata. Crea un nuovo oggetto [`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/) . Puoi aggiungere anche la [`configuration`](../../../com.aspose.html/configuration/) come parametro opzionale. Usa il metodo ConvertSVG() della classe Converter per salvare SVG come risultato DOCX con tre o più parametri a seconda dello scenario dell'utente. Convertitore SVG online
...
Converti la sorgente SVG presentata tramite percorso file completo in DOCX. Il risultato è un file DOCX formato dal percorso file di output.
...
Converti la sorgente SVG presentata da un percorso file completo in DOCX. Il risultato è un dato di output formato dall'implementazione dell'interfaccia [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) .
...
Converti la sorgente SVG presentata da contenuto inline in DOCX. Il risultato è un dato di output formato dall'implementazione dell'interfaccia [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) .
...
La classe Converter offre diverse conversioni specifiche per SVG in PDF. Per convertire SVG in PDF, dovresti seguire uno dei semplici scenari costituiti da pochi passaggi:
...
Aspose.HTML offre un [Convertitore SVG in PDF](https://products.aspose.app/svg/en/conversion/svg-to-pdf) online gratuito che converte SVG in PDF con alta qualità, in modo semplice e veloce. Basta caricare, convertire i file e ottenere i risultati in pochi secondi!
...
Converti la sorgente SVG presentata tramite percorso file completo in PDF. Il risultato è un file PDF formato dal percorso file di output.
...
Converti la sorgente SVG presentata da [`SVGDocument`](../../../com.aspose.html.dom.svg/svgdocument/) in PDF. Il risultato è un dato di output formato dall'implementazione dell'interfaccia [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) .
...
Converti la sorgente SVG presentata da un percorso file completo in PDF. Il risultato è un dato di output formato dall'implementazione dell'interfaccia [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) .
...
Converti la sorgente SVG presentata da contenuto inline in PDF. Il risultato è un dato di output formato dall'implementazione dell'interfaccia [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) .
...
Converti la sorgente SVG presentata da [`SVGDocument`](../../../com.aspose.html.dom.svg/svgdocument/). Il risultato è un file immagine creato dal percorso del file di output.
...
Consulta [article](https://docs.aspose.com/html/net/converting-between-formats/svg-to-jpg/) dove trovi informazioni su come convertire SVG in JPG utilizzando i metodi ConvertSVG() della classe [`Converter`](../) e su come applicare i parametri [`ImageSaveOptions`](../../../com.aspose.html.saving/imagesaveoptions/) e [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/). Altri articoli relativi a formati immagine popolari: [SVG to PNG conversion](https://docs.aspose.com/html/net/converting-between-formats/svg-to-png/), [SVG to BMP conversion](https://docs.aspose.com/html/net/converting-between-formats/svg-to-bmp/), [SVG to GIF conversion](https://docs.aspose.com/html/net/converting-between-formats/svg-to-gif/) e [SVG to TIFF conversion](https://docs.aspose.com/html/net/converting-between-formats/svg-to-tiff/).

Converti SVG in Immagine

La classe Converter offre molte conversioni specifiche per SVG in immagine nei formati più diffusi. Per convertire SVG in immagine, dovresti seguire uno dei semplici scenari composti da pochi passaggi:

Fonte di conversione. Rileva un file SVG locale esistente o un [`Url`](../../../com.aspose.html/url/) remoto come fonte di conversione. Puoi anche definire un [`SVGDocument`](../../../com.aspose.html.dom.svg/svgdocument/) come fonte di conversione o persino utilizzare contenuto SVG inline presentato da una stringa. Risultato della conversione. Definisci il percorso del file di output o utilizza un'implementazione dell'interfaccia [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) nota o personalizzata come buffer dei dati di output. Crea un nuovo oggetto [`ImageSaveOptions`](../../../com.aspose.html.saving/imagesaveoptions/) con impostazioni specifiche o predefinite. Nota che il formato immagine predefinito è PNG. Puoi anche aggiungere la [`configuration`](../../../com.aspose.html/configuration/) come parametro opzionale. Usa il metodo ConvertSVG() della classe Converter per salvare SVG come risultato immagine con tre o più parametri a seconda dello scenario dell'utente. Convertitore SVG online

Aspose.HTML offre un gratuito [SVG to JPG Converter](https://products.aspose.app/svg/en/conversion/svg-to-jpg) online che converte SVG in JPG con alta qualità, in modo semplice e veloce. Basta caricare, convertire i tuoi file e ottenere i risultati in pochi secondi!

Altri convertitori di immagini popolari per diversi formati possono essere trovati qui: [SVG to PNG Converter](https://products.aspose.app/svg/en/conversion/svg-to-png), [SVG to BMP Converter](https://products.aspose.app/svg/en/conversion/svg-to-bmp), [SVG to GIF Converter](https://products.aspose.app/svg/en/conversion/svg-to-gif) e [SVG to TIFF Converter](https://products.aspose.app/svg/en/conversion/svg-to-tiff).
...
Converti la sorgente SVG presentata da [`URL`](../../../com.aspose.html/url/). Il risultato è un file immagine creato dal percorso del file di output.
...
Converti la sorgente SVG presentata tramite percorso file completo in immagine. Il risultato è un file immagine formato dal percorso file di output.
...
Converti la sorgente SVG presentata da [`SVGDocument`](../../../com.aspose.html.dom.svg/svgdocument/). Il risultato è un file xps creato dal percorso del file di output.
...
Converti la sorgente SVG presentata da [`URL`](../../../com.aspose.html/url/). Il risultato è un file xps creato dal percorso del file di output.
...
Converti la sorgente SVG presentata tramite percorso file completo in XPS. Il risultato è un file XPS formato dal percorso file di output.
