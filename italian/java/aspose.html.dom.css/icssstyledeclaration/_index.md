...
L'interfaccia CSSStyleDeclaration rappresenta un oggetto che è un blocco di dichiarazione CSS e espone informazioni di stile e vari metodi e proprietà relativi allo stile.
...
| [getPropertyPriority](../../com.aspose.html.dom.css/icssstyledeclaration/getpropertypriority/)(String) | Utilizzato per recuperare la priorità di una proprietà CSS (ad esempio il qualificatore "important") se la proprietà è stata impostata esplicitamente in questo blocco di dichiarazione. |
