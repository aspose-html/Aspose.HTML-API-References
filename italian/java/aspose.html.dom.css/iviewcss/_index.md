...
Lo stile CSS per un dato elemento può essere ottenuto utilizzando il metodo IViewCSS.GetComputedStyle().
...
| Nome | Descrizione |
| --- | --- |
| [getComputedStyle](../../com.aspose.html.dom.css/iviewcss/getcomputedstyle/#getcomputedstyle)(Element) | Il metodo IViewCSS.getComputedStyle() restituisce un oggetto contenente i valori di tutte le proprietà CSS di un elemento, dopo aver applicato i fogli di stile attivi e risolto eventuali calcoli di base che quei valori possono contenere. |
| [getComputedStyle](../../com.aspose.html.dom.css/iviewcss/getcomputedstyle/#getcomputedstyle_1)(Element, String) | Il metodo IViewCSS.getComputedStyle() restituisce un oggetto contenente i valori di tutte le proprietà CSS di un elemento, dopo aver applicato i fogli di stile attivi e risolto eventuali calcoli di base che quei valori possono contenere. |
