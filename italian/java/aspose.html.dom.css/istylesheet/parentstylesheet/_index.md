...
L'attributo parentStyleSheet deve restituire il foglio di stile CSS genitore [`CSS style sheet`](../../icssstylesheet/).

## Osservazioni

Questa proprietà restituisce null se il foglio di stile corrente è un foglio di stile di livello superiore o se l'inclusione di fogli di stile non è supportata.
