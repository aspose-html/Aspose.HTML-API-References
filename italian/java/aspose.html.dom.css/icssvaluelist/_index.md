...
Alcune proprietà consentono una lista vuota nella loro sintassi. In tal caso, queste proprietà assumono l'identificatore none. Quindi, una lista vuota indica che la proprietà ha il valore none.
...
| Nome | Descrizione |
| --- | --- |
| [getItem](../../com.aspose.html.dom.css/icssvaluelist/item/) Questo metodo è usato per recuperare un CSSValue tramite indice ordinale. L'ordine in questa collezione rappresenta l'ordine dei valori nella proprietà di stile CSS. Se l'indice è maggiore o uguale al numero di valori nella lista, restituisce null. |
