...
Un valore di colore può opzionalmente essere specificato prima o dopo i valori di lunghezza dell'effetto di ombra. Il valore di colore sarà usato come base per l'effetto di ombra. Se non viene specificato alcun colore, verrà usato invece il valore della proprietà ['color'](https://www.w3.org/TR/1998/REC-CSS2-19980512/colors.html#propdef-color).
