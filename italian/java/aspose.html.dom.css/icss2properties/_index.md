---
title: "Interfaccia ICSS2Properties"
second_title: "Riferimento API Aspose.HTML per Java"
description: "interfaccia com.aspose.html.dom.css.ICSS2Properties. L'interfaccia CSS2Properties rappresenta un meccanismo di comodità per recuperare e impostare le proprietà all'interno di una CSSStyleDeclaration. Gli attributi di questa interfaccia corrispondono a tutte le proprietà specificate in CSS2. Ottenere un attributo di questa interfaccia è equivalente a chiamare il metodo getPropertyValue dell'interfaccia CSSStyleDeclaration. Impostare un attributo di questa interfaccia è equivalente a chiamare il metodo setProperty dell'interfaccia CSSStyleDeclaration."
type: docs

url: /it/java/com.aspose.html.dom.css/icss2properties/
---
## ICSS2Properties interface

L'interfaccia CSS2Properties rappresenta un meccanismo di comodità per recuperare e impostare le proprietà all'interno di un [`CSSStyleDeclaration`](../icssstyledeclaration/). Gli attributi di questa interfaccia corrispondono a tutte le proprietà specificate in CSS2. Ottenere un attributo di questa interfaccia è equivalente a chiamare il metodo getPropertyValue dell'interfaccia [`CSSStyleDeclaration`](../icssstyledeclaration/). Impostare un attributo di questa interfaccia è equivalente a chiamare il metodo setProperty dell'interfaccia [`CSSStyleDeclaration`](../icssstyledeclaration/).
