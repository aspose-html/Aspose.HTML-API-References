...
Nota: Sebbene insertRule() sia esclusivamente un metodo di [`CSSStyleSheet`](../), inserisce in realtà la regola in CSSStyleSheet.cssRules — il suo interno [`CSSRuleList`](../../icssrulelist/).
