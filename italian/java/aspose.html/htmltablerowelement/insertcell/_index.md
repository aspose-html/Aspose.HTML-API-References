...
description: "Metodo HTMLTableRowElement. Inserisce una cella TD vuota in questa riga. Se l'indice è -1 o uguale al numero di celle, la nuova cella viene aggiunta alla fine"
type: docs
...
Inserisci una cella `TD` vuota in questa riga. Se `index` è -1 o uguale al numero di celle, la nuova cella viene aggiunta.
