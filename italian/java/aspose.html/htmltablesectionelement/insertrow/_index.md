...
description: "Metodo HTMLTableSectionElement. Inserisce una riga in questa sezione. La nuova riga viene inserita immediatamente prima della riga corrente con indice specificato in questa sezione. Se l'indice è -1 o uguale al numero di righe in questa sezione, la nuova riga viene aggiunta alla fine"
type: docs
