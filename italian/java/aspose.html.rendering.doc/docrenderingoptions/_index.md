...
description: "classe com.aspose.html.rendering.doc.DocRenderingOptions. Rappresenta le opzioni di rendering per DocDevice"
type: docs

url: /it/java/com.aspose.html.rendering.doc/docrenderingoptions/
---
## DocRenderingOptions class

Rappresenta le opzioni di rendering per [`DocDevice`](../docdevice/).
...
| Nome | Descrizione |
| --- | --- |
| [DocRenderingOptions](docrenderingoptions/#constructor)() | Inizializza una nuova istanza della classe `DocRenderingOptions`. |
| [DocRenderingOptions](docrenderingoptions/#constructor_1)(FontEmbeddingRule) | Inizializza una nuova istanza della classe `DocRenderingOptions` con la regola di incorporamento del font specificata. |
