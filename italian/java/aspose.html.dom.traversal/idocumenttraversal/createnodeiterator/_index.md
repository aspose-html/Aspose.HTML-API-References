...
| --- | --- | --- |
| radice | Node | nodo che verrà iterato insieme ai suoi figli. L'iteratore è inizialmente posizionato appena prima di questo nodo. Le flag whatToShow e il filtro, se presenti, non sono considerati quando si imposta questa posizione. La radice non deve essere null. |
