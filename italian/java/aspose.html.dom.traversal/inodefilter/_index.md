...
| Nome | Descrizione |
| --- | --- |
| [acceptNode](../../com.aspose.html.dom.traversal/inodefilter/acceptnode/)(Node) | Verifica se un nodo specificato è visibile nella vista logica di un TreeWalker o NodeIterator. Questa funzione sarà chiamata dall'implementazione di TreeWalker e NodeIterator; normalmente non viene chiamata direttamente dal codice dell'utente. (Tuttavia potresti farlo se desideri utilizzare lo stesso filtro per guidare la logica della tua applicazione.) |
