...
| [getRoot](../../com.aspose.html.dom.traversal/itraversal/root/) Il nodo radice del NodeIterator, così come specificato al momento della creazione. |
| [getWhatToShow](../../com.aspose.html.dom.traversal/itraversal/whattoshow/) Questo attributo determina quali tipi di nodo sono presentati tramite l'iteratore. L'insieme disponibile di costanti è definito nell'interfaccia NodeFilter. I nodi non accettati da whatToShow saranno ignorati, ma i loro figli potranno comunque essere considerati. Nota che questa esclusione ha precedenza sul filtro, se presente. |
