...
description: "Metodo ICanvasRenderingContext2D. Riporta se il punto specificato è o meno all'interno dell'area contenuta dal tratto di un percorso."
type: docs

url: /it/java/com.aspose.html.dom.canvas/icanvasrenderingcontext2d/ispointinstroke/
---
...
| y | Double | La coordinata Y del punto da controllare. |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| percorso | Path2D | Un percorso Path2D da controllare. |
| x | Double | La coordinata X del punto da verificare. |
| y | Double | La coordinata Y del punto da controllare. |
