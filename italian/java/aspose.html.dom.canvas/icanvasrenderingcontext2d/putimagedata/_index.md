...
| --- | --- | --- |
| imagedata | IImageData | Un oggetto ImageData contenente l'array di valori dei pixel. |
| dx | Double | Posizione orizzontale (coordinata x) in cui posizionare i dati immagine nella canvas di destinazione. |
| dy | Double | Posizione verticale (coordinata y) in cui posizionare i dati immagine nella canvas di destinazione. |
...
| dx | Double | Posizione orizzontale (coordinata x) in cui posizionare i dati immagine nella canvas di destinazione. |
| dy | Double | Posizione verticale (coordinata y) in cui posizionare i dati immagine nella canvas di destinazione. |
| dirtyX | Double | Posizione orizzontale (coordinata x). La coordinata x dell'angolo in alto a sinistra dei tuoi dati Image. Predefinito 0. |
| dirtyY | Double | Posizione verticale (coordinata y). La coordinata y dell'angolo in alto a sinistra dei tuoi dati Image. Predefinito 0. |
