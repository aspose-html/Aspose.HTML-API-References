...
description: "classe com.aspose.html.dom.Entity. Rappresenta un'entità nota, analizzata o non analizzata, in un documento XML."
type: docs
...
| [getInputEncoding](../../com.aspose.html.dom/entity/inputencoding/) Un attributo che specifica la codifica usata per questa entità al momento dell'analisi, quando è un'entità analizzata esterna. È null se è un'entità del sottoinsieme interno o se non è nota. |
...
| [getXmlEncoding](../../com.aspose.html.dom/entity/xmlencoding/) Un attributo che specifica, come parte della dichiarazione del testo, la codifica di questa entità, quando è un'entità analizzata esterna. Altrimenti è null. |
| [getXmlVersion](../../com.aspose.html.dom/entity/xmlversion/) Un attributo che specifica, come parte della dichiarazione del testo, il numero di versione di questa entità, quando è un'entità analizzata esterna. Altrimenti è null. |
