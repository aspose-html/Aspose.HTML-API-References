...
description: "classe com.aspose.html.dom.Entity. Rappresenta un'entità nota, sia analizzata (parsed) che non analizzata (unparsed) in un documento XML."
type: docs

url: /it/java/com.aspose.html.dom/entity/
---
## Entity class

Rappresenta un'entità nota, sia analizzata che non analizzata, in un documento XML.
...
| [getInputEncoding](../../com.aspose.html.dom/entity/inputencoding/) Un attributo che specifica la codifica usata per questa entità al momento dell'analisi, quando è un'entità esterna analizzata. È null se è un'entità del sottoinsieme interno o se non è nota. |
...
| [getNodeName](../../com.aspose.html.dom/entity/nodename/) Il nome di questo nodo, a seconda del suo tipo. |
| [getNodeType](../../com.aspose.html.dom/entity/nodetype/) Un codice che rappresenta il tipo dell'oggetto sottostante. |
...
| [getNotationName](../../com.aspose.html.dom/entity/notationname/) Per le entità non analizzate, il nome della notazione per l'entità. Per le entità analizzate, è null. |
...
| [getPublicId](../../com.aspose.html.dom/entity/publicid/) L'identificatore pubblico associato all'entità se specificato, altrimenti null. |
| [getSystemId](../../com.aspose.html.dom/entity/systemid/) L'identificatore di sistema associato all'entità se specificato, altrimenti null. Può essere un URI assoluto o meno. |
...
| [getXmlEncoding](../../com.aspose.html.dom/entity/xmlencoding/) Un attributo che specifica, come parte della dichiarazione del testo, la codifica di questa entità, quando è un'entità esterna analizzata. È null altrimenti. |
| [getXmlVersion](../../com.aspose.html.dom/entity/xmlversion/) Un attributo che specifica, come parte della dichiarazione del testo, il numero di versione di questa entità, quando è un'entità esterna analizzata. È null altrimenti. |
