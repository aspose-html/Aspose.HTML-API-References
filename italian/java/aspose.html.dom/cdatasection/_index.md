...
description: "com.aspose.html.dom.CDATASection classe. Le sezioni CDATA sono usate per eseguire l'escape di blocchi di testo contenenti caratteri che altrimenti verrebbero considerati markup."
type: docs

url: /it/java/com.aspose.html.dom/cdatasection/
---
## CDATASection class

Le sezioni CDATA sono utilizzate per eseguire l'escape di blocchi di testo contenenti caratteri che altrimenti verrebbero considerati markup.
...
| [getIsElementContentWhitespace](../../com.aspose.html.dom/text/iselementcontentwhitespace/) Restituisce se questo nodo di testo contiene spazi bianchi di contenuto elemento, spesso chiamati in modo improprio "spazi bianchi ignorabili". |
...
| [getNodeName](../../com.aspose.html.dom/cdatasection/nodename/) Il nome di questo nodo, a seconda del suo tipo. |
| [getNodeType](../../com.aspose.html.dom/cdatasection/nodetype/) Un codice che rappresenta il tipo dell'oggetto sottostante. |
| [nodeValue](../../com.aspose.html.dom/text/nodevalue/) { get; set; } | Il valore di questo nodo, a seconda del suo tipo. |
...
| [textContent](../../com.aspose.html.dom/text/textcontent/) { get; set; } | Questo attributo restituisce il contenuto testuale di questo nodo e dei suoi discendenti. Quando è definito come null, impostarlo non ha alcun effetto. All'impostazione, tutti i possibili figli che questo nodo potrebbe avere vengono rimossi e, se la nuova stringa non è vuota o null, viene sostituito da un unico nodo Text contenente la stringa impostata. |
| [getWholeText](../../com.aspose.html.dom/text/wholetext/) Restituisce tutto il testo dei nodi Text logicamente adiacenti a questo nodo, concatenato in ordine di documento. |
...
| [replaceWholeText](../../com.aspose.html.dom/text/replacewholetext/)(String) | Sostituisce il testo del nodo corrente e tutti i nodi di testo logicamente adiacenti con il testo specificato. Tutti i nodi di testo logicamente adiacenti vengono rimossi, incluso il nodo corrente, a meno che non sia stato il destinatario del testo di sostituzione. |
| [splitText](../../com.aspose.html.dom/text/splittext/)(int) | Divide questo nodo in due nodi alla posizione specificata, mantenendo entrambi nell'albero come fratelli. |
| [subStringData](../../com.aspose.html.dom/characterdata/subStringdata/)(int, int) | Estrae un intervallo di dati dal nodo. |
| [toString](../../com.aspose.html.dom/characterdata/toString/)() | Restituisce una String che rappresenta questa istanza. |
