...
description: "classe com.aspose.html.dom.CDATASection. Le sezioni CDATA sono utilizzate per eseguire l'escape di blocchi di testo contenenti caratteri che altrimenti verrebbero considerati markup"
type: docs
...
Le sezioni CDATA sono usate per eseguire l'escape di blocchi di testo contenenti caratteri che altrimenti sarebbero considerati markup.
...
| [textContent](../../com.aspose.html.dom/text/textcontent/) { get; set; } | Questo attributo restituisce il contenuto testuale di questo nodo e dei suoi discendenti. Quando è definito come null, impostarlo non ha alcun effetto. All'impostazione, eventuali figli che questo nodo potrebbe avere vengono rimossi e, se la nuova stringa non è vuota o null, viene sostituito da un unico nodo Text contenente la stringa a cui è impostato questo attributo. |
