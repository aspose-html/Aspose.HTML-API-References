...
description: "com.aspose.html.dom.DOMException classe. L'interfaccia DOMException rappresenta un evento anomalo chiamato eccezione che si verifica come risultato della chiamata a un metodo o dell'accesso a una proprietà di una web API. Questo è fondamentalmente il modo in cui le condizioni di errore sono descritte nelle web API."
type: docs
...
| Nome | Descrizione |
| --- | --- |
| const [ABORT_ERR](../../com.aspose.html.dom/domexception/abort_err/) | L'operazione è stata interrotta. |
...
| const [HIERARCHY_REQUEST_ERR](../../com.aspose.html.dom/domexception/hierarchy_request_err/) | Se un Node viene inserito in un luogo a cui non appartiene. |
...
| const [INVALID_EXPRESSION_ERR](../../com.aspose.html.dom/domexception/invalid_expression_err/) | L'espressione contiene un errore di sintassi o non è altrimenti un'espressione valida secondo le regole del specifico XPathEvaluator o contiene funzioni di estensione specializzate o variabili non supportate da questa implementazione. |
...
| const [NAMESPACE_ERR](../../com.aspose.html.dom/domexception/package_err/) | Se si tenta di creare o modificare un oggetto in un modo non corretto rispetto ai pacchetti. |
| const [NETWORK_ERR](../../com.aspose.html.dom/domexception/network_err/) | Si è verificato un errore di rete. |
| const [NOT_FOUND_ERR](../../com.aspose.html.dom/domexception/not_found_err/) | Se si tenta di fare riferimento a un Node in un contesto in cui non esiste. |
...
| const [NO_DATA_ALLOWED_ERR](../../com.aspose.html.dom/domexception/no_data_allowed_err/) | Se vengono specificati dati per un Node che non supporta i dati. |
...
| const [SECURITY_ERR](../../com.aspose.html.dom/domexception/security_err/) | L'operazione è insicura. |
| const [SYNTAX_ERR](../../com.aspose.html.dom/domexception/syntax_err/) | Se viene specificata una String non valida o illegale. |
...
| const [VALIDATION_ERR](../../com.aspose.html.dom/domexception/validation_err/) | Se una chiamata a un metodo come insertBefore o removeChild rendesse il Node non valido rispetto alla \"validità parziale\", questa eccezione verrebbe sollevata e l'operazione non verrebbe eseguita. Questo codice è usato in [DOM Level 3 Validation]. Fare riferimento a questa specifica per ulteriori informazioni. |
| const [WRONG_DOCUMENT_ERR](../../com.aspose.html.dom/domexception/wrong_document_err/) | Se un Node viene usato in un documento diverso da quello che lo ha creato (che non lo supporta). |
