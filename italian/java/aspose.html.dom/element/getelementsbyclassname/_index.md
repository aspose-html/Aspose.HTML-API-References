...
description: "Metodo Element. Restituisce un oggetto HTMLCollection contenente tutti gli elementi all'interno dell'elemento che hanno tutte le classi specificate nell'argomento"
type: docs
...
Restituisce l'oggetto [`HTMLCollection`](../../../com.aspose.html.collections/htmlcollection/) contenente tutti gli elementi all'interno di [`element`](../) che hanno tutte le classi specificate nell'argomento.
...
Fare riferimento alla [spec](https://dom.spec.whatwg.org/#dom-element-getelementsbyclassname) ufficiale.
...
L'elemento div stilizzato con la classe pStyle...
