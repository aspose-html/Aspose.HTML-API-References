...
description: "Metodo Element. Restituisce un oggetto HTMLCollection contenente tutti gli elementi con un determinato nome di tag in ordine di documento"
type: docs
...
Restituisce l'oggetto [`HTMLCollection`](../../../com.aspose.html.collections/htmlcollection/) contenente tutti i [`elements`](../) con un determinato nome di tag, in ordine di documento.
...
| --- | --- | --- |
| name | String | Il nome del tag. Rappresentazione stringa del nome del tag. |
...
Fai riferimento alla [spec](https://dom.spec.whatwg.org/#dom-element-getelementsbytagname) ufficiale.
