...
description: "classe com.aspose.html.dom.Element. L'interfaccia Element rappresenta un elemento in un documento HTML o XML"
type: docs

url: /it/java/com.aspose.html.dom/element/
---
## Element class
...
| Nome | Descrizione |
| --- | --- |
| [Element](element/)(QualifiedName, Document) | Inizializza una nuova istanza della classe `Element`. Non chiamare direttamente questo costruttore, usa [`CreateElement`](../document/createelement/) o [`CreateElementNS`](../document/createelementns/). |
...
| [getParentElement](../../com.aspose.html.dom/node/parentelement/) La proprietà di sola lettura parentElement dell'interfaccia [`Node`](../node/) restituisce l`Element` genitore del nodo DOM, o null se il nodo non ha genitore o il suo genitore non è un Element DOM. |
...
| [getElementsByClassName](../../com.aspose.html.dom/element/getelementsbyclassname/)(String) | Restituisce un oggetto [`HTMLCollection`](../../com.aspose.html.collections/htmlcollection/) contenente tutti gli elementi all'interno di `element` che possiedono tutte le classi specificate nell'argomento. |
| [getElementsByTagName](../../com.aspose.html.dom/element/getelementsbytagname/)(String) | Restituisce un oggetto [`HTMLCollection`](../../com.aspose.html.collections/htmlcollection/) contenente tutti gli `elements` con un determinato nome di tag, in ordine di documento. |
| [getElementsByTagNameNS](../../com.aspose.html.dom/element/getelementsbytagnamens/)(String, String) | Restituisce un oggetto [`HTMLCollection`](../../com.aspose.html.collections/htmlcollection/) contenente tutti gli `elements` con un determinato nome locale e stringa URI del pacchetto, in ordine di documento. |
...
| [toggleAttribute](../../com.aspose.html.dom/element/toggleattribute/#toggleattribute)(String) | Se force non è fornito, \"toggles\" qualifiedName, rimuovendolo se è presente e aggiungendolo se non è presente. Se force è true, aggiunge qualifiedName. Se force è false, rimuove qualifiedName. |
| [toggleAttribute](../../com.aspose.html.dom/element/toggleattribute/#toggleattribute_1)(String, bool) | Se force non è fornito, \"toggles\" qualifiedName, rimuovendolo se è presente e aggiungendolo se non è presente. Se force è true, aggiunge qualifiedName. Se force è false, rimuove qualifiedName. |
