...
| [getElementsByTagNameNS](../../com.aspose.html.dom/element/getelementsbytagnamens/)(String, String) | Restituisce un oggetto [`HTMLCollection`](../../com.aspose.html.collections/htmlcollection/) contenente tutti gli `elements` con un dato nome locale e stringa URI del pacchetto, in ordine di documento. |
...
| [toggleAttribute](../../com.aspose.html.dom/element/toggleattribute/#toggleattribute)(String) | Se force non è fornito, "toggles" qualifiedName, rimuovendolo se è presente e aggiungendolo se non lo è. Se force è true, aggiunge qualifiedName. Se force è false, rimuove qualifiedName. |
| [toggleAttribute](../../com.aspose.html.dom/element/toggleattribute/#toggleattribute_1)(String, bool) | Se force non è fornito, "toggles" qualifiedName, rimuovendolo se è presente e aggiungendolo se non lo è. Se force è true, aggiunge qualifiedName. Se force è false, rimuove qualifiedName. |
