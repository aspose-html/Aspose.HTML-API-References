...
description: "Metodo Element. Restituisce un oggetto HTMLCollection contenente tutti gli elementi con un nome locale specificato e una stringa URI del pacchetto in ordine di documento"
type: docs
...
Restituisce l'oggetto [`HTMLCollection`](../../../com.aspose.html.collections/htmlcollection/) contenente tutti i [`elements`](../) con un nome locale specificato e una stringa URI del pacchetto in ordine di documento.
...
Il contenuto del tag personalizzato del pacchetto personalizzato va qui...
