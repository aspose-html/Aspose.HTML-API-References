...
description: "classe com.aspose.html.dom.Comment. Eredita da CharacterData e rappresenta il contenuto di un commento, cioè tutti i caratteri tra l'inizio"
type: docs

url: /it/java/com.aspose.html.dom/comment/
---
## Comment class

Eredita da CharacterData e rappresenta il contenuto di un commento, cioè tutti i caratteri compresi tra le virgolette iniziali ''.
...
| [getNodeName](../../com.aspose.html.dom/comment/nodename/) Il nome di questo nodo, a seconda del suo tipo. |
| [getNodeType](../../com.aspose.html.dom/comment/nodetype/) Un codice che rappresenta il tipo dell'oggetto sottostante. |
| [nodeValue](../../com.aspose.html.dom/comment/nodevalue/) { get; set; } | Il valore di questo nodo, a seconda del suo tipo. |
...
| [textContent](../../com.aspose.html.dom/comment/textcontent/) { get; set; } | Questo attributo restituisce il contenuto testuale di questo nodo e dei suoi discendenti. Quando è definito come null, impostarlo non ha alcun effetto. All'impostazione, tutti i possibili figli che questo nodo potrebbe avere vengono rimossi e, se la nuova stringa non è vuota o null, viene sostituito da un unico nodo Text contenente la stringa impostata. |
