...
description: "classe com.aspose.html.dom.ProcessingInstruction. Il ProcessingInstruction rappresenta un'istruzione di elaborazione usata in XML come modo per conservare informazioni specifiche del processore nel testo del documento"
type: docs
...
Il ProcessingInstruction rappresenta una "istruzione di elaborazione", usata in XML come modo per mantenere informazioni specifiche del processore nel testo del documento.
...
| [getTarget](../../com.aspose.html.dom/processinginstruction/target/) Il target di questa istruzione di elaborazione. |
| [textContent](../../com.aspose.html.dom/processinginstruction/textcontent/) { get; set; } | Questo attributo restituisce il contenuto testuale di questo nodo e dei suoi discendenti. Quando è definito come null, impostarlo non ha alcun effetto. All'impostazione, tutti i possibili figli che questo nodo potrebbe avere vengono rimossi e, se la nuova stringa non è vuota o null, viene sostituito da un unico nodo Text contenente la stringa impostata. |
