...
description: "classe com.aspose.html.dom.DocumentType. DocumentType fornisce un'interfaccia all'elenco delle entità definite per il documento"
type: docs

url: /it/java/com.aspose.html.dom/documenttype/
---
## DocumentType class

Il DocumentType fornisce un'interfaccia all'elenco delle entità definite per il documento
...
| Nome | Descrizione |
| --- | --- |
| [DocumentType](documenttype/)(String, String, String, String, Document) | Inizializza una nuova istanza della classe `DocumentType`. |
...
| [getInternalSubset](../../com.aspose.html.dom/documenttype/internalsubset/) Il sottoinsieme interno come Stringa, o null se non esiste. |
...
| [getName](../../com.aspose.html.dom/documenttype/name/) Il nome del DTD; cioè il nome immediatamente successivo alla parola chiave DOCTYPE. |
...
| [getNodeName](../../com.aspose.html.dom/documenttype/nodename/) Il nome di questo nodo, a seconda del suo tipo. |
| [getNodeType](../../com.aspose.html.dom/documenttype/nodetype/) Un codice che rappresenta il tipo dell'oggetto sottostante. |
...
| [getPublicId](../../com.aspose.html.dom/documenttype/publicid/) L'identificatore pubblico del sottoinsieme esterno. |
| [getSystemId](../../com.aspose.html.dom/documenttype/systemid/) L'identificatore di sistema del sottoinsieme esterno. Può essere un URI assoluto o meno. |
...
| [toString](../../com.aspose.html.dom/documenttype/toString/)() | Restituisce una String che rappresenta questa istanza. |
