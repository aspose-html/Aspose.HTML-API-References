...
Viene cercato l'intero documento, incluso il nodo radice. La [`HTMLCollection`](../../../com.aspose.html.collections/htmlcollection/) restituita è live, il che significa che si aggiorna automaticamente per rimanere sincronizzata con l'albero DOM senza dover richiamare nuovamente document.getElementsByTagName().
...
| --- | --- | --- |
| tagname | String | Una String che rappresenta il nome degli elementi. La String speciale "*" rappresenta tutti gli elementi. |

### Valore di ritorno

Una [`HTMLCollection`](../../../com.aspose.html.collections/htmlcollection/) live di elementi trovati nell'ordine in cui compaiono nell'albero.

## Osservazioni

Fare riferimento alla [specifica](https://dom.spec.whatwg.org/#dom-document-getelementsbytagname) ufficiale.
