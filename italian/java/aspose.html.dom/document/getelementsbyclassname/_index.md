...
Quando viene chiamato sull'oggetto document, viene cercato l'intero documento, compreso il nodo radice. È anche possibile chiamare getElementsByClassName() su qualsiasi elemento; restituirà solo gli elementi che sono discendenti dell'elemento radice specificato con i nomi di classe forniti.
...
Consulta la [spec](https://dom.spec.whatwg.org/#dom-document-getelementsbyclassname) ufficiale.
