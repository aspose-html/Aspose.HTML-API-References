...
description: "classe com.aspose.html.dom.Document. Il Document rappresenta l'intero documento HTML, XML o SVG. Concettualmente è la radice dell'albero del documento e fornisce l'accesso primario ai dati del documento"
type: docs
...
| [getLocalName](../../com.aspose.html.dom/node/localname/) Restituisce la parte locale del nome qualificato di questo nodo. Per i nodi di qualsiasi tipo diverso da [`ELEMENT_NODE`](../node/element_node/) e [`ATTRIBUTE_NODE`](../node/attribute_node/) e per i nodi creati con un metodo DOM Level 1, come [`Document.createElement()`](./createelement/), questo è sempre null. |
...
| [createAttribute](../../com.aspose.html.dom/document/createattribute/)(String) | Il metodo Document.createAttribute() crea un nuovo nodo attributo e lo restituisce. L'oggetto creato è un nodo che implementa l'interfaccia [`Attr`](../attr/). Il DOM non impone che tipo di attributi possano essere aggiunti a un particolare elemento in questo modo. |
...
| [createDocumentFragment](../../com.aspose.html.dom/document/createdocumentfragment/)() | Crea un nuovo [`DocumentFragment`](../documentfragment/) vuoto nel quale è possibile aggiungere nodi DOM per costruire un albero DOM off-screen. |
...
| [getElementById](../../com.aspose.html.dom/document/getelementbyid/)(String) | Il metodo getElementById() del Document restituisce un oggetto [`Element`](../element/) che rappresenta l'elemento la cui proprietà id corrisponde alla Stringa specificata. Poiché gli ID degli elementi devono essere unici se specificati, sono un modo utile per accedere rapidamente a un elemento specifico. |
| [getElementsByClassName](../../com.aspose.html.dom/document/getelementsbyclassname/)(String) | Il metodo getElementsByClassName dell'interfaccia `Document` restituisce un oggetto simile a un array di tutti gli elementi figlio che possiedono tutti i nomi di classe forniti. |
...
| [navigate](../../com.aspose.html.dom/document/navigate/#navigate_3)(Stream, String) | Carica il documento dal contenuto specificato e usando baseUri per risolvere le risorse relative, sostituendo il contenuto precedente. Il caricamento del documento inizia dalla posizione corrente nello stream. |
| [navigate](../../com.aspose.html.dom/document/navigate/#navigate_2)(Stream, Url) | Carica il documento dal contenuto specificato e usando baseUri per risolvere le risorse relative, sostituendo il contenuto precedente. Il caricamento del documento inizia dalla posizione corrente nello stream. |
| [navigate](../../com.aspose.html.dom/document/navigate/#navigate_6)(String, String) | Carica il documento dal contenuto specificato e usando baseUri per risolvere le risorse relative, sostituendo il contenuto precedente. |
| [navigate](../../com.aspose.html.dom/document/navigate/#navigate_5)(String, Url) | Carica il documento dal contenuto specificato e usando baseUri per risolvere le risorse relative, sostituendo il contenuto precedente. |
