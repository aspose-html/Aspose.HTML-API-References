...
description: "Metodo Document. Restituisce un elenco di elementi con il nome di tag specificato appartenenti al pacchetto indicato. L'intero documento viene cercato, incluso il nodo radice."
type: docs
...
Restituisce un elenco di elementi con il nome di tag fornito appartenenti al pacchetto specificato. Viene cercato l'intero documento, compreso il nodo radice.
...
| localName | String | Può essere il nome locale degli elementi da cercare o il valore speciale *, che corrisponde a tutti gli elementi. |

### Valore di ritorno

Una [`NodeList`](../../../com.aspose.html.collections/nodelist/) live (ma vedi la nota sotto) degli elementi trovati nell'ordine in cui appaiono nell'albero.

## Osservazioni

Consulta la [spec](https://dom.spec.whatwg.org/#dom-document-getelementsbytagnamens) ufficiale.
