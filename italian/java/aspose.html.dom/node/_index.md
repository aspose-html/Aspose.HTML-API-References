...
description: "classe com.aspose.html.dom.Node. L'interfaccia Node è il tipo di dato principale per l'intero Document Object Model. Rappresenta un singolo nodo nell'albero del documento. Sebbene tutti gli oggetti che implementano l'interfaccia Node espongano metodi per gestire i figli, non tutti gli oggetti che implementano l'interfaccia Node possono avere figli. Per esempio i nodi Text potrebbero non avere figli e aggiungere figli a tali nodi genera un'eccezione DOMException."
type: docs

url: /it/java/com.aspose.html.dom/node/
---
## Node class

L'interfaccia Node è il tipo di dato principale per l'intero Document Object Model. Rappresenta un singolo nodo nell'albero del documento. Sebbene tutti gli oggetti che implementano l'interfaccia Node espongano metodi per gestire i figli, non tutti gli oggetti che implementano l'interfaccia Node possono avere figli. Ad esempio, i nodi [`Text`](../text/) potrebbero non avere figli, e aggiungere figli a tali nodi provoca il sollevamento di una [`DOMException`](../domexception/).

Gli attributi [`nodeName`](./nodename/), [`nodeValue`](./nodevalue/) e gli attributi sono inclusi come meccanismo per accedere alle informazioni del nodo senza effettuare il cast verso l'interfaccia derivata specifica. Nei casi in cui non esista una mappatura evidente di questi attributi per un determinato [`nodeType`](./nodetype/) (ad esempio, nodeValue per un [`Element`](../element/) o attributi per un [`Comment`](../comment/)), questo restituisce null. Si noti che le interfacce specializzate possono contenere meccanismi aggiuntivi e più comodi per ottenere e impostare le informazioni rilevanti.
...
| [getFirstChild](../../com.aspose.html.dom/node/firstchild/) La proprietà di sola lettura firstChild dell'interfaccia `Node` restituisce il primo figlio del nodo nell'albero, o null se il nodo non ha figli. |
| [getLastChild](../../com.aspose.html.dom/node/lastchild/) La proprietà di sola lettura lastChild dell'interfaccia `Node` restituisce l'ultimo figlio del nodo. Se il suo genitore è un elemento, il figlio è generalmente un nodo elemento, un nodo di testo o un nodo commento. Restituisce null se non ci sono elementi figli. |
| [getLocalName](../../com.aspose.html.dom/node/localname/) Restituisce la parte locale del nome qualificato di questo nodo. Per i nodi di qualsiasi tipo diverso da [`ELEMENT_NODE`](./element_node/) e [`ATTRIBUTE_NODE`](./attribute_node/) e per i nodi creati con un metodo DOM Level 1, come [`Document.createElement()`](../document/createelement/), questo è sempre null. |
...
| [getNextSibling](../../com.aspose.html.dom/node/nextsibling/) La proprietà di sola lettura nextSibling dell'interfaccia `Node` restituisce il nodo immediatamente successivo a quello specificato nei [`childNodes`](./childnodes/) del genitore, oppure restituisce null se il nodo specificato è l'ultimo figlio dell'elemento genitore. |
| abstract [getNodeName](../../com.aspose.html.dom/node/nodename/) La proprietà di sola lettura nodeName di Node restituisce il nome del nodo corrente come Stringa. |
| abstract [getNodeType](../../com.aspose.html.dom/node/nodetype/) Un codice che rappresenta il tipo dell'oggetto sottostante. |
| [nodeValue](../../com.aspose.html.dom/node/nodevalue/) { get; set; } | La proprietà nodeValue dell'interfaccia `Node` restituisce o imposta il valore del nodo corrente. |
...
| [getParentElement](../../com.aspose.html.dom/node/parentelement/) La proprietà di sola lettura parentElement dell'interfaccia `Node` restituisce il genitore DOM del nodo, ovvero un [`Element`](../element/), o null se il nodo non ha genitore o se il suo genitore non è un elemento DOM. |
...
| [getPreviousSibling](../../com.aspose.html.dom/node/previoussibling/) La proprietà di sola lettura previousSibling dell'interfaccia `Node` restituisce il nodo immediatamente precedente a quello specificato nella lista dei [`childNodes`](./firstchild/) del genitore, o null se il nodo specificato è il primo nella lista. |
| [textContent](../../com.aspose.html.dom/node/textcontent/) { get; set; } | La proprietà textContent dell'interfaccia `Node` rappresenta il contenuto testuale del nodo e dei suoi discendenti. |
...
| [cloneNode](../../com.aspose.html.dom/node/clonenode/#clonenode)() | Il metodo cloneNode() dell'interfaccia Node restituisce un duplicato del nodo su cui è stato chiamato questo metodo. Il suo parametro controlla se il sottoalbero contenuto in un nodo viene anche clonato o meno. |
| [cloneNode](../../com.aspose.html.dom/node/clonenode/#clonenode_1)(bool) | Il metodo cloneNode() dell'interfaccia Node restituisce un duplicato del nodo su cui è stato chiamato questo metodo. Il suo parametro controlla se il sottoalbero contenuto in un nodo viene anche clonato o meno. |
...
| [hasChildNodes](../../com.aspose.html.dom/node/haschildnodes/)() | Il metodo hasChildNodes() dell'interfaccia Node restituisce un valore booleano che indica se il dato `Node` ha nodi figli o meno. |
...
| [isEqualNode](../../com.aspose.html.dom/node/isequalnode/)(Node) | Il metodo isEqualNode() dell'interfaccia `Node` verifica se due nodi sono uguali. Due nodi sono uguali quando hanno lo stesso tipo, caratteristiche distintive (per gli elementi, ad esempio ID, numero di figli, ecc.), i loro attributi corrispondono, e così via. L'insieme specifico di dati che devono corrispondere varia a seconda del tipo dei nodi. |
...
| Nome | Descrizione |
| --- | --- |
| const [ATTRIBUTE_NODE](../../com.aspose.html.dom/node/attribute_node/) | Un [`Attribute`](../attr/) di un [`Element`](../element/). |
| const [CDATA_SECTION_NODE](../../com.aspose.html.dom/node/cdata_section_node/) | Una [`CDATASection`](../cdatasection/), ad esempio &lt;!CDATA[[ … ]]&gt;. |
| const [COMMENT_NODE](../../com.aspose.html.dom/node/comment_node/) | Un nodo [`Comment`](../comment/), ad esempio &lt;!-- … --&gt;. |
| const [DOCUMENT_FRAGMENT_NODE](../../com.aspose.html.dom/node/document_fragment_node/) | Un nodo [`DocumentFragment`](../documentfragment/). |
| const [DOCUMENT_NODE](../../com.aspose.html.dom/node/document_node/) | Un nodo [`Document`](../document/). |
| const [DOCUMENT_TYPE_NODE](../../com.aspose.html.dom/node/document_type_node/) | Un nodo [`DocumentType`](../documenttype/), ad esempio &lt;!DOCTYPE html&gt;. |
| const [ELEMENT_NODE](../../com.aspose.html.dom/node/element_node/) | Un nodo [`Element`](../element/) come &lt;p&gt; o &lt;div&gt;. |
| const [ENTITY_NODE](../../com.aspose.html.dom/node/entity_node/) | Un nodo [`Entity`](../entity/). |
| const [ENTITY_REFERENCE_NODE](../../com.aspose.html.dom/node/entity_reference_node/) | Un nodo [`EntityReference`](../entityreference/). |
| const [NOTATION_NODE](../../com.aspose.html.dom/node/notation_node/) | Un nodo [`Notation`](../notation/) |
| const [PROCESSING_INSTRUCTION_NODE](../../com.aspose.html.dom/node/processing_instruction_node/) | Una [`ProcessingInstruction`](../processinginstruction/) di un documento XML, come &lt;?xml-stylesheet … ?&gt;. |
| const [TEXT_NODE](../../com.aspose.html.dom/node/text_node/) | Il reale [`Text`](../text/) all'interno di un [`Element`](../element/) o [`Attr`](../attr/). |
