...
description: "Node field. Il testo effettivo all'interno di un Element o Attr"
type: docs

url: /it/java/com.aspose.html.dom/node/text_node/
---
## Node.TEXT_NODE field

Il vero [`Text`](../../text/) all'interno di un [`Element`](../../element/) o [`Attr`](../../attr/).
