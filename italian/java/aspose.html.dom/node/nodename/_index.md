...
description: "Proprietà Node. La proprietà nodeName di sola lettura di Node restituisce il nome del nodo corrente come una String"
type: docs
...
La proprietà nodeName di sola lettura di Node restituisce il nome del nodo corrente come una String.
...
Una String, i valori per i diversi tipi di nodi sono:
