...
description: "classe com.aspose.html.dom.Attr. L'interfaccia Attr rappresenta un attributo in un oggetto Element. Tipicamente i valori consentiti per l'attributo sono definiti in uno schema associato al documento."
type: docs

url: /it/java/com.aspose.html.dom/attr/
---
## Attr class

L'interfaccia Attr rappresenta un attributo in un oggetto Element. Tipicamente i valori consentiti per l'attributo sono definiti in uno schema associato al documento.
...
| [getLocalName](../../com.aspose.html.dom/attr/localname/) Restituisce la parte locale del nome qualificato di questo nodo. Per i nodi di qualsiasi tipo diverso da ELEMENT_NODE e ATTRIBUTE_NODE e per i nodi creati con un metodo DOM Level 1, come Document.createElement(), questo è sempre null. |
| [getName](../../com.aspose.html.dom/attr/name/) Restituisce il nome di questo attributo. |
| [getNamespaceURI](../../com.aspose.html.dom/attr/packageuri/) L'URI del pacchetto di questo nodo, o null se non è specificato. |
...
| [getNodeName](../../com.aspose.html.dom/attr/nodename/) Il nome di questo nodo, a seconda del suo tipo. |
| [getNodeType](../../com.aspose.html.dom/attr/nodetype/) Un codice che rappresenta il tipo dell'oggetto sottostante. |
| [nodeValue](../../com.aspose.html.dom/attr/nodevalue/) { get; set; } | Il valore di questo nodo, a seconda del suo tipo. |
...
| [getOwnerElement](../../com.aspose.html.dom/attr/ownerelement/) Il nodo Element a cui è collegato questo attributo o null se l'attributo non è in uso. |
...
| [getPrefix](../../com.aspose.html.dom/attr/prefix/) Il prefisso del pacchetto di questo nodo, o null se non è specificato. Quando è definito come null, impostarlo non ha effetto. |
...
| [getSpecified](../../com.aspose.html.dom/attr/specified/) Vero se questo attributo è stato esplicitamente assegnato un valore nel documento di istanza, falso altrimenti. |
| [textContent](../../com.aspose.html.dom/attr/textcontent/) { get; set; } | Questo attributo restituisce il contenuto testuale di questo nodo e dei suoi discendenti. Quando è definito come null, impostarlo non ha alcun effetto. All'impostazione, tutti i possibili figli che questo nodo potrebbe avere vengono rimossi e, se la nuova stringa non è vuota o null, viene sostituito da un unico nodo Text contenente la stringa impostata. |
[getValue]
