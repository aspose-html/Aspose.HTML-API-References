...
| [getPrefix](../../com.aspose.html.dom/attr/prefix/) Il prefisso del pacchetto di questo nodo, o null se non è specificato. Quando è definito come null, impostarlo non ha alcun effetto. |
...
| [getSpecified](../../com.aspose.html.dom/attr/specified/) True se questo attributo ha ricevuto esplicitamente un valore nel documento di istanza, false altrimenti. |
| [textContent](../../com.aspose.html.dom/attr/textcontent/) { get; set; } | Questo attributo restituisce il contenuto testuale di questo nodo e dei suoi discendenti. Quando è definito come null, impostarlo non ha alcun effetto. All'impostazione, eventuali figli che questo nodo potrebbe avere vengono rimossi e, se la nuova stringa non è vuota o null, viene sostituito da un unico nodo Text contenente la stringa a cui è impostato questo attributo. |
[getValue]
