...
description: Aspose.Html.Dom.Svg.Paths.SVGPathSegLinetoAbs classe. Linterfaccia SVGPathSegLinetoAbs corrisponde a un comando di dati di percorso absolute lineto L.
type: docs
weight: 1810
url: /it/net/aspose.html.dom.svg.paths/svgpathseglinetoabs/
---
## SVGPathSegLinetoAbs class

L'interfaccia SVGPathSegLinetoAbs corrisponde a un comando di dati di percorso "absolute lineto" (L).
...
| [X](../../aspose.html.dom.svg.paths/svgpathseglinetoabs/x/) { get; set; } | La coordinata X assoluta per il punto finale di questo segmento di percorso. |
| [Y](../../aspose.html.dom.svg.paths/svgpathseglinetoabs/y/) { get; set; } | La coordinata Y assoluta per il punto finale di questo segmento di percorso. |
