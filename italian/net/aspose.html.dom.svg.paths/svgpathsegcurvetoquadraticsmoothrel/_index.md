...
description: Aspose.Html.Dom.Svg.Paths.SVGPathSegCurvetoQuadraticSmoothRel classe. Linterfaccia SVGPathSegCurvetoQuadraticSmoothRel corrisponde a un comando di dati di percorso curva cubica liscia relativato t.
type: docs
weight: 1800
url: /it/net/aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticsmoothrel/
---
## SVGPathSegCurvetoQuadraticSmoothRel class

L'interfaccia SVGPathSegCurvetoQuadraticSmoothRel corrisponde a un comando di dati di percorso "curva cubica liscia relativato" (t).
...
| [X](../../aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticsmoothrel/x/) { get; set; } | La coordinata X relativa per il punto finale di questo segmento di percorso. |
| [Y](../../aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticsmoothrel/y/) { get; set; } | La coordinata Y relativa per il punto finale di questo segmento di percorso. |
