...
description: Aspose.Html.Dom.Svg.Paths.SVGPathSegCurvetoQuadraticSmoothAbs classe. Linterfaccia SVGPathSegCurvetoQuadraticSmoothAbs corrisponde a un comando di dati di percorso absolute smooth cubic curveto T.
type: docs
weight: 1790
url: /it/net/aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticsmoothabs/
---
...
| [X](../../aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticsmoothabs/x/) { get; set; } | La coordinata X assoluta per il punto finale di questo segmento di percorso. |
| [Y](../../aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticsmoothabs/y/) { get; set; } | La coordinata Y assoluta per il punto finale di questo segmento di percorso. |
