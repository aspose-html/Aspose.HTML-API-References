...
description: Aspose.Html.Dom.Svg.Paths.SVGPathSegLinetoVerticalAbs classe. Linterfaccia SVGPathSegLinetoVerticalAbs corrisponde a un comando di dati di percorso linea verticale assoluta V.
type: docs
weight: 1850
url: /it/net/aspose.html.dom.svg.paths/svgpathseglinetoverticalabs/
---
## SVGPathSegLinetoVerticalAbs class

L'interfaccia SVGPathSegLinetoVerticalAbs corrisponde a un comando di dati di percorso "linea verticale assoluta" (V).
...
| [Y](../../aspose.html.dom.svg.paths/svgpathseglinetoverticalabs/y/) { get; set; } | La coordinata Y assoluta per il punto finale di questo segmento di percorso. |
