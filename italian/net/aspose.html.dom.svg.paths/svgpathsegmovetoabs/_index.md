...
description: Aspose.Html.Dom.Svg.Paths.SVGPathSegMovetoAbs classe. Linterfaccia SVGPathSegMovetoAbs corrisponde a un comando di dati di percorso absolute moveto M.
type: docs
weight: 1880
url: /it/net/aspose.html.dom.svg.paths/svgpathsegmovetoabs/
---
## SVGPathSegMovetoAbs class

L'interfaccia SVGPathSegMovetoAbs corrisponde a un comando di dati di percorso "absolute moveto" (M).
...
| [X](../../aspose.html.dom.svg.paths/svgpathsegmovetoabs/x/) { get; set; } | La coordinata X assoluta per il punto finale di questo segmento di percorso. |
| [Y](../../aspose.html.dom.svg.paths/svgpathsegmovetoabs/y/) { get; set; } | La coordinata Y assoluta per il punto finale di questo segmento di percorso. |
