...
description: Aspose.Html.Dom.Svg.Paths.SVGPathSegLinetoHorizontalRel classe. Linterfaccia SVGPathSegLinetoHorizontalRel corrisponde a un comando di dati di percorso riga orizzontale relativa h.
type: docs
weight: 1830
url: /it/net/aspose.html.dom.svg.paths/svgpathseglinetohorizontalrel/
---
## SVGPathSegLinetoHorizontalRel class

L'interfaccia SVGPathSegLinetoHorizontalRel corrisponde a un comando di dati di percorso "riga orizzontale relativa" (h).
...
| [X](../../aspose.html.dom.svg.paths/svgpathseglinetohorizontalrel/x/) { get; set; } | La coordinata X relativa per il punto finale di questo segmento di percorso. |
