...
description: Aspose.Html.Dom.Svg.Paths.SVGPathSegLinetoVerticalRel classe. Linterfaccia SVGPathSegLinetoVerticalRel corrisponde a un comando di dati di percorso riga verticale relativa v.
type: docs
weight: 1860
url: /it/net/aspose.html.dom.svg.paths/svgpathseglinetoverticalrel/
---
## SVGPathSegLinetoVerticalRel class

L'interfaccia SVGPathSegLinetoVerticalRel corrisponde a un comando di dati di percorso "riga verticale relativa" (v).
...
| [Y](../../aspose.html.dom.svg.paths/svgpathseglinetoverticalrel/y/) { get; set; } | La coordinata Y relativa per il punto finale di questo segmento di percorso. |
