...
description: Aspose.Html.Toolkit.Markdown.Syntax.ThematicBreakSyntaxNode classe. Implementato il nodo di sintassi dellinterruzione tematica.
type: docs
weight: 5680
url: /it/net/aspose.html.toolkit.markdown.syntax/thematicbreaksyntaxnode/
---
## ThematicBreakSyntaxNode class

Implementato il nodo di sintassi dell'interruzione tematica.
...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/thematicbreaksyntaxnode/accept/)(MarkdownSyntaxVisitor) | Definisce l'interfaccia per Accetta visitatore. |
