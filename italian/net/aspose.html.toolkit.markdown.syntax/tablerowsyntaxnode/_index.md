...
description: Aspose.Html.Toolkit.Markdown.Syntax.TableRowSyntaxNode classe. Il nodo della sintassi della riga della tabella.
type: docs
weight: 5580
url: /it/net/aspose.html.toolkit.markdown.syntax/tablerowsyntaxnode/
---
## TableRowSyntaxNode class

Il nodo della sintassi della riga della tabella.
...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/blocksyntaxnode/accept/)(MarkdownSyntaxVisitor) | Definisce l'interfaccia per accettare il visitatore. |
| [AppendCell](../../aspose.html.toolkit.markdown.syntax/tablerowsyntaxnode/appendcell/)(TableCellSyntaxNode) | Definisce l'interfaccia per l'accodamento della cella. |
| [AppendChild](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/appendchild/)(MarkdownSyntaxNode) | Aggiungi nodo figlio. |
| [AppendDelimiter](../../aspose.html.toolkit.markdown.syntax/tablerowsyntaxnode/appenddelimiter/)(TableDelimiterSyntaxNode) | Definisce l'interfaccia per il delimitatore di accodamento. |
| [ChildNodes](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/childnodes/)() | Ottieni la raccolta dei nodi figlio. |
| [GetCells](../../aspose.html.toolkit.markdown.syntax/tablerowsyntaxnode/getcells/)() | Definisce l'interfaccia per ottenere le celle. |
