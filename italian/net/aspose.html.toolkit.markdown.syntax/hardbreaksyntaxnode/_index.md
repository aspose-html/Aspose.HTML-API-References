...
description: Aspose.Html.Toolkit.Markdown.Syntax.HardBreakSyntaxNode classe. Rappresenta HardBreakSyntaxNode.
type: docs
weight: 5010
url: /it/net/aspose.html.toolkit.markdown.syntax/hardbreaksyntaxnode/
---
## HardBreakSyntaxNode class

Rappresenta HardBreakSyntaxNode.
...
| virtual [Source](../../aspose.html.toolkit.markdown.syntax/linebreaksyntaxnode/source/) { get; } | Ottieni la fonte. |
| virtual [Span](../../aspose.html.toolkit.markdown.syntax/linebreaksyntaxnode/span/) { get; } | Ottieni lo span. |
| [Value](../../aspose.html.toolkit.markdown.syntax/linebreaksyntaxnode/value/) { get; } | Ottieni il valore. |

## Metodi

| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/hardbreaksyntaxnode/accept/)(MarkdownSyntaxVisitor) | Definisce l'interfaccia per accettare il visitatore. |
...
| [GetBreakingTag](../../aspose.html.toolkit.markdown.syntax/hardbreaksyntaxnode/getbreakingtag/)() | Definisce l'interfaccia per ottenere Breaking Tag |
