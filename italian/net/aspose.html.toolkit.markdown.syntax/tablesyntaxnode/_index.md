---
title: Class TableSyntaxNode
second_title: Aspose.HTML per riferimento API .NET
description: Aspose.Html.Toolkit.Markdown.Syntax.TableSyntaxNode classe. Il nodo della classe TableSyntax.
type: docs
weight: 5590
url: /it/net/aspose.html.toolkit.markdown.syntax/tablesyntaxnode/
---
## TableSyntaxNode class

Il nodo della classe TableSyntax.
...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/tablesyntaxnode/accept/)(MarkdownSyntaxVisitor) | Definisce l'interfaccia per l'accettazione del visitatore. |
| [AppendChild](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/appendchild/)(MarkdownSyntaxNode) | Aggiungi nodo figlio. |
| [AppendRow](../../aspose.html.toolkit.markdown.syntax/tablesyntaxnode/appendrow/)(TableRowSyntaxNode) | Definisce l'interfaccia per aggiungere riga. |
| [ChildNodes](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/childnodes/)() | Ottieni la raccolta dei nodi figlio. |
| [GetAlignment](../../aspose.html.toolkit.markdown.syntax/tablesyntaxnode/getalignment/)() | Definisce l'interfaccia per ottenere l'allineamento. |
| [GetBodyRows](../../aspose.html.toolkit.markdown.syntax/tablesyntaxnode/getbodyrows/)() | Definisce l'interfaccia per ottenere le righe del corpo. |
| [GetHeader](../../aspose.html.toolkit.markdown.syntax/tablesyntaxnode/getheader/)() | Definisce l'interfaccia per ottenere l'intestazione della tabella. |
