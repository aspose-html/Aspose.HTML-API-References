---
title: Class FencedCodeBlockSyntaxNode
second_title: Aspose.HTML per riferimento API .NET
description: Aspose.Html.Toolkit.Markdown.Syntax.FencedCodeBlockSyntaxNode classe. Rappresenta il FencedCodeBlockSyntaxNode.
type: docs
weight: 4990
url: /it/net/aspose.html.toolkit.markdown.syntax/fencedcodeblocksyntaxnode/
---
...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/fencedcodeblocksyntaxnode/accept/)(MarkdownSyntaxVisitor) | Definisce l'interfaccia per accettare il visitatore. |
...
| [GetClosingTag](../../aspose.html.toolkit.markdown.syntax/fencedcodeblocksyntaxnode/getclosingtag/)() | Definisce l'interfaccia per ottenere il tag di chiusura. |
| [GetContent](../../aspose.html.toolkit.markdown.syntax/fencedcodeblocksyntaxnode/getcontent/)() | Definisce l'interfaccia per ottenere contenuto. |
| [GetInfo](../../aspose.html.toolkit.markdown.syntax/fencedcodeblocksyntaxnode/getinfo/)() | Definisce l'interfaccia per ottenere informazioni. |
| [GetLeadingTrivia](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/getleadingtrivia/)() | Ottieni le principali curiosità. |
| [GetOpeningTag](../../aspose.html.toolkit.markdown.syntax/fencedcodeblocksyntaxnode/getopeningtag/)() | Definisce l'interfaccia per ottenere il tag di apertura. |
