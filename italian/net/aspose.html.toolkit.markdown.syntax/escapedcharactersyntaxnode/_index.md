...
description: Aspose.Html.Toolkit.Markdown.Syntax.EscapedCharacterSyntaxNode classe. Implementato il nodo della sintassi del carattere escape.
type: docs
weight: 4890
url: /it/net/aspose.html.toolkit.markdown.syntax/escapedcharactersyntaxnode/
---
## EscapedCharacterSyntaxNode class

Implementato il nodo della sintassi del carattere escape.
...
| virtual [Source](../../aspose.html.toolkit.markdown.syntax/textsyntaxnode/source/) { get; } | Restituisce il testo di origine. |
| virtual [Span](../../aspose.html.toolkit.markdown.syntax/textsyntaxnode/span/) { get; } | Definisce l'interfaccia per get span. |
| [Value](../../aspose.html.toolkit.markdown.syntax/textsyntaxnode/value/) { get; } | Definisce la proprietà per ottenere il valore della stringa. |

## Metodi

| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/escapedcharactersyntaxnode/accept/)(MarkdownSyntaxVisitor) | Definisce l'interfaccia per accettare il visitatore. |
