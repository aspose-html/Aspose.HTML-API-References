...
description: Aspose.Html.Toolkit.Markdown.Syntax.SetextHeadingSyntaxNode classe. Rappresenta il nodo della sintassi dellintestazione Setext.
type: docs
weight: 5530
url: /it/net/aspose.html.toolkit.markdown.syntax/setextheadingsyntaxnode/
---
## SetextHeadingSyntaxNode class

Rappresenta il nodo della sintassi dell'intestazione Setext.
...
| [Level](../../aspose.html.toolkit.markdown.syntax/setextheadingsyntaxnode/level/) { get; } | Ottieni il livello della sintassi corrente. |
...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/setextheadingsyntaxnode/accept/)(MarkdownSyntaxVisitor) | Definisce l'interfaccia per l'accettazione del visitatore. |
