...
description: Aspose.Html.Toolkit.Markdown.Syntax.SoftBreakSyntaxNode classe. Rappresenta la sintassi di soft breaking.
type: docs
weight: 5540
url: /it/net/aspose.html.toolkit.markdown.syntax/softbreaksyntaxnode/
---
## SoftBreakSyntaxNode class

Rappresenta la sintassi di soft breaking.
...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/softbreaksyntaxnode/accept/)(MarkdownSyntaxVisitor) | Definisce l'interfaccia per l'accettazione del visitatore. |
