...
description: Aspose.Html.Dom.Events.FocusEvent classe. Linterfaccia FocusEvent fornisce informazioni contestuali specifiche associate agli eventi Focus.
type: docs
weight: 780
url: /it/net/aspose.html.dom.events/focusevent/
---
## FocusEvent class
...
| Nome | Descrizione |
| --- | --- |
| [FocusEvent](focusevent/#constructor)(string) | Inizializza una nuova istanza di`FocusEvent` classe. |
| [FocusEvent](focusevent/#constructor_1)(string, IDictionary&lt;string, object&gt;) | Inizializza una nuova istanza di`FocusEvent` classe. |
...
| [RelatedTarget](../../aspose.html.dom.events/focusevent/relatedtarget/) { get; } | Usato per identificare un EventTarget secondario relativo ad un evento Focus, a seconda del tipo di evento. |
