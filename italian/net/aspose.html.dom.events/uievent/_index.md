...
description: Aspose.Html.Dom.Events.UIEvent classe. Linterfaccia UIEvent fornisce informazioni contestuali specifiche associate agli eventi dellinterfaccia utente.
type: docs
weight: 850
url: /it/net/aspose.html.dom.events/uievent/
---
## UIEvent class
...
| Nome | Descrizione |
| --- | --- |
| [UIEvent](uievent/#constructor)(string) | Inizializza una nuova istanza di`UIEvent` classe. |
| [UIEvent](uievent/#constructor_1)(string, IDictionary&lt;string, object&gt;) | Inizializza una nuova istanza di`UIEvent` classe. |
