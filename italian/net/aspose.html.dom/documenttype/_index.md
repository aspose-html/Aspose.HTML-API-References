...
description: Aspose.Html.Dom.DocumentType classe. DocumentType fornisce uninterfaccia allelenco di entità definite per il documento
type: docs
weight: 680
url: /it/net/aspose.html.dom/documenttype/
---
## DocumentType class

DocumentType fornisce un'interfaccia all'elenco di entità definite per il documento
...
| Nome | Descrizione |
| --- | --- |
| [DocumentType](documenttype/)(string, string, string, string, Document) | Inizializza una nuova istanza di`DocumentType` classe. |
...
| [InternalSubset](../../aspose.html.dom/documenttype/internalsubset/) { get; } | Il sottoinsieme interno come stringa o null se non ce n'è nessuno. |
...
| [Name](../../aspose.html.dom/documenttype/name/) { get; } | Il nome del DTD; cioè, il nome che segue immediatamente la parola chiave DOCTYPE. |
...
| override [NodeName](../../aspose.html.dom/documenttype/nodename/) { get; } | Il nome di questo nodo, a seconda del suo tipo. |
| override [NodeType](../../aspose.html.dom/documenttype/nodetype/) { get; } | Un codice che rappresenta il tipo dell'oggetto sottostante. |
...
| [PublicId](../../aspose.html.dom/documenttype/publicid/) { get; } | L'identificatore pubblico del sottoinsieme esterno. |
| [SystemId](../../aspose.html.dom/documenttype/systemid/) { get; } | L'identificatore di sistema del sottoinsieme esterno. Questo può essere un URI assoluto o meno. |
...
| override [ToString](../../aspose.html.dom/documenttype/tostring/)() | Restituisce aString che rappresenta questa istanza. |
