...
description: Aspose.Html.Dom.EntityReference classe. I nodi EntityReference possono essere utilizzati per rappresentare un riferimento a unentità nellalbero.
type: docs
weight: 710
url: /it/net/aspose.html.dom/entityreference/
---
...
| override [NodeName](../../aspose.html.dom/entityreference/nodename/) { get; } | Il nome di questo nodo, a seconda del suo tipo. |
| override [NodeType](../../aspose.html.dom/entityreference/nodetype/) { get; } | Un codice che rappresenta il tipo dell'oggetto sottostante. |
