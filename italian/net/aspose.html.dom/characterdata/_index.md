...
description: Aspose.Html.Dom.CharacterData classe. CharacterData estende Node con un set di attributi e metodi per accedere ai dati dei personaggi nel DOM.
type: docs
weight: 300
url: /it/net/aspose.html.dom/characterdata/
---
## CharacterData class

CharacterData estende Node con un set di attributi e metodi per accedere ai dati dei personaggi nel DOM.
