...
description: Aspose.Html.Dom.Notation classe. Rappresenta una notazione dichiarata nel DTD.
type: docs
weight: 1010
url: /it/net/aspose.html.dom/notation/
---
## Notation class
...
| override [NodeName](../../aspose.html.dom/notation/nodename/) { get; } | Il nome di questo nodo, a seconda del suo tipo. |
| override [NodeType](../../aspose.html.dom/notation/nodetype/) { get; } | Un codice che rappresenta il tipo dell'oggetto sottostante. |
...
| [PublicId](../../aspose.html.dom/notation/publicid/) { get; } | L'identificatore pubblico di questa notazione. Se l'identificatore pubblico non è stato specificato, questo è null. |
| [SystemId](../../aspose.html.dom/notation/systemid/) { get; } | L'identificatore di sistema di questa notazione. Se l'identificatore di sistema non è stato specificato, questo è nullo. Questo può essere un URI assoluto o meno. |
