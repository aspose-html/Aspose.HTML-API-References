...
description: Aspose.Html.Dom.ProcessingInstruction classe. ProcessingInstruction rappresenta una istruzione di elaborazione utilizzata in XML come un modo per mantenere le informazioni specifiche del processore nel testo del documento.
type: docs
weight: 1020
url: /it/net/aspose.html.dom/processinginstruction/
---
## ProcessingInstruction class

ProcessingInstruction rappresenta una "istruzione di elaborazione", utilizzata in XML come un modo per mantenere le informazioni specifiche del processore nel testo del documento.
...
| virtual [Data](../../aspose.html.dom/characterdata/data/) { get; set; } | I dati carattere del nodo che implementa questa interfaccia. |
...
| [Length](../../aspose.html.dom/characterdata/length/) { get; } | Il numero di unità a 16 bit disponibili tramite i dati e il metodo substringData riportato di seguito. Questo può avere il valore zero, cioè i nodi CharacterData possono essere vuoti. |
...
| override [NodeName](../../aspose.html.dom/processinginstruction/nodename/) { get; } | Il nome di questo nodo, a seconda del suo tipo. |
| override [NodeType](../../aspose.html.dom/processinginstruction/nodetype/) { get; } | Un codice che rappresenta il tipo dell'oggetto sottostante. |
| override [NodeValue](../../aspose.html.dom/processinginstruction/nodevalue/) { get; set; } | Il valore di questo nodo, a seconda del suo tipo. |
...
| [Target](../../aspose.html.dom/processinginstruction/target/) { get; } | La destinazione di questa istruzione di elaborazione. |
| override [TextContent](../../aspose.html.dom/processinginstruction/textcontent/) { get; set; } | Questo attributo restituisce il contenuto testuale di questo nodo e dei suoi discendenti. Quando è definito nullo, impostarlo non ha alcun effetto. Al momento dell'impostazione, tutti i possibili figli che questo nodo può avere vengono rimossi e, se la nuova stringa non è vuota o nulla, sostituita da un singolo nodo di testo contenente la stringa su cui è impostato questo attributo. |
...
| virtual [AppendData](../../aspose.html.dom/characterdata/appenddata/)(string) | Aggiungi la stringa alla fine dei dati carattere del nodo. |
...
| virtual [DeleteData](../../aspose.html.dom/characterdata/deletedata/)(int, int) | Rimuove un intervallo di unità a 16 bit dal nodo. |
...
| virtual [InsertData](../../aspose.html.dom/characterdata/insertdata/)(int, string) | Inserisce una stringa all'offset dell'unità a 16 bit specificato. |
...
| virtual [ReplaceData](../../aspose.html.dom/characterdata/replacedata/)(int, int, string) | Sostituisce i caratteri a partire dall'offset dell'unità a 16 bit specificato con la stringa specificata. |
| virtual [SubstringData](../../aspose.html.dom/characterdata/substringdata/)(int, int) | Estrae un intervallo di dati dal nodo. |
| override [ToString](../../aspose.html.dom/characterdata/tostring/)() | Restituisce aString che rappresenta questa istanza. |
