...
description: Aspose.Html.Dom.DocumentFragment classe. DocumentFragment è un oggetto Document leggero o minimo. È molto comune voler poter estrarre una porzione dellalbero di un documento o creare un nuovo frammento di un documento.
type: docs
weight: 670
url: /it/net/aspose.html.dom/documentfragment/
---
## DocumentFragment class

DocumentFragment è un oggetto Document "leggero" o "minimo". È molto comune voler poter estrarre una porzione dell'albero di un documento o creare un nuovo frammento di un documento.
