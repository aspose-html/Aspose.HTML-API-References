...
description: Aspose.Html.Dom.Svg.Filters.SVGFEDiffuseLightingElement classe. Linterfaccia SVGFEDiffuseLightingElement corrisponde allelemento feDiffuseLighting.
type: docs
weight: 1410
url: /it/net/aspose.html.dom.svg.filters/svgfediffuselightingelement/
---
...
| [DiffuseConstant](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/diffuseconstant/) { get; } | Corrisponde all'attributo 'diffuseConstant' sull'elemento 'feDiffuseLighting' specificato. |
...
| [Height](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/height/) { get; } | Corrisponde all'attributo 'altezza' sull'elemento 'filtro' dato. |
...
| [In1](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/in1/) { get; } | Corrisponde all'attributo 'in' sull'elemento 'feDiffuseLighting' dato. |
...
| [KernelUnitLengthX](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/kernelunitlengthx/) { get; } | Corrisponde all'attributo 'kernelUnitLength' sull'elemento 'feDiffuseLighting' specificato. |
| [KernelUnitLengthY](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/kernelunitlengthy/) { get; } | Corrisponde all'attributo 'kernelUnitLength' sull'elemento 'feDiffuseLighting' specificato. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/result/) { get; } | Corrisponde all'attributo 'risultato' sull'elemento 'filtro' dato. |
...
| [SurfaceScale](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/surfacescale/) { get; } | Corrisponde all'attributo 'surfaceScale' sull'elemento 'feDiffuseLighting' dato. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/width/) { get; } | Corrisponde all'attributo 'width' sull'elemento 'filter' dato. |
| [X](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/x/) { get; } | Corrisponde all'attributo 'x' sull'elemento 'filtro' dato. |
| [Y](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/y/) { get; } | Corrisponde all'attributo 'y' sull'elemento 'filtro' dato. |
