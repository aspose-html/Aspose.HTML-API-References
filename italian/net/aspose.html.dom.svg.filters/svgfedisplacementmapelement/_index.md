...
description: Aspose.Html.Dom.Svg.Filters.SVGFEDisplacementMapElement classe. Linterfaccia SVGFEDisplacementMapElement corrisponde allelemento feDisplacementMap.
type: docs
weight: 1420
url: /it/net/aspose.html.dom.svg.filters/svgfedisplacementmapelement/
---
...
| [Height](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/height/) { get; } | Corrisponde all'attributo 'altezza' sull'elemento 'filtro' dato. |
...
| [In1](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/in1/) { get; } | Corrisponde all'attributo 'in' sull'elemento 'feDisplacementMap' dato. |
| [In2](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/in2/) { get; } | Corrisponde all'attributo 'in2' sull'elemento 'feDisplacementMap' dato. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/result/) { get; } | Corrisponde all'attributo 'risultato' sull'elemento 'filtro' dato. |
| [Scale](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/scale/) { get; } | Corrisponde all'attributo 'scale' sull'elemento 'feDisplacementMap' dato. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/width/) { get; } | Corrisponde all'attributo 'width' sull'elemento 'filter' dato. |
| [X](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/x/) { get; } | Corrisponde all'attributo 'x' sull'elemento 'filtro' dato. |
| [XChannelSelector](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/xchannelselector/) { get; } | Corrisponde all'attributo 'xChannelSelector' sull'elemento 'feDisplacementMap' specificato. Accetta una delle costanti SVG_CHANNEL_* definite su questa interfaccia. |
| [Y](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/y/) { get; } | Corrisponde all'attributo 'y' sull'elemento 'filtro' dato. |
| [YChannelSelector](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/ychannelselector/) { get; } | Corrisponde all'attributo 'yChannelSelector' sull'elemento 'feDisplacementMap' specificato. Accetta una delle costanti SVG_CHANNEL_* definite su questa interfaccia. |
...
| Nome | Descrizione |
| --- | --- |
| const [SVG_CHANNEL_A](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_a/) | Corrisponde al valore 'A'. |
| const [SVG_CHANNEL_B](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_b/) | Corrisponde al valore 'B'. |
| const [SVG_CHANNEL_G](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_g/) | Corrisponde al valore 'G'. |
| const [SVG_CHANNEL_R](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_r/) | Corrisponde al valore 'R'. |
| const [SVG_CHANNEL_UNKNOWN](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_unknown/) | Il tipo non è uno dei tipi predefiniti. Non è valido tentare di definire un nuovo valore di questo tipo o tentare di convertire un valore esistente in questo tipo. |
