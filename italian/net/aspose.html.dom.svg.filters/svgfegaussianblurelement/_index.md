...
description: Aspose.Html.Dom.Svg.Filters.SVGFEGaussianBlurElement classe. Linterfaccia SVGFEGaussianBlurElement corrisponde allelemento feGaussianBlur.
type: docs
weight: 1500
url: /it/net/aspose.html.dom.svg.filters/svgfegaussianblurelement/
---
...
| [Height](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/height/) { get; } | Corrisponde all'attributo "altezza" sull'elemento "filtro" dato. |
...
| [In1](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/in1/) { get; } | Corrisponde all'attributo �in� sull'elemento �feGaussianBlur� dato. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/result/) { get; } | Corrisponde all'attributo "risultato" sull'elemento "filtro" dato. |
...
| [StdDeviationX](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/stddeviationx/) { get; } | Corrisponde all'attributo �stdDeviation� sull'elemento �feGaussianBlur� dato. Contiene il componente X dell'attributo �stdDeviation�. |
| [StdDeviationY](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/stddeviationy/) { get; } | Corrisponde all'attributo �stdDeviation� sull'elemento �feGaussianBlur� dato. Contiene la componente Y (eventualmente calcolata automaticamente) dell'attributo �stdDeviation�. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/width/) { get; } | Corrisponde all'attributo "larghezza" sull'elemento "filtro" dato. |
| [X](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/x/) { get; } | Corrisponde all'attributo �x� sull'elemento �filtro� dato. |
| [Y](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/y/) { get; } | Corrisponde all'attributo �y� sull'elemento �filtro� dato. |
...
| [SetStdDeviation](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/setstddeviation/)(float, float) | Imposta i valori per l'attributo �stdDeviation�. |
