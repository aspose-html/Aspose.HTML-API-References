...
description: Aspose.Html.Dom.Svg.Filters.SVGFEMorphologyElement classe. Linterfaccia SVGFEMorphologyElement corrisponde allelemento feMorphology.
type: docs
weight: 1540
url: /it/net/aspose.html.dom.svg.filters/svgfemorphologyelement/
---
...
| [Height](../../aspose.html.dom.svg.filters/svgfemorphologyelement/height/) { get; } | Corrisponde all'attributo 'altezza' sull'elemento 'filtro' dato. |
...
| [In1](../../aspose.html.dom.svg.filters/svgfemorphologyelement/in1/) { get; } | Corrisponde all'attributo 'in' sull'elemento 'feMorphology' dato. |
...
| [Operator](../../aspose.html.dom.svg.filters/svgfemorphologyelement/operator/) { get; } | Corrisponde all'attributo 'operator' sull'elemento 'feMorphology' dato. Accetta una delle costanti SVG_MORPHOLOGY_OPERATOR_* definite su questa interfaccia. |
...
| [RadiusX](../../aspose.html.dom.svg.filters/svgfemorphologyelement/radiusx/) { get; } | Corrisponde all'attributo 'radius' sull'elemento 'feMorphology' dato. |
| [RadiusY](../../aspose.html.dom.svg.filters/svgfemorphologyelement/radiusy/) { get; } | Corrisponde all'attributo 'radius' sull'elemento 'feMorphology' dato. |
| [Result](../../aspose.html.dom.svg.filters/svgfemorphologyelement/result/) { get; } | Corrisponde all'attributo 'risultato' sull'elemento 'filtro' dato. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfemorphologyelement/width/) { get; } | Corrisponde all'attributo 'width' sull'elemento 'filter' dato. |
| [X](../../aspose.html.dom.svg.filters/svgfemorphologyelement/x/) { get; } | Corrisponde all'attributo 'x' sull'elemento 'filtro' dato. |
| [Y](../../aspose.html.dom.svg.filters/svgfemorphologyelement/y/) { get; } | Corrisponde all'attributo 'y' sull'elemento 'filtro' dato. |
...
| Nome | Descrizione |
| --- | --- |
| const [SVG_MORPHOLOGY_OPERATOR_DILATE](../../aspose.html.dom.svg.filters/svgfemorphologyelement/svg_morphology_operator_dilate/) | Corrisponde al valore 'dilate'. |
| const [SVG_MORPHOLOGY_OPERATOR_ERODE](../../aspose.html.dom.svg.filters/svgfemorphologyelement/svg_morphology_operator_erode/) | Corrisponde al valore 'erodere'. |
| const [SVG_MORPHOLOGY_OPERATOR_UNKNOWN](../../aspose.html.dom.svg.filters/svgfemorphologyelement/svg_morphology_operator_unknown/) | Il tipo non è uno dei tipi predefiniti. Non è valido tentare di definire un nuovo valore di questo tipo o tentare di convertire un valore esistente in questo tipo. |
