...
description: Aspose.Html.Dom.Svg.Filters.SVGFEConvolveMatrixElement classe. Linterfaccia SVGFEConvolveMatrixElement corrisponde allelemento feConvolveMatrix.
type: docs
weight: 1400
url: /it/net/aspose.html.dom.svg.filters/svgfeconvolvematrixelement/
---
...
| [Bias](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/bias/) { get; } | Corrisponde all'attributo 'bias' sull'elemento 'feConvolveMatrix' dato. |
...
| [Divisor](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/divisor/) { get; } | Corrisponde all'attributo 'divisor' sull'elemento 'feConvolveMatrix' dato. |
| [EdgeMode](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/edgemode/) { get; } | Corrisponde all'attributo 'edgeMode' sull'elemento 'feConvolveMatrix' dato. |
...
| [Height](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/height/) { get; } | Corrisponde all'attributo 'altezza' sull'elemento 'filtro' dato. |
...
| [In1](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/in1/) { get; } | Corrisponde all'attributo 'in' sull'elemento 'feConvolveMatrix' dato. |
...
| [KernelMatrix](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelmatrix/) { get; } | Corrisponde all'attributo 'kernelMatrix' sull'elemento 'feConvolveMatrix' dato. |
| [KernelUnitLengthX](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelunitlengthx/) { get; } | Corrisponde all'attributo 'kernelUnitLength' sull'elemento 'feConvolveMatrix' dato. |
| [KernelUnitLengthY](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelunitlengthy/) { get; } | Corrisponde all'attributo 'kernelUnitLength' sull'elemento 'feConvolveMatrix' dato. |
...
| [OrderX](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/orderx/) { get; } | Corrisponde all'attributo 'ordine' sull'elemento 'feConvolveMatrix' dato. |
| [OrderY](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/ordery/) { get; } | Corrisponde all'attributo 'ordine' sull'elemento 'feConvolveMatrix' dato. |
...
| [PreserveAlpha](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/preservealpha/) { get; } | Corrisponde all'attributo 'preserveAlpha' sull'elemento 'feConvolveMatrix' dato. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/result/) { get; } | Corrisponde all'attributo 'risultato' sull'elemento 'filtro' dato. |
...
| [TargetX](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/targetx/) { get; } | Corrisponde all'attributo 'targetX' sull'elemento 'feConvolveMatrix' dato. |
| [TargetY](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/targety/) { get; } | Corrisponde all'attributo 'targetY' sull'elemento 'feConvolveMatrix' dato. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/width/) { get; } | Corrisponde all'attributo 'width' sull'elemento 'filter' dato. |
| [X](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/x/) { get; } | Corrisponde all'attributo 'x' sull'elemento 'filtro' dato. |
| [Y](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/y/) { get; } | Corrisponde all'attributo 'y' sull'elemento 'filtro' dato. |
...
| Nome | Descrizione |
| --- | --- |
| const [SVG_EDGEMODE_DUPLICATE](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_duplicate/) | Corrisponde al valore 'duplicato'. |
| const [SVG_EDGEMODE_NONE](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_none/) | Corrisponde al valore 'none'. |
| const [SVG_EDGEMODE_UNKNOWN](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_unknown/) | Il tipo non è uno dei tipi predefiniti. Non è valido tentare di definire un nuovo valore di questo tipo o tentare di convertire un valore esistente in questo tipo. |
| const [SVG_EDGEMODE_WRAP](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_wrap/) | Corrisponde al valore 'wrap'. |
