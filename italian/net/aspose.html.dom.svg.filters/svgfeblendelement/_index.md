...
description: Aspose.Html.Dom.Svg.Filters.SVGFEBlendElement classe. Linterfaccia SVGFEBlendElement corrisponde allelemento feBlend.
type: docs
weight: 1360
url: /it/net/aspose.html.dom.svg.filters/svgfeblendelement/
---
...
| [Height](../../aspose.html.dom.svg.filters/svgfeblendelement/height/) { get; } | Corrisponde all'attributo 'altezza' sull'elemento 'filtro' dato. |
...
| [In1](../../aspose.html.dom.svg.filters/svgfeblendelement/in1/) { get; } | Corrisponde all'attributo 'in' sull'elemento 'feBlend' dato. |
| [In2](../../aspose.html.dom.svg.filters/svgfeblendelement/in2/) { get; } | Corrisponde all'attributo 'in2' sull'elemento 'feBlend' dato. |
...
| [Mode](../../aspose.html.dom.svg.filters/svgfeblendelement/mode/) { get; } | Corrisponde all'attributo 'mode' sull'elemento 'feBlend' dato. Accetta una delle costanti SVG_FEBLEND_MODE_* definite su questa interfaccia. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfeblendelement/result/) { get; } | Corrisponde all'attributo 'risultato' sull'elemento 'filtro' dato. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfeblendelement/width/) { get; } | Corrisponde all'attributo 'width' sull'elemento 'filter' dato. |
| [X](../../aspose.html.dom.svg.filters/svgfeblendelement/x/) { get; } | Corrisponde all'attributo 'x' sull'elemento 'filtro' dato. |
| [Y](../../aspose.html.dom.svg.filters/svgfeblendelement/y/) { get; } | Corrisponde all'attributo 'y' sull'elemento 'filtro' dato. |
...
| Nome | Descrizione |
| --- | --- |
| const [SVG_FEBLEND_MODE_COLOR](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_color/) | Corrisponde al valore 'colore'. |
| const [SVG_FEBLEND_MODE_COLOR_BURN](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_color_burn/) | Corrisponde al valore 'color_burn'. |
| const [SVG_FEBLEND_MODE_COLOR_DODGE](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_color_dodge/) | Corrisponde al valore 'color_dodge'. |
| const [SVG_FEBLEND_MODE_DARKEN](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_darken/) | Corrisponde al valore 'scuro'. |
| const [SVG_FEBLEND_MODE_DIFFERENCE](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_difference/) | Corrisponde al valore 'differenza'. |
| const [SVG_FEBLEND_MODE_EXCLUSION](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_exclusion/) | Corrisponde al valore 'esclusione'. |
| const [SVG_FEBLEND_MODE_HARD_LIGHT](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_hard_light/) | Corrisponde al valore 'hard_light'. |
| const [SVG_FEBLEND_MODE_HUE](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_hue/) | Corrisponde al valore 'tonalità'. |
| const [SVG_FEBLEND_MODE_LIGHTEN](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_lighten/) | Corrisponde al valore 'schiarire'. |
| const [SVG_FEBLEND_MODE_LUMINOSITY](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_luminosity/) | Corrisponde al valore 'luminosità'. |
| const [SVG_FEBLEND_MODE_MULTIPLY](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_multiply/) | Corrisponde al valore 'moltiplica'. |
| const [SVG_FEBLEND_MODE_NORMAL](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_normal/) | Corrisponde al valore 'normale'. |
| const [SVG_FEBLEND_MODE_OVERLAY](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_overlay/) | Corrisponde al valore 'overlay'. |
| const [SVG_FEBLEND_MODE_SATURATION](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_saturation/) | Corrisponde al valore 'saturazione'. |
| const [SVG_FEBLEND_MODE_SCREEN](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_screen/) | Corrisponde al valore 'schermo'. |
| const [SVG_FEBLEND_MODE_SOFT_LIGHT](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_soft_light/) | Corrisponde al valore 'soft_light'. |
| const [SVG_FEBLEND_MODE_UNKNOWN](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_unknown/) | Il tipo non è uno dei tipi predefiniti. Non è valido tentare di definire un nuovo valore di questo tipo o tentare di convertire un valore esistente in questo tipo. |
...
* spazio dei nomi [Aspose.Html.Dom.Svg.Filters](../../aspose.html.dom.svg.filters/)
