...
description: Aspose.Html.HTMLTableSectionElement classe. IlTESTA TFOOT  ETBODY elementi.
type: docs
weight: 3590
url: /it/net/aspose.html/htmltablesectionelement/
---
## HTMLTableSectionElement class

Il`TESTA` ,`TFOOT` , E`TBODY` elementi.
...
| Nome | Descrizione |
| --- | --- |
| [Align](../../aspose.html/htmltablesectionelement/align/) { get; set; } | Allineamento orizzontale dei dati nelle celle. Vedi il`allineare` attributo per HTMLTheadElement per i dettagli. |
...
| [Ch](../../aspose.html/htmltablesectionelement/ch/) { get; set; } | Carattere di allineamento per le celle in una colonna. Vedi la definizione dell'attributo char in HTML 4.01. |
...
| [ChOff](../../aspose.html/htmltablesectionelement/choff/) { get; set; } | Offset del carattere di allineamento. Vedi la definizione dell'attributo charoff in HTML 4.01. |
...
| [Rows](../../aspose.html/htmltablesectionelement/rows/) { get; } | La raccolta di righe in questa sezione della tabella. |
...
| [VAlign](../../aspose.html/htmltablesectionelement/valign/) { get; set; } | Allineamento verticale dei dati nelle celle. Vedi il`valign` attributo per HTMLTheadElement per i dettagli. |
...
| [DeleteRow](../../aspose.html/htmltablesectionelement/deleterow/)(int) | Elimina una riga da questa sezione. |
...
| [InsertRow](../../aspose.html/htmltablesectionelement/insertrow/)(int) | Inserisci una riga in questa sezione. La nuova riga viene inserita immediatamente prima della corrente`indice` esima riga in questa sezione. Se `indice` è -1 o uguale al numero di righe in questa sezione , la nuova riga viene aggiunta. |
