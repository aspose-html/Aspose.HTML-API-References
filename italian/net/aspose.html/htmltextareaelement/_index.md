...
description: Aspose.Html.HTMLTextAreaElement classe. Campo di testo multilinea. Vedere la definizione dellelemento TEXTAREA in HTML 4.01.
type: docs
weight: 3610
url: /it/net/aspose.html/htmltextareaelement/
---
## HTMLTextAreaElement class

Campo di testo multilinea. Vedere la definizione dell'elemento TEXTAREA in HTML 4.01.
...
| Nome | Descrizione |
| --- | --- |
| [AccessKey](../../aspose.html/htmltextareaelement/accesskey/) { get; set; } | Una chiave di accesso a carattere singolo per dare accesso al controllo del modulo. Vedi la definizione dell'attributo accesskey in HTML 4.01. |
...
| [Cols](../../aspose.html/htmltextareaelement/cols/) { get; set; } | Ampiezza del controllo (in caratteri). Vedere la definizione dell'attributo cols in HTML 4.01. |
| [DefaultValue](../../aspose.html/htmltextareaelement/defaultvalue/) { get; set; } | Rappresenta il contenuto dell'elemento. Il valore di questo attributo non cambia se il contenuto del controllo del modulo corrispondente, in un agente utente interattivo, cambia. @version DOM Level 2 |
...
| [Disabled](../../aspose.html/htmltextareaelement/disabled/) { get; set; } | Il controllo non è disponibile in questo contesto. Vedi la definizione dell'attributo disabilitato in HTML 4.01. |
...
| [Form](../../aspose.html/htmltextareaelement/form/) { get; } | Restituisce il`MODULO` elemento che contiene questo controllo. Restituisce `nullo` se questo controllo non è all'interno del contesto di un modulo . |
...
| [Name](../../aspose.html/htmltextareaelement/name/) { get; set; } | Controllo modulo o nome oggetto quando inviato con un modulo. Vedi la definizione dell'attributo name in HTML 4.01. |
...
| [ReadOnly](../../aspose.html/htmltextareaelement/readonly/) { get; set; } | Questo controllo è di sola lettura. Vedi la definizione dell'attributo di sola lettura in HTML 4.01. |
| [Rows](../../aspose.html/htmltextareaelement/rows/) { get; set; } | Numero di righe di testo. Vedi la definizione dell'attributo rows in HTML 4.01. |
...
| [TabIndex](../../aspose.html/htmltextareaelement/tabindex/) { get; set; } | Indice che rappresenta la posizione dell'elemento nell'ordine di tabulazione. Vedi la definizione dell'attributo tabindex in HTML 4.01. |
...
| [Type](../../aspose.html/htmltextareaelement/type/) { get; } | Il tipo di questo controllo modulo. Questa è la stringa "textarea". |
| [Value](../../aspose.html/htmltextareaelement/value/) { get; set; } | Rappresenta il contenuto corrente del controllo del modulo corrispondente, in un agente utente interattivo. La modifica di questo attributo modifica il contenuto di del controllo del modulo, ma non modifica il contenuto dell'elemento . Se la totalità dei dati non può rientrare in un singolo `DOMStringa` , l'implementazione potrebbe troncare i dati. |
