...
description: Aspose.Html.HTMLMapElement classe. Mappa immagine lato client. Vedi la definizione dellelemento MAP in HTML 4.01.
type: docs
weight: 3380
url: /it/net/aspose.html/htmlmapelement/
---
...
| Nome | Descrizione |
| --- | --- |
| [Areas](../../aspose.html/htmlmapelement/areas/) { get; } | L'elenco delle aree definite per la mappa immagine. |
...
| [Name](../../aspose.html/htmlmapelement/name/) { get; set; } | Assegna un nome alla mappa (da utilizzare con`usemap` ). Vedi la definizione dell'attributo name in HTML 4.01. |
