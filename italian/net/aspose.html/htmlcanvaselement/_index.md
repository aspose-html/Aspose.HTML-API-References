...
description: Aspose.Html.HTMLCanvasElement classe. Linterfaccia HTMLCanvasElement fornisce proprietà e metodi per manipolare il layout e la presentazione degli elementi canvas. Linterfaccia HTMLCanvasElement eredita anche le proprietà ei metodi dellinterfaccia HTMLElement.
type: docs
weight: 3140
url: /it/net/aspose.html/htmlcanvaselement/
---
## HTMLCanvasElement class

L'interfaccia HTMLCanvasElement fornisce proprietà e metodi per manipolare il layout e la presentazione degli elementi canvas. L'interfaccia HTMLCanvasElement eredita anche le proprietà ei metodi dell'interfaccia HTMLElement.
...
| [Height](../../aspose.html/htmlcanvaselement/height/) { get; set; } | È un numero intero positivo che riflette l'attributo HTML height dell'elemento canvas interpretato in pixel CSS. Quando l'attributo non è specificato o se è impostato su un valore non valido, come un valore negativo, viene utilizzato il valore predefinito di 150. |
...
| [Width](../../aspose.html/htmlcanvaselement/width/) { get; set; } | È un numero intero positivo che riflette l'attributo HTML width dell'elemento canvas interpretato in pixel CSS. Quando l'attributo non è specificato o se è impostato su un valore non valido, come un valore negativo, viene utilizzato il valore predefinito 300. |
...
| [GetContext](../../aspose.html/htmlcanvaselement/getcontext/)(string) | Restituisce un contesto di disegno nell'area di disegno o null se l'ID contesto non è supportato. Un contesto di disegno ti consente di disegnare sulla tela. |
...
| [ToDataURL](../../aspose.html/htmlcanvaselement/todataurl/#todataurl)() | restituisce un URI di dati contenente una rappresentazione dell'immagine nel formato specificato dal parametro type (il valore predefinito è PNG). L'immagine restituita ha una risoluzione di 96 dpi. |
| [ToDataURL](../../aspose.html/htmlcanvaselement/todataurl/#todataurl_1)(string) | restituisce un URI di dati contenente una rappresentazione dell'immagine nel formato specificato dal parametro type (il valore predefinito è PNG). L'immagine restituita ha una risoluzione di 96 dpi. |
| [ToDataURL](../../aspose.html/htmlcanvaselement/todataurl/#todataurl_2)(string, double) | restituisce un URI di dati contenente una rappresentazione dell'immagine nel formato specificato dal parametro type (il valore predefinito è PNG). L'immagine restituita ha una risoluzione di 96 dpi. |
