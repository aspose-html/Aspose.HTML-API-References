...
description: Aspose.Html.HTMLHeadElement classe. Informazioni sulla testata del documento. Vedi la definizione dellelemento HEAD in HTML 4.01.
type: docs
weight: 3270
url: /it/net/aspose.html/htmlheadelement/
---
## HTMLHeadElement class

Informazioni sulla testata del documento. Vedi la definizione dell'elemento HEAD in HTML 4.01.
...
| [Profile](../../aspose.html/htmlheadelement/profile/) { get; set; } | URI [[RFC 2396 dell'IETF](http://www.ietf.org/rfc/rfc2396.txt) ] che designa un profilo di metadati. Vedere la definizione dell'attributo del profilo in HTML 4.01. |
