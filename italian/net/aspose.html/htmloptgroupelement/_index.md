...
description: Aspose.Html.HTMLOptGroupElement classe. Raggruppa le opzioni in suddivisioni logiche. Vedere la definizione dellelemento OPTGROUP in HTML 4.01.
type: docs
weight: 3450
url: /it/net/aspose.html/htmloptgroupelement/
---
## HTMLOptGroupElement class

Raggruppa le opzioni in suddivisioni logiche. Vedere la definizione dell'elemento OPTGROUP in HTML 4.01.
...
| [Disabled](../../aspose.html/htmloptgroupelement/disabled/) { get; set; } | Il controllo non è disponibile in questo contesto. Vedi la definizione dell'attributo disabilitato in HTML 4.01. |
...
| [Label](../../aspose.html/htmloptgroupelement/label/) { get; set; } | Assegna un'etichetta a questo gruppo di opzioni. Vedi l'attributo label definition in HTML 4.01. |
