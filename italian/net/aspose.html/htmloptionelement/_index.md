...
description: Aspose.Html.HTMLOptionElement classe. Una scelta selezionabile. Vedere la definizione dellelemento OPTION in HTML 4.01.
type: docs
weight: 3460
url: /it/net/aspose.html/htmloptionelement/
---
## HTMLOptionElement class

Una scelta selezionabile. Vedere la definizione dell'elemento OPTION in HTML 4.01.
...
| [DefaultSelected](../../aspose.html/htmloptionelement/defaultselected/) { get; set; } | Rappresenta il valore dell'attributo HTML selezionato. Il valore di questo attributo non cambia se lo stato del corrispondente controllo del modulo , in un agente utente interattivo, cambia. Vedi la definizione dell'attributo selezionato in HTML 4.01. @version DOM Level 2 |
...
| [Disabled](../../aspose.html/htmloptionelement/disabled/) { get; set; } | Il controllo non è disponibile in questo contesto. Vedi la definizione dell'attributo disabilitato in HTML 4.01. |
...
| [Form](../../aspose.html/htmloptionelement/form/) { get; } | Restituisce il`MODULO` elemento che contiene questo controllo. Restituisce `nullo` se questo controllo non è all'interno del contesto di un modulo . |
| [Id](../../aspose.html/htmlelement/id/) { get; set; } | Identificatore dell'elemento. Vedi la definizione dell'attributo id in HTML 4.01. |
| [Index](../../aspose.html/htmloptionelement/index/) { get; } | L'indice di this`OPZIONE` nel suo genitore`SELEZIONARE` , a partire da 0. @versione DOM Livello 2 |
...
| [Label](../../aspose.html/htmloptionelement/label/) { get; set; } | Etichetta opzione da utilizzare nei menu gerarchici. Vedi la definizione dell'attributo label in HTML 4.01. |
...
| [Selected](../../aspose.html/htmloptionelement/selected/) { get; set; } | Rappresenta lo stato corrente del controllo del modulo corrispondente, in un agente utente interattivo . La modifica di questo attributo modifica lo stato di il controllo del modulo, ma non modifica il valore dell'attributo HTML selezionato dell'elemento. |
...
| [Text](../../aspose.html/htmloptionelement/text/) { get; } | Il testo contenuto all'interno dell'elemento option. |
...
| [Value](../../aspose.html/htmloptionelement/value/) { get; set; } | Il valore di controllo del modulo corrente. Vedi la definizione dell'attributo value in HTML 4.01. |
