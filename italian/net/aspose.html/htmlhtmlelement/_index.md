...
description: Aspose.Html.HTMLHtmlElement classe. Radice di un documento HTML. Vedi la definizione dellelemento HTML in HTML 4.01.
type: docs
weight: 3290
url: /it/net/aspose.html/htmlhtmlelement/
---
...
| [Version](../../aspose.html/htmlhtmlelement/version/) { get; set; } | Informazioni sulla versione del DTD del documento. Vedere la definizione dell'attributo di versione in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
