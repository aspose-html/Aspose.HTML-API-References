...
description: Aspose.Html.HTMLQuoteElement classe. Per ilQ EBLOCCOelementi. Vedere la definizione dellelemento Q in HTML 4.01.
type: docs
weight: 3500
url: /it/net/aspose.html/htmlquoteelement/
---
## HTMLQuoteElement class

Per il`Q` E`BLOCCO`elementi. Vedere la definizione dell'elemento Q in HTML 4.01.
...
| [Cite](../../aspose.html/htmlquoteelement/cite/) { get; set; } | Un URI [[RFC 2396 dell'IETF](http://www.ietf.org/rfc/rfc2396.txt) ] che designa un documento o un messaggio di origine. Vedi la definizione dell'attributo cite in HTML 4.01. |
