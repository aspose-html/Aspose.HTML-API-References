...
description: Aspose.Html.HTMLHeadingElement classe. Per ilH1 AH6 elementi. Vedi la definizione H1 element in HTML 4.01.
type: docs
weight: 3280
url: /it/net/aspose.html/htmlheadingelement/
---
## HTMLHeadingElement class

Per il`H1` A`H6` elementi. Vedi la definizione H1 element in HTML 4.01.
...
| Nome | Descrizione |
| --- | --- |
| [Align](../../aspose.html/htmlheadingelement/align/) { get; set; } | Allineamento orizzontale del testo. Vedere la definizione dell'attributo align in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
