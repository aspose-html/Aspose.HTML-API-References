...
description: Aspose.Html.HTMLBodyElement classe. Il corpo del documento HTML. Questo elemento è sempre presente nellAPI DOM anche se i tag non sono presenti nel documento sorgente. Vedere la definizione dellelemento BODY in HTML 4.01.
type: docs
weight: 3120
url: /it/net/aspose.html/htmlbodyelement/
---
## HTMLBodyElement class

Il corpo del documento HTML. Questo elemento è sempre presente nell'API DOM, anche se i tag non sono presenti nel documento sorgente. Vedere la definizione dell'elemento BODY in HTML 4.01.
...
| Nome | Descrizione |
| --- | --- |
| [ALink](../../aspose.html/htmlbodyelement/alink/) { get; set; } | Colore dei collegamenti attivi (dopo il pulsante del mouse in basso, ma prima del pulsante del mouse in alto). Vedere la definizione dell'attributo alink in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
...
| [Background](../../aspose.html/htmlbodyelement/background/) { get; set; } | URI [[RFC 2396 dell'IETF](http://www.ietf.org/rfc/rfc2396.txt) ] dell'immagine del riquadro della texture di sfondo. Vedere la definizione dell'attributo background in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
...
| [BgColor](../../aspose.html/htmlbodyelement/bgcolor/) { get; set; } | Colore di sfondo del documento. Vedere la definizione dell'attributo bgcolor in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
...
| [Link](../../aspose.html/htmlbodyelement/link/) { get; set; } | Colore dei collegamenti non attivi e non visitati. Vedere la definizione dell'attributo link in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
...
| [Text](../../aspose.html/htmlbodyelement/text/) { get; set; } | Colore del testo del documento. Vedere la definizione dell'attributo di testo in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
...
| [VLink](../../aspose.html/htmlbodyelement/vlink/) { get; set; } | Colore dei collegamenti che sono stati visitati dall'utente. Vedere la definizione dell'attributo vlink in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
