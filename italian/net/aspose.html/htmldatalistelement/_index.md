...
description: Aspose.Html.HTMLDataListElement classe. Lelemento datalist rappresenta un insieme di elementi option che rappresentano opzioni predefinite per altri controlli. Vedi anche ilHTML 5.2 Raccomandazione W3C .
type: docs
weight: 3160
url: /it/net/aspose.html/htmldatalistelement/
---
## HTMLDataListElement class

L'elemento datalist rappresenta un insieme di elementi option che rappresentano opzioni predefinite per altri controlli. Vedi anche il[HTML 5.2 Raccomandazione W3C](https://www.w3.org/TR/html52/sec-forms.html#elementdef-datalist) .
...
| [Options](../../aspose.html/htmldatalistelement/options/) { get; } | La collezione di`OPZIONE`elementi contenuti da questo elemento . |
