...
description: Aspose.Html.HTMLIFrameElement classe. Sottofinestre incorporate. Vedi la definizione dellelemento IFRAME in HTML 4.01.
type: docs
weight: 3300
url: /it/net/aspose.html/htmliframeelement/
---
## HTMLIFrameElement class

Sottofinestre incorporate. Vedi la definizione dell'elemento IFRAME in HTML 4.01.
...
| Nome | Descrizione |
| --- | --- |
| [Align](../../aspose.html/htmliframeelement/align/) { get; set; } | Allinea questo oggetto (verticalmente o orizzontalmente) rispetto al suo testo circostante. Vedere la definizione dell'attributo align in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
...
| [FrameBorder](../../aspose.html/htmliframeelement/frameborder/) { get; set; } | Richiedi i bordi del frame. Vedere la definizione dell'attributo frameborder in HTML 4.01. |
| [Height](../../aspose.html/htmliframeelement/height/) { get; set; } | Altezza telaio. Vedi la definizione dell'attributo height in HTML 4.01. |
...
| [LongDesc](../../aspose.html/htmliframeelement/longdesc/) { get; set; } | URI [[RFC 2396 dell'IETF](http://www.ietf.org/rfc/rfc2396.txt) ] che designa una lunga descrizione di questa immagine o cornice. Vedere la definizione dell'attributo longdesc in HTML 4.01. |
| [MarginHeight](../../aspose.html/htmliframeelement/marginheight/) { get; set; } | Altezza del margine del fotogramma, in pixel. Vedi la definizione dell'attributo marginheight in HTML 4.01. |
| [MarginWidth](../../aspose.html/htmliframeelement/marginwidth/) { get; set; } | Larghezza del margine del fotogramma, in pixel. Vedi la definizione dell'attributo marginwidth in HTML 4.01. |
| [Name](../../aspose.html/htmliframeelement/name/) { get; set; } | Il nome del frame (oggetto del file`bersaglio` attributo). Vedere la definizione dell'attributo nome in HTML 4.01. |
...
| [Scrolling](../../aspose.html/htmliframeelement/scrolling/) { get; set; } | Specifica se il frame deve avere o meno barre di scorrimento. Vedi la definizione dell'attributo di scorrimento in HTML 4.01. |
...
| [Src](../../aspose.html/htmliframeelement/src/) { get; set; } | Un URI [[RFC 2396 dell'IETF](http://www.ietf.org/rfc/rfc2396.txt) ] che designa il contenuto del frame iniziale. Vedere la definizione dell'attributo src in HTML 4.01. |
...
| [Width](../../aspose.html/htmliframeelement/width/) { get; set; } | Larghezza telaio. Vedi la definizione dell'attributo width in HTML 4.01. |
