...
description: Aspose.Html.HTMLLinkElement classe. IlCOLLEGAMENTOLelemento specifica un collegamento a una risorsa esterna e definisce la relazione di questo documento con quella risorsa o viceversa. Vedi la definizione dellelemento LINK in HTML 4.01 vedi anche LinkStyle interfaccia nel modulo StyleSheet Fogli di stile DOM di livello 2 e CSS .
type: docs
weight: 3370
url: /it/net/aspose.html/htmllinkelement/
---
## HTMLLinkElement class

Il`COLLEGAMENTO`L'elemento specifica un collegamento a una risorsa esterna e definisce la relazione di questo documento con quella risorsa (o viceversa). Vedi la definizione dell'elemento LINK in HTML 4.01 (vedi anche `LinkStyle` interfaccia nel modulo StyleSheet [[Fogli di stile DOM di livello 2 e CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113) ]).
...
| [Charset](../../aspose.html/htmllinkelement/charset/) { get; set; } | La codifica dei caratteri della risorsa collegata. Vedere la definizione dell'attributo charset in HTML 4.01. |
...
| [Disabled](../../aspose.html/htmllinkelement/disabled/) { get; set; } | Abilita/disabilita il collegamento. Questo è attualmente utilizzato solo per i collegamenti ai fogli di stile e può essere utilizzato per attivare o disattivare i fogli di stile. |
...
| [Href](../../aspose.html/htmllinkelement/href/) { get; set; } | L'URI [[RFC 2396 dell'IETF](http://www.ietf.org/rfc/rfc2396.txt) ] della risorsa collegata. Vedi la definizione dell'attributo href in HTML 4.01. |
| [Hreflang](../../aspose.html/htmllinkelement/hreflang/) { get; set; } | Codice della lingua della risorsa collegata. Vedi la definizione dell'attributo hreflang in HTML 4.01. |
...
| [Media](../../aspose.html/htmllinkelement/media/) { get; set; } | Progettato per l'uso con uno o più supporti di destinazione. Vedi la definizione dell'attributo multimediale in HTML 4.01. |
...
| [Rel](../../aspose.html/htmllinkelement/rel/) { get; set; } | Tipo di collegamento in avanti. Vedere la definizione dell'attributo rel in HTML 4.01. |
| [RelList](../../aspose.html/htmllinkelement/rellist/) { get; } | Restituisce un DOMTokenList attivo che contiene i token ricevuti dall'analisi dell'attributo "rel". |
| [Rev](../../aspose.html/htmllinkelement/rev/) { get; set; } | Tipo di collegamento inverso. Vedi la definizione dell'attributo rev in HTML 4.01. |
...
| [Sheet](../../aspose.html/htmllinkelement/sheet/) { get; } | Ottiene il foglio di stile associato. |
...
| [Target](../../aspose.html/htmllinkelement/target/) { get; set; } | Frame in cui eseguire il rendering della risorsa. Vedere la definizione dell'attributo target in HTML 4.01. |
...
| [Type](../../aspose.html/htmllinkelement/type/) { get; set; } | Tipo di contenuto consultivo. Vedi la definizione dell'attributo type in HTML 4.01. |
