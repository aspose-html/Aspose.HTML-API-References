...
description: Aspose.Html.HTMLBaseElement classe. URI base documento RFC 2396 dellIETF . Vedi la definizione dellelemento BASE in HTML 4.01.
type: docs
weight: 3100
url: /it/net/aspose.html/htmlbaseelement/
---
## HTMLBaseElement class

URI base documento [[RFC 2396 dell'IETF](http://www.ietf.org/rfc/rfc2396.txt) ]. Vedi la definizione dell'elemento BASE in HTML 4.01.
...
| [Href](../../aspose.html/htmlbaseelement/href/) { get; set; } | L'URI di base [[RFC 2396 dell'IETF](http://www.ietf.org/rfc/rfc2396.txt) ]. Vedi la definizione dell'attributo href in HTML 4.01. |
...
| [Target](../../aspose.html/htmlbaseelement/target/) { get; set; } | Il frame di destinazione predefinito. Vedi la definizione dell'attributo target in HTML 4.01. |
