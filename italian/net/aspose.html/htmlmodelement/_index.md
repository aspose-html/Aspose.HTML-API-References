...
description: Aspose.Html.HTMLModElement classe. Avviso di modifica di parte di un documento. Vedere le definizioni degli elementi INS e DEL in HTML 4.01.
type: docs
weight: 3410
url: /it/net/aspose.html/htmlmodelement/
---
## HTMLModElement class

Avviso di modifica di parte di un documento. Vedere le definizioni degli elementi INS e DEL in HTML 4.01.
...
| [Cite](../../aspose.html/htmlmodelement/cite/) { get; set; } | Un URI [[RFC 2396 dell'IETF](http://www.ietf.org/rfc/rfc2396.txt) ] che designa un documento che descrive il motivo della modifica. Vedi la definizione dell'attributo cite in HTML 4.01. |
...
| [DateTime](../../aspose.html/htmlmodelement/datetime/) { get; set; } | La data e l'ora della modifica. Vedi la definizione dell'attributo datetime in HTML 4.01. |
