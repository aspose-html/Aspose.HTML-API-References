...
description: Aspose.Html.HTMLMenuElement classe. Elenco dei menu. Vedere la definizione dellelemento MENU in HTML 4.01. Questo elemento è deprecato in HTML 4.01.
type: docs
weight: 3390
url: /it/net/aspose.html/htmlmenuelement/
---
## HTMLMenuElement class

Elenco dei menu. Vedere la definizione dell'elemento MENU in HTML 4.01. Questo elemento è deprecato in HTML 4.01.
...
| [Compact](../../aspose.html/htmlmenuelement/compact/) { get; set; } | Riduci la spaziatura tra gli elementi dell'elenco. Vedere la definizione dell'attributo compatto in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
