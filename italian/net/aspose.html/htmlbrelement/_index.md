...
description: Aspose.Html.HTMLBRElement classe. Forza uninterruzione di riga. Vedi la definizione dellelemento BR in HTML 4.01.
type: docs
weight: 3090
url: /it/net/aspose.html/htmlbrelement/
---
## HTMLBRElement class
...
| [Clear](../../aspose.html/htmlbrelement/clear/) { get; set; } | Controlla il flusso del testo attorno ai float. Vedere la chiara definizione dell'attributo in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
