...
description: Aspose.Html.HTMLLIElement classe. Voce di elenco. Vedi la definizione dellelemento LI in HTML 4.01.
type: docs
weight: 3340
url: /it/net/aspose.html/htmllielement/
---
## HTMLLIElement class

Voce di elenco. Vedi la definizione dell'elemento LI in HTML 4.01.
...
| [Type](../../aspose.html/htmllielement/type/) { get; set; } | Stile punto elenco elemento elenco. Vedere la definizione dell'attributo type in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
| [Value](../../aspose.html/htmllielement/value/) { get; set; } | Ripristina il numero di sequenza quando utilizzato in`OL` . Vedere la definizione dell'attributo value in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
