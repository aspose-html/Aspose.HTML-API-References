...
description: Aspose.Html.HTMLDListElement classe. Elenco delle definizioni. Vedi la definizione dellelemento DL in HTML 4.01.
type: docs
weight: 3150
url: /it/net/aspose.html/htmldlistelement/
---
## HTMLDListElement class

Elenco delle definizioni. Vedi la definizione dell'elemento DL in HTML 4.01.
...
| [Compact](../../aspose.html/htmldlistelement/compact/) { get; set; } | Riduci la spaziatura tra gli elementi dell'elenco. Vedere la definizione dell'attributo compatto in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
