...
description: Aspose.Html.HTMLInputElement classe. Controllo modulo. A seconda dellambiente in cui la pagina viene visualizzata la proprietà value può essere di sola lettura per il tipo di input di caricamento file . Per il tipo di input password il valore effettivo restituito può essere mascherato per impedire luso non autorizzato. Vedere la definizione dellelemento INPUT in HTML 4.01 .
type: docs
weight: 3320
url: /it/net/aspose.html/htmlinputelement/
---
## HTMLInputElement class

Controllo modulo. A seconda dell'ambiente in cui la pagina viene visualizzata, la proprietà value può essere di sola lettura per il tipo di input di caricamento file . Per il tipo di input "password", il valore effettivo restituito può essere mascherato per impedire l'uso non autorizzato. Vedere la definizione dell'elemento INPUT in [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224) ].
...
| Nome | Descrizione |
| --- | --- |
| [Accept](../../aspose.html/htmlinputelement/accept/) { get; set; } | Un elenco separato da virgole di tipi di contenuto che un server che elabora questo modulo gestirà correttamente. Vedi la definizione dell'attributo accept in HTML 4.01. |
| [AccessKey](../../aspose.html/htmlinputelement/accesskey/) { get; set; } | Una chiave di accesso a carattere singolo per dare accesso al controllo del modulo. Vedi la definizione dell'attributo accesskey in HTML 4.01. |
| [Align](../../aspose.html/htmlinputelement/align/) { get; set; } | Allinea questo oggetto (verticalmente o orizzontalmente) rispetto al suo testo circostante. Vedere la definizione dell'attributo align in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
| [Alt](../../aspose.html/htmlinputelement/alt/) { get; set; } | Testo alternativo per i programmi utente che non riproducono il contenuto normale di questo elemento . Vedi la definizione dell'attributo alt in HTML 4.01. |
...
| [Checked](../../aspose.html/htmlinputelement/checked/) { get; set; } | Quando il`tipo`l'attributo dell'elemento ha il valore "radio" o "checkbox", questo rappresenta lo stato corrente del modulo control, in un programma utente interattivo. Le modifiche a questo attributo modificano lo stato del controllo del modulo, ma non modificano il valore di l'attributo HTML verificato dell'elemento INPUT. Durante la gestione di un evento clic su un elemento di input con un attributo di tipo che ha il value "radio" o "checkbox", alcune implementazioni potrebbero modificare il valore di questa proprietà prima che l'evento venga inviato nel documento . Se l'azione predefinita dell'evento viene annullata, il valore della proprietà può essere riportato al suo valore originale. Ciò significa che il valore di questa proprietà durante la gestione degli eventi clic dipende dall'implementazione. |
...
| [DefaultChecked](../../aspose.html/htmlinputelement/defaultchecked/) { get; set; } | Quando`tipo` ha il valore "radio" o "checkbox", questo rappresenta l'attributo HTML verificato dell'elemento. Il valore di questo attributo non cambia se lo stato del corrispondente modulo control, in un agente utente interattivo, cambia. Vedi la definizione dell'attributo verificato in HTML 4.01. |
| [DefaultValue](../../aspose.html/htmlinputelement/defaultvalue/) { get; set; } | Quando il`tipo`l'attributo dell'elemento ha il valore "testo", "file" o "password", questo rappresenta il valore HTML dell'attributo dell'elemento. Il valore di questo attributo non cambia se il contenuto del controllo del modulo corrispondente, in un agente utente interattivo, cambia. Vedi la definizione dell'attributo value in HTML 4.01. |
...
| [Disabled](../../aspose.html/htmlinputelement/disabled/) { get; set; } | Il controllo non è disponibile in questo contesto. Vedi la definizione dell'attributo disabilitato in HTML 4.01. |
| [Files](../../aspose.html/htmlinputelement/files/) { get; } | L'attributo files IDL consente agli script di accedere ai file selezionati dell'elemento. Al momento dell'acquisizione, se l'attributo IDL si applica, deve restituire un oggetto FileList che rappresenta i file attualmente selezionati. Lo stesso oggetto deve essere restituito finché l'elenco dei file selezionati non cambia. Se l'attributo IDL non si applica, deve invece restituire null. [FILEAPI] |
...
| [Form](../../aspose.html/htmlinputelement/form/) { get; set; } | Restituisce il`MODULO` elemento che contiene questo controllo. Restituisce `nullo` se questo controllo non è all'interno del contesto di un modulo . |
...
| [List](../../aspose.html/htmlinputelement/list/) { get; set; } | L'attributo list viene utilizzato per identificare un elemento che elenca opzioni predefinite suggerite all'utente. Se presente, il suo valore deve essere l'ID di un elemento datalist nello stesso documento. |
...
| [MaxLength](../../aspose.html/htmlinputelement/maxlength/) { get; set; } | Numero massimo di caratteri per i campi di testo, quando`tipo` ha il valore "testo" o "password". Vedi la definizione dell'attributo maxlength in HTML 4.01. |
| [Name](../../aspose.html/htmlinputelement/name/) { get; set; } | Controllo modulo o nome oggetto quando inviato con un modulo. Vedi la definizione dell'attributo name in HTML 4.01. |
...
| [ReadOnly](../../aspose.html/htmlinputelement/readonly/) { get; set; } | Questo controllo è di sola lettura. Rilevante solo quando`tipo` ha il valore "testo" o "password". Vedi la definizione dell'attributo di sola lettura in HTML 4.01. |
...
| [Size](../../aspose.html/htmlinputelement/size/) { get; set; } | Informazioni sulle dimensioni. Il significato preciso è specifico per ogni tipo di campo . Vedi la definizione dell'attributo size in HTML 4.01. @version DOM Level 2 |
| [Src](../../aspose.html/htmlinputelement/src/) { get; set; } | Quando il`tipo`attributo ha il valore "immagine", questo attributo specifica la posizione dell'immagine da utilizzare per decorare il pulsante grafico di invio. Vedere la definizione dell'attributo src in HTML 4.01. |
...
| [TabIndex](../../aspose.html/htmlinputelement/tabindex/) { get; set; } | Indice che rappresenta la posizione dell'elemento nell'ordine di tabulazione. Vedi la definizione dell'attributo tabindex in HTML 4.01. |
...
| [Type](../../aspose.html/htmlinputelement/type/) { get; set; } | Il tipo di controllo creato (tutto minuscolo). Vedere la definizione dell'attributo type in HTML 4.01. @versione DOM Livello 2 |
| [UseMap](../../aspose.html/htmlinputelement/usemap/) { get; set; } | Usa mappa immagine lato client. Vedi la definizione dell'attributo usemap in HTML 4.01. |
| [Value](../../aspose.html/htmlinputelement/value/) { get; set; } | Quando il`tipo` l'attributo dell'elemento ha il valore "testo", "file" o "password", questo rappresenta il contenuto corrente di il controllo del modulo corrispondente, in un programma utente interattivo. La modifica di questo attributo modifica il contenuto del controllo del modulo, ma non modifica il valore dell'attributo HTML value dell'elemento. Quando il`tipo`l'attributo dell'elemento ha il valore "button", "hidden", "submit", "reset", "image", "checkbox" o "radio", questo rappresenta l'attributo del valore HTML dell'elemento. Vedi la definizione dell'attributo value in HTML 4.01. |
