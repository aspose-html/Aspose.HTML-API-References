...
description: Aspose.Html.HTMLAreaElement classe. Definizione area mappa immagine lato client. Vedere la definizione dellelemento AREA in HTML 4.01.
type: docs
weight: 3080
url: /it/net/aspose.html/htmlareaelement/
---
## HTMLAreaElement class

Definizione area mappa immagine lato client. Vedere la definizione dell'elemento AREA in HTML 4.01.
...
| Nome | Descrizione |
| --- | --- |
| [AccessKey](../../aspose.html/htmlareaelement/accesskey/) { get; set; } | Una chiave di accesso a carattere singolo per dare accesso al controllo del modulo. Vedi la definizione dell'attributo accesskey in HTML 4.01. |
| [Alt](../../aspose.html/htmlareaelement/alt/) { get; set; } | Testo alternativo per i programmi utente che non riproducono il contenuto normale di questo elemento . Vedi la definizione dell'attributo alt in HTML 4.01. |
...
| [Coords](../../aspose.html/htmlareaelement/coords/) { get; set; } | Elenco di lunghezze separate da virgole, che definiscono una geometria della regione attiva. Vedi anche`forma` per la forma della regione. Vedi la definizione dell'attributo coords in HTML 4.01. |
...
| [Href](../../aspose.html/htmlareaelement/href/) { get; set; } | L'URI [[RFC 2396 dell'IETF](http://www.ietf.org/rfc/rfc2396.txt) ] della risorsa collegata. Vedi la definizione dell'attributo href in HTML 4.01. |
...
| [NoHref](../../aspose.html/htmlareaelement/nohref/) { get; set; } | Specifica che quest'area è inattiva, cioè non ha alcuna azione associata. Vedi la definizione dell'attributo nohref in HTML 4.01. |
...
| [RelList](../../aspose.html/htmlareaelement/rellist/) { get; } | Restituisce un DOMTokenList attivo che contiene i token ricevuti dall'analisi dell'attributo "rel". |
...
| [Shape](../../aspose.html/htmlareaelement/shape/) { get; set; } | La forma dell'area attiva. Le coordinate sono date da `coordinate` . Vedi la definizione dell'attributo shape in HTML 4.01. |
...
| [TabIndex](../../aspose.html/htmlareaelement/tabindex/) { get; set; } | Indice che rappresenta la posizione dell'elemento nell'ordine di tabulazione. Vedi la definizione dell'attributo tabindex in HTML 4.01. |
| [TagName](../../aspose.html.dom/element/tagname/) { get; } | Il nome dell'elemento. |
| [Target](../../aspose.html/htmlareaelement/target/) { get; set; } | Frame in cui eseguire il rendering della risorsa. Vedere la definizione dell'attributo target in HTML 4.01. |
