...
description: Aspose.Html.HTMLIsIndexElement classe. Questo elemento viene utilizzato per limmissione di testo a riga singola. Vedere la definizione dellelemento ISINDEX in HTML 4.01. Questo elemento è deprecato in HTML 4.01.
type: docs
weight: 3330
url: /it/net/aspose.html/htmlisindexelement/
---
## HTMLIsIndexElement class

Questo elemento viene utilizzato per l'immissione di testo a riga singola. Vedere la definizione dell'elemento ISINDEX in HTML 4.01. Questo elemento è deprecato in HTML 4.01.
...
| [Form](../../aspose.html/htmlisindexelement/form/) { get; } | Restituisce il elemento che contiene questo controllo. Restituisce se questo controllo non è all'interno del contesto di un modulo . |
...
| [Prompt](../../aspose.html/htmlisindexelement/prompt/) { get; set; } | Il messaggio di richiesta. Vedere la definizione dell'attributo prompt in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
