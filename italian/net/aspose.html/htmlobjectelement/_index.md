...
description: Aspose.Html.HTMLObjectElement classe. Oggetto incorporato generico. In linea di principio tutte le proprietà sullelemento oggetto sono di letturascrittura ma in alcuni ambienti alcune proprietà possono essere di sola lettura una volta creata listanza delloggetto sottostante. Vedere la definizione dellelemento OBJECT in HTML 4.01 .
type: docs
weight: 3440
url: /it/net/aspose.html/htmlobjectelement/
---
## HTMLObjectElement class

Oggetto incorporato generico. In linea di principio, tutte le proprietà sull'elemento oggetto sono di lettura-scrittura, ma in alcuni ambienti alcune proprietà possono essere di sola lettura una volta creata l'istanza dell'oggetto sottostante. Vedere la definizione dell'elemento OBJECT in [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224) ].
...
| Nome | Descrizione |
| --- | --- |
| [Align](../../aspose.html/htmlobjectelement/align/) { get; set; } | Allinea questo oggetto (verticalmente o orizzontalmente) rispetto al testo circostante. Vedere la definizione dell'attributo align in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
| [Archive](../../aspose.html/htmlobjectelement/archive/) { get; set; } | Elenco di archivi separati da spazi. Vedi la definizione dell'attributo di archivio in HTML 4.01. |
...
| [Border](../../aspose.html/htmlobjectelement/border/) { get; set; } | Larghezza del bordo intorno all'oggetto. Vedi la definizione dell'attributo border in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
...
| [ClassId](../../aspose.html/htmlobjectelement/classid/) { get; set; } | Definisce un valore ID classe come impostato nel registro di Windows o un URL |
...
| [Code](../../aspose.html/htmlobjectelement/code/) { get; set; } | File di classe Applet. Vedi il`codice` attributo per HTMLAppletElement. |
| [CodeBase](../../aspose.html/htmlobjectelement/codebase/) { get; set; } | URI di base [[RFC 2396 dell'IETF](http://www.ietf.org/rfc/rfc2396.txt) ] per`ID della classe` ,`dati` e `archivio` attributi. Vedi la definizione dell'attributo codebase in HTML 4.01. |
| [CodeType](../../aspose.html/htmlobjectelement/codetype/) { get; set; } | Tipo di contenuto per i dati scaricati tramite`ID della classe` attributo. Vedi la definizione dell'attributo codetype in HTML 4.01. |
| [Data](../../aspose.html/htmlobjectelement/data/) { get; set; } | Un URI [[RFC 2396 dell'IETF](http://www.ietf.org/rfc/rfc2396.txt) ] specificando la posizione dei dati dell'oggetto. Vedi la definizione dell'attributo data in HTML 4.01. |
| [Declare](../../aspose.html/htmlobjectelement/declare/) { get; set; } | Dichiara (per riferimento futuro), ma non istanziare, questo oggetto. Vedere la definizione dell'attributo di dichiarazione in HTML 4.01. |
...
| [Form](../../aspose.html/htmlobjectelement/form/) { get; set; } | Restituisce il`MODULO` elemento che contiene questo controllo. ritorna`nullo` se questo controllo non è all'interno del contesto di un modulo. |
| [Height](../../aspose.html/htmlobjectelement/height/) { get; set; } | Sostituisci altezza. Vedi la definizione dell'attributo height in HTML 4.01. |
| [Hspace](../../aspose.html/htmlobjectelement/hspace/) { get; set; } | Spazio orizzontale, in pixel, a sinistra ea destra di questa immagine, applet o oggetto. Vedere la definizione dell'attributo hspace in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
...
| [Name](../../aspose.html/htmlobjectelement/name/) { get; set; } | Controllo modulo o nome oggetto quando inviato con un modulo. Vedi la definizione dell'attributo name in HTML 4.01. |
...
| [Standby](../../aspose.html/htmlobjectelement/standby/) { get; set; } | Messaggio da visualizzare durante il caricamento dell'oggetto. Vedere la definizione dell'attributo standby in HTML 4.01. |
...
| [TabIndex](../../aspose.html/htmlobjectelement/tabindex/) { get; set; } | Indice che rappresenta la posizione dell'elemento nell'ordine di tabulazione. Vedi la definizione dell'attributo tabindex in HTML 4.01. |
...
| [Type](../../aspose.html/htmlobjectelement/type/) { get; set; } | Tipo di contenuto per i dati scaricati tramite`dati` attributo. Vedi la definizione dell'attributo type in HTML 4.01. |
| [UseMap](../../aspose.html/htmlobjectelement/usemap/) { get; set; } | Usa mappa immagine lato client. Vedi la definizione dell'attributo usemap in HTML 4.01. |
| [Vspace](../../aspose.html/htmlobjectelement/vspace/) { get; set; } | Spazio verticale, in pixel, sopra e sotto questa immagine, applet o oggetto. Vedere la definizione dell'attributo vspace in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
| [Width](../../aspose.html/htmlobjectelement/width/) { get; set; } | Sostituisci larghezza. Vedi la definizione dell'attributo width in HTML 4.01. |
