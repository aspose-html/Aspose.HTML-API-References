...
description: Aspose.Html.HTMLAppletElement classe. Unapplet Java incorporata. Vedere la definizione dellelemento APPLET in HTML 4.01. Questo elemento è deprecato in HTML 4.01.
type: docs
weight: 3070
url: /it/net/aspose.html/htmlappletelement/
---
## HTMLAppletElement class

Un'applet Java incorporata. Vedere la definizione dell'elemento APPLET in HTML 4.01. Questo elemento è deprecato in HTML 4.01.
...
| Nome | Descrizione |
| --- | --- |
| [Align](../../aspose.html/htmlappletelement/align/) { get; set; } | Allinea questo oggetto (verticalmente o orizzontalmente) rispetto al suo testo circostante. Vedere la definizione dell'attributo align in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
| [Alt](../../aspose.html/htmlappletelement/alt/) { get; set; } | Testo alternativo per i programmi utente che non riproducono il contenuto normale di questo elemento . Vedere la definizione dell'attributo alt in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
| [Archive](../../aspose.html/htmlappletelement/archive/) { get; set; } | Elenco archivi separati da virgole. Vedere la definizione dell'attributo di archivio in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
...
| [Code](../../aspose.html/htmlappletelement/code/) { get; set; } | File di classe Applet. Vedere la definizione dell'attributo del codice in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
| [CodeBase](../../aspose.html/htmlappletelement/codebase/) { get; set; } | URI di base facoltativo [[RFC 2396 dell'IETF](http://www.ietf.org/rfc/rfc2396.txt) per applet. Vedere la definizione dell'attributo codebase in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
...
| [Height](../../aspose.html/htmlappletelement/height/) { get; set; } | Sostituisci altezza. Vedi la definizione dell'attributo height in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
| [Hspace](../../aspose.html/htmlappletelement/hspace/) { get; set; } | Spazio orizzontale, in pixel, a sinistra ea destra di questa immagine, applet o oggetto. Vedere la definizione dell'attributo hspace in HTML 4.01. Questo attributo è deprecato in HTML 4.01. @version DOM Level 2 |
...
| [Name](../../aspose.html/htmlappletelement/name/) { get; set; } | Il nome dell'applet. Vedere la definizione dell'attributo name in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
...
| [Object](../../aspose.html/htmlappletelement/object/) { get; set; } | Il valore dell'attributo "oggetto". Vedere la definizione dell'attributo dell'oggetto in HTML 4.01. Questo attributo è deprecato in HTML 4.01. @versione DOM Livello 2 |
...
| [Vspace](../../aspose.html/htmlappletelement/vspace/) { get; set; } | Spazio verticale, in pixel, sopra e sotto questa immagine, applet o oggetto . Vedere la definizione dell'attributo vspace in HTML 4.01. Questo attributo è deprecato in HTML 4.01. @version DOM Level 2 |
| [Width](../../aspose.html/htmlappletelement/width/) { get; set; } | Sostituisci larghezza. Vedi la definizione dell'attributo width in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
