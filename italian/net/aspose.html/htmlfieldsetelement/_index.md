...
description: Aspose.Html.HTMLFieldSetElement classe. Organizza i controlli del modulo in gruppi logici. Vedere la definizione dellelemento FIELDSET in HTML 4.01.
type: docs
weight: 3210
url: /it/net/aspose.html/htmlfieldsetelement/
---
## HTMLFieldSetElement class

Organizza i controlli del modulo in gruppi logici. Vedere la definizione dell'elemento FIELDSET in HTML 4.01.
...
| [Form](../../aspose.html/htmlfieldsetelement/form/) { get; } | Restituisce il`MODULO` elemento che contiene questo controllo. Restituisce `nullo` se questo controllo non è all'interno del contesto di un modulo . |
