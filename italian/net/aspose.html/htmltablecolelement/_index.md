...
description: Aspose.Html.HTMLTableColElement classe. Raggruppa ilCOL ECOLGRUPPO elementi. Vedi la definizione dellelemento COL in HTML 4.01.
type: docs
weight: 3560
url: /it/net/aspose.html/htmltablecolelement/
---
## HTMLTableColElement class

Raggruppa il`COL` E`COLGRUPPO` elementi. Vedi la definizione dell'elemento COL in HTML 4.01.
...
| Nome | Descrizione |
| --- | --- |
| [Align](../../aspose.html/htmltablecolelement/align/) { get; set; } | Allineamento orizzontale dei dati della cella nella colonna. Vedi la definizione dell'attributo align in HTML 4.01. |
...
| [Ch](../../aspose.html/htmltablecolelement/ch/) { get; set; } | Carattere di allineamento per le celle in una colonna. Vedi la definizione dell'attributo char in HTML 4.01. |
...
| [ChOff](../../aspose.html/htmltablecolelement/choff/) { get; set; } | Offset del carattere di allineamento. Vedi la definizione dell'attributo charoff in HTML 4.01. |
...
| [Span](../../aspose.html/htmltablecolelement/span/) { get; set; } | Indica il numero di colonne in un gruppo o interessate da un raggruppamento. Vedi la definizione dell'attributo span in HTML 4.01. |
...
| [VAlign](../../aspose.html/htmltablecolelement/valign/) { get; set; } | Allineamento verticale dei dati della cella nella colonna. Vedi la definizione dell'attributo valign in HTML 4.01. |
| [Width](../../aspose.html/htmltablecolelement/width/) { get; set; } | Larghezza colonna predefinita. Vedi la definizione dell'attributo width in HTML 4.01. |
