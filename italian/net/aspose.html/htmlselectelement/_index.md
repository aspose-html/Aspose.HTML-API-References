...
description: Aspose.Html.HTMLSelectElement classe. Lelemento select consente la selezione di unopzione. È possibile accedere direttamente alle opzioni contenute tramite lelemento select come raccolta. Vedi la definizione dellelemento SELECT in HTML 4.01.
type: docs
weight: 3520
url: /it/net/aspose.html/htmlselectelement/
---
## HTMLSelectElement class

L'elemento select consente la selezione di un'opzione. È possibile accedere direttamente alle opzioni contenute tramite l'elemento select come raccolta. Vedi la definizione dell'elemento SELECT in HTML 4.01.
...
| [Disabled](../../aspose.html/htmlselectelement/disabled/) { get; set; } | Il controllo non è disponibile in questo contesto. Vedi la definizione dell'attributo disabilitato in HTML 4.01. |
...
| [Form](../../aspose.html/htmlselectelement/form/) { get; } | Il numero di opzioni in questo`SELEZIONARE` . |
...
| [Length](../../aspose.html/htmlselectelement/length/) { get; set; } | Il numero di opzioni in questo`SELEZIONARE` . @versione DOM livello 2 |
...
| [Multiple](../../aspose.html/htmlselectelement/multiple/) { get; set; } | Se vero, multiplo`OPZIONE` gli elementi possono essere selezionati in questo`SELEZIONARE` . Vedi la definizione di attributi multipli in HTML 4.01. |
| [Name](../../aspose.html/htmlselectelement/name/) { get; set; } | Controllo modulo o nome oggetto quando inviato con un modulo. Vedi la definizione dell'attributo name in HTML 4.01. |
...
| [Options](../../aspose.html/htmlselectelement/options/) { get; } | La collezione di`OPZIONE` elementi contenuti da questo elemento . @versione DOM livello 2 |
...
| [SelectedIndex](../../aspose.html/htmlselectelement/selectedindex/) { get; set; } | L'indice ordinale dell'opzione selezionata, a partire da 0. Il valore -1 viene restituito se non è selezionato alcun elemento. Se sono selezionate più opzioni , viene restituito l'indice della prima opzione selezionata. |
...
| [Size](../../aspose.html/htmlselectelement/size/) { get; set; } | Numero di righe visibili. Vedi la definizione dell'attributo size in HTML 4.01. |
...
| [TabIndex](../../aspose.html/htmlselectelement/tabindex/) { get; set; } | Indice che rappresenta la posizione dell'elemento nell'ordine di tabulazione. Vedi la definizione dell'attributo tabindex in HTML 4.01. |
...
| [Type](../../aspose.html/htmlselectelement/type/) { get; } | Il tipo di questo controllo modulo. Questa è la stringa "select-multiple" quando l'attributo multiple è`VERO` e la stringa "select-one" when`falso` . |
| [Value](../../aspose.html/htmlselectelement/value/) { get; set; } | Il valore di controllo del modulo corrente (ovvero il valore dell'opzione attualmente selezionata), se sono selezionate più opzioni questo è il valore della prima opzione selezionata. |
