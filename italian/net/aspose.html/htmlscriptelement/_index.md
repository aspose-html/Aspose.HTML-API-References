...
description: Aspose.Html.HTMLScriptElement classe. Dichiarazioni script. Vedi la definizione dellelemento SCRIPT in HTML 4.01.
type: docs
weight: 3510
url: /it/net/aspose.html/htmlscriptelement/
---
## HTMLScriptElement class

Dichiarazioni script. Vedi la definizione dell'elemento SCRIPT in HTML 4.01.
...
| [Charset](../../aspose.html/htmlscriptelement/charset/) { get; set; } | La codifica dei caratteri della risorsa collegata. Vedere la definizione dell'attributo charset in HTML 4.01. |
...
| [Defer](../../aspose.html/htmlscriptelement/defer/) { get; set; } | Indica che l'agente utente può rinviare l'elaborazione dello script. Vedi la definizione dell'attributo defer in HTML 4.01. |
...
| [Event](../../aspose.html/htmlscriptelement/event/) { get; set; } | Riservato per uso futuro. |
...
| [Src](../../aspose.html/htmlscriptelement/src/) { get; set; } | URI [[RFC 2396 dell'IETF](http://www.ietf.org/rfc/rfc2396.txt) ] che designa uno script esterno. Vedere la definizione dell'attributo src in HTML 4.01. |
...
| [Text](../../aspose.html/htmlscriptelement/text/) { get; set; } | Il contenuto dello script dell'elemento. |
...
| [Type](../../aspose.html/htmlscriptelement/type/) { get; set; } | Il tipo di contenuto del linguaggio script. Vedi la definizione dell'attributo type in HTML 4.01. |
