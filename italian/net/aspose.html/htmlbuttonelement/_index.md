...
description: Aspose.Html.HTMLButtonElement classe. Pulsante. Vedi la definizione dellelemento BUTTON in HTML 4.01.
type: docs
weight: 3130
url: /it/net/aspose.html/htmlbuttonelement/
---
...
| Nome | Descrizione |
| --- | --- |
| [AccessKey](../../aspose.html/htmlbuttonelement/accesskey/) { get; set; } | Una chiave di accesso a carattere singolo per dare accesso al controllo del modulo. Vedi la definizione dell'attributo accesskey in HTML 4.01. |
...
| [Disabled](../../aspose.html/htmlbuttonelement/disabled/) { get; set; } | Il controllo non è disponibile in questo contesto. Vedi la definizione dell'attributo disabilitato in HTML 4.01. |
...
| [Form](../../aspose.html/htmlbuttonelement/form/) { get; } | Restituisce il`MODULO` elemento che contiene questo controllo. Restituisce `nullo` se questo controllo non è all'interno del contesto di un modulo . |
...
| [Name](../../aspose.html/htmlbuttonelement/name/) { get; set; } | Controllo modulo o nome oggetto quando inviato con un modulo. Vedi la definizione dell'attributo name in HTML 4.01. |
...
| [TabIndex](../../aspose.html/htmlbuttonelement/tabindex/) { get; set; } | Indice che rappresenta la posizione dell'elemento nell'ordine di tabulazione. Vedi la definizione dell'attributo tabindex in HTML 4.01. |
...
| [Type](../../aspose.html/htmlbuttonelement/type/) { get; set; } | Il tipo di pulsante (tutto minuscolo). Vedi la definizione dell'attributo type in HTML 4.01. |
| [Value](../../aspose.html/htmlbuttonelement/value/) { get; set; } | Il valore di controllo del modulo corrente. Vedi la definizione dell'attributo value in HTML 4.01. |
