...
description: Aspose.Html.HTMLAnchorElement classe. Lelemento di ancoraggio. Vedi la definizione dellelemento A in HTML 4.01.
type: docs
weight: 3060
url: /it/net/aspose.html/htmlanchorelement/
---
## HTMLAnchorElement class

L'elemento di ancoraggio. Vedi la definizione dell'elemento A in HTML 4.01.
...
| Nome | Descrizione |
| --- | --- |
| [AccessKey](../../aspose.html/htmlanchorelement/accesskey/) { get; set; } | Una chiave di accesso a carattere singolo per dare accesso al controllo del modulo. Vedi la definizione dell'attributo accesskey in HTML 4.01. |
...
| [Charset](../../aspose.html/htmlanchorelement/charset/) { get; set; } | La codifica dei caratteri della risorsa collegata. Vedere la definizione dell'attributo charset in HTML 4.01. |
...
| [Coords](../../aspose.html/htmlanchorelement/coords/) { get; set; } | Elenco di lunghezze separate da virgole, che definiscono una geometria della regione attiva. Vedi anche`forma` per la forma della regione. Vedi la definizione dell'attributo coords in HTML 4.01. |
...
| [Hash](../../aspose.html/htmlanchorelement/hash/) { get; set; } | Ottiene o imposta una rappresentazione di stringa del segmento hash dell'URL associato. |
| [Host](../../aspose.html/htmlanchorelement/host/) { get; set; } | Ottiene o imposta una rappresentazione di stringa dei segmenti host e porta dell'URL associato. |
| [Hostname](../../aspose.html/htmlanchorelement/hostname/) { get; set; } | Ottiene o imposta una rappresentazione di stringa del segmento host dell'URL associato. |
| [Href](../../aspose.html/htmlanchorelement/href/) { get; set; } | L'URI assoluto [[RFC 2396 dell'IETF](http://www.ietf.org/rfc/rfc2396.txt) della risorsa collegata. Vedi la definizione dell'attributo href in HTML 4.01. |
| [Hreflang](../../aspose.html/htmlanchorelement/hreflang/) { get; set; } | Codice della lingua della risorsa collegata. Vedi la definizione dell'attributo hreflang in HTML 4.01. |
...
| [Name](../../aspose.html/htmlanchorelement/name/) { get; set; } | Nome dell'ancora. Vedi la definizione dell'attributo name in HTML 4.01. |
...
| [Origin](../../aspose.html/htmlanchorelement/origin/) { get; } | Ottiene una rappresentazione in forma di stringa del segmento di origine dell'URL associato. |
...
| [Password](../../aspose.html/htmlanchorelement/password/) { get; set; } | Ottiene o imposta una rappresentazione di stringa del segmento password dell'URL associato. |
| [Pathname](../../aspose.html/htmlanchorelement/pathname/) { get; set; } | Ottiene o imposta una rappresentazione di stringa del segmento di percorso dell'URL associato. |
| [Port](../../aspose.html/htmlanchorelement/port/) { get; set; } | Ottiene o imposta una rappresentazione di stringa del segmento di porta dell'URL associato. |
...
| [Protocol](../../aspose.html/htmlanchorelement/protocol/) { get; set; } | Ottiene o imposta una rappresentazione di stringa del segmento dello schema dell'URL associato. |
| [Rel](../../aspose.html/htmlanchorelement/rel/) { get; set; } | Tipo di collegamento in avanti. Vedere la definizione dell'attributo rel in HTML 4.01. |
| [RelList](../../aspose.html/htmlanchorelement/rellist/) { get; } | Restituisce un DOMTokenList attivo che contiene i token ricevuti dall'analisi dell'attributo "rel". |
| [Rev](../../aspose.html/htmlanchorelement/rev/) { get; set; } | Tipo di collegamento inverso. Vedi la definizione dell'attributo rev in HTML 4.01. |
| [SchemaTypeInfo](../../aspose.html.dom/element/schematypeinfo/) { get; } | Le informazioni sul tipo associate a questo elemento. |
| [Search](../../aspose.html/htmlanchorelement/search/) { get; set; } | Ottiene o imposta una rappresentazione di stringa del segmento di ricerca dell'URL associato. |
...
| [Shape](../../aspose.html/htmlanchorelement/shape/) { get; set; } | La forma dell'area attiva. Le coordinate sono date da `coordinate` . Vedi la definizione dell'attributo shape in HTML 4.01. |
...
| [TabIndex](../../aspose.html/htmlanchorelement/tabindex/) { get; set; } | Indice che rappresenta la posizione dell'elemento nell'ordine di tabulazione. Vedi la definizione dell'attributo tabindex in HTML 4.01. |
| [TagName](../../aspose.html.dom/element/tagname/) { get; } | Il nome dell'elemento. |
| [Target](../../aspose.html/htmlanchorelement/target/) { get; set; } | Frame in cui eseguire il rendering della risorsa. Vedere la definizione dell'attributo target in HTML 4.01. |
...
| [Type](../../aspose.html/htmlanchorelement/type/) { get; set; } | Tipo di contenuto consultivo. Vedi la definizione dell'attributo type in HTML 4.01. |
| [Username](../../aspose.html/htmlanchorelement/username/) { get; set; } | Ottiene o imposta una rappresentazione di stringa del segmento nome utente dell'URL associato. |
...
| [Blur](../../aspose.html/htmlanchorelement/blur/)() | Rimuove il focus della tastiera da questo elemento. |
...
| [Focus](../../aspose.html/htmlanchorelement/focus/)() | Fornisce il focus della tastiera a questo elemento. |
