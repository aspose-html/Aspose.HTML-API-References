...
description: Aspose.Html.HTMLTableCellElement classe. Loggetto utilizzato per rappresentare il fileTH ETD elementi. Vedi la definizione dellelemento TD in HTML 4.01.
type: docs
weight: 3550
url: /it/net/aspose.html/htmltablecellelement/
---
## HTMLTableCellElement class

L'oggetto utilizzato per rappresentare il file`TH` E`TD` elementi. Vedi la definizione dell'elemento TD in HTML 4.01.
...
| Nome | Descrizione |
| --- | --- |
| [Abbr](../../aspose.html/htmltablecellelement/abbr/) { get; set; } | Abbreviazione per celle di intestazione. Vedere la definizione dell'attributo abbr in HTML 4.01. |
| [Align](../../aspose.html/htmltablecellelement/align/) { get; set; } | Allineamento orizzontale dei dati nella cella. Vedi la definizione dell'attributo align in HTML 4.01. |
...
| [Axis](../../aspose.html/htmltablecellelement/axis/) { get; set; } | Denomina il gruppo di intestazioni correlate. Vedere la definizione dell'attributo dell'asse in HTML 4.01. |
...
| [BgColor](../../aspose.html/htmltablecellelement/bgcolor/) { get; set; } | Colore di sfondo della cella. Vedere la definizione dell'attributo bgcolor in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
| [CellIndex](../../aspose.html/htmltablecellelement/cellindex/) { get; } | L'indice di questa cella nella riga, a partire da 0. Questo indice è nell'ordine dell'albero del documento e non nell'ordine di visualizzazione. |
| [Ch](../../aspose.html/htmltablecellelement/ch/) { get; set; } | Carattere di allineamento per le celle in una colonna. Vedi la definizione dell'attributo char in HTML 4.01. |
...
| [ChOff](../../aspose.html/htmltablecellelement/choff/) { get; set; } | Offset del carattere di allineamento. Vedi la definizione dell'attributo charoff in HTML 4.01. |
...
| [ColSpan](../../aspose.html/htmltablecellelement/colspan/) { get; set; } | Numero di colonne estese per cella. Vedi la definizione dell'attributo colspan in HTML 4.01. |
...
| [Headers](../../aspose.html/htmltablecellelement/headers/) { get; set; } | Elenco di`id` valori degli attributi per le celle di intestazione. Vedi la definizione dell'attributo headers in HTML 4.01. |
| [Height](../../aspose.html/htmltablecellelement/height/) { get; set; } | Altezza cella. Vedi la definizione dell'attributo height in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
...
| [NoWrap](../../aspose.html/htmltablecellelement/nowrap/) { get; set; } | Elimina il ritorno a capo automatico. Vedere la definizione dell'attributo nowrap in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
...
| [RowSpan](../../aspose.html/htmltablecellelement/rowspan/) { get; set; } | Numero di righe estese per cella. Vedi la definizione dell'attributo rowspan in HTML 4.01. |
| [SchemaTypeInfo](../../aspose.html.dom/element/schematypeinfo/) { get; } | Le informazioni sul tipo associate a questo elemento. |
| [Scope](../../aspose.html/htmltablecellelement/scope/) { get; set; } | Ambito coperto dalle celle di intestazione. Vedi la definizione dell'attributo scope in HTML 4.01. |
...
| [VAlign](../../aspose.html/htmltablecellelement/valign/) { get; set; } | Allineamento verticale dei dati nella cella. Vedi la definizione dell'attributo valign in HTML 4.01. |
| [Width](../../aspose.html/htmltablecellelement/width/) { get; set; } | Larghezza cella. Vedi la definizione dell'attributo width in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
