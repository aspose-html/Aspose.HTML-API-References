...
description: Aspose.Html.HTMLFrameSetElement classe. Crea una griglia di frame. Vedere la definizione dellelemento FRAMESET in HTML 4.01.
type: docs
weight: 3250
url: /it/net/aspose.html/htmlframesetelement/
---
## HTMLFrameSetElement class

Crea una griglia di frame. Vedere la definizione dell'elemento FRAMESET in HTML 4.01.
...
| [Cols](../../aspose.html/htmlframesetelement/cols/) { get; set; } | Il numero di colonne di frame nel set di frame. Vedi la definizione dell'attributo cols in HTML 4.01. |
...
| [Rows](../../aspose.html/htmlframesetelement/rows/) { get; set; } | Il numero di righe di fotogrammi nel set di fotogrammi. Vedere la definizione dell'attributo righe in HTML 4.01. |
