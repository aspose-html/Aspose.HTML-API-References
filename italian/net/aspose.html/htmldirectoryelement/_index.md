...
description: Aspose.Html.HTMLDirectoryElement classe. Elenco directory. Vedere la definizione dellelemento DIR in HTML 4.01. Questo elemento è deprecato in HTML 4.01.
type: docs
weight: 3170
url: /it/net/aspose.html/htmldirectoryelement/
---
## HTMLDirectoryElement class

Elenco directory. Vedere la definizione dell'elemento DIR in HTML 4.01. Questo elemento è deprecato in HTML 4.01.
...
| [Compact](../../aspose.html/htmldirectoryelement/compact/) { get; set; } | Riduci la spaziatura tra gli elementi dell'elenco. Vedere la definizione dell'attributo compatto in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
