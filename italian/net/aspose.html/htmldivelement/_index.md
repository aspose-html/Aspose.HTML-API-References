...
description: Aspose.Html.HTMLDivElement classe. Contenitore di blocchi generico. Vedi la definizione dellelemento DIV in HTML 4.01.
type: docs
weight: 3180
url: /it/net/aspose.html/htmldivelement/
---
## HTMLDivElement class

Contenitore di blocchi generico. Vedi la definizione dell'elemento DIV in HTML 4.01.
...
| Nome | Descrizione |
| --- | --- |
| [Align](../../aspose.html/htmldivelement/align/) { get; set; } | Allineamento orizzontale del testo. Vedere la definizione dell'attributo align in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
