...
description: Aspose.Html.HTMLTableElement classe. I metodi create e delete sulla tabella consentono agli autori di costruire e modificare tabelle. HTML 4.01  specifica che solo uno di ciascuno dei DIDASCALIA TESTA  ETFOOT gli elementi possono esistere in una tabella. Pertanto se ne esiste uno e viene chiamato il metodo createTHead o createTFoot il metodo restituisce lelemento THead o TFoot esistente. Vedere la definizione dellelemento TABLE in HTML 4.01.
type: docs
weight: 3570
url: /it/net/aspose.html/htmltableelement/
---
## HTMLTableElement class

I metodi create* e delete* sulla tabella consentono agli autori di costruire e modificare tabelle. [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224) ] specifica che solo uno di ciascuno dei `DIDASCALIA` ,`TESTA` , E`TFOOT` gli elementi possono esistere in una tabella. Pertanto, se ne esiste uno e viene chiamato il metodo createTHead() o createTFoot(), il metodo restituisce l'elemento THead o TFoot esistente. Vedere la definizione dell'elemento TABLE in HTML 4.01.
...
| Nome | Descrizione |
| --- | --- |
| [Align](../../aspose.html/htmltableelement/align/) { get; set; } | Specifica la posizione della tabella rispetto al resto del documento . Vedere la definizione dell'attributo align in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
...
| [BgColor](../../aspose.html/htmltableelement/bgcolor/) { get; set; } | Colore di sfondo della cella. Vedere la definizione dell'attributo bgcolor in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
| [Border](../../aspose.html/htmltableelement/border/) { get; set; } | La larghezza del bordo intorno alla tabella. Vedi la definizione dell'attributo border in HTML 4.01. |
| [Caption](../../aspose.html/htmltableelement/caption/) { get; } | Restituisce la tabella`DIDASCALIA` , o void se non esiste. @versione DOM livello 2 |
| [CellPadding](../../aspose.html/htmltableelement/cellpadding/) { get; set; } | Specifica lo spazio orizzontale e verticale tra il contenuto della cella e i bordi della cella. Vedi la definizione dell'attributo cellpadding in HTML 4.01. |
| [CellSpacing](../../aspose.html/htmltableelement/cellspacing/) { get; set; } | Specifica la separazione orizzontale e verticale tra le celle. Vedi la definizione dell'attributo cellspacing in HTML 4.01. |
...
| [Frame](../../aspose.html/htmltableelement/frame/) { get; set; } | Specifica i bordi della tabella esterna di cui eseguire il rendering. Vedere la definizione dell'attributo frame in HTML 4.01. |
...
| [Rows](../../aspose.html/htmltableelement/rows/) { get; } | Restituisce la tabella`TFOOT` , O`nullo` se non esiste . |
| [Rules](../../aspose.html/htmltableelement/rules/) { get; set; } | Specifica i bordi interni della tabella di cui eseguire il rendering. Vedere la definizione dell'attributo delle regole in HTML 4.01. |
...
| [Summary](../../aspose.html/htmltableelement/summary/) { get; set; } | Descrizione dello scopo o della struttura di una tabella. Vedi il riepilogo della definizione dell'attributo in HTML 4.01. |
| [TagName](../../aspose.html.dom/element/tagname/) { get; } | Il nome dell'elemento. |
| [TBodies](../../aspose.html/htmltableelement/tbodies/) { get; } | Restituisce una raccolta dei corpi delle tabelle (compresi quelli impliciti). |
...
| [TFoot](../../aspose.html/htmltableelement/tfoot/) { get; } | Restituisce la tabella`TESTA` , O`nullo` se non esiste . |
| [THead](../../aspose.html/htmltableelement/thead/) { get; } | Restituisce la tabella`DIDASCALIA` , o void se non esiste. |
...
| [Width](../../aspose.html/htmltableelement/width/) { get; set; } | Specifica la larghezza della tabella desiderata. Vedi la definizione dell'attributo width in HTML 4.01. |
...
| [CreateCaption](../../aspose.html/htmltableelement/createcaption/)() | Crea un nuovo oggetto didascalia tabella o ne restituisce uno esistente. |
| [CreateTFoot](../../aspose.html/htmltableelement/createtfoot/)() | Crea una riga a piè di pagina della tabella o ne restituisce una esistente. |
| [CreateTHead](../../aspose.html/htmltableelement/createthead/)() | Crea una riga di intestazione della tabella o ne restituisce una esistente. |
| [DeleteCaption](../../aspose.html/htmltableelement/deletecaption/)() | Elimina la didascalia della tabella, se esiste. |
| [DeleteRow](../../aspose.html/htmltableelement/deleterow/)(int) | Elimina una riga della tabella. |
| [DeleteTFoot](../../aspose.html/htmltableelement/deletetfoot/)() | Elimina il piè di pagina dalla tabella, se ne esiste uno. |
| [DeleteTHead](../../aspose.html/htmltableelement/deletethead/)() | Elimina l'intestazione dalla tabella, se ne esiste una. |
...
| [InsertRow](../../aspose.html/htmltableelement/insertrow/)(int) | Inserisce una nuova riga vuota nella tabella. La nuova riga viene inserita immediatamente prima e nella stessa sezione dell'attuale `indice` esima riga della tabella. Se`indice` è -1 o uguale al numero di righe, la nuova riga viene aggiunta. Inoltre, quando la tabella è vuota la riga viene inserita in a`TBODY` che viene creato e inserito nella tabella. Una riga della tabella non può essere vuota secondo [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224) ]. |
