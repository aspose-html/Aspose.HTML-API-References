...
description: Aspose.Html.HTMLStyleElement classe. Informazioni sullo stile. Vedi la definizione dellelemento STYLE in HTML 4.01 il modulo CSS Fogli di stile DOM di livello 2 e CSS  e ilLinkStyle interfaccia nel modulo StyleSheets Fogli di stile DOM di livello 2 e CSS .
type: docs
weight: 3530
url: /it/net/aspose.html/htmlstyleelement/
---
## HTMLStyleElement class

Informazioni sullo stile. Vedi la definizione dell'elemento STYLE in HTML 4.01, il modulo CSS [[Fogli di stile DOM di livello 2 e CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113) ] e il`LinkStyle` interfaccia nel modulo StyleSheets [[Fogli di stile DOM di livello 2 e CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113) ].
...
| [Disabled](../../aspose.html/htmlstyleelement/disabled/) { get; set; } | Abilita/disabilita il foglio di stile. |
...
| [Media](../../aspose.html/htmlstyleelement/media/) { get; set; } | Progettato per l'uso con uno o più supporti di destinazione. Vedi la definizione dell'attributo multimediale in HTML 4.01. |
...
| [Sheet](../../aspose.html/htmlstyleelement/sheet/) { get; } | Ottiene il foglio di stile associato. |
...
| [Type](../../aspose.html/htmlstyleelement/type/) { get; set; } | Il tipo di contenuto del linguaggio per fogli di stile. Vedi la definizione dell'attributo type in HTML 4.01. |
