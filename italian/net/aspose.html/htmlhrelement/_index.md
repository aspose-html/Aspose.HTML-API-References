...
description: Aspose.Html.HTMLHRElement classe. Crea un filetto orizzontale. Vedi la definizione dellelemento HR in HTML 4.01.
type: docs
weight: 3260
url: /it/net/aspose.html/htmlhrelement/
---
## HTMLHRElement class

Crea un filetto orizzontale. Vedi la definizione dell'elemento HR in HTML 4.01.
...
| Nome | Descrizione |
| --- | --- |
| [Align](../../aspose.html/htmlhrelement/align/) { get; set; } | Allinea la regola sulla pagina. Vedere la definizione dell'attributo align in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
...
| [NoShade](../../aspose.html/htmlhrelement/noshade/) { get; set; } | Indica all'agente utente che non ci dovrebbe essere ombreggiatura nel rendering di questo elemento. Vedere la definizione dell'attributo noshade in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
...
| [Size](../../aspose.html/htmlhrelement/size/) { get; set; } | L'altezza della regola. Vedi la definizione dell'attributo size in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
...
| [Width](../../aspose.html/htmlhrelement/width/) { get; set; } | La larghezza del filetto. Vedi la definizione dell'attributo width in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
