...
description: Aspose.Html.HTMLTableCaptionElement classe. Didascalia della tabella Vedere la definizione dellelemento CAPTION in HTML 4.01.
type: docs
weight: 3540
url: /it/net/aspose.html/htmltablecaptionelement/
---
## HTMLTableCaptionElement class

Didascalia della tabella Vedere la definizione dell'elemento CAPTION in HTML 4.01.
...
| Nome | Descrizione |
| --- | --- |
| [Align](../../aspose.html/htmltablecaptionelement/align/) { get; set; } | Allineamento didascalia rispetto alla tabella. Vedi la definizione dell'attributo align in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
