...
description: Aspose.Html.HTMLMetaElement classe. Contiene metainformazioni generiche sul documento. Vedi la definizione dellelemento META in HTML 4.01.
type: docs
weight: 3400
url: /it/net/aspose.html/htmlmetaelement/
---
## HTMLMetaElement class

Contiene meta-informazioni generiche sul documento. Vedi la definizione dell'elemento META in HTML 4.01.
...
| [Content](../../aspose.html/htmlmetaelement/content/) { get; set; } | Informazioni associate. Vedere la definizione dell'attributo di contenuto in HTML 4.01. |
...
| [HttpEquiv](../../aspose.html/htmlmetaelement/httpequiv/) { get; set; } | Nome dell'intestazione della risposta HTTP [[RFC 2616 dell'IETF](http://www.ietf.org/rfc/rfc2616.txt) ]. Vedere la definizione dell'attributo http-equiv in HTML 4.01. |
...
| [Name](../../aspose.html/htmlmetaelement/name/) { get; set; } | Nome delle informazioni meta. Vedi la definizione dell'attributo name in HTML 4.01. |
...
| [Scheme](../../aspose.html/htmlmetaelement/scheme/) { get; set; } | Seleziona la forma del contenuto. Vedere la definizione dell'attributo dello schema in HTML 4.01. |
