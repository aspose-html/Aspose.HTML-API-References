...
description: Aspose.Html.HTMLImageElement classe. Immagine incorporata. Vedi la definizione dellelemento IMG in HTML 4.01.
type: docs
weight: 3310
url: /it/net/aspose.html/htmlimageelement/
---
...
| Nome | Descrizione |
| --- | --- |
| [Align](../../aspose.html/htmlimageelement/align/) { get; set; } | Allinea questo oggetto (verticalmente o orizzontalmente) rispetto al suo testo circostante. Vedere la definizione dell'attributo align in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
| [Alt](../../aspose.html/htmlimageelement/alt/) { get; set; } | Testo alternativo per i programmi utente che non riproducono il contenuto normale di questo elemento . Vedi la definizione dell'attributo alt in HTML 4.01. |
...
| [Border](../../aspose.html/htmlimageelement/border/) { get; set; } | Larghezza del bordo intorno all'immagine. Vedi la definizione dell'attributo border in HTML 4.01. Questo attributo è deprecato in HTML 4.01. Si noti che il tipo di questo attributo era`DOMStringa` nel DOM HTML di livello 1 [[DOM Livello 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ] . |
...
| [Height](../../aspose.html/htmlimageelement/height/) { get; set; } | Altezza dell'immagine in pixel. Vedi la definizione dell'attributo height in HTML 4.01. Nota che il tipo di questo attributo era `DOMStringa` nel DOM HTML di livello 1 [[DOM Livello 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ]. @versione DOM Livello 2 |
| [Hspace](../../aspose.html/htmlimageelement/hspace/) { get; set; } | Spazio orizzontale a sinistra ea destra di questa immagine in pixel. Vedi la definizione dell'attributo hspace in HTML 4.01. Questo attributo è deprecato in HTML 4.01. Nota che il tipo di questo attributo era `DOMStringa` nel DOM HTML di livello 1 [[DOM Livello 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ]. @versione DOM Livello 2 |
...
| [IsMap](../../aspose.html/htmlimageelement/ismap/) { get; set; } | Usa mappa immagine lato server. Vedi la definizione dell'attributo ismap in HTML 4.01. |
...
| [LongDesc](../../aspose.html/htmlimageelement/longdesc/) { get; set; } | URI [[RFC 2396 dell'IETF](http://www.ietf.org/rfc/rfc2396.txt) ] che designa una lunga descrizione di questa immagine o cornice. Vedere la definizione dell'attributo longdesc in HTML 4.01. |
| [Name](../../aspose.html/htmlimageelement/name/) { get; set; } | Il nome dell'elemento (per compatibilità con le versioni precedenti). |
...
| [Src](../../aspose.html/htmlimageelement/src/) { get; set; } | URI [[RFC 2396 dell'IETF](http://www.ietf.org/rfc/rfc2396.txt) ] che designa la fonte di questa immagine. Vedere la definizione dell'attributo src in HTML 4.01. |
...
| [UseMap](../../aspose.html/htmlimageelement/usemap/) { get; set; } | Usa mappa immagine lato client. Vedi la definizione dell'attributo usemap in HTML 4.01. |
| [Vspace](../../aspose.html/htmlimageelement/vspace/) { get; set; } | Spazio verticale sopra e sotto questa immagine in pixel. Vedere la definizione dell'attributo vspace in HTML 4.01. Questo attributo è deprecato in HTML 4.01. Si noti che il tipo di questo attributo era "DOMString" in DOM Level 1 HTML [[DOM Livello 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ]. @versione DOM Livello 2 |
| [Width](../../aspose.html/htmlimageelement/width/) { get; set; } | La larghezza dell'immagine in pixel. Vedi la definizione dell'attributo width in HTML 4.01. Nota che il tipo di questo attributo era `DOMStringa` nel DOM HTML di livello 1 [[DOM Livello 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ]. @versione DOM Livello 2 |
