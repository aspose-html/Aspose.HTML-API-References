...
description: Aspose.Html.HTMLTableRowElement classe. Una riga in una tabella. Vedi la definizione dellelemento TR in HTML 4.01.
type: docs
weight: 3580
url: /it/net/aspose.html/htmltablerowelement/
---
...
| Nome | Descrizione |
| --- | --- |
| [Align](../../aspose.html/htmltablerowelement/align/) { get; set; } | Allineamento orizzontale dei dati all'interno delle celle di questa riga. Vedere la definizione dell'attributo align in HTML 4.01. |
...
| [BgColor](../../aspose.html/htmltablerowelement/bgcolor/) { get; set; } | Colore di sfondo per le righe. Vedere la definizione dell'attributo bgcolor in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
| [Cells](../../aspose.html/htmltablerowelement/cells/) { get; } | La raccolta di celle in questa riga. @versione DOM livello 2 |
| [Ch](../../aspose.html/htmltablerowelement/ch/) { get; set; } | Carattere di allineamento per le celle in una colonna. Vedi la definizione dell'attributo char in HTML 4.01. |
...
| [ChOff](../../aspose.html/htmltablerowelement/choff/) { get; set; } | Offset del carattere di allineamento. Vedi la definizione dell'attributo charoff in HTML 4.01. |
...
| [RowIndex](../../aspose.html/htmltablerowelement/rowindex/) { get; } | Questo è in ordine logico e non in ordine di documento. Il `rowIndex` tiene conto delle sezioni ( `TESTA` ,`TFOOT` , O`TBODY` ) all'interno di la tabella, posizionando`TESTA` righe prima nell'indice, seguito da`TBODY` righe, seguite da`TFOOT` righe. @versione DOM Livello 2 |
| [SchemaTypeInfo](../../aspose.html.dom/element/schematypeinfo/) { get; } | Le informazioni sul tipo associate a questo elemento. |
| [SectionRowIndex](../../aspose.html/htmltablerowelement/sectionrowindex/) { get; } | L'indice di questa riga, relativo alla sezione corrente ( `TESTA` ,`TFOOT` , O`TBODY` ), a partire da 0. @versione DOM Level 2 |
...
| [VAlign](../../aspose.html/htmltablerowelement/valign/) { get; set; } | Allineamento verticale dei dati all'interno delle celle di questa riga. Vedere la definizione dell'attributo valign in HTML 4.01. |
...
| [DeleteCell](../../aspose.html/htmltablerowelement/deletecell/)(int) | Elimina una cella dalla riga corrente. |
...
| [InsertCell](../../aspose.html/htmltablerowelement/insertcell/)(int) | Inserisci un vuoto`TD` cella in questa riga. Se `indice` è -1 o uguale al numero di celle, viene aggiunta la nuova cella . |
