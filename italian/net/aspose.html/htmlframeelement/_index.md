...
description: Aspose.Html.HTMLFrameElement classe. Crea una cornice. Vedi la definizione dellelemento FRAME in HTML 4.01.
type: docs
weight: 3240
url: /it/net/aspose.html/htmlframeelement/
---
## HTMLFrameElement class

Crea una cornice. Vedi la definizione dell'elemento FRAME in HTML 4.01.
...
| [ContentDocument](../../aspose.html/htmlframeelement/contentdocument/) { get; } | Il documento contenuto in questo frame, se presente e disponibile, oppure`nullo` altrimenti. @since DOM Level 2 |
...
| [FrameBorder](../../aspose.html/htmlframeelement/frameborder/) { get; set; } | Richiedi i bordi del frame. Vedere la definizione dell'attributo frameborder in HTML 4.01. |
...
| [LongDesc](../../aspose.html/htmlframeelement/longdesc/) { get; set; } | URI [[RFC 2396 dell'IETF](http://www.ietf.org/rfc/rfc2396.txt) ] che designa una lunga descrizione di questa immagine o cornice. Vedere la definizione dell'attributo longdesc in HTML 4.01. |
| [MarginHeight](../../aspose.html/htmlframeelement/marginheight/) { get; set; } | Altezza del margine del fotogramma, in pixel. Vedi la definizione dell'attributo marginheight in HTML 4.01. |
| [MarginWidth](../../aspose.html/htmlframeelement/marginwidth/) { get; set; } | Larghezza del margine del fotogramma, in pixel. Vedi la definizione dell'attributo marginwidth in HTML 4.01. |
| [Name](../../aspose.html/htmlframeelement/name/) { get; set; } | Il nome del frame (oggetto del file`bersaglio` attributo). Vedere la definizione dell'attributo nome in HTML 4.01. |
...
| [NoResize](../../aspose.html/htmlframeelement/noresize/) { get; set; } | Se vero, impedisce all'utente di ridimensionare il frame. Vedi la definizione dell'attributo noresize in HTML 4.01. |
...
| [Scrolling](../../aspose.html/htmlframeelement/scrolling/) { get; set; } | Specifica se il frame deve avere o meno barre di scorrimento. Vedi la definizione dell'attributo di scorrimento in HTML 4.01. |
...
| [Src](../../aspose.html/htmlframeelement/src/) { get; set; } | Un URI [[RFC 2396 dell'IETF](http://www.ietf.org/rfc/rfc2396.txt) ] che designa il contenuto del frame iniziale. Vedere la definizione dell'attributo src in HTML 4.01. |
