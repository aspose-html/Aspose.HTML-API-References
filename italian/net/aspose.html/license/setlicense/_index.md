...
type: docs
weight: 20
url: /it/net/aspose.html/license/setlicense/
---
...
| --- | --- | --- |
| licenseName | String | Può essere un nome file completo o breve o il nome di una risorsa incorporata. Utilizza una stringa vuota per passare alla modalità di valutazione. |
...
* class [License](../)
* spazio dei nomi [Aspose.Html](../../license/)
