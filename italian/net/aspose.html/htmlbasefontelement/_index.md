...
description: Aspose.Html.HTMLBaseFontElement classe. Carattere di base. Vedere la definizione dellelemento BASEFONT in HTML 4.01. Questo elemento è deprecato in HTML 4.01.
type: docs
weight: 3110
url: /it/net/aspose.html/htmlbasefontelement/
---
## HTMLBaseFontElement class

Carattere di base. Vedere la definizione dell'elemento BASEFONT in HTML 4.01. Questo elemento è deprecato in HTML 4.01.
...
| [Color](../../aspose.html/htmlbasefontelement/color/) { get; set; } | Colore del carattere. Vedi la definizione dell'attributo color in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
...
| [Face](../../aspose.html/htmlbasefontelement/face/) { get; set; } | Identificatore del carattere. Vedi la definizione dell'attributo face in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
...
| [Size](../../aspose.html/htmlbasefontelement/size/) { get; set; } | Dimensione carattere calcolata. Vedi la definizione dell'attributo size in HTML 4.01. Questo attributo è deprecato in HTML 4.01. @version DOM Level 2 |
