...
description: Aspose.Html.HTMLParamElement classe. Parametri inviati aOGGETTO elemento. Vedere la definizione dellelemento PARAM in HTML 4.01.
type: docs
weight: 3480
url: /it/net/aspose.html/htmlparamelement/
---
## HTMLParamElement class

Parametri inviati a`OGGETTO` elemento. Vedere la definizione dell'elemento PARAM in HTML 4.01.
...
| [Name](../../aspose.html/htmlparamelement/name/) { get; set; } | Il nome di un parametro di runtime. Vedi la definizione dell'attributo name in HTML 4.01. |
...
| [Type](../../aspose.html/htmlparamelement/type/) { get; set; } | Tipo di contenuto per il file`valore` attributo quando `tipovalore` ha il valore "ref". Vedi la definizione dell'attributo type in HTML 4.01. |
| [Value](../../aspose.html/htmlparamelement/value/) { get; set; } | Il valore di un parametro di runtime. Vedi la definizione dell'attributo value in HTML 4.01. |
| [ValueType](../../aspose.html/htmlparamelement/valuetype/) { get; set; } | Informazioni sul significato del`valore` attributo valore. Vedi la definizione dell'attributo valuetype in HTML 4.01. |
