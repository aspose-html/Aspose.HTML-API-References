...
description: Aspose.Html.HTMLFontElement classe. Modifica locale al carattere. Vedere la definizione dellelemento FONT in HTML 4.01. Questo elemento è deprecato in HTML 4.01.
type: docs
weight: 3220
url: /it/net/aspose.html/htmlfontelement/
---
## HTMLFontElement class

Modifica locale al carattere. Vedere la definizione dell'elemento FONT in HTML 4.01. Questo elemento è deprecato in HTML 4.01.
...
| [Color](../../aspose.html/htmlfontelement/color/) { get; set; } | Colore del carattere. Vedi la definizione dell'attributo color in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
...
| [Face](../../aspose.html/htmlfontelement/face/) { get; set; } | Identificatore del carattere. Vedi la definizione dell'attributo face in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
...
| [Size](../../aspose.html/htmlfontelement/size/) { get; set; } | Dimensione carattere. Vedi la definizione dell'attributo size in HTML 4.01. Questo attributo è deprecato in HTML 4.01. |
