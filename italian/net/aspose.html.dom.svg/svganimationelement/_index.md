...
description: Aspose.Html.Dom.Svg.SVGAnimationElement classe. Linterfaccia SVGAnimationElement è linterfaccia di base per tutte le interfacce degli elementi di animazione SVGAnimateElement SVGSetElement SVGAnimateColorElement SVGAnimateMotionElement e SVGAnimateTransformElement.
type: docs
weight: 1940
url: /it/net/aspose.html.dom.svg/svganimationelement/
---
## SVGAnimationElement class

L'interfaccia SVGAnimationElement è l'interfaccia di base per tutte le interfacce degli elementi di animazione: SVGAnimateElement, SVGSetElement, SVGAnimateColorElement, SVGAnimateMotionElement e SVGAnimateTransformElement.
...
| [RequiredExtensions](../../aspose.html.dom.svg/svganimationelement/requiredextensions/) { get; } | Corrisponde all'attributo 'requiredExtensions' sull'elemento dato. |
| [RequiredFeatures](../../aspose.html.dom.svg/svganimationelement/requiredfeatures/) { get; } | Corrisponde all'attributo 'requiredFeatures' sull'elemento dato. |
...
| [SystemLanguage](../../aspose.html.dom.svg/svganimationelement/systemlanguage/) { get; } | Corrisponde all'attributo 'systemLanguage' sull'elemento dato. |
| [TagName](../../aspose.html.dom/element/tagname/) { get; } | Il nome dell'elemento. |
| [TargetElement](../../aspose.html.dom.svg/svganimationelement/targetelement/) { get; } | L'elemento che viene animato. |
