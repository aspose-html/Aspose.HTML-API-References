...
description: Aspose.Html.Dom.Svg.SVGRadialGradientElement classe. Linterfaccia SVGRadialGradientElement corrisponde allelemento radialGradient.
type: docs
weight: 2230
url: /it/net/aspose.html.dom.svg/svgradialgradientelement/
---
...
| [Cx](../../aspose.html.dom.svg/svgradialgradientelement/cx/) { get; } | Corrisponde all'attributo 'cx' sull'elemento 'radialGradient' dato. |
| [Cy](../../aspose.html.dom.svg/svgradialgradientelement/cy/) { get; } | Corrisponde all'attributo 'cy' sull'elemento 'radialGradient' dato. |
...
| [Fr](../../aspose.html.dom.svg/svgradialgradientelement/fr/) { get; } | Corrisponde all'attributo 'fr' sull'elemento 'radialGradient' dato. |
| [Fx](../../aspose.html.dom.svg/svgradialgradientelement/fx/) { get; } | Corrisponde all'attributo 'fx' sull'elemento 'radialGradient' dato. |
| [Fy](../../aspose.html.dom.svg/svgradialgradientelement/fy/) { get; } | Corrisponde all'attributo 'fy' sull'elemento 'radialGradient' dato. |
| [GradientTransform](../../aspose.html.dom.svg/svggradientelement/gradienttransform/) { get; } | Corrisponde all'attributo 'gradientTransform' sull'elemento dato. |
| [GradientUnits](../../aspose.html.dom.svg/svggradientelement/gradientunits/) { get; } | Corrisponde all'attributo 'gradientUnits' sull'elemento dato. Accetta una delle costanti definite in SVGUnitTypes. |
| [Href](../../aspose.html.dom.svg/svggradientelement/href/) { get; } | Corrisponde all'attributo 'xlink:href' sull'elemento dato. |
...
| [R](../../aspose.html.dom.svg/svgradialgradientelement/r/) { get; } | Corrisponde all'attributo 'r' sull'elemento 'radialGradient' dato. |
...
| [SpreadMethod](../../aspose.html.dom.svg/svggradientelement/spreadmethod/) { get; } | Corrisponde all'attributo 'spreadMethod' sull'elemento dato. Uno dei tipi di metodo di diffusione definiti su questa interfaccia. |
