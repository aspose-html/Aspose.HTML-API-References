...
description: Aspose.Html.Dom.Svg.SVGGeometryElement classe. Interfaccia SVGGeometryElement rappresenta gli elementi SVG il cui rendering è definito dalla geometria con un percorso equivalente e che possono essere riempiti e tracciati. Ciò include i percorsi e le forme di base.
type: docs
weight: 2090
url: /it/net/aspose.html.dom.svg/svggeometryelement/
---
## SVGGeometryElement class

Interfaccia SVGGeometryElement rappresenta gli elementi SVG il cui rendering è definito dalla geometria con un percorso equivalente e che possono essere riempiti e tracciati. Ciò include i percorsi e le forme di base.
...
| [GetEquivalentPath](../../aspose.html.dom.svg/svggeometryelement/getequivalentpath/)() | Restituisce una nuova istanza di[`SVGPathSegList`](../../aspose.html.dom.svg.paths/svgpathseglist/) che rappresenta`SVGGeometryElement` come segmenti di percorso. |
