...
description: Aspose.Html.Dom.Svg.SVGTextPathElement classe. Linterfaccia SVGTextPathElement corrisponde allelemento textPath.
type: docs
weight: 2360
url: /it/net/aspose.html.dom.svg/svgtextpathelement/
---
...
| [Href](../../aspose.html.dom.svg/svgtextpathelement/href/) { get; } | Corrisponde all'attributo 'xlink:href' sull'elemento dato. |
...
| [LengthAdjust](../../aspose.html.dom.svg/svgtextcontentelement/lengthadjust/) { get; } | Corrisponde all'attributo 'lengthAdjust' sull'elemento dato. Il valore deve essere una delle costanti di regolazione della lunghezza definite su questa interfaccia. |
...
| [Method](../../aspose.html.dom.svg/svgtextpathelement/method/) { get; } | Corrisponde all'attributo 'metodo' sull'elemento 'textPath' dato. |
...
| [Spacing](../../aspose.html.dom.svg/svgtextpathelement/spacing/) { get; } | Corrisponde all'attributo 'spaziatura' sull'elemento 'textPath' specificato. |
| [StartOffset](../../aspose.html.dom.svg/svgtextpathelement/startoffset/) { get; } | Corrisponde all'attributo 'startOffset' sull'elemento 'textPath' dato. |
...
| [TextLength](../../aspose.html.dom.svg/svgtextcontentelement/textlength/) { get; } | Corrisponde all'attributo 'textLength' sull'elemento dato. |
...
| [GetComputedTextLength](../../aspose.html.dom.svg/svgtextcontentelement/getcomputedtextlength/)() | La somma totale di tutti i valori di avanzamento dal rendering di tutti i caratteri all'interno di questo elemento, incluso il valore di avanzamento sui glifi (orizzontale o verticale), l'effetto delle proprietà 'kerning', 'letter-spacing' e 'word- spaziatura' e aggiustamenti dovuti agli attributi 'dx' e 'dy' su elementi 'tspan'. Per gli ambienti senza rendering, l'agente utente deve formulare ipotesi ragionevoli sulle metriche dei glifi. |
...
| [GetNumberOfChars](../../aspose.html.dom.svg/svgtextcontentelement/getnumberofchars/)() | Restituisce il numero totale di caratteri disponibili per il rendering all'interno dell'elemento corrente, che include i caratteri referenziati dal riferimento 'tref', indipendentemente dal fatto che verranno visualizzati. In effetti, questo è equivalente alla lunghezza dell'attributo Node::textContent da DOM Level 3 Core ([DOM3], sezione 1.4), se tale attributo ha anche espanso gli elementi 'tref'. |
...
| Nome | Descrizione |
| --- | --- |
| const [TEXTPATH_METHODTYPE_ALIGN](../../aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_align/) | Corrisponde al valore 'align'. |
| const [TEXTPATH_METHODTYPE_STRETCH](../../aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_stretch/) | Corrisponde al valore 'stretch'. |
| const [TEXTPATH_METHODTYPE_UNKNOWN](../../aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_unknown/) | L'enumerazione è stata impostata su un valore che non è uno dei tipi predefiniti. Non è valido tentare di definire un nuovo valore di questo tipo o tentare di convertire un valore esistente in questo tipo. |
| const [TEXTPATH_SPACINGTYPE_AUTO](../../aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_auto/) | Corrisponde al valore 'auto'. |
| const [TEXTPATH_SPACINGTYPE_EXACT](../../aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_exact/) | Corrisponde al valore 'esatto'. |
| const [TEXTPATH_SPACINGTYPE_UNKNOWN](../../aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_unknown/) | L'enumerazione è stata impostata su un valore che non è uno dei tipi predefiniti. Non è valido tentare di definire un nuovo valore di questo tipo o tentare di convertire un valore esistente in questo tipo. |
