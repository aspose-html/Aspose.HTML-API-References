...
description: Aspose.Html.Dom.Svg.SVGPatternElement classe. Linterfaccia SVGPatternElement corrisponde allelemento pattern.
type: docs
weight: 2200
url: /it/net/aspose.html.dom.svg/svgpatternelement/
---
...
| [Height](../../aspose.html.dom.svg/svgpatternelement/height/) { get; } | Corrisponde all'attributo 'height' sull'elemento 'pattern' dato. |
| [Href](../../aspose.html.dom.svg/svgpatternelement/href/) { get; } | Corrisponde all'attributo 'xlink:href' sull'elemento dato. |
...
| [PatternContentUnits](../../aspose.html.dom.svg/svgpatternelement/patterncontentunits/) { get; } | Corrisponde all'attributo 'patternContentUnits' sull'elemento 'pattern' dato. Accetta una delle costanti definite in SVGUnitTypes. |
| [PatternTransform](../../aspose.html.dom.svg/svgpatternelement/patterntransform/) { get; } | Corrisponde all'attributo 'patternTransform' sull'elemento 'pattern' dato. |
| [PatternUnits](../../aspose.html.dom.svg/svgpatternelement/patternunits/) { get; } | Corrisponde all'attributo 'patternUnits' sull'elemento 'pattern' dato. Accetta una delle costanti definite in SVGUnitTypes. |
...
| [PreserveAspectRatio](../../aspose.html.dom.svg/svgpatternelement/preserveaspectratio/) { get; } | Corrisponde all'attributo 'preserveAspectRatio' sull'elemento dato. |
...
| [RequiredExtensions](../../aspose.html.dom.svg/svgpatternelement/requiredextensions/) { get; } | Corrisponde all'attributo 'requiredExtensions' sull'elemento dato. |
| [RequiredFeatures](../../aspose.html.dom.svg/svgpatternelement/requiredfeatures/) { get; } | Corrisponde all'attributo 'requiredFeatures' sull'elemento dato. |
...
| [SystemLanguage](../../aspose.html.dom.svg/svgpatternelement/systemlanguage/) { get; } | Corrisponde all'attributo 'systemLanguage' sull'elemento dato. |
...
| [ViewBox](../../aspose.html.dom.svg/svgpatternelement/viewbox/) { get; } | Corrisponde all'attributo 'viewBox' sull'elemento dato. |
...
| [Width](../../aspose.html.dom.svg/svgpatternelement/width/) { get; } | Corrisponde all'attributo 'width' sull'elemento 'pattern' dato. |
| [X](../../aspose.html.dom.svg/svgpatternelement/x/) { get; } | Corrisponde all'attributo 'x' sull'elemento 'pattern' dato. |
| [Y](../../aspose.html.dom.svg/svgpatternelement/y/) { get; } | Corrisponde all'attributo 'y' sull'elemento 'pattern' dato. |
