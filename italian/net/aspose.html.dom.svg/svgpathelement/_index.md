...
description: Aspose.Html.Dom.Svg.SVGPathElement classe. Linterfaccia SVGPathElement corrisponde allelemento path.
type: docs
weight: 2190
url: /it/net/aspose.html.dom.svg/svgpathelement/
---
...
| [PathLength](../../aspose.html.dom.svg/svggeometryelement/pathlength/) { get; } | Corrisponde all'attributo pathLength sull'elemento dato. |
| [PathSegList](../../aspose.html.dom.svg/svgpathelement/pathseglist/) { get; set; } | Fornisce l'accesso ai contenuti di base (cioè statici) dell'attributo 'd' in una forma che corrisponde uno a uno con la sintassi di SVG. Pertanto, se l'attributo 'd' ha un comando "absolute moveto (M)" e un comando "absolute arcto (A)", pathSegList avrà due voci: un SVG_PATHSEG_MOVETO_ABS e un SVG_PATHSEG_ARC_ABS. |
...
| [CreateSVGPathSegArcAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegarcabs/)(float, float, float, float, float, bool, bool) | Restituisce un oggetto SVGPathSegArcAbs autonomo e parentless. |
| [CreateSVGPathSegArcRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegarcrel/)(float, float, float, float, float, bool, bool) | Restituisce un oggetto SVGPathSegArcRel autonomo e parentless. |
| [CreateSVGPathSegClosePath](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegclosepath/)() | Restituisce un oggetto SVGPathSegClosePath autonomo e parentless. |
| [CreateSVGPathSegCurvetoCubicAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicabs/)(float, float, float, float, float, float) | Restituisce un oggetto SVGPathSegCurvetoCubicAbs autonomo e parentless. |
| [CreateSVGPathSegCurvetoCubicRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicrel/)(float, float, float, float, float, float) | Restituisce un oggetto SVGPathSegCurvetoCubicRel autonomo e parentless. |
| [CreateSVGPathSegCurvetoCubicSmoothAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothabs/)(float, float, float, float) | Restituisce un oggetto SVGPathSegCurvetoCubicSmoothAbs autonomo e parentless. |
| [CreateSVGPathSegCurvetoCubicSmoothRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothrel/)(float, float, float, float) | Restituisce un oggetto SVGPathSegCurvetoCubicSmoothRel autonomo e parentless. |
| [CreateSVGPathSegCurvetoQuadraticAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticabs/)(float, float, float, float) | Restituisce un oggetto SVGPathSegCurvetoQuadraticAbs autonomo e parentless. |
| [CreateSVGPathSegCurvetoQuadraticRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticrel/)(float, float, float, float) | Restituisce un oggetto SVGPathSegCurvetoQuadraticRel autonomo e parentless. |
| [CreateSVGPathSegCurvetoQuadraticSmoothAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothabs/)(float, float) | Restituisce un oggetto SVGPathSegCurvetoQuadraticSmoothAbs autonomo e parentless. |
| [CreateSVGPathSegCurvetoQuadraticSmoothRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothrel/)(float, float) | Restituisce un oggetto SVGPathSegCurvetoQuadraticSmoothRel autonomo e parentless. |
| [CreateSVGPathSegLinetoAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoabs/)(float, float) | Restituisce un oggetto SVGPathSegLinetoAbs autonomo e parentless. |
| [CreateSVGPathSegLinetoHorizontalAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetohorizontalabs/)(float) | Restituisce un oggetto SVGPathSegLinetoHorizontalAbs autonomo e parentless. |
| [CreateSVGPathSegLinetoHorizontalRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetohorizontalrel/)(float) | Restituisce un oggetto SVGPathSegLinetoHorizontalRel autonomo e parentless. |
| [CreateSVGPathSegLinetoRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetorel/)(float, float) | Restituisce un oggetto SVGPathSegLinetoRel autonomo e parentless. |
| [CreateSVGPathSegLinetoVerticalAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoverticalabs/)(float) | Restituisce un oggetto SVGPathSegLinetoVerticalAbs autonomo e parentless. |
| [CreateSVGPathSegLinetoVerticalRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoverticalrel/)(float) | Restituisce un oggetto SVGPathSegLinetoVerticalRel autonomo e parentless. |
| [CreateSVGPathSegMovetoAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegmovetoabs/)(float, float) | Restituisce un oggetto SVGPathSegMovetoAbs autonomo e parentless. |
| [CreateSVGPathSegMovetoRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegmovetorel/)(float, float) | Restituisce un oggetto SVGPathSegMovetoRel autonomo e parentless. |
...
| [GetEquivalentPath](../../aspose.html.dom.svg/svggeometryelement/getequivalentpath/)() | Restituisce una nuova istanza di[`SVGPathSegList`](../../aspose.html.dom.svg.paths/svgpathseglist/) che rappresenta[`SVGGeometryElement`](../svggeometryelement/) come segmenti di percorso. |
...
| [GetPointAtLength](../../aspose.html.dom.svg/svggeometryelement/getpointatlength/)(float) | Restituisce la coordinata (x,y) nello spazio utente che è unità di distanza lungo il percorso, utilizzando l'algoritmo di distanza lungo un percorso dell'agente utente. |
...
| [GetTotalLength](../../aspose.html.dom.svg/svggeometryelement/gettotallength/)() | Restituisce il valore calcolato dall'agente utente per la lunghezza totale del percorso utilizzando l'algoritmo distance-along-a-path dell'agente utente, come distanza nel sistema di coordinate dell'utente corrente. |
