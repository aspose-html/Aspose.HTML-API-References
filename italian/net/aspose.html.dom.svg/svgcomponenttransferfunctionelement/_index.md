...
description: Aspose.Html.Dom.Svg.SVGComponentTransferFunctionElement classe. Questa interfaccia definisce uninterfaccia di base utilizzata dalle interfacce della funzione di trasferimento dei componenti.
type: docs
weight: 1970
url: /it/net/aspose.html.dom.svg/svgcomponenttransferfunctionelement/
---
## SVGComponentTransferFunctionElement class

Questa interfaccia definisce un'interfaccia di base utilizzata dalle interfacce della funzione di trasferimento dei componenti.
...
| Nome | Descrizione |
| --- | --- |
| [Amplitude](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/amplitude/) { get; } | Corrisponde all'attributo 'ampiezza' sull'elemento dato. |
...
| [Exponent](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/exponent/) { get; } | Corrisponde all'attributo 'esponente' sull'elemento dato. |
...
| [Intercept](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/intercept/) { get; } | Corrisponde all'attributo 'intercept' sull'elemento dato. |
...
| [Offset](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/offset/) { get; } | Corrisponde all'attributo 'offset' sull'elemento dato. |
...
| [Slope](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/slope/) { get; } | Corrisponde all'attributo 'pendenza' sull'elemento dato. |
...
| [TableValues](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/tablevalues/) { get; } | Corrisponde all'attributo 'tableValues' sull'elemento dato. |
...
| [Type](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/type/) { get; } | Corrisponde all'attributo 'tipo' sull'elemento dato. Accetta una delle costanti SVG_FECOMPONENTTRANSFER_TYPE_* definite su questa interfaccia. |
...
| Nome | Descrizione |
| --- | --- |
| const [SVG_FECOMPONENTTRANSFER_TYPE_DISCRETE](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_discrete/) | Corrisponde al valore 'discreto'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_GAMMA](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_gamma/) | Corrisponde al valore 'gamma'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_IDENTITY](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_identity/) | Corrisponde al valore 'identità'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_LINEAR](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_linear/) | Corrisponde al valore 'lineare'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_TABLE](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_table/) | Corrisponde al valore 'tabella'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_UNKNOWN](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_unknown/) | Il tipo non è uno dei tipi predefiniti. Non è valido tentare di definire un nuovo valore di questo tipo o tentare di convertire un valore esistente in questo tipo. |
