...
description: Aspose.Html.Dom.Svg.SVGMarkerElement classe. Linterfaccia SVGMarkerElement corrisponde allelemento marker.
type: docs
weight: 2160
url: /it/net/aspose.html.dom.svg/svgmarkerelement/
---
...
| [MarkerHeight](../../aspose.html.dom.svg/svgmarkerelement/markerheight/) { get; } | Corrisponde all'attributo 'markerHeight' sull'elemento 'marker' dato. |
| [MarkerUnits](../../aspose.html.dom.svg/svgmarkerelement/markerunits/) { get; } | Corrisponde all'attributo 'markerUnits' sull'elemento 'marker' dato. Uno dei tipi di unità di marcatura definiti su questa interfaccia. |
| [MarkerWidth](../../aspose.html.dom.svg/svgmarkerelement/markerwidth/) { get; } | Corrisponde all'attributo 'markerWidth' sull'elemento 'marker' dato. |
...
| [OrientAngle](../../aspose.html.dom.svg/svgmarkerelement/orientangle/) { get; } | Corrisponde all'attributo 'orient' sull'elemento 'marker' dato. Se markerUnits è SVG_MARKER_ORIENT_ANGLE, il valore dell'angolo per l'attributo 'orient'; in caso contrario, verrà impostato su zero. |
| [OrientType](../../aspose.html.dom.svg/svgmarkerelement/orienttype/) { get; } | Corrisponde all'attributo 'orient' sull'elemento 'marker' dato. Uno dei tipi di orientamento del marker definiti su questa interfaccia. |
...
| [PreserveAspectRatio](../../aspose.html.dom.svg/svgmarkerelement/preserveaspectratio/) { get; } | Corrisponde all'attributo 'preserveAspectRatio' sull'elemento dato. |
...
| [RefX](../../aspose.html.dom.svg/svgmarkerelement/refx/) { get; } | Corrisponde all'attributo 'refX' sull'elemento 'marker' dato. |
| [RefY](../../aspose.html.dom.svg/svgmarkerelement/refy/) { get; } | Corrisponde all'attributo 'refY' sull'elemento 'marker' dato. |
...
| [ViewBox](../../aspose.html.dom.svg/svgmarkerelement/viewbox/) { get; } | Corrisponde all'attributo 'viewBox' sull'elemento dato. |
...
| [SetOrientToAngle](../../aspose.html.dom.svg/svgmarkerelement/setorienttoangle/)(SVGAngle) | Imposta il valore dell'attributo 'orient' sull'angolo dato. |
| [SetOrientToAuto](../../aspose.html.dom.svg/svgmarkerelement/setorienttoauto/)() | Imposta il valore dell'attributo 'orient' su 'auto'. |
...
| Nome | Descrizione |
| --- | --- |
| const [SVG_MARKERUNITS_STROKEWIDTH](../../aspose.html.dom.svg/svgmarkerelement/svg_markerunits_strokewidth/) | Il valore dell'attributo 'markerUnits' è 'strokeWidth'. |
| const [SVG_MARKERUNITS_UNKNOWN](../../aspose.html.dom.svg/svgmarkerelement/svg_markerunits_unknown/) | Il tipo di unità marcatore non è uno dei tipi predefiniti. Non è valido tentare di definire un nuovo valore di questo tipo o tentare di convertire un valore esistente in questo tipo. |
| const [SVG_MARKERUNITS_USERSPACEONUSE](../../aspose.html.dom.svg/svgmarkerelement/svg_markerunits_userspaceonuse/) | Il valore dell'attributo 'markerUnits' è 'userSpaceOnUse'. |
| const [SVG_MARKER_ORIENT_ANGLE](../../aspose.html.dom.svg/svgmarkerelement/svg_marker_orient_angle/) | L'attributo 'orient' ha un valore angolare. |
| const [SVG_MARKER_ORIENT_AUTO](../../aspose.html.dom.svg/svgmarkerelement/svg_marker_orient_auto/) | L'attributo 'orient' ha valore 'auto'. |
| const [SVG_MARKER_ORIENT_UNKNOWN](../../aspose.html.dom.svg/svgmarkerelement/svg_marker_orient_unknown/) | L'orientamento del marker non è uno dei tipi predefiniti. Non è valido tentare di definire un nuovo valore di questo tipo o tentare di convertire un valore esistente in questo tipo. |
