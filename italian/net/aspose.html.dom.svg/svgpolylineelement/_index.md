...
description: Aspose.Html.Dom.Svg.SVGPolylineElement classe. Linterfaccia SVGPolylineElement corrisponde allelemento polilinea.
type: docs
weight: 2220
url: /it/net/aspose.html.dom.svg/svgpolylineelement/
---
## SVGPolylineElement class

L'interfaccia SVGPolylineElement corrisponde all'elemento 'polilinea'.
...
| Nome | Descrizione |
| --- | --- |
| [AnimatedPoints](../../aspose.html.dom.svg/svgpolylineelement/animatedpoints/) { get; } | Fornisce l'accesso ai contenuti animati correnti dell'attributo 'punti'. Se l'attributo o la proprietà specificata viene animata, contiene il valore animato corrente dell'attributo o della proprietà. Se l'attributo o la proprietà specificata non è attualmente animata, contiene lo stesso valore dei punti. |
...
| [Points](../../aspose.html.dom.svg/svgpolylineelement/points/) { get; } | Fornisce l'accesso ai contenuti di base (cioè statici) dell'attributo 'punti'. |
