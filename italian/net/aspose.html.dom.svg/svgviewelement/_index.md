...
description: Aspose.Html.Dom.Svg.SVGViewElement classe. Linterfaccia SVGViewElement corrisponde allelemento view.
type: docs
weight: 2410
url: /it/net/aspose.html.dom.svg/svgviewelement/
---
...
| [PreserveAspectRatio](../../aspose.html.dom.svg/svgviewelement/preserveaspectratio/) { get; } | Corrisponde all'attributo 'preserveAspectRatio' sull'elemento dato. |
...
| [ViewBox](../../aspose.html.dom.svg/svgviewelement/viewbox/) { get; } | Corrisponde all'attributo 'viewBox' sull'elemento dato. |
...
| [ViewTarget](../../aspose.html.dom.svg/svgviewelement/viewtarget/) { get; } | Corrisponde all'attributo 'viewTarget' sull'elemento 'view' dato. Un elenco di valori DOMString che contengono i nomi elencati nell'attributo 'viewTarget'. Ciascuno dei valori DOMString può essere associato all'elemento corrispondente utilizzando la chiamata al metodo getElementById(). |
| [ZoomAndPan](../../aspose.html.dom.svg/svgviewelement/zoomandpan/) { get; set; } | Corrisponde all'attributo 'zoomAndPan' sull'elemento dato. Il valore deve essere una delle costanti SVG_ZOOMANDPAN_* definite su questa interfaccia. |
