...
description: Aspose.Html.Dom.Svg.SVGMaskElement classe. Linterfaccia SVGMaskElement corrisponde allelemento maschera.
type: docs
weight: 2170
url: /it/net/aspose.html.dom.svg/svgmaskelement/
---
## SVGMaskElement class

L'interfaccia SVGMaskElement corrisponde all'elemento 'maschera'.
...
| [Height](../../aspose.html.dom.svg/svgmaskelement/height/) { get; } | Corrisponde all'attributo 'altezza' sull'elemento 'maschera' dato. Accetta una delle costanti definite in SVGUnitTypes. |
...
| [MaskContentUnits](../../aspose.html.dom.svg/svgmaskelement/maskcontentunits/) { get; } | Corrisponde all'attributo 'maskContentUnits' sull'elemento 'mask' dato. Accetta una delle costanti definite in SVGUnitTypes. |
| [MaskUnits](../../aspose.html.dom.svg/svgmaskelement/maskunits/) { get; } | Corrisponde all'attributo 'maskUnits' sull'elemento 'mask' dato. Accetta una delle costanti definite in SVGUnitTypes. |
...
| [RequiredExtensions](../../aspose.html.dom.svg/svgmaskelement/requiredextensions/) { get; } | Corrisponde all'attributo 'requiredExtensions' sull'elemento dato. |
| [RequiredFeatures](../../aspose.html.dom.svg/svgmaskelement/requiredfeatures/) { get; } | Corrisponde all'attributo 'requiredFeatures' sull'elemento dato. |
...
| [SystemLanguage](../../aspose.html.dom.svg/svgmaskelement/systemlanguage/) { get; } | Corrisponde all'attributo 'systemLanguage' sull'elemento dato. |
...
| [Width](../../aspose.html.dom.svg/svgmaskelement/width/) { get; } | Corrisponde all'attributo 'width' sull'elemento 'mask' dato. Accetta una delle costanti definite in SVGUnitTypes. |
| [X](../../aspose.html.dom.svg/svgmaskelement/x/) { get; } | Corrisponde all'attributo 'x' sull'elemento 'mask' dato. Accetta una delle costanti definite in SVGUnitTypes. |
| [Y](../../aspose.html.dom.svg/svgmaskelement/y/) { get; } | Corrisponde all'attributo 'y' sull'elemento 'mask' dato. Accetta una delle costanti definite in SVGUnitTypes. |
