...
description: Aspose.Html.Dom.Svg.SVGGradientElement classe. Linterfaccia SVGGradientElement è uninterfaccia di base utilizzata da SVGLinearGradientElement e SVGRadialGradientElement.
type: docs
weight: 2100
url: /it/net/aspose.html.dom.svg/svggradientelement/
---
## SVGGradientElement class

L'interfaccia SVGGradientElement è un'interfaccia di base utilizzata da SVGLinearGradientElement e SVGRadialGradientElement.
...
| Nome | Descrizione |
| --- | --- |
| const [SVG_SPREADMETHOD_PAD](../../aspose.html.dom.svg/svggradientelement/svg_spreadmethod_pad/) | Corrisponde al valore 'pad'. |
| const [SVG_SPREADMETHOD_REFLECT](../../aspose.html.dom.svg/svggradientelement/svg_spreadmethod_reflect/) | Corrisponde al valore 'reflect'. |
| const [SVG_SPREADMETHOD_REPEAT](../../aspose.html.dom.svg/svggradientelement/svg_spreadmethod_repeat/) | Corrisponde al valore 'ripeti'. |
| const [SVG_SPREADMETHOD_UNKNOWN](../../aspose.html.dom.svg/svggradientelement/svg_spreadmethod_unknown/) | Il tipo non è uno dei tipi predefiniti. Non è valido tentare di definire un nuovo valore di questo tipo o tentare di convertire un valore esistente in questo tipo. |
