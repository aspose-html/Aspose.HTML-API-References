...
description: Aspose.Html.Dom.Svg.SVGElementInstance classe. Loggetto root di ciascun albero shadow degli elementi use implementa linterfaccia SVGUseElementShadowRoot. Questa interfaccia attualmente non definisce alcuna estensione alle proprietà e ai metodi definiti per linterfaccia ShadowRoot e il mixin DocumentOrShadowRoot. Tuttavia lalbero radicato in questo nodo è interamente di sola lettura dal punto di vista degli script dellautore.
type: docs
weight: 2030
url: /it/net/aspose.html.dom.svg/svgelementinstance/
---
## SVGElementInstance class

L'oggetto root di ciascun albero shadow degli elementi use implementa l'interfaccia SVGUseElementShadowRoot. Questa interfaccia attualmente non definisce alcuna estensione alle proprietà e ai metodi definiti per l'interfaccia ShadowRoot e il mixin DocumentOrShadowRoot. Tuttavia, l'albero radicato in questo nodo è interamente di sola lettura dal punto di vista degli script dell'autore.
...
| [ChildElementCount](../../aspose.html.dom/documentfragment/childelementcount/) { get; } | Restituisce il numero corrente di nodi elemento che sono figli di questo elemento. 0 se questo elemento non ha nodi figli di nodeType 1. |
...
| [Children](../../aspose.html.dom/documentfragment/children/) { get; } | Restituisce gli elementi figli dell'elemento corrente. |
...
| [FirstElementChild](../../aspose.html.dom/documentfragment/firstelementchild/) { get; } | Restituisce il primo nodo dell'elemento figlio di questo elemento. null se questo elemento non ha elementi figlio. |
| [Host](../../aspose.html.dom/shadowroot/host/) { get; } | Host è un elemento che contiene questo ShadowRoot. |
| [InnerHTML](../../aspose.html.dom/documentfragment/innerhtml/) { get; set; } | Restituisce un frammento di HTML o XML che rappresenta il contenuto dell'elemento. Può essere impostato per sostituire il contenuto dell'elemento con i nodi analizzati dalla stringa data. |
...
| [LastElementChild](../../aspose.html.dom/documentfragment/lastelementchild/) { get; } | Restituisce l'ultimo nodo dell'elemento figlio di questo elemento. null se questo elemento non ha elementi figlio. |
...
| [Mode](../../aspose.html.dom/shadowroot/mode/) { get; } | Modalità in cui opera questo ShadowRoot. |
...
| [NextElementSibling](../../aspose.html.dom/documentfragment/nextelementsibling/) { get; } | Restituisce il successivo nodo dell'elemento di pari livello di questo elemento. null se questo elemento non ha nodi di pari livello che vengono dopo questo nell'albero del documento. |
...
| override [NodeName](../../aspose.html.dom/documentfragment/nodename/) { get; } | Il nome di questo nodo, a seconda del suo tipo. |
| override [NodeType](../../aspose.html.dom/documentfragment/nodetype/) { get; } | Un codice che rappresenta il tipo dell'oggetto sottostante. |
| virtual [NodeValue](../../aspose.html.dom/node/nodevalue/) { get; set; } | Il valore di questo nodo, a seconda del suo tipo. |
| [OuterHTML](../../aspose.html.dom/documentfragment/outerhtml/) { get; set; } | Restituisce un frammento di HTML o XML che rappresenta l'elemento e il suo contenuto. Può essere impostato per sostituire l'elemento con i nodi analizzati dalla stringa data. |
...
| [PreviousElementSibling](../../aspose.html.dom/documentfragment/previouselementsibling/) { get; } | Restituisce il precedente nodo dell'elemento di pari livello di questo elemento. null se questo elemento non ha nodi di pari livello che precedono questo nell'albero del documento. |
...
| override [TextContent](../../aspose.html.dom/documentfragment/textcontent/) { get; set; } | Questo attributo restituisce il contenuto testuale di questo nodo e dei suoi discendenti. Quando è definito nullo, impostarlo non ha alcun effetto. Al momento dell'impostazione, tutti i possibili figli che questo nodo può avere vengono rimossi e, se la nuova stringa non è vuota o nulla, sostituita da un singolo nodo di testo contenente la stringa su cui è impostato questo attributo. |
...
| [QuerySelector](../../aspose.html.dom/documentfragment/queryselector/)(string) | Restituisce il primo elemento nel documento, che corrisponde a selector |
| [QuerySelectorAll](../../aspose.html.dom/documentfragment/queryselectorall/)(string) | Restituisce un NodeList di tutti gli elementi nel documento, che corrispondono a selector |
