...
description: Aspose.Html.Dom.Css.IStyleSheet διεπαφή. Η διεπαφή StyleSheet είναι η αφηρημένη βασική διεπαφή για κάθε τύπο φύλλου στυλ. Αντιπροσωπεύει ένα ενιαίο φύλλο στυλ που σχετίζεται με ένα δομημένο έγγραφο.
type: docs
weight: 590
url: /el/net/aspose.html.dom.css/istylesheet/
---
...
| [Href](../../aspose.html.dom.css/istylesheet/href/) { get; } | Εάν το φύλλο στυλ είναι ένα συνδεδεμένο φύλλο στυλ, η τιμή του χαρακτηριστικού του είναι η θέση του. Για ενσωματωμένα φύλλα στυλ, η τιμή αυτού του χαρακτηριστικού είναι μηδενική. |
| [Media](../../aspose.html.dom.css/istylesheet/media/) { get; } | Τα μέσα προορισμού που προορίζονται για πληροφορίες στυλ. |
...
| [Title](../../aspose.html.dom.css/istylesheet/title/) { get; } | Ο συμβουλευτικός τίτλος. |
| [Type](../../aspose.html.dom.css/istylesheet/type/) { get; } | Αυτό καθορίζει τη γλώσσα του φύλλου στυλ για αυτό το φύλλο στυλ. Η γλώσσα του φύλλου στυλ καθορίζεται ως τύπος περιεχομένου (π.χ. "κείμενο/css"). |
