...
description: Το Aspose.Html.Dom.Svg.Filters Ο χώρος ονομάτων περιέχει κλάσεις και διεπαφές που σχετίζονται με εφέ φίλτρου στις προδιαγραφές SVG.
type: docs
weight: 140
url: /el/net/aspose.html.dom.svg.filters/
---
Το **Aspose.Html.Dom.Svg.Filters** Ο χώρος ονομάτων περιέχει κλάσεις και διεπαφές που σχετίζονται με εφέ φίλτρου στις προδιαγραφές SVG.
