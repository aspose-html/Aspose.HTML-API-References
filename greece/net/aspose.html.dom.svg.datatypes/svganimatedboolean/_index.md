...
description: Aspose.Html.Dom.Svg.DataTypes.SVGAnimatedBoolean τάξη. Χρησιμοποιείται για χαρακτηριστικά τύπου boolean που μπορούν να κινηθούν.
type: docs
weight: 1080
url: /el/net/aspose.html.dom.svg.datatypes/svganimatedboolean/
---
## SVGAnimatedBoolean class

Χρησιμοποιείται για χαρακτηριστικά τύπου boolean που μπορούν να κινηθούν.
...
| override [ToString](../../aspose.html.dom.svg.datatypes/svganimatedboolean/tostring/)() | Επιστρέφει αString που αντιπροσωπεύει αυτήν την περίπτωση. |
