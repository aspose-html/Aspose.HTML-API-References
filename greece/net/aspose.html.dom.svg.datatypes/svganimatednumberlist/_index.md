...
description: Aspose.Html.Dom.Svg.DataTypes.SVGAnimatedNumberList τάξη. Χρησιμοποιείται για χαρακτηριστικά που λαμβάνουν μια λίστα αριθμών και τα οποία μπορούν να κινηθούν.
type: docs
weight: 1140
url: /el/net/aspose.html.dom.svg.datatypes/svganimatednumberlist/
---
...
| override [ToString](../../aspose.html.dom.svg.datatypes/svganimatednumberlist/tostring/)() | Επιστρέφει αString που αντιπροσωπεύει αυτήν την περίπτωση. |
