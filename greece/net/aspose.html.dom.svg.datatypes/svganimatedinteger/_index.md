...
description: Aspose.Html.Dom.Svg.DataTypes.SVGAnimatedInteger τάξη. Χρησιμοποιείται για χαρακτηριστικά βασικού τύπου ακέραιου που μπορούν να κινηθούν.
type: docs
weight: 1100
url: /el/net/aspose.html.dom.svg.datatypes/svganimatedinteger/
---
## SVGAnimatedInteger class

Χρησιμοποιείται για χαρακτηριστικά βασικού τύπου ακέραιου που μπορούν να κινηθούν.
...
| override [ToString](../../aspose.html.dom.svg.datatypes/svganimatedinteger/tostring/)() | Επιστρέφει αString που αντιπροσωπεύει αυτήν την περίπτωση. |
