...
description: Aspose.Html.Toolkit.Markdown.Syntax.TaskListItemMarker τάξη. Ο δείκτης στοιχείων της λίστας εργασιών.
type: docs
weight: 5600
url: /el/net/aspose.html.toolkit.markdown.syntax/tasklistitemmarker/
---
## TaskListItemMarker class

Ο δείκτης στοιχείων της λίστας εργασιών.
...
| [IsChecked](../../aspose.html.toolkit.markdown.syntax/tasklistitemmarker/ischecked/)() | Καθορίζει τη διεπαφή για την κατάσταση ελέγχου. |
