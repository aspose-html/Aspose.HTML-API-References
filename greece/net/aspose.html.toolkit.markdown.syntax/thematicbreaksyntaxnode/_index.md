...
description: Aspose.Html.Toolkit.Markdown.Syntax.ThematicBreakSyntaxNode τάξη. Εφάρμοσε τον συντακτικό κόμβο θεματικής διακοπής.
type: docs
weight: 5680
url: /el/net/aspose.html.toolkit.markdown.syntax/thematicbreaksyntaxnode/
---
## ThematicBreakSyntaxNode class

Εφάρμοσε τον συντακτικό κόμβο θεματικής διακοπής.
...
| Ονομα | Περιγραφή |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/thematicbreaksyntaxnode/accept/)(MarkdownSyntaxVisitor) | Καθορίζει τη διεπαφή για την Αποδοχή επισκέπτη. |
