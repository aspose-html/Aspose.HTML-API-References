...
description: Aspose.Html.Toolkit.Markdown.Syntax.CodeSpanSyntaxNode τάξη. Αντιπροσωπεύει το CodeSpanSyntaxNode
type: docs
weight: 4840
url: /el/net/aspose.html.toolkit.markdown.syntax/codespansyntaxnode/
---
...
| Ονομα | Περιγραφή |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/codespansyntaxnode/accept/)(MarkdownSyntaxVisitor) | Καθορίζει τη διεπαφή για την αποδοχή επισκέπτη. |
...
| [GetContent](../../aspose.html.toolkit.markdown.syntax/codespansyntaxnode/getcontent/)() | Καθορίζει τη διεπαφή για λήψη περιεχομένου. |
