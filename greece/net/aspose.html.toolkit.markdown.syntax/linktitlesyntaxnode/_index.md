...
description: Aspose.Html.Toolkit.Markdown.Syntax.LinkTitleSyntaxNode τάξη. Αντιπροσωπεύει το LinkTitleSyntaxNode.
type: docs
weight: 5130
url: /el/net/aspose.html.toolkit.markdown.syntax/linktitlesyntaxnode/
---
...
| Ονομα | Περιγραφή |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/linktitlesyntaxnode/accept/)(MarkdownSyntaxVisitor) | Καθορίζει τη διεπαφή για την αποδοχή επισκέπτη. |
...
| [GetValue](../../aspose.html.toolkit.markdown.syntax/linktitlesyntaxnode/getvalue/)() | Καθορίζει τη διεπαφή για την τιμή συμβολοσειράς λήψης. |
