...
description: Aspose.Html.Toolkit.Markdown.Syntax.LineBreakSyntaxNode τάξη. Αντιπροσωπεύει το LineBreakSyntaxNode.
type: docs
weight: 5100
url: /el/net/aspose.html.toolkit.markdown.syntax/linebreaksyntaxnode/
---
## LineBreakSyntaxNode class

Αντιπροσωπεύει το LineBreakSyntaxNode.
...
| virtual [Source](../../aspose.html.toolkit.markdown.syntax/linebreaksyntaxnode/source/) { get; } | Λάβετε την πηγή. |
| virtual [Span](../../aspose.html.toolkit.markdown.syntax/linebreaksyntaxnode/span/) { get; } | Λάβετε το εύρος. |
| [Value](../../aspose.html.toolkit.markdown.syntax/linebreaksyntaxnode/value/) { get; } | Λάβετε την τιμή. |

## Μέθοδοι

| Ονομα | Περιγραφή |
| --- | --- |
| abstract [Accept](../../aspose.html.toolkit.markdown.syntax/inlinesyntaxnode/accept/)(MarkdownSyntaxVisitor) | Καθορίζει τη διεπαφή για την αποδοχή επισκέπτη. |
