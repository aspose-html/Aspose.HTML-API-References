...
description: Aspose.Html.Toolkit.Markdown.Syntax.LinkReferenceDefinitionSyntaxNode τάξη. Αντιπροσωπεύει το LinkReferenceDefinitionSyntaxNode.
type: docs
weight: 5120
url: /el/net/aspose.html.toolkit.markdown.syntax/linkreferencedefinitionsyntaxnode/
---
...
| Ονομα | Περιγραφή |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/linkreferencedefinitionsyntaxnode/accept/)(MarkdownSyntaxVisitor) | Καθορίζει τη διεπαφή για την αποδοχή επισκέπτη. |
...
| [GetDestination](../../aspose.html.toolkit.markdown.syntax/linkreferencedefinitionsyntaxnode/getdestination/)() | Καθορίζει τη διεπαφή για τον προορισμό λήψης. |
| [GetLabel](../../aspose.html.toolkit.markdown.syntax/linkreferencedefinitionsyntaxnode/getlabel/)() | Καθορίζει τη διεπαφή για την ετικέτα λήψης. |
...
| [GetTitle](../../aspose.html.toolkit.markdown.syntax/linkreferencedefinitionsyntaxnode/gettitle/)() | Καθορίζει τη διεπαφή για λήψη τίτλου. |
