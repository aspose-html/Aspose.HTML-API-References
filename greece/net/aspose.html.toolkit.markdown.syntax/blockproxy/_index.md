...
description: Aspose.Html.Toolkit.Markdown.Syntax.BlockProxy τάξη. Αντιπροσωπεύει το BlockProxy.
type: docs
weight: 4800
url: /el/net/aspose.html.toolkit.markdown.syntax/blockproxy/
---
## BlockProxy class
...
| Ονομα | Περιγραφή |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/blockproxy/accept/)(MarkdownSyntaxVisitor) | Καθορίζει τη διεπαφή για την αποδοχή επισκέπτη. |
...
| [GetTarget](../../aspose.html.toolkit.markdown.syntax/blockproxy/gettarget/)() | Λήψη του κόμβου-στόχου. |
...
| override [WriteTo](../../aspose.html.toolkit.markdown.syntax/blockproxy/writeto/#writeto)(MarkdownTextWriter) | Καθορίζει τη διεπαφή για το Write To writer. |
