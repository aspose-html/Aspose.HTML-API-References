...
description: Aspose.Html.Toolkit.Markdown.Syntax.ParagraphSyntaxNode τάξη. Αντιπροσωπεύει τον συντακτικό κόμβο παραγράφου.
type: docs
weight: 5310
url: /el/net/aspose.html.toolkit.markdown.syntax/paragraphsyntaxnode/
---
## ParagraphSyntaxNode class

Αντιπροσωπεύει τον συντακτικό κόμβο παραγράφου.
...
| Ονομα | Περιγραφή |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/paragraphsyntaxnode/accept/)(MarkdownSyntaxVisitor) | Καθορίζει τη διεπαφή για αποδοχή του επισκέπτη. |
...
| [GetContent](../../aspose.html.toolkit.markdown.syntax/paragraphsyntaxnode/getcontent/)() | Καθορίζει τη διεπαφή για λήψη περιεχομένου. |
