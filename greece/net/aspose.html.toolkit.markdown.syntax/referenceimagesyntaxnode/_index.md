---
title: Class ReferenceImageSyntaxNode
second_title: Aspose.HTML για Αναφορά API .NET
description: Aspose.Html.Toolkit.Markdown.Syntax.ReferenceImageSyntaxNode τάξη. Η σύνταξη της εικόνας αναφοράς.
type: docs
weight: 5510
url: /el/net/aspose.html.toolkit.markdown.syntax/referenceimagesyntaxnode/
---
## ReferenceImageSyntaxNode class

Η σύνταξη της εικόνας αναφοράς.
...
| Ονομα | Περιγραφή |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/referenceimagesyntaxnode/accept/)(MarkdownSyntaxVisitor) | Καθορίζει τη διεπαφή για αποδοχή του επισκέπτη. |
...
| [GetAltText](../../aspose.html.toolkit.markdown.syntax/referenceimagesyntaxnode/getalttext/)() | Καθορίζει τη διεπαφή για λήψη του εναλλακτικού κειμένου. |
| [GetLabel](../../aspose.html.toolkit.markdown.syntax/referenceimagesyntaxnode/getlabel/)() | Καθορίζει τη διεπαφή για την ετικέτα λήψης. |
