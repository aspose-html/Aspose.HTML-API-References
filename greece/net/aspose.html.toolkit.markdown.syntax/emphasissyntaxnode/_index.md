---
title: Class EmphasisSyntaxNode
second_title: Aspose.HTML για Αναφορά API .NET
description: Aspose.Html.Toolkit.Markdown.Syntax.EmphasisSyntaxNode τάξη. Αντιπροσωπεύει τον EmphasisSyntaxNode.
type: docs
weight: 4870
url: /el/net/aspose.html.toolkit.markdown.syntax/emphasissyntaxnode/
---
## EmphasisSyntaxNode class

Αντιπροσωπεύει τον EmphasisSyntaxNode.
...
| Ονομα | Περιγραφή |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/emphasissyntaxnode/accept/)(MarkdownSyntaxVisitor) | Καθορίζει τη διεπαφή για την αποδοχή επισκέπτη. |
...
| [GetEmphasisType](../../aspose.html.toolkit.markdown.syntax/emphasissyntaxnode/getemphasistype/)() | Καθορίζει τη διεπαφή για λήψη Έμφασης Τύπος |
