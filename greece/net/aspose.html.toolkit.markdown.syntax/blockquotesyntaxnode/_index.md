---
title: Class BlockQuoteSyntaxNode
second_title: Aspose.HTML για Αναφορά API .NET
description: Aspose.Html.Toolkit.Markdown.Syntax.BlockQuoteSyntaxNode τάξη. Αντιπροσωπεύει το BlockQuoteSyntaxNode.
type: docs
weight: 4810
url: /el/net/aspose.html.toolkit.markdown.syntax/blockquotesyntaxnode/
---
...
| Ονομα | Περιγραφή |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/blockquotesyntaxnode/accept/)(MarkdownSyntaxVisitor) | Καθορίζει τη διεπαφή για την αποδοχή επισκέπτη. |
