...
description: Aspose.Html.Toolkit.Markdown.Syntax.MarkdownSyntaxNode τάξη. Βασική υλοποίηση του MarkdownSyntaxNode.
type: docs
weight: 5190
url: /el/net/aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/
---
...
| Ονομα | Περιγραφή |
| --- | --- |
| virtual [Accept](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/accept/)(MarkdownSyntaxVisitor) | Αποδεχτείτε τον επισκέπτη. |
...
| virtual [WriteTo](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/writeto/#writeto)(MarkdownTextWriter) | Γράψτε στο MarkdownTextWriter. |
| [WriteTo](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/writeto/#writeto_1)(TextWriter) | Εγγραφή κόμβων στο πρόγραμμα εγγραφής κειμένου. |
