...
description: Aspose.Html.Toolkit.Markdown.Syntax.WhitespaceSyntaxNode τάξη. Αντιπροσωπεύει τον κόμβο σύνταξης κενού διαστήματος.
type: docs
weight: 5740
url: /el/net/aspose.html.toolkit.markdown.syntax/whitespacesyntaxnode/
---
## WhitespaceSyntaxNode class

Αντιπροσωπεύει τον κόμβο σύνταξης κενού διαστήματος.
...
| virtual [Source](../../aspose.html.toolkit.markdown.syntax/textsyntaxnode/source/) { get; } | Επιστρέψτε το αρχικό κείμενο. |
| virtual [Span](../../aspose.html.toolkit.markdown.syntax/textsyntaxnode/span/) { get; } | Καθορίζει τη διεπαφή για το get span. |
| [Value](../../aspose.html.toolkit.markdown.syntax/textsyntaxnode/value/) { get; } | Καθορίζει την ιδιότητα για τη λήψη τιμής συμβολοσειράς. |

## Μέθοδοι

| Ονομα | Περιγραφή |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/whitespacesyntaxnode/accept/)(MarkdownSyntaxVisitor) | Καθορίζει τη διεπαφή για την επίσκεψη κόμβων της σύνταξης. |
