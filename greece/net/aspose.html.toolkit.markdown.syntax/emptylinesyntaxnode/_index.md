...
description: Aspose.Html.Toolkit.Markdown.Syntax.EmptyLineSyntaxNode τάξη. Αντιπροσωπεύει τον EmptyLineSyntaxNode.
type: docs
weight: 4880
url: /el/net/aspose.html.toolkit.markdown.syntax/emptylinesyntaxnode/
---
## EmptyLineSyntaxNode class

Αντιπροσωπεύει τον EmptyLineSyntaxNode.
...
| Ονομα | Περιγραφή |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/emptylinesyntaxnode/accept/)(MarkdownSyntaxVisitor) | Καθορίζει τη διεπαφή για την αποδοχή επισκέπτη. |
