...
description: Aspose.Html.Toolkit.Markdown.Syntax.AutoLinkSyntaxNode τάξη. Αντιπροσωπεύει τον AutoLinkSyntaxNode.
type: docs
weight: 4790
url: /el/net/aspose.html.toolkit.markdown.syntax/autolinksyntaxnode/
---
## AutoLinkSyntaxNode class

Αντιπροσωπεύει τον AutoLinkSyntaxNode.
...
| Ονομα | Περιγραφή |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/autolinksyntaxnode/accept/)(MarkdownSyntaxVisitor) | Καθορίζει τη διεπαφή για την αποδοχή επισκέπτη. |
...
| [GetUri](../../aspose.html.toolkit.markdown.syntax/autolinksyntaxnode/geturi/)() | Πάρτε το uri. |
...
| [IsMail](../../aspose.html.toolkit.markdown.syntax/autolinksyntaxnode/ismail/)() | Get true, αν είναι mail. |
