...
description: Aspose.Html.Toolkit.Markdown.Syntax.SetextHeadingSyntaxNode τάξη. Αντιπροσωπεύει τον συντακτικό κόμβο επικεφαλίδας Setext.
type: docs
weight: 5530
url: /el/net/aspose.html.toolkit.markdown.syntax/setextheadingsyntaxnode/
---
## SetextHeadingSyntaxNode class

Αντιπροσωπεύει τον συντακτικό κόμβο επικεφαλίδας Setext.
...
| [Level](../../aspose.html.toolkit.markdown.syntax/setextheadingsyntaxnode/level/) { get; } | Λάβετε το επίπεδο της τρέχουσας σύνταξης. |
...
| Ονομα | Περιγραφή |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/setextheadingsyntaxnode/accept/)(MarkdownSyntaxVisitor) | Καθορίζει τη διεπαφή για αποδοχή του επισκέπτη. |
