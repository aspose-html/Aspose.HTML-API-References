---
title: Class AtxHeadingSyntaxNode
second_title: Aspose.HTML για Αναφορά API .NET
description: Aspose.Html.Toolkit.Markdown.Syntax.AtxHeadingSyntaxNode τάξη. Αντιπροσωπεύει τον AtxHeadingSyntaxNode.
type: docs
weight: 4780
url: /el/net/aspose.html.toolkit.markdown.syntax/atxheadingsyntaxnode/
---
## AtxHeadingSyntaxNode class

Αντιπροσωπεύει τον AtxHeadingSyntaxNode.
...
| Ονομα | Περιγραφή |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/atxheadingsyntaxnode/accept/)(MarkdownSyntaxVisitor) | Καθορίζει τη διεπαφή για την αποδοχή επισκέπτη. |
...
| [GetClosingTag](../../aspose.html.toolkit.markdown.syntax/atxheadingsyntaxnode/getclosingtag/)() | Καθορίζει τη διεπαφή για λήψη ClosingTag. |
| [GetLeadingTrivia](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/getleadingtrivia/)() | Αποκτήστε τα κορυφαία trivia. |
| [GetOpeningTag](../../aspose.html.toolkit.markdown.syntax/atxheadingsyntaxnode/getopeningtag/)() | Καθορίζει τη διεπαφή για λήψη OpeningTag. |
