...
description: Aspose.Html.Toolkit.Markdown.Syntax.UnorderedListItemMarker τάξη. Αντιπροσωπεύει τη σύνταξη του μη ταξινομημένου στοιχείου λίστας.
type: docs
weight: 5720
url: /el/net/aspose.html.toolkit.markdown.syntax/unorderedlistitemmarker/
---
## UnorderedListItemMarker class

Αντιπροσωπεύει τη σύνταξη του μη ταξινομημένου στοιχείου λίστας.
