...
description: Aspose.Html.Toolkit.Markdown.Syntax.TextSyntaxNode τάξη. Εφάρμοσε τον κόμβο σύνταξης κειμένου.
type: docs
weight: 5670
url: /el/net/aspose.html.toolkit.markdown.syntax/textsyntaxnode/
---
## TextSyntaxNode class

Εφάρμοσε τον κόμβο σύνταξης κειμένου.
...
| Ονομα | Περιγραφή |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/textsyntaxnode/accept/)(MarkdownSyntaxVisitor) | Καθορίζει τη διεπαφή για την αποδοχή επισκέπτη. |
