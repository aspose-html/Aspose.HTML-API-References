---
title: Class IndentedCodeBlockSyntaxNode
second_title: Aspose.HTML για Αναφορά API .NET
description: Aspose.Html.Toolkit.Markdown.Syntax.IndentedCodeBlockSyntaxNode τάξη. Αντιπροσωπεύει τον IndentedCodeBlockSyntaxNode.
type: docs
weight: 5030
url: /el/net/aspose.html.toolkit.markdown.syntax/indentedcodeblocksyntaxnode/
---
## IndentedCodeBlockSyntaxNode class

Αντιπροσωπεύει τον IndentedCodeBlockSyntaxNode.
...
| Ονομα | Περιγραφή |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/indentedcodeblocksyntaxnode/accept/)(MarkdownSyntaxVisitor) | Καθορίζει τη διεπαφή για την αποδοχή επισκέπτη. |
...
| [GetContent](../../aspose.html.toolkit.markdown.syntax/indentedcodeblocksyntaxnode/getcontent/)() | Καθορίζει τη διεπαφή για λήψη περιεχομένου. |
