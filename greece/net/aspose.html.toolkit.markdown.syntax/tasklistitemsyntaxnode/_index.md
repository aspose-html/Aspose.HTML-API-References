...
description: Aspose.Html.Toolkit.Markdown.Syntax.TaskListItemSyntaxNode τάξη. Ο κόμβος σύνταξης του στοιχείου της λίστας εργασιών.
type: docs
weight: 5610
url: /el/net/aspose.html.toolkit.markdown.syntax/tasklistitemsyntaxnode/
---
## TaskListItemSyntaxNode class

Ο κόμβος σύνταξης του στοιχείου της λίστας εργασιών.
...
| Ονομα | Περιγραφή |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/listitemsyntaxnode/accept/)(MarkdownSyntaxVisitor) | Καθορίζει τη διεπαφή για την αποδοχή επισκέπτη. |
...
| [GetLinesLeadingTrivia](../../aspose.html.toolkit.markdown.syntax/multilinecontainerblocksyntaxnode/getlinesleadingtrivia/)() | Καθορίζει τη διεπαφή για λήψη γραμμών που οδηγούν σε trivia. |
| [GetMarker](../../aspose.html.toolkit.markdown.syntax/listitemsyntaxnode/getmarker/)() | Λήψη δείκτη |
...
| [IsChecked](../../aspose.html.toolkit.markdown.syntax/tasklistitemsyntaxnode/ischecked/)() | Καθορίζει τη διεπαφή για την κατάσταση ελέγχου. |
| [IsTight](../../aspose.html.toolkit.markdown.syntax/listitemsyntaxnode/istight/)() | Γίνε αλήθεια αν είναι σφιχτό. |
