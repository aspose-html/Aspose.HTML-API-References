---
title: Class CharacterReferenceSyntaxNode
second_title: Aspose.HTML για Αναφορά API .NET
description: Aspose.Html.Toolkit.Markdown.Syntax.CharacterReferenceSyntaxNode τάξη. Αντιπροσωπεύει τον CharacterReferenceSyntaxNode.
type: docs
weight: 4830
url: /el/net/aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/
---
## CharacterReferenceSyntaxNode class

Αντιπροσωπεύει τον CharacterReferenceSyntaxNode.
...
| [Reference](../../aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/reference/) { get; } | Λάβετε την αναφορά. |
| [Source](../../aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/source/) { get; } | Λάβετε την πηγή. |
| [Span](../../aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/span/) { get; } | Λάβετε το εύρος. |
| [Value](../../aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/value/) { get; } | Λάβετε την τιμή. |

## Μέθοδοι

| Ονομα | Περιγραφή |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/accept/)(MarkdownSyntaxVisitor) | Καθορίζει τη διεπαφή για την αποδοχή επισκέπτη. |
