...
description: Aspose.Html.Toolkit.Markdown.Syntax.InlineImageSyntaxNode τάξη. Αντιπροσωπεύει τον InlineImageSyntaxNode.
type: docs
weight: 5050
url: /el/net/aspose.html.toolkit.markdown.syntax/inlineimagesyntaxnode/
---
## InlineImageSyntaxNode class

Αντιπροσωπεύει τον InlineImageSyntaxNode.
...
| Ονομα | Περιγραφή |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/inlineimagesyntaxnode/accept/)(MarkdownSyntaxVisitor) | Καθορίζει τη διεπαφή για την αποδοχή επισκέπτη. |
...
| [GetAltText](../../aspose.html.toolkit.markdown.syntax/inlineimagesyntaxnode/getalttext/)() | Καθορίζει τη διεπαφή για λήψη όλου του κειμένου. |
| [GetDestination](../../aspose.html.toolkit.markdown.syntax/inlineimagesyntaxnode/getdestination/)() | Καθορίζει τη διεπαφή για τον προορισμό λήψης. |
...
| [GetTitle](../../aspose.html.toolkit.markdown.syntax/inlineimagesyntaxnode/gettitle/)() | Καθορίζει τη διεπαφή για λήψη τίτλου. |
