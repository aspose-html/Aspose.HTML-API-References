...
description: Aspose.Html.Toolkit.Markdown.Syntax.LinkDestinationSyntaxNode τάξη. Αντιπροσωπεύει το LinkDestinationSyntaxNode.
type: docs
weight: 5110
url: /el/net/aspose.html.toolkit.markdown.syntax/linkdestinationsyntaxnode/
---
...
| Ονομα | Περιγραφή |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/linkdestinationsyntaxnode/accept/)(MarkdownSyntaxVisitor) | Καθορίζει τη διεπαφή για την αποδοχή επισκέπτη. |
...
| [GetValue](../../aspose.html.toolkit.markdown.syntax/linkdestinationsyntaxnode/getvalue/)() | Καθορίζει τη διεπαφή για την τιμή συμβολοσειράς λήψης. |
