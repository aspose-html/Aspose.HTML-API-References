...
description: Aspose.Html.Toolkit.Markdown.Syntax.TableRowSyntaxNode τάξη. Ο συντακτικός κόμβος σειρών πίνακα.
type: docs
weight: 5580
url: /el/net/aspose.html.toolkit.markdown.syntax/tablerowsyntaxnode/
---
## TableRowSyntaxNode class

Ο συντακτικός κόμβος σειρών πίνακα.
...
| [AppendCell](../../aspose.html.toolkit.markdown.syntax/tablerowsyntaxnode/appendcell/)(TableCellSyntaxNode) | Καθορίζει τη διεπαφή για την προσάρτηση του κελιού. |
...
| [AppendDelimiter](../../aspose.html.toolkit.markdown.syntax/tablerowsyntaxnode/appenddelimiter/)(TableDelimiterSyntaxNode) | Καθορίζει τη διεπαφή για τον οριοθέτη προσάρτησης. |
| [ChildNodes](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/childnodes/)() | Λήψη της συλλογής θυγατρικών κόμβων. |
| [GetCells](../../aspose.html.toolkit.markdown.syntax/tablerowsyntaxnode/getcells/)() | Καθορίζει τη διεπαφή για τα κελιά λήψης. |
