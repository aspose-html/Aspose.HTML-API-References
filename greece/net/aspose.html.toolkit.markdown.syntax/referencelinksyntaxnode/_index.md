---
title: Class ReferenceLinkSyntaxNode
second_title: Aspose.HTML για Αναφορά API .NET
description: Aspose.Html.Toolkit.Markdown.Syntax.ReferenceLinkSyntaxNode τάξη. Αντιπροσωπεύει τη σύνταξη του συνδέσμου αναφοράς.
type: docs
weight: 5520
url: /el/net/aspose.html.toolkit.markdown.syntax/referencelinksyntaxnode/
---
## ReferenceLinkSyntaxNode class

Αντιπροσωπεύει τη σύνταξη του συνδέσμου αναφοράς.
...
| Ονομα | Περιγραφή |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/referencelinksyntaxnode/accept/)(MarkdownSyntaxVisitor) | Καθορίζει τη διεπαφή για αποδοχή του επισκέπτη. |
...
| [GetContent](../../aspose.html.toolkit.markdown.syntax/referencelinksyntaxnode/getcontent/)() | Καθορίζει τη διεπαφή για λήψη περιεχομένου. |
| [GetLabel](../../aspose.html.toolkit.markdown.syntax/referencelinksyntaxnode/getlabel/)() | Καθορίζει τη διεπαφή για την ετικέτα λήψης. |
