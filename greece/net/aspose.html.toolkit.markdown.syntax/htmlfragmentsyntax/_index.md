---
title: Class HTMLFragmentSyntax
second_title: Aspose.HTML για Αναφορά API .NET
description: Aspose.Html.Toolkit.Markdown.Syntax.HTMLFragmentSyntax τάξη. Αντιπροσωπεύει το HTMLFragmentSyntax.
type: docs
weight: 5000
url: /el/net/aspose.html.toolkit.markdown.syntax/htmlfragmentsyntax/
---
## HTMLFragmentSyntax class

Αντιπροσωπεύει το HTMLFragmentSyntax.
...
| Ονομα | Περιγραφή |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/htmlfragmentsyntax/accept/)(MarkdownSyntaxVisitor) | Καθορίζει τη διεπαφή για την αποδοχή επισκέπτη. |
...
| [GetContent](../../aspose.html.toolkit.markdown.syntax/htmlfragmentsyntax/getcontent/)() | Καθορίζει τη διεπαφή για λήψη περιεχομένου. |
...
| [SetContent](../../aspose.html.toolkit.markdown.syntax/htmlfragmentsyntax/setcontent/)(string) | Καθορίζει τη διεπαφή για το σύνολο Περιεχομένου. |
