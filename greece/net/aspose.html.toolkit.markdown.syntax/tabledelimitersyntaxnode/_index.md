...
description: Aspose.Html.Toolkit.Markdown.Syntax.TableDelimiterSyntaxNode τάξη. Αντιπροσωπεύει τον συντακτικό κόμβο οριοθέτη πίνακα.
type: docs
weight: 5570
url: /el/net/aspose.html.toolkit.markdown.syntax/tabledelimitersyntaxnode/
---
## TableDelimiterSyntaxNode class

Αντιπροσωπεύει τον συντακτικό κόμβο οριοθέτη πίνακα.
