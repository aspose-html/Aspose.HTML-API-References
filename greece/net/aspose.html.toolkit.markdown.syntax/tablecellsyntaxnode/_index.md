...
description: Aspose.Html.Toolkit.Markdown.Syntax.TableCellSyntaxNode τάξη. Αντιπροσωπεύει τον κόμβο σύνταξης κελιών πίνακα.
type: docs
weight: 5560
url: /el/net/aspose.html.toolkit.markdown.syntax/tablecellsyntaxnode/
---
## TableCellSyntaxNode class

Αντιπροσωπεύει τον κόμβο σύνταξης κελιών πίνακα.
...
| [GetValue](../../aspose.html.toolkit.markdown.syntax/tablecellsyntaxnode/getvalue/)() | Καθορίζει τη διεπαφή για την τιμή συμβολοσειράς λήψης. |
