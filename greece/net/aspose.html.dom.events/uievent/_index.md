...
description: Aspose.Html.Dom.Events.UIEvent τάξη. Η διεπαφή UIEvent παρέχει συγκεκριμένες πληροφορίες σχετικά με τα συμφραζόμενα που σχετίζονται με συμβάντα διεπαφής χρήστη.
type: docs
weight: 850
url: /el/net/aspose.html.dom.events/uievent/
---
## UIEvent class

Η διεπαφή UIEvent παρέχει συγκεκριμένες πληροφορίες σχετικά με τα συμφραζόμενα που σχετίζονται με συμβάντα διεπαφής χρήστη.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [UIEvent](uievent/#constructor)(string) | Αρχικοποιεί μια νέα παρουσία του`UIEvent` τάξη. |
| [UIEvent](uievent/#constructor_1)(string, IDictionary&lt;string, object&gt;) | Αρχικοποιεί μια νέα παρουσία του`UIEvent` τάξη. |
