...
description: Aspose.Html.Dom.Events.ErrorEvent τάξη. ΤοErrorEvent παρέχει πληροφορίες σχετικά με τα συμφραζόμενα σχετικά με σφάλματα που παρουσιάστηκαν κατά τη διάρκεια του χρόνου εκτέλεσης.
type: docs
weight: 760
url: /el/net/aspose.html.dom.events/errorevent/
---
## ErrorEvent class

Το`ErrorEvent` παρέχει πληροφορίες σχετικά με τα συμφραζόμενα σχετικά με σφάλματα που παρουσιάστηκαν κατά τη διάρκεια του χρόνου εκτέλεσης.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [ErrorEvent](errorevent/#constructor_1)(Exception) | Αρχικοποιεί μια νέα παρουσία του`ErrorEvent` τάξη. |
| [ErrorEvent](errorevent/#constructor)(IDictionary&lt;string, object&gt;) | Αρχικοποιεί μια νέα παρουσία του`ErrorEvent` τάξη. |
...
| [ColNo](../../aspose.html.dom.events/errorevent/colno/) { get; } | Το χαρακτηριστικό colno πρέπει να επιστρέψει την τιμή στην οποία είχε αρχικοποιηθεί. Όταν δημιουργείται το αντικείμενο, αυτό το χαρακτηριστικό πρέπει να αρχικοποιηθεί στο μηδέν. Αντιπροσωπεύει τον αριθμό της στήλης όπου παρουσιάστηκε το σφάλμα στο σενάριο. |
...
| [Error](../../aspose.html.dom.events/errorevent/error/) { get; } | Το χαρακτηριστικό σφάλματος πρέπει να επιστρέψει την τιμή στην οποία είχε αρχικοποιηθεί. Όταν δημιουργείται το αντικείμενο, αυτό το χαρακτηριστικό πρέπει να αρχικοποιηθεί σε null. Όπου ενδείκνυται, ορίζεται στο αντικείμενο που αντιπροσωπεύει το σφάλμα (π.χ. το αντικείμενο εξαίρεσης στην περίπτωση μιας εξαίρεσης DOM που δεν έχει εντοπιστεί). |
...
| [LineNo](../../aspose.html.dom.events/errorevent/lineno/) { get; } | Το χαρακτηριστικό lineno πρέπει να επιστρέψει την τιμή στην οποία είχε αρχικοποιηθεί. Όταν δημιουργείται το αντικείμενο, αυτό το χαρακτηριστικό πρέπει να αρχικοποιηθεί στο μηδέν. Αντιπροσωπεύει τον αριθμό γραμμής όπου παρουσιάστηκε το σφάλμα στο σενάριο. |
| [Message](../../aspose.html.dom.events/errorevent/message/) { get; } | Το χαρακτηριστικό μήνυμα πρέπει να επιστρέψει την τιμή στην οποία είχε αρχικοποιηθεί. Όταν δημιουργείται το αντικείμενο, αυτό το χαρακτηριστικό πρέπει να αρχικοποιηθεί στην κενή συμβολοσειρά. Αντιπροσωπεύει το μήνυμα σφάλματος. |
