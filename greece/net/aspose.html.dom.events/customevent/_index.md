...
description: Aspose.Html.Dom.Events.CustomEvent τάξη. Τα συμβάντα που χρησιμοποιούν τη διεπαφή CustomEvent μπορούν να χρησιμοποιηθούν για τη μεταφορά προσαρμοσμένων δεδομένων.
type: docs
weight: 730
url: /el/net/aspose.html.dom.events/customevent/
---
## CustomEvent class
...
| [Detail](../../aspose.html.dom.events/customevent/detail/) { get; } | Λαμβάνει τα προσαρμοσμένα δεδομένα. |
...
| [InitCustomEvent](../../aspose.html.dom.events/customevent/initcustomevent/)(string, bool, bool, object) | /// Το[`InitEvent`](../event/initevent/) Η μέθοδος χρησιμοποιείται για την προετοιμασία της τιμής του an[`Event`](../event/) δημιουργήθηκε μέσω του[`IDocumentEvent`](../idocumentevent/) διεπαφή. |
