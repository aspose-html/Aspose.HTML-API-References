...
description: Aspose.Html.Drawing.ColorModel αρίθμηση. Αυτή η απαρίθμηση χρησιμοποιείται για την επιλογή του χρωματικού μοντέλου για εργασία με στοιχεία χρώματος.
type: docs
weight: 2650
url: /el/net/aspose.html.drawing/colormodel/
---
