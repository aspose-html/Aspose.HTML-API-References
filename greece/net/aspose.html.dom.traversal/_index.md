...
description: Το Aspose.Html.Dom.TraversalΟ χώρος ονομάτων περιέχει μεθόδους που δημιουργούν επαναλήπτες και περιπατητές δέντρων για πλοήγηση μεταξύ στοιχείων και διασχίζουν έναν κόμβο και τα παιδιά του με σειρά εγγράφων.
type: docs
weight: 170
url: /el/net/aspose.html.dom.traversal/
---
Το **Aspose.Html.Dom.Traversal**Ο χώρος ονομάτων περιέχει μεθόδους που δημιουργούν επαναλήπτες και περιπατητές δέντρων για πλοήγηση μεταξύ στοιχείων και διασχίζουν έναν κόμβο και τα παιδιά του με σειρά εγγράφων.
