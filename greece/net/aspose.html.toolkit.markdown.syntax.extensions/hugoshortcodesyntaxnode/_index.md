...
description: Aspose.Html.Toolkit.Markdown.Syntax.Extensions.HugoShortCodeSyntaxNode τάξη. Καθορίζει το HugoShortCodeSyntaxNode
type: docs
weight: 4920
url: /el/net/aspose.html.toolkit.markdown.syntax.extensions/hugoshortcodesyntaxnode/
---
## HugoShortCodeSyntaxNode class

Καθορίζει το HugoShortCodeSyntaxNode
...
| Ονομα | Περιγραφή |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/inlinecontainersyntaxnode/accept/)(MarkdownSyntaxVisitor) | Καθορίζει τη διεπαφή για την αποδοχή επισκέπτη. |
...
| [GetEnumerator](../../aspose.html.toolkit.markdown.syntax/inlinecontainersyntaxnode/getenumerator/)() | Επιστρέφει έναν απαριθμητή που επαναλαμβάνει τη συλλογή. |
| [GetLeadingTrivia](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/getleadingtrivia/)() | Αποκτήστε τα κορυφαία trivia. |
| [GetParameter](../../aspose.html.toolkit.markdown.syntax.extensions/hugoshortcodesyntaxnode/getparameter/)(int) | Ορίζει το GetParameter |
| [GetParametersCount](../../aspose.html.toolkit.markdown.syntax.extensions/hugoshortcodesyntaxnode/getparameterscount/)() | Καθορίζει το GetParametersCount |
...
| [IsEndTag](../../aspose.html.toolkit.markdown.syntax.extensions/hugoshortcodesyntaxnode/isendtag/)() | Καθορίζει τη διεπαφή για έλεγχο IsEndTag |
