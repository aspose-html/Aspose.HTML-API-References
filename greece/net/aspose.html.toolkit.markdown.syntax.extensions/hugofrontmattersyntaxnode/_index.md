...
description: Aspose.Html.Toolkit.Markdown.Syntax.Extensions.HugoFrontMatterSyntaxNode τάξη. Καθορίζει τη βασική κλάση HugoFrontMatterSyntaxNode
type: docs
weight: 4910
url: /el/net/aspose.html.toolkit.markdown.syntax.extensions/hugofrontmattersyntaxnode/
---
## HugoFrontMatterSyntaxNode class

Καθορίζει τη βασική κλάση HugoFrontMatterSyntaxNode
...
| abstract [FrontMatterRootNode](../../aspose.html.toolkit.markdown.syntax.extensions/hugofrontmattersyntaxnode/frontmatterrootnode/) { get; } | Λήψη και ρύθμιση του RootNode |
...
| [Find](../../aspose.html.toolkit.markdown.syntax.extensions/hugofrontmattersyntaxnode/find/#find)(params string[]) | Καθορίζει τη διεπαφή για την εύρεση BaseSyntaxNode |
| abstract [Find&lt;T&gt;](../../aspose.html.toolkit.markdown.syntax.extensions/hugofrontmattersyntaxnode/find/#find_1)(params string[]) | Καθορίζει τη διεπαφή για την εύρεση T |
