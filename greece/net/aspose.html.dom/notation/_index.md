...
description: Aspose.Html.Dom.Notation τάξη. Αντιπροσωπεύει μια σημείωση που δηλώνεται στο DTD.
type: docs
weight: 1010
url: /el/net/aspose.html.dom/notation/
---
## Notation class

Αντιπροσωπεύει μια σημείωση που δηλώνεται στο DTD.
...
| override [NodeName](../../aspose.html.dom/notation/nodename/) { get; } | Το όνομα αυτού του κόμβου, ανάλογα με τον τύπο του. |
| override [NodeType](../../aspose.html.dom/notation/nodetype/) { get; } | Ένας κωδικός που αντιπροσωπεύει τον τύπο του υποκείμενου αντικειμένου. |
...
| [PublicId](../../aspose.html.dom/notation/publicid/) { get; } | Το δημόσιο αναγνωριστικό αυτού του συμβολισμού. Εάν το δημόσιο αναγνωριστικό δεν καθορίστηκε, αυτό είναι null. |
| [SystemId](../../aspose.html.dom/notation/systemid/) { get; } | Το αναγνωριστικό συστήματος αυτού του συμβολισμού. Εάν το αναγνωριστικό συστήματος δεν καθορίστηκε, αυτό είναι μηδενικό. Αυτό μπορεί να είναι απόλυτο URI ή όχι. |
