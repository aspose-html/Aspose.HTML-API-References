...
description: Aspose.Html.Dom.CharacterData τάξη. Το CharacterData επεκτείνει τον κόμβο με ένα σύνολο χαρακτηριστικών και μεθόδων για την πρόσβαση σε δεδομένα χαρακτήρων στο DOM.
type: docs
weight: 300
url: /el/net/aspose.html.dom/characterdata/
---
## CharacterData class
