...
description: Aspose.Html.Dom.Entity τάξη. Αντιπροσωπεύει μια γνωστή οντότητα είτε αναλυμένη είτε χωρίς ανάλυση σε ένα έγγραφο XML.
type: docs
weight: 700
url: /el/net/aspose.html.dom/entity/
---
## Entity class

Αντιπροσωπεύει μια γνωστή οντότητα, είτε αναλυμένη είτε χωρίς ανάλυση, σε ένα έγγραφο XML.
...
| [InputEncoding](../../aspose.html.dom/entity/inputencoding/) { get; } | Ένα χαρακτηριστικό που καθορίζει την κωδικοποίηση που χρησιμοποιείται για αυτήν την οντότητα τη στιγμή της ανάλυσης, όταν πρόκειται για μια εξωτερική αναλυμένη οντότητα. Αυτό είναι μηδενικό εάν είναι οντότητα από το εσωτερικό υποσύνολο ή αν δεν είναι γνωστό. |
...
| override [NodeName](../../aspose.html.dom/entity/nodename/) { get; } | Το όνομα αυτού του κόμβου, ανάλογα με τον τύπο του. |
| override [NodeType](../../aspose.html.dom/entity/nodetype/) { get; } | Ένας κωδικός που αντιπροσωπεύει τον τύπο του υποκείμενου αντικειμένου. |
| virtual [NodeValue](../../aspose.html.dom/node/nodevalue/) { get; set; } | Η τιμή αυτού του κόμβου, ανάλογα με τον τύπο του. |
| [NotationName](../../aspose.html.dom/entity/notationname/) { get; } | Για μη αναλυμένες οντότητες, το όνομα της σημείωσης για την οντότητα. Για αναλυμένες οντότητες, αυτό είναι null. |
...
| [PublicId](../../aspose.html.dom/entity/publicid/) { get; } | Το δημόσιο αναγνωριστικό που σχετίζεται με την οντότητα, εάν καθορίζεται, και μηδενικό διαφορετικά. |
| [SystemId](../../aspose.html.dom/entity/systemid/) { get; } | Το αναγνωριστικό συστήματος που σχετίζεται με την οντότητα, εάν καθορίζεται, και μηδενίζεται διαφορετικά. Αυτό μπορεί να είναι απόλυτο URI ή όχι. |
...
| [XmlEncoding](../../aspose.html.dom/entity/xmlencoding/) { get; } | Χαρακτηριστικό που προσδιορίζει, ως μέρος της δήλωσης κειμένου, την κωδικοποίηση αυτής της οντότητας, όταν πρόκειται για μια εξωτερική αναλυμένη οντότητα. Αυτό είναι μηδενικό διαφορετικά. |
| [XmlVersion](../../aspose.html.dom/entity/xmlversion/) { get; } | Χαρακτηριστικό που καθορίζει, ως μέρος της δήλωσης κειμένου, τον αριθμό έκδοσης αυτής της οντότητας, όταν πρόκειται για εξωτερική οντότητα ανάλυσης. Αυτό είναι μηδενικό διαφορετικά. |
