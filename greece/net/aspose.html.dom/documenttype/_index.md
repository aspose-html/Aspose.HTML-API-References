...
description: Aspose.Html.Dom.DocumentType τάξη. Το DocumentType παρέχει μια διεπαφή στη λίστα των οντοτήτων που έχουν οριστεί για το document
type: docs
weight: 680
url: /el/net/aspose.html.dom/documenttype/
---
## DocumentType class

Το DocumentType παρέχει μια διεπαφή στη λίστα των οντοτήτων που έχουν οριστεί για το document
...
| Ονομα | Περιγραφή |
| --- | --- |
| [DocumentType](documenttype/)(string, string, string, string, Document) | Αρχικοποιεί μια νέα παρουσία του`DocumentType` τάξη. |
...
| [InternalSubset](../../aspose.html.dom/documenttype/internalsubset/) { get; } | Το εσωτερικό υποσύνολο ως συμβολοσειρά ή μηδενικό αν δεν υπάρχει. |
...
| [Name](../../aspose.html.dom/documenttype/name/) { get; } | Το όνομα του DTD. δηλαδή το όνομα αμέσως μετά τη λέξη-κλειδί DOCTYPE. |
...
| override [NodeName](../../aspose.html.dom/documenttype/nodename/) { get; } | Το όνομα αυτού του κόμβου, ανάλογα με τον τύπο του. |
| override [NodeType](../../aspose.html.dom/documenttype/nodetype/) { get; } | Ένας κωδικός που αντιπροσωπεύει τον τύπο του υποκείμενου αντικειμένου. |
...
| [PublicId](../../aspose.html.dom/documenttype/publicid/) { get; } | Το δημόσιο αναγνωριστικό του εξωτερικού υποσυνόλου. |
| [SystemId](../../aspose.html.dom/documenttype/systemid/) { get; } | Το αναγνωριστικό συστήματος του εξωτερικού υποσυνόλου. Αυτό μπορεί να είναι απόλυτο URI ή όχι. |
...
| override [ToString](../../aspose.html.dom/documenttype/tostring/)() | Επιστρέφει αString που αντιπροσωπεύει αυτήν την περίπτωση. |
