...
description: Aspose.Html.Dom.ProcessingInstruction τάξη. Το ProcessingInstruction αντιπροσωπεύει μια εντολή επεξεργασίας που χρησιμοποιείται σε XML ως ένας τρόπος για να διατηρούνται πληροφορίες για τον επεξεργαστή στο κείμενο του εγγράφου.
type: docs
weight: 1020
url: /el/net/aspose.html.dom/processinginstruction/
---
## ProcessingInstruction class

Το ProcessingInstruction αντιπροσωπεύει μια "εντολή επεξεργασίας", που χρησιμοποιείται σε XML ως ένας τρόπος για να διατηρούνται πληροφορίες για τον επεξεργαστή στο κείμενο του εγγράφου.
...
| override [NodeName](../../aspose.html.dom/processinginstruction/nodename/) { get; } | Το όνομα αυτού του κόμβου, ανάλογα με τον τύπο του. |
| override [NodeType](../../aspose.html.dom/processinginstruction/nodetype/) { get; } | Ένας κωδικός που αντιπροσωπεύει τον τύπο του υποκείμενου αντικειμένου. |
| override [NodeValue](../../aspose.html.dom/processinginstruction/nodevalue/) { get; set; } | Η τιμή αυτού του κόμβου, ανάλογα με τον τύπο του. |
