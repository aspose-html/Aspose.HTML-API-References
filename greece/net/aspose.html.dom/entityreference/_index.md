...
description: Aspose.Html.Dom.EntityReference τάξη. Οι κόμβοι EntityReference μπορούν να χρησιμοποιηθούν για την αναπαράσταση μιας αναφοράς οντότητας στο δέντρο.
type: docs
weight: 710
url: /el/net/aspose.html.dom/entityreference/
---
...
| override [NodeName](../../aspose.html.dom/entityreference/nodename/) { get; } | Το όνομα αυτού του κόμβου, ανάλογα με τον τύπο του. |
| override [NodeType](../../aspose.html.dom/entityreference/nodetype/) { get; } | Ένας κωδικός που αντιπροσωπεύει τον τύπο του υποκείμενου αντικειμένου. |
