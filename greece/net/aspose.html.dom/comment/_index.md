...
description: Aspose.Html.Dom.Comment τάξη. Κληρονομεί από το CharacterData και αντιπροσωπεύει το περιεχόμενο ενός σχολίου δηλαδή όλους τους χαρακτήρες μεταξύ του αρχικού  .
type: docs
weight: 310
url: /el/net/aspose.html.dom/comment/
---
## Comment class

Κληρονομεί από το CharacterData και αντιπροσωπεύει το περιεχόμενο ενός σχολίου, δηλαδή όλους τους χαρακτήρες μεταξύ του αρχικού ' .
...
| override [NodeName](../../aspose.html.dom/comment/nodename/) { get; } | Το όνομα αυτού του κόμβου, ανάλογα με τον τύπο του. |
| override [NodeType](../../aspose.html.dom/comment/nodetype/) { get; } | Ένας κωδικός που αντιπροσωπεύει τον τύπο του υποκείμενου αντικειμένου. |
| override [NodeValue](../../aspose.html.dom/comment/nodevalue/) { get; set; } | Η τιμή αυτού του κόμβου, ανάλογα με τον τύπο του. |
