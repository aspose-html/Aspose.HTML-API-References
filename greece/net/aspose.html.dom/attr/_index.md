...
description: Aspose.Html.Dom.Attr τάξη. Η διεπαφή Attr αντιπροσωπεύει ένα χαρακτηριστικό σε ένα αντικείμενο Element. Συνήθως οι επιτρεπόμενες τιμές για το χαρακτηριστικό ορίζονται σε ένα σχήμα που σχετίζεται με το έγγραφο.
type: docs
weight: 110
url: /el/net/aspose.html.dom/attr/
---
## Attr class
...
| [IsId](../../aspose.html.dom/attr/isid/) { get; } | Επιστρέφει εάν αυτό το χαρακτηριστικό είναι γνωστό ότι είναι τύπου ID (δηλαδή ότι περιέχει ένα αναγνωριστικό για το στοιχείο κατόχου του) ή όχι. |
...
| override [LocalName](../../aspose.html.dom/attr/localname/) { get; } | Επιστρέφει το τοπικό τμήμα του αναγνωρισμένου ονόματος αυτού του κόμβου. Για κόμβους οποιουδήποτε τύπου εκτός από ELEMENT_NODE και ATTRIBUTE_NODE και κόμβους που έχουν δημιουργηθεί με μια μέθοδο DOM Level 1, όπως Document.createElement(), αυτό είναι πάντα null. |
| [Name](../../aspose.html.dom/attr/name/) { get; } | Επιστρέφει το όνομα αυτού του χαρακτηριστικού. |
| override [NamespaceURI](../../aspose.html.dom/attr/namespaceuri/) { get; } | Το URI χώρου ονομάτων αυτού του κόμβου ή μηδενικό εάν δεν έχει καθοριστεί. |
...
| override [NodeName](../../aspose.html.dom/attr/nodename/) { get; } | Το όνομα αυτού του κόμβου, ανάλογα με τον τύπο του. |
| override [NodeType](../../aspose.html.dom/attr/nodetype/) { get; } | Ένας κωδικός που αντιπροσωπεύει τον τύπο του υποκείμενου αντικειμένου. |
| override [NodeValue](../../aspose.html.dom/attr/nodevalue/) { get; set; } | Η τιμή αυτού του κόμβου, ανάλογα με τον τύπο του. |
...
| [OwnerElement](../../aspose.html.dom/attr/ownerelement/) { get; } | Ο κόμβος στοιχείου αυτού του χαρακτηριστικού είναι συνδεδεμένος ή μηδενικός εάν αυτό το χαρακτηριστικό δεν χρησιμοποιείται. |
...
| override [Prefix](../../aspose.html.dom/attr/prefix/) { get; } | Το πρόθεμα χώρου ονομάτων αυτού του κόμβου ή μηδενικό εάν δεν έχει καθοριστεί. Όταν ορίζεται ότι είναι null, η ρύθμιση του δεν έχει effect |
...
| [SchemaTypeInfo](../../aspose.html.dom/attr/schematypeinfo/) { get; } | Οι πληροφορίες τύπου που σχετίζονται με αυτό το χαρακτηριστικό. |
| [Specified](../../aspose.html.dom/attr/specified/) { get; } | Σωστό εάν αυτό το χαρακτηριστικό είχε ρητά δοθεί μια τιμή στο έγγραφο της παρουσίας, ψευδής διαφορετικά. |
| override [TextContent](../../aspose.html.dom/attr/textcontent/) { get; set; } | Αυτό το χαρακτηριστικό επιστρέφει το περιεχόμενο κειμένου αυτού του κόμβου και των απογόνων του. Όταν ορίζεται ότι είναι μηδενικό, η ρύθμιση του δεν έχει αποτέλεσμα. Κατά τη ρύθμιση, τυχόν παιδιά που μπορεί να έχει αυτός ο κόμβος αφαιρούνται και, εάν η νέα συμβολοσειρά δεν είναι κενή ή μηδενική, αντικαθίστανται από έναν μόνο κόμβο κειμένου που περιέχει τη συμβολοσειρά στην οποία έχει οριστεί αυτό το χαρακτηριστικό. |
| [Value](../../aspose.html.dom/attr/value/) { get; set; } | Κατά την ανάκτηση, η τιμή του χαρακτηριστικού επιστρέφεται ως συμβολοσειρά. |
