...
description: Aspose.Html.Dom.Node τάξη. Η διεπαφή Node είναι ο κύριος τύπος δεδομένων για ολόκληρο το Μοντέλο αντικειμένου εγγράφου. Αντιπροσωπεύει έναν μόνο κόμβο στο δέντρο εγγράφων.
type: docs
weight: 1000
url: /el/net/aspose.html.dom/node/
---
## Node class
...
| abstract [NodeName](../../aspose.html.dom/node/nodename/) { get; } | Το όνομα αυτού του κόμβου, ανάλογα με τον τύπο του. |
| abstract [NodeType](../../aspose.html.dom/node/nodetype/) { get; } | Ένας κωδικός που αντιπροσωπεύει τον τύπο του υποκείμενου αντικειμένου. |
...
| [CloneNode](../../aspose.html.dom/node/clonenode/#clonenode)() | Επιστρέφει ένα αντίγραφο αυτού του κόμβου, δηλαδή, χρησιμεύει ως γενικός κατασκευαστής αντιγράφων για κόμβους. Ο διπλότυπος κόμβος δεν έχει γονικό (parentNode είναι null) και δεν έχει δεδομένα χρήστη. |
| [CloneNode](../../aspose.html.dom/node/clonenode/#clonenode_1)(bool) | Επιστρέφει ένα αντίγραφο αυτού του κόμβου, δηλαδή, χρησιμεύει ως γενικός κατασκευαστής αντιγράφων για κόμβους. Ο διπλότυπος κόμβος δεν έχει γονικό (parentNode είναι null) και δεν έχει δεδομένα χρήστη. |
...
| Ονομα | Περιγραφή |
| --- | --- |
| const [ATTRIBUTE_NODE](../../aspose.html.dom/node/attribute_node/) | Ένας κόμβος χαρακτηριστικών |
| const [CDATA_SECTION_NODE](../../aspose.html.dom/node/cdata_section_node/) | Ένας κόμβος ενότητας cdata |
| const [COMMENT_NODE](../../aspose.html.dom/node/comment_node/) | Ένας κόμβος σχολίου |
| const [DOCUMENT_FRAGMENT_NODE](../../aspose.html.dom/node/document_fragment_node/) | Ένα κομμάτι εγγράφου node |
| const [DOCUMENT_NODE](../../aspose.html.dom/node/document_node/) | Ένας κόμβος εγγράφου |
| const [DOCUMENT_TYPE_NODE](../../aspose.html.dom/node/document_type_node/) | Ένας τύπος εγγράφου node |
| const [ELEMENT_NODE](../../aspose.html.dom/node/element_node/) | Ένας κόμβος στοιχείου |
| const [ENTITY_NODE](../../aspose.html.dom/node/entity_node/) | Ένας κόμβος οντότητας |
| const [ENTITY_REFERENCE_NODE](../../aspose.html.dom/node/entity_reference_node/) | Ένας κόμβος αναφοράς οντότητας |
| const [NOTATION_NODE](../../aspose.html.dom/node/notation_node/) | Ένας κόμβος σημειογραφίας |
| const [PROCESSING_INSTRUCTION_NODE](../../aspose.html.dom/node/processing_instruction_node/) | Ένας κόμβος εντολών επεξεργασίας |
| const [TEXT_NODE](../../aspose.html.dom/node/text_node/) | Ένας κόμβος κειμένου |
