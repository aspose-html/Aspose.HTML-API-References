...
| Διεπαφή | Περιγραφή |
| --- | --- |
| [IBrowsingContext](./ibrowsingcontext/) | Ένα περιβάλλον περιήγησης είναι ένα περιβάλλον στο οποίο[`Document`](../aspose.html.dom/document/) τα αντικείμενα παρουσιάζονται στον χρήστη. |
| [IChildNode](./ichildnode/) | Ορίζει[`IChildNode`](../aspose.html.dom/ichildnode/) διεπαφή που θα πρέπει να υλοποιηθεί από[`Node`](../aspose.html.dom/node/) που μπορεί να έχει γονέα. |
| [IDocumentInit](./idocumentinit/) | Αυτή η διεπαφή παρέχει[`Document`](../aspose.html.dom/document/) πληροφορίες προετοιμασίας. |
...
| [IElementInit](./ielementinit/) | Αυτή η διεπαφή παρέχει[`Element`](../aspose.html.dom/element/) πληροφορίες προετοιμασίας. |
...
| [INonDocumentTypeChildNode](./inondocumenttypechildnode/) | Ορίζει[`IChildNode`](../aspose.html.dom/ichildnode/) που δεν είναι[`DOCUMENT_TYPE_NODE`](../aspose.html.dom/node/document_type_node/) . |
| [INonElementParentNode](./inonelementparentnode/) | Ορίζει[`IParentNode`](../aspose.html.dom/iparentnode/) που δεν είναι τύπος στοιχείου. |
| [IParentNode](./iparentnode/) | Ορίζει το[`IParentNode`](../aspose.html.dom/iparentnode/) διεπαφή που υλοποιείται από οποιουσδήποτε πιθανούς γονείς. |
## Απαρίθμηση
