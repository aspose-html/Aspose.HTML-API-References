...
description: Aspose.Html.Dom.CDATASection τάξη. Οι ενότητες CDATA χρησιμοποιούνται για τη διαφυγή μπλοκ κειμένου που περιέχει χαρακτήρες που διαφορετικά θα θεωρούνταν ως σήμανση.
type: docs
weight: 200
url: /el/net/aspose.html.dom/cdatasection/
---
## CDATASection class

Οι ενότητες CDATA χρησιμοποιούνται για τη διαφυγή μπλοκ κειμένου που περιέχει χαρακτήρες που διαφορετικά θα θεωρούνταν ως σήμανση.
...
| virtual [Data](../../aspose.html.dom/characterdata/data/) { get; set; } | Τα δεδομένα χαρακτήρων του κόμβου που υλοποιεί αυτήν τη διεπαφή. |
...
| [IsElementContentWhitespace](../../aspose.html.dom/text/iselementcontentwhitespace/) { get; } | Επιστρέφει εάν αυτός ο κόμβος κειμένου περιέχει κενό διάστημα περιεχομένου στοιχείου, που συχνά αποκαλείται καταχρηστικά "άγνομο κενό διάστημα". |
...
| [Length](../../aspose.html.dom/characterdata/length/) { get; } | Ο αριθμός των μονάδων 16-bit που είναι διαθέσιμες μέσω δεδομένων και της μεθόδου substringData παρακάτω. Αυτό μπορεί να έχει την τιμή μηδέν, δηλαδή, οι κόμβοι CharacterData μπορεί να είναι κενοί. |
...
| override [NodeName](../../aspose.html.dom/cdatasection/nodename/) { get; } | Το όνομα αυτού του κόμβου, ανάλογα με τον τύπο του. |
| override [NodeType](../../aspose.html.dom/cdatasection/nodetype/) { get; } | Ένας κωδικός που αντιπροσωπεύει τον τύπο του υποκείμενου αντικειμένου. |
| override [NodeValue](../../aspose.html.dom/text/nodevalue/) { get; set; } | Η τιμή αυτού του κόμβου, ανάλογα με τον τύπο του. |
...
| [WholeText](../../aspose.html.dom/text/wholetext/) { get; } | Επιστρέφει όλο το κείμενο των κόμβων κειμένου σε λογικά παρακείμενους κόμβους κειμένου σε αυτόν τον κόμβο, συνενωμένα με σειρά εγγράφων. |
...
| virtual [AppendData](../../aspose.html.dom/characterdata/appenddata/)(string) | Προσθέστε τη συμβολοσειρά στο τέλος των δεδομένων χαρακτήρων του κόμβου. |
...
| virtual [DeleteData](../../aspose.html.dom/characterdata/deletedata/)(int, int) | Καταργήστε ένα εύρος μονάδων 16-bit από τον κόμβο. |
...
| virtual [InsertData](../../aspose.html.dom/characterdata/insertdata/)(int, string) | Εισαγάγετε μια συμβολοσειρά στην καθορισμένη μετατόπιση μονάδας 16-bit. |
...
| virtual [ReplaceData](../../aspose.html.dom/characterdata/replacedata/)(int, int, string) | Αντικαταστήστε τους χαρακτήρες που ξεκινούν από την καθορισμένη μετατόπιση μονάδας 16 bit με την καθορισμένη συμβολοσειρά. |
...
| [SplitText](../../aspose.html.dom/text/splittext/)(int) | Διασπά αυτόν τον κόμβο σε δύο κόμβους στην καθορισμένη μετατόπιση, διατηρώντας και τους δύο στο δέντρο ως αδέρφια. |
| virtual [SubstringData](../../aspose.html.dom/characterdata/substringdata/)(int, int) | Εξάγει μια σειρά δεδομένων από τον κόμβο. |
| override [ToString](../../aspose.html.dom/characterdata/tostring/)() | Επιστρέφει αString που αντιπροσωπεύει αυτήν την περίπτωση. |
