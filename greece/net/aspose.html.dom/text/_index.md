...
description: Aspose.Html.Dom.Text τάξη. Η διεπαφή κειμένου κληρονομεί από το CharacterData και αντιπροσωπεύει το περιεχόμενο κειμένου ονομάζονται δεδομένα χαρακτήρων σε XML ενός Στοιχείου ή Attr.
type: docs
weight: 2450
url: /el/net/aspose.html.dom/text/
---
## Text class
...
| override [NodeName](../../aspose.html.dom/text/nodename/) { get; } | Το όνομα αυτού του κόμβου, ανάλογα με τον τύπο του. |
| override [NodeType](../../aspose.html.dom/text/nodetype/) { get; } | Ένας κωδικός που αντιπροσωπεύει τον τύπο του υποκείμενου αντικειμένου. |
