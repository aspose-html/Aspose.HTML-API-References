...
description: Aspose.Html.Rendering.Xps.XpsDeviceXpsGraphicContext τάξη. Διατηρεί τις τρέχουσες παραμέτρους ελέγχου γραφικών για το XpsDevice. Αυτές οι παράμετροι ορίζουν το παγκόσμιο πλαίσιο εντός του οποίου εκτελούν οι τελεστές γραφικών.
type: docs
weight: 4540
url: /el/net/aspose.html.rendering.xps/xpsdevice.xpsgraphiccontext/
---
...
| Ονομα | Περιγραφή |
| --- | --- |
| override [Clone](../../aspose.html.rendering.xps/xpsgraphiccontext/clone/)() | Δημιουργεί μια νέα παρουσία μιας κλάσης XpsGraphicContext με τις ίδιες τιμές ιδιοτήτων με μια υπάρχουσα παρουσία. |
