...
description: "Κατασκευαστής Page. Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης Page"
type: docs

url: /el/java/com.aspose.html.drawing/page/page/
---
## Page(Size, Margin) {#constructor_3}

Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [`Page`](../).
