...
description: "Το πακέτο com.aspose.html.net παρουσιάζεται από κλάσεις και διεπαφές που είναι υπεύθυνες για τη διευκόλυνση της εύκολης επεξεργασίας δικτύου."
type: docs

url: /el/java/com.aspose.html.net/
---
Το πακέτο **com.aspose.html.net** παρουσιάζεται από κλάσεις και διεπαφές που είναι υπεύθυνες για τη διευκόλυνση της εύκολης επεξεργασίας δικτύου.
...
| [FormUrlEncodedContent](./formurlencodedcontent/) | Ένα δοχείο για ζεύγη ονομα/τιμή κωδικοποιημένα με τον τύπο MIME application/x-www-form-urlencoded. |
| [HttpMethod](./httpmethod/) | Αναπαριστά βοηθητική κλάση για την ανάκτηση και σύγκριση των τυπικών μεθόδων HTTP. |
| [MessageFilter](./messagefilter/) | Αντιπροσωπεύει την αφηρημένη βασική κλάση για διαφορετικές κλάσεις φίλτρων που χρησιμοποιούνται για την ανάκτηση μηνυμάτων |
| [MessageHandler](./messagehandler/) | Αντιπροσωπεύει έναν βασικό τύπο για διαχειριστές μηνυμάτων. |
| [MessageHandlerCollection](./messagehandlercollection/) | Αντιπροσωπεύει τη συλλογή του [`MessageHandler`](../com.aspose.html.net/messagehandler/). |
...
| [UrlResolver](./urlresolver/) | Αντιπροσωπεύει κλάση βοηθητικού προγράμματος για την επίλυση απόλυτης διεύθυνσης URL μέσω ενός Uniform Resource Identifier (URI). |
## Διεπαφές

| Διεπαφή | Περιγραφή |
| --- | --- |
| [INetwork](./inetwork/) | Παρέχει μια διεπαφή για υπηρεσίες δικτύου. |
| [INetworkOperationContext](./inetworkoperationcontext/) | Παρέχει πληροφορίες περιβάλλοντος για τις υπηρεσίες δικτύου. |
