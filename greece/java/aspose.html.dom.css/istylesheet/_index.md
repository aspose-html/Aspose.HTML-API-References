...
| [getParentStyleSheet](../../com.aspose.html.dom.css/istylesheet/parentstylesheet/) Για γλώσσες φύλλων στυλ που υποστηρίζουν την έννοια της ένταξης φύλλου στυλ, αυτό το χαρακτηριστικό αντιπροσωπεύει το φύλλο στυλ που περιλαμβάνει, εάν υπάρχει. Εάν το φύλλο στυλ είναι κορυφαίο ή η γλώσσα φύλλου στυλ δεν υποστηρίζει ένταξη, η τιμή του χαρακτηριστικού είναι null. |
