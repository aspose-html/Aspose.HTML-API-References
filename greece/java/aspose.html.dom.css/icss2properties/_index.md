---
title: "Διεπαφή ICSS2Properties"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.dom.css.ICSS2Properties interface. Η διεπαφή CSS2Properties αντιπροσωπεύει έναν βολικό μηχανισμό για την ανάκτηση και ορισμό ιδιοτήτων μέσα σε ένα CSSStyleDeclaration. Τα χαρακτηριστικά αυτής της διεπαφής αντιστοιχούν σε όλες τις ιδιότητες που καθορίζονται στο CSS2. Η λήψη ενός χαρακτηριστικού αυτής της διεπαφής είναι ισοδύναμη με την κλήση της μεθόδου getPropertyValue της διεπαφής CSSStyleDeclaration. Η ρύθμιση ενός χαρακτηριστικού αυτής της διεπαφής είναι ισοδύναμη με την κλήση της μεθόδου setProperty της διεπαφής CSSStyleDeclaration."
type: docs

url: /el/java/com.aspose.html.dom.css/icss2properties/
---
## ICSS2Properties interface

Η διεπαφή CSS2Properties αντιπροσωπεύει έναν βολικό μηχανισμό για την ανάκτηση και ορισμό ιδιοτήτων μέσα σε ένα [`CSSStyleDeclaration`](../icssstyledeclaration/). Τα χαρακτηριστικά αυτής της διεπαφής αντιστοιχούν σε όλες τις ιδιότητες που καθορίζονται στο CSS2. Η λήψη ενός χαρακτηριστικού αυτής της διεπαφής είναι ισοδύναμη με την κλήση της μεθόδου getPropertyValue της διεπαφής [`CSSStyleDeclaration`](../icssstyledeclaration/). Η ρύθμιση ενός χαρακτηριστικού αυτής της διεπαφής είναι ισοδύναμη με την κλήση της μεθόδου setProperty της διεπαφής [`CSSStyleDeclaration`](../icssstyledeclaration/).
