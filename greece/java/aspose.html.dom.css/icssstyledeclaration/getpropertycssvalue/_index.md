...
description: "Μέθοδος ICSSStyleDeclaration. Χρησιμοποιείται για την ανάκτηση της αντικειμενικής αναπαράστασης της τιμής μιας ιδιότητας CSS εάν έχει οριστεί ρητά μέσα σε αυτό το μπλοκ δήλωσης. Αυτή η μέθοδος επιστρέφει null εάν η ιδιότητα είναι ιδιότητα συντόμευσης. Οι τιμές ιδιοτήτων συντόμευσης μπορούν να προσπελαστούν και να τροποποιηθούν μόνο ως Strings χρησιμοποιώντας τις μεθόδους getPropertyValue και setProperty."
type: docs
