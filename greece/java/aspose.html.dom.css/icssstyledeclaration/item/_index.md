...
url: /el/java/com.aspose.html.dom.css/icssstyledeclaration/item/
---
...
Το propertyName είναι μια String που είναι το όνομα της ιδιότητας CSS στον καθορισμένο δείκτη.

### Property Value

Το index είναι ο δείκτης του κόμβου που θα ανακτηθεί. Ο δείκτης είναι μηδενικής βάσης.
