---
title: "ICSSStyleDeclaration Διεπαφή"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "Διεπαφή com.aspose.html.dom.css.ICSSStyleDeclaration. Η διεπαφή CSSStyleDeclaration αντιπροσωπεύει ένα αντικείμενο που είναι μπλοκ δήλωσης CSS και εκθέτει πληροφορίες στυλ και διάφορες μεθόδους και ιδιότητες σχετικές με το στυλ."
type: docs
...
Η διεπαφή CSSStyleDeclaration αντιπροσωπεύει ένα αντικείμενο που είναι ένα μπλοκ δήλωσης CSS και εκθέτει πληροφορίες στυλ καθώς και διάφορες μεθόδους και ιδιότητες σχετικές με το στυλ.

Ένα αντικείμενο CSSStyleDeclaration μπορεί να εκτεθεί χρησιμοποιώντας τρία διαφορετικά API:

Μέσω του HTMLElement.style, το οποίο διαχειρίζεται τα ενσωματωμένα στυλ ενός μόνο στοιχείου. Μέσω του API [`CSSStyleSheet`](../icssstylesheet/). Για παράδειγμα, το document.styleSheets[0].cssRules[0].style επιστρέφει ένα αντικείμενο `CSSStyleDeclaration` στον πρώτο κανόνα CSS του πρώτου φύλλου στυλ του εγγράφου. Μέσω του Window.getComputedStyle(), το οποίο εκθέτει το αντικείμενο `CSSStyleDeclaration` ως διεπαφή μόνο για ανάγνωση.
...
| [getLength](../../com.aspose.html.dom.css/icssstyledeclaration/length/) Η ιδιότητα μόνο για ανάγνωση επιστρέφει έναν ακέραιο αριθμό ιδιοτήτων που έχουν οριστεί ρητά σε αυτό το μπλοκ δήλωσης CSS. Η σειρά των έγκυρων δεικτών είναι από 0 έως length-1 συμπεριλαμβανομένου. |
...
| [getPropertyPriority](../../com.aspose.html.dom.css/icssstyledeclaration/getpropertypriority/)(String) | Χρησιμοποιείται για την ανάκτηση της προτεραιότητας μιας ιδιότητας CSS (π.χ. ο χαρακτηρισμός "important") εάν η ιδιότητα έχει οριστεί ρητά σε αυτό το μπλοκ δήλωσης. |
...
| [setProperty](../../com.aspose.html.dom.css/icssstyledeclaration/setproperty/#setproperty)(String, String) | Η διεπαφή μεθόδου CSSStyleDeclaration.setProperty() χρησιμοποιείται για να ορίσει μια τιμή ιδιότητας με προεπιλεγμένη προτεραιότητα μέσα σε αυτό το μπλοκ δήλωσης. Η προεπιλεγμένη προτεραιότητα δεν είναι "important", δηλαδή String.Empty. |
