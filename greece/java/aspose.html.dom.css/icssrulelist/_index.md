...
description: "com.aspose.html.dom.css.ICSSRuleList interface. Η CSSRuleList αντιπροσωπεύει μια διατεταγμένη συλλογή αντικειμένων CSSRule μόνο για ανάγνωση."
type: docs
...
Μια CSSRuleList αντιπροσωπεύει μια διατεταγμένη συλλογή αντικειμένων μόνο για ανάγνωση [`CSSRule`](../icssrule/).
