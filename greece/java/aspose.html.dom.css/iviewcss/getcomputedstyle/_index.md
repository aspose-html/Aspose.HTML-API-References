...
Οι μεμονωμένες τιμές ιδιοτήτων CSS προσπελάζονται μέσω των API που παρέχονται από το αντικείμενο, ή μέσω ευρετηρίασης με τα ονόματα ιδιοτήτων CSS.
...
| --- | --- | --- |
| element | Element | Το [`Element`](../../../com.aspose.html.dom/element/) για το οποίο θα ληφθεί το υπολογισμένο στυλ. Αυτό το όρισμα δεν μπορεί να είναι null. |

### Τιμή Επιστροφής

Το επιστρεφόμενο στυλ είναι ένα ζωντανό αντικείμενο [`CSSStyleDeclaration`](../../icssstyledeclaration/), το οποίο ενημερώνεται αυτόματα όταν αλλάζουν τα στυλ του στοιχείου.

### Εξαιρέσεις

| εξαίρεση | συνθήκη |
| --- | --- |
| TypeError | Εάν το περασμένο αντικείμενο δεν είναι ένα Element ή το pseudoElt δεν είναι έγκυρος επιλογέας ψευδο-στοιχείου. |
...
| --- | --- | --- |
| element | Element | Το [`Element`](../../../com.aspose.html.dom/element/) για το οποίο θα ληφθεί το υπολογισμένο στυλ. Αυτό το όρισμα δεν μπορεί να είναι null. |
| pseudoElement | String | Μια συμβολοσειρά που καθορίζει το ψευδο-στοιχείο για αντιστοίχιση. Παραλείπεται (ή null) για πραγματικά στοιχεία. |
