...
description: "Διεπαφή com.aspose.html.dom.css.ICSSStyleSheet. Η διεπαφή CSSStyleSheet αντιπροσωπεύει ένα μοναδικό φύλλο στυλ CSS και σας επιτρέπει να επιθεωρήσετε και να τροποποιήσετε τη λίστα των κανόνων που περιέχονται στο φύλλο στυλ. Κληρονομεί ιδιότητες και μεθόδους από τον γονέα της IStyleSheet."
type: docs
...
Η διεπαφή CSSStyleSheet αντιπροσωπεύει ένα μοναδικό φύλλο στυλ CSS και σας επιτρέπει να επιθεωρήσετε και να τροποποιήσετε τη λίστα των κανόνων που περιέχονται στο φύλλο στυλ. Κληρονομεί ιδιότητες και μεθόδους από τον γονέα της, [`IStyleSheet`](../istylesheet/).
