...
description: "com.aspose.html.HTMLSelectElement class. Το στοιχείο select επιτρέπει την επιλογή μιας επιλογής. Οι περιεχόμενες επιλογές μπορούν να προσπελαστούν άμεσα μέσω του στοιχείου select ως συλλογή. Δείτε τον ορισμό του στοιχείου SELECT στο HTML 4.01"
type: docs
