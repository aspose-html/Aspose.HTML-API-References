---
title: "HTMLStyleElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLStyleElement κλάση. Πληροφορίες στυλ. Δείτε τον ορισμό του στοιχείου STYLE στο HTML 4.01, το μοντέλο CSS DOM Level 2 Style Sheets και CSS και τη διεπαφή LinkStyle στο μοντέλο StyleSheets DOM Level 2 Style Sheets και CSS."
type: docs

url: /el/java/com.aspose.html/htmlstyleelement/
---
## HTMLStyleElement class

Πληροφορίες στυλ. Δείτε τον ορισμό του στοιχείου STYLE στο HTML 4.01, το μοντέλο CSS [[DOM Level 2 Style Sheets and CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113)] και τη διεπαφή `LinkStyle` στο μοντέλο StyleSheets [[DOM Level 2 Style Sheets and CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113)].
...
| [getSheet](../../com.aspose.html/htmlstyleelement/sheet/) Αποκτά το συσχετισμένο φύλλο στυλ. |
