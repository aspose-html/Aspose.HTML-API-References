---
title: "Κλάση HTMLTableCaptionElement"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "Κλάση com.aspose.html.HTMLTableCaptionElement. Λεζάντα πίνακα. Δείτε τον ορισμό του στοιχείου CAPTION στο HTML 4.01"
type: docs

url: /el/java/com.aspose.html/htmltablecaptionelement/
---
## HTMLTableCaptionElement class

Λεζάντα πίνακα. Δείτε τον ορισμό του στοιχείου CAPTION στο HTML 4.01.
