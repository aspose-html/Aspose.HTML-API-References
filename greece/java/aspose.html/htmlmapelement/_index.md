---
title: "HTMLMapElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLMapElement κλάση. Χάρτης εικόνας στην πλευρά του πελάτη. Δείτε τον ορισμό του στοιχείου MAP στο HTML 4.01"
type: docs

url: /el/java/com.aspose.html/htmlmapelement/
---
## HTMLMapElement class

Χάρτης εικόνας στην πλευρά του πελάτη. Δείτε τον ορισμό του στοιχείου MAP στο HTML 4.01.
...
| Όνομα | Περιγραφή |
| --- | --- |
| [getAreas](../../com.aspose.html/htmlmapelement/areas/) Η λίστα των περιοχών που ορίζονται για τον χάρτη εικόνας. |
