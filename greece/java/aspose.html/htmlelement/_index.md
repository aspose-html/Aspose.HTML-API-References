...
description: "com.aspose.html.HTMLElement κλάση. Όλες οι διεπαφές στοιχείων HTML κληρονομούν από αυτήν την κλάση. Τα στοιχεία που εκθέτουν μόνο τα βασικά χαρακτηριστικά HTML αντιπροσωπεύονται από τη βασική διεπαφή HTMLElement. Τα στοιχεία αυτά είναι τα εξής ειδικά SUB SUP SPAN BDOfont TT I B U S STRIKE BIG SMALL phrase EM STRONG DFN CODE SAMP KBD VAR CITE ACRONYM ABBRlist DD DTNOFRAMES NOSCRIPTADDRESS CENTER. Το χαρακτηριστικό style ενός στοιχείου HTML είναι προσβάσιμο μέσω της διεπαφής ElementCSSInlineStyle που ορίζεται στο CSS module DOM Level 2 Style Sheets and CSS"
type: docs
