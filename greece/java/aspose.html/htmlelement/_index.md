---
title: "HTMLElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLElement κλάση. Όλες οι διεπαφές στοιχείων HTML κληρονομούν από αυτήν την κλάση. Στοιχεία που εκθέτουν μόνο τα βασικά χαρακτηριστικά HTML αντιπροσωπεύονται από τη βασική διεπαφή HTMLElement. Τα στοιχεία αυτά είναι τα εξής ειδικά SUB SUP SPAN BDOfont TT I B U S STRIKE BIG SMALL phrase EM STRONG DFN CODE SAMP KBD VAR CITE ACRONYM ABBRlist DD DTNOFRAMES NOSCRIPTADDRESS CENTER. Το χαρακτηριστικό style ενός στοιχείου HTML είναι προσβάσιμο μέσω της διεπαφής ElementCSSInlineStyle, η οποία ορίζεται στο μοντέλο CSS του DOM Level 2 Style Sheets και CSS"
type: docs

url: /el/java/com.aspose.html/htmlelement/
---
## HTMLElement class

Όλες οι διεπαφές στοιχείων HTML κληρονομούν από αυτήν την κλάση. Τα στοιχεία που εκθέτουν μόνο τα βασικά χαρακτηριστικά HTML αντιπροσωπεύονται από τη βασική διεπαφή `HTMLElement`. Αυτά τα στοιχεία είναι τα εξής: ειδικά: SUB, SUP, SPAN, BDOfont: TT, I, B, U, S, STRIKE, BIG, SMALL φράση: EM, STRONG, DFN, CODE, SAMP, KBD, VAR, CITE, ACRONYM, ABBR λίστα: DD, DT NOFRAMES, NOSCRIPT ADDRESS, CENTER. Το χαρακτηριστικό `style` ενός στοιχείου HTML είναι προσβάσιμο μέσω της διεπαφής `ElementCSSInlineStyle` που ορίζεται στο μοντέλο CSS [[DOM Level 2 Style Sheets and CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113)].
