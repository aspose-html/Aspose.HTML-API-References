---
title: "HTMLBaseFontElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLBaseFontElement class. Βασική γραμματοσειρά. Δείτε τον ορισμό του στοιχείου BASEFONT στο HTML 4.01. Αυτό το στοιχείο είναι παρωχημένο στο HTML 4.01"
type: docs

url: /el/java/com.aspose.html/htmlbasefontelement/
---
## HTMLBaseFontElement class

Βασική γραμματοσειρά. Δείτε τον ορισμό του στοιχείου BASEFONT στο HTML 4.01. Αυτό το στοιχείο είναι παρωχημένο στο HTML 4.01.
