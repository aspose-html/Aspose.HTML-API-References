---
title: "Κλάση HTMLScriptElement"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "Κλάση com.aspose.html.HTMLScriptElement. Δηλώσεις script. Δείτε τον ορισμό του στοιχείου SCRIPT στο HTML 4.01"
type: docs

url: /el/java/com.aspose.html/htmlscriptelement/
---
## HTMLScriptElement class

Δηλώσεις script. Δείτε τον ορισμό του στοιχείου SCRIPT στο HTML 4.01.
