---
title: "Κλάση HTMLIsIndexElement"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "Κλάση com.aspose.html.HTMLIsIndexElement. Αυτό το στοιχείο χρησιμοποιείται για εισαγωγή κειμένου μίας γραμμής. Δείτε τον ορισμό του στοιχείου ISINDEX στο HTML 4.01. Αυτό το στοιχείο είναι παρωχημένο στο HTML 4.01"
type: docs

url: /el/java/com.aspose.html/htmlisindexelement/
---
## HTMLIsIndexElement class

Αυτό το στοιχείο χρησιμοποιείται για εισαγωγή κειμένου μίας γραμμής. Δείτε τον ορισμό του στοιχείου ISINDEX στο HTML 4.01. Αυτό το στοιχείο είναι παρωχημένο στο HTML 4.01.
...
| [getForm](../../com.aspose.html/htmlisindexelement/form/) Επιστρέφει το |
[getId]
