---
title: "HTMLAreaElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLAreaElement κλάση. Ορισμός περιοχής χάρτη εικόνας στην πλευρά του πελάτη. Δείτε τον ορισμό του στοιχείου AREA στο HTML 4.01"
type: docs

url: /el/java/com.aspose.html/htmlareaelement/
---
## HTMLAreaElement class

Ορισμός περιοχής χάρτη εικόνας στην πλευρά του πελάτη. Δείτε τον ορισμό του στοιχείου AREA στο HTML 4.01.
...
| [getRelList](../../com.aspose.html/htmlareaelement/rellist/) Επιστρέφει μια ζωντανή DOMTokenList που περιέχει διακριτικά που λαμβάνονται από την ανάλυση της ιδιότητας \"rel\". |
