---
title: "Κλάση HTMLAreaElement"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "κλάση com.aspose.html.HTMLAreaElement. Ορισμός περιοχής χάρτη εικόνας στην πλευρά του πελάτη. Δείτε τον ορισμό του στοιχείου AREA στο HTML 4.01"
type: docs
...
| [getRelList](../../com.aspose.html/htmlareaelement/rellist/) Επιστρέφει μια ζωντανή DOMTokenList που περιέχει διακριτικά που λήφθηκαν από την ανάλυση της ιδιότητας "rel". |
