---
title: "HTMLHeadElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLHeadElement κλάση. Πληροφορίες κεφαλίδας εγγράφου. Δείτε τον ορισμό του στοιχείου HEAD στο HTML 4.01"
type: docs

url: /el/java/com.aspose.html/htmlheadelement/
---
## HTMLHeadElement class

Πληροφορίες κεφαλίδας εγγράφου. Δείτε τον ορισμό του στοιχείου HEAD στο HTML 4.01.
