---
title: "Κλάση HTMLHeadElement"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "κλάση com.aspose.html.HTMLHeadElement. Πληροφορίες κεφαλίδας εγγράφου. Δείτε τον ορισμό του στοιχείου HEAD στο HTML 4.01"
type: docs
