---
title: "Κλάση HTMLAnchorElement"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLAnchorElement κλάση. Το στοιχείο άγκυρας. Δείτε τον ορισμό του στοιχείου A στο HTML 4.01"
type: docs
...
| [getRelList](../../com.aspose.html/htmlanchorelement/rellist/) Επιστρέφει ένα ζωντανό DOMTokenList που περιέχει διακριτικά που προέκυψαν από την ανάλυση της ιδιότητας "rel". |
[getRev]
...
| [blur](../../com.aspose.html/htmlanchorelement/blur/)() | Αφαιρεί την εστίαση πληκτρολογίου από αυτό το στοιχείο. |
...
| [focus](../../com.aspose.html/htmlanchorelement/focus/)() | Δίνει εστίαση πληκτρολογίου σε αυτό το στοιχείο. |
