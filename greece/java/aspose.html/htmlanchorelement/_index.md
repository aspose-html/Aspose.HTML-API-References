---
title: "HTMLAnchorElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLAnchorElement class. Το στοιχείο άγκυρας. Δείτε τον ορισμό του στοιχείου A στο HTML 4.01"
type: docs

url: /el/java/com.aspose.html/htmlanchorelement/
---
## HTMLAnchorElement class

Το στοιχείο anchor. Δείτε τον ορισμό του στοιχείου A στο HTML 4.01.
...
| [getOrigin](../../com.aspose.html/htmlanchorelement/origin/) Λαμβάνει μια αναπαράσταση String του τμήματος προέλευσης του σχετικού URL. |
[getOuterHTML]
...
| [getRelList](../../com.aspose.html/htmlanchorelement/rellist/) Επιστρέφει ένα ζωντανό DOMTokenList που περιέχει διακριτικά που προέρχονται από την ανάλυση της ιδιότητας "rel". |
[getRev]
...
| [blur](../../com.aspose.html/htmlanchorelement/blur/)() | Αφαιρεί την εστίαση του πληκτρολογίου από αυτό το στοιχείο. |
...
| [focus](../../com.aspose.html/htmlanchorelement/focus/)() | Δίνει εστίαση του πληκτρολογίου σε αυτό το στοιχείο. |
