---
title: "HTMLFontElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLFontElement κλάση. Τοπική αλλαγή στη γραμματοσειρά. Δείτε τον ορισμό του στοιχείου FONT στο HTML 4.01. Αυτό το στοιχείο είναι παρωχημένο στο HTML 4.01"
type: docs

url: /el/java/com.aspose.html/htmlfontelement/
---
## HTMLFontElement class

Τοπική αλλαγή γραμματοσειράς. Δείτε τον ορισμό του στοιχείου FONT στο HTML 4.01. Αυτό το στοιχείο είναι παρωχημένο στο HTML 4.01.
