---
title: "HTMLTableSectionElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLTableSectionElement κλάση. Τα στοιχεία THEAD, TFOOT και TBODY"
type: docs

url: /el/java/com.aspose.html/htmltablesectionelement/
---
## HTMLTableSectionElement class

Τα στοιχεία `THEAD`, `TFOOT` και `TBODY`.
...
| [getRows](../../com.aspose.html/htmltablesectionelement/rows/) Η συλλογή των γραμμών σε αυτήν την ενότητα πίνακα. |
...
| [deleteRow](../../com.aspose.html/htmltablesectionelement/deleterow/)(int) | Διαγράψτε μια γραμμή από αυτήν την ενότητα. |
...
| [insertRow](../../com.aspose.html/htmltablesectionelement/insertrow/)(int) | Εισάγετε μια γραμμή σε αυτήν την ενότητα. Η νέα γραμμή εισάγεται αμέσως πριν από την τρέχουσα γραμμή `index` σε αυτήν την ενότητα. Εάν το `index` είναι -1 ή ίσο με τον αριθμό των γραμμών σε αυτήν την ενότητα, η νέα γραμμή προσαρτάται στο τέλος. |
