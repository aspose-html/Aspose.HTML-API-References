...
description: "com.aspose.html.HTMLLinkElement κλάση. Το στοιχείο LINK καθορίζει έναν σύνδεσμο προς έναν εξωτερικό πόρο και ορίζει τη σχέση αυτού του εγγράφου με εκείνον τον πόρο ή αντίστροφα. Δείτε τον ορισμό του στοιχείου LINK στο HTML 4.01, δείτε επίσης τη διεπαφή LinkStyle στο μοντέλο StyleSheet, DOM Level 2 Style Sheets και CSS."
type: docs
...
Το στοιχείο `LINK` καθορίζει έναν σύνδεσμο προς εξωτερικό πόρο και ορίζει τη σχέση αυτού του εγγράφου με εκείνο τον πόρο (ή αντίστροφα). Δείτε τον ορισμό του στοιχείου LINK στο HTML 4.01 (δείτε επίσης τη διεπαφή `LinkStyle` στο μοντέλο StyleSheet [[DOM Level 2 Style Sheets and CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113)]).
...
| [getRelList](../../com.aspose.html/htmllinkelement/rellist/) Επιστρέφει ένα ζωντανό DOMTokenList που περιέχει διακριτικά που προέκυψαν από την ανάλυση της ιδιότητας "rel". |
[getRev]
