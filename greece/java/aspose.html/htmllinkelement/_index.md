---
title: "HTMLLinkElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLLinkElement class. Το στοιχείο LINK καθορίζει έναν σύνδεσμο προς έναν εξωτερικό πόρο και ορίζει τη σχέση αυτού του εγγράφου με εκείνο τον πόρο ή αντίστροφα. Δείτε τον ορισμό του στοιχείου LINK στο HTML 4.01, δείτε επίσης τη διεπαφή LinkStyle στο μοντέλο StyleSheet, DOM Level 2 Style Sheets και CSS."
type: docs

url: /el/java/com.aspose.html/htmllinkelement/
---
## HTMLLinkElement class

Το στοιχείο `LINK` καθορίζει έναν σύνδεσμο προς εξωτερικό πόρο και ορίζει τη σχέση αυτού του εγγράφου με εκείνον τον πόρο (ή αντίστροφα). Δείτε τον ορισμό του στοιχείου LINK στο HTML 4.01 (δείτε επίσης τη διεπαφή `LinkStyle` στο module StyleSheet [[DOM Level 2 Style Sheets and CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113)]).
...
| [getRelList](../../com.aspose.html/htmllinkelement/rellist/) Επιστρέφει ένα ζωντανό DOMTokenList που περιέχει διακριτικά που προέρχονται από την ανάλυση της ιδιότητας "rel". |
[getRev]
...
| [getSheet](../../com.aspose.html/htmllinkelement/sheet/) Λαμβάνει το σχετικό φύλλο στυλ. |
