...
description: "com.aspose.html.HTMLMetaElement κλάση. Αυτό περιέχει γενικές μετα-πληροφορίες για το έγγραφο. Δείτε τον ορισμό του στοιχείου META στο HTML 4.01"
type: docs
...
Περιέχει γενικές μετα-πληροφορίες για το έγγραφο. Δείτε τον ορισμό του στοιχείου META στο HTML 4.01.
