---
title: "HTMLMetaElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLMetaElement κλάση. Περιέχει γενικές μετα-πληροφορίες για το έγγραφο. Δείτε τον ορισμό του στοιχείου META στο HTML 4.01"
type: docs

url: /el/java/com.aspose.html/htmlmetaelement/
---
## HTMLMetaElement class

Αυτό περιέχει γενικές μεταπληροφορίες σχετικά με το έγγραφο. Δείτε τον ορισμό του στοιχείου META στο HTML 4.01.
