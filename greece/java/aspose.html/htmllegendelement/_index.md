---
title: "HTMLLegendElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLLegendElement κλάση. Παρέχει μια λεζάντα για μια ομάδα FIELDSET. Δείτε τον ορισμό του στοιχείου LEGEND στο HTML 4.01"
type: docs

url: /el/java/com.aspose.html/htmllegendelement/
---
## HTMLLegendElement class

Παρέχει λεζάντα για μια ομάδα `FIELDSET`. Δείτε τον ορισμό του στοιχείου LEGEND στο HTML 4.01.
...
| [getForm](../../com.aspose.html/htmllegendelement/form/) Επιστρέφει το στοιχείο `FORM` που περιέχει αυτόν τον έλεγχο. Επιστρέφει `null` εάν αυτός ο έλεγχος δεν βρίσκεται στο πλαίσιο μιας φόρμας. |
[getId]
