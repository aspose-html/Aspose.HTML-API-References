---
title: "HTMLBaseElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLBaseElement κλάση. Βασικό URI εγγράφου IETF RFC 2396. Δείτε τον ορισμό του στοιχείου BASE στο HTML 4.01"
type: docs

url: /el/java/com.aspose.html/htmlbaseelement/
---
## HTMLBaseElement class

Βασικό URI εγγράφου [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt)]. Δείτε τον ορισμό του στοιχείου BASE στο HTML 4.01.
