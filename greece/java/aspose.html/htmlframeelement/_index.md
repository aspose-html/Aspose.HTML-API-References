---
title: "HTMLFrameElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLFrameElement κλάση. Δημιουργήστε ένα πλαίσιο. Δείτε τον ορισμό του στοιχείου FRAME στο HTML 4.01"
type: docs

url: /el/java/com.aspose.html/htmlframeelement/
---
## HTMLFrameElement class

Δημιουργία πλαισίου. Δείτε τον ορισμό του στοιχείου FRAME στο HTML 4.01.
...
| [getContentDocument](../../com.aspose.html/htmlframeelement/contentdocument/) Το έγγραφο που περιέχει αυτό το πλαίσιο, εάν υπάρχει και είναι διαθέσιμο, ή `null` διαφορετικά. @since DOM Level 2 |
[getDir]
