...
description: "com.aspose.html.HTMLFrameElement class. Δημιουργήστε ένα πλαίσιο. Δείτε τον ορισμό του στοιχείου FRAME στο HTML 4.01"
type: docs
...
Δημιουργήστε ένα πλαίσιο. Δείτε τον ορισμό του στοιχείου FRAME στο HTML 4.01.
...
| [getContentDocument](../../com.aspose.html/htmlframeelement/contentdocument/) Το έγγραφο που περιέχει αυτό το πλαίσιο, εάν υπάρχει και είναι διαθέσιμο, ή `null` αλλιώς. @since DOM Level 2 |
[getDir]
