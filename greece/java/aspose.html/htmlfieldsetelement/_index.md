---
title: "HTMLFieldSetElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLFieldSetElement κλάση. Οργανώνει τα στοιχεία ελέγχου φόρμας σε λογικές ομάδες. Δείτε τον ορισμό του στοιχείου FIELDSET στο HTML 4.01"
type: docs

url: /el/java/com.aspose.html/htmlfieldsetelement/
---
## HTMLFieldSetElement class

Οργανώνει τα στοιχεία ελέγχου φόρμας σε λογικές ομάδες. Δείτε τον ορισμό του στοιχείου FIELDSET στο HTML 4.01.
...
| [getForm](../../com.aspose.html/htmlfieldsetelement/form/) Επιστρέφει το στοιχείο `FORM` που περιέχει αυτόν τον έλεγχο. Επιστρέφει `null` εάν αυτός ο έλεγχος δεν βρίσκεται στο πλαίσιο μιας φόρμας. |
[getId]
