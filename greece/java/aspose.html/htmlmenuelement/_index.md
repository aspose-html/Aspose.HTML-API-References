---
title: "HTMLMenuElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLMenuElement κλάση. Λίστα μενού. Δείτε τον ορισμό του στοιχείου MENU στο HTML 4.01. Αυτό το στοιχείο είναι παρωχημένο στο HTML 4.01"
type: docs
