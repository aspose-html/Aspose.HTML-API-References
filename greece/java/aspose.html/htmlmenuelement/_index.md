---
title: "Κλάση HTMLMenuElement"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "κλάση com.aspose.html.HTMLMenuElement. Λίστα μενού. Δείτε τον ορισμό του στοιχείου MENU στο HTML 4.01. Αυτό το στοιχείο είναι παρωχημένο στο HTML 4.01"
type: docs

url: /el/java/com.aspose.html/htmlmenuelement/
---
## HTMLMenuElement class

Λίστα μενού. Δείτε τον ορισμό του στοιχείου MENU στο HTML 4.01. Αυτό το στοιχείο είναι παρωχημένο στο HTML 4.01.
