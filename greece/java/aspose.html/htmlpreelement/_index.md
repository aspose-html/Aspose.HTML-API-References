---
title: "HTMLPreElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLPreElement class. Προμορφοποιημένο κείμενο. Δείτε τον ορισμό του στοιχείου PRE στο HTML 4.01"
type: docs

url: /el/java/com.aspose.html/htmlpreelement/
---
## HTMLPreElement class

Προ-μορφοποιημένο κείμενο. Δείτε τον ορισμό του στοιχείου PRE στο HTML 4.01.
