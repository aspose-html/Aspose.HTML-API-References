...
description: "com.aspose.html.HTMLDataListElement class. Το στοιχείο datalist αντιπροσωπεύει ένα σύνολο στοιχείων option που παρέχουν προορισμένες επιλογές για άλλα στοιχεία ελέγχου. Δείτε επίσης την σύσταση W3C HTML 5.2"
type: docs
...
Το στοιχείο datalist αντιπροσωπεύει ένα σύνολο στοιχείων option που παρέχουν προορισμένες επιλογές για άλλα στοιχεία ελέγχου. Δείτε επίσης την [HTML 5.2 W3C Recommendation](https://www.w3.org/TR/html52/sec-forms.html#elementdef-datalist).
