---
title: "HTMLDataListElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLDataListElement class. Το στοιχείο datalist αντιπροσωπεύει ένα σύνολο στοιχείων option που παρέχουν προορισμένες επιλογές για άλλα στοιχεία ελέγχου. Δείτε επίσης την HTML 5.2 W3C Σύσταση"
type: docs

url: /el/java/com.aspose.html/htmldatalistelement/
---
## HTMLDataListElement class

Το στοιχείο datalist αντιπροσωπεύει ένα σύνολο στοιχείων option που αντιπροσωπεύουν προορισμένες επιλογές για άλλα στοιχεία ελέγχου. Δείτε επίσης την [HTML 5.2 W3C Recommendation](https://www.w3.org/TR/html52/sec-forms.html#elementdef-datalist).
...
| [getOptions](../../com.aspose.html/htmldatalistelement/options/) Η συλλογή των στοιχείων `OPTION` που περιέχονται σε αυτό το στοιχείο. |
[getOuterHTML]
