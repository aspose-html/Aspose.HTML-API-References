---
title: "Κλάση HTMLTableRowElement"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "κλάση com.aspose.html.HTMLTableRowElement. Μια γραμμή σε έναν πίνακα. Δείτε τον ορισμό του στοιχείου TR στο HTML 4.01"
type: docs

url: /el/java/com.aspose.html/htmltablerowelement/
---
## HTMLTableRowElement class

Μια γραμμή σε έναν πίνακα. Δείτε τον ορισμό του στοιχείου TR στο HTML 4.01.
...
| [getCells](../../com.aspose.html/htmltablerowelement/cells/) Η συλλογή των κελιών σε αυτή τη γραμμή. @version DOM Level 2 |
[getCh]
...
| [getRowIndex](../../com.aspose.html/htmltablerowelement/rowindex/) Αυτό είναι σε λογική σειρά και όχι σε σειρά εγγράφου. Το `rowIndex` λαμβάνει υπόψη τις ενότητες (`THEAD`, `TFOOT` ή `TBODY`) μέσα στον πίνακα, τοποθετώντας τις γραμμές `THEAD` πρώτες στο ευρετήριο, ακολουθούμενες από τις γραμμές `TBODY`, και στη συνέχεια τις γραμμές `TFOOT`. @version DOM Level 2 |
| [getSectionRowIndex](../../com.aspose.html/htmltablerowelement/sectionrowindex/) Το ευρετήριο αυτής της γραμμής, σε σχέση με την τρέχουσα ενότητα (`THEAD`, `TFOOT` ή `TBODY`), ξεκινώντας από 0. @version DOM Level 2 |
...
| [deleteCell](../../com.aspose.html/htmltablerowelement/deletecell/)(int) | Διαγράψτε ένα κελί από την τρέχουσα γραμμή. |
...
| [insertCell](../../com.aspose.html/htmltablerowelement/insertcell/)(int) | Εισάγετε ένα κενό κελί `TD` σε αυτή τη γραμμή. Εάν το `index` είναι -1 ή ίσο με τον αριθμό των κελιών, το νέο κελί προσαρτάται. |
