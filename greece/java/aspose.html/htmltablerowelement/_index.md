---
title: "HTMLTableRowElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLTableRowElement κλάση. Μια γραμμή σε έναν πίνακα. Δείτε τον ορισμό του στοιχείου TR στο HTML 4.01"
type: docs
...
Μία γραμμή σε έναν πίνακα. Δείτε τον ορισμό του στοιχείου TR στο HTML 4.01.
