---
title: "HTMLLabelElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLLabelElement κλάση. Κείμενο ετικέτας πεδίου φόρμας. Δείτε τον ορισμό του στοιχείου LABEL στο HTML 4.01"
type: docs

url: /el/java/com.aspose.html/htmllabelelement/
---
## HTMLLabelElement class

Κείμενο ετικέτας πεδίου φόρμας. Δείτε τον ορισμό του στοιχείου LABEL στο HTML 4.01.
...
| [getForm](../../com.aspose.html/htmllabelelement/form/) Επιστρέφει το στοιχείο `FORM` που περιέχει αυτόν τον έλεγχο. Επιστρέφει `null` εάν αυτός ο έλεγχος δεν βρίσκεται μέσα στο πλαίσιο μιας φόρμας. |
[getId]
