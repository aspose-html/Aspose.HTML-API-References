---
title: "HTMLAppletElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLAppletElement κλάση. Ένα ενσωματωμένο Java applet. Δείτε τον ορισμό του στοιχείου APPLET στο HTML 4.01. Αυτό το στοιχείο είναι παρωχημένο στο HTML 4.01"
type: docs

url: /el/java/com.aspose.html/htmlappletelement/
---
## HTMLAppletElement class

Ένα ενσωματωμένο Java applet. Δείτε τον ορισμό του στοιχείου APPLET στο HTML 4.01. Αυτό το στοιχείο είναι παρωχημένο στο HTML 4.01.
