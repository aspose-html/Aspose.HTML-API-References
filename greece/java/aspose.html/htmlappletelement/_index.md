...
description: "com.aspose.html.HTMLAppletElement class. Ένα ενσωματωμένο Java applet. Δείτε τον ορισμό του στοιχείου APPLET στο HTML 4.01. Αυτό το στοιχείο είναι παρωχημένο στο HTML 4.01"
type: docs
