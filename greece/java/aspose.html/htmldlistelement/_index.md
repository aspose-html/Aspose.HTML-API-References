---
title: "HTMLDListElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLDListElement κλάση. Λίστα ορισμών. Δείτε τον ορισμό του στοιχείου DL στο HTML 4.01"
type: docs

url: /el/java/com.aspose.html/htmldlistelement/
---
## HTMLDListElement class

Λίστα ορισμών. Δείτε τον ορισμό του στοιχείου DL στο HTML 4.01.
