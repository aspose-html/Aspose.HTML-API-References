---
title: "HTMLOptionElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLOptionElement class. Μία επιλογή που μπορεί να επιλεγεί. Δείτε τον ορισμό του στοιχείου OPTION στο HTML 4.01"
type: docs

url: /el/java/com.aspose.html/htmloptionelement/
---
## HTMLOptionElement class

Μία επιλογή που μπορεί να επιλεγεί. Δείτε τον ορισμό του στοιχείου OPTION στο HTML 4.01.
...
| [getForm](../../com.aspose.html/htmloptionelement/form/) Επιστρέφει το στοιχείο `FORM` που περιέχει αυτόν τον έλεγχο. Επιστρέφει `null` εάν αυτός ο έλεγχος δεν βρίσκεται στο πλαίσιο μιας φόρμας. |
[getId]
[setId] The element's identifier. See the id attribute definition in HTML 4.01. |
| [getIndex](../../com.aspose.html/htmloptionelement/index/) Ο δείκτης αυτού του `OPTION` στο γονικό του `SELECT`, ξεκινώντας από το 0. @version DOM Level 2 |
[getInnerHTML]
...
| [getText](../../com.aspose.html/htmloptionelement/text/) Το κείμενο που περιέχεται μέσα στο στοιχείο επιλογής. |
