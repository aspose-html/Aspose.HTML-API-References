...
description: "com.aspose.html.HTMLOptionElement κλάση. Μια επιλέξιμη επιλογή. Δείτε τον ορισμό του στοιχείου OPTION στο HTML 4.01"
type: docs
...
Μία επιλέξιμη επιλογή. Δείτε τον ορισμό του στοιχείου OPTION στο HTML 4.01.
...
| [getIndex](../../com.aspose.html/htmloptionelement/index/) Ο δείκτης αυτού του `OPTION` στο γονικό του `SELECT`, ξεκινώντας από 0. @version DOM Level 2 |
[getInnerHTML]
