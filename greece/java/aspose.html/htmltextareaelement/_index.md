---
title: "HTMLTextAreaElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLTextAreaElement class. Πεδία κειμένου πολλαπλών γραμμών. Δείτε τον ορισμό του στοιχείου TEXTAREA στο HTML 4.01"
type: docs

url: /el/java/com.aspose.html/htmltextareaelement/
---
## HTMLTextAreaElement class

Πεδίο κειμένου πολλαπλών γραμμών. Δείτε τον ορισμό του στοιχείου TEXTAREA στο HTML 4.01.
...
| [getForm](../../com.aspose.html/htmltextareaelement/form/) Επιστρέφει το στοιχείο `FORM` που περιέχει αυτόν τον έλεγχο. Επιστρέφει `null` εάν αυτός ο έλεγχος δεν βρίσκεται στο πλαίσιο μιας φόρμας. |
[getId]
...
| [getType](../../com.aspose.html/htmltextareaelement/type/) Ο τύπος αυτού του ελέγχου φόρμας. Αυτό είναι το String "textarea". |
[getValue]
