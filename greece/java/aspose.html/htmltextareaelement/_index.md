...
Πολυγραμμικό πεδίο κειμένου. Δείτε τον ορισμό του στοιχείου TEXTAREA στο HTML 4.01.
...
| [getType](../../com.aspose.html/htmltextareaelement/type/) Ο τύπος αυτού του ελέγχου φόρμας. Αυτό είναι η συμβολοσειρά "textarea". |
[getValue]
