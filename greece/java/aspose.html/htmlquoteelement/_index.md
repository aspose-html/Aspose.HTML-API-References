---
title: "HTMLQuoteElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLQuoteElement κλάση. Για τα στοιχεία Q και BLOCKQUOTE. Δείτε τον ορισμό του στοιχείου Q στο HTML 4.01"
type: docs

url: /el/java/com.aspose.html/htmlquoteelement/
---
## HTMLQuoteElement class

Για τα στοιχεία `Q` και `BLOCKQUOTE`. Δείτε τον ορισμό του στοιχείου Q στο HTML 4.01.
