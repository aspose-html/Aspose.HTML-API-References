---
title: "HTMLModElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLModElement κλάση. Ειδοποίηση τροποποίησης μέρους ενός εγγράφου. Δείτε τους ορισμούς των στοιχείων INS και DEL στο HTML 4.01"
type: docs

url: /el/java/com.aspose.html/htmlmodelement/
---
## HTMLModElement class

Ειδοποίηση τροποποίησης μέρους ενός εγγράφου. Δείτε τους ορισμούς των στοιχείων INS και DEL στο HTML 4.01.
