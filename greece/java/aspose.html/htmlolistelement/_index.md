---
title: "HTMLOListElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLOListElement κλάση. Ταξινομημένη λίστα. Δείτε τον ορισμό του στοιχείου OL στο HTML 4.01"
type: docs

url: /el/java/com.aspose.html/htmlolistelement/
---
## HTMLOListElement class

Ταξινομημένη λίστα. Δείτε τον ορισμό του στοιχείου OL στο HTML 4.01.
