---
title: "HTMLTableColElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLTableColElement κλάση. Επαναομαδοποιεί τα στοιχεία COL και COLGROUP. Δείτε τον ορισμό του στοιχείου COL στο HTML 4.01"
type: docs

url: /el/java/com.aspose.html/htmltablecolelement/
---
## HTMLTableColElement class

Ομαδοποιεί ξανά τα στοιχεία `COL` και `COLGROUP`. Δείτε τον ορισμό του στοιχείου COL στο HTML 4.01.
