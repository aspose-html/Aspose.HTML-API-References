...
description: "com.aspose.html.HTMLTableColElement κλάση. Ομαδοποιεί τα στοιχεία COL και COLGROUP. Δείτε τον ορισμό του στοιχείου COL στο HTML 4.01"
type: docs
...
Ομαδοποιεί τα στοιχεία `COL` και `COLGROUP`. Δείτε τον ορισμό του στοιχείου COL στο HTML 4.01.
