---
title: "HTMLCanvasElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLCanvasElement κλάση. Η διεπαφή HTMLCanvasElement παρέχει ιδιότητες και μεθόδους για τη διαχείριση της διάταξης και της παρουσίασης των στοιχείων canvas. Η διεπαφή HTMLCanvasElement κληρονομεί επίσης τις ιδιότητες και τις μεθόδους της διεπαφής HTMLElement"
type: docs

url: /el/java/com.aspose.html/htmlcanvaselement/
---
## HTMLCanvasElement class

Η διεπαφή HTMLCanvasElement παρέχει ιδιότητες και μεθόδους για τη διαχείριση της διάταξης και της παρουσίασης των στοιχείων canvas. Η διεπαφή HTMLCanvasElement κληρονομεί επίσης τις ιδιότητες και τις μεθόδους της διεπαφής HTMLElement.
...
| [getContext](../../com.aspose.html/htmlcanvaselement/getcontext/)(String) | Επιστρέφει ένα περιβάλλον σχεδίασης στο canvas, ή null εάν το ID του περιβάλλοντος δεν υποστηρίζεται. Ένα περιβάλλον σχεδίασης σας επιτρέπει να σχεδιάζετε στο canvas. |
...
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl)() | επιστρέφει ένα URI δεδομένων που περιέχει μια αναπαράσταση της εικόνας στη μορφή που καθορίζεται από την παράμετρο τύπου (προεπιλογή PNG). Η επιστρεφόμενη εικόνα έχει ανάλυση 96 dpi. |
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl_1)(String) | επιστρέφει ένα URI δεδομένων που περιέχει μια αναπαράσταση της εικόνας στη μορφή που καθορίζεται από την παράμετρο τύπου (προεπιλογή PNG). Η επιστρεφόμενη εικόνα έχει ανάλυση 96 dpi. |
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl_2)(String, double) | επιστρέφει ένα URI δεδομένων που περιέχει μια αναπαράσταση της εικόνας στη μορφή που καθορίζεται από την παράμετρο τύπου (προεπιλογή PNG). Η επιστρεφόμενη εικόνα έχει ανάλυση 96 dpi. |
