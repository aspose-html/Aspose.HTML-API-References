---
title: "Κλάση HTMLCanvasElement"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "κλάση com.aspose.html.HTMLCanvasElement. Η διεπαφή HTMLCanvasElement παρέχει ιδιότητες και μεθόδους για τη διαχείριση της διάταξης και της παρουσίασης των στοιχείων canvas. Η διεπαφή HTMLCanvasElement κληρονομεί επίσης τις ιδιότητες και τις μεθόδους της διεπαφής HTMLElement"
type: docs
...
Η διεπαφή HTMLCanvasElement παρέχει ιδιότητες και μεθόδους για τη διαχείριση της διάταξης και της παρουσίασης των στοιχείων καμβά. Η διεπαφή HTMLCanvasElement κληρονομεί επίσης τις ιδιότητες και τις μεθόδους της διεπαφής HTMLElement.
...
| [getContext](../../com.aspose.html/htmlcanvaselement/getcontext/)(String) | Επιστρέφει ένα πλαίσιο σχεδίασης στο canvas, ή null εάν το ID του πλαισίου δεν υποστηρίζεται. Ένα πλαίσιο σχεδίασης σας επιτρέπει να σχεδιάζετε στο canvas. |
