---
title: "HTMLDivElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLDivElement κλάση. Γενικός μπλοκ-δοχείο. Δείτε τον ορισμό του στοιχείου DIV στο HTML 4.01"
type: docs

url: /el/java/com.aspose.html/htmldivelement/
---
## HTMLDivElement class

Γενικό μπλοκ-περιέκτη. Δείτε τον ορισμό του στοιχείου DIV στο HTML 4.01.
