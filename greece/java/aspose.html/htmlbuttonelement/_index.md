---
title: "HTMLButtonElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLButtonElement κλάση. Κουμπί ώθησης. Δείτε τον ορισμό του στοιχείου BUTTON στο HTML 4.01"
type: docs

url: /el/java/com.aspose.html/htmlbuttonelement/
---
## HTMLButtonElement class

Πιέστε το κουμπί. Δείτε τον ορισμό του στοιχείου BUTTON στο HTML 4.01.
...
| [getForm](../../com.aspose.html/htmlbuttonelement/form/) Επιστρέφει το στοιχείο `FORM` που περιέχει αυτόν τον έλεγχο. Επιστρέφει `null` εάν αυτός ο έλεγχος δεν βρίσκεται στο πλαίσιο μιας φόρμας. |
[getId]
