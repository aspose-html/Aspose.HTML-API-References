---
title: "Κλάση HTMLButtonElement"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "κλάση com.aspose.html.HTMLButtonElement. Κουμπί πίεσης. Δείτε τον ορισμό του στοιχείου BUTTON στο HTML 4.01"
type: docs
...
Κουμπί. Δείτε τον ορισμό του στοιχείου BUTTON στο HTML 4.01.
