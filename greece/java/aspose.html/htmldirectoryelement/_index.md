---
title: "HTMLDirectoryElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLDirectoryElement κλάση. Λίστα καταλόγου. Δείτε τον ορισμό του στοιχείου DIR στο HTML 4.01. Αυτό το στοιχείο είναι παρωχημένο στο HTML 4.01"
type: docs

url: /el/java/com.aspose.html/htmldirectoryelement/
---
## HTMLDirectoryElement class

Λίστα καταλόγου. Δείτε τον ορισμό του στοιχείου DIR στο HTML 4.01. Αυτό το στοιχείο είναι παρωχημένο στο HTML 4.01.
