---
title: "HTMLParagraphElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLParagraphElement κλάση. Παράγραφοι. Δείτε τον ορισμό του στοιχείου P στο HTML 4.01"
type: docs

url: /el/java/com.aspose.html/htmlparagraphelement/
---
## HTMLParagraphElement class

Παράγραφοι. Δείτε τον ορισμό του στοιχείου P στο HTML 4.01.
