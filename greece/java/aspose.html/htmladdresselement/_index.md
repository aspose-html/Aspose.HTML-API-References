---
title: "HTMLAddressElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLAddressElement κλάση. Το στοιχείο διεύθυνσης. Δείτε τον ορισμό του στοιχείου ADDRESS στο HTML 4.01"
type: docs

url: /el/java/com.aspose.html/htmladdresselement/
---
## HTMLAddressElement class

Το στοιχείο address. Δείτε τον ορισμό του στοιχείου ADDRESS στο HTML 4.01.
