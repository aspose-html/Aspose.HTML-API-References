...
description: "com.aspose.html.HTMLFrameSetElement class. Δημιουργεί ένα πλέγμα πλαισίων. Δείτε τον ορισμό του στοιχείου FRAMESET στο HTML 4.01"
type: docs
...
Δημιουργία πλέγματος πλαισίων. Δείτε τον ορισμό του στοιχείου FRAMESET στο HTML 4.01.
