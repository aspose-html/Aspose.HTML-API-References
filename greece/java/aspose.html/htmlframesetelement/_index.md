---
title: "HTMLFrameSetElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLFrameSetElement κλάση. Δημιουργεί ένα πλέγμα πλαισίων. Δείτε τον ορισμό του στοιχείου FRAMESET στο HTML 4.01"
type: docs

url: /el/java/com.aspose.html/htmlframesetelement/
---
## HTMLFrameSetElement class

Δημιουργήστε ένα πλέγμα πλαισίων. Δείτε τον ορισμό του στοιχείου FRAMESET στο HTML 4.01.
