---
title: "Κλάση HTMLParamElement"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "κλάση com.aspose.html.HTMLParamElement. Παράμετροι που παρέχονται στο στοιχείο OBJECT. Δείτε τον ορισμό του στοιχείου PARAM στο HTML 4.01"
type: docs
...
Παράμετροι που δίνονται στο στοιχείο `OBJECT`. Δείτε τον ορισμό του στοιχείου PARAM στο HTML 4.01.
