---
title: "HTMLParamElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLParamElement κλάση. Παράμετροι που παρέχονται στο στοιχείο OBJECT. Δείτε τον ορισμό του στοιχείου PARAM στο HTML 4.01"
type: docs

url: /el/java/com.aspose.html/htmlparamelement/
---
## HTMLParamElement class

Παράμετροι που παρέχονται στο στοιχείο `OBJECT`. Δείτε τον ορισμό του στοιχείου PARAM στο HTML 4.01.
