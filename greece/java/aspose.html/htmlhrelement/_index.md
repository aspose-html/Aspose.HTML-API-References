---
title: "HTMLHRElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLHRElement κλάση. Δημιουργεί μια οριζόντια γραμμή. Δείτε τον ορισμό του στοιχείου HR στο HTML 4.01"
type: docs

url: /el/java/com.aspose.html/htmlhrelement/
---
## HTMLHRElement class

Δημιουργήστε μια οριζόντια γραμμή. Δείτε τον ορισμό του στοιχείου HR στο HTML 4.01.
