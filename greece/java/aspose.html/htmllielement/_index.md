---
title: "HTMLLIElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLLIElement κλάση. Στοιχείο λίστας. Δείτε τον ορισμό του στοιχείου LI στο HTML 4.01"
type: docs

url: /el/java/com.aspose.html/htmllielement/
---
## HTMLLIElement class

Στοιχείο λίστας. Δείτε τον ορισμό του στοιχείου LI στο HTML 4.01.
