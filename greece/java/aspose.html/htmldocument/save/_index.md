...
description: "Μέθοδος HTMLDocument. Αποθηκεύει το έγγραφο σε τοπικό αρχείο που καθορίζεται από το url. Όλοι οι πόροι που χρησιμοποιούνται σε αυτό το έγγραφο θα αποθηκευτούν σε έναν γειτονικό φάκελο του οποίου το όνομα θα κατασκευαστεί ως output_file_name _files."
type: docs
...
Αποθηκεύει το έγγραφο σε ένα τοπικό αρχείο που καθορίζεται από τη διεύθυνση URL. Όλοι οι πόροι που χρησιμοποιούνται σε αυτό το έγγραφο θα αποθηκευτούν σε έναν διπλανό φάκελο, του οποίου το όνομα θα κατασκευαστεί ως output_file_name + "_files".
...
| --- | --- | --- |
| url | Url | Τοπικό [`URL`](../../url/) προς το αρχείο εξόδου. |
...
| Parameter | Type | Περιγραφή |
| --- | --- | --- |
| διαδρομή | String | Διαδρομή συστήματος αρχείων τοπικού υπολογιστή προς το αρχείο εξόδου. |
...
Η μέθοδος Save(String) λαμβάνει ως παράμετρο μια διαδρομή συστήματος αρχείων τοπικού υπολογιστή προς ένα αρχείο εξόδου και αποθηκεύει ένα έγγραφο HTML στο τοπικό αρχείο που καθορίζεται από τη διαδρομή. Όλοι οι πόροι που χρησιμοποιούνται στο έγγραφο θα αποθηκευτούν σε έναν γειτονικό φάκελο.
...
| Parameter | Type | Περιγραφή |
| --- | --- | --- |
| διαδρομή | String | Τοπική διαδρομή αρχείου προς το αρχείο εξόδου. |
...
&lt;div id="uniqueIdentifier"&gt;Δοχείο με ID - αναγνωριστικό&lt;/div&gt;

&lt;div class="custom-class"&gt;Προσαρμοσμένο από το κοντέινερ της κλάσης CSS&lt;/div&gt;

&lt;div&gt;

&lt;p class="pStyle"&gt;Πρώτο στυλ από την κλάση pStyle παράγραφος&lt;/p&gt;

&lt;p class="pStyle"&gt;Δεύτερο στυλ από την κλάση pStyle παράγραφος&lt;/p&gt;

&lt;p class="pStyle"&gt;Τρίτο στυλ από την κλάση pStyle παράγραφος&lt;/p&gt;
...
&lt;p id="p1" class="ddd kkk"&gt;Παράγραφος μορφοποιημένη με το όνομα κλάσης =ddd kkk=&lt;/p&gt;

&lt;p id="p2" class="ddd fff"&gt;Παράγραφος μορφοποιημένη με το όνομα κλάσης =ddd fff=&lt;/p&gt;

&lt;p id="p3" class="kkk fff"&gt;Παράγραφος μορφοποιημένη με το όνομα κλάσης =kkk fff=&lt;/p&gt;
...
Τύπος-Περιεχομένου: text/css;

Τοποθεσία-Περιεχομένου: main.css
...
Η μέθοδος Save(String, HTMLSaveOptions) λαμβάνει ως παραμέτρους μια διαδρομή τοπικού συστήματος αρχείων προς το αρχείο εξόδου, μια παρουσία της κλάσης [HTMLSaveOptions](https://docs.aspose.com/html/net/working-with-documents/saving-a-document/) και αποθηκεύει ένα έγγραφο HTML με πόρους στο τοπικό αρχείο που καθορίζεται από τη διαδρομή. Ο κατασκευαστής HTMLSaveOptions() δημιουργεί μια παρουσία επιλογών αποθήκευσης που έχει ιδιότητες [`ResourceHandlingOptions`](../../../com.aspose.html.saving/htmlsaveoptions/) που χρησιμοποιούνται για τη διαμόρφωση της διαχείρισης πόρων. Όλοι οι πόροι που χρησιμοποιούνται στο έγγραφο θα αποθηκευτούν σε έναν διπλανό φάκελο.
...
Απαιτείται να καθοριστεί διαδρομή τοπικού συστήματος αρχείων προς το αρχείο εξόδου για την αποθήκευση του εγγράφου. Ο κατασκευαστής MarkdownSaveOptions() δημιουργεί μια παρουσία της κλάσης [`MarkdownSaveOptions`](../../../com.aspose.html.saving/markdownsaveoptions/) που διαθέτει ένα σύνολο ιδιοτήτων. Για παράδειγμα, μπορείτε να ορίσετε το στυλ μορφοποίησης markdown, να χρησιμοποιήσετε προεπιλεγμένες επιλογές συμβατές με GitHub Flavored Markdown και να διαμορφώσετε τη διαχείριση πόρων. Η μέθοδος Save(path, saveOptions) λαμβάνει τη διαδρομή του τοπικού συστήματος αρχείων προς το αρχείο εξόδου και την παρουσία επιλογών ως παραμέτρους και αποθηκεύει το HTML ως έγγραφο Markdown με πόρους στο τοπικό αρχείο που καθορίζεται από τη διαδρομή.
...
| --- | --- | --- |
| url | Url | Τοπικό [`URL`](../../url/) προς το αρχείο εξόδου. |
| saveOptions | MarkdownSaveOptions | Η χρήση του αντικειμένου [`MarkdownSaveOptions`](../../../com.aspose.html.saving/markdownsaveoptions/) σας επιτρέπει να ρυθμίσετε τη διαδικασία απόδοσης. Για περισσότερες πληροφορίες δείτε την [τεκμηρίωση](https://docs.aspose.com/html/net/converting-between-formats/html-to-markdown/#save-options). |
...
| --- | --- | --- |
| διαδρομή | String | Τοπική διαδρομή για το αρχείο εξόδου. |
| saveOptions | MHTMLSaveOptions | Η χρήση του αντικειμένου [`MHTMLSaveOptions`](../../../com.aspose.html.saving/mhtmlsaveoptions/) σας επιτρέπει να ρυθμίσετε τη διαδικασία απόδοσης. Για περισσότερες πληροφορίες δείτε την [τεκμηρίωση](https://docs.aspose.com/html/net/converting-between-formats/html-to-mhtml/#save-options). |
...
Απαιτείται να καθοριστεί μια διαδρομή τοπικού συστήματος αρχείων για το αρχείο εξόδου κατά την αποθήκευση του εγγράφου. Ο κατασκευαστής MHTMLSaveOptions() αρχικοποιεί μια παρουσία της κλάσης [`MHTMLSaveOptions`](../../../com.aspose.html.saving/mhtmlsaveoptions/) που διαθέτει την ιδιότητα ResourceHandlingOptions η οποία χρησιμοποιείται για τη διαμόρφωση του χειρισμού πόρων. Η μέθοδος Save(path, saveOptions) λαμβάνει ως παραμέτρους μια διαδρομή τοπικού συστήματος αρχείων για το αρχείο εξόδου και μια παρουσία επιλογών αποθήκευσης και αποθηκεύει το HTML ως έγγραφο MHTML στο τοπικό αρχείο που ορίζεται από τη διαδρομή.
