---
title: "HTMLTableCellElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLTableCellElement class. Το αντικείμενο που χρησιμοποιείται για την αναπαράσταση των στοιχείων TH και TD. Δείτε τον ορισμό του στοιχείου TD στο HTML 4.01"
type: docs

url: /el/java/com.aspose.html/htmltablecellelement/
---
## HTMLTableCellElement class

Το αντικείμενο που χρησιμοποιείται για την αναπαράσταση των στοιχείων `TH` και `TD`. Δείτε τον ορισμό του στοιχείου TD στο HTML 4.01.
...
| [getCellIndex](../../com.aspose.html/htmltablecellelement/cellindex/) Ο δείκτης αυτού του κελιού στη σειρά, ξεκινώντας από το 0. Αυτός ο δείκτης είναι με σειρά δένδρου εγγράφου και όχι με σειρά εμφάνισης. |
[getCh]
