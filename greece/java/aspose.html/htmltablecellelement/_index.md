...
| [getCellIndex](../../com.aspose.html/htmltablecellelement/cellindex/) Ο δείκτης αυτού του κελιού στη σειρά, ξεκινώντας από 0. Αυτός ο δείκτης είναι με σειρά δένδρου εγγράφου και όχι με σειρά εμφάνισης. |
[getCh]
