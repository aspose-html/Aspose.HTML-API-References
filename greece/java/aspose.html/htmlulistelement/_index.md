---
title: "HTMLUListElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLUListElement κλάση. Μη ταξινομημένη λίστα. Δείτε τον ορισμό του στοιχείου UL στο HTML 4.01"
type: docs

url: /el/java/com.aspose.html/htmlulistelement/
---
## HTMLUListElement class

Μη ταξινομημένη λίστα. Δείτε τον ορισμό του στοιχείου UL στο HTML 4.01.
