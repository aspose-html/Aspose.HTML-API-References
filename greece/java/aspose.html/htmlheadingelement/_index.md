---
title: "HTMLHeadingElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLHeadingElement κλάση. Για τα στοιχεία H1 έως H6. Δείτε τον ορισμό του στοιχείου H1 στο HTML 4.01"
type: docs

url: /el/java/com.aspose.html/htmlheadingelement/
---
## HTMLHeadingElement class

Για τα στοιχεία `H1` έως `H6`. Δείτε τον ορισμό του στοιχείου H1 στο HTML 4.01.
