---
title: "Κλάση HTMLObjectElement"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "κλάση com.aspose.html.HTMLObjectElement. Γενικό ενσωματωμένο αντικείμενο. Κατ' αρχήν όλες οι ιδιότητες του στοιχείου object είναι αναγνώσιμες-εγγράψιμες, αλλά σε ορισμένα περιβάλλοντα ορισμένες ιδιότητες μπορεί να είναι μόνο ανάγνωση μετά την δημιουργία του υποκείμενου αντικειμένου. Δείτε τον ορισμό του στοιχείου OBJECT στο HTML 4.01"
type: docs

url: /el/java/com.aspose.html/htmlobjectelement/
---
## HTMLObjectElement class

Γενικό ενσωματωμένο αντικείμενο. Κατ' αρχήν, όλες οι ιδιότητες του στοιχείου object είναι αναγνώσιμες-εγγράψιμες, αλλά σε ορισμένα περιβάλλοντα κάποιες ιδιότητες μπορεί να είναι μόνο ανάγνωση μόλις το υποκείμενο αντικείμενο δημιουργηθεί. Δείτε τον ορισμό του στοιχείου OBJECT στο [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224)].
