---
title: "HTMLNoScriptElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLNoScriptElement class. Δηλώσεις σεναρίου. Δείτε τον ορισμό του στοιχείου NOSCRIPT στο HTML 4.01"
type: docs

url: /el/java/com.aspose.html/htmlnoscriptelement/
---
## HTMLNoScriptElement class

Δηλώσεις script. Δείτε τον ορισμό του στοιχείου NOSCRIPT στο HTML 4.01.
