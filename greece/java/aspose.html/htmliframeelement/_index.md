---
title: "HTMLIFrameElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "κλάση com.aspose.html.HTMLIFrameElement. Ενσωματωμένα υποπαράθυρα. Δείτε τον ορισμό του στοιχείου IFRAME στο HTML 4.01"
type: docs

url: /el/java/com.aspose.html/htmliframeelement/
---
## HTMLIFrameElement class

Ενσωματωμένα υποπαράθυρα. Δείτε τον ορισμό του στοιχείου IFRAME στο HTML 4.01.
