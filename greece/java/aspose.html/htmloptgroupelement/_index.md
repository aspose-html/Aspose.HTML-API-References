---
title: "HTMLOptGroupElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLOptGroupElement κλάση. Ομαδοποιήστε τις επιλογές σε λογικές υποδιαιρέσεις. Δείτε τον ορισμό του στοιχείου OPTGROUP στο HTML 4.01"
type: docs

url: /el/java/com.aspose.html/htmloptgroupelement/
---
## HTMLOptGroupElement class

Ομαδοποιήστε τις επιλογές μαζί σε λογικές υποδιαιρέσεις. Δείτε τον ορισμό του στοιχείου OPTGROUP στο HTML 4.01.
