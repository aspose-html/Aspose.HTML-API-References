...
description: "com.aspose.html.HTMLOptGroupElement class. Ομαδοποιήστε τις επιλογές μαζί σε λογικές υποδιαιρέσεις. Δείτε τον ορισμό του στοιχείου OPTGROUP στο HTML 4.01"
type: docs
...
Ομαδοποίηση επιλογών σε λογικές υποδιαιρέσεις. Δείτε τον ορισμό του στοιχείου OPTGROUP στο HTML 4.01.
