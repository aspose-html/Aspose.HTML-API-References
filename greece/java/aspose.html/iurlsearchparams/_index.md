...
description: "Διεπαφή com.aspose.html.IUrlSearchParams. Παρέχει μεθόδους για εργασία με τη συμβολοσειρά ερωτήματος URLs"
type: docs
...
Παρέχει μεθόδους για εργασία με τη συμβολοσειρά ερωτήματος URLs.
...
| [get](../../com.aspose.html/iurlsearchparams/get/)(String) | Επιστρέφει την τιμή του πρώτου ζεύγους όνομα-τιμή του οποίου το όνομα είναι `name`. |
...
| [sort](../../com.aspose.html/iurlsearchparams/sort/)() | Ταξινομεί όλα τα ζεύγη όνομα-τιμή, εάν υπάρχουν, κατά τα ονόματά τους. |
