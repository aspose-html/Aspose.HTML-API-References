---
title: "HTMLHtmlElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLHtmlElement class. Ρίζα ενός εγγράφου HTML. Δείτε τον ορισμό του στοιχείου HTML στο HTML 4.01"
type: docs

url: /el/java/com.aspose.html/htmlhtmlelement/
---
## HTMLHtmlElement class

Ρίζα ενός εγγράφου HTML. Δείτε τον ορισμό του στοιχείου HTML στο HTML 4.01.
