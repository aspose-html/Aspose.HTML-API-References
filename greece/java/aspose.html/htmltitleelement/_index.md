---
title: "HTMLTitleElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLTitleElement κλάση. Το στοιχείο τίτλου. Δείτε τον ορισμό του στοιχείου TITLE στο HTML 4.01"
type: docs

url: /el/java/com.aspose.html/htmltitleelement/
---
## HTMLTitleElement class

Το στοιχείο title. Δείτε τον ορισμό του στοιχείου TITLE στο HTML 4.01.
