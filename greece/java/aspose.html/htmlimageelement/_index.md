---
title: "HTMLImageElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLImageElement κλάση. Ενσωματωμένη εικόνα. Δείτε τον ορισμό του στοιχείου IMG στο HTML 4.01"
type: docs

url: /el/java/com.aspose.html/htmlimageelement/
---
## HTMLImageElement class

Ενσωματωμένη εικόνα. Δείτε τον ορισμό του στοιχείου IMG στο HTML 4.01.
