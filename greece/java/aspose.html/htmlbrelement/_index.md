---
title: "HTMLBRElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLBRElement κλάση. Αναγκάζει μια αλλαγή γραμμής. Δείτε τον ορισμό του στοιχείου BR στο HTML 4.01"
type: docs
url: /el/java/com.aspose.html/htmlbrelement/
---
## HTMLBRElement class

Αναγκάστε μια αλλαγή γραμμής. Δείτε τον ορισμό του στοιχείου BR στο HTML 4.01.
