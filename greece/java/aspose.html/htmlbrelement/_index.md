...
description: "com.aspose.html.HTMLBRElement κλάση. Αναγκάζει αλλαγή γραμμής. Δείτε τον ορισμό του στοιχείου BR στο HTML 4.01"
type: docs
url: /el/java/com.aspose.html/htmlbrelement/
---
## HTMLBRElement class

Επιβάλετε αλλαγή γραμμής. Δείτε τον ορισμό του στοιχείου BR στο HTML 4.01.
