---
title: "HTMLTableElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.HTMLTableElement κλάση. Οι μέθοδοι create και delete στον πίνακα επιτρέπουν στους συγγραφείς να δημιουργούν και να τροποποιούν πίνακες. Το HTML 4.01 καθορίζει ότι μπορεί να υπάρχει μόνο ένα από κάθε στοιχείο CAPTION, THEAD και TFOOT σε έναν πίνακα. Συνεπώς, εάν υπάρχει και κληθεί η μέθοδος createTHead ή createTFoot, η μέθοδος επιστρέφει το υπάρχον στοιχείο THead ή TFoot. Δείτε τον ορισμό του στοιχείου TABLE στο HTML 4.01."
type: docs

url: /el/java/com.aspose.html/htmltableelement/
---
## HTMLTableElement class

Οι μέθοδοι create* και delete* στον πίνακα επιτρέπουν στους συγγραφείς να δημιουργούν και να τροποποιούν πίνακες. Το [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224)] καθορίζει ότι μπορεί να υπάρχει μόνο ένα από κάθε στοιχείο `CAPTION`, `THEAD` και `TFOOT` σε έναν πίνακα. Συνεπώς, αν υπάρχει, και κληθεί η μέθοδος createTHead() ή createTFoot(), η μέθοδος επιστρέφει το υπάρχον στοιχείο THead ή TFoot. Δείτε τον ορισμό του στοιχείου TABLE στο HTML 4.01.
...
| [getCaption](../../com.aspose.html/htmltableelement/caption/) Επιστρέφει το `CAPTION` του πίνακα, ή void εάν δεν υπάρχει. @version DOM Level 2 |
[getCellPadding]
...
| [getRows](../../com.aspose.html/htmltableelement/rows/) Επιστρέφει το `TFOOT` του πίνακα, ή `null` εάν δεν υπάρχει. |
[getRules]
...
| [getTBodies](../../com.aspose.html/htmltableelement/tbodies/) Επιστρέφει μια συλλογή των σωμάτων του πίνακα (συμπεριλαμβανομένων των έμμεσων). |
...
| [getTFoot](../../com.aspose.html/htmltableelement/tfoot/) Επιστρέφει το `THEAD` του πίνακα, ή `null` εάν δεν υπάρχει. |
| [getTHead](../../com.aspose.html/htmltableelement/thead/) Επιστρέφει το `CAPTION` του πίνακα, ή void εάν δεν υπάρχει. |
[getTitle]
...
| [createCaption](../../com.aspose.html/htmltableelement/createcaption/)() | Δημιουργήστε ένα νέο αντικείμενο caption πίνακα ή επιστρέψτε ένα υπάρχον. |
| [createTFoot](../../com.aspose.html/htmltableelement/createtfoot/)() | Δημιουργήστε μια γραμμή υποσέλιδου πίνακα ή επιστρέψτε μια υπάρχουσα. |
| [createTHead](../../com.aspose.html/htmltableelement/createthead/)() | Δημιουργήστε μια γραμμή κεφαλίδας πίνακα ή επιστρέψτε μια υπάρχουσα. |
| [deleteCaption](../../com.aspose.html/htmltableelement/deletecaption/)() | Διαγράψτε το caption του πίνακα, εάν υπάρχει. |
| [deleteRow](../../com.aspose.html/htmltableelement/deleterow/)(int) | Διαγράψτε μια γραμμή πίνακα. |
| [deleteTFoot](../../com.aspose.html/htmltableelement/deletetfoot/)() | Διαγράψτε το υποσέλιδο από τον πίνακα, εάν υπάρχει. |
| [deleteTHead](../../com.aspose.html/htmltableelement/deletethead/)() | Διαγράψτε την κεφαλίδα από τον πίνακα, εάν υπάρχει. |
...
| [insertRow](../../com.aspose.html/htmltableelement/insertrow/)(int) | Εισάγετε μια νέα κενή γραμμή στον πίνακα. Η νέα γραμμή εισάγεται αμέσως πριν και στην ίδια ενότητα με τη τρέχουσα γραμμή `index` του πίνακα. Εάν το `index` είναι -1 ή ίσο με τον αριθμό των γραμμών, η νέα γραμμή προσαρτάται στο τέλος. Επιπλέον, όταν ο πίνακας είναι κενός, η γραμμή εισάγεται σε ένα `TBODY` που δημιουργείται και εισάγεται στον πίνακα. Μια γραμμή πίνακα δεν μπορεί να είναι κενή σύμφωνα με [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224)]. |
