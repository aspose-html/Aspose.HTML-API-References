...
description: "com.aspose.html.HTMLTableElement κλάση. Οι μέθοδοι δημιουργίας και διαγραφής στον πίνακα επιτρέπουν στους δημιουργούς να κατασκευάσουν και να τροποποιήσουν πίνακες. Το HTML 4.01 καθορίζει ότι μπορεί να υπάρχει μόνο ένα από καθένα από τα στοιχεία CAPTION, THEAD και TFOOT σε έναν πίνακα. Συνεπώς, εάν υπάρχει και κληθεί η μέθοδος createTHead ή createTFoot, η μέθοδος επιστρέφει το υπάρχον στοιχείο THead ή TFoot. Δείτε τον ορισμό του στοιχείου TABLE στο HTML 4.01."
type: docs
...
| [createCaption](../../com.aspose.html/htmltableelement/createcaption/)() | Δημιουργήστε ένα νέο αντικείμενο λεζάντας πίνακα ή επιστρέψτε ένα υπάρχον. |
...
| [deleteCaption](../../com.aspose.html/htmltableelement/deletecaption/)() | Διαγράψτε τη λεζάντα του πίνακα, εάν υπάρχει. |
...
| [insertRow](../../com.aspose.html/htmltableelement/insertrow/)(int) | Εισάγετε μια νέα κενή γραμμή στον πίνακα. Η νέα γραμμή εισάγεται αμέσως πριν και στην ίδια ενότητα με την τρέχουσα γραμμή `index` του πίνακα. Εάν το `index` είναι -1 ή ίσο με τον αριθμό των γραμμών, η νέα γραμμή προσαρτάται. Επιπλέον, όταν ο πίνακας είναι κενός, η γραμμή εισάγεται σε ένα `TBODY` που δημιουργείται και εισάγεται στον πίνακα. Μια γραμμή πίνακα δεν μπορεί να είναι κενή σύμφωνα με [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224)]. |
