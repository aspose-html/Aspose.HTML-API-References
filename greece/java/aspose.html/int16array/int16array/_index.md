...
description: "Int16Array constructor. Αρχικοποιεί ένα νέο αντικείμενο της κλάσης Int16Array"
type: docs

url: /el/java/com.aspose.html/int16array/int16array/
---
## Int16Array(int) {#constructor_4}

Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [`Int16Array`](../).
...
| Parameter | Type | Περιγραφή |
| --- | --- | --- |
| δεδομένα | Int16[] | Τα δεδομένα του πίνακα. |
...
| --- | --- | --- |
| buffer | ArrayBuffer | Το buffer δεδομένων. |
| byteOffset | Int32 | Η μετατόπιση byte. |
