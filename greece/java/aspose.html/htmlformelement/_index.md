---
title: "HTMLFormElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "Η κλάση com.aspose.html.HTMLFormElement. Το στοιχείο FORM περιλαμβάνει συμπεριφορά παρόμοια με συλλογή και στοιχείο. Παρέχει άμεση πρόσβαση στους περιεχόμενους ελέγχους φόρμας καθώς και στα χαρακτηριστικά του στοιχείου φόρμας. Δείτε τον ορισμό του στοιχείου FORM στο HTML 4.01."
type: docs
