---
title: "Κλάση HTMLFormElement"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "Κλάση com.aspose.html.HTMLFormElement. Το στοιχείο FORM περιλαμβάνει συμπεριφορά παρόμοια με μια συλλογή και ένα στοιχείο. Παρέχει άμεση πρόσβαση στους περιεχόμενους ελέγχους φόρμας καθώς και στα χαρακτηριστικά του στοιχείου φόρμας. Δείτε τον ορισμό του στοιχείου FORM στο HTML 4.01"
type: docs

url: /el/java/com.aspose.html/htmlformelement/
---
## HTMLFormElement class

Το στοιχείο `FORM` περιλαμβάνει συμπεριφορά παρόμοια με μια συλλογή και ένα στοιχείο. Παρέχει άμεση πρόσβαση στα περιεχόμενα στοιχεία ελέγχου της φόρμας καθώς και στα χαρακτηριστικά του στοιχείου φόρμας. Δείτε τον ορισμό του στοιχείου FORM στο HTML 4.01.
...
| [getElements](../../com.aspose.html/htmlformelement/elements/) Επιστρέφει μια συλλογή όλων των στοιχείων ελέγχου φόρμας στη φόρμα. |
[getEnctype]
...
| [getLength](../../com.aspose.html/htmlformelement/length/) Ο αριθμός των ελέγχων φόρμας στη φόρμα. |
...
| [reset](../../com.aspose.html/htmlformelement/reset/)() | Επαναφέρει τις προεπιλεγμένες τιμές ενός στοιχείου φόρμας. Εκτελεί την ίδια ενέργεια με ένα κουμπί επαναφοράς. |
...
| [submit](../../com.aspose.html/htmlformelement/submit/)() | Υποβάλλει τη φόρμα. Εκτελεί την ίδια ενέργεια με ένα κουμπί υποβολής. |
