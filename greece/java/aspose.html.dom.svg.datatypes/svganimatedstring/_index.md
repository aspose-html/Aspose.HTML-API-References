---
title: "Κλάση SVGAnimatedString"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "Κλάση com.aspose.html.dom.svg.datatypes.SVGAnimatedString. Χρησιμοποιείται για χαρακτηριστικά τύπου DOMString που μπορούν να αναπαραχθούν."
type: docs

url: /el/java/com.aspose.html.dom.svg.datatypes/svganimatedString/
---
## SVGAnimatedString class

Χρησιμοποιείται για χαρακτηριστικά τύπου DOMString που μπορούν να ανιμαριστούν.
...
| [toString](../../com.aspose.html.dom.svg.datatypes/svganimatedString/toString/)() | Επιστρέφει ένα String που αντιπροσωπεύει αυτό το αντικείμενο. |
