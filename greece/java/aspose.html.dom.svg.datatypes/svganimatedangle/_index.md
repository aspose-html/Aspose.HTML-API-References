---
title: "SVGAnimatedAngle Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.dom.svg.datatypes.SVGAnimatedAngle κλάση. Χρησιμοποιείται για ιδιότητες βασικού τύπου δεδομένων γωνίας που μπορούν να αναπαραχθούν με κίνηση."
type: docs

url: /el/java/com.aspose.html.dom.svg.datatypes/svganimatedangle/
---
## SVGAnimatedAngle class

Χρησιμοποιείται για ιδιότητες του βασικού τύπου δεδομένων γωνίας που μπορούν να αναπαραχθούν.
...
| [toString](../../com.aspose.html.dom.svg.datatypes/svganimatedangle/toString/)() | Επιστρέφει ένα String που αντιπροσωπεύει αυτό το αντικείμενο. |
