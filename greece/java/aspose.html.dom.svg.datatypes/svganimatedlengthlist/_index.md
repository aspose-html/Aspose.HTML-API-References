---
title: "SVGAnimatedLengthList Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.dom.svg.datatypes.SVGAnimatedLengthList κλάση. Χρησιμοποιείται για χαρακτηριστικά τύπου SVGLengthList που μπορούν να είναι κινούμενα."
type: docs

url: /el/java/com.aspose.html.dom.svg.datatypes/svganimatedlengthlist/
---
## SVGAnimatedLengthList class

Χρησιμοποιείται για χαρακτηριστικά τύπου SVGLengthList που μπορούν να ανιμαριστούν.
...
| [toString](../../com.aspose.html.dom.svg.datatypes/svganimatedlengthlist/toString/)() | Επιστρέφει ένα String που αντιπροσωπεύει αυτό το αντικείμενο. |
