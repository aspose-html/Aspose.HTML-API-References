...
description: "κλάση com.aspose.html.dom.svg.datatypes.SVGMatrix. Πολλές από τις λειτουργίες γραφικών SVG χρησιμοποιούν πίνακες 2x3 της μορφής a c e b d f που όταν επεκτείνονται σε πίνακα 3x3 για σκοπούς αριθμητικών πράξεων γίνονται a c e b d f 0 0 1"
type: docs
...
Πολλές από τις γραφικές λειτουργίες του SVG χρησιμοποιούν πίνακες 2x3 της μορφής: [a c e] [b d f] που, όταν επεκταθούν σε πίνακα 3x3 για σκοπούς μαθηματικών πινάκων, γίνονται: [a c e] [b d f] [0 0 1]
...
| [multiply](../../com.aspose.html.dom.svg.datatypes/svgmatrix/multiply/)(SVGMatrix) | Εκτελεί πολλαπλασιασμό πινάκων. Αυτός ο πίνακας πολλαπλασιάζεται μετά από άλλο πίνακα, επιστρέφοντας τον νέο προκύπτοντα πίνακα. |
