---
title: "SVGStringList Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.dom.svg.datatypes.SVGStringList class. Η SVGStringList διαθέτει τα ίδια χαρακτηριστικά και μεθόδους με άλλες διεπαφές SVGxxxList. Οι υλοποιητές μπορεί να εξετάσουν τη χρήση μιας ενιαίας βασικής κλάσης για την υλοποίηση των διαφόρων διεπαφών SVGxxxList."
type: docs

url: /el/java/com.aspose.html.dom.svg.datatypes/svgStringlist/
---
## SVGStringList class

Η SVGStringList έχει τα ίδια χαρακτηριστικά και μεθόδους με άλλες διεπαφές SVGxxxList. Οι υλοποιητές μπορεί να εξετάσουν τη χρήση μιας ενιαίας βασικής κλάσης για την υλοποίηση των διαφόρων διεπαφών SVGxxxList.
...
| Όνομα | Περιγραφή |
| --- | --- |
| [SVGStringList](svgStringlist/#constructor)() | Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης `SVGStringList`. |
| [SVGStringList](svgStringlist/#constructor_1)(IEnumerable&lt;String&gt;) | Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης `SVGStringList`. |
...
| [toString](../../com.aspose.html.dom.svg.datatypes/svgStringlist/toString/)() | Επιστρέφει ένα String που αντιπροσωπεύει αυτό το αντικείμενο. |
