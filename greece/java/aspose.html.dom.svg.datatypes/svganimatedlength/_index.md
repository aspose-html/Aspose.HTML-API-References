---
title: "Κλάση SVGAnimatedLength"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.dom.svg.datatypes.SVGAnimatedLength class. Χρησιμοποιείται για ιδιότητες βασικού τύπου length που μπορούν να ανιματοποιηθούν"
type: docs

url: /el/java/com.aspose.html.dom.svg.datatypes/svganimatedlength/
---
## SVGAnimatedLength class

Χρησιμοποιείται για ιδιότητες του βασικού τύπου length που μπορούν να αναπαραχθούν.
...
| [toString](../../com.aspose.html.dom.svg.datatypes/svganimatedlength/toString/)() | Επιστρέφει ένα String που αντιπροσωπεύει αυτό το αντικείμενο. |
