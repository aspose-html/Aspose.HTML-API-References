---
title: "SVGTransformList Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.dom.svg.datatypes.SVGTransformList class. Αυτή η διασύνδεση ορίζει μια λίστα από αντικείμενα SVGTransform"
type: docs

url: /el/java/com.aspose.html.dom.svg.datatypes/svgtransformlist/
---
## SVGTransformList class

Αυτή η διεπαφή ορίζει μια λίστα από αντικείμενα SVGTransform.
...
| Όνομα | Περιγραφή |
| --- | --- |
| [SVGTransformList](svgtransformlist/#constructor)() | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης `SVGTransformList`. |
| [SVGTransformList](svgtransformlist/#constructor_1)(IEnumerable&lt;SVGTransform&gt;) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης `SVGTransformList`. |
...
| [toString](../../com.aspose.html.dom.svg.datatypes/svgtransformlist/toString/)() | Επιστρέφει ένα String που αντιπροσωπεύει αυτό το αντικείμενο. |
