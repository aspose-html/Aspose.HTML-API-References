---
title: "SVGAnimatedPreserveAspectRatio Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.dom.svg.datatypes.SVGAnimatedPreserveAspectRatio class. Χρησιμοποιείται για χαρακτηριστικά τύπου SVGPreserveAspectRatio που μπορούν να αναπαράγονται με animation."
type: docs

url: /el/java/com.aspose.html.dom.svg.datatypes/svganimatedpreserveaspectratio/
---
## SVGAnimatedPreserveAspectRatio class

Χρησιμοποιείται για ιδιότητες τύπου SVGPreserveAspectRatio που μπορούν να αναπαραχθούν.
...
| [toString](../../com.aspose.html.dom.svg.datatypes/svganimatedpreserveaspectratio/toString/)() | Επιστρέφει ένα String που αντιπροσωπεύει αυτό το αντικείμενο. |
