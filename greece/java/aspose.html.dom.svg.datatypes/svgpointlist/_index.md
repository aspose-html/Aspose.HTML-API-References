---
title: "SVGPointList Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.dom.svg.datatypes.SVGPointList class. Αυτή η διεπαφή ορίζει μια λίστα από αντικείμενα SVGPoint."
type: docs

url: /el/java/com.aspose.html.dom.svg.datatypes/svgpointlist/
---
## SVGPointList class

Αυτή η διεπαφή ορίζει μια λίστα από αντικείμενα SVGPoint.
...
| [toString](../../com.aspose.html.dom.svg.datatypes/svgpointlist/toString/)() | Επιστρέφει ένα String που αντιπροσωπεύει αυτό το αντικείμενο. |
