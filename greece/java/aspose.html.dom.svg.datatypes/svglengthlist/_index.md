---
title: "Κλάση SVGLengthList"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.dom.svg.datatypes.SVGLengthList class. Αυτό το interface ορίζει μια λίστα από αντικείμενα SVGLength"
type: docs

url: /el/java/com.aspose.html.dom.svg.datatypes/svglengthlist/
---
## SVGLengthList class

Αυτή η διεπαφή ορίζει μια λίστα από αντικείμενα SVGLength.
...
| [toString](../../com.aspose.html.dom.svg.datatypes/svglengthlist/toString/)() | Επιστρέφει ένα String που αντιπροσωπεύει αυτό το αντικείμενο. |
