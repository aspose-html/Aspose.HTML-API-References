...
description: "Μέθοδος SVGAngle. Επαναφέρει την τιμή ως αριθμό με έναν σχετικό unitType, αντικαθιστώντας έτσι τις τιμές όλων των χαρακτηριστικών του αντικειμένου."
type: docs
