---
title: "Κλάση SVGAnimatedNumber"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.dom.svg.datatypes.SVGAnimatedNumber class. Χρησιμοποιείται για ιδιότητες βασικού τύπου number που μπορούν να ανιματοποιηθούν"
type: docs

url: /el/java/com.aspose.html.dom.svg.datatypes/svganimatednumber/
---
## SVGAnimatedNumber class

Χρησιμοποιείται για ιδιότητες του βασικού τύπου number που μπορούν να αναπαραχθούν.
...
| [toString](../../com.aspose.html.dom.svg.datatypes/svganimatednumber/toString/)() | Επιστρέφει ένα String που αντιπροσωπεύει αυτό το αντικείμενο. |
