---
title: "SVGAnimatedInteger Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.dom.svg.datatypes.SVGAnimatedInteger κλάση. Χρησιμοποιείται για ιδιότητες βασικού τύπου ακέραιου που μπορούν να αναπαραχθούν"
type: docs

url: /el/java/com.aspose.html.dom.svg.datatypes/svganimatedinteger/
---
## SVGAnimatedInteger class

Χρησιμοποιείται για χαρακτηριστικά του βασικού τύπου integer που μπορούν να ανιμαριστούν.
...
| [toString](../../com.aspose.html.dom.svg.datatypes/svganimatedinteger/toString/)() | Επιστρέφει ένα String που αντιπροσωπεύει αυτό το αντικείμενο. |
