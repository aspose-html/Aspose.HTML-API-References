---
title: "DocRenderingOptions Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.rendering.doc.DocRenderingOptions κλάση. Αντιπροσωπεύει τις επιλογές απόδοσης για το DocDevice"
type: docs

url: /el/java/com.aspose.html.rendering.doc/docrenderingoptions/
---
## DocRenderingOptions class

Αντιπροσωπεύει τις επιλογές απόδοσης για το [`DocDevice`](../docdevice/).
...
| Όνομα | Περιγραφή |
| --- | --- |
| [DocRenderingOptions](docrenderingoptions/#constructor)() | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης `DocRenderingOptions`. |
| [DocRenderingOptions](docrenderingoptions/#constructor_1)(FontEmbeddingRule) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης `DocRenderingOptions` με τον καθορισμένο κανόνα ενσωμάτωσης γραμματοσειράς. |
