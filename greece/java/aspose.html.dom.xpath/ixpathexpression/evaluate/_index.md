...
| [dOMException](../../../com.aspose.html.dom/domexception/) | WRONG_DOCUMENT_ERR: Ο Node προέρχεται από έγγραφο που δεν υποστηρίζεται από το [`IXPathEvaluator`](../../ixpathevaluator/) που δημιούργησε αυτό το [`IXPathExpression`](../). |
| [dOMException](../../../com.aspose.html.dom/domexception/) | NOT_SUPPORTED_ERR: Ο Node δεν είναι τύπος που επιτρέπεται ως κόμβος περιβάλλοντος XPath ή ο τύπος αιτήματος δεν επιτρέπεται από αυτό το [`IXPathExpression`](../). |
