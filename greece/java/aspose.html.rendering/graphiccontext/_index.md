---
title: "GraphicContext Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.rendering.GraphicContext κλάση. Διατηρεί τρέχουσες παραμέτρους ελέγχου γραφικών. Αυτές οι παράμετροι ορίζουν το παγκόσμιο πλαίσιο μέσα στο οποίο εκτελούνται οι τελεστές γραφικών."
type: docs

url: /el/java/com.aspose.html.rendering/graphiccontext/
---
## GraphicContext class

Διατηρεί τρέχοντες παραμέτρους ελέγχου γραφικών. Αυτές οι παράμετροι ορίζουν το παγκόσμιο πλαίσιο μέσα στο οποίο εκτελούνται οι τελεστές γραφικών.
...
| [getTextInfo](../../com.aspose.html.rendering/graphiccontext/textinfo/) Λαμβάνει ένα αντικείμενο [`TextInfo`](../textinfo/) που περιέχει πληροφορίες σχετικά με το αποδομένο κείμενο. |
