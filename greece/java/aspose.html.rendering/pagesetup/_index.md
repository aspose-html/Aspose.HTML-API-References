...
description: "com.aspose.html.rendering.PageSetup κλάση. Αντιπροσωπεύει ένα αντικείμενο ρύθμισης σελίδας που χρησιμοποιείται για τη διαμόρφωση του εξόδου page-set."
type: docs
...
| [getLeftPage](../../com.aspose.html.rendering/pagesetup/leftpage/) Λαμβάνει τη ρύθμιση Odd Page. |
...
| [getRightPage](../../com.aspose.html.rendering/pagesetup/rightpage/) Λαμβάνει τη ρύθμιση Even Page. |

## Μέθοδοι

| Όνομα | Περιγραφή |
| --- | --- |
| [setLeftRightPage](../../com.aspose.html.rendering/pagesetup/setleftrightpage/)(Page, Page) | Ορίζει τη ρύθμιση σελίδας Left/Right. |
