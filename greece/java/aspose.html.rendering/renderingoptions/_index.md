---
title: "RenderingOptions Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.rendering.RenderingOptions κλάση. Αντιπροσωπεύει επιλογές απόδοσης"
type: docs

url: /el/java/com.aspose.html.rendering/renderingoptions/
---
## RenderingOptions class

Αναπαριστά τις επιλογές απόδοσης.
...
| Όνομα | Περιγραφή |
| --- | --- |
| [RenderingOptions](renderingoptions/)() | Αρχικοποιεί μια νέα παρουσία της κλάσης `RenderingOptions`. |
...
| [getCss](../../com.aspose.html.rendering/renderingoptions/css/) Λαμβάνει ένα αντικείμενο [`CssOptions`](../cssoptions/) το οποίο χρησιμοποιείται για τη ρύθμιση της επεξεργασίας ιδιοτήτων css. |
