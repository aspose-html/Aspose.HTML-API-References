---
title: "ImageDevice Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.rendering.image.ImageDevice κλάση. Αντιπροσωπεύει την απόδοση σε μορφές raster όπως jpeg, png, bmp, gif, tiff."
type: docs
...
| Όνομα | Περιγραφή |
| --- | --- |
| class [ImageGraphicContext](../../com.aspose.html.rendering.image/imagedevice.imagegraphiccontext) | Κρατά τρέχουσες παραμέτρους ελέγχου γραφικών για το `ImageDevice`. Αυτές οι παράμετροι ορίζουν το παγκόσμιο πλαίσιο μέσα στο οποίο εκτελούνται οι τελεστές γραφικών. |
