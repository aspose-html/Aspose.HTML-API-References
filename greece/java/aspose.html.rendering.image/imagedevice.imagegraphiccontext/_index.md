...
description: "com.aspose.html.rendering.image.ImageDeviceImageGraphicContext κλάση. Διατηρεί τρέχουσες παραμέτρους ελέγχου γραφικών για το ImageDevice. Αυτές οι παράμετροι ορίζουν το παγκόσμιο πλαίσιο μέσα στο οποίο εκτελούνται οι λειτουργίες γραφικών."
type: docs
...
Διατηρεί τρέχουσες παραμέτρους ελέγχου γραφικών για το [`ImageDevice`](../imagedevice/). Αυτές οι παράμετροι ορίζουν το παγκόσμιο πλαίσιο μέσα στο οποίο εκτελούνται οι λειτουργίες γραφικών.
