...
description: "SVGPathSegLinetoHorizontalRel ιδιότητα. Η σχετική συντεταγμένη X για το τελικό σημείο αυτού του τμήματος διαδρομής"
type: docs

url: /el/java/com.aspose.html.dom.svg.paths/svgpathseglinetohorizontalrel/x/
---
