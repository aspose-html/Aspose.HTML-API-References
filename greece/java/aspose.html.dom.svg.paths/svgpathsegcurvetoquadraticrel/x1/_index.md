...
description: "SVGPathSegCurvetoQuadraticRel property. Η σχετική συντεταγμένη X για το πρώτο σημείο ελέγχου"
type: docs

url: /el/java/com.aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticrel/x1/
---
## SVGPathSegCurvetoQuadraticRel.X1 property

Η σχετική συντεταγμένη X για το πρώτο σημείο ελέγχου.
