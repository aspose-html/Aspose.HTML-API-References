---
title: "PdfDocumentInfo Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.rendering.pdf.PdfDocumentInfo κλάση. Αναπαριστά τις πληροφορίες για το έγγραφο PDF"
type: docs

url: /el/java/com.aspose.html.rendering.pdf/pdfdocumentinfo/
---
## PdfDocumentInfo class

Αντιπροσωπεύει τις πληροφορίες σχετικά με το PDF έγγραφο.
