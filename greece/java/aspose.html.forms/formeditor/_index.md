...
description: "Η κλάση com.aspose.html.forms.FormEditor. Αυτή η κλάση αντιπροσωπεύει τον επεξεργαστή πάνω στο HTMLFormElement που δημιουργεί έναν πιο εύκολο τρόπο για προγραμματιστές .net να επεξεργάζονται τις φόρμες HTML."
type: docs
...
Αυτή η κλάση αντιπροσωπεύει τον επεξεργαστή πάνω στο [`HTMLFormElement`](../../com.aspose.html/htmlformelement/) που δημιουργεί έναν πιο εύκολο τρόπο για προγραμματιστές .net να επεξεργάζονται τις φόρμες HTML.
...
| [getForm](../../com.aspose.html.forms/formeditor/form/) Το αρχικό [`HTMLFormElement`](../../com.aspose.html/htmlformelement/) που είναι συσχετισμένο με την τρέχουσα παρουσία του `FormEditor`. |
| [getItem](../../com.aspose.html.forms/formeditor/item/) Επιστρέφει το στοιχείο με το συγκεκριμένο δείκτη. (2 δείκτες) |
[getMethod]
...
| [GetElement&lt;T&gt;](../../com.aspose.html.forms/formeditor/getelement/#getelement)(int) | Επιστρέφει το στοιχείο με το συγκεκριμένο δείκτη. |
| [GetElement&lt;T&gt;](../../com.aspose.html.forms/formeditor/getelement/#getelement_1)(String) | Επιστρέφει το στοιχείο με το συγκεκριμένο όνομα. |
