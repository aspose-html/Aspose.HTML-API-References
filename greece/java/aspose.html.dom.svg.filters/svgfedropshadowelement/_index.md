...
description: "com.aspose.html.dom.svg.filters.SVGFEDropShadowElement class. Η διεπαφή SVGFEDropShadowElement αντιστοιχεί στο στοιχείο feDropShadow"
type: docs
...
| [getStdDeviationX](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/stddeviationx/) Αντιστοιχεί στο χαρακτηριστικό ‘stdDeviation’ του δεδομένου στοιχείου ‘feDropShadow’. Περιέχει το συστατικό X του χαρακτηριστικού ‘stdDeviation’. |
| [getStdDeviationY](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/stddeviationy/) Αντιστοιχεί στο χαρακτηριστικό ‘stdDeviation’ του δεδομένου στοιχείου ‘feDropShadow’. Περιέχει το συστατικό Y (ενδεχομένως υπολογιζόμενο αυτόματα) του χαρακτηριστικού ‘stdDeviation’. |
