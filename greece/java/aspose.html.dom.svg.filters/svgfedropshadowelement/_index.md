---
title: "SVGFEDropShadowElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.dom.svg.filters.SVGFEDropShadowElement κλάση. Η διεπαφή SVGFEDropShadowElement αντιστοιχεί στο στοιχείο feDropShadow."
type: docs

url: /el/java/com.aspose.html.dom.svg.filters/svgfedropshadowelement/
---
...
| [getDx](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/dx/) Αντιστοιχεί στο χαρακτηριστικό ‘dx’ του δεδομένου στοιχείου ‘feDropShadow’. |
| [getDy](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/dy/) Αντιστοιχεί στο χαρακτηριστικό ‘dy’ του δεδομένου στοιχείου ‘feDropShadow’. |
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/height/) Αντιστοιχεί στο χαρακτηριστικό ‘height’ του δεδομένου στοιχείου ‘feDropShadow’. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/in1/) Αντιστοιχεί στο χαρακτηριστικό ‘in’ του δεδομένου στοιχείου ‘feDropShadow’. |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/result/) Αντιστοιχεί στο χαρακτηριστικό ‘result’ του δεδομένου στοιχείου ‘feDropShadow’. |
...
| [getStdDeviationX](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/stddeviationx/) Αντιστοιχεί στο χαρακτηριστικό ‘stdDeviation’ του δεδομένου στοιχείου ‘feDropShadow’. Περιέχει το X συστατικό του χαρακτηριστικού ‘stdDeviation’. |
| [getStdDeviationY](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/stddeviationy/) Αντιστοιχεί στο χαρακτηριστικό ‘stdDeviation’ του δεδομένου στοιχείου ‘feDropShadow’. Περιέχει το Y συστατικό (πιθανώς υπολογιζόμενο αυτόματα) του χαρακτηριστικού ‘stdDeviation’. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/width/) Αντιστοιχεί στο χαρακτηριστικό ‘width’ του δεδομένου στοιχείου ‘feDropShadow’. |
| [X](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘x’ του δεδομένου στοιχείου ‘feDropShadow’. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘y’ του δεδομένου στοιχείου ‘feDropShadow’. |
...
| [setStdDeviation](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/setstddeviation/)(float, float) | Ορίζει τις τιμές για το χαρακτηριστικό ‘stdDeviation’. |
