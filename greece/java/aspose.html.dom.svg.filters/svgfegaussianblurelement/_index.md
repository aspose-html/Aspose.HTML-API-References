---
title: "SVGFEGaussianBlurElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.dom.svg.filters.SVGFEGaussianBlurElement κλάση. Η SVGFEGaussianBlurElement διεπαφή αντιστοιχεί στο στοιχείο feGaussianBlur"
type: docs
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/height/) Αντιστοιχεί στο χαρακτηριστικό �height� του δεδομένου �filter� στοιχείου. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/in1/) Αντιστοιχεί στο χαρακτηριστικό �in� του δεδομένου �feGaussianBlur� στοιχείου. |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/result/) Αντιστοιχεί στο χαρακτηριστικό �result� του δεδομένου �filter� στοιχείου. |
...
| [getStdDeviationX](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/stddeviationx/) Αντιστοιχεί στο χαρακτηριστικό �stdDeviation� του δεδομένου �feGaussianBlur� στοιχείου. Περιέχει το X συστατικό του χαρακτηριστικού �stdDeviation�. |
| [getStdDeviationY](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/stddeviationy/) Αντιστοιχεί στο χαρακτηριστικό �stdDeviation� του δεδομένου �feGaussianBlur� στοιχείου. Περιέχει το Y συστατικό (ενδεχομένως υπολογιζόμενο αυτόματα) του χαρακτηριστικού �stdDeviation�. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/width/) Αντιστοιχεί στο χαρακτηριστικό �width� του δεδομένου �filter� στοιχείου. |
| [X](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό �x� του δεδομένου �filter� στοιχείου. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό �y� του δεδομένου �filter� στοιχείου. |
