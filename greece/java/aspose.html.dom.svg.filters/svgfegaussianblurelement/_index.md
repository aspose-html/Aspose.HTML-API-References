---
title: "Κλάση SVGFEGaussianBlurElement"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.dom.svg.filters.SVGFEGaussianBlurElement κλάση. Η διεπαφή SVGFEGaussianBlurElement αντιστοιχεί στο στοιχείο feGaussianBlur"
type: docs

url: /el/java/com.aspose.html.dom.svg.filters/svgfegaussianblurelement/
---
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/height/) Αντιστοιχεί στο χαρακτηριστικό �height� στο δοσμένο �filter� στοιχείο. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/in1/) Αντιστοιχεί στο χαρακτηριστικό �in� στο δοσμένο �feGaussianBlur� στοιχείο. |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/result/) Αντιστοιχεί στο χαρακτηριστικό �result� στο δοσμένο �filter� στοιχείο. |
...
| [getStdDeviationX](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/stddeviationx/) Αντιστοιχεί στο χαρακτηριστικό �stdDeviation� στο δοσμένο �feGaussianBlur� στοιχείο. Περιέχει το συστατικό X του χαρακτηριστικού �stdDeviation�. |
| [getStdDeviationY](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/stddeviationy/) Αντιστοιχεί στο χαρακτηριστικό �stdDeviation� στο δοσμένο �feGaussianBlur� στοιχείο. Περιέχει το συστατικό Y (ενδεχομένως υπολογιζόμενο αυτόματα) του χαρακτηριστικού �stdDeviation�. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/width/) Αντιστοιχεί στο χαρακτηριστικό �width� στο δοσμένο �filter� στοιχείο. |
| [X](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό �x� στο δοσμένο �filter� στοιχείο. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό �y� στο δοσμένο �filter� στοιχείο. |
...
| [setStdDeviation](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/setstddeviation/)(float, float) | Ορίζει τις τιμές για το χαρακτηριστικό �stdDeviation�. |
