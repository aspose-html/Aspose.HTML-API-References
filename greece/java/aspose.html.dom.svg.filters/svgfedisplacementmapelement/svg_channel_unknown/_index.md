...
description: "Πεδίο SVGFEDisplacementMapElement. Ο τύπος δεν είναι ένας από τους προ-ορισμένους τύπους. Είναι άκυρο να προσπαθήσετε να ορίσετε μια νέα τιμή αυτού του τύπου ή να προσπαθήσετε να μετατρέψετε μια υπάρχουσα τιμή σε αυτόν τον τύπο."
type: docs

url: /el/java/com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_unknown/
---
