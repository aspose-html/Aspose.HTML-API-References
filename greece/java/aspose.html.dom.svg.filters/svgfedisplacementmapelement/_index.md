---
title: "Κλάση SVGFEDisplacementMapElement"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.dom.svg.filters.SVGFEDisplacementMapElement κλάση. Η διεπαφή SVGFEDisplacementMapElement αντιστοιχεί στο στοιχείο feDisplacementMap"
type: docs

url: /el/java/com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/
---
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/height/) Αντιστοιχεί στο χαρακτηριστικό ‘height’ στο δοσμένο στοιχείο ‘filter’. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/in1/) Αντιστοιχεί στο χαρακτηριστικό ‘in’ στο δοσμένο στοιχείο ‘feDisplacementMap’. |
| [getIn2](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/in2/) Αντιστοιχεί στο χαρακτηριστικό ‘in2’ στο δοσμένο στοιχείο ‘feDisplacementMap’. |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/result/) Αντιστοιχεί στο χαρακτηριστικό ‘result’ στο δοσμένο στοιχείο ‘filter’. |
| [getScale](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/scale/) Αντιστοιχεί στο χαρακτηριστικό ‘scale’ στο δοσμένο στοιχείο ‘feDisplacementMap’. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/width/) Αντιστοιχεί στο χαρακτηριστικό ‘width’ στο δοσμένο στοιχείο ‘filter’. |
| [X](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/x/) { get; } | Corresponds to attribute ‘x’ on the given ‘filter’ element. Αντιστοιχεί στο χαρακτηριστικό ‘x’ του δοσμένου στοιχείου ‘filter’. |
| [getXChannelSelector](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/xchannelselector/) Αντιστοιχεί στο χαρακτηριστικό ‘xChannelSelector’ στο δοσμένο στοιχείο ‘feDisplacementMap’. Δέχεται μία από τις σταθερές SVG_CHANNEL_* που ορίζονται σε αυτή τη διεπαφή. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/y/) { get; } | Corresponds to attribute ‘y’ on the given ‘filter’ element. Αντιστοιχεί στο χαρακτηριστικό ‘y’ του δοσμένου στοιχείου ‘filter’. |
| [getYChannelSelector](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/ychannelselector/) Αντιστοιχεί στο χαρακτηριστικό ‘yChannelSelector’ του δεδομένου στοιχείου ‘feDisplacementMap’. Παίρνει μία από τις σταθερές SVG_CHANNEL_* που ορίζονται σε αυτή τη διεπαφή. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| const [SVG_CHANNEL_A](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_a/) | Αντιστοιχεί στην τιμή 'A'. |
| const [SVG_CHANNEL_B](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_b/) | Αντιστοιχεί στην τιμή 'B'. |
| const [SVG_CHANNEL_G](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_g/) | Αντιστοιχεί στην τιμή 'G'. |
| const [SVG_CHANNEL_R](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_r/) | Αντιστοιχεί στην τιμή 'R'. |
| const [SVG_CHANNEL_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_unknown/) | Ο τύπος δεν είναι ένας από τους προκαθορισμένους τύπους. Είναι μη έγκυρο να προσπαθήσετε να ορίσετε μια νέα τιμή αυτού του τύπου ή να προσπαθήσετε να αλλάξετε μια υπάρχουσα τιμή σε αυτόν τον τύπο. |
