---
title: "Κλάση SVGFEComponentTransferElement"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "κλάση com.aspose.html.dom.svg.filters.SVGFEComponentTransferElement. Η διεπαφή SVGFEComponentTransferElement αντιστοιχεί στο στοιχείο feComponentTransfer."
type: docs
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfecomponenttransferelement/height/) Αντιστοιχεί στο χαρακτηριστικό ‘height’ του δεδομένου στοιχείου ‘filter’. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfecomponenttransferelement/in1/) Αντιστοιχεί στο χαρακτηριστικό ‘in’ του δεδομένου στοιχείου ‘feComponentTransfer’. |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfecomponenttransferelement/result/) Αντιστοιχεί στο χαρακτηριστικό ‘result’ του δεδομένου στοιχείου ‘filter’. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfecomponenttransferelement/width/) Αντιστοιχεί στο χαρακτηριστικό ‘width’ του δεδομένου στοιχείου ‘filter’. |
| [X](../../com.aspose.html.dom.svg.filters/svgfecomponenttransferelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘x’ του δοσμένου στοιχείου ‘filter’. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfecomponenttransferelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘y’ του δοσμένου στοιχείου ‘filter’. |
