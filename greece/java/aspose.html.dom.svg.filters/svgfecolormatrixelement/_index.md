---
title: "Κλάση SVGFEColorMatrixElement"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "κλάση com.aspose.html.dom.svg.filters.SVGFEColorMatrixElement. Η διεπαφή SVGFEColorMatrixElement αντιστοιχεί στο στοιχείο feColorMatrix."
type: docs

url: /el/java/com.aspose.html.dom.svg.filters/svgfecolormatrixelement/
---
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/height/) Αντιστοιχεί στο attribute ‘height’ στο δεδομένο στοιχείο ‘filter’. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/in1/) Αντιστοιχεί στο attribute ‘in’ στο δεδομένο στοιχείο ‘feColorMatrix’. |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/result/) Αντιστοιχεί στο attribute ‘result’ στο δεδομένο στοιχείο ‘filter’. |
...
| [getType](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/type/) Αντιστοιχεί στο attribute ‘type’ στο δεδομένο στοιχείο ‘feColorMatrix’. Παίρνει μία από τις σταθερές SVG_FECOLORMATRIX_TYPE_* που ορίζονται σε αυτή τη διεπαφή. |
| [getValues](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/values/) Αντιστοιχεί στο attribute ‘values’ στο δεδομένο στοιχείο ‘feColorMatrix’. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/width/) Αντιστοιχεί στο attribute ‘width’ στο δεδομένο στοιχείο ‘filter’. |
| [X](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/x/) { get; } | Corresponds to attribute ‘x’ on the given ‘filter’ element. Αντιστοιχεί στο χαρακτηριστικό ‘x’ του δοσμένου στοιχείου ‘filter’. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/y/) { get; } | Corresponds to attribute ‘y’ on the given ‘filter’ element. Αντιστοιχεί στο χαρακτηριστικό ‘y’ του δοσμένου στοιχείου ‘filter’. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| const [SVG_FECOLORMATRIX_TYPE_HUEROTATE](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_huerotate/) | Αντιστοιχεί στην τιμή 'hueRotate'. |
| const [SVG_FECOLORMATRIX_TYPE_LUMINANCETOALPHA](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_luminancetoalpha/) | Αντιστοιχεί στην τιμή 'luminanceToAlpha'. |
| const [SVG_FECOLORMATRIX_TYPE_MATRIX](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_matrix/) | Αντιστοιχεί στην τιμή 'matrix'. |
| const [SVG_FECOLORMATRIX_TYPE_SATURATE](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_saturate/) | Αντιστοιχεί στην τιμή 'saturate'. |
| const [SVG_FECOLORMATRIX_TYPE_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_unknown/) | Ο τύπος δεν είναι ένας από τους προκαθορισμένους τύπους. Είναι μη έγκυρο να προσπαθήσετε να ορίσετε μια νέα τιμή αυτού του τύπου ή να προσπαθήσετε να αλλάξετε μια υπάρχουσα τιμή σε αυτόν τον τύπο. |
