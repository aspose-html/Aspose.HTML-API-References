...
description: "κλάση com.aspose.html.dom.svg.filters.SVGFEColorMatrixElement. Το interface SVGFEColorMatrixElement αντιστοιχεί στο στοιχείο feColorMatrix."
type: docs
...
| [getType](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/type/) Αντιστοιχεί στο attribute ‘type’ στο δεδομένο στοιχείο ‘feColorMatrix’. Παίρνει μία από τις σταθερές SVG_FECOLORMATRIX_TYPE_* που ορίζονται σε αυτό το interface. |
...
| [X](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘x’ του δοσμένου στοιχείου ‘filter’. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘y’ του δοσμένου στοιχείου ‘filter’. |
...
| const [SVG_FECOLORMATRIX_TYPE_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_unknown/) | Ο τύπος δεν είναι ένας από τους προκαθορισμένους τύπους. Είναι άκυρο να προσπαθήσετε να ορίσετε μια νέα τιμή αυτού του τύπου ή να προσπαθήσετε να αλλάξετε μια υπάρχουσα τιμή σε αυτόν τον τύπο. |
