---
title: "SVGFEDiffuseLightingElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.dom.svg.filters.SVGFEDiffuseLightingElement κλάση. Η διεπαφή SVGFEDiffuseLightingElement αντιστοιχεί στο στοιχείο feDiffuseLighting."
type: docs

url: /el/java/com.aspose.html.dom.svg.filters/svgfediffuselightingelement/
---
...
| [getDiffuseConstant](../../com.aspose.html.dom.svg.filters/svgfediffuselightingelement/diffuseconstant/) Αντιστοιχεί στο χαρακτηριστικό ‘diffuseConstant’ στο δεδομένο στοιχείο ‘feDiffuseLighting’. |
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfediffuselightingelement/height/) Αντιστοιχεί στο χαρακτηριστικό ‘height’ στο δεδομένο στοιχείο ‘filter’. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfediffuselightingelement/in1/) Αντιστοιχεί στο χαρακτηριστικό ‘in’ στο δεδομένο στοιχείο ‘feDiffuseLighting’. |
[getInnerHTML]
...
| [getKernelUnitLengthX](../../com.aspose.html.dom.svg.filters/svgfediffuselightingelement/kernelunitlengthx/) Αντιστοιχεί στο χαρακτηριστικό ‘kernelUnitLength’ στο δεδομένο στοιχείο ‘feDiffuseLighting’. |
| [getKernelUnitLengthY](../../com.aspose.html.dom.svg.filters/svgfediffuselightingelement/kernelunitlengthy/) Αντιστοιχεί στο χαρακτηριστικό ‘kernelUnitLength’ στο δεδομένο στοιχείο ‘feDiffuseLighting’. |
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfediffuselightingelement/result/) Αντιστοιχεί στο χαρακτηριστικό ‘result’ στο δεδομένο στοιχείο ‘filter’. |
...
| [getSurfaceScale](../../com.aspose.html.dom.svg.filters/svgfediffuselightingelement/surfacescale/) Αντιστοιχεί στο χαρακτηριστικό ‘surfaceScale’ στο δεδομένο στοιχείο ‘feDiffuseLighting’. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfediffuselightingelement/width/) Αντιστοιχεί στο χαρακτηριστικό ‘width’ στο δεδομένο στοιχείο ‘filter’. |
| [X](../../com.aspose.html.dom.svg.filters/svgfediffuselightingelement/x/) { get; } | Corresponds to attribute ‘x’ on the given ‘filter’ element. Αντιστοιχεί στο χαρακτηριστικό ‘x’ του δοσμένου στοιχείου ‘filter’. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfediffuselightingelement/y/) { get; } | Corresponds to attribute ‘y’ on the given ‘filter’ element. Αντιστοιχεί στο χαρακτηριστικό ‘y’ του δοσμένου στοιχείου ‘filter’. |
