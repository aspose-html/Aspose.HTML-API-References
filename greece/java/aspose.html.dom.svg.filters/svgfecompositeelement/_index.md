---
title: "Κλάση SVGFECompositeElement"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "κλάση com.aspose.html.dom.svg.filters.SVGFECompositeElement. Η διεπαφή SVGFECompositeElement αντιστοιχεί στο στοιχείο feComposite."
type: docs
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/height/) Αντιστοιχεί στο χαρακτηριστικό ‘height’ του δεδομένου στοιχείου ‘filter’. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/in1/) Αντιστοιχεί στο χαρακτηριστικό ‘in’ του δεδομένου στοιχείου ‘feComposite’. |
| [getIn2](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/in2/) Αντιστοιχεί στο χαρακτηριστικό ‘in2’ του δεδομένου στοιχείου ‘feComposite’. |
[getInnerHTML]
...
| [getK1](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k1/) Αντιστοιχεί στο χαρακτηριστικό ‘k1’ του δεδομένου στοιχείου ‘feComposite’. |
| [getK2](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k2/) Αντιστοιχεί στο χαρακτηριστικό ‘k2’ του δεδομένου στοιχείου ‘feComposite’. |
| [getK3](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k3/) Αντιστοιχεί στο χαρακτηριστικό ‘k3’ του δεδομένου στοιχείου ‘feComposite’. |
| [getK4](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k4/) Αντιστοιχεί στο χαρακτηριστικό ‘k4’ του δεδομένου στοιχείου ‘feComposite’. |
...
| [getOperator](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/operator/) Αντιστοιχεί στο χαρακτηριστικό ‘operator’ του δεδομένου στοιχείου ‘feComposite’. Παίρνει μία από τις σταθερές SVG_FECOMPOSITE_OPERATOR_* που ορίζονται σε αυτή τη διεπαφή. |
[getOuterHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/result/) Αντιστοιχεί στο χαρακτηριστικό ‘result’ του δεδομένου στοιχείου ‘filter’. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/width/) Αντιστοιχεί στο χαρακτηριστικό ‘width’ του δεδομένου στοιχείου ‘filter’. |
| [X](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘x’ του δοσμένου στοιχείου ‘filter’. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘y’ του δοσμένου στοιχείου ‘filter’. |
...
| const [SVG_FECOMPOSITE_OPERATOR_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_unknown/) | Ο τύπος δεν είναι ένας από τους προκαθορισμένους τύπους. Είναι άκυρο να προσπαθήσετε να ορίσετε μια νέα τιμή αυτού του τύπου ή να προσπαθήσετε να αλλάξετε μια υπάρχουσα τιμή σε αυτόν τον τύπο. |
