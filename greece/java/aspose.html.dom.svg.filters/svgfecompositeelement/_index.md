---
title: "SVGFECompositeElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.dom.svg.filters.SVGFECompositeElement κλάση. Η διεπαφή SVGFECompositeElement αντιστοιχεί στο στοιχείο feComposite."
type: docs

url: /el/java/com.aspose.html.dom.svg.filters/svgfecompositeelement/
---
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/height/) Αντιστοιχεί στο χαρακτηριστικό ‘height’ στο δεδομένο στοιχείο ‘filter’. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/in1/) Αντιστοιχεί στο χαρακτηριστικό ‘in’ στο δεδομένο στοιχείο ‘feComposite’. |
| [getIn2](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/in2/) Αντιστοιχεί στο χαρακτηριστικό ‘in2’ στο δεδομένο στοιχείο ‘feComposite’. |
[getInnerHTML]
...
| [getK1](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k1/) Αντιστοιχεί στο χαρακτηριστικό ‘k1’ στο δεδομένο στοιχείο ‘feComposite’. |
| [getK2](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k2/) Αντιστοιχεί στο χαρακτηριστικό ‘k2’ στο δεδομένο στοιχείο ‘feComposite’. |
| [getK3](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k3/) Αντιστοιχεί στο χαρακτηριστικό ‘k3’ στο δεδομένο στοιχείο ‘feComposite’. |
| [getK4](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k4/) Αντιστοιχεί στο χαρακτηριστικό ‘k4’ στο δεδομένο στοιχείο ‘feComposite’. |
...
| [getOperator](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/operator/) Αντιστοιχεί στο χαρακτηριστικό ‘operator’ στο δεδομένο στοιχείο ‘feComposite’. Παίρνει μία από τις σταθερές SVG_FECOMPOSITE_OPERATOR_* που ορίζονται σε αυτή τη διεπαφή. |
[getOuterHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/result/) Αντιστοιχεί στο χαρακτηριστικό ‘result’ στο δεδομένο στοιχείο ‘filter’. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/width/) Αντιστοιχεί στο χαρακτηριστικό ‘width’ στο δεδομένο στοιχείο ‘filter’. |
| [X](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/x/) { get; } | Corresponds to attribute ‘x’ on the given ‘filter’ element. Αντιστοιχεί στο χαρακτηριστικό ‘x’ του δοσμένου στοιχείου ‘filter’. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/y/) { get; } | Corresponds to attribute ‘y’ on the given ‘filter’ element. Αντιστοιχεί στο χαρακτηριστικό ‘y’ του δοσμένου στοιχείου ‘filter’. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| const [SVG_FECOMPOSITE_OPERATOR_ARITHMETIC](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_arithmetic/) | Αντιστοιχεί στην τιμή 'arithmetic'. |
| const [SVG_FECOMPOSITE_OPERATOR_ATOP](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_atop/) | Αντιστοιχεί στην τιμή 'atop'. |
| const [SVG_FECOMPOSITE_OPERATOR_IN](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_in/) | Αντιστοιχεί στην τιμή 'in'. |
| const [SVG_FECOMPOSITE_OPERATOR_OUT](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_out/) | Αντιστοιχεί στην τιμή 'out'. |
| const [SVG_FECOMPOSITE_OPERATOR_OVER](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_over/) | Αντιστοιχεί στην τιμή 'over'. |
| const [SVG_FECOMPOSITE_OPERATOR_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_unknown/) | Ο τύπος δεν είναι ένας από τους προκαθορισμένους τύπους. Είναι μη έγκυρο να προσπαθήσετε να ορίσετε μια νέα τιμή αυτού του τύπου ή να προσπαθήσετε να αλλάξετε μια υπάρχουσα τιμή σε αυτόν τον τύπο. |
| const [SVG_FECOMPOSITE_OPERATOR_XOR](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_xor/) | Αντιστοιχεί στην τιμή 'xor'. |
