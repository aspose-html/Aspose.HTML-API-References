...
description: "com.aspose.html.dom.svg.filters.SVGFEFloodElement κλάση. Η SVGFEFloodElement διεπαφή αντιστοιχεί στο στοιχείο feFlood"
type: docs
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfefloodelement/height/) Αντιστοιχεί στο χαρακτηριστικό ‘height’ του δεδομένου στοιχείου ‘filter’. |
[getId]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfefloodelement/result/) Αντιστοιχεί στο χαρακτηριστικό ‘result’ του δεδομένου στοιχείου ‘filter’. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfefloodelement/width/) Αντιστοιχεί στο χαρακτηριστικό ‘width’ του δεδομένου στοιχείου ‘filter’. |
| [X](../../com.aspose.html.dom.svg.filters/svgfefloodelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘x’ του δοσμένου στοιχείου ‘filter’. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfefloodelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘y’ του δοσμένου στοιχείου ‘filter’. |
