---
title: "Κλάση SVGFEFloodElement"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.dom.svg.filters.SVGFEFloodElement κλάση. Η διεπαφή SVGFEFloodElement αντιστοιχεί στο στοιχείο feFlood"
type: docs

url: /el/java/com.aspose.html.dom.svg.filters/svgfefloodelement/
---
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfefloodelement/height/) Αντιστοιχεί στο χαρακτηριστικό ‘height’ στο δοσμένο στοιχείο ‘filter’. |
[getId]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfefloodelement/result/) Αντιστοιχεί στο χαρακτηριστικό ‘result’ στο δοσμένο στοιχείο ‘filter’. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfefloodelement/width/) Αντιστοιχεί στο χαρακτηριστικό ‘width’ στο δοσμένο στοιχείο ‘filter’. |
| [X](../../com.aspose.html.dom.svg.filters/svgfefloodelement/x/) { get; } | Corresponds to attribute ‘x’ on the given ‘filter’ element. Αντιστοιχεί στο χαρακτηριστικό ‘x’ του δοσμένου στοιχείου ‘filter’. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfefloodelement/y/) { get; } | Corresponds to attribute ‘y’ on the given ‘filter’ element. Αντιστοιχεί στο χαρακτηριστικό ‘y’ του δοσμένου στοιχείου ‘filter’. |
