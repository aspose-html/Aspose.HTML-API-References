---
title: "SVGFEOffsetElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.dom.svg.filters.SVGFEOffsetElement κλάση. Η διεπαφή SVGFEOffsetElement αντιστοιχεί στο στοιχείο feOffset"
type: docs

url: /el/java/com.aspose.html.dom.svg.filters/svgfeoffsetelement/
---
...
| [getDx](../../com.aspose.html.dom.svg.filters/svgfeoffsetelement/dx/) Αντιστοιχεί στο χαρακτηριστικό ‘dx’ του δεδομένου στοιχείου ‘feOffset’. |
| [getDy](../../com.aspose.html.dom.svg.filters/svgfeoffsetelement/dy/) Αντιστοιχεί στο χαρακτηριστικό ‘dy’ του δεδομένου στοιχείου ‘feOffset’. |
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfeoffsetelement/height/) Αντιστοιχεί στο χαρακτηριστικό ‘height’ του δεδομένου στοιχείου ‘filter’. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfeoffsetelement/in1/) Αντιστοιχεί στο χαρακτηριστικό ‘in’ του δεδομένου στοιχείου ‘feOffset’. |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfeoffsetelement/result/) Αντιστοιχεί στο χαρακτηριστικό ‘result’ του δεδομένου στοιχείου ‘filter’. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfeoffsetelement/width/) Αντιστοιχεί στο χαρακτηριστικό ‘width’ του δεδομένου στοιχείου ‘filter’. |
| [X](../../com.aspose.html.dom.svg.filters/svgfeoffsetelement/x/) { get; } | Corresponds to attribute ‘x’ on the given ‘filter’ element. Αντιστοιχεί στο χαρακτηριστικό ‘x’ του δοσμένου στοιχείου ‘filter’. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfeoffsetelement/y/) { get; } | Corresponds to attribute ‘y’ on the given ‘filter’ element. Αντιστοιχεί στο χαρακτηριστικό ‘y’ του δοσμένου στοιχείου ‘filter’. |
