...
| [getBaseFrequencyX](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/basefrequencyx/) Αντιστοιχεί στο χαρακτηριστικό ‘baseFrequency’ στο δοσμένο στοιχείο ‘feTurbulence’. Περιέχει το συστατικό X του χαρακτηριστικού ‘baseFrequency’. |
| [getBaseFrequencyY](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/basefrequencyy/) Αντιστοιχεί στο χαρακτηριστικό ‘baseFrequency’ στο δοσμένο στοιχείο ‘feTurbulence’. Περιέχει το συστατικό Y του (ενδεχομένως υπολογιζόμενου αυτόματα) χαρακτηριστικού ‘baseFrequency’. |
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/height/) Αντιστοιχεί στο χαρακτηριστικό ‘height’ στο δοσμένο στοιχείο ‘filter’. |
[getId]
...
| [getNumOctaves](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/numoctaves/) Αντιστοιχεί στο χαρακτηριστικό ‘numOctaves’ στο δοσμένο στοιχείο ‘feTurbulence’. |
[getOuterHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/result/) Αντιστοιχεί στο χαρακτηριστικό ‘result’ στο δοσμένο στοιχείο ‘filter’. |
| [getSeed](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/seed/) Αντιστοιχεί στο χαρακτηριστικό ‘seed’ στο δοσμένο στοιχείο ‘feTurbulence’. |
...
| [getStitchTiles](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/stitchtiles/) Αντιστοιχεί στο χαρακτηριστικό ‘stitchTiles’ στο δοσμένο στοιχείο ‘feTurbulence’. Παίρνει μία από τις σταθερές SVG_STITCHTYPE_* που ορίζονται σε αυτή τη διεπαφή. |
...
| [getType](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/type/) Αντιστοιχεί στο χαρακτηριστικό ‘type’ στο δοσμένο στοιχείο ‘feTurbulence’. Παίρνει μία από τις σταθερές SVG_TURBULENCE_TYPE_* που ορίζονται σε αυτή τη διεπαφή. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/width/) Αντιστοιχεί στο χαρακτηριστικό ‘width’ στο δοσμένο στοιχείο ‘filter’. |
| [X](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘x’ του δοσμένου στοιχείου ‘filter’. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘y’ του δοσμένου στοιχείου ‘filter’. |
...
| const [SVG_STITCHTYPE_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_stitchtype_unknown/) | Ο τύπος δεν είναι ένας από τους προκαθορισμένους τύπους. Είναι άκυρο να προσπαθήσετε να ορίσετε μια νέα τιμή αυτού του τύπου ή να προσπαθήσετε να αλλάξετε μια υπάρχουσα τιμή σε αυτόν τον τύπο. |
