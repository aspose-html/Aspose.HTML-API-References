---
title: "SVGFEConvolveMatrixElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.dom.svg.filters.SVGFEConvolveMatrixElement κλάση. Η διεπαφή SVGFEConvolveMatrixElement αντιστοιχεί στο στοιχείο feConvolveMatrix."
type: docs

url: /el/java/com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/
---
...
| [getBias](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/bias/) Αντιστοιχεί στο χαρακτηριστικό ‘bias’ στο δεδομένο στοιχείο ‘feConvolveMatrix’. |
...
| [getDivisor](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/divisor/) Αντιστοιχεί στο χαρακτηριστικό ‘divisor’ στο δεδομένο στοιχείο ‘feConvolveMatrix’. |
| [getEdgeMode](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/edgemode/) Αντιστοιχεί στο χαρακτηριστικό ‘edgeMode’ στο δεδομένο στοιχείο ‘feConvolveMatrix’. |
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/height/) Αντιστοιχεί στο χαρακτηριστικό ‘height’ στο δεδομένο στοιχείο ‘filter’. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/in1/) Αντιστοιχεί στο χαρακτηριστικό ‘in’ στο δεδομένο στοιχείο ‘feConvolveMatrix’. |
[getInnerHTML]
...
| [getKernelMatrix](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelmatrix/) Αντιστοιχεί στο χαρακτηριστικό ‘kernelMatrix’ στο δεδομένο στοιχείο ‘feConvolveMatrix’. |
| [getKernelUnitLengthX](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelunitlengthx/) Αντιστοιχεί στο χαρακτηριστικό ‘kernelUnitLength’ στο δεδομένο στοιχείο ‘feConvolveMatrix’. |
| [getKernelUnitLengthY](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelunitlengthy/) Αντιστοιχεί στο χαρακτηριστικό ‘kernelUnitLength’ στο δεδομένο στοιχείο ‘feConvolveMatrix’. |
...
| [getOrderX](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/orderx/) Αντιστοιχεί στο χαρακτηριστικό ‘order’ στο δεδομένο στοιχείο ‘feConvolveMatrix’. |
| [getOrderY](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/ordery/) Αντιστοιχεί στο χαρακτηριστικό ‘order’ στο δεδομένο στοιχείο ‘feConvolveMatrix’. |
[getOuterHTML]
...
| [getPreserveAlpha](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/preservealpha/) Αντιστοιχεί στο χαρακτηριστικό ‘preserveAlpha’ στο δεδομένο στοιχείο ‘feConvolveMatrix’. |
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/result/) Αντιστοιχεί στο χαρακτηριστικό ‘result’ στο δεδομένο στοιχείο ‘filter’. |
...
| [getTargetX](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/targetx/) Αντιστοιχεί στο χαρακτηριστικό ‘targetX’ στο δεδομένο στοιχείο ‘feConvolveMatrix’. |
| [getTargetY](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/targety/) Αντιστοιχεί στο χαρακτηριστικό ‘targetY’ στο δεδομένο στοιχείο ‘feConvolveMatrix’. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/width/) Αντιστοιχεί στο χαρακτηριστικό ‘width’ στο δεδομένο στοιχείο ‘filter’. |
| [X](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/x/) { get; } | Corresponds to attribute ‘x’ on the given ‘filter’ element. Αντιστοιχεί στο χαρακτηριστικό ‘x’ του δοσμένου στοιχείου ‘filter’. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/y/) { get; } | Corresponds to attribute ‘y’ on the given ‘filter’ element. Αντιστοιχεί στο χαρακτηριστικό ‘y’ του δοσμένου στοιχείου ‘filter’. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| const [SVG_EDGEMODE_DUPLICATE](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_duplicate/) | Αντιστοιχεί στην τιμή 'duplicate'. |
| const [SVG_EDGEMODE_NONE](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_none/) | Αντιστοιχεί στην τιμή 'none'. |
| const [SVG_EDGEMODE_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_unknown/) | Ο τύπος δεν είναι ένας από τους προκαθορισμένους τύπους. Είναι μη έγκυρο να προσπαθήσετε να ορίσετε μια νέα τιμή αυτού του τύπου ή να προσπαθήσετε να αλλάξετε μια υπάρχουσα τιμή σε αυτόν τον τύπο. |
| const [SVG_EDGEMODE_WRAP](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_wrap/) | Αντιστοιχεί στην τιμή 'wrap'. |
