---
title: "SVGFESpecularLightingElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.dom.svg.filters.SVGFESpecularLightingElement κλάση. Η διεπαφή SVGFESpecularLightingElement αντιστοιχεί στο στοιχείο feSpecularLighting."
type: docs

url: /el/java/com.aspose.html.dom.svg.filters/svgfespecularlightingelement/
---
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/height/) Αντιστοιχεί στο χαρακτηριστικό ‘height’ στο δεδομένο στοιχείο ‘filter’. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/in1/) Αντιστοιχεί στο χαρακτηριστικό ‘in’ στο δεδομένο στοιχείο ‘feSpecularLighting’. |
[getInnerHTML]
...
| [getKernelUnitLengthX](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/kernelunitlengthx/) Αντιστοιχεί στο χαρακτηριστικό ‘kernelUnitLength’ στο δεδομένο στοιχείο ‘feSpecularLighting’. |
| [getKernelUnitLengthY](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/kernelunitlengthy/) Αντιστοιχεί στο χαρακτηριστικό ‘kernelUnitLength’ στο δεδομένο στοιχείο ‘feSpecularLighting’. |
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/result/) Αντιστοιχεί στο χαρακτηριστικό ‘result’ στο δεδομένο στοιχείο ‘filter’. |
...
| [getSpecularConstant](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/specularconstant/) Αντιστοιχεί στο χαρακτηριστικό ‘specularConstant’ στο δεδομένο στοιχείο ‘feSpecularLighting’. |
| [getSpecularExponent](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/specularexponent/) Αντιστοιχεί στο χαρακτηριστικό ‘specularExponent’ στο δεδομένο στοιχείο ‘feSpecularLighting’. |
...
| [getSurfaceScale](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/surfacescale/) Αντιστοιχεί στο χαρακτηριστικό ‘surfaceScale’ στο δεδομένο στοιχείο ‘feSpecularLighting’. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/width/) Αντιστοιχεί στο χαρακτηριστικό ‘width’ στο δεδομένο στοιχείο ‘filter’. |
| [X](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/x/) { get; } | Corresponds to attribute ‘x’ on the given ‘filter’ element. Αντιστοιχεί στο χαρακτηριστικό ‘x’ του δοσμένου στοιχείου ‘filter’. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/y/) { get; } | Corresponds to attribute ‘y’ on the given ‘filter’ element. Αντιστοιχεί στο χαρακτηριστικό ‘y’ του δοσμένου στοιχείου ‘filter’. |
