...
description: "Το πακέτο com.aspose.html.dom.svg.filters περιέχει κλάσεις και διεπαφές σχετικές με τα εφέ φίλτρων στην προδιαγραφή SVG"
type: docs

url: /el/java/com.aspose.html.dom.svg.filters/
---
Το **com.aspose.html.dom.svg.filters** πακέτο περιέχει κλάσεις και διεπαφές σχετικές με τα εφέ φίλτρων στην προδιαγραφή SVG.
...
| [SVGFETurbulenceElement](./svgfeturbulenceelement/) | Η διεπαφή SVGFETurbulenceElement αντιστοιχεί στο στοιχείο ‘feTurbulence’. |
## Διεπαφές

| Διεπαφή | Περιγραφή |
| --- | --- |
| [ISVGFilterPrimitiveStandardAttributes](./isvgfilterprimitivestandardattributes/) | Αυτή η διεπαφή ορίζει το σύνολο των χαρακτηριστικών DOM που είναι κοινά σε όλες τις διεπαφές των primitive φίλτρων. |
