---
title: "Κλάση SVGFETileElement"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "κλάση com.aspose.html.dom.svg.filters.SVGFETileElement. Η διεπαφή SVGFETileElement αντιστοιχεί στο στοιχείο feTile"
type: docs

url: /el/java/com.aspose.html.dom.svg.filters/svgfetileelement/
---
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfetileelement/height/) Αντιστοιχεί στο χαρακτηριστικό ‘height’ του δεδομένου στοιχείου ‘filter’. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfetileelement/in1/) Αντιστοιχεί στο χαρακτηριστικό ‘in’ του δεδομένου στοιχείου ‘feTile’. |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfetileelement/result/) Αντιστοιχεί στο χαρακτηριστικό ‘result’ του δοσμένου στοιχείου ‘filter’. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfetileelement/width/) Αντιστοιχεί στο χαρακτηριστικό ‘width’ του δοσμένου στοιχείου ‘filter’. |
| [X](../../com.aspose.html.dom.svg.filters/svgfetileelement/x/) { get; } | Corresponds to attribute ‘x’ on the given ‘filter’ element. Αντιστοιχεί στο χαρακτηριστικό ‘x’ του δοσμένου στοιχείου ‘filter’. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfetileelement/y/) { get; } | Corresponds to attribute ‘y’ on the given ‘filter’ element. Αντιστοιχεί στο χαρακτηριστικό ‘y’ του δοσμένου στοιχείου ‘filter’. |
