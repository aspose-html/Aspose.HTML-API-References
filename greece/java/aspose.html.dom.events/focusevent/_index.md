...
description: "com.aspose.html.dom.events.FocusEvent κλάση. Η FocusEvent διεπαφή παρέχει συγκεκριμένες συμφραζόμενες πληροφορίες που σχετίζονται με συμβάντα εστίασης."
type: docs
...
Το FocusEvent interface παρέχει συγκεκριμένες συμφραζόμενες πληροφορίες που σχετίζονται με τα Focus events.
...
| Όνομα | Περιγραφή |
| --- | --- |
| [FocusEvent](focusevent/#constructor)(String) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης `FocusEvent`. |
...
| [getRelatedTarget](../../com.aspose.html.dom.events/focusevent/relatedtarget/) Χρησιμοποιείται για τον προσδιορισμό ενός δευτερεύοντος EventTarget που σχετίζεται με ένα Focus συμβάν, ανάλογα με τον τύπο του συμβάντος. |
