...
description: "com.aspose.html.dom.events.MouseEvent class. Η διεπαφή MouseEvent παρέχει συγκεκριμένες πληροφορίες συμφραζομένων που σχετίζονται με συμβάντα ποντικιού."
type: docs
...
Το interface MouseEvent παρέχει συγκεκριμένη συμφραζόμενη πληροφορία που σχετίζεται με γεγονότα ποντικιού.
