---
title: "Κλάση ErrorEvent"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "Κλάση com.aspose.html.dom.events.ErrorEvent. Το ErrorEvent παρέχει πληροφορίες περιβάλλοντος σχετικά με σφάλματα που συνέβησαν κατά την εκτέλεση"
type: docs
...
Το ErrorEvent παρέχει συμφραζόμενες πληροφορίες σχετικά με σφάλματα που συνέβησαν κατά την εκτέλεση.
...
| Όνομα | Περιγραφή |
| --- | --- |
| [ErrorEvent](errorevent/#constructor_1)(Exception) | Αρχικοποιεί μια νέα παρουσία της κλάσης `ErrorEvent`. |
