...
description: "Κατασκευαστής WheelEvent. Αρχικοποιεί ένα νέο αντικείμενο της κλάσης WheelEvent."
type: docs

url: /el/java/com.aspose.html.dom.events/wheelevent/wheelevent/
---
## WheelEvent(String) {#constructor}

Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [`WheelEvent`](../).
