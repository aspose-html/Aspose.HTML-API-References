...
description: "com.aspose.html.dom.events.UIEvent κλάση. Η διεπαφή UIEvent παρέχει συγκεκριμένες συμφραζόμενες πληροφορίες που σχετίζονται με συμβάντα Διεπαφής Χρήστη."
type: docs
...
Το interface UIEvent παρέχει συγκεκριμένη συμφραζόμενη πληροφορία που σχετίζεται με γεγονότα διεπαφής χρήστη.
...
| Όνομα | Περιγραφή |
| --- | --- |
| [UIEvent](uievent/#constructor)(String) | Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης `UIEvent`. |
