...
description: "Μέθοδος Converter. Συγχωνεύει την πηγή προτύπου που παρουσιάζεται από HTMLDocument με τα δεδομένα προτύπου XML JSON. Το αποτέλεσμα είναι αρχείο html που δημιουργείται από τη διαδρομή αρχείου εξόδου."
type: docs
...
Συγχωνεύει την πηγή προτύπου που παρουσιάζεται από [`HTMLDocument`](../../../com.aspose.html/htmldocument/) με τα δεδομένα προτύπου (XML, JSON). Το αποτέλεσμα είναι αρχείο html που δημιουργείται από τη διαδρομή αρχείου εξόδου.
...
| --- | --- | --- |
| template | HTMLDocument | Συγχώνευση του σκελετού πηγής που παρουσιάζεται από [`HTMLDocument`](../../../com.aspose.html/htmldocument/). |
| δεδομένα | TemplateData | Δεδομένα προτύπου για συγχώνευση - αντικατάσταση (XML, JSON). |
| options | TemplateLoadOptions | [`TemplateLoadOptions`](../../../com.aspose.html.loading/templateloadoptions/) αντικείμενο. Χρησιμοποιείται για να καθορίσει εάν τα ονόματα του προτύπου και των στοιχείων δεδομένων ταιριάζουν, ανεξάρτητα από πεζά ή κεφαλαία (επιλογές). |
...
Η ιδέα του συγχώνευσης προτύπων είναι η δημιουργία ενός εγγράφου HTML βασισμένου σε ένα πρότυπο HTML και η συμπλήρωσή του από μια πηγή δεδομένων. Το Aspose.HTML παρέχει τη σύνταξη ενσωματωμένων εκφράσεων για εργασία με πρότυπα και διάφορους τύπους πηγών δεδομένων, όπως XML και JSON. Ανατρέξτε στο [άρθρο](https://docs.aspose.com/html/net/converting-between-formats/html-template/) όπου μπορείτε να βρείτε περισσότερες πληροφορίες σχετικά με το συγχώνευση προτύπων και τη χρήση της μεθόδου ConvertTemplate().
...
Πηγή προτύπου. Ορίστε την πηγή προτύπου HTML με αρχείο, [`URL`](../../../com.aspose.html/url/), [`HTMLDocument`](../../../com.aspose.html/htmldocument/) αντικείμενο ή ακόμη και με ενσωματωμένο περιεχόμενο. Αποτέλεσμα μετατροπής. Μπορείτε να λάβετε άμεσα το προκύπτον HTMLDocument ή να ορίσετε τη διαδρομή εξόδου του αρχείου αποτελέσματος ανάλογα με την υπογραφή της μεθόδου. Δημιουργήστε ένα παράδειγμα του [`TemplateLoadOptions`](../../../com.aspose.html.loading/templateloadoptions/). Χρησιμοποιήστε τη μέθοδο ConvertTemplate() της κλάσης Converter για να συγχωνεύσετε το πρότυπο με τα δεδομένα. Μπορείτε επίσης να προσθέσετε το [`configuration`](../../../com.aspose.html/configuration/) ως παράμετρο επιλογής. Πηγαίος κώδικας
...
...
      ...
      // Ορίστε ένα αντικείμενο TemplateData
...
Συγχωνεύστε την πηγή HTML προτύπου που παρουσιάζεται από [`URL`](../../../com.aspose.html/url/) με τα δεδομένα προτύπου (XML, JSON). Το αποτέλεσμα είναι αρχείο html που δημιουργείται από τη διαδρομή εξόδου του αρχείου.
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| sourcePath | String | Συγχώνευση σκελετού πηγής HTML που παρουσιάζεται από πλήρη διαδρομή αρχείου. |
| δεδομένα | TemplateData | Δεδομένα προτύπου για συγχώνευση - αντικατάσταση (XML, JSON). |
| options | TemplateLoadOptions | [`TemplateLoadOptions`](../../../com.aspose.html.loading/templateloadoptions/) αντικείμενο. Χρησιμοποιείται για να καθορίσει εάν τα ονόματα του προτύπου και των στοιχείων δεδομένων ταιριάζουν, ανεξάρτητα από πεζά ή κεφαλαία (επιλογές). |
| outputPath | String | Πλήρης διαδρομή αρχείου html ως αποτέλεσμα εξόδου μετατροπής. |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| περιεχόμενο | String | Συγχώνευση σκελετού πηγής HTML που παρουσιάζεται από ενσωματωμένο περιεχόμενο String. |
| baseUrl | String | Βασικό URI του προτύπου html. Θα συνδυαστεί με τη διαδρομή του τρέχοντος καταλόγου για να δημιουργήσει μια απόλυτη URL. |
| δεδομένα | TemplateData | Δεδομένα προτύπου για συγχώνευση - αντικατάσταση (XML, JSON). |
| options | TemplateLoadOptions | [`TemplateLoadOptions`](../../../com.aspose.html.loading/templateloadoptions/) αντικείμενο. Χρησιμοποιείται για να καθορίσει εάν τα ονόματα του προτύπου και των στοιχείων δεδομένων ταιριάζουν, ανεξάρτητα από πεζά ή κεφαλαία (επιλογές). |
| outputPath | String | Πλήρης διαδρομή αρχείου html ως αποτέλεσμα εξόδου μετατροπής. |
...
...
   ...
   // Ορίστε ένα αντικείμενο configuration
...
Συγχώνευση πηγής προτύπου που παρουσιάζεται από [`HTMLDocument`](../../../com.aspose.html/htmldocument/) με τα δεδομένα προτύπου (XML, JSON). Το αποτέλεσμα είναι ένα νέο δημιουργημένο HTMLDocument το οποίο μπορεί να αποθηκευτεί ως αρχείο.
...
...
      ...
      using (var template = new HTMLDocument(sourcePath, new Configuration()))
      {
        ...
        // Αποθήκευση αποτελέσματος με συνδεδεμένους πόρους
...
Συγχώνευση πηγής HTML προτύπου που παρουσιάζεται από [`URL`](../../../com.aspose.html/url/) με τα δεδομένα προτύπου (XML, JSON). Το αποτέλεσμα είναι ένα νέο δημιουργημένο [`HTMLDocument`](../../../com.aspose.html/htmldocument/) το οποίο μπορεί να αποθηκευτεί ως αρχείο.
...
import com.aspose.html.converters;  
...
      // Δημιουργία URL για το σκελετικό αρχείο πηγής html
      var sourceUrl = new Url(Path.Combine(InputFolder, "source.html"));
...
Συγχώνευση πηγής HTML προτύπου που παρουσιάζεται από πλήρη διαδρομή αρχείου με τα δεδομένα προτύπου (XML, JSON). Το αποτέλεσμα είναι ένα νέο δημιουργημένο [`HTMLDocument`](../../../com.aspose.html/htmldocument/) το οποίο μπορεί να αποθηκευτεί ως αρχείο.
...
Συγχώνευση πηγής HTML προτύπου που παρουσιάζεται από ενσωματωμένο περιεχόμενο με τα δεδομένα προτύπου (XML, JSON). Το αποτέλεσμα είναι ένα νέο δημιουργημένο [`HTMLDocument`](../../../com.aspose.html/htmldocument/) το οποίο μπορεί να αποθηκευτεί ως αρχείο.
...
...
      ...
      // Έναρξη διαδικασίας μετατροπής και αποθήκευση αποτελέσματος
