...
description: "Διεπαφή com.aspose.html.dom.traversal.ITreeWalker. Τα αντικείμενα TreeWalker χρησιμοποιούνται για την περιήγηση ενός δέντρου εγγράφου ή υποδέντρου χρησιμοποιώντας την προβολή του εγγράφου που ορίζεται από τις σημαίες whatToShow και το φίλτρο, εάν υπάρχει. Οποιαδήποτε λειτουργία που εκτελεί περιήγηση χρησιμοποιώντας ένα TreeWalker θα υποστηρίζει αυτόματα οποιαδήποτε προβολή ορίζεται από ένα TreeWalker."
type: docs
...
| [parentNode](../../com.aspose.html.dom.traversal/itreewalker/parentnode/)() | Μετακινείται και επιστρέφει τον πλησιέστερο ορατό γονικό κόμβο του τρέχοντος κόμβου. Εάν η αναζήτηση για parentNode προσπαθήσει να ανέβει από τον ριζικό κόμβο του TreeWalker, ή εάν δεν βρει ορατό γονικό κόμβο, αυτή η μέθοδος διατηρεί τη τρέχουσα θέση και επιστρέφει null. |
| [previousNode](../../com.aspose.html.dom.traversal/itreewalker/previousnode/)() | Μετακινεί το TreeWalker στον προηγούμενο ορατό κόμβο με τη σειρά του εγγράφου σε σχέση με τον τρέχοντα κόμβο και επιστρέφει τον νέο κόμβο. Εάν ο τρέχων κόμβος δεν έχει προηγούμενο κόμβο ή εάν η αναζήτηση για previousNode προσπαθήσει να ανέβει από τον ριζικό κόμβο του TreeWalker, επιστρέφει null και διατηρεί τον τρέχοντα κόμβο. |
