---
title: "Notation Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.dom.Notation κλάση. Αντιπροσωπεύει μια σημείωση που δηλώθηκε στο DTD"
type: docs
...
| [getPublicId](../../com.aspose.html.dom/notation/publicid/) Το δημόσιο αναγνωριστικό αυτής της σημείωσης. Εάν το δημόσιο αναγνωριστικό δεν έχει καθοριστεί, είναι null. |
| [getSystemId](../../com.aspose.html.dom/notation/systemid/) Το αναγνωριστικό συστήματος αυτής της σημείωσης. Εάν το αναγνωριστικό συστήματος δεν έχει καθοριστεί, είναι null. Αυτό μπορεί να είναι απόλυτο URI ή όχι. |
