---
title: "Κλάση Notation"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.dom.Notation κλάση. Αντιπροσωπεύει μια σημειογραφία που δηλώνεται στο DTD"
type: docs

url: /el/java/com.aspose.html.dom/notation/
---
## Notation class

Αντιπροσωπεύει μια σημειογραφία που δηλώθηκε στο DTD.
...
| [getNodeName](../../com.aspose.html.dom/notation/nodename/) Το όνομα αυτού του κόμβου, ανάλογα με τον τύπο του. |
| [getNodeType](../../com.aspose.html.dom/notation/nodetype/) Ένας κώδικας που αντιπροσωπεύει τον τύπο του υποκείμενου αντικειμένου. |
...
| [getPublicId](../../com.aspose.html.dom/notation/publicid/) Ο δημόσιος ταυτοποιητής αυτής της σημειογραφίας. Εάν ο δημόσιος ταυτοποιητής δεν έχει καθοριστεί, είναι null. |
| [getSystemId](../../com.aspose.html.dom/notation/systemid/) Ο αναγνωριστικός αριθμός συστήματος αυτής της σημειογραφίας. Εάν δεν έχει καθοριστεί, είναι null. Μπορεί να είναι απόλυτο URI ή όχι. |
