...
description: "Πεδίο TypeInfo. Εάν το σχήμα του εγγράφου είναι ένα XML Schema (XML Schema Part 1), αυτή η σταθερά αντιπροσωπεύει την παράγωγο με περιορισμό εάν εμπλέκονται σύνθετοι τύποι ή έναν περιορισμό εάν εμπλέκονται απλοί τύποι"
type: docs

url: /el/java/com.aspose.html.dom/typeinfo/derivation_restriction/
---
