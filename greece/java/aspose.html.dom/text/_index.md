...
description: "κλάση com.aspose.html.dom.Text. Η διεπαφή Text κληρονομεί από το CharacterData και αντιπροσωπεύει το κειμενικό περιεχόμενο που ονομάζεται δεδομένα χαρακτήρων σε XML ενός Element ή Attr"
type: docs
...
| [getWholeText](../../com.aspose.html.dom/text/wholetext/) Επιστρέφει όλο το κείμενο των κόμβων Text που είναι λογικά γειτονικοί σε αυτόν τον κόμβο, ενωμένα με τη σειρά του εγγράφου. |
