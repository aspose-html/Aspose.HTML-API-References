...
description: "com.aspose.html.dom.EntityReference κλάση. Οι κόμβοι EntityReference μπορούν να χρησιμοποιηθούν για την αναπαράσταση μιας αναφοράς οντότητας στο δέντρο."
type: docs
...
Κόμβοι EntityReference μπορούν να χρησιμοποιηθούν για να αντιπροσωπεύσουν μια αναφορά οντότητας στο δέντρο.
