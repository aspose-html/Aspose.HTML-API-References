...
description: "Ιδιότητα Node. Η μόνο για ανάγνωση ιδιότητα nodeName του Node επιστρέφει το όνομα του τρέχοντος κόμβου ως String."
type: docs

url: /el/java/com.aspose.html.dom/node/nodename/
---
## Node.NodeName property

Η μόνο για ανάγνωση ιδιότητα nodeName του Node επιστρέφει το όνομα του τρέχοντος κόμβου ως String.
...
Ένα String, οι τιμές για τους διαφορετικούς τύπους κόμβων είναι:
