...
description: "Πεδίο Node. Το πραγματικό κείμενο μέσα σε ένα Element ή Attr"
type: docs

url: /el/java/com.aspose.html.dom/node/text_node/
---
## Node.TEXT_NODE field

Το πραγματικό [`Text`](../../text/) μέσα σε ένα [`Element`](../../element/) ή [`Attr`](../../attr/).
