...
Ένα Node που είναι ο γονέας του τρέχοντος κόμβου. Ο γονέας ενός στοιχείου είναι ένας κόμβος [`Element`](../../element/), ένας κόμβος [`Document`](../../document/) ή ένας κόμβος [`DocumentFragment`](../../documentfragment/).
