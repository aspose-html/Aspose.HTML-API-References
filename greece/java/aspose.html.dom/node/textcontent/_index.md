...
description: "Ιδιότητα Node. Η ιδιότητα textContent της διεπαφής Node αντιπροσωπεύει το κείμενο του κόμβου και των απογόνων του"
type: docs
