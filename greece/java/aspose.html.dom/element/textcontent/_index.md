...
description: "Ιδιότητα Element. Αυτό το χαρακτηριστικό επιστρέφει το περιεχόμενο κειμένου αυτού του κόμβου και των απογόνων του. Όταν ορίζεται σε null, η ρύθμιση δεν έχει καμία επίδραση. Κατά τη ρύθμιση, τυχόν παιδιά που μπορεί να έχει αυτός ο κόμβος αφαιρούνται και εάν η νέα String δεν είναι κενή ή null, αντικαθίσταται από έναν μοναδικό κόμβο Text που περιέχει τη String· αυτό το χαρακτηριστικό ορίζεται σε"
type: docs
