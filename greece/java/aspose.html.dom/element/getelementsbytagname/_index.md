...
description: "Μέθοδος Element. Επιστρέφει το αντικείμενο HTMLCollection που περιέχει όλα τα στοιχεία με ένα συγκεκριμένο όνομα ετικέτας με τη σειρά του εγγράφου."
type: docs
...
Επιστρέφει το αντικείμενο [`HTMLCollection`](../../../com.aspose.html.collections/htmlcollection/) που περιέχει όλα τα [`elements`](../) με ένα συγκεκριμένο όνομα ετικέτας, με τη σειρά του εγγράφου.
...
Ανατρέξτε στην επίσημη [προδιαγραφή](https://dom.spec.whatwg.org/#dom-element-getelementsbytagname).
...
Η παράγραφος με στυλ κλάσης pStyle περιεχόμενο...
