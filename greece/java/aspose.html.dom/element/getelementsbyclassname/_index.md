...
description: "Μέθοδος Element. Επιστρέφει αντικείμενο HTMLCollection που περιέχει όλα τα στοιχεία εντός του στοιχείου που έχουν όλες τις κλάσεις που καθορίζονται στο όρισμα."
type: docs
...
Αναφερθείτε στην επίσημη [spec](https://dom.spec.whatwg.org/#dom-element-getelementsbyclassname).
