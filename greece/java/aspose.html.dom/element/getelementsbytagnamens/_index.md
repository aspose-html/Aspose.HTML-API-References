...
description: "Μέθοδος Element. Επιστρέφει αντικείμενο HTMLCollection που περιέχει όλα τα στοιχεία με το συγκεκριμένο τοπικό όνομα και τη συμβολοσειρά URI πακέτου με τη σειρά του εγγράφου."
type: docs
...
Επιστρέφει το αντικείμενο [`HTMLCollection`](../../../com.aspose.html.collections/htmlcollection/) που περιέχει όλα τα [`elements`](../) με το συγκεκριμένο τοπικό όνομα και τη συμβολοσειρά URI πακέτου με τη σειρά του εγγράφου.
...
Το προσαρμοσμένο περιεχόμενο ετικέτας προσαρμοσμένου πακέτου πηγαίνει εδώ...
