...
description: "Comment ιδιότητα. Αυτό το χαρακτηριστικό επιστρέφει το κείμενο περιεχομένου αυτού του κόμβου και των απογόνων του. Όταν ορίζεται σε null, η ρύθμιση δεν έχει καμία επίδραση. Κατά τη ρύθμιση, τυχόν πιθανά παιδιά που μπορεί να έχει αυτός ο κόμβος αφαιρούνται και εάν το νέο String δεν είναι κενό ή null, αντικαθίσταται από έναν μοναδικό κόμβο κειμένου που περιέχει το String, αυτό το χαρακτηριστικό ορίζεται σε"
type: docs

url: /el/java/com.aspose.html.dom/comment/textcontent/
---
