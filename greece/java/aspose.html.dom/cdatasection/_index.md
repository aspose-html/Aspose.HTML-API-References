---
title: "Κατηγορία CDATASection"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "κλάση com.aspose.html.dom.CDATASection. Οι ενότητες CDATA χρησιμοποιούνται για την απόδραση μπλοκ κειμένου που περιέχουν χαρακτήρες που διαφορετικά θα θεωρούνταν σήμανση."
type: docs

url: /el/java/com.aspose.html.dom/cdatasection/
---
## CDATASection class

Οι ενότητες CDATA χρησιμοποιούνται για την απόδραση τμημάτων κειμένου που περιέχουν χαρακτήρες που διαφορετικά θα θεωρούνταν σήμανση.
...
| [getIsElementContentWhitespace](../../com.aspose.html.dom/text/iselementcontentwhitespace/) Επιστρέφει εάν αυτός ο κόμβος κειμένου περιέχει λευκό διάστημα περιεχομένου στοιχείου, συχνά λανθασμένα αποκαλούμενο «παραβλέψιμο λευκό διάστημα». |
...
| [getNodeName](../../com.aspose.html.dom/cdatasection/nodename/) Το όνομα αυτού του κόμβου, ανάλογα με τον τύπο του. |
| [getNodeType](../../com.aspose.html.dom/cdatasection/nodetype/) Ένας κώδικας που αντιπροσωπεύει τον τύπο του υποκείμενου αντικειμένου. |
| [nodeValue](../../com.aspose.html.dom/text/nodevalue/) { get; set; } | Η τιμή αυτού του κόμβου, ανάλογα με τον τύπο του. |
...
| [getWholeText](../../com.aspose.html.dom/text/wholetext/) Επιστρέφει όλο το κείμενο των κόμβων Text που είναι λογικά γειτονικοί σε αυτόν τον κόμβο, ενωμένο με τη σειρά του εγγράφου. |
...
| [normalize](../../com.aspose.html.dom/node/normalize/)() | Τοποθετεί όλους τους κόμβους [`Text`](../text/) σε όλο το βάθος του υποδέντρου κάτω από αυτόν τον Κόμβο, συμπεριλαμβανομένων των κόμβων χαρακτηριστικών, σε μια «κανονική» μορφή όπου μόνο η δομή (π.χ., [`elements`](../element/), [`comments`](../comment/), [`processing instructions`](../processinginstruction/), `CDATA sections`, και [`entity references`](../entityreference/)) διαχωρίζει τους κόμβους [`Text`](../text/), δηλαδή δεν υπάρχουν ούτε προσαρτημένοι κόμβοι Text ούτε κενά κόμβοι Text. Αυτό μπορεί να χρησιμοποιηθεί για να διασφαλιστεί ότι η προβολή DOM ενός εγγράφου είναι η ίδια όπως θα ήταν αν αποθηκευόταν και φορτωνόταν ξανά, και είναι χρήσιμο όταν εκτελούνται λειτουργίες (όπως αναζητήσεις XPointer [XPointer]) που εξαρτώνται από μια συγκεκριμένη δομή δέντρου εγγράφου. Εάν η παράμετρος «normalize-characters» του αντικειμένου [`DOMConfiguration`](../../com.aspose.html/configuration/) που είναι συνδεδεμένο με το [`Node.ownerDocument`](../node/ownerdocument/) είναι αληθής, αυτή η μέθοδος θα κανονικοποιήσει επίσης πλήρως τους χαρακτήρες των κόμβων Text. |
...
| [replaceWholeText](../../com.aspose.html.dom/text/replacewholetext/)(String) | Αντικαθιστά το κείμενο του τρέχοντος κόμβου και όλων των λογικά-προσαρτημένων κόμβων κειμένου με το καθορισμένο κείμενο. Όλοι οι λογικά-προσαρτημένοι κόμβοι κειμένου αφαιρούνται, συμπεριλαμβανομένου του τρέχοντος κόμβου, εκτός εάν ήταν ο παραλήπτης του κειμένου αντικατάστασης. |
| [splitText](../../com.aspose.html.dom/text/splittext/)(int) | Διαιρεί αυτόν τον κόμβο σε δύο κόμβους στο καθορισμένο offset, διατηρώντας και τους δύο στο δέντρο ως αδέρφια. |
