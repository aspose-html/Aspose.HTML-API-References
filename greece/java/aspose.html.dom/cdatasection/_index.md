---
title: "Κλάση CDATASection"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "κλάση com.aspose.html.dom.CDATASection. Τα CDATA sections χρησιμοποιούνται για την απόδραση μπλοκ κειμένου που περιέχουν χαρακτήρες που διαφορετικά θα θεωρούνταν ως σήμανση."
type: docs
...
Τα τμήματα CDATA χρησιμοποιούνται για την απόδραση μπλοκ κειμένου που περιέχουν χαρακτήρες που διαφορετικά θα θεωρούνταν σήμανση.
