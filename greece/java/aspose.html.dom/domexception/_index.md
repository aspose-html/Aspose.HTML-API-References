...
| Όνομα | Περιγραφή |
| --- | --- |
| [getCode](../../com.aspose.html.dom/domexception/code/) Επιστρέφει μια τιμή που περιέχει μία από τις σταθερές κωδικού σφάλματος, ή 0 αν καμία δεν ταιριάζει. Αυτό το πεδίο χρησιμοποιείται για ιστορικούς λόγους. |
| [getMessage](../../com.aspose.html.dom/domexception/message/) Επιστρέφει ένα String που αντιπροσωπεύει ένα μήνυμα ή περιγραφή που σχετίζεται με το δεδομένο όνομα σφάλματος. |
| [getName](../../com.aspose.html.dom/domexception/name/) Επιστρέφει ένα String που περιέχει ένα από τα Strings που σχετίζονται με ένα όνομα σφάλματος. |
...
| const [HIERARCHY_REQUEST_ERR](../../com.aspose.html.dom/domexception/hierarchy_request_err/) | Εάν οποιοσδήποτε Node εισαχθεί κάπου που δεν του ανήκει. |
| const [INDEX_SIZE_ERR](../../com.aspose.html.dom/domexception/index_size_err/) | Εάν το ευρετήριο ή το μέγεθος είναι αρνητικό, ή μεγαλύτερο από την επιτρεπόμενη τιμή. |
| const [INUSE_ATTRIBUTE_ERR](../../com.aspose.html.dom/domexception/inuse_attribute_err/) | Εάν γίνει προσπάθεια προσθήκης ενός χαρακτηριστικού που χρησιμοποιείται ήδη κάπου αλλού. |
...
| const [INVALID_EXPRESSION_ERR](../../com.aspose.html.dom/domexception/invalid_expression_err/) | Η έκφραση έχει σφάλμα σύνταξης ή αλλιώς δεν είναι έγκυρη έκφραση σύμφωνα με τους κανόνες του συγκεκριμένου XPathEvaluator ή περιέχει εξειδικευμένες συναρτήσεις επέκτασης ή μεταβλητές που δεν υποστηρίζονται από αυτήν την υλοποίηση. |
...
| const [INVALID_NODE_TYPE_ERR](../../com.aspose.html.dom/domexception/invalid_node_type_err/) | Ο παρεχόμενος κόμβος είναι εσφαλμένος ή έχει εσφαλμένο πρόγονο για αυτή τη λειτουργία. |
...
| const [VALIDATION_ERR](../../com.aspose.html.dom/domexception/validation_err/) | Εάν μια κλήση σε μια μέθοδο όπως insertBefore ή removeChild έκανε τον Node μη έγκυρο ως προς την «μερική εγκυρότητα», αυτή η εξαίρεση θα εξαπολύεται και η λειτουργία δεν θα εκτελείται. Αυτός ο κώδικας χρησιμοποιείται στο [DOM Level 3 Validation]. Ανατρέξτε σε αυτήν την προδιαγραφή για περισσότερες πληροφορίες. |
| const [WRONG_DOCUMENT_ERR](../../com.aspose.html.dom/domexception/wrong_document_err/) | Εάν ένας Node χρησιμοποιηθεί σε διαφορετικό έγγραφο από αυτό που τον δημιούργησε (που δεν τον υποστηρίζει). |
