---
title: "CharacterData Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.dom.CharacterData κλάση. Η CharacterData επεκτείνει το Node με σύνολο ιδιοτήτων και μεθόδων για πρόσβαση σε δεδομένα χαρακτήρων στο DOM"
type: docs

url: /el/java/com.aspose.html.dom/characterdata/
---
## CharacterData class

Η CharacterData επεκτείνει το Node με ένα σύνολο χαρακτηριστικών και μεθόδων για την πρόσβαση σε δεδομένα χαρακτήρων στο DOM.
