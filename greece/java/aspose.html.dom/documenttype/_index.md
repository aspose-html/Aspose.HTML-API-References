---
title: "Κλάση DocumentType"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.dom.DocumentType κλάση. Η DocumentType παρέχει μια διεπαφή στη λίστα των οντοτήτων που ορίζονται για το έγγραφο"
type: docs

url: /el/java/com.aspose.html.dom/documenttype/
---
## DocumentType class

Το DocumentType παρέχει μια διεπαφή στη λίστα των οντοτήτων που ορίζονται για το έγγραφο.
...
| Όνομα | Περιγραφή |
| --- | --- |
| [DocumentType](documenttype/)(String, String, String, String, Document) | Αρχικοποιεί μια νέα παρουσία της κλάσης `DocumentType`. |
...
| [getInternalSubset](../../com.aspose.html.dom/documenttype/internalsubset/) Το εσωτερικό υποσύνολο ως String, ή null εάν δεν υπάρχει. |
...
| [getName](../../com.aspose.html.dom/documenttype/name/) Το όνομα του DTD· δηλαδή το όνομα που ακολουθεί αμέσως τη λέξη-κλειδί DOCTYPE. |
...
| [getNodeName](../../com.aspose.html.dom/documenttype/nodename/) Το όνομα αυτού του κόμβου, ανάλογα με τον τύπο του. |
| [getNodeType](../../com.aspose.html.dom/documenttype/nodetype/) Ένας κώδικας που αντιπροσωπεύει τον τύπο του υποκείμενου αντικειμένου. |
...
| [getPublicId](../../com.aspose.html.dom/documenttype/publicid/) Ο δημόσιος ταυτοποιητής του εξωτερικού υποσυνόλου. |
| [getSystemId](../../com.aspose.html.dom/documenttype/systemid/) Ο αναγνωριστικός αριθμός συστήματος του εξωτερικού υποσυνόλου. Μπορεί να είναι απόλυτο URI ή όχι. |
...
| [toString](../../com.aspose.html.dom/documenttype/toString/)() | Επιστρέφει ένα String που αντιπροσωπεύει αυτό το αντικείμενο. |
