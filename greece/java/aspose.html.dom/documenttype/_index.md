---
title: "DocumentType Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.dom.DocumentType κλάση. Το DocumentType παρέχει μια διεπαφή στη λίστα των οντοτήτων που ορίζονται για το έγγραφο"
type: docs
...
| Όνομα | Περιγραφή |
| --- | --- |
| [DocumentType](documenttype/)(String, String, String, String, Document) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης `DocumentType`. |
...
| [getPublicId](../../com.aspose.html.dom/documenttype/publicid/) Το δημόσιο αναγνωριστικό του εξωτερικού υποσυνόλου. |
| [getSystemId](../../com.aspose.html.dom/documenttype/systemid/) Το αναγνωριστικό συστήματος του εξωτερικού υποσυνόλου. Αυτό μπορεί να είναι απόλυτο URI ή όχι. |
