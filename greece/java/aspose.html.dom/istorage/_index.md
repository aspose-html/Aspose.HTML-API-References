...
description: "com.aspose.html.dom.IStorage διεπαφή. Αυτή η διεπαφή του Web Storage API παρέχει πρόσβαση στη συνεδρία ή την τοπική αποθήκευση ενός συγκεκριμένου τομέα. Δείτε την προδιαγραφή Web Storage https//html.spec.whatwg.org/multipage/webstorage.htmlwebstorage"
type: docs
