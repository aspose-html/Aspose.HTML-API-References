...
| [getNodeType](../../com.aspose.html.dom/attr/nodetype/) Ένας κώδικας που αντιπροσωπεύει τον τύπο του υποκείμενου αντικειμένου. |
...
| [getPrefix](../../com.aspose.html.dom/attr/prefix/) Το πρόθεμα του πακέτου αυτού του κόμβου, ή null εάν δεν έχει οριστεί. Όταν ορίζεται ως null, η ρύθμισή του δεν έχει καμία επίδραση. |
