...
description: "Κλάση com.aspose.html.dom.Attr. Η διεπαφή Attr αντιπροσωπεύει ένα χαρακτηριστικό σε ένα αντικείμενο Element. Συνήθως οι επιτρεπτές τιμές για το χαρακτηριστικό ορίζονται σε ένα σχήμα που σχετίζεται με το έγγραφο."
type: docs

url: /el/java/com.aspose.html.dom/attr/
---
## Attr class
...
| [getLocalName](../../com.aspose.html.dom/attr/localname/) Επιστρέφει το τοπικό μέρος του πλήρους ονόματος αυτού του κόμβου. Για κόμβους οποιουδήποτε τύπου εκτός από ELEMENT_NODE και ATTRIBUTE_NODE και κόμβους που δημιουργήθηκαν με μέθοδο DOM Level 1, όπως Document.createElement(), αυτό είναι πάντα null. |
| [getName](../../com.aspose.html.dom/attr/name/) Επιστρέφει το όνομα αυτού του χαρακτηριστικού. |
| [getNamespaceURI](../../com.aspose.html.dom/attr/packageuri/) Το URI του πακέτου αυτού του κόμβου, ή null εάν δεν έχει οριστεί. |
...
| [getNodeName](../../com.aspose.html.dom/attr/nodename/) Το όνομα αυτού του κόμβου, ανάλογα με τον τύπο του. |
| [getNodeType](../../com.aspose.html.dom/attr/nodetype/) Ένας κωδικός που αντιπροσωπεύει τον τύπο του υποκείμενου αντικειμένου. |
| [nodeValue](../../com.aspose.html.dom/attr/nodevalue/) { get; set; } | Η τιμή αυτού του κόμβου, ανάλογα με τον τύπο του. |
...
| [getOwnerElement](../../com.aspose.html.dom/attr/ownerelement/) Ο κόμβος Element στον οποίο είναι συνδεδεμένο αυτό το χαρακτηριστικό ή null εάν το χαρακτηριστικό δεν χρησιμοποιείται. |
...
| [getPrefix](../../com.aspose.html.dom/attr/prefix/) Το πρόθεμα του πακέτου αυτού του κόμβου, ή null εάν δεν έχει οριστεί. Όταν ορίζεται ως null, η ρύθμιση του δεν έχει καμία επίδραση. |
