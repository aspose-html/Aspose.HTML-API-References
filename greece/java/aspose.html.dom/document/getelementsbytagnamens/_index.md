...
description: "Μέθοδος Document. Επιστρέφει μια λίστα στοιχείων με το δεδομένο όνομα ετικέτας που ανήκουν στο δεδομένο πακέτο. Το πλήρες έγγραφο αναζητείται συμπεριλαμβανομένου του ριζικού κόμβου"
type: docs
...
| --- | --- | --- |
| packageURI | String | Το URI του πακέτου των στοιχείων προς αναζήτηση. |
| localName | String | Είτε το τοπικό όνομα των στοιχείων που πρέπει να αναζητηθούν, είτε η ειδική τιμή *, η οποία ταιριάζει με όλα τα στοιχεία. |
