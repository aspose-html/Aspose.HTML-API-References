...
description: "Μέθοδος Document. Η μέθοδος getElementsByClassName της διεπαφής Document επιστρέφει ένα αντικείμενο παρόμοιο με πίνακα όλων των στοιχείων-παιδιών που έχουν όλα τα δοσμένα ονόματα κλάσης"
type: docs
...
Η μέθοδος getElementsByClassName της διεπαφής [`Document`](../) επιστρέφει ένα αντικείμενο παρόμοιο με πίνακα όλων των στοιχείων-παιδιών που έχουν όλα τα δοσμένα ονόματα κλάσης.

Όταν κληθεί στο αντικείμενο document, αναζητείται ολόκληρο το έγγραφο, συμπεριλαμβανομένου του ριζικού κόμβου. Μπορείτε επίσης να καλέσετε getElementsByClassName() σε οποιοδήποτε στοιχείο· θα επιστρέψει μόνο τα στοιχεία που είναι απόγονοι του καθορισμένου ριζικού στοιχείου με τα δοσμένα ονόματα κλάσης.
...
| --- | --- | --- |
| classNames | String | Η String String που περιέχει ένα αταξινόμητο σύνολο μοναδικών διαχωρισμένων διαστημάτων που αντιπροσωπεύουν κλάσεις (ονόματα κλάσεων) |
...
Παράγραφος μορφοποιημένη από την κλάση με όνομα =ddd kkk=

Τύπος στοιχείου: Aspose.Html.HTMLParagraphElement

Παράγραφος μορφοποιημένη από την κλάση με όνομα =ddd fff=
