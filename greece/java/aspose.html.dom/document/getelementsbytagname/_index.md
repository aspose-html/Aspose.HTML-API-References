...
| --- | --- | --- |
| όνομα ετικέτας | String | Μια String που αντιπροσωπεύει το όνομα των στοιχείων. Η ειδική String "*" αντιπροσωπεύει όλα τα στοιχεία. |
...
Ανατρέξτε στην επίσημη [spec](https://dom.spec.whatwg.org/#dom-document-getelementsbytagname).

Το περιεχόμενο πρακτικής ανάπτυξης ιστού μπορεί να βρεθεί στο [w3schools](https://www.w3schools.com/jsref/met_document_getelementsbytagname.asp).
...
Παράγραφος μορφοποιημένη από την κλάση με όνομα =kkk fff=
