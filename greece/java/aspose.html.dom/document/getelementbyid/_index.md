...
Εάν χρειάζεστε πρόσβαση σε ένα στοιχείο που δεν έχει ID, μπορείτε να χρησιμοποιήσετε το querySelector() για να βρείτε το στοιχείο χρησιμοποιώντας οποιονδήποτε επιλογέα.
...
| --- | --- | --- |
| elementId | String | Το ID του στοιχείου που πρέπει να εντοπιστεί. Το ID είναι μια case-sensitive String που είναι μοναδική εντός του εγγράφου· μόνο ένα στοιχείο μπορεί να έχει το συγκεκριμένο ID. |
