...
Η μέθοδος επιστρέφει ένα αντικείμενο [`DocumentType`](../../documenttype/) το οποίο μπορεί είτε να χρησιμοποιηθεί με DOMImplementation.createDocument κατά τη δημιουργία του εγγράφου είτε να τοποθετηθεί στο έγγραφο μέσω μεθόδων όπως Node.insertBefore() ή Node.replaceChild().
