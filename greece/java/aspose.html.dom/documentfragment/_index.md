---
title: "Κλάση DocumentFragment"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.dom.DocumentFragment class. Το DocumentFragment είναι ένα ελαφρύ ή ελάχιστο αντικείμενο Document. Είναι πολύ συνηθισμένο να θέλετε να εξάγετε ένα τμήμα του δέντρου ενός εγγράφου ή να δημιουργήσετε ένα νέο τμήμα ενός εγγράφου."
type: docs

url: /el/java/com.aspose.html.dom/documentfragment/
---
## DocumentFragment class

Το DocumentFragment είναι ένα "ελαφρύ" ή "ελάχιστο" αντικείμενο Document. Είναι πολύ συνηθισμένο να θέλουμε να εξάγουμε ένα τμήμα του δέντρου ενός εγγράφου ή να δημιουργήσουμε ένα νέο απόσπασμα ενός εγγράφου.
