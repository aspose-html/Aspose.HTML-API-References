---
title: "Accessors Απαρίθμηση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.dom.attributes.Accessors απαρίθμηση. Αναπαριστά την απαρίθμηση των προσδιοριστών μελών που ορίζεται από το W3C"
type: docs

url: /el/java/com.aspose.html.dom.attributes/accessors/
---
## Accessors enumeration

Αντιπροσωπεύει την απαρίθμηση των προσπελαστών μελών που ορίζεται από το W3C.
...
| --- | --- | --- |
| None | `0` | Καθορίζει ότι η ιδιότητα δεν έχει ιδιαίτερο νόημα. |
