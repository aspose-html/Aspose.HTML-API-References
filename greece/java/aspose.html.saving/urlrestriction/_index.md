...
description: "com.aspose.html.saving.UrlRestriction enum. Αυτό το enum αντιπροσωπεύει περιορισμό που εφαρμόζεται στα URL των επεξεργασμένων πόρων"
type: docs

url: /el/java/com.aspose.html.saving/urlrestriction/
---
## UrlRestriction enumeration

Αυτό το enum αντιπροσωπεύει περιορισμό που εφαρμόζεται στα URL των επεξεργασμένων πόρων.
