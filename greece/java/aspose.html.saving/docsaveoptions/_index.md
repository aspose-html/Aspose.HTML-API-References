---
title: "Κλάση DocSaveOptions"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "Η κλάση com.aspose.html.saving.DocSaveOptions. Συγκεκριμένη κλάση δεδομένων επιλογών. Αναθέτοντας ιδιότητες μπορείτε να διαχειριστείτε χαρακτηριστικά απόδοσης όπως ανάλυση, μέγεθος σελίδας, χρώμα φόντου, καθώς και ειδικές επιλογές εγγράφου όπως ενσωμάτωση γραμματοσειρών. Περισσότερες πληροφορίες στο άρθρο τεκμηρίωσης."
type: docs
