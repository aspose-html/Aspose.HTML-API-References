...
...
     // Προετοιμάστε μια διαδρομή εξόδου για ένα έγγραφο HTML 
      ...
      {
        // Δημιουργήστε μια παρουσία επιλογών αποθήκευσης
        var options = new HTMLSaveOptions();

        // Η ακόλουθη γραμμή με τιμή '0' αποκόπτει όλα τα άλλα συνδεδεμένα HTML‑αρχεία κατά την αποθήκευση αυτού του αντικειμένου
