...
description: "Η κλάση com.aspose.html.saving.XpsSaveOptions. Η συγκεκριμένη κλάση δεδομένων επιλογών παρέχει μερικές ιδιότητες για τη διαχείριση του αποτελέσματος μετατροπής. Για παράδειγμα, το PageSetup καθορίζει τα χαρακτηριστικά της σελίδας. Ανατρέξτε στο άρθρο τεκμηρίωσης."
type: docs
