---
title: "Τάξη PdfSaveOptions"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.saving.PdfSaveOptions κλάση. Συγκεκριμένη κλάση δεδομένων παρέχει μερικές ιδιότητες για τη διαχείριση του αποτελέσματος της μετατροπής. Για παράδειγμα, το PageSetup καθορίζει τα χαρακτηριστικά της σελίδας. Ανατρέξτε στο άρθρο τεκμηρίωσης."
type: docs
...
Συγκεκριμένη κλάση δεδομένων παρέχει μερικές ιδιότητες για τη διαχείριση του αποτελέσματος της μετατροπής. Για παράδειγμα, το [`PageSetup`](../../com.aspose.html.rendering/pagesetup/) καθορίζει τα χαρακτηριστικά της σελίδας. Ανατρέξτε στην τεκμηρίωση [άρθρο](https://docs.aspose.com/html/net/converting-between-formats/html-to-pdf/#convert-html-to-pdf-using-pdfsaveoptions).
...
...
      ...
      // Αρχικοποιήστε το PdfSaveOptions. Ορίστε το μέγεθος σελίδας 600x300 pixel, περιθώρια, 
