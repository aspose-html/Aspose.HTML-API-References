...
description: "IAbstractView ιδιότητα. Η πηγή DocumentView του οποίου αυτό είναι ένα AbstractView"
type: docs

url: /el/java/com.aspose.html.dom.views/iabstractview/document/
---
## IAbstractView.Document property

Η πηγή DocumentView του οποίου αυτό είναι ένα AbstractView.
