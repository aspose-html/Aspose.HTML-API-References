---
title: "ReferenceImageSyntaxNode Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.toolkit.markdown.syntax.ReferenceImageSyntaxNode class. Η σύνταξη εικόνας αναφοράς"
type: docs

url: /el/java/com.aspose.html.toolkit.markdown.syntax/referenceimagesyntaxnode/
---
## ReferenceImageSyntaxNode class

Η σύνταξη εικόνας αναφοράς.
...
| Όνομα | Περιγραφή |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/referenceimagesyntaxnode/accept/)(MarkdownSyntaxVisitor) | Ορίζει τη διεπαφή για αποδοχή του επισκέπτη. |
...
| [getAltText](../../com.aspose.html.toolkit.markdown.syntax/referenceimagesyntaxnode/getalttext/)() | Ορίζει τη διεπαφή για λήψη του εναλλακτικού κειμένου. |
| [getLabel](../../com.aspose.html.toolkit.markdown.syntax/referenceimagesyntaxnode/getlabel/)() | Ορίζει τη διεπαφή για λήψη της ετικέτας. |
