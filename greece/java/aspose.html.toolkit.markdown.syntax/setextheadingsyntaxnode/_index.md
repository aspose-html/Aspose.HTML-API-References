---
title: "SetextHeadingSyntaxNode Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.toolkit.markdown.syntax.SetextHeadingSyntaxNode κλάση. Αναπαριστά τον κόμβο σύνταξης Setext heading."
type: docs

url: /el/java/com.aspose.html.toolkit.markdown.syntax/setextheadingsyntaxnode/
---
## SetextHeadingSyntaxNode class

Αναπαριστά τον κόμβο σύνταξης κεφαλίδας Setext.
...
| [getLevel](../../com.aspose.html.toolkit.markdown.syntax/setextheadingsyntaxnode/level/) Λάβετε το επίπεδο της τρέχουσας σύνταξης. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/setextheadingsyntaxnode/accept/)(MarkdownSyntaxVisitor) | Ορίζει τη διεπαφή για αποδοχή του επισκέπτη. |
