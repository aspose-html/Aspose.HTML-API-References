...
description: "com.aspose.html.toolkit.markdown.syntax.MarkdownSyntaxToken class. Αναπαριστά το Διακριτικό Σύνταξης Markdown"
type: docs
...
| [getSource](../../com.aspose.html.toolkit.markdown.syntax/markdownsyntaxtoken/source/) Λήψη του κειμένου προέλευσης. |
| [getSpan](../../com.aspose.html.toolkit.markdown.syntax/markdownsyntaxtoken/span/) Λήψη του εύρους. |
| [getText](../../com.aspose.html.toolkit.markdown.syntax/markdownsyntaxtoken/text/) Λήψη του κειμενικού περιεχομένου του εύρους. |
