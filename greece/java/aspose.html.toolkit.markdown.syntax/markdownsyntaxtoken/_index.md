---
title: "MarkdownSyntaxToken Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.toolkit.markdown.syntax.MarkdownSyntaxToken κλάση. Αναπαριστά το Markdown Syntax Token"
type: docs

url: /el/java/com.aspose.html.toolkit.markdown.syntax/markdownsyntaxtoken/
---
## MarkdownSyntaxToken class

Αντιπροσωπεύει το Markdown Syntax Token.
...
| [getSource](../../com.aspose.html.toolkit.markdown.syntax/markdownsyntaxtoken/source/) Λαμβάνει το κείμενο προέλευσης. |
| [getSpan](../../com.aspose.html.toolkit.markdown.syntax/markdownsyntaxtoken/span/) Λαμβάνει το εύρος. |
| [getText](../../com.aspose.html.toolkit.markdown.syntax/markdownsyntaxtoken/text/) Λαμβάνει το περιεχόμενο κειμένου του εύρους. |

## Μέθοδοι

| Όνομα | Περιγραφή |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/accept/)(MarkdownSyntaxVisitor) | Αποδεχτείτε τον επισκέπτη. |
...
| [getFullText](../../com.aspose.html.toolkit.markdown.syntax/markdownsyntaxtoken/getfulltext/)() | Ορίζει τη διεπαφή για λήψη του πλήρους κειμένου. |
