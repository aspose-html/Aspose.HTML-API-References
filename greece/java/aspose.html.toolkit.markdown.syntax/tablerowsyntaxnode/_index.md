---
title: "TableRowSyntaxNode Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.toolkit.markdown.syntax.TableRowSyntaxNode κλάση. Ο κόμβος σύνταξης γραμμής πίνακα"
type: docs

url: /el/java/com.aspose.html.toolkit.markdown.syntax/tablerowsyntaxnode/
---
## TableRowSyntaxNode class

Ο κόμβος σύνταξης γραμμής πίνακα.
...
| Όνομα | Περιγραφή |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/blocksyntaxnode/accept/)(MarkdownSyntaxVisitor) | Ορίζει τη διεπαφή για αποδοχή επισκέπτη. |
| [appendCell](../../com.aspose.html.toolkit.markdown.syntax/tablerowsyntaxnode/appendcell/)(TableCellSyntaxNode) | Ορίζει τη διεπαφή για την προσθήκη του κελιού. |
...
| [appendDelimiter](../../com.aspose.html.toolkit.markdown.syntax/tablerowsyntaxnode/appenddelimiter/)(TableDelimiterSyntaxNode) | Ορίζει τη διεπαφή για την προσθήκη οριοθέτη. |
| [childNodes](../../com.aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/childnodes/)() | Λάβετε τη συλλογή των παιδικών κόμβων. |
| [getCells](../../com.aspose.html.toolkit.markdown.syntax/tablerowsyntaxnode/getcells/)() | Ορίζει τη διεπαφή για τη λήψη των κελιών. |
