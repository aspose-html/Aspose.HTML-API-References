---
title: "TableCellSyntaxNode Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.toolkit.markdown.syntax.TableCellSyntaxNode κλάση. Αναπαριστά τον κόμβο σύνταξης κελιού πίνακα"
type: docs

url: /el/java/com.aspose.html.toolkit.markdown.syntax/tablecellsyntaxnode/
---
## TableCellSyntaxNode class

Αναπαριστά τον κόμβο σύνταξης κελιού πίνακα.
...
| [getValue](../../com.aspose.html.toolkit.markdown.syntax/tablecellsyntaxnode/getvalue/)() | Ορίζει τη διεπαφή για λήψη τιμής String. |
