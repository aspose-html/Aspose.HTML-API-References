---
title: "TaskListItemMarker Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.toolkit.markdown.syntax.TaskListItemMarker κλάση. Ο δείκτης στοιχείου λίστας εργασιών"
type: docs

url: /el/java/com.aspose.html.toolkit.markdown.syntax/tasklistitemmarker/
---
## TaskListItemMarker class

Ο δείκτης στοιχείου λίστας εργασιών.
...
| [isChecked](../../com.aspose.html.toolkit.markdown.syntax/tasklistitemmarker/ischecked/)() | Ορίζει τη διεπαφή για λήψη της κατάστασης ελέγχου. |
