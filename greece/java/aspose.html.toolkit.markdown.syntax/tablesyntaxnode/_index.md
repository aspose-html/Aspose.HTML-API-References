---
title: "Κλάση TableSyntaxNode"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.toolkit.markdown.syntax.TableSyntaxNode class. Ο κόμβος κλάσης TableSyntax"
type: docs

url: /el/java/com.aspose.html.toolkit.markdown.syntax/tablesyntaxnode/
---
## TableSyntaxNode class

Ο κόμβος κλάσης TableSyntax.
...
| Όνομα | Περιγραφή |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/tablesyntaxnode/accept/)(MarkdownSyntaxVisitor) | Ορίζει τη διεπαφή για αποδοχή του επισκέπτη. |
...
| [appendRow](../../com.aspose.html.toolkit.markdown.syntax/tablesyntaxnode/appendrow/)(TableRowSyntaxNode) | Ορίζει τη διεπαφή για προσθήκη γραμμής. |
| [childNodes](../../com.aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/childnodes/)() | Λάβετε τη συλλογή των παιδικών κόμβων. |
| [getAlignment](../../com.aspose.html.toolkit.markdown.syntax/tablesyntaxnode/getalignment/)() | Ορίζει τη διεπαφή για λήψη aligment. |
| [getBodyRows](../../com.aspose.html.toolkit.markdown.syntax/tablesyntaxnode/getbodyrows/)() | Ορίζει τη διεπαφή για λήψη γραμμών σώματος. |
| [getHeader](../../com.aspose.html.toolkit.markdown.syntax/tablesyntaxnode/getheader/)() | Ορίζει τη διεπαφή για λήψη κεφαλίδας πίνακα. |
