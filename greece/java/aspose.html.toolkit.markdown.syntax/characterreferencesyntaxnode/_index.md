---
title: "CharacterReferenceSyntaxNode Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.toolkit.markdown.syntax.CharacterReferenceSyntaxNode κλάση. Αντιπροσωπεύει το CharacterReferenceSyntaxNode"
type: docs

url: /el/java/com.aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/
---
## CharacterReferenceSyntaxNode class

Αντιπροσωπεύει το CharacterReferenceSyntaxNode.
...
| [getReference](../../com.aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/reference/) Λάβετε την αναφορά. |
| [getSource](../../com.aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/source/) Λάβετε την πηγή. |
| [getSpan](../../com.aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/span/) Λάβετε το εύρος. |
| [getValue](../../com.aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/value/) Λάβετε την τιμή. |

## Μέθοδοι

| Όνομα | Περιγραφή |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/accept/)(MarkdownSyntaxVisitor) | Ορίζει τη διεπαφή για αποδοχή επισκέπτη. |
