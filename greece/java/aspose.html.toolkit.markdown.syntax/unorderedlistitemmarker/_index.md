---
title: "UnorderedListItemMarker Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.toolkit.markdown.syntax.UnorderedListItemMarker κλάση. Αναπαριστά τη σύνταξη στοιχείου μη ταξινομημένης λίστας"
type: docs

url: /el/java/com.aspose.html.toolkit.markdown.syntax/unorderedlistitemmarker/
---
## UnorderedListItemMarker class

Αναπαριστά τη σύνταξη στοιχείου μη ταξινομημένης λίστας.
