---
title: "TaskListItemSyntaxNode Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.toolkit.markdown.syntax.TaskListItemSyntaxNode class. Η σύνταξη task list item syntax node"
type: docs

url: /el/java/com.aspose.html.toolkit.markdown.syntax/tasklistitemsyntaxnode/
---
## TaskListItemSyntaxNode class

Ο κόμβος σύνταξης στοιχείου λίστας εργασιών.
...
| Όνομα | Περιγραφή |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/listitemsyntaxnode/accept/)(MarkdownSyntaxVisitor) | Ορίζει τη διεπαφή για αποδοχή επισκέπτη. |
...
| [getLinesLeadingTrivia](../../com.aspose.html.toolkit.markdown.syntax/multilinecontainerblocksyntaxnode/getlinesleadingtrivia/)() | Ορίζει τη διεπαφή για λήψη γραμμών που οδηγούν σε trivia. |
| [getMarker](../../com.aspose.html.toolkit.markdown.syntax/listitemsyntaxnode/getmarker/)() | Λήψη marker |
...
| [isChecked](../../com.aspose.html.toolkit.markdown.syntax/tasklistitemsyntaxnode/ischecked/)() | Ορίζει τη διεπαφή για λήψη της κατάστασης ελέγχου. |
| [isTight](../../com.aspose.html.toolkit.markdown.syntax/listitemsyntaxnode/istight/)() | Επιστρέφει true εάν είναι tight. |
