...
description: "com.aspose.html.toolkit.markdown.syntax.TaskListItemSyntaxNode class. Ο κόμβος σύνταξης στοιχείου λίστας εργασιών"
type: docs
...
| [getLinesLeadingTrivia](../../com.aspose.html.toolkit.markdown.syntax/multilinecontainerblocksyntaxnode/getlinesleadingtrivia/)() | Ορίζει τη διεπαφή για λήψη των γραμμών που οδηγούν το trivia. |
| [getMarker](../../com.aspose.html.toolkit.markdown.syntax/listitemsyntaxnode/getmarker/)() | Λήψη δείκτη |
...
| [isTight](../../com.aspose.html.toolkit.markdown.syntax/listitemsyntaxnode/istight/)() | Επιστρέφει true εάν είναι στενό. |
