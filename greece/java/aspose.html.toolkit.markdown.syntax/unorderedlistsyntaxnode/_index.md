---
title: "UnorderedListSyntaxNode Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.toolkit.markdown.syntax.UnorderedListSyntaxNode κλάση. Αναπαριστά τον κόμβο σύνταξης μη ταξινομημένης λίστας"
type: docs

url: /el/java/com.aspose.html.toolkit.markdown.syntax/unorderedlistsyntaxnode/
---
## UnorderedListSyntaxNode class

Αναπαριστά τον κόμβο σύνταξης μη ταξινομημένης λίστας.
...
| Όνομα | Περιγραφή |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/unorderedlistsyntaxnode/accept/)(MarkdownSyntaxVisitor) | Ορίζει τη διεπαφή για την επίσκεψη κόμβων της σύνταξης. |
...
| [getMarker](../../com.aspose.html.toolkit.markdown.syntax/unorderedlistsyntaxnode/getmarker/)() | Ορίζει τη διεπαφή για λήψη του δείκτη. |
...
| [isTight](../../com.aspose.html.toolkit.markdown.syntax/listsyntaxnode/istight/)() | Ορίζει τη διεπαφή για λήψη is tight. |
