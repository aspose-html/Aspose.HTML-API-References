---
title: "TextSyntaxNode κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.toolkit.markdown.syntax.textSyntaxNode κλάση. Υλοποιεί τον κόμβο σύνταξης κειμένου"
type: docs

url: /el/java/com.aspose.html.toolkit.markdown.syntax/textsyntaxnode/
---
## TextSyntaxNode class

Υλοποιήθηκε ο κόμβος σύνταξης κειμένου.
...
| Όνομα | Περιγραφή |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/textsyntaxnode/accept/)(MarkdownSyntaxVisitor) | Ορίζει τη διεπαφή για αποδοχή επισκέπτη. |
