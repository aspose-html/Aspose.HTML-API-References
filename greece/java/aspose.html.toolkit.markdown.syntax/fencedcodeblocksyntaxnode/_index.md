---
title: "FencedCodeBlockSyntaxNode Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.toolkit.markdown.syntax.FencedCodeBlockSyntaxNode κλάση. Αντιπροσωπεύει το FencedCodeBlockSyntaxNode"
type: docs

url: /el/java/com.aspose.html.toolkit.markdown.syntax/fencedcodeblocksyntaxnode/
---
## FencedCodeBlockSyntaxNode class

Αντιπροσωπεύει το FencedCodeBlockSyntaxNode.
...
| Όνομα | Περιγραφή |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/fencedcodeblocksyntaxnode/accept/)(MarkdownSyntaxVisitor) | Ορίζει τη διεπαφή για αποδοχή επισκέπτη. |
...
| [getClosingTag](../../com.aspose.html.toolkit.markdown.syntax/fencedcodeblocksyntaxnode/getclosingtag/)() | Ορίζει τη διεπαφή για λήψη του Closing Tag. |
| [getContent](../../com.aspose.html.toolkit.markdown.syntax/fencedcodeblocksyntaxnode/getcontent/)() | Ορίζει τη διεπαφή για λήψη του Content. |
| [getInfo](../../com.aspose.html.toolkit.markdown.syntax/fencedcodeblocksyntaxnode/getinfo/)() | Ορίζει τη διεπαφή για λήψη του Info. |
| [getLeadingTrivia](../../com.aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/getleadingtrivia/)() | Λάβετε τα αρχικά trivia. |
| [getOpeningTag](../../com.aspose.html.toolkit.markdown.syntax/fencedcodeblocksyntaxnode/getopeningtag/)() | Ορίζει τη διεπαφή για λήψη του Opening Tag. |
