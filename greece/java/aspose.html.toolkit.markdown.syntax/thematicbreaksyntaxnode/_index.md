...
Υλοποιήθηκε ο κόμβος σύνταξης θεματικού διαχωρισμού.
...
| Όνομα | Περιγραφή |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/thematicbreaksyntaxnode/accept/)(MarkdownSyntaxVisitor) | Ορίζει τη διεπαφή για τον επισκέπτη Accept. |
