---
title: "BlockProxy Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.toolkit.markdown.syntax.BlockProxy κλάση. Αναπαριστά το BlockProxy"
type: docs

url: /el/java/com.aspose.html.toolkit.markdown.syntax/blockproxy/
---
## BlockProxy class

Αντιπροσωπεύει το BlockProxy.
...
| Όνομα | Περιγραφή |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/blockproxy/accept/)(MarkdownSyntaxVisitor) | Ορίζει τη διεπαφή για αποδοχή επισκέπτη. |
...
| [getTarget](../../com.aspose.html.toolkit.markdown.syntax/blockproxy/gettarget/)() | Λάβετε τον κόμβο-στόχο. |
...
| [writeTo](../../com.aspose.html.toolkit.markdown.syntax/blockproxy/writeto/#writeto)(MarkdownTextWriter) | Ορίζει τη διεπαφή για Write To writer. |
