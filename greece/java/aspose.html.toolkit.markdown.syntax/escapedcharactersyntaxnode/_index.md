...
description: "com.aspose.html.toolkit.markdown.syntax.EscapedCharacterSyntaxNode class. Υλοποιήθηκε ο κόμβος σύνταξης χαρακτήρα διαφυγής"
type: docs
...
| [getSpan](../../com.aspose.html.toolkit.markdown.syntax/textsyntaxnode/span/) Ορίζει τη διεπαφή για λήψη του span. |
| [getValue](../../com.aspose.html.toolkit.markdown.syntax/textsyntaxnode/value/) Ορίζει την ιδιότητα για λήψη της τιμής String. |
