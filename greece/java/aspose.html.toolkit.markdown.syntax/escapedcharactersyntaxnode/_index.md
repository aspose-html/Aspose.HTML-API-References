---
title: "EscapedCharacterSyntaxNode Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.toolkit.markdown.syntax.EscapedCharacterSyntaxNode class. Υλοποιεί το escape character syntax node"
type: docs

url: /el/java/com.aspose.html.toolkit.markdown.syntax/escapedcharactersyntaxnode/
---
## EscapedCharacterSyntaxNode class

Υλοποιήθηκε ο κόμβος σύνταξης χαρακτήρα διαφυγής.
...
| [getSource](../../com.aspose.html.toolkit.markdown.syntax/textsyntaxnode/source/) Επιστρέφει το κείμενο προέλευσης. |
| [getSpan](../../com.aspose.html.toolkit.markdown.syntax/textsyntaxnode/span/) Ορίζει τη διεπαφή για λήψη span. |
| [getValue](../../com.aspose.html.toolkit.markdown.syntax/textsyntaxnode/value/) Ορίζει την ιδιότητα για λήψη τιμής String. |

## Μέθοδοι

| Όνομα | Περιγραφή |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/escapedcharactersyntaxnode/accept/)(MarkdownSyntaxVisitor) | Ορίζει τη διεπαφή για αποδοχή επισκέπτη. |
