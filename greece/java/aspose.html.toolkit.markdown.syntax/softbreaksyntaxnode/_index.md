---
title: "SoftBreakSyntaxNode Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.toolkit.markdown.syntax.SoftBreakSyntaxNode class. Αναπαριστά τη σύνταξη ήπιας διακοπής"
type: docs

url: /el/java/com.aspose.html.toolkit.markdown.syntax/softbreaksyntaxnode/
---
## SoftBreakSyntaxNode class

Αναπαριστά τη σύνταξη ήπιας διακοπής.
...
| Όνομα | Περιγραφή |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/softbreaksyntaxnode/accept/)(MarkdownSyntaxVisitor) | Ορίζει τη διεπαφή για αποδοχή του επισκέπτη. |
