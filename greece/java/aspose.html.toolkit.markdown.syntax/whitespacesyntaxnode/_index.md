---
title: "Κλάση WhitespaceSyntaxNode"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.toolkit.markdown.syntax.WhitespaceSyntaxNode κλάση. Αντιπροσωπεύει τον κόμβο σύνταξης whitespace"
type: docs

url: /el/java/com.aspose.html.toolkit.markdown.syntax/whitespacesyntaxnode/
---
## WhitespaceSyntaxNode class

Αναπαριστά τον κόμβο σύνταξης κενών χαρακτήρων.
...
| Όνομα | Περιγραφή |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/whitespacesyntaxnode/accept/)(MarkdownSyntaxVisitor) | Ορίζει τη διεπαφή για την επίσκεψη κόμβων της σύνταξης. |
