...
description: "Μέθοδος MarkdownSyntaxFactory. Δημιουργεί InlineImageSyntaxNode"
type: docs

url: /el/java/com.aspose.html.toolkit.markdown.syntax/markdownsyntaxfactory/inlineimage/
---
## InlineImage(String, String, String) {#inlineimage_1}

Δημιουργεί [`InlineImageSyntaxNode`](../../inlineimagesyntaxnode/).
...
| --- | --- | --- |
| altText | String | Το εναλλακτικό κείμενο. |
| href | String | Το URL της εικόνας. |
| τίτλος | String | Ο τίτλος. |

### Τιμή Επιστροφής

Το InlineImageSyntax.
