...
description: "MarkdownSyntaxFactory μέθοδος. Δημιουργεί TextSyntaxNode"
type: docs

url: /el/java/com.aspose.html.toolkit.markdown.syntax/markdownsyntaxfactory/escapedcharacter/
---
## EscapedCharacter(char) {#escapedcharacter_1}

Δημιουργεί [`TextSyntaxNode`](../../textsyntaxnode/).
...
| --- | --- | --- |
| escapedChar | Char | Το escapedChar. |
...
| Parameter | Type | Περιγραφή |
| --- | --- | --- |
| source | SourceText | Το SourceText. |
| span | TextSpan | Το TextSpan. |
