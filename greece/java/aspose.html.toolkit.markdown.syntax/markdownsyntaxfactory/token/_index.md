...
description: "MarkdownSyntaxFactory μέθοδος. Δημιουργεί MarkdownSyntaxToken"
type: docs

url: /el/java/com.aspose.html.toolkit.markdown.syntax/markdownsyntaxfactory/token/
---
## Token(SourceText, TextSpan) {#token_1}

Δημιουργεί [`MarkdownSyntaxToken`](../../markdownsyntaxtoken/).
