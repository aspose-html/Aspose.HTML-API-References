---
title: "ReferenceLinkSyntaxNode Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.toolkit.markdown.syntax.ReferenceLinkSyntaxNode κλάση. Αντιπροσωπεύει τη σύνταξη του συνδέσμου αναφοράς"
type: docs

url: /el/java/com.aspose.html.toolkit.markdown.syntax/referencelinksyntaxnode/
---
## ReferenceLinkSyntaxNode class

Αναπαριστά τη σύνταξη συνδέσμου αναφοράς.
...
| Όνομα | Περιγραφή |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/referencelinksyntaxnode/accept/)(MarkdownSyntaxVisitor) | Ορίζει τη διεπαφή για αποδοχή του visitor. |
...
| [getContent](../../com.aspose.html.toolkit.markdown.syntax/referencelinksyntaxnode/getcontent/)() | Ορίζει τη διεπαφή για λήψη του content. |
| [getLabel](../../com.aspose.html.toolkit.markdown.syntax/referencelinksyntaxnode/getlabel/)() | Ορίζει τη διεπαφή για λήψη ετικέτας. |
