...
description: "com.aspose.html.toolkit.markdown.syntax.ReferenceLinkSyntaxNode κλάση. Αναπαριστά τη σύνταξη του reference link."
type: docs
...
| Όνομα | Περιγραφή |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/referencelinksyntaxnode/accept/)(MarkdownSyntaxVisitor) | Ορίζει τη διεπαφή για αποδοχή του επισκέπτη. |
...
| [getContent](../../com.aspose.html.toolkit.markdown.syntax/referencelinksyntaxnode/getcontent/)() | Ορίζει τη διεπαφή για get content. |
| [getLabel](../../com.aspose.html.toolkit.markdown.syntax/referencelinksyntaxnode/getlabel/)() | Ορίζει τη διεπαφή για λήψη της ετικέτας. |
