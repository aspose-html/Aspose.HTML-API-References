---
title: "OrderedListItemMarker Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.toolkit.markdown.syntax.OrderedListItemMarker κλάση. Αναπαριστά το δείκτη στοιχείου ταξινομημένης λίστας"
type: docs

url: /el/java/com.aspose.html.toolkit.markdown.syntax/orderedlistitemmarker/
---
## OrderedListItemMarker class

Αναπαριστά το σημάδι στοιχείου ταξινομημένης λίστας.
...
| [getDelimiter](../../com.aspose.html.toolkit.markdown.syntax/orderedlistitemmarker/getdelimiter/)() | Ορίζει τη διεπαφή για τη λήψη του οριοθέτη. |
| [getIndex](../../com.aspose.html.toolkit.markdown.syntax/orderedlistitemmarker/getindex/)() | Ορίζει τη διεπαφή για τη λήψη του δείκτη λήψης. |
