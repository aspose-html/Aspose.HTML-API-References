---
title: "Διεπαφή IUserAgentService"
...
| [getFontsSettings](../../com.aspose.html.services/iuseragentservice/fontssettings/) Λαμβάνει ένα αντικείμενο του [`FontsSettings`](../../com.aspose.html/fontssettings/) που χρησιμοποιείται για τη διαμόρφωση της διαχείρισης γραμματοσειρών. |
[getLanguage]
