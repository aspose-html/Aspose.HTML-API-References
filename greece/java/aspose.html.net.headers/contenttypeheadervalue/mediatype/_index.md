...
description: "ContentTypeHeaderValue ιδιότητα. Ανακτά ή ορίζει τον τύπο μέσου για το περιεχόμενο"
type: docs

url: /el/java/com.aspose.html.net.headers/contenttypeheadervalue/mediatype/
---
## ContentTypeHeaderValue.MediaType property

Ανακτά ή ορίζει τον τύπο μέσου για το περιεχόμενο.
