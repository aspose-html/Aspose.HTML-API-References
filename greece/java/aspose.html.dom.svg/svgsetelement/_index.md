---
title: "Κλάση SVGSetElement"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "κλάση com.aspose.html.dom.svg.SVGSetElement. Η διεπαφή SVGSetElement αντιστοιχεί στο στοιχείο set. Η αντικειμενοστραφής πρόσβαση στα χαρακτηριστικά του στοιχείου set μέσω του SVG DOM δεν είναι διαθέσιμη"
type: docs

url: /el/java/com.aspose.html.dom.svg/svgsetelement/
---
## SVGSetElement class

Η διεπαφή SVGSetElement αντιστοιχεί στο στοιχείο ‘set’. Η πρόσβαση αντικειμενοστραφώς στα χαρακτηριστικά του στοιχείου ‘set’ μέσω του SVG DOM δεν είναι διαθέσιμη.
