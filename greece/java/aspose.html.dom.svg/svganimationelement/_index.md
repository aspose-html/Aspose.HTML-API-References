---
title: "Κλάση SVGAnimationElement"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "Κλάση com.aspose.html.dom.svg.SVGAnimationElement. Η διεπαφή SVGAnimationElement είναι η βασική διεπαφή για όλες τις διεπαφές στοιχείων κίνησης SVGAnimateElement, SVGSetElement, SVGAnimateColorElement, SVGAnimateMotionElement και SVGAnimateTransformElement"
type: docs

url: /el/java/com.aspose.html.dom.svg/svganimationelement/
---
## SVGAnimationElement class

Η διεπαφή SVGAnimationElement είναι η βασική διεπαφή για όλες τις διεπαφές στοιχείων κίνησης: SVGAnimateElement, SVGSetElement, SVGAnimateColorElement, SVGAnimateMotionElement και SVGAnimateTransformElement.
...
| [getRequiredExtensions](../../com.aspose.html.dom.svg/svganimationelement/requiredextensions/) Αντιστοιχεί στο χαρακτηριστικό ‘requiredExtensions’ του συγκεκριμένου στοιχείου. |
| [getRequiredFeatures](../../com.aspose.html.dom.svg/svganimationelement/requiredfeatures/) Αντιστοιχεί στο χαρακτηριστικό ‘requiredFeatures’ του συγκεκριμένου στοιχείου. |
...
| [getSystemLanguage](../../com.aspose.html.dom.svg/svganimationelement/systemlanguage/) Αντιστοιχεί στο χαρακτηριστικό ‘systemLanguage’ του συγκεκριμένου στοιχείου. |
| [getTagName](../../com.aspose.html.dom/element/tagname/) Το όνομα του στοιχείου. |
| [getTargetElement](../../com.aspose.html.dom.svg/svganimationelement/targetelement/) Το στοιχείο που κινείται. |
