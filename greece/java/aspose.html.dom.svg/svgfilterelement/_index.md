...
| [getFilterUnits](../../com.aspose.html.dom.svg/svgfilterelement/filterunits/) Αντιστοιχεί στο χαρακτηριστικό ‘filterUnits’ του δεδομένου στοιχείου ‘filter’. Δέχεται μία από τις σταθερές που ορίζονται στο SVGUnitTypes. |
...
| [getPrimitiveUnits](../../com.aspose.html.dom.svg/svgfilterelement/primitiveunits/) Αντιστοιχεί στο χαρακτηριστικό ‘primitiveUnits’ του δεδομένου στοιχείου ‘filter’. Δέχεται μία από τις σταθερές που ορίζονται στο SVGUnitTypes. |
...
| [X](../../com.aspose.html.dom.svg/svgfilterelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘x’ του δοσμένου στοιχείου ‘filter’. |
| [Y](../../com.aspose.html.dom.svg/svgfilterelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘y’ του δοσμένου στοιχείου ‘filter’. |
