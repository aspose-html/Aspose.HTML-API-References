---
title: "SVGFilterElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.dom.svg.SVGFilterElement κλάση. Η διεπαφή SVGFilterElement αντιστοιχεί στο στοιχείο filter."
type: docs

url: /el/java/com.aspose.html.dom.svg/svgfilterelement/
---
## SVGFilterElement class

Η διεπαφή SVGFilterElement αντιστοιχεί στο στοιχείο ‘filter’.
...
| [getFilterUnits](../../com.aspose.html.dom.svg/svgfilterelement/filterunits/) Αντιστοιχεί στο χαρακτηριστικό ‘filterUnits’ του δεδομένου στοιχείου ‘filter’. Παίρνει μία από τις σταθερές που ορίζονται στο SVGUnitTypes. |
...
| [getHeight](../../com.aspose.html.dom.svg/svgfilterelement/height/) Αντιστοιχεί στο χαρακτηριστικό ‘height’ του δεδομένου στοιχείου ‘filter’. |
| [getHref](../../com.aspose.html.dom.svg/svgfilterelement/href/) Αντιστοιχεί στο χαρακτηριστικό ‘xlink:href’ του δεδομένου στοιχείου. |
[getId]
...
| [getPrimitiveUnits](../../com.aspose.html.dom.svg/svgfilterelement/primitiveunits/) Αντιστοιχεί στο χαρακτηριστικό ‘primitiveUnits’ του δεδομένου στοιχείου ‘filter’. Παίρνει μία από τις σταθερές που ορίζονται στο SVGUnitTypes. |
...
| [getWidth](../../com.aspose.html.dom.svg/svgfilterelement/width/) Αντιστοιχεί στο χαρακτηριστικό ‘width’ του δεδομένου στοιχείου ‘filter’. |
| [X](../../com.aspose.html.dom.svg/svgfilterelement/x/) { get; } | Corresponds to attribute ‘x’ on the given ‘filter’ element. Αντιστοιχεί στο χαρακτηριστικό ‘x’ του δοσμένου στοιχείου ‘filter’. |
| [Y](../../com.aspose.html.dom.svg/svgfilterelement/y/) { get; } | Corresponds to attribute ‘y’ on the given ‘filter’ element. Αντιστοιχεί στο χαρακτηριστικό ‘y’ του δοσμένου στοιχείου ‘filter’. |
