---
title: "Κλάση SVGTextPathElement"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.dom.svg.SVGTextPathElement κλάση. Η διεπαφή SVGTextPathElement αντιστοιχεί στο στοιχείο textPath."
type: docs

url: /el/java/com.aspose.html.dom.svg/svgtextpathelement/
---
...
| [getClassName](../../com.aspose.html.dom.svg/svgelement/classname/) Αντιστοιχεί στο χαρακτηριστικό ‘class’ του δεδομένου στοιχείου. |
[getClassName]
...
| [getFarthestViewportElement](../../com.aspose.html.dom.svg/svggraphicselement/farthestviewportelement/) Το πιο απομακρυσμένο πρόγονο στοιχείο ‘svg’. Null εάν το τρέχον στοιχείο είναι το εξωτερικότερο στοιχείο svg. |
...
| [getHref](../../com.aspose.html.dom.svg/svgtextpathelement/href/) Αντιστοιχεί στο χαρακτηριστικό ‘xlink:href’ στο δεδομένο στοιχείο. |
[getId]
...
| [getLengthAdjust](../../com.aspose.html.dom.svg/svgtextcontentelement/lengthadjust/) Αντιστοιχεί στο χαρακτηριστικό ‘lengthAdjust’ του δεδομένου στοιχείου. Η τιμή πρέπει να είναι μία από τις σταθερές ρυθμίσεων μήκους που ορίζονται σε αυτή τη διεπαφή. |
...
| [getMethod](../../com.aspose.html.dom.svg/svgtextpathelement/method/) Αντιστοιχεί στο χαρακτηριστικό ‘method’ στο δεδομένο στοιχείο ‘textPath’. |
| [getNamespaceURI](../../com.aspose.html.dom/element/packageuri/) Το URI του πακέτου αυτού του κόμβου, ή null εάν δεν έχει οριστεί. |
| [getNearestViewportElement](../../com.aspose.html.dom.svg/svggraphicselement/nearestviewportelement/) Το στοιχείο που καθόρισε το τρέχον viewport. Συχνά, το πιο κοντινό πρόγονο στοιχείο ‘svg’. Null εάν το τρέχον στοιχείο είναι το εξωτερικότερο στοιχείο svg. |
...
| [getOwnerSVGElement](../../com.aspose.html.dom.svg/svgelement/ownersvgelement/) Το πλησιέστερο πρόγονο στοιχείο ‘svg’. Null εάν το δοσμένο στοιχείο είναι το εξωτερικότερο στοιχείο svg. |
...
| [getRequiredExtensions](../../com.aspose.html.dom.svg/svggraphicselement/requiredextensions/) Αντιστοιχεί στο χαρακτηριστικό ‘requiredExtensions’ του δεδομένου στοιχείου. |
| [getRequiredFeatures](../../com.aspose.html.dom.svg/svggraphicselement/requiredfeatures/) Αντιστοιχεί στο χαρακτηριστικό ‘requiredFeatures’ του δεδομένου στοιχείου. |
...
| [getSpacing](../../com.aspose.html.dom.svg/svgtextpathelement/spacing/) Αντιστοιχεί στο χαρακτηριστικό ‘spacing’ στο δεδομένο στοιχείο ‘textPath’. |
| [getStartOffset](../../com.aspose.html.dom.svg/svgtextpathelement/startoffset/) Αντιστοιχεί στο χαρακτηριστικό ‘startOffset’ στο δεδομένο στοιχείο ‘textPath’. |
| [getStyle](../../com.aspose.html.dom.svg/svgelement/style/) Αντιστοιχεί στο χαρακτηριστικό ‘style’ του δοσμένου στοιχείου. Εάν ο πράκτορας χρήστη δεν υποστηρίζει στυλ με CSS, τότε αυτό το χαρακτηριστικό πρέπει πάντα να έχει τιμή null. |
| [getSystemLanguage](../../com.aspose.html.dom.svg/svggraphicselement/systemlanguage/) Αντιστοιχεί στο χαρακτηριστικό ‘systemLanguage’ του δεδομένου στοιχείου. |
...
| [getTextLength](../../com.aspose.html.dom.svg/svgtextcontentelement/textlength/) Αντιστοιχεί στο χαρακτηριστικό ‘textLength’ του δεδομένου στοιχείου. |
| [getTransform](../../com.aspose.html.dom.svg/svggraphicselement/transform/) Αντιστοιχεί στο χαρακτηριστικό ‘transform’ του δεδομένου στοιχείου. |
| [getViewportElement](../../com.aspose.html.dom.svg/svgelement/viewportelement/) Το στοιχείο που καθόρισε το τρέχον viewport. Συχνά, το πλησιέστερο πρόγονο στοιχείο ‘svg’. Null εάν το δοσμένο στοιχείο είναι το εξωτερικότερο στοιχείο svg. |
...
| [getBBox](../../com.aspose.html.dom.svg/svggraphicselement/getbbox/)() | Επιστρέφει το ακριβές πλαίσιο περιγράμματος στον τρέχοντα χώρο χρήστη (δηλαδή, μετά την εφαρμογή του χαρακτηριστικού ‘transform’, εφόσον υπάρχει) στη γεωμετρία όλων των περιεχόμενων στοιχείων γραφικών, εξαιρουμένου του περιγράμματος, της αποκοπής, της μάσκας και των εφέ φίλτρου. Σημειώστε ότι η μέθοδος getBBox πρέπει να επιστρέφει το πραγματικό πλαίσιο περιγράμματος τη στιγμή που κλήθηκε, ακόμη και αν το στοιχείο δεν έχει ακόμη αποδοθεί. |
| [getComputedTextLength](../../com.aspose.html.dom.svg/svgtextcontentelement/getcomputedtextlength/)() | Το συνολικό άθροισμα όλων των τιμών προόδου από την απόδοση όλων των χαρακτήρων μέσα σε αυτό το στοιχείο, συμπεριλαμβανομένης της τιμής προόδου στα γλύφους (οριζόντια ή κάθετη), της επίδρασης των ιδιοτήτων ‘kerning’, ‘letter-spacing’ και ‘word-spacing’ και των προσαρμογών λόγω των χαρακτηριστικών ‘dx’ και ‘dy’ στα στοιχεία ‘tspan’. Για περιβάλλοντα χωρίς απόδοση, ο πράκτορας χρήστη πρέπει να κάνει λογικές υποθέσεις σχετικά με τις μετρικές των γλύφων. |
| [getCTM](../../com.aspose.html.dom.svg/svggraphicselement/getctm/)() | Επιστρέφει τον πίνακα μετασχηματισμού από τις τρέχουσες μονάδες χρήστη (δηλαδή, μετά την εφαρμογή του χαρακτηριστικού ‘transform’, εφόσον υπάρχει) στο σύστημα συντεταγμένων του viewport για το nearestViewportElement. |
...
| [getNumberOfChars](../../com.aspose.html.dom.svg/svgtextcontentelement/getnumberofchars/)() | Επιστρέφει το συνολικό αριθμό χαρακτήρων διαθέσιμων για απόδοση εντός του τρέχοντος στοιχείου, που περιλαμβάνει τους αναφερόμενους χαρακτήρες από την αναφορά ‘tref’, ανεξάρτητα από το αν θα αποδοθούν. Στην ουσία, αυτό ισοδυναμεί με το μήκος του χαρακτηριστικού Node::textContent από το DOM Level 3 Core ([DOM3], ενότητα 1.4), εάν αυτό το χαρακτηριστικό επίσης επεκτείνει τα στοιχεία ‘tref’. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| const [TEXTPATH_METHODTYPE_ALIGN](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_align/) | Αντιστοιχεί στην τιμή 'align'. |
| const [TEXTPATH_METHODTYPE_STRETCH](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_stretch/) | Αντιστοιχεί στην τιμή 'stretch'. |
| const [TEXTPATH_METHODTYPE_UNKNOWN](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_unknown/) | Η απαρίθμηση ορίστηκε σε τιμή που δεν είναι μία από τις προκαθορισμένες τιμές. Είναι άκυρο να προσπαθήσετε να ορίσετε μια νέα τιμή αυτού του τύπου ή να προσπαθήσετε να αλλάξετε μια υπάρχουσα τιμή σε αυτόν τον τύπο. |
| const [TEXTPATH_SPACINGTYPE_AUTO](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_auto/) | Αντιστοιχεί στην τιμή 'auto'. |
| const [TEXTPATH_SPACINGTYPE_EXACT](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_exact/) | Αντιστοιχεί στην τιμή 'exact'. |
| const [TEXTPATH_SPACINGTYPE_UNKNOWN](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_unknown/) | Η απαρίθμηση ορίστηκε σε τιμή που δεν είναι μία από τις προκαθορισμένες τιμές. Είναι άκυρο να προσπαθήσετε να ορίσετε μια νέα τιμή αυτού του τύπου ή να προσπαθήσετε να αλλάξετε μια υπάρχουσα τιμή σε αυτόν τον τύπο. |
