---
title: "SVGTextPathElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.dom.svg.SVGTextPathElement class. Η διεπαφή SVGTextPathElement αντιστοιχεί στο στοιχείο textPath."
type: docs
...
| [getFarthestViewportElement](../../com.aspose.html.dom.svg/svggraphicselement/farthestviewportelement/) Το πιο απομακρυσμένο προγονικό στοιχείο ‘svg’. Null εάν το τρέχον στοιχείο είναι το εξωτερικότερο στοιχείο svg. |
...
| [getHref](../../com.aspose.html.dom.svg/svgtextpathelement/href/) Αντιστοιχεί στο χαρακτηριστικό ‘xlink:href’ του συγκεκριμένου στοιχείου. |
[getId]
...
| [getMethod](../../com.aspose.html.dom.svg/svgtextpathelement/method/) Αντιστοιχεί στο χαρακτηριστικό ‘method’ του συγκεκριμένου στοιχείου ‘textPath’. |
| [getNamespaceURI](../../com.aspose.html.dom/element/packageuri/) Το URI του πακέτου αυτού του κόμβου, ή null εάν δεν έχει οριστεί. |
| [getNearestViewportElement](../../com.aspose.html.dom.svg/svggraphicselement/nearestviewportelement/) Το στοιχείο που καθόρισε το τρέχον viewport. Συχνά, το πιο κοντινό προγονικό στοιχείο ‘svg’. Null εάν το τρέχον στοιχείο είναι το εξωτερικότερο στοιχείο svg. |
...
| [getSpacing](../../com.aspose.html.dom.svg/svgtextpathelement/spacing/) Αντιστοιχεί στο χαρακτηριστικό ‘spacing’ του συγκεκριμένου στοιχείου ‘textPath’. |
| [getStartOffset](../../com.aspose.html.dom.svg/svgtextpathelement/startoffset/) Αντιστοιχεί στο χαρακτηριστικό ‘startOffset’ του συγκεκριμένου στοιχείου ‘textPath’. |
| [getStyle](../../com.aspose.html.dom.svg/svgelement/style/) Αντιστοιχεί στο χαρακτηριστικό ‘style’ του δοσμένου στοιχείου. Εάν ο χρήστης-πράκτορας δεν υποστηρίζει στυλ με CSS, τότε αυτό το χαρακτηριστικό πρέπει πάντα να έχει τιμή null. |
...
| [getBBox](../../com.aspose.html.dom.svg/svggraphicselement/getbbox/)() | Επιστρέφει το ακριβές πλαίσιο περιορισμού στο τρέχον χώρο χρήστη (δηλαδή, μετά την εφαρμογή του χαρακτηριστικού ‘transform’, εάν υπάρχει) στη γεωμετρία όλων των περιεχόμενων στοιχείων γραφικών, εξαιρουμένων των περιγράμματος, αποκοπής, μάσκας και εφέ φίλτρου). Σημειώστε ότι η μέθοδος getBBox πρέπει να επιστρέφει το πραγματικό πλαίσιο περιορισμού τη στιγμή που κλήθηκε, ακόμη και αν το στοιχείο δεν έχει ακόμη αποδοθεί. |
| [getComputedTextLength](../../com.aspose.html.dom.svg/svgtextcontentelement/getcomputedtextlength/)() | Το συνολικό άθροισμα όλων των τιμών προόδου από την απόδοση όλων των χαρακτήρων εντός αυτού του στοιχείου, συμπεριλαμβανομένης της τιμής προόδου στα γλύφους (οριζόντια ή κάθετη), της επίδρασης των ιδιοτήτων ‘kerning’, ‘letter-spacing’ και ‘word-spacing’ και των προσαρμογών λόγω των χαρακτηριστικών ‘dx’ και ‘dy’ στα στοιχεία ‘tspan’. Για περιβάλλοντα που δεν πραγματοποιούν απόδοση, ο πράκτορας χρήστη πρέπει να κάνει λογικές υποθέσεις σχετικά με τις μετρήσεις των γλύφων. |
| [getCTM](../../com.aspose.html.dom.svg/svggraphicselement/getctm/)() | Επιστρέφει τον πίνακα μετασχηματισμού από τις τρέχουσες μονάδες χρήστη (δηλαδή, μετά την εφαρμογή του χαρακτηριστικού ‘transform’, εάν υπάρχει) στο σύστημα συντεταγμένων του viewport για το nearestViewportElement. |
...
| [getNumberOfChars](../../com.aspose.html.dom.svg/svgtextcontentelement/getnumberofchars/)() | Επιστρέφει το συνολικό αριθμό χαρακτήρων που είναι διαθέσιμοι για απόδοση εντός του τρέχοντος στοιχείου, συμπεριλαμβανομένων των χαρακτήρων που αναφέρονται από την αναφορά ‘tref’, ανεξάρτητα από το αν θα αποδοθούν. Στην ουσία, αυτό ισοδυναμεί με το μήκος του χαρακτηριστικού Node::textContent από το DOM Level 3 Core ([DOM3], ενότητα 1.4), εάν αυτό το χαρακτηριστικό επεκτείνει επίσης τα στοιχεία ‘tref’. |
...
| const [TEXTPATH_METHODTYPE_UNKNOWN](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_unknown/) | Η απαρίθμηση ορίστηκε σε τιμή που δεν είναι μία από τις προκαθορισμένες τιμές. Είναι μη έγκυρο να προσπαθήσετε να ορίσετε μια νέα τιμή αυτού του τύπου ή να προσπαθήσετε να αλλάξετε μια υπάρχουσα τιμή σε αυτόν τον τύπο. |
