---
title: "SVGRadialGradientElement κλάση"
...
| [getGradientUnits](../../com.aspose.html.dom.svg/svggradientelement/gradientunits/) Αντιστοιχεί στο χαρακτηριστικό ‘gradientUnits’ του δεδομένου στοιχείου. Παίρνει μία από τις σταθερές που ορίζονται στο SVGUnitTypes. |
...
| [getSpreadMethod](../../com.aspose.html.dom.svg/svggradientelement/spreadmethod/) Αντιστοιχεί στο χαρακτηριστικό ‘spreadMethod’ του συγκεκριμένου στοιχείου. Ένας από τους τύπους Spread Method που ορίζονται σε αυτό το interface. |
