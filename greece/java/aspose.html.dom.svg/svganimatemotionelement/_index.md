---
title: "SVGAnimateMotionElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.dom.svg.SVGAnimateMotionElement κλάση. Η διεπαφή SVGAnimateMotionElement αντιστοιχεί στο στοιχείο animateMotion. Η αντικειμενοστραφής πρόσβαση στα χαρακτηριστικά του στοιχείου animateMotion μέσω του SVG DOM δεν είναι διαθέσιμη."
type: docs

url: /el/java/com.aspose.html.dom.svg/svganimatemotionelement/
---
## SVGAnimateMotionElement class

Η διεπαφή SVGAnimateMotionElement αντιστοιχεί στο στοιχείο ‘animateMotion’. Η αντικειμενοστραφής πρόσβαση στα χαρακτηριστικά του στοιχείου ‘animateMotion’ μέσω του SVG DOM δεν είναι διαθέσιμη.
