---
title: "SVGGradientElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.dom.svg.SVGGradientElement κλάση. Η διεπαφή SVGGradientElement είναι μια βασική διεπαφή που χρησιμοποιείται από τις SVGLinearGradientElement και SVGRadialGradientElement."
type: docs
...
| const [SVG_SPREADMETHOD_UNKNOWN](../../com.aspose.html.dom.svg/svggradientelement/svg_spreadmethod_unknown/) | Ο τύπος δεν είναι ένας από τους προκαθορισμένους τύπους. Είναι άκυρο να προσπαθήσετε να ορίσετε μια νέα τιμή αυτού του τύπου ή να προσπαθήσετε να αλλάξετε μια υπάρχουσα τιμή σε αυτόν τον τύπο. |
