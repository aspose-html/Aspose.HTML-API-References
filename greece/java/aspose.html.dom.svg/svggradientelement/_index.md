---
title: "Κλάση SVGGradientElement"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "κλάση com.aspose.html.dom.svg.SVGGradientElement. Η διεπαφή SVGGradientElement είναι μια βασική διεπαφή που χρησιμοποιείται από τις SVGLinearGradientElement και SVGRadialGradientElement."
type: docs

url: /el/java/com.aspose.html.dom.svg/svggradientelement/
---
## SVGGradientElement class

Η διεπαφή SVGGradientElement είναι μια βασική διεπαφή που χρησιμοποιείται από τις SVGLinearGradientElement και SVGRadialGradientElement.
...
| Όνομα | Περιγραφή |
| --- | --- |
| const [SVG_SPREADMETHOD_PAD](../../com.aspose.html.dom.svg/svggradientelement/svg_spreadmethod_pad/) | Αντιστοιχεί στην τιμή 'pad'. |
| const [SVG_SPREADMETHOD_REFLECT](../../com.aspose.html.dom.svg/svggradientelement/svg_spreadmethod_reflect/) | Αντιστοιχεί στην τιμή 'reflect'. |
| const [SVG_SPREADMETHOD_REPEAT](../../com.aspose.html.dom.svg/svggradientelement/svg_spreadmethod_repeat/) | Αντιστοιχεί στην τιμή 'repeat'. |
| const [SVG_SPREADMETHOD_UNKNOWN](../../com.aspose.html.dom.svg/svggradientelement/svg_spreadmethod_unknown/) | Ο τύπος δεν είναι ένας από τους προκαθορισμένους τύπους. Είναι μη έγκυρο να προσπαθήσετε να ορίσετε μια νέα τιμή αυτού του τύπου ή να προσπαθήσετε να αλλάξετε μια υπάρχουσα τιμή σε αυτόν τον τύπο. |
