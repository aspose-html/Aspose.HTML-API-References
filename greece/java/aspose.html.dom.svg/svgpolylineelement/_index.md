---
title: "SVGPolylineElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.dom.svg.SVGPolylineElement class. Η διεπαφή SVGPolylineElement αντιστοιχεί στο στοιχείο polyline."
type: docs

url: /el/java/com.aspose.html.dom.svg/svgpolylineelement/
---
...
| Όνομα | Περιγραφή |
| --- | --- |
| [getAnimatedPoints](../../com.aspose.html.dom.svg/svgpolylineelement/animatedpoints/) Παρέχει πρόσβαση στα τρέχοντα κινούμενα περιεχόμενα του χαρακτηριστικού ‘points’. Εάν το συγκεκριμένο χαρακτηριστικό ή ιδιότητα βρίσκεται σε κίνηση, περιέχει την τρέχουσα κινούμενη τιμή του χαρακτηριστικού ή της ιδιότητας. Εάν το συγκεκριμένο χαρακτηριστικό ή ιδιότητα δεν βρίσκεται σε κίνηση, περιέχει την ίδια τιμή με το points. |
...
| [getPoints](../../com.aspose.html.dom.svg/svgpolylineelement/points/) Παρέχει πρόσβαση στα βασικά (δηλαδή στατικά) περιεχόμενα του χαρακτηριστικού ‘points’. |
