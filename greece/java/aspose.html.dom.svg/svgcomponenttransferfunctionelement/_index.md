...
description: "com.aspose.html.dom.svg.SVGComponentTransferFunctionElement κλάση. Αυτή η διεπαφή ορίζει μια βασική διεπαφή που χρησιμοποιείται από τις διεπαφές της λειτουργίας μεταφοράς στοιχείων."
type: docs
