---
title: "SVGComponentTransferFunctionElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.dom.svg.SVGComponentTransferFunctionElement κλάση. Αυτή η διασύνδεση ορίζει μια βασική διασύνδεση που χρησιμοποιείται από τις διασυνδέσεις λειτουργίας μεταφοράς στοιχείων."
type: docs

url: /el/java/com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/
---
## SVGComponentTransferFunctionElement class

Αυτή η διεπαφή ορίζει μια βασική διεπαφή που χρησιμοποιείται από τις διεπαφές λειτουργιών μεταφοράς στοιχείων.
...
| Όνομα | Περιγραφή |
| --- | --- |
| [getAmplitude](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/amplitude/) Αντιστοιχεί στο χαρακτηριστικό ‘amplitude’ του δεδομένου στοιχείου. |
...
| [getExponent](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/exponent/) Αντιστοιχεί στο χαρακτηριστικό ‘exponent’ του δεδομένου στοιχείου. |
...
| [getIntercept](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/intercept/) Αντιστοιχεί στο χαρακτηριστικό ‘intercept’ του δεδομένου στοιχείου. |
...
| [getOffset](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/offset/) Αντιστοιχεί στο χαρακτηριστικό ‘offset’ του δεδομένου στοιχείου. |
[getOuterHTML]
...
| [getSlope](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/slope/) Αντιστοιχεί στο χαρακτηριστικό ‘slope’ του δεδομένου στοιχείου. |
...
| [getTableValues](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/tablevalues/) Αντιστοιχεί στο χαρακτηριστικό ‘tableValues’ του δεδομένου στοιχείου. |
...
| [getType](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/type/) Αντιστοιχεί στο χαρακτηριστικό ‘type’ του δεδομένου στοιχείου. Παίρνει μία από τις σταθερές SVG_FECOMPONENTTRANSFER_TYPE_* που ορίζονται σε αυτή τη διεπαφή. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| const [SVG_FECOMPONENTTRANSFER_TYPE_DISCRETE](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_discrete/) | Αντιστοιχεί στην τιμή 'discrete'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_GAMMA](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_gamma/) | Αντιστοιχεί στην τιμή 'gamma'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_IDENTITY](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_identity/) | Αντιστοιχεί στην τιμή 'identity'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_LINEAR](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_linear/) | Αντιστοιχεί στην τιμή 'linear'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_TABLE](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_table/) | Αντιστοιχεί στην τιμή 'table'. |
