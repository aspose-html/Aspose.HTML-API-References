---
title: "Κλάση SVGAnimateTransformElement"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.dom.svg.SVGAnimateTransformElement κλάση. Η διεπαφή SVGAnimateTransformElement αντιστοιχεί στο στοιχείο animateTransform. Η αντικειμενοστραφής πρόσβαση στα χαρακτηριστικά του στοιχείου animateTransform μέσω του SVG DOM δεν είναι διαθέσιμη."
type: docs

url: /el/java/com.aspose.html.dom.svg/svganimatetransformelement/
---
## SVGAnimateTransformElement class

Η διεπαφή SVGAnimateTransformElement αντιστοιχεί στο στοιχείο ‘animateTransform’. Η αντικειμενοστραφής πρόσβαση στα χαρακτηριστικά του στοιχείου ‘animateTransform’ μέσω του SVG DOM δεν είναι διαθέσιμη.
