---
title: "SVGGeometryElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.dom.svg.SVGGeometryElement κλάση. Η διεπαφή SVGGeometryElement αντιπροσωπεύει στοιχεία SVG των οποίων η απόδοση ορίζεται από γεωμετρία με ισοδύναμη διαδρομή και μπορεί να γεμιστεί και να περιγραφεί. Αυτό περιλαμβάνει διαδρομές και τα βασικά σχήματα."
type: docs

url: /el/java/com.aspose.html.dom.svg/svggeometryelement/
---
## SVGGeometryElement class

Η διεπαφή SVGGeometryElement αντιπροσωπεύει στοιχεία SVG των οποίων η απόδοση ορίζεται από γεωμετρία με ισοδύναμη διαδρομή, και που μπορούν να γεμίσουν και να περιγράψουν. Αυτό περιλαμβάνει διαδρομές και τα βασικά σχήματα.
...
| [getEquivalentPath](../../com.aspose.html.dom.svg/svggeometryelement/getequivalentpath/)() | Επιστρέφει ένα νέο αντικείμενο της [`SVGPathSegList`](../../com.aspose.html.dom.svg.paths/svgpathseglist/) που αντιπροσωπεύει το `SVGGeometryElement` ως τμήματα διαδρομής. |
