---
title: "SVGAnimateElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.dom.svg.SVGAnimateElement κλάση. Η SVGAnimateElement διασύνδεση αντιστοιχεί στο στοιχείο animate. Η αντικειμενοστραφής πρόσβαση στα χαρακτηριστικά του στοιχείου animate μέσω του SVG DOM δεν είναι διαθέσιμη."
type: docs

url: /el/java/com.aspose.html.dom.svg/svganimateelement/
---
## SVGAnimateElement class

Η διεπαφή SVGAnimateElement αντιστοιχεί στο στοιχείο ‘animate’. Η αντικειμενοστραφής πρόσβαση στα χαρακτηριστικά του στοιχείου ‘animate’ μέσω του SVG DOM δεν είναι διαθέσιμη.
