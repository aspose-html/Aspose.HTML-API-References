...
description: "com.aspose.html.dom.svg.SVGAnimateElement κλάση. Η διεπαφή SVGAnimateElement αντιστοιχεί στο στοιχείο animate. Η αντικειμενοστραφής πρόσβαση στα χαρακτηριστικά του στοιχείου animate μέσω του SVG DOM δεν είναι διαθέσιμη."
type: docs
