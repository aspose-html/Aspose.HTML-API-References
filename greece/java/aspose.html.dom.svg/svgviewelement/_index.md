---
title: "SVGViewElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.dom.svg.SVGViewElement κλάση. Η διεπαφή SVGViewElement αντιστοιχεί στο στοιχείο view."
type: docs
...
| [getPreserveAspectRatio](../../com.aspose.html.dom.svg/svgviewelement/preserveaspectratio/) Αντιστοιχεί στο χαρακτηριστικό ‘preserveAspectRatio’ στο δεδομένο στοιχείο. |
...
| [getViewBox](../../com.aspose.html.dom.svg/svgviewelement/viewbox/) Αντιστοιχεί στο χαρακτηριστικό ‘viewBox’ στο δεδομένο στοιχείο. |
...
| [getViewTarget](../../com.aspose.html.dom.svg/svgviewelement/viewtarget/) Αντιστοιχεί στο χαρακτηριστικό ‘viewTarget’ στο δεδομένο στοιχείο ‘view’. Μια λίστα τιμών DOMString που περιέχουν τα ονόματα που αναφέρονται στο χαρακτηριστικό ‘viewTarget’. Κάθε τιμή DOMString μπορεί να συσχετιστεί με το αντίστοιχο στοιχείο χρησιμοποιώντας την κλήση μεθόδου getElementById(). |
[getZoomAndPan]
