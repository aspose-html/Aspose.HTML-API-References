---
title: "Κλάση SVGViewElement"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "κλάση com.aspose.html.dom.svg.SVGViewElement. Η διεπαφή SVGViewElement αντιστοιχεί στο στοιχείο view."
type: docs

url: /el/java/com.aspose.html.dom.svg/svgviewelement/
---
...
| [getPreserveAspectRatio](../../com.aspose.html.dom.svg/svgviewelement/preserveaspectratio/) Αντιστοιχεί στο χαρακτηριστικό ‘preserveAspectRatio’ του δεδομένου στοιχείου. |
...
| [getViewBox](../../com.aspose.html.dom.svg/svgviewelement/viewbox/) Αντιστοιχεί στο χαρακτηριστικό ‘viewBox’ του δεδομένου στοιχείου. |
...
| [getViewTarget](../../com.aspose.html.dom.svg/svgviewelement/viewtarget/) Αντιστοιχεί στο χαρακτηριστικό ‘viewTarget’ του δεδομένου στοιχείου ‘view’. Μια λίστα τιμών DOMString που περιέχουν τα ονόματα που αναφέρονται στο χαρακτηριστικό ‘viewTarget’. Κάθε τιμή DOMString μπορεί να συσχετιστεί με το αντίστοιχο στοιχείο χρησιμοποιώντας την κλήση μεθόδου getElementById(). |
[getZoomAndPan]
