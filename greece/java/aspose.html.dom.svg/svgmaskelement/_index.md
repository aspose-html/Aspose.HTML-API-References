---
title: "Κλάση SVGMaskElement"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.dom.svg.SVGMaskElement κλάση. Η διεπαφή SVGMaskElement αντιστοιχεί στο στοιχείο mask."
type: docs

url: /el/java/com.aspose.html.dom.svg/svgmaskelement/
---
## SVGMaskElement class

Η διεπαφή SVGMaskElement αντιστοιχεί στο στοιχείο ‘mask’.
...
| [getHeight](../../com.aspose.html.dom.svg/svgmaskelement/height/) Αντιστοιχεί στο χαρακτηριστικό ‘height’ του δεδομένου στοιχείου ‘mask’. Παίρνει μία από τις σταθερές που ορίζονται στο SVGUnitTypes. |
[getId]
...
| [getMaskContentUnits](../../com.aspose.html.dom.svg/svgmaskelement/maskcontentunits/) Αντιστοιχεί στο χαρακτηριστικό ‘maskContentUnits’ του δεδομένου στοιχείου ‘mask’. Παίρνει μία από τις σταθερές που ορίζονται στο SVGUnitTypes. |
| [getMaskUnits](../../com.aspose.html.dom.svg/svgmaskelement/maskunits/) Αντιστοιχεί στο χαρακτηριστικό ‘maskUnits’ του δεδομένου στοιχείου ‘mask’. Παίρνει μία από τις σταθερές που ορίζονται στο SVGUnitTypes. |
...
| [getRequiredExtensions](../../com.aspose.html.dom.svg/svgmaskelement/requiredextensions/) Αντιστοιχεί στο χαρακτηριστικό ‘requiredExtensions’ του δεδομένου στοιχείου. |
| [getRequiredFeatures](../../com.aspose.html.dom.svg/svgmaskelement/requiredfeatures/) Αντιστοιχεί στο χαρακτηριστικό ‘requiredFeatures’ του δεδομένου στοιχείου. |
...
| [getSystemLanguage](../../com.aspose.html.dom.svg/svgmaskelement/systemlanguage/) Αντιστοιχεί στο χαρακτηριστικό ‘systemLanguage’ του δεδομένου στοιχείου. |
...
| [getWidth](../../com.aspose.html.dom.svg/svgmaskelement/width/) Αντιστοιχεί στο χαρακτηριστικό ‘width’ του δεδομένου στοιχείου ‘mask’. Παίρνει μία από τις σταθερές που ορίζονται στο SVGUnitTypes. |
| [X](../../com.aspose.html.dom.svg/svgmaskelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘x’ του δεδομένου στοιχείου ‘mask’. Παίρνει μία από τις σταθερές που ορίζονται στο SVGUnitTypes. |
| [Y](../../com.aspose.html.dom.svg/svgmaskelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘y’ του δεδομένου στοιχείου ‘mask’. Παίρνει μία από τις σταθερές που ορίζονται στο SVGUnitTypes. |
