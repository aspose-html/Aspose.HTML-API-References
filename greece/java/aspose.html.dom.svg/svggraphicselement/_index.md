---
title: "Κλάση SVGGraphicsElement"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.dom.svg.SVGGraphicsElement κλάση. Η διεπαφή SVGGraphicsElement αντιπροσωπεύει στοιχεία SVG των οποίων ο κύριος σκοπός είναι η άμεση απόδοση γραφικών σε μια ομάδα"
type: docs

url: /el/java/com.aspose.html.dom.svg/svggraphicselement/
---
## SVGGraphicsElement class

Η διεπαφή SVGGraphicsElement αντιπροσωπεύει στοιχεία SVG των οποίων ο κύριος σκοπός είναι η άμεση απόδοση γραφικών σε μια ομάδα.
