...
description: "com.aspose.html.dom.svg.SVGCursorElement class. Η διεπαφή SVGCursorElement αντιστοιχεί στο στοιχείο cursor."
type: docs
...
| [getHref](../../com.aspose.html.dom.svg/svgcursorelement/href/) Αντιστοιχεί στο χαρακτηριστικό ‘xlink:href’ στο δεδομένο στοιχείο. |
[getId]
...
| [getRequiredExtensions](../../com.aspose.html.dom.svg/svgcursorelement/requiredextensions/) Αντιστοιχεί στο χαρακτηριστικό ‘requiredExtensions’ στο δεδομένο στοιχείο. |
| [getRequiredFeatures](../../com.aspose.html.dom.svg/svgcursorelement/requiredfeatures/) Αντιστοιχεί στο χαρακτηριστικό ‘requiredFeatures’ στο δεδομένο στοιχείο. |
...
| [getSystemLanguage](../../com.aspose.html.dom.svg/svgcursorelement/systemlanguage/) Αντιστοιχεί στο χαρακτηριστικό ‘systemLanguage’ στο δεδομένο στοιχείο. |
...
| [X](../../com.aspose.html.dom.svg/svgcursorelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘x’ στο δεδομένο στοιχείο ‘cursor’. |
