---
title: "Κλάση SVGRectElement"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.dom.svg.SVGRectElement κλάση. Η διεπαφή SVGRectElement αντιστοιχεί στο στοιχείο rect."
type: docs

url: /el/java/com.aspose.html.dom.svg/svgrectelement/
---
...
| [getHeight](../../com.aspose.html.dom.svg/svgrectelement/height/) Αντιστοιχεί στο χαρακτηριστικό ‘height’ του δοσμένου στοιχείου ‘rect’. |
[getId]
...
| [getPathLength](../../com.aspose.html.dom.svg/svggeometryelement/pathlength/) Αντιστοιχεί στο χαρακτηριστικό pathLength στο συγκεκριμένο στοιχείο. |
...
| [getRx](../../com.aspose.html.dom.svg/svgrectelement/rx/) Αντιστοιχεί στο χαρακτηριστικό ‘rx’ του δοσμένου στοιχείου ‘rect’. |
| [getRy](../../com.aspose.html.dom.svg/svgrectelement/ry/) Αντιστοιχεί στο χαρακτηριστικό ‘ry’ στο δοσμένο στοιχείο ‘rect’. |
...
| [getWidth](../../com.aspose.html.dom.svg/svgrectelement/width/) Αντιστοιχεί στο χαρακτηριστικό ‘width’ στο δοσμένο στοιχείο ‘rect’. |
| [X](../../com.aspose.html.dom.svg/svgrectelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘x’ στο δοσμένο στοιχείο ‘rect’. |
| [Y](../../com.aspose.html.dom.svg/svgrectelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘y’ στο δοσμένο στοιχείο ‘rect’. |
...
| [getEquivalentPath](../../com.aspose.html.dom.svg/svggeometryelement/getequivalentpath/)() | Επιστρέφει ένα νέο αντικείμενο της [`SVGPathSegList`](../../com.aspose.html.dom.svg.paths/svgpathseglist/) που αντιπροσωπεύει το [`SVGGeometryElement`](../svggeometryelement/) ως τμήματα διαδρομής. |
...
| [getPointAtLength](../../com.aspose.html.dom.svg/svggeometryelement/getpointatlength/)(float) | Επιστρέφει τις συντεταγμένες (x,y) στο χώρο χρήστη, οι οποίες είναι μονάδες απόστασης κατά μήκος της διαδρομής, χρησιμοποιώντας τον αλγόριθμο distance-along-a-path του πράκτορα χρήστη. |
...
| [getTotalLength](../../com.aspose.html.dom.svg/svggeometryelement/gettotallength/)() | Επιστρέφει την υπολογισμένη τιμή του πράκτορα χρήστη για το συνολικό μήκος της διαδρομής, χρησιμοποιώντας τον αλγόριθμο distance-along-a-path του πράκτορα χρήστη, ως απόσταση στο τρέχον σύστημα συντεταγμένων του χρήστη. |
