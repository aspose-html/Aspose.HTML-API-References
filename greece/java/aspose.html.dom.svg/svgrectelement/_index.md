...
| [getHeight](../../com.aspose.html.dom.svg/svgrectelement/height/) Αντιστοιχεί στο χαρακτηριστικό ‘height’ του δεδομένου στοιχείου ‘rect’. |
[getId]
...
| [getPathLength](../../com.aspose.html.dom.svg/svggeometryelement/pathlength/) Αντιστοιχεί στο χαρακτηριστικό pathLength του δεδομένου στοιχείου. |
...
| [getRx](../../com.aspose.html.dom.svg/svgrectelement/rx/) Αντιστοιχεί στο χαρακτηριστικό ‘rx’ του δεδομένου στοιχείου ‘rect’. |
| [getRy](../../com.aspose.html.dom.svg/svgrectelement/ry/) Αντιστοιχεί στο χαρακτηριστικό ‘ry’ στο δοθέν στοιχείο ‘rect’. |
...
| [getWidth](../../com.aspose.html.dom.svg/svgrectelement/width/) Αντιστοιχεί στο χαρακτηριστικό ‘width’ στο δοθέν στοιχείο ‘rect’. |
| [X](../../com.aspose.html.dom.svg/svgrectelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘x’ στο δοθέν στοιχείο ‘rect’. |
| [Y](../../com.aspose.html.dom.svg/svgrectelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘y’ στο δοθέν στοιχείο ‘rect’. |
...
| [getPointAtLength](../../com.aspose.html.dom.svg/svggeometryelement/getpointatlength/)(float) | Επιστρέφει τις συντεταγμένες (x,y) στον χώρο χρήστη, οι οποίες είναι μονάδες απόστασης κατά μήκος της διαδρομής, χρησιμοποιώντας τον αλγόριθμο distance-along-a-path του προγράμματος-πελάτη. |
...
| [getTotalLength](../../com.aspose.html.dom.svg/svggeometryelement/gettotallength/)() | Επιστρέφει την υπολογισμένη τιμή του προγράμματος-πελάτη για το συνολικό μήκος της διαδρομής, χρησιμοποιώντας τον αλγόριθμο distance-along-a-path του προγράμματος-πελάτη, ως απόσταση στο τρέχον σύστημα συντεταγμένων του χρήστη. |
