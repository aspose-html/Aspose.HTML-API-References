...
description: "Μέθοδος SVGDocument. Αποθηκεύει το έγγραφο σε τοπικό αρχείο που καθορίζεται από το url. Όλοι οι πόροι που χρησιμοποιούνται σε αυτό το έγγραφο θα αποθηκευτούν σε γειτονικό φάκελο του οποίου το όνομα θα δημιουργηθεί ως output_file_name  _files"
type: docs
