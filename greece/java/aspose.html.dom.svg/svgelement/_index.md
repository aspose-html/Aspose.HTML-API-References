---
title: "Κλάση SVGElement"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "κλάση com.aspose.html.dom.svg.SVGElement. Όλες οι διεπαφές SVG DOM που αντιστοιχούν άμεσα σε στοιχεία της γλώσσας SVG, όπως η διεπαφή SVGPathElement για το στοιχείο path, κληρονομούν από τη διεπαφή SVGElement"
type: docs
...
Όλες οι διεπαφές SVG DOM που αντιστοιχούν άμεσα σε στοιχεία της γλώσσας SVG (όπως η διεπαφή SVGPathElement για το στοιχείο ‘path’) προέρχονται από τη διεπαφή SVGElement.
