---
title: "SVGElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.dom.svg.SVGElement κλάση. Όλες οι διεπαφές SVG DOM που αντιστοιχούν άμεσα σε στοιχεία της γλώσσας SVG, όπως η διεπαφή SVGPathElement για το στοιχείο path, κληρονομούν από τη διεπαφή SVGElement."
type: docs

url: /el/java/com.aspose.html.dom.svg/svgelement/
---
## SVGElement class

Όλες οι διεπαφές SVG DOM που αντιστοιχούν άμεσα σε στοιχεία της γλώσσας SVG (όπως η διεπαφή SVGPathElement για το στοιχείο ‘path’) κληρονομούν από τη διεπαφή SVGElement.
