---
title: "SVGMarkerElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.dom.svg.SVGMarkerElement κλάση. Η διεπαφή SVGMarkerElement αντιστοιχεί στο στοιχείο marker."
type: docs
...
| [getMarkerHeight](../../com.aspose.html.dom.svg/svgmarkerelement/markerheight/) Αντιστοιχεί στο χαρακτηριστικό ‘markerHeight’ στο δεδομένο στοιχείο ‘marker’. |
| [getMarkerUnits](../../com.aspose.html.dom.svg/svgmarkerelement/markerunits/) Αντιστοιχεί στο χαρακτηριστικό ‘markerUnits’ στο δεδομένο στοιχείο ‘marker’. Ένας από τους τύπους μονάδων δείκτη (Marker Unit Types) που ορίζονται σε αυτή τη διεπαφή. |
| [getMarkerWidth](../../com.aspose.html.dom.svg/svgmarkerelement/markerwidth/) Αντιστοιχεί στο χαρακτηριστικό ‘markerWidth’ στο δεδομένο στοιχείο ‘marker’. |
...
| [getOrientAngle](../../com.aspose.html.dom.svg/svgmarkerelement/orientangle/) Αντιστοιχεί στο χαρακτηριστικό ‘orient’ στο δεδομένο στοιχείο ‘marker’. Εάν το markerUnits είναι SVG_MARKER_ORIENT_ANGLE, η τιμή γωνίας για το χαρακτηριστικό ‘orient’; διαφορετικά, θα οριστεί στο μηδέν. |
| [getOrientType](../../com.aspose.html.dom.svg/svgmarkerelement/orienttype/) Αντιστοιχεί στο χαρακτηριστικό ‘orient’ στο δεδομένο στοιχείο ‘marker’. Ένας από τους τύπους προσανατολισμού δείκτη που ορίζονται σε αυτή τη διεπαφή. |
[getOuterHTML]
...
| [getPreserveAspectRatio](../../com.aspose.html.dom.svg/svgmarkerelement/preserveaspectratio/) Αντιστοιχεί στο χαρακτηριστικό ‘preserveAspectRatio’ στο δεδομένο στοιχείο. |
...
| [getRefX](../../com.aspose.html.dom.svg/svgmarkerelement/refx/) Αντιστοιχεί στο χαρακτηριστικό ‘refX’ στο δεδομένο στοιχείο ‘marker’. |
| [getRefY](../../com.aspose.html.dom.svg/svgmarkerelement/refy/) Αντιστοιχεί στο χαρακτηριστικό ‘refY’ στο δεδομένο στοιχείο ‘marker’. |
...
| [getViewBox](../../com.aspose.html.dom.svg/svgmarkerelement/viewbox/) Αντιστοιχεί στο χαρακτηριστικό ‘viewBox’ στο δεδομένο στοιχείο. |
...
| [setOrientToAngle](../../com.aspose.html.dom.svg/svgmarkerelement/setorienttoangle/)(SVGAngle) | Ορίζει την τιμή του χαρακτηριστικού ‘orient’ στην δεδομένη γωνία. |
