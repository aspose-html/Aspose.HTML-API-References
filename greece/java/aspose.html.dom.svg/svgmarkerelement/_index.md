---
title: "Κλάση SVGMarkerElement"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "κλάση com.aspose.html.dom.svg.SVGMarkerElement. Η διεπαφή SVGMarkerElement αντιστοιχεί στο στοιχείο marker."
type: docs

url: /el/java/com.aspose.html.dom.svg/svgmarkerelement/
---
## SVGMarkerElement class

Η διεπαφή SVGMarkerElement αντιστοιχεί στο στοιχείο ‘marker’.
...
| [getMarkerHeight](../../com.aspose.html.dom.svg/svgmarkerelement/markerheight/) Αντιστοιχεί στο χαρακτηριστικό ‘markerHeight’ του δεδομένου στοιχείου ‘marker’. |
| [getMarkerUnits](../../com.aspose.html.dom.svg/svgmarkerelement/markerunits/) Αντιστοιχεί στο χαρακτηριστικό ‘markerUnits’ του δεδομένου στοιχείου ‘marker’. Ένας από τους τύπους μονάδων marker που ορίζονται σε αυτή τη διεπαφή. |
| [getMarkerWidth](../../com.aspose.html.dom.svg/svgmarkerelement/markerwidth/) Αντιστοιχεί στο χαρακτηριστικό ‘markerWidth’ του δεδομένου στοιχείου ‘marker’. |
...
| [getOrientAngle](../../com.aspose.html.dom.svg/svgmarkerelement/orientangle/) Αντιστοιχεί στο χαρακτηριστικό ‘orient’ του δεδομένου στοιχείου ‘marker’. Εάν το markerUnits είναι SVG_MARKER_ORIENT_ANGLE, η τιμή γωνίας για το χαρακτηριστικό ‘orient’; διαφορετικά, θα οριστεί στο μηδέν. |
| [getOrientType](../../com.aspose.html.dom.svg/svgmarkerelement/orienttype/) Αντιστοιχεί στο χαρακτηριστικό ‘orient’ του δεδομένου στοιχείου ‘marker’. Ένας από τους τύπους προσανατολισμού δείκτη που ορίζονται σε αυτή τη διεπαφή. |
[getOuterHTML]
...
| [getPreserveAspectRatio](../../com.aspose.html.dom.svg/svgmarkerelement/preserveaspectratio/) Αντιστοιχεί στο χαρακτηριστικό ‘preserveAspectRatio’ του δεδομένου στοιχείου. |
...
| [getRefX](../../com.aspose.html.dom.svg/svgmarkerelement/refx/) Αντιστοιχεί στο χαρακτηριστικό ‘refX’ του δεδομένου στοιχείου ‘marker’. |
| [getRefY](../../com.aspose.html.dom.svg/svgmarkerelement/refy/) Αντιστοιχεί στο χαρακτηριστικό ‘refY’ του δεδομένου στοιχείου ‘marker’. |
...
| [getViewBox](../../com.aspose.html.dom.svg/svgmarkerelement/viewbox/) Αντιστοιχεί στο χαρακτηριστικό ‘viewBox’ του δεδομένου στοιχείου. |
...
| [setOrientToAngle](../../com.aspose.html.dom.svg/svgmarkerelement/setorienttoangle/)(SVGAngle) | Ορίζει την τιμή του χαρακτηριστικού ‘orient’ στη δεδομένη γωνία. |
| [setOrientToAuto](../../com.aspose.html.dom.svg/svgmarkerelement/setorienttoauto/)() | Ορίζει την τιμή του χαρακτηριστικού ‘orient’ σε 'auto'. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| const [SVG_MARKERUNITS_STROKEWIDTH](../../com.aspose.html.dom.svg/svgmarkerelement/svg_markerunits_strokewidth/) | Η τιμή του χαρακτηριστικού ‘markerUnits’ είναι 'strokeWidth'. |
| const [SVG_MARKERUNITS_UNKNOWN](../../com.aspose.html.dom.svg/svgmarkerelement/svg_markerunits_unknown/) | Ο τύπος μονάδας δείκτη δεν είναι ένας από τους προκαθορισμένους τύπους. Είναι άκυρο να προσπαθήσετε να ορίσετε μια νέα τιμή αυτού του τύπου ή να προσπαθήσετε να αλλάξετε μια υπάρχουσα τιμή σε αυτόν τον τύπο. |
| const [SVG_MARKERUNITS_USERSPACEONUSE](../../com.aspose.html.dom.svg/svgmarkerelement/svg_markerunits_userspaceonuse/) | Η τιμή του χαρακτηριστικού ‘markerUnits’ είναι 'userSpaceOnUse'. |
| const [SVG_MARKER_ORIENT_ANGLE](../../com.aspose.html.dom.svg/svgmarkerelement/svg_marker_orient_angle/) | Το χαρακτηριστικό ‘orient’ έχει τιμή γωνίας. |
| const [SVG_MARKER_ORIENT_AUTO](../../com.aspose.html.dom.svg/svgmarkerelement/svg_marker_orient_auto/) | Το χαρακτηριστικό ‘orient’ έχει τιμή 'auto'. |
| const [SVG_MARKER_ORIENT_UNKNOWN](../../com.aspose.html.dom.svg/svgmarkerelement/svg_marker_orient_unknown/) | Ο προσανατολισμός δείκτη δεν είναι ένας από τους προκαθορισμένους τύπους. Είναι άκυρο να προσπαθήσετε να ορίσετε μια νέα τιμή αυτού του τύπου ή να προσπαθήσετε να αλλάξετε μια υπάρχουσα τιμή σε αυτόν τον τύπο. |
