---
title: "Κλάση SVGClipPathElement"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "κλάση com.aspose.html.dom.svg.SVGClipPathElement. Η διεπαφή SVGClipPathElement αντιστοιχεί στο στοιχείο clipPath"
type: docs
...
| [getClipPathUnits](../../com.aspose.html.dom.svg/svgclippathelement/clippathunits/) Αντιστοιχεί στο χαρακτηριστικό ‘clipPathUnits’ στο δεδομένο στοιχείο ‘clipPath’. Παίρνει μία από τις σταθερές που ορίζονται στο SVGUnitTypes. |
...
| [getTransform](../../com.aspose.html.dom.svg/svgclippathelement/transform/) Αντιστοιχεί στο χαρακτηριστικό ‘transform’ στο δεδομένο στοιχείο. |
