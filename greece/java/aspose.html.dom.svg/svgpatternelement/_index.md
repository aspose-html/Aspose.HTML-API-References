---
title: "SVGPatternElement Κλάση"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "com.aspose.html.dom.svg.SVGPatternElement κλάση. Η διεπαφή SVGPatternElement αντιστοιχεί στο στοιχείο pattern."
type: docs
...
| [getPatternContentUnits](../../com.aspose.html.dom.svg/svgpatternelement/patterncontentunits/) Αντιστοιχεί στο χαρακτηριστικό ‘patternContentUnits’ του δεδομένου στοιχείου ‘pattern’. Παίρνει μία από τις σταθερές που ορίζονται στο SVGUnitTypes. |
...
| [getPatternUnits](../../com.aspose.html.dom.svg/svgpatternelement/patternunits/) Αντιστοιχεί στο χαρακτηριστικό ‘patternUnits’ του δεδομένου στοιχείου ‘pattern’. Παίρνει μία από τις σταθερές που ορίζονται στο SVGUnitTypes. |
