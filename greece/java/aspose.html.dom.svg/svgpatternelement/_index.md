---
title: "Κλάση SVGPatternElement"
second_title: "Αναφορά API του Aspose.HTML για Java"
description: "Κλάση com.aspose.html.dom.svg.SVGPatternElement. Η διεπαφή SVGPatternElement αντιστοιχεί στο στοιχείο pattern."
type: docs

url: /el/java/com.aspose.html.dom.svg/svgpatternelement/
---
## SVGPatternElement class

Η διεπαφή SVGPatternElement αντιστοιχεί στο στοιχείο ‘pattern’.
...
| [getHeight](../../com.aspose.html.dom.svg/svgpatternelement/height/) Αντιστοιχεί στο χαρακτηριστικό ‘height’ του δεδομένου στοιχείου ‘pattern’. |
| [getHref](../../com.aspose.html.dom.svg/svgpatternelement/href/) Αντιστοιχεί στο χαρακτηριστικό ‘xlink:href’ του δεδομένου στοιχείου. |
[getId]
...
| [getPatternContentUnits](../../com.aspose.html.dom.svg/svgpatternelement/patterncontentunits/) Αντιστοιχεί στο χαρακτηριστικό ‘patternContentUnits’ του δεδομένου στοιχείου ‘pattern’. Δέχεται μία από τις σταθερές που ορίζονται στο SVGUnitTypes. |
| [getPatternTransform](../../com.aspose.html.dom.svg/svgpatternelement/patterntransform/) Αντιστοιχεί στο χαρακτηριστικό ‘patternTransform’ του δεδομένου στοιχείου ‘pattern’. |
| [getPatternUnits](../../com.aspose.html.dom.svg/svgpatternelement/patternunits/) Αντιστοιχεί στο χαρακτηριστικό ‘patternUnits’ του δεδομένου στοιχείου ‘pattern’. Δέχεται μία από τις σταθερές που ορίζονται στο SVGUnitTypes. |
...
| [getPreserveAspectRatio](../../com.aspose.html.dom.svg/svgpatternelement/preserveaspectratio/) Αντιστοιχεί στο χαρακτηριστικό ‘preserveAspectRatio’ του δεδομένου στοιχείου. |
...
| [getRequiredExtensions](../../com.aspose.html.dom.svg/svgpatternelement/requiredextensions/) Αντιστοιχεί στο χαρακτηριστικό ‘requiredExtensions’ του δεδομένου στοιχείου. |
| [getRequiredFeatures](../../com.aspose.html.dom.svg/svgpatternelement/requiredfeatures/) Αντιστοιχεί στο χαρακτηριστικό ‘requiredFeatures’ του δεδομένου στοιχείου. |
...
| [getSystemLanguage](../../com.aspose.html.dom.svg/svgpatternelement/systemlanguage/) Αντιστοιχεί στο χαρακτηριστικό ‘systemLanguage’ του δεδομένου στοιχείου. |
...
| [getViewBox](../../com.aspose.html.dom.svg/svgpatternelement/viewbox/) Αντιστοιχεί στο χαρακτηριστικό ‘viewBox’ του δεδομένου στοιχείου. |
...
| [getWidth](../../com.aspose.html.dom.svg/svgpatternelement/width/) Αντιστοιχεί στο χαρακτηριστικό ‘width’ του δεδομένου στοιχείου ‘pattern’. |
| [X](../../com.aspose.html.dom.svg/svgpatternelement/x/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘x’ του δεδομένου στοιχείου ‘pattern’. |
| [Y](../../com.aspose.html.dom.svg/svgpatternelement/y/) { get; } | Αντιστοιχεί στο χαρακτηριστικό ‘y’ του δεδομένου στοιχείου ‘pattern’. |
