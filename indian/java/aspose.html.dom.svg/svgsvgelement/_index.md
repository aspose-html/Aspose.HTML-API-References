---
title: "SVGSVGElement क्लास"
second_title: "Aspose.HTML Java के लिए API संदर्भ"
description: "com.aspose.html.dom.svg.SVGSVGElement क्लास। एक प्रमुख इंटरफ़ेस परिभाषा SVGSVGElement इंटरफ़ेस है जो svg तत्व के अनुरूप है। इस इंटरफ़ेस में विभिन्न सामान्यतः उपयोगी उपयोगिता विधियाँ शामिल हैं, जैसे मैट्रिक्स संचालन और दृश्य रेंडरिंग उपकरणों पर पुनः-ड्रॉ समय को नियंत्रित करने की क्षमता।"
type: docs
...
एक प्रमुख इंटरफ़ेस परिभाषा SVGSVGElement इंटरफ़ेस है, जो ‘svg’ तत्व के अनुरूप इंटरफ़ेस है। इस इंटरफ़ेस में विभिन्न सामान्यतः उपयोग किए जाने वाले उपयोगी मेथड्स शामिल हैं, जैसे मैट्रिक्स ऑपरेशन्स और दृश्य रेंडरिंग डिवाइसों पर पुनः-ड्रॉ का समय नियंत्रित करने की क्षमता।
...
| [getCurrentTranslate](../../com.aspose.html.dom.svg/svgsvgelement/currenttranslate/) बाहरीmost svg तत्व पर, उपयोगकर्ता "वृद्धि" को ध्यान में रखने वाला अनुकूल अनुवाद कारक। जब इसे किसी ‘svg’ तत्व पर एक्सेस किया जाता है जो बाहरीmost नहीं है, तो इस विशेषता का व्यवहार अपरिभाषित रहता है। |
...
| [createSVGAngle](../../com.aspose.html.dom.svg/svgsvgelement/createsvgangle/)() | किसी भी दस्तावेज़ वृक्ष के बाहर एक SVGAngle ऑब्जेक्ट बनाता है। ऑब्जेक्ट को 0 डिग्री (एकक रहित) मान से प्रारंभ किया जाता है। |
| [createSVGLength](../../com.aspose.html.dom.svg/svgsvgelement/createsvglength/)() | किसी भी दस्तावेज़ वृक्ष के बाहर एक SVGLength ऑब्जेक्ट बनाता है। ऑब्जेक्ट को 0 उपयोगकर्ता इकाइयों के मान से प्रारंभ किया जाता है। |
| [createSVGMatrix](../../com.aspose.html.dom.svg/svgsvgelement/createsvgmatrix/)() | किसी भी दस्तावेज़ वृक्ष के बाहर एक SVGMatrix ऑब्जेक्ट बनाता है। ऑब्जेक्ट को पहचान मैट्रिक्स से प्रारंभ किया जाता है। |
| [createSVGNumber](../../com.aspose.html.dom.svg/svgsvgelement/createsvgnumber/)() | किसी भी दस्तावेज़ वृक्ष के बाहर एक SVGNumber ऑब्जेक्ट बनाता है। ऑब्जेक्ट को शून्य मान से प्रारंभ किया जाता है। |
| [createSVGPoint](../../com.aspose.html.dom.svg/svgsvgelement/createsvgpoint/)() | किसी भी दस्तावेज़ वृक्ष के बाहर एक SVGPoint ऑब्जेक्ट बनाता है। ऑब्जेक्ट को उपयोगकर्ता निर्देशांक प्रणाली में बिंदु (0,0) से प्रारंभ किया जाता है। |
| [createSVGRect](../../com.aspose.html.dom.svg/svgsvgelement/createsvgrect/)() | किसी भी दस्तावेज़ वृक्ष के बाहर एक SVGRect ऑब्जेक्ट बनाता है। ऑब्जेक्ट को इस प्रकार प्रारंभ किया जाता है कि सभी मान 0 उपयोगकर्ता इकाइयों पर सेट हों। |
| [createSVGTransform](../../com.aspose.html.dom.svg/svgsvgelement/createsvgtransform/)() | किसी भी दस्तावेज़ वृक्ष के बाहर एक SVGTransform ऑब्जेक्ट बनाता है। ऑब्जेक्ट को पहचान मैट्रिक्स ट्रांसफ़ॉर्म (SVG_TRANSFORM_MATRIX) से प्रारंभ किया जाता है। |
| [createSVGTransformFromMatrix](../../com.aspose.html.dom.svg/svgsvgelement/createsvgtransformfrommatrix/)(SVGMatrix) | किसी भी दस्तावेज़ वृक्ष के बाहर एक SVGTransform ऑब्जेक्ट बनाता है। ऑब्जेक्ट को दिए गए मैट्रिक्स ट्रांसफ़ॉर्म (अर्थात, SVG_TRANSFORM_MATRIX) से प्रारंभ किया जाता है। पैरामीटर मैट्रिक्स के मान कॉपी किए जाते हैं, मैट्रिक्स पैरामीटर को SVGTransform::matrix के रूप में अपनाया नहीं जाता। |
...
| [pauseAnimations](../../com.aspose.html.dom.svg/svgsvgelement/pauseanimations/)() | इस ‘svg’ तत्व के अनुरूप SVG दस्तावेज़ अंश में परिभाषित सभी वर्तमान में चल रही एनीमेशन को निलंबित (अर्थात, विराम) करता है, जिससे इस दस्तावेज़ अंश से संबंधित एनीमेशन घड़ी तब तक स्थिर रहती है जब तक उसे पुनः शुरू नहीं किया जाता। |
...
| [unpauseAnimations](../../com.aspose.html.dom.svg/svgsvgelement/unpauseanimations/)() | वर्तमान में चल रही एनिमेशन को अनसस्पेंड (अर्थात्, अनपॉज़) करता है जो SVG दस्तावेज़ फ्रैगमेंट के भीतर परिभाषित हैं, जिससे एनिमेशन घड़ी उस समय से जारी रहती है जब इसे निलंबित किया गया था। |
