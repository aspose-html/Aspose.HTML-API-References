---
title: "SVGSVGElement वर्ग"
second_title: "Aspose.HTML for Java API संदर्भ"
description: "com.aspose.html.dom.svg.SVGSVGElement वर्ग। एक प्रमुख इंटरफ़ेस परिभाषा SVGSVGElement इंटरफ़ेस है जो svg तत्व के अनुरूप है। यह इंटरफ़ेस विभिन्न सामान्यतः उपयोग किए जाने वाले उपयोगी विधियों को शामिल करता है, जैसे मैट्रिक्स संचालन और दृश्य रेंडरिंग उपकरणों पर पुनः ड्रॉ समय को नियंत्रित करने की क्षमता।"
type: docs

url: /hi/java/com.aspose.html.dom.svg/svgsvgelement/
---
## SVGSVGElement class

एक प्रमुख इंटरफ़ेस परिभाषा SVGSVGElement इंटरफ़ेस है, जो ‘svg’ तत्व के अनुरूप इंटरफ़ेस है। यह इंटरफ़ेस विभिन्न सामान्यतः उपयोग किए जाने वाले उपयोगी मेथड्स शामिल करता है, जैसे मैट्रिक्स ऑपरेशन्स और दृश्य रेंडरिंग डिवाइसों पर पुनः-ड्रॉ का समय नियंत्रित करने की क्षमता।
...
| [getCurrentTranslate](../../com.aspose.html.dom.svg/svgsvgelement/currenttranslate/) बाहरीmost svg तत्व पर, उपयोगकर्ता \"वृद्धि\" को ध्यान में रखने वाला संबंधित अनुवाद कारक। जब इसे किसी ‘svg’ तत्व पर एक्सेस किया जाता है जो बाहरीmost नहीं है, तो इस विशेषता के व्यवहार को अनिर्धारित माना जाता है। |
| [getFarthestViewportElement](../../com.aspose.html.dom.svg/svggraphicselement/farthestviewportelement/) सबसे दूरस्थ पूर्वज ‘svg’ तत्व। यदि वर्तमान तत्व सबसे बाहरी svg तत्व है तो Null। |
...
| [getHeight](../../com.aspose.html.dom.svg/svgsvgelement/height/) दिए गए ‘svg’ तत्व पर ‘height’ विशेषता के अनुरूप है। |
[getId]
...
| [getNearestViewportElement](../../com.aspose.html.dom.svg/svggraphicselement/nearestviewportelement/) वह तत्व जो वर्तमान व्यूपोर्ट स्थापित करता है। अक्सर, सबसे निकटतम पूर्वज ‘svg’ तत्व। यदि वर्तमान तत्व सबसे बाहरी svg तत्व है तो Null। |
...
| [getOwnerSVGElement](../../com.aspose.html.dom.svg/svgelement/ownersvgelement/) निकटतम पूर्वज ‘svg’ एलिमेंट। यदि दिया गया एलिमेंट सबसे बाहरी svg एलिमेंट है तो Null। |
...
| [getPreserveAspectRatio](../../com.aspose.html.dom.svg/svgsvgelement/preserveaspectratio/) दिए गए तत्व पर ‘preserveAspectRatio’ विशेषता के अनुरूप है। |
...
| [getStyle](../../com.aspose.html.dom.svg/svgelement/style/) दिए गए एलिमेंट के ‘style’ एट्रिब्यूट से मेल खाता है। यदि यूज़र एजेंट CSS के साथ स्टाइलिंग का समर्थन नहीं करता है, तो इस एट्रिब्यूट का मान हमेशा null होना चाहिए। |
...
| [getViewBox](../../com.aspose.html.dom.svg/svgsvgelement/viewbox/) दिए गए तत्व पर ‘viewBox’ विशेषता के अनुरूप है। |
| [getViewportElement](../../com.aspose.html.dom.svg/svgelement/viewportelement/) वह एलिमेंट जो वर्तमान व्यूपोर्ट स्थापित करता है। अक्सर, निकटतम पूर्वज ‘svg’ एलिमेंट। यदि दिया गया एलिमेंट सबसे बाहरी svg एलिमेंट है तो Null। |
| [getWidth](../../com.aspose.html.dom.svg/svgsvgelement/width/) दिए गए ‘svg’ तत्व पर ‘width’ विशेषता के अनुरूप है। |
| [X](../../com.aspose.html.dom.svg/svgsvgelement/x/) { get; } | दिए गए ‘svg’ तत्व पर ‘x’ विशेषता के अनुरूप है। |
| [Y](../../com.aspose.html.dom.svg/svgsvgelement/y/) { get; } | दिए गए ‘svg’ तत्व पर ‘y’ विशेषता के अनुरूप है। |
[getZoomAndPan]
...
| [animationsPaused](../../com.aspose.html.dom.svg/svgsvgelement/animationspaused/)() | यदि यह SVG दस्तावेज़ अंश विराम स्थिति में है तो true लौटाता है। |
...
| [createEvent](../../com.aspose.html.dom.svg/svgsvgelement/createevent/)(String) | इम्प्लीमेंटेशन द्वारा समर्थित प्रकार का एक [`Event`](../../com.aspose.html.dom.events/event/) बनाता है। |
| [createSVGAngle](../../com.aspose.html.dom.svg/svgsvgelement/createsvgangle/)() | SVGAngle ऑब्जेक्ट बनाता है जो किसी भी दस्तावेज़ वृक्ष के बाहर है। यह ऑब्जेक्ट 0 डिग्री (इकाई रहित) मान से प्रारंभ किया जाता है। |
| [createSVGLength](../../com.aspose.html.dom.svg/svgsvgelement/createsvglength/)() | SVGLength ऑब्जेक्ट बनाता है जो किसी भी दस्तावेज़ वृक्ष के बाहर है। यह ऑब्जेक्ट 0 उपयोगकर्ता इकाइयों के मान से प्रारंभ किया जाता है। |
| [createSVGMatrix](../../com.aspose.html.dom.svg/svgsvgelement/createsvgmatrix/)() | SVGMatrix ऑब्जेक्ट बनाता है जो किसी भी दस्तावेज़ वृक्ष के बाहर है। यह ऑब्जेक्ट पहचान मैट्रिक्स से प्रारंभ किया जाता है। |
| [createSVGNumber](../../com.aspose.html.dom.svg/svgsvgelement/createsvgnumber/)() | SVGNumber ऑब्जेक्ट बनाता है जो किसी भी दस्तावेज़ वृक्ष के बाहर है। यह ऑब्जेक्ट शून्य मान से प्रारंभ किया जाता है। |
| [createSVGPoint](../../com.aspose.html.dom.svg/svgsvgelement/createsvgpoint/)() | SVGPoint ऑब्जेक्ट बनाता है जो किसी भी दस्तावेज़ वृक्ष के बाहर है। यह ऑब्जेक्ट उपयोगकर्ता निर्देशांक प्रणाली में बिंदु (0,0) से प्रारंभ किया जाता है। |
| [createSVGRect](../../com.aspose.html.dom.svg/svgsvgelement/createsvgrect/)() | SVGRect ऑब्जेक्ट बनाता है जो किसी भी दस्तावेज़ वृक्ष के बाहर है। यह ऑब्जेक्ट इस प्रकार प्रारंभ किया जाता है कि सभी मान 0 उपयोगकर्ता इकाइयों पर सेट हों। |
| [createSVGTransform](../../com.aspose.html.dom.svg/svgsvgelement/createsvgtransform/)() | SVGTransform ऑब्जेक्ट बनाता है जो किसी भी दस्तावेज़ वृक्ष के बाहर है। यह ऑब्जेक्ट पहचान मैट्रिक्स ट्रांसफ़ॉर्म (SVG_TRANSFORM_MATRIX) से प्रारंभ किया जाता है। |
| [createSVGTransformFromMatrix](../../com.aspose.html.dom.svg/svgsvgelement/createsvgtransformfrommatrix/)(SVGMatrix) | SVGTransform ऑब्जेक्ट बनाता है जो किसी भी दस्तावेज़ वृक्ष के बाहर है। यह ऑब्जेक्ट दिए गए मैट्रिक्स ट्रांसफ़ॉर्म (अर्थात् SVG_TRANSFORM_MATRIX) से प्रारंभ किया जाता है। पैरामीटर मैट्रिक्स के मान कॉपी किए जाते हैं, मैट्रिक्स पैरामीटर को SVGTransform::matrix के रूप में अपनाया नहीं जाता। |
...
| [getCTM](../../com.aspose.html.dom.svg/svggraphicselement/getctm/)() | वर्तमान उपयोगकर्ता इकाइयों से (यदि लागू हो तो ‘transform’ विशेषता के लागू होने के बाद) nearestViewportElement के व्यूपोर्ट निर्देशांक प्रणाली तक परिवर्तन मैट्रिक्स लौटाता है। |
| [getCurrentTime](../../com.aspose.html.dom.svg/svgsvgelement/getcurrenttime/)() | वर्तमान SVG दस्तावेज़ अंश के प्रारंभ समय के सापेक्ष सेकंड में वर्तमान समय लौटाता है। यदि getCurrentTime को दस्तावेज़ टाइमलाइन शुरू होने से पहले कॉल किया जाता है (उदाहरण के लिए, ‘script’ तत्व में चल रहे स्क्रिप्ट द्वारा, दस्तावेज़ के SVGLoad इवेंट के डिस्पैच होने से पहले), तो 0 लौटाया जाता है। |
| [getElementById](../../com.aspose.html.dom.svg/svgsvgelement/getelementbyid/)(String) | इस SVG दस्तावेज़ अंश (अर्थात् खोज दस्तावेज़ वृक्ष के एक उपसमुच्चय तक सीमित है) में वह Element खोजता है जिसका id elementId द्वारा दिया गया है। यदि कोई Element मिलता है, तो वह Element लौटाया जाता है। यदि ऐसा कोई तत्व नहीं है, तो null लौटाया जाता है। यदि एक से अधिक तत्वों का यह id समान है तो व्यवहार अनिर्धारित है। |
...
| [pauseAnimations](../../com.aspose.html.dom.svg/svgsvgelement/pauseanimations/)() | सभी वर्तमान में चल रही एनिमेशन को निलंबित (अर्थात् विराम) करता है जो इस ‘svg’ तत्व से संबंधित SVG दस्तावेज़ अंश में परिभाषित हैं, जिससे इस दस्तावेज़ अंश के एनिमेशन घड़ी को तब तक स्थिर रखा जाता है जब तक इसे पुनः शुरू नहीं किया जाता। |
...
| [setCurrentTime](../../com.aspose.html.dom.svg/svgsvgelement/setcurrenttime/)(float) | इस SVG दस्तावेज़ फ्रैगमेंट के लिए घड़ी को समायोजित करता है, एक नया वर्तमान समय स्थापित करता है। यदि setCurrentTime को दस्तावेज़ टाइमलाइन शुरू होने से पहले बुलाया जाता है (उदाहरण के लिए, ‘script’ तत्व में चल रहे स्क्रिप्ट द्वारा, जब दस्तावेज़ का SVGLoad इवेंट भेजा जाना है), तो विधि के अंतिम कॉल में सेकंड का मान वह समय देता है जिसे दस्तावेज़ टाइमलाइन शुरू होने पर प्राप्त करने का प्रयास करेगा। |
...
| [unpauseAnimations](../../com.aspose.html.dom.svg/svgsvgelement/unpauseanimations/)() | SVG दस्तावेज़ फ्रैगमेंट के भीतर परिभाषित वर्तमान में चल रही एनिमेशन को अनसस्पेंड (अर्थात, अनपॉज़) करता है, जिससे एनीमेशन घड़ी उस समय से जारी रहती है जब इसे निलंबित किया गया था। |
