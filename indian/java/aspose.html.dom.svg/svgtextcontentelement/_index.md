---
title: "SVGTextContentElement वर्ग"
second_title: "Aspose.HTML Java के लिए API संदर्भ"
description: "com.aspose.html.dom.svg.SVGTextContentElement वर्ग। SVGTextContentElement विभिन्न टेक्स्ट-संबंधित इंटरफ़ेस जैसे SVGTextElement, SVGTSpanElement, SVGTRefElement, SVGAltGlyphElement और SVGTextPathElement द्वारा विरासत में प्राप्त है। इस इंटरफ़ेस की उन विधियों के लिए जो किसी अक्षर के इंडेक्स या अक्षरों की संख्या का उल्लेख करती हैं, इन संदर्भों को क्रमशः UTF-16 कोड यूनिट के इंडेक्स या UTF-16 कोड यूनिट्स की संख्या के रूप में व्याख्यायित किया जाना चाहिए। यह DOM Level 2 Core के साथ संगतता के लिए है जहाँ CharacterData इंटरफ़ेस की विधियाँ अक्षर डेटा के भीतर इंडेक्स और गिनती के लिए UTF-16 कोड यूनिट्स का उपयोग करती हैं। उदाहरण के लिए, यदि किसी टेक्स्ट तत्व की सामग्री एक एकल non-BMP अक्षर जैसे U10000 है, तो उस तत्व पर getNumberOfChars को कॉल करने पर 2 लौटेगा क्योंकि उस एक अक्षर को दर्शाने के लिए दो UTF-16 कोड यूनिट्स (सर्जेट जोड़ी) उपयोग किए जाते हैं।"
type: docs
...
| [getLengthAdjust](../../com.aspose.html.dom.svg/svgtextcontentelement/lengthadjust/) दिए गए तत्व पर ‘lengthAdjust’ विशेषता के अनुरूप है। मान इस इंटरफ़ेस में परिभाषित length adjust स्थिरांकों में से एक होना चाहिए। |
...
| [getNumberOfChars](../../com.aspose.html.dom.svg/svgtextcontentelement/getnumberofchars/)() | वर्तमान तत्व के भीतर रेंडरिंग के लिए उपलब्ध कुल अक्षरों की संख्या लौटाता है, जिसमें ‘tref’ संदर्भ से संदर्भित अक्षर भी शामिल हैं, चाहे उन्हें रेंडर किया जाए या न किया जाए। व्यावहारिक रूप से, यह DOM Level 3 Core ([DOM3], अनुभाग 1.4) के Node::textContent विशेषता की लंबाई के बराबर है, यदि वह विशेषता ‘tref’ तत्वों को भी विस्तारित करती है। |
...
| const [LENGTHADJUST_UNKNOWN](../../com.aspose.html.dom.svg/svgtextcontentelement/lengthadjust_unknown/) | एन्यूमरेशन को एक ऐसे मान पर सेट किया गया है जो पूर्वनिर्धारित प्रकारों में से नहीं है। इस प्रकार का नया मान परिभाषित करने या मौजूदा मान को इस प्रकार में बदलने का प्रयास करना अवैध है। |
