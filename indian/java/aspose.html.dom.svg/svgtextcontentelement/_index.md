---
title: "SVGTextContentElement क्लास"
second_title: "Aspose.HTML for Java API संदर्भ"
description: "com.aspose.html.dom.svg.SVGTextContentElement क्लास। SVGTextContentElement विभिन्न टेक्स्ट-संबंधित इंटरफ़ेस जैसे SVGTextElement, SVGTSpanElement, SVGTRefElement, SVGAltGlyphElement और SVGTextPathElement द्वारा विरासत में प्राप्त है। इस इंटरफ़ेस पर उन मेथड्स के लिए जो किसी अक्षर के इंडेक्स या अक्षरों की संख्या को संदर्भित करते हैं, इन संदर्भों को क्रमशः UTF-16 कोड यूनिट के इंडेक्स या UTF-16 कोड यूनिट्स की संख्या के रूप में व्याख्यायित किया जाना चाहिए। यह DOM Level 2 Core के साथ संगतता के लिए है जहाँ CharacterData इंटरफ़ेस के मेथड्स UTF-16 कोड यूनिट्स को इंडेक्स और काउंट के रूप में उपयोग करते हैं। इसलिए उदाहरण के तौर पर यदि किसी टेक्स्ट तत्व की सामग्री एक एकल non-BMP अक्षर जैसे U10000 है, तो उस तत्व पर getNumberOfChars को कॉल करने पर 2 लौटेगा क्योंकि उस एक अक्षर को दर्शाने के लिए दो UTF-16 कोड यूनिट्स (सर्जेट पेयर) उपयोग होते हैं।"
type: docs

url: /hi/java/com.aspose.html.dom.svg/svgtextcontentelement/
---
## SVGTextContentElement class

SVGTextContentElement विभिन्न टेक्स्ट-संबंधित इंटरफ़ेसों द्वारा विरासत में लिया जाता है, जैसे SVGTextElement, SVGTSpanElement, SVGTRefElement, SVGAltGlyphElement और SVGTextPathElement। इस इंटरफ़ेस पर उन मेथड्स के लिए जो किसी अक्षर के इंडेक्स या अक्षरों की संख्या का उल्लेख करते हैं, इन संदर्भों को क्रमशः UTF-16 कोड यूनिट के इंडेक्स या UTF-16 कोड यूनिट की संख्या के रूप में समझा जाना चाहिए। यह DOM Level 2 Core के साथ संगतता के लिए है, जहाँ CharacterData इंटरफ़ेस पर मेथड्स UTF-16 कोड यूनिट को इंडेक्स और काउंट के रूप में उपयोग करते हैं। उदाहरण के लिए, यदि ‘text’ तत्व की टेक्स्ट सामग्री एक एकल non-BMP अक्षर है, जैसे U+10000, तो उस तत्व पर getNumberOfChars को कॉल करने पर 2 लौटेगा क्योंकि उस एक अक्षर को दर्शाने के लिए दो UTF-16 कोड यूनिट (सर्जेट पेयर) उपयोग किए जाते हैं।
...
| [getLengthAdjust](../../com.aspose.html.dom.svg/svgtextcontentelement/lengthadjust/) दिए गए तत्व पर ‘lengthAdjust’ विशेषता के अनुरूप है। मान इस इंटरफ़ेस में परिभाषित length adjust स्थिरांक में से एक होना चाहिए। |
...
| [getTextLength](../../com.aspose.html.dom.svg/svgtextcontentelement/textlength/) दिए गए तत्व पर ‘textLength’ विशेषता के अनुरूप है। |
...
| [getComputedTextLength](../../com.aspose.html.dom.svg/svgtextcontentelement/getcomputedtextlength/)() | इस तत्व के भीतर सभी अक्षरों को रेंडर करने से प्राप्त सभी अग्रिम मानों का कुल योग, जिसमें ग्लिफ़ (क्षैतिज या लंबवत) पर अग्रिम मान, ‘kerning’, ‘letter-spacing’ और ‘word-spacing’ गुणों का प्रभाव, तथा ‘tspan’ तत्वों पर ‘dx’ और ‘dy’ विशेषताओं के कारण समायोजन शामिल हैं। गैर‑रेंडरिंग वातावरण के लिए, उपयोगकर्ता एजेंट को ग्लिफ़ मेट्रिक्स के बारे में उचित अनुमान लगाना चाहिए। |
...
| [getNumberOfChars](../../com.aspose.html.dom.svg/svgtextcontentelement/getnumberofchars/)() | वर्तमान तत्व के भीतर रेंडरिंग के लिए उपलब्ध कुल अक्षरों की संख्या लौटाता है, जिसमें ‘tref’ संदर्भ से संदर्भित अक्षर भी शामिल हैं, चाहे उन्हें रेंडर किया जाए या नहीं। व्यावहारिक रूप से, यह DOM Level 3 Core ([DOM3], अनुभाग 1.4) के Node::textContent विशेषता की लंबाई के बराबर है, यदि वह विशेषता ‘tref’ तत्वों को भी विस्तारित करती है। |
...
| नाम | विवरण |
| --- | --- |
| const [LENGTHADJUST_SPACING](../../com.aspose.html.dom.svg/svgtextcontentelement/lengthadjust_spacing/) | ‘spacing’ मान से संबंधित है। |
| const [LENGTHADJUST_SPACINGANDGLYPHS](../../com.aspose.html.dom.svg/svgtextcontentelement/lengthadjust_spacingandglyphs/) | ‘spacingAndGlyphs’ मान से संबंधित है। |
| const [LENGTHADJUST_UNKNOWN](../../com.aspose.html.dom.svg/svgtextcontentelement/lengthadjust_unknown/) | एन्यूमरेशन को ऐसे मान पर सेट किया गया था जो पूर्वनिर्धारित प्रकारों में से नहीं है। इस प्रकार का नया मान परिभाषित करने या मौजूदा मान को इस प्रकार में बदलने का प्रयास करना अमान्य है। |
