---
title: "SVGElement क्लास"
second_title: "Aspose.HTML for Java API संदर्भ"
description: "com.aspose.html.dom.svg.SVGElement क्लास। सभी SVG DOM इंटरफ़ेस जो SVG भाषा में तत्वों के साथ सीधे मेल खाते हैं, जैसे path तत्व के लिए SVGPathElement इंटरफ़ेस, SVGElement इंटरफ़ेस से व्युत्पन्न होते हैं।"
type: docs

url: /hi/java/com.aspose.html.dom.svg/svgelement/
---
## SVGElement class

SVG भाषा के तत्वों (जैसे ‘path’ तत्व के लिए SVGPathElement इंटरफ़ेस) के सीधे अनुरूप सभी SVG DOM इंटरफ़ेस SVGElement इंटरफ़ेस से व्युत्पन्न होते हैं।
