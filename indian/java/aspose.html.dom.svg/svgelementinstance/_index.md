...
description: "com.aspose.html.dom.svg.SVGElementInstance क्लास। प्रत्येक use‑element शैडो ट्री का मूल वस्तु SVGUseElementShadowRoot इंटरफ़ेस को लागू करता है। यह इंटरफ़ेस वर्तमान में ShadowRoot इंटरफ़ेस और DocumentOrShadowRoot मिक्सिन के लिए परिभाषित गुणों और विधियों में कोई विस्तार नहीं निर्धारित करता है। हालांकि इस नोड पर आधारित ट्री लेखक स्क्रिप्ट्स के दृष्टिकोण से पूरी तरह पढ़ने‑के‑लिए‑रोक है।"
type: docs
