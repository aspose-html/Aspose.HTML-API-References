---
title: "SVGPathElement क्लास"
second_title: "Aspose.HTML for Java API संदर्भ"
description: "com.aspose.html.dom.svg.SVGPathElement क्लास। SVGPathElement इंटरफ़ेस path तत्व से संबंधित है।"
type: docs
...
| नाम | विवरण |
| --- | --- |
| [getAnimatedPathSegList](../../com.aspose.html.dom.svg/svgpathelement/animatedpathseglist/) ‘d’ attribute की वर्तमान एनिमेटेड सामग्री तक पहुँच प्रदान करता है, जो SVG की सिंटैक्स के साथ एक‑से‑एक मेल खाती है। यदि दिया गया attribute या property एनिमेट हो रहा है, तो यह वर्तमान एनिमेटेड मान रखता है और ऑब्जेक्ट तथा उसकी सामग्री केवल‑पढ़ने योग्य होती है। यदि वर्तमान में एनिमेट नहीं हो रहा है, तो यह pathSegList के समान मान रखता है। |
