---
title: "SVGAnimateTransformElement क्लास"
second_title: "Aspose.HTML for Java API संदर्भ"
description: "com.aspose.html.dom.svg.SVGAnimateTransformElement क्लास। The SVGAnimateTransformElement इंटरफ़ेस animateTransform तत्व के अनुरूप है। SVG DOM के माध्यम से animateTransform तत्व के गुणों तक ऑब्जेक्ट-ओरिएंटेड पहुँच उपलब्ध नहीं है।"
type: docs

url: /hi/java/com.aspose.html.dom.svg/svganimatetransformelement/
---
## SVGAnimateTransformElement class

SVGAnimateTransformElement इंटरफ़ेस ‘animateTransform’ तत्व के अनुरूप है। SVG DOM के माध्यम से ‘animateTransform’ तत्व के गुणों तक ऑब्जेक्ट‑ओरिएंटेड पहुँच उपलब्ध नहीं है।
