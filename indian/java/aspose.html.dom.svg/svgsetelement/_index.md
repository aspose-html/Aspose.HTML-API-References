---
title: "SVGSetElement वर्ग"
second_title: "Aspose.HTML for Java API संदर्भ"
description: "com.aspose.html.dom.svg.SVGSetElement वर्ग। SVGSetElement इंटरफ़ेस set तत्व के अनुरूप है। SVG DOM के माध्यम से set तत्व की विशेषताओं तक ऑब्जेक्ट-ओरिएंटेड पहुँच उपलब्ध नहीं है।"
type: docs

url: /hi/java/com.aspose.html.dom.svg/svgsetelement/
---
## SVGSetElement class

SVGSetElement इंटरफ़ेस ‘set’ तत्व के अनुरूप है। ‘set’ तत्व के गुणों तक ऑब्जेक्ट-ओरिएंटेड पहुँच SVG DOM के माध्यम से उपलब्ध नहीं है।
