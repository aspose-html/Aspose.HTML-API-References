---
title: "SVGAnimateMotionElement क्लास"
second_title: "Aspose.HTML for Java API संदर्भ"
description: "com.aspose.html.dom.svg.SVGAnimateMotionElement क्लास। The SVGAnimateMotionElement इंटरफ़ेस animateMotion तत्व के अनुरूप है। SVG DOM के माध्यम से animateMotion तत्व के गुणों तक ऑब्जेक्ट-ओरिएंटेड पहुँच उपलब्ध नहीं है।"
type: docs

url: /hi/java/com.aspose.html.dom.svg/svganimatemotionelement/
---
## SVGAnimateMotionElement class

SVGAnimateMotionElement इंटरफ़ेस ‘animateMotion’ तत्व के अनुरूप है। SVG DOM के माध्यम से ‘animateMotion’ तत्व के गुणों तक ऑब्जेक्ट‑ओरिएंटेड पहुँच उपलब्ध नहीं है।
