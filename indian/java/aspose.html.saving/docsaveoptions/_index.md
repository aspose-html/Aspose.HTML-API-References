...
description: "com.aspose.html.saving.DocSaveOptions क्लास। विशिष्ट विकल्प डेटा क्लास। गुणों को असाइन करके आप रेंडरिंग विशेषताओं जैसे रिज़ॉल्यूशन, पेज आकार, पृष्ठभूमि रंग तथा दस्तावेज़‑विशिष्ट विकल्प जैसे फ़ॉन्ट एम्बेडिंग को प्रबंधित कर सकते हैं। अधिक जानकारी के लिए दस्तावेज़ लेख देखें।"
type: docs
...
...
 // एक स्रोत HTML फ़ाइल का पथ तैयार करें
      ...
      // DocSaveOptions को प्रारंभ करें। पेज‑आकार 600x400 पिक्सेल और मार्जिन सेट करें
