...
description: "com.aspose.html.saving.XpsSaveOptions क्लास। विशिष्ट विकल्प डेटा क्लास कुछ गुण प्रदान करती है जिससे रूपांतरण परिणाम को प्रबंधित किया जा सकता है। उदाहरण के लिए PageSetup पेज की विशेषताओं को निर्दिष्ट करता है। दस्तावेज़ लेख देखें"
type: docs
...
विशिष्ट विकल्प डेटा क्लास कुछ गुण प्रदान करती है जिससे रूपांतरण परिणाम को प्रबंधित किया जा सकता है। उदाहरण के लिए [`PageSetup`](../../com.aspose.html.rendering/pagesetup/) पेज की विशेषताओं को निर्दिष्ट करता है। दस्तावेज़ [लेख](https://docs.aspose.com/html/net/converting-between-formats/html-to-xps/#save-options) देखें।
...
| [horizontalResolution](../../com.aspose.html.rendering/renderingoptions/horizontalresolution/) { get; set; } | आंतरिक (जो फ़िल्टर प्रोसेसिंग के दौरान उपयोग होते हैं) छवियों के लिए क्षैतिज रेज़ोल्यूशन सेट या प्राप्त करता है, पिक्सेल प्रति इंच में। डिफ़ॉल्ट रूप से यह प्रॉपर्टी 300 dpi है। |
...
| [verticalResolution](../../com.aspose.html.rendering/renderingoptions/verticalresolution/) { get; set; } | आंतरिक (जो फ़िल्टर प्रोसेसिंग के दौरान उपयोग होते हैं) छवियों के लिए ऊर्ध्वाधर रेज़ोल्यूशन सेट या प्राप्त करता है, पिक्सेल प्रति इंच में। डिफ़ॉल्ट रूप से यह प्रॉपर्टी 300 dpi है। |
...
...
      ...
      // पेज‑आकार, मार्जिन सेट करें और पृष्ठभूमि रंग को AntiqueWhite में बदलें
