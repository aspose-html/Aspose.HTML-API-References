---
title: "SVGPathSegLinetoRel क्लास"
second_title: "Aspose.HTML for Java API संदर्भ"
description: "com.aspose.html.dom.svg.paths.SVGPathSegLinetoRel क्लास। SVGPathSegLinetoRel इंटरफ़ेस एक रिलेटिव lineto l पाथ डेटा कमांड के अनुरूप है"
type: docs

url: /hi/java/com.aspose.html.dom.svg.paths/svgpathseglinetorel/
---
## SVGPathSegLinetoRel class

यह SVGPathSegLinetoRel इंटरफ़ेस "relative lineto" (l) पाथ डेटा कमांड के अनुरूप है।
...
| [X](../../com.aspose.html.dom.svg.paths/svgpathseglinetorel/x/) { get; set; } | इस पाथ सेगमेंट के अंत बिंदु के लिए रिलेटिव X निर्देशांक। |
| [Y](../../com.aspose.html.dom.svg.paths/svgpathseglinetorel/y/) { get; set; } | इस पाथ सेगमेंट के अंत बिंदु के लिए रिलेटिव Y निर्देशांक। |
