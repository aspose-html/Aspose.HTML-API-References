---
title: "SVGPathSegCurvetoCubicAbs क्लास"
second_title: "Aspose.HTML for Java API संदर्भ"
description: "com.aspose.html.dom.svg.paths.SVGPathSegCurvetoCubicAbs क्लास। यह SVGPathSegCurvetoCubicAbs इंटरफ़ेस एक परम cubic Bézier curveto C पाथ डेटा कमांड के अनुरूप है"
type: docs

url: /hi/java/com.aspose.html.dom.svg.paths/svgpathsegcurvetocubicabs/
---
## SVGPathSegCurvetoCubicAbs class

SVGPathSegCurvetoCubicAbs इंटरफ़ेस "absolute cubic Bézier curveto" (C) पाथ डेटा कमांड से मेल खाता है।
...
| [X](../../com.aspose.html.dom.svg.paths/svgpathsegcurvetocubicabs/x/) { get; set; } | यह परम X निर्देशांक इस पाथ सेगमेंट के अंत बिंदु के लिए है। |
[getX1]
[setX1] The absolute X coordinate for the first control point. |
[getX2]
[setX2] The absolute X coordinate for the second control point. |
| [Y](../../com.aspose.html.dom.svg.paths/svgpathsegcurvetocubicabs/y/) { get; set; } | यह परम Y निर्देशांक इस पाथ सेगमेंट के अंत बिंदु के लिए है। |
[getY1]
