...
description: "com.aspose.html.dom.svg.paths.SVGPathSegLinetoVerticalAbs क्लास। यह SVGPathSegLinetoVerticalAbs इंटरफ़ेस एक परम vertical lineto V पाथ डेटा कमांड के अनुरूप है।"
type: docs
...
| [Y](../../com.aspose.html.dom.svg.paths/svgpathseglinetoverticalabs/y/) { get; set; } | यह परम Y निर्देशांक इस पाथ सेगमेंट के अंत बिंदु के लिए है। |
