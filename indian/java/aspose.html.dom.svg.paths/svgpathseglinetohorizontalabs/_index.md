...
description: "com.aspose.html.dom.svg.paths.SVGPathSegLinetoHorizontalAbs क्लास। यह SVGPathSegLinetoHorizontalAbs इंटरफ़ेस एक परम horizontal lineto H पाथ डेटा कमांड के अनुरूप है।"
type: docs
...
| [X](../../com.aspose.html.dom.svg.paths/svgpathseglinetohorizontalabs/x/) { get; set; } | यह परम X निर्देशांक इस पाथ सेगमेंट के अंत बिंदु के लिए है। |
