...
रूपांतरणों के लिए उपयोग की जाने वाली मैट्रिक्स का प्रतिनिधित्व करता है।
...
| नाम | विवरण |
| --- | --- |
| [getIsIdentity](../../com.aspose.html.drawing/imatrix/isidentity/) इस मैट्रिक्स के पहचान मैट्रिक्स होने का संकेत देने वाला मान प्राप्त करता है। |
| [getIsInvertible](../../com.aspose.html.drawing/imatrix/isinvertible/) इस मैट्रिक्स के उलटने योग्य होने का संकेत देने वाला मान प्राप्त करता है। |
[getM11]
...
| नाम | विवरण |
| --- | --- |
| [clone](../../com.aspose.html.drawing/imatrix/clone/)() | इस मैट्रिक्स की एक प्रति बनाता है। |
...
| [multiply](../../com.aspose.html.drawing/imatrix/multiply/#multiply)(IMatrix) | इस मैट्रिक्स को किसी अन्य मैट्रिक्स से गुणा करता है। |
| [multiply](../../com.aspose.html.drawing/imatrix/multiply/#multiply_1)(IMatrix, WebMatrixOrder) | निर्दिष्ट क्रम में इस मैट्रिक्स को किसी अन्य मैट्रिक्स से गुणा करता है। |
| [reset](../../com.aspose.html.drawing/imatrix/reset/)() | मैट्रिक्स को पहचान मैट्रिक्स पर रीसेट करता है। |
...
| [scale](../../com.aspose.html.drawing/imatrix/scale/#scale)(float, float) | निर्दिष्ट स्केल फैक्टर्स द्वारा मैट्रिक्स को समान रूप से स्केल करता है। |
| [scale](../../com.aspose.html.drawing/imatrix/scale/#scale_1)(float, float, WebMatrixOrder) | निर्दिष्ट क्रम में निर्दिष्ट स्केल फैक्टर्स द्वारा मैट्रिक्स को स्केल करता है। |
