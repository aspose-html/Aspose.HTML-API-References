...
description: "HtmlRenderer मेथड। कई HTMLDocuments को विशिष्ट IDevice में रेंडर करने के लिए मेथड को परिभाषित करता है"
type: docs
...
कई [`HTMLDocument`](../../../com.aspose.html/htmldocument/) को विशिष्ट [`IDevice`](../../idevice/) में रेंडर करने के लिए मेथड को परिभाषित करता है।
...
कई [`HTMLDocument`](../../../com.aspose.html/htmldocument/) को विशिष्ट [`IDevice`](../../idevice/) में रेंडर करने के लिए एक मेथड को परिभाषित करता है, ऑपरेशन को रद्द करने के अनुरोध के लिए कैंसलेशन टोकन का उपयोग करता है।
