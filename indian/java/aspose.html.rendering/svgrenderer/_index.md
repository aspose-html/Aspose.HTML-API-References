---
title: "SvgRenderer क्लास"
second_title: "Aspose.HTML Java के लिए API संदर्भ"
description: "com.aspose.html.rendering.SvgRenderer क्लास। SVG दस्तावेज़ रेंडरर का प्रतिनिधित्व करता है।"
type: docs

url: /hi/java/com.aspose.html.rendering/svgrenderer/
---
## SvgRenderer class

SVG दस्तावेज़ रेंडरर का प्रतिनिधित्व करता है।
...
| नाम | विवरण |
| --- | --- |
| [SvgRenderer](svgrenderer/)() | डिफ़ॉल्ट कंस्ट्रक्टर। |
...
| [render](../../com.aspose.html.rendering/svgrenderer/render/#render_5)(IDevice, CancellationToken, params SVGDocument[]) | एक विधि को परिभाषित करता है जो कई [`SVGDocument`](../../com.aspose.html.dom.svg/svgdocument/) को एक विशिष्ट [`IDevice`](../idevice/) में रेंडर करती है, संचालन को रद्द करने के अनुरोध के लिए एक कैंसलेशन टोकन का उपयोग करते हुए। |
...
| [render](../../com.aspose.html.rendering/svgrenderer/render/#render_6)(IDevice, TimeSpan, params SVGDocument[]) | कई [`SVGDocument`](../../com.aspose.html.dom.svg/svgdocument/) को विशिष्ट [`IDevice`](../idevice/) में रेंडर करने के लिए विधि को परिभाषित करता है। रेंडरिंग तब की जाएगी जब संसाधनों को लोड करने के लिए कोई नेटवर्क ऑपरेशन, सक्रिय टाइमर, एनीमेशन कार्य नहीं रहे, या निर्दिष्ट टाइमआउट समाप्त हो गया हो। |
