...
description: "com.aspose.html.rendering.PageSetup क्लास। पृष्ठ सेटअप ऑब्जेक्ट का प्रतिनिधित्व करता है जो आउटपुट पेज-सेट की कॉन्फ़िगरेशन के लिए उपयोग किया जाता है।"
type: docs
...
पेज सेटअप ऑब्जेक्ट का प्रतिनिधित्व करता है जो आउटपुट पेज-सेट को कॉन्फ़िगर करने के लिए उपयोग होता है।
