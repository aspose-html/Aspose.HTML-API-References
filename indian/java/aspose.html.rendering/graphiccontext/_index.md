---
title: "GraphicContext क्लास"
second_title: "Aspose.HTML for Java API संदर्भ"
description: "com.aspose.html.rendering.GraphicContext क्लास। वर्तमान ग्राफ़िक्स नियंत्रण पैरामीटर रखता है। ये पैरामीटर वह वैश्विक ढांचा निर्धारित करते हैं जिसमें ग्राफ़िक्स ऑपरेटर निष्पादित होते हैं"
type: docs

url: /hi/java/com.aspose.html.rendering/graphiccontext/
---
## GraphicContext class

वर्तमान ग्राफ़िक्स नियंत्रण पैरामीटर रखता है। ये पैरामीटर वह वैश्विक फ्रेमवर्क परिभाषित करते हैं जिसमें ग्राफ़िक्स ऑपरेटर निष्पादित होते हैं।
...
| नाम | विवरण |
| --- | --- |
| [GraphicContext](graphiccontext/)() | `GraphicContext` क्लास का नया इंस्टेंस इनिशियलाइज़ करता है। |
...
| [getTextInfo](../../com.aspose.html.rendering/graphiccontext/textinfo/) एक [`TextInfo`](../textinfo/) ऑब्जेक्ट प्राप्त करता है जिसमें रेंडर किए गए टेक्स्ट के बारे में जानकारी होती है। |
| [transformationMatrix](../../com.aspose.html.rendering/graphiccontext/transformationmatrix/) { get; set; } | ट्रांसफ़ॉर्मेशन मैट्रिक्स सेट करता है या प्राप्त करता है। |
