...
| नाम | विवरण |
| --- | --- |
| [PdfDevice](pdfdevice/#constructor)(ICreateStreamProvider) | `PdfDevice` क्लास का नया उदाहरण प्रारंभ करता है। |
| [PdfDevice](pdfdevice/#constructor_4)(Stream) | `PdfDevice` क्लास का नया उदाहरण प्रारंभ करता है। |
| [PdfDevice](pdfdevice/#constructor_5)(String) | `PdfDevice` क्लास का नया उदाहरण प्रारंभ करता है। |
| [PdfDevice](pdfdevice/#constructor_1)(PdfRenderingOptions, ICreateStreamProvider) | `PdfDevice` क्लास का नया उदाहरण रेंडरिंग विकल्पों और स्ट्रीम प्रोवाइडर द्वारा प्रारंभ करता है। |
| [PdfDevice](pdfdevice/#constructor_2)(PdfRenderingOptions, Stream) | `PdfDevice` क्लास का नया उदाहरण रेंडरिंग विकल्पों और आउटपुट स्ट्रीम द्वारा प्रारंभ करता है। |
| [PdfDevice](pdfdevice/#constructor_3)(PdfRenderingOptions, String) | `PdfDevice` क्लास का नया उदाहरण रेंडरिंग विकल्पों और आउटपुट फ़ाइल नाम द्वारा प्रारंभ करता है। |
...
| नाम | विवरण |
| --- | --- |
| class [PdfGraphicContext](../../com.aspose.html.rendering.pdf/pdfdevice.pdfgraphiccontext) | PdfDevice के लिए वर्तमान ग्राफ़िक्स नियंत्रण पैरामीटर रखता है। ये पैरामीटर वह वैश्विक फ्रेमवर्क परिभाषित करते हैं जिसमें ग्राफ़िक्स ऑपरेटर निष्पादित होते हैं। |
