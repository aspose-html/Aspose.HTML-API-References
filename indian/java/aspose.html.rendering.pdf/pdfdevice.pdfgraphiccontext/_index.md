---
title: "PdfDevice.PdfGraphicContext क्लास"
second_title: "Aspose.HTML for Java API संदर्भ"
description: "com.aspose.html.rendering.pdf.PdfDevicePdfGraphicContext क्लास। PdfDevice के वर्तमान ग्राफ़िक्स कंट्रोल पैरामीटर रखता है। ये पैरामीटर वह ग्लोबल फ्रेमवर्क परिभाषित करते हैं जिसमें ग्राफ़िक्स ऑपरेटर निष्पादित होते हैं।"
type: docs

url: /hi/java/com.aspose.html.rendering.pdf/pdfdevice.pdfgraphiccontext/
---
## PdfDevice.PdfGraphicContext class

PdfDevice के वर्तमान ग्राफ़िक्स कंट्रोल पैरामीटर रखता है। ये पैरामीटर वह ग्लोबल फ्रेमवर्क परिभाषित करते हैं जिसमें ग्राफ़िक्स ऑपरेटर निष्पादित होते हैं।
...
| नाम | विवरण |
| --- | --- |
| [pdfGraphicContext](../../com.aspose.html.rendering.pdf/pdfdevice.pdfgraphiccontext/.ctor)() | डिफ़ॉल्ट कंस्ट्रक्टर। |
