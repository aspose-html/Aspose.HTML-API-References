---
title: "PdfRenderingOptions क्लास"
second_title: "Aspose.HTML Java के लिए API संदर्भ"
description: "com.aspose.html.rendering.pdf.PdfRenderingOptions क्लास। PdfDevice के लिए रेंडरिंग विकल्पों का प्रतिनिधित्व करता है"
type: docs

url: /hi/java/com.aspose.html.rendering.pdf/pdfrenderingoptions/
---
## PdfRenderingOptions class

[`PdfDevice`](../pdfdevice/) के लिए रेंडरिंग विकल्पों का प्रतिनिधित्व करता है।
...
| नाम | विवरण |
| --- | --- |
| [PdfRenderingOptions](pdfrenderingoptions/)() | `PdfRenderingOptions` क्लास का नया उदाहरण प्रारंभ करता है। |
