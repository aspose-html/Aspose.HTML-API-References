...
description: "Converter मेथड। इनपुट स्ट्रीम द्वारा प्रस्तुत MHTML स्रोत को परिवर्तित करें। परिणाम आउटपुट फ़ाइल पथ द्वारा निर्मित xps फ़ाइल है।"
type: docs
...
| options | XpsSaveOptions | [`XpsSaveOptions`](../../../com.aspose.html.saving/xpssaveoptions/) ऑब्जेक्ट का उपयोग आपको रेंडरिंग प्रक्रिया को ट्यून करने में सक्षम बनाता है। अधिक जानकारी के लिए देखें [Aspose दस्तावेज़ीकरण](https://docs.aspose.com/html/net/converting-between-formats/mhtml-to-xps/#save-options)। |
...
MHTML से [XPS](https://docs.fileformat.com/page-description-language/xps/) रूपांतरण अक्सर विशिष्ट कार्यों के लिए XPS फ़ॉर्मैट का लाभ उठाने के लिए आवश्यक होता है। एक XPS फ़ाइल पेज लेआउट फ़ाइलों को दर्शाती है जो XML पेपर स्पेसिफिकेशन पर आधारित हैं, माइक्रोसॉफ्ट द्वारा निर्मित।

जहाँ आप ConvertHTML() मेथड्स का उपयोग करके MHTML को XPS में परिवर्तित करने और कैसे [`Converter`](../) क्लास की विधियों का उपयोग करें, तथा कैसे [`XpsSaveOptions`](../../../com.aspose.html.saving/xpssaveoptions/) और [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) पैरामीटर लागू करें, उस [लेख](https://docs.aspose.com/html/net/converting-between-formats/mhtml-to-xps/) को देखें।

MHTML को XPS में परिवर्तित करें
...
रूपांतरण स्रोत। मौजूदा स्थानीय MHTML (.mht) फ़ाइल या रिमोट [`Url`](../../../com.aspose.html/url/) को रूपांतरण स्रोत के रूप में पहचानें। आप मानक या कस्टम विशिष्ट स्ट्रीम को भी रूपांतरण स्रोत के रूप में उपयोग कर सकते हैं। रूपांतरण परिणाम। परिणाम आउटपुट फ़ाइल पथ को परिभाषित करें या आउटपुट डेटा बफ़र के रूप में ज्ञात या कस्टम [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) इंटरफ़ेस कार्यान्वयन का उपयोग करें। विशिष्ट या डिफ़ॉल्ट सेटिंग्स के साथ नया [`XpsSaveOptions`](../../../com.aspose.html.saving/xpssaveoptions/) ऑब्जेक्ट बनाएं। आप विकल्प पैरामीटर के रूप में [`configuration`](../../../com.aspose.html/configuration/) भी जोड़ सकते हैं। Converter क्लास की ConvertMHTML() मेथड का उपयोग करके MHTML को XPS परिणाम के रूप में सहेजें, जिसमें उपयोगकर्ता परिदृश्य के अनुसार तीन या अधिक पैरामीटर हो सकते हैं। ऑनलाइन MHTML कनवर्टर

Aspose.HTML एक मुफ्त ऑनलाइन [MHTML से XPS कनवर्टर](https://products.aspose.app/html/en/conversion/mhtml-to-xps) प्रदान करता है जो उच्च गुणवत्ता, सरलता और तेज़ी से MHTML को XPS में परिवर्तित करता है। बस फ़ाइलें अपलोड करें, उन्हें परिवर्तित करें और कुछ ही सेकंड में परिणाम प्राप्त करें!
...
| Parameter | Type | विवरण |
| --- | --- | --- |
| sourcePath | String | MHTML स्रोत की पूर्ण फ़ाइल पथ। |
| options | XpsSaveOptions | [`XpsSaveOptions`](../../../com.aspose.html.saving/xpssaveoptions/) ऑब्जेक्ट का उपयोग आपको रेंडरिंग प्रक्रिया को ट्यून करने में सक्षम बनाता है। अधिक जानकारी के लिए देखें [Aspose दस्तावेज़ीकरण](https://docs.aspose.com/html/net/converting-between-formats/mhtml-to-xps/#save-options)। |
| outputPath | String | आउटपुट परिवर्तन परिणाम के रूप में पूर्ण xps फ़ाइल पथ। |
...
| Parameter | Type | विवरण |
| --- | --- | --- |
| sourceUrl | Url | MHTML स्रोत दस्तावेज़ URL - एक सार्वभौमिक पहचानकर्ता (URL) का वस्तु प्रतिनिधित्व प्रदान करता है। |
| options | XpsSaveOptions | [`XpsSaveOptions`](../../../com.aspose.html.saving/xpssaveoptions/) ऑब्जेक्ट का उपयोग आपको रेंडरिंग प्रक्रिया को ट्यून करने में सक्षम बनाता है। अधिक जानकारी के लिए देखें [Aspose दस्तावेज़ीकरण](https://docs.aspose.com/html/net/converting-between-formats/mhtml-to-xps/#save-options)। |
| outputPath | String | आउटपुट परिवर्तन परिणाम के रूप में पूर्ण xps फ़ाइल पथ। |
...
इनपुट [स्ट्रीम](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream?view=net-6.0) द्वारा प्रस्तुत MHTML स्रोत को परिवर्तित करें। परिणाम आउटपुट फ़ाइल पथ द्वारा निर्मित XPS फ़ाइल है।
...
| Parameter | Type | विवरण |
| --- | --- | --- |
| स्ट्रीम | स्ट्रीम | परिवर्तन स्रोत mhtml (.mht) डेटा स्ट्रीम। |
...
| Parameter | Type | विवरण |
| --- | --- | --- |
| स्ट्रीम | स्ट्रीम | MHTML परिवर्तन इनपुट डेटा स्ट्रीम। |
| options | DocSaveOptions | [`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/) ऑब्जेक्ट का उपयोग रेंडरिंग प्रक्रिया को समायोजित करने में सक्षम बनाता है। अधिक जानकारी के लिए देखें [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/mhtml-to-docx/#save-options)। |
...
MHTML को DOCX में परिवर्तित करना अक्सर विशिष्ट कार्यों के लिए [DOCX](https://docs.fileformat.com/word-processing/docx/) फ़ॉर्मेट का लाभ उठाने के लिए आवश्यक होता है। DOCX माइक्रोसॉफ्ट वर्ड दस्तावेज़ों के लिए एक प्रसिद्ध फ़ॉर्मेट है। इसमें टेक्स्ट, तालिकाएँ, रास्टर और वेक्टर ग्राफ़िक्स, वीडियो, ध्वनियाँ और आरेख सहित विभिन्न प्रकार का डेटा हो सकता है। यह फ़ॉर्मेट जटिल फ़ॉर्मेटिंग सुविधाओं का समर्थन करता है और उपयोगकर्ताओं को किसी भी प्रकार का दस्तावेज़ लिखने के लिए कई विकल्प प्रदान करता है।

इस [article](https://docs.aspose.com/html/net/converting-between-formats/mhtml-to-docx/) को देखें जहाँ आप ConvertMHTML() मेथड्स का उपयोग करके MHTML को DOCX में कैसे परिवर्तित करें, जो [`Converter`](../) क्लास का हिस्सा हैं, और कैसे [`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/) तथा [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) पैरामीटर लागू करें, इस बारे में जानकारी पाएँगे।

MHTML को DOCX में परिवर्तित करें

Converter क्लास कुछ MHTML-विशिष्ट परिवर्तनों को DOCX में प्रदान करती है। MHTML को DOCX में परिवर्तित करने के लिए, आपको कुछ सरल चरणों वाले परिदृश्यों में से एक का पालन करना चाहिए:

परिवर्तन स्रोत। मौजूदा स्थानीय MHTML (.mht) फ़ाइल या रिमोट [`Url`](../../../com.aspose.html/url/) को परिवर्तन स्रोत के रूप में पहचानें। आप मानक या कस्टम विशिष्ट स्ट्रीम को भी परिवर्तन स्रोत के रूप में उपयोग कर सकते हैं। परिवर्तन परिणाम। परिणाम आउटपुट फ़ाइल पथ निर्धारित करें या ज्ञात या कस्टम [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) इंटरफ़ेस कार्यान्वयन को आउटपुट डेटा बफ़र के रूप में उपयोग करें। विशिष्ट या डिफ़ॉल्ट सेटिंग्स के साथ नया [`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/) ऑब्जेक्ट बनाएँ। आप विकल्प पैरामीटर के रूप में [`configuration`](../../../com.aspose.html/configuration/) भी जोड़ सकते हैं। Converter क्लास की ConvertMHTML() मेथड का उपयोग करके MHTML को DOCX परिणाम के रूप में सहेजें, जिसमें उपयोगकर्ता परिदृश्य के आधार पर तीन या अधिक पैरामीटर हो सकते हैं। ऑनलाइन MHTML कनवर्टर

Aspose.HTML एक मुफ्त ऑनलाइन [MHTML to DOCX Converter](https://products.aspose.app/html/en/conversion/mhtml-to-docx) प्रदान करता है जो MHTML को उच्च गुणवत्ता, आसान और तेज़ी से DOCX में परिवर्तित करता है। बस फ़ाइलें अपलोड करें, परिवर्तित करें और कुछ सेकंड में परिणाम प्राप्त करें!
...
| Parameter | Type | विवरण |
| --- | --- | --- |
| sourceUrl | Url | MHTML स्रोत दस्तावेज़ [`URL`](../../../com.aspose.html/url/) - एक सार्वभौमिक पहचानकर्ता (URL) का वस्तु प्रतिनिधित्व प्रदान करता है। |
| configuration | Configuration | पर्यावरण कॉन्फ़िगरेशन। यह [`configuration`](../../../com.aspose.html/configuration/) कॉन्टेक्स्ट ऑब्जेक्ट को दर्शाता है जिसका उपयोग एप्लिकेशन के लिए पर्यावरण सेटिंग्स को सेट करने में किया जाता है। |
| options | DocSaveOptions | [`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/) ऑब्जेक्ट का उपयोग रेंडरिंग प्रक्रिया को समायोजित करने में सक्षम बनाता है। अधिक जानकारी के लिए देखें [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/mhtml-to-docx/#save-options)। |
| outputPath | String | आउटपुट रूपांतरण परिणाम के रूप में पूर्ण docx फ़ाइल पाथ। |
...
| --- | --- | --- |
| स्ट्रीम | स्ट्रीम | MHTML परिवर्तन इनपुट डेटा स्ट्रीम। |
| options | PdfSaveOptions | [`PdfSaveOptions`](../../../com.aspose.html.saving/pdfsaveoptions/) ऑब्जेक्ट का उपयोग रेंडरिंग प्रक्रिया को समायोजित करने में सक्षम बनाता है। अधिक जानकारी के लिए देखें [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/mhtml-to-pdf/#save-options)। |
...
MHTML को PDF में परिवर्तित करना अक्सर विशिष्ट कार्यों के लिए [PDF](https://docs.fileformat.com/pdf/) फ़ॉर्मेट का लाभ उठाने के लिए आवश्यक होता है। PDF में कई ऐसे लाभ हैं जो अन्य फ़ाइलों में नहीं होते। उदाहरण के लिए, कई प्रोग्राम और ऐप्स PDF दस्तावेज़ों का समर्थन करते हैं; PDF फ़ाइलें प्रिंटिंग के लिए अनुकूलित होती हैं, और वे आपके दस्तावेज़ों की भौतिक प्रतियां बनाने के लिए आदर्श हैं; आप PDF फ़ाइलों के लिए सुरक्षा सेटिंग्स कॉन्फ़िगर कर सकते हैं - प्रिंटिंग, संपादन, इलेक्ट्रॉनिक सिग्नेचर आदि को निष्क्रिय कर सकते हैं।

इस [article](https://docs.aspose.com/html/net/converting-between-formats/mhtml-to-pdf/) को देखें, जहाँ आप ConvertMHTML() मेथड्स का उपयोग करके MHTML को PDF में कैसे परिवर्तित करें, जो [`Converter`](../) क्लास का हिस्सा हैं, और कैसे [`PdfSaveOptions`](../../../com.aspose.html.saving/pdfsaveoptions/) तथा [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) पैरामीटर लागू करें, इस बारे में जानकारी पाएँगे।

MHTML को PDF में बदलें

Converter क्लास MHTML से PDF में कुछ विशिष्ट रूपांतरण प्रदान करती है। MHTML को PDF में बदलने के लिए, आपको कुछ चरणों वाले सरल परिदृश्यों में से एक का पालन करना चाहिए:

रूपांतरण स्रोत। मौजूदा स्थानीय MHTML (.mht) फ़ाइल या रिमोट Url को रूपांतरण स्रोत के रूप में पहचानें। आप स्रोत के रूप में मानक या कस्टम विशिष्ट [stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream?view=net-6.0) का भी उपयोग कर सकते हैं। रूपांतरण परिणाम। परिणाम आउटपुट फ़ाइल पथ निर्धारित करें या ज्ञात या कस्टम [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) इंटरफ़ेस कार्यान्वयन को आउटपुट डेटा बफ़र के रूप में उपयोग करें। विशिष्ट या डिफ़ॉल्ट सेटिंग्स के साथ नया [`PdfSaveOptions`](../../../com.aspose.html.saving/pdfsaveoptions/) ऑब्जेक्ट बनाएं। आप विकल्प पैरामीटर के रूप में [`configuration`](../../../com.aspose.html/configuration/) भी जोड़ सकते हैं। Converter क्लास की ConvertMHTML() मेथड का उपयोग करके MHTML को PDF परिणाम के रूप में सहेजें, जिसमें उपयोगकर्ता परिदृश्य के आधार पर तीन या अधिक पैरामीटर हो सकते हैं। ऑनलाइन MHTML कनवर्टर
...
इनपुट स्ट्रीम द्वारा प्रस्तुत MHTML स्रोत को इमेज में परिवर्तित करें। परिणाम आउटपुट फ़ाइल पथ द्वारा निर्मित इमेज फ़ाइल है।
...
[MHTML](https://docs.fileformat.com/web/mhtml/) एक्सटेंशन वाली फ़ाइलें वेब पेज आर्काइव फ़ॉर्मेट का प्रतिनिधित्व करती हैं जिसे विभिन्न अनुप्रयोग बना सकते हैं। इस फ़ॉर्मेट को आर्काइव फ़ॉर्मेट कहा जाता है क्योंकि यह वेब HTML कोड और संबंधित संसाधनों को एक ही फ़ाइल में सहेजता है। इन संसाधनों में वेबपेज से जुड़े चित्र, एप्लेट, एनीमेशन, ऑडियो फ़ाइलें आदि शामिल हैं। MHTML फ़ाइलें विभिन्न अनुप्रयोगों जैसे Internet Explorer और Microsoft Word में खोली जा सकती हैं। इस फ़ॉर्मेट की वास्तविक विशिष्टताएँ [RFC 2557](https://datatracker.ietf.org/doc/html/rfc2557) में विस्तृत हैं।

लेख देखें, जहाँ आप Converter क्लास की ConvertMHTML() मेथड्स का उपयोग करके MHTML को विभिन्न फ़ॉर्मेट में इमेज में बदलने की जानकारी और [`ImageSaveOptions`](../../../com.aspose.html.saving/imagesaveoptions/) तथा [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) पैरामीटर कैसे लागू करें, पा सकते हैं।

MHTML को इमेज में बदलें

Converter क्लास MHTML से इमेज में कुछ विशिष्ट रूपांतरण प्रदान करती है। समर्थित फ़ॉर्मेट हैं [JPEG](https://docs.fileformat.com/image/jpeg/), [PNG](https://docs.fileformat.com/image/png/), [BMP](https://docs.fileformat.com/image/bmp/), [GIF](https://docs.fileformat.com/image/gif/) और [TIFF](https://docs.fileformat.com/image/tiff/)। MHTML को इमेज में बदलने के लिए, आपको कुछ चरणों वाले सरल परिदृश्यों में से एक का पालन करना चाहिए:

रूपांतरण स्रोत। मौजूदा स्थानीय MHTML (.mht) फ़ाइल या रिमोट [`Url`](../../../com.aspose.html/url/) को रूपांतरण स्रोत के रूप में पहचानें। आप स्रोत के रूप में मानक या कस्टम विशिष्ट स्ट्रीम का भी उपयोग कर सकते हैं। रूपांतरण परिणाम। परिणाम आउटपुट फ़ाइल पथ निर्धारित करें या ज्ञात या कस्टम [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) इंटरफ़ेस कार्यान्वयन को आउटपुट डेटा बफ़र के रूप में उपयोग करें। विशिष्ट या डिफ़ॉल्ट सेटिंग्स के साथ नया [`ImageSaveOptions`](../../../com.aspose.html.saving/imagesaveoptions/) ऑब्जेक्ट बनाएं। डिफ़ॉल्ट इमेज फ़ॉर्मेट PNG है। आप विकल्प पैरामीटर के रूप में कॉन्फ़िगरेशन भी जोड़ सकते हैं। Converter क्लास की ConvertMHTML() मेथड का उपयोग करके MHTML को इमेज परिणाम के रूप में सहेजें, जिसमें उपयोगकर्ता परिदृश्य के आधार पर तीन या अधिक पैरामीटर हो सकते हैं। ऑनलाइन MHTML कनवर्टर
...
पूर्ण फ़ाइल पथ द्वारा प्रस्तुत MHTML स्रोत को परिवर्तित करें। परिणाम आउटपुट फ़ाइल पथ द्वारा निर्मित इमेज फ़ाइल है।
