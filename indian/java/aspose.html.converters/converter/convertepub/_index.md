...
| options | ImageSaveOptions | नए निर्मित इमेज विकल्प जैसे फ़ॉर्मेट, रिज़ॉल्यूशन आदि। देखें [`ImageSaveOptions `](../../../com.aspose.html.saving/imagesaveoptions/) क्लास और [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-png/#save-options)। |
...
EPUB एक ई-बुक फ़ाइल फ़ॉर्मेट है जो मानक डिजिटल प्रकाशन फ़ॉर्मेट प्रदान करता है। इसे International Digital Publishing Forum (IDPF) ने बनाया था, और अब यह कई ई-रीडर और सॉफ्टवेयर अनुप्रयोगों द्वारा समर्थित है।
...
Aspose.HTML की मुख्य विशेषता रूपांतरण सुविधा है। EPUB एक ओपन XML-आधारित फ़ॉर्मेट है डिजिटल पुस्तकों और प्रकाशनों के लिए, जिसे स्मार्टफ़ोन, टैबलेट और कंप्यूटर पर देखा और पढ़ा जा सकता है। com.aspose.html.converters पैकेज रूपांतरण मेथड्स तक आसान पहुँच प्रदान करता है। यह लोकप्रिय फ़ॉर्मेट्स जैसे [PDF](https://docs.fileformat.com/pdf/), [XPS](https://docs.fileformat.com/page-description-language/xps/), [DOCX](https://docs.fileformat.com/word-processing/docx/), [JPEG](https://docs.fileformat.com/image/jpeg/), [PNG](https://docs.fileformat.com/image/png/), [BMP](https://docs.fileformat.com/image/bmp/), [TIFF](https://docs.fileformat.com/image/tiff/), और [GIF](https://docs.fileformat.com/image/gif/) में व्यापक [EPUB](https://docs.fileformat.com/ebook/epub/) रूपांतरण उपलब्ध कराता है।

यह अनुभाग समर्थित EPUB रूपांतरण परिदृश्यों की सूची और उन्हें Converter क्लास का उपयोग करके कैसे निष्पादित करें, इस बारे में जानकारी प्रदान करता है, जो सभी लो-लेवल रूपांतरण ऑपरेशन्स को एक ही क्लास में समूहित करता है ताकि वे आरामदायक और उपयोग में आसान हों। EPUB Converter गाइड में, आप निम्नलिखित लेख पाएँगे:
...
निर्दिष्ट पथ पर मौजूद EPUB फ़ाइल के आधार पर URL निर्धारित करें। परिणाम आउटपुट फ़ाइल पथ निर्धारित करें। आवश्यक ImageFormat के साथ एक नया [`ImageSaveOptions`](../../../com.aspose.html.saving/imagesaveoptions/) ऑब्जेक्ट बनाएं। डिफ़ॉल्ट रूप से, Format प्रॉपर्टी PNG है। EPUB को इमेज के रूप में सहेजने के लिए Converter क्लास की ConvertEPUB() मेथड का उपयोग करें। इमेज रूपांतरण के लिए आपको ImageSaveOptions और Configuration ऑब्जेक्ट भी पास करने की आवश्यकता है। ऑनलाइन EPUB कन्वर्टर

Aspose.HTML एक मुफ्त ऑनलाइन [EPUB to PNG](https://products.aspose.app/html/en/conversion/epub-to-png) कन्वर्टर प्रदान करता है जो उच्च गुणवत्ता, आसान और तेज़ी से EPUB को PNG इमेज में बदलता है। बस फ़ाइलें अपलोड करें, उन्हें कन्वर्ट करें और कुछ सेकंड में परिणाम प्राप्त करें!
...
पूर्ण फ़ाइल पथ द्वारा प्रस्तुत EPUB स्रोत को बदलें। परिणाम आउटपुट फ़ाइल पथ द्वारा निर्मित छवि फ़ाइल है। छवि प्रारूप ImageSaveOptions ऑब्जेक्ट द्वारा निर्दिष्ट किया जाता है।
...
URL द्वारा परिभाषित EPUB स्रोत को बदलें। परिणाम आउटपुट फ़ाइल पथ द्वारा निर्मित छवि फ़ाइल है। छवि प्रारूप ImageSaveOptions ऑब्जेक्ट द्वारा निर्दिष्ट किया जाता है।
...
डेटा इनपुट स्ट्रीम द्वारा प्रस्तुत EPUB स्रोत को बदलें। परिणाम आउटपुट फ़ाइल पथ द्वारा निर्मित छवि फ़ाइल है। छवि प्रारूप ImageSaveOptions ऑब्जेक्ट द्वारा निर्दिष्ट किया जाता है।
...
| --- | --- | --- |
| sourcePath | String | इनपुट पैरामीटर के रूप में EPUB स्रोत फ़ाइल पथ। |
| configuration | Configuration | पर्यावरण कॉन्फ़िगरेशन। यह [configuration](https://apireference.aspose.com/html/net/aspose.html/configuration) कॉन्टेक्स्ट ऑब्जेक्ट का प्रतिनिधित्व करता है जिसका उपयोग एप्लिकेशन के लिए पर्यावरण सेटिंग्स को सेट अप करने में किया जाता है। |
| options | ImageSaveOptions | ImageSaveOptions ऑब्जेक्ट का उपयोग आपको रेंडरिंग प्रक्रिया को ट्यून करने की अनुमति देता है। आप [`page size`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/), [`margins`](../../../com.aspose.html.drawing/page/margin/), [`CSS media-type`](../../../com.aspose.html.rendering/mediatype/) आदि निर्दिष्ट कर सकते हैं। देखें [`ImageSaveOptions `](../../../com.aspose.html.saving/imagesaveoptions/) क्लास। |
| outputPath | String | आउटपुट रूपांतरण परिणाम के रूप में पूर्ण इमेज फ़ाइल पथ। |
...
इनपुट [Stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream?view=net-5.0) द्वारा प्रस्तुत epub स्रोत को इमेज में बदलें। परिणाम वह इमेज फ़ाइल है जो [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) इंटरफ़ेस के कार्यान्वयन द्वारा बनाई गई है।
...
मौजूदा EPUB फ़ाइल खोलें। उदाहरण में, हम निर्दिष्ट पथ पर फ़ाइल सिस्टम से EPUB फ़ाइल खोलने और पढ़ने के लिए System.IO.FileStream क्लास की OpenRead() मेथड का उपयोग करते हैं। आउटपुट डेटा बफ़र के रूप में ज्ञात या कस्टम [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) इंटरफ़ेस कार्यान्वयन का उपयोग करें। आवश्यक ImageFormat के साथ एक नया [`ImageSaveOptions`](../../../com.aspose.html.saving/imagesaveoptions/) ऑब्जेक्ट बनाएं। डिफ़ॉल्ट रूप से, Format प्रॉपर्टी PNG है। EPUB को इमेज के रूप में सहेजने के लिए Converter क्लास की ConvertEPUB() मेथड का उपयोग करें। EPUB को इमेज में बदलने के लिए आपको EPUB inputStream, ImageSaveOptions, और आउटपुट स्ट्रीम को ConvertEPUB() मेथड में पास करना होगा। ऑनलाइन EPUB कन्वर्टर
...
// ICreateStreamProvider इंटरफ़ेस कार्यान्वयन को देखें  
...
फ़ाइल पथ द्वारा प्रस्तुत EPUB स्रोत को इमेज में बदलें। परिणाम वह इमेज फ़ाइल है जो [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) इंटरफ़ेस के कार्यान्वयन द्वारा बनाई गई है।
...
मौजूदा EPUB फ़ाइल खोलें। उदाहरण में, हम निर्दिष्ट पथ पर फ़ाइल सिस्टम से EPUB फ़ाइल खोलने और पढ़ने के लिए System.IO.FileStream क्लास की OpenRead() मेथड का उपयोग करते हैं। आउटपुट डेटा बफ़र के रूप में ज्ञात या कस्टम ICreateStreamProvider इंटरफ़ेस कार्यान्वयन का उपयोग करें। आवश्यक ImageFormat के साथ एक नया ImageSaveOptions ऑब्जेक्ट बनाएं। डिफ़ॉल्ट रूप से, Format प्रॉपर्टी PNG है। EPUB को इमेज के रूप में सहेजने के लिए Converter क्लास की ConvertEPUB() मेथड का उपयोग करें। EPUB को इमेज में बदलने के लिए आपको EPUB inputStream, ImageSaveOptions, और आउटपुट स्ट्रीम को ConvertEPUB() मेथड में पास करना होगा। ऑनलाइन EPUB कन्वर्टर
...
// ConvertEPUB मेथड को कॉल करके EPUB कोड को JPG छवि में बदलें
...
URL द्वारा प्रस्तुत EPUB स्रोत को छवि में बदलें। परिणाम एक छवि फ़ाइल है जो [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) इंटरफ़ेस के कार्यान्वयन द्वारा बनाई गई है।
...
| configuration | Configuration | पर्यावरण कॉन्फ़िगरेशन। यह [`configuration`](../../../com.aspose.html/configuration/) कॉन्टेक्स्ट ऑब्जेक्ट को दर्शाता है जिसका उपयोग एप्लिकेशन के लिए पर्यावरण सेटिंग्स को सेट करने में किया जाता है। |
| options | ImageSaveOptions | ImageSaveOptions ऑब्जेक्ट का उपयोग रेंडरिंग प्रक्रिया को ट्यून करने में सक्षम बनाता है। आप [`page size`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/), [`margins`](../../../com.aspose.html.drawing/page/margin/), [`CSS media-type`](../../../com.aspose.html.rendering/mediatype/) आदि निर्दिष्ट कर सकते हैं। |
| प्रदाता | ICreateStreamProvider | इंटरफ़ेस का कार्यान्वयन, जिसका उपयोग आउटपुट स्ट्रीम प्राप्त करने के लिए किया जाएगा। |
...
फ़ाइल पथ द्वारा प्रस्तुत EPUB स्रोत को छवि में बदलें। परिणाम एक छवि फ़ाइल है जो [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) इंटरफ़ेस के कार्यान्वयन द्वारा बनाई गई है।
...
| configuration | Configuration | पर्यावरण कॉन्फ़िगरेशन। यह [`configuration`](../../../com.aspose.html/configuration/) कॉन्टेक्स्ट ऑब्जेक्ट को दर्शाता है जिसका उपयोग एप्लिकेशन के लिए पर्यावरण सेटिंग्स को सेट करने में किया जाता है। |
| options | ImageSaveOptions | ImageSaveOptions ऑब्जेक्ट का उपयोग रेंडरिंग प्रक्रिया को ट्यून करने में सक्षम बनाता है। आप [`page size`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/), [`margins`](../../../com.aspose.html.drawing/page/margin/), [`CSS media-type`](../../../com.aspose.html.rendering/mediatype/) आदि निर्दिष्ट कर सकते हैं। |
| provider | ICreateStreamProvider | इंटरफ़ेस का कार्यान्वयन, जिसका उपयोग आउटपुट स्ट्रीम प्राप्त करने के लिए किया जाएगा। ICreateStreamProvider कार्यान्वयन का उदाहरण [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-jpg/#output-stream-providers) में देखें। |
...
URL द्वारा प्रस्तुत epub स्रोत को छवि में बदलें। परिणाम एक छवि फ़ाइल है जो [ICreateStreamProvider](https://apireference.aspose.com/html/net/aspose.html.io/icreatestreamprovider) इंटरफ़ेस के कार्यान्वयन द्वारा निर्मित होती है।
...
import com.aspose.html.converters;
...
// इनपुट फ़ाइल पथ से स्रोत URL बनाएं।
var sourceUrl = new Url(Path.Combine(InputFolder, "sample.epub"));
...
इनपुट स्ट्रीम द्वारा प्रस्तुत epub स्रोत को XPS में बदलें। परिणाम पूर्ण पथ द्वारा परिभाषित XPS फ़ाइल है।
...
| Parameter | Type | विवरण |
| --- | --- | --- |
| stream | Stream | रूपांतरण स्रोत के रूप में इनपुट स्ट्रीम। स्ट्रीम विनिर्देश [official source](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream?view=net-5.0) में देखें। |
| options | XpsSaveOptions | रूपांतरण विकल्प। [`XpsSaveOptions`](../../../com.aspose.html.saving/xpssaveoptions/) ऑब्जेक्ट का उपयोग आपको रेंडरिंग प्रक्रिया को ट्यून करने की अनुमति देता है; आप पृष्ठ आकार, मार्जिन, CSS आदि निर्दिष्ट कर सकते हैं। |
...
एक XPS फ़ाइल पृष्ठ लेआउट फ़ाइलों का प्रतिनिधित्व करती है जो माइक्रोसॉफ्ट द्वारा निर्मित XML पेपर स्पेसिफिकेशन पर आधारित होती हैं। इसे EMF फ़ाइल फ़ॉर्मेट के विकल्प के रूप में विकसित किया गया था और यह PDF फ़ाइल फ़ॉर्मेट के समान है, लेकिन दस्तावेज़ के लेआउट, उपस्थिति और प्रिंटिंग जानकारी में XML का उपयोग करता है।

Aspose.HTML की मुख्य विशेषता रूपांतरण सुविधा है। EPUB एक ओपन XML-आधारित फ़ॉर्मेट है डिजिटल पुस्तकों और प्रकाशनों के लिए, जिसे स्मार्टफ़ोन, टैबलेट और कंप्यूटर पर देखा और पढ़ा जा सकता है। com.aspose.html.converters पैकेज रूपांतरण मेथड्स तक आसान पहुँच प्रदान करता है। यह लोकप्रिय फ़ॉर्मेट्स जैसे [PDF](https://docs.fileformat.com/pdf/), [XPS](https://docs.fileformat.com/page-description-language/xps/), [DOCX](https://docs.fileformat.com/word-processing/docx/), [JPEG](https://docs.fileformat.com/image/jpeg/), [PNG](https://docs.fileformat.com/image/png/), [BMP](https://docs.fileformat.com/image/bmp/), [TIFF](https://docs.fileformat.com/image/tiff/), और [GIF](https://docs.fileformat.com/image/gif/) में व्यापक [EPUB](https://docs.fileformat.com/ebook/epub/) रूपांतरण उपलब्ध कराता है।

यह अनुभाग समर्थित EPUB रूपांतरण परिदृश्यों की सूची और उन्हें कैसे निष्पादित करें, इस बारे में जानकारी प्रदान करता है, जिसमें एक [`Converter`](../) क्लास का उपयोग किया जाता है जो सभी लो‑लेवल रूपांतरण ऑपरेशनों को एक ही क्लास में समूहित करता है ताकि वे आरामदायक और उपयोग में आसान हों। EPUB Converter XPS विशिष्ट गाइड में, आप निम्न लेख पाएंगे:
...
EPUB को XPS फ़ाइल फ़ॉर्मेट में बदलने के लिए, आपको कुछ चरणों का पालन करना चाहिए:

एक मौजूदा EPUB फ़ाइल खोलें। उदाहरण के लिए, हम स्रोत फ़ाइल पथ को ConvertEPUB मेथड के पहले पैरामीटर के रूप में परिभाषित कर सकते हैं। आउटपुट डेटा बफ़र के रूप में ज्ञात या कस्टम ICreateStreamProvider इंटरफ़ेस कार्यान्वयन का उपयोग करें। हम परिणाम आउटपुट फ़ाइल पथ को एक सरल विकल्प के रूप में भी उपयोग कर सकते हैं। पृष्ठ आकार, मार्जिन, CSS आदि जैसे वांछित पैरामीटरों के साथ एक नया XpsSaveOptions ऑब्जेक्ट बनाएं। XpsSaveOptions क्लास का डिफ़ॉल्ट इंस्टेंस उपयोग करना संभव है। स्थैतिक Converter क्लास के ConvertEPUB() मेथड का उपयोग करके EPUB को XPS फ़ाइल के रूप में सहेजें। रूपांतरण प्रक्रिया शुरू करने के लिए आपको EPUB स्रोत डेटा, XpsSaveOptions, और आउटपुट डेटा बफ़र को किसी भी रूप में पास करना होगा। Online EPUB to XPS converter

Aspose.HTML एक मुफ्त ऑनलाइन [EPUB to XPS](https://products.aspose.app/html/en/conversion/epub-to-xps) कनवर्टर प्रदान करता है जो उच्च गुणवत्ता, आसान और तेज़ी से EPUB को XPS फ़ाइल में बदलता है। बस अपलोड करें, अपनी फ़ाइलों को बदलें और कुछ सेकंड में परिणाम प्राप्त करें!
...
...
  ...
  // बदलाव की गई फ़ाइल को सहेजने के लिए पथ तैयार करें
  ...
  // EPUB को XPS में बदलने के लिए ConvertEPUB मेथड को कॉल करें
...
इनपुट EPUB फ़ाइल पथ द्वारा प्रस्तुत epub स्रोत को XPS में बदलें। परिणाम पूर्ण पथ द्वारा परिभाषित XPS फ़ाइल है।
...
एक मौजूदा EPUB फ़ाइल खोलें। उदाहरण के लिए, हम स्रोत फ़ाइल पथ को ConvertEPUB मेथड के पहले पैरामीटर के रूप में परिभाषित कर सकते हैं। आउटपुट डेटा बफ़र के रूप में ज्ञात या कस्टम ICreateStreamProvider इंटरफ़ेस कार्यान्वयन का उपयोग करें। हम परिणाम आउटपुट फ़ाइल पथ को एक सरल विकल्प के रूप में भी उपयोग कर सकते हैं। पृष्ठ आकार, मार्जिन, CSS आदि जैसे वांछित पैरामीटरों के साथ एक नया XpsSaveOptions ऑब्जेक्ट बनाएं। XpsSaveOptions क्लास का डिफ़ॉल्ट इंस्टेंस उपयोग करना संभव है। स्थैतिक Converter क्लास के ConvertEPUB() मेथड का उपयोग करके EPUB को XPS फ़ाइल के रूप में सहेजें। रूपांतरण प्रक्रिया शुरू करने के लिए आपको EPUB स्रोत डेटा, [`XpsSaveOptions`](../../../com.aspose.html.saving/xpssaveoptions/), और आउटपुट डेटा बफ़र को किसी भी रूप में पास करना होगा। Online EPUB to XPS converter
...
URL द्वारा प्रस्तुत epub स्रोत को पूर्ण पथ द्वारा परिभाषित XPS फ़ाइल में बदलें। देखें [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-xps/).
...
इनपुट [Stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream?view=net-5.0) द्वारा प्रस्तुत epub स्रोत को XPS में बदलें। परिणाम पूर्ण पथ द्वारा परिभाषित XPS फ़ाइल है।
...
एक मौजूदा EPUB फ़ाइल खोलें। उदाहरण के लिए, हम स्रोत फ़ाइल पथ को ConvertEPUB मेथड के पहले पैरामीटर के रूप में परिभाषित कर सकते हैं। आउटपुट डेटा बफ़र के रूप में ज्ञात या कस्टम ICreateStreamProvider इंटरफ़ेस कार्यान्वयन का उपयोग करें। हम परिणाम आउटपुट फ़ाइल पथ के रूप में अधिक सरल विकल्प का उपयोग कर सकते हैं। पृष्ठ आकार, मार्जिन, CSS आदि जैसे वांछित पैरामीटरों की संख्या के साथ एक नया XpsSaveOptions ऑब्जेक्ट बनाएं। XpsSaveOptions क्लास का डिफ़ॉल्ट इंस्टेंस उपयोग करना संभव है। स्थैतिक Converter क्लास की ConvertEPUB() मेथड का उपयोग करके EPUB को xps फ़ाइल के रूप में सहेजें। आपको परिवर्तन प्रक्रिया शुरू करने के लिए EPUB स्रोत डेटा, XpsSaveOptions, और आउटपुट डेटा बफ़र को किसी भी रूप में पास करना होगा। आप उस [`configuration`](../../../com.aspose.html/configuration/) संदर्भ वस्तु का उपयोग कर सकते हैं जो एप्लिकेशन के पर्यावरण सेटिंग्स को सेट करने के लिए उपयोग होती है। ऑनलाइन EPUB से XPS रूपांतरणकर्ता
...
| sourcePath | String | EPUB स्रोत फ़ाइल पथ। इसे वर्तमान डायरेक्टरी पथ के साथ मिलाकर एक पूर्ण URL बनाया जाएगा। |
| configuration | Configuration | पर्यावरण कॉन्फ़िगरेशन। यह [configuration](https://apireference.aspose.com/html/net/aspose.html/configuration) कॉन्टेक्स्ट ऑब्जेक्ट का प्रतिनिधित्व करता है जिसका उपयोग एप्लिकेशन के लिए पर्यावरण सेटिंग्स को सेट अप करने में किया जाता है। |
| options | XpsSaveOptions | रूपांतरण विकल्प। [XpsSaveOptions ](https://apireference.aspose.com/html/net/aspose.html.saving/xpssaveoptions)ऑब्जेक्ट का उपयोग आपको रेंडरिंग प्रक्रिया को ट्यून करने की अनुमति देता है; आप पृष्ठ आकार, मार्जिन, CSS आदि निर्दिष्ट कर सकते हैं। |
| outputPath | String | आउटपुट रूपांतरण परिणाम के रूप में पूर्ण .xps फ़ाइल पथ। |
...
// डिफ़ॉल्ट कॉन्फ़िगरेशन के साथ रूपांतरण प्रक्रिया प्रारंभ करें 
Converter.ConvertEPUB(sourceUrl, new Configuration(), options, resultPath);
```
...
| स्ट्रीम | स्ट्रीम | इनपुट स्ट्रीम को रूपांतरण स्रोत के रूप में उपयोग करें। |
| options | XpsSaveOptions | रूपांतरण विकल्प। [`XpsSaveOptions `](../../../com.aspose.html.saving/xpssaveoptions/)ऑब्जेक्ट का उपयोग आपको रेंडरिंग प्रक्रिया को ट्यून करने की अनुमति देता है; आप [`page size`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/), [`margins`](../../../com.aspose.html.drawing/page/margin/), [`CSS media-type`](../../../com.aspose.html.rendering/mediatype/) आदि निर्दिष्ट कर सकते हैं। |
| provider | ICreateStreamProvider | इंटरफ़ेस का कार्यान्वयन, जिसका उपयोग आउटपुट स्ट्रीम प्राप्त करने के लिए किया जाएगा। [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-xps/#output-stream-providers) में ICreateStreamProvider कार्यान्वयन का नमूना देखें। |
...
...
 ...
 // परिणाम डेटा को सम्मिलित करने वाले मेमोरी स्ट्रीम तक पहुंच प्राप्त करें
 var memory = streamProvider.Streams.First();
 memory.Seek(0, SeekOrigin.Begin);

 // परिणाम डेटा को आउटपुट फ़ाइल में फ़्लश करें
...
| sourcePath | String | EPUB स्रोत फ़ाइल पथ। इसे वर्तमान डायरेक्टरी पथ के साथ मिलाकर एक पूर्ण URL बनाया जाएगा। |
| options | XpsSaveOptions | रूपांतरण विकल्प। [XpsSaveOptions ](https://apireference.aspose.com/html/net/aspose.html.saving/xpssaveoptions)ऑब्जेक्ट का उपयोग आपको रेंडरिंग प्रक्रिया को ट्यून करने की अनुमति देता है; आप पृष्ठ आकार, मार्जिन, CSS आदि निर्दिष्ट कर सकते हैं। |
| provider | ICreateStreamProvider | इंटरफ़ेस का कार्यान्वयन, जिसका उपयोग आउटपुट स्ट्रीम प्राप्त करने के लिए किया जाएगा। [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-xps/#output-stream-providers) में उन्नत नमूना देखें। |
...
| --- | --- | --- |
| sourceUrl | Url | EPUB स्रोत URL - एक सार्वभौमिक पहचानकर्ता (URL) का ऑब्जेक्ट प्रतिनिधित्व प्रदान करता है। |
| options | XpsSaveOptions | रूपांतरण विकल्प। [`XpsSaveOptions `](../../../com.aspose.html.saving/xpssaveoptions/)ऑब्जेक्ट का उपयोग आपको रेंडरिंग प्रक्रिया को ट्यून करने की अनुमति देता है; आप पृष्ठ आकार, मार्जिन, CSS आदि निर्दिष्ट कर सकते हैं। देखें [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-xps/#save-options)। |
| provider | ICreateStreamProvider | [`interface`](../../../com.aspose.html.io/icreatestreamprovider/) का कार्यान्वयन, जिसका उपयोग आउटपुट स्ट्रीम प्राप्त करने के लिए किया जाएगा। [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-xps/#output-stream-providers) में उन्नत नमूना देखें। |
...
एक मौजूदा EPUB फ़ाइल खोलें। उदाहरण के लिए, हम स्रोत फ़ाइल पथ को ConvertEPUB मेथड के पहले पैरामीटर के रूप में परिभाषित कर सकते हैं। आउटपुट डेटा बफ़र के रूप में ज्ञात या कस्टम [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) इंटरफ़ेस कार्यान्वयन का उपयोग करें। हम परिणाम आउटपुट फ़ाइल पथ के रूप में अधिक सरल विकल्प का उपयोग कर सकते हैं। पृष्ठ आकार, मार्जिन, CSS आदि जैसे वांछित पैरामीटरों की संख्या के साथ एक नया XpsSaveOptions ऑब्जेक्ट बनाएं। XpsSaveOptions क्लास का डिफ़ॉल्ट इंस्टेंस उपयोग करना संभव है। स्थैतिक Converter क्लास की ConvertEPUB() मेथड का उपयोग करके EPUB को xps फ़ाइल के रूप में सहेजें। आपको परिवर्तन प्रक्रिया शुरू करने के लिए EPUB स्रोत डेटा, XpsSaveOptions, और आउटपुट डेटा बफ़र को किसी भी रूप में पास करना होगा। ऑनलाइन EPUB से XPS रूपांतरणकर्ता
...
| Parameter | Type | विवरण |
| --- | --- | --- |
| stream | Stream | इनपुट [Stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream?view=net-5.0) द्वारा प्रस्तुत रूपांतरण स्रोत। |
| options | DocSaveOptions | रूपांतरण विकल्प। [`DocSaveOptions `](../../../com.aspose.html.saving/docsaveoptions/) ऑब्जेक्ट का उपयोग रेंडरिंग प्रक्रिया को अनुकूलित करने में सक्षम बनाता है; आप [`पृष्ठ आकार`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/), [`मार्जिन`](../../../com.aspose.html.drawing/page/margin/), [`CSS मीडिया-टाइप`](../../../com.aspose.html.rendering/mediatype/), आदि निर्दिष्ट कर सकते हैं। देखें [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-docx/#save-options). |
| outputPath | String | आउटपुट रूपांतरण परिणाम के रूप में पूर्ण .docx फ़ाइल पथ। |

## टिप्पणियाँ

EPUB को DOCX में कैसे परिवर्तित करें

DOCX माइक्रोसॉफ्ट वर्ड दस्तावेज़ों के लिए एक प्रसिद्ध फ़ॉर्मेट है। यह फ़ॉर्मेट लोकप्रिय है क्योंकि यह विभिन्न फ़ॉर्मेटिंग सुविधाओं का समर्थन करता है और उपयोगकर्ताओं को किसी भी प्रकार के दस्तावेज़ को लिखने के लिए कई विकल्प प्रदान करता है। DOCX फ़ाइलें वर्ड 2007 और बाद के संस्करणों के साथ खुल सकती हैं, लेकिन पुराने MS Word संस्करणों के साथ नहीं, जो DOC फ़ाइल एक्सटेंशन को समर्थन देते हैं। EPUB से DOCX रूपांतरण अक्सर DOCX फ़ॉर्मेट का उपयोग विशेष उपयोगकर्ता कार्यों के लिए करने के लिए आवश्यक होता है।

Aspose.HTML की मुख्य विशेषता रूपांतरण सुविधा है। EPUB एक ओपन XML-आधारित फ़ॉर्मेट है डिजिटल पुस्तकों और प्रकाशनों के लिए, जिसे स्मार्टफ़ोन, टैबलेट और कंप्यूटर पर देखा और पढ़ा जा सकता है। com.aspose.html.converters पैकेज रूपांतरण मेथड्स तक आसान पहुँच प्रदान करता है। यह लोकप्रिय फ़ॉर्मेट्स जैसे [PDF](https://docs.fileformat.com/pdf/), [XPS](https://docs.fileformat.com/page-description-language/xps/), [DOCX](https://docs.fileformat.com/word-processing/docx/), [JPEG](https://docs.fileformat.com/image/jpeg/), [PNG](https://docs.fileformat.com/image/png/), [BMP](https://docs.fileformat.com/image/bmp/), [TIFF](https://docs.fileformat.com/image/tiff/), और [GIF](https://docs.fileformat.com/image/gif/) में व्यापक [EPUB](https://docs.fileformat.com/ebook/epub/) रूपांतरण उपलब्ध कराता है।

यह अनुभाग समर्थित EPUB रूपांतरण परिदृश्यों की सूची और उन्हें कैसे निष्पादित किया जाए, इस बारे में जानकारी प्रदान करता है, जिसमें एक [`Converter`](../) क्लास का उपयोग किया जाता है जो सभी लो-लेवल रूपांतरण ऑपरेशनों को एक ही क्लास में समूहित करता है ताकि वे आरामदायक और उपयोग में आसान हों। EPUB Converter DOCX विशिष्ट गाइड में, आप निम्नलिखित लेख पाएंगे:
...
EPUB को DOCX में परिवर्तित करें

EPUB को DOCX फ़ाइल फ़ॉर्मेट में परिवर्तित करने के लिए, आपको कुछ चरणों का पालन करना चाहिए:

एक मौजूदा EPUB फ़ाइल खोलें। उदाहरण के लिए, हम ConvertEPUB मेथड के पहले पैरामीटर के रूप में स्रोत फ़ाइल पथ को परिभाषित कर सकते हैं। आउटपुट डेटा बफ़र के रूप में ज्ञात या कस्टम **ICreateStreamProvider** इंटरफ़ेस कार्यान्वयन का उपयोग करें। हम परिणाम आउटपुट फ़ाइल पथ को एक सरल विकल्प के रूप में भी उपयोग कर सकते हैं। पृष्ठ आकार, मार्जिन, CSS आदि जैसे वांछित पैरामीटरों की संख्या के साथ एक नया **DocSaveOptions** ऑब्जेक्ट बनाएं। **DocSaveOptions** क्लास का डिफ़ॉल्ट इंस्टेंस उपयोग करना संभव है। स्थिर **Converter** क्लास की ConvertEPUB() मेथड का उपयोग करके EPUB को DOCX फ़ाइल के रूप में सहेजें। आपको EPUB स्रोत डेटा को फ़ाइल पथ या इनपुट स्ट्रीम के रूप में, साथ ही URL, **DocSaveOptions** इंस्टेंस, और आउटपुट डेटा बफ़र को किसी भी रूप में पास करना होगा ताकि रूपांतरण प्रक्रिया शुरू की जा सके। आप उस **[`configuration`](../../../com.aspose.html/configuration/)** संदर्भ ऑब्जेक्ट का उपयोग कर सकते हैं जो एप्लिकेशन के पर्यावरण सेटिंग्स को सेट करने के लिए उपयोग होता है। ऑनलाइन EPUB से DOCX रूपांतरणकर्ता

Aspose.HTML एक मुफ्त ऑनलाइन [EPUB to DOC](https://products.aspose.app/html/en/conversion/epub-to-docx)[X](https://products.aspose.app/html/en/conversion/epub-to-xps) कनवर्टर प्रदान करता है जो EPUB को उच्च गुणवत्ता, आसान और तेज़ी से DOCX फ़ाइल में परिवर्तित करता है। बस फ़ाइलें अपलोड करें, उन्हें परिवर्तित करें और कुछ सेकंड में परिणाम प्राप्त करें!
...
पूर्ण फ़ाइल पथ द्वारा प्रस्तुत EPUB स्रोत को DOCX में बदलें। परिणाम आउटपुट फ़ाइल पथ द्वारा निर्मित DOCX फ़ाइल है।
...
URL द्वारा प्रस्तुत EPUB स्रोत को बदलें। परिणाम आउटपुट फ़ाइल पथ द्वारा निर्मित DOCX फ़ाइल है।
...
| --- | --- | --- |
| sourceUrl | Url | EPUB स्रोत URL - एक सार्वभौमिक पहचानकर्ता (URL) का ऑब्जेक्ट प्रतिनिधित्व प्रदान करता है। |
| options | DocSaveOptions | [`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/) का उपयोग रेंडरिंग प्रक्रिया को अनुकूलित करने में सक्षम बनाता है; आप [`पृष्ठ आकार`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/), [`मार्जिन`](../../../com.aspose.html.drawing/page/margin/), [`रिज़ॉल्यूशन`](../../../com.aspose.html.rendering.image/imagerenderingoptions/), [`CSS मीडिया-टाइप`](../../../com.aspose.html.rendering/mediatype/), आदि निर्दिष्ट कर सकते हैं। देखें [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-docx/#save-options). |
| outputPath | String | आउटपुट रूपांतरण परिणाम के रूप में पूर्ण .docx फ़ाइल पथ। |
...
डेटा इनपुट स्ट्रीम द्वारा प्रस्तुत EPUB स्रोत को बदलें। परिणाम आउटपुट फ़ाइल पथ द्वारा निर्मित DOCX फ़ाइल है।
...
| sourcePath | String | EPUB स्रोत फ़ाइल पथ। इसे वर्तमान डायरेक्टरी पथ के साथ मिलाकर एक पूर्ण URL बनाया जाएगा। |
| configuration | Configuration | पर्यावरण कॉन्फ़िगरेशन। यह [`configuration`](../../../com.aspose.html/configuration/) कॉन्टेक्स्ट ऑब्जेक्ट को दर्शाता है जिसका उपयोग एप्लिकेशन के लिए पर्यावरण सेटिंग्स को सेट करने में किया जाता है। |
| options | DocSaveOptions | रूपांतरण विकल्प। [DocSaveOptions ](https://apireference.aspose.com/html/net/aspose.html.saving/docsaveoptions) ऑब्जेक्ट का उपयोग रेंडरिंग प्रक्रिया को अनुकूलित करने में सक्षम बनाता है; आप पृष्ठ आकार, मार्जिन, CSS आदि निर्दिष्ट कर सकते हैं। देखें [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-docx/#save-options). |
| outputPath | String | आउटपुट रूपांतरण परिणाम के रूप में पूर्ण .docx फ़ाइल पथ। |
...
| स्ट्रीम | स्ट्रीम | इनपुट स्ट्रीम को रूपांतरण स्रोत के रूप में उपयोग करें। |
| options | DocSaveOptions | रूपांतरण विकल्प। [`DocSaveOptions `](../../../com.aspose.html.saving/docsaveoptions/) ऑब्जेक्ट का उपयोग रेंडरिंग प्रक्रिया को अनुकूलित करने में सक्षम बनाता है; आप [`पृष्ठ आकार`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/), [`मार्जिन`](../../../com.aspose.html.drawing/page/margin/), [`CSS मीडिया-टाइप`](../../../com.aspose.html.rendering/mediatype/), आदि निर्दिष्ट कर सकते हैं। देखें [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-docx/#save-options). |
| provider | ICreateStreamProvider | `[`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/)` इंटरफ़ेस का कार्यान्वयन, जिसका उपयोग आउटपुट स्ट्रीम प्राप्त करने के लिए किया जाएगा। देखें उन्नत नमूना [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-docx/#output-stream-providers). |
...
पूर्ण फ़ाइल पथ द्वारा प्रस्तुत EPUB स्रोत को DOCX में परिवर्तित करें। परिणाम आउटपुट डेटा है जो [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) कार्यान्वयन द्वारा निर्मित है।
...
URL द्वारा प्रस्तुत EPUB स्रोत को बदलें। परिणाम आउटपुट डेटा है जो ICreateStreamProvider इंटरफ़ेस कार्यान्वयन द्वारा निर्मित होता है।
...
| --- | --- | --- |
| sourceUrl | Url | EPUB स्रोत URL - एक सार्वभौमिक पहचानकर्ता (URL) का ऑब्जेक्ट प्रतिनिधित्व प्रदान करता है। |
| options | DocSaveOptions | [`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/) का उपयोग रेंडरिंग प्रक्रिया को अनुकूलित करने में सक्षम बनाता है; आप पृष्ठ आकार, मार्जिन, रिज़ॉल्यूशन, CSS आदि निर्दिष्ट कर सकते हैं। देखें [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-docx/#save-options). |
| provider | ICreateStreamProvider | `[`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/)` इंटरफ़ेस का कार्यान्वयन, जिसका उपयोग आउटपुट स्ट्रीम प्राप्त करने के लिए किया जाएगा। देखें उन्नत नमूना [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-docx/#output-stream-providers). |
...
डेटा इनपुट स्ट्रीम द्वारा प्रस्तुत EPUB स्रोत को बदलें। परिणाम आउटपुट डेटा है जो ICreateStreamProvider इंटरफ़ेस कार्यान्वयन द्वारा निर्मित होता है।
...
एक मौजूदा EPUB फ़ाइल खोलें। उदाहरण के लिए, हम ConvertEPUB मेथड के पहले पैरामीटर के रूप में स्रोत फ़ाइल पथ को परिभाषित कर सकते हैं। आउटपुट डेटा बफ़र के रूप में ज्ञात या कस्टम **ICreateStreamProvider** इंटरफ़ेस कार्यान्वयन का उपयोग करें। हम परिणाम आउटपुट फ़ाइल पथ को एक सरल विकल्प के रूप में भी उपयोग कर सकते हैं। पृष्ठ आकार, मार्जिन, CSS आदि जैसे वांछित पैरामीटरों की संख्या के साथ एक नया [`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/) ऑब्जेक्ट बनाएं। **DocSaveOptions** क्लास का डिफ़ॉल्ट इंस्टेंस उपयोग करना संभव है। स्थिर **Converter** क्लास की ConvertEPUB() मेथड का उपयोग करके EPUB को DOCX फ़ाइल के रूप में सहेजें। आपको EPUB स्रोत डेटा को फ़ाइल पथ या इनपुट स्ट्रीम के रूप में, साथ ही URL, **DocSaveOptions** इंस्टेंस, और आउटपुट डेटा बफ़र को किसी भी रूप में पास करना होगा ताकि रूपांतरण प्रक्रिया शुरू की जा सके। आप उस **[`configuration`](../../../com.aspose.html/configuration/)** संदर्भ ऑब्जेक्ट का उपयोग कर सकते हैं जो एप्लिकेशन के पर्यावरण सेटिंग्स को सेट करने के लिए उपयोग होता है। ऑनलाइन EPUB से DOCX रूपांतरणकर्ता
...
पूर्ण फ़ाइल पथ द्वारा प्रस्तुत EPUB स्रोत को DOCX में परिवर्तित करें। परिणाम आउटपुट डेटा है जो [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) इंटरफ़ेस कार्यान्वयन द्वारा निर्मित है।
...
URL द्वारा प्रस्तुत EPUB स्रोत को परिवर्तित करें। परिणाम आउटपुट डेटा है जो [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) इंटरफ़ेस कार्यान्वयन द्वारा निर्मित है।
...
| options | PdfSaveOptions | रूपांतरण विकल्प। [`PdfSaveOption`](../../../com.aspose.html.saving/pdfsaveoptions/) ऑब्जेक्ट का उपयोग रेंडरिंग प्रक्रिया को अनुकूलित करने में सक्षम बनाता है; आप [`पृष्ठ आकार`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/), [`मार्जिन`](../../../com.aspose.html.drawing/page/margin/), [`CSS मीडिया-टाइप`](../../../com.aspose.html.rendering/mediatype/), आदि निर्दिष्ट कर सकते हैं। देखें [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-pdf/#save-options). |
| outputPath | String | आउटपुट रूपांतरण परिणाम के रूप में पूर्ण .pdf फ़ाइल पथ। |

## टिप्पणियाँ

EPUB को PDF में कैसे परिवर्तित करें

EPUB एक ई-बुक फ़ाइल फ़ॉर्मेट है जो एक मानक डिजिटल प्रकाशन फ़ॉर्मेट प्रदान करता है। यह अंतर्राष्ट्रीय डिजिटल पब्लिशिंग फोरम ([IDPF](http://idpf.org/)) द्वारा बनाया गया है, और अब यह कई ई-रीडर्स और सॉफ़्टवेयर एप्लिकेशनों द्वारा समर्थित है। EPUB से PDF रूपांतरण अक्सर PDF फ़ॉर्मेट का लाभ उठाने के लिए आवश्यक होता है। PDF फ़ाइल फ़ॉर्मेट में टेक्स्ट, इमेज, हाइपरलिंक, फ़ॉर्म-फ़ील्ड, रिच मीडिया, मेटाडेटा आदि जैसी जानकारी रखने की पूरी क्षमता है। PDF फ़ाइलें Adobe Acrobat Reader/Writer और अधिकांश आधुनिक ब्राउज़रों जैसे Chrome, Safari, Firefox में खोली जा सकती हैं। वे प्रिंटिंग के लिए अनुकूलित हैं, और आपके दस्तावेज़ों की भौतिक प्रतियां बनाने के लिए आदर्श हैं; आप PDF के लिए सुरक्षा सेटिंग्स भी कॉन्फ़िगर कर सकते हैं।
...
EPUB को PDF फ़ाइल प्रारूप में बदलने के लिए, आपको कुछ चरणों का पालन करना चाहिए:

एक मौजूदा EPUB फ़ाइल खोलें। उदाहरण के लिए, हम ConvertEPUB मेथड के पहले पैरामीटर के रूप में स्रोत फ़ाइल पथ को परिभाषित कर सकते हैं। वैकल्पिक रूप से हम इनपुट स्ट्रीम या Url ऑब्जेक्ट इंस्टेंस का उपयोग कर सकते हैं। आउटपुट डेटा बफ़र के रूप में ज्ञात या कस्टम ICreateStreamProvider इंटरफ़ेस इम्प्लीमेंटेशन का उपयोग करें। हम परिणाम आउटपुट फ़ाइल पथ को भी एक सरल विकल्प के रूप में उपयोग कर सकते हैं। एक नया PdfSaveOptions ऑब्जेक्ट बनाएं जिसमें पृष्ठ आकार, मार्जिन, CSS आदि जैसे वांछित पैरामीटर हों। PdfSaveOptions क्लास का डिफ़ॉल्ट इंस्टेंस उपयोग करना संभव है। स्थिर Converter क्लास की ConvertEPUB() मेथड का उपयोग करके EPUB को PDF फ़ाइल के रूप में सहेजें। आपको EPUB स्रोत डेटा को फ़ाइल पथ या इनपुट स्ट्रीम के साथ-साथ Url, PdfSaveOptions इंस्टेंस, और आउटपुट डेटा बफ़र किसी भी रूप में पास करना होगा ताकि रूपांतरण प्रक्रिया शुरू की जा सके। आप कॉन्फ़िगरेशन का उपयोग कर सकते हैं जो [`configuration`](../../../com.aspose.html/configuration/) संदर्भ ऑब्जेक्ट का प्रतिनिधित्व करता है और एप्लिकेशन के पर्यावरण सेटिंग्स को सेट करने के लिए उपयोग किया जाता है। ऑनलाइन EPUB से PDF रूपांतरणकर्ता

Aspose.HTML एक मुफ्त ऑनलाइन [EPUB to PDF](https://products.aspose.app/html/en/conversion/epub-to-pdf) कनवर्टर प्रदान करता है जो उच्च गुणवत्ता, आसान और तेज़ी से EPUB को PDF फ़ाइल में बदलता है। बस फ़ाइलें अपलोड करें, उन्हें बदलें और कुछ सेकंड में परिणाम प्राप्त करें!
...
पूर्ण फ़ाइल पथ द्वारा प्रस्तुत EPUB स्रोत को PDF में बदलें। परिणाम आउटपुट फ़ाइल पथ द्वारा निर्मित PDF फ़ाइल है।
...
एक मौजूदा EPUB फ़ाइल खोलें। उदाहरण के लिए, हम ConvertEPUB मेथड के पहले पैरामीटर के रूप में स्रोत फ़ाइल पथ को परिभाषित कर सकते हैं। वैकल्पिक रूप से हम इनपुट स्ट्रीम या Url ऑब्जेक्ट इंस्टेंस का उपयोग कर सकते हैं। आउटपुट डेटा बफ़र के रूप में ज्ञात या कस्टम ICreateStreamProvider इंटरफ़ेस इम्प्लीमेंटेशन का उपयोग करें। हम परिणाम आउटपुट फ़ाइल पथ को भी एक सरल विकल्प के रूप में उपयोग कर सकते हैं। एक नया [`PdfSaveOptions`](../../../com.aspose.html.saving/pdfsaveoptions/) ऑब्जेक्ट बनाएं जिसमें पृष्ठ आकार, मार्जिन, CSS आदि जैसे वांछित पैरामीटर हों। PdfSaveOptions क्लास का डिफ़ॉल्ट इंस्टेंस उपयोग करना संभव है। स्थिर Converter क्लास की ConvertEPUB() मेथड का उपयोग करके EPUB को PDF फ़ाइल के रूप में सहेजें। आपको EPUB स्रोत डेटा को फ़ाइल पथ या इनपुट स्ट्रीम के साथ-साथ Url, PdfSaveOptions इंस्टेंस, और आउटपुट डेटा बफ़र किसी भी रूप में पास करना होगा ताकि रूपांतरण प्रक्रिया शुरू की जा सके। आप कॉन्फ़िगरेशन का उपयोग कर सकते हैं जो [`configuration`](../../../com.aspose.html/configuration/) संदर्भ ऑब्जेक्ट का प्रतिनिधित्व करता है और एप्लिकेशन के पर्यावरण सेटिंग्स को सेट करने के लिए उपयोग किया जाता है। ऑनलाइन EPUB से PDF रूपांतरणकर्ता
...
URL द्वारा प्रस्तुत EPUB स्रोत को बदलें। परिणाम आउटपुट फ़ाइल पथ द्वारा निर्मित PDF फ़ाइल है।
...
| --- | --- | --- |
| sourceUrl | Url | EPUB स्रोत URL - एक सार्वभौमिक पहचानकर्ता (URL) का ऑब्जेक्ट प्रतिनिधित्व प्रदान करता है। |
| options | PdfSaveOptions | [`PdfSaveOptions`](../../../com.aspose.html.saving/pdfsaveoptions/) उपयोग आपको रेंडरिंग प्रक्रिया को ट्यून करने की सुविधा देता है; आप [`page size`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/), [`margins`](../../../com.aspose.html.drawing/page/margin/), [`file permissions`](../../../com.aspose.html.rendering.pdf.encryption/pdfencryptioninfo/), [`CSS media-type`](../../../com.aspose.html.rendering/mediatype/) आदि निर्दिष्ट कर सकते हैं। देखें [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-pdf/#save-options)। |
| outputPath | String | आउटपुट रूपांतरण परिणाम के रूप में पूर्ण .pdf फ़ाइल पथ। |
...
पूर्ण फ़ाइल पथ द्वारा प्रस्तुत EPUB स्रोत को PDF में बदलें। परिणाम आउटपुट डेटा है जो [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) इंटरफ़ेस इम्प्लीमेंटेशन द्वारा निर्मित होता है।
...
| sourceUrl | Url | EPUB स्रोत URL - एक सार्वभौमिक पहचानकर्ता (URL) का ऑब्जेक्ट प्रतिनिधित्व प्रदान करता है। |
| options | PdfSaveOptions | [`PdfSaveOptions`](../../../com.aspose.html.saving/pdfsaveoptions/) उपयोग आपको रेंडरिंग प्रक्रिया को ट्यून करने की सुविधा देता है; आप [`page size`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/), [`margins`](../../../com.aspose.html.drawing/page/margin/), [`file permissions`](../../../com.aspose.html.rendering.pdf.encryption/pdfencryptioninfo/), [`CSS media-type`](../../../com.aspose.html.rendering/mediatype/) आदि निर्दिष्ट कर सकते हैं। देखें [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-pdf/#save-options)। |
| provider | ICreateStreamProvider | Implementation of [ICreateStreamProvider](https://apireference.aspose.com/svg/net/aspose.svg.io/icreatestreamprovider) इंटरफ़ेस, जिसका उपयोग आउटपुट स्ट्रीम प्राप्त करने के लिए किया जाएगा। उन्नत उदाहरण देखें [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-pdf/#output-stream-providers)। |
...
पूर्ण फ़ाइल पथ द्वारा प्रस्तुत EPUB स्रोत को PDF में बदलें। परिणाम आउटपुट डेटा है जो ICreateStreamProvider इंटरफ़ेस कार्यान्वयन द्वारा निर्मित होता है।
...
| sourcePath | String | EPUB स्रोत फ़ाइल पथ। इसे वर्तमान डायरेक्टरी पथ के साथ मिलाकर एक पूर्ण URL बनाया जाएगा। |
| configuration | Configuration | पर्यावरण कॉन्फ़िगरेशन। यह [configuration](https://apireference.aspose.com/html/net/aspose.html/configuration) कॉन्टेक्स्ट ऑब्जेक्ट का प्रतिनिधित्व करता है जिसका उपयोग एप्लिकेशन के लिए पर्यावरण सेटिंग्स को सेट अप करने में किया जाता है। |
| options | PdfSaveOptions | रूपांतरण विकल्प। [PdfSaveOption](https://apireference.aspose.com/html/net/aspose.html.saving/pdfsaveoptions) ऑब्जेक्ट का उपयोग आपको रेंडरिंग प्रक्रिया को ट्यून करने की अनुमति देता है; आप पृष्ठ आकार, मार्जिन, CSS आदि निर्दिष्ट कर सकते हैं। देखें [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-pdf/#save-options)। |
| provider | ICreateStreamProvider | Implementation of [ICreateStreamProvider](https://apireference.aspose.com/svg/net/aspose.svg.io/icreatestreamprovider) इंटरफ़ेस, जिसका उपयोग आउटपुट स्ट्रीम प्राप्त करने के लिए किया जाएगा। उन्नत उदाहरण देखें [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-pdf/#output-stream-providers)। |
