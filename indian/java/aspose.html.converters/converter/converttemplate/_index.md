...
| डेटा | TemplateData | टेम्पलेट मर्जिंग के लिए डेटा - प्रतिस्थापन (XML, JSON)। |
| options | TemplateLoadOptions | [`TemplateLoadOptions`](../../../com.aspose.html.loading/templateloadoptions/) ऑब्जेक्ट इंस्टेंस। यह निर्धारित करने के लिए उपयोग किया जाता है कि टेम्पलेट और डेटा आइटम नाम केस की परवाह किए बिना मेल खाते हैं या नहीं (विकल्प)। |
...
टेम्पलेट मर्जिंग का विचार यह है कि एक HTML टेम्पलेट के आधार पर HTML दस्तावेज़ बनाया जाए और उसे डेटा स्रोत से भर दिया जाए। Aspose.HTML टेम्पलेट्स और विभिन्न डेटा स्रोत प्रकारों, जैसे XML और JSON, के साथ काम करने के लिए इनलाइन एक्सप्रेशन सिंटैक्स प्रदान करता है। अधिक जानकारी के लिए [article](https://docs.aspose.com/html/net/converting-between-formats/html-template/) देखें जहाँ आप टेम्पलेट मर्जिंग और ConvertTemplate() मेथड के उपयोग के बारे में अधिक जानकारी पा सकते हैं।
...
टेम्पलेट स्रोत। फ़ाइल, [`URL`](../../../com.aspose.html/url/), [`HTMLDocument`](../../../com.aspose.html/htmldocument/) ऑब्जेक्ट इंस्टेंस या यहाँ तक कि इनलाइन कंटेंट द्वारा HTML टेम्पलेट स्रोत को परिभाषित करें। रूपांतरण परिणाम। आप सीधे परिणामस्वरूप HTMLDocument प्राप्त कर सकते हैं या मेथड सिग्नेचर के आधार पर परिणाम आउटपुट फ़ाइल पथ को परिभाषित कर सकते हैं। [`TemplateLoadOptions`](../../../com.aspose.html.loading/templateloadoptions/) का इंस्टेंस बनाएं। टेम्पलेट को डेटा के साथ मर्ज करने के लिए Converter क्लास की ConvertTemplate() मेथड का उपयोग करें। आप विकल्प पैरामीटर के रूप में [`configuration`](../../../com.aspose.html/configuration/) भी जोड़ सकते हैं। स्रोत कोड
...
...
      // फ़ॉर्म स्केलेटन HTML स्रोत फ़ाइल पथ
      var sourcePath = Path.Combine(InputFolder, "source.html");

      // फ़ॉर्म XML (JSON) टेम्पलेट डेटा फ़ाइल पथ
...
[`URL`](../../../com.aspose.html/url/) द्वारा प्रस्तुत टेम्पलेट HTML स्रोत को टेम्पलेट डेटा (XML, JSON) के साथ मर्ज करें। परिणाम आउटपुट फ़ाइल पथ द्वारा निर्मित HTML फ़ाइल है।
...
| पैरामीटर | टाइप | विवरण |
| --- | --- | --- |
| url | Url | [`URL`](../../../com.aspose.html/url/) द्वारा प्रस्तुत HTML स्रोत स्केलेटन को मर्ज किया जा रहा है। |
| डेटा | TemplateData | टेम्पलेट मर्जिंग के लिए डेटा - प्रतिस्थापन (XML, JSON)। |
| options | TemplateLoadOptions | [`TemplateLoadOptions`](../../../com.aspose.html.loading/templateloadoptions/) ऑब्जेक्ट इंस्टेंस। यह निर्धारित करने के लिए उपयोग किया जाता है कि टेम्पलेट और डेटा आइटम नाम केस की परवाह किए बिना मेल खाते हैं या नहीं (विकल्प)। |
| outputPath | String | आउटपुट रूपांतरण परिणाम के रूप में पूर्ण HTML फ़ाइल पथ। |
...
import com.aspose.html.converters;  
...
      // फ़ॉर्म स्केलेटन HTML स्रोत URL
...
| पैरामीटर | टाइप | विवरण |
| --- | --- | --- |
| sourcePath | String | पूर्ण फ़ाइल पथ द्वारा प्रस्तुत HTML स्रोत स्केलेटन को मर्ज किया जा रहा है। |
| डेटा | TemplateData | टेम्पलेट मर्जिंग के लिए डेटा - प्रतिस्थापन (XML, JSON)। |
| options | TemplateLoadOptions | [`TemplateLoadOptions`](../../../com.aspose.html.loading/templateloadoptions/) ऑब्जेक्ट इंस्टेंस। यह निर्धारित करने के लिए उपयोग किया जाता है कि टेम्पलेट और डेटा आइटम नाम केस की परवाह किए बिना मेल खाते हैं या नहीं (विकल्प)। |
| outputPath | String | आउटपुट रूपांतरण परिणाम के रूप में पूर्ण HTML फ़ाइल पथ। |
...
| पैरामीटर | टाइप | विवरण |
| --- | --- | --- |
| सामग्री | String | इनलाइन स्ट्रिंग कंटेंट द्वारा प्रस्तुत HTML स्रोत स्केलेटन को मर्ज किया जा रहा है। |
| baseUrl | String | HTML टेम्पलेट का बेस URI। इसे वर्तमान डायरेक्टरी पथ के साथ मिलाकर एक पूर्ण URL बनाया जाएगा। |
| डेटा | TemplateData | टेम्पलेट मर्जिंग के लिए डेटा - प्रतिस्थापन (XML, JSON)। |
| options | TemplateLoadOptions | [`TemplateLoadOptions`](../../../com.aspose.html.loading/templateloadoptions/) ऑब्जेक्ट इंस्टेंस। यह निर्धारित करने के लिए उपयोग किया जाता है कि टेम्पलेट और डेटा आइटम नाम केस की परवाह किए बिना मेल खाते हैं या नहीं (विकल्प)। |
| outputPath | String | आउटपुट रूपांतरण परिणाम के रूप में पूर्ण HTML फ़ाइल पथ। |
...
import com.aspose.html.converters;  
...
	  // फ़ॉर्म इनलाइन स्रोत कंटेंट को टेम्पलेट के रूप में
...
टेम्पलेट डेटा (XML, JSON) के साथ प्रस्तुत किए गए टेम्पलेट स्रोत को `[`HTMLDocument`](../../../com.aspose.html/htmldocument/)` के द्वारा मिलाएँ। परिणाम एक नया निर्मित HTMLDocument है जिसे फ़ाइल के रूप में सहेजा जा सकता है।
...
टेम्पलेट डेटा (XML, JSON) के साथ प्रस्तुत किए गए टेम्पलेट HTML स्रोत को `[`URL`](../../../com.aspose.html/url/)` के द्वारा मिलाएँ। परिणाम एक नया निर्मित `[`HTMLDocument`](../../../com.aspose.html/htmldocument/)` है जिसे फ़ाइल के रूप में सहेजा जा सकता है।
