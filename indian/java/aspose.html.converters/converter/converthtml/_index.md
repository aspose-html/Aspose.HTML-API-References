...
description: "Converter मेथड। HTMLDocument द्वारा प्रस्तुत HTML स्रोत को कनवर्ट करें। परिणाम आउटपुट फ़ाइल पाथ द्वारा निर्मित docx फ़ाइल है।"
type: docs

url: /hi/java/com.aspose.html.converters/converter/converthtml/
---
## ConvertHTML(HTMLDocument, DocSaveOptions, String) {#converthtml_1}

[`HTMLDocument`](../../../com.aspose.html/htmldocument/) द्वारा प्रस्तुत HTML स्रोत को कनवर्ट करें। परिणाम आउटपुट फ़ाइल पाथ द्वारा निर्मित docx फ़ाइल है।
...
| पैरामीटर | टाइप | विवरण |
| --- | --- | --- |
| document | HTMLDocument | [`HTMLDocument`](../../../com.aspose.html/htmldocument/) इंस्टेंस को रूपांतरण स्रोत के रूप में। |
| options | DocSaveOptions | [`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/) ऑब्जेक्ट का उपयोग रेंडरिंग प्रक्रिया को ट्यून करने में सक्षम बनाता है। अधिक जानकारी के लिए देखें [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/html-to-docx/#convert-html-to-docx-using-docsaveoptions)। |
| outputPath | String | आउटपुट रूपांतरण परिणाम के रूप में पूर्ण docx फ़ाइल पाथ। |

## Remarks

HTML को DOCX में कैसे कनवर्ट करें
...
Aspose.HTML की मुख्य विशेषता उसका रूपांतरण फ़ीचर है। विभिन्न कारणों से फ़ॉर्मेट्स के बीच रूपांतरण आवश्यक होता है: परिचित, सुविधाजनक फ़ॉर्मेट में काम करने के लिए या विशिष्ट कार्यों के लिए विभिन्न फ़ॉर्मेट्स का लाभ उठाने के लिए। com.aspose.html.converters पैकेज रूपांतरण मेथड्स तक आसान पहुँच प्रदान करता है। यह लोकप्रिय फ़ॉर्मेट्स जैसे कि [PDF](https://docs.fileformat.com/pdf/), [XPS](https://docs.fileformat.com/page-description-language/xps/), [DOCX](https://docs.fileformat.com/word-processing/docx/), [JPEG](https://docs.fileformat.com/image/jpeg/), [PNG](https://docs.fileformat.com/image/png/), [BMP](https://docs.fileformat.com/image/bmp/), [TIFF](https://docs.fileformat.com/image/tiff/), [GIF](https://docs.fileformat.com/image/gif/), [MHTML](https://docs.fileformat.com/web/mhtml/), और [MD](https://docs.fileformat.com/word-processing/md/) में HTML रूपांतरण की विस्तृत श्रृंखला प्रदान करता है।

यह लेख समर्थित HTML रूपांतरणों की सूची और उन्हें [`Converter`](../) क्लास का उपयोग करके कैसे निष्पादित करें, इस बारे में जानकारी देता है, जो सभी लो-लेवल रूपांतरण ऑपरेशन्स को एक ही क्लास में समूहित करता है ताकि वे आरामदायक और उपयोग में आसान हों। HTML Converter गाइड में, आप निम्नलिखित लेख पाएँगे:

DOCX रूपांतरण

DOCX फ़ाइल एक Microsoft Word दस्तावेज़ है जो सामान्यतः पाठ शामिल करता है, लेकिन तालिकाएँ, रास्टर और वेक्टर ग्राफ़िक्स, वीडियो, ध्वनियाँ और आरेख सहित विभिन्न प्रकार के डेटा भी रख सकता है। DOCX फ़ाइल अत्यधिक संपादन योग्य, उपयोग में आसान और आकार में प्रबंधनीय है। यह फ़ॉर्मेट लोकप्रिय है क्योंकि यह उपयोगकर्ताओं को किसी भी प्रकार के दस्तावेज़ लिखने के लिए विभिन्न विकल्प प्रदान करता है। यह फ़ाइल फ़ॉर्मेट सबसे अधिक उपयोग किए जाने वाले में से एक है और कई प्रोग्रामों के माध्यम से उपलब्ध है।
...
अन्य लोकप्रिय फ़ॉर्मेट रूपांतरण
...
रूपांतरण स्रोत। एक मौजूदा स्थानीय HTML फ़ाइल या रिमोट URL को रूपांतरण स्रोत के रूप में पहचानें। आप इनलाइन HTML सामग्री को रूपांतरण स्रोत के रूप में परिभाषित कर सकते हैं या किसी भी तरीके से HTML दस्तावेज़ ([`HTMLDocument`](../../../com.aspose.html/htmldocument/)) बना सकते हैं। रूपांतरण परिणाम। परिणाम आउटपुट फ़ाइल पथ निर्धारित करें या ज्ञात या कस्टम [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) इंटरफ़ेस कार्यान्वयन को आउटपुट डेटा बफ़र के रूप में उपयोग करें। कस्टम या डिफ़ॉल्ट सेटिंग्स के साथ नया [`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/) ऑब्जेक्ट बनाएं। आप विकल्प पैरामीटर के रूप में [`configuration`](../../../com.aspose.html/configuration/) भी जोड़ सकते हैं। कन्वर्टर क्लास की ConvertHTML() मेथड का उपयोग करके HTML को DOCX परिणाम के रूप में सहेजें, जिसमें उपयोगकर्ता परिदृश्य के अनुसार तीन या अधिक पैरामीटर हो सकते हैं। ऑनलाइन HTML कन्वर्टर

Aspose.HTML एक मुफ्त ऑनलाइन [HTML to DOCX Converter](https://products.aspose.app/html/en/conversion/html-to-docx) प्रदान करता है जो HTML को उच्च गुणवत्ता, आसान और तेज़ी से DOCX में परिवर्तित करता है। बस फ़ाइलें अपलोड करें, उन्हें परिवर्तित करें और कुछ सेकंड में परिणाम प्राप्त करें!

अन्य लोकप्रिय फ़ॉर्मेट रूपांतरणों का उपयोग करने का प्रयास करें
...
...
    ...
    // डिफ़ॉल्ट कॉन्फ़िगरेशन ऑब्जेक्ट को इंस्टैंशिएट करें
...
URL द्वारा प्रस्तुत HTML स्रोत को बदलें। परिणाम आउटपुट फ़ाइल पथ द्वारा निर्मित docx फ़ाइल है।
...
| पैरामीटर | टाइप | विवरण |
| --- | --- | --- |
| url | Url | HTML स्रोत दस्तावेज़ URL - एक सार्वभौमिक पहचानकर्ता (URL) का ऑब्जेक्ट प्रतिनिधित्व प्रदान करता है। |
| options | DocSaveOptions | [`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/) ऑब्जेक्ट का उपयोग रेंडरिंग प्रक्रिया को ट्यून करने में सक्षम बनाता है। अधिक जानकारी के लिए देखें [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/html-to-docx/#convert-html-to-docx-using-docsaveoptions)। |
| outputPath | String | आउटपुट रूपांतरण परिणाम के रूप में पूर्ण docx फ़ाइल पाथ। |
...
पूर्ण फ़ाइल पथ द्वारा प्रस्तुत HTML स्रोत को DOCX में बदलें। परिणाम आउटपुट फ़ाइल पथ द्वारा निर्मित docx फ़ाइल है।
...
| पैरामीटर | टाइप | विवरण |
| --- | --- | --- |
| sourcePath | String | HTML पूर्ण फ़ाइल स्रोत पथ। |
| options | DocSaveOptions | [`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/) ऑब्जेक्ट का उपयोग रेंडरिंग प्रक्रिया को ट्यून करने में सक्षम बनाता है। अधिक जानकारी के लिए देखें [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/html-to-docx/#convert-html-to-docx-using-docsaveoptions)। |
| outputPath | String | आउटपुट रूपांतरण परिणाम के रूप में पूर्ण docx फ़ाइल पाथ। |
...
इनलाइन सामग्री द्वारा प्रस्तुत HTML स्रोत को परिवर्तित करें। परिणाम आउटपुट फ़ाइल पथ द्वारा निर्मित docx फ़ाइल है।
...
| पैरामीटर | टाइप | विवरण |
| --- | --- | --- |
| सामग्री | String | स्ट्रिंग को इनलाइन HTML सामग्री के रूप में। |
...
[`HTMLDocument`](../../../com.aspose.html/htmldocument/) द्वारा प्रस्तुत HTML स्रोत को परिवर्तित करें। परिणाम आउटपुट डेटा है जो [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) इंटरफ़ेस कार्यान्वयन द्वारा बनाया गया है।
...
| पैरामीटर | टाइप | विवरण |
| --- | --- | --- |
| document | HTMLDocument | [`HTMLDocument`](../../../com.aspose.html/htmldocument/) द्वारा प्रस्तुत रूपांतरण स्रोत। |
| options | DocSaveOptions | [`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/) ऑब्जेक्ट का उपयोग रेंडरिंग प्रक्रिया को ट्यून करने में सक्षम बनाता है। अधिक जानकारी के लिए देखें [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/html-to-docx/#convert-html-to-docx-using-docsaveoptions)। |
...
import com.aspose.html.converters;  
... 
		// इनलाइन HTML सामग्री को परिभाषित करें
      	var content = @"<!DOCTYPE html><html><body><p>Hello, World!</p></body></html>";

      	// डिफ़ॉल्ट कॉन्फ़िगरेशन ऑब्जेक्ट को इंस्टैंशिएट करें
      	var configuration = new Configuration();

      	// कई तरीकों में से एक द्वारा HTML दस्तावेज़ बनाएं
      	using (var document = new HTMLDocument(content, String.Empty, configuration))
     	 {
        	// एक्सटेंशन के बिना परिणाम फ़ाइल पाथ को परिभाषित करें
...
URL द्वारा प्रस्तुत HTML स्रोत को परिवर्तित करें। परिणाम आउटपुट डेटा है जो [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) इंटरफ़ेस कार्यान्वयन द्वारा बनाया गया है।
...
... 	 
      ...
      // ज्ञात ICreateStreamProvider कार्यान्वयन का उपयोग करें
      ICreateStreamProvider provider = new FileCreateStreamProvider(resultPath);
...
पूर्ण फ़ाइल पाथ द्वारा प्रस्तुत HTML स्रोत को DOCX में परिवर्तित करें। परिणाम आउटपुट डेटा है जो [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) इंटरफ़ेस कार्यान्वयन द्वारा बनाया गया है।
...
import com.aspose.html.converters;  
... 
      // स्रोत HTML फ़ाइल पाथ बनाएं
      var sourcePath = Path.Combine(InputFolder, "source.html");

      // परिणाम फ़ाइल पाथ को परिभाषित करें
      var resultPath = Path.Combine(OutputFolder, "result");

      // डिफ़ॉल्ट ICreateStreamProvider कार्यान्वयन का उपयोग करें
      ICreateStreamProvider provider = new FileCreateStreamProvider(resultPath);
...
इनलाइन सामग्री द्वारा प्रस्तुत HTML स्रोत को DOCX में परिवर्तित करें। परिणाम आउटपुट डेटा है जो [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) इंटरफ़ेस कार्यान्वयन द्वारा बनाया गया है।
...
import com.aspose.html.converters;  
... 
	  // HTML इनलाइन सामग्री बनाएं
      var content = @"<!DOCTYPE html><html><body><p>Hello, World!</p></body></html>";

      // परिणाम फ़ाइल पाथ को परिभाषित करें
      var resultPath = Path.Combine(OutputFolder, "result");

      // ज्ञात स्थानीय फ़ाइल-उन्मुख ICreateStreamProvider कार्यान्वयन का उपयोग करें
      ICreateStreamProvider provider = new FileCreateStreamProvider(resultPath);

      // डिफ़ॉल्ट DocSaveOptions ऑब्जेक्ट को इंस्टैंसिएट करें
      var options = new DocSaveOptions();
...
[`HTMLDocument`](../../../com.aspose.html/htmldocument/) द्वारा प्रस्तुत HTML स्रोत को परिवर्तित करें। परिणाम आउटपुट फ़ाइल पाथ द्वारा निर्मित PDF फ़ाइल है।
...
पोर्टेबल डॉक्यूमेंट फॉर्मेट (PDF) एक प्रकार का दस्तावेज़ है जिसे Adobe ने 1990 के दशक में बनाया था। इस फ़ाइल फ़ॉर्मेट का उद्देश्य दस्तावेज़ों और अन्य संदर्भ सामग्री का प्रतिनिधित्व करने के लिए एक मानक प्रस्तुत करना था, जो एप्लिकेशन सॉफ़्टवेयर, हार्डवेयर और ऑपरेटिंग सिस्टम से स्वतंत्र हो। एक PDF फ़ाइल बाइट्स का एक सेट है जिसे PDF विनिर्देशों द्वारा परिभाषित सिंटैक्स नियमों के अनुसार टोकन में समूहित किया जा सकता है। एक या अधिक टोकन को मिलाकर उच्च-स्तरीय सिंटैक्टिक इकाइयाँ, मुख्यतः ऑब्जेक्ट्स, बनते हैं, जो मूल डेटा मान हैं जिनसे PDF दस्तावेज़ निर्मित होता है।
...
रूपांतरण स्रोत। मौजूदा स्थानीय HTML फ़ाइल या रिमोट URL को रूपांतरण स्रोत के रूप में पहचानें। आप इनलाइन HTML सामग्री को भी रूपांतरण स्रोत के रूप में परिभाषित कर सकते हैं या किसी भी तरीके से HTML दस्तावेज़ (HTMLDocument) बना सकते हैं। रूपांतरण परिणाम। परिणाम आउटपुट फ़ाइल पथ को परिभाषित करें या ज्ञात या कस्टम [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) इंटरफ़ेस कार्यान्वयन को आउटपुट डेटा बफ़र के रूप में उपयोग करें। एक नया [`PdfSaveOptions`](../../../com.aspose.html.saving/pdfsaveoptions/) ऑब्जेक्ट कस्टम या डिफ़ॉल्ट सेटिंग्स के साथ बनाएं। आप विकल्प पैरामीटर के रूप में [`configuration`](../../../com.aspose.html/configuration/) भी जोड़ सकते हैं। `ConvertHTML()` मेथड का उपयोग करके Converter क्लास के माध्यम से HTML को PDF परिणाम के रूप में सहेजें, जिसमें उपयोगकर्ता परिदृश्य के अनुसार तीन या अधिक पैरामीटर हो सकते हैं। ऑनलाइन HTML रूपांतरणकर्ता

Aspose.HTML एक मुफ्त ऑनलाइन [HTML to PDF Converter](https://products.aspose.app/html/en/conversion/html-to-pdf) प्रदान करता है जो HTML को उच्च गुणवत्ता, आसान और तेज़ी से PDF में परिवर्तित करता है। बस फ़ाइलें अपलोड करें, उन्हें परिवर्तित करें और कुछ सेकंड में परिणाम प्राप्त करें!
...
... 
      ...
      using (var document = new HTMLDocument(sourcePath, configuration))
      {
		...
		// रूपांतरण प्रक्रिया को इंस्टैंशिएट करें
        Converter.ConvertHTML(document, options, resultPath);
      }
```
...
URL द्वारा प्रस्तुत HTML स्रोत को परिवर्तित करें। परिणाम आउटपुट फ़ाइल पथ द्वारा निर्मित pdf फ़ाइल है।
...
पूर्ण फ़ाइल पथ द्वारा प्रस्तुत HTML स्रोत को PDF में बदलें। परिणाम आउटपुट फ़ाइल पथ द्वारा निर्मित pdf फ़ाइल है।
...
इनलाइन सामग्री द्वारा प्रस्तुत HTML स्रोत को PDF में परिवर्तित करें। परिणाम आउटपुट फ़ाइल पथ द्वारा निर्मित pdf फ़ाइल है।
...
[`HTMLDocument`](../../../com.aspose.html/htmldocument/) द्वारा प्रस्तुत HTML स्रोत को PDF में परिवर्तित करें। परिणाम आउटपुट डेटा है जो [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) इंटरफ़ेस कार्यान्वयन द्वारा निर्मित होता है।
...
पूर्ण फ़ाइल पथ द्वारा प्रस्तुत HTML स्रोत को PDF में परिवर्तित करें। परिणाम आउटपुट डेटा है जो [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) इंटरफ़ेस कार्यान्वयन द्वारा निर्मित होता है।
...
इनलाइन सामग्री द्वारा प्रस्तुत HTML स्रोत को PDF में परिवर्तित करें। परिणाम आउटपुट डेटा है जो [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) इंटरफ़ेस कार्यान्वयन द्वारा निर्मित होता है।
...
`[`HTMLDocument`](../../../com.aspose.html/htmldocument/)` द्वारा प्रस्तुत HTML स्रोत को परिवर्तित करें। परिणाम आउटपुट फ़ाइल पथ द्वारा निर्मित mhtml (.mht) फ़ाइल है।
...
| --- | --- | --- |
| document | HTMLDocument | [`HTMLDocument`](../../../com.aspose.html/htmldocument/) द्वारा प्रस्तुत रूपांतरण स्रोत। |
| options | MHTMLSaveOptions | [`MHTMLSaveOptions`](../../../com.aspose.html.saving/mhtmlsaveoptions/) ऑब्जेक्ट का उपयोग आपको रेंडरिंग प्रक्रिया को ट्यून करने की अनुमति देता है। अधिक जानकारी के लिए देखें [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/html-to-mhtml/#convert-html-to-mhtml-using-mhtmlsaveoptions)। |
| outputPath | String | आउटपुट रूपांतरण परिणाम के रूप में पूर्ण mhtml (.mht) फ़ाइल पथ। |

## Remarks

HTML को MHTML में कैसे परिवर्तित करें
...
रूपांतरण स्रोत। मौजूदा स्थानीय HTML फ़ाइल या रिमोट URL को रूपांतरण स्रोत के रूप में पहचानें। आप इनलाइन HTML सामग्री को भी रूपांतरण स्रोत के रूप में परिभाषित कर सकते हैं या किसी भी तरीके से HTML दस्तावेज़ ([`HTMLDocument`](../../../com.aspose.html/htmldocument/)) बना सकते हैं। रूपांतरण परिणाम। परिणाम आउटपुट फ़ाइल पथ को परिभाषित करें या ज्ञात या कस्टम [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) इंटरफ़ेस कार्यान्वयन को आउटपुट डेटा बफ़र के रूप में उपयोग करें। एक नया [`MHTMLSaveOptions`](../../../com.aspose.html.saving/mhtmlsaveoptions/) ऑब्जेक्ट कस्टम या डिफ़ॉल्ट सेटिंग्स के साथ बनाएं। आप विकल्प पैरामीटर के रूप में [`configuration`](../../../com.aspose.html/configuration/) भी जोड़ सकते हैं। `ConvertHTML()` मेथड का उपयोग करके Converter क्लास के माध्यम से HTML को MHTML परिणाम के रूप में सहेजें, जिसमें उपयोगकर्ता परिदृश्य के अनुसार तीन या अधिक पैरामीटर हो सकते हैं। ऑनलाइन HTML रूपांतरणकर्ता

Aspose.HTML एक मुफ्त ऑनलाइन [HTML to MHTML Converter](https://products.aspose.app/html/en/conversion/html-to-mhtml) प्रदान करता है जो HTML को उच्च गुणवत्ता, आसान और तेज़ी से MHTML में परिवर्तित करता है। बस फ़ाइलें अपलोड करें, उन्हें परिवर्तित करें और कुछ सेकंड में परिणाम प्राप्त करें!
...
URL द्वारा प्रस्तुत HTML स्रोत को बदलें। परिणाम आउटपुट फ़ाइल पथ द्वारा निर्मित mhtml (.mht) फ़ाइल है।
...
पूर्ण फ़ाइल पथ द्वारा प्रस्तुत HTML स्रोत को MHTML में बदलें। परिणाम आउटपुट फ़ाइल पथ द्वारा निर्मित mhtml (.mht) फ़ाइल है।
...
| पैरामीटर | टाइप | विवरण |
| --- | --- | --- |
| sourcePath | String | HTML फ़ाइल स्रोत पथ। इसे वर्तमान निर्देशिका पथ के साथ मिलाकर एक पूर्ण URL बनाया जाएगा। |
| options | MHTMLSaveOptions | [`MHTMLSaveOptions`](../../../com.aspose.html.saving/mhtmlsaveoptions/) ऑब्जेक्ट का उपयोग आपको रेंडरिंग प्रक्रिया को ट्यून करने की अनुमति देता है। अधिक जानकारी के लिए देखें [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/html-to-mhtml/#convert-html-to-mhtml-using-mhtmlsaveoptions)। |
| outputPath | String | आउटपुट रूपांतरण परिणाम के रूप में पूर्ण mhtml (.mht) फ़ाइल पथ। |
...
इनलाइन सामग्री द्वारा प्रस्तुत HTML स्रोत को MHTML में परिवर्तित करें। परिणाम आउटपुट फ़ाइल पथ द्वारा निर्मित mhtml (.mht) फ़ाइल है।
...
... 
	...
	// डिफ़ॉल्ट सहेजने विकल्प ऑब्जेक्ट को परिभाषित करें
  	var options = new MHTMLSaveOptions();
...
परिवर्तन स्रोत। एक मौजूदा स्थानीय HTML फ़ाइल या रिमोट URL को परिवर्तन स्रोत के रूप में पहचानें। आप इनलाइन HTML सामग्री को भी परिवर्तन स्रोत के रूप में परिभाषित कर सकते हैं या किसी भी तरीके से HTML दस्तावेज़ ([`HTMLDocument`](../../../com.aspose.html/htmldocument/)) बना सकते हैं। परिवर्तन परिणाम। परिणाम आउटपुट फ़ाइल पथ को परिभाषित करें या आउटपुट डेटा बफ़र के रूप में ज्ञात या कस्टम [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) इंटरफ़ेस कार्यान्वयन का उपयोग करें। कस्टम या डिफ़ॉल्ट सेटिंग्स के साथ नया [`MHTMLSaveOptions`](../../../com.aspose.html.saving/mhtmlsaveoptions/) ऑब्जेक्ट बनाएं। आप विकल्प पैरामीटर के रूप में [`configuration`](../../../com.aspose.html/configuration/) भी जोड़ सकते हैं। उपयोगकर्ता परिदृश्य के आधार पर तीन या अधिक पैरामीटर के साथ HTML को MHTML परिणाम के रूप में सहेजने के लिए Converter क्लास की ConvertHTML() मेथड का उपयोग करें। ऑनलाइन HTML रूपांतरणकर्ता
...
[`HTMLDocument`](../../../com.aspose.html/htmldocument/) द्वारा प्रस्तुत HTML स्रोत को परिवर्तित करें। परिणाम आउटपुट फ़ाइल पथ द्वारा निर्मित markdown (.md) फ़ाइल है।
...
| --- | --- | --- |
| document | HTMLDocument | [`HTMLDocument`](../../../com.aspose.html/htmldocument/) द्वारा प्रस्तुत रूपांतरण स्रोत। |
| options | MarkdownSaveOptions | [`MarkdownSaveOptions`](../../../com.aspose.html.saving/markdownsaveoptions/) ऑब्जेक्ट का उपयोग रेंडरिंग प्रक्रिया को ट्यून करने में सक्षम बनाता है। अधिक जानकारी के लिए देखें [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/html-to-markdown/#convert-html-to-markdown-using-markdownsaveoptions). |
| outputPath | String | आउटपुट रूपांतरण परिणाम के रूप में पूर्ण md फ़ाइल पथ। |

## Remarks

HTML को Markdown में कैसे परिवर्तित करें
...
HTML को Markdown में परिवर्तित करें
...
परिवर्तन स्रोत। एक मौजूदा स्थानीय HTML फ़ाइल या रिमोट URL को परिवर्तन स्रोत के रूप में पहचानें। आप इनलाइन HTML सामग्री को भी परिवर्तन स्रोत के रूप में परिभाषित कर सकते हैं या किसी भी तरीके से HTML दस्तावेज़ ([`HTMLDocument`](../../../com.aspose.html/htmldocument/)) बना सकते हैं। परिवर्तन परिणाम। परिणाम आउटपुट फ़ाइल पथ को परिभाषित करें या आउटपुट डेटा बफ़र के रूप में ज्ञात या कस्टम [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) इंटरफ़ेस कार्यान्वयन का उपयोग करें। कस्टम या डिफ़ॉल्ट सेटिंग्स के साथ नया [MarkdownSaveOptions](https://apireference.aspose.com/html/net/aspose.html.saving/markdownsaveoptions) ऑब्जेक्ट बनाएं। आप विकल्प पैरामीटर के रूप में [`configuration`](../../../com.aspose.html/configuration/) भी जोड़ सकते हैं। उपयोगकर्ता परिदृश्य के आधार पर तीन या अधिक पैरामीटर के साथ HTML को Markdown परिणाम के रूप में सहेजने के लिए Converter क्लास की ConvertHTML() मेथड का उपयोग करें। ऑनलाइन HTML रूपांतरणकर्ता

Aspose.HTML एक मुफ्त ऑनलाइन [HTML to Markdown](https://products.aspose.app/html/en/conversion/html-to-md) प्रदान करता है जो उच्च गुणवत्ता, आसान और तेज़ी से HTML को MD में परिवर्तित करता है। बस अपलोड करें, अपनी फ़ाइलें परिवर्तित करें और कुछ सेकंड में परिणाम प्राप्त करें!
...
... 
		...
		using (HTMLDocument document = new HTMLDocument(sourcePath, new Configuration()))
		{
			// सहेजने विकल्प ऑब्जेक्ट इंस्टेंस को परिभाषित करें
...
URL द्वारा प्रस्तुत HTML स्रोत को बदलें। परिणाम आउटपुट फ़ाइल पथ द्वारा निर्मित markdown (.md) फ़ाइल है।
...
पूर्ण फ़ाइल पथ द्वारा प्रस्तुत HTML स्रोत को Markdown में बदलें। परिणाम आउटपुट फ़ाइल पथ द्वारा निर्मित markdown (.md) फ़ाइल है।
...
इनलाइन सामग्री द्वारा प्रस्तुत HTML स्रोत को Markdown में परिवर्तित करें। परिणाम आउटपुट फ़ाइल पथ द्वारा निर्मित mhtml (.mht) फ़ाइल है।
...
[`HTMLDocument`](../../../com.aspose.html/htmldocument/) द्वारा प्रस्तुत HTML स्रोत को परिवर्तित करें। परिणाम आउटपुट फ़ाइल पथ द्वारा निर्मित xps फ़ाइल है।
...
| --- | --- | --- |
| document | HTMLDocument | [`HTMLDocument`](../../../com.aspose.html/htmldocument/) द्वारा प्रस्तुत रूपांतरण स्रोत। |
| options | XpsSaveOptions | [`XpsSaveOptions`](../../../com.aspose.html.saving/xpssaveoptions/) ऑब्जेक्ट का उपयोग रेंडरिंग प्रक्रिया को ट्यून करने में सक्षम बनाता है। अधिक जानकारी के लिए देखें [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/html-to-xps/#convert-html-to-xps-using-xpssaveoptions). |
...
परिवर्तन स्रोत। एक मौजूदा स्थानीय HTML फ़ाइल या रिमोट URL को परिवर्तन स्रोत के रूप में पहचानें। आप इनलाइन HTML सामग्री को भी परिवर्तन स्रोत के रूप में परिभाषित कर सकते हैं या किसी भी तरीके से HTML दस्तावेज़ (HTMLDocument) बना सकते हैं। परिवर्तन परिणाम। परिणाम आउटपुट फ़ाइल पथ को परिभाषित करें या आउटपुट डेटा बफ़र के रूप में ज्ञात या कस्टम [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) इंटरफ़ेस कार्यान्वयन का उपयोग करें। कस्टम या डिफ़ॉल्ट सेटिंग्स के साथ नया [`XpsSaveOptions`](../../../com.aspose.html.saving/xpssaveoptions/) ऑब्जेक्ट बनाएं। आप विकल्प पैरामीटर के रूप में [`configuration`](../../../com.aspose.html/configuration/) भी जोड़ सकते हैं। उपयोगकर्ता परिदृश्य के आधार पर तीन या अधिक पैरामीटर के साथ HTML को XPS परिणाम के रूप में सहेजने के लिए Converter क्लास की ConvertHTML() मेथड का उपयोग करें। ऑनलाइन HTML रूपांतरणकर्ता

Aspose.HTML एक मुफ्त ऑनलाइन [HTML to XPS Converter](https://products.aspose.app/html/en/conversion/html-to-xps) प्रदान करता है जो उच्च गुणवत्ता, आसान और तेज़ी से HTML को XPS में परिवर्तित करता है। बस अपलोड करें, अपनी फ़ाइलें परिवर्तित करें और कुछ सेकंड में परिणाम प्राप्त करें!
...
URL द्वारा प्रस्तुत HTML स्रोत को परिवर्तित करें। परिणाम आउटपुट फ़ाइल पथ द्वारा निर्मित xps फ़ाइल है।
...
पूर्ण फ़ाइल पथ द्वारा प्रस्तुत HTML स्रोत को XPS में बदलें। परिणाम आउटपुट फ़ाइल पथ द्वारा निर्मित xps फ़ाइल है।
...
इनलाइन सामग्री द्वारा प्रस्तुत HTML स्रोत को XPS में परिवर्तित करें। परिणाम आउटपुट फ़ाइल पथ द्वारा निर्मित xps फ़ाइल है।
...
... 
	...
	// कई तरीकों में से एक द्वारा HTML दस्तावेज़ बनाएं
   	using (HTMLDocument document = new HTMLDocument(sourcePath, new Configuration()))
   	{
		...
		// ज्ञात ICreateStreamProvider कार्यान्वयन में से एक का उपयोग करें
  		ICreateStreamProvider provider = new FileCreateStreamProvider(resultPath);
...
| पैरामीटर | टाइप | विवरण |
| --- | --- | --- |
| url | Url | HTML स्रोत URL - एक सार्वभौमिक पहचानकर्ता (URL) का ऑब्जेक्ट प्रतिनिधित्व प्रदान करता है। |
| configuration | Configuration | पर्यावरण कॉन्फ़िगरेशन। यह [`configuration`](../../../com.aspose.html/configuration/) संदर्भ ऑब्जेक्ट का प्रतिनिधित्व करता है जिसका उपयोग एप्लिकेशन के लिए पर्यावरण सेटिंग्स को सेट करने में किया जाता है। |
| options | XpsSaveOptions | [`XpsSaveOptions`](../../../com.aspose.html.saving/xpssaveoptions/) ऑब्जेक्ट का उपयोग रेंडरिंग प्रक्रिया को ट्यून करने में सक्षम बनाता है। |
| provider | ICreateStreamProvider | [`interface`](../../../com.aspose.html.io/icreatestreamprovider/) का कार्यान्वयन, जिसका उपयोग आउटपुट स्ट्रीम प्राप्त करने के लिए किया जाएगा। |
...
पूर्ण फ़ाइल पथ द्वारा प्रस्तुत HTML स्रोत को XPS में परिवर्तित करें। परिणाम आउटपुट डेटा है जो [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) इंटरफ़ेस कार्यान्वयन द्वारा निर्मित है।
...
इनलाइन सामग्री द्वारा प्रस्तुत HTML स्रोत को XPS में बदलें। परिणाम आउटपुट डेटा है जो [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) इंटरफ़ेस कार्यान्वयन द्वारा निर्मित होता है।
...
Aspose.HTML एक मुफ्त ऑनलाइन [HTML to XPS](https://products.aspose.app/html/en/conversion/html-to-xps) कनवर्टर प्रदान करता है जो उच्च गुणवत्ता, आसान और तेज़ी से HTML को XPS में बदलता है। बस फ़ाइलें अपलोड करें, उन्हें बदलें और कुछ सेकंड में परिणाम प्राप्त करें!
...
[`HTMLDocument`](../../../com.aspose.html/htmldocument/) द्वारा प्रस्तुत HTML स्रोत को बदलें। परिणाम आउटपुट फ़ाइल पथ द्वारा निर्मित इमेज फ़ाइल है।
...
| --- | --- | --- |
| document | HTMLDocument | [`HTMLDocument`](../../../com.aspose.html/htmldocument/) द्वारा प्रस्तुत रूपांतरण स्रोत। |
| options | ImageSaveOptions | [`ImageSaveOptions`](../../../com.aspose.html.saving/imagesaveoptions/) ऑब्जेक्ट का उपयोग रेंडरिंग प्रक्रिया को ट्यून करने में सक्षम बनाता है। |
| outputPath | String | आउटपुट रूपांतरण परिणाम के रूप में पूर्ण इमेज फ़ाइल पथ। |

## Remarks

HTML को इमेज में कैसे बदलें
...
रूपांतरण स्रोत। मौजूदा स्थानीय HTML फ़ाइल या रिमोट URL को रूपांतरण स्रोत के रूप में पहचानें। आप इनलाइन HTML सामग्री को भी रूपांतरण स्रोत के रूप में परिभाषित कर सकते हैं या किसी भी तरीके से HTML दस्तावेज़ (HTMLDocument) बना सकते हैं। रूपांतरण परिणाम। परिणाम आउटपुट फ़ाइल पथ को परिभाषित करें या आउटपुट डेटा बफ़र के रूप में ज्ञात या कस्टम [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) इंटरफ़ेस कार्यान्वयन का उपयोग करें। आवश्यक [`ImageFormat`](../../../com.aspose.html.rendering.image/imageformat/) के साथ एक नया [`ImageSaveOptions`](../../../com.aspose.html.saving/imagesaveoptions/) ऑब्जेक्ट बनाएं। डिफ़ॉल्ट रूप से, Format प्रॉपर्टी PNG है। आप विकल्प पैरामीटर के रूप में [`configuration`](../../../com.aspose.html/configuration/) भी जोड़ सकते हैं। Converter क्लास की ConvertHTML() मेथड का उपयोग करके HTML को इमेज के रूप में सहेजें, जिसमें उपयोगकर्ता परिदृश्य के अनुसार तीन या अधिक पैरामीटर हो सकते हैं। ऑनलाइन HTML कनवर्टर।

Aspose.HTML एक मुफ्त ऑनलाइन [HTML to PNG Converter](https://products.aspose.app/html/en/conversion/html-to-png) प्रदान करता है जो उच्च गुणवत्ता, आसान और तेज़ी से HTML को इमेज में बदलता है। बस फ़ाइलें अपलोड करें, उन्हें बदलें और कुछ सेकंड में परिणाम प्राप्त करें!
...
URL द्वारा प्रस्तुत HTML स्रोत को बदलें। परिणाम आउटपुट फ़ाइल पथ द्वारा निर्मित इमेज फ़ाइल है।
...
पूर्ण फ़ाइल पथ द्वारा प्रस्तुत HTML स्रोत को छवि में बदलें। परिणाम आउटपुट फ़ाइल पथ द्वारा निर्मित इमेज फ़ाइल है।
...
| --- | --- | --- |
| sourcePath | String | HTML फ़ाइल स्रोत पथ। इसे वर्तमान निर्देशिका पथ के साथ मिलाकर एक पूर्ण URL बनाया जाएगा। |
| options | ImageSaveOptions | [`ImageSaveOptions`](../../../com.aspose.html.saving/imagesaveoptions/) क्लास के बारे में अधिक जानने के लिए, कृपया [Fine-Tuning Converters](https://docs.aspose.com/html/net/converting-between-formats/fine-tuning-converters/) लेख पढ़ें। |
| outputPath | String | आउटपुट रूपांतरण परिणाम के रूप में पूर्ण इमेज फ़ाइल पथ। |
...
... 
	...
	// सेव विकल्प ऑब्जेक्ट इंस्टेंस को परिभाषित करें। डिफ़ॉल्ट रूप से PNG इमेज फ़ॉर्मेट है।
...
इनलाइन सामग्री द्वारा प्रस्तुत HTML स्रोत को छवि में परिवर्तित करें। परिणाम आउटपुट फ़ाइल पथ द्वारा निर्मित छवि फ़ाइल है।
...
| सामग्री | String | स्ट्रिंग को इनलाइन HTML सामग्री के रूप में। |
| baseUri | String | दस्तावेज़ का बेस URI। इसे वर्तमान डायरेक्टरी पाथ के साथ मिलाकर एक पूर्ण URL बनाया जाएगा। |
| options | ImageSaveOptions | नए निर्मित इमेज विकल्प जैसे फ़ॉर्मेट, रिज़ॉल्यूशन आदि। देखें [`ImageSaveOptions`](../../../com.aspose.html.saving/imagesaveoptions/) क्लास और [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/html-to-jpg/#output-stream-providers)। |
| outputPath | String | आउटपुट रूपांतरण परिणाम के रूप में पूर्ण इमेज फ़ाइल पथ। |
...
| configuration | Configuration | पर्यावरण कॉन्फ़िगरेशन। यह [`configuration`](../../../com.aspose.html/configuration/) संदर्भ ऑब्जेक्ट का प्रतिनिधित्व करता है जिसका उपयोग एप्लिकेशन के लिए पर्यावरण सेटिंग्स को सेट करने में किया जाता है। |
| options | ImageSaveOptions | ImageSaveOptions ऑब्जेक्ट का उपयोग रेंडरिंग प्रक्रिया को ट्यून करने में सक्षम बनाता है। आप [`page size`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/), [`margins`](../../../com.aspose.html.drawing/page/margin/), [`CSS media-type`](../../../com.aspose.html.rendering/mediatype/), आदि निर्दिष्ट कर सकते हैं। |
| provider | ICreateStreamProvider | इंटरफ़ेस का कार्यान्वयन, जिसका उपयोग आउटपुट स्ट्रीम प्राप्त करने के लिए किया जाएगा। प्रोवाइडर्स के बारे में अधिक जानकारी के लिए देखें [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/html-to-jpg/#output-stream-providers)। |
...
पूर्ण फ़ाइल पथ द्वारा प्रस्तुत HTML स्रोत को इमेज में बदलें। परिणाम आउटपुट डेटा है जो [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) इंटरफ़ेस कार्यान्वयन द्वारा निर्मित होता है।
...
इनलाइन सामग्री द्वारा प्रस्तुत HTML स्रोत को इमेज में बदलें। परिणाम आउटपुट डेटा है जो [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) इंटरफ़ेस कार्यान्वयन द्वारा निर्मित होता है।
...
| सामग्री | String | स्ट्रिंग को इनलाइन HTML सामग्री के रूप में। |
| baseUri | String | दस्तावेज़ का बेस URI। इसे वर्तमान डायरेक्टरी पाथ के साथ मिलाकर एक पूर्ण URL बनाया जाएगा। |
| configuration | Configuration | पर्यावरण कॉन्फ़िगरेशन। यह वह [`configuration `](../../../com.aspose.html/configuration/) कॉन्टेक्स्ट ऑब्जेक्ट दर्शाता है जो एप्लिकेशन के लिए पर्यावरण सेटिंग्स को सेट करने में उपयोग होता है। |
| options | ImageSaveOptions | ImageSaveOptions ऑब्जेक्ट का उपयोग रेंडरिंग प्रक्रिया को ट्यून करने में सक्षम बनाता है। आप [`page size`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/), [`margins`](../../../com.aspose.html.drawing/page/margin/), [`CSS media-type`](../../../com.aspose.html.rendering/mediatype/), आदि निर्दिष्ट कर सकते हैं। |
| provider | ICreateStreamProvider | [`interface`](../../../com.aspose.html.io/icreatestreamprovider/) का कार्यान्वयन, जिसका उपयोग आउटपुट स्ट्रीम प्राप्त करने के लिए किया जाएगा। प्रोवाइडर्स के बारे में अधिक जानकारी के लिए देखें [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/html-to-jpg/#output-stream-providers)। |
...
html दस्तावेज़ को टेक्स्ट में बदलें। परिणाम TXT फ़ाइल है।
...
| पैरामीटर | टाइप | विवरण |
| --- | --- | --- |
| दस्तावेज़ | HTMLDocument | रूपांतरण स्रोत। |
| विकल्प | TextSaveOptions | रूपांतरण विकल्प। |
...
| --- | --- | --- |
| url | Url | दस्तावेज़ URL। |
| कॉन्फ़िगरेशन | कॉन्फ़िगरेशन | पर्यावरण कॉन्फ़िगरेशन। |
| विकल्प | TextSaveOptions | रूपांतरण विकल्प। |
| outputPath | String | आउटपुट फ़ाइल पथ। |
...
| पैरामीटर | टाइप | विवरण |
| --- | --- | --- |
| सामग्री | String | इनलाइन स्ट्रिंग HTML सामग्री। |
| baseUri | String | दस्तावेज़ का बेस URI। इसे वर्तमान डायरेक्टरी पाथ के साथ मिलाकर एक पूर्ण URL बनाया जाएगा। |
| विकल्प | TextSaveOptions | रूपांतरण विकल्प। |
| outputPath | String | आउटपुट फ़ाइल पथ। |
