...
description: "com.aspose.html.toolkit.markdown.syntax.OrderedListItemMarker क्लास. क्रमबद्ध सूची आइटम मार्कर को दर्शाता है"
type: docs
...
| [getDelimiter](../../com.aspose.html.toolkit.markdown.syntax/orderedlistitemmarker/getdelimiter/)() | डिलिमिटर के प्राप्त करने के इंटरफ़ेस को परिभाषित करता है। |
| [getIndex](../../com.aspose.html.toolkit.markdown.syntax/orderedlistitemmarker/getindex/)() | इंडेक्स प्राप्त करने के इंटरफ़ेस को परिभाषित करता है। |
