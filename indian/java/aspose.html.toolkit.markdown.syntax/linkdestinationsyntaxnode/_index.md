---
title: "LinkDestinationSyntaxNode क्लास"
second_title: "Aspose.HTML Java के लिए API संदर्भ"
description: "com.aspose.html.toolkit.markdown.syntax.LinkDestinationSyntaxNode क्लास। LinkDestinationSyntaxNode को दर्शाता है"
type: docs

url: /hi/java/com.aspose.html.toolkit.markdown.syntax/linkdestinationsyntaxnode/
---
## LinkDestinationSyntaxNode class

LinkDestinationSyntaxNode को दर्शाता है।
...
| नाम | विवरण |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/linkdestinationsyntaxnode/accept/)(MarkdownSyntaxVisitor) | विज़िटर को स्वीकार करने के लिए इंटरफ़ेस को परिभाषित करता है। |
...
| [getEnumerator](../../com.aspose.html.toolkit.markdown.syntax/inlinecontainersyntaxnode/getenumerator/)() | एक एनेमरेटर लौटाता है जो संग्रह के माध्यम से इटररेट करता है। |
...
| [getValue](../../com.aspose.html.toolkit.markdown.syntax/linkdestinationsyntaxnode/getvalue/)() | String मान प्राप्त करने के लिए इंटरफ़ेस को परिभाषित करता है। |
