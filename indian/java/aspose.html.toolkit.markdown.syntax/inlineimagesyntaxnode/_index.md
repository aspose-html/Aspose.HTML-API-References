---
title: "InlineImageSyntaxNode क्लास"
second_title: "Aspose.HTML Java के लिए API संदर्भ"
description: "com.aspose.html.toolkit.markdown.syntax.InlineImageSyntaxNode क्लास। InlineImageSyntaxNode का प्रतिनिधित्व करता है"
type: docs

url: /hi/java/com.aspose.html.toolkit.markdown.syntax/inlineimagesyntaxnode/
---
## InlineImageSyntaxNode class

InlineImageSyntaxNode को दर्शाता है।
...
| नाम | विवरण |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/inlineimagesyntaxnode/accept/)(MarkdownSyntaxVisitor) | विज़िटर को स्वीकार करने के लिए इंटरफ़ेस को परिभाषित करता है। |
...
| [getAltText](../../com.aspose.html.toolkit.markdown.syntax/inlineimagesyntaxnode/getalttext/)() | सभी टेक्स्ट प्राप्त करने के लिए इंटरफ़ेस को परिभाषित करता है। |
| [getDestination](../../com.aspose.html.toolkit.markdown.syntax/inlineimagesyntaxnode/getdestination/)() | डेस्टिनेशन प्राप्त करने के लिए इंटरफ़ेस को परिभाषित करता है। |
...
| [getTitle](../../com.aspose.html.toolkit.markdown.syntax/inlineimagesyntaxnode/gettitle/)() | टाइटल प्राप्त करने के लिए इंटरफ़ेस को परिभाषित करता है। |
