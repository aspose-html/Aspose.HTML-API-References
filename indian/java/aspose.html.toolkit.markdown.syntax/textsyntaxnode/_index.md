---
title: "TextSyntaxNode क्लास"
second_title: "Aspose.HTML for Java API संदर्भ"
description: "com.aspose.html.toolkit.markdown.syntax.textSyntaxNode क्लास। टेक्स्ट सिंटैक्स नोड को लागू किया गया है"
type: docs

url: /hi/java/com.aspose.html.toolkit.markdown.syntax/textsyntaxnode/
---
## TextSyntaxNode class

टेक्स्ट सिंटैक्स नोड को इम्प्लीमेंट किया गया.
...
| नाम | विवरण |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/textsyntaxnode/accept/)(MarkdownSyntaxVisitor) | विज़िटर को स्वीकार करने के लिए इंटरफ़ेस को परिभाषित करता है। |
