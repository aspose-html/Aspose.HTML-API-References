---
title: "LineBreakSyntaxNode क्लास"
second_title: "Aspose.HTML Java के लिए API संदर्भ"
description: "com.aspose.html.toolkit.markdown.syntax.LineBreakSyntaxNode क्लास। LineBreakSyntaxNode का प्रतिनिधित्व करता है।"
type: docs

url: /hi/java/com.aspose.html.toolkit.markdown.syntax/linebreaksyntaxnode/
---
## LineBreakSyntaxNode class

LineBreakSyntaxNode को दर्शाता है।
...
| नाम | विवरण |
| --- | --- |
| abstract [Accept](../../com.aspose.html.toolkit.markdown.syntax/inlinesyntaxnode/accept/)(MarkdownSyntaxVisitor) | विज़िटर को स्वीकार करने के लिए इंटरफ़ेस को परिभाषित करता है। |
