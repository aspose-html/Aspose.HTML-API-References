---
title: "HTMLFragmentSyntax क्लास"
second_title: "Aspose.HTML Java के लिए API संदर्भ"
description: "com.aspose.html.toolkit.markdown.syntax.HTMLFragmentSyntax क्लास। HTMLFragmentSyntax को दर्शाता है"
type: docs

url: /hi/java/com.aspose.html.toolkit.markdown.syntax/htmlfragmentsyntax/
---
## HTMLFragmentSyntax class

HTMLFragmentSyntax को दर्शाता है।
...
| नाम | विवरण |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/htmlfragmentsyntax/accept/)(MarkdownSyntaxVisitor) | विज़िटर को स्वीकार करने के लिए इंटरफ़ेस को परिभाषित करता है। |
...
| [getContent](../../com.aspose.html.toolkit.markdown.syntax/htmlfragmentsyntax/getcontent/)() | कंटेंट प्राप्त करने के लिए इंटरफ़ेस को परिभाषित करता है। |
...
| [setContent](../../com.aspose.html.toolkit.markdown.syntax/htmlfragmentsyntax/setcontent/)(String) | सामग्री सेट करने के लिए इंटरफ़ेस को परिभाषित करता है। |
