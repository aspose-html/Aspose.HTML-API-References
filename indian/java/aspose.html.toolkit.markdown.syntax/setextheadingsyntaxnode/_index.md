---
title: "SetextHeadingSyntaxNode क्लास"
second_title: "Aspose.HTML Java के लिए API संदर्भ"
description: "com.aspose.html.toolkit.markdown.syntax.SetextHeadingSyntaxNode क्लास। Setext हेडिंग सिंटैक्स नोड का प्रतिनिधित्व करता है"
type: docs

url: /hi/java/com.aspose.html.toolkit.markdown.syntax/setextheadingsyntaxnode/
---
## SetextHeadingSyntaxNode class

सेटेक्स्ट हेडिंग सिंटैक्स नोड का प्रतिनिधित्व करता है।
...
| [getLevel](../../com.aspose.html.toolkit.markdown.syntax/setextheadingsyntaxnode/level/) वर्तमान सिंटैक्स का स्तर प्राप्त करें। |
...
| नाम | विवरण |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/setextheadingsyntaxnode/accept/)(MarkdownSyntaxVisitor) | विज़िटर को स्वीकार करने के लिए इंटरफ़ेस को परिभाषित करता है। |
