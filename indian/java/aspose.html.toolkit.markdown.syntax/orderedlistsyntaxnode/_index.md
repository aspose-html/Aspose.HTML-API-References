---
title: "OrderedListSyntaxNode क्लास"
second_title: "Aspose.HTML Java के लिए API संदर्भ"
description: "com.aspose.html.toolkit.markdown.syntax.OrderedListSyntaxNode क्लास। Ordered list सिंटैक्स का प्रतिनिधित्व करता है"
type: docs

url: /hi/java/com.aspose.html.toolkit.markdown.syntax/orderedlistsyntaxnode/
---
## OrderedListSyntaxNode class

ऑर्डर्ड लिस्ट सिंटैक्स का प्रतिनिधित्व करता है।
...
| नाम | विवरण |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/orderedlistsyntaxnode/accept/)(MarkdownSyntaxVisitor) | विज़िटर को स्वीकार करने के लिए इंटरफ़ेस को परिभाषित करता है। |
...
| [getDelimiter](../../com.aspose.html.toolkit.markdown.syntax/orderedlistsyntaxnode/getdelimiter/)() | डिलिमिटर के get के लिए इंटरफ़ेस को परिभाषित करता है। |
...
| [getStart](../../com.aspose.html.toolkit.markdown.syntax/orderedlistsyntaxnode/getstart/)() | स्टार्ट इंडेक्स प्राप्त करने के लिए इंटरफ़ेस को परिभाषित करता है। |
...
| [isTight](../../com.aspose.html.toolkit.markdown.syntax/listsyntaxnode/istight/)() | is tight प्राप्त करने के लिए इंटरफ़ेस को परिभाषित करता है। |
