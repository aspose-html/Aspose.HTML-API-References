---
title: "InlineLinkSyntaxNode क्लास"
second_title: "Aspose.HTML Java के लिए API संदर्भ"
description: "com.aspose.html.toolkit.markdown.syntax.InlineLinkSyntaxNode क्लास। InlineLinkSyntaxNode का प्रतिनिधित्व करता है"
type: docs

url: /hi/java/com.aspose.html.toolkit.markdown.syntax/inlinelinksyntaxnode/
---
## InlineLinkSyntaxNode class

InlineLinkSyntaxNode को दर्शाता है।
...
| नाम | विवरण |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/inlinelinksyntaxnode/accept/)(MarkdownSyntaxVisitor) | विज़िटर को स्वीकार करने के लिए इंटरफ़ेस को परिभाषित करता है। |
...
| [getDestination](../../com.aspose.html.toolkit.markdown.syntax/inlinelinksyntaxnode/getdestination/)() | डेस्टिनेशन प्राप्त करने के लिए इंटरफ़ेस को परिभाषित करता है। |
...
| [getTitle](../../com.aspose.html.toolkit.markdown.syntax/inlinelinksyntaxnode/gettitle/)() | टाइटल प्राप्त करने के लिए इंटरफ़ेस को परिभाषित करता है। |
