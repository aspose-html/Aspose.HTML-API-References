---
title: "CodeSpanSyntaxNode क्लास"
second_title: "Aspose.HTML Java के लिए API संदर्भ"
description: "com.aspose.html.toolkit.markdown.syntax.CodeSpanSyntaxNode क्लास। CodeSpanSyntaxNode का प्रतिनिधित्व करता है"
type: docs

url: /hi/java/com.aspose.html.toolkit.markdown.syntax/codespansyntaxnode/
---
## CodeSpanSyntaxNode class

CodeSpanSyntaxNode का प्रतिनिधित्व करता है
...
| नाम | विवरण |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/codespansyntaxnode/accept/)(MarkdownSyntaxVisitor) | विज़िटर को स्वीकार करने के लिए इंटरफ़ेस को परिभाषित करता है। |
...
| [getContent](../../com.aspose.html.toolkit.markdown.syntax/codespansyntaxnode/getcontent/)() | कंटेंट प्राप्त करने के लिए इंटरफ़ेस को परिभाषित करता है। |
