---
title: "UnorderedListSyntaxNode क्लास"
second_title: "Aspose.HTML Java के लिए API संदर्भ"
description: "com.aspose.html.toolkit.markdown.syntax.UnorderedListSyntaxNode क्लास। अनऑर्डर्ड सूची सिंटैक्स नोड का प्रतिनिधित्व करता है"
type: docs

url: /hi/java/com.aspose.html.toolkit.markdown.syntax/unorderedlistsyntaxnode/
---
## UnorderedListSyntaxNode class

अव्यवस्थित सूची सिंटैक्स नोड का प्रतिनिधित्व करें।
...
| नाम | विवरण |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/unorderedlistsyntaxnode/accept/)(MarkdownSyntaxVisitor) | सिंटैक्स के नोड्स का विज़िट करने के लिए इंटरफ़ेस को परिभाषित करता है। |
...
| [getMarker](../../com.aspose.html.toolkit.markdown.syntax/unorderedlistsyntaxnode/getmarker/)() | मार्कर को प्राप्त करने के लिए इंटरफ़ेस को परिभाषित करता है। |
