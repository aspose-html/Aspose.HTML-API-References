---
title: "ReferenceLinkSyntaxNode क्लास"
second_title: "Aspose.HTML Java के लिए API संदर्भ"
description: "com.aspose.html.toolkit.markdown.syntax.ReferenceLinkSyntaxNode क्लास। रेफ़रेंस लिंक सिंटैक्स को दर्शाता है"
type: docs

url: /hi/java/com.aspose.html.toolkit.markdown.syntax/referencelinksyntaxnode/
---
## ReferenceLinkSyntaxNode class

रेफ़रेंस लिंक सिंटैक्स का प्रतिनिधित्व करता है।
...
| नाम | विवरण |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/referencelinksyntaxnode/accept/)(MarkdownSyntaxVisitor) | विज़िटर को स्वीकार करने के लिए इंटरफ़ेस को परिभाषित करता है। |
...
| [getContent](../../com.aspose.html.toolkit.markdown.syntax/referencelinksyntaxnode/getcontent/)() | get content के लिए इंटरफ़ेस को परिभाषित करता है। |
| [getLabel](../../com.aspose.html.toolkit.markdown.syntax/referencelinksyntaxnode/getlabel/)() | लेबल प्राप्त करने के लिए इंटरफ़ेस को परिभाषित करता है। |
