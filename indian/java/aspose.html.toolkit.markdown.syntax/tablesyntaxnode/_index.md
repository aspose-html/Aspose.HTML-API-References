---
title: "TableSyntaxNode क्लास"
second_title: "Aspose.HTML Java के लिए API संदर्भ"
description: "com.aspose.html.toolkit.markdown.syntax.TableSyntaxNode क्लास। TableSyntax क्लास नोड"
type: docs

url: /hi/java/com.aspose.html.toolkit.markdown.syntax/tablesyntaxnode/
---
## TableSyntaxNode class

टेबलसिंटैक्स क्लास नोड।
...
| नाम | विवरण |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/tablesyntaxnode/accept/)(MarkdownSyntaxVisitor) | विज़िटर को स्वीकार करने के लिए इंटरफ़ेस को परिभाषित करता है। |
| [appendChild](../../com.aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/appendchild/)(MarkdownSyntaxNode) | चाइल्ड नोड जोड़ें। |
| [appendRow](../../com.aspose.html.toolkit.markdown.syntax/tablesyntaxnode/appendrow/)(TableRowSyntaxNode) | पंक्ति जोड़ने के लिए इंटरफ़ेस को परिभाषित करता है। |
| [childNodes](../../com.aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/childnodes/)() | चाइल्ड नोड्स का संग्रह प्राप्त करें। |
| [getAlignment](../../com.aspose.html.toolkit.markdown.syntax/tablesyntaxnode/getalignment/)() | aligment प्राप्त करने के लिए इंटरफ़ेस को परिभाषित करता है। |
| [getBodyRows](../../com.aspose.html.toolkit.markdown.syntax/tablesyntaxnode/getbodyrows/)() | बॉडी पंक्तियों को प्राप्त करने के लिए इंटरफ़ेस को परिभाषित करता है। |
| [getHeader](../../com.aspose.html.toolkit.markdown.syntax/tablesyntaxnode/getheader/)() | टेबल हेडर को प्राप्त करने के लिए इंटरफ़ेस को परिभाषित करता है। |
