---
title: "TaskListItemSyntaxNode क्लास"
second_title: "Aspose.HTML Java के लिए API संदर्भ"
description: "com.aspose.html.toolkit.markdown.syntax.TaskListItemSyntaxNode क्लास। टास्क लिस्ट आइटम सिंटैक्स नोड"
type: docs

url: /hi/java/com.aspose.html.toolkit.markdown.syntax/tasklistitemsyntaxnode/
---
## TaskListItemSyntaxNode class

टास्क लिस्ट आइटम सिंटैक्स नोड।
...
| नाम | विवरण |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/listitemsyntaxnode/accept/)(MarkdownSyntaxVisitor) | विज़िटर को स्वीकार करने के लिए इंटरफ़ेस को परिभाषित करता है। |
...
| [getLinesLeadingTrivia](../../com.aspose.html.toolkit.markdown.syntax/multilinecontainerblocksyntaxnode/getlinesleadingtrivia/)() | लाइन लीडिंग ट्रिविया प्राप्त करने के लिए इंटरफ़ेस को परिभाषित करता है। |
| [getMarker](../../com.aspose.html.toolkit.markdown.syntax/listitemsyntaxnode/getmarker/)() | मार्कर प्राप्त करें |
...
| [isChecked](../../com.aspose.html.toolkit.markdown.syntax/tasklistitemsyntaxnode/ischecked/)() | जाँच की स्थिति प्राप्त करने के लिए इंटरफ़ेस को परिभाषित करता है। |
| [isTight](../../com.aspose.html.toolkit.markdown.syntax/listitemsyntaxnode/istight/)() | यदि टाइट है तो true लौटाता है। |
