---
title: "ReferenceImageSyntaxNode क्लास"
second_title: "Aspose.HTML for Java API संदर्भ"
description: "com.aspose.html.toolkit.markdown.syntax.ReferenceImageSyntaxNode क्लास। रेफ़रेंस इमेज सिंटैक्स।"
type: docs

url: /hi/java/com.aspose.html.toolkit.markdown.syntax/referenceimagesyntaxnode/
---
## ReferenceImageSyntaxNode class

रेफ़रेंस इमेज सिंटैक्स.
...
| नाम | विवरण |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/referenceimagesyntaxnode/accept/)(MarkdownSyntaxVisitor) | विज़िटर को स्वीकार करने के लिए इंटरफ़ेस को परिभाषित करता है। |
...
| [getAltText](../../com.aspose.html.toolkit.markdown.syntax/referenceimagesyntaxnode/getalttext/)() | वैकल्पिक टेक्स्ट प्राप्त करने के लिए इंटरफ़ेस को परिभाषित करता है। |
| [getLabel](../../com.aspose.html.toolkit.markdown.syntax/referenceimagesyntaxnode/getlabel/)() | लेबल प्राप्त करने के लिए इंटरफ़ेस को परिभाषित करता है। |
