---
title: "EscapedCharacterSyntaxNode क्लास"
second_title: "Aspose.HTML Java के लिए API संदर्भ"
description: "com.aspose.html.toolkit.markdown.syntax.EscapedCharacterSyntaxNode क्लास। एस्केप कैरेक्टर सिंटैक्स नोड को लागू किया गया है"
type: docs

url: /hi/java/com.aspose.html.toolkit.markdown.syntax/escapedcharactersyntaxnode/
---
## EscapedCharacterSyntaxNode class

एस्केप कैरेक्टर सिंटैक्स नोड को लागू किया गया।
...
| [getSource](../../com.aspose.html.toolkit.markdown.syntax/textsyntaxnode/source/) स्रोत टेक्स्ट लौटाता है। |
| [getSpan](../../com.aspose.html.toolkit.markdown.syntax/textsyntaxnode/span/) स्पैन प्राप्त करने के लिए इंटरफ़ेस को परिभाषित करता है। |
| [getValue](../../com.aspose.html.toolkit.markdown.syntax/textsyntaxnode/value/) स्ट्रिंग वैल्यू प्राप्त करने के लिए प्रॉपर्टी को परिभाषित करता है। |

## विधियाँ

| नाम | विवरण |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/escapedcharactersyntaxnode/accept/)(MarkdownSyntaxVisitor) | विज़िटर को स्वीकार करने के लिए इंटरफ़ेस को परिभाषित करता है। |
