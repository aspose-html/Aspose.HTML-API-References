...
description: "com.aspose.html.dom.canvas.ICanvasRenderingContext2D इंटरफ़ेस। ICanvasRenderingContext2D इंटरफ़ेस का उपयोग कैनवास एलिमेंट पर आयत, टेक्स्ट, इमेज और अन्य ऑब्जेक्ट्स ड्रॉ करने के लिए किया जाता है। यह कैनवास एलिमेंट की ड्रॉइंग सतह के लिए 2D रेंडरिंग कॉन्टेक्स्ट प्रदान करता है"
type: docs
...
ICanvasRenderingContext2D इंटरफ़ेस आयत, पाठ, छवियों और अन्य ऑब्जेक्ट्स को कैनवास एलिमेंट पर ड्रॉ करने के लिए उपयोग किया जाता है। यह कैनवास एलिमेंट की ड्रॉइंग सतह के लिए 2D रेंडरिंग कॉन्टेक्स्ट प्रदान करता है।
...
| नाम | विवरण |
| --- | --- |
| [getCanvas](../../com.aspose.html.dom.canvas/icanvasrenderingcontext2d/canvas/) HTMLCanvasElement का एक रीड-ओनली बैक-रेफ़रेंस। यदि यह किसी कैनवास एलिमेंट से जुड़ा नहीं है तो यह null हो सकता है। |
[getFillStyle]
...
| [clearRect](../../com.aspose.html.dom.canvas/icanvasrenderingcontext2d/clearrect/)(double, double, double, double) | शुरुआती बिंदु (x, y) और आकार (width, height) द्वारा परिभाषित आयत में सभी पिक्सेल को ट्रांसपेरेंट ब्लैक सेट करता है, जिससे पहले से ड्रॉ किया गया कोई भी कंटेंट मिट जाता है। |
| [clip](../../com.aspose.html.dom.canvas/icanvasrenderingcontext2d/clip/#clip)() | नॉन-ज़ीरो विंडिंग नंबर नियम का उपयोग करके वर्तमान क्लिपिंग रीजन और पाथ द्वारा वर्णित क्षेत्र के इंटरसेक्शन की गणना करके एक नया क्लिपिंग रीजन बनाता है। क्लिपिंग रीजन की गणना करते समय खुले सबपाथ को अप्रत्यक्ष रूप से बंद किया जाना चाहिए, बिना वास्तविक सबपाथ को प्रभावित किए। नया क्लिपिंग रीजन वर्तमान क्लिपिंग रीजन को प्रतिस्थापित करता है। |
| [clip](../../com.aspose.html.dom.canvas/icanvasrenderingcontext2d/clip/#clip_1)(CanvasFillRule) | नॉन-ज़ीरो विंडिंग नंबर नियम का उपयोग करके वर्तमान क्लिपिंग रीजन और पाथ द्वारा वर्णित क्षेत्र के इंटरसेक्शन की गणना करके एक नया क्लिपिंग रीजन बनाता है। क्लिपिंग रीजन की गणना करते समय खुले सबपाथ को अप्रत्यक्ष रूप से बंद किया जाना चाहिए, बिना वास्तविक सबपाथ को प्रभावित किए। नया क्लिपिंग रीजन वर्तमान क्लिपिंग रीजन को प्रतिस्थापित करता है। |
| [clip](../../com.aspose.html.dom.canvas/icanvasrenderingcontext2d/clip/#clip_2)(Path2D, CanvasFillRule) | नॉन-ज़ीरो विंडिंग नंबर नियम का उपयोग करके वर्तमान क्लिपिंग रीजन और पाथ द्वारा वर्णित क्षेत्र के इंटरसेक्शन की गणना करके एक नया क्लिपिंग रीजन बनाता है। क्लिपिंग रीजन की गणना करते समय खुले सबपाथ को अप्रत्यक्ष रूप से बंद किया जाना चाहिए, बिना वास्तविक सबपाथ को प्रभावित किए। नया क्लिपिंग रीजन वर्तमान क्लिपिंग रीजन को प्रतिस्थापित करता है। |
| [createImageData](../../com.aspose.html.dom.canvas/icanvasrenderingcontext2d/createimagedata/#createimagedata)(IImageData) | निर्दिष्ट आयामों के साथ एक नया, खाली ImageData ऑब्जेक्ट बनाता है। नए ऑब्जेक्ट के सभी पिक्सेल ट्रांसपेरेंट ब्लैक होते हैं। |
| [createImageData](../../com.aspose.html.dom.canvas/icanvasrenderingcontext2d/createimagedata/#createimagedata_1)(double, double) | निर्दिष्ट आयामों के साथ एक नया, खाली ImageData ऑब्जेक्ट बनाता है। नए ऑब्जेक्ट के सभी पिक्सेल ट्रांसपेरेंट ब्लैक होते हैं। |
| [createLinearGradient](../../com.aspose.html.dom.canvas/icanvasrenderingcontext2d/createlineargradient/)(double, double, double, double) | पैरामीटर द्वारा दर्शाए गए निर्देशांक वाली रेखा के साथ एक रैखिक ग्रेडिएंट बनाता है। |
| [createPattern](../../com.aspose.html.dom.canvas/icanvasrenderingcontext2d/createpattern/#createpattern)(HTMLCanvasElement, String) | निर्दिष्ट इमेज (CanvasImageSource) का उपयोग करके एक पैटर्न बनाता है। यह स्रोत को रिपीटेशन आर्ग्यूमेंट द्वारा निर्दिष्ट दिशाओं में दोहराता है। |
| [createPattern](../../com.aspose.html.dom.canvas/icanvasrenderingcontext2d/createpattern/#createpattern_1)(HTMLImageElement, String) | निर्दिष्ट इमेज (CanvasImageSource) का उपयोग करके एक पैटर्न बनाता है। यह स्रोत को रिपीटेशन आर्ग्यूमेंट द्वारा निर्दिष्ट दिशाओं में दोहराता है। |
| [createRadialGradient](../../com.aspose.html.dom.canvas/icanvasrenderingcontext2d/createradialgradient/)(double, double, double, double, double, double) | पैरामीटर द्वारा दर्शाए गए दो वृत्तों के निर्देशांक के आधार पर एक रेडियल ग्रेडिएंट बनाता है। |
| [drawFocusIfNeeded](../../com.aspose.html.dom.canvas/icanvasrenderingcontext2d/drawfocusifneeded/)(Element) | यदि कोई दिया गया तत्व फोकस किया गया है, तो यह मेथड वर्तमान पथ के चारों ओर फोकस रिंग बनाता है। |
...
| [fillRect](../../com.aspose.html.dom.canvas/icanvasrenderingcontext2d/fillrect/)(double, double, double, double) | (x, y) स्थिति पर एक भरा हुआ आयत ड्रॉ करता है जिसकी आकार चौड़ाई और ऊँचाई द्वारा निर्धारित होती है। |
| [fillText](../../com.aspose.html.dom.canvas/icanvasrenderingcontext2d/filltext/#filltext)(String, double, double) | दिए गए (x,y) स्थिति पर एक निर्दिष्ट पाठ को ड्रॉ (भर) करता है। |
| [fillText](../../com.aspose.html.dom.canvas/icanvasrenderingcontext2d/filltext/#filltext_1)(String, double, double, double) | दिए गए (x,y) स्थिति पर एक निर्दिष्ट पाठ को ड्रॉ (भर) करता है। |
...
| [putImageData](../../com.aspose.html.dom.canvas/icanvasrenderingcontext2d/putimagedata/#putimagedata)(IImageData, double, double) | दिए गए ImageData ऑब्जेक्ट से डेटा को बिटमैप पर पेंट करता है। यदि एक डर्टी आयत प्रदान की जाती है, तो केवल उस आयत के पिक्सेल पेंट होते हैं। यह मेथड कैनवास ट्रांसफ़ॉर्मेशन मैट्रिक्स से प्रभावित नहीं होता। |
| [putImageData](../../com.aspose.html.dom.canvas/icanvasrenderingcontext2d/putimagedata/#putimagedata_1)(IImageData, double, double, double, double, double, double) | दिए गए ImageData ऑब्जेक्ट से डेटा को बिटमैप पर पेंट करता है। यदि एक डर्टी आयत प्रदान की जाती है, तो केवल उस आयत के पिक्सेल पेंट होते हैं। यह मेथड कैनवास ट्रांसफ़ॉर्मेशन मैट्रिक्स से प्रभावित नहीं होता। |
| [removeHitRegion](../../com.aspose.html.dom.canvas/icanvasrenderingcontext2d/removehitregion/)(String) | निर्दिष्ट आईडी वाले हिट रीजन को कैनवास से हटाता है। |
...
| [restore](../../com.aspose.html.dom.canvas/icanvasrenderingcontext2d/restore/)() | ड्रॉइंग स्टाइल की स्थिति को 'state stack' में save() द्वारा सहेजे गए अंतिम तत्व पर पुनर्स्थापित करता है। |
| [rotate](../../com.aspose.html.dom.canvas/icanvasrenderingcontext2d/rotate/)(double) | ट्रांसफ़ॉर्मेशन मैट्रिक्स में एक रोटेशन जोड़ता है। एंगल आर्ग्यूमेंट घड़ी की दिशा में रोटेशन एंगल को दर्शाता है और इसे रेडियन में व्यक्त किया जाता है। |
| [save](../../com.aspose.html.dom.canvas/icanvasrenderingcontext2d/save/)() | स्टैक का उपयोग करके वर्तमान ड्रॉइंग स्टाइल की स्थिति को सहेजता है ताकि आप restore() द्वारा किए गए किसी भी परिवर्तन को वापस कर सकें। |
...
| [strokeRect](../../com.aspose.html.dom.canvas/icanvasrenderingcontext2d/strokerect/)(double, double, double, double) | (x, y) पर प्रारंभिक बिंदु वाला एक आयत पेंट करता है जिसकी चौड़ाई w और ऊँचाई h है, इसे कैनवास पर वर्तमान स्ट्रोक स्टाइल का उपयोग करके लागू करता है। |
| [strokeText](../../com.aspose.html.dom.canvas/icanvasrenderingcontext2d/stroketext/#stroketext)(String, double, double) | दिए गए (x, y) स्थिति पर एक निर्दिष्ट पाठ को ड्रॉ (स्ट्रोक) करता है। |
| [strokeText](../../com.aspose.html.dom.canvas/icanvasrenderingcontext2d/stroketext/#stroketext_1)(String, double, double, double?) | दिए गए (x, y) स्थिति पर एक निर्दिष्ट पाठ को ड्रॉ (स्ट्रोक) करता है। |
...
| [translate](../../com.aspose.html.dom.canvas/icanvasrenderingcontext2d/translate/)(double, double) | कैनवास और उसके मूल बिंदु को x क्षैतिज और y लंबवत ग्रिड पर ले जाकर एक ट्रांसलेशन ट्रांसफ़ॉर्मेशन जोड़ता है। |
