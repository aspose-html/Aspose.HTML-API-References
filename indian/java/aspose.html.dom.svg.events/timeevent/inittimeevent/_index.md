...
description: "TimeEvent मेथड। initTimeEvent मेथड का उपयोग DocumentEvent इंटरफ़ेस के माध्यम से निर्मित TimeEvent के मान को प्रारंभ करने के लिए किया जाता है। यह मेथड केवल तब बुलाया जा सकता है जब TimeEvent को dispatchEvent मेथड के द्वारा डिस्पैच किया जाना बाकी हो, हालांकि आवश्यक होने पर इस चरण के दौरान इसे कई बार बुलाया जा सकता है। यदि कई बार बुलाया जाता है तो अंतिम कॉल को प्राथमिकता दी जाती है।"
type: docs
...
| पैरामीटर | टाइप | विवरण |
| --- | --- | --- |
| typeArg | String | इवेंट प्रकार निर्दिष्ट करता है। |
| viewArg | IAbstractView | इवेंट का AbstractView निर्दिष्ट करता है। |
