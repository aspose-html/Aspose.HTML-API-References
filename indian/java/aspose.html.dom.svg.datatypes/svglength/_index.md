...
description: "com.aspose.html.dom.svg.datatypes.SVGLength क्लास। SVGLength इंटरफ़ेस लंबाई के बुनियादी डेटा प्रकार के अनुरूप है। एक SVGLength ऑब्जेक्ट को केवल-पढ़ने योग्य के रूप में निर्धारित किया जा सकता है, जिसका अर्थ है कि ऑब्जेक्ट को संशोधित करने के प्रयास नीचे वर्णित अनुसार एक अपवाद उत्पन्न करेंगे"
type: docs
...
| नाम | विवरण |
| --- | --- |
| [getUnitType](../../com.aspose.html.dom.svg.datatypes/svglength/unittype/) मान का प्रकार जैसा कि इस इंटरफ़ेस पर परिभाषित SVG_LENGTHTYPE_* स्थिरांक में से एक द्वारा निर्दिष्ट किया गया है। |
[getValue]
...
| नाम | विवरण |
| --- | --- |
| [convertToSpecifiedUnits](../../com.aspose.html.dom.svg.datatypes/svglength/converttospecifiedunits/)(ushort) | एक ही अंतर्निहित संग्रहीत मान को बनाए रखें, लेकिन संग्रहीत इकाई पहचानकर्ता को दिए गए unitType पर रीसेट करें। इस विधि के परिणामस्वरूप ऑब्जेक्ट एट्रिब्यूट्स unitType, valueInSpecifiedUnits और valueAsString संशोधित हो सकते हैं। उदाहरण के लिए, यदि मूल मान "0.5cm" था और विधि को मिलीमीटर में बदलने के लिए बुलाया गया, तो unitType को SVG_LENGTHTYPE_MM में बदल दिया जाएगा, valueInSpecifiedUnits को संख्यात्मक मान 5 में बदल दिया जाएगा और valueAsString को "5mm" में बदल दिया जाएगा। |
...
| [newValueSpecifiedUnits](../../com.aspose.html.dom.svg.datatypes/svglength/newvaluespecifiedunits/)(ushort, float) | मान को एक संख्या के रूप में रीसेट करें जिसमें संबंधित unitType हो, इस प्रकार ऑब्जेक्ट के सभी गुणों के मान बदल दिए जाते हैं। |
...
| const [SVG_LENGTHTYPE_NUMBER](../../com.aspose.html.dom.svg.datatypes/svglength/svg_lengthtype_number/) | कोई इकाई प्रकार प्रदान नहीं किया गया (अर्थात, एक इकाई‑रहित मान निर्दिष्ट किया गया), जो उपयोगकर्ता इकाइयों में मान दर्शाता है। |
...
| const [SVG_LENGTHTYPE_UNKNOWN](../../com.aspose.html.dom.svg.datatypes/svglength/svg_lengthtype_unknown/) | इकाई प्रकार पूर्वनिर्धारित इकाई प्रकारों में से नहीं है। इस प्रकार का नया मान परिभाषित करने या मौजूदा मान को इस प्रकार में बदलने का प्रयास करना अमान्य है। |
