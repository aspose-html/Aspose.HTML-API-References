---
title: "SVGTransformList क्लास"
second_title: "Aspose.HTML Java के लिए API संदर्भ"
description: "com.aspose.html.dom.svg.datatypes.SVGTransformList class. यह इंटरफ़ेस SVGTransform वस्तुओं की एक सूची को परिभाषित करता है।"
type: docs

url: /hi/java/com.aspose.html.dom.svg.datatypes/svgtransformlist/
---
## SVGTransformList class

यह इंटरफ़ेस SVGTransform ऑब्जेक्ट्स की एक सूची को परिभाषित करता है।
...
| नाम | विवरण |
| --- | --- |
| [SVGTransformList](svgtransformlist/#constructor)() | `SVGTransformList` क्लास का एक नया उदाहरण प्रारंभ करता है। |
| [SVGTransformList](svgtransformlist/#constructor_1)(IEnumerable&lt;SVGTransform&gt;) | `SVGTransformList` क्लास का एक नया उदाहरण प्रारंभ करता है। |
...
| [toString](../../com.aspose.html.dom.svg.datatypes/svgtransformlist/toString/)() | इस उदाहरण का प्रतिनिधित्व करने वाली स्ट्रिंग लौटाता है। |
