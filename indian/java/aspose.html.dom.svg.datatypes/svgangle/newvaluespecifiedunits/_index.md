...
description: "SVGAngle मेथड। मान को एक संख्या के रूप में रीसेट करें जिसमें संबंधित unitType हो, इस प्रकार ऑब्जेक्ट के सभी एट्रीब्यूट्स के मानों को प्रतिस्थापित किया जाता है।"
type: docs
...
| --- | --- | --- |
| newUnitType | UInt16 | मान के लिए यूनिट टाइप (उदाहरण के लिए, SVG_ANGLETYPE_DEG)। |
