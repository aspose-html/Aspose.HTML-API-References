...
description: "com.aspose.html.window.MediaQueryList class. MediaQueryList ऑब्जेक्ट दस्तावेज़ पर लागू मीडिया क्वेरी की जानकारी संग्रहीत करता है, जिसमें दस्तावेज़ की स्थिति के विरुद्ध तत्काल और इवेंट-ड्रिवेन मिलान दोनों का समर्थन शामिल है। देखें CSSOM View Module विनिर्देशन https//www.w3.org/TR/cssom-view/the-mediaquerylist-interface"
type: docs
...
| नाम | विवरण |
| --- | --- |
| [getDocument](../../com.aspose.html.window/mediaquerylist/document/) संदर्भ ऑब्जेक्ट का संबंधित दस्तावेज़। |
...
| [getMedia](../../com.aspose.html.window/mediaquerylist/media/) एक स्ट्रिंग जो सीरियलाइज़्ड मीडिया क्वेरी का प्रतिनिधित्व करती है। |
...
| नाम | विवरण |
| --- | --- |
| event [OnChange](../../com.aspose.html.window/mediaquerylist/onchange/) | इवेंट जो MediaQueryList पर तब फायर होता है जब मैच स्थिति बदलती है। |
