...
description: "com.aspose.html.dom.css.ICSS2Properties इंटरफ़ेस। CSS2Properties इंटरफ़ेस CSSStyleDeclaration के भीतर प्रॉपर्टी प्राप्त करने और सेट करने के लिए एक सुविधाजनक तंत्र का प्रतिनिधित्व करता है। इस इंटरफ़ेस के एट्रिब्यूट CSS2 में निर्दिष्ट सभी प्रॉपर्टी के अनुरूप होते हैं। इस इंटरफ़ेस का एट्रिब्यूट प्राप्त करना CSSStyleDeclaration इंटरफ़ेस की getPropertyValue मेथड को कॉल करने के बराबर है। इस इंटरफ़ेस का एट्रिब्यूट सेट करना CSSStyleDeclaration इंटरफ़ेस की setProperty मेथड को कॉल करने के बराबर है।"
type: docs
...
CSS2Properties इंटरफ़ेस CSSStyleDeclaration के भीतर प्रॉपर्टी प्राप्त करने और सेट करने के लिए एक सुविधाजनक तंत्र का प्रतिनिधित्व करता है। इस इंटरफ़ेस के एट्रिब्यूट CSS2 में निर्दिष्ट सभी प्रॉपर्टी के अनुरूप होते हैं। इस इंटरफ़ेस का एट्रिब्यूट प्राप्त करना [`CSSStyleDeclaration`](../icssstyledeclaration/) इंटरफ़ेस की getPropertyValue मेथड को कॉल करने के बराबर है। इस इंटरफ़ेस का एट्रिब्यूट सेट करना [`CSSStyleDeclaration`](../icssstyledeclaration/) इंटरफ़ेस की setProperty मेथड को कॉल करने के बराबर है।
