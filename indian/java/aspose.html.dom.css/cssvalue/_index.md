...
description: "com.aspose.html.dom.css.CSSValue क्लास। एक सरल या जटिल मान का प्रतिनिधित्व करता है। एक CSSValue ऑब्जेक्ट केवल CSS प्रॉपर्टी के संदर्भ में ही प्रकट होता है।"
type: docs
...
एक सरल या जटिल मान का प्रतिनिधित्व करता है। CSSValue ऑब्जेक्ट केवल CSS प्रॉपर्टी के संदर्भ में ही प्रकट होता है।
...
| const [CSS_PRIMITIVE_VALUE](../../com.aspose.html.dom.css/cssvalue/css_primitive_value/) | मान एक प्रिमिटिव मान है और CSSPrimitiveValue इंटरफ़ेस का एक इंस्टेंस इस CSSValue इंटरफ़ेस के इस इंस्टेंस पर बाइंडिंग-विशिष्ट कास्टिंग विधियों का उपयोग करके प्राप्त किया जा सकता है। |
| const [CSS_VALUE_LIST](../../com.aspose.html.dom.css/cssvalue/css_value_list/) | यह मान एक CSSValue सूची है और CSSValueList इंटरफ़ेस का एक उदाहरण इस CSSValue इंटरफ़ेस के इस उदाहरण पर बाइंडिंग-विशिष्ट कास्टिंग विधियों का उपयोग करके प्राप्त किया जा सकता है। |
