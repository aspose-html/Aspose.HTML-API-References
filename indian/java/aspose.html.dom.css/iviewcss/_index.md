...
description: "com.aspose.html.dom.css.IViewCSS इंटरफ़ेस। IViewCSS इंटरफ़ेस Window ऑब्जेक्ट का एक विस्तार दर्शाता है जो किसी तत्व की सभी CSS प्रॉपर्टीज़ के मानों तक पहुंच प्रदान करता है।"
type: docs
...
IViewCSS इंटरफ़ेस Window वस्तु का एक विस्तार दर्शाता है जो किसी तत्व की सभी CSS गुणों के मानों तक पहुँच प्रदान करता है।

किसी दिए गए तत्व की CSS स्टाइल को IViewCSS.GetComputedStyle() मेथड का उपयोग करके प्राप्त किया जा सकता है।
