...
CSSKeyframeRule इंटरफ़ेस की name प्रॉपर्टी एनीमेशन-नाम प्रॉपर्टी द्वारा उपयोग किए गए एनीमेशन के नाम को प्राप्त और सेट करती है।
...
| [deleteRule](../../com.aspose.html.dom.css/icsskeyframesrule/deleterule/)(String) | deleteRule मेथड पास किए गए कुंजी के साथ मौजूद [`CSSKeyframeRule`](../icsskeyframerule/) को हटाता है। यदि इस कुंजी वाला कोई नियम मौजूद नहीं है, तो मेथड कुछ नहीं करता। |
| [findRule](../../com.aspose.html.dom.css/icsskeyframesrule/findrule/)(String) | findRule मेथड पास किए गए कुंजी से मेल खाने वाले नियम को लौटाता है। यदि ऐसा कोई नियम नहीं है, तो null मान लौटाया जाता है। |
