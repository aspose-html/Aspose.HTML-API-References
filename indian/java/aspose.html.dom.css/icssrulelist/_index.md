...
[`CSSRule`](../icssrule/) ऑब्जेक्ट्स द्वारा लौटाए गए अंतर्निहित नियमों को संपादित करने के लिए, CSSStyleSheet.insertRule() और CSSStyleSheet.deleteRule() का उपयोग करें, जो [`CSSStyleSheet`](../icssstylesheet/) की विधियाँ हैं।
...
| नाम | विवरण |
| --- | --- |
| [getItem](../../com.aspose.html.dom.css/icssrulelist/item/) मेथड item() (http://www.w3.org/TR/DOM-Level-2-Style/css.html#CSS-CSSRuleList) द्वारा एक CSS नियम प्राप्त करने के लिए उपयोग किया जाता है। इस संग्रह में क्रम CSS स्टाइल शीट में नियमों के क्रम को दर्शाता है। यदि इंडेक्स सूची में नियमों की संख्या के बराबर या उससे बड़ा है, तो यह null लौटाता है। |
