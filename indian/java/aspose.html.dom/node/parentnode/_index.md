...
एक Node जो वर्तमान नोड का पैरेंट है। किसी तत्व का पैरेंट एक [`Element`](../../element/) नोड, एक [`Document`](../../document/) नोड, या एक [`DocumentFragment`](../../documentfragment/) नोड होता है।
