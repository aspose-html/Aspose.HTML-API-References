...
description: "Node फ़ील्ड। एक Element या Attr के भीतर वास्तविक टेक्स्ट।"
type: docs

url: /hi/java/com.aspose.html.dom/node/text_node/
---
## Node.TEXT_NODE field

वास्तविक [`Text`](../../text/) जो एक [`Element`](../../element/) या [`Attr`](../../attr/) के भीतर है।
