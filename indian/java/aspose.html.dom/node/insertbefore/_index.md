...
insertBefore() मेथड Node इंटरफ़ेस का यह निर्दिष्ट पैरेंट नोड के एक रेफ़रेंस नोड से पहले एक नोड को बच्चे के रूप में डालता है।

यदि दिया गया नोड दस्तावेज़ में पहले से मौजूद है, तो insertBefore() उसे उसकी वर्तमान स्थिति से नई स्थिति में ले जाता है। (अर्थात, इसे निर्दिष्ट नए पैरेंट में जोड़ने से पहले अपने मौजूदा पैरेंट से स्वचालित रूप से हटा दिया जाएगा।)
