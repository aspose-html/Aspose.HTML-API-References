...
Node इंटरफ़ेस की removeChild() विधि DOM से एक चाइल्ड नोड हटाती है और हटाए गए नोड को लौटाती है।

नोट: जब तक हटाए गए चाइल्ड पर एक रेफ़रेंस रखा जाता है, वह मेमोरी में मौजूद रहता है, लेकिन अब DOM का हिस्सा नहीं रहता। इसे कोड में बाद में फिर से उपयोग किया जा सकता है। यदि removeChild() का रिटर्न वैल्यू संग्रहीत नहीं किया जाता, और कोई अन्य रेफ़रेंस नहीं रखा जाता, तो यह थोड़े समय बाद स्वचालित रूप से मेमोरी से हटा दिया जाएगा।
