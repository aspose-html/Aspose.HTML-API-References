...
description: "com.aspose.html.dom.Text क्लास। Text इंटरफ़ेस CharacterData से विरासत में मिलता है और Element या Attr के XML में वर्ण डेटा कहलाने वाली पाठ्य सामग्री को दर्शाता है।"
type: docs

url: /hi/java/com.aspose.html.dom/text/
---
## Text class

Text इंटरफ़ेस CharacterData से विरासत में मिलता है और एक Element या Attr की पाठ्य सामग्री (XML में इसे character data कहा जाता है) का प्रतिनिधित्व करता है।
...
| [getLength](../../com.aspose.html.dom/characterdata/length/) डेटा और नीचे दिए गए subStringData मेथड के माध्यम से उपलब्ध 16‑bit इकाइयों की संख्या। यह शून्य भी हो सकती है, अर्थात् CharacterData नोड्स खाली हो सकते हैं। |
...
| [getNodeName](../../com.aspose.html.dom/text/nodename/) इस नोड का नाम, उसके प्रकार पर निर्भर करता है। |
| [getNodeType](../../com.aspose.html.dom/text/nodetype/) अंतर्निहित ऑब्जेक्ट के प्रकार को दर्शाने वाला कोड। |
...
| [textContent](../../com.aspose.html.dom/text/textcontent/) { get; set; } | यह एट्रिब्यूट इस नोड और उसके वंशजों की टेक्स्ट सामग्री लौटाता है। जब इसे null पर परिभाषित किया जाता है, तो इसे सेट करने का कोई प्रभाव नहीं पड़ता। सेट करने पर, इस नोड के सभी संभावित चाइल्ड हटाए जाते हैं और यदि नया स्ट्रिंग खाली या null नहीं है, तो इसे एकल Text नोड से प्रतिस्थापित किया जाता है जिसमें वह स्ट्रिंग होती है जिसे इस एट्रिब्यूट को सेट किया गया है। |
| [getWholeText](../../com.aspose.html.dom/text/wholetext/) इस नोड के तर्कसंगत रूप से सटे हुए Text नोड्स के सभी टेक्स्ट को दस्तावेज़ क्रम में जोड़कर लौटाता है। |
...
| [deleteData](../../com.aspose.html.dom/characterdata/deletedata/)(int, int) | नोड से 16‑bit इकाइयों की एक रेंज हटाएँ। |
...
| [insertData](../../com.aspose.html.dom/characterdata/insertdata/)(int, String) | निर्दिष्ट 16‑bit इकाई ऑफ़सेट पर स्ट्रिंग डालें। |
...
| [replaceData](../../com.aspose.html.dom/characterdata/replacedata/)(int, int, String) | निर्दिष्ट 16‑bit इकाई ऑफ़सेट से शुरू होने वाले अक्षरों को निर्दिष्ट स्ट्रिंग से बदलें। |
| [replaceWholeText](../../com.aspose.html.dom/text/replacewholetext/)(String) | वर्तमान नोड और सभी तार्किक‑सन्निहित टेक्स्ट नोड्स के टेक्स्ट को निर्दिष्ट टेक्स्ट से बदलता है। सभी तार्किक‑सन्निहित टेक्स्ट नोड्स हटाए जाते हैं, जिसमें वर्तमान नोड भी शामिल है जब तक कि वह प्रतिस्थापन टेक्स्ट का प्राप्तकर्ता न हो। |
| [splitText](../../com.aspose.html.dom/text/splittext/)(int) | इस नोड को निर्दिष्ट ऑफ़सेट पर दो नोड्स में विभाजित करता है, दोनों को पेड़ में भाई‑बहन के रूप में रखता है। |
| [subStringData](../../com.aspose.html.dom/characterdata/subStringdata/)(int, int) | नोड से डेटा की एक सीमा निकालता है। |
