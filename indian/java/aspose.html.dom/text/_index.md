...
description: "com.aspose.html.dom.Text क्लास। The Text इंटरफ़ेस CharacterData से विरासत में मिलता है और Element या Attr के XML में वर्ण डेटा कहलाने वाली पाठ्य सामग्री का प्रतिनिधित्व करता है।"
type: docs
...
Text इंटरफ़ेस CharacterData से विरासत में मिलता है और एक Element या Attr की पाठ्य सामग्री (XML में इसे character data कहा जाता है) को दर्शाता है।
