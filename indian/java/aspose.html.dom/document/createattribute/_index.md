...
Document.createAttribute() मेथड एक नया एट्रिब्यूट नोड बनाता है, और उसे लौटाता है। यह ऑब्जेक्ट [`Attr`](../../attr/) इंटरफ़ेस को लागू करने वाला नोड बनाता है। DOM यह निर्धारित नहीं करता कि इस प्रकार किसी विशेष एलिमेंट में कौन‑से एट्रिब्यूट जोड़े जा सकते हैं।
