...
description: "Document मेथड। दिए गए पैकेज से संबंधित निर्दिष्ट टैग नाम वाले एलिमेंट्स की सूची लौटाता है। पूर्ण दस्तावेज़ को रूट नोड सहित खोजा जाता है।"
type: docs
...
दिए गए पैकेज से संबंधित दिए गए टैग नाम वाले तत्वों की सूची लौटाता है। पूरी दस्तावेज़, जिसमें रूट नोड भी शामिल है, खोजी जाती है।
...
| --- | --- | --- |
| packageURI | String | खोजे जाने वाले एलिमेंट्स का पैकेज URI। |
| localName | String | या तो तत्वों के खोजे जाने वाले स्थानीय नाम या विशेष मान *, जो सभी तत्वों से मेल खाता है। |

### रिटर्न वैल्यू

एक लाइव [`NodeList`](../../../com.aspose.html.collections/nodelist/) (लेकिन नीचे नोट देखें) पाए गए तत्वों का क्रम जिसमें वे पेड़ में प्रकट होते हैं।
