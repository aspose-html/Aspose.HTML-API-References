...
description: "Element method. दस्तावेज़ क्रम में दिए गए स्थानीय नाम और पैकेज URI स्ट्रिंग वाले सभी तत्वों को शामिल करने वाला HTMLCollection ऑब्जेक्ट लौटाता है।"
type: docs
...
डॉक्यूमेंट क्रम में दिए गए स्थानीय नाम और पैकेज URI स्ट्रिंग वाले सभी [`elements`](../) को शामिल करने वाला [`HTMLCollection`](../../../com.aspose.html.collections/htmlcollection/) ऑब्जेक्ट लौटाता है।
...
कस्टम पैकेज कस्टम टैग कंटेंट यहाँ जाता है...
