...
description: "com.aspose.html.dom.Attr क्लास। Attr इंटरफ़ेस एक Element ऑब्जेक्ट में एक गुण (attribute) का प्रतिनिधित्व करता है। सामान्यतः इस गुण के स्वीकार्य मान दस्तावेज़ से जुड़े स्कीमा में परिभाषित होते हैं।"
type: docs
...
| [getLocalName](../../com.aspose.html.dom/attr/localname/) इस नोड के योग्य नाम (qualified name) का स्थानीय भाग लौटाता है। ELEMENT_NODE और ATTRIBUTE_NODE के अलावा किसी भी प्रकार के नोड्स और DOM Level 1 विधि जैसे Document.createElement() से निर्मित नोड्स के लिए यह हमेशा null रहता है। |
| [getName](../../com.aspose.html.dom/attr/name/) इस गुण (attribute) का नाम लौटाता है। |
...
| [getNodeType](../../com.aspose.html.dom/attr/nodetype/) अंतर्निहित वस्तु के प्रकार को दर्शाने वाला कोड। |
