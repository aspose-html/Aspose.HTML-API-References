...
description: "com.aspose.html.dom.Attr क्लास। Attr इंटरफ़ेस एक Element ऑब्जेक्ट में एक गुण को दर्शाता है। सामान्यतः इस गुण के अनुमत मान दस्तावेज़ से जुड़े स्कीमा में परिभाषित होते हैं।"
type: docs

url: /hi/java/com.aspose.html.dom/attr/
---
## Attr class

Attr इंटरफ़ेस एक Element ऑब्जेक्ट में एट्रिब्यूट का प्रतिनिधित्व करता है। सामान्यतः एट्रिब्यूट के अनुमत मान दस्तावेज़ से जुड़े स्कीमा में परिभाषित होते हैं।
...
| [getLocalName](../../com.aspose.html.dom/attr/localname/) इस नोड के योग्य नाम का स्थानीय भाग लौटाता है। ELEMENT_NODE और ATTRIBUTE_NODE के अलावा किसी भी प्रकार के नोड और DOM Level 1 विधि जैसे Document.createElement() से निर्मित नोड के लिए यह हमेशा null रहता है। |
| [getName](../../com.aspose.html.dom/attr/name/) इस गुण का नाम लौटाता है। |
| [getNamespaceURI](../../com.aspose.html.dom/attr/packageuri/) इस नोड का पैकेज URI, या यदि निर्दिष्ट नहीं है तो null। |
...
| [getNodeName](../../com.aspose.html.dom/attr/nodename/) इस नोड का नाम, उसके प्रकार पर निर्भर करता है। |
| [getNodeType](../../com.aspose.html.dom/attr/nodetype/) अंतर्निहित ऑब्जेक्ट के प्रकार को दर्शाने वाला कोड। |
| [nodeValue](../../com.aspose.html.dom/attr/nodevalue/) { get; set; } | इस नोड का मान, उसके प्रकार पर निर्भर करता है। |
...
| [getOwnerElement](../../com.aspose.html.dom/attr/ownerelement/) वह Element नोड जिससे यह गुण जुड़ा है, या यदि यह गुण उपयोग में नहीं है तो null। |
...
| [getPrefix](../../com.aspose.html.dom/attr/prefix/) इस नोड का पैकेज प्रीफ़िक्स, या यदि निर्दिष्ट नहीं है तो null। जब इसे null पर सेट किया जाता है, तो इसका कोई प्रभाव नहीं पड़ता। |
...
| [getSpecified](../../com.aspose.html.dom/attr/specified/) यदि इस गुण को उदाहरण दस्तावेज़ में स्पष्ट रूप से मान दिया गया हो तो true, अन्यथा false। |
| [textContent](../../com.aspose.html.dom/attr/textcontent/) { get; set; } | यह एट्रिब्यूट इस नोड और उसके वंशजों की टेक्स्ट सामग्री लौटाता है। जब इसे null पर परिभाषित किया जाता है, तो इसे सेट करने का कोई प्रभाव नहीं पड़ता। सेट करने पर, इस नोड के सभी संभावित चाइल्ड हटाए जाते हैं और यदि नया स्ट्रिंग खाली या null नहीं है, तो इसे एकल Text नोड से प्रतिस्थापित किया जाता है जिसमें वह स्ट्रिंग होती है जिसे इस एट्रिब्यूट को सेट किया गया है। |
[getValue]
