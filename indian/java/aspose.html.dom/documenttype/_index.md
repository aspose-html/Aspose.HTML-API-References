---
title: "DocumentType क्लास"
second_title: "Aspose.HTML for Java API संदर्भ"
description: "com.aspose.html.dom.DocumentType क्लास। यह DocumentType दस्तावेज़ के लिए परिभाषित इकाइयों की सूची के लिए एक इंटरफ़ेस प्रदान करता है।"
type: docs

url: /hi/java/com.aspose.html.dom/documenttype/
---
## DocumentType class

DocumentType दस्तावेज़ के लिए परिभाषित इकाइयों की सूची के लिए एक इंटरफ़ेस प्रदान करता है।
...
| नाम | विवरण |
| --- | --- |
| [DocumentType](documenttype/)(String, String, String, String, Document) | `DocumentType` क्लास का एक नया उदाहरण प्रारंभ करता है। |
...
| [getInternalSubset](../../com.aspose.html.dom/documenttype/internalsubset/) आंतरिक उपसमुच्चय को स्ट्रिंग के रूप में, या यदि नहीं है तो null। |
...
| [getName](../../com.aspose.html.dom/documenttype/name/) DTD का नाम; अर्थात्, DOCTYPE कुंजीशब्द के तुरंत बाद आने वाला नाम। |
...
| [getNodeName](../../com.aspose.html.dom/documenttype/nodename/) इस नोड का नाम, उसके प्रकार के आधार पर। |
| [getNodeType](../../com.aspose.html.dom/documenttype/nodetype/) अंतर्निहित वस्तु के प्रकार को दर्शाने वाला कोड। |
...
| [getPublicId](../../com.aspose.html.dom/documenttype/publicid/) बाहरी उपसमुच्चय का सार्वजनिक पहचानकर्ता। |
| [getSystemId](../../com.aspose.html.dom/documenttype/systemid/) बाहरी उपसमुच्चय का सिस्टम पहचानकर्ता। यह एक पूर्ण URI हो सकता है या नहीं। |
...
| [toString](../../com.aspose.html.dom/documenttype/toString/)() | इस उदाहरण का प्रतिनिधित्व करने वाली स्ट्रिंग लौटाता है। |
