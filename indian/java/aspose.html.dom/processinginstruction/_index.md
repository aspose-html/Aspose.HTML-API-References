...
description: "com.aspose.html.dom.ProcessingInstruction क्लास। ProcessingInstruction XML में उपयोग की जाने वाली प्रोसेसर-विशिष्ट जानकारी को दस्तावेज़ के पाठ में रखने का तरीका है।"
type: docs
...
ProcessingInstruction एक "प्रोसेसिंग इंस्ट्रक्शन" का प्रतिनिधित्व करता है, जो XML में दस्तावेज़ के टेक्स्ट में प्रोसेसर-विशिष्ट जानकारी रखने का तरीका है।
...
| [getNodeName](../../com.aspose.html.dom/processinginstruction/nodename/) इस नोड का नाम, उसके प्रकार के आधार पर। |
| [getNodeType](../../com.aspose.html.dom/processinginstruction/nodetype/) अंतर्निहित वस्तु के प्रकार को दर्शाने वाला कोड। |
