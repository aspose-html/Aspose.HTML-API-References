---
title: "CharacterData क्लास"
second_title: "Aspose.HTML for Java API संदर्भ"
description: "com.aspose.html.dom.CharacterData क्लास। यह CharacterData Node को विस्तारित करता है जिसमें DOM में कैरेक्टर डेटा तक पहुँचने के लिए गुणों और विधियों का सेट होता है।"
type: docs

url: /hi/java/com.aspose.html.dom/characterdata/
---
## CharacterData class

CharacterData, Node को उन एट्रिब्यूट्स और मेथड्स के सेट के साथ विस्तारित करता है जो DOM में कैरेक्टर डेटा तक पहुँच प्रदान करते हैं।
