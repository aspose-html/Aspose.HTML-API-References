...
description: "com.aspose.html.dom.CharacterData class. CharacterData Node को विस्तारित करता है और DOM में कैरेक्टर डेटा तक पहुँचने के लिए गुणों और विधियों का एक सेट प्रदान करता है।"
type: docs
...
CharacterData, Node को DOM में कैरेक्टर डेटा तक पहुँचने के लिए एट्रिब्यूट्स और मेथड्स के सेट के साथ विस्तारित करता है।
