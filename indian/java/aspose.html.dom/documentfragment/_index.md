...
DocumentFragment एक "हल्का" या "न्यूनतम" Document ऑब्जेक्ट है। यह बहुत सामान्य है कि आप दस्तावेज़ के ट्री का एक भाग निकालना या नया फ्रैगमेंट बनाना चाहें।
...
| [replaceChild](../../com.aspose.html.dom/node/replacechild/)(Node, Node) | चाइल्ड नोड oldChild को newChild से बच्चों की सूची में बदलता है और oldChild नोड को लौटाता है। यदि newChild एक `DocumentFragment` ऑब्जेक्ट है, तो oldChild को `DocumentFragment` के सभी बच्चों से बदल दिया जाता है, जो उसी क्रम में सम्मिलित होते हैं। यदि newChild पहले से ही ट्री में मौजूद है, तो उसे पहले हटाया जाता है। |
