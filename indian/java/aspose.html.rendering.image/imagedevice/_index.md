...
description: "com.aspose.html.rendering.image.ImageDevice class. jpeg png bmp gif tiff रास्टर स्वरूपों में रेंडरिंग का प्रतिनिधित्व करता है।"
type: docs
...
| नाम | विवरण |
| --- | --- |
| [ImageDevice](imagedevice/#constructor)(ICreateStreamProvider) | `ImageDevice` class का एक नया उदाहरण आरंभ करता है। |
| [ImageDevice](imagedevice/#constructor_4)(Stream) | `ImageDevice` class का एक नया उदाहरण आरंभ करता है। |
| [ImageDevice](imagedevice/#constructor_5)(String) | `ImageDevice` class का एक नया उदाहरण आरंभ करता है। |
| [ImageDevice](imagedevice/#constructor_1)(ImageRenderingOptions, ICreateStreamProvider) | रेंडरिंग विकल्पों और स्ट्रीम प्रदाता द्वारा `ImageDevice` क्लास का नया इंस्टेंस प्रारंभ करता है। |
| [ImageDevice](imagedevice/#constructor_2)(ImageRenderingOptions, Stream) | रेंडरिंग विकल्पों और आउटपुट स्ट्रीम द्वारा `ImageDevice` क्लास का नया इंस्टेंस प्रारंभ करता है। |
| [ImageDevice](imagedevice/#constructor_3)(ImageRenderingOptions, String) | रेंडरिंग विकल्पों और आउटपुट फ़ाइल नाम द्वारा `ImageDevice` क्लास का नया इंस्टेंस प्रारंभ करता है। |
...
| नाम | विवरण |
| --- | --- |
| class [ImageGraphicContext](../../com.aspose.html.rendering.image/imagedevice.imagegraphiccontext) | `ImageDevice` के लिए वर्तमान ग्राफ़िक्स नियंत्रण पैरामीटर रखता है। ये पैरामीटर उस वैश्विक फ्रेमवर्क को परिभाषित करते हैं जिसमें ग्राफ़िक्स ऑपरेटर निष्पादित होते हैं। |
