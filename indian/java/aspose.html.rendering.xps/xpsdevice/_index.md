...
description: "com.aspose.html.rendering.xps.XpsDevice क्लास। XPS दस्तावेज़ में रेंडरिंग का प्रतिनिधित्व करता है।"
type: docs
...
XPS दस्तावेज़ में रेंडरिंग को दर्शाता है।
...
| नाम | विवरण |
| --- | --- |
| [XpsDevice](xpsdevice/#constructor)(ICreateStreamProvider) | `XpsDevice` क्लास का एक नया इंस्टेंस इनिशियलाइज़ करता है। |
| [XpsDevice](xpsdevice/#constructor_4)(Stream) | `XpsDevice` क्लास का एक नया इंस्टेंस इनिशियलाइज़ करता है। |
| [XpsDevice](xpsdevice/#constructor_5)(String) | `XpsDevice` क्लास का एक नया इंस्टेंस इनिशियलाइज़ करता है। |
| [XpsDevice](xpsdevice/#constructor_1)(XpsRenderingOptions, ICreateStreamProvider) | `XpsDevice` क्लास का एक नया इंस्टेंस रेंडरिंग विकल्पों और स्ट्रीम प्रोवाइडर द्वारा इनिशियलाइज़ करता है। |
| [XpsDevice](xpsdevice/#constructor_2)(XpsRenderingOptions, Stream) | `XpsDevice` क्लास का एक नया इंस्टेंस रेंडरिंग विकल्पों और आउटपुट स्ट्रीम द्वारा इनिशियलाइज़ करता है। |
| [XpsDevice](xpsdevice/#constructor_3)(XpsRenderingOptions, String) | `XpsDevice` क्लास का एक नया इंस्टेंस रेंडरिंग विकल्पों और आउटपुट फ़ाइल नाम द्वारा इनिशियलाइज़ करता है। |
...
| नाम | विवरण |
| --- | --- |
| class [XpsGraphicContext](../../com.aspose.html.rendering.xps/xpsdevice.xpsgraphiccontext) | XpsDevice के लिए वर्तमान ग्राफ़िक्स नियंत्रण पैरामीटर रखता है। ये पैरामीटर वह वैश्विक फ्रेमवर्क परिभाषित करते हैं जिसमें ग्राफ़िक्स ऑपरेटर निष्पादित होते हैं। |
