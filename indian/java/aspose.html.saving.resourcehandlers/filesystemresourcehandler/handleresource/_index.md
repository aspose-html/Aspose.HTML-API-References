...
description: "FileSystemResourceHandler मेथड। यह मेथड संसाधन को संभालने के लिए ज़िम्मेदार है। इसमें आप संसाधन को स्ट्रीम में सहेज सकते हैं या इसे पैरेंट संसाधन में एम्बेड कर सकते हैं"
type: docs

url: /hi/java/com.aspose.html.saving.resourcehandlers/filesystemresourcehandler/handleresource/
---
## FileSystemResourceHandler.HandleResource method

यह मेथड संसाधन को संभालने के लिए ज़िम्मेदार है। इसमें आप [`Resource`](../../../com.aspose.html.saving/resource/) को स्ट्रीम में सहेज सकते हैं या इसे पैरेंट संसाधन में एम्बेड कर सकते हैं।
