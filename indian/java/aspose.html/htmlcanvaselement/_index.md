---
title: "HTMLCanvasElement क्लास"
second_title: "Aspose.HTML Java के लिए API संदर्भ"
description: "com.aspose.html.HTMLCanvasElement क्लास। HTMLCanvasElement इंटरफ़ेस कैनवास तत्वों के लेआउट और प्रस्तुति को नियंत्रित करने के लिए प्रॉपर्टीज़ और मेथड्स प्रदान करता है। HTMLCanvasElement इंटरफ़ेस HTMLElement इंटरफ़ेस की प्रॉपर्टीज़ और मेथड्स को भी विरासत में लेता है।"
type: docs

url: /hi/java/com.aspose.html/htmlcanvaselement/
---
## HTMLCanvasElement class

HTMLCanvasElement इंटरफ़ेस कैनवास तत्वों के लेआउट और प्रस्तुति को बदलने के लिए गुण और विधियाँ प्रदान करता है। HTMLCanvasElement इंटरफ़ेस HTMLElement इंटरफ़ेस के गुण और विधियों को भी विरासत में प्राप्त करता है।
...
| [getContext](../../com.aspose.html/htmlcanvaselement/getcontext/)(String) | कैनवास पर एक ड्रॉइंग कॉन्टेक्स्ट लौटाता है, या यदि कॉन्टेक्स्ट ID समर्थित नहीं है तो null। ड्रॉइंग कॉन्टेक्स्ट आपको कैनवास पर ड्रॉ करने की अनुमति देता है। |
...
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl)() | type पैरामीटर द्वारा निर्दिष्ट फ़ॉर्मेट (डिफ़ॉल्ट रूप से PNG) में छवि का प्रतिनिधित्व करने वाला एक डेटा URI लौटाता है। लौटाई गई छवि 96 dpi के रिज़ॉल्यूशन में है। |
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl_1)(String) | type पैरामीटर द्वारा निर्दिष्ट फ़ॉर्मेट (डिफ़ॉल्ट रूप से PNG) में छवि का प्रतिनिधित्व करने वाला एक डेटा URI लौटाता है। लौटाई गई छवि 96 dpi के रिज़ॉल्यूशन में है। |
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl_2)(String, double) | type पैरामीटर द्वारा निर्दिष्ट फ़ॉर्मेट (डिफ़ॉल्ट रूप से PNG) में छवि का प्रतिनिधित्व करने वाला एक डेटा URI लौटाता है। लौटाई गई छवि 96 dpi के रिज़ॉल्यूशन में है। |
