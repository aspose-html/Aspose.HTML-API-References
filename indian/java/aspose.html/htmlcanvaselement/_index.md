...
description: "com.aspose.html.HTMLCanvasElement क्लास। HTMLCanvasElement इंटरफ़ेस कैनवास तत्वों के लेआउट और प्रस्तुति को नियंत्रित करने के लिए गुण और विधियाँ प्रदान करता है। HTMLCanvasElement इंटरफ़ेस HTMLElement इंटरफ़ेस के गुण और विधियों को भी विरासत में प्राप्त करता है"
type: docs
...
HTMLCanvasElement इंटरफ़ेस कैनवास तत्वों की लेआउट और प्रस्तुति को संशोधित करने के लिए गुण और विधियाँ प्रदान करता है। HTMLCanvasElement इंटरफ़ेस HTMLElement इंटरफ़ेस के गुण और विधियों को भी विरासत में प्राप्त करता है।
...
| [getContext](../../com.aspose.html/htmlcanvaselement/getcontext/)(String) | कैनवास पर एक ड्रॉइंग कॉन्टेक्स्ट लौटाता है, या यदि कॉन्टेक्स्ट ID समर्थित नहीं है तो null। एक ड्रॉइंग कॉन्टेक्स्ट आपको कैनवास पर ड्रॉ करने देता है। |
...
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl)() | एक डेटा URI लौटाता है जिसमें छवि का प्रतिनिधित्व उस फ़ॉर्मेट में होता है जो type पैरामीटर द्वारा निर्दिष्ट किया गया है (डिफ़ॉल्ट PNG)। लौटाई गई छवि 96 dpi के रिज़ॉल्यूशन में होती है। |
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl_1)(String) | एक डेटा URI लौटाता है जिसमें छवि का प्रतिनिधित्व उस फ़ॉर्मेट में होता है जो type पैरामीटर द्वारा निर्दिष्ट किया गया है (डिफ़ॉल्ट PNG)। लौटाई गई छवि 96 dpi के रिज़ॉल्यूशन में होती है। |
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl_2)(String, double) | एक डेटा URI लौटाता है जिसमें छवि का प्रतिनिधित्व उस फ़ॉर्मेट में होता है जो type पैरामीटर द्वारा निर्दिष्ट किया गया है (डिफ़ॉल्ट PNG)। लौटाई गई छवि 96 dpi के रिज़ॉल्यूशन में होती है। |
