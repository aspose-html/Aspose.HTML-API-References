...
description: "com.aspose.html.HTMLOptionElement class. चयन योग्य विकल्प। HTML 4.01 में OPTION तत्व की परिभाषा देखें"
type: docs
...
एक चयन योग्य विकल्प। HTML 4.01 में OPTION तत्व की परिभाषा देखें।
...
| [getForm](../../com.aspose.html/htmloptionelement/form/) इस नियंत्रण को सम्मिलित करने वाला `FORM` तत्व लौटाता है। यदि यह नियंत्रण फ़ॉर्म के संदर्भ में नहीं है तो `null` लौटाता है। |
[getId]
[setId] The element's identifier. See the id attribute definition in HTML 4.01. |
| [getIndex](../../com.aspose.html/htmloptionelement/index/) इस `OPTION` का इंडेक्स, उसके पैरेंट `SELECT` में, 0 से शुरू होता है। @version DOM Level 2 |
[getInnerHTML]
...
| [getText](../../com.aspose.html/htmloptionelement/text/) विकल्प तत्व के भीतर मौजूद पाठ। |
