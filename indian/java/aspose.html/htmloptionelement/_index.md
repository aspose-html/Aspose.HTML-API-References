---
title: "HTMLOptionElement क्लास"
second_title: "Aspose.HTML Java के लिए API संदर्भ"
description: "com.aspose.html.HTMLOptionElement क्लास। एक चयन योग्य विकल्प। HTML 4.01 में OPTION तत्व की परिभाषा देखें।"
type: docs

url: /hi/java/com.aspose.html/htmloptionelement/
---
## HTMLOptionElement class

एक चयन योग्य विकल्प। देखें OPTION तत्व की परिभाषा HTML 4.01 में।
...
| [getForm](../../com.aspose.html/htmloptionelement/form/) `FORM` तत्व जो इस नियंत्रण को सम्मिलित करता है, लौटाता है। यदि यह नियंत्रण फ़ॉर्म के संदर्भ में नहीं है तो `null` लौटाता है। |
[getId]
[setId] The element's identifier. See the id attribute definition in HTML 4.01. |
| [getIndex](../../com.aspose.html/htmloptionelement/index/) इस `OPTION` का उसके पैरेंट `SELECT` में इंडेक्स, 0 से शुरू। @version DOM Level 2 |
[getInnerHTML]
...
| [getText](../../com.aspose.html/htmloptionelement/text/) ऑप्शन तत्व के भीतर मौजूद टेक्स्ट। |
