---
title: "HTMLTableSectionElement क्लास"
second_title: "Aspose.HTML Java के लिए API संदर्भ"
description: "com.aspose.html.HTMLTableSectionElement क्लास। THEAD, TFOOT और TBODY तत्व।"
type: docs

url: /hi/java/com.aspose.html/htmltablesectionelement/
---
## HTMLTableSectionElement class

`THEAD`, `TFOOT` और `TBODY` तत्व।
...
| [getRows](../../com.aspose.html/htmltablesectionelement/rows/) इस टेबल सेक्शन में पंक्तियों का संग्रह। |
...
| [deleteRow](../../com.aspose.html/htmltablesectionelement/deleterow/)(int) | इस सेक्शन से एक पंक्ति हटाएँ। |
...
| [insertRow](../../com.aspose.html/htmltablesectionelement/insertrow/)(int) | इस सेक्शन में एक पंक्ति डालें। नई पंक्ति इस सेक्शन में वर्तमान `index`वीं पंक्ति के ठीक पहले डाली जाती है। यदि `index` -1 है या इस सेक्शन में पंक्तियों की संख्या के बराबर है, तो नई पंक्ति को अंत में जोड़ा जाता है। |
