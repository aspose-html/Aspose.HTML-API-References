...
| [getRows](../../com.aspose.html/htmltablesectionelement/rows/) इस तालिका सेक्शन में पंक्तियों का संग्रह। |
...
| [insertRow](../../com.aspose.html/htmltablesectionelement/insertrow/)(int) | इस सेक्शन में एक पंक्ति डालें। नई पंक्ति इस सेक्शन में वर्तमान `index`वीं पंक्ति से ठीक पहले डाली जाती है। यदि `index` -1 है या इस सेक्शन में पंक्तियों की संख्या के बराबर है, तो नई पंक्ति अंत में जोड़ी जाती है। |
