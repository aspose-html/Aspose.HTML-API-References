...
description: "com.aspose.html.HTMLTableRowElement क्लास। तालिका में एक पंक्ति। HTML 4.01 में TR तत्व की परिभाषा देखें"
type: docs
...
टेबल में एक पंक्ति। HTML 4.01 में TR तत्व की परिभाषा देखें।
...
| [getRowIndex](../../com.aspose.html/htmltablerowelement/rowindex/) यह तार्किक क्रम में है और दस्तावेज़ क्रम में नहीं। `rowIndex` तालिका के भीतर सेक्शन (`THEAD`, `TFOOT`, या `TBODY`) को ध्यान में रखता है, `THEAD` पंक्तियों को पहले इंडेक्स में रखता है, उसके बाद `TBODY` पंक्तियाँ, फिर `TFOOT` पंक्तियाँ। @version DOM Level 2 |
...
| [deleteCell](../../com.aspose.html/htmltablerowelement/deletecell/)(int) | वर्तमान पंक्ति से एक कोशिका हटाएँ। |
...
| [insertCell](../../com.aspose.html/htmltablerowelement/insertcell/)(int) | इस पंक्ति में एक खाली `TD` कोशिका डालें। यदि `index` -1 है या कोशिकाओं की संख्या के बराबर है, तो नई कोशिका जोड़ दी जाएगी। |
