---
title: "HTMLTableRowElement क्लास"
second_title: "Aspose.HTML Java के लिए API संदर्भ"
description: "com.aspose.html.HTMLTableRowElement क्लास। एक तालिका में पंक्ति। HTML 4.01 में TR तत्व की परिभाषा देखें।"
type: docs

url: /hi/java/com.aspose.html/htmltablerowelement/
---
## HTMLTableRowElement class

टेबल में एक पंक्ति। देखें TR तत्व की परिभाषा HTML 4.01 में।
...
| [getCells](../../com.aspose.html/htmltablerowelement/cells/) इस पंक्ति में कोशिकाओं का संग्रह। @version DOM Level 2 |
[getCh]
...
| [getRowIndex](../../com.aspose.html/htmltablerowelement/rowindex/) यह तार्किक क्रम में है, न कि दस्तावेज़ क्रम में। `rowIndex` तालिका के भीतर सेक्शन (`THEAD`, `TFOOT`, या `TBODY`) को ध्यान में रखता है, जिससे `THEAD` पंक्तियाँ पहले इंडेक्स में आती हैं, उसके बाद `TBODY` पंक्तियाँ, फिर `TFOOT` पंक्तियाँ। @version DOM Level 2 |
| [getSectionRowIndex](../../com.aspose.html/htmltablerowelement/sectionrowindex/) इस पंक्ति का इंडेक्स, वर्तमान सेक्शन (`THEAD`, `TFOOT`, या `TBODY`) के सापेक्ष, 0 से शुरू। @version DOM Level 2 |
...
| [deleteCell](../../com.aspose.html/htmltablerowelement/deletecell/)(int) | वर्तमान पंक्ति से एक सेल हटाएँ। |
...
| [insertCell](../../com.aspose.html/htmltablerowelement/insertcell/)(int) | इस पंक्ति में एक खाली `TD` सेल डालें। यदि `index` -1 है या सेलों की संख्या के बराबर है, तो नया सेल अंत में जोड़ा जाता है। |
