---
title: "HTMLTextAreaElement क्लास"
second_title: "Aspose.HTML Java के लिए API संदर्भ"
description: "com.aspose.html.HTMLTextAreaElement क्लास। मल्टी-लाइन टेक्स्ट फ़ील्ड। HTML 4.01 में TEXTAREA तत्व की परिभाषा देखें।"
type: docs

url: /hi/java/com.aspose.html/htmltextareaelement/
---
## HTMLTextAreaElement class

बहु-लाइन टेक्स्ट फ़ील्ड। देखें TEXTAREA तत्व की परिभाषा HTML 4.01 में।
...
| [getForm](../../com.aspose.html/htmltextareaelement/form/) इस कंट्रोल को सम्मिलित करने वाला `FORM` तत्व लौटाता है। यदि यह कंट्रोल किसी फ़ॉर्म के संदर्भ में नहीं है तो `null` लौटाता है। |
[getId]
...
| [getType](../../com.aspose.html/htmltextareaelement/type/) इस फ़ॉर्म कंट्रोल का प्रकार। यह स्ट्रिंग "textarea" है। |
[getValue]
