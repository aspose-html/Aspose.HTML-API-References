...
description: "com.aspose.html.HTMLTextAreaElement क्लास। बहु-लाइन टेक्स्ट फ़ील्ड। HTML 4.01 में TEXTAREA तत्व की परिभाषा देखें।"
type: docs
...
बहु-रेखा पाठ फ़ील्ड। HTML 4.01 में TEXTAREA तत्व की परिभाषा देखें।
...
| [getForm](../../com.aspose.html/htmltextareaelement/form/) इस नियंत्रण को शामिल करने वाले `FORM` तत्व को लौटाता है। यदि यह नियंत्रण फ़ॉर्म के संदर्भ में नहीं है तो `null` लौटाता है। |
[getId]
...
| [getType](../../com.aspose.html/htmltextareaelement/type/) इस फ़ॉर्म नियंत्रण का प्रकार। यह स्ट्रिंग "textarea" है। |
[getValue]
