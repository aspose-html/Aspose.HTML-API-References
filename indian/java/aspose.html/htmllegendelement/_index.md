...
`FIELDSET` समूह के लिए एक कैप्शन प्रदान करता है। देखें LEGEND तत्व की परिभाषा HTML 4.01 में।
...
| [getForm](../../com.aspose.html/htmllegendelement/form/) इस नियंत्रण को सम्मिलित करने वाले `FORM` तत्व को लौटाता है। यदि यह नियंत्रण किसी फ़ॉर्म के संदर्भ में नहीं है तो `null` लौटाता है। |
[getId]
