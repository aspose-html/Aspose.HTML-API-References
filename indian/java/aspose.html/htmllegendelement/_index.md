---
title: "HTMLLegendElement क्लास"
second_title: "Aspose.HTML Java के लिए API संदर्भ"
description: "com.aspose.html.HTMLLegendElement क्लास। FIELDSET समूह के लिए एक कैप्शन प्रदान करता है। HTML 4.01 में LEGEND तत्व की परिभाषा देखें।"
type: docs

url: /hi/java/com.aspose.html/htmllegendelement/
---
## HTMLLegendElement class

`FIELDSET` समूह के लिए कैप्शन प्रदान करता है। HTML 4.01 में LEGEND तत्व की परिभाषा देखें।
...
| [getForm](../../com.aspose.html/htmllegendelement/form/) इस नियंत्रण को शामिल करने वाले `FORM` तत्व को लौटाता है। यदि यह नियंत्रण फ़ॉर्म के संदर्भ में नहीं है तो `null` लौटाता है। |
[getId]
