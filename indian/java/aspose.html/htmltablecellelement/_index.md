---
title: "HTMLTableCellElement क्लास"
second_title: "Aspose.HTML Java के लिए API संदर्भ"
description: "com.aspose.html.HTMLTableCellElement क्लास। TH और TD तत्वों को दर्शाने के लिए प्रयुक्त ऑब्जेक्ट। HTML 4.01 में TD तत्व की परिभाषा देखें।"
type: docs

url: /hi/java/com.aspose.html/htmltablecellelement/
---
## HTMLTableCellElement class

`TH` और `TD` तत्वों को दर्शाने के लिए उपयोग किया गया ऑब्जेक्ट। देखें TD तत्व की परिभाषा HTML 4.01 में।
...
| [getCellIndex](../../com.aspose.html/htmltablecellelement/cellindex/) इस सेल का इंडेक्स पंक्ति में, 0 से शुरू। यह इंडेक्स दस्तावेज़ ट्री क्रम में है और प्रदर्शित क्रम में नहीं। |
[getCh]
