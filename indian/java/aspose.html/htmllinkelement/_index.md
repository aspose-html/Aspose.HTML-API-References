...
`LINK` तत्व बाहरी संसाधन के लिए लिंक निर्दिष्ट करता है, और इस दस्तावेज़ और उस संसाधन के बीच संबंध (या उल्टा) को परिभाषित करता है। देखें LINK तत्व की परिभाषा HTML 4.01 में (साथ ही देखें StyleSheet मॉड्यूल में `LinkStyle` इंटरफ़ेस [[DOM Level 2 Style Sheets and CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113)]).
...
| [getRelList](../../com.aspose.html/htmllinkelement/rellist/) \"rel\" एट्रिब्यूट को पार्स करने से प्राप्त टोकन को शामिल करने वाली लाइव DOMTokenList लौटाता है। |
[getRev]
