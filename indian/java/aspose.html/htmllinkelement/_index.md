---
title: "HTMLLinkElement क्लास"
second_title: "Aspose.HTML Java के लिए API संदर्भ"
description: "com.aspose.html.HTMLLinkElement क्लास। LINK तत्व बाहरी संसाधन के लिए लिंक निर्दिष्ट करता है और इस दस्तावेज़ और उस संसाधन के बीच संबंध को परिभाषित करता है या इसके विपरीत। HTML 4.01 में LINK तत्व की परिभाषा देखें, साथ ही StyleSheet मॉड्यूल में LinkStyle इंटरफ़ेस देखें, DOM Level 2 स्टाइल शीट्स और CSS।"
type: docs

url: /hi/java/com.aspose.html/htmllinkelement/
---
## HTMLLinkElement class

`LINK` तत्व बाहरी संसाधन के लिए लिंक निर्दिष्ट करता है, और इस दस्तावेज़ तथा उस संसाधन के बीच संबंध को परिभाषित करता है (या इसके विपरीत)। HTML 4.01 में LINK तत्व की परिभाषा देखें (StyleSheet मॉड्यूल में `LinkStyle` इंटरफ़ेस को भी देखें [[DOM Level 2 Style Sheets and CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113)])।
...
| [getRelList](../../com.aspose.html/htmllinkelement/rellist/) एक लाइव DOMTokenList लौटाता है जिसमें "rel" एट्रिब्यूट को पार्स करने से प्राप्त टोकन होते हैं। |
[getRev]
...
| [getSheet](../../com.aspose.html/htmllinkelement/sheet/) संबंधित स्टाइल शीट प्राप्त करता है। |
