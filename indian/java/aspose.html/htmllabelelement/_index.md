---
title: "HTMLLabelElement क्लास"
second_title: "Aspose.HTML Java के लिए API संदर्भ"
description: "com.aspose.html.HTMLLabelElement क्लास। फ़ॉर्म फ़ील्ड लेबल टेक्स्ट। HTML 4.01 में LABEL तत्व की परिभाषा देखें।"
type: docs

url: /hi/java/com.aspose.html/htmllabelelement/
---
## HTMLLabelElement class

फ़ॉर्म फ़ील्ड लेबल टेक्स्ट। HTML 4.01 में LABEL तत्व की परिभाषा देखें।
...
| [getForm](../../com.aspose.html/htmllabelelement/form/) इस नियंत्रण को सम्मिलित करने वाले `FORM` तत्व को लौटाता है। यदि यह नियंत्रण फ़ॉर्म के संदर्भ में नहीं है तो `null` लौटाता है। |
[getId]
