...
description: "com.aspose.html.HTMLElement क्लास। सभी HTML तत्व इंटरफ़ेस इस क्लास से व्युत्पन्न होते हैं। जो तत्व केवल HTML कोर एट्रिब्यूट्स को उजागर करते हैं, उन्हें बेस HTMLElement इंटरफ़ेस द्वारा दर्शाया जाता है। ये तत्व इस प्रकार हैं: विशेष SUB SUP SPAN BDOfont TT I B U S STRIKE BIG SMALL phrase EM STRONG DFN CODE SAMP KBD VAR CITE ACRONYM ABBRlist DD DTNOFRAMES NOSCRIPTADDRESS CENTER। एक HTML तत्व का style एट्रिब्यूट ElementCSSInlineStyle इंटरफ़ेस के माध्यम से उपलब्ध है, जो CSS मॉड्यूल DOM Level 2 Style Sheets और CSS में परिभाषित है।"
type: docs
...
सभी HTML तत्व इंटरफ़ेस इस क्लास से व्युत्पन्न होते हैं। वे तत्व जो केवल HTML कोर गुणों को उजागर करते हैं, बेस `HTMLElement` इंटरफ़ेस द्वारा प्रतिनिधित्व किए जाते हैं। ये तत्व निम्नलिखित हैं: विशेष: SUB, SUP, SPAN, BDOfont: TT, I, B, U, S, STRIKE, BIG, SMALL वाक्यांश: EM, STRONG, DFN, CODE, SAMP, KBD, VAR, CITE, ACRONYM, ABBR सूची: DD, DTNOFRAMES, NOSCRIPTADDRESS, CENTER। HTML तत्व का `style` गुण `ElementCSSInlineStyle` इंटरफ़ेस के माध्यम से सुलभ है, जो CSS मॉड्यूल में परिभाषित है [[DOM Level 2 Style Sheets and CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113)]।
