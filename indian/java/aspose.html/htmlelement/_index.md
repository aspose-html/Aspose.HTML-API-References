---
title: "HTMLElement क्लास"
second_title: "Aspose.HTML Java के लिए API संदर्भ"
description: "com.aspose.html.HTMLElement क्लास। सभी HTML तत्व इंटरफ़ेस इस क्लास से व्युत्पन्न होते हैं। वे तत्व जो केवल HTML कोर गुणों को उजागर करते हैं, बेस HTMLElement इंटरफ़ेस द्वारा प्रतिनिधित्व किए जाते हैं। ये तत्व इस प्रकार हैं: विशेष SUB SUP SPAN BDO फ़ॉन्ट TT I B U S STRIKE BIG SMALL phrase EM STRONG DFN CODE SAMP KBD VAR CITE ACRONYM ABBRlist DD DT NOFRAMES NOSCRIPT ADDRESS CENTER। एक HTML तत्व का style गुण ElementCSSInlineStyle इंटरफ़ेस के माध्यम से उपलब्ध है, जो CSS मॉड्यूल DOM Level 2 Style Sheets और CSS में परिभाषित है।"
type: docs

url: /hi/java/com.aspose.html/htmlelement/
---
## HTMLElement class

सभी HTML तत्व इंटरफ़ेस इस क्लास से व्युत्पन्न होते हैं। वे तत्व जो केवल HTML कोर गुण दिखाते हैं, बेस `HTMLElement` इंटरफ़ेस द्वारा प्रतिनिधित्व किए जाते हैं। ये तत्व इस प्रकार हैं: विशेष: SUB, SUP, SPAN, BDO; फ़ॉन्ट: TT, I, B, U, S, STRIKE, BIG, SMALL; वाक्यांश: EM, STRONG, DFN, CODE, SAMP, KBD, VAR, CITE, ACRONYM, ABBR; सूची: DD, DT, NOFRAMES, NOSCRIPT, ADDRESS, CENTER। HTML तत्व का `style` गुण `ElementCSSInlineStyle` इंटरफ़ेस के माध्यम से उपलब्ध है, जो CSS मॉड्यूल में परिभाषित है [[DOM Level 2 Style Sheets and CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113)]।
