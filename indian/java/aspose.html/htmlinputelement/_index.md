---
title: "HTMLInputElement क्लास"
second_title: "Aspose.HTML Java के लिए API संदर्भ"
description: "com.aspose.html.HTMLInputElement क्लास। फ़ॉर्म नियंत्रण। जिस वातावरण में पृष्ठ देखा जा रहा है, उसके आधार पर फ़ाइल अपलोड इनपुट प्रकार के लिए value प्रॉपर्टी केवल‑पढ़ने योग्य हो सकती है। पासवर्ड इनपुट प्रकार के लिए वास्तविक मान को अनधिकृत उपयोग से बचाने के लिए मास्क किया जा सकता है। HTML 4.01 में INPUT तत्व की परिभाषा देखें। साथ ही Document Object Model DOM Level 2 HTML Specification देखें।"
type: docs

url: /hi/java/com.aspose.html/htmlinputelement/
---
## HTMLInputElement class

फ़ॉर्म नियंत्रण। जिस वातावरण में पृष्ठ देखा जा रहा है, उसके आधार पर फ़ाइल अपलोड इनपुट प्रकार के लिए value गुण केवल‑पढ़ने योग्य हो सकता है। "password" इनपुट प्रकार के लिए, वास्तविक मान को अनधिकृत उपयोग से बचाने के लिए छिपाया जा सकता है। [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224)] में INPUT तत्व की परिभाषा देखें। साथ ही देखें [Document object Model (DOM) Level 2 HTML Specification](http://www.w3.org/TR/2003/REC-DOM-Level-2-HTML-20030109)।
...
| [getFiles](../../com.aspose.html/htmlinputelement/files/) files IDL एट्रिब्यूट स्क्रिप्ट्स को तत्व की चयनित फ़ाइलों तक पहुँचने की अनुमति देता है। प्राप्त करने पर, यदि IDL एट्रिब्यूट लागू होता है, तो इसे एक FileList ऑब्जेक्ट लौटाना चाहिए जो वर्तमान चयनित फ़ाइलों का प्रतिनिधित्व करता है। चयनित फ़ाइलों की सूची बदलने तक वही ऑब्जेक्ट लौटाया जाना चाहिए। यदि IDL एट्रिब्यूट लागू नहीं होता, तो इसे `null` लौटाना चाहिए। [FILEAPI] |
...
import (var document = new HTMLDocument(inputHtmlPath))
{
	...
	// लेबल तत्व - पहला नाम
	// <label for=\"fname\">पहला नाम:</label><br>
	...
	// लेबल तत्व - अंतिम नाम
	// <label for=\"lname\">अंतिम नाम:</label><br>
