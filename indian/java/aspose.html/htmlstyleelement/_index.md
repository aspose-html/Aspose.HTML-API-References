...
description: "com.aspose.html.HTMLStyleElement क्लास। शैली जानकारी। HTML 4.01 में STYLE तत्व की परिभाषा देखें, CSS मॉड्यूल DOM Level 2 Style Sheets और CSS, तथा StyleSheets मॉड्यूल DOM Level 2 Style Sheets और CSS में LinkStyle इंटरफ़ेस देखें।"
type: docs
...
स्टाइल जानकारी। HTML 4.01 में STYLE तत्व की परिभाषा, CSS मॉड्यूल [[DOM Level 2 Style Sheets and CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113)] और StyleSheets मॉड्यूल में `LinkStyle` इंटरफ़ेस देखें।
