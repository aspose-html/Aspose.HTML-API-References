---
title: "HTMLStyleElement क्लास"
second_title: "Aspose.HTML Java के लिए API संदर्भ"
description: "com.aspose.html.HTMLStyleElement क्लास। शैली जानकारी। HTML 4.01 में STYLE तत्व की परिभाषा देखें, CSS मॉड्यूल DOM Level 2 Style Sheets और CSS, तथा StyleSheets मॉड्यूल में LinkStyle इंटरफ़ेस देखें।"
type: docs

url: /hi/java/com.aspose.html/htmlstyleelement/
---
## HTMLStyleElement class

स्टाइल जानकारी। देखें STYLE तत्व की परिभाषा HTML 4.01 में, CSS मॉड्यूल [[DOM Level 2 Style Sheets and CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113)] और StyleSheets मॉड्यूल में `LinkStyle` इंटरफ़ेस [[DOM Level 2 Style Sheets and CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113)]।
...
| [getSheet](../../com.aspose.html/htmlstyleelement/sheet/) संबंधित स्टाइल शीट प्राप्त करता है। |
