---
title: "HTMLSelectElement क्लास"
second_title: "Aspose.HTML Java के लिए API संदर्भ"
description: "com.aspose.html.HTMLSelectElement क्लास। चयन तत्व एक विकल्प के चयन की अनुमति देता है। सम्मिलित विकल्पों को सीधे चयन तत्व के माध्यम से एक संग्रह के रूप में एक्सेस किया जा सकता है। HTML 4.01 में SELECT तत्व की परिभाषा देखें।"
type: docs

url: /hi/java/com.aspose.html/htmlselectelement/
---
## HTMLSelectElement class

सेलेक्ट तत्व विकल्प के चयन की अनुमति देता है। इसमें शामिल विकल्पों को सीधे सेलेक्ट तत्व के माध्यम से संग्रह के रूप में एक्सेस किया जा सकता है। देखें SELECT तत्व की परिभाषा HTML 4.01 में।
...
| [getForm](../../com.aspose.html/htmlselectelement/form/) इस `SELECT` में विकल्पों की संख्या। |
[getId]
...
| [getOptions](../../com.aspose.html/htmlselectelement/options/) इस तत्व द्वारा सम्मिलित `OPTION` तत्वों का संग्रह। @version DOM Level 2 |
[getOuterHTML]
...
| [getType](../../com.aspose.html/htmlselectelement/type/) इस फ़ॉर्म नियंत्रण का प्रकार। जब multiple गुण `true` हो तो यह स्ट्रिंग "select-multiple" है और जब `false` हो तो स्ट्रिंग "select-one" है। |
[getValue]
