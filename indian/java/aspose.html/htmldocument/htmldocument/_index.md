...
HTMLDocument कंस्ट्रक्टर एक नया HTML Document ऑब्जेक्ट बनाता है जो ब्राउज़र में लोड किया गया वेब पेज होता है और पेज की सामग्री में प्रवेश बिंदु के रूप में कार्य करता है।
...
एक बार दस्तावेज़ ऑब्जेक्ट बन जाने के बाद, इसे बाद में HTML तत्वों से भरा जा सकता है। निम्नलिखित कोड स्निपेट डिफ़ॉल्ट HTMLDocument() कंस्ट्रक्टर के उपयोग को दर्शाता है जिससे एक खाली HTML दस्तावेज़ बनाया जाता है और उसे फ़ाइल में सहेजा जाता है।
...
निम्नलिखित उदाहरण दर्शाता है कि स्क्रिप्ट को निष्क्रिय करने के लिए कॉन्फ़िगरेशन ऑब्जेक्ट का उपयोग कैसे किया जाए:
...
HTML दस्तावेज़ को एक URL से लोड करता है।
...
HTML दस्तावेज़ को एक पते से लोड करता है।
...
निर्दिष्ट base-uri के साथ एक स्ट्रिंग सामग्री से HTML दस्तावेज़ बनाता है।
...
निर्दिष्ट base-uri और पर्यावरण कॉन्फ़िगरेशन सेटिंग्स के साथ एक स्ट्रिंग सामग्री से HTML दस्तावेज़ बनाता है।
...
निर्दिष्ट base-uri के साथ एक [Stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream) सामग्री से HTML दस्तावेज़ बनाता है, जिसका उपयोग सापेक्ष संसाधनों के पथ को हल करने के लिए किया जाता है।
...
निर्दिष्ट base-uri और पर्यावरण कॉन्फ़िगरेशन सेटिंग्स के साथ एक [Stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream) सामग्री से HTML दस्तावेज़ बनाता है।
...
एक [RequestMessage](T:com.aspose.html.net.RequestMessage) ऑब्जेक्ट से HTML दस्तावेज़ बनाता है।
