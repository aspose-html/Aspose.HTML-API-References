...
description: "com.aspose.html.HTMLDocument क्लास। एक HTML दस्तावेज़ का प्रतिनिधित्व करता है। सभी टॉप‑लेवल HTML ऑब्जेक्ट्स इस ऑब्जेक्ट में जोड़े जाते हैं। यह क्लास ब्राउज़र में दिखने वाले HTML पेज को दर्शाता है। सभी फ़ॉर्म, टेबल, स्क्रिप्ट आदि इस क्लास के इंटरफ़ेस के माध्यम से HTML पेज में जोड़े जाते हैं। HTMLDocument सबसे सामान्य Document इंटरफ़ेस का HTML कार्यान्वयन है और दोनों DOM - Document Object Model के मुख्य या मूल बिंदु हैं। ये अवधारणाएँ आधिकारिक वेब विकास आधार या मानकों के पूर्ण अनुरूप हैं। वेब विकास के उद्देश्य से आप सामान्यतः HTMLDocument को उस Document का उपनाम मान सकते हैं जिस पर HTMLDocument आधारित है।"
type: docs
...
एक HTML दस्तावेज़ का प्रतिनिधित्व करता है। सभी शीर्ष‑स्तर के HTML ऑब्जेक्ट इस ऑब्जेक्ट में जोड़े जाते हैं। यह क्लास ब्राउज़र में दिखाई देने वाले HTML पृष्ठ को दर्शाती है। सभी फ़ॉर्म, तालिकाएँ, स्क्रिप्ट आदि इस क्लास के इंटरफ़ेस के माध्यम से HTML पृष्ठ में जोड़े जाते हैं। [HTMLDocument](https://dom.spec.whatwg.org/#ref-for-dom-domimplementation-createhtmldocument) सबसे सामान्य [Document](https://dom.spec.whatwg.org/#document) इंटरफ़ेस का HTML कार्यान्वयन है और दोनों [DOM](https://dom.spec.whatwg.org/) - दस्तावेज़ वस्तु मॉडल के मूल बिंदु हैं। ये अवधारणाएँ आधिकारिक वेब विकास आधार या मानकों के पूर्ण अनुरूप हैं। वेब विकास के उद्देश्यों के लिए, आप सामान्यतः HTMLDocument को Document का उपनाम मान सकते हैं, जिस पर HTMLDocument आधारित है।
...
| नाम | विवरण |
| --- | --- |
| [HTMLDocument](htmldocument/#constructor)() | HTMLDocument कंस्ट्रक्टर एक नया HTML Document ऑब्जेक्ट बनाता है जो ब्राउज़र में लोड किया गया वेब पेज है और पेज की सामग्री में प्रवेश बिंदु के रूप में कार्य करता है। |
| [HTMLDocument](htmldocument/#constructor_1)(Configuration) | HTMLDocument कंस्ट्रक्टर एक नया HTML Document ऑब्जेक्ट बनाता है जो ब्राउज़र में लोड किया गया वेब पेज है और पेज की सामग्री में प्रवेश बिंदु के रूप में कार्य करता है। |
| [HTMLDocument](htmldocument/#constructor_2)(RequestMessage) | [`RequestMessage`](../../com.aspose.html.net/requestmessage/) ऑब्जेक्ट से एक HTML दस्तावेज़ बनाता है। |
| [HTMLDocument](htmldocument/#constructor_10)(String) | एक पते से HTML दस्तावेज़ लोड करता है। |
| [HTMLDocument](htmldocument/#constructor_4)(Url) | एक URL से HTML दस्तावेज़ लोड करता है। |
| [HTMLDocument](htmldocument/#constructor_3)(RequestMessage, Configuration) | [RequestMessage](T:com.aspose.html.net.RequestMessage) ऑब्जेक्ट से एक HTML दस्तावेज़ बनाता है। |
| [HTMLDocument](htmldocument/#constructor_8)(Stream, String) | [Stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream) सामग्री से एक HTML दस्तावेज़ बनाता है, जिसमें निर्दिष्ट base-uri का उपयोग सापेक्ष संसाधनों के पथ को हल करने के लिए किया जाता है। |
| [HTMLDocument](htmldocument/#constructor_6)(Stream, Url) | [Stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream) सामग्री से एक HTML दस्तावेज़ बनाता है, जिसमें निर्दिष्ट base-uri का उपयोग सापेक्ष संसाधनों के पथ को हल करने के लिए किया जाता है। |
...
| [HTMLDocument](htmldocument/#constructor_14)(String, String) | निर्दिष्ट base-uri के साथ एक String सामग्री से HTML दस्तावेज़ बनाता है। |
| [HTMLDocument](htmldocument/#constructor_12)(String, Url) | निर्दिष्ट base-uri के साथ एक String सामग्री से HTML दस्तावेज़ बनाता है। |
...
| [HTMLDocument](htmldocument/#constructor_9)(Stream, String, Configuration) | [Stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream) सामग्री से एक HTML दस्तावेज़ बनाता है, जिसमें निर्दिष्ट base-uri और पर्यावरण कॉन्फ़िगरेशन सेटिंग्स शामिल हैं। |
| [HTMLDocument](htmldocument/#constructor_7)(Stream, Url, Configuration) | [Stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream) सामग्री से एक HTML दस्तावेज़ बनाता है, जिसमें निर्दिष्ट base-uri और पर्यावरण कॉन्फ़िगरेशन सेटिंग्स शामिल हैं। |
| [HTMLDocument](htmldocument/#constructor_15)(String, String, Configuration) | निर्दिष्ट base-uri और पर्यावरण कॉन्फ़िगरेशन सेटिंग्स के साथ एक String सामग्री से HTML दस्तावेज़ बनाता है। |
| [HTMLDocument](htmldocument/#constructor_13)(String, Url, Configuration) | निर्दिष्ट base-uri और पर्यावरण कॉन्फ़िगरेशन सेटिंग्स के साथ एक String सामग्री से HTML दस्तावेज़ बनाता है। |

## प्रॉपर्टीज़

| नाम | विवरण |
| --- | --- |
| [getAnchors](../../com.aspose.html/htmldocument/anchors/) एक दस्तावेज़ में सभी एंकर (`A`) तत्वों का संग्रह है जिनमें `name` एट्रिब्यूट का मान होता है। पिछली संगतता के कारण, लौटाए गए एंकर सेट में केवल वे एंकर शामिल होते हैं जो `name` एट्रिब्यूट के साथ बनाए गए हैं, `id` एट्रिब्यूट वाले नहीं। ध्यान दें कि [[XHTML 1.0](http://www.w3.org/TR/2002/REC-xhtml1-20020801)] में `name` एट्रिब्यूट (सेक्शन 4.10 देखें) का कोई अर्थ नहीं है और यह केवल लेगेसी यूज़र एजेंट्स के लिए मौजूद है: इसके बजाय `id` एट्रिब्यूट उपयोग किया जाता है। उपयोगकर्ताओं को [[DOM Level 2 Traversal](http://www.w3.org/TR/2000/REC-DOM-Level-2-Traversal-Range-20001113)] द्वारा प्रदान किए गए इटररेटर तंत्र को प्राथमिकता देनी चाहिए। |
| [getApplets](../../com.aspose.html/htmldocument/applets/) एक दस्तावेज़ में सभी `OBJECT` तत्वों का संग्रह है जो एप्लेट्स और `APPLET` (अप्रचलित) तत्वों को शामिल करते हैं। |
...
| [getDomain](../../com.aspose.html/htmldocument/domain/) सर्वर का डोमेन नाम जो दस्तावेज़ सर्व करता है, या `null` यदि सर्वर को डोमेन नाम से पहचाना नहीं जा सकता। |
...
| [getForms](../../com.aspose.html/htmldocument/forms/) एक दस्तावेज़ के सभी फ़ॉर्मों का संग्रह। |
| [getImages](../../com.aspose.html/htmldocument/images/) एक दस्तावेज़ में सभी `IMG` तत्वों का संग्रह। पिछली संगतता के लिए व्यवहार केवल `IMG` तत्वों तक सीमित है। [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224)] के अनुसार, चित्र शामिल करने के लिए लेखक `OBJECT` तत्व या `IMG` तत्व का उपयोग कर सकते हैं। इसलिए, दस्तावेज़ में चित्र खोजने के लिए इस एट्रिब्यूट का उपयोग न करने और HTML 4.01 के साथ `getElementsByTagName` या XHTML 1.0 के साथ `getElementsByTagNameNS` उपयोग करने की सलाह दी जाती है। |
...
| [getLocalName](../../com.aspose.html.dom/node/localname/) इस नोड के योग्य नाम का स्थानीय भाग लौटाता है। किसी भी प्रकार के नोड के लिए, जो [`ELEMENT_NODE`](../../com.aspose.html.dom/node/element_node/) और [`ATTRIBUTE_NODE`](../../com.aspose.html.dom/node/attribute_node/) के अलावा हैं और जो DOM Level 1 विधि जैसे [`Document.createElement()`](../../com.aspose.html.dom/document/createelement/) से बनाए गए हैं, यह हमेशा null होता है। |
...
| [getReferrer](../../com.aspose.html/htmldocument/referrer/) उस पृष्ठ का URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt)] लौटाता है जो इस पृष्ठ से लिंक करता है। यदि उपयोगकर्ता सीधे (लिंक के माध्यम से नहीं, बल्कि उदाहरण के लिए बुकमार्क द्वारा) पृष्ठ पर नेविगेट करता है तो मान एक खाली String होगा। |
...
| [textContent](../../com.aspose.html.dom/node/textcontent/) { get; set; } | `textContent` प्रॉपर्टी [`Node`](../../com.aspose.html.dom/node/) इंटरफ़ेस का नोड और उसके वंशजों की टेक्स्ट सामग्री का प्रतिनिधित्व करती है। |
[getTitle]
...
| [createAttribute](../../com.aspose.html.dom/document/createattribute/)(String) | Document.createAttribute() मेथड एक नया एट्रिब्यूट नोड बनाता है, और उसे लौटाता है। बनाया गया ऑब्जेक्ट एक नोड बनाता है जो [`Attr`](../../com.aspose.html.dom/attr/) इंटरफ़ेस को लागू करता है। DOM इस बात को लागू नहीं करता कि किस प्रकार के एट्रिब्यूट्स को इस तरीके से किसी विशेष तत्व में जोड़ा जा सकता है। |
...
| [createCDATASection](../../com.aspose.html.dom/document/createcdatasection/)(String) | `CDATASection` नोड बनाता है जिसकी वैल्यू निर्दिष्ट स्ट्रिंग है। |
| [createComment](../../com.aspose.html.dom/document/createcomment/)(String) | `Comment` नोड बनाता है जो निर्दिष्ट स्ट्रिंग को लेता है। |
| [createDocumentFragment](../../com.aspose.html.dom/document/createdocumentfragment/)() | एक नया खाली [`DocumentFragment`](../../com.aspose.html.dom/documentfragment/) बनाता है जिसमें DOM नोड्स को जोड़ा जा सकता है ताकि एक ऑफस्क्रीन DOM ट्री बनाया जा सके। |
...
| [createNodeIterator](../../com.aspose.html.dom/document/createnodeiterator/)(Node) | निर्दिष्ट नोड पर मूलित उपवृक्ष के ऊपर एक नया NodeIterator बनाएं। |
| [createNodeIterator](../../com.aspose.html.dom/document/createnodeiterator/)(Node, long) | निर्दिष्ट नोड पर मूलित उपवृक्ष के ऊपर एक नया NodeIterator बनाएं। |
| [createNodeIterator](../../com.aspose.html.dom/document/createnodeiterator/)(Node, long, INodeFilter) | निर्दिष्ट नोड पर मूलित उपवृक्ष के ऊपर एक नया NodeIterator बनाएं। |
...
| [createTreeWalker](../../com.aspose.html.dom/document/createtreewalker/)(Node) | निर्दिष्ट नोड पर मूलित उपवृक्ष के ऊपर एक नया TreeWalker बनाएं। |
| [createTreeWalker](../../com.aspose.html.dom/document/createtreewalker/)(Node, long) | निर्दिष्ट नोड पर मूलित उपवृक्ष के ऊपर एक नया TreeWalker बनाएं। |
| [createTreeWalker](../../com.aspose.html.dom/document/createtreewalker/)(Node, long, INodeFilter) | निर्दिष्ट नोड पर मूलित उपवृक्ष के ऊपर एक नया TreeWalker बनाएं। |
...
| [getElementById](../../com.aspose.html.dom/document/getelementbyid/)(String) | Document मेथड getElementById() एक [`Element`](../../com.aspose.html.dom/element/) ऑब्जेक्ट लौटाता है जो उस तत्व का प्रतिनिधित्व करता है जिसकी id प्रॉपर्टी निर्दिष्ट स्ट्रिंग से मेल खाती है। चूँकि तत्व IDs को विशिष्ट होना आवश्यक है, यह एक विशिष्ट तत्व तक तेज़ी से पहुँचने का उपयोगी तरीका है। |
| [getElementsByClassName](../../com.aspose.html.dom/document/getelementsbyclassname/)(String) | `Document` इंटरफ़ेस की getElementsByClassName मेथड सभी चाइल्ड तत्वों का एक array‑like ऑब्जेक्ट लौटाती है जिनके पास सभी दिए गए क्लास नाम हैं। |
...
| [getOverrideStyle](../../com.aspose.html/htmldocument/getoverridestyle/)(Element, String) | यह मेथड किसी निर्दिष्ट तत्व और किसी निर्दिष्ट pseudo-element के लिए ओवरराइड स्टाइल घोषणा को पुनः प्राप्त करने के लिए उपयोग किया जाता है। |
...
| [navigate](../../com.aspose.html.dom/document/navigate/)(RequestMessage) | निर्दिष्ट अनुरोध ऑब्जेक्ट के आधार पर दस्तावेज़ लोड करता है, पिछले सामग्री को प्रतिस्थापित करता है। |
| [navigate](../../com.aspose.html.dom/document/navigate/)(String) | निर्दिष्ट यूनिफॉर्म रिसोर्स लोकेटर (URL) पर दस्तावेज़ को वर्तमान इंस्टेंस में लोड करता है, पिछले सामग्री को बदलते हुए। |
| [navigate](../../com.aspose.html.dom/document/navigate/)(Url) | निर्दिष्ट यूनिफॉर्म रिसोर्स लोकेटर (URL) पर दस्तावेज़ को वर्तमान इंस्टेंस में लोड करता है, पिछले सामग्री को बदलते हुए। |
...
| [normalize](../../com.aspose.html.dom/node/normalize/)() | सभी [`Text`](../../com.aspose.html.dom/text/) नोड्स को इस नोड के नीचे सब‑ट्री की पूरी गहराई में, गुण नोड्स सहित, एक \"सामान्य\" रूप में रखता है जहाँ केवल संरचना (जैसे, [`elements`](../../com.aspose.html.dom/element/), [`comments`](../../com.aspose.html.dom/comment/), [`processing instructions`](../../com.aspose.html.dom/processinginstruction/), [`CDATA sections`](../../com.aspose.html.dom/cdatasection/), और [`entity references`](../../com.aspose.html.dom/entityreference/)) [`Text`](../../com.aspose.html.dom/text/) नोड्स को अलग करती है, अर्थात् न तो आसन्न Text नोड्स होते हैं और न ही खाली Text नोड्स। यह उपयोग किया जा सकता है यह सुनिश्चित करने के लिए कि किसी दस्तावेज़ का DOM दृश्य उसी तरह हो जैसा कि इसे सहेजा गया हो और पुनः लोड किया गया हो, और यह उपयोगी है जब ऐसे संचालन (जैसे XPointer [XPointer] लुकअप) जो किसी विशिष्ट दस्तावेज़ वृक्ष संरचना पर निर्भर होते हैं, उपयोग किए जाने हों। यदि [`DOMConfiguration`](../configuration/) ऑब्जेक्ट के "normalize-characters" पैरामीटर, जो [`Node.ownerDocument`](../../com.aspose.html.dom/node/ownerdocument/) से जुड़ा है, सत्य है, तो यह विधि Text नोड्स के अक्षरों को भी पूरी तरह से सामान्यीकृत करेगी। |
...
| [renderTo](../../com.aspose.html/htmldocument/renderto/)(IDevice) | यह मेथड वर्तमान दस्तावेज़ की सामग्री को निर्दिष्ट डिवाइस पर प्रिंट करने के लिए उपयोग किया जाता है। |
...
| [save](../../com.aspose.html/htmldocument/save/#save_10)(String) | दस्तावेज़ को निर्दिष्ट पथ वाली स्थानीय फ़ाइल में सहेजता है। इस दस्तावेज़ में उपयोग किए गए सभी संसाधन एक सन्निहित फ़ोल्डर में सहेजे जाएंगे, जिसका नाम इस प्रकार बनाया जाएगा: output_file_name + "_files"। |
| [save](../../com.aspose.html/htmldocument/save/#save_5)(Url) | दस्तावेज़ को URL द्वारा निर्दिष्ट स्थानीय फ़ाइल में सहेजता है। इस दस्तावेज़ में उपयोग किए गए सभी संसाधनों को एक सन्निहित फ़ोल्डर में सहेजा जाएगा, जिसका नाम output_file_name + "_files" के रूप में बनाया जाएगा। |
...
| [save](../../com.aspose.html/htmldocument/save/#save_11)(String, HTMLSaveFormat) | दस्तावेज़ को पथ द्वारा निर्दिष्ट स्थानीय फ़ाइल में सहेजता है। इस दस्तावेज़ में उपयोग किए गए सभी संसाधनों को एक सन्निहित फ़ोल्डर में सहेजा जाएगा, जिसका नाम output_file_name + "_files" के रूप में बनाया जाएगा। |
| [save](../../com.aspose.html/htmldocument/save/#save_12)(String, HTMLSaveOptions) | दस्तावेज़ को निर्दिष्ट पथ वाली स्थानीय फ़ाइल में सहेजता है। इस दस्तावेज़ में उपयोग किए गए सभी संसाधन एक सन्निहित फ़ोल्डर में सहेजे जाएंगे, जिसका नाम इस प्रकार बनाया जाएगा: output_file_name + "_files"। |
| [save](../../com.aspose.html/htmldocument/save/#save_13)(String, MarkdownSaveOptions) | दस्तावेज़ को निर्दिष्ट पथ वाली स्थानीय फ़ाइल में सहेजता है। इस दस्तावेज़ में उपयोग किए गए सभी संसाधन एक सन्निहित फ़ोल्डर में सहेजे जाएंगे, जिसका नाम इस प्रकार बनाया जाएगा: output_file_name + "_files"। |
| [save](../../com.aspose.html/htmldocument/save/#save_14)(String, MHTMLSaveOptions) | दस्तावेज़ को निर्दिष्ट पथ वाली स्थानीय फ़ाइल में सहेजता है। इस दस्तावेज़ में उपयोग किए गए सभी संसाधन एक सन्निहित फ़ोल्डर में सहेजे जाएंगे, जिसका नाम इस प्रकार बनाया जाएगा: output_file_name + "_files"। |
| [save](../../com.aspose.html/htmldocument/save/#save_6)(Url, HTMLSaveFormat) | दस्तावेज़ को URL द्वारा निर्दिष्ट स्थानीय फ़ाइल में सहेजता है। इस दस्तावेज़ में उपयोग किए गए सभी संसाधनों को एक सन्निहित फ़ोल्डर में सहेजा जाएगा, जिसका नाम output_file_name + "_files" के रूप में बनाया जाएगा। |
| [save](../../com.aspose.html/htmldocument/save/#save_7)(Url, HTMLSaveOptions) | दस्तावेज़ को URL द्वारा निर्दिष्ट स्थानीय फ़ाइल में सहेजता है। इस दस्तावेज़ में उपयोग किए गए सभी संसाधनों को एक सन्निहित फ़ोल्डर में सहेजा जाएगा, जिसका नाम इस प्रकार बनाया जाएगा: output_file_name + "_files"। |
| [save](../../com.aspose.html/htmldocument/save/#save_8)(Url, MarkdownSaveOptions) | दस्तावेज़ को URL द्वारा निर्दिष्ट स्थानीय फ़ाइल में सहेजता है। इस दस्तावेज़ में उपयोग किए गए सभी संसाधनों को एक सन्निहित फ़ोल्डर में सहेजा जाएगा, जिसका नाम इस प्रकार बनाया जाएगा: output_file_name + "_files"। |
| [save](../../com.aspose.html/htmldocument/save/#save_9)(Url, MHTMLSaveOptions) | दस्तावेज़ को URL द्वारा निर्दिष्ट स्थानीय फ़ाइल में सहेजता है। इस दस्तावेज़ में उपयोग किए गए सभी संसाधनों को एक सन्निहित फ़ोल्डर में सहेजा जाएगा, जिसका नाम इस प्रकार बनाया जाएगा: output_file_name + "_files"। |
...
```java
    // एक HTML दस्तावेज़ का उदाहरण बनाएं
	using (var document = new HTMLDocument())
      {
        // एक style तत्व बनाएं और class-name 'gr' वाले सभी तत्वों को हरा रंग असाइन करें।
        var style = document.CreateElement("style");
        style.TextContent = ".gr { color: green }";

        // दस्तावेज़ के हेडर तत्व को खोजें और style तत्व को हेडर में जोड़ें
        ...
        // पैराग्राफ को दस्तावेज़ बॉडी तत्व में जोड़ें
