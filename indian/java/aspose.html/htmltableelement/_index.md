---
title: "HTMLTableElement क्लास"
second_title: "Aspose.HTML Java के लिए API संदर्भ"
description: "com.aspose.html.HTMLTableElement क्लास। टेबल पर create और delete मेथड्स लेखकों को टेबल बनाने और संशोधित करने की अनुमति देते हैं। HTML 4.01 निर्दिष्ट करता है कि टेबल में CAPTION, THEAD और TFOOT तत्वों में से प्रत्येक केवल एक ही मौजूद हो सकता है। इसलिए यदि कोई मौजूद है और createTHead या createTFoot मेथड को कॉल किया जाता है तो मेथड मौजूदा THead या TFoot तत्व को लौटाता है। HTML 4.01 में TABLE तत्व की परिभाषा देखें।"
type: docs

url: /hi/java/com.aspose.html/htmltableelement/
---
## HTMLTableElement class

टेबल पर create* और delete* मेथड्स लेखकों को टेबल बनाने और संशोधित करने की अनुमति देते हैं। [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224)] निर्दिष्ट करता है कि टेबल में `CAPTION`, `THEAD` और `TFOOT` तत्वों में से प्रत्येक केवल एक ही मौजूद हो सकता है। इसलिए, यदि वह मौजूद है, और createTHead() या createTFoot() मेथड को कॉल किया जाता है, तो मेथड मौजूदा THead या TFoot तत्व को लौटाता है। देखें TABLE तत्व की परिभाषा HTML 4.01 में।
...
| [getCaption](../../com.aspose.html/htmltableelement/caption/) टेबल का `CAPTION` लौटाता है, या यदि कोई नहीं है तो void। @version DOM Level 2 |
[getCellPadding]
...
| [getRows](../../com.aspose.html/htmltableelement/rows/) टेबल का `TFOOT` लौटाता है, या यदि कोई नहीं है तो `null`। |
[getRules]
...
| [getTBodies](../../com.aspose.html/htmltableelement/tbodies/) टेबल बॉडीज़ (अंतर्निहित सहित) का एक संग्रह लौटाता है। |
...
| [getTFoot](../../com.aspose.html/htmltableelement/tfoot/) टेबल का `THEAD` लौटाता है, या यदि कोई नहीं है तो `null`। |
| [getTHead](../../com.aspose.html/htmltableelement/thead/) टेबल का `CAPTION` लौटाता है, या यदि कोई नहीं है तो void। |
[getTitle]
...
| [createCaption](../../com.aspose.html/htmltableelement/createcaption/)() | एक नया टेबल कैप्शन ऑब्जेक्ट बनाएं या मौजूदा को लौटाएँ। |
| [createTFoot](../../com.aspose.html/htmltableelement/createtfoot/)() | एक टेबल फुटर पंक्ति बनाएं या मौजूदा को लौटाएँ। |
| [createTHead](../../com.aspose.html/htmltableelement/createthead/)() | एक टेबल हेडर पंक्ति बनाएं या मौजूदा को लौटाएँ। |
| [deleteCaption](../../com.aspose.html/htmltableelement/deletecaption/)() | टेबल कैप्शन को हटाएँ, यदि वह मौजूद है। |
| [deleteRow](../../com.aspose.html/htmltableelement/deleterow/)(int) | एक टेबल पंक्ति हटाएँ। |
| [deleteTFoot](../../com.aspose.html/htmltableelement/deletetfoot/)() | टेबल से फुटर हटाएँ, यदि वह मौजूद है। |
| [deleteTHead](../../com.aspose.html/htmltableelement/deletethead/)() | टेबल से हेडर हटाएँ, यदि वह मौजूद है। |
...
| [insertRow](../../com.aspose.html/htmltableelement/insertrow/)(int) | टेबल में एक नई खाली पंक्ति डालें। नई पंक्ति वर्तमान `index`वीं पंक्ति से ठीक पहले और उसी सेक्शन में डाली जाती है। यदि `index` -1 है या पंक्तियों की संख्या के बराबर है, तो नई पंक्ति को अंत में जोड़ा जाता है। अतिरिक्त रूप से, जब टेबल खाली हो तो पंक्ति को एक `TBODY` में डाला जाता है जिसे बनाया जाता है और टेबल में सम्मिलित किया जाता है। टेबल पंक्ति खाली नहीं हो सकती है, जैसा कि [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224)] में बताया गया है। |
