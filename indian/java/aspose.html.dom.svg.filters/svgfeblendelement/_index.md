---
title: "SVGFEBlendElement वर्ग"
second_title: "Aspose.HTML for Java API संदर्भ"
description: "com.aspose.html.dom.svg.filters.SVGFEBlendElement वर्ग। यह SVGFEBlendElement इंटरफ़ेस दिए गए feBlend तत्व के अनुरूप है।"
type: docs

url: /hi/java/com.aspose.html.dom.svg.filters/svgfeblendelement/
---
## SVGFEBlendElement class

यह SVGFEBlendElement इंटरफ़ेस ‘feBlend’ तत्व के अनुरूप है।
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfeblendelement/height/) दिए गए ‘filter’ तत्व पर ‘height’ विशेषता के अनुरूप है। |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfeblendelement/in1/) दिए गए ‘feBlend’ तत्व पर ‘in’ विशेषता के अनुरूप है। |
| [getIn2](../../com.aspose.html.dom.svg.filters/svgfeblendelement/in2/) दिए गए ‘feBlend’ तत्व पर ‘in2’ विशेषता के अनुरूप है। |
[getInnerHTML]
...
| [getMode](../../com.aspose.html.dom.svg.filters/svgfeblendelement/mode/) दिए गए ‘feBlend’ तत्व पर ‘mode’ विशेषता के अनुरूप है। यह इंटरफ़ेस पर परिभाषित SVG_FEBLEND_MODE_* स्थिरांक में से एक लेता है। |
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfeblendelement/result/) दिए गए ‘filter’ तत्व पर ‘result’ विशेषता के अनुरूप है। |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfeblendelement/width/) दिए गए ‘filter’ तत्व पर ‘width’ विशेषता के अनुरूप है। |
| [X](../../com.aspose.html.dom.svg.filters/svgfeblendelement/x/) { get; } | दिए गए ‘filter’ एलिमेंट के ‘x’ एट्रिब्यूट से मेल खाता है। |
| [Y](../../com.aspose.html.dom.svg.filters/svgfeblendelement/y/) { get; } | दिए गए ‘filter’ एलिमेंट के ‘y’ एट्रिब्यूट से मेल खाता है। |
...
| नाम | विवरण |
| --- | --- |
| const [SVG_FEBLEND_MODE_COLOR](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_color/) | 'color' मान के अनुरूप है। |
| const [SVG_FEBLEND_MODE_COLOR_BURN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_color_burn/) | 'color_burn' मान के अनुरूप है। |
| const [SVG_FEBLEND_MODE_COLOR_DODGE](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_color_dodge/) | 'color_dodge' मान के अनुरूप है। |
| const [SVG_FEBLEND_MODE_DARKEN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_darken/) | 'darken' मान के अनुरूप है। |
| const [SVG_FEBLEND_MODE_DIFFERENCE](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_difference/) | 'difference' मान के अनुरूप है। |
| const [SVG_FEBLEND_MODE_EXCLUSION](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_exclusion/) | 'exclusion' मान के अनुरूप है। |
| const [SVG_FEBLEND_MODE_HARD_LIGHT](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_hard_light/) | 'hard_light' मान के अनुरूप है। |
| const [SVG_FEBLEND_MODE_HUE](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_hue/) | मान 'hue' के अनुरूप है। |
| const [SVG_FEBLEND_MODE_LIGHTEN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_lighten/) | मान 'lighten' के अनुरूप है। |
| const [SVG_FEBLEND_MODE_LUMINOSITY](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_luminosity/) | मान 'luminosity' के अनुरूप है। |
| const [SVG_FEBLEND_MODE_MULTIPLY](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_multiply/) | मान 'multiply' के अनुरूप है। |
| const [SVG_FEBLEND_MODE_NORMAL](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_normal/) | मान 'normal' के अनुरूप है। |
| const [SVG_FEBLEND_MODE_OVERLAY](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_overlay/) | मान 'overlay' के अनुरूप है। |
| const [SVG_FEBLEND_MODE_SATURATION](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_saturation/) | मान 'saturation' के अनुरूप है। |
| const [SVG_FEBLEND_MODE_SCREEN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_screen/) | मान 'screen' के अनुरूप है। |
| const [SVG_FEBLEND_MODE_SOFT_LIGHT](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_soft_light/) | मान 'soft_light' के अनुरूप है। |
| const [SVG_FEBLEND_MODE_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_unknown/) | यह प्रकार पूर्वनिर्धारित प्रकारों में से नहीं है। इस प्रकार का नया मान परिभाषित करने या मौजूदा मान को इस प्रकार में बदलने का प्रयास अवैध है। |
