...
description: "com.aspose.html.dom.events.UIEvent क्लास। UIEvent इंटरफ़ेस उपयोगकर्ता इंटरफ़ेस इवेंट्स से संबंधित विशिष्ट संदर्भात्मक जानकारी प्रदान करता है।"
type: docs
...
UIEvent इंटरफ़ेस यूज़र इंटरफ़ेस इवेंट्स से संबंधित विशिष्ट संदर्भात्मक जानकारी प्रदान करता है।
...
| नाम | विवरण |
| --- | --- |
| [UIEvent](uievent/#constructor)(String) | एक नया `UIEvent` क्लास का उदाहरण प्रारंभ करता है। |
