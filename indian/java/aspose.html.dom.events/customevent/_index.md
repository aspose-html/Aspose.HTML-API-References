---
title: "CustomEvent क्लास"
second_title: "Aspose.HTML for Java API संदर्भ"
description: "com.aspose.html.dom.events.CustomEvent क्लास। CustomEvent इंटरफ़ेस का उपयोग करने वाले इवेंट्स को कस्टम डेटा ले जाने के लिए उपयोग किया जा सकता है।"
type: docs
...
CustomEvent इंटरफ़ेस का उपयोग करने वाले इवेंट्स को कस्टम डेटा ले जाने के लिए उपयोग किया जा सकता है।
...
| नाम | विवरण |
| --- | --- |
| [CustomEvent](customevent/#constructor)(String) | एक नया `CustomEvent` क्लास का उदाहरण प्रारंभ करता है। |
...
| [getDetail](../../com.aspose.html.dom.events/customevent/detail/) कस्टम डेटा प्राप्त करता है। |
...
| [initCustomEvent](../../com.aspose.html.dom.events/customevent/initcustomevent/)(String, bool, bool, object) | /// यह [`InitEvent`](../event/initevent/) विधि एक [`Event`](../event/) के मान को प्रारंभ करने के लिए उपयोग की जाती है जो [`IDocumentEvent`](../idocumentevent/) इंटरफ़ेस के माध्यम से बनाया गया है। |
