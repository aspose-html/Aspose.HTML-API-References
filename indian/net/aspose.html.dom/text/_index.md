...
description: Aspose.Html.Dom.Text कक्ष. टेक्स्ट इंटरफ़ेस कैरेक्टरडेट से प्रप्त हत है और कस तत्व य Attr. क पठ्य समग्र XML में वर्ण डेट कह जत है क प्रतनधत्व करत है
type: docs
weight: 2450
url: /hi/net/aspose.html.dom/text/
---
## Text class

टेक्स्ट इंटरफ़ेस कैरेक्टरडेटा से प्राप्त होता है और किसी तत्व या Attr. की पाठ्य सामग्री (XML में वर्ण डेटा कहा जाता है) का प्रतिनिधित्व करता है
...
| virtual [Data](../../aspose.html.dom/characterdata/data/) { get; set; } | इस इंटरफ़ेस को लागू करने वाले नोड का वर्ण डेटा। |
| [FirstChild](../../aspose.html.dom/node/firstchild/) { get; } | इस नोड का पहला चाइल्ड। यदि ऐसा कोई नोड नहीं है, तो यह शून्य वापस आ जाता है। |
| [IsElementContentWhitespace](../../aspose.html.dom/text/iselementcontentwhitespace/) { get; } | लौटाता है कि क्या इस टेक्स्ट नोड में एलिमेंट कंटेंट व्हाइटस्पेस है, जिसे अक्सर अपमानजनक रूप से "इग्नोरेबल व्हाइटस्पेस" कहा जाता है। |
| [LastChild](../../aspose.html.dom/node/lastchild/) { get; } | इस नोड का अंतिम बच्चा। यदि ऐसा कोई नोड नहीं है, तो यह शून्य वापस आ जाता है। |
| [Length](../../aspose.html.dom/characterdata/length/) { get; } | 16-बिट इकाइयों की संख्या जो डेटा और सबस्ट्रिंगडेटा विधि के माध्यम से उपलब्ध हैं। इसका मान शून्य हो सकता है, अर्थात, कैरेक्टरडेटा नोड खाली हो सकता है। |
...
| override [NodeName](../../aspose.html.dom/text/nodename/) { get; } | इस नोड का नाम, इसके प्रकार पर निर्भर करता है। |
| override [NodeType](../../aspose.html.dom/text/nodetype/) { get; } | अंतर्निहित वस्तु के प्रकार का प्रतिनिधित्व करने वाला एक कोड। |
| override [NodeValue](../../aspose.html.dom/text/nodevalue/) { get; set; } | इस नोड का मान, इसके प्रकार पर निर्भर करता है। |
...
| [WholeText](../../aspose.html.dom/text/wholetext/) { get; } | टेक्स्ट नोड्स के सभी टेक्स्ट को तार्किक रूप से आसन्न टेक्स्ट नोड्स को इस नोड में लौटाता है, जो दस्तावेज़ क्रम में जुड़ा हुआ है। |
...
| virtual [AppendData](../../aspose.html.dom/characterdata/appenddata/)(string) | नोड के वर्ण डेटा के अंत में स्ट्रिंग जोड़ें। |
...
| virtual [DeleteData](../../aspose.html.dom/characterdata/deletedata/)(int, int) | नोड से 16-बिट इकाइयों की श्रेणी निकालें। |
...
| virtual [InsertData](../../aspose.html.dom/characterdata/insertdata/)(int, string) | निर्दिष्ट 16-बिट इकाई ऑफ़सेट पर एक स्ट्रिंग डालें. |
...
| virtual [ReplaceData](../../aspose.html.dom/characterdata/replacedata/)(int, int, string) | निर्दिष्ट स्ट्रिंग के साथ निर्दिष्ट 16-बिट इकाई ऑफ़सेट पर शुरू होने वाले वर्णों को बदलें। |
| [ReplaceWholeText](../../aspose.html.dom/text/replacewholetext/)(string) | निर्दिष्ट पाठ के साथ वर्तमान नोड और सभी तार्किक रूप से आसन्न पाठ नोड्स के पाठ को प्रतिस्थापित करता है। सभी तार्किक रूप से आसन्न पाठ नोड्स को वर्तमान नोड सहित हटा दिया जाता है जब तक कि यह प्रतिस्थापन पाठ का प्राप्तकर्ता नहीं था। |
| [SplitText](../../aspose.html.dom/text/splittext/)(int) | निर्दिष्ट ऑफसेट पर इस नोड को दो नोड्स में तोड़ता है, दोनों को पेड़ में भाई-बहन के रूप में रखता है। |
| virtual [SubstringData](../../aspose.html.dom/characterdata/substringdata/)(int, int) | नोड से डेटा की एक श्रेणी निकालता है। |
| override [ToString](../../aspose.html.dom/characterdata/tostring/)() | रिटर्न एString जो इस उदाहरण का प्रतिनिधित्व करता है। |
