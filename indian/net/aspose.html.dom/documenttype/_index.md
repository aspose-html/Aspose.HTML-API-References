...
description: Aspose.Html.Dom.DocumentType कक्ष. दस्तवेज़ प्रकर उन संस्थओं क सूच के लए एक इंटरफ़ेस प्रदन करत है ज दस्तवेज़ के लए परभषत हैं
type: docs
weight: 680
url: /hi/net/aspose.html.dom/documenttype/
---
## DocumentType class

दस्तावेज़ प्रकार उन संस्थाओं की सूची के लिए एक इंटरफ़ेस प्रदान करता है जो दस्तावेज़ के लिए परिभाषित हैं
...
| नाम | विवरण |
| --- | --- |
| [DocumentType](documenttype/)(string, string, string, string, Document) | का एक नया उदाहरण प्रारंभ करता है`DocumentType` वर्ग. |
...
| [InternalSubset](../../aspose.html.dom/documenttype/internalsubset/) { get; } | एक स्ट्रिंग के रूप में आंतरिक उपसमुच्चय, या कोई नहीं होने पर अशक्त। |
...
| [Name](../../aspose.html.dom/documenttype/name/) { get; } | डीटीडी का नाम; यानी, DOCTYPE कीवर्ड के तुरंत बाद का नाम. |
...
| override [NodeName](../../aspose.html.dom/documenttype/nodename/) { get; } | इस नोड का नाम, इसके प्रकार पर निर्भर करता है। |
| override [NodeType](../../aspose.html.dom/documenttype/nodetype/) { get; } | अंतर्निहित वस्तु के प्रकार का प्रतिनिधित्व करने वाला एक कोड। |
...
| [PublicId](../../aspose.html.dom/documenttype/publicid/) { get; } | बाहरी उपसमुच्चय का सार्वजनिक पहचानकर्ता. |
| [SystemId](../../aspose.html.dom/documenttype/systemid/) { get; } | बाहरी सबसेट का सिस्टम पहचानकर्ता। यह पूर्ण यूआरआई हो सकता है या नहीं. |
...
| override [ToString](../../aspose.html.dom/documenttype/tostring/)() | रिटर्न एString जो इस उदाहरण का प्रतिनिधित्व करता है। |
