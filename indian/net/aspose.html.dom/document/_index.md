...
description: Aspose.Html.Dom.Document कक्ष. दस्तवेज़ संपूर्ण HTML XML य SVG दस्तवेज़ क प्रतनधत्व करत है संकल्पनत्मक रूप से यह दस्तवेज़ वृक्ष क मूल है और दस्तवेज़ के डेट तक प्रथमक पहुँच प्रदन करत है
type: docs
weight: 660
url: /hi/net/aspose.html.dom/document/
---
## Document class
...
| [CreateNodeIterator](../../aspose.html.dom/document/createnodeiterator/#createnodeiterator)(Node) | निर्दिष्ट नोड पर रूट किए गए सबट्री पर एक नया नोडइटरेटर बनाएं। |
| [CreateNodeIterator](../../aspose.html.dom/document/createnodeiterator/#createnodeiterator_1)(Node, long) | निर्दिष्ट नोड पर रूट किए गए सबट्री पर एक नया नोडइटरेटर बनाएं। |
| [CreateNodeIterator](../../aspose.html.dom/document/createnodeiterator/#createnodeiterator_2)(Node, long, INodeFilter) | निर्दिष्ट नोड पर रूट किए गए सबट्री पर एक नया नोडइटरेटर बनाएं। |
...
| [CreateTreeWalker](../../aspose.html.dom/document/createtreewalker/#createtreewalker)(Node) | निर्दिष्ट नोड पर रूट किए गए सबट्री पर एक नया ट्रीवॉकर बनाएं। |
| [CreateTreeWalker](../../aspose.html.dom/document/createtreewalker/#createtreewalker_1)(Node, long) | निर्दिष्ट नोड पर रूट किए गए सबट्री पर एक नया ट्रीवॉकर बनाएं। |
| [CreateTreeWalker](../../aspose.html.dom/document/createtreewalker/#createtreewalker_2)(Node, long, INodeFilter) | निर्दिष्ट नोड पर रूट किए गए सबट्री पर एक नया ट्रीवॉकर बनाएं। |
...
| [Navigate](../../aspose.html.dom/document/navigate/#navigate)(RequestMessage) | निर्दिष्ट अनुरोध वस्तु के आधार पर दस्तावेज़ को लोड करता है, पिछली सामग्री को प्रतिस्थापित करता है। |
| [Navigate](../../aspose.html.dom/document/navigate/#navigate_4)(string) | निर्दिष्ट यूनिफ़ॉर्म रिसोर्स लोकेटर (URL) पर दस्तावेज़ को वर्तमान उदाहरण में लोड करता है, पिछली सामग्री को प्रतिस्थापित करता है। |
| [Navigate](../../aspose.html.dom/document/navigate/#navigate_1)(Url) | निर्दिष्ट यूनिफ़ॉर्म रिसोर्स लोकेटर (URL) पर दस्तावेज़ को वर्तमान उदाहरण में लोड करता है, पिछली सामग्री को प्रतिस्थापित करता है। |
| [Navigate](../../aspose.html.dom/document/navigate/#navigate_3)(Stream, string) | दस्तावेज़ को निर्दिष्ट सामग्री से लोड करता है और संबंधित संसाधनों को हल करने के लिए बेसयूरी का उपयोग करता है, पिछली सामग्री को प्रतिस्थापित करता है। दस्तावेज़ लोडिंग स्ट्रीम में वर्तमान स्थिति से शुरू होती है। |
| [Navigate](../../aspose.html.dom/document/navigate/#navigate_2)(Stream, Url) | दस्तावेज़ को निर्दिष्ट सामग्री से लोड करता है और संबंधित संसाधनों को हल करने के लिए बेसयूरी का उपयोग करता है, पिछली सामग्री को प्रतिस्थापित करता है। दस्तावेज़ लोडिंग स्ट्रीम में वर्तमान स्थिति से शुरू होती है। |
| [Navigate](../../aspose.html.dom/document/navigate/#navigate_6)(string, string) | निर्दिष्ट सामग्री से दस्तावेज़ लोड करता है और संबंधित संसाधनों को हल करने के लिए बेसयूरी का उपयोग करता है, पिछली सामग्री को प्रतिस्थापित करता है। |
| [Navigate](../../aspose.html.dom/document/navigate/#navigate_5)(string, Url) | निर्दिष्ट सामग्री से दस्तावेज़ लोड करता है और संबंधित संसाधनों को हल करने के लिए बेसयूरी का उपयोग करता है, पिछली सामग्री को प्रतिस्थापित करता है। |
...
| virtual [RenderTo](../../aspose.html.dom/document/renderto/)(IDevice) | इस पद्धति का उपयोग वर्तमान दस्तावेज़ की सामग्री को एक निर्दिष्ट ग्राफ़िकल डिवाइस में प्रस्तुत करने के लिए किया जाता है। |
