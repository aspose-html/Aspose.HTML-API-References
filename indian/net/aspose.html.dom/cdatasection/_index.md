...
description: Aspose.Html.Dom.CDATASection कक्ष. सडएटए अनुभगं क उपयग अक्षरं वले टेक्स्ट के ब्लक से बचने के लए कय जत है जसे अन्यथ मर्कअप के रूप में मन जएग
type: docs
weight: 200
url: /hi/net/aspose.html.dom/cdatasection/
---
## CDATASection class
...
| override [NodeName](../../aspose.html.dom/cdatasection/nodename/) { get; } | इस नोड का नाम, इसके प्रकार पर निर्भर करता है। |
| override [NodeType](../../aspose.html.dom/cdatasection/nodetype/) { get; } | अंतर्निहित वस्तु के प्रकार का प्रतिनिधित्व करने वाला एक कोड। |
