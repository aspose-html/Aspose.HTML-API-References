...
description: Aspose.Html.Dom.Comment कक्ष. कैरेक्टरडेट से वरसत में मलत है और एक टप्पण क समग्र क प्रतनधत्व करत है यन शुरुआत के बच के सभ वर्ण .
type: docs
weight: 310
url: /hi/net/aspose.html.dom/comment/
---
## Comment class

कैरेक्टरडेटा से विरासत में मिलता है और एक टिप्पणी की सामग्री का प्रतिनिधित्व करता है, यानी, शुरुआती 'के बीच के सभी वर्ण .
...
| override [NodeName](../../aspose.html.dom/comment/nodename/) { get; } | इस नोड का नाम, इसके प्रकार पर निर्भर करता है। |
| override [NodeType](../../aspose.html.dom/comment/nodetype/) { get; } | अंतर्निहित वस्तु के प्रकार का प्रतिनिधित्व करने वाला एक कोड। |
| override [NodeValue](../../aspose.html.dom/comment/nodevalue/) { get; set; } | इस नोड का मान, इसके प्रकार पर निर्भर करता है। |
