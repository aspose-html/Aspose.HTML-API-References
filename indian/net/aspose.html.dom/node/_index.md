...
description: Aspose.Html.Dom.Node कक्ष. नड इंटरफ़ेस संपूर्ण दस्तवेज़ ऑब्जेक्ट मडल के लए प्रथमक डेट प्रकर है यह दस्तवेज़ ट्र में एकल नड क प्रतनधत्व करत है.
type: docs
weight: 1000
url: /hi/net/aspose.html.dom/node/
---
## Node class
...
| abstract [NodeName](../../aspose.html.dom/node/nodename/) { get; } | इस नोड का नाम, इसके प्रकार पर निर्भर करता है। |
| abstract [NodeType](../../aspose.html.dom/node/nodetype/) { get; } | अंतर्निहित वस्तु के प्रकार का प्रतिनिधित्व करने वाला एक कोड। |
...
| [CloneNode](../../aspose.html.dom/node/clonenode/#clonenode)() | इस नोड का एक डुप्लिकेट लौटाता है, अर्थात, नोड्स के लिए एक सामान्य कॉपी कंस्ट्रक्टर के रूप में कार्य करता है। डुप्लिकेट नोड का कोई पैरेंट नहीं है (parentNode खाली है) और कोई उपयोगकर्ता डेटा नहीं है। |
| [CloneNode](../../aspose.html.dom/node/clonenode/#clonenode_1)(bool) | इस नोड का एक डुप्लिकेट लौटाता है, अर्थात, नोड्स के लिए एक सामान्य कॉपी कंस्ट्रक्टर के रूप में कार्य करता है। डुप्लिकेट नोड का कोई पैरेंट नहीं है (parentNode खाली है) और कोई उपयोगकर्ता डेटा नहीं है। |
...
| नाम | विवरण |
| --- | --- |
| const [ATTRIBUTE_NODE](../../aspose.html.dom/node/attribute_node/) | एक विशेषता नोड |
| const [CDATA_SECTION_NODE](../../aspose.html.dom/node/cdata_section_node/) | एक cdata अनुभाग नोड |
| const [COMMENT_NODE](../../aspose.html.dom/node/comment_node/) | एक टिप्पणी नोड |
| const [DOCUMENT_FRAGMENT_NODE](../../aspose.html.dom/node/document_fragment_node/) | एक दस्तावेज़ खंड नोड |
| const [DOCUMENT_NODE](../../aspose.html.dom/node/document_node/) | एक दस्तावेज़ नोड |
| const [DOCUMENT_TYPE_NODE](../../aspose.html.dom/node/document_type_node/) | एक दस्तावेज़ प्रकार नोड |
| const [ELEMENT_NODE](../../aspose.html.dom/node/element_node/) | एक तत्व नोड |
| const [ENTITY_NODE](../../aspose.html.dom/node/entity_node/) | एक इकाई नोड |
| const [ENTITY_REFERENCE_NODE](../../aspose.html.dom/node/entity_reference_node/) | एक इकाई संदर्भ नोड |
| const [NOTATION_NODE](../../aspose.html.dom/node/notation_node/) | एक संकेतन नोड |
| const [PROCESSING_INSTRUCTION_NODE](../../aspose.html.dom/node/processing_instruction_node/) | एक प्रोसेसिंग निर्देश नोड |
| const [TEXT_NODE](../../aspose.html.dom/node/text_node/) | एक टेक्स्ट नोड |
