...
description: Aspose.Html.Dom.Element कक्ष. एलमेंट इंटरफ़ेस HTML य XML दस्तवेज़ में एक तत्व क प्रतनधत्व करत है
type: docs
weight: 690
url: /hi/net/aspose.html.dom/element/
---
## Element class

एलिमेंट इंटरफ़ेस HTML या XML दस्तावेज़ में एक तत्व का प्रतिनिधित्व करता है।
...
| नाम | विवरण |
| --- | --- |
| [Element](element/)(IElementInit) | का एक नया उदाहरण प्रारंभ करता है`Element`कक्षा। इस कन्स्ट्रक्टर को सीधे कॉल न करें, उपयोग करें[`CreateElement`](../document/createelement/) या[`CreateElementNS`](../document/createelementns/) . |
...
| [Id](../../aspose.html.dom/element/id/) { get; set; } | तत्व का पहचानकर्ता। HTML 4.01. में आईडी विशेषता परिभाषा देखें |
...
| [ParentElement](../../aspose.html.dom/node/parentelement/) { get; } | माता-पिता को प्राप्त करता है`Element` इस नोड का. |
