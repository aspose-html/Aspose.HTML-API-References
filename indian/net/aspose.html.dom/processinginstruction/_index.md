...
description: Aspose.Html.Dom.ProcessingInstruction कक्ष. प्रसेसंग इंस्ट्रक्शन एक प्रसेसंग इंस्ट्रक्शन क प्रतनधत्व करत है जसक उपयग XML में दस्तवेज़ के टेक्स्ट में प्रसेसरवशष्ट जनकर रखने के तरके के रूप में कय जत है
type: docs
weight: 1020
url: /hi/net/aspose.html.dom/processinginstruction/
---
## ProcessingInstruction class

प्रोसेसिंग इंस्ट्रक्शन एक "प्रोसेसिंग इंस्ट्रक्शन" का प्रतिनिधित्व करता है, जिसका उपयोग XML में दस्तावेज़ के टेक्स्ट में प्रोसेसर-विशिष्ट जानकारी रखने के तरीके के रूप में किया जाता है।
...
| override [NodeName](../../aspose.html.dom/processinginstruction/nodename/) { get; } | इस नोड का नाम, इसके प्रकार पर निर्भर करता है। |
| override [NodeType](../../aspose.html.dom/processinginstruction/nodetype/) { get; } | अंतर्निहित वस्तु के प्रकार का प्रतिनिधित्व करने वाला एक कोड। |
| override [NodeValue](../../aspose.html.dom/processinginstruction/nodevalue/) { get; set; } | इस नोड का मान, इसके प्रकार पर निर्भर करता है। |
...
| [Target](../../aspose.html.dom/processinginstruction/target/) { get; } | इस प्रसंस्करण निर्देश का लक्ष्य। |
| override [TextContent](../../aspose.html.dom/processinginstruction/textcontent/) { get; set; } | यह विशेषता इस नोड और उसके वंश की पाठ्य सामग्री लौटाती है। जब इसे शून्य के रूप में परिभाषित किया जाता है, तो इसे सेट करने का कोई प्रभाव नहीं पड़ता है। सेट करने पर, इस नोड के किसी भी संभावित बच्चे को हटा दिया जा सकता है और, यदि यह नया स्ट्रिंग खाली या शून्य नहीं है, तो इस विशेषता को सेट करने वाले स्ट्रिंग वाले एकल टेक्स्ट नोड द्वारा प्रतिस्थापित किया जाता है। |
