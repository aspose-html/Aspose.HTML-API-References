...
description: Aspose.Html.Dom.CharacterData कक्ष. कैरेक्टरडट डओएम में कैरेक्टर डेट तक पहुंचने के लए वशेषतओं और वधयं के एक सेट के सथ नड क वस्तर करत है
type: docs
weight: 300
url: /hi/net/aspose.html.dom/characterdata/
---
## CharacterData class

कैरेक्टरडाटा डीओएम में कैरेक्टर डेटा तक पहुंचने के लिए विशेषताओं और विधियों के एक सेट के साथ नोड का विस्तार करता है।
