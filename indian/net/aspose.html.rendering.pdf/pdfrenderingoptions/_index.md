...
description: Aspose.Html.Rendering.Pdf.PdfRenderingOptions कक्ष. के लए रेंडरंग वकल्पं क प्रतनधत्व करत हैPdfDevice .
type: docs
weight: 4470
url: /hi/net/aspose.html.rendering.pdf/pdfrenderingoptions/
---
## PdfRenderingOptions class

के लिए रेंडरिंग विकल्पों का प्रतिनिधित्व करता है[`PdfDevice`](../pdfdevice/) .
...
| नाम | विवरण |
| --- | --- |
| [PdfRenderingOptions](pdfrenderingoptions/)() | का एक नया उदाहरण प्रारंभ करता है`PdfRenderingOptions` वर्ग. |
...
| [DocumentInfo](../../aspose.html.rendering.pdf/pdfrenderingoptions/documentinfo/) { get; } | में आउटपुट पीडीएफ दस्तावेज़ के बारे में जानकारी शामिल है। |
| [Encryption](../../aspose.html.rendering.pdf/pdfrenderingoptions/encryption/) { get; set; } | एन्क्रिप्शन विवरण प्राप्त या सेट करता है। यदि सेट नहीं है, तो कोई एन्क्रिप्शन नहीं किया जाएगा. |
| [FormFieldBehaviour](../../aspose.html.rendering.pdf/pdfrenderingoptions/formfieldbehaviour/) { get; set; } | आउटपुट PDF दस्तावेज़ में प्रपत्र फ़ील्ड के व्यवहार को निर्दिष्ट करता है। |
...
| [JpegQuality](../../aspose.html.rendering.pdf/pdfrenderingoptions/jpegquality/) { get; set; } | छवियों के लिए जेपीईजी संपीड़न की गुणवत्ता निर्दिष्ट करता है (यदि जेपीईजी संपीड़न का उपयोग किया जाता है)। डिफ़ॉल्ट 95 है। |
