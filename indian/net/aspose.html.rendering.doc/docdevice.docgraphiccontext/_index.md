...
description: Aspose.Html.Rendering.Doc.DocDeviceDocGraphicContext कक्ष. DocDevice के लए वर्तमन ग्रफक्स नयंत्रण पैरमटर रखत है ये पैरमटर वैश्वक ढंचे क परभषत करते हैं जसके भतर ग्रफक्स ऑपरेटर नष्पदत करते हैं
type: docs
weight: 4180
url: /hi/net/aspose.html.rendering.doc/docdevice.docgraphiccontext/
---
## DocDevice.DocGraphicContext class

DocDevice के लिए वर्तमान ग्राफिक्स नियंत्रण पैरामीटर रखता है। ये पैरामीटर वैश्विक ढांचे को परिभाषित करते हैं जिसके भीतर ग्राफिक्स ऑपरेटर निष्पादित करते हैं।
...
| नाम | विवरण |
| --- | --- |
| [DocGraphicContext](docgraphiccontext/)() | डिफ़ॉल्ट कंस्ट्रक्टर। |
...
| override [TransformationMatrix](../../aspose.html.rendering.doc/docgraphiccontext/transformationmatrix/) { get; set; } | परिवर्तन मैट्रिक्स सेट या प्राप्त करता है। |

## तरीकों

| नाम | विवरण |
| --- | --- |
| override [Clone](../../aspose.html.rendering.doc/docgraphiccontext/clone/)() | का एक नया उदाहरण बनाता है[`GraphicContext`](../../aspose.html.rendering/graphiccontext/) एक मौजूदा उदाहरण के रूप में एक ही संपत्ति मूल्यों के साथ वर्ग। |
| override [Transform](../../aspose.html.rendering.doc/docgraphiccontext/transform/)(Matrix) | निर्दिष्ट मैट्रिक्स को गुणा करके वर्तमान परिवर्तन मैट्रिक्स को संशोधित करें। |
