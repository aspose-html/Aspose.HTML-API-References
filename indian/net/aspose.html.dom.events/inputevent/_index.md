...
description: Aspose.Html.Dom.Events.InputEvent कक्ष. जब भ DOM क अपडेट कय ज रह हत है त इनपुट इवेंट नटफकेशन के रूप में भेजे जते हैं
type: docs
weight: 820
url: /hi/net/aspose.html.dom.events/inputevent/
---
## InputEvent class
...
| [Data](../../aspose.html.dom.events/inputevent/data/) { get; } | डेटा एक इनपुट विधि द्वारा उत्पन्न वर्णों का मान रखता है। यह एक एकल यूनिकोड वर्ण या यूनिकोड वर्ण [यूनिकोड] का एक गैर-रिक्त अनुक्रम हो सकता है। [UAX15] में परिभाषित यूनिकोड सामान्यीकरण फॉर्म एनएफसी द्वारा परिभाषित वर्णों को सामान्यीकृत किया जाना चाहिए। इस विशेषता में खाली स्ट्रिंग हो सकती है। |
...
| [IsComposing](../../aspose.html.dom.events/inputevent/iscomposing/) { get; } | सच है अगर इनपुट इवेंट कंपोजिशन सेशन के हिस्से के रूप में होता है, यानी कंपोजिशनस्टार्ट इवेंट के बाद और संबंधित कंपोज़िशनएंड इवेंट से पहले। इस विशेषता का गैर-प्रारंभिक मान गलत होना चाहिए। |
