...
description: Aspose.Html.Dom.Events.FocusEvent कक्ष. फकसइवेंट इंटरफ़ेस फकस इवेंट्स से जुड़ वशष्ट प्रसंगक जनकर प्रदन करत है
type: docs
weight: 780
url: /hi/net/aspose.html.dom.events/focusevent/
---
## FocusEvent class
...
| [RelatedTarget](../../aspose.html.dom.events/focusevent/relatedtarget/) { get; } | इवेंट के प्रकार के आधार पर फ़ोकस ईवेंट से संबंधित द्वितीयक ईवेंट लक्ष्य की पहचान करने के लिए उपयोग किया जाता है। |
