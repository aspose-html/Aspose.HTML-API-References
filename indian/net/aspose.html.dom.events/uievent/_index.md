...
description: Aspose.Html.Dom.Events.UIEvent कक्ष. UIEvent इंटरफ़ेस उपयगकर्त इंटरफ़ेस ईवेंट से संबंधत वशष्ट प्रसंगक जनकर प्रदन करत है
type: docs
weight: 850
url: /hi/net/aspose.html.dom.events/uievent/
---
## UIEvent class

UIEvent इंटरफ़ेस उपयोगकर्ता इंटरफ़ेस ईवेंट से संबंधित विशिष्ट प्रासंगिक जानकारी प्रदान करता है।
...
| नाम | विवरण |
| --- | --- |
| [UIEvent](uievent/#constructor)(string) | का एक नया उदाहरण प्रारंभ करता है`UIEvent` वर्ग. |
| [UIEvent](uievent/#constructor_1)(string, IDictionary&lt;string, object&gt;) | का एक नया उदाहरण प्रारंभ करता है`UIEvent` वर्ग. |
