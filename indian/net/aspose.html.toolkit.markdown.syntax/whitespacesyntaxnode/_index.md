...
description: Aspose.Html.Toolkit.Markdown.Syntax.WhitespaceSyntaxNode कक्ष. व्हट्सएप संटैक्स नड क प्रतनधत्व करत है
type: docs
weight: 5740
url: /hi/net/aspose.html.toolkit.markdown.syntax/whitespacesyntaxnode/
---
## WhitespaceSyntaxNode class

व्हॉट्सएप सिंटैक्स नोड का प्रतिनिधित्व करता है।
...
| नाम | विवरण |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/whitespacesyntaxnode/accept/)(MarkdownSyntaxVisitor) | सिंटैक्स के विज़िटिंग नोड्स के लिए इंटरफ़ेस को परिभाषित करता है। |
