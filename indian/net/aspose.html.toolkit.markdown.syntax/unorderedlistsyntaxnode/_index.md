...
description: Aspose.Html.Toolkit.Markdown.Syntax.UnorderedListSyntaxNode कक्ष. अनयंत्रत सूच संटैक्स नड क प्रतनधत्व करत है
type: docs
weight: 5730
url: /hi/net/aspose.html.toolkit.markdown.syntax/unorderedlistsyntaxnode/
---
## UnorderedListSyntaxNode class

अनियंत्रित सूची सिंटैक्स नोड का प्रतिनिधित्व करता है।
...
| नाम | विवरण |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/unorderedlistsyntaxnode/accept/)(MarkdownSyntaxVisitor) | सिंटैक्स के विज़िटिंग नोड्स के लिए इंटरफ़ेस को परिभाषित करता है। |
...
| [GetMarker](../../aspose.html.toolkit.markdown.syntax/unorderedlistsyntaxnode/getmarker/)() | मार्कर प्राप्त करने के लिए इंटरफ़ेस को परिभाषित करता है। |
