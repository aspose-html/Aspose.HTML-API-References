...
description: ParagraphSyntaxNode तरक. आगंतुक क स्वकृत के लए इंटरफ़ेस क परभषत करत है
type: docs
weight: 10
url: /hi/net/aspose.html.toolkit.markdown.syntax/paragraphsyntaxnode/accept/
---
## ParagraphSyntaxNode.Accept method

आगंतुक की स्वीकृति के लिए इंटरफ़ेस को परिभाषित करता है।
...
* नाम स्थान [Aspose.Html.Toolkit.Markdown.Syntax](../../paragraphsyntaxnode/)
* सभा [Aspose.HTML](../../../)
