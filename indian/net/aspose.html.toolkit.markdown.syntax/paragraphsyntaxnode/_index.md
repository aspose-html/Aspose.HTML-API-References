...
description: Aspose.Html.Toolkit.Markdown.Syntax.ParagraphSyntaxNode कक्ष. पैरग्रफ संटैक्स नड क प्रतनधत्व करें
type: docs
weight: 5310
url: /hi/net/aspose.html.toolkit.markdown.syntax/paragraphsyntaxnode/
---
## ParagraphSyntaxNode class

पैराग्राफ सिंटैक्स नोड का प्रतिनिधित्व करें।
...
| नाम | विवरण |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/paragraphsyntaxnode/accept/)(MarkdownSyntaxVisitor) | आगंतुक की स्वीकृति के लिए इंटरफ़ेस को परिभाषित करता है। |
...
| [GetContent](../../aspose.html.toolkit.markdown.syntax/paragraphsyntaxnode/getcontent/)() | सामग्री प्राप्त करने के लिए इंटरफ़ेस को परिभाषित करता है। |
