...
description: Aspose.Html.Toolkit.Markdown.Syntax.TextSyntaxNode कक्ष. टेक्स्ट संटैक्स नड लगू कय
type: docs
weight: 5670
url: /hi/net/aspose.html.toolkit.markdown.syntax/textsyntaxnode/
---
## TextSyntaxNode class

टेक्स्ट सिंटैक्स नोड लागू किया।
...
| नाम | विवरण |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/textsyntaxnode/accept/)(MarkdownSyntaxVisitor) | आगंतुक स्वीकार करने के लिए इंटरफ़ेस परिभाषित करता है। |
