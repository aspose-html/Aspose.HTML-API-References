...
description: Aspose.Html.Toolkit.Markdown.Syntax.EmphasisSyntaxNode कक्ष. जर संटैक्स नड क प्रतनधत्व करत है
type: docs
weight: 4870
url: /hi/net/aspose.html.toolkit.markdown.syntax/emphasissyntaxnode/
---
## EmphasisSyntaxNode class

जोर सिंटैक्स नोड का प्रतिनिधित्व करता है।
...
| नाम | विवरण |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/emphasissyntaxnode/accept/)(MarkdownSyntaxVisitor) | आगंतुक स्वीकार करने के लिए इंटरफ़ेस परिभाषित करता है। |
...
| [GetEmphasisType](../../aspose.html.toolkit.markdown.syntax/emphasissyntaxnode/getemphasistype/)() | जोर प्रकार प्राप्त करने के लिए इंटरफ़ेस को परिभाषित करता है |
