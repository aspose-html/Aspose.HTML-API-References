...
description: Aspose.Html.Toolkit.Markdown.Syntax.HTMLFragmentSyntax कक्ष. HTMLFragmentSyntax क प्रतनधत्व करत है
type: docs
weight: 5000
url: /hi/net/aspose.html.toolkit.markdown.syntax/htmlfragmentsyntax/
---
...
| नाम | विवरण |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/htmlfragmentsyntax/accept/)(MarkdownSyntaxVisitor) | आगंतुक स्वीकार करने के लिए इंटरफ़ेस परिभाषित करता है। |
...
| [GetContent](../../aspose.html.toolkit.markdown.syntax/htmlfragmentsyntax/getcontent/)() | सामग्री प्राप्त करने के लिए इंटरफ़ेस को परिभाषित करता है। |
...
| [SetContent](../../aspose.html.toolkit.markdown.syntax/htmlfragmentsyntax/setcontent/)(string) | सेट सामग्री के लिए इंटरफ़ेस को परिभाषित करता है। |
