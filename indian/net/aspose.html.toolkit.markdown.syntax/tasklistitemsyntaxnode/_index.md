...
description: Aspose.Html.Toolkit.Markdown.Syntax.TaskListItemSyntaxNode कक्ष. कर्य सूच आइटम संटैक्स नड.
type: docs
weight: 5610
url: /hi/net/aspose.html.toolkit.markdown.syntax/tasklistitemsyntaxnode/
---
## TaskListItemSyntaxNode class

कार्य सूची आइटम सिंटैक्स नोड.
...
| नाम | विवरण |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/listitemsyntaxnode/accept/)(MarkdownSyntaxVisitor) | आगंतुक स्वीकार करने के लिए इंटरफ़ेस परिभाषित करता है। |
...
| [GetLinesLeadingTrivia](../../aspose.html.toolkit.markdown.syntax/multilinecontainerblocksyntaxnode/getlinesleadingtrivia/)() | गेट लाइन्स लीडिंग ट्रिविया के लिए इंटरफ़ेस को परिभाषित करता है। |
| [GetMarker](../../aspose.html.toolkit.markdown.syntax/listitemsyntaxnode/getmarker/)() | मार्कर प्राप्त करें |
...
| [IsChecked](../../aspose.html.toolkit.markdown.syntax/tasklistitemsyntaxnode/ischecked/)() | चेक की गई स्थिति के लिए इंटरफ़ेस को परिभाषित करता है। |
| [IsTight](../../aspose.html.toolkit.markdown.syntax/listitemsyntaxnode/istight/)() | सही है अगर तंग है। |
