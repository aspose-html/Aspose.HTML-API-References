...
description: Aspose.Html.Toolkit.Markdown.Syntax.LineBreakSyntaxNode कक्ष. लइनब्रेक संटेक्स नड क प्रतनधत्व करत है
type: docs
weight: 5100
url: /hi/net/aspose.html.toolkit.markdown.syntax/linebreaksyntaxnode/
---
## LineBreakSyntaxNode class

लाइनब्रेक सिंटेक्स नोड का प्रतिनिधित्व करता है।
...
| नाम | विवरण |
| --- | --- |
| abstract [Accept](../../aspose.html.toolkit.markdown.syntax/inlinesyntaxnode/accept/)(MarkdownSyntaxVisitor) | आगंतुक स्वीकार करने के लिए इंटरफ़ेस परिभाषित करता है। |
