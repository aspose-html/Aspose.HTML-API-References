...
description: Aspose.Html.Toolkit.Markdown.Syntax.SetextHeadingSyntaxNode कक्ष. सेटेक्स्ट हेडंग संटैक्स नड क प्रतनधत्व करत है
type: docs
weight: 5530
url: /hi/net/aspose.html.toolkit.markdown.syntax/setextheadingsyntaxnode/
---
...
| [Level](../../aspose.html.toolkit.markdown.syntax/setextheadingsyntaxnode/level/) { get; } | वर्तमान सिंटैक्स का स्तर प्राप्त करें। |
...
| नाम | विवरण |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/setextheadingsyntaxnode/accept/)(MarkdownSyntaxVisitor) | आगंतुक की स्वीकृति के लिए इंटरफ़ेस को परिभाषित करता है। |
