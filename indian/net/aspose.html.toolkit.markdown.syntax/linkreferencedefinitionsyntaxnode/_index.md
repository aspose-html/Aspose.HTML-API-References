...
description: Aspose.Html.Toolkit.Markdown.Syntax.LinkReferenceDefinitionSyntaxNode कक्ष. LinkReferenceDefinitionSyntaxNode क प्रतनधत्व करत है
type: docs
weight: 5120
url: /hi/net/aspose.html.toolkit.markdown.syntax/linkreferencedefinitionsyntaxnode/
---
...
| नाम | विवरण |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/linkreferencedefinitionsyntaxnode/accept/)(MarkdownSyntaxVisitor) | आगंतुक स्वीकार करने के लिए इंटरफ़ेस परिभाषित करता है। |
...
| [GetDestination](../../aspose.html.toolkit.markdown.syntax/linkreferencedefinitionsyntaxnode/getdestination/)() | गंतव्य प्राप्त करने के लिए इंटरफ़ेस को परिभाषित करता है। |
| [GetLabel](../../aspose.html.toolkit.markdown.syntax/linkreferencedefinitionsyntaxnode/getlabel/)() | लेबल प्राप्त करने के लिए इंटरफ़ेस को परिभाषित करता है। |
...
| [GetTitle](../../aspose.html.toolkit.markdown.syntax/linkreferencedefinitionsyntaxnode/gettitle/)() | शीर्षक प्राप्त करने के लिए इंटरफ़ेस को परिभाषित करता है। |
