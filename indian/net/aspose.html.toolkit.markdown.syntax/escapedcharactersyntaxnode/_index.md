...
description: Aspose.Html.Toolkit.Markdown.Syntax.EscapedCharacterSyntaxNode कक्ष. एस्केप कैरेक्टर संटैक्स नड लगू कय
type: docs
weight: 4890
url: /hi/net/aspose.html.toolkit.markdown.syntax/escapedcharactersyntaxnode/
---
## EscapedCharacterSyntaxNode class

एस्केप कैरेक्टर सिंटैक्स नोड लागू किया।
...
| virtual [Source](../../aspose.html.toolkit.markdown.syntax/textsyntaxnode/source/) { get; } | स्रोत पाठ लौटाएं। |
| virtual [Span](../../aspose.html.toolkit.markdown.syntax/textsyntaxnode/span/) { get; } | स्पैन प्राप्त करने के लिए इंटरफ़ेस को परिभाषित करता है। |
| [Value](../../aspose.html.toolkit.markdown.syntax/textsyntaxnode/value/) { get; } | स्ट्रिंग मान प्राप्त करने के लिए संपत्ति को परिभाषित करता है। |

## तरीकों

| नाम | विवरण |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/escapedcharactersyntaxnode/accept/)(MarkdownSyntaxVisitor) | आगंतुक स्वीकार करने के लिए इंटरफ़ेस परिभाषित करता है। |
