---
title: Class OrderedListSyntaxNode
second_title: .NET API संदर्भ के लिए Aspose.HTML
description: Aspose.Html.Toolkit.Markdown.Syntax.OrderedListSyntaxNode कक्ष. आदेशत सूच संटैक्स क प्रतनधत्व करत है
type: docs
weight: 5300
url: /hi/net/aspose.html.toolkit.markdown.syntax/orderedlistsyntaxnode/
---
## OrderedListSyntaxNode class

आदेशित सूची सिंटैक्स का प्रतिनिधित्व करता है।
...
| नाम | विवरण |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/orderedlistsyntaxnode/accept/)(MarkdownSyntaxVisitor) | आगंतुक की स्वीकृति के लिए इंटरफ़ेस को परिभाषित करता है। |
...
| [GetDelimiter](../../aspose.html.toolkit.markdown.syntax/orderedlistsyntaxnode/getdelimiter/)() | सीमांकक प्राप्त करने के लिए इंटरफ़ेस को परिभाषित करता है। |
| [GetLeadingTrivia](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/getleadingtrivia/)() | प्रमुख ट्रिविया प्राप्त करें. |
| [GetStart](../../aspose.html.toolkit.markdown.syntax/orderedlistsyntaxnode/getstart/)() | स्टार्ट इंडेक्स प्राप्त करने के लिए इंटरफ़ेस को परिभाषित करता है। |
...
| [IsTight](../../aspose.html.toolkit.markdown.syntax/listsyntaxnode/istight/)() | गेट इज टाइट के लिए इंटरफेस को परिभाषित करता है। |
