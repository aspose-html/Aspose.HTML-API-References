...
description: Aspose.Html.Toolkit.Markdown.Syntax.LinkTitleSyntaxNode कक्ष. LinkTitleSyntaxNode क प्रतनधत्व करत है
type: docs
weight: 5130
url: /hi/net/aspose.html.toolkit.markdown.syntax/linktitlesyntaxnode/
---
...
| नाम | विवरण |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/linktitlesyntaxnode/accept/)(MarkdownSyntaxVisitor) | आगंतुक स्वीकार करने के लिए इंटरफ़ेस परिभाषित करता है। |
...
| [GetValue](../../aspose.html.toolkit.markdown.syntax/linktitlesyntaxnode/getvalue/)() | स्ट्रिंग मान प्राप्त करने के लिए इंटरफ़ेस को परिभाषित करता है। |
