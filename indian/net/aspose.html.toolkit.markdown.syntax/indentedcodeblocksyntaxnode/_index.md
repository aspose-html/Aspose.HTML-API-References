...
description: Aspose.Html.Toolkit.Markdown.Syntax.IndentedCodeBlockSyntaxNode कक्ष. IndentedCodeBlockSyntaxNode. क प्रतनधत्व करत है
type: docs
weight: 5030
url: /hi/net/aspose.html.toolkit.markdown.syntax/indentedcodeblocksyntaxnode/
---
...
| नाम | विवरण |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/indentedcodeblocksyntaxnode/accept/)(MarkdownSyntaxVisitor) | आगंतुक स्वीकार करने के लिए इंटरफ़ेस परिभाषित करता है। |
...
| [GetContent](../../aspose.html.toolkit.markdown.syntax/indentedcodeblocksyntaxnode/getcontent/)() | सामग्री प्राप्त करने के लिए इंटरफ़ेस को परिभाषित करता है। |
