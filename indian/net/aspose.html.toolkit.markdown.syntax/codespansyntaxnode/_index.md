...
description: Aspose.Html.Toolkit.Markdown.Syntax.CodeSpanSyntaxNode कक्ष. कडSpanSyntaxNode क प्रतनधत्व करत है
type: docs
weight: 4840
url: /hi/net/aspose.html.toolkit.markdown.syntax/codespansyntaxnode/
---
## CodeSpanSyntaxNode class

कोडSpanSyntaxNode का प्रतिनिधित्व करता है
...
| नाम | विवरण |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/codespansyntaxnode/accept/)(MarkdownSyntaxVisitor) | आगंतुक स्वीकार करने के लिए इंटरफ़ेस परिभाषित करता है। |
...
| [GetContent](../../aspose.html.toolkit.markdown.syntax/codespansyntaxnode/getcontent/)() | सामग्री प्राप्त करने के लिए इंटरफ़ेस को परिभाषित करता है। |
