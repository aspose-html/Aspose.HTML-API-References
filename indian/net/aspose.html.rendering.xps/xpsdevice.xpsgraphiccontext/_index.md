...
description: Aspose.Html.Rendering.Xps.XpsDeviceXpsGraphicContext कक्ष. XpsDevice के लए वर्तमन ग्रफ़क्स नयंत्रण पैरमटर रखत है. ये पैरमटर वैश्वक ढंचे क परभषत करते हैं जसके भतर ग्रफ़क्स ऑपरेटर नष्पदत करते हैं.
type: docs
weight: 4540
url: /hi/net/aspose.html.rendering.xps/xpsdevice.xpsgraphiccontext/
---
## XpsDevice.XpsGraphicContext class

XpsDevice के लिए वर्तमान ग्राफ़िक्स नियंत्रण पैरामीटर रखता है. ये पैरामीटर वैश्विक ढांचे को परिभाषित करते हैं जिसके भीतर ग्राफ़िक्स ऑपरेटर निष्पादित करते हैं.
...
| नाम | विवरण |
| --- | --- |
| [XpsGraphicContext](xpsgraphiccontext/)() | डिफ़ॉल्ट कंस्ट्रक्टर। |
...
| नाम | विवरण |
| --- | --- |
| override [Clone](../../aspose.html.rendering.xps/xpsgraphiccontext/clone/)() | एक XpsGraphicContext वर्ग का एक नया उदाहरण बनाता है जिसमें मौजूदा उदाहरण के समान गुण मान होते हैं। |
