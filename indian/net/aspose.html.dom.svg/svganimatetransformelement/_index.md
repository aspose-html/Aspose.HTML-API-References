...
description: Aspose.Html.Dom.Svg.SVGAnimateTransformElement कक्ष. SVGAnimateTransformElement इंटरफ़ेस एनमेटट्रंसफ़र्म तत्व से संबंधत है SVG DOM के मध्यम से एनमेटट्रंसफ़र्म तत्व क वशेषतओं के लए ऑब्जेक्टओरएंटेड एक्सेस उपलब्ध नहं है
type: docs
weight: 1930
url: /hi/net/aspose.html.dom.svg/svganimatetransformelement/
---
## SVGAnimateTransformElement class

SVGAnimateTransformElement इंटरफ़ेस 'एनिमेटट्रांसफ़ॉर्म' तत्व से संबंधित है। SVG DOM के माध्यम से 'एनिमेटट्रांसफ़ॉर्म' तत्व की विशेषताओं के लिए ऑब्जेक्ट-ओरिएंटेड एक्सेस उपलब्ध नहीं है।
