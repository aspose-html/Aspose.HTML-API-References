...
description: Aspose.Html.Dom.Svg.SVGDocument कक्ष. एकएसवज दस्तवेज़एसवज पदनुक्रम क जड़ है और संपूर्ण समग्र रखत है पदनुक्रम तक पहुँच प्रदन करने के अलव यह दस्तवेज़ से जनकर के कुछ सेटं तक पहुँचने के लए कुछ सुवधजनक तरके भ प्रदन करत है तत्व एक एक्सएचटएमएल दस्तवेज़ एक्सएचटएमएल के भतर इनलइन एम्बेडेड है त एक एसवजडक्यूमेंट ऑब्जेक्ट मजूद नहं हग इसके बजय दस्तवेज़ ऑब्जेक्ट पदनुक्रम में रूट ऑब्जेक्ट एक भन्न प्रकर क दस्तवेज़ ऑब्जेक्ट हग जैसे क HTMLDocument ऑब्जेक्ट. हलंक एक SVGDocument ऑब्जेक्ट वस्तव में तब मजूद हग जब XML दस्तवेज़ पदनुक्रम क मूल तत्व svg तत्व ह  जैसे स्टैंडअलन SVG फ़इल देखते समय अर्थत MIME प्रकर वल फ़इल image/svgxml इस स्थत में SVGDocument ऑब्जेक्ट दस्तवेज़ ऑब्जेक्ट मडल पदनुक्रम क मूल ऑब्जेक्ट हग
type: docs
weight: 2010
url: /hi/net/aspose.html.dom.svg/svgdocument/
---
## SVGDocument class

एक`एसवीजी दस्तावेज़`एसवीजी पदानुक्रम की जड़ है और संपूर्ण सामग्री रखती है। पदानुक्रम तक पहुँच प्रदान करने के अलावा, यह दस्तावेज़ से जानकारी के कुछ सेटों तक पहुँचने के लिए कुछ सुविधाजनक तरीके भी प्रदान करता है। तत्व एक एक्सएचटीएमएल दस्तावेज़ [एक्सएचटीएमएल] के भीतर इनलाइन एम्बेडेड है, तो एक एसवीजीडॉक्यूमेंट ऑब्जेक्ट मौजूद नहीं होगा; इसके बजाय, दस्तावेज़ ऑब्जेक्ट पदानुक्रम में रूट ऑब्जेक्ट एक भिन्न प्रकार का दस्तावेज़ ऑब्जेक्ट होगा, जैसे कि HTMLDocument ऑब्जेक्ट. हालांकि, एक SVGDocument ऑब्जेक्ट वास्तव में तब मौजूद होगा जब XML दस्तावेज़ पदानुक्रम का मूल तत्व 'svg' तत्व हो , जैसे स्टैंड-अलोन SVG फ़ाइल देखते समय (अर्थात, MIME प्रकार वाली फ़ाइल "image/svg+xml")। इस स्थिति में, SVGDocument ऑब्जेक्ट दस्तावेज़ ऑब्जेक्ट मॉडल पदानुक्रम का मूल ऑब्जेक्ट होगा।
...
| नाम | विवरण |
| --- | --- |
| [SVGDocument](svgdocument/#constructor)() | का एक नया उदाहरण प्रारंभ करता है`SVGDocument` वर्ग. |
| [SVGDocument](svgdocument/#constructor_1)(Configuration) | का एक नया उदाहरण प्रारंभ करता है`SVGDocument` वर्ग. |
| [SVGDocument](svgdocument/#constructor_2)(RequestMessage) | का एक नया उदाहरण प्रारंभ करता है`SVGDocument` कक्षा। कंस्ट्रक्टर समकालिक रूप से काम करता है, यह सभी बाहरी संसाधनों (छवियों, स्क्रिप्ट, आदि) के लोड होने की प्रतीक्षा करता है। दस्तावेज़ को एसिंक्रोनस रूप से लोड करने के लिए विधि का उपयोग करें[`Navigate`](../../aspose.html.dom/document/navigate/) या इसके ओवरलोड्स. या आप उपयुक्त फ़्लैग्स सेट करके कुछ बाहरी संसाधनों को लोड करना अक्षम कर सकते हैं[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [SVGDocument](svgdocument/#constructor_10)(string) | का एक नया उदाहरण प्रारंभ करता है`SVGDocument` कक्षा। कंस्ट्रक्टर समकालिक रूप से काम करता है, यह सभी बाहरी संसाधनों (छवियों, स्क्रिप्ट, आदि) के लोड होने की प्रतीक्षा करता है। दस्तावेज़ को एसिंक्रोनस रूप से लोड करने के लिए विधि का उपयोग करें[`Navigate`](../../aspose.html.dom/document/navigate/) या इसके ओवरलोड्स. या आप उपयुक्त फ़्लैग्स सेट करके कुछ बाहरी संसाधनों को लोड करना अक्षम कर सकते हैं[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [SVGDocument](svgdocument/#constructor_4)(Url) | का एक नया उदाहरण प्रारंभ करता है`SVGDocument` कक्षा। कंस्ट्रक्टर समकालिक रूप से काम करता है, यह सभी बाहरी संसाधनों (छवियों, स्क्रिप्ट, आदि) के लोड होने की प्रतीक्षा करता है। दस्तावेज़ को एसिंक्रोनस रूप से लोड करने के लिए विधि का उपयोग करें[`Navigate`](../../aspose.html.dom/document/navigate/) या इसके ओवरलोड्स. या आप उपयुक्त फ़्लैग्स सेट करके कुछ बाहरी संसाधनों को लोड करना अक्षम कर सकते हैं[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [SVGDocument](svgdocument/#constructor_3)(RequestMessage, Configuration) | का एक नया उदाहरण प्रारंभ करता है`SVGDocument` कक्षा। कंस्ट्रक्टर समकालिक रूप से काम करता है, यह सभी बाहरी संसाधनों (छवियों, स्क्रिप्ट, आदि) के लोड होने की प्रतीक्षा करता है। दस्तावेज़ को एसिंक्रोनस रूप से लोड करने के लिए विधि का उपयोग करें[`Navigate`](../../aspose.html.dom/document/navigate/) या इसके ओवरलोड्स. या आप उपयुक्त फ़्लैग्स सेट करके कुछ बाहरी संसाधनों को लोड करना अक्षम कर सकते हैं[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [SVGDocument](svgdocument/#constructor_8)(Stream, string) | का एक नया उदाहरण प्रारंभ करता है`SVGDocument` कक्षा। कंस्ट्रक्टर समकालिक रूप से काम करता है, यह सभी बाहरी संसाधनों (छवियों, स्क्रिप्ट, आदि) के लोड होने की प्रतीक्षा करता है। दस्तावेज़ को एसिंक्रोनस रूप से लोड करने के लिए विधि का उपयोग करें[`Navigate`](../../aspose.html.dom/document/navigate/) या इसके ओवरलोड्स. या आप उपयुक्त फ़्लैग्स सेट करके कुछ बाहरी संसाधनों को लोड करना अक्षम कर सकते हैं[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . दस्तावेज़ लोड करना स्ट्रीम में वर्तमान स्थिति से शुरू होता है। |
| [SVGDocument](svgdocument/#constructor_6)(Stream, Url) | का एक नया उदाहरण प्रारंभ करता है`SVGDocument` कक्षा। कंस्ट्रक्टर समकालिक रूप से काम करता है, यह सभी बाहरी संसाधनों (छवियों, स्क्रिप्ट, आदि) के लोड होने की प्रतीक्षा करता है। दस्तावेज़ को एसिंक्रोनस रूप से लोड करने के लिए विधि का उपयोग करें[`Navigate`](../../aspose.html.dom/document/navigate/) या इसके ओवरलोड्स. या आप उपयुक्त फ़्लैग्स सेट करके कुछ बाहरी संसाधनों को लोड करना अक्षम कर सकते हैं[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . दस्तावेज़ लोड करना स्ट्रीम में वर्तमान स्थिति से शुरू होता है। |
| [SVGDocument](svgdocument/#constructor_11)(string, Configuration) | का एक नया उदाहरण प्रारंभ करता है`SVGDocument` कक्षा। कंस्ट्रक्टर समकालिक रूप से काम करता है, यह सभी बाहरी संसाधनों (छवियों, स्क्रिप्ट, आदि) के लोड होने की प्रतीक्षा करता है। दस्तावेज़ को एसिंक्रोनस रूप से लोड करने के लिए विधि का उपयोग करें[`Navigate`](../../aspose.html.dom/document/navigate/) या इसके ओवरलोड्स. या आप उपयुक्त फ़्लैग्स सेट करके कुछ बाहरी संसाधनों को लोड करना अक्षम कर सकते हैं[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [SVGDocument](svgdocument/#constructor_14)(string, string) | का एक नया उदाहरण प्रारंभ करता है`SVGDocument` कक्षा। कंस्ट्रक्टर समकालिक रूप से काम करता है, यह सभी बाहरी संसाधनों (छवियों, स्क्रिप्ट, आदि) के लोड होने की प्रतीक्षा करता है। दस्तावेज़ को एसिंक्रोनस रूप से लोड करने के लिए विधि का उपयोग करें[`Navigate`](../../aspose.html.dom/document/navigate/) या इसके ओवरलोड्स. या आप उपयुक्त फ़्लैग्स सेट करके कुछ बाहरी संसाधनों को लोड करना अक्षम कर सकते हैं[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [SVGDocument](svgdocument/#constructor_12)(string, Url) | का एक नया उदाहरण प्रारंभ करता है`SVGDocument` कक्षा। कंस्ट्रक्टर समकालिक रूप से काम करता है, यह सभी बाहरी संसाधनों (छवियों, स्क्रिप्ट, आदि) के लोड होने की प्रतीक्षा करता है। दस्तावेज़ को एसिंक्रोनस रूप से लोड करने के लिए विधि का उपयोग करें[`Navigate`](../../aspose.html.dom/document/navigate/) या इसके ओवरलोड्स. या आप उपयुक्त फ़्लैग्स सेट करके कुछ बाहरी संसाधनों को लोड करना अक्षम कर सकते हैं[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [SVGDocument](svgdocument/#constructor_5)(Url, Configuration) | का एक नया उदाहरण प्रारंभ करता है`SVGDocument` कक्षा। कंस्ट्रक्टर समकालिक रूप से काम करता है, यह सभी बाहरी संसाधनों (छवियों, स्क्रिप्ट, आदि) के लोड होने की प्रतीक्षा करता है। दस्तावेज़ को एसिंक्रोनस रूप से लोड करने के लिए विधि का उपयोग करें[`Navigate`](../../aspose.html.dom/document/navigate/) या इसके ओवरलोड्स. या आप उपयुक्त फ़्लैग्स सेट करके कुछ बाहरी संसाधनों को लोड करना अक्षम कर सकते हैं[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [SVGDocument](svgdocument/#constructor_9)(Stream, string, Configuration) | का एक नया उदाहरण प्रारंभ करता है`SVGDocument` कक्षा। कंस्ट्रक्टर समकालिक रूप से काम करता है, यह सभी बाहरी संसाधनों (छवियों, स्क्रिप्ट, आदि) के लोड होने की प्रतीक्षा करता है। दस्तावेज़ को एसिंक्रोनस रूप से लोड करने के लिए विधि का उपयोग करें[`Navigate`](../../aspose.html.dom/document/navigate/) या इसके ओवरलोड्स. या आप उपयुक्त फ़्लैग्स सेट करके कुछ बाहरी संसाधनों को लोड करना अक्षम कर सकते हैं[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . दस्तावेज़ लोड करना स्ट्रीम में वर्तमान स्थिति से शुरू होता है। |
| [SVGDocument](svgdocument/#constructor_7)(Stream, Url, Configuration) | का एक नया उदाहरण प्रारंभ करता है`SVGDocument` कक्षा। कंस्ट्रक्टर समकालिक रूप से काम करता है, यह सभी बाहरी संसाधनों (छवियों, स्क्रिप्ट, आदि) के लोड होने की प्रतीक्षा करता है। दस्तावेज़ को एसिंक्रोनस रूप से लोड करने के लिए विधि का उपयोग करें[`Navigate`](../../aspose.html.dom/document/navigate/) या इसके ओवरलोड्स. या आप उपयुक्त फ़्लैग्स सेट करके कुछ बाहरी संसाधनों को लोड करना अक्षम कर सकते हैं[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . दस्तावेज़ लोड करना स्ट्रीम में वर्तमान स्थिति से शुरू होता है। |
| [SVGDocument](svgdocument/#constructor_15)(string, string, Configuration) | का एक नया उदाहरण प्रारंभ करता है`SVGDocument` कक्षा। कंस्ट्रक्टर समकालिक रूप से काम करता है, यह सभी बाहरी संसाधनों (छवियों, स्क्रिप्ट, आदि) के लोड होने की प्रतीक्षा करता है। दस्तावेज़ को एसिंक्रोनस रूप से लोड करने के लिए विधि का उपयोग करें[`Navigate`](../../aspose.html.dom/document/navigate/) या इसके ओवरलोड्स. या आप उपयुक्त फ़्लैग्स सेट करके कुछ बाहरी संसाधनों को लोड करना अक्षम कर सकते हैं[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [SVGDocument](svgdocument/#constructor_13)(string, Url, Configuration) | का एक नया उदाहरण प्रारंभ करता है`SVGDocument` कक्षा। कंस्ट्रक्टर समकालिक रूप से काम करता है, यह सभी बाहरी संसाधनों (छवियों, स्क्रिप्ट, आदि) के लोड होने की प्रतीक्षा करता है। दस्तावेज़ को एसिंक्रोनस रूप से लोड करने के लिए विधि का उपयोग करें[`Navigate`](../../aspose.html.dom/document/navigate/) या इसके ओवरलोड्स. या आप उपयुक्त फ़्लैग्स सेट करके कुछ बाहरी संसाधनों को लोड करना अक्षम कर सकते हैं[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
...
| [Domain](../../aspose.html.dom.svg/svgdocument/domain/) { get; } | उस सर्वर का डोमेन नाम जिसने दस्तावेज़ दिया, या एक शून्य स्ट्रिंग यदि सर्वर को डोमेन नाम से पहचाना नहीं जा सकता है। |
...
| [Referrer](../../aspose.html.dom.svg/svgdocument/referrer/) { get; } | उस पृष्ठ का URI लौटाता है जो इस पृष्ठ से जुड़ा हुआ है। मान एक खाली स्ट्रिंग है यदि उपयोगकर्ता सीधे पृष्ठ पर नेविगेट करता है (लिंक के माध्यम से नहीं, बल्कि, उदाहरण के लिए, बुकमार्क के माध्यम से)। |
| [RootElement](../../aspose.html.dom.svg/svgdocument/rootelement/) { get; } | दस्तावेज़ पदानुक्रम में रूट 'svg'. |
...
| [Title](../../aspose.html.dom.svg/svgdocument/title/) { get; } | 'एसवीजी' मूल तत्व के 'शीर्षक' उप-तत्व द्वारा निर्दिष्ट दस्तावेज़ का शीर्षक (यानी,यहाँ शीर्षक है... ) |
| [URL](../../aspose.html.dom.svg/svgdocument/url/) { get; } | दस्तावेज़ का पूरा यूआरआई. |
...
| [GetOverrideStyle](../../aspose.html.dom.svg/svgdocument/getoverridestyle/)(Element, string) | इस विधि का उपयोग निर्दिष्ट तत्व और निर्दिष्ट छद्म तत्व के लिए ओवरराइड शैली घोषणा को पुनर्प्राप्त करने के लिए किया जाता है। |
...
| override [RenderTo](../../aspose.html.dom.svg/svgdocument/renderto/)(IDevice) | इस विधि का उपयोग वर्तमान दस्तावेज़ की सामग्री को निर्दिष्ट डिवाइस पर प्रिंट करने के लिए किया जाता है। |
...
| [Save](../../aspose.html.dom.svg/svgdocument/save/#save)(IOutputStorage) | दस्तावेज़ सामग्री और संसाधनों को आउटपुट स्टोरेज में सहेजता है। |
| [Save](../../aspose.html.dom.svg/svgdocument/save/#save_6)(string) | द्वारा निर्दिष्ट स्थानीय फ़ाइल में दस्तावेज़ सहेजता है`पथ` इस दस्तावेज़ में उपयोग किए गए सभी संसाधनों को में आसन्न फ़ोल्डर में सहेजा जाएगा, जिसका नाम इस प्रकार बनाया जाएगा: output_file_name + "_files". |
| [Save](../../aspose.html.dom.svg/svgdocument/save/#save_3)(Url) | द्वारा निर्दिष्ट स्थानीय फ़ाइल में दस्तावेज़ सहेजता है`यूआरएल` इस दस्तावेज़ में उपयोग किए गए सभी संसाधनों को में आसन्न फ़ोल्डर में सहेजा जाएगा, जिसका नाम इस प्रकार बनाया जाएगा: output_file_name + "_files". |
| [Save](../../aspose.html.dom.svg/svgdocument/save/#save_1)(IOutputStorage, SVGSaveFormat) | दस्तावेज़ सामग्री और संसाधनों को आउटपुट स्टोरेज में सहेजता है। |
| [Save](../../aspose.html.dom.svg/svgdocument/save/#save_2)(IOutputStorage, SVGSaveOptions) | दस्तावेज़ सामग्री और संसाधनों को आउटपुट स्टोरेज में सहेजता है। |
| [Save](../../aspose.html.dom.svg/svgdocument/save/#save_7)(string, SVGSaveFormat) | द्वारा निर्दिष्ट स्थानीय फ़ाइल में दस्तावेज़ सहेजता है`पथ` इस दस्तावेज़ में उपयोग किए गए सभी संसाधनों को में आसन्न फ़ोल्डर में सहेजा जाएगा, जिसका नाम इस प्रकार बनाया जाएगा: output_file_name + "_files". |
| [Save](../../aspose.html.dom.svg/svgdocument/save/#save_8)(string, SVGSaveOptions) | द्वारा निर्दिष्ट स्थानीय फ़ाइल में दस्तावेज़ सहेजता है`पथ` इस दस्तावेज़ में उपयोग किए गए सभी संसाधनों को में आसन्न फ़ोल्डर में सहेजा जाएगा, जिसका नाम इस प्रकार बनाया जाएगा: output_file_name + "_files". |
| [Save](../../aspose.html.dom.svg/svgdocument/save/#save_4)(Url, SVGSaveFormat) | द्वारा निर्दिष्ट स्थानीय फ़ाइल में दस्तावेज़ सहेजता है`यूआरएल` इस दस्तावेज़ में उपयोग किए गए सभी संसाधनों को में आसन्न फ़ोल्डर में सहेजा जाएगा, जिसका नाम इस प्रकार बनाया जाएगा: output_file_name + "_files". |
| [Save](../../aspose.html.dom.svg/svgdocument/save/#save_5)(Url, SVGSaveOptions) | द्वारा निर्दिष्ट स्थानीय फ़ाइल में दस्तावेज़ सहेजता है`यूआरएल` इस दस्तावेज़ में उपयोग किए गए सभी संसाधनों को में आसन्न फ़ोल्डर में सहेजा जाएगा, जिसका नाम इस प्रकार बनाया जाएगा: output_file_name + "_files". |
