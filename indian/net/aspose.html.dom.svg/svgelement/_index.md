...
description: Aspose.Html.Dom.Svg.SVGElement कक्ष. सभ SVG DOM इंटरफ़ेस ज सधे SVG भष में तत्वं से मेल खते हैं जैसे क पथ तत्व के लए SVGPathElement इंटरफ़ेस SVGElement इंटरफ़ेस से प्रप्त हते हैं
type: docs
weight: 2020
url: /hi/net/aspose.html.dom.svg/svgelement/
---
## SVGElement class

सभी SVG DOM इंटरफ़ेस जो सीधे SVG भाषा में तत्वों से मेल खाते हैं (जैसे कि 'पथ' तत्व के लिए SVGPathElement इंटरफ़ेस) SVGElement इंटरफ़ेस से प्राप्त होते हैं।
