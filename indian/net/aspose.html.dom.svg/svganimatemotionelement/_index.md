...
description: Aspose.Html.Dom.Svg.SVGAnimateMotionElement कक्ष. SVGAnimateMotionElement इंटरफ़ेस एनमेटमशन तत्व से संबंधत है SVG DOM के मध्यम से एनमेटमशन तत्व क वशेषतओं के लए ऑब्जेक्टओरएंटेड एक्सेस उपलब्ध नहं है
type: docs
weight: 1920
url: /hi/net/aspose.html.dom.svg/svganimatemotionelement/
---
## SVGAnimateMotionElement class

SVGAnimateMotionElement इंटरफ़ेस 'एनिमेटमोशन' तत्व से संबंधित है। SVG DOM के माध्यम से 'एनिमेटमोशन' तत्व की विशेषताओं के लिए ऑब्जेक्ट-ओरिएंटेड एक्सेस उपलब्ध नहीं है।
