...
description: Aspose.Html.Dom.Svg.SVGTextPathElement कक्ष. SVGTextPathElement इंटरफ़ेस textPath तत्व से मेल खत है.
type: docs
weight: 2360
url: /hi/net/aspose.html.dom.svg/svgtextpathelement/
---
## SVGTextPathElement class

SVGTextPathElement इंटरफ़ेस 'textPath' तत्व से मेल खाता है.
...
| [Href](../../aspose.html.dom.svg/svgtextpathelement/href/) { get; } | दिए गए तत्व पर विशेषता 'xlink:href' के अनुरूप है। |
...
| [LengthAdjust](../../aspose.html.dom.svg/svgtextcontentelement/lengthadjust/) { get; } | दिए गए तत्व पर विशेषता 'लंबाई समायोजित' के अनुरूप है। मान इस इंटरफ़ेस पर परिभाषित लंबाई समायोजन स्थिरांक में से एक होना चाहिए। |
...
| [Method](../../aspose.html.dom.svg/svgtextpathelement/method/) { get; } | दिए गए 'टेक्स्टपाथ' तत्व पर विशेषता 'विधि' के अनुरूप है। |
...
| [Spacing](../../aspose.html.dom.svg/svgtextpathelement/spacing/) { get; } | दिए गए 'टेक्स्टपाथ' तत्व पर विशेषता 'स्पेसिंग' के अनुरूप है। |
| [StartOffset](../../aspose.html.dom.svg/svgtextpathelement/startoffset/) { get; } | दिए गए 'टेक्स्टपाथ' तत्व पर विशेषता 'स्टार्टऑफसेट' के अनुरूप है। |
...
| [TextLength](../../aspose.html.dom.svg/svgtextcontentelement/textlength/) { get; } | दिए गए तत्व पर विशेषता 'टेक्स्ट लम्बाई' के अनुरूप है। |
...
| [GetComputedTextLength](../../aspose.html.dom.svg/svgtextcontentelement/getcomputedtextlength/)() | इस तत्व के भीतर सभी वर्णों को प्रस्तुत करने से सभी अग्रिम मूल्यों का कुल योग, जिसमें ग्लिफ (क्षैतिज या लंबवत) पर अग्रिम मूल्य शामिल है, गुणों का प्रभाव 'कर्निंग', 'लेटर-स्पेसिंग' और 'शब्द- रिक्ति' और 'स्पेन' तत्वों पर 'dx' और 'dy' विशेषताओं के कारण समायोजन। गैर-प्रतिपादन परिवेशों के लिए, उपयोगकर्ता एजेंट ग्लिफ़ मेट्रिक्स के बारे में उचित अनुमान लगाएगा। |
...
| [GetNumberOfChars](../../aspose.html.dom.svg/svgtextcontentelement/getnumberofchars/)() | वर्तमान तत्व के भीतर प्रतिपादन के लिए उपलब्ध वर्णों की कुल संख्या लौटाता है, जिसमें 'ट्रेफ' संदर्भ से संदर्भित वर्ण शामिल हैं, भले ही उन्हें प्रस्तुत किया जाएगा या नहीं। प्रभावी रूप से, यह DOM लेवल 3 कोर ([DOM3], सेक्शन 1.4) से Node::textContent विशेषता की लंबाई के बराबर है, यदि वह विशेषता 'tref' एलिमेंट्स का भी विस्तार करती है। |
...
| नाम | विवरण |
| --- | --- |
| const [TEXTPATH_METHODTYPE_ALIGN](../../aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_align/) | मान 'संरेखित' के अनुरूप है। |
| const [TEXTPATH_METHODTYPE_STRETCH](../../aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_stretch/) | मान 'खिंचाव' के अनुरूप है। |
| const [TEXTPATH_METHODTYPE_UNKNOWN](../../aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_unknown/) | गणना एक ऐसे मान पर सेट की गई थी जो पूर्वनिर्धारित प्रकारों में से एक नहीं है। इस प्रकार के नए मान को परिभाषित करने का प्रयास करना या किसी मौजूदा मान को इस प्रकार में बदलने का प्रयास करना अमान्य है। |
| const [TEXTPATH_SPACINGTYPE_AUTO](../../aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_auto/) | मान 'ऑटो' के अनुरूप है। |
| const [TEXTPATH_SPACINGTYPE_EXACT](../../aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_exact/) | 'सटीक' मान के अनुरूप है। |
| const [TEXTPATH_SPACINGTYPE_UNKNOWN](../../aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_unknown/) | गणना एक ऐसे मान पर सेट की गई थी जो पूर्वनिर्धारित प्रकारों में से एक नहीं है। इस प्रकार के नए मान को परिभाषित करने का प्रयास करना या किसी मौजूदा मान को इस प्रकार में बदलने का प्रयास करना अमान्य है। |
