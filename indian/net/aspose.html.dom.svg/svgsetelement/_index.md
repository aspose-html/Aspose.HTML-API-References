...
description: Aspose.Html.Dom.Svg.SVGSetElement कक्ष. SVGSetElement इंटरफ़ेस सेट तत्व से संबंधत है SVG DOM के मध्यम से सेट तत्व क वशेषतओं के लए ऑब्जेक्टओरएंटेड एक्सेस उपलब्ध नहं है
type: docs
weight: 2280
url: /hi/net/aspose.html.dom.svg/svgsetelement/
---
## SVGSetElement class

SVGSetElement इंटरफ़ेस 'सेट' तत्व से संबंधित है। SVG DOM के माध्यम से 'सेट' तत्व की विशेषताओं के लिए ऑब्जेक्ट-ओरिएंटेड एक्सेस उपलब्ध नहीं है।
