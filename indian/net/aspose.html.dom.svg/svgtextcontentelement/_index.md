...
description: Aspose.Html.Dom.Svg.SVGTextContentElement कक्ष. SVGTextContentElement क वभन्न टेक्स्टसंबंधत इंटरफेस द्वर इनहेरट कय गय है जैसे क SVGTextElement SVGTSpanElement SVGTRefElement SVGAltGlyphElement और SVGTextPathElement. इस इंटरफ़ेस पर उन वधयं के लए ज कस वर्ण य वर्णं क संख्य के लए एक अनुक्रमणक क संदर्भत करते हैं इन संदर्भं क हन चहए एक UTF16 कड इकई य कई UTF16 कड इकइयं के सूचकंक के रूप में व्यख्य क जत है यह DOM लेवल 2 कर के सथ संगत के लए है जहँ कैरेक्टरडेट इंटरफ़ेस पर वधयँ UTF16 कड इकइयं क इंडेक्स के रूप में उपयग करत हैं और कैरेक्टर डेट के भतर गनत करत हैं उदहरण के लए यद टेक्स्ट तत्व क टेक्स्ट समग्र एक गैर बएमप चरत्र जैसे यू  10000 फर उस तत्व पर getNumberOfChars क आह्वन 2 लटएग क्यंक द यूटएफ 16 कड इकइयं हैं सरगेट जड़ उस एक चरत्र क प्रतनधत्व करने के लए उपयग क जत हैं
type: docs
weight: 2340
url: /hi/net/aspose.html.dom.svg/svgtextcontentelement/
---
## SVGTextContentElement class

SVGTextContentElement को विभिन्न टेक्स्ट-संबंधित इंटरफेस द्वारा इनहेरिट किया गया है, जैसे कि SVGTextElement, SVGTSpanElement, SVGTRefElement, SVGAltGlyphElement और SVGTextPathElement. इस इंटरफ़ेस पर उन विधियों के लिए जो किसी वर्ण या वर्णों की संख्या के लिए एक अनुक्रमणिका को संदर्भित करते हैं, इन संदर्भों को होना चाहिए एक UTF-16 कोड इकाई या कई UTF-16 कोड इकाइयों के सूचकांक के रूप में व्याख्या की जाती है। यह DOM लेवल 2 कोर के साथ संगति के लिए है, जहाँ कैरेक्टरडेटा इंटरफ़ेस पर विधियाँ UTF-16 कोड इकाइयों को इंडेक्स के रूप में उपयोग करती हैं और कैरेक्टर डेटा के भीतर गिनती करती हैं। उदाहरण के लिए, यदि 'टेक्स्ट' तत्व की टेक्स्ट सामग्री एक गैर- बीएमपी चरित्र, जैसे यू + 10000, फिर उस तत्व पर getNumberOfChars का आह्वान 2 लौटाएगा क्योंकि दो यूटीएफ -16 कोड इकाइयां हैं (सरोगेट जोड़ी) उस एक चरित्र का प्रतिनिधित्व करने के लिए उपयोग की जाती हैं।
...
| नाम | विवरण |
| --- | --- |
| const [LENGTHADJUST_SPACING](../../aspose.html.dom.svg/svgtextcontentelement/lengthadjust_spacing/) | मान 'स्पेसिंग' के अनुरूप है। |
| const [LENGTHADJUST_SPACINGANDGLYPHS](../../aspose.html.dom.svg/svgtextcontentelement/lengthadjust_spacingandglyphs/) | मान 'spacingAndGlyphs' के अनुरूप है। |
| const [LENGTHADJUST_UNKNOWN](../../aspose.html.dom.svg/svgtextcontentelement/lengthadjust_unknown/) | गणना एक ऐसे मान पर सेट की गई थी जो पूर्वनिर्धारित प्रकारों में से एक नहीं है। इस प्रकार के नए मान को परिभाषित करने का प्रयास करना या किसी मौजूदा मान को इस प्रकार में बदलने का प्रयास करना अमान्य है। |
