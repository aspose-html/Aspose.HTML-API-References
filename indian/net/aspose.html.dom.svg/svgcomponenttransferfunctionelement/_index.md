...
description: Aspose.Html.Dom.Svg.SVGComponentTransferFunctionElement कक्ष. यह इंटरफ़ेस घटक स्थनंतरण फ़ंक्शन इंटरफ़ेस द्वर उपयग कए जने वले आधर इंटरफ़ेस क परभषत करत है
type: docs
weight: 1970
url: /hi/net/aspose.html.dom.svg/svgcomponenttransferfunctionelement/
---
## SVGComponentTransferFunctionElement class

यह इंटरफ़ेस घटक स्थानांतरण फ़ंक्शन इंटरफ़ेस द्वारा उपयोग किए जाने वाले आधार इंटरफ़ेस को परिभाषित करता है।
...
| नाम | विवरण |
| --- | --- |
| [Amplitude](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/amplitude/) { get; } | दिए गए तत्व पर विशेषता 'आयाम' के अनुरूप है। |
...
| [Exponent](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/exponent/) { get; } | दिए गए तत्व पर विशेषता 'एक्सपोनेंट' के अनुरूप है। |
...
| [Intercept](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/intercept/) { get; } | दिए गए तत्व पर विशेषता 'अवरोधन' के अनुरूप है। |
...
| [Offset](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/offset/) { get; } | दिए गए तत्व पर विशेषता 'ऑफसेट' के अनुरूप है। |
...
| [Slope](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/slope/) { get; } | दिए गए तत्व पर विशेषता 'ढलान' के अनुरूप है। |
...
| [TableValues](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/tablevalues/) { get; } | दिए गए तत्व पर विशेषता 'टेबलवैल्यू' के अनुरूप है। |
...
| [Type](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/type/) { get; } | दिए गए तत्व पर विशेषता 'प्रकार' के अनुरूप है। इस इंटरफ़ेस पर परिभाषित SVG_FECOMPONENTTRANSFER_TYPE_* स्थिरांकों में से एक लेता है। |
...
| नाम | विवरण |
| --- | --- |
| const [SVG_FECOMPONENTTRANSFER_TYPE_DISCRETE](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_discrete/) | मूल्य 'असतत' के अनुरूप है। |
| const [SVG_FECOMPONENTTRANSFER_TYPE_GAMMA](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_gamma/) | मान 'गामा' के अनुरूप है। |
| const [SVG_FECOMPONENTTRANSFER_TYPE_IDENTITY](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_identity/) | मूल्य 'पहचान' के अनुरूप है। |
| const [SVG_FECOMPONENTTRANSFER_TYPE_LINEAR](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_linear/) | मान 'रैखिक' के अनुरूप है। |
| const [SVG_FECOMPONENTTRANSFER_TYPE_TABLE](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_table/) | मान 'तालिका' के अनुरूप है। |
| const [SVG_FECOMPONENTTRANSFER_TYPE_UNKNOWN](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_unknown/) | प्रकार पूर्वनिर्धारित प्रकारों में से एक नहीं है। इस प्रकार के नए मान को परिभाषित करने का प्रयास करना या किसी मौजूदा मान को इस प्रकार में बदलने का प्रयास करना अमान्य है। |
