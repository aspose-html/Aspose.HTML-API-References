...
description: Aspose.Html.HTMLObjectElement कक्ष. समन्य एम्बेडेड ऑब्जेक्ट सद्धंत रूप में ऑब्जेक्ट तत्व पर सभ गुण पढ़नेलखने वले हते हैं लेकन कुछ वतवरणं में कुछ गुण केवलपढ़ने के लए ह सकते हैं जब अंतर्नहत वस्तु क तत्कल कय जत है वस्तु तत्व क परभष देखें एचटएमएल 4.01 .
type: docs
weight: 3440
url: /hi/net/aspose.html/htmlobjectelement/
---
## HTMLObjectElement class

सामान्य एम्बेडेड ऑब्जेक्ट। सिद्धांत रूप में, ऑब्जेक्ट तत्व पर सभी गुण पढ़ने-लिखने वाले होते हैं लेकिन कुछ वातावरणों में कुछ गुण केवल-पढ़ने के लिए हो सकते हैं, जब अंतर्निहित वस्तु को तत्काल किया जाता है। वस्तु तत्व की परिभाषा देखें [[एचटीएमएल 4.01](http://www.w3.org/TR/1999/REC-html401-19991224) ].
...
| नाम | विवरण |
| --- | --- |
| [Align](../../aspose.html/htmlobjectelement/align/) { get; set; } | इस ऑब्जेक्ट को इसके आसपास के टेक्स्ट के संबंध में (लंबवत या क्षैतिज रूप से) संरेखित करता है। HTML 4.01 में एलाइन विशेषता परिभाषा देखें। यह विशेषता HTML 4.01. में बहिष्कृत है |
| [Archive](../../aspose.html/htmlobjectelement/archive/) { get; set; } | स्पेस से अलग किए गए संग्रह की सूची. HTML 4.01. में संग्रह विशेषता परिभाषा देखें |
...
| [Border](../../aspose.html/htmlobjectelement/border/) { get; set; } | वस्तु के चारों ओर बॉर्डर की चौड़ाई। HTML 4.01 में बॉर्डर विशेषता परिभाषा देखें। यह विशेषता HTML 4.01. में बहिष्कृत है |
...
| [ClassId](../../aspose.html/htmlobjectelement/classid/) { get; set; } | Windows रजिस्ट्री या URL में सेट किए गए क्लास आईडी मान को परिभाषित करता है |
...
| [Code](../../aspose.html/htmlobjectelement/code/) { get; set; } | एप्लेट वर्ग फ़ाइल। देखें`कोड` HTMLAppletElement के लिए विशेषता। |
| [CodeBase](../../aspose.html/htmlobjectelement/codebase/) { get; set; } | बेस यूआरआई [[आईईटीएफ आरएफसी 2396](http://www.ietf.org/rfc/rfc2396.txt) ] के लिए`कक्षा आईडी` ,`आंकड़े` , और `पुरालेख` गुण। HTML 4.01. में कोडबेस विशेषता definition देखें |
| [CodeType](../../aspose.html/htmlobjectelement/codetype/) { get; set; } | द्वारा डाउनलोड किए गए डेटा के लिए सामग्री प्रकार`कक्षा आईडी` गुण। HTML 4.01. में कोडटाइप विशेषता परिभाषा देखें |
| [Data](../../aspose.html/htmlobjectelement/data/) { get; set; } | एक यूआरआई [[आईईटीएफ आरएफसी 2396](http://www.ietf.org/rfc/rfc2396.txt) ] वस्तु के डेटा का स्थान निर्दिष्ट करना। HTML 4.01. में डेटा विशेषता परिभाषा देखें |
| [Declare](../../aspose.html/htmlobjectelement/declare/) { get; set; } | घोषित करें (भविष्य के संदर्भ के लिए), लेकिन इस वस्तु को तत्काल न करें। HTML 4.01. में डिक्लेयर एट्रिब्यूट की परिभाषा देखें |
...
| [Form](../../aspose.html/htmlobjectelement/form/) { get; set; } | लौटाता है`प्रपत्र` इस नियंत्रण वाले तत्व। रिटर्न`व्यर्थ` यदि यह नियंत्रण प्रपत्र के संदर्भ में नहीं है। |
| [Height](../../aspose.html/htmlobjectelement/height/) { get; set; } | ओवरराइड ऊंचाई। HTML 4.01. में ऊंचाई विशेषता परिभाषा देखें |
| [Hspace](../../aspose.html/htmlobjectelement/hspace/) { get; set; } | क्षैतिज स्थान, पिक्सेल में, इस छवि के बाएँ और दाएँ, एप्लेट, या ऑब्जेक्ट। HTML 4.01 में hspace विशेषता परिभाषा देखें। यह विशेषता HTML 4.01. में बहिष्कृत है |
...
| [Name](../../aspose.html/htmlobjectelement/name/) { get; set; } | प्रपत्र नियंत्रण या वस्तु का नाम जब प्रपत्र के साथ सबमिट किया जाता है। HTML 4.01. में नाम विशेषता परिभाषा देखें |
...
| [Standby](../../aspose.html/htmlobjectelement/standby/) { get; set; } | ऑब्जेक्ट लोड करते समय रेंडर करने के लिए संदेश। HTML 4.01. में स्टैंडबाय विशेषता परिभाषा देखें |
...
| [TabIndex](../../aspose.html/htmlobjectelement/tabindex/) { get; set; } | अनुक्रमणिका जो टैबिंग क्रम में तत्व की स्थिति का प्रतिनिधित्व करती है। HTML 4.01. में Tabindex विशेषता परिभाषा देखें |
...
| [Type](../../aspose.html/htmlobjectelement/type/) { get; set; } | द्वारा डाउनलोड किए गए डेटा के लिए सामग्री प्रकार`आंकड़े` गुण। देखें HTML 4.01. में प्रकार विशेषता परिभाषा |
| [UseMap](../../aspose.html/htmlobjectelement/usemap/) { get; set; } | क्लाइंट-साइड इमेज मैप का उपयोग करें। HTML 4.01. में usemap विशेषता परिभाषा देखें |
| [Vspace](../../aspose.html/htmlobjectelement/vspace/) { get; set; } | वर्टिकल स्पेस, पिक्सल में, इस इमेज, एप्लेट या ऑब्जेक्ट के ऊपर और नीचे। HTML 4.01 में vspace विशेषता परिभाषा देखें। यह विशेषता HTML 4.01. में बहिष्कृत है |
| [Width](../../aspose.html/htmlobjectelement/width/) { get; set; } | ओवरराइड चौड़ाई। HTML 4.01. में चौड़ाई विशेषता परिभाषा देखें |
