...
description: Aspose.Html.HTMLOptionElement कक्ष. एक चयन यग्य वकल्प HTML 4.01. में वकल्प तत्व परभष देखें
type: docs
weight: 3460
url: /hi/net/aspose.html/htmloptionelement/
---
## HTMLOptionElement class

एक चयन योग्य विकल्प। HTML 4.01. में विकल्प तत्व परिभाषा देखें
...
| [DefaultSelected](../../aspose.html/htmloptionelement/defaultselected/) { get; set; } | HTML चयनित विशेषता के मान का प्रतिनिधित्व करता है। इस विशेषता का मान नहीं बदलता है यदि एक इंटरैक्टिव उपयोगकर्ता एजेंट में संबंधित प्रपत्र नियंत्रण की स्थिति बदल जाती है। HTML 4.01. @version DOM Level 2 में चयनित विशेषता परिभाषा देखें |
...
| [Disabled](../../aspose.html/htmloptionelement/disabled/) { get; set; } | इस संदर्भ में नियंत्रण उपलब्ध नहीं है। HTML 4.01. में अक्षम विशेषता परिभाषा देखें |
...
| [Form](../../aspose.html/htmloptionelement/form/) { get; } | लौटाता है`प्रपत्र` इस नियंत्रण वाले तत्व। रिटर्न `व्यर्थ` अगर यह नियंत्रण फ़ॉर्म के संदर्भ में नहीं है. |
| [Id](../../aspose.html/htmlelement/id/) { get; set; } | तत्व का पहचानकर्ता। HTML 4.01. में आईडी विशेषता परिभाषा देखें |
| [Index](../../aspose.html/htmloptionelement/index/) { get; } | इसका सूचकांक`विकल्प` इसके माता-पिता में`चुनना` , 0. @वर्जन डोम लेवल 2 से शुरू |
...
| [Label](../../aspose.html/htmloptionelement/label/) { get; set; } | श्रेणीबद्ध मेनू में उपयोग के लिए विकल्प लेबल। HTML 4.01. में लेबल विशेषता परिभाषा देखें |
...
| [Selected](../../aspose.html/htmloptionelement/selected/) { get; set; } | एक इंटरैक्टिव उपयोगकर्ता एजेंट में संबंधित प्रपत्र नियंत्रण की वर्तमान स्थिति का प्रतिनिधित्व करता है। इस विशेषता को बदलने से फ़ॉर्म नियंत्रण की स्थिति बदल जाती है, लेकिन तत्व के HTML चयनित विशेषता का मान नहीं बदलता है। |
...
| [Text](../../aspose.html/htmloptionelement/text/) { get; } | विकल्प तत्व के भीतर निहित पाठ। |
...
| [Value](../../aspose.html/htmloptionelement/value/) { get; set; } | वर्तमान प्रपत्र नियंत्रण मान। HTML 4.01. में मान विशेषता परिभाषा देखें |
