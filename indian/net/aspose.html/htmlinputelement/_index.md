...
description: Aspose.Html.HTMLInputElement कक्ष. प्रपत्र नयंत्रण उस वतवरण पर नर्भर करत है जसमें पृष्ठ देख ज रह है मन गुण फ़इल अपलड इनपुट प्रकर के लए केवल पढ़ने के लए ह सकत है पसवर्ड इनपुट प्रकर के लए अनधकृत उपयग क रकने के लए लटय गय वस्तवक मन मस्क कय ज सकत है में INPUT तत्व परभष देखेंएचटएमएल 4.01 .
type: docs
weight: 3320
url: /hi/net/aspose.html/htmlinputelement/
---
## HTMLInputElement class

प्रपत्र नियंत्रण। उस वातावरण पर निर्भर करता है जिसमें पृष्ठ देखा जा रहा है, मान गुण फ़ाइल अपलोड इनपुट प्रकार के लिए केवल पढ़ने के लिए हो सकता है। "पासवर्ड" इनपुट प्रकार के लिए, अनधिकृत उपयोग को रोकने के लिए लौटाया गया वास्तविक मान मास्क किया जा सकता है। [में INPUT तत्व परिभाषा देखें[एचटीएमएल 4.01](http://www.w3.org/TR/1999/REC-html401-19991224) ].
...
| नाम | विवरण |
| --- | --- |
| [Accept](../../aspose.html/htmlinputelement/accept/) { get; set; } | सामग्री प्रकारों की अल्पविराम से अलग की गई सूची जो इस फ़ॉर्म को संसाधित करने वाला सर्वर सही ढंग से संभालेगा। HTML 4.01. में स्वीकार विशेषता परिभाषा देखें |
| [AccessKey](../../aspose.html/htmlinputelement/accesskey/) { get; set; } | प्रपत्र नियंत्रण तक पहुंच प्रदान करने के लिए एकल वर्ण पहुंच कुंजी। HTML 4.01. में एक्सेसकुंजी विशेषता परिभाषा देखें |
| [Align](../../aspose.html/htmlinputelement/align/) { get; set; } | इस ऑब्जेक्ट को इसके आसपास के टेक्स्ट के संबंध में (लंबवत या क्षैतिज रूप से) संरेखित करता है। HTML 4.01 में एलाइन विशेषता परिभाषा देखें। यह विशेषता HTML 4.01. में बहिष्कृत है |
| [Alt](../../aspose.html/htmlinputelement/alt/) { get; set; } | उपयोगकर्ता एजेंटों के लिए वैकल्पिक पाठ इस तत्व की सामान्य सामग्री को प्रस्तुत नहीं कर रहा है। HTML 4.01. में ऑल्ट विशेषता परिभाषा देखें |
...
| [DefaultChecked](../../aspose.html/htmlinputelement/defaultchecked/) { get; set; } | कब`प्रकार` मान "रेडियो" या "चेकबॉक्स" है, यह तत्व के HTML चेक किए गए विशेषता का प्रतिनिधित्व करता है। का मान इस विशेषता में परिवर्तन नहीं होता है यदि एक इंटरैक्टिव उपयोगकर्ता एजेंट में संबंधित प्रपत्र नियंत्रण की स्थिति बदल जाती है। HTML 4.01. में जाँच की गई विशेषता परिभाषा देखें |
| [DefaultValue](../../aspose.html/htmlinputelement/defaultvalue/) { get; set; } | जब`प्रकार`तत्व की विशेषता का मान "टेक्स्ट", "फ़ाइल" या "पासवर्ड" है, यह तत्व के HTML मान विशेषता का प्रतिनिधित्व करता है। इस विशेषता का मान नहीं बदलता है यदि संबंधित प्रपत्र नियंत्रण की सामग्री, एक इंटरैक्टिव उपयोगकर्ता एजेंट में बदलती है। HTML 4.01. में मान विशेषता परिभाषा देखें |
...
| [Disabled](../../aspose.html/htmlinputelement/disabled/) { get; set; } | इस संदर्भ में नियंत्रण उपलब्ध नहीं है। HTML 4.01. में अक्षम विशेषता परिभाषा देखें |
| [Files](../../aspose.html/htmlinputelement/files/) { get; } | फ़ाइलें IDL विशेषता स्क्रिप्ट को तत्व की चयनित फ़ाइलों तक पहुँचने की अनुमति देती हैं। प्राप्त करने पर, यदि IDL विशेषता लागू होती है, तो उसे एक FileList ऑब्जेक्ट वापस करना होगा जो वर्तमान चयनित फ़ाइलों का प्रतिनिधित्व करता है। जब तक चयनित फ़ाइलों की सूची नहीं बदल जाती, तब तक उसी वस्तु को लौटाया जाना चाहिए। यदि IDL विशेषता लागू नहीं होती है, तो उसे इसके बजाय शून्य होना चाहिए। [FILEAPI] |
...
| [Form](../../aspose.html/htmlinputelement/form/) { get; set; } | लौटाता है`प्रपत्र` इस नियंत्रण वाले तत्व। रिटर्न `व्यर्थ` अगर यह नियंत्रण फ़ॉर्म के संदर्भ में नहीं है. |
...
| [List](../../aspose.html/htmlinputelement/list/) { get; set; } | सूची विशेषता का उपयोग उस तत्व की पहचान करने के लिए किया जाता है जो उपयोगकर्ता को सुझाए गए पूर्वनिर्धारित विकल्पों को सूचीबद्ध करता है। यदि मौजूद है, तो इसका मान उसी दस्तावेज़ में डेटालिस्ट तत्व की आईडी होना चाहिए। |
...
| [MaxLength](../../aspose.html/htmlinputelement/maxlength/) { get; set; } | टेक्स्ट फ़ील्ड के लिए वर्णों की अधिकतम संख्या, जब`प्रकार` का मान "टेक्स्ट" या "पासवर्ड" है। HTML 4.01. में अधिकतम लम्बाई विशेषता परिभाषा देखें |
| [Name](../../aspose.html/htmlinputelement/name/) { get; set; } | प्रपत्र नियंत्रण या वस्तु का नाम जब प्रपत्र के साथ सबमिट किया जाता है। HTML 4.01. में नाम विशेषता परिभाषा देखें |
...
| [ReadOnly](../../aspose.html/htmlinputelement/readonly/) { get; set; } | यह नियंत्रण केवल पढ़ने के लिए है। प्रासंगिक केवल जब`प्रकार` मान "टेक्स्ट" या "पासवर्ड" है। HTML 4.01. में केवल पढ़ने योग्य विशेषता परिभाषा देखें |
...
| [Size](../../aspose.html/htmlinputelement/size/) { get; set; } | आकार की जानकारी। सटीक अर्थ प्रत्येक प्रकार के फ़ील्ड के लिए विशिष्ट है। HTML 4.01. @version DOM Level 2 में आकार विशेषता परिभाषा देखें |
| [Src](../../aspose.html/htmlinputelement/src/) { get; set; } | जब`प्रकार`विशेषता का मूल्य "छवि" है, यह विशेषता चित्र के स्थान को निर्दिष्ट करती है जिसका उपयोग ग्राफिकल सबमिट बटन को सजाने के लिए किया जाता है। HTML 4.01. में src विशेषता परिभाषा देखें |
...
| [TabIndex](../../aspose.html/htmlinputelement/tabindex/) { get; set; } | अनुक्रमणिका जो टैबिंग क्रम में तत्व की स्थिति का प्रतिनिधित्व करती है। HTML 4.01. में Tabindex विशेषता परिभाषा देखें |
...
| [Type](../../aspose.html/htmlinputelement/type/) { get; set; } | निर्मित नियंत्रण का प्रकार (सभी लोअर केस)। HTML 4.01 में प्रकार विशेषता परिभाषा देखें। @वर्जन डोम लेवल 2 |
| [UseMap](../../aspose.html/htmlinputelement/usemap/) { get; set; } | क्लाइंट-साइड इमेज मैप का उपयोग करें। HTML 4.01. में usemap विशेषता परिभाषा देखें |
| [Value](../../aspose.html/htmlinputelement/value/) { get; set; } | जब`प्रकार` तत्व की विशेषता का मान "टेक्स्ट", "फ़ाइल" या "पासवर्ड" है, यह एक इंटरैक्टिव उपयोगकर्ता एजेंट में संबंधित प्रपत्र नियंत्रण की वर्तमान सामग्री का प्रतिनिधित्व करता है। इस विशेषता को बदलने से प्रपत्र नियंत्रण की सामग्री बदल जाती है, लेकिन तत्व के HTML मान विशेषता का मान नहीं बदलता है। जब`प्रकार`तत्व की विशेषता का मान "बटन", "छिपा हुआ", "सबमिट", "रीसेट", "छवि", "चेकबॉक्स" या "रेडियो" है, यह तत्व के HTML मान विशेषता का प्रतिनिधित्व करता है। HTML 4.01. में मान विशेषता परिभाषा देखें |
