...
description: Aspose.Html.HTMLElement कक्ष. सभ HTML एलमेंट इंटरफेस इस क्लस से प्रप्त हते हैं वे तत्व ज केवल HTML कर वशेषतओं क प्रदर्शत करते हैं आधर द्वर दर्शए जते हैंHTMLतत्वइंटरफेस ये तत्व इस प्रकर हैं वशेष SUB SUP SPAN BDOफ़न्ट TT I B U S STRIKE BIG SMALL वक्यंश EM STRONG DFN CODE SAMP KBD VAR CITE एक्रनम एबबआरसूच डड डटएनओफ्रेम्स नस्क्रप्टपत केंद्रशैल HTML तत्व क वशेषत क के मध्यम से एक्सेस कय ज सकत हैElementCSSInlineStyle इंटरफ़ेस जसे CSS मड्यूल में परभषत कय गय है DOM लेवल 2 स्टइल शट और CSS 
type: docs
weight: 3200
url: /hi/net/aspose.html/htmlelement/
---
## HTMLElement class

सभी HTML एलिमेंट इंटरफेस इस क्लास से प्राप्त होते हैं। वे तत्व जो केवल HTML कोर विशेषताओं को प्रदर्शित करते हैं, आधार द्वारा दर्शाए जाते हैं`HTMLतत्व`इंटरफेस। ये तत्व इस प्रकार हैं: विशेष: SUB, SUP, SPAN, BDOफ़ॉन्ट: TT, I, B, U, S, STRIKE, BIG, SMALL वाक्यांश: EM, STRONG, DFN, CODE, SAMP, KBD, VAR, CITE, एक्रोनिम, एबीबीआरसूची: डीडी, डीटीएनओफ्रेम्स, नोस्क्रिप्टपता, केंद्र`शैली` HTML तत्व की विशेषता को के माध्यम से एक्सेस किया जा सकता है`ElementCSSInlineStyle` इंटरफ़ेस जिसे CSS मॉड्यूल में परिभाषित किया गया है [[DOM लेवल 2 स्टाइल शीट और CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113) ]।
