...
description: Aspose.Html.HTMLImageElement कक्ष. एम्बेडेड छव HTML 4.01. में IMG तत्व क परभष देखें
type: docs
weight: 3310
url: /hi/net/aspose.html/htmlimageelement/
---
## HTMLImageElement class

एम्बेडेड छवि। HTML 4.01. में IMG तत्व की परिभाषा देखें
...
| नाम | विवरण |
| --- | --- |
| [Align](../../aspose.html/htmlimageelement/align/) { get; set; } | इस ऑब्जेक्ट को इसके आसपास के टेक्स्ट के संबंध में (लंबवत या क्षैतिज रूप से) संरेखित करता है। HTML 4.01 में एलाइन विशेषता परिभाषा देखें। यह विशेषता HTML 4.01. में बहिष्कृत है |
| [Alt](../../aspose.html/htmlimageelement/alt/) { get; set; } | उपयोगकर्ता एजेंटों के लिए वैकल्पिक पाठ इस तत्व की सामान्य सामग्री को प्रस्तुत नहीं कर रहा है। HTML 4.01. में ऑल्ट विशेषता परिभाषा देखें |
...
| [Border](../../aspose.html/htmlimageelement/border/) { get; set; } | छवि के चारों ओर बॉर्डर की चौड़ाई। HTML 4.01 में बॉर्डर विशेषता परिभाषा देखें। यह विशेषता HTML 4.01 में बहिष्कृत है। ध्यान दें कि इस विशेषता का प्रकार था`DOMString` DOM लेवल 1 HTML में [[डोम स्तर 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ] . |
...
| [Height](../../aspose.html/htmlimageelement/height/) { get; set; } | पिक्सल में छवि की ऊंचाई। HTML 4.01 में ऊंचाई विशेषता परिभाषा देखें। ध्यान दें कि इस विशेषता का प्रकार था`DOMString` DOM लेवल 1 HTML में [[डोम स्तर 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ]. @वर्जन डोम लेवल 2 |
| [Hspace](../../aspose.html/htmlimageelement/hspace/) { get; set; } | पिक्सेल में इस छवि के बाएँ और दाएँ क्षैतिज स्थान। HTML 4.01 में hspace विशेषता परिभाषा देखें। यह विशेषता HTML 4.01 में बहिष्कृत है। ध्यान दें कि इस विशेषता का प्रकार था`DOMString` DOM लेवल 1 HTML में [[डोम स्तर 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ]. @वर्जन डोम लेवल 2 |
...
| [IsMap](../../aspose.html/htmlimageelement/ismap/) { get; set; } | सर्वर-साइड इमेज मैप का उपयोग करें। HTML 4.01. में ismap विशेषता परिभाषा देखें |
...
| [LongDesc](../../aspose.html/htmlimageelement/longdesc/) { get; set; } | यूआरआई [[आईईटीएफ आरएफसी 2396](http://www.ietf.org/rfc/rfc2396.txt) ] इस छवि या फ्रेम का एक लंबा विवरण निर्दिष्ट करना। HTML 4.01. में longdesc विशेषता परिभाषा देखें |
| [Name](../../aspose.html/htmlimageelement/name/) { get; set; } | तत्व का नाम (पिछड़ी संगतता के लिए)। |
...
| [Src](../../aspose.html/htmlimageelement/src/) { get; set; } | यूआरआई [[आईईटीएफ आरएफसी 2396](http://www.ietf.org/rfc/rfc2396.txt) ] इस छवि के स्रोत को निर्दिष्ट करना। HTML 4.01. में src विशेषता परिभाषा देखें |
...
| [UseMap](../../aspose.html/htmlimageelement/usemap/) { get; set; } | क्लाइंट-साइड इमेज मैप का उपयोग करें। HTML 4.01. में usemap विशेषता परिभाषा देखें |
| [Vspace](../../aspose.html/htmlimageelement/vspace/) { get; set; } | पिक्सेल में इस छवि के ऊपर और नीचे लंबवत स्थान। HTML 4.01 में vspace विशेषता परिभाषा देखें। यह विशेषता HTML 4.01 में बहिष्कृत है। ध्यान दें कि इस विशेषता का प्रकार DOM स्तर 1 HTML में "DOMString" था [[डोम स्तर 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ]. @वर्जन डोम लेवल 2 |
| [Width](../../aspose.html/htmlimageelement/width/) { get; set; } | पिक्सल में छवि की चौड़ाई। HTML 4.01 में चौड़ाई विशेषता परिभाषा देखें। ध्यान दें कि इस विशेषता का प्रकार था`DOMString` DOM लेवल 1 HTML में [[डोम स्तर 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ]. @वर्जन डोम लेवल 2 |
