...
description: Aspose.Html.HTMLStyleElement कक्ष. शैल क जनकर HTML 4.01 में स्टइल एलमेंट क परभष देखें CSS मड्यूल DOM लेवल 2 स्टइल शट और CSS  और यहलंक स्टइल स्टइलशट्स मड्यूल में इंटरफ़ेस DOM लेवल 2 स्टइल शट और CSS 
type: docs
weight: 3530
url: /hi/net/aspose.html/htmlstyleelement/
---
## HTMLStyleElement class

शैली की जानकारी। HTML 4.01 में स्टाइल एलिमेंट की परिभाषा देखें, CSS मॉड्यूल [[DOM लेवल 2 स्टाइल शीट और CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113) ] और यह`लिंक स्टाइल` स्टाइलशीट्स मॉड्यूल में इंटरफ़ेस [[DOM लेवल 2 स्टाइल शीट और CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113) ]।
...
| [Disabled](../../aspose.html/htmlstyleelement/disabled/) { get; set; } | स्टाइल शीट को सक्षम/अक्षम करता है। |
...
| [Media](../../aspose.html/htmlstyleelement/media/) { get; set; } | एक या अधिक लक्ष्य मीडिया के साथ उपयोग के लिए डिज़ाइन किया गया। HTML 4.01. में मीडिया विशेषता परिभाषा देखें |
...
| [Sheet](../../aspose.html/htmlstyleelement/sheet/) { get; } | संबंधित स्टाइल शीट प्राप्त करता है। |
...
| [Type](../../aspose.html/htmlstyleelement/type/) { get; set; } | स्टाइल शीट भाषा का सामग्री प्रकार। HTML 4.01. में प्रकार विशेषता परिभाषा देखें |
