...
description: Aspose.Html.HTMLTableElement कक्ष. टेबल पर क्रएट और डलट वधयं लेखकं क टेबल बनने और संशधत करने क अनुमत देत हैं एचटएमएल 4.01  नर्दष्ट करत है क प्रत्येक में से केवल एककैप्शन ठेड  औरTFOOT तत्व तलक में मजूद ह सकते हैं इसलए यद कई मजूद है और createTHead य createTFoot वध क कल कय जत है त वध मजूद THead य TFoot तत्व क वपस कर देत है HTML 4.01. में तलक तत्व परभष देखें
type: docs
weight: 3570
url: /hi/net/aspose.html/htmltableelement/
---
...
| नाम | विवरण |
| --- | --- |
| [Align](../../aspose.html/htmltableelement/align/) { get; set; } | शेष दस्तावेज़ के संबंध में तालिका की स्थिति निर्दिष्ट करता है। HTML 4.01 में एलाइन विशेषता परिभाषा देखें। यह विशेषता HTML 4.01. में बहिष्कृत है |
...
| [BgColor](../../aspose.html/htmltableelement/bgcolor/) { get; set; } | सेल पृष्ठभूमि रंग। HTML 4.01 में bgcolor विशेषता परिभाषा देखें। यह विशेषता HTML 4.01. में बहिष्कृत है |
| [Border](../../aspose.html/htmltableelement/border/) { get; set; } | टेबल के चारों ओर बॉर्डर की चौड़ाई. HTML 4.01. में बॉर्डर विशेषता परिभाषा देखें |
| [Caption](../../aspose.html/htmltableelement/caption/) { get; } | तालिका लौटाता है`कैप्शन` , या शून्य अगर कोई मौजूद नहीं है। @वर्जन डोम लेवल 2 |
| [CellPadding](../../aspose.html/htmltableelement/cellpadding/) { get; set; } | सेल सामग्री और सेल बॉर्डर के बीच क्षैतिज और लंबवत स्थान निर्दिष्ट करता है। HTML 4.01. में सेलपैडिंग विशेषता परिभाषा देखें |
| [CellSpacing](../../aspose.html/htmltableelement/cellspacing/) { get; set; } | कोशिकाओं के बीच क्षैतिज और लंबवत अलगाव निर्दिष्ट करता है। HTML 4.01. में सेलस्पेसिंग विशेषता परिभाषा देखें |
...
| [Frame](../../aspose.html/htmltableelement/frame/) { get; set; } | निर्दिष्ट करता है कि कौन सी बाहरी तालिका बॉर्डर प्रस्तुत करनी है। HTML 4.01. में फ़्रेम विशेषता परिभाषा देखें |
...
| [Rows](../../aspose.html/htmltableelement/rows/) { get; } | तालिका लौटाता है`TFOOT` , या`व्यर्थ` अगर कोई नहीं मौजूद है। |
| [Rules](../../aspose.html/htmltableelement/rules/) { get; set; } | निर्दिष्ट करता है कि कौन सी आंतरिक तालिका सीमाएँ प्रस्तुत करनी हैं। HTML 4.01. में नियम विशेषता परिभाषा देखें |
...
| [Summary](../../aspose.html/htmltableelement/summary/) { get; set; } | तालिका के उद्देश्य या संरचना के बारे में विवरण। HTML 4.01. में सारांश विशेषता परिभाषा देखें |
| [TagName](../../aspose.html.dom/element/tagname/) { get; } | तत्व का नाम। |
| [TBodies](../../aspose.html/htmltableelement/tbodies/) { get; } | तालिका निकायों का एक संग्रह लौटाता है (अंतर्निहित लोगों सहित)। |
...
| [TFoot](../../aspose.html/htmltableelement/tfoot/) { get; } | तालिका लौटाता है`ठेड` , या`व्यर्थ` अगर कोई नहीं मौजूद है। |
| [THead](../../aspose.html/htmltableelement/thead/) { get; } | तालिका लौटाता है`कैप्शन` , या शून्य अगर कोई मौजूद नहीं है। |
| [Title](../../aspose.html/htmlelement/title/) { get; set; } | तत्व का सलाहकार शीर्षक। HTML 4.01. में शीर्षक विशेषता परिभाषा देखें |
| [Width](../../aspose.html/htmltableelement/width/) { get; set; } | वांछित तालिका चौड़ाई निर्दिष्ट करता है। HTML 4.01. में चौड़ाई विशेषता परिभाषा देखें |
...
| [CreateCaption](../../aspose.html/htmltableelement/createcaption/)() | एक नया टेबल कैप्शन ऑब्जेक्ट बनाएं या किसी मौजूदा को वापस करें। |
| [CreateTFoot](../../aspose.html/htmltableelement/createtfoot/)() | एक तालिका पादलेख पंक्ति बनाएँ या किसी मौजूदा को लौटाएँ। |
| [CreateTHead](../../aspose.html/htmltableelement/createthead/)() | तालिका शीर्षलेख पंक्ति बनाएं या मौजूदा तालिका वापस करें। |
| [DeleteCaption](../../aspose.html/htmltableelement/deletecaption/)() | तालिका शीर्षक हटाएं, यदि कोई मौजूद है। |
| [DeleteRow](../../aspose.html/htmltableelement/deleterow/)(int) | तालिका पंक्ति हटाएं। |
| [DeleteTFoot](../../aspose.html/htmltableelement/deletetfoot/)() | तालिका से पाद लेख हटाएं, यदि कोई मौजूद है। |
| [DeleteTHead](../../aspose.html/htmltableelement/deletethead/)() | हेडर को तालिका से हटाएं, यदि कोई मौजूद है। |
