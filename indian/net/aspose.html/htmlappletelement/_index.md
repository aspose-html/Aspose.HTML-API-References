...
description: Aspose.Html.HTMLAppletElement कक्ष. एक एम्बेडेड जव एप्लेट HTML 4.01 में APPLET तत्व परभष देखें यह तत्व HTML 4.01. में बहष्कृत है
type: docs
weight: 3070
url: /hi/net/aspose.html/htmlappletelement/
---
## HTMLAppletElement class

एक एम्बेडेड जावा एप्लेट। HTML 4.01 में APPLET तत्व परिभाषा देखें। यह तत्व HTML 4.01. में बहिष्कृत है
...
| नाम | विवरण |
| --- | --- |
| [Align](../../aspose.html/htmlappletelement/align/) { get; set; } | इस ऑब्जेक्ट को इसके आसपास के टेक्स्ट के संबंध में (लंबवत या क्षैतिज रूप से) संरेखित करता है। HTML 4.01 में एलाइन विशेषता परिभाषा देखें। यह विशेषता HTML 4.01. में बहिष्कृत है |
| [Alt](../../aspose.html/htmlappletelement/alt/) { get; set; } | उपयोगकर्ता एजेंटों के लिए वैकल्पिक पाठ इस तत्व की सामान्य सामग्री को प्रस्तुत नहीं कर रहा है। HTML 4.01 में alt विशेषता परिभाषा देखें। यह विशेषता HTML 4.01. में बहिष्कृत है |
| [Archive](../../aspose.html/htmlappletelement/archive/) { get; set; } | अल्पविराम से अलग की गई संग्रह सूची। HTML 4.01 में संग्रह विशेषता परिभाषा देखें। यह विशेषता HTML 4.01. में बहिष्कृत है |
...
| [Code](../../aspose.html/htmlappletelement/code/) { get; set; } | एप्लेट वर्ग फ़ाइल। HTML 4.01 में कोड विशेषता परिभाषा देखें। यह विशेषता HTML 4.01. में बहिष्कृत है |
| [CodeBase](../../aspose.html/htmlappletelement/codebase/) { get; set; } | वैकल्पिक आधार यूआरआई [[आईईटीएफ आरएफसी 2396](http://www.ietf.org/rfc/rfc2396.txt) एप्लेट के लिए। HTML 4.01 में कोडबेस विशेषता परिभाषा देखें। यह विशेषता HTML 4.01. में बहिष्कृत है |
...
| [Height](../../aspose.html/htmlappletelement/height/) { get; set; } | ओवरराइड ऊंचाई। HTML 4.01 में ऊंचाई विशेषता परिभाषा देखें। यह विशेषता HTML 4.01. में बहिष्कृत है |
| [Hspace](../../aspose.html/htmlappletelement/hspace/) { get; set; } | क्षैतिज स्थान, पिक्सेल में, इस छवि के बाएँ और दाएँ, एप्लेट, या ऑब्जेक्ट। HTML 4.01 में hspace विशेषता परिभाषा देखें। यह विशेषता HTML 4.01. @version DOM स्तर 2 में बहिष्कृत है |
...
| [Name](../../aspose.html/htmlappletelement/name/) { get; set; } | एप्लेट का नाम। HTML 4.01 में नाम विशेषता परिभाषा देखें। यह विशेषता HTML 4.01. में बहिष्कृत है |
...
| [Object](../../aspose.html/htmlappletelement/object/) { get; set; } | "ऑब्जेक्ट" विशेषता का मान। HTML 4.01 में ऑब्जेक्ट विशेषता definition देखें। यह विशेषता HTML 4.01 में बहिष्कृत है। @वर्जन डोम लेवल 2 |
...
| [Vspace](../../aspose.html/htmlappletelement/vspace/) { get; set; } | लंबवत स्थान, पिक्सेल में, इस छवि, एप्लेट, या ऑब्जेक्ट के ऊपर और नीचे। HTML 4.01 में vspace विशेषता परिभाषा देखें। यह विशेषता HTML 4.01. @version DOM स्तर 2 में बहिष्कृत है |
| [Width](../../aspose.html/htmlappletelement/width/) { get; set; } | ओवरराइड चौड़ाई। HTML 4.01 में चौड़ाई विशेषता परिभाषा देखें। यह विशेषता HTML 4.01. में बहिष्कृत है |
