...
description: Aspose.Html.HTMLLabelElement कक्ष. फ़र्म फ़ल्ड लेबल टेक्स्ट. HTML 4.01. में लेबल तत्व क परभष देखें
type: docs
weight: 3350
url: /hi/net/aspose.html/htmllabelelement/
---
## HTMLLabelElement class

फ़ॉर्म फ़ील्ड लेबल टेक्स्ट. HTML 4.01. में लेबल तत्व की परिभाषा देखें
...
| नाम | विवरण |
| --- | --- |
| [AccessKey](../../aspose.html/htmllabelelement/accesskey/) { get; set; } | प्रपत्र नियंत्रण तक पहुंच प्रदान करने के लिए एकल वर्ण पहुंच कुंजी। HTML 4.01. में एक्सेसकुंजी विशेषता परिभाषा देखें |
...
| [For](../../aspose.html/htmllabelelement/for/) { get; set; } | यह विशेषता द्वारा इस लेबल को अन्य प्रपत्र नियंत्रण से जोड़ती है`पहचान`गुण। HTML 4.01. में विशेषता परिभाषा देखें |
| [Form](../../aspose.html/htmllabelelement/form/) { get; } | लौटाता है`प्रपत्र` इस नियंत्रण वाले तत्व। रिटर्न `व्यर्थ` अगर यह नियंत्रण फ़ॉर्म के संदर्भ में नहीं है. |
