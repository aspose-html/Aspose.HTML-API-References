...
description: Aspose.Html.HTMLFrameElement कक्ष. एक फ्रेम बनएं HTML 4.01. में FRAME तत्व क परभष देखें
type: docs
weight: 3240
url: /hi/net/aspose.html/htmlframeelement/
---
## HTMLFrameElement class

एक फ्रेम बनाएं। HTML 4.01. में FRAME तत्व की परिभाषा देखें
...
| [ContentDocument](../../aspose.html/htmlframeelement/contentdocument/) { get; } | इस फ्रेम में मौजूद दस्तावेज़, यदि कोई है और यह उपलब्ध है, या`व्यर्थ` अन्यथा. @ चूंकि डोम स्तर 2 |
...
| [FrameBorder](../../aspose.html/htmlframeelement/frameborder/) { get; set; } | फ्रेम बॉर्डर का अनुरोध करें। HTML 4.01. में फ़्रेमबॉर्डर विशेषता परिभाषा देखें |
...
| [LongDesc](../../aspose.html/htmlframeelement/longdesc/) { get; set; } | यूआरआई [[आईईटीएफ आरएफसी 2396](http://www.ietf.org/rfc/rfc2396.txt) ] इस छवि या फ्रेम का एक लंबा विवरण निर्दिष्ट करना। HTML 4.01. में longdesc विशेषता परिभाषा देखें |
| [MarginHeight](../../aspose.html/htmlframeelement/marginheight/) { get; set; } | फ़्रेम मार्जिन ऊंचाई, पिक्सेल में. HTML 4.01. में मार्जिनहाइट विशेषता परिभाषा देखें |
| [MarginWidth](../../aspose.html/htmlframeelement/marginwidth/) { get; set; } | फ़्रेम मार्जिन चौड़ाई, पिक्सेल में. HTML 4.01. में मार्जिनविड्थ विशेषता परिभाषा देखें |
| [Name](../../aspose.html/htmlframeelement/name/) { get; set; } | फ़्रेम का नाम (ऑब्जेक्ट ऑफ़ द`लक्ष्य` गुण)। HTML 4.01. में नाम विशेषता परिभाषा देखें |
...
| [NoResize](../../aspose.html/htmlframeelement/noresize/) { get; set; } | सही होने पर, उपयोगकर्ता को फ़्रेम का आकार बदलने से रोकें। HTML 4.01. में noresize विशेषता परिभाषा देखें |
...
| [Scrolling](../../aspose.html/htmlframeelement/scrolling/) { get; set; } | निर्दिष्ट करें कि फ्रेम में स्क्रॉलबार होना चाहिए या नहीं। HTML 4.01. में स्क्रॉल विशेषता परिभाषा देखें |
| [ShadowRoot](../../aspose.html.dom/element/shadowroot/) { get; } | इस तत्व पर संग्रहीत शैडोरूट लौटाता है या बंद होने पर अशक्त होता है। |
| [Src](../../aspose.html/htmlframeelement/src/) { get; set; } | एक यूआरआई [[आईईटीएफ आरएफसी 2396](http://www.ietf.org/rfc/rfc2396.txt) ] प्रारंभिक फ्रेम सामग्री को नामित करना। HTML 4.01. में src विशेषता परिभाषा देखें |
