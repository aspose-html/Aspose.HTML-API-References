...
description: Aspose.Html.HTMLTableCellElement कक्ष. वस्तु क प्रतनधत्व करने के लए प्रयग कय जत हैवं औरटड तत्व HTML 4.01. में TD तत्व क परभष देखें
type: docs
weight: 3550
url: /hi/net/aspose.html/htmltablecellelement/
---
## HTMLTableCellElement class

वस्तु का प्रतिनिधित्व करने के लिए प्रयोग किया जाता है`वां` और`टीडी` तत्व। HTML 4.01. में TD तत्व की परिभाषा देखें
...
| नाम | विवरण |
| --- | --- |
| [Abbr](../../aspose.html/htmltablecellelement/abbr/) { get; set; } | हेडर सेल के लिए संक्षिप्त रूप। HTML 4.01. में abbr विशेषता परिभाषा देखें |
| [Align](../../aspose.html/htmltablecellelement/align/) { get; set; } | सेल में डेटा का क्षैतिज संरेखण। HTML 4.01. में एलाइन विशेषता definition देखें |
...
| [Axis](../../aspose.html/htmltablecellelement/axis/) { get; set; } | संबंधित हेडर के समूह का नाम देता है। HTML 4.01. में अक्ष विशेषता परिभाषा देखें |
...
| [BgColor](../../aspose.html/htmltablecellelement/bgcolor/) { get; set; } | सेल पृष्ठभूमि रंग। HTML 4.01 में bgcolor विशेषता परिभाषा देखें। यह विशेषता HTML 4.01. में बहिष्कृत है |
| [CellIndex](../../aspose.html/htmltablecellelement/cellindex/) { get; } | पंक्ति में इस सेल का सूचकांक, 0 से शुरू होता है। यह सूचकांक दस्तावेज़ ट्री ऑर्डर में है और डिस्प्ले ऑर्डर नहीं है। |
| [Ch](../../aspose.html/htmltablecellelement/ch/) { get; set; } | कॉलम में सेल के लिए अलाइनमेंट कैरेक्टर। HTML 4.01. में चार विशेषता परिभाषा देखें |
...
| [ChOff](../../aspose.html/htmltablecellelement/choff/) { get; set; } | संरेखण चरित्र का ऑफसेट। HTML 4.01. में charoff विशेषता परिभाषा देखें |
...
| [ColSpan](../../aspose.html/htmltablecellelement/colspan/) { get; set; } | सेल द्वारा फैले कॉलम की संख्या। HTML 4.01. में कोलस्पैन विशेषता परिभाषा देखें |
...
| [Headers](../../aspose.html/htmltablecellelement/headers/) { get; set; } | की सूची`पहचान` हेडर सेल के लिए विशेषता मान। HTML 4.01. में हेडर विशेषता परिभाषा देखें |
| [Height](../../aspose.html/htmltablecellelement/height/) { get; set; } | सेल की ऊंचाई। HTML 4.01 में ऊंचाई विशेषता परिभाषा देखें। यह विशेषता HTML 4.01. में बहिष्कृत है |
...
| [NoWrap](../../aspose.html/htmltablecellelement/nowrap/) { get; set; } | वर्ड रैपिंग को दबाएं। HTML 4.01 में Nowrap विशेषता परिभाषा देखें। यह विशेषता HTML 4.01. में बहिष्कृत है |
...
| [RowSpan](../../aspose.html/htmltablecellelement/rowspan/) { get; set; } | सेल द्वारा फैली पंक्तियों की संख्या। HTML 4.01. में रोस्पेन विशेषता परिभाषा देखें |
| [SchemaTypeInfo](../../aspose.html.dom/element/schematypeinfo/) { get; } | इस तत्व से जुड़ी प्रकार की जानकारी। |
| [Scope](../../aspose.html/htmltablecellelement/scope/) { get; set; } | दायरा हेडर सेल द्वारा कवर किया गया। _ HTML 4.01. में स्कोप विशेषता परिभाषा देखें |
...
| [VAlign](../../aspose.html/htmltablecellelement/valign/) { get; set; } | सेल में डेटा का लंबवत संरेखण। HTML 4.01. में वेलिग्न विशेषता परिभाषा देखें |
| [Width](../../aspose.html/htmltablecellelement/width/) { get; set; } | सेल की चौड़ाई। HTML 4.01 में चौड़ाई विशेषता परिभाषा देखें। यह विशेषता HTML 4.01. में बहिष्कृत है |
