...
description: Aspose.Html.HTMLLIElement कक्ष. सूच आइटम HTML 4.01. में LI तत्व क परभष देखें
type: docs
weight: 3340
url: /hi/net/aspose.html/htmllielement/
---
## HTMLLIElement class
...
| [Type](../../aspose.html/htmllielement/type/) { get; set; } | सूची आइटम बुलेट शैली। HTML 4.01 में प्रकार विशेषता परिभाषा देखें। यह विशेषता HTML 4.01. में बहिष्कृत है |
| [Value](../../aspose.html/htmllielement/value/) { get; set; } | में उपयोग किए जाने पर अनुक्रम संख्या रीसेट करें`राजभाषा` . HTML 4.01 में मान विशेषता परिभाषा देखें। यह विशेषता HTML 4.01. में बहिष्कृत है |
