...
description: Aspose.Html.HTMLFrameSetElement कक्ष. फ़्रेम क ग्रड बनएं HTML 4.01. में FRAMESET तत्व परभष देखें
type: docs
weight: 3250
url: /hi/net/aspose.html/htmlframesetelement/
---
## HTMLFrameSetElement class

फ़्रेम का ग्रिड बनाएं। HTML 4.01. में FRAMESET तत्व परिभाषा देखें
...
| [Cols](../../aspose.html/htmlframesetelement/cols/) { get; set; } | फ़्रेमसेट में फ़्रेम के स्तंभों की संख्या। HTML 4.01. में cols विशेषता परिभाषा देखें |
...
| [Rows](../../aspose.html/htmlframesetelement/rows/) { get; set; } | फ़्रेमसेट में फ़्रेम की पंक्तियों की संख्या। HTML 4.01. में पंक्तियों की विशेषता परिभाषा देखें |
