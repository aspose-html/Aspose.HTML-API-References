...
description: Aspose.Html.HTMLTableColElement कक्ष. पुन समूहत करत हैकर्नल औरकलग्रुप तत्व HTML 4.01. में COL एलमेंट क परभष देखें
type: docs
weight: 3560
url: /hi/net/aspose.html/htmltablecolelement/
---
## HTMLTableColElement class

पुन: समूहित करता है`कर्नल` और`कोलग्रुप` तत्व। HTML 4.01. में COL एलिमेंट की परिभाषा देखें
...
| नाम | विवरण |
| --- | --- |
| [Align](../../aspose.html/htmltablecolelement/align/) { get; set; } | कॉलम में सेल डेटा का क्षैतिज संरेखण। HTML 4.01. में संरेखित विशेषता परिभाषा देखें |
...
| [Ch](../../aspose.html/htmltablecolelement/ch/) { get; set; } | कॉलम में सेल के लिए अलाइनमेंट कैरेक्टर। HTML 4.01. में चार विशेषता परिभाषा देखें |
...
| [ChOff](../../aspose.html/htmltablecolelement/choff/) { get; set; } | संरेखण चरित्र का ऑफसेट। HTML 4.01. में charoff विशेषता परिभाषा देखें |
...
| [Span](../../aspose.html/htmltablecolelement/span/) { get; set; } | किसी समूह में स्तंभों की संख्या या किसी समूहीकरण से प्रभावित होने का संकेत देता है। HTML 4.01. में स्पैन विशेषता परिभाषा देखें |
...
| [VAlign](../../aspose.html/htmltablecolelement/valign/) { get; set; } | कॉलम में सेल डेटा का वर्टिकल अलाइनमेंट। HTML 4.01. में valign विशेषता परिभाषा देखें |
| [Width](../../aspose.html/htmltablecolelement/width/) { get; set; } | डिफ़ॉल्ट कॉलम चौड़ाई। HTML 4.01. में चौड़ाई विशेषता परिभाषा देखें |
