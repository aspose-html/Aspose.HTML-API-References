...
description: Aspose.Html.HTMLBodyElement कक्ष. HTML दस्तवेज़ नकय यह तत्व हमेश DOM API में मजूद हत है भले ह अगर स्रत दस्तवेज़ में टैग मजूद नहं हैं HTML 4.01. में बड तत्व परभष देखें
type: docs
weight: 3120
url: /hi/net/aspose.html/htmlbodyelement/
---
## HTMLBodyElement class

HTML दस्तावेज़ निकाय। यह तत्व हमेशा DOM API में मौजूद होता है, भले ही अगर स्रोत दस्तावेज़ में टैग मौजूद नहीं हैं। HTML 4.01. में बॉडी तत्व परिभाषा देखें
...
| नाम | विवरण |
| --- | --- |
| [ALink](../../aspose.html/htmlbodyelement/alink/) { get; set; } | सक्रिय लिंक का रंग (माउस-बटन नीचे के बाद, लेकिन माउस-बटन ऊपर से पहले)। HTML 4.01 में alink विशेषता परिभाषा देखें। यह विशेषता HTML 4.01. में बहिष्कृत है |
...
| [Background](../../aspose.html/htmlbodyelement/background/) { get; set; } | यूआरआई [[आईईटीएफ आरएफसी 2396](http://www.ietf.org/rfc/rfc2396.txt) ] पृष्ठभूमि बनावट टाइल छवि का। HTML 4.01 में पृष्ठभूमि विशेषता परिभाषा देखें। यह विशेषता HTML 4.01. में बहिष्कृत है |
...
| [BgColor](../../aspose.html/htmlbodyelement/bgcolor/) { get; set; } | दस्तावेज़ पृष्ठभूमि रंग। HTML 4.01 में bgcolor विशेषता परिभाषा देखें। यह विशेषता HTML 4.01. में बहिष्कृत है |
...
| [Link](../../aspose.html/htmlbodyelement/link/) { get; set; } | उन लिंक्स का रंग जो सक्रिय नहीं हैं और न देखे गए हैं। HTML 4.01 में लिंक विशेषता परिभाषा देखें। यह विशेषता HTML 4.01. में बहिष्कृत है |
...
| [Text](../../aspose.html/htmlbodyelement/text/) { get; set; } | दस्तावेज़ टेक्स्ट का रंग। HTML 4.01 में टेक्स्ट विशेषता परिभाषा देखें। यह विशेषता HTML 4.01. में बहिष्कृत है |
...
| [VLink](../../aspose.html/htmlbodyelement/vlink/) { get; set; } | लिंक का रंग जो उपयोगकर्ता द्वारा देखा गया है। HTML 4.01 में vlink विशेषता परिभाषा देखें। यह विशेषता HTML 4.01. में बहिष्कृत है |
