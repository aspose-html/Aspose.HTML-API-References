...
description: Aspose.Html.HTMLButtonElement कक्ष. पुश बटन HTML 4.01. में बटन तत्व परभष देखें
type: docs
weight: 3130
url: /hi/net/aspose.html/htmlbuttonelement/
---
## HTMLButtonElement class

पुश बटन। HTML 4.01. में बटन तत्व परिभाषा देखें
...
| नाम | विवरण |
| --- | --- |
| [AccessKey](../../aspose.html/htmlbuttonelement/accesskey/) { get; set; } | प्रपत्र नियंत्रण तक पहुंच प्रदान करने के लिए एकल वर्ण पहुंच कुंजी। HTML 4.01. में एक्सेसकुंजी विशेषता परिभाषा देखें |
...
| [Disabled](../../aspose.html/htmlbuttonelement/disabled/) { get; set; } | इस संदर्भ में नियंत्रण उपलब्ध नहीं है। HTML 4.01. में अक्षम विशेषता परिभाषा देखें |
...
| [Form](../../aspose.html/htmlbuttonelement/form/) { get; } | लौटाता है`प्रपत्र` इस नियंत्रण वाले तत्व। रिटर्न `व्यर्थ` अगर यह नियंत्रण फ़ॉर्म के संदर्भ में नहीं है. |
...
| [Name](../../aspose.html/htmlbuttonelement/name/) { get; set; } | प्रपत्र नियंत्रण या वस्तु का नाम जब प्रपत्र के साथ सबमिट किया जाता है। HTML 4.01. में नाम विशेषता परिभाषा देखें |
...
| [TabIndex](../../aspose.html/htmlbuttonelement/tabindex/) { get; set; } | अनुक्रमणिका जो टैबिंग क्रम में तत्व की स्थिति का प्रतिनिधित्व करती है। HTML 4.01. में Tabindex विशेषता परिभाषा देखें |
...
| [Type](../../aspose.html/htmlbuttonelement/type/) { get; set; } | बटन का प्रकार (सभी लोअर केस)। HTML 4.01. में प्रकार विशेषता परिभाषा देखें |
| [Value](../../aspose.html/htmlbuttonelement/value/) { get; set; } | वर्तमान प्रपत्र नियंत्रण मान। HTML 4.01. में मान विशेषता परिभाषा देखें |
