...
description: Aspose.Html.HTMLLinkElement कक्ष. दजड़नतत्व बहर संसधन के लए एक लंक नर्दष्ट करत है और उस संसधन य इसके वपरत के लए इस दस्तवेज़ के संबंध क परभषत करत है HTML 4.01 में लंक तत्व परभष देखें यह भ देखें लंक स्टइल स्टइलशट मड्यूल में इंटरफ़ेस DOM लेवल 2 स्टइल शट और CSS .
type: docs
weight: 3370
url: /hi/net/aspose.html/htmllinkelement/
---
## HTMLLinkElement class

द`जोड़ना`तत्व बाहरी संसाधन के लिए एक लिंक निर्दिष्ट करता है, और उस संसाधन (या इसके विपरीत) के लिए इस दस्तावेज़ के संबंध को परिभाषित करता है। HTML 4.01 में लिंक तत्व परिभाषा देखें (यह भी देखें `लिंक स्टाइल` स्टाइलशीट मॉड्यूल में इंटरफ़ेस [[DOM लेवल 2 स्टाइल शीट और CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113) ]).
...
| [Charset](../../aspose.html/htmllinkelement/charset/) { get; set; } | जिस संसाधन से लिंक किया जा रहा है उसका वर्ण एन्कोडिंग। HTML 4.01. में वर्णसेट विशेषता परिभाषा देखें |
...
| [Disabled](../../aspose.html/htmllinkelement/disabled/) { get; set; } | लिंक को सक्षम/अक्षम करता है। यह वर्तमान में केवल स्टाइल शीट लिंक के लिए उपयोग किया जाता है, और इसका उपयोग स्टाइल शीट को सक्रिय या निष्क्रिय करने के लिए किया जा सकता है। |
...
| [Href](../../aspose.html/htmllinkelement/href/) { get; set; } | यूआरआई [[आईईटीएफ आरएफसी 2396](http://www.ietf.org/rfc/rfc2396.txt) ] लिंक किए गए संसाधन का। HTML 4.01. में href विशेषता परिभाषा देखें |
| [Hreflang](../../aspose.html/htmllinkelement/hreflang/) { get; set; } | लिंक किए गए संसाधन का भाषा कोड। HTML 4.01. में hreflang विशेषता परिभाषा देखें |
...
| [Media](../../aspose.html/htmllinkelement/media/) { get; set; } | एक या अधिक लक्ष्य मीडिया के साथ उपयोग के लिए डिज़ाइन किया गया। HTML 4.01. में मीडिया विशेषता परिभाषा देखें |
...
| [Rel](../../aspose.html/htmllinkelement/rel/) { get; set; } | फॉरवर्ड लिंक प्रकार। HTML 4.01. में rel विशेषता परिभाषा देखें |
| [RelList](../../aspose.html/htmllinkelement/rellist/) { get; } | एक लाइव DOMTokenList लौटाता है जिसमें "रिलायंस" विशेषता को पार्स करने से प्राप्त टोकन शामिल हैं। |
| [Rev](../../aspose.html/htmllinkelement/rev/) { get; set; } | रिवर्स लिंक प्रकार। HTML 4.01. में रेव विशेषता परिभाषा देखें |
...
| [Sheet](../../aspose.html/htmllinkelement/sheet/) { get; } | संबंधित स्टाइल शीट प्राप्त करता है। |
...
| [Target](../../aspose.html/htmllinkelement/target/) { get; set; } | संसाधन को प्रस्तुत करने के लिए फ़्रेम। HTML 4.01. में लक्ष्य विशेषता परिभाषा देखें |
...
| [Type](../../aspose.html/htmllinkelement/type/) { get; set; } | सलाहकार सामग्री प्रकार। HTML 4.01. में प्रकार विशेषता परिभाषा देखें |
