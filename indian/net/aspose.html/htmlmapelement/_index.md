...
description: Aspose.Html.HTMLMapElement कक्ष. क्लइंटसइड इमेज मैप HTML 4.01. में एमएप तत्व परभष देखें
type: docs
weight: 3380
url: /hi/net/aspose.html/htmlmapelement/
---
## HTMLMapElement class

क्लाइंट-साइड इमेज मैप। HTML 4.01. में एमएपी तत्व परिभाषा देखें
...
| नाम | विवरण |
| --- | --- |
| [Areas](../../aspose.html/htmlmapelement/areas/) { get; } | छवि मानचित्र के लिए परिभाषित क्षेत्रों की सूची। |
...
| [Name](../../aspose.html/htmlmapelement/name/) { get; set; } | मानचित्र को नाम देता है (उपयोग के लिए`usemap` ). HTML 4.01. में नाम विशेषता परिभाषा देखें |
