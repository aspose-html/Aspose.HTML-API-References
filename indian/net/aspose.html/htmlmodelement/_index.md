...
description: Aspose.Html.HTMLModElement कक्ष. दस्तवेज़ के भग में संशधन क सूचन HTML 4.01 में INS और DEL तत्व परभषएँ देखें
type: docs
weight: 3410
url: /hi/net/aspose.html/htmlmodelement/
---
## HTMLModElement class

दस्तावेज़ के भाग में संशोधन की सूचना। HTML 4.01 में INS और DEL तत्व परिभाषाएँ देखें।
...
| [Cite](../../aspose.html/htmlmodelement/cite/) { get; set; } | एक यूआरआई [[आईईटीएफ आरएफसी 2396](http://www.ietf.org/rfc/rfc2396.txt) ] एक दस्तावेज़ निर्दिष्ट करना जो परिवर्तन के कारण का वर्णन करता है। HTML 4.01. में उद्धरण विशेषता परिभाषा देखें |
...
| [DateTime](../../aspose.html/htmlmodelement/datetime/) { get; set; } | परिवर्तन की तिथि और समय। HTML 4.01. में दिनांक समय विशेषता परिभाषा देखें |
