...
description: Aspose.Html.HTMLHRElement कक्ष. एक क्षैतज नयम बनएं HTML 4.01. में एचआर एलमेंट क परभष देखें
type: docs
weight: 3260
url: /hi/net/aspose.html/htmlhrelement/
---
## HTMLHRElement class

एक क्षैतिज नियम बनाएं। HTML 4.01. में एचआर एलिमेंट की परिभाषा देखें
...
| नाम | विवरण |
| --- | --- |
| [Align](../../aspose.html/htmlhrelement/align/) { get; set; } | पृष्ठ पर नियम संरेखित करें। HTML 4.01 में एलाइन विशेषता परिभाषा देखें। यह विशेषता HTML 4.01. में बहिष्कृत है |
...
| [NoShade](../../aspose.html/htmlhrelement/noshade/) { get; set; } | उपयोगकर्ता एजेंट को इंगित करता है कि इस तत्व के प्रतिपादन में कोई छायांकन नहीं होना चाहिए। HTML 4.01 में noshade विशेषता परिभाषा देखें। यह विशेषता HTML 4.01. में बहिष्कृत है |
...
| [Size](../../aspose.html/htmlhrelement/size/) { get; set; } | नियम की ऊंचाई। HTML 4.01 में आकार विशेषता परिभाषा देखें। यह विशेषता HTML 4.01. में बहिष्कृत है |
...
| [Width](../../aspose.html/htmlhrelement/width/) { get; set; } | नियम की चौड़ाई। HTML 4.01 में चौड़ाई विशेषता परिभाषा देखें। यह विशेषता HTML 4.01. में बहिष्कृत है |
