...
type: docs
weight: 20
url: /hi/net/aspose.html/license/setlicense/
---
...
| --- | --- | --- |
| licenseName | String | फ़ाइल का पूरा या छोटा नाम हो सकता है या एक एम्बेडेड संसाधन का नाम. मूल्यांकन मोड पर स्विच करने के लिए खाली स्ट्रिंग का उपयोग करें। |
