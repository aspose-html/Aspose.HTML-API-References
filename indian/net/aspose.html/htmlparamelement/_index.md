...
description: Aspose.Html.HTMLParamElement कक्ष. पैरमटर्स क फड कय गयवस्तु तत्व HTML 4.01. में परम तत्व परभष देखें
type: docs
weight: 3480
url: /hi/net/aspose.html/htmlparamelement/
---
## HTMLParamElement class

पैरामीटर्स को फीड किया गया`वस्तु` तत्व। HTML 4.01. में परम तत्व परिभाषा देखें
...
| [Name](../../aspose.html/htmlparamelement/name/) { get; set; } | रन-टाइम पैरामीटर का नाम। HTML 4.01. में नाम विशेषता परिभाषा देखें |
...
| [Type](../../aspose.html/htmlparamelement/type/) { get; set; } | के लिए सामग्री प्रकार`कीमत` विशेषता जब `मान प्रकार` मूल्य "रेफरी" है। HTML 4.01. में प्रकार विशेषता परिभाषा देखें |
| [Value](../../aspose.html/htmlparamelement/value/) { get; set; } | रन-टाइम पैरामीटर का मान। HTML 4.01. में मान विशेषता परिभाषा देखें |
| [ValueType](../../aspose.html/htmlparamelement/valuetype/) { get; set; } | के अर्थ के बारे में जानकारी`कीमत` विशेषता मान। HTML 4.01. में valuetype विशेषता परिभाषा देखें |
