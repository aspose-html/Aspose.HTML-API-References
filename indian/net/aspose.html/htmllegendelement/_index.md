...
description: Aspose.Html.HTMLLegendElement कक्ष. एक के लए एक कैप्शन प्रदन करत हैफ़ल्डसेट समूहकरण HTML 4.01. में लजेंड तत्व क परभष देखें
type: docs
weight: 3360
url: /hi/net/aspose.html/htmllegendelement/
---
## HTMLLegendElement class

एक के लिए एक कैप्शन प्रदान करता है`फ़ील्डसेट` समूहीकरण। HTML 4.01. में लीजेंड तत्व की परिभाषा देखें
...
| नाम | विवरण |
| --- | --- |
| [AccessKey](../../aspose.html/htmllegendelement/accesskey/) { get; set; } | प्रपत्र नियंत्रण तक पहुंच प्रदान करने के लिए एकल वर्ण पहुंच कुंजी। HTML 4.01. में एक्सेसकुंजी विशेषता परिभाषा देखें |
| [Align](../../aspose.html/htmllegendelement/align/) { get; set; } | के सापेक्ष पाठ संरेखण`फ़ील्डसेट` . HTML 4.01 में संरेखित विशेषता परिभाषा देखें। यह विशेषता HTML 4.01. में बहिष्कृत है |
...
| [Form](../../aspose.html/htmllegendelement/form/) { get; } | लौटाता है`प्रपत्र` इस नियंत्रण वाले तत्व। रिटर्न `व्यर्थ` अगर यह नियंत्रण फ़ॉर्म के संदर्भ में नहीं है. |
