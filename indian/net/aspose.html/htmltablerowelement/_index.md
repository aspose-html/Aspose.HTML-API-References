...
description: Aspose.Html.HTMLTableRowElement कक्ष. तलक में एक पंक्त HTML 4.01. में TR तत्व परभष देखें
type: docs
weight: 3580
url: /hi/net/aspose.html/htmltablerowelement/
---
## HTMLTableRowElement class

तालिका में एक पंक्ति। HTML 4.01. में TR तत्व परिभाषा देखें
...
| नाम | विवरण |
| --- | --- |
| [Align](../../aspose.html/htmltablerowelement/align/) { get; set; } | इस पंक्ति के कक्षों के भीतर डेटा का क्षैतिज संरेखण। HTML 4.01. में संरेखित विशेषता परिभाषा देखें |
...
| [BgColor](../../aspose.html/htmltablerowelement/bgcolor/) { get; set; } | पंक्तियों के लिए पृष्ठभूमि का रंग। HTML 4.01 में bgcolor विशेषता परिभाषा देखें। यह विशेषता HTML 4.01. में बहिष्कृत है |
| [Cells](../../aspose.html/htmltablerowelement/cells/) { get; } | इस पंक्ति में कोशिकाओं का संग्रह। @वर्जन डोम लेवल 2 |
| [Ch](../../aspose.html/htmltablerowelement/ch/) { get; set; } | कॉलम में सेल के लिए अलाइनमेंट कैरेक्टर। HTML 4.01. में चार विशेषता परिभाषा देखें |
...
| [ChOff](../../aspose.html/htmltablerowelement/choff/) { get; set; } | संरेखण चरित्र का ऑफसेट। HTML 4.01. में charoff विशेषता परिभाषा देखें |
...
| [RowIndex](../../aspose.html/htmltablerowelement/rowindex/) { get; } | यह तार्किक क्रम में है न कि दस्तावेज़ क्रम में। द `rowIndex` अनुभागों को ध्यान में रखता है ( `ठेड` ,`TFOOT` , या`टीबीडी` ) टेबल के भीतर, रखकर`ठेड` अनुक्रमणिका में पहले पंक्तियाँ, उसके बाद`टीबीडी` पंक्तियाँ, उसके बाद`TFOOT` पंक्तियां. @वर्जन डोम स्तर 2 |
| [SchemaTypeInfo](../../aspose.html.dom/element/schematypeinfo/) { get; } | इस तत्व से जुड़ी प्रकार की जानकारी। |
| [SectionRowIndex](../../aspose.html/htmltablerowelement/sectionrowindex/) { get; } | इस पंक्ति की अनुक्रमणिका, वर्तमान अनुभाग के सापेक्ष ( `ठेड` ,`TFOOT` , या`टीबीडी` ), 0. @वर्जन डोम लेवल 2 से शुरू |
...
| [VAlign](../../aspose.html/htmltablerowelement/valign/) { get; set; } | इस पंक्ति के कक्षों के भीतर डेटा का लंबवत संरेखण। HTML 4.01. में valign विशेषता परिभाषा देखें |
...
| [DeleteCell](../../aspose.html/htmltablerowelement/deletecell/)(int) | वर्तमान पंक्ति से एक सेल हटाएं। |
...
| [InsertCell](../../aspose.html/htmltablerowelement/insertcell/)(int) | एक खाली डालें`टीडी` इस पंक्ति में सेल। अगर `अनुक्रमणिका` -1 या कोशिकाओं की संख्या के बराबर है, तो नया सेल जोड़ा जाता है। |
