...
description: Aspose.Html.HTMLAreaElement कक्ष. क्लइंटसइड छव मनचत्र क्षेत्र परभष _ HTML 4.01. में क्षेत्र तत्व परभष देखें
type: docs
weight: 3080
url: /hi/net/aspose.html/htmlareaelement/
---
## HTMLAreaElement class

क्लाइंट-साइड छवि मानचित्र क्षेत्र परिभाषा। _ HTML 4.01. में क्षेत्र तत्व परिभाषा देखें
...
| नाम | विवरण |
| --- | --- |
| [AccessKey](../../aspose.html/htmlareaelement/accesskey/) { get; set; } | प्रपत्र नियंत्रण तक पहुंच प्रदान करने के लिए एकल वर्ण पहुंच कुंजी। HTML 4.01. में एक्सेसकुंजी विशेषता परिभाषा देखें |
| [Alt](../../aspose.html/htmlareaelement/alt/) { get; set; } | उपयोगकर्ता एजेंटों के लिए वैकल्पिक पाठ इस तत्व की सामान्य सामग्री को प्रस्तुत नहीं कर रहा है। HTML 4.01. में ऑल्ट विशेषता परिभाषा देखें |
...
| [Coords](../../aspose.html/htmlareaelement/coords/) { get; set; } | अल्पविराम से अलग की गई लंबाई की सूची, एक सक्रिय क्षेत्र ज्यामिति को परिभाषित करती है। यह भी देखें`आकार` क्षेत्र के आकार के लिए। HTML 4.01. में कॉर्ड विशेषता परिभाषा देखें |
...
| [Href](../../aspose.html/htmlareaelement/href/) { get; set; } | यूआरआई [[आईईटीएफ आरएफसी 2396](http://www.ietf.org/rfc/rfc2396.txt) ] लिंक किए गए संसाधन का। HTML 4.01. में href विशेषता परिभाषा देखें |
...
| [NoHref](../../aspose.html/htmlareaelement/nohref/) { get; set; } | निर्दिष्ट करता है कि यह क्षेत्र निष्क्रिय है, अर्थात इसमें कोई संबद्ध क्रिया नहीं है। HTML 4.01. में nohref विशेषता परिभाषा देखें |
...
| [RelList](../../aspose.html/htmlareaelement/rellist/) { get; } | एक लाइव DOMTokenList लौटाता है जिसमें "रिलायंस" विशेषता को पार्स करने से प्राप्त टोकन शामिल हैं। |
...
| [Shape](../../aspose.html/htmlareaelement/shape/) { get; set; } | सक्रिय क्षेत्र का आकार। निर्देशांक द्वारा दिए गए हैं`कोर्ड्स` . HTML 4.01. में आकृति विशेषता परिभाषा देखें |
...
| [TabIndex](../../aspose.html/htmlareaelement/tabindex/) { get; set; } | अनुक्रमणिका जो टैबिंग क्रम में तत्व की स्थिति का प्रतिनिधित्व करती है। HTML 4.01. में Tabindex विशेषता परिभाषा देखें |
| [TagName](../../aspose.html.dom/element/tagname/) { get; } | तत्व का नाम। |
| [Target](../../aspose.html/htmlareaelement/target/) { get; set; } | संसाधन को प्रस्तुत करने के लिए फ़्रेम। HTML 4.01. में लक्ष्य विशेषता परिभाषा देखें |
