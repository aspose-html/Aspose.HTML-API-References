...
description: Aspose.Html.HTMLAnchorElement कक्ष. एंकर तत्व HTML 4.01. में A तत्व क परभष देखें
type: docs
weight: 3060
url: /hi/net/aspose.html/htmlanchorelement/
---
## HTMLAnchorElement class

एंकर तत्व। HTML 4.01. में A तत्व की परिभाषा देखें
...
| नाम | विवरण |
| --- | --- |
| [AccessKey](../../aspose.html/htmlanchorelement/accesskey/) { get; set; } | प्रपत्र नियंत्रण तक पहुंच प्रदान करने के लिए एकल वर्ण पहुंच कुंजी। HTML 4.01. में एक्सेसकुंजी विशेषता परिभाषा देखें |
...
| [Charset](../../aspose.html/htmlanchorelement/charset/) { get; set; } | लिंक किए गए संसाधन का वर्ण एन्कोडिंग। HTML 4.01. में वर्णसेट विशेषता परिभाषा देखें |
...
| [Coords](../../aspose.html/htmlanchorelement/coords/) { get; set; } | अल्पविराम से अलग की गई लंबाई की सूची, एक सक्रिय क्षेत्र ज्यामिति को परिभाषित करती है। यह भी देखें`आकार` क्षेत्र के आकार के लिए। HTML 4.01. में the कोर्ड्स विशेषता परिभाषा देखें |
...
| [Hash](../../aspose.html/htmlanchorelement/hash/) { get; set; } | संबंधित URL के हैश सेगमेंट का एक स्ट्रिंग प्रतिनिधित्व प्राप्त या सेट करता है। |
| [Host](../../aspose.html/htmlanchorelement/host/) { get; set; } | संबंधित URL के होस्ट और पोर्ट सेगमेंट का एक स्ट्रिंग प्रतिनिधित्व प्राप्त या सेट करता है। |
| [Hostname](../../aspose.html/htmlanchorelement/hostname/) { get; set; } | संबंधित URL के होस्ट सेगमेंट का एक स्ट्रिंग प्रतिनिधित्व प्राप्त या सेट करता है। |
| [Href](../../aspose.html/htmlanchorelement/href/) { get; set; } | पूर्ण यूआरआई [[आईईटीएफ आरएफसी 2396](http://www.ietf.org/rfc/rfc2396.txt) लिंक किए गए संसाधन का। HTML 4.01. में href विशेषता परिभाषा देखें |
| [Hreflang](../../aspose.html/htmlanchorelement/hreflang/) { get; set; } | लिंक किए गए संसाधन का भाषा कोड। HTML 4.01. में hreflang विशेषता परिभाषा देखें |
...
| [Name](../../aspose.html/htmlanchorelement/name/) { get; set; } | एंकर का नाम। HTML 4.01. में नाम विशेषता परिभाषा देखें |
...
| [Origin](../../aspose.html/htmlanchorelement/origin/) { get; } | संबंधित URL के मूल खंड का एक स्ट्रिंग प्रतिनिधित्व प्राप्त करता है। |
...
| [Password](../../aspose.html/htmlanchorelement/password/) { get; set; } | संबंधित URL के पासवर्ड सेगमेंट का एक स्ट्रिंग प्रतिनिधित्व प्राप्त या सेट करता है। |
| [Pathname](../../aspose.html/htmlanchorelement/pathname/) { get; set; } | संबद्ध URL के पथ खंड का एक स्ट्रिंग प्रतिनिधित्व प्राप्त या सेट करता है। |
| [Port](../../aspose.html/htmlanchorelement/port/) { get; set; } | संबंधित URL के पोर्ट सेगमेंट का एक स्ट्रिंग प्रतिनिधित्व प्राप्त या सेट करता है। |
...
| [Protocol](../../aspose.html/htmlanchorelement/protocol/) { get; set; } | संबद्ध URL के योजना खंड का एक स्ट्रिंग प्रतिनिधित्व प्राप्त या सेट करता है। |
| [Rel](../../aspose.html/htmlanchorelement/rel/) { get; set; } | फॉरवर्ड लिंक प्रकार। HTML 4.01. में rel विशेषता परिभाषा देखें |
| [RelList](../../aspose.html/htmlanchorelement/rellist/) { get; } | एक लाइव DOMTokenList लौटाता है जिसमें "रिलायंस" विशेषता को पार्स करने से प्राप्त टोकन शामिल हैं। |
| [Rev](../../aspose.html/htmlanchorelement/rev/) { get; set; } | रिवर्स लिंक प्रकार। HTML 4.01. में रेव विशेषता परिभाषा देखें |
| [SchemaTypeInfo](../../aspose.html.dom/element/schematypeinfo/) { get; } | इस तत्व से जुड़ी प्रकार की जानकारी। |
| [Search](../../aspose.html/htmlanchorelement/search/) { get; set; } | संबंधित URL के खोज खंड का एक स्ट्रिंग प्रतिनिधित्व प्राप्त या सेट करता है। |
| [ShadowRoot](../../aspose.html.dom/element/shadowroot/) { get; } | इस तत्व पर संग्रहीत शैडोरूट लौटाता है या बंद होने पर अशक्त होता है। |
| [Shape](../../aspose.html/htmlanchorelement/shape/) { get; set; } | सक्रिय क्षेत्र का आकार। निर्देशांक द्वारा दिए गए हैं`कोर्ड्स` . HTML 4.01. में आकृति विशेषता परिभाषा देखें |
...
| [TabIndex](../../aspose.html/htmlanchorelement/tabindex/) { get; set; } | अनुक्रमणिका जो टैबिंग क्रम में तत्व की स्थिति का प्रतिनिधित्व करती है। HTML 4.01. में Tabindex विशेषता परिभाषा देखें |
| [TagName](../../aspose.html.dom/element/tagname/) { get; } | तत्व का नाम। |
| [Target](../../aspose.html/htmlanchorelement/target/) { get; set; } | संसाधन को प्रस्तुत करने के लिए फ़्रेम। HTML 4.01. में लक्ष्य विशेषता परिभाषा देखें |
...
| [Type](../../aspose.html/htmlanchorelement/type/) { get; set; } | सलाहकार सामग्री प्रकार। HTML 4.01. में प्रकार विशेषता परिभाषा देखें |
| [Username](../../aspose.html/htmlanchorelement/username/) { get; set; } | संबंधित URL के उपयोगकर्ता नाम खंड का एक स्ट्रिंग प्रतिनिधित्व प्राप्त या सेट करता है। |
...
| [Blur](../../aspose.html/htmlanchorelement/blur/)() | इस तत्व से कीबोर्ड फोकस हटाता है। |
...
| [Focus](../../aspose.html/htmlanchorelement/focus/)() | इस तत्व पर कीबोर्ड फ़ोकस देता है. |
