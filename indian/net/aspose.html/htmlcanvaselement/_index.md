...
description: Aspose.Html.HTMLCanvasElement कक्ष. HTMLCanvasElement इंटरफ़ेस कैनवस तत्वं के लेआउट और प्रस्तुत में हेरफेर करने के लए गुण और वधयँ प्रदन करत है HTMLCanvasElement इंटरफ़ेस भ HTMLElement इंटरफ़ेस के गुणं और वधयं क इनहेरट करत है
type: docs
weight: 3140
url: /hi/net/aspose.html/htmlcanvaselement/
---
## HTMLCanvasElement class

HTMLCanvasElement इंटरफ़ेस कैनवास तत्वों के लेआउट और प्रस्तुति में हेरफेर करने के लिए गुण और विधियाँ प्रदान करता है। HTMLCanvasElement इंटरफ़ेस भी HTMLElement इंटरफ़ेस के गुणों और विधियों को इनहेरिट करता है।
...
| [Height](../../aspose.html/htmlcanvaselement/height/) { get; set; } | एक सकारात्मक पूर्णांक है जो सीएसएस पिक्सेल में व्याख्या किए गए कैनवास तत्व की ऊंचाई HTML विशेषता को दर्शाता है। जब विशेषता निर्दिष्ट नहीं है, या यदि यह एक नकारात्मक मान की तरह एक अमान्य मान पर सेट है, तो 150 का डिफ़ॉल्ट मान उपयोग किया जाता है। |
...
| [Width](../../aspose.html/htmlcanvaselement/width/) { get; set; } | एक धनात्मक पूर्णांक है जो CSS पिक्सेल में व्याख्या किए गए कैनवास तत्व की चौड़ाई HTML विशेषता को दर्शाता है। जब विशेषता निर्दिष्ट नहीं है, या यदि यह एक नकारात्मक मान की तरह एक अमान्य मान पर सेट है, तो 300 का डिफ़ॉल्ट मान उपयोग किया जाता है। |
...
| [GetContext](../../aspose.html/htmlcanvaselement/getcontext/)(string) | कैनवास पर एक ड्राइंग संदर्भ देता है, या यदि संदर्भ आईडी समर्थित नहीं है तो शून्य। एक ड्राइंग संदर्भ आपको कैनवास पर आकर्षित करने देता है। |
...
| [ToDataURL](../../aspose.html/htmlcanvaselement/todataurl/#todataurl)() | एक डेटा यूआरआई देता है जिसमें टाइप पैरामीटर (पीएनजी के लिए डिफ़ॉल्ट) द्वारा निर्दिष्ट प्रारूप में छवि का प्रतिनिधित्व होता है। लौटाई गई छवि 96 डीपीआई के रिज़ॉल्यूशन में है। |
| [ToDataURL](../../aspose.html/htmlcanvaselement/todataurl/#todataurl_1)(string) | एक डेटा यूआरआई देता है जिसमें टाइप पैरामीटर (पीएनजी के लिए डिफ़ॉल्ट) द्वारा निर्दिष्ट प्रारूप में छवि का प्रतिनिधित्व होता है। लौटाई गई छवि 96 डीपीआई के रिज़ॉल्यूशन में है। |
| [ToDataURL](../../aspose.html/htmlcanvaselement/todataurl/#todataurl_2)(string, double) | एक डेटा यूआरआई देता है जिसमें टाइप पैरामीटर (पीएनजी के लिए डिफ़ॉल्ट) द्वारा निर्दिष्ट प्रारूप में छवि का प्रतिनिधित्व होता है। लौटाई गई छवि 96 डीपीआई के रिज़ॉल्यूशन में है। |
