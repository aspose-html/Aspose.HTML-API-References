...
description: Aspose.Html.HTMLMetaElement कक्ष. इसमें दस्तवेज़ के बरे में समन्य मेटजनकर शमल है HTML 4.01. में मेट तत्व परभष देखें
type: docs
weight: 3400
url: /hi/net/aspose.html/htmlmetaelement/
---
## HTMLMetaElement class

इसमें दस्तावेज़ के बारे में सामान्य मेटा-जानकारी शामिल है। HTML 4.01. में मेटा तत्व परिभाषा देखें
...
| [Content](../../aspose.html/htmlmetaelement/content/) { get; set; } | संबद्ध जानकारी। HTML 4.01. में सामग्री विशेषता परिभाषा देखें |
...
| [HttpEquiv](../../aspose.html/htmlmetaelement/httpequiv/) { get; set; } | HTTP प्रतिक्रिया हेडर नाम [[आईईटीएफ आरएफसी 2616](http://www.ietf.org/rfc/rfc2616.txt) ]। HTML 4.01. में http-equiv विशेषता परिभाषा देखें |
...
| [Name](../../aspose.html/htmlmetaelement/name/) { get; set; } | मेटा जानकारी का नाम। HTML 4.01. में नाम विशेषता परिभाषा देखें |
...
| [Scheme](../../aspose.html/htmlmetaelement/scheme/) { get; set; } | सामग्री का प्रकार चुनें। HTML 4.01. में स्कीम विशेषता परिभाषा देखें |
