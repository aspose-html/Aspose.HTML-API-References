...
description: Aspose.Html.HTMLHtmlElement कक्ष. HTML दस्तवेज़ क रूट HTML तत्व क परभष HTML 4.01. में देखें
type: docs
weight: 3290
url: /hi/net/aspose.html/htmlhtmlelement/
---
## HTMLHtmlElement class

HTML दस्तावेज़ का रूट। HTML तत्व की परिभाषा HTML 4.01. में देखें
...
| [Version](../../aspose.html/htmlhtmlelement/version/) { get; set; } | दस्तावेज़ के डीटीडी के बारे में संस्करण जानकारी। HTML 4.01 में संस्करण विशेषता परिभाषा देखें। यह विशेषता HTML 4.01. में बहिष्कृत है |
