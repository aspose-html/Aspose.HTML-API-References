...
description: Aspose.Html.HTMLScriptElement कक्ष. स्क्रप्ट स्टेटमेंट HTML 4.01. में SCRIPT एलमेंट क परभष देखें
type: docs
weight: 3510
url: /hi/net/aspose.html/htmlscriptelement/
---
## HTMLScriptElement class

स्क्रिप्ट स्टेटमेंट। HTML 4.01. में SCRIPT एलिमेंट की परिभाषा देखें
...
| [Charset](../../aspose.html/htmlscriptelement/charset/) { get; set; } | लिंक किए गए संसाधन का वर्ण एन्कोडिंग। HTML 4.01. में वर्णसेट विशेषता परिभाषा देखें |
...
| [Defer](../../aspose.html/htmlscriptelement/defer/) { get; set; } | इंगित करता है कि उपयोगकर्ता एजेंट स्क्रिप्ट के प्रसंस्करण को स्थगित कर सकता है। देखें HTML 4.01. में defer विशेषता परिभाषा |
...
| [Event](../../aspose.html/htmlscriptelement/event/) { get; set; } | भविष्य में उपयोग के लिए आरक्षित। |
...
| [Src](../../aspose.html/htmlscriptelement/src/) { get; set; } | यूआरआई [[आईईटीएफ आरएफसी 2396](http://www.ietf.org/rfc/rfc2396.txt) ] बाहरी स्क्रिप्ट निर्दिष्ट करना। HTML 4.01. में src विशेषता परिभाषा देखें |
...
| [Text](../../aspose.html/htmlscriptelement/text/) { get; set; } | तत्व की स्क्रिप्ट सामग्री। |
...
| [Type](../../aspose.html/htmlscriptelement/type/) { get; set; } | स्क्रिप्ट भाषा का सामग्री प्रकार। HTML 4.01. में प्रकार विशेषता परिभाषा देखें |
