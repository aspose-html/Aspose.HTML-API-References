...
description: Aspose.Html.HTMLIFrameElement कक्ष. इनलइन सबवंड HTML 4.01. में IFRAME तत्व परभष देखें
type: docs
weight: 3300
url: /hi/net/aspose.html/htmliframeelement/
---
## HTMLIFrameElement class

इनलाइन सबविंडो। HTML 4.01. में IFRAME तत्व परिभाषा देखें
...
| नाम | विवरण |
| --- | --- |
| [Align](../../aspose.html/htmliframeelement/align/) { get; set; } | इस ऑब्जेक्ट को इसके आसपास के टेक्स्ट के संबंध में (लंबवत या क्षैतिज रूप से) संरेखित करता है। HTML 4.01 में एलाइन विशेषता परिभाषा देखें। यह विशेषता HTML 4.01. में बहिष्कृत है |
...
| [FrameBorder](../../aspose.html/htmliframeelement/frameborder/) { get; set; } | फ्रेम बॉर्डर का अनुरोध करें। HTML 4.01. में फ़्रेमबॉर्डर विशेषता परिभाषा देखें |
| [Height](../../aspose.html/htmliframeelement/height/) { get; set; } | फ़्रेम की ऊंचाई. HTML 4.01. में ऊंचाई विशेषता परिभाषा देखें |
...
| [LongDesc](../../aspose.html/htmliframeelement/longdesc/) { get; set; } | यूआरआई [[आईईटीएफ आरएफसी 2396](http://www.ietf.org/rfc/rfc2396.txt) ] इस छवि या फ्रेम का एक लंबा विवरण निर्दिष्ट करना। HTML 4.01. में longdesc विशेषता परिभाषा देखें |
| [MarginHeight](../../aspose.html/htmliframeelement/marginheight/) { get; set; } | फ़्रेम मार्जिन ऊंचाई, पिक्सेल में. HTML 4.01. में मार्जिनहाइट विशेषता परिभाषा देखें |
| [MarginWidth](../../aspose.html/htmliframeelement/marginwidth/) { get; set; } | फ़्रेम मार्जिन चौड़ाई, पिक्सेल में. HTML 4.01. में मार्जिनविड्थ विशेषता परिभाषा देखें |
| [Name](../../aspose.html/htmliframeelement/name/) { get; set; } | फ़्रेम का नाम (ऑब्जेक्ट ऑफ़ द`लक्ष्य` गुण)। HTML 4.01. में नाम विशेषता परिभाषा देखें |
...
| [Scrolling](../../aspose.html/htmliframeelement/scrolling/) { get; set; } | निर्दिष्ट करें कि फ्रेम में स्क्रॉलबार होना चाहिए या नहीं। HTML 4.01. में स्क्रॉल विशेषता परिभाषा देखें |
| [ShadowRoot](../../aspose.html.dom/element/shadowroot/) { get; } | इस तत्व पर संग्रहीत शैडोरूट लौटाता है या बंद होने पर अशक्त होता है। |
| [Src](../../aspose.html/htmliframeelement/src/) { get; set; } | एक यूआरआई [[आईईटीएफ आरएफसी 2396](http://www.ietf.org/rfc/rfc2396.txt) ] प्रारंभिक फ्रेम सामग्री को नामित करना। HTML 4.01. में src विशेषता परिभाषा देखें |
...
| [Width](../../aspose.html/htmliframeelement/width/) { get; set; } | फ़्रेम की चौड़ाई. HTML 4.01. में चौड़ाई विशेषता परिभाषा देखें |
