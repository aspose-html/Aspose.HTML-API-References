...
description: Aspose.Html.HTMLTextAreaElement कक्ष. बहुपंक्त टेक्स्ट फ़ल्ड HTML 4.01. में टेक्स्टटेरय तत्व क परभष देखें
type: docs
weight: 3610
url: /hi/net/aspose.html/htmltextareaelement/
---
## HTMLTextAreaElement class

बहु-पंक्ति टेक्स्ट फ़ील्ड। HTML 4.01. में टेक्स्टटेरिया तत्व की परिभाषा देखें
...
| नाम | विवरण |
| --- | --- |
| [AccessKey](../../aspose.html/htmltextareaelement/accesskey/) { get; set; } | प्रपत्र नियंत्रण तक पहुंच प्रदान करने के लिए एकल वर्ण पहुंच कुंजी। HTML 4.01. में एक्सेसकुंजी विशेषता परिभाषा देखें |
...
| [Cols](../../aspose.html/htmltextareaelement/cols/) { get; set; } | नियंत्रण की चौड़ाई (अक्षरों में)। HTML 4.01. में कॉल्स विशेषता परिभाषा देखें |
| [DefaultValue](../../aspose.html/htmltextareaelement/defaultvalue/) { get; set; } | तत्व की सामग्री का प्रतिनिधित्व करता है। इस विशेषता का मान नहीं बदलता है यदि संबंधित प्रपत्र नियंत्रण की सामग्री, में एक इंटरैक्टिव उपयोगकर्ता एजेंट, बदलती है। @version DOM स्तर 2 |
...
| [Disabled](../../aspose.html/htmltextareaelement/disabled/) { get; set; } | इस संदर्भ में नियंत्रण उपलब्ध नहीं है। HTML 4.01. में अक्षम विशेषता परिभाषा देखें |
...
| [Form](../../aspose.html/htmltextareaelement/form/) { get; } | लौटाता है`प्रपत्र` इस नियंत्रण वाले तत्व। रिटर्न `व्यर्थ` अगर यह नियंत्रण फ़ॉर्म के संदर्भ में नहीं है. |
...
| [Name](../../aspose.html/htmltextareaelement/name/) { get; set; } | प्रपत्र नियंत्रण या वस्तु का नाम जब प्रपत्र के साथ सबमिट किया जाता है। HTML 4.01. में नाम विशेषता परिभाषा देखें |
...
| [ReadOnly](../../aspose.html/htmltextareaelement/readonly/) { get; set; } | यह नियंत्रण केवल पढ़ने के लिए है। HTML 4.01. में केवल पढ़ने योग्य विशेषता परिभाषा देखें |
| [Rows](../../aspose.html/htmltextareaelement/rows/) { get; set; } | पाठ पंक्तियों की संख्या। HTML 4.01. में पंक्तियों की विशेषता परिभाषा देखें |
...
| [TabIndex](../../aspose.html/htmltextareaelement/tabindex/) { get; set; } | अनुक्रमणिका जो टैबिंग क्रम में तत्व की स्थिति का प्रतिनिधित्व करती है। HTML 4.01. में Tabindex विशेषता परिभाषा देखें |
...
| [Type](../../aspose.html/htmltextareaelement/type/) { get; } | इस प्रपत्र नियंत्रण का प्रकार। यह स्ट्रिंग "textarea". |
| [Value](../../aspose.html/htmltextareaelement/value/) { get; set; } | एक इंटरैक्टिव उपयोगकर्ता एजेंट में संबंधित प्रपत्र नियंत्रण की वर्तमान सामग्री का प्रतिनिधित्व करता है। इस विशेषता को बदलने से प्रपत्र नियंत्रण की सामग्री बदल जाती है, लेकिन तत्व की सामग्री नहीं बदलती है। यदि संपूर्ण डेटा एक में फिट नहीं हो सकता है`DOMString` , कार्यान्वयन डेटा को कम कर सकता है. |
