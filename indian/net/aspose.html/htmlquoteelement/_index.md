...
description: Aspose.Html.HTMLQuoteElement कक्ष. के लएक्यू औरब्लककटतत्व HTML 4.01. में Q तत्व क परभष देखें
type: docs
weight: 3500
url: /hi/net/aspose.html/htmlquoteelement/
---
## HTMLQuoteElement class

के लिए`क्यू` और`ब्लॉककोट`तत्व। HTML 4.01. में Q तत्व की परिभाषा देखें
...
| [Cite](../../aspose.html/htmlquoteelement/cite/) { get; set; } | एक यूआरआई [[आईईटीएफ आरएफसी 2396](http://www.ietf.org/rfc/rfc2396.txt) ] स्रोत दस्तावेज़ या संदेश निर्दिष्ट करना। HTML 4.01. में साइट विशेषता परिभाषा देखें |
