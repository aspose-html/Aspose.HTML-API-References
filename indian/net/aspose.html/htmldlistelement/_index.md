...
description: Aspose.Html.HTMLDListElement कक्ष. परभष सूच HTML 4.01. में DL एलमेंट क परभष देखें
type: docs
weight: 3150
url: /hi/net/aspose.html/htmldlistelement/
---
## HTMLDListElement class

परिभाषा सूची। HTML 4.01. में DL एलिमेंट की परिभाषा देखें
...
| [Compact](../../aspose.html/htmldlistelement/compact/) { get; set; } | सूची आइटम के बीच रिक्ति कम करें। HTML 4.01 में कॉम्पैक्ट विशेषता परिभाषा देखें। यह विशेषता HTML 4.01. में बहिष्कृत है |
