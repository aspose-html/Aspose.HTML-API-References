...
description: Aspose.Html.HTMLBaseFontElement कक्ष. बेस फन्ट HTML 4.01 में BASEFONT तत्व क परभष देखें यह तत्व HTML 4.01. में बहष्कृत है
type: docs
weight: 3110
url: /hi/net/aspose.html/htmlbasefontelement/
---
## HTMLBaseFontElement class

बेस फॉन्ट। HTML 4.01 में BASEFONT तत्व की परिभाषा देखें। यह तत्व HTML 4.01. में बहिष्कृत है
...
| [Color](../../aspose.html/htmlbasefontelement/color/) { get; set; } | फ़ॉन्ट रंग। HTML 4.01 में रंग विशेषता की परिभाषा देखें। यह विशेषता HTML 4.01. में बहिष्कृत है |
...
| [Face](../../aspose.html/htmlbasefontelement/face/) { get; set; } | फ़ॉन्ट चेहरा पहचानकर्ता। HTML 4.01 में चेहरा विशेषता परिभाषा देखें। यह विशेषता HTML 4.01. में बहिष्कृत है |
...
| [Size](../../aspose.html/htmlbasefontelement/size/) { get; set; } | परिकलित फ़ॉन्ट आकार। HTML 4.01 में आकार विशेषता परिभाषा देखें। यह विशेषता HTML 4.01. @version DOM स्तर 2 में बहिष्कृत है |
