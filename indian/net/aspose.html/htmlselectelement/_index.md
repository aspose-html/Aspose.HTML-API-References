...
description: Aspose.Html.HTMLSelectElement कक्ष. चयन तत्व एक वकल्प के चयन क अनुमत देत है नहत वकल्प क संग्रह के रूप में चयनत तत्व के मध्यम से सधे एक्सेस कय ज सकत है देखें HTML 4.01. में तत्व क चयन करें परभष
type: docs
weight: 3520
url: /hi/net/aspose.html/htmlselectelement/
---
## HTMLSelectElement class

चयन तत्व एक विकल्प के चयन की अनुमति देता है। निहित विकल्प को संग्रह के रूप में चयनित तत्व के माध्यम से सीधे एक्सेस किया जा सकता है। देखें HTML 4.01. में तत्व का चयन करें परिभाषा
...
| [Disabled](../../aspose.html/htmlselectelement/disabled/) { get; set; } | इस संदर्भ में नियंत्रण उपलब्ध नहीं है। HTML 4.01. में अक्षम विशेषता परिभाषा देखें |
...
| [Form](../../aspose.html/htmlselectelement/form/) { get; } | इसमें विकल्पों की संख्या`चुनना` . |
...
| [Length](../../aspose.html/htmlselectelement/length/) { get; set; } | इसमें विकल्पों की संख्या`चुनना` . @वर्जन डोम लेवल 2 |
...
| [Multiple](../../aspose.html/htmlselectelement/multiple/) { get; set; } | यदि सत्य है, एकाधिक`विकल्प` इसमें तत्वों का चयन किया जा सकता है`चुनना` . HTML 4.01. में एकाधिक विशेषता परिभाषा देखें |
| [Name](../../aspose.html/htmlselectelement/name/) { get; set; } | प्रपत्र नियंत्रण या वस्तु का नाम जब प्रपत्र के साथ सबमिट किया जाता है। HTML 4.01. में नाम विशेषता परिभाषा देखें |
...
| [Options](../../aspose.html/htmlselectelement/options/) { get; } | का संग्रह`विकल्प` इस तत्व में निहित तत्व। @वर्जन डोम लेवल 2 |
...
| [SelectedIndex](../../aspose.html/htmlselectelement/selectedindex/) { get; set; } | चयनित विकल्प का क्रमिक सूचकांक, 0 से शुरू होता है। मान -1 लौटाया जाता है यदि कोई तत्व नहीं चुना जाता है। यदि एकाधिक विकल्प चयनित हैं, तो पहले चयनित विकल्प का सूचकांक लौटाया जाता है। |
| [ShadowRoot](../../aspose.html.dom/element/shadowroot/) { get; } | इस तत्व पर संग्रहीत शैडोरूट लौटाता है या बंद होने पर अशक्त होता है। |
| [Size](../../aspose.html/htmlselectelement/size/) { get; set; } | दृश्यमान पंक्तियों की संख्या। HTML 4.01. में आकार विशेषता परिभाषा देखें |
...
| [TabIndex](../../aspose.html/htmlselectelement/tabindex/) { get; set; } | अनुक्रमणिका जो टैबिंग क्रम में तत्व की स्थिति का प्रतिनिधित्व करती है। HTML 4.01. में Tabindex विशेषता परिभाषा देखें |
...
| [Type](../../aspose.html/htmlselectelement/type/) { get; } | इस प्रपत्र नियंत्रण का प्रकार। एकाधिक विशेषता होने पर यह स्ट्रिंग "चयन-एकाधिक" है`सत्य` और स्ट्रिंग "सिलेक्ट-वन" कब`असत्य` . |
| [Value](../../aspose.html/htmlselectelement/value/) { get; set; } | वर्तमान प्रपत्र नियंत्रण मान (अर्थात् वर्तमान में चयनित विकल्प का मान), यदि एकाधिक विकल्प चुने गए हैं तो यह पहले चयनित विकल्प का मान है। |
