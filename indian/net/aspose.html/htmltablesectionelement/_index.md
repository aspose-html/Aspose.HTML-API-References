...
description: Aspose.Html.HTMLTableSectionElement कक्ष. दठेड TFOOT  औरटबड तत्व
type: docs
weight: 3590
url: /hi/net/aspose.html/htmltablesectionelement/
---
## HTMLTableSectionElement class

द`ठेड` ,`TFOOT` , और`टीबीडी` तत्व।
...
| नाम | विवरण |
| --- | --- |
| [Align](../../aspose.html/htmltablesectionelement/align/) { get; set; } | कोशिकाओं में डेटा का क्षैतिज संरेखण। देखें`संरेखित` विवरण के लिए HTMLTheadElement के लिए विशेषता। |
...
| [Ch](../../aspose.html/htmltablesectionelement/ch/) { get; set; } | कॉलम में सेल के लिए अलाइनमेंट कैरेक्टर। HTML 4.01. में चार विशेषता परिभाषा देखें |
...
| [ChOff](../../aspose.html/htmltablesectionelement/choff/) { get; set; } | संरेखण चरित्र का ऑफसेट। HTML 4.01. में charoff विशेषता परिभाषा देखें |
...
| [Rows](../../aspose.html/htmltablesectionelement/rows/) { get; } | इस तालिका अनुभाग में पंक्तियों का संग्रह। |
...
| [VAlign](../../aspose.html/htmltablesectionelement/valign/) { get; set; } | कोशिकाओं में डेटा का लंबवत संरेखण। देखें`वेलिजन` विवरण के लिए HTMLTheadElement के लिए विशेषता। |
...
| [DeleteRow](../../aspose.html/htmltablesectionelement/deleterow/)(int) | इस खंड से एक पंक्ति हटाएं। |
...
| [InsertRow](../../aspose.html/htmltablesectionelement/insertrow/)(int) | इस खंड में एक पंक्ति डालें। नई पंक्ति वर्तमान से पहले तुरंत डाली गई है`अनुक्रमणिका` इस खंड में वीं पंक्ति। अगर `अनुक्रमणिका` इस सेक्शन में -1 या पंक्तियों की संख्या के बराबर है, नई पंक्ति जोड़ी गई है। |
