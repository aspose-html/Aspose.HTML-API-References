...
description: Aspose.Html.HTMLOptGroupElement कक्ष. तर्कक उपखंडं में एक सथ समूह वकल्प HTML 4.01. में OPTGROUP तत्व परभष देखें
type: docs
weight: 3450
url: /hi/net/aspose.html/htmloptgroupelement/
---
## HTMLOptGroupElement class

तार्किक उपखंडों में एक साथ समूह विकल्प। HTML 4.01. में OPTGROUP तत्व परिभाषा देखें
...
| [Disabled](../../aspose.html/htmloptgroupelement/disabled/) { get; set; } | इस संदर्भ में नियंत्रण उपलब्ध नहीं है। HTML 4.01. में अक्षम विशेषता परिभाषा देखें |
...
| [Label](../../aspose.html/htmloptgroupelement/label/) { get; set; } | इस विकल्प समूह को एक लेबल प्रदान करता है। HTML 4.01. में लेबल विशेषता definition देखें |
