...
description: Aspose.Html.HTMLHeadElement कक्ष. दस्तवेज़ शर्ष जनकर HTML 4.01. में हेड एलमेंट क परभष देखें
type: docs
weight: 3270
url: /hi/net/aspose.html/htmlheadelement/
---
## HTMLHeadElement class

दस्तावेज़ शीर्ष जानकारी। HTML 4.01. में हेड एलिमेंट की परिभाषा देखें
...
| [Profile](../../aspose.html/htmlheadelement/profile/) { get; set; } | यूआरआई [[आईईटीएफ आरएफसी 2396](http://www.ietf.org/rfc/rfc2396.txt) ] मेटाडेटा प्रोफ़ाइल निर्दिष्ट करना। HTML 4.01. में प्रोफ़ाइल विशेषता परिभाषा देखें |
