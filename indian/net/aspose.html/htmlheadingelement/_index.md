...
description: Aspose.Html.HTMLHeadingElement कक्ष. के लएएच 1 कएच 6 तत्व HTML 4.01. में H1 एलमेंट क परभष देखें
type: docs
weight: 3280
url: /hi/net/aspose.html/htmlheadingelement/
---
## HTMLHeadingElement class

के लिए`एच 1` को`एच 6` तत्व। HTML 4.01. में H1 एलिमेंट की परिभाषा देखें
...
| नाम | विवरण |
| --- | --- |
| [Align](../../aspose.html/htmlheadingelement/align/) { get; set; } | क्षैतिज पाठ संरेखण। HTML 4.01 में एलाइन विशेषता परिभाषा देखें। यह विशेषता HTML 4.01. में बहिष्कृत है |
