...
description: Aspose.Html.HTMLFormElement कक्ष. दप्रपत्र तत्व एक संग्रह और एक तत्व के समन व्यवहर क समहत करत है यह नहत प्रपत्र नयंत्रणं के सथसथ प्रपत्र तत्व क वशेषतओं तक सध पहुंच प्रदन करत है HTML 4.01. में फर्म तत्व परभष देखें
type: docs
weight: 3230
url: /hi/net/aspose.html/htmlformelement/
---
## HTMLFormElement class

द`प्रपत्र` तत्व एक संग्रह और एक तत्व के समान व्यवहार को समाहित करता है। यह निहित प्रपत्र नियंत्रणों के साथ-साथ प्रपत्र तत्व की विशेषताओं तक सीधी पहुंच प्रदान करता है। HTML 4.01. में फॉर्म तत्व परिभाषा देखें
...
| नाम | विवरण |
| --- | --- |
| [AcceptCharset](../../aspose.html/htmlformelement/acceptcharset/) { get; set; } | सर्वर द्वारा समर्थित कैरेक्टर सेट की सूची। HTML 4.01. में स्वीकृति-चारसेट विशेषता परिभाषा देखें |
| [Action](../../aspose.html/htmlformelement/action/) { get; set; } | सर्वर-साइड फॉर्म हैंडलर। HTML 4.01. में क्रिया विशेषता परिभाषा देखें |
...
| [Elements](../../aspose.html/htmlformelement/elements/) { get; } | प्रपत्र में सभी प्रपत्र नियंत्रण तत्वों का संग्रह लौटाता है। |
| [Enctype](../../aspose.html/htmlformelement/enctype/) { get; set; } | सबमिट किए गए फॉर्म का सामग्री प्रकार, आम तौर पर "आवेदन/x-www-form-urlencoded"। HTML 4.01 में enctype विशेषता परिभाषा देखें। इस विधि को लागू करते समय चालू होने वाले हैंडलर को ट्रिगर होने की गारंटी नहीं है। व्यवहार ऐतिहासिक कारणों से असंगत है और लेखकों को विशेष पर भरोसा नहीं करना चाहिए। |
...
| [Length](../../aspose.html/htmlformelement/length/) { get; } | प्रपत्र में प्रपत्र नियंत्रणों की संख्या. |
...
| [Method](../../aspose.html/htmlformelement/method/) { get; set; } | HTTP विधि [[आईईटीएफ आरएफसी 2616](http://www.ietf.org/rfc/rfc2616.txt) फॉर्म जमा करते थे। HTML 4.01. में विधि विशेषता परिभाषा देखें |
| [Name](../../aspose.html/htmlformelement/name/) { get; set; } | फॉर्म को नाम देता है। |
...
| [Target](../../aspose.html/htmlformelement/target/) { get; set; } | संसाधन को प्रस्तुत करने के लिए फ़्रेम। HTML 4.01. में लक्ष्य विशेषता परिभाषा देखें |
...
| [Reset](../../aspose.html/htmlformelement/reset/)() | प्रपत्र तत्व के डिफ़ॉल्ट मानों को पुनर्स्थापित करता है। यह एक रीसेट बटन के रूप में समान क्रिया करता है। |
...
| [Submit](../../aspose.html/htmlformelement/submit/)() | फॉर्म जमा करता है। यह सबमिट बटन के समान कार्य करता है। |
