...
description: Aspose.Html.Rendering.GraphicContext कक्ष. वर्तमन ग्रफक्स नयंत्रण पैरमटर रखत है ये पैरमटर वैश्वक ढंचे क परभषत करते हैं जसके भतर ग्रफक्स ऑपरेटर नष्पदत करते हैं
type: docs
weight: 4260
url: /hi/net/aspose.html.rendering/graphiccontext/
---
## GraphicContext class

वर्तमान ग्राफिक्स नियंत्रण पैरामीटर रखता है। ये पैरामीटर वैश्विक ढांचे को परिभाषित करते हैं जिसके भीतर ग्राफिक्स ऑपरेटर निष्पादित करते हैं।
...
| नाम | विवरण |
| --- | --- |
| [GraphicContext](graphiccontext/)() | का एक नया उदाहरण प्रारंभ करता है`GraphicContext` वर्ग. |
...
| virtual [TextInfo](../../aspose.html.rendering/graphiccontext/textinfo/) { get; } | हो जाता है[`TextInfo`](../textinfo/) ऑब्जेक्ट जिसमें रेंडर किए गए टेक्स्ट के बारे में जानकारी है. |
| virtual [TransformationMatrix](../../aspose.html.rendering/graphiccontext/transformationmatrix/) { get; set; } | परिवर्तन मैट्रिक्स सेट या प्राप्त करता है। |

## तरीकों

| नाम | विवरण |
| --- | --- |
| virtual [Clone](../../aspose.html.rendering/graphiccontext/clone/)() | एक ग्राफ़िककॉन्टेक्स्ट क्लास का एक नया उदाहरण बनाता है जिसमें मौजूदा उदाहरण के समान गुण मान होते हैं। |
| virtual [Transform](../../aspose.html.rendering/graphiccontext/transform/)(Matrix) | निर्दिष्ट मैट्रिक्स को गुणा करके वर्तमान परिवर्तन मैट्रिक्स को संशोधित करें। |
