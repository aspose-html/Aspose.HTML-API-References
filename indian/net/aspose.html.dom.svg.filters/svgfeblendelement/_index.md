...
description: Aspose.Html.Dom.Svg.Filters.SVGFEBlendElement कक्ष. SVGFEBlendElement इंटरफ़ेस feBlend तत्व से मेल खत है.
type: docs
weight: 1360
url: /hi/net/aspose.html.dom.svg.filters/svgfeblendelement/
---
## SVGFEBlendElement class

SVGFEBlendElement इंटरफ़ेस 'feBlend' तत्व से मेल खाता है.
...
| [Height](../../aspose.html.dom.svg.filters/svgfeblendelement/height/) { get; } | दिए गए 'फिल्टर' तत्व पर विशेषता 'ऊंचाई' के अनुरूप है। |
| [Id](../../aspose.html.dom.svg/svgelement/id/) { get; set; } | दिए गए तत्व पर 'आईडी' विशेषता का मान, या 'आईडी' मौजूद नहीं होने पर खाली स्ट्रिंग। |
| [In1](../../aspose.html.dom.svg.filters/svgfeblendelement/in1/) { get; } | दिए गए 'feBlend' तत्व पर विशेषता 'इन' के अनुरूप है। |
| [In2](../../aspose.html.dom.svg.filters/svgfeblendelement/in2/) { get; } | दिए गए 'feBlend' तत्व पर विशेषता 'in2' के अनुरूप है। |
...
| [Mode](../../aspose.html.dom.svg.filters/svgfeblendelement/mode/) { get; } | दिए गए 'feBlend' तत्व पर विशेषता 'मोड' के अनुरूप है। इस इंटरफ़ेस पर परिभाषित SVG_FEBLEND_MODE_* स्थिरांकों में से एक लेता है। |
...
| [Result](../../aspose.html.dom.svg.filters/svgfeblendelement/result/) { get; } | दिए गए 'फिल्टर' तत्व पर विशेषता 'परिणाम' के अनुरूप है। |
...
| [Width](../../aspose.html.dom.svg.filters/svgfeblendelement/width/) { get; } | दिए गए 'फ़िल्टर' तत्व पर विशेषता 'चौड़ाई' के अनुरूप है। |
| [X](../../aspose.html.dom.svg.filters/svgfeblendelement/x/) { get; } | दिए गए 'फ़िल्टर' तत्व पर विशेषता 'x' के अनुरूप है। |
| [Y](../../aspose.html.dom.svg.filters/svgfeblendelement/y/) { get; } | दिए गए 'फ़िल्टर' तत्व पर विशेषता 'y' के अनुरूप है। |
...
| नाम | विवरण |
| --- | --- |
| const [SVG_FEBLEND_MODE_COLOR](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_color/) | मान 'रंग' के अनुरूप है। |
| const [SVG_FEBLEND_MODE_COLOR_BURN](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_color_burn/) | मान 'color_burn' के अनुरूप है. |
| const [SVG_FEBLEND_MODE_COLOR_DODGE](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_color_dodge/) | मान 'color_dodge' के अनुरूप है। |
| const [SVG_FEBLEND_MODE_DARKEN](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_darken/) | मान 'गहरा' के अनुरूप है। |
| const [SVG_FEBLEND_MODE_DIFFERENCE](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_difference/) | मूल्य 'अंतर' के अनुरूप है। |
| const [SVG_FEBLEND_MODE_EXCLUSION](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_exclusion/) | मूल्य 'बहिष्करण' के अनुरूप है। |
| const [SVG_FEBLEND_MODE_HARD_LIGHT](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_hard_light/) | मान 'हार्ड_लाइट' के अनुरूप है। |
| const [SVG_FEBLEND_MODE_HUE](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_hue/) | मान 'ह्यू' के अनुरूप है। |
| const [SVG_FEBLEND_MODE_LIGHTEN](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_lighten/) | मान 'हल्का' के अनुरूप है। |
| const [SVG_FEBLEND_MODE_LUMINOSITY](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_luminosity/) | मान 'चमक' के अनुरूप है। |
| const [SVG_FEBLEND_MODE_MULTIPLY](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_multiply/) | मान 'गुणा' के अनुरूप है। |
| const [SVG_FEBLEND_MODE_NORMAL](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_normal/) | मान 'सामान्य' के अनुरूप है। |
| const [SVG_FEBLEND_MODE_OVERLAY](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_overlay/) | मान 'ओवरले' के अनुरूप है। |
| const [SVG_FEBLEND_MODE_SATURATION](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_saturation/) | मान 'संतृप्ति' के अनुरूप है। |
| const [SVG_FEBLEND_MODE_SCREEN](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_screen/) | मान 'स्क्रीन' के अनुरूप है। |
| const [SVG_FEBLEND_MODE_SOFT_LIGHT](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_soft_light/) | मान 'सॉफ्ट_लाइट' के अनुरूप है। |
| const [SVG_FEBLEND_MODE_UNKNOWN](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_unknown/) | प्रकार पूर्वनिर्धारित प्रकारों में से एक नहीं है। इस प्रकार के नए मान को परिभाषित करने का प्रयास करना या किसी मौजूदा मान को इस प्रकार में बदलने का प्रयास करना अमान्य है। |
...
* नाम स्थान [Aspose.Html.Dom.Svg.Filters](../../aspose.html.dom.svg.filters/)
* सभा [Aspose.HTML](../../)
