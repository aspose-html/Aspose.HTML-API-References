...
description: Aspose.Html.Dom.Notation 수업. DTD에 선언된 표기법을 나타냅니다.
type: docs
weight: 1010
url: /ko/net/aspose.html.dom/notation/
---
## Notation class
...
| override [NodeName](../../aspose.html.dom/notation/nodename/) { get; } | 유형에 따라 이 노드의 이름입니다. |
| override [NodeType](../../aspose.html.dom/notation/nodetype/) { get; } | 기본 개체의 유형을 나타내는 코드입니다. |
...
| [PublicId](../../aspose.html.dom/notation/publicid/) { get; } | 이 표기법의 공용 식별자입니다. 공용 식별자가 지정되지 않은 경우 null입니다. |
| [SystemId](../../aspose.html.dom/notation/systemid/) { get; } | 이 표기법의 시스템 식별자입니다. 시스템 식별자가 지정되지 않은 경우 null입니다. 절대 URI일 수도 있고 아닐 수도 있습니다. |
