...
description: Aspose.Html.Dom.Document 수업. 문서는 전체 HTML XML 또는 SVG 문서를 나타냅니다. 개념적으로 문서 트리의 루트이며 문서 데이터에 대한 기본 액세스를 제공합니다.
type: docs
weight: 660
url: /ko/net/aspose.html.dom/document/
---
## Document class
...
| [CreateNodeIterator](../../aspose.html.dom/document/createnodeiterator/#createnodeiterator)(Node) | 지정한 노드 에 뿌리를 둔 하위 트리에 새 NodeIterator를 만듭니다. |
| [CreateNodeIterator](../../aspose.html.dom/document/createnodeiterator/#createnodeiterator_1)(Node, long) | 지정한 노드 에 뿌리를 둔 하위 트리에 새 NodeIterator를 만듭니다. |
| [CreateNodeIterator](../../aspose.html.dom/document/createnodeiterator/#createnodeiterator_2)(Node, long, INodeFilter) | 지정한 노드 에 뿌리를 둔 하위 트리에 새 NodeIterator를 만듭니다. |
...
| [CreateTreeWalker](../../aspose.html.dom/document/createtreewalker/#createtreewalker)(Node) | 지정한 노드 에 뿌리를 둔 하위 트리에 새 TreeWalker를 만듭니다. |
| [CreateTreeWalker](../../aspose.html.dom/document/createtreewalker/#createtreewalker_1)(Node, long) | 지정한 노드 에 뿌리를 둔 하위 트리에 새 TreeWalker를 만듭니다. |
| [CreateTreeWalker](../../aspose.html.dom/document/createtreewalker/#createtreewalker_2)(Node, long, INodeFilter) | 지정한 노드 에 뿌리를 둔 하위 트리에 새 TreeWalker를 만듭니다. |
...
| [Navigate](../../aspose.html.dom/document/navigate/#navigate)(RequestMessage) | 지정된 요청 개체를 기반으로 문서를 로드하여 이전 내용을 바꿉니다. |
| [Navigate](../../aspose.html.dom/document/navigate/#navigate_4)(string) | 지정된 URL(Uniform Resource Locator)의 문서를 현재 인스턴스로 로드하여 이전 콘텐츠를 바꿉니다. |
| [Navigate](../../aspose.html.dom/document/navigate/#navigate_1)(Url) | 지정된 URL(Uniform Resource Locator)의 문서를 현재 인스턴스로 로드하여 이전 콘텐츠를 바꿉니다. |
| [Navigate](../../aspose.html.dom/document/navigate/#navigate_3)(Stream, string) | 지정된 콘텐츠에서 문서를 로드하고 baseUri를 사용하여 상대 리소스를 확인하고 이전 콘텐츠를 바꿉니다. 문서 로드는 스트림의 현재 위치에서 시작됩니다. |
| [Navigate](../../aspose.html.dom/document/navigate/#navigate_2)(Stream, Url) | 지정된 콘텐츠에서 문서를 로드하고 baseUri를 사용하여 상대 리소스를 확인하고 이전 콘텐츠를 바꿉니다. 문서 로드는 스트림의 현재 위치에서 시작됩니다. |
| [Navigate](../../aspose.html.dom/document/navigate/#navigate_6)(string, string) | 지정된 콘텐츠에서 문서를 로드하고 baseUri를 사용하여 관련 리소스를 확인하여 이전 콘텐츠를 바꿉니다. |
| [Navigate](../../aspose.html.dom/document/navigate/#navigate_5)(string, Url) | 지정된 콘텐츠에서 문서를 로드하고 baseUri를 사용하여 관련 리소스를 확인하여 이전 콘텐츠를 바꿉니다. |
...
| virtual [RenderTo](../../aspose.html.dom/document/renderto/)(IDevice) | 이 메서드는 현재 문서의 내용을 지정된 그래픽 장치에 렌더링하는 데 사용됩니다. |
