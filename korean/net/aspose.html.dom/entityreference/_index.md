...
description: Aspose.Html.Dom.EntityReference 수업. EntityReference 노드는 트리에서 엔티티 참조를 나타내는 데 사용될 수 있습니다.
type: docs
weight: 710
url: /ko/net/aspose.html.dom/entityreference/
---
## EntityReference class

EntityReference 노드는 트리에서 엔티티 참조를 나타내는 데 사용될 수 있습니다.
...
| override [NodeName](../../aspose.html.dom/entityreference/nodename/) { get; } | 유형에 따라 이 노드의 이름입니다. |
| override [NodeType](../../aspose.html.dom/entityreference/nodetype/) { get; } | 기본 개체의 유형을 나타내는 코드입니다. |
