...
description: Aspose.Html.Toolkit.Markdown.Syntax.ReferenceLinkSyntaxNode 수업. 참조 링크 구문을 나타냅니다.
type: docs
weight: 5520
url: /ko/net/aspose.html.toolkit.markdown.syntax/referencelinksyntaxnode/
---
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/referencelinksyntaxnode/accept/)(MarkdownSyntaxVisitor) | 방문자 수락을 위한 인터페이스를 정의합니다. |
...
| [GetContent](../../aspose.html.toolkit.markdown.syntax/referencelinksyntaxnode/getcontent/)() | 콘텐츠 가져오기를 위한 인터페이스를 정의합니다. |
| [GetLabel](../../aspose.html.toolkit.markdown.syntax/referencelinksyntaxnode/getlabel/)() | get label. 에 대한 인터페이스를 정의합니다. |
