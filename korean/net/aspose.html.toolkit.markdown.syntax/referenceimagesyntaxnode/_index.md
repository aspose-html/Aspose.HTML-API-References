...
description: Aspose.Html.Toolkit.Markdown.Syntax.ReferenceImageSyntaxNode 수업. 참조 이미지 구문.
type: docs
weight: 5510
url: /ko/net/aspose.html.toolkit.markdown.syntax/referenceimagesyntaxnode/
---
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/referenceimagesyntaxnode/accept/)(MarkdownSyntaxVisitor) | 방문자 수락을 위한 인터페이스를 정의합니다. |
...
| [GetAltText](../../aspose.html.toolkit.markdown.syntax/referenceimagesyntaxnode/getalttext/)() | 대체 텍스트를 가져오기 위한 인터페이스를 정의합니다. |
| [GetLabel](../../aspose.html.toolkit.markdown.syntax/referenceimagesyntaxnode/getlabel/)() | get label. 에 대한 인터페이스를 정의합니다. |
