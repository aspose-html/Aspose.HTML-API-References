...
description: Aspose.Html.Toolkit.Markdown.Syntax.InlineProxy 수업. 는 InlineProxy를 나타냅니다.
type: docs
weight: 5070
url: /ko/net/aspose.html.toolkit.markdown.syntax/inlineproxy/
---
## InlineProxy class

는 InlineProxy를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/inlineproxy/accept/)(MarkdownSyntaxVisitor) | 방문자 수락을 위한 인터페이스를 정의합니다. |
...
| [GetTarget](../../aspose.html.toolkit.markdown.syntax/inlineproxy/gettarget/)() | get target. 에 대한 인터페이스를 정의합니다. |
...
| override [WriteTo](../../aspose.html.toolkit.markdown.syntax/inlineproxy/writeto/#writeto)(MarkdownTextWriter) | 텍스트 작성기에 쓰기. |
