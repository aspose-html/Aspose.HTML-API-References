...
description: Aspose.Html.Toolkit.Markdown.Syntax.IndentedCodeBlockSyntaxNode 수업. 는 IndentedCodeBlockSyntaxNode를 나타냅니다.
type: docs
weight: 5030
url: /ko/net/aspose.html.toolkit.markdown.syntax/indentedcodeblocksyntaxnode/
---
## IndentedCodeBlockSyntaxNode class

는 IndentedCodeBlockSyntaxNode를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/indentedcodeblocksyntaxnode/accept/)(MarkdownSyntaxVisitor) | 방문자 수락을 위한 인터페이스를 정의합니다. |
...
| [GetContent](../../aspose.html.toolkit.markdown.syntax/indentedcodeblocksyntaxnode/getcontent/)() | 콘텐츠를 가져오기 위한 인터페이스를 정의합니다. |
