...
description: Aspose.Html.Toolkit.Markdown.Syntax.LinkReferenceDefinitionSyntaxNode 수업. LinkReferenceDefinitionSyntaxNode를 나타냅니다.
type: docs
weight: 5120
url: /ko/net/aspose.html.toolkit.markdown.syntax/linkreferencedefinitionsyntaxnode/
---
## LinkReferenceDefinitionSyntaxNode class

LinkReferenceDefinitionSyntaxNode를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/linkreferencedefinitionsyntaxnode/accept/)(MarkdownSyntaxVisitor) | 방문자 수락을 위한 인터페이스를 정의합니다. |
...
| [GetDestination](../../aspose.html.toolkit.markdown.syntax/linkreferencedefinitionsyntaxnode/getdestination/)() | 대상을 가져오기 위한 인터페이스를 정의합니다. |
| [GetLabel](../../aspose.html.toolkit.markdown.syntax/linkreferencedefinitionsyntaxnode/getlabel/)() | get label. 에 대한 인터페이스를 정의합니다. |
...
| [GetTitle](../../aspose.html.toolkit.markdown.syntax/linkreferencedefinitionsyntaxnode/gettitle/)() | get title. 에 대한 인터페이스를 정의합니다. |
