...
description: Aspose.Html.Toolkit.Markdown.Syntax.MarkdownSyntaxToken 수업. Markdown 구문 토큰을 나타냅니다.
type: docs
weight: 5210
url: /ko/net/aspose.html.toolkit.markdown.syntax/markdownsyntaxtoken/
---
...
| [Source](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxtoken/source/) { get; } | 원본 텍스트 가져오기. |
| [Span](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxtoken/span/) { get; } | 범위를 가져옵니다. |
| [Text](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxtoken/text/) { get; } | span. 의 텍스트 내용 가져오기 |

## 행동 양식

| 이름 | 설명 |
| --- | --- |
| virtual [Accept](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/accept/)(MarkdownSyntaxVisitor) | 방문자를 수락합니다. |
...
| [GetFullText](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxtoken/getfulltext/)() | 전체 텍스트를 가져오기 위한 인터페이스를 정의합니다. |
