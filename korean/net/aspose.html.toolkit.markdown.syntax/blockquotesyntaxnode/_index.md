...
description: Aspose.Html.Toolkit.Markdown.Syntax.BlockQuoteSyntaxNode 수업. 는 BlockQuoteSyntaxNode를 나타냅니다.
type: docs
weight: 4810
url: /ko/net/aspose.html.toolkit.markdown.syntax/blockquotesyntaxnode/
---
## BlockQuoteSyntaxNode class

는 BlockQuoteSyntaxNode를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/blockquotesyntaxnode/accept/)(MarkdownSyntaxVisitor) | 방문자 수락을 위한 인터페이스를 정의합니다. |
