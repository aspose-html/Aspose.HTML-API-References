...
description: Aspose.Html.Toolkit.Markdown.Syntax.InlineLinkSyntaxNode 수업. 는 InlineLinkSyntaxNode를 나타냅니다.
type: docs
weight: 5060
url: /ko/net/aspose.html.toolkit.markdown.syntax/inlinelinksyntaxnode/
---
## InlineLinkSyntaxNode class

는 InlineLinkSyntaxNode를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/inlinelinksyntaxnode/accept/)(MarkdownSyntaxVisitor) | 방문자 수락을 위한 인터페이스를 정의합니다. |
...
| [GetDestination](../../aspose.html.toolkit.markdown.syntax/inlinelinksyntaxnode/getdestination/)() | 대상을 가져오기 위한 인터페이스를 정의합니다. |
...
| [GetTitle](../../aspose.html.toolkit.markdown.syntax/inlinelinksyntaxnode/gettitle/)() | get title. 에 대한 인터페이스를 정의합니다. |
