...
description: Aspose.Html.Toolkit.Markdown.Syntax.TableSyntaxNode 수업. TableSyntax 클래스 노드입니다.
type: docs
weight: 5590
url: /ko/net/aspose.html.toolkit.markdown.syntax/tablesyntaxnode/
---
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/tablesyntaxnode/accept/)(MarkdownSyntaxVisitor) | 방문자 수락을 위한 인터페이스를 정의합니다. |
| [AppendChild](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/appendchild/)(MarkdownSyntaxNode) | 자식 노드 추가. |
| [AppendRow](../../aspose.html.toolkit.markdown.syntax/tablesyntaxnode/appendrow/)(TableRowSyntaxNode) | 추가 행에 대한 인터페이스를 정의합니다. |
| [ChildNodes](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/childnodes/)() | 자식 노드 컬렉션을 가져옵니다. |
| [GetAlignment](../../aspose.html.toolkit.markdown.syntax/tablesyntaxnode/getalignment/)() | 정렬을 위한 인터페이스를 정의합니다. |
| [GetBodyRows](../../aspose.html.toolkit.markdown.syntax/tablesyntaxnode/getbodyrows/)() | 본문 행 가져오기에 대한 인터페이스를 정의합니다. |
| [GetHeader](../../aspose.html.toolkit.markdown.syntax/tablesyntaxnode/getheader/)() | 테이블 헤더 가져오기를 위한 인터페이스를 정의합니다. |
