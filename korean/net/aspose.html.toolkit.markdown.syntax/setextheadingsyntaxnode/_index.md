...
description: Aspose.Html.Toolkit.Markdown.Syntax.SetextHeadingSyntaxNode 수업. Setext 제목 구문 노드를 나타냅니다.
type: docs
weight: 5530
url: /ko/net/aspose.html.toolkit.markdown.syntax/setextheadingsyntaxnode/
---
## SetextHeadingSyntaxNode class

Setext 제목 구문 노드를 나타냅니다.
...
| [Level](../../aspose.html.toolkit.markdown.syntax/setextheadingsyntaxnode/level/) { get; } | 현재 구문의 수준을 가져옵니다. |
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/setextheadingsyntaxnode/accept/)(MarkdownSyntaxVisitor) | 방문자 수락을 위한 인터페이스를 정의합니다. |
