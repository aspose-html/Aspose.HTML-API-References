...
description: Aspose.Html.Toolkit.Markdown.Syntax.TaskListItemSyntaxNode 수업. 작업 목록 항목 구문 node.
type: docs
weight: 5610
url: /ko/net/aspose.html.toolkit.markdown.syntax/tasklistitemsyntaxnode/
---
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/listitemsyntaxnode/accept/)(MarkdownSyntaxVisitor) | 방문자 수락을 위한 인터페이스를 정의합니다. |
...
| [GetLinesLeadingTrivia](../../aspose.html.toolkit.markdown.syntax/multilinecontainerblocksyntaxnode/getlinesleadingtrivia/)() | 퀴즈를 이끄는 줄을 얻기 위한 인터페이스를 정의합니다. |
| [GetMarker](../../aspose.html.toolkit.markdown.syntax/listitemsyntaxnode/getmarker/)() | marker 가져오기 |
...
| [IsChecked](../../aspose.html.toolkit.markdown.syntax/tasklistitemsyntaxnode/ischecked/)() | 상태 확인을 위한 인터페이스를 정의합니다. |
| [IsTight](../../aspose.html.toolkit.markdown.syntax/listitemsyntaxnode/istight/)() | 타이트한 경우 true를 가져옵니다. |
