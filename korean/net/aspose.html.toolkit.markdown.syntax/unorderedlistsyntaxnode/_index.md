...
description: Aspose.Html.Toolkit.Markdown.Syntax.UnorderedListSyntaxNode 수업. 정렬되지 않은 목록 구문 노드를 나타냅니다.
type: docs
weight: 5730
url: /ko/net/aspose.html.toolkit.markdown.syntax/unorderedlistsyntaxnode/
---
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/unorderedlistsyntaxnode/accept/)(MarkdownSyntaxVisitor) | 구문의 방문 노드에 대한 인터페이스를 정의합니다. |
...
| [GetMarker](../../aspose.html.toolkit.markdown.syntax/unorderedlistsyntaxnode/getmarker/)() | 마커를 가져올 인터페이스를 정의합니다. |
