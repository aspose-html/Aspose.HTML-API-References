...
description: Aspose.Html.Toolkit.Markdown.Syntax.InlineImageSyntaxNode 수업. 는 InlineImageSyntaxNode를 나타냅니다.
type: docs
weight: 5050
url: /ko/net/aspose.html.toolkit.markdown.syntax/inlineimagesyntaxnode/
---
## InlineImageSyntaxNode class

는 InlineImageSyntaxNode를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/inlineimagesyntaxnode/accept/)(MarkdownSyntaxVisitor) | 방문자 수락을 위한 인터페이스를 정의합니다. |
...
| [GetAltText](../../aspose.html.toolkit.markdown.syntax/inlineimagesyntaxnode/getalttext/)() | 모든 텍스트를 가져오기 위한 인터페이스를 정의합니다. |
| [GetDestination](../../aspose.html.toolkit.markdown.syntax/inlineimagesyntaxnode/getdestination/)() | 대상을 가져오기 위한 인터페이스를 정의합니다. |
...
| [GetTitle](../../aspose.html.toolkit.markdown.syntax/inlineimagesyntaxnode/gettitle/)() | get title. 에 대한 인터페이스를 정의합니다. |
