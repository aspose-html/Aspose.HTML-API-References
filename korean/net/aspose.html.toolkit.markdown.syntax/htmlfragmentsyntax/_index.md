...
description: Aspose.Html.Toolkit.Markdown.Syntax.HTMLFragmentSyntax 수업. 는 HTMLFragmentSyntax. 를 나타냅니다.
type: docs
weight: 5000
url: /ko/net/aspose.html.toolkit.markdown.syntax/htmlfragmentsyntax/
---
## HTMLFragmentSyntax class

는 HTMLFragmentSyntax. 를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/htmlfragmentsyntax/accept/)(MarkdownSyntaxVisitor) | 방문자 수락을 위한 인터페이스를 정의합니다. |
...
| [GetContent](../../aspose.html.toolkit.markdown.syntax/htmlfragmentsyntax/getcontent/)() | 콘텐츠를 가져오기 위한 인터페이스를 정의합니다. |
...
| [SetContent](../../aspose.html.toolkit.markdown.syntax/htmlfragmentsyntax/setcontent/)(string) | Content. 집합에 대한 인터페이스를 정의합니다. |
