...
description: Aspose.Html.Toolkit.Markdown.Syntax.TableDelimiterSyntaxNode 수업. 테이블 구분 기호 구문 노드를 나타냅니다.
type: docs
weight: 5570
url: /ko/net/aspose.html.toolkit.markdown.syntax/tabledelimitersyntaxnode/
---
## TableDelimiterSyntaxNode class

테이블 구분 기호 구문 노드를 나타냅니다.
