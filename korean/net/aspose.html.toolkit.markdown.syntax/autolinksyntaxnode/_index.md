...
description: Aspose.Html.Toolkit.Markdown.Syntax.AutoLinkSyntaxNode 수업. 는 AutoLinkSyntaxNode를 나타냅니다.
type: docs
weight: 4790
url: /ko/net/aspose.html.toolkit.markdown.syntax/autolinksyntaxnode/
---
## AutoLinkSyntaxNode class

는 AutoLinkSyntaxNode를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/autolinksyntaxnode/accept/)(MarkdownSyntaxVisitor) | 방문자 수락을 위한 인터페이스를 정의합니다. |
...
| [GetUri](../../aspose.html.toolkit.markdown.syntax/autolinksyntaxnode/geturi/)() | URI를 가져옵니다. |
...
| [IsMail](../../aspose.html.toolkit.markdown.syntax/autolinksyntaxnode/ismail/)() | 메일인 경우 true를 가져옵니다. |
