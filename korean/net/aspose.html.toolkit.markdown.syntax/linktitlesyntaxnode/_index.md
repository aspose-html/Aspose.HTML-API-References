...
description: Aspose.Html.Toolkit.Markdown.Syntax.LinkTitleSyntaxNode 수업. LinkTitleSyntaxNode를 나타냅니다.
type: docs
weight: 5130
url: /ko/net/aspose.html.toolkit.markdown.syntax/linktitlesyntaxnode/
---
## LinkTitleSyntaxNode class

LinkTitleSyntaxNode를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/linktitlesyntaxnode/accept/)(MarkdownSyntaxVisitor) | 방문자 수락을 위한 인터페이스를 정의합니다. |
...
| [GetValue](../../aspose.html.toolkit.markdown.syntax/linktitlesyntaxnode/getvalue/)() | 문자열 값을 가져오기 위한 인터페이스를 정의합니다. |
