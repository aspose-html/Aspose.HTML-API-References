...
description: Aspose.Html.Toolkit.Markdown.Syntax.BlockProxy 수업. 는 BlockProxy를 나타냅니다.
type: docs
weight: 4800
url: /ko/net/aspose.html.toolkit.markdown.syntax/blockproxy/
---
## BlockProxy class
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/blockproxy/accept/)(MarkdownSyntaxVisitor) | 방문자 수락을 위한 인터페이스를 정의합니다. |
...
| [GetTarget](../../aspose.html.toolkit.markdown.syntax/blockproxy/gettarget/)() | 대상 노드를 가져옵니다. |
...
| override [WriteTo](../../aspose.html.toolkit.markdown.syntax/blockproxy/writeto/#writeto)(MarkdownTextWriter) | Write To writer의 인터페이스를 정의합니다. |
