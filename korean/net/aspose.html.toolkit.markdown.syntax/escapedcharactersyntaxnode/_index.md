...
description: Aspose.Html.Toolkit.Markdown.Syntax.EscapedCharacterSyntaxNode 수업. 이스케이프 문자 구문 노드를 구현했습니다.
type: docs
weight: 4890
url: /ko/net/aspose.html.toolkit.markdown.syntax/escapedcharactersyntaxnode/
---
## EscapedCharacterSyntaxNode class

이스케이프 문자 구문 노드를 구현했습니다.
...
| virtual [Source](../../aspose.html.toolkit.markdown.syntax/textsyntaxnode/source/) { get; } | 원본 텍스트를 반환합니다. |
| virtual [Span](../../aspose.html.toolkit.markdown.syntax/textsyntaxnode/span/) { get; } | get span. 에 대한 인터페이스를 정의합니다. |
| [Value](../../aspose.html.toolkit.markdown.syntax/textsyntaxnode/value/) { get; } | 문자열 값을 가져오기 위한 속성을 정의합니다. |

## 행동 양식

| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/escapedcharactersyntaxnode/accept/)(MarkdownSyntaxVisitor) | 방문자 수락을 위한 인터페이스를 정의합니다. |
