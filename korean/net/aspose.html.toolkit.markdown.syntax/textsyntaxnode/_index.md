...
description: Aspose.Html.Toolkit.Markdown.Syntax.TextSyntaxNode 수업. 텍스트 구문 노드를 구현했습니다.
type: docs
weight: 5670
url: /ko/net/aspose.html.toolkit.markdown.syntax/textsyntaxnode/
---
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/textsyntaxnode/accept/)(MarkdownSyntaxVisitor) | 방문자 수락을 위한 인터페이스를 정의합니다. |
