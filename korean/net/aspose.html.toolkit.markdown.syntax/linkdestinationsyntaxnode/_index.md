...
description: Aspose.Html.Toolkit.Markdown.Syntax.LinkDestinationSyntaxNode 수업. LinkDestinationSyntaxNode를 나타냅니다.
type: docs
weight: 5110
url: /ko/net/aspose.html.toolkit.markdown.syntax/linkdestinationsyntaxnode/
---
## LinkDestinationSyntaxNode class

LinkDestinationSyntaxNode를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/linkdestinationsyntaxnode/accept/)(MarkdownSyntaxVisitor) | 방문자 수락을 위한 인터페이스를 정의합니다. |
...
| [GetEnumerator](../../aspose.html.toolkit.markdown.syntax/inlinecontainersyntaxnode/getenumerator/)() | 컬렉션을 반복하는 열거자를 반환합니다. |
...
| [GetValue](../../aspose.html.toolkit.markdown.syntax/linkdestinationsyntaxnode/getvalue/)() | 문자열 값을 가져오기 위한 인터페이스를 정의합니다. |
