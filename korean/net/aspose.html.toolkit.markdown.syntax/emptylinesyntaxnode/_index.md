...
description: Aspose.Html.Toolkit.Markdown.Syntax.EmptyLineSyntaxNode 수업. 는 EmptyLineSyntaxNode를 나타냅니다.
type: docs
weight: 4880
url: /ko/net/aspose.html.toolkit.markdown.syntax/emptylinesyntaxnode/
---
## EmptyLineSyntaxNode class

는 EmptyLineSyntaxNode를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/emptylinesyntaxnode/accept/)(MarkdownSyntaxVisitor) | 방문자 수락을 위한 인터페이스를 정의합니다. |
