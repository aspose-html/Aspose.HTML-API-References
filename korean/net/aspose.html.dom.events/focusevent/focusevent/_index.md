...
description: FocusEvent 건설자. 의 새 인스턴스를 초기화합니다.FocusEvent 클래스.
type: docs
weight: 10
url: /ko/net/aspose.html.dom.events/focusevent/focusevent/
---
## FocusEvent(string) {#constructor}

의 새 인스턴스를 초기화합니다.[`FocusEvent`](../) 클래스.
...
* class [FocusEvent](../)
* 네임스페이스 [Aspose.Html.Dom.Events](../../focusevent/)
* 집회 [Aspose.HTML](../../../)
