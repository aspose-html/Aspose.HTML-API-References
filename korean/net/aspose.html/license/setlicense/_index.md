...
type: docs
weight: 20
url: /ko/net/aspose.html/license/setlicense/
---
...
| 모수 | 유형 | 설명 |
| --- | --- | --- |
| licenseName | String | 전체 또는 짧은 파일 이름일 수 있습니다. 또는 임베디드 리소스의 이름. 평가 모드로 전환하려면 빈 문자열을 사용하십시오. |
