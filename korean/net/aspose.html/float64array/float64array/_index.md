...
description: Float64Array 건설자. 의 새 인스턴스를 초기화합니다.Float64Array 클래스.
type: docs
weight: 10
url: /ko/net/aspose.html/float64array/float64array/
---
## Float64Array(int) {#constructor_4}

의 새 인스턴스를 초기화합니다.[`Float64Array`](../) 클래스.
...
| 모수 | 유형 | 설명 |
| --- | --- | --- |
| length | Int32 | 길이(요소 수)입니다. |

### 또한보십시오

* class [Float64Array](../)
* 네임스페이스 [Aspose.Html](../../float64array/)
* 집회 [Aspose.HTML](../../../)
