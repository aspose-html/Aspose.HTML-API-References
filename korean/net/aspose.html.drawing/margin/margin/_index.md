...
description: Margin 건설자. 의 새 인스턴스를 초기화합니다.Margin 클래스.
type: docs
weight: 10
url: /ko/net/aspose.html.drawing/margin/margin/
---
## Margin() {#constructor}

의 새 인스턴스를 초기화합니다.[`Margin`](../) 클래스.
...
* class [Margin](../)
* 네임스페이스 [Aspose.Html.Drawing](../../margin/)
* 집회 [Aspose.HTML](../../../)
...
| 모수 | 유형 | 설명 |
| --- | --- | --- |
| left | Int32 | 왼쪽 사이즈입니다. |
| top | Int32 | 최고 크기입니다. |
| right | Int32 | 적당한 크기. |
| bottom | Int32 | 하단 사이즈입니다. |
...
| 모수 | 유형 | 설명 |
| --- | --- | --- |
| left | Length | 왼쪽 사이즈입니다. |
| top | Length | 최고 크기입니다. |
| right | Length | 적당한 크기. |
| bottom | Length | 하단 사이즈입니다. |
