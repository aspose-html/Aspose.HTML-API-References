...
description: SVGPathSegList 건설자. 의 새 인스턴스를 초기화합니다.SVGPathSegList 클래스.
type: docs
weight: 10
url: /ko/net/aspose.html.dom.svg.paths/svgpathseglist/svgpathseglist/
---
## SVGPathSegList() {#constructor}

의 새 인스턴스를 초기화합니다.[`SVGPathSegList`](../) 클래스.
...
* 네임스페이스 [Aspose.Html.Dom.Svg.Paths](../../svgpathseglist/)
* 집회 [Aspose.HTML](../../../)
