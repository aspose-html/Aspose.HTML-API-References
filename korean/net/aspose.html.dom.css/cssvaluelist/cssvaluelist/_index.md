...
description: CSSValueList 건설자. 의 새 인스턴스를 초기화합니다.CSSValueList 클래스.
type: docs
weight: 10
url: /ko/net/aspose.html.dom.css/cssvaluelist/cssvaluelist/
---
## CSSValueList() {#constructor}

의 새 인스턴스를 초기화합니다.[`CSSValueList`](../) 클래스.
...
* class [CSSValueList](../)
* 네임스페이스 [Aspose.Html.Dom.Css](../../cssvaluelist/)
* 집회 [Aspose.HTML](../../../)
