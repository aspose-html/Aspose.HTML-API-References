...
description: IViewCSS 방법. 이 메서드는 CSS2. 에 정의된 대로 계산된 스타일을 가져오는 데 사용됩니다.
type: docs
weight: 10
url: /ko/net/aspose.html.dom.css/iviewcss/getcomputedstyle/
---
...
* interface [IViewCSS](../)
* 네임스페이스 [Aspose.Html.Dom.Css](../../iviewcss/)
* 집회 [Aspose.HTML](../../../)
