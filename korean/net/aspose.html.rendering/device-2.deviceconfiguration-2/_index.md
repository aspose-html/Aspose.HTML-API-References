...
description: Aspose.Html.Rendering.Device2DeviceConfigurationTGraphicContextTRenderingOptions 수업. 장치에 대한 구성 개체를 나타냅니다.
type: docs
weight: 4150
url: /ko/net/aspose.html.rendering/device-2.deviceconfiguration-2/
---
...
| 이름 | 설명 |
| --- | --- |
| [DeviceConfiguration](deviceconfiguration/)() | 기본 생성자입니다. |

## 속성

| 이름 | 설명 |
| --- | --- |
| [PageWritingStrategy](../../aspose.html.rendering/deviceconfiguration/pagewritingstrategy/) { get; set; } | 페이지 쓰기 전략을 가져오거나 설정합니다. |
