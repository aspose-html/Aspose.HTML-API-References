...
description: MhtmlRenderer 방법. 여러 MHTML 문서를 지정된 형식으로 렌더링합니다.IDevice . 리소스 로드 활성 타이머 애니메이션 작업 또는 지정된 시간 초과에 대한 네트워크 작업이 없으면 렌더링이 수행됩니다.
type: docs
weight: 20
url: /ko/net/aspose.html.rendering/mhtmlrenderer/render/
---
## Render(IDevice, TimeSpan, params Stream[]) {#render_9}

여러 MHTML 문서를 지정된 형식으로 렌더링합니다.[`IDevice`](../../idevice/) . 리소스 로드, 활성 타이머, 애니메이션 작업 또는 지정된 시간 초과에 대한 네트워크 작업이 없으면 렌더링이 수행됩니다.
...
* class [MhtmlRenderer](../)
* 네임스페이스 [Aspose.Html.Rendering](../../mhtmlrenderer/)
* 집회 [Aspose.HTML](../../../)
...
MHTML 문서를 지정된 형식으로 렌더링합니다.[`IDevice`](../../idevice/) .
...
MHTML 문서를 지정된 형식으로 렌더링합니다.[`IDevice`](../../idevice/) . 리소스 로드, 활성 타이머, 애니메이션 작업 또는 지정된 시간 초과에 대한 네트워크 작업이 없으면 렌더링이 수행됩니다.
...
여러 MHTML 문서를 지정된 형식으로 렌더링합니다.[`IDevice`](../../idevice/) .
