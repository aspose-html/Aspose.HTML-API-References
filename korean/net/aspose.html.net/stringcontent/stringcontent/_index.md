...
description: StringContent 건설자. 의 새 인스턴스를 초기화합니다.StringContent 클래스.
type: docs
weight: 10
url: /ko/net/aspose.html.net/stringcontent/stringcontent/
---
## StringContent(string) {#constructor}

의 새 인스턴스를 초기화합니다.[`StringContent`](../) 클래스.
...
* class [StringContent](../)
* 네임스페이스 [Aspose.Html.Net](../../stringcontent/)
* 집회 [Aspose.HTML](../../../)
