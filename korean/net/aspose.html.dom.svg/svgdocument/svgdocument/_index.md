...
description: SVGDocument 건설자. 의 새 인스턴스를 초기화합니다.SVGDocument 클래스.
type: docs
weight: 10
url: /ko/net/aspose.html.dom.svg/svgdocument/svgdocument/
---
## SVGDocument() {#constructor}

의 새 인스턴스를 초기화합니다.[`SVGDocument`](../) 클래스.
...
의 새 인스턴스를 초기화합니다.[`SVGDocument`](../) 수업. 생성자는 동기적으로 작동하며 모든 외부 리소스(이미지, 스크립트 등)의 로드를 기다립니다. 문서를 비동기적으로 로드하려면 메소드를 사용하십시오.[`Navigate`](../../../aspose.html.dom/document/navigate/) 또는 과부하. 또는 다음에서 적절한 플래그를 설정하여 일부 외부 리소스의 로드를 비활성화할 수 있습니다.[`Security`](../../../aspose.html.dom/ibrowsingcontext/security/) .
...
의 새 인스턴스를 초기화합니다.[`SVGDocument`](../) 수업. 생성자는 동기적으로 작동하며 모든 외부 리소스(이미지, 스크립트 등)의 로드를 기다립니다. 문서를 비동기적으로 로드하려면 메소드를 사용하십시오.[`Navigate`](../../../aspose.html.dom/document/navigate/) 또는 과부하. 또는 다음에서 적절한 플래그를 설정하여 일부 외부 리소스의 로드를 비활성화할 수 있습니다.[`Security`](../../../aspose.html.dom/ibrowsingcontext/security/) . 스트림의 현재 위치에서 문서 로드가 시작됩니다.
