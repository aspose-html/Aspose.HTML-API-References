...
description: Aspose.Html.Dom.XPath.XPathResultType 열거형. 결과 유형을 나타내는 부호 없는 short입니다. 특정 유형지정되면 결과는 필요하고 가능한 경우 XPath 유형 변환을 사용하여 해당 유형으로 반환됩니다.
type: docs
weight: 2610
url: /ko/net/aspose.html.dom.xpath/xpathresulttype/
---
