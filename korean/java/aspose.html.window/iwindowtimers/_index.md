...
| 이름 | 설명 |
| --- | --- |
| [clearInterval](../../com.aspose.html.window/iwindowtimers/clearinterval/)(int) | handle로 식별되는 setInterval()으로 설정된 타임아웃을 취소합니다. |
| [clearTimeout](../../com.aspose.html.window/iwindowtimers/cleartimeout/)(int) | handle로 식별되는 setTimeout()으로 설정된 타임아웃을 취소합니다. |
