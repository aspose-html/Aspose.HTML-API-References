...
description: "com.aspose.html.window.MediaQueryList 클래스. MediaQueryList 객체는 문서에 적용된 미디어 쿼리 정보를 저장하며, 문서 상태에 대한 즉시 및 이벤트 기반 매칭을 모두 지원합니다. CSSOM View Module 사양 https//www.w3.org/TR/cssom-view/the-mediaquerylist-interface을 참조하십시오."
type: docs
...
MediaQueryList 객체는 문서에 적용된 미디어 쿼리에 대한 정보를 저장하며, 문서 상태에 대한 즉시 및 이벤트 기반 매칭을 모두 지원합니다. CSSOM View Module 사양을 참조하십시오: [https://www.w3.org/TR/cssom-view/#the-mediaquerylist-interface](https://www.w3.org/TR/cssom-view/#the-mediaquerylist-interface)
...
| [getMatches](../../com.aspose.html.window/mediaquerylist/matches/) 문서가 현재 미디어 쿼리 리스트와 일치하면 true, 그렇지 않으면 false를 반환하는 부울 값. |
