...
description: "IXPathEvaluator 메서드. 해석된 패키지를 포함한 파싱된 XPath 식을 생성합니다. 이 식을 애플리케이션에서 재사용할 경우, 식 문자열을 보다 효율적인 내부 형태로 컴파일하고 식 내에 발생하는 모든 패키지 접두사를 미리 해석할 수 있게 해주므로 유용합니다."
type: docs
