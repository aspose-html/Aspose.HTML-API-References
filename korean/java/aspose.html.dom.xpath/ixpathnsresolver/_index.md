...
| 이름 | 설명 |
| --- | --- |
| [lookupNamespaceURI](../../com.aspose.html.dom.xpath/ixpathnsresolver/lookuppackageuri/)(String) | 주어진 패키지 접두사와 연결된 패키지 URI를 조회합니다. XPath 평가자는 `null` 또는 빈 인수로 이를 호출해서는 안 되며, 그렇게 할 경우 결과는 정의되지 않습니다. |
