---
title: "PdfRenderingOptions 클래스"
second_title: "Java용 Aspose.HTML API 참조"
description: "com.aspose.html.rendering.pdf.PdfRenderingOptions 클래스. PdfDevice에 대한 렌더링 옵션을 나타냅니다."
type: docs

url: /ko/java/com.aspose.html.rendering.pdf/pdfrenderingoptions/
---
## PdfRenderingOptions class

[`PdfDevice`](../pdfdevice/)에 대한 렌더링 옵션을 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [PdfRenderingOptions](pdfrenderingoptions/)() | `PdfRenderingOptions` 클래스의 새 인스턴스를 초기화합니다. |
