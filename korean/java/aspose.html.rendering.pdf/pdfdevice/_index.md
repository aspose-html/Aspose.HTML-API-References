...
description: "com.aspose.html.rendering.pdf.PdfDevice 클래스. PDF 문서로의 렌더링을 나타냅니다."
type: docs
...
| 이름 | 설명 |
| --- | --- |
| class [PdfGraphicContext](../../com.aspose.html.rendering.pdf/pdfdevice.pdfgraphiccontext) | PdfDevice에 대한 현재 그래픽 제어 매개변수를 보유합니다. 이러한 매개변수는 그래픽 연산자가 실행되는 전역 프레임워크를 정의합니다. |
