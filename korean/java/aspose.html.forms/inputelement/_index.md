...
| [value](../../com.aspose.html.forms/inputelement/value/) { get; set; } | 입력 요소의 'value' 속성에 직접 매핑되는 문자열 값을 나타냅니다. |
...
| [getCheckboxValue](../../com.aspose.html.forms/inputelement/getcheckboxvalue/)() | Checkbox 유형을 가진 입력 요소의 선택 상태를 반환합니다. |
...
| [getRadioValue](../../com.aspose.html.forms/inputelement/getradiovalue/)() | radio 유형을 가진 입력 요소의 선택 상태를 반환합니다. |
...
| [setCheckboxValue](../../com.aspose.html.forms/inputelement/setcheckboxvalue/)(bool) | Checkbox 유형을 가진 입력 요소의 선택 상태를 설정합니다. |
...
| [setRadioValue](../../com.aspose.html.forms/inputelement/setradiovalue/)(bool) | radio 유형을 가진 입력 요소의 선택 상태를 설정합니다. |
...
| [setUrlValue](../../com.aspose.html.forms/inputelement/seturlvalue/)(Url) | 이 메서드는 [`Url`](../../com.aspose.html/url/) 객체를 입력 요소의 값으로 설정하는 데 사용됩니다. 이 메서드는 입력 요소의 유형이 "url"인 경우에만 유효합니다. |
| [setWeekValue](../../com.aspose.html.forms/inputelement/setweekvalue/)(String) | 이 메서드는 'week' 문자열을 입력 요소의 값으로 설정하는 데 사용됩니다. 이 메서드는 입력 요소의 유형이 "week"인 경우에만 유효합니다. |
