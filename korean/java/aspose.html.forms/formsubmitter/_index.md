...
| [FormSubmitter](formsubmitter/#constructor_3)(HTMLFormElement) | `FormSubmitter` 클래스의 새 인스턴스를 [`HTMLFormElement`](../../com.aspose.html/htmlformelement/)를 기반으로 초기화합니다. |
| [FormSubmitter](formsubmitter/#constructor_1)(HTMLDocument, int) | [`HTMLDocument`](../../com.aspose.html/htmldocument/)에서 인덱스로 선택한 [`HTMLFormElement`](../../com.aspose.html/htmlformelement/)를 기반으로 `FormSubmitter` 클래스의 새 인스턴스를 초기화합니다. |
| [FormSubmitter](formsubmitter/#constructor_2)(HTMLDocument, String) | [`HTMLDocument`](../../com.aspose.html/htmldocument/)에서 식별자로 선택한 [`HTMLFormElement`](../../com.aspose.html/htmlformelement/)를 기반으로 `FormSubmitter` 클래스의 새 인스턴스를 초기화합니다. |
