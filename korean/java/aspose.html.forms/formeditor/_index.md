...
description: "com.aspose.html.forms.FormEditor 클래스. 이 클래스는 HTMLFormElement 위의 편집기를 나타내며, .net 개발자가 HTML 폼을 보다 쉽게 편집할 수 있도록 합니다."
type: docs
...
이 클래스는 [`HTMLFormElement`](../../com.aspose.html/htmlformelement/) 위의 편집기를 나타내며, .net 개발자가 HTML 폼을 보다 쉽게 편집할 수 있도록 합니다.
...
| 이름 | 설명 |
| --- | --- |
| static [Create](../../com.aspose.html.forms/formeditor/create/#create_2)(HTMLFormElement) | 새로운 `FormEditor`를 [`HTMLFormElement`](../../com.aspose.html/htmlformelement/)을 기반으로 생성합니다. |
| static [Create](../../com.aspose.html.forms/formeditor/create/#create)(HTMLDocument, int) | 인덱스로 선택된 [`Forms`](../../com.aspose.html/htmldocument/forms/) 컬렉션에서 [`HTMLFormElement`](../../com.aspose.html/htmlformelement/)을 기반으로 새로운 `FormEditor`를 생성합니다. |
...
| static [CreateNew](../../com.aspose.html.forms/formeditor/createnew/)(HTMLDocument) | 새로운 [`HTMLFormElement`](../../com.aspose.html/htmlformelement/)를 생성하고 이를 `FormEditor`와 연결합니다. [`HTMLFormElement`](../../com.aspose.html/htmlformelement/)은 문서와 분리된 상태로 생성되며, 문서에 첨부하려면 적절한 위치를 선택하고 [`AppendChild`](../../com.aspose.html.dom/node/appendchild/) 메서드를 사용하십시오. |
| [Add&lt;T&gt;](../../com.aspose.html.forms/formeditor/add/)(String) | 새로운 [`HTMLElement`](../../com.aspose.html/htmlelement/)를 생성하고 폼 끝에 추가합니다. |
| [addInput](../../com.aspose.html.forms/formeditor/addinput/#addinput)(String) | 새로운 [`InputElement`](../inputelement/)를 생성하고 폼 끝에 추가합니다. |
| [addInput](../../com.aspose.html.forms/formeditor/addinput/#addinput_1)(String, InputElementType) | 새로운 [`InputElement`](../inputelement/)를 생성하고 폼 끝에 추가합니다. |
