...
description: "FormEditor 메서드. HTMLFormElement를 기반으로 새로운 FormEditor를 생성합니다."
type: docs
...
새로운 [`FormEditor`](../)를 [`HTMLFormElement`](../../../com.aspose.html/htmlformelement/)를 기반으로 생성합니다.
...
새로운 [`FormEditor`](../) 클래스 인스턴스를 반환합니다.
...
인덱스로 선택된 [`Forms`](../../../com.aspose.html/htmldocument/forms/) 컬렉션에서 [`HTMLFormElement`](../../../com.aspose.html/htmlformelement/)를 기반으로 새로운 [`FormEditor`](../)를 생성합니다.
...
문서에서 ID로 선택된 [`HTMLFormElement`](../../../com.aspose.html/htmlformelement/)를 기반으로 새로운 [`FormEditor`](../)를 생성합니다.
