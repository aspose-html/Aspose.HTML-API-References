...
description: "INodeIterator method. 집합에서 다음 노드를 반환하고 반복자의 위치를 집합 내에서 앞으로 이동시킵니다. NodeIterator가 생성된 후 첫 번째 nextNode 호출은 집합의 첫 번째 노드를 반환합니다."
type: docs
...
반복 중인 집합에서 다음 노드이며, 더 이상 멤버가 없으면 null을 반환합니다.
