...
description: "com.aspose.html.dom.events.MouseEvent 클래스. MouseEvent 인터페이스는 마우스 이벤트와 연관된 구체적인 컨텍스트 정보를 제공합니다."
type: docs
...
| 이름 | 설명 |
| --- | --- |
| [MouseEvent](mouseevent/#constructor)(String) | `MouseEvent` 클래스의 새 인스턴스를 초기화합니다. |
