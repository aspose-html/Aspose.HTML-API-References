...
| 이름 | 설명 |
| --- | --- |
| [InputEvent](inputevent/#constructor)(String) | 새로운 `InputEvent` 클래스 인스턴스를 초기화합니다. |
...
| [getIsComposing](../../com.aspose.html.dom.events/inputevent/iscomposing/) 입력 이벤트가 구성 세션의 일부로 발생하는 경우, 즉 compositionstart 이벤트 이후 및 해당 compositionend 이벤트 이전인 경우 true입니다. 이 속성의 초기화되지 않은 값은 false이어야 합니다. |
