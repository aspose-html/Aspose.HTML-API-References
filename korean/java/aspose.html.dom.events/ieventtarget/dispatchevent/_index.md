...
description: "IEventTarget 메서드. 지정된 EventTarget에서 Event를 동기적으로 디스패치하며, 영향을 받은 EventListener들을 적절한 순서대로 호출합니다. 캡처링 및 선택적 버블링 단계를 포함한 일반적인 이벤트 처리 규칙이 dispatchEvent로 수동 디스패치된 이벤트에도 적용됩니다."
type: docs
