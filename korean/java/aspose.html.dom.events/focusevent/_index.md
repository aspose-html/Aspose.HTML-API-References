...
| 이름 | 설명 |
| --- | --- |
| [FocusEvent](focusevent/#constructor)(String) | `FocusEvent` 클래스의 새 인스턴스를 초기화합니다. |
...
| [getRelatedTarget](../../com.aspose.html.dom.events/focusevent/relatedtarget/) 포커스 이벤트와 관련된 보조 EventTarget을 식별하는 데 사용됩니다(이벤트 유형에 따라). |
