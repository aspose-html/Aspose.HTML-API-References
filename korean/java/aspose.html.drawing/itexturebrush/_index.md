...
| 이름 | 설명 |
| --- | --- |
| [getColorMap](../../com.aspose.html.drawing/itexturebrush/colormap/) 요소의 개수는 짝수여야 합니다. 짝수 요소는 기존 색상이고, 홀수 요소는 새로운 색상입니다. |
| [getImage](../../com.aspose.html.drawing/itexturebrush/image/) 브러시에서 사용하는 이미지를 가져오거나 설정합니다. |
| [getImageArea](../../com.aspose.html.drawing/itexturebrush/imagearea/) 브러시가 사용하는 이미지의 영역을 지정합니다. RectangleF.Empty와 같으면 전체 이미지를 사용합니다. 좌표는 픽셀 단위입니다. |
[getOpacity]
