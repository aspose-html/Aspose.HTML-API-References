...
| 이름 | 설명 |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/tablesyntaxnode/accept/)(MarkdownSyntaxVisitor) | 방문자 수용을 위한 인터페이스를 정의합니다. |
...
| [getAlignment](../../com.aspose.html.toolkit.markdown.syntax/tablesyntaxnode/getalignment/)() | aligment 가져오기를 위한 인터페이스를 정의합니다. |
| [getBodyRows](../../com.aspose.html.toolkit.markdown.syntax/tablesyntaxnode/getbodyrows/)() | 본문 행을 가져오는 인터페이스를 정의합니다. |
| [getHeader](../../com.aspose.html.toolkit.markdown.syntax/tablesyntaxnode/getheader/)() | 테이블 헤더를 가져오는 인터페이스를 정의합니다. |
