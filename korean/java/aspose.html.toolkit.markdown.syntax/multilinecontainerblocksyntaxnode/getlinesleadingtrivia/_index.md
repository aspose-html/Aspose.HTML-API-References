...
description: "MultiLineContainerBlockSyntaxNode 메서드. 앞 트리비아 라인을 가져오기 위한 인터페이스를 정의합니다."
type: docs

url: /ko/java/com.aspose.html.toolkit.markdown.syntax/multilinecontainerblocksyntaxnode/getlinesleadingtrivia/
---
## MultiLineContainerBlockSyntaxNode.GetLinesLeadingTrivia method

줄 앞의 트리비아를 가져오는 인터페이스를 정의합니다.
