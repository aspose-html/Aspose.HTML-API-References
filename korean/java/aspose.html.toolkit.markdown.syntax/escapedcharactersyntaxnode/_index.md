---
title: "EscapedCharacterSyntaxNode 클래스"
second_title: "Java용 Aspose.HTML API 참조"
description: "com.aspose.html.toolkit.markdown.syntax.EscapedCharacterSyntaxNode 클래스. 이스케이프 문자 구문 노드를 구현했습니다."
type: docs

url: /ko/java/com.aspose.html.toolkit.markdown.syntax/escapedcharactersyntaxnode/
---
## EscapedCharacterSyntaxNode class

escape character 구문 노드를 구현했습니다.
...
| [getSource](../../com.aspose.html.toolkit.markdown.syntax/textsyntaxnode/source/) 소스 텍스트를 반환합니다. |
| [getSpan](../../com.aspose.html.toolkit.markdown.syntax/textsyntaxnode/span/) span을 가져오는 인터페이스를 정의합니다. |
| [getValue](../../com.aspose.html.toolkit.markdown.syntax/textsyntaxnode/value/) 문자열 값을 가져오는 속성을 정의합니다. |

## 메서드

| 이름 | 설명 |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/escapedcharactersyntaxnode/accept/)(MarkdownSyntaxVisitor) | 방문자를 수락하기 위한 인터페이스를 정의합니다. |
