...
| 이름 | 설명 |
| --- | --- |
| abstract [getCount](../../com.aspose.html.toolkit.markdown.syntax/nodelist-1/count/) 리스트에 있는 노드 수를 가져옵니다. |

## 메서드

| 이름 | 설명 |
| --- | --- |
| abstract [Get](../../com.aspose.html.toolkit.markdown.syntax/nodelist-1/get/)(int) | 지정된 인덱스에 있는 노드를 가져옵니다. |
