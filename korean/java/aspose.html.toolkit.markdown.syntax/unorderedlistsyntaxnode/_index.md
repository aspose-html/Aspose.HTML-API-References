---
title: "UnorderedListSyntaxNode 클래스"
second_title: "Java용 Aspose.HTML API 참조"
description: "com.aspose.html.toolkit.markdown.syntax.UnorderedListSyntaxNode 클래스. 순서 없는 리스트 구문 노드를 나타냅니다."
type: docs

url: /ko/java/com.aspose.html.toolkit.markdown.syntax/unorderedlistsyntaxnode/
---
## UnorderedListSyntaxNode class

정렬되지 않은 목록 구문 노드를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/unorderedlistsyntaxnode/accept/)(MarkdownSyntaxVisitor) | 구문 노드를 방문하기 위한 인터페이스를 정의합니다. |
...
| [getMarker](../../com.aspose.html.toolkit.markdown.syntax/unorderedlistsyntaxnode/getmarker/)() | 마커를 가져오는 인터페이스를 정의합니다. |
