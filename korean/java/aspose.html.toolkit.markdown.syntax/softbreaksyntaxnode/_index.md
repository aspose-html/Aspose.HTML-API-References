...
description: "com.aspose.html.toolkit.markdown.syntax.SoftBreakSyntaxNode 클래스. 소프트 브레이크 구문을 나타냅니다."
type: docs
...
| 이름 | 설명 |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/softbreaksyntaxnode/accept/)(MarkdownSyntaxVisitor) | 방문자 수락을 위한 인터페이스를 정의합니다. |
