...
| 이름 | 설명 |
| --- | --- |
| [accept](../../com.aspose.html.toolkit.markdown.syntax/paragraphsyntaxnode/accept/)(MarkdownSyntaxVisitor) | 방문자 수용을 위한 인터페이스를 정의합니다. |
...
| [getContent](../../com.aspose.html.toolkit.markdown.syntax/paragraphsyntaxnode/getcontent/)() | 콘텐츠를 가져오는 인터페이스를 정의합니다. |
