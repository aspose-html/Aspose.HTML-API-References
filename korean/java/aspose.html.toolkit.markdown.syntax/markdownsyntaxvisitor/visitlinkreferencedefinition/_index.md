...
description: "MarkdownSyntaxVisitor 메서드. LinkReferenceDefinitionSyntax 방문을 위한 인터페이스를 정의합니다."
type: docs
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| 정의 | LinkReferenceDefinitionSyntaxNode | LinkReferenceDefinitionSyntax입니다. |
