---
title: "SVGPathSegCurvetoQuadraticAbs 클래스"
second_title: "Aspose.HTML for Java API 참조"
description: "com.aspose.html.dom.svg.paths.SVGPathSegCurvetoQuadraticAbs 클래스. SVGPathSegCurvetoQuadraticAbs 인터페이스는 절대적인 2차 베지어 curveto Q 경로 데이터 명령에 해당합니다."
type: docs

url: /ko/java/com.aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticabs/
---
## SVGPathSegCurvetoQuadraticAbs class

SVGPathSegCurvetoQuadraticAbs 인터페이스는 "절대 2차 베지어 curveto" (Q) 경로 데이터 명령에 해당합니다.
...
| [X](../../com.aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticabs/x/) { get; set; } | 이 경로 세그먼트의 끝점에 대한 절대 X 좌표입니다. |
[getX1]
[setX1] The absolute X coordinate for the first control point. |
| [Y](../../com.aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticabs/y/) { get; set; } | 이 경로 세그먼트의 끝점에 대한 절대 Y 좌표입니다. |
[getY1]
