---
title: "SVGPathSegLinetoVerticalRel 클래스"
second_title: "Java용 Aspose.HTML API 참조"
description: "com.aspose.html.dom.svg.paths.SVGPathSegLinetoVerticalRel 클래스. SVGPathSegLinetoVerticalRel 인터페이스는 상대 수직 lineto v 경로 데이터 명령에 해당합니다."
type: docs

url: /ko/java/com.aspose.html.dom.svg.paths/svgpathseglinetoverticalrel/
---
## SVGPathSegLinetoVerticalRel class

SVGPathSegLinetoVerticalRel 인터페이스는 "relative vertical lineto" (v) 경로 데이터 명령에 해당합니다.
...
| [Y](../../com.aspose.html.dom.svg.paths/svgpathseglinetoverticalrel/y/) { get; set; } | 이 경로 세그먼트 끝점의 상대 Y 좌표입니다. |
