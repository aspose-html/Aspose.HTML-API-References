---
title: "SVGPathSegLinetoHorizontalRel 클래스"
second_title: "Aspose.HTML for Java API 참조"
description: "com.aspose.html.dom.svg.paths.SVGPathSegLinetoHorizontalRel 클래스. SVGPathSegLinetoHorizontalRel 인터페이스는 상대적인 수평 lineto h 경로 데이터 명령에 해당합니다."
type: docs

url: /ko/java/com.aspose.html.dom.svg.paths/svgpathseglinetohorizontalrel/
---
## SVGPathSegLinetoHorizontalRel class

SVGPathSegLinetoHorizontalRel 인터페이스는 "relative horizontal lineto" (h) 경로 데이터 명령에 해당합니다.
...
| [X](../../com.aspose.html.dom.svg.paths/svgpathseglinetohorizontalrel/x/) { get; set; } | 이 경로 세그먼트 끝점의 상대 X 좌표입니다. |
