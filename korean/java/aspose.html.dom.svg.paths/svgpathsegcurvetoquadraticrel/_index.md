---
title: "SVGPathSegCurvetoQuadraticRel 클래스"
second_title: "Aspose.HTML for Java API 참조"
description: "com.aspose.html.dom.svg.paths.SVGPathSegCurvetoQuadraticRel 클래스. SVGPathSegCurvetoQuadraticRel 인터페이스는 상대적인 2차 베지어 curveto q 경로 데이터 명령에 해당합니다."
type: docs

url: /ko/java/com.aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticrel/
---
## SVGPathSegCurvetoQuadraticRel class

SVGPathSegCurvetoQuadraticRel 인터페이스는 "relative quadratic Bézier curveto" (q) 경로 데이터 명령에 해당합니다.
...
| [X](../../com.aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticrel/x/) { get; set; } | 이 경로 세그먼트 끝점의 상대 X 좌표입니다. |
[getX1]
[setX1] The relative X coordinate for the first control point. |
| [Y](../../com.aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticrel/y/) { get; set; } | 이 경로 세그먼트 끝점의 상대 Y 좌표입니다. |
[getY1]
