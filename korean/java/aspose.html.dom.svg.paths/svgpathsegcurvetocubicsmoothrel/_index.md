...
description: "com.aspose.html.dom.svg.paths.SVGPathSegCurvetoCubicSmoothRel 클래스. SVGPathSegCurvetoCubicSmoothRel 인터페이스는 상대 부드러운 큐빅 curveto s 경로 데이터 명령에 해당합니다."
type: docs
...
SVGPathSegCurvetoCubicSmoothRel 인터페이스는 "상대 스무스 큐빅 커브투" (s) 경로 데이터 명령에 해당합니다.
