---
title: "SVGPathSegCurvetoCubicSmoothRel 클래스"
second_title: "Aspose.HTML for Java API 참조"
description: "com.aspose.html.dom.svg.paths.SVGPathSegCurvetoCubicSmoothRel 클래스. SVGPathSegCurvetoCubicSmoothRel 인터페이스는 상대적인 부드러운 큐빅 curveto s 경로 데이터 명령에 해당합니다."
type: docs

url: /ko/java/com.aspose.html.dom.svg.paths/svgpathsegcurvetocubicsmoothrel/
---
## SVGPathSegCurvetoCubicSmoothRel class

SVGPathSegCurvetoCubicSmoothRel 인터페이스는 "상대 스무스 큐빅 curveto" (s) 경로 데이터 명령에 해당합니다.
...
| [X](../../com.aspose.html.dom.svg.paths/svgpathsegcurvetocubicsmoothrel/x/) { get; set; } | 이 경로 세그먼트 끝점의 상대 X 좌표입니다. |
[getX2]
[setX2] The relative X coordinate for the second control point. |
| [Y](../../com.aspose.html.dom.svg.paths/svgpathsegcurvetocubicsmoothrel/y/) { get; set; } | 이 경로 세그먼트 끝점의 상대 Y 좌표입니다. |
[getY2]
