---
title: "SVGPathSegList 클래스"
second_title: "Java용 Aspose.HTML API 참조"
description: "com.aspose.html.dom.svg.paths.SVGPathSegList 클래스. 이 인터페이스는 SVGPathSeg 객체들의 목록을 정의합니다."
type: docs

url: /ko/java/com.aspose.html.dom.svg.paths/svgpathseglist/
---
## SVGPathSegList class

이 인터페이스는 SVGPathSeg 객체 목록을 정의합니다.
...
| 이름 | 설명 |
| --- | --- |
| [SVGPathSegList](svgpathseglist/#constructor)() | `SVGPathSegList` 클래스의 새 인스턴스를 초기화합니다. |
| [SVGPathSegList](svgpathseglist/#constructor_1)(IEnumerable&lt;SVGPathSeg&gt;) | `SVGPathSegList` 클래스의 새 인스턴스를 초기화합니다. |
