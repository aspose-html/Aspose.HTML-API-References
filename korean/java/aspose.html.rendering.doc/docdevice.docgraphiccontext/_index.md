...
description: "com.aspose.html.rendering.doc.DocDeviceDocGraphicContext 클래스. DocDevice에 대한 현재 그래픽 제어 매개변수를 보유합니다. 이 매개변수들은 그래픽 연산자가 실행되는 전역 프레임워크를 정의합니다."
type: docs
...
DocDevice에 대한 현재 그래픽 제어 매개변수를 보유합니다. 이 매개변수들은 그래픽 연산자가 실행되는 전역 프레임워크를 정의합니다.
