...
description: "SVGListBase 메서드. 지정된 위치에 새 항목을 리스트에 삽입합니다. 첫 번째 항목은 번호 0입니다."
type: docs
...
| index | UInt64 | 새 항목을 삽입할 대상 항목 앞의 인덱스입니다. 첫 번째 항목은 번호 0입니다. 인덱스가 0이면 새 항목이 리스트 앞에 삽입됩니다. 인덱스가 numberOfItems보다 크거나 같으면 새 항목이 리스트 끝에 추가됩니다. |
