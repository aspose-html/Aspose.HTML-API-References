...
이 인터페이스는 모든 SVG 목록의 기본 리스트를 정의합니다.
...
| [clear](../../com.aspose.html.dom.svg.collections/svglistbase-1/clear/)() | 목록에서 기존 모든 현재 항목을 제거하여 빈 목록이 됩니다. |
...
| [initialize](../../com.aspose.html.dom.svg.collections/svglistbase-1/initialize/)(T) | 목록에서 기존 모든 현재 항목을 제거하고 매개변수로 지정된 단일 항목을 보관하도록 목록을 다시 초기화합니다. |
