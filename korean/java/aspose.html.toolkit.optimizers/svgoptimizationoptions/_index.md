---
title: "SVGOptimizationOptions 클래스"
second_title: "Aspose.HTML for Java API 참조"
description: "com.aspose.html.toolkit.optimizers.SVGOptimizationOptions 클래스. SVGOptimizationOptions는 SVG 문서를 최적화하기 위한 옵션을 저장하는 클래스입니다."
type: docs

url: /ko/java/com.aspose.html.toolkit.optimizers/svgoptimizationoptions/
---
## SVGOptimizationOptions class

SVGOptimizationOptions는 SVG 문서를 최적화하기 위한 옵션을 저장하는 클래스입니다.
...
| 이름 | 설명 |
| --- | --- |
| [SVGOptimizationOptions](svgoptimizationoptions/)() | 새 `SVGOptimizationOptions` 클래스 인스턴스를 초기화합니다. |
