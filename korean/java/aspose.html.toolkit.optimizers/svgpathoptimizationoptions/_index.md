---
title: "SVGPathOptimizationOptions 클래스"
second_title: "Java용 Aspose.HTML API 참조"
description: "com.aspose.html.toolkit.optimizers.SVGPathOptimizationOptions 클래스. SVGPathOptimizationOptions는 SVG 경로 요소의 세그먼트를 최적화하기 위한 옵션을 저장하는 클래스입니다"
type: docs

url: /ko/java/com.aspose.html.toolkit.optimizers/svgpathoptimizationoptions/
---
## SVGPathOptimizationOptions class

SVGPathOptimizationOptions는 SVG 경로 요소의 세그먼트를 최적화하기 위한 옵션을 저장하는 클래스입니다.
...
| 이름 | 설명 |
| --- | --- |
| [SVGPathOptimizationOptions](svgpathoptimizationoptions/)() | 새 `SVGPathOptimizationOptions` 클래스 인스턴스를 초기화합니다. |
