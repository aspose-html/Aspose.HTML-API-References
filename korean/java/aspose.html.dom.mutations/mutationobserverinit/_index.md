...
| [remove](../../com.aspose.html.dom.mutations/mutationobserverinit/remove/#remove_1)(String) | 지정된 키와 연관된 값을 `MutationObserverInit` 컬렉션에서 제거합니다. |
| [tryGetValue](../../com.aspose.html.dom.mutations/mutationobserverinit/trygetvalue/)(String, out object) | 지정된 키와 연관된 값을 가져옵니다. |
