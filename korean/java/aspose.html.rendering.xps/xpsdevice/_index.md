...
| [XpsDevice](xpsdevice/#constructor_1)(XpsRenderingOptions, ICreateStreamProvider) | 렌더링 옵션 및 스트림 공급자를 사용하여 `XpsDevice` 클래스의 새 인스턴스를 초기화합니다. |
...
| 이름 | 설명 |
| --- | --- |
| class [XpsGraphicContext](../../com.aspose.html.rendering.xps/xpsdevice.xpsgraphiccontext) | XpsDevice의 현재 그래픽 제어 매개변수를 보유합니다. 이러한 매개변수는 그래픽 연산자가 실행되는 전역 프레임워크를 정의합니다. |
