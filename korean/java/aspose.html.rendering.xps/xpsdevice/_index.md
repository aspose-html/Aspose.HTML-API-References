...
description: "com.aspose.html.rendering.xps.XpsDevice 클래스. XPS 문서에 대한 렌더링을 나타냅니다."
type: docs

url: /ko/java/com.aspose.html.rendering.xps/xpsdevice/
---
## XpsDevice class
...
| 이름 | 설명 |
| --- | --- |
| [XpsDevice](xpsdevice/#constructor)(ICreateStreamProvider) | `XpsDevice` 클래스의 새 인스턴스를 초기화합니다. |
| [XpsDevice](xpsdevice/#constructor_4)(Stream) | `XpsDevice` 클래스의 새 인스턴스를 초기화합니다. |
| [XpsDevice](xpsdevice/#constructor_5)(String) | `XpsDevice` 클래스의 새 인스턴스를 초기화합니다. |
| [XpsDevice](xpsdevice/#constructor_1)(XpsRenderingOptions, ICreateStreamProvider) | 렌더링 옵션 및 스트림 제공자를 사용하여 `XpsDevice` 클래스의 새 인스턴스를 초기화합니다. |
| [XpsDevice](xpsdevice/#constructor_2)(XpsRenderingOptions, Stream) | 렌더링 옵션 및 출력 스트림을 사용하여 `XpsDevice` 클래스의 새 인스턴스를 초기화합니다. |
| [XpsDevice](xpsdevice/#constructor_3)(XpsRenderingOptions, String) | 렌더링 옵션 및 출력 파일 이름을 사용하여 `XpsDevice` 클래스의 새 인스턴스를 초기화합니다. |
...
| 이름 | 설명 |
| --- | --- |
| class [XpsGraphicContext](../../com.aspose.html.rendering.xps/xpsdevice.xpsgraphiccontext) | XpsDevice에 대한 현재 그래픽 제어 매개변수를 보유합니다. 이러한 매개변수는 그래픽 연산자가 실행되는 전역 프레임워크를 정의합니다. |
