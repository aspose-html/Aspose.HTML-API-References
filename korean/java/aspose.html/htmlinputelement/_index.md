---
title: "HTMLInputElement 클래스"
second_title: "Aspose.HTML for Java API 참조"
description: "com.aspose.html.HTMLInputElement 클래스. 폼 컨트롤. 페이지가 표시되는 환경에 따라 파일 업로드 입력 유형의 value 속성이 읽기 전용일 수 있습니다. 비밀번호 입력 유형의 경우 실제 반환값이 마스킹되어 무단 사용을 방지할 수 있습니다. HTML 4.01의 INPUT 요소 정의를 참조하십시오. 또한 Document Object Model DOM Level 2 HTML 사양을 참조하십시오."
type: docs

url: /ko/java/com.aspose.html/htmlinputelement/
---
## HTMLInputElement class

폼 컨트롤입니다. 페이지가 표시되는 환경에 따라 파일 업로드 입력 유형의 value 속성이 읽기 전용일 수 있습니다. "password" 입력 유형의 경우, 실제 반환값이 마스킹되어 무단 사용을 방지할 수 있습니다. [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224)]의 INPUT 요소 정의를 참조하십시오. 또한 [Document object Model (DOM) Level 2 HTML Specification](http://www.w3.org/TR/2003/REC-DOM-Level-2-HTML-20030109)을 참조하십시오.
...
| [getFiles](../../com.aspose.html/htmlinputelement/files/) files IDL 속성을 통해 스크립트가 요소의 선택된 파일에 접근할 수 있습니다. 가져올 때 IDL 속성이 적용되면 현재 선택된 파일을 나타내는 FileList 객체를 반환해야 합니다. 선택된 파일 목록이 변경될 때까지 동일한 객체가 반환됩니다. IDL 속성이 적용되지 않으면 대신 null을 반환해야 합니다. [FILEAPI] |
