---
title: "HTMLObjectElement 클래스"
second_title: "Aspose.HTML for Java API 참조"
description: "com.aspose.html.HTMLObjectElement 클래스. 일반적인 임베디드 객체. 원칙적으로 객체 요소의 모든 속성은 읽기-쓰기 가능하지만 일부 환경에서는 기본 객체가 인스턴스화된 후 일부 속성이 읽기 전용이 될 수 있습니다. HTML 4.01의 OBJECT 요소 정의를 참조하십시오."
type: docs

url: /ko/java/com.aspose.html/htmlobjectelement/
---
## HTMLObjectElement class

일반적인 임베디드 객체입니다. 원칙적으로 object 요소의 모든 속성은 읽기-쓰기 가능하지만 일부 환경에서는 기본 객체가 인스턴스화된 후 일부 속성이 읽기 전용이 될 수 있습니다. [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224)]에서 OBJECT 요소 정의를 참조하십시오.
