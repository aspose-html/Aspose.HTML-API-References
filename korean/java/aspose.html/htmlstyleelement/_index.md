---
title: "HTMLStyleElement 클래스"
second_title: "Aspose.HTML for Java API 참조"
description: "com.aspose.html.HTMLStyleElement 클래스. 스타일 정보. HTML 4.01의 STYLE 요소 정의와 CSS 모듈 DOM Level 2 Style Sheets 및 CSS, 그리고 StyleSheets 모듈 DOM Level 2 Style Sheets 및 CSS의 LinkStyle 인터페이스를 참조하십시오."
type: docs

url: /ko/java/com.aspose.html/htmlstyleelement/
---
## HTMLStyleElement class

스타일 정보입니다. HTML 4.01의 STYLE 요소 정의, CSS 모듈 [[DOM Level 2 Style Sheets and CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113)] 및 StyleSheets 모듈의 `LinkStyle` 인터페이스 [[DOM Level 2 Style Sheets and CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113)]를 참조하십시오.
...
| [getSheet](../../com.aspose.html/htmlstyleelement/sheet/) 연결된 스타일 시트를 가져옵니다. |
