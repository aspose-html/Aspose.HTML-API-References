---
title: "HTMLTableColElement 클래스"
second_title: "Aspose.HTML for Java API 참조"
description: "com.aspose.html.HTMLTableColElement 클래스. COL 및 COLGROUP 요소를 재그룹화합니다. HTML 4.01의 COL 요소 정의를 참조하십시오."
type: docs

url: /ko/java/com.aspose.html/htmltablecolelement/
---
## HTMLTableColElement class

`COL` 및 `COLGROUP` 요소를 다시 그룹화합니다. HTML 4.01의 COL 요소 정의를 참조하십시오.
