---
title: "HTMLTableCellElement 클래스"
second_title: "Aspose.HTML for Java API 참조"
description: "com.aspose.html.HTMLTableCellElement 클래스. TH 및 TD 요소를 나타내는 데 사용되는 객체입니다. HTML 4.01의 TD 요소 정의를 참조하십시오."
type: docs

url: /ko/java/com.aspose.html/htmltablecellelement/
---
## HTMLTableCellElement class

`TH` 및 `TD` 요소를 나타내는 객체입니다. HTML 4.01의 TD 요소 정의를 참조하십시오.
...
| [getCellIndex](../../com.aspose.html/htmltablecellelement/cellindex/) 이 셀의 행 내 인덱스로, 0부터 시작합니다. 이 인덱스는 문서 트리 순서이며 표시 순서는 아닙니다. |
[getCh]
