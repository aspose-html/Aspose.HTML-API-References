---
title: "HTMLFieldSetElement 클래스"
second_title: "Aspose.HTML for Java API 참조"
description: "com.aspose.html.HTMLFieldSetElement 클래스. 폼 컨트롤을 논리적 그룹으로 조직합니다. HTML 4.01의 FIELDSET 요소 정의를 참조하십시오"
type: docs

url: /ko/java/com.aspose.html/htmlfieldsetelement/
---
## HTMLFieldSetElement class

폼 컨트롤을 논리적 그룹으로 조직합니다. HTML 4.01의 FIELDSET 요소 정의를 참조하십시오.
...
| [getForm](../../com.aspose.html/htmlfieldsetelement/form/) 이 컨트롤을 포함하는 `FORM` 요소를 반환합니다. 이 컨트롤이 폼 컨텍스트 내에 없으면 `null`을 반환합니다. |
[getId]
