---
title: "HTMLCanvasElement 클래스"
second_title: "Aspose.HTML for Java API 참조"
description: "com.aspose.html.HTMLCanvasElement 클래스. HTMLCanvasElement 인터페이스는 캔버스 요소의 레이아웃 및 표현을 조작하기 위한 속성과 메서드를 제공합니다. 또한 HTMLCanvasElement 인터페이스는 HTMLElement 인터페이스의 속성과 메서드를 상속합니다."
type: docs

url: /ko/java/com.aspose.html/htmlcanvaselement/
---
## HTMLCanvasElement class

HTMLCanvasElement 인터페이스는 캔버스 요소의 레이아웃과 표시를 조작하기 위한 속성과 메서드를 제공합니다. HTMLCanvasElement 인터페이스는 또한 HTMLElement 인터페이스의 속성과 메서드를 상속합니다.
...
| [getContext](../../com.aspose.html/htmlcanvaselement/getcontext/)(String) | 캔버스에 대한 그리기 컨텍스트를 반환합니다. 지원되지 않는 컨텍스트 ID인 경우 null을 반환합니다. 그리기 컨텍스트를 사용하면 캔버스에 그릴 수 있습니다. |
...
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl)() | type 매개변수로 지정된 형식(기본값은 PNG)으로 이미지 표현을 포함하는 데이터 URI를 반환합니다. 반환된 이미지는 96 dpi 해상도를 가집니다. |
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl_1)(String) | type 매개변수로 지정된 형식(기본값은 PNG)으로 이미지 표현을 포함하는 데이터 URI를 반환합니다. 반환된 이미지는 96 dpi 해상도를 가집니다. |
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl_2)(String, double) | type 매개변수로 지정된 형식(기본값은 PNG)으로 이미지 표현을 포함하는 데이터 URI를 반환합니다. 반환된 이미지는 96 dpi 해상도를 가집니다. |
