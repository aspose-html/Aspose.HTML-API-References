...
description: "com.aspose.html.HTMLAppletElement 클래스. 임베드된 Java 애플릿입니다. HTML 4.01의 APPLET 요소 정의를 참조하십시오. 이 요소는 HTML 4.01에서 사용 중단되었습니다"
type: docs
...
임베드된 Java 애플릿입니다. HTML 4.01의 APPLET 요소 정의를 참조하십시오. 이 요소는 HTML 4.01에서 사용 중단되었습니다.
