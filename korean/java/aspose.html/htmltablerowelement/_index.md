---
title: "HTMLTableRowElement 클래스"
second_title: "Aspose.HTML for Java API 참조"
description: "com.aspose.html.HTMLTableRowElement 클래스. 표의 행입니다. HTML 4.01의 TR 요소 정의를 참조하십시오."
type: docs

url: /ko/java/com.aspose.html/htmltablerowelement/
---
## HTMLTableRowElement class

테이블의 행입니다. HTML 4.01의 TR 요소 정의를 참조하십시오.
...
| [getCells](../../com.aspose.html/htmltablerowelement/cells/) 이 행의 셀 컬렉션입니다. @version DOM Level 2 |
[getCh]
...
| [getRowIndex](../../com.aspose.html/htmltablerowelement/rowindex/) 이는 논리 순서이며 문서 순서는 아닙니다. `rowIndex`는 테이블 내의 섹션(`THEAD`, `TFOOT`, 또는 `TBODY`)을 고려하여 인덱스에 `THEAD` 행을 먼저 배치하고, 그 다음 `TBODY` 행, 마지막으로 `TFOOT` 행을 배치합니다. @version DOM Level 2 |
| [getSectionRowIndex](../../com.aspose.html/htmltablerowelement/sectionrowindex/) 현재 섹션(`THEAD`, `TFOOT`, 또는 `TBODY`)에 대한 이 행의 인덱스로, 0부터 시작합니다. @version DOM Level 2 |
...
| [deleteCell](../../com.aspose.html/htmltablerowelement/deletecell/)(int) | 현재 행에서 셀을 삭제합니다. |
...
| [insertCell](../../com.aspose.html/htmltablerowelement/insertcell/)(int) | 이 행에 빈 `TD` 셀을 삽입합니다. `index`가 -1이거나 셀 수와 같으면 새 셀이 추가됩니다. |
