...
description: "com.aspose.html.HTMLQuoteElement 클래스. Q 및 BLOCKQUOTE 요소에 대한 것입니다. HTML 4.01의 Q 요소 정의를 참조하십시오."
type: docs
...
`Q` 및 `BLOCKQUOTE` 요소에 대해. HTML 4.01의 Q 요소 정의를 참조하십시오.
