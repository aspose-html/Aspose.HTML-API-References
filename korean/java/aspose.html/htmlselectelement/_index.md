---
title: "HTMLSelectElement 클래스"
second_title: "Aspose.HTML for Java API 참조"
description: "com.aspose.html.HTMLSelectElement 클래스. select 요소는 옵션 선택을 허용합니다. 포함된 옵션은 select 요소를 통해 컬렉션으로 직접 접근할 수 있습니다. HTML 4.01의 SELECT 요소 정의를 참조하십시오."
type: docs

url: /ko/java/com.aspose.html/htmlselectelement/
---
## HTMLSelectElement class

select 요소는 옵션 선택을 허용합니다. 포함된 옵션은 select 요소를 통해 컬렉션으로 직접 접근할 수 있습니다. HTML 4.01의 SELECT 요소 정의를 참조하십시오.
...
| [getForm](../../com.aspose.html/htmlselectelement/form/) 이 `SELECT`의 옵션 수. |
[getId]
...
| [getOptions](../../com.aspose.html/htmlselectelement/options/) 이 요소가 포함하는 `OPTION` 요소들의 컬렉션입니다. @version DOM Level 2 |
[getOuterHTML]
...
| [getType](../../com.aspose.html/htmlselectelement/type/) 이 폼 컨트롤의 유형입니다. multiple 속성이 `true`일 때는 문자열 "select-multiple"이며, `false`일 때는 문자열 "select-one"입니다. |
[getValue]
