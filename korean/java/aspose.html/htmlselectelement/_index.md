...
select 요소는 옵션 선택을 허용합니다. 포함된 옵션은 컬렉션으로서 select 요소를 통해 직접 접근할 수 있습니다. HTML 4.01의 SELECT 요소 정의를 참조하십시오.
...
| [getOptions](../../com.aspose.html/htmlselectelement/options/) 이 요소가 포함하는 `OPTION` 요소들의 컬렉션. @version DOM Level 2 |
[getOuterHTML]
