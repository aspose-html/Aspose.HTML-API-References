...
description: "com.aspose.html.HTMLDirectoryElement 클래스. 디렉터리 목록. HTML 4.01의 DIR 요소 정의를 참조하십시오. 이 요소는 HTML 4.01에서 사용 중단되었습니다."
type: docs
...
디렉터리 목록. HTML 4.01의 DIR 요소 정의를 참조하십시오. 이 요소는 HTML 4.01에서 사용 중단되었습니다.
