...
description: "com.aspose.html.HTMLTableSectionElement 클래스. THEAD, TFOOT 및 TBODY 요소"
type: docs
...
| [insertRow](../../com.aspose.html/htmltablesectionelement/insertrow/)(int) | 이 섹션에 행을 삽입합니다. 새 행은 이 섹션의 현재 `index`번째 행 바로 앞에 삽입됩니다. `index`가 -1이거나 이 섹션의 행 수와 같으면 새 행이 추가됩니다. |
