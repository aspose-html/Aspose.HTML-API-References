---
title: "HTMLTableSectionElement 클래스"
second_title: "Aspose.HTML for Java API 참조"
description: "com.aspose.html.HTMLTableSectionElement 클래스. THEAD TFOOT 및 TBODYelements"
type: docs

url: /ko/java/com.aspose.html/htmltablesectionelement/
---
## HTMLTableSectionElement class

`THEAD`, `TFOOT`, 및 `TBODY` 요소입니다.
...
| [getRows](../../com.aspose.html/htmltablesectionelement/rows/) 이 테이블 섹션의 행 컬렉션. |
...
| [deleteRow](../../com.aspose.html/htmltablesectionelement/deleterow/)(int) | 이 섹션에서 행을 삭제합니다. |
...
| [insertRow](../../com.aspose.html/htmltablesectionelement/insertrow/)(int) | 이 섹션에 행을 삽입합니다. 새 행은 이 섹션의 현재 `index`번째 행 바로 앞에 삽입됩니다. `index`가 -1이거나 이 섹션의 행 수와 같으면 새 행이 뒤에 추가됩니다. |
