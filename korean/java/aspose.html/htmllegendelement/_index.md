---
title: "HTMLLegendElement 클래스"
second_title: "Aspose.HTML for Java API 참조"
description: "com.aspose.html.HTMLLegendElement 클래스. FIELDSET 그룹에 대한 캡션을 제공합니다. HTML 4.01의 LEGEND 요소 정의를 참조하십시오."
type: docs

url: /ko/java/com.aspose.html/htmllegendelement/
---
## HTMLLegendElement class

`FIELDSET` 그룹에 대한 캡션을 제공합니다. HTML 4.01의 LEGEND 요소 정의를 참조하십시오.
...
| [getForm](../../com.aspose.html/htmllegendelement/form/) 이 컨트롤을 포함하는 `FORM` 요소를 반환합니다. 이 컨트롤이 폼 컨텍스트에 없으면 `null`을 반환합니다. |
[getId]
