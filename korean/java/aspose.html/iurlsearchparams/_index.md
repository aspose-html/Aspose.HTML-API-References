...
description: "com.aspose.html.IUrlSearchParams 인터페이스. URL의 query String을 작업하기 위한 메서드를 제공합니다"
type: docs
...
| [set](../../com.aspose.html/iurlsearchparams/set/)(String, String) | 찾은 첫 번째 이름-값 쌍의 값을 지정된 값으로 설정하고 나머지는 제거합니다. 지정된 이름을 가진 이름-값 쌍이 없으면 새 항목이 목록에 추가됩니다. |
| [sort](../../com.aspose.html/iurlsearchparams/sort/)() | 존재하는 경우 모든 이름-값 쌍을 이름 순으로 정렬합니다. |
