---
title: "HTMLTextAreaElement 클래스"
second_title: "Aspose.HTML for Java API 참조"
description: "com.aspose.html.HTMLTextAreaElement 클래스. 다중 행 텍스트 필드입니다. HTML 4.01의 TEXTAREA 요소 정의를 참조하십시오."
type: docs

url: /ko/java/com.aspose.html/htmltextareaelement/
---
## HTMLTextAreaElement class

다중 행 텍스트 필드입니다. HTML 4.01의 TEXTAREA 요소 정의를 참조하십시오.
...
| [getForm](../../com.aspose.html/htmltextareaelement/form/) 이 컨트롤을 포함하는 `FORM` 요소를 반환합니다. 이 컨트롤이 폼 컨텍스트에 없으면 `null`을 반환합니다. |
[getId]
...
| [getType](../../com.aspose.html/htmltextareaelement/type/) 이 폼 컨트롤의 유형입니다. 문자열 "textarea"입니다. |
[getValue]
