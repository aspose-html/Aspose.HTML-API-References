---
title: "HTMLDataListElement 클래스"
second_title: "Aspose.HTML for Java API 참조"
description: "com.aspose.html.HTMLDataListElement 클래스. datalist 요소는 다른 컨트롤을 위한 사전 정의된 옵션을 나타내는 옵션 요소 집합을 나타냅니다. 또한 HTML 5.2 W3C 권고안을 참조하십시오."
type: docs

url: /ko/java/com.aspose.html/htmldatalistelement/
---
## HTMLDataListElement class

datalist 요소는 다른 컨트롤을 위한 미리 정의된 옵션을 나타내는 option 요소들의 집합을 나타냅니다. 또한 [HTML 5.2 W3C Recommendation](https://www.w3.org/TR/html52/sec-forms.html#elementdef-datalist)을 참조하십시오.
...
| [getOptions](../../com.aspose.html/htmldatalistelement/options/) 이 요소에 포함된 `OPTION` 요소들의 컬렉션입니다. |
[getOuterHTML]
