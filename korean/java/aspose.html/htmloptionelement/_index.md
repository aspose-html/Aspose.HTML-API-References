---
title: "HTMLOptionElement 클래스"
second_title: "Aspose.HTML for Java API 참조"
description: "com.aspose.html.HTMLOptionElement 클래스. 선택 가능한 옵션입니다. HTML 4.01의 OPTION 요소 정의를 참조하십시오."
type: docs

url: /ko/java/com.aspose.html/htmloptionelement/
---
## HTMLOptionElement class

선택 가능한 옵션입니다. HTML 4.01의 OPTION 요소 정의를 참조하십시오.
...
| [getForm](../../com.aspose.html/htmloptionelement/form/) 이 컨트롤을 포함하는 `FORM` 요소를 반환합니다. 이 컨트롤이 폼 컨텍스트에 없으면 `null`을 반환합니다. |
[getId]
[setId] The element's identifier. See the id attribute definition in HTML 4.01. |
| [getIndex](../../com.aspose.html/htmloptionelement/index/) 부모 `SELECT` 내에서 이 `OPTION`의 인덱스를 0부터 시작하여 반환합니다. @version DOM Level 2 |
[getInnerHTML]
...
| [getText](../../com.aspose.html/htmloptionelement/text/) 옵션 요소에 포함된 텍스트를 반환합니다. |
