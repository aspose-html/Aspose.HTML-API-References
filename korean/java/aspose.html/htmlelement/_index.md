---
title: "HTMLElement 클래스"
second_title: "Aspose.HTML for Java API 참조"
description: "com.aspose.html.HTMLElement 클래스. 모든 HTML 요소 인터페이스는 이 클래스를 상속합니다. HTML 핵심 속성만 노출하는 요소는 기본 HTMLElement 인터페이스로 표현됩니다. 이러한 요소는 다음과 같습니다: special SUB SUP SPAN BDOfont TT I B U S STRIKE BIG SMALL phrase EM STRONG DFN CODE SAMP KBD VAR CITE ACRONYM ABBRlist DD DTNOFRAMES NOSCRIPTADDRESS CENTER. HTML 요소의 style 속성은 CSS 모듈 DOM Level 2 Style Sheets 및 CSS에 정의된 ElementCSSInlineStyle 인터페이스를 통해 접근할 수 있습니다."
type: docs

url: /ko/java/com.aspose.html/htmlelement/
---
## HTMLElement class

모든 HTML 요소 인터페이스는 이 클래스로부터 파생됩니다. HTML 핵심 속성만 노출하는 요소들은 기본 `HTMLElement` 인터페이스로 표현됩니다. 이러한 요소들은 다음과 같습니다: 특수: SUB, SUP, SPAN, BDO; 글꼴: TT, I, B, U, S, STRIKE, BIG, SMALL; 구문: EM, STRONG, DFN, CODE, SAMP, KBD, VAR, CITE, ACRONYM, ABBR; 목록: DD, DT, NOFRAMES, NOSCRIPT, ADDRESS, CENTER. HTML 요소의 `style` 속성은 CSS 모듈에 정의된 `ElementCSSInlineStyle` 인터페이스를 통해 접근할 수 있습니다 [[DOM Level 2 Style Sheets and CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113)].
