---
title: "HTMLParamElement 클래스"
second_title: "Aspose.HTML for Java API 참조"
description: "com.aspose.html.HTMLParamElement 클래스. OBJECT 요소에 전달되는 매개변수입니다. HTML 4.01의 PARAM 요소 정의를 참조하십시오."
type: docs

url: /ko/java/com.aspose.html/htmlparamelement/
---
## HTMLParamElement class

`OBJECT` 요소에 전달되는 매개변수입니다. HTML 4.01의 PARAM 요소 정의를 참조하십시오.
