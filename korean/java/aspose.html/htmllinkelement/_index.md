---
title: "HTMLLinkElement 클래스"
second_title: "Aspose.HTML for Java API 참조"
description: "com.aspose.html.HTMLLinkElement 클래스. LINK 요소는 외부 리소스에 대한 링크를 지정하고 이 문서와 해당 리소스 간의 관계를 정의합니다(또는 그 반대). HTML 4.01의 LINK 요소 정의를 참조하고, StyleSheet 모듈의 LinkStyle 인터페이스(DOM Level 2 스타일 시트 및 CSS)도 확인하십시오."
type: docs

url: /ko/java/com.aspose.html/htmllinkelement/
---
## HTMLLinkElement class

`LINK` 요소는 외부 리소스에 대한 링크를 지정하고, 이 문서와 해당 리소스 간의 관계를 정의합니다(또는 그 반대). HTML 4.01의 LINK 요소 정의를 참조하십시오 (또한 스타일시트 모듈의 `LinkStyle` 인터페이스를 [[DOM Level 2 Style Sheets and CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113)]에서 확인하십시오).
...
| [getRelList](../../com.aspose.html/htmllinkelement/rellist/) \"rel\" 속성을 구문 분석하여 얻은 토큰을 포함하는 실시간 DOMTokenList를 반환합니다. |
[getRev]
...
| [getSheet](../../com.aspose.html/htmllinkelement/sheet/) 연결된 스타일 시트를 가져옵니다. |
