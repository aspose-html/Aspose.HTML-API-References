...
| 이름 | 설명 |
| --- | --- |
| static [getAll](../../com.aspose.html.accessibility/validationbuilder/all/) 모든 수준과 모든 기술 설정을 포함합니다. |
| static [getDefault](../../com.aspose.html.accessibility/validationbuilder/default/) 기본 설정: 일반 기술만 사용되며 최저 기준 수준에 해당합니다. |
| static [getNone](../../com.aspose.html.accessibility/validationbuilder/none/) 없음 설정 - 매개변수가 지정되지 않았습니다. |

## 메서드

| 이름 | 설명 |
| --- | --- |
| [allLevels](../../com.aspose.html.accessibility/validationbuilder/alllevels/)() | 모든 기준 수준을 설정하는 메서드입니다. 그리고 문서가 세 가지 수준의 기준에 따라 검사될 것임을 나타냅니다. |
| [allTechnologies](../../com.aspose.html.accessibility/validationbuilder/alltechnologies/)() | 테스트 기준에 모든 기술을 설정하는 메서드 |
| [setHTMLTags](../../com.aspose.html.accessibility/validationbuilder/sethtmltags/)(params String[]) | 검사할 HTML 태그 목록. 태그가 명시적으로 지정되지 않으면 태그 배열이 비어 있으며 검사는 모든 태그를 통과합니다. |
...
| [useHighestLevel](../../com.aspose.html.accessibility/validationbuilder/usehighestlevel/)() | 규칙에서 기준의 최고 수준 AAA 사용 |
| [useHTML](../../com.aspose.html.accessibility/validationbuilder/usehtml/)() | 규칙 집합에 HTML 기술을 포함하는 메서드 |
| [useLowestLevel](../../com.aspose.html.accessibility/validationbuilder/uselowestlevel/)() | 규칙에서 기준의 최저 수준 A 사용 |
| [useMiddleLevel](../../com.aspose.html.accessibility/validationbuilder/usemiddlelevel/)() | 규칙에서 기준의 중간 수준 AA 사용 |
