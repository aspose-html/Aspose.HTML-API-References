...
---
**com.aspose.html.accessibility** 패키지는 모든 웹 접근성 관련 조작을 위해 제공됩니다. W3C 웹 접근성 이니셔티브의 국제 표준을 준수합니다.
...
| [Criterion](./criterion/) | 각 권고에 대해 검증 가능한 성공 기준이 제공되어, WCAG 2.0을 준수 테스트가 필요한 영역에 적용할 수 있습니다. https://www.w3.org/WAI/WCAG21/Understanding/understanding-techniques |
| [Guideline](./guideline/) | Guidelines - 원칙 다음 단계입니다. 테스트 가능한 것은 아니지만, 프레임워크와 일반 목표를 개략적으로 제시하여 작성자가 성공 기준을 이해하고 기술을 보다 잘 적용하도록 돕습니다. Guidelines는 RuleDirectory{Criterion} 유형의 수용 기준 목록입니다. |
| [Principle](./principle/) | Accessibility Principle - 웹 접근성의 기반을 제공하는 최고 수준으로, RuleCollection{Guideline} 유형의 Guidelines 목록을 포함합니다. 해당 객체는 어셈블리 외부에서 생성될 수 없습니다. https://www.w3.org/WAI/fundamentals/accessibility-principles/ |
