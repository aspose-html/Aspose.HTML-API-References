...
description: "WebAccessibility 메서드. 전체 매개변수가 포함된 ValidationBuilder.All 객체를 사용하여 특정 규칙에 대한 AccessibilityValidator 인스턴스가 생성됩니다."
type: docs

url: /ko/java/com.aspose.html.accessibility/webaccessibility/createvalidator/
---
## CreateValidator(IRule) {#createvalidator_1}

ValidationBuilder.All 객체의 전체 매개변수를 제공하여 특정 규칙에 대해 AccessibilityValidator 인스턴스가 생성됩니다.
...
| Parameter | Type | 설명 |
| --- | --- | --- |
| 규칙 | IRule | IRule 인터페이스를 구현한 규칙 객체 |

### 반환 값

AccessibilityValidator 객체
...
AccessibilityValidator 인스턴스 생성
...
| --- | --- | --- |
| 규칙 | IRule | IRule 인터페이스를 구현한 규칙 객체 |
| 빌더 | ValidationBuilder | ValidationBuilder 객체 |
...
| --- | --- | --- |
| 규칙 | IRule | IRule 인터페이스를 구현한 규칙 객체 |
| 빌더 | Action`1 | ValidationBuilder 객체를 반환하는 메서드 |
...
AccessibilityValidator 인스턴스가 ValidationBuilder.All 객체와 함께 모든 규칙에 따라 생성됩니다.
...
특정 규칙 목록에 대해 AccessibilityValidator 인스턴스가 생성됩니다.
