...
문서가 저장되는 형식을 지정합니다. [`HTMLDocument`](../../com.aspose.html/htmldocument/) 저장에 대한 자세한 정보는 [article](https://docs.aspose.com/html/net/working-with-documents/saving-a-document/)에서 확인할 수 있습니다.
