---
title: "DocSaveOptions 클래스"
second_title: "Java용 Aspose.HTML API 참조"
description: "com.aspose.html.saving.DocSaveOptions 클래스. 특정 옵션 데이터 클래스. 속성을 할당하여 해상도, 페이지 크기, 배경 색상과 같은 렌더링 특성 및 글꼴 포함과 같은 문서별 옵션을 관리할 수 있습니다. 자세한 내용은 문서 기사에서 확인하세요."
type: docs
...
특정 옵션 데이터 클래스입니다. 속성을 할당함으로써 해상도, 페이지 크기, 배경 색상과 같은 렌더링 특성 및 글꼴 포함과 같은 문서별 옵션을 관리할 수 있습니다. 자세한 내용은 문서의 [article](https://docs.aspose.com/html/net/converting-between-formats/html-to-docx/#save-options)를 참고하십시오.
...
...
 // 소스 HTML 파일에 대한 경로를 준비합니다.
      ...
      // DocSaveOptions를 초기화합니다. 페이지 크기를 600x400 픽셀 및 여백을 설정합니다.
