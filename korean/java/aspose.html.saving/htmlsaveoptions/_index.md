...
description: "com.aspose.html.saving.HTMLSaveOptions 클래스. HTML 저장 옵션을 나타냅니다. 특정 속성을 할당하여 최대 처리 깊이 등과 같은 리소스 처리를 관리할 수 있습니다. 자세한 내용은 문서 기사에서 확인하세요."
type: docs
...
HTML 저장 옵션을 나타냅니다. 특정 속성을 할당하여 최대 처리 깊이 등과 같은 리소스 처리를 관리할 수 있습니다. 자세한 내용은 문서의 [article](https://docs.aspose.com/html/net/working-with-documents/saving-a-document/)를 참조하십시오.
...
| const [HTML](../../com.aspose.html.saving/htmlsaveoptions/html/) | 문서가 HTML 형식으로 저장됩니다. |
| const [XHTML](../../com.aspose.html.saving/htmlsaveoptions/xhtml/) | 문서가 XHTML 형식으로 저장됩니다. |
