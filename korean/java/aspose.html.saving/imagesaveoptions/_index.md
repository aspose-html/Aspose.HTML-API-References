...
description: "com.aspose.html.saving.ImageSaveOptions 클래스. 특정 옵션 데이터 클래스입니다. 이미지 결과의 해상도, 스무딩, 품질, 형식 및 페이지 설정 등을 관리하는 속성을 제공합니다. 자세한 내용은 문서 항목에서 확인할 수 있습니다."
type: docs
...
특정 옵션 데이터 클래스입니다. 이미지 결과 해상도, 스무딩 품질, 형식 및 페이지 설정 등을 관리하는 속성을 제공합니다. 자세한 내용은 문서의 [article](https://docs.aspose.com/html/net/converting-between-formats/html-to-jpg/#save-options)에서 확인할 수 있습니다.
...
| 이름 | 설명 |
| --- | --- |
| [ImageSaveOptions](imagesaveoptions/#constructor)() | `ImageSaveOptions` 클래스의 새 인스턴스를 초기화합니다; 기본 이미지 형식으로 Png가 사용됩니다. |
