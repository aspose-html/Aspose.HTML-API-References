...
description: "com.aspose.html.saving.PdfSaveOptions 클래스. 특정 데이터 클래스는 변환 결과를 관리하기 위한 몇 가지 속성을 제공합니다. 예를 들어 PageSetup은 페이지 특성을 지정합니다. 문서 항목을 참조하십시오."
type: docs
...
...
      ...
      // 해상도를 설정하고 배경색을 AliceBlue로 변경합니다 
