...
description: "com.aspose.html.saving.MHTMLSaveOptions 클래스. MHTML 저장 옵션을 나타냅니다. 특정 속성을 할당함으로써 최대 처리 깊이 등과 같은 리소스 처리를 관리할 수 있습니다. 자세한 내용은 문서 기사에서 확인하십시오."
type: docs
...
MHTML 저장 옵션을 나타냅니다. 특정 속성을 할당하여 최대 처리 깊이와 같은 리소스 처리를 관리할 수 있습니다. 자세한 내용은 문서의 [article](https://docs.aspose.com/html/net/converting-between-formats/html-to-mhtml/#save-options)를 참고하십시오.
...
...
	 // 다른 파일에 대한 링크가 포함된 HTML 코드를 준비하고 이를 'document.html' 파일로 저장합니다.
      ...
      // 직접 연결된 리소스를 가진 문서를 변환하기 위해 리소스 연결 깊이 값을 1로 변경합니다.
