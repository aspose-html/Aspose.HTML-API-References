...
많은 SVG 그래픽 작업은 다음 형태의 2x3 행렬을 사용합니다: [a c e] [b d f] . 행렬 연산을 위해 3x3 행렬로 확장될 때는 다음과 같이 됩니다: [a c e] [b d f] [0 0 1]
...
| [multiply](../../com.aspose.html.dom.svg.datatypes/svgmatrix/multiply/)(SVGMatrix) | 행렬 곱셈을 수행합니다. 이 행렬은 다른 행렬에 후곱되어 새로운 결과 행렬을 반환합니다. |
| [rotate](../../com.aspose.html.dom.svg.datatypes/svgmatrix/rotate/)(float) | 현재 행렬에 회전 변환을 후곱하고 결과 행렬을 반환합니다. |
| [scale](../../com.aspose.html.dom.svg.datatypes/svgmatrix/scale/)(float) | 현재 행렬에 균일 스케일 변환을 후곱하고 결과 행렬을 반환합니다. |
| [scaleNonUniform](../../com.aspose.html.dom.svg.datatypes/svgmatrix/scalenonuniform/)(float, float) | 현재 행렬에 비균일 스케일 변환을 후곱하고 결과 행렬을 반환합니다. |
