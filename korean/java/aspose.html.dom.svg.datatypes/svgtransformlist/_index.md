---
title: "SVGTransformList 클래스"
second_title: "Aspose.HTML for Java API 참조"
description: "com.aspose.html.dom.svg.datatypes.SVGTransformList 클래스. 이 인터페이스는 SVGTransform 객체들의 목록을 정의합니다."
type: docs

url: /ko/java/com.aspose.html.dom.svg.datatypes/svgtransformlist/
---
## SVGTransformList class

이 인터페이스는 SVGTransform 객체 목록을 정의합니다.
...
| 이름 | 설명 |
| --- | --- |
| [SVGTransformList](svgtransformlist/#constructor)() | `SVGTransformList` 클래스의 새 인스턴스를 초기화합니다. |
| [SVGTransformList](svgtransformlist/#constructor_1)(IEnumerable&lt;SVGTransform&gt;) | `SVGTransformList` 클래스의 새 인스턴스를 초기화합니다. |
...
| [toString](../../com.aspose.html.dom.svg.datatypes/svgtransformlist/toString/)() | 이 인스턴스를 나타내는 문자열을 반환합니다. |
