...
description: "SVGAngle 메서드. 동일한 기본 저장 값을 유지하면서 저장된 단위 식별자를 지정된 unitType으로 재설정합니다. 이 메서드의 결과로 객체 속성인 unitType, valueInSpecifiedUnits 및 valueAsString이 변경될 수 있습니다."
type: docs
