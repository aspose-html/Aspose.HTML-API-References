...
입력 스트림으로 제공된 MD(마크다운) 소스를 HTML로 변환합니다. 결과는 [`HTMLDocument`](../../../com.aspose.html/htmldocument/)이며 출력 파일 경로를 통해 저장할 수 있습니다.
...
변환 소스. 기존 로컬 MD 파일을 감지하거나 입력 데이터 스트림을 변환 소스로 생성합니다. 변환 결과. 메서드 시그니처에 따라 직접 [`HTMLDocument`](../../../com.aspose.html/htmldocument/)을 얻거나 결과 출력 파일 경로를 정의할 수 있습니다. Converter 클래스의 ConvertMarkdown() 메서드를 사용하여 MD를 HTML 결과로 저장합니다. 옵션 매개변수로 [`configuration`](../../../com.aspose.html/configuration/)을 추가할 수도 있습니다. 온라인 MD 변환기

무료 온라인 [MD to HTML Converter](https://products.aspose.app/html/en/conversion/md-to-html)를 사용하면 고품질, 쉽고 빠르게 MD를 HTML로 변환할 수 있습니다. 파일을 업로드하고 변환하면 몇 초 안에 결과를 얻을 수 있습니다! 또한 다른 온라인 MD 변환기도 확인할 수 있습니다: [MD to PDF](https://products.aspose.app/html/en/conversion/md-to-pdf), [MD to DOCX](https://products.aspose.app/html/en/conversion/md-to-docx), [MD to XPS](https://products.aspose.app/html/en/conversion/md-to-xps) 및 적절한 [MD to image converters](https://docs.aspose.com/html/net/converting-between-formats/markdown-to-image/).
...
전체 파일 경로로 제공된 MD(마크다운) 소스를 HTML로 변환합니다. 결과는 [`HTMLDocument`](../../../com.aspose.html/htmldocument/)이며 출력 파일 경로를 통해 저장할 수 있습니다.
