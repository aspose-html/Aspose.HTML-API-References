...
description: "Converter 메서드. HTMLDocument에 의해 제공된 HTML 소스를 변환합니다. 결과는 출력 파일 경로에 생성된 docx 파일입니다."
type: docs

url: /ko/java/com.aspose.html.converters/converter/converthtml/
---
## ConvertHTML(HTMLDocument, DocSaveOptions, String) {#converthtml_1}

[`HTMLDocument`](../../../com.aspose.html/htmldocument/)에 의해 제공된 HTML 소스를 변환합니다. 결과는 출력 파일 경로에 생성된 docx 파일입니다.
...
| Parameter | Type | 설명 |
| --- | --- | --- |
| document | HTMLDocument | [`HTMLDocument`](../../../com.aspose.html/htmldocument/) 인스턴스를 변환 소스로 사용합니다. |
| options | DocSaveOptions | [`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/) 객체 사용을 통해 렌더링 프로세스를 조정할 수 있습니다. 자세한 내용은 [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/html-to-docx/#convert-html-to-docx-using-docsaveoptions)를 참조하십시오. |
...
Aspose.HTML의 주요 특징은 변환 기능입니다. 다양한 이유로 포맷 간 변환이 필요합니다: 익숙하고 편리한 포맷으로 작업하거나 특정 작업에 맞는 다른 포맷을 활용하기 위해서입니다. com.aspose.html.converters 패키지는 변환 메서드에 손쉽게 접근할 수 있도록 구현되었습니다. 이 패키지는 [PDF](https://docs.fileformat.com/pdf/), [XPS](https://docs.fileformat.com/page-description-language/xps/), [DOCX](https://docs.fileformat.com/word-processing/docx/), [JPEG](https://docs.fileformat.com/image/jpeg/), [PNG](https://docs.fileformat.com/image/png/), [BMP](https://docs.fileformat.com/image/bmp/), [TIFF](https://docs.fileformat.com/image/tiff/), [GIF](https://docs.fileformat.com/image/gif/), [MHTML](https://docs.fileformat.com/web/mhtml/), 및 [MD](https://docs.fileformat.com/word-processing/md/)와 같은 인기 포맷으로의 다양한 HTML 변환을 제공합니다.

이 문서는 지원되는 HTML 변환 목록과 [`Converter`](../) 클래스를 사용하여 이를 수행하는 방법에 대한 정보를 제공합니다. 이 클래스는 모든 저수준 변환 작업을 하나의 클래스로 묶어 편리하고 사용하기 쉽게 합니다. HTML Converter 가이드에서는 다음 문서를 찾을 수 있습니다:

DOCX 변환

DOCX 파일은 일반적으로 텍스트를 포함하지만 표, 래스터 및 벡터 그래픽, 비디오, 사운드 및 다이어그램 등 다양한 데이터를 포함할 수 있는 Microsoft Word 문서입니다. DOCX 파일은 편집이 매우 쉽고 사용이 간편하며 크기 관리가 용이합니다. 이 형식은 사용자가 모든 유형의 문서를 작성할 수 있도록 다양한 옵션을 제공하기 때문에 인기가 있습니다. 이 파일 형식은 가장 널리 사용되는 형식 중 하나이며 다양한 프로그램을 통해 사용할 수 있습니다.
...
변환 소스. 기존 로컬 HTML 파일이나 원격 Url을 변환 소스로 감지합니다. 인라인 HTML 콘텐츠를 변환 소스로 정의하거나 어떤 방식으로든 HTML 문서 ([`HTMLDocument`](../../../com.aspose.html/htmldocument/))를 생성할 수 있습니다. 변환 결과. 결과 출력 파일 경로를 정의하거나 알려진 또는 사용자 지정 [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) 인터페이스 구현을 출력 데이터 버퍼로 사용할 수 있습니다. 사용자 지정 또는 기본 설정으로 새로운 [`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/) 객체를 생성합니다. 옵션 매개변수로 [`configuration`](../../../com.aspose.html/configuration/)을 추가할 수도 있습니다. Converter 클래스의 ConvertHTML() 메서드를 사용하여 사용자 시나리오에 따라 세 개 이상의 매개변수로 HTML을 DOCX 결과로 저장합니다. 온라인 HTML 변환기

Aspose.HTML은 고품질, 쉽고 빠르게 HTML을 DOCX로 변환하는 무료 온라인 [HTML to DOCX Converter](https://products.aspose.app/html/en/conversion/html-to-docx)를 제공합니다. 파일을 업로드하고 변환하면 몇 초 안에 결과를 얻을 수 있습니다!

다른 인기 있는 형식 변환을 사용해 보세요
...
URL로 제공된 HTML 소스를 변환합니다. 결과는 출력 파일 경로에 의해 생성된 docx 파일입니다.
...
| Parameter | Type | 설명 |
| --- | --- | --- |
| url | Url | HTML 소스 문서 URL - 보편 식별자(URL)의 객체 표현을 제공합니다. |
| options | DocSaveOptions | [`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/) 객체 사용을 통해 렌더링 프로세스를 조정할 수 있습니다. 자세한 내용은 [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/html-to-docx/#convert-html-to-docx-using-docsaveoptions)를 참조하십시오. |
| outputPath | String | 출력 변환 결과로서 전체 docx 파일 경로. |
...
전체 파일 경로로 제공된 HTML 소스를 DOCX로 변환합니다. 결과는 출력 파일 경로에 의해 생성된 docx 파일입니다.
...
| Parameter | Type | 설명 |
| --- | --- | --- |
| sourcePath | String | Html 전체 파일 소스 경로. |
| options | DocSaveOptions | [`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/) 객체 사용을 통해 렌더링 프로세스를 조정할 수 있습니다. 자세한 내용은 [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/html-to-docx/#convert-html-to-docx-using-docsaveoptions)를 참조하십시오. |
| outputPath | String | 출력 변환 결과로서 전체 docx 파일 경로. |
...
인라인 콘텐츠로 제공된 HTML 소스를 변환합니다. 결과는 출력 파일 경로에 의해 생성된 docx 파일입니다.
...
`[`HTMLDocument`](../../../com.aspose.html/htmldocument/)`에 의해 제공된 HTML 소스를 변환합니다. 결과는 `[`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/)` 인터페이스 구현에 의해 형성된 출력 데이터입니다.
...
| Parameter | Type | 설명 |
| --- | --- | --- |
| document | HTMLDocument | `[`HTMLDocument`](../../../com.aspose.html/htmldocument/)`에 의해 제공된 변환 소스. |
| options | DocSaveOptions | [`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/) 객체 사용을 통해 렌더링 프로세스를 조정할 수 있습니다. 자세한 내용은 [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/html-to-docx/#convert-html-to-docx-using-docsaveoptions)를 참조하십시오. |
...
URL에 의해 제공된 HTML 소스를 변환합니다. 결과는 `[`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/)` 인터페이스 구현에 의해 형성된 출력 데이터입니다.
...
... 	 
      ...
      // 알려진 ICreateStreamProvider 구현을 사용합니다
      ICreateStreamProvider provider = new FileCreateStreamProvider(resultPath);
...
전체 파일 경로에 의해 제공된 HTML 소스를 DOCX로 변환합니다. 결과는 `[`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/)` 인터페이스 구현에 의해 형성된 출력 데이터입니다.
...
... 
      ...
      // 기본 ICreateStreamProvider 구현을 사용합니다
      ICreateStreamProvider provider = new FileCreateStreamProvider(resultPath);
...
인라인 콘텐츠에 의해 제공된 HTML 소스를 DOCX로 변환합니다. 결과는 `[`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/)` 인터페이스 구현에 의해 형성된 출력 데이터입니다.
...
... 
      ...
      // 알려진 로컬 파일 지향 ICreateStreamProvider 구현을 사용합니다
      ICreateStreamProvider provider = new FileCreateStreamProvider(resultPath);

      // 기본 DocSaveOptions 객체를 인스턴스화합니다
      var options = new DocSaveOptions();
...
`[`HTMLDocument`](../../../com.aspose.html/htmldocument/)`에 의해 제공된 HTML 소스를 변환합니다. 결과는 출력 파일 경로에 의해 형성된 pdf 파일입니다.
...
| --- | --- | --- |
| document | HTMLDocument | `[`HTMLDocument`](../../../com.aspose.html/htmldocument/)`에 의해 제공된 변환 소스. |
| options | PdfSaveOptions | `[`PdfSaveOptions`](../../../com.aspose.html.saving/pdfsaveoptions/)` 객체 사용을 통해 렌더링 프로세스를 조정할 수 있습니다. 자세한 내용은 [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/html-to-pdf/#convert-html-to-pdf-using-pdfsaveoptions)를 참조하십시오. |
...
Portable Document Format (PDF)은 1990년대에 Adobe에서 만든 문서 유형입니다. 이 파일 형식의 목적은 응용 프로그램 소프트웨어, 하드웨어 및 운영 체제와 무관한 형식으로 문서와 기타 참고 자료를 표현하기 위한 표준을 도입하는 것이었습니다. PDF 파일은 PDF 사양에 정의된 구문 규칙에 따라 토큰으로 그룹화될 수 있는 바이트 집합입니다. 하나 이상의 토큰이 결합되어 주로 객체인 고수준 구문 엔터티를 형성하며, 이는 PDF 문서를 구성하는 기본 데이터 값입니다.
...
변환 소스. 기존 로컬 HTML 파일이나 원격 Url을 변환 소스로 감지합니다. 인라인 html 콘텐츠를 변환 소스로 정의하거나 HTML 문서 (HTMLDocument)를 어떤 방식으로든 생성할 수도 있습니다. 변환 결과. 결과 출력 파일 경로를 정의하거나 알려진 또는 사용자 정의 [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) 인터페이스 구현을 출력 데이터 버퍼로 사용합니다. 사용자 지정 또는 기본 설정으로 새로운 [`PdfSaveOptions`](../../../com.aspose.html.saving/pdfsaveoptions/) 객체를 생성합니다. 옵션 매개변수로 [`configuration`](../../../com.aspose.html/configuration/)도 추가할 수 있습니다. Converter 클래스의 ConvertHTML() 메서드를 사용하여 HTML을 PDF 결과로 저장하며, 시나리오에 따라 세 개 이상의 매개변수가 필요합니다. 온라인 HTML 변환기

Aspose.HTML은 고품질, 쉽고 빠르게 HTML을 PDF로 변환하는 무료 온라인 [HTML to PDF Converter](https://products.aspose.app/html/en/conversion/html-to-pdf)를 제공합니다. 파일을 업로드하고 변환하면 몇 초 안에 결과를 얻을 수 있습니다!
...
URL로 제공된 HTML 소스를 변환합니다. 결과는 출력 파일 경로에 의해 생성된 pdf 파일입니다.
...
전체 파일 경로로 제공된 HTML 소스를 PDF로 변환합니다. 결과는 출력 파일 경로에 의해 생성된 pdf 파일입니다.
...
인라인 콘텐츠로 제공된 HTML 소스를 PDF로 변환합니다. 결과는 출력 파일 경로에 의해 생성된 pdf 파일입니다.
...
[`HTMLDocument`](../../../com.aspose.html/htmldocument/)에 의해 제공되는 HTML 소스를 PDF로 변환합니다. 결과는 [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) 인터페이스 구현에 의해 형성된 출력 데이터입니다.
...
전체 파일 경로로 제공되는 HTML 소스를 PDF로 변환합니다. 결과는 [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) 인터페이스 구현에 의해 형성된 출력 데이터입니다.
...
인라인 콘텐츠로 제공되는 HTML 소스를 PDF로 변환합니다. 결과는 [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) 인터페이스 구현에 의해 형성된 출력 데이터입니다.
...
[`HTMLDocument`](../../../com.aspose.html/htmldocument/)에 의해 제공되는 HTML 소스를 변환합니다. 결과는 출력 파일 경로에 의해 생성된 mhtml(.mht) 파일입니다.
...
| --- | --- | --- |
| document | HTMLDocument | `[`HTMLDocument`](../../../com.aspose.html/htmldocument/)`에 의해 제공된 변환 소스. |
| options | MHTMLSaveOptions | [`MHTMLSaveOptions`](../../../com.aspose.html.saving/mhtmlsaveoptions/) 객체 사용을 통해 렌더링 프로세스를 조정할 수 있습니다. 자세한 내용은 [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/html-to-mhtml/#convert-html-to-mhtml-using-mhtmlsaveoptions)를 참조하십시오. |
| outputPath | String | 출력 변환 결과로 전체 mhtml(.mht) 파일 경로. |

## 비고

HTML을 MHTML로 변환하는 방법
...
변환 소스. 기존 로컬 HTML 파일이나 원격 Url을 변환 소스로 감지합니다. 인라인 html 콘텐츠를 변환 소스로 정의하거나 HTML 문서([`HTMLDocument`](../../../com.aspose.html/htmldocument/))를 어떤 방식으로든 생성할 수도 있습니다. 변환 결과. 결과 출력 파일 경로를 정의하거나 알려진 또는 사용자 정의 [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) 인터페이스 구현을 출력 데이터 버퍼로 사용합니다. 사용자 지정 또는 기본 설정으로 새로운 [`MHTMLSaveOptions`](../../../com.aspose.html.saving/mhtmlsaveoptions/) 객체를 생성합니다. 옵션 매개변수로 [`configuration`](../../../com.aspose.html/configuration/)도 추가할 수 있습니다. Converter 클래스의 ConvertHTML() 메서드를 사용하여 HTML을 MHTML 결과로 저장하며, 시나리오에 따라 세 개 이상의 매개변수가 필요합니다. 온라인 HTML 변환기

Aspose.HTML은 고품질, 쉽고 빠르게 HTML을 MHTML로 변환하는 무료 온라인 [HTML to MHTML Converter](https://products.aspose.app/html/en/conversion/html-to-mhtml)를 제공합니다. 파일을 업로드하고 변환하면 몇 초 안에 결과를 얻을 수 있습니다!
...
URL로 제공된 HTML 소스를 변환합니다. 결과는 출력 파일 경로에 의해 생성된 mhtml (.mht) 파일입니다.
...
전체 파일 경로로 제공된 HTML 소스를 MHTML로 변환합니다. 결과는 출력 파일 경로에 의해 생성된 mhtml (.mht) 파일입니다.
...
| Parameter | Type | 설명 |
| --- | --- | --- |
| sourcePath | String | Html 파일 소스 경로. 현재 디렉터리 경로와 결합되어 절대 URL을 형성합니다. |
| options | MHTMLSaveOptions | [`MHTMLSaveOptions`](../../../com.aspose.html.saving/mhtmlsaveoptions/) 객체 사용을 통해 렌더링 프로세스를 조정할 수 있습니다. 자세한 내용은 [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/html-to-mhtml/#convert-html-to-mhtml-using-mhtmlsaveoptions)를 참조하십시오. |
| outputPath | String | 출력 변환 결과로 전체 mhtml(.mht) 파일 경로. |
...
인라인 콘텐츠로 제공된 HTML 소스를 MHTML로 변환합니다. 결과는 출력 파일 경로에 의해 생성된 mhtml (.mht) 파일입니다.
...
변환 소스. 기존 로컬 HTML 파일이나 원격 URL을 변환 소스로 감지합니다. 인라인 HTML 콘텐츠를 변환 소스로 정의하거나, 어떤 방식으로든 HTML 문서 ([`HTMLDocument`](../../../com.aspose.html/htmldocument/))를 생성할 수도 있습니다. 변환 결과. 결과 출력 파일 경로를 정의하거나, 알려진 또는 사용자 지정 [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) 인터페이스 구현을 출력 데이터 버퍼로 사용할 수 있습니다. 맞춤 설정 또는 기본 설정으로 새로운 [`MHTMLSaveOptions`](../../../com.aspose.html.saving/mhtmlsaveoptions/) 객체를 생성합니다. 옵션 매개변수로 [`configuration`](../../../com.aspose.html/configuration/)을 추가할 수도 있습니다. Converter 클래스의 ConvertHTML() 메서드를 사용하여 HTML을 MHTML 결과로 저장합니다. 사용자 시나리오에 따라 세 개 이상의 매개변수를 사용할 수 있습니다. 온라인 HTML 변환기
...
[`HTMLDocument`](../../../com.aspose.html/htmldocument/)에 의해 제공된 HTML 소스를 변환합니다. 결과는 출력 파일 경로에 의해 생성된 markdown (.md) 파일입니다.
...
| --- | --- | --- |
| document | HTMLDocument | `[`HTMLDocument`](../../../com.aspose.html/htmldocument/)`에 의해 제공된 변환 소스. |
| options | MarkdownSaveOptions | [`MarkdownSaveOptions`](../../../com.aspose.html.saving/markdownsaveoptions/) 객체 사용을 통해 렌더링 프로세스를 조정할 수 있습니다. 자세한 내용은 [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/html-to-markdown/#convert-html-to-markdown-using-markdownsaveoptions)를 참조하십시오. |
| outputPath | String | 출력 변환 결과로서 전체 md 파일 경로. |
...
변환 소스. 기존 로컬 HTML 파일이나 원격 URL을 변환 소스로 감지합니다. 인라인 HTML 콘텐츠를 변환 소스로 정의하거나, 어떤 방식으로든 HTML 문서 ([`HTMLDocument`](../../../com.aspose.html/htmldocument/))를 생성할 수도 있습니다. 변환 결과. 결과 출력 파일 경로를 정의하거나, 알려진 또는 사용자 지정 [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) 인터페이스 구현을 출력 데이터 버퍼로 사용할 수 있습니다. 맞춤 설정 또는 기본 설정으로 새로운 [MarkdownSaveOptions](https://apireference.aspose.com/html/net/aspose.html.saving/markdownsaveoptions) 객체를 생성합니다. 옵션 매개변수로 [`configuration`](../../../com.aspose.html/configuration/)을 추가할 수도 있습니다. Converter 클래스의 ConvertHTML() 메서드를 사용하여 HTML을 Markdown 결과로 저장합니다. 사용자 시나리오에 따라 세 개 이상의 매개변수를 사용할 수 있습니다. 온라인 HTML 변환기

Aspose.HTML은 고품질, 쉽고 빠르게 HTML을 MD로 변환하는 무료 온라인 [HTML to Markdown](https://products.aspose.app/html/en/conversion/html-to-md) 서비스를 제공합니다. 파일을 업로드하고 변환하면 몇 초 안에 결과를 얻을 수 있습니다!
...
URL로 제공된 HTML 소스를 변환합니다. 결과는 출력 파일 경로에 의해 생성된 markdown (.md) 파일입니다.
...
전체 파일 경로로 제공된 HTML 소스를 Markdown으로 변환합니다. 결과는 출력 파일 경로에 의해 생성된 markdown (.md) 파일입니다.
...
인라인 콘텐츠로 제공된 HTML 소스를 Markdown으로 변환합니다. 결과는 출력 파일 경로에 의해 생성된 mhtml (.mht) 파일입니다.
...
[`HTMLDocument`](../../../com.aspose.html/htmldocument/)에 의해 제공된 HTML 소스를 변환합니다. 결과는 출력 파일 경로에 의해 생성된 xps 파일입니다.
...
| --- | --- | --- |
| document | HTMLDocument | `[`HTMLDocument`](../../../com.aspose.html/htmldocument/)`에 의해 제공된 변환 소스. |
| options | XpsSaveOptions | [`XpsSaveOptions`](../../../com.aspose.html.saving/xpssaveoptions/) 객체 사용을 통해 렌더링 프로세스를 조정할 수 있습니다. 자세한 내용은 [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/html-to-xps/#convert-html-to-xps-using-xpssaveoptions)를 참조하십시오. |
...
변환 소스. 기존 로컬 HTML 파일이나 원격 URL을 변환 소스로 감지합니다. 인라인 HTML 콘텐츠를 변환 소스로 정의하거나, 어떤 방식으로든 HTML 문서 (HTMLDocument)를 생성할 수도 있습니다. 변환 결과. 결과 출력 파일 경로를 정의하거나, 알려진 또는 사용자 지정 [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) 인터페이스 구현을 출력 데이터 버퍼로 사용할 수 있습니다. 맞춤 설정 또는 기본 설정으로 새로운 [`XpsSaveOptions`](../../../com.aspose.html.saving/xpssaveoptions/) 객체를 생성합니다. 옵션 매개변수로 [`configuration`](../../../com.aspose.html/configuration/)을 추가할 수도 있습니다. Converter 클래스의 ConvertHTML() 메서드를 사용하여 HTML을 XPS 결과로 저장합니다. 사용자 시나리오에 따라 세 개 이상의 매개변수를 사용할 수 있습니다. 온라인 HTML 변환기

Aspose.HTML은 고품질, 쉽고 빠르게 HTML을 XPS로 변환하는 무료 온라인 [HTML to XPS Converter](https://products.aspose.app/html/en/conversion/html-to-xps) 서비스를 제공합니다. 파일을 업로드하고 변환하면 몇 초 안에 결과를 얻을 수 있습니다!
...
URL로 제공된 HTML 소스를 변환합니다. 결과는 출력 파일 경로에 의해 생성된 xps 파일입니다.
...
전체 파일 경로로 제공된 HTML 소스를 XPS로 변환합니다. 결과는 출력 파일 경로에 의해 생성된 xps 파일입니다.
...
인라인 콘텐츠로 제공된 HTML 소스를 XPS로 변환합니다. 결과는 출력 파일 경로에 의해 생성된 xps 파일입니다.
...
... 
	...
	// 다양한 방법 중 하나로 HTML 문서를 생성합니다
   	using (HTMLDocument document = new HTMLDocument(sourcePath, new Configuration()))
   	{
		...
		// 알려진 ICreateStreamProvider 구현 중 하나를 사용하십시오
  		ICreateStreamProvider provider = new FileCreateStreamProvider(resultPath);
...
| Parameter | Type | 설명 |
| --- | --- | --- |
| url | Url | HTML 소스 URL - 범용 식별자(URL)의 객체 표현을 제공합니다. |
| configuration | Configuration | 환경 구성. 애플리케이션의 환경 설정을 구성하는 데 사용되는 [`configuration`](../../../com.aspose.html/configuration/) 컨텍스트 객체를 나타냅니다. |
| options | XpsSaveOptions | [`XpsSaveOptions`](../../../com.aspose.html.saving/xpssaveoptions/) 객체 사용을 통해 렌더링 프로세스를 조정할 수 있습니다. |
| provider | ICreateStreamProvider | `[`interface`](../../../com.aspose.html.io/icreatestreamprovider/)`의 구현으로, 출력 스트림을 얻는 데 사용됩니다. |
...
전체 파일 경로로 제공된 HTML 소스를 XPS로 변환합니다. 결과는 [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) 인터페이스 구현에 의해 생성된 출력 데이터입니다.
...
인라인 콘텐츠로 제공된 HTML 소스를 XPS로 변환합니다. 결과는 [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) 인터페이스 구현에 의해 형성된 출력 데이터입니다.
...
Aspose.HTML은 고품질, 쉽고 빠르게 HTML을 XPS로 변환하는 무료 온라인 [HTML to XPS](https://products.aspose.app/html/en/conversion/html-to-xps) 변환기를 제공합니다. 파일을 업로드하고 변환하면 몇 초 안에 결과를 얻을 수 있습니다!
...
`[`HTMLDocument`](../../../com.aspose.html/htmldocument/)` 로 제공된 HTML 소스를 변환합니다. 결과는 출력 파일 경로에 의해 생성된 이미지 파일입니다.
...
| --- | --- | --- |
| document | HTMLDocument | `[`HTMLDocument`](../../../com.aspose.html/htmldocument/)`에 의해 제공된 변환 소스. |
| options | ImageSaveOptions | [`ImageSaveOptions`](../../../com.aspose.html.saving/imagesaveoptions/) 객체 사용을 통해 렌더링 프로세스를 조정할 수 있습니다. |
...
변환 소스. 기존 로컬 HTML 파일이나 원격 URL을 변환 소스로 감지합니다. 인라인 HTML 콘텐츠를 변환 소스로 정의하거나 다양한 방법으로 HTML 문서(HTMLDocument)를 생성할 수도 있습니다. 변환 결과. 결과 출력 파일 경로를 정의하거나 알려진 또는 사용자 정의 [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) 인터페이스 구현을 출력 데이터 버퍼로 사용할 수 있습니다. 필요한 [`ImageFormat`](../../../com.aspose.html.rendering.image/imageformat/)을 지정하여 새로운 [`ImageSaveOptions`](../../../com.aspose.html.saving/imagesaveoptions/) 객체를 생성합니다. 기본적으로 Format 속성은 PNG입니다. 옵션 매개변수로 [`configuration`](../../../com.aspose.html/configuration/)을 추가할 수도 있습니다. Converter 클래스의 ConvertHTML() 메서드를 사용하여 사용자 시나리오에 따라 세 개 이상의 매개변수로 HTML을 이미지로 저장합니다. 온라인 HTML 변환기

Aspose.HTML은 고품질, 쉽고 빠르게 HTML을 이미지로 변환하는 무료 온라인 [HTML to PNG Converter](https://products.aspose.app/html/en/conversion/html-to-png) 를 제공합니다. 파일을 업로드하고 변환하면 몇 초 안에 결과를 얻을 수 있습니다!
...
URL로 제공된 HTML 소스를 변환합니다. 결과는 출력 파일 경로에 의해 생성된 이미지 파일입니다.
...
전체 파일 경로로 제공된 HTML 소스를 이미지로 변환합니다. 결과는 출력 파일 경로에 의해 생성된 이미지 파일입니다.
...
| --- | --- | --- |
| sourcePath | String | Html 파일 소스 경로. 현재 디렉터리 경로와 결합되어 절대 URL을 형성합니다. |
| options | ImageSaveOptions | [`ImageSaveOptions`](../../../com.aspose.html.saving/imagesaveoptions/) 클래스에 대해 자세히 알아보려면 [Fine-Tuning Converters](https://docs.aspose.com/html/net/converting-between-formats/fine-tuning-converters/) 기사를 읽어 주세요. |
| outputPath | String | 전체 이미지 파일 경로가 출력 변환 결과로 사용됩니다. |
...
... 
	...
	// 저장 옵션 객체 인스턴스를 정의합니다. 기본 이미지 형식은 PNG입니다.
...
인라인 콘텐츠로 제공된 HTML 소스를 이미지로 변환합니다. 결과는 출력 파일 경로에 의해 생성된 이미지 파일입니다.
...
| 내용 | String | 인라인 html 콘텐츠 문자열. |
| baseUri | String | 문서의 기본 URI입니다. 현재 디렉터리 경로와 결합되어 절대 URL을 형성합니다. |
| options | ImageSaveOptions | 새로 생성된 이미지 옵션은 형식, 해상도 등입니다. [`ImageSaveOptions`](../../../com.aspose.html.saving/imagesaveoptions/) 클래스와 [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/html-to-jpg/#output-stream-providers)를 참고하세요. |
| outputPath | String | 전체 이미지 파일 경로가 출력 변환 결과로 사용됩니다. |
...
| configuration | Configuration | 환경 구성. 애플리케이션의 환경 설정을 구성하는 데 사용되는 [`configuration`](../../../com.aspose.html/configuration/) 컨텍스트 객체를 나타냅니다. |
| options | ImageSaveOptions | ImageSaveOptions 객체 사용을 통해 렌더링 프로세스를 조정할 수 있습니다. [`page size`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/), [`margins`](../../../com.aspose.html.drawing/page/margin/), [`CSS media-type`](../../../com.aspose.html.rendering/mediatype/) 등을 지정할 수 있습니다. |
| provider | ICreateStreamProvider | 출력 스트림을 얻기 위해 사용될 인터페이스 구현입니다. 공급자에 대한 자세한 내용은 [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/html-to-jpg/#output-stream-providers)에서 확인하세요. |
...
전체 파일 경로로 제공된 HTML 소스를 이미지로 변환합니다. 결과는 [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) 인터페이스 구현에 의해 형성된 출력 데이터입니다.
...
인라인 콘텐츠로 제공된 HTML 소스를 이미지로 변환합니다. 결과는 [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) 인터페이스 구현에 의해 형성된 출력 데이터입니다.
...
| 내용 | String | 인라인 html 콘텐츠 문자열. |
| baseUri | String | 문서의 기본 URI입니다. 현재 디렉터리 경로와 결합되어 절대 URL을 형성합니다. |
| configuration | Configuration | 환경 구성입니다. 애플리케이션의 환경 설정을 구성하는 데 사용되는 [`configuration `](../../../com.aspose.html/configuration/) 컨텍스트 객체를 나타냅니다. |
| options | ImageSaveOptions | ImageSaveOptions 객체 사용을 통해 렌더링 프로세스를 조정할 수 있습니다. [`page size`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/), [`margins`](../../../com.aspose.html.drawing/page/margin/), [`CSS media-type`](../../../com.aspose.html.rendering/mediatype/) 등을 지정할 수 있습니다. |
| provider | ICreateStreamProvider | `[`interface`](../../../com.aspose.html.io/icreatestreamprovider/)`의 구현으로, 출력 스트림을 얻는 데 사용됩니다. 공급자에 대한 자세한 내용은 [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/html-to-jpg/#output-stream-providers)에서 확인하세요. |
...
html 문서를 텍스트로 변환합니다. 결과는 TXT 파일입니다.
...
| Parameter | Type | 설명 |
| --- | --- | --- |
| 문서 | HTMLDocument | 변환 소스. |
| options | TextSaveOptions | 변환 옵션. |
