...
description: "ICSS2Properties 속성. orphans 속성은 페이지 하단에 남겨야 하는 단락의 최소 줄 수를 지정합니다. widows 속성은 페이지 상단에 남겨야 하는 단락의 최소 줄 수를 지정합니다. 페이지 나눔을 제어하는 데 사용되는 예시는 아래에 제시됩니다."
type: docs
