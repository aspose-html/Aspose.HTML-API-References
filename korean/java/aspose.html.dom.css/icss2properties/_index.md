---
title: "ICSS2Properties 인터페이스"
second_title: "Java용 Aspose.HTML API 참조"
description: "com.aspose.html.dom.css.ICSS2Properties 인터페이스. CSS2Properties 인터페이스는 CSSStyleDeclaration 내의 속성을 가져오고 설정하기 위한 편리한 메커니즘을 제공합니다. 이 인터페이스의 속성들은 CSS2에 지정된 모든 속성과 대응됩니다. 이 인터페이스의 속성을 가져오는 것은 CSSStyleDeclaration 인터페이스의 getPropertyValue 메서드를 호출하는 것과 동일합니다. 이 인터페이스의 속성을 설정하는 것은 CSSStyleDeclaration 인터페이스의 setProperty 메서드를 호출하는 것과 동일합니다."
type: docs

url: /ko/java/com.aspose.html.dom.css/icss2properties/
---
## ICSS2Properties interface

CSS2Properties 인터페이스는 [`CSSStyleDeclaration`](../icssstyledeclaration/) 내의 속성을 가져오고 설정하기 위한 편리한 메커니즘을 제공합니다. 이 인터페이스의 속성들은 CSS2에 지정된 모든 속성과 대응됩니다. 이 인터페이스의 속성을 가져오는 것은 [`CSSStyleDeclaration`](../icssstyledeclaration/) 인터페이스의 getPropertyValue 메서드를 호출하는 것과 동일합니다. 이 인터페이스의 속성을 설정하는 것은 [`CSSStyleDeclaration`](../icssstyledeclaration/) 인터페이스의 setProperty 메서드를 호출하는 것과 동일합니다.
