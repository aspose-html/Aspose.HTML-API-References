...
description: "com.aspose.html.dom.css.ICSSKeyframesRule interface. CSSKeyframeRule 인터페이스의 name 속성은 animation-name 속성에서 사용되는 애니메이션 이름을 가져오고 설정합니다."
type: docs
...
| [deleteRule](../../com.aspose.html.dom.css/icsskeyframesrule/deleterule/)(String) | deleteRule 메서드는 전달된 키를 가진 [`CSSKeyframeRule`](../icsskeyframerule/)을 삭제합니다. 해당 키를 가진 규칙이 없으면 메서드는 아무 작업도 수행하지 않습니다. |
