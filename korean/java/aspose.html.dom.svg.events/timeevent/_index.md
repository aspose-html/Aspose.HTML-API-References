...
description: "com.aspose.html.dom.svg.events.TimeEvent 클래스. TimeEvent 인터페이스는 Time 이벤트와 관련된 특정 컨텍스트 정보를 제공합니다. 발생할 수 있는 다양한 이벤트 유형은 beginEvent, endEvent 및 repeatEvent입니다."
type: docs
...
TimeEvent 인터페이스는 시간 이벤트와 관련된 특정 컨텍스트 정보를 제공합니다. 발생할 수 있는 다양한 이벤트 유형은: beginEvent, endEvent 및 repeatEvent입니다.
...
| [initTimeEvent](../../com.aspose.html.dom.svg.events/timeevent/inittimeevent/)(String, IAbstractView, long) | initTimeEvent 메서드는 DocumentEvent 인터페이스를 통해 생성된 TimeEvent의 값을 초기화하는 데 사용됩니다. 이 메서드는 TimeEvent가 dispatchEvent 메서드로 전달되기 전에만 호출할 수 있지만, 필요에 따라 해당 단계에서 여러 번 호출될 수 있습니다. 여러 번 호출된 경우, 마지막 호출이 우선합니다. |
