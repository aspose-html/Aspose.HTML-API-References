---
title: "SVGMarkerElement 클래스"
second_title: "Aspose.HTML for Java API 참조"
description: "com.aspose.html.dom.svg.SVGMarkerElement 클래스. SVGMarkerElement 인터페이스는 marker 요소에 해당합니다."
type: docs

url: /ko/java/com.aspose.html.dom.svg/svgmarkerelement/
---
...
| [getMarkerHeight](../../com.aspose.html.dom.svg/svgmarkerelement/markerheight/) 주어진 ‘marker’ 요소의 ‘markerHeight’ 속성에 해당합니다. |
| [getMarkerUnits](../../com.aspose.html.dom.svg/svgmarkerelement/markerunits/) 주어진 ‘marker’ 요소의 ‘markerUnits’ 속성에 해당합니다. 이 인터페이스에 정의된 마커 단위 유형 중 하나입니다. |
| [getMarkerWidth](../../com.aspose.html.dom.svg/svgmarkerelement/markerwidth/) 주어진 ‘marker’ 요소의 ‘markerWidth’ 속성에 해당합니다. |
...
| [getOrientAngle](../../com.aspose.html.dom.svg/svgmarkerelement/orientangle/) 주어진 ‘marker’ 요소의 ‘orient’ 속성에 해당합니다. markerUnits가 SVG_MARKER_ORIENT_ANGLE인 경우, ‘orient’ 속성의 각도 값이며; 그렇지 않으면 0으로 설정됩니다. |
| [getOrientType](../../com.aspose.html.dom.svg/svgmarkerelement/orienttype/) 주어진 ‘marker’ 요소의 ‘orient’ 속성에 해당합니다. 이 인터페이스에 정의된 마커 방향 유형 중 하나입니다. |
[getOuterHTML]
...
| [getPreserveAspectRatio](../../com.aspose.html.dom.svg/svgmarkerelement/preserveaspectratio/) 주어진 요소의 ‘preserveAspectRatio’ 속성에 해당합니다. |
...
| [getRefX](../../com.aspose.html.dom.svg/svgmarkerelement/refx/) 주어진 ‘marker’ 요소의 ‘refX’ 속성에 해당합니다. |
| [getRefY](../../com.aspose.html.dom.svg/svgmarkerelement/refy/) 주어진 ‘marker’ 요소의 ‘refY’ 속성에 해당합니다. |
...
| [getViewBox](../../com.aspose.html.dom.svg/svgmarkerelement/viewbox/) 주어진 요소의 ‘viewBox’ 속성에 해당합니다. |
...
| [setOrientToAngle](../../com.aspose.html.dom.svg/svgmarkerelement/setorienttoangle/)(SVGAngle) | ‘orient’ 속성의 값을 주어진 각도로 설정합니다. |
| [setOrientToAuto](../../com.aspose.html.dom.svg/svgmarkerelement/setorienttoauto/)() | ‘orient’ 속성의 값을 'auto'로 설정합니다. |
...
| 이름 | 설명 |
| --- | --- |
| const [SVG_MARKERUNITS_STROKEWIDTH](../../com.aspose.html.dom.svg/svgmarkerelement/svg_markerunits_strokewidth/) | ‘markerUnits’ 속성의 값은 'strokeWidth'입니다. |
| const [SVG_MARKERUNITS_UNKNOWN](../../com.aspose.html.dom.svg/svgmarkerelement/svg_markerunits_unknown/) | 마커 단위 유형이 사전 정의된 유형 중 하나가 아닙니다. 이 유형의 새 값을 정의하거나 기존 값을 이 유형으로 전환하려는 시도는 유효하지 않습니다. |
| const [SVG_MARKERUNITS_USERSPACEONUSE](../../com.aspose.html.dom.svg/svgmarkerelement/svg_markerunits_userspaceonuse/) | ‘markerUnits’ 속성의 값은 'userSpaceOnUse'입니다. |
| const [SVG_MARKER_ORIENT_ANGLE](../../com.aspose.html.dom.svg/svgmarkerelement/svg_marker_orient_angle/) | ‘orient’ 속성은 각도 값을 가집니다. |
| const [SVG_MARKER_ORIENT_AUTO](../../com.aspose.html.dom.svg/svgmarkerelement/svg_marker_orient_auto/) | ‘orient’ 속성은 'auto' 값을 가집니다. |
| const [SVG_MARKER_ORIENT_UNKNOWN](../../com.aspose.html.dom.svg/svgmarkerelement/svg_marker_orient_unknown/) | 마커 방향이 사전 정의된 유형 중 하나가 아닙니다. 이 유형의 새 값을 정의하거나 기존 값을 이 유형으로 전환하려는 시도는 유효하지 않습니다. |
