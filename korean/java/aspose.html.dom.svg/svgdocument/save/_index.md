...
description: "SVGDocument 메서드. url로 지정된 로컬 파일에 문서를 저장합니다. 이 문서에서 사용된 모든 리소스는 output_file_name_files라는 이름의 인접 폴더에 저장됩니다."
type: docs
...
`url`로 지정된 로컬 파일에 문서를 저장합니다. 이 문서에서 사용된 모든 리소스는 인접 폴더에 저장되며, 폴더 이름은 output_file_name + "_files" 형태로 구성됩니다.
...
`path`로 지정된 로컬 파일에 문서를 저장합니다. 이 문서에서 사용된 모든 리소스는 인접 폴더에 저장되며, 폴더 이름은 output_file_name + "_files" 형태로 구성됩니다.
