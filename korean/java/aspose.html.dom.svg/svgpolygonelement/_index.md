...
| 이름 | 설명 |
| --- | --- |
| [getAnimatedPoints](../../com.aspose.html.dom.svg/svgpolygonelement/animatedpoints/) ‘points’ 속성의 현재 애니메이션된 내용을 액세스합니다. 해당 속성이나 프로퍼티가 애니메이션 중이면, 현재 애니메이션된 값을 포함합니다. 애니메이션 중이 아니면, points와 동일한 값을 포함합니다. |
...
| [getPoints](../../com.aspose.html.dom.svg/svgpolygonelement/points/) ‘points’ 속성의 기본(즉, 정적) 내용을 액세스합니다. |
