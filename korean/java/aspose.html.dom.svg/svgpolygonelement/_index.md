---
title: "SVGPolygonElement 클래스"
second_title: "Aspose.HTML for Java API 참조"
description: "com.aspose.html.dom.svg.SVGPolygonElement 클래스. SVGPolygonElement 인터페이스는 polygon 요소에 해당합니다."
type: docs

url: /ko/java/com.aspose.html.dom.svg/svgpolygonelement/
---
## SVGPolygonElement class

SVGPolygonElement 인터페이스는 ‘polygon’ 요소에 해당합니다.
...
| 이름 | 설명 |
| --- | --- |
| [getAnimatedPoints](../../com.aspose.html.dom.svg/svgpolygonelement/animatedpoints/) 현재 ‘points’ 속성의 애니메이션된 내용을 제공합니다. 해당 속성이나 프로퍼티가 애니메이션 중이면, 현재 애니메이션된 값을 포함합니다. 해당 속성이나 프로퍼티가 현재 애니메이션되지 않은 경우, points와 동일한 값을 포함합니다. |
...
| [getPoints](../../com.aspose.html.dom.svg/svgpolygonelement/points/) ‘points’ 속성의 기본(즉, 정적) 내용을 제공합니다. |
