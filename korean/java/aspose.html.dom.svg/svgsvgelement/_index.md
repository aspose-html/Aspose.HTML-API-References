...
description: "com.aspose.html.dom.svg.SVGSVGElement 클래스. 주요 인터페이스 정의는 svg 요소에 해당하는 SVGSVGElement 인터페이스이며, 이 인터페이스는 행렬 연산 및 시각 렌더링 장치에서 다시 그리기 시간을 제어하는 기능과 같은 다양한 일반적으로 사용되는 유틸리티 메서드를 포함합니다."
type: docs
...
핵심 인터페이스 정의는 SVGSVGElement 인터페이스이며, 이는 ‘svg’ 요소에 해당하는 인터페이스입니다. 이 인터페이스는 행렬 연산 및 시각 렌더링 장치에서 다시 그리기 시간을 제어하는 기능과 같은 다양한 일반적으로 사용되는 유틸리티 메서드를 포함합니다.
...
| [getCurrentTranslate](../../com.aspose.html.dom.svg/svgsvgelement/currenttranslate/) 최외곽 svg 요소에서 사용자 \"확대\"를 고려한 해당 변환 계수를 나타냅니다. 최외곽 svg 요소가 아닌 ‘svg’ 요소에서 접근할 경우, 이 속성의 동작은 정의되지 않습니다. |
...
| [getHeight](../../com.aspose.html.dom.svg/svgsvgelement/height/) 주어진 ‘svg’ 요소의 ‘height’ 속성에 해당합니다. |
[getId]
...
| [getPreserveAspectRatio](../../com.aspose.html.dom.svg/svgsvgelement/preserveaspectratio/) 주어진 요소의 ‘preserveAspectRatio’ 속성에 해당합니다. |
...
| [getViewBox](../../com.aspose.html.dom.svg/svgsvgelement/viewbox/) 주어진 요소의 ‘viewBox’ 속성에 해당합니다. |
...
| [getWidth](../../com.aspose.html.dom.svg/svgsvgelement/width/) 주어진 ‘svg’ 요소의 ‘width’ 속성에 해당합니다. |
| [X](../../com.aspose.html.dom.svg/svgsvgelement/x/) { get; } | 주어진 ‘svg’ 요소의 ‘x’ 속성에 해당합니다. |
| [Y](../../com.aspose.html.dom.svg/svgsvgelement/y/) { get; } | 주어진 ‘svg’ 요소의 ‘y’ 속성에 해당합니다. |
[getZoomAndPan]
...
| [createEvent](../../com.aspose.html.dom.svg/svgsvgelement/createevent/)(String) | 구현에서 지원하는 유형의 [`Event`](../../com.aspose.html.dom.events/event/)을 생성합니다. |
...
| [createSVGPoint](../../com.aspose.html.dom.svg/svgsvgelement/createsvgpoint/)() | 문서 트리 외부에서 SVGPoint 객체를 생성합니다. 객체는 사용자 좌표계에서 (0,0) 점으로 초기화됩니다. |
...
| [createSVGTransformFromMatrix](../../com.aspose.html.dom.svg/svgsvgelement/createsvgtransformfrommatrix/)(SVGMatrix) | 문서 트리 외부에서 SVGTransform 객체를 생성합니다. 객체는 주어진 행렬 변환(예: SVG_TRANSFORM_MATRIX)으로 초기화됩니다. 매개변수 행렬의 값이 복사되며, 행렬 매개변수는 SVGTransform::matrix로 채택되지 않습니다. |
...
| [getCurrentTime](../../com.aspose.html.dom.svg/svgsvgelement/getcurrenttime/)() | 현재 SVG 문서 조각의 시작 시간에 대한 상대적인 현재 시간을 초 단위로 반환합니다. 문서 타임라인이 시작되기 전에 getCurrentTime이 호출되면(예: ‘script’ 요소에서 실행되는 스크립트가 문서의 SVGLoad 이벤트가 발생하기 전에 호출되는 경우) 0을 반환합니다. |
| [getElementById](../../com.aspose.html.dom.svg/svgsvgelement/getelementbyid/)(String) | 이 SVG 문서 조각(즉, 검색이 문서 트리의 일부에 제한됨)에서 elementId로 지정된 id를 가진 Element를 검색합니다. Element가 발견되면 해당 Element를 반환합니다. 존재하지 않으면 null을 반환합니다. 동일한 id를 가진 요소가 둘 이상인 경우 동작은 정의되지 않습니다. |
...
| [pauseAnimations](../../com.aspose.html.dom.svg/svgsvgelement/pauseanimations/)() | 이 ‘svg’ 요소에 해당하는 SVG 문서 조각 내에 정의된 현재 실행 중인 모든 애니메이션을 일시 중지(즉, 정지)시켜, 해당 문서 조각의 애니메이션 시계가 재개될 때까지 멈추게 합니다. |
...
| [setCurrentTime](../../com.aspose.html.dom.svg/svgsvgelement/setcurrenttime/)(float) | 이 SVG 문서 조각의 시계를 조정하여 새로운 현재 시간을 설정합니다. setCurrentTime이 문서 타임라인이 시작되기 전에 호출되면(예: 문서의 SVGLoad 이벤트가 발생하기 전에 ‘script’ 요소에서 실행되는 스크립트에 의해), 메서드의 마지막 호출에서 반환된 초 값은 문서 타임라인이 시작된 후 문서가 이동할 시간을 나타냅니다. |
