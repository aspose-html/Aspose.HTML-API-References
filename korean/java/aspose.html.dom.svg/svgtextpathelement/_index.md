---
title: "SVGTextPathElement 클래스"
second_title: "Java용 Aspose.HTML API 참조"
description: "com.aspose.html.dom.svg.SVGTextPathElement 클래스. SVGTextPathElement 인터페이스는 textPath 요소에 해당합니다."
type: docs

url: /ko/java/com.aspose.html.dom.svg/svgtextpathelement/
---
...
| [getHref](../../com.aspose.html.dom.svg/svgtextpathelement/href/) 주어진 요소의 ‘xlink:href’ 속성에 해당한다. |
[getId]
...
| [getLengthAdjust](../../com.aspose.html.dom.svg/svgtextcontentelement/lengthadjust/) 지정된 요소의 ‘lengthAdjust’ 속성에 해당합니다. 값은 이 인터페이스에 정의된 길이 조정 상수 중 하나여야 합니다. |
...
| [getMethod](../../com.aspose.html.dom.svg/svgtextpathelement/method/) 주어진 ‘textPath’ 요소의 ‘method’ 속성에 해당한다. |
...
| [getSpacing](../../com.aspose.html.dom.svg/svgtextpathelement/spacing/) 주어진 ‘textPath’ 요소의 ‘spacing’ 속성에 해당한다. |
| [getStartOffset](../../com.aspose.html.dom.svg/svgtextpathelement/startoffset/) 주어진 ‘textPath’ 요소의 ‘startOffset’ 속성에 해당한다. |
...
| [getTextLength](../../com.aspose.html.dom.svg/svgtextcontentelement/textlength/) 지정된 요소의 ‘textLength’ 속성에 해당합니다. |
...
| [getComputedTextLength](../../com.aspose.html.dom.svg/svgtextcontentelement/getcomputedtextlength/)() | 이 요소 내의 모든 문자들을 렌더링하면서 발생하는 전진값들의 총합으로, 글리프(수평 또는 수직)의 전진값, ‘kerning’, ‘letter-spacing’, ‘word-spacing’ 속성의 효과, 그리고 ‘tspan’ 요소의 ‘dx’ 및 ‘dy’ 속성에 의한 조정이 포함됩니다. 렌더링되지 않는 환경에서는 사용자 에이전트가 글리프 메트릭에 대해 합리적인 가정을 해야 합니다. |
...
| [getNumberOfChars](../../com.aspose.html.dom.svg/svgtextcontentelement/getnumberofchars/)() | 현재 요소 내에서 렌더링할 수 있는 문자 총수를 반환합니다. 여기에는 ‘tref’ 참조에서 가져온 문자도 포함되며, 실제로 렌더링 여부와 관계없이 포함됩니다. 실제로 이는 DOM Level 3 Core ([DOM3], 섹션 1.4)의 Node::textContent 속성 길이와 동일하며, 해당 속성이 ‘tref’ 요소까지 확장된 경우에 해당합니다. |
...
| 이름 | 설명 |
| --- | --- |
| const [TEXTPATH_METHODTYPE_ALIGN](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_align/) | 값 'align'에 해당한다. |
| const [TEXTPATH_METHODTYPE_STRETCH](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_stretch/) | 값 'stretch'에 해당한다. |
| const [TEXTPATH_METHODTYPE_UNKNOWN](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_unknown/) | 열거형이 미리 정의된 유형 중 하나가 아닌 값으로 설정되었습니다. 이 유형의 새 값을 정의하거나 기존 값을 이 유형으로 전환하려는 시도는 유효하지 않습니다. |
| const [TEXTPATH_SPACINGTYPE_AUTO](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_auto/) | 값 'auto'에 해당한다. |
| const [TEXTPATH_SPACINGTYPE_EXACT](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_exact/) | 값 'exact'에 해당한다. |
| const [TEXTPATH_SPACINGTYPE_UNKNOWN](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_unknown/) | 열거형이 미리 정의된 유형 중 하나가 아닌 값으로 설정되었습니다. 이 유형의 새 값을 정의하거나 기존 값을 이 유형으로 전환하려는 시도는 유효하지 않습니다. |
