...
| 이름 | 설명 |
| --- | --- |
| [getAnimatedPathSegList](../../com.aspose.html.dom.svg/svgpathelement/animatedpathseglist/) ‘d’ 속성의 현재 애니메이션된 내용을 SVG 구문과 일대일로 일치하는 형태로 제공합니다. 해당 속성이나 프로퍼티가 애니메이션 중이면 속성 또는 프로퍼티의 현재 애니메이션된 값을 포함하며, 객체 자체와 그 내용은 읽기 전용입니다. 해당 속성이나 프로퍼티가 현재 애니메이션되지 않은 경우, pathSegList와 동일한 값을 포함합니다. |
...
| [getClassName](../../com.aspose.html.dom.svg/svgelement/classname/) 지정된 요소의 ‘class’ 속성에 해당합니다. |
[getClassName]
...
| [getFarthestViewportElement](../../com.aspose.html.dom.svg/svggraphicselement/farthestviewportelement/) 가장 먼 조상 ‘svg’ 요소. 현재 요소가 가장 바깥쪽 svg 요소인 경우 null. |
...
| [getNearestViewportElement](../../com.aspose.html.dom.svg/svggraphicselement/nearestviewportelement/) 현재 뷰포트를 설정한 요소. 일반적으로 가장 가까운 조상 ‘svg’ 요소입니다. 현재 요소가 가장 바깥쪽 svg 요소인 경우 null. |
...
| [getOwnerSVGElement](../../com.aspose.html.dom.svg/svgelement/ownersvgelement/) 가장 가까운 상위 ‘svg’ 요소를 반환합니다. 주어진 요소가 최외곽 svg 요소인 경우 null을 반환합니다. |
...
| [getPathLength](../../com.aspose.html.dom.svg/svggeometryelement/pathlength/) 지정된 요소의 pathLength 속성에 해당합니다. |
[getPathSegList]
...
| [getViewportElement](../../com.aspose.html.dom.svg/svgelement/viewportelement/) 현재 뷰포트를 설정한 요소를 반환합니다. 일반적으로 가장 가까운 상위 ‘svg’ 요소이며, 주어진 요소가 최외곽 svg 요소인 경우 null을 반환합니다. |
...
| [createSVGPathSegCurvetoQuadraticAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticabs/)(float, float, float, float) | 독립적인, 부모가 없는 SVGPathSegCurvetoQuadraticAbs 객체를 반환합니다. |
| [createSVGPathSegCurvetoQuadraticRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticrel/)(float, float, float, float) | 독립적인, 부모가 없는 SVGPathSegCurvetoQuadraticRel 객체를 반환합니다. |
| [createSVGPathSegCurvetoQuadraticSmoothAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothabs/)(float, float) | 독립적인, 부모가 없는 SVGPathSegCurvetoQuadraticSmoothAbs 객체를 반환합니다. |
| [createSVGPathSegCurvetoQuadraticSmoothRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothrel/)(float, float) | 독립적인, 부모가 없는 SVGPathSegCurvetoQuadraticSmoothRel 객체를 반환합니다. |
| [createSVGPathSegLinetoAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoabs/)(float, float) | 독립적인, 부모가 없는 SVGPathSegLinetoAbs 객체를 반환합니다. |
| [createSVGPathSegLinetoHorizontalAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetohorizontalabs/)(float) | 독립적인, 부모가 없는 SVGPathSegLinetoHorizontalAbs 객체를 반환합니다. |
| [createSVGPathSegLinetoHorizontalRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetohorizontalrel/)(float) | 독립적인, 부모가 없는 SVGPathSegLinetoHorizontalRel 객체를 반환합니다. |
| [createSVGPathSegLinetoRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetorel/)(float, float) | 독립적인, 부모가 없는 SVGPathSegLinetoRel 객체를 반환합니다. |
| [createSVGPathSegLinetoVerticalAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoverticalabs/)(float) | 독립적인, 부모가 없는 SVGPathSegLinetoVerticalAbs 객체를 반환합니다. |
| [createSVGPathSegLinetoVerticalRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoverticalrel/)(float) | 독립적인, 부모가 없는 SVGPathSegLinetoVerticalRel 객체를 반환합니다. |
| [createSVGPathSegMovetoAbs](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegmovetoabs/)(float, float) | 독립적인, 부모가 없는 SVGPathSegMovetoAbs 객체를 반환합니다. |
| [createSVGPathSegMovetoRel](../../com.aspose.html.dom.svg/svgpathelement/createsvgpathsegmovetorel/)(float, float) | 독립적인, 부모가 없는 SVGPathSegMovetoRel 객체를 반환합니다. |
...
| [getBBox](../../com.aspose.html.dom.svg/svggraphicselement/getbbox/)() | 현재 사용자 공간(‘transform’ 속성이 적용된 경우)에서 모든 포함된 그래픽 요소의 기하학에 대한 정확한 경계 상자를 반환합니다(스트로크, 클리핑, 마스킹 및 필터 효과는 제외). getBBox는 메서드가 호출된 시점의 실제 경계 상자를 반환해야 하며, 요소가 아직 렌더링되지 않은 경우에도 마찬가지임을 유의하십시오. |
...
| [getScreenCTM](../../com.aspose.html.dom.svg/svggraphicselement/getscreenctm/)() | 현재 사용자 단위(‘transform’ 속성이 적용된 경우)에서 부모 사용자 에이전트가 인식하는 "픽셀"까지의 변환 행렬을 반환합니다. 표시 장치의 경우 이는 물리적 화면 픽셀을 나타냅니다. 물리적 픽셀 크기를 알 수 없는 다른 장치나 환경에서는 CSS2 정의의 "픽셀"과 유사한 알고리즘을 사용할 수 있습니다. 이 요소가 문서 트리에 연결되지 않은 경우 null을 반환한다는 점에 유의하십시오. 이 메서드는 getClientCTM이라는 이름이 더 적절했지만, 역사적 이유로 getScreenCTM이라는 이름이 유지됩니다. |
