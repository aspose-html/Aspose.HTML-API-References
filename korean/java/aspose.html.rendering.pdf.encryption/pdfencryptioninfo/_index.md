---
title: "PdfEncryptionInfo 클래스"
second_title: "Java용 Aspose.HTML API 참조"
description: "com.aspose.html.rendering.pdf.encryption.PdfEncryptionInfo 클래스. PDF 암호화에 대한 세부 정보를 포함합니다."
type: docs

url: /ko/java/com.aspose.html.rendering.pdf.encryption/pdfencryptioninfo/
---
...
| 이름 | 설명 |
| --- | --- |
| [PdfEncryptionInfo](pdfencryptioninfo/)(String, String, PdfPermissions, PdfEncryptionAlgorithm) | `PdfEncryptionInfo` 클래스의 새 인스턴스를 초기화합니다. |
