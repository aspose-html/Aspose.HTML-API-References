...
| 이름 | 설명 |
| --- | --- |
| [ImageDevice](imagedevice/#constructor)(ICreateStreamProvider) | `ImageDevice` 클래스의 새 인스턴스를 초기화합니다. |
| [ImageDevice](imagedevice/#constructor_4)(Stream) | `ImageDevice` 클래스의 새 인스턴스를 초기화합니다. |
| [ImageDevice](imagedevice/#constructor_5)(String) | `ImageDevice` 클래스의 새 인스턴스를 초기화합니다. |
| [ImageDevice](imagedevice/#constructor_1)(ImageRenderingOptions, ICreateStreamProvider) | 렌더링 옵션 및 스트림 제공자를 사용하여 `ImageDevice` 클래스의 새 인스턴스를 초기화합니다. |
| [ImageDevice](imagedevice/#constructor_2)(ImageRenderingOptions, Stream) | 렌더링 옵션 및 출력 스트림을 사용하여 `ImageDevice` 클래스의 새 인스턴스를 초기화합니다. |
| [ImageDevice](imagedevice/#constructor_3)(ImageRenderingOptions, String) | 렌더링 옵션 및 출력 파일 이름을 사용하여 `ImageDevice` 클래스의 새 인스턴스를 초기화합니다. |
