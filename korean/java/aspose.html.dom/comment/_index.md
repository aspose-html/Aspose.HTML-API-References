...
description: "com.aspose.html.dom.Comment 클래스. CharacterData를 상속하며, 주석의 내용, 즉 시작과 끝 사이의 모든 문자를 나타냅니다."
type: docs

url: /ko/java/com.aspose.html.dom/comment/
---
## Comment class

CharacterData를 상속하며, 주석의 내용, 즉 시작 '' 사이의 모든 문자를 나타냅니다.
...
| [getNodeName](../../com.aspose.html.dom/comment/nodename/) 이 노드의 유형에 따라 달라지는 노드 이름입니다. |
| [getNodeType](../../com.aspose.html.dom/comment/nodetype/) 기본 객체의 유형을 나타내는 코드입니다. |
| [nodeValue](../../com.aspose.html.dom/comment/nodevalue/) { get; set; } | 이 노드의 유형에 따라 값이 달라집니다. |
...
| [textContent](../../com.aspose.html.dom/comment/textcontent/) { get; set; } | 이 속성은 이 노드와 그 하위 노드들의 텍스트 내용을 반환합니다. null로 정의된 경우, 값을 설정해도 효과가 없습니다. 값을 설정하면 해당 노드의 모든 자식이 제거되고, 새 문자열이 비어 있지 않거나 null이 아니면 해당 문자열을 포함하는 단일 Text 노드로 교체됩니다. |
