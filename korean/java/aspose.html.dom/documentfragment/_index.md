---
title: "DocumentFragment 클래스"
second_title: "Java용 Aspose.HTML API 참조"
description: "com.aspose.html.dom.DocumentFragment 클래스. DocumentFragment는 가볍거나 최소한의 Document 객체입니다. 문서 트리의 일부를 추출하거나 새 문서 조각을 만들고자 하는 경우가 매우 흔합니다."
type: docs

url: /ko/java/com.aspose.html.dom/documentfragment/
---
## DocumentFragment class

DocumentFragment는 "경량" 또는 "최소" Document 객체입니다. 문서 트리의 일부를 추출하거나 새로운 문서 조각을 생성하고자 하는 경우가 매우 흔합니다.
...
| [replaceChild](../../com.aspose.html.dom/node/replacechild/)(Node, Node) | 자식 노드 목록에서 child 노드 oldChild를 newChild로 교체하고 oldChild 노드를 반환합니다. newChild가 `DocumentFragment` 객체인 경우, oldChild는 모든 `DocumentFragment` 자식들로 교체되며, 이들은 동일한 순서로 삽입됩니다. newChild가 이미 트리에 존재하면 먼저 제거됩니다. |
