...
description: "com.aspose.html.dom.Text 클래스. Text 인터페이스는 CharacterData를 상속하며 Element 또는 Attr의 XML에서 문자 데이터라고 하는 텍스트 내용을 나타냅니다."
type: docs

url: /ko/java/com.aspose.html.dom/text/
---
## Text class

Text 인터페이스는 CharacterData를 상속하며 Element 또는 Attr의 텍스트 콘텐츠(XML에서는 문자 데이터라고 함)를 나타냅니다.
...
| [getNodeName](../../com.aspose.html.dom/text/nodename/) 이 노드의 유형에 따라 달라지는 이름입니다. |
| [getNodeType](../../com.aspose.html.dom/text/nodetype/) 기본 객체의 유형을 나타내는 코드입니다. |
