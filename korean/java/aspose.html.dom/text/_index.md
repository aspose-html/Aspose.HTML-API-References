...
description: "com.aspose.html.dom.Text 클래스. Text 인터페이스는 CharacterData를 상속하며 Element 또는 Attr의 XML에서 문자 데이터라고 불리는 텍스트 내용을 나타냅니다."
type: docs
