...
description: "com.aspose.html.dom.Entity 클래스. XML 문서에서 구문 분석되었거나 구문 분석되지 않은 알려진 엔터티를 나타냅니다."
type: docs
...
| [getInputEncoding](../../com.aspose.html.dom/entity/inputencoding/) 외부 구문 분석 엔터티인 경우 파싱 시 이 엔터티에 사용된 인코딩을 지정하는 속성입니다. 내부 하위 집합의 엔터티이거나 알 수 없는 경우 null입니다. |
...
| [getNodeName](../../com.aspose.html.dom/entity/nodename/) 해당 노드의 이름이며, 노드 유형에 따라 달라집니다. |
| [getNodeType](../../com.aspose.html.dom/entity/nodetype/) 기본 객체 유형을 나타내는 코드입니다. |
| [nodeValue](../../com.aspose.html.dom/node/nodevalue/) { get; set; } | `[`Node `](../node/)` 인터페이스의 nodeValue 속성은 현재 노드의 값을 반환하거나 설정합니다. |
| [getNotationName](../../com.aspose.html.dom/entity/notationname/) 구문 분석되지 않은 엔터티의 경우 엔터티에 대한 표기법 이름을 나타냅니다. 구문 분석된 엔터티인 경우 null입니다. |
...
| [getPublicId](../../com.aspose.html.dom/entity/publicid/) 지정된 경우 엔터티와 연결된 공개 식별자를 나타내며, 그렇지 않으면 null입니다. |
| [getSystemId](../../com.aspose.html.dom/entity/systemid/) 지정된 경우 엔터티와 연결된 시스템 식별자를 나타내며, 그렇지 않으면 null입니다. 이는 절대 URI일 수도 있고 아닐 수도 있습니다. |
| [textContent](../../com.aspose.html.dom/node/textcontent/) { get; set; } | `[`Node`](../node/)` 인터페이스의 textContent 속성은 노드와 그 하위 노드들의 텍스트 내용을 나타냅니다. |
| [getXmlEncoding](../../com.aspose.html.dom/entity/xmlencoding/) 외부 구문 분석 엔터티인 경우 텍스트 선언의 일부로 이 엔터티의 인코딩을 지정하는 속성입니다. 그렇지 않으면 null입니다. |
| [getXmlVersion](../../com.aspose.html.dom/entity/xmlversion/) 외부 구문 분석 엔터티인 경우 텍스트 선언의 일부로 이 엔터티의 버전 번호를 지정하는 속성입니다. 그렇지 않으면 null입니다. |
