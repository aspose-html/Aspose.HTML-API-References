...
description: "Document 메서드. XPath 식 문자열을 평가하고 가능한 경우 지정된 유형의 결과를 반환합니다."
type: docs
...
| contextNode | Node | 컨텍스트는 이 XPath 식을 평가하기 위한 컨텍스트 노드입니다. |
| resolver | IXPathNSResolver | 해결자는 XPath 식 내의 모든 접두사(예: xml 패키지 접두사)를 적절한 패키지 URI로 변환할 수 있도록 허용합니다. |
