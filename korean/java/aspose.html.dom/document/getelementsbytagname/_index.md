...
전체 문서를 검색하며, 루트 노드도 포함합니다. 반환된 [`HTMLCollection`](../../../com.aspose.html.collections/htmlcollection/)은 라이브 컬렉션으로, document.getElementsByTagName()을 다시 호출하지 않아도 자동으로 업데이트되어 DOM 트리와 동기화됩니다.
...
| Parameter | Type | 설명 |
| --- | --- | --- |
| tagname | String | 요소의 이름을 나타내는 문자열입니다. 특수 문자열 "*"은 모든 요소를 의미합니다. |
...
공식 [spec](https://dom.spec.whatwg.org/#dom-document-getelementsbytagname)을 참조하세요.
