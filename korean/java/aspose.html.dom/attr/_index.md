...
description: "com.aspose.html.dom.Attr 클래스. Attr 인터페이스는 Element 객체의 속성을 나타냅니다. 일반적으로 해당 속성의 허용 값은 문서와 연결된 스키마에 정의됩니다."
type: docs

url: /ko/java/com.aspose.html.dom/attr/
---
## Attr class

Attr 인터페이스는 Element 객체의 속성을 나타냅니다. 일반적으로 해당 속성의 허용 값은 문서와 연관된 스키마에 정의됩니다.
...
| [getLocalName](../../com.aspose.html.dom/attr/localname/) 이 노드의 정규화된 이름 중 로컬 부분을 반환합니다. ELEMENT_NODE 및 ATTRIBUTE_NODE가 아닌 모든 유형의 노드와 Document.createElement()와 같은 DOM Level 1 메서드로 생성된 노드의 경우, 항상 null을 반환합니다. |
| [getName](../../com.aspose.html.dom/attr/name/) 이 속성의 이름을 반환합니다. |
| [getNamespaceURI](../../com.aspose.html.dom/attr/packageuri/) 이 노드의 패키지 URI를 반환하며, 지정되지 않은 경우 null을 반환합니다. |
...
| [getNodeName](../../com.aspose.html.dom/attr/nodename/) 이 노드의 유형에 따라 이름을 반환합니다. |
| [getNodeType](../../com.aspose.html.dom/attr/nodetype/) 기본 객체의 유형을 나타내는 코드입니다. |
| [nodeValue](../../com.aspose.html.dom/attr/nodevalue/) { get; set; } | 이 노드의 유형에 따라 값이 달라집니다. |
| [getOwnerDocument](../../com.aspose.html.dom/node/ownerdocument/) Node 인터페이스의 읽기 전용 ownerDocument 속성은 해당 노드의 최상위 문서 객체를 반환합니다. |
| [getOwnerElement](../../com.aspose.html.dom/attr/ownerelement/) 이 속성이 연결된 Element 노드를 반환하며, 사용되지 않는 경우 null을 반환합니다. |
...
| [getPrefix](../../com.aspose.html.dom/attr/prefix/) 이 노드의 패키지 접두사를 반환하며, 지정되지 않은 경우 null을 반환합니다. null로 정의된 경우, 이를 설정해도 효과가 없습니다. |
...
| [getSpecified](../../com.aspose.html.dom/attr/specified/) 인스턴스 문서에서 이 속성에 명시적으로 값이 지정된 경우 true, 그렇지 않으면 false입니다. |
| [textContent](../../com.aspose.html.dom/attr/textcontent/) { get; set; } | 이 속성은 이 노드와 그 하위 노드들의 텍스트 내용을 반환합니다. null로 정의된 경우, 값을 설정해도 효과가 없습니다. 값을 설정하면 해당 노드의 모든 자식이 제거되고, 새 문자열이 비어 있지 않거나 null이 아니면 해당 문자열을 포함하는 단일 Text 노드로 교체됩니다. |
[getValue]
