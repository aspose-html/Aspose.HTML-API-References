...
description: "Node 속성. Node 인터페이스의 읽기 전용 childNodes 속성은 지정된 요소의 자식 노드들에 대한 실시간 NodeList를 반환하며, 첫 번째 자식 노드는 인덱스 0을 가집니다. 자식 노드에는 요소, 텍스트 및 주석이 포함됩니다."
type: docs
...
Node 인터페이스의 읽기 전용 childNodes 속성은 지정된 요소의 자식 노드에 대한 실시간 [`NodeList`](../../../com.aspose.html.collections/nodelist/)를 반환하며, 첫 번째 자식 노드는 인덱스 0을 가집니다. 자식 노드에는 요소, 텍스트 및 주석이 포함됩니다.
...
참고: childNodes를 여러 번 호출하면 동일한 [`NodeList`](../../../com.aspose.html.collections/nodelist/)를 반환합니다.
