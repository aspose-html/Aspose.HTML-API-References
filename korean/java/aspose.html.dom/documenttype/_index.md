...
| 이름 | 설명 |
| --- | --- |
| [DocumentType](documenttype/)(String, String, String, String, Document) | `DocumentType` 클래스의 새 인스턴스를 초기화합니다. |
...
| [getName](../../com.aspose.html.dom/documenttype/name/) DTD의 이름입니다; 즉, DOCTYPE 키워드 바로 뒤에 오는 이름입니다. |
...
| [getNodeName](../../com.aspose.html.dom/documenttype/nodename/) 이 노드의 이름은 유형에 따라 달라집니다. |
