---
title: "SVGFEConvolveMatrixElement 클래스"
second_title: "Aspose.HTML for Java API 참조"
description: "com.aspose.html.dom.svg.filters.SVGFEConvolveMatrixElement 클래스. SVGFEConvolveMatrixElement 인터페이스는 feConvolveMatrix 요소에 해당합니다."
type: docs

url: /ko/java/com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/
---
...
| [getBias](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/bias/) 주어진 ‘feConvolveMatrix’ 요소의 ‘bias’ 속성에 해당합니다. |
...
| [getDivisor](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/divisor/) 주어진 ‘feConvolveMatrix’ 요소의 ‘divisor’ 속성에 해당합니다. |
| [getEdgeMode](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/edgemode/) 주어진 ‘feConvolveMatrix’ 요소의 ‘edgeMode’ 속성에 해당합니다. |
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/height/) 주어진 ‘filter’ 요소의 ‘height’ 속성에 해당합니다. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/in1/) 주어진 ‘feConvolveMatrix’ 요소의 ‘in’ 속성에 해당합니다. |
[getInnerHTML]
...
| [getKernelMatrix](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelmatrix/) 주어진 ‘feConvolveMatrix’ 요소의 ‘kernelMatrix’ 속성에 해당합니다. |
| [getKernelUnitLengthX](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelunitlengthx/) 주어진 ‘feConvolveMatrix’ 요소의 ‘kernelUnitLength’ 속성에 해당합니다. |
| [getKernelUnitLengthY](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelunitlengthy/) 주어진 ‘feConvolveMatrix’ 요소의 ‘kernelUnitLength’ 속성에 해당합니다. |
...
| [getOrderX](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/orderx/) 주어진 ‘feConvolveMatrix’ 요소의 ‘order’ 속성에 해당합니다. |
| [getOrderY](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/ordery/) 주어진 ‘feConvolveMatrix’ 요소의 ‘order’ 속성에 해당합니다. |
[getOuterHTML]
...
| [getPreserveAlpha](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/preservealpha/) 주어진 ‘feConvolveMatrix’ 요소의 ‘preserveAlpha’ 속성에 해당합니다. |
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/result/) 주어진 ‘filter’ 요소의 ‘result’ 속성에 해당합니다. |
...
| [getTargetX](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/targetx/) 주어진 ‘feConvolveMatrix’ 요소의 ‘targetX’ 속성에 해당합니다. |
| [getTargetY](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/targety/) 주어진 ‘feConvolveMatrix’ 요소의 ‘targetY’ 속성에 해당합니다. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/width/) 주어진 ‘filter’ 요소의 ‘width’ 속성에 해당합니다. |
| [X](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/x/) { get; } | 지정된 ‘filter’ 요소의 ‘x’ 속성에 해당합니다. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/y/) { get; } | 지정된 ‘filter’ 요소의 ‘y’ 속성에 해당합니다. |
...
| 이름 | 설명 |
| --- | --- |
| const [SVG_EDGEMODE_DUPLICATE](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_duplicate/) | 값 'duplicate'에 해당합니다. |
| const [SVG_EDGEMODE_NONE](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_none/) | 값 'none'에 해당합니다. |
| const [SVG_EDGEMODE_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_unknown/) | 이 유형은 미리 정의된 유형 중 하나가 아닙니다. 이 유형의 새 값을 정의하거나 기존 값을 이 유형으로 전환하려는 시도는 유효하지 않습니다. |
| const [SVG_EDGEMODE_WRAP](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_wrap/) | 값 'wrap'에 해당합니다. |
