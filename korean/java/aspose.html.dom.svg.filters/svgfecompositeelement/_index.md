---
title: "SVGFECompositeElement 클래스"
second_title: "Aspose.HTML for Java API 참조"
description: "com.aspose.html.dom.svg.filters.SVGFECompositeElement 클래스. SVGFECompositeElement 인터페이스는 feComposite 요소에 해당합니다."
type: docs

url: /ko/java/com.aspose.html.dom.svg.filters/svgfecompositeelement/
---
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/height/) 해당 ‘filter’ 요소의 ‘height’ 속성에 해당합니다. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/in1/) 해당 ‘feComposite’ 요소의 ‘in’ 속성에 해당합니다. |
| [getIn2](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/in2/) 해당 ‘feComposite’ 요소의 ‘in2’ 속성에 해당합니다. |
[getInnerHTML]
...
| [getK1](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k1/) 해당 ‘feComposite’ 요소의 ‘k1’ 속성에 해당합니다. |
| [getK2](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k2/) 해당 ‘feComposite’ 요소의 ‘k2’ 속성에 해당합니다. |
| [getK3](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k3/) 해당 ‘feComposite’ 요소의 ‘k3’ 속성에 해당합니다. |
| [getK4](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k4/) 해당 ‘feComposite’ 요소의 ‘k4’ 속성에 해당합니다. |
...
| [getOperator](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/operator/) 해당 ‘feComposite’ 요소의 ‘operator’ 속성에 해당합니다. 이 인터페이스에 정의된 SVG_FECOMPOSITE_OPERATOR_* 상수 중 하나를 사용합니다. |
[getOuterHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/result/) 해당 ‘filter’ 요소의 ‘result’ 속성에 해당합니다. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/width/) 해당 ‘filter’ 요소의 ‘width’ 속성에 해당합니다. |
| [X](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/x/) { get; } | 지정된 ‘filter’ 요소의 ‘x’ 속성에 해당합니다. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/y/) { get; } | 지정된 ‘filter’ 요소의 ‘y’ 속성에 해당합니다. |
...
| 이름 | 설명 |
| --- | --- |
| const [SVG_FECOMPOSITE_OPERATOR_ARITHMETIC](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_arithmetic/) | 값 'arithmetic'에 해당합니다. |
| const [SVG_FECOMPOSITE_OPERATOR_ATOP](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_atop/) | 값 'atop'에 해당합니다. |
| const [SVG_FECOMPOSITE_OPERATOR_IN](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_in/) | 값 'in'에 해당합니다. |
| const [SVG_FECOMPOSITE_OPERATOR_OUT](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_out/) | 값 'out'에 해당합니다. |
| const [SVG_FECOMPOSITE_OPERATOR_OVER](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_over/) | 값 'over'에 해당합니다. |
| const [SVG_FECOMPOSITE_OPERATOR_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_unknown/) | 이 유형은 미리 정의된 유형 중 하나가 아닙니다. 이 유형의 새 값을 정의하거나 기존 값을 이 유형으로 전환하려는 시도는 유효하지 않습니다. |
| const [SVG_FECOMPOSITE_OPERATOR_XOR](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_xor/) | 값 'xor'에 해당합니다. |
