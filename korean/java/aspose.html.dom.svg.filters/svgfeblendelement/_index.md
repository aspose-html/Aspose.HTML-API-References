---
title: "SVGFEBlendElement 클래스"
second_title: "Aspose.HTML for Java API 참조"
description: "com.aspose.html.dom.svg.filters.SVGFEBlendElement 클래스. SVGFEBlendElement 인터페이스는 feBlend 요소에 해당합니다."
type: docs

url: /ko/java/com.aspose.html.dom.svg.filters/svgfeblendelement/
---
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfeblendelement/height/) 주어진 ‘filter’ 요소의 ‘height’ 속성에 해당합니다. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfeblendelement/in1/) 주어진 ‘feBlend’ 요소의 ‘in’ 속성에 해당합니다. |
| [getIn2](../../com.aspose.html.dom.svg.filters/svgfeblendelement/in2/) 주어진 ‘feBlend’ 요소의 ‘in2’ 속성에 해당합니다. |
[getInnerHTML]
...
| [getMode](../../com.aspose.html.dom.svg.filters/svgfeblendelement/mode/) 주어진 ‘feBlend’ 요소의 ‘mode’ 속성에 해당합니다. 이 인터페이스에 정의된 SVG_FEBLEND_MODE_* 상수 중 하나를 사용합니다. |
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfeblendelement/result/) 주어진 ‘filter’ 요소의 ‘result’ 속성에 해당합니다. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfeblendelement/width/) 주어진 ‘filter’ 요소의 ‘width’ 속성에 해당합니다. |
| [X](../../com.aspose.html.dom.svg.filters/svgfeblendelement/x/) { get; } | 지정된 ‘filter’ 요소의 ‘x’ 속성에 해당합니다. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfeblendelement/y/) { get; } | 지정된 ‘filter’ 요소의 ‘y’ 속성에 해당합니다. |
...
| 이름 | 설명 |
| --- | --- |
| const [SVG_FEBLEND_MODE_COLOR](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_color/) | 값 'color'에 해당합니다. |
| const [SVG_FEBLEND_MODE_COLOR_BURN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_color_burn/) | 값 'color_burn'에 해당합니다. |
| const [SVG_FEBLEND_MODE_COLOR_DODGE](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_color_dodge/) | 값 'color_dodge'에 해당합니다. |
| const [SVG_FEBLEND_MODE_DARKEN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_darken/) | 값 'darken'에 해당합니다. |
| const [SVG_FEBLEND_MODE_DIFFERENCE](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_difference/) | 값 'difference'에 해당합니다. |
| const [SVG_FEBLEND_MODE_EXCLUSION](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_exclusion/) | 값 'exclusion'에 해당합니다. |
| const [SVG_FEBLEND_MODE_HARD_LIGHT](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_hard_light/) | 값 'hard_light'에 해당합니다. |
| const [SVG_FEBLEND_MODE_HUE](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_hue/) | 값 'hue'에 해당합니다. |
| const [SVG_FEBLEND_MODE_LIGHTEN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_lighten/) | 값 'lighten'에 해당합니다. |
| const [SVG_FEBLEND_MODE_LUMINOSITY](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_luminosity/) | 값 'luminosity'에 해당합니다. |
| const [SVG_FEBLEND_MODE_MULTIPLY](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_multiply/) | 값 'multiply'에 해당합니다. |
| const [SVG_FEBLEND_MODE_NORMAL](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_normal/) | 값 'normal'에 해당합니다. |
| const [SVG_FEBLEND_MODE_OVERLAY](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_overlay/) | 값 'overlay'에 해당합니다. |
| const [SVG_FEBLEND_MODE_SATURATION](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_saturation/) | 값 'saturation'에 해당합니다. |
| const [SVG_FEBLEND_MODE_SCREEN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_screen/) | 값 'screen'에 해당합니다. |
| const [SVG_FEBLEND_MODE_SOFT_LIGHT](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_soft_light/) | 값 'soft_light'에 해당합니다. |
| const [SVG_FEBLEND_MODE_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_unknown/) | 이 유형은 미리 정의된 유형 중 하나가 아닙니다. 이 유형의 새 값을 정의하거나 기존 값을 이 유형으로 전환하려는 시도는 유효하지 않습니다. |
