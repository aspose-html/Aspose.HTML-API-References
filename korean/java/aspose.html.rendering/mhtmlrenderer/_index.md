...
| [render](../../com.aspose.html.rendering/mhtmlrenderer/render/#render_9)(IDevice, CancellationToken, params Stream[]) | 취소 토큰을 사용하여 작업 취소를 요청하면서 특정 [`IDevice`](../idevice/)에 여러 MHTML 문서를 렌더링하는 메서드를 정의합니다. |
