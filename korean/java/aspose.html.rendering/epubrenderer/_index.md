...
| [render](../../com.aspose.html.rendering/epubrenderer/render/#render_10)(IDevice, TimeSpan, params Stream[]) | 여러 EPub 스트림을 특정 [`IDevice`](../idevice/)에 렌더링하는 메서드를 정의합니다. 렌더링은 리소스 로드, 활성 타이머, 애니메이션 작업에 대한 네트워크 작업이 없고 지정된 시간 제한이 경과했을 때 수행됩니다. |
| [render](../../com.aspose.html.rendering/epubrenderer/render/#render_2)(IDevice, IList&lt;Stream&gt;, Configuration, TimeSpan) | 여러 EPub 문서를 지정된 [`IDevice`](../idevice/)에 렌더링합니다. 렌더링은 리소스 로드, 활성 타이머, 애니메이션 작업에 대한 네트워크 작업이 없고 지정된 시간 제한이 경과했을 때 수행됩니다. |
| [render](../../com.aspose.html.rendering/epubrenderer/render/#render_5)(IDevice, Stream, Configuration, TimeSpan) | EPub 문서를 지정된 [`IDevice`](../idevice/)에 렌더링합니다. 렌더링은 리소스 로드, 활성 타이머, 애니메이션 작업에 대한 네트워크 작업이 없고 지정된 시간 제한이 경과했을 때 수행됩니다. |
