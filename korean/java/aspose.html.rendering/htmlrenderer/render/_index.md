...
여러 [`HTMLDocument`](../../../com.aspose.html/htmldocument/)를 특정 [`IDevice`](../../idevice/)에 렌더링하는 메서드를 정의합니다.
...
여러 [`HTMLDocument`](../../../com.aspose.html/htmldocument/)를 특정 [`IDevice`](../../idevice/)에 렌더링하는 메서드를 정의하며, 작업 취소를 요청하기 위해 취소 토큰을 사용합니다.
