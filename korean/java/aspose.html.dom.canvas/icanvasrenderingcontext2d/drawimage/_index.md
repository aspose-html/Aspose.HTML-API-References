...
| dx | Double | 목적지 캔버스에서 소스 이미지의 왼쪽 위 모서리를 배치할 X 좌표. |
| dy | Double | 목적지 캔버스에서 소스 이미지의 왼쪽 위 모서리를 배치할 Y 좌표. |
...
| dx | Double | 목적지 캔버스에서 소스 이미지의 왼쪽 위 모서리를 배치할 X 좌표. |
| dy | Double | 목적지 캔버스에서 소스 이미지의 왼쪽 위 모서리를 배치할 Y 좌표. |
| dw | Double | 목적지 캔버스에 이미지를 그릴 너비. 이는 그려진 이미지의 크기 조정을 가능하게 합니다. 지정하지 않으면 그릴 때 이미지가 너비 방향으로 스케일되지 않습니다. |
| dh | Double | 목적지 캔버스에 이미지를 그릴 높이. 이는 그려진 이미지의 크기 조정을 가능하게 합니다. 지정하지 않으면 그릴 때 이미지가 높이 방향으로 스케일되지 않습니다. |
...
| --- | --- | --- |
| 이미지 | HTMLImageElement | 컨텍스트에 그리기 위한 HTMLImageElement. |
| sx | Double | 목적지 컨텍스트에 그릴 소스 이미지 서브 사각형의 왼쪽 위 모서리 X 좌표. |
| sy | Double | 목적지 컨텍스트에 그릴 소스 이미지 서브 사각형의 왼쪽 위 모서리 Y 좌표. |
| sw | Double | 목적지 컨텍스트에 그릴 소스 이미지 서브 사각형의 너비. 지정하지 않으면 sx와 sy로 지정된 좌표부터 이미지 오른쪽 아래 모서리까지의 전체 사각형이 사용됩니다. |
| sh | Double | 목적지 컨텍스트에 그릴 소스 이미지 서브 사각형의 높이. |
| dx | Double | 목적지 캔버스에서 소스 이미지의 왼쪽 위 모서리를 배치할 X 좌표. |
| dy | Double | 목적지 캔버스에서 소스 이미지의 왼쪽 위 모서리를 배치할 Y 좌표. |
| dw | Double | 목적지 캔버스에 이미지를 그릴 너비. 이는 그려진 이미지의 크기 조정을 가능하게 합니다. 지정하지 않으면 그릴 때 이미지가 너비 방향으로 스케일되지 않습니다. |
| dh | Double | 목적지 캔버스에 이미지를 그릴 높이. 이는 그려진 이미지의 크기 조정을 가능하게 합니다. 지정하지 않으면 그릴 때 이미지가 높이 방향으로 스케일되지 않습니다. |
