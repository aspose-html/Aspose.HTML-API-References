...
description: "ICanvasRenderingContext2D 메서드. sx와 sy에서 시작하고 sw 너비와 sh 높이를 가진 사각형으로 지정된 캔버스 영역의 기본 픽셀 데이터를 나타내는 ImageData 객체를 반환합니다. 이 메서드는 캔버스 변환 행렬의 영향을 받지 않습니다."
type: docs
