...
description: "classe com.aspose.html.forms.FormEditor. Cette classe représente l'éditeur du HTMLFormElement qui crée un moyen plus simple pour les développeurs .net d'éditer les formulaires html."
type: docs
...
Cette classe représente l'éditeur du [`HTMLFormElement`](../../com.aspose.html/htmlformelement/) qui crée un moyen plus simple pour les développeurs .net d'éditer les formulaires html.
