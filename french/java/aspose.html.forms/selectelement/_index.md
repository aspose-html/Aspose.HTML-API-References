...
| [value](../../com.aspose.html.forms/selectelement/value/) { get; set; } | Lors de la lecture, doit renvoyer la valeur du premier élément option dans la liste des options selon l'ordre de l'arbre dont la sélection est définie sur true, le cas échéant. |
