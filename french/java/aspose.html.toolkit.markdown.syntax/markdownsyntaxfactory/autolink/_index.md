...
description: "MarkdownSyntaxFactory méthode. Crée AutoLinkSyntaxNode"
type: docs

url: /fr/java/com.aspose.html.toolkit.markdown.syntax/markdownsyntaxfactory/autolink/
---
## AutoLink(MarkdownSyntaxToken, TextSyntaxNode, MarkdownSyntaxToken) {#autolink}

Crée [`AutoLinkSyntaxNode`](../../autolinksyntaxnode/).
...
| --- | --- | --- |
| opening | MarkdownSyntaxToken | Le MarkdownSyntaxToken. |
| contenu | TextSyntaxNode | Le TextSyntax. |
| closing | MarkdownSyntaxToken | Le MarkdownSyntaxToken. |
...
| contenu | TextSyntaxNode | Le TextSyntax. |
| closing | MarkdownSyntaxToken | Le MarkdownSyntaxToken. |
| courriel | Boolean | Le drapeau booléen. |
