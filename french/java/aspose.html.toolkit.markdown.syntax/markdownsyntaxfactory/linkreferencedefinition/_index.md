...
description: "MarkdownSyntaxFactory méthode. Crée LinkReferenceDefinitionSyntaxNode"
type: docs

url: /fr/java/com.aspose.html.toolkit.markdown.syntax/markdownsyntaxfactory/linkreferencedefinition/
---
## MarkdownSyntaxFactory.LinkReferenceDefinition method

Crée [`LinkReferenceDefinitionSyntaxNode`](../../linkreferencedefinitionsyntaxnode/).
...
| --- | --- | --- |
| labelOpening | MarkdownSyntaxToken | Le labelOpening. |
| étiquette | TextSyntaxNode | L'étiquette. |
| labelClosing | MarkdownSyntaxToken | Le labelClosing. |
