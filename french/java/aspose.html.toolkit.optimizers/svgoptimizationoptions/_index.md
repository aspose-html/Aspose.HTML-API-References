---
title: "Classe SVGOptimizationOptions"
second_title: "Référence de l'API Aspose.HTML pour Java"
description: "classe com.aspose.html.toolkit.optimizers.SVGOptimizationOptions. SVGOptimizationOptions est une classe permettant de stocker des options d'optimisation des documents SVG"
type: docs

url: /fr/java/com.aspose.html.toolkit.optimizers/svgoptimizationoptions/
---
## SVGOptimizationOptions class

SVGOptimizationOptions est une classe permettant de stocker les options d'optimisation des documents SVG.
...
| Nom | Description |
| --- | --- |
| [SVGOptimizationOptions](svgoptimizationoptions/)() | Initialise une nouvelle instance de la classe `SVGOptimizationOptions`. |
