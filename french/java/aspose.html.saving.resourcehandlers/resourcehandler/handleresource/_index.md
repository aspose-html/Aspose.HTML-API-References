...
description: "Méthode ResourceHandler. Cette méthode est responsable de la gestion de la ressource. Vous pouvez y enregistrer la Resource dans le flux ou l’intégrer dans la ressource parent."
type: docs

url: /fr/java/com.aspose.html.saving.resourcehandlers/resourcehandler/handleresource/
---
## ResourceHandler.HandleResource method

Cette méthode est responsable de la gestion de la ressource. Vous pouvez y enregistrer le [`Resource`](../../../com.aspose.html.saving/resource/) dans le flux ou l’intégrer dans la ressource parent.
