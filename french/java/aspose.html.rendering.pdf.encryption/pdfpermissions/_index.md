...
| ExtractContentWithDisabilities | `200` | (Gestionnaires de sécurité de la révision 3 ou supérieure) Extraire le texte et les graphiques (pour soutenir l'accessibilité des utilisateurs en situation de handicap ou à d'autres fins). |
