---
title: "DocDevice.DocGraphicContext Classe"
second_title: "Référence de l'API Aspose.HTML pour Java"
description: "com.aspose.html.rendering.doc.DocDeviceDocGraphicContext class. Contient les paramètres de contrôle graphique actuels pour le DocDevice. Ces paramètres définissent le cadre global dans lequel les opérateurs graphiques s’exécutent"
type: docs

url: /fr/java/com.aspose.html.rendering.doc/docdevice.docgraphiccontext/
---
## DocDevice.DocGraphicContext class

Contient les paramètres de contrôle graphique actuels pour le DocDevice. Ces paramètres définissent le cadre global dans lequel les opérateurs graphiques s’exécutent.
...
| Nom | Description |
| --- | --- |
| [docGraphicContext](../../com.aspose.html.rendering.doc/docdevice.docgraphiccontext/.ctor)() | Le constructeur par défaut. |
...
| [transformationMatrix](../../com.aspose.html.rendering.doc/docdevice.docgraphiccontext/transformationmatrix) { get; set; } | Définit ou obtient la matrice de transformation. |

## Méthodes

| Nom | Description |
| --- | --- |
| [clone](../../com.aspose.html.rendering.doc/docdevice.docgraphiccontext/clone)() | Crée une nouvelle instance d’une classe [`GraphicContext`](../../com.aspose.html.rendering/graphiccontext/) avec les mêmes valeurs de propriétés qu’une instance existante. |
| [transform](../../com.aspose.html.rendering.doc/docdevice.docgraphiccontext/transform)(IMatrix) | Modifie la matrice de transformation actuelle en multipliant par la matrice spécifiée. |
