---
title: "Classe DocRenderingOptions"
second_title: "Référence de l'API Aspose.HTML pour Java"
description: "classe com.aspose.html.rendering.doc.DocRenderingOptions. Représente les options de rendu pour le DocDevice"
type: docs

url: /fr/java/com.aspose.html.rendering.doc/docrenderingoptions/
---
## DocRenderingOptions class

Représente les options de rendu pour [`DocDevice`](../docdevice/).
...
| Nom | Description |
| --- | --- |
| [DocRenderingOptions](docrenderingoptions/#constructor)() | Initialise une nouvelle instance de la classe `DocRenderingOptions`. |
| [DocRenderingOptions](docrenderingoptions/#constructor_1)(FontEmbeddingRule) | Initialise une nouvelle instance de la classe `DocRenderingOptions` avec la règle d’incorporation de police spécifiée. |
