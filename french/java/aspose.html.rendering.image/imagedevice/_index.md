...
description: "com.aspose.html.rendering.image.ImageDevice classe. Représente le rendu vers les formats raster jpeg png bmp gif tiff"
type: docs
...
| [ImageDevice](imagedevice/#constructor_1)(ImageRenderingOptions, ICreateStreamProvider) | Initialise une nouvelle instance de la classe `ImageDevice` à l'aide des options de rendu et du fournisseur de flux. |
| [ImageDevice](imagedevice/#constructor_2)(ImageRenderingOptions, Stream) | Initialise une nouvelle instance de la classe `ImageDevice` à l'aide des options de rendu et du flux de sortie. |
| [ImageDevice](imagedevice/#constructor_3)(ImageRenderingOptions, String) | Initialise une nouvelle instance de la classe `ImageDevice` à l'aide des options de rendu et du nom de fichier de sortie. |
