...
description: "com.aspose.html.rendering.xps.XpsDeviceXpsGraphicContext classe. Contient les paramètres de contrôle graphique actuels pour le XpsDevice. Ces paramètres définissent le cadre global dans lequel les opérateurs graphiques s'exécutent"
type: docs

url: /fr/java/com.aspose.html.rendering.xps/xpsdevice.xpsgraphiccontext/
---
## XpsDevice.XpsGraphicContext class

Contient les paramètres de contrôle graphique actuels pour le XpsDevice. Ces paramètres définissent le cadre global dans lequel les opérateurs graphiques s'exécutent.
...
| Nom | Description |
| --- | --- |
| [xpsGraphicContext](../../com.aspose.html.rendering.xps/xpsdevice.xpsgraphiccontext/.ctor)() | Le constructeur par défaut. |
