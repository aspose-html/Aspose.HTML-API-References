...
description: "com.aspose.html.dom.svg.events.SVGZoomEvent class. L'événement de zoom se produit lorsque l'utilisateur initie une action qui entraîne le redimensionnement de la vue actuelle du fragment de document SVG. Les gestionnaires d'événements ne sont reconnus que sur les éléments svg."
type: docs
