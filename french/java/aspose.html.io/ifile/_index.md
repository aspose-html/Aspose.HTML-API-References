...
| Nom | Description |
| --- | --- |
| [getLastModified](../../com.aspose.html.io/ifile/lastmodified/) La date de dernière modification du fichier. Lors de la lecture, si les agents utilisateurs peuvent fournir cette information, cela doit renvoyer un long long correspondant au moment où le fichier a été modifié pour la dernière fois, exprimé en nombre de millisecondes depuis l'époque Unix. |
