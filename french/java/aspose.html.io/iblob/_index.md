...
| Nom | Description |
| --- | --- |
| [slice](../../com.aspose.html.io/iblob/slice/)(ulong, ulong, String) | Renvoie un nouvel objet Blob contenant les octets allant du paramètre optionnel start jusqu'au paramètre optionnel end (exclu), et avec un attribut type dont la valeur correspond au paramètre optionnel contentType. |
