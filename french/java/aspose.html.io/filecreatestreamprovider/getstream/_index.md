...
description: "FileCreateStreamProvider method. Fournit un flux pour le rendu"
type: docs
...
| extension | String | L'extension de nom de fichier à utiliser si un flux de fichier est créé. |
