...
description: "Méthode FileCreateStreamProvider. Fournit un flux pour le rendu."
type: docs

url: /fr/java/com.aspose.html.io/filecreatestreamprovider/getstream/
---
...
| --- | --- | --- |
| nom | String | Le nom du flux. |
| extension | String | L'extension du nom de fichier à utiliser si un flux de fichier est créé. |
