...
description: "com.aspose.html.dom.svg.filters.SVGFEGaussianBlurElement classe. L'interface SVGFEGaussianBlurElement correspond à l'élément feGaussianBlur."
type: docs

url: /fr/java/com.aspose.html.dom.svg.filters/svgfegaussianblurelement/
---
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/height/) Correspond à l'attribut �height� sur l'élément �filter� donné. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/in1/) Correspond à l'attribut �in� sur l'élément �feGaussianBlur� donné. |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/result/) Correspond à l'attribut �result� sur l'élément �filter� donné. |
| [getShadowRoot](../../com.aspose.html.dom/element/shadowroot/) Renvoie le shadowRoot stocké sur cet élément ou null s'il est fermé. |
| [getStdDeviationX](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/stddeviationx/) Correspond à l'attribut �stdDeviation� sur l'élément �feGaussianBlur� donné. Contient le composant X de l'attribut �stdDeviation�. |
| [getStdDeviationY](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/stddeviationy/) Correspond à l'attribut �stdDeviation� sur l'élément �feGaussianBlur� donné. Contient le composant Y (éventuellement calculé automatiquement) de l'attribut �stdDeviation�. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/width/) Correspond à l'attribut �width� sur l'élément �filter� donné. |
| [X](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/x/) { get; } | Correspond à l'attribut �x� sur l'élément �filter� donné. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/y/) { get; } | Correspond à l'attribut �y� sur l'élément �filter� donné. |
...
| [setStdDeviation](../../com.aspose.html.dom.svg.filters/svgfegaussianblurelement/setstddeviation/)(float, float) | Définit les valeurs de l'attribut �stdDeviation�. |
