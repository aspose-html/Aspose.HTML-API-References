...
description: "classe com.aspose.html.dom.svg.filters.SVGFEDropShadowElement. L'interface SVGFEDropShadowElement correspond à l'élément feDropShadow."
type: docs

url: /fr/java/com.aspose.html.dom.svg.filters/svgfedropshadowelement/
---
...
| [getDx](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/dx/) Correspond à l'attribut ‘dx’ sur l'élément ‘feDropShadow’ donné. |
| [getDy](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/dy/) Correspond à l'attribut ‘dy’ sur l'élément ‘feDropShadow’ donné. |
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/height/) Correspond à l'attribut ‘height’ sur l'élément ‘feDropShadow’ donné. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/in1/) Correspond à l'attribut ‘in’ sur l'élément ‘feDropShadow’ donné. |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/result/) Correspond à l'attribut ‘result’ sur l'élément ‘feDropShadow’ donné. |
| [getShadowRoot](../../com.aspose.html.dom/element/shadowroot/) Renvoie le shadowRoot stocké sur cet élément ou null s'il est fermé. |
| [getStdDeviationX](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/stddeviationx/) Correspond à l'attribut ‘stdDeviation’ sur l'élément ‘feDropShadow’ donné. Contient le composant X de l'attribut ‘stdDeviation’. |
| [getStdDeviationY](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/stddeviationy/) Correspond à l'attribut ‘stdDeviation’ sur l'élément ‘feDropShadow’ donné. Contient le composant Y (éventuellement calculé automatiquement) de l'attribut ‘stdDeviation’. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/width/) Correspond à l'attribut ‘width’ sur l'élément ‘feDropShadow’ donné. |
| [X](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/x/) { get; } | Correspond à l'attribut ‘x’ sur l'élément ‘feDropShadow’ donné. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/y/) { get; } | Correspond à l'attribut ‘y’ sur l'élément ‘feDropShadow’ donné. |
...
| [setStdDeviation](../../com.aspose.html.dom.svg.filters/svgfedropshadowelement/setstddeviation/)(float, float) | Définit les valeurs de l'attribut ‘stdDeviation’. |
