...
description: "classe com.aspose.html.dom.svg.filters.SVGFESpecularLightingElement. L'interface SVGFESpecularLightingElement correspond à l'élément feSpecularLighting."
type: docs

url: /fr/java/com.aspose.html.dom.svg.filters/svgfespecularlightingelement/
---
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/height/) Correspond à l'attribut ‘height’ sur l'élément ‘filter’ donné. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/in1/) Correspond à l'attribut ‘in’ sur l'élément ‘feSpecularLighting’ donné. |
[getInnerHTML]
...
| [getKernelUnitLengthX](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/kernelunitlengthx/) Correspond à l'attribut ‘kernelUnitLength’ sur l'élément ‘feSpecularLighting’ donné. |
| [getKernelUnitLengthY](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/kernelunitlengthy/) Correspond à l'attribut ‘kernelUnitLength’ sur l'élément ‘feSpecularLighting’ donné. |
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/result/) Correspond à l'attribut ‘result’ sur l'élément ‘filter’ donné. |
| [getShadowRoot](../../com.aspose.html.dom/element/shadowroot/) Renvoie le shadowRoot stocké sur cet élément ou null s'il est fermé. |
| [getSpecularConstant](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/specularconstant/) Correspond à l'attribut ‘specularConstant’ sur l'élément ‘feSpecularLighting’ donné. |
| [getSpecularExponent](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/specularexponent/) Correspond à l'attribut ‘specularExponent’ sur l'élément ‘feSpecularLighting’ donné. |
...
| [getSurfaceScale](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/surfacescale/) Correspond à l'attribut ‘surfaceScale’ sur l'élément ‘feSpecularLighting’ donné. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/width/) Correspond à l'attribut ‘width’ sur l'élément ‘filter’ donné. |
| [X](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/x/) { get; } | Correspond à l'attribut ‘x’ de l'élément ‘filter’ donné. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfespecularlightingelement/y/) { get; } | Correspond à l'attribut ‘y’ de l'élément ‘filter’ donné. |
