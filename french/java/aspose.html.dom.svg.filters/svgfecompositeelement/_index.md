---
title: "SVGFECompositeElement Classe"
second_title: "Référence de l'API Aspose.HTML pour Java"
description: "classe com.aspose.html.dom.svg.filters.SVGFECompositeElement. L'interface SVGFECompositeElement correspond à l'élément feComposite"
type: docs

url: /fr/java/com.aspose.html.dom.svg.filters/svgfecompositeelement/
---
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/height/) Correspond à l'attribut ‘height’ de l'élément ‘filter’ donné. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/in1/) Correspond à l'attribut ‘in’ de l'élément ‘feComposite’ donné. |
| [getIn2](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/in2/) Correspond à l'attribut ‘in2’ de l'élément ‘feComposite’ donné. |
[getInnerHTML]
...
| [getK1](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k1/) Correspond à l'attribut ‘k1’ de l'élément ‘feComposite’ donné. |
| [getK2](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k2/) Correspond à l'attribut ‘k2’ de l'élément ‘feComposite’ donné. |
| [getK3](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k3/) Correspond à l'attribut ‘k3’ de l'élément ‘feComposite’ donné. |
| [getK4](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/k4/) Correspond à l'attribut ‘k4’ de l'élément ‘feComposite’ donné. |
...
| [getOperator](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/operator/) Correspond à l'attribut ‘operator’ de l'élément ‘feComposite’ donné. Prend l'une des constantes SVG_FECOMPOSITE_OPERATOR_* définies sur cette interface. |
[getOuterHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/result/) Correspond à l'attribut ‘result’ de l'élément ‘filter’ donné. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/width/) Correspond à l'attribut ‘width’ de l'élément ‘filter’ donné. |
| [X](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/x/) { get; } | Correspond à l'attribut ‘x’ de l'élément ‘filter’ donné. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/y/) { get; } | Correspond à l'attribut ‘y’ de l'élément ‘filter’ donné. |
...
| Nom | Description |
| --- | --- |
| const [SVG_FECOMPOSITE_OPERATOR_ARITHMETIC](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_arithmetic/) | Correspond à la valeur 'arithmetic'. |
| const [SVG_FECOMPOSITE_OPERATOR_ATOP](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_atop/) | Correspond à la valeur 'atop'. |
| const [SVG_FECOMPOSITE_OPERATOR_IN](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_in/) | Correspond à la valeur 'in'. |
| const [SVG_FECOMPOSITE_OPERATOR_OUT](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_out/) | Correspond à la valeur 'out'. |
| const [SVG_FECOMPOSITE_OPERATOR_OVER](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_over/) | Correspond à la valeur 'over'. |
| const [SVG_FECOMPOSITE_OPERATOR_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_unknown/) | Le type ne fait pas partie des types prédéfinis. Il est invalide de tenter de définir une nouvelle valeur de ce type ou d'essayer de changer une valeur existante vers ce type. |
| const [SVG_FECOMPOSITE_OPERATOR_XOR](../../com.aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_xor/) | Correspond à la valeur 'xor'. |
