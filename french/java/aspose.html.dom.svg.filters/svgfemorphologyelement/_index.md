...
description: "classe com.aspose.html.dom.svg.filters.SVGFEMorphologyElement. L'interface SVGFEMorphologyElement correspond à l'élément feMorphology."
type: docs

url: /fr/java/com.aspose.html.dom.svg.filters/svgfemorphologyelement/
---
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/height/) Correspond à l'attribut ‘height’ sur l'élément ‘filter’ donné. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/in1/) Correspond à l'attribut ‘in’ sur l'élément ‘feMorphology’ donné. |
[getInnerHTML]
...
| [getOperator](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/operator/) Correspond à l'attribut ‘operator’ de l'élément ‘feMorphology’ donné. Prend l'une des constantes SVG_MORPHOLOGY_OPERATOR_* définies sur cette interface. |
[getOuterHTML]
...
| [getRadiusX](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/radiusx/) Correspond à l'attribut ‘radius’ de l'élément ‘feMorphology’ donné. |
| [getRadiusY](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/radiusy/) Correspond à l'attribut ‘radius’ de l'élément ‘feMorphology’ donné. |
| [getResult](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/result/) Correspond à l'attribut ‘result’ de l'élément ‘filter’ donné. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/width/) Correspond à l'attribut ‘width’ de l'élément ‘filter’ donné. |
| [X](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/x/) { get; } | Correspond à l'attribut ‘x’ de l'élément ‘filter’ donné. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/y/) { get; } | Correspond à l'attribut ‘y’ de l'élément ‘filter’ donné. |
...
| Nom | Description |
| --- | --- |
| const [SVG_MORPHOLOGY_OPERATOR_DILATE](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/svg_morphology_operator_dilate/) | Correspond à la valeur 'dilate'. |
| const [SVG_MORPHOLOGY_OPERATOR_ERODE](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/svg_morphology_operator_erode/) | Correspond à la valeur 'erode'. |
| const [SVG_MORPHOLOGY_OPERATOR_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfemorphologyelement/svg_morphology_operator_unknown/) | Le type ne fait pas partie des types prédéfinis. Il est invalide de tenter de définir une nouvelle valeur de ce type ou d'essayer de changer une valeur existante vers ce type. |
