...
description: "classe com.aspose.html.dom.svg.filters.SVGFEOffsetElement. L'interface SVGFEOffsetElement correspond à l'élément feOffset."
type: docs

url: /fr/java/com.aspose.html.dom.svg.filters/svgfeoffsetelement/
---
...
| [getDx](../../com.aspose.html.dom.svg.filters/svgfeoffsetelement/dx/) Correspond à l'attribut ‘dx’ sur l'élément ‘feOffset’ donné. |
| [getDy](../../com.aspose.html.dom.svg.filters/svgfeoffsetelement/dy/) Correspond à l'attribut ‘dy’ sur l'élément ‘feOffset’ donné. |
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfeoffsetelement/height/) Correspond à l'attribut ‘height’ sur l'élément ‘filter’ donné. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfeoffsetelement/in1/) Correspond à l'attribut ‘in’ sur l'élément ‘feOffset’ donné. |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfeoffsetelement/result/) Correspond à l'attribut ‘result’ sur l'élément ‘filter’ donné. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfeoffsetelement/width/) Correspond à l'attribut ‘width’ sur l'élément ‘filter’ donné. |
| [X](../../com.aspose.html.dom.svg.filters/svgfeoffsetelement/x/) { get; } | Correspond à l'attribut ‘x’ de l'élément ‘filter’ donné. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfeoffsetelement/y/) { get; } | Correspond à l'attribut ‘y’ de l'élément ‘filter’ donné. |
