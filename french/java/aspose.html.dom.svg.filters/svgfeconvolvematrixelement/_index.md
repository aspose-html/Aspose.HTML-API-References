---
title: "SVGFEConvolveMatrixElement Classe"
second_title: "Référence de l'API Aspose.HTML pour Java"
description: "com.aspose.html.dom.svg.filters.SVGFEConvolveMatrixElement classe. L'interface SVGFEConvolveMatrixElement correspond à l'élément feConvolveMatrix."
type: docs

url: /fr/java/com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/
---
...
| [getBias](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/bias/) Correspond à l'attribut ‘bias’ sur l'élément ‘feConvolveMatrix’ donné. |
...
| [getDivisor](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/divisor/) Correspond à l'attribut ‘divisor’ sur l'élément ‘feConvolveMatrix’ donné. |
| [getEdgeMode](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/edgemode/) Correspond à l'attribut ‘edgeMode’ sur l'élément ‘feConvolveMatrix’ donné. |
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/height/) Correspond à l'attribut ‘height’ sur l'élément ‘filter’ donné. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/in1/) Correspond à l'attribut ‘in’ sur l'élément ‘feConvolveMatrix’ donné. |
[getInnerHTML]
...
| [getKernelMatrix](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelmatrix/) Correspond à l'attribut ‘kernelMatrix’ sur l'élément ‘feConvolveMatrix’ donné. |
| [getKernelUnitLengthX](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelunitlengthx/) Correspond à l'attribut ‘kernelUnitLength’ sur l'élément ‘feConvolveMatrix’ donné. |
| [getKernelUnitLengthY](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelunitlengthy/) Correspond à l'attribut ‘kernelUnitLength’ sur l'élément ‘feConvolveMatrix’ donné. |
...
| [getOrderX](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/orderx/) Correspond à l'attribut ‘order’ sur l'élément ‘feConvolveMatrix’ donné. |
| [getOrderY](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/ordery/) Correspond à l'attribut ‘order’ sur l'élément ‘feConvolveMatrix’ donné. |
[getOuterHTML]
...
| [getPreserveAlpha](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/preservealpha/) Correspond à l'attribut ‘preserveAlpha’ sur l'élément ‘feConvolveMatrix’ donné. |
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/result/) Correspond à l'attribut ‘result’ sur l'élément ‘filter’ donné. |
...
| [getTargetX](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/targetx/) Correspond à l'attribut ‘targetX’ sur l'élément ‘feConvolveMatrix’ donné. |
| [getTargetY](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/targety/) Correspond à l'attribut ‘targetY’ sur l'élément ‘feConvolveMatrix’ donné. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/width/) Correspond à l'attribut ‘width’ sur l'élément ‘filter’ donné. |
| [X](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/x/) { get; } | Correspond à l'attribut ‘x’ de l'élément ‘filter’ donné. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/y/) { get; } | Correspond à l'attribut ‘y’ de l'élément ‘filter’ donné. |
...
| Nom | Description |
| --- | --- |
| const [SVG_EDGEMODE_DUPLICATE](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_duplicate/) | Correspond à la valeur 'duplicate'. |
| const [SVG_EDGEMODE_NONE](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_none/) | Correspond à la valeur 'none'. |
| const [SVG_EDGEMODE_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_unknown/) | Le type ne fait pas partie des types prédéfinis. Il est invalide de tenter de définir une nouvelle valeur de ce type ou d'essayer de changer une valeur existante vers ce type. |
| const [SVG_EDGEMODE_WRAP](../../com.aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_wrap/) | Correspond à la valeur 'wrap'. |
