...
description: "classe com.aspose.html.dom.svg.filters.SVGFEDiffuseLightingElement. L'interface SVGFEDiffuseLightingElement correspond à l'élément feDiffuseLighting."
type: docs

url: /fr/java/com.aspose.html.dom.svg.filters/svgfediffuselightingelement/
---
...
| [getDiffuseConstant](../../com.aspose.html.dom.svg.filters/svgfediffuselightingelement/diffuseconstant/) Correspond à l'attribut ‘diffuseConstant’ sur l'élément ‘feDiffuseLighting’ donné. |
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfediffuselightingelement/height/) Correspond à l'attribut ‘height’ sur l'élément ‘filter’ donné. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfediffuselightingelement/in1/) Correspond à l'attribut ‘in’ sur l'élément ‘feDiffuseLighting’ donné. |
[getInnerHTML]
...
| [getKernelUnitLengthX](../../com.aspose.html.dom.svg.filters/svgfediffuselightingelement/kernelunitlengthx/) Correspond à l'attribut ‘kernelUnitLength’ sur l'élément ‘feDiffuseLighting’ donné. |
| [getKernelUnitLengthY](../../com.aspose.html.dom.svg.filters/svgfediffuselightingelement/kernelunitlengthy/) Correspond à l'attribut ‘kernelUnitLength’ sur l'élément ‘feDiffuseLighting’ donné. |
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfediffuselightingelement/result/) Correspond à l'attribut ‘result’ sur l'élément ‘filter’ donné. |
...
| [getSurfaceScale](../../com.aspose.html.dom.svg.filters/svgfediffuselightingelement/surfacescale/) Correspond à l'attribut ‘surfaceScale’ sur l'élément ‘feDiffuseLighting’ donné. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfediffuselightingelement/width/) Correspond à l'attribut ‘width’ sur l'élément ‘filter’ donné. |
| [X](../../com.aspose.html.dom.svg.filters/svgfediffuselightingelement/x/) { get; } | Correspond à l'attribut ‘x’ de l'élément ‘filter’ donné. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfediffuselightingelement/y/) { get; } | Correspond à l'attribut ‘y’ de l'élément ‘filter’ donné. |
