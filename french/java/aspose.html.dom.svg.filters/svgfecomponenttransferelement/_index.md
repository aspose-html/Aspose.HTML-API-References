---
title: "SVGFEComponentTransferElement Classe"
second_title: "Référence de l'API Aspose.HTML pour Java"
description: "classe com.aspose.html.dom.svg.filters.SVGFEComponentTransferElement. L'interface SVGFEComponentTransferElement correspond à l'élément feComponentTransfer"
type: docs

url: /fr/java/com.aspose.html.dom.svg.filters/svgfecomponenttransferelement/
---
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfecomponenttransferelement/height/) Correspond à l'attribut ‘height’ de l'élément ‘filter’ donné. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfecomponenttransferelement/in1/) Correspond à l'attribut ‘in’ de l'élément ‘feComponentTransfer’ donné. |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfecomponenttransferelement/result/) Correspond à l'attribut ‘result’ de l'élément ‘filter’ donné. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfecomponenttransferelement/width/) Correspond à l'attribut ‘width’ de l'élément ‘filter’ donné. |
| [X](../../com.aspose.html.dom.svg.filters/svgfecomponenttransferelement/x/) { get; } | Correspond à l'attribut ‘x’ de l'élément ‘filter’ donné. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfecomponenttransferelement/y/) { get; } | Correspond à l'attribut ‘y’ de l'élément ‘filter’ donné. |
