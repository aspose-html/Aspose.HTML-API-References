...
description: "com.aspose.html.dom.svg.filters.SVGFEDisplacementMapElement classe. L'interface SVGFEDisplacementMapElement correspond à l'élément feDisplacementMap."
type: docs

url: /fr/java/com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/
---
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/height/) Correspond à l'attribut ‘height’ sur l'élément ‘filter’ donné. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/in1/) Correspond à l'attribut ‘in’ sur l'élément ‘feDisplacementMap’ donné. |
| [getIn2](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/in2/) Correspond à l'attribut ‘in2’ sur l'élément ‘feDisplacementMap’ donné. |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/result/) Correspond à l'attribut ‘result’ sur l'élément ‘filter’ donné. |
| [getScale](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/scale/) Correspond à l'attribut ‘scale’ sur l'élément ‘feDisplacementMap’ donné. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/width/) Correspond à l'attribut ‘width’ sur l'élément ‘filter’ donné. |
| [X](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/x/) { get; } | Correspond à l'attribut ‘x’ de l'élément ‘filter’ donné. |
| [getXChannelSelector](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/xchannelselector/) Correspond à l'attribut ‘xChannelSelector’ sur l'élément ‘feDisplacementMap’ donné. Prend l'une des constantes SVG_CHANNEL_* définies sur cette interface. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/y/) { get; } | Correspond à l'attribut ‘y’ de l'élément ‘filter’ donné. |
| [getYChannelSelector](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/ychannelselector/) Correspond à l'attribut ‘yChannelSelector’ de l'élément ‘feDisplacementMap’ fourni. Accepte l'une des constantes SVG_CHANNEL_* définies sur cette interface. |
...
| Nom | Description |
| --- | --- |
| const [SVG_CHANNEL_A](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_a/) | Correspond à la valeur 'A'. |
| const [SVG_CHANNEL_B](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_b/) | Correspond à la valeur 'B'. |
| const [SVG_CHANNEL_G](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_g/) | Correspond à la valeur 'G'. |
| const [SVG_CHANNEL_R](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_r/) | Correspond à la valeur 'R'. |
| const [SVG_CHANNEL_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_unknown/) | Le type ne fait pas partie des types prédéfinis. Il est invalide de tenter de définir une nouvelle valeur de ce type ou d'essayer de changer une valeur existante vers ce type. |
