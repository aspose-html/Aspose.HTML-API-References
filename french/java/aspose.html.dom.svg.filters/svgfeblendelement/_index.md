...
description: "com.aspose.html.dom.svg.filters.SVGFEBlendElement classe. L'interface SVGFEBlendElement correspond à l'élément feBlend."
type: docs

url: /fr/java/com.aspose.html.dom.svg.filters/svgfeblendelement/
---
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfeblendelement/height/) Correspond à l'attribut ‘height’ sur l'élément ‘filter’ donné. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfeblendelement/in1/) Correspond à l'attribut ‘in’ sur l'élément ‘feBlend’ donné. |
| [getIn2](../../com.aspose.html.dom.svg.filters/svgfeblendelement/in2/) Correspond à l'attribut ‘in2’ sur l'élément ‘feBlend’ donné. |
[getInnerHTML]
...
| [getMode](../../com.aspose.html.dom.svg.filters/svgfeblendelement/mode/) Correspond à l'attribut ‘mode’ sur l'élément ‘feBlend’ donné. Prend l'une des constantes SVG_FEBLEND_MODE_* définies sur cette interface. |
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfeblendelement/result/) Correspond à l'attribut ‘result’ sur l'élément ‘filter’ donné. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfeblendelement/width/) Correspond à l'attribut ‘width’ sur l'élément ‘filter’ donné. |
| [X](../../com.aspose.html.dom.svg.filters/svgfeblendelement/x/) { get; } | Correspond à l'attribut ‘x’ de l'élément ‘filter’ donné. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfeblendelement/y/) { get; } | Correspond à l'attribut ‘y’ de l'élément ‘filter’ donné. |
...
| Nom | Description |
| --- | --- |
| const [SVG_FEBLEND_MODE_COLOR](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_color/) | Correspond à la valeur 'color'. |
| const [SVG_FEBLEND_MODE_COLOR_BURN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_color_burn/) | Correspond à la valeur 'color_burn'. |
| const [SVG_FEBLEND_MODE_COLOR_DODGE](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_color_dodge/) | Correspond à la valeur 'color_dodge'. |
| const [SVG_FEBLEND_MODE_DARKEN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_darken/) | Correspond à la valeur 'darken'. |
| const [SVG_FEBLEND_MODE_DIFFERENCE](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_difference/) | Correspond à la valeur 'difference'. |
| const [SVG_FEBLEND_MODE_EXCLUSION](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_exclusion/) | Correspond à la valeur 'exclusion'. |
| const [SVG_FEBLEND_MODE_HARD_LIGHT](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_hard_light/) | Correspond à la valeur 'hard_light'. |
| const [SVG_FEBLEND_MODE_HUE](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_hue/) | Correspond à la valeur 'hue'. |
| const [SVG_FEBLEND_MODE_LIGHTEN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_lighten/) | Correspond à la valeur 'lighten'. |
| const [SVG_FEBLEND_MODE_LUMINOSITY](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_luminosity/) | Correspond à la valeur 'luminosity'. |
| const [SVG_FEBLEND_MODE_MULTIPLY](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_multiply/) | Correspond à la valeur 'multiply'. |
| const [SVG_FEBLEND_MODE_NORMAL](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_normal/) | Correspond à la valeur 'normal'. |
| const [SVG_FEBLEND_MODE_OVERLAY](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_overlay/) | Correspond à la valeur 'overlay'. |
| const [SVG_FEBLEND_MODE_SATURATION](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_saturation/) | Correspond à la valeur 'saturation'. |
| const [SVG_FEBLEND_MODE_SCREEN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_screen/) | Correspond à la valeur 'screen'. |
| const [SVG_FEBLEND_MODE_SOFT_LIGHT](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_soft_light/) | Correspond à la valeur 'soft_light'. |
| const [SVG_FEBLEND_MODE_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_unknown/) | Le type ne fait pas partie des types prédéfinis. Il est invalide de tenter de définir une nouvelle valeur de ce type ou d'essayer de changer une valeur existante vers ce type. |
