...
description: "classe com.aspose.html.dom.svg.filters.SVGFETileElement. L'interface SVGFETileElement correspond à l'élément feTile"
type: docs

url: /fr/java/com.aspose.html.dom.svg.filters/svgfetileelement/
---
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfetileelement/height/) Correspond à l'attribut ‘height’ de l'élément ‘filter’ donné. |
[getId]
[setId] The value of the ‘id’ attribute on the given element, or the empty String if ‘id’ is not present. |
| [getIn1](../../com.aspose.html.dom.svg.filters/svgfetileelement/in1/) Correspond à l'attribut ‘in’ de l'élément ‘feTile’ donné. |
[getInnerHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfetileelement/result/) Correspond à l'attribut ‘result’ de l'élément ‘filter’ donné. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfetileelement/width/) Correspond à l'attribut ‘width’ de l'élément ‘filter’ donné. |
| [X](../../com.aspose.html.dom.svg.filters/svgfetileelement/x/) { get; } | Correspond à l'attribut ‘x’ de l'élément ‘filter’ donné. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfetileelement/y/) { get; } | Correspond à l'attribut ‘y’ de l'élément ‘filter’ donné. |
