...
description: "com.aspose.html.dom.svg.filters.SVGFETurbulenceElement class. L'interface SVGFETurbulenceElement correspond à l'élément feTurbulence."
type: docs

url: /fr/java/com.aspose.html.dom.svg.filters/svgfeturbulenceelement/
---
...
| [getBaseFrequencyX](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/basefrequencyx/) Correspond à l'attribut ‘baseFrequency’ de l'élément ‘feTurbulence’ fourni. Contient la composante X de l'attribut ‘baseFrequency’. |
| [getBaseFrequencyY](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/basefrequencyy/) Correspond à l'attribut ‘baseFrequency’ de l'élément ‘feTurbulence’ fourni. Contient la composante Y de l'attribut ‘baseFrequency’ (éventuellement calculée automatiquement). |
...
| [getHeight](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/height/) Correspond à l'attribut ‘height’ de l'élément ‘filter’ fourni. |
[getId]
...
| [getNumOctaves](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/numoctaves/) Correspond à l'attribut ‘numOctaves’ de l'élément ‘feTurbulence’ fourni. |
[getOuterHTML]
...
| [getResult](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/result/) Correspond à l'attribut ‘result’ de l'élément ‘filter’ fourni. |
| [getSeed](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/seed/) Correspond à l'attribut ‘seed’ de l'élément ‘feTurbulence’ fourni. |
| [getShadowRoot](../../com.aspose.html.dom/element/shadowroot/) Renvoie le shadowRoot stocké sur cet élément ou null s'il est fermé. |
| [getStitchTiles](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/stitchtiles/) Correspond à l'attribut ‘stitchTiles’ de l'élément ‘feTurbulence’ fourni. Accepte l'une des constantes SVG_STITCHTYPE_* définies sur cette interface. |
...
| [getType](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/type/) Correspond à l'attribut ‘type’ de l'élément ‘feTurbulence’ fourni. Accepte l'une des constantes SVG_TURBULENCE_TYPE_* définies sur cette interface. |
...
| [getWidth](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/width/) Correspond à l'attribut ‘width’ de l'élément ‘filter’ fourni. |
| [X](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/x/) { get; } | Correspond à l'attribut ‘x’ de l'élément ‘filter’ donné. |
| [Y](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/y/) { get; } | Correspond à l'attribut ‘y’ de l'élément ‘filter’ donné. |
...
| Nom | Description |
| --- | --- |
| const [SVG_STITCHTYPE_NOSTITCH](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_stitchtype_nostitch/) | Correspond à la valeur 'noStitch'. |
| const [SVG_STITCHTYPE_STITCH](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_stitchtype_stitch/) | Correspond à la valeur 'stitch'. |
| const [SVG_STITCHTYPE_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_stitchtype_unknown/) | Le type ne fait pas partie des types prédéfinis. Il est invalide de tenter de définir une nouvelle valeur de ce type ou d'essayer de changer une valeur existante vers ce type. |
| const [SVG_TURBULENCE_TYPE_FRACTALNOISE](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_turbulence_type_fractalnoise/) | Correspond à la valeur 'fractalNoise'. |
| const [SVG_TURBULENCE_TYPE_TURBULENCE](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_turbulence_type_turbulence/) | Correspond à la valeur 'turbulence'. |
| const [SVG_TURBULENCE_TYPE_UNKNOWN](../../com.aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_turbulence_type_unknown/) | Le type ne fait pas partie des types prédéfinis. Il est invalide de tenter de définir une nouvelle valeur de ce type ou d'essayer de changer une valeur existante vers ce type. |
