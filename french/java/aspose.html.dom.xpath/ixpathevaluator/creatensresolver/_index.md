...
description: "Méthode IXPathEvaluator. Adapte tout nœud DOM pour résoudre les packages afin qu’une expression XPath puisse être évaluée facilement par rapport au contexte du nœud où elle apparaît dans le document. Cet adaptateur fonctionne comme la méthode DOM Level 3 lookupNamespaceURI sur les nœuds pour résoudre le packageURI à partir d’un préfixe donné en utilisant les informations disponibles dans la hiérarchie des nœuds au moment où lookupNamespaceURI est appelée, tout en résolvant correctement le préfixe xml implicite."
type: docs
