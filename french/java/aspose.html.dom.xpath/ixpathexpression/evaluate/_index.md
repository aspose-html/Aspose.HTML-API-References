...
| [dOMException](../../../com.aspose.html.dom/domexception/) | WRONG_DOCUMENT_ERR : Le nœud provient d'un document qui n'est pas pris en charge par le [`IXPathEvaluator`](../../ixpathevaluator/) qui a créé ce [`IXPathExpression`](../). |
| [dOMException](../../../com.aspose.html.dom/domexception/) | NOT_SUPPORTED_ERR : Le nœud n'est pas d'un type autorisé comme nœud de contexte XPath ou le type de requête n'est pas autorisé par ce [`IXPathExpression`](../). |
