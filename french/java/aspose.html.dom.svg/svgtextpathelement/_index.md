...
description: "com.aspose.html.dom.svg.SVGTextPathElement classe. L'interface SVGTextPathElement correspond à l'élément textPath"
type: docs

url: /fr/java/com.aspose.html.dom.svg/svgtextpathelement/
---
...
| [getHref](../../com.aspose.html.dom.svg/svgtextpathelement/href/) Correspond à l'attribut ‘xlink:href’ de l'élément donné. |
[getId]
...
| [getMethod](../../com.aspose.html.dom.svg/svgtextpathelement/method/) Correspond à l'attribut ‘method’ sur l'élément ‘textPath’ donné. |
...
| [getSpacing](../../com.aspose.html.dom.svg/svgtextpathelement/spacing/) Correspond à l'attribut ‘spacing’ sur l'élément ‘textPath’ donné. |
| [getStartOffset](../../com.aspose.html.dom.svg/svgtextpathelement/startoffset/) Correspond à l'attribut ‘startOffset’ sur l'élément ‘textPath’ donné. |
...
| Nom | Description |
| --- | --- |
| const [TEXTPATH_METHODTYPE_ALIGN](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_align/) | Correspond à la valeur 'align'. |
| const [TEXTPATH_METHODTYPE_STRETCH](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_stretch/) | Correspond à la valeur 'stretch'. |
| const [TEXTPATH_METHODTYPE_UNKNOWN](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_unknown/) | L'énumération a été définie sur une valeur qui n'est pas l'une des types prédéfinis. Il est invalide de tenter de définir une nouvelle valeur de ce type ou d'essayer de basculer une valeur existante vers ce type. |
| const [TEXTPATH_SPACINGTYPE_AUTO](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_auto/) | Correspond à la valeur 'auto'. |
| const [TEXTPATH_SPACINGTYPE_EXACT](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_exact/) | Correspond à la valeur 'exact'. |
| const [TEXTPATH_SPACINGTYPE_UNKNOWN](../../com.aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_unknown/) | L'énumération a été définie sur une valeur qui n'est pas l'une des types prédéfinis. Il est invalide de tenter de définir une nouvelle valeur de ce type ou d'essayer de basculer une valeur existante vers ce type. |
