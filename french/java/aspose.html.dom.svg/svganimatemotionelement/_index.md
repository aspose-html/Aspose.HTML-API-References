...
description: "classe com.aspose.html.dom.svg.SVGAnimateMotionElement. L'interface SVGAnimateMotionElement correspond à l'élément animateMotion. L'accès orienté objet aux attributs de l'élément animateMotion via le SVG DOM n'est pas disponible"
type: docs

url: /fr/java/com.aspose.html.dom.svg/svganimatemotionelement/
---
## SVGAnimateMotionElement class

L'interface SVGAnimateMotionElement correspond à l'élément ‘animateMotion’. L'accès orienté objet aux attributs de l'élément ‘animateMotion’ via le SVG DOM n'est pas disponible.
