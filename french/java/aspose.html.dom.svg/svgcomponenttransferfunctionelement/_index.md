...
description: "classe com.aspose.html.dom.svg.SVGComponentTransferFunctionElement. Cette interface définit une interface de base utilisée par les interfaces de fonction de transfert de composant"
type: docs

url: /fr/java/com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/
---
## SVGComponentTransferFunctionElement class

Cette interface définit une interface de base utilisée par les interfaces de fonction de transfert de composant.
...
| Nom | Description |
| --- | --- |
| [getAmplitude](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/amplitude/) Correspond à l'attribut ‘amplitude’ sur l'élément donné. |
...
| [getExponent](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/exponent/) Correspond à l'attribut ‘exponent’ sur l'élément donné. |
...
| [getIntercept](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/intercept/) Correspond à l'attribut ‘intercept’ sur l'élément donné. |
...
| [getOffset](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/offset/) Correspond à l'attribut ‘offset’ sur l'élément donné. |
[getOuterHTML]
...
| [getSlope](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/slope/) Correspond à l'attribut ‘slope’ sur l'élément donné. |
...
| [getTableValues](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/tablevalues/) Correspond à l'attribut ‘tableValues’ sur l'élément donné. |
...
| [getType](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/type/) Correspond à l'attribut ‘type’ sur l'élément donné. Prend l'une des constantes SVG_FECOMPONENTTRANSFER_TYPE_* définies sur cette interface. |
...
| Nom | Description |
| --- | --- |
| const [SVG_FECOMPONENTTRANSFER_TYPE_DISCRETE](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_discrete/) | Correspond à la valeur 'discrete'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_GAMMA](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_gamma/) | Correspond à la valeur 'gamma'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_IDENTITY](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_identity/) | Correspond à la valeur 'identity'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_LINEAR](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_linear/) | Correspond à la valeur 'linear'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_TABLE](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_table/) | Correspond à la valeur 'table'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_UNKNOWN](../../com.aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_unknown/) | Le type ne fait pas partie des types prédéfinis. Il est invalide de tenter de définir une nouvelle valeur de ce type ou d'essayer de changer une valeur existante vers ce type. |
