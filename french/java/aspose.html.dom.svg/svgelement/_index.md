...
description: "com.aspose.html.dom.svg.SVGElement class. Toutes les interfaces SVG DOM qui correspondent directement aux éléments du langage SVG, telles que l'interface SVGPathElement pour l'élément path, dérivent de l'interface SVGElement."
type: docs

url: /fr/java/com.aspose.html.dom.svg/svgelement/
---
## SVGElement class

Toutes les interfaces du SVG DOM qui correspondent directement aux éléments du langage SVG (comme l'interface SVGPathElement pour l'élément ‘path’) dérivent de l'interface SVGElement.
