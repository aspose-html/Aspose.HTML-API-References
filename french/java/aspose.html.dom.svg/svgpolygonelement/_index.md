...
description: "classe com.aspose.html.dom.svg.SVGPolygonElement. L'interface SVGPolygonElement correspond à l'élément polygon"
type: docs

url: /fr/java/com.aspose.html.dom.svg/svgpolygonelement/
---
...
| Nom | Description |
| --- | --- |
| [getAnimatedPoints](../../com.aspose.html.dom.svg/svgpolygonelement/animatedpoints/) Fournit l'accès au contenu animé actuel de l’attribut ‘points’. Si l’attribut ou la propriété donné(e) est animé(e), contient la valeur animée actuelle de l’attribut ou de la propriété. Si l’attribut ou la propriété donné(e) n’est pas actuellement animé(e), contient la même valeur que points. |
...
| [getPoints](../../com.aspose.html.dom.svg/svgpolygonelement/points/) Fournit l'accès au contenu de base (c’est‑à‑dire statique) de l’attribut ‘points’. |
