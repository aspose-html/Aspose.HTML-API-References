...
| --- | --- | --- |
| eventType | String | Le paramètre eventType spécifie le type d'interface [`Event`](../../../com.aspose.html.dom.events/event/) à créer. Si l'interface [`Event`](../../../com.aspose.html.dom.events/event/) spécifiée est prise en charge par l'implémentation, cette méthode renverra un nouveau[`Event`](../../../com.aspose.html.dom.events/event/) du type d'interface demandé. Si le [`Event`](../../../com.aspose.html.dom.events/event/) doit être déclenché via la méthode [`DispatchEvent`](../../../com.aspose.html.dom/eventtarget/dispatchevent/) la méthode appropriée[`InitEvent`](../../../com.aspose.html.dom.events/event/initevent/) doit être appelée après la création afin d'initialiser les valeurs du [`Event`](../../../com.aspose.html.dom.events/event/). |
