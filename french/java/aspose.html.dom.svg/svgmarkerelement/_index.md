...
description: "classe com.aspose.html.dom.svg.SVGMarkerElement. L'interface SVGMarkerElement correspond à l'élément marker."
type: docs

url: /fr/java/com.aspose.html.dom.svg/svgmarkerelement/
---
...
| [getMarkerHeight](../../com.aspose.html.dom.svg/svgmarkerelement/markerheight/) Correspond à l'attribut ‘markerHeight’ sur l'élément ‘marker’ donné. |
| [getMarkerUnits](../../com.aspose.html.dom.svg/svgmarkerelement/markerunits/) Correspond à l'attribut ‘markerUnits’ sur l'élément ‘marker’ donné. L'un des types d'unités de marqueur définis sur cette interface. |
| [getMarkerWidth](../../com.aspose.html.dom.svg/svgmarkerelement/markerwidth/) Correspond à l’attribut ‘markerWidth’ sur l’élément ‘marker’ donné. |
...
| [getOrientAngle](../../com.aspose.html.dom.svg/svgmarkerelement/orientangle/) Correspond à l’attribut ‘orient’ sur l’élément ‘marker’ donné. Si markerUnits est SVG_MARKER_ORIENT_ANGLE, la valeur d’angle pour l’attribut ‘orient’; sinon, elle sera définie à zéro. |
| [getOrientType](../../com.aspose.html.dom.svg/svgmarkerelement/orienttype/) Correspond à l’attribut ‘orient’ sur l’élément ‘marker’ donné. L’un des types d’orientation de marqueur définis sur cette interface. |
[getOuterHTML]
...
| [getPreserveAspectRatio](../../com.aspose.html.dom.svg/svgmarkerelement/preserveaspectratio/) Correspond à l’attribut ‘preserveAspectRatio’ sur l’élément donné. |
...
| [getRefX](../../com.aspose.html.dom.svg/svgmarkerelement/refx/) Correspond à l’attribut ‘refX’ sur l’élément ‘marker’ donné. |
| [getRefY](../../com.aspose.html.dom.svg/svgmarkerelement/refy/) Correspond à l’attribut ‘refY’ sur l’élément ‘marker’ donné. |
...
| [getViewBox](../../com.aspose.html.dom.svg/svgmarkerelement/viewbox/) Correspond à l’attribut ‘viewBox’ sur l’élément donné. |
...
| [setOrientToAngle](../../com.aspose.html.dom.svg/svgmarkerelement/setorienttoangle/)(SVGAngle) | Définit la valeur de l’attribut ‘orient’ à l’angle donné. |
| [setOrientToAuto](../../com.aspose.html.dom.svg/svgmarkerelement/setorienttoauto/)() | Définit la valeur de l’attribut ‘orient’ à 'auto'. |
...
| Nom | Description |
| --- | --- |
| const [SVG_MARKERUNITS_STROKEWIDTH](../../com.aspose.html.dom.svg/svgmarkerelement/svg_markerunits_strokewidth/) | La valeur de l’attribut ‘markerUnits’ est 'strokeWidth'. |
| const [SVG_MARKERUNITS_UNKNOWN](../../com.aspose.html.dom.svg/svgmarkerelement/svg_markerunits_unknown/) | Le type d’unité de marqueur n’est pas l’un des types prédéfinis. Il est invalide de tenter de définir une nouvelle valeur de ce type ou d’essayer de changer une valeur existante vers ce type. |
| const [SVG_MARKERUNITS_USERSPACEONUSE](../../com.aspose.html.dom.svg/svgmarkerelement/svg_markerunits_userspaceonuse/) | La valeur de l’attribut ‘markerUnits’ est 'userSpaceOnUse'. |
| const [SVG_MARKER_ORIENT_ANGLE](../../com.aspose.html.dom.svg/svgmarkerelement/svg_marker_orient_angle/) | L’attribut ‘orient’ possède une valeur d’angle. |
| const [SVG_MARKER_ORIENT_AUTO](../../com.aspose.html.dom.svg/svgmarkerelement/svg_marker_orient_auto/) | L’attribut ‘orient’ a la valeur 'auto'. |
| const [SVG_MARKER_ORIENT_UNKNOWN](../../com.aspose.html.dom.svg/svgmarkerelement/svg_marker_orient_unknown/) | L’orientation du marqueur n’est pas l’un des types prédéfinis. Il est invalide de tenter de définir une nouvelle valeur de ce type ou d’essayer de changer une valeur existante vers ce type. |
