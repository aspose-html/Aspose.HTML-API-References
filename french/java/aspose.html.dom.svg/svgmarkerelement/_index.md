...
description: "com.aspose.html.dom.svg.SVGMarkerElement class. L'interface SVGMarkerElement correspond à l'élément marker."
type: docs
...
| [getOrientAngle](../../com.aspose.html.dom.svg/svgmarkerelement/orientangle/) Correspond à l'attribut ‘orient’ sur l'élément ‘marker’ donné. Si markerUnits est SVG_MARKER_ORIENT_ANGLE, la valeur d'angle pour l'attribut ‘orient’; sinon, elle sera mise à zéro. |
...
| const [SVG_MARKERUNITS_UNKNOWN](../../com.aspose.html.dom.svg/svgmarkerelement/svg_markerunits_unknown/) | Le type d'unité du marqueur n'est pas l'un des types prédéfinis. Il est invalide de tenter de définir une nouvelle valeur de ce type ou d'essayer de changer une valeur existante vers ce type. |
