---
title: "Classe SVGTextContentElement"
second_title: "Référence de l'API Aspose.HTML pour Java"
description: "com.aspose.html.dom.svg.SVGTextContentElement class. Le SVGTextContentElement est hérité par diverses interfaces liées au texte telles que SVGTextElement, SVGTSpanElement, SVGTRefElement, SVGAltGlyphElement et SVGTextPathElement. Pour les méthodes de cette interface qui font référence à un indice de caractère ou à un nombre de caractères, ces références doivent être interprétées comme un indice d'une unité de code UTF‑16 ou un nombre d'unités de code UTF‑16 respectivement. Cela assure la cohérence avec DOM Level 2 Core où les méthodes de l'interface CharacterData utilisent les unités de code UTF‑16 comme indices et comptes dans les données de caractères. Ainsi, par exemple, si le contenu texte d'un élément texte est un seul caractère hors du BMP tel que U+10000, alors appeler getNumberOfChars sur cet élément renverra 2, car il y a deux unités de code UTF‑16 – la paire de substitution utilisée pour représenter ce caractère unique."
type: docs
...
| [getLengthAdjust](../../com.aspose.html.dom.svg/svgtextcontentelement/lengthadjust/) Correspond à l'attribut ‘lengthAdjust’ sur l'élément donné. La valeur doit être l'une des constantes d'ajustement de longueur définies dans cette interface. |
