---
title: "SVGTextContentElement Classe"
second_title: "Référence de l'API Aspose.HTML pour Java"
description: "com.aspose.html.dom.svg.SVGTextContentElement class. Le SVGTextContentElement est hérité par diverses interfaces liées au texte telles que SVGTextElement SVGTSpanElement SVGTRefElement SVGAltGlyphElement et SVGTextPathElement. Pour les méthodes de cette interface qui font référence à un indice de caractère ou à un nombre de caractères, ces références doivent être interprétées comme un indice d'une unité de code UTF-16 ou un nombre d'unités de code UTF-16 respectivement. Ceci est fait pour la cohérence avec DOM Level 2 Core où les méthodes de l'interface CharacterData utilisent des unités de code UTF-16 comme indices et comptes dans les données de caractères. Ainsi, par exemple, si le contenu texte d'un élément texte est un seul caractère non-BMP tel que U10000, alors appeler getNumberOfChars sur cet élément renverra 2 puisque deux unités de code UTF-16 (la paire de substitution) sont utilisées pour représenter ce caractère."
type: docs

url: /fr/java/com.aspose.html.dom.svg/svgtextcontentelement/
---
## SVGTextContentElement class

L'interface SVGTextContentElement est héritée par diverses interfaces liées au texte, telles que SVGTextElement, SVGTSpanElement, SVGTRefElement, SVGAltGlyphElement et SVGTextPathElement. Pour les méthodes de cette interface qui font référence à un indice de caractère ou à un nombre de caractères, ces références doivent être interprétées comme un indice d'une unité de code UTF-16 ou un nombre d'unités de code UTF-16, respectivement. Cela garantit la cohérence avec DOM Level 2 Core, où les méthodes de l'interface CharacterData utilisent les unités de code UTF-16 comme indices et comptes au sein des données de caractères. Ainsi, par exemple, si le contenu texte d'un élément ‘text’ est un seul caractère hors du BMP, tel que U+10000, alors appeler getNumberOfChars sur cet élément renverra 2, car deux unités de code UTF-16 (la paire de substitution) sont utilisées pour représenter ce caractère.
...
| [getLengthAdjust](../../com.aspose.html.dom.svg/svgtextcontentelement/lengthadjust/) Correspond à l'attribut ‘lengthAdjust’ sur l'élément donné. La valeur doit être l'une des constantes d'ajustement de longueur définies sur cette interface. |
...
| [getTextLength](../../com.aspose.html.dom.svg/svgtextcontentelement/textlength/) Correspond à l'attribut ‘textLength’ sur l'élément donné. |
...
| [getComputedTextLength](../../com.aspose.html.dom.svg/svgtextcontentelement/getcomputedtextlength/)() | La somme totale de toutes les valeurs d'avance provenant du rendu de tous les caractères de cet élément, y compris la valeur d'avance sur les glyphes (horizontale ou verticale), l'effet des propriétés ‘kerning’, ‘letter-spacing’ et ‘word-spacing’ ainsi que les ajustements dus aux attributs ‘dx’ et ‘dy’ sur les éléments ‘tspan’. Pour les environnements non rendus, l'agent utilisateur doit faire des hypothèses raisonnables sur les métriques des glyphes. |
...
| [getNumberOfChars](../../com.aspose.html.dom.svg/svgtextcontentelement/getnumberofchars/)() | Renvoie le nombre total de caractères disponibles pour le rendu dans l'élément actuel, ce qui inclut les caractères référencés depuis la référence ‘tref’, indépendamment du fait qu'ils seront rendus ou non. En pratique, cela équivaut à la longueur de l'attribut Node::textContent du DOM Niveau 3 Core ([DOM3], section 1.4), si cet attribut a également développé les éléments ‘tref’. |
...
| Nom | Description |
| --- | --- |
| const [LENGTHADJUST_SPACING](../../com.aspose.html.dom.svg/svgtextcontentelement/lengthadjust_spacing/) | Correspond à la valeur 'spacing'. |
| const [LENGTHADJUST_SPACINGANDGLYPHS](../../com.aspose.html.dom.svg/svgtextcontentelement/lengthadjust_spacingandglyphs/) | Correspond à la valeur 'spacingAndGlyphs'. |
| const [LENGTHADJUST_UNKNOWN](../../com.aspose.html.dom.svg/svgtextcontentelement/lengthadjust_unknown/) | L'énumération a été définie sur une valeur qui n'est pas l'une des types prédéfinis. Il est invalide de tenter de définir une nouvelle valeur de ce type ou d'essayer de basculer une valeur existante vers ce type. |
