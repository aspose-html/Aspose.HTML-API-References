...
description: "com.aspose.html.dom.svg.SVGPolylineElement classe. L'interface SVGPolylineElement correspond à l'élément polyline"
type: docs

url: /fr/java/com.aspose.html.dom.svg/svgpolylineelement/
---
...
| Nom | Description |
| --- | --- |
| [getAnimatedPoints](../../com.aspose.html.dom.svg/svgpolylineelement/animatedpoints/) Fournit l'accès au contenu animé actuel de l'attribut ‘points’. Si l'attribut ou la propriété donnée est animé, contient la valeur animée actuelle de l'attribut ou de la propriété. Si l'attribut ou la propriété donnée n'est pas actuellement animé, contient la même valeur que points. |
...
| [getPoints](../../com.aspose.html.dom.svg/svgpolylineelement/points/) Fournit l'accès au contenu de base (c.-à-d. statique) de l'attribut ‘points’. |
