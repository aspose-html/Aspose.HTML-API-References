...
description: "com.aspose.html.dom.svg.SVGAnimateElement classe. L'interface SVGAnimateElement correspond à l'élément animate. L'accès orienté objet aux attributs de l'élément animate via le SVG DOM n'est pas disponible."
type: docs

url: /fr/java/com.aspose.html.dom.svg/svganimateelement/
---
## SVGAnimateElement class

L'interface SVGAnimateElement correspond à l'élément ‘animate’. L'accès orienté objet aux attributs de l'élément ‘animate’ via le SVG DOM n'est pas disponible.
