...
description: "Classe com.aspose.html.dom.svg.SVGPatternElement. L'interface SVGPatternElement correspond à l'élément pattern."
type: docs

url: /fr/java/com.aspose.html.dom.svg/svgpatternelement/
---
...
| [getHeight](../../com.aspose.html.dom.svg/svgpatternelement/height/) Correspond à l'attribut ‘height’ sur l'élément ‘pattern’ donné. |
| [getHref](../../com.aspose.html.dom.svg/svgpatternelement/href/) Correspond à l'attribut ‘xlink:href’ sur l'élément donné. |
[getId]
...
| [getPatternContentUnits](../../com.aspose.html.dom.svg/svgpatternelement/patterncontentunits/) Correspond à l'attribut ‘patternContentUnits’ sur l'élément ‘pattern’ donné. Accepte l'une des constantes définies dans SVGUnitTypes. |
| [getPatternTransform](../../com.aspose.html.dom.svg/svgpatternelement/patterntransform/) Correspond à l'attribut ‘patternTransform’ sur l'élément ‘pattern’ donné. |
| [getPatternUnits](../../com.aspose.html.dom.svg/svgpatternelement/patternunits/) Correspond à l'attribut ‘patternUnits’ sur l'élément ‘pattern’ donné. Accepte l'une des constantes définies dans SVGUnitTypes. |
...
| [getPreserveAspectRatio](../../com.aspose.html.dom.svg/svgpatternelement/preserveaspectratio/) Correspond à l'attribut ‘preserveAspectRatio’ sur l'élément donné. |
...
| [getRequiredExtensions](../../com.aspose.html.dom.svg/svgpatternelement/requiredextensions/) Correspond à l'attribut ‘requiredExtensions’ sur l'élément donné. |
| [getRequiredFeatures](../../com.aspose.html.dom.svg/svgpatternelement/requiredfeatures/) Correspond à l'attribut ‘requiredFeatures’ sur l'élément donné. |
...
| [getSystemLanguage](../../com.aspose.html.dom.svg/svgpatternelement/systemlanguage/) Correspond à l'attribut ‘systemLanguage’ sur l'élément donné. |
...
| [getViewBox](../../com.aspose.html.dom.svg/svgpatternelement/viewbox/) Correspond à l'attribut ‘viewBox’ sur l'élément donné. |
...
| [getWidth](../../com.aspose.html.dom.svg/svgpatternelement/width/) Correspond à l'attribut ‘width’ sur l'élément ‘pattern’ donné. |
| [X](../../com.aspose.html.dom.svg/svgpatternelement/x/) { get; } | Correspond à l'attribut ‘x’ sur l'élément ‘pattern’ donné. |
| [Y](../../com.aspose.html.dom.svg/svgpatternelement/y/) { get; } | Correspond à l'attribut ‘y’ sur l'élément ‘pattern’ donné. |
