...
description: "com.aspose.html.dom.svg.SVGGeometryElement class. L'interface SVGGeometryElement représente les éléments SVG dont le rendu est défini par une géométrie avec un chemin équivalent et qui peuvent être remplis et tracés. Cela inclut les chemins et les formes de base."
type: docs

url: /fr/java/com.aspose.html.dom.svg/svggeometryelement/
---
## SVGGeometryElement class

L'interface SVGGeometryElement représente les éléments SVG dont le rendu est défini par une géométrie avec un chemin équivalent, et qui peuvent être remplis et tracés. Cela inclut les chemins et les formes de base.
...
| [getEquivalentPath](../../com.aspose.html.dom.svg/svggeometryelement/getequivalentpath/)() | Renvoie une nouvelle instance de [`SVGPathSegList`](../../com.aspose.html.dom.svg.paths/svgpathseglist/) qui représente `SVGGeometryElement` sous forme de segments de chemin. |
