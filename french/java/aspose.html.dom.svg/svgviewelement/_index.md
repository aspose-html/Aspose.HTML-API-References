...
description: "com.aspose.html.dom.svg.SVGViewElement class. L'interface SVGViewElement correspond à l'élément view."
type: docs
...
| [getViewTarget](../../com.aspose.html.dom.svg/svgviewelement/viewtarget/) Correspond à l'attribut ‘viewTarget’ sur l'élément ‘view’ donné. Une liste de valeurs DOMString qui contiennent les noms listés dans l'attribut ‘viewTarget’. Chacune de ces valeurs DOMString peut être associée à l'élément correspondant en utilisant l'appel de méthode getElementById(). |
[getZoomAndPan]
