...
description: "com.aspose.html.dom.svg.SVGRadialGradientElement classe. L'interface SVGRadialGradientElement correspond à l'élément radialGradient."
type: docs

url: /fr/java/com.aspose.html.dom.svg/svgradialgradientelement/
---
...
| [getCx](../../com.aspose.html.dom.svg/svgradialgradientelement/cx/) Correspond à l'attribut ‘cx’ sur l'élément ‘radialGradient’ donné. |
| [getCy](../../com.aspose.html.dom.svg/svgradialgradientelement/cy/) Correspond à l'attribut ‘cy’ sur l'élément ‘radialGradient’ donné. |
...
| [getFr](../../com.aspose.html.dom.svg/svgradialgradientelement/fr/) Correspond à l'attribut ‘fr’ sur l'élément ‘radialGradient’ donné. |
| [getFx](../../com.aspose.html.dom.svg/svgradialgradientelement/fx/) Correspond à l'attribut ‘fx’ sur l'élément ‘radialGradient’ donné. |
| [getFy](../../com.aspose.html.dom.svg/svgradialgradientelement/fy/) Correspond à l'attribut ‘fy’ sur l'élément ‘radialGradient’ donné. |
| [getGradientTransform](../../com.aspose.html.dom.svg/svggradientelement/gradienttransform/) Correspond à l'attribut ‘gradientTransform’ sur l'élément donné. |
| [getGradientUnits](../../com.aspose.html.dom.svg/svggradientelement/gradientunits/) Correspond à l'attribut ‘gradientUnits’ sur l'élément donné. Prend l'une des constantes définies dans SVGUnitTypes. |
| [getHref](../../com.aspose.html.dom.svg/svggradientelement/href/) Correspond à l'attribut ‘xlink:href’ sur l'élément donné. |
[getId]
...
| [R](../../com.aspose.html.dom.svg/svgradialgradientelement/r/) { get; } | Correspond à l'attribut ‘r’ sur l'élément ‘radialGradient’ donné. |
| [getShadowRoot](../../com.aspose.html.dom/element/shadowroot/) Renvoie le shadowRoot stocké sur cet élément ou null s'il est fermé. |
| [getSpreadMethod](../../com.aspose.html.dom.svg/svggradientelement/spreadmethod/) Correspond à l'attribut ‘spreadMethod’ de l'élément donné. L'un des types de méthode de diffusion définis sur cette interface. |
