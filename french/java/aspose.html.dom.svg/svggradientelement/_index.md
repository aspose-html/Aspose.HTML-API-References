...
description: "classe com.aspose.html.dom.svg.SVGGradientElement. L'interface SVGGradientElement est une interface de base utilisée par SVGLinearGradientElement et SVGRadialGradientElement."
type: docs

url: /fr/java/com.aspose.html.dom.svg/svggradientelement/
---
...
| Nom | Description |
| --- | --- |
| const [SVG_SPREADMETHOD_PAD](../../com.aspose.html.dom.svg/svggradientelement/svg_spreadmethod_pad/) | Correspond à la valeur 'pad'. |
| const [SVG_SPREADMETHOD_REFLECT](../../com.aspose.html.dom.svg/svggradientelement/svg_spreadmethod_reflect/) | Correspond à la valeur 'reflect'. |
| const [SVG_SPREADMETHOD_REPEAT](../../com.aspose.html.dom.svg/svggradientelement/svg_spreadmethod_repeat/) | Correspond à la valeur 'repeat'. |
| const [SVG_SPREADMETHOD_UNKNOWN](../../com.aspose.html.dom.svg/svggradientelement/svg_spreadmethod_unknown/) | Le type ne fait pas partie des types prédéfinis. Il est invalide de tenter de définir une nouvelle valeur de ce type ou d'essayer de changer une valeur existante vers ce type. |
