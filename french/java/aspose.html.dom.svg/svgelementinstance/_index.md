...
description: "com.aspose.html.dom.svg.SVGElementInstance class. L'objet racine de chaque arbre d'ombre d'élément use implémente l'interface SVGUseElementShadowRoot. Cette interface ne définit actuellement aucune extension aux propriétés et méthodes définies pour l'interface ShadowRoot et le mixin DocumentOrShadowRoot. Cependant, l'arbre enraciné à ce nœud est entièrement en lecture seule du point de vue des scripts d'auteur."
type: docs

url: /fr/java/com.aspose.html.dom.svg/svgelementinstance/
---
## SVGElementInstance class

L'objet racine de chaque arbre d'ombre d'élément use implémente l'interface SVGUseElementShadowRoot. Cette interface ne définit actuellement aucune extension aux propriétés et méthodes définies pour l'interface ShadowRoot et le mixin DocumentOrShadowRoot. Cependant, l'arbre enraciné à ce nœud est entièrement en lecture seule du point de vue des scripts d'auteur.
