...
description: "com.aspose.html.dom.svg.SVGMaskElement classe. L'interface SVGMaskElement correspond à l'élément mask"
type: docs
...
| [getHeight](../../com.aspose.html.dom.svg/svgmaskelement/height/) Correspond à l'attribut ‘height’ de l'élément ‘mask’ donné. Prend l'une des constantes définies dans SVGUnitTypes. |
[getId]
...
| [getMaskContentUnits](../../com.aspose.html.dom.svg/svgmaskelement/maskcontentunits/) Correspond à l'attribut ‘maskContentUnits’ de l'élément ‘mask’ donné. Prend l'une des constantes définies dans SVGUnitTypes. |
| [getMaskUnits](../../com.aspose.html.dom.svg/svgmaskelement/maskunits/) Correspond à l'attribut ‘maskUnits’ de l'élément ‘mask’ donné. Prend l'une des constantes définies dans SVGUnitTypes. |
...
| [getRequiredExtensions](../../com.aspose.html.dom.svg/svgmaskelement/requiredextensions/) Correspond à l'attribut ‘requiredExtensions’ de l'élément donné. |
| [getRequiredFeatures](../../com.aspose.html.dom.svg/svgmaskelement/requiredfeatures/) Correspond à l'attribut ‘requiredFeatures’ de l'élément donné. |
...
| [getSystemLanguage](../../com.aspose.html.dom.svg/svgmaskelement/systemlanguage/) Correspond à l'attribut ‘systemLanguage’ de l'élément donné. |
...
| [getWidth](../../com.aspose.html.dom.svg/svgmaskelement/width/) Correspond à l'attribut ‘width’ de l'élément ‘mask’ donné. Prend l'une des constantes définies dans SVGUnitTypes. |
| [X](../../com.aspose.html.dom.svg/svgmaskelement/x/) { get; } | Correspond à l'attribut ‘x’ de l'élément ‘mask’ donné. Prend l'une des constantes définies dans SVGUnitTypes. |
| [Y](../../com.aspose.html.dom.svg/svgmaskelement/y/) { get; } | Correspond à l'attribut ‘y’ de l'élément ‘mask’ donné. Prend l'une des constantes définies dans SVGUnitTypes. |
