...
Cloner un nœud copie tous ses attributs et leurs valeurs, y compris les écouteurs intrinsèques (en ligne). Il ne copie pas les écouteurs d'événements ajoutés avec [`addEventListener()`](../../../com.aspose.html.dom.events/ieventtarget/addeventlistener/) ou ceux assignés aux propriétés d'élément (par ex., node.onclick = someFunction). De plus, pour un élément [`&lt;canvas&gt;`](../../../com.aspose.html/htmlcanvaselement/), l'image peinte n'est pas copiée.
...
Cloner un nœud copie tous ses attributs et leurs valeurs, y compris les écouteurs intrinsèques (en ligne). Il ne copie pas les écouteurs d'événements ajoutés avec [addEventListener()](M:com.aspose.html.dom.events.IEventTarget.AddEventListener(System.String,com.aspose.html.dom.events.IEventListener)) ou ceux assignés aux propriétés d'élément (par ex., node.onclick = someFunction). De plus, pour un élément [&lt;canvas&gt;](T:Aspose.Html.HTMLCanvasElement), l'image peinte n'est pas copiée.
...
| --- | --- | --- |
| deep | Boolean | Si vrai, le nœud et tout son sous‑arbre, y compris le texte pouvant se trouver dans les nœuds enfants [`Text`](../../text/), sont également copiés. |
