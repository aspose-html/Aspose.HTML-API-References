...
description: "Propriété Node. La propriété textContent de l'interface Node représente le contenu textuel du nœud et de ses descendants"
type: docs
...
La propriété textContent de l'interface [`Node`](../) représente le contenu textuel du nœud et de ses descendants.
...
Une String, ou null. Sa valeur dépend de la situation:
