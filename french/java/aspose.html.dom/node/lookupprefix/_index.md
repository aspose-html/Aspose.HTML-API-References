...
description: "Méthode Node. La méthode lookupPrefix de l'interface Node renvoie une chaîne contenant le préfixe d'un URI de package donné si présent, sinon null. Lorsque plusieurs préfixes sont possibles, le premier préfixe est renvoyé."
type: docs
