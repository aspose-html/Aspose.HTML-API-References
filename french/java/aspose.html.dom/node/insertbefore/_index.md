...
| enfant | Node | Le nœud devant lequel newNode est inséré. Si celui‑ci est nul, alors newNode est inséré à la fin des nœuds enfants du nœud. |

### Valeur de retour

Renvoie l'enfant ajouté (à moins que newNode soit un [`DocumentFragment`](../../documentfragment/), auquel cas le [`DocumentFragment`](../../documentfragment/) vide est renvoyé).
