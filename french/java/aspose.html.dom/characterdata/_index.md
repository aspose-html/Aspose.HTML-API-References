...
description: "classe com.aspose.html.dom.CharacterData. Le CharacterData étend Node avec un ensemble d'attributs et de méthodes pour accéder aux données de caractères dans le DOM"
type: docs
