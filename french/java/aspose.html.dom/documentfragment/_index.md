...
description: "classe com.aspose.html.dom.DocumentFragment. DocumentFragment est un objet Document léger ou minimal. Il est très fréquent de vouloir extraire une partie de l’arbre d’un document ou de créer un nouveau fragment d’un document."
type: docs

url: /fr/java/com.aspose.html.dom/documentfragment/
---
## DocumentFragment class

DocumentFragment est un objet Document "léger" ou "minimal". Il est très fréquent de vouloir extraire une partie de l'arbre d'un document ou créer un nouveau fragment d'un document.
...
| [getNextElementSibling](../../com.aspose.html.dom/documentfragment/nextelementsibling/) Retourne le nœud d'élément frère suivant de cet élément. null si cet élément n'a aucun nœud frère d'élément qui vient après celui-ci dans l'arbre du document. |
...
| [getPreviousElementSibling](../../com.aspose.html.dom/documentfragment/previouselementsibling/) Retourne le nœud d'élément frère précédent de cet élément. null si cet élément n'a aucun nœud frère d'élément qui vient avant celui-ci dans l'arbre du document. |
...
| [replaceChild](../../com.aspose.html.dom/node/replacechild/)(Node, Node) | Remplace le nœud enfant oldChild par newChild dans la liste des enfants, et renvoie le nœud oldChild. Si newChild est un objet `DocumentFragment`, oldChild est remplacé par tous les enfants du `DocumentFragment`, insérés dans le même ordre. Si le newChild est déjà dans l’arbre, il est d’abord supprimé. |
