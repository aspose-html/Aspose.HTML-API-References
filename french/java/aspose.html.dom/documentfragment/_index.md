...
description: "com.aspose.html.dom.DocumentFragment classe. DocumentFragment est un objet Document léger ou minimal. Il est très fréquent de vouloir extraire une partie de l’arbre d’un document ou de créer un nouveau fragment d’un document."
type: docs
...
| [replaceChild](../../com.aspose.html.dom/node/replacechild/)(Node, Node) | Remplace le nœud enfant oldChild par newChild dans la liste des enfants, et renvoie le nœud oldChild. Si newChild est un objet `DocumentFragment`, oldChild est remplacé par tous les enfants du `DocumentFragment`, insérés dans le même ordre. Si newChild est déjà présent dans l’arbre, il est d’abord supprimé. |
