---
title: "Classe DocumentType"
second_title: "Référence de l'API Aspose.HTML pour Java"
description: "classe com.aspose.html.dom.DocumentType. DocumentType fournit une interface vers la liste des entités définies pour le document"
type: docs

url: /fr/java/com.aspose.html.dom/documenttype/
---
## DocumentType class

Le DocumentType fournit une interface vers la liste des entités définies pour le document.
...
| Nom | Description |
| --- | --- |
| [DocumentType](documenttype/)(String, String, String, String, Document) | Initialise une nouvelle instance de la classe `DocumentType`. |
...
| [getInternalSubset](../../com.aspose.html.dom/documenttype/internalsubset/) Le sous-ensemble interne en tant que chaîne, ou null s'il n'existe pas. |
...
| [getName](../../com.aspose.html.dom/documenttype/name/) Le nom du DTD ; c’est‑à‑dire le nom immédiatement après le mot‑clé DOCTYPE. |
...
| [getNodeName](../../com.aspose.html.dom/documenttype/nodename/) Le nom de ce nœud, selon son type. |
| [getNodeType](../../com.aspose.html.dom/documenttype/nodetype/) Un code représentant le type de l'objet sous-jacent. |
...
| [getPublicId](../../com.aspose.html.dom/documenttype/publicid/) L'identifiant public du sous-ensemble externe. |
| [getSystemId](../../com.aspose.html.dom/documenttype/systemid/) L'identifiant système du sous-ensemble externe. Cela peut être une URI absolue ou non. |
...
| [toString](../../com.aspose.html.dom/documenttype/toString/)() | Renvoie une chaîne qui représente cette instance. |
