...
description: "Propriété Text. Cet attribut renvoie le contenu texte de ce nœud et de ses descendants. Lorsqu'il est défini sur `null`, le réglage n'a aucun effet. En le définissant, tous les enfants éventuels de ce nœud sont supprimés et si la nouvelle `String` n'est pas vide ou `null`, elle est remplacée par un nœud Text unique contenant la `String` ; cet attribut est alors défini sur celle‑ci."
type: docs

url: /fr/java/com.aspose.html.dom/text/textcontent/
---
