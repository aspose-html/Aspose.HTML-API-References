...
description: "classe com.aspose.html.dom.ProcessingInstruction. Le ProcessingInstruction représente une instruction de traitement utilisée dans XML afin de conserver des informations spécifiques au processeur dans le texte du document"
type: docs

url: /fr/java/com.aspose.html.dom/processinginstruction/
---
## ProcessingInstruction class

L'interface ProcessingInstruction représente une "processing instruction", utilisée en XML comme moyen de conserver des informations spécifiques au processeur dans le texte du document.
...
| [getNodeName](../../com.aspose.html.dom/processinginstruction/nodename/) Le nom de ce nœud, selon son type. |
| [getNodeType](../../com.aspose.html.dom/processinginstruction/nodetype/) Un code représentant le type de l'objet sous-jacent. |
| [nodeValue](../../com.aspose.html.dom/processinginstruction/nodevalue/) { get; set; } | La valeur de ce nœud, selon son type. |
...
| [insertData](../../com.aspose.html.dom/characterdata/insertdata/)(int, String) | Insère une chaîne à la position d'offset de 16 bits spécifiée. |
...
| [replaceData](../../com.aspose.html.dom/characterdata/replacedata/)(int, int, String) | Remplace les caractères à partir de l'offset d'unité de 16 bits spécifié par la chaîne spécifiée. |
