...
description: "Classe com.aspose.html.dom.EventTarget. L'interface EventTarget est implémentée par les objets qui peuvent recevoir des événements et peuvent avoir des écouteurs pour ceux-ci. En d'autres termes, tout cible d'événements implémente les trois méthodes associées à cette interface"
type: docs
