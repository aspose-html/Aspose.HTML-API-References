...
Cela fonctionne en ajoutant une fonction ou un objet qui implémente [EventListener](T:com.aspose.html.dom.events.IEventListener) à la liste des écouteurs d'événements pour le type d'événement spécifié sur l'EventTarget sur lequel il est appelé. Si la fonction ou l'objet est déjà dans la liste des écouteurs d'événements pour cette cible, ils ne sont pas ajoutés une seconde fois.
...
| --- | --- | --- |
| type | String | Le type d'événement pour lequel l'utilisateur s'enregistre |
| gestionnaire | DOMEventHandler | Prend un gestionnaire à appeler lorsque l'événement se produit. |
...
Cela fonctionne en ajoutant une fonction ou un objet qui implémente [`EventListener`](../../../com.aspose.html.dom.events/ieventlistener/) à la liste des écouteurs d'événements pour le type d'événement spécifié sur l'EventTarget sur lequel il est appelé. Si la fonction ou l'objet est déjà dans la liste des écouteurs d'événements pour cette cible, ils ne sont pas ajoutés une seconde fois.
