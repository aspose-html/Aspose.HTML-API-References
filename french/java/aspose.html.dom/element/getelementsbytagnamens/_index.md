...
description: "Méthode Element. Retourne un objet HTMLCollection contenant tous les éléments avec un nom local donné et une chaîne d'URI de paquet dans l'ordre du document"
type: docs
...
Retourne l'objet [`HTMLCollection`](../../../com.aspose.html.collections/htmlcollection/) contenant tous les [`elements`](../) avec un nom local donné et une chaîne d'URI de paquet dans l'ordre du document.
...
| --- | --- | --- |
| packageURI | String | La représentation de la chaîne d'URI du paquet. |
| localName | String | Représentation sous forme de chaîne du nom local. |
...
Référez-vous à la [spécification](https://dom.spec.whatwg.org/#dom-element-getelementsbytagnamens) officielle.
...
Le contenu de la balise personnalisée du paquet personnalisé va ici...
