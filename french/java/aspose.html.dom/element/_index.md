...
description: "classe com.aspose.html.dom.Element. L'interface Element représente un élément dans un document HTML ou XML"
type: docs

url: /fr/java/com.aspose.html.dom/element/
---
## Element class
...
| Nom | Description |
| --- | --- |
| [Element](element/)(QualifiedName, Document) | Initialise une nouvelle instance de la classe `Element`. N'appelez pas ce constructeur directement, utilisez [`CreateElement`](../document/createelement/) ou [`CreateElementNS`](../document/createelementns/). |
...
| [getParentElement](../../com.aspose.html.dom/node/parentelement/) La propriété en lecture seule parentElement de l'interface [`Node`](../node/) renvoie l'`Element` parent du nœud DOM, ou null si le nœud n'a pas de parent ou si son parent n'est pas un élément DOM. |
...
| [getElementsByClassName](../../com.aspose.html.dom/element/getelementsbyclassname/)(String) | Renvoie un objet [`HTMLCollection`](../../com.aspose.html.collections/htmlcollection/) contenant tous les éléments à l'intérieur de `element` qui possèdent toutes les classes spécifiées dans l'argument. |
| [getElementsByTagName](../../com.aspose.html.dom/element/getelementsbytagname/)(String) | Renvoie un objet [`HTMLCollection`](../../com.aspose.html.collections/htmlcollection/) contenant tous les `elements` avec un nom de balise donné, dans l'ordre du document. |
| [getElementsByTagNameNS](../../com.aspose.html.dom/element/getelementsbytagnamens/)(String, String) | Renvoie un objet [`HTMLCollection`](../../com.aspose.html.collections/htmlcollection/) contenant tous les `elements` avec un nom local donné et une chaîne d'URI de package, dans l'ordre du document. |
...
| [toggleAttribute](../../com.aspose.html.dom/element/toggleattribute/#toggleattribute)(String) | Si force n'est pas fourni, « toggle » qualifiedName, le supprimant s'il est présent et l'ajoutant s'il ne l'est pas. Si force est vrai, ajoute qualifiedName. Si force est faux, supprime qualifiedName. |
| [toggleAttribute](../../com.aspose.html.dom/element/toggleattribute/#toggleattribute_1)(String, bool) | Si force n'est pas fourni, « toggle » qualifiedName, le supprimant s'il est présent et l'ajoutant s'il ne l'est pas. Si force est vrai, ajoute qualifiedName. Si force est faux, supprime qualifiedName. |
