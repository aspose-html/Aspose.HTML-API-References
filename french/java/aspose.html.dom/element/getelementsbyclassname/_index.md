...
description: "Méthode de l'élément. Retourne un objet HTMLCollection contenant tous les éléments à l'intérieur de l'élément qui possèdent toutes les classes spécifiées dans l'argument"
type: docs
...
Consultez la [spécification](https://dom.spec.whatwg.org/#dom-element-getelementsbyclassname) officielle.
