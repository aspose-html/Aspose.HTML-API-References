...
description: "com.aspose.html.dom.Entity classe. Représente une entité connue, analysée ou non analysée, dans un document XML."
type: docs
...
| [getInputEncoding](../../com.aspose.html.dom/entity/inputencoding/) Un attribut spécifiant l’encodage utilisé pour cette entité au moment de l’analyse, lorsqu’il s’agit d’une entité analysée externe. Cette valeur est nulle si c’est une entité du sous‑ensemble interne ou si elle n’est pas connue. |
...
| [getNotationName](../../com.aspose.html.dom/entity/notationname/) Pour les entités non analysées, le nom de la notation de l’entité. Pour les entités analysées, cette valeur est nulle. |
...
| [getXmlEncoding](../../com.aspose.html.dom/entity/xmlencoding/) Un attribut spécifiant, dans le cadre de la déclaration de texte, l’encodage de cette entité lorsqu’il s’agit d’une entité analysée externe. Sinon, cette valeur est nulle. |
| [getXmlVersion](../../com.aspose.html.dom/entity/xmlversion/) Un attribut spécifiant, dans le cadre de la déclaration de texte, le numéro de version de cette entité lorsqu’il s’agit d’une entité analysée externe. Sinon, cette valeur est nulle. |
