...
description: "classe com.aspose.html.dom.Entity. Représente une entité connue, analysée ou non analysée, dans un document XML."
type: docs

url: /fr/java/com.aspose.html.dom/entity/
---
## Entity class

Représente une entité connue, analysée ou non analysée, dans un document XML.
...
| [getInputEncoding](../../com.aspose.html.dom/entity/inputencoding/) Un attribut spécifiant l’encodage utilisé pour cette entité au moment de l’analyse, lorsqu’il s’agit d’une entité externe analysée. Il est nul si c’est une entité du sous‑ensemble interne ou si elle n’est pas connue. |
...
| [getLocalName](../../com.aspose.html.dom/node/localname/) Retourne la partie locale du nom qualifié de ce nœud. Pour les nœuds de tout type autre que [`ELEMENT_NODE`](../node/element_node/) et [`ATTRIBUTE_NODE`](../node/attribute_node/) et les nœuds créés avec une méthode DOM Niveau 1, telle que [`Document.createElement()`](../document/createelement/), ceci est toujours nul. |
...
| [getNodeName](../../com.aspose.html.dom/entity/nodename/) Le nom de ce nœud, selon son type. |
| [getNodeType](../../com.aspose.html.dom/entity/nodetype/) Un code représentant le type de l’objet sous‑jacent. |
...
| [getNotationName](../../com.aspose.html.dom/entity/notationname/) Pour les entités non analysées, le nom de la notation de l’entité. Pour les entités analysées, il est nul. |
...
| [getPublicId](../../com.aspose.html.dom/entity/publicid/) L’identifiant public associé à l’entité s’il est spécifié, sinon nul. |
| [getSystemId](../../com.aspose.html.dom/entity/systemid/) L’identifiant système associé à l’entité s’il est spécifié, sinon nul. Il peut s’agir d’un URI absolu ou non. |
...
| [getXmlEncoding](../../com.aspose.html.dom/entity/xmlencoding/) Un attribut spécifiant, dans le cadre de la déclaration de texte, l’encodage de cette entité lorsqu’il s’agit d’une entité externe analysée. Il est nul sinon. |
| [getXmlVersion](../../com.aspose.html.dom/entity/xmlversion/) Un attribut spécifiant, dans le cadre de la déclaration de texte, le numéro de version de cette entité lorsqu’il s’agit d’une entité externe analysée. Il est nul sinon. |
