...
description: "Classe com.aspose.html.dom.DOMException. L'interface DOMException représente un événement anormal appelé exception qui se produit suite à l'appel d'une méthode ou à l'accès à une propriété d'une API web. C'est essentiellement la façon dont les conditions d'erreur sont décrites dans les API web."
type: docs
...
| [getMessage](../../com.aspose.html.dom/domexception/message/) Retourne une chaîne représentant un message ou une description associés au nom d'erreur donné. |
...
| Nom | Description |
| --- | --- |
| const [ABORT_ERR](../../com.aspose.html.dom/domexception/abort_err/) | L'opération a été abandonnée. |
...
| const [INUSE_ATTRIBUTE_ERR](../../com.aspose.html.dom/domexception/inuse_attribute_err/) | Si une tentative d'ajout d'un attribut déjà utilisé ailleurs est effectuée. |
...
| const [INVALID_EXPRESSION_ERR](../../com.aspose.html.dom/domexception/invalid_expression_err/) | L'expression comporte une erreur de syntaxe ou n'est pas une expression valide selon les règles du XPathEvaluator spécifique ou contient des fonctions d'extension spécialisées ou des variables non prises en charge par cette implémentation. |
| const [INVALID_MODIFICATION_ERR](../../com.aspose.html.dom/domexception/invalid_modification_err/) | Si une tentative de modification du type de l'objet sous-jacent est effectuée. |
...
| const [NOT_FOUND_ERR](../../com.aspose.html.dom/domexception/not_found_err/) | Si une tentative est faite de référencer un Node dans un contexte où il n'existe pas. |
| const [NOT_SUPPORTED_ERR](../../com.aspose.html.dom/domexception/not_supported_err/) | Si l'implémentation ne prend pas en charge le type d'objet ou l'opération demandé(e). |
| const [NO_DATA_ALLOWED_ERR](../../com.aspose.html.dom/domexception/no_data_allowed_err/) | Si des données sont spécifiées pour un Node qui ne prend pas en charge les données. |
...
| const [SYNTAX_ERR](../../com.aspose.html.dom/domexception/syntax_err/) | Si une chaîne (String) invalide ou illégale est spécifiée. |
...
| const [VALIDATION_ERR](../../com.aspose.html.dom/domexception/validation_err/) | Si un appel à une méthode telle que insertBefore ou removeChild rendait le Node invalide par rapport à la « partial validity », cette exception serait levée et l'opération ne serait pas effectuée. Ce code est utilisé dans [DOM Level 3 Validation]. Référez-vous à cette spécification pour plus d'informations. |
| const [WRONG_DOCUMENT_ERR](../../com.aspose.html.dom/domexception/wrong_document_err/) | Si un Node est utilisé dans un document différent de celui qui l'a créé (qui ne le prend pas en charge). |
