...
description: "Méthode du Document. La méthode getElementById du Document renvoie un objet Element représentant l'élément dont la propriété id correspond à la chaîne spécifiée. Puisque les ID d'éléments doivent être uniques lorsqu'ils sont spécifiés, ils constituent un moyen pratique d'accéder rapidement à un élément spécifique."
type: docs
...
La méthode getElementById() du Document renvoie un objet [`Element`](../../element/) représentant l'élément dont la propriété id correspond à la chaîne spécifiée. Puisque les ID d'éléments doivent être uniques lorsqu'ils sont spécifiés, ils constituent un moyen pratique d'accéder rapidement à un élément spécifique.
...
| --- | --- | --- |
| elementId | String | L'ID de l'élément à localiser. L'ID est une chaîne sensible à la casse qui est unique dans le document ; un seul élément peut posséder un ID donné. |
...
Consultez la [spécification](https://dom.spec.whatwg.org/#dom-nonelementparentnode-getelementbyid) officielle.
