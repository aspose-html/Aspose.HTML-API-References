...
description: "Méthode Document. La méthode getElementsByTagName de l'interface Document renvoie une HTMLCollection d'éléments avec le nom de balise donné"
type: docs
...
La méthode getElementsByTagName de l'interface [`Document`](../) renvoie une [`HTMLCollection`](../../../com.aspose.html.collections/htmlcollection/) d'éléments avec le nom de balise donné.

Le document complet est parcouru, y compris le nœud racine. La [`HTMLCollection`](../../../com.aspose.html.collections/htmlcollection/) retournée est dynamique, ce qui signifie qu'elle se met à jour automatiquement pour rester synchronisée avec l'arbre DOM sans devoir appeler à nouveau document.getElementsByTagName().
...
| --- | --- | --- |
| nomTag | String | Une chaîne représentant le nom des éléments. La chaîne spéciale "*" représente tous les éléments. |
