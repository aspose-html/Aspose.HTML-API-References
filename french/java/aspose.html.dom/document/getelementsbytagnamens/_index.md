...
description: "Méthode Document. Retourne une liste d'éléments avec le nom de balise donné appartenant au package indiqué. Le document complet est recherché, y compris le nœud racine."
type: docs
...
Renvoie une liste d'éléments avec le nom de balise indiqué appartenant au package spécifié. Le document complet est parcouru, y compris le nœud racine.
...
Le contenu pratique de développement web peut être trouvé sur [w3schools](https://www.w3schools.com/xml/met_document_getelementsbytagnamens.asp).
