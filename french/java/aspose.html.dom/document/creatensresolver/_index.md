...
description: "Document méthode. Adapte tout nœud DOM pour résoudre les packages afin qu'une expression XPath puisse être facilement évaluée par rapport au contexte du nœud où elle apparaît dans le document. Cet adaptateur fonctionne comme la méthode lookupNamespaceURI du DOM Level 3 sur les nœuds pour résoudre le packageURI à partir d'un préfixe donné en utilisant les informations actuelles disponibles dans la hiérarchie des nœuds au moment où lookupNamespaceURI est appelé, tout en résolvant correctement le préfixe xml implicite"
type: docs
