...
Lorsqu'elle est appelée sur l'objet document, le document complet est recherché, y compris le nœud racine. Vous pouvez également appeler getElementsByClassName() sur n'importe quel élément ; elle ne renverra que les éléments qui sont des descendants de l'élément racine spécifié avec les classes données.
...
Référez-vous à la [spécification](https://dom.spec.whatwg.org/#dom-document-getelementsbyclassname) officielle.
