...
| [getWhatToShow](../../com.aspose.html.dom.traversal/itraversal/whattoshow/) Cet attribut détermine quels types de nœuds sont présentés par l’itérateur. L’ensemble disponible de constantes est défini dans l’interface NodeFilter. Les nœuds non acceptés par whatToShow seront ignorés, mais leurs enfants peuvent encore être pris en compte. Notez que cet omission a priorité sur le filtre, le cas échéant. |
