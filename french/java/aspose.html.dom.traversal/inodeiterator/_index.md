...
| Nom | Description |
| --- | --- |
| [detach](../../com.aspose.html.dom.traversal/inodeiterator/detach/)() | Détache le NodeIterator de l'ensemble qu'il parcourait, libérant toutes les ressources informatiques et plaçant l'itérateur dans l'état INVALID. Après l'appel de detach, les appels à nextNode ou previousNode lèveront l'exception INVALID_STATE_ERR. |
