...
description: "SvgRenderer method. Définit une méthode pour rendre plusieurs SVGDocuments dans un IDevice spécifique. Le rendu sera effectué une fois qu'il n'y a aucune opération réseau de chargement de ressources, aucun minuteur actif, aucune tâche d'animation ou que le délai d'attente spécifié est écoulé"
type: docs
...
| --- | --- | --- |
| dispositif | IDevice | Le dispositif de sortie. |
| cancellationToken | CancellationToken | Un jeton d'annulation à observer pendant l'attente de la fin de la tâche. |
