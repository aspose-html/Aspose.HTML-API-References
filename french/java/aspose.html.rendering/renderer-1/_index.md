...
description: "com.aspose.html.rendering.Renderer1TSource classe. Représente une classe abstraite pour tous les renderers"
type: docs
...
| [render](../../com.aspose.html.rendering/renderer-1/render/#render_3)(IDevice, TSource) | Définit la méthode de rendu !:TDocument vers le [`IDevice`](../idevice/) spécifié. |
...
| [render](../../com.aspose.html.rendering/renderer-1/render/#render_4)(IDevice, TSource, int) | Définit la méthode de rendu !:TDocument vers le [`IDevice`](../idevice/) spécifié. Le rendu sera effectué une fois qu'il n'y aura aucune opération réseau pour le chargement des ressources, aucun minuteur actif, aucune tâche d'animation ou que le délai spécifié sera écoulé. |
| [render](../../com.aspose.html.rendering/renderer-1/render/#render_5)(IDevice, TSource, TimeSpan) | Définit la méthode de rendu !:TDocument vers le [`IDevice`](../idevice/) spécifié. Le rendu sera effectué une fois qu'il n'y aura aucune opération réseau pour le chargement des ressources, aucun minuteur actif, aucune tâche d'animation ou que le délai spécifié sera écoulé. |
