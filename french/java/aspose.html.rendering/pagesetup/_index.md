...
description: "classe com.aspose.html.rendering.PageSetup. Représente un objet de configuration de page utilisé pour la configuration de la sortie du jeu de pages"
type: docs
