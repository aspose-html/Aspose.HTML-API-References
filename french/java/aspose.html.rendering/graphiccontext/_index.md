...
description: "com.aspose.html.rendering.GraphicContext classe. Contient les paramètres de contrôle graphique actuels. Ces paramètres définissent le cadre global dans lequel les opérateurs graphiques s’exécutent"
type: docs

url: /fr/java/com.aspose.html.rendering/graphiccontext/
---
## GraphicContext class

Contient les paramètres de contrôle graphique actuels. Ces paramètres définissent le cadre global dans lequel les opérateurs graphiques s'exécutent.
...
| Nom | Description |
| --- | --- |
| [GraphicContext](graphiccontext/)() | Initialise une nouvelle instance de la classe `GraphicContext`. |
...
| [getTextInfo](../../com.aspose.html.rendering/graphiccontext/textinfo/) Obtient un objet [`TextInfo`](../textinfo/) qui contient des informations sur le texte rendu. |
