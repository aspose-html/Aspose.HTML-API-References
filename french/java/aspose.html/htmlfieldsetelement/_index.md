...
description: "classe com.aspose.html.HTMLFieldSetElement. Organise les contrôles de formulaire en groupes logiques. Voir la définition de l'élément FIELDSET dans HTML 4.01"
type: docs

url: /fr/java/com.aspose.html/htmlfieldsetelement/
---
...
| [getForm](../../com.aspose.html/htmlfieldsetelement/form/) Retourne l'élément `FORM` contenant ce contrôle. Retourne `null` si ce contrôle n'est pas dans le contexte d'un formulaire. |
[getId]
