...
description: "classe com.aspose.html.HTMLStyleElement. Informations de style. Voir la définition de l'élément STYLE dans HTML 4.01, le module CSS DOM Level 2 Style Sheets and CSS et l'interface LinkStyle dans le module StyleSheets DOM Level 2 Style Sheets and CSS."
type: docs

url: /fr/java/com.aspose.html/htmlstyleelement/
---
## HTMLStyleElement class

Informations de style. Voir la définition de l'élément STYLE dans HTML 4.01, le module CSS [[DOM Level 2 Style Sheets and CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113)] et l'interface `LinkStyle` dans le module StyleSheets [[DOM Level 2 Style Sheets and CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113)].
...
| [getSheet](../../com.aspose.html/htmlstyleelement/sheet/) Obtient la feuille de style associée. |
