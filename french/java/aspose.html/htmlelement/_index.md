...
description: "classe com.aspose.html.HTMLElement. Toutes les interfaces d'éléments HTML dérivent de cette classe. Les éléments qui n'exposent que les attributs de base HTML sont représentés par l'interface de base HTMLElement. Ces éléments sont les suivants : spécial SUB SUP SPAN BDOfont TT I B U S STRIKE BIG SMALL phrase EM STRONG DFN CODE SAMP KBD VAR CITE ACRONYM ABBRlist DD DTNOFRAMES NOSCRIPTADDRESS CENTER. L'attribut style d'un élément HTML est accessible via l'interface ElementCSSInlineStyle qui est définie dans le module CSS DOM Level 2 Style Sheets and CSS"
type: docs

url: /fr/java/com.aspose.html/htmlelement/
---
## HTMLElement class

Tous les interfaces d'éléments HTML dérivent de cette classe. Les éléments qui n'exposent que les attributs de base HTML sont représentés par l'interface de base `HTMLElement`. Ces éléments sont les suivants : spécial : SUB, SUP, SPAN, BDOfont : TT, I, B, U, S, STRIKE, BIG, SMALL phrase : EM, STRONG, DFN, CODE, SAMP, KBD, VAR, CITE, ACRONYM, ABBRlist : DD, DTNOFRAMES, NOSCRIPTADDRESS, CENTERL'attribut `style` d'un élément HTML est accessible via l'interface `ElementCSSInlineStyle` qui est définie dans le module CSS [[DOM Level 2 Style Sheets and CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113)].
