...
description: "com.aspose.html.HTMLElement classe. Toutes les interfaces d'éléments HTML dérivent de cette classe. Les éléments qui n'exposent que les attributs de base HTML sont représentés par l'interface de base HTMLElement. Ces éléments sont les suivants : spécial SUB SUP SPAN BDO font TT I B U S STRIKE BIG SMALL phrase EM STRONG DFN CODE SAMP KBD VAR CITE ACRONYM ABBR list DD DT NOFRAMES NOSCRIPT ADDRESS CENTER. L'attribut style d'un élément HTML est accessible via l'interface ElementCSSInlineStyle qui est définie dans le module CSS DOM Level 2 Style Sheets and CSS"
type: docs
