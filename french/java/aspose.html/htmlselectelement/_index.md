...
description: "classe com.aspose.html.HTMLSelectElement. L'élément select permet la sélection d'une option. Les options contenues peuvent être directement accessibles via l'élément select sous forme de collection. Voir la définition de l'élément SELECT dans HTML 4.01"
type: docs

url: /fr/java/com.aspose.html/htmlselectelement/
---
## HTMLSelectElement class

L'élément select permet la sélection d'une option. Les options contenues peuvent être directement accessibles via l'élément select sous forme de collection. Voir la définition de l'élément SELECT dans HTML 4.01.
...
| [getForm](../../com.aspose.html/htmlselectelement/form/) Le nombre d'options dans ce `SELECT`. |
[getId]
...
| [getOptions](../../com.aspose.html/htmlselectelement/options/) La collection d'éléments `OPTION` contenus par cet élément. @version DOM Level 2 |
[getOuterHTML]
...
| [getType](../../com.aspose.html/htmlselectelement/type/) Le type de ce contrôle de formulaire. C'est la chaîne "select-multiple" lorsque l'attribut multiple est `true` et la chaîne "select-one" lorsque `false`. |
[getValue]
