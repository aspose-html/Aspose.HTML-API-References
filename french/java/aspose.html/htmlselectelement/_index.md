---
title: "HTMLSelectElement Classe"
second_title: "Référence de l'API Aspose.HTML pour Java"
description: "com.aspose.html.HTMLSelectElement classe. L'élément select permet la sélection d'une option. Les options contenues peuvent être directement accessibles via l'élément select sous forme de collection. Voir la définition de l'élément SELECT dans HTML 4.01"
type: docs
