...
description: "com.aspose.html.HTMLCanvasElement classe. L'interface HTMLCanvasElement fournit des propriétés et des méthodes pour manipuler la mise en page et la présentation des éléments canvas. L'interface HTMLCanvasElement hérite également des propriétés et des méthodes de l'interface HTMLElement"
type: docs

url: /fr/java/com.aspose.html/htmlcanvaselement/
---
## HTMLCanvasElement class

L'interface HTMLCanvasElement fournit des propriétés et des méthodes pour manipuler la mise en page et la présentation des éléments canvas. L'interface HTMLCanvasElement hérite également des propriétés et des méthodes de l'interface HTMLElement.
...
| [getContext](../../com.aspose.html/htmlcanvaselement/getcontext/)(String) | Retourne un contexte de dessin sur le canvas, ou null si l'ID de contexte n'est pas pris en charge. Un contexte de dessin vous permet de dessiner sur le canvas. |
...
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl)() | renvoie un URI de données contenant une représentation de l'image dans le format spécifié par le paramètre type (par défaut PNG). L'image renvoyée a une résolution de 96 dpi. |
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl_1)(String) | renvoie un URI de données contenant une représentation de l'image dans le format spécifié par le paramètre type (par défaut PNG). L'image renvoyée a une résolution de 96 dpi. |
| [toDataURL](../../com.aspose.html/htmlcanvaselement/todataurl/#todataurl_2)(String, double) | renvoie un URI de données contenant une représentation de l'image dans le format spécifié par le paramètre type (par défaut PNG). L'image renvoyée a une résolution de 96 dpi. |
