...
description: "HTMLTableSectionElement method. Insérer une ligne dans cette section. La nouvelle ligne est insérée immédiatement avant la ligne d'index actuelle dans cette section. Si l'index est -1 ou égal au nombre de lignes dans cette section, la nouvelle ligne est ajoutée à la fin"
type: docs
...
Insérez une ligne dans cette section. La nouvelle ligne est insérée immédiatement avant la ligne `index` actuelle dans cette section. Si `index` vaut -1 ou est égal au nombre de lignes dans cette section, la nouvelle ligne est ajoutée à la fin.
