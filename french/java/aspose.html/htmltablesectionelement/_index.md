...
description: "classe com.aspose.html.HTMLTableSectionElement. Les éléments THEAD, TFOOT et TBODY"
type: docs

url: /fr/java/com.aspose.html/htmltablesectionelement/
---
...
| [getRows](../../com.aspose.html/htmltablesectionelement/rows/) La collection de lignes dans cette section de tableau. |
...
| [deleteRow](../../com.aspose.html/htmltablesectionelement/deleterow/)(int) | Supprimez une ligne de cette section. |
...
| [insertRow](../../com.aspose.html/htmltablesectionelement/insertrow/)(int) | Insérez une ligne dans cette section. La nouvelle ligne est insérée immédiatement avant la ligne `index`e actuelle de cette section. Si `index` vaut -1 ou est égal au nombre de lignes de cette section, la nouvelle ligne est ajoutée à la fin. |
