...
description: "com.aspose.html.HTMLTableSectionElement classe. Les éléments THEAD, TFOOT et TBODY"
type: docs
...
| [insertRow](../../com.aspose.html/htmltablesectionelement/insertrow/)(int) | Insérez une ligne dans cette section. La nouvelle ligne est insérée immédiatement avant la ligne `index` actuelle dans cette section. Si `index` vaut -1 ou est égal au nombre de lignes dans cette section, la nouvelle ligne est ajoutée à la fin. |
