...
description: "classe com.aspose.html.HTMLTextAreaElement. Champ de texte multilignes. Voir la définition de l'élément TEXTAREA dans HTML 4.01"
type: docs

url: /fr/java/com.aspose.html/htmltextareaelement/
---
## HTMLTextAreaElement class

Champ de texte multilignes. Voir la définition de l'élément TEXTAREA dans HTML 4.01.
...
| [getForm](../../com.aspose.html/htmltextareaelement/form/) Retourne l'élément `FORM` contenant ce contrôle. Retourne `null` si ce contrôle n'est pas dans le contexte d'un formulaire. |
[getId]
...
| [getType](../../com.aspose.html/htmltextareaelement/type/) Le type de ce contrôle de formulaire. C'est la chaîne "textarea". |
[getValue]
