...
description: "classe com.aspose.html.HTMLLegendElement. Fournit une légende pour un groupe FIELDSET. Voir la définition de l'élément LEGEND dans HTML 4.01"
type: docs

url: /fr/java/com.aspose.html/htmllegendelement/
---
## HTMLLegendElement class

Fournit une légende pour un groupe `FIELDSET`. Voir la définition de l'élément LEGEND dans HTML 4.01.
...
| [getForm](../../com.aspose.html/htmllegendelement/form/) Renvoie l'élément `FORM` contenant ce contrôle. Renvoie `null` si ce contrôle n'est pas dans le contexte d'un formulaire. |
[getId]
