...
description: "Classe com.aspose.html.HTMLFormElement. L'élément FORM englobe un comportement similaire à une collection et à un élément. Il fournit un accès direct aux contrôles de formulaire contenus ainsi qu'aux attributs de l'élément de formulaire. Voir la définition de l'élément FORM dans HTML 4.01"
type: docs

url: /fr/java/com.aspose.html/htmlformelement/
---
## HTMLFormElement class

L'élément `FORM` englobe un comportement similaire à une collection et à un élément. Il fournit un accès direct aux contrôles de formulaire contenus ainsi qu'aux attributs de l'élément de formulaire. Voir la définition de l'élément FORM dans HTML 4.01.
...
| [getElements](../../com.aspose.html/htmlformelement/elements/) Renvoie une collection de tous les éléments de contrôle de formulaire dans le formulaire. |
[getEnctype]
...
| [getLength](../../com.aspose.html/htmlformelement/length/) Le nombre de contrôles de formulaire dans le formulaire. |
...
| [reset](../../com.aspose.html/htmlformelement/reset/)() | Restaure les valeurs par défaut d'un élément de formulaire. Elle effectue la même action qu'un bouton de réinitialisation. |
...
| [submit](../../com.aspose.html/htmlformelement/submit/)() | Soumet le formulaire. Elle effectue la même action qu'un bouton d'envoi. |
