...
description: "classe com.aspose.html.HTMLDataListElement. L'élément datalist représente un ensemble d'éléments option qui offrent des options prédéfinies pour d'autres contrôles. Voir également la recommandation W3C HTML 5.2"
type: docs

url: /fr/java/com.aspose.html/htmldatalistelement/
---
## HTMLDataListElement class

L'élément datalist représente un ensemble d'éléments option qui correspondent à des options prédéfinies pour d'autres contrôles. Voir également la [HTML 5.2 W3C Recommendation](https://www.w3.org/TR/html52/sec-forms.html#elementdef-datalist).
...
| [getOptions](../../com.aspose.html/htmldatalistelement/options/) La collection d'éléments `OPTION` contenus dans cet élément. |
[getOuterHTML]
