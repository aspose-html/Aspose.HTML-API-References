...
description: "classe com.aspose.html.HTMLDataListElement. L'élément datalist représente un ensemble d'éléments option qui constituent des options prédéfinies pour d'autres contrôles. Voir également la recommandation W3C HTML 5.2"
type: docs
...
| [getOptions](../../com.aspose.html/htmldatalistelement/options/) La collection d'éléments `OPTION` contenus par cet élément. |
[getOuterHTML]
