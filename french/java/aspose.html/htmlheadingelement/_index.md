...
description: "classe com.aspose.html.HTMLHeadingElement. Pour les éléments H1 à H6. Voir la définition de l'élément H1 dans HTML 4.01"
type: docs

url: /fr/java/com.aspose.html/htmlheadingelement/
---
## HTMLHeadingElement class

Pour les éléments `H1` à `H6`. Voir la définition de l'élément H1 dans HTML 4.01.
