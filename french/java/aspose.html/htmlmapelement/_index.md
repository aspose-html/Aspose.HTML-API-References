---
title: "Classe HTMLMapElement"
second_title: "Référence de l'API Aspose.HTML pour Java"
description: "com.aspose.html.HTMLMapElement classe. Carte d'image côté client. Voir la définition de l'élément MAP dans HTML 4.01"
type: docs

url: /fr/java/com.aspose.html/htmlmapelement/
---
## HTMLMapElement class

Carte d'image côté client. Voir la définition de l'élément MAP dans HTML 4.01.
...
| Nom | Description |
| --- | --- |
| [getAreas](../../com.aspose.html/htmlmapelement/areas/) La liste des zones définies pour la carte d'image. |
