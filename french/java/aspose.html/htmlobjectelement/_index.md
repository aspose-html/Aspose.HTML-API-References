...
description: "classe com.aspose.html.HTMLObjectElement. Objet intégré générique. En principe, toutes les propriétés de l’élément object sont en lecture‑écriture, mais dans certains environnements, certaines propriétés peuvent devenir en lecture seule une fois l’objet sous‑jacent instancié. Voir la définition de l’élément OBJECT dans HTML 4.01"
type: docs

url: /fr/java/com.aspose.html/htmlobjectelement/
---
## HTMLObjectElement class

Objet intégré générique. En principe, toutes les propriétés de l'élément object sont en lecture‑écriture mais dans certains environnements, certaines propriétés peuvent être en lecture seule une fois l'objet sous‑jacent instancié. Voir la définition de l'élément OBJECT dans [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224)].
