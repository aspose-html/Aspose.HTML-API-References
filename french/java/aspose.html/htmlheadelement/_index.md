...
description: "classe com.aspose.html.HTMLHeadElement. Informations d'en-tête du document. Voir la définition de l'élément HEAD dans HTML 4.01"
type: docs

url: /fr/java/com.aspose.html/htmlheadelement/
---
## HTMLHeadElement class

Informations d'en-tête du document. Voir la définition de l'élément HEAD dans HTML 4.01.
