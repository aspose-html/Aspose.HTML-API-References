...
description: "classe com.aspose.html.HTMLButtonElement. Bouton poussoir. Voir la définition de l'élément BUTTON dans HTML 4.01"
type: docs

url: /fr/java/com.aspose.html/htmlbuttonelement/
---
...
| [getForm](../../com.aspose.html/htmlbuttonelement/form/) Retourne l'élément `FORM` contenant ce contrôle. Retourne `null` si ce contrôle n'est pas dans le contexte d'un formulaire. |
[getId]
