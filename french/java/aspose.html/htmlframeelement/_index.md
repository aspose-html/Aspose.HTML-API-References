...
description: "classe com.aspose.html.HTMLFrameElement. Créez un cadre. Voir la définition de l'élément FRAME dans HTML 4.01"
type: docs

url: /fr/java/com.aspose.html/htmlframeelement/
---
## HTMLFrameElement class

Créer un cadre. Voir la définition de l'élément FRAME dans HTML 4.01.
...
| [getContentDocument](../../com.aspose.html/htmlframeelement/contentdocument/) Le document que ce cadre contient, s'il existe et est disponible, ou `null` sinon. @since DOM Level 2 |
[getDir]
