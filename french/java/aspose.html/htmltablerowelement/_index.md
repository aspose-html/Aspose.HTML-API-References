...
description: "com.aspose.html.HTMLTableRowElement classe. Une ligne dans un tableau. Voir la définition de l'élément TR dans HTML 4.01"
type: docs
...
| [getCells](../../com.aspose.html/htmltablerowelement/cells/) La collection des cellules de cette ligne. @version DOM Level 2 |
[getCh]
...
| [getRowIndex](../../com.aspose.html/htmltablerowelement/rowindex/) Ceci est dans l'ordre logique et non dans l'ordre du document. Le `rowIndex` prend en compte les sections (`THEAD`, `TFOOT`, ou `TBODY`) du tableau, plaçant les lignes `THEAD` en premier dans l'index, suivies des lignes `TBODY`, puis des lignes `TFOOT`. @version DOM Level 2 |
...
| [deleteCell](../../com.aspose.html/htmltablerowelement/deletecell/)(int) | Supprimez une cellule de la ligne actuelle. |
...
| [insertCell](../../com.aspose.html/htmltablerowelement/insertcell/)(int) | Insérez une cellule `TD` vide dans cette ligne. Si `index` vaut -1 ou est égal au nombre de cellules, la nouvelle cellule est ajoutée à la fin. |
