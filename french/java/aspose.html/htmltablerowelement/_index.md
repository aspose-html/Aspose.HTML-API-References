...
description: "classe com.aspose.html.HTMLTableRowElement. Une ligne dans un tableau. Voir la définition de l'élément TR dans HTML 4.01"
type: docs

url: /fr/java/com.aspose.html/htmltablerowelement/
---
...
| [getCells](../../com.aspose.html/htmltablerowelement/cells/) La collection de cellules dans cette ligne. @version DOM Level 2 |
[getCh]
...
| [getRowIndex](../../com.aspose.html/htmltablerowelement/rowindex/) Ceci est dans l'ordre logique et non dans l'ordre du document. Le `rowIndex` prend en compte les sections (`THEAD`, `TFOOT` ou `TBODY`) du tableau, plaçant d'abord les lignes `THEAD` dans l'index, suivies des lignes `TBODY`, puis des lignes `TFOOT`. @version DOM Level 2 |
| [getSectionRowIndex](../../com.aspose.html/htmltablerowelement/sectionrowindex/) L'index de cette ligne, relatif à la section actuelle (`THEAD`, `TFOOT` ou `TBODY`), à partir de 0. @version DOM Level 2 |
...
| [deleteCell](../../com.aspose.html/htmltablerowelement/deletecell/)(int) | Supprimer une cellule de la ligne actuelle. |
...
| [insertCell](../../com.aspose.html/htmltablerowelement/insertcell/)(int) | Insérer une cellule vide `TD` dans cette ligne. Si `index` vaut -1 ou est égal au nombre de cellules, la nouvelle cellule est ajoutée à la fin. |
