---
title: "Classe HTMLOptionElement"
second_title: "Référence de l'API Aspose.HTML pour Java"
description: "com.aspose.html.HTMLOptionElement classe. Un choix sélectionnable. Voir la définition de l'élément OPTION dans HTML 4.01"
type: docs

url: /fr/java/com.aspose.html/htmloptionelement/
---
...
| [getForm](../../com.aspose.html/htmloptionelement/form/) Renvoie l'élément `FORM` contenant ce contrôle. Renvoie `null` si ce contrôle n'est pas dans le contexte d'un formulaire. |
[getId]
[setId] The element's identifier. See the id attribute definition in HTML 4.01. |
| [getIndex](../../com.aspose.html/htmloptionelement/index/) L'index de cet `OPTION` dans son parent `SELECT`, à partir de 0. @version DOM Level 2 |
[getInnerHTML]
...
| [getText](../../com.aspose.html/htmloptionelement/text/) Le texte contenu dans l'élément d'option. |
