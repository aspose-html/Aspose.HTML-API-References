...
description: "classe com.aspose.html.HTMLTableElement. Les méthodes de création et de suppression sur la table permettent aux auteurs de construire et de modifier des tables. HTML 4.01 spécifie qu'un seul élément parmi CAPTION, THEAD et TFOOT peut exister dans une table. Ainsi, si l'un existe et que la méthode createTHead ou createTFoot est appelée, la méthode renvoie l'élément THead ou TFoot existant. Voir la définition de l'élément TABLE dans HTML 4.01"
type: docs
...
| [getCaption](../../com.aspose.html/htmltableelement/caption/) Renvoie le `CAPTION` de la table, ou void si aucun n'existe. @version DOM Level 2 |
[getCellPadding]
...
| [getRows](../../com.aspose.html/htmltableelement/rows/) Renvoie le `TFOOT` de la table, ou `null` si aucun n'existe. |
[getRules]
...
| [getTBodies](../../com.aspose.html/htmltableelement/tbodies/) Renvoie une collection des corps de la table (y compris les implicites). |
...
| [getTFoot](../../com.aspose.html/htmltableelement/tfoot/) Renvoie le `THEAD` de la table, ou `null` si aucun n'existe. |
| [getTHead](../../com.aspose.html/htmltableelement/thead/) Renvoie le `CAPTION` de la table, ou void si aucun n'existe. |
[getTitle]
...
| [deleteCaption](../../com.aspose.html/htmltableelement/deletecaption/)() | Supprime la légende de la table, si elle existe. |
| [deleteRow](../../com.aspose.html/htmltableelement/deleterow/)(int) | Supprime une ligne de table. |
| [deleteTFoot](../../com.aspose.html/htmltableelement/deletetfoot/)() | Supprime le pied de la table, s'il existe. |
| [deleteTHead](../../com.aspose.html/htmltableelement/deletethead/)() | Supprime l'en-tête de la table, s'il existe. |
...
| [insertRow](../../com.aspose.html/htmltableelement/insertrow/)(int) | Insère une nouvelle ligne vide dans la table. La nouvelle ligne est insérée immédiatement avant et dans la même section que la ligne actuelle `index` de la table. Si `index` vaut -1 ou est égal au nombre de lignes, la nouvelle ligne est ajoutée à la fin. De plus, lorsque la table est vide, la ligne est insérée dans un `TBODY` qui est créé et inséré dans la table. Une ligne de table ne peut pas être vide selon [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224)]. |
