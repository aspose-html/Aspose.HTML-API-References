...
description: "classe com.aspose.html.HTMLTableElement. Les méthodes de création et de suppression sur le tableau permettent aux auteurs de construire et de modifier des tableaux. HTML 4.01 spécifie qu'un seul élément CAPTION, THEAD et TFOOT peut exister dans un tableau. Ainsi, si l'un d'eux existe et que la méthode createTHead ou createTFoot est appelée, la méthode renvoie l'élément THead ou TFoot existant. Voir la définition de l'élément TABLE dans HTML 4.01."
type: docs

url: /fr/java/com.aspose.html/htmltableelement/
---
## HTMLTableElement class

Les méthodes create* et delete* sur le tableau permettent aux auteurs de créer et modifier des tableaux. [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224)] précise qu'un seul des éléments `CAPTION`, `THEAD` et `TFOOT` peut exister dans un tableau. Ainsi, si l'un existe et que la méthode createTHead() ou createTFoot() est appelée, la méthode renvoie l'élément THead ou TFoot existant. Voir la définition de l'élément TABLE dans HTML 4.01.
...
| [getCaption](../../com.aspose.html/htmltableelement/caption/) Renvoie le `CAPTION` du tableau, ou void s'il n'existe pas. @version DOM Level 2 |
[getCellPadding]
...
| [getRows](../../com.aspose.html/htmltableelement/rows/) Renvoie le `TFOOT` du tableau, ou `null` s'il n'existe pas. |
[getRules]
...
| [getTBodies](../../com.aspose.html/htmltableelement/tbodies/) Renvoie une collection des corps du tableau (y compris les implicites). |
...
| [getTFoot](../../com.aspose.html/htmltableelement/tfoot/) Renvoie le `THEAD` du tableau, ou `null` s'il n'existe pas. |
| [getTHead](../../com.aspose.html/htmltableelement/thead/) Renvoie le `CAPTION` du tableau, ou void s'il n'existe pas. |
[getTitle]
...
| [createCaption](../../com.aspose.html/htmltableelement/createcaption/)() | Crée un nouvel objet de légende de tableau ou renvoie un existant. |
| [createTFoot](../../com.aspose.html/htmltableelement/createtfoot/)() | Crée une ligne de pied de tableau ou renvoie une existante. |
| [createTHead](../../com.aspose.html/htmltableelement/createthead/)() | Crée une ligne d'en-tête de tableau ou renvoie une existante. |
| [deleteCaption](../../com.aspose.html/htmltableelement/deletecaption/)() | Supprime la légende du tableau, si elle existe. |
| [deleteRow](../../com.aspose.html/htmltableelement/deleterow/)(int) | Supprime une ligne de tableau. |
| [deleteTFoot](../../com.aspose.html/htmltableelement/deletetfoot/)() | Supprime le pied du tableau, s'il existe. |
| [deleteTHead](../../com.aspose.html/htmltableelement/deletethead/)() | Supprime l'en-tête du tableau, s'il existe. |
