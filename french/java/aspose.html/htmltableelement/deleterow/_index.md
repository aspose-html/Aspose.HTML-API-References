...
description: "Méthode HTMLTableElement. Supprime une ligne de tableau"
type: docs
...
| exception | condition |
| --- | --- |
| [dOMException](../../../com.aspose.html.dom/domexception/) | INDEX_SIZE_ERR : Levé si l'index spécifié est supérieur ou égal au nombre de lignes ou si l'index est un nombre négatif autre que -1. @version DOM Level 2 |
