...
description: "classe com.aspose.html.HTMLMenuElement. Liste de menus. Voir la définition de l'élément MENU dans HTML 4.01. Cet élément est obsolète dans HTML 4.01"
type: docs

url: /fr/java/com.aspose.html/htmlmenuelement/
---
## HTMLMenuElement class

Liste de menu. Voir la définition de l'élément MENU dans HTML 4.01. Cet élément est obsolète dans HTML 4.01.
