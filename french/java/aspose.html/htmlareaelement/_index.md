...
description: "com.aspose.html.HTMLAreaElement classe. Définition de zone de carte d'image côté client. Voir la définition de l'élément AREA dans HTML 4.01"
type: docs

url: /fr/java/com.aspose.html/htmlareaelement/
---
## HTMLAreaElement class

Définition d'une zone de carte d'image côté client. Voir la définition de l'élément AREA dans HTML 4.01.
...
| [getRelList](../../com.aspose.html/htmlareaelement/rellist/) Retourne un DOMTokenList dynamique qui contient les jetons obtenus à partir de l'analyse de l'attribut "rel". |
