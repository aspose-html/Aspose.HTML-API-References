...
description: "classe com.aspose.html.HTMLTableCellElement. L'objet utilisé pour représenter les éléments TH et TD. Voir la définition de l'élément TD dans HTML 4.01"
type: docs

url: /fr/java/com.aspose.html/htmltablecellelement/
---
## HTMLTableCellElement class

L'objet utilisé pour représenter les éléments `TH` et `TD`. Voir la définition de l'élément TD dans HTML 4.01.
...
| [getCellIndex](../../com.aspose.html/htmltablecellelement/cellindex/) L'index de cette cellule dans la ligne, à partir de 0. Cet index suit l'ordre de l'arbre du document et non l'ordre d'affichage. |
[getCh]
