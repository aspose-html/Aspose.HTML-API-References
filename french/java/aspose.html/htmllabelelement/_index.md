---
title: "HTMLLabelElement Classe"
second_title: "Référence de l'API Aspose.HTML pour Java"
description: "com.aspose.html.HTMLLabelElement classe. Texte du libellé du champ de formulaire. Voir la définition de l'élément LABEL dans HTML 4.01."
type: docs

url: /fr/java/com.aspose.html/htmllabelelement/
---
## HTMLLabelElement class

Texte d'étiquette de champ de formulaire. Voir la définition de l'élément LABEL dans HTML 4.01.
...
| [getForm](../../com.aspose.html/htmllabelelement/form/) Retourne l'élément `FORM` contenant ce contrôle. Retourne `null` si ce contrôle n'est pas dans le contexte d'un formulaire. |
[getId]
