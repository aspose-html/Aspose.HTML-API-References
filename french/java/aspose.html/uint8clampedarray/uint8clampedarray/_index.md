...
description: "Uint8ClampedArray constructor. Initialise une nouvelle instance de la classe Uint8ClampedArray"
type: docs

url: /fr/java/com.aspose.html/uint8clampedarray/uint8clampedarray/
---
## Uint8ClampedArray(int) {#constructor_4}

Initialise une nouvelle instance de la classe [`Uint8ClampedArray`](../).
...
| --- | --- | --- |
| longueur | Int32 | La longueur (nombre d’éléments). |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| données | Byte[] | Les données du tableau. |
