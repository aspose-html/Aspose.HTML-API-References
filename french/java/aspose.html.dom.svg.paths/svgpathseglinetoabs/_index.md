...
description: "com.aspose.html.dom.svg.paths.SVGPathSegLinetoAbs classe. L'interface SVGPathSegLinetoAbs correspond à une \"absolute lineto\" L commande de données de chemin"
type: docs

url: /fr/java/com.aspose.html.dom.svg.paths/svgpathseglinetoabs/
---
## SVGPathSegLinetoAbs class

L'interface SVGPathSegLinetoAbs correspond à une commande de données de chemin "lineto absolu" (L).
...
| [X](../../com.aspose.html.dom.svg.paths/svgpathseglinetoabs/x/) { get; set; } | La coordonnée X absolue du point final de ce segment de chemin. |
| [Y](../../com.aspose.html.dom.svg.paths/svgpathseglinetoabs/y/) { get; set; } | La coordonnée Y absolue du point final de ce segment de chemin. |
