...
description: "Classe com.aspose.html.dom.svg.paths.SVGPathSegCurvetoCubicRel. L’interface SVGPathSegCurvetoCubicRel correspond à une commande de données de chemin curveto c Bézier cubique relative."
type: docs

url: /fr/java/com.aspose.html.dom.svg.paths/svgpathsegcurvetocubicrel/
---
## SVGPathSegCurvetoCubicRel class

L'interface SVGPathSegCurvetoCubicRel correspond à une commande de données de chemin « courbe cubique Bézier relative » (c).
...
| [X](../../com.aspose.html.dom.svg.paths/svgpathsegcurvetocubicrel/x/) { get; set; } | La coordonnée X relative du point final de ce segment de chemin. |
[getX1]
[setX1] The relative X coordinate for the first control point. |
[getX2]
[setX2] The relative X coordinate for the second control point. |
| [Y](../../com.aspose.html.dom.svg.paths/svgpathsegcurvetocubicrel/y/) { get; set; } | La coordonnée Y relative du point final de ce segment de chemin. |
[getY1]
