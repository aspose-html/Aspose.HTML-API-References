...
description: "classe com.aspose.html.dom.svg.paths.SVGPathSegLinetoRel. L'interface SVGPathSegLinetoRel correspond à une commande de données de chemin relative lineto l."
type: docs

url: /fr/java/com.aspose.html.dom.svg.paths/svgpathseglinetorel/
---
## SVGPathSegLinetoRel class

L'interface SVGPathSegLinetoRel correspond à une commande de données de chemin "lineto relatif" (l).
...
| [X](../../com.aspose.html.dom.svg.paths/svgpathseglinetorel/x/) { get; set; } | La coordonnée X relative du point final de ce segment de chemin. |
| [Y](../../com.aspose.html.dom.svg.paths/svgpathseglinetorel/y/) { get; set; } | La coordonnée Y relative du point final de ce segment de chemin. |
