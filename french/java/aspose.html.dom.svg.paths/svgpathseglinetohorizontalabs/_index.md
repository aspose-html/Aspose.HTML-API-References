...
description: "com.aspose.html.dom.svg.paths.SVGPathSegLinetoHorizontalAbs classe. L'interface SVGPathSegLinetoHorizontalAbs correspond à une commande de données de chemin absolue de type lineto horizontal H"
type: docs

url: /fr/java/com.aspose.html.dom.svg.paths/svgpathseglinetohorizontalabs/
---
## SVGPathSegLinetoHorizontalAbs class

L'interface SVGPathSegLinetoHorizontalAbs correspond à une commande de données de chemin "lineto horizontal absolu" (H).
...
| [X](../../com.aspose.html.dom.svg.paths/svgpathseglinetohorizontalabs/x/) { get; set; } | La coordonnée X absolue du point final de ce segment de chemin. |
