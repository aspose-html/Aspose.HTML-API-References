...
description: "com.aspose.html.dom.svg.paths.SVGPathSegCurvetoQuadraticRel classe. L'interface SVGPathSegCurvetoQuadraticRel correspond à une commande de données de chemin relative de type courbe quadratique Bézier q"
type: docs

url: /fr/java/com.aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticrel/
---
## SVGPathSegCurvetoQuadraticRel class

L'interface SVGPathSegCurvetoQuadraticRel correspond à une commande de données de chemin "curveto quadratique Bézier relatif" (q).
...
| [X](../../com.aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticrel/x/) { get; set; } | La coordonnée X relative du point final de ce segment de chemin. |
[getX1]
[setX1] The relative X coordinate for the first control point. |
| [Y](../../com.aspose.html.dom.svg.paths/svgpathsegcurvetoquadraticrel/y/) { get; set; } | La coordonnée Y relative du point final de ce segment de chemin. |
[getY1]
