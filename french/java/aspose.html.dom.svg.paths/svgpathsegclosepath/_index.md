...
description: "com.aspose.html.dom.svg.paths.SVGPathSegClosePath classe. L'interface SVGPathSegClosePath correspond à une commande de données de chemin closepath z"
type: docs

url: /fr/java/com.aspose.html.dom.svg.paths/svgpathsegclosepath/
---
## SVGPathSegClosePath class

L'interface SVGPathSegClosePath correspond à une commande de données de chemin « closepath » (z).
