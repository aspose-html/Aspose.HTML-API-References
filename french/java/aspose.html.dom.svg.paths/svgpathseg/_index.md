...
description: "com.aspose.html.dom.svg.paths.SVGPathSeg class. L'interface SVGPathSeg est une interface de base qui correspond à une seule commande au sein d'une spécification de données de chemin."
type: docs
...
| const [PATHSEG_CURVETO_QUADRATIC_SMOOTH_REL](../../com.aspose.html.dom.svg.paths/svgpathseg/pathseg_curveto_quadratic_smooth_rel/) | Correspond à une "relative smooth quadratic curveto" (t) commande de données de chemin. |
| const [PATHSEG_LINETO_ABS](../../com.aspose.html.dom.svg.paths/svgpathseg/pathseg_lineto_abs/) | Correspond à une "absolute lineto" (L) commande de données de chemin. |
| const [PATHSEG_LINETO_HORIZONTAL_ABS](../../com.aspose.html.dom.svg.paths/svgpathseg/pathseg_lineto_horizontal_abs/) | Correspond à une " absolute horizontal lineto" (H) commande de données de chemin. |
| const [PATHSEG_LINETO_HORIZONTAL_REL](../../com.aspose.html.dom.svg.paths/svgpathseg/pathseg_lineto_horizontal_rel/) | Correspond à une "relative horizontal lineto" (h) commande de données de chemin. |
| const [PATHSEG_LINETO_REL](../../com.aspose.html.dom.svg.paths/svgpathseg/pathseg_lineto_rel/) | Correspond à une "relative lineto" (l) commande de données de chemin. |
| const [PATHSEG_LINETO_VERTICAL_ABS](../../com.aspose.html.dom.svg.paths/svgpathseg/pathseg_lineto_vertical_abs/) | Correspond à une "absolute vertical lineto" (V) commande de données de chemin. |
| const [PATHSEG_LINETO_VERTICAL_REL](../../com.aspose.html.dom.svg.paths/svgpathseg/pathseg_lineto_vertical_rel/) | Correspond à une "relative vertical lineto" (v) commande de données de chemin. |
| const [PATHSEG_MOVETO_ABS](../../com.aspose.html.dom.svg.paths/svgpathseg/pathseg_moveto_abs/) | Correspond à une "absolute moveto" (M) commande de données de chemin. |
| const [PATHSEG_MOVETO_REL](../../com.aspose.html.dom.svg.paths/svgpathseg/pathseg_moveto_rel/) | Correspond à une "relative moveto" (m) commande de données de chemin. |
