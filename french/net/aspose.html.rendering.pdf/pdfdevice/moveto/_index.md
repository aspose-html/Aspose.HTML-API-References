...
description: PdfDevice méthode. Commence un nouveau souschemin en déplaçant le point courant aux coordonnées du paramètre pt en omettant tout segment de ligne de connexion. Si la méthode de construction de chemin précédente dans le chemin actuel était également MoveTo le nouveau MoveTo la remplace  aucun vestige de lopération MoveTo précédente ne reste dans le chemin.
type: docs
weight: 170
url: /fr/net/aspose.html.rendering.pdf/pdfdevice/moveto/
---
