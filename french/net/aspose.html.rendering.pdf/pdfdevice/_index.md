...
description: Aspose.Html.Rendering.Pdf.PdfDevice classe. Représente le rendu dun document pdf.
type: docs
weight: 4440
...
| Nom | La description |
| --- | --- |
| [PdfDevice](pdfdevice/#constructor)(ICreateStreamProvider) | Initialise une nouvelle instance du`PdfDevice` classe. |
| [PdfDevice](pdfdevice/#constructor_4)(Stream) | Initialise une nouvelle instance du`PdfDevice` classe. |
| [PdfDevice](pdfdevice/#constructor_5)(string) | Initialise une nouvelle instance du`PdfDevice` classe. |
| [PdfDevice](pdfdevice/#constructor_1)(PdfRenderingOptions, ICreateStreamProvider) | Initialise une nouvelle instance du`PdfDevice` classe en rendant les options et le fournisseur de flux. |
| [PdfDevice](pdfdevice/#constructor_2)(PdfRenderingOptions, Stream) | Initialise une nouvelle instance du`PdfDevice`classe en rendant les options et le flux de sortie. |
| [PdfDevice](pdfdevice/#constructor_3)(PdfRenderingOptions, string) | Initialise une nouvelle instance du`PdfDevice` classe en rendant les options et le nom du fichier de sortie. |
