...
description: Aspose.Html.Rendering.Doc.DocDeviceDocGraphicContext classe. Contient les paramètres de contrôle graphiques actuels pour le DocDevice. Ces paramètres définissent le cadre global dans lequel les opérateurs graphiques sexécutent.
type: docs
weight: 4180
url: /fr/net/aspose.html.rendering.doc/docdevice.docgraphiccontext/
---
## DocDevice.DocGraphicContext class

Contient les paramètres de contrôle graphiques actuels pour le DocDevice. Ces paramètres définissent le cadre global dans lequel les opérateurs graphiques s'exécutent.
...
| override [TransformationMatrix](../../aspose.html.rendering.doc/docgraphiccontext/transformationmatrix/) { get; set; } | Définit ou obtient la matrice de transformation. |

## Méthodes

| Nom | La description |
| --- | --- |
| override [Clone](../../aspose.html.rendering.doc/docgraphiccontext/clone/)() | Crée une nouvelle instance d'un[`GraphicContext`](../../aspose.html.rendering/graphiccontext/) classe avec les mêmes valeurs de propriété qu'une instance existante. |
| override [Transform](../../aspose.html.rendering.doc/docgraphiccontext/transform/)(Matrix) | Modifier la matrice de transformation actuelle en multipliant la matrice spécifiée. |
