...
description: Aspose.Html.Drawing.Length classe. Représente une unité de mesure de longueur.
type: docs
weight: 2770
url: /fr/net/aspose.html.drawing/length/
---
## Length class
...
| [operator +](../../aspose.html.drawing/length/op_addition/) | Implémente l'opérateur +. |
| [operator ==](../../aspose.html.drawing/length/op_equality/) | Implémente l'opérateur ==. |
| [operator &gt;](../../aspose.html.drawing/length/op_greaterthan/) | Implémente l'opérateur &gt;. |
| [operator &gt;=](../../aspose.html.drawing/length/op_greaterthanorequal/) | Implémente l'opérateur &gt;=. |
| [operator !=](../../aspose.html.drawing/length/op_inequality/) | Implémente l'opérateur !=. |
| [operator &lt;](../../aspose.html.drawing/length/op_lessthan/) | Implémente l'opérateur &lt;. |
| [operator &lt;=](../../aspose.html.drawing/length/op_lessthanorequal/) | Implémente l'opérateur &lt;=. |
| [operator -](../../aspose.html.drawing/length/op_subtraction/) | Implémente l'opérateur -. |
