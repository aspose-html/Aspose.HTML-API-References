...
description: Cette méthode renvoie sil existe une dérivation entre la définition du type de référence cestàdire le TypeInfo sur lequel la méthode est appelée et lautre définition de type cestàdire celle passée en paramètre.
type: docs
weight: 30
