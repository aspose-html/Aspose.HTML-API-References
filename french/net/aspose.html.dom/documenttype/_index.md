...
description: Aspose.Html.Dom.DocumentType classe. Le DocumentType fournit une interface à la liste des entités qui sont définies pour le document
type: docs
weight: 680
url: /fr/net/aspose.html.dom/documenttype/
---
## DocumentType class

Le DocumentType fournit une interface à la liste des entités qui sont définies pour le document
...
| Nom | La description |
| --- | --- |
| [DocumentType](documenttype/)(string, string, string, string, Document) | Initialise une nouvelle instance du`DocumentType` classe. |
...
| [InternalSubset](../../aspose.html.dom/documenttype/internalsubset/) { get; } | Le sous-ensemble interne sous forme de chaîne, ou null s'il n'y en a pas. |
...
| [Name](../../aspose.html.dom/documenttype/name/) { get; } | Le nom de la DTD ; c'est-à-dire, le nom suivant immédiatement le mot-clé DOCTYPE. |
...
| override [NodeName](../../aspose.html.dom/documenttype/nodename/) { get; } | Le nom de ce nœud, en fonction de son type. |
| override [NodeType](../../aspose.html.dom/documenttype/nodetype/) { get; } | Un code représentant le type de l'objet sous-jacent. |
...
| [PublicId](../../aspose.html.dom/documenttype/publicid/) { get; } | L'identifiant public du sous-ensemble externe. |
| [SystemId](../../aspose.html.dom/documenttype/systemid/) { get; } | L'identifiant système du sous-ensemble externe. Cela peut être un URI absolu ou non. |
...
| override [ToString](../../aspose.html.dom/documenttype/tostring/)() | Renvoie unString qui représente cette instance. |
