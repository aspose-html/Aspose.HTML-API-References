...
description: Le DocumentType fournit une interface à la liste des entités qui sont définies pour le document
type: docs
weight: 690
...
| Nom | La description |
| --- | --- |
| [DocumentType](documenttype)(string, string, string, string, Document) | Initialise une nouvelle instance du[`DocumentType`](../documenttype) classe. |
