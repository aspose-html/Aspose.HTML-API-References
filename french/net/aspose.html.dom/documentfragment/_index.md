...
description: DocumentFragment est un objet Document léger ou minimal. Il est très courant de vouloir pouvoir extraire une partie de larborescence dun document ou de créer un nouveau fragment dun document.
type: docs
weight: 680
