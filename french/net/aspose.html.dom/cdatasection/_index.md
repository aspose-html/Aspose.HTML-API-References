...
description: Aspose.Html.Dom.CDATASection classe. Les sections CDATA sont utilisées pour échapper des blocs de texte contenant des caractères qui seraient autrement considérés comme du balisage.
type: docs
weight: 200
url: /fr/net/aspose.html.dom/cdatasection/
---
## CDATASection class
...
| [IsElementContentWhitespace](../../aspose.html.dom/text/iselementcontentwhitespace/) { get; } | Renvoie si ce nœud de texte contient des espaces de contenu d'élément, souvent appelés abusivement "espaces ignorables". |
...
| override [NodeName](../../aspose.html.dom/cdatasection/nodename/) { get; } | Le nom de ce nœud, en fonction de son type. |
| override [NodeType](../../aspose.html.dom/cdatasection/nodetype/) { get; } | Un code représentant le type de l'objet sous-jacent. |
| override [NodeValue](../../aspose.html.dom/text/nodevalue/) { get; set; } | La valeur de ce nœud, en fonction de son type. |
...
| [WholeText](../../aspose.html.dom/text/wholetext/) { get; } | Renvoie tout le texte des nœuds de texte logiquement adjacents à ce nœud, concaténés dans l'ordre du document. |
...
| [SplitText](../../aspose.html.dom/text/splittext/)(int) | Divise ce nœud en deux nœuds au décalage spécifié, en gardant les deux dans l'arborescence en tant que frères et sœurs. |
