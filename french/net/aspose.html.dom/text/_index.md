...
description: Aspose.Html.Dom.Text classe. Linterface Text hérite de CharacterData et représente le contenu textuel appelé données de caractères en XML dun Element ou Attr.
type: docs
weight: 2450
url: /fr/net/aspose.html.dom/text/
---
## Text class

L'interface Text hérite de CharacterData et représente le contenu textuel (appelé données de caractères en XML) d'un Element ou Attr.
...
| override [NodeName](../../aspose.html.dom/text/nodename/) { get; } | Le nom de ce nœud, en fonction de son type. |
| override [NodeType](../../aspose.html.dom/text/nodetype/) { get; } | Un code représentant le type de l'objet sous-jacent. |
