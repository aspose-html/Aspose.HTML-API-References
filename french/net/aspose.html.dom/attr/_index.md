...
description: Aspose.Html.Dom.Attr classe. Linterface Attr représente un attribut dans un objet Element. Généralement les valeurs autorisées pour lattribut sont définies dans un schéma associé au document.
type: docs
weight: 110
url: /fr/net/aspose.html.dom/attr/
---
## Attr class
...
| [IsId](../../aspose.html.dom/attr/isid/) { get; } | Renvoie si cet attribut est connu pour être de type ID (c'est-à-dire pour contenir un identifiant pour son élément propriétaire) ou non. |
| [LastChild](../../aspose.html.dom/node/lastchild/) { get; } | Le dernier enfant de ce nœud. S'il n'y a pas de tel nœud, cela renvoie null. |
| override [LocalName](../../aspose.html.dom/attr/localname/) { get; } | Renvoie la partie locale du nom qualifié de ce nœud. Pour les nœuds de tout type autre que ELEMENT_NODE et ATTRIBUTE_NODE et les nœuds créés avec une méthode DOM Niveau 1, comme Document.createElement(), c'est toujours null. |
| [Name](../../aspose.html.dom/attr/name/) { get; } | Renvoie le nom de cet attribut. |
| override [NamespaceURI](../../aspose.html.dom/attr/namespaceuri/) { get; } | L'URI de l'espace de noms de ce nœud, ou null s'il n'est pas spécifié. |
...
| override [NodeName](../../aspose.html.dom/attr/nodename/) { get; } | Le nom de ce nœud, en fonction de son type. |
| override [NodeType](../../aspose.html.dom/attr/nodetype/) { get; } | Un code représentant le type de l'objet sous-jacent. |
| override [NodeValue](../../aspose.html.dom/attr/nodevalue/) { get; set; } | La valeur de ce nœud, en fonction de son type. |
...
| [OwnerElement](../../aspose.html.dom/attr/ownerelement/) { get; } | Le nœud d'élément auquel cet attribut est attaché ou null si cet attribut n'est pas utilisé. |
...
| override [Prefix](../../aspose.html.dom/attr/prefix/) { get; } | Le préfixe d'espace de noms de ce nœud, ou null s'il n'est pas spécifié. Lorsqu'il est défini comme étant nul, sa définition n'a aucun effet |
...
| [SchemaTypeInfo](../../aspose.html.dom/attr/schematypeinfo/) { get; } | Les informations de type associées à cet attribut. |
| [Specified](../../aspose.html.dom/attr/specified/) { get; } | Vrai si cet attribut a reçu une valeur explicite dans le document d'instance, faux sinon. |
| override [TextContent](../../aspose.html.dom/attr/textcontent/) { get; set; } | Cet attribut renvoie le contenu textuel de ce nœud et de ses descendants. Lorsqu'il est défini comme étant nul, sa définition n'a aucun effet. Lors de la définition, tous les enfants possibles que ce nœud peut avoir sont supprimés et, si la nouvelle chaîne n'est pas vide ou nulle, remplacés par un seul nœud de texte contenant la chaîne à laquelle cet attribut est défini. |
| [Value](../../aspose.html.dom/attr/value/) { get; set; } | Lors de la récupération, la valeur de l'attribut est renvoyée sous forme de chaîne. |
