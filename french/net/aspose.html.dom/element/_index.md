...
description: Linterface Element représente un élément dans un document HTML ou XML.
type: docs
weight: 700
...
| Nom | La description |
| --- | --- |
| [Element](element)(IElementInit) | Initialise une nouvelle instance du[`Element`](../element)classer. N'appelez pas ce constructeur directement, utilisez[`CreateElement`](../document/createelement) ou[`CreateElementNS`](../document/createelementns) . |
