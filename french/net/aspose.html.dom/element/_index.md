...
description: Aspose.Html.Dom.Element classe. Linterface Element représente un élément dans un document HTML ou XML.
type: docs
weight: 690
url: /fr/net/aspose.html.dom/element/
---
## Element class
...
| Nom | La description |
| --- | --- |
| [Element](element/)(IElementInit) | Initialise une nouvelle instance du`Element`classe. N'appelez pas ce constructeur directement, utilisez[`CreateElement`](../document/createelement/) ou[`CreateElementNS`](../document/createelementns/) . |
...
| [Id](../../aspose.html.dom/element/id/) { get; set; } | L'identifiant de l'élément. Voir la définition de l'attribut id dans HTML 4.01. |
...
| [ParentElement](../../aspose.html.dom/node/parentelement/) { get; } | Obtient le parent`Element` de ce nœud. |
