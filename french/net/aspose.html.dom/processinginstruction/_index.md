...
description: Aspose.Html.Dom.ProcessingInstruction classe. Le ProcessingInstruction représente une instruction de traitement utilisée en XML comme moyen de conserver des informations spécifiques au processeur dans le texte du document.
type: docs
weight: 1020
url: /fr/net/aspose.html.dom/processinginstruction/
---
...
| override [NodeName](../../aspose.html.dom/processinginstruction/nodename/) { get; } | Le nom de ce nœud, en fonction de son type. |
| override [NodeType](../../aspose.html.dom/processinginstruction/nodetype/) { get; } | Un code représentant le type de l'objet sous-jacent. |
| override [NodeValue](../../aspose.html.dom/processinginstruction/nodevalue/) { get; set; } | La valeur de ce nœud, en fonction de son type. |
