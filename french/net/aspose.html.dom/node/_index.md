...
description: Aspose.Html.Dom.Node classe. Linterface Node est le type de données principal pour lensemble du modèle dobjet Document. Il représente un nœud unique dans larborescence du document.
type: docs
weight: 1000
url: /fr/net/aspose.html.dom/node/
---
## Node class

L'interface Node est le type de données principal pour l'ensemble du modèle d'objet Document. Il représente un nœud unique dans l'arborescence du document.
...
| [CloneNode](../../aspose.html.dom/node/clonenode/#clonenode)() | Renvoie un doublon de ce nœud, c'est-à-dire qu'il sert de constructeur de copie générique pour les nœuds. Le nœud dupliqué n'a pas de parent (parentNode est nul) et pas de données utilisateur. |
| [CloneNode](../../aspose.html.dom/node/clonenode/#clonenode_1)(bool) | Renvoie un doublon de ce nœud, c'est-à-dire qu'il sert de constructeur de copie générique pour les nœuds. Le nœud dupliqué n'a pas de parent (parentNode est nul) et pas de données utilisateur. |
...
| Nom | La description |
| --- | --- |
| const [ATTRIBUTE_NODE](../../aspose.html.dom/node/attribute_node/) | Un nœud d'attribut |
| const [CDATA_SECTION_NODE](../../aspose.html.dom/node/cdata_section_node/) | Un nœud de section de données |
| const [COMMENT_NODE](../../aspose.html.dom/node/comment_node/) | Un nœud de commentaire |
| const [DOCUMENT_FRAGMENT_NODE](../../aspose.html.dom/node/document_fragment_node/) | Un nœud de fragment de document |
| const [DOCUMENT_NODE](../../aspose.html.dom/node/document_node/) | Un nœud de document |
| const [DOCUMENT_TYPE_NODE](../../aspose.html.dom/node/document_type_node/) | Un type de document node |
| const [ELEMENT_NODE](../../aspose.html.dom/node/element_node/) | Un nœud d'élément |
| const [ENTITY_NODE](../../aspose.html.dom/node/entity_node/) | Un nœud d'entité |
| const [ENTITY_REFERENCE_NODE](../../aspose.html.dom/node/entity_reference_node/) | Un nœud de référence d'entité |
| const [NOTATION_NODE](../../aspose.html.dom/node/notation_node/) | Un nœud de notation |
| const [PROCESSING_INSTRUCTION_NODE](../../aspose.html.dom/node/processing_instruction_node/) | Un nœud d'instruction de traitement |
| const [TEXT_NODE](../../aspose.html.dom/node/text_node/) | Un nœud de texte |
