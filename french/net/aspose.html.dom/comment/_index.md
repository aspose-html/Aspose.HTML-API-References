...
description: Aspose.Html.Dom.Comment classe. Hérite de CharacterData et représente le contenu dun commentaire cestàdire tous les caractères entre le  de début .
type: docs
weight: 310
url: /fr/net/aspose.html.dom/comment/
---
## Comment class

Hérite de CharacterData et représente le contenu d'un commentaire, c'est-à-dire tous les caractères entre le ' de début .
...
| override [NodeName](../../aspose.html.dom/comment/nodename/) { get; } | Le nom de ce nœud, en fonction de son type. |
| override [NodeType](../../aspose.html.dom/comment/nodetype/) { get; } | Un code représentant le type de l'objet sous-jacent. |
| override [NodeValue](../../aspose.html.dom/comment/nodevalue/) { get; set; } | La valeur de ce nœud, en fonction de son type. |
