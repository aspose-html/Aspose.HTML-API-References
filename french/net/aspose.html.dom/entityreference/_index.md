...
description: Aspose.Html.Dom.EntityReference classe. Les nœuds EntityReference peuvent être utilisés pour représenter une référence dentité dans larborescence.
type: docs
weight: 710
url: /fr/net/aspose.html.dom/entityreference/
---
## EntityReference class

Les nœuds EntityReference peuvent être utilisés pour représenter une référence d'entité dans l'arborescence.
...
| override [NodeName](../../aspose.html.dom/entityreference/nodename/) { get; } | Le nom de ce nœud, en fonction de son type. |
| override [NodeType](../../aspose.html.dom/entityreference/nodetype/) { get; } | Un code représentant le type de l'objet sous-jacent. |
