...
description: Converter méthode. Convertir le document source HTML en DOCX. Le résultat est un fichier docx.
type: docs
weight: 20
url: /fr/net/aspose.html.converters/converter/converthtml/
---
## ConvertHTML(HTMLDocument, DocSaveOptions, string) {#converthtml_1}

Convertir le document source HTML en DOCX. Le résultat est un fichier docx.
...
| --- | --- | --- |
| document | HTMLDocument | Origine des conversions[`HTMLDocument`](../../../aspose.html/htmldocument/). |
...
| Paramètre | Taper | La description |
| --- | --- | --- |
| content | String | Contenu HTML de chaîne en ligne. |
...
| Paramètre | Taper | La description |
| --- | --- | --- |
| content | String | Contenu html de la chaîne en ligne. |
| baseUri | String | URI de base du document. Il sera combiné avec le chemin du répertoire actuel pour former une URL absolue. |
| configuration | Configuration | La configuration de l'environnement. |
| options | DocSaveOptions | Possibilités de conversion. |
| outputPath | String | Chemin du fichier de sortie. |
...
Convertir le document source html en PDF. Le résultat est un fichier pdf.
...
Convertir un document html en mhtml. Le résultat est un fichier mhtml.
...
| options | MHTMLSaveOptions | Possibilités de conversion. |
| outputPath | String | Chemin du fichier de sortie. |
...
Convertir le document html en démarque. Le résultat est le fichier md.
...
| --- | --- | --- |
| document | HTMLDocument | Source de conversion. |
| options | MarkdownSaveOptions | Possibilités de conversion. |
| outputPath | String | Chemin du fichier de sortie. |
...
Convertir la source html en démarque. Le résultat est le fichier md.
...
Convertir un document html en xps. Le résultat est le fichier xps.
...
Convertir la source html en xps. Le résultat est le fichier xps.
...
Convertir le document html en image. Le résultat est un fichier image.
...
Convertir la source html en image. Le résultat est un fichier image.
