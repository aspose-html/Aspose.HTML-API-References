...
Convertir la source epub en image. Le résultat est un fichier image.
...
Convertir la source epub en xps. Le résultat est le fichier xps.
...
Convertir la source EPUB en DOCX. Le résultat est un fichier docx.
...
Convertir la source epub en pdf. Le résultat est un fichier pdf.
