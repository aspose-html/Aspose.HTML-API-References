...
Fusionner le modèle html avec les données utilisateur. Le résultat est un fichier html.
...
| --- | --- | --- |
| template | HTMLDocument | Squelette source doc html. |
| data | TemplateData | Données à fusionner (XML, JSON). |
| options | TemplateLoadOptions | Objet Options de fusion. |
...
| Paramètre | Taper | La description |
| --- | --- | --- |
| url | Url | URL du document source du modèle. |
| data | TemplateData | Données à fusionner (XML, JSON). |
| options | TemplateLoadOptions | Objet Options de fusion. |
| outputPath | String | Chemin du fichier de sortie. |
...
| Paramètre | Taper | La description |
| --- | --- | --- |
| sourcePath | String | Chemin d'accès au fichier html source du modèle. Il sera combiné avec le chemin du répertoire actuel pour former une URL absolue. |
| data | TemplateData | Données à fusionner (XML, JSON). |
| options | TemplateLoadOptions | Objet Options de fusion. |
| outputPath | String | Chemin du fichier de sortie. |
...
| Paramètre | Taper | La description |
| --- | --- | --- |
| content | String | Modèle html en ligne - squelette. |
...
Résultat de la conversion HTMLDocument.
