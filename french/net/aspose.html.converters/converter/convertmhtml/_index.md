...
description: Converter méthode. Convertir la source mhtml en xps. Le résultat est le fichier xps.
type: docs
weight: 40
url: /fr/net/aspose.html.converters/converter/convertmhtml/
---
## ConvertMHTML(Stream, XpsSaveOptions, string) {#convertmhtml_31}

Convertir la source mhtml en xps. Le résultat est le fichier xps.
...
| --- | --- | --- |
| stream | Stream | Flux source de conversion. |
...
Convertir la source MHTML en DOCX. Le résultat est un fichier docx.
...
Convertir la source mhtml en pdf. Le résultat est un fichier pdf.
...
Convertir la source mhtml en image. Le résultat est un fichier image.
