...
description: La NodeList fournit labstraction dune collection ordonnée de nœuds sans définir ni contraindre la façon dont cette collection est implémentée.
type: docs
weight: 50
