...
description: Aspose.Html.Dom.Svg.SVGMaskElement classe. Linterface SVGMaskElement correspond à lélément mask.
type: docs
weight: 2170
url: /fr/net/aspose.html.dom.svg/svgmaskelement/
---
...
| [Height](../../aspose.html.dom.svg/svgmaskelement/height/) { get; } | Correspond à l'attribut 'height' sur l'élément 'mask' donné. Prend l'une des constantes définies dans SVGUnitTypes. |
...
| [MaskContentUnits](../../aspose.html.dom.svg/svgmaskelement/maskcontentunits/) { get; } | Correspond à l'attribut 'maskContentUnits' sur l'élément 'mask' donné. Prend l'une des constantes définies dans SVGUnitTypes. |
| [MaskUnits](../../aspose.html.dom.svg/svgmaskelement/maskunits/) { get; } | Correspond à l'attribut 'maskUnits' sur l'élément 'mask' donné. Prend l'une des constantes définies dans SVGUnitTypes. |
...
| [RequiredExtensions](../../aspose.html.dom.svg/svgmaskelement/requiredextensions/) { get; } | Correspond à l'attribut 'requiredExtensions' sur l'élément donné. |
| [RequiredFeatures](../../aspose.html.dom.svg/svgmaskelement/requiredfeatures/) { get; } | Correspond à l'attribut 'requiredFeatures' sur l'élément donné. |
...
| [SystemLanguage](../../aspose.html.dom.svg/svgmaskelement/systemlanguage/) { get; } | Correspond à l'attribut 'systemLanguage' sur l'élément donné. |
...
| [Width](../../aspose.html.dom.svg/svgmaskelement/width/) { get; } | Correspond à l'attribut 'width' sur l'élément 'mask' donné. Prend l'une des constantes définies dans SVGUnitTypes. |
| [X](../../aspose.html.dom.svg/svgmaskelement/x/) { get; } | Correspond à l'attribut 'x' sur l'élément 'mask' donné. Prend l'une des constantes définies dans SVGUnitTypes. |
| [Y](../../aspose.html.dom.svg/svgmaskelement/y/) { get; } | Correspond à l'attribut 'y' sur l'élément 'mask' donné. Prend l'une des constantes définies dans SVGUnitTypes. |
