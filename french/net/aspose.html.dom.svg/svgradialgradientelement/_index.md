...
description: Aspose.Html.Dom.Svg.SVGRadialGradientElement classe. Linterface SVGRadialGradientElement correspond à lélément radialGradient.
type: docs
weight: 2230
url: /fr/net/aspose.html.dom.svg/svgradialgradientelement/
---
...
| [Cx](../../aspose.html.dom.svg/svgradialgradientelement/cx/) { get; } | Correspond à l'attribut 'cx' sur l'élément 'radialGradient' donné. |
| [Cy](../../aspose.html.dom.svg/svgradialgradientelement/cy/) { get; } | Correspond à l'attribut 'cy' sur l'élément 'radialGradient' donné. |
...
| [Fr](../../aspose.html.dom.svg/svgradialgradientelement/fr/) { get; } | Correspond à l'attribut 'fr' sur l'élément 'radialGradient' donné. |
| [Fx](../../aspose.html.dom.svg/svgradialgradientelement/fx/) { get; } | Correspond à l'attribut 'fx' sur l'élément 'radialGradient' donné. |
| [Fy](../../aspose.html.dom.svg/svgradialgradientelement/fy/) { get; } | Correspond à l'attribut 'fy' sur l'élément 'radialGradient' donné. |
| [GradientTransform](../../aspose.html.dom.svg/svggradientelement/gradienttransform/) { get; } | Correspond à l'attribut 'gradientTransform' sur l'élément donné. |
| [GradientUnits](../../aspose.html.dom.svg/svggradientelement/gradientunits/) { get; } | Correspond à l'attribut 'gradientUnits' sur l'élément donné. Prend l'une des constantes définies dans SVGUnitTypes. |
| [Href](../../aspose.html.dom.svg/svggradientelement/href/) { get; } | Correspond à l'attribut 'xlink:href' sur l'élément donné. |
...
| [R](../../aspose.html.dom.svg/svgradialgradientelement/r/) { get; } | Correspond à l'attribut 'r' sur l'élément 'radialGradient' donné. |
...
| [SpreadMethod](../../aspose.html.dom.svg/svggradientelement/spreadmethod/) { get; } | Correspond à l'attribut 'spreadMethod' sur l'élément donné. L'un des types de méthodes de répartition définis sur cette interface. |
