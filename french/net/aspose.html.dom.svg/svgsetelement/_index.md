...
description: Aspose.Html.Dom.Svg.SVGSetElement classe. Linterface SVGSetElement correspond à lélément set. Laccès orienté objet aux attributs de lélément set via le DOM SVG nest pas disponible.
type: docs
weight: 2280
url: /fr/net/aspose.html.dom.svg/svgsetelement/
---
## SVGSetElement class

L'interface SVGSetElement correspond à l'élément 'set'. L'accès orienté objet aux attributs de l'élément 'set' via le DOM SVG n'est pas disponible.
