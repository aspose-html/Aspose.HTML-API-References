...
description: Linterface SVGAnimateElement correspond à lélément animate. Laccès orienté objet aux attributs de lélément animate via le DOM SVG nest pas disponible.
type: docs
weight: 1920
