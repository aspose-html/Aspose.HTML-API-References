...
description: Aspose.Html.Dom.Svg.SVGAnimateElement classe. Linterface SVGAnimateElement correspond à lélément animate. Laccès orienté objet aux attributs de lélément animate via le DOM SVG nest pas disponible.
type: docs
weight: 1910
url: /fr/net/aspose.html.dom.svg/svganimateelement/
---
## SVGAnimateElement class

L'interface SVGAnimateElement correspond à l'élément 'animate'. L'accès orienté objet aux attributs de l'élément 'animate' via le DOM SVG n'est pas disponible.
