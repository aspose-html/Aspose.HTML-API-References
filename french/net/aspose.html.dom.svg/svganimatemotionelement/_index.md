...
description: Aspose.Html.Dom.Svg.SVGAnimateMotionElement classe. Linterface SVGAnimateMotionElement correspond à lélément animateMotion. Laccès orienté objet aux attributs de lélément animateMotion via le DOM SVG nest pas disponible.
type: docs
weight: 1920
url: /fr/net/aspose.html.dom.svg/svganimatemotionelement/
---
## SVGAnimateMotionElement class

L'interface SVGAnimateMotionElement correspond à l'élément 'animateMotion'. L'accès orienté objet aux attributs de l'élément 'animateMotion' via le DOM SVG n'est pas disponible.
