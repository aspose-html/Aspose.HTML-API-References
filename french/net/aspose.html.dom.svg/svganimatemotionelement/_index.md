...
description: Linterface SVGAnimateMotionElement correspond à lélément animateMotion. Laccès orienté objet aux attributs de lélément animateMotion via le DOM SVG nest pas disponible.
type: docs
weight: 1930
