...
description: Aspose.Html.Dom.Svg.SVGGraphicsElement classe. Linterface SVGGraphicsElement représente des éléments SVG dont le but principal est de rendre directement les graphiques dans un groupe.
type: docs
weight: 2110
url: /fr/net/aspose.html.dom.svg/svggraphicselement/
---
## SVGGraphicsElement class

L'interface SVGGraphicsElement représente des éléments SVG dont le but principal est de rendre directement les graphiques dans un groupe.
