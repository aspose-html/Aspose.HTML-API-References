...
| [Domain](../../aspose.html.dom.svg/svgdocument/domain/) { get; } | Le nom de domaine du serveur qui a servi le document, ou une chaîne nulle si le serveur ne peut pas être identifié par un nom de domaine. |
...
| [Referrer](../../aspose.html.dom.svg/svgdocument/referrer/) { get; } | Renvoie l'URI de la page liée à cette page. La valeur est une chaîne vide si l'utilisateur a accédé directement à la page (pas via un lien, mais, par exemple, via un signet). |
| [RootElement](../../aspose.html.dom.svg/svgdocument/rootelement/) { get; } | La racine 'svg' dans la hiérarchie du document. |
...
| [Title](../../aspose.html.dom.svg/svgdocument/title/) { get; } | Le titre d'un document tel que spécifié par le sous-élément 'title' de l'élément racine 'svg' (c'est-à-dire,Voici le titre... ) |
| [URL](../../aspose.html.dom.svg/svgdocument/url/) { get; } | L'URI complet du document. |
...
| [GetOverrideStyle](../../aspose.html.dom.svg/svgdocument/getoverridestyle/)(Element, string) | Cette méthode est utilisée pour récupérer la déclaration de style de remplacement pour un élément spécifié et un pseudo-élément spécifié. |
...
| override [RenderTo](../../aspose.html.dom.svg/svgdocument/renderto/)(IDevice) | Cette méthode est utilisée pour imprimer le contenu du document actuel sur le périphérique spécifié. |
...
| [Save](../../aspose.html.dom.svg/svgdocument/save/#save)(IOutputStorage) | Enregistre le contenu et les ressources du document dans le stockage de sortie. |
| [Save](../../aspose.html.dom.svg/svgdocument/save/#save_6)(string) | Enregistre le document dans le fichier local spécifié par`chemin` Toutes les ressources utilisées dans ce document seront enregistrées dans dans le dossier adjacent, dont le nom sera construit comme : output_file_name + "_files". |
| [Save](../../aspose.html.dom.svg/svgdocument/save/#save_3)(Url) | Enregistre le document dans le fichier local spécifié par`URL` Toutes les ressources utilisées dans ce document seront enregistrées dans dans le dossier adjacent, dont le nom sera construit comme : output_file_name + "_files". |
| [Save](../../aspose.html.dom.svg/svgdocument/save/#save_1)(IOutputStorage, SVGSaveFormat) | Enregistre le contenu et les ressources du document dans le stockage de sortie. |
| [Save](../../aspose.html.dom.svg/svgdocument/save/#save_2)(IOutputStorage, SVGSaveOptions) | Enregistre le contenu et les ressources du document dans le stockage de sortie. |
| [Save](../../aspose.html.dom.svg/svgdocument/save/#save_7)(string, SVGSaveFormat) | Enregistre le document dans le fichier local spécifié par`chemin` Toutes les ressources utilisées dans ce document seront enregistrées dans dans le dossier adjacent, dont le nom sera construit comme : output_file_name + "_files". |
| [Save](../../aspose.html.dom.svg/svgdocument/save/#save_8)(string, SVGSaveOptions) | Enregistre le document dans le fichier local spécifié par`chemin` Toutes les ressources utilisées dans ce document seront enregistrées dans dans le dossier adjacent, dont le nom sera construit comme : output_file_name + "_files". |
| [Save](../../aspose.html.dom.svg/svgdocument/save/#save_4)(Url, SVGSaveFormat) | Enregistre le document dans le fichier local spécifié par`URL` Toutes les ressources utilisées dans ce document seront enregistrées dans dans le dossier adjacent, dont le nom sera construit comme : output_file_name + "_files". |
| [Save](../../aspose.html.dom.svg/svgdocument/save/#save_5)(Url, SVGSaveOptions) | Enregistre le document dans le fichier local spécifié par`URL` Toutes les ressources utilisées dans ce document seront enregistrées dans dans le dossier adjacent, dont le nom sera construit comme : output_file_name + "_files". |
