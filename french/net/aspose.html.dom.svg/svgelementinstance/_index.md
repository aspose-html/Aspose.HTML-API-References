...
description: Aspose.Html.Dom.Svg.SVGElementInstance classe. Lobjet racine de chaque arbre fantôme déléments dutilisation implémente linterface SVGUseElementShadowRoot. Cette interface ne définit actuellement aucune extension des propriétés et des méthodes définies pour linterface ShadowRoot et le mixin DocumentOrShadowRoot. Cependant larborescence enracinée à ce nœud est entièrement en lecture seule du point de vue des scripts dauteur.
type: docs
weight: 2030
url: /fr/net/aspose.html.dom.svg/svgelementinstance/
---
## SVGElementInstance class

L'objet racine de chaque arbre fantôme d'éléments d'utilisation implémente l'interface SVGUseElementShadowRoot. Cette interface ne définit actuellement aucune extension des propriétés et des méthodes définies pour l'interface ShadowRoot et le mixin DocumentOrShadowRoot. Cependant, l'arborescence enracinée à ce nœud est entièrement en lecture seule du point de vue des scripts d'auteur.
