...
description: Toutes les interfaces SVG DOM qui correspondent directement aux éléments du langage SVG comme linterface SVGPathElement pour lélément path dérivent de linterface SVGElement.
type: docs
weight: 2030
