...
description: Aspose.Html.Dom.Svg.SVGElement classe. Toutes les interfaces SVG DOM qui correspondent directement aux éléments du langage SVG comme linterface SVGPathElement pour lélément path dérivent de linterface SVGElement.
type: docs
weight: 2020
url: /fr/net/aspose.html.dom.svg/svgelement/
---
## SVGElement class

Toutes les interfaces SVG DOM qui correspondent directement aux éléments du langage SVG (comme l'interface SVGPathElement pour l'élément 'path') dérivent de l'interface SVGElement.
