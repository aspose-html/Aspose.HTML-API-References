...
description: Aspose.Html.Dom.Svg.SVGAnimationElement classe. Linterface SVGAnimationElement est linterface de base pour toutes les interfaces déléments danimation  SVGAnimateElement SVGSetElement SVGAnimateColorElement SVGAnimateMotionElement et SVGAnimateTransformElement.
type: docs
weight: 1940
url: /fr/net/aspose.html.dom.svg/svganimationelement/
---
## SVGAnimationElement class

L'interface SVGAnimationElement est l'interface de base pour toutes les interfaces d'éléments d'animation : SVGAnimateElement, SVGSetElement, SVGAnimateColorElement, SVGAnimateMotionElement et SVGAnimateTransformElement.
...
| [RequiredExtensions](../../aspose.html.dom.svg/svganimationelement/requiredextensions/) { get; } | Correspond à l'attribut 'requiredExtensions' sur l'élément donné. |
| [RequiredFeatures](../../aspose.html.dom.svg/svganimationelement/requiredfeatures/) { get; } | Correspond à l'attribut 'requiredFeatures' sur l'élément donné. |
...
| [SystemLanguage](../../aspose.html.dom.svg/svganimationelement/systemlanguage/) { get; } | Correspond à l'attribut 'systemLanguage' sur l'élément donné. |
| [TagName](../../aspose.html.dom/element/tagname/) { get; } | Le nom de l'élément. |
| [TargetElement](../../aspose.html.dom.svg/svganimationelement/targetelement/) { get; } | L'élément qui est animé. |
