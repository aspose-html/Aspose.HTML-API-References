...
description: Aspose.Html.Dom.Svg.SVGPatternElement classe. Linterface SVGPatternElement correspond à lélément pattern.
type: docs
weight: 2200
url: /fr/net/aspose.html.dom.svg/svgpatternelement/
---
...
| [Height](../../aspose.html.dom.svg/svgpatternelement/height/) { get; } | Correspond à l'attribut 'height' sur l'élément 'pattern' donné. |
| [Href](../../aspose.html.dom.svg/svgpatternelement/href/) { get; } | Correspond à l'attribut 'xlink:href' sur l'élément donné. |
...
| [PatternContentUnits](../../aspose.html.dom.svg/svgpatternelement/patterncontentunits/) { get; } | Correspond à l'attribut 'patternContentUnits' sur l'élément 'pattern' donné. Prend l'une des constantes définies dans SVGUnitTypes. |
| [PatternTransform](../../aspose.html.dom.svg/svgpatternelement/patterntransform/) { get; } | Correspond à l'attribut 'patternTransform' sur l'élément 'pattern' donné. |
| [PatternUnits](../../aspose.html.dom.svg/svgpatternelement/patternunits/) { get; } | Correspond à l'attribut 'patternUnits' sur l'élément 'pattern' donné. Prend l'une des constantes définies dans SVGUnitTypes. |
...
| [PreserveAspectRatio](../../aspose.html.dom.svg/svgpatternelement/preserveaspectratio/) { get; } | Correspond à l'attribut 'preserveAspectRatio' sur l'élément donné. |
...
| [RequiredExtensions](../../aspose.html.dom.svg/svgpatternelement/requiredextensions/) { get; } | Correspond à l'attribut 'requiredExtensions' sur l'élément donné. |
| [RequiredFeatures](../../aspose.html.dom.svg/svgpatternelement/requiredfeatures/) { get; } | Correspond à l'attribut 'requiredFeatures' sur l'élément donné. |
...
| [SystemLanguage](../../aspose.html.dom.svg/svgpatternelement/systemlanguage/) { get; } | Correspond à l'attribut 'systemLanguage' sur l'élément donné. |
...
| [ViewBox](../../aspose.html.dom.svg/svgpatternelement/viewbox/) { get; } | Correspond à l'attribut 'viewBox' sur l'élément donné. |
...
| [Width](../../aspose.html.dom.svg/svgpatternelement/width/) { get; } | Correspond à l'attribut 'width' sur l'élément 'pattern' donné. |
| [X](../../aspose.html.dom.svg/svgpatternelement/x/) { get; } | Correspond à l'attribut 'x' sur l'élément 'pattern' donné. |
| [Y](../../aspose.html.dom.svg/svgpatternelement/y/) { get; } | Correspond à l'attribut 'y' sur l'élément 'pattern' donné. |
