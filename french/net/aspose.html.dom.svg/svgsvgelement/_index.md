...
| [ClassName](../../aspose.html.dom.svg/svgelement/classname/) { get; } | Correspond à l'attribut 'class' sur l'élément donné. |
| [ClassName](../../aspose.html.dom/element/classname/) { get; set; } | L'attribut de classe de l'élément. Cet attribut a été renommé due en raison de conflits avec le mot clé "class" exposé par de nombreuses langues. Voir la définition d'attribut de classe dans HTML 4.01. |
| [CurrentScale](../../aspose.html.dom.svg/svgsvgelement/currentscale/) { get; set; } | Sur un élément svg le plus à l'extérieur, cet attribut indique le facteur d'échelle actuel par rapport à la vue initiale pour prendre en compte les opérations d'agrandissement et de panoramique de l'utilisateur, comme décrit dans Agrandissement et panoramique. Les attributs DOM currentScale et currentTranslate sont équivalents à la matrice 2x3 [abcdef] = [currentScale 0 0 currentScale currentTranslate.x currentTranslate.y]. Si le "grossissement" est activé (c'est-à-dire zoomAndPan="magnify"), l'effet est comme si une transformation supplémentaire était placée au niveau le plus externe sur le fragment de document SVG (c'est-à-dire à l'extérieur de l'élément svg le plus externe). un élément 'svg' qui n'est pas un élément svg le plus externe, le comportement de cet attribut n'est pas défini. |
| [CurrentTranslate](../../aspose.html.dom.svg/svgsvgelement/currenttranslate/) { get; } | Sur un élément svg le plus à l'extérieur, le facteur de traduction correspondant qui prend en compte le "grossissement" de l'utilisateur. Lorsqu'il est accédé sur un élément 'svg' qui n'est pas un élément svg le plus à l'extérieur, le comportement de cet attribut n'est pas défini. |
| [FarthestViewportElement](../../aspose.html.dom.svg/svggraphicselement/farthestviewportelement/) { get; } | L'élément 'svg' ancêtre le plus éloigné. Null si l'élément actuel est l'élément svg le plus externe. |
...
| [Height](../../aspose.html.dom.svg/svgsvgelement/height/) { get; } | Correspond à l'attribut 'height' sur l'élément 'svg' donné. |
| [Id](../../aspose.html.dom.svg/svgelement/id/) { get; set; } | La valeur de l'attribut 'id' sur l'élément donné, ou la chaîne vide si 'id' n'est pas présent. |
...
| [NearestViewportElement](../../aspose.html.dom.svg/svggraphicselement/nearestviewportelement/) { get; } | L'élément qui a établi la fenêtre courante. Souvent, l'élément 'svg' ancêtre le plus proche. Null si l'élément actuel est l'élément svg le plus externe. |
...
| [OwnerSVGElement](../../aspose.html.dom.svg/svgelement/ownersvgelement/) { get; } | L'élément 'svg' ancêtre le plus proche. Null si l'élément donné est l'élément svg le plus externe. |
...
| [PreserveAspectRatio](../../aspose.html.dom.svg/svgsvgelement/preserveaspectratio/) { get; } | Correspond à l'attribut 'preserveAspectRatio' sur l'élément donné. |
...
| [RequiredExtensions](../../aspose.html.dom.svg/svggraphicselement/requiredextensions/) { get; } | Correspond à l'attribut 'requiredExtensions' sur l'élément donné. |
| [RequiredFeatures](../../aspose.html.dom.svg/svggraphicselement/requiredfeatures/) { get; } | Correspond à l'attribut 'requiredFeatures' sur l'élément donné. |
...
| [Style](../../aspose.html.dom.svg/svgelement/style/) { get; } | Correspond à l'attribut 'style' sur l'élément donné. Si l'agent utilisateur ne prend pas en charge le style avec CSS, cet attribut doit toujours avoir la valeur null. |
| [SystemLanguage](../../aspose.html.dom.svg/svggraphicselement/systemlanguage/) { get; } | Correspond à l'attribut 'systemLanguage' sur l'élément donné. |
...
| [Transform](../../aspose.html.dom.svg/svggraphicselement/transform/) { get; } | Correspond à l'attribut 'transform' sur l'élément donné. |
| [ViewBox](../../aspose.html.dom.svg/svgsvgelement/viewbox/) { get; } | Correspond à l'attribut 'viewBox' sur l'élément donné. |
| [ViewportElement](../../aspose.html.dom.svg/svgelement/viewportelement/) { get; } | L'élément qui a établi la fenêtre courante. Souvent, l'élément 'svg' ancêtre le plus proche. Null si l'élément donné est l'élément svg le plus externe. |
| [Width](../../aspose.html.dom.svg/svgsvgelement/width/) { get; } | Correspond à l'attribut 'width' sur l'élément 'svg' donné. |
| [X](../../aspose.html.dom.svg/svgsvgelement/x/) { get; } | Correspond à l'attribut 'x' sur l'élément 'svg' donné. |
| [Y](../../aspose.html.dom.svg/svgsvgelement/y/) { get; } | Correspond à l'attribut 'y' sur l'élément 'svg' donné. |
| [ZoomAndPan](../../aspose.html.dom.svg/svgsvgelement/zoomandpan/) { get; set; } | Correspond à l'attribut 'zoomAndPan' sur l'élément donné. La valeur doit être l'une des constantes SVG_ZOOMANDPAN_* définies sur cette interface. |
...
| [AnimationsPaused](../../aspose.html.dom.svg/svgsvgelement/animationspaused/)() | Renvoie true si ce fragment de document SVG est en pause. |
...
| [CreateEvent](../../aspose.html.dom.svg/svgsvgelement/createevent/)(string) | Crée un[`Event`](../../aspose.html.dom.events/event/) d'un type pris en charge par l'implémentation. |
| [CreateSVGAngle](../../aspose.html.dom.svg/svgsvgelement/createsvgangle/)() | Crée un objet SVGAngle en dehors de toute arborescence de documents. L'objet est initialisé à la valeur 0 degrés (sans unité). |
| [CreateSVGLength](../../aspose.html.dom.svg/svgsvgelement/createsvglength/)() | Crée un objet SVGLength en dehors de toute arborescence de documents. L'objet est initialisé à la valeur de 0 unités utilisateur. |
| [CreateSVGMatrix](../../aspose.html.dom.svg/svgsvgelement/createsvgmatrix/)() | Crée un objet SVGMatrix en dehors de toute arborescence de documents. L'objet est initialisé à la matrice d'identité. |
| [CreateSVGNumber](../../aspose.html.dom.svg/svgsvgelement/createsvgnumber/)() | Crée un objet SVGNumber en dehors de toute arborescence de documents. L'objet est initialisé à une valeur de zéro. |
| [CreateSVGPoint](../../aspose.html.dom.svg/svgsvgelement/createsvgpoint/)() | Crée un objet SVGPoint en dehors de toute arborescence de documents. L'objet est initialisé au point (0,0) dans le système de coordonnées utilisateur. |
| [CreateSVGRect](../../aspose.html.dom.svg/svgsvgelement/createsvgrect/)() | Crée un objet SVGRect en dehors de toute arborescence de documents. L'objet est initialisé de sorte que toutes les valeurs soient définies sur 0 unités utilisateur. |
| [CreateSVGTransform](../../aspose.html.dom.svg/svgsvgelement/createsvgtransform/)() | Crée un objet SVGTransform en dehors de toute arborescence de documents. L'objet est initialisé à une transformation de matrice d'identité (SVG_TRANSFORM_MATRIX). |
| [CreateSVGTransformFromMatrix](../../aspose.html.dom.svg/svgsvgelement/createsvgtransformfrommatrix/)(SVGMatrix) | Crée un objet SVGTransform en dehors de toute arborescence de documents. L'objet est initialisé à la transformation matricielle donnée (c'est-à-dire, SVG_TRANSFORM_MATRIX). Les valeurs du paramètre matrix sont copiées, le paramètre matrix n'est pas adopté comme SVGTransform::matrix. |
...
| [GetElementById](../../aspose.html.dom.svg/svgsvgelement/getelementbyid/)(string) | Recherche dans ce fragment de document SVG (c'est-à-dire que la recherche est limitée à un sous-ensemble de l'arborescence du document) un élément dont l'identifiant est donné par elementId. Si un élément est trouvé, cet élément est renvoyé. Si aucun élément de ce type n'existe, renvoie null. Le comportement n'est pas défini si plus d'un élément a cet identifiant. |
...
| [PauseAnimations](../../aspose.html.dom.svg/svgsvgelement/pauseanimations/)() | Suspend (c'est-à-dire met en pause) toutes les animations en cours d'exécution qui sont définies dans le fragment de document SVG correspondant à cet élément 'svg', provoquant l'arrêt de l'horloge d'animation correspondant à ce fragment de document jusqu'à ce qu'il soit rétabli. |
...
| [SetCurrentTime](../../aspose.html.dom.svg/svgsvgelement/setcurrenttime/)(float) | Ajuste l'horloge pour ce fragment de document SVG, établissant une nouvelle heure actuelle. Si setCurrentTime est appelée avant le début de la chronologie du document (par exemple, par un script exécuté dans un élément 'script' avant que l'événement SVGLoad du document ne soit envoyé), alors la valeur de secondes dans la dernière invocation de la méthode donne l'heure à laquelle le document cherchera à une fois que la chronologie du document a commencé. |
...
| [UnpauseAnimations](../../aspose.html.dom.svg/svgsvgelement/unpauseanimations/)() | Annule la suspension (c'est-à-dire, rétablit la pause) des animations en cours d'exécution qui sont définies dans le fragment de document SVG, entraînant la poursuite de l'horloge de l'animation à partir du moment où elle a été suspendue. |
