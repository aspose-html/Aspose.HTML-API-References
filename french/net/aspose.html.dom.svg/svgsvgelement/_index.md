...
| [GetBBox](../../aspose.html.dom.svg/svggraphicselement/getbbox)() | Renvoie la boîte englobante étroite dans l'espace utilisateur actuel (c'est-à-dire après application de l'attribut 'transform', le cas échéant) sur la géométrie de tous les éléments graphiques contenus, à l'exclusion des effets de contour, de découpage, de masquage et de filtre). Notez que getBBox doit renvoyer la boîte englobante réelle au moment où la méthode a été appelée, même si l'élément n'a pas encore été rendu. |
| [GetCTM](../../aspose.html.dom.svg/svggraphicselement/getctm)() | Renvoie la matrice de transformation à partir des unités utilisateur actuelles (c'est-à-dire après application de l'attribut 'transform', le cas échéant) au système de coordonnées de la fenêtre pour le ViewportElement le plus proche. |
