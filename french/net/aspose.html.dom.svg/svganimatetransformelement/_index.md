...
description: Linterface SVGAnimateTransformElement correspond à lélément animateTransform. Laccès orienté objet aux attributs de lélément animateTransform via le DOM SVG nest pas disponible.
type: docs
weight: 1940
