...
description: Aspose.Html.Toolkit.Markdown.Syntax.CharacterReferenceSyntaxNode classe. Représente le CharacterReferenceSyntaxNode.
type: docs
weight: 4830
url: /fr/net/aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/
---
## CharacterReferenceSyntaxNode class

Représente le CharacterReferenceSyntaxNode.
...
| [Reference](../../aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/reference/) { get; } | Obtenir la référence. |
| [Source](../../aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/source/) { get; } | Obtenez la source. |
| [Span](../../aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/span/) { get; } | Obtenez l'étendue. |
| [Value](../../aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/value/) { get; } | Obtenir la valeur. |

## Méthodes

| Nom | La description |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/characterreferencesyntaxnode/accept/)(MarkdownSyntaxVisitor) | Définit l'interface pour accepter le visiteur. |
