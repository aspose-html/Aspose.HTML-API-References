...
description: Aspose.Html.Toolkit.Markdown.Syntax.HardBreakSyntaxNode classe. Représente le HardBreakSyntaxNode.
type: docs
weight: 5010
url: /fr/net/aspose.html.toolkit.markdown.syntax/hardbreaksyntaxnode/
---
## HardBreakSyntaxNode class

Représente le HardBreakSyntaxNode.
...
| virtual [Source](../../aspose.html.toolkit.markdown.syntax/linebreaksyntaxnode/source/) { get; } | Obtenez la source. |
| virtual [Span](../../aspose.html.toolkit.markdown.syntax/linebreaksyntaxnode/span/) { get; } | Obtenez l'étendue. |
| [Value](../../aspose.html.toolkit.markdown.syntax/linebreaksyntaxnode/value/) { get; } | Obtenir la valeur. |

## Méthodes

| Nom | La description |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/hardbreaksyntaxnode/accept/)(MarkdownSyntaxVisitor) | Définit l'interface pour accepter le visiteur. |
...
| [GetBreakingTag](../../aspose.html.toolkit.markdown.syntax/hardbreaksyntaxnode/getbreakingtag/)() | Définit l'interface pour obtenir Breaking Tag |
