...
description: Aspose.Html.Toolkit.Markdown.Syntax.TableDelimiterSyntaxNode classe. Représente le nœud de syntaxe du délimiteur de table.
type: docs
weight: 5570
url: /fr/net/aspose.html.toolkit.markdown.syntax/tabledelimitersyntaxnode/
---
## TableDelimiterSyntaxNode class

Représente le nœud de syntaxe du délimiteur de table.
