...
description: Aspose.Html.Toolkit.Markdown.Syntax.LinkDestinationSyntaxNode classe. Représente le LinkDestinationSyntaxNode.
type: docs
weight: 5110
url: /fr/net/aspose.html.toolkit.markdown.syntax/linkdestinationsyntaxnode/
---
...
| Nom | La description |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/linkdestinationsyntaxnode/accept/)(MarkdownSyntaxVisitor) | Définit l'interface pour accepter le visiteur. |
...
| [GetEnumerator](../../aspose.html.toolkit.markdown.syntax/inlinecontainersyntaxnode/getenumerator/)() | Renvoie un énumérateur qui parcourt la collection. |
...
| [GetValue](../../aspose.html.toolkit.markdown.syntax/linkdestinationsyntaxnode/getvalue/)() | Définit l'interface pour obtenir la valeur de chaîne. |
