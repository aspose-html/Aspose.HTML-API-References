...
description: Aspose.Html.Toolkit.Markdown.Syntax.InlineProxy classe. Représente InlineProxy.
type: docs
weight: 5070
url: /fr/net/aspose.html.toolkit.markdown.syntax/inlineproxy/
---
## InlineProxy class

Représente InlineProxy.
...
| Nom | La description |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/inlineproxy/accept/)(MarkdownSyntaxVisitor) | Définit l'interface pour accepter le visiteur. |
...
| [GetTarget](../../aspose.html.toolkit.markdown.syntax/inlineproxy/gettarget/)() | Définit l'interface pour obtenir la cible. |
...
| override [WriteTo](../../aspose.html.toolkit.markdown.syntax/inlineproxy/writeto/#writeto)(MarkdownTextWriter) | Écrire au rédacteur de texte. |
