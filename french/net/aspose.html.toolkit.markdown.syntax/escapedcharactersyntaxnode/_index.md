...
description: Aspose.Html.Toolkit.Markdown.Syntax.EscapedCharacterSyntaxNode classe. Implémentation du nœud de syntaxe de caractère déchappement.
type: docs
weight: 4890
url: /fr/net/aspose.html.toolkit.markdown.syntax/escapedcharactersyntaxnode/
---
## EscapedCharacterSyntaxNode class

Implémentation du nœud de syntaxe de caractère d'échappement.
...
| virtual [Source](../../aspose.html.toolkit.markdown.syntax/textsyntaxnode/source/) { get; } | Renvoie le texte source. |
| virtual [Span](../../aspose.html.toolkit.markdown.syntax/textsyntaxnode/span/) { get; } | Définit l'interface pour obtenir l'étendue. |
| [Value](../../aspose.html.toolkit.markdown.syntax/textsyntaxnode/value/) { get; } | Définit la propriété pour obtenir la valeur de chaîne. |

## Méthodes

| Nom | La description |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/escapedcharactersyntaxnode/accept/)(MarkdownSyntaxVisitor) | Définit l'interface pour accepter le visiteur. |
