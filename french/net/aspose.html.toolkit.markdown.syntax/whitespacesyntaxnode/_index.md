...
description: Aspose.Html.Toolkit.Markdown.Syntax.WhitespaceSyntaxNode classe. Représente le nœud de syntaxe des espaces blancs.
type: docs
weight: 5740
url: /fr/net/aspose.html.toolkit.markdown.syntax/whitespacesyntaxnode/
---
## WhitespaceSyntaxNode class

Représente le nœud de syntaxe des espaces blancs.
...
| Nom | La description |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/whitespacesyntaxnode/accept/)(MarkdownSyntaxVisitor) | Définit l'interface pour visiter les nœuds de la syntaxe. |
