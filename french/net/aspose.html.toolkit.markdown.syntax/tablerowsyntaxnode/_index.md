...
description: Aspose.Html.Toolkit.Markdown.Syntax.TableRowSyntaxNode classe. Le nœud de syntaxe de ligne de table.
type: docs
weight: 5580
url: /fr/net/aspose.html.toolkit.markdown.syntax/tablerowsyntaxnode/
---
## TableRowSyntaxNode class

Le nœud de syntaxe de ligne de table.
...
| [AppendCell](../../aspose.html.toolkit.markdown.syntax/tablerowsyntaxnode/appendcell/)(TableCellSyntaxNode) | Définit l'interface pour l'ajout de la cellule. |
| [AppendChild](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/appendchild/)(MarkdownSyntaxNode) | Ajouter un nœud enfant. |
| [AppendDelimiter](../../aspose.html.toolkit.markdown.syntax/tablerowsyntaxnode/appenddelimiter/)(TableDelimiterSyntaxNode) | Définit l'interface pour le délimiteur d'ajout. |
| [ChildNodes](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/childnodes/)() | Obtenez la collection de nœuds enfants. |
| [GetCells](../../aspose.html.toolkit.markdown.syntax/tablerowsyntaxnode/getcells/)() | Définit l'interface pour obtenir les cellules. |
