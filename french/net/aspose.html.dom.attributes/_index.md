...
description: Le Aspose.Html.Dom.Attributes lespace de noms contient des classes dattributs unifiées qui spécifient ou qualifient tout objet nœud élément ... caractéristique ou comportement.
type: docs
weight: 50
url: /fr/net/aspose.html.dom.attributes/
---
Le **Aspose.Html.Dom.Attributes** l'espace de noms contient des classes d'attributs unifiées qui spécifient ou qualifient tout objet (nœud, élément, ...) caractéristique ou comportement.
