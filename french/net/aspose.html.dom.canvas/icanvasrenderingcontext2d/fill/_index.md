...
description: Remplit les souschemins avec le style de remplissage actuel et lalgorithme par défaut CanvasFillRule.Nonzero.
type: docs
weight: 220
url: /fr/net/aspose.html.dom.canvas/icanvasrenderingcontext2d/fill/
---
## Fill() {#fill}
...
| Paramètre | Taper | La description |
| --- | --- | --- |
| path | Path2D | Un chemin Path2D à remplir. |
