...
description: Les filtres sont des objets qui savent comment filtrer les nœuds. Si un NodeIterator ou TreeWalker reçoit un NodeFilter il applique le filtre avant de renvoyer le nœud suivant. Si le filtre dit daccepter le nœud la logique de traversée le renvoie  sinon la traversée recherche le nœud suivant et prétend que le nœud qui a été rejeté nétait pas là.
type: docs
weight: 2500
