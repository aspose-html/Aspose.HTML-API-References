...
description: Teste si un nœud spécifié est visible dans la vue logique dun TreeWalker ou NodeIterator. Cette fonction sera appelée par limplémentation de TreeWalker et NodeIterator  il nest normalement pas appelé directement depuis le code utilisateur . Bien que vous puissiez le faire si vous vouliez utiliser le même filtre pour guider votre propre logique dapplication.
type: docs
weight: 10
