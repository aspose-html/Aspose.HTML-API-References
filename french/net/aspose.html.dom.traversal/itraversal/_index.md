...
| Nom | La description |
| --- | --- |
| [Filter](../../aspose.html.dom.traversal/itraversal/filter/) { get; } | Le NodeFilter utilisé pour filtrer les nœuds. |
| [Root](../../aspose.html.dom.traversal/itraversal/root/) { get; } | Le nœud racine du NodeIterator, tel que spécifié lors de sa création . |
