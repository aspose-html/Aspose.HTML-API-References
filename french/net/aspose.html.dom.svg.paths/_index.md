...
description: Le Aspose.Html.Dom.Svg.Paths namespace décrit les classes pour la représentation du contour dune forme qui peut être remplie ou tracée. Un chemin peut également être utilisé comme chemin de détourage pour décrire une animation ou positionner du texte.
type: docs
weight: 150
url: /fr/net/aspose.html.dom.svg.paths/
---
Le **Aspose.Html.Dom.Svg.Paths** namespace décrit les classes pour la représentation du contour d'une forme qui peut être remplie ou tracée. Un chemin peut également être utilisé comme chemin de détourage, pour décrire une animation, ou positionner du texte.
