...
description: Linterface KeyboardEvent fournit des informations contextuelles spécifiques associées aux périphériques clavier. Chaque événement de clavier fait référence à une touche à laide dune valeur. Les événements de clavier sont généralement dirigés vers lélément qui a le focus.
type: docs
weight: 840
...
| Nom | La description |
| --- | --- |
| [KeyboardEvent](keyboardevent#constructor)(string) | Initialise une nouvelle instance du[`KeyboardEvent`](../keyboardevent) classe. |
| [KeyboardEvent](keyboardevent#constructor_1)(string, IDictionary&lt;string, object&gt;) | Initialise une nouvelle instance du[`KeyboardEvent`](../keyboardevent) classe. |
