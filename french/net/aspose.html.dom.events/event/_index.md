...
description: Aspose.Html.Dom.Events.Event classe. LeEvent est utilisé pour fournir des informations contextuelles sur un événement au gestionnaire traitant lévénement.
type: docs
weight: 770
...
| [InitEvent](../../aspose.html.dom.events/event/initevent/)(string, bool, bool) | Le[`InitEvent`](./initevent/) méthode est utilisée pour initialiser la valeur d'un`Event` créé via the [`IDocumentEvent`](../idocumentevent/) interface. |
