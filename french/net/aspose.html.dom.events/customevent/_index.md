...
description: Les événements utilisant linterface CustomEvent peuvent être utilisés pour transporter des données personnalisées.
type: docs
weight: 740
...
| Nom | La description |
| --- | --- |
| [CustomEvent](customevent#constructor)(string) | Initialise une nouvelle instance du[`CustomEvent`](../customevent) classe. |
| [CustomEvent](customevent#constructor_1)(string, IDictionary&lt;string, object&gt;) | Initialise une nouvelle instance du[`CustomEvent`](../customevent) classe. |
