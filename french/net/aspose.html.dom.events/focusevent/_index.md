...
description: Linterface FocusEvent fournit des informations contextuelles spécifiques associées aux événements Focus.
type: docs
weight: 790
...
| Nom | La description |
| --- | --- |
| [FocusEvent](focusevent#constructor)(string) | Initialise une nouvelle instance du[`FocusEvent`](../focusevent) classe. |
| [FocusEvent](focusevent#constructor_1)(string, IDictionary&lt;string, object&gt;) | Initialise une nouvelle instance du[`FocusEvent`](../focusevent) classe. |
