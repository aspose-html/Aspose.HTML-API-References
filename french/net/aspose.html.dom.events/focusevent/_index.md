...
description: Aspose.Html.Dom.Events.FocusEvent classe. Linterface FocusEvent fournit des informations contextuelles spécifiques associées aux événements Focus.
type: docs
weight: 780
url: /fr/net/aspose.html.dom.events/focusevent/
---
## FocusEvent class

L'interface FocusEvent fournit des informations contextuelles spécifiques associées aux événements Focus.
...
| Nom | La description |
| --- | --- |
| [FocusEvent](focusevent/#constructor)(string) | Initialise une nouvelle instance du`FocusEvent` classe. |
| [FocusEvent](focusevent/#constructor_1)(string, IDictionary&lt;string, object&gt;) | Initialise une nouvelle instance du`FocusEvent` classe. |
...
| [RelatedTarget](../../aspose.html.dom.events/focusevent/relatedtarget/) { get; } | Utilisé pour identifier un EventTarget secondaire lié à un événement Focus, selon le type d'événement. |
