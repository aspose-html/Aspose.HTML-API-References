...
description: LeEventTarget../aspose.html.dom/eventtarget est implémentée par tous les nœuds dans une implémentation qui prend en charge le modèle dévénement DOM. Par conséquent cette interface peut être obtenue en utilisant des méthodes de conversion spécifiques à la liaison sur une instance de linterface de nœud. Linterface permet lenregistrement et la suppression des écouteurs dévénement sur unEventTarget../aspose.html.dom/eventtarget et lenvoi dévénements à ceIEventTarget./ieventtarget .
type: docs
weight: 820
