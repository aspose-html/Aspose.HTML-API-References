...
description: Aspose.Html.Dom.Svg.Filters.SVGFEDiffuseLightingElement classe. Linterface SVGFEDiffuseLightingElement correspond à lélément feDiffuseLighting.
type: docs
weight: 1410
url: /fr/net/aspose.html.dom.svg.filters/svgfediffuselightingelement/
---
...
| [DiffuseConstant](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/diffuseconstant/) { get; } | Correspond à l'attribut 'diffuseConstant' sur l'élément 'feDiffuseLighting' donné. |
...
| [Height](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/height/) { get; } | Correspond à l'attribut 'height' sur l'élément 'filter' donné. |
...
| [In1](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/in1/) { get; } | Correspond à l'attribut 'in' sur l'élément 'feDiffuseLighting' donné. |
...
| [KernelUnitLengthX](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/kernelunitlengthx/) { get; } | Correspond à l'attribut 'kernelUnitLength' sur l'élément 'feDiffuseLighting' donné. |
| [KernelUnitLengthY](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/kernelunitlengthy/) { get; } | Correspond à l'attribut 'kernelUnitLength' sur l'élément 'feDiffuseLighting' donné. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/result/) { get; } | Correspond à l'attribut 'result' sur l'élément 'filter' donné. |
...
| [SurfaceScale](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/surfacescale/) { get; } | Correspond à l'attribut 'surfaceScale' sur l'élément 'feDiffuseLighting' donné. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/width/) { get; } | Correspond à l'attribut 'width' sur l'élément 'filter' donné. |
| [X](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/x/) { get; } | Correspond à l'attribut 'x' sur l'élément 'filter' donné. |
| [Y](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/y/) { get; } | Correspond à l'attribut 'y' sur l'élément 'filter' donné. |
