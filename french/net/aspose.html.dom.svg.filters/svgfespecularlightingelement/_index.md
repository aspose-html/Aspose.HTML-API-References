...
description: Aspose.Html.Dom.Svg.Filters.SVGFESpecularLightingElement classe. Linterface SVGFESpecularLightingElement correspond à lélément feSpecularLighting.
type: docs
weight: 1570
url: /fr/net/aspose.html.dom.svg.filters/svgfespecularlightingelement/
---
...
| [Height](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/height/) { get; } | Correspond à l'attribut 'height' sur l'élément 'filter' donné. |
...
| [In1](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/in1/) { get; } | Correspond à l'attribut 'in' sur l'élément 'feSpecularLighting' donné. |
...
| [KernelUnitLengthX](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/kernelunitlengthx/) { get; } | Correspond à l'attribut 'kernelUnitLength' sur l'élément 'feSpecularLighting' donné. |
| [KernelUnitLengthY](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/kernelunitlengthy/) { get; } | Correspond à l'attribut 'kernelUnitLength' sur l'élément 'feSpecularLighting' donné. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/result/) { get; } | Correspond à l'attribut 'result' sur l'élément 'filter' donné. |
...
| [SpecularConstant](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/specularconstant/) { get; } | Correspond à l'attribut 'specularConstant' sur l'élément 'feSpecularLighting' donné. |
| [SpecularExponent](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/specularexponent/) { get; } | Correspond à l'attribut 'specularExponent' sur l'élément 'feSpecularLighting' donné. |
...
| [SurfaceScale](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/surfacescale/) { get; } | Correspond à l'attribut 'surfaceScale' sur l'élément 'feSpecularLighting' donné. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/width/) { get; } | Correspond à l'attribut 'width' sur l'élément 'filter' donné. |
| [X](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/x/) { get; } | Correspond à l'attribut 'x' sur l'élément 'filter' donné. |
| [Y](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/y/) { get; } | Correspond à l'attribut 'y' sur l'élément 'filter' donné. |
