...
description: Aspose.Html.Dom.Svg.Filters.SVGFEConvolveMatrixElement classe. Linterface SVGFEConvolveMatrixElement correspond à lélément feConvolveMatrix.
type: docs
weight: 1400
url: /fr/net/aspose.html.dom.svg.filters/svgfeconvolvematrixelement/
---
...
| [Bias](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/bias/) { get; } | Correspond à l'attribut 'bias' sur l'élément 'feConvolveMatrix' donné. |
...
| [Divisor](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/divisor/) { get; } | Correspond à l'attribut 'divisor' sur l'élément 'feConvolveMatrix' donné. |
| [EdgeMode](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/edgemode/) { get; } | Correspond à l'attribut 'edgeMode' sur l'élément 'feConvolveMatrix' donné. |
...
| [Height](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/height/) { get; } | Correspond à l'attribut 'height' sur l'élément 'filter' donné. |
...
| [In1](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/in1/) { get; } | Correspond à l'attribut 'in' sur l'élément 'feConvolveMatrix' donné. |
...
| [KernelMatrix](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelmatrix/) { get; } | Correspond à l'attribut 'kernelMatrix' sur l'élément 'feConvolveMatrix' donné. |
| [KernelUnitLengthX](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelunitlengthx/) { get; } | Correspond à l'attribut 'kernelUnitLength' sur l'élément 'feConvolveMatrix' donné. |
| [KernelUnitLengthY](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelunitlengthy/) { get; } | Correspond à l'attribut 'kernelUnitLength' sur l'élément 'feConvolveMatrix' donné. |
...
| [OrderX](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/orderx/) { get; } | Correspond à l'attribut 'order' sur l'élément 'feConvolveMatrix' donné. |
| [OrderY](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/ordery/) { get; } | Correspond à l'attribut 'order' sur l'élément 'feConvolveMatrix' donné. |
...
| [PreserveAlpha](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/preservealpha/) { get; } | Correspond à l'attribut 'preserveAlpha' sur l'élément 'feConvolveMatrix' donné. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/result/) { get; } | Correspond à l'attribut 'result' sur l'élément 'filter' donné. |
...
| [TargetX](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/targetx/) { get; } | Correspond à l'attribut 'targetX' sur l'élément 'feConvolveMatrix' donné. |
| [TargetY](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/targety/) { get; } | Correspond à l'attribut 'targetY' sur l'élément 'feConvolveMatrix' donné. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/width/) { get; } | Correspond à l'attribut 'width' sur l'élément 'filter' donné. |
| [X](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/x/) { get; } | Correspond à l'attribut 'x' sur l'élément 'filter' donné. |
| [Y](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/y/) { get; } | Correspond à l'attribut 'y' sur l'élément 'filter' donné. |
...
| Nom | La description |
| --- | --- |
| const [SVG_EDGEMODE_DUPLICATE](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_duplicate/) | Correspond à la valeur 'dupliquer'. |
| const [SVG_EDGEMODE_NONE](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_none/) | Correspond à la valeur 'aucun'. |
| const [SVG_EDGEMODE_UNKNOWN](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_unknown/) | Le type ne fait pas partie des types prédéfinis. Il n'est pas valide de tenter de définir une nouvelle valeur de ce type ou de tenter de basculer une valeur existante vers ce type. |
| const [SVG_EDGEMODE_WRAP](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_wrap/) | Correspond à la valeur 'wrap'. |
