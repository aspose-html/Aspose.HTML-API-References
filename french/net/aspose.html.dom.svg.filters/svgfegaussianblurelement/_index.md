...
description: Aspose.Html.Dom.Svg.Filters.SVGFEGaussianBlurElement classe. Linterface SVGFEGaussianBlurElement correspond à lélément feGaussianBlur.
type: docs
weight: 1500
url: /fr/net/aspose.html.dom.svg.filters/svgfegaussianblurelement/
---
...
| [Height](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/height/) { get; } | Correspond à l'attribut "height" sur l'élément "filter" donné. |
...
| [In1](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/in1/) { get; } | Correspond à l'attribut "in" sur l'élément "feGaussianBlur" donné. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/result/) { get; } | Correspond à l'attribut "résultat" sur l'élément "filtre" donné. |
...
| [StdDeviationX](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/stddeviationx/) { get; } | Correspond à l'attribut "stdDeviation" sur l'élément "feGaussianBlur" donné. Contient la composante X de l'attribut �stdDeviation�. |
| [StdDeviationY](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/stddeviationy/) { get; } | Correspond à l'attribut "stdDeviation" sur l'élément "feGaussianBlur" donné. Contient la composante Y (éventuellement calculée automatiquement) de l'attribut "stdDeviation". |
...
| [Width](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/width/) { get; } | Correspond à l'attribut "width" sur l'élément "filter" donné. |
| [X](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/x/) { get; } | Correspond à l'attribut "x" sur l'élément "filter" donné. |
| [Y](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/y/) { get; } | Correspond à l'attribut "y" sur l'élément "filter" donné. |
...
| [SetStdDeviation](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/setstddeviation/)(float, float) | Définit les valeurs de l'attribut "stdDeviation". |
