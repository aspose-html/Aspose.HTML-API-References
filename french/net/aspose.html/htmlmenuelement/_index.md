...
description: Aspose.Html.HTMLMenuElement classe. Liste des menus. Voir la définition de lélément MENU dans HTML 4.01. Cet élément est obsolète dans HTML 4.01.
type: docs
weight: 3390
url: /fr/net/aspose.html/htmlmenuelement/
---
## HTMLMenuElement class

Liste des menus. Voir la définition de l'élément MENU dans HTML 4.01. Cet élément est obsolète dans HTML 4.01.
...
| [Compact](../../aspose.html/htmlmenuelement/compact/) { get; set; } | Réduisez l'espacement entre les éléments de la liste. Voir la définition d'attribut compact dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
