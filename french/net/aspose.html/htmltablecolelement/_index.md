...
description: Aspose.Html.HTMLTableColElement classe. Regroupe lesCOL etGROUPE DE COLLOQUE éléments. Voir la définition de lélément COL dans HTML 4.01.
type: docs
weight: 3560
url: /fr/net/aspose.html/htmltablecolelement/
---
## HTMLTableColElement class

Regroupe les`COL` et`GROUPE DE COLLOQUE` éléments. Voir la définition de l'élément COL dans HTML 4.01.
...
| Nom | La description |
| --- | --- |
| [Align](../../aspose.html/htmltablecolelement/align/) { get; set; } | Alignement horizontal des données de cellule dans la colonne. Voir la définition de l'attribut align dans HTML 4.01. |
...
| [Ch](../../aspose.html/htmltablecolelement/ch/) { get; set; } | Caractère d'alignement pour les cellules d'une colonne. Voir la définition de l'attribut char dans HTML 4.01. |
...
| [ChOff](../../aspose.html/htmltablecolelement/choff/) { get; set; } | Décalage du caractère d'alignement. Voir la définition de l'attribut charoff dans HTML 4.01. |
...
| [Span](../../aspose.html/htmltablecolelement/span/) { get; set; } | Indique le nombre de colonnes dans un groupe ou affectées par un regroupement. Voir la définition de l'attribut span dans HTML 4.01. |
...
| [VAlign](../../aspose.html/htmltablecolelement/valign/) { get; set; } | Alignement vertical des données de cellule dans la colonne. Voir la définition de l'attribut valign dans HTML 4.01. |
| [Width](../../aspose.html/htmltablecolelement/width/) { get; set; } | Largeur de colonne par défaut. Voir la définition de l'attribut width dans HTML 4.01. |
