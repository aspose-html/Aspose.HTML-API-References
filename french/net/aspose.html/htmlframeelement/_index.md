...
description: Aspose.Html.HTMLFrameElement classe. Créez un cadre. Voir la définition de lélément FRAME dans HTML 4.01.
type: docs
weight: 3240
url: /fr/net/aspose.html/htmlframeelement/
---
## HTMLFrameElement class

Créez un cadre. Voir la définition de l'élément FRAME dans HTML 4.01.
...
| [ContentDocument](../../aspose.html/htmlframeelement/contentdocument/) { get; } | Le document que contient ce cadre, s'il y en a un et qu'il est disponible, ou`nul` sinon. @depuis le niveau DOM 2 |
...
| [FrameBorder](../../aspose.html/htmlframeelement/frameborder/) { get; set; } | Demander les bordures du cadre. Voir la définition de l'attribut frameborder dans HTML 4.01. |
...
| [LongDesc](../../aspose.html/htmlframeelement/longdesc/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] désignant une longue description de cette image ou de ce cadre. Voir la définition de l'attribut longdesc dans HTML 4.01. |
| [MarginHeight](../../aspose.html/htmlframeelement/marginheight/) { get; set; } | Hauteur de la marge du cadre, en pixels. Voir la définition de l'attribut marginheight dans HTML 4.01. |
| [MarginWidth](../../aspose.html/htmlframeelement/marginwidth/) { get; set; } | Largeur de la marge du cadre, en pixels. Voir la définition de l'attribut marginwidth dans HTML 4.01. |
| [Name](../../aspose.html/htmlframeelement/name/) { get; set; } | Le nom de la trame (objet du`cible` attribut). Voir la définition de l'attribut de nom dans HTML 4.01. |
...
| [NoResize](../../aspose.html/htmlframeelement/noresize/) { get; set; } | Lorsque vrai, interdit à l'utilisateur de redimensionner le cadre. Voir la définition de l'attribut noresize dans HTML 4.01. |
...
| [Scrolling](../../aspose.html/htmlframeelement/scrolling/) { get; set; } | Spécifiez si le cadre doit avoir ou non des barres de défilement. Voir la définition de l'attribut de défilement dans HTML 4.01. |
| [ShadowRoot](../../aspose.html.dom/element/shadowroot/) { get; } | Renvoie shadowRoot stocké sur cet élément ou null s'il est fermé. |
| [Src](../../aspose.html/htmlframeelement/src/) { get; set; } | Une URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] désignant le contenu initial de la trame. Voir la définition de l'attribut src dans HTML 4.01. |
