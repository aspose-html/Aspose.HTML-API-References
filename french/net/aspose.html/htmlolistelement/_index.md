...
description: Aspose.Html.HTMLOListElement classe. Liste ordonnée. Voir la définition de lélément OL dans HTML 4.01.
type: docs
weight: 3430
url: /fr/net/aspose.html/htmlolistelement/
---
## HTMLOListElement class

Liste ordonnée. Voir la définition de l'élément OL dans HTML 4.01.
...
| [Compact](../../aspose.html/htmlolistelement/compact/) { get; set; } | Réduisez l'espacement entre les éléments de la liste. Voir la définition d'attribut compact dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
...
| [Start](../../aspose.html/htmlolistelement/start/) { get; set; } | Numéro de séquence de départ. Voir la définition de l'attribut start dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
...
| [Type](../../aspose.html/htmlolistelement/type/) { get; set; } | Style de numérotation. Voir la définition de l'attribut type dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
