...
description: Aspose.Html.HTMLParamElement classe. Paramètres transmis auOBJET élément. Voir la définition de lélément PARAM dans HTML 4.01.
type: docs
weight: 3480
url: /fr/net/aspose.html/htmlparamelement/
---
## HTMLParamElement class

Paramètres transmis au`OBJET` élément. Voir la définition de l'élément PARAM dans HTML 4.01.
...
| [Name](../../aspose.html/htmlparamelement/name/) { get; set; } | Le nom d'un paramètre d'exécution. Voir la définition de l'attribut name dans HTML 4.01. |
...
| [Type](../../aspose.html/htmlparamelement/type/) { get; set; } | Type de contenu pour le`valeur` attribut quand `type de valeur` a la valeur "ref". Voir la définition de l'attribut de type dans HTML 4.01. |
| [Value](../../aspose.html/htmlparamelement/value/) { get; set; } | La valeur d'un paramètre d'exécution. Voir la définition d'attribut de valeur dans HTML 4.01. |
| [ValueType](../../aspose.html/htmlparamelement/valuetype/) { get; set; } | Informations sur la signification du`valeur` valeur de l'attribut . Voir la définition de l'attribut valuetype dans HTML 4.01. |
