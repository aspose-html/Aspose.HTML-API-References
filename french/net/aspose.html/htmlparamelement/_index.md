...
description: Paramètres transmis auOBJET élément. Voir la définition de lélément PARAM dans HTML 4.01.
type: docs
weight: 3470
...
| [Type](../../aspose.html/htmlparamelement/type) { get; set; } | Type de contenu pour le`évaluer` attribut quand `type de valeur` a la valeur "ref". Voir la définition de l'attribut de type dans HTML 4.01. |
...
| [ValueType](../../aspose.html/htmlparamelement/valuetype) { get; set; } | Informations sur la signification du`évaluer` valeur de l'attribut . Voir la définition de l'attribut valuetype dans HTML 4.01. |
