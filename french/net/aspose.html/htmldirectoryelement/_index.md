...
description: Aspose.Html.HTMLDirectoryElement classe. Liste des répertoires. Voir la définition de lélément DIR dans HTML 4.01. Cet élément est obsolète dans HTML 4.01.
type: docs
weight: 3170
url: /fr/net/aspose.html/htmldirectoryelement/
---
## HTMLDirectoryElement class

Liste des répertoires. Voir la définition de l'élément DIR dans HTML 4.01. Cet élément est obsolète dans HTML 4.01.
...
| [Compact](../../aspose.html/htmldirectoryelement/compact/) { get; set; } | Réduisez l'espacement entre les éléments de la liste. Voir la définition d'attribut compact dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
