...
description: Aspose.Html.HTMLHtmlElement classe. Racine dun document HTML. Voir la définition de lélément HTML dans HTML 4.01.
type: docs
weight: 3290
url: /fr/net/aspose.html/htmlhtmlelement/
---
## HTMLHtmlElement class

Racine d'un document HTML. Voir la définition de l'élément HTML dans HTML 4.01.
...
| [Version](../../aspose.html/htmlhtmlelement/version/) { get; set; } | Informations de version sur la DTD du document. Voir la définition de l'attribut de version dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
