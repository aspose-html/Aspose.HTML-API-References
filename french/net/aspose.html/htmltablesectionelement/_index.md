...
description: Aspose.Html.HTMLTableSectionElement classe. LeLA TÊTE PIED  etCORPS éléments.
type: docs
weight: 3590
url: /fr/net/aspose.html/htmltablesectionelement/
---
## HTMLTableSectionElement class

Le`LA TÊTE` ,`PIED` , et`CORPS` éléments.
...
| Nom | La description |
| --- | --- |
| [Align](../../aspose.html/htmltablesectionelement/align/) { get; set; } | Alignement horizontal des données dans les cellules. Voir le`aligner` attribut pour HTMLTheadElement pour plus de détails. |
...
| [Ch](../../aspose.html/htmltablesectionelement/ch/) { get; set; } | Caractère d'alignement pour les cellules d'une colonne. Voir la définition de l'attribut char dans HTML 4.01. |
...
| [ChOff](../../aspose.html/htmltablesectionelement/choff/) { get; set; } | Décalage du caractère d'alignement. Voir la définition de l'attribut charoff dans HTML 4.01. |
...
| [Rows](../../aspose.html/htmltablesectionelement/rows/) { get; } | La collection de lignes dans cette section de table. |
...
| [VAlign](../../aspose.html/htmltablesectionelement/valign/) { get; set; } | Alignement vertical des données dans les cellules. Voir le`valigner` attribut pour HTMLTheadElement pour plus de détails. |
...
| [DeleteRow](../../aspose.html/htmltablesectionelement/deleterow/)(int) | Supprimer une ligne de cette section. |
...
| [InsertRow](../../aspose.html/htmltablesectionelement/insertrow/)(int) | Insérez une ligne dans cette section. La nouvelle ligne est insérée immédiatement avant le courant`indice` ème rangée dans cette section. Si `indice` est -1 ou égal au nombre de lignes dans cette section , la nouvelle ligne est ajoutée. |
