...
description: Aspose.Html.HTMLBaseElement classe. URI de base du document IETF RFC 2396 . Voir la définition de lélément BASE dans HTML 4.01.
type: docs
weight: 3100
url: /fr/net/aspose.html/htmlbaseelement/
---
## HTMLBaseElement class

URI de base du document [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ]. Voir la définition de l'élément BASE dans HTML 4.01.
...
| [Href](../../aspose.html/htmlbaseelement/href/) { get; set; } | L'URI de base [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ]. Voir la définition de l'attribut href dans HTML 4.01. |
...
| [Target](../../aspose.html/htmlbaseelement/target/) { get; set; } | Le cadre cible par défaut. Voir la définition de l'attribut cible dans HTML 4.01. |
