...
description: Un ensemble dindicateurs de sandboxing est un ensemble de zéro ou plusieurs des indicateurs suivants qui sont utilisés pour restreindre les capacités des ressources potentiellement non fiables.
type: docs
weight: 4540
