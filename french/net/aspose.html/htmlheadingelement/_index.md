...
description: Aspose.Html.HTMLHeadingElement classe. Pour leH1 pourH6 éléments. Voir la définition H1 element dans HTML 4.01.
type: docs
weight: 3280
url: /fr/net/aspose.html/htmlheadingelement/
---
## HTMLHeadingElement class

Pour le`H1` pour`H6` éléments. Voir la définition H1 element dans HTML 4.01.
...
| Nom | La description |
| --- | --- |
| [Align](../../aspose.html/htmlheadingelement/align/) { get; set; } | Alignement horizontal du texte. Voir la définition de l'attribut align dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
