...
description: Aspose.Html.HTMLOptionElement classe. Un choix sélectionnable. Voir la définition de lélément OPTION dans HTML 4.01.
type: docs
weight: 3460
url: /fr/net/aspose.html/htmloptionelement/
---
## HTMLOptionElement class

Un choix sélectionnable. Voir la définition de l'élément OPTION dans HTML 4.01.
...
| [DefaultSelected](../../aspose.html/htmloptionelement/defaultselected/) { get; set; } | Représente la valeur de l'attribut HTML sélectionné. La valeur de cet attribut ne change pas si l'état du contrôle de formulaire correspondant, dans un agent utilisateur interactif, change. Voir la définition d'attribut sélectionnée dans HTML 4.01. @version DOM Niveau 2 |
...
| [Disabled](../../aspose.html/htmloptionelement/disabled/) { get; set; } | Le contrôle n'est pas disponible dans ce contexte. Voir la définition d'attribut désactivé dans HTML 4.01. |
...
| [Form](../../aspose.html/htmloptionelement/form/) { get; } | Renvoie le`FORMER` élément contenant ce champ. Renvoie `nul` si ce champ n'est pas dans le contexte d'un formulaire . |
| [Id](../../aspose.html/htmlelement/id/) { get; set; } | L'identifiant de l'élément. Voir la définition de l'attribut id dans HTML 4.01. |
| [Index](../../aspose.html/htmloptionelement/index/) { get; } | L'indice de ce`OPTION` dans son père`SÉLECTIONNER` , à partir de 0. @version DOM Niveau 2 |
...
| [Label](../../aspose.html/htmloptionelement/label/) { get; set; } | Étiquette d'option à utiliser dans les menus hiérarchiques. Voir la définition de l'attribut label dans HTML 4.01. |
...
| [Selected](../../aspose.html/htmloptionelement/selected/) { get; set; } | Représente l'état actuel du contrôle de formulaire correspondant, dans un agent utilisateur interactif . La modification de cet attribut modifie l'état de le contrôle de formulaire, mais ne modifie pas la valeur de l'attribut HTML sélectionné de l'élément. |
...
| [Text](../../aspose.html/htmloptionelement/text/) { get; } | Le texte contenu dans l'élément d'option. |
...
| [Value](../../aspose.html/htmloptionelement/value/) { get; set; } | La valeur de contrôle de formulaire actuelle. Voir la définition de l'attribut value dans HTML 4.01. |
