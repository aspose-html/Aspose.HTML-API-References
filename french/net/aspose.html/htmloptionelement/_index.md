...
description: Un choix sélectionnable. Voir la définition de lélément OPTION dans HTML 4.01.
type: docs
weight: 3450
...
| [Form](../../aspose.html/htmloptionelement/form) { get; } | Renvoie le`FORMULAIRE` élément contenant ce champ. Renvoie `nul` si ce champ n'est pas dans le contexte d'un formulaire . |
