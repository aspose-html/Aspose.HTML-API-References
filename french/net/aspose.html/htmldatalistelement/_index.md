...
description: Aspose.Html.HTMLDataListElement classe. Lélément datalist représente un ensemble déléments doption qui représentent des options prédéfinies pour dautres contrôles. Voir aussi leRecommandation HTML 5.2 W3C .
type: docs
weight: 3160
url: /fr/net/aspose.html/htmldatalistelement/
---
## HTMLDataListElement class

L'élément datalist représente un ensemble d'éléments d'option qui représentent des options prédéfinies pour d'autres contrôles. Voir aussi le[Recommandation HTML 5.2 W3C](https://www.w3.org/TR/html52/sec-forms.html#elementdef-datalist) .
...
| [Options](../../aspose.html/htmldatalistelement/options/) { get; } | La collection de`OPTION`éléments contenus par cet élément . |
