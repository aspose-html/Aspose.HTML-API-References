...
description: Aspose.Html.HTMLDivElement classe. Conteneur de blocs générique. Voir la définition de lélément DIV dans HTML 4.01.
type: docs
weight: 3180
url: /fr/net/aspose.html/htmldivelement/
---
## HTMLDivElement class

Conteneur de blocs générique. Voir la définition de l'élément DIV dans HTML 4.01.
...
| Nom | La description |
| --- | --- |
| [Align](../../aspose.html/htmldivelement/align/) { get; set; } | Alignement horizontal du texte. Voir la définition de l'attribut align dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
