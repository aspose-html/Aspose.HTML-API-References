...
description: Aspose.Html.HTMLAnchorElement classe. Lélément dancrage. Voir la définition de lélément A dans HTML 4.01.
type: docs
weight: 3060
url: /fr/net/aspose.html/htmlanchorelement/
---
## HTMLAnchorElement class

L'élément d'ancrage. Voir la définition de l'élément A dans HTML 4.01.
...
| Nom | La description |
| --- | --- |
| [AccessKey](../../aspose.html/htmlanchorelement/accesskey/) { get; set; } | Une clé d'accès à un seul caractère pour donner accès au contrôle du formulaire. Voir la définition de l'attribut accesskey dans HTML 4.01. |
...
| [Charset](../../aspose.html/htmlanchorelement/charset/) { get; set; } | Le codage de caractères de la ressource liée. Voir la définition de l'attribut charset dans HTML 4.01. |
...
| [Coords](../../aspose.html/htmlanchorelement/coords/) { get; set; } | Liste de longueurs séparées par des virgules, définissant une géométrie de région active. Voir aussi`forme` pour la forme de la région. Voir la définition de l'attribut coords dans HTML 4.01. |
...
| [Hash](../../aspose.html/htmlanchorelement/hash/) { get; set; } | Obtient ou définit une représentation sous forme de chaîne du segment de hachage de l'URL associée. |
| [Host](../../aspose.html/htmlanchorelement/host/) { get; set; } | Obtient ou définit une représentation sous forme de chaîne des segments d'hôte et de port de l'URL associée. |
| [Hostname](../../aspose.html/htmlanchorelement/hostname/) { get; set; } | Obtient ou définit une représentation sous forme de chaîne du segment hôte de l'URL associée. |
| [Href](../../aspose.html/htmlanchorelement/href/) { get; set; } | L'URI absolu [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) de la ressource liée. Voir la définition de l'attribut href dans HTML 4.01. |
| [Hreflang](../../aspose.html/htmlanchorelement/hreflang/) { get; set; } | Code de langue de la ressource liée. Voir la définition de l'attribut hreflang dans HTML 4.01. |
...
| override [LocalName](../../aspose.html.dom/element/localname/) { get; } | Renvoie la partie locale du nom qualifié de ce nœud. Pour les nœuds de tout type autre que ELEMENT_NODE et ATTRIBUTE_NODE et les nœuds créés avec une méthode DOM Niveau 1, comme Document.createElement(), c'est toujours null. |
| [Name](../../aspose.html/htmlanchorelement/name/) { get; set; } | Nom de l'ancre. Voir la définition de l'attribut name dans HTML 4.01. |
...
| [Origin](../../aspose.html/htmlanchorelement/origin/) { get; } | Obtient une représentation sous forme de chaîne du segment d'origine de l'URL associée. |
...
| [Password](../../aspose.html/htmlanchorelement/password/) { get; set; } | Obtient ou définit une représentation sous forme de chaîne du segment de mot de passe de l'URL associée. |
| [Pathname](../../aspose.html/htmlanchorelement/pathname/) { get; set; } | Obtient ou définit une représentation sous forme de chaîne du segment de chemin de l'URL associée. |
| [Port](../../aspose.html/htmlanchorelement/port/) { get; set; } | Obtient ou définit une représentation sous forme de chaîne du segment de port de l'URL associée. |
...
| [Protocol](../../aspose.html/htmlanchorelement/protocol/) { get; set; } | Obtient ou définit une représentation sous forme de chaîne du segment de schéma de l'URL associée. |
| [Rel](../../aspose.html/htmlanchorelement/rel/) { get; set; } | Type de lien vers l'avant. Voir la définition de l'attribut rel dans HTML 4.01. |
| [RelList](../../aspose.html/htmlanchorelement/rellist/) { get; } | Renvoie une DOMTokenList en direct qui contient les jetons reçus de l'analyse de l'attribut "rel". |
| [Rev](../../aspose.html/htmlanchorelement/rev/) { get; set; } | Type de lien inverse. Voir la définition de l'attribut rev dans HTML 4.01. |
| [SchemaTypeInfo](../../aspose.html.dom/element/schematypeinfo/) { get; } | Les informations de type associées à cet élément. |
| [Search](../../aspose.html/htmlanchorelement/search/) { get; set; } | Obtient ou définit une représentation sous forme de chaîne du segment de recherche de l'URL associée. |
| [ShadowRoot](../../aspose.html.dom/element/shadowroot/) { get; } | Renvoie shadowRoot stocké sur cet élément ou null s'il est fermé. |
| [Shape](../../aspose.html/htmlanchorelement/shape/) { get; set; } | La forme de la zone active. Les coordonnées sont données par `coordonnées` . Voir la définition de l'attribut shape dans HTML 4.01. |
...
| [TabIndex](../../aspose.html/htmlanchorelement/tabindex/) { get; set; } | Index qui représente la position de l'élément dans l'ordre de tabulation. Voir la définition de l'attribut tabindex dans HTML 4.01. |
| [TagName](../../aspose.html.dom/element/tagname/) { get; } | Le nom de l'élément. |
| [Target](../../aspose.html/htmlanchorelement/target/) { get; set; } | Cadre dans lequel afficher la ressource. Voir la définition de l'attribut cible dans HTML 4.01. |
...
| [Type](../../aspose.html/htmlanchorelement/type/) { get; set; } | Type de contenu consultatif. Voir la définition de l'attribut type dans HTML 4.01. |
| [Username](../../aspose.html/htmlanchorelement/username/) { get; set; } | Obtient ou définit une représentation sous forme de chaîne du segment de nom d'utilisateur de l'URL associée. |
...
| [Blur](../../aspose.html/htmlanchorelement/blur/)() | Supprime le focus clavier de cet élément. |
...
| [Focus](../../aspose.html/htmlanchorelement/focus/)() | Donne le focus clavier à cet élément. |
...
| Nom | La description |
| --- | --- |
| event [OnAbort](../../aspose.html/htmlelement/onabort/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnAbort. |
| event [OnBlur](../../aspose.html/htmlelement/onblur/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnBlur. |
| event [OnCancel](../../aspose.html/htmlelement/oncancel/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnCancel. |
| event [OnCanplay](../../aspose.html/htmlelement/oncanplay/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnCanplay. |
| event [OnCanPlayThrough](../../aspose.html/htmlelement/oncanplaythrough/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnCanPlayThrough. |
| event [OnChange](../../aspose.html/htmlelement/onchange/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnChange. |
| event [OnClick](../../aspose.html/htmlelement/onclick/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnClick. |
| event [OnCueChange](../../aspose.html/htmlelement/oncuechange/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnCueChange. |
| event [OnDblClick](../../aspose.html/htmlelement/ondblclick/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnDblClick. |
| event [OnDurationChange](../../aspose.html/htmlelement/ondurationchange/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnDurationChange. |
| event [OnEmptied](../../aspose.html/htmlelement/onemptied/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnEmptied. |
| event [OnEnded](../../aspose.html/htmlelement/onended/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnEnded. |
| event [OnError](../../aspose.html/htmlelement/onerror/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnError. |
| event [OnFocus](../../aspose.html/htmlelement/onfocus/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnFocus. |
| event [OnInput](../../aspose.html/htmlelement/oninput/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnInput. |
| event [OnInvalid](../../aspose.html/htmlelement/oninvalid/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnInvalid. |
| event [OnKeyDown](../../aspose.html/htmlelement/onkeydown/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnKeyDown. |
| event [OnKeyPress](../../aspose.html/htmlelement/onkeypress/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnKeyPress. |
| event [OnKeyUp](../../aspose.html/htmlelement/onkeyup/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnKeyUp. |
| event [OnLoad](../../aspose.html/htmlelement/onload/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnLoad. |
| event [OnLoadedData](../../aspose.html/htmlelement/onloadeddata/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnLoadedData. |
| event [OnLoadedMetadata](../../aspose.html/htmlelement/onloadedmetadata/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnLoadedMetadata. |
| event [OnLoadStart](../../aspose.html/htmlelement/onloadstart/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnLoadStart. |
| event [OnMouseDown](../../aspose.html/htmlelement/onmousedown/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnMouseDown. |
| event [OnMouseEnter](../../aspose.html/htmlelement/onmouseenter/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnMouseEnter. |
| event [OnMouseLeave](../../aspose.html/htmlelement/onmouseleave/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnMouseLeave. |
| event [OnMouseMove](../../aspose.html/htmlelement/onmousemove/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnMouseMove. |
| event [OnMouseOut](../../aspose.html/htmlelement/onmouseout/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnMouseOut. |
| event [OnMouseOver](../../aspose.html/htmlelement/onmouseover/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnMouseOver. |
| event [OnMouseUp](../../aspose.html/htmlelement/onmouseup/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnMouseUp. |
| event [OnMouseWheel](../../aspose.html/htmlelement/onmousewheel/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnMouseWheel. |
| event [OnPause](../../aspose.html/htmlelement/onpause/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnPause. |
| event [OnPlay](../../aspose.html/htmlelement/onplay/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnPlay. |
| event [OnPlaying](../../aspose.html/htmlelement/onplaying/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnPlaying. |
| event [OnProgress](../../aspose.html/htmlelement/onprogress/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnProgress. |
| event [OnRateChange](../../aspose.html/htmlelement/onratechange/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnRateChange. |
| event [OnReset](../../aspose.html/htmlelement/onreset/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnReset. |
| event [OnResize](../../aspose.html/htmlelement/onresize/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnResize. |
| event [OnScroll](../../aspose.html/htmlelement/onscroll/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnScroll. |
| event [OnSeeked](../../aspose.html/htmlelement/onseeked/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnSeeked. |
| event [OnSeeking](../../aspose.html/htmlelement/onseeking/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnSeeking. |
| event [OnSelect](../../aspose.html/htmlelement/onselect/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnSelect. |
| event [OnShow](../../aspose.html/htmlelement/onshow/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnShow. |
| event [OnStalled](../../aspose.html/htmlelement/onstalled/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnStalled. |
| event [OnSubmit](../../aspose.html/htmlelement/onsubmit/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnSubmit. |
| event [OnSuspend](../../aspose.html/htmlelement/onsuspend/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnSuspend. |
| event [OnTimeUpdate](../../aspose.html/htmlelement/ontimeupdate/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnTimeUpdate. |
| event [OnToggle](../../aspose.html/htmlelement/ontoggle/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnToggle. |
| event [OnVolumeChange](../../aspose.html/htmlelement/onvolumechange/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnVolumeChange. |
| event [OnWaiting](../../aspose.html/htmlelement/onwaiting/) | Obtient ou définit le gestionnaire d'événements pour l'événement OnWaiting. |
