...
description: Aspose.Html.HTMLAreaElement classe. Définition de la zone de carte dimage côté client. Voir la définition de lélément AREA dans HTML 4.01.
type: docs
weight: 3080
url: /fr/net/aspose.html/htmlareaelement/
---
## HTMLAreaElement class

Définition de la zone de carte d'image côté client. Voir la définition de l'élément AREA dans HTML 4.01.
...
| Nom | La description |
| --- | --- |
| [AccessKey](../../aspose.html/htmlareaelement/accesskey/) { get; set; } | Une clé d'accès à un seul caractère pour donner accès au contrôle du formulaire. Voir la définition de l'attribut accesskey dans HTML 4.01. |
| [Alt](../../aspose.html/htmlareaelement/alt/) { get; set; } | Texte alternatif pour les agents utilisateurs ne restituant pas le contenu normal de cet élément . Voir la définition de l'attribut alt dans HTML 4.01. |
...
| [Coords](../../aspose.html/htmlareaelement/coords/) { get; set; } | Liste de longueurs séparées par des virgules, définissant une géométrie de région active. Voir aussi`forme` pour la forme de la région. Voir la définition de l'attribut coords dans HTML 4.01. |
...
| [Href](../../aspose.html/htmlareaelement/href/) { get; set; } | L'URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] de la ressource liée. Voir la définition de l'attribut href dans HTML 4.01. |
...
| [NoHref](../../aspose.html/htmlareaelement/nohref/) { get; set; } | Spécifie que cette zone est inactive, c'est-à-dire qu'elle n'a aucune action associée. Voir la définition de l'attribut nohref dans HTML 4.01. |
...
| [RelList](../../aspose.html/htmlareaelement/rellist/) { get; } | Renvoie une DOMTokenList en direct qui contient les jetons reçus de l'analyse de l'attribut "rel". |
...
| [Shape](../../aspose.html/htmlareaelement/shape/) { get; set; } | La forme de la zone active. Les coordonnées sont données par `coordonnées` . Voir la définition de l'attribut shape dans HTML 4.01. |
...
| [TabIndex](../../aspose.html/htmlareaelement/tabindex/) { get; set; } | Index qui représente la position de l'élément dans l'ordre de tabulation. Voir la définition de l'attribut tabindex dans HTML 4.01. |
| [TagName](../../aspose.html.dom/element/tagname/) { get; } | Le nom de l'élément. |
| [Target](../../aspose.html/htmlareaelement/target/) { get; set; } | Cadre dans lequel afficher la ressource. Voir la définition de l'attribut cible dans HTML 4.01. |
