...
description: Uint32Array constructeur. Initialise une nouvelle instance duUint32Array classe.
type: docs
weight: 10
url: /fr/net/aspose.html/uint32array/uint32array/
---
## Uint32Array(int) {#constructor_3}

Initialise une nouvelle instance du[`Uint32Array`](../) classe.
...
| Paramètre | Taper | La description |
| --- | --- | --- |
| data | UInt32[] | Les données du tableau. |
