...
description: Aspose.Html.HTMLLinkElement classe. LeLIENLélément spécifie un lien vers une ressource externe et définit la relation de ce document avec cette ressource ou vice versa. Voir la définition de lélément LINK dans HTML 4.01 voir aussi le Style de lien interface dans le module StyleSheet Feuilles de style DOM niveau 2 et CSS .
type: docs
weight: 3370
url: /fr/net/aspose.html/htmllinkelement/
---
## HTMLLinkElement class

Le`LIEN`L'élément spécifie un lien vers une ressource externe et définit la relation de ce document avec cette ressource (ou vice versa). Voir la définition de l'élément LINK dans HTML 4.01 (voir aussi le `Style de lien` interface dans le module StyleSheet [[Feuilles de style DOM niveau 2 et CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113) ]).
...
| [Charset](../../aspose.html/htmllinkelement/charset/) { get; set; } | Le codage de caractères de la ressource à laquelle est lié. Voir la définition de l'attribut charset dans HTML 4.01. |
...
| [Disabled](../../aspose.html/htmllinkelement/disabled/) { get; set; } | Active/désactive le lien. Ceci n'est actuellement utilisé que pour les liens de feuille de style et peut être utilisé pour activer ou désactiver les feuilles de style. |
...
| [Href](../../aspose.html/htmllinkelement/href/) { get; set; } | L'URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] de la ressource liée. Voir la définition de l'attribut href dans HTML 4.01. |
| [Hreflang](../../aspose.html/htmllinkelement/hreflang/) { get; set; } | Code de langue de la ressource liée. Voir la définition de l'attribut hreflang dans HTML 4.01. |
...
| [Media](../../aspose.html/htmllinkelement/media/) { get; set; } | Conçu pour être utilisé avec un ou plusieurs supports cibles. Voir la définition de l'attribut média dans HTML 4.01. |
...
| [Rel](../../aspose.html/htmllinkelement/rel/) { get; set; } | Type de lien vers l'avant. Voir la définition de l'attribut rel dans HTML 4.01. |
| [RelList](../../aspose.html/htmllinkelement/rellist/) { get; } | Renvoie une DOMTokenList en direct qui contient les jetons reçus de l'analyse de l'attribut "rel". |
| [Rev](../../aspose.html/htmllinkelement/rev/) { get; set; } | Type de lien inverse. Voir la définition de l'attribut rev dans HTML 4.01. |
...
| [Sheet](../../aspose.html/htmllinkelement/sheet/) { get; } | Obtient la feuille de style associée. |
...
| [Target](../../aspose.html/htmllinkelement/target/) { get; set; } | Cadre dans lequel afficher la ressource. Voir la définition de l'attribut cible dans HTML 4.01. |
...
| [Type](../../aspose.html/htmllinkelement/type/) { get; set; } | Type de contenu consultatif. Voir la définition de l'attribut type dans HTML 4.01. |
