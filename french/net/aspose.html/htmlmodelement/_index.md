...
description: Aspose.Html.HTMLModElement classe. Avis de modification dune partie dun document. Voir les définitions des éléments INS et DEL dans HTML 4.01.
type: docs
weight: 3410
url: /fr/net/aspose.html/htmlmodelement/
---
## HTMLModElement class

Avis de modification d'une partie d'un document. Voir les définitions des éléments INS et DEL dans HTML 4.01.
...
| [Cite](../../aspose.html/htmlmodelement/cite/) { get; set; } | Une URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] désignant un document qui décrit la raison du changement. Voir la définition de l'attribut de citation dans HTML 4.01. |
...
| [DateTime](../../aspose.html/htmlmodelement/datetime/) { get; set; } | La date et l'heure du changement. Voir la définition de l'attribut datetime dans HTML 4.01. |
