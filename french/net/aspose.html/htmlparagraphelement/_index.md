...
description: Aspose.Html.HTMLParagraphElement classe. Paragraphes. Voir la définition de lélément P dans HTML 4.01.
type: docs
weight: 3470
url: /fr/net/aspose.html/htmlparagraphelement/
---
## HTMLParagraphElement class

Paragraphes. Voir la définition de l'élément P dans HTML 4.01.
...
| Nom | La description |
| --- | --- |
| [Align](../../aspose.html/htmlparagraphelement/align/) { get; set; } | Alignement horizontal du texte. Voir la définition de l'attribut align dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
