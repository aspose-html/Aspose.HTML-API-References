...
description: Aspose.Html.HTMLObjectElement classe. Objet intégré générique. En principe toutes les propriétés de lélément dobjet sont en lectureécriture mais dans certains environnements certaines propriétés peuvent être en lecture seule une fois lobjet sousjacent instancié. Voir la définition de lélément OBJECT dans HTML 4.01 .
type: docs
weight: 3440
url: /fr/net/aspose.html/htmlobjectelement/
---
## HTMLObjectElement class

Objet intégré générique. En principe, toutes les propriétés de l'élément d'objet sont en lecture-écriture, mais dans certains environnements, certaines propriétés peuvent être en lecture seule une fois l'objet sous-jacent instancié. Voir la définition de l'élément OBJECT dans [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224) ].
...
| Nom | La description |
| --- | --- |
| [Align](../../aspose.html/htmlobjectelement/align/) { get; set; } | Aligne cet objet (verticalement ou horizontalement) par rapport au texte qui l'entoure. Voir la définition de l'attribut align dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
| [Archive](../../aspose.html/htmlobjectelement/archive/) { get; set; } | Liste d'archives séparées par des espaces. Voir la définition de l'attribut d'archive dans HTML 4.01. |
...
| [Border](../../aspose.html/htmlobjectelement/border/) { get; set; } | Largeur de la bordure autour de l'objet. Voir la définition de l'attribut border dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
...
| [ClassId](../../aspose.html/htmlobjectelement/classid/) { get; set; } | Définit une valeur d'ID de classe telle qu'elle est définie dans le registre Windows ou une URL |
...
| [Code](../../aspose.html/htmlobjectelement/code/) { get; set; } | Fichier de classe Applet. Voir le`code` attribut pour HTMLAppletElement. |
| [CodeBase](../../aspose.html/htmlobjectelement/codebase/) { get; set; } | URI de base [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] pour`identifiant de classe` ,`données` , et `archive` les attributs. Voir l'attribut codebase definition dans HTML 4.01. |
| [CodeType](../../aspose.html/htmlobjectelement/codetype/) { get; set; } | Type de contenu pour les données téléchargées via`identifiant de classe` attribut. Voir la définition de l'attribut codetype dans HTML 4.01. |
| [Data](../../aspose.html/htmlobjectelement/data/) { get; set; } | Une URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] spécifiant l'emplacement des données de l'objet. Voir la définition de l'attribut data dans HTML 4.01. |
| [Declare](../../aspose.html/htmlobjectelement/declare/) { get; set; } | Déclarez (pour référence future), mais n'instanciez pas cet objet. Voir la définition de l'attribut declare dans HTML 4.01. |
...
| [Form](../../aspose.html/htmlobjectelement/form/) { get; set; } | Renvoie le`FORMER` élément contenant ce champ. Retour`nul` si ce champ n'est pas dans le contexte d'un formulaire. |
| [Height](../../aspose.html/htmlobjectelement/height/) { get; set; } | Remplacer la hauteur. Voir la définition de l'attribut de hauteur dans HTML 4.01. |
| [Hspace](../../aspose.html/htmlobjectelement/hspace/) { get; set; } | Espace horizontal, en pixels, à gauche et à droite de cette image, applet ou objet. Voir la définition de l'attribut hspace dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
...
| [Name](../../aspose.html/htmlobjectelement/name/) { get; set; } | Contrôle de formulaire ou nom d'objet lorsqu'il est soumis avec un formulaire. Voir la définition de l'attribut name dans HTML 4.01. |
...
| [Standby](../../aspose.html/htmlobjectelement/standby/) { get; set; } | Message à afficher lors du chargement de l'objet. Voir la définition de l'attribut standby dans HTML 4.01. |
...
| [TabIndex](../../aspose.html/htmlobjectelement/tabindex/) { get; set; } | Index qui représente la position de l'élément dans l'ordre de tabulation. Voir la définition de l'attribut tabindex dans HTML 4.01. |
...
| [Type](../../aspose.html/htmlobjectelement/type/) { get; set; } | Type de contenu pour les données téléchargées via`données` attribut. Voir la définition de l'attribut type dans HTML 4.01. |
| [UseMap](../../aspose.html/htmlobjectelement/usemap/) { get; set; } | Utiliser une image cliquable côté client. Voir la définition de l'attribut usemap dans HTML 4.01. |
| [Vspace](../../aspose.html/htmlobjectelement/vspace/) { get; set; } | Espace vertical, en pixels, au-dessus et au-dessous de cette image, applet ou objet. Voir la définition de l'attribut vspace dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
| [Width](../../aspose.html/htmlobjectelement/width/) { get; set; } | Remplacer la largeur. Voir la définition de l'attribut width dans HTML 4.01. |
