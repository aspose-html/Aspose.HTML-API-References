...
description: Les méthodes create et delete sur la table permettent aux auteurs de construire et de modifier des tables. HTML 4.01http//www.w3.org/TR/1999/REChtml40119991224  spécifie quun seul de chacun des LÉGENDE LA TÊTE  etPIED les éléments peuvent exister dans une table. Par conséquent sil en existe un et que la méthode createTHead ou createTFoot est appelée la méthode renvoie lélément THead ou TFoot existant. Voir la définition de lélément TABLE dans HTML 4.01.
type: docs
weight: 3560
