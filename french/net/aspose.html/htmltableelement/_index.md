...
description: Aspose.Html.HTMLTableElement classe. Les méthodes create et delete sur la table permettent aux auteurs de construire et de modifier des tables. HTML 4.01  spécifie quun seul de chacun des LÉGENDE LA TÊTE  etPIED les éléments peuvent exister dans une table. Par conséquent sil en existe un et que la méthode createTHead ou createTFoot est appelée la méthode renvoie lélément THead ou TFoot existant. Voir la définition de lélément TABLE dans HTML 4.01.
type: docs
weight: 3570
url: /fr/net/aspose.html/htmltableelement/
---
## HTMLTableElement class

Les méthodes create* et delete* sur la table permettent aux auteurs de construire et de modifier des tables. [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224) ] spécifie qu'un seul de chacun des `LÉGENDE` ,`LA TÊTE` , et`PIED` les éléments peuvent exister dans une table. Par conséquent, s'il en existe un et que la méthode createTHead() ou createTFoot() est appelée, la méthode renvoie l'élément THead ou TFoot existant. Voir la définition de l'élément TABLE dans HTML 4.01.
...
| Nom | La description |
| --- | --- |
| [Align](../../aspose.html/htmltableelement/align/) { get; set; } | Spécifie la position du tableau par rapport au reste du document . Voir la définition de l'attribut align dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
...
| [BgColor](../../aspose.html/htmltableelement/bgcolor/) { get; set; } | Couleur d'arrière-plan de la cellule. Voir la définition de l'attribut bgcolor dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
| [Border](../../aspose.html/htmltableelement/border/) { get; set; } | La largeur de la bordure autour du tableau. Voir la définition de l'attribut border dans HTML 4.01. |
| [Caption](../../aspose.html/htmltableelement/caption/) { get; } | Renvoie la valeur de la table`LÉGENDE` , ou vide s'il n'en existe pas. @version DOM niveau 2 |
| [CellPadding](../../aspose.html/htmltableelement/cellpadding/) { get; set; } | Spécifie l'espace horizontal et vertical entre le contenu de la cellule et les bordures de cellule . Voir la définition de l'attribut cellpadding dans HTML 4.01. |
| [CellSpacing](../../aspose.html/htmltableelement/cellspacing/) { get; set; } | Spécifie la séparation horizontale et verticale entre les cellules. Voir la définition de l'attribut cellpacing dans HTML 4.01. |
...
| [Frame](../../aspose.html/htmltableelement/frame/) { get; set; } | Spécifie les bordures de table externes à afficher. Voir la définition de l'attribut frame dans HTML 4.01. |
...
| [Rows](../../aspose.html/htmltableelement/rows/) { get; } | Renvoie la valeur de la table`PIED` , ou`nul` si aucun n'existe. |
| [Rules](../../aspose.html/htmltableelement/rules/) { get; set; } | Spécifie les bordures de tableau internes à afficher. Voir la définition de l'attribut rules dans HTML 4.01. |
...
| [Summary](../../aspose.html/htmltableelement/summary/) { get; set; } | Description de l'objectif ou de la structure d'un tableau. Voir la définition de l'attribut récapitulatif dans HTML 4.01. |
| [TagName](../../aspose.html.dom/element/tagname/) { get; } | Le nom de l'élément. |
| [TBodies](../../aspose.html/htmltableelement/tbodies/) { get; } | Renvoie une collection des corps de table (y compris ceux implicites). |
...
| [TFoot](../../aspose.html/htmltableelement/tfoot/) { get; } | Renvoie la valeur de la table`LA TÊTE` , ou`nul` si aucun n'existe. |
| [THead](../../aspose.html/htmltableelement/thead/) { get; } | Renvoie la valeur de la table`LÉGENDE` , ou vide s'il n'en existe pas. |
...
| [Width](../../aspose.html/htmltableelement/width/) { get; set; } | Spécifie la largeur de tableau souhaitée. Voir la définition de l'attribut width dans HTML 4.01. |
...
| [CreateCaption](../../aspose.html/htmltableelement/createcaption/)() | Créez un nouvel objet de légende de table ou renvoyez-en un existant. |
| [CreateTFoot](../../aspose.html/htmltableelement/createtfoot/)() | Créez une ligne de pied de tableau ou renvoyez-en une existante. |
| [CreateTHead](../../aspose.html/htmltableelement/createthead/)() | Créez une ligne d'en-tête de tableau ou renvoyez-en une existante. |
| [DeleteCaption](../../aspose.html/htmltableelement/deletecaption/)() | Supprimez la légende du tableau, le cas échéant. |
| [DeleteRow](../../aspose.html/htmltableelement/deleterow/)(int) | Supprimer une ligne de tableau. |
| [DeleteTFoot](../../aspose.html/htmltableelement/deletetfoot/)() | Supprimer le pied de page du tableau, s'il en existe un. |
| [DeleteTHead](../../aspose.html/htmltableelement/deletethead/)() | Supprimer l'en-tête du tableau, s'il en existe un. |
