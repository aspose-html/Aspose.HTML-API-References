...
description: Aspose.Html.HTMLElement classe. Toutes les interfaces déléments HTML dérivent de cette classe. Les éléments qui nexposent que les attributs de base HTML sont représentés par la base Élément HTMLinterface. Ces éléments sont les suivants  special  SUB SUP SPAN BDOfont  TT I B U S STRIKE BIG SMALL phrase  EM STRONG DFN CODE SAMP KBD VAR CITE ACRONYME ABBRlist  DD DTNOFRAMES NOSCRIPTADRESS CENTERThestyle lattribut dun élément HTML est accessible via le ElementCSSInlineStyle interface définie dans le module CSS Feuilles de style DOM niveau 2 et CSS .
type: docs
weight: 3200
url: /fr/net/aspose.html/htmlelement/
---
## HTMLElement class

Toutes les interfaces d'éléments HTML dérivent de cette classe. Les éléments qui n'exposent que les attributs de base HTML sont représentés par la base `Élément HTML`interface. Ces éléments sont les suivants : special : SUB, SUP, SPAN, BDOfont : TT, I, B, U, S, STRIKE, BIG, SMALL phrase : EM, STRONG, DFN, CODE, SAMP, KBD, VAR, CITE, ACRONYME, ABBRlist : DD, DTNOFRAMES, NOSCRIPTADRESS, CENTERThe`style` l'attribut d'un élément HTML est accessible via le `ElementCSSInlineStyle` interface définie dans le module CSS [[Feuilles de style DOM niveau 2 et CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113) ].
