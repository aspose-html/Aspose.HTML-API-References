...
description: Aspose.Html.HTMLScriptElement classe. Instructions de script. Voir la définition de lélément SCRIPT dans HTML 4.01.
type: docs
weight: 3510
url: /fr/net/aspose.html/htmlscriptelement/
---
## HTMLScriptElement class

Instructions de script. Voir la définition de l'élément SCRIPT dans HTML 4.01.
...
| [Charset](../../aspose.html/htmlscriptelement/charset/) { get; set; } | Le codage de caractères de la ressource liée. Voir la définition de l'attribut charset dans HTML 4.01. |
...
| [Defer](../../aspose.html/htmlscriptelement/defer/) { get; set; } | Indique que l'agent utilisateur peut différer le traitement du script. Voir la définition de l'attribut de report dans HTML 4.01. |
...
| [Event](../../aspose.html/htmlscriptelement/event/) { get; set; } | Réservé pour une utilisation future. |
...
| [Src](../../aspose.html/htmlscriptelement/src/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] désignant un script externe. Voir la définition de l'attribut src dans HTML 4.01. |
...
| [Text](../../aspose.html/htmlscriptelement/text/) { get; set; } | Le contenu du script de l'élément. |
...
| [Type](../../aspose.html/htmlscriptelement/type/) { get; set; } | Le type de contenu du langage de script. Voir la définition de l'attribut de type dans HTML 4.01. |
