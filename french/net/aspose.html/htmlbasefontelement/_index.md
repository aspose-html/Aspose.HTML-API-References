...
description: Aspose.Html.HTMLBaseFontElement classe. Police de base. Voir la définition de lélément BASEFONT dans HTML 4.01. Cet élément est obsolète dans HTML 4.01.
type: docs
weight: 3110
url: /fr/net/aspose.html/htmlbasefontelement/
---
## HTMLBaseFontElement class

Police de base. Voir la définition de l'élément BASEFONT dans HTML 4.01. Cet élément est obsolète dans HTML 4.01.
...
| [Color](../../aspose.html/htmlbasefontelement/color/) { get; set; } | Couleur de la police. Voir la définition de l'attribut de couleur dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
...
| [Face](../../aspose.html/htmlbasefontelement/face/) { get; set; } | Identificateur de police. Voir la définition de l'attribut face dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
...
| [Size](../../aspose.html/htmlbasefontelement/size/) { get; set; } | Taille de police calculée. Voir la définition de l'attribut size dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. @version DOM Niveau 2 |
