...
description: Aspose.Html.HTMLDListElement classe. Liste de définition. Voir la définition de lélément DL dans HTML 4.01.
type: docs
weight: 3150
url: /fr/net/aspose.html/htmldlistelement/
---
## HTMLDListElement class

Liste de définition. Voir la définition de l'élément DL dans HTML 4.01.
...
| [Compact](../../aspose.html/htmldlistelement/compact/) { get; set; } | Réduisez l'espacement entre les éléments de la liste. Voir la définition d'attribut compact dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
