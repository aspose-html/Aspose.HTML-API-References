...
description: Le corps du document HTML. Cet élément est toujours présent dans lAPI DOM même si les balises ne sont pas présentes dans le document source. Voir la définition de lélément BODY dans HTML 4.01.
type: docs
weight: 3110
