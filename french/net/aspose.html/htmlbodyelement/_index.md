...
description: Aspose.Html.HTMLBodyElement classe. Le corps du document HTML. Cet élément est toujours présent dans lAPI DOM même si les balises ne sont pas présentes dans le document source. Voir la définition de lélément BODY dans HTML 4.01.
type: docs
weight: 3120
url: /fr/net/aspose.html/htmlbodyelement/
---
## HTMLBodyElement class

Le corps du document HTML. Cet élément est toujours présent dans l'API DOM, même si les balises ne sont pas présentes dans le document source. Voir la définition de l'élément BODY dans HTML 4.01.
...
| Nom | La description |
| --- | --- |
| [ALink](../../aspose.html/htmlbodyelement/alink/) { get; set; } | Couleur des liens actifs (après le bouton de la souris enfoncé, mais avant le bouton de la souris vers le haut). Voir la définition de l'attribut alink dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
...
| [Background](../../aspose.html/htmlbodyelement/background/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] de l'image de mosaïque de texture d'arrière-plan. Voir la définition de l'attribut d'arrière-plan dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
...
| [BgColor](../../aspose.html/htmlbodyelement/bgcolor/) { get; set; } | Couleur d'arrière-plan du document. Voir la définition de l'attribut bgcolor dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
...
| [Link](../../aspose.html/htmlbodyelement/link/) { get; set; } | Couleur des liens qui ne sont pas actifs et non visités. Voir la définition de l'attribut link dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
...
| [Text](../../aspose.html/htmlbodyelement/text/) { get; set; } | Couleur du texte du document. Voir la définition de l'attribut de texte dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
...
| [VLink](../../aspose.html/htmlbodyelement/vlink/) { get; set; } | Couleur des liens visités par l'utilisateur. Voir la définition de l'attribut vlink dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
