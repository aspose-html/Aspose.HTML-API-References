...
description: Aspose.Html.HTMLSelectElement classe. Lélément select permet de sélectionner une option. Les options contenues sont directement accessibles via lélément select en tant que collection. Voir la définition de lélément SELECT dans HTML 4.01.
type: docs
weight: 3520
url: /fr/net/aspose.html/htmlselectelement/
---
## HTMLSelectElement class

L'élément select permet de sélectionner une option. Les options contenues sont directement accessibles via l'élément select en tant que collection. Voir la définition de l'élément SELECT dans HTML 4.01.
...
| [Disabled](../../aspose.html/htmlselectelement/disabled/) { get; set; } | Le contrôle n'est pas disponible dans ce contexte. Voir la définition de l'attribut désactivé dans HTML 4.01. |
...
| [Form](../../aspose.html/htmlselectelement/form/) { get; } | Le nombre d'options dans ce`SÉLECTIONNER` . |
...
| [Length](../../aspose.html/htmlselectelement/length/) { get; set; } | Le nombre d'options dans ce`SÉLECTIONNER` . @version DOM niveau 2 |
...
| [Multiple](../../aspose.html/htmlselectelement/multiple/) { get; set; } | Si vrai, multiple`OPTION` éléments peuvent être sélectionnés dans ce`SÉLECTIONNER` . Voir la définition d'attributs multiples dans HTML 4.01. |
| [Name](../../aspose.html/htmlselectelement/name/) { get; set; } | Contrôle de formulaire ou nom d'objet lorsqu'il est soumis avec un formulaire. Voir la définition de l'attribut name dans HTML 4.01. |
...
| [Options](../../aspose.html/htmlselectelement/options/) { get; } | La collection de`OPTION` éléments contenus par cet élément . @version DOM niveau 2 |
...
| [SelectedIndex](../../aspose.html/htmlselectelement/selectedindex/) { get; set; } | L'index ordinal de l'option sélectionnée, commençant à 0. La valeur -1 est renvoyée si aucun élément n'est sélectionné. Si plusieurs options sont sélectionnées, l'index de la première option sélectionnée est renvoyé. |
| [ShadowRoot](../../aspose.html.dom/element/shadowroot/) { get; } | Renvoie shadowRoot stocké sur cet élément ou null s'il est fermé. |
| [Size](../../aspose.html/htmlselectelement/size/) { get; set; } | Nombre de lignes visibles. Voir la définition de l'attribut de taille dans HTML 4.01. |
...
| [TabIndex](../../aspose.html/htmlselectelement/tabindex/) { get; set; } | Index qui représente la position de l'élément dans l'ordre de tabulation. Voir la définition de l'attribut tabindex dans HTML 4.01. |
...
| [Type](../../aspose.html/htmlselectelement/type/) { get; } | Le type de ce contrôle de formulaire. Il s'agit de la chaîne "select-multiple" lorsque l'attribut multiple est`vrai` et la chaîne "select-one" lorsque`FAUX` . |
| [Value](../../aspose.html/htmlselectelement/value/) { get; set; } | La valeur actuelle du contrôle du formulaire (c'est-à-dire la valeur de l'option actuellement sélectionnée), si plusieurs options sont sélectionnées, il s'agit de la valeur de la première option sélectionnée. |
