...
description: Lélément select permet de sélectionner une option. Les options contenues sont directement accessibles via lélément select en tant que collection. Voir la définition de lélément SELECT dans HTML 4.01.
type: docs
weight: 3510
