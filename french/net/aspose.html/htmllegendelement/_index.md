...
description: Fournit une légende pour unJEU DE CHAMPS regroupement. Voir la définition de lélément LEGEND dans HTML 4.01.
type: docs
weight: 3350
...
| [Form](../../aspose.html/htmllegendelement/form) { get; } | Renvoie le`FORMULAIRE` élément contenant ce champ. Renvoie `nul` si ce champ n'est pas dans le contexte d'un formulaire . |
