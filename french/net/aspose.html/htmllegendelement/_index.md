...
description: Aspose.Html.HTMLLegendElement classe. Fournit une légende pour unJEU DE CHAMPS regroupement. Voir la définition de lélément LEGEND dans HTML 4.01.
type: docs
weight: 3360
url: /fr/net/aspose.html/htmllegendelement/
---
## HTMLLegendElement class

Fournit une légende pour un`JEU DE CHAMPS` regroupement. Voir la définition de l'élément LEGEND dans HTML 4.01.
...
| Nom | La description |
| --- | --- |
| [AccessKey](../../aspose.html/htmllegendelement/accesskey/) { get; set; } | Une clé d'accès à un seul caractère pour donner accès au contrôle du formulaire. Voir la définition de l'attribut accesskey dans HTML 4.01. |
| [Align](../../aspose.html/htmllegendelement/align/) { get; set; } | Alignement du texte par rapport à`JEU DE CHAMPS` . Voir la définition de l'attribut align dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
...
| [Form](../../aspose.html/htmllegendelement/form/) { get; } | Renvoie le`FORMER` élément contenant ce champ. Renvoie `nul` si ce champ n'est pas dans le contexte d'un formulaire . |
