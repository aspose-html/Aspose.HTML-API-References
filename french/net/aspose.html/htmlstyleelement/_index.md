...
description: Aspose.Html.HTMLStyleElement classe. Informations de style. Voir la définition de lélément STYLE dans HTML 4.01 le module CSS Feuilles de style DOM niveau 2 et CSS  et leStyle de lien interface dans le module StyleSheets Feuilles de style DOM niveau 2 et CSS .
type: docs
weight: 3530
url: /fr/net/aspose.html/htmlstyleelement/
---
...
| [Disabled](../../aspose.html/htmlstyleelement/disabled/) { get; set; } | Active/désactive la feuille de style. |
...
| [Media](../../aspose.html/htmlstyleelement/media/) { get; set; } | Conçu pour être utilisé avec un ou plusieurs supports cibles. Voir la définition de l'attribut média dans HTML 4.01. |
...
| [Sheet](../../aspose.html/htmlstyleelement/sheet/) { get; } | Obtient la feuille de style associée. |
...
| [Type](../../aspose.html/htmlstyleelement/type/) { get; set; } | Le type de contenu du langage de la feuille de style. Voir la définition de l'attribut de type dans HTML 4.01. |
