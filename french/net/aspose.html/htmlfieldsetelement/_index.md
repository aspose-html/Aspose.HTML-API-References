...
description: Aspose.Html.HTMLFieldSetElement classe. Organise les contrôles de formulaire en groupes logiques. Voir la définition de lélément FIELDSET dans HTML 4.01.
type: docs
weight: 3210
url: /fr/net/aspose.html/htmlfieldsetelement/
---
## HTMLFieldSetElement class

Organise les contrôles de formulaire en groupes logiques. Voir la définition de l'élément FIELDSET dans HTML 4.01.
...
| [Form](../../aspose.html/htmlfieldsetelement/form/) { get; } | Renvoie le`FORMER` élément contenant ce champ. Renvoie `nul` si ce champ n'est pas dans le contexte d'un formulaire . |
