...
description: Organise les contrôles de formulaire en groupes logiques. Voir la définition de lélément FIELDSET dans HTML 4.01.
type: docs
weight: 3200
...
| [Form](../../aspose.html/htmlfieldsetelement/form) { get; } | Renvoie le`FORMULAIRE` élément contenant ce champ. Renvoie `nul` si ce champ n'est pas dans le contexte d'un formulaire . |
