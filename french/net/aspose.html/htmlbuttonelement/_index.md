...
description: Bouton poussoir. Voir la définition de lélément BUTTON dans HTML 4.01.
type: docs
weight: 3120
...
| [Form](../../aspose.html/htmlbuttonelement/form) { get; } | Renvoie le`FORMULAIRE` élément contenant ce champ. Renvoie `nul` si ce champ n'est pas dans le contexte d'un formulaire . |
