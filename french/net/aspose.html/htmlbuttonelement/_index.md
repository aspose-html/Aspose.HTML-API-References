...
description: Aspose.Html.HTMLButtonElement classe. Bouton poussoir. Voir la définition de lélément BUTTON dans HTML 4.01.
type: docs
weight: 3130
url: /fr/net/aspose.html/htmlbuttonelement/
---
## HTMLButtonElement class

Bouton poussoir. Voir la définition de l'élément BUTTON dans HTML 4.01.
...
| Nom | La description |
| --- | --- |
| [AccessKey](../../aspose.html/htmlbuttonelement/accesskey/) { get; set; } | Une clé d'accès à un seul caractère pour donner accès au contrôle du formulaire. Voir la définition de l'attribut accesskey dans HTML 4.01. |
...
| [Disabled](../../aspose.html/htmlbuttonelement/disabled/) { get; set; } | Le contrôle n'est pas disponible dans ce contexte. Voir la définition de l'attribut désactivé dans HTML 4.01. |
...
| [Form](../../aspose.html/htmlbuttonelement/form/) { get; } | Renvoie le`FORMER` élément contenant ce champ. Renvoie `nul` si ce champ n'est pas dans le contexte d'un formulaire . |
...
| [Name](../../aspose.html/htmlbuttonelement/name/) { get; set; } | Contrôle de formulaire ou nom d'objet lorsqu'il est soumis avec un formulaire. Voir la définition de l'attribut name dans HTML 4.01. |
...
| [TabIndex](../../aspose.html/htmlbuttonelement/tabindex/) { get; set; } | Index qui représente la position de l'élément dans l'ordre de tabulation. Voir la définition de l'attribut tabindex dans HTML 4.01. |
...
| [Type](../../aspose.html/htmlbuttonelement/type/) { get; set; } | Le type de bouton (tout en minuscules). Voir la définition d'attribut de type dans HTML 4.01. |
| [Value](../../aspose.html/htmlbuttonelement/value/) { get; set; } | La valeur de contrôle de formulaire actuelle. Voir la définition de l'attribut value dans HTML 4.01. |
