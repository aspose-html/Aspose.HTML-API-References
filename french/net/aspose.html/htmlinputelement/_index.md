...
| [Form](../../aspose.html/htmlinputelement/form/) { get; set; } | Renvoie le`FORMER` élément contenant ce champ. Renvoie `nul` si ce champ n'est pas dans le contexte d'un formulaire . |
...
| [List](../../aspose.html/htmlinputelement/list/) { get; set; } | L'attribut list est utilisé pour identifier un élément qui répertorie les options prédéfinies proposées à l'utilisateur. S'il est présent, sa valeur doit être l'ID d'un élément datalist dans le même document. |
