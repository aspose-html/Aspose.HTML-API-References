...
description: Une ligne dans un tableau. Voir la définition de lélément TR dans HTML 4.01.
type: docs
weight: 3570
...
| [InsertCell](../../aspose.html/htmltablerowelement/insertcell)(int) | Insérer un vide`TD` cellule dans cette rangée. Si `indice` est -1 ou égal au nombre de cellules, la nouvelle cellule est ajoutée. |
