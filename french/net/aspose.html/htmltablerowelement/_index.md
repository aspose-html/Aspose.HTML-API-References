...
description: Aspose.Html.HTMLTableRowElement classe. Une ligne dans un tableau. Voir la définition de lélément TR dans HTML 4.01.
type: docs
weight: 3580
url: /fr/net/aspose.html/htmltablerowelement/
---
## HTMLTableRowElement class

Une ligne dans un tableau. Voir la définition de l'élément TR dans HTML 4.01.
...
| Nom | La description |
| --- | --- |
| [Align](../../aspose.html/htmltablerowelement/align/) { get; set; } | Alignement horizontal des données dans les cellules de cette ligne. Voir la définition de l'attribut align dans HTML 4.01. |
...
| [BgColor](../../aspose.html/htmltablerowelement/bgcolor/) { get; set; } | Couleur de fond des lignes. Voir la définition de l'attribut bgcolor dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
| [Cells](../../aspose.html/htmltablerowelement/cells/) { get; } | La collection de cellules de cette ligne. @version DOM niveau 2 |
| [Ch](../../aspose.html/htmltablerowelement/ch/) { get; set; } | Caractère d'alignement pour les cellules d'une colonne. Voir la définition de l'attribut char dans HTML 4.01. |
...
| [ChOff](../../aspose.html/htmltablerowelement/choff/) { get; set; } | Décalage du caractère d'alignement. Voir la définition de l'attribut charoff dans HTML 4.01. |
...
| [RowIndex](../../aspose.html/htmltablerowelement/rowindex/) { get; } | C'est dans l'ordre logique et non dans l'ordre des documents. Le `index de ligne` prend en compte les sections ( `LA TÊTE` ,`PIED` , ou`CORPS` ) dans le tableau, en plaçant`LA TÊTE` lignes en premier dans l'index, suivi de`CORPS` rangées, suivies de`PIED` lignes. @version DOM niveau 2 |
| [SchemaTypeInfo](../../aspose.html.dom/element/schematypeinfo/) { get; } | Les informations de type associées à cet élément. |
| [SectionRowIndex](../../aspose.html/htmltablerowelement/sectionrowindex/) { get; } | L'index de cette ligne, relatif à la section actuelle ( `LA TÊTE` ,`PIED` , ou`CORPS` ), à partir de 0. @version DOM niveau 2 |
...
| [VAlign](../../aspose.html/htmltablerowelement/valign/) { get; set; } | Alignement vertical des données dans les cellules de cette ligne. Voir la définition de l'attribut valign dans HTML 4.01. |
...
| [DeleteCell](../../aspose.html/htmltablerowelement/deletecell/)(int) | Supprimer une cellule de la ligne actuelle. |
...
| [InsertCell](../../aspose.html/htmltablerowelement/insertcell/)(int) | Insérer un vide`TD` cellule dans cette ligne. Si `indice` est -1 ou égal au nombre de cellules, la nouvelle cellule est ajoutée. |
