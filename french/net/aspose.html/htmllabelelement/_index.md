...
description: Texte de létiquette du champ de formulaire. Voir la définition de lélément LABEL dans HTML 4.01.
type: docs
weight: 3340
...
| [Form](../../aspose.html/htmllabelelement/form) { get; } | Renvoie le`FORMULAIRE` élément contenant ce champ. Renvoie `nul` si ce champ n'est pas dans le contexte d'un formulaire . |
