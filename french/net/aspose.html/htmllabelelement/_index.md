...
description: Aspose.Html.HTMLLabelElement classe. Texte de létiquette du champ de formulaire. Voir la définition de lélément LABEL dans HTML 4.01.
type: docs
weight: 3350
url: /fr/net/aspose.html/htmllabelelement/
---
## HTMLLabelElement class

Texte de l'étiquette du champ de formulaire. Voir la définition de l'élément LABEL dans HTML 4.01.
...
| Nom | La description |
| --- | --- |
| [AccessKey](../../aspose.html/htmllabelelement/accesskey/) { get; set; } | Une clé d'accès à un seul caractère pour donner accès au contrôle du formulaire. Voir la définition de l'attribut accesskey dans HTML 4.01. |
...
| [For](../../aspose.html/htmllabelelement/for/) { get; set; } | Cet attribut relie cette étiquette à un autre contrôle de formulaire par `identifiant`attribut. Voir la définition de l'attribut for dans HTML 4.01. |
| [Form](../../aspose.html/htmllabelelement/form/) { get; } | Renvoie le`FORMER` élément contenant ce champ. Renvoie `nul` si ce champ n'est pas dans le contexte d'un formulaire . |
