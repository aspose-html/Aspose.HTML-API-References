...
description: Aspose.Html.HTMLBRElement classe. Forcer un saut de ligne. Voir la définition de lélément BR dans HTML 4.01.
type: docs
weight: 3090
url: /fr/net/aspose.html/htmlbrelement/
---
## HTMLBRElement class

Forcer un saut de ligne. Voir la définition de l'élément BR dans HTML 4.01.
...
| [Clear](../../aspose.html/htmlbrelement/clear/) { get; set; } | Contrôlez le flux de texte autour des éléments flottants. Voir la définition d'attribut clair dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
