...
description: Aspose.Html.HTMLImageElement classe. Image intégrée. Voir la définition de lélément IMG dans HTML 4.01.
type: docs
weight: 3310
url: /fr/net/aspose.html/htmlimageelement/
---
## HTMLImageElement class

Image intégrée. Voir la définition de l'élément IMG dans HTML 4.01.
...
| Nom | La description |
| --- | --- |
| [Align](../../aspose.html/htmlimageelement/align/) { get; set; } | Aligne cet objet (verticalement ou horizontalement) par rapport au texte qui l'entoure . Voir la définition de l'attribut align dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
| [Alt](../../aspose.html/htmlimageelement/alt/) { get; set; } | Texte alternatif pour les agents utilisateurs ne restituant pas le contenu normal de cet élément . Voir la définition de l'attribut alt dans HTML 4.01. |
...
| [Border](../../aspose.html/htmlimageelement/border/) { get; set; } | Largeur de la bordure autour de l'image. Voir la définition de l'attribut border dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. Notez que le type de cet attribut était`Chaîne DOM` dans le HTML de niveau 1 du DOM [[DOM niveau 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ] . |
...
| [Height](../../aspose.html/htmlimageelement/height/) { get; set; } | Hauteur de l'image en pixels. Voir la définition de l'attribut height dans HTML 4.01. Notez que le type de cet attribut était `Chaîne DOM` dans le HTML de niveau 1 du DOM [[DOM niveau 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ]. @version DOM Niveau 2 |
| [Hspace](../../aspose.html/htmlimageelement/hspace/) { get; set; } | Espace horizontal à gauche et à droite de cette image en pixels. Voir la définition de l'attribut hspace dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. Notez que le type de cet attribut était `Chaîne DOM` dans le HTML de niveau 1 du DOM [[DOM niveau 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ]. @version DOM Niveau 2 |
...
| [IsMap](../../aspose.html/htmlimageelement/ismap/) { get; set; } | Utiliser une image cliquable côté serveur. Voir la définition de l'attribut ismap dans HTML 4.01. |
...
| [LongDesc](../../aspose.html/htmlimageelement/longdesc/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] désignant une longue description de cette image ou de ce cadre. Voir la définition de l'attribut longdesc dans HTML 4.01. |
| [Name](../../aspose.html/htmlimageelement/name/) { get; set; } | Le nom de l'élément (pour la rétrocompatibilité). |
...
| [Src](../../aspose.html/htmlimageelement/src/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] désignant la source de cette image. Voir la définition de l'attribut src dans HTML 4.01. |
...
| [UseMap](../../aspose.html/htmlimageelement/usemap/) { get; set; } | Utiliser une image cliquable côté client. Voir la définition de l'attribut usemap dans HTML 4.01. |
| [Vspace](../../aspose.html/htmlimageelement/vspace/) { get; set; } | Espace vertical au-dessus et au-dessous de cette image en pixels. Voir la définition de l'attribut vspace dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. Notez que le type de cet attribut était "DOMString" dans DOM Level 1 HTML [[DOM niveau 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ]. @version DOM Niveau 2 |
| [Width](../../aspose.html/htmlimageelement/width/) { get; set; } | La largeur de l'image en pixels. Voir la définition de l'attribut width dans HTML 4.01. Notez que le type de cet attribut était `Chaîne DOM` dans le HTML de niveau 1 du DOM [[DOM niveau 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ]. @version DOM Niveau 2 |
