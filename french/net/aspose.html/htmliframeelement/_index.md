...
description: Aspose.Html.HTMLIFrameElement classe. Sousfenêtres en ligne. Voir la définition de lélément IFRAME dans HTML 4.01.
type: docs
weight: 3300
url: /fr/net/aspose.html/htmliframeelement/
---
## HTMLIFrameElement class

Sous-fenêtres en ligne. Voir la définition de l'élément IFRAME dans HTML 4.01.
...
| Nom | La description |
| --- | --- |
| [Align](../../aspose.html/htmliframeelement/align/) { get; set; } | Aligne cet objet (verticalement ou horizontalement) par rapport au texte qui l'entoure . Voir la définition de l'attribut align dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
...
| [FrameBorder](../../aspose.html/htmliframeelement/frameborder/) { get; set; } | Demander les bordures du cadre. Voir la définition de l'attribut frameborder dans HTML 4.01. |
| [Height](../../aspose.html/htmliframeelement/height/) { get; set; } | Hauteur du cadre. Voir la définition de l'attribut de hauteur dans HTML 4.01. |
...
| [LongDesc](../../aspose.html/htmliframeelement/longdesc/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] désignant une longue description de cette image ou de ce cadre. Voir la définition de l'attribut longdesc dans HTML 4.01. |
| [MarginHeight](../../aspose.html/htmliframeelement/marginheight/) { get; set; } | Hauteur de la marge du cadre, en pixels. Voir la définition de l'attribut marginheight dans HTML 4.01. |
| [MarginWidth](../../aspose.html/htmliframeelement/marginwidth/) { get; set; } | Largeur de la marge du cadre, en pixels. Voir la définition de l'attribut marginwidth dans HTML 4.01. |
| [Name](../../aspose.html/htmliframeelement/name/) { get; set; } | Le nom de la trame (objet du`cible` attribut). Voir la définition de l'attribut de nom dans HTML 4.01. |
...
| [Scrolling](../../aspose.html/htmliframeelement/scrolling/) { get; set; } | Spécifiez si le cadre doit avoir ou non des barres de défilement. Voir la définition de l'attribut de défilement dans HTML 4.01. |
| [ShadowRoot](../../aspose.html.dom/element/shadowroot/) { get; } | Renvoie shadowRoot stocké sur cet élément ou null s'il est fermé. |
| [Src](../../aspose.html/htmliframeelement/src/) { get; set; } | Une URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] désignant le contenu initial de la trame. Voir la définition de l'attribut src dans HTML 4.01. |
...
| [Width](../../aspose.html/htmliframeelement/width/) { get; set; } | Largeur du cadre. Voir la définition de l'attribut width dans HTML 4.01. |
