...
description: Aspose.Html.HTMLFormElement classe. LeFORMER Lélément englobe un comportement similaire à une collection et un élément. Il fournit un accès direct aux contrôles de formulaire contenus ainsi quaux attributs de lélément de formulaire. Voir la définition de lélément FORM dans HTML 4.01.
type: docs
weight: 3230
url: /fr/net/aspose.html/htmlformelement/
---
## HTMLFormElement class

Le`FORMER` L'élément englobe un comportement similaire à une collection et un élément. Il fournit un accès direct aux contrôles de formulaire contenus ainsi qu'aux attributs de l'élément de formulaire. Voir la définition de l'élément FORM dans HTML 4.01.
...
| Nom | La description |
| --- | --- |
| [AcceptCharset](../../aspose.html/htmlformelement/acceptcharset/) { get; set; } | Liste des jeux de caractères pris en charge par le serveur. Voir la définition de l'attribut accept-charset dans HTML 4.01. |
| [Action](../../aspose.html/htmlformelement/action/) { get; set; } | Gestionnaire de formulaires côté serveur. Voir la définition de l'attribut d'action dans HTML 4.01. |
...
| [Elements](../../aspose.html/htmlformelement/elements/) { get; } | Renvoie une collection de tous les éléments de contrôle de formulaire dans le formulaire. |
| [Enctype](../../aspose.html/htmlformelement/enctype/) { get; set; } | Le type de contenu du formulaire soumis, généralement "application/x-www-form-urlencoded". Voir la définition de l'attribut enctype dans HTML 4.01. Il n'est pas garanti que le gestionnaire onsubmit even soit déclenché lors de l'appel de cette méthode. Le comportement est incohérent pour des raisons historiques et les auteurs ne doivent pas s'appuyer sur un particulier. |
...
| [Length](../../aspose.html/htmlformelement/length/) { get; } | Le nombre de contrôles de formulaire dans le formulaire. |
...
| [Method](../../aspose.html/htmlformelement/method/) { get; set; } | méthode HTTP [[IETF RFC 2616](http://www.ietf.org/rfc/rfc2616.txt) utilisé pour soumettre le formulaire. Voir la définition de l'attribut method dans HTML 4.01. |
| [Name](../../aspose.html/htmlformelement/name/) { get; set; } | Nomme le formulaire. |
...
| [Target](../../aspose.html/htmlformelement/target/) { get; set; } | Cadre dans lequel afficher la ressource. Voir la définition de l'attribut cible dans HTML 4.01. |
...
| [Reset](../../aspose.html/htmlformelement/reset/)() | Restaure les valeurs par défaut d'un élément de formulaire. Il effectue la même action qu'un bouton de réinitialisation. |
...
| [Submit](../../aspose.html/htmlformelement/submit/)() | Soumet le formulaire. Il effectue la même action qu'un bouton d'envoi. |
