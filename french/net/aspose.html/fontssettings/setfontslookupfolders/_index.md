...
description: Définit un tableau de dossiers utilisés lors de la sélection des polices.
type: docs
weight: 40
url: /fr/net/aspose.html/fontssettings/setfontslookupfolders/
---
## SetFontsLookupFolders(string[]) {#setfontslookupfolders}

Définit un tableau de dossiers utilisés lors de la sélection des polices.
