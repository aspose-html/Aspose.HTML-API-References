...
description: Aspose.Html.HTMLLIElement classe. Élément de liste. Voir la définition de lélément LI dans HTML 4.01.
type: docs
weight: 3340
url: /fr/net/aspose.html/htmllielement/
---
## HTMLLIElement class

Élément de liste. Voir la définition de l'élément LI dans HTML 4.01.
...
| [Type](../../aspose.html/htmllielement/type/) { get; set; } | Style de puce d'élément de liste. Voir la définition de l'attribut type dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
| [Value](../../aspose.html/htmllielement/value/) { get; set; } | Réinitialiser le numéro de séquence lorsqu'il est utilisé dans`LO` . Voir la définition de l'attribut value dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
