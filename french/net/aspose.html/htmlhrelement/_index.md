...
description: Aspose.Html.HTMLHRElement classe. Créez une règle horizontale. Voir la définition de lélément HR dans HTML 4.01.
type: docs
weight: 3260
url: /fr/net/aspose.html/htmlhrelement/
---
## HTMLHRElement class

Créez une règle horizontale. Voir la définition de l'élément HR dans HTML 4.01.
...
| Nom | La description |
| --- | --- |
| [Align](../../aspose.html/htmlhrelement/align/) { get; set; } | Alignez la règle sur la page. Voir la définition de l'attribut align dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
...
| [NoShade](../../aspose.html/htmlhrelement/noshade/) { get; set; } | Indique à l'agent utilisateur qu'il ne devrait y avoir aucun ombrage dans le rendu de cet élément. Voir la définition de l'attribut noshade dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
...
| [Size](../../aspose.html/htmlhrelement/size/) { get; set; } | La hauteur de la règle. Voir la définition de l'attribut size dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
...
| [Width](../../aspose.html/htmlhrelement/width/) { get; set; } | La largeur de la règle. Voir la définition de l'attribut width dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
