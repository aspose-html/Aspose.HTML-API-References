...
description: Aspose.Html.HTMLOptGroupElement classe. Regroupez les options en subdivisions logiques. Voir la définition de lélément OPTGROUP dans HTML 4.01.
type: docs
weight: 3450
url: /fr/net/aspose.html/htmloptgroupelement/
---
## HTMLOptGroupElement class

Regroupez les options en subdivisions logiques. Voir la définition de l'élément OPTGROUP dans HTML 4.01.
...
| [Disabled](../../aspose.html/htmloptgroupelement/disabled/) { get; set; } | Le contrôle n'est pas disponible dans ce contexte. Voir la définition de l'attribut désactivé dans HTML 4.01. |
...
| [Label](../../aspose.html/htmloptgroupelement/label/) { get; set; } | Attribue une étiquette à ce groupe d'options. Voir la définition d'attribut d'étiquette dans HTML 4.01. |
