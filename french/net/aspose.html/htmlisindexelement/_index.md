...
description: Aspose.Html.HTMLIsIndexElement classe. Cet élément est utilisé pour la saisie de texte sur une seule ligne. Voir la définition de lélément ISINDEX dans HTML 4.01. Cet élément est obsolète dans HTML 4.01.
type: docs
weight: 3330
url: /fr/net/aspose.html/htmlisindexelement/
---
## HTMLIsIndexElement class

Cet élément est utilisé pour la saisie de texte sur une seule ligne. Voir la définition de l'élément ISINDEX dans HTML 4.01. Cet élément est obsolète dans HTML 4.01.
...
| [Form](../../aspose.html/htmlisindexelement/form/) { get; } | Renvoie le élément contenant ce champ. Renvoie si ce champ n'est pas dans le contexte d'un formulaire . |
...
| [Prompt](../../aspose.html/htmlisindexelement/prompt/) { get; set; } | Le message d'invite. Voir la définition de l'attribut prompt dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
