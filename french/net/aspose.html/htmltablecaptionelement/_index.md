...
description: Aspose.Html.HTMLTableCaptionElement classe. Légende du tableau Voir la définition de lélément CAPTION dans HTML 4.01.
type: docs
weight: 3540
url: /fr/net/aspose.html/htmltablecaptionelement/
---
## HTMLTableCaptionElement class

Légende du tableau Voir la définition de l'élément CAPTION dans HTML 4.01.
...
| Nom | La description |
| --- | --- |
| [Align](../../aspose.html/htmltablecaptionelement/align/) { get; set; } | Alignement des légendes par rapport au tableau. Voir la définition de l'attribut align dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
