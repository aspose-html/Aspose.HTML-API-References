...
description: Champ de texte multiligne. Voir la définition de lélément TEXTARE dans HTML 4.01.
type: docs
weight: 3600
...
| [Form](../../aspose.html/htmltextareaelement/form) { get; } | Renvoie le`FORMULAIRE` élément contenant ce champ. Renvoie `nul` si ce champ n'est pas dans le contexte d'un formulaire . |
