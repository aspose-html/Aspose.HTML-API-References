...
description: Aspose.Html.HTMLTextAreaElement classe. Champ de texte multiligne. Voir la définition de lélément TEXTARE dans HTML 4.01.
type: docs
weight: 3610
url: /fr/net/aspose.html/htmltextareaelement/
---
## HTMLTextAreaElement class

Champ de texte multiligne. Voir la définition de l'élément TEXTARE dans HTML 4.01.
...
| Nom | La description |
| --- | --- |
| [AccessKey](../../aspose.html/htmltextareaelement/accesskey/) { get; set; } | Une clé d'accès à un seul caractère pour donner accès au contrôle du formulaire. Voir la définition de l'attribut accesskey dans HTML 4.01. |
...
| [Cols](../../aspose.html/htmltextareaelement/cols/) { get; set; } | Largeur du champ (en caractères). Voir la définition de l'attribut cols dans HTML 4.01. |
| [DefaultValue](../../aspose.html/htmltextareaelement/defaultvalue/) { get; set; } | Représente le contenu de l'élément. La valeur de cet attribut ne change pas si le contenu du contrôle de formulaire correspondant, dans un agent utilisateur interactif, change. @version DOM Niveau 2 |
...
| [Disabled](../../aspose.html/htmltextareaelement/disabled/) { get; set; } | Le contrôle n'est pas disponible dans ce contexte. Voir la définition de l'attribut désactivé dans HTML 4.01. |
...
| [Form](../../aspose.html/htmltextareaelement/form/) { get; } | Renvoie le`FORMER` élément contenant ce champ. Renvoie `nul` si ce champ n'est pas dans le contexte d'un formulaire . |
...
| [Name](../../aspose.html/htmltextareaelement/name/) { get; set; } | Contrôle de formulaire ou nom d'objet lorsqu'il est soumis avec un formulaire. Voir la définition de l'attribut name dans HTML 4.01. |
...
| [ReadOnly](../../aspose.html/htmltextareaelement/readonly/) { get; set; } | Ce contrôle est en lecture seule. Voir la définition de l'attribut readonly dans HTML 4.01. |
| [Rows](../../aspose.html/htmltextareaelement/rows/) { get; set; } | Nombre de lignes de texte. Voir la définition de l'attribut rows dans HTML 4.01. |
...
| [TabIndex](../../aspose.html/htmltextareaelement/tabindex/) { get; set; } | Index qui représente la position de l'élément dans l'ordre de tabulation. Voir la définition de l'attribut tabindex dans HTML 4.01. |
...
| [Type](../../aspose.html/htmltextareaelement/type/) { get; } | Le type de ce contrôle de formulaire. C'est la chaîne "textarea". |
| [Value](../../aspose.html/htmltextareaelement/value/) { get; set; } | Représente le contenu actuel du contrôle de formulaire correspondant, dans un agent utilisateur interactif. La modification de cet attribut modifie le contenu du contrôle de formulaire, mais ne modifie pas le contenu de l'élément . Si l'intégralité des données ne peut pas tenir dans un seul `Chaîne DOM` , l'implémentation peut tronquer les données. |
