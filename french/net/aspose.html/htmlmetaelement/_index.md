...
description: Aspose.Html.HTMLMetaElement classe. Ceci contient des métainformations génériques sur le document. Voir la définition de lélément META dans HTML 4.01.
type: docs
weight: 3400
url: /fr/net/aspose.html/htmlmetaelement/
---
## HTMLMetaElement class

Ceci contient des méta-informations génériques sur le document. Voir la définition de l'élément META dans HTML 4.01.
...
| [Content](../../aspose.html/htmlmetaelement/content/) { get; set; } | Informations associées. Voir la définition de l'attribut de contenu dans HTML 4.01. |
...
| [HttpEquiv](../../aspose.html/htmlmetaelement/httpequiv/) { get; set; } | nom de l'en-tête de réponse HTTP [[IETF RFC 2616](http://www.ietf.org/rfc/rfc2616.txt) ]. Voir la définition de l'attribut http-equiv dans HTML 4.01. |
...
| [Name](../../aspose.html/htmlmetaelement/name/) { get; set; } | Nom de la méta-information. Voir la définition de l'attribut name dans HTML 4.01. |
...
| [Scheme](../../aspose.html/htmlmetaelement/scheme/) { get; set; } | Sélectionnez la forme du contenu. Voir la définition de l'attribut de schéma dans HTML 4.01. |
