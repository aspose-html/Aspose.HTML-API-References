...
description: Aspose.Html.HTMLFrameSetElement classe. Créez une grille de cadres. Voir la définition de lélément FRAMESET dans HTML 4.01.
type: docs
weight: 3250
url: /fr/net/aspose.html/htmlframesetelement/
---
## HTMLFrameSetElement class

Créez une grille de cadres. Voir la définition de l'élément FRAMESET dans HTML 4.01.
...
| [Cols](../../aspose.html/htmlframesetelement/cols/) { get; set; } | Le nombre de colonnes de cadres dans le jeu de cadres. Voir la définition de l'attribut cols dans HTML 4.01. |
...
| [Rows](../../aspose.html/htmlframesetelement/rows/) { get; set; } | Le nombre de rangées de cadres dans le jeu de cadres. Voir la définition de l'attribut rows dans HTML 4.01. |
