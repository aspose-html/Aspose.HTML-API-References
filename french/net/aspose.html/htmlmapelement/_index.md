...
description: Aspose.Html.HTMLMapElement classe. Image cliquable côté client. Voir la définition de lélément MAP dans HTML 4.01.
type: docs
weight: 3380
url: /fr/net/aspose.html/htmlmapelement/
---
## HTMLMapElement class

Image cliquable côté client. Voir la définition de l'élément MAP dans HTML 4.01.
...
| Nom | La description |
| --- | --- |
| [Areas](../../aspose.html/htmlmapelement/areas/) { get; } | La liste des zones définies pour l'image cliquable. |
...
| [Name](../../aspose.html/htmlmapelement/name/) { get; set; } | Nomme la carte (à utiliser avec`usemap` ). Voir la définition de l'attribut name dans HTML 4.01. |
