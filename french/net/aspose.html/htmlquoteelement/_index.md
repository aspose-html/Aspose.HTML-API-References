...
description: Aspose.Html.HTMLQuoteElement classe. Pour leQ etCITATION EN BLOCéléments. Voir la définition de lélément Q dans HTML 4.01.
type: docs
weight: 3500
url: /fr/net/aspose.html/htmlquoteelement/
---
## HTMLQuoteElement class

Pour le`Q` et`CITATION EN BLOC`éléments. Voir la définition de l'élément Q dans HTML 4.01.
...
| [Cite](../../aspose.html/htmlquoteelement/cite/) { get; set; } | Une URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] désignant un document ou un message source. Voir la définition de l'attribut de citation dans HTML 4.01. |
