...
description: Aspose.Html.HTMLFontElement classe. Modification locale de la police. Voir la définition de lélément FONT dans HTML 4.01. Cet élément est obsolète dans HTML 4.01.
type: docs
weight: 3220
url: /fr/net/aspose.html/htmlfontelement/
---
## HTMLFontElement class

Modification locale de la police. Voir la définition de l'élément FONT dans HTML 4.01. Cet élément est obsolète dans HTML 4.01.
...
| [Color](../../aspose.html/htmlfontelement/color/) { get; set; } | Couleur de la police. Voir la définition de l'attribut de couleur dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
...
| [Face](../../aspose.html/htmlfontelement/face/) { get; set; } | Identificateur de police. Voir la définition de l'attribut face dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
...
| [Size](../../aspose.html/htmlfontelement/size/) { get; set; } | Taille de la police. Voir la définition de l'attribut size dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
