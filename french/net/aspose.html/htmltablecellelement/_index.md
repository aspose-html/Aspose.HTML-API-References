...
description: Aspose.Html.HTMLTableCellElement classe. Lobjet utilisé pour représenter leE etTD éléments. Voir la définition de lélément TD dans HTML 4.01.
type: docs
weight: 3550
url: /fr/net/aspose.html/htmltablecellelement/
---
## HTMLTableCellElement class

L'objet utilisé pour représenter le`E` et`TD` éléments. Voir la définition de l'élément TD dans HTML 4.01.
...
| Nom | La description |
| --- | --- |
| [Abbr](../../aspose.html/htmltablecellelement/abbr/) { get; set; } | Abréviation des cellules d'en-tête. Voir la définition de l'attribut abbr dans HTML 4.01. |
| [Align](../../aspose.html/htmltablecellelement/align/) { get; set; } | Alignement horizontal des données dans la cellule. Voir l'attribut align definition dans HTML 4.01. |
...
| [Axis](../../aspose.html/htmltablecellelement/axis/) { get; set; } | Groupe de noms d'en-têtes associés. Voir la définition de l'attribut d'axe dans HTML 4.01. |
...
| [BgColor](../../aspose.html/htmltablecellelement/bgcolor/) { get; set; } | Couleur d'arrière-plan de la cellule. Voir la définition de l'attribut bgcolor dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
| [CellIndex](../../aspose.html/htmltablecellelement/cellindex/) { get; } | L'index de cette cellule dans la ligne, à partir de 0. Cet index est dans l'ordre de l'arborescence du document et non l'ordre d'affichage. |
| [Ch](../../aspose.html/htmltablecellelement/ch/) { get; set; } | Caractère d'alignement pour les cellules d'une colonne. Voir la définition de l'attribut char dans HTML 4.01. |
...
| [ChOff](../../aspose.html/htmltablecellelement/choff/) { get; set; } | Décalage du caractère d'alignement. Voir la définition de l'attribut charoff dans HTML 4.01. |
...
| [ColSpan](../../aspose.html/htmltablecellelement/colspan/) { get; set; } | Nombre de colonnes étendues par cellule. Voir la définition de l'attribut colspan dans HTML 4.01. |
...
| [Headers](../../aspose.html/htmltablecellelement/headers/) { get; set; } | Liste des`identifiant` valeurs d'attribut pour les cellules d'en-tête. Voir la définition de l'attribut headers dans HTML 4.01. |
| [Height](../../aspose.html/htmltablecellelement/height/) { get; set; } | Hauteur de cellule. Voir la définition de l'attribut height dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
...
| [NoWrap](../../aspose.html/htmltablecellelement/nowrap/) { get; set; } | Supprimer l'habillage des mots. Voir la définition de l'attribut nowrap dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
...
| [RowSpan](../../aspose.html/htmltablecellelement/rowspan/) { get; set; } | Nombre de lignes étendues par cellule. Voir la définition de l'attribut rowspan dans HTML 4.01. |
| [SchemaTypeInfo](../../aspose.html.dom/element/schematypeinfo/) { get; } | Les informations de type associées à cet élément. |
| [Scope](../../aspose.html/htmltablecellelement/scope/) { get; set; } | Périmètre couvert par les cellules d'en-tête. Voir la définition de l'attribut scope dans HTML 4.01. |
...
| [VAlign](../../aspose.html/htmltablecellelement/valign/) { get; set; } | Alignement vertical des données dans la cellule. Voir la définition d'attribut valign dans HTML 4.01. |
| [Width](../../aspose.html/htmltablecellelement/width/) { get; set; } | Largeur de cellule. Voir la définition de l'attribut width dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
