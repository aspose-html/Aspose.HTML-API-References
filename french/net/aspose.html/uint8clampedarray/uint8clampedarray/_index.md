...
description: Uint8ClampedArray constructeur. Initialise une nouvelle instance duUint8ClampedArray classe.
type: docs
weight: 10
url: /fr/net/aspose.html/uint8clampedarray/uint8clampedarray/
---
## Uint8ClampedArray(int) {#constructor_4}

Initialise une nouvelle instance du[`Uint8ClampedArray`](../) classe.
...
| Paramètre | Taper | La description |
| --- | --- | --- |
| data | Byte[] | Les données du tableau. |
