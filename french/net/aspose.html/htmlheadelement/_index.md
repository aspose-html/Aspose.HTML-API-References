...
description: Aspose.Html.HTMLHeadElement classe. Informations sur lentête du document. Voir la définition de lélément HEAD dans HTML 4.01.
type: docs
weight: 3270
url: /fr/net/aspose.html/htmlheadelement/
---
## HTMLHeadElement class

Informations sur l'en-tête du document. Voir la définition de l'élément HEAD dans HTML 4.01.
...
| [Profile](../../aspose.html/htmlheadelement/profile/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] désignant un profil de métadonnées. Voir la définition de l'attribut de profil dans HTML 4.01. |
