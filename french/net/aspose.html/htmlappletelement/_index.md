...
description: Aspose.Html.HTMLAppletElement classe. Une applet Java intégrée. Voir la définition de lélément APPLET dans HTML 4.01. Cet élément est obsolète dans HTML 4.01.
type: docs
weight: 3070
url: /fr/net/aspose.html/htmlappletelement/
---
## HTMLAppletElement class

Une applet Java intégrée. Voir la définition de l'élément APPLET dans HTML 4.01. Cet élément est obsolète dans HTML 4.01.
...
| Nom | La description |
| --- | --- |
| [Align](../../aspose.html/htmlappletelement/align/) { get; set; } | Aligne cet objet (verticalement ou horizontalement) par rapport au texte qui l'entoure . Voir la définition de l'attribut align dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
| [Alt](../../aspose.html/htmlappletelement/alt/) { get; set; } | Texte alternatif pour les agents utilisateurs ne restituant pas le contenu normal de cet élément . Voir la définition de l'attribut alt dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
| [Archive](../../aspose.html/htmlappletelement/archive/) { get; set; } | Liste d'archives séparées par des virgules. Voir la définition de l'attribut archive dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
...
| [Code](../../aspose.html/htmlappletelement/code/) { get; set; } | Fichier de classe Applet. Voir la définition de l'attribut code dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
| [CodeBase](../../aspose.html/htmlappletelement/codebase/) { get; set; } | URI de base facultatif [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) pour l'applet. Voir la définition de l'attribut codebase dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
...
| [Height](../../aspose.html/htmlappletelement/height/) { get; set; } | Remplacer la hauteur. Voir la définition de l'attribut height dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
| [Hspace](../../aspose.html/htmlappletelement/hspace/) { get; set; } | Espace horizontal, en pixels, à gauche et à droite de cette image, applet ou objet. Voir la définition de l'attribut hspace dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. @version DOM Niveau 2 |
...
| [Name](../../aspose.html/htmlappletelement/name/) { get; set; } | Le nom de l'applet. Voir la définition de l'attribut name dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
...
| [Object](../../aspose.html/htmlappletelement/object/) { get; set; } | La valeur de l'attribut "objet". Voir l'attribut d'objet definition dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. @version DOM niveau 2 |
...
| [Vspace](../../aspose.html/htmlappletelement/vspace/) { get; set; } | Espace vertical, en pixels, au-dessus et au-dessous de cette image, applet ou objet . Voir la définition de l'attribut vspace dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. @version DOM niveau 2 |
| [Width](../../aspose.html/htmlappletelement/width/) { get; set; } | Remplacer la largeur. Voir la définition de l'attribut width dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
