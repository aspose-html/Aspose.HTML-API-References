...
description: Aspose.Html.HTMLUListElement classe. Liste non ordonnée. Voir la définition de lélément UL dans HTML 4.01.
type: docs
weight: 3630
url: /fr/net/aspose.html/htmlulistelement/
---
## HTMLUListElement class

Liste non ordonnée. Voir la définition de l'élément UL dans HTML 4.01.
...
| [Compact](../../aspose.html/htmlulistelement/compact/) { get; set; } | Réduisez l'espacement entre les éléments de la liste. Voir la définition d'attribut compact dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
...
| [Type](../../aspose.html/htmlulistelement/type/) { get; set; } | Style puce. Voir la définition de l'attribut type dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
