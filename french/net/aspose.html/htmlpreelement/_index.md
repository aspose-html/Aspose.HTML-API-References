...
description: Aspose.Html.HTMLPreElement classe. Texte préformaté. Voir la définition de lélément PRE dans HTML 4.01.
type: docs
weight: 3490
url: /fr/net/aspose.html/htmlpreelement/
---
## HTMLPreElement class

Texte préformaté. Voir la définition de l'élément PRE dans HTML 4.01.
...
| [Width](../../aspose.html/htmlpreelement/width/) { get; set; } | Largeur fixe pour le contenu. Voir la définition de l'attribut width dans HTML 4.01. Cet attribut est obsolète dans HTML 4.01. |
