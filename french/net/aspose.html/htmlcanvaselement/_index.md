...
description: Aspose.Html.HTMLCanvasElement classe. Linterface HTMLCanvasElement fournit des propriétés et des méthodes pour manipuler la mise en page et la présentation des éléments de canevas. Linterface HTMLCanvasElement hérite également des propriétés et des méthodes de linterface HTMLElement.
type: docs
weight: 3140
url: /fr/net/aspose.html/htmlcanvaselement/
---
## HTMLCanvasElement class

L'interface HTMLCanvasElement fournit des propriétés et des méthodes pour manipuler la mise en page et la présentation des éléments de canevas. L'interface HTMLCanvasElement hérite également des propriétés et des méthodes de l'interface HTMLElement.
...
| [Height](../../aspose.html/htmlcanvaselement/height/) { get; set; } | Est un entier positif reflétant l'attribut HTML de hauteur de l'élément canvas interprété en pixels CSS. Lorsque l'attribut n'est pas spécifié, ou s'il est défini sur une valeur non valide, comme un négatif, la valeur par défaut de 150 est utilisée. |
...
| [Width](../../aspose.html/htmlcanvaselement/width/) { get; set; } | Est un entier positif reflétant l'attribut HTML width de l'élément canvas interprété en pixels CSS. Lorsque l'attribut n'est pas spécifié, ou s'il est défini sur une valeur non valide, comme un négatif, la valeur par défaut de 300 est utilisée. |
...
| [GetContext](../../aspose.html/htmlcanvaselement/getcontext/)(string) | Renvoie un contexte de dessin sur le canevas, ou null si l'ID de contexte n'est pas pris en charge. Un contexte de dessin vous permet de dessiner sur le canevas. |
...
| [ToDataURL](../../aspose.html/htmlcanvaselement/todataurl/#todataurl)() | renvoie un URI de données contenant une représentation de l'image dans le format spécifié par le paramètre type (par défaut, PNG). L'image renvoyée est dans une résolution de 96 dpi. |
| [ToDataURL](../../aspose.html/htmlcanvaselement/todataurl/#todataurl_1)(string) | renvoie un URI de données contenant une représentation de l'image dans le format spécifié par le paramètre type (par défaut, PNG). L'image renvoyée est dans une résolution de 96 dpi. |
| [ToDataURL](../../aspose.html/htmlcanvaselement/todataurl/#todataurl_2)(string, double) | renvoie un URI de données contenant une représentation de l'image dans le format spécifié par le paramètre type (par défaut, PNG). L'image renvoyée est dans une résolution de 96 dpi. |
