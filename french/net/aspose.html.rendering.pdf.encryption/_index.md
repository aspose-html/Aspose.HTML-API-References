...
description: Le Aspose.Html.Rendering.Pdf.Encryptionlespace de noms contient des classes de données décrivant les détails de cryptage pdf comme le mot de passe lalgorithme de cryptage et ainsi de suite.
type: docs
weight: 340
url: /fr/net/aspose.html.rendering.pdf.encryption/
---
Le **Aspose.Html.Rendering.Pdf.Encryption**l'espace de noms contient des classes de données décrivant les détails de cryptage pdf comme le mot de passe, l'algorithme de cryptage et ainsi de suite.
