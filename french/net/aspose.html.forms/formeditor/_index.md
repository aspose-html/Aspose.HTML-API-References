...
description: Cette classe représente léditeur sur leHTMLFormElement../aspose.html/htmlformelement qui crée un moyen plus simple pour les développeurs .net de modifier les formulaires html.
type: docs
weight: 2920
...
| [Form](../../aspose.html.forms/formeditor/form) { get; } | L'original[`HTMLFormElement`](../../aspose.html/htmlformelement) qui est associé à l'instance actuelle de[`FormEditor`](../formeditor) . |
...
| Nom | La description |
| --- | --- |
| static [Create](../../aspose.html.forms/formeditor/create#create_2)(HTMLFormElement) | Crée un nouveau[`FormEditor`](../formeditor) basé sur[`HTMLFormElement`](../../aspose.html/htmlformelement) . |
| static [Create](../../aspose.html.forms/formeditor/create#create)(HTMLDocument, int) | Crée un nouveau[`FormEditor`](../formeditor) basé sur[`HTMLFormElement`](../../aspose.html/htmlformelement) sélectionné parmi les[`Forms`](../../aspose.html/htmldocument/forms) collection par index. |
| static [Create](../../aspose.html.forms/formeditor/create#create_1)(HTMLDocument, string) | Crée un nouveau[`FormEditor`](../formeditor) basé sur[`HTMLFormElement`](../../aspose.html/htmlformelement) sélectionné dans le document par id. |
