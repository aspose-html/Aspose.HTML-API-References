...
description: Contient les paramètres de contrôle graphiques actuels pour le XpsDevice. Ces paramètres définissent le cadre global dans lequel les opérateurs graphiques sexécutent.
type: docs
weight: 4520
url: /fr/net/aspose.html.rendering.xps/xpsdevice.xpsgraphiccontext/
---
...
| Nom | La description |
| --- | --- |
| override [Clone](../../aspose.html.rendering.xps/xpsgraphiccontext/clone)() | Crée une nouvelle instance d'une classe XpsGraphicContext avec les mêmes valeurs de propriété qu'une instance existante. |
