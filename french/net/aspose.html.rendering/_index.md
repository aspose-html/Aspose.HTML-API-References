...
description: Le Aspose.Html.Rendering lespace de noms se compose de de nombreux objets de rendu ainsi que des classes doptions de bas niveau appropriées qui sont responsables de restituer les documents/fichiers dans limplémentation IDevice.
type: docs
weight: 290
url: /fr/net/aspose.html.rendering/
---
Le **Aspose.Html.Rendering** l'espace de noms se compose de de nombreux objets de rendu ainsi que des classes d'options de bas niveau appropriées qui sont responsables de restituer les documents/fichiers dans l'implémentation IDevice.
...
| [EpubRenderer](./epubrenderer/) | Représente un moteur de rendu de document EPub. |
...
| [HtmlRenderer](./htmlrenderer/) | Représente un rendu de document HTML. |
| [MhtmlRenderer](./mhtmlrenderer/) | Représente un rendu de document MHTML. |
...
| [PageLayoutOptions](./pagelayoutoptions/) | Spécifie les drapeaux qui, avec d'autres options de PageSetup, déterminent les tailles et les mises en page des pages. Ces drapeaux peuvent être combinés en fonction de leurs descriptions. |
