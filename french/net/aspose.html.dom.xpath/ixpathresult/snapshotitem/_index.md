...
type: docs
weight: 90
url: /fr/net/aspose.html.dom.xpath/ixpathresult/snapshotitem/
---
...
| exception | condition |
| --- | --- |
| [DOMException](../../../aspose.html.dom/domexception/) | TYPE_ERR : déclenché si`type de résultat` n'est pas `UnorderedNodeSnapshotUnorderedNodeSnapshot` taper ou`OrderedNodeSnapshot` taper. |
