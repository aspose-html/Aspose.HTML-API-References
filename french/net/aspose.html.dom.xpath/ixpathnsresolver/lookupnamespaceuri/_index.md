...
description: Recherchez lURI despace de noms associé au préfixe despace de noms donné. Lévaluateur XPath ne doit jamais appeler ceci avec unnul ou un argument vide car le résultat de cette opération est indéfini.
type: docs
weight: 10
