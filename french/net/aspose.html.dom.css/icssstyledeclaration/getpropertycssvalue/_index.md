...
description: Utilisé pour récupérer la représentation objet de la valeur dune propriété CSS si elle a été explicitement définie dans ce bloc de déclaration. Cette méthode renvoie null si la propriété est une propriété abrégée. Les valeurs de propriété abrégées ne peuvent être consultées et modifiées que sous forme de chaînes à laide des méthodes getPropertyValue et setProperty.
type: docs
weight: 50
