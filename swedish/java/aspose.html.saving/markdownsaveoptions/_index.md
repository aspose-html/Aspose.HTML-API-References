...
description: "com.aspose.html.saving.MarkdownSaveOptions-klass. Representerar sparalternativ för Markdown. Till exempel kan du ställa in markdown-formateringsstil, använda fördefinierade GitLab Flavored Markdown‑kompatibla alternativ och konfigurera resurshantering. Se mer information i artikeln."
type: docs
...
| Namn | Beskrivning |
| --- | --- |
| statisk [getDefault](../../com.aspose.html.saving/markdownsaveoptions/default/) Returnerar en uppsättning alternativ som är kompatibla med standard‑Markdown‑dokumentation. |
...
...
	 // Förbered en sökväg för att spara den konverterade filen 
      ...
      // Anropa metoden ConvertHTML för att konvertera HTML till Markdown.
