...
Representerar MHTML-sparalternativ. Genom att tilldela specifika egenskaper kan du hantera resursbehandling såsom maximalt hanteringsdjup med mera. Mer information finns i dokumentationen [article](https://docs.aspose.com/html/net/converting-between-formats/html-to-mhtml/#save-options).
...
...
	 // Förbered HTML‑kod med en länk till en annan fil och spara den till filen som 'document.html'
      ...
      // Ändra värdet för resurssladdningsdjupet till 1 för att konvertera dokumentet med direkt länkade resurser
