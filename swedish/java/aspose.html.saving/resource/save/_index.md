...
description: "Resource-metod. Sparar resursen till den angivna strömmen."
type: docs
...
| undantag | villkor |
| --- | --- |
| InvalidOperationException | Uppstår om [`OutputUrl`](../outputurl/) är `null`. [`OutputUrl`](../outputurl/) bör specificeras innan resursen sparas eftersom det annars är omöjligt att ange rätt referens i resurserna som refererar till denna. |
