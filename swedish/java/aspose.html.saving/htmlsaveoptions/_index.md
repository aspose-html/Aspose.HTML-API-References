...
| Namn | Beskrivning |
| --- | --- |
| const [AUTO](../../com.aspose.html.saving/htmlsaveoptions/auto/) | Utgångsdokumenttypen kommer att väljas automatiskt. |
...
...
     // Förbered en utdataväg för ett HTML-dokument 
      ...
      using (var document = new HTMLDocument(documentPath))
      {
        ...
        // Följande rad med värdet '0' klipper av alla andra länkade HTML-filer när detta objekt sparas.
        // Om du tar bort den här raden eller ändrar värdet till '1' kommer filen 'linked.html' också att sparas till utskriftsmappen.
