...
| [DocDevice](docdevice/#constructor_4)(Stream) | Initierar en ny instans av klassen `DocDevice` via utskriftsström. |
| [DocDevice](docdevice/#constructor_5)(String) | Initierar en ny instans av klassen `DocDevice` via utskriftsfilnamn. |
| [DocDevice](docdevice/#constructor_1)(DocRenderingOptions, ICreateStreamProvider) | Initierar en ny instans av klassen `DocDevice` med renderingsalternativ och strömtjänst. |
| [DocDevice](docdevice/#constructor_2)(DocRenderingOptions, Stream) | Initierar en ny instans av klassen `DocDevice` med renderingsalternativ och utskriftsström. |
| [DocDevice](docdevice/#constructor_3)(DocRenderingOptions, String) | Initierar en ny instans av klassen `DocDevice` med renderingsalternativ och utskriftsfilnamn. |
...
| Namn | Beskrivning |
| --- | --- |
| [addRect](../../com.aspose.html.rendering.doc/docdevice/addrect/)(RectangleF) | Lägger till en rektangel till den aktuella vägen som en komplett underväg. |
...
| [clip](../../com.aspose.html.rendering.doc/docdevice/clip/)(FillRule) | Modifierar den aktuella beskärningsvägen genom att skära den med den aktuella vägen, med FillMode‑regeln för att bestämma området som ska fyllas. Denna metod avslutar den aktuella vägen. |
| [closePath](../../com.aspose.html.rendering.doc/docdevice/closepath/)() | Stänger den aktuella undervägen genom att lägga till ett rakt linjesegment från den aktuella punkten till startpunkten för undervägen. Om den aktuella undervägen redan är stängd gör "ClosePath" inget. Denna operator avslutar den aktuella undervägen. Att lägga till ett annat segment till den aktuella vägen startar en ny underväg, även om det nya segmentet börjar vid slutpunkten som nåddes av "ClosePath"‑metoden. |
| [cubicBezierTo](../../com.aspose.html.rendering.doc/docdevice/cubicbezierto/)(PointF, PointF, PointF) | Lägger till en kubisk Bézier‑kurva till den aktuella vägen. Kurvan sträcker sig från den aktuella punkten till punkten pt2, med pt1 och pt2 som Bézier‑kontrollpunkter. Den nya aktuella punkten är pt3. |
...
| [fill](../../com.aspose.html.rendering.doc/docdevice/fill/)(FillRule) | Fyller hela området som omsluts av den aktuella vägen. Om vägen består av flera frånkopplade delvägar, fyller den insidan av alla delvägar, betraktade tillsammans. Denna metod avslutar den aktuella vägen. |
...
| [moveTo](../../com.aspose.html.rendering.doc/docdevice/moveto/)(PointF) | Påbörjar en ny delväg genom att flytta den aktuella punkten till koordinaterna för parametern pt, utan att lägga till något anslutande linjesegment. Om den tidigare väggenereringsmetoden i den aktuella vägen också var \"MoveTo\", så ersätter den nya \"MoveTo\" den; ingen spår av den tidigare \"MoveTo\"-operationen finns kvar i vägen. |
