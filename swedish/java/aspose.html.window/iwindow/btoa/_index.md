...
description: "IWindow‑metod. Tar indata i form av en Unicode String som endast innehåller tecken i intervallet U0000 till U00FF, där varje tecken representerar en binär byte med värdena 0x00 till 0xFF, och konverterar den till dess base64‑representation som den returnerar."
type: docs
...
| --- | --- | --- |
| data | String | Unicode String som endast innehåller tecken i intervallet U+0000 till U+00FF. |
