...
description: "MarkdownSyntaxFactory metod. Skapar ListItemMarker"
type: docs

url: /sv/java/com.aspose.html.toolkit.markdown.syntax/markdownsyntaxfactory/listitemmarker/
---
## ListItemMarker(MarkdownSyntaxToken, MarkdownSyntaxToken) {#listitemmarker_1}

Skapar [`ListItemMarker`](../../listitemmarker/).
...
| --- | --- | --- |
| nummer | MarkdownSyntaxToken | Numret. |
| avgränsare | MarkdownSyntaxToken | Avgränsaren. |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| token | MarkdownSyntaxToken | Tokenet. |
