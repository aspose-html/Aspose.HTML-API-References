...
description: "MarkdownSyntaxFactory-metoden. Skapar AutoLinkSyntaxNode"
type: docs

url: /sv/java/com.aspose.html.toolkit.markdown.syntax/markdownsyntaxfactory/autolink/
---
## AutoLink(MarkdownSyntaxToken, TextSyntaxNode, MarkdownSyntaxToken) {#autolink}

Skapar [`AutoLinkSyntaxNode`](../../autolinksyntaxnode/).
...
| --- | --- | --- |
| opening | MarkdownSyntaxToken | Den MarkdownSyntaxToken. |
| content | TextSyntaxNode | Den TextSyntax. |
| closing | MarkdownSyntaxToken | Den MarkdownSyntaxToken. |
...
| content | TextSyntaxNode | Den TextSyntax. |
| closing | MarkdownSyntaxToken | Den MarkdownSyntaxToken. |
| e-post | Boolean | Den booleska flaggan. |
