...
description: "MarkdownSyntaxTree-metod. Definierar gränssnittet för att skapa trädföljaren"
type: docs

url: /sv/java/com.aspose.html.toolkit.markdown.syntax/markdownsyntaxtree/createtreewalker/
---
## CreateTreeWalker(MarkdownSyntaxNodeFilter) {#createtreewalker_2}

Definierar gränssnittet för att skapa tree walker.
...
| --- | --- | --- |
| filter | MarkdownSyntaxNodeFilter | Den MarkdownSyntaxNodeFilter. |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| rot | MarkdownSyntaxNode | Den MarkdownSyntaxNode. |
