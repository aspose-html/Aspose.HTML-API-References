...
TimeEvent‑gränssnittet tillhandahåller specifik kontextuell information som är associerad med tids‑händelser. De olika typerna av händelser som kan förekomma är: beginEvent, endEvent och repeatEvent.
