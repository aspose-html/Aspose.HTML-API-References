...
Representerar meddelandehanteraren för `http:`‑protokollet.
...
| Namn | Beskrivning |
| --- | --- |
| [HttpProtocolMessageHandler](httpprotocolmessagehandler/)() | Initierar en ny instans av klassen `HttpProtocolMessageHandler`. |
