...
description: "Converter‑metod. Konvertera SVG‑källa som presenteras av SVGDocument. Resultatet är utdata som bildas av en ICreateStreamProvider‑gränssnittsimplementation"
type: docs
...
Konvertera SVG‑källa som presenteras av [`SVGDocument`](../../../com.aspose.html.dom.svg/svgdocument/). Resultatet är utdata som bildas av [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) gränssnittsimplementation.
...
| options | XpsSaveOptions | [`XpsSaveOptions`](../../../com.aspose.html.saving/xpssaveoptions/)‑objektet möjliggör att du kan finjustera renderingsprocessen. För mer info se [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/svg-to-xps/#save-options). |
...
Konverteringskälla. Detektera en befintlig lokal SVG‑fil eller fjärr‑[`Url`](../../../com.aspose.html/url/) som konverteringskälla. Du kan också definiera [`SVGDocument`](../../../com.aspose.html.dom.svg/svgdocument/) som konverteringskälla eller till och med använda inbäddat SVG‑innehåll som presenteras av en String‑källa. Konverteringsresultat. Definiera resultatets utdatafilssökväg eller använd en känd eller anpassad [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) gränssnittsimplementation som utdata‑buffer. Skapa ett nytt [`XpsSaveOptions`](../../../com.aspose.html.saving/xpssaveoptions/)‑objekt med specifika eller standardinställningar. Du kan också lägga till [`configuration`](../../../com.aspose.html/configuration/) som ett alternativparameter. Använd ConvertSVG()-metoden i Converter‑klassen för att spara SVG som ett XPS‑resultat med tre eller fler parametrar beroende på användarscenario. Online SVG‑konverterare

Aspose.HTML erbjuder en gratis online [SVG to XPS Converter](https://products.aspose.app/svg/en/conversion/svg-to-xps) som konverterar SVG till XPS med hög kvalitet, enkelt och snabbt. Ladda bara upp, konvertera dina filer och få resultat på några sekunder!
...
Konvertera SVG‑källa som presenteras av [`URL`](../../../com.aspose.html/url/). Resultatet är utdata som bildas av [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) gränssnittsimplementation.
...
Konvertera SVG‑källa som presenteras av fullständig filsökväg till XPS. Resultatet är utdata som bildas av [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) gränssnittsimplementation.
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| sourcePath | String | Fullständig filsökväg för SVG‑källa. |
| options | XpsSaveOptions | [`XpsSaveOptions`](../../../com.aspose.html.saving/xpssaveoptions/) objektanvändning gör det möjligt att finjustera renderingsprocessen. |
| provider | ICreateStreamProvider | Implementering av [`interface`](../../../com.aspose.html.io/icreatestreamprovider/), som kommer att användas för att få en utström. |
...
Konvertera SVG-källa som presenteras av inline-innehåll till XPS. Resultatet är utdata som bildas av [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/) gränssnittsimplementation.
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| content | String | Sträng som inline‑svg‑innehåll. |
...
Konvertera SVG-källa som presenteras av [`SVGDocument`](../../../com.aspose.html.dom.svg/svgdocument/). Resultatet är en docx‑fil som skapas via utskriftsfilens sökväg.
...
| options | DocSaveOptions | `[`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/)`‑objektet möjliggör att du kan finjustera renderingsprocessen. För mer info se [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/svg-to-docx/#convert-svg-to-docx-using-docsaveoptions). |
...
Källkonvertering. Detektera en befintlig lokal SVG‑fil eller en fjärr‑[`Url`](../../../com.aspose.html/url/) som källfil. Du kan också definiera ett [`SVGDocument`](../../../com.aspose.html.dom.svg/svgdocument/) som källa eller till och med använda inline‑SVG‑innehåll som presenteras av en String‑källa. Resultat. Ange sökväg för utdatafilen eller använd en känd eller anpassad [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/)‑gränssnittsimplementation som utdata‑buffert. Skapa ett nytt [`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/)‑objekt med specifika eller standardinställningar. Du kan även lägga till [`configuration`](../../../com.aspose.html/configuration/) som alternativparameter. Använd ConvertSVG()-metoden i Converter‑klassen för att spara SVG som ett DOCX‑resultat med tre eller fler parametrar beroende på användarscenariot. Online‑SVG‑konverterare
...
Konvertera SVG‑källa som presenteras av [`URL`](../../../com.aspose.html/url/). Resultatet är en docx‑fil som skapas via utskriftsfilens sökväg.
...
Källkonvertering. Detektera en befintlig lokal SVG‑fil eller en fjärr‑[`Url`](../../../com.aspose.html/url/) som källa. Du kan också definiera ett [`SVGDocument`](../../../com.aspose.html.dom.svg/svgdocument/) som källa eller till och med använda inline‑SVG‑innehåll som presenteras av en String‑källa. Resultat. Ange sökväg för utdatafilen eller använd en känd eller anpassad [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/)‑gränssnittsimplementation som utdata‑buffert. Skapa ett nytt [`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/)‑objekt med specifika eller standardinställningar. Du kan även lägga till [`configuration`](../../../com.aspose.html/configuration/) som alternativparameter. Använd ConvertSVG()-metoden i Converter‑klassen för att spara SVG som ett DOCX‑resultat med tre eller fler parametrar beroende på användarscenariot. Online‑SVG‑konverterare
...
Konvertera SVG-källa som presenteras via fullständig filsökväg till DOCX. Resultatet är docx-fil som bildas av utdatafilens sökväg.
...
Konvertera SVG-källan som presenteras av inline-innehåll. Resultatet är en docx-fil som bildas av utdatans filsökväg.
...
Konvertera SVG‑källa som presenteras av [`SVGDocument`](../../../com.aspose.html.dom.svg/svgdocument/) till PDF. Resultatet är en pdf‑fil som skapas via utskriftsfilens sökväg.
...
| --- | --- | --- |
| source | SVGDocument | Konverteringskälla som presenteras av [`SVGDocument`](../../../com.aspose.html.dom.svg/svgdocument/). |
| options | PdfSaveOptions | `[`PdfSaveOptions`](../../../com.aspose.html.saving/pdfsaveoptions/)`‑objektet gör det möjligt att finjustera renderingsprocessen. För mer info, se [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/svg-to-pdf/#save-options). |
...
Källkonvertering. Detektera en befintlig lokal SVG‑fil eller en fjärr‑[`Url`](../../../com.aspose.html/url/) som källa. Du kan också definiera ett [`SVGDocument`](../../../com.aspose.html.dom.svg/svgdocument/) som källa eller till och med använda inline‑SVG‑innehåll som presenteras av en String‑källa. Resultat. Ange sökväg för utdatafilen eller använd en känd eller anpassad [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/)‑gränssnittsimplementation som utdata‑buffert. Skapa ett nytt [`PdfSaveOptions`](../../../com.aspose.html.saving/pdfsaveoptions/)‑objekt med specifika eller standardinställningar. Du kan även lägga till [`configuration`](../../../com.aspose.html/configuration/) som alternativparameter. Använd ConvertSVG()-metoden i Converter‑klassen för att spara SVG som ett PDF‑resultat med tre eller fler parametrar beroende på användarscenariot. Online‑SVG‑konverterare
...
Konvertera SVG‑källa som presenteras av [`URL`](../../../com.aspose.html/url/). Resultatet är en pdf‑fil som skapas via utskriftsfilens sökväg.
...
Konvertera SVG-källa som presenteras via fullständig filsökväg till PDF. Resultatet är pdf-fil som bildas av utdatafilens sökväg.
...
Konvertera SVG-källan som presenteras av inline-innehåll till PDF. Resultatet är en pdf-fil som bildas av utdatans filsökväg.
...
Konvertera SVG-källan som presenteras av [`SVGDocument`](../../../com.aspose.html.dom.svg/svgdocument/). Resultatet är en bildfil som bildas av utdatavägen.
...
Konvertera SVG-källan som presenteras av [`URL`](../../../com.aspose.html/url/). Resultatet är en bildfil som bildas av utdatavägen.
...
Konvertera SVG-källa som presenteras via fullständig filsökväg till bild. Resultatet är bildfil som bildas av utdatafilens sökväg.
...
Konvertera SVG-källan som presenteras av inline-innehåll till bild. Resultatet är en bildfil som bildas av utdatans filsökväg.
...
Konvertera SVG-källan som presenteras av [`SVGDocument`](../../../com.aspose.html.dom.svg/svgdocument/). Resultatet är en xps‑fil som bildas av utdatavägen.
...
Konvertera SVG-källan som presenteras av [`URL`](../../../com.aspose.html/url/). Resultatet är en xps‑fil som bildas av utdatavägen.
...
import com.aspose.html.converters;  
...
      // Skapa Url baserat på inmatningsfilens sökväg
      var sourceUrl = new Url(Path.Combine(InputFolder, "sample.svg"));
...
Konvertera SVG-källa som presenteras via fullständig filsökväg till XPS. Resultatet är xps-fil som bildas av utdatafilens sökväg.
...
Konvertera SVG-källan som presenteras av inline-innehåll till XPS. Resultatet är en xps-fil som bildas av utdatans filsökväg.
