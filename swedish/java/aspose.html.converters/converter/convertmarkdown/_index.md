...
description: "Converter‑metod. Konvertera MD‑markdown‑källa som presenteras via inmatningsström till HTML. Resultatet är HTMLDocument som kan sparas via utdataväg."
type: docs
...
Konvertera MD (markdown)‑källa som presenteras via inmatningsström till HTML. Resultatet är [`HTMLDocument`](../../../com.aspose.html/htmldocument/) som kan sparas via utdataväg.
...
Konverteringskälla. Detektera en befintlig lokal MD‑fil eller skapa en inmatningsdatastream som konverteringskälla. Konverteringsresultat. Du kan erhålla direkt [`HTMLDocument`](../../../com.aspose.html/htmldocument/) eller definiera resultatets utdataväg beroende på metodsignatur. Använd ConvertMarkdown()-metoden i Converter‑klassen för att spara MD som ett HTML‑resultat. Du kan även lägga till [`configuration`](../../../com.aspose.html/configuration/) som ett alternativparameter. Online‑MD‑konverterare

Du kan också vara intresserad av en gratis online [MD till HTML‑konverterare](https://products.aspose.app/html/en/conversion/md-to-html) som konverterar MD till HTML med hög kvalitet, enkelt och snabbt. Ladda bara upp, konvertera dina filer och få resultat på några sekunder! Du kan också titta på andra online‑MD‑konverterare: [MD till PDF](https://products.aspose.app/html/en/conversion/md-to-pdf), [MD till DOCX](https://products.aspose.app/html/en/conversion/md-to-docx), [MD till XPS](https://products.aspose.app/html/en/conversion/md-to-xps) och hitta lämpliga [MD till bild‑konverterare](https://docs.aspose.com/html/net/converting-between-formats/markdown-to-image/).
...
Konvertera MD (markdown)-källa som presenteras via inmatningsström till html. Resultatet är html-fil som bildas av utdatans filsökväg.
...
Konvertera MD (markdown)‑källa som presenteras via fullständig filsökväg till HTML. Resultatet är [`HTMLDocument`](../../../com.aspose.html/htmldocument/) som kan sparas via utdataväg.
...
Konvertera MD (markdown)-källa som presenteras via fullständig filsökväg till html. Resultatet är html-fil som bildas av utdatans filsökväg.
