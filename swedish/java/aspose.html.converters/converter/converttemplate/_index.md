...
description: "Converter‑metod. Slå samman mallkälla som presenteras av HTMLDocument med malldata XML JSON. Resultatet är en HTML‑fil som bildas av utdatavägen."
type: docs
...
Slå samman mallkälla som presenteras av [`HTMLDocument`](../../../com.aspose.html/htmldocument/) med malldata (XML, JSON). Resultatet är en HTML‑fil som bildas av utdatavägen.
...
| options | TemplateLoadOptions | [`TemplateLoadOptions`](../../../com.aspose.html.loading/templateloadoptions/) objektinstans. Den används för att avgöra om mall- och dataobjektnamnen matchar, oavsett om de är versala eller inte (alternativ). |
...
...
      ...
      // Formulärs xml (json) malldatafilssökväg
...
Sammanfoga mallens HTML‑källa som presenteras via [`URL`](../../../com.aspose.html/url/) med malldata (XML, JSON). Resultatet är en html‑fil som skapas enligt utdatafilens sökväg.
...
import com.aspose.html.converters;  
...
      // Formulärs skelett‑html‑käll‑URL
...
Sammanfoga mallens HTML-källa som presenteras av inline-innehåll med malldata (XML, JSON). Resultatet är en html-fil som bildas av utdatans filsökväg.
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| content | String | Sammanfogar HTML‑källskelett som presenteras via inbäddat String‑innehåll. |
| baseUrl | String | Bas-URI för html‑mallen. Den kommer att kombineras med den aktuella katalogens sökväg för att bilda en absolut URL. |
| data | TemplateData | Malldata för sammanslagning - ersättning (XML, JSON). |
| options | TemplateLoadOptions | [`TemplateLoadOptions`](../../../com.aspose.html.loading/templateloadoptions/) objektinstans. Den används för att avgöra om mall- och dataobjektnamnen matchar, oavsett om de är versala eller inte (alternativ). |
| outputPath | String | Fullständig HTML‑filväg som utdata för konverteringsresultat. |
...
import com.aspose.html.converters;  
...
	  // Formulär inbäddat källinnehåll som mall
      ...
      // Formulärs utdata som sammanfogningsresultat 
...
Slå samman mallkällan som presenteras av [`HTMLDocument`](../../../com.aspose.html/htmldocument/) med malldata (XML, JSON). Resultatet är ett nytt bildat HTMLDocument som kan sparas som fil.
...
Ny skapad [`HTMLDocument`](../../../com.aspose.html/htmldocument/) som konverteringsresultat som kan sparas via utdataväg.
...
Slå samman mall‑HTML‑källan som presenteras av [`URL`](../../../com.aspose.html/url/) med malldata (XML, JSON). Resultatet är ett nytt bildat [`HTMLDocument`](../../../com.aspose.html/htmldocument/) som kan sparas som fil.
...
Slå samman mall‑HTML‑källan som presenteras av fullständig filsökväg med malldata (XML, JSON). Resultatet är ett nytt bildat [`HTMLDocument`](../../../com.aspose.html/htmldocument/) som kan sparas som fil.
...
Slå samman mall‑HTML‑källan som presenteras av inbäddat innehåll med malldata (XML, JSON). Resultatet är ett nytt bildat [`HTMLDocument`](../../../com.aspose.html/htmldocument/) som kan sparas som fil.
