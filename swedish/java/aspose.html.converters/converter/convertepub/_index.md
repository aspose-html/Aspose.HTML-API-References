...
description: "Converter‑metod. Konvertera EPUB‑källa som presenteras av dataingångsström. Resultatet är en fil som bildas av utdatafilens sökväg."
type: docs
...
Konvertera EPUB-källa som presenteras med dataindataström. Resultatet är en fil som bildas av utdatafilens sökväg.
...
| --- | --- | --- |
| ström | Stream | Ingångsström som konverteringskälla. |
...
Definiera URL baserat på befintlig EPUB‑fil på den angivna sökvägen. Definiera resultatets utdatafilssökväg. Skapa ett nytt [`ImageSaveOptions`](../../../com.aspose.html.saving/imagesaveoptions/)‑objekt med erforderligt ImageFormat. Som standard är egenskapen Format PNG. Använd ConvertEPUB()-metoden i Converter‑klassen för att spara EPUB som en bild. Du måste också skicka ImageSaveOptions och Configuration‑objektet till bildkonverteringen. Online EPUB‑konverterare

Aspose.HTML erbjuder en gratis online‑konverterare [EPUB till PNG](https://products.aspose.app/html/en/conversion/epub-to-png) som konverterar EPUB till PNG‑bild med hög kvalitet, enkelt och snabbt. Ladda bara upp, konvertera dina filer och få resultat på några sekunder!
...
Konvertera EPUB-källa som presenteras via fullständig filsökväg. Resultatet är en bildfil som bildas av utdatafilens sökväg. Bildformatet specificeras av ImageSaveOptions-objektet.
...
| options | ImageSaveOptions | Användning av ImageSaveOptions‑objektet gör att du kan finjustera renderingsprocessen. Du kan specificera [`page size`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/), [`margins`](../../../com.aspose.html.drawing/page/margin/), [`CSS media-type`](../../../com.aspose.html.rendering/mediatype/), etc. |
| outputPath | String | Fullständig bildfilssökväg som utdata för konverteringsresultatet. |
...
// Skapa utdataresultatets filsökväg
var resultPath = Path.Combine(OutputFolder, "sample.png"); 

// Definiera standardinstans för ImageSaveOptions‑objektet
var options = new ImageSaveOptions(); 
...
Konvertera EPUB-källa definierad av URL. Resultatet är en bildfil som bildas av utdatafilens sökväg. Bildformatet specificeras av ImageSaveOptions-objektet.
...
| options | ImageSaveOptions | Användning av ImageSaveOptions‑objektet gör det möjligt att finjustera renderingsprocessen. Du kan ange [`page size`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/), [`margins`](../../../com.aspose.html.drawing/page/margin/), [`CSS media-type`](../../../com.aspose.html.rendering/mediatype/) osv. Se [`ImageSaveOptions `](../../../com.aspose.html.saving/imagesaveoptions/)klassen. |
| outputPath | String | Fullständig bildfilssökväg som utdata för konverteringsresultatet. |
...
Konvertera EPUB-källa som presenteras via dataindataström. Resultatet är en bildfil som bildas av utdatafilens sökväg. Bildformatet specificeras av ImageSaveOptions-objektet.
...
// Initiera konverteringsprocessen med standardkonfigurationsobjekt
...
| --- | --- | --- |
| sourcePath | String | EPUB‑källfilens sökväg som inparameter. |
| configuration | Configuration | Miljökonfigurationen. Representerar [configuration](https://apireference.aspose.com/html/net/aspose.html/configuration)-kontextobjektet som används för att ställa in miljöinställningarna för applikationen. |
| options | ImageSaveOptions | Användning av ImageSaveOptions‑objektet gör det möjligt att finjustera renderingsprocessen. Du kan ange [`page size`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/), [`margins`](../../../com.aspose.html.drawing/page/margin/), [`CSS media-type`](../../../com.aspose.html.rendering/mediatype/) osv. Se [`ImageSaveOptions `](../../../com.aspose.html.saving/imagesaveoptions/)klassen. |
| outputPath | String | Fullständig bildfilssökväg som utdata för konverteringsresultatet. |
...
| sourceUrl | Url | EPUB‑käll‑URL – tillhandahåller en objektrepresentation av en universell identifierare (URL). |
| configuration | Configuration | Miljökonfigurationen. Representerar [`configuration`](../../../com.aspose.html/configuration/) kontextobjektet som används för att ställa in miljöinställningarna för applikationen. |
| options | ImageSaveOptions | Användning av ImageSaveOptions‑objektet gör det möjligt att finjustera renderingsprocessen. Du kan ange [page size](https://apireference.aspose.com/html/net/aspose.html.rendering/renderingoptions/properties/pagesetup), [margins](https://apireference.aspose.com/html/net/aspose.html.drawing/page/properties/margin), [CSS media-type](https://apireference.aspose.com/html/net/aspose.html.rendering/mediatype) osv. Se [ImageSaveOptions ](https://apireference.aspose.com/html/net/aspose.html.saving/imagesaveoptions)klassen. |
| outputPath | String | Fullständig bildfilssökväg som utdata för konverteringsresultatet. |
...
Konvertera EPUB‑källan som presenteras av filsökväg till bild. Resultatet är en bildfil som skapas av implementeringen av [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/)‑gränssnittet.
...
| options | ImageSaveOptions | Nya bildalternativ som format, upplösning osv. Se [`ImageSaveOptions `](../../../com.aspose.html.saving/imagesaveoptions/)klassen och [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-png/#save-options). |
| provider | ICreateStreamProvider | Implementering av gränssnittet, som kommer att användas för att få en utström. Mer information om leverantörer finns i [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-jpg/#output-stream-providers). |
...
Öppna en befintlig EPUB‑fil. I exemplet använder vi OpenRead()-metoden i System.IO.FileStream‑klassen för att öppna och läsa en EPUB‑fil från filsystemet på den angivna sökvägen. Använd en känd eller anpassad ICreateStreamProvider‑gränssnittsimplementation som utdata‑databuffert. Skapa ett nytt ImageSaveOptions‑objekt med erforderligt ImageFormat. Som standard är Format‑egenskapen PNG. Använd ConvertEPUB()-metoden i Converter‑klassen för att spara EPUB som en bild. Du måste skicka EPUB‑inputStream, ImageSaveOptions och utströmmen till ConvertEPUB()-metoden för konvertering från EPUB till bild. Online EPUB‑konverterare
...
// Anropa ConvertEPUB‑metoden för att konvertera EPUB‑koden till JPG‑bild
...
Konvertera EPUB‑källan som presenteras via URL till bild. Resultatet är en bildfil som skapas av implementeringen av [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/)‑gränssnittet.
...
| configuration | Configuration | Miljökonfigurationen. Representerar [`configuration`](../../../com.aspose.html/configuration/) kontextobjektet som används för att ställa in miljöinställningarna för applikationen. |
| options | ImageSaveOptions | Användning av ImageSaveOptions‑objektet gör att du kan finjustera renderingsprocessen. Du kan specificera [`page size`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/), [`margins`](../../../com.aspose.html.drawing/page/margin/), [`CSS media-type`](../../../com.aspose.html.rendering/mediatype/), etc. |
| leverantör | ICreateStreamProvider | Implementering av gränssnittet som kommer att användas för att få en utdata‑ström. |
...
Konvertera EPUB‑källan som presenteras via filsökväg till bild. Resultatet är en bildfil som skapas av implementeringen av [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/)‑gränssnittet.
...
| configuration | Configuration | Miljökonfigurationen. Representerar [`configuration`](../../../com.aspose.html/configuration/) kontextobjektet som används för att ställa in miljöinställningarna för applikationen. |
| options | ImageSaveOptions | Användning av ImageSaveOptions‑objektet gör att du kan finjustera renderingsprocessen. Du kan specificera [`page size`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/), [`margins`](../../../com.aspose.html.drawing/page/margin/), [`CSS media-type`](../../../com.aspose.html.rendering/mediatype/), etc. |
| provider | ICreateStreamProvider | Implementering av gränssnittet som kommer att användas för att få en utdata‑ström. Se exempel på ICreateStreamProvider‑implementering i [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-jpg/#output-stream-providers). |
...
Konvertera epub-källa som presenteras via inmatningsström till xps. Resultatet är xps-fil definierad av fullständig sökväg.
...
| options | XpsSaveOptions | Konverteringsalternativ. Användning av objektet [`XpsSaveOptions`](../../../com.aspose.html.saving/xpssaveoptions/) gör det möjligt att finjustera renderingsprocessen; du kan ange sidstorlek, marginaler, CSS osv. |
| outputPath | String | Fullständig .xps‑filväg som utdata för konverteringsresultatet. |
...
Detta avsnitt ger information om listan över stödda EPUB‑konverteringsscenarier och hur man utför dem med hjälp av klassen [`Converter`](../) som samlar alla låg‑nivå konverteringsoperationer i en enda klass för att göra dem bekväma och enkla att använda. I den specifika guiden för EPUB‑konverterare XPS hittar du följande artikel:
...
Öppna en befintlig EPUB‑fil. Till exempel kan vi ange källfilens sökväg som den första parametern till ConvertEPUB‑metoden. Använd en känd eller anpassad implementation av ICreateStreamProvider‑gränssnittet som utdata‑buffert. Vi kan använda ett enklare alternativ som resultat‑utdatafilens sökväg. Skapa ett nytt XpsSaveOptions‑objekt med önskade parametrar såsom sidstorlek, marginaler, CSS osv. Det är möjligt att använda standardinstansen av XpsSaveOptions‑klassen. Använd ConvertEPUB()‑metoden i den statiska Converter‑klassen för att spara EPUB som en xps‑fil. Du måste skicka EPUB‑källan, XpsSaveOptions och utdata‑bufferten i någon form för att initiera konverteringsprocessen. Online EPUB till XPS‑konverterare

Aspose.HTML erbjuder en gratis online‑konverterare [EPUB to XPS](https://products.aspose.app/html/en/conversion/epub-to-xps) som konverterar EPUB till XPS‑fil med hög kvalitet, enkelt och snabbt. Ladda bara upp, konvertera dina filer och få resultat på några sekunder!
...
Konvertera epub-källa som presenteras via inmatnings-EPUB-filsökväg till xps. Resultatet är en xps-fil definierad av fullständig sökväg.
...
| --- | --- | --- |
| sourcePath | String | EPUB‑källfilens sökväg. Den kommer att kombineras med den aktuella katalogens sökväg för att bilda en absolut URL. |
| options | XpsSaveOptions | Konverteringsalternativ. Användning av objektet [`XpsSaveOptions`](../../../com.aspose.html.saving/xpssaveoptions/) gör det möjligt att finjustera renderingsprocessen; du kan ange [`page size`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/), [`margins`](../../../com.aspose.html.drawing/page/margin/), [`CSS media type`](../../../com.aspose.html.rendering/mediatype/) osv. |
| outputPath | String | Fullständig .xps‑filväg som utdata för konverteringsresultatet. |
...
Konvertera epub-källa som presenteras via URL till xps-fil definierad av fullständig sökväg. Se [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-xps/).
...
Öppna en befintlig EPUB‑fil. Som exempel kan vi definiera källfilens sökväg som den första parametern till metoden ConvertEPUB. Använd en känd eller anpassad ICreateStreamProvider‑gränssnittimplementation som utdata‑buffert. Vi kan använda ett enklare alternativ som resultat‑utdatafilens sökväg. Skapa ett nytt XpsSaveOptions‑objekt med ett antal föredragna parametrar såsom sidstorlek, marginaler, CSS osv. Det är möjligt att använda standardinstansen av klassen XpsSaveOptions. Använd ConvertEPUB()-metoden i den statiska klassen Converter för att spara EPUB som en xps‑fil. Du måste skicka EPUB‑källan, XpsSaveOptions och utdata‑bufferten i någon form för att initiera konverteringsprocessen.
...
Konvertera epub-källa som presenteras via inmatnings-[Stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream?view=net-5.0) till xps. Resultatet är en xps-fil definierad av fullständig sökväg.
...
Öppna en befintlig EPUB‑fil. Som exempel kan vi definiera källfilens sökväg som den första parametern till metoden ConvertEPUB. Använd en känd eller anpassad ICreateStreamProvider‑gränssnittimplementation som utdata‑buffert. Vi kan använda ett enklare alternativ som resultat‑utdatafilens sökväg. Skapa ett nytt XpsSaveOptions‑objekt med ett antal föredragna parametrar såsom sidstorlek, marginaler, CSS osv. Det är möjligt att använda standardinstansen av klassen XpsSaveOptions. Använd ConvertEPUB()-metoden i den statiska klassen Converter för att spara EPUB som en xps‑fil. Du måste skicka EPUB‑källan, XpsSaveOptions och utdata‑bufferten i någon form för att initiera konverteringsprocessen. Du kan använda konfiguration som representerar [`configuration`](../../../com.aspose.html/configuration/) kontextobjektet som används för att ställa in miljöinställningarna för applikationen. Online EPUB till XPS‑konverterare
...
...
 ...
 // Konvertera EPUB till XPS genom att använda klassen MemoryStreamProvider
...
Konvertera EPUB-källfil som anges med fullständig sökväg till DOCX. Resultatet är en docx-fil som definieras av fullständig sökväg.
...
| options | DocSaveOptions | Konverteringsalternativ. [`DocSaveOptions `](../../../com.aspose.html.saving/docsaveoptions/)objektanvändning möjliggör att du kan finjustera renderingsprocessen; du kan specificera [`page size`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/), [`margins`](../../../com.aspose.html.drawing/page/margin/), [`CSS media-type`](../../../com.aspose.html.rendering/mediatype/), osv. Se [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-docx/#save-options). |
| outputPath | String | Fullständig .docx‑filväg som utdata för konverteringsresultatet. |

## Anmärkningar

Hur man konverterar EPUB till DOCX

DOCX är ett välkänt format för Microsoft Word‑dokument. Detta format är populärt eftersom det stöder ett brett spektrum av formateringsfunktioner och erbjuder användare en mängd olika alternativ för att skriva vilken typ av dokument som helst. DOCX‑filer kan öppnas med Word 2007 och senare versioner men inte med de äldre versionerna av MS Word, som bara stödjer DOC‑filändelser. EPUB‑till‑DOCX‑konvertering krävs ofta för att dra nytta av DOCX‑formatet för specifika användaruppgifter.
...
Öppna en befintlig EPUB‑fil. Till exempel kan vi definiera källfilens sökväg som den första parametern till metoden ConvertEPUB. Använd en känd eller anpassad implementation av gränssnittet ICreateStreamProvider som utdata‑buffer. Vi kan också använda ett enklare alternativ som resultat‑utdatafilväg. Skapa ett nytt DocSaveOptions‑objekt med ett antal föredragna parametrar som sidstorlek, marginaler, CSS osv. Det är möjligt att använda standardinstansen av DocSaveOptions‑klassen. Använd ConvertEPUB()-metoden i den statiska Converter‑klassen för att spara EPUB som en docx‑fil. Du måste skicka EPUB‑källan som filväg eller inmatningsström samt Url, en DocSaveOptions‑instans och utdata‑buffer i någon form för att initiera konverteringsprocessen. Du kan använda en konfiguration som representerar [`configuration`](../../../com.aspose.html/configuration/)‑kontextobjektet som används för att ställa in miljöinställningarna för applikationen. Online‑EPUB‑till‑DOCX‑konverterare
...
Konvertera EPUB-källa som presenteras via fullständig filsökväg till DOCX. Resultatet är docx-fil bildad av utdatafilens sökväg.
...
Konvertera EPUB-källa som presenteras via URL. Resultatet är en docx-fil som bildas av utdatafilens sökväg.
...
| --- | --- | --- |
| sourceUrl | Url | EPUB‑käll‑URL – tillhandahåller en objektrepresentation av en universell identifierare (URL). |
| options | DocSaveOptions | [`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/)‑användning möjliggör att du kan finjustera renderingsprocessen; du kan specificera [`page size`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/), [`margins`](../../../com.aspose.html.drawing/page/margin/), [`resolutions`](../../../com.aspose.html.rendering.image/imagerenderingoptions/), [`CSS media-type`](../../../com.aspose.html.rendering/mediatype/), osv. Se [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-docx/#save-options). |
| outputPath | String | Fullständig .docx‑filväg som utdata för konverteringsresultatet. |
...
Konvertera EPUB-källa som presenteras via dataindataström. Resultatet är en docx-fil som bildas av utdatafilens sökväg.
...
| sourcePath | String | EPUB‑källfilens sökväg. Den kommer att kombineras med den aktuella katalogens sökväg för att bilda en absolut URL. |
| configuration | Configuration | Miljökonfigurationen. Representerar [`configuration`](../../../com.aspose.html/configuration/) kontextobjektet som används för att ställa in miljöinställningarna för applikationen. |
| options | DocSaveOptions | Konverteringsalternativ. [DocSaveOptions ](https://apireference.aspose.com/html/net/aspose.html.saving/docsaveoptions)objektanvändning möjliggör att du kan finjustera renderingsprocessen; du kan specificera sidstorlek, marginaler, CSS osv. Se [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-docx/#save-options). |
| outputPath | String | Fullständig .docx‑filväg som utdata för konverteringsresultatet. |
...
// Filväg för konverteringsresultatet
var resultPath = Path.Combine(OutputFolder, "sample.docx");
...
Konvertera EPUB-källa som inmatningsström till DOCX. Resultatet är en docx-fil som bildas av ICreateStreamProvider-implementation.
...
| ström | Stream | Ingångsström som konverteringskälla. |
| options | DocSaveOptions | Konverteringsalternativ. [`DocSaveOptions `](../../../com.aspose.html.saving/docsaveoptions/)objektanvändning möjliggör att du kan finjustera renderingsprocessen; du kan specificera [`page size`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/), [`margins`](../../../com.aspose.html.drawing/page/margin/), [`CSS media-type`](../../../com.aspose.html.rendering/mediatype/), osv. Se [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-docx/#save-options). |
| provider | ICreateStreamProvider | Implementation av [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/)‑gränssnittet, som kommer att användas för att få en utström. Se avancerat exempel i [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-docx/#output-stream-providers). |
...
Konvertera EPUB‑källa som anges med fullständig filväg till DOCX. Resultatet är utdata som bildas av en implementation av [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/).
...
Konvertera EPUB-källa som presenteras via URL. Resultatet är utdata skapad av ICreateStreamProvider-gränssnittsimplementation.
...
| --- | --- | --- |
| sourceUrl | Url | EPUB‑käll‑URL – tillhandahåller en objektrepresentation av en universell identifierare (URL). |
| options | DocSaveOptions | [`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/)‑användning möjliggör att du kan finjustera renderingsprocessen; du kan specificera sidstorlek, marginaler, upplösningar, CSS osv. Se [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-docx/#save-options). |
| provider | ICreateStreamProvider | Implementation av [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/)‑gränssnittet, som kommer att användas för att få en utström. Se avancerat exempel i [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-docx/#output-stream-providers). |
...
Konvertera EPUB-källa som presenteras via dataindataström. Resultatet är utdata skapad av ICreateStreamProvider-gränssnittsimplementation.
...
Öppna en befintlig EPUB‑fil. Till exempel kan vi definiera källfilens sökväg som den första parametern till metoden ConvertEPUB. Använd en känd eller anpassad implementation av ICreateStreamProvider‑gränssnittet som utdata‑buffer. Vi kan också använda ett enklare alternativ som resultat‑utdatafilväg. Skapa ett nytt [`DocSaveOptions`](../../../com.aspose.html.saving/docsaveoptions/)‑objekt med ett antal föredragna parametrar som sidstorlek, marginaler, CSS osv. Det är möjligt att använda standardinstansen av DocSaveOptions‑klassen. Använd ConvertEPUB()-metoden i den statiska Converter‑klassen för att spara EPUB som en docx‑fil. Du måste skicka EPUB‑källan som filväg eller inmatningsström samt Url, en DocSaveOptions‑instans och utdata‑buffer i någon form för att initiera konverteringsprocessen. Du kan använda en konfiguration som representerar [`configuration`](../../../com.aspose.html/configuration/)‑kontextobjektet som används för att ställa in miljöinställningarna för applikationen. Online‑EPUB‑till‑DOCX‑konverterare
...
Konvertera EPUB‑källa som anges med fullständig filväg till DOCX. Resultatet är utdata som bildas av en implementation av [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/)‑gränssnittet.
...
Konvertera EPUB‑källa som anges med URL. Resultatet är utdata som bildas av en implementation av [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/)‑gränssnittet.
...
Konvertera EPUB-källa som presenteras med dataindataström. Resultatet är en pdf-fil som bildas av utdatafilens sökväg.
...
| options | PdfSaveOptions | Konverteringsalternativ. [`PdfSaveOption`](../../../com.aspose.html.saving/pdfsaveoptions/) objektanvändning möjliggör att du kan finjustera renderingsprocessen; du kan specificera [`page size`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/), [`margins`](../../../com.aspose.html.drawing/page/margin/), [`CSS media-type`](../../../com.aspose.html.rendering/mediatype/), osv. Se [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-pdf/#save-options). |
...
EPUB är ett e‑bokfilformat som tillhandahåller ett standardiserat digitalt publiceringsformat. Det skapades av International Digital Publishing Forum ([IDPF](http://idpf.org/)) och stöds nu av många e‑läsare och programvaror. EPUB‑till‑PDF‑konvertering krävs ofta för att utnyttja PDF‑formatet. PDF‑filformatet har full förmåga att innehålla information såsom text, bilder, hyperlänkar, formulärfält, rik media, metadata osv. PDF‑filer kan öppnas i Adobe Acrobat Reader/Writer och de flesta moderna webbläsare som Chrome, Safari, Firefox. De är optimerade för utskrift och är idealiska för att skapa fysiska kopior av dina dokument; du kan också konfigurera säkerhetsinställningarna för PDF.

Huvudattraktionen i Aspose.HTML är konverteringsfunktionen. EPUB är ett öppet XML‑baserat format för digitala böcker och publikationer, som kan visas och läsas på smartphones, surfplattor och datorer. Paketet com.aspose.html.converters implementerar enkel åtkomst till konverteringsmetoder. Det erbjuder ett brett utbud av [EPUB](https://docs.fileformat.com/ebook/epub/)‑konverteringar till populära format, såsom [PDF](https://docs.fileformat.com/pdf/), [XPS](https://docs.fileformat.com/page-description-language/xps/), [DOCX](https://docs.fileformat.com/word-processing/docx/), [JPEG](https://docs.fileformat.com/image/jpeg/), [PNG](https://docs.fileformat.com/image/png/), [BMP](https://docs.fileformat.com/image/bmp/), [TIFF](https://docs.fileformat.com/image/tiff/) och [GIF](https://docs.fileformat.com/image/gif/).

Detta avsnitt ger information om listan över stödjade EPUB-konverteringsscenarier och hur man utför dem med hjälp av en [`Converter`](../)-klass som samlar alla låg‑nivå konverteringsoperationer i en enda klass för att göra dem bekväma och enkla att använda. I den specifika guiden för EPUB‑konverterare till PDF hittar du följande artikel:
...
Öppna en befintlig EPUB‑fil. Till exempel kan vi definiera källfilens sökväg som den första parametern till metoden ConvertEPUB. Som alternativ kan vi använda en inmatningsström eller ett Url‑objekt. Använd en känd eller anpassad ICreateStreamProvider‑gränssnittimplementation som utdata‑buffer. Vi kan också använda ett enklare alternativ som resultat‑utdatafilens sökväg. Skapa ett nytt PdfSaveOptions‑objekt med ett antal föredragna parametrar såsom sidstorlek, marginaler, CSS osv. Det är möjligt att använda standardinstansen av PdfSaveOptions‑klassen. Använd ConvertEPUB()-metoden i den statiska Converter‑klassen för att spara EPUB som en pdf‑fil. Du måste skicka EPUB‑källan som filsökväg eller inmatningsström samt Url, PdfSaveOptions‑instans och utdata‑buffer i någon form för att initiera konverteringsprocessen. Du kan använda configuration som representerar [`configuration`](../../../com.aspose.html/configuration/) kontextobjektet som används för att ställa in miljöinställningarna för applikationen. Online EPUB till PDF‑konverterare
...
Konvertera EPUB-källa som presenteras via fullständig filsökväg till PDF. Resultatet är en pdf-fil som bildas av utdatafilens sökväg.
...
Öppna en befintlig EPUB‑fil. Till exempel kan vi definiera källfilens sökväg som den första parametern till metoden ConvertEPUB. Som alternativ kan vi använda en inmatningsström eller ett Url‑objekt. Använd en känd eller anpassad ICreateStreamProvider‑gränssnittimplementation som utdata‑buffer. Vi kan också använda ett enklare alternativ som resultat‑utdatafilens sökväg. Skapa ett nytt [`PdfSaveOptions`](../../../com.aspose.html.saving/pdfsaveoptions/)‑objekt med ett antal föredragna parametrar såsom sidstorlek, marginaler, CSS osv. Det är möjligt att använda standardinstansen av PdfSaveOptions‑klassen. Använd ConvertEPUB()-metoden i den statiska Converter‑klassen för att spara EPUB som en pdf‑fil. Du måste skicka EPUB‑källan som filsökväg eller inmatningsström samt Url, PdfSaveOptions‑instans och utdata‑buffer i någon form för att initiera konverteringsprocessen. Du kan använda configuration som representerar [`configuration`](../../../com.aspose.html/configuration/) kontextobjektet som används för att ställa in miljöinställningarna för applikationen. Online EPUB till PDF‑konverterare
...
Konvertera EPUB-källa som presenteras via URL. Resultatet är en pdf-fil som bildas av utdatafilens sökväg.
...
| --- | --- | --- |
| sourceUrl | Url | EPUB‑käll‑URL – tillhandahåller en objektrepresentation av en universell identifierare (URL). |
| options | PdfSaveOptions | Användning av [`PdfSaveOptions`](../../../com.aspose.html.saving/pdfsaveoptions/) gör det möjligt att finjustera renderingsprocessen; du kan ange [`page size`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/), [`margins`](../../../com.aspose.html.drawing/page/margin/), [`file permissions`](../../../com.aspose.html.rendering.pdf.encryption/pdfencryptioninfo/), [`CSS media-type`](../../../com.aspose.html.rendering/mediatype/) osv. Se [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-pdf/#save-options). |
| outputPath | String | Fullständig .pdf‑filväg som utdata för konverteringsresultatet. |
...
Konvertera EPUB‑källa som presenteras via datainmatningsström. Resultatet är utdata som bildas av [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/)‑gränssnittimplementation.
...
Konvertera EPUB‑källa som presenteras via fullständig filsökväg till PDF. Resultatet är utdata som bildas av [`ICreateStreamProvider`](../../../com.aspose.html.io/icreatestreamprovider/)‑gränssnittimplementation.
...
| sourceUrl | Url | EPUB‑käll‑URL – tillhandahåller en objektrepresentation av en universell identifierare (URL). |
| options | PdfSaveOptions | Användning av [`PdfSaveOptions`](../../../com.aspose.html.saving/pdfsaveoptions/) gör det möjligt att finjustera renderingsprocessen; du kan ange [`page size`](../../../com.aspose.html.rendering/renderingoptions/pagesetup/), [`margins`](../../../com.aspose.html.drawing/page/margin/), [`file permissions`](../../../com.aspose.html.rendering.pdf.encryption/pdfencryptioninfo/), [`CSS media-type`](../../../com.aspose.html.rendering/mediatype/) osv. Se [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-pdf/#save-options). |
| provider | ICreateStreamProvider | Implementering av [ICreateStreamProvider](https://apireference.aspose.com/svg/net/aspose.svg.io/icreatestreamprovider)‑gränssnittet, som kommer att användas för att få en utström. Se avancerat exempel i [Aspose Documentation](https://docs.aspose.com/html/net/converting-between-formats/epub-to-pdf/#output-stream-providers). |
...
Konvertera EPUB-källa som presenteras via fullständig filsökväg till PDF. Resultatet är utdata skapad av ICreateStreamProvider-gränssnittsimplementation.
