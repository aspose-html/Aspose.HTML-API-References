...
description: "ICSSStyleSheet-metod. CSSStyleSheet.insertRule‑metoden infogar en ny CSS‑regel i det aktuella stilarket med vissa begränsningar."
type: docs
...
Metoden CSSStyleSheet.insertRule() infogar en ny CSS‑regel i den aktuella formatmallen, med vissa begränsningar.

Obs: Även om insertRule() är enbart en metod för [`CSSStyleSheet`](../) så infogar den faktiskt regeln i CSSStyleSheet.cssRules — dess interna [`CSSRuleList`](../../icssrulelist/).
...
Den nyinfogade regelns index i stilarkets regellista.
