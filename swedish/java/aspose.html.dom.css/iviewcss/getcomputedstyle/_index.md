...
Metoden IViewCSS.getComputedStyle() returnerar ett objekt som innehåller värdena för alla CSS‑egenskaper hos ett element, efter att ha tillämpat aktiva stilark och löst eventuella grundläggande beräkningar som dessa värden kan innehålla.
...
| --- | --- | --- |
| element | Element | Den [`Element`](../../../com.aspose.html.dom/element/) som den beräknade stilen ska hämtas för. Denna parameter får inte vara null. |
...
| undantag | villkor |
| --- | --- |
| TypeError | Om det överförda objektet inte är ett Element eller pseudoElt inte är en giltig pseudo‑element‑väljare. |
...
| --- | --- | --- |
| element | Element | Den [`Element`](../../../com.aspose.html.dom/element/) som den beräknade stilen ska hämtas för. Denna parameter får inte vara null. |
| pseudoElement | String | En sträng som specificerar pseudo‑elementet att matcha. Utelämnad (eller null) för riktiga element. |
