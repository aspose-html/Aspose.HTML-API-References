...
| [getItem](../../com.aspose.html.dom.css/cssvaluelist/item/) item()-metoden för CSSValueList‑gränssnittet används för att hämta ett CSSValue efter ordningsindex. |
| [getLength](../../com.aspose.html.dom.css/cssvaluelist/length/) length‑egenskapen (skrivskyddad) för CSSValueList‑gränssnittet representerar antalet CSSValues i listan. Intervallet för giltiga indexvärden är 0 till length‑1 inklusive. |
...
| [getPlatformType](../../com.aspose.html.dom.css/cssvaluelist/getplatformtype/)() | Denna metod används för att hämta ECMAScript‑objekttyp. |
