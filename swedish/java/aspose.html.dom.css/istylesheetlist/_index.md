...
description: "com.aspose.html.dom.css.IStyleSheetList‑gränssnitt. StyleSheetList‑gränssnittet representerar en lista av CSSStyleSheet‑objekt. En instans av detta objekt kan returneras via Document.styleSheets."
type: docs
...
StyleSheetList‑gränssnittet representerar en lista av [`CSSStyleSheet`](../icssstylesheet/)‑objekt. En instans av detta objekt kan returneras via [`Document.styleSheets`](../../com.aspose.html.dom/document/stylesheets/).
...
| [getLength](../../com.aspose.html.dom.css/istylesheetlist/length/) length‑attributet måste returnera antalet CSS‑stilark som representeras av samlingen. Intervallet för giltiga underordnade stilarksindex är 0 till length‑1 inklusive. |
