...
| --- | --- | --- |
| propertyName | String | propertyName är en String som representerar egenskapsnamnet som ska tas bort. Observera att flervordiga egenskapsnamn skrivs med bindestreck och inte i camelCase. |
