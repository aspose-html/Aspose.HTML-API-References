...
| Namn | Beskrivning |
| --- | --- |
| [getItem](../../com.aspose.html.dom.css/icssrulelist/item/) Används för att hämta en CSS‑regel med metoden item() (http://www.w3.org/TR/DOM-Level-2-Style/css.html#CSS-CSSRuleList). Ordningen i denna samling representerar ordningen av reglerna i CSS‑stilarbladet. Om index är större än eller lika med antalet regler i listan, returneras null. |
| [getLength](../../com.aspose.html.dom.css/icssrulelist/length/) Längd‑egenskapen för `CSSRuleList`‑gränssnittet returnerar antalet [`CSSRule`](../icssrule/)‑objekt i listan. |
