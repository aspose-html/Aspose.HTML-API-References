...
description: "com.aspose.html.dom.css.CSSValue‑klass. Representerar ett enkelt eller ett komplext värde. Ett CSSValue‑objekt förekommer endast i ett sammanhang av en CSS‑egenskap."
type: docs
...
| Namn | Beskrivning |
| --- | --- |
| abstract [CSSText](../../com.aspose.html.dom.css/cssvalue/csstext/) { get; set; } | cssText‑egenskapen för `CSSValue`‑gränssnittet representerar det aktuella beräknade CSS‑egenskapsvärdet. |
