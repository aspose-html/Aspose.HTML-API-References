...
none - Förhindrar auditiv rendering så att elementet inte kräver någon tid för att renderas. Observera dock att underordnade kan åsidosätta detta värde och kommer att uttalas. (För att säkert förhindra rendering av ett element och dess underordnade, använd ['display'](https://www.w3.org/TR/1998/REC-CSS2-19980512/visuren.html#propdef-display)‑egenskapen).normal - Använder språkberoende uttalsregler för rendering av ett element och dess barn.spell-out - Stavade texten bokstav för bokstav (användbart för akronymer och förkortningar).
