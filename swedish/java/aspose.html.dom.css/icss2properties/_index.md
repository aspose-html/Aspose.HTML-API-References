---
title: "ICSS2Properties-gränssnitt"
second_title: "Aspose.HTML för Java API-referens"
description: "com.aspose.html.dom.css.ICSS2Properties gränssnitt. CSS2Properties-gränssnittet representerar en bekvämlighetsmekanism för att hämta och sätta egenskaper i ett CSSStyleDeclaration. Attributen i detta gränssnitt motsvarar alla egenskaper som specificeras i CSS2. Att hämta ett attribut i detta gränssnitt är ekvivalent med att anropa getPropertyValue‑metoden i CSSStyleDeclaration‑gränssnittet. Att sätta ett attribut i detta gränssnitt är ekvivalent med att anropa setProperty‑metoden i CSSStyleDeclaration‑gränssnittet."
type: docs

url: /sv/java/com.aspose.html.dom.css/icss2properties/
---
## ICSS2Properties interface

CSS2Properties-gränssnittet representerar en bekvämlighetsmekanism för att hämta och sätta egenskaper i ett [`CSSStyleDeclaration`](../icssstyledeclaration/). Attributen i detta gränssnitt motsvarar alla egenskaper som specificeras i CSS2. Att hämta ett attribut i detta gränssnitt är ekvivalent med att anropa getPropertyValue‑metoden i [`CSSStyleDeclaration`](../icssstyledeclaration/)-gränssnittet. Att sätta ett attribut i detta gränssnitt är ekvivalent med att anropa setProperty‑metoden i [`CSSStyleDeclaration`](../icssstyledeclaration/)-gränssnittet.
