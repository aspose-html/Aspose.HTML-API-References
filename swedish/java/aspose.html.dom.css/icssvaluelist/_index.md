...
| Namn | Beskrivning |
| --- | --- |
| [getItem](../../com.aspose.html.dom.css/icssvaluelist/item/) Denna metod används för att hämta ett CSSValue med ett ordinalt index. Ordningen i denna samling representerar ordningen av värdena i CSS‑stilegenskapen. Om index är större än eller lika med antalet värden i listan returneras null. |
| [getLength](../../com.aspose.html.dom.css/icssvaluelist/length/) Längd‑egenskapen, som är skrivskyddad, i CSSValueList‑gränssnittet representerar antalet CSSValues i listan. Giltigt intervall för index är 0 till length‑1 inklusive. |
...
det otippade [CSS Object Model](https://drafts.csswg.org/cssom/), brett stöd, eller det moderna [CSS Typed Object Model API](https://drafts.css-houdini.org/css-typed-om/#stylevalue-objects), mindre stöd och anses vara experimentellt.
