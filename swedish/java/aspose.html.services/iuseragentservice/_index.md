---
title: "IUserAgentService-gränssnitt"
second_title: "Aspose.HTML för Java API-referens"
description: "com.aspose.html.services.IUserAgentService-gränssnitt. Ett gränssnitt som beskriver en användaragentsmiljö."
type: docs

url: /sv/java/com.aspose.html.services/iuseragentservice/
---
## IUserAgentService interface

Ett gränssnitt som beskriver en användaragentmiljö.
...
| [getFontsSettings](../../com.aspose.html.services/iuseragentservice/fontssettings/) Hämtar ett [`FontsSettings`](../../com.aspose.html/fontssettings/)-objekt som används för konfiguration av teckensnittshantering. |
[getLanguage]
