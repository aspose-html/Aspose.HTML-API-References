...
description: "Url‑konstruktor. Initierar en ny instans av Url med den angivna URL‑en"
type: docs

url: /sv/java/com.aspose.html/url/url/
---
...
| undantag | villkor |
| --- | --- |
| Fel | TypeError: kastas om `url` inte kan parsas som en giltig URL. |
...
| undantag | villkor |
| --- | --- |
| Fel | TypeError: kastas om `url` eller `baseUrl` inte kan parsas som en giltig URL. |
