...
description: "Uint8ClampedArray-konstruktor. Initierar en ny instans av Uint8ClampedArray-klassen"
type: docs

url: /sv/java/com.aspose.html/uint8clampedarray/uint8clampedarray/
---
## Uint8ClampedArray(int) {#constructor_4}

Initierar en ny instans av [`Uint8ClampedArray`](../)-klassen.
...
| --- | --- | --- |
| längd | Int32 | Längden (antal element). |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| buffer | ArrayBuffer | Databufferten. |
...
| --- | --- | --- |
| buffer | ArrayBuffer | Databufferten. |
| byteOffset | Int32 | Byte‑offseten. |
