...
Formulärkontroll. Beroende på den miljö där sidan visas kan värde‑egenskapen vara skrivskyddad för filuppladdnings‑input‑typen. För input‑typen "password" kan det faktiska värdet maskeras för att förhindra obehörig användning. Se definitionen för elementet INPUT i [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224)]. Se även [Document object Model (DOM) Level 2 HTML Specification](http://www.w3.org/TR/2003/REC-DOM-Level-2-HTML-20030109).
...
| [getFiles](../../com.aspose.html/htmlinputelement/files/) Fil‑IDL‑attributet tillåter skript att komma åt elementets valda filer. Vid hämtning, om IDL‑attributet gäller, måste det returnera ett FileList‑objekt som representerar de för närvarande valda filerna. Samma objekt måste returneras tills listan över valda filer ändras. Om IDL‑attributet inte gäller, måste det istället returnera null. [FILEAPI] |
