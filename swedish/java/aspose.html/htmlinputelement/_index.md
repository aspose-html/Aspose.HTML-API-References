---
title: "HTMLInputElement klass"
second_title: "Aspose.HTML för Java API-referens"
description: "com.aspose.html.HTMLInputElement klass. Formulärkontroll. Beroende på den miljö där sidan visas kan värdeegenskapen vara skrivskyddad för filuppladdningstypen. För lösenordstypen kan det faktiska värdet maskeras för att förhindra obehörig användning. Se INPUT-elementdefinitionen i HTML 4.01. Se även Document object Model DOM Level 2 HTML Specification."
type: docs

url: /sv/java/com.aspose.html/htmlinputelement/
---
## HTMLInputElement class

Formulärkontroll. Beroende på den miljö där sidan visas kan värde‑egenskapen vara skrivskyddad för filuppladdnings‑inmatningstypen. För inmatningstypen "password" kan det faktiska värdet maskeras för att förhindra obehörig användning. Se definitionen för INPUT‑elementet i [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224)]. Se även [Document object Model (DOM) Level 2 HTML Specification](http://www.w3.org/TR/2003/REC-DOM-Level-2-HTML-20030109).
...
| [getFiles](../../com.aspose.html/htmlinputelement/files/) IDL-attributet files låter skript komma åt elementets valda filer. Vid hämtning, om IDL-attributet gäller, måste det returnera ett FileList-objekt som representerar de för närvarande valda filerna. Samma objekt måste returneras tills listan över valda filer ändras. Om IDL-attributet inte gäller, måste det i stället returnera null. [FILEAPI] |
...
import (var document = new HTMLDocument(inputHtmlPath))
{
	...
	// Inmatningselement för efternamn
