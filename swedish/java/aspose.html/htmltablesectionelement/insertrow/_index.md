...
description: "HTMLTableSectionElement metod. Infoga en rad i detta avsnitt. Den nya raden infogas omedelbart före den aktuella indexth raden i detta avsnitt. Om index är -1 eller lika med antalet rader i detta avsnitt läggs den nya raden till i slutet"
type: docs
...
| --- | --- | --- |
| index | Int32 | Radnumret där en ny rad ska infogas. Detta index börjar på 0 och är endast relativt till raderna som finns i detta avsnitt, inte alla rader i tabellen. |
