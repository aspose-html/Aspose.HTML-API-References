...
description: "HTMLTableSectionElement method. Ta bort en rad från detta avsnitt"
type: docs
...
| --- | --- | --- |
| index | Int32 | Indexet för raden som ska tas bort, eller -1 för att ta bort den sista raden. Detta index startar från 0 och är endast relativt till raderna som finns i detta avsnitt, inte alla rader i tabellen. |
