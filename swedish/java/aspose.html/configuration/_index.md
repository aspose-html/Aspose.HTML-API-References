...
description: "com.aspose.html.Configuration-klass. Representerar kontextobjektet för konfiguration som används för att ställa in miljöinställningarna för applikationen. Genom att hantera konfiguration kan du åsidosätta dokumentstilen genom att tillämpa ett anpassat användarstilmall eller hantera alla webbförfrågningar från applikationen samt konfigurera skriptpolicy. Detaljer finns i guiden för miljökonfiguration."
type: docs
...
Representerar konfigurationskontextobjektet som används för att ställa in miljöinställningarna för applikationen. Genom att hantera konfiguration kan du åsidosätta dokumentstil genom att tillämpa ett anpassat användar‑stylesheet, eller hantera webbförfrågningar från applikationen samt konfigurera skriptpolicy. Detaljer finns i [Environment Configuration guide](https://docs.aspose.com/html/net/working-with-documents/environment-configuration/).
...
import com.aspose.html.services;
    ...
    // Denna meddelandehanterare skriver ut ett meddelande om start och avslut av begärans bearbetning
