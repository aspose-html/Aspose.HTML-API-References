...
| --- | --- | --- |
| konfiguration | Konfiguration | Miljökonfigurationen såsom skriptpolicy, anpassad användarstylesheet, osv. |
...
Följande exempel visar hur man använder konfigurationsobjektet för att inaktivera skript:
...
Laddar HTML‑dokumentet från en URL.
...
{
	// Skriv dokumentets innehåll till utdataströmmen
...
Laddar HTML‑dokumentet från en URL med angivna miljökonfigurationsinställningar.
...
Laddar HTML‑dokumentet från en adress.
...
Laddar HTML‑dokumentet från en adress med angivna miljökonfigurationsinställningar.
...
Skapar ett HTML‑dokument från en String‑innehåll med angiven bas‑uri.
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| innehåll | String | String-innehållet att ladda dokumentet med. |
...
Skapar ett HTML‑dokument från en String‑innehåll med angiven bas‑uri och miljökonfigurationsinställningar.
...
Skapar ett HTML‑dokument från ett [Stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream)-innehåll med angiven bas‑uri som används för att lösa den relativa resurssökvägen.
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| content | Stream | Det [Stream](https://docs.microsoft.com/en-us/dotnet/api/system.io.stream) innehållet för att ladda dokumentet med. |
| baseUri | String | Dokumentets bas-URI. |
...
import (var sw = new StreamWriter(mem))
{
	...
	// Det är viktigt att ställa in positionen till början eftersom HTMLDocument börjar läsa exakt från den aktuella positionen i strömmen.
	sw.Flush();
...
Skapar ett HTML‑dokument från objektet [`RequestMessage`](../../../com.aspose.html.net/requestmessage/).
...
Vänligen besök vår [docs site](https://docs.aspose.com/html/net/message-handlers/) för att se fler scenarier för hur man använder den här konstruktorn.
