...
description: "ICanvasRenderingContext2D‑metod. Ritar konturer av en given text på den angivna x‑ och y‑positionen."
type: docs
...
Ritar (konturerar) en given text vid den angivna (x, y)-positionen.
