...
description: "ICanvasRenderingContext2D metod. Rapporterar huruvida den angivna punkten finns i den aktuella banan."
type: docs

url: /sv/java/com.aspose.html.dom.canvas/icanvasrenderingcontext2d/ispointinpath/
---
## IsPointInPath(double, double) {#ispointinpath_2}

Rapporterar om den angivna punkten finns i den aktuella vägen eller inte.
...
| --- | --- | --- |
| x | Double | X‑koordinaten för den punkt som ska kontrolleras. |
| y | Double | Y‑koordinaten för den punkt som ska kontrolleras. |

### Returvärde

Returnerar true om punkten ligger inom området som definieras av fyllningen av en bana, annars false.
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| path | Path2D | En Path2D‑bana att kontrollera. |
| x | Double | X‑koordinaten för den punkt som ska kontrolleras. |
| y | Double | Y‑koordinaten för den punkt som ska kontrolleras. |
