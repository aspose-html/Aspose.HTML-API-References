...
description: "ICanvasRenderingContext2D-metod. Målar data från det angivna ImageData-objektet på bitmapen. Om en smutsig rektangel tillhandahålls målas endast pixlarna från den rektangeln. Denna metod påverkas inte av canvasens transformationsmatris."
type: docs
...
Målar data från det angivna ImageData-objektet på bitmapen. Om en smutsig rektangel anges målas endast pixlarna från den rektangeln. Denna metod påverkas inte av canvas transformationsmatris.
