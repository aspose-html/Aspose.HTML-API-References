...
description: "Renderer-metod. Definierar en metod för att rendera TDocument till angivet IDevice"
type: docs
...
Definierar en metod för att rendera !:TDocument till angivet [`IDevice`](../../idevice/). Renderingen kommer att utföras när det inte finns några nätverksoperationer för att ladda resurser, aktiva timers, animationsuppgifter eller när den angivna tidsgränsen har löpt ut.
...
| enhet | IDevice | Utmatningsenheten. |
| dokument | TSource | Dokumentet. |
| timeout | Int32 | Ett antal millisekunder som representerar antalet millisekunder att vänta, eller -1 millisekund för att vänta obegränsat. |
