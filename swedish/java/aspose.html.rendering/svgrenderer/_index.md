...
| [render](../../com.aspose.html.rendering/svgrenderer/render/#render_6)(IDevice, TimeSpan, params SVGDocument[]) | Definierar en metod för att rendera flera [`SVGDocument`](../../com.aspose.html.dom.svg/svgdocument/)s till en specifik [`IDevice`](../idevice/). Renderingen kommer att utföras när det inte finns några nätverksoperationer för att ladda resurser, aktiva timers, animation tasks eller när den angivna tidsgränsen har löpt ut. |
