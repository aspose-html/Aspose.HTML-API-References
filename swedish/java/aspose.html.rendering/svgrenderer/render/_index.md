...
description: "SvgRenderer-metod. Definierar metod för rendering av flera SVGDocuments till en specifik IDevice. Rendering kommer att utföras när det inte finns några nätverksoperationer för att ladda resurser, aktiva timers, animationsuppgifter eller när angiven timeout har löpt ut."
type: docs
...
Definierar metod för rendering av flera [`SVGDocument`](../../../com.aspose.html.dom.svg/svgdocument/)s till en specifik [`IDevice`](../../idevice/). Rendering kommer att utföras när det inte finns några nätverksoperationer för att ladda resurser, aktiva timers, animationsuppgifter eller när angiven timeout har löpt ut.
