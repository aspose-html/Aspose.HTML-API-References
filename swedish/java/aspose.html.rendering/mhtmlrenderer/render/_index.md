...
description: "MhtmlRenderer-metod. Renderar flera MHTML-dokument till angivet IDevice. Renderingen kommer att utföras när det inte finns några nätverksoperationer för att ladda resurser, aktiva timers, animation tasks eller när den angivna tidsgränsen har löpt ut."
type: docs
...
Renderar flera MHTML-dokument till angivet [`IDevice`](../../idevice/). Renderingen kommer att utföras när det inte finns några nätverksoperationer för att ladda resurser, aktiva timers, animation tasks eller när den angivna tidsgränsen har löpt ut.
...
Renderar MHTML-dokument till angiven [`IDevice`](../../idevice/). Renderingen kommer att utföras när det inte finns några nätverksoperationer för att ladda resurser, aktiva timers, animationsuppgifter eller när den angivna tidsgränsen har löpt ut.
