...
Representerar en basklass för implementering av specifika renderingsenheter.
...
| Namn | Beskrivning |
| --- | --- |
| [addRect](../../com.aspose.html.rendering/device-2/addrect/)(RectangleF) | Lägger till en rektangel till den aktuella vägen som en komplett underväg. |
...
| [clip](../../com.aspose.html.rendering/device-2/clip/)(FillRule) | Modifierar den aktuella beskärningsbanan genom att skära den med den aktuella banan, med hjälp av FillRule för att bestämma området som ska fyllas. Denna metod avslutar den aktuella banan. |
| [closePath](../../com.aspose.html.rendering/device-2/closepath/)() | Stänger den aktuella undervägen genom att lägga till ett rakt linjesegment från den aktuella punkten till startpunkten för undervägen. Om den aktuella undervägen redan är stängd gör "ClosePath" inget. Denna operator avslutar den aktuella undervägen. Att lägga till ett annat segment till den aktuella vägen startar en ny underväg, även om det nya segmentet börjar vid slutpunkten som nåddes av "ClosePath"‑metoden. |
| [cubicBezierTo](../../com.aspose.html.rendering/device-2/cubicbezierto/)(PointF, PointF, PointF) | Lägger till en kubisk Bézier‑kurva till den aktuella vägen. Kurvan sträcker sig från den aktuella punkten till punkten pt2, med pt1 och pt2 som Bézier‑kontrollpunkter. Den nya aktuella punkten är pt3. |
...
| [fill](../../com.aspose.html.rendering/device-2/fill/)(FillRule) | Fyller hela området som omsluts av den aktuella vägen. Om vägen består av flera frånkopplade delvägar, fyller den insidan av alla delvägar, betraktade tillsammans. Denna metod avslutar den aktuella vägen. |
...
| enum [PageWritingStrategy&lt;TGraphicContext,TRenderingOptions&gt;](../../com.aspose.html.rendering/device-2.pagewritingstrategy-2) | Anger typer av strategier för att skriva sidor till output stream\streams. |
