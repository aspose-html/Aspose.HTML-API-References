...
description: "Color‑konstruktor. Initierar en ny instans av Color‑klassen. Som standard är färgen svart."
type: docs

url: /sv/java/com.aspose.html.drawing/color/color/
---
## Color() {#constructor}
...
| grön | Single | Den gröna komponenten i färgen. |
| blå | Single | Den blå komponenten i färgen. |
| alfa | Single | Den alfa-komponenten i färgen. |
...
| grön | Int32 | Den gröna komponenten i färgen. |
| blå | Int32 | Den blå komponenten i färgen. |
| alfa | Int32 | Den alfa-komponenten i färgen. |
