...
description: "Color-metod. Returnerar en ny Color med de begärda röd, grön, blå och alfa-värdena. Alla färgkomponenter måste vara i intervallet 0-255."
type: docs

url: /sv/java/com.aspose.html.drawing/color/fromrgba/
---
## FromRgba(byte, byte, byte, byte) {#fromrgba}

Returnerar en ny Color med de begärda ged-, grön-, blå- och alfa-värdena. Alla färgkomponenter måste ligga i intervallet 0-255.
...
Returnerar en ny Color med de begärda ged-, grön-, blå- och alfa-värdena. Alla färgkomponenter måste ligga i intervallet 0-1.
