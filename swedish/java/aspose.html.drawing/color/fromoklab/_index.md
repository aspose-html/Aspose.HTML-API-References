...
description: "Color‑metod. Returnerar en ny Color med de begärda ljusstyrke‑ A‑ B‑värdena för OKLAB‑modellen."
type: docs

url: /sv/java/com.aspose.html.drawing/color/fromoklab/
---
## Color.FromOklab method

Returnerar en ny Color med den begärda ljusheten, A, B värden för OKLAB-modellen.
