...
description: "Color-metod. Returnerar en ny Color med de begärda ljusstyrke‑A‑B‑alfavärdena för OKLAB-modellen"
type: docs

url: /sv/java/com.aspose.html.drawing/color/fromoklaba/
---
## Color.FromOklaba method

Returnerar en ny Color med den efterfrågade ljusheten, A, B, alfa‑värden för OKLAB‑modellen.
