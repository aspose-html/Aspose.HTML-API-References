...
description: "Color-metod. Returnerar en ny Color med de begärda röd, gröna och blå värdena. Alla färgkomponenter måste ligga i intervallet 0-255."
type: docs

url: /sv/java/com.aspose.html.drawing/color/fromrgb/
---
## FromRgb(byte, byte, byte) {#fromrgb}

Returnerar en ny Color med de efterfrågade röd, grön, blå‑värdena. Alla färgkomponenter måste vara i intervallet 0‑255.
...
Returnerar en ny Color med de efterfrågade röd, grön, blå‑värdena. Alla färgkomponenter måste vara i intervallet 0‑1.
