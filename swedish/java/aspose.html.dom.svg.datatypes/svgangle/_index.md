...
Det SVGAngle‑gränssnittet motsvarar den grundläggande datatypen vinkel.
...
| Namn | Beskrivning |
| --- | --- |
| [getUnitType](../../com.aspose.html.dom.svg.datatypes/svgangle/unittype/) Typen av värdet som specificeras av en av SVG_ANGLETYPE_*‑konstanterna som definieras i detta gränssnitt. |
[getValue]
