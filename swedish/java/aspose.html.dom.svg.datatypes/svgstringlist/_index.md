---
title: "SVGStringList klass"
second_title: "Aspose.HTML för Java API-referens"
description: "com.aspose.html.dom.svg.datatypes.SVGStringList class. SVGStringList har samma attribut och metoder som andra SVGxxxList‑gränssnitt. Implementatörer kan överväga att använda en enda basklass för att implementera de olika SVGxxxList‑gränssnitten"
type: docs

url: /sv/java/com.aspose.html.dom.svg.datatypes/svgStringlist/
---
## SVGStringList class

SVGStringList har samma attribut och metoder som andra SVGxxxList‑gränssnitt. Implementatörer kan överväga att använda en enda basklass för att implementera de olika SVGxxxList‑gränssnitten.
...
| Namn | Beskrivning |
| --- | --- |
| [SVGStringList](svgStringlist/#constructor)() | Initierar en ny instans av klassen `SVGStringList`. |
| [SVGStringList](svgStringlist/#constructor_1)(IEnumerable&lt;String&gt;) | Initierar en ny instans av klassen `SVGStringList`. |
...
| [toString](../../com.aspose.html.dom.svg.datatypes/svgStringlist/toString/)() | Returnerar en sträng som representerar detta objekt. |
