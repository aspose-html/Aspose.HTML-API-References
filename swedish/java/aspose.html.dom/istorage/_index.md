...
description: "com.aspose.html.dom.IStorage‑gränssnitt. Detta gränssnitt i Web Storage‑API:t ger åtkomst till en specifik domäns session‑ eller lokala lagring. Se Web Storage‑specifikationen https//html.spec.whatwg.org/multipage/webstorage.htmlwebstorage"
type: docs
...
Detta gränssnitt i Web Storage‑API:et ger åtkomst till en specifik domäns session‑ eller lokala lagring. Se Web Storage‑specifikationen: [https://html.spec.whatwg.org/multipage/webstorage.html#webstorage](https://html.spec.whatwg.org/multipage/webstorage.html#webstorage)
