...
DOMException-gränssnittet representerar en onormal händelse (kallad ett undantag) som uppstår som ett resultat av att anropa en metod eller komma åt en egenskap i ett web‑API. Detta är i princip hur felvillkor beskrivs i web‑API:er.
...
| [getMessage](../../com.aspose.html.dom/domexception/message/) Returnerar en String som representerar ett meddelande eller en beskrivning som är associerad med det givna felnamnet. |
| [getName](../../com.aspose.html.dom/domexception/name/) Returnerar en String som innehåller en av de Strängar som är associerade med ett felnamn. |
...
| const [HIERARCHY_REQUEST_ERR](../../com.aspose.html.dom/domexception/hierarchy_request_err/) | Om någon Nod infogas någonstans där den inte hör hemma. |
...
| const [NOT_SUPPORTED_ERR](../../com.aspose.html.dom/domexception/not_supported_err/) | Om implementationen inte stödjer den begärda typen av objekt eller operation. |
...
| const [TIMEOUT_ERR](../../com.aspose.html.dom/domexception/timeout_err/) | Operationen tidsgränsen löpte ut. |
...
| const [VALIDATION_ERR](../../com.aspose.html.dom/domexception/validation_err/) | Om ett anrop till en metod som insertBefore eller removeChild skulle göra Node ogiltig med avseende på \"partial validity\", skulle detta undantag kastas och operationen skulle inte utföras. Denna kod används i [DOM Level 3 Validation]. Se denna specifikation för ytterligare information. |
