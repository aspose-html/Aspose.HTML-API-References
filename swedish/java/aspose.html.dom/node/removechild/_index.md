...
Obs: Så länge en referens hålls till den borttagna barnet, finns det fortfarande i minnet, men är inte längre en del av DOM. Det kan fortfarande återanvändas senare i koden. Om returvärdet från removeChild() inte lagras och ingen annan referens hålls, kommer det automatiskt att tas bort från minnet efter en kort stund.
