...
description: "Node‑metod. Metoden insertBefore i Node‑gränssnittet infogar en nod före en referensnod som ett barn till en angiven föräldranod."
type: docs
...
Om den angivna noden redan finns i dokumentet, flyttar insertBefore() den från sin nuvarande position till den nya positionen. (Det vill säga, den tas automatiskt bort från sin befintliga förälder innan den läggs till i den angivna nya föräldern.)
