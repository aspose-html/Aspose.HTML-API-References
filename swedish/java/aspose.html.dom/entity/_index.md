...
| [getInputEncoding](../../com.aspose.html.dom/entity/inputencoding/) Ett attribut som specificerar kodningen som används för denna entitet vid parsning, när den är en extern parsad entitet. Detta är null om det är en entitet från den interna delmängden eller om den inte är känd. |
...
| [getNotationName](../../com.aspose.html.dom/entity/notationname/) För oparsade entiteter, namnet på notationen för entiteten. För parsade entiteter är detta null. |
