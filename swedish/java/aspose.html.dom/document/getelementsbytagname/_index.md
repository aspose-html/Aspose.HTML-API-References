...
description: "Document‑metod. Metoden getElementsByTagName i Document‑gränssnittet returnerar en HTMLCollection av element med det angivna taggnamnet."
type: docs
...
| --- | --- | --- |
| taggnamn | String | En String som representerar namnet på elementen. Den speciella String‑värdet "*" representerar alla element. |
...
Stycke stylat av klassnamn =kkk fff=
