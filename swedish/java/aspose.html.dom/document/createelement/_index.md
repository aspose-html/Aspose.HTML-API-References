...
| --- | --- | --- |
| localName | String | En sträng som specificerar vilken typ av element som ska skapas. nodeName för det skapade elementet initieras med värdet av tagName. Använd inte kvalificerade namn (t.ex. "html:a") med denna metod. När den anropas på ett HTML‑dokument konverterar createElement() tagName till gemener innan elementet skapas. |
