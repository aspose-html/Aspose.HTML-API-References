...
description: "Document‑metod. getElementsByClassName‑metoden i Document‑gränssnittet returnerar ett array‑liknande objekt av alla barn‑element som har alla de angivna klassnamnen."
type: docs
...
Den getElementsByClassName‑metoden i [`Document`](../)‑gränssnittet returnerar ett array‑liknande objekt av alla barn‑element som har alla de angivna klassnamnen.

När den anropas på dokumentobjektet söks hela dokumentet, inklusive rot‑noden. Du kan också anropa getElementsByClassName() på vilket element som helst; den kommer endast att returnera element som är underordnade det angivna rot‑elementet med de givna klassnamnen.
...
Praktiskt webbutvecklingsinnehåll kan hittas i [w3schools](https://www.w3schools.com/jsref/met_element_getelementsbyclassname.asp).
