...
description: "Document‑metod. Utvärderar en XPath‑uttrycksssträng och returnerar ett resultat av den angivna typen om möjligt"
type: docs
...
| resolver | IXPathNSResolver | Resolvern tillåter översättning av alla prefix, inklusive xml‑paketprefixet, inom XPath‑uttrycket till lämpliga paket‑URI:er. |
