...
description: "Document‑metod. Returnerar en lista med element med det angivna taggnamnet som tillhör det angivna paketet. Hela dokumentet söks inklusive rot‑noden."
type: docs
...
Returnerar en lista med element med det angivna taggnamnet som tillhör det angivna paketet. Hela dokumentet genomsöks, inklusive rotnoden.
...
| localName | String | Antingen det lokala namnet på elementen att söka efter eller det speciella värdet *, som matchar alla element. |

### Returvärde

En levande [`NodeList`](../../../com.aspose.html.collections/nodelist/) (men se noteringen nedan) av hittade element i den ordning de visas i trädet.
