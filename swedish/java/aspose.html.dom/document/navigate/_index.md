...
| baseUri | String | Bas‑URI för att lösa relativa resurser. Den kombineras med den aktuella katalogvägen för att bilda en absolut URL. |
...
Laddar dokumentet baserat på det angivna begäran‑objektet och ersätter det tidigare innehållet.
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| begäran | RequestMessage | Begärande‑objektet som används för att ladda dokumentinnehåll. |
