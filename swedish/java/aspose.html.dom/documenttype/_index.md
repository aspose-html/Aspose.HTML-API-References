...
description: "com.aspose.html.dom.DocumentType klass. DocumentType tillhandahåller ett gränssnitt till listan över entiteter som är definierade för dokumentet."
type: docs
...
| Namn | Beskrivning |
| --- | --- |
| [DocumentType](documenttype/)(String, String, String, String, Document) | Initierar en ny instans av klassen `DocumentType`. |
...
| [getInternalSubset](../../com.aspose.html.dom/documenttype/internalsubset/) Det interna delmängden som en sträng, eller null om den saknas. |
...
| [getName](../../com.aspose.html.dom/documenttype/name/) Namnet på DTD; det vill säga namnet som omedelbart följer efter DOCTYPE-nyckelordet. |
