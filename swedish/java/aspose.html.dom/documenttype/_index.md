...
description: "com.aspose.html.dom.DocumentType klass. DocumentType tillhandahåller ett gränssnitt till listan över enheter som är definierade för dokumentet."
type: docs

url: /sv/java/com.aspose.html.dom/documenttype/
---
## DocumentType class
...
| Namn | Beskrivning |
| --- | --- |
| [DocumentType](documenttype/)(String, String, String, String, Document) | Initierar en ny instans av `DocumentType`-klassen. |
...
| [getInternalSubset](../../com.aspose.html.dom/documenttype/internalsubset/) Det interna delmängden som en String, eller null om det inte finns någon. |
...
| [getName](../../com.aspose.html.dom/documenttype/name/) Namnet på DTD; d.v.s. namnet som omedelbart följer DOCTYPE-nyckelordet. |
...
| [getNodeName](../../com.aspose.html.dom/documenttype/nodename/) Namnet på denna nod, beroende på dess typ. |
| [getNodeType](../../com.aspose.html.dom/documenttype/nodetype/) En kod som representerar typen av det underliggande objektet. |
...
| [getPublicId](../../com.aspose.html.dom/documenttype/publicid/) Den offentliga identifieraren för den externa delmängden. |
| [getSystemId](../../com.aspose.html.dom/documenttype/systemid/) Systemidentifieraren för den externa delmängden. Detta kan vara en absolut URI eller inte. |
...
| [toString](../../com.aspose.html.dom/documenttype/toString/)() | Returnerar en sträng som representerar detta objekt. |
