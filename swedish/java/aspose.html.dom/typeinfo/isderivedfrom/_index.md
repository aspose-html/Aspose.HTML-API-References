...
description: "TypeInfo-metod. Denna metod returnerar om det finns en härledning mellan referenstypdefinitionen, d.v.s. den TypeInfo som metoden anropas på, och den andra typdefinitionen, d.v.s. den som skickas som parameter"
type: docs
...
Denna metod returnerar om det finns en derivation mellan referenstypdefinitionen, dvs. TypeInfo som metoden anropas på, och den andra typdefinitionen, dvs. den som skickas som parameter.
