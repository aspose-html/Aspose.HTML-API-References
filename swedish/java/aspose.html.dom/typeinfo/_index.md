...
| [getTypeNamespace](../../com.aspose.html.dom/typeinfo/typepackage/) Hämtar typens paket. Paketet för den typ som deklarerats för det associerade elementet eller attributet, eller null om elementet saknar deklaration eller om ingen paketinformation är tillgänglig. |
...
| [isDerivedFrom](../../com.aspose.html.dom/typeinfo/isderivedfrom/)(String, String, ulong) | Denna metod returnerar om det finns en härledning mellan referenstypdefinitionen, d.v.s. TypeInfo som metoden anropas på, och den andra typdefinitionen, d.v.s. den som skickas som parameter. |

## Fält

| Namn | Beskrivning |
| --- | --- |
| const [DERIVATION_EXTENSION](../../com.aspose.html.dom/typeinfo/derivation_extension/) | Om dokumentets schema är ett XML-schema [XML Schema Part 1] representerar denna konstant härledningen genom extension. |
...
| const [DERIVATION_RESTRICTION](../../com.aspose.html.dom/typeinfo/derivation_restriction/) | Om dokumentets schema är ett XML-schema [XML Schema Part 1] representerar denna konstant härledningen genom restriktion om komplexa typer är inblandade, eller en restriktion om enkla typer är inblandade. |
