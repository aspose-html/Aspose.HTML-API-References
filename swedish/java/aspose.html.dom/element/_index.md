...
| Namn | Beskrivning |
| --- | --- |
| [Element](element/)(QualifiedName, Document) | Initierar en ny instans av `Element`-klassen. Anropa inte denna konstruktor direkt, använd [`CreateElement`](../document/createelement/) eller [`CreateElementNS`](../document/createelementns/). |
...
| [getParentElement](../../com.aspose.html.dom/node/parentelement/) Den skrivskyddade parentElement‑egenskapen i [`Node`](../node/)-gränssnittet returnerar DOM‑nodens föräldra-`Element`, eller null om noden saknar förälder, eller om dess förälder inte är ett DOM‑Element. |
...
| [toggleAttribute](../../com.aspose.html.dom/element/toggleattribute/#toggleattribute)(String) | Om force inte anges, "växlar" qualifiedName, tar bort det om det finns och lägger till det om det saknas. Om force är true, läggs qualifiedName till. Om force är false, tas qualifiedName bort. |
| [toggleAttribute](../../com.aspose.html.dom/element/toggleattribute/#toggleattribute_1)(String, bool) | Om force inte anges, "växlar" qualifiedName, tar bort det om det finns och lägger till det om det saknas. Om force är true, läggs qualifiedName till. Om force är false, tas qualifiedName bort. |
