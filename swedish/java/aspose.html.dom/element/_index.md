...
description: "com.aspose.html.dom.Element-klass. Element‑gränssnittet representerar ett element i ett HTML‑ eller XML‑dokument"
type: docs

url: /sv/java/com.aspose.html.dom/element/
---
## Element class

Element-gränssnittet representerar ett element i ett HTML- eller XML-dokument.
...
| Namn | Beskrivning |
| --- | --- |
| [Element](element/)(QualifiedName, Document) | Initierar en ny instans av klassen `Element`. Anropa inte denna konstruktor direkt, använd [`CreateElement`](../document/createelement/) eller [`CreateElementNS`](../document/createelementns/). |
...
| [getParentElement](../../com.aspose.html.dom/node/parentelement/) Den skrivskyddade egenskapen parentElement för [`Node`](../node/)‑gränssnittet returnerar DOM-nodens föräldra-`Element`, eller null om noden saknar förälder eller om dess förälder inte är ett DOM‑Element. |
...
| [getElementsByClassName](../../com.aspose.html.dom/element/getelementsbyclassname/)(String) | Returnerar ett [`HTMLCollection`](../../com.aspose.html.collections/htmlcollection/)-objekt som innehåller alla element inom `element` som har alla klasser som anges i argumentet. |
| [getElementsByTagName](../../com.aspose.html.dom/element/getelementsbytagname/)(String) | Returnerar ett [`HTMLCollection`](../../com.aspose.html.collections/htmlcollection/)-objekt som innehåller alla `elements` med ett givet taggnamn, i dokumentordning. |
| [getElementsByTagNameNS](../../com.aspose.html.dom/element/getelementsbytagnamens/)(String, String) | Returnerar ett [`HTMLCollection`](../../com.aspose.html.collections/htmlcollection/)-objekt som innehåller alla `elements` med ett givet lokalt namn och paket‑URI‑sträng, i dokumentordning. |
...
| [toggleAttribute](../../com.aspose.html.dom/element/toggleattribute/#toggleattribute)(String) | Om force inte anges, "växlar" qualifiedName genom att ta bort det om det finns och lägga till det om det inte finns. Om force är true, läggs qualifiedName till. Om force är false, tas qualifiedName bort. |
| [toggleAttribute](../../com.aspose.html.dom/element/toggleattribute/#toggleattribute_1)(String, bool) | Om force inte anges, "växlar" qualifiedName genom att ta bort det om det finns och lägga till det om det inte finns. Om force är true, läggs qualifiedName till. Om force är false, tas qualifiedName bort. |
