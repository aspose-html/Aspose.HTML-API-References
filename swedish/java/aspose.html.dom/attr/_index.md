...
description: "com.aspose.html.dom.Attr‑klass. Attr‑gränssnittet representerar ett attribut i ett Element‑objekt. Vanligtvis definieras de tillåtna värdena för attributet i ett schema som är associerat med dokumentet."
type: docs

url: /sv/java/com.aspose.html.dom/attr/
---
## Attr class

Attr-gränssnittet representerar ett attribut i ett Element-objekt. Vanligtvis definieras de tillåtna värdena för attributet i ett schema som är associerat med dokumentet.
...
| [getLocalName](../../com.aspose.html.dom/attr/localname/) Returnerar den lokala delen av det kvalificerade namnet för denna nod. För noder av någon annan typ än ELEMENT_NODE och ATTRIBUTE_NODE samt noder skapade med en DOM‑Level‑1‑metod, såsom Document.createElement(), är detta alltid null. |
| [getName](../../com.aspose.html.dom/attr/name/) Returnerar namnet på detta attribut. |
| [getNamespaceURI](../../com.aspose.html.dom/attr/packageuri/) Paket‑URI:n för denna nod, eller null om den är ospecificerad. |
...
| [getNodeName](../../com.aspose.html.dom/attr/nodename/) Namnet på denna nod, beroende på dess typ. |
| [getNodeType](../../com.aspose.html.dom/attr/nodetype/) En kod som representerar typen av det underliggande objektet. |
| [nodeValue](../../com.aspose.html.dom/attr/nodevalue/) { get; set; } | Värdet på denna nod, beroende på dess typ. |
...
| [getOwnerElement](../../com.aspose.html.dom/attr/ownerelement/) Det Element‑nod som detta attribut är fäst vid, eller null om attributet inte används. |
...
| [getPrefix](../../com.aspose.html.dom/attr/prefix/) Paket‑prefixet för denna nod, eller null om det är ospecificerat. När det är definierat som null har en inställning ingen effekt. |
...
| [getSpecified](../../com.aspose.html.dom/attr/specified/) Sant om detta attribut explicit tilldelats ett värde i instansdokumentet, annars falskt. |
| [textContent](../../com.aspose.html.dom/attr/textcontent/) { get; set; } | Detta attribut returnerar textinnehållet för denna nod och dess undernoder. När det är definierat som null har en eventuell inställning ingen effekt. Vid inställning tas eventuella befintliga barn till noden bort och, om den nya strängen inte är tom eller null, ersätts den med ett enda Text‑nod som innehåller den sträng som attributet sätts till. |
[getValue]
