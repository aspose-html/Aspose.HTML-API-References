...
description: "EventTarget-metod. Denna metod möjliggör borttagning av händelselyssnare från händelsemålet. Om en tas bort från en medan den bearbetar en händelse kommer den inte att utlösas av de aktuella åtgärderna. Händelselyssnare kan aldrig anropas efter att de har tagits bort."
type: docs
...
| hanterare | DOMEventHandler | Parametern indikerar den som ska tas bort. |
