...
| Klass | Beskrivning |
| --- | --- |
| [Attr](./attr/) | Attr-gränssnittet representerar ett attribut i ett Element-objekt. Vanligtvis definieras de tillåtna värdena för attributet i ett schema som är associerat med dokumentet. |
...
| [Comment](./comment/) | Ärver från CharacterData och representerar innehållet i en kommentar, d.v.s. alla tecken mellan den inledande ''. |
...
| [DocumentFragment](./documentfragment/) | DocumentFragment är ett "lightweight" eller "minimal" Document-objekt. Det är mycket vanligt att vilja kunna extrahera en del av ett dokuments träd eller skapa ett nytt fragment av ett dokument. |
...
| [DOMException](./domexception/) | DOMException-gränssnittet representerar en onormal händelse (kallad ett undantag) som uppstår som ett resultat av att anropa en metod eller komma åt en egenskap i ett web‑API. Detta är i princip hur felvillkor beskrivs i web‑API:er. |
...
| [EventTarget](./eventtarget/) | EventTarget‑gränssnittet implementeras av objekt som kan ta emot händelser och kan ha lyssnare för dem. Med andra ord implementerar alla händelse‑mål de tre metoder som är associerade med detta gränssnitt. |
| [Node](./node/) | Node‑gränssnittet är den primära datatypen för hela Document Object Model. Det representerar en enskild nod i dokumentträdet. Även om alla objekt som implementerar Node‑gränssnittet exponerar metoder för att hantera barn, kan inte alla objekt som implementerar Node‑gränssnittet ha barn. Till exempel kan [`Text`](../com.aspose.html.dom/text/)‑noder sakna barn, och att lägga till barn till sådana noder resulterar i att ett [`DOMException`](../com.aspose.html.dom/domexception/) kastas. |
...
| [ShadowRoot](./shadowroot/) | ShadowRoot är en rot‑nod i ett shadow‑träd. |
...
| --- | --- |
| [IBrowsingContext](./ibrowsingcontext/) | Ett webbläsarkontext är en miljö där [`Document`](../com.aspose.html.dom/document/)‑objekt presenteras för användaren. |
...
| [IStorage](./istorage/) | Detta gränssnitt i Web Storage‑API:t ger åtkomst till en specifik domäns session‑ eller lokala lagring. Se Web Storage‑specifikationen: [https://html.spec.whatwg.org/multipage/webstorage.html#webstorage](https://html.spec.whatwg.org/multipage/webstorage.html#webstorage) |
## Uppräkning
