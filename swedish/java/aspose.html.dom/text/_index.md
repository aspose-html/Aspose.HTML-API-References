...
description: "com.aspose.html.dom.Text-klass. Text‑gränssnittet ärver från CharacterData och representerar det textuella innehållet, benämnt teckendata i XML för ett Element eller Attr."
type: docs

url: /sv/java/com.aspose.html.dom/text/
---
## Text class

Text‑gränssnittet ärver från CharacterData och representerar det textuella innehållet (benämnt teckendata i XML) för ett Element eller Attr.
...
| [getIsElementContentWhitespace](../../com.aspose.html.dom/text/iselementcontentwhitespace/) Returnerar om detta text‑node innehåller elementinnehålls‑whitespace, ofta felaktigt kallat "ignorerbart whitespace". |
...
| [getNodeName](../../com.aspose.html.dom/text/nodename/) Namnet på denna nod, beroende på dess typ. |
| [getNodeType](../../com.aspose.html.dom/text/nodetype/) En kod som representerar typen av det underliggande objektet. |
| [nodeValue](../../com.aspose.html.dom/text/nodevalue/) { get; set; } | Värdet på denna nod, beroende på dess typ. |
...
| [textContent](../../com.aspose.html.dom/text/textcontent/) { get; set; } | Detta attribut returnerar textinnehållet för denna nod och dess undernoder. När det är definierat som null har en eventuell inställning ingen effekt. Vid inställning tas eventuella befintliga barn till noden bort och, om den nya strängen inte är tom eller null, ersätts den med ett enda Text‑nod som innehåller den sträng som attributet sätts till. |
| [getWholeText](../../com.aspose.html.dom/text/wholetext/) Returnerar all text från Text‑noder som logiskt är intilliggande denna nod, sammanfogade i dokumentordning. |
...
| [replaceWholeText](../../com.aspose.html.dom/text/replacewholetext/)(String) | Ersätter texten i den aktuella noden och alla logiskt intilliggande textnoder med den angivna texten. Alla logiskt intilliggande textnoder tas bort, inklusive den aktuella noden, såvida den inte var mottagare av ersättningstexten. |
| [splitText](../../com.aspose.html.dom/text/splittext/)(int) | Delar upp denna nod i två noder vid den angivna förskjutningen och behåller båda i trädet som syskon. |
