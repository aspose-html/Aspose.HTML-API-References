...
description: "com.aspose.html.dom.Text-klass. Text‑gränssnittet ärver från CharacterData och representerar det textuella innehållet som kallas teckendata i XML för ett Element eller Attr."
type: docs
...
| [getNodeName](../../com.aspose.html.dom/text/nodename/) Namnet på denna node, beroende på dess typ. |
...
| [getWholeText](../../com.aspose.html.dom/text/wholetext/) Returnerar all text från Text‑noder som logiskt är intilliggande text‑noder till denna node, sammanfogade i dokumentordning. |
...
| [replaceWholeText](../../com.aspose.html.dom/text/replacewholetext/)(String) | Ersätter texten i den aktuella noden och alla logiskt intilliggande textnoder med den angivna texten. Alla logiskt intilliggande textnoder tas bort inklusive den aktuella noden om den inte var mottagare av ersättningstexten. |
