...
SelectElement representerar en wrapper som är associerad med HTMLSelectElement.
...
| [name](../../com.aspose.html.forms/selectelement/name/) { get; set; } | Representera namn-attributet för input-elementet. |
...
| [value](../../com.aspose.html.forms/selectelement/value/) { get; set; } | Vid hämtning måste den returnera värdet för det första alternativelementet i listan av alternativ i trädordning som har sin selectedness satt till true, om någon finns. |
