...
description: "com.aspose.html.forms.FormSubmitter klass. Denna klass möjliggör att förbereda ett specificerat HTMLFormElement, samla värden från formulärelementet, skicka dem till fjärrservern och ta emot ett svar."
type: docs
...
Denna klass möjliggör att förbereda ett specificerat [`HTMLFormElement`](../../com.aspose.html/htmlformelement/), samla värden från formulärelementet, skicka dem till fjärrservern och ta emot ett svar.
...
| [submit](../../com.aspose.html.forms/formsubmitter/submit/#submit_1)(CookieContainer) | Skickar formulärdata till servern med specificerade cookies. |
