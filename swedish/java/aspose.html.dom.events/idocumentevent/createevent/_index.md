...
| --- | --- | --- |
| eventType | String | eventType‑parametern specificerar vilken typ av gränssnitt som ska skapas. Om det angivna gränssnittet stöds av implementationen kommer denna metod att returnera ett nytt av den begärda gränssnittstypen. Om the är att skickas via metoden måste den lämpliga metoden anropas efter skapandet för att initiera värdena. Metoden används för att skapa s när det är antingen opraktiskt eller onödigt för användaren att skapa dem själv. I fall där den tillhandahållna implementationen är otillräcklig kan användare tillhandahålla sina egna implementationer för användning med metoden. |
