...
description: "com.aspose.html.dom.events.InputEvent klass. Input‑händelser skickas som aviseringar när DOM uppdateras"
type: docs
...
| [getIsComposing](../../com.aspose.html.dom.events/inputevent/iscomposing/) true om inmatningseventet inträffar som en del av en kompositionssession, d.v.s. efter ett compositionstart‑event och före motsvarande compositionend‑event. Det oinitierade värdet för detta attribut MÅSTE vara falskt. |
