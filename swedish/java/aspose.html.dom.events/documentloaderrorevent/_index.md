---
title: "DocumentLoadErrorEvent klass"
second_title: "Aspose.HTML för Java API-referens"
description: "com.aspose.html.dom.events.DocumentLoadErrorEvent klass. DocumentLoadErrorEvent inträffar när den begärda resursen inte är tillgänglig"
type: docs

url: /sv/java/com.aspose.html.dom.events/documentloaderrorevent/
---
## DocumentLoadErrorEvent class

DocumentLoadErrorEvent inträffar när den begärda resursen inte är tillgänglig.
...
| [getColNo](../../com.aspose.html.dom.events/errorevent/colno/) colno-attributet måste returnera det värde det initierades med. När objektet skapas ska detta attribut initieras till noll. Det representerar kolumnnumret där felet inträffade i skriptet. |
...
| [getError](../../com.aspose.html.dom.events/errorevent/error/) error-attributet måste returnera det värde det initierades med. När objektet skapas ska detta attribut initieras till null. När lämpligt sätts det till objektet som representerar felet (t.ex. undantagsobjektet i fallet med ett oavlyssnat DOM-undantag). |
...
| [getFileName](../../com.aspose.html.dom.events/errorevent/filename/) filename-attributet måste returnera det värde det initierades med. När objektet skapas ska detta attribut initieras till en tom sträng. Det representerar den absoluta URL:en för skriptet där felet ursprungligen inträffade. |
...
| [getLineNo](../../com.aspose.html.dom.events/errorevent/lineno/) Attributet lineno måste returnera det värde som det initierades till. När objektet skapas måste detta attribut initieras till noll. Det representerar radnumret där felet inträffade i skriptet. |
| [getMessage](../../com.aspose.html.dom.events/errorevent/message/) Attributet message måste returnera det värde som det initierades till. När objektet skapas måste detta attribut initieras till den tomma strängen. Det representerar felmeddelandet. |
