...
Den ErrorEvent tillhandahåller kontextuell information om ett fel som inträffade under körning.
...
| Namn | Beskrivning |
| --- | --- |
| [ErrorEvent](errorevent/#constructor_1)(Exception) | Initierar en ny instans av `ErrorEvent`-klassen. |
