...
description: "com.aspose.html.dom.svg.paths.SVGPathSegLinetoRel class. SVGPathSegLinetoRel‑gränssnittet motsvarar ett relativt lineto‑l‑sökvägsdatakommandon."
type: docs
...
| [X](../../com.aspose.html.dom.svg.paths/svgpathseglinetorel/x/) { get; set; } | Den relativa X‑koordinaten för slutpunkten av detta sökvägssegment. |
| [Y](../../com.aspose.html.dom.svg.paths/svgpathseglinetorel/y/) { get; set; } | Den relativa Y‑koordinaten för slutpunkten av detta sökvägssegment. |
