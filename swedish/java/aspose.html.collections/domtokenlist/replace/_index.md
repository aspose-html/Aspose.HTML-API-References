...
url: /sv/java/com.aspose.html.collections/domtokenlist/replace/
---
...
| newToken | String | Token du vill ersätta det gamla tokenet med. |

### Returvärde

Boolesk `true` om tokenet hittades och ersattes, `false` annars.
