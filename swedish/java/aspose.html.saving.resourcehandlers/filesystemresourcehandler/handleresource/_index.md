...
description: "FileSystemResourceHandler‑metod. Denna metod är ansvarig för att hantera resursen. I den kan du spara Resource till strömmen eller bädda in den i den överordnade resursen."
type: docs

url: /sv/java/com.aspose.html.saving.resourcehandlers/filesystemresourcehandler/handleresource/
---
## FileSystemResourceHandler.HandleResource method

Denna metod är ansvarig för att hantera resursen. I den kan du spara [`Resource`](../../../com.aspose.html.saving/resource/) till strömmen eller bädda in den i den överordnade resursen.
