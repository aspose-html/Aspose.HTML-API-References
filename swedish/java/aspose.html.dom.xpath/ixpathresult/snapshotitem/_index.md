...
Returnerar det `index`:e elementet i ögonblicksbildsamlingen. Om `index` är större än eller lika med antalet noder i listan returnerar metoden `null`. Till skillnad från iteratorresultatet blir ögonblicksbilden inte ogiltig, men kan avvika från det aktuella dokumentet om det har förändrats.
