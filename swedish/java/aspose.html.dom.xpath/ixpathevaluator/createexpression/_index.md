...
description: "IXPathEvaluator‑metod. Skapar ett analyserat XPath‑uttryck med upplösta paket. Detta är användbart när ett uttryck kommer att återanvändas i en applikation eftersom det möjliggör att kompilera expression String till en mer effektiv intern form och förupplösa alla paketprefix som förekommer i uttrycket."
type: docs
