...
description: "WebAccessibility‑metod. En AccessibilityValidator‑instans skapas för en specifik regel med de fullständiga parametrarna för ValidationBuilder.All‑objektet"
type: docs

url: /sv/java/com.aspose.html.accessibility/webaccessibility/createvalidator/
---
## CreateValidator(IRule) {#createvalidator_1}

En AccessibilityValidator-instans skapas för en specifik regel, med de fullständiga parametrarna från ValidationBuilder.All-objektet.
...
| --- | --- | --- |
| regel | IRule | objekt av regel som implementerade IRule‑gränssnittet |
...
Skapa AccessibilityValidator-instans
...
| --- | --- | --- |
| regel | IRule | objekt av regel som implementerade IRule‑gränssnittet |
| builder | Action`1 | metod som returnerar ValidationBuilder‑objekt |
...
En AccessibilityValidator-instans skapas enligt alla regler med ett ValidationBuilder.All-objekt.
...
En AccessibilityValidator-instans skapas för en specifik regellista.
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| regler | IList`1 | lista över regler |
