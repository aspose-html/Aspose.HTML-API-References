...
description: "com.aspose.html.accessibility.ValidationBuilder-klass. ValidationBuilder-klassen tillhandahåller konkreta implementationer av konfigurationsstegen. Definierar metoder och inställningar för klassen ValidationSettings"
type: docs
...
ValidationBuilder-klassen tillhandahåller konkreta implementationer av konfigurationsstegen. Definierar metoder och inställningar för klassen ValidationSettings.
...
| Namn | Beskrivning |
| --- | --- |
| statisk [getAll](../../com.aspose.html.accessibility/validationbuilder/all/) Inkluderar alla nivåer och alla teknologiinställningar |
| statisk [getDefault](../../com.aspose.html.accessibility/validationbuilder/default/) Standardinställningar: endast General-teknologier används och för lägsta kriterienivå |
| statisk [getNone](../../com.aspose.html.accessibility/validationbuilder/none/) Inga inställningar – inga parametrar är specificerade. |
