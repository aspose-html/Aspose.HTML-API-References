---
title: "SVGGradientElement-klass"
second_title: "Aspose.HTML för Java API-referens"
description: "com.aspose.html.dom.svg.SVGGradientElement-klass. Gränssnittet SVGGradientElement är ett basgränssnitt som används av SVGLinearGradientElement och SVGRadialGradientElement."
type: docs

url: /sv/java/com.aspose.html.dom.svg/svggradientelement/
---
## SVGGradientElement class

SVGGradientElement‑gränssnittet är ett basgränssnitt som används av SVGLinearGradientElement och SVGRadialGradientElement.
...
| Namn | Beskrivning |
| --- | --- |
| const [SVG_SPREADMETHOD_PAD](../../com.aspose.html.dom.svg/svggradientelement/svg_spreadmethod_pad/) | Motsvarar värdet 'pad'. |
| const [SVG_SPREADMETHOD_REFLECT](../../com.aspose.html.dom.svg/svggradientelement/svg_spreadmethod_reflect/) | Motsvarar värdet 'reflect'. |
| const [SVG_SPREADMETHOD_REPEAT](../../com.aspose.html.dom.svg/svggradientelement/svg_spreadmethod_repeat/) | Motsvarar värdet 'repeat'. |
| const [SVG_SPREADMETHOD_UNKNOWN](../../com.aspose.html.dom.svg/svggradientelement/svg_spreadmethod_unknown/) | Typen är inte en av de fördefinierade typerna. Det är ogiltigt att försöka definiera ett nytt värde av denna typ eller att försöka byta ett befintligt värde till denna typ. |
