---
title: "SVGElement-klass"
second_title: "Aspose.HTML för Java API-referens"
description: "com.aspose.html.dom.svg.SVGElement klass. Alla SVG DOM-gränssnitt som motsvarar direkt element i SVG-språket, såsom SVGPathElement-gränssnittet för path-elementet, ärver från SVGElement-gränssnittet"
type: docs

url: /sv/java/com.aspose.html.dom.svg/svgelement/
---
## SVGElement class

Alla SVG‑DOM‑gränssnitt som motsvarar element direkt i SVG‑språket (t.ex. SVGPathElement‑gränssnittet för ‘path’-elementet) ärver från SVGElement‑gränssnittet.
