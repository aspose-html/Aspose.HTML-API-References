...
description: Aspose.Html.Toolkit.Markdown.Syntax.HardBreakSyntaxNode klass. Representerar HardBreakSyntaxNode.
type: docs
weight: 5010
url: /sv/net/aspose.html.toolkit.markdown.syntax/hardbreaksyntaxnode/
---
...
| virtual [Source](../../aspose.html.toolkit.markdown.syntax/linebreaksyntaxnode/source/) { get; } | Hämta källan. |
| virtual [Span](../../aspose.html.toolkit.markdown.syntax/linebreaksyntaxnode/span/) { get; } | Hämta spann. |
| [Value](../../aspose.html.toolkit.markdown.syntax/linebreaksyntaxnode/value/) { get; } | Få värdet. |

## Metoder

| namn | Beskrivning |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/hardbreaksyntaxnode/accept/)(MarkdownSyntaxVisitor) | Definierar gränssnittet för acceptera besökare. |
...
| [GetBreakingTag](../../aspose.html.toolkit.markdown.syntax/hardbreaksyntaxnode/getbreakingtag/)() | Definierar gränssnittet för get Breaking Tag |
