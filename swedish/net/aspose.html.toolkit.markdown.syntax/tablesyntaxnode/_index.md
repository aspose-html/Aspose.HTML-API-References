...
description: Aspose.Html.Toolkit.Markdown.Syntax.TableSyntaxNode klass. Klassnoden TableSyntax.
type: docs
weight: 5590
url: /sv/net/aspose.html.toolkit.markdown.syntax/tablesyntaxnode/
---
## TableSyntaxNode class

Klassnoden TableSyntax.
...
| namn | Beskrivning |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/tablesyntaxnode/accept/)(MarkdownSyntaxVisitor) | Definierar gränssnittet för att acceptera besökaren. |
...
| [AppendRow](../../aspose.html.toolkit.markdown.syntax/tablesyntaxnode/appendrow/)(TableRowSyntaxNode) | Definierar gränssnittet för append row. |
| [ChildNodes](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/childnodes/)() | Hämta samlingen av underordnade noder. |
| [GetAlignment](../../aspose.html.toolkit.markdown.syntax/tablesyntaxnode/getalignment/)() | Definierar gränssnittet för get alignment. |
| [GetBodyRows](../../aspose.html.toolkit.markdown.syntax/tablesyntaxnode/getbodyrows/)() | Definierar gränssnittet för get body-rader. |
| [GetHeader](../../aspose.html.toolkit.markdown.syntax/tablesyntaxnode/getheader/)() | Definierar gränssnittet för get table header. |
