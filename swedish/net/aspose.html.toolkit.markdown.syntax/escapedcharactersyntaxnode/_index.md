...
description: Aspose.Html.Toolkit.Markdown.Syntax.EscapedCharacterSyntaxNode klass. Implementerade syntaxnoden för escapetecken.
type: docs
weight: 4890
url: /sv/net/aspose.html.toolkit.markdown.syntax/escapedcharactersyntaxnode/
---
## EscapedCharacterSyntaxNode class

Implementerade syntaxnoden för escape-tecken.
...
| virtual [Source](../../aspose.html.toolkit.markdown.syntax/textsyntaxnode/source/) { get; } | Returnera källtexten. |
| virtual [Span](../../aspose.html.toolkit.markdown.syntax/textsyntaxnode/span/) { get; } | Definierar gränssnittet för get span. |
| [Value](../../aspose.html.toolkit.markdown.syntax/textsyntaxnode/value/) { get; } | Definierar egenskapen för get string value. |

## Metoder

| namn | Beskrivning |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/escapedcharactersyntaxnode/accept/)(MarkdownSyntaxVisitor) | Definierar gränssnittet för acceptera besökare. |
