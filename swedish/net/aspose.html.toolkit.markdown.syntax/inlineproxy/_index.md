...
description: Aspose.Html.Toolkit.Markdown.Syntax.InlineProxy klass. Representerar InlineProxy.
type: docs
weight: 5070
url: /sv/net/aspose.html.toolkit.markdown.syntax/inlineproxy/
---
## InlineProxy class
...
| namn | Beskrivning |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/inlineproxy/accept/)(MarkdownSyntaxVisitor) | Definierar gränssnittet för acceptera besökare. |
...
| [GetTarget](../../aspose.html.toolkit.markdown.syntax/inlineproxy/gettarget/)() | Definierar gränssnittet för get target. |
...
| override [WriteTo](../../aspose.html.toolkit.markdown.syntax/inlineproxy/writeto/#writeto)(MarkdownTextWriter) | Skriv till textförfattare. |
