...
description: Aspose.Html.Toolkit.Markdown.Syntax.SetextHeadingSyntaxNode klass. Representerar Setextrubriksyntaxnoden.
type: docs
weight: 5530
url: /sv/net/aspose.html.toolkit.markdown.syntax/setextheadingsyntaxnode/
---
## SetextHeadingSyntaxNode class

Representerar Setext-rubriksyntaxnoden.
...
| [Level](../../aspose.html.toolkit.markdown.syntax/setextheadingsyntaxnode/level/) { get; } | Få nivån på aktuell syntax. |
...
| namn | Beskrivning |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/setextheadingsyntaxnode/accept/)(MarkdownSyntaxVisitor) | Definierar gränssnittet för att acceptera besökaren. |
