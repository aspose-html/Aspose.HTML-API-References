...
description: Aspose.Html.HTMLLabelElement klass. Formulärfältetiketttext. Se LABELelementdefinitionen i HTML 4.01.
type: docs
weight: 3350
url: /sv/net/aspose.html/htmllabelelement/
---
## HTMLLabelElement class

Formulärfältetiketttext. Se LABEL-elementdefinitionen i HTML 4.01.
...
| namn | Beskrivning |
| --- | --- |
| [AccessKey](../../aspose.html/htmllabelelement/accesskey/) { get; set; } | En åtkomstnyckel med ett tecken för att ge åtkomst till formulärkontrollen. Se definitionen av accesskey-attributet i HTML 4.01. |
...
| [For](../../aspose.html/htmllabelelement/for/) { get; set; } | Det här attributet länkar denna etikett med en annan formulärkontroll av `id`attribut. Se för attributdefinitionen i HTML 4.01. |
| [Form](../../aspose.html/htmllabelelement/form/) { get; } | Returnerar`FORM` element som innehåller denna kontroll. Returnerar `null` om denna kontroll inte är inom ramen för ett -formulär. |
