...
description: Aspose.Html.HTMLParamElement klass. Parametrar som matas tillOBJEKT element. Se PARAMelementets definition i HTML 4.01.
type: docs
weight: 3480
url: /sv/net/aspose.html/htmlparamelement/
---
## HTMLParamElement class

Parametrar som matas till`OBJEKT` element. Se PARAM-elementets definition i HTML 4.01.
...
| [Name](../../aspose.html/htmlparamelement/name/) { get; set; } | Namnet på en körtidsparameter. Se definitionen av namnattribut i HTML 4.01. |
...
| [Type](../../aspose.html/htmlparamelement/type/) { get; set; } | Innehållstyp för`värde` attribut när `värde typ` har värdet "ref". Se typattributet definition i HTML 4.01. |
| [Value](../../aspose.html/htmlparamelement/value/) { get; set; } | Värdet för en körtidsparameter. Se värdeattributdefinitionen i HTML 4.01. |
| [ValueType](../../aspose.html/htmlparamelement/valuetype/) { get; set; } | Information om innebörden av`värde` attribut värde. Se definitionen av värdetypsattribut i HTML 4.01. |
