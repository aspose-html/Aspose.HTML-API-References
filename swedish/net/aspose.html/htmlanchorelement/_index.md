...
description: Aspose.Html.HTMLAnchorElement klass. Ankarelementet. Se Aelementdefinitionen i HTML 4.01.
type: docs
weight: 3060
url: /sv/net/aspose.html/htmlanchorelement/
---
## HTMLAnchorElement class

Ankarelementet. Se A-elementdefinitionen i HTML 4.01.
...
| namn | Beskrivning |
| --- | --- |
| [AccessKey](../../aspose.html/htmlanchorelement/accesskey/) { get; set; } | En åtkomstnyckel med ett tecken för att ge åtkomst till formulärkontrollen. Se definitionen av accesskey-attributet i HTML 4.01. |
...
| [Charset](../../aspose.html/htmlanchorelement/charset/) { get; set; } | Teckenkodningen för den länkade resursen. Se teckenuppsättningen attributdefinition i HTML 4.01. |
...
| [Coords](../../aspose.html/htmlanchorelement/coords/) { get; set; } | Kommaseparerad lista över längder, som definierar en aktiv regions geometri. Se även`form` för regionens form. Se definitionen av attributet coords i HTML 4.01. |
...
| [Hash](../../aspose.html/htmlanchorelement/hash/) { get; set; } | Hämtar eller ställer in en strängrepresentation av hashsegmentet för den associerade webbadressen. |
| [Host](../../aspose.html/htmlanchorelement/host/) { get; set; } | Hämtar eller ställer in en strängrepresentation av värd- och portsegmenten för den associerade webbadressen. |
| [Hostname](../../aspose.html/htmlanchorelement/hostname/) { get; set; } | Hämtar eller ställer in en strängrepresentation av värdsegmentet för den associerade webbadressen. |
| [Href](../../aspose.html/htmlanchorelement/href/) { get; set; } | Den absoluta URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) av den länkade resursen. Se href-attributet definition i HTML 4.01. |
| [Hreflang](../../aspose.html/htmlanchorelement/hreflang/) { get; set; } | Språkkoden för den länkade resursen. Se hreflang-attributet definition i HTML 4.01. |
...
| [Name](../../aspose.html/htmlanchorelement/name/) { get; set; } | Ankarnamn. Se definitionen av namnattribut i HTML 4.01. |
...
| [Origin](../../aspose.html/htmlanchorelement/origin/) { get; } | Får en strängrepresentation av ursprungssegmentet för den associerade webbadressen. |
...
| [Password](../../aspose.html/htmlanchorelement/password/) { get; set; } | Hämtar eller ställer in en strängrepresentation av lösenordssegmentet för den associerade webbadressen. |
| [Pathname](../../aspose.html/htmlanchorelement/pathname/) { get; set; } | Hämtar eller ställer in en strängrepresentation av sökvägssegmentet för den associerade webbadressen. |
| [Port](../../aspose.html/htmlanchorelement/port/) { get; set; } | Hämtar eller ställer in en strängrepresentation av portsegmentet för den associerade URL:en. |
...
| [Protocol](../../aspose.html/htmlanchorelement/protocol/) { get; set; } | Hämtar eller ställer in en strängrepresentation av schemasegmentet för den associerade webbadressen. |
| [Rel](../../aspose.html/htmlanchorelement/rel/) { get; set; } | Vidarebefordra länktyp. Se rel-attributdefinitionen i HTML 4.01. |
| [RelList](../../aspose.html/htmlanchorelement/rellist/) { get; } | Returnerar en levande DOMTokenList som innehåller tokens som tagits emot från att analysera "rel"-attributet. |
| [Rev](../../aspose.html/htmlanchorelement/rev/) { get; set; } | Typ av omvänd länk. Se rev-attributdefinitionen i HTML 4.01. |
| [SchemaTypeInfo](../../aspose.html.dom/element/schematypeinfo/) { get; } | Typinformationen som är associerad med detta element. |
| [Search](../../aspose.html/htmlanchorelement/search/) { get; set; } | Hämtar eller ställer in en strängrepresentation av söksegmentet för den associerade webbadressen. |
...
| [Shape](../../aspose.html/htmlanchorelement/shape/) { get; set; } | Formen på det aktiva området. Koordinaterna ges av `koordinater` . Se formattributdefinitionen i HTML 4.01. |
...
| [TabIndex](../../aspose.html/htmlanchorelement/tabindex/) { get; set; } | Index som representerar elementets position i tabbordningen. Se tabindex-attributdefinitionen i HTML 4.01. |
| [TagName](../../aspose.html.dom/element/tagname/) { get; } | Namnet på elementet. |
| [Target](../../aspose.html/htmlanchorelement/target/) { get; set; } | Ram att rendera resursen i. Se målattributdefinitionen i HTML 4.01. |
...
| [Type](../../aspose.html/htmlanchorelement/type/) { get; set; } | Rådgivande innehållstyp. Se typattributdefinitionen i HTML 4.01. |
| [Username](../../aspose.html/htmlanchorelement/username/) { get; set; } | Hämtar eller ställer in en strängrepresentation av användarnamnssegmentet för den associerade webbadressen. |
...
| [Blur](../../aspose.html/htmlanchorelement/blur/)() | Tar bort tangentbordsfokus från detta element. |
...
| [Focus](../../aspose.html/htmlanchorelement/focus/)() | Ger tangentbordsfokus till detta element. |
