...
description: Aspose.Html.HTMLMapElement klass. Bildkarta på klientsidan. Se MAPelementdefinitionen i HTML 4.01.
type: docs
weight: 3380
url: /sv/net/aspose.html/htmlmapelement/
---
## HTMLMapElement class

Bildkarta på klientsidan. Se MAP-elementdefinitionen i HTML 4.01.
...
| namn | Beskrivning |
| --- | --- |
| [Areas](../../aspose.html/htmlmapelement/areas/) { get; } | Listan över områden som definierats för bildkartan. |
...
| [Name](../../aspose.html/htmlmapelement/name/) { get; set; } | Namner kartan (för användning med`använd kartan` ). Se namnet attributdefinition i HTML 4.01. |
