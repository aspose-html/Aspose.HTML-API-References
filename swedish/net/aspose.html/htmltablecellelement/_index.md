...
description: Aspose.Html.HTMLTableCellElement klass. Objektet som används för att representeraTH ochTD element. Se TDelementdefinitionen i HTML 4.01.
type: docs
weight: 3550
url: /sv/net/aspose.html/htmltablecellelement/
---
## HTMLTableCellElement class

Objektet som används för att representera`TH` och`TD` element. Se TD-elementdefinitionen i HTML 4.01.
...
| namn | Beskrivning |
| --- | --- |
| [Abbr](../../aspose.html/htmltablecellelement/abbr/) { get; set; } | Förkortning för rubrikceller. Se förkortningsattributdefinitionen i HTML 4.01. |
| [Align](../../aspose.html/htmltablecellelement/align/) { get; set; } | Horisontell justering av data i cell. Se align attribut definition i HTML 4.01. |
...
| [Axis](../../aspose.html/htmltablecellelement/axis/) { get; set; } | Namnger grupp med relaterade rubriker. Se definitionen av axelattribut i HTML 4.01. |
...
| [BgColor](../../aspose.html/htmltablecellelement/bgcolor/) { get; set; } | Cellbakgrundsfärg. Se bgcolor-attributdefinitionen i HTML 4.01. Det här attributet är utfasat i HTML 4.01. |
| [CellIndex](../../aspose.html/htmltablecellelement/cellindex/) { get; } | Indexet för denna cell i raden, med start från 0. Detta index är i dokumentträdordning och inte visningsordning. |
| [Ch](../../aspose.html/htmltablecellelement/ch/) { get; set; } | Justeringstecken för celler i en kolumn. Se char-attributet definition i HTML 4.01. |
...
| [ChOff](../../aspose.html/htmltablecellelement/choff/) { get; set; } | Offset av inriktningstecken. Se definitionen av charoff-attributet i HTML 4.01. |
...
| [ColSpan](../../aspose.html/htmltablecellelement/colspan/) { get; set; } | Antal kolumner som sträcks av cell. Se colspan-attributdefinitionen i HTML 4.01. |
...
| [Headers](../../aspose.html/htmltablecellelement/headers/) { get; set; } | Lista över`id` attributvärden för rubrikceller. Se attributdefinitionen headers i HTML 4.01. |
| [Height](../../aspose.html/htmltablecellelement/height/) { get; set; } | Cellhöjd. Se definitionen av höjdattributet i HTML 4.01. Detta -attribut är utfasat i HTML 4.01. |
...
| [NoWrap](../../aspose.html/htmltablecellelement/nowrap/) { get; set; } | Undertryck radbrytning. Se nowrap-attributdefinitionen i HTML 4.01. Det här attributet är utfasat i HTML 4.01. |
...
| [RowSpan](../../aspose.html/htmltablecellelement/rowspan/) { get; set; } | Antal rader som sträcks av cell. Se definitionen av rowspan-attributet i HTML 4.01. |
| [SchemaTypeInfo](../../aspose.html.dom/element/schematypeinfo/) { get; } | Typinformationen som är associerad med detta element. |
| [Scope](../../aspose.html/htmltablecellelement/scope/) { get; set; } | Omfattning täckt av rubrikceller. Se definitionen av scope-attribut i HTML 4.01. |
...
| [VAlign](../../aspose.html/htmltablecellelement/valign/) { get; set; } | Vertikal justering av data i cell. Se definitionen av ogiltig attribut i HTML 4.01. |
| [Width](../../aspose.html/htmltablecellelement/width/) { get; set; } | Cellbredd. Se width-attributdefinitionen i HTML 4.01. Detta -attribut är utfasat i HTML 4.01. |
