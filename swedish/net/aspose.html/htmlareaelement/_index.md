...
description: Aspose.Html.HTMLAreaElement klass. Definition av bildkarta på klientsidan. Se AREAelementdefinitionen i HTML 4.01.
type: docs
weight: 3080
url: /sv/net/aspose.html/htmlareaelement/
---
## HTMLAreaElement class

Definition av bildkarta på klientsidan. Se AREA-elementdefinitionen i HTML 4.01.
...
| namn | Beskrivning |
| --- | --- |
| [AccessKey](../../aspose.html/htmlareaelement/accesskey/) { get; set; } | En åtkomstnyckel med ett tecken för att ge åtkomst till formulärkontrollen. Se definitionen av accesskey-attributet i HTML 4.01. |
| [Alt](../../aspose.html/htmlareaelement/alt/) { get; set; } | Alternativ text för användaragenter som inte återger det normala innehållet i detta element. Se alt-attributdefinitionen i HTML 4.01. |
...
| [Coords](../../aspose.html/htmlareaelement/coords/) { get; set; } | Kommaseparerad lista med längder som definierar en aktiv regions geometri. Se även`form` för regionens form. Se definitionen av attributet coords i HTML 4.01. |
...
| [Href](../../aspose.html/htmlareaelement/href/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] av den länkade resursen. Se href-attributdefinitionen i HTML 4.01. |
...
| [NoHref](../../aspose.html/htmlareaelement/nohref/) { get; set; } | Anger att detta område är inaktivt, dvs. har ingen associerad åtgärd. Se nohref-attributdefinitionen i HTML 4.01. |
...
| [RelList](../../aspose.html/htmlareaelement/rellist/) { get; } | Returnerar en levande DOMTokenList som innehåller tokens som tagits emot från att analysera "rel"-attributet. |
...
| [Shape](../../aspose.html/htmlareaelement/shape/) { get; set; } | Formen på det aktiva området. Koordinaterna ges av `koordinater` . Se formattributdefinitionen i HTML 4.01. |
...
| [TabIndex](../../aspose.html/htmlareaelement/tabindex/) { get; set; } | Index som representerar elementets position i tabbordningen. Se tabindex-attributdefinitionen i HTML 4.01. |
| [TagName](../../aspose.html.dom/element/tagname/) { get; } | Namnet på elementet. |
| [Target](../../aspose.html/htmlareaelement/target/) { get; set; } | Ram att rendera resursen i. Se målattributdefinitionen i HTML 4.01. |
