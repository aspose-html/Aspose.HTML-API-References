...
description: Aspose.Html.HTMLIFrameElement klass. Inline underfönster. Se IFRAMEelementdefinitionen i HTML 4.01.
type: docs
weight: 3300
url: /sv/net/aspose.html/htmliframeelement/
---
## HTMLIFrameElement class

Inline underfönster. Se IFRAME-elementdefinitionen i HTML 4.01.
...
| namn | Beskrivning |
| --- | --- |
| [Align](../../aspose.html/htmliframeelement/align/) { get; set; } | Justerar detta objekt (vertikalt eller horisontellt) med avseende på dess omgivande text. Se definitionen av align attribut i HTML 4.01. Det här attributet är utfasat i HTML 4.01. |
...
| [FrameBorder](../../aspose.html/htmliframeelement/frameborder/) { get; set; } | Begär ramkanter. Se frameborder-attributdefinitionen i HTML 4.01. |
| [Height](../../aspose.html/htmliframeelement/height/) { get; set; } | Ramhöjd. Se definitionen av höjdattributet i HTML 4.01. |
...
| [LongDesc](../../aspose.html/htmliframeelement/longdesc/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] som anger en lång beskrivning av denna bild eller ram. Se longdesc-attributdefinitionen i HTML 4.01. |
| [MarginHeight](../../aspose.html/htmliframeelement/marginheight/) { get; set; } | Rammarginalens höjd, i pixlar. Se marginheight-attributet definition i HTML 4.01. |
| [MarginWidth](../../aspose.html/htmliframeelement/marginwidth/) { get; set; } | Rammarginalens bredd, i pixlar. Se marginwidth-attributdefinitionen i HTML 4.01. |
| [Name](../../aspose.html/htmliframeelement/name/) { get; set; } | Ramnamnet (objektet i`mål` attribut). Se definitionen av attributet name i HTML 4.01. |
...
| [Scrolling](../../aspose.html/htmliframeelement/scrolling/) { get; set; } | Ange om ramen ska ha rullningslister eller inte. Se definitionen av rullningsattribut i HTML 4.01. |
...
| [Src](../../aspose.html/htmliframeelement/src/) { get; set; } | A URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] som anger det ursprungliga raminnehållet. Se src-attributet definition i HTML 4.01. |
...
| [Width](../../aspose.html/htmliframeelement/width/) { get; set; } | Rambredd. Se definitionen av width-attributet i HTML 4.01. |
