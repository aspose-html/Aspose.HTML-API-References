...
description: Aspose.Html.HTMLBRElement klass. Framtvinga en radbrytning. Se BRelementdefinitionen i HTML 4.01.
type: docs
weight: 3090
url: /sv/net/aspose.html/htmlbrelement/
---
## HTMLBRElement class

Framtvinga en radbrytning. Se BR-elementdefinitionen i HTML 4.01.
...
| [Clear](../../aspose.html/htmlbrelement/clear/) { get; set; } | Styr flödet av text runt flottörer. Se den tydliga attributdefinitionen i HTML 4.01. Det här attributet är utfasat i HTML 4.01. |
