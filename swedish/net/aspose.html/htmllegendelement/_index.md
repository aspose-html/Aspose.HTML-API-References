...
description: Aspose.Html.HTMLLegendElement klass. Tillhandahåller en bildtext för enFÄLTSET gruppering. Se LEGEND elementdefinitionen i HTML 4.01.
type: docs
weight: 3360
url: /sv/net/aspose.html/htmllegendelement/
---
## HTMLLegendElement class

Tillhandahåller en bildtext för en`FÄLTSET` gruppering. Se LEGEND elementdefinitionen i HTML 4.01.
...
| namn | Beskrivning |
| --- | --- |
| [AccessKey](../../aspose.html/htmllegendelement/accesskey/) { get; set; } | En åtkomstnyckel med ett tecken för att ge åtkomst till formulärkontrollen. Se definitionen av accesskey-attributet i HTML 4.01. |
| [Align](../../aspose.html/htmllegendelement/align/) { get; set; } | Textjustering i förhållande till`FÄLTSET` . Se attributdefinitionen align i HTML 4.01. Det här attributet är utfasat i HTML 4.01. |
...
| [Form](../../aspose.html/htmllegendelement/form/) { get; } | Returnerar`FORM` element som innehåller denna kontroll. Returnerar `null` om denna kontroll inte är inom ramen för ett -formulär. |
