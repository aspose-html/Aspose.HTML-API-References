...
description: Aspose.Html.HTMLButtonElement klass. Tryckknapp. Se BUTTONelementdefinitionen i HTML 4.01.
type: docs
weight: 3130
url: /sv/net/aspose.html/htmlbuttonelement/
---
## HTMLButtonElement class

Tryckknapp. Se BUTTON-elementdefinitionen i HTML 4.01.
...
| namn | Beskrivning |
| --- | --- |
| [AccessKey](../../aspose.html/htmlbuttonelement/accesskey/) { get; set; } | En åtkomstnyckel med ett tecken för att ge åtkomst till formulärkontrollen. Se definitionen av accesskey-attributet i HTML 4.01. |
...
| [Disabled](../../aspose.html/htmlbuttonelement/disabled/) { get; set; } | Kontrollen är inte tillgänglig i detta sammanhang. Se disabled-attributet definition i HTML 4.01. |
...
| [Form](../../aspose.html/htmlbuttonelement/form/) { get; } | Returnerar`FORM` element som innehåller denna kontroll. Returnerar `null` om denna kontroll inte är inom ramen för ett -formulär. |
...
| [Name](../../aspose.html/htmlbuttonelement/name/) { get; set; } | Formulärkontroll eller objektnamn när det skickas med ett formulär. Se namnet attributdefinition i HTML 4.01. |
...
| [TabIndex](../../aspose.html/htmlbuttonelement/tabindex/) { get; set; } | Index som representerar elementets position i tabbordningen. Se tabindex-attributdefinitionen i HTML 4.01. |
...
| [Type](../../aspose.html/htmlbuttonelement/type/) { get; set; } | Typ av knapp (alla gemener). Se typattributdefinitionen i HTML 4.01. |
| [Value](../../aspose.html/htmlbuttonelement/value/) { get; set; } | Det aktuella formulärkontrollvärdet. Se definitionen av värdeattributet i HTML 4.01. |
