...
description: Aspose.Html.HTMLInputElement klass. Formulärkontroll. Beroende på miljön där sidan visas kan värdeegenskapen vara skrivskyddad för filuppladdningsindatatypen . För inmatningstypen lösenord kan det faktiska värdet som returneras vara maskerat för att förhindra obehörig användning. Se INPUTelementdefinitionen i HTML 4.01 .
type: docs
weight: 3320
url: /sv/net/aspose.html/htmlinputelement/
---
## HTMLInputElement class

Formulärkontroll. Beroende på miljön där sidan visas, kan värdeegenskapen vara skrivskyddad för filuppladdningsindatatypen . För inmatningstypen "lösenord" kan det faktiska värdet som returneras vara maskerat för att förhindra obehörig användning. Se INPUT-elementdefinitionen i [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224) ].
...
| namn | Beskrivning |
| --- | --- |
| [Accept](../../aspose.html/htmlinputelement/accept/) { get; set; } | En kommaseparerad lista över innehållstyper som en server som bearbetar detta -formulär kommer att hantera korrekt. Se definitionen av acceptera attribut i HTML 4.01. |
| [AccessKey](../../aspose.html/htmlinputelement/accesskey/) { get; set; } | En åtkomstnyckel med ett tecken för att ge åtkomst till formulärkontrollen. Se definitionen av accesskey-attributet i HTML 4.01. |
| [Align](../../aspose.html/htmlinputelement/align/) { get; set; } | Justerar detta objekt (vertikalt eller horisontellt) med avseende på dess omgivande text. Se definitionen av align attribut i HTML 4.01. Det här attributet är utfasat i HTML 4.01. |
| [Alt](../../aspose.html/htmlinputelement/alt/) { get; set; } | Alternativ text för användaragenter som inte återger det normala innehållet i detta element. Se alt-attributdefinitionen i HTML 4.01. |
...
| [Checked](../../aspose.html/htmlinputelement/checked/) { get; set; } | När`typ`elementets attribut har värdet "radio" eller "checkbox", detta representerar det aktuella tillståndet för formen kontroll, i en interaktiv användaragent. Ändringar av detta attribut ändrar formulärkontrollens tillstånd, men ändrar inte värdet på det HTML-kontrollerade attributet för INPUT-elementet. Under hanteringen av en klickhändelse på ett indataelement med ett typattribut som har värdet "radio" eller "checkbox", kan vissa implementeringar ändra -värdet för den här egenskapen innan händelsen skickas i -dokumentet. Om standardåtgärden för händelsen avbryts kan värdet för egenskapen ändras tillbaka till dess ursprungliga värde. Detta betyder att värdet på den här egenskapen under hanteringen av klickhändelser är implementeringsberoende. |
...
| [DefaultChecked](../../aspose.html/htmlinputelement/defaultchecked/) { get; set; } | När`typ` har värdet "radio" eller "checkbox", representerar denna det HTML-kontrollerade attributet för elementet. Värdet på detta attribut ändras inte om tillståndet för motsvarande form kontroll, i en interaktiv användaragent, ändras. Se den markerade -attributdefinitionen i HTML 4.01. |
| [DefaultValue](../../aspose.html/htmlinputelement/defaultvalue/) { get; set; } | När`typ`elementets attribut har värdet "text", "file" eller "lösenord", detta representerar HTML-värdet attribut för elementet. Värdet på detta attribut ändras inte om innehållet i motsvarande formulärkontroll, i en interaktiv användaragent, ändras. Se definitionen av värdeattributet i HTML 4.01. |
...
| [Disabled](../../aspose.html/htmlinputelement/disabled/) { get; set; } | Kontrollen är inte tillgänglig i detta sammanhang. Se disabled-attributet definition i HTML 4.01. |
| [Files](../../aspose.html/htmlinputelement/files/) { get; } | Files IDL-attributet tillåter skript att komma åt elementets valda filer. Om IDL-attributet gäller måste det returnera ett FileList-objekt som representerar de aktuella valda filerna. Samma objekt måste returneras tills listan över valda filer ändras. Om IDL-attributet inte gäller måste det istället returnera null. [FILEAPI] |
...
| [Form](../../aspose.html/htmlinputelement/form/) { get; set; } | Returnerar`FORM` element som innehåller denna kontroll. Returnerar `null` om denna kontroll inte är inom ramen för ett -formulär. |
...
| [List](../../aspose.html/htmlinputelement/list/) { get; set; } | Listattributet används för att identifiera ett element som listar fördefinierade alternativ som föreslås för användaren. Om det finns måste dess värde vara ID:t för ett datalistelement i samma dokument. |
...
| [MaxLength](../../aspose.html/htmlinputelement/maxlength/) { get; set; } | Maximalt antal tecken för textfält, när`typ` har värdet "text" eller "lösenord". Se maxlängd-attributet definition i HTML 4.01. |
| [Name](../../aspose.html/htmlinputelement/name/) { get; set; } | Formulärkontroll eller objektnamn när det skickas med ett formulär. Se namnet attributdefinition i HTML 4.01. |
...
| [ReadOnly](../../aspose.html/htmlinputelement/readonly/) { get; set; } | Denna kontroll är skrivskyddad. Relevant endast när`typ` har värdet "text" eller "lösenord". Se definitionen av skrivskyddat attribut i HTML 4.01. |
...
| [Size](../../aspose.html/htmlinputelement/size/) { get; set; } | Storleksinformation. Den exakta betydelsen är specifik för varje typ av -fält. Se storleksattributdefinitionen i HTML 4.01. @version DOM Level 2 |
| [Src](../../aspose.html/htmlinputelement/src/) { get; set; } | När`typ`attributet har värdet "image", detta -attribut anger platsen för bilden som ska användas för att dekorera den grafiska skicka-knappen. Se src-attributdefinitionen i HTML 4.01. |
...
| [TabIndex](../../aspose.html/htmlinputelement/tabindex/) { get; set; } | Index som representerar elementets position i tabbordningen. Se tabindex-attributdefinitionen i HTML 4.01. |
...
| [Type](../../aspose.html/htmlinputelement/type/) { get; set; } | Typen av kontroll som skapats (alla små bokstäver). Se typattributdefinitionen i HTML 4.01. @version DOM Level 2 |
| [UseMap](../../aspose.html/htmlinputelement/usemap/) { get; set; } | Använd bildkarta på klientsidan. Se definitionen av usemap-attribut i HTML 4.01. |
| [Value](../../aspose.html/htmlinputelement/value/) { get; set; } | När`typ` elementets attribut har värdet "text", "fil" eller "lösenord", detta representerar det aktuella innehållet i motsvarande formulärkontroll, i en interaktiv användaragent. Ändring av detta attribut ändrar innehållet i formulärkontrollen, men ändrar inte värdet på HTML-värdeattributet för elementet. När`typ`elementets attribut har värdet "button", "hidden", "submit", "reset", "image", "checkbox" eller "radio", detta representerar elementets HTML-värdeattribut. Se definitionen av värdeattributet i HTML 4.01. |
