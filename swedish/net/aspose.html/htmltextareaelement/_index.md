...
description: Aspose.Html.HTMLTextAreaElement klass. Flerradigt textfält. Se TEXTAREAelementdefinitionen i HTML 4.01.
type: docs
weight: 3610
url: /sv/net/aspose.html/htmltextareaelement/
---
...
| namn | Beskrivning |
| --- | --- |
| [AccessKey](../../aspose.html/htmltextareaelement/accesskey/) { get; set; } | En åtkomstnyckel med ett tecken för att ge åtkomst till formulärkontrollen. Se definitionen av accesskey-attributet i HTML 4.01. |
...
| [Cols](../../aspose.html/htmltextareaelement/cols/) { get; set; } | Kontrollbredd (i tecken). Se cols-attributdefinitionen i HTML 4.01. |
| [DefaultValue](../../aspose.html/htmltextareaelement/defaultvalue/) { get; set; } | Representerar innehållet i elementet. Värdet på detta attribut ändras inte om innehållet i motsvarande formulärkontroll, i en interaktiv användaragent, ändras. @version DOM Level 2 |
...
| [Disabled](../../aspose.html/htmltextareaelement/disabled/) { get; set; } | Kontrollen är inte tillgänglig i detta sammanhang. Se disabled-attributet definition i HTML 4.01. |
...
| [Form](../../aspose.html/htmltextareaelement/form/) { get; } | Returnerar`FORM` element som innehåller denna kontroll. Returnerar `null` om denna kontroll inte är inom ramen för ett -formulär. |
...
| [Name](../../aspose.html/htmltextareaelement/name/) { get; set; } | Formulärkontroll eller objektnamn när det skickas med ett formulär. Se namnet attributdefinition i HTML 4.01. |
...
| [ReadOnly](../../aspose.html/htmltextareaelement/readonly/) { get; set; } | Denna kontroll är skrivskyddad. Se definitionen av skrivskyddat attribut i HTML 4.01. |
| [Rows](../../aspose.html/htmltextareaelement/rows/) { get; set; } | Antal textrader. Se definitionen av radattribut i HTML 4.01. |
...
| [TabIndex](../../aspose.html/htmltextareaelement/tabindex/) { get; set; } | Index som representerar elementets position i tabbordningen. Se tabindex-attributdefinitionen i HTML 4.01. |
...
| [Type](../../aspose.html/htmltextareaelement/type/) { get; } | Typen av denna formulärkontroll. Detta är strängen "textarea". |
| [Value](../../aspose.html/htmltextareaelement/value/) { get; set; } | Representerar det aktuella innehållet i motsvarande formulärkontroll, i en interaktiv användaragent. Ändring av detta attribut ändrar innehållet i formulärkontrollen, men ändrar inte innehållet i elementet . Om hela data inte får plats i en enda `DOMString` , kan implementeringen trunkera data. |
