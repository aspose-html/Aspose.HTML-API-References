...
description: Aspose.Html.HTMLTableRowElement klass. En rad i en tabell. Se TRelementdefinitionen i HTML 4.01.
type: docs
weight: 3580
url: /sv/net/aspose.html/htmltablerowelement/
---
...
| namn | Beskrivning |
| --- | --- |
| [Align](../../aspose.html/htmltablerowelement/align/) { get; set; } | Horisontell justering av data inom cellerna i denna rad. Se attributdefinitionen align i HTML 4.01. |
...
| [BgColor](../../aspose.html/htmltablerowelement/bgcolor/) { get; set; } | Bakgrundsfärg för rader. Se bgcolor-attributdefinitionen i HTML 4.01. Det här attributet är utfasat i HTML 4.01. |
| [Cells](../../aspose.html/htmltablerowelement/cells/) { get; } | Samlingen av celler i den här raden. @version DOM Nivå 2 |
| [Ch](../../aspose.html/htmltablerowelement/ch/) { get; set; } | Justeringstecken för celler i en kolumn. Se char-attributet definition i HTML 4.01. |
...
| [ChOff](../../aspose.html/htmltablerowelement/choff/) { get; set; } | Offset av inriktningstecken. Se definitionen av charoff-attributet i HTML 4.01. |
...
| [RowIndex](../../aspose.html/htmltablerowelement/rowindex/) { get; } | Detta är i logisk ordning och inte i dokumentordning. `rowIndex` tar hänsyn till avsnitt ( `THEAD` ,`TFOT` , eller`TBODY` ) inom tabellen, placering`THEAD` raderna först i indexet, följt av`TBODY` rader, följt av`TFOT` rows. @version DOM Nivå 2 |
| [SchemaTypeInfo](../../aspose.html.dom/element/schematypeinfo/) { get; } | Typinformationen som är associerad med detta element. |
| [SectionRowIndex](../../aspose.html/htmltablerowelement/sectionrowindex/) { get; } | Indexet för den här raden, relativt det aktuella avsnittet ( `THEAD` ,`TFOT` , eller`TBODY` ), från 0. @version DOM Level 2 |
...
| [VAlign](../../aspose.html/htmltablerowelement/valign/) { get; set; } | Vertikal justering av data inom cellerna i denna rad. Se valign attributdefinitionen i HTML 4.01. |
...
| [DeleteCell](../../aspose.html/htmltablerowelement/deletecell/)(int) | Ta bort en cell från den aktuella raden. |
...
| [InsertCell](../../aspose.html/htmltablerowelement/insertcell/)(int) | Infoga en tom`TD` cell in i den här raden. Om `index` är -1 eller lika med antalet celler, läggs den nya -cellen till. |
