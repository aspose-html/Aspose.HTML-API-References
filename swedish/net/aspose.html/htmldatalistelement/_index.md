...
description: Aspose.Html.HTMLDataListElement klass. Datalistelementet representerar en uppsättning alternativelement som representerar fördefinierade alternativ för andra kontroller. Se ävenHTML 5.2 W3Crekommendation .
type: docs
weight: 3160
url: /sv/net/aspose.html/htmldatalistelement/
---
## HTMLDataListElement class

Datalistelementet representerar en uppsättning alternativelement som representerar fördefinierade alternativ för andra kontroller. Se även[HTML 5.2 W3C-rekommendation](https://www.w3.org/TR/html52/sec-forms.html#elementdef-datalist) .
...
| [Options](../../aspose.html/htmldatalistelement/options/) { get; } | Samlingen av`ALTERNATIV`element som ingår i detta element. |
