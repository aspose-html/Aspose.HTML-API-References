...
description: Aspose.Html.HTMLImageElement klass. Inbäddad bild. Se IMGelementdefinitionen i HTML 4.01.
type: docs
weight: 3310
url: /sv/net/aspose.html/htmlimageelement/
---
## HTMLImageElement class

Inbäddad bild. Se IMG-elementdefinitionen i HTML 4.01.
...
| namn | Beskrivning |
| --- | --- |
| [Align](../../aspose.html/htmlimageelement/align/) { get; set; } | Justerar detta objekt (vertikalt eller horisontellt) med avseende på dess omgivande text. Se definitionen av align attribut i HTML 4.01. Det här attributet är utfasat i HTML 4.01. |
| [Alt](../../aspose.html/htmlimageelement/alt/) { get; set; } | Alternativ text för användaragenter som inte återger det normala innehållet i detta element. Se alt-attributdefinitionen i HTML 4.01. |
...
| [Border](../../aspose.html/htmlimageelement/border/) { get; set; } | Bredd på ram runt bilden. Se gränsattributdefinitionen i HTML 4.01. Det här attributet är föråldrat i HTML 4.01. Observera att -typen för detta attribut var`DOMString` i DOM nivå 1 HTML [[DOM nivå 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ] . |
...
| [Height](../../aspose.html/htmlimageelement/height/) { get; set; } | Bildens höjd i pixlar. Se definitionen av höjdattributet i HTML 4.01. Observera att typen av detta attribut var `DOMString` i DOM nivå 1 HTML [[DOM nivå 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ]. @version DOM Nivå 2 |
| [Hspace](../../aspose.html/htmlimageelement/hspace/) { get; set; } | Horisontellt utrymme till vänster och höger om denna bild i pixlar. Se hspace-attributdefinitionen i HTML 4.01. Det här attributet är föråldrat i HTML 4.01. Observera att typen av detta attribut var `DOMString` i DOM nivå 1 HTML [[DOM nivå 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ]. @version DOM Nivå 2 |
...
| [IsMap](../../aspose.html/htmlimageelement/ismap/) { get; set; } | Använd bildkarta på serversidan. Se ismap-attributdefinitionen i HTML 4.01. |
...
| [LongDesc](../../aspose.html/htmlimageelement/longdesc/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] som anger en lång beskrivning av denna bild eller ram. Se longdesc-attributdefinitionen i HTML 4.01. |
| [Name](../../aspose.html/htmlimageelement/name/) { get; set; } | Namnet på elementet (för bakåtkompatibilitet). |
...
| [Src](../../aspose.html/htmlimageelement/src/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] som anger källan till denna bild. Se src-attributet definition i HTML 4.01. |
...
| [UseMap](../../aspose.html/htmlimageelement/usemap/) { get; set; } | Använd bildkarta på klientsidan. Se definitionen av usemap-attribut i HTML 4.01. |
| [Vspace](../../aspose.html/htmlimageelement/vspace/) { get; set; } | Vertikalt utrymme ovanför och under denna bild i pixlar. Se vspace -attributdefinitionen i HTML 4.01. Det här attributet är föråldrat i HTML 4.01. Observera att typen av detta attribut var "DOMString" i DOM Level 1 HTML [[DOM nivå 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ]. @version DOM Nivå 2 |
| [Width](../../aspose.html/htmlimageelement/width/) { get; set; } | Bildens bredd i pixlar. Se width-attributdefinitionen i HTML 4.01. Observera att typen av detta attribut var `DOMString` i DOM nivå 1 HTML [[DOM nivå 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ]. @version DOM Nivå 2 |
