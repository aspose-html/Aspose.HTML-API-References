...
description: Aspose.Html.HTMLObjectElement klass. Generiskt inbäddat objekt. I princip är alla egenskaper på objektelementet lässkriva men i vissa miljöer kan vissa egenskaper vara skrivskyddade när det underliggande objektet instansierats. Se OBJECTelementets definition i HTML 4.01 .
type: docs
weight: 3440
url: /sv/net/aspose.html/htmlobjectelement/
---
## HTMLObjectElement class

Generiskt inbäddat objekt. I princip är alla egenskaper på objektelementet läs-skriva men i vissa miljöer kan vissa egenskaper vara skrivskyddade när det underliggande objektet instansierats. Se OBJECT-elementets definition i [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224) ].
...
| namn | Beskrivning |
| --- | --- |
| [Align](../../aspose.html/htmlobjectelement/align/) { get; set; } | Justerar detta objekt (vertikalt eller horisontellt) med avseende på dess omgivande text. Se definitionen av align attribut i HTML 4.01. Det här attributet är utfasat i HTML 4.01. |
| [Archive](../../aspose.html/htmlobjectelement/archive/) { get; set; } | Mellanslagsseparerad lista över arkiv. Se definitionen av arkivattribut i HTML 4.01. |
...
| [Border](../../aspose.html/htmlobjectelement/border/) { get; set; } | Kantbredden runt objektet. Se gränsattributdefinitionen i HTML 4.01. Det här attributet är utfasat i HTML 4.01. |
...
| [ClassId](../../aspose.html/htmlobjectelement/classid/) { get; set; } | Definierar ett klass-ID-värde som ställts in i Windows-registret eller en URL |
...
| [Code](../../aspose.html/htmlobjectelement/code/) { get; set; } | Applet-klassfil. Se den`koda` attribut för HTMLAppletElement. |
| [CodeBase](../../aspose.html/htmlobjectelement/codebase/) { get; set; } | Bas-URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] för`klassid` ,`data` , och `arkiv` attribut. Se kodbasattributet definition i HTML 4.01. |
| [CodeType](../../aspose.html/htmlobjectelement/codetype/) { get; set; } | Innehållstyp för data som laddas ner via`klassid` attribut. Se kodtypsattributdefinitionen i HTML 4.01. |
| [Data](../../aspose.html/htmlobjectelement/data/) { get; set; } | A URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] som anger platsen för objektets data. Se data attributdefinitionen i HTML 4.01. |
| [Declare](../../aspose.html/htmlobjectelement/declare/) { get; set; } | Deklarera (för framtida referens), men instansiera inte, detta objekt. Se definitionen av deklarera attribut i HTML 4.01. |
...
| [Form](../../aspose.html/htmlobjectelement/form/) { get; set; } | Returnerar`FORM` element som innehåller denna kontroll. Returnerar`null` om denna kontroll inte är inom ramen för ett formulär. |
| [Height](../../aspose.html/htmlobjectelement/height/) { get; set; } | Åsidosätt höjd. Se definitionen av höjdattributet i HTML 4.01. |
| [Hspace](../../aspose.html/htmlobjectelement/hspace/) { get; set; } | Horisontellt utrymme, i pixlar, till vänster och höger om denna bild, applet eller objekt. Se hspace-attributdefinitionen i HTML 4.01. Det här attributet är utfasat i HTML 4.01. |
...
| [Name](../../aspose.html/htmlobjectelement/name/) { get; set; } | Formulärkontroll eller objektnamn när det skickas med ett formulär. Se namnet attributdefinition i HTML 4.01. |
...
| [Standby](../../aspose.html/htmlobjectelement/standby/) { get; set; } | Meddelande att rendera när objektet laddas. Se standby-attributet definition i HTML 4.01. |
...
| [TabIndex](../../aspose.html/htmlobjectelement/tabindex/) { get; set; } | Index som representerar elementets position i tabbordningen. Se tabindex-attributdefinitionen i HTML 4.01. |
...
| [Type](../../aspose.html/htmlobjectelement/type/) { get; set; } | Innehållstyp för data som laddas ner via`data` attribut. Se definitionen av typattributet i HTML 4.01. |
| [UseMap](../../aspose.html/htmlobjectelement/usemap/) { get; set; } | Använd bildkarta på klientsidan. Se definitionen av usemap-attribut i HTML 4.01. |
| [Vspace](../../aspose.html/htmlobjectelement/vspace/) { get; set; } | Vertikalt utrymme, i pixlar, över och under denna bild, applet eller objekt. Se vspace-attributdefinitionen i HTML 4.01. Det här attributet är utfasat i HTML 4.01. |
| [Width](../../aspose.html/htmlobjectelement/width/) { get; set; } | Åsidosätt bredd. Se definitionen av width-attributet i HTML 4.01. |
