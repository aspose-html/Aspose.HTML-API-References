...
description: Aspose.Html.HTMLIsIndexElement klass. Detta element används för textinmatning på en rad. Se ISINDEXelementets definition i HTML 4.01. Detta element är föråldrat i HTML 4.01.
type: docs
weight: 3330
url: /sv/net/aspose.html/htmlisindexelement/
---
## HTMLIsIndexElement class

Detta element används för textinmatning på en rad. Se ISINDEX-elementets definition i HTML 4.01. Detta element är föråldrat i HTML 4.01.
...
| [Form](../../aspose.html/htmlisindexelement/form/) { get; } | Returnerar element som innehåller denna kontroll. Returnerar om denna kontroll inte är inom ramen för ett -formulär. |
...
| [Prompt](../../aspose.html/htmlisindexelement/prompt/) { get; set; } | Uppmaningsmeddelandet. Se definitionen av promptattribut i HTML 4.01. Det här attributet är utfasat i HTML 4.01. |
