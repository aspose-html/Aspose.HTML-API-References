...
description: Aspose.Html.HTMLOptGroupElement klass. Gruppera alternativ i logiska underavdelningar. Se OPTGROUPelementets definition i HTML 4.01.
type: docs
weight: 3450
url: /sv/net/aspose.html/htmloptgroupelement/
---
## HTMLOptGroupElement class

Gruppera alternativ i logiska underavdelningar. Se OPTGROUP-elementets definition i HTML 4.01.
...
| [Disabled](../../aspose.html/htmloptgroupelement/disabled/) { get; set; } | Kontrollen är inte tillgänglig i detta sammanhang. Se disabled-attributet definition i HTML 4.01. |
...
| [Label](../../aspose.html/htmloptgroupelement/label/) { get; set; } | Tilldelar en etikett till denna alternativgrupp. Se etikettattributet definition i HTML 4.01. |
