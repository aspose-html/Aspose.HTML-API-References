...
description: Aspose.Html.HTMLBodyElement klass. HTMLdokumentets brödtext. Detta element finns alltid i DOM API även om taggarna inte finns i källdokumentet. Se BODYelementets definition i HTML 4.01.
type: docs
weight: 3120
url: /sv/net/aspose.html/htmlbodyelement/
---
## HTMLBodyElement class

HTML-dokumentets brödtext. Detta element finns alltid i DOM API, även om taggarna inte finns i källdokumentet. Se BODY-elementets definition i HTML 4.01.
...
| namn | Beskrivning |
| --- | --- |
| [ALink](../../aspose.html/htmlbodyelement/alink/) { get; set; } | Färg på aktiva länkar (efter musknapp ned, men före musknapp upp). Se definitionen av alink-attribut i HTML 4.01. Det här attributet är utfasat i HTML 4.01. |
...
| [Background](../../aspose.html/htmlbodyelement/background/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] av bakgrundstexturbilden. Se bakgrundsattributet definition i HTML 4.01. Det här attributet är utfasat i HTML 4.01. |
...
| [BgColor](../../aspose.html/htmlbodyelement/bgcolor/) { get; set; } | Dokumentets bakgrundsfärg. Se bgcolor-attributdefinitionen i HTML 4.01. Det här attributet är utfasat i HTML 4.01. |
...
| [Link](../../aspose.html/htmlbodyelement/link/) { get; set; } | Färg på länkar som inte är aktiva och obesökta. Se länken attributdefinition i HTML 4.01. Det här attributet är utfasat i HTML 4.01. |
...
| [Text](../../aspose.html/htmlbodyelement/text/) { get; set; } | Dokumenttextfärg. Se textattributdefinitionen i HTML 4.01. Det här attributet är utfasat i HTML 4.01. |
...
| [VLink](../../aspose.html/htmlbodyelement/vlink/) { get; set; } | Färg på länkar som har besökts av användaren. Se vlink -attributdefinitionen i HTML 4.01. Det här attributet är utfasat i HTML 4.01. |
