...
description: Aspose.Html.HTMLLIElement klass. Listobjekt. Se LIelementdefinitionen i HTML 4.01.
type: docs
weight: 3340
url: /sv/net/aspose.html/htmllielement/
---
## HTMLLIElement class

Listobjekt. Se LI-elementdefinitionen i HTML 4.01.
...
| [Type](../../aspose.html/htmllielement/type/) { get; set; } | Listobjekt punktstil. Se typattributdefinitionen i HTML 4.01. Det här attributet är utfasat i HTML 4.01. |
| [Value](../../aspose.html/htmllielement/value/) { get; set; } | Återställ sekvensnummer när det används i`OL` . Se värdet attributdefinition i HTML 4.01. Det här attributet är utfasat i HTML 4.01. |
