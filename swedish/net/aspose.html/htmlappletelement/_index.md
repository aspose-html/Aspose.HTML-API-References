...
description: Aspose.Html.HTMLAppletElement klass. En inbäddad Javaapplet. Se APPLETelementdefinitionen i HTML 4.01. Detta element är utfasat i HTML 4.01.
type: docs
weight: 3070
url: /sv/net/aspose.html/htmlappletelement/
---
## HTMLAppletElement class

En inbäddad Java-applet. Se APPLET-elementdefinitionen i HTML 4.01. Detta element är utfasat i HTML 4.01.
...
| namn | Beskrivning |
| --- | --- |
| [Align](../../aspose.html/htmlappletelement/align/) { get; set; } | Justerar detta objekt (vertikalt eller horisontellt) med avseende på dess omgivande text. Se definitionen av align attribut i HTML 4.01. Det här attributet är utfasat i HTML 4.01. |
| [Alt](../../aspose.html/htmlappletelement/alt/) { get; set; } | Alternativ text för användaragenter som inte återger det normala innehållet i detta element. Se alt-attributdefinitionen i HTML 4.01. Detta -attribut är utfasat i HTML 4.01. |
| [Archive](../../aspose.html/htmlappletelement/archive/) { get; set; } | Kommaseparerad arkivlista. Se definitionen av arkivattribut i HTML 4.01. Det här attributet är utfasat i HTML 4.01. |
...
| [Code](../../aspose.html/htmlappletelement/code/) { get; set; } | Applet-klassfil. Se kodattributdefinitionen i HTML 4.01. Detta -attribut är utfasat i HTML 4.01. |
| [CodeBase](../../aspose.html/htmlappletelement/codebase/) { get; set; } | Valfri bas-URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) för applet. Se kodbasattributdefinitionen i HTML 4.01. Det här attributet är utfasat i HTML 4.01. |
...
| [Height](../../aspose.html/htmlappletelement/height/) { get; set; } | Åsidosätt höjd. Se definitionen av höjdattributet i HTML 4.01. Detta -attribut är utfasat i HTML 4.01. |
| [Hspace](../../aspose.html/htmlappletelement/hspace/) { get; set; } | Horisontellt utrymme, i pixlar, till vänster och höger om denna bild, applet eller objekt. Se hspace-attributdefinitionen i HTML 4.01. Det här attributet är utfasat i HTML 4.01. @version DOM Level 2 |
...
| [Name](../../aspose.html/htmlappletelement/name/) { get; set; } | Namnet på appleten. Se definitionen av namnattribut i HTML 4.01. Det här attributet är utfasat i HTML 4.01. |
...
| [Object](../../aspose.html/htmlappletelement/object/) { get; set; } | Värdet för attributet "object". Se objektattributet definition i HTML 4.01. Det här attributet är föråldrat i HTML 4.01. @version DOM Nivå 2 |
...
| [Vspace](../../aspose.html/htmlappletelement/vspace/) { get; set; } | Vertikalt utrymme, i pixlar, över och under denna bild, applet eller objekt. Se vspace-attributdefinitionen i HTML 4.01. Detta -attribut är utfasat i HTML 4.01. @version DOM Level 2 |
| [Width](../../aspose.html/htmlappletelement/width/) { get; set; } | Åsidosätt bredd. Se width-attributdefinitionen i HTML 4.01. Detta -attribut är utfasat i HTML 4.01. |
