...
description: Aspose.Html.HTMLOptionElement klass. Ett valbart val. Se OPTIONelementdefinitionen i HTML 4.01.
type: docs
weight: 3460
url: /sv/net/aspose.html/htmloptionelement/
---
## HTMLOptionElement class

Ett valbart val. Se OPTION-elementdefinitionen i HTML 4.01.
...
| [DefaultSelected](../../aspose.html/htmloptionelement/defaultselected/) { get; set; } | Representerar värdet för det valda HTML-attributet. Värdet på detta -attribut ändras inte om tillståndet för motsvarande formulär -kontroll, i en interaktiv användaragent, ändras. Se den valda -attributdefinitionen i HTML 4.01. @version DOM Level 2 |
...
| [Disabled](../../aspose.html/htmloptionelement/disabled/) { get; set; } | Kontrollen är inte tillgänglig i detta sammanhang. Se definitionen av inaktiverat attribut i HTML 4.01. |
...
| [Form](../../aspose.html/htmloptionelement/form/) { get; } | Returnerar`FORM` element som innehåller denna kontroll. Returnerar `null` om denna kontroll inte är inom ramen för ett -formulär. |
| [Id](../../aspose.html/htmlelement/id/) { get; set; } | Elementets identifierare. Se definitionen av id-attributet i HTML 4.01. |
| [Index](../../aspose.html/htmloptionelement/index/) { get; } | Indexet för detta`ALTERNATIV` i sin förälder`VÄLJ` , från 0. @version DOM Level 2 |
...
| [Label](../../aspose.html/htmloptionelement/label/) { get; set; } | Alternativetikett för användning i hierarkiska menyer. Se definitionen av etikettattribut i HTML 4.01. |
...
| [Selected](../../aspose.html/htmloptionelement/selected/) { get; set; } | Representerar det aktuella tillståndet för motsvarande formulärkontroll, i en interaktiv användaragent. Om du ändrar det här attributet ändras statusen för formulärkontrollen, men ändrar inte värdet på det HTML-valda -attributet för elementet. |
...
| [Text](../../aspose.html/htmloptionelement/text/) { get; } | Texten som finns i alternativelementet. |
...
| [Value](../../aspose.html/htmloptionelement/value/) { get; set; } | Det aktuella formulärkontrollvärdet. Se definitionen av värdeattributet i HTML 4.01. |
