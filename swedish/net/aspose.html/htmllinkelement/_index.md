...
description: Aspose.Html.HTMLLinkElement klass. DenLÄNKelement anger en länk till en extern resurs och definierar detta dokuments relation till den resursen eller vice versa. Se LINKelementdefinitionen i HTML 4.01 se även LinkStyle gränssnitt i StyleSheetmodulen DOM Level 2 Style Sheets och CSS .
type: docs
weight: 3370
url: /sv/net/aspose.html/htmllinkelement/
---
## HTMLLinkElement class

Den`LÄNK`element anger en länk till en extern resurs och definierar detta dokuments relation till den resursen (eller vice versa). Se LINK-elementdefinitionen i HTML 4.01 (se även `LinkStyle` gränssnitt i StyleSheet-modulen [[DOM Level 2 Style Sheets och CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113) ]).
...
| [Charset](../../aspose.html/htmllinkelement/charset/) { get; set; } | Teckenkodningen för resursen som länkas till. Se teckenuppsättningen attributdefinition i HTML 4.01. |
...
| [Disabled](../../aspose.html/htmllinkelement/disabled/) { get; set; } | Aktiverar/inaktiverar länken. Detta används för närvarande endast för stilmallslänkar och kan användas för att aktivera eller inaktivera stilmallar. |
...
| [Href](../../aspose.html/htmllinkelement/href/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] av den länkade resursen. Se href-attributdefinitionen i HTML 4.01. |
| [Hreflang](../../aspose.html/htmllinkelement/hreflang/) { get; set; } | Språkkoden för den länkade resursen. Se hreflang-attributet definition i HTML 4.01. |
...
| [Media](../../aspose.html/htmllinkelement/media/) { get; set; } | Designad för användning med ett eller flera målmedia. Se medieattributet definition i HTML 4.01. |
...
| [Rel](../../aspose.html/htmllinkelement/rel/) { get; set; } | Vidarebefordra länktyp. Se rel-attributdefinitionen i HTML 4.01. |
| [RelList](../../aspose.html/htmllinkelement/rellist/) { get; } | Returnerar en levande DOMTokenList som innehåller tokens som tagits emot från att analysera "rel"-attributet. |
| [Rev](../../aspose.html/htmllinkelement/rev/) { get; set; } | Typ av omvänd länk. Se rev-attributdefinitionen i HTML 4.01. |
...
| [Sheet](../../aspose.html/htmllinkelement/sheet/) { get; } | Hämtar tillhörande stilmall. |
...
| [Target](../../aspose.html/htmllinkelement/target/) { get; set; } | Ram att rendera resursen i. Se målattributdefinitionen i HTML 4.01. |
...
| [Type](../../aspose.html/htmllinkelement/type/) { get; set; } | Rådgivande innehållstyp. Se typattributdefinitionen i HTML 4.01. |
