...
description: Aspose.Html.HTMLHeadingElement klass. FörH1 tillH6 element. Se definitionen av H1 element i HTML 4.01.
type: docs
weight: 3280
url: /sv/net/aspose.html/htmlheadingelement/
---
## HTMLHeadingElement class

För`H1` till`H6` element. Se definitionen av H1 element i HTML 4.01.
...
| namn | Beskrivning |
| --- | --- |
| [Align](../../aspose.html/htmlheadingelement/align/) { get; set; } | Horisontell textjustering. Se definitionen av align attribut i HTML 4.01. Det här attributet är utfasat i HTML 4.01. |
