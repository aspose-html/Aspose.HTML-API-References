...
description: Aspose.Html.HTMLModElement klass. Meddelande om ändring av en del av ett dokument. Se INS och DELelementets definitioner i HTML 4.01.
type: docs
weight: 3410
url: /sv/net/aspose.html/htmlmodelement/
---
## HTMLModElement class

Meddelande om ändring av en del av ett dokument. Se INS- och DEL-elementets definitioner i HTML 4.01.
...
| [Cite](../../aspose.html/htmlmodelement/cite/) { get; set; } | A URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] utse en handling som beskriver anledningen till ändringen. Se definitionen av citera attribut i HTML 4.01. |
...
| [DateTime](../../aspose.html/htmlmodelement/datetime/) { get; set; } | Datum och tid för ändringen. Se datetime-attributdefinitionen i HTML 4.01. |
