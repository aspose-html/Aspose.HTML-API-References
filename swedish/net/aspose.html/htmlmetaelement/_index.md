...
description: Aspose.Html.HTMLMetaElement klass. Detta innehåller generisk metainformation om dokumentet. Se META elementdefinitionen i HTML 4.01.
type: docs
weight: 3400
url: /sv/net/aspose.html/htmlmetaelement/
---
## HTMLMetaElement class

Detta innehåller generisk metainformation om dokumentet. Se META elementdefinitionen i HTML 4.01.
...
| [Content](../../aspose.html/htmlmetaelement/content/) { get; set; } | Tillhörande information. Se definitionen av innehållsattribut i HTML 4.01. |
...
| [HttpEquiv](../../aspose.html/htmlmetaelement/httpequiv/) { get; set; } | HTTP-svarshuvudnamn [[IETF RFC 2616](http://www.ietf.org/rfc/rfc2616.txt) ]. Se http-equiv-attributdefinitionen i HTML 4.01. |
...
| [Name](../../aspose.html/htmlmetaelement/name/) { get; set; } | Namn på metainformation. Se definitionen av namnattribut i HTML 4.01. |
...
| [Scheme](../../aspose.html/htmlmetaelement/scheme/) { get; set; } | Välj form av innehåll. Se definitionen av schemaattributet i HTML 4.01. |
