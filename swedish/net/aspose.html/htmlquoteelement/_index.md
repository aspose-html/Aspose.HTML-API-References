...
description: Aspose.Html.HTMLQuoteElement klass. FörF ochBLOCK CITATelement. Se Q elementdefinitionen i HTML 4.01.
type: docs
weight: 3500
url: /sv/net/aspose.html/htmlquoteelement/
---
## HTMLQuoteElement class

För`F` och`BLOCK CITAT`element. Se Q elementdefinitionen i HTML 4.01.
...
| [Cite](../../aspose.html/htmlquoteelement/cite/) { get; set; } | A URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] betecknar ett källdokument eller meddelande. Se citera attributet definition i HTML 4.01. |
