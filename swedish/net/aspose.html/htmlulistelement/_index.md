...
description: Aspose.Html.HTMLUListElement klass. Oordnad lista. Se definitionen av ULelement i HTML 4.01.
type: docs
weight: 3630
url: /sv/net/aspose.html/htmlulistelement/
---
## HTMLUListElement class

Oordnad lista. Se definitionen av UL-element i HTML 4.01.
...
| [Compact](../../aspose.html/htmlulistelement/compact/) { get; set; } | Minska avståndet mellan listobjekt. Se den kompakta attributdefinitionen i HTML 4.01. Det här attributet är utfasat i HTML 4.01. |
...
| [Type](../../aspose.html/htmlulistelement/type/) { get; set; } | Kulstil. Se typattributdefinitionen i HTML 4.01. Detta -attribut är utfasat i HTML 4.01. |
