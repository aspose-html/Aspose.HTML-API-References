...
description: Aspose.Html.HTMLFieldSetElement klass. Ordnar formulärkontroller i logiska grupper. Se FIELDSETelementets definition i HTML 4.01.
type: docs
weight: 3210
url: /sv/net/aspose.html/htmlfieldsetelement/
---
## HTMLFieldSetElement class

Ordnar formulärkontroller i logiska grupper. Se FIELDSET-elementets definition i HTML 4.01.
...
| [Form](../../aspose.html/htmlfieldsetelement/form/) { get; } | Returnerar`FORM` element som innehåller denna kontroll. Returnerar `null` om denna kontroll inte är inom ramen för ett -formulär. |
