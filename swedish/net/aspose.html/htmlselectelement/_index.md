...
description: Aspose.Html.HTMLSelectElement klass. Selectelementet tillåter val av ett alternativ. De inneslutna alternativen kan nås direkt via selectelementet som en samling. Se SELECTelementdefinitionen i HTML 4.01.
type: docs
weight: 3520
url: /sv/net/aspose.html/htmlselectelement/
---
## HTMLSelectElement class

Select-elementet tillåter val av ett alternativ. De inneslutna alternativen kan nås direkt via select-elementet som en samling. Se SELECT-elementdefinitionen i HTML 4.01.
...
| [Disabled](../../aspose.html/htmlselectelement/disabled/) { get; set; } | Kontrollen är inte tillgänglig i detta sammanhang. Se disabled-attributet definition i HTML 4.01. |
...
| [Form](../../aspose.html/htmlselectelement/form/) { get; } | Antalet alternativ i denna`VÄLJ` . |
...
| [Length](../../aspose.html/htmlselectelement/length/) { get; set; } | Antalet alternativ i denna`VÄLJ` . @version DOM Nivå 2 |
...
| [Multiple](../../aspose.html/htmlselectelement/multiple/) { get; set; } | Om sant, multipla`ALTERNATIV` element kan väljas i denna`VÄLJ` . Se definitionen av flera attribut i HTML 4.01. |
| [Name](../../aspose.html/htmlselectelement/name/) { get; set; } | Formulärkontroll eller objektnamn när det skickas med ett formulär. Se namnet attributdefinition i HTML 4.01. |
...
| [Options](../../aspose.html/htmlselectelement/options/) { get; } | Samlingen av`ALTERNATIV` element som ingår i detta element. @version DOM Nivå 2 |
...
| [SelectedIndex](../../aspose.html/htmlselectelement/selectedindex/) { get; set; } | Ordinalindexet för det valda alternativet, med start från 0. Värdet -1 returneras om inget element är markerat. Om flera alternativ är valda, returneras indexet för det först valda alternativet. |
...
| [Size](../../aspose.html/htmlselectelement/size/) { get; set; } | Antal synliga rader. Se storleksattributdefinitionen i HTML 4.01. |
...
| [TabIndex](../../aspose.html/htmlselectelement/tabindex/) { get; set; } | Index som representerar elementets position i tabbordningen. Se tabindex-attributdefinitionen i HTML 4.01. |
...
| [Type](../../aspose.html/htmlselectelement/type/) { get; } | Typen av denna formulärkontroll. Detta är strängen "select-multiple" när multipelattributet är`Sann` och strängen "select-one" när`falsk` . |
| [Value](../../aspose.html/htmlselectelement/value/) { get; set; } | Det aktuella formulärkontrollvärdet (dvs värdet för det för närvarande valda alternativet ), om flera alternativ är valda är detta värdet för det först valda alternativet. |
