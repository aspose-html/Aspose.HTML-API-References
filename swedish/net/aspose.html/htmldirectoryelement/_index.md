...
description: Aspose.Html.HTMLDirectoryElement klass. Kataloglista. Se DIRelementdefinitionen i HTML 4.01. Det här elementet är utfasat i HTML 4.01.
type: docs
weight: 3170
url: /sv/net/aspose.html/htmldirectoryelement/
---
## HTMLDirectoryElement class

Kataloglista. Se DIR-elementdefinitionen i HTML 4.01. Det här elementet är utfasat i HTML 4.01.
...
| [Compact](../../aspose.html/htmldirectoryelement/compact/) { get; set; } | Minska avståndet mellan listobjekt. Se den kompakta attributdefinitionen i HTML 4.01. Det här attributet är utfasat i HTML 4.01. |
