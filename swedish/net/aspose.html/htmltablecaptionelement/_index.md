...
description: Aspose.Html.HTMLTableCaptionElement klass. Tabelltext Se CAPTIONelementdefinitionen i HTML 4.01.
type: docs
weight: 3540
url: /sv/net/aspose.html/htmltablecaptionelement/
---
## HTMLTableCaptionElement class

Tabelltext Se CAPTION-elementdefinitionen i HTML 4.01.
...
| namn | Beskrivning |
| --- | --- |
| [Align](../../aspose.html/htmltablecaptionelement/align/) { get; set; } | Bildtextjustering med avseende på tabellen. Se definitionen av align attributet i HTML 4.01. Det här attributet är utfasat i HTML 4.01. |
