...
description: Aspose.Html.HTMLFrameElement klass. Skapa en ram. Se FRAMEelementdefinitionen i HTML 4.01.
type: docs
weight: 3240
url: /sv/net/aspose.html/htmlframeelement/
---
## HTMLFrameElement class

Skapa en ram. Se FRAME-elementdefinitionen i HTML 4.01.
...
| [ContentDocument](../../aspose.html/htmlframeelement/contentdocument/) { get; } | Dokumentet som denna ram innehåller, om det finns något och det är tillgängligt, eller`null` annars. @sedan DOM nivå 2 |
...
| [FrameBorder](../../aspose.html/htmlframeelement/frameborder/) { get; set; } | Begär ramkanter. Se frameborder-attributdefinitionen i HTML 4.01. |
...
| [LongDesc](../../aspose.html/htmlframeelement/longdesc/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] som anger en lång beskrivning av denna bild eller ram. Se longdesc-attributdefinitionen i HTML 4.01. |
| [MarginHeight](../../aspose.html/htmlframeelement/marginheight/) { get; set; } | Rammarginalens höjd, i pixlar. Se marginheight-attributet definition i HTML 4.01. |
| [MarginWidth](../../aspose.html/htmlframeelement/marginwidth/) { get; set; } | Rammarginalens bredd, i pixlar. Se marginwidth-attributdefinitionen i HTML 4.01. |
| [Name](../../aspose.html/htmlframeelement/name/) { get; set; } | Ramnamnet (objektet i`mål` attribut). Se definitionen av attributet name i HTML 4.01. |
...
| [NoResize](../../aspose.html/htmlframeelement/noresize/) { get; set; } | När sant, förbjud användaren att ändra storlek på ram. Se noresize-attributet definition i HTML 4.01. |
...
| [Scrolling](../../aspose.html/htmlframeelement/scrolling/) { get; set; } | Ange om ramen ska ha rullningslister eller inte. Se definitionen av rullningsattribut i HTML 4.01. |
...
| [Src](../../aspose.html/htmlframeelement/src/) { get; set; } | A URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] som anger det ursprungliga raminnehållet. Se src-attributet definition i HTML 4.01. |
