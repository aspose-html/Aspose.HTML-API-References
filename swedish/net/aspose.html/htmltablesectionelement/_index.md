...
description: Aspose.Html.HTMLTableSectionElement klass. DenTHEAD TFOT  ochTBODY element.
type: docs
weight: 3590
url: /sv/net/aspose.html/htmltablesectionelement/
---
## HTMLTableSectionElement class

Den`THEAD` ,`TFOT` , och`TBODY` element.
...
| namn | Beskrivning |
| --- | --- |
| [Align](../../aspose.html/htmltablesectionelement/align/) { get; set; } | Horisontell justering av data i celler. Se den`justera` attribut för HTMLTheadElement för detaljer. |
...
| [Ch](../../aspose.html/htmltablesectionelement/ch/) { get; set; } | Justeringstecken för celler i en kolumn. Se char-attributet definition i HTML 4.01. |
...
| [ChOff](../../aspose.html/htmltablesectionelement/choff/) { get; set; } | Offset av inriktningstecken. Se definitionen av charoff-attributet i HTML 4.01. |
...
| [Rows](../../aspose.html/htmltablesectionelement/rows/) { get; } | Samlingen av rader i detta tabellavsnitt. |
...
| [VAlign](../../aspose.html/htmltablesectionelement/valign/) { get; set; } | Vertikal justering av data i celler. Se den`valign` attribut för HTMLTheadElement för detaljer. |
...
| [DeleteRow](../../aspose.html/htmltablesectionelement/deleterow/)(int) | Ta bort en rad från det här avsnittet. |
...
| [InsertRow](../../aspose.html/htmltablesectionelement/insertrow/)(int) | Infoga en rad i det här avsnittet. Den nya raden infogas omedelbart före den nuvarande`index` raden i detta avsnitt. Om `index` är -1 eller lika med antalet rader i denna -sektion, läggs den nya raden till. |
