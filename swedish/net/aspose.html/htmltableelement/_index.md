...
description: Aspose.Html.HTMLTableElement klass. Metoderna skapa och ta bort i tabellen tillåter författare att konstruera och modifiera tabeller. HTML 4.01  anger att endast en av var och en av RUBRIK THEAD  ochTFOT elementen kan finnas i en tabell. Därför om det finns en och metoden createTHead eller createTFoot anropas returnerar metoden det befintliga THead eller TFootelementet. Se TABLEelementdefinitionen i HTML 4.01.
type: docs
weight: 3570
url: /sv/net/aspose.html/htmltableelement/
---
## HTMLTableElement class

Metoderna skapa* och ta bort* i tabellen tillåter författare att konstruera och modifiera tabeller. [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224) ] anger att endast en av var och en av `RUBRIK` ,`THEAD` , och`TFOT` elementen kan finnas i en tabell. Därför, om det finns en och metoden createTHead() eller createTFoot() anropas, returnerar metoden det befintliga THead- eller TFoot-elementet. Se TABLE-elementdefinitionen i HTML 4.01.
...
| namn | Beskrivning |
| --- | --- |
| [Align](../../aspose.html/htmltableelement/align/) { get; set; } | Anger tabellens position i förhållande till resten av dokumentet . Se definitionen av align attribut i HTML 4.01. Detta -attribut är utfasat i HTML 4.01. |
...
| [BgColor](../../aspose.html/htmltableelement/bgcolor/) { get; set; } | Cellbakgrundsfärg. Se bgcolor-attributdefinitionen i HTML 4.01. Det här attributet är utfasat i HTML 4.01. |
| [Border](../../aspose.html/htmltableelement/border/) { get; set; } | Bredden på kanten runt bordet. Se gränsattributet definition i HTML 4.01. |
| [Caption](../../aspose.html/htmltableelement/caption/) { get; } | Returnerar tabellens`RUBRIK` , eller ogiltig om ingen finns. @version DOM Nivå 2 |
| [CellPadding](../../aspose.html/htmltableelement/cellpadding/) { get; set; } | Anger det horisontella och vertikala utrymmet mellan cellinnehåll och cellkanter. Se definitionen av cellpadding-attribut i HTML 4.01. |
| [CellSpacing](../../aspose.html/htmltableelement/cellspacing/) { get; set; } | Anger den horisontella och vertikala separationen mellan celler. Se definitionen av cellmellanrumsattribut i HTML 4.01. |
...
| [Frame](../../aspose.html/htmltableelement/frame/) { get; set; } | Anger vilka externa tabellkanter som ska renderas. Se ram attributdefinition i HTML 4.01. |
...
| [Rows](../../aspose.html/htmltableelement/rows/) { get; } | Returnerar tabellens`TFOT` , eller`null` om ingen finns. |
| [Rules](../../aspose.html/htmltableelement/rules/) { get; set; } | Anger vilka interna tabellkanter som ska renderas. Se reglerna attributdefinition i HTML 4.01. |
...
| [Summary](../../aspose.html/htmltableelement/summary/) { get; set; } | Beskrivning om syftet eller strukturen för en tabell. Se sammanfattningen av attributdefinitionen i HTML 4.01. |
| [TagName](../../aspose.html.dom/element/tagname/) { get; } | Namnet på elementet. |
| [TBodies](../../aspose.html/htmltableelement/tbodies/) { get; } | Returnerar en samling av tabellkropparna (inklusive implicita). |
...
| [TFoot](../../aspose.html/htmltableelement/tfoot/) { get; } | Returnerar tabellens`THEAD` , eller`null` om ingen finns. |
| [THead](../../aspose.html/htmltableelement/thead/) { get; } | Returnerar tabellens`RUBRIK` , eller ogiltig om ingen finns. |
| [Title](../../aspose.html/htmlelement/title/) { get; set; } | Elementets rådgivande titel. Se titelattributdefinitionen i HTML 4.01. |
| [Width](../../aspose.html/htmltableelement/width/) { get; set; } | Anger önskad tabellbredd. Se width-attributdefinitionen i HTML 4.01. |
...
| [CreateCaption](../../aspose.html/htmltableelement/createcaption/)() | Skapa ett nytt tabelltextobjekt eller returnera ett befintligt. |
| [CreateTFoot](../../aspose.html/htmltableelement/createtfoot/)() | Skapa en tabellsidfotsrad eller returnera en befintlig. |
| [CreateTHead](../../aspose.html/htmltableelement/createthead/)() | Skapa en tabellrubrikrad eller returnera en befintlig. |
| [DeleteCaption](../../aspose.html/htmltableelement/deletecaption/)() | Ta bort tabelltexten, om en sådan finns. |
| [DeleteRow](../../aspose.html/htmltableelement/deleterow/)(int) | Ta bort en tabellrad. |
| [DeleteTFoot](../../aspose.html/htmltableelement/deletetfoot/)() | Ta bort sidfoten från tabellen, om en sådan finns. |
| [DeleteTHead](../../aspose.html/htmltableelement/deletethead/)() | Ta bort rubriken från tabellen, om en sådan finns. |
