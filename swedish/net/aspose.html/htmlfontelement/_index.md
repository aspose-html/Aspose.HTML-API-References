...
description: Aspose.Html.HTMLFontElement klass. Lokal ändring av teckensnitt. Se FONTelementdefinitionen i HTML 4.01. Detta element är utfasat i HTML 4.01.
type: docs
weight: 3220
url: /sv/net/aspose.html/htmlfontelement/
---
## HTMLFontElement class

Lokal ändring av teckensnitt. Se FONT-elementdefinitionen i HTML 4.01. Detta -element är utfasat i HTML 4.01.
...
| [Color](../../aspose.html/htmlfontelement/color/) { get; set; } | Teckensnittsfärg. Se färgattributdefinitionen i HTML 4.01. Detta -attribut är utfasat i HTML 4.01. |
...
| [Face](../../aspose.html/htmlfontelement/face/) { get; set; } | Teckensnittsidentifierare. Se definitionen av ansiktsattribut i HTML 4.01. Det här attributet är utfasat i HTML 4.01. |
...
| [Size](../../aspose.html/htmlfontelement/size/) { get; set; } | Teckenstorlek. Se definitionen av storleksattribut i HTML 4.01. Detta -attribut är utfasat i HTML 4.01. |
