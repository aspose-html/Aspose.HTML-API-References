...
description: Aspose.Html.HTMLFormElement klass. DenFORM element omfattar beteende som liknar en samling och ett element. Det ger direkt åtkomst till de inneslutna formulärkontrollerna såväl som attributen för formulärelementet. Se definitionen av FORMelementet i HTML 4.01.
type: docs
weight: 3230
url: /sv/net/aspose.html/htmlformelement/
---
## HTMLFormElement class

Den`FORM` element omfattar beteende som liknar en samling och ett element. Det ger direkt åtkomst till de inneslutna formulärkontrollerna såväl som attributen för formulärelementet. Se definitionen av FORM-elementet i HTML 4.01.
...
| namn | Beskrivning |
| --- | --- |
| [AcceptCharset](../../aspose.html/htmlformelement/acceptcharset/) { get; set; } | Lista över teckenuppsättningar som stöds av servern. Se accept-charset attributdefinitionen i HTML 4.01. |
| [Action](../../aspose.html/htmlformelement/action/) { get; set; } | Formulärhanterare på serversidan. Se definitionen av handlingsattribut i HTML 4.01. |
...
| [Elements](../../aspose.html/htmlformelement/elements/) { get; } | Returnerar en samling av alla formulärkontrollelement i formuläret. |
| [Enctype](../../aspose.html/htmlformelement/enctype/) { get; set; } | Innehållstypen för det inskickade formuläret, vanligtvis "application/x-www-form-urlencoded". Se enctype-attributet definition i HTML 4.01. Onsubmit even-hanteraren garanteras inte att utlöses när den här metoden anropas. Beteendet är inkonsekvent av historiska skäl och författare bör inte förlita sig på en viss . |
...
| [Length](../../aspose.html/htmlformelement/length/) { get; } | Antalet formulärkontroller i formuläret. |
...
| [Method](../../aspose.html/htmlformelement/method/) { get; set; } | HTTP-metod [[IETF RFC 2616](http://www.ietf.org/rfc/rfc2616.txt) används för att skicka in formuläret. Se metodattributdefinitionen i HTML 4.01. |
| [Name](../../aspose.html/htmlformelement/name/) { get; set; } | Namner formuläret. |
...
| [Target](../../aspose.html/htmlformelement/target/) { get; set; } | Ram att rendera resursen i. Se målattributdefinitionen i HTML 4.01. |
...
| [Reset](../../aspose.html/htmlformelement/reset/)() | Återställer ett formulärelements standardvärden. Den utför samma åtgärd som en återställningsknapp. |
...
| [Submit](../../aspose.html/htmlformelement/submit/)() | Skickar in formuläret. Den utför samma åtgärd som en skicka-knapp. |
