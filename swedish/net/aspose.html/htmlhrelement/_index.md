...
description: Aspose.Html.HTMLHRElement klass. Skapa en horisontell regel. Se definitionen av HRelement i HTML 4.01.
type: docs
weight: 3260
url: /sv/net/aspose.html/htmlhrelement/
---
## HTMLHRElement class

Skapa en horisontell regel. Se definitionen av HR-element i HTML 4.01.
...
| namn | Beskrivning |
| --- | --- |
| [Align](../../aspose.html/htmlhrelement/align/) { get; set; } | Justera regeln på sidan. Se definitionen av align attribut i HTML 4.01. Det här attributet är utfasat i HTML 4.01. |
...
| [NoShade](../../aspose.html/htmlhrelement/noshade/) { get; set; } | Indikerar för användaragenten att det inte ska finnas någon skuggning i -renderingen av detta element. Se definitionen av noshade-attribut i HTML 4.01. Det här attributet är utfasat i HTML 4.01. |
...
| [Size](../../aspose.html/htmlhrelement/size/) { get; set; } | Regelns höjd. Se definitionen av storleksattribut i HTML 4.01. Det här attributet är utfasat i HTML 4.01. |
...
| [Width](../../aspose.html/htmlhrelement/width/) { get; set; } | Regelns bredd. Se width-attributdefinitionen i HTML 4.01. Det här attributet är utfasat i HTML 4.01. |
