...
description: Aspose.Html.HTMLBaseFontElement klass. Basteckensnitt. Se BASEFONTelementdefinitionen i HTML 4.01. Det här elementet är utfasat i HTML 4.01.
type: docs
weight: 3110
url: /sv/net/aspose.html/htmlbasefontelement/
---
## HTMLBaseFontElement class

Basteckensnitt. Se BASEFONT-elementdefinitionen i HTML 4.01. Det här elementet är utfasat i HTML 4.01.
...
| [Color](../../aspose.html/htmlbasefontelement/color/) { get; set; } | Teckensnittsfärg. Se färgattributdefinitionen i HTML 4.01. Detta -attribut är utfasat i HTML 4.01. |
...
| [Face](../../aspose.html/htmlbasefontelement/face/) { get; set; } | Teckensnittsidentifierare. Se definitionen av ansiktsattribut i HTML 4.01. Det här attributet är utfasat i HTML 4.01. |
...
| [Size](../../aspose.html/htmlbasefontelement/size/) { get; set; } | Beräknad teckenstorlek. Se definitionen av storleksattribut i HTML 4.01. Det här attributet är utfasat i HTML 4.01. @version DOM Level 2 |
