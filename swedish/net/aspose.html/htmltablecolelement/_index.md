...
description: Aspose.Html.HTMLTableColElement klass. OmgrupperarCOL ochKOLGROUP element. Se COL elementdefinitionen i HTML 4.01.
type: docs
weight: 3560
url: /sv/net/aspose.html/htmltablecolelement/
---
## HTMLTableColElement class

Omgrupperar`COL` och`KOLGROUP` element. Se COL elementdefinitionen i HTML 4.01.
...
| namn | Beskrivning |
| --- | --- |
| [Align](../../aspose.html/htmltablecolelement/align/) { get; set; } | Horisontell justering av celldata i kolumn. Se align attributet definition i HTML 4.01. |
...
| [Ch](../../aspose.html/htmltablecolelement/ch/) { get; set; } | Justeringstecken för celler i en kolumn. Se char-attributet definition i HTML 4.01. |
...
| [ChOff](../../aspose.html/htmltablecolelement/choff/) { get; set; } | Offset av inriktningstecken. Se definitionen av charoff-attributet i HTML 4.01. |
...
| [Span](../../aspose.html/htmltablecolelement/span/) { get; set; } | Indikerar antalet kolumner i en grupp eller som påverkas av en gruppering. Se span-attributdefinitionen i HTML 4.01. |
...
| [VAlign](../../aspose.html/htmltablecolelement/valign/) { get; set; } | Vertikal justering av celldata i kolumn. Se valign-attributet definition i HTML 4.01. |
| [Width](../../aspose.html/htmltablecolelement/width/) { get; set; } | Standard kolumnbredd. Se definitionen av width-attributet i HTML 4.01. |
