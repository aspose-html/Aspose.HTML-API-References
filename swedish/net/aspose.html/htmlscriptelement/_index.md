...
description: Aspose.Html.HTMLScriptElement klass. Skriptsatser. Se SCRIPTelementdefinitionen i HTML 4.01.
type: docs
weight: 3510
url: /sv/net/aspose.html/htmlscriptelement/
---
## HTMLScriptElement class

Skriptsatser. Se SCRIPT-elementdefinitionen i HTML 4.01.
...
| [Charset](../../aspose.html/htmlscriptelement/charset/) { get; set; } | Teckenkodningen för den länkade resursen. Se teckenuppsättningen attributdefinition i HTML 4.01. |
...
| [Defer](../../aspose.html/htmlscriptelement/defer/) { get; set; } | Indikerar att användaragenten kan skjuta upp bearbetningen av skriptet. Se definitionen av defer-attributet i HTML 4.01. |
...
| [Event](../../aspose.html/htmlscriptelement/event/) { get; set; } | Reserverad för framtida bruk. |
...
| [Src](../../aspose.html/htmlscriptelement/src/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] betecknar ett externt skript. Se src-attributdefinitionen i HTML 4.01. |
...
| [Text](../../aspose.html/htmlscriptelement/text/) { get; set; } | Skriptinnehållet i elementet. |
...
| [Type](../../aspose.html/htmlscriptelement/type/) { get; set; } | Innehållstypen för skriptspråket. Se typattributet definition i HTML 4.01. |
