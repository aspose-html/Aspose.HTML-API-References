...
description: Namnutrymmet som representeras av nodfiltreringsfunktionalitet. Filter är objekt som vet hur man filtrerar bort noder. Om en noditerator eller trädvandrare ges ett nodfilter tillämpar den filtret innan den returnerar nästa nod. Om filtret säger att man ska acceptera noden returnerar traversallogic den annars letar traversal efter nästa nod och låtsas att noden som avvisades inte var där.
type: docs
weight: 180
url: /sv/net/aspose.html.dom.traversal.filters/
---
...
| Klass | Beskrivning |
| --- | --- |
| [NodeFilter](./nodefilter/) | Filter är objekt som vet hur man "filtrerar bort" noder. |
