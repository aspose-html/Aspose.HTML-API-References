...
description: Aspose.Html.Dom.Svg.Filters.SVGFEBlendElement klass. SVGFEBlendElementgränssnittet motsvarar elementet feBlend.
type: docs
weight: 1360
url: /sv/net/aspose.html.dom.svg.filters/svgfeblendelement/
---
...
| [Height](../../aspose.html.dom.svg.filters/svgfeblendelement/height/) { get; } | Motsvarar attributet 'höjd' på det givna 'filter'-elementet. |
...
| [In1](../../aspose.html.dom.svg.filters/svgfeblendelement/in1/) { get; } | Motsvarar attributet 'in' på det givna 'feBlend'-elementet. |
| [In2](../../aspose.html.dom.svg.filters/svgfeblendelement/in2/) { get; } | Motsvarar attributet 'in2' på det givna 'feBlend'-elementet. |
...
| [Mode](../../aspose.html.dom.svg.filters/svgfeblendelement/mode/) { get; } | Motsvarar attributet 'mode' på det givna 'feBlend'-elementet. Tar en av SVG_FEBLEND_MODE_*-konstanterna som definierats i detta gränssnitt. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfeblendelement/result/) { get; } | Motsvarar attributet 'result' på det givna 'filter'-elementet. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfeblendelement/width/) { get; } | Motsvarar attributet 'width' på det givna 'filter'-elementet. |
| [X](../../aspose.html.dom.svg.filters/svgfeblendelement/x/) { get; } | Motsvarar attributet 'x' på det givna 'filter'-elementet. |
| [Y](../../aspose.html.dom.svg.filters/svgfeblendelement/y/) { get; } | Motsvarar attributet 'y' på det givna 'filter'-elementet. |
...
| namn | Beskrivning |
| --- | --- |
| const [SVG_FEBLEND_MODE_COLOR](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_color/) | Motsvarar värdet 'color'. |
| const [SVG_FEBLEND_MODE_COLOR_BURN](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_color_burn/) | Motsvarar värdet 'color_burn'. |
| const [SVG_FEBLEND_MODE_COLOR_DODGE](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_color_dodge/) | Motsvarar värdet 'color_dodge'. |
| const [SVG_FEBLEND_MODE_DARKEN](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_darken/) | Motsvarar värdet 'mörkare'. |
| const [SVG_FEBLEND_MODE_DIFFERENCE](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_difference/) | Motsvarar värdet 'difference'. |
| const [SVG_FEBLEND_MODE_EXCLUSION](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_exclusion/) | Motsvarar värdet 'exclusion'. |
| const [SVG_FEBLEND_MODE_HARD_LIGHT](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_hard_light/) | Motsvarar värdet 'hard_light'. |
| const [SVG_FEBLEND_MODE_HUE](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_hue/) | Motsvarar värdet 'hue'. |
| const [SVG_FEBLEND_MODE_LIGHTEN](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_lighten/) | Motsvarar värdet 'lighten'. |
| const [SVG_FEBLEND_MODE_LUMINOSITY](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_luminosity/) | Motsvarar värdet 'luminosity'. |
| const [SVG_FEBLEND_MODE_MULTIPLY](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_multiply/) | Motsvarar värdet 'multiplicera'. |
| const [SVG_FEBLEND_MODE_NORMAL](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_normal/) | Motsvarar värdet "normalt". |
| const [SVG_FEBLEND_MODE_OVERLAY](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_overlay/) | Motsvarar värdet 'overlay'. |
| const [SVG_FEBLEND_MODE_SATURATION](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_saturation/) | Motsvarar värdet 'saturation'. |
| const [SVG_FEBLEND_MODE_SCREEN](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_screen/) | Motsvarar värdet 'skärm'. |
| const [SVG_FEBLEND_MODE_SOFT_LIGHT](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_soft_light/) | Motsvarar värdet 'soft_light'. |
| const [SVG_FEBLEND_MODE_UNKNOWN](../../aspose.html.dom.svg.filters/svgfeblendelement/svg_feblend_mode_unknown/) | Typen är inte en av fördefinierade typer. Det är ogiltigt att försöka definiera ett nytt värde av denna typ eller att försöka ändra ett befintligt värde till denna typ. |
...
* namnutrymme [Aspose.Html.Dom.Svg.Filters](../../aspose.html.dom.svg.filters/)
