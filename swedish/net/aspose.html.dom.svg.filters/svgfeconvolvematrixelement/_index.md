...
description: Aspose.Html.Dom.Svg.Filters.SVGFEConvolveMatrixElement klass. SVGFEConvolveMatrixElementgränssnittet motsvarar elementet feConvolveMatrix.
type: docs
weight: 1400
url: /sv/net/aspose.html.dom.svg.filters/svgfeconvolvematrixelement/
---
## SVGFEConvolveMatrixElement class

SVGFEConvolveMatrixElement-gränssnittet motsvarar elementet 'feConvolveMatrix'.
...
| [Bias](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/bias/) { get; } | Motsvarar attributet 'bias' på det givna 'feConvolveMatrix'-elementet. |
...
| [Divisor](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/divisor/) { get; } | Motsvarar attributet 'divisor' på det givna 'feConvolveMatrix'-elementet. |
| [EdgeMode](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/edgemode/) { get; } | Motsvarar attributet 'edgeMode' på det givna 'feConvolveMatrix'-elementet. |
...
| [Height](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/height/) { get; } | Motsvarar attributet 'höjd' på det givna 'filter'-elementet. |
...
| [In1](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/in1/) { get; } | Motsvarar attributet 'in' på det givna 'feConvolveMatrix'-elementet. |
...
| [KernelMatrix](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelmatrix/) { get; } | Motsvarar attributet 'kernelMatrix' på det givna 'feConvolveMatrix'-elementet. |
| [KernelUnitLengthX](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelunitlengthx/) { get; } | Motsvarar attributet 'kernelUnitLength' på det givna 'feConvolveMatrix'-elementet. |
| [KernelUnitLengthY](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/kernelunitlengthy/) { get; } | Motsvarar attributet 'kernelUnitLength' på det givna 'feConvolveMatrix'-elementet. |
...
| [OrderX](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/orderx/) { get; } | Motsvarar attributet 'order' på det givna 'feConvolveMatrix'-elementet. |
| [OrderY](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/ordery/) { get; } | Motsvarar attributet 'order' på det givna 'feConvolveMatrix'-elementet. |
...
| [PreserveAlpha](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/preservealpha/) { get; } | Motsvarar attributet 'preserveAlpha' på det givna 'feConvolveMatrix'-elementet. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/result/) { get; } | Motsvarar attributet 'result' på det givna 'filter'-elementet. |
...
| [TargetX](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/targetx/) { get; } | Motsvarar attributet 'targetX' på det givna 'feConvolveMatrix'-elementet. |
| [TargetY](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/targety/) { get; } | Motsvarar attributet 'targetY' på det givna 'feConvolveMatrix'-elementet. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/width/) { get; } | Motsvarar attributet 'width' på det givna 'filter'-elementet. |
| [X](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/x/) { get; } | Motsvarar attributet 'x' på det givna 'filter'-elementet. |
| [Y](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/y/) { get; } | Motsvarar attributet 'y' på det givna 'filter'-elementet. |
...
| namn | Beskrivning |
| --- | --- |
| const [SVG_EDGEMODE_DUPLICATE](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_duplicate/) | Motsvarar värdet 'duplicera'. |
| const [SVG_EDGEMODE_NONE](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_none/) | Motsvarar värdet 'ingen'. |
| const [SVG_EDGEMODE_UNKNOWN](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_unknown/) | Typen är inte en av fördefinierade typer. Det är ogiltigt att försöka definiera ett nytt värde av denna typ eller att försöka ändra ett befintligt värde till denna typ. |
| const [SVG_EDGEMODE_WRAP](../../aspose.html.dom.svg.filters/svgfeconvolvematrixelement/svg_edgemode_wrap/) | Motsvarar värdet 'wrap'. |
