...
description: Aspose.Html.Dom.Svg.Filters.SVGFEColorMatrixElement klass. SVGFEColorMatrixElementgränssnittet motsvarar elementet feColorMatrix.
type: docs
weight: 1370
url: /sv/net/aspose.html.dom.svg.filters/svgfecolormatrixelement/
---
...
| [Height](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/height/) { get; } | Motsvarar attributet 'höjd' på det givna 'filter'-elementet. |
...
| [In1](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/in1/) { get; } | Motsvarar attributet 'in' på det givna 'feColorMatrix'-elementet. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/result/) { get; } | Motsvarar attributet 'result' på det givna 'filter'-elementet. |
...
| [Type](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/type/) { get; } | Motsvarar attributet 'type' på det givna 'feColorMatrix'-elementet. Tar en av SVG_FECOLORMATRIX_TYPE_* konstanterna som definierats i detta gränssnitt. |
| [Values](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/values/) { get; } | Motsvarar attributet 'värden' på det givna 'feColorMatrix'-elementet. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/width/) { get; } | Motsvarar attributet 'width' på det givna 'filter'-elementet. |
| [X](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/x/) { get; } | Motsvarar attributet 'x' på det givna 'filter'-elementet. |
| [Y](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/y/) { get; } | Motsvarar attributet 'y' på det givna 'filter'-elementet. |
...
| namn | Beskrivning |
| --- | --- |
| const [SVG_FECOLORMATRIX_TYPE_HUEROTATE](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_huerotate/) | Motsvarar värdet 'hueRotate'. |
| const [SVG_FECOLORMATRIX_TYPE_LUMINANCETOALPHA](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_luminancetoalpha/) | Motsvarar värdet 'luminanceToAlpha'. |
| const [SVG_FECOLORMATRIX_TYPE_MATRIX](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_matrix/) | Motsvarar värdet 'matris'. |
| const [SVG_FECOLORMATRIX_TYPE_SATURATE](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_saturate/) | Motsvarar värdet 'saturate'. |
| const [SVG_FECOLORMATRIX_TYPE_UNKNOWN](../../aspose.html.dom.svg.filters/svgfecolormatrixelement/svg_fecolormatrix_type_unknown/) | Typen är inte en av fördefinierade typer. Det är ogiltigt att försöka definiera ett nytt värde av denna typ eller att försöka ändra ett befintligt värde till denna typ. |
