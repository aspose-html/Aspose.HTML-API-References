...
description: Aspose.Html.Dom.Svg.Filters.SVGFECompositeElement klass. SVGFECompositeElementgränssnittet motsvarar elementet feComposite.
type: docs
weight: 1390
url: /sv/net/aspose.html.dom.svg.filters/svgfecompositeelement/
---
...
| [Height](../../aspose.html.dom.svg.filters/svgfecompositeelement/height/) { get; } | Motsvarar attributet 'höjd' på det givna 'filter'-elementet. |
...
| [In1](../../aspose.html.dom.svg.filters/svgfecompositeelement/in1/) { get; } | Motsvarar attributet 'in' på det givna 'feComposite'-elementet. |
| [In2](../../aspose.html.dom.svg.filters/svgfecompositeelement/in2/) { get; } | Motsvarar attributet 'in2' på det givna 'feComposite'-elementet. |
...
| [K1](../../aspose.html.dom.svg.filters/svgfecompositeelement/k1/) { get; } | Motsvarar attributet 'k1' på det givna 'feComposite'-elementet. |
| [K2](../../aspose.html.dom.svg.filters/svgfecompositeelement/k2/) { get; } | Motsvarar attributet 'k2' på det givna 'feComposite'-elementet. |
| [K3](../../aspose.html.dom.svg.filters/svgfecompositeelement/k3/) { get; } | Motsvarar attributet 'k3' på det givna 'feComposite'-elementet. |
| [K4](../../aspose.html.dom.svg.filters/svgfecompositeelement/k4/) { get; } | Motsvarar attributet 'k4' på det givna 'feComposite'-elementet. |
...
| [Operator](../../aspose.html.dom.svg.filters/svgfecompositeelement/operator/) { get; } | Motsvarar attributet 'operator' på det givna 'feComposite'-elementet. Tar en av SVG_FECOMPOSITE_OPERATOR_* konstanterna som definierats i detta gränssnitt. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfecompositeelement/result/) { get; } | Motsvarar attributet 'result' på det givna 'filter'-elementet. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfecompositeelement/width/) { get; } | Motsvarar attributet 'width' på det givna 'filter'-elementet. |
| [X](../../aspose.html.dom.svg.filters/svgfecompositeelement/x/) { get; } | Motsvarar attributet 'x' på det givna 'filter'-elementet. |
| [Y](../../aspose.html.dom.svg.filters/svgfecompositeelement/y/) { get; } | Motsvarar attributet 'y' på det givna 'filter'-elementet. |
...
| namn | Beskrivning |
| --- | --- |
| const [SVG_FECOMPOSITE_OPERATOR_ARITHMETIC](../../aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_arithmetic/) | Motsvarar värdet 'arithmetic'. |
| const [SVG_FECOMPOSITE_OPERATOR_ATOP](../../aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_atop/) | Motsvarar värdet 'atop'. |
| const [SVG_FECOMPOSITE_OPERATOR_IN](../../aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_in/) | Motsvarar värdet 'in'. |
| const [SVG_FECOMPOSITE_OPERATOR_OUT](../../aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_out/) | Motsvarar värdet 'out'. |
| const [SVG_FECOMPOSITE_OPERATOR_OVER](../../aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_over/) | Motsvarar värdet 'över'. |
| const [SVG_FECOMPOSITE_OPERATOR_UNKNOWN](../../aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_unknown/) | Typen är inte en av fördefinierade typer. Det är ogiltigt att försöka definiera ett nytt värde av denna typ eller att försöka ändra ett befintligt värde till denna typ. |
| const [SVG_FECOMPOSITE_OPERATOR_XOR](../../aspose.html.dom.svg.filters/svgfecompositeelement/svg_fecomposite_operator_xor/) | Motsvarar värdet 'xor'. |
