...
description: Aspose.Html.Dom.Svg.Filters.SVGFEDisplacementMapElement klass. SVGFEDisplacementMapElementgränssnittet motsvarar elementet feDisplacementMap.
type: docs
weight: 1420
url: /sv/net/aspose.html.dom.svg.filters/svgfedisplacementmapelement/
---
...
| [Height](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/height/) { get; } | Motsvarar attributet 'höjd' på det givna 'filter'-elementet. |
...
| [In1](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/in1/) { get; } | Motsvarar attributet 'in' på det givna 'feDisplacementMap'-elementet. |
| [In2](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/in2/) { get; } | Motsvarar attributet 'in2' på det givna 'feDisplacementMap'-elementet. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/result/) { get; } | Motsvarar attributet 'result' på det givna 'filter'-elementet. |
| [Scale](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/scale/) { get; } | Motsvarar attributet 'scale' på det givna 'feDisplacementMap'-elementet. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/width/) { get; } | Motsvarar attributet 'width' på det givna 'filter'-elementet. |
| [X](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/x/) { get; } | Motsvarar attributet 'x' på det givna 'filter'-elementet. |
| [XChannelSelector](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/xchannelselector/) { get; } | Motsvarar attributet 'xChannelSelector' på det givna 'feDisplacementMap'-elementet. Tar en av SVG_CHANNEL_* konstanterna som definierats i detta gränssnitt. |
| [Y](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/y/) { get; } | Motsvarar attributet 'y' på det givna 'filter'-elementet. |
| [YChannelSelector](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/ychannelselector/) { get; } | Motsvarar attributet 'yChannelSelector' på det givna 'feDisplacementMap'-elementet. Tar en av SVG_CHANNEL_* konstanterna som definierats i detta gränssnitt. |
...
| namn | Beskrivning |
| --- | --- |
| const [SVG_CHANNEL_A](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_a/) | Motsvarar värdet 'A'. |
| const [SVG_CHANNEL_B](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_b/) | Motsvarar värdet 'B'. |
| const [SVG_CHANNEL_G](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_g/) | Motsvarar värdet 'G'. |
| const [SVG_CHANNEL_R](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_r/) | Motsvarar värdet 'R'. |
| const [SVG_CHANNEL_UNKNOWN](../../aspose.html.dom.svg.filters/svgfedisplacementmapelement/svg_channel_unknown/) | Typen är inte en av fördefinierade typer. Det är ogiltigt att försöka definiera ett nytt värde av denna typ eller att försöka ändra ett befintligt värde till denna typ. |
