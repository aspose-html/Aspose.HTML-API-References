...
description: Aspose.Html.Dom.Svg.Filters.SVGFEGaussianBlurElement klass. SVGFEGaussianBlurElementgränssnittet motsvarar elementet feGaussianBlur.
type: docs
weight: 1500
url: /sv/net/aspose.html.dom.svg.filters/svgfegaussianblurelement/
---
...
| [Height](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/height/) { get; } | Motsvarar attributet �höjd� på det givna �filter�-elementet. |
...
| [In1](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/in1/) { get; } | Motsvarar attributet �in� på det givna elementet �feGaussianBlur�. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/result/) { get; } | Motsvarar attributet �result� på det givna �filter�-elementet. |
...
| [StdDeviationX](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/stddeviationx/) { get; } | Motsvarar attributet �stdDeviation� på det givna elementet �feGaussianBlur�. Innehåller X-komponenten av attributet �stdDeviation�. |
| [StdDeviationY](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/stddeviationy/) { get; } | Motsvarar attributet �stdDeviation� på det givna elementet �feGaussianBlur�. Innehåller Y-komponenten (möjligen beräknad automatiskt) för attributet �stdDeviation�. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/width/) { get; } | Motsvarar attributet �width� på det givna �filter�-elementet. |
| [X](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/x/) { get; } | Motsvarar attributet �x� på det givna �filter�-elementet. |
| [Y](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/y/) { get; } | Motsvarar attributet �y� på det givna �filter�-elementet. |
...
| [SetStdDeviation](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/setstddeviation/)(float, float) | Ställer in värdena för attributet �stdDeviation�. |
