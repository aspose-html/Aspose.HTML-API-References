...
description: Aspose.Html.Dom.Svg.Filters.SVGFETurbulenceElement klass. SVGFETurbulenceElementgränssnittet motsvarar elementet feTurbulence.
type: docs
weight: 1600
url: /sv/net/aspose.html.dom.svg.filters/svgfeturbulenceelement/
---
## SVGFETurbulenceElement class

SVGFETurbulenceElement-gränssnittet motsvarar elementet 'feTurbulence'.
...
| [BaseFrequencyX](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/basefrequencyx/) { get; } | Motsvarar attributet 'baseFrequency' på det givna 'feTurbulence'-elementet. Innehåller X-komponenten av attributet 'baseFrequency'. |
| [BaseFrequencyY](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/basefrequencyy/) { get; } | Motsvarar attributet 'baseFrequency' på det givna 'feTurbulence'-elementet. Innehåller Y-komponenten av (möjligen beräknad automatiskt) 'baseFrequency'-attributet. |
...
| [Height](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/height/) { get; } | Motsvarar attributet 'höjd' på det givna 'filter'-elementet. |
...
| [NumOctaves](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/numoctaves/) { get; } | Motsvarar attributet 'numOctaves' på det givna 'feTurbulence'-elementet. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/result/) { get; } | Motsvarar attributet 'result' på det givna 'filter'-elementet. |
| [SchemaTypeInfo](../../aspose.html.dom/element/schematypeinfo/) { get; } | Typinformationen som är associerad med detta element. |
| [Seed](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/seed/) { get; } | Motsvarar attributet 'seed' på det givna 'feTurbulence'-elementet. |
...
| [StitchTiles](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/stitchtiles/) { get; } | Motsvarar attributet 'stitchTiles' på det givna 'feTurbulence'-elementet. Tar en av SVG_STITCHTYPE_* konstanterna som definierats i detta gränssnitt. |
...
| [Type](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/type/) { get; } | Motsvarar attributet 'type' på det givna 'feTurbulence'-elementet. Tar en av SVG_TURBULENCE_TYPE_* konstanterna som definierats i detta gränssnitt. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/width/) { get; } | Motsvarar attributet 'width' på det givna 'filter'-elementet. |
| [X](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/x/) { get; } | Motsvarar attributet 'x' på det givna 'filter'-elementet. |
| [Y](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/y/) { get; } | Motsvarar attributet 'y' på det givna 'filter'-elementet. |
...
| namn | Beskrivning |
| --- | --- |
| const [SVG_STITCHTYPE_NOSTITCH](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_stitchtype_nostitch/) | Motsvarar värdet 'noStitch'. |
| const [SVG_STITCHTYPE_STITCH](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_stitchtype_stitch/) | Motsvarar värdet 'stitch'. |
| const [SVG_STITCHTYPE_UNKNOWN](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_stitchtype_unknown/) | Typen är inte en av fördefinierade typer. Det är ogiltigt att försöka definiera ett nytt värde av denna typ eller att försöka ändra ett befintligt värde till denna typ. |
| const [SVG_TURBULENCE_TYPE_FRACTALNOISE](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_turbulence_type_fractalnoise/) | Motsvarar värdet 'fractalNoise'. |
| const [SVG_TURBULENCE_TYPE_TURBULENCE](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_turbulence_type_turbulence/) | Motsvarar värdet 'turbulens'. |
| const [SVG_TURBULENCE_TYPE_UNKNOWN](../../aspose.html.dom.svg.filters/svgfeturbulenceelement/svg_turbulence_type_unknown/) | Typen är inte en av fördefinierade typer. Det är ogiltigt att försöka definiera ett nytt värde av denna typ eller att försöka ändra ett befintligt värde till denna typ. |
