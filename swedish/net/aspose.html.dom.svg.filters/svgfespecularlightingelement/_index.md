...
description: Aspose.Html.Dom.Svg.Filters.SVGFESpecularLightingElement klass. SVGFESpecularLightingElementgränssnittet motsvarar elementet feSpecularLighting.
type: docs
weight: 1570
url: /sv/net/aspose.html.dom.svg.filters/svgfespecularlightingelement/
---
...
| [Height](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/height/) { get; } | Motsvarar attributet 'höjd' på det givna 'filter'-elementet. |
...
| [In1](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/in1/) { get; } | Motsvarar attributet 'in' på det givna 'feSpecularLighting'-elementet. |
...
| [KernelUnitLengthX](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/kernelunitlengthx/) { get; } | Motsvarar attributet 'kernelUnitLength' på det givna 'feSpecularLighting'-elementet. |
| [KernelUnitLengthY](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/kernelunitlengthy/) { get; } | Motsvarar attributet 'kernelUnitLength' på det givna 'feSpecularLighting'-elementet. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/result/) { get; } | Motsvarar attributet 'result' på det givna 'filter'-elementet. |
...
| [SpecularConstant](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/specularconstant/) { get; } | Motsvarar attributet 'specularConstant' på det givna 'feSpecularLighting'-elementet. |
| [SpecularExponent](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/specularexponent/) { get; } | Motsvarar attributet 'specularExponent' på det givna 'feSpecularLighting'-elementet. |
...
| [SurfaceScale](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/surfacescale/) { get; } | Motsvarar attributet 'surfaceScale' på det givna 'feSpecularLighting'-elementet. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/width/) { get; } | Motsvarar attributet 'width' på det givna 'filter'-elementet. |
| [X](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/x/) { get; } | Motsvarar attributet 'x' på det givna 'filter'-elementet. |
| [Y](../../aspose.html.dom.svg.filters/svgfespecularlightingelement/y/) { get; } | Motsvarar attributet 'y' på det givna 'filter'-elementet. |
