...
description: Den Aspose.Html.Dom.Svg.Paths namnutrymme beskriver klasser för representation av konturerna av en form som kan fyllas eller strökas. En bana kan också användas som en urklippsbana för att beskriva animation eller positionstext.
type: docs
weight: 150
url: /sv/net/aspose.html.dom.svg.paths/
---
Den **Aspose.Html.Dom.Svg.Paths** namnutrymme beskriver klasser för representation av konturerna av en form som kan fyllas eller strökas. En bana kan också användas som en urklippsbana, för att beskriva animation, eller positionstext.
