...
description: Aspose.Html.Dom.Svg.Paths.SVGPathSegLinetoAbs klass. SVGPathSegLinetoAbsgränssnittet motsvarar ett absolut lineto L sökvägsdatakommando.
type: docs
weight: 1810
url: /sv/net/aspose.html.dom.svg.paths/svgpathseglinetoabs/
---
...
| [X](../../aspose.html.dom.svg.paths/svgpathseglinetoabs/x/) { get; set; } | Den absoluta X-koordinaten för slutpunkten för detta vägsegment. |
| [Y](../../aspose.html.dom.svg.paths/svgpathseglinetoabs/y/) { get; set; } | Den absoluta Y-koordinaten för slutpunkten för detta vägsegment. |
