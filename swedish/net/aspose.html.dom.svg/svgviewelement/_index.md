...
description: Aspose.Html.Dom.Svg.SVGViewElement klass. SVGViewElementgränssnittet motsvarar viewelementet.
type: docs
weight: 2410
url: /sv/net/aspose.html.dom.svg/svgviewelement/
---
...
| [PreserveAspectRatio](../../aspose.html.dom.svg/svgviewelement/preserveaspectratio/) { get; } | Motsvarar attributet 'preserveAspectRatio' på det givna elementet. |
...
| [ViewBox](../../aspose.html.dom.svg/svgviewelement/viewbox/) { get; } | Motsvarar attributet 'viewBox' på det givna elementet. |
...
| [ViewTarget](../../aspose.html.dom.svg/svgviewelement/viewtarget/) { get; } | Motsvarar attributet 'viewTarget' på det givna 'view'-elementet. En lista med DOMString-värden som innehåller namnen som anges i attributet 'viewTarget'. Vart och ett av DOMString-värdena kan associeras med motsvarande element med metoden getElementById() call. |
| [ZoomAndPan](../../aspose.html.dom.svg/svgviewelement/zoomandpan/) { get; set; } | Motsvarar attributet 'zoomAndPan' på det givna elementet. Värdet måste vara en av SVG_ZOOMANDPAN_*-konstanterna som definierats i detta gränssnitt. |
