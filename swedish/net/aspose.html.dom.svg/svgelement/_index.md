...
description: Aspose.Html.Dom.Svg.SVGElement klass. Alla SVG DOMgränssnitt som direkt motsvarar element i SVGspråket som SVGPathElementgränssnittet för pathelementet härrör från SVGElementgränssnittet.
type: docs
weight: 2020
url: /sv/net/aspose.html.dom.svg/svgelement/
---
## SVGElement class

Alla SVG DOM-gränssnitt som direkt motsvarar element i SVG-språket (som SVGPathElement-gränssnittet för "path"-elementet) härrör från SVGElement-gränssnittet.
