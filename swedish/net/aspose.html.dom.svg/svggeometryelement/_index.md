...
description: Aspose.Html.Dom.Svg.SVGGeometryElement klass. Gränssnitt SVGGeometryElement representerar SVGelement vars rendering definieras av geometri med en ekvivalent bana och som kan fyllas och strökas. Detta inkluderar banor och de grundläggande formerna.
type: docs
weight: 2090
url: /sv/net/aspose.html.dom.svg/svggeometryelement/
---
## SVGGeometryElement class

Gränssnitt SVGGeometryElement representerar SVG-element vars rendering definieras av geometri med en ekvivalent bana och som kan fyllas och strökas. Detta inkluderar banor och de grundläggande formerna.
...
| [GetEquivalentPath](../../aspose.html.dom.svg/svggeometryelement/getequivalentpath/)() | Returnerar en ny instans av[`SVGPathSegList`](../../aspose.html.dom.svg.paths/svgpathseglist/) som representerar`SVGGeometryElement` som vägsegment. |
