...
description: Aspose.Html.Dom.Svg.SVGComponentTransferFunctionElement klass. Detta gränssnitt definierar ett basgränssnitt som används av komponentöverföringsfunktionsgränssnitten.
type: docs
weight: 1970
url: /sv/net/aspose.html.dom.svg/svgcomponenttransferfunctionelement/
---
...
| namn | Beskrivning |
| --- | --- |
| [Amplitude](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/amplitude/) { get; } | Motsvarar attributet 'amplitud' på det givna elementet. |
...
| [Exponent](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/exponent/) { get; } | Motsvarar attributet 'exponent' på det givna elementet. |
...
| [Intercept](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/intercept/) { get; } | Motsvarar attributet 'intercept' på det givna elementet. |
...
| [Offset](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/offset/) { get; } | Motsvarar attributet 'offset' på det givna elementet. |
...
| [Slope](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/slope/) { get; } | Motsvarar attributet 'lutning' på det givna elementet. |
...
| [TableValues](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/tablevalues/) { get; } | Motsvarar attributet 'tableValues' på det givna elementet. |
...
| [Type](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/type/) { get; } | Motsvarar attributet 'type' på det givna elementet. Tar en av SVG_FECOMPONENTTRANSFER_TYPE_* konstanterna som definierats i detta gränssnitt. |
...
| namn | Beskrivning |
| --- | --- |
| const [SVG_FECOMPONENTTRANSFER_TYPE_DISCRETE](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_discrete/) | Motsvarar värdet 'diskret'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_GAMMA](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_gamma/) | Motsvarar värdet 'gamma'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_IDENTITY](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_identity/) | Motsvarar värdet 'identity'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_LINEAR](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_linear/) | Motsvarar värdet 'linjär'. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_TABLE](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_table/) | Motsvarar värdet 'tabell'. |
