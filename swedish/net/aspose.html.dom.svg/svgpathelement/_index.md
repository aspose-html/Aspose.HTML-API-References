...
description: Aspose.Html.Dom.Svg.SVGPathElement klass. SVGPathElementgränssnittet motsvarar pathelementet.
type: docs
weight: 2190
url: /sv/net/aspose.html.dom.svg/svgpathelement/
---
...
| [CreateSVGPathSegArcAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegarcabs/)(float, float, float, float, float, bool, bool) | Returnerar ett fristående, föräldralöst SVGPathSegArcAbs-objekt. |
| [CreateSVGPathSegArcRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegarcrel/)(float, float, float, float, float, bool, bool) | Returnerar ett fristående, föräldralöst SVGPathSegArcRel-objekt. |
| [CreateSVGPathSegClosePath](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegclosepath/)() | Returnerar ett fristående, föräldralöst SVGPathSegClosePath-objekt. |
| [CreateSVGPathSegCurvetoCubicAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicabs/)(float, float, float, float, float, float) | Returnerar ett fristående, föräldralöst SVGPathSegCurvetoCubicAbs-objekt. |
| [CreateSVGPathSegCurvetoCubicRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicrel/)(float, float, float, float, float, float) | Returnerar ett fristående, föräldralöst SVGPathSegCurvetoCubicRel-objekt. |
| [CreateSVGPathSegCurvetoCubicSmoothAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothabs/)(float, float, float, float) | Returnerar ett fristående, föräldralöst SVGPathSegCurvetoCubicSmoothAbs-objekt. |
| [CreateSVGPathSegCurvetoCubicSmoothRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothrel/)(float, float, float, float) | Returnerar ett fristående, föräldralöst SVGPathSegCurvetoCubicSmoothRel-objekt. |
| [CreateSVGPathSegCurvetoQuadraticAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticabs/)(float, float, float, float) | Returnerar ett fristående, föräldralöst SVGPathSegCurvetoQuadraticAbs-objekt. |
| [CreateSVGPathSegCurvetoQuadraticRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticrel/)(float, float, float, float) | Returnerar ett fristående, föräldralöst SVGPathSegCurvetoQuadraticRel-objekt. |
| [CreateSVGPathSegCurvetoQuadraticSmoothAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothabs/)(float, float) | Returnerar ett fristående, föräldralöst SVGPathSegCurvetoQuadraticSmoothAbs-objekt. |
| [CreateSVGPathSegCurvetoQuadraticSmoothRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothrel/)(float, float) | Returnerar ett fristående, föräldralöst SVGPathSegCurvetoQuadraticSmoothRel-objekt. |
| [CreateSVGPathSegLinetoAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoabs/)(float, float) | Returnerar ett fristående, föräldralöst SVGPathSegLinetoAbs-objekt. |
| [CreateSVGPathSegLinetoHorizontalAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetohorizontalabs/)(float) | Returnerar ett fristående, föräldralöst SVGPathSegLinetoHorizontalAbs-objekt. |
| [CreateSVGPathSegLinetoHorizontalRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetohorizontalrel/)(float) | Returnerar ett fristående, föräldralöst SVGPathSegLinetoHorizontalRel-objekt. |
| [CreateSVGPathSegLinetoRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetorel/)(float, float) | Returnerar ett fristående, föräldralöst SVGPathSegLinetoRel-objekt. |
| [CreateSVGPathSegLinetoVerticalAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoverticalabs/)(float) | Returnerar ett fristående, föräldralöst SVGPathSegLinetoVerticalAbs-objekt. |
| [CreateSVGPathSegLinetoVerticalRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoverticalrel/)(float) | Returnerar ett fristående, föräldralöst SVGPathSegLinetoVerticalRel-objekt. |
| [CreateSVGPathSegMovetoAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegmovetoabs/)(float, float) | Returnerar ett fristående, föräldralöst SVGPathSegMovetoAbs-objekt. |
| [CreateSVGPathSegMovetoRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegmovetorel/)(float, float) | Returnerar ett fristående, föräldralöst SVGPathSegMovetoRel-objekt. |
...
| [GetEquivalentPath](../../aspose.html.dom.svg/svggeometryelement/getequivalentpath/)() | Returnerar en ny instans av[`SVGPathSegList`](../../aspose.html.dom.svg.paths/svgpathseglist/) som representerar[`SVGGeometryElement`](../svggeometryelement/) som vägsegment. |
...
| [GetPointAtLength](../../aspose.html.dom.svg/svggeometryelement/getpointatlength/)(float) | Returnerar (x,y)-koordinaten i användarutrymmet som är avståndsenheter längs vägen, med hjälp av användaragentens algoritm för avstånd längs en väg. |
...
| [GetTotalLength](../../aspose.html.dom.svg/svggeometryelement/gettotallength/)() | Returnerar användaragentens beräknade värde för sökvägens totala längd med hjälp av användaragentens algoritm för avstånd längs en väg, som ett avstånd i det aktuella användarkoordinatsystemet. |
