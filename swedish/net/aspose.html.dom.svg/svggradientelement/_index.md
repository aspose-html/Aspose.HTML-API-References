...
description: Aspose.Html.Dom.Svg.SVGGradientElement klass. SVGGradientElementgränssnittet är ett basgränssnitt som används av SVGLinearGradientElement och SVGRadialGradientElement.
type: docs
weight: 2100
url: /sv/net/aspose.html.dom.svg/svggradientelement/
---
...
| namn | Beskrivning |
| --- | --- |
| const [SVG_SPREADMETHOD_PAD](../../aspose.html.dom.svg/svggradientelement/svg_spreadmethod_pad/) | Motsvarar värdet 'pad'. |
| const [SVG_SPREADMETHOD_REFLECT](../../aspose.html.dom.svg/svggradientelement/svg_spreadmethod_reflect/) | Motsvarar värdet 'reflektera'. |
| const [SVG_SPREADMETHOD_REPEAT](../../aspose.html.dom.svg/svggradientelement/svg_spreadmethod_repeat/) | Motsvarar värdet 'repetera'. |
| const [SVG_SPREADMETHOD_UNKNOWN](../../aspose.html.dom.svg/svggradientelement/svg_spreadmethod_unknown/) | Typen är inte en av fördefinierade typer. Det är ogiltigt att försöka definiera ett nytt värde av denna typ eller att försöka ändra ett befintligt värde till denna typ. |
