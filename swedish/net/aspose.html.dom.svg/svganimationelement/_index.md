...
description: Aspose.Html.Dom.Svg.SVGAnimationElement klass. SVGAnimationElementgränssnittet är basgränssnittet för alla animeringselementgränssnitt SVGAnimateElement SVGSetElement SVGAnimateColorElement SVGAnimateMotionElement och SVGAnimateTransformElement.
type: docs
weight: 1940
url: /sv/net/aspose.html.dom.svg/svganimationelement/
---
## SVGAnimationElement class

SVGAnimationElement-gränssnittet är basgränssnittet för alla animeringselementgränssnitt: SVGAnimateElement, SVGSetElement, SVGAnimateColorElement, SVGAnimateMotionElement och SVGAnimateTransformElement.
...
| [RequiredExtensions](../../aspose.html.dom.svg/svganimationelement/requiredextensions/) { get; } | Motsvarar attributet 'requiredExtensions' på det givna elementet. |
| [RequiredFeatures](../../aspose.html.dom.svg/svganimationelement/requiredfeatures/) { get; } | Motsvarar attributet 'requiredFeatures' på det givna elementet. |
...
| [SystemLanguage](../../aspose.html.dom.svg/svganimationelement/systemlanguage/) { get; } | Motsvarar attributet 'systemLanguage' på det givna elementet. |
| [TagName](../../aspose.html.dom/element/tagname/) { get; } | Namnet på elementet. |
| [TargetElement](../../aspose.html.dom.svg/svganimationelement/targetelement/) { get; } | Elementet som animeras. |
