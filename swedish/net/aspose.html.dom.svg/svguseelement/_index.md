...
description: Aspose.Html.Dom.Svg.SVGUseElement klass. SVGUseElementgränssnittet motsvarar elementet use.
type: docs
weight: 2400
url: /sv/net/aspose.html.dom.svg/svguseelement/
---
## SVGUseElement class

SVGUseElement-gränssnittet motsvarar elementet 'use'.
...
| [Height](../../aspose.html.dom.svg/svguseelement/height/) { get; } | Motsvarar attributet 'height' på det givna 'use'-elementet. |
| [Href](../../aspose.html.dom.svg/svguseelement/href/) { get; } | Motsvarar attributet 'xlink:href' på det givna elementet. |
...
| [Width](../../aspose.html.dom.svg/svguseelement/width/) { get; } | Motsvarar attributet 'width' på det givna 'use'-elementet. |
| [X](../../aspose.html.dom.svg/svguseelement/x/) { get; } | Motsvarar attributet 'x' på det givna 'use'-elementet. |
| [Y](../../aspose.html.dom.svg/svguseelement/y/) { get; } | Motsvarar attributet 'y' på det givna 'use'-elementet. |
