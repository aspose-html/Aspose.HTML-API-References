...
description: Aspose.Html.Dom.Svg.SVGDocument klass. AnSVGDokumentär roten till SVGhierarkin och innehåller hela innehållet. Förutom att ge åtkomst till hierarkin tillhandahåller den också några bekvämlighetsmetoder för att komma åt vissa uppsättningar information från dokumentet. När ett svgelement är inbäddat i ett dokument från ett annat namnområde till exempel när en svg element är inbäddat i ett XHTMLdokument XHTML så kommer ett SVGDocumentobjekt inte att existera i stället kommer rotobjektet i dokumentobjekthierarkin att vara ett dokumentobjekt av en annan typ till exempel ett HTMLDocumentobjekt. Ett SVGDocumentobjekt kommer dock verkligen att finnas när rotelementet i XMLdokumenthierarkin är ett svgelement  till exempel när du visar en fristående SVGfil dvs. en fil med MIMEtypen image/svgxml. I det här fallet kommer SVGDocumentobjektet att vara rotobjektet för dokumentobjektets modellhierarki.
type: docs
weight: 2010
url: /sv/net/aspose.html.dom.svg/svgdocument/
---
## SVGDocument class

An`SVGDokument`är roten till SVG-hierarkin och innehåller hela innehållet. Förutom att ge åtkomst till hierarkin, tillhandahåller den också några bekvämlighetsmetoder för att komma åt vissa uppsättningar information från dokumentet. När ett 'svg'-element är inbäddat i ett dokument från ett annat namnområde, till exempel när en 'svg' element är inbäddat i ett XHTML-dokument [XHTML], så kommer ett SVGDocument-objekt inte att existera; i stället kommer rotobjektet i dokumentobjekthierarkin att vara ett dokumentobjekt av en annan typ, till exempel ett HTMLDocument-objekt. Ett SVGDocument-objekt kommer dock verkligen att finnas när rotelementet i XML-dokumenthierarkin är ett "svg"-element , till exempel när du visar en fristående SVG-fil (dvs. en fil med MIME-typen "image/svg+xml"). I det här fallet kommer SVGDocument-objektet att vara rotobjektet för dokumentobjektets modellhierarki.
...
| [Domain](../../aspose.html.dom.svg/svgdocument/domain/) { get; } | Domännamnet för servern som serverade dokumentet, eller en nollsträng om servern inte kan identifieras med ett domännamn. |
...
| [Referrer](../../aspose.html.dom.svg/svgdocument/referrer/) { get; } | Returnerar URI för sidan som länkade till denna sida. Värdet är en tom sträng om användaren navigerade till sidan direkt (inte via en länk, utan t.ex. via ett bokmärke). |
| [RootElement](../../aspose.html.dom.svg/svgdocument/rootelement/) { get; } | Roten "svg" i dokumenthierarkin. |
...
| [Title](../../aspose.html.dom.svg/svgdocument/title/) { get; } | Titeln på ett dokument som specificeras av underelementet 'title' i rotelementet 'svg' (dvs.Här är titeln... ) |
| [URL](../../aspose.html.dom.svg/svgdocument/url/) { get; } | Dokumentets fullständiga URI. |
...
| [GetOverrideStyle](../../aspose.html.dom.svg/svgdocument/getoverridestyle/)(Element, string) | Denna metod används för att hämta åsidosättningsstilsdeklarationen för ett angivet element och ett specificerat pseudoelement. |
...
| override [RenderTo](../../aspose.html.dom.svg/svgdocument/renderto/)(IDevice) | Denna metod används för att skriva ut innehållet i det aktuella dokumentet till den angivna enheten. |
...
| [Save](../../aspose.html.dom.svg/svgdocument/save/#save)(IOutputStorage) | Sparar dokumentinnehållet och resurserna till utdatalagringen. |
| [Save](../../aspose.html.dom.svg/svgdocument/save/#save_6)(string) | Sparar dokumentet till lokal fil specificerad av`väg` Alla resurser som används i detta dokument kommer att sparas i till intilliggande mapp, vars namn kommer att konstrueras som: output_file_name + "_files". |
| [Save](../../aspose.html.dom.svg/svgdocument/save/#save_3)(Url) | Sparar dokumentet till lokal fil specificerad av`url` Alla resurser som används i detta dokument kommer att sparas i till intilliggande mapp, vars namn kommer att konstrueras som: output_file_name + "_files". |
| [Save](../../aspose.html.dom.svg/svgdocument/save/#save_1)(IOutputStorage, SVGSaveFormat) | Sparar dokumentinnehållet och resurserna till utdatalagringen. |
| [Save](../../aspose.html.dom.svg/svgdocument/save/#save_2)(IOutputStorage, SVGSaveOptions) | Sparar dokumentinnehållet och resurserna till utdatalagringen. |
| [Save](../../aspose.html.dom.svg/svgdocument/save/#save_7)(string, SVGSaveFormat) | Sparar dokumentet till lokal fil specificerad av`väg` Alla resurser som används i detta dokument kommer att sparas i till intilliggande mapp, vars namn kommer att konstrueras som: output_file_name + "_files". |
| [Save](../../aspose.html.dom.svg/svgdocument/save/#save_8)(string, SVGSaveOptions) | Sparar dokumentet till lokal fil specificerad av`väg` Alla resurser som används i detta dokument kommer att sparas i till intilliggande mapp, vars namn kommer att konstrueras som: output_file_name + "_files". |
| [Save](../../aspose.html.dom.svg/svgdocument/save/#save_4)(Url, SVGSaveFormat) | Sparar dokumentet till lokal fil specificerad av`url` Alla resurser som används i detta dokument kommer att sparas i till intilliggande mapp, vars namn kommer att konstrueras som: output_file_name + "_files". |
| [Save](../../aspose.html.dom.svg/svgdocument/save/#save_5)(Url, SVGSaveOptions) | Sparar dokumentet till lokal fil specificerad av`url` Alla resurser som används i detta dokument kommer att sparas i till intilliggande mapp, vars namn kommer att konstrueras som: output_file_name + "_files". |
