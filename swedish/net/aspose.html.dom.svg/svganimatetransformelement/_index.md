...
description: Aspose.Html.Dom.Svg.SVGAnimateTransformElement klass. SVGAnimateTransformElementgränssnittet motsvarar elementet animateTransform. Objektorienterad åtkomst till attributen för elementet animateTransform via SVG DOM är inte tillgänglig.
type: docs
weight: 1930
url: /sv/net/aspose.html.dom.svg/svganimatetransformelement/
---
## SVGAnimateTransformElement class

SVGAnimateTransformElement-gränssnittet motsvarar elementet 'animateTransform'. Objektorienterad åtkomst till attributen för elementet 'animateTransform' via SVG DOM är inte tillgänglig.
