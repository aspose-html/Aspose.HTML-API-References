...
type: docs
weight: 2260
url: /sv/net/aspose.html.dom.svg/svgsvgelement/
---
## SVGSVGElement class
...
| [CurrentTranslate](../../aspose.html.dom.svg/svgsvgelement/currenttranslate/) { get; } | På ett yttersta svg-element, motsvarande översättningsfaktor som tar hänsyn till användarens "förstoring". När det öppnas på ett "svg"-element som inte är ett yttersta svg-element är det odefinierat vilket beteende detta attribut har. |
...
| [Height](../../aspose.html.dom.svg/svgsvgelement/height/) { get; } | Motsvarar attributet 'höjd' på det givna 'svg'-elementet. |
...
| [PreserveAspectRatio](../../aspose.html.dom.svg/svgsvgelement/preserveaspectratio/) { get; } | Motsvarar attributet 'preserveAspectRatio' på det givna elementet. |
...
| [ViewBox](../../aspose.html.dom.svg/svgsvgelement/viewbox/) { get; } | Motsvarar attributet 'viewBox' på det givna elementet. |
...
| [Width](../../aspose.html.dom.svg/svgsvgelement/width/) { get; } | Motsvarar attributet 'width' på det givna 'svg'-elementet. |
| [X](../../aspose.html.dom.svg/svgsvgelement/x/) { get; } | Motsvarar attributet 'x' på det givna 'svg'-elementet. |
| [Y](../../aspose.html.dom.svg/svgsvgelement/y/) { get; } | Motsvarar attributet 'y' på det givna 'svg'-elementet. |
| [ZoomAndPan](../../aspose.html.dom.svg/svgsvgelement/zoomandpan/) { get; set; } | Motsvarar attributet 'zoomAndPan' på det givna elementet. Värdet måste vara en av SVG_ZOOMANDPAN_*-konstanterna som definierats i detta gränssnitt. |
...
| [AnimationsPaused](../../aspose.html.dom.svg/svgsvgelement/animationspaused/)() | Returnerar sant om detta SVG-dokumentfragment är i pausat tillstånd. |
...
| [CreateEvent](../../aspose.html.dom.svg/svgsvgelement/createevent/)(string) | Skapar en[`Event`](../../aspose.html.dom.events/event/) av en typ som stöds av implementeringen. |
| [CreateSVGAngle](../../aspose.html.dom.svg/svgsvgelement/createsvgangle/)() | Skapar ett SVGAngle-objekt utanför alla dokumentträd. Objektet initieras till värdet 0 grader (enhetslös). |
| [CreateSVGLength](../../aspose.html.dom.svg/svgsvgelement/createsvglength/)() | Skapar ett SVGLength-objekt utanför alla dokumentträd. Objektet initieras till värdet 0 användarenheter. |
| [CreateSVGMatrix](../../aspose.html.dom.svg/svgsvgelement/createsvgmatrix/)() | Skapar ett SVGMatrix-objekt utanför alla dokumentträd. Objektet initieras till identitetsmatrisen. |
| [CreateSVGNumber](../../aspose.html.dom.svg/svgsvgelement/createsvgnumber/)() | Skapar ett SVGNumber-objekt utanför alla dokumentträd. Objektet initieras till värdet noll. |
| [CreateSVGPoint](../../aspose.html.dom.svg/svgsvgelement/createsvgpoint/)() | Skapar ett SVGPoint-objekt utanför alla dokumentträd. Objektet initieras till punkten (0,0) i användarens koordinatsystem. |
| [CreateSVGRect](../../aspose.html.dom.svg/svgsvgelement/createsvgrect/)() | Skapar ett SVGRect-objekt utanför alla dokumentträd. Objektet initieras så att alla värden sätts till 0 användarenheter. |
| [CreateSVGTransform](../../aspose.html.dom.svg/svgsvgelement/createsvgtransform/)() | Skapar ett SVGTransform-objekt utanför alla dokumentträd. Objektet initieras till en identitetsmatristransform (SVG_TRANSFORM_MATRIX). |
...
| [PauseAnimations](../../aspose.html.dom.svg/svgsvgelement/pauseanimations/)() | Stänger av (dvs. pausar) alla körande animeringar som är definierade i SVG-dokumentfragmentet som motsvarar detta 'svg'-element, vilket gör att animeringsklockan som motsvarar detta dokumentfragment står stilla tills den återupptas. |
...
| [UnpauseAnimations](../../aspose.html.dom.svg/svgsvgelement/unpauseanimations/)() | Avbryter (dvs återställer) körande animeringar som är definierade i SVG-dokumentfragmentet, vilket gör att animeringsklockan fortsätter från den tidpunkt då den avbröts. |
