...
description: Aspose.Html.Dom.Svg.SVGFilterElement klass. SVGFilterElementgränssnittet motsvarar filterelementet.
type: docs
weight: 2060
url: /sv/net/aspose.html.dom.svg/svgfilterelement/
---
...
| [FilterUnits](../../aspose.html.dom.svg/svgfilterelement/filterunits/) { get; } | Motsvarar attributet 'filterUnits' på det givna 'filter'-elementet. Tar en av konstanterna definierade i SVGUnitTypes. |
...
| [Height](../../aspose.html.dom.svg/svgfilterelement/height/) { get; } | Motsvarar attributet 'höjd' på det givna 'filter'-elementet. |
| [Href](../../aspose.html.dom.svg/svgfilterelement/href/) { get; } | Motsvarar attributet 'xlink:href' på det givna elementet. |
...
| [PrimitiveUnits](../../aspose.html.dom.svg/svgfilterelement/primitiveunits/) { get; } | Motsvarar attributet 'primitiveUnits' på det givna 'filter'-elementet. Tar en av konstanterna definierade i SVGUnitTypes. |
...
| [Width](../../aspose.html.dom.svg/svgfilterelement/width/) { get; } | Motsvarar attributet 'width' på det givna 'filter'-elementet. |
| [X](../../aspose.html.dom.svg/svgfilterelement/x/) { get; } | Motsvarar attributet 'x' på det givna 'filter'-elementet. |
| [Y](../../aspose.html.dom.svg/svgfilterelement/y/) { get; } | Motsvarar attributet 'y' på det givna 'filter'-elementet. |
