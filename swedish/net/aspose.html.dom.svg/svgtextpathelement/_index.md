...
description: Aspose.Html.Dom.Svg.SVGTextPathElement klass. SVGTextPathElementgränssnittet motsvarar elementet textPath.
type: docs
weight: 2360
url: /sv/net/aspose.html.dom.svg/svgtextpathelement/
---
## SVGTextPathElement class

SVGTextPathElement-gränssnittet motsvarar elementet 'textPath'.
...
| [Href](../../aspose.html.dom.svg/svgtextpathelement/href/) { get; } | Motsvarar attributet 'xlink:href' på det givna elementet. |
...
| [Method](../../aspose.html.dom.svg/svgtextpathelement/method/) { get; } | Motsvarar attributet 'metod' på det givna 'textPath'-elementet. |
...
| [Spacing](../../aspose.html.dom.svg/svgtextpathelement/spacing/) { get; } | Motsvarar attributet 'mellanrum' på det givna 'textPath'-elementet. |
| [StartOffset](../../aspose.html.dom.svg/svgtextpathelement/startoffset/) { get; } | Motsvarar attributet 'startOffset' på det givna 'textPath'-elementet. |
...
| namn | Beskrivning |
| --- | --- |
| const [TEXTPATH_METHODTYPE_ALIGN](../../aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_align/) | Motsvarar värdet 'align'. |
| const [TEXTPATH_METHODTYPE_STRETCH](../../aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_stretch/) | Motsvarar värdet 'stretch'. |
| const [TEXTPATH_METHODTYPE_UNKNOWN](../../aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_unknown/) | Uppräkningen sattes till ett värde som inte är en av fördefinierade typer. Det är ogiltigt att försöka definiera ett nytt värde av denna typ eller att försöka ändra ett befintligt värde till denna typ. |
| const [TEXTPATH_SPACINGTYPE_AUTO](../../aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_auto/) | Motsvarar värdet 'auto'. |
| const [TEXTPATH_SPACINGTYPE_EXACT](../../aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_exact/) | Motsvarar värdet 'exakt'. |
| const [TEXTPATH_SPACINGTYPE_UNKNOWN](../../aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_unknown/) | Uppräkningen sattes till ett värde som inte är en av fördefinierade typer. Det är ogiltigt att försöka definiera ett nytt värde av denna typ eller att försöka ändra ett befintligt värde till denna typ. |
