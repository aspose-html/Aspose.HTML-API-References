...
description: Aspose.Html.Dom.Svg.SVGMaskElement klass. SVGMaskElementgränssnittet motsvarar maskelementet.
type: docs
weight: 2170
url: /sv/net/aspose.html.dom.svg/svgmaskelement/
---
...
| [Height](../../aspose.html.dom.svg/svgmaskelement/height/) { get; } | Motsvarar attributet 'höjd' på det givna 'mask'-elementet. Tar en av konstanterna definierade i SVGUnitTypes. |
...
| [MaskContentUnits](../../aspose.html.dom.svg/svgmaskelement/maskcontentunits/) { get; } | Motsvarar attributet 'maskContentUnits' på det givna 'mask'-elementet. Tar en av konstanterna definierade i SVGUnitTypes. |
| [MaskUnits](../../aspose.html.dom.svg/svgmaskelement/maskunits/) { get; } | Motsvarar attributet 'maskUnits' på det givna 'mask'-elementet. Tar en av konstanterna definierade i SVGUnitTypes. |
...
| [RequiredExtensions](../../aspose.html.dom.svg/svgmaskelement/requiredextensions/) { get; } | Motsvarar attributet 'requiredExtensions' på det givna elementet. |
| [RequiredFeatures](../../aspose.html.dom.svg/svgmaskelement/requiredfeatures/) { get; } | Motsvarar attributet 'requiredFeatures' på det givna elementet. |
...
| [SystemLanguage](../../aspose.html.dom.svg/svgmaskelement/systemlanguage/) { get; } | Motsvarar attributet 'systemLanguage' på det givna elementet. |
...
| [Width](../../aspose.html.dom.svg/svgmaskelement/width/) { get; } | Motsvarar attributet 'width' på det givna 'mask'-elementet. Tar en av konstanterna definierade i SVGUnitTypes. |
| [X](../../aspose.html.dom.svg/svgmaskelement/x/) { get; } | Motsvarar attributet 'x' på det givna 'mask'-elementet. Tar en av konstanterna definierade i SVGUnitTypes. |
| [Y](../../aspose.html.dom.svg/svgmaskelement/y/) { get; } | Motsvarar attributet 'y' på det givna 'mask'-elementet. Tar en av konstanterna definierade i SVGUnitTypes. |
