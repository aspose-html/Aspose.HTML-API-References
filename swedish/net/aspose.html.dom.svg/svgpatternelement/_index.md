...
description: Aspose.Html.Dom.Svg.SVGPatternElement klass. SVGPatternElementgränssnittet motsvarar elementet mönster.
type: docs
weight: 2200
url: /sv/net/aspose.html.dom.svg/svgpatternelement/
---
## SVGPatternElement class

SVGPatternElement-gränssnittet motsvarar elementet 'mönster'.
...
| [Height](../../aspose.html.dom.svg/svgpatternelement/height/) { get; } | Motsvarar attributet 'höjd' på det givna 'mönster'-elementet. |
| [Href](../../aspose.html.dom.svg/svgpatternelement/href/) { get; } | Motsvarar attributet 'xlink:href' på det givna elementet. |
...
| [PatternContentUnits](../../aspose.html.dom.svg/svgpatternelement/patterncontentunits/) { get; } | Motsvarar attributet 'patternContentUnits' på det givna 'pattern'-elementet. Tar en av konstanterna definierade i SVGUnitTypes. |
| [PatternTransform](../../aspose.html.dom.svg/svgpatternelement/patterntransform/) { get; } | Motsvarar attributet 'patternTransform' på det givna 'pattern'-elementet. |
| [PatternUnits](../../aspose.html.dom.svg/svgpatternelement/patternunits/) { get; } | Motsvarar attributet 'patternUnits' på det givna 'pattern'-elementet. Tar en av konstanterna definierade i SVGUnitTypes. |
...
| [PreserveAspectRatio](../../aspose.html.dom.svg/svgpatternelement/preserveaspectratio/) { get; } | Motsvarar attributet 'preserveAspectRatio' på det givna elementet. |
...
| [RequiredExtensions](../../aspose.html.dom.svg/svgpatternelement/requiredextensions/) { get; } | Motsvarar attributet 'requiredExtensions' på det givna elementet. |
| [RequiredFeatures](../../aspose.html.dom.svg/svgpatternelement/requiredfeatures/) { get; } | Motsvarar attributet 'requiredFeatures' på det givna elementet. |
...
| [SystemLanguage](../../aspose.html.dom.svg/svgpatternelement/systemlanguage/) { get; } | Motsvarar attributet 'systemLanguage' på det givna elementet. |
...
| [ViewBox](../../aspose.html.dom.svg/svgpatternelement/viewbox/) { get; } | Motsvarar attributet 'viewBox' på det givna elementet. |
...
| [Width](../../aspose.html.dom.svg/svgpatternelement/width/) { get; } | Motsvarar attributet 'width' på det givna 'pattern'-elementet. |
| [X](../../aspose.html.dom.svg/svgpatternelement/x/) { get; } | Motsvarar attributet 'x' på det givna 'pattern'-elementet. |
| [Y](../../aspose.html.dom.svg/svgpatternelement/y/) { get; } | Motsvarar attributet 'y' på det givna 'pattern'-elementet. |
