...
description: Aspose.Html.Dom.Svg.SVGMarkerElement klass. SVGMarkerElementgränssnittet motsvarar markerelementet.
type: docs
weight: 2160
url: /sv/net/aspose.html.dom.svg/svgmarkerelement/
---
...
| [MarkerHeight](../../aspose.html.dom.svg/svgmarkerelement/markerheight/) { get; } | Motsvarar attributet 'markerHeight' på det givna 'marker'-elementet. |
| [MarkerUnits](../../aspose.html.dom.svg/svgmarkerelement/markerunits/) { get; } | Motsvarar attributet 'markerUnits' på det givna 'marker'-elementet. En av de markörenhetstyper som definieras i detta gränssnitt. |
| [MarkerWidth](../../aspose.html.dom.svg/svgmarkerelement/markerwidth/) { get; } | Motsvarar attributet 'markerWidth' på det givna 'marker'-elementet. |
...
| [OrientAngle](../../aspose.html.dom.svg/svgmarkerelement/orientangle/) { get; } | Motsvarar attributet 'orient' på det givna 'markör'-elementet. Om markerUnits är SVG_MARKER_ORIENT_ANGLE, vinkelvärdet för attributet 'orient'; annars sätts den till noll. |
| [OrientType](../../aspose.html.dom.svg/svgmarkerelement/orienttype/) { get; } | Motsvarar attributet 'orient' på det givna 'markör'-elementet. En av markörorienteringstyperna som definieras i detta gränssnitt. |
...
| [PreserveAspectRatio](../../aspose.html.dom.svg/svgmarkerelement/preserveaspectratio/) { get; } | Motsvarar attributet 'preserveAspectRatio' på det givna elementet. |
...
| [RefX](../../aspose.html.dom.svg/svgmarkerelement/refx/) { get; } | Motsvarar attributet 'refX' på det givna 'markör'-elementet. |
| [RefY](../../aspose.html.dom.svg/svgmarkerelement/refy/) { get; } | Motsvarar attributet 'refY' på det givna 'marker'-elementet. |
...
| [ViewBox](../../aspose.html.dom.svg/svgmarkerelement/viewbox/) { get; } | Motsvarar attributet 'viewBox' på det givna elementet. |
...
| [SetOrientToAngle](../../aspose.html.dom.svg/svgmarkerelement/setorienttoangle/)(SVGAngle) | Anger värdet för attributet 'orient' till den givna vinkeln. |
| [SetOrientToAuto](../../aspose.html.dom.svg/svgmarkerelement/setorienttoauto/)() | Anger värdet för attributet 'orient' till 'auto'. |
...
| namn | Beskrivning |
| --- | --- |
| const [SVG_MARKERUNITS_STROKEWIDTH](../../aspose.html.dom.svg/svgmarkerelement/svg_markerunits_strokewidth/) | Värdet för attributet 'markerUnits' är 'strokeWidth'. |
| const [SVG_MARKERUNITS_UNKNOWN](../../aspose.html.dom.svg/svgmarkerelement/svg_markerunits_unknown/) | Markörenhetstypen är inte en av fördefinierade typer. Det är ogiltigt att försöka definiera ett nytt värde av denna typ eller att försöka ändra ett befintligt värde till denna typ. |
| const [SVG_MARKERUNITS_USERSPACEONUSE](../../aspose.html.dom.svg/svgmarkerelement/svg_markerunits_userspaceonuse/) | Värdet för attributet 'markerUnits' är 'userSpaceOnUse'. |
| const [SVG_MARKER_ORIENT_ANGLE](../../aspose.html.dom.svg/svgmarkerelement/svg_marker_orient_angle/) | Attributet 'orient' har ett vinkelvärde. |
| const [SVG_MARKER_ORIENT_AUTO](../../aspose.html.dom.svg/svgmarkerelement/svg_marker_orient_auto/) | Attributet 'orient' har värdet 'auto'. |
| const [SVG_MARKER_ORIENT_UNKNOWN](../../aspose.html.dom.svg/svgmarkerelement/svg_marker_orient_unknown/) | Markörens orientering är inte en av fördefinierade typer. Det är ogiltigt att försöka definiera ett nytt värde av denna typ eller att försöka ändra ett befintligt värde till denna typ. |
