...
description: Aspose.Html.Dom.Events.MouseEvent klass. MouseEventgränssnittet tillhandahåller specifik kontextuell information associerad med Mousehändelser.
type: docs
weight: 840
url: /sv/net/aspose.html.dom.events/mouseevent/
---
## MouseEvent class

MouseEvent-gränssnittet tillhandahåller specifik kontextuell information associerad med Mouse-händelser.
...
| namn | Beskrivning |
| --- | --- |
| [MouseEvent](mouseevent/#constructor)(string) | Initierar en ny instans av`MouseEvent` class. |
| [MouseEvent](mouseevent/#constructor_1)(string, IDictionary&lt;string, object&gt;) | Initierar en ny instans av`MouseEvent` class. |
