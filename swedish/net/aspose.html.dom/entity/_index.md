...
description: Aspose.Html.Dom.Entity klass. Representerar en känd enhet antingen tolkad eller oparsad i ett XMLdokument.
type: docs
weight: 700
url: /sv/net/aspose.html.dom/entity/
---
## Entity class
...
| [InputEncoding](../../aspose.html.dom/entity/inputencoding/) { get; } | Ett attribut som anger den kodning som används för denna entitet vid tidpunkten för analys, när det är en extern analyserad entitet. Detta är null om det är en enhet från den interna delmängden eller om det inte är känt. |
...
| override [NodeName](../../aspose.html.dom/entity/nodename/) { get; } | Namnet på denna nod, beroende på dess typ. |
| override [NodeType](../../aspose.html.dom/entity/nodetype/) { get; } | En kod som representerar typen av det underliggande objektet. |
| virtual [NodeValue](../../aspose.html.dom/node/nodevalue/) { get; set; } | Värdet för denna nod, beroende på dess typ. |
| [NotationName](../../aspose.html.dom/entity/notationname/) { get; } | För oparsade entiteter, namnet på notationen för entiteten. För analyserade enheter är detta null. |
...
| [PublicId](../../aspose.html.dom/entity/publicid/) { get; } | Den offentliga identifieraren som är associerad med enheten om den anges, och i övrigt null. |
| [SystemId](../../aspose.html.dom/entity/systemid/) { get; } | Systemidentifieraren som är associerad med entiteten om den anges, och null i övrigt. Detta kan vara en absolut URI eller inte. |
...
| [XmlEncoding](../../aspose.html.dom/entity/xmlencoding/) { get; } | Ett attribut som anger, som en del av textdeklarationen, kodningen av denna entitet, när den är en extern tolkad entitet. Detta är null annars. |
| [XmlVersion](../../aspose.html.dom/entity/xmlversion/) { get; } | Ett attribut som anger, som en del av textdeklarationen, versionsnumret för denna enhet, när den är en extern tolkad enhet. Detta är null annars. |
