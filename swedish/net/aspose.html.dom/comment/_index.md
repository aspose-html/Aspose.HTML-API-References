...
description: Aspose.Html.Dom.Comment klass. Ärver från CharacterData och representerar innehållet i en kommentar dvs alla tecken mellan början  .
type: docs
weight: 310
url: /sv/net/aspose.html.dom/comment/
---
## Comment class

Ärver från CharacterData och representerar innehållet i en kommentar, dvs alla tecken mellan början ' .
...
| override [NodeName](../../aspose.html.dom/comment/nodename/) { get; } | Namnet på denna nod, beroende på dess typ. |
| override [NodeType](../../aspose.html.dom/comment/nodetype/) { get; } | En kod som representerar typen av det underliggande objektet. |
| override [NodeValue](../../aspose.html.dom/comment/nodevalue/) { get; set; } | Värdet för denna nod, beroende på dess typ. |
