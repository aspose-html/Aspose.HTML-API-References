...
description: Aspose.Html.Dom.DocumentFragment klass. DocumentFragment är ett lätt eller minimalt dokumentobjekt. Det är mycket vanligt att man vill kunna extrahera en del av ett dokuments träd eller skapa ett nytt fragment av ett dokument.
type: docs
weight: 670
url: /sv/net/aspose.html.dom/documentfragment/
---
## DocumentFragment class

DocumentFragment är ett "lätt" eller "minimalt" dokumentobjekt. Det är mycket vanligt att man vill kunna extrahera en del av ett dokuments träd eller skapa ett nytt fragment av ett dokument.
