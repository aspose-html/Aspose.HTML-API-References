...
description: Aspose.Html.Dom.Node klass. Nodgränssnittet är den primära datatypen för hela dokumentobjektmodellen. Den representerar en enda nod i dokumentträdet.
type: docs
weight: 1000
url: /sv/net/aspose.html.dom/node/
---
## Node class
...
| abstract [NodeName](../../aspose.html.dom/node/nodename/) { get; } | Namnet på denna nod, beroende på dess typ. |
| abstract [NodeType](../../aspose.html.dom/node/nodetype/) { get; } | En kod som representerar typen av det underliggande objektet. |
...
| [CloneNode](../../aspose.html.dom/node/clonenode/#clonenode)() | Returnerar en dubblett av denna nod, dvs fungerar som en generisk kopiakonstruktor för noder. Dubblettnoden har ingen förälder (parentNode är null) och inga användardata. |
| [CloneNode](../../aspose.html.dom/node/clonenode/#clonenode_1)(bool) | Returnerar en dubblett av denna nod, dvs fungerar som en generisk kopiakonstruktor för noder. Dubblettnoden har ingen förälder (parentNode är null) och inga användardata. |
...
| namn | Beskrivning |
| --- | --- |
| const [ATTRIBUTE_NODE](../../aspose.html.dom/node/attribute_node/) | En attribut node |
| const [CDATA_SECTION_NODE](../../aspose.html.dom/node/cdata_section_node/) | En cdatasektion node |
| const [COMMENT_NODE](../../aspose.html.dom/node/comment_node/) | En kommentarsnod |
| const [DOCUMENT_FRAGMENT_NODE](../../aspose.html.dom/node/document_fragment_node/) | Ett dokumentfragment node |
| const [DOCUMENT_NODE](../../aspose.html.dom/node/document_node/) | En dokumentnod |
| const [DOCUMENT_TYPE_NODE](../../aspose.html.dom/node/document_type_node/) | En dokumenttyp node |
| const [ELEMENT_NODE](../../aspose.html.dom/node/element_node/) | En elementnod |
| const [ENTITY_NODE](../../aspose.html.dom/node/entity_node/) | En entitetsnod |
| const [ENTITY_REFERENCE_NODE](../../aspose.html.dom/node/entity_reference_node/) | En entitetsreferensnod |
| const [NOTATION_NODE](../../aspose.html.dom/node/notation_node/) | En notationsnod |
| const [PROCESSING_INSTRUCTION_NODE](../../aspose.html.dom/node/processing_instruction_node/) | En bearbetningsinstruktionsnod |
| const [TEXT_NODE](../../aspose.html.dom/node/text_node/) | En textnod |
