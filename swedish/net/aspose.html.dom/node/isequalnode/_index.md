...
description: Node metod. Testar om två noder är lika. Denna metod testar likadana noder inte likhet dvs om de två noderna är referenser till samma objekt som kan testas med Node.isSameNode. Alla noder som är lika kommer också att vara lika även om det omvända kanske inte är sant.
type: docs
weight: 240
url: /sv/net/aspose.html.dom/node/isequalnode/
---
