...
description: Aspose.Html.Dom.CDATASection klass. CDATAsektioner används för att undvika textblock som innehåller tecken som annars skulle betraktas som uppmärkning.
type: docs
weight: 200
url: /sv/net/aspose.html.dom/cdatasection/
---
## CDATASection class

CDATA-sektioner används för att undvika textblock som innehåller tecken som annars skulle betraktas som uppmärkning.
...
| override [NodeName](../../aspose.html.dom/cdatasection/nodename/) { get; } | Namnet på denna nod, beroende på dess typ. |
| override [NodeType](../../aspose.html.dom/cdatasection/nodetype/) { get; } | En kod som representerar typen av det underliggande objektet. |
