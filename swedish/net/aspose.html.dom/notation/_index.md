...
description: Aspose.Html.Dom.Notation klass. Representerar en notation som deklareras i DTD.
type: docs
weight: 1010
url: /sv/net/aspose.html.dom/notation/
---
## Notation class

Representerar en notation som deklareras i DTD.
...
| override [NodeName](../../aspose.html.dom/notation/nodename/) { get; } | Namnet på denna nod, beroende på dess typ. |
| override [NodeType](../../aspose.html.dom/notation/nodetype/) { get; } | En kod som representerar typen av det underliggande objektet. |
...
| [PublicId](../../aspose.html.dom/notation/publicid/) { get; } | Den offentliga identifieraren för denna notation. Om den offentliga identifieraren inte angavs är den null. |
| [SystemId](../../aspose.html.dom/notation/systemid/) { get; } | Systemidentifieraren för denna notation. Om systemidentifieraren inte angavs är denna null. Detta kan vara en absolut URI eller inte. |
