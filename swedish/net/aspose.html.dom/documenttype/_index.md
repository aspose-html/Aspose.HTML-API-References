...
description: Aspose.Html.Dom.DocumentType klass. DocumentType tillhandahåller ett gränssnitt till listan över enheter som är definierade för document
type: docs
weight: 680
url: /sv/net/aspose.html.dom/documenttype/
---
## DocumentType class

DocumentType tillhandahåller ett gränssnitt till listan över enheter som är definierade för document
...
| namn | Beskrivning |
| --- | --- |
| [DocumentType](documenttype/)(string, string, string, string, Document) | Initierar en ny instans av`DocumentType` class. |
...
| [InternalSubset](../../aspose.html.dom/documenttype/internalsubset/) { get; } | Den interna delmängden som en sträng, eller null om det inte finns någon. |
...
| [Name](../../aspose.html.dom/documenttype/name/) { get; } | Namnet på DTD; dvs namnet omedelbart efter DOCTYPE-nyckelordet. |
...
| override [NodeName](../../aspose.html.dom/documenttype/nodename/) { get; } | Namnet på denna nod, beroende på dess typ. |
| override [NodeType](../../aspose.html.dom/documenttype/nodetype/) { get; } | En kod som representerar typen av det underliggande objektet. |
...
| [PublicId](../../aspose.html.dom/documenttype/publicid/) { get; } | Den offentliga identifieraren för den externa delmängden. |
| [SystemId](../../aspose.html.dom/documenttype/systemid/) { get; } | Systemidentifieraren för den externa delmängden. Detta kan vara en absolut URI eller inte. |
...
| override [ToString](../../aspose.html.dom/documenttype/tostring/)() | Returnerar enString som representerar denna instans. |
