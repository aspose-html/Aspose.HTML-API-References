...
description: Aspose.Html.Dom.Element klass. Elementgränssnittet representerar ett element i ett HTML eller XMLdokument.
type: docs
weight: 690
url: /sv/net/aspose.html.dom/element/
---
## Element class
...
| namn | Beskrivning |
| --- | --- |
| [Element](element/)(IElementInit) | Initierar en ny instans av`Element`klass. Ring inte den här konstruktören direkt, använd[`CreateElement`](../document/createelement/) eller[`CreateElementNS`](../document/createelementns/) . |
...
| [Id](../../aspose.html.dom/element/id/) { get; set; } | Elementets identifierare. Se definitionen av id-attributet i HTML 4.01. |
...
| [ParentElement](../../aspose.html.dom/node/parentelement/) { get; } | Hämtar föräldern`Element` av denna nod. |
