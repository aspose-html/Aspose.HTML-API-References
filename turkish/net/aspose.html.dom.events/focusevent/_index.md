...
description: Aspose.Html.Dom.Events.FocusEvent sınıf. FocusEvent arabirimi Focus olaylarıyla ilişkili belirli bağlamsal bilgiler sağlar.
type: docs
weight: 780
url: /tr/net/aspose.html.dom.events/focusevent/
---
## FocusEvent class
...
| [RelatedTarget](../../aspose.html.dom.events/focusevent/relatedtarget/) { get; } | Olayın türüne bağlı olarak, bir Focus olayıyla ilgili ikincil EventTarget'ı tanımlamak için kullanılır. |
