...
description: Aspose.Html.Dom.Events.UIEvent sınıf. UIEvent arabirimi Kullanıcı Arabirimi olaylarıyla ilişkili belirli bağlamsal bilgiler sağlar.
type: docs
weight: 850
url: /tr/net/aspose.html.dom.events/uievent/
---
## UIEvent class

UIEvent arabirimi, Kullanıcı Arabirimi olaylarıyla ilişkili belirli bağlamsal bilgiler sağlar.
...
| İsim | Tanım |
| --- | --- |
| [UIEvent](uievent/#constructor)(string) | Yeni bir örneğini başlatır.`UIEvent` sınıf. |
| [UIEvent](uievent/#constructor_1)(string, IDictionary&lt;string, object&gt;) | Yeni bir örneğini başlatır.`UIEvent` sınıf. |
