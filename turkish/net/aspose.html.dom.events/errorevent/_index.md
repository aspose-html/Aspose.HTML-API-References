...
description: Aspose.Html.Dom.Events.ErrorEvent sınıf. ErrorEvent çalışma zamanı sırasında oluşan bir hata hakkında bağlamsal bilgi sağlar.
type: docs
weight: 760
url: /tr/net/aspose.html.dom.events/errorevent/
---
## ErrorEvent class
