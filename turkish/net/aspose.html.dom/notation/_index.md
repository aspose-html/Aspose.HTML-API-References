...
description: Aspose.Html.Dom.Notation sınıf. DTD. de bildirilen bir notasyonu temsil eder.
type: docs
weight: 1010
url: /tr/net/aspose.html.dom/notation/
---
## Notation class

DTD. 'de bildirilen bir notasyonu temsil eder.
...
| override [NodeName](../../aspose.html.dom/notation/nodename/) { get; } | Türüne bağlı olarak bu düğümün adı. |
| override [NodeType](../../aspose.html.dom/notation/nodetype/) { get; } | Altta yatan nesnenin türünü temsil eden bir kod. |
...
| [PublicId](../../aspose.html.dom/notation/publicid/) { get; } | Bu gösterimin genel tanımlayıcısı. Genel tanımlayıcı belirtilmemişse, bu null. |
| [SystemId](../../aspose.html.dom/notation/systemid/) { get; } | Bu gösterimin sistem tanımlayıcısı. Sistem tanımlayıcısı belirtilmemişse, bu boştur. Bu, mutlak bir URI olabilir veya olmayabilir. |
