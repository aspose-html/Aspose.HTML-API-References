...
description: Aspose.Html.Dom.Node sınıf. Düğüm arabirimi tüm Belge nesnesi Modeli için birincil veri türüdür. Belge ağacında tek bir düğümü temsil eder.
type: docs
weight: 1000
url: /tr/net/aspose.html.dom/node/
---
## Node class

Düğüm arabirimi, tüm Belge nesnesi Modeli için birincil veri türüdür. Belge ağacında tek bir düğümü temsil eder.
...
| abstract [NodeName](../../aspose.html.dom/node/nodename/) { get; } | Türüne bağlı olarak bu düğümün adı. |
| abstract [NodeType](../../aspose.html.dom/node/nodetype/) { get; } | Altta yatan nesnenin türünü temsil eden bir kod. |
...
| [CloneNode](../../aspose.html.dom/node/clonenode/#clonenode)() | Bu düğümün bir kopyasını döndürür, yani düğümler için genel bir kopya oluşturucu görevi görür. Yinelenen düğümün üst öğesi (parentNode boştur) ve kullanıcı verisi yoktur. |
| [CloneNode](../../aspose.html.dom/node/clonenode/#clonenode_1)(bool) | Bu düğümün bir kopyasını döndürür, yani düğümler için genel bir kopya oluşturucu görevi görür. Yinelenen düğümün üst öğesi (parentNode boştur) ve kullanıcı verisi yoktur. |
...
| İsim | Tanım |
| --- | --- |
| const [ATTRIBUTE_NODE](../../aspose.html.dom/node/attribute_node/) | Bir öznitelik node |
| const [CDATA_SECTION_NODE](../../aspose.html.dom/node/cdata_section_node/) | Bir cdata bölümü node |
| const [COMMENT_NODE](../../aspose.html.dom/node/comment_node/) | Bir yorum düğümü |
| const [DOCUMENT_FRAGMENT_NODE](../../aspose.html.dom/node/document_fragment_node/) | Bir belge parçası node |
| const [DOCUMENT_NODE](../../aspose.html.dom/node/document_node/) | Bir belge düğümü |
| const [DOCUMENT_TYPE_NODE](../../aspose.html.dom/node/document_type_node/) | Bir belge türü node |
| const [ELEMENT_NODE](../../aspose.html.dom/node/element_node/) | Bir öğe node |
| const [ENTITY_NODE](../../aspose.html.dom/node/entity_node/) | Bir varlık node |
| const [ENTITY_REFERENCE_NODE](../../aspose.html.dom/node/entity_reference_node/) | Bir varlık referans düğümü |
| const [NOTATION_NODE](../../aspose.html.dom/node/notation_node/) | Bir gösterim düğümü |
| const [PROCESSING_INSTRUCTION_NODE](../../aspose.html.dom/node/processing_instruction_node/) | Bir işleme talimatı node |
| const [TEXT_NODE](../../aspose.html.dom/node/text_node/) | Bir metin düğümü |
