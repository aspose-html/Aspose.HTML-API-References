...
description: Aspose.Html.Dom.Element sınıf. Öğe arabirimi bir HTML veya XML belgesindeki bir öğeyi temsil eder.
type: docs
weight: 690
url: /tr/net/aspose.html.dom/element/
---
## Element class

Öğe arabirimi, bir HTML veya XML belgesindeki bir öğeyi temsil eder.
...
| İsim | Tanım |
| --- | --- |
| [Element](element/)(IElementInit) | Yeni bir örneğini başlatır.`Element`sınıf. Bu yapıcıyı doğrudan aramayın, kullanın[`CreateElement`](../document/createelement/) veya[`CreateElementNS`](../document/createelementns/) . |
...
| [Id](../../aspose.html.dom/element/id/) { get; set; } | Öğenin tanımlayıcısı. HTML 4.01. 'deki id niteliği tanımına bakın |
...
| [ParentElement](../../aspose.html.dom/node/parentelement/) { get; } | Ebeveyni alır`Element` bu düğümün. |
