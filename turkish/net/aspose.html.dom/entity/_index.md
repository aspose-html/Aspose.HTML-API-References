...
description: Aspose.Html.Dom.Entity sınıf. Bir XML belgesinde ayrıştırılmış veya ayrıştırılmamış olarak bilinen bir varlığı temsil eder.
type: docs
weight: 700
url: /tr/net/aspose.html.dom/entity/
---
## Entity class
...
| [InputEncoding](../../aspose.html.dom/entity/inputencoding/) { get; } | Harici ayrıştırılmış bir varlık olduğunda, ayrıştırma sırasında bu varlık için kullanılan kodlamayı belirten bir öznitelik. Bu, dahili alt kümeden bir varlıksa veya bilinmiyorsa boştur. |
...
| override [NodeName](../../aspose.html.dom/entity/nodename/) { get; } | Türüne bağlı olarak bu düğümün adı. |
| override [NodeType](../../aspose.html.dom/entity/nodetype/) { get; } | Altta yatan nesnenin türünü temsil eden bir kod. |
| virtual [NodeValue](../../aspose.html.dom/node/nodevalue/) { get; set; } | Türüne bağlı olarak bu düğümün değeri. |
| [NotationName](../../aspose.html.dom/entity/notationname/) { get; } | Ayrıştırılmamış varlıklar için, varlığın gösteriminin adı. Ayrıştırılmış varlıklar için bu null. |
...
| [PublicId](../../aspose.html.dom/entity/publicid/) { get; } | Belirtilmişse varlıkla ilişkili genel tanımlayıcı, aksi halde boş. |
| [SystemId](../../aspose.html.dom/entity/systemid/) { get; } | Belirtilmişse varlıkla ilişkili sistem tanımlayıcısı, aksi halde boş. Bu, mutlak bir URI olabilir veya olmayabilir. |
...
| [XmlEncoding](../../aspose.html.dom/entity/xmlencoding/) { get; } | Harici ayrıştırılmış bir varlık olduğunda, metin bildiriminin bir parçası olarak bu varlığın kodlamasını belirten bir öznitelik. Aksi takdirde bu boştur. |
| [XmlVersion](../../aspose.html.dom/entity/xmlversion/) { get; } | Harici ayrıştırılmış bir varlık olduğunda, metin bildiriminin bir parçası olarak bu varlığın sürüm numarasını belirten bir öznitelik. Aksi takdirde bu boştur. |
