...
description: Aspose.Html.Dom.Comment sınıf. CharacterDatadan devralır ve bir yorumun içeriğini temsil eder yani  ile başlayan arasındaki tüm karakterler .
type: docs
weight: 310
url: /tr/net/aspose.html.dom/comment/
---
## Comment class

CharacterData'dan devralır ve bir yorumun içeriğini temsil eder, yani ' ile başlayan arasındaki tüm karakterler .
...
| override [NodeName](../../aspose.html.dom/comment/nodename/) { get; } | Türüne bağlı olarak bu düğümün adı. |
| override [NodeType](../../aspose.html.dom/comment/nodetype/) { get; } | Altta yatan nesnenin türünü temsil eden bir kod. |
| override [NodeValue](../../aspose.html.dom/comment/nodevalue/) { get; set; } | Türüne bağlı olarak bu düğümün değeri. |
