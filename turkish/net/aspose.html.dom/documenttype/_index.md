...
description: Aspose.Html.Dom.DocumentType sınıf. DocumentType document için tanımlanan varlıkların listesine bir arabirim sağlar.
type: docs
weight: 680
url: /tr/net/aspose.html.dom/documenttype/
---
## DocumentType class
...
| İsim | Tanım |
| --- | --- |
| [DocumentType](documenttype/)(string, string, string, string, Document) | Yeni bir örneğini başlatır.`DocumentType` sınıf. |
...
| [InternalSubset](../../aspose.html.dom/documenttype/internalsubset/) { get; } | Dizi olarak dahili altküme veya hiçbiri yoksa null. |
...
| [Name](../../aspose.html.dom/documenttype/name/) { get; } | DTD'nin adı; yani, DOCTYPE anahtar sözcüğünden hemen sonraki ad. |
...
| override [NodeName](../../aspose.html.dom/documenttype/nodename/) { get; } | Türüne bağlı olarak bu düğümün adı. |
| override [NodeType](../../aspose.html.dom/documenttype/nodetype/) { get; } | Altta yatan nesnenin türünü temsil eden bir kod. |
...
| [PublicId](../../aspose.html.dom/documenttype/publicid/) { get; } | Harici alt kümenin genel tanımlayıcısı. |
| [SystemId](../../aspose.html.dom/documenttype/systemid/) { get; } | Harici alt kümenin sistem tanımlayıcısı. Bu, mutlak bir URI olabilir veya olmayabilir. |
...
| override [ToString](../../aspose.html.dom/documenttype/tostring/)() | a döndürürString bu örneği temsil eder. |
