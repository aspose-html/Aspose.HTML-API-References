...
description: Aspose.Html.Dom.CDATASection sınıf. CDATA bölümleri normalde biçimlendirme olarak kabul edilecek karakterleri içeren metin bloklarından kaçmak için kullanılır.
type: docs
weight: 200
url: /tr/net/aspose.html.dom/cdatasection/
---
## CDATASection class

CDATA bölümleri, normalde biçimlendirme olarak kabul edilecek karakterleri içeren metin bloklarından kaçmak için kullanılır.
...
| [IsElementContentWhitespace](../../aspose.html.dom/text/iselementcontentwhitespace/) { get; } | Bu metin düğümünün öğe içeriği boşluk içerip içermediğini döndürür, genellikle kötü bir şekilde "göz ardı edilebilir boşluk" olarak adlandırılır. |
...
| override [NodeName](../../aspose.html.dom/cdatasection/nodename/) { get; } | Türüne bağlı olarak bu düğümün adı. |
| override [NodeType](../../aspose.html.dom/cdatasection/nodetype/) { get; } | Altta yatan nesnenin türünü temsil eden bir kod. |
| override [NodeValue](../../aspose.html.dom/text/nodevalue/) { get; set; } | Türüne bağlı olarak bu düğümün değeri. |
...
| [WholeText](../../aspose.html.dom/text/wholetext/) { get; } | Bu düğüme mantıksal olarak bitişik metin düğümlerinin tüm metinlerini belge sırasına göre birleştirilmiş olarak döndürür. |
...
| [ReplaceWholeText](../../aspose.html.dom/text/replacewholetext/)(string) | Geçerli düğümün metnini ve tüm mantıksal olarak bitişik metin düğümlerini belirtilen metinle değiştirir. Değiştirilen metnin alıcısı olmadığı sürece geçerli düğüm de dahil olmak üzere mantıksal olarak bitişik tüm metin düğümleri kaldırılır. |
| [SplitText](../../aspose.html.dom/text/splittext/)(int) | Her ikisini de ağaçta kardeş olarak tutarak, bu düğümü belirtilen uzaklıkta iki düğüme böler. |
