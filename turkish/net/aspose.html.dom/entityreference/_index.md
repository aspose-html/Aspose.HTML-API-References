...
description: Aspose.Html.Dom.EntityReference sınıf. EntityReference düğümleri ağaçta bir varlık referansını temsil etmek için kullanılabilir.
type: docs
weight: 710
url: /tr/net/aspose.html.dom/entityreference/
---
## EntityReference class

EntityReference düğümleri, ağaçta bir varlık referansını temsil etmek için kullanılabilir.
...
| override [NodeName](../../aspose.html.dom/entityreference/nodename/) { get; } | Türüne bağlı olarak bu düğümün adı. |
| override [NodeType](../../aspose.html.dom/entityreference/nodetype/) { get; } | Altta yatan nesnenin türünü temsil eden bir kod. |
