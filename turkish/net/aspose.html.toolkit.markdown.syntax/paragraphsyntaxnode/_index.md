...
description: Aspose.Html.Toolkit.Markdown.Syntax.ParagraphSyntaxNode sınıf. Paragraf sözdizimi düğümünü temsil eder.
type: docs
weight: 5310
url: /tr/net/aspose.html.toolkit.markdown.syntax/paragraphsyntaxnode/
---
## ParagraphSyntaxNode class

Paragraf sözdizimi düğümünü temsil eder.
...
| İsim | Tanım |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/paragraphsyntaxnode/accept/)(MarkdownSyntaxVisitor) | Ziyaretçinin kabulü için arayüzü tanımlar. |
...
| [GetContent](../../aspose.html.toolkit.markdown.syntax/paragraphsyntaxnode/getcontent/)() | İçeriği almak için arabirimi tanımlar. |
