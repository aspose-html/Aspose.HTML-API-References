...
description: Aspose.Html.Toolkit.Markdown.Syntax.HardBreakSyntaxNode sınıf. HardBreakSyntaxNodeu temsil eder.
type: docs
weight: 5010
url: /tr/net/aspose.html.toolkit.markdown.syntax/hardbreaksyntaxnode/
---
## HardBreakSyntaxNode class

HardBreakSyntaxNode'u temsil eder.
...
| virtual [Source](../../aspose.html.toolkit.markdown.syntax/linebreaksyntaxnode/source/) { get; } | Kaynağı alın. |
| virtual [Span](../../aspose.html.toolkit.markdown.syntax/linebreaksyntaxnode/span/) { get; } | Açıklığı alın. |
| [Value](../../aspose.html.toolkit.markdown.syntax/linebreaksyntaxnode/value/) { get; } | Değeri alın. |

## yöntemler

| İsim | Tanım |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/hardbreaksyntaxnode/accept/)(MarkdownSyntaxVisitor) | Ziyaretçi kabul etmek için arayüzü tanımlar. |
...
| [GetBreakingTag](../../aspose.html.toolkit.markdown.syntax/hardbreaksyntaxnode/getbreakingtag/)() | Breaking Tag'ı almak için arayüzü tanımlar |
