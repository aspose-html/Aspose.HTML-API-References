...
description: Aspose.Html.Toolkit.Markdown.Syntax.WhitespaceSyntaxNode sınıf. Boşluk sözdizimi düğümünü temsil eder.
type: docs
weight: 5740
url: /tr/net/aspose.html.toolkit.markdown.syntax/whitespacesyntaxnode/
---
## WhitespaceSyntaxNode class

Boşluk sözdizimi düğümünü temsil eder.
...
| İsim | Tanım |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/whitespacesyntaxnode/accept/)(MarkdownSyntaxVisitor) | Sözdiziminin düğümlerini ziyaret etmek için arabirimi tanımlar. |
