...
description: Aspose.Html.Toolkit.Markdown.Syntax.ThematicBreakSyntaxNode sınıf. Tematik Ara Söz Dizimi Düğümünü Uyguladı.
type: docs
weight: 5680
url: /tr/net/aspose.html.toolkit.markdown.syntax/thematicbreaksyntaxnode/
---
## ThematicBreakSyntaxNode class

Tematik Ara Söz Dizimi Düğümünü Uyguladı.
...
| İsim | Tanım |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/thematicbreaksyntaxnode/accept/)(MarkdownSyntaxVisitor) | Ziyaretçi kabul etmek için arayüzü tanımlar. |
