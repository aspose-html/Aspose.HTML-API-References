...
description: Aspose.Html.Toolkit.Markdown.Syntax.TextSyntaxNode sınıf. Metin sözdizimi düğümü uygulandı.
type: docs
weight: 5670
url: /tr/net/aspose.html.toolkit.markdown.syntax/textsyntaxnode/
---
## TextSyntaxNode class

Metin sözdizimi düğümü uygulandı.
...
| İsim | Tanım |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/textsyntaxnode/accept/)(MarkdownSyntaxVisitor) | Ziyaretçi kabul etmek için arayüzü tanımlar. |
