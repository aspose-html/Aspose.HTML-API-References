...
description: Aspose.Html.Toolkit.Markdown.Syntax.OrderedListItemMarker sınıf. Sıralı liste öğesi işaretçisini temsil eder.
type: docs
weight: 5290
url: /tr/net/aspose.html.toolkit.markdown.syntax/orderedlistitemmarker/
---
## OrderedListItemMarker class

Sıralı liste öğesi işaretçisini temsil eder.
...
| [GetDelimiter](../../aspose.html.toolkit.markdown.syntax/orderedlistitemmarker/getdelimiter/)() | Ayırıcıyı almak için arabirimi tanımlar. |
| [GetIndex](../../aspose.html.toolkit.markdown.syntax/orderedlistitemmarker/getindex/)() | Get index. için arabirimi tanımlar. |
