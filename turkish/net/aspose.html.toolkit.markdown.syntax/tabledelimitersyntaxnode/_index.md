...
description: Aspose.Html.Toolkit.Markdown.Syntax.TableDelimiterSyntaxNode sınıf. Tablo sınırlayıcı sözdizimi düğümünü temsil eder.
type: docs
weight: 5570
url: /tr/net/aspose.html.toolkit.markdown.syntax/tabledelimitersyntaxnode/
---
## TableDelimiterSyntaxNode class

Tablo sınırlayıcı sözdizimi düğümünü temsil eder.
