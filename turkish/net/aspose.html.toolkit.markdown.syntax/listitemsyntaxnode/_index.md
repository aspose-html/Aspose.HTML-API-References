...
description: Aspose.Html.Toolkit.Markdown.Syntax.ListItemSyntaxNode sınıf. ListItemSyntaxNodeu temsil eder.
type: docs
weight: 5150
url: /tr/net/aspose.html.toolkit.markdown.syntax/listitemsyntaxnode/
---
## ListItemSyntaxNode class

ListItemSyntaxNode'u temsil eder.
...
| İsim | Tanım |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/listitemsyntaxnode/accept/)(MarkdownSyntaxVisitor) | Ziyaretçi kabul etmek için arayüzü tanımlar. |
...
| [GetLinesLeadingTrivia](../../aspose.html.toolkit.markdown.syntax/multilinecontainerblocksyntaxnode/getlinesleadingtrivia/)() | Trivia. 'ye giden satırları almak için arabirimi tanımlar |
| [GetMarker](../../aspose.html.toolkit.markdown.syntax/listitemsyntaxnode/getmarker/)() | İşaretçiyi al |
...
| [IsTight](../../aspose.html.toolkit.markdown.syntax/listitemsyntaxnode/istight/)() | Sıkıysa doğru olur. |
