...
description: Aspose.Html.Toolkit.Markdown.Syntax.EscapedCharacterSyntaxNode sınıf. Kaçış karakteri sözdizimi node. uygulandı
type: docs
weight: 4890
url: /tr/net/aspose.html.toolkit.markdown.syntax/escapedcharactersyntaxnode/
---
## EscapedCharacterSyntaxNode class

Kaçış karakteri sözdizimi node. uygulandı
...
| virtual [Source](../../aspose.html.toolkit.markdown.syntax/textsyntaxnode/source/) { get; } | Kaynak metni döndür. |
| virtual [Span](../../aspose.html.toolkit.markdown.syntax/textsyntaxnode/span/) { get; } | get span. için arabirimi tanımlar |
| [Value](../../aspose.html.toolkit.markdown.syntax/textsyntaxnode/value/) { get; } | Dizi değeri alma özelliğini tanımlar. |

## yöntemler

| İsim | Tanım |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/escapedcharactersyntaxnode/accept/)(MarkdownSyntaxVisitor) | Ziyaretçi kabul etmek için arayüzü tanımlar. |
