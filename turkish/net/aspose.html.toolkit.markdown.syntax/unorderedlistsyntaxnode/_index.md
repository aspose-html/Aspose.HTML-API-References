...
description: Aspose.Html.Toolkit.Markdown.Syntax.UnorderedListSyntaxNode sınıf. Sırasız liste sözdizimi düğümünü temsil eder.
type: docs
weight: 5730
url: /tr/net/aspose.html.toolkit.markdown.syntax/unorderedlistsyntaxnode/
---
## UnorderedListSyntaxNode class

Sırasız liste sözdizimi düğümünü temsil eder.
...
| İsim | Tanım |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/unorderedlistsyntaxnode/accept/)(MarkdownSyntaxVisitor) | Sözdiziminin düğümlerini ziyaret etmek için arabirimi tanımlar. |
...
| [GetMarker](../../aspose.html.toolkit.markdown.syntax/unorderedlistsyntaxnode/getmarker/)() | İşaretleyiciden alınacak arabirimi tanımlar. |
...
| [IsTight](../../aspose.html.toolkit.markdown.syntax/listsyntaxnode/istight/)() | get için arayüzü tanımlar sıkı. |
