...
description: Aspose.Html.Toolkit.Markdown.Syntax.TableSyntaxNode sınıf. TableSyntax sınıf düğümü.
type: docs
weight: 5590
url: /tr/net/aspose.html.toolkit.markdown.syntax/tablesyntaxnode/
---
## TableSyntaxNode class

TableSyntax sınıf düğümü.
...
| İsim | Tanım |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/tablesyntaxnode/accept/)(MarkdownSyntaxVisitor) | Ziyaretçinin kabulü için arayüzü tanımlar. |
| [AppendChild](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/appendchild/)(MarkdownSyntaxNode) | Alt düğümü ekle. |
| [AppendRow](../../aspose.html.toolkit.markdown.syntax/tablesyntaxnode/appendrow/)(TableRowSyntaxNode) | Ekleme satırı için arabirimi tanımlar. |
| [ChildNodes](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/childnodes/)() | Alt düğüm koleksiyonunu alın. |
| [GetAlignment](../../aspose.html.toolkit.markdown.syntax/tablesyntaxnode/getalignment/)() | Hizalama için arayüzü tanımlar. |
| [GetBodyRows](../../aspose.html.toolkit.markdown.syntax/tablesyntaxnode/getbodyrows/)() | Gövde satırlarını almak için arayüzü tanımlar. |
| [GetHeader](../../aspose.html.toolkit.markdown.syntax/tablesyntaxnode/getheader/)() | Tablo başlığını almak için arabirimi tanımlar. |
