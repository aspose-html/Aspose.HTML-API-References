...
description: Aspose.Html.Toolkit.Markdown.Syntax.MarkdownSyntaxToken sınıf. Markdown Sözdizimi Simgesini Temsil Eder.
type: docs
weight: 5210
url: /tr/net/aspose.html.toolkit.markdown.syntax/markdownsyntaxtoken/
---
## MarkdownSyntaxToken class

Markdown Sözdizimi Simgesini Temsil Eder.
...
| [Source](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxtoken/source/) { get; } | Kaynak metni alın. |
| [Span](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxtoken/span/) { get; } | Açıklığı alın. |
| [Text](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxtoken/text/) { get; } | span. metin içeriğini alın |

## yöntemler

| İsim | Tanım |
| --- | --- |
| virtual [Accept](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxnode/accept/)(MarkdownSyntaxVisitor) | Ziyaretçiyi kabul edin. |
...
| [GetFullText](../../aspose.html.toolkit.markdown.syntax/markdownsyntaxtoken/getfulltext/)() | Tam metni almak için arayüzü tanımlar. |
