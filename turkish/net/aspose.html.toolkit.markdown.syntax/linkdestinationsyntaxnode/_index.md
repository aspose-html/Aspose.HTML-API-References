...
description: Aspose.Html.Toolkit.Markdown.Syntax.LinkDestinationSyntaxNode sınıf. LinkDestinationSyntaxNodeu temsil eder.
type: docs
weight: 5110
url: /tr/net/aspose.html.toolkit.markdown.syntax/linkdestinationsyntaxnode/
---
## LinkDestinationSyntaxNode class

LinkDestinationSyntaxNode'u temsil eder.
...
| İsim | Tanım |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/linkdestinationsyntaxnode/accept/)(MarkdownSyntaxVisitor) | Ziyaretçi kabul etmek için arayüzü tanımlar. |
...
| [GetEnumerator](../../aspose.html.toolkit.markdown.syntax/inlinecontainersyntaxnode/getenumerator/)() | Koleksiyon boyunca yinelenen bir numaralandırıcı döndürür. |
...
| [GetValue](../../aspose.html.toolkit.markdown.syntax/linkdestinationsyntaxnode/getvalue/)() | Dizi değeri almak için arabirimi tanımlar. |
