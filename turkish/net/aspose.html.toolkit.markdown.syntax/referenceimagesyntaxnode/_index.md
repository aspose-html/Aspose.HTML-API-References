...
description: Aspose.Html.Toolkit.Markdown.Syntax.ReferenceImageSyntaxNode sınıf. Referans görüntü sözdizimi.
type: docs
weight: 5510
url: /tr/net/aspose.html.toolkit.markdown.syntax/referenceimagesyntaxnode/
---
## ReferenceImageSyntaxNode class

Referans görüntü sözdizimi.
...
| İsim | Tanım |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/referenceimagesyntaxnode/accept/)(MarkdownSyntaxVisitor) | Ziyaretçinin kabulü için arayüzü tanımlar. |
...
| [GetAltText](../../aspose.html.toolkit.markdown.syntax/referenceimagesyntaxnode/getalttext/)() | Alternatif metnin alınması için arayüzü tanımlar. |
| [GetLabel](../../aspose.html.toolkit.markdown.syntax/referenceimagesyntaxnode/getlabel/)() | Etiket alma arabirimini tanımlar. |
