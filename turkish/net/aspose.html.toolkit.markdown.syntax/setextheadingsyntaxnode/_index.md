...
description: Aspose.Html.Toolkit.Markdown.Syntax.SetextHeadingSyntaxNode sınıf. Setext başlık sözdizimi düğümünü temsil eder.
type: docs
weight: 5530
url: /tr/net/aspose.html.toolkit.markdown.syntax/setextheadingsyntaxnode/
---
## SetextHeadingSyntaxNode class

Setext başlık sözdizimi düğümünü temsil eder.
...
| [Level](../../aspose.html.toolkit.markdown.syntax/setextheadingsyntaxnode/level/) { get; } | Mevcut sözdiziminin seviyesini alın. |
...
| İsim | Tanım |
| --- | --- |
| override [Accept](../../aspose.html.toolkit.markdown.syntax/setextheadingsyntaxnode/accept/)(MarkdownSyntaxVisitor) | Ziyaretçinin kabulü için arayüzü tanımlar. |
