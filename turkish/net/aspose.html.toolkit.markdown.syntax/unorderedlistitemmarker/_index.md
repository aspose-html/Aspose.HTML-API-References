...
description: Aspose.Html.Toolkit.Markdown.Syntax.UnorderedListItemMarker sınıf. Sırasız liste öğesi sözdizimini temsil eder.
type: docs
weight: 5720
url: /tr/net/aspose.html.toolkit.markdown.syntax/unorderedlistitemmarker/
---
## UnorderedListItemMarker class

Sırasız liste öğesi sözdizimini temsil eder.
