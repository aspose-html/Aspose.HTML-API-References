...
description: Aspose.Html.Rendering.GraphicContext sınıf. Geçerli grafik kontrol parametrelerini tutar. Bu parametreler grafik işleçlerinin yürüttüğü genel çerçeveyi tanımlar.
type: docs
weight: 4260
url: /tr/net/aspose.html.rendering/graphiccontext/
---
## GraphicContext class

Geçerli grafik kontrol parametrelerini tutar. Bu parametreler, grafik işleçlerinin yürüttüğü genel çerçeveyi tanımlar.
...
| İsim | Tanım |
| --- | --- |
| [GraphicContext](graphiccontext/)() | Yeni bir örneğini başlatır.`GraphicContext` sınıf. |
...
| virtual [TextInfo](../../aspose.html.rendering/graphiccontext/textinfo/) { get; } | Bir alır[`TextInfo`](../textinfo/) işlenmiş metin hakkında bilgi içeren nesne. |
| virtual [TransformationMatrix](../../aspose.html.rendering/graphiccontext/transformationmatrix/) { get; set; } | Dönüşüm matrisini ayarlar veya alır. |

## yöntemler

| İsim | Tanım |
| --- | --- |
| virtual [Clone](../../aspose.html.rendering/graphiccontext/clone/)() | Mevcut bir örnekle aynı özellik değerlerine sahip bir GraphicContext sınıfının yeni bir örneğini oluşturur. |
| virtual [Transform](../../aspose.html.rendering/graphiccontext/transform/)(Matrix) | Geçerli dönüşüm matrisini, belirtilen matrisi çarparak değiştirin. |
