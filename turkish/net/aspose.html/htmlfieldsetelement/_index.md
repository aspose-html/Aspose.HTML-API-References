...
description: Aspose.Html.HTMLFieldSetElement sınıf. Form denetimlerini mantıksal gruplar halinde düzenler. HTML 4.01. deki FIELDSET öğesi tanımına bakın
type: docs
weight: 3210
url: /tr/net/aspose.html/htmlfieldsetelement/
---
## HTMLFieldSetElement class

Form denetimlerini mantıksal gruplar halinde düzenler. HTML 4.01. 'deki FIELDSET öğesi tanımına bakın
...
| [Form](../../aspose.html/htmlfieldsetelement/form/) { get; } | şunu döndürür:`BİÇİM` bu denetimi içeren öğe. döndürür`hükümsüz` bu kontrol bir formu bağlamında değilse. |
