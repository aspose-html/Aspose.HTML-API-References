...
description: Aspose.Html.HTMLMetaElement sınıf. Bu belge hakkında genel meta bilgileri içerir. HTML 4.01. deki META öğe tanımına bakın
type: docs
weight: 3400
url: /tr/net/aspose.html/htmlmetaelement/
---
## HTMLMetaElement class

Bu, belge hakkında genel meta bilgileri içerir. HTML 4.01. 'deki META öğe tanımına bakın
...
| [Content](../../aspose.html/htmlmetaelement/content/) { get; set; } | İlişkili bilgiler. HTML'deki içerik özelliği tanımına bakın 4.01. |
...
| [HttpEquiv](../../aspose.html/htmlmetaelement/httpequiv/) { get; set; } | HTTP yanıt başlığı adı [[IETF RFC 2616](http://www.ietf.org/rfc/rfc2616.txt) ]. HTML 4.01. 'deki http-equiv özellik tanımına bakın |
...
| [Name](../../aspose.html/htmlmetaelement/name/) { get; set; } | Meta bilgi adı. HTML 4.01. 'deki ad özelliği tanımına bakın |
...
| [Scheme](../../aspose.html/htmlmetaelement/scheme/) { get; set; } | İçerik biçimini seçin. HTML 4.01. 'deki şema özniteliği tanımına bakın |
