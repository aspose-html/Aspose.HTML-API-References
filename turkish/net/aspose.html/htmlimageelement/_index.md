...
description: Aspose.Html.HTMLImageElement sınıf. Katıştırılmış görüntü. HTML 4.01. deki IMG öğe tanımına bakın
type: docs
weight: 3310
url: /tr/net/aspose.html/htmlimageelement/
---
## HTMLImageElement class

Katıştırılmış görüntü. HTML 4.01. 'deki IMG öğe tanımına bakın
...
| İsim | Tanım |
| --- | --- |
| [Align](../../aspose.html/htmlimageelement/align/) { get; set; } | Bu nesneyi (dikey veya yatay olarak) çevreleyen metnine göre hizalar. HTML 4.01'deki hizalama özniteliği tanımına bakın. Bu özellik HTML 4.01. 'de kullanımdan kaldırılmıştır. |
| [Alt](../../aspose.html/htmlimageelement/alt/) { get; set; } | Bu öğesinin normal içeriğini oluşturmayan kullanıcı aracıları için alternatif metin. HTML 4.01. 'deki alt nitelik tanımına bakın |
...
| [Border](../../aspose.html/htmlimageelement/border/) { get; set; } | Görüntünün etrafındaki kenarlık genişliği. HTML 4.01'deki kenarlık özelliği tanımına bakın. Bu özellik HTML 4.01'de kullanımdan kaldırılmıştır. Bu özniteliğin türünün,`DOMString` DOM Düzey 1 HTML'de [[DOM Seviye 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ] . |
...
| [Height](../../aspose.html/htmlimageelement/height/) { get; set; } | Görüntünün piksel cinsinden yüksekliği. HTML 4.01'deki yükseklik özelliği tanımına bakın. Bu özelliğin türünün olduğunu unutmayın.`DOMString` DOM Düzey 1 HTML'de [[DOM Seviye 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ]. @version DOM Düzeyi 2 |
| [Hspace](../../aspose.html/htmlimageelement/hspace/) { get; set; } | Bu görüntünün solunda ve sağında piksel cinsinden yatay boşluk. HTML 4.01'deki hspace nitelik tanımına bakın. Bu öznitelik, HTML 4.01'de kullanımdan kaldırılmıştır. Bu özelliğin türünün olduğunu unutmayın.`DOMString` DOM Düzey 1 HTML'de [[DOM Seviye 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ]. @version DOM Düzeyi 2 |
...
| [IsMap](../../aspose.html/htmlimageelement/ismap/) { get; set; } | Sunucu tarafı görüntü eşlemesini kullanın. HTML 4.01. 'deki ismap öznitelik tanımına bakın |
...
| [LongDesc](../../aspose.html/htmlimageelement/longdesc/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] bu görüntünün veya çerçevenin uzun bir açıklamasını belirtir. HTML 4.01. 'deki longdesc öznitelik tanımına bakın |
| [Name](../../aspose.html/htmlimageelement/name/) { get; set; } | Öğenin adı (geriye dönük uyumluluk için). |
...
| [Src](../../aspose.html/htmlimageelement/src/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] bu görüntünün kaynağını belirtir. HTML 4.01. 'deki src özniteliği tanımına bakın |
...
| [UseMap](../../aspose.html/htmlimageelement/usemap/) { get; set; } | İstemci tarafı görüntü eşlemesini kullanın. HTML 4.01. 'deki kullanım haritası öznitelik tanımına bakın |
| [Vspace](../../aspose.html/htmlimageelement/vspace/) { get; set; } | Bu görüntünün üstünde ve altında piksel cinsinden dikey boşluk. HTML 4.01'deki vspace nitelik tanımına bakın. Bu öznitelik, HTML 4.01'de kullanımdan kaldırılmıştır. Bu özelliğin türünün DOM Düzey 1 HTML'de "DOMString" olduğunu unutmayın [[DOM Seviye 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ]. @version DOM Düzeyi 2 |
| [Width](../../aspose.html/htmlimageelement/width/) { get; set; } | Görüntünün piksel cinsinden genişliği. HTML 4.01'deki genişlik özelliği tanımına bakın. Bu özelliğin türünün olduğunu unutmayın.`DOMString` DOM Düzey 1 HTML'de [[DOM Seviye 1](http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001) ]. @version DOM Düzeyi 2 |
