...
description: Aspose.Html.HTMLBaseFontElement sınıf. Temel yazı tipi. HTML 4.01deki BASEFONT öğe tanımına bakın. Bu öğe  HTML 4.01. de kullanımdan kaldırılmıştır
type: docs
weight: 3110
url: /tr/net/aspose.html/htmlbasefontelement/
---
## HTMLBaseFontElement class

Temel yazı tipi. HTML 4.01'deki BASEFONT öğe tanımına bakın. Bu öğe , HTML 4.01. 'de kullanımdan kaldırılmıştır
...
| [Color](../../aspose.html/htmlbasefontelement/color/) { get; set; } | Yazı tipi rengi. HTML 4.01'deki renk özelliği tanımına bakın. Bu özelliği, HTML 4.01. 'de kullanımdan kaldırılmıştır. |
...
| [Face](../../aspose.html/htmlbasefontelement/face/) { get; set; } | Yazı tipi yüzü tanımlayıcısı. HTML 4.01'deki yüz özelliği tanımına bakın. Bu özellik HTML 4.01. 'de kullanımdan kaldırılmıştır. |
...
| [Size](../../aspose.html/htmlbasefontelement/size/) { get; set; } | Hesaplanan yazı tipi boyutu. HTML 4.01'deki boyut özelliği tanımına bakın. Bu öznitelik HTML 4.01. @version DOM Level 2 'de kullanımdan kaldırılmıştır |
