...
description: Aspose.Html.HTMLParagraphElement sınıf. Paragraflar. HTML 4.01. deki P öğesi tanımına bakın
type: docs
weight: 3470
url: /tr/net/aspose.html/htmlparagraphelement/
---
## HTMLParagraphElement class

Paragraflar. HTML 4.01. 'deki P öğesi tanımına bakın
...
| İsim | Tanım |
| --- | --- |
| [Align](../../aspose.html/htmlparagraphelement/align/) { get; set; } | Yatay metin hizalaması. HTML 4.01'deki hizalama özelliği tanımına bakın. Bu özellik HTML 4.01. 'de kullanımdan kaldırılmıştır |
