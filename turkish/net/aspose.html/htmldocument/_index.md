...
description: Aspose.Html.HTMLDocument sınıf. birHTMLBelgesi HTML hiyerarşisinin köküdür ve tüm içeriği tutar. Hiyerarşiye erişim sağlamanın yanı sıra  belgeden belirli bilgi kümelerine erişmek için bazı kolaylık sağlayan yöntemler de sağlar.
type: docs
weight: 3190
url: /tr/net/aspose.html/htmldocument/
---
## HTMLDocument class

bir`HTMLBelgesi` HTML hiyerarşisinin köküdür ve tüm içeriği tutar. Hiyerarşiye erişim sağlamanın yanı sıra, , belgeden belirli bilgi kümelerine erişmek için bazı kolaylık sağlayan yöntemler de sağlar.

Aşağıdaki özellikler, için karşılık gelenler lehine kullanımdan kaldırılmıştır.`VÜCUT` element. DOM Düzey 2'de, yöntem`getElementById` dan miras alınır`belge` taşındığı arayüz.
...
| İsim | Tanım |
| --- | --- |
| [HTMLDocument](htmldocument/#constructor)() | Yeni bir örneğini başlatır.`HTMLDocument` sınıf. |
| [HTMLDocument](htmldocument/#constructor_1)(Configuration) | Yeni bir örneğini başlatır.`HTMLDocument` sınıf. |
| [HTMLDocument](htmldocument/#constructor_2)(RequestMessage) | Yeni bir örneğini başlatır.`HTMLDocument` sınıf. Yapıcı senkronize çalışır, tüm harici kaynakların (resimler, komut dosyaları vb.) yüklenmesini bekler. Belgeyi asenkron olarak yüklemek için yöntemi kullanın[`Navigate`](../../aspose.html.dom/document/navigate/) veya aşırı yüklemeleri. Veya uygun bayrakları ayarlayarak bazı harici kaynakların yüklenmesini devre dışı bırakabilirsiniz.[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_10)(string) | Yeni bir örneğini başlatır.`HTMLDocument` sınıf. Yapıcı senkronize çalışır, tüm harici kaynakların (resimler, komut dosyaları vb.) yüklenmesini bekler. Belgeyi asenkron olarak yüklemek için yöntemi kullanın[`Navigate`](../../aspose.html.dom/document/navigate/) veya aşırı yüklemeleri. Veya uygun bayrakları ayarlayarak bazı harici kaynakların yüklenmesini devre dışı bırakabilirsiniz.[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_4)(Url) | Yeni bir örneğini başlatır.`HTMLDocument` sınıf. Yapıcı senkronize çalışır, tüm harici kaynakların (resimler, komut dosyaları vb.) yüklenmesini bekler. Belgeyi asenkron olarak yüklemek için yöntemi kullanın[`Navigate`](../../aspose.html.dom/document/navigate/) veya aşırı yüklemeleri. Veya uygun bayrakları ayarlayarak bazı harici kaynakların yüklenmesini devre dışı bırakabilirsiniz.[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_3)(RequestMessage, Configuration) | Yeni bir örneğini başlatır.`HTMLDocument` sınıf. Yapıcı senkronize çalışır, tüm harici kaynakların (resimler, komut dosyaları vb.) yüklenmesini bekler. Belgeyi asenkron olarak yüklemek için yöntemi kullanın[`Navigate`](../../aspose.html.dom/document/navigate/) veya aşırı yüklemeleri. Veya uygun bayrakları ayarlayarak bazı harici kaynakların yüklenmesini devre dışı bırakabilirsiniz.[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_8)(Stream, string) | Yeni bir örneğini başlatır.`HTMLDocument` sınıf. Yapıcı senkronize çalışır, tüm harici kaynakların (resimler, komut dosyaları vb.) yüklenmesini bekler. Belgeyi asenkron olarak yüklemek için yöntemi kullanın[`Navigate`](../../aspose.html.dom/document/navigate/) veya aşırı yüklemeleri. Veya uygun bayrakları ayarlayarak bazı harici kaynakların yüklenmesini devre dışı bırakabilirsiniz.[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . Belge yükleme, akıştaki geçerli konumdan başlar. |
| [HTMLDocument](htmldocument/#constructor_6)(Stream, Url) | Yeni bir örneğini başlatır.`HTMLDocument` sınıf. Yapıcı senkronize çalışır, tüm harici kaynakların (resimler, komut dosyaları vb.) yüklenmesini bekler. Belgeyi asenkron olarak yüklemek için yöntemi kullanın[`Navigate`](../../aspose.html.dom/document/navigate/) veya aşırı yüklemeleri. Veya uygun bayrakları ayarlayarak bazı harici kaynakların yüklenmesini devre dışı bırakabilirsiniz.[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . Belge yükleme, akıştaki geçerli konumdan başlar. |
| [HTMLDocument](htmldocument/#constructor_11)(string, Configuration) | Yeni bir örneğini başlatır.`HTMLDocument` sınıf. Yapıcı senkronize çalışır, tüm harici kaynakların (resimler, komut dosyaları vb.) yüklenmesini bekler. Belgeyi asenkron olarak yüklemek için yöntemi kullanın[`Navigate`](../../aspose.html.dom/document/navigate/) veya aşırı yüklemeleri. Veya uygun bayrakları ayarlayarak bazı harici kaynakların yüklenmesini devre dışı bırakabilirsiniz.[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_14)(string, string) | Yeni bir örneğini başlatır.`HTMLDocument` sınıf. Yapıcı senkronize çalışır, tüm harici kaynakların (resimler, komut dosyaları vb.) yüklenmesini bekler. Belgeyi asenkron olarak yüklemek için yöntemi kullanın[`Navigate`](../../aspose.html.dom/document/navigate/) veya aşırı yüklemeleri. Veya uygun bayrakları ayarlayarak bazı harici kaynakların yüklenmesini devre dışı bırakabilirsiniz.[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_12)(string, Url) | Yeni bir örneğini başlatır.`HTMLDocument` sınıf. Yapıcı senkronize çalışır, tüm harici kaynakların (resimler, komut dosyaları vb.) yüklenmesini bekler. Belgeyi asenkron olarak yüklemek için yöntemi kullanın[`Navigate`](../../aspose.html.dom/document/navigate/) veya aşırı yüklemeleri. Veya uygun bayrakları ayarlayarak bazı harici kaynakların yüklenmesini devre dışı bırakabilirsiniz.[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_5)(Url, Configuration) | Yeni bir örneğini başlatır.`HTMLDocument` sınıf. Yapıcı senkronize çalışır, tüm harici kaynakların (resimler, komut dosyaları vb.) yüklenmesini bekler. Belgeyi asenkron olarak yüklemek için yöntemi kullanın[`Navigate`](../../aspose.html.dom/document/navigate/) veya aşırı yüklemeleri. Veya uygun bayrakları ayarlayarak bazı harici kaynakların yüklenmesini devre dışı bırakabilirsiniz.[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
| [HTMLDocument](htmldocument/#constructor_9)(Stream, string, Configuration) | Yeni bir örneğini başlatır.`HTMLDocument` sınıf. Yapıcı senkronize çalışır, tüm harici kaynakların (resimler, komut dosyaları vb.) yüklenmesini bekler. Belgeyi asenkron olarak yüklemek için yöntemi kullanın[`Navigate`](../../aspose.html.dom/document/navigate/) veya aşırı yüklemeleri. Veya uygun bayrakları ayarlayarak bazı harici kaynakların yüklenmesini devre dışı bırakabilirsiniz.[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . Belge yükleme, akıştaki geçerli konumdan başlar. |
| [HTMLDocument](htmldocument/#constructor_7)(Stream, Url, Configuration) | Yeni bir örneğini başlatır.`HTMLDocument` sınıf. Yapıcı senkronize çalışır, tüm harici kaynakların (resimler, komut dosyaları vb.) yüklenmesini bekler. Belgeyi asenkron olarak yüklemek için yöntemi kullanın[`Navigate`](../../aspose.html.dom/document/navigate/) veya aşırı yüklemeleri. Veya uygun bayrakları ayarlayarak bazı harici kaynakların yüklenmesini devre dışı bırakabilirsiniz.[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . Belge yükleme, akıştaki geçerli konumdan başlar. |
| [HTMLDocument](htmldocument/#constructor_15)(string, string, Configuration) | Yeni bir örneğini başlatır.`HTMLDocument` sınıf. Yapıcı senkronize çalışır, tüm harici kaynakların (resimler, komut dosyaları vb.) yüklenmesini bekler. Belgeyi asenkron olarak yüklemek için yöntemi kullanın[`Navigate`](../../aspose.html.dom/document/navigate/) veya aşırı yüklemeleri. Veya uygun bayrakları ayarlayarak bazı harici kaynakların yüklenmesini devre dışı bırakabilirsiniz.[`Security`](../../aspose.html.dom/ibrowsingcontext/security/) . |
...
| İsim | Tanım |
| --- | --- |
| [Anchors](../../aspose.html/htmldocument/anchors/) { get; } | Tüm bağlantılardan oluşan bir koleksiyon (`A` ) bir değere sahip bir belgesindeki öğeler`isim`bağlanmak. geriye dönük uyumluluk nedenleriyle, döndürülen bağlantı kümesi yalnızca ile oluşturulan bağlantı noktalarını içerir.`isim` öznitelik, ile oluşturulanlar değil`İD` bağlanmak. [[XHTML 1.0](http://www.w3.org/TR/2002/REC-xhtml1-20020801) ], `isim` özniteliğin (bkz. bölüm 4.10) anlamı yoktur ve yalnızca eski kullanıcı aracıları için mevcuttur:`İD` bunun yerine özniteliği kullanılır. Kullanıcılar, [ tarafından sağlanan yineleyici mekanizmalarını tercih etmelidir.[DOM Düzey 2 Geçişi](http://www.w3.org/TR/2000/REC-DOM-Level-2-Traversal-Range-20001113) ] yerine. |
| [Applets](../../aspose.html/htmldocument/applets/) { get; } | Hepsinin bir koleksiyonu`NESNE` uygulamacıklarını içeren öğeler ve`UYGULAMA` (kullanımdan kaldırıldı) bir belgedeki öğeler. |
...
| [Body](../../aspose.html/htmldocument/body/) { get; set; } | Belge içeriğini içeren öğe. belgelerinde`VÜCUT` içindekiler, döndürür`VÜCUT` öğesi. Çerçeve kümesi belgelerinde bu, en dıştaki değerini döndürür`ÇERÇEVE SETİ` eleman. |
...
| [Domain](../../aspose.html/htmldocument/domain/) { get; } | Belgeyi sunan sunucunun alan adı veya `hükümsüz` sunucu bir etki alanı adıyla tanımlanamıyorsa. |
...
| [Forms](../../aspose.html/htmldocument/forms/) { get; } | Bir belgenin tüm biçimlerinin bir koleksiyonu. |
| [Images](../../aspose.html/htmldocument/images/) { get; } | Hepsinin bir koleksiyonu`IMG` bir belgedeki öğeler. davranışı şunlarla sınırlıdır:`IMG` geriye dönük uyumluluğu için öğeler. tarafından önerildiği gibi [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224)], görüntüleri dahil etmek için yazarlar kullanabilir`NESNE` eleman veya`IMG` eleman. Bu nedenle, belgedeki resimlerini bulmak için bu özniteliği kullanmamanız önerilir.`getElementsByTagName` HTML 4.01 ile veya`getElementsByTagNameNS` XHTML 1.0. ile |
...
| [Links](../../aspose.html/htmldocument/links/) { get; } | Hepsinin bir koleksiyonu`ALAN` öğeler ve bağlantı ( `A` ) için bir değere sahip bir belgedeki öğeler`href` bağlanmak. |
...
| [Referrer](../../aspose.html/htmldocument/referrer/) { get; } | URI'yi döndürür [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) bu sayfaya bağlanan sayfanın. Kullanıcı doğrudan sayfaya gittiyse değer boş bir dizedir (bir bağlantı aracılığıyla değil, örneğin bir yer imi aracılığıyla). |
...
| [Title](../../aspose.html/htmldocument/title/) { get; set; } | tarafından belirtildiği şekliyle bir belgenin başlığı`BAŞLIK` belgenin başındaki öğesi. |
...
| [GetOverrideStyle](../../aspose.html/htmldocument/getoverridestyle/)(Element, string) | Bu yöntem, belirtilen bir öğe ve belirtilen sözde öğe için geçersiz kılma stili bildirimini almak için kullanılır. |
...
| override [RenderTo](../../aspose.html/htmldocument/renderto/)(IDevice) | Bu yöntem, geçerli belgenin içeriğini belirtilen aygıta yazdırmak için kullanılır. |
...
| [Save](../../aspose.html/htmldocument/save/#save)(IOutputStorage) | Belge içeriğini ve kaynakları çıktı deposuna kaydeder. |
| [Save](../../aspose.html/htmldocument/save/#save_10)(string) | Belgeyi tarafından belirtilen yerel dosyaya kaydeder.`yol` Bu belgede kullanılan tüm kaynaklar, adı şu şekilde yapılandırılacak olan bitişik klasöre dosyasına kaydedilecektir: output_file_name + "_files". |
| [Save](../../aspose.html/htmldocument/save/#save_5)(Url) | Belgeyi tarafından belirtilen yerel dosyaya kaydeder.`url` Bu belgede kullanılan tüm kaynaklar, adı şu şekilde yapılandırılacak olan bitişik klasöre dosyasına kaydedilecektir: output_file_name + "_files". |
| [Save](../../aspose.html/htmldocument/save/#save_1)(IOutputStorage, HTMLSaveFormat) | Belge içeriğini ve kaynakları çıktı deposuna kaydeder. |
| [Save](../../aspose.html/htmldocument/save/#save_2)(IOutputStorage, HTMLSaveOptions) | Belge içeriğini ve kaynakları çıktı deposuna kaydeder. |
| [Save](../../aspose.html/htmldocument/save/#save_3)(IOutputStorage, MarkdownSaveOptions) | Belge içeriğini ve kaynakları çıktı deposuna kaydeder. |
| [Save](../../aspose.html/htmldocument/save/#save_4)(IOutputStorage, MHTMLSaveOptions) | Belge içeriğini ve kaynakları çıktı deposuna kaydeder. |
| [Save](../../aspose.html/htmldocument/save/#save_11)(string, HTMLSaveFormat) | Belgeyi tarafından belirtilen yerel dosyaya kaydeder.`yol` Bu belgede kullanılan tüm kaynaklar, adı şu şekilde yapılandırılacak olan bitişik klasöre dosyasına kaydedilecektir: output_file_name + "_files". |
| [Save](../../aspose.html/htmldocument/save/#save_12)(string, HTMLSaveOptions) | Belgeyi tarafından belirtilen yerel dosyaya kaydeder.`yol` Bu belgede kullanılan tüm kaynaklar, adı şu şekilde yapılandırılacak olan bitişik klasöre dosyasına kaydedilecektir: output_file_name + "_files". |
| [Save](../../aspose.html/htmldocument/save/#save_13)(string, MarkdownSaveOptions) | Belgeyi tarafından belirtilen yerel dosyaya kaydeder.`yol` Bu belgede kullanılan tüm kaynaklar, adı şu şekilde yapılandırılacak olan bitişik klasöre dosyasına kaydedilecektir: output_file_name + "_files". |
| [Save](../../aspose.html/htmldocument/save/#save_14)(string, MHTMLSaveOptions) | Belgeyi tarafından belirtilen yerel dosyaya kaydeder.`yol` Bu belgede kullanılan tüm kaynaklar, adı şu şekilde yapılandırılacak olan bitişik klasöre dosyasına kaydedilecektir: output_file_name + "_files". |
| [Save](../../aspose.html/htmldocument/save/#save_6)(Url, HTMLSaveFormat) | Belgeyi tarafından belirtilen yerel dosyaya kaydeder.`url` Bu belgede kullanılan tüm kaynaklar, adı şu şekilde yapılandırılacak olan bitişik klasöre dosyasına kaydedilecektir: output_file_name + "_files". |
| [Save](../../aspose.html/htmldocument/save/#save_7)(Url, HTMLSaveOptions) | Belgeyi tarafından belirtilen yerel dosyaya kaydeder.`url` Bu belgede kullanılan tüm kaynaklar, adı şu şekilde yapılandırılacak olan bitişik klasöre dosyasına kaydedilecektir: output_file_name + "_files". |
| [Save](../../aspose.html/htmldocument/save/#save_8)(Url, MarkdownSaveOptions) | Belgeyi tarafından belirtilen yerel dosyaya kaydeder.`url` Bu belgede kullanılan tüm kaynaklar, adı şu şekilde yapılandırılacak olan bitişik klasöre dosyasına kaydedilecektir: output_file_name + "_files". |
| [Save](../../aspose.html/htmldocument/save/#save_9)(Url, MHTMLSaveOptions) | Belgeyi tarafından belirtilen yerel dosyaya kaydeder.`url` Bu belgede kullanılan tüm kaynaklar, adı şu şekilde yapılandırılacak olan bitişik klasöre dosyasına kaydedilecektir: output_file_name + "_files". |
