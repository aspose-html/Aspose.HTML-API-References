...
description: Aspose.Html.HTMLLabelElement sınıf. Form alanı etiket metni. HTML 4.01. deki LABEL öğe tanımına bakın
type: docs
weight: 3350
url: /tr/net/aspose.html/htmllabelelement/
---
## HTMLLabelElement class

Form alanı etiket metni. HTML 4.01. 'deki LABEL öğe tanımına bakın
...
| İsim | Tanım |
| --- | --- |
| [AccessKey](../../aspose.html/htmllabelelement/accesskey/) { get; set; } | Form denetimine erişim sağlamak için tek karakterli bir erişim anahtarı. HTML 4.01. 'deki erişim anahtarı öznitelik tanımına bakın |
...
| [For](../../aspose.html/htmllabelelement/for/) { get; set; } | Bu özellik, bu etiketi tarafından sağlanan başka bir form kontrolüne bağlar.`İD`bağlanmak. HTML'deki öznitelik tanımına bakın 4.01. |
| [Form](../../aspose.html/htmllabelelement/form/) { get; } | şunu döndürür:`BİÇİM` bu denetimi içeren öğe. döndürür`hükümsüz` bu kontrol bir formu bağlamında değilse. |
