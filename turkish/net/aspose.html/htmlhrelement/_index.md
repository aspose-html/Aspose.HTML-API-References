...
description: Aspose.Html.HTMLHRElement sınıf. Yatay bir kural oluşturun. HTML 4.01. deki HR öğesi tanımına bakın
type: docs
weight: 3260
url: /tr/net/aspose.html/htmlhrelement/
---
## HTMLHRElement class

Yatay bir kural oluşturun. HTML 4.01. 'deki HR öğesi tanımına bakın
...
| İsim | Tanım |
| --- | --- |
| [Align](../../aspose.html/htmlhrelement/align/) { get; set; } | Sayfadaki kuralı hizalayın. HTML 4.01'deki hizalama özelliği tanımına bakın. Bu özellik HTML 4.01. 'de kullanımdan kaldırılmıştır |
...
| [NoShade](../../aspose.html/htmlhrelement/noshade/) { get; set; } | Kullanıcı aracısına, bu öğenin sunumunda gölgeleme olmaması gerektiğini belirtir. HTML 4.01'deki noshade öznitelik tanımına bakın. Bu özellik HTML 4.01. 'de kullanımdan kaldırılmıştır |
...
| [Size](../../aspose.html/htmlhrelement/size/) { get; set; } | Kuralın yüksekliği. HTML 4.01'deki boyut özelliği tanımına bakın. Bu özellik HTML 4.01. 'de kullanımdan kaldırılmıştır. |
...
| [Width](../../aspose.html/htmlhrelement/width/) { get; set; } | Kuralın genişliği. HTML 4.01'deki genişlik özelliği tanımına bakın. Bu özellik HTML 4.01. 'de kullanımdan kaldırılmıştır. |
