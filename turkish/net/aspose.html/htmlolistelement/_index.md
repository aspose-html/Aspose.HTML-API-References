...
description: Aspose.Html.HTMLOListElement sınıf. Sıralı liste. HTML 4.01. deki OL öğe tanımına bakın
type: docs
weight: 3430
url: /tr/net/aspose.html/htmlolistelement/
---
## HTMLOListElement class

Sıralı liste. HTML 4.01. 'deki OL öğe tanımına bakın
...
| [Compact](../../aspose.html/htmlolistelement/compact/) { get; set; } | Liste öğeleri arasındaki boşluğu azaltın. HTML 4.01'deki kompakt öznitelik tanımı 'ye bakın. Bu özellik HTML 4.01. 'de kullanımdan kaldırılmıştır |
...
| [Start](../../aspose.html/htmlolistelement/start/) { get; set; } | Başlangıç sıra numarası. HTML 4.01'deki başlangıç özelliği tanımına bakın. Bu özellik HTML 4.01. 'de kullanımdan kaldırılmıştır |
...
| [Type](../../aspose.html/htmlolistelement/type/) { get; set; } | Numaralandırma stili. HTML 4.01'deki tür özelliği tanımına bakın. Bu özelliği, HTML 4.01. 'de kullanımdan kaldırılmıştır. |
