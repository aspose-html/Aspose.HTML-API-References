...
description: Aspose.Html.HTMLHeadElement sınıf. Belge kafası bilgisi. HTML 4.01. deki HEAD öğe tanımına bakın
type: docs
weight: 3270
url: /tr/net/aspose.html/htmlheadelement/
---
## HTMLHeadElement class

Belge kafası bilgisi. HTML 4.01. 'deki HEAD öğe tanımına bakın
...
| [Profile](../../aspose.html/htmlheadelement/profile/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] bir meta veri profili belirleme. HTML 4.01. 'deki profil özniteliği tanımına bakın |
