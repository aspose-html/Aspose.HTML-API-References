...
description: Aspose.Html.HTMLAreaElement sınıf. İstemci tarafı görüntü eşleme alanı tanımı. HTML 4.01. deki ALAN öğesi tanımına bakın
type: docs
weight: 3080
url: /tr/net/aspose.html/htmlareaelement/
---
## HTMLAreaElement class

İstemci tarafı görüntü eşleme alanı tanımı. HTML 4.01. 'deki ALAN öğesi tanımına bakın
...
| İsim | Tanım |
| --- | --- |
| [AccessKey](../../aspose.html/htmlareaelement/accesskey/) { get; set; } | Form denetimine erişim sağlamak için tek karakterli bir erişim anahtarı. HTML 4.01. 'deki erişim anahtarı öznitelik tanımına bakın |
| [Alt](../../aspose.html/htmlareaelement/alt/) { get; set; } | Bu öğesinin normal içeriğini oluşturmayan kullanıcı aracıları için alternatif metin. HTML 4.01. 'deki alt nitelik tanımına bakın |
...
| [Coords](../../aspose.html/htmlareaelement/coords/) { get; set; } | Aktif bölge geometrisini tanımlayan virgülle ayrılmış uzunluk listesi. Ayrıca bkz.`şekil` Bölgenin şekli için. HTML 4.01. 'deki coords nitelik tanımına bakın |
...
| [Href](../../aspose.html/htmlareaelement/href/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] bağlı kaynağın. HTML 4.01. 'deki href özellik tanımına bakın |
...
| [NoHref](../../aspose.html/htmlareaelement/nohref/) { get; set; } | Bu alanın etkin olmadığını, yani ilişkili bir eylemi olmadığını belirtir. HTML 4.01. 'deki nohref özellik tanımına bakın |
...
| [RelList](../../aspose.html/htmlareaelement/rellist/) { get; } | "rel" özniteliğinin ayrıştırılmasından alınan belirteçleri içeren canlı bir DOMTokenList döndürür. |
...
| [Shape](../../aspose.html/htmlareaelement/shape/) { get; set; } | Etkin alanın şekli. Koordinatlar tarafından verilmiştir.`koordinatlar` . HTML 4.01. 'deki şekil özelliği tanımına bakın |
...
| [TabIndex](../../aspose.html/htmlareaelement/tabindex/) { get; set; } | Öğenin sekme sırasındaki konumunu temsil eden dizin. HTML 4.01. 'deki tabindex öznitelik tanımına bakın |
| [TagName](../../aspose.html.dom/element/tagname/) { get; } | Öğenin adı. |
| [Target](../../aspose.html/htmlareaelement/target/) { get; set; } | Kaynağı işlemek için çerçeve. HTML 4.01. 'deki hedef öznitelik tanımına bakın |
