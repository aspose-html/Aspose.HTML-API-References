...
description: Aspose.Html.HTMLTableElement sınıf. Tablodaki oluşturma ve silme yöntemleri yazarların tabloları oluşturmasına ve değiştirmesine olanak tanır. HTML 4.01  her bir öğesinden yalnızca birininALTYAZI TEAD  VeTAYAK öğeleri bir tabloda bulunabilir. Bu nedenle varsa ve createTHead veya createTFoot yöntemi çağrılırsa yöntem mevcut THead veya TFoot öğesini döndürür. HTML 4.01. deki TABLE öğe tanımına bakın
type: docs
weight: 3570
url: /tr/net/aspose.html/htmltableelement/
---
## HTMLTableElement class

Tablodaki oluşturma* ve silme* yöntemleri, yazarların tabloları oluşturmasına ve değiştirmesine olanak tanır. [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224) ], her bir öğesinden yalnızca birinin`ALTYAZI` ,`TEAD` , Ve`TAYAK` öğeleri bir tabloda bulunabilir. Bu nedenle, varsa ve createTHead() veya createTFoot() yöntemi çağrılırsa, yöntem mevcut THead veya TFoot öğesini döndürür. HTML 4.01. 'deki TABLE öğe tanımına bakın
...
| İsim | Tanım |
| --- | --- |
| [Align](../../aspose.html/htmltableelement/align/) { get; set; } | belgesinin geri kalanına göre tablonun konumunu belirtir. HTML 4.01'deki hizalama özniteliği tanımına bakın. Bu özelliği, HTML 4.01. 'de kullanımdan kaldırılmıştır. |
...
| [BgColor](../../aspose.html/htmltableelement/bgcolor/) { get; set; } | Hücre arka plan rengi. HTML 4.01'deki bgcolor nitelik tanımına bakın. Bu özellik HTML 4.01. 'de kullanımdan kaldırılmıştır |
| [Border](../../aspose.html/htmltableelement/border/) { get; set; } | Tablonun etrafındaki kenarlığın genişliği. HTML 4.01. 'deki kenarlık özniteliği tanımına bakın |
| [Caption](../../aspose.html/htmltableelement/caption/) { get; } | Tablonun`ALTYAZI` veya hiçbiri yoksa geçersizdir. @versiyon DOM Seviyesi 2 |
| [CellPadding](../../aspose.html/htmltableelement/cellpadding/) { get; set; } | Hücre içeriği ile hücre sınırları arasındaki yatay ve dikey boşluğu belirtir. HTML 4.01. 'deki cellpadding öznitelik tanımına bakın |
| [CellSpacing](../../aspose.html/htmltableelement/cellspacing/) { get; set; } | Hücreler arasındaki yatay ve dikey ayrımı belirtir. HTML 4.01. 'deki cellpacing öznitelik tanımına bakın |
...
| [Frame](../../aspose.html/htmltableelement/frame/) { get; set; } | Hangi harici tablo kenarlıklarının oluşturulacağını belirtir. HTML 4.01. 'deki çerçeve nitelik tanımına bakın |
...
| [Rows](../../aspose.html/htmltableelement/rows/) { get; } | Tablonun`TAYAK` , veya`hükümsüz` hiçbiri yoksa. |
| [Rules](../../aspose.html/htmltableelement/rules/) { get; set; } | Hangi dahili tablo kenarlıklarının oluşturulacağını belirtir. HTML 4.01. 'deki öznitelik tanımı kurallarına bakın |
...
| [Summary](../../aspose.html/htmltableelement/summary/) { get; set; } | Bir tablonun amacı veya yapısı hakkında açıklama. HTML 4.01. 'deki özet nitelik tanımına bakın |
| [TagName](../../aspose.html.dom/element/tagname/) { get; } | Öğenin adı. |
| [TBodies](../../aspose.html/htmltableelement/tbodies/) { get; } | Tablo gövdelerinin bir koleksiyonunu döndürür (örtülü olanlar dahil). |
...
| [TFoot](../../aspose.html/htmltableelement/tfoot/) { get; } | Tablonun`TEAD` , veya`hükümsüz` hiçbiri yoksa. |
| [THead](../../aspose.html/htmltableelement/thead/) { get; } | Tablonun`ALTYAZI` veya hiçbiri yoksa geçersizdir. |
| [Title](../../aspose.html/htmlelement/title/) { get; set; } | Öğenin danışma başlığı. HTML 4.01. 'deki başlık özelliği tanımına bakın |
| [Width](../../aspose.html/htmltableelement/width/) { get; set; } | İstenen tablo genişliğini belirtir. HTML 4.01. 'deki genişlik özelliği tanımına bakın |
...
| [CreateCaption](../../aspose.html/htmltableelement/createcaption/)() | Yeni bir tablo başlığı nesnesi oluşturun veya mevcut olanı döndürün. |
| [CreateTFoot](../../aspose.html/htmltableelement/createtfoot/)() | Bir tablo alt bilgi satırı oluşturun veya mevcut olanı döndürün. |
| [CreateTHead](../../aspose.html/htmltableelement/createthead/)() | Bir tablo başlık satırı oluşturun veya mevcut olanı döndürün. |
| [DeleteCaption](../../aspose.html/htmltableelement/deletecaption/)() | Varsa tablo başlığını silin. |
| [DeleteRow](../../aspose.html/htmltableelement/deleterow/)(int) | Bir tablo satırını silin. |
| [DeleteTFoot](../../aspose.html/htmltableelement/deletetfoot/)() | Varsa tablodan altbilgiyi silin. |
| [DeleteTHead](../../aspose.html/htmltableelement/deletethead/)() | Varsa tablodan başlığı silin. |
