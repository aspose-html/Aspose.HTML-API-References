...
description: Aspose.Html.HTMLTableRowElement sınıf. Tablodaki bir satır. HTML 4.01. deki TR öğesi tanımına bakın
type: docs
weight: 3580
url: /tr/net/aspose.html/htmltablerowelement/
---
## HTMLTableRowElement class

Tablodaki bir satır. HTML 4.01. 'deki TR öğesi tanımına bakın
...
| İsim | Tanım |
| --- | --- |
| [Align](../../aspose.html/htmltablerowelement/align/) { get; set; } | Bu satırın hücreleri içindeki verilerin yatay hizalaması. HTML 4.01. 'deki hizalama öznitelik tanımına bakın |
...
| [BgColor](../../aspose.html/htmltablerowelement/bgcolor/) { get; set; } | Satırlar için arka plan rengi. HTML 4.01'deki bgcolor nitelik tanımına bakın. Bu özellik HTML 4.01. 'de kullanımdan kaldırılmıştır |
| [Cells](../../aspose.html/htmltablerowelement/cells/) { get; } | Bu satırdaki hücrelerin koleksiyonu. @versiyon DOM Seviyesi 2 |
| [Ch](../../aspose.html/htmltablerowelement/ch/) { get; set; } | Bir sütundaki hücreler için hizalama karakteri. HTML 4.01. 'deki char özniteliği tanımına bakın |
...
| [ChOff](../../aspose.html/htmltablerowelement/choff/) { get; set; } | Hizalama karakterinin ofseti. HTML 4.01. 'deki karakter özelliği tanımına bakın |
...
| [RowIndex](../../aspose.html/htmltablerowelement/rowindex/) { get; } | Bu, mantıksal sıradadır ve belge sırasında değildir. `satır dizini` bölümleri dikkate alır ( `TEAD` ,`TAYAK` , veya`TBODY` ) içinde tablo, yerleştirme`TEAD` dizinde ilk satırlar, ardından`TBODY` sıralar, ardından`TAYAK` rows. @version DOM Seviye 2 |
| [SchemaTypeInfo](../../aspose.html.dom/element/schematypeinfo/) { get; } | Bu öğeyle ilişkili tür bilgisi. |
| [SectionRowIndex](../../aspose.html/htmltablerowelement/sectionrowindex/) { get; } | Geçerli bölüme göre bu satırın dizini ( `TEAD` ,`TAYAK` , veya`TBODY` ), 0. 'den başlayarak @version DOM Düzey 2 |
...
| [VAlign](../../aspose.html/htmltablerowelement/valign/) { get; set; } | Bu satırın hücreleri içindeki verilerin dikey hizalanması. HTML 4.01. 'deki valign nitelik tanımına bakın |
...
| [DeleteCell](../../aspose.html/htmltablerowelement/deletecell/)(int) | Geçerli satırdan bir hücreyi silin. |
...
| [InsertCell](../../aspose.html/htmltablerowelement/insertcell/)(int) | Boş girin`TD` hücreyi bu satıra ise`dizin` -1 veya hücre sayısına eşitse, yeni hücresi eklenir. |
