...
description: Aspose.Html.HTMLBRElement sınıf. Satır sonunu zorla. HTML 4.01. deki BR öğesi tanımına bakın
type: docs
weight: 3090
url: /tr/net/aspose.html/htmlbrelement/
---
## HTMLBRElement class

Satır sonunu zorla. HTML 4.01. 'deki BR öğesi tanımına bakın
...
| [Clear](../../aspose.html/htmlbrelement/clear/) { get; set; } | Kayan noktalar etrafındaki metin akışını kontrol edin. HTML 4.01'deki açık öznitelik tanımı 'ye bakın. Bu özellik HTML 4.01. 'de kullanımdan kaldırılmıştır |
