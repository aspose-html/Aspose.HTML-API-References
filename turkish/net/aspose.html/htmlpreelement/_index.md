...
description: Aspose.Html.HTMLPreElement sınıf. Önceden biçimlendirilmiş metin. HTML 4.01. deki PRE öğe tanımına bakın
type: docs
weight: 3490
url: /tr/net/aspose.html/htmlpreelement/
---
## HTMLPreElement class

Önceden biçimlendirilmiş metin. HTML 4.01. 'deki PRE öğe tanımına bakın
...
| [Width](../../aspose.html/htmlpreelement/width/) { get; set; } | İçerik için sabit genişlik. HTML 4.01'deki genişlik özelliği tanımına bakın. Bu özellik HTML 4.01. 'de kullanımdan kaldırılmıştır |
