...
description: Aspose.Html.HTMLDListElement sınıf. Tanım listesi. HTML 4.01. deki DL öğesi tanımına bakın
type: docs
weight: 3150
url: /tr/net/aspose.html/htmldlistelement/
---
## HTMLDListElement class

Tanım listesi. HTML 4.01. 'deki DL öğesi tanımına bakın
...
| [Compact](../../aspose.html/htmldlistelement/compact/) { get; set; } | Liste öğeleri arasındaki boşluğu azaltın. HTML 4.01'deki kompakt öznitelik tanımı 'ye bakın. Bu özellik HTML 4.01. 'de kullanımdan kaldırılmıştır |
