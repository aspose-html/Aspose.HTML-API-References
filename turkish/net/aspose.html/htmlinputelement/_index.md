...
description: Aspose.Html.HTMLInputElement sınıf. Form kontrolü.Sayfanın görüntülendiği ortama bağlı olarak değer özelliği dosya yükleme girişi türü için salt okunur olabilir. Parola giriş türü için yetkisiz kullanımı önlemek için döndürülen gerçek değer maskelenebilir. deki INPUT öğesi tanımına bakın.HTML 4.01 .
type: docs
weight: 3320
url: /tr/net/aspose.html/htmlinputelement/
---
## HTMLInputElement class

Form kontrolü.Sayfanın görüntülendiği ortama bağlı olarak, değer özelliği dosya yükleme girişi türü için salt okunur olabilir. "Parola" giriş türü için, yetkisiz kullanımı önlemek için döndürülen gerçek değer maskelenebilir. ['deki INPUT öğesi tanımına bakın.[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224) ].
...
| İsim | Tanım |
| --- | --- |
| [Accept](../../aspose.html/htmlinputelement/accept/) { get; set; } | Bu formunu işleyen bir sunucunun doğru şekilde işleyeceği içerik türlerinin virgülle ayrılmış listesi. HTML 4.01. 'deki kabul öznitelik tanımına bakın |
| [AccessKey](../../aspose.html/htmlinputelement/accesskey/) { get; set; } | Form denetimine erişim sağlamak için tek karakterli bir erişim anahtarı. HTML 4.01. 'deki erişim anahtarı öznitelik tanımına bakın |
| [Align](../../aspose.html/htmlinputelement/align/) { get; set; } | Bu nesneyi (dikey veya yatay olarak) çevreleyen metnine göre hizalar. HTML 4.01'deki hizalama özniteliği tanımına bakın. Bu özellik HTML 4.01. 'de kullanımdan kaldırılmıştır. |
| [Alt](../../aspose.html/htmlinputelement/alt/) { get; set; } | Bu öğesinin normal içeriğini oluşturmayan kullanıcı aracıları için alternatif metin. HTML 4.01. 'deki alt nitelik tanımına bakın |
...
| [Checked](../../aspose.html/htmlinputelement/checked/) { get; set; } | ne zaman`tip`öğenin özniteliği "radyo" veya "onay kutusu" değerine sahiptir, bu, etkileşimli bir kullanıcı aracısında denetimi formunun mevcut durumunu temsil eder. Bu öznitelik üzerinde yapılan değişiklikler, form kontrolünün durumunu değiştirir, ancak INPUT öğesinin HTML tarafından kontrol edilen özniteliği olan değerini değiştirmez. "radyo" veya "onay kutusu" değeri, bazı uygulamalar, olay belgesinde gönderilmeden önce bu özelliğin değerini değiştirebilir. Olayın varsayılan eylemi iptal edilirse, özelliğin değeri orijinal değerine geri döndürülebilir. Bu, , tıklama olaylarının işlenmesi sırasında bu özelliğin değerinin uygulamaya bağlı olduğu anlamına gelir. |
...
| [DefaultChecked](../../aspose.html/htmlinputelement/defaultchecked/) { get; set; } | Ne zaman`tip` "radyo" veya "onay kutusu" değerine sahipse, bu , öğenin HTML tarafından kontrol edilen özniteliğini temsil eder. Etkileşimli bir kullanıcı aracısında karşılık gelen denetim formunun durumu değişirse, bu özniteliğin değeri değişmez. HTML 4.01. 'de kontrol edilen özellik tanımına bakın |
| [DefaultValue](../../aspose.html/htmlinputelement/defaultvalue/) { get; set; } | ne zaman`tip`öğenin özniteliği "text", "file" veya "password" değerine sahiptir, bu, öğenin HTML değeri özniteliğini temsil eder. Etkileşimli bir kullanıcı aracısında karşılık gelen form kontrolünün içeriği değişirse, bu özniteliğin değeri değişmez. HTML 4.01. 'deki değer özelliği tanımına bakın |
...
| [Disabled](../../aspose.html/htmlinputelement/disabled/) { get; set; } | Kontrol bu bağlamda kullanılamaz. HTML 4.01. 'de devre dışı bırakılan öznitelik tanımına bakın |
| [Files](../../aspose.html/htmlinputelement/files/) { get; } | files IDL özniteliği, betiklerin öğenin seçili dosyalarına erişmesine izin verir. Alırken, IDL özniteliği geçerliyse, geçerli seçili dosyaları temsil eden bir FileList nesnesi döndürmesi gerekir. Seçilen dosyaların listesi değişene kadar aynı nesne döndürülmelidir. IDL özniteliği geçerli değilse, bunun yerine boş değer döndürmesi gerekir. [FILEAPI] |
...
| [Form](../../aspose.html/htmlinputelement/form/) { get; set; } | şunu döndürür:`BİÇİM` bu denetimi içeren öğe. döndürür`hükümsüz` bu kontrol bir formu bağlamında değilse. |
...
| [List](../../aspose.html/htmlinputelement/list/) { get; set; } | list özniteliği, kullanıcıya önerilen önceden tanımlanmış seçenekleri listeleyen bir öğeyi tanımlamak için kullanılır. Varsa, değeri, aynı belgedeki bir veri listesi öğesinin kimliği olmalıdır. |
...
| [MaxLength](../../aspose.html/htmlinputelement/maxlength/) { get; set; } | Metin alanları için maksimum karakter sayısı`tip` , "metin" veya "şifre" değerine sahiptir. HTML 4.01. 'deki maksimum uzunluk özniteliği tanımına bakın |
| [Name](../../aspose.html/htmlinputelement/name/) { get; set; } | Formla gönderildiğinde form kontrolü veya nesne adı. HTML 4.01. 'deki öznitelik tanımına bakın |
...
| [ReadOnly](../../aspose.html/htmlinputelement/readonly/) { get; set; } | Bu kontrol salt okunurdur. Yalnızca ne zaman alakalı`tip` değerine "metin" veya "şifre" sahiptir. HTML 4.01. 'deki salt okunur öznitelik tanımına bakın |
...
| [Size](../../aspose.html/htmlinputelement/size/) { get; set; } | Boyut bilgisi. Kesin anlam, her bir alanı türüne özeldir. HTML 4.01. @version DOM Level 2 içindeki boyut özelliği tanımına bakın |
| [Src](../../aspose.html/htmlinputelement/src/) { get; set; } | ne zaman`tip`özniteliği "görüntü" değerine sahiptir, bu özniteliği, grafik gönder düğmesini süslemek için kullanılacak görüntünün konumunu belirtir. HTML'deki src özelliği tanımına bakın 4.01. |
...
| [TabIndex](../../aspose.html/htmlinputelement/tabindex/) { get; set; } | Öğenin sekme sırasındaki konumunu temsil eden dizin. HTML 4.01. 'deki tabindex öznitelik tanımına bakın |
...
| [Type](../../aspose.html/htmlinputelement/type/) { get; set; } | Oluşturulan denetim türü (tümü küçük harf). HTML 4.01'deki tür özelliği tanımına bakın. @version DOM Seviyesi 2 |
| [UseMap](../../aspose.html/htmlinputelement/usemap/) { get; set; } | İstemci tarafı görüntü eşlemesini kullanın. HTML 4.01. 'deki kullanım haritası öznitelik tanımına bakın |
| [Value](../../aspose.html/htmlinputelement/value/) { get; set; } | ne zaman`tip` öğenin özniteliği "text", "file" veya "password" değerine sahiptir, bu, etkileşimli bir kullanıcı aracısında karşılık gelen form kontrolünün geçerli içeriğini temsil eder. Bu özniteliğin değiştirilmesi, form denetiminin içeriğini değiştirir, ancak , öğenin HTML değer özniteliğinin değerini değiştirmez. ne zaman`tip`öğenin özniteliği "button", "hidden", "submit", "reset", "image", "checkbox" veya "radio" değerine sahiptir, bu, öğenin HTML değer özniteliğini temsil eder. HTML 4.01. 'deki değer özelliği tanımına bakın |
