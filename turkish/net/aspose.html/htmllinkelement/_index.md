...
description: Aspose.Html.HTMLLinkElement sınıf. BAĞLANTIöğesi harici bir kaynağa giden bir bağlantıyı belirtir ve  bu belgenin bu kaynakla ilişkisini tanımlar veya tam tersi. HTML 4.01deki LINK öğesi tanımına bakın ayrıca bkz. bağlantı stili StyleSheet modülündeki arayüz DOM Düzey 2 Stil Sayfaları ve CSS .
type: docs
weight: 3370
url: /tr/net/aspose.html/htmllinkelement/
---
## HTMLLinkElement class

`BAĞLANTI`öğesi, harici bir kaynağa giden bir bağlantıyı belirtir ve , bu belgenin bu kaynakla ilişkisini tanımlar (veya tam tersi). HTML 4.01'deki LINK öğesi tanımına bakın (ayrıca bkz. `bağlantı stili` StyleSheet modülündeki arayüz [[DOM Düzey 2 Stil Sayfaları ve CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113) ]).
...
| [Charset](../../aspose.html/htmllinkelement/charset/) { get; set; } | Bağlanmakta olan kaynağın karakter kodlaması. HTML 4.01. 'deki karakter kümesi nitelik tanımına bakın |
...
| [Disabled](../../aspose.html/htmllinkelement/disabled/) { get; set; } | Bağlantıyı etkinleştirir/devre dışı bırakır. Bu, şu anda yalnızca stil sayfası bağlantıları için kullanılmaktadır ve stil sayfalarını etkinleştirmek veya devre dışı bırakmak için kullanılabilir. |
...
| [Href](../../aspose.html/htmllinkelement/href/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] bağlı kaynağın. HTML 4.01. 'deki href özellik tanımına bakın |
| [Hreflang](../../aspose.html/htmllinkelement/hreflang/) { get; set; } | Bağlantılı kaynağın dil kodu. HTML 4.01. 'deki hreflang özniteliği tanımına bakın |
...
| [Media](../../aspose.html/htmllinkelement/media/) { get; set; } | Bir veya daha fazla hedef ortamla kullanılmak üzere tasarlanmıştır. HTML 4.01. 'deki ortam özniteliği tanımına bakın |
...
| [Rel](../../aspose.html/htmllinkelement/rel/) { get; set; } | İleri bağlantı türü. HTML 4.01. 'deki rel özelliği tanımına bakın |
| [RelList](../../aspose.html/htmllinkelement/rellist/) { get; } | "rel" özniteliğinin ayrıştırılmasından alınan belirteçleri içeren canlı bir DOMTokenList döndürür. |
| [Rev](../../aspose.html/htmllinkelement/rev/) { get; set; } | Ters bağlantı türü. HTML 4.01. 'deki rev özelliği tanımına bakın |
...
| [Sheet](../../aspose.html/htmllinkelement/sheet/) { get; } | İlgili stil sayfasını alır. |
...
| [Target](../../aspose.html/htmllinkelement/target/) { get; set; } | Kaynağı işlemek için çerçeve. HTML 4.01. 'deki hedef öznitelik tanımına bakın |
...
| [Type](../../aspose.html/htmllinkelement/type/) { get; set; } | Danışma içerik türü. HTML 4.01. 'deki tür özelliği tanımına bakın |
