...
description: Aspose.Html.HTMLBodyElement sınıf. HTML belge gövdesi. Bu öğe etiketler kaynak belgede yoksa bile DOM APIsinde her zaman bulunur. HTML 4.01. deki BODY öğesi tanımına bakın
type: docs
weight: 3120
url: /tr/net/aspose.html/htmlbodyelement/
---
## HTMLBodyElement class

HTML belge gövdesi. Bu öğe, etiketler kaynak belgede yoksa, bile DOM API'sinde her zaman bulunur. HTML 4.01. 'deki BODY öğesi tanımına bakın
...
| İsim | Tanım |
| --- | --- |
| [ALink](../../aspose.html/htmlbodyelement/alink/) { get; set; } | Etkin bağlantıların rengi (fare düğmesi aşağıdan sonra, ancak yukarı fare düğmesinden önce). HTML 4.01'deki alink özelliği tanımına bakın. Bu özniteliği HTML 4.01. 'de kullanımdan kaldırılmıştır |
...
| [Background](../../aspose.html/htmlbodyelement/background/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] arka plan dokusu döşeme görüntüsünün. HTML 4.01'deki arka plan özniteliği tanımına bakın. Bu özellik HTML 4.01. 'de kullanımdan kaldırılmıştır |
...
| [BgColor](../../aspose.html/htmlbodyelement/bgcolor/) { get; set; } | Belge arka plan rengi. HTML 4.01'deki bgcolor nitelik tanımına bakın. Bu özellik HTML 4.01. 'de kullanımdan kaldırılmıştır |
...
| [Link](../../aspose.html/htmlbodyelement/link/) { get; set; } | Aktif olmayan ve ziyaret edilmemiş bağlantıların rengi. HTML 4.01'deki bağlantı nitelik tanımına bakın. Bu özellik HTML 4.01. 'de kullanımdan kaldırılmıştır |
...
| [Text](../../aspose.html/htmlbodyelement/text/) { get; set; } | Belge metin rengi. HTML 4.01'deki metin özelliği tanımına bakın. Bu özellik HTML 4.01. 'de kullanımdan kaldırılmıştır. |
...
| [VLink](../../aspose.html/htmlbodyelement/vlink/) { get; set; } | Kullanıcı tarafından ziyaret edilen bağlantıların rengi. HTML 4.01'deki vlink öznitelik tanımına bakın. Bu özellik HTML 4.01. 'de kullanımdan kaldırılmıştır |
