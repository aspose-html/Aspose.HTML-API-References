...
description: Aspose.Html.HTMLButtonElement sınıf. Düğmeye basın. HTML 4.01. deki BUTTON öğe tanımına bakın
type: docs
weight: 3130
url: /tr/net/aspose.html/htmlbuttonelement/
---
## HTMLButtonElement class

Düğmeye basın. HTML 4.01. 'deki BUTTON öğe tanımına bakın
...
| İsim | Tanım |
| --- | --- |
| [AccessKey](../../aspose.html/htmlbuttonelement/accesskey/) { get; set; } | Form denetimine erişim sağlamak için tek karakterli bir erişim anahtarı. HTML 4.01. 'deki erişim anahtarı öznitelik tanımına bakın |
...
| [Disabled](../../aspose.html/htmlbuttonelement/disabled/) { get; set; } | Kontrol bu bağlamda kullanılamaz. HTML 4.01. 'de devre dışı bırakılan öznitelik tanımına bakın |
...
| [Form](../../aspose.html/htmlbuttonelement/form/) { get; } | şunu döndürür:`BİÇİM` bu denetimi içeren öğe. döndürür`hükümsüz` bu kontrol bir formu bağlamında değilse. |
...
| [Name](../../aspose.html/htmlbuttonelement/name/) { get; set; } | Formla gönderildiğinde form kontrolü veya nesne adı. HTML 4.01. 'deki öznitelik tanımına bakın |
...
| [TabIndex](../../aspose.html/htmlbuttonelement/tabindex/) { get; set; } | Öğenin sekme sırasındaki konumunu temsil eden dizin. HTML 4.01. 'deki tabindex öznitelik tanımına bakın |
...
| [Type](../../aspose.html/htmlbuttonelement/type/) { get; set; } | Düğme türü (tümü küçük harf). HTML 4.01. 'deki tipi öznitelik tanımına bakın |
| [Value](../../aspose.html/htmlbuttonelement/value/) { get; set; } | Mevcut form kontrol değeri. HTML 4.01. 'deki değer özelliği tanımına bakın |
