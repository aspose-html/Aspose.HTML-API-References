...
description: Aspose.Html.HTMLOptionElement sınıf. Seçilebilir bir seçim. HTML 4.01. deki SEÇENEK öğe tanımına bakın
type: docs
weight: 3460
url: /tr/net/aspose.html/htmloptionelement/
---
## HTMLOptionElement class

Seçilebilir bir seçim. HTML 4.01. 'deki SEÇENEK öğe tanımına bakın
...
| [DefaultSelected](../../aspose.html/htmloptionelement/defaultselected/) { get; set; } | Seçilen HTML özniteliğinin değerini temsil eder. Bu özniteliğinin değeri, etkileşimli bir kullanıcı aracısında karşılık gelen denetimi formunun durumu değişirse değişmez. HTML 4.01. @version DOM Level 2 içindeki seçili öznitelik tanımına bakın |
...
| [Disabled](../../aspose.html/htmloptionelement/disabled/) { get; set; } | Kontrol bu bağlamda kullanılamaz. HTML 4.01. 'de devre dışı bırakılan öznitelik tanımına bakın |
...
| [Form](../../aspose.html/htmloptionelement/form/) { get; } | şunu döndürür:`BİÇİM` bu denetimi içeren öğe. döndürür`hükümsüz` bu kontrol bir formu bağlamında değilse. |
| [Id](../../aspose.html/htmlelement/id/) { get; set; } | Öğenin tanımlayıcısı. HTML 4.01. 'deki id niteliği tanımına bakın |
| [Index](../../aspose.html/htmloptionelement/index/) { get; } | Bunun dizini`SEÇENEK` ebeveyninde`SEÇME` , 0. 'den başlayarak @version DOM Düzey 2 |
...
| [Label](../../aspose.html/htmloptionelement/label/) { get; set; } | Hiyerarşik menülerde kullanım için seçenek etiketi. HTML 4.01. 'deki etiket özelliği tanımına bakın |
...
| [Selected](../../aspose.html/htmloptionelement/selected/) { get; set; } | Etkileşimli bir kullanıcı aracısında karşılık gelen form kontrolünün mevcut durumunu temsil eder. Bu özniteliğin değiştirilmesi, form denetiminin durumunu değiştirir, ancak öğenin seçili HTML özniteliğinin değerini değiştirmez. |
...
| [Text](../../aspose.html/htmloptionelement/text/) { get; } | Seçenek öğesinin içerdiği metin. |
...
| [Value](../../aspose.html/htmloptionelement/value/) { get; set; } | Mevcut form kontrol değeri. HTML 4.01. 'deki değer özelliği tanımına bakın |
