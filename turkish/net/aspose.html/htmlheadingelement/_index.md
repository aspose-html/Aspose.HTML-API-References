...
description: Aspose.Html.HTMLHeadingElement sınıf. içinH1 ileH6 elementler. HTML 4.01. deki H1 element tanımına bakın
type: docs
weight: 3280
url: /tr/net/aspose.html/htmlheadingelement/
---
## HTMLHeadingElement class

için`H1` ile`H6` elementler. HTML 4.01. 'deki H1 element tanımına bakın
...
| İsim | Tanım |
| --- | --- |
| [Align](../../aspose.html/htmlheadingelement/align/) { get; set; } | Yatay metin hizalaması. HTML 4.01'deki hizalama özelliği tanımına bakın. Bu özellik HTML 4.01. 'de kullanımdan kaldırılmıştır |
