...
description: Aspose.Html.HTMLQuoteElement sınıf. içinQ VeBLOKQUOTEelementler. HTML 4.01. deki Q öğe tanımına bakın
type: docs
weight: 3500
url: /tr/net/aspose.html/htmlquoteelement/
---
## HTMLQuoteElement class

için`Q` Ve`BLOKQUOTE`elementler. HTML 4.01. 'deki Q öğe tanımına bakın
...
| [Cite](../../aspose.html/htmlquoteelement/cite/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] bir kaynak belge veya mesaj belirlemek. HTML 4.01. 'deki alıntı özniteliği tanımına bakın |
