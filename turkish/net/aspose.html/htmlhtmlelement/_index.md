...
description: Aspose.Html.HTMLHtmlElement sınıf. Bir HTML belgesinin kökü. HTML 4.01. deki HTML öğesi tanımına bakın
type: docs
weight: 3290
url: /tr/net/aspose.html/htmlhtmlelement/
---
## HTMLHtmlElement class

Bir HTML belgesinin kökü. HTML 4.01. 'deki HTML öğesi tanımına bakın
...
| [Version](../../aspose.html/htmlhtmlelement/version/) { get; set; } | Belgenin DTD'si hakkında sürüm bilgisi. HTML 4.01'deki sürüm özniteliği tanımına bakın. Bu özellik HTML 4.01. 'de kullanımdan kaldırılmıştır |
