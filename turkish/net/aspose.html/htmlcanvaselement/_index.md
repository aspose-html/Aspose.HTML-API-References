...
description: Aspose.Html.HTMLCanvasElement sınıf. HTMLCanvasElement arabirimi tuval öğelerinin düzenini ve sunumunu değiştirmek için özellikler ve yöntemler sağlar. HTMLCanvasElement arabirimi HTMLElement arabiriminin özelliklerini ve yöntemlerini de devralır.
type: docs
weight: 3140
url: /tr/net/aspose.html/htmlcanvaselement/
---
## HTMLCanvasElement class

HTMLCanvasElement arabirimi, tuval öğelerinin düzenini ve sunumunu değiştirmek için özellikler ve yöntemler sağlar. HTMLCanvasElement arabirimi, HTMLElement arabiriminin özelliklerini ve yöntemlerini de devralır.
...
| [Height](../../aspose.html/htmlcanvaselement/height/) { get; set; } | CSS piksellerinde yorumlanan tuval öğesinin yükseklik HTML özniteliğini yansıtan pozitif bir tam sayıdır. Öznitelik belirtilmediğinde veya negatif gibi geçersiz bir değere ayarlandığında, varsayılan değeri olan 150 kullanılır. |
...
| [Width](../../aspose.html/htmlcanvaselement/width/) { get; set; } | CSS piksellerinde yorumlanan tuval öğesinin genişlik HTML özelliğini yansıtan pozitif bir tam sayıdır. Öznitelik belirtilmediğinde veya negatif gibi geçersiz bir değere ayarlandığında, varsayılan değer olan 300 kullanılır. |
...
| [GetContext](../../aspose.html/htmlcanvaselement/getcontext/)(string) | Tuval üzerinde bir çizim bağlamı veya içerik kimliği desteklenmiyorsa boş değer döndürür. Çizim bağlamı, tuval üzerine çizim yapmanızı sağlar. |
...
| [ToDataURL](../../aspose.html/htmlcanvaselement/todataurl/#todataurl)() | , type parametresi tarafından belirtilen biçimde (varsayılanı PNG'dir) görüntünün temsilini içeren bir veri URI'si döndürür. Döndürülen görüntü 96 dpi çözünürlükte. |
| [ToDataURL](../../aspose.html/htmlcanvaselement/todataurl/#todataurl_1)(string) | , type parametresi tarafından belirtilen biçimde (varsayılanı PNG'dir) görüntünün temsilini içeren bir veri URI'si döndürür. Döndürülen görüntü 96 dpi çözünürlükte. |
| [ToDataURL](../../aspose.html/htmlcanvaselement/todataurl/#todataurl_2)(string, double) | , type parametresi tarafından belirtilen biçimde (varsayılanı PNG'dir) görüntünün temsilini içeren bir veri URI'si döndürür. Döndürülen görüntü 96 dpi çözünürlükte. |
