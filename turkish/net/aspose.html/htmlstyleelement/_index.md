...
description: Aspose.Html.HTMLStyleElement sınıf. Stil bilgisi. HTML 4.01deki STYLE öğesi tanımına bakın CSS modülü DOM Düzey 2 Stil Sayfaları ve CSS  vebağlantı stili StyleSheets modülündeki arayüz DOM Düzey 2 Stil Sayfaları ve CSS .
type: docs
weight: 3530
url: /tr/net/aspose.html/htmlstyleelement/
---
## HTMLStyleElement class

Stil bilgisi. HTML 4.01'deki STYLE öğesi tanımına bakın, CSS modülü [[DOM Düzey 2 Stil Sayfaları ve CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113) ] ve`bağlantı stili` StyleSheets modülündeki arayüz [[DOM Düzey 2 Stil Sayfaları ve CSS](http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113) ].
...
| [Disabled](../../aspose.html/htmlstyleelement/disabled/) { get; set; } | Stil sayfasını etkinleştirir/devre dışı bırakır. |
...
| [Media](../../aspose.html/htmlstyleelement/media/) { get; set; } | Bir veya daha fazla hedef ortamla kullanılmak üzere tasarlanmıştır. HTML 4.01. 'deki ortam özniteliği tanımına bakın |
...
| [Sheet](../../aspose.html/htmlstyleelement/sheet/) { get; } | İlgili stil sayfasını alır. |
...
| [Type](../../aspose.html/htmlstyleelement/type/) { get; set; } | Stil sayfası dilinin içerik türü. HTML 4.01. 'deki tür özniteliği tanımına bakın |
