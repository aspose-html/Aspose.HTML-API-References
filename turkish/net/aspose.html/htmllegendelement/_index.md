...
description: Aspose.Html.HTMLLegendElement sınıf. Şunun için bir başlık sağlarSAHA SETİ gruplama. HTML 4.01. deki LEGEND öğe tanımına bakın
type: docs
weight: 3360
url: /tr/net/aspose.html/htmllegendelement/
---
## HTMLLegendElement class

Şunun için bir başlık sağlar:`SAHA SETİ` gruplama. HTML 4.01. 'deki LEGEND öğe tanımına bakın
...
| İsim | Tanım |
| --- | --- |
| [AccessKey](../../aspose.html/htmllegendelement/accesskey/) { get; set; } | Form denetimine erişim sağlamak için tek karakterli bir erişim anahtarı. HTML 4.01. 'deki erişim anahtarı öznitelik tanımına bakın |
| [Align](../../aspose.html/htmllegendelement/align/) { get; set; } | Göreceli metin hizalaması`SAHA SETİ` . HTML 4.01'deki align nitelik tanımına bakın. Bu özellik HTML 4.01. 'de kullanımdan kaldırılmıştır |
...
| [Form](../../aspose.html/htmllegendelement/form/) { get; } | şunu döndürür:`BİÇİM` bu denetimi içeren öğe. döndürür`hükümsüz` bu kontrol bir formu bağlamında değilse. |
