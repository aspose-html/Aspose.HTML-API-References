...
description: Aspose.Html.HTMLModElement sınıf. Belgenin bir bölümünde değişiklik bildirimi. HTML 4.01deki INS ve DEL öğesi tanımlarına bakın.
type: docs
weight: 3410
url: /tr/net/aspose.html/htmlmodelement/
---
## HTMLModElement class

Belgenin bir bölümünde değişiklik bildirimi. HTML 4.01'deki INS ve DEL öğesi tanımlarına bakın.
...
| [Cite](../../aspose.html/htmlmodelement/cite/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] değişikliğin nedenini açıklayan bir belge belirlemek. HTML 4.01. 'deki alıntı niteliği tanımına bakın |
...
| [DateTime](../../aspose.html/htmlmodelement/datetime/) { get; set; } | Değişikliğin tarihi ve saati. HTML 4.01. 'deki tarih-zaman özelliği tanımına bakın |
