...
description: Aspose.Html.HTMLOptGroupElement sınıf. Seçenekleri mantıksal alt bölümlerde gruplandırın. HTML 4.01. deki OPTGROUP öğesi tanımına bakın
type: docs
weight: 3450
url: /tr/net/aspose.html/htmloptgroupelement/
---
## HTMLOptGroupElement class

Seçenekleri mantıksal alt bölümlerde gruplandırın. HTML 4.01. 'deki OPTGROUP öğesi tanımına bakın
...
| [Disabled](../../aspose.html/htmloptgroupelement/disabled/) { get; set; } | Kontrol bu bağlamda kullanılamaz. HTML 4.01. 'de devre dışı bırakılan öznitelik tanımına bakın |
...
| [Label](../../aspose.html/htmloptgroupelement/label/) { get; set; } | Bu seçenek grubuna bir etiket atar. HTML 4.01. 'deki tanımlama etiket özniteliğine bakın |
