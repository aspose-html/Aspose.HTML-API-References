...
description: Aspose.Html.HTMLParamElement sınıf. Şuraya beslenen parametrelerNESNE eleman. HTML 4.01. deki PARAM öğesi tanımına bakın
type: docs
weight: 3480
url: /tr/net/aspose.html/htmlparamelement/
---
## HTMLParamElement class

Şuraya beslenen parametreler:`NESNE` eleman. HTML 4.01. 'deki PARAM öğesi tanımına bakın
...
| [Name](../../aspose.html/htmlparamelement/name/) { get; set; } | Çalışma zamanı parametresinin adı. HTML 4.01. 'deki ad özelliği tanımına bakın |
...
| [Type](../../aspose.html/htmlparamelement/type/) { get; set; } | için içerik türü`değer` olduğunda öznitelik`değer türü` "ref" değerine sahiptir. HTML 4.01. 'deki tür özniteliği tanımına bakın |
| [Value](../../aspose.html/htmlparamelement/value/) { get; set; } | Çalışma zamanı parametresinin değeri. HTML 4.01. 'deki değer özelliği tanımına bakın |
| [ValueType](../../aspose.html/htmlparamelement/valuetype/) { get; set; } | anlamı hakkında bilgi`değer` öznitelik değeri. HTML 4.01. 'deki değer türü öznitelik tanımına bakın |
