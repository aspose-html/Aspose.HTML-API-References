...
description: Aspose.Html.HTMLAnchorElement sınıf. Bağlantı elemanı. HTML 4.01. deki A öğesi tanımına bakın
type: docs
weight: 3060
url: /tr/net/aspose.html/htmlanchorelement/
---
## HTMLAnchorElement class

Bağlantı elemanı. HTML 4.01. 'deki A öğesi tanımına bakın
...
| İsim | Tanım |
| --- | --- |
| [AccessKey](../../aspose.html/htmlanchorelement/accesskey/) { get; set; } | Form denetimine erişim sağlamak için tek karakterli bir erişim anahtarı. HTML 4.01. 'deki erişim anahtarı öznitelik tanımına bakın |
...
| [Charset](../../aspose.html/htmlanchorelement/charset/) { get; set; } | Bağlantılı kaynağın karakter kodlaması. HTML 4.01. 'deki karakter kümesi nitelik tanımına bakın |
...
| [Coords](../../aspose.html/htmlanchorelement/coords/) { get; set; } | Aktif bölge geometrisini tanımlayan virgülle ayrılmış uzunluk listesi. Ayrıca bkz.`şekil` Bölgenin şekli için. HTML 4.01. 'deki coords öznitelik tanımına bakın |
...
| [Hash](../../aspose.html/htmlanchorelement/hash/) { get; set; } | İlişkili URL'nin karma segmentinin dize gösterimini alır veya ayarlar. |
| [Host](../../aspose.html/htmlanchorelement/host/) { get; set; } | İlişkili URL'nin ana bilgisayar ve bağlantı noktası segmentlerinin dize temsilini alır veya ayarlar. |
| [Hostname](../../aspose.html/htmlanchorelement/hostname/) { get; set; } | İlişkili URL'nin ana bilgisayar segmentinin dize gösterimini alır veya ayarlar. |
| [Href](../../aspose.html/htmlanchorelement/href/) { get; set; } | Mutlak URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) bağlı kaynağın. HTML 4.01. 'deki href özniteliği tanımına bakın |
| [Hreflang](../../aspose.html/htmlanchorelement/hreflang/) { get; set; } | Bağlantılı kaynağın dil kodu. HTML 4.01. 'deki hreflang özniteliği tanımına bakın |
...
| [Name](../../aspose.html/htmlanchorelement/name/) { get; set; } | Çapa adı. HTML 4.01. 'deki ad özelliği tanımına bakın |
...
| [Origin](../../aspose.html/htmlanchorelement/origin/) { get; } | İlişkili URL'nin kaynak bölümünün dize gösterimini alır. |
...
| [Password](../../aspose.html/htmlanchorelement/password/) { get; set; } | İlişkili URL'nin parola bölümünün dize gösterimini alır veya ayarlar. |
| [Pathname](../../aspose.html/htmlanchorelement/pathname/) { get; set; } | İlişkili URL'nin yol bölümünün dize gösterimini alır veya ayarlar. |
| [Port](../../aspose.html/htmlanchorelement/port/) { get; set; } | İlişkili URL'nin bağlantı noktası segmentinin dize gösterimini alır veya ayarlar. |
...
| [Protocol](../../aspose.html/htmlanchorelement/protocol/) { get; set; } | İlişkili URL'nin şema segmentinin dize gösterimini alır veya ayarlar. |
| [Rel](../../aspose.html/htmlanchorelement/rel/) { get; set; } | İleri bağlantı türü. HTML 4.01. 'deki rel özelliği tanımına bakın |
| [RelList](../../aspose.html/htmlanchorelement/rellist/) { get; } | "rel" özniteliğinin ayrıştırılmasından alınan belirteçleri içeren canlı bir DOMTokenList döndürür. |
| [Rev](../../aspose.html/htmlanchorelement/rev/) { get; set; } | Ters bağlantı türü. HTML 4.01. 'deki rev özelliği tanımına bakın |
| [SchemaTypeInfo](../../aspose.html.dom/element/schematypeinfo/) { get; } | Bu öğeyle ilişkili tür bilgisi. |
| [Search](../../aspose.html/htmlanchorelement/search/) { get; set; } | İlişkili URL'nin arama bölümünün dize gösterimini alır veya ayarlar. |
| [ShadowRoot](../../aspose.html.dom/element/shadowroot/) { get; } | Bu öğede depolanan shadowRoot'u veya kapalıysa boş değeri döndürür. |
| [Shape](../../aspose.html/htmlanchorelement/shape/) { get; set; } | Etkin alanın şekli. Koordinatlar, tarafından verilmiştir.`koordinatlar` . HTML 4.01. 'deki şekil özelliği tanımına bakın |
...
| [TabIndex](../../aspose.html/htmlanchorelement/tabindex/) { get; set; } | Öğenin sekme sırasındaki konumunu temsil eden dizin. HTML 4.01. 'deki tabindex öznitelik tanımına bakın |
| [TagName](../../aspose.html.dom/element/tagname/) { get; } | Öğenin adı. |
| [Target](../../aspose.html/htmlanchorelement/target/) { get; set; } | Kaynağı işlemek için çerçeve. HTML 4.01. 'deki hedef öznitelik tanımına bakın |
...
| [Type](../../aspose.html/htmlanchorelement/type/) { get; set; } | Danışma içerik türü. HTML 4.01. 'deki tür özelliği tanımına bakın |
| [Username](../../aspose.html/htmlanchorelement/username/) { get; set; } | İlişkili URL'nin kullanıcı adı bölümünün dize gösterimini alır veya ayarlar. |
...
| [Blur](../../aspose.html/htmlanchorelement/blur/)() | Klavye odağını bu öğeden kaldırır. |
...
| [Focus](../../aspose.html/htmlanchorelement/focus/)() | Klavye odağını bu öğeye verir. |
