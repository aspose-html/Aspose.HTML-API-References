...
description: Aspose.Html.HTMLDataListElement sınıf. datalist öğesi diğer kontroller için önceden tanımlanmış seçenekleri temsil eden bir dizi seçenek öğesini temsil eder. Ayrıca bkz.HTML 5.2 W3C Önerisi .
type: docs
weight: 3160
url: /tr/net/aspose.html/htmldatalistelement/
---
## HTMLDataListElement class

datalist öğesi, diğer kontroller için önceden tanımlanmış seçenekleri temsil eden bir dizi seçenek öğesini temsil eder. Ayrıca bkz.[HTML 5.2 W3C Önerisi](https://www.w3.org/TR/html52/sec-forms.html#elementdef-datalist) .
...
| [Options](../../aspose.html/htmldatalistelement/options/) { get; } | koleksiyonu`SEÇENEK`bu öğesinin içerdiği öğeler. |
