...
description: Aspose.Html.HTMLDirectoryElement sınıf. Dizin listesi. HTML 4.01deki DIR öğesi tanımına bakın. Bu öğe  HTML 4.01. de kullanımdan kaldırılmıştır
type: docs
weight: 3170
url: /tr/net/aspose.html/htmldirectoryelement/
---
## HTMLDirectoryElement class

Dizin listesi. HTML 4.01'deki DIR öğesi tanımına bakın. Bu öğe , HTML 4.01. 'de kullanımdan kaldırılmıştır
...
| [Compact](../../aspose.html/htmldirectoryelement/compact/) { get; set; } | Liste öğeleri arasındaki boşluğu azaltın. HTML 4.01'deki kompakt öznitelik tanımı 'ye bakın. Bu özellik HTML 4.01. 'de kullanımdan kaldırılmıştır |
