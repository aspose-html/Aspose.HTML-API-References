...
description: Aspose.Html.HTMLTableColElement sınıf. yeniden gruplandırırCOL VeBİRLİK GRUBU elementler. HTML 4.01. deki COL öğe tanımına bakın
type: docs
weight: 3560
url: /tr/net/aspose.html/htmltablecolelement/
---
## HTMLTableColElement class

yeniden gruplandırır`COL` Ve`BİRLİK GRUBU` elementler. HTML 4.01. 'deki COL öğe tanımına bakın
...
| İsim | Tanım |
| --- | --- |
| [Align](../../aspose.html/htmltablecolelement/align/) { get; set; } | Sütundaki hücre verilerinin yatay hizalaması. HTML 4.01. 'deki hizalama özniteliği tanımına bakın |
...
| [Ch](../../aspose.html/htmltablecolelement/ch/) { get; set; } | Bir sütundaki hücreler için hizalama karakteri. HTML 4.01. 'deki char özniteliği tanımına bakın |
...
| [ChOff](../../aspose.html/htmltablecolelement/choff/) { get; set; } | Hizalama karakterinin ofseti. HTML 4.01. 'deki karakter özelliği tanımına bakın |
...
| [Span](../../aspose.html/htmltablecolelement/span/) { get; set; } | Bir gruptaki veya gruplandırmadan etkilenen sütun sayısını gösterir. HTML 4.01. 'deki yayılma özniteliği tanımına bakın |
...
| [VAlign](../../aspose.html/htmltablecolelement/valign/) { get; set; } | Sütundaki hücre verilerinin dikey hizalaması. HTML 4.01. 'deki valign özniteliği tanımına bakın |
| [Width](../../aspose.html/htmltablecolelement/width/) { get; set; } | Varsayılan sütun genişliği. HTML 4.01. 'deki genişlik özelliği tanımına bakın |
