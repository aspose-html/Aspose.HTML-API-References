...
description: Aspose.Html.HTMLFormElement sınıf. BİÇİM öğe bir koleksiyonuna ve bir öğeye benzer davranışı kapsar. İçerilen form kontrollerine ve ayrıca form öğesinin özniteliklerine doğrudan erişim sağlar. HTML 4.01. deki FORM öğesi tanımına bakın
type: docs
weight: 3230
url: /tr/net/aspose.html/htmlformelement/
---
## HTMLFormElement class

`BİÇİM` öğe, bir koleksiyonuna ve bir öğeye benzer davranışı kapsar. İçerilen form kontrollerine ve ayrıca form öğesinin özniteliklerine doğrudan erişim sağlar. HTML 4.01. 'deki FORM öğesi tanımına bakın
...
| İsim | Tanım |
| --- | --- |
| [AcceptCharset](../../aspose.html/htmlformelement/acceptcharset/) { get; set; } | Sunucu tarafından desteklenen karakter kümelerinin listesi. HTML 4.01. 'deki accept-charset nitelik tanımına bakın |
| [Action](../../aspose.html/htmlformelement/action/) { get; set; } | Sunucu tarafı form işleyici. HTML 4.01. 'deki eylem özniteliği tanımına bakın |
...
| [Elements](../../aspose.html/htmlformelement/elements/) { get; } | Formdaki tüm form kontrol öğelerinin bir koleksiyonunu döndürür. |
| [Enctype](../../aspose.html/htmlformelement/enctype/) { get; set; } | Gönderilen formun içerik türü, genellikle "application/x-www-form-urlencoded". HTML 4.01'deki enctype özniteliği tanımına bakın. Gönderim sırasında bile işleyicinin, bu yöntem çağrılırken tetiklenmesi garanti edilmez. Davranış, tarihsel nedenlerden dolayı tutarsızdır ve yazarlar belirli bir davranışına güvenmemelidir. |
...
| [Length](../../aspose.html/htmlformelement/length/) { get; } | Formdaki form kontrollerinin sayısı. |
...
| [Method](../../aspose.html/htmlformelement/method/) { get; set; } | HTTP yöntemi [[IETF RFC 2616](http://www.ietf.org/rfc/rfc2616.txt) formu göndermek için kullanılır. HTML 4.01. 'deki yöntem özniteliği tanımına bakın |
| [Name](../../aspose.html/htmlformelement/name/) { get; set; } | Formu adlandırır. |
...
| [Target](../../aspose.html/htmlformelement/target/) { get; set; } | Kaynağı işlemek için çerçeve. HTML 4.01. 'deki hedef öznitelik tanımına bakın |
...
| [Reset](../../aspose.html/htmlformelement/reset/)() | Bir form öğesinin varsayılan değerlerini geri yükler. Sıfırlama düğmesiyle aynı eylemi gerçekleştirir. |
...
| [Submit](../../aspose.html/htmlformelement/submit/)() | Formu gönderir. Gönder düğmesiyle aynı eylemi gerçekleştirir. |
