...
description: Aspose.Html.HTMLIFrameElement sınıf. Satır içi alt pencereler. HTML 4.01. deki IFRAME öğe tanımına bakın
type: docs
weight: 3300
url: /tr/net/aspose.html/htmliframeelement/
---
## HTMLIFrameElement class

Satır içi alt pencereler. HTML 4.01. 'deki IFRAME öğe tanımına bakın
...
| İsim | Tanım |
| --- | --- |
| [Align](../../aspose.html/htmliframeelement/align/) { get; set; } | Bu nesneyi (dikey veya yatay olarak) çevreleyen metnine göre hizalar. HTML 4.01'deki hizalama özniteliği tanımına bakın. Bu özellik HTML 4.01. 'de kullanımdan kaldırılmıştır. |
...
| [FrameBorder](../../aspose.html/htmliframeelement/frameborder/) { get; set; } | Çerçeve kenarlıkları isteyin. HTML 4.01. 'deki çerçeve kenarlığı özniteliği tanımına bakın |
| [Height](../../aspose.html/htmliframeelement/height/) { get; set; } | Çerçeve yüksekliği. HTML 4.01. 'deki yükseklik özniteliği tanımına bakın |
...
| [LongDesc](../../aspose.html/htmliframeelement/longdesc/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] bu görüntünün veya çerçevenin uzun bir açıklamasını belirtir. HTML 4.01. 'deki longdesc öznitelik tanımına bakın |
| [MarginHeight](../../aspose.html/htmliframeelement/marginheight/) { get; set; } | Piksel cinsinden çerçeve kenar boşluğu yüksekliği. HTML 4.01. 'deki marj yüksekliği özniteliği tanımına bakın |
| [MarginWidth](../../aspose.html/htmliframeelement/marginwidth/) { get; set; } | Piksel cinsinden çerçeve kenar boşluğu genişliği. HTML 4.01. 'deki kenar boşluğu özniteliği tanımı 'ye bakın |
| [Name](../../aspose.html/htmliframeelement/name/) { get; set; } | Çerçeve adı (nesnesi`hedef` bağlanmak). HTML 4.01. 'deki ad özelliği tanımına bakın |
...
| [Scrolling](../../aspose.html/htmliframeelement/scrolling/) { get; set; } | Çerçevenin kaydırma çubuklarına sahip olup olmayacağını belirtin. HTML 4.01. 'deki kaydırma özelliği tanımına bakın |
| [ShadowRoot](../../aspose.html.dom/element/shadowroot/) { get; } | Bu öğede depolanan shadowRoot'u veya kapalıysa boş değeri döndürür. |
| [Src](../../aspose.html/htmliframeelement/src/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] ilk çerçeve içeriklerini belirtir. HTML 4.01. 'deki src özniteliği tanımına bakın |
...
| [Width](../../aspose.html/htmliframeelement/width/) { get; set; } | Çerçeve genişliği. HTML 4.01. 'deki genişlik özelliği tanımına bakın |
