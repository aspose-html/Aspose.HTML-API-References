...
description: Aspose.Html.HTMLBaseElement sınıf. Belge tabanı URIsi IETF RFC 2396 . HTML 4.01. deki BASE öğe tanımına bakın
type: docs
weight: 3100
url: /tr/net/aspose.html/htmlbaseelement/
---
## HTMLBaseElement class

Belge tabanı URI'si [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ]. HTML 4.01. 'deki BASE öğe tanımına bakın
...
| [Href](../../aspose.html/htmlbaseelement/href/) { get; set; } | Temel URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ]. HTML 4.01. 'deki href nitelik tanımına bakın |
...
| [Target](../../aspose.html/htmlbaseelement/target/) { get; set; } | Varsayılan hedef çerçeve. HTML'deki hedef özellik tanımına bakın 4.01. |
