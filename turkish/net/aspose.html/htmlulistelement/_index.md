...
description: Aspose.Html.HTMLUListElement sınıf. Sırasız liste. HTML 4.01. deki UL öğe tanımına bakın
type: docs
weight: 3630
url: /tr/net/aspose.html/htmlulistelement/
---
## HTMLUListElement class

Sırasız liste. HTML 4.01. 'deki UL öğe tanımına bakın
...
| [Compact](../../aspose.html/htmlulistelement/compact/) { get; set; } | Liste öğeleri arasındaki boşluğu azaltın. HTML 4.01'deki kompakt öznitelik tanımı 'ye bakın. Bu özellik HTML 4.01. 'de kullanımdan kaldırılmıştır |
...
| [Type](../../aspose.html/htmlulistelement/type/) { get; set; } | Madde işareti stili. HTML 4.01'deki tür özelliği tanımına bakın. Bu özelliği, HTML 4.01. 'de kullanımdan kaldırılmıştır. |
