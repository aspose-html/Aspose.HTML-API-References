...
description: Aspose.Html.HTMLTableCellElement sınıf. Şunu temsil etmek için kullanılan nesneTH VeTD öğeleri. HTML 4.01. deki TD öğesi tanımına bakın
type: docs
weight: 3550
url: /tr/net/aspose.html/htmltablecellelement/
---
## HTMLTableCellElement class

Şunu temsil etmek için kullanılan nesne:`TH` Ve`TD` öğeleri. HTML 4.01. 'deki TD öğesi tanımına bakın
...
| İsim | Tanım |
| --- | --- |
| [Abbr](../../aspose.html/htmltablecellelement/abbr/) { get; set; } | Başlık hücrelerinin kısaltması. HTML 4.01. 'deki kısaltılmış öznitelik tanımına bakın |
| [Align](../../aspose.html/htmltablecellelement/align/) { get; set; } | Hücredeki verilerin yatay hizalanması. HTML 4.01. 'de tanım hizalama özniteliğine bakın |
...
| [Axis](../../aspose.html/htmltablecellelement/axis/) { get; set; } | İlgili başlıkların grubunu adlandırır. HTML 4.01. 'deki eksen özelliği tanımına bakın |
...
| [BgColor](../../aspose.html/htmltablecellelement/bgcolor/) { get; set; } | Hücre arka plan rengi. HTML 4.01'deki bgcolor nitelik tanımına bakın. Bu özellik HTML 4.01. 'de kullanımdan kaldırılmıştır |
| [CellIndex](../../aspose.html/htmltablecellelement/cellindex/) { get; } | Satırdaki bu hücrenin 0'dan başlayan dizini. Bu dizin belge ağacı sırasındadır ve görüntülenme sırasında değildir. |
| [Ch](../../aspose.html/htmltablecellelement/ch/) { get; set; } | Bir sütundaki hücreler için hizalama karakteri. HTML 4.01. 'deki char özniteliği tanımına bakın |
...
| [ChOff](../../aspose.html/htmltablecellelement/choff/) { get; set; } | Hizalama karakterinin ofseti. HTML 4.01. 'deki karakter özelliği tanımına bakın |
...
| [ColSpan](../../aspose.html/htmltablecellelement/colspan/) { get; set; } | Hücre tarafından yayılan sütun sayısı. HTML 4.01. 'deki colspan özellik tanımı 'ye bakın |
...
| [Headers](../../aspose.html/htmltablecellelement/headers/) { get; set; } | listesi`İD` başlık hücreleri için öznitelik değerleri. HTML 4.01. 'deki başlık öznitelik tanımına bakın |
| [Height](../../aspose.html/htmltablecellelement/height/) { get; set; } | Hücre yüksekliği. HTML 4.01'deki yükseklik özelliği tanımına bakın. Bu özelliği, HTML 4.01. 'de kullanımdan kaldırılmıştır. |
...
| [NoWrap](../../aspose.html/htmltablecellelement/nowrap/) { get; set; } | Sözcük kaydırmayı bastır. HTML 4.01'deki nowrap öznitelik tanımına bakın. Bu özellik HTML 4.01. 'de kullanımdan kaldırılmıştır |
...
| [RowSpan](../../aspose.html/htmltablecellelement/rowspan/) { get; set; } | Hücre tarafından yayılan satır sayısı. HTML 4.01. 'deki satır aralığı özniteliği tanımına bakın |
| [SchemaTypeInfo](../../aspose.html.dom/element/schematypeinfo/) { get; } | Bu öğeyle ilişkili tür bilgisi. |
| [Scope](../../aspose.html/htmltablecellelement/scope/) { get; set; } | Başlık hücrelerinin kapsadığı kapsam. HTML 4.01. 'deki kapsam özelliği tanımına bakın |
...
| [VAlign](../../aspose.html/htmltablecellelement/valign/) { get; set; } | Hücredeki verilerin dikey hizalanması. HTML 4.01. 'de valign öznitelik tanımına bakın |
| [Width](../../aspose.html/htmltablecellelement/width/) { get; set; } | Hücre genişliği. HTML 4.01'deki genişlik özelliği tanımına bakın. Bu özelliği, HTML 4.01. 'de kullanımdan kaldırılmıştır. |
