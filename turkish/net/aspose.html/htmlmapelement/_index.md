...
description: Aspose.Html.HTMLMapElement sınıf. İstemci tarafı görüntü haritası. HTML 4.01. deki MAP öğesi tanımına bakın
type: docs
weight: 3380
url: /tr/net/aspose.html/htmlmapelement/
---
## HTMLMapElement class

İstemci tarafı görüntü haritası. HTML 4.01. 'deki MAP öğesi tanımına bakın
...
| İsim | Tanım |
| --- | --- |
| [Areas](../../aspose.html/htmlmapelement/areas/) { get; } | Görüntü haritası için tanımlanan alanların listesi. |
...
| [Name](../../aspose.html/htmlmapelement/name/) { get; set; } | Haritayı adlandırır (ile kullanım için`kullanım haritası` ). HTML 4.01. 'deki öznitelik tanımına bakın |
