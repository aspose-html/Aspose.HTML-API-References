...
description: Aspose.Html.HTMLNoScriptElement sınıf. Komut dosyası ifadeleri. HTML 4.01. deki NOSCRIPT öğe tanımına bakın
type: docs
weight: 3420
url: /tr/net/aspose.html/htmlnoscriptelement/
---
## HTMLNoScriptElement class

Komut dosyası ifadeleri. HTML 4.01. 'deki NOSCRIPT öğe tanımına bakın
