...
description: Aspose.Html.HTMLFrameElement sınıf. Bir çerçeve oluşturun. HTML 4.01. deki ÇERÇEVE öğesi tanımına bakın
type: docs
weight: 3240
url: /tr/net/aspose.html/htmlframeelement/
---
## HTMLFrameElement class

Bir çerçeve oluşturun. HTML 4.01. 'deki ÇERÇEVE öğesi tanımına bakın
...
| [ContentDocument](../../aspose.html/htmlframeelement/contentdocument/) { get; } | Varsa ve varsa bu çerçevenin içerdiği belge veya`hükümsüz` aksi takdirde. @dOM Düzey 2 beri |
...
| [FrameBorder](../../aspose.html/htmlframeelement/frameborder/) { get; set; } | Çerçeve kenarlıkları isteyin. HTML 4.01. 'deki çerçeve kenarlığı özniteliği tanımına bakın |
...
| [LongDesc](../../aspose.html/htmlframeelement/longdesc/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] bu görüntünün veya çerçevenin uzun bir açıklamasını belirtir. HTML 4.01. 'deki longdesc öznitelik tanımına bakın |
| [MarginHeight](../../aspose.html/htmlframeelement/marginheight/) { get; set; } | Piksel cinsinden çerçeve kenar boşluğu yüksekliği. HTML 4.01. 'deki marj yüksekliği özniteliği tanımına bakın |
| [MarginWidth](../../aspose.html/htmlframeelement/marginwidth/) { get; set; } | Piksel cinsinden çerçeve kenar boşluğu genişliği. HTML 4.01. 'deki kenar boşluğu özniteliği tanımı 'ye bakın |
| [Name](../../aspose.html/htmlframeelement/name/) { get; set; } | Çerçeve adı (nesnesi`hedef` bağlanmak). HTML 4.01. 'deki ad özelliği tanımına bakın |
...
| [NoResize](../../aspose.html/htmlframeelement/noresize/) { get; set; } | Doğru olduğunda, kullanıcının çerçeveyi yeniden boyutlandırmasını yasaklayın. HTML 4.01. 'deki noresize özniteliği tanımına bakın |
...
| [Scrolling](../../aspose.html/htmlframeelement/scrolling/) { get; set; } | Çerçevenin kaydırma çubuklarına sahip olup olmayacağını belirtin. HTML 4.01. 'deki kaydırma özelliği tanımına bakın |
| [ShadowRoot](../../aspose.html.dom/element/shadowroot/) { get; } | Bu öğede depolanan shadowRoot'u veya kapalıysa boş değeri döndürür. |
| [Src](../../aspose.html/htmlframeelement/src/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] ilk çerçeve içeriklerini belirtir. HTML 4.01. 'deki src özniteliği tanımına bakın |
