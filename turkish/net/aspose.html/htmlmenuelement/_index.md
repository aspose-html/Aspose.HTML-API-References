...
description: Aspose.Html.HTMLMenuElement sınıf. Menü listesi. HTML 4.01deki MENU öğe tanımına bakın. Bu öğe HTML 4.01. de kullanımdan kaldırılmıştır
type: docs
weight: 3390
url: /tr/net/aspose.html/htmlmenuelement/
---
## HTMLMenuElement class

Menü listesi. HTML 4.01'deki MENU öğe tanımına bakın. Bu öğe, HTML 4.01. 'de kullanımdan kaldırılmıştır
...
| [Compact](../../aspose.html/htmlmenuelement/compact/) { get; set; } | Liste öğeleri arasındaki boşluğu azaltın. HTML 4.01'deki kompakt öznitelik tanımı 'ye bakın. Bu özellik HTML 4.01. 'de kullanımdan kaldırılmıştır |
