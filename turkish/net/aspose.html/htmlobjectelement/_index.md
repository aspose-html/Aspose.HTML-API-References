...
description: Aspose.Html.HTMLObjectElement sınıf. Genel katıştırılmış nesne. Prensipte nesne öğesindeki tüm özellikler okumayazmadır ancak bazı ortamlarda temeldeki nesne başlatıldıktan sonra bazı özellikler salt okunur olabilir. NESNE öğesi tanımına bakın HTML 4.01 .
type: docs
weight: 3440
url: /tr/net/aspose.html/htmlobjectelement/
---
## HTMLObjectElement class

Genel katıştırılmış nesne. Prensipte, nesne öğesindeki tüm özellikler okuma-yazmadır, ancak bazı ortamlarda, temeldeki nesne başlatıldıktan sonra bazı özellikler salt okunur olabilir. NESNE öğesi tanımına bakın [[HTML 4.01](http://www.w3.org/TR/1999/REC-html401-19991224) ].
...
| İsim | Tanım |
| --- | --- |
| [Align](../../aspose.html/htmlobjectelement/align/) { get; set; } | Bu nesneyi çevreleyen metne göre (dikey veya yatay olarak) hizalar. HTML 4.01'deki hizalama özniteliği tanımına bakın. Bu özellik HTML 4.01. 'de kullanımdan kaldırılmıştır |
| [Archive](../../aspose.html/htmlobjectelement/archive/) { get; set; } | Boşlukla ayrılmış arşiv listesi. HTML 4.01. 'deki arşiv özelliği tanımına bakın |
...
| [Border](../../aspose.html/htmlobjectelement/border/) { get; set; } | Nesne etrafındaki kenarlık genişliği. HTML 4.01'deki border niteliği tanımına bakın. Bu özellik HTML 4.01. 'de kullanımdan kaldırılmıştır |
...
| [ClassId](../../aspose.html/htmlobjectelement/classid/) { get; set; } | Windows Kayıt Defterinde ayarlanan bir sınıf kimliği değeri veya bir URL tanımlar |
...
| [Code](../../aspose.html/htmlobjectelement/code/) { get; set; } | Applet sınıf dosyası. Bkz.`kod` HTMLAppletElement için öznitelik. |
| [CodeBase](../../aspose.html/htmlobjectelement/codebase/) { get; set; } | Temel URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] için`sınıf kimliği` ,`veri` ve `Arşiv` Öznitellikler. HTML 4.01. 'deki kod tabanı özniteliği definition 'ye bakın |
| [CodeType](../../aspose.html/htmlobjectelement/codetype/) { get; set; } | Üzerinden indirilen veriler için içerik türü`sınıf kimliği` bağlanmak. HTML 4.01. 'deki kod tipi öznitelik tanımına bakın |
| [Data](../../aspose.html/htmlobjectelement/data/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] nesnenin verilerinin konumunu belirterek. HTML 4.01. 'deki veri özellik tanımına bakın |
| [Declare](../../aspose.html/htmlobjectelement/declare/) { get; set; } | Bu nesneyi bildirin (ileride başvurmak üzere), ancak örneğini oluşturmayın. HTML 4.01. 'deki bildirim özelliği tanımına bakın |
...
| [Form](../../aspose.html/htmlobjectelement/form/) { get; set; } | şunu döndürür:`BİÇİM` bu denetimi içeren öğe. İadeler`hükümsüz` bu kontrol bir form bağlamında değilse. |
| [Height](../../aspose.html/htmlobjectelement/height/) { get; set; } | Yüksekliği geçersiz kıl. HTML 4.01. 'deki yükseklik özniteliği tanımına bakın |
| [Hspace](../../aspose.html/htmlobjectelement/hspace/) { get; set; } | Bu görüntünün, uygulamasının veya nesnenin solunda ve sağında piksel cinsinden yatay boşluk. HTML 4.01'deki hspace nitelik tanımına bakın. Bu özellik HTML 4.01. 'de kullanımdan kaldırılmıştır. |
...
| [Name](../../aspose.html/htmlobjectelement/name/) { get; set; } | Formla gönderildiğinde form kontrolü veya nesne adı. HTML 4.01. 'deki öznitelik tanımına bakın |
...
| [Standby](../../aspose.html/htmlobjectelement/standby/) { get; set; } | Nesne yüklenirken işlenecek mesaj. HTML 4.01. 'deki bekleme özniteliği tanımına bakın |
...
| [TabIndex](../../aspose.html/htmlobjectelement/tabindex/) { get; set; } | Öğenin sekme sırasındaki konumunu temsil eden dizin. HTML 4.01. 'deki tabindex öznitelik tanımına bakın |
...
| [Type](../../aspose.html/htmlobjectelement/type/) { get; set; } | Üzerinden indirilen veriler için içerik türü`veri` bağlanmak. HTML 4.01. 'deki tür özelliği tanımına bakın |
| [UseMap](../../aspose.html/htmlobjectelement/usemap/) { get; set; } | İstemci tarafı görüntü eşlemesini kullanın. HTML 4.01. 'deki kullanım haritası öznitelik tanımına bakın |
| [Vspace](../../aspose.html/htmlobjectelement/vspace/) { get; set; } | Bu görüntünün, uygulamanın veya nesnenin üstünde ve altında piksel cinsinden dikey boşluk. HTML 4.01'deki vspace nitelik tanımına bakın. Bu özellik HTML 4.01. 'de kullanımdan kaldırılmıştır |
| [Width](../../aspose.html/htmlobjectelement/width/) { get; set; } | Geçersiz kılma genişliği. HTML 4.01. 'deki genişlik özelliği tanımına bakın |
