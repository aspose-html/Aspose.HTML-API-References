...
description: Aspose.Html.HTMLFontElement sınıf. Yazı tipinde yerel değişiklik. HTML 4.01deki FONT öğesi tanımına bakın. Bu öğesi HTML 4.01. sürümünde kullanımdan kaldırılmıştır.
type: docs
weight: 3220
url: /tr/net/aspose.html/htmlfontelement/
---
## HTMLFontElement class

Yazı tipinde yerel değişiklik. HTML 4.01'deki FONT öğesi tanımına bakın. Bu öğesi, HTML 4.01. sürümünde kullanımdan kaldırılmıştır.
...
| [Color](../../aspose.html/htmlfontelement/color/) { get; set; } | Yazı tipi rengi. HTML 4.01'deki renk özelliği tanımına bakın. Bu özelliği, HTML 4.01. 'de kullanımdan kaldırılmıştır. |
...
| [Face](../../aspose.html/htmlfontelement/face/) { get; set; } | Yazı tipi yüzü tanımlayıcısı. HTML 4.01'deki yüz özelliği tanımına bakın. Bu özellik HTML 4.01. 'de kullanımdan kaldırılmıştır. |
...
| [Size](../../aspose.html/htmlfontelement/size/) { get; set; } | Yazı tipi boyutu. HTML 4.01'deki boyut özelliği tanımına bakın. Bu özelliği, HTML 4.01. 'de kullanımdan kaldırılmıştır. |
