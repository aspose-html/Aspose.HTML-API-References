...
description: Aspose.Html.HTMLTextAreaElement sınıf. Çok satırlı metin alanı. HTML 4.01. deki TEXTAREA öğe tanımına bakın
type: docs
weight: 3610
url: /tr/net/aspose.html/htmltextareaelement/
---
## HTMLTextAreaElement class

Çok satırlı metin alanı. HTML 4.01. 'deki TEXTAREA öğe tanımına bakın
...
| İsim | Tanım |
| --- | --- |
| [AccessKey](../../aspose.html/htmltextareaelement/accesskey/) { get; set; } | Form denetimine erişim sağlamak için tek karakterli bir erişim anahtarı. HTML 4.01. 'deki erişim anahtarı öznitelik tanımına bakın |
...
| [Cols](../../aspose.html/htmltextareaelement/cols/) { get; set; } | Kontrol genişliği (karakter olarak). HTML 4.01. 'deki cols nitelik tanımına bakın |
| [DefaultValue](../../aspose.html/htmltextareaelement/defaultvalue/) { get; set; } | Öğenin içeriğini temsil eder. Bu özniteliğinin değeri, etkileşimli bir kullanıcı aracısı olan 'deki ilgili form kontrolünün içeriği değişirse değişmez. @version DOM Düzey 2 |
...
| [Disabled](../../aspose.html/htmltextareaelement/disabled/) { get; set; } | Kontrol bu bağlamda kullanılamaz. HTML 4.01. 'de devre dışı bırakılan öznitelik tanımına bakın |
...
| [Form](../../aspose.html/htmltextareaelement/form/) { get; } | şunu döndürür:`BİÇİM` bu denetimi içeren öğe. döndürür`hükümsüz` bu kontrol bir formu bağlamında değilse. |
...
| [Name](../../aspose.html/htmltextareaelement/name/) { get; set; } | Formla gönderildiğinde form kontrolü veya nesne adı. HTML 4.01. 'deki öznitelik tanımına bakın |
...
| [ReadOnly](../../aspose.html/htmltextareaelement/readonly/) { get; set; } | Bu kontrol salt okunurdur. HTML 4.01. 'deki salt okunur öznitelik tanımına bakın |
| [Rows](../../aspose.html/htmltextareaelement/rows/) { get; set; } | Metin satırı sayısı. HTML 4.01. 'deki satır özniteliği tanımına bakın |
...
| [TabIndex](../../aspose.html/htmltextareaelement/tabindex/) { get; set; } | Öğenin sekme sırasındaki konumunu temsil eden dizin. HTML 4.01. 'deki tabindex öznitelik tanımına bakın |
...
| [Type](../../aspose.html/htmltextareaelement/type/) { get; } | Bu form denetiminin türü. Bu, "textarea". dizisidir. |
| [Value](../../aspose.html/htmltextareaelement/value/) { get; set; } | Etkileşimli bir kullanıcı aracısı olan 'de karşılık gelen form kontrolünün geçerli içeriğini temsil eder. Bu özniteliğin değiştirilmesi, form kontrolünün içeriğini değiştirir, ancak öğesinin içeriğini değiştirmez. Verilerin tamamı tek bir içine sığamıyorsa`DOMString` , uygulama verileri kesebilir. |
