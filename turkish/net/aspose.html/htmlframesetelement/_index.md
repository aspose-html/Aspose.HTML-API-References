...
description: Aspose.Html.HTMLFrameSetElement sınıf. Çerçeve ızgarası oluşturun. HTML 4.01. deki FRAMESET öğe tanımına bakın
type: docs
weight: 3250
url: /tr/net/aspose.html/htmlframesetelement/
---
## HTMLFrameSetElement class

Çerçeve ızgarası oluşturun. HTML 4.01. 'deki FRAMESET öğe tanımına bakın
...
| [Cols](../../aspose.html/htmlframesetelement/cols/) { get; set; } | Çerçeve kümesindeki çerçevelerin sütun sayısı. HTML 4.01. 'deki cols özniteliği tanımına bakın |
...
| [Rows](../../aspose.html/htmlframesetelement/rows/) { get; set; } | Çerçeve kümesindeki çerçeve sıralarının sayısı. HTML 4.01. 'deki satır özniteliği tanımına bakın |
