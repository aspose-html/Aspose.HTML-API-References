...
description: Aspose.Html.HTMLSelectElement sınıf. Select öğesi bir seçeneğin seçilmesine olanak tanır. Kapsanan seçeneklerine bir koleksiyon olarak seçme öğesi aracılığıyla doğrudan erişilebilir. HTML 4.01. deki SELECT öğesi tanımına bakın
type: docs
weight: 3520
url: /tr/net/aspose.html/htmlselectelement/
---
## HTMLSelectElement class

Select öğesi, bir seçeneğin seçilmesine olanak tanır. Kapsanan seçeneklerine, bir koleksiyon olarak seçme öğesi aracılığıyla doğrudan erişilebilir. HTML 4.01. 'deki SELECT öğesi tanımına bakın
...
| [Disabled](../../aspose.html/htmlselectelement/disabled/) { get; set; } | Kontrol bu bağlamda kullanılamaz. HTML 4.01. 'de devre dışı bırakılan öznitelik tanımına bakın |
...
| [Form](../../aspose.html/htmlselectelement/form/) { get; } | Buradaki seçeneklerin sayısı`SEÇME` . |
...
| [Length](../../aspose.html/htmlselectelement/length/) { get; set; } | Buradaki seçeneklerin sayısı`SEÇME` . @versiyon DOM Seviyesi 2 |
...
| [Multiple](../../aspose.html/htmlselectelement/multiple/) { get; set; } | Doğruysa, birden çok`SEÇENEK` elemanlar bu kısımda seçilebilir`SEÇME` . HTML 4.01. 'deki çoklu özellik tanımına bakın |
| [Name](../../aspose.html/htmlselectelement/name/) { get; set; } | Formla gönderildiğinde form kontrolü veya nesne adı. HTML 4.01. 'deki öznitelik tanımına bakın |
...
| [Options](../../aspose.html/htmlselectelement/options/) { get; } | koleksiyonu`SEÇENEK` bu öğesinin içerdiği öğeler. @versiyon DOM Seviyesi 2 |
...
| [SelectedIndex](../../aspose.html/htmlselectelement/selectedindex/) { get; set; } | Seçilen seçeneğin 0'dan başlayan sıra dizini. Hiçbir öğe seçilmezse -1 değeri döndürülür. Birden çok seçenek seçilirse, ilk seçilen seçeneğin dizini döndürülür. |
| [ShadowRoot](../../aspose.html.dom/element/shadowroot/) { get; } | Bu öğede depolanan shadowRoot'u veya kapalıysa boş değeri döndürür. |
| [Size](../../aspose.html/htmlselectelement/size/) { get; set; } | Görünür satır sayısı. HTML 4.01. 'deki boyut özelliği tanımına bakın |
...
| [TabIndex](../../aspose.html/htmlselectelement/tabindex/) { get; set; } | Öğenin sekme sırasındaki konumunu temsil eden dizin. HTML 4.01. 'deki tabindex öznitelik tanımına bakın |
...
| [Type](../../aspose.html/htmlselectelement/type/) { get; } | Bu form denetiminin türü. multiple özniteliği olduğunda bu "select-multiple" dizesidir.`doğru` ve "select-one" dizesi`YANLIŞ` . |
| [Value](../../aspose.html/htmlselectelement/value/) { get; set; } | Geçerli form kontrol değeri (yani seçili olan seçeneğinin değeri), birden çok seçenek seçilirse bu, ilk seçilen seçeneğin değeridir. |
