...
description: Aspose.Html.HTMLLIElement sınıf. Liste öğesi. HTML 4.01. deki LI öğesi tanımına bakın
type: docs
weight: 3340
url: /tr/net/aspose.html/htmllielement/
---
## HTMLLIElement class

Liste öğesi. HTML 4.01. 'deki LI öğesi tanımına bakın
...
| [Type](../../aspose.html/htmllielement/type/) { get; set; } | Liste öğesi madde işareti stili. HTML 4.01'deki tür özelliği tanımına bakın. Bu özellik HTML 4.01. 'de kullanımdan kaldırılmıştır. |
| [Value](../../aspose.html/htmllielement/value/) { get; set; } | Kullanıldığında sıra numarasını sıfırla`OL` . HTML 4.01'deki öznitelik tanımına bakın. Bu özellik HTML 4.01. 'de kullanımdan kaldırılmıştır |
