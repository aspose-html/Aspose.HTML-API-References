...
description: Aspose.Html.HTMLTableSectionElement sınıf. TEAD TAYAK  VeTBODY öğeleri.
type: docs
weight: 3590
url: /tr/net/aspose.html/htmltablesectionelement/
---
## HTMLTableSectionElement class

`TEAD` ,`TAYAK` , Ve`TBODY` öğeleri.
...
| İsim | Tanım |
| --- | --- |
| [Align](../../aspose.html/htmltablesectionelement/align/) { get; set; } | Hücrelerdeki verilerin yatay hizalanması. Bkz.`hizalamak` Ayrıntılar için HTMLTheadElement için özelliği. |
...
| [Ch](../../aspose.html/htmltablesectionelement/ch/) { get; set; } | Bir sütundaki hücreler için hizalama karakteri. HTML 4.01. 'deki char özniteliği tanımına bakın |
...
| [ChOff](../../aspose.html/htmltablesectionelement/choff/) { get; set; } | Hizalama karakterinin ofseti. HTML 4.01. 'deki karakter özelliği tanımına bakın |
...
| [Rows](../../aspose.html/htmltablesectionelement/rows/) { get; } | Bu tablo bölümündeki satırların toplanması. |
...
| [VAlign](../../aspose.html/htmltablesectionelement/valign/) { get; set; } | Hücrelerdeki verilerin dikey hizalanması. Bkz.`geçerlilik` Ayrıntılar için HTMLTheadElement için özelliği. |
...
| [DeleteRow](../../aspose.html/htmltablesectionelement/deleterow/)(int) | Bu bölümden bir satırı silin. |
...
| [InsertRow](../../aspose.html/htmltablesectionelement/insertrow/)(int) | Bu bölüme bir satır ekleyin. Yeni satır, geçerli satırdan hemen önce eklenir`dizin` bu bölümdeki inci sıra. ise`dizin` -1 veya bu bölümündeki satır sayısına eşitse, yeni satır eklenir. |
