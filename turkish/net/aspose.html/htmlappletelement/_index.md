...
description: Aspose.Html.HTMLAppletElement sınıf. Katıştırılmış bir Java uygulaması. HTML 4.01deki APPLET öğesi tanımına bakın. Bu öğe HTML 4.01. de kullanımdan kaldırılmıştır.
type: docs
weight: 3070
url: /tr/net/aspose.html/htmlappletelement/
---
## HTMLAppletElement class

Katıştırılmış bir Java uygulaması. HTML 4.01'deki APPLET öğesi tanımına bakın. Bu öğe HTML 4.01. 'de kullanımdan kaldırılmıştır.
...
| İsim | Tanım |
| --- | --- |
| [Align](../../aspose.html/htmlappletelement/align/) { get; set; } | Bu nesneyi (dikey veya yatay olarak) çevreleyen metnine göre hizalar. HTML 4.01'deki hizalama özniteliği tanımına bakın. Bu özellik HTML 4.01. 'de kullanımdan kaldırılmıştır. |
| [Alt](../../aspose.html/htmlappletelement/alt/) { get; set; } | Bu öğesinin normal içeriğini oluşturmayan kullanıcı aracıları için alternatif metin. HTML 4.01'deki alt nitelik tanımına bakın. Bu özelliği, HTML 4.01. 'de kullanımdan kaldırılmıştır. |
| [Archive](../../aspose.html/htmlappletelement/archive/) { get; set; } | Virgülle ayrılmış arşiv listesi. HTML 4.01'deki arşiv özelliği tanımına bakın. Bu özellik HTML 4.01. 'de kullanımdan kaldırılmıştır |
...
| [Code](../../aspose.html/htmlappletelement/code/) { get; set; } | Applet sınıf dosyası. HTML 4.01'deki kod özelliği tanımına bakın. Bu özelliği, HTML 4.01. 'de kullanımdan kaldırılmıştır. |
| [CodeBase](../../aspose.html/htmlappletelement/codebase/) { get; set; } | İsteğe bağlı temel URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) uygulaması için. HTML 4.01'deki kod tabanı öznitelik tanımına bakın. Bu özellik HTML 4.01. 'de kullanımdan kaldırılmıştır |
...
| [Height](../../aspose.html/htmlappletelement/height/) { get; set; } | Yüksekliği geçersiz kıl. HTML 4.01'deki yükseklik özelliği tanımına bakın. Bu özelliği, HTML 4.01. 'de kullanımdan kaldırılmıştır. |
| [Hspace](../../aspose.html/htmlappletelement/hspace/) { get; set; } | Bu görüntünün, uygulamasının veya nesnenin solunda ve sağında piksel cinsinden yatay boşluk. HTML 4.01'deki hspace nitelik tanımına bakın. Bu öznitelik HTML 4.01. @version DOM Level 2 'de kullanımdan kaldırılmıştır |
...
| [Name](../../aspose.html/htmlappletelement/name/) { get; set; } | Uygulamanın adı. HTML 4.01'deki ad niteliği tanımına bakın. Bu özellik HTML 4.01. 'de kullanımdan kaldırılmıştır. |
...
| [Object](../../aspose.html/htmlappletelement/object/) { get; set; } | "nesne" özniteliğinin değeri. HTML 4.01'deki define nesne özniteliğine bakın. Bu özellik HTML 4.01'de kullanımdan kaldırılmıştır. @versiyon DOM Seviyesi 2 |
...
| [Vspace](../../aspose.html/htmlappletelement/vspace/) { get; set; } | Bu görüntünün, uygulamanın veya nesnesinin üstünde ve altında piksel cinsinden dikey boşluk. HTML 4.01'deki vspace nitelik tanımına bakın. Bu özniteliği, HTML 4.01. @version DOM Level 2 sürümünde kullanımdan kaldırılmıştır. |
| [Width](../../aspose.html/htmlappletelement/width/) { get; set; } | Geçersiz kılma genişliği. HTML 4.01'deki genişlik özelliği tanımına bakın. Bu özelliği, HTML 4.01. 'de kullanımdan kaldırılmıştır. |
