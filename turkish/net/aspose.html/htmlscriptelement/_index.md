...
description: Aspose.Html.HTMLScriptElement sınıf. Komut dosyası ifadeleri. HTML 4.01. deki SCRIPT öğesi tanımına bakın
type: docs
weight: 3510
url: /tr/net/aspose.html/htmlscriptelement/
---
## HTMLScriptElement class

Komut dosyası ifadeleri. HTML 4.01. 'deki SCRIPT öğesi tanımına bakın
...
| [Charset](../../aspose.html/htmlscriptelement/charset/) { get; set; } | Bağlantılı kaynağın karakter kodlaması. HTML 4.01. 'deki karakter kümesi nitelik tanımına bakın |
...
| [Defer](../../aspose.html/htmlscriptelement/defer/) { get; set; } | Kullanıcı aracısının komut dosyasının işlenmesini erteleyebileceğini belirtir. HTML 4.01. 'deki erteleme özniteliği tanımına bakın |
...
| [Event](../../aspose.html/htmlscriptelement/event/) { get; set; } | İleride kullanılmak üzere ayrılmıştır. |
...
| [Src](../../aspose.html/htmlscriptelement/src/) { get; set; } | URI [[IETF RFC 2396](http://www.ietf.org/rfc/rfc2396.txt) ] harici bir komut dosyası belirleme. HTML 4.01. 'deki src öznitelik tanımına bakın |
...
| [Text](../../aspose.html/htmlscriptelement/text/) { get; set; } | Öğenin kod içeriği. |
...
| [Type](../../aspose.html/htmlscriptelement/type/) { get; set; } | Kod dilinin içerik türü. HTML 4.01. 'deki tür özniteliği tanımına bakın |
