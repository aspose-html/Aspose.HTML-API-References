...
description: Aspose.Html.HTMLIsIndexElement sınıf. Bu öğe tek satırlık metin girişi için kullanılır. HTML 4.01deki ISINDEX öğesi tanımına bakın. Bu öğe HTML 4.01. de kullanımdan kaldırılmıştır
type: docs
weight: 3330
url: /tr/net/aspose.html/htmlisindexelement/
---
## HTMLIsIndexElement class

Bu öğe, tek satırlık metin girişi için kullanılır. HTML 4.01'deki ISINDEX öğesi tanımına bakın. Bu öğe HTML 4.01. 'de kullanımdan kaldırılmıştır
...
| [Form](../../aspose.html/htmlisindexelement/form/) { get; } | şunu döndürür: bu denetimi içeren öğe. döndürür bu kontrol bir formu bağlamında değilse. |
...
| [Prompt](../../aspose.html/htmlisindexelement/prompt/) { get; set; } | Bilgi istemi mesajı. HTML 4.01'deki bilgi istemi özniteliği tanımına bakın. Bu özellik HTML 4.01. 'de kullanımdan kaldırılmıştır. |
