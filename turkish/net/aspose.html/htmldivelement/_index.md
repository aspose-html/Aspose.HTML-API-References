...
description: Aspose.Html.HTMLDivElement sınıf. Genel blok kabı. HTML 4.01. deki DIV öğesi tanımına bakın
type: docs
weight: 3180
url: /tr/net/aspose.html/htmldivelement/
---
## HTMLDivElement class

Genel blok kabı. HTML 4.01. 'deki DIV öğesi tanımına bakın
...
| İsim | Tanım |
| --- | --- |
| [Align](../../aspose.html/htmldivelement/align/) { get; set; } | Yatay metin hizalaması. HTML 4.01'deki hizalama özelliği tanımına bakın. Bu özellik HTML 4.01. 'de kullanımdan kaldırılmıştır |
