...
description: Aspose.Html.Dom.Svg.Filters.SVGFEGaussianBlurElement sınıf. SVGFEGaussianBlurElement arabirimi feGaussianBlur öğesine karşılık gelir.
type: docs
weight: 1500
url: /tr/net/aspose.html.dom.svg.filters/svgfegaussianblurelement/
---
## SVGFEGaussianBlurElement class

SVGFEGaussianBlurElement arabirimi, "feGaussianBlur" öğesine karşılık gelir.
...
| [Height](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/height/) { get; } | Verilen "filtre" öğesindeki "yükseklik" özelliğine karşılık gelir. |
| [Id](../../aspose.html.dom.svg/svgelement/id/) { get; set; } | Belirtilen öğedeki 'id' özniteliğinin değeri veya 'id' yoksa boş dize. |
| [In1](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/in1/) { get; } | Verilen "feGaussianBlur" öğesindeki "in" özelliğine karşılık gelir. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/result/) { get; } | Verilen "filtre" öğesindeki "sonuç" özelliğine karşılık gelir. |
...
| [StdDeviationX](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/stddeviationx/) { get; } | Verilen "feGaussianBlur" öğesinde "stdDeviation" özelliğine karşılık gelir. �stdDeviation�. özniteliğinin X bileşenini içerir |
| [StdDeviationY](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/stddeviationy/) { get; } | Verilen "feGaussianBlur" öğesinde "stdDeviation" özelliğine karşılık gelir. "stdDeviation". özniteliğinin Y bileşenini (muhtemelen otomatik olarak hesaplanmıştır) içerir |
...
| [Width](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/width/) { get; } | Verilen "filtre" öğesindeki "genişlik" özelliğine karşılık gelir. |
| [X](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/x/) { get; } | Verilen "filtre" öğesinde "x" özelliğine karşılık gelir. |
| [Y](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/y/) { get; } | Verilen "filter" öğesindeki "y" özelliğine karşılık gelir. |
...
| [SetStdDeviation](../../aspose.html.dom.svg.filters/svgfegaussianblurelement/setstddeviation/)(float, float) | "stdDeviation" özniteliği için değerleri ayarlar. |
