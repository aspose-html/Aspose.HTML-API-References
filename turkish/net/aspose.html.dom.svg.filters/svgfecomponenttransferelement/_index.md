...
description: Aspose.Html.Dom.Svg.Filters.SVGFEComponentTransferElement sınıf. SVGFEComponentTransferElement arabirimi feComponentTransfer öğesine karşılık gelir.
type: docs
weight: 1380
url: /tr/net/aspose.html.dom.svg.filters/svgfecomponenttransferelement/
---
## SVGFEComponentTransferElement class

SVGFEComponentTransferElement arabirimi, 'feComponentTransfer' öğesine karşılık gelir.
...
| [Height](../../aspose.html.dom.svg.filters/svgfecomponenttransferelement/height/) { get; } | Belirtilen 'filtre' öğesindeki 'yükseklik' özelliğine karşılık gelir. |
| [Id](../../aspose.html.dom.svg/svgelement/id/) { get; set; } | Belirtilen öğedeki 'id' özniteliğinin değeri veya 'id' yoksa boş dize. |
| [In1](../../aspose.html.dom.svg.filters/svgfecomponenttransferelement/in1/) { get; } | Verilen 'feComponentTransfer' öğesindeki 'in' özniteliğine karşılık gelir. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfecomponenttransferelement/result/) { get; } | Belirtilen 'filtre' öğesindeki 'sonuç' özniteliğine karşılık gelir. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfecomponenttransferelement/width/) { get; } | Verilen 'filtre' öğesindeki 'genişlik' özelliğine karşılık gelir. |
| [X](../../aspose.html.dom.svg.filters/svgfecomponenttransferelement/x/) { get; } | Verilen 'filtre' öğesindeki 'x' özniteliğine karşılık gelir. |
| [Y](../../aspose.html.dom.svg.filters/svgfecomponenttransferelement/y/) { get; } | Verilen 'filtre' öğesindeki 'y' özniteliğine karşılık gelir. |
