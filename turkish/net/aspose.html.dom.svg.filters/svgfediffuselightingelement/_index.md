...
description: Aspose.Html.Dom.Svg.Filters.SVGFEDiffuseLightingElement sınıf. SVGFEDiffuseLightingElement arabirimi feDiffuseLighting öğesine karşılık gelir.
type: docs
weight: 1410
url: /tr/net/aspose.html.dom.svg.filters/svgfediffuselightingelement/
---
## SVGFEDiffuseLightingElement class

SVGFEDiffuseLightingElement arabirimi, 'feDiffuseLighting' öğesine karşılık gelir.
...
| [DiffuseConstant](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/diffuseconstant/) { get; } | Verilen 'feDiffuseLighting' öğesindeki 'diffuseConstant' özniteliğine karşılık gelir. |
...
| [Height](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/height/) { get; } | Belirtilen 'filtre' öğesindeki 'yükseklik' özelliğine karşılık gelir. |
| [Id](../../aspose.html.dom.svg/svgelement/id/) { get; set; } | Belirtilen öğedeki 'id' özniteliğinin değeri veya 'id' yoksa boş dize. |
| [In1](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/in1/) { get; } | Verilen 'feDiffuseLighting' öğesindeki 'in' özniteliğine karşılık gelir. |
...
| [KernelUnitLengthX](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/kernelunitlengthx/) { get; } | Verilen 'feDiffuseLighting' öğesinde 'kernelUnitLength' özniteliğine karşılık gelir. |
| [KernelUnitLengthY](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/kernelunitlengthy/) { get; } | Verilen 'feDiffuseLighting' öğesinde 'kernelUnitLength' özniteliğine karşılık gelir. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/result/) { get; } | Belirtilen 'filtre' öğesindeki 'sonuç' özniteliğine karşılık gelir. |
...
| [SurfaceScale](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/surfacescale/) { get; } | Verilen 'feDiffuseLighting' öğesindeki 'surfaceScale' özniteliğine karşılık gelir. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/width/) { get; } | Verilen 'filtre' öğesindeki 'genişlik' özelliğine karşılık gelir. |
| [X](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/x/) { get; } | Verilen 'filtre' öğesindeki 'x' özniteliğine karşılık gelir. |
| [Y](../../aspose.html.dom.svg.filters/svgfediffuselightingelement/y/) { get; } | Verilen 'filtre' öğesindeki 'y' özniteliğine karşılık gelir. |
