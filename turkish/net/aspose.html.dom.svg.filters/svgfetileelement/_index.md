...
description: Aspose.Html.Dom.Svg.Filters.SVGFETileElement sınıf. SVGFETileElement arabirimi feTile öğesine karşılık gelir.
type: docs
weight: 1590
url: /tr/net/aspose.html.dom.svg.filters/svgfetileelement/
---
## SVGFETileElement class

SVGFETileElement arabirimi, 'feTile' öğesine karşılık gelir.
...
| [Height](../../aspose.html.dom.svg.filters/svgfetileelement/height/) { get; } | Belirtilen 'filtre' öğesindeki 'yükseklik' özelliğine karşılık gelir. |
| [Id](../../aspose.html.dom.svg/svgelement/id/) { get; set; } | Belirtilen öğedeki 'id' özniteliğinin değeri veya 'id' yoksa boş dize. |
| [In1](../../aspose.html.dom.svg.filters/svgfetileelement/in1/) { get; } | Verilen 'feTile' öğesindeki 'in' özniteliğine karşılık gelir. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfetileelement/result/) { get; } | Belirtilen 'filtre' öğesindeki 'sonuç' özniteliğine karşılık gelir. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfetileelement/width/) { get; } | Verilen 'filtre' öğesindeki 'genişlik' özelliğine karşılık gelir. |
| [X](../../aspose.html.dom.svg.filters/svgfetileelement/x/) { get; } | Verilen 'filtre' öğesindeki 'x' özniteliğine karşılık gelir. |
| [Y](../../aspose.html.dom.svg.filters/svgfetileelement/y/) { get; } | Verilen 'filtre' öğesindeki 'y' özniteliğine karşılık gelir. |
