...
description: Aspose.Html.Dom.Svg.Filters.SVGFEOffsetElement sınıf. SVGFEOffsetElement arabirimi feOffset öğesine karşılık gelir.
type: docs
weight: 1550
url: /tr/net/aspose.html.dom.svg.filters/svgfeoffsetelement/
---
## SVGFEOffsetElement class

SVGFEOffsetElement arabirimi, 'feOffset' öğesine karşılık gelir.
...
| [Dx](../../aspose.html.dom.svg.filters/svgfeoffsetelement/dx/) { get; } | Verilen 'feOffset' öğesindeki 'dx' özniteliğine karşılık gelir. |
| [Dy](../../aspose.html.dom.svg.filters/svgfeoffsetelement/dy/) { get; } | Verilen 'feOffset' öğesindeki 'dy' özniteliğine karşılık gelir. |
...
| [Height](../../aspose.html.dom.svg.filters/svgfeoffsetelement/height/) { get; } | Belirtilen 'filtre' öğesindeki 'yükseklik' özelliğine karşılık gelir. |
| [Id](../../aspose.html.dom.svg/svgelement/id/) { get; set; } | Belirtilen öğedeki 'id' özniteliğinin değeri veya 'id' yoksa boş dize. |
| [In1](../../aspose.html.dom.svg.filters/svgfeoffsetelement/in1/) { get; } | Verilen 'feOffset' öğesindeki 'in' özniteliğine karşılık gelir. |
...
| [Result](../../aspose.html.dom.svg.filters/svgfeoffsetelement/result/) { get; } | Belirtilen 'filtre' öğesindeki 'sonuç' özniteliğine karşılık gelir. |
...
| [Width](../../aspose.html.dom.svg.filters/svgfeoffsetelement/width/) { get; } | Verilen 'filtre' öğesindeki 'genişlik' özelliğine karşılık gelir. |
| [X](../../aspose.html.dom.svg.filters/svgfeoffsetelement/x/) { get; } | Verilen 'filtre' öğesindeki 'x' özniteliğine karşılık gelir. |
| [Y](../../aspose.html.dom.svg.filters/svgfeoffsetelement/y/) { get; } | Verilen 'filtre' öğesindeki 'y' özniteliğine karşılık gelir. |
