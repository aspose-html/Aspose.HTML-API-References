...
description: Aspose.Html.Dom.Svg.DataTypes.SVGAnimatedEnumeration sınıf. Değeri belirli bir numaralandırmadan sabit olması gereken ve canlandırılabilen nitelikler için kullanılır.
type: docs
weight: 1090
url: /tr/net/aspose.html.dom.svg.datatypes/svganimatedenumeration/
---
## SVGAnimatedEnumeration class

Değeri belirli bir numaralandırmadan sabit olması gereken ve canlandırılabilen nitelikler için kullanılır.
...
| override [ToString](../../aspose.html.dom.svg.datatypes/svganimatedenumeration/tostring/)() | a döndürürString bu örneği temsil eder. |
