...
description: Aspose.Html.Dom.Svg.SVGViewElement sınıf. SVGViewElement arabirimi görünüm öğesine karşılık gelir.
type: docs
weight: 2410
url: /tr/net/aspose.html.dom.svg/svgviewelement/
---
## SVGViewElement class

SVGViewElement arabirimi, 'görünüm' öğesine karşılık gelir.
...
| [PreserveAspectRatio](../../aspose.html.dom.svg/svgviewelement/preserveaspectratio/) { get; } | Belirtilen öğede 'preserveAspectRatio' özniteliğine karşılık gelir. |
...
| [ViewBox](../../aspose.html.dom.svg/svgviewelement/viewbox/) { get; } | Belirtilen öğede 'viewBox' özelliğine karşılık gelir. |
...
| [ViewTarget](../../aspose.html.dom.svg/svgviewelement/viewtarget/) { get; } | Verilen 'view' öğesinde 'viewTarget' özniteliğine karşılık gelir. 'viewTarget' özelliğinde listelenen adları içeren DOMString değerlerinin listesi. DOMString değerlerinin her biri, getElementById() yöntemi call. kullanılarak karşılık gelen öğeyle ilişkilendirilebilir. |
| [ZoomAndPan](../../aspose.html.dom.svg/svgviewelement/zoomandpan/) { get; set; } | Belirtilen öğede 'zoomAndPan' özniteliğine karşılık gelir. Değer, bu arabirimde tanımlanan SVG_ZOOMANDPAN_* sabitlerinden biri olmalıdır. |
