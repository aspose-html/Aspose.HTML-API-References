...
description: Aspose.Html.Dom.Svg.SVGPolylineElement sınıf. SVGPolylineElement arabirimi polyline öğesine karşılık gelir.
type: docs
weight: 2220
url: /tr/net/aspose.html.dom.svg/svgpolylineelement/
---
## SVGPolylineElement class

SVGPolylineElement arabirimi, 'polyline' öğesine karşılık gelir.
...
| İsim | Tanım |
| --- | --- |
| [AnimatedPoints](../../aspose.html.dom.svg/svgpolylineelement/animatedpoints/) { get; } | 'puan' özniteliğinin mevcut animasyonlu içeriğine erişim sağlar. Belirtilen öznitelik veya özellik canlandırılıyorsa, öznitelik veya özelliğin geçerli animasyonlu değerini içerir. Belirtilen öznitelik veya özellik şu anda canlandırılmıyorsa points. ile aynı değeri içerir. |
...
| [Points](../../aspose.html.dom.svg/svgpolylineelement/points/) { get; } | 'nokta' özniteliğinin temel (yani statik) içeriğine erişim sağlar. |
