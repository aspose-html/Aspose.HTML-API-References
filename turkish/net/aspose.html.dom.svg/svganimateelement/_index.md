...
description: Aspose.Html.Dom.Svg.SVGAnimateElement sınıf. SVGAnimateElement arabirimi animate öğesine karşılık gelir. animate öğesinin özniteliklerine SVG DOM aracılığıyla nesne yönelimli erişim mevcut değildir.
type: docs
weight: 1910
url: /tr/net/aspose.html.dom.svg/svganimateelement/
---
## SVGAnimateElement class

SVGAnimateElement arabirimi, "animate" öğesine karşılık gelir. "animate" öğesinin özniteliklerine SVG DOM aracılığıyla nesne yönelimli erişim mevcut değildir.
