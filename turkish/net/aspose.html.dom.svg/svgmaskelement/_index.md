...
description: Aspose.Html.Dom.Svg.SVGMaskElement sınıf. SVGMaskElement arabirimi maske öğesine karşılık gelir.
type: docs
weight: 2170
url: /tr/net/aspose.html.dom.svg/svgmaskelement/
---
## SVGMaskElement class

SVGMaskElement arabirimi 'maske' öğesine karşılık gelir.
...
| [Height](../../aspose.html.dom.svg/svgmaskelement/height/) { get; } | Verilen 'maske' öğesindeki 'yükseklik' özelliğine karşılık gelir. SVGUnitTypes. içinde tanımlanan sabitlerden birini alır |
...
| [MaskContentUnits](../../aspose.html.dom.svg/svgmaskelement/maskcontentunits/) { get; } | Verilen 'mask' öğesinde 'maskContentUnits' özniteliğine karşılık gelir. SVGUnitTypes. içinde tanımlanan sabitlerden birini alır |
| [MaskUnits](../../aspose.html.dom.svg/svgmaskelement/maskunits/) { get; } | Verilen 'mask' öğesindeki 'maskUnits' özniteliğine karşılık gelir. SVGUnitTypes. içinde tanımlanan sabitlerden birini alır |
...
| [RequiredExtensions](../../aspose.html.dom.svg/svgmaskelement/requiredextensions/) { get; } | Belirtilen öğede 'requiredExtensions' özniteliğine karşılık gelir. |
| [RequiredFeatures](../../aspose.html.dom.svg/svgmaskelement/requiredfeatures/) { get; } | Belirtilen öğede 'requiredFeatures' özniteliğine karşılık gelir. |
...
| [SystemLanguage](../../aspose.html.dom.svg/svgmaskelement/systemlanguage/) { get; } | Verilen öğedeki 'systemLanguage' özniteliğine karşılık gelir. |
...
| [Width](../../aspose.html.dom.svg/svgmaskelement/width/) { get; } | Verilen 'maske' öğesindeki 'genişlik' özelliğine karşılık gelir. SVGUnitTypes. içinde tanımlanan sabitlerden birini alır |
| [X](../../aspose.html.dom.svg/svgmaskelement/x/) { get; } | Verilen 'maske' öğesindeki 'x' özniteliğine karşılık gelir. SVGUnitTypes. içinde tanımlanan sabitlerden birini alır |
| [Y](../../aspose.html.dom.svg/svgmaskelement/y/) { get; } | Verilen 'maske' öğesindeki 'y' özniteliğine karşılık gelir. SVGUnitTypes. içinde tanımlanan sabitlerden birini alır |
