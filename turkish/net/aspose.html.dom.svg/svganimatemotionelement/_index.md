...
description: Aspose.Html.Dom.Svg.SVGAnimateMotionElement sınıf. SVGAnimateMotionElement arabirimi animateMotion öğesine karşılık gelir. animateMotion öğesinin özniteliklerine SVG DOM üzerinden nesne yönelimli erişim mevcut değildir.
type: docs
weight: 1920
url: /tr/net/aspose.html.dom.svg/svganimatemotionelement/
---
## SVGAnimateMotionElement class

SVGAnimateMotionElement arabirimi, "animateMotion" öğesine karşılık gelir. "animateMotion" öğesinin özniteliklerine SVG DOM üzerinden nesne yönelimli erişim mevcut değildir.
