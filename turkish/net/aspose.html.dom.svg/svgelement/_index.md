...
description: Aspose.Html.Dom.Svg.SVGElement sınıf. SVG dilindeki öğelere yol öğesi için SVGPathElement arabirimi gibi doğrudan karşılık gelen tüm SVG DOM arabirimleri SVGElement arabiriminden türetilir.
type: docs
weight: 2020
url: /tr/net/aspose.html.dom.svg/svgelement/
---
## SVGElement class

SVG dilindeki öğelere ('yol' öğesi için SVGPathElement arabirimi gibi) doğrudan karşılık gelen tüm SVG DOM arabirimleri, SVGElement arabiriminden türetilir.
