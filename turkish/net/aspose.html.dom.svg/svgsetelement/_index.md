...
description: Aspose.Html.Dom.Svg.SVGSetElement sınıf. SVGSetElement arabirimi set öğesine karşılık gelir. set öğesinin özniteliklerine SVG DOM üzerinden nesne yönelimli erişim mevcut değildir.
type: docs
weight: 2280
url: /tr/net/aspose.html.dom.svg/svgsetelement/
---
## SVGSetElement class

SVGSetElement arabirimi 'set' öğesine karşılık gelir. 'set' öğesinin özniteliklerine SVG DOM üzerinden nesne yönelimli erişim mevcut değildir.
