...
description: Aspose.Html.Dom.Svg.SVGAnimateTransformElement sınıf. SVGAnimateTransformElement arabirimi animateTransform öğesine karşılık gelir. animateTransform öğesinin özniteliklerine SVG DOM aracılığıyla nesne yönelimli erişim mevcut değildir.
type: docs
weight: 1930
url: /tr/net/aspose.html.dom.svg/svganimatetransformelement/
---
## SVGAnimateTransformElement class

SVGAnimateTransformElement arabirimi, "animateTransform" öğesine karşılık gelir. "animateTransform" öğesinin özniteliklerine SVG DOM aracılığıyla nesne yönelimli erişim mevcut değildir.
