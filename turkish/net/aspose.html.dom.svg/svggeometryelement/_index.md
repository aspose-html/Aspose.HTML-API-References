...
description: Aspose.Html.Dom.Svg.SVGGeometryElement sınıf. Arayüz SVGGeometryElement işlemesi eşdeğer bir yolla geometri tarafından tanımlanan ve doldurulabilen ve konturlanabilen SVG öğelerini temsil eder. Bu yolları ve temel şekilleri içerir.
type: docs
weight: 2090
url: /tr/net/aspose.html.dom.svg/svggeometryelement/
---
## SVGGeometryElement class

Arayüz SVGGeometryElement, işlemesi eşdeğer bir yolla geometri tarafından tanımlanan ve doldurulabilen ve konturlanabilen SVG öğelerini temsil eder. Bu, yolları ve temel şekilleri içerir.
...
| [GetEquivalentPath](../../aspose.html.dom.svg/svggeometryelement/getequivalentpath/)() | Yeni bir örnek örneğini döndürür.[`SVGPathSegList`](../../aspose.html.dom.svg.paths/svgpathseglist/) hangi temsil eder`SVGGeometryElement` yol segmentleri olarak. |
