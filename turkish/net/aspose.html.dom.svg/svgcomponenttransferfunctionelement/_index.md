...
description: Aspose.Html.Dom.Svg.SVGComponentTransferFunctionElement sınıf. Bu arabirim bileşen aktarım işlevi arabirimleri tarafından kullanılan bir temel arabirimi tanımlar.
type: docs
weight: 1970
url: /tr/net/aspose.html.dom.svg/svgcomponenttransferfunctionelement/
---
## SVGComponentTransferFunctionElement class

Bu arabirim, bileşen aktarım işlevi arabirimleri tarafından kullanılan bir temel arabirimi tanımlar.
...
| İsim | Tanım |
| --- | --- |
| [Amplitude](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/amplitude/) { get; } | Verilen öğedeki 'genlik' özelliğine karşılık gelir. |
...
| [Exponent](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/exponent/) { get; } | Verilen öğedeki 'üs' özniteliğine karşılık gelir. |
...
| [Intercept](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/intercept/) { get; } | Belirli bir öğede 'intercept' özelliğine karşılık gelir. |
...
| [Offset](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/offset/) { get; } | Belirli bir öğede 'offset' özniteliğine karşılık gelir. |
...
| [Slope](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/slope/) { get; } | Belirli bir öğede 'eğim' özelliğine karşılık gelir. |
...
| [TableValues](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/tablevalues/) { get; } | Verilen öğedeki 'tableValues' özniteliğine karşılık gelir. |
...
| [Type](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/type/) { get; } | Belirli bir öğede 'tür' özniteliğine karşılık gelir. Bu arabirimde tanımlanan SVG_FECOMPONENTTRANSFER_TYPE_* sabitlerinden birini alır. |
...
| İsim | Tanım |
| --- | --- |
| const [SVG_FECOMPONENTTRANSFER_TYPE_DISCRETE](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_discrete/) | 'ayrık' değerine karşılık gelir. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_GAMMA](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_gamma/) | 'gamma' değerine karşılık gelir. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_IDENTITY](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_identity/) | 'kimlik' değerine karşılık gelir. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_LINEAR](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_linear/) | 'doğrusal' değerine karşılık gelir. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_TABLE](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_table/) | 'tablo' değerine karşılık gelir. |
| const [SVG_FECOMPONENTTRANSFER_TYPE_UNKNOWN](../../aspose.html.dom.svg/svgcomponenttransferfunctionelement/svg_fecomponenttransfer_type_unknown/) | Tür, önceden tanımlanmış türlerden biri değil. Bu türde yeni bir değer tanımlamaya veya mevcut bir değeri bu türe değiştirmeye çalışmak geçersizdir. |
