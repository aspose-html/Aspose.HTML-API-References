...
description: Aspose.Html.Dom.Svg.SVGStyleElement sınıf. SVGStyleElement arabirimi stil öğesine karşılık gelir.
type: docs
weight: 2300
url: /tr/net/aspose.html.dom.svg/svgstyleelement/
---
...
| [Media](../../aspose.html.dom.svg/svgstyleelement/media/) { get; set; } | Verilen öğedeki 'medya' özniteliğine karşılık gelir. |
...
| [Sheet](../../aspose.html.dom.svg/svgstyleelement/sheet/) { get; } | İlgili stil sayfasını alır. |
...
| [Title](../../aspose.html.dom.svg/svgstyleelement/title/) { get; set; } | Verilen öğedeki 'başlık' özelliğine karşılık gelir. |
| [Type](../../aspose.html.dom.svg/svgstyleelement/type/) { get; set; } | Belirli bir öğede 'tür' özniteliğine karşılık gelir. |
