...
description: Aspose.Html.Dom.Svg.SVGUseElement sınıf. SVGUseElement arabirimi use öğesine karşılık gelir.
type: docs
weight: 2400
url: /tr/net/aspose.html.dom.svg/svguseelement/
---
## SVGUseElement class

SVGUseElement arabirimi, 'use' öğesine karşılık gelir.
...
| [Height](../../aspose.html.dom.svg/svguseelement/height/) { get; } | Belirtilen 'kullanım' öğesinde 'yükseklik' özelliğine karşılık gelir. |
| [Href](../../aspose.html.dom.svg/svguseelement/href/) { get; } | Belirtilen öğede 'xlink:href' özelliğine karşılık gelir. |
...
| [Width](../../aspose.html.dom.svg/svguseelement/width/) { get; } | Belirtilen "kullanım" öğesinde "genişlik" özelliğine karşılık gelir. |
| [X](../../aspose.html.dom.svg/svguseelement/x/) { get; } | Verilen 'use' öğesinde 'x' özniteliğine karşılık gelir. |
| [Y](../../aspose.html.dom.svg/svguseelement/y/) { get; } | Verilen 'use' öğesinde 'y' özniteliğine karşılık gelir. |
