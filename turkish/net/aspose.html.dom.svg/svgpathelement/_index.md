...
description: Aspose.Html.Dom.Svg.SVGPathElement sınıf. SVGPathElement arabirimi yol öğesine karşılık gelir.
type: docs
weight: 2190
url: /tr/net/aspose.html.dom.svg/svgpathelement/
---
## SVGPathElement class

SVGPathElement arabirimi, 'yol' öğesine karşılık gelir.
...
| [PathLength](../../aspose.html.dom.svg/svggeometryelement/pathlength/) { get; } | Verilen öğedeki pathLength özniteliğine karşılık gelir. |
| [PathSegList](../../aspose.html.dom.svg/svgpathelement/pathseglist/) { get; set; } | SVG'nin sözdizimiyle bire bir eşleşen bir biçimde 'd' özniteliğinin temel (yani statik) içeriğine erişim sağlar. Dolayısıyla, 'd' özniteliği bir "mutlak hareket (M)" ve bir "mutlak ark (A)" komutuna sahipse, pathSegList'in iki girişi olacaktır: bir SVG_PATHSEG_MOVETO_ABS ve bir SVG_PATHSEG_ARC_ABS. |
...
| [CreateSVGPathSegArcAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegarcabs/)(float, float, float, float, float, bool, bool) | Tek başına, ebeveynsiz bir SVGPathSegArcAbs nesnesi döndürür. |
| [CreateSVGPathSegArcRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegarcrel/)(float, float, float, float, float, bool, bool) | Tek başına, ebeveynsiz bir SVGPathSegArcRel nesnesi döndürür. |
| [CreateSVGPathSegClosePath](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegclosepath/)() | Tek başına, ebeveynsiz bir SVGPathSegClosePath nesnesi döndürür. |
| [CreateSVGPathSegCurvetoCubicAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicabs/)(float, float, float, float, float, float) | Tek başına, ebeveynsiz bir SVGPathSegCurvetoCubicAbs nesnesi döndürür. |
| [CreateSVGPathSegCurvetoCubicRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicrel/)(float, float, float, float, float, float) | Tek başına, ebeveynsiz bir SVGPathSegCurvetoCubicRel nesnesi döndürür. |
| [CreateSVGPathSegCurvetoCubicSmoothAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothabs/)(float, float, float, float) | Tek başına, ebeveynsiz bir SVGPathSegCurvetoCubicSmoothAbs nesnesi döndürür. |
| [CreateSVGPathSegCurvetoCubicSmoothRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetocubicsmoothrel/)(float, float, float, float) | Tek başına, ebeveynsiz bir SVGPathSegCurvetoCubicSmoothRel nesnesi döndürür. |
| [CreateSVGPathSegCurvetoQuadraticAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticabs/)(float, float, float, float) | Tek başına, ebeveynsiz bir SVGPathSegCurvetoQuadraticAbs nesnesi döndürür. |
| [CreateSVGPathSegCurvetoQuadraticRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticrel/)(float, float, float, float) | Tek başına, ebeveynsiz bir SVGPathSegCurvetoQuadraticRel nesnesi döndürür. |
| [CreateSVGPathSegCurvetoQuadraticSmoothAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothabs/)(float, float) | Tek başına, ebeveynsiz bir SVGPathSegCurvetoQuadraticSmoothAbs nesnesi döndürür. |
| [CreateSVGPathSegCurvetoQuadraticSmoothRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothrel/)(float, float) | Tek başına, ebeveynsiz bir SVGPathSegCurvetoQuadraticSmoothRel nesnesi döndürür. |
| [CreateSVGPathSegLinetoAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoabs/)(float, float) | Tek başına, ebeveynsiz bir SVGPathSegLinetoAbs nesnesi döndürür. |
| [CreateSVGPathSegLinetoHorizontalAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetohorizontalabs/)(float) | Tek başına, ebeveynsiz bir SVGPathSegLinetoHorizontalAbs nesnesi döndürür. |
| [CreateSVGPathSegLinetoHorizontalRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetohorizontalrel/)(float) | Tek başına, ebeveynsiz bir SVGPathSegLinetoHorizontalRel nesnesi döndürür. |
| [CreateSVGPathSegLinetoRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetorel/)(float, float) | Tek başına, ebeveynsiz bir SVGPathSegLinetoRel nesnesi döndürür. |
| [CreateSVGPathSegLinetoVerticalAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoverticalabs/)(float) | Tek başına, ebeveynsiz bir SVGPathSegLinetoVerticalAbs nesnesi döndürür. |
| [CreateSVGPathSegLinetoVerticalRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathseglinetoverticalrel/)(float) | Tek başına, ebeveynsiz bir SVGPathSegLinetoVerticalRel nesnesi döndürür. |
| [CreateSVGPathSegMovetoAbs](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegmovetoabs/)(float, float) | Tek başına, ebeveynsiz bir SVGPathSegMovetoAbs nesnesi döndürür. |
| [CreateSVGPathSegMovetoRel](../../aspose.html.dom.svg/svgpathelement/createsvgpathsegmovetorel/)(float, float) | Tek başına, ebeveynsiz bir SVGPathSegMovetoRel nesnesi döndürür. |
...
| [GetEquivalentPath](../../aspose.html.dom.svg/svggeometryelement/getequivalentpath/)() | Yeni bir örnek örneğini döndürür.[`SVGPathSegList`](../../aspose.html.dom.svg.paths/svgpathseglist/) hangi temsil eder[`SVGGeometryElement`](../svggeometryelement/) yol segmentleri olarak. |
...
| [GetPointAtLength](../../aspose.html.dom.svg/svggeometryelement/getpointatlength/)(float) | Kullanıcı aracısının yol boyunca mesafe algoritmasını kullanarak, yol boyunca mesafe birimleri olan kullanıcı alanındaki (x,y) koordinatını döndürür. |
...
| [GetTotalLength](../../aspose.html.dom.svg/svggeometryelement/gettotallength/)() | Geçerli kullanıcı koordinat sisteminde bir mesafe olarak, kullanıcı aracısının yol boyunca mesafe algoritmasını kullanarak yolun toplam uzunluğu için kullanıcı aracısının hesaplanan değerini döndürür. |
