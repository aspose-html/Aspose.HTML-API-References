...
type: docs
weight: 2260
url: /tr/net/aspose.html.dom.svg/svgsvgelement/
---
## SVGSVGElement class
...
| [CurrentTranslate](../../aspose.html.dom.svg/svgsvgelement/currenttranslate/) { get; } | En dıştaki svg öğesinde, kullanıcının "büyütmesini" hesaba katan karşılık gelen çeviri faktörü. En dıştaki svg öğesi olmayan bir 'svg' öğesinde erişildiğinde, bu özniteliğin hangi davranışa sahip olduğu tanımlanmamıştır. |
...
| [Height](../../aspose.html.dom.svg/svgsvgelement/height/) { get; } | Verilen 'svg' öğesindeki 'yükseklik' özelliğine karşılık gelir. |
...
| [PreserveAspectRatio](../../aspose.html.dom.svg/svgsvgelement/preserveaspectratio/) { get; } | Belirtilen öğede 'preserveAspectRatio' özniteliğine karşılık gelir. |
...
| [ViewBox](../../aspose.html.dom.svg/svgsvgelement/viewbox/) { get; } | Belirtilen öğede 'viewBox' özelliğine karşılık gelir. |
...
| [Width](../../aspose.html.dom.svg/svgsvgelement/width/) { get; } | Verilen 'svg' öğesindeki 'genişlik' özelliğine karşılık gelir. |
| [X](../../aspose.html.dom.svg/svgsvgelement/x/) { get; } | Verilen 'svg' öğesindeki 'x' özniteliğine karşılık gelir. |
| [Y](../../aspose.html.dom.svg/svgsvgelement/y/) { get; } | Verilen 'svg' öğesindeki 'y' özniteliğine karşılık gelir. |
| [ZoomAndPan](../../aspose.html.dom.svg/svgsvgelement/zoomandpan/) { get; set; } | Belirtilen öğede 'zoomAndPan' özniteliğine karşılık gelir. Değer, bu arabirimde tanımlanan SVG_ZOOMANDPAN_* sabitlerinden biri olmalıdır. |
...
| [AnimationsPaused](../../aspose.html.dom.svg/svgsvgelement/animationspaused/)() | Bu SVG belge parçası duraklatılmış durumdaysa true değerini döndürür. |
...
| [CreateEvent](../../aspose.html.dom.svg/svgsvgelement/createevent/)(string) | oluşturur[`Event`](../../aspose.html.dom.events/event/) uygulama tarafından desteklenen bir tür. |
| [CreateSVGAngle](../../aspose.html.dom.svg/svgsvgelement/createsvgangle/)() | Herhangi bir belge ağacının dışında bir SVGAngle nesnesi oluşturur. Nesne, 0 derece (birimsiz) değerine sıfırlanır. |
| [CreateSVGLength](../../aspose.html.dom.svg/svgsvgelement/createsvglength/)() | Herhangi bir belge ağacının dışında bir SVGLength nesnesi oluşturur. Nesne, 0 kullanıcı birimi değerine sıfırlanır. |
| [CreateSVGMatrix](../../aspose.html.dom.svg/svgsvgelement/createsvgmatrix/)() | Herhangi bir belge ağacının dışında bir SVGMatrix nesnesi oluşturur. Nesne, kimlik matrisine göre başlatıldı. |
| [CreateSVGNumber](../../aspose.html.dom.svg/svgsvgelement/createsvgnumber/)() | Herhangi bir belge ağacının dışında bir SVGNumber nesnesi oluşturur. Nesne, sıfır değerine sıfırlanır. |
| [CreateSVGPoint](../../aspose.html.dom.svg/svgsvgelement/createsvgpoint/)() | Herhangi bir belge ağacının dışında bir SVGPoint nesnesi oluşturur. Nesne, kullanıcı koordinat sisteminde (0,0) noktasına sıfırlanır. |
| [CreateSVGRect](../../aspose.html.dom.svg/svgsvgelement/createsvgrect/)() | Herhangi bir belge ağacının dışında bir SVGRect nesnesi oluşturur. Nesne, tüm değerler 0 kullanıcı birimine ayarlanacak şekilde başlatılır. |
| [CreateSVGTransform](../../aspose.html.dom.svg/svgsvgelement/createsvgtransform/)() | Herhangi bir belge ağacının dışında bir SVGTransform nesnesi oluşturur. Nesne, bir kimlik matrisi dönüşümüne (SVG_TRANSFORM_MATRIX). başlatıldı. |
...
| [PauseAnimations](../../aspose.html.dom.svg/svgsvgelement/pauseanimations/)() | Bu 'svg' öğesine karşılık gelen SVG belge parçasında tanımlanan, o anda çalışan tüm animasyonları askıya alır (yani duraklatır), bu belge parçasına karşılık gelen animasyon saatinin duraklatılana kadar sabit kalmasına neden olur. |
...
| [SetCurrentTime](../../aspose.html.dom.svg/svgsvgelement/setcurrenttime/)(float) | Yeni bir geçerli zaman belirleyerek bu SVG belge parçası için saati ayarlar. Belge zaman çizelgesi başlamadan önce setCurrentTime çağrılırsa (örneğin, belgenin SVGLoad olayı gönderilmeden önce bir 'komut dosyası' öğesinde komut dosyası çalıştırılarak), bu durumda yöntemin son çalıştırılmasındaki saniyelerin değeri belgenin başladığı zamanı verir. belge zaman çizelgesi başladıktan sonra arayacaktır. |
...
| [UnpauseAnimations](../../aspose.html.dom.svg/svgsvgelement/unpauseanimations/)() | SVG belge parçasında tanımlanmış olan ve şu anda çalışan animasyonları askıya almayı kaldırır (yani duraklatmayı kaldırır), animasyon saatinin askıya alındığı andan itibaren devam etmesine neden olur. |
