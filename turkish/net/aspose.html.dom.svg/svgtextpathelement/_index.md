...
description: Aspose.Html.Dom.Svg.SVGTextPathElement sınıf. SVGTextPathElement arabirimi textPath öğesine karşılık gelir.
type: docs
weight: 2360
url: /tr/net/aspose.html.dom.svg/svgtextpathelement/
---
## SVGTextPathElement class

SVGTextPathElement arabirimi, 'textPath' öğesine karşılık gelir.
...
| [Href](../../aspose.html.dom.svg/svgtextpathelement/href/) { get; } | Belirtilen öğede 'xlink:href' özelliğine karşılık gelir. |
...
| [LengthAdjust](../../aspose.html.dom.svg/svgtextcontentelement/lengthadjust/) { get; } | Belirtilen öğede 'uzunlukAdjust' özniteliğine karşılık gelir. Değer, bu arabirimde tanımlanan uzunluk ayarlama sabitlerinden biri olmalıdır. |
...
| [Method](../../aspose.html.dom.svg/svgtextpathelement/method/) { get; } | Verilen 'textPath' öğesindeki 'method' özniteliğine karşılık gelir. |
...
| [Spacing](../../aspose.html.dom.svg/svgtextpathelement/spacing/) { get; } | Verilen 'textPath' öğesindeki 'boşluk' özniteliğine karşılık gelir. |
| [StartOffset](../../aspose.html.dom.svg/svgtextpathelement/startoffset/) { get; } | Belirtilen 'textPath' öğesinde 'startOffset' özniteliğine karşılık gelir. |
...
| [TextLength](../../aspose.html.dom.svg/svgtextcontentelement/textlength/) { get; } | Verilen öğedeki 'textLength' özniteliğine karşılık gelir. |
...
| [GetComputedTextLength](../../aspose.html.dom.svg/svgtextcontentelement/getcomputedtextlength/)() | Gliflerdeki ilerleme değeri (yatay veya dikey), 'karakter aralığı', 'harf aralığı' ve 'sözcük- aralık' ve 'tspan' öğeleri üzerindeki 'dx' ve 'dy' özniteliklerinden kaynaklanan ayarlamalar. Oluşturulmayan ortamlar için, kullanıcı aracısının glif ölçümleri hakkında makul varsayımlarda bulunması gerekir. |
...
| [GetNumberOfChars](../../aspose.html.dom.svg/svgtextcontentelement/getnumberofchars/)() | İşlenip işlenmeyeceğine bakılmaksızın, 'tref' referansından başvurulan karakterleri içeren geçerli öğe içinde işlenmeye uygun toplam karakter sayısını döndürür. Etkili olarak bu, DOM Düzey 3 Çekirdeğindeki ([DOM3], bölüm 1.4) Node::textContent özniteliğinin uzunluğuna eşdeğerdir, eğer bu öznitelik 'tref' öğelerini de genişlettiyse. |
...
| İsim | Tanım |
| --- | --- |
| const [TEXTPATH_METHODTYPE_ALIGN](../../aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_align/) | 'hizalama' değerine karşılık gelir. |
| const [TEXTPATH_METHODTYPE_STRETCH](../../aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_stretch/) | 'germe' değerine karşılık gelir. |
| const [TEXTPATH_METHODTYPE_UNKNOWN](../../aspose.html.dom.svg/svgtextpathelement/textpath_methodtype_unknown/) | Numaralandırma, önceden tanımlanmış türlerden biri olmayan bir değere ayarlandı. Bu türde yeni bir değer tanımlamaya veya mevcut bir değeri bu türe değiştirmeye çalışmak geçersizdir. |
| const [TEXTPATH_SPACINGTYPE_AUTO](../../aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_auto/) | 'auto' değerine karşılık gelir. |
| const [TEXTPATH_SPACINGTYPE_EXACT](../../aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_exact/) | 'exact' değerine karşılık gelir. |
| const [TEXTPATH_SPACINGTYPE_UNKNOWN](../../aspose.html.dom.svg/svgtextpathelement/textpath_spacingtype_unknown/) | Numaralandırma, önceden tanımlanmış türlerden biri olmayan bir değere ayarlandı. Bu türde yeni bir değer tanımlamaya veya mevcut bir değeri bu türe değiştirmeye çalışmak geçersizdir. |
